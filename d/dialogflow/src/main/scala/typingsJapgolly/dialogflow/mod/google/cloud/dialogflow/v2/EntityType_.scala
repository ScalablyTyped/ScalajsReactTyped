...
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.AutoExpansionMode
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.IEntity
import typingsJapgolly.dialogflow.mod.google.cloud.dialogflow.v2.EntityType.Kind
