package typingsJapgolly.dplayer

import typingsJapgolly.dplayer.mod.DirectionType
import typingsJapgolly.dplayer.mod.FullScreenType
import typingsJapgolly.dplayer.mod.Lang
import typingsJapgolly.dplayer.mod.Preload
import typingsJapgolly.dplayer.mod.SubTitleType
import typingsJapgolly.dplayer.mod.VideoType
