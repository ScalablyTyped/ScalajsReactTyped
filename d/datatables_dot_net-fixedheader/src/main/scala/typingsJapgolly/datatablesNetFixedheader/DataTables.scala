package typingsJapgolly.datatablesNetFixedheader
...
object DataTables {
  ...
  object FixedHeaderApi {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(adjust = adjust.toJsFn, disable = disable.toJsFn, enable = js.Any.fromFunction1(enable), footerOffset = js.Any.fromFunction1(footerOffset), headerOffset = js.Any.fromFunction1(headerOffset))
      __obj.asInstanceOf[FixedHeaderApi]
    }
    
    extension [Self <: FixedHeaderApi](x: Self) {
      
      inline def setAdjust(value: CallbackTo[Api]): Self = StObject.set(x, "adjust", value.toJsFn)
