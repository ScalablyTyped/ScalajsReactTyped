...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.bufferUsage
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.dataCollected
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.tracingComplete
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Tracing.BufferUsageEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Tracing.DataCollectedEvent
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Tracing.RequestMemoryDumpRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Tracing.RequestMemoryDumpResponse
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Tracing.StartRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Tracing.TracingCompleteEvent
