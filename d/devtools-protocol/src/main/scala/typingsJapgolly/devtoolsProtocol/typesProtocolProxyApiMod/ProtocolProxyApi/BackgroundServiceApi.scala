...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.backgroundServiceEventReceived
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.recordingStateChanged
import typingsJapgolly.devtoolsProtocol.mod.Protocol.BackgroundService.BackgroundServiceEventReceivedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.BackgroundService.ClearEventsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.BackgroundService.RecordingStateChangedEvent
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.BackgroundService.StopObservingRequest
