...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.inspectModeCanceled
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.inspectNodeRequested
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.nodeHighlightRequested
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.screenshotRequested
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.GetGridHighlightObjectsForTestRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.GetGridHighlightObjectsForTestResponse
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.GetHighlightObjectForTestRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.GetHighlightObjectForTestResponse
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.HighlightFrameRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.HighlightNodeRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.HighlightQuadRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.HighlightRectRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.HighlightSourceOrderRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.InspectNodeRequestedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.NodeHighlightRequestedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.ScreenshotRequestedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetInspectModeRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetPausedInDebuggerMessageRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowAdHighlightsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowContainerQueryOverlaysRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowDebugBordersRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowFPSCounterRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowFlexOverlaysRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowGridOverlaysRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowHingeRequest
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowPaintRectsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowScrollBottleneckRectsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowScrollSnapOverlaysRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowViewportSizeOnResizeRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Overlay.SetShowWebVitalsRequest
