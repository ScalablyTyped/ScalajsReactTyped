...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.attachedToTarget
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.detachedFromTarget
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.receivedMessageFromTarget
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.targetCrashed
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.targetCreated
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.targetDestroyed
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.targetInfoChanged
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.ActivateTargetRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.AttachToBrowserTargetResponse
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.AttachedToTargetEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.AutoAttachRelatedRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.CloseTargetRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.CloseTargetResponse
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.CreateTargetRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.CreateTargetResponse
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.DetachFromTargetRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.DetachedFromTargetEvent
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.GetBrowserContextsResponse
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.GetTargetsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.GetTargetsResponse
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.ReceivedMessageFromTargetEvent
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.TargetCrashedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.TargetCreatedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.TargetDestroyedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Target.TargetInfoChangedEvent
