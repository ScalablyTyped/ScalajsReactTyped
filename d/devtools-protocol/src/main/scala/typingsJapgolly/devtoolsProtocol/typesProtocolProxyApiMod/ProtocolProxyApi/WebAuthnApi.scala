...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.WebAuthn.GetCredentialRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.WebAuthn.GetCredentialResponse
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.WebAuthn.RemoveCredentialRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.WebAuthn.RemoveVirtualAuthenticatorRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.WebAuthn.SetAutomaticPresenceSimulationRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.WebAuthn.SetUserVerifiedRequest
