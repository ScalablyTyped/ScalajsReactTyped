...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.dragIntercepted
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Input.DragInterceptedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Input.EmulateTouchFromMouseEventRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Input.ImeSetCompositionRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Input.InsertTextRequest
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Input.SynthesizeScrollGestureRequest
...
object InputApi {
  ...
  inline def apply(
    ...
    on: (dragIntercepted, js.Function1[/* params */ DragInterceptedEvent, Unit]) => Callback,
  ...
  extension [Self <: InputApi](x: Self) {
    ...
    inline def setOn(value: (dragIntercepted, js.Function1[/* params */ DragInterceptedEvent, Unit]) => Callback): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: dragIntercepted, t1: js.Function1[/* params */ DragInterceptedEvent, Unit]) => (value(t0, t1)).runNow()))
