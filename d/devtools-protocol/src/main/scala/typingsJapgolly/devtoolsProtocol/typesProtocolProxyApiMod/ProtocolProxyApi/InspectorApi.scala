...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.detached
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.targetCrashed
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.targetReloadedAfterCrash
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Inspector.DetachedEvent
