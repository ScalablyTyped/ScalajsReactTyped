...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.certificateError
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.securityStateChanged
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.visibleSecurityStateChanged
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Security.CertificateErrorEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Security.HandleCertificateErrorRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Security.SecurityStateChangedEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Security.SetIgnoreCertificateErrorsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Security.SetOverrideCertificateErrorsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Security.VisibleSecurityStateChangedEvent
