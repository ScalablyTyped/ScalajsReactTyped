...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.DOMDebugger.GetEventListenersRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.DOMDebugger.GetEventListenersResponse
import typingsJapgolly.devtoolsProtocol.mod.Protocol.DOMDebugger.RemoveDOMBreakpointRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.DOMDebugger.RemoveEventListenerBreakpointRequest
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.DOMDebugger.SetInstrumentationBreakpointRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.DOMDebugger.SetXHRBreakpointRequest
