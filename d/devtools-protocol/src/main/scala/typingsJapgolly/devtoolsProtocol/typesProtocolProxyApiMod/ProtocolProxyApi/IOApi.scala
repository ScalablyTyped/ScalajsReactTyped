...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.IO.ReadRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.IO.ReadResponse
import typingsJapgolly.devtoolsProtocol.mod.Protocol.IO.ResolveBlobRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.IO.ResolveBlobResponse
