...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.authRequired
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.requestPaused
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Fetch.AuthRequiredEvent
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Fetch.ContinueRequestRequest
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Fetch.EnableRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Fetch.FailRequestRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Fetch.FulfillRequestRequest
...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Fetch.TakeResponseBodyAsStreamRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Fetch.TakeResponseBodyAsStreamResponse
