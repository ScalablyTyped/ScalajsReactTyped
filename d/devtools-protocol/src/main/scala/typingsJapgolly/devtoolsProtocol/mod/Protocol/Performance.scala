...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.threadTicks
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.timeTicks
...
object Performance {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.timeTicks
    - typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.threadTicks
  */
