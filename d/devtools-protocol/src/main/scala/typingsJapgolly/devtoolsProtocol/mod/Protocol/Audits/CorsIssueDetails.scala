...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.ClientSecurityState
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.CorsErrorStatus
