...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.CSSAnimation
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.CSSTransition
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.WebAnimation
...
object Animation {
  ...
  inline def apply(
  ...
  ): typingsJapgolly.devtoolsProtocol.mod.Protocol.Animation.Animation = {
    ...
    __obj.asInstanceOf[typingsJapgolly.devtoolsProtocol.mod.Protocol.Animation.Animation]
  }
  
  extension [Self <: typingsJapgolly.devtoolsProtocol.mod.Protocol.Animation.Animation](x: Self) {
