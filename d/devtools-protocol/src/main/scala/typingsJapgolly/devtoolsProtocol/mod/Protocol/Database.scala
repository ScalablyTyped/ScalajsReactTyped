...
object Database {
  ...
  trait AddDatabaseEvent extends StObject {
    ...
    var database: typingsJapgolly.devtoolsProtocol.mod.Protocol.Database.Database
  }
  object AddDatabaseEvent {
    
    inline def apply(database: typingsJapgolly.devtoolsProtocol.mod.Protocol.Database.Database): AddDatabaseEvent = {
    ...
    extension [Self <: AddDatabaseEvent](x: Self) {
      ...
      inline def setDatabase(value: typingsJapgolly.devtoolsProtocol.mod.Protocol.Database.Database): Self = StObject.set(x, "database", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Database {
    ...
    inline def apply(domain: String, id: DatabaseId, name: String, version: String): typingsJapgolly.devtoolsProtocol.mod.Protocol.Database.Database = {
      ...
      __obj.asInstanceOf[typingsJapgolly.devtoolsProtocol.mod.Protocol.Database.Database]
    }
    
    extension [Self <: typingsJapgolly.devtoolsProtocol.mod.Protocol.Database.Database](x: Self) {
