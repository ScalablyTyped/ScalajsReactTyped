...
import typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.unknown_
...
object SystemInfo {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.jpeg
    - typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.webp
    - typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.unknown_
  */
  trait ImageType extends StObject
  object ImageType {
    
    inline def jpeg: typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.jpeg = "jpeg".asInstanceOf[typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.jpeg]
    
    inline def unknown: unknown_ = "unknown".asInstanceOf[unknown_]
    
    inline def webp: typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.webp = "webp".asInstanceOf[typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.webp]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv420
    - typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv422
    - typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv444
  */
  trait SubsamplingFormat extends StObject
  object SubsamplingFormat {
    
    inline def yuv420: typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv420 = "yuv420".asInstanceOf[typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv420]
    
    inline def yuv422: typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv422 = "yuv422".asInstanceOf[typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv422]
    
    inline def yuv444: typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv444 = "yuv444".asInstanceOf[typingsJapgolly.devtoolsProtocol.devtoolsProtocolStrings.yuv444]
  }
