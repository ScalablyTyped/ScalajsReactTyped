...
trait RequestPausedEvent extends StObject {
  ...
  /**
    ...
    */
  var networkId: js.UndefOr[typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.RequestId] = js.undefined
...
object RequestPausedEvent {
  ...
  extension [Self <: RequestPausedEvent](x: Self) {
    ...
    inline def setNetworkId(value: typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.RequestId): Self = StObject.set(x, "networkId", value.asInstanceOf[js.Any])
