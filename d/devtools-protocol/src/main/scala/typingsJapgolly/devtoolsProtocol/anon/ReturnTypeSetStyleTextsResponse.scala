...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.CSS.SetStyleTextsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.CSS.SetStyleTextsResponse
...
object ReturnTypeSetStyleTextsResponse {
  ...
  extension [Self <: ReturnTypeSetStyleTextsResponse](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: SetStyleTextsRequest*): Self = StObject.set(x, "paramsType", js.Array(value*))
