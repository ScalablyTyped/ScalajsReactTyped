...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Accessibility.GetPartialAXTreeRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Accessibility.GetPartialAXTreeResponse
