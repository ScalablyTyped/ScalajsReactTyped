...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.WebAuthn.AddVirtualAuthenticatorRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.WebAuthn.AddVirtualAuthenticatorResponse
