...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Debugger.GetWasmBytecodeRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Debugger.GetWasmBytecodeResponse
