...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Debugger.NextWasmDisassemblyChunkRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Debugger.NextWasmDisassemblyChunkResponse
