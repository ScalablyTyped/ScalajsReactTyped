...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Debugger.RestartFrameRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Debugger.RestartFrameResponse
