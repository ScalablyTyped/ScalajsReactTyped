...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Input.ImeSetCompositionRequest
...
object `112` {
  ...
  inline def apply(paramsType: js.Array[ImeSetCompositionRequest], returnType: Unit): `112` = {
