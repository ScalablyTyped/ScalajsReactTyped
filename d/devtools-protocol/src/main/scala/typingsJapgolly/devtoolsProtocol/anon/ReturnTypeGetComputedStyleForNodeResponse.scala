...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.CSS.GetComputedStyleForNodeRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.CSS.GetComputedStyleForNodeResponse
