...
trait ReturnTypeGetAllCookiesResponse extends StObject {
  ...
  var returnType: GetAllCookiesResponse
}
object ReturnTypeGetAllCookiesResponse {
  
  inline def apply(paramsType: js.Array[Any], returnType: GetAllCookiesResponse): ReturnTypeGetAllCookiesResponse = {
    val __obj = js.Dynamic.literal(paramsType = paramsType.asInstanceOf[js.Any], returnType = returnType.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReturnTypeGetAllCookiesResponse]
  }
  
  extension [Self <: ReturnTypeGetAllCookiesResponse](x: Self) {
    ...
    inline def setReturnType(value: GetAllCookiesResponse): Self = StObject.set(x, "returnType", value.asInstanceOf[js.Any])
  }
}
