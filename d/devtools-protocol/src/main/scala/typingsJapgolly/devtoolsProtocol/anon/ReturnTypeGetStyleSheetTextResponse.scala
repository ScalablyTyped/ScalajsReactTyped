...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.CSS.GetStyleSheetTextRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.CSS.GetStyleSheetTextResponse
...
object ReturnTypeGetStyleSheetTextResponse {
  ...
  extension [Self <: ReturnTypeGetStyleSheetTextResponse](x: Self) {
    ...
    inline def setParamsTypeVarargs(value: GetStyleSheetTextRequest*): Self = StObject.set(x, "paramsType", js.Array(value*))
