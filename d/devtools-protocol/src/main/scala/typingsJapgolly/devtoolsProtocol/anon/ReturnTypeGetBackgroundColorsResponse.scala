...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.CSS.GetBackgroundColorsRequest
import typingsJapgolly.devtoolsProtocol.mod.Protocol.CSS.GetBackgroundColorsResponse
