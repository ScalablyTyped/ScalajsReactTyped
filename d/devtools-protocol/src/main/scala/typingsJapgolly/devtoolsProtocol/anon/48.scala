...
import typingsJapgolly.devtoolsProtocol.mod.Protocol.Cast.EnableRequest
...
object `48` {
  ...
  inline def apply(paramsType: js.Array[js.UndefOr[EnableRequest]], returnType: Unit): `48` = {
