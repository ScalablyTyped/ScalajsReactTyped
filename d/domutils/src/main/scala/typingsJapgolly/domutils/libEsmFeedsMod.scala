...
object libEsmFeedsMod {
  
  @JSImport("domutils/lib/esm/feeds", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.domutils.domutilsStrings.sample
    - typingsJapgolly.domutils.domutilsStrings.full
    - typingsJapgolly.domutils.domutilsStrings.nonstop
  */
  trait FeedItemMediaExpression extends StObject
  object FeedItemMediaExpression {
    
    inline def full: typingsJapgolly.domutils.domutilsStrings.full = "full".asInstanceOf[typingsJapgolly.domutils.domutilsStrings.full]
    
    inline def nonstop: typingsJapgolly.domutils.domutilsStrings.nonstop = "nonstop".asInstanceOf[typingsJapgolly.domutils.domutilsStrings.nonstop]
    
    inline def sample: typingsJapgolly.domutils.domutilsStrings.sample = "sample".asInstanceOf[typingsJapgolly.domutils.domutilsStrings.sample]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.domutils.domutilsStrings.image
    - typingsJapgolly.domutils.domutilsStrings.audio
    - typingsJapgolly.domutils.domutilsStrings.video
    - typingsJapgolly.domutils.domutilsStrings.document
    - typingsJapgolly.domutils.domutilsStrings.executable
  */
  trait FeedItemMediaMedium extends StObject
  object FeedItemMediaMedium {
    
    inline def audio: typingsJapgolly.domutils.domutilsStrings.audio = "audio".asInstanceOf[typingsJapgolly.domutils.domutilsStrings.audio]
    
    inline def document: typingsJapgolly.domutils.domutilsStrings.document = "document".asInstanceOf[typingsJapgolly.domutils.domutilsStrings.document]
    
    inline def executable: typingsJapgolly.domutils.domutilsStrings.executable = "executable".asInstanceOf[typingsJapgolly.domutils.domutilsStrings.executable]
    
    inline def image: typingsJapgolly.domutils.domutilsStrings.image = "image".asInstanceOf[typingsJapgolly.domutils.domutilsStrings.image]
    
    inline def video: typingsJapgolly.domutils.domutilsStrings.video = "video".asInstanceOf[typingsJapgolly.domutils.domutilsStrings.video]
  }
}
