...
import typingsJapgolly.draftConvert.anon.Data
import typingsJapgolly.draftConvert.anon.Entity
import typingsJapgolly.draftConvert.draftConvertBooleans.`false`
import typingsJapgolly.draftJs.mod.ContentState
...
import typingsJapgolly.draftJs.mod.Draft.Model.Encoding.RawDraftEntityRange
import typingsJapgolly.draftJs.mod.Draft.Model.Encoding.RawDraftInlineStyleRange
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.draftConvert.anon.Empty
    - typingsJapgolly.draftConvert.anon.Element
  */
  type Tag = _Tag | Node
  ...
  object _Tag {
    ...
    inline def Element(): typingsJapgolly.draftConvert.anon.Element = {
      val __obj = js.Dynamic.literal(element = null)
      __obj.asInstanceOf[typingsJapgolly.draftConvert.anon.Element]
    }
    
    inline def Empty(end: String, start: String): typingsJapgolly.draftConvert.anon.Empty = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.draftConvert.anon.Empty]
    }
  }
}
