...
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.BeginTransactionResponse
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.ClientConfiguration
import typingsJapgolly.dataApiClient.anon.Database
import typingsJapgolly.dataApiClient.anon.DeserializeDate
import typingsJapgolly.dataApiClient.anon.HydrateColumnNames
import typingsJapgolly.dataApiClient.anon.InsertId
import typingsJapgolly.dataApiClient.anon.OmitBatchExecuteStatement
import typingsJapgolly.dataApiClient.anon.OmitCommitTransactionRequ
import typingsJapgolly.dataApiClient.anon.OmitExecuteStatementReque
import typingsJapgolly.dataApiClient.anon.OmitRollbackTransactionRe
import typingsJapgolly.dataApiClient.dataApiClientStrings.mysql
import typingsJapgolly.dataApiClient.dataApiClientStrings.pg
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dataApiClient.dataApiClientStrings.database
    - typingsJapgolly.dataApiClient.dataApiClientStrings.resourceArn
    - typingsJapgolly.dataApiClient.dataApiClientStrings.secretArn
    - typingsJapgolly.dataApiClient.dataApiClientStrings.schema
  */
  trait OmittedValues extends StObject
  object OmittedValues {
    
    inline def database: typingsJapgolly.dataApiClient.dataApiClientStrings.database = "database".asInstanceOf[typingsJapgolly.dataApiClient.dataApiClientStrings.database]
    
    inline def resourceArn: typingsJapgolly.dataApiClient.dataApiClientStrings.resourceArn = "resourceArn".asInstanceOf[typingsJapgolly.dataApiClient.dataApiClientStrings.resourceArn]
    
    inline def schema: typingsJapgolly.dataApiClient.dataApiClientStrings.schema = "schema".asInstanceOf[typingsJapgolly.dataApiClient.dataApiClientStrings.schema]
    
    inline def secretArn: typingsJapgolly.dataApiClient.dataApiClientStrings.secretArn = "secretArn".asInstanceOf[typingsJapgolly.dataApiClient.dataApiClientStrings.secretArn]
  }
