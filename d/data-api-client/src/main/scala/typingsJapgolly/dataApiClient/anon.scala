...
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.Id
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.RecordsFormatType
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.ResultSetOptions
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.SqlParameter
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.SqlParameterSets
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.SqlParametersList
import typingsJapgolly.awsSdk.clientsRdsdataserviceMod.SqlStatement
...
object anon {
  ...
  trait OmitExecuteStatementReque extends StObject {
    ...
    var continueAfterTimeout: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsdataserviceMod.Boolean] = js.undefined
    
    var formatRecordsAs: js.UndefOr[RecordsFormatType] = js.undefined
    
    var includeResultMetadata: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsdataserviceMod.Boolean] = js.undefined
  ...
  object OmitExecuteStatementReque {
    ...
    extension [Self <: OmitExecuteStatementReque](x: Self) {
      ...
      inline def setContinueAfterTimeout(value: typingsJapgolly.awsSdk.clientsRdsdataserviceMod.Boolean): Self = StObject.set(x, "continueAfterTimeout", value.asInstanceOf[js.Any])
      ...
      inline def setIncludeResultMetadata(value: typingsJapgolly.awsSdk.clientsRdsdataserviceMod.Boolean): Self = StObject.set(x, "includeResultMetadata", value.asInstanceOf[js.Any])
