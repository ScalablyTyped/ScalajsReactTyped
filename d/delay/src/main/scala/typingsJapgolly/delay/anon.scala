...
import typingsJapgolly.delay.mod.AbortSignal
...
object anon {
  ...
  object ClearTimeout {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(clearTimeout = js.Any.fromFunction1((t0: Any) => clearTimeout(t0).runNow()), setTimeout = js.Any.fromFunction3(setTimeout))
