...
import typingsJapgolly.dirCompare.buildSrcCompareAsyncMod.AsyncDiffSet
...
import typingsJapgolly.dirCompare.dirCompareBooleans.`false`
import typingsJapgolly.dirCompare.dirCompareBooleans.`true`
...
object buildSrcEntryEntryEqualityMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityAsyncSuccess
    - typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityAsyncError
  */
  trait FileEqualityAsync extends StObject
  object FileEqualityAsync {
    
    inline def FileEqualityAsyncError(error: Any): typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityAsyncError = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], hasErrors = true)
      __obj.asInstanceOf[typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityAsyncError]
    }
    
    inline def FileEqualityAsyncSuccess(context: FileEqualityAsyncContext, same: Boolean): typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityAsyncSuccess = {
      val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], hasErrors = false, same = same.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityAsyncSuccess]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityPromiseSync
    - typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityPromiseAsync
  */
  trait FileEqualityPromise extends StObject
  object FileEqualityPromise {
    
    inline def FileEqualityPromiseAsync(fileEqualityAsyncPromise: js.Promise[FileEqualityAsync]): typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityPromiseAsync = {
      val __obj = js.Dynamic.literal(fileEqualityAsyncPromise = fileEqualityAsyncPromise.asInstanceOf[js.Any], isSync = false)
      __obj.asInstanceOf[typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityPromiseAsync]
    }
    
    inline def FileEqualityPromiseSync(same: Boolean): typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityPromiseSync = {
      val __obj = js.Dynamic.literal(isSync = true, same = same.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.dirCompare.buildSrcEntryEntryEqualityMod.FileEqualityPromiseSync]
    }
  }
