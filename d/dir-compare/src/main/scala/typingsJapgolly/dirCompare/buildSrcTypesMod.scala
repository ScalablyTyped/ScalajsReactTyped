...
object buildSrcTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dirCompare.dirCompareStrings.equal
    - typingsJapgolly.dirCompare.dirCompareStrings.left
    - typingsJapgolly.dirCompare.dirCompareStrings.right
    - typingsJapgolly.dirCompare.dirCompareStrings.distinct
  */
  trait DifferenceState extends StObject
  object DifferenceState {
    
    inline def distinct: typingsJapgolly.dirCompare.dirCompareStrings.distinct = "distinct".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.distinct]
    
    inline def equal: typingsJapgolly.dirCompare.dirCompareStrings.equal = "equal".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.equal]
    
    inline def left: typingsJapgolly.dirCompare.dirCompareStrings.left = "left".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.left]
    
    inline def right: typingsJapgolly.dirCompare.dirCompareStrings.right = "right".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.right]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dirCompare.dirCompareStrings.missing
    - typingsJapgolly.dirCompare.dirCompareStrings.file
    - typingsJapgolly.dirCompare.dirCompareStrings.directory
    - typingsJapgolly.dirCompare.dirCompareStrings.`broken-link`
  */
  trait DifferenceType extends StObject
  object DifferenceType {
    
    inline def `broken-link`: typingsJapgolly.dirCompare.dirCompareStrings.`broken-link` = "broken-link".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.`broken-link`]
    
    inline def directory: typingsJapgolly.dirCompare.dirCompareStrings.directory = "directory".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.directory]
    
    inline def file: typingsJapgolly.dirCompare.dirCompareStrings.file = "file".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.file]
    
    inline def missing: typingsJapgolly.dirCompare.dirCompareStrings.missing = "missing".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.missing]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dirCompare.dirCompareStrings.`access-ok`
    - typingsJapgolly.dirCompare.dirCompareStrings.`access-error-both`
    - typingsJapgolly.dirCompare.dirCompareStrings.`access-error-left`
    - typingsJapgolly.dirCompare.dirCompareStrings.`access-error-right`
  */
  trait PermissionDeniedState extends StObject
  object PermissionDeniedState {
    
    inline def `access-error-both`: typingsJapgolly.dirCompare.dirCompareStrings.`access-error-both` = "access-error-both".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.`access-error-both`]
    
    inline def `access-error-left`: typingsJapgolly.dirCompare.dirCompareStrings.`access-error-left` = "access-error-left".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.`access-error-left`]
    
    inline def `access-error-right`: typingsJapgolly.dirCompare.dirCompareStrings.`access-error-right` = "access-error-right".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.`access-error-right`]
    
    inline def `access-ok`: typingsJapgolly.dirCompare.dirCompareStrings.`access-ok` = "access-ok".asInstanceOf[typingsJapgolly.dirCompare.dirCompareStrings.`access-ok`]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Unit
    - typingsJapgolly.dirCompare.dirCompareStrings.`different-size`
    - typingsJapgolly.dirCompare.dirCompareStrings.`different-date`
    - typingsJapgolly.dirCompare.dirCompareStrings.`different-content`
    - typingsJapgolly.dirCompare.dirCompareStrings.`broken-link`
    - typingsJapgolly.dirCompare.dirCompareStrings.`different-symlink`
    - typingsJapgolly.dirCompare.dirCompareStrings.`permission-denied`
  */
