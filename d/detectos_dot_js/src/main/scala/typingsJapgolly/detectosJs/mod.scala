...
object mod {
  ...
  object DetectOS {
    ...
    inline def apply(
      dataBrowser: CallbackTo[js.Array[PropertyData]],
      dataOS: CallbackTo[js.Array[PropertyData]],
      searchString: js.Array[PropertyData] => String | Null,
      searchVersion: String => Double | Null
    ): DetectOS = {
      val __obj = js.Dynamic.literal(dataBrowser = dataBrowser.toJsFn, dataOS = dataOS.toJsFn, searchString = js.Any.fromFunction1(searchString), searchVersion = js.Any.fromFunction1(searchVersion), OS = null, browser = null, version = null)
    ...
    extension [Self <: DetectOS](x: Self) {
      ...
      inline def setDataBrowser(value: CallbackTo[js.Array[PropertyData]]): Self = StObject.set(x, "dataBrowser", value.toJsFn)
      
      inline def setDataOS(value: CallbackTo[js.Array[PropertyData]]): Self = StObject.set(x, "dataOS", value.toJsFn)
