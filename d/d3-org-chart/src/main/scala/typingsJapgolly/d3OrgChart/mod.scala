package typingsJapgolly.d3OrgChart
...
import typingsJapgolly.d3OrgChart.anon.CenterX
import typingsJapgolly.d3OrgChart.anon.CenterY
import typingsJapgolly.d3OrgChart.anon.ChildrenMargin
import typingsJapgolly.d3OrgChart.anon.Ctx
import typingsJapgolly.d3OrgChart.anon.ExpandNodesFirst
import typingsJapgolly.d3OrgChart.anon.Full
import typingsJapgolly.d3OrgChart.anon.IsSvg
import typingsJapgolly.d3OrgChart.anon.K
import typingsJapgolly.d3OrgChart.anon.Node
import typingsJapgolly.d3OrgChart.anon.Nodes
import typingsJapgolly.d3OrgChart.anon.Params
import typingsJapgolly.d3OrgChart.anon.Reverse
import typingsJapgolly.d3OrgChart.anon.knumberPoint
import typingsJapgolly.d3OrgChart.anon.widthnumberheightnumberPo
import typingsJapgolly.d3OrgChart.anon.x0numbery0numberwidthnumb
import typingsJapgolly.d3OrgChart.d3OrgChartStrings.none
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.d3OrgChart.d3OrgChartStrings.left
    - typingsJapgolly.d3OrgChart.d3OrgChartStrings.bottom
    - typingsJapgolly.d3OrgChart.d3OrgChartStrings.right
    - typingsJapgolly.d3OrgChart.d3OrgChartStrings.top
  */
  trait Layout extends StObject
  object Layout {
    
    inline def bottom: typingsJapgolly.d3OrgChart.d3OrgChartStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.d3OrgChart.d3OrgChartStrings.bottom]
    
    inline def left: typingsJapgolly.d3OrgChart.d3OrgChartStrings.left = "left".asInstanceOf[typingsJapgolly.d3OrgChart.d3OrgChartStrings.left]
    
    inline def right: typingsJapgolly.d3OrgChart.d3OrgChartStrings.right = "right".asInstanceOf[typingsJapgolly.d3OrgChart.d3OrgChartStrings.right]
    
    inline def top: typingsJapgolly.d3OrgChart.d3OrgChartStrings.top = "top".asInstanceOf[typingsJapgolly.d3OrgChart.d3OrgChartStrings.top]
  }
