...
object DurandalViewEngineModule {
  ...
  extension [Self <: DurandalViewEngineModule](x: Self) {
    ...
    inline def setPutViewInCache(value: (String, HTMLElement) => Callback): Self = StObject.set(x, "putViewInCache", js.Any.fromFunction2((t0: String, t1: HTMLElement) => (value(t0, t1)).runNow()))
