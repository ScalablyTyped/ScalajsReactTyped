...
object compositionMod {
  ...
  object CompositionContext {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(activeView = activeView.asInstanceOf[js.Any], child = child.asInstanceOf[js.Any], composingNewView = composingNewView.asInstanceOf[js.Any], mode = mode.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any], triggerAttach = triggerAttach.toJsFn)
    ...
    extension [Self <: CompositionContext](x: Self) {
      ...
      inline def setAttached(value: (/* child */ HTMLElement, /* parent */ HTMLElement, CompositionContext) => Callback): Self = StObject.set(x, "attached", js.Any.fromFunction3((t0: /* child */ HTMLElement, t1: /* parent */ HTMLElement, t2: CompositionContext) => (value(t0, t1, t2)).runNow()))
      
      inline def setAttachedUndefined: Self = StObject.set(x, "attached", js.undefined)
      
      inline def setBinding(value: (/* child */ HTMLElement, /* parent */ HTMLElement, CompositionContext) => Callback): Self = StObject.set(x, "binding", js.Any.fromFunction3((t0: /* child */ HTMLElement, t1: /* parent */ HTMLElement, t2: CompositionContext) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setCompositionComplete(value: (/* child */ HTMLElement, /* parent */ HTMLElement, CompositionContext) => Callback): Self = StObject.set(x, "compositionComplete", js.Any.fromFunction3((t0: /* child */ HTMLElement, t1: /* parent */ HTMLElement, t2: CompositionContext) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setTriggerAttach(value: Callback): Self = StObject.set(x, "triggerAttach", value.toJsFn)
  ...
  object CompositionTransation {
    ...
    inline def apply(complete: js.Function => Callback): CompositionTransation = {
      val __obj = js.Dynamic.literal(complete = js.Any.fromFunction1((t0: js.Function) => complete(t0).runNow()))
      __obj.asInstanceOf[CompositionTransation]
    }
    
    extension [Self <: CompositionTransation](x: Self) {
      
      inline def setComplete(value: js.Function => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction1((t0: js.Function) => value(t0).runNow()))
    }
  }
}
