...
import typingsJapgolly.d3Color.anon.A
import typingsJapgolly.d3Color.anon.B
import typingsJapgolly.d3Color.anon.C
import typingsJapgolly.d3Color.anon.H
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.d3Color.mod.RGBColor
    - typingsJapgolly.d3Color.mod.HSLColor
    - typingsJapgolly.d3Color.mod.LabColor
    - typingsJapgolly.d3Color.mod.HCLColor
    - typingsJapgolly.d3Color.mod.CubehelixColor
  */
  ...
  object Color_ {
    ...
    inline def apply(
      displayable: CallbackTo[Boolean],
      formatHex: CallbackTo[String],
      formatHex8: CallbackTo[String],
      formatHsl: CallbackTo[String],
      formatRgb: CallbackTo[String],
      hex: CallbackTo[String]
    ): Color_ = {
      val __obj = js.Dynamic.literal(displayable = displayable.toJsFn, formatHex = formatHex.toJsFn, formatHex8 = formatHex8.toJsFn, formatHsl = formatHsl.toJsFn, formatRgb = formatRgb.toJsFn, hex = hex.toJsFn)
      __obj.asInstanceOf[Color_]
    }
    
    extension [Self <: Color_](x: Self) {
      
      inline def setDisplayable(value: CallbackTo[Boolean]): Self = StObject.set(x, "displayable", value.toJsFn)
      
      inline def setFormatHex(value: CallbackTo[String]): Self = StObject.set(x, "formatHex", value.toJsFn)
      
      inline def setFormatHex8(value: CallbackTo[String]): Self = StObject.set(x, "formatHex8", value.toJsFn)
      
      inline def setFormatHsl(value: CallbackTo[String]): Self = StObject.set(x, "formatHsl", value.toJsFn)
      
      inline def setFormatRgb(value: CallbackTo[String]): Self = StObject.set(x, "formatRgb", value.toJsFn)
