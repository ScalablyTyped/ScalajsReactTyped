...
import typingsJapgolly.dygraphs.anon.ErrorPlotter
import typingsJapgolly.dygraphs.anon.Idx
import typingsJapgolly.dygraphs.anon.Label
import typingsJapgolly.dygraphs.anon.PartialRecordAxisPerAxisO
import typingsJapgolly.dygraphs.anon.ReadonlyAnnotation
import typingsJapgolly.dygraphs.anon.ReadonlyArea
import typingsJapgolly.dygraphs.anon.ReadonlyDygraph
import typingsJapgolly.dygraphs.anon.ReadonlyDygraphAdjustRoll
import typingsJapgolly.dygraphs.anon.ReadonlyPoint
import typingsJapgolly.dygraphs.dygraphsBooleans.`false`
import typingsJapgolly.dygraphs.dygraphsStrings._empty
import typingsJapgolly.dygraphs.dygraphsStrings.all
import typingsJapgolly.dygraphs.dygraphsStrings.always
import typingsJapgolly.dygraphs.dygraphsStrings.follow
import typingsJapgolly.dygraphs.dygraphsStrings.inside
import typingsJapgolly.dygraphs.dygraphsStrings.never
import typingsJapgolly.dygraphs.dygraphsStrings.none
...
import typingsJapgolly.dygraphs.mod.dygraphs.Annotation
import typingsJapgolly.dygraphs.mod.dygraphs.Area
import typingsJapgolly.dygraphs.mod.dygraphs.Data
import typingsJapgolly.dygraphs.mod.dygraphs.Options
import typingsJapgolly.dygraphs.mod.dygraphs.SeriesProperties
import typingsJapgolly.googleVisualization.google.visualization.DataTable
...
object mod {
  ...
  object dygraphs {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.dygraphs.dygraphsStrings.x
      - typingsJapgolly.dygraphs.dygraphsStrings.y
      - typingsJapgolly.dygraphs.dygraphsStrings.y2
    */
    trait Axis extends StObject
    object Axis {
      
      inline def x: typingsJapgolly.dygraphs.dygraphsStrings.x = "x".asInstanceOf[typingsJapgolly.dygraphs.dygraphsStrings.x]
      
      inline def y: typingsJapgolly.dygraphs.dygraphsStrings.y = "y".asInstanceOf[typingsJapgolly.dygraphs.dygraphsStrings.y]
      
      inline def y2: typingsJapgolly.dygraphs.dygraphsStrings.y2 = "y2".asInstanceOf[typingsJapgolly.dygraphs.dygraphsStrings.y2]
    }
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setClickCallback(value: (/* event */ MouseEvent, /* xval */ Double, /* points */ js.Array[Point]) => Callback): Self = StObject.set(x, "clickCallback", js.Any.fromFunction3((t0: /* event */ MouseEvent, t1: /* xval */ Double, t2: /* points */ js.Array[Point]) => (value(t0, t1, t2)).runNow()))
        ...
        inline def setDrawCallback(value: (/* dygraph */ ReadonlyDygraphAdjustRoll, /* is_initial */ Boolean) => Callback): Self = StObject.set(x, "drawCallback", js.Any.fromFunction2((t0: /* dygraph */ ReadonlyDygraphAdjustRoll, t1: /* is_initial */ Boolean) => (value(t0, t1)).runNow()))
        ...
        inline def setHighlightCallback(
          value: (/* event */ MouseEvent, /* xval */ Double, /* points */ js.Array[Point], /* row */ Double, /* seriesName */ String) => Callback
        ): Self = StObject.set(x, "highlightCallback", js.Any.fromFunction5((t0: /* event */ MouseEvent, t1: /* xval */ Double, t2: /* points */ js.Array[Point], t3: /* row */ Double, t4: /* seriesName */ String) => (value(t0, t1, t2, t3, t4)).runNow()))
        ...
        inline def setPointClickCallback(value: (/* event */ MouseEvent, /* point */ ReadonlyPoint) => Callback): Self = StObject.set(x, "pointClickCallback", js.Any.fromFunction2((t0: /* event */ MouseEvent, t1: /* point */ ReadonlyPoint) => (value(t0, t1)).runNow()))
        ...
        inline def setUnderlayCallback(
          value: (/* context */ CanvasRenderingContext2D, /* area */ ReadonlyArea, /* dygraph */ ReadonlyDygraphAdjustRoll) => Callback
        ): Self = StObject.set(x, "underlayCallback", js.Any.fromFunction3((t0: /* context */ CanvasRenderingContext2D, t1: /* area */ ReadonlyArea, t2: /* dygraph */ ReadonlyDygraphAdjustRoll) => (value(t0, t1, t2)).runNow()))
        ...
        inline def setUnhighlightCallback(value: /* event */ MouseEvent => Callback): Self = StObject.set(x, "unhighlightCallback", js.Any.fromFunction1((t0: /* event */ MouseEvent) => value(t0).runNow()))
        ...
        inline def setZoomCallback(
          value: (/* minDate */ Double, /* maxDate */ Double, /* yRanges */ js.Array[js.Tuple2[Double, Double]]) => Callback
        ): Self = StObject.set(x, "zoomCallback", js.Any.fromFunction3((t0: /* minDate */ Double, t1: /* maxDate */ Double, t2: /* yRanges */ js.Array[js.Tuple2[Double, Double]]) => (value(t0, t1, t2)).runNow()))
