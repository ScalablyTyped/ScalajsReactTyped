...
import typingsJapgolly.dygraphs.mod.Dygraph
import typingsJapgolly.dygraphs.mod.dygraphs.Annotation
import typingsJapgolly.dygraphs.mod.dygraphs.AnnotationClickHandler
import typingsJapgolly.dygraphs.mod.dygraphs.AnnotationDblClickHandler
import typingsJapgolly.dygraphs.mod.dygraphs.AnnotationMouseOutHandler
import typingsJapgolly.dygraphs.mod.dygraphs.AnnotationMouseOverHandler
import typingsJapgolly.dygraphs.mod.dygraphs.Area
import typingsJapgolly.dygraphs.mod.dygraphs.Options
import typingsJapgolly.dygraphs.mod.dygraphs.PerAxisOptions
...
object anon {
  ...
  object ErrorPlotter {
    ...
    inline def apply(errorPlotter: Any => Callback, fillPlotter: Any => Callback, linePlotter: Any => Callback): ErrorPlotter = {
      val __obj = js.Dynamic.literal(errorPlotter = js.Any.fromFunction1((t0: Any) => errorPlotter(t0).runNow()), fillPlotter = js.Any.fromFunction1((t0: Any) => fillPlotter(t0).runNow()), linePlotter = js.Any.fromFunction1((t0: Any) => linePlotter(t0).runNow()))
      __obj.asInstanceOf[ErrorPlotter]
    }
    
    extension [Self <: ErrorPlotter](x: Self) {
      
      inline def setErrorPlotter(value: Any => Callback): Self = StObject.set(x, "errorPlotter", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def setFillPlotter(value: Any => Callback): Self = StObject.set(x, "fillPlotter", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def setLinePlotter(value: Any => Callback): Self = StObject.set(x, "linePlotter", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
