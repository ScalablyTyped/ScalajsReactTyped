...
object CalendarObjectOptions {
  ...
  def apply(
    ...
    constructor: /* options */ js.UndefOr[CalendarObjectOptions] => CallbackTo[js.Any] = null,
    data: String = null,
    etag: String = null,
    url: String = null
    ...
    if (constructor != null) __obj.updateDynamic("constructor")(js.Any.fromFunction1((t0: /* options */ js.UndefOr[typingsJapgolly.dav.mod.CalendarObjectOptions]) => constructor(t0).runNow()))
