...
object CredentialsOptions {
  ...
  def apply(
    ...
    constructor: /* options */ js.UndefOr[CredentialsOptions] => CallbackTo[js.Any] = null,
    ...
    if (constructor != null) __obj.updateDynamic("constructor")(js.Any.fromFunction1((t0: /* options */ js.UndefOr[typingsJapgolly.dav.mod.CredentialsOptions]) => constructor(t0).runNow()))
