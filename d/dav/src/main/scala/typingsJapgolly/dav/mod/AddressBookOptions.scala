...
object AddressBookOptions {
  ...
  def apply(
    ...
    constructor: /* options */ js.UndefOr[AddressBookOptions] => CallbackTo[js.Any] = null,
    ctag: String = null,
    data: String = null,
    ...
    if (constructor != null) __obj.updateDynamic("constructor")(js.Any.fromFunction1((t0: /* options */ js.UndefOr[typingsJapgolly.dav.mod.AddressBookOptions]) => constructor(t0).runNow()))
