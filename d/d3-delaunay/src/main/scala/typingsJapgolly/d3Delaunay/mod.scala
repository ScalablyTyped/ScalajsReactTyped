package typingsJapgolly.d3Delaunay

import japgolly.scalajs.react.Callback
import typingsJapgolly.d3Delaunay.anon.Polygonindexnumber
import typingsJapgolly.d3Delaunay.mod.Delaunay.ArcContext
import typingsJapgolly.d3Delaunay.mod.Delaunay.Bounds
import typingsJapgolly.d3Delaunay.mod.Delaunay.ClosableContext
import typingsJapgolly.d3Delaunay.mod.Delaunay.LineContext
import typingsJapgolly.d3Delaunay.mod.Delaunay.MoveContext
import typingsJapgolly.d3Delaunay.mod.Delaunay.Polygon
import typingsJapgolly.d3Delaunay.mod.Delaunay.RectContext
import typingsJapgolly.d3Delaunay.mod.Delaunay.Triangle
...
object mod {
  ...
  object Delaunay {
    ...
    object ClosableContext {
      ...
      inline def apply(closePath: Callback): ClosableContext = {
        val __obj = js.Dynamic.literal(closePath = closePath.toJsFn)
    ...
    object LineContext {
      ...
      inline def apply(lineTo: (Double, Double) => Callback): LineContext = {
        val __obj = js.Dynamic.literal(lineTo = js.Any.fromFunction2((t0: Double, t1: Double) => (lineTo(t0, t1)).runNow()))
    ...
    object MoveContext {
      ...
      inline def apply(moveTo: (Double, Double) => Callback): MoveContext = {
        val __obj = js.Dynamic.literal(moveTo = js.Any.fromFunction2((t0: Double, t1: Double) => (moveTo(t0, t1)).runNow()))
    ...
    object RectContext {
      ...
      inline def apply(rect: (Double, Double, Double, Double) => Callback): RectContext = {
        val __obj = js.Dynamic.literal(rect = js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: Double) => (rect(t0, t1, t2, t3)).runNow()))
