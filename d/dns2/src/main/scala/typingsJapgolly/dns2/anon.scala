package typingsJapgolly.dns2

import japgolly.scalajs.react.Callback
import typingsJapgolly.dns2.mod.DnsHandler
import typingsJapgolly.dns2.mod.DnsRequest
import typingsJapgolly.dns2.mod.DnsResponse
import typingsJapgolly.node.dgramMod.RemoteInfo
import typingsJapgolly.node.netMod.AddressInfo
...
object anon {
  ...
  object Handle {
    ...
    inline def apply(
      handle: (/* request */ DnsRequest, /* sendResponse */ js.Function1[/* response */ DnsResponse, Unit], /* remoteInfo */ RemoteInfo) => Callback
    ): Handle = {
      val __obj = js.Dynamic.literal(handle = js.Any.fromFunction3((t0: /* request */ DnsRequest, t1: /* sendResponse */ js.Function1[/* response */ DnsResponse, Unit], t2: /* remoteInfo */ RemoteInfo) => (handle(t0, t1, t2)).runNow()))
    ...
    extension [Self <: Handle](x: Self) {
      ...
      inline def setHandle(
        value: (/* request */ DnsRequest, /* sendResponse */ js.Function1[/* response */ DnsResponse, Unit], /* remoteInfo */ RemoteInfo) => Callback
      ): Self = StObject.set(x, "handle", js.Any.fromFunction3((t0: /* request */ DnsRequest, t1: /* sendResponse */ js.Function1[/* response */ DnsResponse, Unit], t2: /* remoteInfo */ RemoteInfo) => (value(t0, t1, t2)).runNow()))
