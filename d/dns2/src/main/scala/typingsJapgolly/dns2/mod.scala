...
import typingsJapgolly.dns2.anon.Doh
import typingsJapgolly.dns2.anon.Handle
import typingsJapgolly.dns2.anon.Id
import typingsJapgolly.dns2.anon.Tcp
...
object mod {
  ...
  object Packet {
    ...
    inline def apply(toBuffer: CallbackTo[Buffer]): Packet = {
