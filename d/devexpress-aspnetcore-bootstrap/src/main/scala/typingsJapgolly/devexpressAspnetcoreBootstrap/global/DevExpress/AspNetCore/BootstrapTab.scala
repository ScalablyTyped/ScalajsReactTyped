...
@js.native
open class BootstrapTab protected ()
  extends StObject
     with typingsJapgolly.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapTab {
  ...
  /* CompleteClass */
  override val tabControl: typingsJapgolly.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapTabControl | Null = js.native
}
