...
open class BootstrapMenuItem protected ()
  extends StObject
     with typingsJapgolly.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapMenuItem {
  ...
  /* CompleteClass */
  override def getItem(index: Double): typingsJapgolly.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapMenuItem | Null = js.native
  
  /* CompleteClass */
  override def getItemByName(name: String): typingsJapgolly.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapMenuItem | Null = js.native
  ...
  /* CompleteClass */
  override val menu: typingsJapgolly.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapMenu | Null = js.native
  
  /* CompleteClass */
  override val name: String = js.native
  
  /* CompleteClass */
  override val parent: typingsJapgolly.devexpressAspnetcoreBootstrap.DevExpress.AspNetCore.BootstrapMenuItem | Null = js.native
