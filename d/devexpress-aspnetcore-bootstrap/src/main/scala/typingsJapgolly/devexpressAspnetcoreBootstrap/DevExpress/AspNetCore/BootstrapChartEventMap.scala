...
object BootstrapChartEventMap {
  ...
  extension [Self <: BootstrapChartEventMap](x: Self) {
    ...
    inline def setZoomEnd(value: BootstrapChartZoomEndEventArgs): Self = StObject.set(x, "zoomEnd", value.asInstanceOf[js.Any])
    
    inline def setZoomStart(value: BootstrapChartEventArgsBase): Self = StObject.set(x, "zoomStart", value.asInstanceOf[js.Any])
  }
}
