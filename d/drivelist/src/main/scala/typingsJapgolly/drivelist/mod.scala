package typingsJapgolly.drivelist
...
object mod {
  ...
  */
  ...
  object BusType {
    ...
    inline def ATA: typingsJapgolly.drivelist.drivelistStrings.ATA = "ATA".asInstanceOf[typingsJapgolly.drivelist.drivelistStrings.ATA]
    
    inline def IDE: typingsJapgolly.drivelist.drivelistStrings.IDE = "IDE".asInstanceOf[typingsJapgolly.drivelist.drivelistStrings.IDE]
    
    inline def PCI: typingsJapgolly.drivelist.drivelistStrings.PCI = "PCI".asInstanceOf[typingsJapgolly.drivelist.drivelistStrings.PCI]
    
    inline def SATA: typingsJapgolly.drivelist.drivelistStrings.SATA = "SATA".asInstanceOf[typingsJapgolly.drivelist.drivelistStrings.SATA]
    
    inline def SCSI: typingsJapgolly.drivelist.drivelistStrings.SCSI = "SCSI".asInstanceOf[typingsJapgolly.drivelist.drivelistStrings.SCSI]
    
    inline def UNKNOWN: typingsJapgolly.drivelist.drivelistStrings.UNKNOWN = "UNKNOWN".asInstanceOf[typingsJapgolly.drivelist.drivelistStrings.UNKNOWN]
  }
