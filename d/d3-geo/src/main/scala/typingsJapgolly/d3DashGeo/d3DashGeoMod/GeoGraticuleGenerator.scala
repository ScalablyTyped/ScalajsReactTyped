...
import typingsJapgolly.geojson.geojsonMod.LineString
import typingsJapgolly.geojson.geojsonMod.MultiLineString
import typingsJapgolly.geojson.geojsonMod.Polygon
