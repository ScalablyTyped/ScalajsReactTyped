...
object pluginIsoWeekMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dayjs.dayjsStrings.isoWeek
  ...
  */
  ...
  object ISOUnitType {
    ...
    inline def isoWeek: typingsJapgolly.dayjs.dayjsStrings.isoWeek = "isoWeek".asInstanceOf[typingsJapgolly.dayjs.dayjsStrings.isoWeek]
