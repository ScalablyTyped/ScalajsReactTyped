...
trait AnonDropInsideItemElement extends js.Object {
...
object AnonDropInsideItemElement {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonDropInsideItemElement]
  }
}
