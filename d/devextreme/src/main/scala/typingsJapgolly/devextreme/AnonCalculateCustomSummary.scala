...
object AnonCalculateCustomSummary {
  @scala.inline
  def apply(
    calculateCustomSummary: /* options */ AnonTotalValue => CallbackTo[js.Any] = null,
    ...
    if (calculateCustomSummary != null) __obj.updateDynamic("calculateCustomSummary")(js.Any.fromFunction1((t0: /* options */ typingsJapgolly.devextreme.AnonTotalValue) => calculateCustomSummary(t0).runNow()))
