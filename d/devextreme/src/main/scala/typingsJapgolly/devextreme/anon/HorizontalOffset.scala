...
trait HorizontalOffset extends StObject {
  ...
  /**
    ...
    */
  var overlappingBehavior: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.charts.TextOverflow] = js.undefined
...
object HorizontalOffset {
  ...
  extension [Self <: HorizontalOffset](x: Self) {
    ...
    inline def setOverlappingBehavior(value: typingsJapgolly.devextreme.mod.DevExpress.common.charts.TextOverflow): Self = StObject.set(x, "overlappingBehavior", value.asInstanceOf[js.Any])
