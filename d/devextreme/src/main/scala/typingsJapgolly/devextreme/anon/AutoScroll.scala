...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentDraggingAddEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentDraggingEndEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentDraggingMoveEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentDraggingRemoveEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentDraggingStartEvent
...
object AutoScroll {
  ...
  extension [Self <: AutoScroll](x: Self) {
    ...
    inline def setOnAdd(value: /* e */ AppointmentDraggingAddEvent => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction1((t0: /* e */ AppointmentDraggingAddEvent) => value(t0).runNow()))
    
    inline def setOnAddUndefined: Self = StObject.set(x, "onAdd", js.undefined)
    
    inline def setOnDragEnd(value: /* e */ AppointmentDraggingEndEvent => Callback): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1((t0: /* e */ AppointmentDraggingEndEvent) => value(t0).runNow()))
    
    inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
    
    inline def setOnDragMove(value: /* e */ AppointmentDraggingMoveEvent => Callback): Self = StObject.set(x, "onDragMove", js.Any.fromFunction1((t0: /* e */ AppointmentDraggingMoveEvent) => value(t0).runNow()))
    
    inline def setOnDragMoveUndefined: Self = StObject.set(x, "onDragMove", js.undefined)
    
    inline def setOnDragStart(value: /* e */ AppointmentDraggingStartEvent => Callback): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: /* e */ AppointmentDraggingStartEvent) => value(t0).runNow()))
    
    inline def setOnDragStartUndefined: Self = StObject.set(x, "onDragStart", js.undefined)
    
    inline def setOnRemove(value: /* e */ AppointmentDraggingRemoveEvent => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* e */ AppointmentDraggingRemoveEvent) => value(t0).runNow()))
