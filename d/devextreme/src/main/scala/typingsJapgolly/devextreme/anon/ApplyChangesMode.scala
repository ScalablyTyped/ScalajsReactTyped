...
trait ApplyChangesMode extends StObject {
  ...
  /**
    ...
    */
  var applyChangesMode: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.charts.ApplyChangesMode] = js.undefined
...
object ApplyChangesMode {
  ...
  extension [Self <: ApplyChangesMode](x: Self) {
    ...
    inline def setApplyChangesMode(value: typingsJapgolly.devextreme.mod.DevExpress.common.charts.ApplyChangesMode): Self = StObject.set(x, "applyChangesMode", value.asInstanceOf[js.Any])
