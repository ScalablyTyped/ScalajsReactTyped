...
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.VectorMapLayerType
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.VectorMapMarkerType
...
object BorderWidth {
  ...
  extension [Self <: BorderWidth](x: Self) {
    ...
    inline def setCustomize(value: /* elements */ js.Array[MapLayerElement] => Callback): Self = StObject.set(x, "customize", js.Any.fromFunction1((t0: /* elements */ js.Array[MapLayerElement]) => value(t0).runNow()))
