...
trait ArgumentFormat extends StObject {
  ...
  /**
    ...
    */
  var argumentFormat: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.ui.Format] = js.undefined
...
object ArgumentFormat {
  ...
  extension [Self <: ArgumentFormat](x: Self) {
    ...
    inline def setArgumentFormat(value: typingsJapgolly.devextreme.mod.DevExpress.ui.Format): Self = StObject.set(x, "argumentFormat", value.asInstanceOf[js.Any])
