...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxForm.LabelLocation
...
trait Alignment extends StObject {
  ...
  /**
    ...
    */
  var alignment: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.HorizontalAlignment] = js.undefined
...
object Alignment {
  ...
  extension [Self <: Alignment](x: Self) {
    ...
    inline def setAlignment(value: typingsJapgolly.devextreme.mod.DevExpress.common.HorizontalAlignment): Self = StObject.set(x, "alignment", value.asInstanceOf[js.Any])
