...
trait X extends StObject {
  ...
  /**
    ...
    */
  var x: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.HorizontalAlignment] = js.undefined
...
object X {
  ...
  extension [Self <: X](x: Self) {
    ...
    inline def setX(value: typingsJapgolly.devextreme.mod.DevExpress.common.HorizontalAlignment): Self = StObject.set(x, "x", value.asInstanceOf[js.Any])
