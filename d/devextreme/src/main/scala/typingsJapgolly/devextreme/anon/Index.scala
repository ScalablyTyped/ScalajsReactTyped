...
import typingsJapgolly.devextreme.devextremeStrings.insert
import typingsJapgolly.devextreme.devextremeStrings.remove
import typingsJapgolly.devextreme.devextremeStrings.update
