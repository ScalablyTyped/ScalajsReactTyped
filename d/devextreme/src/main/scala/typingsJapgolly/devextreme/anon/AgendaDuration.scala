...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxScheduler.AppointmentTooltipTemplateData
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxSchedulerScrolling
...
trait AgendaDuration extends StObject {
  ...
  var appointmentCollectorTemplate: js.UndefOr[
    template | (js.Function2[
      ...
      String | UserDefinedElement[org.scalajs.dom.Element]
    ])
  ] = js.undefined
  ...
  /**
    ...
    */
  var groupOrientation: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.Orientation] = js.undefined
...
object AgendaDuration {
  ...
  extension [Self <: AgendaDuration](x: Self) {
    ...
    inline def setAppointmentCollectorTemplateFunction2(
      value: (/* data */ AppointmentCollectorTemplateData, /* collectorElement */ DxElement_[HTMLElement]) => String | UserDefinedElement[org.scalajs.dom.Element]
    ...
    inline def setAppointmentTemplateFunction3(
      value: (/* model */ AppointmentTemplateData, /* itemIndex */ Double, /* contentElement */ DxElement_[HTMLElement]) => String | UserDefinedElement[org.scalajs.dom.Element]
    ...
    inline def setAppointmentTooltipTemplateFunction3(
      value: (/* model */ AppointmentTooltipTemplateData, /* itemIndex */ Double, /* contentElement */ DxElement_[HTMLElement]) => String | UserDefinedElement[org.scalajs.dom.Element]
    ...
    inline def setDataCellTemplateFunction3(
      value: (/* itemData */ Any, /* itemIndex */ Double, /* itemElement */ DxElement_[HTMLElement]) => String | UserDefinedElement[org.scalajs.dom.Element]
    ...
    inline def setDropDownAppointmentTemplateFunction3(
      value: (/* itemData */ Any, /* itemIndex */ Double, /* contentElement */ DxElement_[HTMLElement]) => String | UserDefinedElement[org.scalajs.dom.Element]
    ...
    inline def setGroupOrientation(value: typingsJapgolly.devextreme.mod.DevExpress.common.Orientation): Self = StObject.set(x, "groupOrientation", value.asInstanceOf[js.Any])
