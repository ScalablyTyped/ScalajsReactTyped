...
trait Percent extends StObject {
  ...
  var item: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.viz.dxFunnel.Item] = js.undefined
...
object Percent {
  ...
  extension [Self <: Percent](x: Self) {
    ...
    inline def setItem(value: typingsJapgolly.devextreme.mod.DevExpress.viz.dxFunnel.Item): Self = StObject.set(x, "item", value.asInstanceOf[js.Any])
