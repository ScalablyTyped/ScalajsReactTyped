...
trait ColorOffset extends StObject {
  ...
  /**
    ...
    */
  var position: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.Position] = js.undefined
...
object ColorOffset {
  ...
  extension [Self <: ColorOffset](x: Self) {
    ...
    inline def setPosition(value: typingsJapgolly.devextreme.mod.DevExpress.common.Position): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
