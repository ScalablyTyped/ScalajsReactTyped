...
trait Field extends StObject {
  ...
  var field: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.Field] = js.undefined
...
object Field {
  ...
  extension [Self <: Field](x: Self) {
    ...
    inline def setField(value: typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.Field): Self = StObject.set(x, "field", value.asInstanceOf[js.Any])
