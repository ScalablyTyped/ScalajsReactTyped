...
trait Row[TRowData, TKey] extends StObject {
  ...
  val column: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Column[TRowData, TKey]
...
object Row {
  ...
  inline def apply[TRowData, TKey](
    column: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Column[TRowData, TKey],
  ...
  extension [Self <: Row[?, ?], TRowData, TKey](x: Self & (Row[TRowData, TKey])) {
    ...
    inline def setColumn(value: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Column[TRowData, TKey]): Self = StObject.set(x, "column", value.asInstanceOf[js.Any])
