...
trait BaseSize extends StObject {
  ...
  /**
    ...
    */
  var baseSize: js.UndefOr[Double | typingsJapgolly.devextreme.mod.DevExpress.common.Mode] = js.undefined
...
object BaseSize {
  ...
  extension [Self <: BaseSize](x: Self) {
    ...
    inline def setBaseSize(value: Double | typingsJapgolly.devextreme.mod.DevExpress.common.Mode): Self = StObject.set(x, "baseSize", value.asInstanceOf[js.Any])
