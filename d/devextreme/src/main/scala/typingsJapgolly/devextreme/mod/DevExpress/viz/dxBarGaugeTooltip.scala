...
import typingsJapgolly.devextreme.AnonIndex
...
object dxBarGaugeTooltip {
  ...
  def apply(
    ...
    contentTemplate: template | (js.Function2[/* scaleValue */ AnonIndex, /* element */ dxElement, String | Element | JQuery]) = null,
    cornerRadius: Int | Double = null,
    customizeTooltip: /* scaleValue */ AnonIndex => CallbackTo[js.Any] = null,
    ...
    if (customizeTooltip != null) __obj.updateDynamic("customizeTooltip")(js.Any.fromFunction1((t0: /* scaleValue */ typingsJapgolly.devextreme.AnonIndex) => customizeTooltip(t0).runNow()))
