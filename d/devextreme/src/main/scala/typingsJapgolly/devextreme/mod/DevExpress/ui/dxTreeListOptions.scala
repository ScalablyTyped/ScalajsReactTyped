...
import typingsJapgolly.devextreme.anon.Grouping
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.CellClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.CellDblClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.CellHoverChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.CellPreparedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Column
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.ContextMenuPreparingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Editing
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.EditingStartEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.EditorPreparedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.EditorPreparingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.FocusedCellChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.FocusedCellChangingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.FocusedRowChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.FocusedRowChangingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.NodesInitializedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Paging
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.RowClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.RowDblClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.RowPreparedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Scrolling
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Selection
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.Toolbar
...
object dxTreeListOptions {
  ...
  extension [Self <: dxTreeListOptions[?, ?], TRowData, TKey](x: Self & (dxTreeListOptions[TRowData, TKey])) {
    ...
    inline def setOnNodesInitialized(value: /* e */ NodesInitializedEvent[TRowData, TKey] => Callback): Self = StObject.set(x, "onNodesInitialized", js.Any.fromFunction1((t0: /* e */ NodesInitializedEvent[TRowData, TKey]) => value(t0).runNow()))
