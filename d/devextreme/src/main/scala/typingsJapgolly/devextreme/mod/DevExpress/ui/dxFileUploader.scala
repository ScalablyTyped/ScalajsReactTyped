...
object dxFileUploader {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.instantly
    - typingsJapgolly.devextreme.devextremeStrings.useButtons
    - typingsJapgolly.devextreme.devextremeStrings.useForm
  */
  trait FileUploadMode extends StObject
  object FileUploadMode {
    
    inline def instantly: typingsJapgolly.devextreme.devextremeStrings.instantly = "instantly".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.instantly]
    
    inline def useButtons: typingsJapgolly.devextreme.devextremeStrings.useButtons = "useButtons".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.useButtons]
    
    inline def useForm: typingsJapgolly.devextreme.devextremeStrings.useForm = "useForm".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.useForm]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.devextreme.devextremeStrings.PUT
  */
  ...
  object UploadHttpMethod {
    ...
    inline def PUT: typingsJapgolly.devextreme.devextremeStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.PUT]
  }
