...
import typingsJapgolly.devextreme.anon.FormData
import typingsJapgolly.devextreme.anon.`3`
...
object fileManagement {
  ...
  object CustomFileSystemProviderOptions {
    ...
    extension [Self <: CustomFileSystemProviderOptions](x: Self) {
      ...
      inline def setDownloadItems(value: /* items */ js.Array[FileSystemItem] => Callback): Self = StObject.set(x, "downloadItems", js.Any.fromFunction1((t0: /* items */ js.Array[FileSystemItem]) => value(t0).runNow()))
  ...
  object FileSystemItem {
    ...
    inline def apply(
      ...
      getFileExtension: CallbackTo[String],
    ...
    extension [Self <: FileSystemItem](x: Self) {
      ...
      inline def setGetFileExtension(value: CallbackTo[String]): Self = StObject.set(x, "getFileExtension", value.toJsFn)
  ...
  object FileSystemProviderBase {
    ...
    inline def apply(
      ...
      downloadItems: js.Array[FileSystemItem] => Callback,
    ...
    extension [Self <: FileSystemProviderBase](x: Self) {
      ...
      inline def setDownloadItems(value: js.Array[FileSystemItem] => Callback): Self = StObject.set(x, "downloadItems", js.Any.fromFunction1((t0: js.Array[FileSystemItem]) => value(t0).runNow()))
  ...
  object RemoteFileSystemProviderOptions {
    ...
    extension [Self <: RemoteFileSystemProviderOptions](x: Self) {
      ...
      inline def setBeforeAjaxSend(value: /* options */ FormData => Callback): Self = StObject.set(x, "beforeAjaxSend", js.Any.fromFunction1((t0: /* options */ FormData) => value(t0).runNow()))
      
      inline def setBeforeAjaxSendUndefined: Self = StObject.set(x, "beforeAjaxSend", js.undefined)
      
      inline def setBeforeSubmit(value: /* options */ `3` => Callback): Self = StObject.set(x, "beforeSubmit", js.Any.fromFunction1((t0: /* options */ `3`) => value(t0).runNow()))
