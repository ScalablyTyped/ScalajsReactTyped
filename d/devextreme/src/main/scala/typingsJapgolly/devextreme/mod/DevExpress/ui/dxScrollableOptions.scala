...
object dxScrollableOptions {
  ...
  extension [Self <: dxScrollableOptions[?], TComponent](x: Self & dxScrollableOptions[TComponent]) {
    ...
    inline def setOnScroll(value: /* e */ ScrollEventInfo[TComponent] => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: /* e */ ScrollEventInfo[TComponent]) => value(t0).runNow()))
    
    inline def setOnScrollUndefined: Self = StObject.set(x, "onScroll", js.undefined)
    
    inline def setOnUpdated(value: /* e */ ScrollEventInfo[TComponent] => Callback): Self = StObject.set(x, "onUpdated", js.Any.fromFunction1((t0: /* e */ ScrollEventInfo[TComponent]) => value(t0).runNow()))
