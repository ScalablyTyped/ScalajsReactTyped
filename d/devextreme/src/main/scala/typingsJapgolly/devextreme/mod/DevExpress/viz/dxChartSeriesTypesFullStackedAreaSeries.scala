...
object dxChartSeriesTypesFullStackedAreaSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesFullStackedAreaSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesFullStackedAreaSeriesLabel = null,
    ...
    pane: String = null,
    point: dxChartSeriesTypesFullStackedAreaSeriesPoint = null,
  ...
  ): dxChartSeriesTypesFullStackedAreaSeries = {
