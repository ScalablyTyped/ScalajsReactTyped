...
import typingsJapgolly.devextreme.mod.DevExpress.common.DataStructure
import typingsJapgolly.devextreme.mod.DevExpress.common.ScrollDirection
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.ItemClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.ItemCollapsedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.ItemContextMenuEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.ItemExpandedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.ItemHoldEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.ItemRenderedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.ItemSelectionChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.Node
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.SelectAllValueChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.SelectionChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.TreeViewCheckBoxMode
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeView.TreeViewExpandEvent
...
object dxTreeViewOptions {
  ...
  extension [Self <: dxTreeViewOptions[?], TKey](x: Self & dxTreeViewOptions[TKey]) {
    ...
    inline def setOnContentReady(value: /* e */ EventInfo[dxTreeView[TKey]] => Callback): Self = StObject.set(x, "onContentReady", js.Any.fromFunction1((t0: /* e */ EventInfo[dxTreeView[TKey]]) => value(t0).runNow()))
    
    inline def setOnContentReadyUndefined: Self = StObject.set(x, "onContentReady", js.undefined)
    
    inline def setOnDisposing(value: /* e */ EventInfo[dxTreeView[TKey]] => Callback): Self = StObject.set(x, "onDisposing", js.Any.fromFunction1((t0: /* e */ EventInfo[dxTreeView[TKey]]) => value(t0).runNow()))
    
    inline def setOnDisposingUndefined: Self = StObject.set(x, "onDisposing", js.undefined)
    
    inline def setOnInitialized(value: /* e */ InitializedEventInfo[dxTreeView[TKey]] => Callback): Self = StObject.set(x, "onInitialized", js.Any.fromFunction1((t0: /* e */ InitializedEventInfo[dxTreeView[TKey]]) => value(t0).runNow()))
    
    inline def setOnInitializedUndefined: Self = StObject.set(x, "onInitialized", js.undefined)
    
    inline def setOnItemClick(value: /* e */ ItemClickEvent[TKey] => Callback): Self = StObject.set(x, "onItemClick", js.Any.fromFunction1((t0: /* e */ ItemClickEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnItemClickUndefined: Self = StObject.set(x, "onItemClick", js.undefined)
    
    inline def setOnItemCollapsed(value: /* e */ ItemCollapsedEvent[TKey] => Callback): Self = StObject.set(x, "onItemCollapsed", js.Any.fromFunction1((t0: /* e */ ItemCollapsedEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnItemCollapsedUndefined: Self = StObject.set(x, "onItemCollapsed", js.undefined)
    
    inline def setOnItemContextMenu(value: /* e */ ItemContextMenuEvent[TKey] => Callback): Self = StObject.set(x, "onItemContextMenu", js.Any.fromFunction1((t0: /* e */ ItemContextMenuEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnItemContextMenuUndefined: Self = StObject.set(x, "onItemContextMenu", js.undefined)
    
    inline def setOnItemExpanded(value: /* e */ ItemExpandedEvent[TKey] => Callback): Self = StObject.set(x, "onItemExpanded", js.Any.fromFunction1((t0: /* e */ ItemExpandedEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnItemExpandedUndefined: Self = StObject.set(x, "onItemExpanded", js.undefined)
    
    inline def setOnItemHold(value: /* e */ ItemHoldEvent[TKey] => Callback): Self = StObject.set(x, "onItemHold", js.Any.fromFunction1((t0: /* e */ ItemHoldEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnItemHoldUndefined: Self = StObject.set(x, "onItemHold", js.undefined)
    
    inline def setOnItemRendered(value: /* e */ ItemRenderedEvent[TKey] => Callback): Self = StObject.set(x, "onItemRendered", js.Any.fromFunction1((t0: /* e */ ItemRenderedEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnItemRenderedUndefined: Self = StObject.set(x, "onItemRendered", js.undefined)
    
    inline def setOnItemSelectionChanged(value: /* e */ ItemSelectionChangedEvent[TKey] => Callback): Self = StObject.set(x, "onItemSelectionChanged", js.Any.fromFunction1((t0: /* e */ ItemSelectionChangedEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnItemSelectionChangedUndefined: Self = StObject.set(x, "onItemSelectionChanged", js.undefined)
    
    inline def setOnOptionChanged(value: /* e */ OptionChangedEventInfo[dxTreeView[TKey]] => Callback): Self = StObject.set(x, "onOptionChanged", js.Any.fromFunction1((t0: /* e */ OptionChangedEventInfo[dxTreeView[TKey]]) => value(t0).runNow()))
    
    inline def setOnOptionChangedUndefined: Self = StObject.set(x, "onOptionChanged", js.undefined)
    
    inline def setOnSelectAllValueChanged(value: /* e */ SelectAllValueChangedEvent[TKey] => Callback): Self = StObject.set(x, "onSelectAllValueChanged", js.Any.fromFunction1((t0: /* e */ SelectAllValueChangedEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnSelectAllValueChangedUndefined: Self = StObject.set(x, "onSelectAllValueChanged", js.undefined)
    
    inline def setOnSelectionChanged(value: /* e */ SelectionChangedEvent[TKey] => Callback): Self = StObject.set(x, "onSelectionChanged", js.Any.fromFunction1((t0: /* e */ SelectionChangedEvent[TKey]) => value(t0).runNow()))
