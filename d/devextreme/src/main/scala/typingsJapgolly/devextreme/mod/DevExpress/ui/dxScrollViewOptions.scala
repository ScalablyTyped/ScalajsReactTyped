...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxScrollView.PullDownEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxScrollView.ReachBottomEvent
...
object dxScrollViewOptions {
  ...
  extension [Self <: dxScrollViewOptions](x: Self) {
    ...
    inline def setOnPullDown(value: /* e */ PullDownEvent => Callback): Self = StObject.set(x, "onPullDown", js.Any.fromFunction1((t0: /* e */ PullDownEvent) => value(t0).runNow()))
    
    inline def setOnPullDownUndefined: Self = StObject.set(x, "onPullDown", js.undefined)
    
    inline def setOnReachBottom(value: /* e */ ReachBottomEvent => Callback): Self = StObject.set(x, "onReachBottom", js.Any.fromFunction1((t0: /* e */ ReachBottomEvent) => value(t0).runNow()))
