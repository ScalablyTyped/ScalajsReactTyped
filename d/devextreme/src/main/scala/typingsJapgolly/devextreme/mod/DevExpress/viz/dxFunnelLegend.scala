...
import typingsJapgolly.devextreme.AnonItemDxFunnelItem
...
object dxFunnelLegend {
  ...
  def apply(
    ...
    customizeHint: /* itemInfo */ AnonItemDxFunnelItem => CallbackTo[String] = null,
    customizeItems: /* items */ js.Array[FunnelLegendItem] => CallbackTo[js.Array[FunnelLegendItem]] = null,
    customizeText: /* itemInfo */ AnonItemDxFunnelItem => CallbackTo[String] = null,
    font: Font = null,
    ...
    if (customizeHint != null) __obj.updateDynamic("customizeHint")(js.Any.fromFunction1((t0: /* itemInfo */ typingsJapgolly.devextreme.AnonItemDxFunnelItem) => customizeHint(t0).runNow()))
    if (customizeItems != null) __obj.updateDynamic("customizeItems")(js.Any.fromFunction1((t0: /* items */ js.Array[typingsJapgolly.devextreme.mod.DevExpress.viz.FunnelLegendItem]) => customizeItems(t0).runNow()))
    if (customizeText != null) __obj.updateDynamic("customizeText")(js.Any.fromFunction1((t0: /* itemInfo */ typingsJapgolly.devextreme.AnonItemDxFunnelItem) => customizeText(t0).runNow()))
