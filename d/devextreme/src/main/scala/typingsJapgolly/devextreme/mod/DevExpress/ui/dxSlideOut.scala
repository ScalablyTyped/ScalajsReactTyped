...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.ItemLike
...
object dxSlideOut {
  ...
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    ...
    var ContentReadyEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.ItemRenderedEvent[TItem, TKey]
    
    var MenuGroupRenderedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.MenuGroupRenderedEvent[TItem, TKey]
    
    var MenuItemRenderedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.MenuItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.OptionChangedEvent[TItem, TKey]
    
    var Properties: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.Properties[TItem, TKey]
    
    var SelectionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.SelectionChangedEvent[TItem, TKey]
  }
