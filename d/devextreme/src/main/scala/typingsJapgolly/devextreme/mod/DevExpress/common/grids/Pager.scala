...
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.PagerDisplayMode
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.PagerPageSize
