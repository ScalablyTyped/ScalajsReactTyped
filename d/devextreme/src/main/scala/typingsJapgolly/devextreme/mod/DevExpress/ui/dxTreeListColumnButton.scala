...
import typingsJapgolly.devextreme.anon.Row
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.ColumnButtonClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.ColumnButtonTemplateData
...
trait dxTreeListColumnButton[TRowData, TKey]
  ...
  /**
    ...
    */
  var name: js.UndefOr[TreeListPredefinedColumnButton | String] = js.undefined
...
object dxTreeListColumnButton {
  ...
  extension [Self <: dxTreeListColumnButton[?, ?], TRowData, TKey](x: Self & (dxTreeListColumnButton[TRowData, TKey])) {
    ...
    inline def setName(value: TreeListPredefinedColumnButton | String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
