...
import typingsJapgolly.devextreme.AnonColumnComponentElement
import typingsJapgolly.devextreme.AnonColumnDxTreeListColumn
import typingsJapgolly.devextreme.AnonKeyRow
...
trait dxTreeListColumnButton extends GridBaseColumnButton {
  ...
  var template: js.UndefOr[
    typingsJapgolly.devextreme.mod.DevExpress.core.template | (js.Function2[/* cellElement */ dxElement, /* cellInfo */ AnonKeyRow, String | Element | JQuery])
  ] = js.undefined
...
object dxTreeListColumnButton {
  ...
  def apply(
    ...
    template: typingsJapgolly.devextreme.mod.DevExpress.core.template | (js.Function2[/* cellElement */ dxElement, /* cellInfo */ AnonKeyRow, String | Element | JQuery]) = null,
    text: String = null,
