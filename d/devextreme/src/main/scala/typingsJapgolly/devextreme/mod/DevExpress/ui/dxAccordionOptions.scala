...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxAccordion.ItemTitleClickEvent
...
object dxAccordionOptions {
  ...
  extension [Self <: dxAccordionOptions[?, ?], TItem /* <: ItemLike */, TKey](x: Self & (dxAccordionOptions[TItem, TKey])) {
    ...
    inline def setOnItemTitleClickFunction1(value: /* e */ ItemTitleClickEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onItemTitleClick", js.Any.fromFunction1((t0: /* e */ ItemTitleClickEvent[TItem, TKey]) => value(t0).runNow()))
