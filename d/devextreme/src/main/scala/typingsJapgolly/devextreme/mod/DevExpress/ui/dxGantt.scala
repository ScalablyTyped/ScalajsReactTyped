...
import typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnCustomizeTextArg
import typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnHeaderFilter
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.ColumnCellTemplateData
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxTreeList.ColumnHeaderCellTemplateData
...
object dxGantt {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.all
    - typingsJapgolly.devextreme.devextremeStrings.treeList
    - typingsJapgolly.devextreme.devextremeStrings.chart
  */
  ...
  object GanttPdfExportMode {
    ...
    inline def chart: typingsJapgolly.devextreme.devextremeStrings.chart = "chart".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.chart]
    
    inline def treeList: typingsJapgolly.devextreme.devextremeStrings.treeList = "treeList".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.treeList]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.undo
    - typingsJapgolly.devextreme.devextremeStrings.redo
    - typingsJapgolly.devextreme.devextremeStrings.expandAll
    - typingsJapgolly.devextreme.devextremeStrings.collapseAll
    - typingsJapgolly.devextreme.devextremeStrings.addTask
    - typingsJapgolly.devextreme.devextremeStrings.deleteTask
    - typingsJapgolly.devextreme.devextremeStrings.zoomIn
    - typingsJapgolly.devextreme.devextremeStrings.zoomOut
    - typingsJapgolly.devextreme.devextremeStrings.deleteDependency
    - typingsJapgolly.devextreme.devextremeStrings.taskDetails
    - typingsJapgolly.devextreme.devextremeStrings.resourceManager
  */
  trait GanttPredefinedContextMenuItem extends StObject
  object GanttPredefinedContextMenuItem {
    
    inline def addTask: typingsJapgolly.devextreme.devextremeStrings.addTask = "addTask".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.addTask]
    
    inline def collapseAll: typingsJapgolly.devextreme.devextremeStrings.collapseAll = "collapseAll".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.collapseAll]
    
    inline def deleteDependency: typingsJapgolly.devextreme.devextremeStrings.deleteDependency = "deleteDependency".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.deleteDependency]
    
    inline def deleteTask: typingsJapgolly.devextreme.devextremeStrings.deleteTask = "deleteTask".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.deleteTask]
    
    inline def expandAll: typingsJapgolly.devextreme.devextremeStrings.expandAll = "expandAll".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.expandAll]
    ...
    inline def resourceManager: typingsJapgolly.devextreme.devextremeStrings.resourceManager = "resourceManager".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.resourceManager]
    
    inline def taskDetails: typingsJapgolly.devextreme.devextremeStrings.taskDetails = "taskDetails".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.taskDetails]
    ...
    inline def zoomIn: typingsJapgolly.devextreme.devextremeStrings.zoomIn = "zoomIn".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.zoomIn]
    
    inline def zoomOut: typingsJapgolly.devextreme.devextremeStrings.zoomOut = "zoomOut".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.zoomOut]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.devextreme.devextremeStrings.resourceManager
    - typingsJapgolly.devextreme.devextremeStrings.showResources
    - typingsJapgolly.devextreme.devextremeStrings.showDependencies
  */
  ...
  object GanttPredefinedToolbarItem {
    ...
    inline def showDependencies: typingsJapgolly.devextreme.devextremeStrings.showDependencies = "showDependencies".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.showDependencies]
    
    inline def showResources: typingsJapgolly.devextreme.devextremeStrings.showResources = "showResources".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.showResources]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.minutes
    - typingsJapgolly.devextreme.devextremeStrings.hours
    - typingsJapgolly.devextreme.devextremeStrings.sixHours
    - typingsJapgolly.devextreme.devextremeStrings.days
    - typingsJapgolly.devextreme.devextremeStrings.weeks
    - typingsJapgolly.devextreme.devextremeStrings.months
    - typingsJapgolly.devextreme.devextremeStrings.quarters
    - typingsJapgolly.devextreme.devextremeStrings.years
    - typingsJapgolly.devextreme.devextremeStrings.fiveYears
  */
  trait GanttRenderScaleType extends StObject
  object GanttRenderScaleType {
    
    inline def days: typingsJapgolly.devextreme.devextremeStrings.days = "days".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.days]
    
    inline def fiveYears: typingsJapgolly.devextreme.devextremeStrings.fiveYears = "fiveYears".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.fiveYears]
    
    inline def hours: typingsJapgolly.devextreme.devextremeStrings.hours = "hours".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.hours]
    
    inline def minutes: typingsJapgolly.devextreme.devextremeStrings.minutes = "minutes".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.minutes]
    
    inline def months: typingsJapgolly.devextreme.devextremeStrings.months = "months".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.months]
    
    inline def quarters: typingsJapgolly.devextreme.devextremeStrings.quarters = "quarters".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.quarters]
    
    inline def sixHours: typingsJapgolly.devextreme.devextremeStrings.sixHours = "sixHours".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.sixHours]
    
    inline def weeks: typingsJapgolly.devextreme.devextremeStrings.weeks = "weeks".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.weeks]
    
    inline def years: typingsJapgolly.devextreme.devextremeStrings.years = "years".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.years]
  }
