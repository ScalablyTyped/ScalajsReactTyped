...
import typingsJapgolly.devextreme.AnonData
...
object XmlaStoreOptions {
  @scala.inline
  def apply(
    beforeSend: /* options */ AnonData => CallbackTo[js.Any] = null,
    catalog: String = null,
    cube: String = null,
    url: String = null
  ): XmlaStoreOptions = {
    val __obj = js.Dynamic.literal()
    if (beforeSend != null) __obj.updateDynamic("beforeSend")(js.Any.fromFunction1((t0: /* options */ typingsJapgolly.devextreme.AnonData) => beforeSend(t0).runNow()))
