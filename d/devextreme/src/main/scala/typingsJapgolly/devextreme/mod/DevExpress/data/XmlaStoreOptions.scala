...
import typingsJapgolly.devextreme.anon.DataType
...
object XmlaStoreOptions {
  ...
  extension [Self <: XmlaStoreOptions](x: Self) {
    ...
    inline def setBeforeSend(value: /* options */ DataType => Callback): Self = StObject.set(x, "beforeSend", js.Any.fromFunction1((t0: /* options */ DataType) => value(t0).runNow()))
