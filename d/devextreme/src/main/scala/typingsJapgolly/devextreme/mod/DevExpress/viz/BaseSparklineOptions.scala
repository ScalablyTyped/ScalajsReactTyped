...
object BaseSparklineOptions {
  ...
  def apply[T](
    ...
    onTooltipHidden: /* e */ AnonElementDxElementModelAny[T] => CallbackTo[js.Any] = null,
    onTooltipShown: /* e */ AnonElementDxElementModelAny[T] => CallbackTo[js.Any] = null,
    ...
    if (onTooltipHidden != null) __obj.updateDynamic("onTooltipHidden")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonElementDxElementModelAny[T]) => onTooltipHidden(t0).runNow()))
    if (onTooltipShown != null) __obj.updateDynamic("onTooltipShown")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonElementDxElementModelAny[T]) => onTooltipShown(t0).runNow()))
