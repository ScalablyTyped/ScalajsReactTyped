...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownBox.ContentTemplateData
...
- typingsJapgolly.devextreme.mod.DevExpress.ui.WidgetOptions because var conflicts: activeStateEnabled, focusStateEnabled, hoverStateEnabled. Inlined accessKey, disabled, hint, onContentReady, tabIndex, visible
- typingsJapgolly.devextreme.mod.DevExpress.ui.EditorOptions because var conflicts: activeStateEnabled, focusStateEnabled, hoverStateEnabled, stylingMode, value. Inlined isValid, onValueChanged, readOnly, validationError, validationErrors, validationMessageMode, validationStatus
...
- typingsJapgolly.devextreme.mod.DevExpress.ui.dxTextBoxOptions because var conflicts: activeStateEnabled, buttons, value. Inlined maxLength, mode
- typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownEditorOptions because var conflicts: value. Inlined acceptCustomValue, activeStateEnabled, applyValueMode, dropDownOptions, buttons, deferRendering, dropDownButtonTemplate, onClosed, onOpened, openOnFieldClick, opened, showDropDownButton */ trait dxDropDownBoxOptions
  ...
  /**
    ...
    */
  @JSName("dataSource")
  var dataSource_dxDropDownBoxOptions: js.UndefOr[(DataSourceLike[Any, Any]) | Null] = js.undefined
  ...
  /**
    ...
    */
  var dropDownOptions: js.UndefOr[Properties | typingsJapgolly.devextreme.mod.DevExpress.ui.dxPopover.Properties] = js.undefined
...
object dxDropDownBoxOptions {
  ...
  extension [Self <: dxDropDownBoxOptions](x: Self) {
    ...
    inline def setDropDownOptions(value: Properties | typingsJapgolly.devextreme.mod.DevExpress.ui.dxPopover.Properties): Self = StObject.set(x, "dropDownOptions", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: /* e */ NativeEventInfo[dxDropDownBox, Event] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, Event]) => value(t0).runNow()))
    
    inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    inline def setOnClosed(value: /* e */ EventInfo[dxDropDownBox] => Callback): Self = StObject.set(x, "onClosed", js.Any.fromFunction1((t0: /* e */ EventInfo[dxDropDownBox]) => value(t0).runNow()))
    
    inline def setOnClosedUndefined: Self = StObject.set(x, "onClosed", js.undefined)
    
    inline def setOnContentReady(value: /* e */ EventInfo[dxDropDownBox] => Callback): Self = StObject.set(x, "onContentReady", js.Any.fromFunction1((t0: /* e */ EventInfo[dxDropDownBox]) => value(t0).runNow()))
    
    inline def setOnContentReadyUndefined: Self = StObject.set(x, "onContentReady", js.undefined)
    
    inline def setOnCopy(value: /* e */ NativeEventInfo[dxDropDownBox, ClipboardEvent] => Callback): Self = StObject.set(x, "onCopy", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, ClipboardEvent]) => value(t0).runNow()))
    
    inline def setOnCopyUndefined: Self = StObject.set(x, "onCopy", js.undefined)
    
    inline def setOnCut(value: /* e */ NativeEventInfo[dxDropDownBox, ClipboardEvent] => Callback): Self = StObject.set(x, "onCut", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, ClipboardEvent]) => value(t0).runNow()))
    
    inline def setOnCutUndefined: Self = StObject.set(x, "onCut", js.undefined)
    
    inline def setOnEnterKey(value: /* e */ NativeEventInfo[dxDropDownBox, KeyboardEvent] => Callback): Self = StObject.set(x, "onEnterKey", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, KeyboardEvent]) => value(t0).runNow()))
    
    inline def setOnEnterKeyUndefined: Self = StObject.set(x, "onEnterKey", js.undefined)
    
    inline def setOnFocusIn(value: /* e */ NativeEventInfo[dxDropDownBox, FocusEvent] => Callback): Self = StObject.set(x, "onFocusIn", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, FocusEvent]) => value(t0).runNow()))
    
    inline def setOnFocusInUndefined: Self = StObject.set(x, "onFocusIn", js.undefined)
    
    inline def setOnFocusOut(value: /* e */ NativeEventInfo[dxDropDownBox, FocusEvent] => Callback): Self = StObject.set(x, "onFocusOut", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, FocusEvent]) => value(t0).runNow()))
    
    inline def setOnFocusOutUndefined: Self = StObject.set(x, "onFocusOut", js.undefined)
    
    inline def setOnInput(value: /* e */ NativeEventInfo[dxDropDownBox, UIEvent] => Callback): Self = StObject.set(x, "onInput", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, UIEvent]) => value(t0).runNow()))
    
    inline def setOnInputUndefined: Self = StObject.set(x, "onInput", js.undefined)
    
    inline def setOnKeyDown(value: /* e */ NativeEventInfo[dxDropDownBox, KeyboardEvent] => Callback): Self = StObject.set(x, "onKeyDown", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, KeyboardEvent]) => value(t0).runNow()))
    
    inline def setOnKeyDownUndefined: Self = StObject.set(x, "onKeyDown", js.undefined)
    
    inline def setOnKeyUp(value: /* e */ NativeEventInfo[dxDropDownBox, KeyboardEvent] => Callback): Self = StObject.set(x, "onKeyUp", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, KeyboardEvent]) => value(t0).runNow()))
    
    inline def setOnKeyUpUndefined: Self = StObject.set(x, "onKeyUp", js.undefined)
    
    inline def setOnOpened(value: /* e */ EventInfo[dxDropDownBox] => Callback): Self = StObject.set(x, "onOpened", js.Any.fromFunction1((t0: /* e */ EventInfo[dxDropDownBox]) => value(t0).runNow()))
    
    inline def setOnOpenedUndefined: Self = StObject.set(x, "onOpened", js.undefined)
    
    inline def setOnPaste(value: /* e */ NativeEventInfo[dxDropDownBox, ClipboardEvent] => Callback): Self = StObject.set(x, "onPaste", js.Any.fromFunction1((t0: /* e */ NativeEventInfo[dxDropDownBox, ClipboardEvent]) => value(t0).runNow()))
    
    inline def setOnPasteUndefined: Self = StObject.set(x, "onPaste", js.undefined)
    
    inline def setOnValueChanged(value: /* e */ (NativeEventInfo[dxDropDownBox, Event]) & ValueChangedInfo => Callback): Self = StObject.set(x, "onValueChanged", js.Any.fromFunction1((t0: /* e */ (NativeEventInfo[dxDropDownBox, Event]) & ValueChangedInfo) => value(t0).runNow()))
