...
import typingsJapgolly.devextreme.anon.Action
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.GroupRenderedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemContextMenuEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemDeleteMode
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemDeletedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemDeletingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemHoldEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemLike
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemReorderedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ItemSwipeEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ListMenuMode
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.PageLoadingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.PullRefreshEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.ScrollEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxList.SelectAllValueChangedEvent
...
object dxListOptions {
  ...
  extension [Self <: dxListOptions[?, ?], TItem /* <: ItemLike */, TKey](x: Self & (dxListOptions[TItem, TKey])) {
    ...
    inline def setOnGroupRendered(value: /* e */ GroupRenderedEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onGroupRendered", js.Any.fromFunction1((t0: /* e */ GroupRenderedEvent[TItem, TKey]) => value(t0).runNow()))
    ...
    inline def setOnItemClickFunction1(value: /* e */ ItemClickEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onItemClick", js.Any.fromFunction1((t0: /* e */ ItemClickEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnItemClickUndefined: Self = StObject.set(x, "onItemClick", js.undefined)
    
    inline def setOnItemContextMenu(value: /* e */ ItemContextMenuEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onItemContextMenu", js.Any.fromFunction1((t0: /* e */ ItemContextMenuEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnItemContextMenuUndefined: Self = StObject.set(x, "onItemContextMenu", js.undefined)
    
    inline def setOnItemDeleted(value: /* e */ ItemDeletedEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onItemDeleted", js.Any.fromFunction1((t0: /* e */ ItemDeletedEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnItemDeletedUndefined: Self = StObject.set(x, "onItemDeleted", js.undefined)
    
    inline def setOnItemDeleting(value: /* e */ ItemDeletingEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onItemDeleting", js.Any.fromFunction1((t0: /* e */ ItemDeletingEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnItemDeletingUndefined: Self = StObject.set(x, "onItemDeleting", js.undefined)
    
    inline def setOnItemHold(value: /* e */ ItemHoldEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onItemHold", js.Any.fromFunction1((t0: /* e */ ItemHoldEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnItemHoldUndefined: Self = StObject.set(x, "onItemHold", js.undefined)
    
    inline def setOnItemReordered(value: /* e */ ItemReorderedEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onItemReordered", js.Any.fromFunction1((t0: /* e */ ItemReorderedEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnItemReorderedUndefined: Self = StObject.set(x, "onItemReordered", js.undefined)
    
    inline def setOnItemSwipe(value: /* e */ ItemSwipeEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onItemSwipe", js.Any.fromFunction1((t0: /* e */ ItemSwipeEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnItemSwipeUndefined: Self = StObject.set(x, "onItemSwipe", js.undefined)
    
    inline def setOnPageLoading(value: /* e */ PageLoadingEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onPageLoading", js.Any.fromFunction1((t0: /* e */ PageLoadingEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnPageLoadingUndefined: Self = StObject.set(x, "onPageLoading", js.undefined)
    
    inline def setOnPullRefresh(value: /* e */ PullRefreshEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onPullRefresh", js.Any.fromFunction1((t0: /* e */ PullRefreshEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnPullRefreshUndefined: Self = StObject.set(x, "onPullRefresh", js.undefined)
    
    inline def setOnScroll(value: /* e */ ScrollEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: /* e */ ScrollEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnScrollUndefined: Self = StObject.set(x, "onScroll", js.undefined)
    
    inline def setOnSelectAllValueChanged(value: /* e */ SelectAllValueChangedEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onSelectAllValueChanged", js.Any.fromFunction1((t0: /* e */ SelectAllValueChangedEvent[TItem, TKey]) => value(t0).runNow()))
