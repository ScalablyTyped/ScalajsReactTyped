...
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.StateStoreType
...
object StateStoring {
  ...
  extension [Self <: StateStoring](x: Self) {
    ...
    inline def setCustomLoad(value: CallbackTo[PromiseLike[Any]]): Self = StObject.set(x, "customLoad", value.toJsFn)
