...
import typingsJapgolly.devextreme.mod.DevExpress.fileManagement.UploadInfo
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.BeforeSendEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.DropZoneEnterEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.DropZoneLeaveEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.FileUploadMode
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.FilesUploadedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.ProgressEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.UploadAbortedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.UploadErrorEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.UploadHttpMethod
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.UploadStartedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.UploadedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFileUploader.ValueChangedEvent
...
object dxFileUploaderOptions {
  ...
  extension [Self <: dxFileUploaderOptions](x: Self) {
    ...
    inline def setOnBeforeSend(value: /* e */ BeforeSendEvent => Callback): Self = StObject.set(x, "onBeforeSend", js.Any.fromFunction1((t0: /* e */ BeforeSendEvent) => value(t0).runNow()))
    
    inline def setOnBeforeSendUndefined: Self = StObject.set(x, "onBeforeSend", js.undefined)
    
    inline def setOnDropZoneEnter(value: /* e */ DropZoneEnterEvent => Callback): Self = StObject.set(x, "onDropZoneEnter", js.Any.fromFunction1((t0: /* e */ DropZoneEnterEvent) => value(t0).runNow()))
    
    inline def setOnDropZoneEnterUndefined: Self = StObject.set(x, "onDropZoneEnter", js.undefined)
    
    inline def setOnDropZoneLeave(value: /* e */ DropZoneLeaveEvent => Callback): Self = StObject.set(x, "onDropZoneLeave", js.Any.fromFunction1((t0: /* e */ DropZoneLeaveEvent) => value(t0).runNow()))
    
    inline def setOnDropZoneLeaveUndefined: Self = StObject.set(x, "onDropZoneLeave", js.undefined)
    
    inline def setOnFilesUploaded(value: /* e */ FilesUploadedEvent => Callback): Self = StObject.set(x, "onFilesUploaded", js.Any.fromFunction1((t0: /* e */ FilesUploadedEvent) => value(t0).runNow()))
    
    inline def setOnFilesUploadedUndefined: Self = StObject.set(x, "onFilesUploaded", js.undefined)
    
    inline def setOnProgress(value: /* e */ ProgressEvent => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction1((t0: /* e */ ProgressEvent) => value(t0).runNow()))
    
    inline def setOnProgressUndefined: Self = StObject.set(x, "onProgress", js.undefined)
    
    inline def setOnUploadAborted(value: /* e */ UploadAbortedEvent => Callback): Self = StObject.set(x, "onUploadAborted", js.Any.fromFunction1((t0: /* e */ UploadAbortedEvent) => value(t0).runNow()))
    
    inline def setOnUploadAbortedUndefined: Self = StObject.set(x, "onUploadAborted", js.undefined)
    
    inline def setOnUploadError(value: /* e */ UploadErrorEvent => Callback): Self = StObject.set(x, "onUploadError", js.Any.fromFunction1((t0: /* e */ UploadErrorEvent) => value(t0).runNow()))
    
    inline def setOnUploadErrorUndefined: Self = StObject.set(x, "onUploadError", js.undefined)
    
    inline def setOnUploadStarted(value: /* e */ UploadStartedEvent => Callback): Self = StObject.set(x, "onUploadStarted", js.Any.fromFunction1((t0: /* e */ UploadStartedEvent) => value(t0).runNow()))
    
    inline def setOnUploadStartedUndefined: Self = StObject.set(x, "onUploadStarted", js.undefined)
    
    inline def setOnUploaded(value: /* e */ UploadedEvent => Callback): Self = StObject.set(x, "onUploaded", js.Any.fromFunction1((t0: /* e */ UploadedEvent) => value(t0).runNow()))
