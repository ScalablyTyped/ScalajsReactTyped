...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.CustomOperationEditorTemplate
...
trait dxFilterBuilderCustomOperation extends StObject {
  ...
  /**
    ...
    */
  var customizeText: js.UndefOr[js.Function1[/* fieldInfo */ typingsJapgolly.devextreme.anon.Field, String]] = js.undefined
...
object dxFilterBuilderCustomOperation {
  ...
  extension [Self <: dxFilterBuilderCustomOperation](x: Self) {
    ...
    inline def setCustomizeText(value: /* fieldInfo */ typingsJapgolly.devextreme.anon.Field => String): Self = StObject.set(x, "customizeText", js.Any.fromFunction1(value))
