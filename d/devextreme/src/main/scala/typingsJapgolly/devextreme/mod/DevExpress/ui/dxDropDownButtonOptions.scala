...
import typingsJapgolly.devextreme.AnonItemElementModel
import typingsJapgolly.devextreme.AnonModel
import typingsJapgolly.devextreme.AnonName
import typingsJapgolly.devextreme.AnonPreviousItem
import typingsJapgolly.devextreme.AnonSelectedItem
...
object dxDropDownButtonOptions {
  ...
  def apply(
    ...
    dropDownContentTemplate: typingsJapgolly.devextreme.mod.DevExpress.core.template | (js.Function2[
      /* data */ (js.Array[String | Double | _]) | DataSource, 
      /* contentElement */ dxElement, 
      String | Element | JQuery
    ]) = null,
    ...
    onContentReady: /* e */ AnonComponentElement[dxDropDownButton] => CallbackTo[js.Any] = null,
    onDisposing: /* e */ AnonModel[dxDropDownButton] => CallbackTo[js.Any] = null,
    onInitialized: /* e */ AnonElement[dxDropDownButton] => CallbackTo[js.Any] = null,
    onItemClick: (js.Function1[/* e */ AnonItemElementModel, _]) | String = null,
    onOptionChanged: /* e */ AnonName[dxDropDownButton] => CallbackTo[js.Any] = null,
    ...
    if (onContentReady != null) __obj.updateDynamic("onContentReady")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonComponentElement[typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownButton]) => onContentReady(t0).runNow()))
    if (onDisposing != null) __obj.updateDynamic("onDisposing")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonModel[typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownButton]) => onDisposing(t0).runNow()))
    if (onInitialized != null) __obj.updateDynamic("onInitialized")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonElement[typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownButton]) => onInitialized(t0).runNow()))
    if (onItemClick != null) __obj.updateDynamic("onItemClick")(onItemClick.asInstanceOf[js.Any])
    if (onOptionChanged != null) __obj.updateDynamic("onOptionChanged")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonName[typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownButton]) => onOptionChanged(t0).runNow()))
