...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownButton.ButtonClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownButton.Item
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownButton.ItemClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxDropDownButton.SelectionChangedEvent
...
object dxDropDownButtonOptions {
  ...
  extension [Self <: dxDropDownButtonOptions](x: Self) {
    ...
    inline def setOnButtonClickFunction1(value: /* e */ ButtonClickEvent => Callback): Self = StObject.set(x, "onButtonClick", js.Any.fromFunction1((t0: /* e */ ButtonClickEvent) => value(t0).runNow()))
    ...
    inline def setOnItemClickFunction1(value: /* e */ ItemClickEvent => Callback): Self = StObject.set(x, "onItemClick", js.Any.fromFunction1((t0: /* e */ ItemClickEvent) => value(t0).runNow()))
    ...
    inline def setOnSelectionChangedFunction1(value: /* e */ SelectionChangedEvent => Callback): Self = StObject.set(x, "onSelectionChanged", js.Any.fromFunction1((t0: /* e */ SelectionChangedEvent) => value(t0).runNow()))
