...
import typingsJapgolly.devextreme.anon.Duration
...
trait BaseChartOptions[TComponent]
  ...
  /**
    ...
    */
  var pointSelectionMode: js.UndefOr[SingleOrMultiple] = js.undefined
...
object BaseChartOptions {
  ...
  extension [Self <: BaseChartOptions[?], TComponent](x: Self & BaseChartOptions[TComponent]) {
    ...
    inline def setOnDone(value: /* e */ EventInfo[TComponent] => Callback): Self = StObject.set(x, "onDone", js.Any.fromFunction1((t0: /* e */ EventInfo[TComponent]) => value(t0).runNow()))
    ...
    inline def setOnPointClickFunction1(
      value: /* e */ (NativeEventInfo[TComponent, MouseEvent | PointerEvent]) & PointInteractionInfo => Callback
    ): Self = StObject.set(x, "onPointClick", js.Any.fromFunction1((t0: /* e */ (NativeEventInfo[TComponent, MouseEvent | PointerEvent]) & PointInteractionInfo) => value(t0).runNow()))
    
    inline def setOnPointClickUndefined: Self = StObject.set(x, "onPointClick", js.undefined)
    
    inline def setOnPointHoverChanged(value: /* e */ EventInfo[TComponent] & PointInteractionInfo => Callback): Self = StObject.set(x, "onPointHoverChanged", js.Any.fromFunction1((t0: /* e */ EventInfo[TComponent] & PointInteractionInfo) => value(t0).runNow()))
    
    inline def setOnPointHoverChangedUndefined: Self = StObject.set(x, "onPointHoverChanged", js.undefined)
    
    inline def setOnPointSelectionChanged(value: /* e */ EventInfo[TComponent] & PointInteractionInfo => Callback): Self = StObject.set(x, "onPointSelectionChanged", js.Any.fromFunction1((t0: /* e */ EventInfo[TComponent] & PointInteractionInfo) => value(t0).runNow()))
    ...
    inline def setPointSelectionMode(value: SingleOrMultiple): Self = StObject.set(x, "pointSelectionMode", value.asInstanceOf[js.Any])
