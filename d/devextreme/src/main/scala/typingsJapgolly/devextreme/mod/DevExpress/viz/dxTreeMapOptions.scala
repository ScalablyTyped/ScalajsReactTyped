...
import typingsJapgolly.devextreme.anon.ColorCodeField
import typingsJapgolly.devextreme.anon.HeaderHeight
import typingsJapgolly.devextreme.anon.Rect
import typingsJapgolly.devextreme.anon.SelectionStyle
...
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxTreeMap.ClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxTreeMap.DrillEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxTreeMap.HoverChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxTreeMap.NodesInitializedEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxTreeMap.NodesRenderingEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxTreeMap.SelectionChangedEvent
...
object dxTreeMapOptions {
  ...
  extension [Self <: dxTreeMapOptions](x: Self) {
    ...
    inline def setOnClickFunction1(value: /* e */ ClickEvent => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* e */ ClickEvent) => value(t0).runNow()))
    
    inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
    
    inline def setOnDrill(value: /* e */ DrillEvent => Callback): Self = StObject.set(x, "onDrill", js.Any.fromFunction1((t0: /* e */ DrillEvent) => value(t0).runNow()))
    
    inline def setOnDrillUndefined: Self = StObject.set(x, "onDrill", js.undefined)
    
    inline def setOnHoverChanged(value: /* e */ HoverChangedEvent => Callback): Self = StObject.set(x, "onHoverChanged", js.Any.fromFunction1((t0: /* e */ HoverChangedEvent) => value(t0).runNow()))
    
    inline def setOnHoverChangedUndefined: Self = StObject.set(x, "onHoverChanged", js.undefined)
    
    inline def setOnNodesInitialized(value: /* e */ NodesInitializedEvent => Callback): Self = StObject.set(x, "onNodesInitialized", js.Any.fromFunction1((t0: /* e */ NodesInitializedEvent) => value(t0).runNow()))
    
    inline def setOnNodesInitializedUndefined: Self = StObject.set(x, "onNodesInitialized", js.undefined)
    
    inline def setOnNodesRendering(value: /* e */ NodesRenderingEvent => Callback): Self = StObject.set(x, "onNodesRendering", js.Any.fromFunction1((t0: /* e */ NodesRenderingEvent) => value(t0).runNow()))
