...
object dxSelectBoxOptions {
  ...
  def apply[T](
    ...
    onCustomItemCreating: /* e */ AnonCustomItem[T] => CallbackTo[js.Any] = null,
    ...
    if (onCustomItemCreating != null) __obj.updateDynamic("onCustomItemCreating")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonCustomItem[T]) => onCustomItemCreating(t0).runNow()))
