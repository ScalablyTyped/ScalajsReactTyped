...
import typingsJapgolly.devextreme.anon.Bing
import typingsJapgolly.devextreme.anon.Color
import typingsJapgolly.devextreme.anon.IconSrc
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMap.ClickEvent
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMap.MarkerAddedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMap.MarkerRemovedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMap.ReadyEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMap.RouteAddedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMap.RouteRemovedEvent
...
object dxMapOptions {
  ...
  extension [Self <: dxMapOptions](x: Self) {
    ...
    inline def setOnMarkerAdded(value: /* e */ MarkerAddedEvent => Callback): Self = StObject.set(x, "onMarkerAdded", js.Any.fromFunction1((t0: /* e */ MarkerAddedEvent) => value(t0).runNow()))
    
    inline def setOnMarkerAddedUndefined: Self = StObject.set(x, "onMarkerAdded", js.undefined)
    
    inline def setOnMarkerRemoved(value: /* e */ MarkerRemovedEvent => Callback): Self = StObject.set(x, "onMarkerRemoved", js.Any.fromFunction1((t0: /* e */ MarkerRemovedEvent) => value(t0).runNow()))
    
    inline def setOnMarkerRemovedUndefined: Self = StObject.set(x, "onMarkerRemoved", js.undefined)
    
    inline def setOnReady(value: /* e */ ReadyEvent => Callback): Self = StObject.set(x, "onReady", js.Any.fromFunction1((t0: /* e */ ReadyEvent) => value(t0).runNow()))
    
    inline def setOnReadyUndefined: Self = StObject.set(x, "onReady", js.undefined)
    
    inline def setOnRouteAdded(value: /* e */ RouteAddedEvent => Callback): Self = StObject.set(x, "onRouteAdded", js.Any.fromFunction1((t0: /* e */ RouteAddedEvent) => value(t0).runNow()))
    
    inline def setOnRouteAddedUndefined: Self = StObject.set(x, "onRouteAdded", js.undefined)
    
    inline def setOnRouteRemoved(value: /* e */ RouteRemovedEvent => Callback): Self = StObject.set(x, "onRouteRemoved", js.Any.fromFunction1((t0: /* e */ RouteRemovedEvent) => value(t0).runNow()))
