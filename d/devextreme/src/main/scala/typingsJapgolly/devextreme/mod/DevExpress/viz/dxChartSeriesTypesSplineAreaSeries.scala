...
object dxChartSeriesTypesSplineAreaSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesSplineAreaSeriesAggregation = null,
    ...
    label: dxChartSeriesTypesSplineAreaSeriesLabel = null,
    ...
    pane: String = null,
    point: dxChartSeriesTypesSplineAreaSeriesPoint = null,
  ...
  ): dxChartSeriesTypesSplineAreaSeries = {
