...
object dxMenu {
  ...
  trait ExplicitTypes[TKey] extends StObject {
    ...
    var ContentReadyEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.ContentReadyEvent[TKey]
    
    var DisposingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.DisposingEvent[TKey]
    
    var InitializedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.InitializedEvent[TKey]
    
    var ItemClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.ItemClickEvent[TKey]
    
    var ItemContextMenuEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.ItemContextMenuEvent[TKey]
    
    var ItemRenderedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.ItemRenderedEvent[TKey]
    
    var OptionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.OptionChangedEvent[TKey]
    
    var Properties: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.Properties[TKey]
    
    var SelectionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SelectionChangedEvent[TKey]
    
    var SubmenuHiddenEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuHiddenEvent[TKey]
    
    var SubmenuHidingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuHidingEvent[TKey]
    
    var SubmenuShowingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuShowingEvent[TKey]
    
    var SubmenuShownEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuShownEvent[TKey]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.devextreme.devextremeStrings.leftOrTop
    - typingsJapgolly.devextreme.devextremeStrings.rightOrBottom
  */
  trait SubmenuDirection extends StObject
  object SubmenuDirection {
    ...
    inline def leftOrTop: typingsJapgolly.devextreme.devextremeStrings.leftOrTop = "leftOrTop".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.leftOrTop]
    
    inline def rightOrBottom: typingsJapgolly.devextreme.devextremeStrings.rightOrBottom = "rightOrBottom".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.rightOrBottom]
  }
