...
import typingsJapgolly.devextreme.anon.AllowMouseWheel
import typingsJapgolly.devextreme.anon.CheckTypeForAllData
import typingsJapgolly.devextreme.anon.ColorOffset
import typingsJapgolly.devextreme.anon.CustomizeSeries
import typingsJapgolly.devextreme.anon.HorizontalLine
import typingsJapgolly.devextreme.mod.DevExpress.common.SingleOrMultiple
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.ChartsLabelOverlap
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxChart.ArgumentAxisClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxChart.LegendClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxChart.SeriesClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxChart.SeriesHoverChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxChart.SeriesSelectionChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxChart.ZoomEndEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxChart.ZoomStartEvent
...
object dxChartOptions {
  ...
  extension [Self <: dxChartOptions](x: Self) {
    ...
    inline def setOnArgumentAxisClickFunction1(value: /* e */ ArgumentAxisClickEvent => Callback): Self = StObject.set(x, "onArgumentAxisClick", js.Any.fromFunction1((t0: /* e */ ArgumentAxisClickEvent) => value(t0).runNow()))
    ...
    inline def setOnLegendClickFunction1(value: /* e */ LegendClickEvent => Callback): Self = StObject.set(x, "onLegendClick", js.Any.fromFunction1((t0: /* e */ LegendClickEvent) => value(t0).runNow()))
    ...
    inline def setOnSeriesClickFunction1(value: /* e */ SeriesClickEvent => Callback): Self = StObject.set(x, "onSeriesClick", js.Any.fromFunction1((t0: /* e */ SeriesClickEvent) => value(t0).runNow()))
    
    inline def setOnSeriesClickUndefined: Self = StObject.set(x, "onSeriesClick", js.undefined)
    
    inline def setOnSeriesHoverChanged(value: /* e */ SeriesHoverChangedEvent => Callback): Self = StObject.set(x, "onSeriesHoverChanged", js.Any.fromFunction1((t0: /* e */ SeriesHoverChangedEvent) => value(t0).runNow()))
    
    inline def setOnSeriesHoverChangedUndefined: Self = StObject.set(x, "onSeriesHoverChanged", js.undefined)
    
    inline def setOnSeriesSelectionChanged(value: /* e */ SeriesSelectionChangedEvent => Callback): Self = StObject.set(x, "onSeriesSelectionChanged", js.Any.fromFunction1((t0: /* e */ SeriesSelectionChangedEvent) => value(t0).runNow()))
    
    inline def setOnSeriesSelectionChangedUndefined: Self = StObject.set(x, "onSeriesSelectionChanged", js.undefined)
    
    inline def setOnZoomEnd(value: /* e */ ZoomEndEvent => Callback): Self = StObject.set(x, "onZoomEnd", js.Any.fromFunction1((t0: /* e */ ZoomEndEvent) => value(t0).runNow()))
    
    inline def setOnZoomEndUndefined: Self = StObject.set(x, "onZoomEnd", js.undefined)
    
    inline def setOnZoomStart(value: /* e */ ZoomStartEvent => Callback): Self = StObject.set(x, "onZoomStart", js.Any.fromFunction1((t0: /* e */ ZoomStartEvent) => value(t0).runNow()))
