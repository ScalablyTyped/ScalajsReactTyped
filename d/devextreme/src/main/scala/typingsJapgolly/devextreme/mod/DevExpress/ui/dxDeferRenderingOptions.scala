...
import typingsJapgolly.devextreme.anon.Element
...
object dxDeferRenderingOptions {
  ...
  extension [Self <: dxDeferRenderingOptions](x: Self) {
    ...
    inline def setOnRendered(value: /* e */ Element => Callback): Self = StObject.set(x, "onRendered", js.Any.fromFunction1((t0: /* e */ Element) => value(t0).runNow()))
    
    inline def setOnRenderedUndefined: Self = StObject.set(x, "onRendered", js.undefined)
    
    inline def setOnShown(value: /* e */ Element => Callback): Self = StObject.set(x, "onShown", js.Any.fromFunction1((t0: /* e */ Element) => value(t0).runNow()))
