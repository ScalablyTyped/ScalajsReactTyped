...
import typingsJapgolly.devextreme.anon.Layer
import typingsJapgolly.devextreme.anon.Start
...
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.LegendItem
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.VectorMapMarkerShape
