...
import typingsJapgolly.devextreme.anon.Component
import typingsJapgolly.devextreme.mod.DevExpress.common.SearchMode
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.HeaderFilterGroupInterval
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.FilterLookupDataSource
...
object ColumnHeaderFilter {
  ...
  extension [Self <: ColumnHeaderFilter](x: Self) {
    ...
    inline def setDataSourceFunction1(value: /* options */ Component => Callback): Self = StObject.set(x, "dataSource", js.Any.fromFunction1((t0: /* options */ Component) => value(t0).runNow()))
