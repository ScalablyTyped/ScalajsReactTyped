...
import typingsJapgolly.devextreme.anon.ConnectorColor
import typingsJapgolly.devextreme.anon.EndAngle
...
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxBarGauge.TooltipHiddenEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxBarGauge.TooltipShownEvent
...
object dxBarGaugeOptions {
  ...
  extension [Self <: dxBarGaugeOptions](x: Self) {
    ...
    inline def setOnTooltipHidden(value: /* e */ TooltipHiddenEvent => Callback): Self = StObject.set(x, "onTooltipHidden", js.Any.fromFunction1((t0: /* e */ TooltipHiddenEvent) => value(t0).runNow()))
    
    inline def setOnTooltipHiddenUndefined: Self = StObject.set(x, "onTooltipHidden", js.undefined)
    
    inline def setOnTooltipShown(value: /* e */ TooltipShownEvent => Callback): Self = StObject.set(x, "onTooltipShown", js.Any.fromFunction1((t0: /* e */ TooltipShownEvent) => value(t0).runNow()))
