...
object BaseSparklineTooltip {
  ...
  def apply(
    ...
    contentTemplate: template | (js.Function2[/* pointsInfo */ js.Any, /* element */ dxElement, String | Element | JQuery]) = null,
    cornerRadius: Int | Double = null,
    customizeTooltip: /* pointsInfo */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (customizeTooltip != null) __obj.updateDynamic("customizeTooltip")(js.Any.fromFunction1((t0: /* pointsInfo */ js.Any) => customizeTooltip(t0).runNow()))
