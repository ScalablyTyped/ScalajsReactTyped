...
import typingsJapgolly.devextreme.anon.Bottom
import typingsJapgolly.devextreme.anon.Cancel
import typingsJapgolly.devextreme.anon.GridCell
import typingsJapgolly.devextreme.anon.RowCells
import typingsJapgolly.devextreme.anon.Size
...
import typingsJapgolly.devextreme.devextremeStrings.middle
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxGantt
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxGantt.GanttPdfExportDateRange
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxGantt.GanttPdfExportMode
...
object pdfExporter {
  ...
  type PdfDataGridCell = typingsJapgolly.devextreme.mod.DevExpress.excelExporter.DataGridCell
  ...
  object PdfExportDataGridProps {
    ...
    extension [Self <: PdfExportDataGridProps](x: Self) {
      ...
      inline def setCustomDrawCell(value: /* options */ Cancel => Callback): Self = StObject.set(x, "customDrawCell", js.Any.fromFunction1((t0: /* options */ Cancel) => value(t0).runNow()))
      
      inline def setCustomDrawCellUndefined: Self = StObject.set(x, "customDrawCell", js.undefined)
      
      inline def setCustomizeCell(value: /* options */ GridCell => Callback): Self = StObject.set(x, "customizeCell", js.Any.fromFunction1((t0: /* options */ GridCell) => value(t0).runNow()))
      ...
      inline def setOnRowExporting(value: /* options */ RowCells => Callback): Self = StObject.set(x, "onRowExporting", js.Any.fromFunction1((t0: /* options */ RowCells) => value(t0).runNow()))
