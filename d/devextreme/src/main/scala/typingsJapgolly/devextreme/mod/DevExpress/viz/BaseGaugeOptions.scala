...
object BaseGaugeOptions {
  ...
  extension [Self <: BaseGaugeOptions[?], TComponent](x: Self & BaseGaugeOptions[TComponent]) {
    ...
    inline def setOnTooltipHidden(value: /* e */ EventInfo[TComponent] & TooltipInfo => Callback): Self = StObject.set(x, "onTooltipHidden", js.Any.fromFunction1((t0: /* e */ EventInfo[TComponent] & TooltipInfo) => value(t0).runNow()))
    
    inline def setOnTooltipHiddenUndefined: Self = StObject.set(x, "onTooltipHidden", js.undefined)
    
    inline def setOnTooltipShown(value: /* e */ EventInfo[TComponent] & TooltipInfo => Callback): Self = StObject.set(x, "onTooltipShown", js.Any.fromFunction1((t0: /* e */ EventInfo[TComponent] & TooltipInfo) => value(t0).runNow()))
