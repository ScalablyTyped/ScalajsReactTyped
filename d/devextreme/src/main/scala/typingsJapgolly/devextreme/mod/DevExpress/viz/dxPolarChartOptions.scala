...
import typingsJapgolly.devextreme.anon.Argument
import typingsJapgolly.devextreme.anon.ConvertToAxisDataType
import typingsJapgolly.devextreme.anon.CustomizeSeriesNameField
...
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxPolarChart.LegendClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxPolarChart.SeriesClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxPolarChart.SeriesHoverChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxPolarChart.SeriesSelectionChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxPolarChart.ZoomEndEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxPolarChart.ZoomStartEvent
...
object dxPolarChartOptions {
  ...
  extension [Self <: dxPolarChartOptions](x: Self) {
    ...
    inline def setOnArgumentAxisClickFunction1(value: /* e */ Argument => Callback): Self = StObject.set(x, "onArgumentAxisClick", js.Any.fromFunction1((t0: /* e */ Argument) => value(t0).runNow()))
