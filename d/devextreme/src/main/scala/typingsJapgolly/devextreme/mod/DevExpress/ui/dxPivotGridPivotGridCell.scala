...
import typingsJapgolly.devextreme.devextremeStrings.D
import typingsJapgolly.devextreme.devextremeStrings.GT
import typingsJapgolly.devextreme.devextremeStrings.T
...
object dxPivotGridPivotGridCell {
  ...
  def apply(
    ...
    path: js.Array[String | Double | js.Date] = null,
