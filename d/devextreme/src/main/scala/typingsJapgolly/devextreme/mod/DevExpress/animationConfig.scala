...
import typingsJapgolly.devextreme.mod.DevExpress.animation.AnimationState
import typingsJapgolly.devextreme.mod.DevExpress.animation.AnimationType
import typingsJapgolly.devextreme.mod.DevExpress.common.Direction
...
object AnimationConfig {
  ...
  extension [Self <: AnimationConfig](x: Self) {
    ...
    inline def setComplete(value: (/* $element */ DxElement_[HTMLElement], /* config */ AnimationConfig) => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction2((t0: /* $element */ DxElement_[HTMLElement], t1: /* config */ AnimationConfig) => (value(t0, t1)).runNow()))
    ...
    inline def setStart(value: (/* $element */ DxElement_[HTMLElement], /* config */ AnimationConfig) => Callback): Self = StObject.set(x, "start", js.Any.fromFunction2((t0: /* $element */ DxElement_[HTMLElement], t1: /* config */ AnimationConfig) => (value(t0, t1)).runNow()))
