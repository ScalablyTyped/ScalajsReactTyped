...
import typingsJapgolly.devextreme.mod.DevExpress.viz.chartPointAggregationInfoObject
...
class chartPointObject ()
  extends typingsJapgolly.devextreme.mod.DevExpress.viz.chartPointObject {
