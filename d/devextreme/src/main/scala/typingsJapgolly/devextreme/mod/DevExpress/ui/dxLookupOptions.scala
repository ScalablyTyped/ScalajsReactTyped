...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxLookup.PageLoadingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxLookup.PullRefreshEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxLookup.ScrollEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxLookup.ValueChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxPopover.Properties
...
object dxLookupOptions {
  ...
  extension [Self <: dxLookupOptions](x: Self) {
    ...
    inline def setOnPageLoading(value: /* e */ PageLoadingEvent => Callback): Self = StObject.set(x, "onPageLoading", js.Any.fromFunction1((t0: /* e */ PageLoadingEvent) => value(t0).runNow()))
    
    inline def setOnPageLoadingUndefined: Self = StObject.set(x, "onPageLoading", js.undefined)
    
    inline def setOnPullRefresh(value: /* e */ PullRefreshEvent => Callback): Self = StObject.set(x, "onPullRefresh", js.Any.fromFunction1((t0: /* e */ PullRefreshEvent) => value(t0).runNow()))
    
    inline def setOnPullRefreshUndefined: Self = StObject.set(x, "onPullRefresh", js.undefined)
    
    inline def setOnScroll(value: /* e */ ScrollEvent => Callback): Self = StObject.set(x, "onScroll", js.Any.fromFunction1((t0: /* e */ ScrollEvent) => value(t0).runNow()))
