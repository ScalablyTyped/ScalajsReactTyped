...
import typingsJapgolly.devextreme.anon.ShowMode
...
trait dxSliderBaseOptions[TComponent]
  ...
  /**
    ...
    */
  var label: js.UndefOr[typingsJapgolly.devextreme.anon.Format] = js.undefined
...
object dxSliderBaseOptions {
  ...
  extension [Self <: dxSliderBaseOptions[?], TComponent](x: Self & dxSliderBaseOptions[TComponent]) {
    ...
    inline def setLabel(value: typingsJapgolly.devextreme.anon.Format): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
