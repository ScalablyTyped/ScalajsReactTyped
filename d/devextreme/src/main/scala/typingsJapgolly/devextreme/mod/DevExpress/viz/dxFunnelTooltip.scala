...
import typingsJapgolly.devextreme.AnonPercent
...
object dxFunnelTooltip {
  ...
  def apply(
    ...
    customizeTooltip: /* info */ AnonPercent => CallbackTo[js.Any] = null,
    ...
    if (customizeTooltip != null) __obj.updateDynamic("customizeTooltip")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.devextreme.AnonPercent) => customizeTooltip(t0).runNow()))
