...
import typingsJapgolly.devextreme.anon.CornerRadius
...
trait BaseLegend extends StObject {
  ...
  /**
    ...
    */
  var title: js.UndefOr[typingsJapgolly.devextreme.anon.HorizontalAlignment | String] = js.undefined
...
object BaseLegend {
  ...
  extension [Self <: BaseLegend](x: Self) {
    ...
    inline def setTitle(value: typingsJapgolly.devextreme.anon.HorizontalAlignment | String): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
