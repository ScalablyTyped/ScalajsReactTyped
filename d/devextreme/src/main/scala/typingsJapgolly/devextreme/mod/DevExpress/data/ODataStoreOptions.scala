...
trait ODataStoreOptions[TItem, TKey]
  ...
  var keyType: js.UndefOr[
    String | Int32 | Int64 | typingsJapgolly.devextreme.devextremeStrings.Guid | typingsJapgolly.devextreme.devextremeStrings.Boolean | Single | Decimal | Any
  ] = js.undefined
...
object ODataStoreOptions {
  ...
  extension [Self <: ODataStoreOptions[?, ?], TItem, TKey](x: Self & (ODataStoreOptions[TItem, TKey])) {
    ...
    inline def setKeyType(
      value: String | Int32 | Int64 | typingsJapgolly.devextreme.devextremeStrings.Guid | typingsJapgolly.devextreme.devextremeStrings.Boolean | Single | Decimal | Any
