...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.Item
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuDirection
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuHiddenEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuHidingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuShowingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxMenu.SubmenuShownEvent
...
object dxMenuOptions {
  ...
  extension [Self <: dxMenuOptions[?], TKey](x: Self & dxMenuOptions[TKey]) {
    ...
    inline def setOnContentReady(value: /* e */ EventInfo[dxMenu[TKey]] => Callback): Self = StObject.set(x, "onContentReady", js.Any.fromFunction1((t0: /* e */ EventInfo[dxMenu[TKey]]) => value(t0).runNow()))
    
    inline def setOnContentReadyUndefined: Self = StObject.set(x, "onContentReady", js.undefined)
    
    inline def setOnDisposing(value: /* e */ EventInfo[dxMenu[TKey]] => Callback): Self = StObject.set(x, "onDisposing", js.Any.fromFunction1((t0: /* e */ EventInfo[dxMenu[TKey]]) => value(t0).runNow()))
    
    inline def setOnDisposingUndefined: Self = StObject.set(x, "onDisposing", js.undefined)
    
    inline def setOnInitialized(value: /* e */ InitializedEventInfo[dxMenu[TKey]] => Callback): Self = StObject.set(x, "onInitialized", js.Any.fromFunction1((t0: /* e */ InitializedEventInfo[dxMenu[TKey]]) => value(t0).runNow()))
    ...
    inline def setOnItemClickFunction1(
      value: /* e */ (NativeEventInfo[dxMenu[TKey], MouseEvent | PointerEvent]) & ItemInfo[dxMenuItem] => Callback
    ): Self = StObject.set(x, "onItemClick", js.Any.fromFunction1((t0: /* e */ (NativeEventInfo[dxMenu[TKey], MouseEvent | PointerEvent]) & ItemInfo[dxMenuItem]) => value(t0).runNow()))
    
    inline def setOnItemClickUndefined: Self = StObject.set(x, "onItemClick", js.undefined)
    
    inline def setOnItemContextMenu(
      value: /* e */ (NativeEventInfo[dxMenu[TKey], MouseEvent | PointerEvent | TouchEvent]) & ItemInfo[dxMenuItem] => Callback
    ): Self = StObject.set(x, "onItemContextMenu", js.Any.fromFunction1((t0: /* e */ (NativeEventInfo[dxMenu[TKey], MouseEvent | PointerEvent | TouchEvent]) & ItemInfo[dxMenuItem]) => value(t0).runNow()))
    
    inline def setOnItemContextMenuUndefined: Self = StObject.set(x, "onItemContextMenu", js.undefined)
    
    inline def setOnItemHold(
      value: /* e */ (NativeEventInfo[dxMenu[TKey], MouseEvent | PointerEvent | TouchEvent]) & ItemInfo[dxMenuItem] => Callback
    ): Self = StObject.set(x, "onItemHold", js.Any.fromFunction1((t0: /* e */ (NativeEventInfo[dxMenu[TKey], MouseEvent | PointerEvent | TouchEvent]) & ItemInfo[dxMenuItem]) => value(t0).runNow()))
    
    inline def setOnItemHoldUndefined: Self = StObject.set(x, "onItemHold", js.undefined)
    
    inline def setOnItemRendered(value: /* e */ EventInfo[dxMenu[TKey]] & ItemInfo[dxMenuItem] => Callback): Self = StObject.set(x, "onItemRendered", js.Any.fromFunction1((t0: /* e */ EventInfo[dxMenu[TKey]] & ItemInfo[dxMenuItem]) => value(t0).runNow()))
    
    inline def setOnItemRenderedUndefined: Self = StObject.set(x, "onItemRendered", js.undefined)
    
    inline def setOnOptionChanged(value: /* e */ OptionChangedEventInfo[dxMenu[TKey]] => Callback): Self = StObject.set(x, "onOptionChanged", js.Any.fromFunction1((t0: /* e */ OptionChangedEventInfo[dxMenu[TKey]]) => value(t0).runNow()))
    
    inline def setOnOptionChangedUndefined: Self = StObject.set(x, "onOptionChanged", js.undefined)
    
    inline def setOnSelectionChanged(value: /* e */ EventInfo[dxMenu[TKey]] & SelectionChangedInfo[dxMenuItem] => Callback): Self = StObject.set(x, "onSelectionChanged", js.Any.fromFunction1((t0: /* e */ EventInfo[dxMenu[TKey]] & SelectionChangedInfo[dxMenuItem]) => value(t0).runNow()))
    
    inline def setOnSelectionChangedUndefined: Self = StObject.set(x, "onSelectionChanged", js.undefined)
    
    inline def setOnSubmenuHidden(value: /* e */ SubmenuHiddenEvent[TKey] => Callback): Self = StObject.set(x, "onSubmenuHidden", js.Any.fromFunction1((t0: /* e */ SubmenuHiddenEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnSubmenuHiddenUndefined: Self = StObject.set(x, "onSubmenuHidden", js.undefined)
    
    inline def setOnSubmenuHiding(value: /* e */ SubmenuHidingEvent[TKey] => Callback): Self = StObject.set(x, "onSubmenuHiding", js.Any.fromFunction1((t0: /* e */ SubmenuHidingEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnSubmenuHidingUndefined: Self = StObject.set(x, "onSubmenuHiding", js.undefined)
    
    inline def setOnSubmenuShowing(value: /* e */ SubmenuShowingEvent[TKey] => Callback): Self = StObject.set(x, "onSubmenuShowing", js.Any.fromFunction1((t0: /* e */ SubmenuShowingEvent[TKey]) => value(t0).runNow()))
    
    inline def setOnSubmenuShowingUndefined: Self = StObject.set(x, "onSubmenuShowing", js.undefined)
    
    inline def setOnSubmenuShown(value: /* e */ SubmenuShownEvent[TKey] => Callback): Self = StObject.set(x, "onSubmenuShown", js.Any.fromFunction1((t0: /* e */ SubmenuShownEvent[TKey]) => value(t0).runNow()))
