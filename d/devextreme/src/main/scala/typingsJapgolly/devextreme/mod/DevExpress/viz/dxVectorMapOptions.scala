...
import typingsJapgolly.devextreme.anon.BorderColorColor
import typingsJapgolly.devextreme.anon.BorderWidth
import typingsJapgolly.devextreme.anon.ColorGroupingField
import typingsJapgolly.devextreme.anon.Margin
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.CenterChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.ClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.SelectionChangedEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.TooltipHiddenEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.TooltipShownEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxVectorMap.ZoomFactorChangedEvent
...
object dxVectorMapOptions {
  ...
  extension [Self <: dxVectorMapOptions](x: Self) {
    ...
    inline def setOnCenterChanged(value: /* e */ CenterChangedEvent => Callback): Self = StObject.set(x, "onCenterChanged", js.Any.fromFunction1((t0: /* e */ CenterChangedEvent) => value(t0).runNow()))
    ...
    inline def setOnZoomFactorChanged(value: /* e */ ZoomFactorChangedEvent => Callback): Self = StObject.set(x, "onZoomFactorChanged", js.Any.fromFunction1((t0: /* e */ ZoomFactorChangedEvent) => value(t0).runNow()))
