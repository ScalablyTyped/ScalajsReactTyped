...
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxSparkline.SparklineType
...
trait dxSparklineOptions
  ...
  /**
    ...
    */
  var pointSymbol: js.UndefOr[PointSymbol] = js.undefined
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[SparklineType] = js.undefined
...
object dxSparklineOptions {
  ...
  extension [Self <: dxSparklineOptions](x: Self) {
    ...
    inline def setPointSymbol(value: PointSymbol): Self = StObject.set(x, "pointSymbol", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: SparklineType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
