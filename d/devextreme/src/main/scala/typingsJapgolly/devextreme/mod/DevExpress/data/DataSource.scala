...
import typingsJapgolly.devextreme.anon.Changes
import typingsJapgolly.devextreme.anon.Message
import typingsJapgolly.devextreme.anon.keyinEventNameFunctionChanged
import typingsJapgolly.devextreme.mod.DevExpress.core.utils.DxExtendedPromise
import typingsJapgolly.devextreme.mod.DevExpress.data.DataSource.EventName
...
trait DataSource[TItem, TKey]
  ...
  /**
    ...
    */
  def store(): typingsJapgolly.devextreme.mod.DevExpress.data.utils.Store[TItem, TKey] = js.native
...
object DataSource {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - js.Array[TItem]
    - typingsJapgolly.devextreme.mod.DevExpress.data.utils.Store[TItem, TKey]
    - typingsJapgolly.devextreme.mod.DevExpress.data.DataSource.DataSourceOptionsStub[scala.Any, scala.Any, TItem]
    - typingsJapgolly.devextreme.mod.DevExpress.data.DataSource[TItem, TKey]
  */
  ...
  trait DataSourceOptionsStub[TStoreItem, TMappedItem, TItem] extends StObject {
    ...
    var store: js.UndefOr[
        js.Array[TStoreItem] | (typingsJapgolly.devextreme.mod.DevExpress.data.utils.Store[TStoreItem, Any]) | (typingsJapgolly.devextreme.mod.DevExpress.data.utils.StoreOptions[TStoreItem, Any])
      ] = js.undefined
  }
  object DataSourceOptionsStub {
    ...
    extension [Self <: DataSourceOptionsStub[?, ?, ?], TStoreItem, TMappedItem, TItem](x: Self & (DataSourceOptionsStub[TStoreItem, TMappedItem, TItem])) {
      ...
      inline def setOnChanged(value: /* e */ Changes[TMappedItem] => Callback): Self = StObject.set(x, "onChanged", js.Any.fromFunction1((t0: /* e */ Changes[TMappedItem]) => value(t0).runNow()))
      
      inline def setOnChangedUndefined: Self = StObject.set(x, "onChanged", js.undefined)
      
      inline def setOnLoadError(value: /* error */ Message => Callback): Self = StObject.set(x, "onLoadError", js.Any.fromFunction1((t0: /* error */ Message) => value(t0).runNow()))
      ...
      inline def setStore(
        value: js.Array[TStoreItem] | (typingsJapgolly.devextreme.mod.DevExpress.data.utils.Store[TStoreItem, Any]) | (typingsJapgolly.devextreme.mod.DevExpress.data.utils.StoreOptions[TStoreItem, Any])
