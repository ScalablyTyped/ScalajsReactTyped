...
trait dxGanttSorting extends StObject {
  ...
  /**
    * Specifies sort mode.
    */
  var mode: js.UndefOr[SingleMultipleOrNone | String] = js.undefined
...
object dxGanttSorting {
  ...
  extension [Self <: dxGanttSorting](x: Self) {
    ...
    inline def setMode(value: SingleMultipleOrNone | String): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
