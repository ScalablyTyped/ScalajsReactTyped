...
object dxScheduler {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.devextreme.devextremeStrings.allDay
  ...
  */
  ...
  object AllDayPanelMode {
    ...
    inline def allDay: typingsJapgolly.devextreme.devextremeStrings.allDay = "allDay".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.allDay]
  ...
  trait AppointmentFormOpeningEvent
    ...
    val popup: dxPopup[typingsJapgolly.devextreme.mod.DevExpress.ui.dxPopup.Properties]
  }
  object AppointmentFormOpeningEvent {
    ...
    inline def apply(
      ...
      element: DxElement_[HTMLElement],
      form: dxForm,
      popup: dxPopup[typingsJapgolly.devextreme.mod.DevExpress.ui.dxPopup.Properties]
    ...
    extension [Self <: AppointmentFormOpeningEvent](x: Self) {
      ...
      inline def setPopup(value: dxPopup[typingsJapgolly.devextreme.mod.DevExpress.ui.dxPopup.Properties]): Self = StObject.set(x, "popup", value.asInstanceOf[js.Any])
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.devextreme.devextremeStrings.unlimited
  */
  ...
  object CellAppointmentsLimit {
    ...
    inline def unlimited: typingsJapgolly.devextreme.devextremeStrings.unlimited = "unlimited".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.unlimited]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.dialog
    - typingsJapgolly.devextreme.devextremeStrings.occurrence
    - typingsJapgolly.devextreme.devextremeStrings.series
  */
  trait RecurrenceEditMode extends StObject
  object RecurrenceEditMode {
    
    inline def dialog: typingsJapgolly.devextreme.devextremeStrings.dialog = "dialog".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.dialog]
    
    inline def occurrence: typingsJapgolly.devextreme.devextremeStrings.occurrence = "occurrence".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.occurrence]
    
    inline def series: typingsJapgolly.devextreme.devextremeStrings.series = "series".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.series]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.agenda
    - typingsJapgolly.devextreme.devextremeStrings.day
    - typingsJapgolly.devextreme.devextremeStrings.month
    - typingsJapgolly.devextreme.devextremeStrings.timelineDay
    - typingsJapgolly.devextreme.devextremeStrings.timelineMonth
    - typingsJapgolly.devextreme.devextremeStrings.timelineWeek
    - typingsJapgolly.devextreme.devextremeStrings.timelineWorkWeek
    - typingsJapgolly.devextreme.devextremeStrings.week
    - typingsJapgolly.devextreme.devextremeStrings.workWeek
  */
  trait ViewType extends StObject
  object ViewType {
    
    inline def agenda: typingsJapgolly.devextreme.devextremeStrings.agenda = "agenda".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.agenda]
    ...
    inline def timelineDay: typingsJapgolly.devextreme.devextremeStrings.timelineDay = "timelineDay".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.timelineDay]
    
    inline def timelineMonth: typingsJapgolly.devextreme.devextremeStrings.timelineMonth = "timelineMonth".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.timelineMonth]
    
    inline def timelineWeek: typingsJapgolly.devextreme.devextremeStrings.timelineWeek = "timelineWeek".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.timelineWeek]
    
    inline def timelineWorkWeek: typingsJapgolly.devextreme.devextremeStrings.timelineWorkWeek = "timelineWorkWeek".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.timelineWorkWeek]
    
    inline def week: typingsJapgolly.devextreme.devextremeStrings.week = "week".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.week]
    
    inline def workWeek: typingsJapgolly.devextreme.devextremeStrings.workWeek = "workWeek".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.workWeek]
  }
}
