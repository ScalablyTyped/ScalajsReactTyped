...
@js.native
class MapLayer ()
  extends typingsJapgolly.devextreme.mod.DevExpress.viz.MapLayer {
  ...
  /* CompleteClass */
  override def getElements(): js.Array[typingsJapgolly.devextreme.mod.DevExpress.viz.MapLayerElement] = js.native
}
