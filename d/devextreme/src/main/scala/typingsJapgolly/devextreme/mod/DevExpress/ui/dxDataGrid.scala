...
import typingsJapgolly.devextreme.anon.ComponentRow
import typingsJapgolly.devextreme.anon.Y
import typingsJapgolly.devextreme.devextremeStrings.pdf_
import typingsJapgolly.devextreme.devextremeStrings.xlsx
...
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.DataRenderMode
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.FilterOperation
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.FilterType
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.GridsEditMode
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.GridsEditRefreshMode
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.GroupExpandMode
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.NewRowPosition
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.SelectedFilterOperation
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.SelectionColumnDisplayMode
import typingsJapgolly.devextreme.mod.DevExpress.common.charts.StartEditAction
...
import typingsJapgolly.devextreme.mod.DevExpress.excelExporter.DataGridCell
...
object dxDataGrid {
  ...
  trait ColumnBase[TRowData] extends StObject {
    ...
    var customizeText: js.UndefOr[
        js.Function1[
          /* cellInfo */ typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnCustomizeTextArg, 
          String
        ]
      ] = js.undefined
    ...
    /**
      ...
      */
    var headerFilter: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnHeaderFilter] = js.undefined
    ...
    /**
      ...
      */
    var lookup: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnLookup] = js.undefined
  ...
  object ColumnBase {
    ...
    extension [Self <: ColumnBase[?], TRowData](x: Self & ColumnBase[TRowData]) {
      ...
      inline def setCustomizeText(
        value: /* cellInfo */ typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnCustomizeTextArg => String
      ...
      inline def setHeaderFilter(value: typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnHeaderFilter): Self = StObject.set(x, "headerFilter", value.asInstanceOf[js.Any])
      ...
      inline def setLookup(value: typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnLookup): Self = StObject.set(x, "lookup", value.asInstanceOf[js.Any])
  ...
  type ColumnChooser = typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnChooser
  
  type ColumnCustomizeTextArg = typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnCustomizeTextArg
  ...
  type ColumnFixing = typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnFixing
  
  type ColumnFixingTexts = typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnFixingTexts
  ...
  type ColumnHeaderFilter = typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnHeaderFilter
  
  type ColumnLookup = typingsJapgolly.devextreme.mod.DevExpress.common.grids.ColumnLookup
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.nextColumn
    - typingsJapgolly.devextreme.devextremeStrings.widget
  */
  trait ColumnResizeMode extends StObject
  object ColumnResizeMode {
    
    inline def nextColumn: typingsJapgolly.devextreme.devextremeStrings.nextColumn = "nextColumn".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.nextColumn]
    
    inline def widget: typingsJapgolly.devextreme.devextremeStrings.widget = "widget".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.widget]
  }
  ...
  type DataChange = typingsJapgolly.devextreme.mod.DevExpress.common.grids.DataChange[Any, Any]
  
  trait DataChangeInfo[TRowData, TKey] extends StObject {
    
    val changes: js.Array[
        typingsJapgolly.devextreme.mod.DevExpress.common.grids.DataChange[TRowData, TKey]
      ]
  }
  object DataChangeInfo {
    ...
    extension [Self <: DataChangeInfo[?, ?], TRowData, TKey](x: Self & (DataChangeInfo[TRowData, TKey])) {
      ...
      inline def setChangesVarargs(value: (typingsJapgolly.devextreme.mod.DevExpress.common.grids.DataChange[TRowData, TKey])*): Self = StObject.set(x, "changes", js.Array(value*))
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.devextreme.devextremeStrings.detailExpand
    - typingsJapgolly.devextreme.devextremeStrings.groupExpand
    - typingsJapgolly.devextreme.devextremeStrings.selection
  ...
  */
  ...
  object DataGridCommandColumnType {
    ...
    inline def detailExpand: typingsJapgolly.devextreme.devextremeStrings.detailExpand = "detailExpand".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.detailExpand]
    ...
    inline def groupExpand: typingsJapgolly.devextreme.devextremeStrings.groupExpand = "groupExpand".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.groupExpand]
    
    inline def selection: typingsJapgolly.devextreme.devextremeStrings.selection = "selection".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.selection]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.pdf_
    - typingsJapgolly.devextreme.devextremeStrings.xlsx
  */
  ...
  object DataGridExportFormat {
    ...
    inline def xlsx: typingsJapgolly.devextreme.devextremeStrings.xlsx = "xlsx".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.xlsx]
  }
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.devextreme.devextremeStrings.exportButton
    - typingsJapgolly.devextreme.devextremeStrings.groupPanel
  ...
  */
  ...
  object DataGridPredefinedToolbarItem {
    ...
    inline def exportButton: typingsJapgolly.devextreme.devextremeStrings.exportButton = "exportButton".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.exportButton]
    
    inline def groupPanel: typingsJapgolly.devextreme.devextremeStrings.groupPanel = "groupPanel".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.groupPanel]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.infinite
    - typingsJapgolly.devextreme.devextremeStrings.standard
    - typingsJapgolly.devextreme.devextremeStrings.virtual
  */
  trait DataGridScrollMode extends StObject
  object DataGridScrollMode {
    
    inline def infinite: typingsJapgolly.devextreme.devextremeStrings.infinite = "infinite".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.infinite]
    ...
    inline def virtual: typingsJapgolly.devextreme.devextremeStrings.virtual = "virtual".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.virtual]
  }
  ...
  trait EditingBase[TRowData, TKey] extends StObject {
    ...
    /**
      ...
      */
    var popup: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.ui.dxPopup.Properties] = js.undefined
  ...
  object EditingBase {
    ...
    extension [Self <: EditingBase[?, ?], TRowData, TKey](x: Self & (EditingBase[TRowData, TKey])) {
      ...
      inline def setPopup(value: typingsJapgolly.devextreme.mod.DevExpress.ui.dxPopup.Properties): Self = StObject.set(x, "popup", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.devextreme.devextremeStrings.centerContinuous
    - typingsJapgolly.devextreme.devextremeStrings.distributed
    - typingsJapgolly.devextreme.devextremeStrings.fill
    - typingsJapgolly.devextreme.devextremeStrings.general
    - typingsJapgolly.devextreme.devextremeStrings.justify
  ...
  */
  ...
  object ExcelCellHorizontalAlignment {
    ...
    inline def centerContinuous: typingsJapgolly.devextreme.devextremeStrings.centerContinuous = "centerContinuous".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.centerContinuous]
    
    inline def distributed: typingsJapgolly.devextreme.devextremeStrings.distributed = "distributed".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.distributed]
    
    inline def fill: typingsJapgolly.devextreme.devextremeStrings.fill = "fill".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.fill]
    ...
    inline def justify: typingsJapgolly.devextreme.devextremeStrings.justify = "justify".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.justify]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.devextreme.devextremeStrings.darkDown
    - typingsJapgolly.devextreme.devextremeStrings.darkGray
    - typingsJapgolly.devextreme.devextremeStrings.darkGrid
    - typingsJapgolly.devextreme.devextremeStrings.darkHorizontal
    - typingsJapgolly.devextreme.devextremeStrings.darkTrellis
    - typingsJapgolly.devextreme.devextremeStrings.darkUp
    - typingsJapgolly.devextreme.devextremeStrings.darkVertical
    - typingsJapgolly.devextreme.devextremeStrings.gray0625
    - typingsJapgolly.devextreme.devextremeStrings.gray125
    - typingsJapgolly.devextreme.devextremeStrings.lightDown
    - typingsJapgolly.devextreme.devextremeStrings.lightGray
    - typingsJapgolly.devextreme.devextremeStrings.lightGrid
    - typingsJapgolly.devextreme.devextremeStrings.lightHorizontal
    - typingsJapgolly.devextreme.devextremeStrings.lightTrellis
    - typingsJapgolly.devextreme.devextremeStrings.lightUp
    - typingsJapgolly.devextreme.devextremeStrings.lightVertical
    - typingsJapgolly.devextreme.devextremeStrings.mediumGray
    - typingsJapgolly.devextreme.devextremeStrings.none
    - typingsJapgolly.devextreme.devextremeStrings.solid
  */
  trait ExcelCellPatternType extends StObject
  object ExcelCellPatternType {
    
    inline def darkDown: typingsJapgolly.devextreme.devextremeStrings.darkDown = "darkDown".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.darkDown]
    
    inline def darkGray: typingsJapgolly.devextreme.devextremeStrings.darkGray = "darkGray".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.darkGray]
    
    inline def darkGrid: typingsJapgolly.devextreme.devextremeStrings.darkGrid = "darkGrid".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.darkGrid]
    
    inline def darkHorizontal: typingsJapgolly.devextreme.devextremeStrings.darkHorizontal = "darkHorizontal".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.darkHorizontal]
    
    inline def darkTrellis: typingsJapgolly.devextreme.devextremeStrings.darkTrellis = "darkTrellis".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.darkTrellis]
    
    inline def darkUp: typingsJapgolly.devextreme.devextremeStrings.darkUp = "darkUp".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.darkUp]
    
    inline def darkVertical: typingsJapgolly.devextreme.devextremeStrings.darkVertical = "darkVertical".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.darkVertical]
    
    inline def gray0625: typingsJapgolly.devextreme.devextremeStrings.gray0625 = "gray0625".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.gray0625]
    
    inline def gray125: typingsJapgolly.devextreme.devextremeStrings.gray125 = "gray125".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.gray125]
    
    inline def lightDown: typingsJapgolly.devextreme.devextremeStrings.lightDown = "lightDown".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.lightDown]
    
    inline def lightGray: typingsJapgolly.devextreme.devextremeStrings.lightGray = "lightGray".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.lightGray]
    
    inline def lightGrid: typingsJapgolly.devextreme.devextremeStrings.lightGrid = "lightGrid".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.lightGrid]
    
    inline def lightHorizontal: typingsJapgolly.devextreme.devextremeStrings.lightHorizontal = "lightHorizontal".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.lightHorizontal]
    
    inline def lightTrellis: typingsJapgolly.devextreme.devextremeStrings.lightTrellis = "lightTrellis".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.lightTrellis]
    
    inline def lightUp: typingsJapgolly.devextreme.devextremeStrings.lightUp = "lightUp".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.lightUp]
    
    inline def lightVertical: typingsJapgolly.devextreme.devextremeStrings.lightVertical = "lightVertical".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.lightVertical]
    
    inline def mediumGray: typingsJapgolly.devextreme.devextremeStrings.mediumGray = "mediumGray".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.mediumGray]
    ...
    inline def solid: typingsJapgolly.devextreme.devextremeStrings.solid = "solid".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.solid]
  }
  ...
  */
  ...
  trait ExplicitTypes[TRowData, TKey] extends StObject {
    ...
    var AdaptiveDetailRowPreparingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.AdaptiveDetailRowPreparingEvent[TRowData, TKey]
    
    var CellClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.CellClickEvent[TRowData, TKey]
    
    var CellDblClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.CellDblClickEvent[TRowData, TKey]
    
    var CellHoverChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.CellHoverChangedEvent[TRowData, TKey]
    
    var CellPreparedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.CellPreparedEvent[TRowData, TKey]
    
    var Column: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Column[TRowData, TKey]
    
    var ColumnButton: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ColumnButton[TRowData, TKey]
    
    var ColumnButtonClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ColumnButtonClickEvent[TRowData, TKey]
    
    var ColumnButtonTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ColumnButtonTemplateData[TRowData, TKey]
    
    var ColumnCellTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ColumnCellTemplateData[TRowData, TKey]
    
    var ColumnEditCellTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ColumnEditCellTemplateData[TRowData, TKey]
    
    var ColumnGroupCellTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ColumnGroupCellTemplateData[TRowData, TKey]
    
    var ColumnHeaderCellTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ColumnHeaderCellTemplateData[TRowData, TKey]
    
    var ContentReadyEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ContentReadyEvent[TRowData, TKey]
    
    var ContextMenuPreparingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ContextMenuPreparingEvent[TRowData, TKey]
    
    var CustomSummaryInfo: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.CustomSummaryInfo[TRowData, TKey]
    
    var DataErrorOccurredEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.DataErrorOccurredEvent[TRowData, TKey]
    
    var DataRowTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.DataRowTemplateData[TRowData, TKey]
    
    var DisposingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.DisposingEvent[TRowData, TKey]
    
    var EditCanceledEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.EditCanceledEvent[TRowData, TKey]
    
    var EditCancelingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.EditCancelingEvent[TRowData, TKey]
    
    var Editing: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Editing[TRowData, TKey]
    
    var EditingStartEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.EditingStartEvent[TRowData, TKey]
    
    var EditorPreparedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.EditorPreparedEvent[TRowData, TKey]
    
    var EditorPreparingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.EditorPreparingEvent[TRowData, TKey]
    
    var ExcelCellInfo: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ExcelCellInfo[TRowData, TKey]
    
    var Export: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Export[TRowData, TKey]
    
    var ExportTexts: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ExportTexts
    
    var ExportedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ExportedEvent[TRowData, TKey]
    
    var ExportingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ExportingEvent[TRowData, TKey]
    
    var FileSavingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.FileSavingEvent[TRowData, TKey]
    
    var FocusedCellChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.FocusedCellChangedEvent[TRowData, TKey]
    
    var FocusedCellChangingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.FocusedCellChangingEvent[TRowData, TKey]
    
    var FocusedRowChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.FocusedRowChangedEvent[TRowData, TKey]
    
    var FocusedRowChangingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.FocusedRowChangingEvent[TRowData, TKey]
    
    var GroupData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.GroupData[TRowData]
    
    var GroupPanel: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.GroupPanel
    
    var Grouping: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Grouping
    
    var GroupingTexts: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.GroupingTexts
    
    var InitNewRowEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.InitNewRowEvent[TRowData, TKey]
    
    var InitializedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.InitializedEvent[TRowData, TKey]
    
    var KeyDownEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.KeyDownEvent[TRowData, TKey]
    
    var MasterDetail: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.MasterDetail[TRowData, TKey]
    
    var MasterDetailTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.MasterDetailTemplateData[TRowData, TKey]
    
    var OptionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.OptionChangedEvent[TRowData, TKey]
    
    var Properties: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Properties[TRowData, TKey]
    
    var Row: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Row[TRowData, TKey]
    
    var RowClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowClickEvent[TRowData, TKey]
    
    var RowCollapsedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowCollapsedEvent[TRowData, TKey]
    
    var RowCollapsingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowCollapsingEvent[TRowData, TKey]
    
    var RowDblClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDblClickEvent[TRowData, TKey]
    
    var RowDraggingAddEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDraggingAddEvent[TRowData, TKey]
    
    var RowDraggingChangeEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDraggingChangeEvent[TRowData, TKey]
    
    var RowDraggingEndEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDraggingEndEvent[TRowData, TKey]
    
    var RowDraggingMoveEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDraggingMoveEvent[TRowData, TKey]
    
    var RowDraggingRemoveEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDraggingRemoveEvent[TRowData, TKey]
    
    var RowDraggingReorderEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDraggingReorderEvent[TRowData, TKey]
    
    var RowDraggingStartEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDraggingStartEvent[TRowData, TKey]
    
    var RowDraggingTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowDraggingTemplateData[TRowData]
    
    var RowExpandedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowExpandedEvent[TRowData, TKey]
    
    var RowExpandingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowExpandingEvent[TRowData, TKey]
    
    var RowInsertedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowInsertedEvent[TRowData, TKey]
    
    var RowInsertingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowInsertingEvent[TRowData, TKey]
    
    var RowPreparedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowPreparedEvent[TRowData, TKey]
    
    var RowRemovedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowRemovedEvent[TRowData, TKey]
    
    var RowRemovingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowRemovingEvent[TRowData, TKey]
    
    var RowTemplateData: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowTemplateData[TRowData, TKey]
    
    var RowUpdatedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowUpdatedEvent[TRowData, TKey]
    
    var RowUpdatingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowUpdatingEvent[TRowData, TKey]
    
    var RowValidatingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.RowValidatingEvent[TRowData, TKey]
    
    var SavedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.SavedEvent[TRowData, TKey]
    
    var SavingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.SavingEvent[TRowData, TKey]
    
    var Scrolling: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Scrolling
    
    var Selection: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Selection
    
    var SelectionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.SelectionChangedEvent[TRowData, TKey]
    
    var Summary: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Summary[TRowData, TKey]
    
    var SummaryGroupItem: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.SummaryGroupItem
    
    var SummaryItemTextInfo: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.SummaryItemTextInfo
    
    var SummaryTexts: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.SummaryTexts
    
    var SummaryTotalItem: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.SummaryTotalItem
    
    var Toolbar: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.Toolbar
    
    var ToolbarItem: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ToolbarItem
    
    var ToolbarPreparingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxDataGrid.ToolbarPreparingEvent[TRowData, TKey]
  }
  ...
  object Export {
    ...
    extension [Self <: Export[?, ?], TRowData, TKey](x: Self & (Export[TRowData, TKey])) {
      ...
      inline def setCustomizeExcelCell(value: /* options */ ExcelCellInfo[TRowData, TKey] => Callback): Self = StObject.set(x, "customizeExcelCell", js.Any.fromFunction1((t0: /* options */ ExcelCellInfo[TRowData, TKey]) => value(t0).runNow()))
  ...
  trait FilterPanel[T /* <: GridBase[TRowData, TKey] */, TRowData, TKey] extends StObject {
    ...
    /**
      ...
      */
    var texts: js.UndefOr[typingsJapgolly.devextreme.mod.DevExpress.common.grids.FilterPanelTexts] = js.undefined
  ...
  object FilterPanel {
    ...
    extension [Self <: FilterPanel[?, ?, ?], T /* <: GridBase[TRowData, TKey] */, TRowData, TKey](x: Self & (FilterPanel[T, TRowData, TKey])) {
      ...
      inline def setTexts(value: typingsJapgolly.devextreme.mod.DevExpress.common.grids.FilterPanelTexts): Self = StObject.set(x, "texts", value.asInstanceOf[js.Any])
  ...
  type FilterPanelTexts = typingsJapgolly.devextreme.mod.DevExpress.common.grids.FilterPanelTexts
  
  type FilterRow = typingsJapgolly.devextreme.mod.DevExpress.common.grids.FilterRow
  
  type FilterRowOperationDescriptions = typingsJapgolly.devextreme.mod.DevExpress.common.grids.FilterRowOperationDescriptions
  ...
  type HeaderFilter = typingsJapgolly.devextreme.mod.DevExpress.common.grids.HeaderFilter
  ...
  */
  ...
  object HeaderFilterGroupInterval {
    ...
    inline def hour: typingsJapgolly.devextreme.devextremeStrings.hour = "hour".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.hour]
    
    inline def minute: typingsJapgolly.devextreme.devextremeStrings.minute = "minute".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.minute]
    ...
    inline def second: typingsJapgolly.devextreme.devextremeStrings.second = "second".asInstanceOf[typingsJapgolly.devextreme.devextremeStrings.second]
  ...
  type HeaderFilterTexts = typingsJapgolly.devextreme.mod.DevExpress.common.grids.HeaderFilterTexts
  ...
  type KeyboardNavigation = typingsJapgolly.devextreme.mod.DevExpress.common.grids.KeyboardNavigation
  
  type LoadPanel = typingsJapgolly.devextreme.mod.DevExpress.common.grids.LoadPanel
  ...
  type Pager = typingsJapgolly.devextreme.mod.DevExpress.common.grids.Pager
  ...
  object RowDragging {
    ...
    extension [Self <: RowDragging[?, ?, ?], T /* <: GridBase[TRowData, TKey] */, TRowData, TKey](x: Self & (RowDragging[T, TRowData, TKey])) {
      ...
      inline def setOnAdd(value: /* e */ (RowDraggingEventInfo[T, TRowData, TKey]) & DragDropInfo => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction1((t0: /* e */ (RowDraggingEventInfo[T, TRowData, TKey]) & DragDropInfo) => value(t0).runNow()))
      
      inline def setOnAddUndefined: Self = StObject.set(x, "onAdd", js.undefined)
      
      inline def setOnDragChange(value: /* e */ Cancelable & (RowDraggingEventInfo[T, TRowData, TKey]) & DragDropInfo => Callback): Self = StObject.set(x, "onDragChange", js.Any.fromFunction1((t0: /* e */ Cancelable & (RowDraggingEventInfo[T, TRowData, TKey]) & DragDropInfo) => value(t0).runNow()))
      
      inline def setOnDragChangeUndefined: Self = StObject.set(x, "onDragChange", js.undefined)
      
      inline def setOnDragEnd(value: /* e */ Cancelable & (RowDraggingEventInfo[T, TRowData, TKey]) & DragDropInfo => Callback): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1((t0: /* e */ Cancelable & (RowDraggingEventInfo[T, TRowData, TKey]) & DragDropInfo) => value(t0).runNow()))
      
      inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
      
      inline def setOnDragMove(value: /* e */ Cancelable & (RowDraggingEventInfo[T, TRowData, TKey]) & DragDropInfo => Callback): Self = StObject.set(x, "onDragMove", js.Any.fromFunction1((t0: /* e */ Cancelable & (RowDraggingEventInfo[T, TRowData, TKey]) & DragDropInfo) => value(t0).runNow()))
      
      inline def setOnDragMoveUndefined: Self = StObject.set(x, "onDragMove", js.undefined)
      
      inline def setOnDragStart(value: /* e */ Cancelable & (DragStartEventInfo[T, TRowData, TKey]) => Callback): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: /* e */ Cancelable & (DragStartEventInfo[T, TRowData, TKey])) => value(t0).runNow()))
      
      inline def setOnDragStartUndefined: Self = StObject.set(x, "onDragStart", js.undefined)
      
      inline def setOnRemove(value: /* e */ RowDraggingEventInfo[T, TRowData, TKey] => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* e */ RowDraggingEventInfo[T, TRowData, TKey]) => value(t0).runNow()))
      
      inline def setOnRemoveUndefined: Self = StObject.set(x, "onRemove", js.undefined)
      
      inline def setOnReorder(
        value: /* e */ (RowDraggingEventInfo[dxDataGrid[TRowData, TKey], TRowData, TKey]) & DragReorderInfo => Callback
      ): Self = StObject.set(x, "onReorder", js.Any.fromFunction1((t0: /* e */ (RowDraggingEventInfo[dxDataGrid[TRowData, TKey], TRowData, TKey]) & DragReorderInfo) => value(t0).runNow()))
  ...
  type SearchPanel = typingsJapgolly.devextreme.mod.DevExpress.common.grids.SearchPanel
  ...
  type Sorting = typingsJapgolly.devextreme.mod.DevExpress.common.grids.Sorting
  
  type StateStoring = typingsJapgolly.devextreme.mod.DevExpress.common.grids.StateStoring
  ...
  object Summary {
    ...
    extension [Self <: Summary[?, ?], TRowData, TKey](x: Self & (Summary[TRowData, TKey])) {
      ...
      inline def setCalculateCustomSummary(value: /* options */ CustomSummaryInfo[TRowData, TKey] => Callback): Self = StObject.set(x, "calculateCustomSummary", js.Any.fromFunction1((t0: /* options */ CustomSummaryInfo[TRowData, TKey]) => value(t0).runNow()))
