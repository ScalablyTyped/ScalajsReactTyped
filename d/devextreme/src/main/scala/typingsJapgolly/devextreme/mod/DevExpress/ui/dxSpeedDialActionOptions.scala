...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxSpeedDialAction.ClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxSpeedDialAction.ContentReadyEvent
...
object dxSpeedDialActionOptions {
  ...
  extension [Self <: dxSpeedDialActionOptions](x: Self) {
    ...
    inline def setOnClick(value: /* e */ ClickEvent => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* e */ ClickEvent) => value(t0).runNow()))
    
    inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
    
    inline def setOnContentReady(value: /* e */ ContentReadyEvent => Callback): Self = StObject.set(x, "onContentReady", js.Any.fromFunction1((t0: /* e */ ContentReadyEvent) => value(t0).runNow()))
