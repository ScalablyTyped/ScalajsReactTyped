...
object dxChartSeriesTypesCandleStickSeries {
  @scala.inline
  def apply(
    aggregation: dxChartSeriesTypesCandleStickSeriesAggregation = null,
    ...
    hoverStyle: dxChartSeriesTypesCandleStickSeriesHoverStyle = null,
    ignoreEmptyPoints: js.UndefOr[Boolean] = js.undefined,
    innerColor: String = null,
    label: dxChartSeriesTypesCandleStickSeriesLabel = null,
    ...
    selectionStyle: dxChartSeriesTypesCandleStickSeriesSelectionStyle = null,
  ...
  ): dxChartSeriesTypesCandleStickSeries = {
