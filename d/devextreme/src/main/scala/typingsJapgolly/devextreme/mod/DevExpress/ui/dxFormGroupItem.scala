...
import typingsJapgolly.devextreme.AnonFormData
...
trait dxFormGroupItem extends js.Object {
  ...
  var template: js.UndefOr[
    typingsJapgolly.devextreme.mod.DevExpress.core.template | (js.Function2[/* data */ AnonFormData, /* itemElement */ dxElement, String | Element | JQuery])
  ] = js.undefined
...
object dxFormGroupItem {
  ...
  def apply(
    ...
    name: String = null,
    template: typingsJapgolly.devextreme.mod.DevExpress.core.template | (js.Function2[/* data */ AnonFormData, /* itemElement */ dxElement, String | Element | JQuery]) = null,
