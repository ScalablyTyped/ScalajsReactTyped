...
object BaseGaugeTooltip {
  ...
  def apply(
    ...
    customizeTooltip: /* scaleValue */ AnonValueText => CallbackTo[js.Any] = null,
    ...
    if (customizeTooltip != null) __obj.updateDynamic("customizeTooltip")(js.Any.fromFunction1((t0: /* scaleValue */ typingsJapgolly.devextreme.AnonValueText) => customizeTooltip(t0).runNow()))
