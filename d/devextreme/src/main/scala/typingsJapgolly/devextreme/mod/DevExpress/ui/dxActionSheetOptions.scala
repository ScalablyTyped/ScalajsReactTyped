...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.CancelClickEvent
...
object dxActionSheetOptions {
  ...
  extension [Self <: dxActionSheetOptions[?, ?], TItem /* <: ItemLike[TKey] */, TKey](x: Self & (dxActionSheetOptions[TItem, TKey])) {
    ...
    inline def setOnCancelClickFunction1(value: /* e */ CancelClickEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onCancelClick", js.Any.fromFunction1((t0: /* e */ CancelClickEvent[TItem, TKey]) => value(t0).runNow()))
