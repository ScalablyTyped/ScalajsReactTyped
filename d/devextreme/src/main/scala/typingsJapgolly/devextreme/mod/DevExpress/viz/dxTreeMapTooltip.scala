...
import typingsJapgolly.devextreme.AnonNodeValue
...
object dxTreeMapTooltip {
  ...
  def apply(
    ...
    customizeTooltip: /* info */ AnonNodeValue => CallbackTo[js.Any] = null,
    ...
    if (customizeTooltip != null) __obj.updateDynamic("customizeTooltip")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.devextreme.AnonNodeValue) => customizeTooltip(t0).runNow()))
