...
object dxTabPanel {
  ...
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    ...
    var ContentReadyEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.ItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.OptionChangedEvent[TItem, TKey]
    
    var Properties: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.Properties[TItem, TKey]
    
    var SelectionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.SelectionChangedEvent[TItem, TKey]
    
    var TitleClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.TitleClickEvent[TItem, TKey]
    
    var TitleHoldEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.TitleHoldEvent[TItem, TKey]
    
    var TitleRenderedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabPanel.TitleRenderedEvent[TItem, TKey]
  }
