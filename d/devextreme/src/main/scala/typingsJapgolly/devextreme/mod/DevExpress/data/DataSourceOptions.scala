...
trait DataSourceOptions[TStoreItem, TMappedItem, TItem, TKey] extends StObject {
  ...
  var store: js.UndefOr[
    js.Array[TStoreItem] | (typingsJapgolly.devextreme.mod.DevExpress.data.utils.Store[TStoreItem, TKey]) | (typingsJapgolly.devextreme.mod.DevExpress.data.utils.StoreOptions[TStoreItem, TKey])
  ] = js.undefined
}
object DataSourceOptions {
  ...
  extension [Self <: DataSourceOptions[?, ?, ?, ?], TStoreItem, TMappedItem, TItem, TKey](x: Self & (DataSourceOptions[TStoreItem, TMappedItem, TItem, TKey])) {
    ...
    inline def setStore(
      value: js.Array[TStoreItem] | (typingsJapgolly.devextreme.mod.DevExpress.data.utils.Store[TStoreItem, TKey]) | (typingsJapgolly.devextreme.mod.DevExpress.data.utils.StoreOptions[TStoreItem, TKey])
