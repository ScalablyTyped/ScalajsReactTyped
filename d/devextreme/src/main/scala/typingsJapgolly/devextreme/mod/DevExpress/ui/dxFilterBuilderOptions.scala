...
import typingsJapgolly.devextreme.anon.And
import typingsJapgolly.devextreme.anon.Between
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.CustomOperation
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.EditorPreparedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.EditorPreparingEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.Field
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.GroupOperation
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxFilterBuilder.ValueChangedEvent
...
trait dxFilterBuilderOptions
  ...
  /**
    ...
    */
  var groupOperations: js.UndefOr[js.Array[GroupOperation]] = js.undefined
...
object dxFilterBuilderOptions {
  ...
  extension [Self <: dxFilterBuilderOptions](x: Self) {
    ...
    inline def setGroupOperations(value: js.Array[GroupOperation]): Self = StObject.set(x, "groupOperations", value.asInstanceOf[js.Any])
    
    inline def setGroupOperationsUndefined: Self = StObject.set(x, "groupOperations", js.undefined)
    
    inline def setGroupOperationsVarargs(value: GroupOperation*): Self = StObject.set(x, "groupOperations", js.Array(value*))
    ...
    inline def setOnEditorPrepared(value: /* e */ EditorPreparedEvent => Callback): Self = StObject.set(x, "onEditorPrepared", js.Any.fromFunction1((t0: /* e */ EditorPreparedEvent) => value(t0).runNow()))
    
    inline def setOnEditorPreparedUndefined: Self = StObject.set(x, "onEditorPrepared", js.undefined)
    
    inline def setOnEditorPreparing(value: /* e */ EditorPreparingEvent => Callback): Self = StObject.set(x, "onEditorPreparing", js.Any.fromFunction1((t0: /* e */ EditorPreparingEvent) => value(t0).runNow()))
