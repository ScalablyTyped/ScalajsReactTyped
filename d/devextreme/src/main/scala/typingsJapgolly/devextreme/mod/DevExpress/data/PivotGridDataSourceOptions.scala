...
import typingsJapgolly.devextreme.AnonType
...
object PivotGridDataSourceOptions {
  ...
  def apply(
    ...
    onFieldsPrepared: /* fields */ js.Array[PivotGridDataSourceField] => CallbackTo[js.Any] = null,
    onLoadError: /* error */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (onFieldsPrepared != null) __obj.updateDynamic("onFieldsPrepared")(js.Any.fromFunction1((t0: /* fields */ js.Array[typingsJapgolly.devextreme.mod.DevExpress.data.PivotGridDataSourceField]) => onFieldsPrepared(t0).runNow()))
    if (onLoadError != null) __obj.updateDynamic("onLoadError")(js.Any.fromFunction1((t0: /* error */ js.Any) => onLoadError(t0).runNow()))
