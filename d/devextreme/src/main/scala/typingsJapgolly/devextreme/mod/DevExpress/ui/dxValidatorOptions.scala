...
import typingsJapgolly.devextreme.anon.ApplyValidationResults
import typingsJapgolly.devextreme.mod.DevExpress.DOMComponentOptions
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxValidator.ValidatedEvent
...
object dxValidatorOptions {
  ...
  extension [Self <: dxValidatorOptions](x: Self) {
    ...
    inline def setOnValidated(value: /* validatedInfo */ ValidatedEvent => Callback): Self = StObject.set(x, "onValidated", js.Any.fromFunction1((t0: /* validatedInfo */ ValidatedEvent) => value(t0).runNow()))
