...
object dxActionSheet {
  ...
  trait ExplicitTypes[TItem /* <: ItemLike[TKey] */, TKey] extends StObject {
    ...
    var CancelClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.CancelClickEvent[TItem, TKey]
    
    var ContentReadyEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.ItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.OptionChangedEvent[TItem, TKey]
    
    var Properties: typingsJapgolly.devextreme.mod.DevExpress.ui.dxActionSheet.Properties[TItem, TKey]
  }
