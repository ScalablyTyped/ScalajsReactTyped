...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxHtmlEditor.FocusInEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxHtmlEditor.FocusOutEvent
...
object dxHtmlEditorOptions {
  ...
  extension [Self <: dxHtmlEditorOptions](x: Self) {
    ...
    inline def setCustomizeModules(value: /* config */ Any => Callback): Self = StObject.set(x, "customizeModules", js.Any.fromFunction1((t0: /* config */ Any) => value(t0).runNow()))
    ...
    inline def setOnFocusIn(value: /* e */ FocusInEvent => Callback): Self = StObject.set(x, "onFocusIn", js.Any.fromFunction1((t0: /* e */ FocusInEvent) => value(t0).runNow()))
    
    inline def setOnFocusInUndefined: Self = StObject.set(x, "onFocusIn", js.undefined)
    
    inline def setOnFocusOut(value: /* e */ FocusOutEvent => Callback): Self = StObject.set(x, "onFocusOut", js.Any.fromFunction1((t0: /* e */ FocusOutEvent) => value(t0).runNow()))
