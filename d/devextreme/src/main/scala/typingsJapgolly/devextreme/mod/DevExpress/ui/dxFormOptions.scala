...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxForm.EditorEnterKeyEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxForm.FieldDataChangedEvent
...
object dxFormOptions {
  ...
  extension [Self <: dxFormOptions](x: Self) {
    ...
    inline def setCustomizeItem(value: /* item */ Item => Callback): Self = StObject.set(x, "customizeItem", js.Any.fromFunction1((t0: /* item */ Item) => value(t0).runNow()))
    ...
    inline def setOnEditorEnterKey(value: /* e */ EditorEnterKeyEvent => Callback): Self = StObject.set(x, "onEditorEnterKey", js.Any.fromFunction1((t0: /* e */ EditorEnterKeyEvent) => value(t0).runNow()))
    
    inline def setOnEditorEnterKeyUndefined: Self = StObject.set(x, "onEditorEnterKey", js.undefined)
    
    inline def setOnFieldDataChanged(value: /* e */ FieldDataChangedEvent => Callback): Self = StObject.set(x, "onFieldDataChanged", js.Any.fromFunction1((t0: /* e */ FieldDataChangedEvent) => value(t0).runNow()))
