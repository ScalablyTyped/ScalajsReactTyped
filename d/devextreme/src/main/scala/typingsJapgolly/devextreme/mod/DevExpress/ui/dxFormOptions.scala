...
import typingsJapgolly.devextreme.AnonComponentDataField
import typingsJapgolly.devextreme.AnonComponentElement
import typingsJapgolly.devextreme.AnonDataFieldElement
...
object dxFormOptions {
  ...
  def apply(
    ...
    customizeItem: /* item */ dxFormSimpleItem | dxFormGroupItem | dxFormTabbedItem | dxFormEmptyItem | dxFormButtonItem => CallbackTo[js.Any] = null,
    ...
    onContentReady: /* e */ AnonComponentElement[dxForm] => CallbackTo[js.Any] = null,
    onDisposing: /* e */ AnonModel[dxForm] => CallbackTo[js.Any] = null,
    onEditorEnterKey: /* e */ AnonComponentDataField => CallbackTo[js.Any] = null,
    onFieldDataChanged: /* e */ AnonDataFieldElement => CallbackTo[js.Any] = null,
    onInitialized: /* e */ AnonElement[dxForm] => CallbackTo[js.Any] = null,
    onOptionChanged: /* e */ AnonName[dxForm] => CallbackTo[js.Any] = null,
    ...
    if (customizeItem != null) __obj.updateDynamic("customizeItem")(js.Any.fromFunction1((t0: /* item */ typingsJapgolly.devextreme.mod.DevExpress.ui.dxFormSimpleItem | typingsJapgolly.devextreme.mod.DevExpress.ui.dxFormGroupItem | typingsJapgolly.devextreme.mod.DevExpress.ui.dxFormTabbedItem | typingsJapgolly.devextreme.mod.DevExpress.ui.dxFormEmptyItem | typingsJapgolly.devextreme.mod.DevExpress.ui.dxFormButtonItem) => customizeItem(t0).runNow()))
    ...
    if (onContentReady != null) __obj.updateDynamic("onContentReady")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonComponentElement[typingsJapgolly.devextreme.mod.DevExpress.ui.dxForm]) => onContentReady(t0).runNow()))
    if (onDisposing != null) __obj.updateDynamic("onDisposing")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonModel[typingsJapgolly.devextreme.mod.DevExpress.ui.dxForm]) => onDisposing(t0).runNow()))
    if (onEditorEnterKey != null) __obj.updateDynamic("onEditorEnterKey")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonComponentDataField) => onEditorEnterKey(t0).runNow()))
    if (onFieldDataChanged != null) __obj.updateDynamic("onFieldDataChanged")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonDataFieldElement) => onFieldDataChanged(t0).runNow()))
    if (onInitialized != null) __obj.updateDynamic("onInitialized")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonElement[typingsJapgolly.devextreme.mod.DevExpress.ui.dxForm]) => onInitialized(t0).runNow()))
    if (onOptionChanged != null) __obj.updateDynamic("onOptionChanged")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonName[typingsJapgolly.devextreme.mod.DevExpress.ui.dxForm]) => onOptionChanged(t0).runNow()))
