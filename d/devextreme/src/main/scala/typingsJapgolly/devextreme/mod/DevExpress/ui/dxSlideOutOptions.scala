...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.MenuGroupRenderedEvent
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxSlideOut.MenuItemRenderedEvent
...
object dxSlideOutOptions {
  ...
  extension [Self <: dxSlideOutOptions[?, ?], TItem /* <: ItemLike */, TKey](x: Self & (dxSlideOutOptions[TItem, TKey])) {
    ...
    inline def setOnMenuGroupRendered(value: /* e */ MenuGroupRenderedEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onMenuGroupRendered", js.Any.fromFunction1((t0: /* e */ MenuGroupRenderedEvent[TItem, TKey]) => value(t0).runNow()))
    
    inline def setOnMenuGroupRenderedUndefined: Self = StObject.set(x, "onMenuGroupRendered", js.undefined)
    
    inline def setOnMenuItemRendered(value: /* e */ MenuItemRenderedEvent[TItem, TKey] => Callback): Self = StObject.set(x, "onMenuItemRendered", js.Any.fromFunction1((t0: /* e */ MenuItemRenderedEvent[TItem, TKey]) => value(t0).runNow()))
