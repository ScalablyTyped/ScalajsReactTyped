...
import typingsJapgolly.devextreme.AnonId
...
trait dxHtmlEditorMention extends js.Object {
  ...
  var template: js.UndefOr[
    typingsJapgolly.devextreme.mod.DevExpress.core.template | (js.Function2[/* mentionData */ AnonId, /* contentElement */ dxElement, String | Element | JQuery])
  ] = js.undefined
...
object dxHtmlEditorMention {
  ...
  def apply(
    ...
    template: typingsJapgolly.devextreme.mod.DevExpress.core.template | (js.Function2[/* mentionData */ AnonId, /* contentElement */ dxElement, String | Element | JQuery]) = null,
