...
import typingsJapgolly.devextreme.anon.ExcelCell
import typingsJapgolly.devextreme.anon.Name
import typingsJapgolly.devextreme.anon.PivotCell
...
import typingsJapgolly.devextreme.mod.DevExpress.ui.dxPivotGridPivotGridCell
...
object excelExporter {
  ...
  object ExcelExportDataGridProps {
    ...
    extension [Self <: ExcelExportDataGridProps](x: Self) {
      ...
      inline def setCustomizeCell(value: /* options */ ExcelCell => Callback): Self = StObject.set(x, "customizeCell", js.Any.fromFunction1((t0: /* options */ ExcelCell) => value(t0).runNow()))
  ...
  object ExcelExportPivotGridProps {
    ...
    extension [Self <: ExcelExportPivotGridProps](x: Self) {
      ...
      inline def setCustomizeCell(value: /* options */ PivotCell => Callback): Self = StObject.set(x, "customizeCell", js.Any.fromFunction1((t0: /* options */ PivotCell) => value(t0).runNow()))
