...
import typingsJapgolly.devextreme.anon.ColorMode
import typingsJapgolly.devextreme.anon.HorizontalOffset
import typingsJapgolly.devextreme.anon.KeepLabels
import typingsJapgolly.devextreme.anon.Padding
...
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxSankey.LinkClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxSankey.LinkHoverEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxSankey.NodeClickEvent
import typingsJapgolly.devextreme.mod.DevExpress.viz.dxSankey.NodeHoverEvent
...
object dxSankeyOptions {
  ...
  extension [Self <: dxSankeyOptions](x: Self) {
    ...
    inline def setOnLinkClickFunction1(value: /* e */ LinkClickEvent => Callback): Self = StObject.set(x, "onLinkClick", js.Any.fromFunction1((t0: /* e */ LinkClickEvent) => value(t0).runNow()))
    
    inline def setOnLinkClickUndefined: Self = StObject.set(x, "onLinkClick", js.undefined)
    
    inline def setOnLinkHoverChanged(value: /* e */ LinkHoverEvent => Callback): Self = StObject.set(x, "onLinkHoverChanged", js.Any.fromFunction1((t0: /* e */ LinkHoverEvent) => value(t0).runNow()))
    ...
    inline def setOnNodeClickFunction1(value: /* e */ NodeClickEvent => Callback): Self = StObject.set(x, "onNodeClick", js.Any.fromFunction1((t0: /* e */ NodeClickEvent) => value(t0).runNow()))
    
    inline def setOnNodeClickUndefined: Self = StObject.set(x, "onNodeClick", js.undefined)
    
    inline def setOnNodeHoverChanged(value: /* e */ NodeHoverEvent => Callback): Self = StObject.set(x, "onNodeHoverChanged", js.Any.fromFunction1((t0: /* e */ NodeHoverEvent) => value(t0).runNow()))
