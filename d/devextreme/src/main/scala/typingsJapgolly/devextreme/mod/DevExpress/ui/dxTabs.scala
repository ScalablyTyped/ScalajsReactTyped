...
object dxTabs {
  ...
  trait ExplicitTypes[TItem /* <: ItemLike */, TKey] extends StObject {
    ...
    var ContentReadyEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.ContentReadyEvent[TItem, TKey]
    
    var DisposingEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.DisposingEvent[TItem, TKey]
    
    var InitializedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.InitializedEvent[TItem, TKey]
    
    var ItemClickEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.ItemClickEvent[TItem, TKey]
    
    var ItemContextMenuEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.ItemContextMenuEvent[TItem, TKey]
    
    var ItemHoldEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.ItemHoldEvent[TItem, TKey]
    
    var ItemRenderedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.ItemRenderedEvent[TItem, TKey]
    
    var OptionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.OptionChangedEvent[TItem, TKey]
    
    var Properties: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.Properties[TItem, TKey]
    
    var SelectionChangedEvent: typingsJapgolly.devextreme.mod.DevExpress.ui.dxTabs.SelectionChangedEvent[TItem, TKey]
  }
