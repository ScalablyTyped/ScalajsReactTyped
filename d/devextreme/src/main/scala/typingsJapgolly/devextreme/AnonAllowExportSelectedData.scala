...
object AnonAllowExportSelectedData {
  ...
  def apply(
    ...
    customizeExcelCell: /* options */ AnonFillPatternColor => CallbackTo[js.Any] = null,
    ...
    if (customizeExcelCell != null) __obj.updateDynamic("customizeExcelCell")(js.Any.fromFunction1((t0: /* options */ typingsJapgolly.devextreme.AnonFillPatternColor) => customizeExcelCell(t0).runNow()))
