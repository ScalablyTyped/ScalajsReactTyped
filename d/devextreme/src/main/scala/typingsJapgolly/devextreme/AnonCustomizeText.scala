...
object AnonCustomizeText {
  @scala.inline
  def apply[T](
    customizeText: /* e */ AnonFilterValue[T] => CallbackTo[String] = null,
    filterEnabled: js.UndefOr[Boolean] = js.undefined,
    texts: AnonClearFilter = null,
    visible: js.UndefOr[Boolean] = js.undefined
  ): AnonCustomizeText[T] = {
    val __obj = js.Dynamic.literal()
    if (customizeText != null) __obj.updateDynamic("customizeText")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.devextreme.AnonFilterValue[T]) => customizeText(t0).runNow()))
