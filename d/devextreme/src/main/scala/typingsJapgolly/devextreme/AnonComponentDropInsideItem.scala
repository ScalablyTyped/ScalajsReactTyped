...
trait AnonComponentDropInsideItem extends js.Object {
...
object AnonComponentDropInsideItem {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[AnonComponentDropInsideItem]
  }
}
