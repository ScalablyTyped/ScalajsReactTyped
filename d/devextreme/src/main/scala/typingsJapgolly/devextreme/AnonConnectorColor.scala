...
object AnonConnectorColor {
  ...
  def apply(
    ...
    customizeText: /* barValue */ AnonValueText => CallbackTo[String] = null,
    font: Font = null,
    format: format = null,
    ...
    if (customizeText != null) __obj.updateDynamic("customizeText")(js.Any.fromFunction1((t0: /* barValue */ typingsJapgolly.devextreme.AnonValueText) => customizeText(t0).runNow()))
