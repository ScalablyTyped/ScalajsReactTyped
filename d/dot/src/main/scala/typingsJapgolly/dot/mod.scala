...
object mod {
  ...
  object global {
    ...
    object String {
      ...
      inline def apply(encodeHTML: CallbackTo[java.lang.String]): typingsJapgolly.dot.mod.global.String = {
        val __obj = js.Dynamic.literal(encodeHTML = encodeHTML.toJsFn)
        __obj.asInstanceOf[typingsJapgolly.dot.mod.global.String]
      }
      
      extension [Self <: typingsJapgolly.dot.mod.global.String](x: Self) {
        
        inline def setEncodeHTML(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "encodeHTML", value.toJsFn)
      }
    }
  }
}
