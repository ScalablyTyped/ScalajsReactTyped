...
import typingsJapgolly.datadogPprof.outSrcCpuProfilerMod.default
import typingsJapgolly.datadogPprof.outSrcTimeProfilerMod.Microseconds
import typingsJapgolly.datadogPprof.outSrcTimeProfilerMod.TimeProfilerOptions
...
object mod {
  ...
  open class SourceMapper ()
    extends typingsJapgolly.datadogPprof.outSrcSourcemapperSourcemapperMod.SourceMapper
  /* static members */
  object SourceMapper {
    ...
    inline def create(searchDirs: js.Array[String]): js.Promise[typingsJapgolly.datadogPprof.outSrcSourcemapperSourcemapperMod.SourceMapper] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(searchDirs.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.datadogPprof.outSrcSourcemapperSourcemapperMod.SourceMapper]]
  }
  ...
  object heap {
    ...
    inline def profile(
      ...
      sourceMapper: typingsJapgolly.datadogPprof.outSrcSourcemapperSourcemapperMod.SourceMapper
    ...
    def profile_Fheap: js.Function2[
        ...
        /* sourceMapper */ js.UndefOr[typingsJapgolly.datadogPprof.outSrcSourcemapperSourcemapperMod.SourceMapper], 
