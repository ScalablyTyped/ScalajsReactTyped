...
object ColumnSettings {
  ...
  extension [Self <: ColumnSettings](x: Self) {
    ...
    ): Self = StObject.set(x, "createdCell", js.Any.fromFunction5((t0: /* cell */ Node, t1: /* cellData */ Any, t2: /* rowData */ Any, t3: /* row */ Double, t4: /* col */ Double) => (value(t0, t1, t2, t3, t4)).runNow()))
