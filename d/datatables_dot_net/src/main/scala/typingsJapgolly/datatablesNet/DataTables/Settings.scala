...
object Settings {
  ...
  def apply(
    ...
    createdRow: (/* row */ Node, /* data */ js.Array[js.Any] | js.Object, /* dataIndex */ Double) => Callback = null,
    ...
    dom: String = null,
    drawCallback: /* settings */ SettingsLegacy => Callback = null,
    footerCallback: (/* tfoot */ Node, /* data */ js.Array[js.Any], /* start */ Double, /* end */ Double, /* display */ js.Array[js.Any]) => Callback = null,
    formatNumber: /* formatNumber */ Double => Callback = null,
    headerCallback: (/* thead */ Node, /* data */ js.Array[js.Any], /* start */ Double, /* end */ Double, /* display */ js.Array[js.Any]) => Callback = null,
    info: js.UndefOr[Boolean] = js.undefined,
    infoCallback: (/* settings */ SettingsLegacy, /* start */ Double, /* end */ Double, /* mnax */ Double, /* total */ Double, /* pre */ String) => Callback = null,
    initComplete: (/* settings */ SettingsLegacy, /* json */ js.Object) => Callback = null,
    ...
    preDrawCallback: /* settings */ SettingsLegacy => Callback = null,
    ...
    rowCallback: (/* row */ Node, /* data */ js.Array[js.Any] | js.Object, /* index */ Double) => Callback = null,
    rowId: String = null,
    ...
    stateLoadCallback: /* settings */ SettingsLegacy => Callback = null,
    stateLoadParams: (/* settings */ SettingsLegacy, /* data */ js.Object) => Callback = null,
    stateLoaded: (/* settings */ SettingsLegacy, /* data */ js.Object) => Callback = null,
    stateSave: js.UndefOr[Boolean] = js.undefined,
    stateSaveCallback: (/* settings */ SettingsLegacy, /* data */ js.Object) => Callback = null,
    stateSaveParams: (/* settings */ SettingsLegacy, /* data */ js.Object) => Callback = null,
    ...
    if (createdRow != null) __obj.updateDynamic("createdRow")(js.Any.fromFunction3((t0: /* row */ org.scalajs.dom.raw.Node, t1: /* data */ js.Array[js.Any] | js.Object, t2: /* dataIndex */ scala.Double) => createdRow(t0, t1, t2).runNow()))
    ...
    if (drawCallback != null) __obj.updateDynamic("drawCallback")(js.Any.fromFunction1((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy) => drawCallback(t0).runNow()))
    if (footerCallback != null) __obj.updateDynamic("footerCallback")(js.Any.fromFunction5((t0: /* tfoot */ org.scalajs.dom.raw.Node, t1: /* data */ js.Array[js.Any], t2: /* start */ scala.Double, t3: /* end */ scala.Double, t4: /* display */ js.Array[js.Any]) => footerCallback(t0, t1, t2, t3, t4).runNow()))
    if (formatNumber != null) __obj.updateDynamic("formatNumber")(js.Any.fromFunction1((t0: /* formatNumber */ scala.Double) => formatNumber(t0).runNow()))
    if (headerCallback != null) __obj.updateDynamic("headerCallback")(js.Any.fromFunction5((t0: /* thead */ org.scalajs.dom.raw.Node, t1: /* data */ js.Array[js.Any], t2: /* start */ scala.Double, t3: /* end */ scala.Double, t4: /* display */ js.Array[js.Any]) => headerCallback(t0, t1, t2, t3, t4).runNow()))
    if (!js.isUndefined(info)) __obj.updateDynamic("info")(info.asInstanceOf[js.Any])
    if (infoCallback != null) __obj.updateDynamic("infoCallback")(js.Any.fromFunction6((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy, t1: /* start */ scala.Double, t2: /* end */ scala.Double, t3: /* mnax */ scala.Double, t4: /* total */ scala.Double, t5: /* pre */ java.lang.String) => infoCallback(t0, t1, t2, t3, t4, t5).runNow()))
    if (initComplete != null) __obj.updateDynamic("initComplete")(js.Any.fromFunction2((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy, t1: /* json */ js.Object) => initComplete(t0, t1).runNow()))
    ...
    if (preDrawCallback != null) __obj.updateDynamic("preDrawCallback")(js.Any.fromFunction1((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy) => preDrawCallback(t0).runNow()))
    ...
    if (rowCallback != null) __obj.updateDynamic("rowCallback")(js.Any.fromFunction3((t0: /* row */ org.scalajs.dom.raw.Node, t1: /* data */ js.Array[js.Any] | js.Object, t2: /* index */ scala.Double) => rowCallback(t0, t1, t2).runNow()))
    ...
    if (stateLoadCallback != null) __obj.updateDynamic("stateLoadCallback")(js.Any.fromFunction1((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy) => stateLoadCallback(t0).runNow()))
    if (stateLoadParams != null) __obj.updateDynamic("stateLoadParams")(js.Any.fromFunction2((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy, t1: /* data */ js.Object) => stateLoadParams(t0, t1).runNow()))
    if (stateLoaded != null) __obj.updateDynamic("stateLoaded")(js.Any.fromFunction2((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy, t1: /* data */ js.Object) => stateLoaded(t0, t1).runNow()))
    if (!js.isUndefined(stateSave)) __obj.updateDynamic("stateSave")(stateSave.asInstanceOf[js.Any])
    if (stateSaveCallback != null) __obj.updateDynamic("stateSaveCallback")(js.Any.fromFunction2((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy, t1: /* data */ js.Object) => stateSaveCallback(t0, t1).runNow()))
    if (stateSaveParams != null) __obj.updateDynamic("stateSaveParams")(js.Any.fromFunction2((t0: /* settings */ typingsJapgolly.datatablesNet.DataTables.SettingsLegacy, t1: /* data */ js.Object) => stateSaveParams(t0, t1).runNow()))
