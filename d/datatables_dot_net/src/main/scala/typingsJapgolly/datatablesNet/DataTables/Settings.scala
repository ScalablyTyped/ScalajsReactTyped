...
object Settings {
  ...
  extension [Self <: Settings](x: Self) {
    ...
    inline def setAjaxFunction3(
      value: (/* data */ js.Object, /* callback */ js.Function1[/* data */ Any, Unit], /* settings */ SettingsLegacy) => Callback
    ): Self = StObject.set(x, "ajax", js.Any.fromFunction3((t0: /* data */ js.Object, t1: /* callback */ js.Function1[/* data */ Any, Unit], t2: /* settings */ SettingsLegacy) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setCreatedRow(
      value: (/* row */ Node, /* data */ js.Array[Any] | js.Object, /* dataIndex */ Double, /* cells */ js.Array[Node]) => Callback
    ): Self = StObject.set(x, "createdRow", js.Any.fromFunction4((t0: /* row */ Node, t1: /* data */ js.Array[Any] | js.Object, t2: /* dataIndex */ Double, t3: /* cells */ js.Array[Node]) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setDrawCallback(value: /* settings */ SettingsLegacy => Callback): Self = StObject.set(x, "drawCallback", js.Any.fromFunction1((t0: /* settings */ SettingsLegacy) => value(t0).runNow()))
    
    inline def setDrawCallbackUndefined: Self = StObject.set(x, "drawCallback", js.undefined)
    
    inline def setFooterCallback(
      value: (/* tfoot */ Node, /* data */ js.Array[Any], /* start */ Double, /* end */ Double, /* display */ js.Array[Any]) => Callback
    ): Self = StObject.set(x, "footerCallback", js.Any.fromFunction5((t0: /* tfoot */ Node, t1: /* data */ js.Array[Any], t2: /* start */ Double, t3: /* end */ Double, t4: /* display */ js.Array[Any]) => (value(t0, t1, t2, t3, t4)).runNow()))
    
    inline def setFooterCallbackUndefined: Self = StObject.set(x, "footerCallback", js.undefined)
    
    inline def setFormatNumber(value: /* formatNumber */ Double => Callback): Self = StObject.set(x, "formatNumber", js.Any.fromFunction1((t0: /* formatNumber */ Double) => value(t0).runNow()))
    
    inline def setFormatNumberUndefined: Self = StObject.set(x, "formatNumber", js.undefined)
    
    inline def setHeaderCallback(
      value: (/* thead */ Node, /* data */ js.Array[Any], /* start */ Double, /* end */ Double, /* display */ js.Array[Any]) => Callback
    ): Self = StObject.set(x, "headerCallback", js.Any.fromFunction5((t0: /* thead */ Node, t1: /* data */ js.Array[Any], t2: /* start */ Double, t3: /* end */ Double, t4: /* display */ js.Array[Any]) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def setInfoCallback(
      value: (/* settings */ SettingsLegacy, /* start */ Double, /* end */ Double, /* mnax */ Double, /* total */ Double, /* pre */ String) => Callback
    ): Self = StObject.set(x, "infoCallback", js.Any.fromFunction6((t0: /* settings */ SettingsLegacy, t1: /* start */ Double, t2: /* end */ Double, t3: /* mnax */ Double, t4: /* total */ Double, t5: /* pre */ String) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
    
    inline def setInfoCallbackUndefined: Self = StObject.set(x, "infoCallback", js.undefined)
    
    inline def setInfoUndefined: Self = StObject.set(x, "info", js.undefined)
    
    inline def setInitComplete(value: (/* settings */ SettingsLegacy, /* json */ js.Object) => Callback): Self = StObject.set(x, "initComplete", js.Any.fromFunction2((t0: /* settings */ SettingsLegacy, t1: /* json */ js.Object) => (value(t0, t1)).runNow()))
    ...
    inline def setPreDrawCallback(value: /* settings */ SettingsLegacy => Callback): Self = StObject.set(x, "preDrawCallback", js.Any.fromFunction1((t0: /* settings */ SettingsLegacy) => value(t0).runNow()))
    ...
    inline def setRowCallback(value: (/* row */ Node, /* data */ js.Array[Any] | js.Object, /* index */ Double) => Callback): Self = StObject.set(x, "rowCallback", js.Any.fromFunction3((t0: /* row */ Node, t1: /* data */ js.Array[Any] | js.Object, t2: /* index */ Double) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setStateLoadCallback(value: /* settings */ SettingsLegacy => Callback): Self = StObject.set(x, "stateLoadCallback", js.Any.fromFunction1((t0: /* settings */ SettingsLegacy) => value(t0).runNow()))
    
    inline def setStateLoadCallbackUndefined: Self = StObject.set(x, "stateLoadCallback", js.undefined)
    
    inline def setStateLoadParams(value: (/* settings */ SettingsLegacy, /* data */ js.Object) => Callback): Self = StObject.set(x, "stateLoadParams", js.Any.fromFunction2((t0: /* settings */ SettingsLegacy, t1: /* data */ js.Object) => (value(t0, t1)).runNow()))
    
    inline def setStateLoadParamsUndefined: Self = StObject.set(x, "stateLoadParams", js.undefined)
    
    inline def setStateLoaded(value: (/* settings */ SettingsLegacy, /* data */ js.Object) => Callback): Self = StObject.set(x, "stateLoaded", js.Any.fromFunction2((t0: /* settings */ SettingsLegacy, t1: /* data */ js.Object) => (value(t0, t1)).runNow()))
    ...
    inline def setStateSaveCallback(value: (/* settings */ SettingsLegacy, /* data */ js.Object) => Callback): Self = StObject.set(x, "stateSaveCallback", js.Any.fromFunction2((t0: /* settings */ SettingsLegacy, t1: /* data */ js.Object) => (value(t0, t1)).runNow()))
    
    inline def setStateSaveCallbackUndefined: Self = StObject.set(x, "stateSaveCallback", js.undefined)
    
    inline def setStateSaveParams(value: (/* settings */ SettingsLegacy, /* data */ js.Object) => Callback): Self = StObject.set(x, "stateSaveParams", js.Any.fromFunction2((t0: /* settings */ SettingsLegacy, t1: /* data */ js.Object) => (value(t0, t1)).runNow()))
