...
object compute {
  ...
  trait Compute extends StObject {
    ...
    /**
      ...
      */
    def calculateSlicePayment(sliceProfile: SliceProfile, workValue: WorkValue): Double = js.native
    ...
    /**
      ...
      * @param arguments
      */
    def `do`(n: Double, arguments: js.Object): js.Promise[JobHandle] = js.native
    def `do`(n: Double, work: String | URL): js.Promise[JobHandle] = js.native
    def `do`(n: Double, work: String | URL, arguments: js.Object): js.Promise[JobHandle] = js.native
    def `do`(n: Double, work: js.Object, arguments: js.Object): js.Promise[JobHandle] = js.native
    ...
    /**
      ...
      * @param jobId
      */
    def getJobInfo(jobId: Double): JobInfo = js.native
    ...
    /**
      ...
      */
    def getMarketValue(): WorkValueQuote = js.native
    ...
    /**
      ...
      * @param jobId
      */
    def getSliceInfo(jobId: Double): JobHistory = js.native
    ...
    /**
      ...
      * @param factor
      */
    def marketRate(): Unit = js.native
    def marketRate(factor: Double): Unit = js.native
    
    def status(job: JobHandle): Status | js.Array[Status] = js.native
    /**
      ...
      */
    def status(job: jobId): Status | js.Array[Status] = js.native
    /**
      ...
      * @param endTime
      */
    def status(startTime: Double, endTime: Double, paymentAccount: Keystore): JobHandle = js.native
  }
}
