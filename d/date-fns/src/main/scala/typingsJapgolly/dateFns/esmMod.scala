...
import typingsJapgolly.dateFns.anon.AddSuffixLocale
import typingsJapgolly.dateFns.anon.AdditionalDigits
import typingsJapgolly.dateFns.anon.Era
...
import typingsJapgolly.dateFns.anon.NearestToRoundingMethod
import typingsJapgolly.dateFns.anon.Numeric
...
import typingsJapgolly.dateFns.dateFnsInts.`0`
import typingsJapgolly.dateFns.dateFnsInts.`1`
...
object esmMod {
  ...
  inline def getWeek(date: js.Date, options: typingsJapgolly.dateFns.anon.`1`): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeek(date: Double, options: typingsJapgolly.dateFns.anon.`1`): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeekYear(date: js.Date, options: typingsJapgolly.dateFns.anon.`1`): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeekYear")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeekYear(date: Double, options: typingsJapgolly.dateFns.anon.`1`): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeekYear")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def intlFormat(argument: js.Date, formatOptions: Unit, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = (^.asInstanceOf[js.Dynamic].applyDynamic("intlFormat")(argument.asInstanceOf[js.Any], formatOptions.asInstanceOf[js.Any], localeOptions.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def intlFormat(argument: js.Date, formatOptions: Era, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = (^.asInstanceOf[js.Dynamic].applyDynamic("intlFormat")(argument.asInstanceOf[js.Any], formatOptions.asInstanceOf[js.Any], localeOptions.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def intlFormat(argument: Double, formatOptions: Unit, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = (^.asInstanceOf[js.Dynamic].applyDynamic("intlFormat")(argument.asInstanceOf[js.Any], formatOptions.asInstanceOf[js.Any], localeOptions.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def intlFormat(argument: Double, formatOptions: Era, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = (^.asInstanceOf[js.Dynamic].applyDynamic("intlFormat")(argument.asInstanceOf[js.Any], formatOptions.asInstanceOf[js.Any], localeOptions.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def setDefaultOptions(newOptions: typingsJapgolly.dateFns.anon.`1`): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setDefaultOptions")(newOptions.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  inline def setWeek(date: js.Date, week: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setWeek")(date.asInstanceOf[js.Any], week.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setWeek(date: Double, week: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setWeek")(date.asInstanceOf[js.Any], week.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setWeekYear(date: js.Date, weekYear: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setWeekYear")(date.asInstanceOf[js.Any], weekYear.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setWeekYear(date: Double, weekYear: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setWeekYear")(date.asInstanceOf[js.Any], weekYear.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def startOfWeekYear(date: js.Date, options: typingsJapgolly.dateFns.anon.`1`): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("startOfWeekYear")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def startOfWeekYear(date: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("startOfWeekYear")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
