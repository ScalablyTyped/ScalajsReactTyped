...
trait dateFns extends StObject {
  ...
  def getWeek(date: js.Date, options: typingsJapgolly.dateFns.anon.`1`): Double = js.native
  def getWeek(date: Double): Double = js.native
  def getWeek(date: Double, options: typingsJapgolly.dateFns.anon.`1`): Double = js.native
  ...
  def getWeekYear(date: js.Date, options: typingsJapgolly.dateFns.anon.`1`): Double = js.native
  def getWeekYear(date: Double): Double = js.native
  def getWeekYear(date: Double, options: typingsJapgolly.dateFns.anon.`1`): Double = js.native
  ...
  def intlFormat(argument: js.Date, formatOptions: Unit, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = js.native
  def intlFormat(argument: js.Date, formatOptions: Era): String = js.native
  def intlFormat(argument: js.Date, formatOptions: Era, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = js.native
  def intlFormat(argument: Double): String = js.native
  def intlFormat(argument: Double, formatOptions: Unit, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = js.native
  def intlFormat(argument: Double, formatOptions: Era): String = js.native
  def intlFormat(argument: Double, formatOptions: Era, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = js.native
  ...
  def setDefaultOptions(newOptions: typingsJapgolly.dateFns.anon.`1`): Unit = js.native
  ...
  def setWeek(date: js.Date, week: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = js.native
  def setWeek(date: Double, week: Double): js.Date = js.native
  def setWeek(date: Double, week: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = js.native
  
  def setWeekYear(date: js.Date, weekYear: Double): js.Date = js.native
  def setWeekYear(date: js.Date, weekYear: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = js.native
  def setWeekYear(date: Double, weekYear: Double): js.Date = js.native
  def setWeekYear(date: Double, weekYear: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = js.native
  ...
  def startOfWeekYear(date: js.Date, options: typingsJapgolly.dateFns.anon.`1`): js.Date = js.native
  def startOfWeekYear(date: Double): js.Date = js.native
  def startOfWeekYear(date: Double, options: typingsJapgolly.dateFns.anon.`1`): js.Date = js.native
