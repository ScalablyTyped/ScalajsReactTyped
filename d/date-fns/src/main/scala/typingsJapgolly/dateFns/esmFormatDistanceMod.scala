...
object esmFormatDistanceMod {
  ...
  object default {
    ...
    inline def apply(date: js.Date, baseDate: js.Date, options: IncludeSeconds): String = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
    ...
    inline def apply(date: js.Date, baseDate: Double, options: IncludeSeconds): String = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
    ...
    inline def apply(date: Double, baseDate: js.Date, options: IncludeSeconds): String = (^.asInstanceOf[js.Dynamic].apply(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
