...
object mod {
  ...
  inline def add(date: js.Date, duration: typingsJapgolly.dateFns.mod.Duration): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(date.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  inline def add(date: Double, duration: typingsJapgolly.dateFns.mod.Duration): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(date.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  ): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("areIntervalsOverlapping")(intervalLeft.asInstanceOf[js.Any], intervalRight.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def areIntervalsOverlapping(
    intervalLeft: typingsJapgolly.dateFns.mod.Interval,
    intervalRight: typingsJapgolly.dateFns.mod.Interval,
    options: Inclusive
  ...
  inline def clamp(date: js.Date, interval: typingsJapgolly.dateFns.mod.Interval): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("clamp")(date.asInstanceOf[js.Any], interval.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  inline def clamp(date: Double, interval: typingsJapgolly.dateFns.mod.Interval): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("clamp")(date.asInstanceOf[js.Any], interval.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def differenceInCalendarWeeks(dateLeft: js.Date, dateRight: js.Date, options: typingsJapgolly.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("differenceInCalendarWeeks")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def differenceInCalendarWeeks(dateLeft: js.Date, dateRight: Double, options: typingsJapgolly.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("differenceInCalendarWeeks")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def differenceInCalendarWeeks(dateLeft: Double, dateRight: js.Date, options: typingsJapgolly.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("differenceInCalendarWeeks")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def differenceInCalendarWeeks(dateLeft: Double, dateRight: Double, options: typingsJapgolly.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("differenceInCalendarWeeks")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def eachDayOfInterval(interval: typingsJapgolly.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachDayOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  inline def eachDayOfInterval(interval: typingsJapgolly.dateFns.mod.Interval, options: Step): js.Array[js.Date] = (^.asInstanceOf[js.Dynamic].applyDynamic("eachDayOfInterval")(interval.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Date]]
  
  inline def eachHourOfInterval(interval: typingsJapgolly.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachHourOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  inline def eachHourOfInterval(interval: typingsJapgolly.dateFns.mod.Interval, options: Step): js.Array[js.Date] = (^.asInstanceOf[js.Dynamic].applyDynamic("eachHourOfInterval")(interval.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Date]]
  
  inline def eachMinuteOfInterval(interval: typingsJapgolly.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachMinuteOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  inline def eachMinuteOfInterval(interval: typingsJapgolly.dateFns.mod.Interval, options: Step): js.Array[js.Date] = (^.asInstanceOf[js.Dynamic].applyDynamic("eachMinuteOfInterval")(interval.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Date]]
  
  inline def eachMonthOfInterval(interval: typingsJapgolly.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachMonthOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  
  inline def eachQuarterOfInterval(interval: typingsJapgolly.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachQuarterOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  
  inline def eachWeekOfInterval(interval: typingsJapgolly.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachWeekOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  inline def eachWeekOfInterval(interval: typingsJapgolly.dateFns.mod.Interval, options: typingsJapgolly.dateFns.anon.Locale): js.Array[js.Date] = (^.asInstanceOf[js.Dynamic].applyDynamic("eachWeekOfInterval")(interval.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Date]]
  
  inline def eachWeekendOfInterval(interval: typingsJapgolly.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachWeekendOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  ...
  inline def eachYearOfInterval(interval: typingsJapgolly.dateFns.mod.Interval): js.Array[js.Date] = ^.asInstanceOf[js.Dynamic].applyDynamic("eachYearOfInterval")(interval.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Date]]
  ...
  inline def endOfWeek(date: js.Date, options: typingsJapgolly.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("endOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def endOfWeek(date: Double, options: typingsJapgolly.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("endOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def formatDuration(duration: typingsJapgolly.dateFns.mod.Duration): String = ^.asInstanceOf[js.Dynamic].applyDynamic("formatDuration")(duration.asInstanceOf[js.Any]).asInstanceOf[String]
  inline def formatDuration(duration: typingsJapgolly.dateFns.mod.Duration, options: Delimiter): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatDuration")(duration.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatISODuration(duration: typingsJapgolly.dateFns.mod.Duration): String = ^.asInstanceOf[js.Dynamic].applyDynamic("formatISODuration")(duration.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def formatRelative(date: js.Date, baseDate: js.Date, options: typingsJapgolly.dateFns.anon.Locale): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatRelative")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatRelative(date: js.Date, baseDate: Double, options: typingsJapgolly.dateFns.anon.Locale): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatRelative")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatRelative(date: Double, baseDate: js.Date, options: typingsJapgolly.dateFns.anon.Locale): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatRelative")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def formatRelative(date: Double, baseDate: Double, options: typingsJapgolly.dateFns.anon.Locale): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatRelative")(date.asInstanceOf[js.Any], baseDate.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def getOverlappingDaysInIntervals(
    intervalLeft: typingsJapgolly.dateFns.mod.Interval,
    intervalRight: typingsJapgolly.dateFns.mod.Interval
  ): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getOverlappingDaysInIntervals")(intervalLeft.asInstanceOf[js.Any], intervalRight.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeekOfMonth(date: js.Date, options: typingsJapgolly.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeekOfMonth")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeekOfMonth(date: Double, options: typingsJapgolly.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeekOfMonth")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeeksInMonth(date: js.Date, options: typingsJapgolly.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeeksInMonth")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def getWeeksInMonth(date: Double, options: typingsJapgolly.dateFns.anon.Locale): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWeeksInMonth")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def intervalToDuration(interval: typingsJapgolly.dateFns.mod.Interval): typingsJapgolly.dateFns.mod.Duration = ^.asInstanceOf[js.Dynamic].applyDynamic("intervalToDuration")(interval.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.dateFns.mod.Duration]
  ...
  inline def intlFormat(argument: js.Date, formatOptions: scala.Unit, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = (^.asInstanceOf[js.Dynamic].applyDynamic("intlFormat")(argument.asInstanceOf[js.Any], formatOptions.asInstanceOf[js.Any], localeOptions.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def intlFormat(argument: Double, formatOptions: scala.Unit, localeOptions: typingsJapgolly.dateFns.anon.`0`): String = (^.asInstanceOf[js.Dynamic].applyDynamic("intlFormat")(argument.asInstanceOf[js.Any], formatOptions.asInstanceOf[js.Any], localeOptions.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  inline def isSameWeek(dateLeft: js.Date, dateRight: js.Date, options: typingsJapgolly.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isSameWeek")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isSameWeek(dateLeft: js.Date, dateRight: Double, options: typingsJapgolly.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isSameWeek")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isSameWeek(dateLeft: Double, dateRight: js.Date, options: typingsJapgolly.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isSameWeek")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isSameWeek(dateLeft: Double, dateRight: Double, options: typingsJapgolly.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isSameWeek")(dateLeft.asInstanceOf[js.Any], dateRight.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isThisWeek(date: js.Date, options: typingsJapgolly.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isThisWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isThisWeek(date: Double, options: typingsJapgolly.dateFns.anon.Locale): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isThisWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def isWithinInterval(date: js.Date, interval: typingsJapgolly.dateFns.mod.Interval): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isWithinInterval")(date.asInstanceOf[js.Any], interval.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def isWithinInterval(date: Double, interval: typingsJapgolly.dateFns.mod.Interval): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isWithinInterval")(date.asInstanceOf[js.Any], interval.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  inline def lastDayOfWeek(date: js.Date, options: typingsJapgolly.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("lastDayOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def lastDayOfWeek(date: Double, options: typingsJapgolly.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("lastDayOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def milliseconds(duration: typingsJapgolly.dateFns.mod.Duration): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("milliseconds")(duration.asInstanceOf[js.Any]).asInstanceOf[Double]
  ...
  inline def nextDay(date: js.Date, day: typingsJapgolly.dateFns.mod.Day): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("nextDay")(date.asInstanceOf[js.Any], day.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  inline def nextDay(date: Double, day: typingsJapgolly.dateFns.mod.Day): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("nextDay")(date.asInstanceOf[js.Any], day.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setDay(date: js.Date, day: Double, options: typingsJapgolly.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setDay")(date.asInstanceOf[js.Any], day.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def setDay(date: Double, day: Double, options: typingsJapgolly.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("setDay")(date.asInstanceOf[js.Any], day.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def startOfWeek(date: js.Date, options: typingsJapgolly.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("startOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def startOfWeek(date: Double, options: typingsJapgolly.dateFns.anon.Locale): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("startOfWeek")(date.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  ...
  inline def sub(date: js.Date, duration: typingsJapgolly.dateFns.mod.Duration): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("sub")(date.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Date]
  inline def sub(date: Double, duration: typingsJapgolly.dateFns.mod.Duration): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("sub")(date.asInstanceOf[js.Any], duration.asInstanceOf[js.Any])).asInstanceOf[js.Date]
