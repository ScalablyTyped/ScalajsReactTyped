...
object distSrcShardMod {
  ...
  open class ShardBase protected ()
    extends StObject
       with typingsJapgolly.datastoreCore.distSrcTypesMod.Shard {
    /**
      * @param {any} param
      */
  ...
  inline def readShardFun(path: String, store: Datastore): js.Promise[typingsJapgolly.datastoreCore.distSrcTypesMod.Shard] = (^.asInstanceOf[js.Dynamic].applyDynamic("readShardFun")(path.asInstanceOf[js.Any], store.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.datastoreCore.distSrcTypesMod.Shard]]
  inline def readShardFun(path: js.typedarray.Uint8Array, store: Datastore): js.Promise[typingsJapgolly.datastoreCore.distSrcTypesMod.Shard] = (^.asInstanceOf[js.Dynamic].applyDynamic("readShardFun")(path.asInstanceOf[js.Any], store.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.datastoreCore.distSrcTypesMod.Shard]]
