package typingsJapgolly.desktopService

import typingsJapgolly.desktopService.desktopServiceStrings.alreadyinstalled
import typingsJapgolly.desktopService.desktopServiceStrings.error
import typingsJapgolly.desktopService.desktopServiceStrings.install
import typingsJapgolly.desktopService.desktopServiceStrings.invalidinstallation
import typingsJapgolly.desktopService.desktopServiceStrings.start
import typingsJapgolly.desktopService.desktopServiceStrings.stop
import typingsJapgolly.desktopService.desktopServiceStrings.uninstall
...
object mod {
  ...
  object EnvironmentVariables {
    ...
    extension [Self <: EnvironmentVariables](x: Self) {
  ...
  object ServiceConfigOptions {
    ...
    extension [Self <: ServiceConfigOptions](x: Self) {
