...
object distEsmMultiBackendImplMod {
  
  @JSImport("dnd-multi-backend/dist/esm/MultiBackendImpl", "MultiBackendImpl")
  @js.native
  ...
  object MultiBackendImpl {
    ...
    @JSImport("dnd-multi-backend/dist/esm/MultiBackendImpl", "MultiBackendImpl.isSetUp")
    @js.native
