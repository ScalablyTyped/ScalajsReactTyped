...
object mod {
  ...
  object Chunk {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(end = js.Any.fromFunction1(end), map = js.Any.fromFunction1(map), render = js.Any.fromFunction2(render), setError = js.Any.fromFunction1(setError), tap = js.Any.fromFunction1(tap), untap = untap.toJsFn, write = js.Any.fromFunction1(write))
    ...
    extension [Self <: Chunk](x: Self) {
      ...
      inline def setUntap(value: CallbackTo[Chunk]): Self = StObject.set(x, "untap", value.toJsFn)
  ...
  object Stream_ {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(emit = js.Any.fromFunction2((t0: String, t1: Any) => (emit(t0, t1)).runNow()), flush = flush.toJsFn, on = js.Any.fromFunction2(on), pipe = js.Any.fromFunction1(pipe))
