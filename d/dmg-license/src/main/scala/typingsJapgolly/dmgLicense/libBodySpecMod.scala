...
import typingsJapgolly.dmgLicense.dmgLicenseStrings.`UTF-8`
import typingsJapgolly.dmgLicense.dmgLicenseStrings.plain
...
object libBodySpecMod {
  ...
  object default {
    ...
    inline def prepare(spec: BodySpec, lang: typingsJapgolly.dmgLicense.libLanguageMod.default): js.Promise[Data] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(spec.asInstanceOf[js.Any], lang.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Data]]
    inline def prepare(
      spec: BodySpec,
    ...
    inline def prepare(spec: BodySpec, lang: typingsJapgolly.dmgLicense.libLanguageMod.default, contextOrOptions: Options): js.Promise[Data] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(spec.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Data]]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dmgLicense.libBodySpecMod.BodySpec.BodyInline
    - typingsJapgolly.dmgLicense.libBodySpecMod.BodySpec.BodyInFile
  */
  ...
  object BodySpec {
    ...
    inline def prepare(spec: BodySpec, lang: default, contextOrOptions: typingsJapgolly.dmgLicense.libContextMod.default): js.Promise[Data] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(spec.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Data]]
