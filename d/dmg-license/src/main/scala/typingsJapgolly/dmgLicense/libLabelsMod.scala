...
import typingsJapgolly.dmgLicense.libLanguageMod.Localization
import typingsJapgolly.dmgLicense.libLanguageMod.default
import typingsJapgolly.dmgLicense.libUtilFormatVerrorMod.PrettyVError
import typingsJapgolly.dmgLicense.mod.Options
...
object libLabelsMod {
  ...
  object default {
    ...
    /**
      ...
      */
    inline def prepare(labels: Labels[String], lang: typingsJapgolly.dmgLicense.libLanguageMod.default): Buffer = (^.asInstanceOf[js.Dynamic].applyDynamic("prepare")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any])).asInstanceOf[Buffer]
    ...
    /**
      ...
      * @returns A `Buffer` in `STR#` format.
      */
    inline def prepareDefault(lang: typingsJapgolly.dmgLicense.libLanguageMod.default): Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("prepareDefault")(lang.asInstanceOf[js.Any]).asInstanceOf[Buffer]
    
    inline def prepareSpec(
      labels: Null,
      lang: typingsJapgolly.dmgLicense.libLanguageMod.default,
    ...
    inline def prepareSpec(labels: Null, lang: typingsJapgolly.dmgLicense.libLanguageMod.default, contextOrOptions: Options): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
    inline def prepareSpec(
      labels: Unit,
      lang: typingsJapgolly.dmgLicense.libLanguageMod.default,
      contextOrOptions: typingsJapgolly.dmgLicense.libContextMod.default
    ): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
    inline def prepareSpec(labels: Unit, lang: typingsJapgolly.dmgLicense.libLanguageMod.default, contextOrOptions: Options): js.Promise[Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSpec")(labels.asInstanceOf[js.Any], lang.asInstanceOf[js.Any], contextOrOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Buffer]]
    /**
      * Prepares a label set for insertion into a disk image as a `STR#` resource.
      *
      * @remarks
  ...
  object Labels {
    ...
    object ForEachOptions {
      ...
      extension [Self <: ForEachOptions](x: Self) {
        ...
        inline def setOnNoLanguageName(value: Callback): Self = StObject.set(x, "onNoLanguageName", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dmgLicense.libLabelsMod.LabelsSpec.LabelsInline
    - typingsJapgolly.dmgLicense.libLabelsMod.LabelsSpec.LabelsRaw
  */
