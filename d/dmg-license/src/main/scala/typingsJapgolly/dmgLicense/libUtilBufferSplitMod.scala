...
object libUtilBufferSplitMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dmgLicense.dmgLicenseStrings.tab
    - typingsJapgolly.dmgLicense.dmgLicenseStrings.lf
    - typingsJapgolly.dmgLicense.dmgLicenseStrings.cr
    - typingsJapgolly.dmgLicense.dmgLicenseStrings.crlf
    - typingsJapgolly.dmgLicense.dmgLicenseStrings.nul
    - typingsJapgolly.dmgLicense.dmgLicenseStrings.eol
