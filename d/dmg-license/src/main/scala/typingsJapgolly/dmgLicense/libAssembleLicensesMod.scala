...
import typingsJapgolly.dmgLicense.mod.LicenseSpec
...
object libAssembleLicensesMod {
  ...
  inline def default(spec: LicenseSpec, optionsOrContext: typingsJapgolly.dmgLicense.libContextMod.default): js.Promise[AssembledLicenseSet] = (^.asInstanceOf[js.Dynamic].applyDynamic("default")(spec.asInstanceOf[js.Any], optionsOrContext.asInstanceOf[js.Any])).asInstanceOf[js.Promise[AssembledLicenseSet]]
