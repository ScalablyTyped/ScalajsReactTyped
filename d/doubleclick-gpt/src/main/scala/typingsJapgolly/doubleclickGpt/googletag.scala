...
import typingsJapgolly.doubleclickGpt.anon.ChangeCorrelator
import typingsJapgolly.doubleclickGpt.doubleclickGptInts.`0`
import typingsJapgolly.doubleclickGpt.doubleclickGptInts.`1`
...
object googletag {
  ...
  object SizeMappingBuilder {
    ...
    inline def apply(addSize: (SingleSizeArray, GeneralSize) => SizeMappingBuilder, build: CallbackTo[SizeMappingArray]): SizeMappingBuilder = {
      val __obj = js.Dynamic.literal(addSize = js.Any.fromFunction2(addSize), build = build.toJsFn)
    ...
    extension [Self <: SizeMappingBuilder](x: Self) {
      ...
      inline def setBuild(value: CallbackTo[SizeMappingArray]): Self = StObject.set(x, "build", value.toJsFn)
    }
  }
