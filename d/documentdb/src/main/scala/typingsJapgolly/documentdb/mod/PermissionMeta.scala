...
- typingsJapgolly.documentdb.mod.AbstractMeta because var conflicts: id. Inlined _self, _ts, _rid, _etag, _attachments */ trait PermissionMeta
  extends StObject
     with Permission {
...
object PermissionMeta {
  ...
  inline def apply(_self: String, _ts: Double, id: String, permissionMode: PermissionMode, resource: String): PermissionMeta = {
