...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.dashdash.mod.OptionWithoutAliases
    - typingsJapgolly.dashdash.mod.OptionWithAliases
  */
  trait Option extends StObject
  object Option {
    
    inline def OptionWithAliases(names: js.Array[String], `type`: String): typingsJapgolly.dashdash.mod.OptionWithAliases = {
      val __obj = js.Dynamic.literal(names = names.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.dashdash.mod.OptionWithAliases]
    }
    
    inline def OptionWithoutAliases(name: String, `type`: String): typingsJapgolly.dashdash.mod.OptionWithoutAliases = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.dashdash.mod.OptionWithoutAliases]
    }
  }
