...
object global {
  ...
  open class BlobEvent protected ()
    extends StObject
       with typingsJapgolly.domMediacaptureRecord.BlobEvent {
  ...
  open class MediaRecorder protected ()
    extends StObject
       with typingsJapgolly.domMediacaptureRecord.MediaRecorder {
  ...
  open class MediaRecorderErrorEvent protected ()
    extends StObject
       with typingsJapgolly.domMediacaptureRecord.MediaRecorderErrorEvent {
