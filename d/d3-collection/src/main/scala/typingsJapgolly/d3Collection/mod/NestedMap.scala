...
object NestedMap {
  ...
  def apply[Datum, RollupType](
    ...
    entries: CallbackTo[js.Array[AnonKey[(NestedMap[Datum, RollupType]) | js.Array[Datum] | RollupType]]],
  ...
  (typingsJapgolly.d3Collection.mod.NestedMap[Datum, RollupType]) | js.Array[Datum] | RollupType, 
  /* key */ java.lang.String, 
  /* map */ typingsJapgolly.d3Collection.mod.Map_[
    (typingsJapgolly.d3Collection.mod.NestedMap[Datum, RollupType]) | js.Array[Datum] | RollupType
  ], 
  scala.Unit]) => each(t0).runNow()))
    ...
    __obj.updateDynamic("set")(js.Any.fromFunction2((t0: java.lang.String, t1: (typingsJapgolly.d3Collection.mod.NestedMap[Datum, RollupType]) | js.Array[Datum] | RollupType) => set(t0, t1).runNow()))
