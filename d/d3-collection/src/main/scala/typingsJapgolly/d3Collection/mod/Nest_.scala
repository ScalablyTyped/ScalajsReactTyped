...
import typingsJapgolly.d3Collection.AnonKeyValue
...
object Nest_ {
  ...
  def apply[Datum, RollupType](
    entries: js.Array[Datum] => CallbackTo[js.Array[AnonKeyValue[RollupType]]],
    key: js.Function1[/* datum */ Datum, String] => CallbackTo[Nest_[Datum, RollupType]],
    map: js.Array[Datum] => CallbackTo[Map_[js.Any]],
    `object`: js.Array[Datum] => CallbackTo[StringDictionary[js.Any]],
    rollup: js.Function1[/* values */ js.Array[Datum], RollupType] => CallbackTo[Nest_[Datum, RollupType]],
    sortKeys: js.Function2[/* a */ String, /* b */ String, Double] => CallbackTo[Nest_[Datum, RollupType]],
    sortValues: js.Function2[/* a */ Datum, /* b */ Datum, Double] => CallbackTo[Nest_[Datum, RollupType]]
