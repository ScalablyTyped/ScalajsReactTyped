...
import typingsJapgolly.d3kit.mod.ChartOptions
...
object global {
  ...
  object d3kit {
    ...
    open class AbstractChart protected ()
      extends typingsJapgolly.d3kit.mod.AbstractChart {
    ...
    open class AbstractPlate protected ()
      extends typingsJapgolly.d3kit.mod.AbstractPlate {
      def this(selector: String) = this()
      def this(selector: Element) = this()
      def this(selector: String, options: ChartOptions) = this()
      def this(selector: Element, options: ChartOptions) = this()
    ...
    @js.native
    open class Base ()
      extends typingsJapgolly.d3kit.mod.Base {
    ...
    open class CanvasChart protected ()
      extends typingsJapgolly.d3kit.mod.CanvasChart {
      def this(selector: String) = this()
      def this(selector: Element) = this()
      def this(selector: String, options: ChartOptions) = this()
      def this(selector: Element, options: ChartOptions) = this()
    ...
    open class CanvasPlate ()
      extends typingsJapgolly.d3kit.mod.CanvasPlate {
      def this(options: ChartOptions) = this()
    }
    /* static members */
    object CanvasPlate {
    ...
    @js.native
    open class DivPlate ()
      extends typingsJapgolly.d3kit.mod.DivPlate {
      def this(options: ChartOptions) = this()
    }
    /* static members */
    object DivPlate {
    ...
    open class HybridChart protected ()
      extends typingsJapgolly.d3kit.mod.HybridChart {
      def this(selector: String) = this()
      def this(selector: Element) = this()
      def this(selector: String, options: ChartOptions) = this()
      def this(selector: Element, options: ChartOptions) = this()
    ...
    open class LayerOrganizer protected ()
      extends typingsJapgolly.d3kit.mod.LayerOrganizer {
    ...
    open class SvgChart protected ()
      extends typingsJapgolly.d3kit.mod.SvgChart {
      def this(selector: String) = this()
      def this(selector: Element) = this()
      def this(selector: String, options: ChartOptions) = this()
      def this(selector: Element, options: ChartOptions) = this()
    ...
    @js.native
    open class SvgPlate ()
      extends typingsJapgolly.d3kit.mod.SvgPlate {
      def this(options: ChartOptions) = this()
    }
    /* static members */
    object SvgPlate {
