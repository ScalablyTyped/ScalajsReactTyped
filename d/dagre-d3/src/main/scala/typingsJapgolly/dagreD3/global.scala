...
import typingsJapgolly.dagreD3.mod.Point
import typingsJapgolly.dagreD3.mod.Render_
...
object global {
  ...
  object dagreD3 {
    ...
    object dagre {
      ...
      @JSGlobal("dagreD3.dagre")
      @js.native
      val ^ : js.Any = js.native
      
      object graphlib {
        
        @JSGlobal("dagreD3.dagre.graphlib.Graph")
        @js.native
        open class Graph[T] ()
          extends typingsJapgolly.dagreD3.mod.dagre.graphlib.Graph[T] {
          def this(opt: Compound) = this()
        }
        
        object alg {
          
          @JSGlobal("dagreD3.dagre.graphlib.alg")
          @js.native
          val ^ : js.Any = js.native
        ...
        object json {
          ...
          @JSGlobal("dagreD3.dagre.graphlib.json")
          @js.native
          val ^ : js.Any = js.native
    ...
    object graphlib {
      ...
      @js.native
      open class Graph ()
        extends typingsJapgolly.dagreD3.mod.graphlib.Graph {
