package typingsJapgolly.dagreD3
...
import typingsJapgolly.d3Selection.mod.ValueFn
import typingsJapgolly.d3Transition.mod.SelectionOrTransition
...
import typingsJapgolly.dagreD3.anon.Name
import typingsJapgolly.dagreD3.anon.Node
import typingsJapgolly.graphlib.mod.Edge
import typingsJapgolly.graphlib.mod.GraphOptions
import typingsJapgolly.graphlib.mod.Path
...
object mod {
  ...
  object graphlib {
    ...
    @js.native
    open class Graph ()
      extends typingsJapgolly.graphlib.mod.Graph {
    ...
    object alg {
      ...
      /**
        ...
        */
      inline def components(graph: typingsJapgolly.graphlib.mod.Graph): js.Array[js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("components")(graph.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Array[String]]]
      ...
      /**
        ...
        */
      inline def dijkstra(graph: typingsJapgolly.graphlib.mod.Graph, source: String): StringDictionary[Path] = (^.asInstanceOf[js.Dynamic].applyDynamic("dijkstra")(graph.asInstanceOf[js.Any], source.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Path]]
      inline def dijkstra(
        graph: typingsJapgolly.graphlib.mod.Graph,
        source: String,
        weightFn: js.Function1[/* e */ Edge, Double]
      ): StringDictionary[Path] = (^.asInstanceOf[js.Dynamic].applyDynamic("dijkstra")(graph.asInstanceOf[js.Any], source.asInstanceOf[js.Any], weightFn.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Path]]
      inline def dijkstra(
        graph: typingsJapgolly.graphlib.mod.Graph,
        source: String,
        weightFn: js.Function1[/* e */ Edge, Double],
      ...
      /**
        ...
        */
      inline def dijkstraAll(graph: typingsJapgolly.graphlib.mod.Graph): StringDictionary[StringDictionary[Path]] = ^.asInstanceOf[js.Dynamic].applyDynamic("dijkstraAll")(graph.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[StringDictionary[Path]]]
      inline def dijkstraAll(graph: typingsJapgolly.graphlib.mod.Graph, weightFn: js.Function1[/* e */ Edge, Double]): StringDictionary[StringDictionary[Path]] = (^.asInstanceOf[js.Dynamic].applyDynamic("dijkstraAll")(graph.asInstanceOf[js.Any], weightFn.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[StringDictionary[Path]]]
      ...
      /**
        ...
        * @returns cycles list.
        */
      inline def findCycles(graph: typingsJapgolly.graphlib.mod.Graph): js.Array[js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("findCycles")(graph.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Array[String]]]
      ...
      /**
        ...
        * @returns shortest pathes map.
        */
      inline def floydWarshall(graph: typingsJapgolly.graphlib.mod.Graph): StringDictionary[StringDictionary[Path]] = ^.asInstanceOf[js.Dynamic].applyDynamic("floydWarshall")(graph.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[StringDictionary[Path]]]
      inline def floydWarshall(graph: typingsJapgolly.graphlib.mod.Graph, weightFn: js.Function1[/* e */ Edge, Double]): StringDictionary[StringDictionary[Path]] = (^.asInstanceOf[js.Dynamic].applyDynamic("floydWarshall")(graph.asInstanceOf[js.Any], weightFn.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[StringDictionary[Path]]]
      ...
      /**
        ...
        */
      inline def isAcyclic(graph: typingsJapgolly.graphlib.mod.Graph): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isAcyclic")(graph.asInstanceOf[js.Any]).asInstanceOf[Boolean]
      ...
      /**
        ...
        */
      inline def postorder(graph: typingsJapgolly.graphlib.mod.Graph, vs: js.Array[String]): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("postorder")(graph.asInstanceOf[js.Any], vs.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
      ...
      /**
        ...
        * @returns the nodes in the order they were visited as a list of their names.
        */
      inline def preorder(graph: typingsJapgolly.graphlib.mod.Graph, vs: js.Array[String]): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("preorder")(graph.asInstanceOf[js.Any], vs.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
      ...
      /**
        ...
        */
      inline def prim(graph: typingsJapgolly.graphlib.mod.Graph, weightFn: js.Function1[/* e */ Edge, Double]): typingsJapgolly.graphlib.mod.Graph = (^.asInstanceOf[js.Dynamic].applyDynamic("prim")(graph.asInstanceOf[js.Any], weightFn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.graphlib.mod.Graph]
      ...
      /**
        ...
        */
      inline def tarjan(graph: typingsJapgolly.graphlib.mod.Graph): js.Array[js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("tarjan")(graph.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Array[String]]]
      ...
      /**
        ...
        */
      inline def topsort(graph: typingsJapgolly.graphlib.mod.Graph): js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("topsort")(graph.asInstanceOf[js.Any]).asInstanceOf[js.Array[String]]
    }
    ...
    object json {
      ...
      /**
        ...
        */
      inline def read(json: js.Object): typingsJapgolly.graphlib.mod.Graph = ^.asInstanceOf[js.Dynamic].applyDynamic("read")(json.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.graphlib.mod.Graph]
      ...
      /**
        ...
        */
      inline def write(graph: typingsJapgolly.graphlib.mod.Graph): js.Object = ^.asInstanceOf[js.Dynamic].applyDynamic("write")(graph.asInstanceOf[js.Any]).asInstanceOf[js.Object]
    }
  }
  ...
  type Arrow = js.Function4[
    ...
    /* id */ String, 
    /* edge */ typingsJapgolly.dagre.mod.Edge, 
    /* type */ String, 
    Unit
  ]
