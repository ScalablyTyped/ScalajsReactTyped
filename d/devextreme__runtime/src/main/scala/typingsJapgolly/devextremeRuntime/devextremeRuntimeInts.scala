...
import typingsJapgolly.devextremeRuntime.esmInfernoMockedVnodeFlagsMod.ChildFlags
import typingsJapgolly.devextremeRuntime.esmInfernoMockedVnodeFlagsMod.VNodeFlags
...
object devextremeRuntimeInts {
  ...
  sealed trait `-16385`
    extends StObject
       with VNodeFlags
       with typingsJapgolly.devextremeRuntime.cjsInfernoMockedVnodeFlagsMod.VNodeFlags
  ...
  sealed trait `0`
    extends StObject
       with ChildFlags
       with typingsJapgolly.devextremeRuntime.cjsInfernoMockedVnodeFlagsMod.ChildFlags
