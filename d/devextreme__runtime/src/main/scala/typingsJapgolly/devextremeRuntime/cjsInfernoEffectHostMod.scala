...
object cjsInfernoEffectHostMod {
  
  object InfernoEffectHost {
    
    @JSImport("@devextreme/runtime/cjs/inferno/effect_host", "InfernoEffectHost")
    @js.native
    val ^ : js.Any = js.native
    
    inline def callEffects(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("callEffects")().asInstanceOf[Unit]
    
    @JSImport("@devextreme/runtime/cjs/inferno/effect_host", "InfernoEffectHost.callbacks")
    @js.native
    ...
    @JSImport("@devextreme/runtime/cjs/inferno/effect_host", "InfernoEffectHost.lockCount")
    @js.native
