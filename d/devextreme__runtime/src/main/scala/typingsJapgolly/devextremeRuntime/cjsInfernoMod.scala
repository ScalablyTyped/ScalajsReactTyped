...
import typingsJapgolly.devextremeRuntime.cjsInfernoRenderTemplateMod.IProps
...
object cjsInfernoMod {
  ...
  open class BaseInfernoComponent[P, S] ()
    extends typingsJapgolly.devextremeRuntime.cjsInfernoBaseComponentMod.BaseInfernoComponent[P, S] {
  ...
  open class InfernoComponent[P, S] ()
    extends typingsJapgolly.devextremeRuntime.cjsInfernoBaseComponentMod.InfernoComponent[P, S] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
    def this(props: Unit, context: Any) = this()
  }
  ...
  open class InfernoEffect protected ()
    extends typingsJapgolly.devextremeRuntime.cjsInfernoEffectMod.InfernoEffect {
  ...
  open class InfernoWrapperComponent[P, S] ()
    extends typingsJapgolly.devextremeRuntime.cjsInfernoBaseComponentMod.InfernoWrapperComponent[P, S] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
    def this(props: Unit, context: Any) = this()
  }
  ...
  inline def createReRenderEffect(): typingsJapgolly.devextremeRuntime.cjsInfernoEffectMod.InfernoEffect = ^.asInstanceOf[js.Dynamic].applyDynamic("createReRenderEffect")().asInstanceOf[typingsJapgolly.devextremeRuntime.cjsInfernoEffectMod.InfernoEffect]
