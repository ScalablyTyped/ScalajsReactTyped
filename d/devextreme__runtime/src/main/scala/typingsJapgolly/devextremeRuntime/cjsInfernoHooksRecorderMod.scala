...
import typingsJapgolly.devextremeRuntime.cjsInfernoHooksContainerMod.HookContainer
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object cjsInfernoHooksRecorderMod {
  
  @JSImport("@devextreme/runtime/cjs/inferno-hooks/recorder", JSImport.Namespace)
  @js.native
  ...
  object currentComponent {
    ...
    @JSImport("@devextreme/runtime/cjs/inferno-hooks/recorder", "currentComponent")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@devextreme/runtime/cjs/inferno-hooks/recorder", "currentComponent.current")
    @js.native
