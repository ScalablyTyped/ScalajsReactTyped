...
import typingsJapgolly.devextremeRuntime.esmInfernoPortalMod.PortalProps
import typingsJapgolly.devextremeRuntime.esmInfernoRenderTemplateMod.IProps
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esmInfernoMod {
  
  @JSImport("@devextreme/runtime/esm/inferno", JSImport.Namespace)
  @js.native
  ...
  open class BaseInfernoComponent[P, S] ()
    extends typingsJapgolly.devextremeRuntime.esmInfernoBaseComponentMod.BaseInfernoComponent[P, S] {
  ...
  open class InfernoComponent[P, S] ()
    extends typingsJapgolly.devextremeRuntime.esmInfernoBaseComponentMod.InfernoComponent[P, S] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
    def this(props: Unit, context: Any) = this()
  }
  ...
  open class InfernoEffect protected ()
    extends typingsJapgolly.devextremeRuntime.esmInfernoEffectMod.InfernoEffect {
    def this(effect: js.Function0[js.Function0[Unit] | Unit], dependency: js.Array[Any]) = this()
  }
  
  object InfernoEffectHost {
    
    @JSImport("@devextreme/runtime/esm/inferno", "InfernoEffectHost")
    @js.native
    val ^ : js.Any = js.native
    
    inline def callEffects(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("callEffects")().asInstanceOf[Unit]
    
    @JSImport("@devextreme/runtime/esm/inferno", "InfernoEffectHost.callbacks")
    @js.native
    ...
    @JSImport("@devextreme/runtime/esm/inferno", "InfernoEffectHost.lockCount")
    @js.native
  ...
  open class InfernoWrapperComponent[P, S] ()
    extends typingsJapgolly.devextremeRuntime.esmInfernoBaseComponentMod.InfernoWrapperComponent[P, S] {
    def this(props: P) = this()
    def this(props: P, context: Any) = this()
    def this(props: Unit, context: Any) = this()
  }
  ...
  inline def createReRenderEffect(): typingsJapgolly.devextremeRuntime.esmInfernoEffectMod.InfernoEffect = ^.asInstanceOf[js.Dynamic].applyDynamic("createReRenderEffect")().asInstanceOf[typingsJapgolly.devextremeRuntime.esmInfernoEffectMod.InfernoEffect]
