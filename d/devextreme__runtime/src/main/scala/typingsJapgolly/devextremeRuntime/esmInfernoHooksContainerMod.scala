...
import typingsJapgolly.devextremeRuntime.anon.Id
import typingsJapgolly.devextremeRuntime.anon.RenderRef
import typingsJapgolly.inferno.distCoreTypesMod.global.JSX.Element
...
object esmInfernoHooksContainerMod {
  ...
  @js.native
  open class HookContainer () extends Component[RenderRef, Record[String, Any]] {
