...
import typingsJapgolly.devextremeRuntime.cjsAngularTemplateMod.IModel
import typingsJapgolly.devextremeRuntime.cjsAngularUpdateUndefinedFromDefaultsMod.DefaultEntries
...
object cjsAngularMod {
  ...
  open class UndefinedNativeElementRef[T] ()
    extends typingsJapgolly.devextremeRuntime.cjsAngularUndefinedNativeElementRefMod.UndefinedNativeElementRef[T]
