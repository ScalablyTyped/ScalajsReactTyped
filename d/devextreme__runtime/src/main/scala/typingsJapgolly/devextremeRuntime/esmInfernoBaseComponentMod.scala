...
import typingsJapgolly.devextremeRuntime.esmInfernoEffectMod.InfernoEffect
...
object esmInfernoBaseComponentMod {
  
  @JSImport("@devextreme/runtime/esm/inferno/base_component", "BaseInfernoComponent")
  @js.native
  ...
  @JSImport("@devextreme/runtime/esm/inferno/base_component", "InfernoComponent")
  @js.native
  ...
  @JSImport("@devextreme/runtime/esm/inferno/base_component", "InfernoWrapperComponent")
  @js.native
