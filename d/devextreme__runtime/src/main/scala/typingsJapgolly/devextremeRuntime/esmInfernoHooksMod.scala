...
import typingsJapgolly.devextremeRuntime.esmInfernoHooksHooksMod.Dispatch
import typingsJapgolly.devextremeRuntime.esmInfernoHooksHooksMod.SetStateAction
import typingsJapgolly.devextremeRuntime.esmInfernoHooksPortalMod.PortalProps
...
object esmInfernoHooksMod {
  ...
  open class HookContainer ()
    extends typingsJapgolly.devextremeRuntime.esmInfernoHooksContainerMod.HookContainer {
  ...
  open class InfernoWrapperComponent ()
    extends typingsJapgolly.devextremeRuntime.esmInfernoHooksBaseHooksComponentMod.InfernoWrapperComponent {
    def this(props: RenderRef) = this()
    def this(props: Unit, context: Any) = this()
    def this(props: RenderRef, context: Any) = this()
  }
  ...
  inline def createRecorder(component: typingsJapgolly.devextremeRuntime.esmInfernoHooksContainerMod.HookContainer): ComponentDidMount = ^.asInstanceOf[js.Dynamic].applyDynamic("createRecorder")(component.asInstanceOf[js.Any]).asInstanceOf[ComponentDidMount]
  ...
  inline def renderChild(
    component: typingsJapgolly.devextremeRuntime.esmInfernoHooksContainerMod.HookContainer,
