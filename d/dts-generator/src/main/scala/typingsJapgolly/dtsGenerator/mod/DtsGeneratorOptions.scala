package typingsJapgolly.dtsGenerator.mod
...
object DtsGeneratorOptions {
  ...
  def apply(
    ...
    project: String = null,
    resolveModuleId: /* params */ ResolveModuleIdParams => CallbackTo[String] = null,
    resolveModuleImport: /* params */ ResolveModuleImportParams => CallbackTo[String] = null,
    ...
    if (resolveModuleId != null) __obj.updateDynamic("resolveModuleId")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.dtsGenerator.mod.ResolveModuleIdParams) => resolveModuleId(t0).runNow()))
    if (resolveModuleImport != null) __obj.updateDynamic("resolveModuleImport")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.dtsGenerator.mod.ResolveModuleImportParams) => resolveModuleImport(t0).runNow()))
