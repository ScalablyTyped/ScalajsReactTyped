package typingsJapgolly.dtsGenerator
...
object mod {
  ...
  inline def apply(options: DtsGeneratorOptions): typingsJapgolly.bluebird.mod.^[Unit] = ^.asInstanceOf[js.Dynamic].apply(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  ...
  object DtsGeneratorOptions {
    ...
    extension [Self <: DtsGeneratorOptions](x: Self) {
      ...
      inline def setSendMessage(value: (/* message */ Any, /* repeated */ Any) => Callback): Self = StObject.set(x, "sendMessage", js.Any.fromFunction2((t0: /* message */ Any, t1: /* repeated */ Any) => (value(t0, t1)).runNow()))
