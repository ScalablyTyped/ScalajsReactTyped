...
trait DetoxAndroidAppConfig extends StObject {
...
object DetoxAndroidAppConfig {
  
  inline def apply(binaryPath: String): DetoxAndroidAppConfig = {
    val __obj = js.Dynamic.literal(binaryPath = binaryPath.asInstanceOf[js.Any])
    __obj.updateDynamic("type")("android.apk")
    __obj.asInstanceOf[DetoxAndroidAppConfig]
  }
  
  extension [Self <: DetoxAndroidAppConfig](x: Self) {
