...
import typingsJapgolly.detox.mod._Global_.Detox_.Direction
import typingsJapgolly.detox.mod._Global_.Detox_.LocationPermission
import typingsJapgolly.detox.mod._Global_.Detox_.Orientation
import typingsJapgolly.detox.mod._Global_.Detox_.PermissionState
import typingsJapgolly.detox.mod._Global_.Detox_.Speed
