...
import typingsJapgolly.domAccessibilityApi.domAccessibilityApiStrings.description
import typingsJapgolly.domAccessibilityApi.domAccessibilityApiStrings.name
