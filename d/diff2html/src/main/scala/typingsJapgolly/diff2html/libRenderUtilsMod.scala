...
import typingsJapgolly.diff2html.anon.Content
import typingsJapgolly.diff2html.libTypesMod.DiffFile
import typingsJapgolly.diff2html.libTypesMod.DiffFileName
import typingsJapgolly.diff2html.libTypesMod.DiffLineParts
import typingsJapgolly.diff2html.libTypesMod.DiffStyleType
import typingsJapgolly.diff2html.libTypesMod.LineMatchingType
import typingsJapgolly.diff2html.libTypesMod.LineType
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libRenderUtilsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.diff2html.diff2htmlStrings.`d2h-ins`
    - typingsJapgolly.diff2html.diff2htmlStrings.`d2h-del`
    - typingsJapgolly.diff2html.diff2htmlStrings.`d2h-cntx`
    - typingsJapgolly.diff2html.diff2htmlStrings.`d2h-info`
    - typingsJapgolly.diff2html.diff2htmlStrings.`d2h-ins d2h-change`
    - typingsJapgolly.diff2html.diff2htmlStrings.`d2h-del d2h-change`
  */
