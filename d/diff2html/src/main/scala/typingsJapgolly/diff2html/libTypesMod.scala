...
import typingsJapgolly.diff2html.libTypesMod.LineType.CONTEXT
import typingsJapgolly.diff2html.libTypesMod.LineType.DELETE
import typingsJapgolly.diff2html.libTypesMod.LineType.INSERT
...
object libTypesMod {
  ...
  object LineType extends StObject {
    ...
    sealed trait CONTEXT
      extends StObject
         with LineType
    /* "context" */ val CONTEXT: typingsJapgolly.diff2html.libTypesMod.LineType.CONTEXT & String = js.native
    
    @js.native
    sealed trait DELETE
      extends StObject
         with LineType
    /* "delete" */ val DELETE: typingsJapgolly.diff2html.libTypesMod.LineType.DELETE & String = js.native
    
    @js.native
    sealed trait INSERT
      extends StObject
         with LineType
    /* "insert" */ val INSERT: typingsJapgolly.diff2html.libTypesMod.LineType.INSERT & String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.diff2html.diff2htmlStrings.word
    - typingsJapgolly.diff2html.diff2htmlStrings.char
  */
  trait DiffStyleType extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.diff2html.diff2htmlStrings.lines
    - typingsJapgolly.diff2html.diff2htmlStrings.words
    - typingsJapgolly.diff2html.diff2htmlStrings.none
  */
  trait LineMatchingType extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.diff2html.diff2htmlStrings.`line-by-line`
    - typingsJapgolly.diff2html.diff2htmlStrings.`side-by-side`
  */
