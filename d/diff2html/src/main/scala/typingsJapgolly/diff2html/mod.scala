...
import typingsJapgolly.diff2html.libDiffParserMod.DiffParserConfig
import typingsJapgolly.diff2html.libHoganjsUtilsMod.HoganJsUtilsConfig
import typingsJapgolly.diff2html.libLineByLineRendererMod.LineByLineRendererConfig
...
object mod {
  ...
  - typingsJapgolly.diff2html.libRenderUtilsMod.RenderConfig because Already inherited
  - typingsJapgolly.diff2html.libSideBySideRendererMod.SideBySideRendererConfig because var conflicts: diffStyle, matchWordsThreshold, matching, matchingMaxComparisons, maxLineLengthHighlight, maxLineSizeInBlockForComparison, renderNothingWhenEmpty. Inlined  */ trait Diff2HtmlConfig
    extends StObject
