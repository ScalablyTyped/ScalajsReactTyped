package typingsJapgolly.dotdotdot.JQueryDotDotDot

import japgolly.scalajs.react.Callback
import typingsJapgolly.dotdotdot.JQuery
...
object IDotDotDotOptions {
  ...
  def apply(
    ...
    callback: (/* isTruncated */ Boolean, /* orgContent */ js.Any) => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: /* isTruncated */ scala.Boolean, t1: /* orgContent */ js.Any) => callback(t0, t1).runNow()))
