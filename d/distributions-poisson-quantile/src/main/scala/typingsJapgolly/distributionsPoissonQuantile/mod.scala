...
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypefloat32
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypefloat64undefi
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypeint16
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypeint32
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypeint8
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypeuint16
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypeuint32
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypeuint8
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypeuint8clamped
import typingsJapgolly.distributionsPoissonQuantile.anon.Optionsdtypeundefined
...
object mod {
  ...
  inline def apply(p: MatrixLike): Matrix = ^.asInstanceOf[js.Dynamic].apply(p.asInstanceOf[js.Any]).asInstanceOf[Matrix]
  inline def apply(p: MatrixLike, options: Options): Matrix = (^.asInstanceOf[js.Dynamic].apply(p.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Matrix]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int8
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint8
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint8_clamped
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int16
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint16
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int32
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint32
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.float32
    - typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.float64
  */
  trait DataType extends StObject
  object DataType {
    
    inline def float32: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.float32 = "float32".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.float32]
    
    inline def float64: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.float64 = "float64".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.float64]
    
    inline def int16: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int16 = "int16".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int16]
    
    inline def int32: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int32 = "int32".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int32]
    
    inline def int8: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int8 = "int8".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.int8]
    
    inline def uint16: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint16 = "uint16".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint16]
    
    inline def uint32: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint32 = "uint32".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint32]
    
    inline def uint8: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint8 = "uint8".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint8]
    
    inline def uint8_clamped: typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint8_clamped = "uint8_clamped".asInstanceOf[typingsJapgolly.distributionsPoissonQuantile.distributionsPoissonQuantileStrings.uint8_clamped]
  }
