...
object dynamsoftMod extends Shortcut {
  ...
  object DynamsoftStatic {
    ...
    @js.native
    def FileUploader: typingsJapgolly.dwt.dynamsoftDotFileUploaderMod.FileUploader = js.native
    ...
    @js.native
    def WebTwainEnv: typingsJapgolly.dwt.dynamsoftMod.WebTwainEnv = js.native
  ...
  object DSLibEnv {
    ...
    inline def apply(
      ...
      isDesktopViewer: CallbackTo[Boolean],
      isMobileViewer: CallbackTo[Boolean],
      isPadViewer: CallbackTo[Boolean],
      isX64: Boolean,
      macOSX: String,
      osVersion: String,
      pathType: Double,
      ...
      val __obj = js.Dynamic.literal(WSSession = WSSession.asInstanceOf[js.Any], WSVersion = WSVersion.asInstanceOf[js.Any], bChrome = bChrome.asInstanceOf[js.Any], bEdge = bEdge.asInstanceOf[js.Any], bFileSystem = bFileSystem.asInstanceOf[js.Any], bFirefox = bFirefox.asInstanceOf[js.Any], bIE = bIE.asInstanceOf[js.Any], bLinux = bLinux.asInstanceOf[js.Any], bMac = bMac.asInstanceOf[js.Any], bMobile = bMobile.asInstanceOf[js.Any], bSafari = bSafari.asInstanceOf[js.Any], bWin = bWin.asInstanceOf[js.Any], bWin64 = bWin64.asInstanceOf[js.Any], basePath = basePath.asInstanceOf[js.Any], iPluginLength = iPluginLength.asInstanceOf[js.Any], isDesktopViewer = isDesktopViewer.toJsFn, isMobileViewer = isMobileViewer.toJsFn, isPadViewer = isPadViewer.toJsFn, isX64 = isX64.asInstanceOf[js.Any], macOSX = macOSX.asInstanceOf[js.Any], osVersion = osVersion.asInstanceOf[js.Any], pathType = pathType.asInstanceOf[js.Any], strChromeVersion = strChromeVersion.asInstanceOf[js.Any], strFirefoxVersion = strFirefoxVersion.asInstanceOf[js.Any], strIEVersion = strIEVersion.asInstanceOf[js.Any])
    ...
    extension [Self <: DSLibEnv](x: Self) {
      ...
      inline def setIsDesktopViewer(value: CallbackTo[Boolean]): Self = StObject.set(x, "isDesktopViewer", value.toJsFn)
      
      inline def setIsMobileViewer(value: CallbackTo[Boolean]): Self = StObject.set(x, "isMobileViewer", value.toJsFn)
      
      inline def setIsPadViewer(value: CallbackTo[Boolean]): Self = StObject.set(x, "isPadViewer", value.toJsFn)
  ...
  object DynamsoftLib {
    ...
    inline def apply(
      addEventListener: (HTMLElement, String, EventListenerOrEventListenerObject) => Callback,
      debug: Boolean,
      detect: DSLibDetect,
      dlgLoadingShowStatus: Boolean,
      env: DSLibEnv,
      getScript: (String, Boolean, js.Function0[Unit]) => Callback,
      getScripts: (js.Array[String], Boolean, js.Function0[Unit]) => Callback,
      hideMask: Callback,
      product: Product,
      showMask: Callback
    ): DynamsoftLib = {
      val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction3((t0: HTMLElement, t1: String, t2: EventListenerOrEventListenerObject) => (addEventListener(t0, t1, t2)).runNow()), debug = debug.asInstanceOf[js.Any], detect = detect.asInstanceOf[js.Any], dlgLoadingShowStatus = dlgLoadingShowStatus.asInstanceOf[js.Any], env = env.asInstanceOf[js.Any], getScript = js.Any.fromFunction3((t0: String, t1: Boolean, t2: js.Function0[Unit]) => (getScript(t0, t1, t2)).runNow()), getScripts = js.Any.fromFunction3((t0: js.Array[String], t1: Boolean, t2: js.Function0[Unit]) => (getScripts(t0, t1, t2)).runNow()), hideMask = hideMask.toJsFn, product = product.asInstanceOf[js.Any], showMask = showMask.toJsFn)
      __obj.asInstanceOf[DynamsoftLib]
    }
    
    extension [Self <: DynamsoftLib](x: Self) {
      
      inline def setAddEventListener(value: (HTMLElement, String, EventListenerOrEventListenerObject) => Callback): Self = StObject.set(x, "addEventListener", js.Any.fromFunction3((t0: HTMLElement, t1: String, t2: EventListenerOrEventListenerObject) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setGetScript(value: (String, Boolean, js.Function0[Unit]) => Callback): Self = StObject.set(x, "getScript", js.Any.fromFunction3((t0: String, t1: Boolean, t2: js.Function0[Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setGetScripts(value: (js.Array[String], Boolean, js.Function0[Unit]) => Callback): Self = StObject.set(x, "getScripts", js.Any.fromFunction3((t0: js.Array[String], t1: Boolean, t2: js.Function0[Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setHideMask(value: Callback): Self = StObject.set(x, "hideMask", value.toJsFn)
      
      inline def setProduct(value: Product): Self = StObject.set(x, "product", value.asInstanceOf[js.Any])
      
      inline def setShowMask(value: Callback): Self = StObject.set(x, "showMask", value.toJsFn)
    }
  }
