...
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTInterpolationMethod
import typingsJapgolly.dwt.webTwainDotBufferMod.WebTwainBuffer
