...
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTTIFFCompressionType
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTUploadDataFormat
import typingsJapgolly.dwt.webTwainDotUtilMod.WebTwainUtil
...
object webTwainDotIOMod {
  ...
  object Base64Result {
    ...
    inline def apply(getData: (Double, Double) => String, getLength: CallbackTo[Double], getMD5: CallbackTo[String]): Base64Result = {
      val __obj = js.Dynamic.literal(getData = js.Any.fromFunction2(getData), getLength = getLength.toJsFn, getMD5 = getMD5.toJsFn)
    ...
    extension [Self <: Base64Result](x: Self) {
      ...
      inline def setGetMD5(value: CallbackTo[String]): Self = StObject.set(x, "getMD5", value.toJsFn)
    }
  }
