...
object EnumDWTCapFeederAlignment extends StObject {
  ...
  /* 2 */ val TWFA_CENTER: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederAlignment.TWFA_CENTER & Double = js.native
  ...
  sealed trait TWFA_LEFT
    extends StObject
       with EnumDWTCapFeederAlignment
  /* 1 */ val TWFA_LEFT: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederAlignment.TWFA_LEFT & Double = js.native
  ...
  sealed trait TWFA_NONE
    extends StObject
       with EnumDWTCapFeederAlignment
  /* 0 */ val TWFA_NONE: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederAlignment.TWFA_NONE & Double = js.native
  ...
  sealed trait TWFA_RIGHT
    extends StObject
       with EnumDWTCapFeederAlignment
  /* 3 */ val TWFA_RIGHT: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederAlignment.TWFA_RIGHT & Double = js.native
}
