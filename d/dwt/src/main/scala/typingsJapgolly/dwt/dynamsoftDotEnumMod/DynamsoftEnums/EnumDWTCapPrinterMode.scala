...
object EnumDWTCapPrinterMode extends StObject {
  ...
  /* 2 */ val TWPM_COMPOUNDSTRING: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_COMPOUNDSTRING & Double = js.native
  ...
  sealed trait TWPM_MULTISTRING
    extends StObject
       with EnumDWTCapPrinterMode
  /* 1 */ val TWPM_MULTISTRING: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_MULTISTRING & Double = js.native
  ...
  sealed trait TWPM_SINGLESTRING
    extends StObject
       with EnumDWTCapPrinterMode
  /* 0 */ val TWPM_SINGLESTRING: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPrinterMode.TWPM_SINGLESTRING & Double = js.native
}
