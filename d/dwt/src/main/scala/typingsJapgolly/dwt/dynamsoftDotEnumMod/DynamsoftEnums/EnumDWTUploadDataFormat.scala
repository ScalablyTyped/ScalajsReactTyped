...
object EnumDWTUploadDataFormat extends StObject {
  ...
  /* 1 */ val Base64: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTUploadDataFormat.Base64 & Double = js.native
  
  @js.native
  sealed trait Binary
    extends StObject
       with EnumDWTUploadDataFormat
  /* 0 */ val Binary: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTUploadDataFormat.Binary & Double = js.native
}
