...
object EnumDWTConvertMode extends StObject {
  ...
  /* 0 */ val CM_DEFAULT: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTConvertMode.CM_DEFAULT & Double = js.native
  
  @js.native
  sealed trait CM_RENDERALL
    extends StObject
       with EnumDWTConvertMode
  /* 1 */ val CM_RENDERALL: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTConvertMode.CM_RENDERALL & Double = js.native
}
