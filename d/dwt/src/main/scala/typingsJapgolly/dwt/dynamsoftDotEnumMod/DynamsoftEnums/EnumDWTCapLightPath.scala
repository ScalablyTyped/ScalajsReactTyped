...
object EnumDWTCapLightPath extends StObject {
  ...
  /* 0 */ val TWLP_REFLECTIVE: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapLightPath.TWLP_REFLECTIVE & Double = js.native
  
  @js.native
  sealed trait TWLP_TRANSMISSIVE
    extends StObject
       with EnumDWTCapLightPath
  /* 1 */ val TWLP_TRANSMISSIVE: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapLightPath.TWLP_TRANSMISSIVE & Double = js.native
}
