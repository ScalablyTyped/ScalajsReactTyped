...
object EnumDWTDataSourceStatus extends StObject {
  ...
  /* 3 */ val TWDSS_ACQUIRING: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTDataSourceStatus.TWDSS_ACQUIRING & Double = js.native
  ...
  sealed trait TWDSS_CLOSED
    extends StObject
       with EnumDWTDataSourceStatus
  /* 0 */ val TWDSS_CLOSED: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTDataSourceStatus.TWDSS_CLOSED & Double = js.native
  ...
  sealed trait TWDSS_ENABLED
    extends StObject
       with EnumDWTDataSourceStatus
  /* 2 */ val TWDSS_ENABLED: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTDataSourceStatus.TWDSS_ENABLED & Double = js.native
  ...
  sealed trait TWDSS_OPENED
    extends StObject
       with EnumDWTDataSourceStatus
  /* 1 */ val TWDSS_OPENED: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTDataSourceStatus.TWDSS_OPENED & Double = js.native
}
