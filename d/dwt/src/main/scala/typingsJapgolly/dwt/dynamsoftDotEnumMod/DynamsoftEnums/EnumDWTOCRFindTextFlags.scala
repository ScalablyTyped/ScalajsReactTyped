...
object EnumDWTOCRFindTextFlags extends StObject {
  ...
  /* 4 */ val OCRFT_FUZZYMATCH: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTOCRFindTextFlags.OCRFT_FUZZYMATCH & Double = js.native
  
  @js.native
  sealed trait OCRFT_MATCHCASE
    extends StObject
       with EnumDWTOCRFindTextFlags
  /* 2 */ val OCRFT_MATCHCASE: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTOCRFindTextFlags.OCRFT_MATCHCASE & Double = js.native
  
  @js.native
  sealed trait OCRFT_WHOLEWORD
    extends StObject
       with EnumDWTOCRFindTextFlags
  /* 1 */ val OCRFT_WHOLEWORD: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTOCRFindTextFlags.OCRFT_WHOLEWORD & Double = js.native
}
