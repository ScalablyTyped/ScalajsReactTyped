...
object EnumDWTCapPlanarChunky extends StObject {
  ...
  /* 0 */ val TWPC_CHUNKY: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPlanarChunky.TWPC_CHUNKY & Double = js.native
  
  @js.native
  sealed trait TWPC_PLANAR
    extends StObject
       with EnumDWTCapPlanarChunky
  /* 1 */ val TWPC_PLANAR: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPlanarChunky.TWPC_PLANAR & Double = js.native
}
