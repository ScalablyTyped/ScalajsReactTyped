...
object EnumDPMCodeReadingMode extends StObject {
  ...
  /* 1 */ val DPMCRM_AUTO: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDPMCodeReadingMode.DPMCRM_AUTO & Double = js.native
  
  @js.native
  sealed trait DPMCRM_GENERAL
    extends StObject
       with EnumDPMCodeReadingMode
  /* 2 */ val DPMCRM_GENERAL: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDPMCodeReadingMode.DPMCRM_GENERAL & Double = js.native
  
  @js.native
  sealed trait DPMCRM_SKIP
    extends StObject
       with EnumDPMCodeReadingMode
  /* 0 */ val DPMCRM_SKIP: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDPMCodeReadingMode.DPMCRM_SKIP & Double = js.native
}
