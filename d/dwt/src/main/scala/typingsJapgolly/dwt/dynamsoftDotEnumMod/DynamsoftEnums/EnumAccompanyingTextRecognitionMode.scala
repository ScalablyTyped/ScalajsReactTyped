...
object EnumAccompanyingTextRecognitionMode extends StObject {
  ...
  /* 1 */ val ATRM_GENERAL: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumAccompanyingTextRecognitionMode.ATRM_GENERAL & Double = js.native
  
  @js.native
  sealed trait ATRM_SKIP
    extends StObject
       with EnumAccompanyingTextRecognitionMode
  /* 0 */ val ATRM_SKIP: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumAccompanyingTextRecognitionMode.ATRM_SKIP & Double = js.native
}
