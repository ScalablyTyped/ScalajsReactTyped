...
object EnumIntermediateResultSavingMode extends StObject {
  ...
  /* 4 */ val IRSM_BOTH: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_BOTH & Double = js.native
  
  @js.native
  sealed trait IRSM_FILESYSTEM
    extends StObject
       with EnumIntermediateResultSavingMode
  /* 2 */ val IRSM_FILESYSTEM: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_FILESYSTEM & Double = js.native
  
  @js.native
  sealed trait IRSM_MEMORY
    extends StObject
       with EnumIntermediateResultSavingMode
  /* 1 */ val IRSM_MEMORY: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumIntermediateResultSavingMode.IRSM_MEMORY & Double = js.native
}
