...
object EnumColourClusteringMode extends StObject {
  ...
  /* 1 */ val CCM_AUTO: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumColourClusteringMode.CCM_AUTO & Double = js.native
  
  @js.native
  sealed trait CCM_GENERAL_HSV
    extends StObject
       with EnumColourClusteringMode
  /* 2 */ val CCM_GENERAL_HSV: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumColourClusteringMode.CCM_GENERAL_HSV & Double = js.native
  
  @js.native
  sealed trait CCM_SKIP
    extends StObject
       with EnumColourClusteringMode
  /* 0 */ val CCM_SKIP: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumColourClusteringMode.CCM_SKIP & Double = js.native
}
