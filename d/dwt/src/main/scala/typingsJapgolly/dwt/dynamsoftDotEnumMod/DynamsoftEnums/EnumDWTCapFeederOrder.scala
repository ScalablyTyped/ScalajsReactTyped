...
object EnumDWTCapFeederOrder extends StObject {
  ...
  /* 0 */ val TWFO_FIRSTPAGEFIRST: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederOrder.TWFO_FIRSTPAGEFIRST & Double = js.native
  ...
  sealed trait TWFO_LASTPAGEFIRST
    extends StObject
       with EnumDWTCapFeederOrder
  /* 1 */ val TWFO_LASTPAGEFIRST: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapFeederOrder.TWFO_LASTPAGEFIRST & Double = js.native
}
