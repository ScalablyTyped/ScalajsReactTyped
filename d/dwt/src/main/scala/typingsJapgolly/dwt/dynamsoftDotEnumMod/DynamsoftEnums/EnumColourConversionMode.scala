...
object EnumColourConversionMode extends StObject {
  ...
  /* 1 */ val CICM_GENERAL: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumColourConversionMode.CICM_GENERAL & Double = js.native
  
  @js.native
  sealed trait CICM_SKIP
    extends StObject
       with EnumColourConversionMode
  /* 0 */ val CICM_SKIP: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumColourConversionMode.CICM_SKIP & Double = js.native
}
