...
object EnumDWTCapPixelFlavor extends StObject {
  ...
  /* 0 */ val TWPF_CHOCOLATE: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPixelFlavor.TWPF_CHOCOLATE & Double = js.native
  ...
  sealed trait TWPF_VANILLA
    extends StObject
       with EnumDWTCapPixelFlavor
  /* 1 */ val TWPF_VANILLA: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapPixelFlavor.TWPF_VANILLA & Double = js.native
}
