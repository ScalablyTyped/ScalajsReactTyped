...
object EnumTextFilterMode extends StObject {
  ...
  /* 1 */ val TFM_AUTO: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumTextFilterMode.TFM_AUTO & Double = js.native
  
  @js.native
  sealed trait TFM_GENERAL_CONTOUR
    extends StObject
       with EnumTextFilterMode
  /* 2 */ val TFM_GENERAL_CONTOUR: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumTextFilterMode.TFM_GENERAL_CONTOUR & Double = js.native
  
  @js.native
  sealed trait TFM_SKIP
    extends StObject
       with EnumTextFilterMode
  /* 0 */ val TFM_SKIP: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumTextFilterMode.TFM_SKIP & Double = js.native
}
