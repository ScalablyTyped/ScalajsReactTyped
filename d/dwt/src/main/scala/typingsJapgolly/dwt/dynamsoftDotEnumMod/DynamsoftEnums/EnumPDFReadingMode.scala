...
object EnumPDFReadingMode extends StObject {
  ...
  /* 2 */ val PDFRM_AUTO: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumPDFReadingMode.PDFRM_AUTO & Double = js.native
  
  @js.native
  sealed trait PDFRM_RASTER
    extends StObject
       with EnumPDFReadingMode
  /* 1 */ val PDFRM_RASTER: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumPDFReadingMode.PDFRM_RASTER & Double = js.native
  
  @js.native
  sealed trait PDFRM_VECTOR
    extends StObject
       with EnumPDFReadingMode
  /* 4 */ val PDFRM_VECTOR: typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumPDFReadingMode.PDFRM_VECTOR & Double = js.native
}
