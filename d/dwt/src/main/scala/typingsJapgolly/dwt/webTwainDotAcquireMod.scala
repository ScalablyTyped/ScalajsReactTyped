...
import typingsJapgolly.dwt.anon.AutoBorderDetection
import typingsJapgolly.dwt.anon.BDuplex
import typingsJapgolly.dwt.anon.BShowIndicator
import typingsJapgolly.dwt.anon.CompressionType
import typingsJapgolly.dwt.anon.CurrentPageNum
import typingsJapgolly.dwt.anon.Format
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCap
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapSupportedSizes
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapType
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTCapValueType
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTDUPLEX
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTDriver
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTFileFormat
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTMagType
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTMessageType
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTPixelType
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTTransferMode
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTUnitType
import typingsJapgolly.dwt.webTwainDotEditMod.WebTwainEdit
...
object webTwainDotAcquireMod {
  ...
  object ScanSetup {
    ...
    extension [Self <: ScanSetup](x: Self) {
      ...
      inline def setFuncScanStatus(value: /* status */ Status => Callback): Self = StObject.set(x, "funcScanStatus", js.Any.fromFunction1((t0: /* status */ Status) => value(t0).runNow()))
  ...
  trait SourceDetails extends StObject {
    ...
    /**
      ...
      */
    var Version: js.UndefOr[typingsJapgolly.dwt.webTwainDotAcquireMod.Version] = js.undefined
  }
