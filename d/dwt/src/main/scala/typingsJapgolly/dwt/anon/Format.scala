...
import typingsJapgolly.dwt.dwtBooleans.`false`
import typingsJapgolly.dwt.dynamsoftDotEnumMod.DynamsoftEnums.EnumDWTImageType
...
object Format {
  ...
  extension [Self <: Format](x: Self) {
    ...
    inline def setFuncHttpUploadStatus(value: /* fileInfo */ Any => Callback): Self = StObject.set(x, "funcHttpUploadStatus", js.Any.fromFunction1((t0: /* fileInfo */ Any) => value(t0).runNow()))
