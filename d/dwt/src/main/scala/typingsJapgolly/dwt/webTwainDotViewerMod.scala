...
import typingsJapgolly.dwt.addonDotCameraMod.Resolution
import typingsJapgolly.dwt.anon.AllImage
import typingsJapgolly.dwt.anon.AsideBackground
import typingsJapgolly.dwt.anon.AsideMenu
import typingsJapgolly.dwt.anon.AutoFit
import typingsJapgolly.dwt.anon.BackgroundColor
import typingsJapgolly.dwt.anon.Crop
import typingsJapgolly.dwt.anon.CropBar
import typingsJapgolly.dwt.anon.DisplayMode
import typingsJapgolly.dwt.anon.Global
import typingsJapgolly.dwt.anon.GoToThumbnail
import typingsJapgolly.dwt.anon.IfResize
import typingsJapgolly.dwt.webTwainDotAcquireMod.WebTwainAcquire
