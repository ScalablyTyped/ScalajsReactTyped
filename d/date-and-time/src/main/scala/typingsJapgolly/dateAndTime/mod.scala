package typingsJapgolly.dateAndTime
...
object mod {
  ...
  inline def timeSpan(date1: js.Date, date2: js.Date): typingsJapgolly.dateAndTime.pluginTimespanMod.dateAndTimeAugmentingMod.TimeSpanResult = (^.asInstanceOf[js.Dynamic].applyDynamic("timeSpan")(date1.asInstanceOf[js.Any], date2.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.dateAndTime.pluginTimespanMod.dateAndTimeAugmentingMod.TimeSpanResult]
  ...
  object SubtractResult {
    ...
    inline def apply(
      toDays: CallbackTo[Double],
      toHours: CallbackTo[Double],
      toMilliseconds: CallbackTo[Double],
      toMinutes: CallbackTo[Double],
      toSeconds: CallbackTo[Double]
    ): SubtractResult = {
      val __obj = js.Dynamic.literal(toDays = toDays.toJsFn, toHours = toHours.toJsFn, toMilliseconds = toMilliseconds.toJsFn, toMinutes = toMinutes.toJsFn, toSeconds = toSeconds.toJsFn)
      __obj.asInstanceOf[SubtractResult]
    }
    
    extension [Self <: SubtractResult](x: Self) {
      
      inline def setToDays(value: CallbackTo[Double]): Self = StObject.set(x, "toDays", value.toJsFn)
      
      inline def setToHours(value: CallbackTo[Double]): Self = StObject.set(x, "toHours", value.toJsFn)
      
      inline def setToMilliseconds(value: CallbackTo[Double]): Self = StObject.set(x, "toMilliseconds", value.toJsFn)
      
      inline def setToMinutes(value: CallbackTo[Double]): Self = StObject.set(x, "toMinutes", value.toJsFn)
      
      inline def setToSeconds(value: CallbackTo[Double]): Self = StObject.set(x, "toSeconds", value.toJsFn)
    }
  }
