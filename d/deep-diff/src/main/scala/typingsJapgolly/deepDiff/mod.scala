...
object mod {
  ...
  object Accumulator {
    ...
    inline def apply[LHS, RHS](length: Double, push: Diff_[LHS, RHS] => Callback): Accumulator[LHS, RHS] = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any], push = js.Any.fromFunction1((t0: Diff_[LHS, RHS]) => push(t0).runNow()))
    ...
    extension [Self <: Accumulator[?, ?], LHS, RHS](x: Self & (Accumulator[LHS, RHS])) {
      ...
      inline def setPush(value: Diff_[LHS, RHS] => Callback): Self = StObject.set(x, "push", js.Any.fromFunction1((t0: Diff_[LHS, RHS]) => value(t0).runNow()))
    }
  }
  ...
  */
  ...
  object Diff_ {
    ...
    inline def DiffArray[LHS, RHS](index: Double, item: Diff_[LHS, RHS]): typingsJapgolly.deepDiff.mod.DiffArray[LHS, RHS] = {
      val __obj = js.Dynamic.literal(index = index.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any], kind = "A")
      __obj.asInstanceOf[typingsJapgolly.deepDiff.mod.DiffArray[LHS, RHS]]
    }
    
    inline def DiffDeleted[LHS](lhs: LHS): typingsJapgolly.deepDiff.mod.DiffDeleted[LHS] = {
      val __obj = js.Dynamic.literal(kind = "D", lhs = lhs.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.deepDiff.mod.DiffDeleted[LHS]]
    }
    
    inline def DiffEdit[LHS, RHS](lhs: LHS, rhs: RHS): typingsJapgolly.deepDiff.mod.DiffEdit[LHS, RHS] = {
      val __obj = js.Dynamic.literal(kind = "E", lhs = lhs.asInstanceOf[js.Any], rhs = rhs.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.deepDiff.mod.DiffEdit[LHS, RHS]]
    }
    
    inline def DiffNew[RHS](rhs: RHS): typingsJapgolly.deepDiff.mod.DiffNew[RHS] = {
      val __obj = js.Dynamic.literal(kind = "N", rhs = rhs.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.deepDiff.mod.DiffNew[RHS]]
    }
  }
