package typingsJapgolly.d3Zoom
...
import typingsJapgolly.d3Zoom.d3ZoomStrings.end
import typingsJapgolly.d3Zoom.d3ZoomStrings.start
import typingsJapgolly.d3Zoom.d3ZoomStrings.zoom
...
object mod {
  ...
  inline def zoom[ZoomRefElement /* <: Element */, Datum](): ZoomBehavior[ZoomRefElement, Datum] = ^.asInstanceOf[js.Dynamic].applyDynamic("zoom")().asInstanceOf[ZoomBehavior[ZoomRefElement, Datum]]
  
  @JSImport("d3-zoom", "zoomIdentity")
  @js.native
  val zoomIdentity: ZoomTransform_ = js.native
  
  inline def zoomTransform(node: Element): ZoomTransform_ = ^.asInstanceOf[js.Dynamic].applyDynamic("zoomTransform")(node.asInstanceOf[js.Any]).asInstanceOf[ZoomTransform_]
  ...
  object D3ZoomEvent {
    ...
    inline def apply[ZoomRefElement /* <: Element */, Datum](
      sourceEvent: Any,
    ...
    extension [Self <: D3ZoomEvent[?, ?], ZoomRefElement /* <: Element */, Datum](x: Self & (D3ZoomEvent[ZoomRefElement, Datum])) {
