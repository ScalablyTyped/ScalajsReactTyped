...
object mod {
  ...
  trait Options
    extends StObject
       with typingsJapgolly.globby.mod.Options {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnProgress(value: /* progress */ ProgressData => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction1((t0: /* progress */ ProgressData) => value(t0).runNow()))
