...
object libSequenceComparisonCommonMod {
  ...
  object SesType extends StObject {
    ...
    sealed trait Add
      extends StObject
         with SesType
    /* 1 */ val Add: typingsJapgolly.devexpressUtils.libSequenceComparisonCommonMod.SesType.Add & Double = js.native
    
    @js.native
    sealed trait Common
      extends StObject
         with SesType
    /* 0 */ val Common: typingsJapgolly.devexpressUtils.libSequenceComparisonCommonMod.SesType.Common & Double = js.native
    
    @js.native
    sealed trait Delete
      extends StObject
         with SesType
    /* -1 */ val Delete: typingsJapgolly.devexpressUtils.libSequenceComparisonCommonMod.SesType.Delete & Double = js.native
  }
  ...
  object ISequenceComparatorItertor {
    ...
    inline def apply[T](
      getByIndex: Double => T,
      getComparer: CallbackTo[js.Function2[/* a */ T, /* b */ T, Boolean]],
      length: Double
    ): ISequenceComparatorItertor[T] = {
      val __obj = js.Dynamic.literal(getByIndex = js.Any.fromFunction1(getByIndex), getComparer = getComparer.toJsFn, length = length.asInstanceOf[js.Any])
    ...
    extension [Self <: ISequenceComparatorItertor[?], T](x: Self & ISequenceComparatorItertor[T]) {
      ...
      inline def setGetComparer(value: CallbackTo[js.Function2[/* a */ T, /* b */ T, Boolean]]): Self = StObject.set(x, "getComparer", value.toJsFn)
