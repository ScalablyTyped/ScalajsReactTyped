...
import typingsJapgolly.dynmap.dynmapStrings.`login-required`
import typingsJapgolly.dynmap.dynmapStrings.xCommayCommaz
...
object Configuration {
  ...
  inline def apply(url: typingsJapgolly.dynmap.anon.Configuration): Configuration = {
