...
import typingsJapgolly.dynmap.mod.global.JQuery
...
trait DynMap extends StObject {
  ...
  var DynmapLayerControl: js.UndefOr[typingsJapgolly.dynmap.mod.DynmapLayerControl] = js.native
  ...
  var components: Array[js.UndefOr[ComponentchatpopupsRecord | typingsJapgolly.dynmap.anon.Component]] = js.native
