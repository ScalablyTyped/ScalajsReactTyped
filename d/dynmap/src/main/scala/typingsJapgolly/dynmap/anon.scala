...
import typingsJapgolly.dynmap.dynmapInts.`-1`
import typingsJapgolly.dynmap.dynmapInts.`1`
  ...
  trait Component
    extends StObject
       ...
       with Instantiable2[
          ...
          typingsJapgolly.dynmap.mod.Component[js.Object]
        ]
  ...
  trait ComponentchatpopupsRecord
    extends StObject
       ...
       with Instantiable2[
          /* dynmap */ DynMap, 
          /* configuration */ Record[String | Double | js.Symbol, Any | Null | Array[Any]], 
          typingsJapgolly.dynmap.mod.Component[Chatpopups]
        ] {
  ...
  trait Instantiable[Data /* <: Record[String | Double | js.Symbol, Any | Null | Array[Any]] */]
    extends StObject
       ...
       with Instantiable2[
          /* dynmap */ DynMap, 
          /* configuration */ Record[String | Double | js.Symbol, Any | Null | Array[Any]], 
          typingsJapgolly.dynmap.mod.Component[Data]
        ]
