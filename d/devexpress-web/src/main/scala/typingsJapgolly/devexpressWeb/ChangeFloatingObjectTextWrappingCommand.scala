...
object ChangeFloatingObjectTextWrappingCommand {
  ...
  inline def apply(
    ...
    getState: CallbackTo[CommandState[FloatingObjectTextWrappingSettings]]
  ...
  extension [Self <: ChangeFloatingObjectTextWrappingCommand](x: Self) {
    ...
    inline def setGetState(value: CallbackTo[CommandState[FloatingObjectTextWrappingSettings]]): Self = StObject.set(x, "getState", value.toJsFn)
  }
}
