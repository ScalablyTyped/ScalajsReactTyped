...
object ASPxClientGanttContextMenuItem {
  ...
  inline def apply(
    ...
    GetSubItems: CallbackTo[ASPxClientGanttContextMenuItemCollection],
    beginGroup: Boolean,
    enabled: Boolean,
  ...
  extension [Self <: ASPxClientGanttContextMenuItem](x: Self) {
    ...
    inline def setGetSubItems(value: CallbackTo[ASPxClientGanttContextMenuItemCollection]): Self = StObject.set(x, "GetSubItems", value.toJsFn)
