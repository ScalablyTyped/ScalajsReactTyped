...
object ASPxClientDropDownEditBase {
  ...
  extension [Self <: ASPxClientDropDownEditBase](x: Self) {
    ...
    inline def setHideDropDown(value: Callback): Self = StObject.set(x, "HideDropDown", value.toJsFn)
    ...
    inline def setShowDropDown(value: Callback): Self = StObject.set(x, "ShowDropDown", value.toJsFn)
  }
}
