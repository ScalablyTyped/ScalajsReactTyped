...
/**
  ...
  */
trait ASPxClientGridViewBatchEditChangesSavingEventArgs
  extends StObject
...
object ASPxClientGridViewBatchEditChangesSavingEventArgs {
  ...
  inline def apply(cancel: Boolean, deletedValues: Any, insertedValues: Any, updatedValues: Any): ASPxClientGridViewBatchEditChangesSavingEventArgs = {
