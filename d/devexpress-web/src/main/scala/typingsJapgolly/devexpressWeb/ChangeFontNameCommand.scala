...
object ChangeFontNameCommand {
  ...
  inline def apply(
    ...
    fontNames: js.Array[String],
    getState: CallbackTo[CommandState[String]]
  ): ChangeFontNameCommand = {
    val __obj = js.Dynamic.literal(execute = js.Any.fromFunction1(execute), fontNames = fontNames.asInstanceOf[js.Any], getState = getState.toJsFn)
