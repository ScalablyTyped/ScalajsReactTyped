...
/**
  ...
  */
@js.native
trait MVCxClientVerticalGrid
  extends StObject
     with ASPxClientVerticalGrid {
  ...
  /**
    ...
    */
  def GetValuesOnCustomCallback(data: Any, onCallback: ASPxClientGridViewValuesCallback): Unit = js.native
