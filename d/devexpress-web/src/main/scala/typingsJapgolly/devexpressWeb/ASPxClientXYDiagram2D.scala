...
object ASPxClientXYDiagram2D {
  ...
  extension [Self <: ASPxClientXYDiagram2D](x: Self) {
    ...
    inline def setShowCrosshair(value: (Double, Double) => Callback): Self = StObject.set(x, "ShowCrosshair", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
  }
}
