...
object ASPxClientRichEditPopupMenuItem {
  ...
  inline def apply(
    ...
    GetSubItems: CallbackTo[ASPxClientRichEditPopupMenuItemCollection],
    beginGroup: Boolean,
    enabled: Boolean,
  ...
  extension [Self <: ASPxClientRichEditPopupMenuItem](x: Self) {
    ...
    inline def setGetSubItems(value: CallbackTo[ASPxClientRichEditPopupMenuItemCollection]): Self = StObject.set(x, "GetSubItems", value.toJsFn)
