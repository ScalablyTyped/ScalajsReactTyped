...
/**
  ...
  */
@JSGlobal("ASPxClientButtonEdit")
@js.native
class ASPxClientButtonEdit () extends ASPxClientButtonEditBase

/* static members */
@JSGlobal("ASPxClientButtonEdit")
@js.native
object ASPxClientButtonEdit extends js.Object {
  /**
    ...
    */
  def Cast(obj: js.Any): ASPxClientButtonEdit = js.native
}
