...
object ASPxClientSpreadsheetPopupMenuItem {
  ...
  inline def apply(
    ...
    GetSubItems: CallbackTo[ASPxClientSpreadsheetPopupMenuItemCollection],
    beginGroup: Boolean,
    enabled: Boolean,
  ...
  extension [Self <: ASPxClientSpreadsheetPopupMenuItem](x: Self) {
    ...
    inline def setGetSubItems(value: CallbackTo[ASPxClientSpreadsheetPopupMenuItemCollection]): Self = StObject.set(x, "GetSubItems", value.toJsFn)
