...
open class ASPxClientGanttContextMenuCustomizationEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientGanttContextMenuCustomizationEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  var menuItems: typingsJapgolly.devexpressWeb.ASPxClientGanttContextMenuItemCollection = js.native
}
