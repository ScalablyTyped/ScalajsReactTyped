...
@js.native
open class ASPxClientMonthlyRecurrenceControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientMonthlyRecurrenceControl {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def CreateValueAccessor(): typingsJapgolly.devexpressWeb.DefaultRecurrenceRuleValuesAccessor = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Update(recurrenceInfo: typingsJapgolly.devexpressWeb.ASPxClientRecurrenceInfo): Unit = js.native
