...
import typingsJapgolly.devexpressWeb.ASPxClientFilterAppliedEventHandler
...
open class ASPxClientFilterControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientFilterControl {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Applied: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientFilterAppliedEventHandler[typingsJapgolly.devexpressWeb.ASPxClientFilterControl]
  ] = js.native
  ...
  var BeginCallback: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientBeginCallbackEventHandler[typingsJapgolly.devexpressWeb.ASPxClientFilterControl]
  ] = js.native
  ...
  var CallbackError: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientCallbackErrorEventHandler[typingsJapgolly.devexpressWeb.ASPxClientFilterControl]
  ] = js.native
  ...
  var EndCallback: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientEndCallbackEventHandler[typingsJapgolly.devexpressWeb.ASPxClientFilterControl]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetEditor(index: Double, valueIndex: Double): typingsJapgolly.devexpressWeb.ASPxClientEditBase = js.native
...
object ASPxClientFilterControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientFilterControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientFilterControl]
}
