...
@js.native
open class TableCellFormattingSettings ()
  extends StObject
     with typingsJapgolly.devexpressWeb.TableCellFormattingSettings {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var preferredWidth: typingsJapgolly.devexpressWeb.TableWidthUnit = js.native
  
  /**
    * Gets or sets the vertical alignment of a table cell's content.
    */
  /* CompleteClass */
  var verticalAlignment: typingsJapgolly.devexpressWeb.TableCellVerticalAlignment = js.native
}
