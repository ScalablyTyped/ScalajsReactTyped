...
open class ASPxClientWebChartControlHotTrackEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientWebChartControlHotTrackEventArgs {
  /**
    * Initializes a new instance of the ASPxClientWebChartControlHotTrackEventArgs class with specified settings.
    */
  def this(
    processOnServer: Boolean,
    hitObject: typingsJapgolly.devexpressWeb.ASPxClientWebChartElement,
    additionalHitObject: typingsJapgolly.devexpressWeb.ASPxClientWebChartElement,
    hitInfo: typingsJapgolly.devexpressWeb.ASPxClientWebChartHitInfo,
    htmlElement: Any,
    x: Double,
    y: Double
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var additionalHitObject: typingsJapgolly.devexpressWeb.ASPxClientWebChartElement = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var hitInfo: typingsJapgolly.devexpressWeb.ASPxClientWebChartHitInfo = js.native
  
  /**
    * Provides access on the client side to the chart element, for which the event was raised.
    */
  /* CompleteClass */
  var hitObject: typingsJapgolly.devexpressWeb.ASPxClientWebChartElement = js.native
