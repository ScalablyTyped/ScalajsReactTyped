...
open class ASPxClientTreeListBatchEditStartEditingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTreeListBatchEditStartEditingEventArgs {
  /**
  ...
  def this(
    nodeKey: String,
    focusedColumn: typingsJapgolly.devexpressWeb.ASPxClientTreeListColumn,
    nodeValues: Any
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var focusedColumn: typingsJapgolly.devexpressWeb.ASPxClientTreeListColumn = js.native
