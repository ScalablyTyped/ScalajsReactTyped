...
/**
  ...
  */
@JSGlobal("OpenTableFormattingDialogCommand")
@js.native
open class OpenTableFormattingDialogCommand ()
  extends StObject
     with typingsJapgolly.devexpressWeb.OpenTableFormattingDialogCommand {
