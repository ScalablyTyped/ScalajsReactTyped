...
@js.native
open class ParagraphFormattingSettings ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ParagraphFormattingSettings {
  
  /**
    * Specifies the paragraph alignment.
    */
  /* CompleteClass */
  var alignment: typingsJapgolly.devexpressWeb.ParagraphAlignment = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var firstLineIndentType: typingsJapgolly.devexpressWeb.ParagraphFirstLineIndent = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var lineSpacingType: typingsJapgolly.devexpressWeb.ParagraphLineSpacingType = js.native
