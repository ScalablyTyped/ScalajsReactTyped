...
open class ASPxClientNavBarGroupCancelEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientNavBarGroupCancelEventArgs {
  /**
    ...
    */
  def this(processOnServer: Boolean, group: typingsJapgolly.devexpressWeb.ASPxClientNavBarGroup) = this()
