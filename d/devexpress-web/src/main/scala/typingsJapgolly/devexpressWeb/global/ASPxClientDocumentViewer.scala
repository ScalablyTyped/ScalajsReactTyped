...
@js.native
open class ASPxClientDocumentViewer ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDocumentViewer {
...
object ASPxClientDocumentViewer {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientDocumentViewer = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientDocumentViewer]
}
