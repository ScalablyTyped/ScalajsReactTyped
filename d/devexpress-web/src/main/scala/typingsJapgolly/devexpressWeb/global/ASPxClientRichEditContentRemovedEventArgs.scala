...
open class ASPxClientRichEditContentRemovedEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRichEditContentRemovedEventArgs {
  /**
    ...
    */
  def this(subDocumentId: Double, interval: typingsJapgolly.devexpressWeb.Interval, removedText: String) = this()
