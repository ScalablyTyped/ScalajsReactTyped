...
@js.native
open class MVCxClientSchedulerStorage ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientSchedulerStorage {
...
object MVCxClientSchedulerStorage {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientSchedulerStorage = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientSchedulerStorage]
}
