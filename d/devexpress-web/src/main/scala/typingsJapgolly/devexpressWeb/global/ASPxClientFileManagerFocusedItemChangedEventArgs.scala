...
open class ASPxClientFileManagerFocusedItemChangedEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientFileManagerFocusedItemChangedEventArgs {
  /**
    ...
    */
  def this(item: typingsJapgolly.devexpressWeb.ASPxClientFileManagerItem, name: String, fullName: String) = this()
