...
open class ASPxClientFileManagerSelectionChangedEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientFileManagerSelectionChangedEventArgs {
  /**
    ...
    */
  def this(
    item: typingsJapgolly.devexpressWeb.ASPxClientFileManagerItem,
    name: String,
    fullName: String,
    isSelected: Boolean
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var item: typingsJapgolly.devexpressWeb.ASPxClientFileManagerItem = js.native
