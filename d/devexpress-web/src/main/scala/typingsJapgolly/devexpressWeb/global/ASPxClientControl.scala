...
open class ASPxClientControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientControl {
...
object ASPxClientControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientControl]
  
  /**
    * Returns a collection of client web control objects.
    */
  /* static member */
  inline def GetControlCollection(): typingsJapgolly.devexpressWeb.ASPxClientControlCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("GetControlCollection")().asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientControlCollection]
}
