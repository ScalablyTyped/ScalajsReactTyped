...
@js.native
open class BootstrapClientMenuItem ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientMenuItem {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var menu: typingsJapgolly.devexpressWeb.ASPxClientMenuBase = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var parent: typingsJapgolly.devexpressWeb.ASPxClientMenuItem = js.native
  /**
    * Gets the immediate parent item to which the current item belongs.
    */
  /* CompleteClass */
  @JSName("parent")
  var parent_BootstrapClientMenuItem: typingsJapgolly.devexpressWeb.BootstrapClientMenuItem = js.native
}
