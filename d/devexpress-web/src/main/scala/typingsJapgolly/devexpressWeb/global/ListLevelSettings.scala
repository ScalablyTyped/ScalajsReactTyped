...
open class ListLevelSettings ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ListLevelSettings {
  
  /**
    * Gets or sets the paragraph text alignment within numbered list levels.
    */
  /* CompleteClass */
  var alignment: typingsJapgolly.devexpressWeb.ListLevelNumberAlignment = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var format: typingsJapgolly.devexpressWeb.ListLevelFormat = js.native
