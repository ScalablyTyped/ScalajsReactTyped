...
open class BootstrapClientTreeView ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientTreeView {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetSelectedNode(node: typingsJapgolly.devexpressWeb.BootstrapClientTreeViewNode): Unit = js.native
