...
@js.native
open class MVCxClientPageControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientPageControl {
...
object MVCxClientPageControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientPageControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientPageControl]
}
