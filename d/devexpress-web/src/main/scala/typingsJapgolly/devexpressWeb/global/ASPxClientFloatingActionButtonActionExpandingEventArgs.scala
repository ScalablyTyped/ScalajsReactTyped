...
@js.native
open class ASPxClientFloatingActionButtonActionExpandingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientFloatingActionButtonActionExpandingEventArgs {
  /**
