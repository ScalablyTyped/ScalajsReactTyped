...
@js.native
open class ASPxClientCaptcha ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCaptcha {
...
object ASPxClientCaptcha {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientCaptcha = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientCaptcha]
}
