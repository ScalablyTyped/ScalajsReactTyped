...
open class ASPxClientPageControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientPageControl {
...
object ASPxClientPageControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientPageControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientPageControl]
}
