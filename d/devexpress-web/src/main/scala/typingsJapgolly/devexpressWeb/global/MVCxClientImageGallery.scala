...
@js.native
open class MVCxClientImageGallery ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientImageGallery {
...
object MVCxClientImageGallery {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientImageGallery = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientImageGallery]
}
