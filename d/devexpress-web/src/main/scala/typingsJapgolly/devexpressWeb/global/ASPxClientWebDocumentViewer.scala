...
open class ASPxClientWebDocumentViewer ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientWebDocumentViewer {
...
object ASPxClientWebDocumentViewer {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientWebDocumentViewer = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientWebDocumentViewer]
}
