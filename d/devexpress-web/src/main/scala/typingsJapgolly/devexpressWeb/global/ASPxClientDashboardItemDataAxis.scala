...
open class ASPxClientDashboardItemDataAxis ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxis {
  
  /**
    * Gets the dimensions used to create a hierarchy of axis points belonging to the current axis.
    */
  /* CompleteClass */
  override def GetDimensions(): js.Array[typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataDimension] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetPointByUniqueValues(uniqueValues: js.Array[Any]): typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxisPoint = js.native
  
  /**
    * Returns axis points corresponding to values of the last-level dimension.
    */
  /* CompleteClass */
  override def GetPoints(): js.Array[typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxisPoint] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetPointsByDimension(dimensionId: String): js.Array[typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxisPoint] = js.native
  
  /**
    * Gets the root axis point belonging to the current ASPxClientDashboardItemDataAxis.
    */
  /* CompleteClass */
  override def GetRootPoint(): typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxisPoint = js.native
}
