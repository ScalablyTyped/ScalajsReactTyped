...
open class ASPxClientReportDesigner ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientReportDesigner {
...
object ASPxClientReportDesigner {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientReportDesigner = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientReportDesigner]
}
