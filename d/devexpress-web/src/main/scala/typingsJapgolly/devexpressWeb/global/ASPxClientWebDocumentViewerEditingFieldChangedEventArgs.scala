...
open class ASPxClientWebDocumentViewerEditingFieldChangedEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientWebDocumentViewerEditingFieldChangedEventArgs {
  /**
    ...
    */
  def this(
    field: typingsJapgolly.devexpressWeb.ASPxClientWebDocumentViewerEditingField,
    oldValue: Any,
    newValue: Any
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Field: typingsJapgolly.devexpressWeb.ASPxClientWebDocumentViewerEditingField = js.native
