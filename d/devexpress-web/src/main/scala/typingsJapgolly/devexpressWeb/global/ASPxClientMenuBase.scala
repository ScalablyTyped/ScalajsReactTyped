...
open class ASPxClientMenuBase ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientMenuBase {
...
object ASPxClientMenuBase {
  ...
  /**
    ...
    */
  /* static member */
  inline def GetMenuCollection(): typingsJapgolly.devexpressWeb.ASPxClientMenuCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("GetMenuCollection")().asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientMenuCollection]
}
