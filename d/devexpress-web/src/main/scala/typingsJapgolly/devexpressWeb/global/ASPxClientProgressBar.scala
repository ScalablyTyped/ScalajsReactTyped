...
open class ASPxClientProgressBar ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientProgressBar {
...
object ASPxClientProgressBar {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientProgressBar = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientProgressBar]
}
