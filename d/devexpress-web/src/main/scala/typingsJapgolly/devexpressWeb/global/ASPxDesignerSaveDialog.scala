...
open class ASPxDesignerSaveDialog ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxDesignerSaveDialog {
  ...
  /* CompleteClass */
  override def customize(template: String, model: typingsJapgolly.devexpressWeb.ASPxDesignerDialogModel): Unit = js.native
  ...
  /* CompleteClass */
  var saveReportDialog: typingsJapgolly.devexpressWeb.ASPxDesignerSaveAsDialog = js.native
  
  /* CompleteClass */
  override def show(tab: typingsJapgolly.devexpressWeb.ASPxDesignerNavigateTab): Unit = js.native
