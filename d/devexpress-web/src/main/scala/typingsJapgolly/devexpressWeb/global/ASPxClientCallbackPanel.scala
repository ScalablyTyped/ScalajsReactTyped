...
open class ASPxClientCallbackPanel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCallbackPanel {
...
object ASPxClientCallbackPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientCallbackPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientCallbackPanel]
}
