...
open class ASPxClientWebChartControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientWebChartControl {
...
object ASPxClientWebChartControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientWebChartControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientWebChartControl]
}
