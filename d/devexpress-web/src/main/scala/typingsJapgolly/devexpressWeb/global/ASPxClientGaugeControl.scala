...
open class ASPxClientGaugeControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientGaugeControl {
...
object ASPxClientGaugeControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientGaugeControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientGaugeControl]
}
