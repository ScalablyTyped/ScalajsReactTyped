...
open class MVCxClientSpreadsheet ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientSpreadsheet {
...
object MVCxClientSpreadsheet {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientSpreadsheet = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientSpreadsheet]
}
