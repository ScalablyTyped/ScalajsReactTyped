...
@js.native
open class ASPxClientVerticalGrid ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientVerticalGrid {
...
object ASPxClientVerticalGrid {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientVerticalGrid = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientVerticalGrid]
}
