...
@js.native
open class BootstrapClientTabControlTabCancelEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientTabControlTabCancelEventArgs {
  /**
    ...
    */
  def this(processOnServer: Boolean, tab: typingsJapgolly.devexpressWeb.BootstrapClientTab) = this()
