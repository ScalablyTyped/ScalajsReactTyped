...
open class ASPxClientCardViewBatchEditStartEditingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCardViewBatchEditStartEditingEventArgs {
  /**
  ...
  def this(
    visibleIndex: Double,
    focusedColumn: typingsJapgolly.devexpressWeb.ASPxClientCardViewColumn,
    cardValues: Any
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var focusedColumn: typingsJapgolly.devexpressWeb.ASPxClientCardViewColumn = js.native
