...
@js.native
open class ASPxClientHtmlEditorVideoDialog ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientHtmlEditorVideoDialog {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetPosterTextBox(): typingsJapgolly.devexpressWeb.ASPxClientTextBox = js.native
  
  /**
    * Provides access to the client object of the "Preload mode" combo box in the Html Editor's Video dialog.
    */
  /* CompleteClass */
  override def GetPreloadModeComboBox(): typingsJapgolly.devexpressWeb.ASPxClientComboBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetShowPlayerControlsCheckBox(): typingsJapgolly.devexpressWeb.ASPxClientCheckBox = js.native
