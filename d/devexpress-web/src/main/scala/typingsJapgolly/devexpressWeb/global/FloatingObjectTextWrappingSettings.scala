...
open class FloatingObjectTextWrappingSettings ()
  extends StObject
     with typingsJapgolly.devexpressWeb.FloatingObjectTextWrappingSettings {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var floatingObjectTextWrapSide: typingsJapgolly.devexpressWeb.FloatingObjectTextWrapSide = js.native
  
  /**
    * Gets or sets a value specifying how text is wrapped around a floating object.
    */
  /* CompleteClass */
  var floatingObjectTextWrapType: typingsJapgolly.devexpressWeb.FloatingObjectTextWrapType = js.native
