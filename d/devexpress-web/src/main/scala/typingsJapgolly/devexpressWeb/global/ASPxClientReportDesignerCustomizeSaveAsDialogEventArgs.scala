...
open class ASPxClientReportDesignerCustomizeSaveAsDialogEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientReportDesignerCustomizeSaveAsDialogEventArgs {
  /**
    ...
    */
  def this(popup: typingsJapgolly.devexpressWeb.ASPxDesignerSaveAsDialog) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Popup: typingsJapgolly.devexpressWeb.ASPxDesignerSaveAsDialog = js.native
}
