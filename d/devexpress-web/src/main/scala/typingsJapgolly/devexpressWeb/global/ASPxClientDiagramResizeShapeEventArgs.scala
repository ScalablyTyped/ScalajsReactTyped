...
open class ASPxClientDiagramResizeShapeEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDiagramResizeShapeEventArgs {
  /**
    ...
    */
  def this(shape: typingsJapgolly.devexpressWeb.DiagramShape, newSize: Any, oldSize: Any) = this()
