...
open class ASPxClientGanttContextMenuItemCollection ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientGanttContextMenuItemCollection {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Add(item: typingsJapgolly.devexpressWeb.ASPxClientGanttContextMenuItem): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Get(index: Double): typingsJapgolly.devexpressWeb.ASPxClientGanttContextMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetByName(name: String): typingsJapgolly.devexpressWeb.ASPxClientGanttContextMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Insert(index: Double, item: typingsJapgolly.devexpressWeb.ASPxClientGanttContextMenuItem): Unit = js.native
