...
@js.native
open class ASPxClientDockPanel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDockPanel {
...
object ASPxClientDockPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientDockPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientDockPanel]
}
