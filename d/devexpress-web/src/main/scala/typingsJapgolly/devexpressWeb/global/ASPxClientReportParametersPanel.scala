...
open class ASPxClientReportParametersPanel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientReportParametersPanel {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def AssignParameters(parametersInfo: js.Array[typingsJapgolly.devexpressWeb.ASPxClientReportParameterInfo]): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetEditorByParameterName(parameterName: String): typingsJapgolly.devexpressWeb.ASPxClientControl = js.native
