...
open class ASPxClientPopupWindowResizeEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientPopupWindowResizeEventArgs {
  /**
    ...
    */
  def this(window: typingsJapgolly.devexpressWeb.ASPxClientPopupWindow, resizeState: Double) = this()
