...
open class ASPxClientUploadControlValidationErrorOccurredEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientUploadControlValidationErrorOccurredEventArgs {
  /**
  ...
  def this(
    errorText: String,
    invalidFiles: js.Array[typingsJapgolly.devexpressWeb.ASPxClientUploadControlInvalidFileInfo]
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var invalidFiles: js.Array[typingsJapgolly.devexpressWeb.ASPxClientUploadControlInvalidFileInfo] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var validationSettings: typingsJapgolly.devexpressWeb.ASPxClientUploadControlValidationSettings = js.native
}
