...
open class ASPxClientHintOptions ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientHintOptions {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var onHiding: typingsJapgolly.devexpressWeb.ASPxClientEvent[ASPxClientHintHidingEventHandler] = js.native
  
  /**
    * A handler for the ASPxClientHint.Showing event.
    */
  /* CompleteClass */
  var onShowing: typingsJapgolly.devexpressWeb.ASPxClientEvent[ASPxClientHintShowingEventHandler] = js.native
