...
open class MVCxClientRichEdit ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientRichEdit {
...
object MVCxClientRichEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientRichEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientRichEdit]
}
