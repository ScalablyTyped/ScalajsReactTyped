...
open class ASPxClientPanelBase ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientPanelBase {
...
object ASPxClientPanelBase {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientPanelBase = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientPanelBase]
}
