...
open class ASPxClientDashboardItemElementCustomColorEventArgs ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDashboardItemElementCustomColorEventArgs {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetTargetElement(): typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxisPointTuple = js.native
