...
@js.native
open class ASPxClientDockZoneProcessingModeEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDockZoneProcessingModeEventArgs {
  /**
    ...
    */
  def this(processOnServer: Boolean, panel: typingsJapgolly.devexpressWeb.ASPxClientDockPanel) = this()
