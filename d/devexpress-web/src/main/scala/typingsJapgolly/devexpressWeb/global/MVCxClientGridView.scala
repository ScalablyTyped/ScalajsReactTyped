...
@js.native
open class MVCxClientGridView ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientGridView {
...
object MVCxClientGridView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientGridView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientGridView]
}
