...
@js.native
open class MVCxClientCallbackPanel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientCallbackPanel {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Collapsed: typingsJapgolly.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsJapgolly.devexpressWeb.ASPxClientPanel]] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Expanded: typingsJapgolly.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsJapgolly.devexpressWeb.ASPxClientPanel]] = js.native
...
object MVCxClientCallbackPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientCallbackPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientCallbackPanel]
}
