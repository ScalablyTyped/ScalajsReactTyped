...
open class ASPxClientMemo ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTextEdit {
...
object ASPxClientMemo {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientMemo = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientMemo]
}
