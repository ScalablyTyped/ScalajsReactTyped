...
@js.native
open class ASPxClientImageSlider ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientImageSlider {
...
object ASPxClientImageSlider {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientImageSlider = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientImageSlider]
}
