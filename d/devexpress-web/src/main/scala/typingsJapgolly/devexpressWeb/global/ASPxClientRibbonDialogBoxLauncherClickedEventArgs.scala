...
open class ASPxClientRibbonDialogBoxLauncherClickedEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRibbonDialogBoxLauncherClickedEventArgs {
  /**
    ...
    */
  def this(group: typingsJapgolly.devexpressWeb.ASPxClientRibbonGroup, processOnServer: Boolean) = this()
  
  /**
    * Gets the client group object to which the clicked dialog box launcher belongs.
    */
  /* CompleteClass */
  var group: typingsJapgolly.devexpressWeb.ASPxClientRibbonGroup = js.native
