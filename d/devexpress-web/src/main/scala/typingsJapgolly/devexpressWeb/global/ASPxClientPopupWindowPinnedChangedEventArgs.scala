...
@js.native
open class ASPxClientPopupWindowPinnedChangedEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientPopupWindowPinnedChangedEventArgs {
  /**
    ...
    */
  def this(window: typingsJapgolly.devexpressWeb.ASPxClientPopupWindow, pinned: Boolean) = this()
