...
@js.native
open class ASPxClientBinaryImage ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientBinaryImage {
...
object ASPxClientBinaryImage {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientBinaryImage = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientBinaryImage]
}
