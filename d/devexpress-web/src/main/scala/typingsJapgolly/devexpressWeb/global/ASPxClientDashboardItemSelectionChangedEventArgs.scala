...
open class ASPxClientDashboardItemSelectionChangedEventArgs ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDashboardItemSelectionChangedEventArgs {
  
  /**
    * Gets currently selected elements.
    */
  /* CompleteClass */
  override def GetCurrentSelection(): js.Array[typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxisPointTuple] = js.native
