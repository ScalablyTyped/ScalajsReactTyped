...
open class MVCxClientFilterControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientFilterControl {
...
object MVCxClientFilterControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientFilterControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientFilterControl]
}
