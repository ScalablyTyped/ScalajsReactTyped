...
open class ASPxClientCalendar ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCalendar {
...
object ASPxClientCalendar {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientCalendar = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientCalendar]
}
