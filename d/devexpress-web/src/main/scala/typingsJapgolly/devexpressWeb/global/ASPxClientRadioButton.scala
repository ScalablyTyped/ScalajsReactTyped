...
open class ASPxClientRadioButton ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRadioButton {
  ...
  var CheckedChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCheckBox]
  ] = js.native
...
object ASPxClientRadioButton {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientRadioButton = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientRadioButton]
}
