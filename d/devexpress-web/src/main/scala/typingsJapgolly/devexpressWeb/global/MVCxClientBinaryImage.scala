...
@js.native
open class MVCxClientBinaryImage ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientBinaryImage {
...
object MVCxClientBinaryImage {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientBinaryImage = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientBinaryImage]
}
