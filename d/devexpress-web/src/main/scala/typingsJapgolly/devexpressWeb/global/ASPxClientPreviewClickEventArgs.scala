...
open class ASPxClientPreviewClickEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientPreviewClickEventArgs {
  /**
    ...
    */
  def this(pageIndex: Double, brick: typingsJapgolly.devexpressWeb.ASPxClientWebDocumentViewerBrick) = this()
}
