...
@js.native
open class ASPxClientDockManager ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDockManager {
...
object ASPxClientDockManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientDockManager = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientDockManager]
}
