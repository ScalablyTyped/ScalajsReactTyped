...
/**
  ...
  */
@JSGlobal("ASPxClientRadioButtonList")
@js.native
open class ASPxClientRadioButtonList ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCheckListBase {
...
object ASPxClientRadioButtonList {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientRadioButtonList = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientRadioButtonList]
}
