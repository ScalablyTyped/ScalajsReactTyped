...
open class ASPxClientColorEdit ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientColorEdit {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ColorChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientColorEdit]
  ] = js.native
  ...
  /* CompleteClass */
  @JSName("TextChanged")
  var TextChanged_ASPxClientColorEdit: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientColorEdit]
  ] = js.native
...
object ASPxClientColorEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientColorEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientColorEdit]
}
