...
open class ASPxClientSpreadsheetPopupMenuShowingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetPopupMenuShowingEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  var menuItems: typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetPopupMenuItemCollection = js.native
  
  /**
    * Gets the currently displayed context menu's type.
    */
  /* CompleteClass */
  var menuType: typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetPopupMenuType = js.native
}
