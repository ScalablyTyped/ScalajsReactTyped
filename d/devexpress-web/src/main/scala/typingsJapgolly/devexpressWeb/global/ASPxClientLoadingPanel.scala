...
open class ASPxClientLoadingPanel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientLoadingPanel {
...
object ASPxClientLoadingPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientLoadingPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientLoadingPanel]
}
