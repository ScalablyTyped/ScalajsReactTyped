...
open class MVCxClientPopupControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientPopupControl {
...
object MVCxClientPopupControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientPopupControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientPopupControl]
}
