...
@js.native
open class ASPxClientTimeEdit ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTimeEdit {
  ...
  var DateChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientTimeEdit]
  ] = js.native
...
object ASPxClientTimeEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientTimeEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientTimeEdit]
}
