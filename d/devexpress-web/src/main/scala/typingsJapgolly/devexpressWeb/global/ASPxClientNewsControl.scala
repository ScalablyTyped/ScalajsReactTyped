...
@js.native
open class ASPxClientNewsControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientNewsControl {
...
object ASPxClientNewsControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientNewsControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientNewsControl]
}
