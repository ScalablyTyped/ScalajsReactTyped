...
open class BootstrapClientAccordion ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientAccordion {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetActiveGroup(group: typingsJapgolly.devexpressWeb.BootstrapClientAccordionGroup): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetSelectedItem(item: typingsJapgolly.devexpressWeb.BootstrapClientAccordionItem): Unit = js.native
