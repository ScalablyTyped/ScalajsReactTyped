...
open class MisspelledInterval ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MisspelledInterval {
  
  /**
    * Gets the spelling error type.
    */
  /* CompleteClass */
  override val errorType: typingsJapgolly.devexpressWeb.SpellingErrorType = js.native
  
  /**
    * Gets the text buffer interval occupied by the current element.
    */
  /* CompleteClass */
  override val interval: typingsJapgolly.devexpressWeb.Interval = js.native
