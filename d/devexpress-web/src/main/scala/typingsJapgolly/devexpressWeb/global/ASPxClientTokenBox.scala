...
@js.native
open class ASPxClientTokenBox ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTokenBox {
...
object ASPxClientTokenBox {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientTokenBox = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientTokenBox]
}
