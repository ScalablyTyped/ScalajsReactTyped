...
open class ASPxClientReportDesignerCustomizeSaveDialogEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientReportDesignerCustomizeSaveDialogEventArgs {
  /**
    ...
    */
  def this(popup: typingsJapgolly.devexpressWeb.ASPxDesignerSaveDialog) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Popup: typingsJapgolly.devexpressWeb.ASPxDesignerSaveDialog = js.native
}
