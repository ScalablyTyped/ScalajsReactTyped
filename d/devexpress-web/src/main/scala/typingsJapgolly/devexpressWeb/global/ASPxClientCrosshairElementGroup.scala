...
open class ASPxClientCrosshairElementGroup ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCrosshairElementGroup {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var CrosshairIndicatorElements: js.Array[typingsJapgolly.devexpressWeb.ASPxClientCrosshairIndicatorElement] = js.native
  
  /**
    * Returns the Crosshair Cursor group's Header element.
    */
  /* CompleteClass */
  var HeaderElement: typingsJapgolly.devexpressWeb.ASPxClientCrosshairGroupHeaderElement = js.native
}
