...
open class BootstrapClientRibbon ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientRibbon {
  ...
  /* CompleteClass */
  override def GetQuickAccessToolbarItem(name: String): typingsJapgolly.devexpressWeb.ASPxClientRibbonItem = js.native
