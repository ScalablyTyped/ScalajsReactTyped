...
@js.native
open class ASPxClientPopupMenu ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientPopupMenu {
...
object ASPxClientPopupMenu {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientPopupMenu = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientPopupMenu]
}
