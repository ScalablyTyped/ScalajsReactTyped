...
open class ASPxClientControlBase ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientControlBase {
...
object ASPxClientControlBase {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientControlBase = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientControlBase]
}
