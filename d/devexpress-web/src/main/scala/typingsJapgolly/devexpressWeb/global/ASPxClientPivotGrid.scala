...
@js.native
open class ASPxClientPivotGrid ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientPivotGrid {
...
object ASPxClientPivotGrid {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientPivotGrid = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientPivotGrid]
}
