...
@js.native
open class ASPxClientPanel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientPanel {
...
object ASPxClientPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientPanel]
}
