...
@js.native
open class MVCxClientScheduler ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientScheduler {
...
object MVCxClientScheduler {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientScheduler = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientScheduler]
}
