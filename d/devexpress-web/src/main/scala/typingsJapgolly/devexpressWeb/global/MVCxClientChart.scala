...
@js.native
open class MVCxClientChart ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientChart {
...
object MVCxClientChart {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientChart = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientChart]
}
