...
open class BootstrapClientAccordionItemEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientAccordionItemEventArgs {
  /**
  ...
  def this(
    ...
    item: typingsJapgolly.devexpressWeb.BootstrapClientAccordionItem,
    htmlElement: Any,
    htmlEvent: Any
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var item: typingsJapgolly.devexpressWeb.BootstrapClientAccordionItem = js.native
