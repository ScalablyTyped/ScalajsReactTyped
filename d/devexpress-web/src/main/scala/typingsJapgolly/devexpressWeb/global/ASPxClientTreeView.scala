...
open class ASPxClientTreeView ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTreeView {
...
object ASPxClientTreeView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientTreeView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientTreeView]
}
