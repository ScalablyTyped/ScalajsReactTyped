...
open class MailMergeSettings ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MailMergeSettings {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var mergeMode: typingsJapgolly.devexpressWeb.MergeMode = js.native
  
  /**
    * Specifies which data rows should be exported into a merged document.
    */
  /* CompleteClass */
  var range: typingsJapgolly.devexpressWeb.MailMergeExportRange = js.native
}
