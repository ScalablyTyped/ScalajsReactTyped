...
import typingsJapgolly.devexpressWeb.ASPxClientGridViewRowClickEventHandler
...
@js.native
open class ASPxClientGridLookup ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientGridLookup {
  ...
  var BeginCallback: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientBeginCallbackEventHandler[typingsJapgolly.devexpressWeb.ASPxClientGridLookup]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def ConfirmCurrentSelection(): Unit = js.native
  ...
  var EndCallback: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientEndCallbackEventHandler[typingsJapgolly.devexpressWeb.ASPxClientGridLookup]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetGridView(): typingsJapgolly.devexpressWeb.ASPxClientGridView = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def RollbackToLastConfirmedSelection(): Unit = js.native
  
  /**
    * Fires on the client when a data row is clicked within the built-in dropdown grid.
    */
  /* CompleteClass */
  var RowClick: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientGridViewRowClickEventHandler[typingsJapgolly.devexpressWeb.ASPxClientGridLookup]
  ] = js.native
...
object ASPxClientGridLookup {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientGridLookup = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientGridLookup]
}
