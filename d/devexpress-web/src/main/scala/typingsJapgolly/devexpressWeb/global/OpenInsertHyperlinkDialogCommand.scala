...
/**
  ...
  */
@JSGlobal("OpenInsertHyperlinkDialogCommand")
@js.native
open class OpenInsertHyperlinkDialogCommand ()
  extends StObject
     with typingsJapgolly.devexpressWeb.OpenInsertHyperlinkDialogCommand {
