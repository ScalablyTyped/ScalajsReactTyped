...
open class ASPxClientHyperLink ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientHyperLink {
...
object ASPxClientHyperLink {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientHyperLink = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientHyperLink]
}
