...
import typingsJapgolly.devexpressWeb.BootstrapClientRangeSelectorValueChangedEventHandler
...
@js.native
open class BootstrapClientRangeSelector ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientRangeSelector {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetValue(): js.Array[Any] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetValue(value: js.Array[Any]): Unit = js.native
  ...
  var ValueChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    BootstrapClientRangeSelectorValueChangedEventHandler[typingsJapgolly.devexpressWeb.BootstrapClientRangeSelector]
  ] = js.native
