...
open class ParagraphStyle ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ParagraphStyle {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val linkedStyle: typingsJapgolly.devexpressWeb.CharacterStyle = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val nextStyle: typingsJapgolly.devexpressWeb.ParagraphStyle = js.native
  
  /**
    * Gets or sets the style from which the current style inherits.
    */
  /* CompleteClass */
  override val parent: typingsJapgolly.devexpressWeb.ParagraphStyle = js.native
}
