...
/**
  ...
  */
@JSGlobal("MVCxClientDateEdit")
@js.native
open class MVCxClientDateEdit ()
  extends StObject
...
object MVCxClientDateEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientDateEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientDateEdit]
}
