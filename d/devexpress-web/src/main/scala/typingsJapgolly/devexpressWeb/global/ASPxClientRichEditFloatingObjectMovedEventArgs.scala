...
open class ASPxClientRichEditFloatingObjectMovedEventArgs ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRichEditFloatingObjectMovedEventArgs {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val pageIntervals: js.Array[typingsJapgolly.devexpressWeb.Interval] = js.native
