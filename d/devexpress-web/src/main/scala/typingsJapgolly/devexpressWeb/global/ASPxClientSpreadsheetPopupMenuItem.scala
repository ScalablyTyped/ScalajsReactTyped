...
open class ASPxClientSpreadsheetPopupMenuItem ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItem(index: Double): typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemByName(name: String): typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSubItems(): typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetPopupMenuItemCollection = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var parent: typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetPopupMenuItem = js.native
