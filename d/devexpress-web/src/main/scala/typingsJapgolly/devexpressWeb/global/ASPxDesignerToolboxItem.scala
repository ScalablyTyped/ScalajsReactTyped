...
open class ASPxDesignerToolboxItem ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxDesignerToolboxItem {
  
  /* CompleteClass */
  var defaultVal: Any = js.native
  
  /* CompleteClass */
  var info: js.Array[typingsJapgolly.devexpressWeb.ASPxDesignerElementSerializationInfo] = js.native
