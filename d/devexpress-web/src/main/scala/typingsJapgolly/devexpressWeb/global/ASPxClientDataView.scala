...
open class ASPxClientDataView ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDataView {
...
object ASPxClientDataView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientDataView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientDataView]
}
