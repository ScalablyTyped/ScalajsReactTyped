...
open class ASPxClientHtmlEditor ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientHtmlEditor {
...
object ASPxClientHtmlEditor {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientHtmlEditor = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientHtmlEditor]
