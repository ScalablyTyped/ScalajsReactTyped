...
@js.native
open class ASPxClientDockZone ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDockZone {
...
object ASPxClientDockZone {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientDockZone = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientDockZone]
}
