...
@js.native
open class MVCxClientListBox ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientListBox {
...
object MVCxClientListBox {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientListBox = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientListBox]
}
