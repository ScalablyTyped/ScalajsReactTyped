...
open class ASPxClientGridViewBatchEditStartEditingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientGridViewBatchEditStartEditingEventArgs {
  /**
  ...
  def this(
    visibleIndex: Double,
    focusedColumn: typingsJapgolly.devexpressWeb.ASPxClientGridViewColumn,
    rowValues: Any,
    key: Any
  ) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var focusedColumn: typingsJapgolly.devexpressWeb.ASPxClientGridViewColumn = js.native
