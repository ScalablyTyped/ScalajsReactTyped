...
open class ASPxClientTreeViewNodeCancelEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTreeViewNodeCancelEventArgs {
  /**
    ...
    */
  def this(processOnServer: Boolean, node: typingsJapgolly.devexpressWeb.ASPxClientTreeViewNode) = this()
