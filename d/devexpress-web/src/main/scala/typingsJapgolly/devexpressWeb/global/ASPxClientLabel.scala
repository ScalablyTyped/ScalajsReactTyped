...
open class ASPxClientLabel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientLabel {
...
object ASPxClientLabel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientLabel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientLabel]
}
