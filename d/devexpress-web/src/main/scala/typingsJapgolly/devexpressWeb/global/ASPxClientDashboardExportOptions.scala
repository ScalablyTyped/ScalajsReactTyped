...
open class ASPxClientDashboardExportOptions ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDashboardExportOptions {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var CardOptions: typingsJapgolly.devexpressWeb.CardExportOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ChartOptions: typingsJapgolly.devexpressWeb.ChartExportOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ExcelOptions: typingsJapgolly.devexpressWeb.ExcelFormatOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var GaugeOptions: typingsJapgolly.devexpressWeb.GaugeExportOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var GridOptions: typingsJapgolly.devexpressWeb.GridExportOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ImageOptions: typingsJapgolly.devexpressWeb.ImageFormatOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var MapOptions: typingsJapgolly.devexpressWeb.MapExportOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var PieOptions: typingsJapgolly.devexpressWeb.PieExportOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var PivotOptions: typingsJapgolly.devexpressWeb.PivotExportOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var RangeFilterOptions: typingsJapgolly.devexpressWeb.RangeFilterExportOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var TreemapOptions: typingsJapgolly.devexpressWeb.TreemapExportOptions = js.native
}
