...
@js.native
open class ASPxClientCardView ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCardView {
...
object ASPxClientCardView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientCardView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientCardView]
}
