...
open class ASPxClientImage ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientImage {
...
object ASPxClientImage {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientImage = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientImage]
}
