...
open class ASPxClientQueryBuilder ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientQueryBuilder {
...
object ASPxClientQueryBuilder {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientQueryBuilder = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientQueryBuilder]
}
