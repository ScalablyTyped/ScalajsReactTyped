...
@js.native
open class ASPxClientTreeListBatchEditChangesSavingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTreeListBatchEditChangesSavingEventArgs {
  /**
