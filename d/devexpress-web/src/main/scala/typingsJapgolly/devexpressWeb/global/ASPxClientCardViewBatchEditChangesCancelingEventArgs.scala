...
@js.native
open class ASPxClientCardViewBatchEditChangesCancelingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCardViewBatchEditChangesCancelingEventArgs {
  /**
