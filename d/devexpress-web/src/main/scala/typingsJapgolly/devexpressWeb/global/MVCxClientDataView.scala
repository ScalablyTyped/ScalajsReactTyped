...
open class MVCxClientDataView ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientDataView {
...
object MVCxClientDataView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientDataView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientDataView]
}
