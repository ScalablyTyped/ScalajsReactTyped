...
@js.native
open class ASPxClientImageGallery ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientImageGallery {
...
object ASPxClientImageGallery {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientImageGallery = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientImageGallery]
}
