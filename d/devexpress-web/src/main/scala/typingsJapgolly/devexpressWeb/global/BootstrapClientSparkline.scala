...
import typingsJapgolly.devexpressWeb.BootstrapClientSparklineTooltipHiddenEventHandler
import typingsJapgolly.devexpressWeb.BootstrapClientSparklineTooltipShownEventHandler
...
open class BootstrapClientSparkline ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientSparkline {
  ...
  var TooltipHidden: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    BootstrapClientSparklineTooltipHiddenEventHandler[typingsJapgolly.devexpressWeb.BootstrapClientSparkline]
  ] = js.native
  
  /* CompleteClass */
  var TooltipShown: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    BootstrapClientSparklineTooltipShownEventHandler[typingsJapgolly.devexpressWeb.BootstrapClientSparkline]
  ] = js.native
