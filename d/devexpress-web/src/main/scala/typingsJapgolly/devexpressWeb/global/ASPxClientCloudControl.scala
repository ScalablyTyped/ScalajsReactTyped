...
import typingsJapgolly.devexpressWeb.ASPxClientCloudControlItemEventHandler
...
open class ASPxClientCloudControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCloudControl {
  ...
  var ItemClick: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientCloudControlItemEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCloudControl]
  ] = js.native
...
object ASPxClientCloudControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientCloudControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientCloudControl]
}
