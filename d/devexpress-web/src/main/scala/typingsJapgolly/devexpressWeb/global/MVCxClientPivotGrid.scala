...
open class MVCxClientPivotGrid ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientPivotGrid {
...
object MVCxClientPivotGrid {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientPivotGrid = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientPivotGrid]
}
