...
@js.native
open class ASPxClientFileManager ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientFileManager {
...
object ASPxClientFileManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientFileManager = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientFileManager]
}
