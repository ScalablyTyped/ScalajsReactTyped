...
open class ASPxClientPivotGridControlCollection ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientControlCollection {
...
object ASPxClientPivotGridControlCollection {
  ...
  /* static member */
  inline def GetPivotGridControlCollection(): typingsJapgolly.devexpressWeb.ASPxClientPivotGridControlCollection = ^.asInstanceOf[js.Dynamic].applyDynamic("GetPivotGridControlCollection")().asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientPivotGridControlCollection]
}
