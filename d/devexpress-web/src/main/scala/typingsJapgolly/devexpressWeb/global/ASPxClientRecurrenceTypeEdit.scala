...
@js.native
open class ASPxClientRecurrenceTypeEdit ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRecurrenceTypeEdit {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetRecurrenceType(recurrenceType: typingsJapgolly.devexpressWeb.ASPxClientRecurrenceType): Unit = js.native
