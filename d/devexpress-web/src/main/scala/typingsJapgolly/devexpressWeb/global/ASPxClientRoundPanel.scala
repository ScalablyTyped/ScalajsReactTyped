...
@js.native
open class ASPxClientRoundPanel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRoundPanel {
...
object ASPxClientRoundPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientRoundPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientRoundPanel]
}
