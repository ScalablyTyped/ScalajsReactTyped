...
open class ASPxClientHtmlEditorPlaceholderDialog ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientHtmlEditorPlaceholderDialog {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetPlaceholderNameListBox(): typingsJapgolly.devexpressWeb.ASPxClientListBox = js.native
}
