...
open class MVCxClientNavBar ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientNavBar {
  ...
  var BeginCallback_MVCxClientNavBar: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    MVCxClientBeginCallbackEventHandler[typingsJapgolly.devexpressWeb.MVCxClientNavBar]
  ] = js.native
...
object MVCxClientNavBar {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientNavBar = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientNavBar]
}
