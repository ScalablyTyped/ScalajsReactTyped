...
@js.native
open class ASPxClientGridView ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientGridView {
...
object ASPxClientGridView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientGridView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientGridView]
}
