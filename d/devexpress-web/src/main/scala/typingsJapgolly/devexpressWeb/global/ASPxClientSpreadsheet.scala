...
@js.native
open class ASPxClientSpreadsheet ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientSpreadsheet {
...
object ASPxClientSpreadsheet {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientSpreadsheet = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientSpreadsheet]
}
