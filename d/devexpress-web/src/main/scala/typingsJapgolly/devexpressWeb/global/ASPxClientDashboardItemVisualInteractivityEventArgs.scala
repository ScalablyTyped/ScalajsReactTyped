...
open class ASPxClientDashboardItemVisualInteractivityEventArgs ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDashboardItemVisualInteractivityEventArgs {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetDefaultSelection(): js.Array[typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxisPointTuple] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetDefaultSelection(values: js.Array[typingsJapgolly.devexpressWeb.ASPxClientDashboardItemDataAxisPointTuple]): Unit = js.native
