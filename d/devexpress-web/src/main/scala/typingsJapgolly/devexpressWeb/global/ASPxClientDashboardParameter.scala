...
open class ASPxClientDashboardParameter ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDashboardParameter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetValues(): js.Array[typingsJapgolly.devexpressWeb.ASPxClientDashboardParameterValue] = js.native
