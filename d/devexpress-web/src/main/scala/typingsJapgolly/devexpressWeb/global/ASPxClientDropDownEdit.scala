...
import typingsJapgolly.devexpressWeb.ASPxClientDropDownCommandEventHandler
...
open class ASPxClientDropDownEdit ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDropDownEdit {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var DropDownCommandButtonClick: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientDropDownCommandEventHandler[typingsJapgolly.devexpressWeb.ASPxClientDropDownEdit]
  ] = js.native
...
object ASPxClientDropDownEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientDropDownEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientDropDownEdit]
}
