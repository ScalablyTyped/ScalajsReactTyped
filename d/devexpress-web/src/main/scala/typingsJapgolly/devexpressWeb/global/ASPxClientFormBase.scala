...
open class ASPxClientFormBase ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientFormBase {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var FormClosed: typingsJapgolly.devexpressWeb.ASPxClientEvent[ASPxClientEventHandler[typingsJapgolly.devexpressWeb.ASPxClientFormBase]] = js.native
