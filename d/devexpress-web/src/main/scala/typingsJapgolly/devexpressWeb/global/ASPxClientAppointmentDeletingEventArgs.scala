...
open class ASPxClientAppointmentDeletingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientAppointmentDeletingEventArgs {
  /**
    ...
    */
  def this(appointments: js.Array[typingsJapgolly.devexpressWeb.ASPxClientAppointment]) = this()
