...
open class MVCxClientRoundPanel ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientRoundPanel {
...
object MVCxClientRoundPanel {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientRoundPanel = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientRoundPanel]
}
