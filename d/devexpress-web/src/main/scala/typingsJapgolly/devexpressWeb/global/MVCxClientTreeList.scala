...
@js.native
open class MVCxClientTreeList ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientTreeList {
...
object MVCxClientTreeList {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientTreeList = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientTreeList]
}
