...
open class Field ()
  extends StObject
     with typingsJapgolly.devexpressWeb.Field {
  
  /**
    * Gets the text buffer interval occupied by the field code element.
    */
  /* CompleteClass */
  override val codeInterval: typingsJapgolly.devexpressWeb.Interval = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val resultInterval: typingsJapgolly.devexpressWeb.Interval = js.native
