...
@js.native
open class ASPxClientSeries ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientSeries {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var crosshairValueItems: js.Array[typingsJapgolly.devexpressWeb.ASPxClientCrosshairValueItem] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var fibonacciIndicators: js.Array[typingsJapgolly.devexpressWeb.ASPxClientFibonacciIndicator] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var indicators: js.Array[typingsJapgolly.devexpressWeb.ASPxClientIndicator] = js.native
  
  /**
    * Gets the settings of series labels.
    */
  /* CompleteClass */
  var label: typingsJapgolly.devexpressWeb.ASPxClientSeriesLabel = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var points: js.Array[typingsJapgolly.devexpressWeb.ASPxClientSeriesPoint] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var regressionLines: js.Array[typingsJapgolly.devexpressWeb.ASPxClientRegressionLine] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var titles: js.Array[typingsJapgolly.devexpressWeb.ASPxClientSeriesTitle] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var trendLines: js.Array[typingsJapgolly.devexpressWeb.ASPxClientTrendLine] = js.native
