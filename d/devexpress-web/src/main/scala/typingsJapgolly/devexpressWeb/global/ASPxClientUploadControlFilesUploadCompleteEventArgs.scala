...
@js.native
open class ASPxClientUploadControlFilesUploadCompleteEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientUploadControlFilesUploadCompleteEventArgs {
  /**
