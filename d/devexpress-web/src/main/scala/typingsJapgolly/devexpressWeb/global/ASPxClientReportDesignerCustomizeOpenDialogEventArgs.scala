...
open class ASPxClientReportDesignerCustomizeOpenDialogEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientReportDesignerCustomizeOpenDialogEventArgs {
  /**
    ...
    */
  def this(popup: typingsJapgolly.devexpressWeb.ASPxDesignerOpenDialog) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Popup: typingsJapgolly.devexpressWeb.ASPxDesignerOpenDialog = js.native
}
