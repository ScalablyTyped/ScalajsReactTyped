...
@js.native
open class ASPxClientTreeList ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTreeList {
...
object ASPxClientTreeList {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientTreeList = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientTreeList]
}
