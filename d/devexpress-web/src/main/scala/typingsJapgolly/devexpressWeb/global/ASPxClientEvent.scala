...
open class ASPxClientEvent[T] ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientEvent[T] {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def FireEvent(source: Any, e: typingsJapgolly.devexpressWeb.ASPxClientEventArgs): Unit = js.native
