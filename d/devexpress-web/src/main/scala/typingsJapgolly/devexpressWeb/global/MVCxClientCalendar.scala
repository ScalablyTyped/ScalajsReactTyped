...
open class MVCxClientCalendar ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientCalendar {
  ...
  var BeginCallback: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientBeginCallbackEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  /**
    * Occurs when a callback for server-side processing is initiated.
    */
  ...
  var BeginCallback_MVCxClientCalendar: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    MVCxClientBeginCallbackEventHandler[typingsJapgolly.devexpressWeb.MVCxClientCalendar]
  ] = js.native
  ...
  var CallbackError: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientCallbackErrorEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var CellClick: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientCalendarCellClickEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var CustomDisabledDate: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientCalendarCustomDisabledDateEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  ...
  var EndCallback: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientEndCallbackEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var KeyDown: typingsJapgolly.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]] = js.native
  
  /**
    * Occurs on the client-side when an end-user presses and releases a key while the editor has focus.
    */
  /* CompleteClass */
  var KeyPress: typingsJapgolly.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]] = js.native
  
  /**
    * Occurs on the client-side when an end-user releases a pressed key while the editor has focus.
    */
  /* CompleteClass */
  var KeyUp: typingsJapgolly.devexpressWeb.ASPxClientEvent[ASPxClientEditKeyEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]] = js.native
  ...
  var SelectionChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var VisibleMonthChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCalendar]
  ] = js.native
...
object MVCxClientCalendar {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientCalendar = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientCalendar]
}
