...
open class BootstrapClientScheduler ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientScheduler {
...
object BootstrapClientScheduler {
  ...
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientScheduler = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientScheduler]
}
