...
import typingsJapgolly.devexpressWeb.ASPxClientListEditItemSelectedChangedEventHandler
...
@js.native
open class ASPxClientCheckBoxList ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCheckBoxList {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItem(index: Double): typingsJapgolly.devexpressWeb.ASPxClientListEditItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSelectedItems(): js.Array[typingsJapgolly.devexpressWeb.ASPxClientListEditItem] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SelectItems(items: js.Array[typingsJapgolly.devexpressWeb.ASPxClientListEditItem]): Unit = js.native
  ...
  var SelectedIndexChanged_ASPxClientCheckBoxList: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientListEditItemSelectedChangedEventHandler[typingsJapgolly.devexpressWeb.ASPxClientCheckBoxList]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def UnselectItems(items: js.Array[typingsJapgolly.devexpressWeb.ASPxClientListEditItem]): Unit = js.native
...
object ASPxClientCheckBoxList {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientCheckBoxList = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientCheckBoxList]
}
