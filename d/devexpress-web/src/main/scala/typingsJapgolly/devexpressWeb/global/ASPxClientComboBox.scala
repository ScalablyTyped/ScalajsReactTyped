...
open class ASPxClientComboBox ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientComboBox {
...
object ASPxClientComboBox {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientComboBox = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientComboBox]
}
