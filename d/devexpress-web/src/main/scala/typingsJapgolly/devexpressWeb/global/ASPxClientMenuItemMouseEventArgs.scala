...
open class ASPxClientMenuItemMouseEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientMenuItemMouseEventArgs {
  /**
    ...
    */
  def this(item: typingsJapgolly.devexpressWeb.ASPxClientMenuItem, htmlElement: Any) = this()
