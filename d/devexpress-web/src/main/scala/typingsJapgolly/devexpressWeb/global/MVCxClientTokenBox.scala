...
open class MVCxClientTokenBox ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientTokenBox {
...
object MVCxClientTokenBox {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientTokenBox = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientTokenBox]
}
