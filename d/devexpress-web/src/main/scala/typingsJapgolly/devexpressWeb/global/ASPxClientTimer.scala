...
@js.native
open class ASPxClientTimer ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTimer {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var Tick: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientTimer]
  ] = js.native
...
object ASPxClientTimer {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientTimer = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientTimer]
}
