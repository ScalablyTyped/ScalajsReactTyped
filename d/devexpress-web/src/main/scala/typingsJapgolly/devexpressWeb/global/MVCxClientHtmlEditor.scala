...
open class MVCxClientHtmlEditor ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientHtmlEditor {
...
object MVCxClientHtmlEditor {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientHtmlEditor = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientHtmlEditor]
}
