...
/**
  ...
  */
@JSGlobal("MVCxClientUploadControl")
@js.native
open class MVCxClientUploadControl ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientUploadControl {
...
object MVCxClientUploadControl {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientUploadControl = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientUploadControl]
}
