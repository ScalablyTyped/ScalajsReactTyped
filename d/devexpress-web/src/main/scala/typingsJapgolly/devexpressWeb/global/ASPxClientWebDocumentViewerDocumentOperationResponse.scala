...
@js.native
open class ASPxClientWebDocumentViewerDocumentOperationResponse ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientWebDocumentViewerDocumentOperationResponse {
