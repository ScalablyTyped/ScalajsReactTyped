...
@js.native
open class ASPxClientReportToolbar ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientReportToolbar {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemTemplateControl(name: String): typingsJapgolly.devexpressWeb.ASPxClientControl = js.native
...
object ASPxClientReportToolbar {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientReportToolbar = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientReportToolbar]
}
