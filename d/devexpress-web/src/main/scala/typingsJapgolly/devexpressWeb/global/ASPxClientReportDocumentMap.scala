...
open class ASPxClientReportDocumentMap ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientReportDocumentMap {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ContentChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientEventHandler[typingsJapgolly.devexpressWeb.ASPxClientReportDocumentMap]
  ] = js.native
