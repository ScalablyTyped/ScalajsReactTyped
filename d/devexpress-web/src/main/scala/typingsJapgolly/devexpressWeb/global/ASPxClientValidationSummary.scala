...
import typingsJapgolly.devexpressWeb.ASPxClientValidationSummaryVisibilityChangedEventHandler
...
open class ASPxClientValidationSummary ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientValidationSummary {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var VisibilityChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientValidationSummaryVisibilityChangedEventHandler[typingsJapgolly.devexpressWeb.ASPxClientValidationSummary]
  ] = js.native
