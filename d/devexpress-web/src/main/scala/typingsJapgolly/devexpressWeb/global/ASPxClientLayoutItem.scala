...
@js.native
open class ASPxClientLayoutItem ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientLayoutItem {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemByName(name: String): typingsJapgolly.devexpressWeb.ASPxClientLayoutItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var formLayout: typingsJapgolly.devexpressWeb.ASPxClientFormLayout = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var parent: typingsJapgolly.devexpressWeb.ASPxClientLayoutItem = js.native
}
