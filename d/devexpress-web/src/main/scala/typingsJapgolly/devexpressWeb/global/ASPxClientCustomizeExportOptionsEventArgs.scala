...
@js.native
open class ASPxClientCustomizeExportOptionsEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCustomizeExportOptionsEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetExportOptionsModel(format: Any): Any = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def HideFormat(format: Any): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def HideProperties(format: Any, properties: Any*): Unit = js.native
}
