...
import typingsJapgolly.devexpressWeb.BootstrapClientChartZoomEndEventHandler
import typingsJapgolly.devexpressWeb.BootstrapClientChartZoomStartEventHandler
...
open class BootstrapClientChart ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientChart {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ZoomEnd: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    BootstrapClientChartZoomEndEventHandler[typingsJapgolly.devexpressWeb.BootstrapClientChart]
  ] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ZoomStart: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    BootstrapClientChartZoomStartEventHandler[typingsJapgolly.devexpressWeb.BootstrapClientChart]
  ] = js.native
