...
open class ASPxClientRadarDiagram ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRadarDiagram {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def DiagramToPoint(argument: Any, value: Any): typingsJapgolly.devexpressWeb.ASPxClientControlCoordinates = js.native
