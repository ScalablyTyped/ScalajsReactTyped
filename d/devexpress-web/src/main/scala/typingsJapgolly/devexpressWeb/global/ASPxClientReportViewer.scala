...
open class ASPxClientReportViewer ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientReportViewer {
...
object ASPxClientReportViewer {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientReportViewer = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientReportViewer]
}
