...
open class ASPxClientRibbonCommandExecutedEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRibbonCommandExecutedEventArgs {
  /**
    ...
    */
  def this(
    item: typingsJapgolly.devexpressWeb.ASPxClientRibbonItem,
    parameter: String,
  ...
  /**
    ...
    */
  /* CompleteClass */
  var item: typingsJapgolly.devexpressWeb.ASPxClientRibbonItem = js.native
