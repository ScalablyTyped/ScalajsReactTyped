...
open class ASPxClientRichEditPopupMenuItem ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItem {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItem(index: Double): typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetItemByName(name: String): typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetSubItems(): typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItemCollection = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var parent: typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
