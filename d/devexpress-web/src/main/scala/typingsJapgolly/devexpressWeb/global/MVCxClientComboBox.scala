...
@js.native
open class MVCxClientComboBox ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientComboBox {
...
object MVCxClientComboBox {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientComboBox = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientComboBox]
}
