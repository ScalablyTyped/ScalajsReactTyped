...
open class ASPxClientAppointment ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientAppointment {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetAppointmentType(): typingsJapgolly.devexpressWeb.ASPxAppointmentType = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetRecurrenceInfo(): typingsJapgolly.devexpressWeb.ASPxClientRecurrenceInfo = js.native
  
  /**
    * Gets the appointment that is the Appointment.RecurrencePattern for the current appointment.
    */
  /* CompleteClass */
  override def GetRecurrencePattern(): typingsJapgolly.devexpressWeb.ASPxClientAppointment = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetAppointmentType(`type`: typingsJapgolly.devexpressWeb.ASPxAppointmentType): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetRecurrenceInfo(recurrenceInfo: typingsJapgolly.devexpressWeb.ASPxClientRecurrenceInfo): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var appointmentType: typingsJapgolly.devexpressWeb.ASPxAppointmentType = js.native
  
  /**
    * Gets or sets the time interval of the time cells covered by the current appointment.
    */
  /* CompleteClass */
  var interval: typingsJapgolly.devexpressWeb.ASPxClientTimeInterval = js.native
