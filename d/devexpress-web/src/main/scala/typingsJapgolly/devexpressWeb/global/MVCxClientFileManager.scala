...
@js.native
open class MVCxClientFileManager ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientFileManager {
...
object MVCxClientFileManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientFileManager = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientFileManager]
}
