...
@js.native
open class ASPxClientTreeListToolbarItemClickEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTreeListToolbarItemClickEventArgs {
  /**
    ...
    */
  def this(item: typingsJapgolly.devexpressWeb.ASPxClientMenuItem, processOnServer: Boolean) = this()
