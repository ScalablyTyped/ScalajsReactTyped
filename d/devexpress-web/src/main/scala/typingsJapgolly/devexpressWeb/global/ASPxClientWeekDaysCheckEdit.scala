...
open class ASPxClientWeekDaysCheckEdit ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientWeekDaysCheckEdit {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetValue(): typingsJapgolly.devexpressWeb.ASPxClientWeekDays = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def SetValue(value: typingsJapgolly.devexpressWeb.ASPxClientWeekDays): Unit = js.native
