...
open class ASPxClientFinancialIndicatorPoint ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientFinancialIndicatorPoint {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var financialIndicator: typingsJapgolly.devexpressWeb.ASPxClientFinancialIndicator = js.native
