...
open class MVCxClientCardView ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientCardView {
...
object MVCxClientCardView {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientCardView = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientCardView]
}
