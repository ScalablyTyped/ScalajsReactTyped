...
@js.native
open class ASPxClientSpinEdit ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientSpinEdit {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var NumberChanged: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientSpinEdit]
  ] = js.native
  ...
  /* CompleteClass */
  @JSName("TextChanged")
  var TextChanged_ASPxClientSpinEditBase: typingsJapgolly.devexpressWeb.ASPxClientEvent[
    ASPxClientProcessingModeEventHandler[typingsJapgolly.devexpressWeb.ASPxClientSpinEditBase]
  ] = js.native
...
object ASPxClientSpinEdit {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientSpinEdit = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientSpinEdit]
}
