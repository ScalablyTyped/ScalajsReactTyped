...
open class ASPxClientGridBatchEditSummaryDisplayTextEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientGridBatchEditSummaryDisplayTextEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  var summaryType: typingsJapgolly.devexpressWeb.ASPxClientSummaryItemType = js.native
