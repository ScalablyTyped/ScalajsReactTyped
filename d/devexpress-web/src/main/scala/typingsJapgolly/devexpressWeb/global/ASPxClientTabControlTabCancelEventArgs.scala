...
open class ASPxClientTabControlTabCancelEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientTabControlTabCancelEventArgs {
  /**
    ...
    */
  def this(processOnServer: Boolean, tab: typingsJapgolly.devexpressWeb.ASPxClientTab) = this()
