...
@js.native
open class MVCxClientDockManager ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientDockManager {
...
object MVCxClientDockManager {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientDockManager = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientDockManager]
}
