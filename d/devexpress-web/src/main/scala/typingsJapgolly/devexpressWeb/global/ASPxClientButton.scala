...
open class ASPxClientButton ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientButton {
...
object ASPxClientButton {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientButton = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientButton]
}
