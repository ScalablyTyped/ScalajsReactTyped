...
@js.native
open class ASPxClientRichEditPointerUpEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRichEditPointerUpEventArgs {
  /**
    ...
    */
  def this(htmlEvent: Any, handled: Any) = this()
