...
open class ASPxClientRichEditPopupMenuShowingEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuShowingEventArgs {
  /**
    ...
    */
  def this(menuItems: typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItemCollection) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var menuItems: typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItemCollection = js.native
}
