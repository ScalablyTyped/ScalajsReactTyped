...
open class ASPxClientCheckBox ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientCheckBox {
...
object ASPxClientCheckBox {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.ASPxClientCheckBox = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.ASPxClientCheckBox]
}
