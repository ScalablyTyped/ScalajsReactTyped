...
open class BootstrapClientFABAction ()
  extends StObject
     with typingsJapgolly.devexpressWeb.BootstrapClientFABAction {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetActionItem(index: Double): typingsJapgolly.devexpressWeb.ASPxClientFABActionItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetActionItemByName(name: String): typingsJapgolly.devexpressWeb.ASPxClientFABActionItem = js.native
