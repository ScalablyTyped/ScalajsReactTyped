...
open class ASPxClientSpreadsheetViewModeChangedEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetViewModeChangedEventArgs {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  var oldViewMode: typingsJapgolly.devexpressWeb.ASPxClientSpreadsheetViewMode = js.native
}
