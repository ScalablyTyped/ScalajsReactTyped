...
open class ASPxClientDiagramMoveShapeEventArgs protected ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientDiagramMoveShapeEventArgs {
  /**
    ...
    */
  def this(shape: typingsJapgolly.devexpressWeb.DiagramShape, newPosition: Any, oldPosition: Any) = this()
