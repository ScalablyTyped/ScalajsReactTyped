...
open class ASPxClientRichEditPopupMenuItemCollection ()
  extends StObject
     with typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItemCollection {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Add(item: typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItem): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Get(index: Double): typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def GetByName(name: String): typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItem = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def Insert(index: Double, item: typingsJapgolly.devexpressWeb.ASPxClientRichEditPopupMenuItem): Unit = js.native
