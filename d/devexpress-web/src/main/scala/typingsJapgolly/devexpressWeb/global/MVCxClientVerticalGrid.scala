...
open class MVCxClientVerticalGrid ()
  extends StObject
     with typingsJapgolly.devexpressWeb.MVCxClientVerticalGrid {
...
object MVCxClientVerticalGrid {
  ...
  /**
    ...
    */
  /* static member */
  inline def Cast(obj: Any): typingsJapgolly.devexpressWeb.MVCxClientVerticalGrid = ^.asInstanceOf[js.Dynamic].applyDynamic("Cast")(obj.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.devexpressWeb.MVCxClientVerticalGrid]
}
