...
object ASPxClientTreeListBatchEditChangesSavingEventArgs {
  ...
  inline def apply(cancel: Boolean, deletedValues: Any, insertedValues: Any, updatedValues: Any): ASPxClientTreeListBatchEditChangesSavingEventArgs = {
  ...
  extension [Self <: ASPxClientTreeListBatchEditChangesSavingEventArgs](x: Self) {
