...
object HierarchyRectangularNode {
  ...
  def apply[Datum](
    ...
    __obj.updateDynamic("each")(js.Any.fromFunction1((t0: js.Function1[typingsJapgolly.d3Hierarchy.mod.HierarchyRectangularNode[Datum], scala.Unit]) => each(t0).runNow()))
    __obj.updateDynamic("eachAfter")(js.Any.fromFunction1((t0: js.Function1[typingsJapgolly.d3Hierarchy.mod.HierarchyRectangularNode[Datum], scala.Unit]) => eachAfter(t0).runNow()))
    __obj.updateDynamic("eachBefore")(js.Any.fromFunction1((t0: js.Function1[typingsJapgolly.d3Hierarchy.mod.HierarchyRectangularNode[Datum], scala.Unit]) => eachBefore(t0).runNow()))
    __obj.updateDynamic("leaves")(leaves.toJsFn)
    __obj.updateDynamic("links")(links.toJsFn)
    __obj.updateDynamic("path")(js.Any.fromFunction1((t0: typingsJapgolly.d3Hierarchy.mod.HierarchyRectangularNode[Datum]) => path(t0).runNow()))
    __obj.updateDynamic("sort")(js.Any.fromFunction1((t0: js.Function2[
  typingsJapgolly.d3Hierarchy.mod.HierarchyRectangularNode[Datum], 
  typingsJapgolly.d3Hierarchy.mod.HierarchyRectangularNode[Datum], 
