...
object HierarchyPointNode {
  ...
  typingsJapgolly.d3DashHierarchy.d3DashHierarchyMod.HierarchyPointNode[Datum], 
  ...
  scala.Unit]) => eachBefore(t0).runNow()))
    ...
    __obj.updateDynamic("path")(js.Any.fromFunction1((t0: typingsJapgolly.d3DashHierarchy.d3DashHierarchyMod.HierarchyPointNode[Datum]) => path(t0).runNow()))
