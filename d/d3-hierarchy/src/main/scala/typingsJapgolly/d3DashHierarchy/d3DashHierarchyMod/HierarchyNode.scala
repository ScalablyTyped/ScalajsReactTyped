...
object HierarchyNode {
  ...
  typingsJapgolly.d3DashHierarchy.d3DashHierarchyMod.HierarchyNode[Datum], 
  ...
  scala.Unit]) => eachBefore(t0).runNow()))
    ...
    __obj.updateDynamic("path")(js.Any.fromFunction1((t0: typingsJapgolly.d3DashHierarchy.d3DashHierarchyMod.HierarchyNode[Datum]) => path(t0).runNow()))
