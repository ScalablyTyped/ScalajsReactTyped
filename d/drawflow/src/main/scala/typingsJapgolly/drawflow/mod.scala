...
import typingsJapgolly.drawflow.anon.DictcustomModuleName
import typingsJapgolly.drawflow.drawflowStrings.`export`
import typingsJapgolly.drawflow.drawflowStrings.`import`
import typingsJapgolly.drawflow.drawflowStrings.addReroute
import typingsJapgolly.drawflow.drawflowStrings.click
import typingsJapgolly.drawflow.drawflowStrings.clickEnd
import typingsJapgolly.drawflow.drawflowStrings.connectionCancel
import typingsJapgolly.drawflow.drawflowStrings.connectionCreated
import typingsJapgolly.drawflow.drawflowStrings.connectionRemoved
import typingsJapgolly.drawflow.drawflowStrings.connectionSelected
import typingsJapgolly.drawflow.drawflowStrings.connectionStart
import typingsJapgolly.drawflow.drawflowStrings.connectionUnselected
import typingsJapgolly.drawflow.drawflowStrings.contextmenu
import typingsJapgolly.drawflow.drawflowStrings.keydown
import typingsJapgolly.drawflow.drawflowStrings.moduleChanged
import typingsJapgolly.drawflow.drawflowStrings.moduleCreated
import typingsJapgolly.drawflow.drawflowStrings.moduleRemoved
import typingsJapgolly.drawflow.drawflowStrings.mouseMove
import typingsJapgolly.drawflow.drawflowStrings.nodeCreated
import typingsJapgolly.drawflow.drawflowStrings.nodeMoved
import typingsJapgolly.drawflow.drawflowStrings.nodeRemoved
import typingsJapgolly.drawflow.drawflowStrings.nodeSelected
import typingsJapgolly.drawflow.drawflowStrings.nodeUnselected
import typingsJapgolly.drawflow.drawflowStrings.removeReroute
import typingsJapgolly.drawflow.drawflowStrings.translate
import typingsJapgolly.drawflow.drawflowStrings.zoom
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.drawflow.drawflowStrings.edit
    - typingsJapgolly.drawflow.drawflowStrings.fixed
    - typingsJapgolly.drawflow.drawflowStrings.view
  */
  trait DrawFlowEditorMode extends StObject
  object DrawFlowEditorMode {
    
    inline def edit: typingsJapgolly.drawflow.drawflowStrings.edit = "edit".asInstanceOf[typingsJapgolly.drawflow.drawflowStrings.edit]
    
    inline def fixed: typingsJapgolly.drawflow.drawflowStrings.fixed = "fixed".asInstanceOf[typingsJapgolly.drawflow.drawflowStrings.fixed]
    
    inline def view: typingsJapgolly.drawflow.drawflowStrings.view = "view".asInstanceOf[typingsJapgolly.drawflow.drawflowStrings.view]
  }
