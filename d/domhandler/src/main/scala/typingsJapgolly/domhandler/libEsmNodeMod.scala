...
import typingsJapgolly.domelementtype.mod.ElementType.Directive
import typingsJapgolly.domelementtype.mod.ElementType.Root
...
import typingsJapgolly.domhandler.domhandlerInts.`1`
import typingsJapgolly.domhandler.domhandlerInts.`3`
import typingsJapgolly.domhandler.domhandlerInts.`4`
import typingsJapgolly.domhandler.domhandlerInts.`8`
import typingsJapgolly.domhandler.domhandlerInts.`9`
import typingsJapgolly.domhandler.domhandlerStrings.`limited-quirks`
import typingsJapgolly.domhandler.domhandlerStrings.`no-quirks`
import typingsJapgolly.domhandler.domhandlerStrings.quirks
...
object libEsmNodeMod {
  ...
  open class CDATA protected ()
    ...
    @JSName("type")
    var type_CDATA: typingsJapgolly.domelementtype.mod.ElementType.CDATA = js.native
  }
  ...
  open class Comment protected ()
    ...
    @JSName("type")
    var type_Comment: typingsJapgolly.domelementtype.mod.ElementType.Comment = js.native
  }
  ...
  open class Text protected ()
    ...
    @JSName("type")
    var type_Text: typingsJapgolly.domelementtype.mod.ElementType.Text = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.domhandler.libEsmNodeMod.ParentNode
    - typingsJapgolly.domhandler.libEsmNodeMod.ChildNode
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.domhandler.libEsmNodeMod.Text
    - typingsJapgolly.domhandler.libEsmNodeMod.Comment
    - typingsJapgolly.domhandler.libEsmNodeMod.ProcessingInstruction
    - typingsJapgolly.domhandler.libEsmNodeMod.Element
    - typingsJapgolly.domhandler.libEsmNodeMod.CDATA
    - typingsJapgolly.domhandler.libEsmNodeMod.Document
  */
  trait ChildNode
    extends StObject
       with AnyNode
