...
object mod {
  ...
  open class CDATA protected ()
    extends typingsJapgolly.domhandler.libNodeMod.CDATA {
    /**
  ...
  open class Comment protected ()
    extends typingsJapgolly.domhandler.libNodeMod.Comment {
    /**
  ...
  open class DataNode protected ()
    extends typingsJapgolly.domhandler.libNodeMod.DataNode {
    /**
      * @param data The content of the data node
      */
    def this(data: String) = this()
  ...
  open class Document protected ()
    extends typingsJapgolly.domhandler.libNodeMod.Document {
    /**
      * @param children Children of the node. Only certain node types can have children.
      */
    def this(children: js.Array[ChildNode]) = this()
  ...
  open class DomHandler () extends StObject {
    ...
    /* protected */ var lastNode: typingsJapgolly.domhandler.libNodeMod.DataNode | Null = js.native
    ...
    var root: typingsJapgolly.domhandler.libNodeMod.Document = js.native
  ...
  open class Element protected ()
    extends typingsJapgolly.domhandler.libNodeMod.Element {
    /**
  ...
  @js.native
  open class Node ()
    extends typingsJapgolly.domhandler.libNodeMod.Node
  
  /* note: abstract class */ @JSImport("domhandler", "NodeWithChildren")
  @js.native
  open class NodeWithChildren protected ()
    extends typingsJapgolly.domhandler.libNodeMod.NodeWithChildren {
    /**
      * @param children Children of the node. Only certain node types can have children.
      */
    def this(children: js.Array[ChildNode]) = this()
  ...
  open class ProcessingInstruction protected ()
    extends typingsJapgolly.domhandler.libNodeMod.ProcessingInstruction {
  ...
  open class Text protected ()
    extends typingsJapgolly.domhandler.libNodeMod.Text {
    /**
      * @param data The content of the data node
      */
    def this(data: String) = this()
  ...
  inline def cloneNode[T /* <: typingsJapgolly.domhandler.libNodeMod.Node */](node: T): T = ^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(node.asInstanceOf[js.Any]).asInstanceOf[T]
  inline def cloneNode[T /* <: typingsJapgolly.domhandler.libNodeMod.Node */](node: T, recursive: Boolean): T = (^.asInstanceOf[js.Dynamic].applyDynamic("cloneNode")(node.asInstanceOf[js.Any], recursive.asInstanceOf[js.Any])).asInstanceOf[T]
  
  inline def hasChildren(node: typingsJapgolly.domhandler.libNodeMod.Node): /* is domhandler.domhandler/lib/node.ParentNode */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("hasChildren")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/node.ParentNode */ Boolean]
  
  inline def isCDATA(node: typingsJapgolly.domhandler.libNodeMod.Node): /* is domhandler.domhandler/lib/node.CDATA */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCDATA")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/node.CDATA */ Boolean]
  
  inline def isComment(node: typingsJapgolly.domhandler.libNodeMod.Node): /* is domhandler.domhandler/lib/node.Comment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isComment")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/node.Comment */ Boolean]
  
  inline def isDirective(node: typingsJapgolly.domhandler.libNodeMod.Node): /* is domhandler.domhandler/lib/node.ProcessingInstruction */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDirective")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/node.ProcessingInstruction */ Boolean]
  
  inline def isDocument(node: typingsJapgolly.domhandler.libNodeMod.Node): /* is domhandler.domhandler/lib/node.Document */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDocument")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/node.Document */ Boolean]
  
  inline def isTag(node: typingsJapgolly.domhandler.libNodeMod.Node): /* is domhandler.domhandler/lib/node.Element */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isTag")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/node.Element */ Boolean]
  
  inline def isText(node: typingsJapgolly.domhandler.libNodeMod.Node): /* is domhandler.domhandler/lib/node.Text */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isText")(node.asInstanceOf[js.Any]).asInstanceOf[/* is domhandler.domhandler/lib/node.Text */ Boolean]
  ...
  type ElementCallback = js.Function1[/* element */ typingsJapgolly.domhandler.libNodeMod.Element, Unit]
