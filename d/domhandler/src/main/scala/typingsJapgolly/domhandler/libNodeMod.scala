...
object libNodeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.domhandler.libNodeMod.ParentNode
    - typingsJapgolly.domhandler.libNodeMod.ChildNode
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.domhandler.libNodeMod.Text
    - typingsJapgolly.domhandler.libNodeMod.Comment
    - typingsJapgolly.domhandler.libNodeMod.ProcessingInstruction
    - typingsJapgolly.domhandler.libNodeMod.Element
    - typingsJapgolly.domhandler.libNodeMod.CDATA
    - typingsJapgolly.domhandler.libNodeMod.Document
  */
  trait ChildNode
    extends StObject
       with AnyNode
