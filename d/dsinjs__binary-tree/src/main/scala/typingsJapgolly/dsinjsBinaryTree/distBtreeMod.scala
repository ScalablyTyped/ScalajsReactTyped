...
import typingsJapgolly.dsinjsBinaryTree.anon.Next
import typingsJapgolly.dsinjsBinaryTree.anon.TypeofBTree
import typingsJapgolly.dsinjsBinaryTree.distBtreenodeMod.BTreeNode
...
object distBtreeMod {
  ...
  open class BTree[T] protected () extends StObject {
    ...
    /**
      ...
      */
    def toJSON(): typingsJapgolly.dsinjsBinaryTree.distBtreenodeMod.BTreeNodeStruct[T] = js.native
  ...
  open class ExtendedWindow ()
    ...
    var BTreeNode: Instantiable1[
        /* attr */ typingsJapgolly.dsinjsBinaryTree.distBtreenodeMod.BTreeNodeStruct[/* import warning: RewrittenClass.unapply cls was tparam T */ Any], 
        typingsJapgolly.dsinjsBinaryTree.distBtreenodeMod.BTreeNode[js.Object]
      ] = js.native
    
    var DSinJS: typingsJapgolly.dsinjsBinaryTree.anon.BTree = js.native
