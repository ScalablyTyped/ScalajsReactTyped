...
object ButtomSettingsCommon {
  ...
  extension [Self <: ButtomSettingsCommon](x: Self) {
    ...
    inline def setDestroy(value: (/* dt */ Api, /* node */ JQuery, /* config */ Any) => Callback): Self = StObject.set(x, "destroy", js.Any.fromFunction3((t0: /* dt */ Api, t1: /* node */ JQuery, t2: /* config */ Any) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setInit(value: (/* dt */ Api, /* node */ JQuery, /* config */ Any) => Callback): Self = StObject.set(x, "init", js.Any.fromFunction3((t0: /* dt */ Api, t1: /* node */ JQuery, t2: /* config */ Any) => (value(t0, t1, t2)).runNow()))
