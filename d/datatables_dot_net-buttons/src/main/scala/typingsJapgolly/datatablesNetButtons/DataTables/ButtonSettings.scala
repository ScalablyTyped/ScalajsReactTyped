...
object ButtonSettings {
  ...
  def apply(
    ...
    columnText: (/* dt */ Api, /* i */ Double, /* title */ String) => CallbackTo[String] = null,
    columns: js.Any = null,
    customize: /* win */ Window_ | String => Callback = null,
    customizeData: /* content */ js.Any => Callback = null,
    ...
    if (columnText != null) __obj.updateDynamic("columnText")(js.Any.fromFunction3((t0: /* dt */ typingsJapgolly.datatablesNetButtons.DataTables.Api, t1: /* i */ scala.Double, t2: /* title */ java.lang.String) => columnText(t0, t1, t2).runNow()))
    if (columns != null) __obj.updateDynamic("columns")(columns.asInstanceOf[js.Any])
    if (customize != null) __obj.updateDynamic("customize")(js.Any.fromFunction1((t0: /* win */ typingsJapgolly.std.Window_ | java.lang.String) => customize(t0).runNow()))
    if (customizeData != null) __obj.updateDynamic("customizeData")(js.Any.fromFunction1((t0: /* content */ js.Any) => customizeData(t0).runNow()))
