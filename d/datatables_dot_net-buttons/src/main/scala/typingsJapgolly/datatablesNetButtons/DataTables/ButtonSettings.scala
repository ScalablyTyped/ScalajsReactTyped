...
object ButtonSettings {
  ...
  extension [Self <: ButtonSettings](x: Self) {
    ...
    inline def setCustomize(value: /* win */ Window | String => Callback): Self = StObject.set(x, "customize", js.Any.fromFunction1((t0: /* win */ Window | String) => value(t0).runNow()))
    
    inline def setCustomizeData(value: /* content */ Any => Callback): Self = StObject.set(x, "customizeData", js.Any.fromFunction1((t0: /* content */ Any) => value(t0).runNow()))
