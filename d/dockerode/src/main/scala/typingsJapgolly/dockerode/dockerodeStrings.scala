...
import typingsJapgolly.dockerode.mod.LoggingDriverType
import typingsJapgolly.dockerode.mod.MountConsistency
import typingsJapgolly.dockerode.mod.MountPropagation
import typingsJapgolly.dockerode.mod.MountType
import typingsJapgolly.dockerode.mod.UpdateState
