...
trait NetworkInspectInfo extends StObject {
  ...
  var ConfigFrom: js.UndefOr[typingsJapgolly.dockerode.anon.Network] = js.undefined
  ...
  var IPAM: js.UndefOr[typingsJapgolly.dockerode.mod.IPAM] = js.undefined
...
object NetworkInspectInfo {
  ...
  extension [Self <: NetworkInspectInfo](x: Self) {
    ...
    inline def setConfigFrom(value: typingsJapgolly.dockerode.anon.Network): Self = StObject.set(x, "ConfigFrom", value.asInstanceOf[js.Any])
