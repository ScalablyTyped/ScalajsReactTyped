...
import typingsJapgolly.dockerode.dockerodeStrings.`next-exit`
import typingsJapgolly.dockerode.dockerodeStrings.`not-running`
import typingsJapgolly.dockerode.dockerodeStrings.removed
