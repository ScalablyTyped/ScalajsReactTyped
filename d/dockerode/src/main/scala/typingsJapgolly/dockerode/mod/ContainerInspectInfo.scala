...
import typingsJapgolly.dockerode.AnonAttachStderr
import typingsJapgolly.dockerode.AnonBridge
import typingsJapgolly.dockerode.AnonData
import typingsJapgolly.dockerode.AnonDead
import typingsJapgolly.dockerode.AnonMode
