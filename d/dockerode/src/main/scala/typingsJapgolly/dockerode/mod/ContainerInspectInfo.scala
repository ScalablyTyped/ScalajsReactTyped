...
import typingsJapgolly.dockerode.anon.AttachStderr
import typingsJapgolly.dockerode.anon.Bridge
import typingsJapgolly.dockerode.anon.Data
import typingsJapgolly.dockerode.anon.Dead
import typingsJapgolly.dockerode.anon.Mode
...
trait ContainerInspectInfo extends StObject {
  ...
  var HostConfig: typingsJapgolly.dockerode.mod.HostConfig
