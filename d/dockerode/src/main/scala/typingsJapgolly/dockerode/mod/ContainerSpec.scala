...
trait ContainerSpec extends StObject {
  ...
  var DNSConfig: js.UndefOr[typingsJapgolly.dockerode.mod.DNSConfig] = js.undefined
  ...
  var Privileges: js.UndefOr[typingsJapgolly.dockerode.mod.Privileges] = js.undefined
