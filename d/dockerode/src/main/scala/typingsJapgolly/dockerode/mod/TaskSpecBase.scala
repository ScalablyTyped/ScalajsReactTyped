...
import typingsJapgolly.dockerode.anon.NameOptions
...
trait TaskSpecBase extends StObject {
  ...
  var Placement: js.UndefOr[typingsJapgolly.dockerode.mod.Placement] = js.undefined
  
  var Resources: js.UndefOr[ResourceRequirements] = js.undefined
  
  var RestartPolicy: js.UndefOr[typingsJapgolly.dockerode.mod.RestartPolicy] = js.undefined
