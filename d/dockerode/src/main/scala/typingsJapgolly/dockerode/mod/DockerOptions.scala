...
import typingsJapgolly.dockerode.dockerodeStrings.http
import typingsJapgolly.dockerode.dockerodeStrings.https
import typingsJapgolly.dockerode.dockerodeStrings.ssh
