...
trait Spec
  ...
  var CAConfig: js.UndefOr[typingsJapgolly.dockerode.mod.CAConfig] = js.undefined
  
  var Dispatcher: js.UndefOr[DispatcherConfig] = js.undefined
  
  var EncryptionConfig: js.UndefOr[typingsJapgolly.dockerode.mod.EncryptionConfig] = js.undefined
  
  var Orchestration: js.UndefOr[OrchestrationConfig] = js.undefined
  
  var Raft: RaftConfig
  
  var TaskDefaults: js.UndefOr[typingsJapgolly.dockerode.mod.TaskDefaults] = js.undefined
}
object Spec {
