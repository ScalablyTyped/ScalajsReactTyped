...
trait ServiceSpec
  ...
  var EndpointSpec: js.UndefOr[typingsJapgolly.dockerode.mod.EndpointSpec] = js.undefined
  ...
  var UpdateConfig: js.UndefOr[typingsJapgolly.dockerode.mod.UpdateConfig] = js.undefined
}
object ServiceSpec {
