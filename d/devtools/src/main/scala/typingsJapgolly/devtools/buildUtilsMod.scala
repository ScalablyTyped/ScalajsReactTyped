...
import typingsJapgolly.devtools.anon.ValueFunction
import typingsJapgolly.devtools.buildFinderFirefoxMod.Priorities
import typingsJapgolly.node.NodeRequire
import typingsJapgolly.std.Record
import typingsJapgolly.wdioLogger.mod.Logger
import typingsJapgolly.wdioProtocols.buildTypesMod.CommandParameters
import typingsJapgolly.wdioProtocols.buildTypesMod.CommandPathVariables
...
object buildUtilsMod {
  ...
  inline def patchDebug(scoppedLogger: Logger, require: NodeRequire): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("patchDebug")(scoppedLogger.asInstanceOf[js.Any], require.asInstanceOf[js.Any])).asInstanceOf[Unit]
