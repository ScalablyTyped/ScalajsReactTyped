...
import typingsJapgolly.devtools.anon.Actions
import typingsJapgolly.devtools.anon.Args
...
import typingsJapgolly.devtools.anon.Implicit
import typingsJapgolly.devtools.anon.Message
import typingsJapgolly.devtools.anon.Name
import typingsJapgolly.devtools.anon.PageLoad
import typingsJapgolly.devtools.anon.PropertyName
...
object buildCommandsMod {
  ...
  inline def getAllCookies(): js.Promise[js.Array[typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.Cookie]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getAllCookies")().asInstanceOf[js.Promise[js.Array[typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.Cookie]]]
  ...
  inline def getNamedCookie(hasName: Name): js.Promise[typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.Cookie] = ^.asInstanceOf[js.Dynamic].applyDynamic("getNamedCookie")(hasName.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.devtoolsProtocol.mod.Protocol.Network.Cookie]]
