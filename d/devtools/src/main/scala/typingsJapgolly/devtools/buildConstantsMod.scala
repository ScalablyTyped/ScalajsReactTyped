...
import typingsJapgolly.devtools.anon.Default
import typingsJapgolly.devtools.anon.DefaultMatch
import typingsJapgolly.devtools.anon.DefaultMatchRequired
import typingsJapgolly.devtools.anon.Match
import typingsJapgolly.devtools.anon.MatchRequired
import typingsJapgolly.devtools.anon.MatchRequiredType
import typingsJapgolly.devtools.anon.MessageName
import typingsJapgolly.devtools.anon.Required
import typingsJapgolly.devtools.anon.RequiredType
import typingsJapgolly.devtools.anon.TypeValidate
import typingsJapgolly.devtools.anon.Validate
import typingsJapgolly.devtools.devtoolsStrings.chrome
import typingsJapgolly.devtools.devtoolsStrings.edge
import typingsJapgolly.devtools.devtoolsStrings.firefox
import typingsJapgolly.devtools.devtoolsStrings.googColonchromeOptions
import typingsJapgolly.devtools.devtoolsStrings.mozColonfirefoxOptions
import typingsJapgolly.devtools.devtoolsStrings.msColonedgeOptions
...
object buildConstantsMod {
  ...
  object BROWSER_TYPE {
    ...
    @js.native
    def chrome: typingsJapgolly.devtools.devtoolsStrings.chrome = js.native
    ...
    @js.native
    def edge: typingsJapgolly.devtools.devtoolsStrings.edge = js.native
    ...
    @js.native
    def firefox: typingsJapgolly.devtools.devtoolsStrings.firefox = js.native
