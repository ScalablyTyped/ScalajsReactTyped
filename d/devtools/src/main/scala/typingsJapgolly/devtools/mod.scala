...
import typingsJapgolly.devtools.buildTypesMod.AttachOptions
import typingsJapgolly.devtools.buildTypesMod.Client
...
object mod {
  ...
  object global {
    ...
    object WebdriverIO {
      ...
      type WDIODevtoolsOptions = typingsJapgolly.devtools.buildTypesMod.WDIODevtoolsOptions
    }
  }
}
