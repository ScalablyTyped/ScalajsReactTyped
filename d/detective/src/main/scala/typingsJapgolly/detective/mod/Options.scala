...
object Options {
  ...
  def apply(
    ...
    isRequire: /* node */ js.Any => CallbackTo[Boolean] = null,
    locations: js.UndefOr[Boolean] = js.undefined,
    nodes: String = null,
    parse: typingsJapgolly.acorn.mod.Options = null,
    ranges: String = null,
    ...
    if (isRequire != null) __obj.updateDynamic("isRequire")(js.Any.fromFunction1((t0: /* node */ js.Any) => isRequire(t0).runNow()))
