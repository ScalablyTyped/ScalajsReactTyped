...
import typingsJapgolly.detective.detectiveStrings.module
import typingsJapgolly.detective.detectiveStrings.never
import typingsJapgolly.detective.detectiveStrings.script
...
object mod extends Shortcut {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var parse: js.UndefOr[typingsJapgolly.acorn.mod.Options] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setParse(value: typingsJapgolly.acorn.mod.Options): Self = StObject.set(x, "parse", value.asInstanceOf[js.Any])
