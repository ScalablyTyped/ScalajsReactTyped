...
import typingsJapgolly.momentMini.mod.LongDateFormatKey
import typingsJapgolly.momentMini.mod.RelativeTimeKey
import typingsJapgolly.momentMini.mod._CalendarKey
import typingsJapgolly.momentMini.mod.unitOfTime.All
import typingsJapgolly.momentMini.mod.unitOfTime.Base
import typingsJapgolly.momentMini.mod.unitOfTime.Diff
import typingsJapgolly.momentMini.mod.unitOfTime.DurationConstructor
import typingsJapgolly.momentMini.mod.unitOfTime.MomentConstructor
import typingsJapgolly.momentMini.mod.unitOfTime.StartOf
...
object momentMiniStrings {
  ...
  sealed trait D
    extends All
       ...
       with StartOf
       with typingsJapgolly.momentMini.mod.unitOfTime.date
  ...
  sealed trait Q
    extends All
       ...
       with DurationConstructor
       with StartOf
       with typingsJapgolly.momentMini.mod.unitOfTime.quarter
  
  @js.native
  sealed trait W
    extends All
       with StartOf
       with typingsJapgolly.momentMini.mod.unitOfTime.isoWeek
