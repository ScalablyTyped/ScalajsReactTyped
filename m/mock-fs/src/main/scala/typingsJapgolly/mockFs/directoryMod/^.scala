...
class ^ () extends Directory {
  /**
    ...
    */
  /* CompleteClass */
  override def addItem[T /* <: typingsJapgolly.mockFs.itemMod.^ */](name: String, item: T): T = js.native
  ...
  /* CompleteClass */
  override def getItem(name: String): typingsJapgolly.mockFs.itemMod.^  | Null = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeItem(name: String): typingsJapgolly.mockFs.itemMod.^ = js.native
  /** Set access time. */
  /* CompleteClass */
