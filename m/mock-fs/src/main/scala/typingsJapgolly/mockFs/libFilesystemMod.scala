...
object libFilesystemMod {
  ...
  open class ^ ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getItem(filepath: String): typingsJapgolly.mockFs.libItemMod.^ = js.native
    
    /** Get the root directory. */
    /* CompleteClass */
    override def getRoot(): typingsJapgolly.mockFs.libDirectoryMod.^ = js.native
  }
  @JSImport("mock-fs/lib/filesystem", JSImport.Namespace)
  @js.native
  ...
  type DirectoryItem = String | Buffer | (js.Function0[
    typingsJapgolly.mockFs.libFileMod.^ | typingsJapgolly.mockFs.libDirectoryMod.^ | typingsJapgolly.mockFs.libSymlinkMod.^
  ]) | DirectoryItems
  ...
  trait FileSystem extends StObject {
    ...
    /**
      ...
      * @return The item (or null if not found).
      */
    def getItem(filepath: String): typingsJapgolly.mockFs.libItemMod.^
    
    /** Get the root directory. */
    def getRoot(): typingsJapgolly.mockFs.libDirectoryMod.^
  }
  object FileSystem {
    
    inline def apply(
      getItem: String => typingsJapgolly.mockFs.libItemMod.^,
      getRoot: CallbackTo[typingsJapgolly.mockFs.libDirectoryMod.^]
    ): FileSystem = {
      val __obj = js.Dynamic.literal(getItem = js.Any.fromFunction1(getItem), getRoot = getRoot.toJsFn)
      __obj.asInstanceOf[FileSystem]
    }
    
    extension [Self <: FileSystem](x: Self) {
      
      inline def setGetItem(value: String => typingsJapgolly.mockFs.libItemMod.^): Self = StObject.set(x, "getItem", js.Any.fromFunction1(value))
      
      inline def setGetRoot(value: CallbackTo[typingsJapgolly.mockFs.libDirectoryMod.^]): Self = StObject.set(x, "getRoot", value.toJsFn)
    }
  }
