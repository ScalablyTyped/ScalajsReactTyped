...
import typingsJapgolly.maximMazurokGapiClientMonitoring.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientMonitoring.anon.AltCallback
...
import typingsJapgolly.maximMazurokGapiClientMonitoring.anon.Force
import typingsJapgolly.maximMazurokGapiClientMonitoring.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientMonitoring.anon.UpdateMask
import typingsJapgolly.maximMazurokGapiClientMonitoring.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientMonitoring.anon.Xgafv
