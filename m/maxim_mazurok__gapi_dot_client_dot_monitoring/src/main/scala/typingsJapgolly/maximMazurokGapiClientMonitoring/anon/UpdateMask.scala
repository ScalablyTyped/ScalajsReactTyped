...
import typingsJapgolly.maximMazurokGapiClientMonitoring.gapi.client.monitoring.NotificationChannel
...
object UpdateMask {
  ...
  inline def apply(name: String, resource: NotificationChannel): UpdateMask = {
