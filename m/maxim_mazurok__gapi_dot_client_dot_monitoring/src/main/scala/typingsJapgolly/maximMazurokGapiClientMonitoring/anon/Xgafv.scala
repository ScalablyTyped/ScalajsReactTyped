...
import typingsJapgolly.maximMazurokGapiClientMonitoring.gapi.client.monitoring.GetNotificationChannelVerificationCodeRequest
...
object Xgafv {
  ...
  inline def apply(name: String, resource: GetNotificationChannelVerificationCodeRequest): Xgafv = {
