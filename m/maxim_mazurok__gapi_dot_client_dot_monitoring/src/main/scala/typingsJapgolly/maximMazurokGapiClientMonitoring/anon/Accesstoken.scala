...
trait Accesstoken extends StObject {
  ...
  var aggregationDotgroupByFields: js.UndefOr[String | js.Array[String]] = js.undefined
  ...
  var secondaryAggregationDotgroupByFields: js.UndefOr[String | js.Array[String]] = js.undefined
...
object Accesstoken {
  ...
  extension [Self <: Accesstoken](x: Self) {
    ...
    inline def setAggregationDotgroupByFields(value: String | js.Array[String]): Self = StObject.set(x, "aggregation.groupByFields", value.asInstanceOf[js.Any])
    ...
    inline def setSecondaryAggregationDotgroupByFields(value: String | js.Array[String]): Self = StObject.set(x, "secondaryAggregation.groupByFields", value.asInstanceOf[js.Any])
