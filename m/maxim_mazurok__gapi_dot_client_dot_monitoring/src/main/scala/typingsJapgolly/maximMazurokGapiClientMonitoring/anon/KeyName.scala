...
import typingsJapgolly.maximMazurokGapiClientMonitoring.gapi.client.monitoring.UptimeCheckConfig
...
object KeyName {
  ...
  inline def apply(name: String, resource: UptimeCheckConfig): KeyName = {
  ...
  extension [Self <: KeyName](x: Self) {
    ...
    inline def setResource(value: UptimeCheckConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
