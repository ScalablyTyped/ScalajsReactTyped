...
import typingsJapgolly.maximMazurokGapiClientMonitoring.gapi.client.monitoring.Service
...
object OauthtokenPrettyPrint {
  ...
  inline def apply(name: String, resource: Service): OauthtokenPrettyPrint = {
