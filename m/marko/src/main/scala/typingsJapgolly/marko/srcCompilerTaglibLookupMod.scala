...
import typingsJapgolly.marko.srcCompilerTaglibLookupTaglibLookupMod.default
...
object srcCompilerTaglibLookupMod {
  ...
  inline def registerTaglib(taglib: typingsJapgolly.marko.srcCompilerTaglibLoaderTaglibMod.default): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("registerTaglib")(taglib.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  @JSImport("marko/src/compiler/taglib-lookup", "registeredTaglibs")
  @js.native
  val registeredTaglibs: js.Array[typingsJapgolly.marko.srcCompilerTaglibLoaderTaglibMod.default] = js.native
}
