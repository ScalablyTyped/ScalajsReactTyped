...
import typingsJapgolly.marko.configMod.Config
import typingsJapgolly.marko.markoBooleans.`true`
import typingsJapgolly.marko.tagMod.^
import typingsJapgolly.marko.taglibLookupMod.TaglibLookup
...
object compilerMod extends js.Object {
  ...
  object taglibLoader extends js.Object {
    ...
    def clearCache(): Unit = js.native
    def createTaglib(filePath: String): typingsJapgolly.marko.taglibLoaderMod.Taglib = js.native
    def loadTag(tagProps: js.Any, filePath: String): ^ = js.native
    def loadTaglibFromFile(filePath: String): typingsJapgolly.marko.taglibLoaderMod.Taglib = js.native
    def loadTaglibFromProps(taglib: typingsJapgolly.marko.taglibLoaderMod.Taglib, taglibProps: js.Any): typingsJapgolly.marko.taglibLoaderMod.Taglib = js.native
  }
  ...
  object taglibLookup extends js.Object {
    @js.native
    class TaglibLookup ()
      extends typingsJapgolly.marko.taglibLookupTaglibLookupMod.default
    
    val registeredTaglibs: js.Array[default] = js.native
    def buildLookup(dirname: String): typingsJapgolly.marko.taglibLookupMod.TaglibLookup = js.native
    def clearCache(): Unit = js.native
