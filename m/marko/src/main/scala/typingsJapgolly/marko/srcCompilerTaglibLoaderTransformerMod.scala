...
object srcCompilerTaglibLoaderTransformerMod {
  ...
  object Transformer {
    ...
    inline def apply(getFunc: CallbackTo[Any], id: Double, priority: Any, properties: Any, taglibId: String): Transformer = {
      val __obj = js.Dynamic.literal(getFunc = getFunc.toJsFn, id = id.asInstanceOf[js.Any], priority = priority.asInstanceOf[js.Any], properties = properties.asInstanceOf[js.Any], taglibId = taglibId.asInstanceOf[js.Any], name = null, path = null, tag = null)
      __obj.asInstanceOf[Transformer]
    }
    
    extension [Self <: Transformer](x: Self) {
      
      inline def setGetFunc(value: CallbackTo[Any]): Self = StObject.set(x, "getFunc", value.toJsFn)
