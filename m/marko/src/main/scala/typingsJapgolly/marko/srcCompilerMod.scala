...
import typingsJapgolly.marko.srcCompilerConfigMod.Config
import typingsJapgolly.marko.srcCompilerTaglibLoaderTaglibMod.default
import typingsJapgolly.marko.srcCompilerTaglibLookupMod.TaglibLookup
...
object srcCompilerMod {
  ...
  object taglibLoader {
    ...
    open class Taglib protected ()
      extends typingsJapgolly.marko.srcCompilerTaglibLoaderMod.Taglib {
      def this(filePath: String) = this()
    }
    
    inline def clearCache(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("clearCache")().asInstanceOf[Unit]
    
    inline def createTaglib(filePath: String): typingsJapgolly.marko.srcCompilerTaglibLoaderMod.Taglib = ^.asInstanceOf[js.Dynamic].applyDynamic("createTaglib")(filePath.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.marko.srcCompilerTaglibLoaderMod.Taglib]
    ...
    inline def loadTaglibFromFile(filePath: String): typingsJapgolly.marko.srcCompilerTaglibLoaderMod.Taglib = ^.asInstanceOf[js.Dynamic].applyDynamic("loadTaglibFromFile")(filePath.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.marko.srcCompilerTaglibLoaderMod.Taglib]
    
    inline def loadTaglibFromProps(taglib: typingsJapgolly.marko.srcCompilerTaglibLoaderMod.Taglib, taglibProps: Any): typingsJapgolly.marko.srcCompilerTaglibLoaderMod.Taglib = (^.asInstanceOf[js.Dynamic].applyDynamic("loadTaglibFromProps")(taglib.asInstanceOf[js.Any], taglibProps.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.marko.srcCompilerTaglibLoaderMod.Taglib]
  }
  ...
  object taglibLookup {
    ...
    open class TaglibLookup ()
      extends typingsJapgolly.marko.srcCompilerTaglibLookupMod.TaglibLookup
    
    inline def buildLookup(dirname: String): typingsJapgolly.marko.srcCompilerTaglibLookupMod.TaglibLookup = ^.asInstanceOf[js.Dynamic].applyDynamic("buildLookup")(dirname.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.marko.srcCompilerTaglibLookupMod.TaglibLookup]
