package typingsJapgolly.marko.tagMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.marko.attributeMod.default
...
trait Tag extends js.Object {
  ...
  var transformers: StringDictionary[typingsJapgolly.marko.transformerMod.default] = js.native
  ...
  def forEachTransformer(callback: js.Function1[/* transformer */ typingsJapgolly.marko.transformerMod.default, Unit]): Unit = js.native
  def forEachTransformer(
    callback: js.Function1[/* transformer */ typingsJapgolly.marko.transformerMod.default, Unit],
    thisObj: js.Any
  ): Unit = js.native
  ...
  def setTaglib(taglib: typingsJapgolly.marko.taglibMod.default): Unit = js.native
}
