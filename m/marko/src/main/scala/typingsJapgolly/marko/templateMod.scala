...
import typingsJapgolly.asyncWriter.mod.AsyncWriter
import typingsJapgolly.marko.asyncStreamMod.AsyncStream
import typingsJapgolly.marko.asyncVDOMBuilderMod.AsyncVDOMBuilder
import typingsJapgolly.marko.renderResultMod.RenderResult
...
object templateMod extends js.Object {
  ...
  class Readable protected ()
    extends typingsJapgolly.node.streamMod.Readable {
