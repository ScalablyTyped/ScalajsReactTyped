...
import typingsJapgolly.mochawesome.anon.OptionsVersion
import typingsJapgolly.mochawesome.anon.PartialReporterOptions
import typingsJapgolly.mochawesome.anon.Version
import typingsJapgolly.mochawesome.mochawesomeStrings.failed
import typingsJapgolly.mochawesome.mochawesomeStrings.fast
import typingsJapgolly.mochawesome.mochawesomeStrings.medium
import typingsJapgolly.mochawesome.mochawesomeStrings.passed
import typingsJapgolly.mochawesome.mochawesomeStrings.slow
...
object mod {
  ...
  trait OutputMeta extends StObject {
    ...
    var mochawesome: typingsJapgolly.mochawesome.anon.Options
  }
  object OutputMeta {
    
    inline def apply(marge: OptionsVersion, mocha: Version, mochawesome: typingsJapgolly.mochawesome.anon.Options): OutputMeta = {
    ...
    extension [Self <: OutputMeta](x: Self) {
      ...
      inline def setMochawesome(value: typingsJapgolly.mochawesome.anon.Options): Self = StObject.set(x, "mochawesome", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait OutputStats
    extends StObject
       with typingsJapgolly.mocha.Mocha.Stats
       with Stats
  object OutputStats {
