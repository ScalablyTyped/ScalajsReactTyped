package typingsJapgolly.maximMazurokGapiClientFitness

import typingsJapgolly.maximMazurokGapiClientFitness.gapi.client.fitness.AggregateRequest
import typingsJapgolly.maximMazurokGapiClientFitness.gapi.client.fitness.DataSource
import typingsJapgolly.maximMazurokGapiClientFitness.gapi.client.fitness.Dataset
import typingsJapgolly.maximMazurokGapiClientFitness.gapi.client.fitness.Session
...
object anon {
  ...
  object DataTypeName {
    ...
    extension [Self <: DataTypeName](x: Self) {
