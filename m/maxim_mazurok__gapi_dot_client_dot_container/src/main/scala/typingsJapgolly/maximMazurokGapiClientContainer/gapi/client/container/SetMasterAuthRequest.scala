...
trait SetMasterAuthRequest extends StObject {
...
object SetMasterAuthRequest {
  ...
  inline def apply(): SetMasterAuthRequest = {
  ...
  extension [Self <: SetMasterAuthRequest](x: Self) {
    ...
    inline def setUpdate(value: MasterAuth): Self = StObject.set(x, "update", value.asInstanceOf[js.Any])
