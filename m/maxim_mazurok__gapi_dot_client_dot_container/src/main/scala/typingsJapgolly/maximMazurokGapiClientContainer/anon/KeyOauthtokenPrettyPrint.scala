...
import typingsJapgolly.maximMazurokGapiClientContainer.gapi.client.container.UpdateMasterRequest
...
trait KeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: UpdateMasterRequest
...
object KeyOauthtokenPrettyPrint {
  ...
  inline def apply(clusterId: String, projectId: String, resource: UpdateMasterRequest, zone: String): KeyOauthtokenPrettyPrint = {
  ...
  extension [Self <: KeyOauthtokenPrettyPrint](x: Self) {
    ...
    inline def setResource(value: UpdateMasterRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
