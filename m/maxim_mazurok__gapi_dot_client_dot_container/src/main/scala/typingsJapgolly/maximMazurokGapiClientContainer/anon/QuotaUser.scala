...
import typingsJapgolly.maximMazurokGapiClientContainer.gapi.client.container.SetNodePoolManagementRequest
...
object QuotaUser {
  ...
  inline def apply(name: String, resource: SetNodePoolManagementRequest): QuotaUser = {
