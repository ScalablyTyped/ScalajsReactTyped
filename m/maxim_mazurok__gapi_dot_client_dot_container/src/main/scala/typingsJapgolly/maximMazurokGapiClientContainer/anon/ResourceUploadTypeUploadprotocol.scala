...
import typingsJapgolly.maximMazurokGapiClientContainer.gapi.client.container.SetNetworkPolicyRequest
...
object ResourceUploadTypeUploadprotocol {
  ...
  inline def apply(clusterId: String, projectId: String, resource: SetNetworkPolicyRequest, zone: String): ResourceUploadTypeUploadprotocol = {
