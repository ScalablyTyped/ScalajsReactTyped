...
import typingsJapgolly.maximMazurokGapiClientContainer.gapi.client.container.SetLegacyAbacRequest
...
object CallbackClusterIdFields {
  ...
  inline def apply(clusterId: String, projectId: String, resource: SetLegacyAbacRequest, zone: String): CallbackClusterIdFields = {
  ...
  extension [Self <: CallbackClusterIdFields](x: Self) {
