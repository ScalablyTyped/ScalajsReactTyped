package typingsJapgolly.maximMazurokGapiClientContainer.anon

import typingsJapgolly.maximMazurokGapiClientContainer.gapi.client.container.SetLabelsRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait PrettyPrintProjectIdQuotaUser extends StObject {
...
object PrettyPrintProjectIdQuotaUser {
  
  inline def apply(clusterId: String, projectId: String, resource: SetLabelsRequest, zone: String): PrettyPrintProjectIdQuotaUser = {
    ...
    __obj.asInstanceOf[PrettyPrintProjectIdQuotaUser]
  }
  
  extension [Self <: PrettyPrintProjectIdQuotaUser](x: Self) {
