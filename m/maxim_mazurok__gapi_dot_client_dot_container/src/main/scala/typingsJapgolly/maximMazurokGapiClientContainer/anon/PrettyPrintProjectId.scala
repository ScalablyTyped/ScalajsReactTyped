...
import typingsJapgolly.maximMazurokGapiClientContainer.gapi.client.container.SetAddonsConfigRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait PrettyPrintProjectId extends StObject {
...
object PrettyPrintProjectId {
  ...
  inline def apply(clusterId: String, projectId: String, resource: SetAddonsConfigRequest, zone: String): PrettyPrintProjectId = {
  ...
  extension [Self <: PrettyPrintProjectId](x: Self) {
