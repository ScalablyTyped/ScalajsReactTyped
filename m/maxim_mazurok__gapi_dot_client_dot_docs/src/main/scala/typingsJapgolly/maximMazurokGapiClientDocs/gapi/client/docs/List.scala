...
object List {
  ...
  inline def apply(): typingsJapgolly.maximMazurokGapiClientDocs.gapi.client.docs.List = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typingsJapgolly.maximMazurokGapiClientDocs.gapi.client.docs.List]
  }
  
  extension [Self <: typingsJapgolly.maximMazurokGapiClientDocs.gapi.client.docs.List](x: Self) {
