...
import typingsJapgolly.maximMazurokGapiClientDocs.gapi.client.docs.BatchUpdateDocumentRequest
import typingsJapgolly.maximMazurokGapiClientDocs.gapi.client.docs.Document
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: BatchUpdateDocumentRequest
  ...
  object Accesstoken {
    ...
    inline def apply(documentId: String, resource: BatchUpdateDocumentRequest): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: BatchUpdateDocumentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Alt {
    ...
    inline def apply(documentId: String): Alt = {
  ...
  object Callback {
    ...
    inline def apply(resource: Document): Callback = {
  ...
  object DocumentId {
    ...
    inline def apply(documentId: String): DocumentId = {
      val __obj = js.Dynamic.literal(documentId = documentId.asInstanceOf[js.Any])
