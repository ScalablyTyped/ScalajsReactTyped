...
trait GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative extends StObject {
  ...
  /**
    ...
    * the audio.
    */
  var words: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1WordInfo]] = js.undefined
}
object GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative {
  
  inline def apply(): GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p3beta1SpeechRecognitionAlternative](x: Self) {
    ...
    inline def setWords(value: js.Array[GoogleCloudVideointelligenceV1p3beta1WordInfo]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
