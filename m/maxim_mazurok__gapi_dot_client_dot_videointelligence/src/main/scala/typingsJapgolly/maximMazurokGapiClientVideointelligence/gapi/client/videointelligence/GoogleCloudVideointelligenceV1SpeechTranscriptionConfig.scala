...
trait GoogleCloudVideointelligenceV1SpeechTranscriptionConfig extends StObject {
  ...
  var speechContexts: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1SpeechContext]] = js.undefined
}
object GoogleCloudVideointelligenceV1SpeechTranscriptionConfig {
  
  inline def apply(): GoogleCloudVideointelligenceV1SpeechTranscriptionConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1SpeechTranscriptionConfig]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1SpeechTranscriptionConfig](x: Self) {
    ...
    inline def setSpeechContexts(value: js.Array[GoogleCloudVideointelligenceV1SpeechContext]): Self = StObject.set(x, "speechContexts", value.asInstanceOf[js.Any])
