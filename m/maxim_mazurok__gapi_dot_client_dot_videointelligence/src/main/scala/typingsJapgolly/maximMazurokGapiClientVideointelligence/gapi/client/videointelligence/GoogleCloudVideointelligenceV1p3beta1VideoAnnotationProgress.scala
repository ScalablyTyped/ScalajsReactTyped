...
object GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p3beta1VideoAnnotationProgress](x: Self) {
