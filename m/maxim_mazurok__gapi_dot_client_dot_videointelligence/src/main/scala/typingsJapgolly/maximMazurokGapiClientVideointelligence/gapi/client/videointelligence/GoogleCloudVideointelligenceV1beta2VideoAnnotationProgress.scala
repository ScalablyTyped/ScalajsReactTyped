...
object GoogleCloudVideointelligenceV1beta2VideoAnnotationProgress {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1beta2VideoAnnotationProgress = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1beta2VideoAnnotationProgress]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1beta2VideoAnnotationProgress](x: Self) {
