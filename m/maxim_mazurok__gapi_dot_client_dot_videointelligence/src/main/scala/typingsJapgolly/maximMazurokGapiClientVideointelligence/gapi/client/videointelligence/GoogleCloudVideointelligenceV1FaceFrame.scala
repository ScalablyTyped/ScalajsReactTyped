...
object GoogleCloudVideointelligenceV1FaceFrame {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1FaceFrame](x: Self) {
    ...
    inline def setNormalizedBoundingBoxesVarargs(value: GoogleCloudVideointelligenceV1NormalizedBoundingBox*): Self = StObject.set(x, "normalizedBoundingBoxes", js.Array(value*))
