...
trait GoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation extends StObject {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1ObjectTrackingFrame]] = js.undefined
...
object GoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p3beta1ObjectTrackingAnnotation](x: Self) {
    ...
    inline def setFrames(value: js.Array[GoogleCloudVideointelligenceV1p3beta1ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
    
    inline def setFramesUndefined: Self = StObject.set(x, "frames", js.undefined)
    
    inline def setFramesVarargs(value: GoogleCloudVideointelligenceV1p3beta1ObjectTrackingFrame*): Self = StObject.set(x, "frames", js.Array(value*))
