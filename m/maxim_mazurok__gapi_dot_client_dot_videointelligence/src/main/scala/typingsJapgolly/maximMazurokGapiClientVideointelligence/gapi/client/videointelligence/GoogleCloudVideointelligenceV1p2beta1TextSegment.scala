...
object GoogleCloudVideointelligenceV1p2beta1TextSegment {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1p2beta1TextSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p2beta1TextSegment]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p2beta1TextSegment](x: Self) {
    
    inline def setConfidence(value: Double): Self = StObject.set(x, "confidence", value.asInstanceOf[js.Any])
    
    inline def setConfidenceUndefined: Self = StObject.set(x, "confidence", js.undefined)
    
    inline def setFrames(value: js.Array[GoogleCloudVideointelligenceV1p2beta1TextFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
