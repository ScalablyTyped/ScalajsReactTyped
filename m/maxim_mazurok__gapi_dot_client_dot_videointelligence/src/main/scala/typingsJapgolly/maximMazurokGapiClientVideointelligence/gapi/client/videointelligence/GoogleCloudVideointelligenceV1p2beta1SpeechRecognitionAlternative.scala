...
trait GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative extends StObject {
  ...
  /**
    ...
    * the audio.
    */
  var words: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p2beta1WordInfo]] = js.undefined
}
object GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative {
  
  inline def apply(): GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p2beta1SpeechRecognitionAlternative](x: Self) {
    ...
    inline def setWords(value: js.Array[GoogleCloudVideointelligenceV1p2beta1WordInfo]): Self = StObject.set(x, "words", value.asInstanceOf[js.Any])
    
    inline def setWordsUndefined: Self = StObject.set(x, "words", js.undefined)
    
    inline def setWordsVarargs(value: GoogleCloudVideointelligenceV1p2beta1WordInfo*): Self = StObject.set(x, "words", js.Array(value*))
  }
}
