...
object GoogleCloudVideointelligenceV1p3beta1AnnotateVideoResponse {
  ...
  inline def apply(): GoogleCloudVideointelligenceV1p3beta1AnnotateVideoResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1AnnotateVideoResponse]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p3beta1AnnotateVideoResponse](x: Self) {
    
    inline def setAnnotationResults(value: js.Array[GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults]): Self = StObject.set(x, "annotationResults", value.asInstanceOf[js.Any])
    
    inline def setAnnotationResultsUndefined: Self = StObject.set(x, "annotationResults", js.undefined)
    
    inline def setAnnotationResultsVarargs(value: GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults*): Self = StObject.set(x, "annotationResults", js.Array(value*))
  }
}
