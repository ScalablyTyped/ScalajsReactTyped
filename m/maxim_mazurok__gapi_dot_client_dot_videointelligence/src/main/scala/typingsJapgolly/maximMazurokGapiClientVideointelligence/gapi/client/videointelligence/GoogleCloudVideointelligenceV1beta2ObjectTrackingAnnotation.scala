...
trait GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation extends StObject {
  ...
  /**
    ...
    */
  var frames: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1beta2ObjectTrackingFrame]] = js.undefined
...
object GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation {
  
  inline def apply(): GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1beta2ObjectTrackingAnnotation](x: Self) {
    ...
    inline def setFrames(value: js.Array[GoogleCloudVideointelligenceV1beta2ObjectTrackingFrame]): Self = StObject.set(x, "frames", value.asInstanceOf[js.Any])
