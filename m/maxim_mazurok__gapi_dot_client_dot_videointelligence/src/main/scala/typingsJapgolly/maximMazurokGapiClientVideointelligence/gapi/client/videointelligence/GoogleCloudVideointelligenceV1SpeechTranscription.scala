...
trait GoogleCloudVideointelligenceV1SpeechTranscription extends StObject {
  ...
  /**
    ...
    */
  var alternatives: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1SpeechRecognitionAlternative]] = js.undefined
...
object GoogleCloudVideointelligenceV1SpeechTranscription {
  
  inline def apply(): GoogleCloudVideointelligenceV1SpeechTranscription = {
  ...
  extension [Self <: GoogleCloudVideointelligenceV1SpeechTranscription](x: Self) {
    ...
    inline def setAlternativesVarargs(value: GoogleCloudVideointelligenceV1SpeechRecognitionAlternative*): Self = StObject.set(x, "alternatives", js.Array(value*))
