...
trait GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults extends StObject {
  ...
  var celebrityRecognitionAnnotations: js.UndefOr[GoogleCloudVideointelligenceV1p3beta1CelebrityRecognitionAnnotation] = js.undefined
  ...
  var faceAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1FaceAnnotation]] = js.undefined
  
  /** Face detection annotations. */
  var faceDetectionAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1FaceDetectionAnnotation]] = js.undefined
  
  /** Label annotations on frame level. There is exactly one element for each unique label. */
  var frameLabelAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1LabelAnnotation]] = js.undefined
  
  /** Video file location in [Cloud Storage](https://cloud.google.com/storage/). */
  var inputUri: js.UndefOr[String] = js.undefined
  
  /** Annotations for list of logos detected, tracked and recognized in video. */
  var logoRecognitionAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation]] = js.undefined
  ...
  var personDetectionAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1PersonDetectionAnnotation]] = js.undefined
  
  /** Video segment on which the annotation is run. */
  var segment: js.UndefOr[GoogleCloudVideointelligenceV1p3beta1VideoSegment] = js.undefined
  
  /** Topical label annotations on video level or user-specified segment level. There is exactly one element for each unique label. */
  var segmentLabelAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1LabelAnnotation]] = js.undefined
  ...
  /**
    ...
    */
  var segmentPresenceLabelAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1LabelAnnotation]] = js.undefined
  ...
  var shotLabelAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1LabelAnnotation]] = js.undefined
  ...
  /**
    ...
    */
  var shotPresenceLabelAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1LabelAnnotation]] = js.undefined
  
  /** Speech transcription. */
  var speechTranscriptions: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1SpeechTranscription]] = js.undefined
  
  /** OCR text detection and tracking. Annotations for list of detected text snippets. Each will have list of frame information associated with it. */
  var textAnnotations: js.UndefOr[js.Array[GoogleCloudVideointelligenceV1p3beta1TextAnnotation]] = js.undefined
}
object GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults {
  
  inline def apply(): GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p3beta1VideoAnnotationResults](x: Self) {
    
    inline def setCelebrityRecognitionAnnotations(value: GoogleCloudVideointelligenceV1p3beta1CelebrityRecognitionAnnotation): Self = StObject.set(x, "celebrityRecognitionAnnotations", value.asInstanceOf[js.Any])
    ...
    inline def setFaceAnnotations(value: js.Array[GoogleCloudVideointelligenceV1p3beta1FaceAnnotation]): Self = StObject.set(x, "faceAnnotations", value.asInstanceOf[js.Any])
    ...
    inline def setLogoRecognitionAnnotations(value: js.Array[GoogleCloudVideointelligenceV1p3beta1LogoRecognitionAnnotation]): Self = StObject.set(x, "logoRecognitionAnnotations", value.asInstanceOf[js.Any])
    ...
    inline def setSegmentLabelAnnotations(value: js.Array[GoogleCloudVideointelligenceV1p3beta1LabelAnnotation]): Self = StObject.set(x, "segmentLabelAnnotations", value.asInstanceOf[js.Any])
