...
trait GoogleCloudVideointelligenceV1p1beta1VideoSegment extends StObject {
...
object GoogleCloudVideointelligenceV1p1beta1VideoSegment {
  
  inline def apply(): GoogleCloudVideointelligenceV1p1beta1VideoSegment = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVideointelligenceV1p1beta1VideoSegment]
  }
  
  extension [Self <: GoogleCloudVideointelligenceV1p1beta1VideoSegment](x: Self) {
