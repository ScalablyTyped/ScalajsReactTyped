...
import typingsJapgolly.maximMazurokGapiClientApigateway.anon.GatewayId
...
import typingsJapgolly.maximMazurokGapiClientApigateway.anon.Resource
import typingsJapgolly.maximMazurokGapiClientApigateway.anon.UploadType
