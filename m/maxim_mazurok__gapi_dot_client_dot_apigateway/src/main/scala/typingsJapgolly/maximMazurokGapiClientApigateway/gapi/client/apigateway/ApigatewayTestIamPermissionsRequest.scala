...
trait ApigatewayTestIamPermissionsRequest extends StObject {
...
object ApigatewayTestIamPermissionsRequest {
  
  inline def apply(): ApigatewayTestIamPermissionsRequest = {
