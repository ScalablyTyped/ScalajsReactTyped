...
object ApigatewayPolicy {
  ...
  extension [Self <: ApigatewayPolicy](x: Self) {
    ...
    inline def setAuditConfigsVarargs(value: ApigatewayAuditConfig*): Self = StObject.set(x, "auditConfigs", js.Array(value*))
    ...
    inline def setBindingsVarargs(value: ApigatewayBinding*): Self = StObject.set(x, "bindings", js.Array(value*))
