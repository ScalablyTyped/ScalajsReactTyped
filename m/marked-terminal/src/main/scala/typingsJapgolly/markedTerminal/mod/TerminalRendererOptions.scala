package typingsJapgolly.markedTerminal.mod
...
object TerminalRendererOptions {
  ...
  def apply(
    ...
    list: (/* body */ String, /* ordered */ js.UndefOr[Boolean]) => CallbackTo[String] = null,
    ...
    if (list != null) __obj.updateDynamic("list")(js.Any.fromFunction2((t0: /* body */ java.lang.String, t1: /* ordered */ js.UndefOr[scala.Boolean]) => list(t0, t1).runNow()))
