...
import typingsJapgolly.maximMazurokGapiClientAdexchangebuyer2.gapi.client.adexchangebuyer2.AcceptProposalRequest
...
object FieldsKey {
  ...
  inline def apply(accountId: String, proposalId: String, resource: AcceptProposalRequest): FieldsKey = {
