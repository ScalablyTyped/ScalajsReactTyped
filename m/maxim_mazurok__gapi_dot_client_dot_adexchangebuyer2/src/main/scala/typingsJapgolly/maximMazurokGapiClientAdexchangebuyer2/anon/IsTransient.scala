...
import typingsJapgolly.maximMazurokGapiClientAdexchangebuyer2.gapi.client.adexchangebuyer2.FilterSet
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait IsTransient extends StObject {
...
object IsTransient {
  ...
  inline def apply(ownerName: String, resource: FilterSet): IsTransient = {
    val __obj = js.Dynamic.literal(ownerName = ownerName.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  extension [Self <: IsTransient](x: Self) {
    ...
    inline def setResource(value: FilterSet): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
