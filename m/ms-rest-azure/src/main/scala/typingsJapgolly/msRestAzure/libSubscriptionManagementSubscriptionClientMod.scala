...
import typingsJapgolly.msRest.mod.ServiceClientOptions
import typingsJapgolly.msRestAzure.libSubscriptionManagementOperationsMod.Subscriptions
import typingsJapgolly.msRestAzure.libSubscriptionManagementOperationsMod.Tenants
