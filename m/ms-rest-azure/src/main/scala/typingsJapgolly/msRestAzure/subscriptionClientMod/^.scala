package typingsJapgolly.msRestAzure.subscriptionClientMod

import typingsJapgolly.msRest.mod.ServiceClientCredentials
import typingsJapgolly.msRest.mod.ServiceClientOptions
import typingsJapgolly.msRestAzure.operationsMod.Subscriptions
import typingsJapgolly.msRestAzure.operationsMod.Tenants
