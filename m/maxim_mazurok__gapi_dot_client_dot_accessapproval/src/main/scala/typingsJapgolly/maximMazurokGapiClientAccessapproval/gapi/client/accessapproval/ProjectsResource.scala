package typingsJapgolly.maximMazurokGapiClientAccessapproval.gapi.client.accessapproval

import typingsJapgolly.gapiClient.gapi.client.Request
import typingsJapgolly.maximMazurokGapiClientAccessapproval.anon.Alt
import typingsJapgolly.maximMazurokGapiClientAccessapproval.anon.Key
import typingsJapgolly.maximMazurokGapiClientAccessapproval.anon.Name
