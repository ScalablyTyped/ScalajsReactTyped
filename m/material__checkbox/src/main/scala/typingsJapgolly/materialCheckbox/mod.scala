...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialCheckbox.foundationMod.default {
  ...
  open class MDCCheckbox protected ()
    extends typingsJapgolly.materialCheckbox.componentMod.MDCCheckbox {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
      foundation: typingsJapgolly.materialCheckbox.foundationMod.MDCCheckboxFoundation,
      args: Any*
    ) = this()
  }
  /* static members */
  object MDCCheckbox {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): typingsJapgolly.materialCheckbox.componentMod.MDCCheckbox = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.materialCheckbox.componentMod.MDCCheckbox]
  }
  
  @JSImport("@material/checkbox", "MDCCheckboxFoundation")
  @js.native
  open class MDCCheckboxFoundation ()
    extends typingsJapgolly.materialCheckbox.foundationMod.MDCCheckboxFoundation {
    def this(adapter: PartialMDCCheckboxAdapter) = this()
  }
