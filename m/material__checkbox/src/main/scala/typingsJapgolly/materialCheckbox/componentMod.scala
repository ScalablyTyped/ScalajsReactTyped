...
import typingsJapgolly.materialCheckbox.foundationMod.MDCCheckboxFoundation
...
object componentMod {
  ...
  - typingsJapgolly.materialRipple.typesMod.MDCRippleCapableSurface because var conflicts: root. Inlined disabled, unbounded */ @JSImport("@material/checkbox/component", "MDCCheckbox")
  @js.native
  ...
  object MDCCheckbox {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCCheckbox = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCCheckbox]
  }
