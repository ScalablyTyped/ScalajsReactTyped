...
trait StartIndex extends StObject {
  ...
  var volumeId: js.UndefOr[String | js.Array[String]] = js.undefined
}
object StartIndex {
  ...
  extension [Self <: StartIndex](x: Self) {
    ...
    inline def setVolumeId(value: String | js.Array[String]): Self = StObject.set(x, "volumeId", value.asInstanceOf[js.Any])
