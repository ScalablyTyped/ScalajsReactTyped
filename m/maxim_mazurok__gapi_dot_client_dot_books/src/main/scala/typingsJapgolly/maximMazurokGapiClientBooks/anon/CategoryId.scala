...
trait CategoryId extends StObject {
  ...
  var categoryId: js.UndefOr[String | js.Array[String]] = js.undefined
...
object CategoryId {
  ...
  extension [Self <: CategoryId](x: Self) {
    ...
    inline def setCategoryId(value: String | js.Array[String]): Self = StObject.set(x, "categoryId", value.asInstanceOf[js.Any])
