...
trait AcquireMethod extends StObject {
  ...
  var acquireMethod: js.UndefOr[String | js.Array[String]] = js.undefined
  ...
  var processingState: js.UndefOr[String | js.Array[String]] = js.undefined
...
object AcquireMethod {
  ...
  inline def apply(): AcquireMethod = {
  ...
  extension [Self <: AcquireMethod](x: Self) {
    ...
    inline def setAcquireMethod(value: String | js.Array[String]): Self = StObject.set(x, "acquireMethod", value.asInstanceOf[js.Any])
    ...
    inline def setProcessingState(value: String | js.Array[String]): Self = StObject.set(x, "processingState", value.asInstanceOf[js.Any])
