...
import typingsJapgolly.maximMazurokGapiClientWorkflows.gapi.client.workflows.Workflow
...
object anon {
  ...
  object Callback {
    ...
    inline def apply(parent: String, resource: Workflow): Callback = {
    ...
    extension [Self <: Callback](x: Self) {
      ...
      inline def setResource(value: Workflow): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    inline def apply(name: String, resource: Workflow): Key = {
