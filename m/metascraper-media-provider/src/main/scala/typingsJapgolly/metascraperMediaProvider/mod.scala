...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnError(value: (/* url */ String, /* error */ js.Error) => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction2((t0: /* url */ String, t1: /* error */ js.Error) => (value(t0, t1)).runNow()))
