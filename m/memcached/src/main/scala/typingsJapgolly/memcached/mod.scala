...
import typingsJapgolly.memcached.anon.Dictkey
...
object mod {
  ...
  open class ^ protected () extends Memcached {
    ...
    def this(location: Location, options: typingsJapgolly.memcached.mod.options) = this()
  }
  @JSImport("memcached", JSImport.Namespace)
  @js.native
  ...
  */
  ...
  object EventNames {
    ...
    inline def failure: typingsJapgolly.memcached.memcachedStrings.failure = "failure".asInstanceOf[typingsJapgolly.memcached.memcachedStrings.failure]
    
    inline def issue: typingsJapgolly.memcached.memcachedStrings.issue = "issue".asInstanceOf[typingsJapgolly.memcached.memcachedStrings.issue]
    
    inline def reconnect: typingsJapgolly.memcached.memcachedStrings.reconnect = "reconnect".asInstanceOf[typingsJapgolly.memcached.memcachedStrings.reconnect]
    
    inline def reconnecting: typingsJapgolly.memcached.memcachedStrings.reconnecting = "reconnecting".asInstanceOf[typingsJapgolly.memcached.memcachedStrings.reconnecting]
    
    inline def remove: typingsJapgolly.memcached.memcachedStrings.remove = "remove".asInstanceOf[typingsJapgolly.memcached.memcachedStrings.remove]
  }
