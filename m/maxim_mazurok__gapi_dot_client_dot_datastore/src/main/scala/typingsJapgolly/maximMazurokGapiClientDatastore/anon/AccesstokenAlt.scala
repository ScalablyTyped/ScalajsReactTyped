...
import typingsJapgolly.maximMazurokGapiClientDatastore.gapi.client.datastore.RunQueryRequest
...
object AccesstokenAlt {
  ...
  inline def apply(projectId: String, resource: RunQueryRequest): AccesstokenAlt = {
