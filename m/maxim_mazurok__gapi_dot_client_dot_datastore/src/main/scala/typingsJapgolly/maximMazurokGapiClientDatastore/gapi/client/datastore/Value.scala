...
object Value {
  ...
  extension [Self <: Value](x: Self) {
    ...
    inline def setEntityValue(value: Entity): Self = StObject.set(x, "entityValue", value.asInstanceOf[js.Any])
    ...
    inline def setKeyValue(value: Key): Self = StObject.set(x, "keyValue", value.asInstanceOf[js.Any])
