...
trait SkipInitialVersionCreation extends StObject {
...
object SkipInitialVersionCreation {
  
  inline def apply(parent: String): SkipInitialVersionCreation = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[SkipInitialVersionCreation]
  }
  
  extension [Self <: SkipInitialVersionCreation](x: Self) {
