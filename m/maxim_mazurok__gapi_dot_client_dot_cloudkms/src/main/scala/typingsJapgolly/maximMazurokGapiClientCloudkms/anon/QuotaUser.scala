...
import typingsJapgolly.maximMazurokGapiClientCloudkms.gapi.client.cloudkms.AsymmetricSignRequest
...
object QuotaUser {
  ...
  inline def apply(name: String, resource: AsymmetricSignRequest): QuotaUser = {
