...
import typingsJapgolly.maximMazurokGapiClientCloudkms.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientCloudkms.anon.Alt
...
import typingsJapgolly.maximMazurokGapiClientCloudkms.anon.Key
