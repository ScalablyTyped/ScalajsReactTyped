...
import typingsJapgolly.maximMazurokGapiClientPeople.gapi.client.people.UpdateContactGroupRequest
...
object PrettyPrint {
  ...
  inline def apply(resource: UpdateContactGroupRequest, resourceName: String): PrettyPrint = {
  ...
  extension [Self <: PrettyPrint](x: Self) {
    ...
    inline def setResource(value: UpdateContactGroupRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
