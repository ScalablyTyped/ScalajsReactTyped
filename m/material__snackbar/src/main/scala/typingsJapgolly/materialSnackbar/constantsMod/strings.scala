...
import typingsJapgolly.materialSnackbar.materialSnackbarStrings.MDCSnackbarColonhide
import typingsJapgolly.materialSnackbar.materialSnackbarStrings.MDCSnackbarColonshow
import typingsJapgolly.materialSnackbar.materialSnackbarStrings.`Dotmdc-snackbar__action-button`
import typingsJapgolly.materialSnackbar.materialSnackbarStrings.`Dotmdc-snackbar__action-wrapper`
import typingsJapgolly.materialSnackbar.materialSnackbarStrings.`Dotmdc-snackbar__text`
