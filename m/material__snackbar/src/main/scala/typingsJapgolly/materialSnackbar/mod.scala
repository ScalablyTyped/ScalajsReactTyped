...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialSnackbar.foundationMod.default {
  ...
  open class MDCSnackbar protected ()
    extends typingsJapgolly.materialSnackbar.componentMod.MDCSnackbar {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
      foundation: typingsJapgolly.materialSnackbar.foundationMod.MDCSnackbarFoundation,
      args: Any*
    ) = this()
  }
  /* static members */
  object MDCSnackbar {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): typingsJapgolly.materialSnackbar.componentMod.MDCSnackbar = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.materialSnackbar.componentMod.MDCSnackbar]
  }
  
  @JSImport("@material/snackbar", "MDCSnackbarFoundation")
  @js.native
  open class MDCSnackbarFoundation ()
    extends typingsJapgolly.materialSnackbar.foundationMod.MDCSnackbarFoundation {
    def this(adapter: PartialMDCSnackbarAdapter) = this()
  }
  ...
  object util {
    ...
    inline def announce(ariaEl: org.scalajs.dom.Element): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("announce")(ariaEl.asInstanceOf[js.Any]).asInstanceOf[Unit]
    inline def announce(ariaEl: org.scalajs.dom.Element, labelEl: org.scalajs.dom.Element): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("announce")(ariaEl.asInstanceOf[js.Any], labelEl.asInstanceOf[js.Any])).asInstanceOf[Unit]
  }
}
