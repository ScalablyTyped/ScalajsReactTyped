...
object anon {
  ...
  object PartialMDCSnackbarAdapter {
    ...
    extension [Self <: PartialMDCSnackbarAdapter](x: Self) {
      ...
      inline def setNotifyClosed(value: /* reason */ String => Callback): Self = StObject.set(x, "notifyClosed", js.Any.fromFunction1((t0: /* reason */ String) => value(t0).runNow()))
      
      inline def setNotifyClosedUndefined: Self = StObject.set(x, "notifyClosed", js.undefined)
      
      inline def setNotifyClosing(value: /* reason */ String => Callback): Self = StObject.set(x, "notifyClosing", js.Any.fromFunction1((t0: /* reason */ String) => value(t0).runNow()))
