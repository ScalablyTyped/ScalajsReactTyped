...
import typingsJapgolly.materialSnackbar.foundationMod.MDCSnackbarFoundation
import typingsJapgolly.materialSnackbar.typesMod.MDCSnackbarAnnouncerFactory
...
object componentMod {
  ...
  object MDCSnackbar {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCSnackbar = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCSnackbar]
  }
}
