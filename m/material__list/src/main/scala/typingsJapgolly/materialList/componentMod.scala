...
import typingsJapgolly.materialList.foundationMod.MDCListFoundation
...
object componentMod {
  ...
  open class MDCList protected () extends MDCComponent[MDCListFoundation] {
    ...
    /**
      ...
      */
    def getPrimaryText(item: org.scalajs.dom.Element): String = js.native
    ...
    def listElements: js.Array[org.scalajs.dom.Element] = js.native
  ...
  object MDCList {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCList = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCList]
  }
