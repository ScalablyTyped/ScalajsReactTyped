package typingsJapgolly.momentTimezone
...
import typingsJapgolly.momentTimezone.anon.Links
import typingsJapgolly.momentTimezone.mod.momentAugmentingMod.MomentTimezone
import typingsJapgolly.momentTimezone.momentTimezoneBooleans.`false`
import typingsJapgolly.momentTimezone.momentTimezoneBooleans.`true`
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    trait Moment extends StObject {
      ...
      def tz(timezone: String): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def tz(timezone: String, keepLocalTime: Boolean): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
    ...
    trait MomentTimezone extends StObject {
      ...
      def apply(): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def apply(
        date: String,
        format: typingsJapgolly.moment.ts3Dot1TypingsMomentMod.MomentFormatSpecification,
        language: String,
        strict: Boolean,
        timezone: String
      ): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def apply(
        date: String,
        format: typingsJapgolly.moment.ts3Dot1TypingsMomentMod.MomentFormatSpecification,
        language: String,
      ...
      def apply(date: String, timezone: String): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def apply(date: js.Array[Double], timezone: String): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def apply(date: js.Date, timezone: String): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def apply(date: Any, timezone: String): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def apply(date: Double, timezone: String): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def apply(date: typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment, timezone: String): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      def apply(timezone: String): typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment = js.native
      ...
      def setDefault(): typingsJapgolly.momentTimezone.mod.momentAugmentingMod.Moment = js.native
      def setDefault(timezone: String): typingsJapgolly.momentTimezone.mod.momentAugmentingMod.Moment = js.native
