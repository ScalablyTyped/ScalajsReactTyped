...
object Descriptor {
  ...
  extension [Self <: Descriptor](x: Self) {
    ...
    inline def setNotifyErrorAction(value: /* msg */ js.UndefOr[String] => Callback): Self = StObject.set(x, "notifyErrorAction", js.Any.fromFunction1((t0: /* msg */ js.UndefOr[String]) => value(t0).runNow()))
    
    inline def setNotifyErrorActionUndefined: Self = StObject.set(x, "notifyErrorAction", js.undefined)
    
    inline def setNotifyLoadingQueueHasEmptiedAction(value: Callback): Self = StObject.set(x, "notifyLoadingQueueHasEmptiedAction", value.toJsFn)
