...
import typingsJapgolly.mocha.Mocha_.reporters.Base_.ColorMap
import typingsJapgolly.mocha.Mocha_.reporters.Base_.SymbolMap
...
object TypeofBase {
  ...
  def apply(
    ...
    __obj.updateDynamic("list")(js.Any.fromFunction1((t0: js.Array[typingsJapgolly.mocha.Mocha_.Test_]) => list(t0).runNow()))
