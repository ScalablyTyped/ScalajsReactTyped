...
import typingsJapgolly.mocha.Mocha_.MochaInstanceOptions
import typingsJapgolly.mocha.Mocha_.MochaOptions
import typingsJapgolly.mocha.Mocha_.Reporter
...
class Mocha__ () extends js.Object {
  ...
  def reporter(reporter: typingsJapgolly.mocha.Mocha_.ReporterConstructor): this.type = js.native
  def reporter(reporter: typingsJapgolly.mocha.Mocha_.ReporterConstructor, reporterOptions: js.Any): this.type = js.native
