...
import typingsJapgolly.mocha.Mocha.Interface
import typingsJapgolly.mocha.Mocha.MochaInstanceOptions
import typingsJapgolly.mocha.Mocha.Reporter
import typingsJapgolly.mocha.Mocha.ReporterConstructor
import typingsJapgolly.mocha.Mocha.RootHookObject
import typingsJapgolly.mocha.Mocha.Runner
import typingsJapgolly.mocha.Mocha.Suite
import typingsJapgolly.mocha.Mocha.reporters.Base_
...
import typingsJapgolly.mocha.mochaStrings.afterEach
import typingsJapgolly.mocha.mochaStrings.beforeAll
import typingsJapgolly.mocha.mochaStrings.beforeEach
...
import typingsJapgolly.mocha.mochaStrings.idle
...
import typingsJapgolly.mocha.mochaStrings.run
import typingsJapgolly.mocha.mochaStrings.running
import typingsJapgolly.mocha.mochaStrings.slow
import typingsJapgolly.mocha.mochaStrings.start
import typingsJapgolly.mocha.mochaStrings.stopped
import typingsJapgolly.mocha.mochaStrings.suite
import typingsJapgolly.mocha.mochaStrings.test
...
object Mocha {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mocha.mochaStrings.bdd
    - typingsJapgolly.mocha.mochaStrings.tdd
    - typingsJapgolly.mocha.mochaStrings.qunit
    - typingsJapgolly.mocha.mochaStrings.exports
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mocha.mochaStrings.Base
    - typingsJapgolly.mocha.mochaStrings.base_
    - typingsJapgolly.mocha.mochaStrings.Dot
    - typingsJapgolly.mocha.mochaStrings.dot_
    - typingsJapgolly.mocha.mochaStrings.TAP
    - typingsJapgolly.mocha.mochaStrings.tap_
    - typingsJapgolly.mocha.mochaStrings.JSON
    - typingsJapgolly.mocha.mochaStrings.json_
    - typingsJapgolly.mocha.mochaStrings.HTML
    - typingsJapgolly.mocha.mochaStrings.html_
    - typingsJapgolly.mocha.mochaStrings.List
    - typingsJapgolly.mocha.mochaStrings.list_
    - typingsJapgolly.mocha.mochaStrings.Min
    - typingsJapgolly.mocha.mochaStrings.min_
    - typingsJapgolly.mocha.mochaStrings.Spec
    - typingsJapgolly.mocha.mochaStrings.spec_
    - typingsJapgolly.mocha.mochaStrings.Nyan
    - typingsJapgolly.mocha.mochaStrings.nyan_
    - typingsJapgolly.mocha.mochaStrings.XUnit
    - typingsJapgolly.mocha.mochaStrings.xunit_
    - typingsJapgolly.mocha.mochaStrings.Markdown
    - typingsJapgolly.mocha.mochaStrings.markdown_
    - typingsJapgolly.mocha.mochaStrings.Progress
    - typingsJapgolly.mocha.mochaStrings.progress_
    - typingsJapgolly.mocha.mochaStrings.Landing
    - typingsJapgolly.mocha.mochaStrings.landing_
    - typingsJapgolly.mocha.mochaStrings.JSONStream
    - typingsJapgolly.mocha.mochaStrings.`json-stream`
  */
  ...
  object reporters {
    ...
    object Progress_ {
      ...
      trait MochaOptions
        extends StObject
           with typingsJapgolly.mocha.Mocha.MochaOptions
      object MochaOptions {
        
        inline def apply(): typingsJapgolly.mocha.Mocha.reporters.Progress_.MochaOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.mocha.Mocha.reporters.Progress_.MochaOptions]
        }
      }
    ...
    object XUnit_ {
      ...
      object MochaOptions {
        ...
        inline def apply(): typingsJapgolly.mocha.Mocha.reporters.XUnit_.MochaOptions = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.mocha.Mocha.reporters.XUnit_.MochaOptions]
        }
      }
