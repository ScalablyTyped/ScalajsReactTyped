...
trait SuiteFunction extends js.Object {
  ...
  /**
    ...
    * - _Only available when invoked via the mocha CLI._
    */
  def only(title: String, fn: js.ThisFunction0[/* this */ Suite_, Unit]): Suite_ = js.native
  /**
    * [bdd, tdd] Indicates this suite should not be executed.
    *
    * - _Only available when invoked via the mocha CLI._
    */
  def skip(title: String, fn: js.ThisFunction0[/* this */ Suite_, Unit]): Suite_ | Unit = js.native
}
