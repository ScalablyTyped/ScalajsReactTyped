...
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.anon.Language
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.anon.PrettyPrint
