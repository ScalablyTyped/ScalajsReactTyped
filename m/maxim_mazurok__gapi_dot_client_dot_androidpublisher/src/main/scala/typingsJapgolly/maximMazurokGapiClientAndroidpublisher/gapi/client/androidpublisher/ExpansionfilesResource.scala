...
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.anon.ExpansionFileType
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.anon.PackageName
