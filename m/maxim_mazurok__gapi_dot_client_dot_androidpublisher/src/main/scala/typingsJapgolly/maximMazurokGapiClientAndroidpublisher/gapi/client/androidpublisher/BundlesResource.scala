...
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.anon.AckBundleInstallationWarning
...
trait BundlesResource extends StObject {
  ...
  def list(request: Fields): Request[BundlesListResponse] = js.native
