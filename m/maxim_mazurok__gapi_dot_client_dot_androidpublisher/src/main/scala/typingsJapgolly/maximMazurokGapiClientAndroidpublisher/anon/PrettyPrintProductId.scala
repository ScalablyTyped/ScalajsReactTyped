...
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.MigrateBasePlanPricesRequest
...
trait PrettyPrintProductId extends StObject {
  ...
  /** Request body */
  var resource: MigrateBasePlanPricesRequest
...
object PrettyPrintProductId {
  ...
  inline def apply(basePlanId: String, packageName: String, productId: String, resource: MigrateBasePlanPricesRequest): PrettyPrintProductId = {
  ...
  extension [Self <: PrettyPrintProductId](x: Self) {
    ...
    inline def setResource(value: MigrateBasePlanPricesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
