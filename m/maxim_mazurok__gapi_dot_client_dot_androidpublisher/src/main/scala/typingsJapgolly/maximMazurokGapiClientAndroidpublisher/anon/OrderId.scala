...
object OrderId {
  ...
  inline def apply(orderId: String, packageName: String): OrderId = {
    val __obj = js.Dynamic.literal(orderId = orderId.asInstanceOf[js.Any], packageName = packageName.asInstanceOf[js.Any])
