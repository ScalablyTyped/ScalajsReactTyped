...
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.Subscription
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait RegionsVersionversionResource extends StObject {
...
object RegionsVersionversionResource {
  
  inline def apply(packageName: String, productId: String, resource: Subscription): RegionsVersionversionResource = {
    ...
    __obj.asInstanceOf[RegionsVersionversionResource]
  }
  
  extension [Self <: RegionsVersionversionResource](x: Self) {
