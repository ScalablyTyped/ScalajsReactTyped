...
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.InAppProduct
...
object AllowMissing {
  ...
  inline def apply(packageName: String, resource: InAppProduct, sku: String): AllowMissing = {
