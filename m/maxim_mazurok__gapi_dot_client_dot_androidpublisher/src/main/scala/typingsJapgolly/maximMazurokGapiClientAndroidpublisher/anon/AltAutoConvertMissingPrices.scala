...
trait AltAutoConvertMissingPrices extends StObject {
...
object AltAutoConvertMissingPrices {
  
  inline def apply(packageName: String): AltAutoConvertMissingPrices = {
    val __obj = js.Dynamic.literal(packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltAutoConvertMissingPrices]
  }
  
  extension [Self <: AltAutoConvertMissingPrices](x: Self) {
