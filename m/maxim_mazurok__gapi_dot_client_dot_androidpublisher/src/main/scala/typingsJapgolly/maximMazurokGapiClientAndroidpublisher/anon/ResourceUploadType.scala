...
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.Variant
...
object ResourceUploadType {
  ...
  inline def apply(packageName: String, resource: Variant, versionCode: String): ResourceUploadType = {
