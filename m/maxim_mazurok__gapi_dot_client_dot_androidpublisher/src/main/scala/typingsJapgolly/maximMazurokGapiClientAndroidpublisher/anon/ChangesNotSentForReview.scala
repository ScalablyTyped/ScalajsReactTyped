...
trait ChangesNotSentForReview extends StObject {
...
object ChangesNotSentForReview {
  
  inline def apply(editId: String, packageName: String): ChangesNotSentForReview = {
    val __obj = js.Dynamic.literal(editId = editId.asInstanceOf[js.Any], packageName = packageName.asInstanceOf[js.Any])
    __obj.asInstanceOf[ChangesNotSentForReview]
  }
  
  extension [Self <: ChangesNotSentForReview](x: Self) {
