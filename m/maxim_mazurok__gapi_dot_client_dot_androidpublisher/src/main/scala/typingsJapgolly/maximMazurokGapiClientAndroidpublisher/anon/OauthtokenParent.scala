...
import typingsJapgolly.maximMazurokGapiClientAndroidpublisher.gapi.client.androidpublisher.User
...
object OauthtokenParent {
  ...
  inline def apply(parent: String, resource: User): OauthtokenParent = {
