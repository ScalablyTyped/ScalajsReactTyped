...
trait ParamsBoolean extends StObject {
...
object ParamsBoolean {
  
  inline def apply(id: Double, jsonrpc: String, method: String, params: Boolean): ParamsBoolean = {
    ...
    __obj.asInstanceOf[ParamsBoolean]
  }
  
  extension [Self <: ParamsBoolean](x: Self) {
