...
trait JsonrpcStringMethodNumber extends StObject {
...
object JsonrpcStringMethodNumber {
  
  inline def apply(id: Double, jsonrpc: String, method: Double, params: Unit): JsonrpcStringMethodNumber = {
    ...
    __obj.asInstanceOf[JsonrpcStringMethodNumber]
  }
  
  extension [Self <: JsonrpcStringMethodNumber](x: Self) {
