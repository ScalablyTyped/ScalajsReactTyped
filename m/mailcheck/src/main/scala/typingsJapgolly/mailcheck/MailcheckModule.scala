...
object MailcheckModule {
  ...
  object IAsynchronousOptions {
    ...
    extension [Self <: IAsynchronousOptions](x: Self) {
      ...
      inline def setEmptyCallback(value: Callback): Self = StObject.set(x, "empty", value.toJsFn)
      
      inline def setEmptyFunction1(value: /* element */ JQuery => Callback): Self = StObject.set(x, "empty", js.Any.fromFunction1((t0: /* element */ JQuery) => value(t0).runNow()))
      ...
      inline def setSuggestedFunction1(value: /* suggested */ ISuggestion => Callback): Self = StObject.set(x, "suggested", js.Any.fromFunction1((t0: /* suggested */ ISuggestion) => value(t0).runNow()))
      
      inline def setSuggestedFunction2(value: (/* element */ JQuery, /* suggested */ ISuggestion) => Callback): Self = StObject.set(x, "suggested", js.Any.fromFunction2((t0: /* element */ JQuery, t1: /* suggested */ ISuggestion) => (value(t0, t1)).runNow()))
