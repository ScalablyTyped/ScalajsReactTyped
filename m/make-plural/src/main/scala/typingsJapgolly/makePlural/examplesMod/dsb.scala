...
import typingsJapgolly.makePlural.anon.FewOneOther
...
object dsb {
  ...
  @JSImport("make-plural/examples", "dsb")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("make-plural/examples", "dsb.cardinal")
  @js.native
  ...
  @JSImport("make-plural/examples", "dsb.ordinal")
  @js.native
