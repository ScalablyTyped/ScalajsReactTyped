...
object anon {
  ...
  object PartialMDCSelectAdapter {
    ...
    extension [Self <: PartialMDCSelectAdapter](x: Self) {
      ...
      inline def setAddMenuClass(value: /* className */ String => Callback): Self = StObject.set(x, "addMenuClass", js.Any.fromFunction1((t0: /* className */ String) => value(t0).runNow()))
      ...
      inline def setFocusMenuItemAtIndex(value: /* index */ Double => Callback): Self = StObject.set(x, "focusMenuItemAtIndex", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
      ...
      inline def setNotifyChange(value: /* value */ String => Callback): Self = StObject.set(x, "notifyChange", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
      ...
      inline def setRemoveMenuClass(value: /* className */ String => Callback): Self = StObject.set(x, "removeMenuClass", js.Any.fromFunction1((t0: /* className */ String) => value(t0).runNow()))
      
      inline def setRemoveMenuClassUndefined: Self = StObject.set(x, "removeMenuClass", js.undefined)
      
      inline def setRemoveSelectAnchorAttr(value: /* attr */ String => Callback): Self = StObject.set(x, "removeSelectAnchorAttr", js.Any.fromFunction1((t0: /* attr */ String) => value(t0).runNow()))
      ...
      inline def setSetMenuAnchorCorner(value: /* anchorCorner */ Corner => Callback): Self = StObject.set(x, "setMenuAnchorCorner", js.Any.fromFunction1((t0: /* anchorCorner */ Corner) => value(t0).runNow()))
      
      inline def setSetMenuAnchorCornerUndefined: Self = StObject.set(x, "setMenuAnchorCorner", js.undefined)
      
      inline def setSetMenuAnchorElement(value: /* anchorEl */ Element => Callback): Self = StObject.set(x, "setMenuAnchorElement", js.Any.fromFunction1((t0: /* anchorEl */ Element) => value(t0).runNow()))
      
      inline def setSetMenuAnchorElementUndefined: Self = StObject.set(x, "setMenuAnchorElement", js.undefined)
      
      inline def setSetMenuWrapFocus(value: /* wrapFocus */ Boolean => Callback): Self = StObject.set(x, "setMenuWrapFocus", js.Any.fromFunction1((t0: /* wrapFocus */ Boolean) => value(t0).runNow()))
      
      inline def setSetMenuWrapFocusUndefined: Self = StObject.set(x, "setMenuWrapFocus", js.undefined)
      
      inline def setSetRippleCenter(value: /* normalizedX */ Double => Callback): Self = StObject.set(x, "setRippleCenter", js.Any.fromFunction1((t0: /* normalizedX */ Double) => value(t0).runNow()))
      
      inline def setSetRippleCenterUndefined: Self = StObject.set(x, "setRippleCenter", js.undefined)
      
      inline def setSetSelectAnchorAttr(value: (/* attr */ String, /* value */ String) => Callback): Self = StObject.set(x, "setSelectAnchorAttr", js.Any.fromFunction2((t0: /* attr */ String, t1: /* value */ String) => (value(t0, t1)).runNow()))
      
      inline def setSetSelectAnchorAttrUndefined: Self = StObject.set(x, "setSelectAnchorAttr", js.undefined)
      
      inline def setSetSelectedIndex(value: /* index */ Double => Callback): Self = StObject.set(x, "setSelectedIndex", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
      
      inline def setSetSelectedIndexUndefined: Self = StObject.set(x, "setSelectedIndex", js.undefined)
      
      inline def setSetSelectedText(value: /* text */ String => Callback): Self = StObject.set(x, "setSelectedText", js.Any.fromFunction1((t0: /* text */ String) => value(t0).runNow()))
