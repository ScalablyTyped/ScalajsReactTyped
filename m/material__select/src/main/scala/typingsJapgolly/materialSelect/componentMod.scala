...
import typingsJapgolly.materialMenu.componentMod.MDCMenuFactory
import typingsJapgolly.materialNotchedOutline.componentMod.MDCNotchedOutlineFactory
import typingsJapgolly.materialSelect.foundationMod.MDCSelectFoundation
import typingsJapgolly.materialSelect.helperTextComponentMod.MDCSelectHelperTextFactory
import typingsJapgolly.materialSelect.iconComponentMod.MDCSelectIconFactory
...
object componentMod {
  ...
  object MDCSelect {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCSelect = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCSelect]
  }
}
