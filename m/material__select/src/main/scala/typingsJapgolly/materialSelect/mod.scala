...
object mod {
  ...
  @JSImport("@material/select", JSImport.Default)
  @js.native
  open class default ()
    extends typingsJapgolly.materialSelect.iconMod.default {
  ...
  open class MDCSelect protected ()
    extends typingsJapgolly.materialSelect.componentMod.MDCSelect {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
      foundation: typingsJapgolly.materialSelect.foundationMod.MDCSelectFoundation,
      args: Any*
    ) = this()
  }
  /* static members */
  object MDCSelect {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): typingsJapgolly.materialSelect.componentMod.MDCSelect = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.materialSelect.componentMod.MDCSelect]
  }
  ...
  open class MDCSelectFoundation ()
    extends typingsJapgolly.materialSelect.foundationMod.MDCSelectFoundation {
  ...
  open class MDCSelectHelperText protected ()
    extends typingsJapgolly.materialSelect.helperTextMod.MDCSelectHelperText {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
  ...
  open class MDCSelectHelperTextFoundation ()
    extends typingsJapgolly.materialSelect.helperTextMod.MDCSelectHelperTextFoundation {
  ...
  open class MDCSelectIcon protected ()
    extends typingsJapgolly.materialSelect.iconMod.MDCSelectIcon {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
  ...
  open class MDCSelectIconFoundation ()
    extends typingsJapgolly.materialSelect.iconMod.MDCSelectIconFoundation {
    def this(adapter: PartialMDCSelectIconAdapt) = this()
  }
