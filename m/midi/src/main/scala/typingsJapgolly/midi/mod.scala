...
import typingsJapgolly.midi.midiStrings.message
...
object mod {
  ...
  inline def createReadStream(): typingsJapgolly.node.streamMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createReadStream")().asInstanceOf[typingsJapgolly.node.streamMod.^]
  inline def createReadStream(input: Input_): typingsJapgolly.node.streamMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createReadStream")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.streamMod.^]
  
  inline def createWriteStream(): typingsJapgolly.node.streamMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createWriteStream")().asInstanceOf[typingsJapgolly.node.streamMod.^]
  inline def createWriteStream(output: Output_): typingsJapgolly.node.streamMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createWriteStream")(output.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.streamMod.^]
