...
import typingsJapgolly.mochaSugarFree.anon.Optionsasyncfalseundefine
import typingsJapgolly.mochaSugarFree.anon.OptionsasynctruefnTestCas
import typingsJapgolly.mochaSugarFree.anon.OptionsfnHookFuncundefine
import typingsJapgolly.mochaSugarFree.anon.OptionsfnSuiteFuncundefin
import typingsJapgolly.mochaSugarFree.anon.OptionstitlestringfnSuite
...
object mod extends Shortcut {
  ...
  object BDD {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(after = after.asInstanceOf[js.Any], afterEach = afterEach.asInstanceOf[js.Any], before = before.asInstanceOf[js.Any], beforeEach = beforeEach.asInstanceOf[js.Any], context = context.asInstanceOf[js.Any], describe = describe.asInstanceOf[js.Any], detectedInterface = "bdd", it = it.asInstanceOf[js.Any], run = run.toJsFn, specify = specify.asInstanceOf[js.Any], xcontext = xcontext.asInstanceOf[js.Any], xdescribe = xdescribe.asInstanceOf[js.Any], xit = xit.asInstanceOf[js.Any], xspecify = xspecify.asInstanceOf[js.Any])
  ...
  object BaseInterface {
    ...
    inline def apply(detectedInterface: bdd | tdd | qunit, run: Callback): BaseInterface = {
      val __obj = js.Dynamic.literal(detectedInterface = detectedInterface.asInstanceOf[js.Any], run = run.toJsFn)
  ...
  object QUnit {
    ...
    inline def apply(run: Callback, suite: SuiteFunction, test: TestFunction): QUnit = {
      val __obj = js.Dynamic.literal(detectedInterface = "qunit", run = run.toJsFn, suite = suite.asInstanceOf[js.Any], test = test.asInstanceOf[js.Any])
  ...
  object TDD {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(detectedInterface = "tdd", run = run.toJsFn, setup = setup.asInstanceOf[js.Any], suite = suite.asInstanceOf[js.Any], suiteSetup = suiteSetup.asInstanceOf[js.Any], suiteTeardown = suiteTeardown.asInstanceOf[js.Any], teardown = teardown.asInstanceOf[js.Any], test = test.asInstanceOf[js.Any])
