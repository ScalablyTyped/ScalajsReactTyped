package typingsJapgolly.microeventTs

import typingsJapgolly.microeventTs.eventInterfaceMod.EventInterface
import typingsJapgolly.microeventTs.eventInterfaceMod.EventInterface.HandlerInterface
