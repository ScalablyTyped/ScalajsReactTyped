...
import typingsJapgolly.materialUiLab.anon.PartialClassNameMapTreeIt
...
object treeItemTreeItemMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiLab.materialUiLabStrings.expanded
    - typingsJapgolly.materialUiLab.materialUiLabStrings.selected
    - typingsJapgolly.materialUiLab.materialUiLabStrings.group
    - typingsJapgolly.materialUiLab.materialUiLabStrings.content
    - typingsJapgolly.materialUiLab.materialUiLabStrings.iconContainer
    - typingsJapgolly.materialUiLab.materialUiLabStrings.label
  */
  trait TreeItemClassKey extends StObject
  object TreeItemClassKey {
    
    inline def content: typingsJapgolly.materialUiLab.materialUiLabStrings.content = "content".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.content]
    
    inline def expanded: typingsJapgolly.materialUiLab.materialUiLabStrings.expanded = "expanded".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.expanded]
    
    inline def group: typingsJapgolly.materialUiLab.materialUiLabStrings.group = "group".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.group]
    
    inline def iconContainer: typingsJapgolly.materialUiLab.materialUiLabStrings.iconContainer = "iconContainer".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.iconContainer]
  ...
  trait TreeItemProps extends StObject {
    ...
    /**
      ...
      */
    var collapseIcon: js.UndefOr[Node] = js.undefined
    ...
    /**
      ...
      */
    var onIconClick: js.UndefOr[MouseEventHandler[org.scalajs.dom.Element]] = js.undefined
    ...
    /**
      ...
      */
    var onLabelClick: js.UndefOr[MouseEventHandler[org.scalajs.dom.Element]] = js.undefined
  ...
  object TreeItemProps {
    ...
    extension [Self <: TreeItemProps](x: Self) {
      ...
      inline def setCollapseIcon(value: VdomNode): Self = StObject.set(x, "collapseIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setCollapseIconNull: Self = StObject.set(x, "collapseIcon", null)
      
      inline def setCollapseIconUndefined: Self = StObject.set(x, "collapseIcon", js.undefined)
      
      inline def setCollapseIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "collapseIcon", js.Array(value*))
      
      inline def setCollapseIconVdomElement(value: VdomElement): Self = StObject.set(x, "collapseIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setEndIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "endIcon", js.Array(value*))
      ...
      inline def setOnIconClick(value: ReactMouseEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onIconClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setOnLabelClick(value: ReactMouseEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onLabelClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => value(t0).runNow()))
