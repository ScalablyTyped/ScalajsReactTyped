...
import typingsJapgolly.materialUiLab.paginationUsePaginationMod.UsePaginationItem
...
object paginationPaginationMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiLab.materialUiLabStrings.ul
  */
  ...
  object PaginationClassKey {
    ...
    inline def ul: typingsJapgolly.materialUiLab.materialUiLabStrings.ul = "ul".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.ul]
  }
