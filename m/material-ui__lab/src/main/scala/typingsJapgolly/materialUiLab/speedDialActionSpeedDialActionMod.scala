...
object speedDialActionSpeedDialActionMod {
  ...
  @JSImport("@material-ui/lab/SpeedDialAction/SpeedDialAction", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.materialUiLab.materialUiLabStrings.fab
    - typingsJapgolly.materialUiLab.materialUiLabStrings.fabClosed
    - typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltip
    - typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltipClosed
    - typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltipLabel
    - typingsJapgolly.materialUiLab.materialUiLabStrings.tooltipPlacementLeft
  */
  trait SpeedDialActionClassKey extends StObject
  object SpeedDialActionClassKey {
    
    inline def fab: typingsJapgolly.materialUiLab.materialUiLabStrings.fab = "fab".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.fab]
    
    inline def fabClosed: typingsJapgolly.materialUiLab.materialUiLabStrings.fabClosed = "fabClosed".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.fabClosed]
    
    inline def staticTooltip: typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltip = "staticTooltip".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltip]
    
    inline def staticTooltipClosed: typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltipClosed = "staticTooltipClosed".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltipClosed]
    
    inline def staticTooltipLabel: typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltipLabel = "staticTooltipLabel".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.staticTooltipLabel]
    
    inline def tooltipPlacementLeft: typingsJapgolly.materialUiLab.materialUiLabStrings.tooltipPlacementLeft = "tooltipPlacementLeft".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.tooltipPlacementLeft]
  }
  ...
  trait SpeedDialActionProps extends StObject {
    ...
    /**
      ...
      */
    var FabProps: js.UndefOr[Partial[typingsJapgolly.materialUiCore.fabFabMod.FabProps[button, js.Object]]] = js.undefined
    ...
    /**
      ...
      */
    var TooltipClasses: js.UndefOr[PartialClassNameMapToolti] = js.undefined
    
    var TransitionComponent: js.UndefOr[ComponentType[TransitionPropschildrenRe]] = js.undefined
    
    var TransitionProps: js.UndefOr[typingsJapgolly.materialUiCore.transitionsTransitionMod.TransitionProps] = js.undefined
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapSpeedDFab] = js.undefined
    ...
    var title: js.UndefOr[NonNullable[Node]] = js.undefined
  ...
  object SpeedDialActionProps {
    ...
    extension [Self <: SpeedDialActionProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapSpeedDFab): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setFabProps(value: Partial[FabProps[button, js.Object]]): Self = StObject.set(x, "FabProps", value.asInstanceOf[js.Any])
      ...
      inline def setOnClose(value: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element]) => value(t0).runNow()))
      ...
      inline def setTitle(value: NonNullable[Node]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
      
      inline def setTitleUndefined: Self = StObject.set(x, "title", js.undefined)
      
      inline def setTooltipClasses(value: PartialClassNameMapToolti): Self = StObject.set(x, "TooltipClasses", value.asInstanceOf[js.Any])
