...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/lab.@material-ui/lab/TreeItem/TreeItem.TreeItemClassKey>> */
...
object PartialClassNameMapTreeIt {
  ...
  inline def apply(): PartialClassNameMapTreeIt = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialClassNameMapTreeIt]
  }
  
  extension [Self <: PartialClassNameMapTreeIt](x: Self) {
