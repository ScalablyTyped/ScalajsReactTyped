...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/lab.@material-ui/lab/SpeedDialIcon/SpeedDialIcon.SpeedDialIconClassKey>> */
...
object PartialClassNameMapSpeedDIcon {
  ...
  inline def apply(): PartialClassNameMapSpeedDIcon = {
