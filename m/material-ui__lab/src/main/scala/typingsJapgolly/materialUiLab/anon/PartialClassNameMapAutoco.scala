...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/lab.@material-ui/lab/Autocomplete/Autocomplete.AutocompleteClassKey>> */
...
object PartialClassNameMapAutoco {
  ...
  inline def apply(): PartialClassNameMapAutoco = {
  ...
  extension [Self <: PartialClassNameMapAutoco](x: Self) {
    ...
    inline def setClearIndicatorDirty(value: String): Self = StObject.set(x, "clearIndicatorDirty", value.asInstanceOf[js.Any])
    
    inline def setClearIndicatorDirtyUndefined: Self = StObject.set(x, "clearIndicatorDirty", js.undefined)
