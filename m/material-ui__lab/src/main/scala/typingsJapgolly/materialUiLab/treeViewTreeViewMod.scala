...
import typingsJapgolly.materialUiLab.anon.PartialClassNameMapTreeVi
...
object treeViewTreeViewMod {
  ...
  @JSImport("@material-ui/lab/TreeView/TreeView", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def default(props: TreeViewProps): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(props.asInstanceOf[js.Any]).asInstanceOf[Element]
  
  trait MultiSelectTreeViewProps
    extends StObject
       with TreeViewPropsBase
       with TreeViewProps {
    ...
    /**
      ...
      */
    var multiSelect: js.UndefOr[`true`] = js.undefined
  ...
  object MultiSelectTreeViewProps {
    ...
    inline def apply(): MultiSelectTreeViewProps = {
    ...
    extension [Self <: MultiSelectTreeViewProps](x: Self) {
      ...
      inline def setDefaultSelectedVarargs(value: String*): Self = StObject.set(x, "defaultSelected", js.Array(value*))
      
      inline def setMultiSelect(value: `true`): Self = StObject.set(x, "multiSelect", value.asInstanceOf[js.Any])
      
      inline def setMultiSelectUndefined: Self = StObject.set(x, "multiSelect", js.undefined)
      
      inline def setOnNodeSelect(
        value: (/* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], /* nodeIds */ js.Array[String]) => Callback
      ): Self = StObject.set(x, "onNodeSelect", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* nodeIds */ js.Array[String]) => (value(t0, t1)).runNow()))
  ...
  trait SingleSelectTreeViewProps
    ...
    /**
      ...
      * When `multiSelect` is true this takes an array of strings; when false (default) a string.
      */
    var defaultSelected: js.UndefOr[String] = js.undefined
    
    /**
      * If true `ctrl` and `shift` will trigger multiselect.
      */
    var multiSelect: js.UndefOr[`false`] = js.undefined
  ...
  object SingleSelectTreeViewProps {
    ...
    inline def apply(): SingleSelectTreeViewProps = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: SingleSelectTreeViewProps](x: Self) {
      ...
      inline def setMultiSelect(value: `false`): Self = StObject.set(x, "multiSelect", value.asInstanceOf[js.Any])
      
      inline def setMultiSelectUndefined: Self = StObject.set(x, "multiSelect", js.undefined)
      
      inline def setOnNodeSelect(
        value: (/* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], /* nodeIds */ String) => Callback
      ): Self = StObject.set(x, "onNodeSelect", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* nodeIds */ String) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.materialUiLab.treeViewTreeViewMod.SingleSelectTreeViewProps
    - typingsJapgolly.materialUiLab.treeViewTreeViewMod.MultiSelectTreeViewProps
  */
  trait TreeViewProps extends StObject
  object TreeViewProps {
    
    inline def MultiSelectTreeViewProps(): typingsJapgolly.materialUiLab.treeViewTreeViewMod.MultiSelectTreeViewProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.materialUiLab.treeViewTreeViewMod.MultiSelectTreeViewProps]
    }
    
    inline def SingleSelectTreeViewProps(): typingsJapgolly.materialUiLab.treeViewTreeViewMod.SingleSelectTreeViewProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.materialUiLab.treeViewTreeViewMod.SingleSelectTreeViewProps]
    }
  }
  ...
  trait TreeViewPropsBase extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapTreeVi] = js.undefined
    ...
    /**
      ...
      */
    var defaultCollapseIcon: js.UndefOr[Node] = js.undefined
    
    /**
      * The default icon displayed next to a end node. This is applied to all
      * tree nodes and can be overridden by the TreeItem `icon` prop.
      */
    var defaultEndIcon: js.UndefOr[Node] = js.undefined
    
    /**
      * The default icon used to expand the node.
      */
    var defaultExpandIcon: js.UndefOr[Node] = js.undefined
    ...
    /**
      ...
      */
    var defaultParentIcon: js.UndefOr[Node] = js.undefined
    ...
    var ref: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: react.react.HTMLAttributes<std.HTMLUListElement> extends {  ref :infer RefType | undefined} ? RefType : react.react.Ref<unknown> */ js.Any
      ] = js.undefined
  ...
  object TreeViewPropsBase {
    ...
    inline def apply(): TreeViewPropsBase = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: TreeViewPropsBase](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapTreeVi): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setDefaultCollapseIcon(value: VdomNode): Self = StObject.set(x, "defaultCollapseIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setDefaultCollapseIconNull: Self = StObject.set(x, "defaultCollapseIcon", null)
      
      inline def setDefaultCollapseIconUndefined: Self = StObject.set(x, "defaultCollapseIcon", js.undefined)
      
      inline def setDefaultCollapseIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "defaultCollapseIcon", js.Array(value*))
      
      inline def setDefaultCollapseIconVdomElement(value: VdomElement): Self = StObject.set(x, "defaultCollapseIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setDefaultEndIcon(value: VdomNode): Self = StObject.set(x, "defaultEndIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setDefaultEndIconNull: Self = StObject.set(x, "defaultEndIcon", null)
      
      inline def setDefaultEndIconUndefined: Self = StObject.set(x, "defaultEndIcon", js.undefined)
      
      inline def setDefaultEndIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "defaultEndIcon", js.Array(value*))
      
      inline def setDefaultEndIconVdomElement(value: VdomElement): Self = StObject.set(x, "defaultEndIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setDefaultExpandIcon(value: VdomNode): Self = StObject.set(x, "defaultExpandIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setDefaultExpandIconNull: Self = StObject.set(x, "defaultExpandIcon", null)
      
      inline def setDefaultExpandIconUndefined: Self = StObject.set(x, "defaultExpandIcon", js.undefined)
      
      inline def setDefaultExpandIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "defaultExpandIcon", js.Array(value*))
      
      inline def setDefaultExpandIconVdomElement(value: VdomElement): Self = StObject.set(x, "defaultExpandIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setDefaultExpanded(value: js.Array[String]): Self = StObject.set(x, "defaultExpanded", value.asInstanceOf[js.Any])
      
      inline def setDefaultExpandedUndefined: Self = StObject.set(x, "defaultExpanded", js.undefined)
      
      inline def setDefaultExpandedVarargs(value: String*): Self = StObject.set(x, "defaultExpanded", js.Array(value*))
      
      inline def setDefaultParentIcon(value: VdomNode): Self = StObject.set(x, "defaultParentIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setDefaultParentIconNull: Self = StObject.set(x, "defaultParentIcon", null)
      
      inline def setDefaultParentIconUndefined: Self = StObject.set(x, "defaultParentIcon", js.undefined)
      
      inline def setDefaultParentIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "defaultParentIcon", js.Array(value*))
      
      inline def setDefaultParentIconVdomElement(value: VdomElement): Self = StObject.set(x, "defaultParentIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnNodeToggle(
        value: (/* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], /* nodeIds */ js.Array[String]) => Callback
      ): Self = StObject.set(x, "onNodeToggle", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* nodeIds */ js.Array[String]) => (value(t0, t1)).runNow()))
      
      inline def setOnNodeToggleUndefined: Self = StObject.set(x, "onNodeToggle", js.undefined)
      ...
      inline def setRef(
        value: /* import warning: importer.ImportType#apply Failed type conversion: react.react.HTMLAttributes<std.HTMLUListElement> extends {  ref :infer RefType | undefined} ? RefType : react.react.Ref<unknown> */ js.Any
