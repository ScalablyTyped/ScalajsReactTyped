...
import typingsJapgolly.materialUiLab.anon.PartialClassNameMapTabPan
...
object TabPanel {
  ...
  inline def apply(value: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[TabPanelProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapTabPan): this.type = set("classes", value.asInstanceOf[js.Any])
