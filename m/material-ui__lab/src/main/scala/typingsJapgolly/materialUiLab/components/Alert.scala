...
object Alert {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapAlertC): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def icon(value: Node | `false`): this.type = set("icon", value.asInstanceOf[js.Any])
    
    inline def iconMapping(value: PartialRecordColorReactNo): this.type = set("iconMapping", value.asInstanceOf[js.Any])
    ...
    inline def severity(value: Color): this.type = set("severity", value.asInstanceOf[js.Any])
