...
object TabList {
  ...
  implicit def make(companion: TabList.type): SharedBuilder_DefaultComponentProps_1844487730 = new SharedBuilder_DefaultComponentProps_1844487730(js.Array(this.component, js.Dictionary.empty))()
