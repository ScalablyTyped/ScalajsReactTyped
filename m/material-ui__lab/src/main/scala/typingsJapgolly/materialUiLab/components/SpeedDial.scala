...
object SpeedDial {
  ...
  inline def apply(ariaLabel: String, open: Boolean): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapSpeedD): this.type = set("classes", value.asInstanceOf[js.Any])
