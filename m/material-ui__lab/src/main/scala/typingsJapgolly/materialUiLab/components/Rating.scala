...
object Rating {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapRating): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* value */ Double | Null) => (value(t0, t1)).runNow()))
    
    inline def onChangeActive(
      value: (/* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], /* value */ Double) => Callback
    ): this.type = set("onChangeActive", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* value */ Double) => (value(t0, t1)).runNow()))
