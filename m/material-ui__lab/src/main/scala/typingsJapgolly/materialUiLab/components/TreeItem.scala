...
object TreeItem {
  ...
  inline def apply(nodeId: String): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapTreeIt): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def collapseIcon(value: VdomNode): this.type = set("collapseIcon", value.rawNode.asInstanceOf[js.Any])
    
    inline def collapseIconNull: this.type = set("collapseIcon", null)
    
    inline def collapseIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("collapseIcon", js.Array(value*))
    
    inline def collapseIconVdomElement(value: VdomElement): this.type = set("collapseIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onIconClick(value: ReactMouseEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element] => Callback): this.type = set("onIconClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def onLabelClick(value: ReactMouseEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element] => Callback): this.type = set("onLabelClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[org.scalajs.dom.Element & org.scalajs.dom.Element]) => value(t0).runNow()))
