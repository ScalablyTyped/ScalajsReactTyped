...
import typingsJapgolly.materialUiLab.anon.PartialClassNameMapPagina
...
import typingsJapgolly.materialUiLab.paginationPaginationMod.PaginationRenderItemParams
...
object Pagination {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapPagina): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def shape(value: round | rounded): this.type = set("shape", value.asInstanceOf[js.Any])
