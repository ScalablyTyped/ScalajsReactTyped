...
import typingsJapgolly.materialUiLab.anon.PartialClassNameMapToggle
...
object ToggleButtonGroup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapToggle): this.type = set("classes", value.asInstanceOf[js.Any])
