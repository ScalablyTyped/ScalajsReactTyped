...
object Timeline {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def align(value: left | right | alternate): this.type = set("align", value.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def classes(value: PartialClassNameMapTimeli): this.type = set("classes", value.asInstanceOf[js.Any])
