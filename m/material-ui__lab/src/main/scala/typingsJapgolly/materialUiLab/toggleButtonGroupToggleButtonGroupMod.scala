...
object toggleButtonGroupToggleButtonGroupMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiLab.materialUiLabStrings.vertical
    - typingsJapgolly.materialUiLab.materialUiLabStrings.grouped
    - typingsJapgolly.materialUiLab.materialUiLabStrings.groupedHorizontal
    - typingsJapgolly.materialUiLab.materialUiLabStrings.groupedVertical
  */
  trait ToggleButtonGroupClassKey extends StObject
  object ToggleButtonGroupClassKey {
    
    inline def grouped: typingsJapgolly.materialUiLab.materialUiLabStrings.grouped = "grouped".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.grouped]
    
    inline def groupedHorizontal: typingsJapgolly.materialUiLab.materialUiLabStrings.groupedHorizontal = "groupedHorizontal".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.groupedHorizontal]
    
    inline def groupedVertical: typingsJapgolly.materialUiLab.materialUiLabStrings.groupedVertical = "groupedVertical".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.groupedVertical]
    ...
    inline def vertical: typingsJapgolly.materialUiLab.materialUiLabStrings.vertical = "vertical".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.vertical]
  }
