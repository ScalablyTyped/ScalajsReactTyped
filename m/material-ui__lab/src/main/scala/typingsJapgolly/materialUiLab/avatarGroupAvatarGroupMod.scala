...
import typingsJapgolly.materialUiLab.anon.PartialClassNameMapAvatar
...
object avatarGroupAvatarGroupMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiLab.materialUiLabStrings.avatar
  */
  trait AvatarGroupClassKey extends StObject
  object AvatarGroupClassKey {
    
    inline def avatar: typingsJapgolly.materialUiLab.materialUiLabStrings.avatar = "avatar".asInstanceOf[typingsJapgolly.materialUiLab.materialUiLabStrings.avatar]
