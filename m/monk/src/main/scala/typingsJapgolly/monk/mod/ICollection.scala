...
import typingsJapgolly.monk.AnonAvgObjSize
import typingsJapgolly.monk.AnonDeletedCount
import typingsJapgolly.monk.AnonEach
import typingsJapgolly.monk.AnonMsg
import typingsJapgolly.monk.AnonNIndexesWas
import typingsJapgolly.monk.AnonNModified
import typingsJapgolly.monk.monkBooleans.`true`
import typingsJapgolly.monk.monkNumbers.`-1`
import typingsJapgolly.monk.monkNumbers.`1`
import typingsJapgolly.monk.monkStrings.`ns not found`
...
class ICollection[T] () extends js.Object {
  ...
  def aggregate[U](
    stages: js.Array[_],
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ U, Unit]
  ): Unit = js.native
  @JSName("aggregate")
  ...
  def createIndex(
    ...
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ String, Unit]
  ): Unit = js.native
  ...
  def dropIndex(
    fields: TFields,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ AnonNIndexesWas, Unit]
  ): Unit = js.native
  @JSName("dropIndex")
  ...
  def dropIndexes(callback: js.Function2[/* err */ js.Error | Null, /* data */ AnonMsg, Unit]): Unit = js.native
  @JSName("dropIndexes")
  ...
  def find[U](
    query: TQuery,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ js.Array[U] with AnonEach[U], Unit]
  ): Unit = js.native
  ...
  def findOne[U](
    query: TQuery,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ js.UndefOr[U], Unit]
  ): Unit = js.native
  ...
  def remove(
    query: TQuery,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ AnonDeletedCount, Unit]
  ): Unit = js.native
  @JSName("remove")
  ...
  def stats(
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ AnonAvgObjSize, Unit]
  ): Unit = js.native
  @JSName("stats")
  ...
  def update(
    ...
    update: js.Object,
    options: js.Object,
    callback: js.Function2[/* err */ js.Error | Null, /* data */ AnonNModified, Unit]
  ): Unit = js.native
  @JSName("update")
