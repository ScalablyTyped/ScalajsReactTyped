...
import typingsJapgolly.maximMazurokGapiClientMl.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientMl.anon.Alt
import typingsJapgolly.maximMazurokGapiClientMl.anon.Fields
import typingsJapgolly.maximMazurokGapiClientMl.anon.Parent
import typingsJapgolly.maximMazurokGapiClientMl.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientMl.anon.Resource
import typingsJapgolly.maximMazurokGapiClientMl.anon.UploadType
import typingsJapgolly.maximMazurokGapiClientMl.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientMl.anon.Xgafv
