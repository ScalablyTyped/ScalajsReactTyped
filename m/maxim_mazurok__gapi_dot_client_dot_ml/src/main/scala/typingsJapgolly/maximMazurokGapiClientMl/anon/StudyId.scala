package typingsJapgolly.maximMazurokGapiClientMl.anon

import typingsJapgolly.maximMazurokGapiClientMl.gapi.client.ml.GoogleCloudMlV1Study
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait StudyId extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudMlV1Study
...
object StudyId {
  ...
  inline def apply(parent: String, resource: GoogleCloudMlV1Study): StudyId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[StudyId]
  }
  
  extension [Self <: StudyId](x: Self) {
    ...
    inline def setResource(value: GoogleCloudMlV1Study): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
