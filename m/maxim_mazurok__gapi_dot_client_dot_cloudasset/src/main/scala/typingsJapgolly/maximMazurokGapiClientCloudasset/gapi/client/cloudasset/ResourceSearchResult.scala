...
trait ResourceSearchResult extends StObject {
  ...
  /**
    * Attached resources of this resource. For example, an OSConfig Inventory is an attached resource of a Compute Instance. This field is repeated because a resource could have multiple
    * attached resources. This `attached_resources` field is not searchable. Some attributes of the attached resources are exposed in `additional_attributes` field, so as to allow users
    * to search on them.
    */
  var attachedResources: js.UndefOr[js.Array[AttachedResource]] = js.undefined
  ...
  /**
    ...
    * resource's Protobuf contains it. To search against `create_time`: * use a field query. - value in seconds since unix epoch. Example: `createTime > 1609459200` - value in date
    * string. Example: `createTime > 2021-01-01` - value in date-time string (must be quoted). Example: `createTime > "2021-01-01T00:00:00"`
    */
  var createTime: js.UndefOr[String] = js.undefined
  
  /**
    * One or more paragraphs of text description of this resource. Maximum length could be up to 1M bytes. This field is available only when the resource's Protobuf contains it. To search
  ...
  /**
    * The display name of this resource. This field is available only when the resource's Protobuf contains it. To search against the `display_name`: * use a field query. Example:
  ...
  /**
    ...
    * [CryptoKeyVersion](https://cloud.google.com/kms/docs/reference/rest/v1/projects.locations.keyRings.cryptoKeys.cryptoKeyVersions) name. This field is available only when the
    * resource's Protobuf contains it. To search against the `kms_key`: * use a field query. Example: `kmsKey:key` * use a free text query. Example: `key`
    */
  ...
  /**
    * Location can be `global`, regional like `us-east1`, or zonal like `us-west1-b`. This field is available only when the resource's Protobuf contains it. To search against the
  ...
  /**
    ...
    */
  var parentAssetType: js.UndefOr[String] = js.undefined
  ...
  /**
    ...
    */
  var parentFullResourceName: js.UndefOr[String] = js.undefined
  ...
  /**
    * A map of related resources of this resource, keyed by the relationship type. A relationship type is in the format of {SourceType}_{ACTION}_{DestType}. Example: `DISK_TO_INSTANCE`,
  ...
  /**
    * TagKey namespaced names, in the format of {ORG_ID}/{TAG_KEY_SHORT_NAME}. To search against the `tagKeys`: * use a field query. Example: - `tagKeys:"123456789/env*"` -
    * `tagKeys="123456789/env"` - `tagKeys:"env"` * use a free text query. Example: - `env`
    */
  var tagKeys: js.UndefOr[js.Array[String]] = js.undefined
  
  /**
    * TagValue IDs, in the format of tagValues/{TAG_VALUE_ID}. To search against the `tagValueIds`: * use a field query. Example: - `tagValueIds:"456"` - `tagValueIds="tagValues/456"` *
    * use a free text query. Example: - `456`
    */
  var tagValueIds: js.UndefOr[js.Array[String]] = js.undefined
  
  /**
    * TagValue namespaced names, in the format of {ORG_ID}/{TAG_KEY_SHORT_NAME}/{TAG_VALUE_SHORT_NAME}. To search against the `tagValues`: * use a field query. Example: -
    * `tagValues:"env"` - `tagValues:"env/prod"` - `tagValues:"123456789/env/prod*"` - `tagValues="123456789/env/prod"` * use a free text query. Example: - `prod`
    */
  var tagValues: js.UndefOr[js.Array[String]] = js.undefined
  ...
  /**
    ...
    * available only when the resource's Protobuf contains it. To search against `update_time`: * use a field query. - value in seconds since unix epoch. Example: `updateTime <
    * 1609459200` - value in date string. Example: `updateTime < 2021-01-01` - value in date-time string (must be quoted). Example: `updateTime < "2021-01-01T00:00:00"`
    */
  ...
  /**
    ...
    * `versioned_resources` field is not searchable. Some attributes of the resource representations are exposed in `additional_attributes` field, so as to allow users to search on them.
    */
  var versionedResources: js.UndefOr[js.Array[VersionedResource]] = js.undefined
}
object ResourceSearchResult {
  
  inline def apply(): ResourceSearchResult = {
  ...
  extension [Self <: ResourceSearchResult](x: Self) {
    ...
    inline def setAttachedResources(value: js.Array[AttachedResource]): Self = StObject.set(x, "attachedResources", value.asInstanceOf[js.Any])
    
    inline def setAttachedResourcesUndefined: Self = StObject.set(x, "attachedResources", js.undefined)
    
    inline def setAttachedResourcesVarargs(value: AttachedResource*): Self = StObject.set(x, "attachedResources", js.Array(value*))
