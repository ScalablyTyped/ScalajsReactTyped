...
import typingsJapgolly.maximMazurokGapiClientCloudasset.anon.AnalysisQueryaccessSelectorpermissions
import typingsJapgolly.maximMazurokGapiClientCloudasset.anon.AssetNames
import typingsJapgolly.maximMazurokGapiClientCloudasset.anon.AssetTypes
import typingsJapgolly.maximMazurokGapiClientCloudasset.anon.DestinationParent
import typingsJapgolly.maximMazurokGapiClientCloudasset.anon.Fields
import typingsJapgolly.maximMazurokGapiClientCloudasset.anon.OrderBy
import typingsJapgolly.maximMazurokGapiClientCloudasset.anon.Scope
import typingsJapgolly.maximMazurokGapiClientCloudasset.anon.UploadType
...
trait V1Resource extends StObject {
  ...
  /**
    ...
    */
  def analyzeIamPolicyLongrunning(request: typingsJapgolly.maximMazurokGapiClientCloudasset.anon.Resource): Request[Operation] = js.native
