...
import typingsJapgolly.maximMazurokGapiClientCloudasset.gapi.client.cloudasset.CreateFeedRequest
...
object Callback {
  ...
  inline def apply(parent: String, resource: CreateFeedRequest): Callback = {
