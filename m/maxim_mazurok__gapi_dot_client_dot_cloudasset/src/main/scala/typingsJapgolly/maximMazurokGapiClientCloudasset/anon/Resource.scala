...
import typingsJapgolly.maximMazurokGapiClientCloudasset.gapi.client.cloudasset.AnalyzeIamPolicyLongrunningRequest
...
object Resource {
  ...
  inline def apply(resource: AnalyzeIamPolicyLongrunningRequest, scope: String): Resource = {
