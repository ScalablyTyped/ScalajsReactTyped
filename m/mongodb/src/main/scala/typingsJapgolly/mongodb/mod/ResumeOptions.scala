...
trait ResumeOptions extends StObject {
  ...
  var startAtOperationTime: js.UndefOr[typingsJapgolly.bson.mod.Timestamp] = js.undefined
}
object ResumeOptions {
  ...
  extension [Self <: ResumeOptions](x: Self) {
    ...
    inline def setStartAtOperationTime(value: typingsJapgolly.bson.mod.Timestamp): Self = StObject.set(x, "startAtOperationTime", value.asInstanceOf[js.Any])
