...
import typingsJapgolly.mongodb.anon.Aws
import typingsJapgolly.mongodb.anon.Azure
import typingsJapgolly.mongodb.anon.CryptSharedLibPath
...
trait AutoEncryptionOptions extends StObject {
  ...
  var options: js.UndefOr[typingsJapgolly.mongodb.anon.Logger] = js.undefined
...
object AutoEncryptionOptions {
  ...
  extension [Self <: AutoEncryptionOptions](x: Self) {
    ...
    inline def setOptions(value: typingsJapgolly.mongodb.anon.Logger): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
