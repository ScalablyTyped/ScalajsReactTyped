...
import typingsJapgolly.mongodb.mongodbStrings.modify
...
object ChangeStreamCollModDocument {
  ...
  inline def apply(_id: ResumeToken, collectionUUID: typingsJapgolly.bson.mod.Binary): ChangeStreamCollModDocument = {
