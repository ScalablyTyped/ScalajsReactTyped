...
import typingsJapgolly.mongodb.anon.CausalConsistency
...
open class ClientSession () extends TypedEventEmitter[ClientSessionEvents] {
  ...
  /**
    ...
    */
  def advanceOperationTime(operationTime: typingsJapgolly.bson.mod.Timestamp): Unit = js.native
  ...
  var operationTime: js.UndefOr[typingsJapgolly.bson.mod.Timestamp] = js.native
