...
import typingsJapgolly.mongodb.mongodbStrings.create
...
object ChangeStreamCreateDocument {
  ...
  inline def apply(_id: ResumeToken, collectionUUID: typingsJapgolly.bson.mod.Binary): ChangeStreamCreateDocument = {
