...
import typingsJapgolly.mongodb.mongodbStrings.drop
...
object ChangeStreamDropDocument {
  ...
  inline def apply(_id: ResumeToken, collectionUUID: typingsJapgolly.bson.mod.Binary, ns: ChangeStreamNameSpace): ChangeStreamDropDocument = {
