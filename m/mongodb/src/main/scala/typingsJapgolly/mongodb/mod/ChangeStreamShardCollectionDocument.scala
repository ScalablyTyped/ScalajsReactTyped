...
import typingsJapgolly.mongodb.mongodbStrings.shardCollection
...
object ChangeStreamShardCollectionDocument {
  ...
  inline def apply(_id: ResumeToken, collectionUUID: typingsJapgolly.bson.mod.Binary): ChangeStreamShardCollectionDocument = {
