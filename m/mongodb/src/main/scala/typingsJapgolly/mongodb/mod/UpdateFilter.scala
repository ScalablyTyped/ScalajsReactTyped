...
import typingsJapgolly.mongodb.anon.And
import typingsJapgolly.mongodb.anon.Or
import typingsJapgolly.mongodb.anon.Type
import typingsJapgolly.mongodb.anon.Xor
...
trait UpdateFilter[TSchema]
  ...
  var $currentDate: js.UndefOr[
    OnlyFieldsOfType[TSchema, js.Date | typingsJapgolly.bson.mod.Timestamp, `true` | Type]
  ] = js.undefined
...
object UpdateFilter {
  ...
  extension [Self <: UpdateFilter[?], TSchema](x: Self & UpdateFilter[TSchema]) {
    ...
    inline def set$currentDate(value: OnlyFieldsOfType[TSchema, js.Date | typingsJapgolly.bson.mod.Timestamp, `true` | Type]): Self = StObject.set(x, "$currentDate", value.asInstanceOf[js.Any])
