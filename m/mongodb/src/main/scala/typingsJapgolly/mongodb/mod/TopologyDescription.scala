...
open class TopologyDescription protected () extends StObject {
  ...
  def this(
    ...
    serverDescriptions: js.UndefOr[(typingsJapgolly.std.Map[String, ServerDescription]) | Null],
  ...
  var servers: typingsJapgolly.std.Map[String, ServerDescription] = js.native
