...
import typingsJapgolly.mongodb.mongodbStrings.createIndexes
...
object ChangeStreamCreateIndexDocument {
  ...
  inline def apply(_id: ResumeToken, collectionUUID: typingsJapgolly.bson.mod.Binary): ChangeStreamCreateIndexDocument = {
