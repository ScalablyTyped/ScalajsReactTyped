...
import typingsJapgolly.mongodb.mongodbStrings.dropDatabase
...
trait ChangeStreamDropDatabaseDocument
  ...
  var ns: typingsJapgolly.mongodb.anon.Db
...
object ChangeStreamDropDatabaseDocument {
  ...
  inline def apply(_id: ResumeToken, ns: typingsJapgolly.mongodb.anon.Db): ChangeStreamDropDatabaseDocument = {
  ...
  extension [Self <: ChangeStreamDropDatabaseDocument](x: Self) {
    ...
    inline def setNs(value: typingsJapgolly.mongodb.anon.Db): Self = StObject.set(x, "ns", value.asInstanceOf[js.Any])
