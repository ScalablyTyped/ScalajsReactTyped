...
/**
  ...
  */
class ObjectId ()
  extends typingsJapgolly.bson.mod.ObjectId {
  def this(id: String) = this()
  def this(id: scala.Double) = this()
  def this(id: typingsJapgolly.bson.mod.ObjectId) = this()
}
...
object ObjectId extends js.Object {
  ...
  /**
    ...
    */
  def createFromHexString(hexString: String): typingsJapgolly.bson.mod.ObjectId = js.native
  /**
    * Creates an ObjectId from a second based number, with the rest of the ObjectId zeroed out. Used for comparisons or sorting the ObjectId.
    * @param {number} time an integer number representing a number of seconds.
    * @return {ObjectId} return the created ObjectId
    */
  def createFromTime(time: scala.Double): typingsJapgolly.bson.mod.ObjectId = js.native
  /**
  ...
  def isValid(id: typingsJapgolly.bson.mod.ObjectId): Boolean = js.native
}
