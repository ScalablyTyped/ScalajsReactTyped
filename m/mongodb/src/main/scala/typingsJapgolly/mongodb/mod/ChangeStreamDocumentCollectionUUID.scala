...
trait ChangeStreamDocumentCollectionUUID extends StObject {
  ...
  /**
    ...
    */
  var collectionUUID: typingsJapgolly.bson.mod.Binary
}
object ChangeStreamDocumentCollectionUUID {
  
  inline def apply(collectionUUID: typingsJapgolly.bson.mod.Binary): ChangeStreamDocumentCollectionUUID = {
  ...
  extension [Self <: ChangeStreamDocumentCollectionUUID](x: Self) {
    ...
    inline def setCollectionUUID(value: typingsJapgolly.bson.mod.Binary): Self = StObject.set(x, "collectionUUID", value.asInstanceOf[js.Any])
  }
}
