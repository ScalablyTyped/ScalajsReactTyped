...
trait UpdateOneModel[TSchema /* <: Document */] extends StObject {
...
object UpdateOneModel {
  ...
  inline def apply[TSchema /* <: Document */](filter: Filter[TSchema], update: UpdateFilter[TSchema] | js.Array[UpdateFilter[TSchema]]): UpdateOneModel[TSchema] = {
    val __obj = js.Dynamic.literal(filter = filter.asInstanceOf[js.Any], update = update.asInstanceOf[js.Any])
    __obj.asInstanceOf[UpdateOneModel[TSchema]]
  }
  
  extension [Self <: UpdateOneModel[?], TSchema /* <: Document */](x: Self & UpdateOneModel[TSchema]) {
