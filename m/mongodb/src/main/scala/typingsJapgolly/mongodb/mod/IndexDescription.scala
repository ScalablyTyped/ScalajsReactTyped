...
trait IndexDescription extends StObject {
  ...
  var key: StringDictionary[IndexDirection] | (typingsJapgolly.std.Map[String, IndexDirection])
...
object IndexDescription {
  ...
  inline def apply(key: StringDictionary[IndexDirection] | (typingsJapgolly.std.Map[String, IndexDirection])): IndexDescription = {
  ...
  extension [Self <: IndexDescription](x: Self) {
    ...
    inline def setKey(value: StringDictionary[IndexDirection] | (typingsJapgolly.std.Map[String, IndexDirection])): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
