package typingsJapgolly.markdownItContainer

import typingsJapgolly.markdownIt.libMod.MarkdownIt
import typingsJapgolly.markdownItContainer.mod.markdownItContainer.ContainerOpts
    ...
    trait ContainerOpts extends StObject {
      ...
      var render: js.UndefOr[
            js.Function5[
              ...
              /* options */ Any, 
              /* env */ Any, 
              /* self */ typingsJapgolly.markdownIt.libRendererMod.^, 
              String
            ]
          ] = js.undefined
    ...
    object ContainerOpts {
      ...
      extension [Self <: ContainerOpts](x: Self) {
        ...
        inline def setRender(
          value: (/* tokens */ js.Array[typingsJapgolly.markdownIt.libTokenMod.^], /* index */ Double, /* options */ Any, /* env */ Any, /* self */ typingsJapgolly.markdownIt.libRendererMod.^) => String
