...
import typingsJapgolly.maximMazurokGapiClientFcm.gapi.client.fcm.SendMessageRequest
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: SendMessageRequest
  ...
  object Accesstoken {
    ...
    inline def apply(parent: String, resource: SendMessageRequest): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: SendMessageRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
