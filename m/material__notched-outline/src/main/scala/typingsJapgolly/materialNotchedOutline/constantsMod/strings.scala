...
import typingsJapgolly.materialNotchedOutline.materialNotchedOutlineStrings.`Dotmdc-notched-outline__idle`
import typingsJapgolly.materialNotchedOutline.materialNotchedOutlineStrings.`Dotmdc-notched-outline__path`
