package typingsJapgolly.materialNotchedOutline.constantsMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.materialBase.foundationMod.MDCStrings
import typingsJapgolly.materialNotchedOutline.materialNotchedOutlineStrings.`mdc-notched-outline--notched`
