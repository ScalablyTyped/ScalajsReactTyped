...
import typingsJapgolly.materialIconToggle.materialIconToggleStrings.`mdc-icon-toggle--disabled`
import typingsJapgolly.materialIconToggle.materialIconToggleStrings.`mdc-icon-toggle`
