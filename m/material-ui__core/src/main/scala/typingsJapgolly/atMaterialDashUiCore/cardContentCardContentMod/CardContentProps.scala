package typingsJapgolly.atMaterialDashUiCore.cardContentCardContentMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapCardContentClassKey
