...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Chip.ChipProps> */
trait PartialChipProps extends js.Object {
...
object PartialChipProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PartialChipProps]
  }
}
