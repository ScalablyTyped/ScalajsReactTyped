package typingsJapgolly.atMaterialDashUiCore.formControlLabelFormControlLabelMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapFormControlLabelClassKey
...
object FormControlLabelProps {
  ...
  def apply(
    ...
    onChange: (/* event */ ReactEventFrom[js.Object with org.scalajs.dom.raw.Element], /* checked */ Boolean) => Callback = null,
