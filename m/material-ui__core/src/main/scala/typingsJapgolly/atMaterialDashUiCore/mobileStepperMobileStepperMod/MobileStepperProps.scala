package typingsJapgolly.atMaterialDashUiCore.mobileStepperMobileStepperMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapMobileStepperClassKey
import typingsJapgolly.atMaterialDashUiCore.PartialLinearProgressProps
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.dots
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.progress
...
object MobileStepperProps {
  @scala.inline
  def apply(
    backButton: VdomElement,
    nextButton: VdomElement,
    steps: Double,
    ...
    if (backButton != null) __obj.updateDynamic("backButton")(backButton.rawElement.asInstanceOf[js.Any])
