...
object Anon_FocusVisibleCheckTime {
  @scala.inline
  def apply(focusVisibleCheckTime: Double, focusVisibleMaxCheckTimes: Double, focusVisibleTimeout: js.Any): Anon_FocusVisibleCheckTime = {
    ...
    __obj.asInstanceOf[Anon_FocusVisibleCheckTime]
  }
}
