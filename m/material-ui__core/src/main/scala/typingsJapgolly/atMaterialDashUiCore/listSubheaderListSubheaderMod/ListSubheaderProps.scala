package typingsJapgolly.atMaterialDashUiCore.listSubheaderListSubheaderMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapListSubheaderClassKey
...
trait ListSubheaderProps extends js.Object {
  ...
  var color: js.UndefOr[
    typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.default | primary | inherit
  ] = js.undefined
  var component: js.UndefOr[ReactType[ListSubheaderProps]] = js.undefined
...
object ListSubheaderProps {
  ...
  def apply(
    ...
    color: typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.default | primary | inherit = null,
