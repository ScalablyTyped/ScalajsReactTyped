...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/ExpansionPanel.ExpansionPanelProps> */
trait PartialExpansionPanelProps extends js.Object {
  var CollapseProps: js.UndefOr[PartialCollapseProps] = js.undefined
  ...
  var classes: js.UndefOr[PartialClassNameMapExpansionPanelClassKey] = js.undefined
  ...
  var onChange: js.UndefOr[
    js.Function2[/* event */ ReactEventFrom[js.Object with Element], /* expanded */ Boolean, Unit]
  ] = js.undefined
...
object PartialExpansionPanelProps {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[PartialExpansionPanelProps]
  }
}
