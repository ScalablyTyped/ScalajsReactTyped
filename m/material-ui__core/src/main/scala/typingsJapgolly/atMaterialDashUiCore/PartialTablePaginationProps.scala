...
import typingsJapgolly.atMaterialDashUiCore.tablePaginationTablePaginationMod.LabelDisplayedRowsArgs
import typingsJapgolly.atMaterialDashUiCore.tablePaginationTablePaginationMod.TablePaginationBaseProps
...
trait PartialTablePaginationProps extends js.Object {
  var ActionsComponent: js.UndefOr[ReactType[TablePaginationActionsProps]] = js.undefined
  ...
  var labelDisplayedRows: js.UndefOr[js.Function1[/* paginationInfo */ LabelDisplayedRowsArgs, Node]] = js.undefined
  var labelRowsPerPage: js.UndefOr[Node] = js.undefined
...
object PartialTablePaginationProps {
  ...
  def apply(
    ...
    labelDisplayedRows: /* paginationInfo */ LabelDisplayedRowsArgs => CallbackTo[Node] = null,
    labelRowsPerPage: VdomNode = null,
    lang: String = null,
    ...
    onChangePage: (/* event */ ReactMouseEventFrom[HTMLButtonElement] | Null, /* page */ Double) => Callback = null,
    onChangeRowsPerPage: ReactEventFrom[(HTMLTextAreaElement | HTMLInputElement) with Element] => Callback = null,
    ...
    if (labelDisplayedRows != null) __obj.updateDynamic("labelDisplayedRows")(js.Any.fromFunction1((t0: /* paginationInfo */ typingsJapgolly.atMaterialDashUiCore.tablePaginationTablePaginationMod.LabelDisplayedRowsArgs) => labelDisplayedRows(t0).runNow()))
    if (labelRowsPerPage != null) __obj.updateDynamic("labelRowsPerPage")(labelRowsPerPage.rawNode.asInstanceOf[js.Any])
    ...
    if (onChangePage != null) __obj.updateDynamic("onChangePage")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLButtonElement] | scala.Null, t1: /* page */ scala.Double) => onChangePage(t0, t1).runNow()))
    if (onChangeRowsPerPage != null) __obj.updateDynamic("onChangeRowsPerPage")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[
  (org.scalajs.dom.raw.HTMLTextAreaElement | org.scalajs.dom.raw.HTMLInputElement) with org.scalajs.dom.raw.Element]) => onChangeRowsPerPage(t0).runNow()))
