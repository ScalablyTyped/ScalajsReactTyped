package typingsJapgolly.atMaterialDashUiCore.checkboxCheckboxMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapCheckboxClassKey
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.primary
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.secondary
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/internal/SwitchBase.SwitchBaseProps, @material-ui/core.@material-ui/core/Checkbox/Checkbox.CheckboxClassKey, 'checkedIcon' | 'color' | 'icon'> */
trait CheckboxProps extends js.Object {
  var TouchRippleProps: js.UndefOr[
    Partial[typingsJapgolly.atMaterialDashUiCore.buttonBaseTouchRippleMod.TouchRippleProps]
  ] = js.undefined
  ...
  var buttonRef: js.UndefOr[Ref | RefHandle[_]] = js.undefined
  ...
  var color: js.UndefOr[
    primary | secondary | typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.default
  ] = js.undefined
...
object CheckboxProps {
  ...
  def apply(
    ...
    color: primary | secondary | typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.default = null,
    ...
    indeterminateIcon: VdomNode = null,
    inlist: js.Any = null,
    ...
    onChange: (/* event */ ReactEventFrom[HTMLInputElement], /* checked */ Boolean) => Callback = null,
    ...
    if (indeterminateIcon != null) __obj.updateDynamic("indeterminateIcon")(indeterminateIcon.rawNode.asInstanceOf[js.Any])
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement], t1: /* checked */ scala.Boolean) => onChange(t0, t1).runNow()))
