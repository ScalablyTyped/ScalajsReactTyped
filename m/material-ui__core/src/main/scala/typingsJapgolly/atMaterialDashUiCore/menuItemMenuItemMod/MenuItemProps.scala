package typingsJapgolly.atMaterialDashUiCore.menuItemMenuItemMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapMenuItemClassKey
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.`additions text`
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.`flex-start`
