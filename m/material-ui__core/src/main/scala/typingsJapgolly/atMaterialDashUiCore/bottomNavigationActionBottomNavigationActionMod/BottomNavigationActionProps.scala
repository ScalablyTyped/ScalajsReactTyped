package typingsJapgolly.atMaterialDashUiCore.bottomNavigationActionBottomNavigationActionMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapBottomNavigationActionClassKey
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/ButtonBase.ButtonBaseProps, @material-ui/core.@material-ui/core/BottomNavigationAction/BottomNavigationAction.BottomNavigationActionClassKey, 'onChange'> */
trait BottomNavigationActionProps extends js.Object {
  ...
  var onChange: js.UndefOr[
    js.Function2[
      /* event */ ReactEventFrom[js.Object with org.scalajs.dom.raw.Element], 
      /* value */ js.Any, 
      Unit
    ]
  ] = js.undefined
  var onClick: js.UndefOr[ReactEventHandler[_]] = js.undefined
