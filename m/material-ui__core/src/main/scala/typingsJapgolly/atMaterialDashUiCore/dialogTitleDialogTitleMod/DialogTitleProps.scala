package typingsJapgolly.atMaterialDashUiCore.dialogTitleDialogTitleMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapDialogTitleClassKey
