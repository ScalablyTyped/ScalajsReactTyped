...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.regular
...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Toolbar.ToolbarProps> */
trait PartialToolbarProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapToolbarClassKey] = js.undefined
...
object PartialToolbarProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PartialToolbarProps]
  }
}
