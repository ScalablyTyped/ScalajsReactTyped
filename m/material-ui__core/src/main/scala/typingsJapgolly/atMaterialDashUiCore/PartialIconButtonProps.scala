...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/IconButton.IconButtonProps> */
trait PartialIconButtonProps extends js.Object {
...
object PartialIconButtonProps {
  ...
  def apply(
    ...
    __obj.asInstanceOf[PartialIconButtonProps]
  }
}
