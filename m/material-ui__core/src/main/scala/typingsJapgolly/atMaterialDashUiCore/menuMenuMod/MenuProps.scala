package typingsJapgolly.atMaterialDashUiCore.menuMenuMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialBackdropProps
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapMenuClassKey
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapModalClassKey
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapPopoverClassKey
import typingsJapgolly.atMaterialDashUiCore.PartialMenuListProps
import typingsJapgolly.atMaterialDashUiCore.PartialPaperProps
...
import typingsJapgolly.atMaterialDashUiCore.popoverPopoverMod.PopoverActions
import typingsJapgolly.atMaterialDashUiCore.popoverPopoverMod.PopoverOrigin
import typingsJapgolly.atMaterialDashUiCore.popoverPopoverMod.PopoverPosition
import typingsJapgolly.atMaterialDashUiCore.popoverPopoverMod.PopoverReference
...
object MenuProps {
  ...
  def apply(
    ...
    if (action != null) __obj.updateDynamic("action")(js.Any.fromFunction1((t0: /* actions */ typingsJapgolly.atMaterialDashUiCore.popoverPopoverMod.PopoverActions) => action(t0).runNow()))
