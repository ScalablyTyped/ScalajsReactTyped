...
trait PartialBottomNavigationActionProps extends js.Object {
...
object PartialBottomNavigationActionProps {
  @scala.inline
  def apply(
    ...
    value: js.Any = null,
    vocab: String = null
  ): PartialBottomNavigationActionProps = {
    ...
    __obj.asInstanceOf[PartialBottomNavigationActionProps]
  }
}
