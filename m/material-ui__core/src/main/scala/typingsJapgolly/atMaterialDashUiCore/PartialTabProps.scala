...
trait PartialTabProps extends js.Object {
  ...
  var onChange: js.UndefOr[
    js.Function2[
      /* event */ ReactEventFrom[Anon_Checked with org.scalajs.dom.raw.Element], 
      /* value */ js.Any, 
      Unit
    ]
  ] = js.undefined
...
object PartialTabProps {
  ...
  def apply(
    ...
    onChange: (/* event */ ReactEventFrom[Anon_Checked with org.scalajs.dom.raw.Element], /* value */ js.Any) => Callback = null,
  ...
  typingsJapgolly.atMaterialDashUiCore.Anon_Checked with org.scalajs.dom.raw.Element], t1: /* value */ js.Any) => onChange(t0, t1).runNow()))
