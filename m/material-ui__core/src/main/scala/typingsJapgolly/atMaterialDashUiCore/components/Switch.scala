...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapSwitchClassKey
...
object Switch {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SwitchProps, typingsJapgolly.atMaterialDashUiCore.switchMod.default, Unit, SwitchProps] = {
