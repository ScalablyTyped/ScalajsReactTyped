...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapTableSortLabelClassKey
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.asc
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.desc
...
import typingsJapgolly.atMaterialDashUiCore.tableSortLabelMod.default
...
object TableSortLabel {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TableSortLabelProps, default, Unit, TableSortLabelProps] = {
