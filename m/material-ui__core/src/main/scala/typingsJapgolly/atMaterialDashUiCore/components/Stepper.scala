...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapStepperClasskey
...
import typingsJapgolly.atMaterialDashUiCore.stepperMod.default
...
object Stepper {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[StepperProps, default, Unit, StepperProps] = {
