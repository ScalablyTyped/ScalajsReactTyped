...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapCardActionAreaClassKey
...
import typingsJapgolly.atMaterialDashUiCore.cardActionAreaCardActionAreaMod.CardActionAreaProps
import typingsJapgolly.atMaterialDashUiCore.cardActionAreaMod.default
...
object CardActionArea {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CardActionAreaProps, default, Unit, CardActionAreaProps] = {
  ...
  typingsJapgolly.atMaterialDashUiCore.cardActionAreaCardActionAreaMod.CardActionAreaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.cardActionAreaMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.cardActionAreaMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.cardActionAreaCardActionAreaMod.CardActionAreaProps])(children: _*)
  }
}
