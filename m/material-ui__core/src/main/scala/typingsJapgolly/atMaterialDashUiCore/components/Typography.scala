...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.textPrimary
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.textSecondary
...
import typingsJapgolly.atMaterialDashUiCore.typographyMod.default
...
object Typography {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TypographyProps, default, Unit, TypographyProps] = {
