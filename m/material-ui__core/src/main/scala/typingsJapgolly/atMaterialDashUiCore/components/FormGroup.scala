...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapFormGroupClassKey
...
import typingsJapgolly.atMaterialDashUiCore.formGroupMod.default
...
object FormGroup {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FormGroupProps, default, Unit, FormGroupProps] = {
