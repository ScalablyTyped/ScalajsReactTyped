...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapFormLabelClassKey
...
import typingsJapgolly.atMaterialDashUiCore.formLabelFormLabelMod.FormLabelBaseProps
import typingsJapgolly.atMaterialDashUiCore.formLabelFormLabelMod.FormLabelProps
import typingsJapgolly.atMaterialDashUiCore.formLabelMod.default
...
object FormLabel {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FormLabelProps, default, Unit, FormLabelProps] = {
  ...
  typingsJapgolly.atMaterialDashUiCore.formLabelFormLabelMod.FormLabelProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.formLabelMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.formLabelMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.formLabelFormLabelMod.FormLabelProps])(children: _*)
  }
}
