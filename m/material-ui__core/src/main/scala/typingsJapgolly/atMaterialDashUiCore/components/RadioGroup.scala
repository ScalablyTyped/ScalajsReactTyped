...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapRadioGroupClassKey
...
import typingsJapgolly.atMaterialDashUiCore.radioGroupMod.default
import typingsJapgolly.atMaterialDashUiCore.radioGroupRadioGroupMod.RadioGroupProps
...
object RadioGroup {
  def apply(
    ...
    onChange: (/* event */ ReactEventFrom[js.Object with Element], /* value */ String) => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RadioGroupProps, default, Unit, RadioGroupProps] = {
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element], t1: /* value */ java.lang.String) => onChange(t0, t1).runNow()))
  ...
  typingsJapgolly.atMaterialDashUiCore.radioGroupRadioGroupMod.RadioGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.radioGroupMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.radioGroupMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.radioGroupRadioGroupMod.RadioGroupProps])(children: _*)
  }
}
