...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapChipClassKey
...
object Chip {
  def apply(
    ...
    variant: default | outlined = null,
    vocab: String = null,
    key: js.UndefOr[Key] = js.undefined,
    overrides: StringDictionary[js.Any] = null
  )(
    children: ChildArg*
  ): UnmountedWithRoot[ChipProps, typingsJapgolly.atMaterialDashUiCore.chipMod.default, Unit, ChipProps] = {
    ...
    if (deleteIcon != null) __obj.updateDynamic("deleteIcon")(deleteIcon.rawElement.asInstanceOf[js.Any])
    ...
    if (onDelete != null) __obj.updateDynamic("onDelete")(js.Any.fromFunction1((t0: js.Any) => onDelete(t0).runNow()))
  ...
  typingsJapgolly.atMaterialDashUiCore.chipChipMod.ChipProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.chipMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.chipMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.chipChipMod.ChipProps])(children: _*)
  }
}
