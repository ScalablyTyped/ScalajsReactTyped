...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapSwitchBaseClassKey
...
import typingsJapgolly.atMaterialDashUiCore.internalSwitchBaseMod.default
