...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapLinkClassKey
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapTypographyClassKey
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreMod.PropTypes.Alignment
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.always
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.hover
...
import typingsJapgolly.atMaterialDashUiCore.linkLinkMod.LinkProps
import typingsJapgolly.atMaterialDashUiCore.linkMod.default
import typingsJapgolly.atMaterialDashUiCore.typeinStylestring
import typingsJapgolly.atMaterialDashUiCore.typographyTypographyMod.Style
...
object Link {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LinkProps, default, Unit, LinkProps] = {
