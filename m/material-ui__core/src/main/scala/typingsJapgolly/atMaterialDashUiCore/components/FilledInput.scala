...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapFilledInputClassKey
...
import typingsJapgolly.atMaterialDashUiCore.filledInputFilledInputMod.FilledInputProps
import typingsJapgolly.atMaterialDashUiCore.filledInputMod.default
...
object FilledInput {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FilledInputProps, default, Unit, FilledInputProps] = {
  ...
  typingsJapgolly.atMaterialDashUiCore.filledInputFilledInputMod.FilledInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.filledInputMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.filledInputMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.filledInputFilledInputMod.FilledInputProps])(children: _*)
  }
}
