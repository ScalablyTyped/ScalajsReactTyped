...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapStepContentClasskey
...
import typingsJapgolly.atMaterialDashUiCore.stepContentMod.default
import typingsJapgolly.atMaterialDashUiCore.stepContentStepContentMod.StepContentProps
import typingsJapgolly.atMaterialDashUiCore.stepperStepperMod.Orientation
...
object StepContent {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[StepContentProps, default, Unit, StepContentProps] = {
  ...
  typingsJapgolly.atMaterialDashUiCore.stepContentStepContentMod.StepContentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.stepContentMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.stepContentMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.stepContentStepContentMod.StepContentProps])(children: _*)
  }
}
