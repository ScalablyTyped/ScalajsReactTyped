...
import typingsJapgolly.atMaterialDashUiCore.inputBaseTextareaMod.TextareaProps
import typingsJapgolly.atMaterialDashUiCore.inputBaseTextareaMod.default
...
object Textarea {
  ...
  typingsJapgolly.atMaterialDashUiCore.inputBaseTextareaMod.TextareaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.inputBaseTextareaMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.inputBaseTextareaMod.TextareaProps])(children: _*)
  }
