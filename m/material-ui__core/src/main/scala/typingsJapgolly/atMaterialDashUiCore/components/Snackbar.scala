...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapSnackbarClassKey
import typingsJapgolly.atMaterialDashUiCore.PartialClickAwayListenerProps
import typingsJapgolly.atMaterialDashUiCore.PartialSnackbarContentProps
...
import typingsJapgolly.atMaterialDashUiCore.snackbarMod.default
import typingsJapgolly.atMaterialDashUiCore.snackbarSnackbarMod.SnackbarOrigin
...
object Snackbar {
  def apply(
    ...
    onClose: (/* event */ ReactEventFrom[Element], /* reason */ String) => Callback = null,
    ...
    if (onClose != null) __obj.updateDynamic("onClose")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.Element], t1: /* reason */ java.lang.String) => onClose(t0, t1).runNow()))
  ...
  typingsJapgolly.atMaterialDashUiCore.snackbarSnackbarMod.SnackbarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.snackbarMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.snackbarMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.snackbarSnackbarMod.SnackbarProps])(children: _*)
  }
}
