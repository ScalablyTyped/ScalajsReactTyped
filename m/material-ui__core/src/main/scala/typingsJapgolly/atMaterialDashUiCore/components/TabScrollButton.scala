...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapTabScrollButtonClassKey
...
import typingsJapgolly.atMaterialDashUiCore.tabsTabScrollButtonMod.TabScrollButtonProps
import typingsJapgolly.atMaterialDashUiCore.tabsTabScrollButtonMod.default
...
object TabScrollButton {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabScrollButtonProps, default, Unit, TabScrollButtonProps] = {
  ...
  typingsJapgolly.atMaterialDashUiCore.tabsTabScrollButtonMod.TabScrollButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.tabsTabScrollButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.tabsTabScrollButtonMod.TabScrollButtonProps])(children: _*)
  }
