...
object TablePagination {
  def apply(
    ...
    page: Double,
    rowsPerPage: Double,
    onChangePage: (ReactMouseEventFrom[HTMLButtonElement], Double) => Callback,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TablePaginationProps, default, Unit, TablePaginationProps] = {
    val __obj = js.Dynamic.literal(count = count.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], rowsPerPage = rowsPerPage.asInstanceOf[js.Any])
      ...
      __obj.updateDynamic("onChangePage")(js.Any.fromFunction2((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLButtonElement], t1: scala.Double) => onChangePage(t0, t1).runNow()))
  ...
  typingsJapgolly.atMaterialDashUiCore.tablePaginationTablePaginationMod.TablePaginationProps, 
  ...
  typingsJapgolly.atMaterialDashUiCore.tablePaginationMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.tablePaginationMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.tablePaginationTablePaginationMod.TablePaginationProps])(children: _*)
  }
}
