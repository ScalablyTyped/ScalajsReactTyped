...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapDialogContentClassKey
...
import typingsJapgolly.atMaterialDashUiCore.dialogContentMod.default
