...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapFabClassKey
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.extended
...
import typingsJapgolly.atMaterialDashUiCore.fabFabMod.FabProps
import typingsJapgolly.atMaterialDashUiCore.fabMod.default
...
object Fab {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FabProps, default, Unit, FabProps] = {
