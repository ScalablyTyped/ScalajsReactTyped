...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapTableHeadClassKey
...
import typingsJapgolly.atMaterialDashUiCore.tableHeadMod.default
import typingsJapgolly.atMaterialDashUiCore.tableHeadTableHeadMod.TableHeadBaseProps
import typingsJapgolly.atMaterialDashUiCore.tableHeadTableHeadMod.TableHeadProps
...
object TableHead {
  def apply(
    ...
    color: String = null,
    component: ReactType[TableHeadBaseProps] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TableHeadProps, default, Unit, TableHeadProps] = {
  ...
  typingsJapgolly.atMaterialDashUiCore.tableHeadTableHeadMod.TableHeadProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.tableHeadMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.tableHeadMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.tableHeadTableHeadMod.TableHeadProps])(children: _*)
  }
}
