...
import typingsJapgolly.atMaterialDashUiCore.swipeableDrawerMod.default
import typingsJapgolly.atMaterialDashUiCore.swipeableDrawerSwipeableDrawerMod.SwipeableDrawerProps
