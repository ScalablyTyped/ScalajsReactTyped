...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapExpansionPanelClassKey
import typingsJapgolly.atMaterialDashUiCore.PartialCollapseProps
...
import typingsJapgolly.atMaterialDashUiCore.expansionPanelMod.default
...
object ExpansionPanel {
  def apply(
    ...
    onChange: (/* event */ ReactEventFrom[js.Object with Element], /* expanded */ Boolean) => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ExpansionPanelProps, default, Unit, ExpansionPanelProps] = {
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element], t1: /* expanded */ scala.Boolean) => onChange(t0, t1).runNow()))
  ...
  typingsJapgolly.atMaterialDashUiCore.expansionPanelExpansionPanelMod.ExpansionPanelProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.expansionPanelMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.expansionPanelMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.expansionPanelExpansionPanelMod.ExpansionPanelProps])(children: _*)
  }
}
