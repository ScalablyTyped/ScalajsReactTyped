...
import typingsJapgolly.atMaterialDashUiCore.zoomMod.default
import typingsJapgolly.atMaterialDashUiCore.zoomZoomMod.ZoomProps
...
object Zoom {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ZoomProps, default, Unit, ZoomProps] = {
