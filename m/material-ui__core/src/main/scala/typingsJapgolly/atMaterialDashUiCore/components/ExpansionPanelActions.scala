...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapExpansionPanelActionsClassKey
...
import typingsJapgolly.atMaterialDashUiCore.expansionPanelActionsMod.default
