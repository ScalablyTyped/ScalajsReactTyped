...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapInputBaseClassKey
...
import typingsJapgolly.atMaterialDashUiCore.inputBaseInputBaseMod.InputBaseProps
import typingsJapgolly.atMaterialDashUiCore.inputBaseMod.default
...
object InputBase {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputBaseProps, default, Unit, InputBaseProps] = {
  ...
  typingsJapgolly.atMaterialDashUiCore.inputBaseInputBaseMod.InputBaseProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.inputBaseMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.inputBaseMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.inputBaseInputBaseMod.InputBaseProps])(children: _*)
  }
}
