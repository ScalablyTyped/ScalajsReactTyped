...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapStepLabelClasskey
...
import typingsJapgolly.atMaterialDashUiCore.stepButtonStepButtonMod.StepButtonIcon
import typingsJapgolly.atMaterialDashUiCore.stepLabelMod.default
...
object StepLabel {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[StepLabelProps, default, Unit, StepLabelProps] = {
  ...
  typingsJapgolly.atMaterialDashUiCore.stepLabelStepLabelMod.StepLabelProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atMaterialDashUiCore.stepLabelMod.default](js.constructorOf[typingsJapgolly.atMaterialDashUiCore.stepLabelMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.atMaterialDashUiCore.stepLabelStepLabelMod.StepLabelProps])(children: _*)
  }
}
