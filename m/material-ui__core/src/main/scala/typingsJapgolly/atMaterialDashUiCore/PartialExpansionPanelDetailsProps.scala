...
trait PartialExpansionPanelDetailsProps extends js.Object {
...
object PartialExpansionPanelDetailsProps {
  @scala.inline
  def apply(
    about: String = null,
    ...
    vocab: String = null
  ): PartialExpansionPanelDetailsProps = {
    ...
    __obj.asInstanceOf[PartialExpansionPanelDetailsProps]
  }
}
