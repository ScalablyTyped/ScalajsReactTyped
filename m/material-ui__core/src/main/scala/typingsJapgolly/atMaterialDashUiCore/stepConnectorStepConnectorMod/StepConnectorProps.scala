package typingsJapgolly.atMaterialDashUiCore.stepConnectorStepConnectorMod
...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapStepConnectorClasskey
...
/* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/StepConnector/StepConnector.StepConnectorClasskey, never> */
trait StepConnectorProps extends js.Object {
  ...
  var classes: js.UndefOr[PartialClassNameMapStepConnectorClasskey] = js.undefined
