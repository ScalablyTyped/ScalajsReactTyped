...
import typingsJapgolly.atMaterialDashUiCore.PartialClassNameMapTabsClassKey
import typingsJapgolly.atMaterialDashUiCore.PartialTabIndicatorProps
...
import typingsJapgolly.atMaterialDashUiCore.atMaterialDashUiCoreStrings.scrollable
...
trait TabsProps extends js.Object {
  ...
  var onChange: js.UndefOr[
    js.Function2[/* event */ ReactEventFrom[js.Object with Element], /* value */ js.Any, Unit]
  ] = js.undefined
...
object TabsProps {
  ...
  def apply(
    ...
    action: /* actions */ TabsActions => Callback = null,
    ...
    onChange: (/* event */ ReactEventFrom[js.Object with Element], /* value */ js.Any) => Callback = null,
    ...
    if (action != null) __obj.updateDynamic("action")(js.Any.fromFunction1((t0: /* actions */ typingsJapgolly.atMaterialDashUiCore.tabsTabsMod.TabsActions) => action(t0).runNow()))
