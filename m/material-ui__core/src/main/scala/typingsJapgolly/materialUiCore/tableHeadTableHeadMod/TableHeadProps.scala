package typingsJapgolly.materialUiCore.tableHeadTableHeadMod
...
import typingsJapgolly.materialUiCore.PartialClassNameMapTableH
...
object TableHeadProps {
  ...
  def apply(
    ...
    classes: PartialClassNameMapTableH = null,
    color: String = null,
