package typingsJapgolly.materialUiCore.swipeableDrawerSwipeableDrawerMod
...
import typingsJapgolly.materialUiCore.PartialClassNameMapDrawer
import typingsJapgolly.materialUiCore.PartialModalProps
import typingsJapgolly.materialUiCore.PartialPaperProps
import typingsJapgolly.materialUiCore.PartialSlideProps
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.permanent
import typingsJapgolly.materialUiCore.materialUiCoreStrings.persistent
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.temporary
...
object SwipeableDrawerProps {
  ...
  def apply(
    ...
    __obj.updateDynamic("onClose")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element]) => onClose(t0).runNow()))
    __obj.updateDynamic("onOpen")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element]) => onOpen(t0).runNow()))
