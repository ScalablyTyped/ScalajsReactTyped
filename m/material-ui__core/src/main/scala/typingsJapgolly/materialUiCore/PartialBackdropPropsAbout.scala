...
object PartialBackdropPropsAbout {
  ...
  def apply(
    ...
    onClick: ReactEventFrom[js.Object with Element] => Callback = null,
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element]) => onClick(t0).runNow()))
