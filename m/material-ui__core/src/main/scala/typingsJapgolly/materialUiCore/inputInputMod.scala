...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapInputC
...
object inputInputMod {
  ...
  @JSImport("@material-ui/core/Input/Input", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.inputTypeSearch
  */
  trait InputClassKey extends StObject
  object InputClassKey {
    ...
    inline def inputMarginDense: typingsJapgolly.materialUiCore.materialUiCoreStrings.inputMarginDense = "inputMarginDense".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.inputMarginDense]
    
    inline def inputMultiline: typingsJapgolly.materialUiCore.materialUiCoreStrings.inputMultiline = "inputMultiline".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.inputMultiline]
    
    inline def inputTypeSearch: typingsJapgolly.materialUiCore.materialUiCoreStrings.inputTypeSearch = "inputTypeSearch".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.inputTypeSearch]
    ...
    inline def multiline: typingsJapgolly.materialUiCore.materialUiCoreStrings.multiline = "multiline".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.multiline]
    ...
    inline def underline: typingsJapgolly.materialUiCore.materialUiCoreStrings.underline = "underline".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.underline]
  }
  ...
  trait InputProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapInputC] = js.undefined
  ...
  object InputProps {
    ...
    extension [Self <: InputProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapInputC): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
