...
object textareaAutosizeTextareaAutosizeMod {
  ...
  @JSImport("@material-ui/core/TextareaAutosize/TextareaAutosize", JSImport.Namespace)
  @js.native
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.Omit<react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, 'children' | 'rows'> */
