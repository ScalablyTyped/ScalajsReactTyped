...
import typingsJapgolly.materialUiCore.modalManagerMod.ModalManager
...
import typingsJapgolly.materialUiCore.popoverPopoverMod.PopoverActions
import typingsJapgolly.materialUiCore.popoverPopoverMod.PopoverClassKey
import typingsJapgolly.materialUiCore.popoverPopoverMod.PopoverOrigin
import typingsJapgolly.materialUiCore.popoverPopoverMod.PopoverPosition
...
@js.native
trait PartialMenuPropsAccessKey extends js.Object {
  var BackdropComponent: js.UndefOr[ReactType[BackdropProps]] = js.native
  var BackdropProps: js.UndefOr[Partial[typingsJapgolly.materialUiCore.backdropBackdropMod.BackdropProps]] = js.native
  var MenuListProps: js.UndefOr[Partial[typingsJapgolly.materialUiCore.menuListMenuListMod.MenuListProps]] = js.native
  var ModalClasses: js.UndefOr[Partial[ClassNameMap[ModalClassKey]]] = js.native
  var PaperProps: js.UndefOr[Partial[typingsJapgolly.materialUiCore.paperPaperMod.PaperProps]] = js.native
  var PopoverClasses: js.UndefOr[Partial[ClassNameMap[PopoverClassKey]]] = js.native
  ...
  var classes: js.UndefOr[Partial[ClassNameMap[MenuClassKey]]] = js.native
...
object PartialMenuPropsAccessKey {
  @scala.inline
  def apply(
    BackdropComponent: ReactType[BackdropProps] = null,
    BackdropProps: Partial[BackdropProps] = null,
    MenuListProps: Partial[MenuListProps] = null,
    ModalClasses: Partial[ClassNameMap[ModalClassKey]] = null,
    PaperProps: Partial[PaperProps] = null,
    PopoverClasses: Partial[ClassNameMap[PopoverClassKey]] = null,
    TransitionComponent: ComponentType[TransitionProps] = null,
    TransitionProps: TransitionProps = null,
    about: String = null,
    accessKey: String = null,
    action: /* actions */ PopoverActions => Callback = null,
    ...
    classes: Partial[ClassNameMap[MenuClassKey]] = null,
    ...
    getContentAnchorEl: /* element */ HTMLElement => CallbackTo[HTMLElement] = null,
    ...
    onBackdropClick: ReactEventFrom[js.Object with Element] => Callback = null,
    ...
    onClose: ReactEventFrom[js.Object with Element] => Callback = null,
    ...
    onEscapeKeyDown: ReactEventFrom[js.Object with Element] => Callback = null,
    onExit: js.Any = null,
    ...
    if (action != null) __obj.updateDynamic("action")(js.Any.fromFunction1((t0: /* actions */ typingsJapgolly.materialUiCore.popoverPopoverMod.PopoverActions) => action(t0).runNow()))
    ...
    if (getContentAnchorEl != null) __obj.updateDynamic("getContentAnchorEl")(js.Any.fromFunction1((t0: /* element */ org.scalajs.dom.raw.HTMLElement) => getContentAnchorEl(t0).runNow()))
    ...
    if (onBackdropClick != null) __obj.updateDynamic("onBackdropClick")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element]) => onBackdropClick(t0).runNow()))
    ...
    if (onClose != null) __obj.updateDynamic("onClose")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element]) => onClose(t0).runNow()))
    ...
    if (onEscapeKeyDown != null) __obj.updateDynamic("onEscapeKeyDown")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element]) => onEscapeKeyDown(t0).runNow()))
    ...
    __obj.asInstanceOf[PartialMenuPropsAccessKey]
  }
}
