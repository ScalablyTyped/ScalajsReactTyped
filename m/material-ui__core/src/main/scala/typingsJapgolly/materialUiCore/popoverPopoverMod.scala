...
object popoverPopoverMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.paper
  */
  trait PopoverClassKey extends StObject
  object PopoverClassKey {
    
    inline def paper: typingsJapgolly.materialUiCore.materialUiCoreStrings.paper = "paper".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.paper]
  ...
  trait PopoverProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapPopove] = js.undefined
    ...
    var container: js.UndefOr[
        /* import warning: importer.ImportType#apply Failed type conversion: @material-ui/core.@material-ui/core/Portal/Portal.PortalProps['container'] */ js.Any
      ] = js.undefined
    ...
    var getContentAnchorEl: js.UndefOr[
        Null | (js.Function1[/* element */ org.scalajs.dom.Element, org.scalajs.dom.Element])
      ] = js.undefined
  ...
  object PopoverProps {
    ...
    extension [Self <: PopoverProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapPopove): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setContainer(
        value: /* import warning: importer.ImportType#apply Failed type conversion: @material-ui/core.@material-ui/core/Portal/Portal.PortalProps['container'] */ js.Any
      ...
      inline def setGetContentAnchorEl(value: /* element */ org.scalajs.dom.Element => org.scalajs.dom.Element): Self = StObject.set(x, "getContentAnchorEl", js.Any.fromFunction1(value))
      ...
      inline def setOnEscapeKeyDown(value: ReactEventFrom[js.Object & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onEscapeKeyDown", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & org.scalajs.dom.Element]) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.anchorEl
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.anchorPosition
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.none
  */
  trait PopoverReference extends StObject
  object PopoverReference {
    
    inline def anchorEl: typingsJapgolly.materialUiCore.materialUiCoreStrings.anchorEl = "anchorEl".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.anchorEl]
    
    inline def anchorPosition: typingsJapgolly.materialUiCore.materialUiCoreStrings.anchorPosition = "anchorPosition".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.anchorPosition]
