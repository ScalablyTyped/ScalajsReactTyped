...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapTouchR
...
object buttonBaseTouchRippleMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.ripple
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.rippleVisible
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.ripplePulsate
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.child
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.childLeaving
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.childPulsate
  */
  trait TouchRippleClassKey extends StObject
  object TouchRippleClassKey {
    
    inline def child: typingsJapgolly.materialUiCore.materialUiCoreStrings.child = "child".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.child]
    
    inline def childLeaving: typingsJapgolly.materialUiCore.materialUiCoreStrings.childLeaving = "childLeaving".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.childLeaving]
    
    inline def childPulsate: typingsJapgolly.materialUiCore.materialUiCoreStrings.childPulsate = "childPulsate".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.childPulsate]
    
    inline def ripple: typingsJapgolly.materialUiCore.materialUiCoreStrings.ripple = "ripple".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.ripple]
    
    inline def ripplePulsate: typingsJapgolly.materialUiCore.materialUiCoreStrings.ripplePulsate = "ripplePulsate".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.ripplePulsate]
    
    inline def rippleVisible: typingsJapgolly.materialUiCore.materialUiCoreStrings.rippleVisible = "rippleVisible".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.rippleVisible]
  ...
  /* Inlined @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLElement>, @material-ui/core.@material-ui/core/ButtonBase/TouchRipple.TouchRippleClassKey, never> & {  center :boolean | undefined} */
  trait TouchRippleProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapTouchR] = js.undefined
  ...
  object TouchRippleProps {
    ...
    extension [Self <: TouchRippleProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapTouchR): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
