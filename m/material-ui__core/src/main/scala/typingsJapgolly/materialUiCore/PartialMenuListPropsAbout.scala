...
@js.native
trait PartialMenuListPropsAbout extends js.Object {
  ...
  var classes: js.UndefOr[Partial[ClassNameMap[MenuListClassKey]]] = js.native
  ...
  var onKeyDown: js.UndefOr[ReactEventHandler[ReactKeyboardEventFrom[Element]]] = js.native
  ...
  var subheader: js.UndefOr[japgolly.scalajs.react.raw.React.Element] = js.native
...
object PartialMenuListPropsAbout {
  @scala.inline
  def apply(
    about: String = null,
    ...
    classes: Partial[ClassNameMap[MenuListClassKey]] = null,
    color: String = null,
  ...
  japgolly.scalajs.react.ReactKeyboardEventFrom[org.scalajs.dom.raw.Element] with org.scalajs.dom.raw.Element]) => onKeyDown(t0).runNow()))
    ...
    __obj.asInstanceOf[PartialMenuListPropsAbout]
  }
}
