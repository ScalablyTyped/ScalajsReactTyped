package typingsJapgolly.materialUiCore.listItemTextListItemTextMod
...
import typingsJapgolly.materialUiCore.PartialClassNameMapListItDense
...
object ListItemTextProps {
  ...
  def apply(
    ...
    if (primary != null) __obj.updateDynamic("primary")(primary.rawNode.asInstanceOf[js.Any])
    ...
    if (secondary != null) __obj.updateDynamic("secondary")(secondary.rawNode.asInstanceOf[js.Any])
