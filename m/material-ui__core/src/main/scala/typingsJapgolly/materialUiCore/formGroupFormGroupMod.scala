...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapFormGr
...
object formGroupFormGroupMod {
  ...
  @JSImport("@material-ui/core/FormGroup/FormGroup", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.row
  */
  ...
  object FormGroupClassKey {
    ...
    inline def row: typingsJapgolly.materialUiCore.materialUiCoreStrings.row = "row".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.row]
  }
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/FormGroup/FormGroup.FormGroupClassKey, never> */
  trait FormGroupProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapFormGr] = js.undefined
  ...
  object FormGroupProps {
    ...
    extension [Self <: FormGroupProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapFormGr): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
