...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapListItAlignItemsFlexStart
...
object listItemIconListItemIconMod {
  ...
  @JSImport("@material-ui/core/ListItemIcon/ListItemIcon", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.alignItemsFlexStart
  */
  trait ListItemIconClassKey extends StObject
  object ListItemIconClassKey {
    
    inline def alignItemsFlexStart: typingsJapgolly.materialUiCore.materialUiCoreStrings.alignItemsFlexStart = "alignItemsFlexStart".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.alignItemsFlexStart]
  ...
  trait ListItemIconProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapListItAlignItemsFlexStart] = js.undefined
  ...
  object ListItemIconProps {
    ...
    extension [Self <: ListItemIconProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapListItAlignItemsFlexStart): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
