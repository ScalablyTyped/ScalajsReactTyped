package typingsJapgolly.materialUiCore.listSubheaderListSubheaderMod
...
trait ListSubheaderProps extends js.Object {
  ...
  var color: js.UndefOr[typingsJapgolly.materialUiCore.materialUiCoreStrings.default | primary | inherit] = js.native
...
object ListSubheaderProps {
  ...
  def apply(
    ...
    color: typingsJapgolly.materialUiCore.materialUiCoreStrings.default | primary | inherit = null,
