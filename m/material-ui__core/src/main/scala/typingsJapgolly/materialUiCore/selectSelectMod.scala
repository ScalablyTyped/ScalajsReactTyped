...
import typingsJapgolly.materialUiCore.anon.Disabled
import typingsJapgolly.materialUiCore.anon.Name
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapSelect
...
object selectSelectMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.selectMenu
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.disabled
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.icon
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.iconOpen
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.iconFilled
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.iconOutlined
  */
  ...
  object SelectClassKey {
    ...
    inline def iconFilled: typingsJapgolly.materialUiCore.materialUiCoreStrings.iconFilled = "iconFilled".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.iconFilled]
    
    inline def iconOpen: typingsJapgolly.materialUiCore.materialUiCoreStrings.iconOpen = "iconOpen".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.iconOpen]
    
    inline def iconOutlined: typingsJapgolly.materialUiCore.materialUiCoreStrings.iconOutlined = "iconOutlined".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.iconOutlined]
    ...
    inline def selectMenu: typingsJapgolly.materialUiCore.materialUiCoreStrings.selectMenu = "selectMenu".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.selectMenu]
  }
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/Input.InputProps, @material-ui/core.@material-ui/core/Select/Select.SelectClassKey, 'value' | 'onChange'> */
  ...
  trait SelectProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapSelect] = js.undefined
    ...
    var onChange: js.UndefOr[
        js.Function2[/* event */ ReactEventFrom[Name & org.scalajs.dom.Element], /* child */ Node, Unit]
      ] = js.undefined
    ...
    /**
      ...
      * @returns {ReactNode}
      */
    var renderValue: js.UndefOr[js.Function1[/* value */ js.UndefOr[Any], Node]] = js.undefined
  ...
  object SelectProps {
    ...
    extension [Self <: SelectProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapSelect): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: (/* event */ ReactEventFrom[Name & org.scalajs.dom.Element], /* child */ Node) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Name & org.scalajs.dom.Element], t1: /* child */ Node) => (value(t0, t1)).runNow()))
      ...
      inline def setRenderValue(value: /* value */ js.UndefOr[Any] => Node): Self = StObject.set(x, "renderValue", js.Any.fromFunction1(value))
