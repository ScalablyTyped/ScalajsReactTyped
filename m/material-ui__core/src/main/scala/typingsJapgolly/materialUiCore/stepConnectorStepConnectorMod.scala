...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapStepCo
...
object stepConnectorStepConnectorMod {
  ...
  @JSImport("@material-ui/core/StepConnector/StepConnector", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.horizontal
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.vertical
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.alternativeLabel
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.active
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.completed
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.disabled
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.line
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.lineHorizontal
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.lineVertical
  */
  ...
  object StepConnectorClasskey {
    ...
    inline def alternativeLabel: typingsJapgolly.materialUiCore.materialUiCoreStrings.alternativeLabel = "alternativeLabel".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.alternativeLabel]
    
    inline def completed: typingsJapgolly.materialUiCore.materialUiCoreStrings.completed = "completed".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.completed]
    ...
    inline def horizontal: typingsJapgolly.materialUiCore.materialUiCoreStrings.horizontal = "horizontal".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.horizontal]
    
    inline def line: typingsJapgolly.materialUiCore.materialUiCoreStrings.line = "line".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.line]
    
    inline def lineHorizontal: typingsJapgolly.materialUiCore.materialUiCoreStrings.lineHorizontal = "lineHorizontal".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.lineHorizontal]
    
    inline def lineVertical: typingsJapgolly.materialUiCore.materialUiCoreStrings.lineVertical = "lineVertical".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.lineVertical]
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/StepConnector/StepConnector.StepConnectorClasskey, 'children'> */
  trait StepConnectorProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapStepCo] = js.undefined
  ...
  object StepConnectorProps {
    ...
    extension [Self <: StepConnectorProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapStepCo): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
