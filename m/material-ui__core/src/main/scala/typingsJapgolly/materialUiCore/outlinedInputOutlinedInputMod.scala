...
object outlinedInputOutlinedInputMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.notchedOutline
  ...
  */
  ...
  object OutlinedInputClassKey {
    ...
    inline def notchedOutline: typingsJapgolly.materialUiCore.materialUiCoreStrings.notchedOutline = "notchedOutline".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.notchedOutline]
