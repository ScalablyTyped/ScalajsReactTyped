...
import typingsJapgolly.materialUiCore.createBreakpointsMod.BreakpointsOptions
import typingsJapgolly.materialUiCore.createMixinsMod.MixinsOptions
import typingsJapgolly.materialUiCore.createPaletteMod.Palette
import typingsJapgolly.materialUiCore.createPaletteMod.PaletteOptions
import typingsJapgolly.materialUiCore.createTypographyMod.TypographyOptions
...
import typingsJapgolly.materialUiCore.shapeMod.ShapeOptions
import typingsJapgolly.materialUiCore.spacingMod.SpacingOptions
import typingsJapgolly.materialUiCore.transitionsMod.TransitionsOptions
import typingsJapgolly.materialUiCore.zIndexMod.ZIndexOptions
