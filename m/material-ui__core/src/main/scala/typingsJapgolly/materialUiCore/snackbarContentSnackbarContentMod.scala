...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapSnackb
...
object snackbarContentSnackbarContentMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.message
  ...
  */
  ...
  object SnackbarContentClassKey {
    ...
    inline def message: typingsJapgolly.materialUiCore.materialUiCoreStrings.message = "message".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.message]
