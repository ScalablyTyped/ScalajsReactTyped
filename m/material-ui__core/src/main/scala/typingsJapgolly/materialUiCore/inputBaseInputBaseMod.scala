...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapInputB
...
object inputBaseInputBaseMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.inputHiddenLabel
  */
  ...
  object InputBaseClassKey {
    ...
    inline def adornedEnd: typingsJapgolly.materialUiCore.materialUiCoreStrings.adornedEnd = "adornedEnd".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.adornedEnd]
    
    inline def adornedStart: typingsJapgolly.materialUiCore.materialUiCoreStrings.adornedStart = "adornedStart".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.adornedStart]
    ...
    inline def inputAdornedEnd: typingsJapgolly.materialUiCore.materialUiCoreStrings.inputAdornedEnd = "inputAdornedEnd".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.inputAdornedEnd]
    
    inline def inputAdornedStart: typingsJapgolly.materialUiCore.materialUiCoreStrings.inputAdornedStart = "inputAdornedStart".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.inputAdornedStart]
    
    inline def inputHiddenLabel: typingsJapgolly.materialUiCore.materialUiCoreStrings.inputHiddenLabel = "inputHiddenLabel".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.inputHiddenLabel]
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/InputBase/InputBase.InputBaseClassKey, 'children' | 'onChange' | 'onKeyUp' | 'onKeyDown' | 'onBlur' | 'onFocus' | 'defaultValue'> */
