...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapAccord
...
object accordionAccordionMod {
  ...
  @JSImport("@material-ui/core/Accordion/Accordion", JSImport.Namespace)
  @js.native
  ...
  */
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/Paper.PaperProps, @material-ui/core.@material-ui/core/Accordion/Accordion.AccordionClassKey, 'onChange'> */
  ...
  object AccordionProps {
    ...
    inline def apply(children: NonNullable[Node]): AccordionProps = {
    ...
    extension [Self <: AccordionProps](x: Self) {
      ...
      inline def setOnChange(
        value: (/* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], /* expanded */ Boolean) => Callback
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* expanded */ Boolean) => (value(t0, t1)).runNow()))
