...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapMobile
import typingsJapgolly.materialUiCore.anon.PartialLinearProgressProp
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.dots
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.progress
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.static
...
object mobileStepperMobileStepperMod {
  ...
  @JSImport("@material-ui/core/MobileStepper/MobileStepper", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.positionStatic
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.dots
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.dot
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.dotActive
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.progress
  */
  trait MobileStepperClassKey extends StObject
  object MobileStepperClassKey {
    
    inline def dot: typingsJapgolly.materialUiCore.materialUiCoreStrings.dot = "dot".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.dot]
    
    inline def dotActive: typingsJapgolly.materialUiCore.materialUiCoreStrings.dotActive = "dotActive".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.dotActive]
    
    inline def dots: typingsJapgolly.materialUiCore.materialUiCoreStrings.dots = "dots".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.dots]
    ...
    inline def positionStatic: typingsJapgolly.materialUiCore.materialUiCoreStrings.positionStatic = "positionStatic".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.positionStatic]
    ...
    inline def progress: typingsJapgolly.materialUiCore.materialUiCoreStrings.progress = "progress".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.progress]
  ...
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<@material-ui/core.@material-ui/core/Paper.PaperProps, @material-ui/core.@material-ui/core/MobileStepper/MobileStepper.MobileStepperClassKey, 'children' | 'variant'> */
  trait MobileStepperProps extends StObject {
    
    /**
      * Props applied to the `LinearProgress` element.
      */
    var LinearProgressProps: js.UndefOr[PartialLinearProgressProp] = js.undefined
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapMobile] = js.undefined
  ...
  object MobileStepperProps {
    ...
    extension [Self <: MobileStepperProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapMobile): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
      ...
      inline def setLinearProgressProps(value: PartialLinearProgressProp): Self = StObject.set(x, "LinearProgressProps", value.asInstanceOf[js.Any])
