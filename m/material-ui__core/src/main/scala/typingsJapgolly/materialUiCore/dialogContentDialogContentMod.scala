...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapDialogDividers
...
object dialogContentDialogContentMod {
  ...
  @JSImport("@material-ui/core/DialogContent/DialogContent", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.dividers
  */
  trait DialogContentClassKey extends StObject
  object DialogContentClassKey {
    
    inline def dividers: typingsJapgolly.materialUiCore.materialUiCoreStrings.dividers = "dividers".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.dividers]
  ...
  trait DialogContentProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapDialogDividers] = js.undefined
  ...
  object DialogContentProps {
    ...
    extension [Self <: DialogContentProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapDialogDividers): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
