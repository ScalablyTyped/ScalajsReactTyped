...
import typingsJapgolly.materialUiCore.anon.Dark
import typingsJapgolly.materialUiCore.anon.PartialCommonColors
import typingsJapgolly.materialUiCore.anon.PartialTypeAction
import typingsJapgolly.materialUiCore.anon.PartialTypeBackground
import typingsJapgolly.materialUiCore.anon.PartialTypeText
import typingsJapgolly.materialUiCore.mod.Color
...
object stylesCreatePaletteMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.materialUiCore.stylesCreatePaletteMod.SimplePaletteColorOptions
    - typingsJapgolly.materialUiCore.stylesCreatePaletteMod.ColorPartial
  */
  trait PaletteColorOptions extends StObject
  object PaletteColorOptions {
    
    inline def ColorPartial(): typingsJapgolly.materialUiCore.stylesCreatePaletteMod.ColorPartial = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.materialUiCore.stylesCreatePaletteMod.ColorPartial]
    }
    
    inline def SimplePaletteColorOptions(main: String): typingsJapgolly.materialUiCore.stylesCreatePaletteMod.SimplePaletteColorOptions = {
      val __obj = js.Dynamic.literal(main = main.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.materialUiCore.stylesCreatePaletteMod.SimplePaletteColorOptions]
    }
  }
