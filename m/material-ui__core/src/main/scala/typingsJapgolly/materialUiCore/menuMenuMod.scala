...
object menuMenuMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.list
  */
  trait MenuClassKey extends StObject
  object MenuClassKey {
    
    inline def list: typingsJapgolly.materialUiCore.materialUiCoreStrings.list = "list".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.list]
