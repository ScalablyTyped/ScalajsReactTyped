package typingsJapgolly.materialUiCore.selectSelectMod
...
import typingsJapgolly.materialUiCore.PartialClassNameMapSelect
...
trait SelectProps extends js.Object {
  ...
  var inputRef: js.UndefOr[Ref | RefHandle[_]] = js.native
  ...
  var renderPrefix: js.UndefOr[js.Function1[/* state */ AnonDisabled, Node]] = js.native
...
object SelectProps {
  ...
  (org.scalajs.dom.raw.HTMLTextAreaElement | org.scalajs.dom.raw.HTMLInputElement) with org.scalajs.dom.raw.Element]) => onKeyUp(t0).runNow()))
    ...
    if (renderValue != null) __obj.updateDynamic("renderValue")(js.Any.fromFunction1((t0: /* value */ js.UndefOr[
  (js.Array[java.lang.String | scala.Double | scala.Boolean | js.Object]) | java.lang.String | scala.Double | scala.Boolean | js.Object]) => renderValue(t0).runNow()))
