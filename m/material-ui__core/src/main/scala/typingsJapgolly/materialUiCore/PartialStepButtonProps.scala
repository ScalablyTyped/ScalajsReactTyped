...
import typingsJapgolly.materialUiCore.stepButtonStepButtonMod.StepButtonIcon
...
object PartialStepButtonProps {
  ...
  def apply(
    ...
    if (optional != null) __obj.updateDynamic("optional")(optional.rawNode.asInstanceOf[js.Any])
