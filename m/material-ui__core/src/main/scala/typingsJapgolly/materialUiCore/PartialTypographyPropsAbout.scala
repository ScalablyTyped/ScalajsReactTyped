...
trait PartialTypographyPropsAbout extends js.Object {
  ...
  {[ type in @material-ui/core.@material-ui/core/Typography/Typography.Style ]: string}
    */ typingsJapgolly.materialUiCore.materialUiCoreStrings.PartialTypographyPropsAbout with js.Any
  ] = js.native
...
object PartialTypographyPropsAbout {
  ...
  {[ type in @material-ui/core.@material-ui/core/Typography/Typography.Style ]: string}
    */ typingsJapgolly.materialUiCore.materialUiCoreStrings.PartialTypographyPropsAbout with js.Any = null,
