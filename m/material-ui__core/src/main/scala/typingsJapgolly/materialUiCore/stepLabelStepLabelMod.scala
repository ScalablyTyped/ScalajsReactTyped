...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapStepLa
import typingsJapgolly.materialUiCore.anon.PartialStepIconProps
...
object stepLabelStepLabelMod {
  ...
  @JSImport("@material-ui/core/StepLabel/StepLabel", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.iconContainer
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.labelContainer
  */
  ...
  object StepLabelClasskey {
    ...
    inline def iconContainer: typingsJapgolly.materialUiCore.materialUiCoreStrings.iconContainer = "iconContainer".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.iconContainer]
    ...
    inline def labelContainer: typingsJapgolly.materialUiCore.materialUiCoreStrings.labelContainer = "labelContainer".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.labelContainer]
  ...
  trait StepLabelProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapStepLa] = js.undefined
  ...
  object StepLabelProps {
    ...
    extension [Self <: StepLabelProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapStepLa): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
