...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapStepCoLast
...
object stepContentStepContentMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.last
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.transition
  */
  trait StepContentClasskey extends StObject
  object StepContentClasskey {
    
    inline def last: typingsJapgolly.materialUiCore.materialUiCoreStrings.last = "last".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.last]
    ...
    inline def transition: typingsJapgolly.materialUiCore.materialUiCoreStrings.transition = "transition".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.transition]
  }
