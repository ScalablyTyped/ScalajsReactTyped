...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapBackdr
...
object backdropBackdropMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.invisible
  */
  trait BackdropClassKey extends StObject
  object BackdropClassKey {
    
    inline def invisible: typingsJapgolly.materialUiCore.materialUiCoreStrings.invisible = "invisible".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.invisible]
