package typingsJapgolly.materialUiCore.svgIconSvgIconMod
...
trait SvgIconProps extends js.Object {
  ...
  var fontSize: js.UndefOr[
    inherit | typingsJapgolly.materialUiCore.materialUiCoreStrings.default | small | large
  ] = js.native
...
object SvgIconProps {
  ...
  def apply(
    ...
    fontSize: inherit | typingsJapgolly.materialUiCore.materialUiCoreStrings.default | small | large = null,
