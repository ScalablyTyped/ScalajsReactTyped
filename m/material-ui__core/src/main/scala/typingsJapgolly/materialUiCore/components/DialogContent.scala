...
import typingsJapgolly.materialUiCore.dialogContentMod.default
...
object DialogContent {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DialogContentProps, default, Unit, DialogContentProps] = {
  ...
  typingsJapgolly.materialUiCore.dialogContentDialogContentMod.DialogContentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.dialogContentMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.dialogContentDialogContentMod.DialogContentProps])(children: _*)
  }
