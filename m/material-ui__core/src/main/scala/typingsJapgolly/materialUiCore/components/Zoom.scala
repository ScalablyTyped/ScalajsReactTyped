...
import typingsJapgolly.materialUiCore.zoomMod.default
...
object Zoom {
  ...
  typingsJapgolly.materialUiCore.zoomZoomMod.ZoomProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.zoomMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.zoomZoomMod.ZoomProps])(children: _*)
  }
