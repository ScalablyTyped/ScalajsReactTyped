...
import typingsJapgolly.materialUiCore.anon.PartialBackdropProps
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapMenuCl
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapPopove
import typingsJapgolly.materialUiCore.anon.PartialPaperProps
...
import typingsJapgolly.materialUiCore.modalModalManagerMod.ModalManager
...
object Menu {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def BackdropProps(value: PartialBackdropProps): this.type = set("BackdropProps", value.asInstanceOf[js.Any])
    
    inline def MenuListProps(value: Partial[typingsJapgolly.materialUiCore.menuListMenuListMod.MenuListProps]): this.type = set("MenuListProps", value.asInstanceOf[js.Any])
    
    inline def PaperProps(value: PartialPaperProps): this.type = set("PaperProps", value.asInstanceOf[js.Any])
    
    inline def PopoverClasses(value: PartialClassNameMapPopove): this.type = set("PopoverClasses", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialClassNameMapMenuCl): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def disableBackdropClick(value: Boolean): this.type = set("disableBackdropClick", value.asInstanceOf[js.Any])
    ...
    inline def getContentAnchorEl(value: /* element */ Element => Element): this.type = set("getContentAnchorEl", js.Any.fromFunction1(value))
    
    inline def getContentAnchorElNull: this.type = set("getContentAnchorEl", null)
    ...
    inline def manager(value: ModalManager): this.type = set("manager", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onEnter", value.asInstanceOf[js.Any])
    
    inline def onEntered(
    ...
    ): this.type = set("onEntered", value.asInstanceOf[js.Any])
    
    inline def onEntering(
    ...
    ): this.type = set("onEntering", value.asInstanceOf[js.Any])
    ...
    inline def onEscapeKeyDown(value: ReactEventFrom[js.Object & Element] => Callback): this.type = set("onEscapeKeyDown", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => value(t0).runNow()))
    ...
    ): this.type = set("onExit", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onExited", value.asInstanceOf[js.Any])
    
    inline def onExiting(
    ...
    ): this.type = set("onExiting", value.asInstanceOf[js.Any])
