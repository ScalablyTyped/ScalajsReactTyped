...
import typingsJapgolly.materialUiCore.PartialClassNameMapTabsCl
import typingsJapgolly.materialUiCore.PartialTabIndicatorProps
...
import typingsJapgolly.materialUiCore.tabsMod.default
...
object Tabs {
  def apply(
    ...
    if (action != null) __obj.updateDynamic("action")(js.Any.fromFunction1((t0: /* actions */ typingsJapgolly.materialUiCore.tabsTabsMod.TabsActions) => action(t0).runNow()))
  ...
  typingsJapgolly.materialUiCore.tabsTabsMod.TabsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.tabsMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.tabsTabsMod.TabsProps])(children: _*)
  }
