...
import typingsJapgolly.materialUiCore.PartialClassNameMapSvgIco
...
object SvgIcon {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SvgIconProps, typingsJapgolly.materialUiCore.svgIconMod.default, Unit, SvgIconProps] = {
  ...
  typingsJapgolly.materialUiCore.svgIconSvgIconMod.SvgIconProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.svgIconMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.svgIconSvgIconMod.SvgIconProps])(children: _*)
  }
