...
import typingsJapgolly.materialUiCore.PartialClassNameMapGridLi
import typingsJapgolly.materialUiCore.gridListGridListMod.GridListProps
import typingsJapgolly.materialUiCore.gridListMod.default
...
object GridList {
  ...
  typingsJapgolly.materialUiCore.gridListGridListMod.GridListProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.gridListMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.gridListGridListMod.GridListProps])(children: _*)
  }
