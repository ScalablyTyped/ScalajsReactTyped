...
import typingsJapgolly.materialUiCore.PartialClassNameMapCardMe
import typingsJapgolly.materialUiCore.cardMediaCardMediaMod.CardMediaProps
import typingsJapgolly.materialUiCore.cardMediaMod.default
...
object CardMedia {
  ...
  typingsJapgolly.materialUiCore.cardMediaCardMediaMod.CardMediaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.cardMediaMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.cardMediaCardMediaMod.CardMediaProps])(children: _*)
  }
