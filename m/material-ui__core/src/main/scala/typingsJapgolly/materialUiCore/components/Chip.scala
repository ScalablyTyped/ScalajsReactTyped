...
object Chip {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ChipProps, typingsJapgolly.materialUiCore.chipMod.default, Unit, ChipProps] = {
  ...
  typingsJapgolly.materialUiCore.chipChipMod.ChipProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.chipMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.chipChipMod.ChipProps])(children: _*)
  }
