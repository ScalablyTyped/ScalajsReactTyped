...
object TablePagination {
  ...
  implicit def make(companion: TablePagination.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(
    p: DefaultComponentProps[TablePaginationTypeMap[js.Object, ComponentType[TablePaginationBaseProps]]]
