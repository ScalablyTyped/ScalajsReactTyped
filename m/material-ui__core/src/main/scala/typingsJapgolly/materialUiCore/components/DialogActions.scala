...
import typingsJapgolly.materialUiCore.PartialClassNameMapDialogAction
import typingsJapgolly.materialUiCore.dialogActionsDialogActionsMod.DialogActionsProps
import typingsJapgolly.materialUiCore.dialogActionsMod.default
...
object DialogActions {
  ...
  typingsJapgolly.materialUiCore.dialogActionsDialogActionsMod.DialogActionsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.dialogActionsMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.dialogActionsDialogActionsMod.DialogActionsProps])(children: _*)
  }
