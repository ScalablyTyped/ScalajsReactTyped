...
import typingsJapgolly.materialUiCore.PartialClassNameMapBackdr
import typingsJapgolly.materialUiCore.backdropBackdropMod.BackdropProps
import typingsJapgolly.materialUiCore.backdropMod.default
...
object Backdrop {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BackdropProps, default, Unit, BackdropProps] = {
  ...
  typingsJapgolly.materialUiCore.backdropBackdropMod.BackdropProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.backdropMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.backdropBackdropMod.BackdropProps])(children: _*)
  }
