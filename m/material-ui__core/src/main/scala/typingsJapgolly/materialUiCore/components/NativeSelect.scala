...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapNative
...
object NativeSelect {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapNative): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def inputProps(value: NativeSelectInputProps): this.type = set("inputProps", value.asInstanceOf[js.Any])
