...
import typingsJapgolly.materialUiCore.buttonBaseTouchRippleMod.TouchRippleProps
...
object TouchRipple {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapTouchR): this.type = set("classes", value.asInstanceOf[js.Any])
