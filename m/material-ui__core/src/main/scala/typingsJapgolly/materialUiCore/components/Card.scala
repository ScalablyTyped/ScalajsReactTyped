...
import typingsJapgolly.materialUiCore.cardMod.default
...
object Card {
  ...
  typingsJapgolly.materialUiCore.cardCardMod.CardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.cardMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.cardCardMod.CardProps])(children: _*)
  }
