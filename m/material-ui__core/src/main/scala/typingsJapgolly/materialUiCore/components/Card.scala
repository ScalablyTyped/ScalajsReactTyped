...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapCardCl
...
object Card {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapCardCl): this.type = set("classes", value.asInstanceOf[js.Any])
