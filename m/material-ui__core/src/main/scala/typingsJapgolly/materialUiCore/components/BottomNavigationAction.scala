...
import typingsJapgolly.materialUiCore.PartialClassNameMapBottomIconOnly
import typingsJapgolly.materialUiCore.bottomNavigationActionBottomNavigationActionMod.BottomNavigationActionProps
import typingsJapgolly.materialUiCore.bottomNavigationActionMod.default
...
object BottomNavigationAction {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BottomNavigationActionProps, default, Unit, BottomNavigationActionProps] = {
  ...
  typingsJapgolly.materialUiCore.bottomNavigationActionBottomNavigationActionMod.BottomNavigationActionProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.bottomNavigationActionMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.bottomNavigationActionBottomNavigationActionMod.BottomNavigationActionProps])(children: _*)
  }
