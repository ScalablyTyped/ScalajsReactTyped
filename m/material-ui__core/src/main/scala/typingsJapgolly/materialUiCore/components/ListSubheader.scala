...
import typingsJapgolly.materialUiCore.PartialClassNameMapListSu
import typingsJapgolly.materialUiCore.listSubheaderListSubheaderMod.ListSubheaderProps
...
object ListSubheader {
  def apply(
    ...
    ListSubheaderProps, 
    typingsJapgolly.materialUiCore.listSubheaderMod.default, 
    Unit, 
    ListSubheaderProps
  ] = {
  ...
  typingsJapgolly.materialUiCore.listSubheaderListSubheaderMod.ListSubheaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.listSubheaderMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.listSubheaderListSubheaderMod.ListSubheaderProps])(children: _*)
  }
