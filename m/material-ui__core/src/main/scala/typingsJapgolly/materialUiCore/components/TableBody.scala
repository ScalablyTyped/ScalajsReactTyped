...
import typingsJapgolly.materialUiCore.tableBodyMod.default
import typingsJapgolly.materialUiCore.tableBodyTableBodyMod.TableBodyBaseProps
import typingsJapgolly.materialUiCore.tableBodyTableBodyMod.TableBodyProps
...
object TableBody {
  ...
  typingsJapgolly.materialUiCore.tableBodyTableBodyMod.TableBodyProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.tableBodyMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.tableBodyTableBodyMod.TableBodyProps])(children: _*)
  }
