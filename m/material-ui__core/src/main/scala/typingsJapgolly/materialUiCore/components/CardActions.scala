...
import typingsJapgolly.materialUiCore.PartialClassNameMapCardAcAction
import typingsJapgolly.materialUiCore.cardActionsCardActionsMod.CardActionsProps
import typingsJapgolly.materialUiCore.cardActionsMod.default
...
object CardActions {
  ...
  typingsJapgolly.materialUiCore.cardActionsCardActionsMod.CardActionsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.cardActionsMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.cardActionsCardActionsMod.CardActionsProps])(children: _*)
  }
