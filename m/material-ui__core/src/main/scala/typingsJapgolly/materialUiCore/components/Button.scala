...
import typingsJapgolly.materialUiCore.buttonMod.default
...
object Button {
  ...
  typingsJapgolly.materialUiCore.buttonButtonMod.ButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.buttonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.buttonButtonMod.ButtonProps])(children: _*)
  }
