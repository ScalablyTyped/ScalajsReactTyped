...
import typingsJapgolly.materialUiCore.PartialClassNameMapCardCo
import typingsJapgolly.materialUiCore.cardContentCardContentMod.CardContentProps
import typingsJapgolly.materialUiCore.cardContentMod.default
...
object CardContent {
  ...
  typingsJapgolly.materialUiCore.cardContentCardContentMod.CardContentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.cardContentMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.cardContentCardContentMod.CardContentProps])(children: _*)
  }
