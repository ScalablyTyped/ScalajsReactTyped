...
import typingsJapgolly.materialUiCore.PartialClassNameMapLinear
import typingsJapgolly.materialUiCore.linearProgressLinearProgressMod.LinearProgressProps
import typingsJapgolly.materialUiCore.linearProgressMod.default
...
object LinearProgress {
  ...
  typingsJapgolly.materialUiCore.linearProgressLinearProgressMod.LinearProgressProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.linearProgressMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.linearProgressLinearProgressMod.LinearProgressProps])(children: _*)
  }
