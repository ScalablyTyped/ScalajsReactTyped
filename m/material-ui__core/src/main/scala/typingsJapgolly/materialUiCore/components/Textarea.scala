...
import typingsJapgolly.materialUiCore.PartialClassNameMapTextar
...
import typingsJapgolly.materialUiCore.textareaMod.TextareaProps
import typingsJapgolly.materialUiCore.textareaMod.default
...
object Textarea {
  def apply(
    ...
    textareaRef: Ref | RefHandle[_] = null,
    title: String = null,
  ...
  typingsJapgolly.materialUiCore.textareaMod.TextareaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.textareaMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.textareaMod.TextareaProps])(children: _*)
  }
