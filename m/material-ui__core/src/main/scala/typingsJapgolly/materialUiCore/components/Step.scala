...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapStepCl
...
object Step {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapStepCl): this.type = set("classes", value.asInstanceOf[js.Any])
