...
import typingsJapgolly.materialUiCore.swipeableDrawerMod.default
...
object SwipeableDrawer {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SwipeableDrawerProps, default, Unit, SwipeableDrawerProps] = {
  ...
  typingsJapgolly.materialUiCore.swipeableDrawerSwipeableDrawerMod.SwipeableDrawerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.swipeableDrawerMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.swipeableDrawerSwipeableDrawerMod.SwipeableDrawerProps])(children: _*)
  }
