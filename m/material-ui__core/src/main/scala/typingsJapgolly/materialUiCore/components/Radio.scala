...
object Radio {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RadioProps, typingsJapgolly.materialUiCore.radioMod.default, Unit, RadioProps] = {
  ...
  typingsJapgolly.materialUiCore.radioRadioMod.RadioProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.radioMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.radioRadioMod.RadioProps])(children: _*)
  }
