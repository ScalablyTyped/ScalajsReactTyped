...
import typingsJapgolly.materialUiCore.PartialClassNameMapFormCo
import typingsJapgolly.materialUiCore.formControlFormControlMod.FormControlProps
import typingsJapgolly.materialUiCore.formControlMod.default
...
object FormControl {
  ...
  typingsJapgolly.materialUiCore.formControlFormControlMod.FormControlProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.formControlMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.formControlFormControlMod.FormControlProps])(children: _*)
  }
