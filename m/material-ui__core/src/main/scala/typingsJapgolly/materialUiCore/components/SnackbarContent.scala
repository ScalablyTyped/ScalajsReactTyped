...
import typingsJapgolly.materialUiCore.PartialClassNameMapSnackb
...
import typingsJapgolly.materialUiCore.snackbarContentMod.default
...
object SnackbarContent {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SnackbarContentProps, default, Unit, SnackbarContentProps] = {
  ...
  typingsJapgolly.materialUiCore.snackbarContentSnackbarContentMod.SnackbarContentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.snackbarContentMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.snackbarContentSnackbarContentMod.SnackbarContentProps])(children: _*)
  }
