...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapSteppe
...
object Stepper {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapSteppe): this.type = set("classes", value.asInstanceOf[js.Any])
