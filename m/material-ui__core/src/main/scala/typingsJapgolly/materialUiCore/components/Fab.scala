...
import typingsJapgolly.materialUiCore.fabMod.default
...
object Fab {
  ...
  typingsJapgolly.materialUiCore.fabFabMod.FabProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.fabMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.fabFabMod.FabProps])(children: _*)
  }
