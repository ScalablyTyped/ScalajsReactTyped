...
import typingsJapgolly.materialUiCore.PartialClassNameMapIconBu
...
import typingsJapgolly.materialUiCore.iconButtonMod.default
...
object IconButton {
  ...
  typingsJapgolly.materialUiCore.iconButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.iconButtonIconButtonMod.IconButtonProps])(children: _*)
  }
