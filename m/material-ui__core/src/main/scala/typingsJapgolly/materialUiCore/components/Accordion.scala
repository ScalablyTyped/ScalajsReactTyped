...
object Accordion {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapAccord): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[js.Object & Element], /* expanded */ Boolean) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & Element], t1: /* expanded */ Boolean) => (value(t0, t1)).runNow()))
