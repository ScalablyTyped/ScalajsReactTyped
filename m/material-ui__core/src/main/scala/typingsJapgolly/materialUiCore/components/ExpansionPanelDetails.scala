...
import typingsJapgolly.materialUiCore.PartialClassNameMapExpansRoot
import typingsJapgolly.materialUiCore.expansionPanelDetailsExpansionPanelDetailsMod.ExpansionPanelDetailsProps
import typingsJapgolly.materialUiCore.expansionPanelDetailsMod.default
...
object ExpansionPanelDetails {
  ...
  typingsJapgolly.materialUiCore.expansionPanelDetailsExpansionPanelDetailsMod.ExpansionPanelDetailsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.expansionPanelDetailsMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.expansionPanelDetailsExpansionPanelDetailsMod.ExpansionPanelDetailsProps])(children: _*)
  }
