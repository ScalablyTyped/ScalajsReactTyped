...
import typingsJapgolly.materialUiCore.PartialClassNameMapExpansContent
...
import typingsJapgolly.materialUiCore.expansionPanelSummaryExpansionPanelSummaryMod.ExpansionPanelSummaryProps
import typingsJapgolly.materialUiCore.expansionPanelSummaryMod.default
...
object ExpansionPanelSummary {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ExpansionPanelSummaryProps, default, Unit, ExpansionPanelSummaryProps] = {
  ...
  typingsJapgolly.materialUiCore.expansionPanelSummaryExpansionPanelSummaryMod.ExpansionPanelSummaryProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.expansionPanelSummaryMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.expansionPanelSummaryExpansionPanelSummaryMod.ExpansionPanelSummaryProps])(children: _*)
  }
