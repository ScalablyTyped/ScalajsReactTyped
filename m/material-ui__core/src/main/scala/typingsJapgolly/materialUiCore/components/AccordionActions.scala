...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapAccordRoot
...
object AccordionActions {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapAccordRoot): this.type = set("classes", value.asInstanceOf[js.Any])
