...
import typingsJapgolly.materialUiCore.AnonPlacement
import typingsJapgolly.materialUiCore.popperMod.default
...
object Popper {
  def apply(
    ...
    children: Node | (js.Function1[/* props */ AnonPlacement, Node]) = null
  ...
  typingsJapgolly.materialUiCore.popperPopperMod.PopperProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.materialUiCore.popperMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.popperPopperMod.PopperProps])
  }
