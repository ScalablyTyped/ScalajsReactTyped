...
object Popper {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def anchorEl(value: ReferenceObject | js.Function0[ReferenceObject]): this.type = set("anchorEl", value.asInstanceOf[js.Any])
    
    inline def anchorElCallbackTo(value: CallbackTo[ReferenceObject]): this.type = set("anchorEl", value.toJsFn)
    ...
    inline def modifiers(value: js.Object): this.type = set("modifiers", value.asInstanceOf[js.Any])
    ...
    inline def popperRef(value: Ref[default]): this.type = set("popperRef", value.asInstanceOf[js.Any])
    
    inline def popperRefFunction1(value: default | Null => Callback): this.type = set("popperRef", js.Any.fromFunction1((t0: default | Null) => value(t0).runNow()))
