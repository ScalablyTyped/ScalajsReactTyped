...
import typingsJapgolly.materialUiCore.AnonLeft
import typingsJapgolly.materialUiCore.PartialClassNameMapTabInd
...
import typingsJapgolly.materialUiCore.tabIndicatorMod.TabIndicatorProps
import typingsJapgolly.materialUiCore.tabIndicatorMod.default
...
object TabIndicator {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabIndicatorProps, default, Unit, TabIndicatorProps] = {
  ...
  typingsJapgolly.materialUiCore.tabIndicatorMod.TabIndicatorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.tabIndicatorMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.tabIndicatorMod.TabIndicatorProps])(children: _*)
  }
