...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapExpans
...
object ExpansionPanel {
  ...
  inline def apply(children: NonNullable[Node]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ExpansionPanelProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapExpans): this.type = set("classes", value.asInstanceOf[js.Any])
