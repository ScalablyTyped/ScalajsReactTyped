...
object ImageListItemBar {
  ...
  @JSImport("@material-ui/core", "ImageListItemBar")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapImageL): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def position(value: top | bottom): this.type = set("position", value.asInstanceOf[js.Any])
