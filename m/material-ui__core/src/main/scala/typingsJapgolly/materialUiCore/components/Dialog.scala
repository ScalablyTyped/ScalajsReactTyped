...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapDialog
...
object Dialog {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def PaperComponent(value: ComponentType[PaperProps]): this.type = set("PaperComponent", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialClassNameMapDialog): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def maxWidth(value: xs | sm | md | lg | xl | `false`): this.type = set("maxWidth", value.asInstanceOf[js.Any])
