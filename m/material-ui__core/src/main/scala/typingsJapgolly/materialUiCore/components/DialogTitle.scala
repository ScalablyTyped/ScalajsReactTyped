...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapDialog0
...
object DialogTitle {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapDialog0): this.type = set("classes", value.asInstanceOf[js.Any])
