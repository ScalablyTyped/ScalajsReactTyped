...
import typingsJapgolly.materialUiCore.dialogTitleMod.default
...
object DialogTitle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DialogTitleProps, default, Unit, DialogTitleProps] = {
  ...
  typingsJapgolly.materialUiCore.dialogTitleDialogTitleMod.DialogTitleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.dialogTitleMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.dialogTitleDialogTitleMod.DialogTitleProps])(children: _*)
  }
