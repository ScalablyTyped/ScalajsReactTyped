...
import typingsJapgolly.materialUiCore.PartialClassNameMapSwitchChecked
...
import typingsJapgolly.materialUiCore.switchBaseMod.SwitchBaseProps
import typingsJapgolly.materialUiCore.switchBaseMod.default
...
object SwitchBase {
  ...
  typingsJapgolly.materialUiCore.switchBaseMod.SwitchBaseProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.switchBaseMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.switchBaseMod.SwitchBaseProps])(children: _*)
  }
