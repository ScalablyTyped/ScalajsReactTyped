...
import typingsJapgolly.materialUiCore.PartialClassNameMapFormLa
import typingsJapgolly.materialUiCore.PartialClassNameMapInputL
import typingsJapgolly.materialUiCore.formLabelFormLabelMod.FormLabelBaseProps
import typingsJapgolly.materialUiCore.inputLabelInputLabelMod.InputLabelProps
import typingsJapgolly.materialUiCore.inputLabelMod.default
...
object InputLabel {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputLabelProps, default, Unit, InputLabelProps] = {
  ...
  typingsJapgolly.materialUiCore.inputLabelInputLabelMod.InputLabelProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.inputLabelMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.inputLabelInputLabelMod.InputLabelProps])(children: _*)
  }
