...
import typingsJapgolly.materialUiCore.PartialClassNameMapStepCo
...
import typingsJapgolly.materialUiCore.stepConnectorMod.default
...
object StepConnector {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[StepConnectorProps, default, Unit, StepConnectorProps] = {
  ...
  typingsJapgolly.materialUiCore.stepConnectorStepConnectorMod.StepConnectorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.stepConnectorMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.stepConnectorStepConnectorMod.StepConnectorProps])(children: _*)
  }
