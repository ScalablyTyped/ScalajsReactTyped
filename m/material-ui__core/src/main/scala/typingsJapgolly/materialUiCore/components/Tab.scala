...
import typingsJapgolly.materialUiCore.AnonChecked
import typingsJapgolly.materialUiCore.PartialClassNameMapTabCla
...
import typingsJapgolly.materialUiCore.tabMod.default
...
object Tab {
  def apply(
    ...
    onChange: (/* event */ ReactEventFrom[AnonChecked with org.scalajs.dom.raw.Element], /* value */ js.Any) => Callback = null,
    onClick: js.Any => Callback = null,
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[typingsJapgolly.materialUiCore.AnonChecked with org.scalajs.dom.raw.Element], t1: /* value */ js.Any) => onChange(t0, t1).runNow()))
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: js.Any) => onClick(t0).runNow()))
  ...
  typingsJapgolly.materialUiCore.tabTabMod.TabProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.tabMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.tabTabMod.TabProps])(children: _*)
  }
