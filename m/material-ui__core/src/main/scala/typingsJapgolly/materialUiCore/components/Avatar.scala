...
import typingsJapgolly.materialUiCore.avatarMod.default
...
object Avatar {
  ...
  typingsJapgolly.materialUiCore.avatarAvatarMod.AvatarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.avatarMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.avatarAvatarMod.AvatarProps])(children: _*)
  }
