...
object MobileStepper {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def LinearProgressProps(value: PartialLinearProgressProp): this.type = set("LinearProgressProps", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialClassNameMapMobile): this.type = set("classes", value.asInstanceOf[js.Any])
