...
import typingsJapgolly.materialUiCore.PartialClassNameMapMobile
...
import typingsJapgolly.materialUiCore.mobileStepperMod.default
...
object MobileStepper {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MobileStepperProps, default, Unit, MobileStepperProps] = {
  ...
  typingsJapgolly.materialUiCore.mobileStepperMobileStepperMod.MobileStepperProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.mobileStepperMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.mobileStepperMobileStepperMod.MobileStepperProps])(children: _*)
  }
