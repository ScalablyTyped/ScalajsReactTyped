...
import typingsJapgolly.materialUiCore.AnonDisabled
import typingsJapgolly.materialUiCore.PartialClassNameMapOutlin
...
import typingsJapgolly.materialUiCore.outlinedInputMod.default
...
object OutlinedInput {
  def apply(
    ...
    onChange: ReactEventFrom[(HTMLTextAreaElement | HTMLInputElement) with Element] => Callback = null,
    ...
    renderPrefix: /* state */ AnonDisabled => CallbackTo[Node] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[OutlinedInputProps, default, Unit, OutlinedInputProps] = {
  ...
  (org.scalajs.dom.raw.HTMLTextAreaElement | org.scalajs.dom.raw.HTMLInputElement) with org.scalajs.dom.raw.Element]) => onChange(t0).runNow()))
  ...
  (org.scalajs.dom.raw.HTMLTextAreaElement | org.scalajs.dom.raw.HTMLInputElement) with org.scalajs.dom.raw.Element]) => onKeyUp(t0).runNow()))
    ...
    if (renderPrefix != null) __obj.updateDynamic("renderPrefix")(js.Any.fromFunction1((t0: /* state */ typingsJapgolly.materialUiCore.AnonDisabled) => renderPrefix(t0).runNow()))
  ...
  typingsJapgolly.materialUiCore.outlinedInputOutlinedInputMod.OutlinedInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.outlinedInputMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.outlinedInputOutlinedInputMod.OutlinedInputProps])(children: _*)
  }
