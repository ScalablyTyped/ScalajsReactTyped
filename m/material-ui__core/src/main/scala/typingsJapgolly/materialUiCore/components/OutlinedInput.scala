...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapOutlin
...
object OutlinedInput {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapOutlin): this.type = set("classes", value.asInstanceOf[js.Any])
