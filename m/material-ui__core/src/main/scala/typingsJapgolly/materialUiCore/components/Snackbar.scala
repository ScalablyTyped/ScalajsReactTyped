...
import typingsJapgolly.materialUiCore.PartialClassNameMapSnackbAnchorOriginBottomCenter
import typingsJapgolly.materialUiCore.PartialClickAwayListenerP
...
import typingsJapgolly.materialUiCore.snackbarMod.default
...
object Snackbar {
  ...
  typingsJapgolly.materialUiCore.snackbarSnackbarMod.SnackbarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.snackbarMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.snackbarSnackbarMod.SnackbarProps])(children: _*)
  }
