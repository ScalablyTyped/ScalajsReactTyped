...
import typingsJapgolly.materialUiCore.PartialClassNameMapDialogRoot
import typingsJapgolly.materialUiCore.dialogContentTextDialogContentTextMod.DialogContentTextProps
import typingsJapgolly.materialUiCore.dialogContentTextMod.default
...
import typingsJapgolly.materialUiCore.typeinStylestring
...
object DialogContentText {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DialogContentTextProps, default, Unit, DialogContentTextProps] = {
  ...
  typingsJapgolly.materialUiCore.dialogContentTextDialogContentTextMod.DialogContentTextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.dialogContentTextMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.dialogContentTextDialogContentTextMod.DialogContentTextProps])(children: _*)
  }
