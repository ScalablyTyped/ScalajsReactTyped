...
import typingsJapgolly.materialUiCore.PartialClassNameMapTabScr
...
import typingsJapgolly.materialUiCore.tabScrollButtonMod.TabScrollButtonProps
import typingsJapgolly.materialUiCore.tabScrollButtonMod.default
...
object TabScrollButton {
  ...
  typingsJapgolly.materialUiCore.tabScrollButtonMod.TabScrollButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.tabScrollButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.tabScrollButtonMod.TabScrollButtonProps])(children: _*)
  }
