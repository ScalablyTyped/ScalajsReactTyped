...
import typingsJapgolly.materialUiCore.tablePaginationActionsMod.default
...
object TablePaginationActions {
  def apply(
    ...
    page: Double,
    rowsPerPage: Double,
    onChangePage: (ReactMouseEventFrom[HTMLButtonElement] | Null, Double) => Callback,
    about: String = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TablePaginationActionsProps, default, Unit, TablePaginationActionsProps] = {
    val __obj = js.Dynamic.literal(count = count.asInstanceOf[js.Any], page = page.asInstanceOf[js.Any], rowsPerPage = rowsPerPage.asInstanceOf[js.Any])
  
      __obj.updateDynamic("onChangePage")(js.Any.fromFunction2((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLButtonElement] | scala.Null, t1: scala.Double) => onChangePage(t0, t1).runNow()))
  ...
  typingsJapgolly.materialUiCore.tablePaginationActionsMod.TablePaginationActionsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.tablePaginationActionsMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.tablePaginationActionsMod.TablePaginationActionsProps])(children: _*)
  }
