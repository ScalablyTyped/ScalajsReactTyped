...
import typingsJapgolly.materialUiCore.tablePaginationTablePaginationActionsMod.TablePaginationActionsProps
...
object TablePaginationActions {
  ...
  inline def apply(
    count: Double,
    onChangePage: (Null | ReactMouseEventFrom[HTMLButtonElement], Double) => Callback,
    onPageChange: (Null | ReactMouseEventFrom[HTMLButtonElement], Double) => Callback,
    page: Double,
    rowsPerPage: Double
  ): Builder = {
    val __props = js.Dynamic.literal(count = count.asInstanceOf[js.Any], onChangePage = js.Any.fromFunction2((t0: Null | ReactMouseEventFrom[HTMLButtonElement], t1: Double) => (onChangePage(t0, t1)).runNow()), onPageChange = js.Any.fromFunction2((t0: Null | ReactMouseEventFrom[HTMLButtonElement], t1: Double) => (onPageChange(t0, t1)).runNow()), page = page.asInstanceOf[js.Any], rowsPerPage = rowsPerPage.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def backIconButtonProps(
      value: Partial[
          IconButtonProps[
    ...
    ): this.type = set("backIconButtonProps", value.asInstanceOf[js.Any])
    ...
    inline def nextIconButtonProps(
      value: Partial[
          IconButtonProps[
            /* import warning: importer.ImportType#apply Failed type conversion: @material-ui/core.anon.DefaultComponent['defaultComponent'] */ js.Any, 
            js.Object
    ...
    ): this.type = set("nextIconButtonProps", value.asInstanceOf[js.Any])
