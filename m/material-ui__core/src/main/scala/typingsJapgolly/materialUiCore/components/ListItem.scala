...
import typingsJapgolly.materialUiCore.listItemMod.default
...
object ListItem {
  ...
  typingsJapgolly.materialUiCore.listItemListItemMod.ListItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.listItemMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.listItemListItemMod.ListItemProps])(children: _*)
  }
