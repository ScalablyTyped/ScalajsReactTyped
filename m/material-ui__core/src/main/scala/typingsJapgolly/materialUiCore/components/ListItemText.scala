...
object ListItemText {
  ...
  open class Builder[PrimaryTypographyComponent /* <: ElementType */, SecondaryTypographyComponent /* <: ElementType */] (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapListItDense): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def primaryTypographyProps(value: TypographyProps[PrimaryTypographyComponent, `5`[PrimaryTypographyComponent]]): this.type = set("primaryTypographyProps", value.asInstanceOf[js.Any])
    ...
    inline def secondaryTypographyProps(value: TypographyProps[SecondaryTypographyComponent, `6`[SecondaryTypographyComponent]]): this.type = set("secondaryTypographyProps", value.asInstanceOf[js.Any])
