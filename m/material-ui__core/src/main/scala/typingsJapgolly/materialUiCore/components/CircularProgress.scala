...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapCircul
...
object CircularProgress {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapCircul): this.type = set("classes", value.asInstanceOf[js.Any])
    
    inline def color(value: primary | secondary | inherit): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: determinate | indeterminate | static): this.type = set("variant", value.asInstanceOf[js.Any])
