...
import typingsJapgolly.materialUiCore.PartialClassNameMapCircul
import typingsJapgolly.materialUiCore.circularProgressCircularProgressMod.CircularProgressProps
import typingsJapgolly.materialUiCore.circularProgressMod.default
...
object CircularProgress {
  ...
  typingsJapgolly.materialUiCore.circularProgressCircularProgressMod.CircularProgressProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.circularProgressMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.circularProgressCircularProgressMod.CircularProgressProps])(children: _*)
  }
