...
import typingsJapgolly.materialUiCore.PartialClassNameMapCardHe
import typingsJapgolly.materialUiCore.PartialTypographyProps
import typingsJapgolly.materialUiCore.cardHeaderCardHeaderMod.CardHeaderProps
import typingsJapgolly.materialUiCore.cardHeaderMod.default
...
object CardHeader {
  ...
  typingsJapgolly.materialUiCore.cardHeaderCardHeaderMod.CardHeaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.cardHeaderMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.cardHeaderCardHeaderMod.CardHeaderProps])(children: _*)
  }
