...
import typingsJapgolly.materialUiCore.cardHeaderCardHeaderMod.CardHeaderTypeMap
...
object CardHeader {
  ...
  def withProps(p: DefaultComponentProps[CardHeaderTypeMap[js.Object, div, span, span]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
