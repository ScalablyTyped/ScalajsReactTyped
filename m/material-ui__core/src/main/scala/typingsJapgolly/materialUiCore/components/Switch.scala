...
import typingsJapgolly.materialUiCore.PartialClassNameMapSwitch
...
object Switch {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[SwitchProps, typingsJapgolly.materialUiCore.switchMod.default, Unit, SwitchProps] = {
  ...
  typingsJapgolly.materialUiCore.switchSwitchMod.SwitchProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.switchMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.switchSwitchMod.SwitchProps])(children: _*)
  }
