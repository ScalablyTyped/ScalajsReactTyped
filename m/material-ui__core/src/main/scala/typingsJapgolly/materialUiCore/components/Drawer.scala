...
object Drawer {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def ModalProps(value: PartialModalProps): this.type = set("ModalProps", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialClassNameMapDrawer): this.type = set("classes", value.asInstanceOf[js.Any])
