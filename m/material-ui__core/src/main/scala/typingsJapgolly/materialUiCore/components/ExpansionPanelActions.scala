...
import typingsJapgolly.materialUiCore.PartialClassNameMapExpansAction
import typingsJapgolly.materialUiCore.expansionPanelActionsExpansionPanelActionsMod.ExpansionPanelActionsProps
import typingsJapgolly.materialUiCore.expansionPanelActionsMod.default
...
object ExpansionPanelActions {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ExpansionPanelActionsProps, default, Unit, ExpansionPanelActionsProps] = {
  ...
  typingsJapgolly.materialUiCore.expansionPanelActionsExpansionPanelActionsMod.ExpansionPanelActionsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.expansionPanelActionsMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.expansionPanelActionsExpansionPanelActionsMod.ExpansionPanelActionsProps])(children: _*)
  }
