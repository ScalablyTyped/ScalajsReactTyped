...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapExpansRoot
...
object ExpansionPanelActions {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapExpansRoot): this.type = set("classes", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ExpansionPanelActions.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ExpansionPanelActionsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
