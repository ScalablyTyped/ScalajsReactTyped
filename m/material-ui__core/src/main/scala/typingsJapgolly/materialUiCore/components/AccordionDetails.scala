...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapAccord0
...
object AccordionDetails {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapAccord0): this.type = set("classes", value.asInstanceOf[js.Any])
