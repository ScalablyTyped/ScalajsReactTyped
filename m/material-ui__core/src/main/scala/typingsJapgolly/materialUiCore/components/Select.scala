...
import typingsJapgolly.materialUiCore.selectMod.default
...
object Select {
  ...
  typingsJapgolly.materialUiCore.selectSelectMod.SelectProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.selectMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.selectSelectMod.SelectProps])(children: _*)
  }
