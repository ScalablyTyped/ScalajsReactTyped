...
object Select {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapSelect): this.type = set("classes", value.asInstanceOf[js.Any])
    ...
    inline def labelWidth(value: Double): this.type = set("labelWidth", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[Name & org.scalajs.dom.Element], /* child */ Node) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Name & org.scalajs.dom.Element], t1: /* child */ Node) => (value(t0, t1)).runNow()))
    ...
    inline def renderValue(value: /* value */ js.UndefOr[Any] => Node): this.type = set("renderValue", js.Any.fromFunction1(value))
    ...
    inline def rowsMin(value: String | Double): this.type = set("rowsMin", value.asInstanceOf[js.Any])
