...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapPaperC
...
object Paper {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapPaperC): this.type = set("classes", value.asInstanceOf[js.Any])
  ...
  def withProps(p: PaperProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
