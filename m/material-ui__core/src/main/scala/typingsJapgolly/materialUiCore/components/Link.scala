...
import typingsJapgolly.materialUiCore.PartialClassNameMapLinkCl
import typingsJapgolly.materialUiCore.PartialClassNameMapTypogr
import typingsJapgolly.materialUiCore.linkLinkMod.LinkProps
import typingsJapgolly.materialUiCore.linkMod.default
...
object Link {
  ...
  typingsJapgolly.materialUiCore.linkLinkMod.LinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.linkMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.linkLinkMod.LinkProps])(children: _*)
  }
