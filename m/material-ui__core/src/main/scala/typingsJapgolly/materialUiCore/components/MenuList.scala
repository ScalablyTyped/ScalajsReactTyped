...
import typingsJapgolly.materialUiCore.PartialClassNameMapMenuLi
...
import typingsJapgolly.materialUiCore.menuListMod.default
...
object MenuList {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MenuListProps, default, Unit, MenuListProps] = {
  ...
  typingsJapgolly.materialUiCore.menuListMenuListMod.MenuListProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.menuListMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.menuListMenuListMod.MenuListProps])(children: _*)
  }
