...
import typingsJapgolly.materialUiCore.listMod.default
...
object List {
  ...
  typingsJapgolly.materialUiCore.listListMod.ListProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.listMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.listListMod.ListProps])(children: _*)
  }
