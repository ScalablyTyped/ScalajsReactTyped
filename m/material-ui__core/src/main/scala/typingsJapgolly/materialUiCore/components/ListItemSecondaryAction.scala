...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapListItRoot
...
object ListItemSecondaryAction {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapListItRoot): this.type = set("classes", value.asInstanceOf[js.Any])
