...
object StepContent {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def TransitionComponent(value: ComponentType[TransitionProps]): this.type = set("TransitionComponent", value.asInstanceOf[js.Any])
    ...
    inline def classes(value: PartialClassNameMapStepCoLast): this.type = set("classes", value.asInstanceOf[js.Any])
