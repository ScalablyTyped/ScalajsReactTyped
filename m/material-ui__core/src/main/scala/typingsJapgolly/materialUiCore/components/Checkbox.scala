...
import typingsJapgolly.materialUiCore.PartialClassNameMapCheckb
...
object Checkbox {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CheckboxProps, typingsJapgolly.materialUiCore.checkboxMod.default, Unit, CheckboxProps] = {
  ...
  typingsJapgolly.materialUiCore.checkboxCheckboxMod.CheckboxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.checkboxMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.checkboxCheckboxMod.CheckboxProps])(children: _*)
  }
