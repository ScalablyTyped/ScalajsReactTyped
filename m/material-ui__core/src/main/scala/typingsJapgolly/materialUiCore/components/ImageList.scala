...
object ImageList {
  ...
  implicit def make(companion: ImageList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DefaultComponentProps[ImageListTypeMap[js.Object, ul]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
