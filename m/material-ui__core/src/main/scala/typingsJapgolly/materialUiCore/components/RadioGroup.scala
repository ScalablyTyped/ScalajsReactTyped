...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapRadioG
...
object RadioGroup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapRadioG): this.type = set("classes", value.asInstanceOf[js.Any])
