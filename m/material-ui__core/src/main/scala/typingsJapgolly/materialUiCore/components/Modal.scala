...
object Modal {
  ...
  typingsJapgolly.materialUiCore.modalModalMod.ModalProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.modalMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.modalModalMod.ModalProps])(children: _*)
  }
