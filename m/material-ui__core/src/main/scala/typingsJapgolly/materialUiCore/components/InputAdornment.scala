...
object InputAdornment {
  ...
  implicit def make(companion: InputAdornment.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: DefaultComponentProps[InputAdornmentTypeMap[js.Object, div]]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
