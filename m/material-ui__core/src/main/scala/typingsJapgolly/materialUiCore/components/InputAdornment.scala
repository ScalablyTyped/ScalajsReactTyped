...
import typingsJapgolly.materialUiCore.inputAdornmentInputAdornmentMod.InputAdornmentProps
import typingsJapgolly.materialUiCore.inputAdornmentMod.default
...
object InputAdornment {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputAdornmentProps, default, Unit, InputAdornmentProps] = {
  ...
  typingsJapgolly.materialUiCore.inputAdornmentInputAdornmentMod.InputAdornmentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUiCore.inputAdornmentMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUiCore.inputAdornmentInputAdornmentMod.InputAdornmentProps])(children: _*)
  }
