...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapFilled
...
object FilledInput {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def classes(value: PartialClassNameMapFilled): this.type = set("classes", value.asInstanceOf[js.Any])
