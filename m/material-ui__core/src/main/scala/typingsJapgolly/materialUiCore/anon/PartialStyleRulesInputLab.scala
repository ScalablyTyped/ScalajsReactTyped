...
object PartialStyleRulesInputLab {
  ...
  inline def apply(): PartialStyleRulesInputLab = {
  ...
  extension [Self <: PartialStyleRulesInputLab](x: Self) {
    ...
    inline def setAnimatedFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "animated", js.Any.fromFunction1(value))
    ...
    inline def setShrinkFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "shrink", js.Any.fromFunction1(value))
