...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Popper/Popper.PopperProps> */
trait PartialPopperProps extends StObject {
  ...
  var popperRef: js.UndefOr[typingsJapgolly.react.mod.Ref[default]] = js.undefined
...
object PartialPopperProps {
  ...
  extension [Self <: PartialPopperProps](x: Self) {
    ...
    inline def setPopperRef(value: typingsJapgolly.react.mod.Ref[default]): Self = StObject.set(x, "popperRef", value.asInstanceOf[js.Any])
