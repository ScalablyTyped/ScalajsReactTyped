...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/CircularProgress.CircularProgressProps> */
trait PartialCircularProgressPr extends StObject {
...
object PartialCircularProgressPr {
  
  inline def apply(): PartialCircularProgressPr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialCircularProgressPr]
  }
  
  extension [Self <: PartialCircularProgressPr](x: Self) {
