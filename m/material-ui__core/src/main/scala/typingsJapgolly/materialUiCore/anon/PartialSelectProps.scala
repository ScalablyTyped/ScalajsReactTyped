...
trait PartialSelectProps extends StObject {
  ...
  var onChange: js.UndefOr[
    js.Function2[
      /* event */ ReactEventFrom[Name & org.scalajs.dom.Element], 
...
object PartialSelectProps {
  ...
  extension [Self <: PartialSelectProps](x: Self) {
    ...
    inline def setOnChange(
      value: (/* event */ ReactEventFrom[Name & org.scalajs.dom.Element], /* child */ japgolly.scalajs.react.facade.React.Node) => Callback
    ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Name & org.scalajs.dom.Element], t1: /* child */ japgolly.scalajs.react.facade.React.Node) => (value(t0, t1)).runNow()))
