...
object PartialSwipeableDrawerPro {
  ...
  extension [Self <: PartialSwipeableDrawerPro](x: Self) {
    ...
    inline def setOnClose(value: ReactEventFrom[js.Object & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def setOnOpen(value: ReactEventFrom[js.Object & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & org.scalajs.dom.Element]) => value(t0).runNow()))
