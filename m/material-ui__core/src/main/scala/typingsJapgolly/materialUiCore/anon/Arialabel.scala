...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.inverted
...
import typingsJapgolly.materialUiCore.sliderSliderMod.Mark
...
trait Arialabel extends StObject {
  ...
  var ThumbComponent: js.UndefOr[ElementType] = js.undefined
  
  var ValueLabelComponent: js.UndefOr[ElementType] = js.undefined
...
object Arialabel {
  ...
  extension [Self <: Arialabel](x: Self) {
    ...
    inline def setOnChange(
      value: (/* event */ ReactEventFrom[js.Object & Element], /* value */ Double | js.Array[Double]) => Callback
    ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & Element], t1: /* value */ Double | js.Array[Double]) => (value(t0, t1)).runNow()))
    
    inline def setOnChangeCommitted(
      value: (/* event */ ReactEventFrom[js.Object & Element], /* value */ Double | js.Array[Double]) => Callback
    ): Self = StObject.set(x, "onChangeCommitted", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & Element], t1: /* value */ Double | js.Array[Double]) => (value(t0, t1)).runNow()))
    ...
    inline def setThumbComponent(value: ElementType): Self = StObject.set(x, "ThumbComponent", value.asInstanceOf[js.Any])
    ...
    inline def setValueLabelComponent(value: ElementType): Self = StObject.set(x, "ValueLabelComponent", value.asInstanceOf[js.Any])
