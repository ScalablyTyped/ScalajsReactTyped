...
trait PartialBackdropPropsAbout extends StObject {
  ...
  var classes: js.UndefOr[Partial[ClassNameMap[BackdropClassKey]]] = js.undefined
...
object PartialBackdropPropsAbout {
  ...
  inline def apply(): PartialBackdropPropsAbout = {
  ...
  extension [Self <: PartialBackdropPropsAbout](x: Self) {
    ...
    inline def setClasses(value: Partial[ClassNameMap[BackdropClassKey]]): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
