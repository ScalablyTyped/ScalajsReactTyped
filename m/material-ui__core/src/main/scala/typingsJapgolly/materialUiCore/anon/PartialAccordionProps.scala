...
trait PartialAccordionProps extends StObject {
  ...
  var children: js.UndefOr[NonNullable[japgolly.scalajs.react.facade.React.Node]] = js.undefined
  ...
  var onChange: js.UndefOr[
    js.Function2[/* event */ ReactEventFrom[js.Object & Element], /* expanded */ Boolean, Unit]
  ] = js.undefined
...
object PartialAccordionProps {
  ...
  extension [Self <: PartialAccordionProps](x: Self) {
    ...
    inline def setOnChange(value: (/* event */ ReactEventFrom[js.Object & Element], /* expanded */ Boolean) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[js.Object & Element], t1: /* expanded */ Boolean) => (value(t0, t1)).runNow()))
