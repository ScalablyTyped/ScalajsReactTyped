...
import typingsJapgolly.materialUiCore.nativeSelectNativeSelectInputMod.NativeSelectInputProps
...
object PartialNativeSelectProps {
  ...
  extension [Self <: PartialNativeSelectProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapNative): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
