...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.absolute
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.elevation
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.fixed
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.relative
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.sticky
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.transparent
...
trait PartialAppBarProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapAppBar] = js.undefined
  
  var color: js.UndefOr[typingsJapgolly.materialUiCore.mod.PropTypes.Color | transparent] = js.undefined
...
object PartialAppBarProps {
  ...
  inline def apply(): PartialAppBarProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAppBarProps]
  }
  
  extension [Self <: PartialAppBarProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapAppBar): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    
    inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
    
    inline def setColor(value: typingsJapgolly.materialUiCore.mod.PropTypes.Color | transparent): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
