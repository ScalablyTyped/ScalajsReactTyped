...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/Stepper.StepperProps> */
trait PartialStepperProps extends StObject {
  ...
  var classes: js.UndefOr[PartialClassNameMapSteppe] = js.undefined
  
  var color: js.UndefOr[String] = js.undefined
  
  var component: js.UndefOr[ElementType] = js.undefined
  
  var connector: js.UndefOr[Element] = js.undefined
...
object PartialStepperProps {
  ...
  extension [Self <: PartialStepperProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapSteppe): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
