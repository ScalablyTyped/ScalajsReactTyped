...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/TabScrollButton.TabScrollButtonProps> */
trait PartialTabScrollButtonPro extends StObject {
...
object PartialTabScrollButtonPro {
  
  inline def apply(): PartialTabScrollButtonPro = {
