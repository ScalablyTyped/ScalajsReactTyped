...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`bottom-end`
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`bottom-start`
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`inline`
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`left-end`
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`left-start`
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`right-end`
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`right-start`
...
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`top-end`
import typingsJapgolly.materialUiCore.materialUiCoreStrings.`top-start`
...
trait PartialTooltipProps extends StObject {
  ...
  var title: js.UndefOr[NonNullable[japgolly.scalajs.react.facade.React.Node]] = js.undefined
...
object PartialTooltipProps {
  ...
  extension [Self <: PartialTooltipProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapToolti): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    ...
    inline def setTitle(value: NonNullable[japgolly.scalajs.react.facade.React.Node]): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
