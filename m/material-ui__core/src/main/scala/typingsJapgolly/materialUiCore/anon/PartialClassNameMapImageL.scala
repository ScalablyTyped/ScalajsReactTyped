...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/ImageListItemBar/ImageListItemBar.ImageListItemBarClassKey>> */
trait PartialClassNameMapImageL extends StObject {
...
object PartialClassNameMapImageL {
  
  inline def apply(): PartialClassNameMapImageL = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialClassNameMapImageL]
  }
  
  extension [Self <: PartialClassNameMapImageL](x: Self) {
    ...
    inline def setRootSubtitle(value: String): Self = StObject.set(x, "rootSubtitle", value.asInstanceOf[js.Any])
