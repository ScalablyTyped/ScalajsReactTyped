...
object PartialStyleRulesAvatarCl {
  ...
  extension [Self <: PartialStyleRulesAvatarCl](x: Self) {
    ...
    inline def setCircleFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "circle", js.Any.fromFunction1(value))
    
    inline def setCircleUndefined: Self = StObject.set(x, "circle", js.undefined)
    
    inline def setCircular(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "circular", value.asInstanceOf[js.Any])
    
    inline def setCircularFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "circular", js.Any.fromFunction1(value))
    ...
    inline def setFallbackFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "fallback", js.Any.fromFunction1(value))
    ...
    inline def setImgFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "img", js.Any.fromFunction1(value))
    ...
    inline def setSquare(
      value: CSSProperties | CreateCSSProperties[js.Object] | (PropsFunc[js.Object, CreateCSSProperties[js.Object]])
    ): Self = StObject.set(x, "square", value.asInstanceOf[js.Any])
    
    inline def setSquareFunction1(value: js.Object => CreateCSSProperties[js.Object]): Self = StObject.set(x, "square", js.Any.fromFunction1(value))
