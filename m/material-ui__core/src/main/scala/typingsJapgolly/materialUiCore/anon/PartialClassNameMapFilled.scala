...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/FilledInput/FilledInput.FilledInputClassKey>> */
...
object PartialClassNameMapFilled {
  ...
  inline def apply(): PartialClassNameMapFilled = {
