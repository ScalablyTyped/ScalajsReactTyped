...
/* Inlined std.Partial<@material-ui/core.@material-ui/core/AccordionActions.AccordionActionsProps> */
trait PartialAccordionActionsPr extends StObject {
...
object PartialAccordionActionsPr {
  
  inline def apply(): PartialAccordionActionsPr = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAccordionActionsPr]
  }
  
  extension [Self <: PartialAccordionActionsPr](x: Self) {
