...
trait PartialMenuPropsAccessKey extends StObject {
  ...
  var MenuListProps: js.UndefOr[Partial[typingsJapgolly.materialUiCore.menuListMenuListMod.MenuListProps]] = js.undefined
  ...
  var action: js.UndefOr[typingsJapgolly.react.mod.Ref[PopoverActions]] = js.undefined
...
object PartialMenuPropsAccessKey {
  ...
  inline def apply(): PartialMenuPropsAccessKey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialMenuPropsAccessKey]
  }
  
  extension [Self <: PartialMenuPropsAccessKey](x: Self) {
    ...
    inline def setAction(value: typingsJapgolly.react.mod.Ref[PopoverActions]): Self = StObject.set(x, "action", value.asInstanceOf[js.Any])
    ...
    inline def setOnEscapeKeyDown(value: ReactEventFrom[js.Object & Element] => Callback): Self = StObject.set(x, "onEscapeKeyDown", js.Any.fromFunction1((t0: ReactEventFrom[js.Object & Element]) => value(t0).runNow()))
