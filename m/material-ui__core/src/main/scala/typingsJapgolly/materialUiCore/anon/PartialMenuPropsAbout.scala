...
trait PartialMenuPropsAbout extends StObject {
  ...
  var BackdropProps: js.UndefOr[Partial[typingsJapgolly.materialUiCore.backdropBackdropMod.BackdropProps]] = js.undefined
  
  var MenuListProps: js.UndefOr[Partial[typingsJapgolly.materialUiCore.menuListMenuListMod.MenuListProps]] = js.undefined
  
  var PaperProps: js.UndefOr[Partial[typingsJapgolly.materialUiCore.paperPaperMod.PaperProps]] = js.undefined
