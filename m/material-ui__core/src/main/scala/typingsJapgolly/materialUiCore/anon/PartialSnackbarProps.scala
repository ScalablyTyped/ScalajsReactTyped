...
trait PartialSnackbarProps extends StObject {
  ...
  var ClickAwayListenerProps: js.UndefOr[PartialClickAwayListenerP] = js.undefined
  
  var ContentProps: js.UndefOr[PartialSnackbarContentPro] = js.undefined
  ...
  var classes: js.UndefOr[PartialClassNameMapSnackbAnchorOriginBottomCenter] = js.undefined
  ...
  var ref: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: / * Inlined react.react.HTMLAttributes<std.HTMLDivElement> & std.Partial<@material-ui/core.@material-ui/core/transitions/transition.TransitionHandlerProps> * /
...
object PartialSnackbarProps {
  ...
  extension [Self <: PartialSnackbarProps](x: Self) {
    ...
    inline def setClasses(value: PartialClassNameMapSnackbAnchorOriginBottomCenter): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
    
    inline def setClassesUndefined: Self = StObject.set(x, "classes", js.undefined)
    
    inline def setClickAwayListenerProps(value: PartialClickAwayListenerP): Self = StObject.set(x, "ClickAwayListenerProps", value.asInstanceOf[js.Any])
    ...
    inline def setContentProps(value: PartialSnackbarContentPro): Self = StObject.set(x, "ContentProps", value.asInstanceOf[js.Any])
    ...
    ): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[Any & org.scalajs.dom.Element], t1: /* reason */ SnackbarCloseReason) => (value(t0, t1)).runNow()))
