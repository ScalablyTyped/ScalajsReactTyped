...
/* Inlined std.Partial<@material-ui/styles.@material-ui/styles/withStyles/withStyles.ClassNameMap<@material-ui/core.@material-ui/core/AppBar/AppBar.AppBarClassKey>> */
...
object PartialClassNameMapAppBar {
  ...
  inline def apply(): PartialClassNameMapAppBar = {
