...
/* Inlined std.Partial<react.react.HTMLAttributes<std.HTMLDivElement>> */
trait PartialHTMLAttributesHTML extends StObject {
...
object PartialHTMLAttributesHTML {
  
  inline def apply(): PartialHTMLAttributesHTML = {
