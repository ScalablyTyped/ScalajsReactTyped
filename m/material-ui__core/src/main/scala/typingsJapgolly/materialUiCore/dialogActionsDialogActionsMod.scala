...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapDialogRoot
...
object dialogActionsDialogActionsMod {
  ...
  @JSImport("@material-ui/core/DialogActions/DialogActions", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.spacing
  */
  ...
  object DialogActionsClassKey {
    ...
    inline def spacing: typingsJapgolly.materialUiCore.materialUiCoreStrings.spacing = "spacing".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.spacing]
  }
