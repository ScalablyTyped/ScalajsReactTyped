package typingsJapgolly.materialUiCore.chipChipMod
...
import typingsJapgolly.materialUiCore.PartialClassNameMapChipCl
...
trait ChipProps extends js.Object {
  ...
  var variant: js.UndefOr[typingsJapgolly.materialUiCore.materialUiCoreStrings.default | outlined] = js.native
...
object ChipProps {
  ...
  def apply(
    ...
    variant: typingsJapgolly.materialUiCore.materialUiCoreStrings.default | outlined = null,
    vocab: String = null
  ): ChipProps = {
