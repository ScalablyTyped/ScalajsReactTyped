package typingsJapgolly.materialUiCore.expansionPanelExpansionPanelMod
...
import typingsJapgolly.materialUiCore.PartialClassNameMapExpans
import typingsJapgolly.materialUiCore.PartialCollapseProps
