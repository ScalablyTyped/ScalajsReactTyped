...
@js.native
trait PartialSelectPropsAbout extends js.Object {
  var IconComponent: js.UndefOr[ReactType[_]] = js.native
  var MenuProps: js.UndefOr[PartialMenuPropsAccessKey] = js.native
...
object PartialSelectPropsAbout {
  @scala.inline
  def apply(
    IconComponent: ReactType[_] = null,
    MenuProps: PartialMenuPropsAccessKey = null,
  ...
  (js.Array[java.lang.String | scala.Double | scala.Boolean | js.Object]) | java.lang.String | scala.Double | scala.Boolean | js.Object]) => renderValue(t0).runNow()))
    ...
    __obj.asInstanceOf[PartialSelectPropsAbout]
  }
}
