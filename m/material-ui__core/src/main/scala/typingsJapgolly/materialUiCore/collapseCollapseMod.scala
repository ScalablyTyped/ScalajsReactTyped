...
object collapseCollapseMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.entered
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.hidden
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.wrapper
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.wrapperInner
  */
  trait CollapseClassKey extends StObject
  object CollapseClassKey {
    
    inline def entered: typingsJapgolly.materialUiCore.materialUiCoreStrings.entered = "entered".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.entered]
    
    inline def hidden: typingsJapgolly.materialUiCore.materialUiCoreStrings.hidden = "hidden".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.hidden]
    ...
    inline def wrapperInner: typingsJapgolly.materialUiCore.materialUiCoreStrings.wrapperInner = "wrapperInner".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.wrapperInner]
  }
