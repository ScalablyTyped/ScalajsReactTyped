...
import typingsJapgolly.materialUiCore.anon.PartialDuration
import typingsJapgolly.materialUiCore.anon.PartialEasing
import typingsJapgolly.materialUiCore.anon.Partialdurationnumberstri
