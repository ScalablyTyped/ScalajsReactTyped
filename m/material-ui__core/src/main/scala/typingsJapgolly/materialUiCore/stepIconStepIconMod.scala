...
import typingsJapgolly.materialUiCore.anon.PartialClassNameMapStepIc
...
object stepIconStepIconMod {
  ...
  @JSImport("@material-ui/core/StepIcon/StepIcon", JSImport.Namespace)
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.materialUiCore.materialUiCoreStrings.text
  ...
  */
  ...
  object StepIconClasskey {
    ...
    inline def text: typingsJapgolly.materialUiCore.materialUiCoreStrings.text = "text".asInstanceOf[typingsJapgolly.materialUiCore.materialUiCoreStrings.text]
  }
  
  /* Inlined parent @material-ui/core.@material-ui/core.StandardProps<react.react.HTMLAttributes<std.HTMLDivElement>, @material-ui/core.@material-ui/core/StepIcon/StepIcon.StepIconClasskey, 'children'> */
  trait StepIconProps extends StObject {
    ...
    /**
      ...
      */
    var classes: js.UndefOr[PartialClassNameMapStepIc] = js.undefined
  ...
  object StepIconProps {
    ...
    extension [Self <: StepIconProps](x: Self) {
      ...
      inline def setClasses(value: PartialClassNameMapStepIc): Self = StObject.set(x, "classes", value.asInstanceOf[js.Any])
