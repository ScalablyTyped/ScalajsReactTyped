...
import typingsJapgolly.metroResolver.metroResolverStrings.asset
import typingsJapgolly.metroResolver.metroResolverStrings.assetFiles
import typingsJapgolly.metroResolver.metroResolverStrings.empty
import typingsJapgolly.metroResolver.metroResolverStrings.failed
import typingsJapgolly.metroResolver.metroResolverStrings.resolved
import typingsJapgolly.metroResolver.metroResolverStrings.sourceFile
import typingsJapgolly.metroResolver.typesMod.AssetFileResolution
import typingsJapgolly.metroResolver.typesMod.FileCandidates
import typingsJapgolly.metroResolver.typesMod.FileResolution
import typingsJapgolly.metroResolver.typesMod.Result
...
object anon {
  ...
  trait Type
    extends StObject
       with typingsJapgolly.metroResolver.typesMod.Resolution {
