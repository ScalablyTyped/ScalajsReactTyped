...
import typingsJapgolly.monacoEditor.monacoEditorStrings.fill
import typingsJapgolly.monacoEditor.monacoEditorStrings.fit
...
import typingsJapgolly.monacoEditor.monacoEditorStrings.proportional
