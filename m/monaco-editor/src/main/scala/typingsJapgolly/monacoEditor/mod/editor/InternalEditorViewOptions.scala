...
object InternalEditorViewOptions {
  ...
  def apply(
    ...
    renderCustomLineNumbers: /* lineNumber */ Double => CallbackTo[String] = null
    ...
    if (renderCustomLineNumbers != null) __obj.updateDynamic("renderCustomLineNumbers")(js.Any.fromFunction1((t0: /* lineNumber */ scala.Double) => renderCustomLineNumbers(t0).runNow()))
