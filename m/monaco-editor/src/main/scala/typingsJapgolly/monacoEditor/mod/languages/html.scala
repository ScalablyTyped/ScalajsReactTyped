...
import typingsJapgolly.monacoEditor.monacoEditorStrings.`force-aligned`
import typingsJapgolly.monacoEditor.monacoEditorStrings.`force-expand-multiline`
import typingsJapgolly.monacoEditor.monacoEditorStrings.auto
import typingsJapgolly.monacoEditor.monacoEditorStrings.force
...
object html {
  ...
  object LanguageServiceRegistration {
    ...
    inline def apply(defaults: LanguageServiceDefaults, dispose: Callback): LanguageServiceRegistration = {
      val __obj = js.Dynamic.literal(defaults = defaults.asInstanceOf[js.Any], dispose = dispose.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.monacoEditor.monacoEditorStrings.plaintext
    - typingsJapgolly.monacoEditor.monacoEditorStrings.markdown
  */
  trait MarkupKind extends StObject
  object MarkupKind {
    
    inline def markdown: typingsJapgolly.monacoEditor.monacoEditorStrings.markdown = "markdown".asInstanceOf[typingsJapgolly.monacoEditor.monacoEditorStrings.markdown]
    
    inline def plaintext: typingsJapgolly.monacoEditor.monacoEditorStrings.plaintext = "plaintext".asInstanceOf[typingsJapgolly.monacoEditor.monacoEditorStrings.plaintext]
  }
