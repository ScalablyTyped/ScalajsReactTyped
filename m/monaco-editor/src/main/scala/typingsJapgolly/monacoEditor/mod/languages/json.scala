...
import typingsJapgolly.monacoEditor.anon.FileMatch
...
object json {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.monacoEditor.monacoEditorStrings.error
    - typingsJapgolly.monacoEditor.monacoEditorStrings.warning
    - typingsJapgolly.monacoEditor.monacoEditorStrings.ignore
  */
  trait SeverityLevel extends StObject
  object SeverityLevel {
    
    inline def error: typingsJapgolly.monacoEditor.monacoEditorStrings.error = "error".asInstanceOf[typingsJapgolly.monacoEditor.monacoEditorStrings.error]
    
    inline def ignore: typingsJapgolly.monacoEditor.monacoEditorStrings.ignore = "ignore".asInstanceOf[typingsJapgolly.monacoEditor.monacoEditorStrings.ignore]
    
    inline def warning: typingsJapgolly.monacoEditor.monacoEditorStrings.warning = "warning".asInstanceOf[typingsJapgolly.monacoEditor.monacoEditorStrings.warning]
  }
}
