...
object IActionDescriptor {
  ...
  def apply(
    id: String,
    label: String,
    run: ICodeEditor => CallbackTo[Unit | js.Promise[Unit]],
    ...
    __obj.updateDynamic("run")(js.Any.fromFunction1((t0: typingsJapgolly.monacoEditor.mod.editor.ICodeEditor) => run(t0).runNow()))
