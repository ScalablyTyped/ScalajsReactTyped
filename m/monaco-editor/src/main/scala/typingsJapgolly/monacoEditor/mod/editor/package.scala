...
import typingsJapgolly.monacoEditor.mod.editor.^
import typingsJapgolly.monacoEditor.monacoEditorStrings.inUntrustedWorkspace
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.monacoEditor.monacoEditorStrings.on
  - typingsJapgolly.monacoEditor.monacoEditorStrings.off
  - typingsJapgolly.monacoEditor.monacoEditorStrings.relative
  - typingsJapgolly.monacoEditor.monacoEditorStrings.interval
