...
trait CodeActionProviderMetadata extends StObject {
  ...
  val documentation: js.UndefOr[js.Array[typingsJapgolly.monacoEditor.anon.Command]] = js.undefined
...
object CodeActionProviderMetadata {
  ...
  extension [Self <: CodeActionProviderMetadata](x: Self) {
    ...
    inline def setDocumentation(value: js.Array[typingsJapgolly.monacoEditor.anon.Command]): Self = StObject.set(x, "documentation", value.asInstanceOf[js.Any])
    
    inline def setDocumentationUndefined: Self = StObject.set(x, "documentation", js.undefined)
    
    inline def setDocumentationVarargs(value: typingsJapgolly.monacoEditor.anon.Command*): Self = StObject.set(x, "documentation", js.Array(value*))
