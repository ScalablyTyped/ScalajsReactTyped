...
trait IEditor extends StObject {
  ...
  /**
    ...
    */
  def createDecorationsCollection(): IEditorDecorationsCollection = js.native
  def createDecorationsCollection(decorations: js.Array[IModelDeltaDecoration]): IEditorDecorationsCollection = js.native
  ...
  /**
    ...
    */
  def restoreViewState(): Unit = js.native
  ...
  def setPosition(position: IPosition, source: String): Unit = js.native
  ...
  def setSelection(selection: IRange, source: String): Unit = js.native
  /**
    * Set the primary selection of the editor. This will remove any secondary cursors.
    * @param selection The new selection
    * @param source Source of the call that caused the selection
  ...
  def setSelection(selection: ISelection, source: String): Unit = js.native
  /**
    * Set the primary selection of the editor. This will remove any secondary cursors.
    * @param selection The new selection
    * @param source Source of the call that caused the selection
  ...
  def setSelection(selection: Range, source: String): Unit = js.native
  /**
    * Set the primary selection of the editor. This will remove any secondary cursors.
    * @param selection The new selection
    * @param source Source of the call that caused the selection
  ...
  def setSelection(selection: Selection, source: String): Unit = js.native
  ...
  def setSelections(selections: js.Array[ISelection], source: String): Unit = js.native
  ...
  /**
    ...
    */
  def trigger(source: String, handlerId: String, payload: Any): Unit = js.native
  def trigger(source: Null, handlerId: String, payload: Any): Unit = js.native
  def trigger(source: Unit, handlerId: String, payload: Any): Unit = js.native
