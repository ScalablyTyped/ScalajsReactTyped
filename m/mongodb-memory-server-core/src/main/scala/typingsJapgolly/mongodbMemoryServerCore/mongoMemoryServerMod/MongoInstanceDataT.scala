package typingsJapgolly.mongodbMemoryServerCore.mongoMemoryServerMod
...
trait MongoInstanceDataT extends StartupInstanceData {
  ...
  var instance: typingsJapgolly.mongodbMemoryServerCore.mongoInstanceMod.default
  @JSName("uri")
...
object MongoInstanceDataT {
  ...
  def apply(
    dbName: String,
    dbPath: String,
    instance: typingsJapgolly.mongodbMemoryServerCore.mongoInstanceMod.default,
    ip: String,
    port: Double,
