...
import typingsJapgolly.mongodbMemoryServerCore.anon.RequiredReplSetOpts
import typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryServerMod.AutomaticAuth
import typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryServerMod.MongoMemoryServer
...
import typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoMemoryInstanceOptsBase
...
object libMongoMemoryReplSetMod {
  ...
  - typingsJapgolly.mongodbMemoryServerCore.libUtilUtilsMod.ManagerAdvanced because Inheritance from two classes. Inlined getUri, getUri, getUri, cleanup, cleanup */ @JSImport("mongodb-memory-server-core/lib/MongoMemoryReplSet", "MongoMemoryReplSet")
  @js.native
  ...
  object MongoMemoryReplSetEvents extends StObject {
    ...
    /* "stateChange" */ val stateChange: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryReplSetMod.MongoMemoryReplSetEvents.stateChange & String = js.native
  }
  ...
  object MongoMemoryReplSetStates extends StObject {
    ...
    /* "init" */ val init: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryReplSetMod.MongoMemoryReplSetStates.init & String = js.native
    
    @js.native
    sealed trait running
      extends StObject
         with MongoMemoryReplSetStates
    /* "running" */ val running: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryReplSetMod.MongoMemoryReplSetStates.running & String = js.native
    
    @js.native
    sealed trait stopped
      extends StObject
         with MongoMemoryReplSetStates
    /* "stopped" */ val stopped: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryReplSetMod.MongoMemoryReplSetStates.stopped & String = js.native
  }
