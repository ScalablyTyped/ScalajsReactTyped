...
import typingsJapgolly.mongodbMemoryServerCore.anon.ClientSource
import typingsJapgolly.mongodbMemoryServerCore.anon.Db
import typingsJapgolly.mongodbMemoryServerCore.anon.PartialMongodOpts
import typingsJapgolly.mongodbMemoryServerCore.anon.RequiredAutomaticAuth
import typingsJapgolly.mongodbMemoryServerCore.libUtilMongoBinaryMod.MongoBinaryOpts
import typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstance
import typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoMemoryInstanceOpts
import typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.StorageEngine
import typingsJapgolly.mongodbMemoryServerCore.libUtilUtilsMod.Cleanup
import typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.`SCRAM-SHA-1`
import typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.`SCRAM-SHA-256`
...
object libMongoMemoryServerMod {
  ...
  - typingsJapgolly.mongodbMemoryServerCore.libUtilUtilsMod.ManagerBase because Inheritance from two classes. Inlined start, start, stop, stop
  - typingsJapgolly.mongodbMemoryServerCore.libUtilUtilsMod.ManagerAdvanced because Inheritance from two classes. Inlined getUri, getUri, getUri, cleanup, cleanup */ @JSImport("mongodb-memory-server-core/lib/MongoMemoryServer", "MongoMemoryServer")
  @js.native
  /**
    * Create an Mongo-Memory-Sever Instance
    * @param opts Mongo-Memory-Sever Options
  ...
  object MongoMemoryServerEvents extends StObject {
    ...
    /* "stateChange" */ val stateChange: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryServerMod.MongoMemoryServerEvents.stateChange & String = js.native
  }
  ...
  object MongoMemoryServerStates extends StObject {
    ...
    /* "new" */ val `new`: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryServerMod.MongoMemoryServerStates.`new` & String = js.native
    
    @js.native
    sealed trait running
      extends StObject
         with MongoMemoryServerStates
    /* "running" */ val running: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryServerMod.MongoMemoryServerStates.running & String = js.native
    
    @js.native
    sealed trait starting
      extends StObject
         with MongoMemoryServerStates
    /* "starting" */ val starting: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryServerMod.MongoMemoryServerStates.starting & String = js.native
    
    @js.native
    sealed trait stopped
      extends StObject
         with MongoMemoryServerStates
    /* "stopped" */ val stopped: typingsJapgolly.mongodbMemoryServerCore.libMongoMemoryServerMod.MongoMemoryServerStates.stopped & String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.read
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.readWrite
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.dbAdmin
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.dbOwner
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.userAdmin
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.clusterAdmin
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.clusterManager
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.clusterMonitor
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.hostManager
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.backup
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.restore
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.readAnyDatabase
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.readWriteAnyDatabase
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.userAdminAnyDatabase
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.dbAdminAnyDatabase
    - typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.root
    - java.lang.String
  */
