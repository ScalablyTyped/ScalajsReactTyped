...
import typingsJapgolly.mongodbMemoryServerCore.anon.ReadonlyMongoBinaryOpts
import typingsJapgolly.mongodbMemoryServerCore.anon.ReadonlySpawnOptions
...
object libUtilMongoInstanceMod {
  ...
  - typingsJapgolly.mongodbMemoryServerCore.libUtilUtilsMod.ManagerBase because Inheritance from two classes. Inlined start, start, stop, stop */ @JSImport("mongodb-memory-server-core/lib/util/MongoInstance", "MongoInstance")
  @js.native
  ...
  object MongoInstanceEvents extends StObject {
    ...
    /* "instanceClosed" */ val instanceClosed: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceClosed & String = js.native
    ...
    sealed trait instanceError
      extends StObject
         with MongoInstanceEvents
    /* "instanceError" */ val instanceError: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceError & String = js.native
    
    @js.native
    sealed trait instanceLaunched
      extends StObject
         with MongoInstanceEvents
    /* "instanceLaunched" */ val instanceLaunched: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceLaunched & String = js.native
    
    @js.native
    sealed trait instancePrimary
      extends StObject
         with MongoInstanceEvents
    /* "instancePrimary" */ val instancePrimary: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instancePrimary & String = js.native
    ...
    sealed trait instanceRawError
      extends StObject
         with MongoInstanceEvents
    /* "instanceRawError" */ val instanceRawError: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceRawError & String = js.native
    
    @js.native
    sealed trait instanceReady
      extends StObject
         with MongoInstanceEvents
    /* "instanceReady" */ val instanceReady: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceReady & String = js.native
    
    @js.native
    sealed trait instanceReplState
      extends StObject
         with MongoInstanceEvents
    /* "instanceReplState" */ val instanceReplState: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceReplState & String = js.native
    
    @js.native
    sealed trait instanceSTDERR
      extends StObject
         with MongoInstanceEvents
    /* "instanceSTDERR" */ val instanceSTDERR: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceSTDERR & String = js.native
    
    @js.native
    sealed trait instanceSTDOUT
      extends StObject
         with MongoInstanceEvents
    /* "instanceSTDOUT" */ val instanceSTDOUT: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceSTDOUT & String = js.native
    
    @js.native
    sealed trait instanceStarted
      extends StObject
         with MongoInstanceEvents
    /* "instanceStarted" */ val instanceStarted: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.instanceStarted & String = js.native
    
    @js.native
    sealed trait killerLaunched
      extends StObject
         with MongoInstanceEvents
    /* "killerLaunched" */ val killerLaunched: typingsJapgolly.mongodbMemoryServerCore.libUtilMongoInstanceMod.MongoInstanceEvents.killerLaunched & String = js.native
  }
  ...
  */
  ...
  object StorageEngine {
    ...
    inline def devnull: typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.devnull = "devnull".asInstanceOf[typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.devnull]
    
    inline def ephemeralForTest: typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.ephemeralForTest = "ephemeralForTest".asInstanceOf[typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.ephemeralForTest]
    
    inline def mmapv1: typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.mmapv1 = "mmapv1".asInstanceOf[typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.mmapv1]
    
    inline def wiredTiger: typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.wiredTiger = "wiredTiger".asInstanceOf[typingsJapgolly.mongodbMemoryServerCore.mongodbMemoryServerCoreStrings.wiredTiger]
  }
}
