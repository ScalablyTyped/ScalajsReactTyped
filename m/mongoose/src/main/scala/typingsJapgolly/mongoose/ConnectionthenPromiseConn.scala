...
import typingsJapgolly.mongoose.mod.Collection
...
import typingsJapgolly.mongoose.mongooseStrings.autoCreate
import typingsJapgolly.mongoose.mongooseStrings.autoIndex
import typingsJapgolly.mongoose.mongooseStrings.bufferCommands
import typingsJapgolly.mongoose.mongooseStrings.useCreateIndex
import typingsJapgolly.mongoose.mongooseStrings.useFindAndModify
...
trait ConnectionthenPromiseConn extends js.Object {
  ...
  def createCollection[T](name: String): js.Promise[typingsJapgolly.mongodb.mod.Collection[T]] = js.native
  def createCollection[T](
    name: String,
    cb: js.Function2[/* err */ js.Any, /* collection */ typingsJapgolly.mongodb.mod.Collection[T], Unit]
  ): js.Promise[Unit] = js.native
  def createCollection[T](name: String, options: CollectionCreateOptions): js.Promise[typingsJapgolly.mongodb.mod.Collection[T]] = js.native
  def createCollection[T](
    name: String,
    options: CollectionCreateOptions,
    cb: js.Function2[
      /* err */ js.Any, 
      /* collection */ typingsJapgolly.mongodb.mod.Collection[DefaultSchema], 
      Unit
    ]
  ): js.Promise[typingsJapgolly.mongodb.mod.Collection[T]] = js.native
  /**
