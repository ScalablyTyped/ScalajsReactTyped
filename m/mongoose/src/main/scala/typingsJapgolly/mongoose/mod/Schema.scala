...
import typingsJapgolly.mongoose.AnonDictother
import typingsJapgolly.mongoose.AnonJ
import typingsJapgolly.mongoose.AnonLength
import typingsJapgolly.mongoose.mongooseStrings._id
import typingsJapgolly.mongoose.mongooseStrings.`throw`
import typingsJapgolly.mongoose.mongooseStrings.aggregate
import typingsJapgolly.mongoose.mongooseStrings.autoIndex
import typingsJapgolly.mongoose.mongooseStrings.bufferCommands
import typingsJapgolly.mongoose.mongooseStrings.capped
import typingsJapgolly.mongoose.mongooseStrings.collation
import typingsJapgolly.mongoose.mongooseStrings.collection
import typingsJapgolly.mongoose.mongooseStrings.count
import typingsJapgolly.mongoose.mongooseStrings.discriminatorKey
import typingsJapgolly.mongoose.mongooseStrings.emitIndexErrors
import typingsJapgolly.mongoose.mongooseStrings.excludeIndexes
import typingsJapgolly.mongoose.mongooseStrings.find
import typingsJapgolly.mongoose.mongooseStrings.findOne
import typingsJapgolly.mongoose.mongooseStrings.findOneAndRemove
import typingsJapgolly.mongoose.mongooseStrings.findOneAndUpdate
import typingsJapgolly.mongoose.mongooseStrings.id
import typingsJapgolly.mongoose.mongooseStrings.init
import typingsJapgolly.mongoose.mongooseStrings.insertMany
import typingsJapgolly.mongoose.mongooseStrings.minimize
import typingsJapgolly.mongoose.mongooseStrings.read
import typingsJapgolly.mongoose.mongooseStrings.remove
import typingsJapgolly.mongoose.mongooseStrings.safe
import typingsJapgolly.mongoose.mongooseStrings.save
import typingsJapgolly.mongoose.mongooseStrings.selectPopulatedPaths
import typingsJapgolly.mongoose.mongooseStrings.shardKey
import typingsJapgolly.mongoose.mongooseStrings.skipVersioning
import typingsJapgolly.mongoose.mongooseStrings.storeSubdocValidationError
import typingsJapgolly.mongoose.mongooseStrings.strict
import typingsJapgolly.mongoose.mongooseStrings.timestamps
import typingsJapgolly.mongoose.mongooseStrings.toJSON
import typingsJapgolly.mongoose.mongooseStrings.toObject
import typingsJapgolly.mongoose.mongooseStrings.typeKey
import typingsJapgolly.mongoose.mongooseStrings.typePojoToMixed
import typingsJapgolly.mongoose.mongooseStrings.update
import typingsJapgolly.mongoose.mongooseStrings.updateMany
import typingsJapgolly.mongoose.mongooseStrings.updateOne
import typingsJapgolly.mongoose.mongooseStrings.useNestedStrict
import typingsJapgolly.mongoose.mongooseStrings.usePushEach
import typingsJapgolly.mongoose.mongooseStrings.validate
import typingsJapgolly.mongoose.mongooseStrings.validateBeforeSave
import typingsJapgolly.mongoose.mongooseStrings.versionKey
import typingsJapgolly.mongoose.mongooseStrings.writeConcern
...
trait Schema[T] extends EventEmitter {
  ...
  {[ F in keyof T ]: T[F]}
    */ typingsJapgolly.mongoose.mongooseStrings.Schema with T = js.native
  ...
  {[ F in keyof T ]: T[F]}
    */ typingsJapgolly.mongoose.mongooseStrings.Schema with T
  ): this.type = js.native
  /**
