...
import typingsJapgolly.mongoose.ConnectionthenPromiseConnAddListener
import typingsJapgolly.mongoose.TypeofSchema
import typingsJapgolly.mongoose.Typeofmongoose
...
trait Mongoose extends js.Object {
  ...
  def model[T /* <: Document */](name: String, schema: typingsJapgolly.mongoose.mod.Schema[_]): Model_[T, js.Object] = js.native
  def model[T /* <: Document */](name: String, schema: typingsJapgolly.mongoose.mod.Schema[_], collection: String): Model_[T, js.Object] = js.native
  def model[T /* <: Document */](
    name: String,
    schema: typingsJapgolly.mongoose.mod.Schema[_],
    collection: String,
    skipInit: Boolean
  ...
  @JSName("model")
  def model_T_DocumentU_Model_TObject_U[T /* <: Document */, U /* <: Model_[T, js.Object] */](name: String, schema: typingsJapgolly.mongoose.mod.Schema[_]): U = js.native
  @JSName("model")
  def model_T_DocumentU_Model_TObject_U[T /* <: Document */, U /* <: Model_[T, js.Object] */](name: String, schema: typingsJapgolly.mongoose.mod.Schema[_], collection: String): U = js.native
  @JSName("model")
