...
import typingsJapgolly.mongoose.TypeofArray
import typingsJapgolly.mongoose.TypeofBoolean
import typingsJapgolly.mongoose.TypeofBuffer
import typingsJapgolly.mongoose.TypeofDate
import typingsJapgolly.mongoose.TypeofDecimal128
import typingsJapgolly.mongoose.TypeofDocumentArray
import typingsJapgolly.mongoose.TypeofMixed
import typingsJapgolly.mongoose.TypeofNumber
import typingsJapgolly.mongoose.TypeofObjectId
import typingsJapgolly.mongoose.TypeofString
  ...
  object Embedded
    extends TopLevel[
          Instantiable3[
            ...
            typingsJapgolly.mongoose.mod.Schema.Types.Embedded
          ]
        ]
  ...
  object Map
    extends TopLevel[
          Instantiable2[
            /* key */ String, 
            js.UndefOr[/* options */ js.Any], 
            typingsJapgolly.mongoose.mod.Schema.Types.Map
          ]
        ]
