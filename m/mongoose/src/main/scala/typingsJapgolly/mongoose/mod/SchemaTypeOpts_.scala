...
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.AsyncPromiseValidationFn
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.AsyncPromiseValidationOpts
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.AsyncValidateOpts
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.DefaultFn
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.EnumOpts
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.IndexOpts
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.RequiredFn
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.ValidateFn
import typingsJapgolly.mongoose.mod.SchemaTypeOpts.ValidateOpts
...
object SchemaTypeOpts_ {
  ...
  def apply[T](
    ...
    get: (/* value */ T, /* schematype */ js.UndefOr[SchemaTypeOpts_[T]]) => CallbackTo[T | js.Any] = null,
    ...
    set: (/* value */ T, /* schematype */ js.UndefOr[SchemaTypeOpts_[T]]) => CallbackTo[T | js.Any] = null,
    ...
    if (get != null) __obj.updateDynamic("get")(js.Any.fromFunction2((t0: /* value */ T, t1: /* schematype */ js.UndefOr[typingsJapgolly.mongoose.mod.SchemaTypeOpts_[T]]) => get(t0, t1).runNow()))
    ...
    if (set != null) __obj.updateDynamic("set")(js.Any.fromFunction2((t0: /* value */ T, t1: /* schematype */ js.UndefOr[typingsJapgolly.mongoose.mod.SchemaTypeOpts_[T]]) => set(t0, t1).runNow()))
