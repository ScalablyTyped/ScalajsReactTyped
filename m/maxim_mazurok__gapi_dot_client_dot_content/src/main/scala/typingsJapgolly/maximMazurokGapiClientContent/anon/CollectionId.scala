...
object CollectionId {
  ...
  inline def apply(collectionId: String, merchantId: String): CollectionId = {
    val __obj = js.Dynamic.literal(collectionId = collectionId.asInstanceOf[js.Any], merchantId = merchantId.asInstanceOf[js.Any])
