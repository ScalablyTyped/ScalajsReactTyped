...
trait TransactionIds extends StObject {
  ...
  var transactionIds: js.UndefOr[String | js.Array[String]] = js.undefined
...
object TransactionIds {
  ...
  inline def apply(merchantId: String, settlementId: String): TransactionIds = {
  ...
  extension [Self <: TransactionIds](x: Self) {
    ...
    inline def setTransactionIds(value: String | js.Array[String]): Self = StObject.set(x, "transactionIds", value.asInstanceOf[js.Any])
