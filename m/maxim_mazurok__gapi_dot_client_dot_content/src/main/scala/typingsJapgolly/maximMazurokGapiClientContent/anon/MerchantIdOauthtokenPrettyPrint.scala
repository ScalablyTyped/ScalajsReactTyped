...
import typingsJapgolly.maximMazurokGapiClientContent.gapi.client.content.OrdersCreateTestOrderRequest
...
object MerchantIdOauthtokenPrettyPrint {
  ...
  extension [Self <: MerchantIdOauthtokenPrettyPrint](x: Self) {
