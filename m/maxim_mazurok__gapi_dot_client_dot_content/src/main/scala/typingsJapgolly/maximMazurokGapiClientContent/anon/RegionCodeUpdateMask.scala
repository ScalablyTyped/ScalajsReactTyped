...
trait RegionCodeUpdateMask extends StObject {
...
object RegionCodeUpdateMask {
  
  inline def apply(merchantId: String, regionCode: String): RegionCodeUpdateMask = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any], regionCode = regionCode.asInstanceOf[js.Any])
    __obj.asInstanceOf[RegionCodeUpdateMask]
  }
  
  extension [Self <: RegionCodeUpdateMask](x: Self) {
