...
import typingsJapgolly.maximMazurokGapiClientContent.gapi.client.content.AccountReturnCarrier
...
object PrettyPrint {
  ...
  inline def apply(accountId: String, resource: AccountReturnCarrier): PrettyPrint = {
