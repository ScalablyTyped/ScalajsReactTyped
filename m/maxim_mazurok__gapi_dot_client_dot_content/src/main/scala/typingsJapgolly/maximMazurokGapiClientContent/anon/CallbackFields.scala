...
import typingsJapgolly.maximMazurokGapiClientContent.gapi.client.content.Account
...
object CallbackFields {
  ...
  inline def apply(accountId: String, merchantId: String, resource: Account): CallbackFields = {
