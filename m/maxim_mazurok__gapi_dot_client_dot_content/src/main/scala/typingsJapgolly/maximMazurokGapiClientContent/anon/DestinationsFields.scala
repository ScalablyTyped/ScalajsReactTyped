...
trait DestinationsFields extends StObject {
...
object DestinationsFields {
  
  inline def apply(merchantId: String): DestinationsFields = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any])
    __obj.asInstanceOf[DestinationsFields]
  }
  
  extension [Self <: DestinationsFields](x: Self) {
