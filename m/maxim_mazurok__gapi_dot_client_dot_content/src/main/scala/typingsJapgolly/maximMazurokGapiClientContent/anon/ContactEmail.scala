...
object ContactEmail {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], contactEmail = contactEmail.asInstanceOf[js.Any], contactName = contactName.asInstanceOf[js.Any], country = country.asInstanceOf[js.Any], language = language.asInstanceOf[js.Any], merchantId = merchantId.asInstanceOf[js.Any])
