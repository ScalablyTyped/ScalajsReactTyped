...
import typingsJapgolly.maximMazurokGapiClientContent.gapi.client.content.Region
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait RegionId extends StObject {
...
object RegionId {
  ...
  inline def apply(merchantId: String, resource: Region): RegionId = {
    val __obj = js.Dynamic.literal(merchantId = merchantId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[RegionId]
  }
  
  extension [Self <: RegionId](x: Self) {
