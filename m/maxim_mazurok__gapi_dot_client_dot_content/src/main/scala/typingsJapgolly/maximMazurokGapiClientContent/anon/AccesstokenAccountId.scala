...
import typingsJapgolly.maximMazurokGapiClientContent.gapi.client.content.AccountsLinkRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AccesstokenAccountId extends StObject {
...
object AccesstokenAccountId {
  
  inline def apply(accountId: String, merchantId: String, resource: AccountsLinkRequest): AccesstokenAccountId = {
    ...
    __obj.asInstanceOf[AccesstokenAccountId]
  }
  
  extension [Self <: AccesstokenAccountId](x: Self) {
