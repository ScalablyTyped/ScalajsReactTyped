...
trait GoogleCloudAssuredworkloadsV1WorkloadResourceSettings extends StObject {
...
object GoogleCloudAssuredworkloadsV1WorkloadResourceSettings {
  ...
  inline def apply(): GoogleCloudAssuredworkloadsV1WorkloadResourceSettings = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudAssuredworkloadsV1WorkloadResourceSettings]
  }
  
  extension [Self <: GoogleCloudAssuredworkloadsV1WorkloadResourceSettings](x: Self) {
