...
trait GoogleCloudAssuredworkloadsV1Workload extends StObject {
  ...
  /**
    ...
    */
  var resourceSettings: js.UndefOr[js.Array[GoogleCloudAssuredworkloadsV1WorkloadResourceSettings]] = js.undefined
  ...
  /**
    ...
    */
  var saaEnrollmentResponse: js.UndefOr[GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponse] = js.undefined
}
object GoogleCloudAssuredworkloadsV1Workload {
  ...
  extension [Self <: GoogleCloudAssuredworkloadsV1Workload](x: Self) {
    ...
    inline def setResourceSettings(value: js.Array[GoogleCloudAssuredworkloadsV1WorkloadResourceSettings]): Self = StObject.set(x, "resourceSettings", value.asInstanceOf[js.Any])
    
    inline def setResourceSettingsUndefined: Self = StObject.set(x, "resourceSettings", js.undefined)
    
    inline def setResourceSettingsVarargs(value: GoogleCloudAssuredworkloadsV1WorkloadResourceSettings*): Self = StObject.set(x, "resourceSettings", js.Array(value*))
    ...
    inline def setResourcesVarargs(value: GoogleCloudAssuredworkloadsV1WorkloadResourceInfo*): Self = StObject.set(x, "resources", js.Array(value*))
    
    inline def setSaaEnrollmentResponse(value: GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponse): Self = StObject.set(x, "saaEnrollmentResponse", value.asInstanceOf[js.Any])
