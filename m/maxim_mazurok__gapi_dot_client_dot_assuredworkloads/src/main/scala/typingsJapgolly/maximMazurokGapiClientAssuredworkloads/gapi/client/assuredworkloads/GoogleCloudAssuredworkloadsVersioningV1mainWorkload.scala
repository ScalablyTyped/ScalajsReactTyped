...
trait GoogleCloudAssuredworkloadsVersioningV1mainWorkload extends StObject {
  ...
  var cjisSettings: js.UndefOr[GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJISSettings] = js.undefined
  
  /** Required. Immutable. Compliance Regime associated with this workload. */
  var complianceRegime: js.UndefOr[String] = js.undefined
  
  /** Output only. Count of active Violations in the Workload. */
  var complianceStatus: js.UndefOr[GoogleCloudAssuredworkloadsVersioningV1mainWorkloadComplianceStatus] = js.undefined
  ...
  var fedrampHighSettings: js.UndefOr[GoogleCloudAssuredworkloadsVersioningV1mainWorkloadFedrampHighSettings] = js.undefined
  
  /** Required. Input only. Immutable. Settings specific to resources needed for FedRAMP Moderate. */
  var fedrampModerateSettings: js.UndefOr[GoogleCloudAssuredworkloadsVersioningV1mainWorkloadFedrampModerateSettings] = js.undefined
  
  /** Required. Input only. Immutable. Settings specific to resources needed for IL4. */
  var il4Settings: js.UndefOr[GoogleCloudAssuredworkloadsVersioningV1mainWorkloadIL4Settings] = js.undefined
  ...
  /**
    ...
    */
  var resources: js.UndefOr[js.Array[GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceInfo]] = js.undefined
  ...
  /**
    ...
    */
  var saaEnrollmentResponse: js.UndefOr[GoogleCloudAssuredworkloadsVersioningV1mainWorkloadSaaEnrollmentResponse] = js.undefined
}
object GoogleCloudAssuredworkloadsVersioningV1mainWorkload {
  
  inline def apply(): GoogleCloudAssuredworkloadsVersioningV1mainWorkload = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudAssuredworkloadsVersioningV1mainWorkload]
  }
  
  extension [Self <: GoogleCloudAssuredworkloadsVersioningV1mainWorkload](x: Self) {
    ...
    inline def setCjisSettings(value: GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJISSettings): Self = StObject.set(x, "cjisSettings", value.asInstanceOf[js.Any])
    ...
    inline def setComplianceStatus(value: GoogleCloudAssuredworkloadsVersioningV1mainWorkloadComplianceStatus): Self = StObject.set(x, "complianceStatus", value.asInstanceOf[js.Any])
    ...
    inline def setFedrampHighSettings(value: GoogleCloudAssuredworkloadsVersioningV1mainWorkloadFedrampHighSettings): Self = StObject.set(x, "fedrampHighSettings", value.asInstanceOf[js.Any])
    
    inline def setFedrampHighSettingsUndefined: Self = StObject.set(x, "fedrampHighSettings", js.undefined)
    
    inline def setFedrampModerateSettings(value: GoogleCloudAssuredworkloadsVersioningV1mainWorkloadFedrampModerateSettings): Self = StObject.set(x, "fedrampModerateSettings", value.asInstanceOf[js.Any])
    
    inline def setFedrampModerateSettingsUndefined: Self = StObject.set(x, "fedrampModerateSettings", js.undefined)
    
    inline def setIl4Settings(value: GoogleCloudAssuredworkloadsVersioningV1mainWorkloadIL4Settings): Self = StObject.set(x, "il4Settings", value.asInstanceOf[js.Any])
    ...
    inline def setResources(value: js.Array[GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceInfo]): Self = StObject.set(x, "resources", value.asInstanceOf[js.Any])
    
    inline def setResourcesUndefined: Self = StObject.set(x, "resources", js.undefined)
    
    inline def setResourcesVarargs(value: GoogleCloudAssuredworkloadsVersioningV1mainWorkloadResourceInfo*): Self = StObject.set(x, "resources", js.Array(value*))
    
    inline def setSaaEnrollmentResponse(value: GoogleCloudAssuredworkloadsVersioningV1mainWorkloadSaaEnrollmentResponse): Self = StObject.set(x, "saaEnrollmentResponse", value.asInstanceOf[js.Any])
