...
import typingsJapgolly.maximMazurokGapiClientAssuredworkloads.gapi.client.assuredworkloads.GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesRequest
import typingsJapgolly.maximMazurokGapiClientAssuredworkloads.gapi.client.assuredworkloads.GoogleCloudAssuredworkloadsV1Workload
...
object anon {
  ...
  trait Callback extends StObject {
    ...
    /** Request body */
    var resource: GoogleCloudAssuredworkloadsV1Workload
  ...
  object Callback {
    ...
    inline def apply(parent: String, resource: GoogleCloudAssuredworkloadsV1Workload): Callback = {
    ...
    extension [Self <: Callback](x: Self) {
      ...
      inline def setResource(value: GoogleCloudAssuredworkloadsV1Workload): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object ExternalId {
    ...
    inline def apply(parent: String): ExternalId = {
  ...
  object Key {
    ...
    inline def apply(name: String, resource: GoogleCloudAssuredworkloadsV1Workload): Key = {
  ...
  trait Oauthtoken extends StObject {
    ...
    /** Request body */
    var resource: GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesRequest
  ...
  object Oauthtoken {
    ...
    inline def apply(name: String, resource: GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesRequest): Oauthtoken = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: Oauthtoken](x: Self) {
      ...
      inline def setResource(value: GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
