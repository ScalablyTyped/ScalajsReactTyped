...
trait RunWorkflowCustomOperationMetadata extends StObject {
  ...
  var pipelineRunId: js.UndefOr[String] = js.undefined
...
object RunWorkflowCustomOperationMetadata {
  ...
  inline def apply(): RunWorkflowCustomOperationMetadata = {
  ...
  extension [Self <: RunWorkflowCustomOperationMetadata](x: Self) {
    ...
    inline def setPipelineRunId(value: String): Self = StObject.set(x, "pipelineRunId", value.asInstanceOf[js.Any])
    
    inline def setPipelineRunIdUndefined: Self = StObject.set(x, "pipelineRunId", js.undefined)
