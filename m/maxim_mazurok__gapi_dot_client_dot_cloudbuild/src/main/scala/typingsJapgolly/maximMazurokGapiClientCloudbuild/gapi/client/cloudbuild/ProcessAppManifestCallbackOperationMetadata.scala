...
trait ProcessAppManifestCallbackOperationMetadata extends StObject {
...
object ProcessAppManifestCallbackOperationMetadata {
  
  inline def apply(): ProcessAppManifestCallbackOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ProcessAppManifestCallbackOperationMetadata]
  }
  
  extension [Self <: ProcessAppManifestCallbackOperationMetadata](x: Self) {
