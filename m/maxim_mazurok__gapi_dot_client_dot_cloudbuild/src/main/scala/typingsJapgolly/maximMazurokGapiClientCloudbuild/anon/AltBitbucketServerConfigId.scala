...
trait AltBitbucketServerConfigId extends StObject {
...
object AltBitbucketServerConfigId {
  
  inline def apply(parent: String): AltBitbucketServerConfigId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltBitbucketServerConfigId]
  }
  
  extension [Self <: AltBitbucketServerConfigId](x: Self) {
