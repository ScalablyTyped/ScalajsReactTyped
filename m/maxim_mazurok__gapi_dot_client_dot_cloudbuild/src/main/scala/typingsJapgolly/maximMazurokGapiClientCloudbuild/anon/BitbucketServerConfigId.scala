...
import typingsJapgolly.maximMazurokGapiClientCloudbuild.gapi.client.cloudbuild.BitbucketServerConfig
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait BitbucketServerConfigId extends StObject {
...
object BitbucketServerConfigId {
  
  inline def apply(parent: String, resource: BitbucketServerConfig): BitbucketServerConfigId = {
  ...
  extension [Self <: BitbucketServerConfigId](x: Self) {
    ...
    inline def setResource(value: BitbucketServerConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
