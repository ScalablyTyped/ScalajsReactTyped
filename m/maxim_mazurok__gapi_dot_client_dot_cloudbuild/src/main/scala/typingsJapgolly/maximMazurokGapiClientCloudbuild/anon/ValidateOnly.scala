...
import typingsJapgolly.maximMazurokGapiClientCloudbuild.gapi.client.cloudbuild.WorkerPool
...
object ValidateOnly {
  ...
  inline def apply(parent: String, resource: WorkerPool): ValidateOnly = {
  ...
  extension [Self <: ValidateOnly](x: Self) {
    ...
    inline def setResource(value: WorkerPool): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
