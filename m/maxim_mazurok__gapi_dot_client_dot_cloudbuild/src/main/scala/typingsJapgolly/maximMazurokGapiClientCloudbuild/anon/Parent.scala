...
import typingsJapgolly.maximMazurokGapiClientCloudbuild.gapi.client.cloudbuild.Build
...
object Parent {
  ...
  extension [Self <: Parent](x: Self) {
    ...
    inline def setResource(value: Build): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
