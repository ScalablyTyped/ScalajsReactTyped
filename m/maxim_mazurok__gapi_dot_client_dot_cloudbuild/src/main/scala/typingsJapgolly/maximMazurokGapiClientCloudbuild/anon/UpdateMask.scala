...
import typingsJapgolly.maximMazurokGapiClientCloudbuild.gapi.client.cloudbuild.GitHubEnterpriseConfig
...
object UpdateMask {
  ...
  inline def apply(name: String, resource: GitHubEnterpriseConfig): UpdateMask = {
  ...
  extension [Self <: UpdateMask](x: Self) {
    ...
    inline def setResource(value: GitHubEnterpriseConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
