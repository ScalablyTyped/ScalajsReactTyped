package typingsJapgolly.mariasql
...
package object mod {
  ...
  type MariaCallBackError = js.Function1[/* error */ js.Error, scala.Unit]
  type MariaCallBackInfo = js.Function1[/* result */ typingsJapgolly.mariasql.mod.MariaInfo, scala.Unit]
  type MariaCallBackObject = js.Function1[/* result */ js.Object, scala.Unit]
  type MariaCallBackResult = js.Function1[/* result */ typingsJapgolly.mariasql.mod.MariaResult, scala.Unit]
