...
import typingsJapgolly.maximMazurokGapiClientIap.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientIap.anon.Alt
...
import typingsJapgolly.maximMazurokGapiClientIap.anon.Key
