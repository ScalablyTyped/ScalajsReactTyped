...
import typingsJapgolly.maximMazurokGapiClientIap.anon.UpdateMask
...
trait V1Resource extends StObject {
  ...
  /**
    ...
    */
  def getIamPolicy(request: typingsJapgolly.maximMazurokGapiClientIap.anon.Resource, body: GetIamPolicyRequest): Request[Policy] = js.native
  ...
  /**
    ...
    * https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api
    */
  def setIamPolicy(request: typingsJapgolly.maximMazurokGapiClientIap.anon.Resource, body: SetIamPolicyRequest): Request[Policy] = js.native
  ...
  /**
    ...
    * https://cloud.google.com/iap/docs/managing-access#managing_access_via_the_api
    */
  def testIamPermissions(request: typingsJapgolly.maximMazurokGapiClientIap.anon.Resource, body: TestIamPermissionsRequest): Request[TestIamPermissionsResponse] = js.native
