...
import typingsJapgolly.maximMazurokGapiClientLifesciences.gapi.client.lifesciences.CancelOperationRequest
import typingsJapgolly.maximMazurokGapiClientLifesciences.gapi.client.lifesciences.RunPipelineRequest
...
object anon {
  ...
  object Fields {
    ...
    inline def apply(parent: String, resource: RunPipelineRequest): Fields = {
