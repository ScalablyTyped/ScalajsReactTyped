...
object anon {
  ...
  trait AssignedClientIdentifier extends StObject {
    ...
    var userProperties: js.UndefOr[typingsJapgolly.mqttPacket.mod.UserProperties] = js.undefined
  ...
  object AssignedClientIdentifier {
    ...
    extension [Self <: AssignedClientIdentifier](x: Self) {
      ...
      inline def setUserProperties(value: typingsJapgolly.mqttPacket.mod.UserProperties): Self = StObject.set(x, "userProperties", value.asInstanceOf[js.Any])
