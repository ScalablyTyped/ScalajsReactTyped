package typingsJapgolly.matteodisabatinoGcInfo

import typingsJapgolly.matteodisabatinoGcInfo.matteodisabatinoGcInfoStrings.data
...
object mod {
  ...
  object GcType extends StObject {
    ...
    sealed trait All
      extends StObject
         with GcType
    /* 15 */ val All: typingsJapgolly.matteodisabatinoGcInfo.mod.GcType.All & Double = js.native
    
    @js.native
    sealed trait IncrementalMarking
      extends StObject
         with GcType
    /* 4 */ val IncrementalMarking: typingsJapgolly.matteodisabatinoGcInfo.mod.GcType.IncrementalMarking & Double = js.native
    
    @js.native
    sealed trait MarkSlashSweepSlashCompact
      extends StObject
         with GcType
    /* 2 */ val MarkSlashSweepSlashCompact: typingsJapgolly.matteodisabatinoGcInfo.mod.GcType.MarkSlashSweepSlashCompact & Double = js.native
    
    @js.native
    sealed trait Scavenge
      extends StObject
         with GcType
    /* 1 */ val Scavenge: typingsJapgolly.matteodisabatinoGcInfo.mod.GcType.Scavenge & Double = js.native
    
    @js.native
    sealed trait WeakSlashPhantomCallbackProcessing
      extends StObject
         with GcType
    /* 8 */ val WeakSlashPhantomCallbackProcessing: typingsJapgolly.matteodisabatinoGcInfo.mod.GcType.WeakSlashPhantomCallbackProcessing & Double = js.native
  }
