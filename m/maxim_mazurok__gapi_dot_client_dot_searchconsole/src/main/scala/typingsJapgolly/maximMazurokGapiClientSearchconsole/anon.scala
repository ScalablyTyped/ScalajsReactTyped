...
import typingsJapgolly.maximMazurokGapiClientSearchconsole.gapi.client.searchconsole.InspectUrlIndexRequest
import typingsJapgolly.maximMazurokGapiClientSearchconsole.gapi.client.searchconsole.RunMobileFriendlyTestRequest
import typingsJapgolly.maximMazurokGapiClientSearchconsole.gapi.client.searchconsole.SearchAnalyticsQueryRequest
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(resource: SearchAnalyticsQueryRequest, siteUrl: String): Accesstoken = {
  ...
  object Alt {
    ...
    inline def apply(siteUrl: String): Alt = {
  ...
  object Callback {
    ...
    inline def apply(feedpath: String, siteUrl: String): Callback = {
  ...
  trait Oauthtoken extends StObject {
    ...
    /** Request body */
    var resource: InspectUrlIndexRequest
  ...
  object Oauthtoken {
    ...
    inline def apply(resource: InspectUrlIndexRequest): Oauthtoken = {
    ...
    extension [Self <: Oauthtoken](x: Self) {
      ...
      inline def setResource(value: InspectUrlIndexRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  trait PrettyPrint extends StObject {
    ...
    /** Request body */
    var resource: RunMobileFriendlyTestRequest
  ...
  object PrettyPrint {
    ...
    inline def apply(resource: RunMobileFriendlyTestRequest): PrettyPrint = {
      val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    ...
    extension [Self <: PrettyPrint](x: Self) {
      ...
      inline def setResource(value: RunMobileFriendlyTestRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
