...
import typingsJapgolly.micromarkUtilTypes.anon.OmitCompileContextsliceSe
import typingsJapgolly.micromarkUtilTypes.anon.OmitPointindexbufferIndex
import typingsJapgolly.micromarkUtilTypes.anon.PartialCompileDataFields
import typingsJapgolly.micromarkUtilTypes.anon.PartialExtensionFields
import typingsJapgolly.micromarkUtilTypes.anon.PartialNormalizedExtensio
import typingsJapgolly.micromarkUtilTypes.anon.`2`
import typingsJapgolly.micromarkUtilTypes.micromarkUtilTypesStrings.enter
import typingsJapgolly.micromarkUtilTypes.micromarkUtilTypesStrings.exit
...
type NormalizedHtmlExtension = (Record[String, Record[String, Any]]) & typingsJapgolly.micromarkUtilTypes.anon.Enter
