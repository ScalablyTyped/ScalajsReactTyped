...
object Effects {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(attempt = js.Any.fromFunction3(attempt), check = js.Any.fromFunction3(check), consume = js.Any.fromFunction1((t0: /* code */ Code) => consume(t0).runNow()), enter = js.Any.fromFunction2(enter), exit = js.Any.fromFunction1(exit), interrupt = js.Any.fromFunction3(interrupt))
  ...
  extension [Self <: Effects](x: Self) {
    ...
    inline def setConsume(value: /* code */ Code => Callback): Self = StObject.set(x, "consume", js.Any.fromFunction1((t0: /* code */ Code) => value(t0).runNow()))
