...
import typingsJapgolly.maximMazurokGapiClientOslogin.gapi.client.oslogin.SshPublicKey
...
object anon {
  ...
  object Alt {
    ...
    inline def apply(parent: String, resource: SshPublicKey): Alt = {
    ...
    extension [Self <: Alt](x: Self) {
      ...
      inline def setResource(value: SshPublicKey): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Fields {
    ...
    inline def apply(name: String, resource: SshPublicKey): Fields = {
  ...
  object Oauthtoken {
    ...
    inline def apply(parent: String, resource: SshPublicKey): Oauthtoken = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
