package typingsJapgolly.maximMazurokGapiClientServicedirectory

import typingsJapgolly.maximMazurokGapiClientServicedirectory.gapi.client.servicedirectory.ProjectsResource
import typingsJapgolly.maximMazurokGapiClientServicedirectory.maximMazurokGapiClientServicedirectoryStrings.servicedirectory
import typingsJapgolly.maximMazurokGapiClientServicedirectory.maximMazurokGapiClientServicedirectoryStrings.v1
