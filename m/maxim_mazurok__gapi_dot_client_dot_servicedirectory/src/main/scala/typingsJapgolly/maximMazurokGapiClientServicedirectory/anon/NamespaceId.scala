package typingsJapgolly.maximMazurokGapiClientServicedirectory.anon

import typingsJapgolly.maximMazurokGapiClientServicedirectory.gapi.client.servicedirectory.Namespace
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait NamespaceId extends StObject {
...
object NamespaceId {
  ...
  inline def apply(parent: String, resource: Namespace): NamespaceId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[NamespaceId]
  }
  
  extension [Self <: NamespaceId](x: Self) {
    ...
    inline def setResource(value: Namespace): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
