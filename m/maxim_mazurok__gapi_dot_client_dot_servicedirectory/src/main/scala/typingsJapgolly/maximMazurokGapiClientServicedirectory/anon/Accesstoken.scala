...
import typingsJapgolly.maximMazurokGapiClientServicedirectory.gapi.client.servicedirectory.Endpoint
...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: Endpoint): Accesstoken = {
