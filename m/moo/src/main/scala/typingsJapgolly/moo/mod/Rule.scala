package typingsJapgolly.moo.mod
...
object Rule {
  ...
  def apply(
    ...
    pop: Int | Double = null,
    push: String = null,
    `type`: /* x */ String => CallbackTo[String] = null,
    value: /* x */ String => CallbackTo[String] = null
  ): Rule = {
    ...
    if (`type` != null) __obj.updateDynamic("type")(js.Any.fromFunction1((t0: /* x */ java.lang.String) => `type`(t0).runNow()))
    if (value != null) __obj.updateDynamic("value")(js.Any.fromFunction1((t0: /* x */ java.lang.String) => value(t0).runNow()))
