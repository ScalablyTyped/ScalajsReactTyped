...
import typingsJapgolly.moduleDeps.anon.Basedir
import typingsJapgolly.moduleDeps.anon.Builtin
import typingsJapgolly.moduleDeps.anon.Dictprop
import typingsJapgolly.moduleDeps.anon.Entry
import typingsJapgolly.moduleDeps.anon.Modules
import typingsJapgolly.moduleDeps.anon.PackageObjectdirnamestrin
import typingsJapgolly.moduleDeps.anon.PartialParentObjectidstri
import typingsJapgolly.moduleDeps.moduleDepsStrings._package
import typingsJapgolly.moduleDeps.moduleDepsStrings.error
import typingsJapgolly.moduleDeps.moduleDepsStrings.file
import typingsJapgolly.moduleDeps.moduleDepsStrings.missing
import typingsJapgolly.moduleDeps.moduleDepsStrings.transform
...
object mod {
  ...
  object InputTransform {
    ...
    extension [Self <: InputTransform](x: Self) {
      ...
      inline def setTransformCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "transform", value.toJsFn)
    }
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setPersistentCache(
        value: (/* file */ String, /* id */ String, /* pkg */ PackageObject, /* fallback */ js.Function2[/* dataAsString */ js.UndefOr[String | Null], /* cb */ CacheCallback, Unit], /* cb */ CacheCallback) => Callback
      ): Self = StObject.set(x, "persistentCache", js.Any.fromFunction5((t0: /* file */ String, t1: /* id */ String, t2: /* pkg */ PackageObject, t3: /* fallback */ js.Function2[/* dataAsString */ js.UndefOr[String | Null], /* cb */ CacheCallback, Unit], t4: /* cb */ CacheCallback) => (value(t0, t1, t2, t3, t4)).runNow()))
      ...
      ): Self = StObject.set(x, "resolve", js.Any.fromFunction3((t0: /* id */ String, t1: /* opts */ ParentObject, t2: /* cb */ js.Function4[
              /* err */ js.UndefOr[js.Error | Null], 
              /* file */ js.UndefOr[String], 
              /* pkg */ js.UndefOr[PackageObject], 
              /* fakePath */ js.UndefOr[Any], 
