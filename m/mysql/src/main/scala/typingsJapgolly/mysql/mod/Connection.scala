...
import typingsJapgolly.mysql.mysqlStrings.authenticated
import typingsJapgolly.mysql.mysqlStrings.connect
import typingsJapgolly.mysql.mysqlStrings.connected
import typingsJapgolly.mysql.mysqlStrings.disconnected
import typingsJapgolly.mysql.mysqlStrings.drain
import typingsJapgolly.mysql.mysqlStrings.end
import typingsJapgolly.mysql.mysqlStrings.enqueue
import typingsJapgolly.mysql.mysqlStrings.error
import typingsJapgolly.mysql.mysqlStrings.fields
import typingsJapgolly.mysql.mysqlStrings.protocol_error
