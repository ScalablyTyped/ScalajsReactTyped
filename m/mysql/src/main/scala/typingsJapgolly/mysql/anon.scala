...
object anon {
  ...
  object UntypedFieldInfotypestrin {
    ...
    inline def apply(
      ...
      orgTable: String,
      protocol41: Boolean,
      string: CallbackTo[Null | String],
      table: String,
      `type`: String,
      zeroFill: Boolean
    ): UntypedFieldInfotypestrin = {
      val __obj = js.Dynamic.literal(buffer = buffer.toJsFn, catalog = catalog.asInstanceOf[js.Any], charsetNr = charsetNr.asInstanceOf[js.Any], db = db.asInstanceOf[js.Any], decimals = decimals.asInstanceOf[js.Any], flags = flags.asInstanceOf[js.Any], geometry = geometry.toJsFn, length = length.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], orgName = orgName.asInstanceOf[js.Any], orgTable = orgTable.asInstanceOf[js.Any], protocol41 = protocol41.asInstanceOf[js.Any], string = string.toJsFn, table = table.asInstanceOf[js.Any], zeroFill = zeroFill.asInstanceOf[js.Any])
    ...
    extension [Self <: UntypedFieldInfotypestrin](x: Self) {
      ...
      inline def setBuffer(value: CallbackTo[Null | Buffer]): Self = StObject.set(x, "buffer", value.toJsFn)
      ...
      inline def setGeometry(value: CallbackTo[Null | GeometryType]): Self = StObject.set(x, "geometry", value.toJsFn)
      ...
      inline def setString(value: CallbackTo[Null | String]): Self = StObject.set(x, "string", value.toJsFn)
