...
object anon {
  ...
  object PartialMDCIconButtonToggl {
    ...
    extension [Self <: PartialMDCIconButtonToggl](x: Self) {
      ...
      inline def setNotifyChange(value: /* evtData */ MDCIconButtonToggleEventDetail => Callback): Self = StObject.set(x, "notifyChange", js.Any.fromFunction1((t0: /* evtData */ MDCIconButtonToggleEventDetail) => value(t0).runNow()))
      ...
      inline def setSetAttr(value: (/* attrName */ String, /* attrValue */ String) => Callback): Self = StObject.set(x, "setAttr", js.Any.fromFunction2((t0: /* attrName */ String, t1: /* attrValue */ String) => (value(t0, t1)).runNow()))
