...
trait MUIDataTableFilterList extends StObject {
  ...
  var columnNames: js.UndefOr[js.Array[typingsJapgolly.muiDatatables.anon.FilterType]] = js.undefined
...
object MUIDataTableFilterList {
  ...
  extension [Self <: MUIDataTableFilterList](x: Self) {
    ...
    inline def setColumnNames(value: js.Array[typingsJapgolly.muiDatatables.anon.FilterType]): Self = StObject.set(x, "columnNames", value.asInstanceOf[js.Any])
    
    inline def setColumnNamesUndefined: Self = StObject.set(x, "columnNames", js.undefined)
    
    inline def setColumnNamesVarargs(value: typingsJapgolly.muiDatatables.anon.FilterType*): Self = StObject.set(x, "columnNames", js.Array(value*))
