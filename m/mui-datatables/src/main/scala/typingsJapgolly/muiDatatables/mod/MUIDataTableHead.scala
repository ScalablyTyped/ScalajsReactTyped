...
object MUIDataTableHead {
  ...
  extension [Self <: MUIDataTableHead](x: Self) {
    ...
    inline def setTableRef(value: CallbackTo[Any]): Self = StObject.set(x, "tableRef", value.toJsFn)
    ...
    inline def setToggleAllExpandableRows(value: CallbackTo[Any]): Self = StObject.set(x, "toggleAllExpandableRows", value.toJsFn)
