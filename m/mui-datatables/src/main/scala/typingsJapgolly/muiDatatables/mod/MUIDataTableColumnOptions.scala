...
import typingsJapgolly.muiDatatables.anon.DataAny
...
trait MUIDataTableColumnOptions extends StObject {
  ...
  /**
    ...
    */
  var customBodyRenderLite: js.UndefOr[js.Function2[/* dataIndex */ Double, /* rowIndex */ Double, String | Node]] = js.undefined
  ...
  /**
    ...
    */
  var customHeadLabelRender: js.UndefOr[js.Function1[/* options */ CustomHeadLabelRenderOptions, String | Node]] = js.undefined
...
object MUIDataTableColumnOptions {
  ...
  extension [Self <: MUIDataTableColumnOptions](x: Self) {
    ...
    inline def setCustomBodyRender(
      value: (/* value */ Any, /* tableMeta */ MUIDataTableMeta, /* updateValue */ js.Function1[/* value */ String, Unit]) => String | Node
    ): Self = StObject.set(x, "customBodyRender", js.Any.fromFunction3(value))
    
    inline def setCustomBodyRenderLite(value: (/* dataIndex */ Double, /* rowIndex */ Double) => String | Node): Self = StObject.set(x, "customBodyRenderLite", js.Any.fromFunction2(value))
    ...
    inline def setCustomHeadLabelRender(value: /* options */ CustomHeadLabelRenderOptions => String | Node): Self = StObject.set(x, "customHeadLabelRender", js.Any.fromFunction1(value))
    ...
    inline def setCustomHeadRender(
      value: (/* columnMeta */ MUIDataTableCustomHeadRenderer, /* handleToggleColumn */ js.Function1[/* columnIndex */ Double, Unit], /* sortOrder */ MUISortOptions) => String | Node
