...
object IObjectVersion {
  ...
  extension [Self <: IObjectVersion](x: Self) {
    ...
    inline def setClone(value: CallbackTo[IObjectVersion]): Self = StObject.set(x, "Clone", value.toJsFn)
