...
object IExportContentJob {
  ...
  extension [Self <: IExportContentJob](x: Self) {
    ...
    inline def setSetExportAllStructureItems(value: Boolean => Callback): Self = StObject.set(x, "SetExportAllStructureItems", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
