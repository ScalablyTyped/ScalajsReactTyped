...
object ISearchCriteria {
  ...
  extension [Self <: ISearchCriteria](x: Self) {
    ...
    inline def setClone(value: CallbackTo[ISearchCriteria]): Self = StObject.set(x, "Clone", value.toJsFn)
