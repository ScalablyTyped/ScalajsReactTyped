...
object IScheduledJobTrigger {
  ...
  inline def apply(
    ...
    BeginMonth: Double,
    BeginYear: Double,
    Clone: CallbackTo[IScheduledJobTrigger],
    EndDay: Double,
    EndMonth: Double,
    EndYear: Double,
    StartHour: Double,
    ...
    val __obj = js.Dynamic.literal(BeginDay = BeginDay.asInstanceOf[js.Any], BeginMonth = BeginMonth.asInstanceOf[js.Any], BeginYear = BeginYear.asInstanceOf[js.Any], Clone = Clone.toJsFn, EndDay = EndDay.asInstanceOf[js.Any], EndMonth = EndMonth.asInstanceOf[js.Any], EndYear = EndYear.asInstanceOf[js.Any], StartHour = StartHour.asInstanceOf[js.Any], StartMinute = StartMinute.asInstanceOf[js.Any], Type = Type.asInstanceOf[js.Any], ValidEndDate = ValidEndDate.asInstanceOf[js.Any])
  ...
  extension [Self <: IScheduledJobTrigger](x: Self) {
    ...
    inline def setClone(value: CallbackTo[IScheduledJobTrigger]): Self = StObject.set(x, "Clone", value.toJsFn)
