...
object IShellFrameEvents {
  ...
  inline def apply(Register: (Event, js.Function) => Double, Unregister: Double => Callback): IShellFrameEvents = {
  ...
  extension [Self <: IShellFrameEvents](x: Self) {
    
    inline def setOnActiveListingChanged(value: (/* oldListing */ Null | IShellListing, /* newListing */ IShellListing) => Callback): Self = StObject.set(x, "OnActiveListingChanged", js.Any.fromFunction2((t0: /* oldListing */ Null | IShellListing, t1: /* newListing */ IShellListing) => (value(t0, t1)).runNow()))
    ...
    inline def setOnShowMainMenu(value: Callback): Self = StObject.set(x, "OnShowMainMenu", value.toJsFn)
