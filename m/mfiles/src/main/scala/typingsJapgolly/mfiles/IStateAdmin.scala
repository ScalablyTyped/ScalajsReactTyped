...
object IStateAdmin {
  ...
  extension [Self <: IStateAdmin](x: Self) {
    ...
    inline def setClone(value: CallbackTo[IStateAdmin]): Self = StObject.set(x, "Clone", value.toJsFn)
