...
object IImportContentJob {
  ...
  extension [Self <: IImportContentJob](x: Self) {
    ...
    inline def setClone(value: CallbackTo[IImportContentJob]): Self = StObject.set(x, "Clone", value.toJsFn)
