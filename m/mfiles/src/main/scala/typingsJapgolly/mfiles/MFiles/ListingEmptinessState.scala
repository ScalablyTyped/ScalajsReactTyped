...
*/
trait ListingEmptinessState extends StObject
object ListingEmptinessState {
  
  inline def Empty: `3` = 3.asInstanceOf[`3`]
  
  inline def NotEmpty: `2` = 2.asInstanceOf[`2`]
  
  inline def NotYetKnown: `1` = 1.asInstanceOf[`1`]
}
