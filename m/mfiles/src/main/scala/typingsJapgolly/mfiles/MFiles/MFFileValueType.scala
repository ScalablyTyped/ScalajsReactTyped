...
*/
trait MFFileValueType extends StObject
object MFFileValueType {
  
  inline def ChangeTime: `5` = 5.asInstanceOf[`5`]
  
  inline def CreationTime: `4` = 4.asInstanceOf[`4`]
  
  inline def FileID: `3` = 3.asInstanceOf[`3`]
  
  inline def FileName: `1` = 1.asInstanceOf[`1`]
  
  inline def FileSize: `2` = 2.asInstanceOf[`2`]
  
  inline def HasFiles: `0` = 0.asInstanceOf[`0`]
  
  inline def LinkedToExtLoc: `6` = 6.asInstanceOf[`6`]
  
  inline def LinkedToExtLocID: `7` = 7.asInstanceOf[`7`]
}
