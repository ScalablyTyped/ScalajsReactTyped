...
*/
trait MFFileValueType extends js.Object

object MFFileValueType {
  @scala.inline
  def ChangeTime: `5` = this.cast(5)
  @scala.inline
  def CreationTime: `4` = this.cast(4)
  @scala.inline
  def FileID: `3` = this.cast(3)
  @scala.inline
  def FileName: `1` = this.cast(1)
  @scala.inline
  def FileSize: `2` = this.cast(2)
  @scala.inline
  def HasFiles: `0` = this.cast(0)
  @scala.inline
  def LinkedToExtLoc: `6` = this.cast(6)
  @scala.inline
  def LinkedToExtLocID: `7` = this.cast(7)
  @scala.inline
