...
import typingsJapgolly.mfiles.anon.Finally
import typingsJapgolly.mfiles.anon.FinallyOnError
import typingsJapgolly.mfiles.anon.OnError
import typingsJapgolly.mfiles.anon.OnSuccess
...
object IVaultEntryEvents {
  ...
  inline def apply(Register: (Event, js.Function) => Double, Unregister: Double => Callback): IVaultEntryEvents = {
  ...
  extension [Self <: IVaultEntryEvents](x: Self) {
    ...
    inline def setOnLogOut(value: CallbackTo[Null | Boolean | OnError]): Self = StObject.set(x, "OnLogOut", value.toJsFn)
    
    inline def setOnLogOutUndefined: Self = StObject.set(x, "OnLogOut", js.undefined)
    
    inline def setOnLoggedIn(value: Callback): Self = StObject.set(x, "OnLoggedIn", value.toJsFn)
    ...
    inline def setOnObjectAddedToFavorites(value: /* objID */ IObjID => Callback): Self = StObject.set(x, "OnObjectAddedToFavorites", js.Any.fromFunction1((t0: /* objID */ IObjID) => value(t0).runNow()))
    
    inline def setOnObjectAddedToFavoritesUndefined: Self = StObject.set(x, "OnObjectAddedToFavorites", js.undefined)
    
    inline def setOnObjectCheckedIn(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnObjectCheckedIn", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnObjectCheckedInUndefined: Self = StObject.set(x, "OnObjectCheckedIn", js.undefined)
    
    inline def setOnObjectCheckedOut(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnObjectCheckedOut", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnObjectCheckedOutUndefined: Self = StObject.set(x, "OnObjectCheckedOut", js.undefined)
    
    inline def setOnObjectCheckoutUndone(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnObjectCheckoutUndone", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnObjectCheckoutUndoneUndefined: Self = StObject.set(x, "OnObjectCheckoutUndone", js.undefined)
    
    inline def setOnObjectCheckoutsUndone(value: /* objectVersions */ IObjectVersions => Callback): Self = StObject.set(x, "OnObjectCheckoutsUndone", js.Any.fromFunction1((t0: /* objectVersions */ IObjectVersions) => value(t0).runNow()))
    
    inline def setOnObjectCheckoutsUndoneUndefined: Self = StObject.set(x, "OnObjectCheckoutsUndone", js.undefined)
    
    inline def setOnObjectCreated(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnObjectCreated", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnObjectCreatedUndefined: Self = StObject.set(x, "OnObjectCreated", js.undefined)
    
    inline def setOnObjectDestroyed(value: /* objID */ IObjID => Callback): Self = StObject.set(x, "OnObjectDestroyed", js.Any.fromFunction1((t0: /* objID */ IObjID) => value(t0).runNow()))
    
    inline def setOnObjectDestroyedUndefined: Self = StObject.set(x, "OnObjectDestroyed", js.undefined)
    
    inline def setOnObjectFileAdded(value: (/* objectVersion */ IObjectVersion, /* objectFile */ IObjectFile) => Callback): Self = StObject.set(x, "OnObjectFileAdded", js.Any.fromFunction2((t0: /* objectVersion */ IObjectVersion, t1: /* objectFile */ IObjectFile) => (value(t0, t1)).runNow()))
    
    inline def setOnObjectFileAddedUndefined: Self = StObject.set(x, "OnObjectFileAdded", js.undefined)
    
    inline def setOnObjectFileRemoved(value: (/* objectVersion */ IObjectVersion, /* fileVer */ IFileVer) => Callback): Self = StObject.set(x, "OnObjectFileRemoved", js.Any.fromFunction2((t0: /* objectVersion */ IObjectVersion, t1: /* fileVer */ IFileVer) => (value(t0, t1)).runNow()))
    
    inline def setOnObjectFileRemovedUndefined: Self = StObject.set(x, "OnObjectFileRemoved", js.undefined)
    
    inline def setOnObjectFileRenamed(value: (/* objectVersion */ IObjectVersion, /* objectFile */ IObjectFile) => Callback): Self = StObject.set(x, "OnObjectFileRenamed", js.Any.fromFunction2((t0: /* objectVersion */ IObjectVersion, t1: /* objectFile */ IObjectFile) => (value(t0, t1)).runNow()))
    
    inline def setOnObjectFileRenamedUndefined: Self = StObject.set(x, "OnObjectFileRenamed", js.undefined)
    
    inline def setOnObjectLevelPropertySet(value: (/* objID */ IObjID, /* propertyValue */ IPropertyValue) => Callback): Self = StObject.set(x, "OnObjectLevelPropertySet", js.Any.fromFunction2((t0: /* objID */ IObjID, t1: /* propertyValue */ IPropertyValue) => (value(t0, t1)).runNow()))
    
    inline def setOnObjectLevelPropertySetUndefined: Self = StObject.set(x, "OnObjectLevelPropertySet", js.undefined)
    
    inline def setOnObjectOfflineAvailabilityRemoved(value: /* objID */ IObjID => Callback): Self = StObject.set(x, "OnObjectOfflineAvailabilityRemoved", js.Any.fromFunction1((t0: /* objID */ IObjID) => value(t0).runNow()))
    ...
    inline def setOnObjectOfflineAvailabilitySet(value: /* objID */ IObjID => Callback): Self = StObject.set(x, "OnObjectOfflineAvailabilitySet", js.Any.fromFunction1((t0: /* objID */ IObjID) => value(t0).runNow()))
    
    inline def setOnObjectOfflineAvailabilitySetUndefined: Self = StObject.set(x, "OnObjectOfflineAvailabilitySet", js.undefined)
    
    inline def setOnObjectRemoved(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnObjectRemoved", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnObjectRemovedFromFavorites(value: /* objID */ IObjID => Callback): Self = StObject.set(x, "OnObjectRemovedFromFavorites", js.Any.fromFunction1((t0: /* objID */ IObjID) => value(t0).runNow()))
    ...
    inline def setOnObjectUndeleted(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnObjectUndeleted", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnObjectUndeletedUndefined: Self = StObject.set(x, "OnObjectUndeleted", js.undefined)
    
    inline def setOnObjectVersionDestroyed(value: /* objVer */ IObjVer => Callback): Self = StObject.set(x, "OnObjectVersionDestroyed", js.Any.fromFunction1((t0: /* objVer */ IObjVer) => value(t0).runNow()))
    ...
    inline def setOnObjectVersionLabelsModified(
      value: (/* objVer */ IObjVer, /* clearFromOtherVersions */ Boolean, /* append */ Boolean, /* labelIDs */ IIDs) => Callback
    ): Self = StObject.set(x, "OnObjectVersionLabelsModified", js.Any.fromFunction4((t0: /* objVer */ IObjVer, t1: /* clearFromOtherVersions */ Boolean, t2: /* append */ Boolean, t3: /* labelIDs */ IIDs) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setOnObjectVersionLabelsModifiedUndefined: Self = StObject.set(x, "OnObjectVersionLabelsModified", js.undefined)
    
    inline def setOnObjectVersionPermissionsSet(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnObjectVersionPermissionsSet", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnObjectVersionPermissionsSetUndefined: Self = StObject.set(x, "OnObjectVersionPermissionsSet", js.undefined)
    
    inline def setOnObjectVersionRolledBack(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnObjectVersionRolledBack", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnObjectVersionRolledBackUndefined: Self = StObject.set(x, "OnObjectVersionRolledBack", js.undefined)
    
    inline def setOnObjectVersionsDestroyed(value: /* objVers */ IObjVers => Callback): Self = StObject.set(x, "OnObjectVersionsDestroyed", js.Any.fromFunction1((t0: /* objVers */ IObjVers) => value(t0).runNow()))
    
    inline def setOnObjectVersionsDestroyedUndefined: Self = StObject.set(x, "OnObjectVersionsDestroyed", js.undefined)
    
    inline def setOnObjectsAddedToFavorites(value: /* objIDs */ IObjIDs => Callback): Self = StObject.set(x, "OnObjectsAddedToFavorites", js.Any.fromFunction1((t0: /* objIDs */ IObjIDs) => value(t0).runNow()))
    
    inline def setOnObjectsAddedToFavoritesUndefined: Self = StObject.set(x, "OnObjectsAddedToFavorites", js.undefined)
    
    inline def setOnObjectsCheckedIn(value: /* objectVersions */ IObjectVersions => Callback): Self = StObject.set(x, "OnObjectsCheckedIn", js.Any.fromFunction1((t0: /* objectVersions */ IObjectVersions) => value(t0).runNow()))
    
    inline def setOnObjectsCheckedInUndefined: Self = StObject.set(x, "OnObjectsCheckedIn", js.undefined)
    
    inline def setOnObjectsCheckedOut(value: /* objectVersions */ IObjectVersions => Callback): Self = StObject.set(x, "OnObjectsCheckedOut", js.Any.fromFunction1((t0: /* objectVersions */ IObjectVersions) => value(t0).runNow()))
    
    inline def setOnObjectsCheckedOutUndefined: Self = StObject.set(x, "OnObjectsCheckedOut", js.undefined)
    
    inline def setOnObjectsDestroyed(value: /* objIDs */ IObjIDs => Callback): Self = StObject.set(x, "OnObjectsDestroyed", js.Any.fromFunction1((t0: /* objIDs */ IObjIDs) => value(t0).runNow()))
    
    inline def setOnObjectsDestroyedUndefined: Self = StObject.set(x, "OnObjectsDestroyed", js.undefined)
    
    inline def setOnObjectsRemoved(value: /* objectVersions */ IObjectVersions => Callback): Self = StObject.set(x, "OnObjectsRemoved", js.Any.fromFunction1((t0: /* objectVersions */ IObjectVersions) => value(t0).runNow()))
    
    inline def setOnObjectsRemovedFromFavorites(value: /* objIDs */ IObjIDs => Callback): Self = StObject.set(x, "OnObjectsRemovedFromFavorites", js.Any.fromFunction1((t0: /* objIDs */ IObjIDs) => value(t0).runNow()))
    ...
    inline def setOnPropertiesOfObjectVersionSet(value: /* objectVersion */ IObjectVersion => Callback): Self = StObject.set(x, "OnPropertiesOfObjectVersionSet", js.Any.fromFunction1((t0: /* objectVersion */ IObjectVersion) => value(t0).runNow()))
    
    inline def setOnPropertiesOfObjectVersionSetUndefined: Self = StObject.set(x, "OnPropertiesOfObjectVersionSet", js.undefined)
    
    inline def setOnPropertiesOfObjectVersionsSet(value: /* objectVersions */ IObjectVersions => Callback): Self = StObject.set(x, "OnPropertiesOfObjectVersionsSet", js.Any.fromFunction1((t0: /* objectVersions */ IObjectVersions) => value(t0).runNow()))
    ...
    inline def setOnSwitchToOfflineMode(value: CallbackTo[Null | Boolean | OnError]): Self = StObject.set(x, "OnSwitchToOfflineMode", value.toJsFn)
    
    inline def setOnSwitchToOfflineModeUndefined: Self = StObject.set(x, "OnSwitchToOfflineMode", js.undefined)
    
    inline def setOnSwitchToOnlineMode(value: CallbackTo[Null | Boolean | OnError]): Self = StObject.set(x, "OnSwitchToOnlineMode", value.toJsFn)
    
    inline def setOnSwitchToOnlineModeUndefined: Self = StObject.set(x, "OnSwitchToOnlineMode", js.undefined)
    
    inline def setOnSwitchedToOfflineMode(value: Callback): Self = StObject.set(x, "OnSwitchedToOfflineMode", value.toJsFn)
    
    inline def setOnSwitchedToOfflineModeUndefined: Self = StObject.set(x, "OnSwitchedToOfflineMode", js.undefined)
    
    inline def setOnSwitchedToOnlineMode(value: Callback): Self = StObject.set(x, "OnSwitchedToOnlineMode", value.toJsFn)
    ...
    inline def setOnVaultLanguageChanged(value: /* languageID */ Double => Callback): Self = StObject.set(x, "OnVaultLanguageChanged", js.Any.fromFunction1((t0: /* languageID */ Double) => value(t0).runNow()))
