...
import typingsJapgolly.makeFetchHappen.anon.FnCall
...
import typingsJapgolly.retry.mod.TimeoutsOptions
...
object mod extends Shortcut {
  ...
  object FetchOptions {
    ...
    extension [Self <: FetchOptions](x: Self) {
      ...
      inline def setOnRetry(value: Callback): Self = StObject.set(x, "onRetry", value.toJsFn)
