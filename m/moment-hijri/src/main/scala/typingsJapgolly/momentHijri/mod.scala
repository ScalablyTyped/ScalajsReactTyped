package typingsJapgolly.momentHijri
...
import typingsJapgolly.momentHijri.mod.momentAugmentingMod.iConvert.GregorianResult
import typingsJapgolly.momentHijri.mod.momentAugmentingMod.iConvert.HijriResult
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.momentHijri.momentHijriStrings.iYear
      - typingsJapgolly.momentHijri.momentHijriStrings.iMonth
    */
    trait IUnitOfTime extends StObject
    object IUnitOfTime {
      
      inline def iMonth: typingsJapgolly.momentHijri.momentHijriStrings.iMonth = "iMonth".asInstanceOf[typingsJapgolly.momentHijri.momentHijriStrings.iMonth]
      
      inline def iYear: typingsJapgolly.momentHijri.momentHijriStrings.iYear = "iYear".asInstanceOf[typingsJapgolly.momentHijri.momentHijriStrings.iYear]
    }
    
    @js.native
    trait Moment extends StObject {
      
      def add(amount: String, unit: IUnitOfTime): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      def add(amount: Double, unit: IUnitOfTime): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def endOf(unit: IUnitOfTime): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iDate(): Double = js.native
      def iDate(d: Double): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iDayOfYear(): Double = js.native
      def iDayOfYear(d: Double): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iDaysInMonth(): Double = js.native
      
      def iMonth(): Double = js.native
      def iMonth(m: String): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      def iMonth(m: Double): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iWeek(): Double = js.native
      def iWeek(d: Double): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iWeekYear(): Double = js.native
      def iWeekYear(d: Double): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def iYear(): Double = js.native
      def iYear(y: Double): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def startOf(unit: IUnitOfTime): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      
      def subtract(amount: String, unit: IUnitOfTime): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
      def subtract(amount: Double, unit: IUnitOfTime): typingsJapgolly.momentHijri.mod.momentAugmentingMod.Moment = js.native
    }
  }
