...
import typingsJapgolly.materialMenu.typesMod.MDCMenuItemEventDetail
...
object anon {
  ...
  object PartialMDCMenuAdapter {
    ...
    extension [Self <: PartialMDCMenuAdapter](x: Self) {
      ...
      inline def setAddAttributeToElementAtIndex(value: (/* index */ Double, /* attr */ String, /* value */ String) => Callback): Self = StObject.set(x, "addAttributeToElementAtIndex", js.Any.fromFunction3((t0: /* index */ Double, t1: /* attr */ String, t2: /* value */ String) => (value(t0, t1, t2)).runNow()))
      
      inline def setAddAttributeToElementAtIndexUndefined: Self = StObject.set(x, "addAttributeToElementAtIndex", js.undefined)
      
      inline def setAddClassToElementAtIndex(value: (/* index */ Double, /* className */ String) => Callback): Self = StObject.set(x, "addClassToElementAtIndex", js.Any.fromFunction2((t0: /* index */ Double, t1: /* className */ String) => (value(t0, t1)).runNow()))
      
      inline def setAddClassToElementAtIndexUndefined: Self = StObject.set(x, "addClassToElementAtIndex", js.undefined)
      
      inline def setCloseSurface(value: /* skipRestoreFocus */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "closeSurface", js.Any.fromFunction1((t0: /* skipRestoreFocus */ js.UndefOr[Boolean]) => value(t0).runNow()))
      ...
      inline def setFocusItemAtIndex(value: /* index */ Double => Callback): Self = StObject.set(x, "focusItemAtIndex", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
      
      inline def setFocusItemAtIndexUndefined: Self = StObject.set(x, "focusItemAtIndex", js.undefined)
      
      inline def setFocusListRoot(value: Callback): Self = StObject.set(x, "focusListRoot", value.toJsFn)
      ...
      inline def setNotifySelected(value: /* evtData */ MDCMenuItemEventDetail => Callback): Self = StObject.set(x, "notifySelected", js.Any.fromFunction1((t0: /* evtData */ MDCMenuItemEventDetail) => value(t0).runNow()))
      
      inline def setNotifySelectedUndefined: Self = StObject.set(x, "notifySelected", js.undefined)
      
      inline def setRemoveAttributeFromElementAtIndex(value: (/* index */ Double, /* attr */ String) => Callback): Self = StObject.set(x, "removeAttributeFromElementAtIndex", js.Any.fromFunction2((t0: /* index */ Double, t1: /* attr */ String) => (value(t0, t1)).runNow()))
      ...
      inline def setRemoveClassFromElementAtIndex(value: (/* index */ Double, /* className */ String) => Callback): Self = StObject.set(x, "removeClassFromElementAtIndex", js.Any.fromFunction2((t0: /* index */ Double, t1: /* className */ String) => (value(t0, t1)).runNow()))
