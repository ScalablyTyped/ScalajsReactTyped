...
import typingsJapgolly.materialMenu.materialMenuStrings.`mdc-list-item--selected`
import typingsJapgolly.materialMenu.materialMenuStrings.`mdc-menu--animating-closed`
import typingsJapgolly.materialMenu.materialMenuStrings.`mdc-menu--animating-open`
import typingsJapgolly.materialMenu.materialMenuStrings.`mdc-menu--open`
import typingsJapgolly.materialMenu.materialMenuStrings.`mdc-menu`
