package typingsJapgolly.materialMenu.foundationMod

import typingsJapgolly.materialMenu.AnonFocusIndex
...
trait MDCMenuFoundation
  extends typingsJapgolly.materialBase.foundationMod.default[MDCMenuFoundation] {
