...
object DisplaySlotId extends StObject {
  ...
  sealed trait belowname
    extends StObject
       with DisplaySlotId
  /* "belowname" */ val belowname: typingsJapgolly.mojangMinecraft.mod.DisplaySlotId.belowname & String = js.native
  ...
  sealed trait list
    extends StObject
       with DisplaySlotId
  /* "list" */ val list: typingsJapgolly.mojangMinecraft.mod.DisplaySlotId.list & String = js.native
  ...
  sealed trait sidebar
    extends StObject
       with DisplaySlotId
  /* "sidebar" */ val sidebar: typingsJapgolly.mojangMinecraft.mod.DisplaySlotId.sidebar & String = js.native
}
