...
object GameMode extends StObject {
  ...
  sealed trait adventure
    extends StObject
       with GameMode
  /* "adventure" */ val adventure: typingsJapgolly.mojangMinecraft.mod.GameMode.adventure & String = js.native
  ...
  sealed trait creative
    extends StObject
       with GameMode
  /* "creative" */ val creative: typingsJapgolly.mojangMinecraft.mod.GameMode.creative & String = js.native
  ...
  sealed trait survival
    extends StObject
       with GameMode
  /* "survival" */ val survival: typingsJapgolly.mojangMinecraft.mod.GameMode.survival & String = js.native
}
