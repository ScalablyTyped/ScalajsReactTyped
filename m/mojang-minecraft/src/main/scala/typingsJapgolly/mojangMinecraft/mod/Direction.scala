...
object Direction extends StObject {
  ...
  sealed trait down
    extends StObject
       with Direction
  /* "down" */ val down: typingsJapgolly.mojangMinecraft.mod.Direction.down & String = js.native
  ...
  sealed trait east
    extends StObject
       with Direction
  /* "east" */ val east: typingsJapgolly.mojangMinecraft.mod.Direction.east & String = js.native
  ...
  sealed trait north
    extends StObject
       with Direction
  /* "north" */ val north: typingsJapgolly.mojangMinecraft.mod.Direction.north & String = js.native
  ...
  sealed trait south
    extends StObject
       with Direction
  /* "south" */ val south: typingsJapgolly.mojangMinecraft.mod.Direction.south & String = js.native
  ...
  sealed trait up
    extends StObject
       with Direction
  /* "up" */ val up: typingsJapgolly.mojangMinecraft.mod.Direction.up & String = js.native
  ...
  sealed trait west
    extends StObject
       with Direction
  /* "west" */ val west: typingsJapgolly.mojangMinecraft.mod.Direction.west & String = js.native
}
