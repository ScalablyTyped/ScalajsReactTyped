...
@JSImport("mojang-minecraft", "EntityNavigationGenericComponent")
@js.native
/* protected */ open class EntityNavigationGenericComponent () extends IEntityComponent {
...
/* static members */
object EntityNavigationGenericComponent {
  
  /**
    * Identifier of this component. Should always be
    * minecraft:navigation.generic.
    */
  @JSImport("mojang-minecraft", "EntityNavigationGenericComponent.id")
  @js.native
  val id: /* "minecraft:navigation.generic" */ String = js.native
}
