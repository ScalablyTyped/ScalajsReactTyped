...
object ObjectiveSortOrder extends StObject {
  ...
  /* 0 */ val ascending: typingsJapgolly.mojangMinecraft.mod.ObjectiveSortOrder.ascending & Double = js.native
  ...
  sealed trait descending
    extends StObject
       with ObjectiveSortOrder
  /* 1 */ val descending: typingsJapgolly.mojangMinecraft.mod.ObjectiveSortOrder.descending & Double = js.native
}
