...
object ScoreboardIdentityType extends StObject {
  ...
  /* "entity" */ val entity: typingsJapgolly.mojangMinecraft.mod.ScoreboardIdentityType.entity & String = js.native
  ...
  sealed trait fakePlayer
    extends StObject
       with ScoreboardIdentityType
  /* "fakePlayer" */ val fakePlayer: typingsJapgolly.mojangMinecraft.mod.ScoreboardIdentityType.fakePlayer & String = js.native
  ...
  sealed trait player
    extends StObject
       with ScoreboardIdentityType
  /* "player" */ val player: typingsJapgolly.mojangMinecraft.mod.ScoreboardIdentityType.player & String = js.native
}
