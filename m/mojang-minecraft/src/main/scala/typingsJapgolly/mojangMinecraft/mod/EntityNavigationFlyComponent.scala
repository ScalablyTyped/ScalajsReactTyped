...
@JSImport("mojang-minecraft", "EntityNavigationFlyComponent")
@js.native
/* protected */ open class EntityNavigationFlyComponent () extends IEntityComponent {
...
/* static members */
object EntityNavigationFlyComponent {
  
  /**
    * Identifier of this component. Should always be
    * minecraft:navigation.fly.
    */
  @JSImport("mojang-minecraft", "EntityNavigationFlyComponent.id")
  @js.native
  val id: /* "minecraft:navigation.fly" */ String = js.native
}
