...
object WatchdogTerminateReason extends StObject {
  ...
  /* "hang" */ val hang: typingsJapgolly.mojangMinecraft.mod.WatchdogTerminateReason.hang & String = js.native
  ...
  sealed trait stackOverflow
    extends StObject
       with WatchdogTerminateReason
  /* "stackOverflow" */ val stackOverflow: typingsJapgolly.mojangMinecraft.mod.WatchdogTerminateReason.stackOverflow & String = js.native
}
