...
import typingsJapgolly.multiaddr.anon.Address
import typingsJapgolly.multiaddr.multiaddrInts.`-1`
...
object mod {
  ...
  open class Multiaddr_ () extends StObject {
    ...
    /**
      ...
      * ```
      */
    def toOptions(): typingsJapgolly.multiaddr.distSrcTypesMod.MultiaddrObject = js.native
  ...
  object protocols {
    ...
    inline def apply(proto: String): typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol = ^.asInstanceOf[js.Dynamic].apply(proto.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol]
    ...
    /**
      ...
      * @returns {Protocol}
      */
    inline def apply(proto: Double): typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol = ^.asInstanceOf[js.Dynamic].apply(proto.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol]
    ...
    @js.native
    def codes: Record[Double, typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol] = js.native
    inline def codes_=(x: Record[Double, typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("codes")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def names: Record[String, typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol] = js.native
    inline def names_=(x: Record[String, typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("names")(x.asInstanceOf[js.Any])
    ...
    /**
      ...
      * @returns {Protocol}
      */
    inline def `object`(code: Double, size: Double, name: String): typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol = (^.asInstanceOf[js.Dynamic].applyDynamic("object")(code.asInstanceOf[js.Any], size.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol]
    inline def `object`(code: Double, size: Double, name: String, resolvable: Any): typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol = (^.asInstanceOf[js.Dynamic].applyDynamic("object")(code.asInstanceOf[js.Any], size.asInstanceOf[js.Any], name.asInstanceOf[js.Any], resolvable.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol]
    inline def `object`(code: Double, size: Double, name: String, resolvable: Any, path: Any): typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol = (^.asInstanceOf[js.Dynamic].applyDynamic("object")(code.asInstanceOf[js.Any], size.asInstanceOf[js.Any], name.asInstanceOf[js.Any], resolvable.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol]
    inline def `object`(code: Double, size: Double, name: String, resolvable: Unit, path: Any): typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol = (^.asInstanceOf[js.Dynamic].applyDynamic("object")(code.asInstanceOf[js.Any], size.asInstanceOf[js.Any], name.asInstanceOf[js.Any], resolvable.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.multiaddr.distSrcProtocolsTableMod.Protocol]
  ...
  type MultiaddrObject = typingsJapgolly.multiaddr.distSrcTypesMod.MultiaddrObject
  
  type Protocol = typingsJapgolly.multiaddr.distSrcTypesMod.Protocol
