...
import typingsJapgolly.multiaddr.distSrcTypesMod.Protocol
...
object distSrcCodecMod {
  ...
  @JSImport("multiaddr/dist/src/codec", JSImport.Namespace)
  @js.native
  ...
  inline def validateBytes(buf: js.typedarray.Uint8Array): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("validateBytes")(buf.asInstanceOf[js.Any]).asInstanceOf[Any]
}
