...
trait ResultsAbove extends StObject {
...
object ResultsAbove {
  ...
  inline def apply(collection: String, leaderboardId: String, timeSpan: String): ResultsAbove = {
  ...
  extension [Self <: ResultsAbove](x: Self) {
