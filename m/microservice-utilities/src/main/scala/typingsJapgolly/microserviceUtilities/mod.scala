package typingsJapgolly.microserviceUtilities
...
object mod {
  ...
  object RequestLoggerConfiguration {
    ...
    extension [Self <: RequestLoggerConfiguration](x: Self) {
      ...
      inline def setLogFunction(value: /* msg */ Any => Callback): Self = StObject.set(x, "logFunction", js.Any.fromFunction1((t0: /* msg */ Any) => value(t0).runNow()))
