...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.Video
...
object UploadprotocolXgafv {
  ...
  inline def apply(part: String | js.Array[String], resource: Video): UploadprotocolXgafv = {
  ...
  extension [Self <: UploadprotocolXgafv](x: Self) {
    ...
    inline def setResource(value: Video): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
