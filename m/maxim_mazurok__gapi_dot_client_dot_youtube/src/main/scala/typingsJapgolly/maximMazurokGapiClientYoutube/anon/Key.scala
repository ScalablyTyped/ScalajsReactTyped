...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.Caption
...
object Key {
  ...
  inline def apply(part: String | js.Array[String], resource: Caption): Key = {
  ...
  extension [Self <: Key](x: Self) {
    ...
    inline def setResource(value: Caption): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
