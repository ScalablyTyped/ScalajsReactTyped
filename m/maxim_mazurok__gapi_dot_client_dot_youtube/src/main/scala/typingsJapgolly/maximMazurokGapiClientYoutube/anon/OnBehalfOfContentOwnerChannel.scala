...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.ChannelSection
...
object OnBehalfOfContentOwnerChannel {
  ...
  inline def apply(part: String | js.Array[String], resource: ChannelSection): OnBehalfOfContentOwnerChannel = {
  ...
  extension [Self <: OnBehalfOfContentOwnerChannel](x: Self) {
    ...
    inline def setResource(value: ChannelSection): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
