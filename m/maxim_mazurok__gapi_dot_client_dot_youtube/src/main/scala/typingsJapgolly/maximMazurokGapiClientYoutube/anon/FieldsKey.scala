...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.LiveBroadcast
...
object FieldsKey {
  ...
  inline def apply(part: String | js.Array[String], resource: LiveBroadcast): FieldsKey = {
  ...
  extension [Self <: FieldsKey](x: Self) {
    ...
    inline def setResource(value: LiveBroadcast): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
