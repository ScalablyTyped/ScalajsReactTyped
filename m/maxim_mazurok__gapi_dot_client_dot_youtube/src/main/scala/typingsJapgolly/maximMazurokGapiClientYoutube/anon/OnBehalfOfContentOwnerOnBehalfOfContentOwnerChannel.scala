...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.Playlist
...
object OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel {
  ...
  inline def apply(part: String | js.Array[String], resource: Playlist): OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel = {
  ...
  extension [Self <: OnBehalfOfContentOwnerOnBehalfOfContentOwnerChannel](x: Self) {
