...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.CommentThread
...
object AltCallback {
  ...
  inline def apply(part: String | js.Array[String], resource: CommentThread): AltCallback = {
