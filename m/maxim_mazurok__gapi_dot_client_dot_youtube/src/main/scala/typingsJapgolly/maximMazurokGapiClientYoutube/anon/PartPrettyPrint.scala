...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.LiveChatMessage
...
object PartPrettyPrint {
  ...
  inline def apply(part: String | js.Array[String], resource: LiveChatMessage): PartPrettyPrint = {
  ...
  extension [Self <: PartPrettyPrint](x: Self) {
