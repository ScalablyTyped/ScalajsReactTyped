...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.LiveStream
...
object OauthtokenOnBehalfOfContentOwner {
  ...
  inline def apply(part: String | js.Array[String], resource: LiveStream): OauthtokenOnBehalfOfContentOwner = {
  ...
  extension [Self <: OauthtokenOnBehalfOfContentOwner](x: Self) {
    ...
    inline def setResource(value: LiveStream): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
