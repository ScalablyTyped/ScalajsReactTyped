...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.VideoAbuseReport
...
object UploadTypeUploadprotocol {
  ...
  inline def apply(resource: VideoAbuseReport): UploadTypeUploadprotocol = {
