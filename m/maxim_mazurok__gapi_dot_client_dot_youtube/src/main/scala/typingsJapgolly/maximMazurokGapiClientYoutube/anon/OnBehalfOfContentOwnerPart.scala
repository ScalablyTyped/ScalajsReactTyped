...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.PlaylistItem
...
object OnBehalfOfContentOwnerPart {
  ...
  inline def apply(part: String | js.Array[String], resource: PlaylistItem): OnBehalfOfContentOwnerPart = {
  ...
  extension [Self <: OnBehalfOfContentOwnerPart](x: Self) {
    ...
    inline def setResource(value: PlaylistItem): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
