...
trait LinkingToken extends StObject {
...
object LinkingToken {
  ...
  inline def apply(linkingToken: String, `type`: String): LinkingToken = {
    val __obj = js.Dynamic.literal(linkingToken = linkingToken.asInstanceOf[js.Any])
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[LinkingToken]
  }
  
  extension [Self <: LinkingToken](x: Self) {
