...
import typingsJapgolly.maximMazurokGapiClientYoutube.gapi.client.youtube.InvideoBranding
...
object ChannelIdFields {
  ...
  inline def apply(channelId: String, resource: InvideoBranding): ChannelIdFields = {
  ...
  extension [Self <: ChannelIdFields](x: Self) {
    ...
    inline def setResource(value: InvideoBranding): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
