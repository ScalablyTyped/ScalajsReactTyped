...
trait MemberListResponse extends StObject {
  ...
  var items: js.UndefOr[js.Array[Member]] = js.undefined
...
object MemberListResponse {
  ...
  inline def apply(): MemberListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[MemberListResponse]
  }
  
  extension [Self <: MemberListResponse](x: Self) {
    ...
    inline def setItems(value: js.Array[Member]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
