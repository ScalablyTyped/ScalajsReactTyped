...
import typingsJapgolly.maximMazurokGapiClientNotebooks.gapi.client.notebooks.ProjectsResource
import typingsJapgolly.maximMazurokGapiClientNotebooks.maximMazurokGapiClientNotebooksStrings.notebooks
import typingsJapgolly.maximMazurokGapiClientNotebooks.maximMazurokGapiClientNotebooksStrings.v1
