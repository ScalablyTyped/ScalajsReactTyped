...
trait GoogleSecuritySafebrowsingV4RawHashes extends StObject {
...
object GoogleSecuritySafebrowsingV4RawHashes {
  
  inline def apply(): GoogleSecuritySafebrowsingV4RawHashes = {
