...
import typingsJapgolly.mpvScript.mp.AddKeyBindingFlags
import typingsJapgolly.mpvScript.mp.FileInfo
import typingsJapgolly.mpvScript.mp.LogLevel
import typingsJapgolly.mpvScript.mp.OSDOverlay
import typingsJapgolly.mpvScript.mp.OSDSize
import typingsJapgolly.mpvScript.mpvScriptBooleans.`true`
import typingsJapgolly.mpvScript.mpvScriptStrings.`ass-events`
import typingsJapgolly.mpvScript.mpvScriptStrings.all
import typingsJapgolly.mpvScript.mpvScriptStrings.bool
import typingsJapgolly.mpvScript.mpvScriptStrings.dirs
import typingsJapgolly.mpvScript.mpvScriptStrings.files
import typingsJapgolly.mpvScript.mpvScriptStrings.native
import typingsJapgolly.mpvScript.mpvScriptStrings.none
import typingsJapgolly.mpvScript.mpvScriptStrings.normal
import typingsJapgolly.mpvScript.mpvScriptStrings.number
import typingsJapgolly.mpvScript.mpvScriptStrings.string
