...
import typingsJapgolly.maximMazurokGapiClientAccesscontextmanager.gapi.client.accesscontextmanager.GcpUserAccessBinding
...
object CallbackFields {
  ...
  inline def apply(name: String, resource: GcpUserAccessBinding): CallbackFields = {
