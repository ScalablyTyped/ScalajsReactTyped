...
import typingsJapgolly.miniCssExtractPlugin.miniCssExtractPluginInts.`-1`
import typingsJapgolly.miniCssExtractPlugin.miniCssExtractPluginInts.`0`
import typingsJapgolly.miniCssExtractPlugin.miniCssExtractPluginInts.`1`
import typingsJapgolly.miniCssExtractPlugin.miniCssExtractPluginStrings.__mini_css_extract_plugin_public_path_auto__
import typingsJapgolly.miniCssExtractPlugin.miniCssExtractPluginStrings.__mini_css_extract_plugin_single_dot_path_segment__
import typingsJapgolly.miniCssExtractPlugin.miniCssExtractPluginStrings.`cssSlashmini-extract`
import typingsJapgolly.miniCssExtractPlugin.miniCssExtractPluginStrings.`webpackColonSlashSlashSlashmini-css-extract-pluginSlash`
import typingsJapgolly.miniCssExtractPlugin.miniCssExtractPluginStrings.webpackColonSlashSlash
...
object typesUtilsMod {
  ...
  type LoaderContext = typingsJapgolly.webpack.mod.LoaderContext[Any]
