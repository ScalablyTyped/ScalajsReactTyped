package typingsJapgolly.miniCssExtractPlugin.mod
...
object PluginOptions {
  ...
  def apply(
    ...
    moduleFilename: /* chunk */ Chunk => CallbackTo[String] = null
  ): PluginOptions = {
    ...
    if (moduleFilename != null) __obj.updateDynamic("moduleFilename")(js.Any.fromFunction1((t0: /* chunk */ typingsJapgolly.webpack.mod.compilation.Chunk) => moduleFilename(t0).runNow()))
