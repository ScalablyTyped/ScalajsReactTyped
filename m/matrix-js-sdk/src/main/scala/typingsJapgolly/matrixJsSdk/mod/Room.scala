...
import typingsJapgolly.matrixJsSdk.anon.NeedsUpgrade
import typingsJapgolly.matrixJsSdk.anon.PendingEventOrdering
...
open class Room protected () extends StObject {
  ...
  def addAccountData(events: js.Array[MatrixEvent[EventContentTypeMessage, EventType]]): Unit = js.native
  ...
  def addLiveEvents(events: js.Array[MatrixEvent[EventContentTypeMessage, EventType]], duplicateStrategy: String): Unit = js.native
  
  def addPendingEvent(event: MatrixEvent[EventContentTypeMessage, EventType], txnId: String): Unit = js.native
  
  def addReceipt(event: MatrixEvent[EventContentTypeMessage, EventType], fake: Boolean): Unit = js.native
  
  def addTags(event: MatrixEvent[EventContentTypeMessage, EventType]): Unit = js.native
  ...
  def findEventById(eventId: String): Null | (MatrixEvent[EventContentTypeMessage, EventType]) = js.native
  
  def getAccountData(`type`: String): Null | (MatrixEvent[EventContentTypeMessage, EventType]) = js.native
  ...
  def getReceiptsForEvent(event: MatrixEvent[EventContentTypeMessage, EventType]): js.Array[js.Object] = js.native
  ...
  def getUsersReadUpTo(event: MatrixEvent[EventContentTypeMessage, EventType]): js.Array[String] = js.native
  ...
  // The room summary.
  var storageToken: Any = js.native
  ...
  var timeline: js.Array[MatrixEvent[EventContentTypeMessage, EventType]] = js.native
  
  def updateMyMembership(membership: MembershipType): Unit = js.native
  
  def updatePendingEvent(event: MatrixEvent[EventContentTypeMessage, EventType], newStatus: EventStatus, newEventId: String): Unit = js.native
