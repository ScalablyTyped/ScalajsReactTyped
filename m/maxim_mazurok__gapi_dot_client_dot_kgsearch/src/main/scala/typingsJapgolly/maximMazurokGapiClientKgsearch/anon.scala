...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    var languages: js.UndefOr[String | js.Array[String]] = js.undefined
  ...
  object Accesstoken {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setLanguages(value: String | js.Array[String]): Self = StObject.set(x, "languages", value.asInstanceOf[js.Any])
