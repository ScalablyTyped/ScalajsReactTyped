...
trait Uint32Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any]): Uint32Array = js.native
  def filter(
  ...
  val toStringTag: typingsJapgolly.minappEnv.minappEnvStrings.Uint32Array = js.native
