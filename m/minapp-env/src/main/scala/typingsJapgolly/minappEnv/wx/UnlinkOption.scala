...
object UnlinkOption {
  ...
  extension [Self <: UnlinkOption](x: Self) {
    ...
    inline def setFail(value: /* result */ UnlinkFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ UnlinkFailCallbackResult) => value(t0).runNow()))
