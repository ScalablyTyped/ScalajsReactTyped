...
object ChooseVideoOption {
  ...
  extension [Self <: ChooseVideoOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ ChooseVideoSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ ChooseVideoSuccessCallbackResult) => value(t0).runNow()))
