...
object CanvasGetImageDataOption {
  ...
  extension [Self <: CanvasGetImageDataOption](x: Self) {
    ...
    inline def setSuccess(
      value: (/* result */ CanvasGetImageDataSuccessCallbackResult, /* data */ Uint8ClampedArray) => Callback
    ): Self = StObject.set(x, "success", js.Any.fromFunction2((t0: /* result */ CanvasGetImageDataSuccessCallbackResult, t1: /* data */ Uint8ClampedArray) => (value(t0, t1)).runNow()))
