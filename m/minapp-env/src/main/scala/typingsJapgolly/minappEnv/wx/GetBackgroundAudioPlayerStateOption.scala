...
object GetBackgroundAudioPlayerStateOption {
  ...
  extension [Self <: GetBackgroundAudioPlayerStateOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetBackgroundAudioPlayerStateSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetBackgroundAudioPlayerStateSuccessCallbackResult) => value(t0).runNow()))
