...
object GetSettingOption {
  ...
  extension [Self <: GetSettingOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetSettingSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetSettingSuccessCallbackResult) => value(t0).runNow()))
