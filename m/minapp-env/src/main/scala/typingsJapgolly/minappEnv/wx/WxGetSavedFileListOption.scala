...
object WxGetSavedFileListOption {
  ...
  extension [Self <: WxGetSavedFileListOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ WxGetSavedFileListSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ WxGetSavedFileListSuccessCallbackResult) => value(t0).runNow()))
