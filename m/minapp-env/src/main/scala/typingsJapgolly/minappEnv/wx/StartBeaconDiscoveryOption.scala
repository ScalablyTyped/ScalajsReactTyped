...
object StartBeaconDiscoveryOption {
  ...
  inline def apply(uuids: Array[String]): StartBeaconDiscoveryOption = {
  ...
  extension [Self <: StartBeaconDiscoveryOption](x: Self) {
    ...
    inline def setUuids(value: Array[String]): Self = StObject.set(x, "uuids", value.asInstanceOf[js.Any])
  }
}
