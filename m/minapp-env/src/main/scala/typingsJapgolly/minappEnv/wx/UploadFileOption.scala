...
object UploadFileOption {
  ...
  def apply(
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.minappEnv.wx.UploadFileSuccessCallbackResult) => success(t0).runNow()))
