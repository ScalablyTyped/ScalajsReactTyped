...
object UploadFileOption {
  ...
  extension [Self <: UploadFileOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ UploadFileSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ UploadFileSuccessCallbackResult) => value(t0).runNow()))
