...
object FileSystemManagerRemoveSavedFileOption {
  ...
  extension [Self <: FileSystemManagerRemoveSavedFileOption](x: Self) {
    ...
    inline def setFail(value: /* result */ RemoveSavedFileFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ RemoveSavedFileFailCallbackResult) => value(t0).runNow()))
