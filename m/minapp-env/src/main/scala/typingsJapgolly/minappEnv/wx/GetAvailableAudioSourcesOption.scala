...
object GetAvailableAudioSourcesOption {
  ...
  inline def apply(): GetAvailableAudioSourcesOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetAvailableAudioSourcesOption]
  }
  
  extension [Self <: GetAvailableAudioSourcesOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetAvailableAudioSourcesSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetAvailableAudioSourcesSuccessCallbackResult) => value(t0).runNow()))
