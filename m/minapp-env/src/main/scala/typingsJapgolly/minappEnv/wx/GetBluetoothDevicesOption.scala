...
object GetBluetoothDevicesOption {
  ...
  inline def apply(): GetBluetoothDevicesOption = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetBluetoothDevicesOption]
  }
  
  extension [Self <: GetBluetoothDevicesOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetBluetoothDevicesSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetBluetoothDevicesSuccessCallbackResult) => value(t0).runNow()))
