...
object CameraContextStartRecordOption {
  ...
  def apply(
    ...
    timeoutCallback: /* result */ StartRecordTimeoutCallbackResult => Callback = null
  ): CameraContextStartRecordOption = {
    val __obj = js.Dynamic.literal()
    if (complete != null) __obj.updateDynamic("complete")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.minappEnv.wx.GeneralCallbackResult) => complete(t0).runNow()))
    if (fail != null) __obj.updateDynamic("fail")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.minappEnv.wx.GeneralCallbackResult) => fail(t0).runNow()))
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.minappEnv.wx.GeneralCallbackResult) => success(t0).runNow()))
    if (timeoutCallback != null) __obj.updateDynamic("timeoutCallback")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.minappEnv.wx.StartRecordTimeoutCallbackResult) => timeoutCallback(t0).runNow()))
