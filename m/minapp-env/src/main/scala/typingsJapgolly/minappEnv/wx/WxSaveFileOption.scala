...
object WxSaveFileOption {
  ...
  extension [Self <: WxSaveFileOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ WxSaveFileSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ WxSaveFileSuccessCallbackResult) => value(t0).runNow()))
