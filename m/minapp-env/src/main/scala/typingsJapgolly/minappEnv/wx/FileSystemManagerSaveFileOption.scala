...
object FileSystemManagerSaveFileOption {
  ...
  extension [Self <: FileSystemManagerSaveFileOption](x: Self) {
    ...
    inline def setFail(value: /* result */ SaveFileFailCallbackResult => Callback): Self = StObject.set(x, "fail", js.Any.fromFunction1((t0: /* result */ SaveFileFailCallbackResult) => value(t0).runNow()))
    ...
    inline def setSuccess(value: /* result */ FileSystemManagerSaveFileSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ FileSystemManagerSaveFileSuccessCallbackResult) => value(t0).runNow()))
