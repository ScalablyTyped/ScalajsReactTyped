...
object GetScreenBrightnessOption {
  ...
  extension [Self <: GetScreenBrightnessOption](x: Self) {
    ...
    inline def setSuccess(value: /* option */ GetScreenBrightnessSuccessCallbackOption => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* option */ GetScreenBrightnessSuccessCallbackOption) => value(t0).runNow()))
