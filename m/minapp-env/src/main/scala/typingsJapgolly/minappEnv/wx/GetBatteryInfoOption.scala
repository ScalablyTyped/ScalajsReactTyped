...
object GetBatteryInfoOption {
  ...
  extension [Self <: GetBatteryInfoOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetBatteryInfoSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetBatteryInfoSuccessCallbackResult) => value(t0).runNow()))
