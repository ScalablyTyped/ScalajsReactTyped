...
object GetRegionOption {
  ...
  extension [Self <: GetRegionOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetRegionSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetRegionSuccessCallbackResult) => value(t0).runNow()))
