...
object GetShareInfoOption {
  ...
  def apply(
    ...
    success: /* result */ GetShareInfoSuccessCallbackResult => Callback = null,
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.minappEnv.wx.GetShareInfoSuccessCallbackResult) => success(t0).runNow()))
