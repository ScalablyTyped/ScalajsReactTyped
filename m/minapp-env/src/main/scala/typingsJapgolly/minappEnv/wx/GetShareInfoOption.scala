...
object GetShareInfoOption {
  ...
  extension [Self <: GetShareInfoOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetShareInfoSuccessCallbackResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetShareInfoSuccessCallbackResult) => value(t0).runNow()))
