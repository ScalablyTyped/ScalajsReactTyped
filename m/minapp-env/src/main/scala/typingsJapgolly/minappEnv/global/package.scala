...
import typingsJapgolly.minappEnv.App.AppConstructor
import typingsJapgolly.minappEnv.App.GetApp
import typingsJapgolly.minappEnv.Console
import typingsJapgolly.minappEnv.GeneratorFunctionConstructor
import typingsJapgolly.minappEnv.MapConstructor
import typingsJapgolly.minappEnv.Page.GetCurrentPages
import typingsJapgolly.minappEnv.Page.PageConstructor
import typingsJapgolly.minappEnv.PromiseConstructor
import typingsJapgolly.minappEnv.ProxyConstructor
import typingsJapgolly.minappEnv.SetConstructor
import typingsJapgolly.minappEnv.SymbolConstructor
import typingsJapgolly.minappEnv.WeakMapConstructor
import typingsJapgolly.minappEnv.WeakSetConstructor
import typingsJapgolly.minappEnv.wx.Wx
...
/**
  ...
  */
inline def JSON: typingsJapgolly.minappEnv.JSON = js.Dynamic.global.selectDynamic("JSON").asInstanceOf[typingsJapgolly.minappEnv.JSON]

inline def Map_=(x: MapConstructor): Unit = js.Dynamic.global.updateDynamic("Map")(x.asInstanceOf[js.Any])

/** An intrinsic object that provides basic mathematics functionality and constants. */
inline def Math: typingsJapgolly.minappEnv.Math = js.Dynamic.global.selectDynamic("Math").asInstanceOf[typingsJapgolly.minappEnv.Math]
...
inline def setInterval(handler: Any, timeout: Any, args: Any*): Double = (js.Dynamic.global.applyDynamic("setInterval")((scala.List(handler.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).`++`(args.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Double]
inline def setInterval(handler: Any, timeout: Unit, args: Any*): Double = (js.Dynamic.global.applyDynamic("setInterval")((scala.List(handler.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).`++`(args.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Double]
...
inline def setTimeout(handler: Any, timeout: Any, args: Any*): Double = (js.Dynamic.global.applyDynamic("setTimeout")((scala.List(handler.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).`++`(args.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Double]
inline def setTimeout(handler: Any, timeout: Unit, args: Any*): Double = (js.Dynamic.global.applyDynamic("setTimeout")((scala.List(handler.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).`++`(args.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Double]
