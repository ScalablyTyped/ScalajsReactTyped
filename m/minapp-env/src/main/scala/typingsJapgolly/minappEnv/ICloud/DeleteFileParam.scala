...
object DeleteFileParam {
  ...
  def apply(
    ...
    complete: /* val */ DeleteFileResult | IAPIError => Callback = null,
    config: ICloudConfig = null,
    fail: /* err */ IAPIError => Callback = null,
    success: DeleteFileResult => Callback = null
  ): DeleteFileParam = {
    val __obj = js.Dynamic.literal(fileList = fileList.asInstanceOf[js.Any])
    if (complete != null) __obj.updateDynamic("complete")(js.Any.fromFunction1((t0: /* val */ typingsJapgolly.minappEnv.ICloud.DeleteFileResult | typingsJapgolly.minappEnv.IAPIError) => complete(t0).runNow()))
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: typingsJapgolly.minappEnv.ICloud.DeleteFileResult) => success(t0).runNow()))
