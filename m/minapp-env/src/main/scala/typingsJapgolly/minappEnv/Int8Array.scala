...
trait Int8Array
  ...
  /**
    ...
    * If thisArg is omitted, undefined is used as the this value.
    */
  def filter(callbackfn: js.Function3[/* value */ Double, /* index */ Double, /* array */ this.type, Any]): Int8Array = js.native
  def filter(
  ...
  val toStringTag: typingsJapgolly.minappEnv.minappEnvStrings.Int8Array = js.native
