...
import typingsJapgolly.minappEnv.minappEnvStrings.button
import typingsJapgolly.minappEnv.minappEnvStrings.menu
...
object Page {
  ...
  object PageInstance {
    ...
    extension [Self <: PageInstance[?, ?], D /* <: IAnyObject */, T /* <: IAnyObject */](x: Self & (PageInstance[D, T])) {
      ...
      inline def setOnLoad(value: /* query */ js.UndefOr[StringDictionary[java.lang.String]] => Callback): Self = StObject.set(x, "onLoad", js.Any.fromFunction1((t0: /* query */ js.UndefOr[StringDictionary[java.lang.String]]) => value(t0).runNow()))
      
      inline def setOnLoadUndefined: Self = StObject.set(x, "onLoad", js.undefined)
      
      inline def setOnPageScroll(value: /* options */ js.UndefOr[IPageScrollOption] => Callback): Self = StObject.set(x, "onPageScroll", js.Any.fromFunction1((t0: /* options */ js.UndefOr[IPageScrollOption]) => value(t0).runNow()))
      ...
      inline def setOnTabItemTap(value: /* options */ js.UndefOr[ITabItemTapOption] => Callback): Self = StObject.set(x, "onTabItemTap", js.Any.fromFunction1((t0: /* options */ js.UndefOr[ITabItemTapOption]) => value(t0).runNow()))
  ...
  object PageInstanceBaseProps {
    ...
    extension [Self <: PageInstanceBaseProps[?], D /* <: IAnyObject */](x: Self & PageInstanceBaseProps[D]) {
      ...
      inline def setSetData(
        value: (/* data */ D | (Pick[D, /* keyof D */ java.lang.String]) | IAnyObject, /* callback */ js.UndefOr[js.Function0[Unit]]) => Callback
      ): Self = StObject.set(x, "setData", js.Any.fromFunction2((t0: /* data */ D | (Pick[D, /* keyof D */ java.lang.String]) | IAnyObject, t1: /* callback */ js.UndefOr[js.Function0[Unit]]) => (value(t0, t1)).runNow()))
