...
object devStreamMod {
  ...
  inline def stream(options: typingsJapgolly.micromarkUtilTypes.mod.Options): MinimalDuplex = ^.asInstanceOf[js.Dynamic].applyDynamic("stream")(options.asInstanceOf[js.Any]).asInstanceOf[MinimalDuplex]
  ...
  object MinimalDuplex {
    ...
    inline def apply(
      ...
      end: CallbackTo[MinimalDuplex],
      eventNames: CallbackTo[js.Array[String | js.Symbol]],
      ...
      readable: Boolean,
      removeAllListeners: CallbackTo[MinimalDuplex],
      ...
      val __obj = js.Dynamic.literal(addListener = js.Any.fromFunction2(addListener), emit = js.Any.fromFunction2(emit), end = end.toJsFn, eventNames = eventNames.toJsFn, getMaxListeners = getMaxListeners.toJsFn, listenerCount = js.Any.fromFunction1(listenerCount), listeners = js.Any.fromFunction1(listeners), off = js.Any.fromFunction2(off), on = js.Any.fromFunction2(on), once = js.Any.fromFunction2(once), pipe = js.Any.fromFunction1(pipe), prependListener = js.Any.fromFunction2(prependListener), prependOnceListener = js.Any.fromFunction2(prependOnceListener), rawListeners = js.Any.fromFunction1(rawListeners), readable = readable.asInstanceOf[js.Any], removeAllListeners = removeAllListeners.toJsFn, removeListener = js.Any.fromFunction2(removeListener), setMaxListeners = js.Any.fromFunction1(setMaxListeners), writable = writable.asInstanceOf[js.Any], write = js.Any.fromFunction1(write))
    ...
    extension [Self <: MinimalDuplex](x: Self) {
      ...
      inline def setEnd(value: CallbackTo[MinimalDuplex]): Self = StObject.set(x, "end", value.toJsFn)
      
      inline def setEventNames(value: CallbackTo[js.Array[String | js.Symbol]]): Self = StObject.set(x, "eventNames", value.toJsFn)
      ...
      inline def setRemoveAllListeners(value: CallbackTo[MinimalDuplex]): Self = StObject.set(x, "removeAllListeners", value.toJsFn)
