...
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.AltCallback
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.CallbackFields
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.FieldsKey
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.Filter
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.KeyOauthtoken
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.OauthtokenPrettyPrint
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.Resource
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.UploadType
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientSpanner.anon.Xgafv
...
trait SessionsResource extends StObject {
  ...
  def batchCreate(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Database): Request[BatchCreateSessionsResponse] = js.native
  ...
  def beginTransaction(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: BeginTransactionRequest): Request[Transaction] = js.native
  
  def commit(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: CommitRequest): Request[CommitResponse] = js.native
  /**
  ...
  def executeBatchDml(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: ExecuteBatchDmlRequest): Request[ExecuteBatchDmlResponse] = js.native
  ...
  def executeSql(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: ExecuteSqlRequest): Request[ResultSet] = js.native
  ...
  def executeStreamingSql(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: ExecuteSqlRequest): Request[PartialResultSet] = js.native
  ...
  def partitionQuery(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: PartitionQueryRequest): Request[PartitionResponse] = js.native
  ...
  def partitionRead(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: PartitionReadRequest): Request[PartitionResponse] = js.native
  ...
  def read(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: ReadRequest): Request[ResultSet] = js.native
  ...
  def rollback(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: RollbackRequest): Request[js.Object] = js.native
  ...
  def streamingRead(request: typingsJapgolly.maximMazurokGapiClientSpanner.anon.Session, body: ReadRequest): Request[PartialResultSet] = js.native
}
