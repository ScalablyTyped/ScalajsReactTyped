...
import typingsJapgolly.maximMazurokGapiClientSpanner.gapi.client.spanner.PartitionReadRequest
...
object FieldsKey {
  ...
  inline def apply(resource: PartitionReadRequest, session: String): FieldsKey = {
