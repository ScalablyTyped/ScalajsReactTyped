...
import typingsJapgolly.maximMazurokGapiClientSpanner.gapi.client.spanner.RollbackRequest
...
object OauthtokenPrettyPrint {
  ...
  inline def apply(resource: RollbackRequest, session: String): OauthtokenPrettyPrint = {
