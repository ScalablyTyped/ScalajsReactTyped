...
import typingsJapgolly.materialDialog.materialDialogStrings.`mdc-dialog--animating`
import typingsJapgolly.materialDialog.materialDialogStrings.`mdc-dialog--open`
import typingsJapgolly.materialDialog.materialDialogStrings.`mdc-dialog-scroll-lock`
import typingsJapgolly.materialDialog.materialDialogStrings.`mdc-dialog__backdrop`
import typingsJapgolly.materialDialog.materialDialogStrings.`mdc-dialog__footer__button--accept`
import typingsJapgolly.materialDialog.materialDialogStrings.`mdc-dialog__footer__button--cancel`
import typingsJapgolly.materialDialog.materialDialogStrings.`mdc-dialog`
