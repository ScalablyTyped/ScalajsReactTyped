...
import typingsJapgolly.materialDialog.foundationMod.MDCDialogFoundation
...
object componentMod {
  ...
  object MDCDialog {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCDialog = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCDialog]
  }
}
