...
import typingsJapgolly.maximMazurokGapiClientGamesmanagement.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientGamesmanagement.anon.Alt
import typingsJapgolly.maximMazurokGapiClientGamesmanagement.anon.Callback
