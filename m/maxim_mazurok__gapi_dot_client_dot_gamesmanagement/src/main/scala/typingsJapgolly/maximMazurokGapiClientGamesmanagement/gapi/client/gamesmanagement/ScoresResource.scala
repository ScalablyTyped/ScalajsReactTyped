...
import typingsJapgolly.maximMazurokGapiClientGamesmanagement.anon.Alt
import typingsJapgolly.maximMazurokGapiClientGamesmanagement.anon.LeaderboardId
import typingsJapgolly.maximMazurokGapiClientGamesmanagement.anon.Oauthtoken
