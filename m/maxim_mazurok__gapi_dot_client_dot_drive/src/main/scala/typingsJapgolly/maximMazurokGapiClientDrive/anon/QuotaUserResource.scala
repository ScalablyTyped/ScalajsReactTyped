...
import typingsJapgolly.maximMazurokGapiClientDrive.gapi.client.drive.TeamDrive
...
object QuotaUserResource {
  ...
  inline def apply(resource: TeamDrive, teamDriveId: String): QuotaUserResource = {
  ...
  extension [Self <: QuotaUserResource](x: Self) {
    ...
    inline def setResource(value: TeamDrive): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
