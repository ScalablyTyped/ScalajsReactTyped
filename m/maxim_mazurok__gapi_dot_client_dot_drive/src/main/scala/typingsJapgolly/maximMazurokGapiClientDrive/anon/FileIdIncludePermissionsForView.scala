...
trait FileIdIncludePermissionsForView extends StObject {
...
object FileIdIncludePermissionsForView {
  
  inline def apply(fileId: String): FileIdIncludePermissionsForView = {
