...
import typingsJapgolly.maximMazurokGapiClientDrive.anon.AcknowledgeAbuse
import typingsJapgolly.maximMazurokGapiClientDrive.anon.AddParents
import typingsJapgolly.maximMazurokGapiClientDrive.anon.AltEnforceSingleParent
import typingsJapgolly.maximMazurokGapiClientDrive.anon.AltFields
import typingsJapgolly.maximMazurokGapiClientDrive.anon.Corpora
import typingsJapgolly.maximMazurokGapiClientDrive.anon.Count
import typingsJapgolly.maximMazurokGapiClientDrive.anon.EnforceSingleParent
import typingsJapgolly.maximMazurokGapiClientDrive.anon.FieldsFileId
import typingsJapgolly.maximMazurokGapiClientDrive.anon.IgnoreDefaultVisibility
import typingsJapgolly.maximMazurokGapiClientDrive.anon.IncludeLabels
import typingsJapgolly.maximMazurokGapiClientDrive.anon.IncludePermissionsForView
import typingsJapgolly.maximMazurokGapiClientDrive.anon.KeepRevisionForever
import typingsJapgolly.maximMazurokGapiClientDrive.anon.MaxResults
import typingsJapgolly.maximMazurokGapiClientDrive.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientDrive.anon.SupportsAllDrives
import typingsJapgolly.maximMazurokGapiClientDrive.anon.SupportsTeamDrives
