...
import typingsJapgolly.maximMazurokGapiClientDrive.anon.CanChangeCopyRequiresWriterPermissionRestriction
import typingsJapgolly.maximMazurokGapiClientDrive.anon.CopyRequiresWriterPermission
import typingsJapgolly.maximMazurokGapiClientDrive.anon.Id
