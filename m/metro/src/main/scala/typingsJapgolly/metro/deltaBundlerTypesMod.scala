...
import typingsJapgolly.metro.anon.AsyncType
import typingsJapgolly.metro.anon.Code
...
import typingsJapgolly.metroTransformWorker.mod.Type
...
object deltaBundlerTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.metro.metroStrings.async
    - typingsJapgolly.metro.metroStrings.prefetch
  */
  trait AsyncDependencyType extends StObject
  object AsyncDependencyType {
    
    inline def async: typingsJapgolly.metro.metroStrings.async = "async".asInstanceOf[typingsJapgolly.metro.metroStrings.async]
    
    inline def prefetch: typingsJapgolly.metro.metroStrings.prefetch = "prefetch".asInstanceOf[typingsJapgolly.metro.metroStrings.prefetch]
  }
  ...
  object Module {
    ...
    inline def apply[T](
      ...
      getSource: CallbackTo[Buffer],
      inverseDependencies: Set[String],
      output: js.Array[T],
      path: String
    ): Module[T] = {
      val __obj = js.Dynamic.literal(dependencies = dependencies.asInstanceOf[js.Any], getSource = getSource.toJsFn, inverseDependencies = inverseDependencies.asInstanceOf[js.Any], output = output.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
    ...
    extension [Self <: Module[?], T](x: Self & Module[T]) {
      ...
      inline def setGetSource(value: CallbackTo[Buffer]): Self = StObject.set(x, "getSource", value.toJsFn)
