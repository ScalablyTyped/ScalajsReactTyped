...
import typingsJapgolly.metro.deltaBundlerTypesMod.TransformResultDependency
import typingsJapgolly.metro.metroStrings.concrete
import typingsJapgolly.metro.metroStrings.linked
import typingsJapgolly.metroSourceMap.mod.BasicSourceMap
...
object moduleGraphTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.metro.moduleGraphTypesMod.ConcreteTransformResult
    - typingsJapgolly.metro.moduleGraphTypesMod.LinkedTransformResult
  */
  trait TransformResult extends StObject
  object TransformResult {
    
    inline def ConcreteTransformResult(code: String, dependencies: js.Array[TransformResultDependency]): typingsJapgolly.metro.moduleGraphTypesMod.ConcreteTransformResult = {
      val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any], dependencies = dependencies.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("concrete")
      __obj.asInstanceOf[typingsJapgolly.metro.moduleGraphTypesMod.ConcreteTransformResult]
    }
    
    inline def LinkedTransformResult(sourceVariantName: String): typingsJapgolly.metro.moduleGraphTypesMod.LinkedTransformResult = {
      val __obj = js.Dynamic.literal(sourceVariantName = sourceVariantName.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("linked")
      __obj.asInstanceOf[typingsJapgolly.metro.moduleGraphTypesMod.LinkedTransformResult]
    }
  }
