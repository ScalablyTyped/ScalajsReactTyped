...
object srcServerMod {
  ...
  object Server {
    ...
    inline def apply(end: Callback, getAssets: BundleOptions => js.Promise[js.Array[AssetData]]): Server = {
      val __obj = js.Dynamic.literal(end = end.toJsFn, getAssets = js.Any.fromFunction1(getAssets))
  ...
  object ServerOptions {
    ...
    extension [Self <: ServerOptions](x: Self) {
      ...
      inline def setOnBundleBuilt(value: /* bundlePath */ String => Callback): Self = StObject.set(x, "onBundleBuilt", js.Any.fromFunction1((t0: /* bundlePath */ String) => value(t0).runNow()))
