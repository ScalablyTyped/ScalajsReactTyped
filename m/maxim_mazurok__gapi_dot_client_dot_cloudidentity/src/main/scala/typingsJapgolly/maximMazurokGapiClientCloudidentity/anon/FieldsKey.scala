...
import typingsJapgolly.maximMazurokGapiClientCloudidentity.gapi.client.cloudidentity.ModifyMembershipRolesRequest
...
object FieldsKey {
  ...
  inline def apply(name: String, resource: ModifyMembershipRolesRequest): FieldsKey = {
