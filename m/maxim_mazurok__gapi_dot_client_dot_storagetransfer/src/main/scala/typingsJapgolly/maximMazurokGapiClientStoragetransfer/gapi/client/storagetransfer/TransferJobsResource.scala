...
import typingsJapgolly.maximMazurokGapiClientStoragetransfer.anon.Filter
import typingsJapgolly.maximMazurokGapiClientStoragetransfer.anon.JobName
import typingsJapgolly.maximMazurokGapiClientStoragetransfer.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientStoragetransfer.anon.PrettyPrint
import typingsJapgolly.maximMazurokGapiClientStoragetransfer.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientStoragetransfer.anon.Resource
import typingsJapgolly.maximMazurokGapiClientStoragetransfer.anon.UploadType
