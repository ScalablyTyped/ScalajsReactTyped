...
import typingsJapgolly.mischnicJsonSourcemap.anon.Data
import typingsJapgolly.mischnicJsonSourcemap.anon.Dialect
...
object distMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mischnicJsonSourcemap.anon.Value
    - typingsJapgolly.mischnicJsonSourcemap.anon.Key
  */
  trait Mapping extends StObject
  object Mapping {
    
    inline def Key(value: Position, valueEnd: Position): typingsJapgolly.mischnicJsonSourcemap.anon.Key = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], valueEnd = valueEnd.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.mischnicJsonSourcemap.anon.Key]
    }
    
    inline def Value(value: Position, valueEnd: Position): typingsJapgolly.mischnicJsonSourcemap.anon.Value = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], valueEnd = valueEnd.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.mischnicJsonSourcemap.anon.Value]
    }
  }
