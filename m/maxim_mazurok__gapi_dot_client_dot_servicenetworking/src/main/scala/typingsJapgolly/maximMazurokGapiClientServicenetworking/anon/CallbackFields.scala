...
import typingsJapgolly.maximMazurokGapiClientServicenetworking.gapi.client.servicenetworking.DisableVpcServiceControlsRequest
...
object CallbackFields {
  ...
  inline def apply(parent: String, resource: DisableVpcServiceControlsRequest): CallbackFields = {
