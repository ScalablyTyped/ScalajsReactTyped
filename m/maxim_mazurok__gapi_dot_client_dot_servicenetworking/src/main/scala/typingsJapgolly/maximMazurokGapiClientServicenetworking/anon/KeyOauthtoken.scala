...
import typingsJapgolly.maximMazurokGapiClientServicenetworking.gapi.client.servicenetworking.SearchRangeRequest
...
object KeyOauthtoken {
  ...
  inline def apply(parent: String, resource: SearchRangeRequest): KeyOauthtoken = {
