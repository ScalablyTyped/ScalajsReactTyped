...
import typingsJapgolly.maximMazurokGapiClientServicenetworking.gapi.client.servicenetworking.PeeredDnsDomain
...
object Uploadprotocol {
  ...
  inline def apply(parent: String, resource: PeeredDnsDomain): Uploadprotocol = {
