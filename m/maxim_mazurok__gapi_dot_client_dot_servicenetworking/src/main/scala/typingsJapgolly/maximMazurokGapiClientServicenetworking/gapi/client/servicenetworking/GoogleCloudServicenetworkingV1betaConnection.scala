...
trait GoogleCloudServicenetworkingV1betaConnection extends StObject {
...
object GoogleCloudServicenetworkingV1betaConnection {
  
  inline def apply(): GoogleCloudServicenetworkingV1betaConnection = {
