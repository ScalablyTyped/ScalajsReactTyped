package typingsJapgolly.muibox.components
...
object DialogProvider {
  ...
  implicit def make(companion: DialogProvider.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
