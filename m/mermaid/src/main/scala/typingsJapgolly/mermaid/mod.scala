...
import typingsJapgolly.mermaid.mermaidStrings.BT
import typingsJapgolly.mermaid.mermaidStrings.LR
import typingsJapgolly.mermaid.mermaidStrings.RL
import typingsJapgolly.mermaid.mermaidStrings.TB
import typingsJapgolly.mermaid.mermaidStrings.`dagre-d3`
import typingsJapgolly.mermaid.mermaidStrings.`dagre-wrapper`
import typingsJapgolly.mermaid.mermaidStrings.`null`
import typingsJapgolly.mermaid.mermaidStrings.antiscript
import typingsJapgolly.mermaid.mermaidStrings.arrowMarkerAbsolute
import typingsJapgolly.mermaid.mermaidStrings.basis
import typingsJapgolly.mermaid.mermaidStrings.c4
import typingsJapgolly.mermaid.mermaidStrings.cardinal
import typingsJapgolly.mermaid.mermaidStrings.center
import typingsJapgolly.mermaid.mermaidStrings.dark
import typingsJapgolly.mermaid.mermaidStrings.debug
import typingsJapgolly.mermaid.mermaidStrings.deterministicIDSeed
import typingsJapgolly.mermaid.mermaidStrings.deterministicIds
import typingsJapgolly.mermaid.mermaidStrings.er
import typingsJapgolly.mermaid.mermaidStrings.error
import typingsJapgolly.mermaid.mermaidStrings.fatal
import typingsJapgolly.mermaid.mermaidStrings.flowchart
import typingsJapgolly.mermaid.mermaidStrings.fontFamily
import typingsJapgolly.mermaid.mermaidStrings.forest
import typingsJapgolly.mermaid.mermaidStrings.gantt
import typingsJapgolly.mermaid.mermaidStrings.info
import typingsJapgolly.mermaid.mermaidStrings.journey
import typingsJapgolly.mermaid.mermaidStrings.left
import typingsJapgolly.mermaid.mermaidStrings.linear
import typingsJapgolly.mermaid.mermaidStrings.logLevel
import typingsJapgolly.mermaid.mermaidStrings.loose
import typingsJapgolly.mermaid.mermaidStrings.neutral
import typingsJapgolly.mermaid.mermaidStrings.pie
import typingsJapgolly.mermaid.mermaidStrings.requirement
import typingsJapgolly.mermaid.mermaidStrings.right
import typingsJapgolly.mermaid.mermaidStrings.sandbox
import typingsJapgolly.mermaid.mermaidStrings.secure
import typingsJapgolly.mermaid.mermaidStrings.securityLevel
import typingsJapgolly.mermaid.mermaidStrings.sequence
import typingsJapgolly.mermaid.mermaidStrings.startOnLoad
import typingsJapgolly.mermaid.mermaidStrings.strict
import typingsJapgolly.mermaid.mermaidStrings.theme
import typingsJapgolly.mermaid.mermaidStrings.warn
...
object mod extends Shortcut {
  ...
  trait Config extends StObject {
    ...
    var secure: js.UndefOr[
        js.Array[
          theme | fontFamily | logLevel | securityLevel | startOnLoad | arrowMarkerAbsolute | typingsJapgolly.mermaid.mermaidStrings.secure | deterministicIds | deterministicIDSeed | flowchart | sequence | gantt | journey | er | pie | requirement | c4
        ]
      ] = js.undefined
    ...
    var theme: js.UndefOr[
        dark | typingsJapgolly.mermaid.mermaidStrings.default | forest | neutral | `null`
      ] = js.undefined
  }
  object Config {
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setTheme(value: dark | typingsJapgolly.mermaid.mermaidStrings.default | forest | neutral | `null`): Self = StObject.set(x, "theme", value.asInstanceOf[js.Any])
  ...
  object Mermaid {
    ...
    inline def apply(
      ...
      initialize: /* options */ Config => Callback,
    ...
    extension [Self <: Mermaid](x: Self) {
      ...
      inline def setInitialize(value: /* options */ Config => Callback): Self = StObject.set(x, "initialize", js.Any.fromFunction1((t0: /* options */ Config) => value(t0).runNow()))
