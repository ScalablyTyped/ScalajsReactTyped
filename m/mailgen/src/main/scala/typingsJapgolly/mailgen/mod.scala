package typingsJapgolly.mailgen
...
object mod {
  ...
  object Mailgen {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(cacheThemes = cacheThemes.toJsFn, generate = js.Any.fromFunction1(generate), generatePlaintext = js.Any.fromFunction1(generatePlaintext), parseParams = js.Any.fromFunction1(parseParams))
      __obj.asInstanceOf[Mailgen]
    }
    
    extension [Self <: Mailgen](x: Self) {
      
      inline def setCacheThemes(value: Callback): Self = StObject.set(x, "cacheThemes", value.toJsFn)
