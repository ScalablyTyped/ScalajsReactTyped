...
import typingsJapgolly.maximMazurokGapiClientFirebase.gapi.client.firebase.ShaCertificate
...
object Callback {
  ...
  inline def apply(parent: String, resource: ShaCertificate): Callback = {
  ...
  extension [Self <: Callback](x: Self) {
    ...
    inline def setResource(value: ShaCertificate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
