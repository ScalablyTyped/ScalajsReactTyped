...
import typingsJapgolly.maximMazurokGapiClientFirebase.gapi.client.firebase.AddFirebaseRequest
...
trait Project extends StObject {
  ...
  /** Request body */
  var resource: AddFirebaseRequest
...
object Project {
  ...
  inline def apply(project: String, resource: AddFirebaseRequest): Project = {
  ...
  extension [Self <: Project](x: Self) {
    ...
    inline def setResource(value: AddFirebaseRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
