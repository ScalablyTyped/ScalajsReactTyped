package typingsJapgolly.maximMazurokGapiClientFirebase.anon

import typingsJapgolly.maximMazurokGapiClientFirebase.gapi.client.firebase.RemoveIosAppRequest
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: RemoveIosAppRequest
...
object UploadType {
  ...
  inline def apply(name: String, resource: RemoveIosAppRequest): UploadType = {
  ...
  extension [Self <: UploadType](x: Self) {
    ...
    inline def setResource(value: RemoveIosAppRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
