...
import typingsJapgolly.maximMazurokGapiClientGamesconfiguration.gapi.client.gamesconfiguration.AchievementConfigurationsResource
import typingsJapgolly.maximMazurokGapiClientGamesconfiguration.gapi.client.gamesconfiguration.ImageConfigurationsResource
import typingsJapgolly.maximMazurokGapiClientGamesconfiguration.gapi.client.gamesconfiguration.LeaderboardConfigurationsResource
import typingsJapgolly.maximMazurokGapiClientGamesconfiguration.maximMazurokGapiClientGamesconfigurationStrings.gamesconfiguration
import typingsJapgolly.maximMazurokGapiClientGamesconfiguration.maximMazurokGapiClientGamesconfigurationStrings.v1configuration
