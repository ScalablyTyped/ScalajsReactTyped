...
object MembersSuccessResponse {
  ...
  extension [Self <: MembersSuccessResponse](x: Self) {
    ...
    inline def set_links(value: js.Array[Links]): Self = StObject.set(x, "_links", value.asInstanceOf[js.Any])
    
    inline def set_linksVarargs(value: Links*): Self = StObject.set(x, "_links", js.Array(value*))
  }
}
