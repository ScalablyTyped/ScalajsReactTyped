...
import typingsJapgolly.mondaySdkJs.anon.AssetId
import typingsJapgolly.mondaySdkJs.anon.BoardId
import typingsJapgolly.mondaySdkJs.anon.CancelButton
import typingsJapgolly.mondaySdkJs.anon.Data
import typingsJapgolly.mondaySdkJs.anon.DataAny
import typingsJapgolly.mondaySdkJs.anon.DataConfirm
import typingsJapgolly.mondaySdkJs.anon.Height
import typingsJapgolly.mondaySdkJs.anon.Instance
import typingsJapgolly.mondaySdkJs.anon.ItemId
import typingsJapgolly.mondaySdkJs.anon.Message
...
import typingsJapgolly.mondaySdkJs.anon.Partialtokenstringvariabl
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.closeAppFeatureModal
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.confirm
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.context
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.itemIds
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.notice
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.openAppFeatureModal
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.openFilesDialog
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.openItemCard
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.sessionToken
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.settings
import typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.triggerFilesUpload
...
object mod {
  ...
  inline def apply(): MondayServerSdk = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[MondayServerSdk]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.context
    - typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.settings
    - typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.itemIds
    - typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.events
  */
  trait SubscribableEvents extends StObject
  object SubscribableEvents {
    
    inline def context: typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.context = "context".asInstanceOf[typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.context]
    
    inline def events: typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.events = "events".asInstanceOf[typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.events]
    
    inline def itemIds: typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.itemIds = "itemIds".asInstanceOf[typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.itemIds]
    
    inline def settings: typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.settings = "settings".asInstanceOf[typingsJapgolly.mondaySdkJs.mondaySdkJsStrings.settings]
  }
}
