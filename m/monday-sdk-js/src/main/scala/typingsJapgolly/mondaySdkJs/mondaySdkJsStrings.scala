...
import typingsJapgolly.mondaySdkJs.mod.SubscribableEvents
...
object mondaySdkJsStrings {
  ...
  sealed trait itemIds
    extends StObject
       with SubscribableEvents
  inline def itemIds: itemIds = "itemIds".asInstanceOf[itemIds]
  ...
  inline def sessionToken: sessionToken = "sessionToken".asInstanceOf[sessionToken]
