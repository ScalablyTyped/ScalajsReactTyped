...
import typingsJapgolly.matterJs.mod.IEvent
import typingsJapgolly.matterJs.mod.IEventCollision
import typingsJapgolly.matterJs.mod.IEventComposite
import typingsJapgolly.matterJs.mod.IEventTimestamped
import typingsJapgolly.matterJs.mod.IMouseEvent
...
@js.native
open class Events ()
  extends typingsJapgolly.matterJs.mod.Events
/* static members */
object Events {
  ...
  inline def on_afterAdd(
    obj: typingsJapgolly.matterJs.mod.Engine,
    name: afterAdd,
    callback: js.Function1[/* e */ IEventComposite[typingsJapgolly.matterJs.mod.Composite], Unit]
  ...
  inline def on_afterRender(
    ...
    callback: js.Function1[
      /* e */ IEventTimestamped[typingsJapgolly.matterJs.mod.Render | typingsJapgolly.matterJs.mod.Runner], 
      Unit
    ]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(obj.asInstanceOf[js.Any], name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def on_afterTick(
    obj: typingsJapgolly.matterJs.mod.Engine,
    name: afterTick,
    callback: js.Function1[/* e */ IEventTimestamped[typingsJapgolly.matterJs.mod.Runner], Unit]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(obj.asInstanceOf[js.Any], name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def on_afterUpdate(
    obj: typingsJapgolly.matterJs.mod.Engine,
    name: afterUpdate,
    callback: js.Function1[/* e */ IEventTimestamped[typingsJapgolly.matterJs.mod.Engine], Unit]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(obj.asInstanceOf[js.Any], name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def on_collisionActive(
    ...
    callback: js.Function1[/* e */ IEventCollision[typingsJapgolly.matterJs.mod.Engine], Unit]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(obj.asInstanceOf[js.Any], name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def on_mousedown(
    obj: typingsJapgolly.matterJs.mod.MouseConstraint,
    name: mousedown,
    callback: js.Function1[/* e */ IMouseEvent[typingsJapgolly.matterJs.mod.MouseConstraint], Unit]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(obj.asInstanceOf[js.Any], name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def on_sleepEnd(
    obj: typingsJapgolly.matterJs.mod.Body,
    name: sleepEnd,
    callback: js.Function1[/* e */ IEvent[typingsJapgolly.matterJs.mod.Body], Unit]
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(obj.asInstanceOf[js.Any], name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
