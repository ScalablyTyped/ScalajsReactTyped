...
import typingsJapgolly.matterJs.mod.Dependency
...
@js.native
open class Plugin ()
  extends typingsJapgolly.matterJs.mod.Plugin
/* static members */
object Plugin {
  ...
  /**
    ...
    */
  inline def isFor(plugin: typingsJapgolly.matterJs.mod.Plugin, module: Dict): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isFor")(plugin.asInstanceOf[js.Any], module.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def register(plugin: typingsJapgolly.matterJs.mod.Plugin): typingsJapgolly.matterJs.mod.Plugin = ^.asInstanceOf[js.Dynamic].applyDynamic("register")(plugin.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.matterJs.mod.Plugin]
  ...
  /**
    ...
    */
  inline def resolve(dependency: String): js.UndefOr[typingsJapgolly.matterJs.mod.Plugin] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(dependency.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.matterJs.mod.Plugin]]
  ...
  inline def toString(plugin: typingsJapgolly.matterJs.mod.Plugin): String = ^.asInstanceOf[js.Dynamic].applyDynamic("toString")(plugin.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    */
  inline def use(module: Uses, plugins: js.Array[typingsJapgolly.matterJs.mod.Plugin | String]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("use")(module.asInstanceOf[js.Any], plugins.asInstanceOf[js.Any])).asInstanceOf[Unit]
