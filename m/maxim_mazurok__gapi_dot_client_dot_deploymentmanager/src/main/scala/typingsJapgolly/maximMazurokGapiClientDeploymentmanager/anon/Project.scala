...
import typingsJapgolly.maximMazurokGapiClientDeploymentmanager.gapi.client.deploymentmanager.DeploymentsStopRequest
...
trait Project extends StObject {
  ...
  /** Request body */
  var resource: DeploymentsStopRequest
...
object Project {
  ...
  inline def apply(deployment: String, project: String, resource: DeploymentsStopRequest): Project = {
  ...
  extension [Self <: Project](x: Self) {
    ...
    inline def setResource(value: DeploymentsStopRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
