...
object anon {
  ...
  object ThisTypeNonNullableNodeHe {
    ...
    extension [Self <: ThisTypeNonNullableNodeHe](x: Self) {
      ...
      inline def setSendSocketNotification(value: (/* notification */ String, /* payload */ Any) => Callback): Self = StObject.set(x, "sendSocketNotification", js.Any.fromFunction2((t0: /* notification */ String, t1: /* payload */ Any) => (value(t0, t1)).runNow()))
      
      inline def setSendSocketNotificationUndefined: Self = StObject.set(x, "sendSocketNotification", js.undefined)
      
      inline def setSocketNotificationReceived(value: (/* notification */ String, /* payload */ Any) => Callback): Self = StObject.set(x, "socketNotificationReceived", js.Any.fromFunction2((t0: /* notification */ String, t1: /* payload */ Any) => (value(t0, t1)).runNow()))
