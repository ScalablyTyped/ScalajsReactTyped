...
trait Fields extends StObject {
  ...
  var wipeDataFlags: js.UndefOr[String | js.Array[String]] = js.undefined
...
object Fields {
  ...
  extension [Self <: Fields](x: Self) {
    ...
    inline def setWipeDataFlags(value: String | js.Array[String]): Self = StObject.set(x, "wipeDataFlags", value.asInstanceOf[js.Any])
