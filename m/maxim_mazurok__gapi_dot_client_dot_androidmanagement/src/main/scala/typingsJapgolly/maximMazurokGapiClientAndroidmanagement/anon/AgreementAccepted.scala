...
import typingsJapgolly.maximMazurokGapiClientAndroidmanagement.gapi.client.androidmanagement.Enterprise
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AgreementAccepted extends StObject {
...
object AgreementAccepted {
  ...
  inline def apply(resource: Enterprise): AgreementAccepted = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AgreementAccepted]
  }
  
  extension [Self <: AgreementAccepted](x: Self) {
