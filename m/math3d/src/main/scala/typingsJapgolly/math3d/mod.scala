package typingsJapgolly.math3d

import typingsJapgolly.math3d.anon.Angle
import typingsJapgolly.math3d.anon.Columns
import typingsJapgolly.math3d.anon.X
import typingsJapgolly.math3d.mod.Transform.Space
  ...
  object Transform {
    ...
    object Space extends StObject {
      ...
      sealed trait Self
        extends StObject
           with Space
      /* 0 */ val Self: typingsJapgolly.math3d.mod.Transform.Space.Self & Double = js.native
      
      @js.native
      sealed trait World
        extends StObject
           with Space
      /* 1 */ val World: typingsJapgolly.math3d.mod.Transform.Space.World & Double = js.native
    }
  }
