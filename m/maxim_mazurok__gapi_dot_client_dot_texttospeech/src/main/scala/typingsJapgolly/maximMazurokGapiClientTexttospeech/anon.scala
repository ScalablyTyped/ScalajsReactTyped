...
import typingsJapgolly.maximMazurokGapiClientTexttospeech.gapi.client.texttospeech.SynthesizeSpeechRequest
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: SynthesizeSpeechRequest
  ...
  object Accesstoken {
    ...
    inline def apply(resource: SynthesizeSpeechRequest): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: SynthesizeSpeechRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
