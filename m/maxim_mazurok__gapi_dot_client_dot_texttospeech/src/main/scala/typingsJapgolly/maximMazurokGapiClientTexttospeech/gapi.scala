...
import typingsJapgolly.maximMazurokGapiClientTexttospeech.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientTexttospeech.anon.Alt
import typingsJapgolly.maximMazurokGapiClientTexttospeech.anon.Callback
