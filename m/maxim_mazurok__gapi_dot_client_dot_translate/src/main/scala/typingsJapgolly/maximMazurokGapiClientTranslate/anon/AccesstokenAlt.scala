...
import typingsJapgolly.maximMazurokGapiClientTranslate.gapi.client.translate.TranslateTextRequest
...
object AccesstokenAlt {
  ...
  inline def apply(parent: String, resource: TranslateTextRequest): AccesstokenAlt = {
