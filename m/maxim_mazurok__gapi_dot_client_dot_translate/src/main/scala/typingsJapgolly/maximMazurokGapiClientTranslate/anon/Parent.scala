package typingsJapgolly.maximMazurokGapiClientTranslate.anon

import typingsJapgolly.maximMazurokGapiClientTranslate.gapi.client.translate.BatchTranslateDocumentRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: BatchTranslateDocumentRequest
...
object Parent {
  ...
  inline def apply(parent: String, resource: BatchTranslateDocumentRequest): Parent = {
  ...
  extension [Self <: Parent](x: Self) {
    ...
    inline def setResource(value: BatchTranslateDocumentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
