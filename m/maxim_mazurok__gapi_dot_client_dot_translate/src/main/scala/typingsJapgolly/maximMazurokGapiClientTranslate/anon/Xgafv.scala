...
import typingsJapgolly.maximMazurokGapiClientTranslate.gapi.client.translate.TranslateDocumentRequest
...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: TranslateDocumentRequest
...
object Xgafv {
  ...
  inline def apply(parent: String, resource: TranslateDocumentRequest): Xgafv = {
  ...
  extension [Self <: Xgafv](x: Self) {
    ...
    inline def setResource(value: TranslateDocumentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
