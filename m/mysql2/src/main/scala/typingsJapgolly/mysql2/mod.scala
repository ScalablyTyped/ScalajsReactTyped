...
import typingsJapgolly.mysql2.anon.Command
...
import typingsJapgolly.mysql2.typingsMysqlMod.Query
...
object mod {
  ...
  inline def createConnection(config: typingsJapgolly.mysql2.typingsMysqlLibConnectionMod.ConnectionOptions): typingsJapgolly.mysql2.typingsMysqlMod.Connection = ^.asInstanceOf[js.Dynamic].applyDynamic("createConnection")(config.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mysql2.typingsMysqlMod.Connection]
  ...
  inline def createPool(config: typingsJapgolly.mysql2.typingsMysqlLibPoolMod.PoolOptions): typingsJapgolly.mysql2.typingsMysqlMod.Pool = ^.asInstanceOf[js.Dynamic].applyDynamic("createPool")(config.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mysql2.typingsMysqlMod.Pool]
  ...
  trait Connection
    ...
    def promise(): typingsJapgolly.mysql2.typingsMysqlMod.Connection = js.native
    def promise(promiseImpl: PromiseConstructor): typingsJapgolly.mysql2.typingsMysqlMod.Connection = js.native
  }
  
  trait ConnectionOptions
    extends StObject
       with typingsJapgolly.mysql2.typingsMysqlLibConnectionMod.ConnectionOptions {
    
    var Promise: js.UndefOr[Any] = js.undefined
    
    var authPlugins: js.UndefOr[StringDictionary[typingsJapgolly.mysql2.mod.authPlugins]] = js.undefined
  ...
  trait Pool
    ...
    def getConnection(
      callback: js.Function2[
          /* err */ ErrnoException, 
          /* connection */ typingsJapgolly.mysql2.typingsMysqlMod.PoolConnection, 
          Any
        ]
    ): Unit = js.native
    ...
    def promise(): typingsJapgolly.mysql2.typingsMysqlMod.Pool = js.native
    def promise(promiseImpl: PromiseConstructor): typingsJapgolly.mysql2.typingsMysqlMod.Pool = js.native
  }
  
  @js.native
  trait PoolConnection
    extends typingsJapgolly.mysql2.typingsMysqlLibPoolConnectionMod.^ {
    
    def promise(): typingsJapgolly.mysql2.typingsMysqlMod.PoolConnection = js.native
    def promise(promiseImpl: PromiseConstructor): typingsJapgolly.mysql2.typingsMysqlMod.PoolConnection = js.native
  }
  
  trait PoolOptions
    extends StObject
       with typingsJapgolly.mysql2.typingsMysqlLibPoolMod.PoolOptions
  object PoolOptions {
