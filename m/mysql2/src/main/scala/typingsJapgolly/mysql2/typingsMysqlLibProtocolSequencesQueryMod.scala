...
import typingsJapgolly.mysql2.mysql2Strings.end
import typingsJapgolly.mysql2.mysql2Strings.error
import typingsJapgolly.mysql2.mysql2Strings.fields
import typingsJapgolly.mysql2.mysql2Strings.result
...
object typingsMysqlLibProtocolSequencesQueryMod {
  ...
  @js.native
  trait Query
    extends typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesSequenceMod.^ {
