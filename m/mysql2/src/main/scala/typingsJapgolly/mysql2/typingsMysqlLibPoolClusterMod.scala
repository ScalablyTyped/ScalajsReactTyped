...
import typingsJapgolly.mysql2.mysql2Strings.remove
  ...
  trait PoolCluster extends EventEmitter {
    ...
    def getConnection(
      callback: js.Function2[
          ...
          /* connection */ typingsJapgolly.mysql2.typingsMysqlLibPoolConnectionMod.^, 
          Unit
        ]
    ): Unit = js.native
    def getConnection(
    ...
    def on_connection(
      event: connection,
      listener: js.Function1[/* connection */ typingsJapgolly.mysql2.typingsMysqlLibPoolConnectionMod.^, Unit]
    ): this.type = js.native
    @JSName("on")
