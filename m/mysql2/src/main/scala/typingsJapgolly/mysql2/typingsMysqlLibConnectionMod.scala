...
import typingsJapgolly.mysql2.mysql2Strings.DATE
import typingsJapgolly.mysql2.mysql2Strings.DATETIME
import typingsJapgolly.mysql2.mysql2Strings.TIMESTAMP
import typingsJapgolly.mysql2.mysql2Strings.local
...
import typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.QueryError
...
object typingsMysqlLibConnectionMod {
  ...
  /* static member */
  inline def createQuery[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](sql: String): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = ^.asInstanceOf[js.Dynamic].applyDynamic("createQuery")(sql.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^]
  ...
  ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = (^.asInstanceOf[js.Dynamic].applyDynamic("createQuery")(sql.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^]
  inline def createQuery[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](sql: String, values: js.Array[Any]): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = (^.asInstanceOf[js.Dynamic].applyDynamic("createQuery")(sql.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^]
  inline def createQuery[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
    sql: String,
    values: js.Array[Any],
    callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
  ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = (^.asInstanceOf[js.Dynamic].applyDynamic("createQuery")(sql.asInstanceOf[js.Any], values.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^]
  inline def createQuery[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](sql: String, values: StringDictionary[Any]): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = (^.asInstanceOf[js.Dynamic].applyDynamic("createQuery")(sql.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^]
  inline def createQuery[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
    sql: String,
  ...
  /* static member */
  inline def createQuery[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](sql: String, values: Any): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = (^.asInstanceOf[js.Dynamic].applyDynamic("createQuery")(sql.asInstanceOf[js.Any], values.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^]
  inline def createQuery[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
    sql: String,
    values: Any,
    callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
  ...
  trait Connection extends EventEmitter {
    ...
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](options: QueryOptions): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    ...
    ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](options: QueryOptions, values: js.Array[Any]): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
      options: QueryOptions,
      values: js.Array[Any],
      callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
    ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](options: QueryOptions, values: StringDictionary[Any]): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
      options: QueryOptions,
      values: StringDictionary[Any],
      callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
    ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](options: QueryOptions, values: Any): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
      options: QueryOptions,
      values: Any,
      callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
    ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](sql: String): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
      sql: String,
      callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
    ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](sql: String, values: js.Array[Any]): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
      sql: String,
      values: js.Array[Any],
      callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
    ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](sql: String, values: StringDictionary[Any]): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
      sql: String,
      values: StringDictionary[Any],
      callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
    ): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](sql: String, values: Any): typingsJapgolly.mysql2.typingsMysqlLibProtocolSequencesQueryMod.^ = js.native
    def query[T /* <: (js.Array[js.Array[RowDataPacket] | OkPacket | RowDataPacket]) | OkPacket | ResultSetHeader */](
      sql: String,
      values: Any,
      callback: js.Function3[/* err */ QueryError | Null, /* result */ T, /* fields */ js.Array[FieldPacket], Any]
  ...
  object ConnectionOptions {
    ...
    extension [Self <: ConnectionOptions](x: Self) {
      ...
      inline def setQueryFormat(value: (/* query */ String, /* values */ Any) => Callback): Self = StObject.set(x, "queryFormat", js.Any.fromFunction2((t0: /* query */ String, t1: /* values */ Any) => (value(t0, t1)).runNow()))
