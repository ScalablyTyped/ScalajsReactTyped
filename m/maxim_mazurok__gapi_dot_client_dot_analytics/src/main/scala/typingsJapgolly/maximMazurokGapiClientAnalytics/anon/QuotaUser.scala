...
object QuotaUser {
  ...
  inline def apply(accountId: String, linkId: String, resource: EntityUserLink): QuotaUser = {
    val __obj = js.Dynamic.literal(accountId = accountId.asInstanceOf[js.Any], linkId = linkId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
