...
import typingsJapgolly.maximMazurokGapiClientAnalytics.gapi.client.analytics.AnalyticsDataimportDeleteUploadDataRequest
...
object CustomDataSourceId {
  ...
  extension [Self <: CustomDataSourceId](x: Self) {
    ...
    inline def setResource(value: AnalyticsDataimportDeleteUploadDataRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
