...
trait CustomDimensionId extends StObject {
...
object CustomDimensionId {
  ...
  inline def apply(accountId: String, customDimensionId: String, webPropertyId: String): CustomDimensionId = {
  ...
  extension [Self <: CustomDimensionId](x: Self) {
