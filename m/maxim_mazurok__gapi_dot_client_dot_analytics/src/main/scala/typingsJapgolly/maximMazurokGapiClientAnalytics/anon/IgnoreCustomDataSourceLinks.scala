...
import typingsJapgolly.maximMazurokGapiClientAnalytics.gapi.client.analytics.CustomDimension
...
object IgnoreCustomDataSourceLinks {
  ...
  inline def apply(accountId: String, customDimensionId: String, resource: CustomDimension, webPropertyId: String): IgnoreCustomDataSourceLinks = {
