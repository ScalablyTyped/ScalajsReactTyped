...
import typingsJapgolly.maximMazurokGapiClientAnalytics.gapi.client.analytics.Goal
...
object OauthtokenPrettyPrint {
  ...
  inline def apply(accountId: String, profileId: String, resource: Goal, webPropertyId: String): OauthtokenPrettyPrint = {
  ...
  extension [Self <: OauthtokenPrettyPrint](x: Self) {
    ...
    inline def setResource(value: Goal): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
