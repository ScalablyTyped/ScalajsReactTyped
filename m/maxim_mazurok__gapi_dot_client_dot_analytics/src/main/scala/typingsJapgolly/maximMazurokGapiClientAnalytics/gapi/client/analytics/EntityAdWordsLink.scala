...
trait EntityAdWordsLink extends StObject {
  ...
  var entity: js.UndefOr[typingsJapgolly.maximMazurokGapiClientAnalytics.anon.WebPropertyRef] = js.undefined
...
object EntityAdWordsLink {
  ...
  extension [Self <: EntityAdWordsLink](x: Self) {
    ...
    inline def setEntity(value: typingsJapgolly.maximMazurokGapiClientAnalytics.anon.WebPropertyRef): Self = StObject.set(x, "entity", value.asInstanceOf[js.Any])
