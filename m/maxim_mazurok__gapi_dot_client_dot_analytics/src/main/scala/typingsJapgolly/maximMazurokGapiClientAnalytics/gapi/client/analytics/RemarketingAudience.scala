...
import typingsJapgolly.maximMazurokGapiClientAnalytics.anon.ExcludeConditions
...
trait RemarketingAudience extends StObject {
  ...
  var audienceDefinition: js.UndefOr[typingsJapgolly.maximMazurokGapiClientAnalytics.anon.IncludeConditions] = js.undefined
...
object RemarketingAudience {
  ...
  extension [Self <: RemarketingAudience](x: Self) {
    ...
    inline def setAudienceDefinition(value: typingsJapgolly.maximMazurokGapiClientAnalytics.anon.IncludeConditions): Self = StObject.set(x, "audienceDefinition", value.asInstanceOf[js.Any])
