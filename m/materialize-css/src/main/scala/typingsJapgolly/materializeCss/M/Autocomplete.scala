...
object Autocomplete extends js.Object {
  ...
  /**
    * Init autocomplete
    */
  def init(els: typingsJapgolly.std.Element): Autocomplete = js.native
  def init(els: typingsJapgolly.std.Element, options: PartialAutocompleteOption): Autocomplete = js.native
}
