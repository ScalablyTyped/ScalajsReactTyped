...
object FormSelect extends js.Object {
  ...
  /**
    * Init FormSelect
    */
  def init(els: typingsJapgolly.std.Element): FormSelect = js.native
  def init(els: typingsJapgolly.std.Element, options: PartialFormSelectOptions): FormSelect = js.native
}
