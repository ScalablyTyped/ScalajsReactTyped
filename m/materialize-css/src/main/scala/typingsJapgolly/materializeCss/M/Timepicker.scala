...
import typingsJapgolly.materializeCss.materializeCssStrings.vibrate
...
trait Timepicker
  ...
  /**
    ...
    */
  var vibrate: typingsJapgolly.materializeCss.materializeCssStrings.vibrate | webkitVibrate | Null
}
object Timepicker {
