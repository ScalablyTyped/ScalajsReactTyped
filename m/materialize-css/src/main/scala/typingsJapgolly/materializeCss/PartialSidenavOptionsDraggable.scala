...
import typingsJapgolly.materializeCss.M.Sidenav
...
object PartialSidenavOptionsDraggable {
  ...
  def apply(
    ...
    onCloseEnd: js.ThisFunction1[/* this */ Sidenav, /* elem */ Element, Unit] = null,
    onCloseStart: js.ThisFunction1[/* this */ Sidenav, /* elem */ Element, Unit] = null,
    onOpenEnd: js.ThisFunction1[/* this */ Sidenav, /* elem */ Element, Unit] = null,
    onOpenStart: js.ThisFunction1[/* this */ Sidenav, /* elem */ Element, Unit] = null,
    outDuration: Int | Double = null
  ): PartialSidenavOptionsDraggable = {
