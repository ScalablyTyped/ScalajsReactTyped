package typingsJapgolly.markdownIt.stateInlineMod

import org.scalablytyped.runtime.NumberDictionary
import typingsJapgolly.markdownIt.AnonCanclose
import typingsJapgolly.markdownIt.libMod.Delimiter
...
trait StateInline
  ...
  /**
    ...
    */
  def push(`type`: String, tag: String, nesting: Double): typingsJapgolly.markdownIt.tokenMod.^ = js.native
  /** Flush pending text */
  def pushPending(): typingsJapgolly.markdownIt.tokenMod.^ = js.native
  /**
