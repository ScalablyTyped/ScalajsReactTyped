...
object libRendererMod {
  ...
  open class ^ ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def render(tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^], options: Options, env: Any): String = js.native
    
    /**
      * Render token attributes to string.
      */
    /* CompleteClass */
    override def renderAttrs(token: typingsJapgolly.markdownIt.libTokenMod.^): String = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def renderInline(tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^], options: Options, env: Any): String = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def renderInlineAsText(tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^], options: Options, env: Any): String = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def renderToken(tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^], idx: Double, options: Options): String = js.native
  ...
  object RenderRuleRecord {
    ...
    extension [Self <: RenderRuleRecord](x: Self) {
      ...
      inline def setCode_block(
        value: (/* tokens */ js.Array[typingsJapgolly.markdownIt.libTokenMod.^], /* idx */ Double, /* options */ Options, /* env */ Any, /* self */ Renderer) => String
  ...
  trait Renderer extends StObject {
    ...
    /**
      ...
      * @param env additional data from parsed input (references, for example)
      */
    def render(tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^], options: Options, env: Any): String
    
    /**
      * Render token attributes to string.
      */
    def renderAttrs(token: typingsJapgolly.markdownIt.libTokenMod.^): String
    ...
    /**
      ...
      * @param env additional data from parsed input (references, for example)
      */
    def renderInline(tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^], options: Options, env: Any): String
    ...
    /**
      ...
      * @param env additional data from parsed input (references, for example)
      */
    def renderInlineAsText(tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^], options: Options, env: Any): String
    ...
    /**
      ...
      * @param options params of parser instance
      */
    def renderToken(tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^], idx: Double, options: Options): String
  ...
  object Renderer {
    ...
    inline def apply(
      render: (js.Array[typingsJapgolly.markdownIt.libTokenMod.^], Options, Any) => String,
      renderAttrs: typingsJapgolly.markdownIt.libTokenMod.^ => String,
      renderInline: (js.Array[typingsJapgolly.markdownIt.libTokenMod.^], Options, Any) => String,
      renderInlineAsText: (js.Array[typingsJapgolly.markdownIt.libTokenMod.^], Options, Any) => String,
      renderToken: (js.Array[typingsJapgolly.markdownIt.libTokenMod.^], Double, Options) => String,
    ...
    extension [Self <: Renderer](x: Self) {
      ...
      inline def setRender(value: (js.Array[typingsJapgolly.markdownIt.libTokenMod.^], Options, Any) => String): Self = StObject.set(x, "render", js.Any.fromFunction3(value))
      
      inline def setRenderAttrs(value: typingsJapgolly.markdownIt.libTokenMod.^ => String): Self = StObject.set(x, "renderAttrs", js.Any.fromFunction1(value))
      
      inline def setRenderInline(value: (js.Array[typingsJapgolly.markdownIt.libTokenMod.^], Options, Any) => String): Self = StObject.set(x, "renderInline", js.Any.fromFunction3(value))
      
      inline def setRenderInlineAsText(value: (js.Array[typingsJapgolly.markdownIt.libTokenMod.^], Options, Any) => String): Self = StObject.set(x, "renderInlineAsText", js.Any.fromFunction3(value))
      
      inline def setRenderToken(value: (js.Array[typingsJapgolly.markdownIt.libTokenMod.^], Double, Options) => String): Self = StObject.set(x, "renderToken", js.Any.fromFunction3(value))
