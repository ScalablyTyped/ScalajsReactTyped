...
object libRulesBlockStateBlockMod {
  ...
  open class ^ protected ()
    extends StObject
       with StateBlock {
    def this(src: String, md: MarkdownIt, env: Any, tokens: js.Array[typingsJapgolly.markdownIt.libTokenMod.^]) = this()
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.markdownIt.markdownItStrings.blockquote
    - typingsJapgolly.markdownIt.markdownItStrings.list
    - typingsJapgolly.markdownIt.markdownItStrings.root
    - typingsJapgolly.markdownIt.markdownItStrings.paragraph
    - typingsJapgolly.markdownIt.markdownItStrings.reference
  */
  trait ParentType extends StObject
  object ParentType {
    
    inline def blockquote: typingsJapgolly.markdownIt.markdownItStrings.blockquote = "blockquote".asInstanceOf[typingsJapgolly.markdownIt.markdownItStrings.blockquote]
    
    inline def list: typingsJapgolly.markdownIt.markdownItStrings.list = "list".asInstanceOf[typingsJapgolly.markdownIt.markdownItStrings.list]
    
    inline def paragraph: typingsJapgolly.markdownIt.markdownItStrings.paragraph = "paragraph".asInstanceOf[typingsJapgolly.markdownIt.markdownItStrings.paragraph]
    
    inline def reference: typingsJapgolly.markdownIt.markdownItStrings.reference = "reference".asInstanceOf[typingsJapgolly.markdownIt.markdownItStrings.reference]
    
    inline def root: typingsJapgolly.markdownIt.markdownItStrings.root = "root".asInstanceOf[typingsJapgolly.markdownIt.markdownItStrings.root]
  }
