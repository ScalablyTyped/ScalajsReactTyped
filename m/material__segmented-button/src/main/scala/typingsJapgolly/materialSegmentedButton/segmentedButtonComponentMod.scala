...
import typingsJapgolly.materialSegmentedButton.segmentComponentMod.MDCSegmentedButtonSegment
import typingsJapgolly.materialSegmentedButton.segmentComponentMod.MDCSegmentedButtonSegmentFactory
import typingsJapgolly.materialSegmentedButton.segmentedButtonFoundationMod.MDCSegmentedButtonFoundation
import typingsJapgolly.materialSegmentedButton.typesMod.SegmentDetail
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object segmentedButtonComponentMod {
  ...
  object MDCSegmentedButton {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCSegmentedButton = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCSegmentedButton]
  }
}
