...
object libInversifyInversifyProtocolMod {
  ...
  object InversifyRegister {
    ...
    inline def apply(
      ...
      unbind: /* serviceIdentifier */ ServiceIdentifier[Any] => Callback
    ): InversifyRegister = {
      val __obj = js.Dynamic.literal(bind = js.Any.fromFunction1(bind), isBound = js.Any.fromFunction1(isBound), rebind = js.Any.fromFunction1(rebind), unbind = js.Any.fromFunction1((t0: /* serviceIdentifier */ ServiceIdentifier[Any]) => unbind(t0).runNow()))
    ...
    extension [Self <: InversifyRegister](x: Self) {
      ...
      inline def setUnbind(value: /* serviceIdentifier */ ServiceIdentifier[Any] => Callback): Self = StObject.set(x, "unbind", js.Any.fromFunction1((t0: /* serviceIdentifier */ ServiceIdentifier[Any]) => value(t0).runNow()))
    }
  }
}
