...
import typingsJapgolly.milkcocoa.anon.Id
import typingsJapgolly.milkcocoa.milkcocoa.MilkCocoa.Error.AddAccount
import typingsJapgolly.milkcocoa.milkcocoa.MilkCocoa.Error.GetCurrentUser
import typingsJapgolly.milkcocoa.milkcocoa.MilkCocoa.Error.Login
...
object milkcocoa {
  ...
  object Query {
    ...
    inline def apply(
      done: js.Function1[/* data */ Any, Unit] => Callback,
      limit: Double => Query,
      skip: Double => Query,
      sort: String => Query
    ): Query = {
      val __obj = js.Dynamic.literal(done = js.Any.fromFunction1((t0: js.Function1[/* data */ Any, Unit]) => done(t0).runNow()), limit = js.Any.fromFunction1(limit), skip = js.Any.fromFunction1(skip), sort = js.Any.fromFunction1(sort))
      __obj.asInstanceOf[Query]
    }
    
    extension [Self <: Query](x: Self) {
      
      inline def setDone(value: js.Function1[/* data */ Any, Unit] => Callback): Self = StObject.set(x, "done", js.Any.fromFunction1((t0: js.Function1[/* data */ Any, Unit]) => value(t0).runNow()))
