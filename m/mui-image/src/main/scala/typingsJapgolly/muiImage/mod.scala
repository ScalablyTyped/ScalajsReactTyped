...
object mod extends Shortcut {
  ...
  trait MuiImageProps extends StObject {
    ...
    var errorIcon: js.UndefOr[Boolean | Node] = js.undefined
    ...
    var showLoading: js.UndefOr[Boolean | Node] = js.undefined
  ...
  object MuiImageProps {
    ...
    extension [Self <: MuiImageProps](x: Self) {
      ...
      inline def setErrorIcon(value: Boolean | Node): Self = StObject.set(x, "errorIcon", value.asInstanceOf[js.Any])
      ...
      inline def setShowLoading(value: Boolean | Node): Self = StObject.set(x, "showLoading", value.asInstanceOf[js.Any])
      
      inline def setShowLoadingNull: Self = StObject.set(x, "showLoading", null)
      
      inline def setShowLoadingUndefined: Self = StObject.set(x, "showLoading", js.undefined)
      
      inline def setShowLoadingVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "showLoading", js.Array(value*))
      
      inline def setShowLoadingVdomElement(value: VdomElement): Self = StObject.set(x, "showLoading", value.rawElement.asInstanceOf[js.Any])
