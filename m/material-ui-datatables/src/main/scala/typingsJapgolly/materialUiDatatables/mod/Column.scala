...
object Column {
  ...
  def apply(
    ...
    key: String = null,
    label: String = null,
    render: (/* value */ js.Any, /* row */ js.Any) => CallbackTo[js.Any] = null,
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction2((t0: /* value */ js.Any, t1: /* row */ js.Any) => render(t0, t1).runNow()))
