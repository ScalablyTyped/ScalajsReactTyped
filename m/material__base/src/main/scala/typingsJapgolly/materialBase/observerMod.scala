...
import typingsJapgolly.materialBase.typesMod.Constructor
...
object observerMod {
  ...
  object MDCObserver_ {
    ...
    inline def apply(
      ...
      setObserversEnabled: (js.Object, Boolean) => Callback,
      unobserve: Callback
    ): MDCObserver_ = {
      val __obj = js.Dynamic.literal(observe = js.Any.fromFunction2(observe), setObserversEnabled = js.Any.fromFunction2((t0: js.Object, t1: Boolean) => (setObserversEnabled(t0, t1)).runNow()), unobserve = unobserve.toJsFn)
    ...
    extension [Self <: MDCObserver_](x: Self) {
      ...
      inline def setSetObserversEnabled(value: (js.Object, Boolean) => Callback): Self = StObject.set(x, "setObserversEnabled", js.Any.fromFunction2((t0: js.Object, t1: Boolean) => (value(t0, t1)).runNow()))
