...
import typingsJapgolly.maximMazurokGapiClientDatamigration.gapi.client.datamigration.ConnectionProfile
...
object Name {
  ...
  inline def apply(name: String, resource: ConnectionProfile): Name = {
