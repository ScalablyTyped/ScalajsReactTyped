...
trait MigrationJobId extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientDatamigration.gapi.client.datamigration.MigrationJob
...
object MigrationJobId {
  ...
  inline def apply(
    parent: String,
    resource: typingsJapgolly.maximMazurokGapiClientDatamigration.gapi.client.datamigration.MigrationJob
  ): MigrationJobId = {
  ...
  extension [Self <: MigrationJobId](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientDatamigration.gapi.client.datamigration.MigrationJob): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
