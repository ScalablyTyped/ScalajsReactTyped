...
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Alt
...
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Name
