...
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.AltCallback
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Callback
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Fields
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Filter
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Key
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.MigrationJobId
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Parent
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.PrettyPrint
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.RequestId
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Resource
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.UploadType
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientDatamigration.anon.Xgafv
...
trait MigrationJobsResource extends StObject {
  ...
  def generateSshScript(request: typingsJapgolly.maximMazurokGapiClientDatamigration.anon.MigrationJob): Request[SshScript] = js.native
