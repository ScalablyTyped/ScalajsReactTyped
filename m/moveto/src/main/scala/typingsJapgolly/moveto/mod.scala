...
object mod {
  ...
  object MoveToOptions {
    ...
    extension [Self <: MoveToOptions](x: Self) {
      ...
      inline def setCallback(value: /* target */ HTMLElement | Double => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* target */ HTMLElement | Double) => value(t0).runNow()))
