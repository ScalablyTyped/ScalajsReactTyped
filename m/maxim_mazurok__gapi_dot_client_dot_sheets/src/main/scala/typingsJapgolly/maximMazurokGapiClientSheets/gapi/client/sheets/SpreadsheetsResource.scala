...
import typingsJapgolly.maximMazurokGapiClientSheets.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientSheets.anon.AltCallback
import typingsJapgolly.maximMazurokGapiClientSheets.anon.Callback
import typingsJapgolly.maximMazurokGapiClientSheets.anon.IncludeGridData
import typingsJapgolly.maximMazurokGapiClientSheets.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientSheets.anon.Xgafv
...
trait SpreadsheetsResource extends StObject {
  ...
  def batchUpdate(request: Callback, body: BatchUpdateSpreadsheetRequest): typingsJapgolly.gapiClient.gapi.client.Request[BatchUpdateSpreadsheetResponse] = js.native
  /**
    ...
    */
  def batchUpdate(request: Uploadprotocol): typingsJapgolly.gapiClient.gapi.client.Request[BatchUpdateSpreadsheetResponse] = js.native
  
  def create(request: AccesstokenAlt, body: Spreadsheet): typingsJapgolly.gapiClient.gapi.client.Request[Spreadsheet] = js.native
  /** Creates a spreadsheet, returning the newly created spreadsheet. */
  def create(request: Xgafv): typingsJapgolly.gapiClient.gapi.client.Request[Spreadsheet] = js.native
  ...
  /**
    ...
    */
  def get(): typingsJapgolly.gapiClient.gapi.client.Request[Spreadsheet] = js.native
  def get(request: IncludeGridData): typingsJapgolly.gapiClient.gapi.client.Request[Spreadsheet] = js.native
  ...
  /**
    ...
    */
  def getByDataFilter(request: AltCallback): typingsJapgolly.gapiClient.gapi.client.Request[Spreadsheet] = js.native
  def getByDataFilter(request: Callback, body: GetSpreadsheetByDataFilterRequest): typingsJapgolly.gapiClient.gapi.client.Request[Spreadsheet] = js.native
