...
trait IncludeGridData extends StObject {
...
object IncludeGridData {
  ...
  extension [Self <: IncludeGridData](x: Self) {
    ...
    inline def setRanges(value: String | js.Array[String]): Self = StObject.set(x, "ranges", value.asInstanceOf[js.Any])
