package typingsJapgolly.materialDesignLite.MaterialDesignLite
...
trait ComponentHandler extends js.Object {
  ...
  /**
    ...
    */
  def upgradeElements(elements: js.Array[typingsJapgolly.std.HTMLElement]): Unit = js.native
  /**
    * Upgrades a specific list of elements rather than all in the DOM.
    *
  ...
  /**
    ...
    * The elements we wish to upgrade.
    */
  def upgradeElements(elements: typingsJapgolly.std.HTMLElement): Unit = js.native
  /**
    * Upgrades a specific list of elements rather than all in the DOM.
    *
