...
import typingsJapgolly.tedious.mod.ColumnMetaData
import typingsJapgolly.tedious.mod.ConnectionOptions
import typingsJapgolly.tedious.mod.DebugOptions
...
object IOptions {
  ...
  def apply(
    ...
    connectionIsolationLevel: typingsJapgolly.tedious.mod.ISOLATION_LEVEL = null,
    ...
    isolationLevel: typingsJapgolly.tedious.mod.ISOLATION_LEVEL = null,
