...
import typingsJapgolly.tedious.mod.Connection
...
object config {
  ...
  def apply(
    database: String,
    server: String,
    beforeConnect: /* conn */ Connection => Callback = null,
    ...
    if (beforeConnect != null) __obj.updateDynamic("beforeConnect")(js.Any.fromFunction1((t0: /* conn */ typingsJapgolly.tedious.mod.Connection) => beforeConnect(t0).runNow()))
