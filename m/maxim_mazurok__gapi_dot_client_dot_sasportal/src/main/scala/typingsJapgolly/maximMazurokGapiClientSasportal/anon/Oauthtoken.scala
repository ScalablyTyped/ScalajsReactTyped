...
import typingsJapgolly.maximMazurokGapiClientSasportal.gapi.client.sasportal.SasPortalDevice
...
object Oauthtoken {
  ...
  inline def apply(name: String, resource: SasPortalDevice): Oauthtoken = {
