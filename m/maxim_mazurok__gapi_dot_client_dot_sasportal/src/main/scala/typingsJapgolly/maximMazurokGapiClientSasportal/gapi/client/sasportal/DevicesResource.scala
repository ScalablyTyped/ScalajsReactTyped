...
import typingsJapgolly.maximMazurokGapiClientSasportal.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientSasportal.anon.Alt
import typingsJapgolly.maximMazurokGapiClientSasportal.anon.Callback
...
import typingsJapgolly.maximMazurokGapiClientSasportal.anon.Name
import typingsJapgolly.maximMazurokGapiClientSasportal.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientSasportal.anon.PrettyPrint
import typingsJapgolly.maximMazurokGapiClientSasportal.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientSasportal.anon.Resource
