...
import typingsJapgolly.memfs.memfsBooleans.`false`
import typingsJapgolly.memfs.memfsBooleans.`true`
import typingsJapgolly.memfs.memfsStrings.string
...
object anon {
  ...
  trait File extends StObject {
    ...
    var File: Instantiable1[/* args (repeated) */ Any, typingsJapgolly.memfs.libNodeMod.File]
    
    var Link: Instantiable1[/* args (repeated) */ Any, typingsJapgolly.memfs.libNodeMod.Link]
    
    var Node: Instantiable1[/* args (repeated) */ Any, typingsJapgolly.memfs.libNodeMod.Node]
  }
  object File {
    
    inline def apply(
      File: Instantiable1[/* args (repeated) */ Any, typingsJapgolly.memfs.libNodeMod.File],
    ...
    extension [Self <: File](x: Self) {
      ...
      inline def setFile(value: Instantiable1[/* args (repeated) */ Any, typingsJapgolly.memfs.libNodeMod.File]): Self = StObject.set(x, "File", value.asInstanceOf[js.Any])
