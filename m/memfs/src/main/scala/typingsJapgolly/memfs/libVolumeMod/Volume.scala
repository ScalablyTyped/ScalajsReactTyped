...
import typingsJapgolly.memfs.anon.Bigint
import typingsJapgolly.memfs.anon.BigintThrowIfNoEntry
import typingsJapgolly.memfs.anon.ThrowIfNoEntry
import typingsJapgolly.memfs.anon.`0`
import typingsJapgolly.memfs.anon.`1`
import typingsJapgolly.memfs.anon.`2`
import typingsJapgolly.memfs.anon.`3`
import typingsJapgolly.memfs.anon.`4`
import typingsJapgolly.memfs.libEncodingMod.TDataOut
import typingsJapgolly.memfs.libNodeMod.File
import typingsJapgolly.memfs.libNodeMod.Link
import typingsJapgolly.memfs.libNodeMod.Node
...
open class Volume () extends StObject {
  ...
  var FSWatcher: Instantiable0[typingsJapgolly.memfs.libVolumeMod.FSWatcher] = js.native
  
  var ReadStream: Instantiable1[/* args (repeated) */ Any, IReadStream] = js.native
  
  var StatWatcher: Instantiable0[typingsJapgolly.memfs.libVolumeMod.StatWatcher] = js.native
  ...
  var props: typingsJapgolly.memfs.anon.File = js.native
  ...
  def readdir(
    path: PathLike,
    callback: TCallback[js.Array[TDataOut | typingsJapgolly.memfs.libDirentMod.default]]
  ): Any = js.native
  def readdir(
    path: PathLike,
    options: String,
  ...
  def readdirSync(path: PathLike): js.Array[TDataOut | typingsJapgolly.memfs.libDirentMod.default] = js.native
  def readdirSync(path: PathLike, options: String): js.Array[TDataOut | typingsJapgolly.memfs.libDirentMod.default] = js.native
  def readdirSync(path: PathLike, options: IReaddirOptions): js.Array[TDataOut | typingsJapgolly.memfs.libDirentMod.default] = js.native
