...
import typingsJapgolly.maximMazurokGapiClientCloudshell.anon.Fields
import typingsJapgolly.maximMazurokGapiClientCloudshell.anon.Key
import typingsJapgolly.maximMazurokGapiClientCloudshell.anon.Name
import typingsJapgolly.maximMazurokGapiClientCloudshell.anon.Oauthtoken
...
trait EnvironmentsResource extends StObject {
  ...
  /**
    ...
    */
  def addPublicKey(request: typingsJapgolly.maximMazurokGapiClientCloudshell.anon.Environment): Request[Operation] = js.native
