...
import typingsJapgolly.mongoose.mod.CollationOptions
import typingsJapgolly.mongoose.mod.Document
import typingsJapgolly.mongoose.mod.DocumentQuery
import typingsJapgolly.mongoose.mod.Error
import typingsJapgolly.mongoose.mod.NativeError
import typingsJapgolly.mongoose.mod.Query
import typingsJapgolly.mongoose.mod.QueryCursor
import typingsJapgolly.mongoose.mod.QueryFindOneAndRemoveOptions
import typingsJapgolly.mongoose.mod.QueryFindOneAndUpdateOptions
import typingsJapgolly.mongoose.mod.QueryPopulateOptions
import typingsJapgolly.mongoose.mod.QueryUpdateOptions
...
@js.native
trait DocumentQueryanynullany extends js.Object {
