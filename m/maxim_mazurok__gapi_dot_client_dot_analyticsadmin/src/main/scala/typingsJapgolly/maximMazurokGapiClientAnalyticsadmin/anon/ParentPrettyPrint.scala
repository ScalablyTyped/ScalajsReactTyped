...
import typingsJapgolly.maximMazurokGapiClientAnalyticsadmin.gapi.client.analyticsadmin.GoogleAnalyticsAdminV1alphaMeasurementProtocolSecret
...
object ParentPrettyPrint {
  ...
  inline def apply(parent: String, resource: GoogleAnalyticsAdminV1alphaMeasurementProtocolSecret): ParentPrettyPrint = {
