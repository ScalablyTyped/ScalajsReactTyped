...
import typingsJapgolly.markdownToJsx.mod.MarkdownOptions
import typingsJapgolly.markdownToJsx.mod.MarkdownProps
import typingsJapgolly.markdownToJsx.mod.default
...
object MarkdownToJsx {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MarkdownProps, default, Unit, MarkdownProps] = {
  ...
  typingsJapgolly.markdownToJsx.mod.MarkdownProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.markdownToJsx.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.markdownToJsx.mod.MarkdownProps])(children: _*)
  }
