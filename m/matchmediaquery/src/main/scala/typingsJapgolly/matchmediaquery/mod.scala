package typingsJapgolly.matchmediaquery

import japgolly.scalajs.react.Callback
import typingsJapgolly.matchmediaquery.anon.PartialMediaValues
...
object mod {
  ...
  object Mql {
    ...
    inline def apply(dispose: Callback, matches: Boolean, media: String, update: Mql => Callback): Mql = {
      val __obj = js.Dynamic.literal(dispose = dispose.toJsFn, matches = matches.asInstanceOf[js.Any], media = media.asInstanceOf[js.Any], update = js.Any.fromFunction1((t0: Mql) => update(t0).runNow()))
    ...
    extension [Self <: Mql](x: Self) {
      ...
      inline def setUpdate(value: Mql => Callback): Self = StObject.set(x, "update", js.Any.fromFunction1((t0: Mql) => value(t0).runNow()))
    }
  }
}
