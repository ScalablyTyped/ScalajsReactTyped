package typingsJapgolly.micromodal.mod
...
object MicroModalConfig {
  ...
  def apply(
    ...
    onClose: /* modal */ js.UndefOr[HTMLElement] => Callback = null,
    onShow: /* modal */ js.UndefOr[HTMLElement] => Callback = null,
    ...
    if (onClose != null) __obj.updateDynamic("onClose")(js.Any.fromFunction1((t0: /* modal */ js.UndefOr[org.scalajs.dom.raw.HTMLElement]) => onClose(t0).runNow()))
    if (onShow != null) __obj.updateDynamic("onShow")(js.Any.fromFunction1((t0: /* modal */ js.UndefOr[org.scalajs.dom.raw.HTMLElement]) => onShow(t0).runNow()))
