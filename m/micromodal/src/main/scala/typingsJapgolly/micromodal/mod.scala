...
object mod {
  ...
  object MicroModalConfig {
    ...
    extension [Self <: MicroModalConfig](x: Self) {
      ...
      inline def setOnClose(value: /* modal */ js.UndefOr[HTMLElement] => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* modal */ js.UndefOr[HTMLElement]) => value(t0).runNow()))
      
      inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
      
      inline def setOnShow(value: /* modal */ js.UndefOr[HTMLElement] => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* modal */ js.UndefOr[HTMLElement]) => value(t0).runNow()))
