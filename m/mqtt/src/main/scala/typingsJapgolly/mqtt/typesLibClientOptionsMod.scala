...
import typingsJapgolly.mqtt.anon.AuthenticationData
import typingsJapgolly.mqtt.anon.CorrelationData
import typingsJapgolly.mqtt.anon.Host
import typingsJapgolly.mqtt.anon.Payload
import typingsJapgolly.mqtt.anon.SubscriptionIdentifier
...
import typingsJapgolly.mqtt.typesLibClientMod.MqttClient
...
object typesLibClientOptionsMod {
  ...
  object IClientPublishOptions {
    ...
    extension [Self <: IClientPublishOptions](x: Self) {
      ...
      inline def setCbStorePut(value: Callback): Self = StObject.set(x, "cbStorePut", value.toJsFn)
