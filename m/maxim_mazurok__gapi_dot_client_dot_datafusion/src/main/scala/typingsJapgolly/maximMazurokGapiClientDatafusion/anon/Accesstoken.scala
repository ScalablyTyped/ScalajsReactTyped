...
import typingsJapgolly.maximMazurokGapiClientDatafusion.gapi.client.datafusion.DnsPeering
...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: DnsPeering): Accesstoken = {
  ...
  extension [Self <: Accesstoken](x: Self) {
    ...
    inline def setResource(value: DnsPeering): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
