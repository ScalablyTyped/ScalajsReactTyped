...
import typingsJapgolly.mailchimpMailchimpTransactional.mailchimpMailchimpTransactionalStrings.PONGExclamationmark
import typingsJapgolly.mailchimpMailchimpTransactional.mod.^
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}


inline def apply(apiKey: String): ApiClient = ^.asInstanceOf[js.Dynamic].apply(apiKey.asInstanceOf[js.Any]).asInstanceOf[ApiClient]
...
type MessageMetadata = StringDictionary[Any]
...
type UsersPingResponse = PONGExclamationmark
