...
object ApiClient {
  ...
  inline def apply(
    ...
    rejects: RejectsApi,
    senders: SendersApi,
    setDefaultOutputFormat: OutputFormat => Callback,
    setDefaultTimeoutMs: Double => Callback,
  ...
  extension [Self <: ApiClient](x: Self) {
    ...
    inline def setSetDefaultOutputFormat(value: OutputFormat => Callback): Self = StObject.set(x, "setDefaultOutputFormat", js.Any.fromFunction1((t0: OutputFormat) => value(t0).runNow()))
    
    inline def setSetDefaultTimeoutMs(value: Double => Callback): Self = StObject.set(x, "setDefaultTimeoutMs", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
