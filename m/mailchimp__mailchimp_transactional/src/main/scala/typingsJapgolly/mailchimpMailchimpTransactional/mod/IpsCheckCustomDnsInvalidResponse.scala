...
import typingsJapgolly.mailchimpMailchimpTransactional.mailchimpMailchimpTransactionalBooleans.`false`
...
object IpsCheckCustomDnsInvalidResponse {
  ...
  extension [Self <: IpsCheckCustomDnsInvalidResponse](x: Self) {
