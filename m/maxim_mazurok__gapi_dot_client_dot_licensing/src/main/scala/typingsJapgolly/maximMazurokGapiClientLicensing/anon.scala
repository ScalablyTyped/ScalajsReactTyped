...
import typingsJapgolly.maximMazurokGapiClientLicensing.gapi.client.licensing.LicenseAssignment
import typingsJapgolly.maximMazurokGapiClientLicensing.gapi.client.licensing.LicenseAssignmentInsert
