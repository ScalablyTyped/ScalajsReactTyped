...
import typingsJapgolly.maximMazurokGapiClientLicensing.gapi.client.licensing.LicenseAssignmentsResource
import typingsJapgolly.maximMazurokGapiClientLicensing.maximMazurokGapiClientLicensingStrings.licensing
import typingsJapgolly.maximMazurokGapiClientLicensing.maximMazurokGapiClientLicensingStrings.v1
