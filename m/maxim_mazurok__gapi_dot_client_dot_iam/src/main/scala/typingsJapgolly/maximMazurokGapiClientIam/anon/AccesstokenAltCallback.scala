...
import typingsJapgolly.maximMazurokGapiClientIam.gapi.client.iam.SignJwtRequest
...
object AccesstokenAltCallback {
  ...
  inline def apply(name: String, resource: SignJwtRequest): AccesstokenAltCallback = {
