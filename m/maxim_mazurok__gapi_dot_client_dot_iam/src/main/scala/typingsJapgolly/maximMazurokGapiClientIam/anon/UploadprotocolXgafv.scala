...
import typingsJapgolly.maximMazurokGapiClientIam.gapi.client.iam.SignBlobRequest
...
object UploadprotocolXgafv {
  ...
  inline def apply(name: String, resource: SignBlobRequest): UploadprotocolXgafv = {
