...
import typingsJapgolly.maximMazurokGapiClientIam.gapi.client.iam.UndeleteServiceAccountRequest
...
object AltCallbackFields {
  ...
  inline def apply(name: String, resource: UndeleteServiceAccountRequest): AltCallbackFields = {
