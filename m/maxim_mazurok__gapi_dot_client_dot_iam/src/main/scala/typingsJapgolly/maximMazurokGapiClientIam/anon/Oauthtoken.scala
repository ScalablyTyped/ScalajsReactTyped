...
import typingsJapgolly.maximMazurokGapiClientIam.gapi.client.iam.EnableServiceAccountKeyRequest
...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: EnableServiceAccountKeyRequest
...
object Oauthtoken {
  ...
  inline def apply(name: String, resource: EnableServiceAccountKeyRequest): Oauthtoken = {
  ...
  extension [Self <: Oauthtoken](x: Self) {
    ...
    inline def setResource(value: EnableServiceAccountKeyRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
