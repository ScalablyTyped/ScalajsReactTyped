...
import typingsJapgolly.maximMazurokGapiClientIam.gapi.client.iam.CreateRoleRequest
...
trait Xgafv extends StObject {
  ...
  /** Request body */
  var resource: CreateRoleRequest
...
object Xgafv {
  ...
  inline def apply(parent: String, resource: CreateRoleRequest): Xgafv = {
  ...
  extension [Self <: Xgafv](x: Self) {
    ...
    inline def setResource(value: CreateRoleRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
