...
trait QuotaUser extends StObject {
  ...
  var range: js.UndefOr[String | js.Array[String]] = js.undefined
...
object QuotaUser {
  ...
  inline def apply(blogId: String): QuotaUser = {
  ...
  extension [Self <: QuotaUser](x: Self) {
    ...
    inline def setRange(value: String | js.Array[String]): Self = StObject.set(x, "range", value.asInstanceOf[js.Any])
