...
import typingsJapgolly.maximMazurokGapiClientBlogger.gapi.client.blogger.Post
...
object FetchImages {
  ...
  inline def apply(blogId: String, resource: Post): FetchImages = {
  ...
  extension [Self <: FetchImages](x: Self) {
