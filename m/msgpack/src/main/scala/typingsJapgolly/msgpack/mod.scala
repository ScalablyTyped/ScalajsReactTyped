...
object mod extends Shortcut {
  ...
  object MsgPackDownloadOption {
    ...
    extension [Self <: MsgPackDownloadOption](x: Self) {
      ...
      inline def setAfter(
        value: (/* xhr */ XMLHttpRequest, MsgPackDownloadOption, /* result */ MsgPackCallbackResult) => Callback
      ): Self = StObject.set(x, "after", js.Any.fromFunction3((t0: /* xhr */ XMLHttpRequest, t1: MsgPackDownloadOption, t2: /* result */ MsgPackCallbackResult) => (value(t0, t1, t2)).runNow()))
      
      inline def setAfterUndefined: Self = StObject.set(x, "after", js.undefined)
      
      inline def setBefore(value: (/* xhr */ XMLHttpRequest, MsgPackDownloadOption) => Callback): Self = StObject.set(x, "before", js.Any.fromFunction2((t0: /* xhr */ XMLHttpRequest, t1: MsgPackDownloadOption) => (value(t0, t1)).runNow()))
  ...
  object MsgPackUploadOption {
    ...
    extension [Self <: MsgPackUploadOption](x: Self) {
      ...
      inline def setAfter(
        value: (/* xhr */ XMLHttpRequest, MsgPackUploadOption, /* result */ MsgPackCallbackResult) => Callback
      ): Self = StObject.set(x, "after", js.Any.fromFunction3((t0: /* xhr */ XMLHttpRequest, t1: MsgPackUploadOption, t2: /* result */ MsgPackCallbackResult) => (value(t0, t1, t2)).runNow()))
      
      inline def setAfterUndefined: Self = StObject.set(x, "after", js.undefined)
      
      inline def setBefore(value: (/* xhr */ XMLHttpRequest, MsgPackUploadOption) => Callback): Self = StObject.set(x, "before", js.Any.fromFunction2((t0: /* xhr */ XMLHttpRequest, t1: MsgPackUploadOption) => (value(t0, t1)).runNow()))
