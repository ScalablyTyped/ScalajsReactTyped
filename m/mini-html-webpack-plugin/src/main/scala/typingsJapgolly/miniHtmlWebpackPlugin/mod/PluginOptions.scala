...
object PluginOptions {
  ...
  def apply(
    ...
    template: /* context */ PluginContext => CallbackTo[String | js.Promise[String]] = null
  ): PluginOptions = {
    ...
    if (template != null) __obj.updateDynamic("template")(js.Any.fromFunction1((t0: /* context */ typingsJapgolly.miniHtmlWebpackPlugin.mod.PluginContext) => template(t0).runNow()))
