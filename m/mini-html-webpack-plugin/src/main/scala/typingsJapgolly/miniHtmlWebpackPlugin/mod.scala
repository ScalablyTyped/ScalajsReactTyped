package typingsJapgolly.miniHtmlWebpackPlugin
...
object mod {
  ...
  object MiniHtmlWebpackPlugin {
    ...
    inline def apply(
      plugin: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify compilation.Compilation */ Any, js.Function0[Unit]) => Callback
    ): MiniHtmlWebpackPlugin = {
      val __obj = js.Dynamic.literal(plugin = js.Any.fromFunction2((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify compilation.Compilation */ Any, t1: js.Function0[Unit]) => (plugin(t0, t1)).runNow()))
    ...
    extension [Self <: MiniHtmlWebpackPlugin](x: Self) {
      ...
      inline def setPlugin(
        value: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify compilation.Compilation */ Any, js.Function0[Unit]) => Callback
      ): Self = StObject.set(x, "plugin", js.Any.fromFunction2((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify compilation.Compilation */ Any, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
    }
  }
