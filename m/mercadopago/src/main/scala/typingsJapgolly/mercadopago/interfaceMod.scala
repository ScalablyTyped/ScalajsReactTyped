...
import typingsJapgolly.mercadopago.configurationMod.ConfigOptions
import typingsJapgolly.mercadopago.configurationMod.MercadoPagoConfig
import typingsJapgolly.mercadopago.resourcesCardsMod.MercadoPagoCard
import typingsJapgolly.mercadopago.resourcesCustomersMod.MercadoPagoCustomer
import typingsJapgolly.mercadopago.resourcesMerchantOrdersMod.MercadoPagoMerchantOrder
import typingsJapgolly.mercadopago.resourcesPaymentMod.MercadoPagoPayment
import typingsJapgolly.mercadopago.resourcesPreapprovalMod.MercadoPagoPreApproval
import typingsJapgolly.mercadopago.resourcesPreferencesMod.MercadoPagoPreference
...
object interfaceMod {
  ...
  object MercadoPago {
    ...
    inline def apply(
      ...
      configure: /* options */ ConfigOptions => Callback,
      connect: Any,
    ...
    extension [Self <: MercadoPago](x: Self) {
      ...
      inline def setConfigure(value: /* options */ ConfigOptions => Callback): Self = StObject.set(x, "configure", js.Any.fromFunction1((t0: /* options */ ConfigOptions) => value(t0).runNow()))
