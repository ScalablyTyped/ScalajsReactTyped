...
import typingsJapgolly.mercadopago.anon.OmitPhoneextension
import typingsJapgolly.mercadopago.mercadopagoStrings.association
import typingsJapgolly.mercadopago.mercadopagoStrings.customer
import typingsJapgolly.mercadopago.mercadopagoStrings.guest
import typingsJapgolly.mercadopago.mercadopagoStrings.individual
import typingsJapgolly.mercadopago.mercadopagoStrings.mercadolibre
import typingsJapgolly.mercadopago.mercadopagoStrings.registered
import typingsJapgolly.mercadopago.sharedAddressMod.Address
import typingsJapgolly.mercadopago.sharedAddressMod.SimpleAddress
import typingsJapgolly.mercadopago.sharedItemMod.Item
import typingsJapgolly.mercadopago.sharedPayerIdentificationMod.Identification
import typingsJapgolly.mercadopago.sharedPhoneMod.Phone
...
object modelsPaymentCreatePayloadDotmodelMod {
  ...
  trait PaymentOrder extends StObject {
    ...
    var `type`: mercadolibre | typingsJapgolly.mercadopago.mercadopagoStrings.mercadopago
  }
  object PaymentOrder {
    
    inline def apply(id: Double, `type`: mercadolibre | typingsJapgolly.mercadopago.mercadopagoStrings.mercadopago): PaymentOrder = {
    ...
    extension [Self <: PaymentOrder](x: Self) {
      ...
      inline def setType(value: mercadolibre | typingsJapgolly.mercadopago.mercadopagoStrings.mercadopago): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
