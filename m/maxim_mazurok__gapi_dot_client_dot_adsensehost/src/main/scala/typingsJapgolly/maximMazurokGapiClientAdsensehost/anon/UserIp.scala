...
import typingsJapgolly.maximMazurokGapiClientAdsensehost.gapi.client.adsensehost.CustomChannel
...
object UserIp {
  ...
  inline def apply(adClientId: String, customChannelId: String, resource: CustomChannel): UserIp = {
  ...
  extension [Self <: UserIp](x: Self) {
    ...
    inline def setResource(value: CustomChannel): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
