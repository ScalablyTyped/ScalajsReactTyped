...
import typingsJapgolly.microsoftAjax.Sys.UI.DomElement
import typingsJapgolly.microsoftAjax.Sys.UI.MouseButton
...
object UI {
  ...
  open class Behavior ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.UI.Behavior {
  ...
  object Behavior {
    ...
    /**
      ...
      */
    /* static member */
    inline def getBehaviorByName(element: HTMLElement, name: String): typingsJapgolly.microsoftAjax.Sys.UI.Behavior = (^.asInstanceOf[js.Dynamic].applyDynamic("getBehaviorByName")(element.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.microsoftAjax.Sys.UI.Behavior]
    ...
    /**
      ...
      */
    /* static member */
    inline def getBehaviors(element: DomElement): js.Array[typingsJapgolly.microsoftAjax.Sys.UI.Behavior] = ^.asInstanceOf[js.Dynamic].applyDynamic("getBehaviors")(element.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.microsoftAjax.Sys.UI.Behavior]]
    ...
    /**
      ...
      */
    /* static member */
    inline def getBehaviorsByType(element: HTMLElement, `type`: typingsJapgolly.microsoftAjax.Sys.UI.Behavior): js.Array[typingsJapgolly.microsoftAjax.Sys.UI.Behavior] = (^.asInstanceOf[js.Dynamic].applyDynamic("getBehaviorsByType")(element.asInstanceOf[js.Any], `type`.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.microsoftAjax.Sys.UI.Behavior]]
  }
  ...
  open class Bounds ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.UI.Bounds {
  ...
  open class Control protected ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.UI.Control {
    //#region Constructors
    /**
  ...
  @js.native
  def DomElement: typingsJapgolly.microsoftAjax.Sys.UI.DomElement = js.native
  ...
  open class DomEvent protected ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.UI.DomEvent {
    //#region Constructors
    /**
  ...
  object DomEvent {
    ...
    inline def addHandler(
      element: HTMLElement,
      eventName: String,
      handler: js.Function1[/* e */ typingsJapgolly.microsoftAjax.Sys.UI.DomEvent, Unit]
    ...
    inline def addHandlers(
      element: HTMLElement,
      events: StringDictionary[js.Function1[/* e */ typingsJapgolly.microsoftAjax.Sys.UI.DomEvent, Unit]]
  ...
  object Key extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.microsoftAjax.Sys.UI.Key & Double] = js.native
    
    /* 0 */ val backspace: typingsJapgolly.microsoftAjax.Sys.UI.Key.backspace & Double = js.native
    
    /* 13 */ val del: typingsJapgolly.microsoftAjax.Sys.UI.Key.del & Double = js.native
    
    /* 12 */ val down: typingsJapgolly.microsoftAjax.Sys.UI.Key.down & Double = js.native
    
    /* 7 */ val end: typingsJapgolly.microsoftAjax.Sys.UI.Key.end & Double = js.native
    
    /* 2 */ val enter: typingsJapgolly.microsoftAjax.Sys.UI.Key.enter & Double = js.native
    
    /* 3 */ val esc: typingsJapgolly.microsoftAjax.Sys.UI.Key.esc & Double = js.native
    
    /* 8 */ val home: typingsJapgolly.microsoftAjax.Sys.UI.Key.home & Double = js.native
    
    /* 9 */ val left: typingsJapgolly.microsoftAjax.Sys.UI.Key.left & Double = js.native
    
    /* 6 */ val pageDown: typingsJapgolly.microsoftAjax.Sys.UI.Key.pageDown & Double = js.native
    
    /* 5 */ val pageUp: typingsJapgolly.microsoftAjax.Sys.UI.Key.pageUp & Double = js.native
    
    /* 11 */ val right: typingsJapgolly.microsoftAjax.Sys.UI.Key.right & Double = js.native
    
    /* 4 */ val space: typingsJapgolly.microsoftAjax.Sys.UI.Key.space & Double = js.native
    
    /* 1 */ val tab: typingsJapgolly.microsoftAjax.Sys.UI.Key.tab & Double = js.native
    
    /* 10 */ val up: typingsJapgolly.microsoftAjax.Sys.UI.Key.up & Double = js.native
  }
  ...
  object MouseButton extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.microsoftAjax.Sys.UI.MouseButton & Double] = js.native
    
    /* 0 */ val leftButton: typingsJapgolly.microsoftAjax.Sys.UI.MouseButton.leftButton & Double = js.native
    
    /* 1 */ val middleButton: typingsJapgolly.microsoftAjax.Sys.UI.MouseButton.middleButton & Double = js.native
    
    /* 2 */ val rightButton: typingsJapgolly.microsoftAjax.Sys.UI.MouseButton.rightButton & Double = js.native
  }
  ...
  open class Point protected ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.UI.Point {
    //#region Constructors
    /**
  ...
  object VisibilityMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.microsoftAjax.Sys.UI.VisibilityMode & Double] = js.native
    
    /* 1 */ val collapse: typingsJapgolly.microsoftAjax.Sys.UI.VisibilityMode.collapse & Double = js.native
    
    /* 0 */ val hide: typingsJapgolly.microsoftAjax.Sys.UI.VisibilityMode.hide & Double = js.native
  }
}
