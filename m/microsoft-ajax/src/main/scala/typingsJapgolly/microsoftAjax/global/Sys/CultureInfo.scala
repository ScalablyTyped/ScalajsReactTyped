...
open class CultureInfo protected ()
  extends StObject
     with typingsJapgolly.microsoftAjax.Sys.CultureInfo {
  //#region Constructors
  /**
...
object CultureInfo {
  ...
  @js.native
  def CurrentCulture: typingsJapgolly.microsoftAjax.Sys.CultureInfo = js.native
  inline def CurrentCulture_=(x: typingsJapgolly.microsoftAjax.Sys.CultureInfo): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CurrentCulture")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def InvariantCulture: typingsJapgolly.microsoftAjax.Sys.CultureInfo = js.native
  inline def InvariantCulture_=(x: typingsJapgolly.microsoftAjax.Sys.CultureInfo): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("InvariantCulture")(x.asInstanceOf[js.Any])
}
