...
object Services {
  ...
  open class AuthenticationService ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.Services.AuthenticationService
  ...
  open class ProfileGroup ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.Services.ProfileGroup {
    /**
  ...
  open class ProfileService ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.Services.ProfileService
  ...
  open class RoleService ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.Services.RoleService
}
