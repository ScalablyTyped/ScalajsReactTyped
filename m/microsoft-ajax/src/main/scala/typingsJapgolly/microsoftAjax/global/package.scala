...
*/
inline def create(`type`: typingsJapgolly.microsoftAjax.Type): Component = js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any]).asInstanceOf[Component]
inline def create(`type`: typingsJapgolly.microsoftAjax.Type, properties: Any): Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any])).asInstanceOf[Component]
inline def create(`type`: typingsJapgolly.microsoftAjax.Type, properties: Any, events: Any): Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[Component]
inline def create(`type`: typingsJapgolly.microsoftAjax.Type, properties: Any, events: Any, references: Any): Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any], references.asInstanceOf[js.Any])).asInstanceOf[Component]
inline def create(
  `type`: typingsJapgolly.microsoftAjax.Type,
  properties: Any,
  events: Any,
  references: Any,
  element: HTMLElement
...
inline def create(`type`: typingsJapgolly.microsoftAjax.Type, properties: Any, events: Unit, references: Any): Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any], references.asInstanceOf[js.Any])).asInstanceOf[Component]
inline def create(
  `type`: typingsJapgolly.microsoftAjax.Type,
  properties: Any,
  events: Unit,
...
inline def create(`type`: typingsJapgolly.microsoftAjax.Type, properties: Unit, events: Any): Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[Component]
inline def create(`type`: typingsJapgolly.microsoftAjax.Type, properties: Unit, events: Any, references: Any): Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any], references.asInstanceOf[js.Any])).asInstanceOf[Component]
inline def create(
  `type`: typingsJapgolly.microsoftAjax.Type,
  properties: Unit,
  events: Any,
...
inline def create(`type`: typingsJapgolly.microsoftAjax.Type, properties: Unit, events: Unit, references: Any): Component = (js.Dynamic.global.applyDynamic("$create")(`type`.asInstanceOf[js.Any], properties.asInstanceOf[js.Any], events.asInstanceOf[js.Any], references.asInstanceOf[js.Any])).asInstanceOf[Component]
inline def create(
  `type`: typingsJapgolly.microsoftAjax.Type,
  properties: Unit,
  events: Unit,
