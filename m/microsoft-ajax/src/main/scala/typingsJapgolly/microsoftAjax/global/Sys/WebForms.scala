...
object WebForms {
  ...
  open class BeginRequestEventArgs protected ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.BeginRequestEventArgs {
    //#region Constructors
    /**
  ...
  open class EndRequestEventArgs protected ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.EndRequestEventArgs {
    //#region Constructors
    /**
  ...
  open class InitializeRequestEventArgs protected ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.InitializeRequestEventArgs {
    //#region Constructors
    /**
      * Initializes a new instance of the EndRequestEventArgs class.
      * @param request
  ...
  open class PageLoadedEventArgs ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.PageLoadedEventArgs {
  ...
  open class PageLoadingEventArgs ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.PageLoadingEventArgs {
  ...
  open class PageRequestManager ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.PageRequestManager
  object PageRequestManager {
    ...
    /**
      ...
      */
    /* static member */
    inline def getInstance(): typingsJapgolly.microsoftAjax.Sys.WebForms.PageRequestManager = ^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")().asInstanceOf[typingsJapgolly.microsoftAjax.Sys.WebForms.PageRequestManager]
  }
  ...
  open class PageRequestManagerParserErrorException ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.PageRequestManagerParserErrorException
  ...
  open class PageRequestManagerServerErrorException ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.PageRequestManagerServerErrorException
  ...
  open class PageRequestManagerTimeoutException ()
    extends StObject
       with typingsJapgolly.microsoftAjax.Sys.WebForms.PageRequestManagerTimeoutException
}
