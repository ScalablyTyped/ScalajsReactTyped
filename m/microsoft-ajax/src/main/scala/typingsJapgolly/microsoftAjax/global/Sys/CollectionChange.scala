...
open class CollectionChange protected ()
  extends StObject
     with typingsJapgolly.microsoftAjax.Sys.CollectionChange {
  //#region Constructors
  /**
    ...
    */
  def this(
    action: typingsJapgolly.microsoftAjax.Sys.NotifyCollectionChangedAction,
  ...
  /**
    ...
    */
  /* CompleteClass */
  var action: typingsJapgolly.microsoftAjax.Sys.NotifyCollectionChangedAction = js.native
