...
open class ApplicationLoadEventArgs protected ()
  extends StObject
     with typingsJapgolly.microsoftAjax.Sys.ApplicationLoadEventArgs {
  //#region Constructors
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def get_components(): js.Array[typingsJapgolly.microsoftAjax.Sys.Component] = js.native
