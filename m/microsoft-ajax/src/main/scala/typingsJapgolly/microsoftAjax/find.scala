...
object find extends js.Object {
  ...
  */
  def apply(id: java.lang.String): Component = js.native
  def apply(id: java.lang.String, parent: Component): Component = js.native
  def apply(id: java.lang.String, parent: HTMLElement): Component = js.native
}
