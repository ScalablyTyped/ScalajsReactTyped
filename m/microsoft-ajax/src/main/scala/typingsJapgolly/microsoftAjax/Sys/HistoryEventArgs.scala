...
object HistoryEventArgs {
  ...
  inline def apply(Empty: EventArgs, get_State: CallbackTo[Any]): HistoryEventArgs = {
    val __obj = js.Dynamic.literal(Empty = Empty.asInstanceOf[js.Any], get_State = get_State.toJsFn)
    __obj.asInstanceOf[HistoryEventArgs]
  }
  
  extension [Self <: HistoryEventArgs](x: Self) {
    
    inline def setGet_State(value: CallbackTo[Any]): Self = StObject.set(x, "get_State", value.toJsFn)
  }
}
