...
import typingsJapgolly.materialTabs.materialTabsStrings.`mdc-tab-bar-scroller__indicator--back`
import typingsJapgolly.materialTabs.materialTabsStrings.`mdc-tab-bar-scroller__indicator--enabled`
import typingsJapgolly.materialTabs.materialTabsStrings.`mdc-tab-bar-scroller__indicator--forward`
import typingsJapgolly.materialTabs.materialTabsStrings.`mdc-tab`
