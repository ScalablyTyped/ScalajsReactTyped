package typingsJapgolly.mathExpressionEvaluator
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.FUNCTION_WITH_ONE_ARG
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.NUMBER
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_HIGH_PRECENDENCE
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.CONSTANT
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.OPENING_PARENTHESIS
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.CLOSING_PARENTHESIS
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.DECIMAL
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.POSTFIX_FUNCTION_WITH_ONE_ARG
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.FUNCTION_WITH_N_ARGS
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_LOW_PRECENDENCE
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_PERMUTATION
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.COMMA
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.EVALUATED_FUNCTION
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.EVALUATED_FUNCTION_PARAMETER
    - typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.SPACE
  */
  trait TokenName extends StObject
  object TokenName {
    
    inline def BINARY_OPERATOR_HIGH_PRECENDENCE: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_HIGH_PRECENDENCE = "BINARY_OPERATOR_HIGH_PRECENDENCE".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_HIGH_PRECENDENCE]
    
    inline def BINARY_OPERATOR_LOW_PRECENDENCE: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_LOW_PRECENDENCE = "BINARY_OPERATOR_LOW_PRECENDENCE".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_LOW_PRECENDENCE]
    
    inline def BINARY_OPERATOR_PERMUTATION: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_PERMUTATION = "BINARY_OPERATOR_PERMUTATION".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.BINARY_OPERATOR_PERMUTATION]
    
    inline def CLOSING_PARENTHESIS: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.CLOSING_PARENTHESIS = "CLOSING_PARENTHESIS".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.CLOSING_PARENTHESIS]
    
    inline def COMMA: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.COMMA = "COMMA".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.COMMA]
    
    inline def CONSTANT: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.CONSTANT = "CONSTANT".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.CONSTANT]
    
    inline def DECIMAL: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.DECIMAL = "DECIMAL".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.DECIMAL]
    
    inline def EVALUATED_FUNCTION: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.EVALUATED_FUNCTION = "EVALUATED_FUNCTION".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.EVALUATED_FUNCTION]
    
    inline def EVALUATED_FUNCTION_PARAMETER: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.EVALUATED_FUNCTION_PARAMETER = "EVALUATED_FUNCTION_PARAMETER".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.EVALUATED_FUNCTION_PARAMETER]
    
    inline def FUNCTION_WITH_N_ARGS: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.FUNCTION_WITH_N_ARGS = "FUNCTION_WITH_N_ARGS".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.FUNCTION_WITH_N_ARGS]
    
    inline def FUNCTION_WITH_ONE_ARG: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.FUNCTION_WITH_ONE_ARG = "FUNCTION_WITH_ONE_ARG".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.FUNCTION_WITH_ONE_ARG]
    
    inline def NUMBER: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.NUMBER = "NUMBER".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.NUMBER]
    
    inline def OPENING_PARENTHESIS: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.OPENING_PARENTHESIS = "OPENING_PARENTHESIS".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.OPENING_PARENTHESIS]
    
    inline def POSTFIX_FUNCTION_WITH_ONE_ARG: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.POSTFIX_FUNCTION_WITH_ONE_ARG = "POSTFIX_FUNCTION_WITH_ONE_ARG".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.POSTFIX_FUNCTION_WITH_ONE_ARG]
    
    inline def SPACE: typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.SPACE = "SPACE".asInstanceOf[typingsJapgolly.mathExpressionEvaluator.mathExpressionEvaluatorStrings.SPACE]
  }
