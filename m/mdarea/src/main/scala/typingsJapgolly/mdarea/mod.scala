...
import typingsJapgolly.mdarea.anon.Action
import typingsJapgolly.mdarea.anon.PartialKeymap
...
object mod {
  ...
  object Editor {
    ...
    inline def apply(
      ...
      onUndo: InputEvent => Callback,
      options: NormalisedOptions,
      state: EditorState
    ): Editor = {
      val __obj = js.Dynamic.literal(elem = elem.asInstanceOf[js.Any], helper = helper.asInstanceOf[js.Any], history = history.asInstanceOf[js.Any], idx = idx.asInstanceOf[js.Any], lock = lock.asInstanceOf[js.Any], onInput = js.Any.fromFunction1((t0: InputEvent) => onInput(t0).runNow()), onKeyDown = js.Any.fromFunction1((t0: KeyboardEvent) => onKeyDown(t0).runNow()), onUndo = js.Any.fromFunction1((t0: InputEvent) => onUndo(t0).runNow()), options = options.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any])
    ...
    extension [Self <: Editor](x: Self) {
      ...
      inline def setOnInput(value: InputEvent => Callback): Self = StObject.set(x, "onInput", js.Any.fromFunction1((t0: InputEvent) => value(t0).runNow()))
      ...
      inline def setOnUndo(value: InputEvent => Callback): Self = StObject.set(x, "onUndo", js.Any.fromFunction1((t0: InputEvent) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mdarea.mdareaStrings.enter
    - typingsJapgolly.mdarea.mdareaStrings.indent
    - typingsJapgolly.mdarea.mdareaStrings.outdent
    - typingsJapgolly.mdarea.mdareaStrings.`inline`
  */
  trait EditorAction extends StObject
  object EditorAction {
    
    inline def enter: typingsJapgolly.mdarea.mdareaStrings.enter = "enter".asInstanceOf[typingsJapgolly.mdarea.mdareaStrings.enter]
    
    inline def indent: typingsJapgolly.mdarea.mdareaStrings.indent = "indent".asInstanceOf[typingsJapgolly.mdarea.mdareaStrings.indent]
    
    inline def `inline`: typingsJapgolly.mdarea.mdareaStrings.`inline` = "inline".asInstanceOf[typingsJapgolly.mdarea.mdareaStrings.`inline`]
    
    inline def outdent: typingsJapgolly.mdarea.mdareaStrings.outdent = "outdent".asInstanceOf[typingsJapgolly.mdarea.mdareaStrings.outdent]
  }
  ...
  object MarkdownAreaExtension {
    ...
    extension [Self <: MarkdownAreaExtension](x: Self) {
      ...
      inline def setCleanup(value: /* editor */ MarkdownArea => Callback): Self = StObject.set(x, "cleanup", js.Any.fromFunction1((t0: /* editor */ MarkdownArea) => value(t0).runNow()))
      ...
      inline def setInit(value: /* editor */ MarkdownArea => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: /* editor */ MarkdownArea) => value(t0).runNow()))
