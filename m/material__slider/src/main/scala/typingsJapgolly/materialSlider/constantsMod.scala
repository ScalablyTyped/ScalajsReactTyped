...
object constantsMod {
  ...
  object attributes {
    ...
    @JSImport("@material/slider/constants", "attributes")
    @js.native
  ...
  object cssClasses {
    ...
    @JSImport("@material/slider/constants", "cssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/slider/constants", "cssClasses.DISABLED")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.DISCRETE")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.THUMB")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.THUMB_TOP")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.THUMB_WITH_INDICATOR")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.TICK_MARKS")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.TICK_MARKS_CONTAINER")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.TICK_MARK_ACTIVE")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.TICK_MARK_INACTIVE")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.TRACK")
    @js.native
    ...
    @JSImport("@material/slider/constants", "cssClasses.TRACK_ACTIVE")
    @js.native
  ...
  object events {
    ...
    @JSImport("@material/slider/constants", "events")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/slider/constants", "events.CHANGE")
    @js.native
    ...
    @JSImport("@material/slider/constants", "events.INPUT")
    @js.native
    def INPUT: String = js.native
    inline def INPUT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("INPUT")(x.asInstanceOf[js.Any])
  }
  ...
  object numbers {
    ...
    @JSImport("@material/slider/constants", "numbers")
    @js.native
    val ^ : js.Any = js.native
