...
import typingsJapgolly.materialSlider.foundationMod.MDCSliderFoundation
...
object componentMod {
  ...
  object MDCSlider {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCSlider = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCSlider]
    inline def attachTo(root: org.scalajs.dom.Element, options: SkipInitialUIUpdate): MDCSlider = (^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[MDCSlider]
  }
}
