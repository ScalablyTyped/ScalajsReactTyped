...
import typingsJapgolly.mustache.mustacheStrings.Ampersand
import typingsJapgolly.mustache.mustacheStrings.Equalssign
import typingsJapgolly.mustache.mustacheStrings.Exclamationmark
import typingsJapgolly.mustache.mustacheStrings.Greaterthansign
import typingsJapgolly.mustache.mustacheStrings.Numbersign
import typingsJapgolly.mustache.mustacheStrings.text
...
object mod {
  ...
  object TemplateCache_ {
    ...
    inline def apply(clear: Callback, get: String => js.UndefOr[String], set: (String, String) => Callback): TemplateCache_ = {
      val __obj = js.Dynamic.literal(clear = clear.toJsFn, get = js.Any.fromFunction1(get), set = js.Any.fromFunction2((t0: String, t1: String) => (set(t0, t1)).runNow()))
