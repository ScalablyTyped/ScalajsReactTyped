...
import typingsJapgolly.maximMazurokGapiClientDataflow.gapi.client.dataflow.CreateJobFromTemplateRequest
...
object KeyOauthtoken {
  ...
  inline def apply(projectId: String, resource: CreateJobFromTemplateRequest): KeyOauthtoken = {
