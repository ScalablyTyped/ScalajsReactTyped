...
import typingsJapgolly.maximMazurokGapiClientDataflow.gapi.client.dataflow.LaunchTemplateParameters
...
object ValidateOnly {
  ...
  inline def apply(projectId: String, resource: LaunchTemplateParameters): ValidateOnly = {
