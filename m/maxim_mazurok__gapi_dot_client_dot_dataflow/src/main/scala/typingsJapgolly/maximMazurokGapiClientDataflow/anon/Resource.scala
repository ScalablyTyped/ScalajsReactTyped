...
import typingsJapgolly.maximMazurokGapiClientDataflow.gapi.client.dataflow.SnapshotJobRequest
...
object Resource {
  ...
  inline def apply(jobId: String, projectId: String, resource: SnapshotJobRequest): Resource = {
