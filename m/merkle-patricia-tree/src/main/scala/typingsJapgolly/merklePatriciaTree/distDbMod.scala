...
import typingsJapgolly.merklePatriciaTree.merklePatriciaTreeStrings.del
import typingsJapgolly.merklePatriciaTree.merklePatriciaTreeStrings.put
...
object distDbMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.merklePatriciaTree.distDbMod.PutBatch
    - typingsJapgolly.merklePatriciaTree.distDbMod.DelBatch
  */
  trait BatchDBOp extends StObject
  object BatchDBOp {
    
    inline def DelBatch(key: Buffer): typingsJapgolly.merklePatriciaTree.distDbMod.DelBatch = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("del")
      __obj.asInstanceOf[typingsJapgolly.merklePatriciaTree.distDbMod.DelBatch]
    }
    
    inline def PutBatch(key: Buffer, value: Buffer): typingsJapgolly.merklePatriciaTree.distDbMod.PutBatch = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("put")
      __obj.asInstanceOf[typingsJapgolly.merklePatriciaTree.distDbMod.PutBatch]
    }
  }
