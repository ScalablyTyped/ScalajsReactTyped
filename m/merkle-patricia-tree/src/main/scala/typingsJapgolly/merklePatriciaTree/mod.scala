...
object mod {
  ...
  open class CheckpointTrie protected ()
    extends typingsJapgolly.merklePatriciaTree.distCheckpointTrieMod.CheckpointTrie {
  ...
  open class SecureTrie protected ()
    extends typingsJapgolly.merklePatriciaTree.distSecureMod.SecureTrie {
    def this(/* import warning: parser.TsParser#functionParam Dropping repeated marker of param args because its type any is not an array type */ args: Any) = this()
  }
  /* static members */
  object SecureTrie {
    ...
    /**
      ...
      * @param key
      */
    inline def createProof(trie: typingsJapgolly.merklePatriciaTree.distSecureMod.SecureTrie, key: Buffer): js.Promise[Proof] = (^.asInstanceOf[js.Dynamic].applyDynamic("createProof")(trie.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Proof]]
    ...
    /**
      ...
      * @param key
      */
    inline def prove(trie: typingsJapgolly.merklePatriciaTree.distSecureMod.SecureTrie, key: Buffer): js.Promise[Proof] = (^.asInstanceOf[js.Dynamic].applyDynamic("prove")(trie.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Promise[Proof]]
  ...
  /* private */ open class WalkController ()
    extends typingsJapgolly.merklePatriciaTree.distUtilWalkControllerMod.WalkController
  /* static members */
