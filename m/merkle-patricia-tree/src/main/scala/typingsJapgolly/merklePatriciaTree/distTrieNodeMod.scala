...
object distTrieNodeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.merklePatriciaTree.distTrieNodeMod.BranchNode
    - typingsJapgolly.merklePatriciaTree.distTrieNodeMod.ExtensionNode
    - typingsJapgolly.merklePatriciaTree.distTrieNodeMod.LeafNode
  */
