...
import typingsJapgolly.markdownIt.libRendererMod.RenderRule
import typingsJapgolly.markdownIt.libRendererMod.Renderer
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setRender(
        value: (/* tokens */ js.Array[typingsJapgolly.markdownIt.libTokenMod.^], /* idx */ Double, /* options */ typingsJapgolly.markdownIt.libMod.Options, /* env */ Any, /* self */ Renderer) => String
