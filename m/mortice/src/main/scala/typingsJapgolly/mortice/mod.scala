...
object mod {
  ...
  object Mortice {
    ...
    inline def apply(readLock: CallbackTo[js.Promise[Release]], writeLock: CallbackTo[js.Promise[Release]]): Mortice = {
    ...
    extension [Self <: Mortice](x: Self) {
      ...
      inline def setReadLock(value: CallbackTo[js.Promise[Release]]): Self = StObject.set(x, "readLock", value.toJsFn)
      
      inline def setWriteLock(value: CallbackTo[js.Promise[Release]]): Self = StObject.set(x, "writeLock", value.toJsFn)
    }
  }
