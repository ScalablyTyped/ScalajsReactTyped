...
object mattersMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.micromarkExtensionFrontmatter.micromarkExtensionFrontmatterStrings.yaml
    - typingsJapgolly.micromarkExtensionFrontmatter.micromarkExtensionFrontmatterStrings.toml
  */
  trait Preset extends StObject
  object Preset {
    
    inline def toml: typingsJapgolly.micromarkExtensionFrontmatter.micromarkExtensionFrontmatterStrings.toml = "toml".asInstanceOf[typingsJapgolly.micromarkExtensionFrontmatter.micromarkExtensionFrontmatterStrings.toml]
    
    inline def yaml: typingsJapgolly.micromarkExtensionFrontmatter.micromarkExtensionFrontmatterStrings.yaml = "yaml".asInstanceOf[typingsJapgolly.micromarkExtensionFrontmatter.micromarkExtensionFrontmatterStrings.yaml]
  }
}
