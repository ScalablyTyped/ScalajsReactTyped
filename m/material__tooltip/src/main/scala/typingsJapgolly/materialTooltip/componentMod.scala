...
import typingsJapgolly.materialTooltip.anon.WithCaretPos
import typingsJapgolly.materialTooltip.constantsMod.AnchorBoundaryType
import typingsJapgolly.materialTooltip.foundationMod.MDCTooltipFoundation
...
object componentMod {
  ...
  object MDCTooltip {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCTooltip = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCTooltip]
  }
}
