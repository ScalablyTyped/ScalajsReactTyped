...
import typingsJapgolly.maximMazurokGapiClientServicecontrol.gapi.client.servicecontrol.CheckRequest
import typingsJapgolly.maximMazurokGapiClientServicecontrol.gapi.client.servicecontrol.ReportRequest
