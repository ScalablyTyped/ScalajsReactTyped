...
trait V2LogEntrySourceLocation extends StObject {
...
object V2LogEntrySourceLocation {
  
  inline def apply(): V2LogEntrySourceLocation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[V2LogEntrySourceLocation]
  }
  
  extension [Self <: V2LogEntrySourceLocation](x: Self) {
