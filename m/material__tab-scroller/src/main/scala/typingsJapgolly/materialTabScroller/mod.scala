...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialTabScroller.foundationMod.default {
  ...
  open class MDCTabScroller protected ()
    extends typingsJapgolly.materialTabScroller.componentMod.MDCTabScroller {
  ...
  open class MDCTabScrollerFoundation ()
    extends typingsJapgolly.materialTabScroller.foundationMod.MDCTabScrollerFoundation {
    def this(adapter: PartialMDCTabScrollerAdap) = this()
  }
