...
import typingsJapgolly.maximMazurokGapiClientFirestore.anon.CallbackFields
...
trait OperationsResource extends StObject {
  ...
  def list(request: typingsJapgolly.maximMazurokGapiClientFirestore.anon.Filter): Request[GoogleLongrunningListOperationsResponse] = js.native
}
