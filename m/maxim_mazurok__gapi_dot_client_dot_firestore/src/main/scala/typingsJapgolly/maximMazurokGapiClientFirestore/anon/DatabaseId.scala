...
import typingsJapgolly.maximMazurokGapiClientFirestore.gapi.client.firestore.GoogleFirestoreAdminV1Database
...
trait DatabaseId extends StObject {
  ...
  /** Request body */
  var resource: GoogleFirestoreAdminV1Database
...
object DatabaseId {
  ...
  inline def apply(parent: String, resource: GoogleFirestoreAdminV1Database): DatabaseId = {
  ...
  extension [Self <: DatabaseId](x: Self) {
    ...
    inline def setResource(value: GoogleFirestoreAdminV1Database): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
