...
trait CallbackDatabaseId extends StObject {
...
object CallbackDatabaseId {
  
  inline def apply(parent: String): CallbackDatabaseId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackDatabaseId]
  }
  
  extension [Self <: CallbackDatabaseId](x: Self) {
