...
import typingsJapgolly.maximMazurokGapiClientFirestore.gapi.client.firestore.PartitionQueryRequest
...
object Xgafv {
  ...
  inline def apply(parent: String, resource: PartitionQueryRequest): Xgafv = {
