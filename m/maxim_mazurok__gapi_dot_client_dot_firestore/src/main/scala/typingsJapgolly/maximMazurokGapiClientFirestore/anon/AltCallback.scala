...
import typingsJapgolly.maximMazurokGapiClientFirestore.gapi.client.firestore.RunQueryRequest
...
object AltCallback {
  ...
  inline def apply(parent: String, resource: RunQueryRequest): AltCallback = {
