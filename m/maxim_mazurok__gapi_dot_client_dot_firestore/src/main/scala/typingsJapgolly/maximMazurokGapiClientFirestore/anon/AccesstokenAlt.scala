...
import typingsJapgolly.maximMazurokGapiClientFirestore.gapi.client.firestore.RollbackRequest
...
object AccesstokenAlt {
  ...
  inline def apply(database: String, resource: RollbackRequest): AccesstokenAlt = {
