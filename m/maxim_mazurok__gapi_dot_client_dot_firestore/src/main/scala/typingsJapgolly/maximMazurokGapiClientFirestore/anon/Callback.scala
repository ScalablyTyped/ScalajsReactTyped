...
import typingsJapgolly.maximMazurokGapiClientFirestore.gapi.client.firestore.GoogleFirestoreAdminV1Field
...
trait Callback extends StObject {
  ...
  /** Request body */
  var resource: GoogleFirestoreAdminV1Field
...
object Callback {
  ...
  inline def apply(name: String, resource: GoogleFirestoreAdminV1Field): Callback = {
  ...
  extension [Self <: Callback](x: Self) {
    ...
    inline def setResource(value: GoogleFirestoreAdminV1Field): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
