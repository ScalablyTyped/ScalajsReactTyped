...
import typingsJapgolly.maximMazurokGapiClientFirestore.gapi.client.firestore.Document
...
object CollectionId {
  ...
  inline def apply(collectionId: String, parent: String, resource: Document): CollectionId = {
