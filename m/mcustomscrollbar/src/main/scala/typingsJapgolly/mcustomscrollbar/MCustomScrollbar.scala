...
import typingsJapgolly.mcustomscrollbar.anon.AlwaysTriggerOffsets
import typingsJapgolly.mcustomscrollbar.anon.AutoExpandHorizontalScroll
import typingsJapgolly.mcustomscrollbar.anon.Axis
import typingsJapgolly.mcustomscrollbar.anon.Enable
import typingsJapgolly.mcustomscrollbar.anon.ScrollAmount
import typingsJapgolly.mcustomscrollbar.mcustomscrollbarStrings.inside
import typingsJapgolly.mcustomscrollbar.mcustomscrollbarStrings.outside
...
import typingsJapgolly.mcustomscrollbar.mcustomscrollbarStrings.yx
...
object MCustomScrollbar {
  ...
  object CustomScrollbarOptions {
    ...
    extension [Self <: CustomScrollbarOptions](x: Self) {
      ...
      inline def setAxis(value: typingsJapgolly.mcustomscrollbar.mcustomscrollbarStrings.x | y | yx): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
