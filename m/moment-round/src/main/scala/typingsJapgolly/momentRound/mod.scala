...
object mod {
  ...
  object momentAugmentingMod {
    ...
    trait Moment extends StObject {
      ...
      def ceil(precision: Double, key: String): typingsJapgolly.momentRound.mod.momentAugmentingMod.Moment = js.native
      
      def floor(precision: Double, key: String): typingsJapgolly.momentRound.mod.momentAugmentingMod.Moment = js.native
      
      def round(precision: Double, key: String): typingsJapgolly.momentRound.mod.momentAugmentingMod.Moment = js.native
      def round(
        precision: Double,
        key: String,
        direction: typingsJapgolly.momentRound.momentRoundStrings.round | ceil | floor
      ): typingsJapgolly.momentRound.mod.momentAugmentingMod.Moment = js.native
    }
  }
}
