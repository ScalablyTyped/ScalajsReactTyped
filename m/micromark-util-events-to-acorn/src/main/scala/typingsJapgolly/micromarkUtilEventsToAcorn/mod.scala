...
import typingsJapgolly.micromarkUtilEventsToAcorn.anon.Column
import typingsJapgolly.micromarkUtilEventsToAcorn.anon.Error
...
object mod {
  ...
  inline def eventsToAcorn(events: js.Array[typingsJapgolly.micromarkUtilTypes.mod.Event], options: Options): Error = (^.asInstanceOf[js.Dynamic].applyDynamic("eventsToAcorn")(events.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Error]
  
  trait Acorn extends StObject {
    
    def parse(input: String, options: typingsJapgolly.acorn.mod.Options): Node
    
    def parseExpressionAt(input: String, pos: Double, options: typingsJapgolly.acorn.mod.Options): Node
    @JSName("parseExpressionAt")
    var parseExpressionAt_Original: js.Function3[
        /* input */ String, 
        /* pos */ Double, 
        /* options */ typingsJapgolly.acorn.mod.Options, 
        Node
      ]
    
    @JSName("parse")
    var parse_Original: js.Function2[/* input */ String, /* options */ typingsJapgolly.acorn.mod.Options, Node]
  }
  object Acorn {
    
    inline def apply(
      parse: (/* input */ String, /* options */ typingsJapgolly.acorn.mod.Options) => Node,
      parseExpressionAt: (/* input */ String, /* pos */ Double, /* options */ typingsJapgolly.acorn.mod.Options) => Node
    ): Acorn = {
    ...
    extension [Self <: Acorn](x: Self) {
      ...
      inline def setParse(value: (/* input */ String, /* options */ typingsJapgolly.acorn.mod.Options) => Node): Self = StObject.set(x, "parse", js.Any.fromFunction2(value))
      
      inline def setParseExpressionAt(
        value: (/* input */ String, /* pos */ Double, /* options */ typingsJapgolly.acorn.mod.Options) => Node
      ): Self = StObject.set(x, "parseExpressionAt", js.Any.fromFunction3(value))
    }
  }
  ...
  type AcornOptions = typingsJapgolly.acorn.mod.Options
  
  type Comment = typingsJapgolly.acorn.mod.Comment
  
  type EstreeNode = typingsJapgolly.estreeUtilVisit.mod.Node
  ...
  trait Options extends StObject {
    ...
    var start: js.UndefOr[typingsJapgolly.micromarkUtilTypes.mod.Point] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setStart(value: typingsJapgolly.micromarkUtilTypes.mod.Point): Self = StObject.set(x, "start", value.asInstanceOf[js.Any])
  ...
  type Program = typingsJapgolly.estree.mod.Program
  
  type Token = typingsJapgolly.acorn.mod.Token
}
