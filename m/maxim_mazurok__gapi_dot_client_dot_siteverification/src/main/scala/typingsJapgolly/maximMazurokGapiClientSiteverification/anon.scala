...
import typingsJapgolly.maximMazurokGapiClientSiteverification.gapi.client.siteverification.SiteVerificationWebResourceGettokenRequest
import typingsJapgolly.maximMazurokGapiClientSiteverification.gapi.client.siteverification.SiteVerificationWebResourceResource
