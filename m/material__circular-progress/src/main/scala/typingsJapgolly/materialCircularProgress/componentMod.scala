...
import typingsJapgolly.materialCircularProgress.foundationMod.MDCCircularProgressFoundation
import typingsJapgolly.materialProgressIndicator.componentMod.MDCProgressIndicator
...
object componentMod {
  ...
  object MDCCircularProgress {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCCircularProgress = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCCircularProgress]
  }
}
