...
object anon {
  ...
  object PartialMDCCircularProgres {
    ...
    extension [Self <: PartialMDCCircularProgres](x: Self) {
      ...
      inline def setRemoveAttribute(value: /* attributeName */ String => Callback): Self = StObject.set(x, "removeAttribute", js.Any.fromFunction1((t0: /* attributeName */ String) => value(t0).runNow()))
      ...
      inline def setSetAttribute(value: (/* attributeName */ String, /* value */ String) => Callback): Self = StObject.set(x, "setAttribute", js.Any.fromFunction2((t0: /* attributeName */ String, t1: /* value */ String) => (value(t0, t1)).runNow()))
      
      inline def setSetAttributeUndefined: Self = StObject.set(x, "setAttribute", js.undefined)
      
      inline def setSetDeterminateCircleAttribute(value: (/* attributeName */ String, /* value */ String) => Callback): Self = StObject.set(x, "setDeterminateCircleAttribute", js.Any.fromFunction2((t0: /* attributeName */ String, t1: /* value */ String) => (value(t0, t1)).runNow()))
