...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialCircularProgress.foundationMod.default {
  ...
  open class MDCCircularProgress protected ()
    extends typingsJapgolly.materialCircularProgress.componentMod.MDCCircularProgress {
  ...
  open class MDCCircularProgressFoundation ()
    extends typingsJapgolly.materialCircularProgress.foundationMod.MDCCircularProgressFoundation {
    def this(adapter: PartialMDCCircularProgres) = this()
  }
