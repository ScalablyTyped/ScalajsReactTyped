...
object DrawCustomMode {
  ...
  inline def apply[CustomModeState, CustomModeOptions](
    toDisplayFeatures: (CustomModeState, GeoJSON, js.Function1[/* geojson */ GeoJSON, Unit]) => Callback
  ): DrawCustomMode[CustomModeState, CustomModeOptions] = {
    val __obj = js.Dynamic.literal(toDisplayFeatures = js.Any.fromFunction3((t0: CustomModeState, t1: GeoJSON, t2: js.Function1[/* geojson */ GeoJSON, Unit]) => (toDisplayFeatures(t0, t1, t2)).runNow()))
  ...
  extension [Self <: DrawCustomMode[?, ?], CustomModeState, CustomModeOptions](x: Self & (DrawCustomMode[CustomModeState, CustomModeOptions])) {
    ...
    inline def setToDisplayFeatures(value: (CustomModeState, GeoJSON, js.Function1[/* geojson */ GeoJSON, Unit]) => Callback): Self = StObject.set(x, "toDisplayFeatures", js.Any.fromFunction3((t0: CustomModeState, t1: GeoJSON, t2: js.Function1[/* geojson */ GeoJSON, Unit]) => (value(t0, t1, t2)).runNow()))
  }
}
