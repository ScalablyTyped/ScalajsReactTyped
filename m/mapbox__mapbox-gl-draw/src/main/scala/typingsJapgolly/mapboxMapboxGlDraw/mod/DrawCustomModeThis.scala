...
import typingsJapgolly.mapboxMapboxGlDraw.anon.Coordpath
import typingsJapgolly.mapboxMapboxGlDraw.mapboxMapboxGlDrawStrings.click
import typingsJapgolly.mapboxMapboxGlDraw.mapboxMapboxGlDrawStrings.tap
