...
trait GoogleCloudDatalabelingV1beta1LabelTextEntityExtractionOperationMetadata extends StObject {
...
object GoogleCloudDatalabelingV1beta1LabelTextEntityExtractionOperationMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1beta1LabelTextEntityExtractionOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1beta1LabelTextEntityExtractionOperationMetadata]
  }
  
  extension [Self <: GoogleCloudDatalabelingV1beta1LabelTextEntityExtractionOperationMetadata](x: Self) {
