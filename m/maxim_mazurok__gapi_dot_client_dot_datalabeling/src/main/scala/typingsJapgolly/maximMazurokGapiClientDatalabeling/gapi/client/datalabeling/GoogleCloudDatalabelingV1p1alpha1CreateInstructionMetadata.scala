...
object GoogleCloudDatalabelingV1p1alpha1CreateInstructionMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p1alpha1CreateInstructionMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p1alpha1CreateInstructionMetadata]
  }
  
  extension [Self <: GoogleCloudDatalabelingV1p1alpha1CreateInstructionMetadata](x: Self) {
