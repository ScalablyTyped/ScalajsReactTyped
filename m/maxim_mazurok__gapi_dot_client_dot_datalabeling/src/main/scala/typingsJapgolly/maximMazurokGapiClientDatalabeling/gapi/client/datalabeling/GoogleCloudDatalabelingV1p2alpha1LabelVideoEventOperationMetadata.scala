...
object GoogleCloudDatalabelingV1p2alpha1LabelVideoEventOperationMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p2alpha1LabelVideoEventOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1LabelVideoEventOperationMetadata]
  }
  
  extension [Self <: GoogleCloudDatalabelingV1p2alpha1LabelVideoEventOperationMetadata](x: Self) {
