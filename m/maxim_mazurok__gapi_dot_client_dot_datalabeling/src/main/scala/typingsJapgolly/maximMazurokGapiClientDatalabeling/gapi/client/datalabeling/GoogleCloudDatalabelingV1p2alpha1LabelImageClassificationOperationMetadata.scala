...
object GoogleCloudDatalabelingV1p2alpha1LabelImageClassificationOperationMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p2alpha1LabelImageClassificationOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1LabelImageClassificationOperationMetadata]
  }
  
  extension [Self <: GoogleCloudDatalabelingV1p2alpha1LabelImageClassificationOperationMetadata](x: Self) {
