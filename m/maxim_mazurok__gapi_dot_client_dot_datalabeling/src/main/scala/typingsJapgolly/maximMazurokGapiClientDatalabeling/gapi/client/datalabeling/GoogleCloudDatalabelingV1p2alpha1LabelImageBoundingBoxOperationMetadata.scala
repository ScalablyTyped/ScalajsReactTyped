...
object GoogleCloudDatalabelingV1p2alpha1LabelImageBoundingBoxOperationMetadata {
  ...
  inline def apply(): GoogleCloudDatalabelingV1p2alpha1LabelImageBoundingBoxOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDatalabelingV1p2alpha1LabelImageBoundingBoxOperationMetadata]
  }
  
  extension [Self <: GoogleCloudDatalabelingV1p2alpha1LabelImageBoundingBoxOperationMetadata](x: Self) {
