...
import typingsJapgolly.maximMazurokGapiClientDatalabeling.gapi.client.datalabeling.GoogleCloudDatalabelingV1beta1EvaluationJob
...
object UpdateMask {
  ...
  inline def apply(name: String, resource: GoogleCloudDatalabelingV1beta1EvaluationJob): UpdateMask = {
  ...
  extension [Self <: UpdateMask](x: Self) {
    ...
    inline def setResource(value: GoogleCloudDatalabelingV1beta1EvaluationJob): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
