...
import typingsJapgolly.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Policy
import typingsJapgolly.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.ValidateAttestationOccurrenceRequest
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: typingsJapgolly.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Attestor
  ...
  object Accesstoken {
    ...
    inline def apply(
      parent: String,
      resource: typingsJapgolly.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Attestor
    ): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(
        value: typingsJapgolly.maximMazurokGapiClientBinaryauthorization.gapi.client.binaryauthorization.Attestor
  ...
  trait Attestor extends StObject {
    ...
    /** Request body */
    var resource: ValidateAttestationOccurrenceRequest
  ...
  object Attestor {
    ...
    inline def apply(attestor: String, resource: ValidateAttestationOccurrenceRequest): Attestor = {
    ...
    extension [Self <: Attestor](x: Self) {
      ...
      inline def setResource(value: ValidateAttestationOccurrenceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object PrettyPrint {
    ...
    inline def apply(attestor: String): PrettyPrint = {
      val __obj = js.Dynamic.literal(attestor = attestor.asInstanceOf[js.Any])
  ...
  object QuotaUser {
    ...
    inline def apply(name: String, resource: Policy): QuotaUser = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
