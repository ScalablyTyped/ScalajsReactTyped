...
import typingsJapgolly.mirrorx.mod.NavLinkProps
...
object NavLink {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[NavLinkProps, typingsJapgolly.mirrorx.mod.NavLink, Unit, NavLinkProps] = {
  ...
  typingsJapgolly.mirrorx.mod.NavLinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.mirrorx.mod.NavLink](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.mirrorx.mod.NavLinkProps])(children: _*)
  }
