...
import typingsJapgolly.mirrorx.mod.LinkProps
...
object Link {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LinkProps, typingsJapgolly.mirrorx.mod.Link, Unit, LinkProps] = {
  ...
  typingsJapgolly.mirrorx.mod.LinkProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.mirrorx.mod.Link](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.mirrorx.mod.LinkProps])(children: _*)
  }
