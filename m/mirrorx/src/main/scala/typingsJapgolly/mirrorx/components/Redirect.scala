...
object Redirect {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[RedirectProps, typingsJapgolly.mirrorx.mod.Redirect, Unit, RedirectProps] = {
  ...
  typingsJapgolly.mirrorx.mod.RedirectProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.mirrorx.mod.Redirect](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.mirrorx.mod.RedirectProps])(children: _*)
  }
