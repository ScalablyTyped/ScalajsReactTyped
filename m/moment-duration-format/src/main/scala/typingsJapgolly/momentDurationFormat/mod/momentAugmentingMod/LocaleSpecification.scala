...
object LocaleSpecification {
  ...
  def apply(
    ...
    durationPluralKey: (/* token */ String, /* integerValue */ Double, /* decimalValue */ Double) => CallbackTo[String] = null,
    ...
    if (durationPluralKey != null) __obj.updateDynamic("durationPluralKey")(js.Any.fromFunction3((t0: /* token */ java.lang.String, t1: /* integerValue */ scala.Double, t2: /* decimalValue */ scala.Double) => durationPluralKey(t0, t1, t2).runNow()))
