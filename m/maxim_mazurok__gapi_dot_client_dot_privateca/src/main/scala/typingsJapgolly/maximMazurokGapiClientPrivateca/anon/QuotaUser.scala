...
import typingsJapgolly.maximMazurokGapiClientPrivateca.gapi.client.privateca.EnableCertificateAuthorityRequest
...
object QuotaUser {
  ...
  inline def apply(name: String, resource: EnableCertificateAuthorityRequest): QuotaUser = {
