package typingsJapgolly.maximMazurokGapiClientPrivateca.anon

import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CaPoolId extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientPrivateca.gapi.client.privateca.CaPool
...
object CaPoolId {
  ...
  inline def apply(
    parent: String,
    resource: typingsJapgolly.maximMazurokGapiClientPrivateca.gapi.client.privateca.CaPool
  ): CaPoolId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CaPoolId]
  }
  
  extension [Self <: CaPoolId](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientPrivateca.gapi.client.privateca.CaPool): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
