...
trait IgnoreActiveCertificates extends StObject {
...
object IgnoreActiveCertificates {
  
  inline def apply(name: String): IgnoreActiveCertificates = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[IgnoreActiveCertificates]
  }
  
  extension [Self <: IgnoreActiveCertificates](x: Self) {
