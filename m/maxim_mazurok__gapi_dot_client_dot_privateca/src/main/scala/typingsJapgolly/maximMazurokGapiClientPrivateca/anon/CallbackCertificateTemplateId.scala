...
trait CallbackCertificateTemplateId extends StObject {
...
object CallbackCertificateTemplateId {
  
  inline def apply(parent: String): CallbackCertificateTemplateId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackCertificateTemplateId]
  }
  
  extension [Self <: CallbackCertificateTemplateId](x: Self) {
