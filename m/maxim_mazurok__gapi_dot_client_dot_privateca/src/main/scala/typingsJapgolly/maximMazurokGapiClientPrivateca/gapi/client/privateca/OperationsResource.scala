...
import typingsJapgolly.maximMazurokGapiClientPrivateca.anon.FieldsKey
...
trait OperationsResource extends StObject {
  ...
  def cancel(request: Accesstoken, body: CancelOperationRequest): Request[js.Object] = js.native
  /**
    ...
    */
  def cancel(request: FieldsKey): Request[js.Object] = js.native
