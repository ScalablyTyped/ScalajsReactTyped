...
import typingsJapgolly.maximMazurokGapiClientPrivateca.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientPrivateca.anon.Alt
import typingsJapgolly.maximMazurokGapiClientPrivateca.anon.AltCallback
import typingsJapgolly.maximMazurokGapiClientPrivateca.anon.CaPoolId
...
import typingsJapgolly.maximMazurokGapiClientPrivateca.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientPrivateca.anon.Xgafv
...
trait CaPoolsResource extends StObject {
  ...
  def fetchCaCerts(request: typingsJapgolly.maximMazurokGapiClientPrivateca.anon.CaPool): Request[FetchCaCertsResponse] = js.native
