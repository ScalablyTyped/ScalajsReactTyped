...
import typingsJapgolly.mraid.mraidStrings.`bottom-left`
import typingsJapgolly.mraid.mraidStrings.`bottom-right`
import typingsJapgolly.mraid.mraidStrings.`top-left`
import typingsJapgolly.mraid.mraidStrings.`top-right`
