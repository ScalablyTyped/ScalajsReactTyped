package typingsJapgolly.mapObj.mod
...
object ^ extends js.Object {
  ...
  {[ K in MappedObjectKeyType ]: MappedObjectValueType}
    */ typingsJapgolly.mapObj.mapObjStrings.^  with js.Any = js.native
  ...
  ): TargetObjectType with typingsJapgolly.mapObj.mapObjStrings.^  with js.Any = js.native
}
