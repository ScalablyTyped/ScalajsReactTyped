...
import typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColondisplay_chat_event
import typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonexecute_command
import typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonplay_sound
import typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonscript_logger_config
import typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonspawn_particle_attached_entity
import typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonspawn_particle_in_world
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColondisplay_chat_event
  - typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonexecute_command
  - typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonplay_sound
  - typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonscript_logger_config
  - typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonspawn_particle_attached_entity
  - typingsJapgolly.minecraftScriptingTypesServer.minecraftScriptingTypesServerStrings.minecraftColonspawn_particle_in_world
*/
