...
package object minecraftScriptingTypesServer {
  type IArmorContainerComponent = js.Array[typingsJapgolly.minecraftScriptingTypesShared.IItemStack]
  /**
    ...
    */
  type IHandContainerComponent = js.Array[typingsJapgolly.minecraftScriptingTypesShared.IItemStack]
  /**
    ...
    */
  type IHotbarContainerComponent = js.Array[typingsJapgolly.minecraftScriptingTypesShared.IItemStack]
  /**
    ...
    */
  type IInventoryContainerComponent = js.Array[typingsJapgolly.minecraftScriptingTypesShared.IItemStack]
}
