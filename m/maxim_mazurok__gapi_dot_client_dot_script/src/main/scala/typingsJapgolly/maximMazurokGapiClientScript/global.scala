package typingsJapgolly.maximMazurokGapiClientScript

import typingsJapgolly.maximMazurokGapiClientScript.gapi.client.script.ProcessesResource
import typingsJapgolly.maximMazurokGapiClientScript.gapi.client.script.ProjectsResource
import typingsJapgolly.maximMazurokGapiClientScript.gapi.client.script.ScriptsResource
import typingsJapgolly.maximMazurokGapiClientScript.maximMazurokGapiClientScriptStrings.script
import typingsJapgolly.maximMazurokGapiClientScript.maximMazurokGapiClientScriptStrings.v1
