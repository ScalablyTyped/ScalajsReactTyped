...
import typingsJapgolly.maximMazurokGapiClientPubsub.anon.Name
...
import typingsJapgolly.maximMazurokGapiClientPubsub.anon.UploadType
...
trait SnapshotsResource extends StObject {
  ...
  def delete(request: typingsJapgolly.maximMazurokGapiClientPubsub.anon.Snapshot): Request[js.Object] = js.native
  ...
  def get(request: typingsJapgolly.maximMazurokGapiClientPubsub.anon.Snapshot): Request[Snapshot] = js.native
