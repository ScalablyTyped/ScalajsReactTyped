...
import typingsJapgolly.maximMazurokGapiClientPubsub.gapi.client.pubsub.UpdateTopicRequest
...
object NameOauthtoken {
  ...
  inline def apply(name: String, resource: UpdateTopicRequest): NameOauthtoken = {
