...
import typingsJapgolly.maximMazurokGapiClientPubsub.gapi.client.pubsub.PublishRequest
...
object OauthtokenPrettyPrint {
  ...
  inline def apply(resource: PublishRequest, topic: String): OauthtokenPrettyPrint = {
