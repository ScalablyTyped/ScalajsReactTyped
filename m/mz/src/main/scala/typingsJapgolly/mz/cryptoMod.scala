...
object cryptoMod {
  ...
  /* private */ open class Cipher ()
    extends typingsJapgolly.node.cryptoMod.Cipher
  ...
  /* private */ open class Decipher ()
    extends typingsJapgolly.node.cryptoMod.Decipher
  ...
  /* private */ open class Hash ()
    extends typingsJapgolly.node.cryptoMod.Hash
  ...
  /* private */ open class Hmac ()
    extends typingsJapgolly.node.cryptoMod.Hmac
  ...
  /* private */ open class Sign_ ()
    extends typingsJapgolly.node.cryptoMod.Sign_
  ...
  /* private */ open class Verify_ ()
    extends typingsJapgolly.node.cryptoMod.Verify_
