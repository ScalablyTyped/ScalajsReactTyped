...
import typingsJapgolly.node.childProcessMod.ExecFileOptionsWithBufferEncoding
import typingsJapgolly.node.childProcessMod.ExecFileOptionsWithOtherEncoding
...
object childProcess {
  ...
  open class ChildProcess ()
    extends typingsJapgolly.mz.childProcessMod.ChildProcess {
