...
object readline {
  ...
  open class Interface protected ()
    extends typingsJapgolly.mz.readlineMod.Interface {
    /**
  ...
  inline def createInterface(input: ReadableStream): typingsJapgolly.mz.readlineMod.Interface = ^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mz.readlineMod.Interface]
  inline def createInterface(input: ReadableStream, output: Unit, completer: Unit, terminal: Boolean): typingsJapgolly.mz.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any], terminal.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mz.readlineMod.Interface]
  inline def createInterface(input: ReadableStream, output: Unit, completer: typingsJapgolly.mz.readlineMod.Completer): typingsJapgolly.mz.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mz.readlineMod.Interface]
  inline def createInterface(
    input: ReadableStream,
    output: Unit,
    completer: typingsJapgolly.mz.readlineMod.Completer,
    terminal: Boolean
  ): typingsJapgolly.mz.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any], terminal.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mz.readlineMod.Interface]
  ...
  inline def createInterface(input: ReadableStream, output: WritableStream): typingsJapgolly.mz.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mz.readlineMod.Interface]
  inline def createInterface(input: ReadableStream, output: WritableStream, completer: Unit, terminal: Boolean): typingsJapgolly.mz.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any], terminal.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mz.readlineMod.Interface]
  inline def createInterface(input: ReadableStream, output: WritableStream, completer: typingsJapgolly.mz.readlineMod.Completer): typingsJapgolly.mz.readlineMod.Interface = (^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(input.asInstanceOf[js.Any], output.asInstanceOf[js.Any], completer.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mz.readlineMod.Interface]
  inline def createInterface(
    input: ReadableStream,
  ...
  inline def createInterface(options: ReadLineOptions): typingsJapgolly.mz.readlineMod.Interface = ^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mz.readlineMod.Interface]
  ...
  inline def createInterface_Interface(options: ReadLineOptions): typingsJapgolly.node.readlineMod.Interface = ^.asInstanceOf[js.Dynamic].applyDynamic("createInterface")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.readlineMod.Interface]
  ...
  object promises {
    ...
    @js.native
    open class Interface protected ()
      extends typingsJapgolly.mz.readlineMod.promises.Interface {
      /**
        * NOTE: According to the documentation:
        *
        * > Instances of the `readline.Interface` class are constructed using the
    ...
    open class Readline protected ()
      extends typingsJapgolly.mz.readlineMod.promises.Readline {
      /**
