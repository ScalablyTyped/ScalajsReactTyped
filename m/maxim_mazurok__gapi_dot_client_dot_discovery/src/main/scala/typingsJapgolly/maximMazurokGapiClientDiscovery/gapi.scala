...
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.Accept
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.Alt
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.Description
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.Discriminant
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.Fields
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.Oauth2
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.ParameterName
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.Required
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.X16
import typingsJapgolly.maximMazurokGapiClientDiscovery.anon.`0`
    ...
    object discovery {
      ...
      trait JsonSchema extends StObject {
        ...
        var properties: js.UndefOr[
                /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.JsonSchema} */ js.Any
              ] = js.undefined
      ...
      object JsonSchema {
        ...
        extension [Self <: JsonSchema](x: Self) {
          ...
          inline def setProperties(
            value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.JsonSchema} */ js.Any
      ...
      trait RestDescription extends StObject {
        ...
        var methods: js.UndefOr[
                /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.RestMethod} */ js.Any
              ] = js.undefined
        ...
        var resources: js.UndefOr[
                /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.RestResource} */ js.Any
              ] = js.undefined
      ...
      object RestDescription {
        ...
        extension [Self <: RestDescription](x: Self) {
          ...
          inline def setResources(
            value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.discovery.gapi.client.discovery.RestResource} */ js.Any
