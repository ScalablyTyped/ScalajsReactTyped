...
object distCoreComputedvalueMod {
  ...
  - typingsJapgolly.mobx.distCoreObservableMod.IDepTreeNode because Already inherited
  - typingsJapgolly.mobx.distCoreDerivationMod.IDerivation because var conflicts: name_, observing_. Inlined newObserving_, dependenciesState_, runId_, unboundDepsCount_, onBecomeStale_, isTracing_, requiresObservable_ */ @JSImport("mobx/dist/core/computedvalue", "ComputedValue")
  @js.native
