...
import typingsJapgolly.mobx.distInternalMod.Atom
...
import typingsJapgolly.mobx.mobxStrings.value
...
object distTypesObservablevalueMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mobx.anon.ObjectObservableKind[T]
    - typingsJapgolly.mobx.distTypesObservablevalueMod.IValueDidChange[T]
  */
  trait IBoxDidChange[T] extends StObject
  object IBoxDidChange {
    
    inline def IValueDidChange[T](debugObjectName: String, newValue: Any, `object`: IObservableValue[T], oldValue: Any): typingsJapgolly.mobx.distTypesObservablevalueMod.IValueDidChange[T] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.mobx.distTypesObservablevalueMod.IValueDidChange[T]]
    }
    
    inline def ObjectObservableKind[T](debugObjectName: String, newValue: Any, `object`: IObservableValue[T]): typingsJapgolly.mobx.anon.ObjectObservableKind[T] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.mobx.anon.ObjectObservableKind[T]]
    }
  }
