...
object distTypesObservablesetMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mobx.anon.DebugObjectNameNewValue[T]
    - typingsJapgolly.mobx.anon.DebugObjectNameObject[T]
  */
  trait ISetDidChange[T] extends StObject
  object ISetDidChange {
    
    inline def DebugObjectNameNewValue[T](debugObjectName: String, newValue: T, `object`: ObservableSet[T]): typingsJapgolly.mobx.anon.DebugObjectNameNewValue[T] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.mobx.anon.DebugObjectNameNewValue[T]]
    }
    
    inline def DebugObjectNameObject[T](debugObjectName: String, `object`: ObservableSet[T], oldValue: T): typingsJapgolly.mobx.anon.DebugObjectNameObject[T] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.mobx.anon.DebugObjectNameObject[T]]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mobx.anon.ObjectOldValue[T]
    - typingsJapgolly.mobx.anon.NewValueObject[T]
  */
  trait ISetWillChange[T] extends StObject
  object ISetWillChange {
    
    inline def NewValueObject[T](newValue: T, `object`: ObservableSet[T]): typingsJapgolly.mobx.anon.NewValueObject[T] = {
      val __obj = js.Dynamic.literal(newValue = newValue.asInstanceOf[js.Any])
      __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("add")
      __obj.asInstanceOf[typingsJapgolly.mobx.anon.NewValueObject[T]]
    }
    
    inline def ObjectOldValue[T](`object`: ObservableSet[T], oldValue: T): typingsJapgolly.mobx.anon.ObjectOldValue[T] = {
      val __obj = js.Dynamic.literal(oldValue = oldValue.asInstanceOf[js.Any])
      __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("delete")
      __obj.asInstanceOf[typingsJapgolly.mobx.anon.ObjectOldValue[T]]
    }
  }
}
