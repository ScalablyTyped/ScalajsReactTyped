...
object distCoreAtomMod {
  ...
  object IAtom {
    ...
    inline def apply(
      ...
      onBO: Callback,
      onBUO: Callback,
      reportChanged: CallbackTo[Any],
      reportObserved: CallbackTo[Boolean]
    ): IAtom = {
      val __obj = js.Dynamic.literal(diffValue_ = diffValue_.asInstanceOf[js.Any], isBeingObserved_ = isBeingObserved_.asInstanceOf[js.Any], isPendingUnobservation_ = isPendingUnobservation_.asInstanceOf[js.Any], lastAccessedBy_ = lastAccessedBy_.asInstanceOf[js.Any], lowestObserverState_ = lowestObserverState_.asInstanceOf[js.Any], name_ = name_.asInstanceOf[js.Any], observers_ = observers_.asInstanceOf[js.Any], onBO = onBO.toJsFn, onBUO = onBUO.toJsFn, reportChanged = reportChanged.toJsFn, reportObserved = reportObserved.toJsFn)
      __obj.asInstanceOf[IAtom]
    }
    
    extension [Self <: IAtom](x: Self) {
      
      inline def setReportChanged(value: CallbackTo[Any]): Self = StObject.set(x, "reportChanged", value.toJsFn)
      
      inline def setReportObserved(value: CallbackTo[Boolean]): Self = StObject.set(x, "reportObserved", value.toJsFn)
    }
  }
}
