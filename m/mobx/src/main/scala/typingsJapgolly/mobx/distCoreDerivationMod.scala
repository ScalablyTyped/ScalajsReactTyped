...
object distCoreDerivationMod {
  ...
  object IDerivation {
    ...
    extension [Self <: IDerivation](x: Self) {
      ...
      inline def setOnBecomeStale_(value: Callback): Self = StObject.set(x, "onBecomeStale_", value.toJsFn)
