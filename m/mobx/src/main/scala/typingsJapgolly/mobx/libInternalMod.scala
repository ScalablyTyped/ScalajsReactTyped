...
import typingsJapgolly.mobx.libTypesObservablemapMod.IKeyValueMap
...
import typingsJapgolly.mobx.mobxNumbers.`false`
import typingsJapgolly.mobx.mobxNumbers.`true`
import typingsJapgolly.mobx.mobxStrings.`An invariant failed, however the error is obfuscated because this is an production buildDOT`
...
object libInternalMod extends js.Object {
  ...
  /**
    ...
    */
  class Atom ()
    extends typingsJapgolly.mobx.libCoreAtomMod.Atom {
    def this(name: String) = this()
  }
  
  @js.native
  class CaughtException protected ()
    extends typingsJapgolly.mobx.libCoreDerivationMod.CaughtException {
    def this(cause: js.Any) = this()
  }
  
  @js.native
  class ComputedValue[T] protected ()
    extends typingsJapgolly.mobx.libCoreComputedvalueMod.ComputedValue[T] {
    /**
  ...
  class FlowCancellationError ()
    extends typingsJapgolly.mobx.libApiFlowMod.FlowCancellationError
  
  @js.native
  class MobXGlobals ()
    extends typingsJapgolly.mobx.libCoreGlobalstateMod.MobXGlobals
  
  @js.native
  class ObservableMap[K, V] ()
    extends typingsJapgolly.mobx.libTypesObservablemapMod.ObservableMap[K, V] {
  ...
  class ObservableObjectAdministration protected ()
    extends typingsJapgolly.mobx.libTypesObservableobjectMod.ObservableObjectAdministration {
    def this(
      target: js.Any,
  ...
  class ObservableSet[T] ()
    extends typingsJapgolly.mobx.libTypesObservablesetMod.ObservableSet[T] {
  ...
  class ObservableValue[T] protected ()
    extends typingsJapgolly.mobx.libTypesObservablevalueMod.ObservableValue[T] {
  ...
  class Reaction protected ()
    extends typingsJapgolly.mobx.libCoreReactionMod.Reaction {
  ...
  var globalState: typingsJapgolly.mobx.libCoreGlobalstateMod.MobXGlobals = js.native
  ...
  def asObservableObject(target: js.Any): typingsJapgolly.mobx.libTypesObservableobjectMod.ObservableObjectAdministration = js.native
  def asObservableObject(target: js.Any, name: PropertyKey): typingsJapgolly.mobx.libTypesObservableobjectMod.ObservableObjectAdministration = js.native
  def asObservableObject(target: js.Any, name: PropertyKey, defaultEnhancer: IEnhancer[_]): typingsJapgolly.mobx.libTypesObservableobjectMod.ObservableObjectAdministration = js.native
  ...
  object TraceMode extends js.Object {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.mobx.libCoreDerivationMod.TraceMode with Double] = js.native
  }
