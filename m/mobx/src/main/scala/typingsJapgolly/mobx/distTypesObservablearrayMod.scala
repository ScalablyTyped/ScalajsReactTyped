...
import typingsJapgolly.mobx.mobxStrings.array
import typingsJapgolly.mobx.mobxStrings.splice
...
object distTypesObservablearrayMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mobx.distTypesObservablearrayMod.IArrayUpdate[T]
    - typingsJapgolly.mobx.distTypesObservablearrayMod.IArraySplice[T]
  */
  ...
  object IArrayDidChange {
    ...
    inline def IArraySplice[T](
      ...
      __obj.asInstanceOf[typingsJapgolly.mobx.distTypesObservablearrayMod.IArraySplice[T]]
    }
    
    inline def IArrayUpdate[T](debugObjectName: String, index: Double, newValue: T, `object`: IObservableArray[T], oldValue: T): typingsJapgolly.mobx.distTypesObservablearrayMod.IArrayUpdate[T] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.mobx.distTypesObservablearrayMod.IArrayUpdate[T]]
    }
  }
