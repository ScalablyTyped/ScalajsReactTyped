package typingsJapgolly.mobx.anon

import japgolly.scalajs.react.Callback
import typingsJapgolly.mobx.mobxStrings.always
import typingsJapgolly.mobx.mobxStrings.ifavailable
...
object ComputedRequiresReaction {
  ...
  extension [Self <: ComputedRequiresReaction](x: Self) {
    ...
    inline def setReactionScheduler(value: /* f */ js.Function0[Unit] => Callback): Self = StObject.set(x, "reactionScheduler", js.Any.fromFunction1((t0: /* f */ js.Function0[Unit]) => value(t0).runNow()))
