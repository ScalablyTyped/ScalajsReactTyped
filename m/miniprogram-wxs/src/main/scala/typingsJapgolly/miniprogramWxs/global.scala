...
import typingsJapgolly.miniprogramWxs.Intl.Collator
import typingsJapgolly.miniprogramWxs.Intl.CollatorOptions
import typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat
import typingsJapgolly.miniprogramWxs.Intl.DateTimeFormatOptions
import typingsJapgolly.miniprogramWxs.Intl.NumberFormat
import typingsJapgolly.miniprogramWxs.Intl.NumberFormatOptions
import typingsJapgolly.miniprogramWxs.Intl.ResolvedCollatorOptions
import typingsJapgolly.miniprogramWxs.Intl.ResolvedNumberFormatOptions
...
object global {
  ...
  open class Error ()
    extends StObject
       with typingsJapgolly.miniprogramWxs.Error {
  ...
  object Intl {
    ...
    object Collator {
      ...
      inline def apply(): typingsJapgolly.miniprogramWxs.Intl.Collator = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.Collator]
      inline def apply(locales: java.lang.String): typingsJapgolly.miniprogramWxs.Intl.Collator = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.Collator]
      inline def apply(locales: java.lang.String, options: CollatorOptions): typingsJapgolly.miniprogramWxs.Intl.Collator = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.Collator]
      inline def apply(locales: Unit, options: CollatorOptions): typingsJapgolly.miniprogramWxs.Intl.Collator = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.Collator]
      inline def apply(locales: Array[java.lang.String]): typingsJapgolly.miniprogramWxs.Intl.Collator = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.Collator]
      inline def apply(locales: Array[java.lang.String], options: CollatorOptions): typingsJapgolly.miniprogramWxs.Intl.Collator = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.Collator]
    ...
    object DateTimeFormat {
      ...
      inline def apply(): typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat]
      inline def apply(locales: java.lang.String): typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat]
      inline def apply(locales: java.lang.String, options: DateTimeFormatOptions): typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat]
      inline def apply(locales: Unit, options: DateTimeFormatOptions): typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat]
      inline def apply(locales: Array[java.lang.String]): typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat]
      inline def apply(locales: Array[java.lang.String], options: DateTimeFormatOptions): typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.DateTimeFormat]
    ...
    object NumberFormat {
      ...
      inline def apply(): typingsJapgolly.miniprogramWxs.Intl.NumberFormat = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.NumberFormat]
      inline def apply(locales: java.lang.String): typingsJapgolly.miniprogramWxs.Intl.NumberFormat = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.NumberFormat]
      inline def apply(locales: java.lang.String, options: NumberFormatOptions): typingsJapgolly.miniprogramWxs.Intl.NumberFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.NumberFormat]
      inline def apply(locales: Unit, options: NumberFormatOptions): typingsJapgolly.miniprogramWxs.Intl.NumberFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.NumberFormat]
      inline def apply(locales: Array[java.lang.String]): typingsJapgolly.miniprogramWxs.Intl.NumberFormat = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.NumberFormat]
      inline def apply(locales: Array[java.lang.String], options: NumberFormatOptions): typingsJapgolly.miniprogramWxs.Intl.NumberFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.miniprogramWxs.Intl.NumberFormat]
  ...
  @JSGlobal("JSON")
  @js.native
  def JSON: typingsJapgolly.miniprogramWxs.JSON = js.native
  inline def JSON_=(x: JSON): Unit = js.Dynamic.global.updateDynamic("JSON")(x.asInstanceOf[js.Any])
  
  /** An intrinsic object that provides basic mathematics functionality and constants. */
  @JSGlobal("Math")
  @js.native
  def Math: typingsJapgolly.miniprogramWxs.Math = js.native
