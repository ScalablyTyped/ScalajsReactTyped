...
trait Array[T]
  ...
  /**
    ...
    */
  def every(callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ Array[T], Any]): scala.Boolean = js.native
  def every(
  ...
  /**
    ...
    * @param thisArg An object to which the this keyword can refer in the callbackfn function. If thisArg is omitted, undefined is used as the this value.
    */
  def some(callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ Array[T], Any]): scala.Boolean = js.native
  def some(
    callbackfn: js.Function3[/* value */ T, /* index */ Double, /* array */ Array[T], Any],
    thisArg: Any
  ): scala.Boolean = js.native
