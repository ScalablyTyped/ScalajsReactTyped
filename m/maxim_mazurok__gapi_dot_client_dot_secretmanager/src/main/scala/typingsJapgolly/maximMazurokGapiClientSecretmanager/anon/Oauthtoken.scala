package typingsJapgolly.maximMazurokGapiClientSecretmanager.anon

import typingsJapgolly.maximMazurokGapiClientSecretmanager.gapi.client.secretmanager.AddSecretVersionRequest
...
object Oauthtoken {
  ...
  inline def apply(parent: String, resource: AddSecretVersionRequest): Oauthtoken = {
