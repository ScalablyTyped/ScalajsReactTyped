...
object announceMod {
  ...
  object AnnouncerPriority extends StObject {
    ...
    /* "assertive" */ val ASSERTIVE: typingsJapgolly.materialDom.announceMod.AnnouncerPriority.ASSERTIVE & String = js.native
    
    @js.native
    sealed trait POLITE
      extends StObject
         with AnnouncerPriority
    /* "polite" */ val POLITE: typingsJapgolly.materialDom.announceMod.AnnouncerPriority.POLITE & String = js.native
  }
