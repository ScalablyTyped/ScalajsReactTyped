...
import typingsJapgolly.maximMazurokGapiClientBigtableadmin.gapi.client.bigtableadmin.Instance
...
object OauthtokenPrettyPrint {
  ...
  inline def apply(name: String, resource: Instance): OauthtokenPrettyPrint = {
