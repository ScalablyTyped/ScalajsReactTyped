...
import typingsJapgolly.materialBanner.materialBannerInts.`0`
import typingsJapgolly.materialBanner.materialBannerInts.`1`
import typingsJapgolly.materialBanner.materialBannerInts.`2`
...
object constantsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.materialBanner.materialBannerInts.`0`
    - typingsJapgolly.materialBanner.materialBannerInts.`1`
    - typingsJapgolly.materialBanner.materialBannerInts.`2`
  */
