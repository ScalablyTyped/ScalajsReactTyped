...
import typingsJapgolly.materialBanner.constantsMod.MDCBannerFocusTrapFactory
import typingsJapgolly.materialBanner.foundationMod.MDCBannerFoundation
...
object componentMod {
  ...
  object MDCBanner {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCBanner = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCBanner]
  }
}
