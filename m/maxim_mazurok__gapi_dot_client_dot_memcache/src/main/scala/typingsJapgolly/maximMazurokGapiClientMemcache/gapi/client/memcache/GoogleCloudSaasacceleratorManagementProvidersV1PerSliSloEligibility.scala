...
trait GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility extends StObject {
  ...
  var eligibilities: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.memcache.gapi.client.memcache.GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility} */ js.Any
  ] = js.undefined
}
object GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility {
  ...
  extension [Self <: GoogleCloudSaasacceleratorManagementProvidersV1PerSliSloEligibility](x: Self) {
    ...
    inline def setEligibilities(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.memcache.gapi.client.memcache.GoogleCloudSaasacceleratorManagementProvidersV1SloEligibility} */ js.Any
