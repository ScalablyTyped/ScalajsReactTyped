package typingsJapgolly.maximMazurokGapiClientMemcache

import typingsJapgolly.maximMazurokGapiClientMemcache.gapi.client.memcache.ApplyParametersRequest
import typingsJapgolly.maximMazurokGapiClientMemcache.gapi.client.memcache.CancelOperationRequest
import typingsJapgolly.maximMazurokGapiClientMemcache.gapi.client.memcache.RescheduleMaintenanceRequest
import typingsJapgolly.maximMazurokGapiClientMemcache.gapi.client.memcache.UpdateParametersRequest
...
object anon {
  ...
  trait Callback extends StObject {
    ...
    /** Request body */
    var resource: typingsJapgolly.maximMazurokGapiClientMemcache.gapi.client.memcache.Instance
  ...
  object Callback {
    ...
    inline def apply(
      parent: String,
      resource: typingsJapgolly.maximMazurokGapiClientMemcache.gapi.client.memcache.Instance
    ): Callback = {
    ...
    extension [Self <: Callback](x: Self) {
      ...
      inline def setResource(value: typingsJapgolly.maximMazurokGapiClientMemcache.gapi.client.memcache.Instance): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
