...
import typingsJapgolly.maximMazurokGapiClientMemcache.gapi.client.memcache.ProjectsResource
import typingsJapgolly.maximMazurokGapiClientMemcache.maximMazurokGapiClientMemcacheStrings.memcache
import typingsJapgolly.maximMazurokGapiClientMemcache.maximMazurokGapiClientMemcacheStrings.v1
