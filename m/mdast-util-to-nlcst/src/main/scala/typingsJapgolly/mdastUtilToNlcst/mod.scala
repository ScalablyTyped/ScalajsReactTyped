...
import typingsJapgolly.mdastUtilToNlcst.anon.FnCall
import typingsJapgolly.mdastUtilToNlcst.mdastUtilToNlcstStrings.children
...
object mod {
  ...
  type MdastRoot = typingsJapgolly.mdast.mod.Root
