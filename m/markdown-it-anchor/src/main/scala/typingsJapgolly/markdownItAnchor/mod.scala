...
import typingsJapgolly.markdownIt.libTokenMod.^
import typingsJapgolly.markdownItAnchor.markdownItAnchorBooleans.`false`
import typingsJapgolly.markdownItAnchor.markdownItAnchorStrings.`aria-describedby`
import typingsJapgolly.markdownItAnchor.markdownItAnchorStrings.`aria-label`
import typingsJapgolly.markdownItAnchor.markdownItAnchorStrings.`aria-labelledby`
import typingsJapgolly.markdownItAnchor.markdownItAnchorStrings.`visually-hidden`
import typingsJapgolly.markdownItAnchor.markdownItAnchorStrings.after
import typingsJapgolly.markdownItAnchor.markdownItAnchorStrings.before
import typingsJapgolly.markdownItAnchor.mod.anchor.AnchorOptions
import typingsJapgolly.markdownItAnchor.mod.anchor.AriaHiddenPermalinkOptions
import typingsJapgolly.markdownItAnchor.mod.anchor.HeaderLinkPermalinkOptions
import typingsJapgolly.markdownItAnchor.mod.anchor.LinkAfterHeaderPermalinkOptions
import typingsJapgolly.markdownItAnchor.mod.anchor.LinkInsideHeaderPermalinkOptions
import typingsJapgolly.markdownItAnchor.mod.anchor.PermalinkGenerator
  ...
  object anchor {
    ...
    object AnchorOptions {
      ...
      extension [Self <: AnchorOptions](x: Self) {
        ...
        inline def setCallback(value: (/* token */ ^, /* anchor_info */ AnchorInfo) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* token */ ^, t1: /* anchor_info */ AnchorInfo) => (value(t0, t1)).runNow()))
        ...
        inline def setPermalink(
          value: (/* slug */ String, /* opts */ PermalinkOptions, /* state */ typingsJapgolly.markdownIt.libRulesCoreStateCoreMod.^, /* index */ Double) => Callback
        ): Self = StObject.set(x, "permalink", js.Any.fromFunction4((t0: /* slug */ String, t1: /* opts */ PermalinkOptions, t2: /* state */ typingsJapgolly.markdownIt.libRulesCoreStateCoreMod.^, t3: /* index */ Double) => (value(t0, t1, t2, t3)).runNow()))
    ...
    type PermalinkGenerator = js.Function4[
        ...
        /* state */ typingsJapgolly.markdownIt.libRulesCoreStateCoreMod.^, 
        /* index */ Double, 
        Unit
      ]
    ...
    object PermalinkOptions {
      ...
      extension [Self <: PermalinkOptions](x: Self) {
        ...
        inline def setRenderAttrs(
          value: (/* slug */ String, /* state */ typingsJapgolly.markdownIt.libRulesCoreStateCoreMod.^) => Record[String, String | Double]
        ...
        inline def setRenderHref(
          value: (/* slug */ String, /* state */ typingsJapgolly.markdownIt.libRulesCoreStateCoreMod.^) => String
        ): Self = StObject.set(x, "renderHref", js.Any.fromFunction2(value))
