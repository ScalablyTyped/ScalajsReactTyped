...
import typingsJapgolly.maximMazurokGapiClientLogging.anon.BucketId
...
import typingsJapgolly.maximMazurokGapiClientLogging.anon.Resource
import typingsJapgolly.maximMazurokGapiClientLogging.anon.UploadType
import typingsJapgolly.maximMazurokGapiClientLogging.anon.Uploadprotocol
