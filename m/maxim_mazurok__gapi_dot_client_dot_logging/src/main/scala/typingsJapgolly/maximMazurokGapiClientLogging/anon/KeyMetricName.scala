...
import typingsJapgolly.maximMazurokGapiClientLogging.gapi.client.logging.LogMetric
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait KeyMetricName extends StObject {
...
object KeyMetricName {
  
  inline def apply(metricName: String, resource: LogMetric): KeyMetricName = {
    val __obj = js.Dynamic.literal(metricName = metricName.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[KeyMetricName]
  }
  
  extension [Self <: KeyMetricName](x: Self) {
