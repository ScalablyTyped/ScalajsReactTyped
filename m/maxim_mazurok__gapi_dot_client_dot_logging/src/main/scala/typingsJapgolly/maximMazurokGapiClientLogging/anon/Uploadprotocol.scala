...
import typingsJapgolly.maximMazurokGapiClientLogging.gapi.client.logging.UndeleteBucketRequest
...
object Uploadprotocol {
  ...
  inline def apply(name: String, resource: UndeleteBucketRequest): Uploadprotocol = {
