...
object bluetoothDisabledSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BluetoothDisabledSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `bluetoothDisabledSharpMod.foo` */
