...
object keyboardArrowRightTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/KeyboardArrowRightTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `keyboardArrowRightTwoToneMod.foo` */
