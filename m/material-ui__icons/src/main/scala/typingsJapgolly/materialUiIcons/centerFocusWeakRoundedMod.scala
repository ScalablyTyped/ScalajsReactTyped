...
object centerFocusWeakRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CenterFocusWeakRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `centerFocusWeakRoundedMod.foo` */
