...
object markunreadMailboxSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/MarkunreadMailboxSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `markunreadMailboxSharpMod.foo` */
