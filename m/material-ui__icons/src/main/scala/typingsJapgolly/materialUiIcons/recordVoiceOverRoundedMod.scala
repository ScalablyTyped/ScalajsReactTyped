...
object recordVoiceOverRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/RecordVoiceOverRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `recordVoiceOverRoundedMod.foo` */
