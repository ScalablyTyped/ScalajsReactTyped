...
object addPhotoAlternateSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AddPhotoAlternateSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `addPhotoAlternateSharpMod.foo` */
