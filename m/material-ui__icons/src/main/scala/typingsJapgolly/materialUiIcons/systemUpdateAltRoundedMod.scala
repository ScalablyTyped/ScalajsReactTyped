...
object systemUpdateAltRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SystemUpdateAltRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `systemUpdateAltRoundedMod.foo` */
