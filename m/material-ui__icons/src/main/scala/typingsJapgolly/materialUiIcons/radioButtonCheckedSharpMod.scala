...
object radioButtonCheckedSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/RadioButtonCheckedSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `radioButtonCheckedSharpMod.foo` */
