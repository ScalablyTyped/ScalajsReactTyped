...
object swapHorizontalCircleOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SwapHorizontalCircleOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `swapHorizontalCircleOutlinedMod.foo` */
