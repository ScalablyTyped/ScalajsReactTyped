...
object formatIndentDecreaseRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FormatIndentDecreaseRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `formatIndentDecreaseRoundedMod.foo` */
