...
object stayPrimaryLandscapeTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/StayPrimaryLandscapeTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `stayPrimaryLandscapeTwoToneMod.foo` */
