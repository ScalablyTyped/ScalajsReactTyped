...
object powerSettingsNewRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PowerSettingsNewRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `powerSettingsNewRoundedMod.foo` */
