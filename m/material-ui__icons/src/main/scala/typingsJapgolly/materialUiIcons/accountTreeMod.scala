...
object accountTreeMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AccountTree", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `accountTreeMod.foo` */
