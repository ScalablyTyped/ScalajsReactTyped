...
object looks3SharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Looks3Sharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `looks3SharpMod.foo` */
