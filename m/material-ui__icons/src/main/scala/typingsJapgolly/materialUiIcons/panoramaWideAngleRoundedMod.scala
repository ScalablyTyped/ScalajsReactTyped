...
object panoramaWideAngleRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PanoramaWideAngleRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `panoramaWideAngleRoundedMod.foo` */
