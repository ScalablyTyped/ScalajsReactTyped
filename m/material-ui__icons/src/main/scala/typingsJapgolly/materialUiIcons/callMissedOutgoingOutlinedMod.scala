...
object callMissedOutgoingOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CallMissedOutgoingOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `callMissedOutgoingOutlinedMod.foo` */
