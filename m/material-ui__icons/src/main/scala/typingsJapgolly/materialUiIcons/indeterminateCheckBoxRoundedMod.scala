...
object indeterminateCheckBoxRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/IndeterminateCheckBoxRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `indeterminateCheckBoxRoundedMod.foo` */
