...
object signalCellularConnectedNoInternet1BarMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `signalCellularConnectedNoInternet1BarMod.foo` */
