...
object noMeetingRoomSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/NoMeetingRoomSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `noMeetingRoomSharpMod.foo` */
