...
object directionsRailwayOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/DirectionsRailwayOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `directionsRailwayOutlinedMod.foo` */
