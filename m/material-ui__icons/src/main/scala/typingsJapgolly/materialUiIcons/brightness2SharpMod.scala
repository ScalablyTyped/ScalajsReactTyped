...
object brightness2SharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Brightness2Sharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `brightness2SharpMod.foo` */
