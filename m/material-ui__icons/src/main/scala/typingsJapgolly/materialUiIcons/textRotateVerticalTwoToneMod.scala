...
object textRotateVerticalTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/TextRotateVerticalTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `textRotateVerticalTwoToneMod.foo` */
