...
object flipCameraIosMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FlipCameraIos", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `flipCameraIosMod.foo` */
