...
object filterCenterFocusTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FilterCenterFocusTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `filterCenterFocusTwoToneMod.foo` */
