...
object stayCurrentPortraitRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/StayCurrentPortraitRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `stayCurrentPortraitRoundedMod.foo` */
