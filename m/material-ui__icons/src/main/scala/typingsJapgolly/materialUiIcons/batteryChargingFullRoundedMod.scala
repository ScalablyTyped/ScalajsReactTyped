...
object batteryChargingFullRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BatteryChargingFullRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `batteryChargingFullRoundedMod.foo` */
