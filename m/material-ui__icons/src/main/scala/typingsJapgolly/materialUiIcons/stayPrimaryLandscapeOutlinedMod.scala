...
object stayPrimaryLandscapeOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/StayPrimaryLandscapeOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `stayPrimaryLandscapeOutlinedMod.foo` */
