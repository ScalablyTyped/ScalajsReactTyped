...
object keyboardArrowLeftRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/KeyboardArrowLeftRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `keyboardArrowLeftRoundedMod.foo` */
