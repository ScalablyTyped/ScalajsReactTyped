...
object houseMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/House", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `houseMod.foo` */
