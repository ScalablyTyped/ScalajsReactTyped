...
object subdirectoryArrowRightOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SubdirectoryArrowRightOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `subdirectoryArrowRightOutlinedMod.foo` */
