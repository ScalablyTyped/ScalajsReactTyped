...
object stayCurrentPortraitOutlinedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/StayCurrentPortraitOutlined", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `stayCurrentPortraitOutlinedMod.foo` */
