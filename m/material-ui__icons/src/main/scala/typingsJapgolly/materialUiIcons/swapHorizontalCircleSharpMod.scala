...
object swapHorizontalCircleSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SwapHorizontalCircleSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `swapHorizontalCircleSharpMod.foo` */
