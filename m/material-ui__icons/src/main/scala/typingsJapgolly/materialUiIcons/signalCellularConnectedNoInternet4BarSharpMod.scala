...
object signalCellularConnectedNoInternet4BarSharpMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `signalCellularConnectedNoInternet4BarSharpMod.foo` */
