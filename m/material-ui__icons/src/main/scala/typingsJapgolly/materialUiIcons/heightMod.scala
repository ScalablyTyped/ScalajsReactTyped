...
object heightMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/Height", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `heightMod.foo` */
