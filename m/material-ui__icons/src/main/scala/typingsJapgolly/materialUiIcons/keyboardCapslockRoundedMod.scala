...
object keyboardCapslockRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/KeyboardCapslockRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `keyboardCapslockRoundedMod.foo` */
