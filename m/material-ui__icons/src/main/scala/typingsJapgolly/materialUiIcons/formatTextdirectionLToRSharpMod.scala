...
object formatTextdirectionLToRSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FormatTextdirectionLToRSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `formatTextdirectionLToRSharpMod.foo` */
