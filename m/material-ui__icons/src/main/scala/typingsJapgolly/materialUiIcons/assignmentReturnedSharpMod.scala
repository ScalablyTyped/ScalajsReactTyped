...
object assignmentReturnedSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AssignmentReturnedSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `assignmentReturnedSharpMod.foo` */
