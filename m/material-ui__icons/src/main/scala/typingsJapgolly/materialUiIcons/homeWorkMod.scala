...
object homeWorkMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/HomeWork", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `homeWorkMod.foo` */
