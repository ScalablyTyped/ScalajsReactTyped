...
object settingsInputSvideoTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SettingsInputSvideoTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `settingsInputSvideoTwoToneMod.foo` */
