...
object assignmentReturnedRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/AssignmentReturnedRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `assignmentReturnedRoundedMod.foo` */
