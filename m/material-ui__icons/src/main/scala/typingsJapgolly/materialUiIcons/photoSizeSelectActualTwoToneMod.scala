...
object photoSizeSelectActualTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PhotoSizeSelectActualTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `photoSizeSelectActualTwoToneMod.foo` */
