...
object callMissedOutgoingRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CallMissedOutgoingRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `callMissedOutgoingRoundedMod.foo` */
