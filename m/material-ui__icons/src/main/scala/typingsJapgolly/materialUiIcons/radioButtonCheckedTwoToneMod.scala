...
object radioButtonCheckedTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/RadioButtonCheckedTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `radioButtonCheckedTwoToneMod.foo` */
