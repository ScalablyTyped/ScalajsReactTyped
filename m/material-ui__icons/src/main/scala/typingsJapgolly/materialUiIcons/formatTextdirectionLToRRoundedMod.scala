...
object formatTextdirectionLToRRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FormatTextdirectionLToRRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `formatTextdirectionLToRRoundedMod.foo` */
