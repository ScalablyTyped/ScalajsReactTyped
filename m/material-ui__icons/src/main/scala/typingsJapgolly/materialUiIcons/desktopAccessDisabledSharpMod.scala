...
object desktopAccessDisabledSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/DesktopAccessDisabledSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `desktopAccessDisabledSharpMod.foo` */
