...
object singleBedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SingleBed", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `singleBedMod.foo` */
