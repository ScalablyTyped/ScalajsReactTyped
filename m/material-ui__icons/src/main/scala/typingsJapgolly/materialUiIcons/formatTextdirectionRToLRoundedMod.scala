...
object formatTextdirectionRToLRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/FormatTextdirectionRToLRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `formatTextdirectionRToLRoundedMod.foo` */
