...
object recordVoiceOverSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/RecordVoiceOverSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `recordVoiceOverSharpMod.foo` */
