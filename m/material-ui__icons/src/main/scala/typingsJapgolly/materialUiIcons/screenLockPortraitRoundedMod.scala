...
object screenLockPortraitRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/ScreenLockPortraitRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `screenLockPortraitRoundedMod.foo` */
