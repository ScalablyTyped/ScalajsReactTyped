...
object signalWifi3BarLockTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SignalWifi3BarLockTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `signalWifi3BarLockTwoToneMod.foo` */
