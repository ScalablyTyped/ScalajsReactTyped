...
object cancelScheduleSendSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CancelScheduleSendSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `cancelScheduleSendSharpMod.foo` */
