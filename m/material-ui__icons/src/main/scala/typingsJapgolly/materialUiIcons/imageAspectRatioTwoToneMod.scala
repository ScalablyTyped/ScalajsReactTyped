...
object imageAspectRatioTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/ImageAspectRatioTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `imageAspectRatioTwoToneMod.foo` */
