...
object collectionsBookmarkSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/CollectionsBookmarkSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `collectionsBookmarkSharpMod.foo` */
