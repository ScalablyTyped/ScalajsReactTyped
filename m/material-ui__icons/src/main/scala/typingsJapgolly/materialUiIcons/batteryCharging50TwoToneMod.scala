...
object batteryCharging50TwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/BatteryCharging50TwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `batteryCharging50TwoToneMod.foo` */
