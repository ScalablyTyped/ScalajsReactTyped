...
object playlistAddCheckTwoToneMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PlaylistAddCheckTwoTone", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `playlistAddCheckTwoToneMod.foo` */
