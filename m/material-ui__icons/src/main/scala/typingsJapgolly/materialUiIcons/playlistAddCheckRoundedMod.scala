...
object playlistAddCheckRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/PlaylistAddCheckRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `playlistAddCheckRoundedMod.foo` */
