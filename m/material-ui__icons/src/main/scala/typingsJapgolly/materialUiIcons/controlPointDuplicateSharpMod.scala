...
object controlPointDuplicateSharpMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/ControlPointDuplicateSharp", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `controlPointDuplicateSharpMod.foo` */
