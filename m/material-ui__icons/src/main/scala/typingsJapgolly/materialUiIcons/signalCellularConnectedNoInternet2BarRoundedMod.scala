...
object signalCellularConnectedNoInternet2BarRoundedMod extends Shortcut {
  ...
  /**
    ...
    */
  @JSImport("@material-ui/icons/SignalCellularConnectedNoInternet2BarRounded", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `signalCellularConnectedNoInternet2BarRoundedMod.foo` */
