package typingsJapgolly.atMaterialDashUiIcons.atMaterialDashUiIconsMod
...
@js.native
class SentimentVeryDissatisfiedTwoTone protected ()
...
@JSImport("@material-ui/icons", "SentimentVeryDissatisfiedTwoTone")
@js.native
object SentimentVeryDissatisfiedTwoTone extends TopLevel[SvgIconComponent]
