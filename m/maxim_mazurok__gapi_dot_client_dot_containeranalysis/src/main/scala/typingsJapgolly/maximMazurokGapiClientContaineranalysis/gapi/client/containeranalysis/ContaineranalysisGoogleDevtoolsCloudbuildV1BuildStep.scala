...
trait ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep extends StObject {
  ...
  var pullTiming: js.UndefOr[ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan] = js.undefined
  ...
  /**
    ...
    */
  var volumes: js.UndefOr[js.Array[ContaineranalysisGoogleDevtoolsCloudbuildV1Volume]] = js.undefined
...
object ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep {
  ...
  inline def apply(): ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep = {
  ...
  extension [Self <: ContaineranalysisGoogleDevtoolsCloudbuildV1BuildStep](x: Self) {
    ...
    inline def setPullTiming(value: ContaineranalysisGoogleDevtoolsCloudbuildV1TimeSpan): Self = StObject.set(x, "pullTiming", value.asInstanceOf[js.Any])
    ...
    inline def setVolumes(value: js.Array[ContaineranalysisGoogleDevtoolsCloudbuildV1Volume]): Self = StObject.set(x, "volumes", value.asInstanceOf[js.Any])
    
    inline def setVolumesUndefined: Self = StObject.set(x, "volumes", js.undefined)
    
    inline def setVolumesVarargs(value: ContaineranalysisGoogleDevtoolsCloudbuildV1Volume*): Self = StObject.set(x, "volumes", js.Array(value*))
