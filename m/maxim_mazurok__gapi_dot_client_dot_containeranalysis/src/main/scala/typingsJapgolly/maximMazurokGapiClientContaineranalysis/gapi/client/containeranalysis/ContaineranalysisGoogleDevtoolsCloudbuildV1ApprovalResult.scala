...
trait ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult extends StObject {
...
object ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult {
  ...
  inline def apply(): ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult]
  }
  
  extension [Self <: ContaineranalysisGoogleDevtoolsCloudbuildV1ApprovalResult](x: Self) {
