...
trait SlsaMetadata extends StObject {
  ...
  var completeness: js.UndefOr[SlsaCompleteness] = js.undefined
...
object SlsaMetadata {
  ...
  extension [Self <: SlsaMetadata](x: Self) {
    ...
    inline def setCompleteness(value: SlsaCompleteness): Self = StObject.set(x, "completeness", value.asInstanceOf[js.Any])
