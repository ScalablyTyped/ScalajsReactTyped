...
import typingsJapgolly.maximMazurokGapiClientTranscoder.gapi.client.transcoder.Job
import typingsJapgolly.maximMazurokGapiClientTranscoder.gapi.client.transcoder.JobTemplate
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(parent: String, resource: Job): Accesstoken = {
  ...
  trait AllowMissing extends StObject {
  ...
  object AllowMissing {
    ...
    inline def apply(name: String): AllowMissing = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[AllowMissing]
    }
    
    extension [Self <: AllowMissing](x: Self) {
  ...
  object JobTemplateId {
    ...
    inline def apply(parent: String, resource: JobTemplate): JobTemplateId = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
      __obj.asInstanceOf[JobTemplateId]
    }
    
    extension [Self <: JobTemplateId](x: Self) {
      ...
      inline def setResource(value: JobTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
