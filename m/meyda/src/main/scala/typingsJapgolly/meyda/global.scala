...
import typingsJapgolly.meyda.mod.MeydaAnalyzerOptions
import typingsJapgolly.meyda.mod.MeydaAudioFeature
import typingsJapgolly.meyda.mod.MeydaSignal
...
object global {
  ...
  object Meyda {
    ...
    open class MeydaAnalyzer ()
      extends typingsJapgolly.meyda.mod.MeydaAnalyzer
    ...
    inline def createMeydaAnalyzer(options: MeydaAnalyzerOptions): typingsJapgolly.meyda.mod.MeydaAnalyzer = ^.asInstanceOf[js.Dynamic].applyDynamic("createMeydaAnalyzer")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.meyda.mod.MeydaAnalyzer]
