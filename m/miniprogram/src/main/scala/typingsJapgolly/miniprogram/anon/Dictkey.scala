...
import typingsJapgolly.miniprogram.LaunchQuery
...
object Dictkey {
  ...
  extension [Self <: Dictkey](x: Self) {
    ...
    inline def setOnLaunch(value: /* options */ js.UndefOr[LaunchQuery] => Callback): Self = StObject.set(x, "onLaunch", js.Any.fromFunction1((t0: /* options */ js.UndefOr[LaunchQuery]) => value(t0).runNow()))
    
    inline def setOnLaunchUndefined: Self = StObject.set(x, "onLaunch", js.undefined)
    
    inline def setOnShow(value: /* options */ js.UndefOr[LaunchQuery] => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* options */ js.UndefOr[LaunchQuery]) => value(t0).runNow()))
