package typingsJapgolly.mojangNet

import typingsJapgolly.mojangMinecraftServerAdmin.mod.SecretString
...
object mod {
  ...
  object HttpRequestMethod extends StObject {
    ...
    /* 3 */ val DELETE: typingsJapgolly.mojangNet.mod.HttpRequestMethod.DELETE & Double = js.native
    ...
    sealed trait GET
      extends StObject
         with HttpRequestMethod
    /* 2 */ val GET: typingsJapgolly.mojangNet.mod.HttpRequestMethod.GET & Double = js.native
    ...
    sealed trait HEAD
      extends StObject
         with HttpRequestMethod
    /* 4 */ val HEAD: typingsJapgolly.mojangNet.mod.HttpRequestMethod.HEAD & Double = js.native
    ...
    sealed trait POST
      extends StObject
         with HttpRequestMethod
    /* 0 */ val POST: typingsJapgolly.mojangNet.mod.HttpRequestMethod.POST & Double = js.native
    ...
    sealed trait PUT
      extends StObject
         with HttpRequestMethod
    /* 1 */ val PUT: typingsJapgolly.mojangNet.mod.HttpRequestMethod.PUT & Double = js.native
  }
