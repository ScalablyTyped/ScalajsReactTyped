...
import typingsJapgolly.maximMazurokGapiClientDisplayvideo.anon.ResourceName
import typingsJapgolly.maximMazurokGapiClientDisplayvideo.anon.ResourceResourceName
