...
trait OrderByPageSize extends StObject {
...
object OrderByPageSize {
  
  inline def apply(advertiserId: String, lineItemId: String): OrderByPageSize = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], lineItemId = lineItemId.asInstanceOf[js.Any])
    __obj.asInstanceOf[OrderByPageSize]
  }
  
  extension [Self <: OrderByPageSize](x: Self) {
