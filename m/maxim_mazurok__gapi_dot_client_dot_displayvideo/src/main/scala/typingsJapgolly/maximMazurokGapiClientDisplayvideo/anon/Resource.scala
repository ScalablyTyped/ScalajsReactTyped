...
import typingsJapgolly.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.Campaign
...
object Resource {
  ...
  inline def apply(advertiserId: String, resource: Campaign): Resource = {
