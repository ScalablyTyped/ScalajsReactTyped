...
trait InventorySourceIdKey extends StObject {
...
object InventorySourceIdKey {
  
  inline def apply(inventorySourceId: String): InventorySourceIdKey = {
    val __obj = js.Dynamic.literal(inventorySourceId = inventorySourceId.asInstanceOf[js.Any])
    __obj.asInstanceOf[InventorySourceIdKey]
  }
  
  extension [Self <: InventorySourceIdKey](x: Self) {
