...
import typingsJapgolly.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.LocationList
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait FieldsKeyLocationListId extends StObject {
...
object FieldsKeyLocationListId {
  
  inline def apply(advertiserId: String, locationListId: String, resource: LocationList): FieldsKeyLocationListId = {
    ...
    __obj.asInstanceOf[FieldsKeyLocationListId]
  }
  
  extension [Self <: FieldsKeyLocationListId](x: Self) {
