...
trait CustomBiddingScriptId extends StObject {
  ...
  var customBiddingScriptId: String
...
object CustomBiddingScriptId {
  
  inline def apply(customBiddingAlgorithmId: String, customBiddingScriptId: String): CustomBiddingScriptId = {
    val __obj = js.Dynamic.literal(customBiddingAlgorithmId = customBiddingAlgorithmId.asInstanceOf[js.Any], customBiddingScriptId = customBiddingScriptId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CustomBiddingScriptId]
  }
  
  extension [Self <: CustomBiddingScriptId](x: Self) {
