...
trait InventorySourceGroupIdKeyOauthtoken extends StObject {
...
object InventorySourceGroupIdKeyOauthtoken {
  
  inline def apply(inventorySourceGroupId: String): InventorySourceGroupIdKeyOauthtoken = {
    val __obj = js.Dynamic.literal(inventorySourceGroupId = inventorySourceGroupId.asInstanceOf[js.Any])
    __obj.asInstanceOf[InventorySourceGroupIdKeyOauthtoken]
  }
  
  extension [Self <: InventorySourceGroupIdKeyOauthtoken](x: Self) {
