...
import typingsJapgolly.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.BulkEditSitesRequest
...
object ChannelId {
  ...
  inline def apply(advertiserId: String, channelId: String, resource: BulkEditSitesRequest): ChannelId = {
