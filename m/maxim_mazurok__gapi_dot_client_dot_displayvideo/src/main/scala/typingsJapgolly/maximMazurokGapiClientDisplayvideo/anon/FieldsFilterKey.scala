...
trait FieldsFilterKey extends StObject {
...
object FieldsFilterKey {
  
  inline def apply(): FieldsFilterKey = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[FieldsFilterKey]
  }
  
  extension [Self <: FieldsFilterKey](x: Self) {
