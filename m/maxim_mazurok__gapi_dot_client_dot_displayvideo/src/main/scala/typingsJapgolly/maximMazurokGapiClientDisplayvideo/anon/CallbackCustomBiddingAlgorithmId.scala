...
trait CallbackCustomBiddingAlgorithmId extends StObject {
...
object CallbackCustomBiddingAlgorithmId {
  
  inline def apply(customBiddingAlgorithmId: String): CallbackCustomBiddingAlgorithmId = {
