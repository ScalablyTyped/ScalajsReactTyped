...
import typingsJapgolly.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.ReplaceSitesRequest
...
object FieldsKey {
  ...
  inline def apply(advertiserId: String, channelId: String, resource: ReplaceSitesRequest): FieldsKey = {
