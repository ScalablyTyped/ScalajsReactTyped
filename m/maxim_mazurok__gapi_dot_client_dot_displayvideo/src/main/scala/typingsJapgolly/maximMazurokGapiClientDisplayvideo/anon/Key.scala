...
import typingsJapgolly.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.AssignedTargetingOption
...
object Key {
  ...
  inline def apply(advertiserId: String, lineItemId: String, resource: AssignedTargetingOption, targetingType: String): Key = {
