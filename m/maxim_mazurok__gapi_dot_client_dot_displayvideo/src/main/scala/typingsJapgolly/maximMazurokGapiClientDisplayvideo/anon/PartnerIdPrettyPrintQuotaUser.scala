...
import typingsJapgolly.maximMazurokGapiClientDisplayvideo.gapi.client.displayvideo.InventorySourceGroup
...
object PartnerIdPrettyPrintQuotaUser {
  ...
  extension [Self <: PartnerIdPrettyPrintQuotaUser](x: Self) {
