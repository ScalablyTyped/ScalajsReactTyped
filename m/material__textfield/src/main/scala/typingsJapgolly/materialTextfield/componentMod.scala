...
import typingsJapgolly.materialFloatingLabel.componentMod.MDCFloatingLabelFactory
import typingsJapgolly.materialLineRipple.componentMod.MDCLineRippleFactory
import typingsJapgolly.materialNotchedOutline.componentMod.MDCNotchedOutlineFactory
...
import typingsJapgolly.materialTextfield.characterCounterComponentMod.MDCTextFieldCharacterCounterFactory
import typingsJapgolly.materialTextfield.foundationMod.MDCTextFieldFoundation
import typingsJapgolly.materialTextfield.helperTextComponentMod.MDCTextFieldHelperTextFactory
import typingsJapgolly.materialTextfield.iconComponentMod.MDCTextFieldIconFactory
...
object componentMod {
  ...
  - typingsJapgolly.materialRipple.typesMod.MDCRippleCapableSurface because var conflicts: root. Inlined disabled, unbounded */ @JSImport("@material/textfield/component", "MDCTextField")
  @js.native
  ...
  object MDCTextField {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCTextField = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCTextField]
  }
}
