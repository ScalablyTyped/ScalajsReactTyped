...
object helperTextMod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialTextfield.helperTextFoundationMod.default {
  ...
  open class MDCTextFieldHelperText protected ()
    extends typingsJapgolly.materialTextfield.helperTextComponentMod.MDCTextFieldHelperText {
  ...
  open class MDCTextFieldHelperTextFoundation ()
    extends typingsJapgolly.materialTextfield.helperTextFoundationMod.MDCTextFieldHelperTextFoundation {
    def this(adapter: PartialMDCTextFieldHelper) = this()
  }
