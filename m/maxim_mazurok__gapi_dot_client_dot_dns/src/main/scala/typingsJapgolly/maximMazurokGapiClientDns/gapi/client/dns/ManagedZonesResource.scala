...
import typingsJapgolly.maximMazurokGapiClientDns.anon.DnsName
import typingsJapgolly.maximMazurokGapiClientDns.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientDns.anon.PrettyPrint
import typingsJapgolly.maximMazurokGapiClientDns.anon.QuotaUser
...
trait ManagedZonesResource extends StObject {
  ...
  def patch(request: typingsJapgolly.maximMazurokGapiClientDns.anon.Project): Request[Operation] = js.native
  ...
  def update(request: typingsJapgolly.maximMazurokGapiClientDns.anon.Project): Request[Operation] = js.native
}
