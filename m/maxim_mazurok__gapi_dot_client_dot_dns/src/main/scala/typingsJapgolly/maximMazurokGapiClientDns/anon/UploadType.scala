...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientDns.gapi.client.dns.Policy
...
object UploadType {
  ...
  inline def apply(
    policy: String,
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientDns.gapi.client.dns.Policy
  ): UploadType = {
  ...
  extension [Self <: UploadType](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientDns.gapi.client.dns.Policy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
