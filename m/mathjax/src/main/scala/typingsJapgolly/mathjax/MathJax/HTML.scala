...
object HTML {
  ...
  inline def apply(
    ...
    setScript: (String, String) => japgolly.scalajs.react.Callback
  ): HTML = {
    val __obj = js.Dynamic.literal(Element = js.Any.fromFunction3(Element), TextNode = js.Any.fromFunction1(TextNode), addElement = js.Any.fromFunction4(addElement), addText = js.Any.fromFunction2(addText), getScript = js.Any.fromFunction1(getScript), setScript = js.Any.fromFunction2((t0: String, t1: String) => (setScript(t0, t1)).runNow()))
  ...
  extension [Self <: HTML](x: Self) {
    ...
    inline def setSetScript(value: (String, String) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "setScript", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
