...
object Hub {
  ...
  inline def apply(
    Config: Config => japgolly.scalajs.react.Callback,
    Configured: japgolly.scalajs.react.Callback,
    Insert: (Any, Any) => Any,
    ...
    Typeset: (Any, Any) => Any,
    Update: (Any, Any) => Any,
    formatError: (Any, Any) => japgolly.scalajs.react.Callback,
    getAllJax: Any => js.Array[Any],
    getJaxByInputType: (String, Any) => japgolly.scalajs.react.Callback,
    getJaxByType: (String, Any) => japgolly.scalajs.react.Callback,
    getJaxFor: Any => Any,
    isJax: Any => Double,
    setRenderer: (String, String) => japgolly.scalajs.react.Callback
  ): Hub = {
    val __obj = js.Dynamic.literal(Config = js.Any.fromFunction1((t0: Config) => Config(t0).runNow()), Configured = Configured.toJsFn, Insert = js.Any.fromFunction2(Insert), PreProcess = js.Any.fromFunction2(PreProcess), Process = js.Any.fromFunction2(Process), Queue = js.Any.fromFunction1(Queue), Reprocess = js.Any.fromFunction2(Reprocess), Rerender = js.Any.fromFunction2(Rerender), Typeset = js.Any.fromFunction2(Typeset), Update = js.Any.fromFunction2(Update), formatError = js.Any.fromFunction2((t0: Any, t1: Any) => (formatError(t0, t1)).runNow()), getAllJax = js.Any.fromFunction1(getAllJax), getJaxByInputType = js.Any.fromFunction2((t0: String, t1: Any) => (getJaxByInputType(t0, t1)).runNow()), getJaxByType = js.Any.fromFunction2((t0: String, t1: Any) => (getJaxByType(t0, t1)).runNow()), getJaxFor = js.Any.fromFunction1(getJaxFor), isJax = js.Any.fromFunction1(isJax), setRenderer = js.Any.fromFunction2((t0: String, t1: String) => (setRenderer(t0, t1)).runNow()))
  ...
  extension [Self <: Hub](x: Self) {
    ...
    inline def setConfig(value: Config => japgolly.scalajs.react.Callback): Self = StObject.set(x, "Config", js.Any.fromFunction1((t0: Config) => value(t0).runNow()))
    
    inline def setConfigUndefined: Self = StObject.set(x, "config", js.undefined)
    
    inline def setConfigured(value: japgolly.scalajs.react.Callback): Self = StObject.set(x, "Configured", value.toJsFn)
    
    inline def setFormatError(value: (Any, Any) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "formatError", js.Any.fromFunction2((t0: Any, t1: Any) => (value(t0, t1)).runNow()))
    
    inline def setGetAllJax(value: Any => js.Array[Any]): Self = StObject.set(x, "getAllJax", js.Any.fromFunction1(value))
    
    inline def setGetJaxByInputType(value: (String, Any) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "getJaxByInputType", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
    
    inline def setGetJaxByType(value: (String, Any) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "getJaxByType", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
    ...
    inline def setSetRenderer(value: (String, String) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "setRenderer", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
