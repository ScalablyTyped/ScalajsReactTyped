...
object BrowserInfo {
  ...
  inline def apply(
    Select: Any => japgolly.scalajs.react.Callback,
    version: String,
    versionAtLeast: String => japgolly.scalajs.react.Callback
  ): BrowserInfo = {
    val __obj = js.Dynamic.literal(Select = js.Any.fromFunction1((t0: Any) => Select(t0).runNow()), version = version.asInstanceOf[js.Any], versionAtLeast = js.Any.fromFunction1((t0: String) => versionAtLeast(t0).runNow()))
  ...
  extension [Self <: BrowserInfo](x: Self) {
    ...
    inline def setSelect(value: Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "Select", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    
    inline def setVersion(value: String): Self = StObject.set(x, "version", value.asInstanceOf[js.Any])
    
    inline def setVersionAtLeast(value: String => japgolly.scalajs.react.Callback): Self = StObject.set(x, "versionAtLeast", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  }
}
