...
object MathMenu {
  ...
  def apply(
    ...
    showFontMenu: js.UndefOr[Boolean] = js.undefined,
    showLocale: js.UndefOr[Boolean] = js.undefined,
    showMathPlayer: js.UndefOr[Boolean] = js.undefined,
    showRenderer: js.UndefOr[Boolean] = js.undefined,
    styles: js.Any = null,
