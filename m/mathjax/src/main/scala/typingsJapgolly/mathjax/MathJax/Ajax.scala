...
object Ajax {
  ...
  inline def apply(
    ...
    Preloading: /* repeated */ Any => japgolly.scalajs.react.Callback,
    Require: (String, Any) => Any,
    STATUS: STATUS,
    Styles: (Any, Any) => Any,
    fileURL: String => String,
    loadComplete: String => japgolly.scalajs.react.Callback,
    loadError: String => japgolly.scalajs.react.Callback,
    loadHooks: Any,
    loadTimeout: String => japgolly.scalajs.react.Callback,
    loaded: Any,
    loading: Boolean
  ): Ajax = {
    val __obj = js.Dynamic.literal(Load = js.Any.fromFunction2(Load), LoadHook = js.Any.fromFunction2(LoadHook), Preloading = js.Any.fromFunction1((t0: /* repeated */ Any) => Preloading(t0).runNow()), Require = js.Any.fromFunction2(Require), STATUS = STATUS.asInstanceOf[js.Any], Styles = js.Any.fromFunction2(Styles), fileURL = js.Any.fromFunction1(fileURL), loadComplete = js.Any.fromFunction1((t0: String) => loadComplete(t0).runNow()), loadError = js.Any.fromFunction1((t0: String) => loadError(t0).runNow()), loadHooks = loadHooks.asInstanceOf[js.Any], loadTimeout = js.Any.fromFunction1((t0: String) => loadTimeout(t0).runNow()), loaded = loaded.asInstanceOf[js.Any], loading = loading.asInstanceOf[js.Any])
  ...
  extension [Self <: Ajax](x: Self) {
    ...
    inline def setLoadComplete(value: String => japgolly.scalajs.react.Callback): Self = StObject.set(x, "loadComplete", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    
    inline def setLoadError(value: String => japgolly.scalajs.react.Callback): Self = StObject.set(x, "loadError", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    ...
    inline def setLoadTimeout(value: String => japgolly.scalajs.react.Callback): Self = StObject.set(x, "loadTimeout", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    
    inline def setLoaded(value: Any): Self = StObject.set(x, "loaded", value.asInstanceOf[js.Any])
    
    inline def setLoading(value: Boolean): Self = StObject.set(x, "loading", value.asInstanceOf[js.Any])
    
    inline def setPreloading(value: /* repeated */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "Preloading", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
