...
import typingsJapgolly.musickitJs.anon.ArtistName
import typingsJapgolly.musickitJs.anon.Morebyartist
...
trait MusicVideos
  ...
  var relationships_MusicVideos: typingsJapgolly.musickitJs.anon.Genres
...
object MusicVideos {
  ...
  inline def apply(
    href: String,
    id: MusicItemID,
    relationships: typingsJapgolly.musickitJs.anon.Genres,
    views: Morebyartist
  ): MusicVideos = {
  ...
  extension [Self <: MusicVideos](x: Self) {
    ...
    inline def setRelationships(value: typingsJapgolly.musickitJs.anon.Genres): Self = StObject.set(x, "relationships", value.asInstanceOf[js.Any])
