...
object MediaItem {
  ...
  extension [Self <: MediaItem](x: Self) {
    ...
    inline def setPrepareToPlay(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "prepareToPlay", value.toJsFn)
