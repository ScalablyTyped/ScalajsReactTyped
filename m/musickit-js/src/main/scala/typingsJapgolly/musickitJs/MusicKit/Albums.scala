...
import typingsJapgolly.musickitJs.anon.Appearson
import typingsJapgolly.musickitJs.anon.ArtistUrl
import typingsJapgolly.musickitJs.musickitJsStrings.albums
...
trait Albums
  ...
  var relationships_Albums: typingsJapgolly.musickitJs.anon.Artists
...
object Albums {
  ...
  inline def apply(href: String, id: String, relationships: typingsJapgolly.musickitJs.anon.Artists, views: Appearson): Albums = {
  ...
  extension [Self <: Albums](x: Self) {
    ...
    inline def setRelationships(value: typingsJapgolly.musickitJs.anon.Artists): Self = StObject.set(x, "relationships", value.asInstanceOf[js.Any])
