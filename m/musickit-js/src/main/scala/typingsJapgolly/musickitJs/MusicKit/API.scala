...
import typingsJapgolly.musickitJs.anon.Data
import typingsJapgolly.musickitJs.anon.Terms
import typingsJapgolly.musickitJs.anon.keyinMusicCatalogChartReq
...
trait API extends StObject {
  ...
  /**
    ...
    */
  def search(term: String): js.Promise[typingsJapgolly.musickitJs.anon.Activities] = js.native
  def search(term: String, parameters: QueryParameters): js.Promise[typingsJapgolly.musickitJs.anon.Activities] = js.native
