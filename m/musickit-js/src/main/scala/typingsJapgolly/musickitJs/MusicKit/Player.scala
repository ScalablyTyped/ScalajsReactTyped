...
object Player {
  ...
  inline def apply(
    ...
    pause: Callback,
    play: CallbackTo[js.Promise[MediaItemPosition]],
    playbackRate: Double,
    ...
    showPlaybackTargetPicker: Callback,
    shuffleMode: PlayerShuffleMode,
    skipToNextItem: CallbackTo[js.Promise[MediaItemPosition]],
    skipToPreviousItem: CallbackTo[js.Promise[MediaItemPosition]],
    stop: Callback,
    volume: Double
  ): Player = {
    val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2((t0: String, t1: js.Function0[Any]) => (addEventListener(t0, t1)).runNow()), bitrate = bitrate.asInstanceOf[js.Any], canSupportDRM = canSupportDRM.asInstanceOf[js.Any], changeToMediaAtIndex = js.Any.fromFunction1(changeToMediaAtIndex), changeToMediaItem = js.Any.fromFunction1(changeToMediaItem), currentPlaybackDuration = currentPlaybackDuration.asInstanceOf[js.Any], currentPlaybackProgress = currentPlaybackProgress.asInstanceOf[js.Any], currentPlaybackTime = currentPlaybackTime.asInstanceOf[js.Any], currentPlaybackTimeRemaining = currentPlaybackTimeRemaining.asInstanceOf[js.Any], formattedCurrentPlaybackDuration = formattedCurrentPlaybackDuration.asInstanceOf[js.Any], isPlaying = isPlaying.asInstanceOf[js.Any], mute = mute.toJsFn, nowPlayingItem = nowPlayingItem.asInstanceOf[js.Any], pause = pause.toJsFn, play = play.toJsFn, playbackRate = playbackRate.asInstanceOf[js.Any], playbackState = playbackState.asInstanceOf[js.Any], prepareToPlay = js.Any.fromFunction1(prepareToPlay), queue = queue.asInstanceOf[js.Any], removeEventListener = js.Any.fromFunction2((t0: String, t1: js.Function0[Any]) => (removeEventListener(t0, t1)).runNow()), repeatMode = repeatMode.asInstanceOf[js.Any], seekToTime = js.Any.fromFunction1(seekToTime), showPlaybackTargetPicker = showPlaybackTargetPicker.toJsFn, shuffleMode = shuffleMode.asInstanceOf[js.Any], skipToNextItem = skipToNextItem.toJsFn, skipToPreviousItem = skipToPreviousItem.toJsFn, stop = stop.toJsFn, volume = volume.asInstanceOf[js.Any])
  ...
  extension [Self <: Player](x: Self) {
    ...
    inline def setPlay(value: CallbackTo[js.Promise[MediaItemPosition]]): Self = StObject.set(x, "play", value.toJsFn)
    ...
    inline def setShowPlaybackTargetPicker(value: Callback): Self = StObject.set(x, "showPlaybackTargetPicker", value.toJsFn)
    
    inline def setShuffleMode(value: PlayerShuffleMode): Self = StObject.set(x, "shuffleMode", value.asInstanceOf[js.Any])
    
    inline def setSkipToNextItem(value: CallbackTo[js.Promise[MediaItemPosition]]): Self = StObject.set(x, "skipToNextItem", value.toJsFn)
    
    inline def setSkipToPreviousItem(value: CallbackTo[js.Promise[MediaItemPosition]]): Self = StObject.set(x, "skipToPreviousItem", value.toJsFn)
