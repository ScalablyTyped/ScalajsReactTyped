...
import typingsJapgolly.musickitJs.musickitJsStrings.`music-recommendations`
import typingsJapgolly.musickitJs.musickitJsStrings.`recently-played`
import typingsJapgolly.musickitJs.musickitJsStrings.unknown
