...
import typingsJapgolly.musickitJs.MusicKit.Preview
import typingsJapgolly.musickitJs.musickitJsStrings.preview
...
trait ArtistName extends StObject {
  ...
  var contentRating: js.UndefOr[typingsJapgolly.musickitJs.MusicKit.ContentRating] = js.undefined
...
object ArtistName {
  ...
  extension [Self <: ArtistName](x: Self) {
    ...
    inline def setContentRating(value: typingsJapgolly.musickitJs.MusicKit.ContentRating): Self = StObject.set(x, "contentRating", value.asInstanceOf[js.Any])
