...
import typingsJapgolly.musickitJs.musickitJsStrings.`opt-in`
import typingsJapgolly.musickitJs.musickitJsStrings.allowed
import typingsJapgolly.musickitJs.musickitJsStrings.prohibited
