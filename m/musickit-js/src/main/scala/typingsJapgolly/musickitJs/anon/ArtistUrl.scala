...
trait ArtistUrl extends StObject {
  ...
  var Possible: js.UndefOr[typingsJapgolly.musickitJs.MusicKit.ContentRating] = js.undefined
...
object ArtistUrl {
  ...
  extension [Self <: ArtistUrl](x: Self) {
    ...
    inline def setPossible(value: typingsJapgolly.musickitJs.MusicKit.ContentRating): Self = StObject.set(x, "Possible", value.asInstanceOf[js.Any])
