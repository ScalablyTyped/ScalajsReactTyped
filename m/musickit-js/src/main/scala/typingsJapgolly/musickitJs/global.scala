...
import typingsJapgolly.musickitJs.MusicKit.Artwork
import typingsJapgolly.musickitJs.MusicKit.Configuration
import typingsJapgolly.musickitJs.MusicKit.EmbedOptions
import typingsJapgolly.musickitJs.MusicKit.FormattedPlaybackDuration
import typingsJapgolly.musickitJs.MusicKit.MediaItemOptions
import typingsJapgolly.musickitJs.MusicKit.MusicKitInstance
...
object global {
  ...
  object MusicKit {
    ...
    open class MKError ()
      extends StObject
         with typingsJapgolly.musickitJs.MusicKit.MKError {
    ...
    open class MediaItem ()
      extends StObject
         with typingsJapgolly.musickitJs.MusicKit.MediaItem {
    ...
    object PlaybackBitrate extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.musickitJs.MusicKit.PlaybackBitrate & Double] = js.native
      
      /* 256 */ val HIGH: typingsJapgolly.musickitJs.MusicKit.PlaybackBitrate.HIGH & Double = js.native
      
      /* 64 */ val STANDARD: typingsJapgolly.musickitJs.MusicKit.PlaybackBitrate.STANDARD & Double = js.native
    }
    ...
    object PlaybackState extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.musickitJs.MusicKit.PlaybackState & Double] = js.native
      
      /* 5 */ val ENDED: typingsJapgolly.musickitJs.MusicKit.PlaybackState.ENDED & Double = js.native
      
      /* 1 */ val LOADING: typingsJapgolly.musickitJs.MusicKit.PlaybackState.LOADING & Double = js.native
      
      /* 0 */ val NONE: typingsJapgolly.musickitJs.MusicKit.PlaybackState.NONE & Double = js.native
      
      /* 3 */ val PAUSED: typingsJapgolly.musickitJs.MusicKit.PlaybackState.PAUSED & Double = js.native
      
      /* 2 */ val PLAYING: typingsJapgolly.musickitJs.MusicKit.PlaybackState.PLAYING & Double = js.native
      
      /* 6 */ val SEEKING: typingsJapgolly.musickitJs.MusicKit.PlaybackState.SEEKING & Double = js.native
      
      /* 4 */ val STOPPED: typingsJapgolly.musickitJs.MusicKit.PlaybackState.STOPPED & Double = js.native
      
      /* 9 */ val completed: typingsJapgolly.musickitJs.MusicKit.PlaybackState.completed & Double = js.native
      
      /* 8 */ val stalled: typingsJapgolly.musickitJs.MusicKit.PlaybackState.stalled & Double = js.native
      
      /* 7 */ val waiting: typingsJapgolly.musickitJs.MusicKit.PlaybackState.waiting & Double = js.native
    }
    ...
    @js.native
    val errors: js.Array[typingsJapgolly.musickitJs.MusicKit.MKError] = js.native
