...
import typingsJapgolly.materialFloatingLabel.foundationMod.MDCFloatingLabelFoundation
...
object componentMod {
  ...
  object MDCFloatingLabel {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCFloatingLabel = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCFloatingLabel]
  }
