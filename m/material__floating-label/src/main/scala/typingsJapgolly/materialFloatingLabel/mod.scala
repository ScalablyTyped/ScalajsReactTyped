...
import typingsJapgolly.materialFloatingLabel.foundationMod.default
...
object mod extends js.Object {
  ...
  class MDCFloatingLabel ()
    extends typingsJapgolly.materialBase.componentMod.default[MDCFloatingLabelAdapter, default] {
    /**
