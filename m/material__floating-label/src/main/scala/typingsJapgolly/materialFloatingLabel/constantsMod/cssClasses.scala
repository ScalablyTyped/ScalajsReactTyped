package typingsJapgolly.materialFloatingLabel.constantsMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.materialBase.foundationMod.MDCStrings
import typingsJapgolly.materialFloatingLabel.materialFloatingLabelStrings.`mdc-floating-label--float-above`
import typingsJapgolly.materialFloatingLabel.materialFloatingLabelStrings.`mdc-floating-label--shake`
