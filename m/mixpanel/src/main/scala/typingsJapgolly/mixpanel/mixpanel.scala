...
import typingsJapgolly.mixpanel.Mixpanel.Config
import typingsJapgolly.mixpanel.Mixpanel.EventBaseType
import typingsJapgolly.mixpanel.Mixpanel.People
import typingsJapgolly.mixpanel.Mixpanel.Query
import typingsJapgolly.mixpanel.mixpanelStrings.cookie
import typingsJapgolly.mixpanel.mixpanelStrings.localStorage
...
trait Mixpanel extends StObject {
  ...
  def init(token: String, config: Unit, libraryName: String): Mixpanel = js.native
...
object Mixpanel {
  ...
  trait Config extends StObject {
    ...
    /**
      * @default function() {}
      */
    var loaded: js.UndefOr[js.Function1[/* lib */ Mixpanel, Unit]] = js.undefined
  ...
  object Config {
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setLoaded(value: /* lib */ Mixpanel => Callback): Self = StObject.set(x, "loaded", js.Any.fromFunction1((t0: /* lib */ Mixpanel) => value(t0).runNow()))
