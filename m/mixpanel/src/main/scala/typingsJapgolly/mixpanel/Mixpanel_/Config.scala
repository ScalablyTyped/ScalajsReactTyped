...
trait Config extends js.Object {
  ...
  /**
    * @default function() {}
    */
  var loaded: js.UndefOr[js.Function1[/* lib */ typingsJapgolly.mixpanel.Mixpanel_, Unit]] = js.undefined
  /**
...
object Config {
  ...
  def apply(
    ...
    loaded: /* lib */ typingsJapgolly.mixpanel.Mixpanel_ => Callback = null,
    ...
    if (loaded != null) __obj.updateDynamic("loaded")(js.Any.fromFunction1((t0: /* lib */ typingsJapgolly.mixpanel.Mixpanel_) => loaded(t0).runNow()))
