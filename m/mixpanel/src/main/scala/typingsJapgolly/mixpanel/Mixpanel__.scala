...
import typingsJapgolly.mixpanel.Mixpanel_.Config
import typingsJapgolly.mixpanel.Mixpanel_.People
import typingsJapgolly.mixpanel.Mixpanel_.Query
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait Mixpanel__ extends js.Object {
  ...
  /**
    ...
    */
  def init(token: String): Mixpanel_ = js.native
  def init(token: String, config: Config): Mixpanel_ = js.native
  def init(token: String, config: Config, libraryName: String): Mixpanel_ = js.native
  /**
