...
import typingsJapgolly.maximMazurokGapiClientOsconfig.gapi.client.osconfig.PatchDeployment
...
object Parent {
  ...
  inline def apply(parent: String, resource: PatchDeployment): Parent = {
  ...
  extension [Self <: Parent](x: Self) {
    ...
    inline def setResource(value: PatchDeployment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
