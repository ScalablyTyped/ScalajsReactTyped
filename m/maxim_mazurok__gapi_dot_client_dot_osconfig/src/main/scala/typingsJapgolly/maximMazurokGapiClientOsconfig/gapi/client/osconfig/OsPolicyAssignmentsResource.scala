...
import typingsJapgolly.maximMazurokGapiClientOsconfig.anon.Key
import typingsJapgolly.maximMazurokGapiClientOsconfig.anon.Name
import typingsJapgolly.maximMazurokGapiClientOsconfig.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientOsconfig.anon.PageSize
import typingsJapgolly.maximMazurokGapiClientOsconfig.anon.PrettyPrint
