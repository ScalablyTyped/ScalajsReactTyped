...
trait InventoryWindowsApplication extends StObject {
...
object InventoryWindowsApplication {
  
  inline def apply(): InventoryWindowsApplication = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InventoryWindowsApplication]
  }
  
  extension [Self <: InventoryWindowsApplication](x: Self) {
