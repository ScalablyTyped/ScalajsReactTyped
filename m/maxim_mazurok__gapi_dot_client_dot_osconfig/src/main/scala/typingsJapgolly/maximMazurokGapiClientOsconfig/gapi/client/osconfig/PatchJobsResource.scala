...
import typingsJapgolly.maximMazurokGapiClientOsconfig.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientOsconfig.anon.AltCallback
...
import typingsJapgolly.maximMazurokGapiClientOsconfig.anon.Xgafv
