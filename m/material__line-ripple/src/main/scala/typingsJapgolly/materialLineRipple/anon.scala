...
object anon {
  ...
  object PartialMDCLineRippleAdapt {
    ...
    extension [Self <: PartialMDCLineRippleAdapt](x: Self) {
      ...
      inline def setSetStyle(value: (/* propertyName */ String, /* value */ String) => Callback): Self = StObject.set(x, "setStyle", js.Any.fromFunction2((t0: /* propertyName */ String, t1: /* value */ String) => (value(t0, t1)).runNow()))
