...
import typingsJapgolly.mobxStateTree.anon.CreationType
import typingsJapgolly.mobxStateTree.anon.SnapshotType
import typingsJapgolly.mobxStateTree.distCoreTypeTypeCheckerMod.IValidationContext
import typingsJapgolly.mobxStateTree.distCoreTypeTypeCheckerMod.IValidationResult
import typingsJapgolly.mobxStateTree.distTypesComplexTypesModelMod.ModelPrimitive
...
object distCoreTypeTypeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mobxStateTree.distCoreTypeTypeMod.SnapshotIn[T]
    - typingsJapgolly.mobxStateTree.distCoreTypeTypeMod.Instance[T]
  */
