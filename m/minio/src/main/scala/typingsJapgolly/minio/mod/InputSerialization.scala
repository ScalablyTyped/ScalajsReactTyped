...
import typingsJapgolly.minio.anon.AllowQuotedRecordDelimiter
import typingsJapgolly.minio.anon.Type
import typingsJapgolly.minio.minioStrings.BZIP2
import typingsJapgolly.minio.minioStrings.GZIP
