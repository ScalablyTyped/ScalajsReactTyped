package typingsJapgolly.maximMazurokGapiClientSourcerepo

import typingsJapgolly.maximMazurokGapiClientSourcerepo.gapi.client.sourcerepo.ProjectsResource
import typingsJapgolly.maximMazurokGapiClientSourcerepo.maximMazurokGapiClientSourcerepoStrings.sourcerepo
import typingsJapgolly.maximMazurokGapiClientSourcerepo.maximMazurokGapiClientSourcerepoStrings.v1
