...
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Callback
import typingsJapgolly.maximMazurokGapiClientDomains.anon.DomainName
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Fields
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Filter
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Key
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Name
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientDomains.anon.OptionsrequestedPolicyVersion
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Parent
import typingsJapgolly.maximMazurokGapiClientDomains.anon.PrettyPrint
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Query
import typingsJapgolly.maximMazurokGapiClientDomains.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Resource
import typingsJapgolly.maximMazurokGapiClientDomains.anon.UpdateMask
import typingsJapgolly.maximMazurokGapiClientDomains.anon.UploadType
import typingsJapgolly.maximMazurokGapiClientDomains.anon.Uploadprotocol
...
trait RegistrationsResource extends StObject {
  ...
  def resetAuthorizationCode(request: typingsJapgolly.maximMazurokGapiClientDomains.anon.Registration): Request[AuthorizationCode] = js.native
  ...
  def retrieveImportableDomains(request: typingsJapgolly.maximMazurokGapiClientDomains.anon.Location): Request[RetrieveImportableDomainsResponse] = js.native
