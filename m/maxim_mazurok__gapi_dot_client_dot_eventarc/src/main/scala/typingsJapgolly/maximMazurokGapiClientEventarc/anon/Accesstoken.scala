package typingsJapgolly.maximMazurokGapiClientEventarc.anon

import typingsJapgolly.maximMazurokGapiClientEventarc.gapi.client.eventarc.ChannelConnection
...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: ChannelConnection): Accesstoken = {
  ...
  extension [Self <: Accesstoken](x: Self) {
    ...
    inline def setResource(value: ChannelConnection): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
