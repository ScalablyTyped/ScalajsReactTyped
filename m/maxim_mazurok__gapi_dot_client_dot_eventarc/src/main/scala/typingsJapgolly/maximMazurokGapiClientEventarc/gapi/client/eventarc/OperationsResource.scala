...
import typingsJapgolly.maximMazurokGapiClientEventarc.anon.Resource
...
trait OperationsResource extends StObject {
  ...
  def cancel(request: Callback, body: GoogleLongrunningCancelOperationRequest): Request[js.Object] = js.native
  /**
