...
import typingsJapgolly.maximMazurokGapiClientEventarc.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientEventarc.anon.Alt
...
import typingsJapgolly.maximMazurokGapiClientEventarc.anon.Key
