...
import typingsJapgolly.micromatch.partstrueScanOptions
import typingsJapgolly.micromatch.tokenstrueScanOptions
...
trait Micromatch extends js.Object {
  ...
  def braces(pattern: String, options: typingsJapgolly.braces.mod.Options): js.Array[String] = js.native
  /**
