package typingsJapgolly.micromatch

import japgolly.scalajs.react.Callback
import typingsJapgolly.micromatch.micromatchBooleans.`true`
import typingsJapgolly.micromatch.mod.Item
...
object anon {
  ...
  object partstrueScanOptions {
    ...
    extension [Self <: partstrueScanOptions](x: Self) {
      ...
      inline def setOnIgnore(value: /* item */ Item => Callback): Self = StObject.set(x, "onIgnore", js.Any.fromFunction1((t0: /* item */ Item) => value(t0).runNow()))
      
      inline def setOnIgnoreUndefined: Self = StObject.set(x, "onIgnore", js.undefined)
      
      inline def setOnMatch(value: /* item */ Item => Callback): Self = StObject.set(x, "onMatch", js.Any.fromFunction1((t0: /* item */ Item) => value(t0).runNow()))
      
      inline def setOnMatchUndefined: Self = StObject.set(x, "onMatch", js.undefined)
      
      inline def setOnResult(value: /* item */ Item => Callback): Self = StObject.set(x, "onResult", js.Any.fromFunction1((t0: /* item */ Item) => value(t0).runNow()))
