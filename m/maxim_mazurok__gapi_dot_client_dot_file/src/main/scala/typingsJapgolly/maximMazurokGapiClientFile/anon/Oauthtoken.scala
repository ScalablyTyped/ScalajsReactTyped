package typingsJapgolly.maximMazurokGapiClientFile.anon

import typingsJapgolly.maximMazurokGapiClientFile.gapi.client.file.Snapshot
...
object Oauthtoken {
  ...
  inline def apply(parent: String, resource: Snapshot): Oauthtoken = {
  ...
  extension [Self <: Oauthtoken](x: Self) {
    ...
    inline def setResource(value: Snapshot): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
