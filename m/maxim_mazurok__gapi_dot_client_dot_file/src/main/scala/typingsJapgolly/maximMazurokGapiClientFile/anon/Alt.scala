...
trait Alt extends StObject {
  ...
  /**
    * Required. The backup's project and location, in the format `projects/{project_number}/locations/{location}`. In Filestore, backup locations map to GCP regions, for example
    * **us-west1**.
    */
  var parent: String
