...
trait GoogleCloudSaasacceleratorManagementProvidersV1Instance extends StObject {
  ...
  var maintenanceSchedules: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.file.gapi.client.file.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule} */ js.Any
  ] = js.undefined
  ...
  var notificationParameters: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.file.gapi.client.file.GoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter} */ js.Any
  ] = js.undefined
...
object GoogleCloudSaasacceleratorManagementProvidersV1Instance {
  ...
  extension [Self <: GoogleCloudSaasacceleratorManagementProvidersV1Instance](x: Self) {
    ...
    inline def setMaintenanceSchedules(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.file.gapi.client.file.GoogleCloudSaasacceleratorManagementProvidersV1MaintenanceSchedule} */ js.Any
    ...
    inline def setNotificationParameters(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.file.gapi.client.file.GoogleCloudSaasacceleratorManagementProvidersV1NotificationParameter} */ js.Any
