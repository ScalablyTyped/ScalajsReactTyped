...
import typingsJapgolly.maximMazurokGapiClientCloudprofiler.gapi.client.cloudprofiler.CreateProfileRequest
import typingsJapgolly.maximMazurokGapiClientCloudprofiler.gapi.client.cloudprofiler.Profile
...
object anon {
  ...
  trait Accesstoken extends StObject {
    ...
    /** Request body */
    var resource: CreateProfileRequest
  ...
  object Accesstoken {
    ...
    inline def apply(parent: String, resource: CreateProfileRequest): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: CreateProfileRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Callback {
    ...
    inline def apply(parent: String, resource: Profile): Callback = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  object Fields {
    ...
    inline def apply(name: String, resource: Profile): Fields = {
