...
import typingsJapgolly.maximMazurokGapiClientDoubleclickbidmanager.gapi.client.doubleclickbidmanager.Query
import typingsJapgolly.maximMazurokGapiClientDoubleclickbidmanager.gapi.client.doubleclickbidmanager.RunQueryRequest
