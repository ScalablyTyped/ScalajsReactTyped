...
import typingsJapgolly.moonjs.moonjsBooleans.`true`
...
object ComponentOptionsProperties {
  ...
  def apply[Props /* <: String */, Data, Methods](
    ...
    render: (/* h */ CreateElement, /* ctx */ js.Any) => CallbackTo[VDomElement] = null,
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction2((t0: /* h */ typingsJapgolly.moonjs.mod.CreateElement, t1: /* ctx */ js.Any) => render(t0, t1).runNow()))
