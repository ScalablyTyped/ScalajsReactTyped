...
object mod extends Shortcut {
  ...
  object MoonConfig {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(delimiters = delimiters.asInstanceOf[js.Any], keycodes = js.Any.fromFunction1((t0: Record[String, Double]) => keycodes(t0).runNow()), prefix = prefix.asInstanceOf[js.Any], silent = silent.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    ...
    extension [Self <: MoonConfig](x: Self) {
      ...
      inline def setKeycodes(value: Record[String, Double] => Callback): Self = StObject.set(x, "keycodes", js.Any.fromFunction1((t0: Record[String, Double]) => value(t0).runNow()))
