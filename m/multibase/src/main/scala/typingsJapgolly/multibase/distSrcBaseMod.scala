...
import typingsJapgolly.multibase.distSrcTypesMod.Codec
...
object distSrcBaseMod {
  ...
  open class ^ protected ()
    ...
    /* CompleteClass */
    var code: typingsJapgolly.multibase.distSrcTypesMod.BaseCode = js.native
    ...
    /* CompleteClass */
    var name: typingsJapgolly.multibase.distSrcTypesMod.BaseName = js.native
  }
  ...
  trait Base extends StObject {
    ...
    var code: typingsJapgolly.multibase.distSrcTypesMod.BaseCode
    ...
    var name: typingsJapgolly.multibase.distSrcTypesMod.BaseName
  }
  object Base {
    
    inline def apply(
      alphabet: String,
      code: typingsJapgolly.multibase.distSrcTypesMod.BaseCode,
      codeBuf: js.typedarray.Uint8Array,
      codec: Codec,
      decode: String => js.typedarray.Uint8Array,
      encode: js.typedarray.Uint8Array => String,
      name: typingsJapgolly.multibase.distSrcTypesMod.BaseName
    ): Base = {
    ...
    extension [Self <: Base](x: Self) {
      ...
      inline def setCode(value: typingsJapgolly.multibase.distSrcTypesMod.BaseCode): Self = StObject.set(x, "code", value.asInstanceOf[js.Any])
      ...
      inline def setName(value: typingsJapgolly.multibase.distSrcTypesMod.BaseName): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
