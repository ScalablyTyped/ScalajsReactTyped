...
object WithStyles {
  @scala.inline
  def apply[StylesType /* <: ClassKeyInferable[_, _] */, IncludeTheme /* <: js.UndefOr[Boolean] */](classes: ClassNameMap[ClassKeyOfStyles[StylesType]], innerRef: Ref = null): WithStyles[StylesType, IncludeTheme] = {
