...
object BaseCSSProperties {
  @scala.inline
  def apply(
    `@font-face`: JSSFontface | js.Array[JSSFontface] = null,
    ...
    if (`@font-face` != null) __obj.updateDynamic("@font-face")(`@font-face`.asInstanceOf[js.Any])
