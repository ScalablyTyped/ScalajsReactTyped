package typingsJapgolly.moviedb

import japgolly.scalajs.react.Callback
import typingsJapgolly.moviedb.mod.MovieDB.IMovieDB
...
object mod {
  ...
  object MovieDB {
    ...
    object IMovieDB {
      ...
      inline def apply(
        movieImages: (InfoOptions, js.Function2[/* err */ Any, /* images */ MovieImages, Unit]) => Callback,
        movieInfo: (InfoOptions, js.Function2[/* err */ Any, /* curMovie */ Movie, Unit]) => Callback,
        searchMovie: (SearchOptions, js.Function2[/* err */ Any, /* movies */ SearchResults, Unit]) => Callback
      ): IMovieDB = {
        val __obj = js.Dynamic.literal(movieImages = js.Any.fromFunction2((t0: InfoOptions, t1: js.Function2[/* err */ Any, /* images */ MovieImages, Unit]) => (movieImages(t0, t1)).runNow()), movieInfo = js.Any.fromFunction2((t0: InfoOptions, t1: js.Function2[/* err */ Any, /* curMovie */ Movie, Unit]) => (movieInfo(t0, t1)).runNow()), searchMovie = js.Any.fromFunction2((t0: SearchOptions, t1: js.Function2[/* err */ Any, /* movies */ SearchResults, Unit]) => (searchMovie(t0, t1)).runNow()))
        __obj.asInstanceOf[IMovieDB]
      }
      
      extension [Self <: IMovieDB](x: Self) {
        
        inline def setMovieImages(value: (InfoOptions, js.Function2[/* err */ Any, /* images */ MovieImages, Unit]) => Callback): Self = StObject.set(x, "movieImages", js.Any.fromFunction2((t0: InfoOptions, t1: js.Function2[/* err */ Any, /* images */ MovieImages, Unit]) => (value(t0, t1)).runNow()))
        
        inline def setMovieInfo(value: (InfoOptions, js.Function2[/* err */ Any, /* curMovie */ Movie, Unit]) => Callback): Self = StObject.set(x, "movieInfo", js.Any.fromFunction2((t0: InfoOptions, t1: js.Function2[/* err */ Any, /* curMovie */ Movie, Unit]) => (value(t0, t1)).runNow()))
        
        inline def setSearchMovie(value: (SearchOptions, js.Function2[/* err */ Any, /* movies */ SearchResults, Unit]) => Callback): Self = StObject.set(x, "searchMovie", js.Any.fromFunction2((t0: SearchOptions, t1: js.Function2[/* err */ Any, /* movies */ SearchResults, Unit]) => (value(t0, t1)).runNow()))
      }
    }
