...
import typingsJapgolly.maximMazurokGapiClientTagmanager.gapi.client.tagmanager.Trigger
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait FingerprintKey extends StObject {
...
object FingerprintKey {
  ...
  inline def apply(path: String, resource: Trigger): FingerprintKey = {
    val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[FingerprintKey]
  }
  
  extension [Self <: FingerprintKey](x: Self) {
