package typingsJapgolly.mysticateaSpy

import japgolly.scalajs.react.Callback
import typingsJapgolly.mysticateaSpy.distMod.Spy_.CallInformation
...
object distMod {
  ...
  object Spy_ {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.mysticateaSpy.distMod.Spy_.ReturnedCall[T]
      - typingsJapgolly.mysticateaSpy.distMod.Spy_.ThrownCall[T]
    */
    trait Call[T /* <: js.Function1[/* repeated */ Any, Any] */] extends StObject
    object Call {
      
      inline def ReturnedCall[T /* <: js.Function1[/* repeated */ Any, Any] */](arguments: Parameters[T], `return`: ReturnType[T], `this`: This[T]): typingsJapgolly.mysticateaSpy.distMod.Spy_.ReturnedCall[T] = {
        ...
        __obj.asInstanceOf[typingsJapgolly.mysticateaSpy.distMod.Spy_.ReturnedCall[T]]
      }
      
      inline def ThrownCall[T /* <: js.Function1[/* repeated */ Any, Any] */](arguments: Parameters[T], `this`: This[T], `throw`: Any): typingsJapgolly.mysticateaSpy.distMod.Spy_.ThrownCall[T] = {
        val __obj = js.Dynamic.literal(arguments = arguments.asInstanceOf[js.Any])
        __obj.updateDynamic("this")(`this`.asInstanceOf[js.Any])
        __obj.updateDynamic("throw")(`throw`.asInstanceOf[js.Any])
        __obj.updateDynamic("type")("throw")
        __obj.asInstanceOf[typingsJapgolly.mysticateaSpy.distMod.Spy_.ThrownCall[T]]
      }
    }
    ...
    object CallInformation {
      ...
      inline def apply[T /* <: js.Function1[/* repeated */ Any, Any] */](
        ...
        val __obj = js.Dynamic.literal(calls = calls.asInstanceOf[js.Any], reset = reset.toJsFn, returnedCalls = returnedCalls.asInstanceOf[js.Any], thrownCalls = thrownCalls.asInstanceOf[js.Any], firstCall = null, firstReturnedCall = null, firstThrownCall = null, lastCall = null, lastReturnedCall = null, lastThrownCall = null)
