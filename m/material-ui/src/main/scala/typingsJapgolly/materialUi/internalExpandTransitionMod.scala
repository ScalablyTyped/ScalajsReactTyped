...
object internalExpandTransitionMod {
  ...
  type ExpandTransition = japgolly.scalajs.react.facade.React.Component[ExpandTransitionProps & js.Object, js.Object]
  ...
  trait ExpandTransitionProps extends StObject {
    ...
    var ref: js.UndefOr[
        LegacyRef[
          japgolly.scalajs.react.facade.React.Component[ExpandTransitionProps & js.Object, js.Object]
        ]
      ] = js.undefined
  ...
  object ExpandTransitionProps {
    ...
    extension [Self <: ExpandTransitionProps](x: Self) {
      ...
      inline def setRefFunction1(
        value: (japgolly.scalajs.react.facade.React.Component[ExpandTransitionProps & js.Object, js.Object]) | Null => Callback
      ): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: (japgolly.scalajs.react.facade.React.Component[ExpandTransitionProps & js.Object, js.Object]) | Null) => value(t0).runNow()))
