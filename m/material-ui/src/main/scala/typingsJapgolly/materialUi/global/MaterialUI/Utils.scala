...
import typingsJapgolly.materialUi.MaterialUI.Utils.Dom
import typingsJapgolly.materialUi.MaterialUI.Utils.Events
...
object Utils {
  ...
  @js.native
  def Dom: typingsJapgolly.materialUi.MaterialUI.Utils.Dom = js.native
  ...
  @js.native
  def Events: typingsJapgolly.materialUi.MaterialUI.Utils.Events = js.native
