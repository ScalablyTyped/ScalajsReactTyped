...
import typingsJapgolly.materialUi.svgIconsActionVisibilityMod.default
...
object Visibility {
  ...
  implicit def make(companion: Visibility.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
