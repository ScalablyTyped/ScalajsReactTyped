...
import typingsJapgolly.materialUi.svgIconsAvReplay5Mod.default
...
object Replay5 {
  ...
  implicit def make(companion: Replay5.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
