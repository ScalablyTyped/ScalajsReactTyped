...
import typingsJapgolly.materialUi.svgIconsMapsTrainMod.default
...
object Train {
  ...
  implicit def make(companion: Train.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
