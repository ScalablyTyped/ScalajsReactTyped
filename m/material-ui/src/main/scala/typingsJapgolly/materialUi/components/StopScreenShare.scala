...
import typingsJapgolly.materialUi.svgIconsCommunicationStopScreenShareMod.default
...
object StopScreenShare {
  ...
  implicit def make(companion: StopScreenShare.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
