...
import typingsJapgolly.materialUi.svgIconsHardwareComputerMod.default
...
object Computer {
  ...
  implicit def make(companion: Computer.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
