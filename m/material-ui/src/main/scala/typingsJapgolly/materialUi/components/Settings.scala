...
import typingsJapgolly.materialUi.svgIconsActionSettingsMod.default
...
object Settings {
  ...
  implicit def make(companion: Settings.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
