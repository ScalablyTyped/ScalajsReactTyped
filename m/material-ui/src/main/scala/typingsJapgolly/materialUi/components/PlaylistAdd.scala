...
import typingsJapgolly.materialUi.svgIconsAvPlaylistAddMod.default
...
object PlaylistAdd {
  ...
  implicit def make(companion: PlaylistAdd.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
