...
import typingsJapgolly.materialUi.svgIconsEditorBorderBottomMod.default
...
object BorderBottom {
  ...
  implicit def make(companion: BorderBottom.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
