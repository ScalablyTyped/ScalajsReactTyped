...
import typingsJapgolly.materialUi.svgIconsSocialShareMod.default
...
object Share {
  ...
  implicit def make(companion: Share.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
