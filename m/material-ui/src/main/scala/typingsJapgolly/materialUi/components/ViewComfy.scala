...
import typingsJapgolly.materialUi.svgIconsImageViewComfyMod.default
...
object ViewComfy {
  ...
  implicit def make(companion: ViewComfy.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
