...
object StepButton {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[StepButtonProps, typingsJapgolly.materialUi.mod.StepButton, Unit, StepButtonProps] = {
  ...
  typingsJapgolly.materialUi.MaterialUI.Stepper.StepButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.mod.StepButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.Stepper.StepButtonProps])(children: _*)
  }
