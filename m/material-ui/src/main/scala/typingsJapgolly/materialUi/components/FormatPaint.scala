...
import typingsJapgolly.materialUi.svgIconsEditorFormatPaintMod.default
...
object FormatPaint {
  ...
  implicit def make(companion: FormatPaint.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
