...
import typingsJapgolly.materialUi.svgIconsDeviceDevicesMod.default
...
object Devices {
  ...
  implicit def make(companion: Devices.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
