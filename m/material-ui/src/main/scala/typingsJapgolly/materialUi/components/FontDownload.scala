...
import typingsJapgolly.materialUi.svgIconsContentFontDownloadMod.default
...
object FontDownload {
  ...
  implicit def make(companion: FontDownload.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
