...
import typingsJapgolly.materialUi.svgIconsContentRemoveCircleMod.default
...
object RemoveCircle {
  ...
  implicit def make(companion: RemoveCircle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
