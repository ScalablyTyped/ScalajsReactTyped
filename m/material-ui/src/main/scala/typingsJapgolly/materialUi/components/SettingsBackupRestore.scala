...
import typingsJapgolly.materialUi.svgIconsActionSettingsBackupRestoreMod.default
...
object SettingsBackupRestore {
  ...
  implicit def make(companion: SettingsBackupRestore.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
