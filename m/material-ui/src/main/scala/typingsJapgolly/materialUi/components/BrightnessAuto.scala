...
import typingsJapgolly.materialUi.svgIconsDeviceBrightnessAutoMod.default
...
object BrightnessAuto {
  ...
  implicit def make(companion: BrightnessAuto.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
