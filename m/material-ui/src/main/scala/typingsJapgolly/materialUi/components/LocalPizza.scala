...
import typingsJapgolly.materialUi.svgIconsMapsLocalPizzaMod.default
...
object LocalPizza {
  ...
  implicit def make(companion: LocalPizza.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
