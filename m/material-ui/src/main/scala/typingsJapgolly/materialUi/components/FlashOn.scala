...
import typingsJapgolly.materialUi.svgIconsImageFlashOnMod.default
...
object FlashOn {
  ...
  implicit def make(companion: FlashOn.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
