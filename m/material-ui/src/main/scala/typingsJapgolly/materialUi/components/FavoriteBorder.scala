...
import typingsJapgolly.materialUi.svgIconsActionFavoriteBorderMod.default
...
object FavoriteBorder {
  ...
  implicit def make(companion: FavoriteBorder.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
