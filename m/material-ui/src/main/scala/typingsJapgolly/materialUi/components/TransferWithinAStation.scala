...
import typingsJapgolly.materialUi.svgIconsMapsTransferWithinAStationMod.default
...
object TransferWithinAStation {
  ...
  implicit def make(companion: TransferWithinAStation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
