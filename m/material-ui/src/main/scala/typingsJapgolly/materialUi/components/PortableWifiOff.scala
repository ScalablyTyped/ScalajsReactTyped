...
import typingsJapgolly.materialUi.svgIconsCommunicationPortableWifiOffMod.default
...
object PortableWifiOff {
  ...
  implicit def make(companion: PortableWifiOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
