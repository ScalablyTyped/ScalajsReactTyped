...
import typingsJapgolly.materialUi.svgIconsSocialSentimentDissatisfiedMod.default
...
object SentimentDissatisfied {
  ...
  implicit def make(companion: SentimentDissatisfied.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
