...
import typingsJapgolly.materialUi.svgIconsNotificationConfirmationNumberMod.default
...
object ConfirmationNumber {
  ...
  implicit def make(companion: ConfirmationNumber.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
