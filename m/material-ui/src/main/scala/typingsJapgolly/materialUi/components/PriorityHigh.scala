...
import typingsJapgolly.materialUi.svgIconsNotificationPriorityHighMod.default
...
object PriorityHigh {
  ...
  implicit def make(companion: PriorityHigh.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
