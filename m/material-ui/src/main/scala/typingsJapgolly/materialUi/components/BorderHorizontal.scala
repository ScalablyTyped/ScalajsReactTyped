...
import typingsJapgolly.materialUi.svgIconsEditorBorderHorizontalMod.default
...
object BorderHorizontal {
  ...
  implicit def make(companion: BorderHorizontal.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
