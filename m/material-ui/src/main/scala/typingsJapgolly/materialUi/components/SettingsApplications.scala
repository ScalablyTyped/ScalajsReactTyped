...
import typingsJapgolly.materialUi.svgIconsActionSettingsApplicationsMod.default
...
object SettingsApplications {
  ...
  implicit def make(companion: SettingsApplications.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
