...
import typingsJapgolly.materialUi.svgIconsActionAssignmentIndMod.default
...
object AssignmentInd {
  ...
  implicit def make(companion: AssignmentInd.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
