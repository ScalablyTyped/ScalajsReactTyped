...
import typingsJapgolly.materialUi.svgIconsActionAssignmentReturnMod.default
...
object AssignmentReturn {
  ...
  implicit def make(companion: AssignmentReturn.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
