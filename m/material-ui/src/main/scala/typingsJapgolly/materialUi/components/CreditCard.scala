...
import typingsJapgolly.materialUi.svgIconsActionCreditCardMod.default
...
object CreditCard {
  ...
  implicit def make(companion: CreditCard.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
