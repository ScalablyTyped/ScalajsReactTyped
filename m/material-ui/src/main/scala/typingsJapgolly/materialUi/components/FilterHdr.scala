...
import typingsJapgolly.materialUi.svgIconsImageFilterHdrMod.default
...
object FilterHdr {
  ...
  implicit def make(companion: FilterHdr.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
