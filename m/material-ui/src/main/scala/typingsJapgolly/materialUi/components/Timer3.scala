...
import typingsJapgolly.materialUi.svgIconsImageTimer3Mod.default
...
object Timer3 {
  ...
  implicit def make(companion: Timer3.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
