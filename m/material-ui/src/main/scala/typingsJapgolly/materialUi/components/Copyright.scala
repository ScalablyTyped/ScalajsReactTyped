...
import typingsJapgolly.materialUi.svgIconsActionCopyrightMod.default
...
object Copyright {
  ...
  implicit def make(companion: Copyright.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
