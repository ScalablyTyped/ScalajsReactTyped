...
import typingsJapgolly.materialUi.svgIconsDeviceBrightnessMediumMod.default
...
object BrightnessMedium {
  ...
  implicit def make(companion: BrightnessMedium.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
