...
import typingsJapgolly.materialUi.svgIconsNotificationPowerMod.default
...
object Power {
  ...
  implicit def make(companion: Power.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
