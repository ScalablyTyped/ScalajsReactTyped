...
import typingsJapgolly.materialUi.svgIconsActionPermPhoneMsgMod.default
...
object PermPhoneMsg {
  ...
  implicit def make(companion: PermPhoneMsg.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
