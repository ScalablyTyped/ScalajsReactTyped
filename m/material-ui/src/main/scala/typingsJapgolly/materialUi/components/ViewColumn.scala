...
import typingsJapgolly.materialUi.svgIconsActionViewColumnMod.default
...
object ViewColumn {
  ...
  implicit def make(companion: ViewColumn.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
