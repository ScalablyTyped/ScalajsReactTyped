...
import typingsJapgolly.materialUi.svgIconsAvHearingMod.default
...
object Hearing {
  ...
  implicit def make(companion: Hearing.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
