...
import typingsJapgolly.materialUi.svgIconsPlacesFreeBreakfastMod.default
...
object FreeBreakfast {
  ...
  implicit def make(companion: FreeBreakfast.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
