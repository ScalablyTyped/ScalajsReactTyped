...
import typingsJapgolly.materialUi.svgIconsActionPictureInPictureMod.default
...
object PictureInPicture {
  ...
  implicit def make(companion: PictureInPicture.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
