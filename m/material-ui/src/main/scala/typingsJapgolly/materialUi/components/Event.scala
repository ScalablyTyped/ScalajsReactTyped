...
import typingsJapgolly.materialUi.svgIconsActionEventMod.default
...
object Event {
  ...
  implicit def make(companion: Event.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
