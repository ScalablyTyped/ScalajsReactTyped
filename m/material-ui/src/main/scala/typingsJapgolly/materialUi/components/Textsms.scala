...
import typingsJapgolly.materialUi.svgIconsCommunicationTextsmsMod.default
...
object Textsms {
  ...
  implicit def make(companion: Textsms.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
