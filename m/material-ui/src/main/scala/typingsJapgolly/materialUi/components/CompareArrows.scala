...
import typingsJapgolly.materialUi.svgIconsActionCompareArrowsMod.default
...
object CompareArrows {
  ...
  implicit def make(companion: CompareArrows.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
