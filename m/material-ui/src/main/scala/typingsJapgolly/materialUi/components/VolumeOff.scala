...
import typingsJapgolly.materialUi.svgIconsAvVolumeOffMod.default
...
object VolumeOff {
  ...
  implicit def make(companion: VolumeOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
