...
import typingsJapgolly.materialUi.svgIconsMapsPersonPinMod.default
...
object PersonPin {
  ...
  implicit def make(companion: PersonPin.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
