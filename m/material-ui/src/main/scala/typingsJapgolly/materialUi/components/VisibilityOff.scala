...
import typingsJapgolly.materialUi.svgIconsActionVisibilityOffMod.default
...
object VisibilityOff {
  ...
  implicit def make(companion: VisibilityOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
