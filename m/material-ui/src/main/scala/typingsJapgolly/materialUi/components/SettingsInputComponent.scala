...
import typingsJapgolly.materialUi.svgIconsActionSettingsInputComponentMod.default
...
object SettingsInputComponent {
  ...
  implicit def make(companion: SettingsInputComponent.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
