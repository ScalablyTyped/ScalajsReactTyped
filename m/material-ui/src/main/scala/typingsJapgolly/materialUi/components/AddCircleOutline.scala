...
import typingsJapgolly.materialUi.svgIconsContentAddCircleOutlineMod.default
...
object AddCircleOutline {
  ...
  implicit def make(companion: AddCircleOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
