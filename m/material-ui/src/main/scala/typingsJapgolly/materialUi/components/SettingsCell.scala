...
import typingsJapgolly.materialUi.svgIconsActionSettingsCellMod.default
...
object SettingsCell {
  ...
  implicit def make(companion: SettingsCell.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
