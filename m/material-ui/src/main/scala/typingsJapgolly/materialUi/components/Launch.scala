...
import typingsJapgolly.materialUi.svgIconsActionLaunchMod.default
...
object Launch {
  ...
  implicit def make(companion: Launch.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
