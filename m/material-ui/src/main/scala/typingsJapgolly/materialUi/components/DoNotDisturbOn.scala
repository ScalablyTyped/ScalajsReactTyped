...
import typingsJapgolly.materialUi.svgIconsNotificationDoNotDisturbOnMod.default
...
object DoNotDisturbOn {
  ...
  implicit def make(companion: DoNotDisturbOn.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
