...
import typingsJapgolly.materialUi.svgIconsNotificationPhoneBluetoothSpeakerMod.default
...
object PhoneBluetoothSpeaker {
  ...
  implicit def make(companion: PhoneBluetoothSpeaker.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
