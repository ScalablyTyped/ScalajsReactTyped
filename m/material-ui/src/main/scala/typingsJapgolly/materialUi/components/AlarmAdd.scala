...
import typingsJapgolly.materialUi.svgIconsActionAlarmAddMod.default
...
object AlarmAdd {
  ...
  implicit def make(companion: AlarmAdd.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
