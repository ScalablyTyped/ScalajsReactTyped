...
import typingsJapgolly.materialUi.svgIconsImageAddAPhotoMod.default
...
object AddAPhoto {
  ...
  implicit def make(companion: AddAPhoto.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
