...
import typingsJapgolly.materialUi.svgIconsActionTocMod.default
...
object Toc {
  ...
  implicit def make(companion: Toc.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
