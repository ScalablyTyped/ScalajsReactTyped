...
import typingsJapgolly.materialUi.svgIconsActionSettingsBluetoothMod.default
...
object SettingsBluetooth {
  ...
  implicit def make(companion: SettingsBluetooth.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
