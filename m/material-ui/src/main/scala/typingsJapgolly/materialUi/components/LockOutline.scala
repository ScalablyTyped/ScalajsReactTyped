...
import typingsJapgolly.materialUi.svgIconsActionLockOutlineMod.default
...
object LockOutline {
  ...
  implicit def make(companion: LockOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
