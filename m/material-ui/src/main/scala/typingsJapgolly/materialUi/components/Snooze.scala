...
import typingsJapgolly.materialUi.svgIconsAvSnoozeMod.default
...
object Snooze {
  ...
  implicit def make(companion: Snooze.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
