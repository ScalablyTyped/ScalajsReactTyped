...
import typingsJapgolly.materialUi.svgIconsActionFlipToBackMod.default
...
object FlipToBack {
  ...
  implicit def make(companion: FlipToBack.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
