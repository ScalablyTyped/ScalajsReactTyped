...
import typingsJapgolly.materialUi.svgIconsAvGamesMod.default
...
object Games {
  ...
  implicit def make(companion: Games.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
