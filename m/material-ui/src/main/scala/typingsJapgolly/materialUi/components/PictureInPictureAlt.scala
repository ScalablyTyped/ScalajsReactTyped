...
import typingsJapgolly.materialUi.svgIconsActionPictureInPictureAltMod.default
...
object PictureInPictureAlt {
  ...
  implicit def make(companion: PictureInPictureAlt.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
