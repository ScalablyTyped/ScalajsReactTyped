...
import typingsJapgolly.materialUi.svgIconsEditorBubbleChartMod.default
...
object BubbleChart {
  ...
  implicit def make(companion: BubbleChart.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
