...
import typingsJapgolly.materialUi.svgIconsDeviceSettingsSystemDaydreamMod.default
...
object SettingsSystemDaydream {
  ...
  implicit def make(companion: SettingsSystemDaydream.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
