...
import typingsJapgolly.materialUi.svgIconsNotificationDiscFullMod.default
...
object DiscFull {
  ...
  implicit def make(companion: DiscFull.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
