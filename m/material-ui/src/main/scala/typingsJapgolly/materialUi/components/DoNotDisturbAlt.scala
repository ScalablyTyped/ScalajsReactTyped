...
import typingsJapgolly.materialUi.svgIconsNotificationDoNotDisturbAltMod.default
...
object DoNotDisturbAlt {
  ...
  implicit def make(companion: DoNotDisturbAlt.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
