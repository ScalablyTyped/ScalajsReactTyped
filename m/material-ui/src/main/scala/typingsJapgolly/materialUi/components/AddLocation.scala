...
import typingsJapgolly.materialUi.svgIconsMapsAddLocationMod.default
...
object AddLocation {
  ...
  implicit def make(companion: AddLocation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
