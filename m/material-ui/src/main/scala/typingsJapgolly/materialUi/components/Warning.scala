...
import typingsJapgolly.materialUi.svgIconsAlertWarningMod.default
...
object Warning {
  ...
  implicit def make(companion: Warning.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
