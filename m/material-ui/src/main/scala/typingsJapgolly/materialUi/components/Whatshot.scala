...
import typingsJapgolly.materialUi.svgIconsSocialWhatshotMod.default
...
object Whatshot {
  ...
  implicit def make(companion: Whatshot.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
