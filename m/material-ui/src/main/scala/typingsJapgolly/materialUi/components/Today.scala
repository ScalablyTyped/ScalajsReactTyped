...
import typingsJapgolly.materialUi.svgIconsActionTodayMod.default
...
object Today {
  ...
  implicit def make(companion: Today.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
