...
import typingsJapgolly.materialUi.svgIconsDeviceAccessTimeMod.default
...
object AccessTime {
  ...
  implicit def make(companion: AccessTime.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
