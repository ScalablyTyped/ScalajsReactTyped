...
import typingsJapgolly.materialUi.svgIconsCommunicationChatBubbleOutlineMod.default
...
object ChatBubbleOutline {
  ...
  implicit def make(companion: ChatBubbleOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
