...
import typingsJapgolly.materialUi.svgIconsHardwareSimCardMod.default
...
object SimCard {
  ...
  implicit def make(companion: SimCard.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
