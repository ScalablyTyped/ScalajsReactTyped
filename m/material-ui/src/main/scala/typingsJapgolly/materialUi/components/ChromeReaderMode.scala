...
import typingsJapgolly.materialUi.svgIconsActionChromeReaderModeMod.default
...
object ChromeReaderMode {
  ...
  implicit def make(companion: ChromeReaderMode.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
