...
import typingsJapgolly.materialUi.svgIconsNotificationNoEncryptionMod.default
...
object NoEncryption {
  ...
  implicit def make(companion: NoEncryption.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
