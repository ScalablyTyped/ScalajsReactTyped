...
import typingsJapgolly.materialUi.svgIconsMapsSatelliteMod.default
...
object Satellite {
  ...
  implicit def make(companion: Satellite.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
