...
import typingsJapgolly.materialUi.svgIconsActionDateRangeMod.default
...
object DateRange {
  ...
  implicit def make(companion: DateRange.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
