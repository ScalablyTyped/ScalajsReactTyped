...
import typingsJapgolly.materialUi.svgIconsActionExploreMod.default
...
object Explore {
  ...
  implicit def make(companion: Explore.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
