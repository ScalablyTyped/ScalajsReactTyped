...
object IconButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.materialUi.mod.IconButton] {
    ...
    inline def hoveredStyle(value: CSSProperties): this.type = set("hoveredStyle", value.asInstanceOf[js.Any])
    ...
    inline def tooltip(value: Node | String): this.type = set("tooltip", value.asInstanceOf[js.Any])
    
    inline def tooltipNull: this.type = set("tooltip", null)
    
    inline def tooltipPosition(value: cornersAndCenter): this.type = set("tooltipPosition", value.asInstanceOf[js.Any])
    
    inline def tooltipStyles(value: CSSProperties): this.type = set("tooltipStyles", value.asInstanceOf[js.Any])
