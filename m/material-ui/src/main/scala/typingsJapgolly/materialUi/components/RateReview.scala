...
import typingsJapgolly.materialUi.svgIconsMapsRateReviewMod.default
...
object RateReview {
  ...
  implicit def make(companion: RateReview.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
