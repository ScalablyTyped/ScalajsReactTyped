...
import typingsJapgolly.materialUi.svgIconsHardwareHeadsetMicMod.default
...
object HeadsetMic {
  ...
  implicit def make(companion: HeadsetMic.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
