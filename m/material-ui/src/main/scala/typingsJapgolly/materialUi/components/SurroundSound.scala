...
import typingsJapgolly.materialUi.svgIconsAvSurroundSoundMod.default
...
object SurroundSound {
  ...
  implicit def make(companion: SurroundSound.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
