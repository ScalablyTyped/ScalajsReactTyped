...
import typingsJapgolly.materialUi.svgIconsImageWbIridescentMod.default
...
object WbIridescent {
  ...
  implicit def make(companion: WbIridescent.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
