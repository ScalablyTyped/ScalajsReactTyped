...
import typingsJapgolly.materialUi.svgIconsActionCardMembershipMod.default
...
object CardMembership {
  ...
  implicit def make(companion: CardMembership.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
