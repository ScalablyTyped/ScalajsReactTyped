...
import typingsJapgolly.materialUi.svgIconsCommunicationPresentToAllMod.default
...
object PresentToAll {
  ...
  implicit def make(companion: PresentToAll.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
