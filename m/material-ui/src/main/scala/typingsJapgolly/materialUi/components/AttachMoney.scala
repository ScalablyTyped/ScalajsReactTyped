...
import typingsJapgolly.materialUi.svgIconsEditorAttachMoneyMod.default
...
object AttachMoney {
  ...
  implicit def make(companion: AttachMoney.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
