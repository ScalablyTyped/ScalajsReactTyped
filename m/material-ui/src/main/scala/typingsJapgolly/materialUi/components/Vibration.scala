...
import typingsJapgolly.materialUi.svgIconsNotificationVibrationMod.default
...
object Vibration {
  ...
  implicit def make(companion: Vibration.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
