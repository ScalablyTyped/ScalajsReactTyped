...
import typingsJapgolly.materialUi.svgIconsAvPauseCircleOutlineMod.default
...
object PauseCircleOutline {
  ...
  implicit def make(companion: PauseCircleOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
