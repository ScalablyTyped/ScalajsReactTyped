...
import typingsJapgolly.materialUi.svgIconsCommunicationLocationOffMod.default
...
object LocationOff {
  ...
  implicit def make(companion: LocationOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
