...
import typingsJapgolly.materialUi.svgIconsActionRestoreMod.default
...
object Restore {
  ...
  implicit def make(companion: Restore.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
