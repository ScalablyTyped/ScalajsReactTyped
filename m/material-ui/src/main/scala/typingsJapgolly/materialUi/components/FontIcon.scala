...
import typingsJapgolly.materialUi.fontIconMod.default
...
object FontIcon {
  ...
  typingsJapgolly.materialUi.MaterialUI.FontIconProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.fontIconMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.FontIconProps])(children: _*)
  }
