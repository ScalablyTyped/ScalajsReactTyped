...
import typingsJapgolly.materialUi.svgIconsMapsMyLocationMod.default
...
object MyLocation {
  ...
  implicit def make(companion: MyLocation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
