...
import typingsJapgolly.materialUi.svgIconsEditorFormatItalicMod.default
...
object FormatItalic {
  ...
  implicit def make(companion: FormatItalic.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
