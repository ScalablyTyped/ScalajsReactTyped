...
import typingsJapgolly.materialUi.svgIconsActionLineWeightMod.default
...
object LineWeight {
  ...
  implicit def make(companion: LineWeight.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
