...
import typingsJapgolly.materialUi.svgIconsEditorVerticalAlignCenterMod.default
...
object VerticalAlignCenter {
  ...
  implicit def make(companion: VerticalAlignCenter.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
