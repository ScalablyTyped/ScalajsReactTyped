...
import typingsJapgolly.materialUi.svgIconsMapsTrafficMod.default
...
object Traffic {
  ...
  implicit def make(companion: Traffic.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
