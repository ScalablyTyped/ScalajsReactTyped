...
import typingsJapgolly.materialUi.svgIconsCommunicationSpeakerPhoneMod.default
...
object SpeakerPhone {
  ...
  implicit def make(companion: SpeakerPhone.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
