...
import typingsJapgolly.materialUi.svgIconsActionRoomMod.default
...
object Room {
  ...
  implicit def make(companion: Room.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
