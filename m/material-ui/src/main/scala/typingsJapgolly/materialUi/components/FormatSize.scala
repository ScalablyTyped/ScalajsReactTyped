...
import typingsJapgolly.materialUi.svgIconsEditorFormatSizeMod.default
...
object FormatSize {
  ...
  implicit def make(companion: FormatSize.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
