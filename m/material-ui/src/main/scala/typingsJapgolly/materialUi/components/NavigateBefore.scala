...
import typingsJapgolly.materialUi.svgIconsImageNavigateBeforeMod.default
...
object NavigateBefore {
  ...
  implicit def make(companion: NavigateBefore.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
