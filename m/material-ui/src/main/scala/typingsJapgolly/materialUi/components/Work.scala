...
import typingsJapgolly.materialUi.svgIconsActionWorkMod.default
...
object Work {
  ...
  implicit def make(companion: Work.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
