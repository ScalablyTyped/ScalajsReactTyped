...
import typingsJapgolly.materialUi.svgIconsContentMailMod.default
...
object Mail {
  ...
  implicit def make(companion: Mail.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
