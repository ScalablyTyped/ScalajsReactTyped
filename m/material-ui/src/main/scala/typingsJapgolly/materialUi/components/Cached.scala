...
import typingsJapgolly.materialUi.svgIconsActionCachedMod.default
...
object Cached {
  ...
  implicit def make(companion: Cached.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
