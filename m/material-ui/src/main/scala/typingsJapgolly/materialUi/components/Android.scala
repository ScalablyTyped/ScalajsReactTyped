...
import typingsJapgolly.materialUi.svgIconsActionAndroidMod.default
...
object Android {
  ...
  implicit def make(companion: Android.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
