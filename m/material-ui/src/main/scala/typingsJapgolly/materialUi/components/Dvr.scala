...
import typingsJapgolly.materialUi.svgIconsDeviceDvrMod.default
...
object Dvr {
  ...
  implicit def make(companion: Dvr.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
