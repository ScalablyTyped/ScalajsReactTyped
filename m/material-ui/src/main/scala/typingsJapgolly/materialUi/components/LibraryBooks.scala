...
import typingsJapgolly.materialUi.svgIconsAvLibraryBooksMod.default
...
object LibraryBooks {
  ...
  implicit def make(companion: LibraryBooks.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
