...
import typingsJapgolly.materialUi.svgIconsAvSortByAlphaMod.default
...
object SortByAlpha {
  ...
  implicit def make(companion: SortByAlpha.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
