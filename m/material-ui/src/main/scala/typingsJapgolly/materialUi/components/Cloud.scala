...
import typingsJapgolly.materialUi.svgIconsFileCloudMod.default
...
object Cloud {
  ...
  implicit def make(companion: Cloud.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
