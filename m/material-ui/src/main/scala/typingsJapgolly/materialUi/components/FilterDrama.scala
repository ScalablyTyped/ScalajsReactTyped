...
import typingsJapgolly.materialUi.svgIconsImageFilterDramaMod.default
...
object FilterDrama {
  ...
  implicit def make(companion: FilterDrama.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
