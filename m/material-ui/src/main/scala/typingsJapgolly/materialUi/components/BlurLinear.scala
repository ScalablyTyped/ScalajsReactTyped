...
import typingsJapgolly.materialUi.svgIconsImageBlurLinearMod.default
...
object BlurLinear {
  ...
  implicit def make(companion: BlurLinear.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
