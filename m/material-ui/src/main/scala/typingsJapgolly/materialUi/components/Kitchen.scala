...
import typingsJapgolly.materialUi.svgIconsPlacesKitchenMod.default
...
object Kitchen {
  ...
  implicit def make(companion: Kitchen.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
