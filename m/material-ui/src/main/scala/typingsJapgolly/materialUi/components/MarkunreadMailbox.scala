...
import typingsJapgolly.materialUi.svgIconsActionMarkunreadMailboxMod.default
...
object MarkunreadMailbox {
  ...
  implicit def make(companion: MarkunreadMailbox.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
