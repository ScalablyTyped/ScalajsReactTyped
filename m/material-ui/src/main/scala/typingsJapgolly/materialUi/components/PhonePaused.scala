...
import typingsJapgolly.materialUi.svgIconsNotificationPhonePausedMod.default
...
object PhonePaused {
  ...
  implicit def make(companion: PhonePaused.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
