...
import typingsJapgolly.materialUi.svgIconsHardwareDeveloperBoardMod.default
...
object DeveloperBoard {
  ...
  implicit def make(companion: DeveloperBoard.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
