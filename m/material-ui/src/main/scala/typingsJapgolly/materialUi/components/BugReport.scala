...
import typingsJapgolly.materialUi.svgIconsActionBugReportMod.default
...
object BugReport {
  ...
  implicit def make(companion: BugReport.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
