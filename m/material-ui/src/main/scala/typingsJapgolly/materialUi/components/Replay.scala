...
import typingsJapgolly.materialUi.svgIconsAvReplayMod.default
...
object Replay {
  ...
  implicit def make(companion: Replay.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
