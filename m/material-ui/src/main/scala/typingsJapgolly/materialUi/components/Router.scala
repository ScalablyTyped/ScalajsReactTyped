...
import typingsJapgolly.materialUi.svgIconsHardwareRouterMod.default
...
object Router {
  ...
  implicit def make(companion: Router.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
