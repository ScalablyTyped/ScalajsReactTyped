...
import typingsJapgolly.materialUi.svgIconsNotificationSimCardAlertMod.default
...
object SimCardAlert {
  ...
  implicit def make(companion: SimCardAlert.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
