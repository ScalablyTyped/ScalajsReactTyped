...
import typingsJapgolly.materialUi.svgIconsDeviceAddAlarmMod.default
...
object AddAlarm {
  ...
  implicit def make(companion: AddAlarm.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
