...
import typingsJapgolly.materialUi.svgIconsMapsDirectionsCarMod.default
...
object DirectionsCar {
  ...
  implicit def make(companion: DirectionsCar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
