...
import typingsJapgolly.materialUi.svgIconsNavigationUnfoldMoreMod.default
...
object UnfoldMore {
  ...
  implicit def make(companion: UnfoldMore.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
