...
import typingsJapgolly.materialUi.svgIconsImagePhotoSizeSelectActualMod.default
...
object PhotoSizeSelectActual {
  ...
  implicit def make(companion: PhotoSizeSelectActual.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
