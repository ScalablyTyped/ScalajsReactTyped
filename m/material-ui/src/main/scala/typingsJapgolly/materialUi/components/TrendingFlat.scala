...
import typingsJapgolly.materialUi.svgIconsActionTrendingFlatMod.default
...
object TrendingFlat {
  ...
  implicit def make(companion: TrendingFlat.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
