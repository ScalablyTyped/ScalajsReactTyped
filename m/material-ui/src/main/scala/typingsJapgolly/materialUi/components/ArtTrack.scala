...
import typingsJapgolly.materialUi.svgIconsAvArtTrackMod.default
...
object ArtTrack {
  ...
  implicit def make(companion: ArtTrack.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
