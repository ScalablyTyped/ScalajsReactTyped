...
import typingsJapgolly.materialUi.svgIconsAvMicOffMod.default
...
object MicOff {
  ...
  implicit def make(companion: MicOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
