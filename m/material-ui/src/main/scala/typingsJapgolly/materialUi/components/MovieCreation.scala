...
import typingsJapgolly.materialUi.svgIconsImageMovieCreationMod.default
...
object MovieCreation {
  ...
  implicit def make(companion: MovieCreation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
