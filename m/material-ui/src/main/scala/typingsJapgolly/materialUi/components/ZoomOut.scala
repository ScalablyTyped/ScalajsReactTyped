...
import typingsJapgolly.materialUi.svgIconsActionZoomOutMod.default
...
object ZoomOut {
  ...
  implicit def make(companion: ZoomOut.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
