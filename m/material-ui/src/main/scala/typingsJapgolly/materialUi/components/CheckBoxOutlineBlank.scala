...
import typingsJapgolly.materialUi.svgIconsToggleCheckBoxOutlineBlankMod.default
...
object CheckBoxOutlineBlank {
  ...
  implicit def make(companion: CheckBoxOutlineBlank.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
