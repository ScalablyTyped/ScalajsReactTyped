...
import typingsJapgolly.materialUi.tableMod.default
...
object Table {
  def apply(
    ...
    if (onRowSelection != null) __obj.updateDynamic("onRowSelection")(js.Any.fromFunction1((t0: /* selectedRows */ js.Array[scala.Double] | typingsJapgolly.materialUi.materialUiStrings.all) => onRowSelection(t0).runNow()))
  ...
  typingsJapgolly.materialUi.MaterialUI.Table.TableProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.tableMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.Table.TableProps])(children: _*)
  }
