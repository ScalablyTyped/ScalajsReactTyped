...
import typingsJapgolly.materialUi.svgIconsToggleRadioButtonCheckedMod.default
...
object RadioButtonChecked {
  ...
  implicit def make(companion: RadioButtonChecked.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
