...
import typingsJapgolly.materialUi.svgIconsNotificationWifiMod.default
...
object Wifi {
  ...
  implicit def make(companion: Wifi.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
