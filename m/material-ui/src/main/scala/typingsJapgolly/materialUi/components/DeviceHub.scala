...
import typingsJapgolly.materialUi.svgIconsHardwareDeviceHubMod.default
...
object DeviceHub {
  ...
  implicit def make(companion: DeviceHub.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
