...
import typingsJapgolly.materialUi.svgIconsMapsEvStationMod.default
...
object EvStation {
  ...
  implicit def make(companion: EvStation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
