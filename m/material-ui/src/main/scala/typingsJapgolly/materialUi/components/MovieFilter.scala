...
import typingsJapgolly.materialUi.svgIconsImageMovieFilterMod.default
...
object MovieFilter {
  ...
  implicit def make(companion: MovieFilter.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
