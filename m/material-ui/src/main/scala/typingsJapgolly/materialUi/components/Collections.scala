...
import typingsJapgolly.materialUi.svgIconsImageCollectionsMod.default
...
object Collections {
  ...
  implicit def make(companion: Collections.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
