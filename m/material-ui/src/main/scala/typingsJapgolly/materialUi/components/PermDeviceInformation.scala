...
import typingsJapgolly.materialUi.svgIconsActionPermDeviceInformationMod.default
...
object PermDeviceInformation {
  ...
  implicit def make(companion: PermDeviceInformation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
