...
import typingsJapgolly.materialUi.svgIconsHardwareSpeakerMod.default
...
object Speaker {
  ...
  implicit def make(companion: Speaker.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
