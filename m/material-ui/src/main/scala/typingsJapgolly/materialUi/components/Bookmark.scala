...
import typingsJapgolly.materialUi.svgIconsActionBookmarkMod.default
...
object Bookmark {
  ...
  implicit def make(companion: Bookmark.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
