...
import typingsJapgolly.materialUi.svgIconsImageImageAspectRatioMod.default
...
object ImageAspectRatio {
  ...
  implicit def make(companion: ImageAspectRatio.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
