...
import typingsJapgolly.materialUi.svgIconsImageFlipMod.default
...
object Flip {
  ...
  implicit def make(companion: Flip.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
