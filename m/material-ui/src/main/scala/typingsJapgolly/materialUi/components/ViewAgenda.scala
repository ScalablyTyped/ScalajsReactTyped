...
import typingsJapgolly.materialUi.svgIconsActionViewAgendaMod.default
...
object ViewAgenda {
  ...
  implicit def make(companion: ViewAgenda.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
