...
import typingsJapgolly.materialUi.svgIconsImageFilterBAndWMod.default
...
object FilterBAndW {
  ...
  implicit def make(companion: FilterBAndW.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
