...
import typingsJapgolly.materialUi.svgIconsActionPrintMod.default
...
object Print {
  ...
  implicit def make(companion: Print.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
