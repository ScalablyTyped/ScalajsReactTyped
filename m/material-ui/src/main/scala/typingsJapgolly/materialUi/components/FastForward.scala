...
import typingsJapgolly.materialUi.svgIconsAvFastForwardMod.default
...
object FastForward {
  ...
  implicit def make(companion: FastForward.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
