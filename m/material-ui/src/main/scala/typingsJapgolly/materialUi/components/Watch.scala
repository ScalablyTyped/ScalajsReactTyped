...
import typingsJapgolly.materialUi.svgIconsHardwareWatchMod.default
...
object Watch {
  ...
  implicit def make(companion: Watch.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
