...
import typingsJapgolly.materialUi.svgIconsMapsLocalAtmMod.default
...
object LocalAtm {
  ...
  implicit def make(companion: LocalAtm.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
