...
import typingsJapgolly.materialUi.svgIconsPlacesChildFriendlyMod.default
...
object ChildFriendly {
  ...
  implicit def make(companion: ChildFriendly.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
