...
import typingsJapgolly.materialUi.svgIconsActionOpenInNewMod.default
...
object OpenInNew {
  ...
  implicit def make(companion: OpenInNew.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
