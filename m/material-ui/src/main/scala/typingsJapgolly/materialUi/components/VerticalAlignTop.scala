...
import typingsJapgolly.materialUi.svgIconsEditorVerticalAlignTopMod.default
...
object VerticalAlignTop {
  ...
  implicit def make(companion: VerticalAlignTop.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
