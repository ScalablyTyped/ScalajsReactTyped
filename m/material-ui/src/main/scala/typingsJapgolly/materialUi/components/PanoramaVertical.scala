...
import typingsJapgolly.materialUi.svgIconsImagePanoramaVerticalMod.default
...
object PanoramaVertical {
  ...
  implicit def make(companion: PanoramaVertical.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
