...
import typingsJapgolly.materialUi.svgIconsNavigationArrowDropDownCircleMod.default
...
object ArrowDropDownCircle {
  ...
  implicit def make(companion: ArrowDropDownCircle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
