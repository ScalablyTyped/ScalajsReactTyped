...
import typingsJapgolly.materialUi.svgIconsEditorInsertCommentMod.default
...
object InsertComment {
  ...
  implicit def make(companion: InsertComment.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
