...
import typingsJapgolly.materialUi.svgIconsMapsLocalCarWashMod.default
...
object LocalCarWash {
  ...
  implicit def make(companion: LocalCarWash.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
