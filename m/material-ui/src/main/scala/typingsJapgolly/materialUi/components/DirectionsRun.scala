...
import typingsJapgolly.materialUi.svgIconsMapsDirectionsRunMod.default
...
object DirectionsRun {
  ...
  implicit def make(companion: DirectionsRun.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
