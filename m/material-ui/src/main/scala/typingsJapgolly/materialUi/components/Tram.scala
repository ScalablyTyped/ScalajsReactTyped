...
import typingsJapgolly.materialUi.svgIconsMapsTramMod.default
...
object Tram {
  ...
  implicit def make(companion: Tram.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
