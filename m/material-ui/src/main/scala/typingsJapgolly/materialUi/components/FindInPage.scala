...
import typingsJapgolly.materialUi.svgIconsActionFindInPageMod.default
...
object FindInPage {
  ...
  implicit def make(companion: FindInPage.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
