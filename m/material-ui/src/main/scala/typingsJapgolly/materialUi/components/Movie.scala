...
import typingsJapgolly.materialUi.svgIconsAvMovieMod.default
...
object Movie {
  ...
  implicit def make(companion: Movie.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
