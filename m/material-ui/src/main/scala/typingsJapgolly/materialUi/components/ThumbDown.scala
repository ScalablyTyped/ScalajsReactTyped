...
import typingsJapgolly.materialUi.svgIconsActionThumbDownMod.default
...
object ThumbDown {
  ...
  implicit def make(companion: ThumbDown.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
