...
import typingsJapgolly.materialUi.svgIconsActionUpdateMod.default
...
object Update {
  ...
  implicit def make(companion: Update.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
