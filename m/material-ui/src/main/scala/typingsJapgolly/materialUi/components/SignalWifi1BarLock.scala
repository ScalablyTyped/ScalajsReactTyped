...
import typingsJapgolly.materialUi.svgIconsDeviceSignalWifi1BarLockMod.default
...
object SignalWifi1BarLock {
  ...
  implicit def make(companion: SignalWifi1BarLock.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
