...
import typingsJapgolly.materialUi.svgIconsActionAccountBoxMod.default
...
object AccountBox {
  ...
  implicit def make(companion: AccountBox.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
