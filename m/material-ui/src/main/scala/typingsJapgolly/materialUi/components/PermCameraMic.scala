...
import typingsJapgolly.materialUi.svgIconsActionPermCameraMicMod.default
...
object PermCameraMic {
  ...
  implicit def make(companion: PermCameraMic.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
