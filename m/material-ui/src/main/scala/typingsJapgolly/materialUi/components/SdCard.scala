...
import typingsJapgolly.materialUi.svgIconsNotificationSdCardMod.default
...
object SdCard {
  ...
  implicit def make(companion: SdCard.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
