...
import typingsJapgolly.materialUi.svgIconsActionDescriptionMod.default
...
object Description {
  ...
  implicit def make(companion: Description.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
