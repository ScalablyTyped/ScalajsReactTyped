...
import typingsJapgolly.materialUi.svgIconsActionPermMediaMod.default
...
object PermMedia {
  ...
  implicit def make(companion: PermMedia.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
