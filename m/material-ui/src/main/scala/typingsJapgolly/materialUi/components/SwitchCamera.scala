...
import typingsJapgolly.materialUi.svgIconsImageSwitchCameraMod.default
...
object SwitchCamera {
  ...
  implicit def make(companion: SwitchCamera.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
