...
import typingsJapgolly.materialUi.svgIconsContentInboxMod.default
...
object Inbox {
  ...
  implicit def make(companion: Inbox.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
