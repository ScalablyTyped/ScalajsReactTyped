...
import typingsJapgolly.materialUi.svgIconsHardwareMemoryMod.default
...
object Memory {
  ...
  implicit def make(companion: Memory.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
