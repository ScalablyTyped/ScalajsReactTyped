...
import typingsJapgolly.materialUi.svgIconsCommunicationForumMod.default
...
object Forum {
  ...
  implicit def make(companion: Forum.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
