...
import typingsJapgolly.materialUi.svgIconsActionLabelMod.default
...
object Label {
  ...
  implicit def make(companion: Label.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
