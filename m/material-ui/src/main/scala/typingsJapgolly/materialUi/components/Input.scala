...
import typingsJapgolly.materialUi.svgIconsActionInputMod.default
...
object Input {
  ...
  implicit def make(companion: Input.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
