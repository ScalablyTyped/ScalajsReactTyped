...
import typingsJapgolly.materialUi.svgIconsEditorFormatLineSpacingMod.default
...
object FormatLineSpacing {
  ...
  implicit def make(companion: FormatLineSpacing.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
