...
import typingsJapgolly.materialUi.svgIconsContentBackspaceMod.default
...
object Backspace {
  ...
  implicit def make(companion: Backspace.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
