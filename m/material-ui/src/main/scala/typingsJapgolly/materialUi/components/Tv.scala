...
import typingsJapgolly.materialUi.svgIconsHardwareTvMod.default
...
object Tv {
  ...
  implicit def make(companion: Tv.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
