...
import typingsJapgolly.materialUi.svgIconsActionReceiptMod.default
...
object Receipt {
  ...
  implicit def make(companion: Receipt.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
