...
import typingsJapgolly.materialUi.svgIconsSocialSentimentNeutralMod.default
...
object SentimentNeutral {
  ...
  implicit def make(companion: SentimentNeutral.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
