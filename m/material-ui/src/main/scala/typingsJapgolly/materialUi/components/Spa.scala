...
import typingsJapgolly.materialUi.svgIconsPlacesSpaMod.default
...
object Spa {
  ...
  implicit def make(companion: Spa.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
