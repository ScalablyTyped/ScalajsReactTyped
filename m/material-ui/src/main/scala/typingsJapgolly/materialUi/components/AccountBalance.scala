...
import typingsJapgolly.materialUi.svgIconsActionAccountBalanceMod.default
...
object AccountBalance {
  ...
  implicit def make(companion: AccountBalance.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
