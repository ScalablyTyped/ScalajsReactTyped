...
import typingsJapgolly.materialUi.svgIconsCommunicationContactMailMod.default
...
object ContactMail {
  ...
  implicit def make(companion: ContactMail.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
