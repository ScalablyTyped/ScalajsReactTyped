...
import typingsJapgolly.materialUi.svgIconsAvNoteMod.default
...
object Note {
  ...
  implicit def make(companion: Note.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
