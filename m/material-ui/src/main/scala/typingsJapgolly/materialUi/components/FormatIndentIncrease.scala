...
import typingsJapgolly.materialUi.svgIconsEditorFormatIndentIncreaseMod.default
...
object FormatIndentIncrease {
  ...
  implicit def make(companion: FormatIndentIncrease.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
