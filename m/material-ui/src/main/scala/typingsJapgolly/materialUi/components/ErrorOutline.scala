...
import typingsJapgolly.materialUi.svgIconsAlertErrorOutlineMod.default
...
object ErrorOutline {
  ...
  implicit def make(companion: ErrorOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
