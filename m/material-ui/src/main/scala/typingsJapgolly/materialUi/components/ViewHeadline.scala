...
import typingsJapgolly.materialUi.svgIconsActionViewHeadlineMod.default
...
object ViewHeadline {
  ...
  implicit def make(companion: ViewHeadline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
