...
import typingsJapgolly.materialUi.svgIconsEditorFormatColorResetMod.default
...
object FormatColorReset {
  ...
  implicit def make(companion: FormatColorReset.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
