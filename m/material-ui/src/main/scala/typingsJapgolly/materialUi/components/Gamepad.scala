...
import typingsJapgolly.materialUi.svgIconsHardwareGamepadMod.default
...
object Gamepad {
  ...
  implicit def make(companion: Gamepad.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
