...
import typingsJapgolly.materialUi.svgIconsActionTrendingUpMod.default
...
object TrendingUp {
  ...
  implicit def make(companion: TrendingUp.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
