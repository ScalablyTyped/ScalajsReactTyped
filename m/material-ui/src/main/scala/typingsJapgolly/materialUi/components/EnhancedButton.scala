...
import typingsJapgolly.materialUi.enhancedButtonMod.EnhancedButtonProps
import typingsJapgolly.materialUi.enhancedButtonMod.default
...
object EnhancedButton {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[EnhancedButtonProps, default, Unit, EnhancedButtonProps] = {
  ...
  typingsJapgolly.materialUi.enhancedButtonMod.EnhancedButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.enhancedButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.enhancedButtonMod.EnhancedButtonProps])(children: _*)
  }
