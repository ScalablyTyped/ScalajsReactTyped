...
import typingsJapgolly.materialUi.svgIconsContentClearMod.default
...
object Clear {
  ...
  implicit def make(companion: Clear.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
