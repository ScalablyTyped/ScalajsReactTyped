...
import typingsJapgolly.materialUi.svgIconsMapsLocalTaxiMod.default
...
object LocalTaxi {
  ...
  implicit def make(companion: LocalTaxi.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
