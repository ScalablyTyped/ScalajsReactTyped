...
import typingsJapgolly.materialUi.svgIconsAvVideoLabelMod.default
...
object VideoLabel {
  ...
  implicit def make(companion: VideoLabel.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
