...
import typingsJapgolly.materialUi.svgIconsDeviceScreenLockRotationMod.default
...
object ScreenLockRotation {
  ...
  implicit def make(companion: ScreenLockRotation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
