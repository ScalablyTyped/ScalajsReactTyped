...
import typingsJapgolly.materialUi.svgIconsActionHomeMod.default
...
object Home {
  ...
  implicit def make(companion: Home.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
