...
import typingsJapgolly.materialUi.svgIconsDeviceNetworkWifiMod.default
...
object NetworkWifi {
  ...
  implicit def make(companion: NetworkWifi.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
