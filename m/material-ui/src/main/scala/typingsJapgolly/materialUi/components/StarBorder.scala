...
import typingsJapgolly.materialUi.svgIconsToggleStarBorderMod.default
...
object StarBorder {
  ...
  implicit def make(companion: StarBorder.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
