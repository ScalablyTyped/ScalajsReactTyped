...
import typingsJapgolly.materialUi.svgIconsDeviceSignalCellular2BarMod.default
...
object SignalCellular2Bar {
  ...
  implicit def make(companion: SignalCellular2Bar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
