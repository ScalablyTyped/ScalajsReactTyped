...
import typingsJapgolly.materialUi.svgIconsImageBrokenImageMod.default
...
object BrokenImage {
  ...
  implicit def make(companion: BrokenImage.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
