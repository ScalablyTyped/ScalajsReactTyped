...
import typingsJapgolly.materialUi.svgIconsImageFilterCenterFocusMod.default
...
object FilterCenterFocus {
  ...
  implicit def make(companion: FilterCenterFocus.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
