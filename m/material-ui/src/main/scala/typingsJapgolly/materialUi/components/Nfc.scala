...
import typingsJapgolly.materialUi.svgIconsDeviceNfcMod.default
...
object Nfc {
  ...
  implicit def make(companion: Nfc.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
