...
import typingsJapgolly.materialUi.svgIconsSocialPersonMod.default
...
object Person {
  ...
  implicit def make(companion: Person.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
