...
import typingsJapgolly.materialUi.svgIconsNotificationAirlineSeatReclineNormalMod.default
...
object AirlineSeatReclineNormal {
  ...
  implicit def make(companion: AirlineSeatReclineNormal.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
