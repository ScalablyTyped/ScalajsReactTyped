...
import typingsJapgolly.materialUi.svgIconsFileCloudDoneMod.default
...
object CloudDone {
  ...
  implicit def make(companion: CloudDone.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
