...
import typingsJapgolly.materialUi.svgIconsSocialNotificationsActiveMod.default
...
object NotificationsActive {
  ...
  implicit def make(companion: NotificationsActive.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
