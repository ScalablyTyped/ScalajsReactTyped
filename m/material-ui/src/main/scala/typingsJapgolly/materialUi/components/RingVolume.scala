...
import typingsJapgolly.materialUi.svgIconsCommunicationRingVolumeMod.default
...
object RingVolume {
  ...
  implicit def make(companion: RingVolume.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
