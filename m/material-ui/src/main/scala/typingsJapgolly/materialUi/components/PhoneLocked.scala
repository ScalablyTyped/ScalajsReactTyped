...
import typingsJapgolly.materialUi.svgIconsNotificationPhoneLockedMod.default
...
object PhoneLocked {
  ...
  implicit def make(companion: PhoneLocked.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
