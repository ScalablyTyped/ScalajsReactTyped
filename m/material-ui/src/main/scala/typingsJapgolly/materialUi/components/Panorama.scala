...
import typingsJapgolly.materialUi.svgIconsImagePanoramaMod.default
...
object Panorama {
  ...
  implicit def make(companion: Panorama.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
