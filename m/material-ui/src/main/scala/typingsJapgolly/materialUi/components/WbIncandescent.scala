...
import typingsJapgolly.materialUi.svgIconsImageWbIncandescentMod.default
...
object WbIncandescent {
  ...
  implicit def make(companion: WbIncandescent.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
