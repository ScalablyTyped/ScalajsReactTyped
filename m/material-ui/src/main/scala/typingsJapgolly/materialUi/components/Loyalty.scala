...
import typingsJapgolly.materialUi.svgIconsActionLoyaltyMod.default
...
object Loyalty {
  ...
  implicit def make(companion: Loyalty.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
