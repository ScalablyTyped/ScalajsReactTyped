...
import typingsJapgolly.materialUi.svgIconsHardwareVideogameAssetMod.default
...
object VideogameAsset {
  ...
  implicit def make(companion: VideogameAsset.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
