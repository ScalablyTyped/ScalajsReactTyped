...
import typingsJapgolly.materialUi.svgIconsCommunicationLiveHelpMod.default
...
object LiveHelp {
  ...
  implicit def make(companion: LiveHelp.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
