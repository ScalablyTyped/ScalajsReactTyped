...
import typingsJapgolly.materialUi.svgIconsImagePhotoLibraryMod.default
...
object PhotoLibrary {
  ...
  implicit def make(companion: PhotoLibrary.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
