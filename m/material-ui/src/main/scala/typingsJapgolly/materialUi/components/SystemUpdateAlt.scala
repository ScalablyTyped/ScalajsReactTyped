...
import typingsJapgolly.materialUi.svgIconsActionSystemUpdateAltMod.default
...
object SystemUpdateAlt {
  ...
  implicit def make(companion: SystemUpdateAlt.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
