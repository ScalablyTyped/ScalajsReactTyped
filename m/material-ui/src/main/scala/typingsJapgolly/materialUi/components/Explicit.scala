...
import typingsJapgolly.materialUi.svgIconsAvExplicitMod.default
...
object Explicit {
  ...
  implicit def make(companion: Explicit.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
