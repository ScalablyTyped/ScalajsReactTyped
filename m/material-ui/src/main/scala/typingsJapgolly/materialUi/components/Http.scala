...
import typingsJapgolly.materialUi.svgIconsActionHttpMod.default
...
object Http {
  ...
  implicit def make(companion: Http.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
