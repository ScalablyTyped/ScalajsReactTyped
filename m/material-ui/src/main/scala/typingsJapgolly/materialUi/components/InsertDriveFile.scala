...
import typingsJapgolly.materialUi.svgIconsEditorInsertDriveFileMod.default
...
object InsertDriveFile {
  ...
  implicit def make(companion: InsertDriveFile.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
