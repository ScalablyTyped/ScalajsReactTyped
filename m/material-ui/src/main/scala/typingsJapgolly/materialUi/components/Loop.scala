...
import typingsJapgolly.materialUi.svgIconsAvLoopMod.default
...
object Loop {
  ...
  implicit def make(companion: Loop.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
