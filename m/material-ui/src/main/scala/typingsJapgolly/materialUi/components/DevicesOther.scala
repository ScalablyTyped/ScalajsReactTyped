...
import typingsJapgolly.materialUi.svgIconsHardwareDevicesOtherMod.default
...
object DevicesOther {
  ...
  implicit def make(companion: DevicesOther.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
