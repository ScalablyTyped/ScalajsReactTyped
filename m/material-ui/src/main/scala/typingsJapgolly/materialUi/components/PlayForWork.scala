...
import typingsJapgolly.materialUi.svgIconsActionPlayForWorkMod.default
...
object PlayForWork {
  ...
  implicit def make(companion: PlayForWork.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
