...
import typingsJapgolly.materialUi.svgIconsImageCrop75Mod.default
...
object Crop75 {
  ...
  implicit def make(companion: Crop75.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
