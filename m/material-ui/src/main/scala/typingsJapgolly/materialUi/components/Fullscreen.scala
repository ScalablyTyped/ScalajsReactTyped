...
import typingsJapgolly.materialUi.svgIconsNavigationFullscreenMod.default
...
object Fullscreen {
  ...
  implicit def make(companion: Fullscreen.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
