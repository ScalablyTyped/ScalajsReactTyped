...
abstract class SharedApply_MenuItemProps330027212 () {
  ...
  def apply(
    ...
    onNestedListToggle: /* item */ typingsJapgolly.materialUi.MaterialUI.List.ListItem => Callback = null,
    ...
    MenuItemProps, 
    MountedWithRawType[MenuItemProps, js.Object, RawMounted[MenuItemProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.materialUi.MaterialUI.Menus.MenuItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.Menus.MenuItemProps])(children: _*)
  }
}
