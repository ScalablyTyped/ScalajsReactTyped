...
import typingsJapgolly.materialUi.svgIconsNotificationVpnLockMod.default
...
object VpnLock {
  ...
  implicit def make(companion: VpnLock.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
