...
import typingsJapgolly.materialUi.svgIconsMapsRestaurantMenuMod.default
...
object RestaurantMenu {
  ...
  implicit def make(companion: RestaurantMenu.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
