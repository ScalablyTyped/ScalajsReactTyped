...
import typingsJapgolly.materialUi.svgIconsPlacesBusinessCenterMod.default
...
object BusinessCenter {
  ...
  implicit def make(companion: BusinessCenter.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
