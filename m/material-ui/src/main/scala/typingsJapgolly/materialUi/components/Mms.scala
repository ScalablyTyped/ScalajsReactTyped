...
import typingsJapgolly.materialUi.svgIconsNotificationMmsMod.default
...
object Mms {
  ...
  implicit def make(companion: Mms.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
