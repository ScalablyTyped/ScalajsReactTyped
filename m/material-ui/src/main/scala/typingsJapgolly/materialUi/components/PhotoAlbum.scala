...
import typingsJapgolly.materialUi.svgIconsImagePhotoAlbumMod.default
...
object PhotoAlbum {
  ...
  implicit def make(companion: PhotoAlbum.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
