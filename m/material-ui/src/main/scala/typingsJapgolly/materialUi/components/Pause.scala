...
import typingsJapgolly.materialUi.svgIconsAvPauseMod.default
...
object Pause {
  ...
  implicit def make(companion: Pause.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
