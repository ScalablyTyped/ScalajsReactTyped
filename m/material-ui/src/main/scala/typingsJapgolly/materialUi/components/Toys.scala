...
import typingsJapgolly.materialUi.svgIconsHardwareToysMod.default
...
object Toys {
  ...
  implicit def make(companion: Toys.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
