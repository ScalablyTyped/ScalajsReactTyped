...
import typingsJapgolly.materialUi.toolbarTitleMod.default
...
object ToolbarTitle {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ToolbarTitleProps, default, Unit, ToolbarTitleProps] = {
  ...
  typingsJapgolly.materialUi.MaterialUI.Toolbar.ToolbarTitleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.toolbarTitleMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.Toolbar.ToolbarTitleProps])(children: _*)
  }
