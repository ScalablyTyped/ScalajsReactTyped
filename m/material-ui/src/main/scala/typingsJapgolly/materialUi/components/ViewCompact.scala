...
import typingsJapgolly.materialUi.svgIconsImageViewCompactMod.default
...
object ViewCompact {
  ...
  implicit def make(companion: ViewCompact.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
