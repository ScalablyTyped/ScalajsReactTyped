...
import typingsJapgolly.materialUi.svgIconsImageHealingMod.default
...
object Healing {
  ...
  implicit def make(companion: Healing.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
