...
import typingsJapgolly.materialUi.svgIconsActionDoneMod.default
...
object Done {
  ...
  implicit def make(companion: Done.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
