...
import typingsJapgolly.materialUi.svgIconsAlertAddAlertMod.default
...
object AddAlert {
  ...
  implicit def make(companion: AddAlert.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
