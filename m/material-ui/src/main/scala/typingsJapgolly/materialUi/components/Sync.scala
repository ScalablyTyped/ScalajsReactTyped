...
import typingsJapgolly.materialUi.svgIconsNotificationSyncMod.default
...
object Sync {
  ...
  implicit def make(companion: Sync.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
