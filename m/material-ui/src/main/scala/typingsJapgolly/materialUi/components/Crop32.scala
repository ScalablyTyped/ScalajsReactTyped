...
import typingsJapgolly.materialUi.svgIconsImageCrop32Mod.default
...
object Crop32 {
  ...
  implicit def make(companion: Crop32.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
