...
import typingsJapgolly.materialUi.svgIconsImageStraightenMod.default
...
object Straighten {
  ...
  implicit def make(companion: Straighten.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
