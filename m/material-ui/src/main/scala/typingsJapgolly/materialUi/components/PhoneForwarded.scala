...
import typingsJapgolly.materialUi.svgIconsNotificationPhoneForwardedMod.default
...
object PhoneForwarded {
  ...
  implicit def make(companion: PhoneForwarded.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
