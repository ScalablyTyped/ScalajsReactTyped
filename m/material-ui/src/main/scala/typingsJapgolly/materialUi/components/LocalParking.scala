...
import typingsJapgolly.materialUi.svgIconsMapsLocalParkingMod.default
...
object LocalParking {
  ...
  implicit def make(companion: LocalParking.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
