...
import typingsJapgolly.materialUi.svgIconsActionSpeakerNotesMod.default
...
object SpeakerNotes {
  ...
  implicit def make(companion: SpeakerNotes.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
