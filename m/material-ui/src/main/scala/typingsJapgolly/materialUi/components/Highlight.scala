...
import typingsJapgolly.materialUi.svgIconsEditorHighlightMod.default
...
object Highlight {
  ...
  implicit def make(companion: Highlight.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
