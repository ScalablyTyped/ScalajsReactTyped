...
import typingsJapgolly.materialUi.svgIconsActionLightbulbOutlineMod.default
...
object LightbulbOutline {
  ...
  implicit def make(companion: LightbulbOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
