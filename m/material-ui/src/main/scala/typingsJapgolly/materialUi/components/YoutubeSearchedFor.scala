...
import typingsJapgolly.materialUi.svgIconsActionYoutubeSearchedForMod.default
...
object YoutubeSearchedFor {
  ...
  implicit def make(companion: YoutubeSearchedFor.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
