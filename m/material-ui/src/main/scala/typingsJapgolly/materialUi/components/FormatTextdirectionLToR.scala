...
import typingsJapgolly.materialUi.svgIconsEditorFormatTextdirectionLToRMod.default
...
object FormatTextdirectionLToR {
  ...
  implicit def make(companion: FormatTextdirectionLToR.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
