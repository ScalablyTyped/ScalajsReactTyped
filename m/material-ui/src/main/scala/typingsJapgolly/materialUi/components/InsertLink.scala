...
import typingsJapgolly.materialUi.svgIconsEditorInsertLinkMod.default
...
object InsertLink {
  ...
  implicit def make(companion: InsertLink.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
