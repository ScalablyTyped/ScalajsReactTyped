...
import typingsJapgolly.materialUi.svgIconsContentSortMod.default
...
object Sort {
  ...
  implicit def make(companion: Sort.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
