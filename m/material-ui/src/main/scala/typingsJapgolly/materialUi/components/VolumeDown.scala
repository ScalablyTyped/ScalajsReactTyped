...
import typingsJapgolly.materialUi.svgIconsAvVolumeDownMod.default
...
object VolumeDown {
  ...
  implicit def make(companion: VolumeDown.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
