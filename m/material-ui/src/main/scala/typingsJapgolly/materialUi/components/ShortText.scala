...
import typingsJapgolly.materialUi.svgIconsEditorShortTextMod.default
...
object ShortText {
  ...
  implicit def make(companion: ShortText.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
