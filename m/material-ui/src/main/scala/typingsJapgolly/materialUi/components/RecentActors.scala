...
import typingsJapgolly.materialUi.svgIconsAvRecentActorsMod.default
...
object RecentActors {
  ...
  implicit def make(companion: RecentActors.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
