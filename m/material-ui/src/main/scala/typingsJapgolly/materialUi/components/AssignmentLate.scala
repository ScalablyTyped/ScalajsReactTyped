...
import typingsJapgolly.materialUi.svgIconsActionAssignmentLateMod.default
...
object AssignmentLate {
  ...
  implicit def make(companion: AssignmentLate.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
