...
import typingsJapgolly.materialUi.svgIconsAvPlayCircleOutlineMod.default
...
object PlayCircleOutline {
  ...
  implicit def make(companion: PlayCircleOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
