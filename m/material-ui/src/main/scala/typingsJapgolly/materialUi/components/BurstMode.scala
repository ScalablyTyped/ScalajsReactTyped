...
import typingsJapgolly.materialUi.svgIconsImageBurstModeMod.default
...
object BurstMode {
  ...
  implicit def make(companion: BurstMode.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
