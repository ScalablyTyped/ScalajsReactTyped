...
import typingsJapgolly.materialUi.svgIconsActionFlightTakeoffMod.default
...
object FlightTakeoff {
  ...
  implicit def make(companion: FlightTakeoff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
