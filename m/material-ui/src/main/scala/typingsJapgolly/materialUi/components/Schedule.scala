...
import typingsJapgolly.materialUi.svgIconsActionScheduleMod.default
...
object Schedule {
  ...
  implicit def make(companion: Schedule.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
