...
import typingsJapgolly.materialUi.svgIconsNotificationNetworkCheckMod.default
...
object NetworkCheck {
  ...
  implicit def make(companion: NetworkCheck.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
