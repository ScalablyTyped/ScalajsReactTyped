...
import typingsJapgolly.materialUi.svgIconsFileFileDownloadMod.default
...
object FileDownload {
  ...
  implicit def make(companion: FileDownload.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
