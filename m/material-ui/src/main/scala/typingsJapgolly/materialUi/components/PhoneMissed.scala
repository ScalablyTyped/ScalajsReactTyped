...
import typingsJapgolly.materialUi.svgIconsNotificationPhoneMissedMod.default
...
object PhoneMissed {
  ...
  implicit def make(companion: PhoneMissed.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
