...
import typingsJapgolly.materialUi.svgIconsAvFiberPinMod.default
...
object FiberPin {
  ...
  implicit def make(companion: FiberPin.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
