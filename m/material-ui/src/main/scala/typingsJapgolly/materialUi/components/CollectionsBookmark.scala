...
import typingsJapgolly.materialUi.svgIconsImageCollectionsBookmarkMod.default
...
object CollectionsBookmark {
  ...
  implicit def make(companion: CollectionsBookmark.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
