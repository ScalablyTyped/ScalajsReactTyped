...
import typingsJapgolly.materialUi.svgIconsActionSettingsVoiceMod.default
...
object SettingsVoice {
  ...
  implicit def make(companion: SettingsVoice.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
