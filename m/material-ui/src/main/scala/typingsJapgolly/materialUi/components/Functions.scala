...
import typingsJapgolly.materialUi.svgIconsEditorFunctionsMod.default
...
object Functions {
  ...
  implicit def make(companion: Functions.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
