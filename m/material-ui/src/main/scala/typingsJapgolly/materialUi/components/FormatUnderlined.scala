...
import typingsJapgolly.materialUi.svgIconsEditorFormatUnderlinedMod.default
...
object FormatUnderlined {
  ...
  implicit def make(companion: FormatUnderlined.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
