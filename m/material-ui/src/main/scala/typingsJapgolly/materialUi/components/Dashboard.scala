...
import typingsJapgolly.materialUi.svgIconsActionDashboardMod.default
...
object Dashboard {
  ...
  implicit def make(companion: Dashboard.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
