...
import typingsJapgolly.materialUi.svgIconsActionAlarmOffMod.default
...
object AlarmOff {
  ...
  implicit def make(companion: AlarmOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
