...
import typingsJapgolly.materialUi.paperMod.default
...
object Paper {
  ...
  typingsJapgolly.materialUi.MaterialUI.PaperProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.paperMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.PaperProps])(children: _*)
  }
