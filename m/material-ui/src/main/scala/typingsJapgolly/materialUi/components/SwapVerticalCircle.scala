...
import typingsJapgolly.materialUi.svgIconsActionSwapVerticalCircleMod.default
...
object SwapVerticalCircle {
  ...
  implicit def make(companion: SwapVerticalCircle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
