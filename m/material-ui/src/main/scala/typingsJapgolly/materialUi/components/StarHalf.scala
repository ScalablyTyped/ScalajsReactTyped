...
import typingsJapgolly.materialUi.svgIconsToggleStarHalfMod.default
...
object StarHalf {
  ...
  implicit def make(companion: StarHalf.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
