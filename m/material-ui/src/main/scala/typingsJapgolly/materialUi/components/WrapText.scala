...
import typingsJapgolly.materialUi.svgIconsEditorWrapTextMod.default
...
object WrapText {
  ...
  implicit def make(companion: WrapText.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
