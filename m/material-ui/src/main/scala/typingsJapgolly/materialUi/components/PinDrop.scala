...
import typingsJapgolly.materialUi.svgIconsMapsPinDropMod.default
...
object PinDrop {
  ...
  implicit def make(companion: PinDrop.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
