...
import typingsJapgolly.materialUi.svgIconsEditorInsertPhotoMod.default
...
object InsertPhoto {
  ...
  implicit def make(companion: InsertPhoto.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
