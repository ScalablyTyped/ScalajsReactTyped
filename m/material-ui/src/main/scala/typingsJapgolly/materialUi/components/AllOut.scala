...
import typingsJapgolly.materialUi.svgIconsActionAllOutMod.default
...
object AllOut {
  ...
  implicit def make(companion: AllOut.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
