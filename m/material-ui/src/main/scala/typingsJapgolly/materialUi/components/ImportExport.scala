...
import typingsJapgolly.materialUi.svgIconsCommunicationImportExportMod.default
...
object ImportExport {
  ...
  implicit def make(companion: ImportExport.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
