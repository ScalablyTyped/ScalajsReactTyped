...
import typingsJapgolly.materialUi.svgIconsActionHourglassFullMod.default
...
object HourglassFull {
  ...
  implicit def make(companion: HourglassFull.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
