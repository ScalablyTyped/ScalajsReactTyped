...
import typingsJapgolly.materialUi.svgIconsCommunicationMessageMod.default
...
object Message {
  ...
  implicit def make(companion: Message.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
