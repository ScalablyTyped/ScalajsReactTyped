...
import typingsJapgolly.materialUi.svgIconsMapsLocalAirportMod.default
...
object LocalAirport {
  ...
  implicit def make(companion: LocalAirport.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
