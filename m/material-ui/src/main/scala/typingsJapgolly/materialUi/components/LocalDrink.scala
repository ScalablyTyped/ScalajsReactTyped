...
import typingsJapgolly.materialUi.svgIconsMapsLocalDrinkMod.default
...
object LocalDrink {
  ...
  implicit def make(companion: LocalDrink.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
