...
import typingsJapgolly.materialUi.svgIconsActionLineStyleMod.default
...
object LineStyle {
  ...
  implicit def make(companion: LineStyle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
