...
import typingsJapgolly.materialUi.svgIconsHardwarePhoneAndroidMod.default
...
object PhoneAndroid {
  ...
  implicit def make(companion: PhoneAndroid.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
