...
import typingsJapgolly.materialUi.svgIconsActionRowingMod.default
...
object Rowing {
  ...
  implicit def make(companion: Rowing.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
