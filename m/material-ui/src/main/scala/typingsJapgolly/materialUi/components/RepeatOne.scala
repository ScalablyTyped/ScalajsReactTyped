...
import typingsJapgolly.materialUi.svgIconsAvRepeatOneMod.default
...
object RepeatOne {
  ...
  implicit def make(companion: RepeatOne.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
