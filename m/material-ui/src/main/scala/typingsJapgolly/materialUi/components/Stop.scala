...
import typingsJapgolly.materialUi.svgIconsAvStopMod.default
...
object Stop {
  ...
  implicit def make(companion: Stop.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
