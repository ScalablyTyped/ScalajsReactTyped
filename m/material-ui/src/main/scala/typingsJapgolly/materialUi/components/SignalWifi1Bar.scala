...
import typingsJapgolly.materialUi.svgIconsDeviceSignalWifi1BarMod.default
...
object SignalWifi1Bar {
  ...
  implicit def make(companion: SignalWifi1Bar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
