...
import typingsJapgolly.materialUi.svgIconsNotificationEventNoteMod.default
...
object EventNote {
  ...
  implicit def make(companion: EventNote.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
