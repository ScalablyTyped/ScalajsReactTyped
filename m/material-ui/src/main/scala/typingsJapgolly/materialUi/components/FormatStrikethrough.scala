...
import typingsJapgolly.materialUi.svgIconsEditorFormatStrikethroughMod.default
...
object FormatStrikethrough {
  ...
  implicit def make(companion: FormatStrikethrough.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
