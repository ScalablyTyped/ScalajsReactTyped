...
import typingsJapgolly.materialUi.svgIconsAvHighQualityMod.default
...
object HighQuality {
  ...
  implicit def make(companion: HighQuality.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
