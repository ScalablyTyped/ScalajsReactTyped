...
import typingsJapgolly.materialUi.svgIconsAvCallToActionMod.default
...
object CallToAction {
  ...
  implicit def make(companion: CallToAction.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
