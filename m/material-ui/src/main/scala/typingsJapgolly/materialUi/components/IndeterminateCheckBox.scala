...
import typingsJapgolly.materialUi.svgIconsToggleIndeterminateCheckBoxMod.default
...
object IndeterminateCheckBox {
  ...
  implicit def make(companion: IndeterminateCheckBox.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
