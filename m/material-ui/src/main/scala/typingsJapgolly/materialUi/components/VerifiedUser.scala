...
import typingsJapgolly.materialUi.svgIconsActionVerifiedUserMod.default
...
object VerifiedUser {
  ...
  implicit def make(companion: VerifiedUser.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
