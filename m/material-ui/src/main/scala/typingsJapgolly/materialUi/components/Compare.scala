...
import typingsJapgolly.materialUi.svgIconsImageCompareMod.default
...
object Compare {
  ...
  implicit def make(companion: Compare.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
