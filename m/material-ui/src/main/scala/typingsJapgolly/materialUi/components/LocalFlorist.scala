...
import typingsJapgolly.materialUi.svgIconsMapsLocalFloristMod.default
...
object LocalFlorist {
  ...
  implicit def make(companion: LocalFlorist.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
