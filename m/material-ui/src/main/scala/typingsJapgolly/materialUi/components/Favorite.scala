...
import typingsJapgolly.materialUi.svgIconsActionFavoriteMod.default
...
object Favorite {
  ...
  implicit def make(companion: Favorite.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
