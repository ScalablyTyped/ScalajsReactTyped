...
import typingsJapgolly.materialUi.svgIconsImagePhotoMod.default
...
object Photo {
  ...
  implicit def make(companion: Photo.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
