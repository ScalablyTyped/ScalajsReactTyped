...
import typingsJapgolly.materialUi.svgIconsHardwareTabletAndroidMod.default
...
object TabletAndroid {
  ...
  implicit def make(companion: TabletAndroid.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
