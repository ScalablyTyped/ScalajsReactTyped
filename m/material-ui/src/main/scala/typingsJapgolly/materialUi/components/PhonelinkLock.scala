...
import typingsJapgolly.materialUi.svgIconsCommunicationPhonelinkLockMod.default
...
object PhonelinkLock {
  ...
  implicit def make(companion: PhonelinkLock.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
