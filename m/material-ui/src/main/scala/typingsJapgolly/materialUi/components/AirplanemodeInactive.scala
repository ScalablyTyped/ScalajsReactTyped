...
import typingsJapgolly.materialUi.svgIconsDeviceAirplanemodeInactiveMod.default
...
object AirplanemodeInactive {
  ...
  implicit def make(companion: AirplanemodeInactive.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
