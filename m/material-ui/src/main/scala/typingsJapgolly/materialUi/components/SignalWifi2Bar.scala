...
import typingsJapgolly.materialUi.svgIconsDeviceSignalWifi2BarMod.default
...
object SignalWifi2Bar {
  ...
  implicit def make(companion: SignalWifi2Bar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
