...
import typingsJapgolly.materialUi.svgIconsImageExposurePlus2Mod.default
...
object ExposurePlus2 {
  ...
  implicit def make(companion: ExposurePlus2.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
