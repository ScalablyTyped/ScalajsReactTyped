...
import typingsJapgolly.materialUi.svgIconsActionPermContactCalendarMod.default
...
object PermContactCalendar {
  ...
  implicit def make(companion: PermContactCalendar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
