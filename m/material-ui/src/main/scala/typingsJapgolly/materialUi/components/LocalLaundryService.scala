...
import typingsJapgolly.materialUi.svgIconsMapsLocalLaundryServiceMod.default
...
object LocalLaundryService {
  ...
  implicit def make(companion: LocalLaundryService.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
