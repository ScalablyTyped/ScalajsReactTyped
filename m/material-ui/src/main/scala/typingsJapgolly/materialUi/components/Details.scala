...
import typingsJapgolly.materialUi.svgIconsImageDetailsMod.default
...
object Details {
  ...
  implicit def make(companion: Details.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
