...
import typingsJapgolly.materialUi.svgIconsHardwareKeyboardArrowDownMod.default
...
object KeyboardArrowDown {
  ...
  implicit def make(companion: KeyboardArrowDown.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
