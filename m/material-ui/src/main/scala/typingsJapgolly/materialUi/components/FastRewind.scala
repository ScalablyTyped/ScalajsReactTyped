...
import typingsJapgolly.materialUi.svgIconsAvFastRewindMod.default
...
object FastRewind {
  ...
  implicit def make(companion: FastRewind.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
