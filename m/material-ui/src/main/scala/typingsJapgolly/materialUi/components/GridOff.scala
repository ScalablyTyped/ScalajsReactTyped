...
import typingsJapgolly.materialUi.svgIconsImageGridOffMod.default
...
object GridOff {
  ...
  implicit def make(companion: GridOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
