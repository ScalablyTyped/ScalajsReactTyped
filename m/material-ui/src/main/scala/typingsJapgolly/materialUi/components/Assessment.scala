...
import typingsJapgolly.materialUi.svgIconsActionAssessmentMod.default
...
object Assessment {
  ...
  implicit def make(companion: Assessment.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
