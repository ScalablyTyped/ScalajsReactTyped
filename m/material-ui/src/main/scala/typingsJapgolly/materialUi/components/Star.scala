...
import typingsJapgolly.materialUi.svgIconsToggleStarMod.default
...
object Star {
  ...
  implicit def make(companion: Star.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
