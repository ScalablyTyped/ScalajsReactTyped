...
import typingsJapgolly.materialUi.svgIconsActionFaceMod.default
...
object Face {
  ...
  implicit def make(companion: Face.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
