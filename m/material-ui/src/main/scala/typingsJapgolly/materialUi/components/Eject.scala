...
import typingsJapgolly.materialUi.svgIconsActionEjectMod.default
...
object Eject {
  ...
  implicit def make(companion: Eject.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
