...
import typingsJapgolly.materialUi.svgIconsActionRedeemMod.default
...
object Redeem {
  ...
  implicit def make(companion: Redeem.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
