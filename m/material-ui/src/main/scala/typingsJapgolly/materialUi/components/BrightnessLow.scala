...
import typingsJapgolly.materialUi.svgIconsDeviceBrightnessLowMod.default
...
object BrightnessLow {
  ...
  implicit def make(companion: BrightnessLow.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
