...
import typingsJapgolly.materialUi.svgIconsActionFingerprintMod.default
...
object Fingerprint {
  ...
  implicit def make(companion: Fingerprint.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
