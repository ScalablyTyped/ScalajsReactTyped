...
import typingsJapgolly.materialUi.svgIconsActionGTranslateMod.default
...
object GTranslate {
  ...
  implicit def make(companion: GTranslate.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
