...
import typingsJapgolly.materialUi.svgIconsImageRemoveRedEyeMod.default
...
object RemoveRedEye {
  ...
  implicit def make(companion: RemoveRedEye.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
