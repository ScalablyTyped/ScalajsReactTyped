...
import typingsJapgolly.materialUi.svgIconsImagePaletteMod.default
...
object Palette {
  ...
  implicit def make(companion: Palette.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
