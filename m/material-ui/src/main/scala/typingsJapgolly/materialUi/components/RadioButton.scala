...
import typingsJapgolly.materialUi.MaterialUI.Switches.RadioButtonProps
import typingsJapgolly.materialUi.radioButtonMod.default
...
object RadioButton {
  def apply(
    ...
    onCheck: (/* e */ ReactEventFrom[js.Object with Element], /* selected */ String) => Callback = null,
    ...
    `type`: String = null,
    typeof: String = null,
    uncheckedIcon: VdomElement = null,
    ...
    if (checkedIcon != null) __obj.updateDynamic("checkedIcon")(checkedIcon.rawElement.asInstanceOf[js.Any])
    ...
    if (onCheck != null) __obj.updateDynamic("onCheck")(js.Any.fromFunction2((t0: /* e */ japgolly.scalajs.react.ReactEventFrom[js.Object with org.scalajs.dom.raw.Element], t1: /* selected */ java.lang.String) => onCheck(t0, t1).runNow()))
    ...
    if (uncheckedIcon != null) __obj.updateDynamic("uncheckedIcon")(uncheckedIcon.rawElement.asInstanceOf[js.Any])
  ...
  typingsJapgolly.materialUi.MaterialUI.Switches.RadioButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.radioButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.Switches.RadioButtonProps])(children: _*)
  }
