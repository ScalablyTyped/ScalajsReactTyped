...
object RadioButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.materialUi.mod.RadioButton] {
    ...
    ): this.type = set("onCheck", js.Any.fromFunction2((t0: /* e */ ReactEventFrom[js.Object & org.scalajs.dom.Element], t1: /* selected */ String) => (value(t0, t1)).runNow()))
