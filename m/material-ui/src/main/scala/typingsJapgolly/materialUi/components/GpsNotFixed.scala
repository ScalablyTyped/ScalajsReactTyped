...
import typingsJapgolly.materialUi.svgIconsDeviceGpsNotFixedMod.default
...
object GpsNotFixed {
  ...
  implicit def make(companion: GpsNotFixed.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
