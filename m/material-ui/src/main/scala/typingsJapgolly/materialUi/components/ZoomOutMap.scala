...
import typingsJapgolly.materialUi.svgIconsMapsZoomOutMapMod.default
...
object ZoomOutMap {
  ...
  implicit def make(companion: ZoomOutMap.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
