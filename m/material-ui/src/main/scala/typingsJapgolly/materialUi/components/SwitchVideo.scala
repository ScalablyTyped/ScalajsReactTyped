...
import typingsJapgolly.materialUi.svgIconsImageSwitchVideoMod.default
...
object SwitchVideo {
  ...
  implicit def make(companion: SwitchVideo.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
