...
import typingsJapgolly.materialUi.svgIconsNavigationChevronRightMod.default
...
object ChevronRight {
  ...
  implicit def make(companion: ChevronRight.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
