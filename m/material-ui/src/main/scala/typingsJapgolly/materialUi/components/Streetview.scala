...
import typingsJapgolly.materialUi.svgIconsMapsStreetviewMod.default
...
object Streetview {
  ...
  implicit def make(companion: Streetview.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
