...
import typingsJapgolly.materialUi.listItemMod.default
...
object ListItem {
  ...
  typingsJapgolly.materialUi.MaterialUI.List.ListItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.listItemMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.List.ListItemProps])(children: _*)
  }
