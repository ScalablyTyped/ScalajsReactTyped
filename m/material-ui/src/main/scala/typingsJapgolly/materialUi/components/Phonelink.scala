...
import typingsJapgolly.materialUi.svgIconsHardwarePhonelinkMod.default
...
object Phonelink {
  ...
  implicit def make(companion: Phonelink.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
