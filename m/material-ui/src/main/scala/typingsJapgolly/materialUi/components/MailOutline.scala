...
import typingsJapgolly.materialUi.svgIconsCommunicationMailOutlineMod.default
...
object MailOutline {
  ...
  implicit def make(companion: MailOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
