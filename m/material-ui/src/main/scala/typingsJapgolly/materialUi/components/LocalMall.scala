...
import typingsJapgolly.materialUi.svgIconsMapsLocalMallMod.default
...
object LocalMall {
  ...
  implicit def make(companion: LocalMall.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
