...
import typingsJapgolly.materialUi.svgIconsImageExposureZeroMod.default
...
object ExposureZero {
  ...
  implicit def make(companion: ExposureZero.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
