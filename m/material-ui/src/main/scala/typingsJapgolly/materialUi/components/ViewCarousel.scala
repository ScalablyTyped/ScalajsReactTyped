...
import typingsJapgolly.materialUi.svgIconsActionViewCarouselMod.default
...
object ViewCarousel {
  ...
  implicit def make(companion: ViewCarousel.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
