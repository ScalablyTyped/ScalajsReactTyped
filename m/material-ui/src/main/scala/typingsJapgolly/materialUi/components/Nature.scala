...
import typingsJapgolly.materialUi.svgIconsImageNatureMod.default
...
object Nature {
  ...
  implicit def make(companion: Nature.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
