...
import typingsJapgolly.materialUi.svgIconsAvVideocamMod.default
...
object Videocam {
  ...
  implicit def make(companion: Videocam.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
