...
import typingsJapgolly.materialUi.svgIconsImageTimelapseMod.default
...
object Timelapse {
  ...
  implicit def make(companion: Timelapse.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
