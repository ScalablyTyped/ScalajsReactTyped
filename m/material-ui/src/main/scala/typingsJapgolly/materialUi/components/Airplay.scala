...
import typingsJapgolly.materialUi.svgIconsAvAirplayMod.default
...
object Airplay {
  ...
  implicit def make(companion: Airplay.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
