...
import typingsJapgolly.materialUi.svgIconsImagePictureAsPdfMod.default
...
object PictureAsPdf {
  ...
  implicit def make(companion: PictureAsPdf.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
