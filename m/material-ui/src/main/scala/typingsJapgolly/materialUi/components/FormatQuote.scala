...
import typingsJapgolly.materialUi.svgIconsEditorFormatQuoteMod.default
...
object FormatQuote {
  ...
  implicit def make(companion: FormatQuote.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
