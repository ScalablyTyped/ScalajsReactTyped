...
import typingsJapgolly.materialUi.svgIconsMapsLocalCafeMod.default
...
object LocalCafe {
  ...
  implicit def make(companion: LocalCafe.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
