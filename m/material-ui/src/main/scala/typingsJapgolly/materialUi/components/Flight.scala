...
import typingsJapgolly.materialUi.svgIconsMapsFlightMod.default
...
object Flight {
  ...
  implicit def make(companion: Flight.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
