...
import typingsJapgolly.materialUi.svgIconsImagePanoramaFishEyeMod.default
...
object PanoramaFishEye {
  ...
  implicit def make(companion: PanoramaFishEye.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
