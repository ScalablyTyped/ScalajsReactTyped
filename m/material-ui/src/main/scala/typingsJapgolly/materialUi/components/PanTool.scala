...
import typingsJapgolly.materialUi.svgIconsActionPanToolMod.default
...
object PanTool {
  ...
  implicit def make(companion: PanTool.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
