...
import typingsJapgolly.materialUi.svgIconsActionCheckCircleMod.default
...
object CheckCircle {
  ...
  implicit def make(companion: CheckCircle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
