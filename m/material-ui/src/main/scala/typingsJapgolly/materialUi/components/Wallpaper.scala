...
import typingsJapgolly.materialUi.svgIconsDeviceWallpaperMod.default
...
object Wallpaper {
  ...
  implicit def make(companion: Wallpaper.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
