...
import typingsJapgolly.materialUi.svgIconsSocialPeopleMod.default
...
object People {
  ...
  implicit def make(companion: People.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
