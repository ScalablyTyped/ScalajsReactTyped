...
import typingsJapgolly.materialUi.svgIconsHardwareLaptopMacMod.default
...
object LaptopMac {
  ...
  implicit def make(companion: LaptopMac.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
