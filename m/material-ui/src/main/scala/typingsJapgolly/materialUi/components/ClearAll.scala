...
import typingsJapgolly.materialUi.svgIconsCommunicationClearAllMod.default
...
object ClearAll {
  ...
  implicit def make(companion: ClearAll.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
