...
import typingsJapgolly.materialUi.svgIconsContentFlagMod.default
...
object Flag {
  ...
  implicit def make(companion: Flag.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
