...
import typingsJapgolly.materialUi.svgIconsContentAddCircleMod.default
...
object AddCircle {
  ...
  implicit def make(companion: AddCircle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
