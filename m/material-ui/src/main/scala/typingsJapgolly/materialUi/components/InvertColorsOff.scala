...
import typingsJapgolly.materialUi.svgIconsCommunicationInvertColorsOffMod.default
...
object InvertColorsOff {
  ...
  implicit def make(companion: InvertColorsOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
