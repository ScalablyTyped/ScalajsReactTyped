...
import typingsJapgolly.materialUi.svgIconsMapsHotelMod.default
...
object Hotel {
  ...
  implicit def make(companion: Hotel.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
