...
import typingsJapgolly.materialUi.svgIconsImageWbSunnyMod.default
...
object WbSunny {
  ...
  implicit def make(companion: WbSunny.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
