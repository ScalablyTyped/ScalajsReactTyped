...
import typingsJapgolly.materialUi.svgIconsDeviceGpsFixedMod.default
...
object GpsFixed {
  ...
  implicit def make(companion: GpsFixed.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
