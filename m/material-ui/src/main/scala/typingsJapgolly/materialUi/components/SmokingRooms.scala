...
import typingsJapgolly.materialUi.svgIconsPlacesSmokingRoomsMod.default
...
object SmokingRooms {
  ...
  implicit def make(companion: SmokingRooms.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
