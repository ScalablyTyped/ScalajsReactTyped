...
import typingsJapgolly.materialUi.svgIconsImageEditMod.default
...
object Edit {
  ...
  implicit def make(companion: Edit.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
