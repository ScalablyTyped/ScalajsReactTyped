...
import typingsJapgolly.materialUi.svgIconsActionOfflinePinMod.default
...
object OfflinePin {
  ...
  implicit def make(companion: OfflinePin.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
