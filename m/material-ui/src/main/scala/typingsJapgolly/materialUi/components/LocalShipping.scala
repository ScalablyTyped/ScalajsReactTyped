...
import typingsJapgolly.materialUi.svgIconsMapsLocalShippingMod.default
...
object LocalShipping {
  ...
  implicit def make(companion: LocalShipping.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
