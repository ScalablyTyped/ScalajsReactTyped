...
import typingsJapgolly.materialUi.svgIconsHardwareKeyboardArrowLeftMod.default
...
object KeyboardArrowLeft {
  ...
  implicit def make(companion: KeyboardArrowLeft.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
