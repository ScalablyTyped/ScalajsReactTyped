...
import typingsJapgolly.materialUi.svgIconsDeviceSignalCellularOffMod.default
...
object SignalCellularOff {
  ...
  implicit def make(companion: SignalCellularOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
