...
import typingsJapgolly.materialUi.svgIconsAvShuffleMod.default
...
object Shuffle {
  ...
  implicit def make(companion: Shuffle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
