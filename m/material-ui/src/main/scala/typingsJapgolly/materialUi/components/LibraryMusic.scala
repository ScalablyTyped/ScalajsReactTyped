...
import typingsJapgolly.materialUi.svgIconsAvLibraryMusicMod.default
...
object LibraryMusic {
  ...
  implicit def make(companion: LibraryMusic.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
