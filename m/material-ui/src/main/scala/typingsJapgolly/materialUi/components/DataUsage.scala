...
import typingsJapgolly.materialUi.svgIconsDeviceDataUsageMod.default
...
object DataUsage {
  ...
  implicit def make(companion: DataUsage.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
