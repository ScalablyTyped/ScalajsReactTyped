...
import typingsJapgolly.materialUi.svgIconsHardwareKeyboardMod.default
...
object Keyboard {
  ...
  implicit def make(companion: Keyboard.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
