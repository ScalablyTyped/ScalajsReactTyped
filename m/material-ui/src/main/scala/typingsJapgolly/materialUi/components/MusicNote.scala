...
import typingsJapgolly.materialUi.svgIconsImageMusicNoteMod.default
...
object MusicNote {
  ...
  implicit def make(companion: MusicNote.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
