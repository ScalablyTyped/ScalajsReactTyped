...
import typingsJapgolly.materialUi.svgIconsCommunicationDialpadMod.default
...
object Dialpad {
  ...
  implicit def make(companion: Dialpad.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
