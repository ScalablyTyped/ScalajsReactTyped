...
import typingsJapgolly.materialUi.svgIconsImageCameraRearMod.default
...
object CameraRear {
  ...
  implicit def make(companion: CameraRear.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
