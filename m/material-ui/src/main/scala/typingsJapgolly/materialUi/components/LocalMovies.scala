...
import typingsJapgolly.materialUi.svgIconsMapsLocalMoviesMod.default
...
object LocalMovies {
  ...
  implicit def make(companion: LocalMovies.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
