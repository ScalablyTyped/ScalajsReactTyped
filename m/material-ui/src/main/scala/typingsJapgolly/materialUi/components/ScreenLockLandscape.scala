...
import typingsJapgolly.materialUi.svgIconsDeviceScreenLockLandscapeMod.default
...
object ScreenLockLandscape {
  ...
  implicit def make(companion: ScreenLockLandscape.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
