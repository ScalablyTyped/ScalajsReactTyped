...
import typingsJapgolly.materialUi.svgIconsImageMonochromePhotosMod.default
...
object MonochromePhotos {
  ...
  implicit def make(companion: MonochromePhotos.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
