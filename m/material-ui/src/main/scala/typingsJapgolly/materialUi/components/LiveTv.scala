...
import typingsJapgolly.materialUi.svgIconsNotificationLiveTvMod.default
...
object LiveTv {
  ...
  implicit def make(companion: LiveTv.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
