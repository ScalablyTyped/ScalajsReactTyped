...
import typingsJapgolly.materialUi.svgIconsMapsPlaceMod.default
...
object Place {
  ...
  implicit def make(companion: Place.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
