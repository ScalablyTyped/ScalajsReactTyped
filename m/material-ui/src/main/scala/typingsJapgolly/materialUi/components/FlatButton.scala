...
import typingsJapgolly.materialUi.flatButtonMod.default
...
object FlatButton {
  ...
  typingsJapgolly.materialUi.MaterialUI.FlatButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.flatButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.FlatButtonProps])(children: _*)
  }
