...
import typingsJapgolly.materialUi.svgIconsActionSettingsInputHdmiMod.default
...
object SettingsInputHdmi {
  ...
  implicit def make(companion: SettingsInputHdmi.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
