...
import typingsJapgolly.materialUi.svgIconsImageAddToPhotosMod.default
...
object AddToPhotos {
  ...
  implicit def make(companion: AddToPhotos.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
