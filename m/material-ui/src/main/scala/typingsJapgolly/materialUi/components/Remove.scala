...
import typingsJapgolly.materialUi.svgIconsContentRemoveMod.default
...
object Remove {
  ...
  implicit def make(companion: Remove.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
