...
import typingsJapgolly.materialUi.svgIconsActionAccessibilityMod.default
...
object Accessibility {
  ...
  implicit def make(companion: Accessibility.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
