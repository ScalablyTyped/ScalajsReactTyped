...
import typingsJapgolly.materialUi.svgIconsImageHdrOffMod.default
...
object HdrOff {
  ...
  implicit def make(companion: HdrOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
