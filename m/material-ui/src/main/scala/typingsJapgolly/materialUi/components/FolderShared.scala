...
import typingsJapgolly.materialUi.svgIconsFileFolderSharedMod.default
...
object FolderShared {
  ...
  implicit def make(companion: FolderShared.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
