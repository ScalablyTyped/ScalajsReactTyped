...
import typingsJapgolly.materialUi.svgIconsActionGavelMod.default
...
object Gavel {
  ...
  implicit def make(companion: Gavel.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
