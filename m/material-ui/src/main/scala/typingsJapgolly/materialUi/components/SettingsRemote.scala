...
import typingsJapgolly.materialUi.svgIconsActionSettingsRemoteMod.default
...
object SettingsRemote {
  ...
  implicit def make(companion: SettingsRemote.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
