...
import typingsJapgolly.materialUi.svgIconsCommunicationScreenShareMod.default
...
object ScreenShare {
  ...
  implicit def make(companion: ScreenShare.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
