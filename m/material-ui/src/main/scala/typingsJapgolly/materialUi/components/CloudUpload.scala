...
import typingsJapgolly.materialUi.svgIconsFileCloudUploadMod.default
...
object CloudUpload {
  ...
  implicit def make(companion: CloudUpload.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
