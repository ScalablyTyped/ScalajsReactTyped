...
import typingsJapgolly.materialUi.svgIconsActionWatchLaterMod.default
...
object WatchLater {
  ...
  implicit def make(companion: WatchLater.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
