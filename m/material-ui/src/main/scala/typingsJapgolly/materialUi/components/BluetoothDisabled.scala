...
import typingsJapgolly.materialUi.svgIconsDeviceBluetoothDisabledMod.default
...
object BluetoothDisabled {
  ...
  implicit def make(companion: BluetoothDisabled.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
