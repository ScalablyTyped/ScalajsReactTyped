...
import typingsJapgolly.materialUi.svgIconsDeviceSignalCellularNullMod.default
...
object SignalCellularNull {
  ...
  implicit def make(companion: SignalCellularNull.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
