...
import typingsJapgolly.materialUi.svgIconsMapsBeenhereMod.default
...
object Beenhere {
  ...
  implicit def make(companion: Beenhere.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
