...
import typingsJapgolly.materialUi.svgIconsDeviceBrightnessHighMod.default
...
object BrightnessHigh {
  ...
  implicit def make(companion: BrightnessHigh.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
