...
import typingsJapgolly.materialUi.svgIconsActionSwapHorizMod.default
...
object SwapHoriz {
  ...
  implicit def make(companion: SwapHoriz.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
