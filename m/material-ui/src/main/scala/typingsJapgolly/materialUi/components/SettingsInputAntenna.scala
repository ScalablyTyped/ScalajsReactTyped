...
import typingsJapgolly.materialUi.svgIconsActionSettingsInputAntennaMod.default
...
object SettingsInputAntenna {
  ...
  implicit def make(companion: SettingsInputAntenna.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
