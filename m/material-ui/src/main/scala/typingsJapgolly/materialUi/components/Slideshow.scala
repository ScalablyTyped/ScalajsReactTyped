...
import typingsJapgolly.materialUi.svgIconsImageSlideshowMod.default
...
object Slideshow {
  ...
  implicit def make(companion: Slideshow.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
