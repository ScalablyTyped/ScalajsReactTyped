...
import typingsJapgolly.materialUi.svgIconsAvPlayCircleFilledMod.default
...
object PlayCircleFilled {
  ...
  implicit def make(companion: PlayCircleFilled.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
