...
import typingsJapgolly.materialUi.svgIconsActionLanguageMod.default
...
object Language {
  ...
  implicit def make(companion: Language.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
