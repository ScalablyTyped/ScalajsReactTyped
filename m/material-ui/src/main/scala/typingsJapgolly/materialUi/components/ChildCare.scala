...
import typingsJapgolly.materialUi.svgIconsPlacesChildCareMod.default
...
object ChildCare {
  ...
  implicit def make(companion: ChildCare.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
