...
import typingsJapgolly.materialUi.svgIconsActionViewStreamMod.default
...
object ViewStream {
  ...
  implicit def make(companion: ViewStream.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
