...
import typingsJapgolly.materialUi.svgIconsDeviceNetworkCellMod.default
...
object NetworkCell {
  ...
  implicit def make(companion: NetworkCell.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
