...
import typingsJapgolly.materialUi.svgIconsNavigationExpandMoreMod.default
...
object ExpandMore {
  ...
  implicit def make(companion: ExpandMore.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
