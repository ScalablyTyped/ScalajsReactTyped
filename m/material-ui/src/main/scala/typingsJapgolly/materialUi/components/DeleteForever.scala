...
import typingsJapgolly.materialUi.svgIconsActionDeleteForeverMod.default
...
object DeleteForever {
  ...
  implicit def make(companion: DeleteForever.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
