...
import typingsJapgolly.materialUi.svgIconsAvQueuePlayNextMod.default
...
object QueuePlayNext {
  ...
  implicit def make(companion: QueuePlayNext.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
