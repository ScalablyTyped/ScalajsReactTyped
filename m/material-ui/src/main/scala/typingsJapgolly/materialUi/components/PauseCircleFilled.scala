...
import typingsJapgolly.materialUi.svgIconsAvPauseCircleFilledMod.default
...
object PauseCircleFilled {
  ...
  implicit def make(companion: PauseCircleFilled.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
