...
import typingsJapgolly.materialUi.svgIconsActionViewQuiltMod.default
...
object ViewQuilt {
  ...
  implicit def make(companion: ViewQuilt.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
