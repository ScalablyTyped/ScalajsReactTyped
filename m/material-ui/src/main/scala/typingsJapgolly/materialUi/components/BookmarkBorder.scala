...
import typingsJapgolly.materialUi.svgIconsActionBookmarkBorderMod.default
...
object BookmarkBorder {
  ...
  implicit def make(companion: BookmarkBorder.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
