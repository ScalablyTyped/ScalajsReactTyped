...
import typingsJapgolly.materialUi.svgIconsImageWbAutoMod.default
...
object WbAuto {
  ...
  implicit def make(companion: WbAuto.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
