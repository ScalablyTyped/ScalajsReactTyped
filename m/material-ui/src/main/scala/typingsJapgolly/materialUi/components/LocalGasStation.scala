...
import typingsJapgolly.materialUi.svgIconsMapsLocalGasStationMod.default
...
object LocalGasStation {
  ...
  implicit def make(companion: LocalGasStation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
