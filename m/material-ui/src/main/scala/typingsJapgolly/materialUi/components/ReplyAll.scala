...
import typingsJapgolly.materialUi.svgIconsContentReplyAllMod.default
...
object ReplyAll {
  ...
  implicit def make(companion: ReplyAll.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
