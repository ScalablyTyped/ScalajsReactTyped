...
import typingsJapgolly.materialUi.svgIconsCommunicationBusinessMod.default
...
object Business {
  ...
  implicit def make(companion: Business.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
