...
import typingsJapgolly.materialUi.svgIconsContentArchiveMod.default
...
object Archive {
  ...
  implicit def make(companion: Archive.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
