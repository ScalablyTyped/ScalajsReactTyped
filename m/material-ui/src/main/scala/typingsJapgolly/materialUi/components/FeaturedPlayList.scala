...
import typingsJapgolly.materialUi.svgIconsAvFeaturedPlayListMod.default
...
object FeaturedPlayList {
  ...
  implicit def make(companion: FeaturedPlayList.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
