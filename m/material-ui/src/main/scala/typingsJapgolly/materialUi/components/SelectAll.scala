...
import typingsJapgolly.materialUi.svgIconsContentSelectAllMod.default
...
object SelectAll {
  ...
  implicit def make(companion: SelectAll.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
