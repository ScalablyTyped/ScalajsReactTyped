...
import typingsJapgolly.materialUi.svgIconsContentReportMod.default
...
object Report {
  ...
  implicit def make(companion: Report.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
