...
import typingsJapgolly.materialUi.svgIconsEditorFormatAlignJustifyMod.default
...
object FormatAlignJustify {
  ...
  implicit def make(companion: FormatAlignJustify.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
