...
import typingsJapgolly.materialUi.svgIconsImageBlurOffMod.default
...
object BlurOff {
  ...
  implicit def make(companion: BlurOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
