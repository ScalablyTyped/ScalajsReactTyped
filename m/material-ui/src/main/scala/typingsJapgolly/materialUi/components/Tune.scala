...
import typingsJapgolly.materialUi.svgIconsImageTuneMod.default
...
object Tune {
  ...
  implicit def make(companion: Tune.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
