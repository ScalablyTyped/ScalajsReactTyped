...
import typingsJapgolly.materialUi.svgIconsNotificationOndemandVideoMod.default
...
object OndemandVideo {
  ...
  implicit def make(companion: OndemandVideo.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
