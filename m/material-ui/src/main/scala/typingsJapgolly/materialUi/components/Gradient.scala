...
import typingsJapgolly.materialUi.svgIconsImageGradientMod.default
...
object Gradient {
  ...
  implicit def make(companion: Gradient.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
