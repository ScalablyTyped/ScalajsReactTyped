...
import typingsJapgolly.materialUi.svgIconsEditorPublishMod.default
...
object Publish {
  ...
  implicit def make(companion: Publish.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
