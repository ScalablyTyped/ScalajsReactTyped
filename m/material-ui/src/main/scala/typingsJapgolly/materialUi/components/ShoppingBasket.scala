...
import typingsJapgolly.materialUi.svgIconsActionShoppingBasketMod.default
...
object ShoppingBasket {
  ...
  implicit def make(companion: ShoppingBasket.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
