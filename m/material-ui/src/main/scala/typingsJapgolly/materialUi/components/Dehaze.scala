...
import typingsJapgolly.materialUi.svgIconsImageDehazeMod.default
...
object Dehaze {
  ...
  implicit def make(companion: Dehaze.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
