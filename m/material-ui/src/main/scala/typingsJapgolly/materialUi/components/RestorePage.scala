...
import typingsJapgolly.materialUi.svgIconsActionRestorePageMod.default
...
object RestorePage {
  ...
  implicit def make(companion: RestorePage.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
