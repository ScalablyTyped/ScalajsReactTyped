...
import typingsJapgolly.materialUi.svgIconsFileCloudOffMod.default
...
object CloudOff {
  ...
  implicit def make(companion: CloudOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
