...
object FloatingActionButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.materialUi.mod.FloatingActionButton] {
    ...
    inline def mini(value: Boolean): this.type = set("mini", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: FloatingActionButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FloatingActionButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
