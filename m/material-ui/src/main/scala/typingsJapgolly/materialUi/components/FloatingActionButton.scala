...
import typingsJapgolly.materialUi.MaterialUI.FloatingActionButtonProps
import typingsJapgolly.materialUi.floatingActionButtonMod.default
...
object FloatingActionButton {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FloatingActionButtonProps, default, Unit, FloatingActionButtonProps] = {
  ...
  typingsJapgolly.materialUi.MaterialUI.FloatingActionButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.floatingActionButtonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.FloatingActionButtonProps])(children: _*)
  }
