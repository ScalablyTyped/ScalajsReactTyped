...
import typingsJapgolly.materialUi.svgIconsImageCameraAltMod.default
...
object CameraAlt {
  ...
  implicit def make(companion: CameraAlt.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
