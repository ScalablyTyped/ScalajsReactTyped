...
import typingsJapgolly.materialUi.svgIconsActionSettingsBrightnessMod.default
...
object SettingsBrightness {
  ...
  implicit def make(companion: SettingsBrightness.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
