...
import typingsJapgolly.materialUi.svgIconsMapsLocalBarMod.default
...
object LocalBar {
  ...
  implicit def make(companion: LocalBar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
