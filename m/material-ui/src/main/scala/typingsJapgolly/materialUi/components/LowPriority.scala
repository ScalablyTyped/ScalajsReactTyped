...
import typingsJapgolly.materialUi.svgIconsContentLowPriorityMod.default
...
object LowPriority {
  ...
  implicit def make(companion: LowPriority.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
