...
import typingsJapgolly.materialUi.svgIconsAvSkipPreviousMod.default
...
object SkipPrevious {
  ...
  implicit def make(companion: SkipPrevious.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
