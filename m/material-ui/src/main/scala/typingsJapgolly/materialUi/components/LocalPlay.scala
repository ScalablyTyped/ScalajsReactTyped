...
import typingsJapgolly.materialUi.svgIconsMapsLocalPlayMod.default
...
object LocalPlay {
  ...
  implicit def make(companion: LocalPlay.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
