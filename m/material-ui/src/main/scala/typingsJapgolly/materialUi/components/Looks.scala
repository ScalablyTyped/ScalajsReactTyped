...
import typingsJapgolly.materialUi.svgIconsImageLooksMod.default
...
object Looks {
  ...
  implicit def make(companion: Looks.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
