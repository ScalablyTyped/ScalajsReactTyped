...
import typingsJapgolly.materialUi.svgIconsHardwareKeyboardTabMod.default
...
object KeyboardTab {
  ...
  implicit def make(companion: KeyboardTab.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
