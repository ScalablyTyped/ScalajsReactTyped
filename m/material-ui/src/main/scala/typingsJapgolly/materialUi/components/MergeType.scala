...
import typingsJapgolly.materialUi.svgIconsEditorMergeTypeMod.default
...
object MergeType {
  ...
  implicit def make(companion: MergeType.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
