...
import typingsJapgolly.materialUi.svgIconsAvFeaturedVideoMod.default
...
object FeaturedVideo {
  ...
  implicit def make(companion: FeaturedVideo.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
