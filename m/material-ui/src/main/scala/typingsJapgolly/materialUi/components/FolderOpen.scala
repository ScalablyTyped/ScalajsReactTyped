...
import typingsJapgolly.materialUi.svgIconsFileFolderOpenMod.default
...
object FolderOpen {
  ...
  implicit def make(companion: FolderOpen.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
