...
import typingsJapgolly.materialUi.svgIconsFileAttachmentMod.default
...
object Attachment {
  ...
  implicit def make(companion: Attachment.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
