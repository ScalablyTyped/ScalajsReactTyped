...
import typingsJapgolly.materialUi.svgIconsCommunicationRssFeedMod.default
...
object RssFeed {
  ...
  implicit def make(companion: RssFeed.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
