...
import typingsJapgolly.materialUi.svgIconsDeviceWifiLockMod.default
...
object WifiLock {
  ...
  implicit def make(companion: WifiLock.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
