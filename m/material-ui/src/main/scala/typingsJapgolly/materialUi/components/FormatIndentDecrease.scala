...
import typingsJapgolly.materialUi.svgIconsEditorFormatIndentDecreaseMod.default
...
object FormatIndentDecrease {
  ...
  implicit def make(companion: FormatIndentDecrease.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
