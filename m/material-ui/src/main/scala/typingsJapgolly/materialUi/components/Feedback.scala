...
import typingsJapgolly.materialUi.svgIconsActionFeedbackMod.default
...
object Feedback {
  ...
  implicit def make(companion: Feedback.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
