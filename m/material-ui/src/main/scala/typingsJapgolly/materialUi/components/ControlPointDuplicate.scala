...
import typingsJapgolly.materialUi.svgIconsImageControlPointDuplicateMod.default
...
object ControlPointDuplicate {
  ...
  implicit def make(companion: ControlPointDuplicate.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
