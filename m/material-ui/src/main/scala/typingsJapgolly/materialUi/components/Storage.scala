...
import typingsJapgolly.materialUi.svgIconsDeviceStorageMod.default
...
object Storage {
  ...
  implicit def make(companion: Storage.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
