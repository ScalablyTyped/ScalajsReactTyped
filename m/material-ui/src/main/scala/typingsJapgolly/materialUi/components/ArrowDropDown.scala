...
import typingsJapgolly.materialUi.svgIconsNavigationArrowDropDownMod.default
...
object ArrowDropDown {
  ...
  implicit def make(companion: ArrowDropDown.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
