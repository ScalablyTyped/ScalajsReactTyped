...
import typingsJapgolly.materialUi.svgIconsPlacesGolfCourseMod.default
...
object GolfCourse {
  ...
  implicit def make(companion: GolfCourse.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
