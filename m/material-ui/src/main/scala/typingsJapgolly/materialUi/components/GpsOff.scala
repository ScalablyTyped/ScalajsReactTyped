...
import typingsJapgolly.materialUi.svgIconsDeviceGpsOffMod.default
...
object GpsOff {
  ...
  implicit def make(companion: GpsOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
