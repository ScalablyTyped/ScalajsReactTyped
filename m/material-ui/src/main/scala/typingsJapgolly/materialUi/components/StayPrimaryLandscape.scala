...
import typingsJapgolly.materialUi.svgIconsCommunicationStayPrimaryLandscapeMod.default
...
object StayPrimaryLandscape {
  ...
  implicit def make(companion: StayPrimaryLandscape.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
