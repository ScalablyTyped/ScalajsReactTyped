...
import typingsJapgolly.materialUi.svgIconsImageTransformMod.default
...
object Transform {
  ...
  implicit def make(companion: Transform.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
