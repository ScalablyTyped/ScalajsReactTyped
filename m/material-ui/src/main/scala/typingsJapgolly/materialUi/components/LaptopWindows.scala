...
import typingsJapgolly.materialUi.svgIconsHardwareLaptopWindowsMod.default
...
object LaptopWindows {
  ...
  implicit def make(companion: LaptopWindows.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
