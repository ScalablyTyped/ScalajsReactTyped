...
import typingsJapgolly.materialUi.svgIconsActionGroupWorkMod.default
...
object GroupWork {
  ...
  implicit def make(companion: GroupWork.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
