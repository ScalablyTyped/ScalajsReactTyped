...
import typingsJapgolly.materialUi.svgIconsNotificationSmsFailedMod.default
...
object SmsFailed {
  ...
  implicit def make(companion: SmsFailed.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
