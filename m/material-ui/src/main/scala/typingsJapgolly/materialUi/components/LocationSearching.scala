...
import typingsJapgolly.materialUi.svgIconsDeviceLocationSearchingMod.default
...
object LocationSearching {
  ...
  implicit def make(companion: LocationSearching.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
