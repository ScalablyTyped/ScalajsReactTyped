...
import typingsJapgolly.materialUi.svgIconsFileCloudDownloadMod.default
...
object CloudDownload {
  ...
  implicit def make(companion: CloudDownload.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
