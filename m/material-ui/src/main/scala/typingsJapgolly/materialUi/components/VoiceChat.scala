...
import typingsJapgolly.materialUi.svgIconsNotificationVoiceChatMod.default
...
object VoiceChat {
  ...
  implicit def make(companion: VoiceChat.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
