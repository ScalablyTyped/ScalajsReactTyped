...
import typingsJapgolly.materialUi.svgIconsPlacesCasinoMod.default
...
object Casino {
  ...
  implicit def make(companion: Casino.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
