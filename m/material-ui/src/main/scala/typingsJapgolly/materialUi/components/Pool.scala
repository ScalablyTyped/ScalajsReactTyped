...
import typingsJapgolly.materialUi.svgIconsPlacesPoolMod.default
...
object Pool {
  ...
  implicit def make(companion: Pool.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
