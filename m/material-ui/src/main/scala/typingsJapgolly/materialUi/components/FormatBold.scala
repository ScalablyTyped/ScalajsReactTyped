...
import typingsJapgolly.materialUi.svgIconsEditorFormatBoldMod.default
...
object FormatBold {
  ...
  implicit def make(companion: FormatBold.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
