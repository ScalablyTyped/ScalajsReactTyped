...
import typingsJapgolly.materialUi.svgIconsActionTurnedInMod.default
...
object TurnedIn {
  ...
  implicit def make(companion: TurnedIn.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
