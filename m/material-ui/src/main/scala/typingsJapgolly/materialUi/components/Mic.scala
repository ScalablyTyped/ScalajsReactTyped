...
import typingsJapgolly.materialUi.svgIconsAvMicMod.default
...
object Mic {
  ...
  implicit def make(companion: Mic.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
