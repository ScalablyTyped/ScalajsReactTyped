...
import typingsJapgolly.materialUi.svgIconsAvAlbumMod.default
...
object Album {
  ...
  implicit def make(companion: Album.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
