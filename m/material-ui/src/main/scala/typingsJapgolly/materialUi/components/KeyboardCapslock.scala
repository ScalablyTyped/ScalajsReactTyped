...
import typingsJapgolly.materialUi.svgIconsHardwareKeyboardCapslockMod.default
...
object KeyboardCapslock {
  ...
  implicit def make(companion: KeyboardCapslock.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
