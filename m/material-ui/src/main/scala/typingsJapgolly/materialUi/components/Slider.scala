...
import typingsJapgolly.materialUi.sliderMod.default
...
object Slider {
  ...
  typingsJapgolly.materialUi.MaterialUI.SliderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.sliderMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.SliderProps])(children: _*)
  }
