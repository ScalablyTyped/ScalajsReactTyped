...
import typingsJapgolly.materialUi.svgIconsImageFilterTiltShiftMod.default
...
object FilterTiltShift {
  ...
  implicit def make(companion: FilterTiltShift.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
