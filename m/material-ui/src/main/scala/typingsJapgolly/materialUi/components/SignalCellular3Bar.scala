...
import typingsJapgolly.materialUi.svgIconsDeviceSignalCellular3BarMod.default
...
object SignalCellular3Bar {
  ...
  implicit def make(companion: SignalCellular3Bar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
