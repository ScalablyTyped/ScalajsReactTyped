...
import typingsJapgolly.materialUi.svgIconsNotificationEnhancedEncryptionMod.default
...
object EnhancedEncryption {
  ...
  implicit def make(companion: EnhancedEncryption.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
