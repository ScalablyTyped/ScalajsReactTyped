...
import typingsJapgolly.materialUi.svgIconsDeviceBatteryStdMod.default
...
object BatteryStd {
  ...
  implicit def make(companion: BatteryStd.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
