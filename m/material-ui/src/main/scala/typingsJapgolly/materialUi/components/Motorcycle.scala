...
import typingsJapgolly.materialUi.svgIconsActionMotorcycleMod.default
...
object Motorcycle {
  ...
  implicit def make(companion: Motorcycle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
