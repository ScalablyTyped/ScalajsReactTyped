...
import typingsJapgolly.materialUi.svgIconsNotificationBluetoothAudioMod.default
...
object BluetoothAudio {
  ...
  implicit def make(companion: BluetoothAudio.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
