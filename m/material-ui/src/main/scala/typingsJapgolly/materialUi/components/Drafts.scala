...
import typingsJapgolly.materialUi.svgIconsContentDraftsMod.default
...
object Drafts {
  ...
  implicit def make(companion: Drafts.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
