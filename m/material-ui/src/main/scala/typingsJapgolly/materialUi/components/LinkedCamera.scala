...
import typingsJapgolly.materialUi.svgIconsImageLinkedCameraMod.default
...
object LinkedCamera {
  ...
  implicit def make(companion: LinkedCamera.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
