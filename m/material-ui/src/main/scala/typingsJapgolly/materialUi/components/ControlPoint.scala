...
import typingsJapgolly.materialUi.svgIconsImageControlPointMod.default
...
object ControlPoint {
  ...
  implicit def make(companion: ControlPoint.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
