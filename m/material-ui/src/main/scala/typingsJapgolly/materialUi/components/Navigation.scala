...
import typingsJapgolly.materialUi.svgIconsMapsNavigationMod.default
...
object Navigation {
  ...
  implicit def make(companion: Navigation.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
