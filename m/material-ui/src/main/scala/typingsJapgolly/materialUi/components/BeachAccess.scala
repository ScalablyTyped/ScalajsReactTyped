...
import typingsJapgolly.materialUi.svgIconsPlacesBeachAccessMod.default
...
object BeachAccess {
  ...
  implicit def make(companion: BeachAccess.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
