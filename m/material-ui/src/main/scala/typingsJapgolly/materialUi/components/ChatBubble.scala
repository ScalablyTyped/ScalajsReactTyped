...
import typingsJapgolly.materialUi.svgIconsCommunicationChatBubbleMod.default
...
object ChatBubble {
  ...
  implicit def make(companion: ChatBubble.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
