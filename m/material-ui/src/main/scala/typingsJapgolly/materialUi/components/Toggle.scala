...
import typingsJapgolly.materialUi.toggleMod.default
...
object Toggle {
  def apply(
    ...
    onToggle: (/* e */ ReactMouseEventFrom[js.Object with Element], /* isInputChecked */ Boolean) => Callback = null,
    ...
    if (onToggle != null) __obj.updateDynamic("onToggle")(js.Any.fromFunction2((t0: /* e */ japgolly.scalajs.react.ReactMouseEventFrom[js.Object with org.scalajs.dom.raw.Element], t1: /* isInputChecked */ scala.Boolean) => onToggle(t0, t1).runNow()))
  ...
  typingsJapgolly.materialUi.MaterialUI.Switches.ToggleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.toggleMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.Switches.ToggleProps])(children: _*)
  }
