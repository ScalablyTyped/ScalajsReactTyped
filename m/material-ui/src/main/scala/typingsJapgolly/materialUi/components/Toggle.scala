...
import typingsJapgolly.materialUi.MaterialUI.Switches.ToggleProps
...
object Toggle {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.materialUi.mod.Toggle] {
    ...
    inline def defaultToggled(value: Boolean): this.type = set("defaultToggled", value.asInstanceOf[js.Any])
    ...
    inline def elementStyle(value: CSSProperties): this.type = set("elementStyle", value.asInstanceOf[js.Any])
    ...
    ): this.type = set("onToggle", js.Any.fromFunction2((t0: /* e */ ReactMouseEventFrom[js.Object & org.scalajs.dom.Element], t1: /* isInputChecked */ Boolean) => (value(t0, t1)).runNow()))
    ...
    inline def thumbStyle(value: CSSProperties): this.type = set("thumbStyle", value.asInstanceOf[js.Any])
    
    inline def thumbSwitchedStyle(value: CSSProperties): this.type = set("thumbSwitchedStyle", value.asInstanceOf[js.Any])
    ...
    inline def trackSwitchedStyle(value: CSSProperties): this.type = set("trackSwitchedStyle", value.asInstanceOf[js.Any])
    ...
    inline def valueLink(value: ReactLink[Boolean]): this.type = set("valueLink", value.asInstanceOf[js.Any])
