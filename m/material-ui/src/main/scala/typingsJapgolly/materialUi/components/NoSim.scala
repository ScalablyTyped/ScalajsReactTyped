...
import typingsJapgolly.materialUi.svgIconsCommunicationNoSimMod.default
...
object NoSim {
  ...
  implicit def make(companion: NoSim.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
