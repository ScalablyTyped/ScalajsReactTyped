...
import typingsJapgolly.materialUi.svgIconsAvVolumeMuteMod.default
...
object VolumeMute {
  ...
  implicit def make(companion: VolumeMute.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
