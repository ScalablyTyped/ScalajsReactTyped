...
import typingsJapgolly.materialUi.svgIconsAvRepeatMod.default
...
object Repeat {
  ...
  implicit def make(companion: Repeat.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
