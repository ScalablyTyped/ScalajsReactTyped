...
import typingsJapgolly.materialUi.svgIconsImageFilterNoneMod.default
...
object FilterNone {
  ...
  implicit def make(companion: FilterNone.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
