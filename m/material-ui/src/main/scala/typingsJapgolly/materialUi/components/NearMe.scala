...
import typingsJapgolly.materialUi.svgIconsMapsNearMeMod.default
...
object NearMe {
  ...
  implicit def make(companion: NearMe.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
