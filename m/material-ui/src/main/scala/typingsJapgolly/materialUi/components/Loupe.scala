...
import typingsJapgolly.materialUi.svgIconsImageLoupeMod.default
...
object Loupe {
  ...
  implicit def make(companion: Loupe.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
