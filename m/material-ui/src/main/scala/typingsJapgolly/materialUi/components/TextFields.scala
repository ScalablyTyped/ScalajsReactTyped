...
import typingsJapgolly.materialUi.svgIconsEditorTextFieldsMod.default
...
object TextFields {
  ...
  implicit def make(companion: TextFields.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
