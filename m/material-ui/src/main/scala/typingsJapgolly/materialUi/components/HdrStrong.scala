...
import typingsJapgolly.materialUi.svgIconsImageHdrStrongMod.default
...
object HdrStrong {
  ...
  implicit def make(companion: HdrStrong.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
