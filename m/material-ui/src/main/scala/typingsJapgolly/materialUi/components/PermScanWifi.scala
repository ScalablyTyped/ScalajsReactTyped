...
import typingsJapgolly.materialUi.svgIconsActionPermScanWifiMod.default
...
object PermScanWifi {
  ...
  implicit def make(companion: PermScanWifi.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
