...
import typingsJapgolly.materialUi.svgIconsContentSaveMod.default
...
object Save {
  ...
  implicit def make(companion: Save.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
