...
import typingsJapgolly.materialUi.svgIconsImageBlurCircularMod.default
...
object BlurCircular {
  ...
  implicit def make(companion: BlurCircular.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
