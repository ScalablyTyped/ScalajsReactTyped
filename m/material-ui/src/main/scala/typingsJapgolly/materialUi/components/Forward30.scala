...
import typingsJapgolly.materialUi.svgIconsAvForward30Mod.default
...
object Forward30 {
  ...
  implicit def make(companion: Forward30.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
