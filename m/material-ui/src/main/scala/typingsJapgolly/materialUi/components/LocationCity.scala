...
import typingsJapgolly.materialUi.svgIconsSocialLocationCityMod.default
...
object LocationCity {
  ...
  implicit def make(companion: LocationCity.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
