...
import typingsJapgolly.materialUi.svgIconsActionViewListMod.default
...
object ViewList {
  ...
  implicit def make(companion: ViewList.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
