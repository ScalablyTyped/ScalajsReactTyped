...
import typingsJapgolly.materialUi.svgIconsNotificationDriveEtaMod.default
...
object DriveEta {
  ...
  implicit def make(companion: DriveEta.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
