...
import typingsJapgolly.materialUi.svgIconsImageCropRotateMod.default
...
object CropRotate {
  ...
  implicit def make(companion: CropRotate.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
