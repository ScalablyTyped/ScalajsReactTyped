...
import typingsJapgolly.materialUi.svgIconsImageStyleMod.default
...
object Style {
  ...
  implicit def make(companion: Style.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
