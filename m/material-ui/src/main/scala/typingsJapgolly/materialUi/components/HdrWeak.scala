...
import typingsJapgolly.materialUi.svgIconsImageHdrWeakMod.default
...
object HdrWeak {
  ...
  implicit def make(companion: HdrWeak.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
