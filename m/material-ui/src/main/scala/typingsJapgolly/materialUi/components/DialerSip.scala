...
import typingsJapgolly.materialUi.svgIconsCommunicationDialerSipMod.default
...
object DialerSip {
  ...
  implicit def make(companion: DialerSip.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
