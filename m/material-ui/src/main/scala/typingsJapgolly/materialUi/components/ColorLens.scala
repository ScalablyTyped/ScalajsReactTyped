...
import typingsJapgolly.materialUi.svgIconsImageColorLensMod.default
...
object ColorLens {
  ...
  implicit def make(companion: ColorLens.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
