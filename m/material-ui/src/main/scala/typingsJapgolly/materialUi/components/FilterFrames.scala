...
import typingsJapgolly.materialUi.svgIconsImageFilterFramesMod.default
...
object FilterFrames {
  ...
  implicit def make(companion: FilterFrames.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
