...
import typingsJapgolly.materialUi.svgIconsMapsLocalLibraryMod.default
...
object LocalLibrary {
  ...
  implicit def make(companion: LocalLibrary.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
