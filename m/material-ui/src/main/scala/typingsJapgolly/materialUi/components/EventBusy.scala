...
import typingsJapgolly.materialUi.svgIconsNotificationEventBusyMod.default
...
object EventBusy {
  ...
  implicit def make(companion: EventBusy.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
