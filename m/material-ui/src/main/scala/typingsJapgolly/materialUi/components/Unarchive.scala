...
import typingsJapgolly.materialUi.svgIconsContentUnarchiveMod.default
...
object Unarchive {
  ...
  implicit def make(companion: Unarchive.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
