...
import typingsJapgolly.materialUi.svgIconsActionSettingsEthernetMod.default
...
object SettingsEthernet {
  ...
  implicit def make(companion: SettingsEthernet.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
