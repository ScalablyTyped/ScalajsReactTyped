...
import typingsJapgolly.materialUi.svgIconsHardwareDesktopWindowsMod.default
...
object DesktopWindows {
  ...
  implicit def make(companion: DesktopWindows.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
