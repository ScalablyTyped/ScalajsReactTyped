...
import typingsJapgolly.materialUi.svgIconsActionPermDataSettingMod.default
...
object PermDataSetting {
  ...
  implicit def make(companion: PermDataSetting.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
