...
import typingsJapgolly.materialUi.svgIconsNavigationArrowBackMod.default
...
object ArrowBack {
  ...
  implicit def make(companion: ArrowBack.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
