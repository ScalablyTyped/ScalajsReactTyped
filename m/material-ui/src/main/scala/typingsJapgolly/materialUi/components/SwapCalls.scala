...
import typingsJapgolly.materialUi.svgIconsCommunicationSwapCallsMod.default
...
object SwapCalls {
  ...
  implicit def make(companion: SwapCalls.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
