...
import typingsJapgolly.materialUi.svgIconsActionInfoMod.default
...
object Info {
  ...
  implicit def make(companion: Info.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
