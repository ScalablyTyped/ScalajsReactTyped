...
import typingsJapgolly.materialUi.svgIconsDeviceBatteryChargingFullMod.default
...
object BatteryChargingFull {
  ...
  implicit def make(companion: BatteryChargingFull.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
