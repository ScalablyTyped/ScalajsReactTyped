...
import typingsJapgolly.materialUi.svgIconsActionOpenInBrowserMod.default
...
object OpenInBrowser {
  ...
  implicit def make(companion: OpenInBrowser.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
