...
import typingsJapgolly.materialUi.svgIconsActionAutorenewMod.default
...
object Autorenew {
  ...
  implicit def make(companion: Autorenew.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
