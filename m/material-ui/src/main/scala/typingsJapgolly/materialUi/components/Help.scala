...
import typingsJapgolly.materialUi.svgIconsActionHelpMod.default
...
object Help {
  ...
  implicit def make(companion: Help.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
