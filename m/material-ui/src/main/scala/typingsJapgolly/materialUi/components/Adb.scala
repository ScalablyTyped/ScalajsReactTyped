...
import typingsJapgolly.materialUi.svgIconsNotificationAdbMod.default
...
object Adb {
  ...
  implicit def make(companion: Adb.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
