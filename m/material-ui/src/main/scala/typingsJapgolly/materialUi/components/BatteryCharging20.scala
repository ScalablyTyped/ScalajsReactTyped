...
import typingsJapgolly.materialUi.svgIconsDeviceBatteryCharging20Mod.default
...
object BatteryCharging20 {
  ...
  implicit def make(companion: BatteryCharging20.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
