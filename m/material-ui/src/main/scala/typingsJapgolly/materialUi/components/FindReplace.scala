...
import typingsJapgolly.materialUi.svgIconsActionFindReplaceMod.default
...
object FindReplace {
  ...
  implicit def make(companion: FindReplace.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
