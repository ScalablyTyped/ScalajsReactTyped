...
import typingsJapgolly.materialUi.svgIconsActionInvertColorsMod.default
...
object InvertColors {
  ...
  implicit def make(companion: InvertColors.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
