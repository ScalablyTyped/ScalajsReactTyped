...
import typingsJapgolly.materialUi.svgIconsCommunicationCallMadeMod.default
...
object CallMade {
  ...
  implicit def make(companion: CallMade.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
