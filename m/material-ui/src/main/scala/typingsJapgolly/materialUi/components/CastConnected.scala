...
import typingsJapgolly.materialUi.svgIconsHardwareCastConnectedMod.default
...
object CastConnected {
  ...
  implicit def make(companion: CastConnected.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
