...
import typingsJapgolly.materialUi.svgIconsDeviceBatteryAlertMod.default
...
object BatteryAlert {
  ...
  implicit def make(companion: BatteryAlert.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
