...
import typingsJapgolly.materialUi.svgIconsActionBookMod.default
...
object Book {
  ...
  implicit def make(companion: Book.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
