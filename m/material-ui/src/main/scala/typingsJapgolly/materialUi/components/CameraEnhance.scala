...
import typingsJapgolly.materialUi.svgIconsActionCameraEnhanceMod.default
...
object CameraEnhance {
  ...
  implicit def make(companion: CameraEnhance.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
