...
import typingsJapgolly.materialUi.svgIconsEditorMultilineChartMod.default
...
object MultilineChart {
  ...
  implicit def make(companion: MultilineChart.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
