...
import typingsJapgolly.materialUi.svgIconsPlacesRoomServiceMod.default
...
object RoomService {
  ...
  implicit def make(companion: RoomService.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
