...
import typingsJapgolly.materialUi.svgIconsActionSettingsPhoneMod.default
...
object SettingsPhone {
  ...
  implicit def make(companion: SettingsPhone.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
