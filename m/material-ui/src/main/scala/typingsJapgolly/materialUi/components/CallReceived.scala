...
import typingsJapgolly.materialUi.svgIconsCommunicationCallReceivedMod.default
...
object CallReceived {
  ...
  implicit def make(companion: CallReceived.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
