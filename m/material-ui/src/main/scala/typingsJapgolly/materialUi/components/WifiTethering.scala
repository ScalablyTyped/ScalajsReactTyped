...
import typingsJapgolly.materialUi.svgIconsDeviceWifiTetheringMod.default
...
object WifiTethering {
  ...
  implicit def make(companion: WifiTethering.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
