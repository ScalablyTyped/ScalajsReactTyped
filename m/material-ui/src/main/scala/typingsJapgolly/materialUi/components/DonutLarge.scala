...
import typingsJapgolly.materialUi.svgIconsActionDonutLargeMod.default
...
object DonutLarge {
  ...
  implicit def make(companion: DonutLarge.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
