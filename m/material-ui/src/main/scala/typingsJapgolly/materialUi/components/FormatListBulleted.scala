...
import typingsJapgolly.materialUi.svgIconsEditorFormatListBulletedMod.default
...
object FormatListBulleted {
  ...
  implicit def make(companion: FormatListBulleted.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
