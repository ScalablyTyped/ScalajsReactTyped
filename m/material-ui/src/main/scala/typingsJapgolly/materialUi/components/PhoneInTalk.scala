...
import typingsJapgolly.materialUi.svgIconsNotificationPhoneInTalkMod.default
...
object PhoneInTalk {
  ...
  implicit def make(companion: PhoneInTalk.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
