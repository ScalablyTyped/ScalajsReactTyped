...
import typingsJapgolly.materialUi.svgIconsActionAccessibleMod.default
...
object Accessible {
  ...
  implicit def make(companion: Accessible.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
