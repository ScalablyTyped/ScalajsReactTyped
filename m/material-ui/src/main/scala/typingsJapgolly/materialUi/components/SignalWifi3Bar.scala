...
import typingsJapgolly.materialUi.svgIconsDeviceSignalWifi3BarMod.default
...
object SignalWifi3Bar {
  ...
  implicit def make(companion: SignalWifi3Bar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
