...
import typingsJapgolly.materialUi.svgIconsImageVignetteMod.default
...
object Vignette {
  ...
  implicit def make(companion: Vignette.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
