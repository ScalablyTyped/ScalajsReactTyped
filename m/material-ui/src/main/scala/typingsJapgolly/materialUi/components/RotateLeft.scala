...
import typingsJapgolly.materialUi.svgIconsImageRotateLeftMod.default
...
object RotateLeft {
  ...
  implicit def make(companion: RotateLeft.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
