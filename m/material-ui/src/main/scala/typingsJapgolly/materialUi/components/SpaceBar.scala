...
import typingsJapgolly.materialUi.svgIconsEditorSpaceBarMod.default
...
object SpaceBar {
  ...
  implicit def make(companion: SpaceBar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
