...
import typingsJapgolly.materialUi.svgIconsHardwareHeadsetMod.default
...
object Headset {
  ...
  implicit def make(companion: Headset.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
