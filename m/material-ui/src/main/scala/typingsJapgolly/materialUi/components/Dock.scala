...
import typingsJapgolly.materialUi.svgIconsHardwareDockMod.default
...
object Dock {
  ...
  implicit def make(companion: Dock.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
