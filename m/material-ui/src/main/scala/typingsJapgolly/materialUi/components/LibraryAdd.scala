...
import typingsJapgolly.materialUi.svgIconsAvLibraryAddMod.default
...
object LibraryAdd {
  ...
  implicit def make(companion: LibraryAdd.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
