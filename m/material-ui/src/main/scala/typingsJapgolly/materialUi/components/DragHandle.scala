...
import typingsJapgolly.materialUi.svgIconsEditorDragHandleMod.default
...
object DragHandle {
  ...
  implicit def make(companion: DragHandle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
