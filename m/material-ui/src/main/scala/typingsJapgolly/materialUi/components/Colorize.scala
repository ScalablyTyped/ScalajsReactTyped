...
import typingsJapgolly.materialUi.svgIconsImageColorizeMod.default
...
object Colorize {
  ...
  implicit def make(companion: Colorize.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
