...
import typingsJapgolly.materialUi.svgIconsActionImportantDevicesMod.default
...
object ImportantDevices {
  ...
  implicit def make(companion: ImportantDevices.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
