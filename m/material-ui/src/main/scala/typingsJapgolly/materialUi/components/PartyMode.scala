...
import typingsJapgolly.materialUi.svgIconsSocialPartyModeMod.default
...
object PartyMode {
  ...
  implicit def make(companion: PartyMode.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
