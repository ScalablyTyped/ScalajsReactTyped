...
import typingsJapgolly.materialUi.svgIconsEditorTitleMod.default
...
object Title {
  ...
  implicit def make(companion: Title.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
