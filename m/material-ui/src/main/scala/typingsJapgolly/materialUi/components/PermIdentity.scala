...
import typingsJapgolly.materialUi.svgIconsActionPermIdentityMod.default
...
object PermIdentity {
  ...
  implicit def make(companion: PermIdentity.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
