...
import typingsJapgolly.materialUi.svgIconsEditorShowChartMod.default
...
object ShowChart {
  ...
  implicit def make(companion: ShowChart.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
