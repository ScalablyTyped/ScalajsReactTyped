...
import typingsJapgolly.materialUi.svgIconsAvEqualizerMod.default
...
object Equalizer {
  ...
  implicit def make(companion: Equalizer.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
