...
import typingsJapgolly.materialUi.svgIconsPlacesAirportShuttleMod.default
...
object AirportShuttle {
  ...
  implicit def make(companion: AirportShuttle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
