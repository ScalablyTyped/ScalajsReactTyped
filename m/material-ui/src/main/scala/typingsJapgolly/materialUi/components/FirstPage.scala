...
import typingsJapgolly.materialUi.svgIconsNavigationFirstPageMod.default
...
object FirstPage {
  ...
  implicit def make(companion: FirstPage.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
