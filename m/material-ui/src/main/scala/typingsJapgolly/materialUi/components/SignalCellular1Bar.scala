...
import typingsJapgolly.materialUi.svgIconsDeviceSignalCellular1BarMod.default
...
object SignalCellular1Bar {
  ...
  implicit def make(companion: SignalCellular1Bar.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
