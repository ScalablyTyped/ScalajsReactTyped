...
import typingsJapgolly.materialUi.svgIconsActionTabUnselectedMod.default
...
object TabUnselected {
  ...
  implicit def make(companion: TabUnselected.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
