...
import typingsJapgolly.materialUi.svgIconsImageHdrOnMod.default
...
object HdrOn {
  ...
  implicit def make(companion: HdrOn.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
