...
import typingsJapgolly.materialUi.svgIconsAvVolumeUpMod.default
...
object VolumeUp {
  ...
  implicit def make(companion: VolumeUp.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
