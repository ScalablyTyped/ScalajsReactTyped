...
import typingsJapgolly.materialUi.svgIconsActionPetsMod.default
...
object Pets {
  ...
  implicit def make(companion: Pets.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
