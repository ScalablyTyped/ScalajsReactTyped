...
import typingsJapgolly.materialUi.selectFieldMod.default
...
object SelectField {
  ...
  typingsJapgolly.materialUi.MaterialUI.SelectFieldProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.selectFieldMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.MaterialUI.SelectFieldProps])(children: _*)
  }
