...
import typingsJapgolly.materialUi.svgIconsActionChangeHistoryMod.default
...
object ChangeHistory {
  ...
  implicit def make(companion: ChangeHistory.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
