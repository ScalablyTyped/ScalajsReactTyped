...
import typingsJapgolly.materialUi.svgIconsContentContentPasteMod.default
...
object ContentPaste {
  ...
  implicit def make(companion: ContentPaste.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
