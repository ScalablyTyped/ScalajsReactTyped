...
import typingsJapgolly.materialUi.svgIconsImagePortraitMod.default
...
object Portrait {
  ...
  implicit def make(companion: Portrait.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
