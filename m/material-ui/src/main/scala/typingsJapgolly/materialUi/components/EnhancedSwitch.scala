...
import typingsJapgolly.materialUi.internalEnhancedSwitchMod.EnhancedSwitchProps
import typingsJapgolly.materialUi.internalEnhancedSwitchMod.default
...
object EnhancedSwitch {
  ...
  implicit def make(companion: EnhancedSwitch.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: EnhancedSwitchProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
