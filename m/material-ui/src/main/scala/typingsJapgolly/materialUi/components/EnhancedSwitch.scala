...
import typingsJapgolly.materialUi.enhancedSwitchMod.EnhancedSwitchProps
import typingsJapgolly.materialUi.enhancedSwitchMod.default
...
object EnhancedSwitch {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[EnhancedSwitchProps, default, Unit, EnhancedSwitchProps] = {
  ...
  typingsJapgolly.materialUi.enhancedSwitchMod.EnhancedSwitchProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialUi.enhancedSwitchMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.materialUi.enhancedSwitchMod.EnhancedSwitchProps])(children: _*)
  }
