...
import typingsJapgolly.materialUi.svgIconsImageGrainMod.default
...
object Grain {
  ...
  implicit def make(companion: Grain.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
