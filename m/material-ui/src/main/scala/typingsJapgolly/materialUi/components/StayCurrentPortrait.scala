...
import typingsJapgolly.materialUi.svgIconsCommunicationStayCurrentPortraitMod.default
...
object StayCurrentPortrait {
  ...
  implicit def make(companion: StayCurrentPortrait.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
