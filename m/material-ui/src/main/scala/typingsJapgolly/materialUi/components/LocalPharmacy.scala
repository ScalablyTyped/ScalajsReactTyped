...
import typingsJapgolly.materialUi.svgIconsMapsLocalPharmacyMod.default
...
object LocalPharmacy {
  ...
  implicit def make(companion: LocalPharmacy.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
