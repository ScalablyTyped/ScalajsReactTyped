...
import typingsJapgolly.materialUi.svgIconsCommunicationCallSplitMod.default
...
object CallSplit {
  ...
  implicit def make(companion: CallSplit.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
