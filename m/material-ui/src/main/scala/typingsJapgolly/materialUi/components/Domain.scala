...
import typingsJapgolly.materialUi.svgIconsSocialDomainMod.default
...
object Domain {
  ...
  implicit def make(companion: Domain.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
