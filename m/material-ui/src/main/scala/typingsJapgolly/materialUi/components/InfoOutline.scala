...
import typingsJapgolly.materialUi.svgIconsActionInfoOutlineMod.default
...
object InfoOutline {
  ...
  implicit def make(companion: InfoOutline.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
