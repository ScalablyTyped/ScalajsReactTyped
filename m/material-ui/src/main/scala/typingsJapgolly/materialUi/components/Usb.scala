...
import typingsJapgolly.materialUi.svgIconsDeviceUsbMod.default
...
object Usb {
  ...
  implicit def make(companion: Usb.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
