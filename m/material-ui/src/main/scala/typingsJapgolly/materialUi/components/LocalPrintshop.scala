...
import typingsJapgolly.materialUi.svgIconsMapsLocalPrintshopMod.default
...
object LocalPrintshop {
  ...
  implicit def make(companion: LocalPrintshop.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
