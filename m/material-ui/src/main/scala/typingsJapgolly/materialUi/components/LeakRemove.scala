...
import typingsJapgolly.materialUi.svgIconsImageLeakRemoveMod.default
...
object LeakRemove {
  ...
  implicit def make(companion: LeakRemove.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
