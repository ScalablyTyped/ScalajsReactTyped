...
import typingsJapgolly.materialUi.svgIconsAvBrandingWatermarkMod.default
...
object BrandingWatermark {
  ...
  implicit def make(companion: BrandingWatermark.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
