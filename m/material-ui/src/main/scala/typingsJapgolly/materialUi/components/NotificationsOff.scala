...
import typingsJapgolly.materialUi.svgIconsSocialNotificationsOffMod.default
...
object NotificationsOff {
  ...
  implicit def make(companion: NotificationsOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
