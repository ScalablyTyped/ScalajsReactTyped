...
import typingsJapgolly.materialUi.svgIconsFileCloudCircleMod.default
...
object CloudCircle {
  ...
  implicit def make(companion: CloudCircle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
