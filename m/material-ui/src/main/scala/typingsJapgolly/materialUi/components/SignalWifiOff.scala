...
import typingsJapgolly.materialUi.svgIconsDeviceSignalWifiOffMod.default
...
object SignalWifiOff {
  ...
  implicit def make(companion: SignalWifiOff.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
