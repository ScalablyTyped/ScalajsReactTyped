...
import typingsJapgolly.materialUi.svgIconsEditorLinearScaleMod.default
...
object LinearScale {
  ...
  implicit def make(companion: LinearScale.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
