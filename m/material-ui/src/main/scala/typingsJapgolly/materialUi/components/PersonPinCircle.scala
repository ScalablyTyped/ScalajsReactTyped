...
import typingsJapgolly.materialUi.svgIconsMapsPersonPinCircleMod.default
...
object PersonPinCircle {
  ...
  implicit def make(companion: PersonPinCircle.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
