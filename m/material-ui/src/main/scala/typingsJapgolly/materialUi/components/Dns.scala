...
import typingsJapgolly.materialUi.svgIconsActionDnsMod.default
...
object Dns {
  ...
  implicit def make(companion: Dns.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
