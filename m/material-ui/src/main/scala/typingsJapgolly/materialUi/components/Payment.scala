...
import typingsJapgolly.materialUi.svgIconsActionPaymentMod.default
...
object Payment {
  ...
  implicit def make(companion: Payment.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
