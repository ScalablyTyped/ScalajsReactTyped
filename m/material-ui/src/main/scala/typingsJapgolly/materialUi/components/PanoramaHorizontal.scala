...
import typingsJapgolly.materialUi.svgIconsImagePanoramaHorizontalMod.default
...
object PanoramaHorizontal {
  ...
  implicit def make(companion: PanoramaHorizontal.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
