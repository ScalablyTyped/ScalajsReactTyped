...
import typingsJapgolly.materialUi.svgIconsActionAnnouncementMod.default
...
object Announcement {
  ...
  implicit def make(companion: Announcement.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
