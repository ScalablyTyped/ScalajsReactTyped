...
import typingsJapgolly.materialUi.svgIconsNotificationWcMod.default
...
object Wc {
  ...
  implicit def make(companion: Wc.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
