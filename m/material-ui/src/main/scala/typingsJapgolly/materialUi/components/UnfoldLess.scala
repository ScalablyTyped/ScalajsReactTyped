...
import typingsJapgolly.materialUi.svgIconsNavigationUnfoldLessMod.default
...
object UnfoldLess {
  ...
  implicit def make(companion: UnfoldLess.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
