...
import typingsJapgolly.materialUi.svgIconsNotificationSystemUpdateMod.default
...
object SystemUpdate {
  ...
  implicit def make(companion: SystemUpdate.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
