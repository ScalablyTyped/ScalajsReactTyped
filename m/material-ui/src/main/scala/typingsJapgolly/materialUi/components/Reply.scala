...
import typingsJapgolly.materialUi.svgIconsContentReplyMod.default
...
object Reply {
  ...
  implicit def make(companion: Reply.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
