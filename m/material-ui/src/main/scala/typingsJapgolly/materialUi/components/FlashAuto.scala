...
import typingsJapgolly.materialUi.svgIconsImageFlashAutoMod.default
...
object FlashAuto {
  ...
  implicit def make(companion: FlashAuto.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
