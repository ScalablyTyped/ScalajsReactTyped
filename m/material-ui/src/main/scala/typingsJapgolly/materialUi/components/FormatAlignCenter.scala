...
import typingsJapgolly.materialUi.svgIconsEditorFormatAlignCenterMod.default
...
object FormatAlignCenter {
  ...
  implicit def make(companion: FormatAlignCenter.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
