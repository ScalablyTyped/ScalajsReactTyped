...
import typingsJapgolly.materialUi.svgIconsMapsTerrainMod.default
...
object Terrain {
  ...
  implicit def make(companion: Terrain.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
