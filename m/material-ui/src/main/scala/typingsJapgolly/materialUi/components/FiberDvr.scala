...
import typingsJapgolly.materialUi.svgIconsAvFiberDvrMod.default
...
object FiberDvr {
  ...
  implicit def make(companion: FiberDvr.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
