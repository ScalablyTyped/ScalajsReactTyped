...
import typingsJapgolly.materialUi.svgIconsNavigationAppsMod.default
...
object Apps {
  ...
  implicit def make(companion: Apps.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
