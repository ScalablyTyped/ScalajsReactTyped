...
import typingsJapgolly.materialUi.svgIconsNavigationExpandLessMod.default
...
object ExpandLess {
  ...
  implicit def make(companion: ExpandLess.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
