...
import typingsJapgolly.materialUi.svgIconsImageCameraMod.default
...
object Camera {
  ...
  implicit def make(companion: Camera.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
