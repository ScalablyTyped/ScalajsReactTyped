...
import typingsJapgolly.materialUi.svgIconsActionGradeMod.default
...
object Grade {
  ...
  implicit def make(companion: Grade.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
