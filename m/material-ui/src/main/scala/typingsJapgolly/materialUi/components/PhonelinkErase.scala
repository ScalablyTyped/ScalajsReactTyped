...
import typingsJapgolly.materialUi.svgIconsCommunicationPhonelinkEraseMod.default
...
object PhonelinkErase {
  ...
  implicit def make(companion: PhonelinkErase.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
