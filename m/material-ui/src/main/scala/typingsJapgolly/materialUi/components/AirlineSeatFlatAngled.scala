...
import typingsJapgolly.materialUi.svgIconsNotificationAirlineSeatFlatAngledMod.default
...
object AirlineSeatFlatAngled {
  ...
  implicit def make(companion: AirlineSeatFlatAngled.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
