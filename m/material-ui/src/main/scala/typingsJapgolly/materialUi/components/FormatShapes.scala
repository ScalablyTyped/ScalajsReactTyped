...
import typingsJapgolly.materialUi.svgIconsEditorFormatShapesMod.default
...
object FormatShapes {
  ...
  implicit def make(companion: FormatShapes.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
