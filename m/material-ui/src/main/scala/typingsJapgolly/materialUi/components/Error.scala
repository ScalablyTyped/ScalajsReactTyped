...
import typingsJapgolly.materialUi.svgIconsAlertErrorMod.default
...
object Error {
  ...
  implicit def make(companion: Error.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
