...
import typingsJapgolly.materialUi.svgIconsContentMarkunreadMod.default
...
object Markunread {
  ...
  implicit def make(companion: Markunread.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
