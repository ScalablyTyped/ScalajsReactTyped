...
import typingsJapgolly.materialUi.svgIconsContentCreateMod.default
...
object Create {
  ...
  implicit def make(companion: Create.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
