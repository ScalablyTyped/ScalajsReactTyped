...
import typingsJapgolly.materialUi.svgIconsContentLinkMod.default
...
object Link {
  ...
  implicit def make(companion: Link.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
