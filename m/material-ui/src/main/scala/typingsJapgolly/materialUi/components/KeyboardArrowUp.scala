...
import typingsJapgolly.materialUi.svgIconsHardwareKeyboardArrowUpMod.default
...
object KeyboardArrowUp {
  ...
  implicit def make(companion: KeyboardArrowUp.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
