...
import typingsJapgolly.materialUi.svgIconsNotificationTapAndPlayMod.default
...
object TapAndPlay {
  ...
  implicit def make(companion: TapAndPlay.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
