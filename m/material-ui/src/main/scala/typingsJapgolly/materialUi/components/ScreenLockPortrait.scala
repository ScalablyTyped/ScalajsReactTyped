...
import typingsJapgolly.materialUi.svgIconsDeviceScreenLockPortraitMod.default
...
object ScreenLockPortrait {
  ...
  implicit def make(companion: ScreenLockPortrait.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
