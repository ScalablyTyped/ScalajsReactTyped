...
import typingsJapgolly.materialUi.svgIconsImageLandscapeMod.default
...
object Landscape {
  ...
  implicit def make(companion: Landscape.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
