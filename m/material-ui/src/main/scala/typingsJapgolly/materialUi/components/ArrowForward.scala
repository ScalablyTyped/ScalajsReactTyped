...
import typingsJapgolly.materialUi.svgIconsNavigationArrowForwardMod.default
...
object ArrowForward {
  ...
  implicit def make(companion: ArrowForward.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
