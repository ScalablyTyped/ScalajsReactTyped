...
import typingsJapgolly.materialUi.svgIconsActionQueryBuilderMod.default
...
object QueryBuilder {
  ...
  implicit def make(companion: QueryBuilder.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
