...
import typingsJapgolly.materialUi.svgIconsCommunicationContactPhoneMod.default
...
object ContactPhone {
  ...
  implicit def make(companion: ContactPhone.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
