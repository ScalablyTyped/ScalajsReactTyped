...
import typingsJapgolly.materialUi.svgIconsPlacesFitnessCenterMod.default
...
object FitnessCenter {
  ...
  implicit def make(companion: FitnessCenter.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
