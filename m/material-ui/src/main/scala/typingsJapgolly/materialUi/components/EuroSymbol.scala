...
import typingsJapgolly.materialUi.svgIconsActionEuroSymbolMod.default
...
object EuroSymbol {
  ...
  implicit def make(companion: EuroSymbol.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
