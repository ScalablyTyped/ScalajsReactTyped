...
import typingsJapgolly.materialUi.svgIconsCommunicationStayCurrentLandscapeMod.default
...
object StayCurrentLandscape {
  ...
  implicit def make(companion: StayCurrentLandscape.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
