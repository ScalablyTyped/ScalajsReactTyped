...
import typingsJapgolly.materialUi.svgIconsAvAddToQueueMod.default
...
object AddToQueue {
  ...
  implicit def make(companion: AddToQueue.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
