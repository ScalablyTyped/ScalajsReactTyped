...
import typingsJapgolly.materialUi.svgIconsMapsDirectionsBoatMod.default
...
object DirectionsBoat {
  ...
  implicit def make(companion: DirectionsBoat.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
