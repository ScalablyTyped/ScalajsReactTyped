...
import typingsJapgolly.materialUi.svgIconsFileCloudQueueMod.default
...
object CloudQueue {
  ...
  implicit def make(companion: CloudQueue.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
