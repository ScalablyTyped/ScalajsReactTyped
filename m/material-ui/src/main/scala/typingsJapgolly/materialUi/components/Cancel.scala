...
import typingsJapgolly.materialUi.svgIconsNavigationCancelMod.default
...
object Cancel {
  ...
  implicit def make(companion: Cancel.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
