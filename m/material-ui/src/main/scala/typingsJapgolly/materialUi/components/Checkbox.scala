...
object Checkbox {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.materialUi.mod.Checkbox] {
    ...
    ): this.type = set("onCheck", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[js.Object & org.scalajs.dom.Element], t1: /* checked */ Boolean) => (value(t0, t1)).runNow()))
