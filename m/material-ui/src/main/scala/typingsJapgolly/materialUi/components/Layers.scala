...
import typingsJapgolly.materialUi.svgIconsMapsLayersMod.default
...
object Layers {
  ...
  implicit def make(companion: Layers.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
