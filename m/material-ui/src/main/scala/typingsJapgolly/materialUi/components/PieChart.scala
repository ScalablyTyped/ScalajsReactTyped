...
import typingsJapgolly.materialUi.svgIconsEditorPieChartMod.default
...
object PieChart {
  ...
  implicit def make(companion: PieChart.type): SharedBuilder_SvgIconProps_115160895[default] = new SharedBuilder_SvgIconProps_115160895[default](js.Array(this.component, js.Dictionary.empty))()
