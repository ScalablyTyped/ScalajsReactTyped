...
trait EnhancedSwitchProps extends CommonEnhancedSwitchProps[EnhancedSwitch] {
  ...
  var switchElement: japgolly.scalajs.react.raw.React.Element
...
object EnhancedSwitchProps {
  ...
  def apply(
    ...
    onSwitch: (/* e */ ReactMouseEventFrom[js.Object with Element], /* isInputChecked */ Boolean) => Callback = null,
    ...
    val __obj = js.Dynamic.literal(inputStyle = inputStyle.asInstanceOf[js.Any], inputType = inputType.asInstanceOf[js.Any], switched = switched.asInstanceOf[js.Any])
    __obj.updateDynamic("onParentShouldUpdate")(js.Any.fromFunction1((t0: scala.Boolean) => onParentShouldUpdate(t0).runNow()))
    if (switchElement != null) __obj.updateDynamic("switchElement")(switchElement.rawElement.asInstanceOf[js.Any])
    ...
    if (onSwitch != null) __obj.updateDynamic("onSwitch")(js.Any.fromFunction2((t0: /* e */ japgolly.scalajs.react.ReactMouseEventFrom[js.Object with org.scalajs.dom.raw.Element], t1: /* isInputChecked */ scala.Boolean) => onSwitch(t0, t1).runNow()))
