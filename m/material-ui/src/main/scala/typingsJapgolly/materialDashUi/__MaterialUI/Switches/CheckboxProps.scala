...
trait CheckboxProps extends CommonEnhancedSwitchProps[Checkbox] {
  ...
  var onCheck: js.UndefOr[
    js.Function2[
      /* event */ ReactMouseEventFrom[js.Object with org.scalajs.dom.raw.Element], 
      /* checked */ Boolean, 
      Unit
    ]
  ] = js.undefined
...
object CheckboxProps {
  ...
  def apply(
    ...
    onCheck: (/* event */ ReactMouseEventFrom[js.Object with org.scalajs.dom.raw.Element], /* checked */ Boolean) => Callback = null,
