...
import typingsJapgolly.materialDashUi.__MaterialUI.Switches.CheckboxProps
import typingsJapgolly.materialDashUi.checkboxMod.default
...
object Checkbox {
  def apply(
    ...
    onCheck: (/* event */ ReactMouseEventFrom[js.Object with Element], /* checked */ Boolean) => Callback = null,
    ...
    if (onCheck != null) __obj.updateDynamic("onCheck")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[js.Object with org.scalajs.dom.raw.Element], t1: /* checked */ scala.Boolean) => onCheck(t0, t1).runNow()))
