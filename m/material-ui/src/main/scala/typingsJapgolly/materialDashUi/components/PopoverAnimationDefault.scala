...
import typingsJapgolly.materialDashUi.__MaterialUI.Popover.PopoverAnimationDefaultProps
import typingsJapgolly.materialDashUi.__MaterialUI.propTypes.origin
import typingsJapgolly.materialDashUi.popoverPopoverAnimationDefaultMod.default
