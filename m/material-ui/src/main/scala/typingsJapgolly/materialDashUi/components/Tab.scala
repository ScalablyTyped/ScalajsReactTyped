...
import typingsJapgolly.materialDashUi.__MaterialUI.Tabs.TabProps
import typingsJapgolly.materialDashUi.tabsTabMod.default
...
object Tab {
  def apply(
    ...
    label: VdomNode = null,
    onActive: /* tab */ typingsJapgolly.materialDashUi.__MaterialUI.Tabs.Tab => Callback = null,
    ...
    if (onActive != null) __obj.updateDynamic("onActive")(js.Any.fromFunction1((t0: /* tab */ typingsJapgolly.materialDashUi.__MaterialUI.Tabs.Tab) => onActive(t0).runNow()))
  ...
  typingsJapgolly.materialDashUi.__MaterialUI.Tabs.TabProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.materialDashUi.tabsTabMod.default](js.constructorOf[typingsJapgolly.materialDashUi.tabsTabMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.materialDashUi.__MaterialUI.Tabs.TabProps])(children: _*)
  }
}
