...
import typingsJapgolly.materialDashUi.internalEnhancedSwitchMod.EnhancedSwitchProps
import typingsJapgolly.materialDashUi.internalEnhancedSwitchMod.default
