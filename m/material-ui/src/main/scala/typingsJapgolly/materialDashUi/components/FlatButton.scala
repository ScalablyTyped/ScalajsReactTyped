...
import typingsJapgolly.materialDashUi.__MaterialUI.FlatButtonProps
import typingsJapgolly.materialDashUi.flatButtonMod.default
...
object FlatButton {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[FlatButtonProps, default, Unit, FlatButtonProps] = {
