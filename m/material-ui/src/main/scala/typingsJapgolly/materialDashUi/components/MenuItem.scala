...
import typingsJapgolly.materialDashUi.__MaterialUI.Menus.MenuItemProps
import typingsJapgolly.materialDashUi.__MaterialUI.Popover.PopoverAnimationProps
import typingsJapgolly.materialDashUi.menuItemMod.default
...
object MenuItem {
  def apply(
    ...
    onNestedListToggle: /* item */ typingsJapgolly.materialDashUi.__MaterialUI.List.ListItem => Callback = null,
    ...
    if (menuItems != null) __obj.updateDynamic("menuItems")(menuItems.rawNode.asInstanceOf[js.Any])
    ...
    if (onNestedListToggle != null) __obj.updateDynamic("onNestedListToggle")(js.Any.fromFunction1((t0: /* item */ typingsJapgolly.materialDashUi.__MaterialUI.List.ListItem) => onNestedListToggle(t0).runNow()))
  ...
  typingsJapgolly.materialDashUi.menuItemMod.default](js.constructorOf[typingsJapgolly.materialDashUi.menuItemMod.default])
