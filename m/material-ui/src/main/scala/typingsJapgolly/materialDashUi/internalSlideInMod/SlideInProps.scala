package typingsJapgolly.materialDashUi.internalSlideInMod
...
trait SlideInProps extends Props[SlideIn] {
  ...
  var direction: js.UndefOr[typingsJapgolly.materialDashUi.__MaterialUI.propTypes.direction] = js.undefined
