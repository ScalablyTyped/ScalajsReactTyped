...
import typingsJapgolly.matomoTrackerReactNative.anon.Cid
import typingsJapgolly.matomoTrackerReactNative.anon.TrackAction
import typingsJapgolly.matomoTrackerReactNative.anon.Uid
...
object mod {
  ...
  object MatomoProviderProps {
    ...
    inline def apply(children: VdomElement, instance: MatomoTracker): MatomoProviderProps = {
      val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], instance = instance.asInstanceOf[js.Any])
