...
import typingsJapgolly.muicss.reactMod.TextareaProps
...
object Textarea {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.muicss.reactMod.Textarea] {
    ...
    inline def floatingLabel(value: Boolean): this.type = set("floatingLabel", value.asInstanceOf[js.Any])
    
    inline def form(value: String): this.type = set("form", value.asInstanceOf[js.Any])
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def hint(value: String): this.type = set("hint", value.asInstanceOf[js.Any])
    ...
    inline def inputRef(value: Ref[HTMLTextAreaElement]): this.type = set("inputRef", value.asInstanceOf[js.Any])
    
    inline def inputRefFunction1(value: HTMLTextAreaElement | Null => Callback): this.type = set("inputRef", js.Any.fromFunction1((t0: HTMLTextAreaElement | Null) => value(t0).runNow()))
    
    inline def inputRefNull: this.type = set("inputRef", null)
    
    inline def invalid(value: Boolean): this.type = set("invalid", value.asInstanceOf[js.Any])
    ...
    inline def onLabelClick(value: ReactMouseEventFrom[HTMLInputElement & org.scalajs.dom.Element] => Callback): this.type = set("onLabelClick", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLInputElement & org.scalajs.dom.Element]) => value(t0).runNow()))
