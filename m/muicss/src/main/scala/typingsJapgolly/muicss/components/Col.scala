...
import typingsJapgolly.muicss.reactMod.ColProps
...
object Col {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.muicss.reactMod.Col] {
    ...
    inline def `lg-offset`(value: Double): this.type = set("lg-offset", value.asInstanceOf[js.Any])
    
    inline def md(value: Double): this.type = set("md", value.asInstanceOf[js.Any])
    
    inline def `md-offset`(value: Double): this.type = set("md-offset", value.asInstanceOf[js.Any])
    ...
    inline def `sm-offset`(value: Double): this.type = set("sm-offset", value.asInstanceOf[js.Any])
    ...
    inline def xl(value: Double): this.type = set("xl", value.asInstanceOf[js.Any])
    
    inline def `xl-offset`(value: Double): this.type = set("xl-offset", value.asInstanceOf[js.Any])
    
    inline def xs(value: Double): this.type = set("xs", value.asInstanceOf[js.Any])
    
    inline def `xs-offset`(value: Double): this.type = set("xs-offset", value.asInstanceOf[js.Any])
  }
