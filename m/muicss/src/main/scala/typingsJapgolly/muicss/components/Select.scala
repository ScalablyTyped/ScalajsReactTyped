...
import typingsJapgolly.muicss.reactMod.SelectProps
...
object Select {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.muicss.reactMod.Select] {
    ...
    inline def useDefault(value: Boolean): this.type = set("useDefault", value.asInstanceOf[js.Any])
