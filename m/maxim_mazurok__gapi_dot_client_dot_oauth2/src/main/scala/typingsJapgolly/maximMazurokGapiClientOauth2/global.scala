...
import typingsJapgolly.maximMazurokGapiClientOauth2.gapi.client.oauth2.UserinfoResource
import typingsJapgolly.maximMazurokGapiClientOauth2.maximMazurokGapiClientOauth2Strings.oauth2
import typingsJapgolly.maximMazurokGapiClientOauth2.maximMazurokGapiClientOauth2Strings.v2
