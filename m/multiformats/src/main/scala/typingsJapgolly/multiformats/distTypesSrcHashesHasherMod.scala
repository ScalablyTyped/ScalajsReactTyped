...
object distTypesSrcHashesHasherMod {
  ...
  open class Hasher[Name /* <: String */, Code /* <: Double */] protected ()
    extends StObject
       with typingsJapgolly.multiformats.distTypesSrcHashesInterfaceMod.MultihashHasher[Double] {
    /**
      *
      * @param {Name} name
      * @param {Code} code
  ...
  type MultihashHasher[Alg /* <: Double */] = typingsJapgolly.multiformats.distTypesSrcHashesInterfaceMod.MultihashHasher[Double]
}
