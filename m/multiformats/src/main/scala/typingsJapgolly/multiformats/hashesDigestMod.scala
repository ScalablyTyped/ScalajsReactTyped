...
import typingsJapgolly.multiformats.distTypesSrcHashesDigestMod.MultihashDigest
...
object hashesDigestMod {
  ...
  open class Digest[Code /* <: Double */, Size /* <: Double */] protected ()
    extends typingsJapgolly.multiformats.distTypesSrcHashesDigestMod.Digest[Code, Size] {
    /**
