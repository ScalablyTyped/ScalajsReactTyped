...
trait RemainingValue
  ...
  var value: CID[Any, Double, Double, typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version]
}
object RemainingValue {
  
  inline def apply(
    remaining: String,
    value: CID[Any, Double, Double, typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version]
  ): RemainingValue = {
  ...
  extension [Self <: RemainingValue](x: Self) {
    ...
    inline def setValue(value: CID[Any, Double, Double, typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
  }
}
