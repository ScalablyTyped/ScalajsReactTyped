...
import typingsJapgolly.multiformats.mod.digest.Digest
...
trait Code extends StObject {
  ...
  def digest(input: js.typedarray.Uint8Array): Digest[typingsJapgolly.multiformats.multiformatsInts.`0`, Double]
...
object Code {
  ...
  inline def apply(
    code: Double,
    digest: js.typedarray.Uint8Array => Digest[typingsJapgolly.multiformats.multiformatsInts.`0`, Double],
  ...
  extension [Self <: Code](x: Self) {
    ...
    inline def setDigest(
      value: js.typedarray.Uint8Array => Digest[typingsJapgolly.multiformats.multiformatsInts.`0`, Double]
    ): Self = StObject.set(x, "digest", js.Any.fromFunction1(value))
