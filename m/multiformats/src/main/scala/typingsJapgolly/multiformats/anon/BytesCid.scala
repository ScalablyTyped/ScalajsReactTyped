...
import typingsJapgolly.multiformats.distTypesSrcCodecsInterfaceMod.BlockDecoder
import typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Link
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait BytesCid[T /* <: Any */, Code /* <: Double */, Alg /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */] extends StObject {
...
object BytesCid {
  ...
  inline def apply[T /* <: Any */, Code /* <: Double */, Alg /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */](bytes: ByteView[T], cid: Link[T, Code, Alg, V], codec: BlockDecoder[Code, T]): BytesCid[T, Code, Alg, V] = {
  ...
  extension [Self <: BytesCid[?, ?, ?, ?], T /* <: Any */, Code /* <: Double */, Alg /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */](x: Self & (BytesCid[T, Code, Alg, V])) {
