...
trait Value[T /* <: Any */, Code /* <: Double */, Alg /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */] extends StObject {
...
object Value {
  ...
  inline def apply[T /* <: Any */, Code /* <: Double */, Alg /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */](bytes: ByteView[T], cid: Link[T, Code, Alg, V], value: T): Value[T, Code, Alg, V] = {
  ...
  extension [Self <: Value[?, ?, ?, ?], T /* <: Any */, Code /* <: Double */, Alg /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */](x: Self & (Value[T, Code, Alg, V])) {
