...
trait Bytes[T /* <: Any */, C /* <: Double */, A /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */] extends StObject {
...
object Bytes {
  ...
  inline def apply[T /* <: Any */, C /* <: Double */, A /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */](bytes: ByteView[T], cid: CID[T, C, A, V], value: T): Bytes[T, C, A, V] = {
  ...
  extension [Self <: Bytes[?, ?, ?, ?], T /* <: Any */, C /* <: Double */, A /* <: Double */, V /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */](x: Self & (Bytes[T, C, A, V])) {
