...
object distTypesSrcHashesDigestMod {
  ...
  open class Digest[Code /* <: Double */, Size /* <: Double */] protected ()
    extends StObject
       with typingsJapgolly.multiformats.distTypesSrcHashesInterfaceMod.MultihashDigest[Double] {
    /**
  ...
  type MultihashDigest = typingsJapgolly.multiformats.distTypesSrcHashesInterfaceMod.MultihashDigest[Double]
}
