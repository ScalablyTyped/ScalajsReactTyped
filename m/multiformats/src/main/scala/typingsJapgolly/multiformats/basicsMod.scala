...
object basicsMod {
  ...
  open class CID[Data /* <: Any */, Format /* <: Double */, Alg /* <: Double */, Version /* <: typingsJapgolly.multiformats.distTypesSrcLinkInterfaceMod.Version */] protected ()
    extends typingsJapgolly.multiformats.distTypesSrcBasicsMod.CID[Data, Format, Alg, Version] {
    /**
  ...
  object digest {
    ...
    open class Digest[Code /* <: Double */, Size /* <: Double */] protected ()
      extends typingsJapgolly.multiformats.distTypesSrcBasicsMod.digest.Digest[Code, Size] {
      /**
  ...
  object hasher {
    ...
    open class Hasher[Name /* <: String */, Code /* <: Double */] protected ()
      extends typingsJapgolly.multiformats.distTypesSrcBasicsMod.hasher.Hasher[Name, Code] {
      /**
        *
        * @param {Name} name
        * @param {Code} code
