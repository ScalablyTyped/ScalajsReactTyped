...
import typingsJapgolly.maximMazurokGapiClientReseller.gapi.client.reseller.Subscription
...
object Resource {
  ...
  inline def apply(customerId: String, resource: Subscription): Resource = {
