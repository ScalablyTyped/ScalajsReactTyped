...
import typingsJapgolly.maximMazurokGapiClientDfareporting.anon.Active
import typingsJapgolly.maximMazurokGapiClientDfareporting.anon.ActivityFilters
import typingsJapgolly.maximMazurokGapiClientDfareporting.anon.Breakdown
import typingsJapgolly.maximMazurokGapiClientDfareporting.anon.ConversionDimensions
import typingsJapgolly.maximMazurokGapiClientDfareporting.anon.EmailOwner
...
trait Report extends StObject {
  ...
  var criteria: js.UndefOr[typingsJapgolly.maximMazurokGapiClientDfareporting.anon.Activities] = js.undefined
  ...
  var floodlightCriteria: js.UndefOr[typingsJapgolly.maximMazurokGapiClientDfareporting.anon.CustomRichMediaEvents] = js.undefined
  ...
  var reachCriteria: js.UndefOr[typingsJapgolly.maximMazurokGapiClientDfareporting.anon.DateRange] = js.undefined
...
object Report {
  ...
  extension [Self <: Report](x: Self) {
    ...
    inline def setCriteria(value: typingsJapgolly.maximMazurokGapiClientDfareporting.anon.Activities): Self = StObject.set(x, "criteria", value.asInstanceOf[js.Any])
    ...
    inline def setFloodlightCriteria(value: typingsJapgolly.maximMazurokGapiClientDfareporting.anon.CustomRichMediaEvents): Self = StObject.set(x, "floodlightCriteria", value.asInstanceOf[js.Any])
    ...
    inline def setReachCriteria(value: typingsJapgolly.maximMazurokGapiClientDfareporting.anon.DateRange): Self = StObject.set(x, "reachCriteria", value.asInstanceOf[js.Any])
