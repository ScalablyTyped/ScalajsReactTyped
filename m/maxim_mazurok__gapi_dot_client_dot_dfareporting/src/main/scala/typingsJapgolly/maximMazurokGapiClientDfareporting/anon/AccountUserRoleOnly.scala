...
object AccountUserRoleOnly {
  ...
  inline def apply(profileId: String): AccountUserRoleOnly = {
  ...
  extension [Self <: AccountUserRoleOnly](x: Self) {
    ...
    inline def setAccountUserRoleOnly(value: Boolean): Self = StObject.set(x, "accountUserRoleOnly", value.asInstanceOf[js.Any])
