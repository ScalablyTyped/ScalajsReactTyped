...
import typingsJapgolly.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.Campaign
...
object FieldsKey {
  ...
  inline def apply(profileId: String, resource: Campaign): FieldsKey = {
