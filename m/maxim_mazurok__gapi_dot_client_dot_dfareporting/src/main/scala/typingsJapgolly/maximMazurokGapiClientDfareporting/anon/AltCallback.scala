...
import typingsJapgolly.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.Advertiser
...
object AltCallback {
  ...
  inline def apply(id: String, profileId: String, resource: Advertiser): AltCallback = {
