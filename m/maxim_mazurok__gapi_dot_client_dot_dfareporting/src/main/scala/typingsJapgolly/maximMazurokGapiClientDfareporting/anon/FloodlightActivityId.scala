...
trait FloodlightActivityId extends StObject {
...
object FloodlightActivityId {
  
  inline def apply(profileId: String): FloodlightActivityId = {
    val __obj = js.Dynamic.literal(profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[FloodlightActivityId]
  }
  
  extension [Self <: FloodlightActivityId](x: Self) {
