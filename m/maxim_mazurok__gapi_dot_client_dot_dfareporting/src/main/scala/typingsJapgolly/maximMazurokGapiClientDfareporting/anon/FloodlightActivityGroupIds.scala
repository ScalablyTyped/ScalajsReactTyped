...
trait FloodlightActivityGroupIds extends StObject {
  ...
  var floodlightActivityGroupIds: js.UndefOr[String | js.Array[String]] = js.undefined
...
object FloodlightActivityGroupIds {
  ...
  inline def apply(profileId: String): FloodlightActivityGroupIds = {
  ...
  extension [Self <: FloodlightActivityGroupIds](x: Self) {
    ...
    inline def setFloodlightActivityGroupIds(value: String | js.Array[String]): Self = StObject.set(x, "floodlightActivityGroupIds", value.asInstanceOf[js.Any])
