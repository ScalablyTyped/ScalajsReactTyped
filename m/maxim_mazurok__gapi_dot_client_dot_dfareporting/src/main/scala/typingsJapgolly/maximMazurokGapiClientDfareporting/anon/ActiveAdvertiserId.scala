...
trait ActiveAdvertiserId extends StObject {
...
object ActiveAdvertiserId {
  
  inline def apply(advertiserId: String, profileId: String): ActiveAdvertiserId = {
    val __obj = js.Dynamic.literal(advertiserId = advertiserId.asInstanceOf[js.Any], profileId = profileId.asInstanceOf[js.Any])
    __obj.asInstanceOf[ActiveAdvertiserId]
  }
  
  extension [Self <: ActiveAdvertiserId](x: Self) {
