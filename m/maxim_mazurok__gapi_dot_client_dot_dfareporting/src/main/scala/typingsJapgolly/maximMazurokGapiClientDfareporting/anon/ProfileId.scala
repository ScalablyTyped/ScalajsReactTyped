...
import typingsJapgolly.maximMazurokGapiClientDfareporting.gapi.client.dfareporting.Ad
...
object ProfileId {
  ...
  inline def apply(profileId: String, resource: Ad): ProfileId = {
  ...
  extension [Self <: ProfileId](x: Self) {
    ...
    inline def setResource(value: Ad): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
