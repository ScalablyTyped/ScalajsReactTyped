...
import typingsJapgolly.maximMazurokGapiClientPubsublite.anon.AccesstokenAlt
...
import typingsJapgolly.maximMazurokGapiClientPubsublite.anon.SkipBacklog
import typingsJapgolly.maximMazurokGapiClientPubsublite.anon.SubscriptionId
import typingsJapgolly.maximMazurokGapiClientPubsublite.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientPubsublite.anon.Xgafv
...
trait SubscriptionsResource extends StObject {
  ...
  def commitCursor(request: typingsJapgolly.maximMazurokGapiClientPubsublite.anon.Subscription): Request[js.Object] = js.native
