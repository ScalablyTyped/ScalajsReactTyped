...
trait Key extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic
...
object Key {
  ...
  inline def apply(
    parent: String,
    resource: typingsJapgolly.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic
  ): Key = {
  ...
  extension [Self <: Key](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientPubsublite.gapi.client.pubsublite.Topic): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
