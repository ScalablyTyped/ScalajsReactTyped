package typingsJapgolly.momentShortformat
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    trait Moment extends StObject {
      ...
      def short(withoutPreOrSuffix: Boolean, now: typingsJapgolly.momentShortformat.mod.momentAugmentingMod.Moment): String = js.native
      def short(withoutPreOrSuffix: Unit, now: typingsJapgolly.momentShortformat.mod.momentAugmentingMod.Moment): String = js.native
    }
  }
}
