...
import typingsJapgolly.mdastBuilder.anon.Align
import typingsJapgolly.mdastBuilder.anon.Alt
...
import typingsJapgolly.mdastBuilder.mdastBuilderStrings.ordered
import typingsJapgolly.mdastBuilder.mdastBuilderStrings.right
import typingsJapgolly.mdastBuilder.mdastBuilderStrings.unordered
...
object mod {
  ...
  inline def code(lang: String, value: String): typingsJapgolly.mdastBuilder.anon.Data = (^.asInstanceOf[js.Dynamic].applyDynamic("code")(lang.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Data]
  ...
  inline def link(url: String): typingsJapgolly.mdastBuilder.anon.Children = ^.asInstanceOf[js.Dynamic].applyDynamic("link")(url.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Children]
  inline def link(url: String, title: String): typingsJapgolly.mdastBuilder.anon.Children = (^.asInstanceOf[js.Dynamic].applyDynamic("link")(url.asInstanceOf[js.Any], title.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Children]
  inline def link(url: String, title: String, kids: js.Array[Node[Data]]): typingsJapgolly.mdastBuilder.anon.Children = (^.asInstanceOf[js.Dynamic].applyDynamic("link")(url.asInstanceOf[js.Any], title.asInstanceOf[js.Any], kids.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Children]
  inline def link(url: String, title: String, kids: js.Function0[Node[Data] | js.Array[Node[Data]]]): typingsJapgolly.mdastBuilder.anon.Children = (^.asInstanceOf[js.Dynamic].applyDynamic("link")(url.asInstanceOf[js.Any], title.asInstanceOf[js.Any], kids.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Children]
  inline def link(url: String, title: String, kids: Node[Data]): typingsJapgolly.mdastBuilder.anon.Children = (^.asInstanceOf[js.Dynamic].applyDynamic("link")(url.asInstanceOf[js.Any], title.asInstanceOf[js.Any], kids.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Children]
  inline def link(url: String, title: Unit, kids: js.Array[Node[Data]]): typingsJapgolly.mdastBuilder.anon.Children = (^.asInstanceOf[js.Dynamic].applyDynamic("link")(url.asInstanceOf[js.Any], title.asInstanceOf[js.Any], kids.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Children]
  inline def link(url: String, title: Unit, kids: js.Function0[Node[Data] | js.Array[Node[Data]]]): typingsJapgolly.mdastBuilder.anon.Children = (^.asInstanceOf[js.Dynamic].applyDynamic("link")(url.asInstanceOf[js.Any], title.asInstanceOf[js.Any], kids.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Children]
  inline def link(url: String, title: Unit, kids: Node[Data]): typingsJapgolly.mdastBuilder.anon.Children = (^.asInstanceOf[js.Dynamic].applyDynamic("link")(url.asInstanceOf[js.Any], title.asInstanceOf[js.Any], kids.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mdastBuilder.anon.Children]
