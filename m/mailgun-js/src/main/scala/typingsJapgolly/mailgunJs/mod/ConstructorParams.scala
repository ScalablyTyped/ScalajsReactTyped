...
import typingsJapgolly.mailgunJs.AnonInterval
...
object ConstructorParams {
  ...
  def apply(
    ...
    testModeLogger: (/* httpOptions */ LoggerHttpOptions, /* payload */ String, /* form */ typingsJapgolly.formData.mod.^) => Callback = null,
    ...
    if (testModeLogger != null) __obj.updateDynamic("testModeLogger")(js.Any.fromFunction3((t0: /* httpOptions */ typingsJapgolly.mailgunJs.mod.LoggerHttpOptions, t1: /* payload */ java.lang.String, t2: /* form */ typingsJapgolly.formData.mod.^) => testModeLogger(t0, t1, t2).runNow()))
