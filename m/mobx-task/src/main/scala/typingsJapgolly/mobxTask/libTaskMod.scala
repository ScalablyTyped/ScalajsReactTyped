...
import typingsJapgolly.mobxTask.mobxTaskStrings.error
import typingsJapgolly.mobxTask.mobxTaskStrings.result
import typingsJapgolly.mobxTask.mobxTaskStrings.state
import typingsJapgolly.mobxTask.mobxTaskStrings.swallow
...
object libTaskMod {
  ...
  @js.native
  trait TaskCreator[K /* <: /* keyof mobx-task.mobx-task/lib/task.TaskOptions<any, any> */ state | error | result | typingsJapgolly.mobxTask.mobxTaskStrings.args | swallow */]
    extends MethodDecorator
       with PropertyDecorator {
    
    def apply(options: Pick[TaskOptions[Any, Any], K]): MethodDecorator = js.native
    /**
  ...
  trait TaskFactory
    extends TaskCreator[
          /* keyof mobx-task.mobx-task/lib/task.TaskOptions<any, any> */ state | error | result | typingsJapgolly.mobxTask.mobxTaskStrings.args | swallow
        ] {
  ...
  object TaskMethods {
    ...
    inline def apply[A /* <: js.Array[Any] */, R](
      ...
      val __obj = js.Dynamic.literal(reset = reset.toJsFn, setState = js.Any.fromFunction1((t0: TaskOptions[A, R]) => setState(t0).runNow()), wrap = js.Any.fromFunction1(wrap))
    ...
    extension [Self <: TaskMethods[?, ?], A /* <: js.Array[Any] */, R](x: Self & (TaskMethods[A, R])) {
      ...
      inline def setSetState(value: TaskOptions[A, R] => Callback): Self = StObject.set(x, "setState", js.Any.fromFunction1((t0: TaskOptions[A, R]) => value(t0).runNow()))
  ...
  */
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    T extends std.Promise<infer P> ? P : T
    }}}
    */
  @js.native
  trait WithoutPromise[T] extends StObject
}
