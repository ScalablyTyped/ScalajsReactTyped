package typingsJapgolly.moxios
...
object mod {
  ...
  object Request {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(config = config.asInstanceOf[js.Any], headers = headers.asInstanceOf[js.Any], respondWith = js.Any.fromFunction1(respondWith), respondWithTimeout = respondWithTimeout.toJsFn, responseType = responseType.asInstanceOf[js.Any], timeout = timeout.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], withCredentials = withCredentials.asInstanceOf[js.Any])
    ...
    extension [Self <: Request](x: Self) {
      ...
      inline def setRespondWithTimeout(value: CallbackTo[js.Promise[Response]]): Self = StObject.set(x, "respondWithTimeout", value.toJsFn)
