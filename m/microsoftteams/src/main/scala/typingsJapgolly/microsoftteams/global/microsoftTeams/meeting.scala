...
import typingsJapgolly.microsoftteams.microsoftTeams.meeting.IMeetingDetails
import typingsJapgolly.microsoftteams.microsoftTeams.meeting.LiveStreamState
...
object meeting {
  ...
  object MeetingType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.microsoftteams.microsoftTeams.meeting.MeetingType & String] = js.native
    
    /* "Adhoc" */ val Adhoc: typingsJapgolly.microsoftteams.microsoftTeams.meeting.MeetingType.Adhoc & String = js.native
    
    /* "Broadcast" */ val Broadcast: typingsJapgolly.microsoftteams.microsoftTeams.meeting.MeetingType.Broadcast & String = js.native
    
    /* "MeetNow" */ val MeetNow: typingsJapgolly.microsoftteams.microsoftTeams.meeting.MeetingType.MeetNow & String = js.native
    
    /* "Recurring" */ val Recurring: typingsJapgolly.microsoftteams.microsoftTeams.meeting.MeetingType.Recurring & String = js.native
    
    /* "Scheduled" */ val Scheduled: typingsJapgolly.microsoftteams.microsoftTeams.meeting.MeetingType.Scheduled & String = js.native
    
    /* "Unknown" */ val Unknown: typingsJapgolly.microsoftteams.microsoftTeams.meeting.MeetingType.Unknown & String = js.native
  }
