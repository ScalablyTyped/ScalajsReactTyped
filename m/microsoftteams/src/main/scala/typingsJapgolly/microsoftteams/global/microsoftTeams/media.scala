...
import typingsJapgolly.microsoftteams.microsoftTeams.media.BarCodeConfig
import typingsJapgolly.microsoftteams.microsoftTeams.media.FileFormat
import typingsJapgolly.microsoftteams.microsoftTeams.media.ImageUri
import typingsJapgolly.microsoftteams.microsoftTeams.media.MediaInputs
...
object media {
  ...
  object CameraStartMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.microsoftteams.microsoftTeams.media.CameraStartMode & Double] = js.native
    
    /* 4 */ val BusinessCard: typingsJapgolly.microsoftteams.microsoftTeams.media.CameraStartMode.BusinessCard & Double = js.native
    
    /* 2 */ val Document: typingsJapgolly.microsoftteams.microsoftTeams.media.CameraStartMode.Document & Double = js.native
    
    /* 1 */ val Photo: typingsJapgolly.microsoftteams.microsoftTeams.media.CameraStartMode.Photo & Double = js.native
    
    /* 3 */ val Whiteboard: typingsJapgolly.microsoftteams.microsoftTeams.media.CameraStartMode.Whiteboard & Double = js.native
  }
  ...
  open class File ()
    extends StObject
       with typingsJapgolly.microsoftteams.microsoftTeams.media.File {
  ...
  object FileFormat extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.microsoftteams.microsoftTeams.media.FileFormat & String] = js.native
    
    /* "base64" */ val Base64: typingsJapgolly.microsoftteams.microsoftTeams.media.FileFormat.Base64 & String = js.native
    
    /* "id" */ val ID: typingsJapgolly.microsoftteams.microsoftTeams.media.FileFormat.ID & String = js.native
  }
  ...
  object ImageUriType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.microsoftteams.microsoftTeams.media.ImageUriType & Double] = js.native
    
    /* 1 */ val ID: typingsJapgolly.microsoftteams.microsoftTeams.media.ImageUriType.ID & Double = js.native
    
    /* 2 */ val URL: typingsJapgolly.microsoftteams.microsoftTeams.media.ImageUriType.URL & Double = js.native
  }
  ...
  open class Media ()
    extends StObject
       with typingsJapgolly.microsoftteams.microsoftTeams.media.Media {
    def this(that: typingsJapgolly.microsoftteams.microsoftTeams.media.Media) = this()
  ...
  object MediaType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.microsoftteams.microsoftTeams.media.MediaType & Double] = js.native
    
    /* 4 */ val Audio: typingsJapgolly.microsoftteams.microsoftTeams.media.MediaType.Audio & Double = js.native
    
    /* 1 */ val Image: typingsJapgolly.microsoftteams.microsoftTeams.media.MediaType.Image & Double = js.native
  }
  ...
  object Source extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.microsoftteams.microsoftTeams.media.Source & Double] = js.native
    
    /* 1 */ val Camera: typingsJapgolly.microsoftteams.microsoftTeams.media.Source.Camera & Double = js.native
    
    /* 2 */ val Gallery: typingsJapgolly.microsoftteams.microsoftTeams.media.Source.Gallery & Double = js.native
  }
  ...
  inline def captureImage(
    callback: js.Function2[
      /* error */ SdkError, 
      /* files */ js.Array[typingsJapgolly.microsoftteams.microsoftTeams.media.File], 
      Unit
    ]
  ...
  inline def selectMedia(
    ...
    callback: js.Function2[
      /* error */ SdkError, 
      /* attachments */ js.Array[typingsJapgolly.microsoftteams.microsoftTeams.media.Media], 
      Unit
    ]
