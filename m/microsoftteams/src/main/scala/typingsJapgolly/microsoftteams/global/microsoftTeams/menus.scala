...
import typingsJapgolly.microsoftteams.microsoftTeams.menus.ActionMenuParameters
import typingsJapgolly.microsoftteams.microsoftTeams.menus.ViewConfiguration
import typingsJapgolly.microsoftteams.microsoftTeams.menus.ViewData
...
object menus {
  ...
  open class MenuItem ()
    extends StObject
       with typingsJapgolly.microsoftteams.microsoftTeams.menus.MenuItem {
  ...
  object MenuListType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.microsoftteams.microsoftTeams.menus.MenuListType & String] = js.native
    
    /* "dropDown" */ val dropDown: typingsJapgolly.microsoftteams.microsoftTeams.menus.MenuListType.dropDown & String = js.native
    
    /* "popOver" */ val popOver: typingsJapgolly.microsoftteams.microsoftTeams.menus.MenuListType.popOver & String = js.native
  }
  ...
  inline def setNavBarMenu(
    items: js.Array[typingsJapgolly.microsoftteams.microsoftTeams.menus.MenuItem],
