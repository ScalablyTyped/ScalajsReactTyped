...
import typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.IExpectedFailureRequest
import typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.IFailedRequest
...
object appInitialization {
  ...
  object ExpectedFailureReason extends StObject {
    ...
    def apply(value: String): js.UndefOr[
        typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.ExpectedFailureReason & String
      ] = js.native
    
    /* "NotFound" */ val NotFound: typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.ExpectedFailureReason.NotFound & String = js.native
    
    /* "Offline" */ val Offline: typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.ExpectedFailureReason.Offline & String = js.native
    
    /* "Other" */ val Other: typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.ExpectedFailureReason.Other & String = js.native
    
    /* "PermissionError" */ val PermissionError: typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.ExpectedFailureReason.PermissionError & String = js.native
    
    /* "Throttling" */ val Throttling: typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.ExpectedFailureReason.Throttling & String = js.native
  }
  ...
  object FailedReason extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[
        typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.FailedReason & String
      ] = js.native
    
    /* "AuthFailed" */ val AuthFailed: typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.FailedReason.AuthFailed & String = js.native
    
    /* "Other" */ val Other: typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.FailedReason.Other & String = js.native
    
    /* "Timeout" */ val Timeout: typingsJapgolly.microsoftteams.microsoftTeams.appInitialization.FailedReason.Timeout & String = js.native
  }
