...
import typingsJapgolly.microsoftteams.microsoftTeams.bot.AuthQueryRequest
import typingsJapgolly.microsoftteams.microsoftTeams.bot.Command
import typingsJapgolly.microsoftteams.microsoftTeams.bot.QueryRequest
import typingsJapgolly.microsoftteams.microsoftTeams.bot.QueryResponse
import typingsJapgolly.microsoftteams.microsoftTeams.bot.Results
...
object bot {
  ...
  object ResponseType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.microsoftteams.microsoftTeams.bot.ResponseType & String] = js.native
    
    /* "Auth" */ val Auth: typingsJapgolly.microsoftteams.microsoftTeams.bot.ResponseType.Auth & String = js.native
    
    /* "Results" */ val Results: typingsJapgolly.microsoftteams.microsoftTeams.bot.ResponseType.Results & String = js.native
  }
