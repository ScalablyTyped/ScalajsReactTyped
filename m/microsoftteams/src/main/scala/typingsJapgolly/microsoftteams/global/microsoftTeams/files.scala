...
import typingsJapgolly.microsoftteams.microsoftTeams.FileOpenPreference.Inline
import typingsJapgolly.microsoftteams.microsoftTeams.FileOpenPreference.Web
import typingsJapgolly.microsoftteams.microsoftTeams.SdkError
import typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageFolder
import typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageFolderItem
import typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProvider
...
object files {
  ...
  object CloudStorageProvider extends StObject {
    ...
    def apply(value: String): js.UndefOr[
        typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProvider & String
      ] = js.native
    
    /* "BOX" */ val Box: typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProvider.Box & String = js.native
    
    /* "DROPBOX" */ val Dropbox: typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProvider.Dropbox & String = js.native
    
    /* "EGNYTE" */ val Egnyte: typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProvider.Egnyte & String = js.native
    
    /* "GOOGLEDRIVE" */ val GoogleDrive: typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProvider.GoogleDrive & String = js.native
    
    /* "SHAREFILE" */ val Sharefile: typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProvider.Sharefile & String = js.native
  }
  ...
  object CloudStorageProviderType extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProviderType & Double
      ] = js.native
    
    /* 2 */ val Google: typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProviderType.Google & Double = js.native
    
    /* 0 */ val Sharepoint: typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProviderType.Sharepoint & Double = js.native
    
    /* 1 */ val WopiIntegration: typingsJapgolly.microsoftteams.microsoftTeams.files.CloudStorageProviderType.WopiIntegration & Double = js.native
  }
