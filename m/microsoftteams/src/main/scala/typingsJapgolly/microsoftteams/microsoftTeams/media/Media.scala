...
object Media {
  ...
  inline def apply(
    content: String,
    format: FileFormat,
    getMedia: js.Function2[/* error */ SdkError, /* blob */ Blob, Unit] => Callback,
    ...
    val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], format = format.asInstanceOf[js.Any], getMedia = js.Any.fromFunction1((t0: js.Function2[/* error */ SdkError, /* blob */ Blob, Unit]) => getMedia(t0).runNow()), getMediaViaCallback = getMediaViaCallback.asInstanceOf[js.Any], getMediaViaHandler = getMediaViaHandler.asInstanceOf[js.Any], mimeType = mimeType.asInstanceOf[js.Any], preview = preview.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any])
    __obj.asInstanceOf[Media]
  }
  
  extension [Self <: Media](x: Self) {
    
    inline def setGetMedia(value: js.Function2[/* error */ SdkError, /* blob */ Blob, Unit] => Callback): Self = StObject.set(x, "getMedia", js.Any.fromFunction1((t0: js.Function2[/* error */ SdkError, /* blob */ Blob, Unit]) => value(t0).runNow()))
