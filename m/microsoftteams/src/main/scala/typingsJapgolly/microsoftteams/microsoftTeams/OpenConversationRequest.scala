...
object OpenConversationRequest {
  ...
  extension [Self <: OpenConversationRequest](x: Self) {
    ...
    inline def setOnCloseConversation(value: /* conversationResponse */ ConversationResponse => Callback): Self = StObject.set(x, "onCloseConversation", js.Any.fromFunction1((t0: /* conversationResponse */ ConversationResponse) => value(t0).runNow()))
    
    inline def setOnCloseConversationUndefined: Self = StObject.set(x, "onCloseConversation", js.undefined)
    
    inline def setOnStartConversation(value: /* conversationResponse */ ConversationResponse => Callback): Self = StObject.set(x, "onStartConversation", js.Any.fromFunction1((t0: /* conversationResponse */ ConversationResponse) => value(t0).runNow()))
