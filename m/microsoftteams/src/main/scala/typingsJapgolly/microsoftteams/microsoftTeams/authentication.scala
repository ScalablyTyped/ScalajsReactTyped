...
object authentication {
  ...
  object AuthTokenRequest {
    ...
    extension [Self <: AuthTokenRequest](x: Self) {
      ...
      inline def setFailureCallback(value: /* reason */ String => Callback): Self = StObject.set(x, "failureCallback", js.Any.fromFunction1((t0: /* reason */ String) => value(t0).runNow()))
      ...
      inline def setSuccessCallback(value: /* token */ String => Callback): Self = StObject.set(x, "successCallback", js.Any.fromFunction1((t0: /* token */ String) => value(t0).runNow()))
  ...
  object AuthenticateParameters {
    ...
    extension [Self <: AuthenticateParameters](x: Self) {
      ...
      inline def setFailureCallback(value: /* reason */ js.UndefOr[String] => Callback): Self = StObject.set(x, "failureCallback", js.Any.fromFunction1((t0: /* reason */ js.UndefOr[String]) => value(t0).runNow()))
      ...
      inline def setSuccessCallback(value: /* result */ js.UndefOr[String] => Callback): Self = StObject.set(x, "successCallback", js.Any.fromFunction1((t0: /* result */ js.UndefOr[String]) => value(t0).runNow()))
  ...
  object UserRequest {
    ...
    extension [Self <: UserRequest](x: Self) {
      ...
      inline def setSuccessCallback(value: /* user */ UserProfile => Callback): Self = StObject.set(x, "successCallback", js.Any.fromFunction1((t0: /* user */ UserProfile) => value(t0).runNow()))
