...
trait GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata extends StObject {
...
object GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata {
  ...
  inline def apply(): GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata]
  }
  
  extension [Self <: GoogleCloudDialogflowV2beta1ClearSuggestionFeatureConfigOperationMetadata](x: Self) {
