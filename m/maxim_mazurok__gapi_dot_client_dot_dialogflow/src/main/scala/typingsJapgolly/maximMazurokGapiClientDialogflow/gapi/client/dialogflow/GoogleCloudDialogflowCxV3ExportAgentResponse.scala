...
trait GoogleCloudDialogflowCxV3ExportAgentResponse extends StObject {
...
object GoogleCloudDialogflowCxV3ExportAgentResponse {
  
  inline def apply(): GoogleCloudDialogflowCxV3ExportAgentResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3ExportAgentResponse]
  }
  
  extension [Self <: GoogleCloudDialogflowCxV3ExportAgentResponse](x: Self) {
