...
trait GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo extends StObject {
  ...
  var parameters: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.dialogflow.gapi.client.dialogflow.GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue} */ js.Any
  ] = js.undefined
}
object GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo {
  ...
  extension [Self <: GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfo](x: Self) {
    ...
    inline def setParameters(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.dialogflow.gapi.client.dialogflow.GoogleCloudDialogflowCxV3beta1WebhookRequestIntentInfoIntentParameterValue} */ js.Any
