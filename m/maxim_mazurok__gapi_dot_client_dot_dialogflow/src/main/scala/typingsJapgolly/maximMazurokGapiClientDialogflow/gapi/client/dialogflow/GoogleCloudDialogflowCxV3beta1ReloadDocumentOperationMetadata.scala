...
trait GoogleCloudDialogflowCxV3beta1ReloadDocumentOperationMetadata extends StObject {
...
object GoogleCloudDialogflowCxV3beta1ReloadDocumentOperationMetadata {
  
  inline def apply(): GoogleCloudDialogflowCxV3beta1ReloadDocumentOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3beta1ReloadDocumentOperationMetadata]
  }
  
  extension [Self <: GoogleCloudDialogflowCxV3beta1ReloadDocumentOperationMetadata](x: Self) {
