...
trait GoogleCloudDialogflowV2QueryResult extends StObject {
  ...
  var sentimentAnalysisResult: js.UndefOr[GoogleCloudDialogflowV2SentimentAnalysisResult] = js.undefined
...
object GoogleCloudDialogflowV2QueryResult {
  ...
  extension [Self <: GoogleCloudDialogflowV2QueryResult](x: Self) {
    ...
    inline def setSentimentAnalysisResult(value: GoogleCloudDialogflowV2SentimentAnalysisResult): Self = StObject.set(x, "sentimentAnalysisResult", value.asInstanceOf[js.Any])
