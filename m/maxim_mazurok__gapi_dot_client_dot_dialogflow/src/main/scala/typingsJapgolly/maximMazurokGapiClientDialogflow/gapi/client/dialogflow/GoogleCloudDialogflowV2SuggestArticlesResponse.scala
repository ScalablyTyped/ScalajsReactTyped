...
trait GoogleCloudDialogflowV2SuggestArticlesResponse extends StObject {
  
  /** Articles ordered by score in descending order. */
  var articleAnswers: js.UndefOr[js.Array[GoogleCloudDialogflowV2ArticleAnswer]] = js.undefined
...
object GoogleCloudDialogflowV2SuggestArticlesResponse {
  
  inline def apply(): GoogleCloudDialogflowV2SuggestArticlesResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowV2SuggestArticlesResponse]
  }
  
  extension [Self <: GoogleCloudDialogflowV2SuggestArticlesResponse](x: Self) {
    
    inline def setArticleAnswers(value: js.Array[GoogleCloudDialogflowV2ArticleAnswer]): Self = StObject.set(x, "articleAnswers", value.asInstanceOf[js.Any])
    
    inline def setArticleAnswersUndefined: Self = StObject.set(x, "articleAnswers", js.undefined)
    
    inline def setArticleAnswersVarargs(value: GoogleCloudDialogflowV2ArticleAnswer*): Self = StObject.set(x, "articleAnswers", js.Array(value*))
