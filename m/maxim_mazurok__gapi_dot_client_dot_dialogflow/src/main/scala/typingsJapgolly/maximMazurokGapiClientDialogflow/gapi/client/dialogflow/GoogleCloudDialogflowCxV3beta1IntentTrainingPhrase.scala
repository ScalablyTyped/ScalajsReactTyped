...
trait GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase extends StObject {
  ...
  /**
    ...
    */
  var parts: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3beta1IntentTrainingPhrasePart]] = js.undefined
  
  /** Indicates how many times this example was added to the intent. */
  var repeatCount: js.UndefOr[Double] = js.undefined
}
object GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase {
  
  inline def apply(): GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase = {
  ...
  extension [Self <: GoogleCloudDialogflowCxV3beta1IntentTrainingPhrase](x: Self) {
    ...
    inline def setParts(value: js.Array[GoogleCloudDialogflowCxV3beta1IntentTrainingPhrasePart]): Self = StObject.set(x, "parts", value.asInstanceOf[js.Any])
    
    inline def setPartsUndefined: Self = StObject.set(x, "parts", js.undefined)
    
    inline def setPartsVarargs(value: GoogleCloudDialogflowCxV3beta1IntentTrainingPhrasePart*): Self = StObject.set(x, "parts", js.Array(value*))
