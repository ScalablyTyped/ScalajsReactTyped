...
trait GoogleCloudDialogflowCxV3WebhookGenericWebService extends StObject {
...
object GoogleCloudDialogflowCxV3WebhookGenericWebService {
  ...
  inline def apply(): GoogleCloudDialogflowCxV3WebhookGenericWebService = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudDialogflowCxV3WebhookGenericWebService]
  }
  
  extension [Self <: GoogleCloudDialogflowCxV3WebhookGenericWebService](x: Self) {
