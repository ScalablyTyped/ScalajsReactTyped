...
trait GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput extends StObject {
  ...
  var differences: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3TestRunDifference]] = js.undefined
  ...
  var textResponses: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3ResponseMessageText]] = js.undefined
  
  /** The Intent that triggered the response. Only name and displayName will be set. */
  var triggeredIntent: js.UndefOr[GoogleCloudDialogflowCxV3Intent] = js.undefined
}
object GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput {
  
  inline def apply(): GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput = {
  ...
  extension [Self <: GoogleCloudDialogflowCxV3ConversationTurnVirtualAgentOutput](x: Self) {
    ...
    inline def setDifferences(value: js.Array[GoogleCloudDialogflowCxV3TestRunDifference]): Self = StObject.set(x, "differences", value.asInstanceOf[js.Any])
    ...
    inline def setTextResponses(value: js.Array[GoogleCloudDialogflowCxV3ResponseMessageText]): Self = StObject.set(x, "textResponses", value.asInstanceOf[js.Any])
    
    inline def setTextResponsesUndefined: Self = StObject.set(x, "textResponses", js.undefined)
    
    inline def setTextResponsesVarargs(value: GoogleCloudDialogflowCxV3ResponseMessageText*): Self = StObject.set(x, "textResponses", js.Array(value*))
    
    inline def setTriggeredIntent(value: GoogleCloudDialogflowCxV3Intent): Self = StObject.set(x, "triggeredIntent", value.asInstanceOf[js.Any])
