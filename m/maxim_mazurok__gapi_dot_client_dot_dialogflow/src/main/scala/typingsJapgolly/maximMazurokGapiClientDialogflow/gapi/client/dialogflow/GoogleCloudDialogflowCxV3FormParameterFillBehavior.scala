...
trait GoogleCloudDialogflowCxV3FormParameterFillBehavior extends StObject {
  ...
  var initialPromptFulfillment: js.UndefOr[GoogleCloudDialogflowCxV3Fulfillment] = js.undefined
  ...
  /**
    ...
    * re-prompted.
    */
  var repromptEventHandlers: js.UndefOr[js.Array[GoogleCloudDialogflowCxV3EventHandler]] = js.undefined
}
object GoogleCloudDialogflowCxV3FormParameterFillBehavior {
  
  inline def apply(): GoogleCloudDialogflowCxV3FormParameterFillBehavior = {
  ...
  extension [Self <: GoogleCloudDialogflowCxV3FormParameterFillBehavior](x: Self) {
    ...
    inline def setRepromptEventHandlers(value: js.Array[GoogleCloudDialogflowCxV3EventHandler]): Self = StObject.set(x, "repromptEventHandlers", value.asInstanceOf[js.Any])
    
    inline def setRepromptEventHandlersUndefined: Self = StObject.set(x, "repromptEventHandlers", js.undefined)
    
    inline def setRepromptEventHandlersVarargs(value: GoogleCloudDialogflowCxV3EventHandler*): Self = StObject.set(x, "repromptEventHandlers", js.Array(value*))
  }
}
