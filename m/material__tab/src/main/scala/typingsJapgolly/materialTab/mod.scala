...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialTab.foundationMod.default {
  ...
  open class MDCTab protected ()
    extends typingsJapgolly.materialTab.componentMod.MDCTab {
  ...
  open class MDCTabFoundation ()
    extends typingsJapgolly.materialTab.foundationMod.MDCTabFoundation {
    def this(adapter: PartialMDCTabAdapter) = this()
  }
