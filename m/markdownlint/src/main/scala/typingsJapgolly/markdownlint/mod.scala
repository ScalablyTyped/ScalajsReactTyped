...
object mod {
  ...
  trait Options extends StObject {
    ...
    /**
      * Additional plugins.
      */
    var markdownItPlugins: js.UndefOr[js.Array[typingsJapgolly.std.Plugin]] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setMarkdownItPlugins(value: js.Array[typingsJapgolly.std.Plugin]): Self = StObject.set(x, "markdownItPlugins", value.asInstanceOf[js.Any])
      
      inline def setMarkdownItPluginsUndefined: Self = StObject.set(x, "markdownItPlugins", js.undefined)
      
      inline def setMarkdownItPluginsVarargs(value: typingsJapgolly.std.Plugin*): Self = StObject.set(x, "markdownItPlugins", js.Array(value*))
  ...
  object Rule {
    ...
    inline def apply(
      description: String,
      function: (/* params */ RuleParams, /* onError */ RuleOnError) => Callback,
      names: js.Array[String],
      tags: js.Array[String]
    ): Rule = {
      val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], function = js.Any.fromFunction2((t0: /* params */ RuleParams, t1: /* onError */ RuleOnError) => (function(t0, t1)).runNow()), names = names.asInstanceOf[js.Any], tags = tags.asInstanceOf[js.Any])
    ...
    extension [Self <: Rule](x: Self) {
      ...
      inline def setFunction(value: (/* params */ RuleParams, /* onError */ RuleOnError) => Callback): Self = StObject.set(x, "function", js.Any.fromFunction2((t0: /* params */ RuleParams, t1: /* onError */ RuleOnError) => (value(t0, t1)).runNow()))
