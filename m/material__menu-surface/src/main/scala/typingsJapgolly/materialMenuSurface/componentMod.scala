...
import typingsJapgolly.materialMenuSurface.foundationMod.MDCMenuSurfaceFoundation
...
object componentMod {
  ...
  open class MDCMenuSurface protected () extends MDCComponent[MDCMenuSurfaceFoundation] {
    ...
    var anchorElement: org.scalajs.dom.Element | Null = js.native
    ...
    def setMenuSurfaceAnchorElement(element: org.scalajs.dom.Element): Unit = js.native
  }
  /* static members */
  object MDCMenuSurface {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCMenuSurface = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCMenuSurface]
  }
