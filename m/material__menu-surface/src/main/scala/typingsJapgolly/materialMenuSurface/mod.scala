...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialMenuSurface.foundationMod.default {
  ...
  open class MDCMenuSurface protected ()
    extends typingsJapgolly.materialMenuSurface.componentMod.MDCMenuSurface {
  ...
  open class MDCMenuSurfaceFoundation ()
    extends typingsJapgolly.materialMenuSurface.foundationMod.MDCMenuSurfaceFoundation {
    def this(adapter: PartialMDCMenuSurfaceAdap) = this()
  }
