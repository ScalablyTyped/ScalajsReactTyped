...
import typingsJapgolly.maquette.anon.PartialCSSStyleDeclaratio
...
object distInterfacesMod {
  ...
  object CalculationCache {
    ...
    inline def apply[Result](invalidate: Callback, result: (js.Array[Any], js.Function0[Result]) => Result): CalculationCache[Result] = {
      val __obj = js.Dynamic.literal(invalidate = invalidate.toJsFn, result = js.Any.fromFunction2(result))
  ...
  object Component {
    ...
    inline def apply(renderMaquette: CallbackTo[js.UndefOr[VNode | Null]]): Component = {
      val __obj = js.Dynamic.literal(renderMaquette = renderMaquette.toJsFn)
      __obj.asInstanceOf[Component]
    }
    
    extension [Self <: Component](x: Self) {
      
      inline def setRenderMaquette(value: CallbackTo[js.UndefOr[VNode | Null]]): Self = StObject.set(x, "renderMaquette", value.toJsFn)
    }
  }
  ...
  object Mapping {
    ...
    inline def apply[Source, Target](map: js.Array[Source] => Callback, results: js.Array[Target]): Mapping[Source, Target] = {
      val __obj = js.Dynamic.literal(map = js.Any.fromFunction1((t0: js.Array[Source]) => map(t0).runNow()), results = results.asInstanceOf[js.Any])
      __obj.asInstanceOf[Mapping[Source, Target]]
    }
    
    extension [Self <: Mapping[?, ?], Source, Target](x: Self & (Mapping[Source, Target])) {
      
      inline def setMap(value: js.Array[Source] => Callback): Self = StObject.set(x, "map", js.Any.fromFunction1((t0: js.Array[Source]) => value(t0).runNow()))
  ...
  object MaquetteComponent {
    ...
    inline def apply(render: CallbackTo[js.UndefOr[VNode | Null]]): MaquetteComponent = {
    ...
    extension [Self <: MaquetteComponent](x: Self) {
      ...
      inline def setRender(value: CallbackTo[js.UndefOr[VNode | Null]]): Self = StObject.set(x, "render", value.toJsFn)
    }
  }
  ...
  */
  ...
  object PerformanceLoggerEvent {
    ...
    inline def domEvent: typingsJapgolly.maquette.maquetteStrings.domEvent = "domEvent".asInstanceOf[typingsJapgolly.maquette.maquetteStrings.domEvent]
    
    inline def domEventProcessed: typingsJapgolly.maquette.maquetteStrings.domEventProcessed = "domEventProcessed".asInstanceOf[typingsJapgolly.maquette.maquetteStrings.domEventProcessed]
    
    inline def patched: typingsJapgolly.maquette.maquetteStrings.patched = "patched".asInstanceOf[typingsJapgolly.maquette.maquetteStrings.patched]
    
    inline def renderDone: typingsJapgolly.maquette.maquetteStrings.renderDone = "renderDone".asInstanceOf[typingsJapgolly.maquette.maquetteStrings.renderDone]
    
    inline def renderStart: typingsJapgolly.maquette.maquetteStrings.renderStart = "renderStart".asInstanceOf[typingsJapgolly.maquette.maquetteStrings.renderStart]
    
    inline def rendered: typingsJapgolly.maquette.maquetteStrings.rendered = "rendered".asInstanceOf[typingsJapgolly.maquette.maquetteStrings.rendered]
  }
  ...
  object Projection {
    ...
    inline def apply(domNode: Element, getLastRender: CallbackTo[VNode], update: VNode => Callback): Projection = {
      val __obj = js.Dynamic.literal(domNode = domNode.asInstanceOf[js.Any], getLastRender = getLastRender.toJsFn, update = js.Any.fromFunction1((t0: VNode) => update(t0).runNow()))
    ...
    extension [Self <: Projection](x: Self) {
      ...
      inline def setGetLastRender(value: CallbackTo[VNode]): Self = StObject.set(x, "getLastRender", value.toJsFn)
      
      inline def setUpdate(value: VNode => Callback): Self = StObject.set(x, "update", js.Any.fromFunction1((t0: VNode) => value(t0).runNow()))
    }
  }
  ...
  object Projector {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(append = js.Any.fromFunction2((t0: Element, t1: js.Function0[VNode]) => (append(t0, t1)).runNow()), detach = js.Any.fromFunction1(detach), insertBefore = js.Any.fromFunction2((t0: Element, t1: js.Function0[VNode]) => (insertBefore(t0, t1)).runNow()), merge = js.Any.fromFunction2((t0: Element, t1: js.Function0[VNode]) => (merge(t0, t1)).runNow()), renderNow = renderNow.toJsFn, replace = js.Any.fromFunction2((t0: Element, t1: js.Function0[VNode]) => (replace(t0, t1)).runNow()), resume = resume.toJsFn, scheduleRender = scheduleRender.toJsFn, stop = stop.toJsFn)
      __obj.asInstanceOf[Projector]
    }
    
    extension [Self <: Projector](x: Self) {
      
      inline def setAppend(value: (Element, js.Function0[VNode]) => Callback): Self = StObject.set(x, "append", js.Any.fromFunction2((t0: Element, t1: js.Function0[VNode]) => (value(t0, t1)).runNow()))
      
      inline def setDetach(value: js.Function0[VNode] => Projection): Self = StObject.set(x, "detach", js.Any.fromFunction1(value))
      
      inline def setInsertBefore(value: (Element, js.Function0[VNode]) => Callback): Self = StObject.set(x, "insertBefore", js.Any.fromFunction2((t0: Element, t1: js.Function0[VNode]) => (value(t0, t1)).runNow()))
      
      inline def setMerge(value: (Element, js.Function0[VNode]) => Callback): Self = StObject.set(x, "merge", js.Any.fromFunction2((t0: Element, t1: js.Function0[VNode]) => (value(t0, t1)).runNow()))
      
      inline def setReplace(value: (Element, js.Function0[VNode]) => Callback): Self = StObject.set(x, "replace", js.Any.fromFunction2((t0: Element, t1: js.Function0[VNode]) => (value(t0, t1)).runNow()))
  ...
  object ProjectorOptions {
    ...
    extension [Self <: ProjectorOptions](x: Self) {
      ...
      inline def setPerformanceLogger(value: (/* eventType */ PerformanceLoggerEvent, /* trigger */ js.UndefOr[Event]) => Callback): Self = StObject.set(x, "performanceLogger", js.Any.fromFunction2((t0: /* eventType */ PerformanceLoggerEvent, t1: /* trigger */ js.UndefOr[Event]) => (value(t0, t1)).runNow()))
      
      inline def setPerformanceLoggerUndefined: Self = StObject.set(x, "performanceLogger", js.undefined)
      
      inline def setStyleApplyer(value: (/* domNode */ HTMLElement, /* styleName */ String, /* value */ String) => Callback): Self = StObject.set(x, "styleApplyer", js.Any.fromFunction3((t0: /* domNode */ HTMLElement, t1: /* styleName */ String, t2: /* value */ String) => (value(t0, t1, t2)).runNow()))
  ...
  object ProjectorService {
    ...
    inline def apply(renderNow: Callback, scheduleRender: Callback): ProjectorService = {
      val __obj = js.Dynamic.literal(renderNow = renderNow.toJsFn, scheduleRender = scheduleRender.toJsFn)
      __obj.asInstanceOf[ProjectorService]
    }
    
    extension [Self <: ProjectorService](x: Self) {
      
      inline def setRenderNow(value: Callback): Self = StObject.set(x, "renderNow", value.toJsFn)
      
      inline def setScheduleRender(value: Callback): Self = StObject.set(x, "scheduleRender", value.toJsFn)
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.maquette.distInterfacesMod.VNode
    - js.Array[scala.Any]
  ...
  object VNodeProperties {
    ...
    extension [Self <: VNodeProperties](x: Self) {
      ...
      inline def setAfterCreate(
        value: (/* element */ Element, /* projectionOptions */ ProjectionOptions, /* vnodeSelector */ String, VNodeProperties, /* children */ js.UndefOr[js.Array[VNode]]) => Callback
      ): Self = StObject.set(x, "afterCreate", js.Any.fromFunction5((t0: /* element */ Element, t1: /* projectionOptions */ ProjectionOptions, t2: /* vnodeSelector */ String, t3: VNodeProperties, t4: /* children */ js.UndefOr[js.Array[VNode]]) => (value(t0, t1, t2, t3, t4)).runNow()))
      
      inline def setAfterCreateUndefined: Self = StObject.set(x, "afterCreate", js.undefined)
      
      inline def setAfterRemoved(value: /* element */ Element => Callback): Self = StObject.set(x, "afterRemoved", js.Any.fromFunction1((t0: /* element */ Element) => value(t0).runNow()))
      
      inline def setAfterRemovedUndefined: Self = StObject.set(x, "afterRemoved", js.undefined)
      
      inline def setAfterUpdate(
        value: (/* element */ Element, /* projectionOptions */ ProjectionOptions, /* vnodeSelector */ String, VNodeProperties, /* children */ js.UndefOr[js.Array[VNode]]) => Callback
      ): Self = StObject.set(x, "afterUpdate", js.Any.fromFunction5((t0: /* element */ Element, t1: /* projectionOptions */ ProjectionOptions, t2: /* vnodeSelector */ String, t3: VNodeProperties, t4: /* children */ js.UndefOr[js.Array[VNode]]) => (value(t0, t1, t2, t3, t4)).runNow()))
      ...
      inline def setEnterAnimation(value: (/* element */ Element, /* properties */ js.UndefOr[VNodeProperties]) => Callback): Self = StObject.set(x, "enterAnimation", js.Any.fromFunction2((t0: /* element */ Element, t1: /* properties */ js.UndefOr[VNodeProperties]) => (value(t0, t1)).runNow()))
      
      inline def setEnterAnimationUndefined: Self = StObject.set(x, "enterAnimation", js.undefined)
      
      inline def setExitAnimation(
        value: (/* element */ Element, /* removeElement */ js.Function0[Unit], /* properties */ js.UndefOr[VNodeProperties]) => Callback
      ): Self = StObject.set(x, "exitAnimation", js.Any.fromFunction3((t0: /* element */ Element, t1: /* removeElement */ js.Function0[Unit], t2: /* properties */ js.UndefOr[VNodeProperties]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setUpdateAnimation(
        value: (/* element */ Element, /* properties */ js.UndefOr[VNodeProperties], /* previousProperties */ js.UndefOr[VNodeProperties]) => Callback
      ): Self = StObject.set(x, "updateAnimation", js.Any.fromFunction3((t0: /* element */ Element, t1: /* properties */ js.UndefOr[VNodeProperties], t2: /* previousProperties */ js.UndefOr[VNodeProperties]) => (value(t0, t1, t2)).runNow()))
