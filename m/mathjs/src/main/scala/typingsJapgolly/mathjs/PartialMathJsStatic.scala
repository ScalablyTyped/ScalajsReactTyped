...
import typingsJapgolly.mathjs.mod.BigNumber
import typingsJapgolly.mathjs.mod.Complex
import typingsJapgolly.mathjs.mod.ConfigOptions
import typingsJapgolly.mathjs.mod.CreateUnitOptions
import typingsJapgolly.mathjs.mod.EvalFunction
import typingsJapgolly.mathjs.mod.FactoryFunction
import typingsJapgolly.mathjs.mod.FactoryFunctionMap
import typingsJapgolly.mathjs.mod.FormatOptions
import typingsJapgolly.mathjs.mod.Fraction
import typingsJapgolly.mathjs.mod.Help
import typingsJapgolly.mathjs.mod.ImportObject
import typingsJapgolly.mathjs.mod.ImportOptions
import typingsJapgolly.mathjs.mod.Index
import typingsJapgolly.mathjs.mod.MathArray
import typingsJapgolly.mathjs.mod.MathExpression
import typingsJapgolly.mathjs.mod.MathJsChain
import typingsJapgolly.mathjs.mod.MathJsFunctionName
import typingsJapgolly.mathjs.mod.MathJsJson
...
import typingsJapgolly.mathjs.mod.NoLiteralType
import typingsJapgolly.mathjs.mod.Parser
import typingsJapgolly.mathjs.mod.PolarCoordinates
import typingsJapgolly.mathjs.mod.Unit
import typingsJapgolly.mathjs.mod.UnitDefinition
...
object PartialMathJsStatic {
  ...
  def apply(
    ...
    abs: /* x */ Double => CallbackTo[Double] = null,
    absDependencies: FactoryFunctionMap = null,
    acos: /* x */ Double => CallbackTo[Double] = null,
    acosDependencies: FactoryFunctionMap = null,
    acosh: /* x */ Double => CallbackTo[Double] = null,
    acoshDependencies: FactoryFunctionMap = null,
    acot: /* x */ Double => CallbackTo[Double] = null,
    acotDependencies: FactoryFunctionMap = null,
    acoth: /* x */ Double => CallbackTo[Double] = null,
    acothDependencies: FactoryFunctionMap = null,
    acsc: /* x */ Double => CallbackTo[Double] = null,
    acscDependencies: FactoryFunctionMap = null,
    acsch: /* x */ Double => CallbackTo[Double] = null,
    acschDependencies: FactoryFunctionMap = null,
    add: (/* x */ MathType, /* y */ MathType) => CallbackTo[MathType] = null,
    addDependencies: FactoryFunctionMap = null,
    addScalarDependencies: FactoryFunctionMap = null,
    all: FactoryFunctionMap = null,
    and: (/* x */ Double | BigNumber | Complex | Unit | MathArray | Matrix, /* y */ Double | BigNumber | Complex | Unit | MathArray | Matrix) => CallbackTo[Boolean | MathArray | Matrix] = null,
    ...
    arg: /* x */ Double | Complex => CallbackTo[Double] = null,
    argDependencies: FactoryFunctionMap = null,
    asec: /* x */ Double => CallbackTo[Double] = null,
    asecDependencies: FactoryFunctionMap = null,
    asech: /* x */ Double => CallbackTo[Double] = null,
    asechDependencies: FactoryFunctionMap = null,
    asin: /* x */ Double => CallbackTo[Double] = null,
    asinDependencies: FactoryFunctionMap = null,
    asinh: /* x */ Double => CallbackTo[Double] = null,
    asinhDependencies: FactoryFunctionMap = null,
    atan: /* x */ Double => CallbackTo[Double] = null,
    atan2: (/* y */ Double, /* x */ Double) => CallbackTo[Double] = null,
    atan2Dependencies: FactoryFunctionMap = null,
    atanDependencies: FactoryFunctionMap = null,
    atanh: /* x */ Double => CallbackTo[Double] = null,
    ...
    bellNumbers: /* n */ Double => CallbackTo[Double] = null,
    bellNumbersDependencies: FactoryFunctionMap = null,
    bignumber: /* x */ js.UndefOr[Double | String | Fraction | BigNumber | MathArray | Matrix | Boolean | Null] => CallbackTo[BigNumber] = null,
    bignumberDependencies: FactoryFunctionMap = null,
    bitAnd: (/* x */ Double | BigNumber | MathArray | Matrix, /* y */ Double | BigNumber | MathArray | Matrix) => CallbackTo[NoLiteralType[Double | BigNumber | MathArray | Matrix]] = null,
    bitAndDependencies: FactoryFunctionMap = null,
    bitNot: /* x */ Double => CallbackTo[Double] = null,
    bitNotDependencies: FactoryFunctionMap = null,
    bitOr: (/* x */ Double, /* y */ Double) => CallbackTo[Double] = null,
    bitOrDependencies: FactoryFunctionMap = null,
    bitXor: (/* x */ Double | BigNumber | MathArray | Matrix, /* y */ Double | BigNumber | MathArray | Matrix) => CallbackTo[NoLiteralType[Double | BigNumber | MathArray | Matrix]] = null,
    ...
    boolean: /* x */ String | Double | Boolean | MathArray | Matrix | Null => CallbackTo[Boolean | MathArray | Matrix] = null,
    booleanDependencies: FactoryFunctionMap = null,
    catalan: /* n */ Double => CallbackTo[Double] = null,
    catalanDependencies: FactoryFunctionMap = null,
    cbrt: (/* x */ Double, /* allRoots */ js.UndefOr[Boolean]) => CallbackTo[Double] = null,
    cbrtDependencies: FactoryFunctionMap = null,
    ceil: /* x */ Double => CallbackTo[Double] = null,
    ceilDependencies: FactoryFunctionMap = null,
    chain: /* value */ js.UndefOr[js.Any] => CallbackTo[MathJsChain] = null,
    chainDependencies: FactoryFunctionMap = null,
    classicalElectronRadiusDependencies: FactoryFunctionMap = null,
    clone: /* x */ js.Any => CallbackTo[js.Any] = null,
    ...
    combinations: (/* n */ Double | BigNumber, /* k */ Double | BigNumber) => CallbackTo[NoLiteralType[Double | BigNumber]] = null,
    combinationsDependencies: FactoryFunctionMap = null,
    compare: (/* x */ MathType | String, /* y */ MathType | String) => CallbackTo[Double | BigNumber | Fraction | MathArray | Matrix] = null,
    compareDependencies: FactoryFunctionMap = null,
    compareNatural: (/* x */ js.Any, /* y */ js.Any) => CallbackTo[Double] = null,
    compareNaturalDependencies: FactoryFunctionMap = null,
    compareText: (/* x */ String | MathArray | Matrix, /* y */ String | MathArray | Matrix) => CallbackTo[Double | MathArray | Matrix] = null,
    compareTextDependencies: FactoryFunctionMap = null,
    compile: /* expr */ MathExpression => CallbackTo[EvalFunction] = null,
    compileDependencies: FactoryFunctionMap = null,
    complex: /* arg */ js.UndefOr[Complex | String | PolarCoordinates] => CallbackTo[Complex] = null,
    complexDependencies: FactoryFunctionMap = null,
    composition: (/* n */ Double | BigNumber, /* k */ Double | BigNumber) => CallbackTo[NoLiteralType[Double | BigNumber]] = null,
    compositionDependencies: FactoryFunctionMap = null,
    concat: /* repeated */ MathArray | Matrix => CallbackTo[MathArray | Matrix] = null,
    ...
    config: /* options */ ConfigOptions => CallbackTo[ConfigOptions] = null,
    conj: /* x */ Double | BigNumber | Complex | MathArray | Matrix => CallbackTo[NoLiteralType[Double | BigNumber | Complex | MathArray | Matrix]] = null,
    conjDependencies: FactoryFunctionMap = null,
    cos: /* x */ Double | Unit => CallbackTo[Double] = null,
    cosDependencies: FactoryFunctionMap = null,
    cosh: /* x */ Double | Unit => CallbackTo[Double] = null,
    coshDependencies: FactoryFunctionMap = null,
    cot: /* x */ Double | Unit => CallbackTo[Double] = null,
    cotDependencies: FactoryFunctionMap = null,
    coth: /* x */ Double | Unit => CallbackTo[Double] = null,
    cothDependencies: FactoryFunctionMap = null,
    coulombDependencies: FactoryFunctionMap = null,
    create: (/* factories */ FactoryFunctionMap, /* config */ ConfigOptions) => CallbackTo[Partial[MathJsStatic]] = null,
    createUnit: (/* name */ String, /* definition */ js.UndefOr[String | UnitDefinition], /* options */ js.UndefOr[CreateUnitOptions]) => CallbackTo[Unit] = null,
    createUnitDependencies: FactoryFunctionMap = null,
    cross: (/* x */ MathArray | Matrix, /* y */ MathArray | Matrix) => CallbackTo[Matrix | MathArray] = null,
    crossDependencies: FactoryFunctionMap = null,
    csc: /* x */ Double | Unit => CallbackTo[Double] = null,
    cscDependencies: FactoryFunctionMap = null,
    csch: /* x */ Double | Unit => CallbackTo[Double] = null,
    cschDependencies: FactoryFunctionMap = null,
    ctransposeDependencies: FactoryFunctionMap = null,
    cube: /* x */ Double => CallbackTo[Double] = null,
    cubeDependencies: FactoryFunctionMap = null,
    deepEqual: (/* x */ MathType, /* y */ MathType) => CallbackTo[Double | BigNumber | Fraction | Complex | Unit | MathArray | Matrix] = null,
    deepEqualDependencies: FactoryFunctionMap = null,
    derivative: (/* expr */ MathNode | String, /* variable */ MathNode | String, /* options */ js.UndefOr[AnonSimplify]) => CallbackTo[MathNode] = null,
    derivativeDependencies: FactoryFunctionMap = null,
    det: /* x */ MathArray | Matrix => CallbackTo[Double] = null,
    detDependencies: FactoryFunctionMap = null,
    deuteronMassDependencies: FactoryFunctionMap = null,
    diag: (/* X */ MathArray | Matrix, /* format */ js.UndefOr[String]) => CallbackTo[Matrix] = null,
    diagDependencies: FactoryFunctionMap = null,
    distance: (/* x */ MathArray | Matrix | js.Object, /* y */ MathArray | Matrix | js.Object) => CallbackTo[Double | BigNumber] = null,
    distanceDependencies: FactoryFunctionMap = null,
    divide: (/* x */ Unit, /* y */ Unit) => CallbackTo[Unit] = null,
    divideDependencies: FactoryFunctionMap = null,
    divideScalarDependencies: FactoryFunctionMap = null,
    dot: (/* x */ MathArray | Matrix, /* y */ MathArray | Matrix) => CallbackTo[Double] = null,
    dotDependencies: FactoryFunctionMap = null,
    dotDivide: (/* x */ MathType, /* y */ MathType) => CallbackTo[MathType] = null,
    dotDivideDependencies: FactoryFunctionMap = null,
    dotMultiply: (/* x */ MathType, /* y */ MathType) => CallbackTo[MathType] = null,
    dotMultiplyDependencies: FactoryFunctionMap = null,
    dotPow: (/* x */ MathType, /* y */ MathType) => CallbackTo[MathType] = null,
    ...
    equal: (/* x */ MathType | String, /* y */ MathType | String) => CallbackTo[Boolean | MathArray | Matrix] = null,
    equalDependencies: FactoryFunctionMap = null,
    equalScalarDependencies: FactoryFunctionMap = null,
    equalText: (/* x */ String | MathArray | Matrix, /* y */ String | MathArray | Matrix) => CallbackTo[Double | MathArray | Matrix] = null,
    equalTextDependencies: FactoryFunctionMap = null,
    erf: /* x */ Double | MathArray | Matrix => CallbackTo[NoLiteralType[Double | MathArray | Matrix]] = null,
    erfDependencies: FactoryFunctionMap = null,
    evalDependencies: FactoryFunctionMap = null,
    evaluate: (/* expr */ MathExpression | js.Array[MathExpression] | Matrix, /* scope */ js.UndefOr[js.Object]) => CallbackTo[js.Any] = null,
    evaluateDependencies: FactoryFunctionMap = null,
    exp: /* x */ Double => CallbackTo[Double] = null,
    expDependencies: FactoryFunctionMap = null,
    expm: /* x */ Matrix => CallbackTo[Matrix] = null,
    expm1: /* x */ Double => CallbackTo[Double] = null,
    ...
    factorial: /* n */ Double | BigNumber | MathArray | Matrix => CallbackTo[NoLiteralType[Double | BigNumber | MathArray | Matrix]] = null,
    factorialDependencies: FactoryFunctionMap = null,
    factory: (/* name */ String, /* dependencies */ js.Array[MathJsFunctionName], /* create */ js.Function1[/* injected */ Partial[MathJsStatic], js.Any], /* meta */ js.UndefOr[js.Any]) => CallbackTo[FactoryFunction[js.Any]] = null,
    ...
    filter: (/* x */ Matrix | MathArray | js.Array[String], /* test */ (js.Function3[
      ...
      /* matrix */ Matrix | MathArray | js.Array[String], 
      Boolean
    ]) | js.RegExp) => CallbackTo[Matrix | MathArray] = null,
    ...
    fix: /* x */ Double => CallbackTo[Double] = null,
    fixDependencies: FactoryFunctionMap = null,
    flatten: /* x */ MathArray | Matrix => CallbackTo[MathArray | Matrix] = null,
    flattenDependencies: FactoryFunctionMap = null,
    floor: /* x */ Double => CallbackTo[Double] = null,
    floorDependencies: FactoryFunctionMap = null,
    forEach: (/* x */ Matrix | MathArray, /* callback */ js.Function3[/* value */ js.Any, /* index */ js.Any, /* matrix */ Matrix | MathArray, scala.Unit]) => Callback = null,
    forEachDependencies: FactoryFunctionMap = null,
    forEachTransformDependencies: FactoryFunctionMap = null,
    format: (/* value */ js.Any, /* options */ js.UndefOr[FormatOptions | Double | (js.Function1[/* item */ js.Any, String])], /* callback */ js.UndefOr[js.Function1[/* value */ js.Any, String]]) => CallbackTo[String] = null,
    formatDependencies: FactoryFunctionMap = null,
    fraction: /* args */ Fraction | MathArray | Matrix => CallbackTo[Fraction | MathArray | Matrix] = null,
    fractionDependencies: FactoryFunctionMap = null,
    gamma: /* n */ Double | MathArray | Matrix => CallbackTo[Double | MathArray | Matrix] = null,
    gammaDependencies: FactoryFunctionMap = null,
    gasConstantDependencies: FactoryFunctionMap = null,
    gcd: /* repeated */ Double => CallbackTo[Double] = null,
    ...
    help: /* search */ js.Function0[js.Any] => CallbackTo[Help] = null,
    helpDependencies: FactoryFunctionMap = null,
    hypot: /* repeated */ Double => CallbackTo[Double] = null,
    hypotDependencies: FactoryFunctionMap = null,
    i: Int | Double = null,
    iDependencies: FactoryFunctionMap = null,
    identity: (/* size */ Double | js.Array[Double] | Matrix | MathArray, /* format */ js.UndefOr[String]) => CallbackTo[Matrix | MathArray | Double] = null,
    identityDependencies: FactoryFunctionMap = null,
    im: /* x */ Double | BigNumber | Complex | MathArray | Matrix => CallbackTo[Double | BigNumber | MathArray | Matrix] = null,
    imDependencies: FactoryFunctionMap = null,
    `import`: (/* object */ ImportObject | js.Array[ImportObject], /* options */ ImportOptions) => Callback = null,
    index: /* repeated */ js.Any => CallbackTo[Index] = null
  ): PartialMathJsStatic = {
    ...
    if (abs != null) __obj.updateDynamic("abs")(js.Any.fromFunction1((t0: /* x */ scala.Double) => abs(t0).runNow()))
    if (absDependencies != null) __obj.updateDynamic("absDependencies")(absDependencies.asInstanceOf[js.Any])
    if (acos != null) __obj.updateDynamic("acos")(js.Any.fromFunction1((t0: /* x */ scala.Double) => acos(t0).runNow()))
    if (acosDependencies != null) __obj.updateDynamic("acosDependencies")(acosDependencies.asInstanceOf[js.Any])
    if (acosh != null) __obj.updateDynamic("acosh")(js.Any.fromFunction1((t0: /* x */ scala.Double) => acosh(t0).runNow()))
    if (acoshDependencies != null) __obj.updateDynamic("acoshDependencies")(acoshDependencies.asInstanceOf[js.Any])
    if (acot != null) __obj.updateDynamic("acot")(js.Any.fromFunction1((t0: /* x */ scala.Double) => acot(t0).runNow()))
    if (acotDependencies != null) __obj.updateDynamic("acotDependencies")(acotDependencies.asInstanceOf[js.Any])
    if (acoth != null) __obj.updateDynamic("acoth")(js.Any.fromFunction1((t0: /* x */ scala.Double) => acoth(t0).runNow()))
    if (acothDependencies != null) __obj.updateDynamic("acothDependencies")(acothDependencies.asInstanceOf[js.Any])
    if (acsc != null) __obj.updateDynamic("acsc")(js.Any.fromFunction1((t0: /* x */ scala.Double) => acsc(t0).runNow()))
    if (acscDependencies != null) __obj.updateDynamic("acscDependencies")(acscDependencies.asInstanceOf[js.Any])
    if (acsch != null) __obj.updateDynamic("acsch")(js.Any.fromFunction1((t0: /* x */ scala.Double) => acsch(t0).runNow()))
    if (acschDependencies != null) __obj.updateDynamic("acschDependencies")(acschDependencies.asInstanceOf[js.Any])
    if (add != null) __obj.updateDynamic("add")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathType, t1: /* y */ typingsJapgolly.mathjs.mod.MathType) => add(t0, t1).runNow()))
    ...
    if (and != null) __obj.updateDynamic("and")(js.Any.fromFunction2((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.Complex | typingsJapgolly.mathjs.mod.Unit | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix, t1: /* y */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.Complex | typingsJapgolly.mathjs.mod.Unit | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => and(t0, t1).runNow()))
    ...
    if (arg != null) __obj.updateDynamic("arg")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.Complex) => arg(t0).runNow()))
    if (argDependencies != null) __obj.updateDynamic("argDependencies")(argDependencies.asInstanceOf[js.Any])
    if (asec != null) __obj.updateDynamic("asec")(js.Any.fromFunction1((t0: /* x */ scala.Double) => asec(t0).runNow()))
    if (asecDependencies != null) __obj.updateDynamic("asecDependencies")(asecDependencies.asInstanceOf[js.Any])
    if (asech != null) __obj.updateDynamic("asech")(js.Any.fromFunction1((t0: /* x */ scala.Double) => asech(t0).runNow()))
    if (asechDependencies != null) __obj.updateDynamic("asechDependencies")(asechDependencies.asInstanceOf[js.Any])
    if (asin != null) __obj.updateDynamic("asin")(js.Any.fromFunction1((t0: /* x */ scala.Double) => asin(t0).runNow()))
    if (asinDependencies != null) __obj.updateDynamic("asinDependencies")(asinDependencies.asInstanceOf[js.Any])
    if (asinh != null) __obj.updateDynamic("asinh")(js.Any.fromFunction1((t0: /* x */ scala.Double) => asinh(t0).runNow()))
    if (asinhDependencies != null) __obj.updateDynamic("asinhDependencies")(asinhDependencies.asInstanceOf[js.Any])
    if (atan != null) __obj.updateDynamic("atan")(js.Any.fromFunction1((t0: /* x */ scala.Double) => atan(t0).runNow()))
    if (atan2 != null) __obj.updateDynamic("atan2")(js.Any.fromFunction2((t0: /* y */ scala.Double, t1: /* x */ scala.Double) => atan2(t0, t1).runNow()))
    ...
    if (atanh != null) __obj.updateDynamic("atanh")(js.Any.fromFunction1((t0: /* x */ scala.Double) => atanh(t0).runNow()))
    ...
    if (bellNumbers != null) __obj.updateDynamic("bellNumbers")(js.Any.fromFunction1((t0: /* n */ scala.Double) => bellNumbers(t0).runNow()))
    if (bellNumbersDependencies != null) __obj.updateDynamic("bellNumbersDependencies")(bellNumbersDependencies.asInstanceOf[js.Any])
    if (bignumber != null) __obj.updateDynamic("bignumber")(js.Any.fromFunction1((t0: /* x */ js.UndefOr[
  scala.Double | java.lang.String | typingsJapgolly.mathjs.mod.Fraction | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix | scala.Boolean | scala.Null]) => bignumber(t0).runNow()))
    if (bignumberDependencies != null) __obj.updateDynamic("bignumberDependencies")(bignumberDependencies.asInstanceOf[js.Any])
    if (bitAnd != null) __obj.updateDynamic("bitAnd")(js.Any.fromFunction2((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix, t1: /* y */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => bitAnd(t0, t1).runNow()))
    if (bitAndDependencies != null) __obj.updateDynamic("bitAndDependencies")(bitAndDependencies.asInstanceOf[js.Any])
    if (bitNot != null) __obj.updateDynamic("bitNot")(js.Any.fromFunction1((t0: /* x */ scala.Double) => bitNot(t0).runNow()))
    if (bitNotDependencies != null) __obj.updateDynamic("bitNotDependencies")(bitNotDependencies.asInstanceOf[js.Any])
    if (bitOr != null) __obj.updateDynamic("bitOr")(js.Any.fromFunction2((t0: /* x */ scala.Double, t1: /* y */ scala.Double) => bitOr(t0, t1).runNow()))
    if (bitOrDependencies != null) __obj.updateDynamic("bitOrDependencies")(bitOrDependencies.asInstanceOf[js.Any])
    if (bitXor != null) __obj.updateDynamic("bitXor")(js.Any.fromFunction2((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix, t1: /* y */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => bitXor(t0, t1).runNow()))
    ...
    if (boolean != null) __obj.updateDynamic("boolean")(js.Any.fromFunction1((t0: /* x */ java.lang.String | scala.Double | scala.Boolean | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix | scala.Null) => boolean(t0).runNow()))
    if (booleanDependencies != null) __obj.updateDynamic("booleanDependencies")(booleanDependencies.asInstanceOf[js.Any])
    if (catalan != null) __obj.updateDynamic("catalan")(js.Any.fromFunction1((t0: /* n */ scala.Double) => catalan(t0).runNow()))
    if (catalanDependencies != null) __obj.updateDynamic("catalanDependencies")(catalanDependencies.asInstanceOf[js.Any])
    if (cbrt != null) __obj.updateDynamic("cbrt")(js.Any.fromFunction2((t0: /* x */ scala.Double, t1: /* allRoots */ js.UndefOr[scala.Boolean]) => cbrt(t0, t1).runNow()))
    if (cbrtDependencies != null) __obj.updateDynamic("cbrtDependencies")(cbrtDependencies.asInstanceOf[js.Any])
    if (ceil != null) __obj.updateDynamic("ceil")(js.Any.fromFunction1((t0: /* x */ scala.Double) => ceil(t0).runNow()))
    if (ceilDependencies != null) __obj.updateDynamic("ceilDependencies")(ceilDependencies.asInstanceOf[js.Any])
    if (chain != null) __obj.updateDynamic("chain")(js.Any.fromFunction1((t0: /* value */ js.UndefOr[js.Any]) => chain(t0).runNow()))
    if (chainDependencies != null) __obj.updateDynamic("chainDependencies")(chainDependencies.asInstanceOf[js.Any])
    ...
    if (clone != null) __obj.updateDynamic("clone")(js.Any.fromFunction1((t0: /* x */ js.Any) => clone(t0).runNow()))
    ...
    if (combinations != null) __obj.updateDynamic("combinations")(js.Any.fromFunction2((t0: /* n */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber, t1: /* k */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber) => combinations(t0, t1).runNow()))
    ...
    if (compare != null) __obj.updateDynamic("compare")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathType | java.lang.String, t1: /* y */ typingsJapgolly.mathjs.mod.MathType | java.lang.String) => compare(t0, t1).runNow()))
    if (compareDependencies != null) __obj.updateDynamic("compareDependencies")(compareDependencies.asInstanceOf[js.Any])
    if (compareNatural != null) __obj.updateDynamic("compareNatural")(js.Any.fromFunction2((t0: /* x */ js.Any, t1: /* y */ js.Any) => compareNatural(t0, t1).runNow()))
    ...
    if (compareText != null) __obj.updateDynamic("compareText")(js.Any.fromFunction2((t0: /* x */ java.lang.String | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix, t1: /* y */ java.lang.String | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => compareText(t0, t1).runNow()))
    if (compareTextDependencies != null) __obj.updateDynamic("compareTextDependencies")(compareTextDependencies.asInstanceOf[js.Any])
    if (compile != null) __obj.updateDynamic("compile")(js.Any.fromFunction1((t0: /* expr */ typingsJapgolly.mathjs.mod.MathExpression) => compile(t0).runNow()))
    if (compileDependencies != null) __obj.updateDynamic("compileDependencies")(compileDependencies.asInstanceOf[js.Any])
    if (complex != null) __obj.updateDynamic("complex")(js.Any.fromFunction1((t0: /* arg */ js.UndefOr[
  typingsJapgolly.mathjs.mod.Complex | java.lang.String | typingsJapgolly.mathjs.mod.PolarCoordinates]) => complex(t0).runNow()))
    if (complexDependencies != null) __obj.updateDynamic("complexDependencies")(complexDependencies.asInstanceOf[js.Any])
    if (composition != null) __obj.updateDynamic("composition")(js.Any.fromFunction2((t0: /* n */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber, t1: /* k */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber) => composition(t0, t1).runNow()))
    if (compositionDependencies != null) __obj.updateDynamic("compositionDependencies")(compositionDependencies.asInstanceOf[js.Any])
    if (concat != null) __obj.updateDynamic("concat")(js.Any.fromFunction1((t0: /* repeated */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => concat(t0).runNow()))
    ...
    if (config != null) __obj.updateDynamic("config")(js.Any.fromFunction1((t0: /* options */ typingsJapgolly.mathjs.mod.ConfigOptions) => config(t0).runNow()))
    if (conj != null) __obj.updateDynamic("conj")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.Complex | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => conj(t0).runNow()))
    if (conjDependencies != null) __obj.updateDynamic("conjDependencies")(conjDependencies.asInstanceOf[js.Any])
    if (cos != null) __obj.updateDynamic("cos")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.Unit) => cos(t0).runNow()))
    if (cosDependencies != null) __obj.updateDynamic("cosDependencies")(cosDependencies.asInstanceOf[js.Any])
    if (cosh != null) __obj.updateDynamic("cosh")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.Unit) => cosh(t0).runNow()))
    if (coshDependencies != null) __obj.updateDynamic("coshDependencies")(coshDependencies.asInstanceOf[js.Any])
    if (cot != null) __obj.updateDynamic("cot")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.Unit) => cot(t0).runNow()))
    if (cotDependencies != null) __obj.updateDynamic("cotDependencies")(cotDependencies.asInstanceOf[js.Any])
    if (coth != null) __obj.updateDynamic("coth")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.Unit) => coth(t0).runNow()))
    ...
    if (create != null) __obj.updateDynamic("create")(js.Any.fromFunction2((t0: /* factories */ typingsJapgolly.mathjs.mod.FactoryFunctionMap, t1: /* config */ typingsJapgolly.mathjs.mod.ConfigOptions) => create(t0, t1).runNow()))
    if (createUnit != null) __obj.updateDynamic("createUnit")(js.Any.fromFunction3((t0: /* name */ java.lang.String, t1: /* definition */ js.UndefOr[java.lang.String | typingsJapgolly.mathjs.mod.UnitDefinition], t2: /* options */ js.UndefOr[typingsJapgolly.mathjs.mod.CreateUnitOptions]) => createUnit(t0, t1, t2).runNow()))
    if (createUnitDependencies != null) __obj.updateDynamic("createUnitDependencies")(createUnitDependencies.asInstanceOf[js.Any])
    if (cross != null) __obj.updateDynamic("cross")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix, t1: /* y */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => cross(t0, t1).runNow()))
    if (crossDependencies != null) __obj.updateDynamic("crossDependencies")(crossDependencies.asInstanceOf[js.Any])
    if (csc != null) __obj.updateDynamic("csc")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.Unit) => csc(t0).runNow()))
    if (cscDependencies != null) __obj.updateDynamic("cscDependencies")(cscDependencies.asInstanceOf[js.Any])
    if (csch != null) __obj.updateDynamic("csch")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.Unit) => csch(t0).runNow()))
    ...
    if (cube != null) __obj.updateDynamic("cube")(js.Any.fromFunction1((t0: /* x */ scala.Double) => cube(t0).runNow()))
    if (cubeDependencies != null) __obj.updateDynamic("cubeDependencies")(cubeDependencies.asInstanceOf[js.Any])
    if (deepEqual != null) __obj.updateDynamic("deepEqual")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathType, t1: /* y */ typingsJapgolly.mathjs.mod.MathType) => deepEqual(t0, t1).runNow()))
    if (deepEqualDependencies != null) __obj.updateDynamic("deepEqualDependencies")(deepEqualDependencies.asInstanceOf[js.Any])
    if (derivative != null) __obj.updateDynamic("derivative")(js.Any.fromFunction3((t0: /* expr */ typingsJapgolly.mathjs.mod.MathNode | java.lang.String, t1: /* variable */ typingsJapgolly.mathjs.mod.MathNode | java.lang.String, t2: /* options */ js.UndefOr[typingsJapgolly.mathjs.AnonSimplify]) => derivative(t0, t1, t2).runNow()))
    if (derivativeDependencies != null) __obj.updateDynamic("derivativeDependencies")(derivativeDependencies.asInstanceOf[js.Any])
    if (det != null) __obj.updateDynamic("det")(js.Any.fromFunction1((t0: /* x */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => det(t0).runNow()))
    ...
    if (diag != null) __obj.updateDynamic("diag")(js.Any.fromFunction2((t0: /* X */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix, t1: /* format */ js.UndefOr[java.lang.String]) => diag(t0, t1).runNow()))
    if (diagDependencies != null) __obj.updateDynamic("diagDependencies")(diagDependencies.asInstanceOf[js.Any])
    if (distance != null) __obj.updateDynamic("distance")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix | js.Object, t1: /* y */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix | js.Object) => distance(t0, t1).runNow()))
    if (distanceDependencies != null) __obj.updateDynamic("distanceDependencies")(distanceDependencies.asInstanceOf[js.Any])
    if (divide != null) __obj.updateDynamic("divide")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.Unit, t1: /* y */ typingsJapgolly.mathjs.mod.Unit) => divide(t0, t1).runNow()))
    ...
    if (dot != null) __obj.updateDynamic("dot")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix, t1: /* y */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => dot(t0, t1).runNow()))
    if (dotDependencies != null) __obj.updateDynamic("dotDependencies")(dotDependencies.asInstanceOf[js.Any])
    if (dotDivide != null) __obj.updateDynamic("dotDivide")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathType, t1: /* y */ typingsJapgolly.mathjs.mod.MathType) => dotDivide(t0, t1).runNow()))
    if (dotDivideDependencies != null) __obj.updateDynamic("dotDivideDependencies")(dotDivideDependencies.asInstanceOf[js.Any])
    if (dotMultiply != null) __obj.updateDynamic("dotMultiply")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathType, t1: /* y */ typingsJapgolly.mathjs.mod.MathType) => dotMultiply(t0, t1).runNow()))
    if (dotMultiplyDependencies != null) __obj.updateDynamic("dotMultiplyDependencies")(dotMultiplyDependencies.asInstanceOf[js.Any])
    if (dotPow != null) __obj.updateDynamic("dotPow")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathType, t1: /* y */ typingsJapgolly.mathjs.mod.MathType) => dotPow(t0, t1).runNow()))
    ...
    if (equal != null) __obj.updateDynamic("equal")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.MathType | java.lang.String, t1: /* y */ typingsJapgolly.mathjs.mod.MathType | java.lang.String) => equal(t0, t1).runNow()))
    ...
    if (equalText != null) __obj.updateDynamic("equalText")(js.Any.fromFunction2((t0: /* x */ java.lang.String | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix, t1: /* y */ java.lang.String | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => equalText(t0, t1).runNow()))
    if (equalTextDependencies != null) __obj.updateDynamic("equalTextDependencies")(equalTextDependencies.asInstanceOf[js.Any])
    if (erf != null) __obj.updateDynamic("erf")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => erf(t0).runNow()))
    ...
    if (evaluate != null) __obj.updateDynamic("evaluate")(js.Any.fromFunction2((t0: /* expr */ typingsJapgolly.mathjs.mod.MathExpression | js.Array[typingsJapgolly.mathjs.mod.MathExpression] | typingsJapgolly.mathjs.mod.Matrix, t1: /* scope */ js.UndefOr[js.Object]) => evaluate(t0, t1).runNow()))
    if (evaluateDependencies != null) __obj.updateDynamic("evaluateDependencies")(evaluateDependencies.asInstanceOf[js.Any])
    if (exp != null) __obj.updateDynamic("exp")(js.Any.fromFunction1((t0: /* x */ scala.Double) => exp(t0).runNow()))
    if (expDependencies != null) __obj.updateDynamic("expDependencies")(expDependencies.asInstanceOf[js.Any])
    if (expm != null) __obj.updateDynamic("expm")(js.Any.fromFunction1((t0: /* x */ typingsJapgolly.mathjs.mod.Matrix) => expm(t0).runNow()))
    if (expm1 != null) __obj.updateDynamic("expm1")(js.Any.fromFunction1((t0: /* x */ scala.Double) => expm1(t0).runNow()))
    ...
    if (factorial != null) __obj.updateDynamic("factorial")(js.Any.fromFunction1((t0: /* n */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => factorial(t0).runNow()))
    if (factorialDependencies != null) __obj.updateDynamic("factorialDependencies")(factorialDependencies.asInstanceOf[js.Any])
    if (factory != null) __obj.updateDynamic("factory")(js.Any.fromFunction4((t0: /* name */ java.lang.String, t1: /* dependencies */ js.Array[typingsJapgolly.mathjs.mod.MathJsFunctionName], t2: /* create */ js.Function1[
  /* injected */ typingsJapgolly.std.Partial[typingsJapgolly.mathjs.mod.MathJsStatic], 
  js.Any], t3: /* meta */ js.UndefOr[js.Any]) => factory(t0, t1, t2, t3).runNow()))
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.Matrix | typingsJapgolly.mathjs.mod.MathArray | js.Array[java.lang.String], t1: /* test */ (js.Function3[
  /* value */ js.Any, 
  /* index */ js.Any, 
  /* matrix */ typingsJapgolly.mathjs.mod.Matrix | typingsJapgolly.mathjs.mod.MathArray | js.Array[java.lang.String], 
  scala.Boolean]) | js.RegExp) => filter(t0, t1).runNow()))
    ...
    if (fix != null) __obj.updateDynamic("fix")(js.Any.fromFunction1((t0: /* x */ scala.Double) => fix(t0).runNow()))
    if (fixDependencies != null) __obj.updateDynamic("fixDependencies")(fixDependencies.asInstanceOf[js.Any])
    if (flatten != null) __obj.updateDynamic("flatten")(js.Any.fromFunction1((t0: /* x */ typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => flatten(t0).runNow()))
    if (flattenDependencies != null) __obj.updateDynamic("flattenDependencies")(flattenDependencies.asInstanceOf[js.Any])
    if (floor != null) __obj.updateDynamic("floor")(js.Any.fromFunction1((t0: /* x */ scala.Double) => floor(t0).runNow()))
    if (floorDependencies != null) __obj.updateDynamic("floorDependencies")(floorDependencies.asInstanceOf[js.Any])
    if (forEach != null) __obj.updateDynamic("forEach")(js.Any.fromFunction2((t0: /* x */ typingsJapgolly.mathjs.mod.Matrix | typingsJapgolly.mathjs.mod.MathArray, t1: /* callback */ js.Function3[
  /* value */ js.Any, 
  /* index */ js.Any, 
  /* matrix */ typingsJapgolly.mathjs.mod.Matrix | typingsJapgolly.mathjs.mod.MathArray, 
  scala.Unit]) => forEach(t0, t1).runNow()))
    ...
    if (format != null) __obj.updateDynamic("format")(js.Any.fromFunction3((t0: /* value */ js.Any, t1: /* options */ js.UndefOr[
  typingsJapgolly.mathjs.mod.FormatOptions | scala.Double | (js.Function1[/* item */ js.Any, java.lang.String])], t2: /* callback */ js.UndefOr[js.Function1[/* value */ js.Any, java.lang.String]]) => format(t0, t1, t2).runNow()))
    if (formatDependencies != null) __obj.updateDynamic("formatDependencies")(formatDependencies.asInstanceOf[js.Any])
    if (fraction != null) __obj.updateDynamic("fraction")(js.Any.fromFunction1((t0: /* args */ typingsJapgolly.mathjs.mod.Fraction | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => fraction(t0).runNow()))
    if (fractionDependencies != null) __obj.updateDynamic("fractionDependencies")(fractionDependencies.asInstanceOf[js.Any])
    if (gamma != null) __obj.updateDynamic("gamma")(js.Any.fromFunction1((t0: /* n */ scala.Double | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => gamma(t0).runNow()))
    ...
    if (gcd != null) __obj.updateDynamic("gcd")(js.Any.fromFunction1((t0: /* repeated */ scala.Double) => gcd(t0).runNow()))
    ...
    if (help != null) __obj.updateDynamic("help")(js.Any.fromFunction1((t0: /* search */ js.Function0[js.Any]) => help(t0).runNow()))
    if (helpDependencies != null) __obj.updateDynamic("helpDependencies")(helpDependencies.asInstanceOf[js.Any])
    if (hypot != null) __obj.updateDynamic("hypot")(js.Any.fromFunction1((t0: /* repeated */ scala.Double) => hypot(t0).runNow()))
    ...
    if (identity != null) __obj.updateDynamic("identity")(js.Any.fromFunction2((t0: /* size */ scala.Double | js.Array[scala.Double] | typingsJapgolly.mathjs.mod.Matrix | typingsJapgolly.mathjs.mod.MathArray, t1: /* format */ js.UndefOr[java.lang.String]) => identity(t0, t1).runNow()))
    if (identityDependencies != null) __obj.updateDynamic("identityDependencies")(identityDependencies.asInstanceOf[js.Any])
    if (im != null) __obj.updateDynamic("im")(js.Any.fromFunction1((t0: /* x */ scala.Double | typingsJapgolly.mathjs.mod.BigNumber | typingsJapgolly.mathjs.mod.Complex | typingsJapgolly.mathjs.mod.MathArray | typingsJapgolly.mathjs.mod.Matrix) => im(t0).runNow()))
    if (imDependencies != null) __obj.updateDynamic("imDependencies")(imDependencies.asInstanceOf[js.Any])
    if (`import` != null) __obj.updateDynamic("import")(js.Any.fromFunction2((t0: /* object */ typingsJapgolly.mathjs.mod.ImportObject | js.Array[typingsJapgolly.mathjs.mod.ImportObject], t1: /* options */ typingsJapgolly.mathjs.mod.ImportOptions) => `import`(t0, t1).runNow()))
    if (index != null) __obj.updateDynamic("index")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => index(t0).runNow()))
