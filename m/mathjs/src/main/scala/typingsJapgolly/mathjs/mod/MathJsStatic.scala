...
import typingsJapgolly.mathjs.mathjsStrings.biased
import typingsJapgolly.mathjs.mathjsStrings.dense
import typingsJapgolly.mathjs.mathjsStrings.desc
import typingsJapgolly.mathjs.mathjsStrings.natural
import typingsJapgolly.mathjs.mathjsStrings.sparse
...
trait MathJsStatic
  ...
  /**
    ...
    */
  def gcd(args: Double*): Double = js.native
  @JSName("gcd")
