...
trait MathJsChain[TValue] extends StObject {
  ...
  def derivative(variable: String, options: typingsJapgolly.mathjs.anon.Simplify): MathJsChain[MathNode] = js.native
  /*************************************************************************
    * Algebra functions
    ************************************************************************/
  /**
  ...
  def derivative(variable: MathNode, options: typingsJapgolly.mathjs.anon.Simplify): MathJsChain[MathNode] = js.native
