...
object PartialMathJsStaticAbs {
  ...
  def apply(
    ...
    create: (/* factories */ FactoryFunctionMap, /* config */ ConfigOptions) => CallbackTo[PartialMathJsStatic] = null,
    ...
    factory: (/* name */ String, /* dependencies */ js.Array[MathJsFunctionName], /* create */ js.Function1[/* injected */ PartialMathJsStatic, js.Any], /* meta */ js.UndefOr[js.Any]) => CallbackTo[FactoryFunction[js.Any]] = null,
  ...
  typingsJapgolly.mathjs.mod.Complex | java.lang.String | typingsJapgolly.mathjs.mod.PolarCoordinates]) => complex(t0).runNow()))
    ...
    if (factory != null) __obj.updateDynamic("factory")(js.Any.fromFunction4((t0: /* name */ java.lang.String, t1: /* dependencies */ js.Array[typingsJapgolly.mathjs.mod.MathJsFunctionName], t2: /* create */ js.Function1[/* injected */ typingsJapgolly.mathjs.PartialMathJsStatic, js.Any], t3: /* meta */ js.UndefOr[js.Any]) => factory(t0, t1, t2, t3).runNow()))
