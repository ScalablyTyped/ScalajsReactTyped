...
object anon {
  ...
  object PartialMDCRippleAdapter {
    ...
    extension [Self <: PartialMDCRippleAdapter](x: Self) {
      ...
      inline def setBrowserSupportsCssVars(value: CallbackTo[Boolean]): Self = StObject.set(x, "browserSupportsCssVars", value.toJsFn)
      
      inline def setBrowserSupportsCssVarsUndefined: Self = StObject.set(x, "browserSupportsCssVars", js.undefined)
      
      inline def setComputeBoundingRect(value: CallbackTo[DOMRect]): Self = StObject.set(x, "computeBoundingRect", value.toJsFn)
      ...
      inline def setDeregisterDocumentInteractionHandler(value: (/* evtType */ EventType, /* handler */ SpecificEventListener[EventType]) => Callback): Self = StObject.set(x, "deregisterDocumentInteractionHandler", js.Any.fromFunction2((t0: /* evtType */ EventType, t1: /* handler */ SpecificEventListener[EventType]) => (value(t0, t1)).runNow()))
      ...
      inline def setGetWindowPageOffset(value: CallbackTo[MDCRipplePoint]): Self = StObject.set(x, "getWindowPageOffset", value.toJsFn)
      
      inline def setGetWindowPageOffsetUndefined: Self = StObject.set(x, "getWindowPageOffset", js.undefined)
      
      inline def setIsSurfaceActive(value: CallbackTo[Boolean]): Self = StObject.set(x, "isSurfaceActive", value.toJsFn)
      
      inline def setIsSurfaceActiveUndefined: Self = StObject.set(x, "isSurfaceActive", js.undefined)
      
      inline def setIsSurfaceDisabled(value: CallbackTo[Boolean]): Self = StObject.set(x, "isSurfaceDisabled", value.toJsFn)
      
      inline def setIsSurfaceDisabledUndefined: Self = StObject.set(x, "isSurfaceDisabled", js.undefined)
      
      inline def setIsUnbounded(value: CallbackTo[Boolean]): Self = StObject.set(x, "isUnbounded", value.toJsFn)
      
      inline def setIsUnboundedUndefined: Self = StObject.set(x, "isUnbounded", js.undefined)
      
      inline def setRegisterDocumentInteractionHandler(value: (/* evtType */ EventType, /* handler */ SpecificEventListener[EventType]) => Callback): Self = StObject.set(x, "registerDocumentInteractionHandler", js.Any.fromFunction2((t0: /* evtType */ EventType, t1: /* handler */ SpecificEventListener[EventType]) => (value(t0, t1)).runNow()))
      ...
      inline def setUpdateCssVariable(value: (/* varName */ String, /* value */ String | Null) => Callback): Self = StObject.set(x, "updateCssVariable", js.Any.fromFunction2((t0: /* varName */ String, t1: /* value */ String | Null) => (value(t0, t1)).runNow()))
