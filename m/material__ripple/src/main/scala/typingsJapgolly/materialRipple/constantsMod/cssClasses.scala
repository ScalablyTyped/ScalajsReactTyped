...
import typingsJapgolly.materialRipple.materialRippleStrings.`mdc-ripple-upgraded--background-focused`
import typingsJapgolly.materialRipple.materialRippleStrings.`mdc-ripple-upgraded--foreground-activation`
import typingsJapgolly.materialRipple.materialRippleStrings.`mdc-ripple-upgraded--foreground-deactivation`
import typingsJapgolly.materialRipple.materialRippleStrings.`mdc-ripple-upgraded--unbounded`
import typingsJapgolly.materialRipple.materialRippleStrings.`mdc-ripple-upgraded`
