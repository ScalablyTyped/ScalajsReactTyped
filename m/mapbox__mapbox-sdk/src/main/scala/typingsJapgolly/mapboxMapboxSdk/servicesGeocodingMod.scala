...
import typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.Feature
import typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.FeatureCollection
import typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.Point
...
object servicesGeocodingMod {
  ...
  inline def default(config: typingsJapgolly.mapboxMapboxSdk.libClassesMapiClientMod.default): GeocodeService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[GeocodeService]
  ...
  */
  ...
  object GeocodeMode {
    ...
    inline def mapboxDotplaces: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.mapboxDotplaces = "mapbox.places".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.mapboxDotplaces]
    
    inline def `mapboxDotplaces-permanent`: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.`mapboxDotplaces-permanent` = "mapbox.places-permanent".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.`mapboxDotplaces-permanent`]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.country
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.region
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.postcode
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.district
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.place
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.locality
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.neighborhood
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.address
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.poi
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.poiDotlandmark
  */
  trait GeocodeQueryType extends StObject
  object GeocodeQueryType {
    
    inline def address: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.address = "address".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.address]
    
    inline def country: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.country = "country".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.country]
    
    inline def district: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.district = "district".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.district]
    
    inline def locality: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.locality = "locality".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.locality]
    
    inline def neighborhood: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.neighborhood = "neighborhood".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.neighborhood]
    
    inline def place: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.place = "place".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.place]
    
    inline def poi: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.poi = "poi".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.poi]
    
    inline def poiDotlandmark: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.poiDotlandmark = "poi.landmark".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.poiDotlandmark]
    
    inline def postcode: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.postcode = "postcode".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.postcode]
    
    inline def region: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.region = "region".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.region]
  }
