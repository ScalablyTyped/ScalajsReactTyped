...
import typingsJapgolly.mapboxMapboxSdk.anon.Config
import typingsJapgolly.mapboxMapboxSdk.anon.Draft
import typingsJapgolly.mapboxMapboxSdk.anon.End
import typingsJapgolly.mapboxMapboxSdk.anon.File
import typingsJapgolly.mapboxMapboxSdk.anon.Format
import typingsJapgolly.mapboxMapboxSdk.anon.Fresh
import typingsJapgolly.mapboxMapboxSdk.anon.IconId
import typingsJapgolly.mapboxMapboxSdk.anon.LastKnownModification
import typingsJapgolly.mapboxMapboxSdk.anon.OwnerId
...
object servicesStylesMod {
  ...
  inline def default(config: typingsJapgolly.mapboxMapboxSdk.libClassesMapiClientMod.default): StylesService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[StylesService]
  ...
  object StylesService {
    ...
    inline def apply(
      ...
      deleteStyleIcon: IconId => Callback,
    ...
    extension [Self <: StylesService](x: Self) {
      ...
      inline def setDeleteStyleIcon(value: IconId => Callback): Self = StObject.set(x, "deleteStyleIcon", js.Any.fromFunction1((t0: IconId) => value(t0).runNow()))
      ...
      inline def setUpdateStyle(value: LastKnownModification => Callback): Self = StObject.set(x, "updateStyle", js.Any.fromFunction1((t0: LastKnownModification) => value(t0).runNow()))
    }
  }
}
