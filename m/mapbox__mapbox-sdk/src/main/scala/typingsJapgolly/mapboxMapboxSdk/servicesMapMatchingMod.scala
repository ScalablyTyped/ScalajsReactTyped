...
import typingsJapgolly.mapboxMapboxSdk.servicesDirectionsMod.Leg
...
object servicesMapMatchingMod {
  ...
  inline def default(config: typingsJapgolly.mapboxMapboxSdk.libClassesMapiClientMod.default): MapMatchingService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[MapMatchingService]
