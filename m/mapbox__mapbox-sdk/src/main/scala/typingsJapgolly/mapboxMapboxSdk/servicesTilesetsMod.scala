...
import typingsJapgolly.mapboxMapboxSdk.anon.Attribution
import typingsJapgolly.mapboxMapboxSdk.anon.Id
import typingsJapgolly.mapboxMapboxSdk.anon.IdOwnerId
import typingsJapgolly.mapboxMapboxSdk.anon.JobId
import typingsJapgolly.mapboxMapboxSdk.anon.Private
import typingsJapgolly.mapboxMapboxSdk.anon.Recipe
import typingsJapgolly.mapboxMapboxSdk.anon.RecipeTilesetId
import typingsJapgolly.mapboxMapboxSdk.anon.SortBy_
import typingsJapgolly.mapboxMapboxSdk.anon.Stage
import typingsJapgolly.mapboxMapboxSdk.anon.Start
import typingsJapgolly.mapboxMapboxSdk.anon.TilesetId
...
object servicesTilesetsMod {
  ...
  inline def default(config: typingsJapgolly.mapboxMapboxSdk.libClassesMapiClientMod.default): TilesetsService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[TilesetsService]
  ...
  object TilesetsService {
    ...
    inline def apply(
      ...
      getTilesetsQueue: CallbackTo[MapiRequest[Any]],
    ...
    extension [Self <: TilesetsService](x: Self) {
      ...
      inline def setGetTilesetsQueue(value: CallbackTo[MapiRequest[Any]]): Self = StObject.set(x, "getTilesetsQueue", value.toJsFn)
