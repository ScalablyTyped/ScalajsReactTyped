...
import typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.point_
...
object servicesTilequeryMod {
  ...
  inline def default(config: typingsJapgolly.mapboxMapboxSdk.libClassesMapiClientMod.default): TileQueryService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[TileQueryService]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.point_
  */
  trait GeometryType extends StObject
  object GeometryType {
    
    inline def linestring: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.linestring = "linestring".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.linestring]
    
    inline def point: point_ = "point".asInstanceOf[point_]
    
    inline def polygon: typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.polygon = "polygon".asInstanceOf[typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.polygon]
  }
