...
import typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.large
import typingsJapgolly.mapboxMapboxSdk.mapboxMapboxSdkStrings.small
...
object servicesStaticMod {
  ...
  inline def default(config: typingsJapgolly.mapboxMapboxSdk.libClassesMapiClientMod.default): StaticMapService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[StaticMapService]
