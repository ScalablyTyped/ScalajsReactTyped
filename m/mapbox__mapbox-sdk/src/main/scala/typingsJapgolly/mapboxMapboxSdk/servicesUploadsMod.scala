...
import typingsJapgolly.mapboxMapboxSdk.anon.Reverse
import typingsJapgolly.mapboxMapboxSdk.anon.Tileset
import typingsJapgolly.mapboxMapboxSdk.anon.UploadId
...
object servicesUploadsMod {
  ...
  inline def default(config: typingsJapgolly.mapboxMapboxSdk.libClassesMapiClientMod.default): UploadsService = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(config.asInstanceOf[js.Any]).asInstanceOf[UploadsService]
