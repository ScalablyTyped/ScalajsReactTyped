...
import typingsJapgolly.materialCheckbox.componentMod.MDCCheckboxFactory
...
object componentMod {
  ...
  open class MDCDataTable protected () extends MDCComponent[MDCDataTableFoundation] {
    ...
    /**
      ...
      */
    def getHeaderCells(): js.Array[org.scalajs.dom.Element] = js.native
    ...
    /**
      ...
      */
    def getRows(): js.Array[org.scalajs.dom.Element] = js.native
  ...
  object MDCDataTable {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCDataTable = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCDataTable]
  }
}
