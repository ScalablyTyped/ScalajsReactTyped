package typingsJapgolly.magicsuggest.MagicSuggest

import japgolly.scalajs.react.Callback
import typingsJapgolly.jquery.JQueryAjaxSettings
import typingsJapgolly.magicsuggest.JQuery
...
object Configuration {
  ...
  def apply(
    ...
    beforeSend: js.UndefOr[Callback] = js.undefined,
    cls: String = null,
    data: js.Any = null,
    ...
    maxEntryRenderer: /* v */ js.UndefOr[Double] => Callback = null,
    maxSelection: Int | Double = null,
    maxSelectionRenderer: /* v */ Double => Callback = null,
    maxSuggestions: Int | Double = null,
    method: String = null,
    minChars: Int | Double = null,
    minCharsRenderer: /* v */ Double => Callback = null,
    mode: String = null,
    name: String = null,
    noSuggestionText: String = null,
    placeholder: String = null,
    queryParam: String = null,
    renderer: /* item */ js.Any => Callback = null,
    ...
    selectionRenderer: /* item */ js.Any => Callback = null,
    ...
    beforeSend.foreach(p => __obj.updateDynamic("beforeSend")(p.toJsFn))
    ...
    if (maxEntryRenderer != null) __obj.updateDynamic("maxEntryRenderer")(js.Any.fromFunction1((t0: /* v */ js.UndefOr[scala.Double]) => maxEntryRenderer(t0).runNow()))
    if (maxSelection != null) __obj.updateDynamic("maxSelection")(maxSelection.asInstanceOf[js.Any])
    if (maxSelectionRenderer != null) __obj.updateDynamic("maxSelectionRenderer")(js.Any.fromFunction1((t0: /* v */ scala.Double) => maxSelectionRenderer(t0).runNow()))
    ...
    if (minCharsRenderer != null) __obj.updateDynamic("minCharsRenderer")(js.Any.fromFunction1((t0: /* v */ scala.Double) => minCharsRenderer(t0).runNow()))
    ...
    if (renderer != null) __obj.updateDynamic("renderer")(js.Any.fromFunction1((t0: /* item */ js.Any) => renderer(t0).runNow()))
    ...
    if (selectionRenderer != null) __obj.updateDynamic("selectionRenderer")(js.Any.fromFunction1((t0: /* item */ js.Any) => selectionRenderer(t0).runNow()))
