...
import typingsJapgolly.mparticleWebSdk.mparticleWebSdkInts.`1`
import typingsJapgolly.mparticleWebSdk.mparticleWebSdkInts.`2`
...
trait MPConfiguration extends StObject {
  ...
  var onCreateBatch: js.UndefOr[typingsJapgolly.mparticleWebSdk.mod.onCreateBatch] = js.undefined
...
object MPConfiguration {
  ...
  extension [Self <: MPConfiguration](x: Self) {
    ...
    inline def setIdentityCallback(value: /* result */ IdentityResult => japgolly.scalajs.react.Callback): Self = StObject.set(x, "identityCallback", js.Any.fromFunction1((t0: /* result */ IdentityResult) => value(t0).runNow()))
