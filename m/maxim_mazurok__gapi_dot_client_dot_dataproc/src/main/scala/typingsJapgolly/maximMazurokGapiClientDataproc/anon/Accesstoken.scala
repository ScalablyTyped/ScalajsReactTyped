...
import typingsJapgolly.maximMazurokGapiClientDataproc.gapi.client.dataproc.AutoscalingPolicy
...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: AutoscalingPolicy): Accesstoken = {
