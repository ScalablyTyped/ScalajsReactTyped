...
import typingsJapgolly.maximMazurokGapiClientDataproc.gapi.client.dataproc.InstantiateWorkflowTemplateRequest
...
trait QuotaUser extends StObject {
  ...
  /** Request body */
  var resource: InstantiateWorkflowTemplateRequest
...
object QuotaUser {
  ...
  inline def apply(name: String, resource: InstantiateWorkflowTemplateRequest): QuotaUser = {
  ...
  extension [Self <: QuotaUser](x: Self) {
    ...
    inline def setResource(value: InstantiateWorkflowTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
