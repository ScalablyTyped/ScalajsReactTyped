package typingsJapgolly.maximMazurokGapiClientDataproc.anon

import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ActionOnFailedPrimaryWorkers extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientDataproc.gapi.client.dataproc.Cluster
...
object ActionOnFailedPrimaryWorkers {
  
  inline def apply(
    projectId: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientDataproc.gapi.client.dataproc.Cluster
  ...
  extension [Self <: ActionOnFailedPrimaryWorkers](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientDataproc.gapi.client.dataproc.Cluster): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
