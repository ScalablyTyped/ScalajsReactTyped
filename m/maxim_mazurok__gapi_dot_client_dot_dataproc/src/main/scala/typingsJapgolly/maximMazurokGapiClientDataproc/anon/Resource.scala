...
import typingsJapgolly.maximMazurokGapiClientDataproc.gapi.client.dataproc.WorkflowTemplate
...
object Resource {
  ...
  inline def apply(name: String, resource: WorkflowTemplate): Resource = {
