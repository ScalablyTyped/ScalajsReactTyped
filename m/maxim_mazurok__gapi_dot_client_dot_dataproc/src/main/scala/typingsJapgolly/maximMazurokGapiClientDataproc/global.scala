package typingsJapgolly.maximMazurokGapiClientDataproc

import typingsJapgolly.maximMazurokGapiClientDataproc.gapi.client.dataproc.ProjectsResource
import typingsJapgolly.maximMazurokGapiClientDataproc.maximMazurokGapiClientDataprocStrings.dataproc
import typingsJapgolly.maximMazurokGapiClientDataproc.maximMazurokGapiClientDataprocStrings.v1
