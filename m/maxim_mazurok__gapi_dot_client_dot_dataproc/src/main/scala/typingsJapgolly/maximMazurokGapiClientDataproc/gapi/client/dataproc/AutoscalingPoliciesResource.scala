...
import typingsJapgolly.maximMazurokGapiClientDataproc.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientDataproc.anon.Alt
...
import typingsJapgolly.maximMazurokGapiClientDataproc.anon.Name
