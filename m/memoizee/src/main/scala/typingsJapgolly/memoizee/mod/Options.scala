...
import typingsJapgolly.memoizee.memoizeeBooleans.`false`
import typingsJapgolly.memoizee.memoizeeBooleans.`true`
...
object Options {
  ...
  def apply(
    ...
    dispose: /* value */ js.Any => Callback = null,
    length: Double | `false` = null,
    max: Int | Double = null,
    maxAge: Int | Double = null,
    normalizer: /* args */ js.Array[js.Any] => CallbackTo[String] = null,
    ...
    if (dispose != null) __obj.updateDynamic("dispose")(js.Any.fromFunction1((t0: /* value */ js.Any) => dispose(t0).runNow()))
    if (length != null) __obj.updateDynamic("length")(length.asInstanceOf[js.Any])
    if (max != null) __obj.updateDynamic("max")(max.asInstanceOf[js.Any])
    if (maxAge != null) __obj.updateDynamic("maxAge")(maxAge.asInstanceOf[js.Any])
    if (normalizer != null) __obj.updateDynamic("normalizer")(js.Any.fromFunction1((t0: /* args */ js.Array[js.Any]) => normalizer(t0).runNow()))
