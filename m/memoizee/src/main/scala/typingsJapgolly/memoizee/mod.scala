...
import typingsJapgolly.memoizee.memoizeeStrings.`then`
import typingsJapgolly.memoizee.memoizeeStrings.done
import typingsJapgolly.memoizee.memoizeeStrings.doneColonfinally
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options[?], F /* <: js.Function1[/* repeated */ Any, Any] */](x: Self & Options[F]) {
      ...
      inline def setDispose(value: /* value */ Any => Callback): Self = StObject.set(x, "dispose", js.Any.fromFunction1((t0: /* value */ Any) => value(t0).runNow()))
