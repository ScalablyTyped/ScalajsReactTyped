...
import typingsJapgolly.maximMazurokGapiClientBigqueryreservation.gapi.client.bigqueryreservation.Assignment
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AssignmentId extends StObject {
...
object AssignmentId {
  ...
  inline def apply(parent: String, resource: Assignment): AssignmentId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[AssignmentId]
  }
  
  extension [Self <: AssignmentId](x: Self) {
