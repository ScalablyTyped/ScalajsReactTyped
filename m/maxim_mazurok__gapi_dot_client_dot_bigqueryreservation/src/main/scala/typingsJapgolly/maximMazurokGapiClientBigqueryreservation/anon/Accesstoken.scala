package typingsJapgolly.maximMazurokGapiClientBigqueryreservation.anon

import typingsJapgolly.maximMazurokGapiClientBigqueryreservation.gapi.client.bigqueryreservation.CapacityCommitment
...
object Accesstoken {
  ...
  inline def apply(parent: String, resource: CapacityCommitment): Accesstoken = {
  ...
  extension [Self <: Accesstoken](x: Self) {
    ...
    inline def setResource(value: CapacityCommitment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
