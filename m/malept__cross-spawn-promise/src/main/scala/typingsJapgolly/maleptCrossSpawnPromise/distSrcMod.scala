package typingsJapgolly.maleptCrossSpawnPromise
...
object distSrcMod {
  ...
  object CrossSpawnOptions {
    ...
    extension [Self <: CrossSpawnOptions](x: Self) {
      ...
      inline def setUpdateErrorCallback(value: (/* error */ js.Error, /* hasLogger */ Boolean) => Callback): Self = StObject.set(x, "updateErrorCallback", js.Any.fromFunction2((t0: /* error */ js.Error, t1: /* hasLogger */ Boolean) => (value(t0, t1)).runNow()))
