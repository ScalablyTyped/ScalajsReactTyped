...
import typingsJapgolly.motorHat.anon.M1
import typingsJapgolly.motorHat.anon.W1
import typingsJapgolly.motorHat.anon.W2
import typingsJapgolly.motorHat.motorHatInts.`16`
import typingsJapgolly.motorHat.motorHatInts.`8`
import typingsJapgolly.motorHat.motorHatStrings.double
import typingsJapgolly.motorHat.motorHatStrings.interleaved
import typingsJapgolly.motorHat.motorHatStrings.microstep
import typingsJapgolly.motorHat.motorHatStrings.single
...
object mod {
  ...
  */
  ...
  object Direction {
    ...
    inline def back: typingsJapgolly.motorHat.motorHatStrings.back = "back".asInstanceOf[typingsJapgolly.motorHat.motorHatStrings.back]
    
    inline def fwd: typingsJapgolly.motorHat.motorHatStrings.fwd = "fwd".asInstanceOf[typingsJapgolly.motorHat.motorHatStrings.fwd]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.motorHat.motorHatStrings.M1
    - typingsJapgolly.motorHat.motorHatStrings.M2
    - typingsJapgolly.motorHat.motorHatStrings.M3
    - typingsJapgolly.motorHat.motorHatStrings.M4
  */
  trait Motor extends StObject
  object Motor {
    
    inline def M1: typingsJapgolly.motorHat.motorHatStrings.M1 = "M1".asInstanceOf[typingsJapgolly.motorHat.motorHatStrings.M1]
    
    inline def M2: typingsJapgolly.motorHat.motorHatStrings.M2 = "M2".asInstanceOf[typingsJapgolly.motorHat.motorHatStrings.M2]
    
    inline def M3: typingsJapgolly.motorHat.motorHatStrings.M3 = "M3".asInstanceOf[typingsJapgolly.motorHat.motorHatStrings.M3]
    
    inline def M4: typingsJapgolly.motorHat.motorHatStrings.M4 = "M4".asInstanceOf[typingsJapgolly.motorHat.motorHatStrings.M4]
  }
  ...
  object Servo {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(calibrate = js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (calibrate(t0, t1, t2)).runNow()), moveTo = js.Any.fromFunction1((t0: Double) => moveTo(t0).runNow()))
      __obj.asInstanceOf[Servo]
    }
    
    extension [Self <: Servo](x: Self) {
      
      inline def setCalibrate(value: (Double, Double, Double) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "calibrate", js.Any.fromFunction3((t0: Double, t1: Double, t2: Double) => (value(t0, t1, t2)).runNow()))
      
      inline def setMoveTo(value: Double => japgolly.scalajs.react.Callback): Self = StObject.set(x, "moveTo", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    }
  }
