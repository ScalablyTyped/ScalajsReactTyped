...
import typingsJapgolly.mjmlCore.anon.Attributes
import typingsJapgolly.mjmlCore.anon.Borders
import typingsJapgolly.mjmlCore.anon.Children
import typingsJapgolly.mjmlCore.anon.End
import typingsJapgolly.mjmlCore.anon.TypeofComponent
import typingsJapgolly.mjmlCore.mjmlCoreStrings.skip
import typingsJapgolly.mjmlCore.mjmlCoreStrings.soft
import typingsJapgolly.mjmlCore.mjmlCoreStrings.strict
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mjmlCore.mod.MJMLJsonWithChildren
    - typingsJapgolly.mjmlCore.mod.MJMLJsonWithContent
    - typingsJapgolly.mjmlCore.mod.MJMLJsonSelfClosingTag
  */
  trait MJMLJsonObject extends StObject
  object MJMLJsonObject {
    
    inline def MJMLJsonSelfClosingTag(attributes: js.Object, tagName: String): typingsJapgolly.mjmlCore.mod.MJMLJsonSelfClosingTag = {
      val __obj = js.Dynamic.literal(attributes = attributes.asInstanceOf[js.Any], tagName = tagName.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.mjmlCore.mod.MJMLJsonSelfClosingTag]
    }
    
    inline def MJMLJsonWithChildren(attributes: js.Object, children: js.Array[MJMLJsonObject], tagName: String): typingsJapgolly.mjmlCore.mod.MJMLJsonWithChildren = {
      ...
      __obj.asInstanceOf[typingsJapgolly.mjmlCore.mod.MJMLJsonWithChildren]
    }
    
    inline def MJMLJsonWithContent(attributes: js.Object, content: String, tagName: String): typingsJapgolly.mjmlCore.mod.MJMLJsonWithContent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.mjmlCore.mod.MJMLJsonWithContent]
    }
  }
  ...
  object MJMLParsingOptions {
    ...
    extension [Self <: MJMLParsingOptions](x: Self) {
      ...
      inline def setSkeletonCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "skeleton", value.toJsFn)
