...
import typingsJapgolly.maximMazurokGapiClientComposer.gapi.client.composer.Environment
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(parent: String, resource: Environment): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: Environment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  trait IncludePastReleases extends StObject {
  ...
  object IncludePastReleases {
    ...
    inline def apply(parent: String): IncludePastReleases = {
      val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
      __obj.asInstanceOf[IncludePastReleases]
    }
    
    extension [Self <: IncludePastReleases](x: Self) {
  ...
  object Key {
    ...
    inline def apply(name: String, resource: Environment): Key = {
