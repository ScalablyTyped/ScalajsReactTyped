...
import typingsJapgolly.mangopay2NodejsSdk.mod.AVSResult
import typingsJapgolly.mangopay2NodejsSdk.mod.ColumnAndDirection
import typingsJapgolly.mangopay2NodejsSdk.mod.PaymentStatus
import typingsJapgolly.mangopay2NodejsSdk.mod.PreAuthorizationStatus
import typingsJapgolly.mangopay2NodejsSdk.mod.SecureMode
import typingsJapgolly.mangopay2NodejsSdk.mod.bankAccount.BankAccountType
import typingsJapgolly.mangopay2NodejsSdk.mod.bankAccount.DepositAccountType
import typingsJapgolly.mangopay2NodejsSdk.mod.card.CardStatus
import typingsJapgolly.mangopay2NodejsSdk.mod.card.CardValidity
import typingsJapgolly.mangopay2NodejsSdk.mod.client.BusinessType
import typingsJapgolly.mangopay2NodejsSdk.mod.client.Sector
import typingsJapgolly.mangopay2NodejsSdk.mod.dispute.DisputeReasonType
import typingsJapgolly.mangopay2NodejsSdk.mod.dispute.DisputeStatus
import typingsJapgolly.mangopay2NodejsSdk.mod.dispute.DisputeType
...
import typingsJapgolly.mangopay2NodejsSdk.mod.event.EventType
...
import typingsJapgolly.mangopay2NodejsSdk.mod.kycDocument.KycDocumentType
import typingsJapgolly.mangopay2NodejsSdk.mod.mandate.MandateCultureCode
import typingsJapgolly.mangopay2NodejsSdk.mod.mandate.MandateScheme
import typingsJapgolly.mangopay2NodejsSdk.mod.refund.RefundReasonType
...
import typingsJapgolly.mangopay2NodejsSdk.mod.user.RequiredUserLegalData
import typingsJapgolly.mangopay2NodejsSdk.mod.user.RequiredUserNaturalData
import typingsJapgolly.mangopay2NodejsSdk.mod.user.StaticKeys
import typingsJapgolly.mangopay2NodejsSdk.mod.wallet.ClientFundsType
import typingsJapgolly.mangopay2NodejsSdk.mod.wallet.FundsType
...
object mangopay2NodejsSdkStrings {
  ...
  @js.native
  sealed trait BCMC
    extends typingsJapgolly.mangopay2NodejsSdk.mod.card.CardType
  ...
  sealed trait BUSINESS
    extends typingsJapgolly.mangopay2NodejsSdk.mod.user.LegalPersonType
  ...
  sealed trait CREATED
    extends CardStatus
       with DisputeStatus
       with DocumentStatus
       with typingsJapgolly.mangopay2NodejsSdk.mod.kycDocument.DocumentStatus
  ...
  @js.native
  sealed trait LEGAL
    extends typingsJapgolly.mangopay2NodejsSdk.mod.user.PersonType
  ...
  @js.native
  sealed trait LIGHT
    extends typingsJapgolly.mangopay2NodejsSdk.mod.user.KYCLevel
