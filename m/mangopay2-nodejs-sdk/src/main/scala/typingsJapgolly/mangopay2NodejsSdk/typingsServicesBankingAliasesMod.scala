...
import typingsJapgolly.mangopay2NodejsSdk.anon.PartialOmitCreateIBANBank
...
import typingsJapgolly.mangopay2NodejsSdk.typingsModelsBankingAliasMod.bankingAlias.CreateIBANBankingAlias
...
object typingsServicesBankingAliasesMod {
  
  @JSImport("mangopay2-nodejs-sdk/typings/services/BankingAliases", "BankingAliases")
  @js.native
  open class BankingAliases () extends StObject {
