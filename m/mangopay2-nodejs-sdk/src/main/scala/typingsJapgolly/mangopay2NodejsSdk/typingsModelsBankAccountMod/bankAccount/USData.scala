...
- typingsJapgolly.mangopay2NodejsSdk.typingsModelsBankAccountMod.bankAccount.USDetails because var conflicts: OwnerAddress, OwnerName, Type. Inlined AccountNumber, ABA, DepositAccountType */ trait USData
  extends StObject
     with BaseData
     with Data
  ...
  var DepositAccountType: js.UndefOr[
    typingsJapgolly.mangopay2NodejsSdk.typingsModelsBankAccountMod.bankAccount.DepositAccountType
  ] = js.undefined
}
object USData {
