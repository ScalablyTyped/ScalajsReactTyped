...
- typingsJapgolly.mangopay2NodejsSdk.typingsModelsBankAccountMod.bankAccount.IBANDetails because var conflicts: OwnerAddress, OwnerName, Type. Inlined IBAN, BIC */ trait IBANData
  extends StObject
     with BaseData
     with Data
