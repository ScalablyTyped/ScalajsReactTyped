...
import typingsJapgolly.mangopay2NodejsSdk.mod.user.IncomeRange
import typingsJapgolly.mangopay2NodejsSdk.mod.user.KYCLevel
...
trait MakeKeysRequiredPartialUsAddress extends js.Object {
  ...
  var IncomeRange: js.UndefOr[typingsJapgolly.mangopay2NodejsSdk.mod.user.IncomeRange] = js.undefined
  var KYCLevel: js.UndefOr[typingsJapgolly.mangopay2NodejsSdk.mod.user.KYCLevel] = js.undefined
  var LastName: String
