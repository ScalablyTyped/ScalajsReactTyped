...
import typingsJapgolly.mangopay2NodejsSdk.anon.ApiVersion
import typingsJapgolly.mangopay2NodejsSdk.anon.PartialHeaders
import typingsJapgolly.mangopay2NodejsSdk.anon.Timeout
