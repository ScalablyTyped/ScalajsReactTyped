...
import typingsJapgolly.mangopay2NodejsSdk.mod.bankAccount.BaseData
import typingsJapgolly.mangopay2NodejsSdk.mod.bankAccount.CreationDetails
import typingsJapgolly.mangopay2NodejsSdk.mod.bankAccount.DataIntersection
...
class BankAccount protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var Type: typingsJapgolly.mangopay2NodejsSdk.mod.bankAccount.BankAccountType with OTHER with CA with GB with IBAN with US = js.native
  /**
