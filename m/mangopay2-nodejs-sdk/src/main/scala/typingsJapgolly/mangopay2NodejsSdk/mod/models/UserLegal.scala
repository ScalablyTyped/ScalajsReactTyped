...
import typingsJapgolly.mangopay2NodejsSdk.MakeKeysRequiredPartialUs
...
class UserLegal protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var LegalPersonType: typingsJapgolly.mangopay2NodejsSdk.mod.user.LegalPersonType = js.native
  /**
