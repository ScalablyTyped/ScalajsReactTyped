...
trait DisputeData extends EntityBaseData {
  ...
  /**
    ...
    */
  var DisputeReason: typingsJapgolly.mangopay2NodejsSdk.mod.dispute.DisputeReason
  /**
    * The type of dispute
    */
  var DisputeType: typingsJapgolly.mangopay2NodejsSdk.mod.dispute.DisputeType
  /**
