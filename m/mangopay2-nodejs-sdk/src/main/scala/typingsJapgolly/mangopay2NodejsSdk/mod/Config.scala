...
object Config {
  ...
  def apply(
    ...
    errorHandler: (/* options */ js.Any, /* err */ js.Any) => Callback = null,
    logClass: /* repeated */ js.Any => Callback = null,
    ...
    if (errorHandler != null) __obj.updateDynamic("errorHandler")(js.Any.fromFunction2((t0: /* options */ js.Any, t1: /* err */ js.Any) => errorHandler(t0, t1).runNow()))
    if (logClass != null) __obj.updateDynamic("logClass")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => logClass(t0).runNow()))
