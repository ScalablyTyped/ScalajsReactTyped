...
import typingsJapgolly.mangopay2NodejsSdk.anon.MakeKeysRequiredPartialUsCompanyNumber
import typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.LEGAL
import typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.PAYER
...
open class UserLegalPayer protected ()
  ...
  def setUserCategory(category: typingsJapgolly.mangopay2NodejsSdk.typingsModelsUserMod.user.UserCategory): Unit = js.native
}
