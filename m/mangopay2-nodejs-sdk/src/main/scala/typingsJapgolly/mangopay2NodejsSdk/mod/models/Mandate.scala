...
import typingsJapgolly.mangopay2NodejsSdk.PartialMandateData
import typingsJapgolly.mangopay2NodejsSdk.mod.mandate.MandateCultureCode
import typingsJapgolly.mangopay2NodejsSdk.mod.mandate.MandateData
...
class Mandate ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var MandateType: typingsJapgolly.mangopay2NodejsSdk.mod.mandate.MandateType = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var Status: typingsJapgolly.mangopay2NodejsSdk.mod.mandate.MandateStatus = js.native
  /* CompleteClass */
