...
import typingsJapgolly.mangopay2NodejsSdk.mod.cardRegistration.CardRegistrationData
import typingsJapgolly.mangopay2NodejsSdk.mod.cardRegistration.CreateCardRegistration
import typingsJapgolly.mangopay2NodejsSdk.mod.cardRegistration.UpdateCardRegistration
...
class CardRegistration protected ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var CardType: typingsJapgolly.mangopay2NodejsSdk.mod.card.CardType = js.native
  /* CompleteClass */
