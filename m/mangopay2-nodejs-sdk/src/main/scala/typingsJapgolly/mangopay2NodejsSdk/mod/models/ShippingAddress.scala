...
import typingsJapgolly.mangopay2NodejsSdk.anon.PartialShippingAddressDat
import typingsJapgolly.mangopay2NodejsSdk.typingsModelsAddressMod.address.AddressType
import typingsJapgolly.mangopay2NodejsSdk.typingsModelsShippingAddressMod.shippingAddress.ShippingAddressData
