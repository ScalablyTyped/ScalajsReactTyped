...
import typingsJapgolly.mangopay2NodejsSdk.typingsBaseMod.base.FallbackReasonData
...
object typingsModelsPayOutMod {
  ...
  object payOut {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.STANDARD
      - typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.INSTANT_PAYMENT
      - typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.INSTANT_PAYMENT_ONLY
    */
    trait PayoutModeRequestedType extends StObject
    object PayoutModeRequestedType {
      
      inline def INSTANT_PAYMENT: typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.INSTANT_PAYMENT = "INSTANT_PAYMENT".asInstanceOf[typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.INSTANT_PAYMENT]
      
      inline def INSTANT_PAYMENT_ONLY: typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.INSTANT_PAYMENT_ONLY = "INSTANT_PAYMENT_ONLY".asInstanceOf[typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.INSTANT_PAYMENT_ONLY]
      
      inline def STANDARD: typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.STANDARD = "STANDARD".asInstanceOf[typingsJapgolly.mangopay2NodejsSdk.mangopay2NodejsSdkStrings.STANDARD]
    }
  }
}
