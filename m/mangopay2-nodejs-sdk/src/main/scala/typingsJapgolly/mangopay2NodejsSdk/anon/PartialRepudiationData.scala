...
/* Inlined std.Partial<mangopay2-nodejs-sdk.mangopay2-nodejs-sdk/typings/models/repudiation.repudiation.RepudiationData> */
trait PartialRepudiationData extends StObject {
  ...
  var RefundReason: js.UndefOr[typingsJapgolly.mangopay2NodejsSdk.typingsModelsRefundMod.refund.RefundReason] = js.undefined
...
object PartialRepudiationData {
  ...
  inline def apply(): PartialRepudiationData = {
