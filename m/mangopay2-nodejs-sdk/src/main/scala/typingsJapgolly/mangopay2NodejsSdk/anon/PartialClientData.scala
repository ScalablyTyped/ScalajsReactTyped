...
import typingsJapgolly.mangopay2NodejsSdk.typingsModelsClientMod.client.PlatformCategorization
...
trait PartialClientData extends StObject {
  ...
  var PlatformCategorization: js.UndefOr[
    typingsJapgolly.mangopay2NodejsSdk.typingsModelsClientMod.client.PlatformCategorization
  ] = js.undefined
