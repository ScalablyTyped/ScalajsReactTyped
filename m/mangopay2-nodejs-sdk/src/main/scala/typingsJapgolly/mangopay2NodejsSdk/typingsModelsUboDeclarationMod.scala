...
import typingsJapgolly.mangopay2NodejsSdk.typingsModelsBirthplaceMod.birthplace.Birthplace
...
object typingsModelsUboDeclarationMod {
  ...
  object uboDeclaration {
    ...
    trait CreateUbo extends StObject {
      ...
      var Birthplace: typingsJapgolly.mangopay2NodejsSdk.typingsModelsBirthplaceMod.birthplace.Birthplace
    ...
    trait UpdateUbo extends StObject {
      ...
      var Birthplace: js.UndefOr[
            typingsJapgolly.mangopay2NodejsSdk.typingsModelsBirthplaceMod.birthplace.Birthplace
          ] = js.undefined
