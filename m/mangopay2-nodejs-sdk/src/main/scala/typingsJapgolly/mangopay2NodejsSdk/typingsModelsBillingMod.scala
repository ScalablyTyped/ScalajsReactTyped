...
import typingsJapgolly.mangopay2NodejsSdk.typingsModelsMod.Models.Address
...
object typingsModelsBillingMod {
  ...
  object billing {
    ...
    trait BillingData extends StObject {
      ...
      var Address: typingsJapgolly.mangopay2NodejsSdk.typingsModelsMod.Models.Address | AddressData | String
    }
    object BillingData {
