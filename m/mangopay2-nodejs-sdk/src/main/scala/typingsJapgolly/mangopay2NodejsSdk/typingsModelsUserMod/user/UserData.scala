...
trait UserData
  ...
  /**
    ...
    */
  var KYCLevel: typingsJapgolly.mangopay2NodejsSdk.typingsModelsUserMod.user.KYCLevel
  
  /**
    * Type of user
    */
  var PersonType: typingsJapgolly.mangopay2NodejsSdk.typingsModelsUserMod.user.PersonType
