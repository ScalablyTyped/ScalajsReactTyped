...
import typingsJapgolly.maximMazurokGapiClientStorage.gapi.client.storage.Policy
...
object KeyOauthtoken {
  ...
  inline def apply(bucket: String, `object`: String, resource: Policy): KeyOauthtoken = {
