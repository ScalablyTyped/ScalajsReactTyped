...
trait IfGenerationMatchIfGenerationNotMatch extends StObject {
  ...
  var resource: typingsJapgolly.maximMazurokGapiClientStorage.gapi.client.storage.Object
...
object IfGenerationMatchIfGenerationNotMatch {
  
  inline def apply(
    bucket: String,
    `object`: String,
    resource: typingsJapgolly.maximMazurokGapiClientStorage.gapi.client.storage.Object
  ): IfGenerationMatchIfGenerationNotMatch = {
    val __obj = js.Dynamic.literal(bucket = bucket.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.updateDynamic("object")(`object`.asInstanceOf[js.Any])
    __obj.asInstanceOf[IfGenerationMatchIfGenerationNotMatch]
  }
  
  extension [Self <: IfGenerationMatchIfGenerationNotMatch](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientStorage.gapi.client.storage.Object): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
