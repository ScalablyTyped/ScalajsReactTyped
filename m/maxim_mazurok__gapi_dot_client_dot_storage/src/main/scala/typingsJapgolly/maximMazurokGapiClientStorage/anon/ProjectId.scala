...
object ProjectId {
  ...
  inline def apply(projectId: String, serviceAccountEmail: String): ProjectId = {
    val __obj = js.Dynamic.literal(projectId = projectId.asInstanceOf[js.Any], serviceAccountEmail = serviceAccountEmail.asInstanceOf[js.Any])
