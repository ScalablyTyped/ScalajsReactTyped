...
import typingsJapgolly.maximMazurokGapiClientStorage.anon.ProjectNumber
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ObjectAccessControl extends StObject {
...
object ObjectAccessControl {
  ...
  inline def apply(): ObjectAccessControl = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ObjectAccessControl]
  }
  
  extension [Self <: ObjectAccessControl](x: Self) {
