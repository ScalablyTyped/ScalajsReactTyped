...
import typingsJapgolly.maximMazurokGapiClientStorage.anon.Alt
import typingsJapgolly.maximMazurokGapiClientStorage.anon.Fields
import typingsJapgolly.maximMazurokGapiClientStorage.anon.Key
...
trait BucketAccessControlsResource extends StObject {
  ...
  def insert(request: typingsJapgolly.maximMazurokGapiClientStorage.anon.Bucket): Request[BucketAccessControl] = js.native
