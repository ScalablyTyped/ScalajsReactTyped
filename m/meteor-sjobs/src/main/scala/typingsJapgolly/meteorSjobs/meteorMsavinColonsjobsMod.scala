...
import typingsJapgolly.meteorSjobs.meteorSjobsBooleans.`false`
import typingsJapgolly.meteorSjobs.meteorSjobsBooleans.`true`
...
object meteorMsavinColonsjobsMod {
  ...
  object JobRunConfigObject {
    ...
    extension [Self <: JobRunConfigObject](x: Self) {
      ...
      inline def setDate(value: CallbackTo[js.Date]): Self = StObject.set(x, "date", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.meteorSjobs.meteorSjobsStrings.pending
    - typingsJapgolly.meteorSjobs.meteorSjobsStrings.success
    - typingsJapgolly.meteorSjobs.meteorSjobsStrings.failure
  */
  trait JobState extends StObject
  object JobState {
    
    inline def failure: typingsJapgolly.meteorSjobs.meteorSjobsStrings.failure = "failure".asInstanceOf[typingsJapgolly.meteorSjobs.meteorSjobsStrings.failure]
    
    inline def pending: typingsJapgolly.meteorSjobs.meteorSjobsStrings.pending = "pending".asInstanceOf[typingsJapgolly.meteorSjobs.meteorSjobsStrings.pending]
    
    inline def success: typingsJapgolly.meteorSjobs.meteorSjobsStrings.success = "success".asInstanceOf[typingsJapgolly.meteorSjobs.meteorSjobsStrings.success]
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setLog(value: /* messages */ String | js.Object => Callback): Self = StObject.set(x, "log", js.Any.fromFunction1((t0: /* messages */ String | js.Object) => value(t0).runNow()))
      ...
      inline def setSetServerId(value: CallbackTo[String]): Self = StObject.set(x, "setServerId", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.meteorSjobs.meteorSjobsStrings.success
    - typingsJapgolly.meteorSjobs.meteorSjobsStrings.failure
    - typingsJapgolly.meteorSjobs.meteorSjobsStrings.Asterisk
  */
  trait State extends StObject
  object State {
    
    inline def Asterisk: typingsJapgolly.meteorSjobs.meteorSjobsStrings.Asterisk = "*".asInstanceOf[typingsJapgolly.meteorSjobs.meteorSjobsStrings.Asterisk]
