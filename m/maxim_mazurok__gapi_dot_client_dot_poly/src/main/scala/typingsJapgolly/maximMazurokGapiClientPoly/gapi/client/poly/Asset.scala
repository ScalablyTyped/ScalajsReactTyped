...
trait Asset extends StObject {
  ...
  var isCurated: js.UndefOr[Boolean] = js.undefined
  ...
  var presentationParams: js.UndefOr[PresentationParams] = js.undefined
  
  /** The remix info for the asset. */
  var remixInfo: js.UndefOr[RemixInfo] = js.undefined
  
  /** The thumbnail image for the asset. */
  var thumbnail: js.UndefOr[File] = js.undefined
