...
import typingsJapgolly.maximMazurokGapiClientPoly.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientPoly.anon.Alt
import typingsJapgolly.maximMazurokGapiClientPoly.anon.Callback
