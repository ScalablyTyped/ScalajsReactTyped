...
object MjmlAccordionTitle {
  def apply(
    ...
    typingsJapgolly.mjmlReact.mod.MjmlAccordionTitle, 
    Unit, 
    RequiredChildrenProps with MjmlAccordionTitleProps with PaddingProps with ClassNameProps
  ] = {
  ...
  typingsJapgolly.mjmlReact.mod.RequiredChildrenProps with typingsJapgolly.mjmlReact.mod.MjmlAccordionTitleProps with typingsJapgolly.mjmlReact.mod.PaddingProps with typingsJapgolly.mjmlReact.mod.ClassNameProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.mjmlReact.mod.MjmlAccordionTitle](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.mjmlReact.mod.RequiredChildrenProps with typingsJapgolly.mjmlReact.mod.MjmlAccordionTitleProps with typingsJapgolly.mjmlReact.mod.PaddingProps with typingsJapgolly.mjmlReact.mod.ClassNameProps])(children: _*)
  }
