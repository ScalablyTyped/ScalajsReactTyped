...
import typingsJapgolly.maximMazurokGapiClientManagedidentities.gapi.client.managedidentities.Domain
...
object DomainName {
  ...
  inline def apply(parent: String, resource: Domain): DomainName = {
