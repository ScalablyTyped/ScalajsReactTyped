...
object DefaultExpression {
  ...
  inline def apply(`property-type`: ExpressionType, transition: Boolean): DefaultExpression = {
    ...
    __obj.asInstanceOf[DefaultExpression]
  }
  
  extension [Self <: DefaultExpression](x: Self) {
