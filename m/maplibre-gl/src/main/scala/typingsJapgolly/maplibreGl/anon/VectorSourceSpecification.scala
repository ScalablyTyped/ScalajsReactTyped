...
import typingsJapgolly.maplibreGl.maplibreGlStrings.tms
import typingsJapgolly.maplibreGl.maplibreGlStrings.vector
import typingsJapgolly.maplibreGl.maplibreGlStrings.xyz
import typingsJapgolly.maplibreGl.mod.PromoteIdSpecification
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined maplibre-gl.maplibre-gl.VectorSourceSpecification & {  collectResourceTiming :boolean} */
trait VectorSourceSpecification extends StObject {
...
object VectorSourceSpecification {
  ...
  inline def apply(collectResourceTiming: Boolean): VectorSourceSpecification = {
