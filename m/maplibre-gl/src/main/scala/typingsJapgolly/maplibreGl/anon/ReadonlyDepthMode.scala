...
import typingsJapgolly.maplibreGl.mod.DepthFuncType
import typingsJapgolly.maplibreGl.mod.DepthMaskType
import typingsJapgolly.maplibreGl.mod.DepthRangeType
