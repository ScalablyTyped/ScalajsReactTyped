...
trait Coordinates extends StObject {
  ...
  var coordinates: js.UndefOr[typingsJapgolly.maplibreGl.mod.Coordinates] = js.undefined
...
object Coordinates {
  ...
  extension [Self <: Coordinates](x: Self) {
    ...
    inline def setCoordinates(value: typingsJapgolly.maplibreGl.mod.Coordinates): Self = StObject.set(x, "coordinates", value.asInstanceOf[js.Any])
