...
import typingsJapgolly.maplibreGl.anon.Rasterbrightnessmin
...
trait RasterLayerSpecification
  ...
  var paint: js.UndefOr[Rasterbrightnessmin] = js.undefined
...
object RasterLayerSpecification {
  ...
  extension [Self <: RasterLayerSpecification](x: Self) {
    ...
    inline def setPaint(value: Rasterbrightnessmin): Self = StObject.set(x, "paint", value.asInstanceOf[js.Any])
