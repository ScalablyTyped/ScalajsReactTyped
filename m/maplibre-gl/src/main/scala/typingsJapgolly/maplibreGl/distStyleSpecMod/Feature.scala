...
trait Feature extends StObject {
  ...
  val geometry: js.UndefOr[js.Array[js.Array[typingsJapgolly.mapboxPointGeometry.mod.^]]] = js.undefined
...
object Feature {
  ...
  extension [Self <: Feature](x: Self) {
    ...
    inline def setGeometry(value: js.Array[js.Array[typingsJapgolly.mapboxPointGeometry.mod.^]]): Self = StObject.set(x, "geometry", value.asInstanceOf[js.Any])
    
    inline def setGeometryUndefined: Self = StObject.set(x, "geometry", js.undefined)
    
    inline def setGeometryVarargs(value: js.Array[typingsJapgolly.mapboxPointGeometry.mod.^]*): Self = StObject.set(x, "geometry", js.Array(value*))
