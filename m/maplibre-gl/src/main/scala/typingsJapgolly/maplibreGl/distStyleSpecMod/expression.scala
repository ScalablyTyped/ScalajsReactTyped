...
import typingsJapgolly.maplibreGl.anon.FnCall
import typingsJapgolly.maplibreGl.anon.TypeofStylePropertyFuncti
...
object expression {
  ...
  def StyleExpression: Instantiable2[
    ...
    typingsJapgolly.maplibreGl.distStyleSpecMod.StyleExpression
  ] = js.native
  ...
  def StylePropertyFunction: TypeofStylePropertyFuncti & (Instantiable2[
    ...
    typingsJapgolly.maplibreGl.distStyleSpecMod.StylePropertyFunction[js.Object]
  ]) = js.native
  ...
  def ZoomConstantExpression: Instantiable2[
    ...
    typingsJapgolly.maplibreGl.distStyleSpecMod.ZoomConstantExpression[EvaluationKind]
  ] = js.native
  ...
  def ZoomDependentExpression: Instantiable4[
    ...
    typingsJapgolly.maplibreGl.distStyleSpecMod.ZoomDependentExpression[EvaluationKind]
  ] = js.native
