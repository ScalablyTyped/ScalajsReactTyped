...
import org.scalajs.dom.PerformanceResourceTiming
...
import typingsJapgolly.maplibreGl.anon.AvailableImages
...
open class Tile protected () extends StObject {
  ...
  def queryRenderedFeatures(
    ...
    pixelPosMatrix: mat4
  ): StringDictionary[js.Array[typingsJapgolly.maplibreGl.anon.Feature]] = js.native
