...
import typingsJapgolly.maplibreGl.anon.LineLength
...
object SymbolBucket {
  ...
  def addDynamicAttributes: js.Function3[
    ...
    /* p */ typingsJapgolly.mapboxPointGeometry.mod.^, 
    /* angle */ Double, 
    scala.Unit
  ] = js.native
  inline def addDynamicAttributes(dynamicLayoutVertexArray: StructArray, p: typingsJapgolly.mapboxPointGeometry.mod.^, angle: Double): scala.Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("addDynamicAttributes")(dynamicLayoutVertexArray.asInstanceOf[js.Any], p.asInstanceOf[js.Any], angle.asInstanceOf[js.Any])).asInstanceOf[scala.Unit]
