...
object StyleImageInterface {
  ...
  extension [Self <: StyleImageInterface](x: Self) {
    ...
    inline def setOnAdd(value: (/* map */ Map, /* id */ String) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction2((t0: /* map */ Map, t1: /* id */ String) => (value(t0, t1)).runNow()))
    
    inline def setOnAddUndefined: Self = StObject.set(x, "onAdd", js.undefined)
    
    inline def setOnRemove(value: japgolly.scalajs.react.Callback): Self = StObject.set(x, "onRemove", value.toJsFn)
    
    inline def setOnRemoveUndefined: Self = StObject.set(x, "onRemove", js.undefined)
    
    inline def setRender(value: CallbackTo[Boolean]): Self = StObject.set(x, "render", value.toJsFn)
