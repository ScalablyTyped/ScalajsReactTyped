...
import typingsJapgolly.maplibreGl.anon.`2`
import typingsJapgolly.maplibreGl.maplibreGlStrings.active
import typingsJapgolly.maplibreGl.maplibreGlStrings.inactive
import typingsJapgolly.maplibreGl.maplibreGlStrings.pending
