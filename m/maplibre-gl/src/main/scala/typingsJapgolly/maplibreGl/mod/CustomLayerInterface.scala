...
import typingsJapgolly.maplibreGl.maplibreGlStrings.`2d`
import typingsJapgolly.maplibreGl.maplibreGlStrings.`3d`
...
object CustomLayerInterface {
  ...
  inline def apply(
    id: String,
    render: (/* gl */ WebGLRenderingContext, /* matrix */ mat4) => japgolly.scalajs.react.Callback
  ): CustomLayerInterface = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], render = js.Any.fromFunction2((t0: /* gl */ WebGLRenderingContext, t1: /* matrix */ mat4) => (render(t0, t1)).runNow()))
  ...
  extension [Self <: CustomLayerInterface](x: Self) {
    ...
    inline def setPrerender(value: (/* gl */ WebGLRenderingContext, /* matrix */ mat4) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "prerender", js.Any.fromFunction2((t0: /* gl */ WebGLRenderingContext, t1: /* matrix */ mat4) => (value(t0, t1)).runNow()))
    
    inline def setPrerenderUndefined: Self = StObject.set(x, "prerender", js.undefined)
    
    inline def setRender(value: (/* gl */ WebGLRenderingContext, /* matrix */ mat4) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "render", js.Any.fromFunction2((t0: /* gl */ WebGLRenderingContext, t1: /* matrix */ mat4) => (value(t0, t1)).runNow()))
