...
import typingsJapgolly.maplibreGl.anon.Animate
import typingsJapgolly.maplibreGl.anon.Duration
import typingsJapgolly.maplibreGl.anon.EaseToOptionseaseIdstring
