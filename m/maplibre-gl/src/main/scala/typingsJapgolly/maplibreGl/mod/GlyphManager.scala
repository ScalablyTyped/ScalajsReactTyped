...
import typingsJapgolly.mapboxTinySdf.mod.TinySDFOptions
...
object GlyphManager {
  ...
  @js.native
  def TinySDF: Instantiable1[/* options */ TinySDFOptions, typingsJapgolly.mapboxTinySdf.mod.default] = js.native
  inline def TinySDF_=(x: Instantiable1[/* options */ TinySDFOptions, typingsJapgolly.mapboxTinySdf.mod.default]): scala.Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TinySDF")(x.asInstanceOf[js.Any])
