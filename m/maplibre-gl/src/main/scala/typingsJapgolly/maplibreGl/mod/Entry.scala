...
trait Entry extends StObject {
  ...
  var tinySDF: js.UndefOr[typingsJapgolly.mapboxTinySdf.mod.default] = js.undefined
}
object Entry {
  ...
  extension [Self <: Entry](x: Self) {
    ...
    inline def setTinySDF(value: typingsJapgolly.mapboxTinySdf.mod.default): Self = StObject.set(x, "tinySDF", value.asInstanceOf[js.Any])
