...
import typingsJapgolly.maplibreGl.anon.Fillextrusionbase
...
trait FillExtrusionLayerSpecification
  ...
  var paint: js.UndefOr[Fillextrusionbase] = js.undefined
...
object FillExtrusionLayerSpecification {
  ...
  extension [Self <: FillExtrusionLayerSpecification](x: Self) {
    ...
    inline def setPaint(value: Fillextrusionbase): Self = StObject.set(x, "paint", value.asInstanceOf[js.Any])
