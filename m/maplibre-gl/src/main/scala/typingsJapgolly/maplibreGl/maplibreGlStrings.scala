...
import typingsJapgolly.maplibreGl.distStyleSpecMod.EvaluationKind
import typingsJapgolly.maplibreGl.mod.ControlPosition
import typingsJapgolly.maplibreGl.mod.ExpressionType
import typingsJapgolly.maplibreGl.mod.MapEvent
import typingsJapgolly.maplibreGl.mod.MapSourceDataType
import typingsJapgolly.maplibreGl.mod.OverlapMode
import typingsJapgolly.maplibreGl.mod.PositionAnchor
import typingsJapgolly.maplibreGl.mod.RenderPass
import typingsJapgolly.maplibreGl.mod.ResourceTypeEnum
import typingsJapgolly.maplibreGl.mod.TextAnchor
import typingsJapgolly.maplibreGl.mod.TileState
import typingsJapgolly.maplibreGl.mod.Unit
import typingsJapgolly.maplibreGl.mod.ViewType
...
object maplibreGlStrings {
  ...
  sealed trait `color-ramp`
    extends StObject
       with ExpressionType
       with typingsJapgolly.maplibreGl.distStyleSpecMod.ExpressionType
