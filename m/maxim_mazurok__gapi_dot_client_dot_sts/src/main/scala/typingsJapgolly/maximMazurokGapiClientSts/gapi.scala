...
import typingsJapgolly.maximMazurokGapiClientSts.anon.Accesstoken
import typingsJapgolly.maximMazurokGapiClientSts.anon.Alt
import typingsJapgolly.maximMazurokGapiClientSts.anon.Callback
