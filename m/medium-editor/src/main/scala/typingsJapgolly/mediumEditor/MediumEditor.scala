...
import typingsJapgolly.mediumEditor.anon.Major
import typingsJapgolly.mediumEditor.anon.Prop
...
object MediumEditor {
  ...
  Instantiable1[/* elements */ elementType, typingsJapgolly.mediumEditor.MediumEditor.MediumEditor]
    ...
    def subscribe(name: String, listener: js.Function2[/* data */ Any, /* editable */ HTMLElement, Unit]): typingsJapgolly.mediumEditor.MediumEditor.MediumEditor = js.native
    
    def trigger(name: String, data: Any, editable: HTMLElement): typingsJapgolly.mediumEditor.MediumEditor.MediumEditor = js.native
    
    def unsubscribe(name: String, listener: js.Function2[/* data */ Any, /* editable */ HTMLElement, Unit]): typingsJapgolly.mediumEditor.MediumEditor.MediumEditor = js.native
  ...
  type elementType = String | HTMLElement | js.Array[HTMLElement] | (NodeList[(Element & Node) | Node]) | HTMLCollection[Any]
