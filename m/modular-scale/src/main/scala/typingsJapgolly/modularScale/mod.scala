package typingsJapgolly.modularScale
...
object mod {
  ...
  inline def default(options: ModularScaleOptions): typingsJapgolly.modularScale.mod.modularScale = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.modularScale.mod.modularScale]
