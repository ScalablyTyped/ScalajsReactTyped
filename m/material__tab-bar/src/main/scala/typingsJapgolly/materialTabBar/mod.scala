...
import typingsJapgolly.materialTabBar.anon.PartialMDCTabBarAdapter
...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialTabBar.foundationMod.default {
  ...
  open class MDCTabBar protected ()
    extends typingsJapgolly.materialTabBar.componentMod.MDCTabBar {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
      foundation: typingsJapgolly.materialTabBar.foundationMod.MDCTabBarFoundation,
      args: Any*
    ) = this()
  }
  /* static members */
  object MDCTabBar {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): typingsJapgolly.materialTabBar.componentMod.MDCTabBar = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.materialTabBar.componentMod.MDCTabBar]
  }
  
  @JSImport("@material/tab-bar", "MDCTabBarFoundation")
  @js.native
  open class MDCTabBarFoundation ()
    extends typingsJapgolly.materialTabBar.foundationMod.MDCTabBarFoundation {
    def this(adapter: PartialMDCTabBarAdapter) = this()
  }
