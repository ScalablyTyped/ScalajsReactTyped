...
object anon {
  ...
  object PartialMDCTabBarAdapter {
    ...
    extension [Self <: PartialMDCTabBarAdapter](x: Self) {
      ...
      inline def setActivateTabAtIndex(value: (/* index */ Double, /* clientRect */ js.UndefOr[DOMRect]) => Callback): Self = StObject.set(x, "activateTabAtIndex", js.Any.fromFunction2((t0: /* index */ Double, t1: /* clientRect */ js.UndefOr[DOMRect]) => (value(t0, t1)).runNow()))
      
      inline def setActivateTabAtIndexUndefined: Self = StObject.set(x, "activateTabAtIndex", js.undefined)
      
      inline def setDeactivateTabAtIndex(value: /* index */ Double => Callback): Self = StObject.set(x, "deactivateTabAtIndex", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
      
      inline def setDeactivateTabAtIndexUndefined: Self = StObject.set(x, "deactivateTabAtIndex", js.undefined)
      
      inline def setFocusTabAtIndex(value: /* index */ Double => Callback): Self = StObject.set(x, "focusTabAtIndex", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
      
      inline def setFocusTabAtIndexUndefined: Self = StObject.set(x, "focusTabAtIndex", js.undefined)
      
      inline def setGetFocusedTabIndex(value: CallbackTo[Double]): Self = StObject.set(x, "getFocusedTabIndex", value.toJsFn)
      ...
      inline def setGetPreviousActiveTabIndex(value: CallbackTo[Double]): Self = StObject.set(x, "getPreviousActiveTabIndex", value.toJsFn)
      
      inline def setGetPreviousActiveTabIndexUndefined: Self = StObject.set(x, "getPreviousActiveTabIndex", js.undefined)
      
      inline def setGetScrollContentWidth(value: CallbackTo[Double]): Self = StObject.set(x, "getScrollContentWidth", value.toJsFn)
      ...
      inline def setGetTabListLength(value: CallbackTo[Double]): Self = StObject.set(x, "getTabListLength", value.toJsFn)
      
      inline def setGetTabListLengthUndefined: Self = StObject.set(x, "getTabListLength", js.undefined)
      
      inline def setIncrementScroll(value: /* scrollXIncrement */ Double => Callback): Self = StObject.set(x, "incrementScroll", js.Any.fromFunction1((t0: /* scrollXIncrement */ Double) => value(t0).runNow()))
      ...
      inline def setNotifyTabActivated(value: /* index */ Double => Callback): Self = StObject.set(x, "notifyTabActivated", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
      
      inline def setNotifyTabActivatedUndefined: Self = StObject.set(x, "notifyTabActivated", js.undefined)
      
      inline def setScrollTo(value: /* scrollX */ Double => Callback): Self = StObject.set(x, "scrollTo", js.Any.fromFunction1((t0: /* scrollX */ Double) => value(t0).runNow()))
      
      inline def setScrollToUndefined: Self = StObject.set(x, "scrollTo", js.undefined)
      
      inline def setSetActiveTab(value: /* index */ Double => Callback): Self = StObject.set(x, "setActiveTab", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
