...
import typingsJapgolly.maximMazurokGapiClientToolresults.anon.ExecutionId
import typingsJapgolly.maximMazurokGapiClientToolresults.anon.HistoryId
import typingsJapgolly.maximMazurokGapiClientToolresults.anon.Locale
import typingsJapgolly.maximMazurokGapiClientToolresults.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientToolresults.anon.RequestId
import typingsJapgolly.maximMazurokGapiClientToolresults.anon.Resource
import typingsJapgolly.maximMazurokGapiClientToolresults.anon.StepId
import typingsJapgolly.maximMazurokGapiClientToolresults.anon.UploadType
