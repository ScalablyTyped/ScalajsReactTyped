...
import typingsJapgolly.moddle.anon.LocalName
import typingsJapgolly.moddle.anon.TypeofElement
import typingsJapgolly.moddle.moddleBooleans.`true`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.moddle.moddleStrings.String
    - typingsJapgolly.moddle.moddleStrings.Boolean
    - typingsJapgolly.moddle.moddleStrings.Integer
    - typingsJapgolly.moddle.moddleStrings.Real
    - typingsJapgolly.moddle.moddleStrings.Element
  */
  trait BuiltInTypes extends StObject
  object BuiltInTypes {
    
    inline def Boolean: typingsJapgolly.moddle.moddleStrings.Boolean = "Boolean".asInstanceOf[typingsJapgolly.moddle.moddleStrings.Boolean]
    
    inline def Element: typingsJapgolly.moddle.moddleStrings.Element = "Element".asInstanceOf[typingsJapgolly.moddle.moddleStrings.Element]
    
    inline def Integer: typingsJapgolly.moddle.moddleStrings.Integer = "Integer".asInstanceOf[typingsJapgolly.moddle.moddleStrings.Integer]
    
    inline def Real: typingsJapgolly.moddle.moddleStrings.Real = "Real".asInstanceOf[typingsJapgolly.moddle.moddleStrings.Real]
    
    inline def String: typingsJapgolly.moddle.moddleStrings.String = "String".asInstanceOf[typingsJapgolly.moddle.moddleStrings.String]
  }
