...
import typingsJapgolly.matrixAppserviceBridge.anon.BackingStore
import typingsJapgolly.matrixAppserviceBridge.anon.Eventid
import typingsJapgolly.matrixAppserviceBridge.anon.Roomid
import typingsJapgolly.matrixAppserviceBridge.anon.Ttl
import typingsJapgolly.matrixAppserviceBridge.libComponentsEventTypesMod.WeakStateEvent
import typingsJapgolly.matrixAppserviceBridge.libComponentsMembershipCacheMod.UserMembership
import typingsJapgolly.matrixAppserviceBridge.libErrorsMod.unstable.BridgeErrorReason
import typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.`private`
import typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.public
import typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.registeredEqualssigntrue
...
object libComponentsIntentMod {
  ...
  object IntentBackingStore {
    ...
    inline def apply(
      ...
      setMembership: (String, String, UserMembership, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify MatrixProfileInfo */ Any) => Callback,
      setPowerLevelContent: (String, PowerLevelContent) => Callback
    ): IntentBackingStore = {
      val __obj = js.Dynamic.literal(getMemberProfile = js.Any.fromFunction2(getMemberProfile), getMembership = js.Any.fromFunction2(getMembership), getPowerLevelContent = js.Any.fromFunction1(getPowerLevelContent), setMembership = js.Any.fromFunction4((t0: String, t1: String, t2: UserMembership, t3: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify MatrixProfileInfo */ Any) => (setMembership(t0, t1, t2, t3)).runNow()), setPowerLevelContent = js.Any.fromFunction2((t0: String, t1: PowerLevelContent) => (setPowerLevelContent(t0, t1)).runNow()))
    ...
    extension [Self <: IntentBackingStore](x: Self) {
      ...
      inline def setSetMembership(
        value: (String, String, UserMembership, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify MatrixProfileInfo */ Any) => Callback
      ): Self = StObject.set(x, "setMembership", js.Any.fromFunction4((t0: String, t1: String, t2: UserMembership, t3: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify MatrixProfileInfo */ Any) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setSetPowerLevelContent(value: (String, PowerLevelContent) => Callback): Self = StObject.set(x, "setPowerLevelContent", js.Any.fromFunction2((t0: String, t1: PowerLevelContent) => (value(t0, t1)).runNow()))
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.avatar_url
    - typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.displayname
    - scala.Null
  */
