...
object libComponentsMembershipCacheMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.join
    - typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.invite
    - typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.leave
    - typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.ban
    - scala.Null
  */
