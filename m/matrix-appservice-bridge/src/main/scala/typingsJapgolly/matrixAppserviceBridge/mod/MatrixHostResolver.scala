...
import typingsJapgolly.matrixAppserviceBridge.anon.Axios
...
open class MatrixHostResolver ()
  extends typingsJapgolly.matrixAppserviceBridge.libUtilsMatrixHostResolverMod.MatrixHostResolver {
