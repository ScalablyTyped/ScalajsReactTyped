...
import typingsJapgolly.matrixAppserviceBridge.libComponentsMembershipQueueMod.MembershipQueueOptsWithDefaults
import typingsJapgolly.matrixAppserviceBridge.mod.^
