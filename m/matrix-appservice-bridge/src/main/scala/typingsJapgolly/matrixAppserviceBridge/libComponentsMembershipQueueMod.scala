...
import typingsJapgolly.matrixAppserviceBridge.libBridgeMod.Bridge
import typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.join
import typingsJapgolly.matrixAppserviceBridge.matrixAppserviceBridgeStrings.leave
...
object libComponentsMembershipQueueMod {
  ...
  object ThinRequest {
    ...
    inline def apply(getId: CallbackTo[String]): ThinRequest = {
