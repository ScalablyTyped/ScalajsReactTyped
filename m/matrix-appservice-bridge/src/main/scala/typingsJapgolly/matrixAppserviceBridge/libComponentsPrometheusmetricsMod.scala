...
import typingsJapgolly.matrixAppserviceBridge.libComponentsAgecountersMod.AgeCounters
import typingsJapgolly.matrixAppserviceBridge.mod.Bridge
import typingsJapgolly.promClient.mod.Counter
import typingsJapgolly.promClient.mod.Gauge
import typingsJapgolly.promClient.mod.Histogram
...
object libComponentsPrometheusmetricsMod {
  ...
  object PrometheusMetrics {
    ...
    def AgeCounters: Instantiable1[
        ...
        typingsJapgolly.matrixAppserviceBridge.libComponentsAgecountersMod.AgeCounters
      ] = js.native
  ...
  object GaugeOpts {
    ...
    extension [Self <: GaugeOpts](x: Self) {
      ...
      inline def setRefresh(value: /* gauge */ Gauge[String] => Callback): Self = StObject.set(x, "refresh", js.Any.fromFunction1((t0: /* gauge */ Gauge[String]) => value(t0).runNow()))
