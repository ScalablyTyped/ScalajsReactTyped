...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "express-rate-limit" % "6.6.0-dd1da1",
  "org.scalablytyped.japgolly" %%% "express-serve-static-core" % "0.1.1-5aecff",
  "org.scalablytyped.japgolly" %%% "logform" % "2.4.2-fd6c39",
  "org.scalablytyped.japgolly" %%% "matrix-appservice" % "1.1.0-e2e909",
  "org.scalablytyped.japgolly" %%% "mime" % "3.0-dt-20220804Z-38356b",
  "org.scalablytyped.japgolly" %%% "nedb" % "1.8-dt-20211202Z-755c51",
  "org.scalablytyped.japgolly" %%% "node" % "18.11-dt-20221015Z-288d1b",
  "org.scalablytyped.japgolly" %%% "prom-client" % "14.1.0-0b8ebd",
