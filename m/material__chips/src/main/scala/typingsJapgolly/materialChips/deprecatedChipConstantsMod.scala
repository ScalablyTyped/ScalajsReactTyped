...
object deprecatedChipConstantsMod {
  ...
  object Direction extends StObject {
    ...
    sealed trait LEFT
      extends StObject
         with Direction
    /* "left" */ val LEFT: typingsJapgolly.materialChips.deprecatedChipConstantsMod.Direction.LEFT & String = js.native
    
    @js.native
    sealed trait RIGHT
      extends StObject
         with Direction
    /* "right" */ val RIGHT: typingsJapgolly.materialChips.deprecatedChipConstantsMod.Direction.RIGHT & String = js.native
  }
  ...
  object EventSource extends StObject {
    ...
    sealed trait NONE
      extends StObject
         with EventSource
    /* "none" */ val NONE: typingsJapgolly.materialChips.deprecatedChipConstantsMod.EventSource.NONE & String = js.native
    
    @js.native
    sealed trait PRIMARY
      extends StObject
         with EventSource
    /* "primary" */ val PRIMARY: typingsJapgolly.materialChips.deprecatedChipConstantsMod.EventSource.PRIMARY & String = js.native
    
    @js.native
    sealed trait TRAILING
      extends StObject
         with EventSource
    /* "trailing" */ val TRAILING: typingsJapgolly.materialChips.deprecatedChipConstantsMod.EventSource.TRAILING & String = js.native
  }
