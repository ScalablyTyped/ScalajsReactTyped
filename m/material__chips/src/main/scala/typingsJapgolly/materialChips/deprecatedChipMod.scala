...
object deprecatedChipMod {
  
  @JSImport("@material/chips/deprecated/chip", JSImport.Default)
  @js.native
  open class default ()
    extends typingsJapgolly.materialChips.deprecatedChipFoundationMod.default {
    def this(adapter: PartialMDCChipAdapterAddClass) = this()
  }
  
  @JSImport("@material/chips/deprecated/chip", "MDCChip")
  @js.native
  open class MDCChip protected ()
    extends typingsJapgolly.materialChips.deprecatedChipComponentMod.MDCChip {
  ...
  @JSImport("@material/chips/deprecated/chip", "MDCChipFoundation")
  @js.native
  open class MDCChipFoundation ()
    extends typingsJapgolly.materialChips.deprecatedChipFoundationMod.MDCChipFoundation {
    def this(adapter: PartialMDCChipAdapterAddClass) = this()
  }
  
  object chipCssClasses {
    
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.CHECKMARK")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.CHIP_EXIT")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.DELETABLE")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.EDITABLE")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.EDITING")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.HIDDEN_LEADING_ICON")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.LEADING_ICON")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.PRIMARY_ACTION")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.PRIMARY_ACTION_FOCUSED")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.SELECTED")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.TEXT")
    @js.native
    def TEXT: String = js.native
    inline def TEXT_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TEXT")(x.asInstanceOf[js.Any])
    
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.TRAILING_ACTION")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipCssClasses.TRAILING_ICON")
    @js.native
  ...
  object chipStrings {
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@material/chips/deprecated/chip", "chipStrings.ADDED_ANNOUNCEMENT_ATTRIBUTE")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.ARIA_CHECKED")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.ARROW_DOWN_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.ARROW_LEFT_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.ARROW_RIGHT_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.ARROW_UP_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.BACKSPACE_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.CHECKMARK_SELECTOR")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.DELETE_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.END_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.ENTER_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.ENTRY_ANIMATION_NAME")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.HOME_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.IE_ARROW_DOWN_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.IE_ARROW_LEFT_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.IE_ARROW_RIGHT_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.IE_ARROW_UP_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.IE_DELETE_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.INTERACTION_EVENT")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.LEADING_ICON_SELECTOR")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.NAVIGATION_EVENT")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.PRIMARY_ACTION_SELECTOR")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.REMOVAL_EVENT")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.REMOVED_ANNOUNCEMENT_ATTRIBUTE")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.SELECTION_EVENT")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.SPACEBAR_KEY")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.TAB_INDEX")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.TRAILING_ACTION_SELECTOR")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.TRAILING_ICON_INTERACTION_EVENT")
    @js.native
    ...
    @JSImport("@material/chips/deprecated/chip", "chipStrings.TRAILING_ICON_SELECTOR")
    @js.native
