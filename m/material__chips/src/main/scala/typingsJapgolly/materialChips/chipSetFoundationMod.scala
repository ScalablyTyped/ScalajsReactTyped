...
import typingsJapgolly.materialChips.chipSetAdapterMod.MDCChipSetAdapter
...
object chipSetFoundationMod {
  ...
  open class MDCChipSetFoundation () extends MDCFoundation[MDCChipSetAdapter] {
    ...
    def handleChipAnimation(hasDetail: CustomEvent): Unit = js.native
    
    def handleChipInteraction(hasDetail: CustomEvent): Unit = js.native
    
    def handleChipNavigation(hasDetail: CustomEvent): Unit = js.native
