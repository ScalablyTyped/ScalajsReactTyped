...
import typingsJapgolly.materialChips.deprecatedChipComponentMod.MDCChip
import typingsJapgolly.materialChips.deprecatedChipComponentMod.MDCChipFactory
import typingsJapgolly.materialChips.deprecatedChipSetFoundationMod.MDCChipSetFoundation
...
object deprecatedChipSetComponentMod {
  ...
  open class MDCChipSet protected () extends MDCComponent[MDCChipSetFoundation] {
    ...
    /**
      ...
      */
    def addChip(chipEl: org.scalajs.dom.Element): Unit = js.native
  ...
  object MDCChipSet {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCChipSet = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCChipSet]
  }
}
