...
object deprecatedChipSetMod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialChips.deprecatedChipSetFoundationMod.default {
  ...
  open class MDCChipSet protected ()
    extends typingsJapgolly.materialChips.deprecatedChipSetComponentMod.MDCChipSet {
  ...
  open class MDCChipSetFoundation ()
    extends typingsJapgolly.materialChips.deprecatedChipSetFoundationMod.MDCChipSetFoundation {
    def this(adapter: PartialMDCChipSetAdapterAnnounceMessage) = this()
  }
