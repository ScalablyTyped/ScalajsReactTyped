...
object deprecatedTrailingactionConstantsMod {
  ...
  object InteractionTrigger extends StObject {
    ...
    /* 2 */ val BACKSPACE_KEY: typingsJapgolly.materialChips.deprecatedTrailingactionConstantsMod.InteractionTrigger.BACKSPACE_KEY & Double = js.native
    
    @js.native
    sealed trait CLICK
      extends StObject
         with InteractionTrigger
    /* 1 */ val CLICK: typingsJapgolly.materialChips.deprecatedTrailingactionConstantsMod.InteractionTrigger.CLICK & Double = js.native
    
    @js.native
    sealed trait DELETE_KEY
      extends StObject
         with InteractionTrigger
    /* 3 */ val DELETE_KEY: typingsJapgolly.materialChips.deprecatedTrailingactionConstantsMod.InteractionTrigger.DELETE_KEY & Double = js.native
    
    @js.native
    sealed trait ENTER_KEY
      extends StObject
         with InteractionTrigger
    /* 5 */ val ENTER_KEY: typingsJapgolly.materialChips.deprecatedTrailingactionConstantsMod.InteractionTrigger.ENTER_KEY & Double = js.native
    
    @js.native
    sealed trait SPACEBAR_KEY
      extends StObject
         with InteractionTrigger
    /* 4 */ val SPACEBAR_KEY: typingsJapgolly.materialChips.deprecatedTrailingactionConstantsMod.InteractionTrigger.SPACEBAR_KEY & Double = js.native
    
    @js.native
    sealed trait UNSPECIFIED
      extends StObject
         with InteractionTrigger
    /* 0 */ val UNSPECIFIED: typingsJapgolly.materialChips.deprecatedTrailingactionConstantsMod.InteractionTrigger.UNSPECIFIED & Double = js.native
  }
