...
trait NodeTypeList extends StObject {
  ...
  var items: js.UndefOr[js.Array[NodeType]] = js.undefined
...
object NodeTypeList {
  ...
  inline def apply(): NodeTypeList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeTypeList]
  }
  
  extension [Self <: NodeTypeList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[NodeType]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: NodeType*): Self = StObject.set(x, "items", js.Array(value*))
