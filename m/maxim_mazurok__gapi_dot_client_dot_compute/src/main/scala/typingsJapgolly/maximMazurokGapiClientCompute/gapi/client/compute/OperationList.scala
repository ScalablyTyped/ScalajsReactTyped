...
trait OperationList extends StObject {
...
object OperationList {
  ...
  inline def apply(): OperationList = {
  ...
  extension [Self <: OperationList](x: Self) {
    ...
    inline def setItems(value: js.Array[Operation]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
