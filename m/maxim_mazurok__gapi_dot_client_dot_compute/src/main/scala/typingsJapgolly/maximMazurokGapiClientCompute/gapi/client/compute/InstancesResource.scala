...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.AltCallbackFieldsInstance
import typingsJapgolly.maximMazurokGapiClientCompute.anon.AutoDelete
import typingsJapgolly.maximMazurokGapiClientCompute.anon.CallbackFieldsInstance
import typingsJapgolly.maximMazurokGapiClientCompute.anon.CallbackFieldsInstanceKey
import typingsJapgolly.maximMazurokGapiClientCompute.anon.CallbackFieldsKeyOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.DeletionProtection
import typingsJapgolly.maximMazurokGapiClientCompute.anon.DeviceName
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsForceAttach
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsInstance
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsInstanceKey
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsInstanceKeyOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FilterInstance
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ForceAttach
import typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceKey
import typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceKeyOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceKeyOauthtokenPrettyPrint
import typingsJapgolly.maximMazurokGapiClientCompute.anon.KeyNetworkInterface
import typingsJapgolly.maximMazurokGapiClientCompute.anon.KeyOauthtokenPrettyPrintProject
import typingsJapgolly.maximMazurokGapiClientCompute.anon.MinimalAction
import typingsJapgolly.maximMazurokGapiClientCompute.anon.MostDisruptiveAllowedAction
import typingsJapgolly.maximMazurokGapiClientCompute.anon.NetworkInterfaceOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.OauthtokenPrettyPrintProjectQuotaUser
import typingsJapgolly.maximMazurokGapiClientCompute.anon.OptionsRequestedPolicyVersion
import typingsJapgolly.maximMazurokGapiClientCompute.anon.Port
import typingsJapgolly.maximMazurokGapiClientCompute.anon.PrettyPrintProjectQuotaUserRequestId
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ProjectQuotaUserRequestIdResource
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QueryPath
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QuotaUserRequestIdResourceUploadType
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QuotaUserResource
import typingsJapgolly.maximMazurokGapiClientCompute.anon.RequestIdResourceUploadTypeUploadprotocol
import typingsJapgolly.maximMazurokGapiClientCompute.anon.RequestIdSourceInstanceTemplate
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ResourceUploadTypeUploadprotocolUserIp
import typingsJapgolly.maximMazurokGapiClientCompute.anon.SourceInstanceTemplate
...
trait InstancesResource extends StObject {
  ...
  def addAccessConfig(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Instance): Request[Operation] = js.native
  def addAccessConfig(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.NetworkInterface, body: AccessConfig): Request[Operation] = js.native
  ...
  def deleteAccessConfig(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.AccessConfig): Request[Operation] = js.native
  ...
  /**
    ...
    * format and processing rules.
    */
  def updateAccessConfig(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Instance): Request[Operation] = js.native
  def updateAccessConfig(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.NetworkInterface, body: AccessConfig): Request[Operation] = js.native
  ...
  def updateNetworkInterface(
    request: typingsJapgolly.maximMazurokGapiClientCompute.anon.NetworkInterface,
