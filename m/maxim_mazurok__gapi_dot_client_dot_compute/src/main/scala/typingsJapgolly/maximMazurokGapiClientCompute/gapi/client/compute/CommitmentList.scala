...
trait CommitmentList extends StObject {
...
object CommitmentList {
  ...
  inline def apply(): CommitmentList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CommitmentList]
  }
  
  extension [Self <: CommitmentList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Commitment]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Commitment*): Self = StObject.set(x, "items", js.Array(value*))
