...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.CallbackDisk
import typingsJapgolly.maximMazurokGapiClientCompute.anon.DiskFields
import typingsJapgolly.maximMazurokGapiClientCompute.anon.GuestFlush
import typingsJapgolly.maximMazurokGapiClientCompute.anon.OptionsRequestedPolicyVersion
import typingsJapgolly.maximMazurokGapiClientCompute.anon.PrettyPrintProject
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ProjectQuotaUser
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QuotaUserRequestId
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QuotaUserResource
import typingsJapgolly.maximMazurokGapiClientCompute.anon.RequestIdResource
import typingsJapgolly.maximMazurokGapiClientCompute.anon.SourceImage
...
trait DisksResource extends StObject {
  ...
  def addResourcePolicies(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Disk): Request[Operation] = js.native
  def addResourcePolicies(
    request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Zone,
  ...
  def delete(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Zone): Request[Operation] = js.native
  ...
  def resize(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Zone, body: DisksResizeRequest): Request[Operation] = js.native
