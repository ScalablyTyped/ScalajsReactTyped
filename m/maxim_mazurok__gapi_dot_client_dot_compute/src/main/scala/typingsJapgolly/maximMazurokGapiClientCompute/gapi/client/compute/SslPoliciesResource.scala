...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QuotaUserSslPolicy
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ResourceSslPolicy
...
trait SslPoliciesResource extends StObject {
  ...
  def delete(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.SslPolicy): Request[Operation] = js.native
  ...
  def patch(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.SslPolicy, body: SslPolicy): Request[Operation] = js.native
}
