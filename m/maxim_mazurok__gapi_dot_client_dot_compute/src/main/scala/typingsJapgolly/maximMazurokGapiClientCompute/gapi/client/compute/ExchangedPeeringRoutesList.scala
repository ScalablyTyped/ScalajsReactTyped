...
trait ExchangedPeeringRoutesList extends StObject {
  ...
  var items: js.UndefOr[js.Array[ExchangedPeeringRoute]] = js.undefined
...
object ExchangedPeeringRoutesList {
  ...
  inline def apply(): ExchangedPeeringRoutesList = {
  ...
  extension [Self <: ExchangedPeeringRoutesList](x: Self) {
    ...
    inline def setItems(value: js.Array[ExchangedPeeringRoute]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: ExchangedPeeringRoute*): Self = StObject.set(x, "items", js.Array(value*))
