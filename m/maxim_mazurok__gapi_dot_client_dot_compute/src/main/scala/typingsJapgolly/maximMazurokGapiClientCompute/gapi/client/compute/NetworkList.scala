...
object NetworkList {
  ...
  inline def apply(): NetworkList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NetworkList]
  }
  
  extension [Self <: NetworkList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Network]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Network*): Self = StObject.set(x, "items", js.Array(value*))
