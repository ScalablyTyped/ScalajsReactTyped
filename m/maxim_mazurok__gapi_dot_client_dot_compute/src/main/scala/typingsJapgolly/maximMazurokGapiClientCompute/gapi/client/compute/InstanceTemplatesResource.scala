...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsInstanceTemplate
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsKeyOauthtokenPrettyPrint
...
trait InstanceTemplatesResource extends StObject {
  ...
  def delete(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceTemplate): Request[Operation] = js.native
