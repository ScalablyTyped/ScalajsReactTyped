...
trait BackendServiceCdnPolicy extends StObject {
  ...
  /**
    ...
    */
  var bypassCacheOnRequestHeaders: js.UndefOr[js.Array[BackendServiceCdnPolicyBypassCacheOnRequestHeader]] = js.undefined
  ...
  /**
    ...
    */
  var negativeCachingPolicy: js.UndefOr[js.Array[BackendServiceCdnPolicyNegativeCachingPolicy]] = js.undefined
...
object BackendServiceCdnPolicy {
  ...
  extension [Self <: BackendServiceCdnPolicy](x: Self) {
    ...
    inline def setBypassCacheOnRequestHeaders(value: js.Array[BackendServiceCdnPolicyBypassCacheOnRequestHeader]): Self = StObject.set(x, "bypassCacheOnRequestHeaders", value.asInstanceOf[js.Any])
    
    inline def setBypassCacheOnRequestHeadersUndefined: Self = StObject.set(x, "bypassCacheOnRequestHeaders", js.undefined)
    
    inline def setBypassCacheOnRequestHeadersVarargs(value: BackendServiceCdnPolicyBypassCacheOnRequestHeader*): Self = StObject.set(x, "bypassCacheOnRequestHeaders", js.Array(value*))
    ...
    inline def setNegativeCachingPolicy(value: js.Array[BackendServiceCdnPolicyNegativeCachingPolicy]): Self = StObject.set(x, "negativeCachingPolicy", value.asInstanceOf[js.Any])
    
    inline def setNegativeCachingPolicyUndefined: Self = StObject.set(x, "negativeCachingPolicy", js.undefined)
    
    inline def setNegativeCachingPolicyVarargs(value: BackendServiceCdnPolicyNegativeCachingPolicy*): Self = StObject.set(x, "negativeCachingPolicy", js.Array(value*))
