...
object XpnHostList {
  ...
  inline def apply(): XpnHostList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[XpnHostList]
  }
  
  extension [Self <: XpnHostList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Project]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Project*): Self = StObject.set(x, "items", js.Array(value*))
