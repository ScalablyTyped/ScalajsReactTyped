...
trait NotificationEndpointList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  
  /** A list of NotificationEndpoint resources. */
  var items: js.UndefOr[js.Array[NotificationEndpoint]] = js.undefined
...
object NotificationEndpointList {
  
  inline def apply(): NotificationEndpointList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NotificationEndpointList]
  }
  
  extension [Self <: NotificationEndpointList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[NotificationEndpoint]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: NotificationEndpoint*): Self = StObject.set(x, "items", js.Array(value*))
