...
trait RegionList extends StObject {
...
object RegionList {
  ...
  inline def apply(): RegionList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[RegionList]
  }
  
  extension [Self <: RegionList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Region]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Region*): Self = StObject.set(x, "items", js.Array(value*))
