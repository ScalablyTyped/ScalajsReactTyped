...
trait DiskList extends StObject {
  ...
  var items: js.UndefOr[js.Array[Disk]] = js.undefined
...
object DiskList {
  ...
  inline def apply(): DiskList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiskList]
  }
  
  extension [Self <: DiskList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Disk]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Disk*): Self = StObject.set(x, "items", js.Array(value*))
