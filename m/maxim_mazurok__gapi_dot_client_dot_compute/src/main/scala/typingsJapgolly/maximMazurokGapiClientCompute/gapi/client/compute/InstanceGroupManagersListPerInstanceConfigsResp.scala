...
trait InstanceGroupManagersListPerInstanceConfigsResp extends StObject {
...
object InstanceGroupManagersListPerInstanceConfigsResp {
  
  inline def apply(): InstanceGroupManagersListPerInstanceConfigsResp = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceGroupManagersListPerInstanceConfigsResp]
  }
  
  extension [Self <: InstanceGroupManagersListPerInstanceConfigsResp](x: Self) {
