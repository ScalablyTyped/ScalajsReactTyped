...
trait PublicDelegatedPrefixList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  
  /** A list of PublicDelegatedPrefix resources. */
  var items: js.UndefOr[js.Array[PublicDelegatedPrefix]] = js.undefined
...
object PublicDelegatedPrefixList {
  
  inline def apply(): PublicDelegatedPrefixList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PublicDelegatedPrefixList]
  }
  
  extension [Self <: PublicDelegatedPrefixList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[PublicDelegatedPrefix]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: PublicDelegatedPrefix*): Self = StObject.set(x, "items", js.Array(value*))
