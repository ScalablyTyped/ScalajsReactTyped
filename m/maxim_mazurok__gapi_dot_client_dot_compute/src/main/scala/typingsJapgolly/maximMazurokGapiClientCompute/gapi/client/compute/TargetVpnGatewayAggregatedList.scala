...
trait TargetVpnGatewayAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.TargetVpnGatewaysScopedList} */ js.Any
  ] = js.undefined
...
object TargetVpnGatewayAggregatedList {
  ...
  inline def apply(): TargetVpnGatewayAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TargetVpnGatewayAggregatedList]
  }
  
  extension [Self <: TargetVpnGatewayAggregatedList](x: Self) {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.TargetVpnGatewaysScopedList} */ js.Any
