...
trait GlobalOrganizationSetPolicyRequest extends StObject {
...
object GlobalOrganizationSetPolicyRequest {
  
  inline def apply(): GlobalOrganizationSetPolicyRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GlobalOrganizationSetPolicyRequest]
  }
  
  extension [Self <: GlobalOrganizationSetPolicyRequest](x: Self) {
