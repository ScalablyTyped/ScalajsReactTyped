...
trait PublicDelegatedPrefixAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.PublicDelegatedPrefixesScopedList} */ js.Any
  ] = js.undefined
...
object PublicDelegatedPrefixAggregatedList {
  
  inline def apply(): PublicDelegatedPrefixAggregatedList = {
  ...
  extension [Self <: PublicDelegatedPrefixAggregatedList](x: Self) {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.PublicDelegatedPrefixesScopedList} */ js.Any
