...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.AltCallbackFieldsKey
import typingsJapgolly.maximMazurokGapiClientCompute.anon.CallbackFieldsInstanceGroup
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsFilter
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsInstanceGroup
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsInstanceGroupKey
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FilterInstanceGroup
import typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceGroupKey
...
trait InstanceGroupsResource extends StObject {
  ...
  /**
    ...
    * information.
    */
  def addInstances(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceGroup): Request[Operation] = js.native
  
  /** Retrieves the list of instance groups and sorts them by zone. */
  def aggregatedList(): Request[InstanceGroupAggregatedList] = js.native
  def aggregatedList(request: Accesstoken): Request[InstanceGroupAggregatedList] = js.native
  ...
  def insert(request: AltCallbackFieldsKey): Request[Operation] = js.native
  def insert(request: QuotaUser, body: InstanceGroup): Request[Operation] = js.native
  ...
  def list(request: Alt): Request[InstanceGroupList] = js.native
  ...
  /**
    ...
    */
  def removeInstances(request: CallbackFieldsInstanceGroup): Request[Operation] = js.native
