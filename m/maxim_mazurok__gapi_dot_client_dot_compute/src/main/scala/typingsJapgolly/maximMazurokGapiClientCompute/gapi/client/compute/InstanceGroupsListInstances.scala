...
trait InstanceGroupsListInstances extends StObject {
...
object InstanceGroupsListInstances {
  ...
  inline def apply(): InstanceGroupsListInstances = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InstanceGroupsListInstances]
  }
  
  extension [Self <: InstanceGroupsListInstances](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[InstanceWithNamedPorts]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: InstanceWithNamedPorts*): Self = StObject.set(x, "items", js.Array(value*))
