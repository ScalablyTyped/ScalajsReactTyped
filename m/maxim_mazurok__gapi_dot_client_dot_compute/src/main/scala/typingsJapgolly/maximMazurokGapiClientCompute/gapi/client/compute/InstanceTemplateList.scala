...
trait InstanceTemplateList extends StObject {
...
object InstanceTemplateList {
  ...
  inline def apply(): InstanceTemplateList = {
  ...
  extension [Self <: InstanceTemplateList](x: Self) {
    ...
    inline def setItems(value: js.Array[InstanceTemplate]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
