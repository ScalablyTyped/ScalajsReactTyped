...
object PacketMirroringMirroredResourceInfo {
  ...
  extension [Self <: PacketMirroringMirroredResourceInfo](x: Self) {
    ...
    inline def setInstancesVarargs(value: PacketMirroringMirroredResourceInfoInstanceInfo*): Self = StObject.set(x, "instances", js.Array(value*))
    ...
    inline def setSubnetworksVarargs(value: PacketMirroringMirroredResourceInfoSubnetInfo*): Self = StObject.set(x, "subnetworks", js.Array(value*))
