...
trait TargetHttpsProxyList extends StObject {
...
object TargetHttpsProxyList {
  ...
  inline def apply(): TargetHttpsProxyList = {
  ...
  extension [Self <: TargetHttpsProxyList](x: Self) {
    ...
    inline def setItems(value: js.Array[TargetHttpsProxy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: TargetHttpsProxy*): Self = StObject.set(x, "items", js.Array(value*))
