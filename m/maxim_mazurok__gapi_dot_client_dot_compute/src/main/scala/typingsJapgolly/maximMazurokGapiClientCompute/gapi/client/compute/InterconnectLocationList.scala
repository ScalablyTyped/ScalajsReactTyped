...
trait InterconnectLocationList extends StObject {
  ...
  var items: js.UndefOr[js.Array[InterconnectLocation]] = js.undefined
...
object InterconnectLocationList {
  ...
  inline def apply(): InterconnectLocationList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InterconnectLocationList]
  }
  
  extension [Self <: InterconnectLocationList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[InterconnectLocation]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: InterconnectLocation*): Self = StObject.set(x, "items", js.Array(value*))
