...
object TargetPoolList {
  ...
  inline def apply(): TargetPoolList = {
  ...
  extension [Self <: TargetPoolList](x: Self) {
    ...
    inline def setItems(value: js.Array[TargetPool]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: TargetPool*): Self = StObject.set(x, "items", js.Array(value*))
