...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.AltBackendService
import typingsJapgolly.maximMazurokGapiClientCompute.anon.AltCallback
import typingsJapgolly.maximMazurokGapiClientCompute.anon.BackendServiceCallback
import typingsJapgolly.maximMazurokGapiClientCompute.anon.CallbackFields
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsKey
import typingsJapgolly.maximMazurokGapiClientCompute.anon.KeyOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.MaxResults
import typingsJapgolly.maximMazurokGapiClientCompute.anon.OauthtokenPrettyPrint
...
trait BackendServicesResource extends StObject {
  ...
  def addSignedUrlKey(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.BackendService): Request[Operation] = js.native
