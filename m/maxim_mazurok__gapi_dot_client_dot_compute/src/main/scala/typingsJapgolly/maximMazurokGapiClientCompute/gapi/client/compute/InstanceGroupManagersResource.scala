...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.AccesstokenAltCallbackFields
import typingsJapgolly.maximMazurokGapiClientCompute.anon.Alt
import typingsJapgolly.maximMazurokGapiClientCompute.anon.CallbackFieldsInstanceGroupManager
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsInstanceGroupManager
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsInstanceGroupManagerKey
import typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceGroupManagerKey
import typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceGroupManagerKeyOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientCompute.anon.QuotaUserRequestIdResource
import typingsJapgolly.maximMazurokGapiClientCompute.anon.RequestIdResourceUploadType
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ResourceUploadTypeUploadprotocol
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ReturnPartialSuccess
import typingsJapgolly.maximMazurokGapiClientCompute.anon.Size
import typingsJapgolly.maximMazurokGapiClientCompute.anon.UploadTypeUploadprotocolUserIp
import typingsJapgolly.maximMazurokGapiClientCompute.anon.UploadprotocolUserIpXgafv
import typingsJapgolly.maximMazurokGapiClientCompute.anon.UserIpXgafvZone
import typingsJapgolly.maximMazurokGapiClientCompute.anon.XgafvZone
...
trait InstanceGroupManagersResource extends StObject {
  ...
  /**
    ...
    */
  def abandonInstances(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.InstanceGroupManager): Request[Operation] = js.native
