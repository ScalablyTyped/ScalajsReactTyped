...
trait DiskAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.DisksScopedList} */ js.Any
  ] = js.undefined
...
object DiskAggregatedList {
  ...
  inline def apply(): DiskAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiskAggregatedList]
  }
  
  extension [Self <: DiskAggregatedList](x: Self) {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.DisksScopedList} */ js.Any
