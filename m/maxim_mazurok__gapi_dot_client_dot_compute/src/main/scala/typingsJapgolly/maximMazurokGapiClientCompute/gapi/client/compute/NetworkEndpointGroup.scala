...
object NetworkEndpointGroup {
  ...
  inline def apply(): NetworkEndpointGroup = {
  ...
  extension [Self <: NetworkEndpointGroup](x: Self) {
    ...
    inline def setAppEngine(value: NetworkEndpointGroupAppEngine): Self = StObject.set(x, "appEngine", value.asInstanceOf[js.Any])
    
    inline def setAppEngineUndefined: Self = StObject.set(x, "appEngine", js.undefined)
    
    inline def setCloudFunction(value: NetworkEndpointGroupCloudFunction): Self = StObject.set(x, "cloudFunction", value.asInstanceOf[js.Any])
    
    inline def setCloudFunctionUndefined: Self = StObject.set(x, "cloudFunction", js.undefined)
    
    inline def setCloudRun(value: NetworkEndpointGroupCloudRun): Self = StObject.set(x, "cloudRun", value.asInstanceOf[js.Any])
