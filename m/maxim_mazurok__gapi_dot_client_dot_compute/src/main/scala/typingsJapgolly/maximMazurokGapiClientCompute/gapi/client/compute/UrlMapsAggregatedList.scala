...
trait UrlMapsAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.UrlMapsScopedList} */ js.Any
  ] = js.undefined
...
object UrlMapsAggregatedList {
  
  inline def apply(): UrlMapsAggregatedList = {
  ...
  extension [Self <: UrlMapsAggregatedList](x: Self) {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.UrlMapsScopedList} */ js.Any
