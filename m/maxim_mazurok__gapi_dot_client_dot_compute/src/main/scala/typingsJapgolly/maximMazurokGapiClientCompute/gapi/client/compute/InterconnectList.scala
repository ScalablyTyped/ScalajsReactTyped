...
trait InterconnectList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  
  /** A list of Interconnect resources. */
  var items: js.UndefOr[js.Array[Interconnect]] = js.undefined
...
object InterconnectList {
  
  inline def apply(): InterconnectList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InterconnectList]
  }
  
  extension [Self <: InterconnectList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[Interconnect]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: Interconnect*): Self = StObject.set(x, "items", js.Array(value*))
