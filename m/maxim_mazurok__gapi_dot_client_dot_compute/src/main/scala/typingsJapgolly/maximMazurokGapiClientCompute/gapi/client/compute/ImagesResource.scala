...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.CallbackFieldsImage
import typingsJapgolly.maximMazurokGapiClientCompute.anon.Family
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsForceCreate
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsImage
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ForceCreate
import typingsJapgolly.maximMazurokGapiClientCompute.anon.ImageKey
...
trait ImagesResource extends StObject {
  ...
  def delete(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Image): Request[Operation] = js.native
  
  /** Sets the deprecation status of an image. If an empty request body is given, clears the deprecation status instead. */
  def deprecate(request: FieldsImage): Request[Operation] = js.native
  def deprecate(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Image, body: DeprecationStatus): Request[Operation] = js.native
  ...
  def patch(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Image, body: Image): Request[Operation] = js.native
