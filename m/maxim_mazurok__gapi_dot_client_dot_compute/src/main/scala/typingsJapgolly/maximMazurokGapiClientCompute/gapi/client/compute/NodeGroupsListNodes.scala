...
trait NodeGroupsListNodes extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  
  /** A list of Node resources. */
  var items: js.UndefOr[js.Array[NodeGroupNode]] = js.undefined
...
object NodeGroupsListNodes {
  
  inline def apply(): NodeGroupsListNodes = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NodeGroupsListNodes]
  }
  
  extension [Self <: NodeGroupsListNodes](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[NodeGroupNode]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: NodeGroupNode*): Self = StObject.set(x, "items", js.Array(value*))
