...
trait AcceleratorTypeList extends StObject {
  
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  
  /** A list of AcceleratorType resources. */
  var items: js.UndefOr[js.Array[AcceleratorType]] = js.undefined
...
object AcceleratorTypeList {
  
  inline def apply(): AcceleratorTypeList = {
  ...
  extension [Self <: AcceleratorTypeList](x: Self) {
    ...
    inline def setItems(value: js.Array[AcceleratorType]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: AcceleratorType*): Self = StObject.set(x, "items", js.Array(value*))
