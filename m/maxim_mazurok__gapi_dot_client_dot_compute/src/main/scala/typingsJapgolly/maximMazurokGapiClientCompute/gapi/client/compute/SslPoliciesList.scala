...
trait SslPoliciesList extends StObject {
  ...
  var items: js.UndefOr[js.Array[SslPolicy]] = js.undefined
...
object SslPoliciesList {
  ...
  inline def apply(): SslPoliciesList = {
  ...
  extension [Self <: SslPoliciesList](x: Self) {
    ...
    inline def setItems(value: js.Array[SslPolicy]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: SslPolicy*): Self = StObject.set(x, "items", js.Array(value*))
