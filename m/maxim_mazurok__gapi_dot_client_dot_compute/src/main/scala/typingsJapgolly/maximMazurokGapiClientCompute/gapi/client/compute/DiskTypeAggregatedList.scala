...
trait DiskTypeAggregatedList extends StObject {
  ...
  var items: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.DiskTypesScopedList} */ js.Any
  ] = js.undefined
...
object DiskTypeAggregatedList {
  ...
  inline def apply(): DiskTypeAggregatedList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DiskTypeAggregatedList]
  }
  
  extension [Self <: DiskTypeAggregatedList](x: Self) {
    ...
    inline def setItems(
      value: /* import warning: importer.ImportType#apply Failed type conversion: {[ P in string ]: @maxim_mazurok/gapi.client.compute.gapi.client.compute.DiskTypesScopedList} */ js.Any
