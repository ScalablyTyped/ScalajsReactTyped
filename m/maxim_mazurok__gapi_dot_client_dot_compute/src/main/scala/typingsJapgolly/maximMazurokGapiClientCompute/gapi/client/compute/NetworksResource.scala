...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.AltCallbackFieldsKeyOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.Direction
import typingsJapgolly.maximMazurokGapiClientCompute.anon.FieldsKeyNetwork
import typingsJapgolly.maximMazurokGapiClientCompute.anon.KeyNetwork
import typingsJapgolly.maximMazurokGapiClientCompute.anon.KeyNetworkOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.MaxResults
import typingsJapgolly.maximMazurokGapiClientCompute.anon.NetworkOauthtoken
import typingsJapgolly.maximMazurokGapiClientCompute.anon.NetworkOauthtokenPrettyPrint
...
trait NetworksResource extends StObject {
  ...
  def addPeering(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.Network): Request[Operation] = js.native
