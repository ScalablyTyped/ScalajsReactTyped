...
object BackendServiceList {
  ...
  inline def apply(): BackendServiceList = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackendServiceList]
  }
  
  extension [Self <: BackendServiceList](x: Self) {
    
    inline def setId(value: String): Self = StObject.set(x, "id", value.asInstanceOf[js.Any])
    
    inline def setIdUndefined: Self = StObject.set(x, "id", js.undefined)
    
    inline def setItems(value: js.Array[BackendService]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: BackendService*): Self = StObject.set(x, "items", js.Array(value*))
