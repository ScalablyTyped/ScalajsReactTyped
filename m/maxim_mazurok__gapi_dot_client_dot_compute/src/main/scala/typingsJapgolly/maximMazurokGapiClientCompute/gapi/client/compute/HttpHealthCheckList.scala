...
object HttpHealthCheckList {
  ...
  inline def apply(): HttpHealthCheckList = {
  ...
  extension [Self <: HttpHealthCheckList](x: Self) {
    ...
    inline def setItems(value: js.Array[HttpHealthCheck]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
    
    inline def setItemsVarargs(value: HttpHealthCheck*): Self = StObject.set(x, "items", js.Array(value*))
