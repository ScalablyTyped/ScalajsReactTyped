...
import typingsJapgolly.maximMazurokGapiClientCompute.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientCompute.anon.KeyName
import typingsJapgolly.maximMazurokGapiClientCompute.anon.MaxResults
import typingsJapgolly.maximMazurokGapiClientCompute.anon.Resource
import typingsJapgolly.maximMazurokGapiClientCompute.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientCompute.anon.UserIp
...
trait BackendBucketsResource extends StObject {
  ...
  def addSignedUrlKey(request: typingsJapgolly.maximMazurokGapiClientCompute.anon.BackendBucket): Request[Operation] = js.native
