...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetPoolsAddHealthCheckRequest
...
trait TargetPool extends StObject {
  ...
  /** Request body */
  var resource: TargetPoolsAddHealthCheckRequest
...
object TargetPool {
  ...
  inline def apply(project: String, region: String, resource: TargetPoolsAddHealthCheckRequest, targetPool: String): TargetPool = {
  ...
  extension [Self <: TargetPool](x: Self) {
    ...
    inline def setResource(value: TargetPoolsAddHealthCheckRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
