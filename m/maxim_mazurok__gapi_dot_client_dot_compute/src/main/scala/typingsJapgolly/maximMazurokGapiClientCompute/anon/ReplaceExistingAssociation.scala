...
trait ReplaceExistingAssociation extends StObject {
...
object ReplaceExistingAssociation {
  ...
  inline def apply(firewallPolicy: String): ReplaceExistingAssociation = {
    val __obj = js.Dynamic.literal(firewallPolicy = firewallPolicy.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReplaceExistingAssociation]
  }
  
  extension [Self <: ReplaceExistingAssociation](x: Self) {
