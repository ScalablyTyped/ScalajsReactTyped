...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.DeprecationStatus
...
trait FieldsImage extends StObject {
  ...
  /** Request body */
  var resource: DeprecationStatus
...
object FieldsImage {
  ...
  inline def apply(image: String, project: String, resource: DeprecationStatus): FieldsImage = {
  ...
  extension [Self <: FieldsImage](x: Self) {
    ...
    inline def setResource(value: DeprecationStatus): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
