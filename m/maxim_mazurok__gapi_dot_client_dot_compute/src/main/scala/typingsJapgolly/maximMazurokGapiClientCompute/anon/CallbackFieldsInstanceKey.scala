...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetMachineTypeRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CallbackFieldsInstanceKey extends StObject {
...
object CallbackFieldsInstanceKey {
  
  inline def apply(instance: String, project: String, resource: InstancesSetMachineTypeRequest, zone: String): CallbackFieldsInstanceKey = {
    ...
    __obj.asInstanceOf[CallbackFieldsInstanceKey]
  }
  
  extension [Self <: CallbackFieldsInstanceKey](x: Self) {
