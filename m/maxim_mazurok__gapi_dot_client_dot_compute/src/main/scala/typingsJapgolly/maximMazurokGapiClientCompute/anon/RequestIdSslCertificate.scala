...
trait RequestIdSslCertificate extends StObject {
...
object RequestIdSslCertificate {
  
  inline def apply(project: String, sslCertificate: String): RequestIdSslCertificate = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], sslCertificate = sslCertificate.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdSslCertificate]
  }
  
  extension [Self <: RequestIdSslCertificate](x: Self) {
