...
trait FieldsForwardingRule extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule
...
object FieldsForwardingRule {
  ...
  inline def apply(
    ...
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule
  ): FieldsForwardingRule = {
    val __obj = js.Dynamic.literal(forwardingRule = forwardingRule.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsForwardingRule]
  }
  
  extension [Self <: FieldsForwardingRule](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ForwardingRule): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
