...
trait PublicAdvertisedPrefixQuotaUser extends StObject {
  ...
  var publicAdvertisedPrefix: String
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PublicAdvertisedPrefix
...
object PublicAdvertisedPrefixQuotaUser {
  
  inline def apply(
    project: String,
    publicAdvertisedPrefix: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PublicAdvertisedPrefix
  ): PublicAdvertisedPrefixQuotaUser = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], publicAdvertisedPrefix = publicAdvertisedPrefix.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  extension [Self <: PublicAdvertisedPrefixQuotaUser](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PublicAdvertisedPrefix): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
