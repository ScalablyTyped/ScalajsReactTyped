...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetServiceAccountRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait OauthtokenPrettyPrintProjectQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: InstancesSetServiceAccountRequest
...
object OauthtokenPrettyPrintProjectQuotaUser {
  
  inline def apply(instance: String, project: String, resource: InstancesSetServiceAccountRequest, zone: String): OauthtokenPrettyPrintProjectQuotaUser = {
    ...
    __obj.asInstanceOf[OauthtokenPrettyPrintProjectQuotaUser]
  }
  
  extension [Self <: OauthtokenPrettyPrintProjectQuotaUser](x: Self) {
    ...
    inline def setResource(value: InstancesSetServiceAccountRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
