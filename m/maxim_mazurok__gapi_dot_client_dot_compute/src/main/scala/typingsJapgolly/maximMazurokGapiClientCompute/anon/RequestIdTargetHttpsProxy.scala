...
trait RequestIdTargetHttpsProxy extends StObject {
...
object RequestIdTargetHttpsProxy {
  
  inline def apply(project: String, targetHttpsProxy: String): RequestIdTargetHttpsProxy = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], targetHttpsProxy = targetHttpsProxy.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdTargetHttpsProxy]
  }
  
  extension [Self <: RequestIdTargetHttpsProxy](x: Self) {
