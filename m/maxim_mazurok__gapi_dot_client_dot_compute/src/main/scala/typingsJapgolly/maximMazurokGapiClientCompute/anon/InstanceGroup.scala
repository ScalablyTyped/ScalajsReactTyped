...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupsAddInstancesRequest
...
trait InstanceGroup extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupsAddInstancesRequest
...
object InstanceGroup {
  ...
  inline def apply(instanceGroup: String, project: String, resource: InstanceGroupsAddInstancesRequest, zone: String): InstanceGroup = {
  ...
  extension [Self <: InstanceGroup](x: Self) {
    ...
    inline def setResource(value: InstanceGroupsAddInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
