...
trait RequestIdResourceUploadTypeUploadprotocolUserIpXgafv extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpProxy
...
object RequestIdResourceUploadTypeUploadprotocolUserIpXgafv {
  
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpProxy
  ): RequestIdResourceUploadTypeUploadprotocolUserIpXgafv = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdResourceUploadTypeUploadprotocolUserIpXgafv]
  }
  
  extension [Self <: RequestIdResourceUploadTypeUploadprotocolUserIpXgafv](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
