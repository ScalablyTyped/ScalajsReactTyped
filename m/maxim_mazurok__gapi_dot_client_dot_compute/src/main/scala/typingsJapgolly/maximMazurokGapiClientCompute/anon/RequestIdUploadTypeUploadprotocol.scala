...
trait RequestIdUploadTypeUploadprotocol extends StObject {
...
object RequestIdUploadTypeUploadprotocol {
  
  inline def apply(instanceGroup: String, project: String, region: String): RequestIdUploadTypeUploadprotocol = {
    ...
    __obj.asInstanceOf[RequestIdUploadTypeUploadprotocol]
  }
  
  extension [Self <: RequestIdUploadTypeUploadprotocol](x: Self) {
