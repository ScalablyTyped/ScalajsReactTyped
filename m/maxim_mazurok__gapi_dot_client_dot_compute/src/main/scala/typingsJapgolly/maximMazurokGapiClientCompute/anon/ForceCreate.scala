...
object ForceCreate {
  ...
  inline def apply(project: String, resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Image): ForceCreate = {
  ...
  extension [Self <: ForceCreate](x: Self) {
