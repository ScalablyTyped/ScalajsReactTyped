...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.RegionDisksResizeRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AltCallbackDiskFields extends StObject {
...
object AltCallbackDiskFields {
  
  inline def apply(disk: String, project: String, region: String, resource: RegionDisksResizeRequest): AltCallbackDiskFields = {
    ...
    __obj.asInstanceOf[AltCallbackDiskFields]
  }
  
  extension [Self <: AltCallbackDiskFields](x: Self) {
