...
trait KeyOauthtokenPrettyPrintProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ResourcePolicy
...
object KeyOauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ResourcePolicy
  ...
  extension [Self <: KeyOauthtokenPrettyPrintProjectQuotaUserRegion](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ResourcePolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
