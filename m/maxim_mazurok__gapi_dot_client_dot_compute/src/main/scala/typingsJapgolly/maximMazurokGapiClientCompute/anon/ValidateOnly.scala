...
trait ValidateOnly extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment
...
object ValidateOnly {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment
  ): ValidateOnly = {
  ...
  extension [Self <: ValidateOnly](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InterconnectAttachment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
