...
trait HttpHealthCheckKey extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HttpHealthCheck
...
object HttpHealthCheckKey {
  
  inline def apply(
    httpHealthCheck: String,
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HttpHealthCheck
  ): HttpHealthCheckKey = {
    val __obj = js.Dynamic.literal(httpHealthCheck = httpHealthCheck.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[HttpHealthCheckKey]
  }
  
  extension [Self <: HttpHealthCheckKey](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HttpHealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
