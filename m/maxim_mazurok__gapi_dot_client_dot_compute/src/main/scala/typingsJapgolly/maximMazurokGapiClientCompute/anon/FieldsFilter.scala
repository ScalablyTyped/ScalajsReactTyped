...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupsListInstancesRequest
...
trait FieldsFilter extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupsListInstancesRequest
...
object FieldsFilter {
  ...
  inline def apply(instanceGroup: String, project: String, resource: InstanceGroupsListInstancesRequest, zone: String): FieldsFilter = {
  ...
  extension [Self <: FieldsFilter](x: Self) {
    ...
    inline def setResource(value: InstanceGroupsListInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
