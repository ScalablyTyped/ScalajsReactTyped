...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersSetInstanceTemplateRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait UploadprotocolUserIpXgafv extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersSetInstanceTemplateRequest
...
object UploadprotocolUserIpXgafv {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[UploadprotocolUserIpXgafv]
  }
  
  extension [Self <: UploadprotocolUserIpXgafv](x: Self) {
    ...
    inline def setResource(value: InstanceGroupManagersSetInstanceTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
