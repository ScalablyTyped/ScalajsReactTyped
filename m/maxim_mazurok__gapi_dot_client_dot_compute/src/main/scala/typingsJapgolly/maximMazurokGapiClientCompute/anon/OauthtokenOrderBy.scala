...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupsListInstancesRequest
...
trait OauthtokenOrderBy extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupsListInstancesRequest
...
object OauthtokenOrderBy {
  ...
  extension [Self <: OauthtokenOrderBy](x: Self) {
    ...
    inline def setResource(value: RegionInstanceGroupsListInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
