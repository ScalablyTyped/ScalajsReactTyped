...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupsRemoveInstancesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CallbackFieldsInstanceGroup extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupsRemoveInstancesRequest
...
object CallbackFieldsInstanceGroup {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CallbackFieldsInstanceGroup]
  }
  
  extension [Self <: CallbackFieldsInstanceGroup](x: Self) {
    ...
    inline def setResource(value: InstanceGroupsRemoveInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
