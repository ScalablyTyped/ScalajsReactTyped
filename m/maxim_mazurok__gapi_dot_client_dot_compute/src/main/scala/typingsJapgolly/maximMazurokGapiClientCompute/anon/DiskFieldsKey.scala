...
trait DiskFieldsKey extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot
...
object DiskFieldsKey {
  ...
  inline def apply(
    ...
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot
  ): DiskFieldsKey = {
  ...
  extension [Self <: DiskFieldsKey](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Snapshot): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
