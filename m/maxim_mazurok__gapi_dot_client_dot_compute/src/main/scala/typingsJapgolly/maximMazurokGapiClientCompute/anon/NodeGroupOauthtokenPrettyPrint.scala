...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroupsSetNodeTemplateRequest
...
trait NodeGroupOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: NodeGroupsSetNodeTemplateRequest
...
object NodeGroupOauthtokenPrettyPrint {
  ...
  inline def apply(nodeGroup: String, project: String, resource: NodeGroupsSetNodeTemplateRequest, zone: String): NodeGroupOauthtokenPrettyPrint = {
  ...
  extension [Self <: NodeGroupOauthtokenPrettyPrint](x: Self) {
    ...
    inline def setResource(value: NodeGroupsSetNodeTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
