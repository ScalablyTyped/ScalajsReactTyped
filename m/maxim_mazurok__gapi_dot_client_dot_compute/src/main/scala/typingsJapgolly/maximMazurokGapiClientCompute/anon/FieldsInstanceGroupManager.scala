...
trait FieldsInstanceGroupManager extends StObject {
...
object FieldsInstanceGroupManager {
  
  inline def apply(instanceGroupManager: String, project: String, zone: String): FieldsInstanceGroupManager = {
    ...
    __obj.asInstanceOf[FieldsInstanceGroupManager]
  }
  
  extension [Self <: FieldsInstanceGroupManager](x: Self) {
