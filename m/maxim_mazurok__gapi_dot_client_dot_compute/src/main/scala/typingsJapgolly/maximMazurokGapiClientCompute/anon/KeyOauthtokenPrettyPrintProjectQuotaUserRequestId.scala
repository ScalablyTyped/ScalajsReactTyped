...
trait KeyOauthtokenPrettyPrintProjectQuotaUserRequestId extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Route
...
object KeyOauthtokenPrettyPrintProjectQuotaUserRequestId {
  ...
  inline def apply(project: String, resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Route): KeyOauthtokenPrettyPrintProjectQuotaUserRequestId = {
  ...
  extension [Self <: KeyOauthtokenPrettyPrintProjectQuotaUserRequestId](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Route): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
