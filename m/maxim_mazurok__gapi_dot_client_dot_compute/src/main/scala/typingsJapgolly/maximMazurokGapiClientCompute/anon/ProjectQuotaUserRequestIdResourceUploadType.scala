...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ProjectsSetDefaultNetworkTierRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ProjectQuotaUserRequestIdResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: ProjectsSetDefaultNetworkTierRequest
...
object ProjectQuotaUserRequestIdResourceUploadType {
  
  inline def apply(project: String, resource: ProjectsSetDefaultNetworkTierRequest): ProjectQuotaUserRequestIdResourceUploadType = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectQuotaUserRequestIdResourceUploadType]
  }
  
  extension [Self <: ProjectQuotaUserRequestIdResourceUploadType](x: Self) {
    ...
    inline def setResource(value: ProjectsSetDefaultNetworkTierRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
