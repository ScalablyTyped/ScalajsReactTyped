...
trait OauthtokenOptionsRequestedPolicyVersion extends StObject {
...
object OauthtokenOptionsRequestedPolicyVersion {
  
  inline def apply(resource: String): OauthtokenOptionsRequestedPolicyVersion = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[OauthtokenOptionsRequestedPolicyVersion]
  }
  
  extension [Self <: OauthtokenOptionsRequestedPolicyVersion](x: Self) {
