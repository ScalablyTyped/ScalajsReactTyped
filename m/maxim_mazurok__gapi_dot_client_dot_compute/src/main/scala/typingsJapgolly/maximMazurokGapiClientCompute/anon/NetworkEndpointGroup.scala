...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.GlobalNetworkEndpointGroupsAttachEndpointsRequest
...
trait NetworkEndpointGroup extends StObject {
  ...
  /** Request body */
  var resource: GlobalNetworkEndpointGroupsAttachEndpointsRequest
...
object NetworkEndpointGroup {
  ...
  extension [Self <: NetworkEndpointGroup](x: Self) {
    ...
    inline def setResource(value: GlobalNetworkEndpointGroupsAttachEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
