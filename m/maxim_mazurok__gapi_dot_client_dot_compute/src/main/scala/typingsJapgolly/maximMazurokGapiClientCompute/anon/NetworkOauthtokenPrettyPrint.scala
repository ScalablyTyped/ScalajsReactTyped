...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworksUpdatePeeringRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait NetworkOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: NetworksUpdatePeeringRequest
...
object NetworkOauthtokenPrettyPrint {
  
  inline def apply(network: String, project: String, resource: NetworksUpdatePeeringRequest): NetworkOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[NetworkOauthtokenPrettyPrint]
  }
  
  extension [Self <: NetworkOauthtokenPrettyPrint](x: Self) {
    ...
    inline def setResource(value: NetworksUpdatePeeringRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
