...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersCreateInstancesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CallbackFieldsInstanceGroupManager extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersCreateInstancesRequest
...
object CallbackFieldsInstanceGroupManager {
  ...
  inline def apply(
    ...
    zone: String
  ): CallbackFieldsInstanceGroupManager = {
  ...
  extension [Self <: CallbackFieldsInstanceGroupManager](x: Self) {
    ...
    inline def setResource(value: InstanceGroupManagersCreateInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
