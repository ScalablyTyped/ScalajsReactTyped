...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Scheduling
...
object KeyOauthtokenPrettyPrintProject {
  ...
  inline def apply(instance: String, project: String, resource: Scheduling, zone: String): KeyOauthtokenPrettyPrintProject = {
  ...
  extension [Self <: KeyOauthtokenPrettyPrintProject](x: Self) {
    ...
    inline def setResource(value: Scheduling): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
