...
trait RegionRequestIdResourceUploadTypeUploadprotocolUserIp extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.VpnGateway
...
object RegionRequestIdResourceUploadTypeUploadprotocolUserIp {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.VpnGateway
  ...
  extension [Self <: RegionRequestIdResourceUploadTypeUploadprotocolUserIp](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.VpnGateway): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
