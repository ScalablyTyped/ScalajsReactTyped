...
trait UploadTypeUploadprotocolUserIpXgafv extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect
...
object UploadTypeUploadprotocolUserIpXgafv {
  
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect
  ): UploadTypeUploadprotocolUserIpXgafv = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[UploadTypeUploadprotocolUserIpXgafv]
  }
  
  extension [Self <: UploadTypeUploadprotocolUserIpXgafv](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Interconnect): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
