...
trait CallbackDiskFields extends StObject {
...
object CallbackDiskFields {
  
  inline def apply(disk: String, project: String, region: String): CallbackDiskFields = {
    ...
    __obj.asInstanceOf[CallbackDiskFields]
  }
  
  extension [Self <: CallbackDiskFields](x: Self) {
