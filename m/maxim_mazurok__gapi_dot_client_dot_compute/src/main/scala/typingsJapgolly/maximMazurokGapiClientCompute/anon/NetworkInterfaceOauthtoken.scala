...
trait NetworkInterfaceOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface
...
object NetworkInterfaceOauthtoken {
  
  inline def apply(
    instance: String,
    networkInterface: String,
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface,
    zone: String
  ): NetworkInterfaceOauthtoken = {
  ...
  extension [Self <: NetworkInterfaceOauthtoken](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkInterface): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
