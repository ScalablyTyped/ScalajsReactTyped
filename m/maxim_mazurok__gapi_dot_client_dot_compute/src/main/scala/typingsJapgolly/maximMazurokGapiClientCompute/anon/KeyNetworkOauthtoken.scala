...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworksRemovePeeringRequest
...
trait KeyNetworkOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: NetworksRemovePeeringRequest
...
object KeyNetworkOauthtoken {
  ...
  inline def apply(network: String, project: String, resource: NetworksRemovePeeringRequest): KeyNetworkOauthtoken = {
  ...
  extension [Self <: KeyNetworkOauthtoken](x: Self) {
    ...
    inline def setResource(value: NetworksRemovePeeringRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
