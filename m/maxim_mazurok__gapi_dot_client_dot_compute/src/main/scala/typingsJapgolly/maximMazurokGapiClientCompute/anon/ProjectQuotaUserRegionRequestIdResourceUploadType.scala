...
trait ProjectQuotaUserRegionRequestIdResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetPool
...
object ProjectQuotaUserRegionRequestIdResourceUploadType {
  
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetPool
  ): ProjectQuotaUserRegionRequestIdResourceUploadType = {
    ...
    __obj.asInstanceOf[ProjectQuotaUserRegionRequestIdResourceUploadType]
  }
  
  extension [Self <: ProjectQuotaUserRegionRequestIdResourceUploadType](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetPool): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
