...
trait CallbackFieldsHealthCheck extends StObject {
...
object CallbackFieldsHealthCheck {
  
  inline def apply(healthCheck: String, project: String, region: String): CallbackFieldsHealthCheck = {
