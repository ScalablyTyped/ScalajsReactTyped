...
trait RegionTargetPool extends StObject {
...
object RegionTargetPool {
  
  inline def apply(project: String, region: String, targetPool: String): RegionTargetPool = {
    ...
    __obj.asInstanceOf[RegionTargetPool]
  }
  
  extension [Self <: RegionTargetPool](x: Self) {
