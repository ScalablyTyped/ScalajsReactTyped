...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpsProxiesSetQuicOverrideRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ResourceTargetHttpsProxyUploadType extends StObject {
  ...
  /** Request body */
  var resource: TargetHttpsProxiesSetQuicOverrideRequest
...
object ResourceTargetHttpsProxyUploadType {
  
  inline def apply(project: String, resource: TargetHttpsProxiesSetQuicOverrideRequest, targetHttpsProxy: String): ResourceTargetHttpsProxyUploadType = {
    ...
    __obj.asInstanceOf[ResourceTargetHttpsProxyUploadType]
  }
  
  extension [Self <: ResourceTargetHttpsProxyUploadType](x: Self) {
    ...
    inline def setResource(value: TargetHttpsProxiesSetQuicOverrideRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
