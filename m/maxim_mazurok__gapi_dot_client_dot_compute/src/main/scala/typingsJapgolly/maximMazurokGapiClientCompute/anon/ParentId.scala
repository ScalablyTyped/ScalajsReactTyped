...
trait ParentId extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicy
...
object ParentId {
  ...
  inline def apply(resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicy): ParentId = {
  ...
  extension [Self <: ParentId](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
