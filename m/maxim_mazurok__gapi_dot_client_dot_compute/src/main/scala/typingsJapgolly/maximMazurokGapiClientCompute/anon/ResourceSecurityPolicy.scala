...
trait ResourceSecurityPolicy extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicy
...
object ResourceSecurityPolicy {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicy,
  ...
  extension [Self <: ResourceSecurityPolicy](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SecurityPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
