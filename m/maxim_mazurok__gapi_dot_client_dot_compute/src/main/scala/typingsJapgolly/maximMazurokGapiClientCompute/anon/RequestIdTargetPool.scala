...
trait RequestIdTargetPool extends StObject {
...
object RequestIdTargetPool {
  
  inline def apply(project: String, region: String, targetPool: String): RequestIdTargetPool = {
    ...
    __obj.asInstanceOf[RequestIdTargetPool]
  }
  
  extension [Self <: RequestIdTargetPool](x: Self) {
