...
trait ParentIdPrettyPrint extends StObject {
...
object ParentIdPrettyPrint {
  
  inline def apply(firewallPolicy: String): ParentIdPrettyPrint = {
    val __obj = js.Dynamic.literal(firewallPolicy = firewallPolicy.asInstanceOf[js.Any])
    __obj.asInstanceOf[ParentIdPrettyPrint]
  }
  
  extension [Self <: ParentIdPrettyPrint](x: Self) {
