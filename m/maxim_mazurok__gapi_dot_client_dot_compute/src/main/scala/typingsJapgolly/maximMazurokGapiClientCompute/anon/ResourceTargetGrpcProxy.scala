...
trait ResourceTargetGrpcProxy extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetGrpcProxy
...
object ResourceTargetGrpcProxy {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetGrpcProxy,
  ...
  extension [Self <: ResourceTargetGrpcProxy](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetGrpcProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
