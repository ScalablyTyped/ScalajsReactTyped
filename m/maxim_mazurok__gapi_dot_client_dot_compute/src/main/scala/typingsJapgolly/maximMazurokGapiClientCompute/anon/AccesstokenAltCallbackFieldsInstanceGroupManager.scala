...
trait AccesstokenAltCallbackFieldsInstanceGroupManager extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager
...
object AccesstokenAltCallbackFieldsInstanceGroupManager {
  
  inline def apply(
    instanceGroupManager: String,
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager
  ): AccesstokenAltCallbackFieldsInstanceGroupManager = {
    ...
    __obj.asInstanceOf[AccesstokenAltCallbackFieldsInstanceGroupManager]
  }
  
  extension [Self <: AccesstokenAltCallbackFieldsInstanceGroupManager](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManager): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
