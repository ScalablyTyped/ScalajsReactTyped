...
trait HealthCheckKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck
...
object HealthCheckKeyOauthtoken {
  
  inline def apply(
    healthCheck: String,
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck
  ): HealthCheckKeyOauthtoken = {
    val __obj = js.Dynamic.literal(healthCheck = healthCheck.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[HealthCheckKeyOauthtoken]
  }
  
  extension [Self <: HealthCheckKeyOauthtoken](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
