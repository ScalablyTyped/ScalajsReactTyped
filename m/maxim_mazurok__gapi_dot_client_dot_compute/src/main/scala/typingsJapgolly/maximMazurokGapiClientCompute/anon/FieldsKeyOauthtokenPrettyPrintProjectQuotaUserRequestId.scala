...
trait FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap
...
object FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId {
  
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap
  ): FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId]
  }
  
  extension [Self <: FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRequestId](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.UrlMap): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
