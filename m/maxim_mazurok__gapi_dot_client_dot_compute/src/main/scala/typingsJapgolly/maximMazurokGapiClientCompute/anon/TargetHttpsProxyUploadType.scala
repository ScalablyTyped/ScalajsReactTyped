...
trait TargetHttpsProxyUploadType extends StObject {
...
object TargetHttpsProxyUploadType {
  
  inline def apply(project: String, region: String, resource: UrlMapReference, targetHttpsProxy: String): TargetHttpsProxyUploadType = {
    ...
    __obj.asInstanceOf[TargetHttpsProxyUploadType]
  }
  
  extension [Self <: TargetHttpsProxyUploadType](x: Self) {
