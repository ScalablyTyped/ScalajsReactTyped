...
trait AltCallbackFieldsKeyOauthtokenPrettyPrint extends StObject {
...
object AltCallbackFieldsKeyOauthtokenPrettyPrint {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[AltCallbackFieldsKeyOauthtokenPrettyPrint]
  }
  
  extension [Self <: AltCallbackFieldsKeyOauthtokenPrettyPrint](x: Self) {
