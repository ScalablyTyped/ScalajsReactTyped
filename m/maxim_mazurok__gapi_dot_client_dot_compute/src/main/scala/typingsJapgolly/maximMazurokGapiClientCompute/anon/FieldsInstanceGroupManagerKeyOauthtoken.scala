...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersDeleteInstancesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait FieldsInstanceGroupManagerKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersDeleteInstancesRequest
...
object FieldsInstanceGroupManagerKeyOauthtoken {
  ...
  inline def apply(
  ...
  ): FieldsInstanceGroupManagerKeyOauthtoken = {
    ...
    __obj.asInstanceOf[FieldsInstanceGroupManagerKeyOauthtoken]
  }
  
  extension [Self <: FieldsInstanceGroupManagerKeyOauthtoken](x: Self) {
    ...
    inline def setResource(value: RegionInstanceGroupManagersDeleteInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
