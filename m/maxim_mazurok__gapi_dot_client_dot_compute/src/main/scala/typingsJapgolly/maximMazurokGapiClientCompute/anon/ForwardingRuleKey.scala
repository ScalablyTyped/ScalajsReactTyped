...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetReference
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ForwardingRuleKey extends StObject {
...
object ForwardingRuleKey {
  
  inline def apply(forwardingRule: String, project: String, region: String, resource: TargetReference): ForwardingRuleKey = {
    ...
    __obj.asInstanceOf[ForwardingRuleKey]
  }
  
  extension [Self <: ForwardingRuleKey](x: Self) {
