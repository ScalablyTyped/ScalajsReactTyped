...
trait AccesstokenAltCallbackFieldsKey extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.License
...
object AccesstokenAltCallbackFieldsKey {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.License
  ): AccesstokenAltCallbackFieldsKey = {
  ...
  extension [Self <: AccesstokenAltCallbackFieldsKey](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.License): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
