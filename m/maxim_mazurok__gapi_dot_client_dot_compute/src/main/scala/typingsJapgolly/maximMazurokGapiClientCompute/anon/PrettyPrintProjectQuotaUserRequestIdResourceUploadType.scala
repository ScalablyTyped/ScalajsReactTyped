...
trait PrettyPrintProjectQuotaUserRequestIdResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SslCertificate
...
object PrettyPrintProjectQuotaUserRequestIdResourceUploadType {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SslCertificate
  ...
  extension [Self <: PrettyPrintProjectQuotaUserRequestIdResourceUploadType](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SslCertificate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
