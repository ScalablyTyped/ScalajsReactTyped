...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.DiskMoveRequest
...
object KeyOauthtokenPrettyPrintProjectQuotaUser {
  ...
  inline def apply(project: String, resource: DiskMoveRequest): KeyOauthtokenPrettyPrintProjectQuotaUser = {
  ...
  extension [Self <: KeyOauthtokenPrettyPrintProjectQuotaUser](x: Self) {
