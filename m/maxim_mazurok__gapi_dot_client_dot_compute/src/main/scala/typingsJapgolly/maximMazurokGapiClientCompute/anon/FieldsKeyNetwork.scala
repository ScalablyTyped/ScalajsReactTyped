...
trait FieldsKeyNetwork extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Network
...
object FieldsKeyNetwork {
  ...
  inline def apply(
    network: String,
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Network
  ): FieldsKeyNetwork = {
  ...
  extension [Self <: FieldsKeyNetwork](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Network): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
