...
trait MinimalAction extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Instance
...
object MinimalAction {
  
  inline def apply(
    instance: String,
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Instance,
    zone: String
  ): MinimalAction = {
  ...
  extension [Self <: MinimalAction](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Instance): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
