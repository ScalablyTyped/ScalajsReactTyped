...
trait ResourceUploadTypeUploadprotocolUserIpXgafv extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint
...
object ResourceUploadTypeUploadprotocolUserIpXgafv {
  
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint
  ): ResourceUploadTypeUploadprotocolUserIpXgafv = {
    ...
    __obj.asInstanceOf[ResourceUploadTypeUploadprotocolUserIpXgafv]
  }
  
  extension [Self <: ResourceUploadTypeUploadprotocolUserIpXgafv](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NotificationEndpoint): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
