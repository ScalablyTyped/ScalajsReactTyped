...
trait QuotaUserRequestIdUploadType extends StObject {
...
object QuotaUserRequestIdUploadType {
  
  inline def apply(project: String, urlMap: String): QuotaUserRequestIdUploadType = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], urlMap = urlMap.asInstanceOf[js.Any])
    __obj.asInstanceOf[QuotaUserRequestIdUploadType]
  }
  
  extension [Self <: QuotaUserRequestIdUploadType](x: Self) {
