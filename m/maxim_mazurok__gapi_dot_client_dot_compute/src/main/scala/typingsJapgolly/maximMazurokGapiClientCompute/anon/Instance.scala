...
trait Instance extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.AccessConfig
...
object Instance {
  ...
  inline def apply(
    ...
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.AccessConfig,
    zone: String
  ): Instance = {
  ...
  extension [Self <: Instance](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.AccessConfig): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
