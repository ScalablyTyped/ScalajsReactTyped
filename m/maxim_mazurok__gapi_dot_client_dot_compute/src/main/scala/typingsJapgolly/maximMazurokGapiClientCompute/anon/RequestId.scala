...
trait RequestId extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler
...
object RequestId {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler,
    zone: String
  ): RequestId = {
  ...
  extension [Self <: RequestId](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Autoscaler): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
