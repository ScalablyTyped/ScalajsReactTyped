...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupsSetNamedPortsRequest
...
trait FieldsInstanceGroupKey extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupsSetNamedPortsRequest
...
object FieldsInstanceGroupKey {
  ...
  inline def apply(instanceGroup: String, project: String, resource: InstanceGroupsSetNamedPortsRequest, zone: String): FieldsInstanceGroupKey = {
  ...
  extension [Self <: FieldsInstanceGroupKey](x: Self) {
    ...
    inline def setResource(value: InstanceGroupsSetNamedPortsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
