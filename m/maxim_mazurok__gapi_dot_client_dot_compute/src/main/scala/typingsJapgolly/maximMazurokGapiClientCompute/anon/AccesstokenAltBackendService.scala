...
trait AccesstokenAltBackendService extends StObject {
...
object AccesstokenAltBackendService {
  
  inline def apply(backendService: String, project: String, region: String): AccesstokenAltBackendService = {
    ...
    __obj.asInstanceOf[AccesstokenAltBackendService]
  }
  
  extension [Self <: AccesstokenAltBackendService](x: Self) {
