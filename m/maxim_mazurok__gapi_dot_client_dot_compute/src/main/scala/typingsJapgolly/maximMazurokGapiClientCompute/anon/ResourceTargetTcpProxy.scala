...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxiesSetBackendServiceRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ResourceTargetTcpProxy extends StObject {
  ...
  /** Request body */
  var resource: TargetTcpProxiesSetBackendServiceRequest
...
object ResourceTargetTcpProxy {
  
  inline def apply(project: String, resource: TargetTcpProxiesSetBackendServiceRequest, targetTcpProxy: String): ResourceTargetTcpProxy = {
  ...
  extension [Self <: ResourceTargetTcpProxy](x: Self) {
    ...
    inline def setResource(value: TargetTcpProxiesSetBackendServiceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
