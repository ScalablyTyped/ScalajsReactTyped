...
trait RegionRequestIdResourceUploadType extends StObject {
...
object RegionRequestIdResourceUploadType {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[RegionRequestIdResourceUploadType]
  }
  
  extension [Self <: RegionRequestIdResourceUploadType](x: Self) {
