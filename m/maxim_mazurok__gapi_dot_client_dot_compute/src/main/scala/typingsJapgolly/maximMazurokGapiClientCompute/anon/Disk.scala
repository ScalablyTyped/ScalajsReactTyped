...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.DisksAddResourcePoliciesRequest
...
trait Disk extends StObject {
  ...
  /** Request body */
  var resource: DisksAddResourcePoliciesRequest
...
object Disk {
  ...
  inline def apply(disk: String, project: String, resource: DisksAddResourcePoliciesRequest, zone: String): Disk = {
  ...
  extension [Self <: Disk](x: Self) {
    ...
    inline def setResource(value: DisksAddResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
