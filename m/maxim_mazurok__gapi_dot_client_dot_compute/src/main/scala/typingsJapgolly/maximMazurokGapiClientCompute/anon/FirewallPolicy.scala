...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicyAssociation
...
object FirewallPolicy {
  ...
  inline def apply(firewallPolicy: String, resource: FirewallPolicyAssociation): FirewallPolicy = {
  ...
  extension [Self <: FirewallPolicy](x: Self) {
    ...
    inline def setResource(value: FirewallPolicyAssociation): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
