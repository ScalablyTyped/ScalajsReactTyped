...
trait BackendServiceCallback extends StObject {
...
object BackendServiceCallback {
  
  inline def apply(backendService: String, keyName: String, project: String): BackendServiceCallback = {
    val __obj = js.Dynamic.literal(backendService = backendService.asInstanceOf[js.Any], keyName = keyName.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[BackendServiceCallback]
  }
  
  extension [Self <: BackendServiceCallback](x: Self) {
