...
trait RequestIdResourceUploadTypeUploadprotocolUserIp extends StObject {
...
object RequestIdResourceUploadTypeUploadprotocolUserIp {
  
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PublicAdvertisedPrefix
  ): RequestIdResourceUploadTypeUploadprotocolUserIp = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdResourceUploadTypeUploadprotocolUserIp]
  }
  
  extension [Self <: RequestIdResourceUploadTypeUploadprotocolUserIp](x: Self) {
