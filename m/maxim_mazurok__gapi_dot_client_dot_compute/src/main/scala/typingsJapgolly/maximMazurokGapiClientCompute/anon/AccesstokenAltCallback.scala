...
trait AccesstokenAltCallback extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Firewall
...
object AccesstokenAltCallback {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Firewall
  ): AccesstokenAltCallback = {
  ...
  extension [Self <: AccesstokenAltCallback](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Firewall): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
