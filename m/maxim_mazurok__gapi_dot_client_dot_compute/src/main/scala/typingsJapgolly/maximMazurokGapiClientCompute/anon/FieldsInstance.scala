...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstancesAddResourcePoliciesRequest
...
trait FieldsInstance extends StObject {
  ...
  /** Request body */
  var resource: InstancesAddResourcePoliciesRequest
...
object FieldsInstance {
  ...
  inline def apply(instance: String, project: String, resource: InstancesAddResourcePoliciesRequest, zone: String): FieldsInstance = {
  ...
  extension [Self <: FieldsInstance](x: Self) {
    ...
    inline def setResource(value: InstancesAddResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
