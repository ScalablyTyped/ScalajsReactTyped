...
trait AltCallbackFieldsKeyOauthtokenPrettyPrintProject extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy
...
object AltCallbackFieldsKeyOauthtokenPrettyPrintProject {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy
  ...
  extension [Self <: AltCallbackFieldsKeyOauthtokenPrettyPrintProject](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
