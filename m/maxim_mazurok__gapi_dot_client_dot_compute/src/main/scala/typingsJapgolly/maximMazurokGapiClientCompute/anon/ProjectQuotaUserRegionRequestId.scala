...
trait ProjectQuotaUserRegionRequestId extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.BackendService
...
object ProjectQuotaUserRegionRequestId {
  
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.BackendService
  ): ProjectQuotaUserRegionRequestId = {
    ...
    __obj.asInstanceOf[ProjectQuotaUserRegionRequestId]
  }
  
  extension [Self <: ProjectQuotaUserRegionRequestId](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.BackendService): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
