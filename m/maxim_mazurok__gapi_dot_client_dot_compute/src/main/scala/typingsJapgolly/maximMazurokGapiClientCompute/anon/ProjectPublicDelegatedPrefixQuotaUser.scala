...
trait ProjectPublicDelegatedPrefixQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PublicDelegatedPrefix
...
object ProjectPublicDelegatedPrefixQuotaUser {
  
  inline def apply(
    project: String,
    publicDelegatedPrefix: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PublicDelegatedPrefix
  ): ProjectPublicDelegatedPrefixQuotaUser = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], publicDelegatedPrefix = publicDelegatedPrefix.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectPublicDelegatedPrefixQuotaUser]
  }
  
  extension [Self <: ProjectPublicDelegatedPrefixQuotaUser](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PublicDelegatedPrefix): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
