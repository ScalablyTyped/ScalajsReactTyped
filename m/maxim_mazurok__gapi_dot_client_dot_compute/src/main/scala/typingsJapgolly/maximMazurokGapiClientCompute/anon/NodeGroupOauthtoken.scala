...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroupsDeleteNodesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait NodeGroupOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: NodeGroupsDeleteNodesRequest
...
object NodeGroupOauthtoken {
  
  inline def apply(nodeGroup: String, project: String, resource: NodeGroupsDeleteNodesRequest, zone: String): NodeGroupOauthtoken = {
    ...
    __obj.asInstanceOf[NodeGroupOauthtoken]
  }
  
  extension [Self <: NodeGroupOauthtoken](x: Self) {
    ...
    inline def setResource(value: NodeGroupsDeleteNodesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
