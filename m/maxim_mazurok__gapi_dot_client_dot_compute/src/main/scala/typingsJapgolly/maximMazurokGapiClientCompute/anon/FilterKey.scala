...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroupsListEndpointsRequest
...
trait FilterKey extends StObject {
  ...
  /** Request body */
  var resource: NetworkEndpointGroupsListEndpointsRequest
...
object FilterKey {
  ...
  extension [Self <: FilterKey](x: Self) {
    ...
    inline def setResource(value: NetworkEndpointGroupsListEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
