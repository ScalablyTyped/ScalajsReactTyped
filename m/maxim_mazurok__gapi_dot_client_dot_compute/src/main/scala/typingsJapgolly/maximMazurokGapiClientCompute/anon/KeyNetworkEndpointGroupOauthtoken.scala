...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroupsAttachEndpointsRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait KeyNetworkEndpointGroupOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: NetworkEndpointGroupsAttachEndpointsRequest
...
object KeyNetworkEndpointGroupOauthtoken {
  ...
  inline def apply(
    ...
    zone: String
  ): KeyNetworkEndpointGroupOauthtoken = {
  ...
  extension [Self <: KeyNetworkEndpointGroupOauthtoken](x: Self) {
    ...
    inline def setResource(value: NetworkEndpointGroupsAttachEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
