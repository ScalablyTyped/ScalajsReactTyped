...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ProjectsListXpnHostsRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait MaxResultsOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: ProjectsListXpnHostsRequest
...
object MaxResultsOauthtoken {
  ...
  inline def apply(project: String, resource: ProjectsListXpnHostsRequest): MaxResultsOauthtoken = {
  ...
  extension [Self <: MaxResultsOauthtoken](x: Self) {
    ...
    inline def setResource(value: ProjectsListXpnHostsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
