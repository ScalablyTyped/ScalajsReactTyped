...
trait CallbackFieldsKeyOauthtokenPrettyPrintProjectQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy
...
object CallbackFieldsKeyOauthtokenPrettyPrintProjectQuotaUser {
  
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy
  ): CallbackFieldsKeyOauthtokenPrettyPrintProjectQuotaUser = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackFieldsKeyOauthtokenPrettyPrintProjectQuotaUser]
  }
  
  extension [Self <: CallbackFieldsKeyOauthtokenPrettyPrintProjectQuotaUser](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetTcpProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
