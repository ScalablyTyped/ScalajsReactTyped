...
trait ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SslPolicy
...
object ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol {
  
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SslPolicy
  ): ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol]
  }
  
  extension [Self <: ProjectQuotaUserRequestIdResourceUploadTypeUploadprotocol](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SslPolicy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
