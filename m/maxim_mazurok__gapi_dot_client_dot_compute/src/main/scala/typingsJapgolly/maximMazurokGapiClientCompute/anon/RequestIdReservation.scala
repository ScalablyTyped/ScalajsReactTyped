...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ReservationsResizeRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait RequestIdReservation extends StObject {
  ...
  /** Request body */
  var resource: ReservationsResizeRequest
...
object RequestIdReservation {
  
  inline def apply(project: String, reservation: String, resource: ReservationsResizeRequest, zone: String): RequestIdReservation = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], reservation = reservation.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdReservation]
  }
  
  extension [Self <: RequestIdReservation](x: Self) {
    ...
    inline def setResource(value: ReservationsResizeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
