...
trait ProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate
...
object ProjectQuotaUserRegion {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate
  ...
  extension [Self <: ProjectQuotaUserRegion](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeTemplate): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
