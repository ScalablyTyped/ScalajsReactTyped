...
trait AccesstokenAltBackendServiceCallback extends StObject {
...
object AccesstokenAltBackendServiceCallback {
  ...
  inline def apply(
  ...
  ): AccesstokenAltBackendServiceCallback = {
    ...
    __obj.asInstanceOf[AccesstokenAltBackendServiceCallback]
  }
  
  extension [Self <: AccesstokenAltBackendServiceCallback](x: Self) {
