...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.SubnetworksExpandIpCidrRangeRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ResourceSubnetwork extends StObject {
  ...
  /** Request body */
  var resource: SubnetworksExpandIpCidrRangeRequest
...
object ResourceSubnetwork {
  
  inline def apply(project: String, region: String, resource: SubnetworksExpandIpCidrRangeRequest, subnetwork: String): ResourceSubnetwork = {
    ...
    __obj.asInstanceOf[ResourceSubnetwork]
  }
  
  extension [Self <: ResourceSubnetwork](x: Self) {
    ...
    inline def setResource(value: SubnetworksExpandIpCidrRangeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
