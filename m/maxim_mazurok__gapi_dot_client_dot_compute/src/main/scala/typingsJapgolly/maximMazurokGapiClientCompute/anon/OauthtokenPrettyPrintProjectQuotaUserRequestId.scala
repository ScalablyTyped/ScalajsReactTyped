...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceMoveRequest
...
trait OauthtokenPrettyPrintProjectQuotaUserRequestId extends StObject {
  ...
  /** Request body */
  var resource: InstanceMoveRequest
...
object OauthtokenPrettyPrintProjectQuotaUserRequestId {
  ...
  inline def apply(project: String, resource: InstanceMoveRequest): OauthtokenPrettyPrintProjectQuotaUserRequestId = {
  ...
  extension [Self <: OauthtokenPrettyPrintProjectQuotaUserRequestId](x: Self) {
    ...
    inline def setResource(value: InstanceMoveRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
