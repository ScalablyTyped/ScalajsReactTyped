...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ProjectsDisableXpnResourceRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CallbackFieldsKeyOauthtokenPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: ProjectsDisableXpnResourceRequest
...
object CallbackFieldsKeyOauthtokenPrettyPrint {
  
  inline def apply(project: String, resource: ProjectsDisableXpnResourceRequest): CallbackFieldsKeyOauthtokenPrettyPrint = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackFieldsKeyOauthtokenPrettyPrint]
  }
  
  extension [Self <: CallbackFieldsKeyOauthtokenPrettyPrint](x: Self) {
    ...
    inline def setResource(value: ProjectsDisableXpnResourceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
