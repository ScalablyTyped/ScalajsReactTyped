...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.DisksResizeRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait QuotaUserRequestId extends StObject {
  ...
  /** Request body */
  var resource: DisksResizeRequest
...
object QuotaUserRequestId {
  
  inline def apply(disk: String, project: String, resource: DisksResizeRequest, zone: String): QuotaUserRequestId = {
    ...
    __obj.asInstanceOf[QuotaUserRequestId]
  }
  
  extension [Self <: QuotaUserRequestId](x: Self) {
    ...
    inline def setResource(value: DisksResizeRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
