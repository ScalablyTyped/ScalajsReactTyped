...
trait AltCallbackFields extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Address
...
object AltCallbackFields {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Address
  ): AltCallbackFields = {
  ...
  extension [Self <: AltCallbackFields](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Address): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
