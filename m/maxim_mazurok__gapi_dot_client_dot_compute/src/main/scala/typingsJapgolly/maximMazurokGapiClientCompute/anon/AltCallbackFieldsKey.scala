...
trait AltCallbackFieldsKey extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroup
...
object AltCallbackFieldsKey {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroup,
    zone: String
  ...
  extension [Self <: AltCallbackFieldsKey](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
