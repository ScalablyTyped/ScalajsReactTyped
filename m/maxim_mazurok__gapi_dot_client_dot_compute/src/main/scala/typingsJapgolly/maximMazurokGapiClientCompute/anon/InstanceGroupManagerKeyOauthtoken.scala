...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersDeletePerInstanceConfigsReq
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait InstanceGroupManagerKeyOauthtoken extends StObject {
...
object InstanceGroupManagerKeyOauthtoken {
  ...
  inline def apply(
    ...
    zone: String
  ): InstanceGroupManagerKeyOauthtoken = {
    ...
    __obj.asInstanceOf[InstanceGroupManagerKeyOauthtoken]
  }
  
  extension [Self <: InstanceGroupManagerKeyOauthtoken](x: Self) {
