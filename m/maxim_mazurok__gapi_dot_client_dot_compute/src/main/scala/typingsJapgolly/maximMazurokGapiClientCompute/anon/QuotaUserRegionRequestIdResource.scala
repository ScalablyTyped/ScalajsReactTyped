...
trait QuotaUserRegionRequestIdResource extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Commitment
...
object QuotaUserRegionRequestIdResource {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Commitment
  ...
  extension [Self <: QuotaUserRegionRequestIdResource](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Commitment): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
