...
trait HttpsHealthCheckKey extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HttpsHealthCheck
...
object HttpsHealthCheckKey {
  ...
  inline def apply(
    ...
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HttpsHealthCheck
  ): HttpsHealthCheckKey = {
  ...
  extension [Self <: HttpsHealthCheckKey](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HttpsHealthCheck): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
