...
trait ResourceSslPolicy extends StObject {
...
object ResourceSslPolicy {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], sslPolicy = sslPolicy.asInstanceOf[js.Any])
