...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstancesSetLabelsRequest
...
trait InstanceKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: InstancesSetLabelsRequest
...
object InstanceKeyOauthtoken {
  ...
  inline def apply(instance: String, project: String, resource: InstancesSetLabelsRequest, zone: String): InstanceKeyOauthtoken = {
  ...
  extension [Self <: InstanceKeyOauthtoken](x: Self) {
    ...
    inline def setResource(value: InstancesSetLabelsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
