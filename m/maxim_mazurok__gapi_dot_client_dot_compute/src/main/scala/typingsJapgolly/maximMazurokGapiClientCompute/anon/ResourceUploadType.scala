...
trait ResourceUploadType extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway
...
object ResourceUploadType {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway
  ): ResourceUploadType = {
  ...
  extension [Self <: ResourceUploadType](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.ExternalVpnGateway): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
