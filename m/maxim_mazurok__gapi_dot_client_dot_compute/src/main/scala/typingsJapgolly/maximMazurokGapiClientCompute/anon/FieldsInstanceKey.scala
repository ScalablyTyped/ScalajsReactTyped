...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstancesRemoveResourcePoliciesRequest
...
trait FieldsInstanceKey extends StObject {
  ...
  /** Request body */
  var resource: InstancesRemoveResourcePoliciesRequest
...
object FieldsInstanceKey {
  ...
  inline def apply(instance: String, project: String, resource: InstancesRemoveResourcePoliciesRequest, zone: String): FieldsInstanceKey = {
  ...
  extension [Self <: FieldsInstanceKey](x: Self) {
    ...
    inline def setResource(value: InstancesRemoveResourcePoliciesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
