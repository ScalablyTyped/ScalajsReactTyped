...
trait QuotaUserRegionRequestIdResourceUploadTypeUploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetVpnGateway
...
object QuotaUserRegionRequestIdResourceUploadTypeUploadprotocol {
  
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetVpnGateway
  ): QuotaUserRegionRequestIdResourceUploadTypeUploadprotocol = {
    ...
    __obj.asInstanceOf[QuotaUserRegionRequestIdResourceUploadTypeUploadprotocol]
  }
  
  extension [Self <: QuotaUserRegionRequestIdResourceUploadTypeUploadprotocol](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetVpnGateway): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
