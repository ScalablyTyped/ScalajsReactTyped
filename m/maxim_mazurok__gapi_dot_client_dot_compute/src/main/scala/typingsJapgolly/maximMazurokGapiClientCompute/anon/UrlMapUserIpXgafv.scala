...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.CacheInvalidationRule
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait UrlMapUserIpXgafv extends StObject {
  ...
  /** Request body */
  var resource: CacheInvalidationRule
...
object UrlMapUserIpXgafv {
  
  inline def apply(project: String, resource: CacheInvalidationRule, urlMap: String): UrlMapUserIpXgafv = {
