...
trait AltBackendService extends StObject {
...
object AltBackendService {
  
  inline def apply(backendService: String, project: String): AltBackendService = {
    val __obj = js.Dynamic.literal(backendService = backendService.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[AltBackendService]
  }
  
  extension [Self <: AltBackendService](x: Self) {
