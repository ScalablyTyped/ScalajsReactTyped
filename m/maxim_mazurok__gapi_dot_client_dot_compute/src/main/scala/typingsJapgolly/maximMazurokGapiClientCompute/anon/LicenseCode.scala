...
object LicenseCode {
  ...
  inline def apply(licenseCode: String, project: String): LicenseCode = {
    val __obj = js.Dynamic.literal(licenseCode = licenseCode.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
