...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Tags
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ProjectQuotaUserRequestIdResource extends StObject {
...
object ProjectQuotaUserRequestIdResource {
  
  inline def apply(instance: String, project: String, resource: Tags, zone: String): ProjectQuotaUserRequestIdResource = {
    ...
    __obj.asInstanceOf[ProjectQuotaUserRequestIdResource]
  }
  
  extension [Self <: ProjectQuotaUserRequestIdResource](x: Self) {
