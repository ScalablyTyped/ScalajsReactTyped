...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersDeleteInstancesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait FieldsInstanceGroupManagerKey extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersDeleteInstancesRequest
...
object FieldsInstanceGroupManagerKey {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[FieldsInstanceGroupManagerKey]
  }
  
  extension [Self <: FieldsInstanceGroupManagerKey](x: Self) {
    ...
    inline def setResource(value: InstanceGroupManagersDeleteInstancesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
