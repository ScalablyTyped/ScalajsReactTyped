...
trait HealthCheckKey extends StObject {
...
object HealthCheckKey {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(healthCheck = healthCheck.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[HealthCheckKey]
  }
  
  extension [Self <: HealthCheckKey](x: Self) {
