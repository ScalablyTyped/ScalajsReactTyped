...
trait CallbackDrainTimeoutSeconds extends StObject {
...
object CallbackDrainTimeoutSeconds {
  
  inline def apply(project: String, region: String, subnetwork: String): CallbackDrainTimeoutSeconds = {
    ...
    __obj.asInstanceOf[CallbackDrainTimeoutSeconds]
  }
  
  extension [Self <: CallbackDrainTimeoutSeconds](x: Self) {
