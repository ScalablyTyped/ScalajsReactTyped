...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroupsAddNodesRequest
...
trait NodeGroup extends StObject {
  ...
  /** Request body */
  var resource: NodeGroupsAddNodesRequest
...
object NodeGroup {
  ...
  inline def apply(nodeGroup: String, project: String, resource: NodeGroupsAddNodesRequest, zone: String): NodeGroup = {
  ...
  extension [Self <: NodeGroup](x: Self) {
    ...
    inline def setResource(value: NodeGroupsAddNodesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
