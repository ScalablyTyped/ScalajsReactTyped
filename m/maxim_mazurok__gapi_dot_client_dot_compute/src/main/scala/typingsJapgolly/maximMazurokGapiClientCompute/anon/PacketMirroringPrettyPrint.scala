...
trait PacketMirroringPrettyPrint extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PacketMirroring
...
object PacketMirroringPrettyPrint {
  
  inline def apply(
    packetMirroring: String,
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PacketMirroring
  ): PacketMirroringPrettyPrint = {
    val __obj = js.Dynamic.literal(packetMirroring = packetMirroring.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[PacketMirroringPrettyPrint]
  }
  
  extension [Self <: PacketMirroringPrettyPrint](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.PacketMirroring): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
