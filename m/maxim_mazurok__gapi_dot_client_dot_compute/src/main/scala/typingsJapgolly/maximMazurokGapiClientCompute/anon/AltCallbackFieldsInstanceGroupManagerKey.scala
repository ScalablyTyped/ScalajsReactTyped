...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagerPatchInstanceConfigReq
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AltCallbackFieldsInstanceGroupManagerKey extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagerPatchInstanceConfigReq
...
object AltCallbackFieldsInstanceGroupManagerKey {
  ...
  inline def apply(
  ...
  ): AltCallbackFieldsInstanceGroupManagerKey = {
    ...
    __obj.asInstanceOf[AltCallbackFieldsInstanceGroupManagerKey]
  }
  
  extension [Self <: AltCallbackFieldsInstanceGroupManagerKey](x: Self) {
    ...
    inline def setResource(value: RegionInstanceGroupManagerPatchInstanceConfigReq): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
