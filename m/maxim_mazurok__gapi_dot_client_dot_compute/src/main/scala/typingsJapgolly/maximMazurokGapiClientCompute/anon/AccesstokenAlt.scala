...
trait AccesstokenAlt extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket
...
object AccesstokenAlt {
  ...
  inline def apply(
    ...
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket
  ): AccesstokenAlt = {
    val __obj = js.Dynamic.literal(backendBucket = backendBucket.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
  ...
  extension [Self <: AccesstokenAlt](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.BackendBucket): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
