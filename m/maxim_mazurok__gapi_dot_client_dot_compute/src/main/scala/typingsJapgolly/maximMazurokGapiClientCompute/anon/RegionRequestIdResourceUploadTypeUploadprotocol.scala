...
trait RegionRequestIdResourceUploadTypeUploadprotocol extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroup
...
object RegionRequestIdResourceUploadTypeUploadprotocol {
  
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroup
  ): RegionRequestIdResourceUploadTypeUploadprotocol = {
    ...
    __obj.asInstanceOf[RegionRequestIdResourceUploadTypeUploadprotocol]
  }
  
  extension [Self <: RegionRequestIdResourceUploadTypeUploadprotocol](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
