...
trait OauthtokenPrettyPrintProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService
...
object OauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService
  ...
  extension [Self <: OauthtokenPrettyPrintProjectQuotaUserRegion](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.HealthCheckService): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
