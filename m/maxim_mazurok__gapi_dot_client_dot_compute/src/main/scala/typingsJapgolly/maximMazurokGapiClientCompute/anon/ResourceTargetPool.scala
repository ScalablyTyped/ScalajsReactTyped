...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetPoolsAddInstanceRequest
...
trait ResourceTargetPool extends StObject {
  ...
  /** Request body */
  var resource: TargetPoolsAddInstanceRequest
...
object ResourceTargetPool {
  ...
  inline def apply(project: String, region: String, resource: TargetPoolsAddInstanceRequest, targetPool: String): ResourceTargetPool = {
  ...
  extension [Self <: ResourceTargetPool](x: Self) {
    ...
    inline def setResource(value: TargetPoolsAddInstanceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
