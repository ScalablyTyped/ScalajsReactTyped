...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxiesSetProxyHeaderRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TargetSslProxyUploadType extends StObject {
  ...
  /** Request body */
  var resource: TargetSslProxiesSetProxyHeaderRequest
...
object TargetSslProxyUploadType {
  
  inline def apply(project: String, resource: TargetSslProxiesSetProxyHeaderRequest, targetSslProxy: String): TargetSslProxyUploadType = {
    ...
    __obj.asInstanceOf[TargetSslProxyUploadType]
  }
  
  extension [Self <: TargetSslProxyUploadType](x: Self) {
    ...
    inline def setResource(value: TargetSslProxiesSetProxyHeaderRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
