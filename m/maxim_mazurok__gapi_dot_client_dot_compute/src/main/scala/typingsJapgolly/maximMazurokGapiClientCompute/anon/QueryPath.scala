...
trait QueryPath extends StObject {
...
object QueryPath {
  ...
  inline def apply(instance: String, project: String, zone: String): QueryPath = {
    ...
    __obj.asInstanceOf[QueryPath]
  }
  
  extension [Self <: QueryPath](x: Self) {
