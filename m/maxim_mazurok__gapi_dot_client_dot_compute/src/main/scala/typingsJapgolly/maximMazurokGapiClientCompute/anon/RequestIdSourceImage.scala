...
trait RequestIdSourceImage extends StObject {
...
object RequestIdSourceImage {
  
  inline def apply(project: String, region: String): RequestIdSourceImage = {
    val __obj = js.Dynamic.literal(project = project.asInstanceOf[js.Any], region = region.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdSourceImage]
  }
  
  extension [Self <: RequestIdSourceImage](x: Self) {
