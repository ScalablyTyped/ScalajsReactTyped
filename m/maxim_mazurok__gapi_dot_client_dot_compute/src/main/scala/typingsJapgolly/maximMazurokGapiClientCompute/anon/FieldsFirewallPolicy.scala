...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.FirewallPolicyRule
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait FieldsFirewallPolicy extends StObject {
...
object FieldsFirewallPolicy {
  
  inline def apply(firewallPolicy: String, resource: FirewallPolicyRule): FieldsFirewallPolicy = {
    val __obj = js.Dynamic.literal(firewallPolicy = firewallPolicy.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[FieldsFirewallPolicy]
  }
  
  extension [Self <: FieldsFirewallPolicy](x: Self) {
    ...
    inline def setResource(value: FirewallPolicyRule): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
