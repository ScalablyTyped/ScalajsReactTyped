...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetSslProxiesSetBackendServiceRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ResourceTargetSslProxy extends StObject {
  ...
  /** Request body */
  var resource: TargetSslProxiesSetBackendServiceRequest
...
object ResourceTargetSslProxy {
  
  inline def apply(project: String, resource: TargetSslProxiesSetBackendServiceRequest, targetSslProxy: String): ResourceTargetSslProxy = {
    ...
    __obj.asInstanceOf[ResourceTargetSslProxy]
  }
  
  extension [Self <: ResourceTargetSslProxy](x: Self) {
    ...
    inline def setResource(value: TargetSslProxiesSetBackendServiceRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
