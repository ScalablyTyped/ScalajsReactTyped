...
trait CallbackFieldsImage extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Image
...
object CallbackFieldsImage {
  
  inline def apply(
    image: String,
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Image
  ): CallbackFieldsImage = {
    ...
    __obj.asInstanceOf[CallbackFieldsImage]
  }
  
  extension [Self <: CallbackFieldsImage](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Image): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
