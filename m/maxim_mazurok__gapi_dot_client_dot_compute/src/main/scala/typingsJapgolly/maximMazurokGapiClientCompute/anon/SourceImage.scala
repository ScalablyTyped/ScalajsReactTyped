...
trait SourceImage extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Disk
...
object SourceImage {
  ...
  inline def apply(
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Disk,
    zone: String
  ): SourceImage = {
  ...
  extension [Self <: SourceImage](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Disk): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
