...
trait RequestIdUploadType extends StObject {
...
object RequestIdUploadType {
  
  inline def apply(forwardingRule: String, project: String): RequestIdUploadType = {
    val __obj = js.Dynamic.literal(forwardingRule = forwardingRule.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any])
    __obj.asInstanceOf[RequestIdUploadType]
  }
  
  extension [Self <: RequestIdUploadType](x: Self) {
