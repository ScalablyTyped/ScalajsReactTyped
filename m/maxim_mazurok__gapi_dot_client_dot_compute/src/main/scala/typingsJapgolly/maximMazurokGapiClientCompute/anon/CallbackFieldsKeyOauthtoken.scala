...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.BulkInsertInstanceResource
...
trait CallbackFieldsKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: BulkInsertInstanceResource
...
object CallbackFieldsKeyOauthtoken {
  ...
  inline def apply(project: String, resource: BulkInsertInstanceResource, zone: String): CallbackFieldsKeyOauthtoken = {
  ...
  extension [Self <: CallbackFieldsKeyOauthtoken](x: Self) {
    ...
    inline def setResource(value: BulkInsertInstanceResource): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
