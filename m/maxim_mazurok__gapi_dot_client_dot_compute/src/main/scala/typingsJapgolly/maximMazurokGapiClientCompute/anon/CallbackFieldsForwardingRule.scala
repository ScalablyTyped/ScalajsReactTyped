...
trait CallbackFieldsForwardingRule extends StObject {
...
object CallbackFieldsForwardingRule {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[CallbackFieldsForwardingRule]
  }
  
  extension [Self <: CallbackFieldsForwardingRule](x: Self) {
