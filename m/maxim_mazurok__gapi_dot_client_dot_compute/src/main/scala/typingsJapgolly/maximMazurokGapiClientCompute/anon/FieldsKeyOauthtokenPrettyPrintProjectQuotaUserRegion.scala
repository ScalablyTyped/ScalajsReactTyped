...
trait FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.VpnTunnel
...
object FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion {
  ...
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.VpnTunnel
  ...
  extension [Self <: FieldsKeyOauthtokenPrettyPrintProjectQuotaUserRegion](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.VpnTunnel): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
