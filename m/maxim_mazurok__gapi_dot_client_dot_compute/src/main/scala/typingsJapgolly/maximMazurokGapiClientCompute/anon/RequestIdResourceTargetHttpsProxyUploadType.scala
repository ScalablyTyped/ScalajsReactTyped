...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.UrlMapReference
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait RequestIdResourceTargetHttpsProxyUploadType extends StObject {
...
object RequestIdResourceTargetHttpsProxyUploadType {
  
  inline def apply(project: String, resource: UrlMapReference, targetHttpsProxy: String): RequestIdResourceTargetHttpsProxyUploadType = {
    ...
    __obj.asInstanceOf[RequestIdResourceTargetHttpsProxyUploadType]
  }
  
  extension [Self <: RequestIdResourceTargetHttpsProxyUploadType](x: Self) {
