...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.RegionDisksAddResourcePoliciesRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait AltCallbackDisk extends StObject {
...
object AltCallbackDisk {
  
  inline def apply(disk: String, project: String, region: String, resource: RegionDisksAddResourcePoliciesRequest): AltCallbackDisk = {
    ...
    __obj.asInstanceOf[AltCallbackDisk]
  }
  
  extension [Self <: AltCallbackDisk](x: Self) {
