...
trait NetworkEndpointGroupOauthtokenPrettyPrint extends StObject {
...
object NetworkEndpointGroupOauthtokenPrettyPrint {
  
  inline def apply(networkEndpointGroup: String, project: String, zone: String): NetworkEndpointGroupOauthtokenPrettyPrint = {
    ...
    __obj.asInstanceOf[NetworkEndpointGroupOauthtokenPrettyPrint]
  }
  
  extension [Self <: NetworkEndpointGroupOauthtokenPrettyPrint](x: Self) {
