...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NetworkEndpointGroupsDetachEndpointsRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CallbackFieldsKeyNetworkEndpointGroup extends StObject {
  ...
  var networkEndpointGroup: String
  ...
  /** Request body */
  var resource: NetworkEndpointGroupsDetachEndpointsRequest
...
object CallbackFieldsKeyNetworkEndpointGroup {
  ...
  inline def apply(
    ...
    zone: String
  ): CallbackFieldsKeyNetworkEndpointGroup = {
    val __obj = js.Dynamic.literal(networkEndpointGroup = networkEndpointGroup.asInstanceOf[js.Any], project = project.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], zone = zone.asInstanceOf[js.Any])
  ...
  extension [Self <: CallbackFieldsKeyNetworkEndpointGroup](x: Self) {
    ...
    inline def setResource(value: NetworkEndpointGroupsDetachEndpointsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
