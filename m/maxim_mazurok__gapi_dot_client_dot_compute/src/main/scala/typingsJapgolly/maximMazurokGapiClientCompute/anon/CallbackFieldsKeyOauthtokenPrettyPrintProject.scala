...
trait CallbackFieldsKeyOauthtokenPrettyPrintProject extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpsProxy
...
object CallbackFieldsKeyOauthtokenPrettyPrintProject {
  
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpsProxy
  ): CallbackFieldsKeyOauthtokenPrettyPrintProject = {
    ...
    __obj.asInstanceOf[CallbackFieldsKeyOauthtokenPrettyPrintProject]
  }
  
  extension [Self <: CallbackFieldsKeyOauthtokenPrettyPrintProject](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetHttpsProxy): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
