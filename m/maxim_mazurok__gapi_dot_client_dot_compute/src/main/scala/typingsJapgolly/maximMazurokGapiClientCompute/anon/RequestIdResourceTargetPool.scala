...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.TargetPoolsRemoveHealthCheckRequest
...
trait RequestIdResourceTargetPool extends StObject {
  ...
  /** Request body */
  var resource: TargetPoolsRemoveHealthCheckRequest
...
object RequestIdResourceTargetPool {
  ...
  inline def apply(project: String, region: String, resource: TargetPoolsRemoveHealthCheckRequest, targetPool: String): RequestIdResourceTargetPool = {
  ...
  extension [Self <: RequestIdResourceTargetPool](x: Self) {
    ...
    inline def setResource(value: TargetPoolsRemoveHealthCheckRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
