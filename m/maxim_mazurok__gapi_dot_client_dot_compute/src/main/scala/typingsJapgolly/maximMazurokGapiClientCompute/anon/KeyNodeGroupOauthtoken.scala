...
trait KeyNodeGroupOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroup
...
object KeyNodeGroupOauthtoken {
  
  inline def apply(
    nodeGroup: String,
    project: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroup,
    zone: String
  ): KeyNodeGroupOauthtoken = {
    ...
    __obj.asInstanceOf[KeyNodeGroupOauthtoken]
  }
  
  extension [Self <: KeyNodeGroupOauthtoken](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.NodeGroup): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
