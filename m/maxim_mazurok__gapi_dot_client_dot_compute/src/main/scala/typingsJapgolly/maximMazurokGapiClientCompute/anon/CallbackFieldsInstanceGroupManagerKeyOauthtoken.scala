...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.RegionInstanceGroupManagersRecreateRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CallbackFieldsInstanceGroupManagerKeyOauthtoken extends StObject {
  ...
  /** Request body */
  var resource: RegionInstanceGroupManagersRecreateRequest
...
object CallbackFieldsInstanceGroupManagerKeyOauthtoken {
  ...
  ): CallbackFieldsInstanceGroupManagerKeyOauthtoken = {
  ...
  extension [Self <: CallbackFieldsInstanceGroupManagerKeyOauthtoken](x: Self) {
    ...
    inline def setResource(value: RegionInstanceGroupManagersRecreateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
