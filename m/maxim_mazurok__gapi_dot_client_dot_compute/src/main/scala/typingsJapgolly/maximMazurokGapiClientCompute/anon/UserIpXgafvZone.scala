...
import typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.InstanceGroupManagersSetTargetPoolsRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait UserIpXgafvZone extends StObject {
  ...
  /** Request body */
  var resource: InstanceGroupManagersSetTargetPoolsRequest
...
object UserIpXgafvZone {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[UserIpXgafvZone]
  }
  
  extension [Self <: UserIpXgafvZone](x: Self) {
    ...
    inline def setResource(value: InstanceGroupManagersSetTargetPoolsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
