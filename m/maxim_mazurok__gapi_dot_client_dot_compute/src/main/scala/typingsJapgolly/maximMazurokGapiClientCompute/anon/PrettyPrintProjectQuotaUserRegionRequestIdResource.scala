...
trait PrettyPrintProjectQuotaUserRegionRequestIdResource extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Subnetwork
...
object PrettyPrintProjectQuotaUserRegionRequestIdResource {
  
  inline def apply(
    project: String,
    region: String,
    resource: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Subnetwork
  ): PrettyPrintProjectQuotaUserRegionRequestIdResource = {
  ...
  extension [Self <: PrettyPrintProjectQuotaUserRegionRequestIdResource](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientCompute.gapi.client.compute.Subnetwork): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
