...
import typingsJapgolly.materialLinearProgress.foundationMod.MDCLinearProgressFoundation
...
object componentMod {
  ...
  object MDCLinearProgress {
    ...
    inline def attachTo(root: org.scalajs.dom.Element): MDCLinearProgress = ^.asInstanceOf[js.Dynamic].applyDynamic("attachTo")(root.asInstanceOf[js.Any]).asInstanceOf[MDCLinearProgress]
  }
}
