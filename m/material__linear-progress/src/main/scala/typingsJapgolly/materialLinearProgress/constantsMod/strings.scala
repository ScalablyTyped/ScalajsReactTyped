...
import typingsJapgolly.materialLinearProgress.materialLinearProgressStrings.`Dotmdc-linear-progress__buffer`
import typingsJapgolly.materialLinearProgress.materialLinearProgressStrings.`Dotmdc-linear-progress__primary-bar`
