...
trait GoogleCloudFunctionsV2alphaOperationMetadata extends StObject {
  ...
  var stages: js.UndefOr[js.Array[GoogleCloudFunctionsV2alphaStage]] = js.undefined
...
object GoogleCloudFunctionsV2alphaOperationMetadata {
  
  inline def apply(): GoogleCloudFunctionsV2alphaOperationMetadata = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudFunctionsV2alphaOperationMetadata]
  }
  
  extension [Self <: GoogleCloudFunctionsV2alphaOperationMetadata](x: Self) {
    ...
    inline def setStages(value: js.Array[GoogleCloudFunctionsV2alphaStage]): Self = StObject.set(x, "stages", value.asInstanceOf[js.Any])
    
    inline def setStagesUndefined: Self = StObject.set(x, "stages", js.undefined)
    
    inline def setStagesVarargs(value: GoogleCloudFunctionsV2alphaStage*): Self = StObject.set(x, "stages", js.Array(value*))
