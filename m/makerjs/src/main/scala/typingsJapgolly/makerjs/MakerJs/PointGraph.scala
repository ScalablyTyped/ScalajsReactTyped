...
object PointGraph {
  ...
  extension [Self <: PointGraph[?], T](x: Self & PointGraph[T]) {
    ...
    ): Self = StObject.set(x, "forEachPoint", js.Any.fromFunction1((t0: js.Function4[
          /* p */ IPoint, 
          /* values */ js.Array[T], 
          /* pointId */ js.UndefOr[Double], 
          /* el */ js.UndefOr[IPointGraphIndexElement], 
    ...
    inline def setMergeNearestSinglePoints(value: Double => Callback): Self = StObject.set(x, "mergeNearestSinglePoints", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def setMergePoints(value: Double => Callback): Self = StObject.set(x, "mergePoints", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
