...
object paths {
  ...
  /**
    * Class for arc path.
    */
  @JSImport("makerjs", "paths.Arc")
  @js.native
  open class Arc protected ()
    extends StObject
       with typingsJapgolly.makerjs.MakerJs.paths.Arc {
    /**
  ...
  /**
    ...
    */
  @JSImport("makerjs", "paths.Chord")
  @js.native
  open class Chord protected ()
    extends StObject
       with typingsJapgolly.makerjs.MakerJs.paths.Chord {
  ...
  /**
    ...
    */
  @JSImport("makerjs", "paths.Circle")
  @js.native
  open class Circle protected ()
    extends StObject
       with typingsJapgolly.makerjs.MakerJs.paths.Circle {
    /**
  ...
  /**
    * Class for line path.
    */
  @JSImport("makerjs", "paths.Line")
  @js.native
  open class Line protected ()
    extends StObject
       with typingsJapgolly.makerjs.MakerJs.paths.Line {
    /**
  ...
  /**
    ...
    */
  @JSImport("makerjs", "paths.Parallel")
  @js.native
  open class Parallel protected ()
    extends StObject
       with typingsJapgolly.makerjs.MakerJs.paths.Parallel {
