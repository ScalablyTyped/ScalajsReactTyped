...
import typingsJapgolly.makerjs.MakerJs.IPointGraphIndexElement
import typingsJapgolly.makerjs.anon.Existed
...
open class PointGraph[T] ()
  extends StObject
     with typingsJapgolly.makerjs.MakerJs.PointGraph[T] {
