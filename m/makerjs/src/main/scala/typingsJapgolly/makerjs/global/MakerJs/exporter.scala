...
import typingsJapgolly.danmarshallJscadTypings.typesMod.CSG
import typingsJapgolly.danmarshallJscadTypings.typesStlSerializerMod.StlSerializer
...
import typingsJapgolly.makerjs.MakerJs.exporter.IDXFRenderOptions
import typingsJapgolly.makerjs.MakerJs.exporter.IJscadCagOptions
import typingsJapgolly.makerjs.MakerJs.exporter.IJscadCsgOptions
import typingsJapgolly.makerjs.MakerJs.exporter.IJscadScriptOptions
import typingsJapgolly.makerjs.MakerJs.exporter.IJsonExportOptions
import typingsJapgolly.makerjs.MakerJs.exporter.IPDFRenderOptions
import typingsJapgolly.makerjs.MakerJs.exporter.IPathDataByLayerMap
import typingsJapgolly.makerjs.MakerJs.exporter.ISVGPathDataRenderOptions
import typingsJapgolly.makerjs.MakerJs.exporter.ISVGRenderOptions
import typingsJapgolly.makerjs.MakerJs.exporter.IXmlTagAttrs
import typingsJapgolly.makerjs.MakerJs.exporter.svgUnitConversion
import typingsJapgolly.makerjs.anon.TypeofCAG
...
object exporter {
  ...
  open class XmlTag protected ()
    extends StObject
       with typingsJapgolly.makerjs.MakerJs.exporter.XmlTag {
    /**
