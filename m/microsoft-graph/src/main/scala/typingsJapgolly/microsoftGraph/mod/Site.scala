...
import typingsJapgolly.microsoftGraph.mod.TermStore.Store
...
trait Site
  ...
  var lists: js.UndefOr[NullableOption[js.Array[typingsJapgolly.microsoftGraph.mod.List]]] = js.undefined
...
object Site {
  ...
  extension [Self <: Site](x: Self) {
    ...
    inline def setLists(value: NullableOption[js.Array[typingsJapgolly.microsoftGraph.mod.List]]): Self = StObject.set(x, "lists", value.asInstanceOf[js.Any])
    ...
    inline def setListsVarargs(value: typingsJapgolly.microsoftGraph.mod.List*): Self = StObject.set(x, "lists", js.Array(value*))
