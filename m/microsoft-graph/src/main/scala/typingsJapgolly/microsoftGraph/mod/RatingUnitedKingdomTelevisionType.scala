...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.microsoftGraph.microsoftGraphStrings.caution
*/
...
object RatingUnitedKingdomTelevisionType {
  ...
  inline def caution: typingsJapgolly.microsoftGraph.microsoftGraphStrings.caution = "caution".asInstanceOf[typingsJapgolly.microsoftGraph.microsoftGraphStrings.caution]
}
