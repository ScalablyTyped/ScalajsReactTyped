...
trait Case
  ...
  var status: js.UndefOr[NullableOption[CaseStatus]] = js.undefined
}
object Case {
  ...
  extension [Self <: Case](x: Self) {
    ...
    inline def setStatus(value: NullableOption[CaseStatus]): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
