...
import typingsJapgolly.microsoftGraph.mod.CallRecords.CallRecord
...
trait CloudCommunications
  ...
  var presences: js.UndefOr[NullableOption[js.Array[Presence]]] = js.undefined
}
object CloudCommunications {
  ...
  extension [Self <: CloudCommunications](x: Self) {
    ...
    inline def setCallRecordsVarargs(value: CallRecord*): Self = StObject.set(x, "callRecords", js.Array(value*))
    ...
    inline def setPresences(value: NullableOption[js.Array[Presence]]): Self = StObject.set(x, "presences", value.asInstanceOf[js.Any])
    
    inline def setPresencesNull: Self = StObject.set(x, "presences", null)
    
    inline def setPresencesUndefined: Self = StObject.set(x, "presences", js.undefined)
    
    inline def setPresencesVarargs(value: Presence*): Self = StObject.set(x, "presences", js.Array(value*))
  }
}
