...
object TermStore {
  ...
  object Group {
    ...
    inline def apply(): typingsJapgolly.microsoftGraph.mod.TermStore.Group = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.microsoftGraph.mod.TermStore.Group]
    }
    
    extension [Self <: typingsJapgolly.microsoftGraph.mod.TermStore.Group](x: Self) {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.microsoftGraph.microsoftGraphStrings.pin
    - typingsJapgolly.microsoftGraph.microsoftGraphStrings.reuse
    - typingsJapgolly.microsoftGraph.microsoftGraphStrings.unknownFutureValue_
  */
  trait RelationType extends StObject
  object RelationType {
    
    inline def pin: typingsJapgolly.microsoftGraph.microsoftGraphStrings.pin = "pin".asInstanceOf[typingsJapgolly.microsoftGraph.microsoftGraphStrings.pin]
    
    inline def reuse: typingsJapgolly.microsoftGraph.microsoftGraphStrings.reuse = "reuse".asInstanceOf[typingsJapgolly.microsoftGraph.microsoftGraphStrings.reuse]
  ...
  trait Set
    ...
    var parentGroup: js.UndefOr[typingsJapgolly.microsoftGraph.mod.TermStore.Group] = js.undefined
  ...
  object Set {
    ...
    extension [Self <: Set](x: Self) {
      ...
      inline def setParentGroup(value: typingsJapgolly.microsoftGraph.mod.TermStore.Group): Self = StObject.set(x, "parentGroup", value.asInstanceOf[js.Any])
  ...
  trait Store
    ...
    var groups: js.UndefOr[NullableOption[js.Array[typingsJapgolly.microsoftGraph.mod.TermStore.Group]]] = js.undefined
  ...
  object Store {
    ...
    extension [Self <: Store](x: Self) {
      ...
      inline def setGroups(value: NullableOption[js.Array[typingsJapgolly.microsoftGraph.mod.TermStore.Group]]): Self = StObject.set(x, "groups", value.asInstanceOf[js.Any])
      
      inline def setGroupsNull: Self = StObject.set(x, "groups", null)
      
      inline def setGroupsUndefined: Self = StObject.set(x, "groups", js.undefined)
      
      inline def setGroupsVarargs(value: typingsJapgolly.microsoftGraph.mod.TermStore.Group*): Self = StObject.set(x, "groups", js.Array(value*))
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.microsoftGraph.microsoftGraphStrings.siteCollection
    - typingsJapgolly.microsoftGraph.microsoftGraphStrings.unknownFutureValue_
  */
  ...
  object TermGroupScope {
    ...
    inline def siteCollection: typingsJapgolly.microsoftGraph.microsoftGraphStrings.siteCollection = "siteCollection".asInstanceOf[typingsJapgolly.microsoftGraph.microsoftGraphStrings.siteCollection]
    
    inline def system: typingsJapgolly.microsoftGraph.microsoftGraphStrings.system = "system".asInstanceOf[typingsJapgolly.microsoftGraph.microsoftGraphStrings.system]
