...
trait TeamUnarchivedEventMessageDetail
  extends StObject
...
object TeamUnarchivedEventMessageDetail {
  
  inline def apply(): TeamUnarchivedEventMessageDetail = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TeamUnarchivedEventMessageDetail]
  }
  
  extension [Self <: TeamUnarchivedEventMessageDetail](x: Self) {
