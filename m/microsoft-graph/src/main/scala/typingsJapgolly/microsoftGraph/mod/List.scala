...
object List {
  ...
  inline def apply(): typingsJapgolly.microsoftGraph.mod.List = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[typingsJapgolly.microsoftGraph.mod.List]
  }
  
  extension [Self <: typingsJapgolly.microsoftGraph.mod.List](x: Self) {
