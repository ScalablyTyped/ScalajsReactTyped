...
import typingsJapgolly.mem.AnonData
...
object Options {
  ...
  def apply[ArgumentsType /* <: js.Array[_] */, CacheKeyType, ReturnType](
    ...
    cacheKey: /* arguments */ ArgumentsType => CallbackTo[CacheKeyType] = null,
    cachePromiseRejection: js.UndefOr[Boolean] = js.undefined,
    maxAge: Int | Double = null
  ): Options[ArgumentsType, CacheKeyType, ReturnType] = {
    val __obj = js.Dynamic.literal()
    if (cache != null) __obj.updateDynamic("cache")(cache.asInstanceOf[js.Any])
    if (cacheKey != null) __obj.updateDynamic("cacheKey")(js.Any.fromFunction1((t0: /* arguments */ ArgumentsType) => cacheKey(t0).runNow()))
