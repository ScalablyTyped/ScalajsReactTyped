...
object mod {
  ...
  object CacheStorage {
    ...
    inline def apply[KeyType, ValueType](
      ...
      has: KeyType => Boolean,
      set: (KeyType, CacheStorageContent[ValueType]) => Callback
    ): CacheStorage[KeyType, ValueType] = {
      val __obj = js.Dynamic.literal(delete = js.Any.fromFunction1((t0: KeyType) => delete(t0).runNow()), get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has), set = js.Any.fromFunction2((t0: KeyType, t1: CacheStorageContent[ValueType]) => (set(t0, t1)).runNow()))
    ...
    extension [Self <: CacheStorage[?, ?], KeyType, ValueType](x: Self & (CacheStorage[KeyType, ValueType])) {
      ...
      inline def setDelete(value: KeyType => Callback): Self = StObject.set(x, "delete", js.Any.fromFunction1((t0: KeyType) => value(t0).runNow()))
      ...
      inline def setSet(value: (KeyType, CacheStorageContent[ValueType]) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: KeyType, t1: CacheStorageContent[ValueType]) => (value(t0, t1)).runNow()))
    }
  }
