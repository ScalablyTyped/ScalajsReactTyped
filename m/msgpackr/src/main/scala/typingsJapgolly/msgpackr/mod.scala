...
import typingsJapgolly.msgpackr.anon.AllowHalfOpen
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setGetStructures(value: CallbackTo[js.Array[js.Object]]): Self = StObject.set(x, "getStructures", value.toJsFn)
      ...
      inline def setOnInvalidDate(value: CallbackTo[Any]): Self = StObject.set(x, "onInvalidDate", value.toJsFn)
