...
object Options {
  ...
  extension [Self <: Options](x: Self) {
    ...
    inline def setAfterDeselect(value: /* repeated */ Any => Callback): Self = StObject.set(x, "afterDeselect", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
    
    inline def setAfterDeselectUndefined: Self = StObject.set(x, "afterDeselect", js.undefined)
    
    inline def setAfterInit(value: /* repeated */ Any => Callback): Self = StObject.set(x, "afterInit", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
    
    inline def setAfterInitUndefined: Self = StObject.set(x, "afterInit", js.undefined)
    
    inline def setAfterSelect(value: /* repeated */ Any => Callback): Self = StObject.set(x, "afterSelect", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
