...
object IDonutOptions {
  ...
  def apply(
    ...
    formatter: (/* y */ Double, /* data */ IDonutData) => CallbackTo[String] = null,
    resize: js.UndefOr[Boolean] = js.undefined
  ): IDonutOptions = {
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], element = element.asInstanceOf[js.Any])
    if (colors != null) __obj.updateDynamic("colors")(colors.asInstanceOf[js.Any])
    if (formatter != null) __obj.updateDynamic("formatter")(js.Any.fromFunction2((t0: /* y */ scala.Double, t1: /* data */ typingsJapgolly.morrisJs.morris.IDonutData) => formatter(t0, t1).runNow()))
