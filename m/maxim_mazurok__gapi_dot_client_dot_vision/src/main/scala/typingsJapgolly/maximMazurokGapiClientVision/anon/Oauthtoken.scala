...
import typingsJapgolly.maximMazurokGapiClientVision.gapi.client.vision.AsyncBatchAnnotateFilesRequest
...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: AsyncBatchAnnotateFilesRequest
...
object Oauthtoken {
  ...
  inline def apply(parent: String, resource: AsyncBatchAnnotateFilesRequest): Oauthtoken = {
  ...
  extension [Self <: Oauthtoken](x: Self) {
    ...
    inline def setResource(value: AsyncBatchAnnotateFilesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
