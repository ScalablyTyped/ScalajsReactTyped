...
import typingsJapgolly.maximMazurokGapiClientVision.gapi.client.vision.BatchAnnotateImagesRequest
...
trait Parent extends StObject {
  ...
  /** Request body */
  var resource: BatchAnnotateImagesRequest
...
object Parent {
  ...
  inline def apply(parent: String, resource: BatchAnnotateImagesRequest): Parent = {
  ...
  extension [Self <: Parent](x: Self) {
    ...
    inline def setResource(value: BatchAnnotateImagesRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
