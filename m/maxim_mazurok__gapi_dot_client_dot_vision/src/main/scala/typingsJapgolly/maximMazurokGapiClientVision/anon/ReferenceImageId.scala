package typingsJapgolly.maximMazurokGapiClientVision.anon

import typingsJapgolly.maximMazurokGapiClientVision.gapi.client.vision.ReferenceImage
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ReferenceImageId extends StObject {
...
object ReferenceImageId {
  ...
  inline def apply(parent: String, resource: ReferenceImage): ReferenceImageId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[ReferenceImageId]
  }
  
  extension [Self <: ReferenceImageId](x: Self) {
    ...
    inline def setResource(value: ReferenceImage): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
