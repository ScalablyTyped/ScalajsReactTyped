...
trait GoogleCloudVisionV1p1beta1Word extends StObject {
  ...
  var symbols: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1Symbol]] = js.undefined
}
object GoogleCloudVisionV1p1beta1Word {
  
  inline def apply(): GoogleCloudVisionV1p1beta1Word = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1Word]
  }
  
  extension [Self <: GoogleCloudVisionV1p1beta1Word](x: Self) {
    ...
    inline def setSymbols(value: js.Array[GoogleCloudVisionV1p1beta1Symbol]): Self = StObject.set(x, "symbols", value.asInstanceOf[js.Any])
    
    inline def setSymbolsUndefined: Self = StObject.set(x, "symbols", js.undefined)
    
    inline def setSymbolsVarargs(value: GoogleCloudVisionV1p1beta1Symbol*): Self = StObject.set(x, "symbols", js.Array(value*))
  }
}
