...
object FaceAnnotation {
  ...
  inline def apply(): FaceAnnotation = {
  ...
  extension [Self <: FaceAnnotation](x: Self) {
    ...
    inline def setFdBoundingPoly(value: BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    inline def setLandmarks(value: js.Array[Landmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
