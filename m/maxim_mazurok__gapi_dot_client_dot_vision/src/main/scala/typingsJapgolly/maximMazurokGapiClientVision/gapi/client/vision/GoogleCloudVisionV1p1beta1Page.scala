...
trait GoogleCloudVisionV1p1beta1Page extends StObject {
  ...
  var blocks: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1Block]] = js.undefined
...
object GoogleCloudVisionV1p1beta1Page {
  ...
  extension [Self <: GoogleCloudVisionV1p1beta1Page](x: Self) {
    ...
    inline def setBlocksVarargs(value: GoogleCloudVisionV1p1beta1Block*): Self = StObject.set(x, "blocks", js.Array(value*))
