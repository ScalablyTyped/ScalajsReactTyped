...
trait GoogleCloudVisionV1p2beta1ProductSearchResults extends StObject {
  ...
  /**
    ...
    */
  var productGroupedResults: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult]] = js.undefined
...
object GoogleCloudVisionV1p2beta1ProductSearchResults {
  ...
  inline def apply(): GoogleCloudVisionV1p2beta1ProductSearchResults = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1ProductSearchResults]
  }
  
  extension [Self <: GoogleCloudVisionV1p2beta1ProductSearchResults](x: Self) {
    ...
    inline def setProductGroupedResults(value: js.Array[GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult]): Self = StObject.set(x, "productGroupedResults", value.asInstanceOf[js.Any])
    
    inline def setProductGroupedResultsUndefined: Self = StObject.set(x, "productGroupedResults", js.undefined)
    
    inline def setProductGroupedResultsVarargs(value: GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult*): Self = StObject.set(x, "productGroupedResults", js.Array(value*))
    
    inline def setResults(value: js.Array[GoogleCloudVisionV1p2beta1ProductSearchResultsResult]): Self = StObject.set(x, "results", value.asInstanceOf[js.Any])
    
    inline def setResultsUndefined: Self = StObject.set(x, "results", js.undefined)
    
    inline def setResultsVarargs(value: GoogleCloudVisionV1p2beta1ProductSearchResultsResult*): Self = StObject.set(x, "results", js.Array(value*))
  }
}
