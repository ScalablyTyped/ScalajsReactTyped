...
object GoogleCloudVisionV1p2beta1ImageProperties {
  ...
  inline def apply(): GoogleCloudVisionV1p2beta1ImageProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1ImageProperties]
  }
  
  extension [Self <: GoogleCloudVisionV1p2beta1ImageProperties](x: Self) {
    
    inline def setDominantColors(value: GoogleCloudVisionV1p2beta1DominantColorsAnnotation): Self = StObject.set(x, "dominantColors", value.asInstanceOf[js.Any])
