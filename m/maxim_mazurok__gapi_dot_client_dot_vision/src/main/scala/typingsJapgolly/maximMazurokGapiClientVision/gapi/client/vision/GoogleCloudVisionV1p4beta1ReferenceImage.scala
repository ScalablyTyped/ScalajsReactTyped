...
trait GoogleCloudVisionV1p4beta1ReferenceImage extends StObject {
  ...
  /**
    ...
    */
  var boundingPolys: js.UndefOr[js.Array[GoogleCloudVisionV1p4beta1BoundingPoly]] = js.undefined
...
object GoogleCloudVisionV1p4beta1ReferenceImage {
  ...
  inline def apply(): GoogleCloudVisionV1p4beta1ReferenceImage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1ReferenceImage]
  }
  
  extension [Self <: GoogleCloudVisionV1p4beta1ReferenceImage](x: Self) {
    
    inline def setBoundingPolys(value: js.Array[GoogleCloudVisionV1p4beta1BoundingPoly]): Self = StObject.set(x, "boundingPolys", value.asInstanceOf[js.Any])
    
    inline def setBoundingPolysUndefined: Self = StObject.set(x, "boundingPolys", js.undefined)
    
    inline def setBoundingPolysVarargs(value: GoogleCloudVisionV1p4beta1BoundingPoly*): Self = StObject.set(x, "boundingPolys", js.Array(value*))
