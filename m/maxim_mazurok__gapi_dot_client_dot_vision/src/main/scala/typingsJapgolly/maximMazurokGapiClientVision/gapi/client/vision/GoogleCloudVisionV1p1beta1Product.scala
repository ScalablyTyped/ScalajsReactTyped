...
trait GoogleCloudVisionV1p1beta1Product extends StObject {
  ...
  /**
    ...
    */
  var productLabels: js.UndefOr[js.Array[GoogleCloudVisionV1p1beta1ProductKeyValue]] = js.undefined
}
object GoogleCloudVisionV1p1beta1Product {
  
  inline def apply(): GoogleCloudVisionV1p1beta1Product = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p1beta1Product]
  }
  
  extension [Self <: GoogleCloudVisionV1p1beta1Product](x: Self) {
    ...
    inline def setProductLabels(value: js.Array[GoogleCloudVisionV1p1beta1ProductKeyValue]): Self = StObject.set(x, "productLabels", value.asInstanceOf[js.Any])
    
    inline def setProductLabelsUndefined: Self = StObject.set(x, "productLabels", js.undefined)
    
    inline def setProductLabelsVarargs(value: GoogleCloudVisionV1p1beta1ProductKeyValue*): Self = StObject.set(x, "productLabels", js.Array(value*))
  }
}
