...
trait GoogleCloudVisionV1p3beta1WebDetectionWebPage extends StObject {
...
object GoogleCloudVisionV1p3beta1WebDetectionWebPage {
  
  inline def apply(): GoogleCloudVisionV1p3beta1WebDetectionWebPage = {
