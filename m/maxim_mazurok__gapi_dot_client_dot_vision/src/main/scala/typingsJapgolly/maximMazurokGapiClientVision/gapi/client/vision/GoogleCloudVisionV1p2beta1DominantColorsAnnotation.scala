...
trait GoogleCloudVisionV1p2beta1DominantColorsAnnotation extends StObject {
  
  /** RGB color values with their score and pixel fraction. */
  var colors: js.UndefOr[js.Array[GoogleCloudVisionV1p2beta1ColorInfo]] = js.undefined
}
object GoogleCloudVisionV1p2beta1DominantColorsAnnotation {
  
  inline def apply(): GoogleCloudVisionV1p2beta1DominantColorsAnnotation = {
