...
trait GoogleCloudVisionV1p2beta1GcsDestination extends StObject {
...
object GoogleCloudVisionV1p2beta1GcsDestination {
  ...
  inline def apply(): GoogleCloudVisionV1p2beta1GcsDestination = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p2beta1GcsDestination]
  }
  
  extension [Self <: GoogleCloudVisionV1p2beta1GcsDestination](x: Self) {
