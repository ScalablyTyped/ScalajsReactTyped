...
object GoogleCloudVisionV1p4beta1FaceAnnotation {
  ...
  inline def apply(): GoogleCloudVisionV1p4beta1FaceAnnotation = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p4beta1FaceAnnotation]
  }
  
  extension [Self <: GoogleCloudVisionV1p4beta1FaceAnnotation](x: Self) {
    ...
    inline def setFdBoundingPoly(value: GoogleCloudVisionV1p4beta1BoundingPoly): Self = StObject.set(x, "fdBoundingPoly", value.asInstanceOf[js.Any])
    ...
    inline def setLandmarks(value: js.Array[GoogleCloudVisionV1p4beta1FaceAnnotationLandmark]): Self = StObject.set(x, "landmarks", value.asInstanceOf[js.Any])
    ...
    inline def setRecognitionResult(value: js.Array[GoogleCloudVisionV1p4beta1FaceRecognitionResult]): Self = StObject.set(x, "recognitionResult", value.asInstanceOf[js.Any])
