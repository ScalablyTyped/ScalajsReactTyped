...
trait GoogleCloudVisionV1p3beta1WebDetectionWebLabel extends StObject {
...
object GoogleCloudVisionV1p3beta1WebDetectionWebLabel {
  ...
  inline def apply(): GoogleCloudVisionV1p3beta1WebDetectionWebLabel = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GoogleCloudVisionV1p3beta1WebDetectionWebLabel]
  }
  
  extension [Self <: GoogleCloudVisionV1p3beta1WebDetectionWebLabel](x: Self) {
