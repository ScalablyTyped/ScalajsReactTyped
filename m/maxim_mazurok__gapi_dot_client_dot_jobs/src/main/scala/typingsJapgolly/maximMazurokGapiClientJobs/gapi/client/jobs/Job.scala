...
trait Job extends StObject {
  ...
  var compensationInfo: js.UndefOr[CompensationInfo] = js.undefined
  ...
  var derivedInfo: js.UndefOr[JobDerivedInfo] = js.undefined
  ...
  var processingOptions: js.UndefOr[ProcessingOptions] = js.undefined
...
object Job {
  ...
  extension [Self <: Job](x: Self) {
    ...
    inline def setCompensationInfo(value: CompensationInfo): Self = StObject.set(x, "compensationInfo", value.asInstanceOf[js.Any])
    ...
    inline def setDegreeTypesVarargs(value: String*): Self = StObject.set(x, "degreeTypes", js.Array(value*))
    ...
    inline def setDerivedInfo(value: JobDerivedInfo): Self = StObject.set(x, "derivedInfo", value.asInstanceOf[js.Any])
    ...
    inline def setJobBenefitsVarargs(value: String*): Self = StObject.set(x, "jobBenefits", js.Array(value*))
    ...
    inline def setProcessingOptions(value: ProcessingOptions): Self = StObject.set(x, "processingOptions", value.asInstanceOf[js.Any])
