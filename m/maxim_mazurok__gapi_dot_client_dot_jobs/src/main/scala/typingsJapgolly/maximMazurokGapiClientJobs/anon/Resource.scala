package typingsJapgolly.maximMazurokGapiClientJobs.anon

import typingsJapgolly.maximMazurokGapiClientJobs.gapi.client.jobs.Job
...
object Resource {
  ...
  inline def apply(parent: String, resource: Job): Resource = {
