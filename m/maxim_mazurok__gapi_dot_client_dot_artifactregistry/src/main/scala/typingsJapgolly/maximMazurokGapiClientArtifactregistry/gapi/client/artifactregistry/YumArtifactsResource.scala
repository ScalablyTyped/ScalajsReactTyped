...
import typingsJapgolly.maximMazurokGapiClientArtifactregistry.anon.Callback
import typingsJapgolly.maximMazurokGapiClientArtifactregistry.anon.Resource
import typingsJapgolly.maximMazurokGapiClientArtifactregistry.anon.Uploadprotocol
