...
import typingsJapgolly.maximMazurokGapiClientArtifactregistry.gapi.client.artifactregistry.Repository
...
object RepositoryId {
  ...
  inline def apply(parent: String, resource: Repository): RepositoryId = {
