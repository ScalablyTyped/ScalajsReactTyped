...
import typingsJapgolly.microsoftLiveConnect.AnonAccount
import typingsJapgolly.microsoftLiveConnect.AnonMobile
import typingsJapgolly.microsoftLiveConnect.AnonPersonal
