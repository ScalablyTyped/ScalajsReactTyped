...
import typingsJapgolly.metroTransformWorker.anon.ReadonlycodestringlineCou
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashscript
    - typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashmodule
    - typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashmoduleSlashasset
  */
  trait JSFileType extends StObject
  object JSFileType {
    
    inline def jsSlashmodule: typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashmodule = "js/module".asInstanceOf[typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashmodule]
    
    inline def jsSlashmoduleSlashasset: typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashmoduleSlashasset = "js/module/asset".asInstanceOf[typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashmoduleSlashasset]
    
    inline def jsSlashscript: typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashscript = "js/script".asInstanceOf[typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.jsSlashscript]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.script
    - typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.module
    - typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.asset
  */
  trait Type extends StObject
  object Type {
    
    inline def asset: typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.asset = "asset".asInstanceOf[typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.asset]
    
    inline def module: typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.module = "module".asInstanceOf[typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.module]
    
    inline def script: typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.script = "script".asInstanceOf[typingsJapgolly.metroTransformWorker.metroTransformWorkerStrings.script]
  }
}
