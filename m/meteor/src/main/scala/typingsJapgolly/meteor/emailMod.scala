...
object emailMod {
  ...
  object Email {
    ...
    trait EmailOptions extends StObject {
      ...
      var mailComposer: js.UndefOr[typingsJapgolly.meteor.emailMod.MailComposer] = js.undefined
    ...
    object EmailOptions {
      ...
      extension [Self <: EmailOptions](x: Self) {
        ...
        inline def setMailComposer(value: typingsJapgolly.meteor.emailMod.MailComposer): Self = StObject.set(x, "mailComposer", value.asInstanceOf[js.Any])
  ...
  object MailComposer {
    ...
    @js.native
    val ^ : typingsJapgolly.meteor.emailMod.MailComposerStatic = js.native
    
    extension [Self <: typingsJapgolly.meteor.emailMod.MailComposer](x: Self) {
  ...
  open class MailComposerCls protected ()
    extends StObject
       with typingsJapgolly.meteor.emailMod.MailComposer {
    def this(options: typingsJapgolly.meteor.emailMod.MailComposerOptions) = this()
  ...
  object MailComposerOptions {
    ...
    inline def apply(
      ...
      keepBcc: Boolean
    ): typingsJapgolly.meteor.emailMod.MailComposerOptions = {
      ...
      __obj.asInstanceOf[typingsJapgolly.meteor.emailMod.MailComposerOptions]
    }
    
    extension [Self <: typingsJapgolly.meteor.emailMod.MailComposerOptions](x: Self) {
  ...
  trait MailComposerStatic
    extends StObject
       with Instantiable1[
          /* options */ typingsJapgolly.meteor.emailMod.MailComposerOptions, 
          typingsJapgolly.meteor.emailMod.MailComposer
        ]
}
