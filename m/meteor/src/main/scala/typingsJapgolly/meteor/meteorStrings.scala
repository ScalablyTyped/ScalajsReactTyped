...
import typingsJapgolly.meteor.DDP.Status
import typingsJapgolly.meteor.Mongo.BsonType
...
object meteorStrings {
  ...
  @js.native
  sealed trait LoadBalancer extends StObject
  inline def LoadBalancer: LoadBalancer = "LoadBalancer".asInstanceOf[LoadBalancer]
  
  @js.native
  sealed trait `MONGODB-AWS` extends StObject
  ...
  @js.native
  sealed trait Mongos extends StObject
  ...
  @js.native
  sealed trait RetryableWriteError extends StObject
  ...
  @js.native
  sealed trait Sharded extends StObject
  ...
  @js.native
  sealed trait UnknownTransactionCommitResult extends StObject
  ...
  sealed trait array
    extends StObject
       with BsonType
       with typingsJapgolly.meteor.mongoMod.Mongo.BsonType
  ...
  @js.native
  sealed trait awaitData extends StObject
  ...
  sealed trait connected
    extends StObject
       with Status
       with typingsJapgolly.meteor.ddpMod.DDP.Status
  ...
  @js.native
  sealed trait exhaust extends StObject
  ...
  @js.native
  sealed trait forwardAndReverse extends StObject
  ...
  @js.native
  sealed trait linearizable extends StObject
  ...
  @js.native
  sealed trait loggingIn extends StObject
  inline def loggingIn: loggingIn = "loggingIn".asInstanceOf[loggingIn]
  
  @js.native
  sealed trait loggingOut extends StObject
  inline def loggingOut: loggingOut = "loggingOut".asInstanceOf[loggingOut]
  ...
  @js.native
  sealed trait noCursorTimeout extends StObject
  ...
  @js.native
  sealed trait oplogReplay extends StObject
  ...
  @js.native
  sealed trait primaryPreferred extends StObject
  ...
  @js.native
  sealed trait secondaryPreferred extends StObject
  ...
  @js.native
  sealed trait slow_only extends StObject
  ...
  @js.native
  sealed trait tailable extends StObject
  ...
  inline def webDotbrowser: webDotbrowser = "web.browser".asInstanceOf[webDotbrowser]
  
  @js.native
  sealed trait webDotbrowserDotlegacy extends StObject
  inline def webDotbrowserDotlegacy: webDotbrowserDotlegacy = "web.browser.legacy".asInstanceOf[webDotbrowserDotlegacy]
  
  @js.native
  sealed trait webDotcordova extends StObject
  inline def webDotcordova: webDotcordova = "web.cordova".asInstanceOf[webDotcordova]
}
