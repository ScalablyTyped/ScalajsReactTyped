...
trait NoRetry[Result /* <: EJSONable | (js.Array[EJSONable | EJSONableProperty]) | EJSONableProperty */] extends StObject {
  ...
  var onResultReceived: js.UndefOr[
    js.Function2[
      /* error */ js.UndefOr[js.Error | typingsJapgolly.meteor.meteorMod.Meteor.Error], 
...
object NoRetry {
  ...
  extension [Self <: NoRetry[?], Result /* <: EJSONable | (js.Array[EJSONable | EJSONableProperty]) | EJSONableProperty */](x: Self & NoRetry[Result]) {
    ...
    inline def setOnResultReceived(
      value: (/* error */ js.UndefOr[js.Error | typingsJapgolly.meteor.meteorMod.Meteor.Error], /* result */ js.UndefOr[Result]) => Callback
    ): Self = StObject.set(x, "onResultReceived", js.Any.fromFunction2((t0: /* error */ js.UndefOr[js.Error | typingsJapgolly.meteor.meteorMod.Meteor.Error], t1: /* result */ js.UndefOr[Result]) => (value(t0, t1)).runNow()))
