...
trait AddToSet[T] extends StObject {
  ...
  var $unset: js.UndefOr[
    (PartialMapTo[T, String | Boolean | `1` | typingsJapgolly.meteor.meteorInts.`0`]) & Dictionary[Any]
  ] = js.undefined
}
object AddToSet {
  ...
  extension [Self <: AddToSet[?], T](x: Self & AddToSet[T]) {
    ...
    inline def set$unset(
      value: (PartialMapTo[T, String | Boolean | `1` | typingsJapgolly.meteor.meteorInts.`0`]) & Dictionary[Any]
