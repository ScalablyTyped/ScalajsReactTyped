...
object LoginMethodOptions {
  ...
  def apply(
    ...
    userCallback: /* err */ js.UndefOr[js.Any] => Callback = null,
    ...
    if (userCallback != null) __obj.updateDynamic("userCallback")(js.Any.fromFunction1((t0: /* err */ js.UndefOr[js.Any]) => userCallback(t0).runNow()))
