...
import typingsJapgolly.meteor.Blaze.TemplateStatic
import typingsJapgolly.meteor.Blaze.View
import typingsJapgolly.meteor.Blaze.ViewStatic
...
object Blaze {
  ...
  @js.native
  def Template: TemplateStatic[Any, typingsJapgolly.meteor.Blaze.TemplateInstance[Any]] = js.native
  ...
  open class TemplateCls ()
    extends StObject
       with typingsJapgolly.meteor.Blaze.Template[Any, typingsJapgolly.meteor.Blaze.TemplateInstance[Any]] {
    ...
    /* CompleteClass */
    override def events(eventsMap: EventsMap[Any, typingsJapgolly.meteor.Blaze.TemplateInstance[Any]]): Unit = js.native
    ...
    /* CompleteClass */
    var head: typingsJapgolly.meteor.Blaze.Template[Any, typingsJapgolly.meteor.Blaze.TemplateInstance[Any]] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def onCreated(callback: js.ThisFunction0[typingsJapgolly.meteor.Blaze.TemplateInstance[Any], Any]): Unit = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def onDestroyed(callback: js.ThisFunction0[typingsJapgolly.meteor.Blaze.TemplateInstance[Any], Any]): Unit = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def onRendered(callback: js.ThisFunction0[typingsJapgolly.meteor.Blaze.TemplateInstance[Any], Any]): Unit = js.native
  ...
  open class TemplateInstance[D] protected ()
    extends StObject
       with typingsJapgolly.meteor.Blaze.TemplateInstance[D] {
  ...
  inline def Template_=(x: TemplateStatic[Any, typingsJapgolly.meteor.Blaze.TemplateInstance[Any]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Template")(x.asInstanceOf[js.Any])
  ...
  open class ViewCls ()
    ...
    /* CompleteClass */
    var template: typingsJapgolly.meteor.Blaze.Template[Any, typingsJapgolly.meteor.Blaze.TemplateInstance[Any]] = js.native
    
    /* CompleteClass */
    override def templateInstance(): typingsJapgolly.meteor.Blaze.TemplateInstance[Any] = js.native
  }
  ...
  inline def render(
    templateOrView: typingsJapgolly.meteor.Blaze.Template[Any, typingsJapgolly.meteor.Blaze.TemplateInstance[Any]],
    parentNode: Node
  ...
  inline def toHTML(
    templateOrView: typingsJapgolly.meteor.Blaze.Template[Any, typingsJapgolly.meteor.Blaze.TemplateInstance[Any]]
  ): String = ^.asInstanceOf[js.Dynamic].applyDynamic("toHTML")(templateOrView.asInstanceOf[js.Any]).asInstanceOf[String]
