...
import typingsJapgolly.meteor.Meteor.ErrorStatic
import typingsJapgolly.meteor.Meteor.LoginWithExternalServiceOptions
import typingsJapgolly.meteor.Meteor.MethodThisType
import typingsJapgolly.meteor.Meteor.Settings
import typingsJapgolly.meteor.Meteor.SubscriptionHandle
import typingsJapgolly.meteor.Meteor.TypedError
import typingsJapgolly.meteor.Meteor.TypedErrorStatic
import typingsJapgolly.meteor.Meteor.User
import typingsJapgolly.meteor.Meteor.absoluteUrlOptions
import typingsJapgolly.meteor.Mongo.Collection
import typingsJapgolly.meteor.Subscription
import typingsJapgolly.meteor.anon.Fields
import typingsJapgolly.meteor.anon.Isauto
import typingsJapgolly.meteor.anon.LoginStyle
import typingsJapgolly.meteor.anon.OnResultReceived
...
object Meteor {
  ...
  open class EnvironmentVariable[T] ()
    extends StObject
       with typingsJapgolly.meteor.Meteor.EnvironmentVariable[T] {
