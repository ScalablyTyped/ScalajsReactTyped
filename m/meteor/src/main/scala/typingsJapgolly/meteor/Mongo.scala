...
import typingsJapgolly.meteor.anon.CurrentDate
import typingsJapgolly.meteor.anon.Id
import typingsJapgolly.meteor.anon.IdGeneration
import typingsJapgolly.meteor.anon.Insert
...
import typingsJapgolly.meteor.anon.Nor
...
object Mongo {
  ...
  */
  ...
  object ObjectID {
    ...
    inline def apply(equals_ : ObjectID => Boolean, toHexString: CallbackTo[String]): ObjectID = {
  ...
  object ObserveCallbacks {
    ...
    extension [Self <: ObserveCallbacks[?], T](x: Self & ObserveCallbacks[T]) {
      ...
      inline def setAdded(value: /* document */ T => japgolly.scalajs.react.Callback): Self = StObject.set(x, "added", js.Any.fromFunction1((t0: /* document */ T) => value(t0).runNow()))
      
      inline def setAddedAt(
        value: (/* document */ T, /* atIndex */ Double, /* before */ T | Null) => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "addedAt", js.Any.fromFunction3((t0: /* document */ T, t1: /* atIndex */ Double, t2: /* before */ T | Null) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setChanged(value: (/* newDocument */ T, /* oldDocument */ T) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "changed", js.Any.fromFunction2((t0: /* newDocument */ T, t1: /* oldDocument */ T) => (value(t0, t1)).runNow()))
      
      inline def setChangedAt(
        value: (/* newDocument */ T, /* oldDocument */ T, /* indexAt */ Double) => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "changedAt", js.Any.fromFunction3((t0: /* newDocument */ T, t1: /* oldDocument */ T, t2: /* indexAt */ Double) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setMovedTo(
        value: (/* document */ T, /* fromIndex */ Double, /* toIndex */ Double, /* before */ T | Null) => japgolly.scalajs.react.Callback
      ...
      inline def setRemoved(value: /* oldDocument */ T => japgolly.scalajs.react.Callback): Self = StObject.set(x, "removed", js.Any.fromFunction1((t0: /* oldDocument */ T) => value(t0).runNow()))
      
      inline def setRemovedAt(value: (/* oldDocument */ T, /* atIndex */ Double) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "removedAt", js.Any.fromFunction2((t0: /* oldDocument */ T, t1: /* atIndex */ Double) => (value(t0, t1)).runNow()))
  ...
  object ObserveChangesCallbacks {
    ...
    extension [Self <: ObserveChangesCallbacks[?], T](x: Self & ObserveChangesCallbacks[T]) {
      ...
      inline def setAdded(value: (/* id */ String, /* fields */ Partial[T]) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "added", js.Any.fromFunction2((t0: /* id */ String, t1: /* fields */ Partial[T]) => (value(t0, t1)).runNow()))
      
      inline def setAddedBefore(
        value: (/* id */ String, /* fields */ Partial[T], /* before */ T | Null) => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "addedBefore", js.Any.fromFunction3((t0: /* id */ String, t1: /* fields */ Partial[T], t2: /* before */ T | Null) => (value(t0, t1, t2)).runNow()))
      
      inline def setAddedBeforeUndefined: Self = StObject.set(x, "addedBefore", js.undefined)
      
      inline def setAddedUndefined: Self = StObject.set(x, "added", js.undefined)
      
      inline def setChanged(value: (/* id */ String, /* fields */ Partial[T]) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "changed", js.Any.fromFunction2((t0: /* id */ String, t1: /* fields */ Partial[T]) => (value(t0, t1)).runNow()))
      
      inline def setChangedUndefined: Self = StObject.set(x, "changed", js.undefined)
      
      inline def setMovedBefore(value: (/* id */ String, /* before */ T | Null) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "movedBefore", js.Any.fromFunction2((t0: /* id */ String, t1: /* before */ T | Null) => (value(t0, t1)).runNow()))
      
      inline def setMovedBeforeUndefined: Self = StObject.set(x, "movedBefore", js.undefined)
      
      inline def setRemoved(value: /* id */ String => japgolly.scalajs.react.Callback): Self = StObject.set(x, "removed", js.Any.fromFunction1((t0: /* id */ String) => value(t0).runNow()))
