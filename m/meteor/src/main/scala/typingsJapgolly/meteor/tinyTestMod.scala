...
object tinyTestMod {
  ...
  object Tinytest {
    ...
    inline def add(
      description: String,
      func: js.Function1[/* test */ typingsJapgolly.meteor.tinyTestMod.ITinytestAssertions, Unit]
  ...
  object ILengthAble {
    ...
    inline def apply(length: Double): typingsJapgolly.meteor.tinyTestMod.ILengthAble = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.meteor.tinyTestMod.ILengthAble]
    }
    
    extension [Self <: typingsJapgolly.meteor.tinyTestMod.ILengthAble](x: Self) {
  ...
  trait ITinytestAssertions extends StObject {
    ...
    def length(obj: typingsJapgolly.meteor.tinyTestMod.ILengthAble, expected_length: Double): Unit = js.native
    def length(obj: typingsJapgolly.meteor.tinyTestMod.ILengthAble, expected_length: Double, msg: String): Unit = js.native
