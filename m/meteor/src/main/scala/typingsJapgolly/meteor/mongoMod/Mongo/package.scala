...
package object Mongo {
  ...
  type Modifier[T] = T | typingsJapgolly.meteor.AnonCurrentDate[T]
  type OnlyArrays[T] = T
  type OnlyElementsOfArrays[T] = typingsJapgolly.std.Partial[
    /* import warning: importer.ImportType#apply Failed type conversion: T[0] */ js.Any
  ]
  type OptionalId[TSchema] = (typingsJapgolly.meteor.mongoMod.UnionOmit[TSchema, typingsJapgolly.meteor.meteorStrings._id]) with typingsJapgolly.meteor.AnonId
  ...
  type Query[T] = typingsJapgolly.meteor.meteorStrings.Query with js.Any with typingsJapgolly.meteor.AnonAnd with typingsJapgolly.meteor.mongoMod.Mongo.Dictionary[_]
  type Selector[T] = typingsJapgolly.meteor.mongoMod.Mongo.Query[T] | typingsJapgolly.meteor.mongoMod.Mongo.QueryWithModifiers[T]
}
