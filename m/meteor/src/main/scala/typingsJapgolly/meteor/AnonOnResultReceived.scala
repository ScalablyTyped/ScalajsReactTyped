...
object AnonOnResultReceived {
  ...
  def apply[Result /* <: EJSONable | (js.Array[EJSONable | EJSONableProperty]) | EJSONableProperty */](
    ...
    if (onResultReceived != null) __obj.updateDynamic("onResultReceived")(js.Any.fromFunction2((t0: /* error */ js.UndefOr[js.Error | typingsJapgolly.meteor.Meteor.Error], t1: /* result */ js.UndefOr[Result]) => onResultReceived(t0, t1).runNow()))
