...
trait InternalDateSource extends StObject {
...
object InternalDateSource {
  
  inline def apply(userId: String): InternalDateSource = {
    val __obj = js.Dynamic.literal(userId = userId.asInstanceOf[js.Any])
    __obj.asInstanceOf[InternalDateSource]
  }
  
  extension [Self <: InternalDateSource](x: Self) {
