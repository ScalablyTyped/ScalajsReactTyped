...
import typingsJapgolly.momentJalaali.mod.momentAugmentingMod.LoadPersianOptions
import typingsJapgolly.momentJalaali.momentJalaaliStrings.`persian-modern`
import typingsJapgolly.momentJalaali.momentJalaaliStrings.persian
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.momentJalaali.momentJalaaliStrings.jYear
      - typingsJapgolly.momentJalaali.momentJalaaliStrings.jMonth
    */
    trait JUnitOfTime extends StObject
    object JUnitOfTime {
      
      inline def jMonth: typingsJapgolly.momentJalaali.momentJalaaliStrings.jMonth = "jMonth".asInstanceOf[typingsJapgolly.momentJalaali.momentJalaaliStrings.jMonth]
      
      inline def jYear: typingsJapgolly.momentJalaali.momentJalaaliStrings.jYear = "jYear".asInstanceOf[typingsJapgolly.momentJalaali.momentJalaaliStrings.jYear]
    }
    ...
    trait Moment extends StObject {
      ...
      def add(amount: String, jUnitOfTime: JUnitOfTime): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      def add(amount: Double, jUnitOfTime: JUnitOfTime): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def endOf(jUnitOfTime: JUnitOfTime): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jDate(): Double = js.native
      def jDate(d: Double): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jDayOfYear(): Double = js.native
      def jDayOfYear(d: Double): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jMonth(): Double = js.native
      def jMonth(M: String): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      def jMonth(M: Double): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jWeek(): Double = js.native
      def jWeek(d: Double): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jWeekYear(): Double = js.native
      def jWeekYear(d: Double): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def jYear(): Double = js.native
      def jYear(y: Double): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def startOf(jUnitOfTime: JUnitOfTime): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      
      def subtract(amount: String, jUnitOfTime: JUnitOfTime): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
      def subtract(amount: Double, jUnitOfTime: JUnitOfTime): typingsJapgolly.momentJalaali.mod.momentAugmentingMod.Moment = js.native
    }
  }
