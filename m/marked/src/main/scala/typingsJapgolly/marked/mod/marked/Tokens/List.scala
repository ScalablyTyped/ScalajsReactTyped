...
import typingsJapgolly.marked.markedStrings.list
...
object List {
  ...
  inline def apply(items: js.Array[ListItem], loose: Boolean, ordered: Boolean, raw: String, start: Double | _empty): typingsJapgolly.marked.mod.marked.Tokens.List = {
  ...
  extension [Self <: typingsJapgolly.marked.mod.marked.Tokens.List](x: Self) {
