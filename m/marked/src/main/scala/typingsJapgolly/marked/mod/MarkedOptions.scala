...
object MarkedOptions {
  ...
  def apply(
    ...
    highlight: (/* code */ String, /* lang */ String, /* callback */ js.UndefOr[js.Function2[/* error */ js.UndefOr[js.Any], /* code */ String, Unit]]) => CallbackTo[String] = null,
    ...
    sanitizer: /* html */ String => CallbackTo[String] = null,
    ...
    if (highlight != null) __obj.updateDynamic("highlight")(js.Any.fromFunction3((t0: /* code */ java.lang.String, t1: /* lang */ java.lang.String, t2: /* callback */ js.UndefOr[
  js.Function2[/* error */ js.UndefOr[js.Any], /* code */ java.lang.String, scala.Unit]]) => highlight(t0, t1, t2).runNow()))
    ...
    if (sanitizer != null) __obj.updateDynamic("sanitizer")(js.Any.fromFunction1((t0: /* html */ java.lang.String) => sanitizer(t0).runNow()))
