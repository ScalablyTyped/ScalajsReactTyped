package typingsJapgolly.maximMazurokGapiClientProdTtSasportal

import typingsJapgolly.maximMazurokGapiClientProdTtSasportal.gapi.client.prodTtSasportal.CustomersResource
import typingsJapgolly.maximMazurokGapiClientProdTtSasportal.gapi.client.prodTtSasportal.DeploymentsResource
import typingsJapgolly.maximMazurokGapiClientProdTtSasportal.gapi.client.prodTtSasportal.InstallerResource
import typingsJapgolly.maximMazurokGapiClientProdTtSasportal.gapi.client.prodTtSasportal.NodesResource
import typingsJapgolly.maximMazurokGapiClientProdTtSasportal.gapi.client.prodTtSasportal.PoliciesResource
import typingsJapgolly.maximMazurokGapiClientProdTtSasportal.maximMazurokGapiClientProdTtSasportalStrings.prod_tt_sasportal
import typingsJapgolly.maximMazurokGapiClientProdTtSasportal.maximMazurokGapiClientProdTtSasportalStrings.v1alpha1
