package typingsJapgolly.momentPreciseRangePlugin
...
import typingsJapgolly.momentPreciseRangePlugin.mod.momentAugmentingMod.PreciseRangeValueObject
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    inline def preciseDiff_false(
      d1: typingsJapgolly.momentPreciseRangePlugin.mod.momentAugmentingMod.Moment,
      d2: typingsJapgolly.momentPreciseRangePlugin.mod.momentAugmentingMod.Moment,
    ...
    trait Moment extends StObject {
      ...
      def preciseDiff(d2: typingsJapgolly.momentPreciseRangePlugin.mod.momentAugmentingMod.Moment): String = js.native
      @JSName("preciseDiff")
