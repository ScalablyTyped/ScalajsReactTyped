...
object FACE_GEOMETRY {
  ...
  @js.native
  def Layout: typingsJapgolly.mediapipeFaceMesh.mod.Layout = js.native
  ...
  @js.native
  def PrimitiveType: typingsJapgolly.mediapipeFaceMesh.mod.PrimitiveType = js.native
  ...
  @js.native
  def VertexType: typingsJapgolly.mediapipeFaceMesh.mod.VertexType = js.native
