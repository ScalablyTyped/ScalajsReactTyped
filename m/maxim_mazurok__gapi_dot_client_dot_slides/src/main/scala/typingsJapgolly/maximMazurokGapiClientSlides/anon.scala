package typingsJapgolly.maximMazurokGapiClientSlides

import typingsJapgolly.maximMazurokGapiClientSlides.gapi.client.slides.BatchUpdatePresentationRequest
import typingsJapgolly.maximMazurokGapiClientSlides.gapi.client.slides.Presentation
