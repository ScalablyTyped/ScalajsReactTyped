...
import typingsJapgolly.maximMazurokGapiClientSlides.anon.Callback
import typingsJapgolly.maximMazurokGapiClientSlides.anon.Fields
import typingsJapgolly.maximMazurokGapiClientSlides.anon.Key
import typingsJapgolly.maximMazurokGapiClientSlides.anon.Oauthtoken
...
trait PresentationsResource extends StObject {
  ...
  /**
    ...
    */
  def batchUpdate(request: Callback): typingsJapgolly.gapiClient.gapi.client.Request[BatchUpdatePresentationResponse] = js.native
  def batchUpdate(request: Fields, body: BatchUpdatePresentationRequest): typingsJapgolly.gapiClient.gapi.client.Request[BatchUpdatePresentationResponse] = js.native
  ...
  /**
    ...
    */
  def create(request: Key): typingsJapgolly.gapiClient.gapi.client.Request[Presentation] = js.native
  def create(request: Oauthtoken, body: Presentation): typingsJapgolly.gapiClient.gapi.client.Request[Presentation] = js.native
  
  /** Gets the latest version of the specified presentation. */
  def get(): typingsJapgolly.gapiClient.gapi.client.Request[Presentation] = js.native
  def get(request: Fields): typingsJapgolly.gapiClient.gapi.client.Request[Presentation] = js.native
