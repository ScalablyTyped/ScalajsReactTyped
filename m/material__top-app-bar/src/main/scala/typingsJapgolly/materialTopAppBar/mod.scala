...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialTopAppBar.standardFoundationMod.default {
  ...
  open class MDCFixedTopAppBarFoundation ()
    extends typingsJapgolly.materialTopAppBar.fixedFoundationMod.MDCFixedTopAppBarFoundation {
    def this(adapter: PartialMDCTopAppBarAdapte) = this()
  }
  ...
  open class MDCShortTopAppBarFoundation ()
    extends typingsJapgolly.materialTopAppBar.shortFoundationMod.MDCShortTopAppBarFoundation {
    def this(adapter: PartialMDCTopAppBarAdapte) = this()
  }
  ...
  open class MDCTopAppBar protected ()
    extends typingsJapgolly.materialTopAppBar.componentMod.MDCTopAppBar {
  ...
  open class MDCTopAppBarBaseFoundation ()
    extends typingsJapgolly.materialTopAppBar.foundationMod.MDCTopAppBarBaseFoundation {
    def this(adapter: PartialMDCTopAppBarAdapte) = this()
  }
  ...
  open class MDCTopAppBarFoundation ()
    extends typingsJapgolly.materialTopAppBar.standardFoundationMod.MDCTopAppBarFoundation {
    def this(adapter: PartialMDCTopAppBarAdapte) = this()
  }
