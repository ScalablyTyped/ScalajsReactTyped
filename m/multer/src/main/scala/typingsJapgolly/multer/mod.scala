...
import typingsJapgolly.multer.anon.FieldNameSize
import typingsJapgolly.multer.anon.PartialFile
...
object mod {
    ...
    extension [Self <: DiskStorageOptions](x: Self) {
      ...
      inline def setDestinationFunction3(
        value: (/* req */ Request_[
              ...
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], /* file */ File, /* callback */ js.Function2[/* error */ js.Error | Null, /* destination */ String, Unit]) => Callback
      ): Self = StObject.set(x, "destination", js.Any.fromFunction3((t0: /* req */ Request_[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
              Any, 
              Any, 
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t1: /* file */ File, t2: /* callback */ js.Function2[/* error */ js.Error | Null, /* destination */ String, Unit]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setFilename(
        value: (/* req */ Request_[
              ...
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], /* file */ File, /* callback */ js.Function2[/* error */ js.Error | Null, /* filename */ String, Unit]) => Callback
      ): Self = StObject.set(x, "filename", js.Any.fromFunction3((t0: /* req */ Request_[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
              Any, 
              Any, 
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t1: /* file */ File, t2: /* callback */ js.Function2[/* error */ js.Error | Null, /* filename */ String, Unit]) => (value(t0, t1, t2)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.multer.multerStrings.LIMIT_PART_COUNT
    - typingsJapgolly.multer.multerStrings.LIMIT_FILE_SIZE
    - typingsJapgolly.multer.multerStrings.LIMIT_FILE_COUNT
    - typingsJapgolly.multer.multerStrings.LIMIT_FIELD_KEY
    - typingsJapgolly.multer.multerStrings.LIMIT_FIELD_VALUE
    - typingsJapgolly.multer.multerStrings.LIMIT_FIELD_COUNT
    - typingsJapgolly.multer.multerStrings.LIMIT_UNEXPECTED_FILE
  */
  trait ErrorCode extends StObject
  object ErrorCode {
    
    inline def LIMIT_FIELD_COUNT: typingsJapgolly.multer.multerStrings.LIMIT_FIELD_COUNT = "LIMIT_FIELD_COUNT".asInstanceOf[typingsJapgolly.multer.multerStrings.LIMIT_FIELD_COUNT]
    
    inline def LIMIT_FIELD_KEY: typingsJapgolly.multer.multerStrings.LIMIT_FIELD_KEY = "LIMIT_FIELD_KEY".asInstanceOf[typingsJapgolly.multer.multerStrings.LIMIT_FIELD_KEY]
    
    inline def LIMIT_FIELD_VALUE: typingsJapgolly.multer.multerStrings.LIMIT_FIELD_VALUE = "LIMIT_FIELD_VALUE".asInstanceOf[typingsJapgolly.multer.multerStrings.LIMIT_FIELD_VALUE]
    
    inline def LIMIT_FILE_COUNT: typingsJapgolly.multer.multerStrings.LIMIT_FILE_COUNT = "LIMIT_FILE_COUNT".asInstanceOf[typingsJapgolly.multer.multerStrings.LIMIT_FILE_COUNT]
    
    inline def LIMIT_FILE_SIZE: typingsJapgolly.multer.multerStrings.LIMIT_FILE_SIZE = "LIMIT_FILE_SIZE".asInstanceOf[typingsJapgolly.multer.multerStrings.LIMIT_FILE_SIZE]
    
    inline def LIMIT_PART_COUNT: typingsJapgolly.multer.multerStrings.LIMIT_PART_COUNT = "LIMIT_PART_COUNT".asInstanceOf[typingsJapgolly.multer.multerStrings.LIMIT_PART_COUNT]
    
    inline def LIMIT_UNEXPECTED_FILE: typingsJapgolly.multer.multerStrings.LIMIT_UNEXPECTED_FILE = "LIMIT_UNEXPECTED_FILE".asInstanceOf[typingsJapgolly.multer.multerStrings.LIMIT_UNEXPECTED_FILE]
  }
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setFileFilter(
        value: (/* req */ Request_[
              ...
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], /* file */ File, /* callback */ FileFilterCallback) => Callback
              ...
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t1: /* file */ File, t2: /* callback */ FileFilterCallback) => (value(t0, t1, t2)).runNow()))
  ...
  object StorageEngine {
    ...
    inline def apply(
      _handleFile: (Request_[
          ...
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
          Record[String, Any]
        ], File, js.Function2[/* error */ js.UndefOr[Any], /* info */ js.UndefOr[PartialFile], Unit]) => Callback,
      _removeFile: (Request_[
          ...
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
          Record[String, Any]
        ], File, js.Function1[/* error */ js.Error | Null, Unit]) => Callback
    ): StorageEngine = {
      val __obj = js.Dynamic.literal(_handleFile = js.Any.fromFunction3((t0: Request_[
          ...
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
          Record[String, Any]
        ], t1: File, t2: js.Function2[/* error */ js.UndefOr[Any], /* info */ js.UndefOr[PartialFile], Unit]) => (_handleFile(t0, t1, t2)).runNow()), _removeFile = js.Any.fromFunction3((t0: Request_[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
          Any, 
          Any, 
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
          Record[String, Any]
        ], t1: File, t2: js.Function1[/* error */ js.Error | Null, Unit]) => (_removeFile(t0, t1, t2)).runNow()))
    ...
    extension [Self <: StorageEngine](x: Self) {
      ...
      inline def set_handleFile(
        value: (Request_[
              ...
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t1: File, t2: js.Function2[/* error */ js.UndefOr[Any], /* info */ js.UndefOr[PartialFile], Unit]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def set_removeFile(
        value: (Request_[
              ...
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t1: File, t2: js.Function1[/* error */ js.Error | Null, Unit]) => (value(t0, t1, t2)).runNow()))
    }
  }
