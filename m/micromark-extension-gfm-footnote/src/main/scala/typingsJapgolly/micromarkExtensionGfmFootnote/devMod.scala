...
import typingsJapgolly.micromarkExtensionGfmFootnote.devLibHtmlMod.HtmlExtension
import typingsJapgolly.micromarkExtensionGfmFootnote.devLibHtmlMod.Options
import typingsJapgolly.micromarkExtensionGfmFootnote.devLibSyntaxMod.Extension
