...
trait CourseIdEnrollmentCode extends StObject {
...
object CourseIdEnrollmentCode {
  
  inline def apply(courseId: String): CourseIdEnrollmentCode = {
    val __obj = js.Dynamic.literal(courseId = courseId.asInstanceOf[js.Any])
    __obj.asInstanceOf[CourseIdEnrollmentCode]
  }
  
  extension [Self <: CourseIdEnrollmentCode](x: Self) {
