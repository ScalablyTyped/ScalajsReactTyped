...
import typingsJapgolly.maximMazurokGapiClientClassroom.gapi.client.classroom.Student
...
object EnrollmentCode {
  ...
  inline def apply(courseId: String, resource: Student): EnrollmentCode = {
  ...
  extension [Self <: EnrollmentCode](x: Self) {
    ...
    inline def setResource(value: Student): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
