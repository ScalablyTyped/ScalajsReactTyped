...
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.CourseWorkId
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.Late
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.PrettyPrint
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.Resource
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.UpdateMask
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.UploadType
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.Uploadprotocol
