...
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.CallbackCourseId
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.CourseIdFields
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.CourseWorkMaterialStates
...
@js.native
trait CourseWorkMaterialsResource extends StObject {
