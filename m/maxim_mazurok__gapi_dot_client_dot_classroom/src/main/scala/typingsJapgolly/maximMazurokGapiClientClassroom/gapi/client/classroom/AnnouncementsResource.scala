...
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.AnnouncementStates
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.CourseId
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.Fields
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.Id
import typingsJapgolly.maximMazurokGapiClientClassroom.anon.Key
