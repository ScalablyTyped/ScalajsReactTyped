...
import typingsJapgolly.maximMazurokGapiClientRecommender.gapi.client.recommender.GoogleCloudRecommenderV1InsightTypeConfig
import typingsJapgolly.maximMazurokGapiClientRecommender.gapi.client.recommender.GoogleCloudRecommenderV1MarkInsightAcceptedRequest
import typingsJapgolly.maximMazurokGapiClientRecommender.gapi.client.recommender.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest
import typingsJapgolly.maximMazurokGapiClientRecommender.gapi.client.recommender.GoogleCloudRecommenderV1MarkRecommendationFailedRequest
import typingsJapgolly.maximMazurokGapiClientRecommender.gapi.client.recommender.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest
import typingsJapgolly.maximMazurokGapiClientRecommender.gapi.client.recommender.GoogleCloudRecommenderV1RecommenderConfig
...
object anon {
  ...
  object Callback {
    ...
    inline def apply(name: String, resource: GoogleCloudRecommenderV1MarkInsightAcceptedRequest): Callback = {
    ...
    extension [Self <: Callback](x: Self) {
      ...
      inline def setResource(value: GoogleCloudRecommenderV1MarkInsightAcceptedRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Name {
    ...
    extension [Self <: Name](x: Self) {
      ...
      inline def setResource(value: GoogleCloudRecommenderV1MarkRecommendationClaimedRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Oauthtoken {
    ...
    extension [Self <: Oauthtoken](x: Self) {
      ...
      inline def setResource(value: GoogleCloudRecommenderV1MarkRecommendationFailedRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object PrettyPrint {
    ...
    extension [Self <: PrettyPrint](x: Self) {
      ...
      inline def setResource(value: GoogleCloudRecommenderV1MarkRecommendationSucceededRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
