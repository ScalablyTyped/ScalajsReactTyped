package typingsJapgolly.mapboxSphericalmercator

import typingsJapgolly.mapboxSphericalmercator.anon.Antimeridian
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mapboxSphericalmercator.mapboxSphericalmercatorStrings.WGS84
    - typingsJapgolly.mapboxSphericalmercator.mapboxSphericalmercatorStrings.`900913`
  */
  trait Projection extends StObject
  object Projection {
    
    inline def `900913`: typingsJapgolly.mapboxSphericalmercator.mapboxSphericalmercatorStrings.`900913` = "900913".asInstanceOf[typingsJapgolly.mapboxSphericalmercator.mapboxSphericalmercatorStrings.`900913`]
    
    inline def WGS84: typingsJapgolly.mapboxSphericalmercator.mapboxSphericalmercatorStrings.WGS84 = "WGS84".asInstanceOf[typingsJapgolly.mapboxSphericalmercator.mapboxSphericalmercatorStrings.WGS84]
  }
