...
object PartialConfig {
  ...
  def apply(
    ...
    loaded: PartialConfig => Callback = null,
    ...
    if (loaded != null) __obj.updateDynamic("loaded")(js.Any.fromFunction1((t0: typingsJapgolly.mixpanelBrowser.PartialConfig) => loaded(t0).runNow()))
