...
object PartialConfigApihost {
  ...
  def apply(
    ...
    loaded: /* mixpanel */ Mixpanel => Callback = null,
    ...
    if (loaded != null) __obj.updateDynamic("loaded")(js.Any.fromFunction1((t0: /* mixpanel */ typingsJapgolly.mixpanelBrowser.mod.Mixpanel) => loaded(t0).runNow()))
