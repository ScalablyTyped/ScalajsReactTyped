...
import typingsJapgolly.mixpanelBrowser.anon.PartialClearOptOutInOutOp
import typingsJapgolly.mixpanelBrowser.anon.PartialConfig
import typingsJapgolly.mixpanelBrowser.anon.PartialConfigApihost
import typingsJapgolly.mixpanelBrowser.anon.PartialHasOptedInOutOptio
import typingsJapgolly.mixpanelBrowser.anon.PartialInTrackingOptions
import typingsJapgolly.mixpanelBrowser.anon.PartialOutTrackingOptions
import typingsJapgolly.mixpanelBrowser.mixpanelBrowserStrings.sendBeacon
import typingsJapgolly.mixpanelBrowser.mixpanelBrowserStrings.xhr
...
object mod {
  ...
  object Config {
    ...
    inline def apply(
      ...
      ip: Boolean,
      loaded: Mixpanel => japgolly.scalajs.react.Callback,
    ...
    extension [Self <: Config](x: Self) {
      ...
      inline def setLoaded(value: Mixpanel => japgolly.scalajs.react.Callback): Self = StObject.set(x, "loaded", js.Any.fromFunction1((t0: Mixpanel) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mixpanelBrowser.mixpanelBrowserInts.`1`
    - typingsJapgolly.mixpanelBrowser.mixpanelBrowserInts.`0`
  */
  ...
  object NormalResponse {
    ...
    inline def `0`: typingsJapgolly.mixpanelBrowser.mixpanelBrowserInts.`0` = 0.asInstanceOf[typingsJapgolly.mixpanelBrowser.mixpanelBrowserInts.`0`]
    
    inline def `1`: typingsJapgolly.mixpanelBrowser.mixpanelBrowserInts.`1` = 1.asInstanceOf[typingsJapgolly.mixpanelBrowser.mixpanelBrowserInts.`1`]
  }
  ...
  */
  ...
  object Persistence {
    ...
    inline def cookie: typingsJapgolly.mixpanelBrowser.mixpanelBrowserStrings.cookie = "cookie".asInstanceOf[typingsJapgolly.mixpanelBrowser.mixpanelBrowserStrings.cookie]
    
    inline def localStorage: typingsJapgolly.mixpanelBrowser.mixpanelBrowserStrings.localStorage = "localStorage".asInstanceOf[typingsJapgolly.mixpanelBrowser.mixpanelBrowserStrings.localStorage]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mixpanelBrowser.mod.VerboseResponse
    - typingsJapgolly.mixpanelBrowser.mod.NormalResponse
  */
  trait Response extends StObject
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mixpanelBrowser.anon.Error
    - typingsJapgolly.mixpanelBrowser.anon.Status
  */
  ...
  object VerboseResponse {
    ...
    inline def Error(error: Null): typingsJapgolly.mixpanelBrowser.anon.Error = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], status = 1)
      __obj.asInstanceOf[typingsJapgolly.mixpanelBrowser.anon.Error]
    }
    
    inline def Status(error: String): typingsJapgolly.mixpanelBrowser.anon.Status = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], status = 0)
      __obj.asInstanceOf[typingsJapgolly.mixpanelBrowser.anon.Status]
    }
  }
