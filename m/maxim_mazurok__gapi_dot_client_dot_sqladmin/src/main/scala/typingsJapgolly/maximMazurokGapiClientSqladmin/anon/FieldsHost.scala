...
trait FieldsHost extends StObject {
...
object FieldsHost {
  ...
  inline def apply(instance: String, project: String, resource: User): FieldsHost = {
    ...
    __obj.asInstanceOf[FieldsHost]
  }
  
  extension [Self <: FieldsHost](x: Self) {
