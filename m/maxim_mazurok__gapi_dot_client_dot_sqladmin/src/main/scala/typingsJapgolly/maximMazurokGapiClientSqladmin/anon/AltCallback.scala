...
import typingsJapgolly.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.DatabaseInstance
...
object AltCallback {
  ...
  inline def apply(instance: String, project: String, resource: DatabaseInstance): AltCallback = {
