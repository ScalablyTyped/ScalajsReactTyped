...
import typingsJapgolly.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.SqlInstancesRescheduleMaintenanceRequestBody
...
object KeyOauthtoken {
  ...
  inline def apply(instance: String, project: String, resource: SqlInstancesRescheduleMaintenanceRequestBody): KeyOauthtoken = {
