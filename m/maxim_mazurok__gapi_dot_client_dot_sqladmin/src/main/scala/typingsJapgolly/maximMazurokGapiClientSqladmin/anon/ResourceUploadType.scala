...
import typingsJapgolly.maximMazurokGapiClientSqladmin.gapi.client.sqladmin.User
...
object ResourceUploadType {
  ...
  inline def apply(instance: String, project: String, resource: User): ResourceUploadType = {
