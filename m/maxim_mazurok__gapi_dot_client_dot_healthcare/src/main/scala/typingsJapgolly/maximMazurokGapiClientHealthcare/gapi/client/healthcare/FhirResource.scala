...
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.At
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.Callback
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.Count
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.OauthtokenParent
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.Parent
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.ParentPrettyPrint
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.PrettyPrintProfile
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.PrettyPrintQuotaUser
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.Profile
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.QuotaUserResource
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.QuotaUserResourceType
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.ResourceType
...
trait FhirResource extends StObject {
  ...
  def `Resource-purge`(request: Callback): Request[js.Object] = js.native
  
  def `Resource-validate`(request: PrettyPrintProfile, body: HttpBody): Request[HttpBody] = js.native
  /**
    ...
    * instead.
    */
  def `Resource-validate`(request: Profile): Request[HttpBody] = js.native
  ...
  def capabilities(request: Callback): Request[HttpBody] = js.native
  
  def create(request: OauthtokenParent, body: HttpBody): Request[HttpBody] = js.native
  /**
    ...
    */
  def create(request: typingsJapgolly.maximMazurokGapiClientHealthcare.anon.Type): Request[HttpBody] = js.native
  ...
  def delete(request: Callback): Request[HttpBody] = js.native
  ...
  /**
    ...
    */
  def executeBundle(request: ParentPrettyPrint): Request[HttpBody] = js.native
  def executeBundle(request: Parent, body: HttpBody): Request[HttpBody] = js.native
  ...
  def patch(request: Callback, body: HttpBody): Request[HttpBody] = js.native
  /**
    ...
    */
  def patch(request: PrettyPrintQuotaUser): Request[HttpBody] = js.native
  ...
  def read(request: Callback): Request[HttpBody] = js.native
  
  def search(request: Parent, body: SearchResourcesRequest): Request[HttpBody] = js.native
  /**
    ...
    */
  def search(request: QuotaUserResource): Request[HttpBody] = js.native
  
  def `search-type`(request: QuotaUserResourceType, body: SearchResourcesRequest): Request[HttpBody] = js.native
  /**
    * Searches for resources in the given FHIR store according to criteria specified as query parameters. Implements the FHIR standard search interaction
    * ([DSTU2](http://hl7.org/implement/standards/fhir/DSTU2/http.html#search), [STU3](http://hl7.org/implement/standards/fhir/STU3/http.html#search),
    * [R4](http://hl7.org/implement/standards/fhir/R4/http.html#search)) using the search semantics described in the FHIR Search specification
    ...
    * resources](/healthcare/docs/how-tos/fhir-search) and [Advanced FHIR search features](/healthcare/docs/how-tos/fhir-advanced-search).
    */
  def `search-type`(request: ResourceType): Request[HttpBody] = js.native
  
  def update(request: Callback, body: HttpBody): Request[HttpBody] = js.native
  /**
    ...
    */
  def update(request: PrettyPrintQuotaUser): Request[HttpBody] = js.native
  ...
  def vread(request: Callback): Request[HttpBody] = js.native
}
