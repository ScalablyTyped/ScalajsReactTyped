...
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.AltCallback
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.Callback
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.CallbackConsentStore
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.CallbackConsentStoreId
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.CallbackFields
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.ConsentStoreFields
import typingsJapgolly.maximMazurokGapiClientHealthcare.anon.ConsentStoreId
...
trait ConsentStoresResource extends StObject {
  ...
  def checkDataAccess(request: typingsJapgolly.maximMazurokGapiClientHealthcare.anon.ConsentStore): Request[CheckDataAccessResponse] = js.native
