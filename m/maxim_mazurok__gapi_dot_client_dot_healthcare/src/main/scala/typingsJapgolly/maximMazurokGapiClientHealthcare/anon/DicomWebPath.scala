...
trait DicomWebPath extends StObject {
...
object DicomWebPath {
  ...
  inline def apply(dicomWebPath: String, parent: String): DicomWebPath = {
    val __obj = js.Dynamic.literal(dicomWebPath = dicomWebPath.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[DicomWebPath]
  }
  
  extension [Self <: DicomWebPath](x: Self) {
