...
trait CallbackFields extends StObject {
  ...
  /** Request body */
  var resource: typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.ConsentStore
...
object CallbackFields {
  ...
  inline def apply(
    name: String,
    resource: typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.ConsentStore
  ): CallbackFields = {
  ...
  extension [Self <: CallbackFields](x: Self) {
    ...
    inline def setResource(value: typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.ConsentStore): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
