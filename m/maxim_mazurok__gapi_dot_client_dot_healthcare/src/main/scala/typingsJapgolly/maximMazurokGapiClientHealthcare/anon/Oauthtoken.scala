...
import typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.ConsentArtifact
...
object Oauthtoken {
  ...
  inline def apply(parent: String, resource: ConsentArtifact): Oauthtoken = {
  ...
  extension [Self <: Oauthtoken](x: Self) {
    ...
    inline def setResource(value: ConsentArtifact): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
