...
import typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.RejectConsentRequest
...
trait UploadType extends StObject {
  ...
  /** Request body */
  var resource: RejectConsentRequest
...
object UploadType {
  ...
  inline def apply(name: String, resource: RejectConsentRequest): UploadType = {
  ...
  extension [Self <: UploadType](x: Self) {
    ...
    inline def setResource(value: RejectConsentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
