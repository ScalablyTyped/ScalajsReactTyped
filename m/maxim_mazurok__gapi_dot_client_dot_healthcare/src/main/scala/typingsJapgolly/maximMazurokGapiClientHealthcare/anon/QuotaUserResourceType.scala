...
trait QuotaUserResourceType extends StObject {
...
object QuotaUserResourceType {
  
  inline def apply(parent: String, resourceType: String): QuotaUserResourceType = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resourceType = resourceType.asInstanceOf[js.Any])
