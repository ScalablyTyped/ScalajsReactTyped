...
import typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.HttpBody
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait CallbackDicomWebPath extends StObject {
...
object CallbackDicomWebPath {
  
  inline def apply(dicomWebPath: String, parent: String, resource: HttpBody): CallbackDicomWebPath = {
    val __obj = js.Dynamic.literal(dicomWebPath = dicomWebPath.asInstanceOf[js.Any], parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackDicomWebPath]
  }
  
  extension [Self <: CallbackDicomWebPath](x: Self) {
