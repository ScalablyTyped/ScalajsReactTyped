...
import typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.FhirStore
...
object FhirStoreId {
  ...
  inline def apply(parent: String, resource: FhirStore): FhirStoreId = {
  ...
  extension [Self <: FhirStoreId](x: Self) {
    ...
    inline def setResource(value: FhirStore): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
