...
trait CallbackFhirStoreId extends StObject {
...
object CallbackFhirStoreId {
  
  inline def apply(parent: String): CallbackFhirStoreId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any])
    __obj.asInstanceOf[CallbackFhirStoreId]
  }
  
  extension [Self <: CallbackFhirStoreId](x: Self) {
