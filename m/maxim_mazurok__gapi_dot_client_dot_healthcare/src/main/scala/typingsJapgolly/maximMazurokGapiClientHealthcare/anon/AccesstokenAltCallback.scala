...
import typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.IngestMessageRequest
...
object AccesstokenAltCallback {
  ...
  inline def apply(parent: String, resource: IngestMessageRequest): AccesstokenAltCallback = {
