...
import typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.CheckDataAccessRequest
...
trait ConsentStore extends StObject {
  ...
  /** Request body */
  var resource: CheckDataAccessRequest
...
object ConsentStore {
  ...
  inline def apply(consentStore: String, resource: CheckDataAccessRequest): ConsentStore = {
  ...
  extension [Self <: ConsentStore](x: Self) {
    ...
    inline def setResource(value: CheckDataAccessRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
