...
import typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.Hl7V2Store
...
object Hl7V2StoreId {
  ...
  inline def apply(parent: String, resource: Hl7V2Store): Hl7V2StoreId = {
  ...
  extension [Self <: Hl7V2StoreId](x: Self) {
