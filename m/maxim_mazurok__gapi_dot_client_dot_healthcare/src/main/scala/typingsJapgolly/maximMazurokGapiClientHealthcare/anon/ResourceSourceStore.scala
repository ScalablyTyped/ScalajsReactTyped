...
import typingsJapgolly.maximMazurokGapiClientHealthcare.gapi.client.healthcare.DeidentifyFhirStoreRequest
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait ResourceSourceStore extends StObject {
...
object ResourceSourceStore {
  
  inline def apply(resource: DeidentifyFhirStoreRequest, sourceStore: String): ResourceSourceStore = {
    val __obj = js.Dynamic.literal(resource = resource.asInstanceOf[js.Any], sourceStore = sourceStore.asInstanceOf[js.Any])
    __obj.asInstanceOf[ResourceSourceStore]
  }
  
  extension [Self <: ResourceSourceStore](x: Self) {
