...
import typingsJapgolly.mapnik.anon.Areathreshold
import typingsJapgolly.mapnik.anon.Callback
import typingsJapgolly.mapnik.anon.Compression
import typingsJapgolly.mapnik.anon.Filltype
import typingsJapgolly.mapnik.anon.Imageformat
import typingsJapgolly.mapnik.anon.Imagescaling
import typingsJapgolly.mapnik.anon.Upgrade
...
object mod {
  ...
  open class VectorTile protected () extends StObject {
    ...
    def query(longitude: Double, latitude: Double, options: typingsJapgolly.mapnik.anon.Layer): Unit = js.native
    def query(
      longitude: Double,
      latitude: Double,
      options: typingsJapgolly.mapnik.anon.Layer,
      callback: js.Function2[/* err */ js.Error, /* features */ js.Array[Feature], Unit]
    ): Unit = js.native
  }
