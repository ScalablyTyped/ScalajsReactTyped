...
object anon {
  ...
  object Callback {
    ...
    extension [Self <: Callback](x: Self) {
      ...
      inline def setCallback(value: /* err */ js.Error => japgolly.scalajs.react.Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* err */ js.Error) => value(t0).runNow()))
