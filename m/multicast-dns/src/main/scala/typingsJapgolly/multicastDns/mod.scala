...
import typingsJapgolly.dnsPacket.mod.Packet
import typingsJapgolly.dnsPacket.mod.Question
import typingsJapgolly.dnsPacket.mod.RecordType
import typingsJapgolly.multicastDns.multicastDnsBooleans.`false`
import typingsJapgolly.multicastDns.multicastDnsStrings.error
import typingsJapgolly.multicastDns.multicastDnsStrings.message
import typingsJapgolly.multicastDns.multicastDnsStrings.query
import typingsJapgolly.multicastDns.multicastDnsStrings.ready
import typingsJapgolly.multicastDns.multicastDnsStrings.response
import typingsJapgolly.multicastDns.multicastDnsStrings.warning
