...
import typingsJapgolly.mithril.mod.CVnode
import typingsJapgolly.mithril.mod.ClassComponent
...
import typingsJapgolly.mithril.mod.Vnode
import typingsJapgolly.mithril.mod.VnodeDOM
import typingsJapgolly.mithril.mod._ComponentTypes
...
object anon {
  ...
  trait Params extends StObject {
    ...
    var params: typingsJapgolly.mithril.mod.Params
    
    var path: String
  }
  object Params {
    
    inline def apply(params: typingsJapgolly.mithril.mod.Params, path: String): Params = {
    ...
    extension [Self <: Params](x: Self) {
      ...
      inline def setParams(value: typingsJapgolly.mithril.mod.Params): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
