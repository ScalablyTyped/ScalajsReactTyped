...
object RequestOptions {
  ...
  def apply[T](
    ...
    config: (/* xhr */ XMLHttpRequest, RequestOptions[T]) => CallbackTo[XMLHttpRequest | Unit] = null,
    deserialize: /* data */ String => CallbackTo[T] = null,
    extract: (/* xhr */ XMLHttpRequest, RequestOptions[T]) => CallbackTo[T] = null,
    headers: StringDictionary[String] = null,
    method: String = null,
    params: StringDictionary[js.Any] = null,
    password: String = null,
    serialize: /* data */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (config != null) __obj.updateDynamic("config")(js.Any.fromFunction2((t0: /* xhr */ org.scalajs.dom.raw.XMLHttpRequest, t1: typingsJapgolly.mithril.mod.RequestOptions[T]) => config(t0, t1).runNow()))
    if (deserialize != null) __obj.updateDynamic("deserialize")(js.Any.fromFunction1((t0: /* data */ java.lang.String) => deserialize(t0).runNow()))
    if (extract != null) __obj.updateDynamic("extract")(js.Any.fromFunction2((t0: /* xhr */ org.scalajs.dom.raw.XMLHttpRequest, t1: typingsJapgolly.mithril.mod.RequestOptions[T]) => extract(t0, t1).runNow()))
    if (headers != null) __obj.updateDynamic("headers")(headers.asInstanceOf[js.Any])
    if (method != null) __obj.updateDynamic("method")(method.asInstanceOf[js.Any])
    if (params != null) __obj.updateDynamic("params")(params.asInstanceOf[js.Any])
    if (password != null) __obj.updateDynamic("password")(password.asInstanceOf[js.Any])
    if (serialize != null) __obj.updateDynamic("serialize")(js.Any.fromFunction1((t0: /* data */ js.Any) => serialize(t0).runNow()))
