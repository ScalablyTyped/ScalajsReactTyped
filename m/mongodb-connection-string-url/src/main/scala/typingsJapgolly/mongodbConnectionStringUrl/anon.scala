...
import typingsJapgolly.mongodbConnectionStringUrl.libMod.ConnectionString
import typingsJapgolly.mongodbConnectionStringUrl.libMod.ConnectionStringParsingOptions
import typingsJapgolly.mongodbConnectionStringUrl.libRedactMod.ConnectionStringRedactionOptions
import typingsJapgolly.mongodbConnectionStringUrl.mongodbConnectionStringUrlStrings.URLSearchParams
...
object anon {
  ...
  trait Readonlydefault extends StObject {
    ...
    def searchParams(): typingsJapgolly.whatwgUrl.mod.URLSearchParams = js.native
