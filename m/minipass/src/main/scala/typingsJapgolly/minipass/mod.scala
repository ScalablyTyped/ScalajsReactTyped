...
import typingsJapgolly.minipass.minipassBooleans.`true`
import typingsJapgolly.minipass.minipassStrings.buffer
import typingsJapgolly.minipass.minipassStrings.close
import typingsJapgolly.minipass.minipassStrings.data
import typingsJapgolly.minipass.minipassStrings.drain
import typingsJapgolly.minipass.minipassStrings.end
import typingsJapgolly.minipass.minipassStrings.error
import typingsJapgolly.minipass.minipassStrings.finish
import typingsJapgolly.minipass.minipassStrings.prefinish
import typingsJapgolly.minipass.minipassStrings.resume
...
object mod {
  ...
  trait Minipass[RType /* <: Any */, WType /* <: Any */]
    ...
    def on(
      event: typingsJapgolly.minipass.minipassStrings.readable | drain | resume | end | prefinish | finish | close,
