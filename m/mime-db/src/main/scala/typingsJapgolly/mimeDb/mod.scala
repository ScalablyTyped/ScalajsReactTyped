...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mimeDb.mimeDbStrings.iana
    - typingsJapgolly.mimeDb.mimeDbStrings.apache
    - typingsJapgolly.mimeDb.mimeDbStrings.nginx
  */
  trait MimeSource extends StObject
  object MimeSource {
    
    inline def apache: typingsJapgolly.mimeDb.mimeDbStrings.apache = "apache".asInstanceOf[typingsJapgolly.mimeDb.mimeDbStrings.apache]
    
    inline def iana: typingsJapgolly.mimeDb.mimeDbStrings.iana = "iana".asInstanceOf[typingsJapgolly.mimeDb.mimeDbStrings.iana]
    
    inline def nginx: typingsJapgolly.mimeDb.mimeDbStrings.nginx = "nginx".asInstanceOf[typingsJapgolly.mimeDb.mimeDbStrings.nginx]
  }
