...
import typingsJapgolly.maximMazurokGapiClientDlp.anon.KeyOauthtoken
import typingsJapgolly.maximMazurokGapiClientDlp.anon.OauthtokenParent
import typingsJapgolly.maximMazurokGapiClientDlp.anon.ParentPrettyPrint
...
trait ContentResource extends StObject {
  ...
  /**
    ...
    */
  def deidentify(request: KeyOauthtoken): Request[GooglePrivacyDlpV2DeidentifyContentResponse] = js.native
  ...
  /**
    ...
    */
  def inspect(request: OauthtokenParent): Request[GooglePrivacyDlpV2InspectContentResponse] = js.native
  ...
  def reidentify(request: ParentPrettyPrint): Request[GooglePrivacyDlpV2ReidentifyContentResponse] = js.native
}
