...
import typingsJapgolly.maximMazurokGapiClientDlp.anon.AccesstokenAlt
import typingsJapgolly.maximMazurokGapiClientDlp.anon.AltCallback
...
import typingsJapgolly.maximMazurokGapiClientDlp.anon.Uploadprotocol
import typingsJapgolly.maximMazurokGapiClientDlp.anon.Xgafv
