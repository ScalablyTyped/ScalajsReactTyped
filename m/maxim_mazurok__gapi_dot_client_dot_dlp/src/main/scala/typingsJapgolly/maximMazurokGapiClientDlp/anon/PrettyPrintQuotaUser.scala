...
import typingsJapgolly.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2RedactImageRequest
...
trait PrettyPrintQuotaUser extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2RedactImageRequest
...
object PrettyPrintQuotaUser {
  ...
  inline def apply(parent: String, resource: GooglePrivacyDlpV2RedactImageRequest): PrettyPrintQuotaUser = {
  ...
  extension [Self <: PrettyPrintQuotaUser](x: Self) {
    ...
    inline def setResource(value: GooglePrivacyDlpV2RedactImageRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
