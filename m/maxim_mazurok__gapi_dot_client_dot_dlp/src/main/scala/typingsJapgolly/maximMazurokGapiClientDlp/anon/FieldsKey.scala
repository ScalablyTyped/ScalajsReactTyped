...
import typingsJapgolly.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2UpdateStoredInfoTypeRequest
...
object FieldsKey {
  ...
  inline def apply(name: String, resource: GooglePrivacyDlpV2UpdateStoredInfoTypeRequest): FieldsKey = {
