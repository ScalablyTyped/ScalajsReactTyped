...
import typingsJapgolly.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2CreateDlpJobRequest
...
object Parent {
  ...
  inline def apply(parent: String, resource: GooglePrivacyDlpV2CreateDlpJobRequest): Parent = {
