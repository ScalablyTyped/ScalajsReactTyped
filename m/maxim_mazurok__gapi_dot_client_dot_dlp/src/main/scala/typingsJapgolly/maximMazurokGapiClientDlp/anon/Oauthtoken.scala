...
import typingsJapgolly.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2CreateInspectTemplateRequest
...
trait Oauthtoken extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2CreateInspectTemplateRequest
...
object Oauthtoken {
  ...
  inline def apply(parent: String, resource: GooglePrivacyDlpV2CreateInspectTemplateRequest): Oauthtoken = {
  ...
  extension [Self <: Oauthtoken](x: Self) {
    ...
    inline def setResource(value: GooglePrivacyDlpV2CreateInspectTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
