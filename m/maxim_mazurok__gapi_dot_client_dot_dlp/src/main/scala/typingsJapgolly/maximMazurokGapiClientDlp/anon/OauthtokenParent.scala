...
import typingsJapgolly.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2InspectContentRequest
...
trait OauthtokenParent extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2InspectContentRequest
...
object OauthtokenParent {
  ...
  inline def apply(parent: String, resource: GooglePrivacyDlpV2InspectContentRequest): OauthtokenParent = {
  ...
  extension [Self <: OauthtokenParent](x: Self) {
    ...
    inline def setResource(value: GooglePrivacyDlpV2InspectContentRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
