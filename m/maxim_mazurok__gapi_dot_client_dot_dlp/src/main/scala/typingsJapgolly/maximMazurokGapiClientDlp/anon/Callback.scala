package typingsJapgolly.maximMazurokGapiClientDlp.anon

import typingsJapgolly.maximMazurokGapiClientDlp.gapi.client.dlp.GooglePrivacyDlpV2CreateDeidentifyTemplateRequest
...
trait Callback extends StObject {
  ...
  /** Request body */
  var resource: GooglePrivacyDlpV2CreateDeidentifyTemplateRequest
...
object Callback {
  ...
  inline def apply(parent: String, resource: GooglePrivacyDlpV2CreateDeidentifyTemplateRequest): Callback = {
  ...
  extension [Self <: Callback](x: Self) {
    ...
    inline def setResource(value: GooglePrivacyDlpV2CreateDeidentifyTemplateRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
