...
object select {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialSelect.mod.default {
  ...
  open class MDCSelectHelperText protected ()
    extends typingsJapgolly.materialSelect.mod.MDCSelectHelperText {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
  ...
  open class MDCSelectHelperTextFoundation ()
    extends typingsJapgolly.materialSelect.mod.MDCSelectHelperTextFoundation {
  ...
  open class MDCSelectIcon protected ()
    extends typingsJapgolly.materialSelect.mod.MDCSelectIcon {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
  ...
  open class MDCSelectIconFoundation ()
    extends typingsJapgolly.materialSelect.mod.MDCSelectIconFoundation {
    def this(adapter: PartialMDCSelectIconAdapt) = this()
  }
