...
object textField {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialTextfield.mod.default {
  ...
  open class MDCTextFieldCharacterCounter protected ()
    extends typingsJapgolly.materialTextfield.mod.MDCTextFieldCharacterCounter {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
  ...
  open class MDCTextFieldCharacterCounterFoundation ()
    extends typingsJapgolly.materialTextfield.mod.MDCTextFieldCharacterCounterFoundation {
