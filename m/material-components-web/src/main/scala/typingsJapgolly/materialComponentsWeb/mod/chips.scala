...
object chips {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialChips.deprecatedMod.default {
  ...
  open class MDCChip protected ()
    extends typingsJapgolly.materialChips.deprecatedMod.MDCChip {
  ...
  open class MDCChipFoundation ()
    extends typingsJapgolly.materialChips.deprecatedMod.MDCChipFoundation {
  ...
  open class MDCChipSet protected ()
    extends typingsJapgolly.materialChips.deprecatedMod.MDCChipSet {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
  ...
  open class MDCChipSetFoundation ()
    extends typingsJapgolly.materialChips.deprecatedMod.MDCChipSetFoundation {
    def this(adapter: PartialMDCChipSetAdapterAnnounceMessage) = this()
  }
  ...
  open class MDCChipTrailingAction protected ()
    extends typingsJapgolly.materialChips.deprecatedMod.MDCChipTrailingAction {
    def this(root: Element, foundation: Unit, args: Any*) = this()
    def this(
      root: Element,
  ...
  open class MDCChipTrailingActionFoundation ()
    extends typingsJapgolly.materialChips.deprecatedMod.MDCChipTrailingActionFoundation {
