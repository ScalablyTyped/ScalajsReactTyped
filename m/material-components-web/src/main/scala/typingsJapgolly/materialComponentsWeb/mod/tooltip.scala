...
object tooltip {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.materialTooltip.mod.default {
  ...
  open class MDCTooltip protected ()
    extends typingsJapgolly.materialTooltip.mod.MDCTooltip {
  ...
  open class MDCTooltipFoundation ()
    extends typingsJapgolly.materialTooltip.mod.MDCTooltipFoundation {
    def this(adapter: PartialMDCTooltipAdapter) = this()
  }
