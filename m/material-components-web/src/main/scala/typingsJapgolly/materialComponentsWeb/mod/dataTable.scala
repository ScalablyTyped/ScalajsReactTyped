...
import typingsJapgolly.materialDataTable.PartialMDCDataTableAdapte
...
object dataTable extends js.Object {
  @js.native
  class MDCDataTable ()
    extends typingsJapgolly.materialDataTable.mod.MDCDataTable
  
  @js.native
  class MDCDataTableFoundation ()
    extends typingsJapgolly.materialDataTable.mod.MDCDataTableFoundation {
