...
object dom {
  ...
  object events {
    ...
    @JSImport("material-components-web", "dom.events")
    @js.native
  ...
  object focusTrap {
    ...
    open class FocusTrap protected ()
      extends typingsJapgolly.materialDom.mod.focusTrap.FocusTrap {
  ...
  object keyboard {
    ...
    @JSImport("material-components-web", "dom.keyboard")
    @js.native
    val ^ : js.Any = js.native
    ...
    object KEY {
      ...
      @JSImport("material-components-web", "dom.keyboard.KEY.TAB")
      @js.native
  ...
  object ponyfill {
    ...
    @JSImport("material-components-web", "dom.ponyfill")
    @js.native
    val ^ : js.Any = js.native
