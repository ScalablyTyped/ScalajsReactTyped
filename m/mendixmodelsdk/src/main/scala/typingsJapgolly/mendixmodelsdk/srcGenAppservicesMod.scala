...
object srcGenAppservicesMod {
  ...
  object appservices {
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenAppservicesMod.appservices.IAppServiceAction because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsConsumedAppService, name, parameters */ @JSImport("mendixmodelsdk/src/gen/appservices", "appservices.AppServiceAction")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IAbstractElement because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IElement because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenAppservicesMod.appservices.IAppServiceActionParameter because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsAppServiceAction, name */ @JSImport("mendixmodelsdk/src/gen/appservices", "appservices.AppServiceActionParameter")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenAppservicesMod.appservices.IConsumedAppService because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined actions */ @JSImport("mendixmodelsdk/src/gen/appservices", "appservices.ConsumedAppService")
    @js.native
