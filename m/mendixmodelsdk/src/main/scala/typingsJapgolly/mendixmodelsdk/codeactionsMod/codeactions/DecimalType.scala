...
- typingsJapgolly.mendixmodelsdk.codeactionsMod.codeactions.IDecimalType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/codeactions", "codeactions.DecimalType")
@js.native
