...
import typingsJapgolly.mendixmodelsdk.anon.Copy
...
object srcSdkInternalElementsMod {
  ...
  - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IAbstractElement because var conflicts: container, id, isLoaded, model, structureTypeName, unit. Inlined load, load, load, load, asLoaded, findElementById */ @JSImport("mendixmodelsdk/src/sdk/internal/elements", "AbstractElement")
  @js.native
  ...
  - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IElement because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/sdk/internal/elements", "Element")
  @js.native
