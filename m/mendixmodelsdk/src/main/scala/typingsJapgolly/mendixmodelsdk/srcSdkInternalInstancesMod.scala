...
import typingsJapgolly.mendixmodelsdk.srcSdkInternalUnitsMod.AbstractUnit
...
import typingsJapgolly.mendixmodelsdk.srcSdkInternalVersionChecksMod.LifeCycle
...
object srcSdkInternalInstancesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IElementConstructor
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalUnitsMod.IAbstractUnitConstructor
  */
