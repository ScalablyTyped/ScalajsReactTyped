...
- typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.IEnumerationValueConditionOutcome because var conflicts: containerAsConditionOutcomeActivity, id, isLoaded, model, structureTypeName, unit. Inlined value, valueQualifiedName */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.EnumerationValueConditionOutcome")
@js.native
