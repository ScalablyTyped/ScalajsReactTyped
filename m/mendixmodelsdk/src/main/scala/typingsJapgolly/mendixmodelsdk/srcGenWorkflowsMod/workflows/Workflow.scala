...
- typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.IWorkflow because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined title, contextEntity, contextEntityQualifiedName, parameter, workflowEntity, workflowEntityQualifiedName, workflowType, overviewPage, overviewPageQualifiedName, flow, allowedModuleRoles, allowedModuleRolesQualifiedNames */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.Workflow")
@js.native
