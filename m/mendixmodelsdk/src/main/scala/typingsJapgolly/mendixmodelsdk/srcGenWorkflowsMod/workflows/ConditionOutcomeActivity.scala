...
- typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.IConditionOutcomeActivity because var conflicts: caption, containerAsFlow, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined outcomes */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.ConditionOutcomeActivity")
@js.native
