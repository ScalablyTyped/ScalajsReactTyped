...
- typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.IWorkflowActivity because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsFlow, name, caption */ @JSImport("mendixmodelsdk/src/gen/workflows", "workflows.WorkflowActivity")
@js.native
