...
- typingsJapgolly.mendixmodelsdk.pagesMod.pages.IFormBase because var conflicts: containerAsFolderBase, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/pages", "pages.FormBase")
@js.native
