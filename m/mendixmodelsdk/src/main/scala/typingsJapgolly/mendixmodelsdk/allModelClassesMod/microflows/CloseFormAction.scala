...
class CloseFormAction protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CloseFormAction {
  def this(
    model: AbstractModel,
...
object CloseFormAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CloseFormAction = js.native
  /**
    * Creates and returns a new CloseFormAction instance in the SDK and on the server.
    * The new CloseFormAction will be automatically stored in the 'action' property
    * of the parent ActionActivity element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CloseFormAction = js.native
}
