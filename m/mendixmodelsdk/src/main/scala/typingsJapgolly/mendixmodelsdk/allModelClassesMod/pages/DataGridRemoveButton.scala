...
class DataGridRemoveButton protected ()
  extends typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataGridRemoveButton {
  def this(
    model: AbstractModel,
...
object DataGridRemoveButton extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataGridRemoveButton = js.native
  /**
    * Creates and returns a new DataGridRemoveButton instance in the SDK and on the server.
    * The new DataGridRemoveButton will be automatically stored in the 'items' property
    * of the parent ControlBar element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.pagesMod.pages.ControlBar): typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataGridRemoveButton = js.native
}
