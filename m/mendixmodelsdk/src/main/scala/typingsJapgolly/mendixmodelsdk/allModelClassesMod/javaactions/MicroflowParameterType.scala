...
class MicroflowParameterType protected ()
  extends typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.MicroflowParameterType {
  def this(
    model: AbstractModel,
...
object MicroflowParameterType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.MicroflowParameterType = js.native
  /**
    * Creates and returns a new MicroflowParameterType instance in the SDK and on the server.
    ...
    *  6.9.0 to 7.20.0
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.JavaActionParameter): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.MicroflowParameterType = js.native
}
