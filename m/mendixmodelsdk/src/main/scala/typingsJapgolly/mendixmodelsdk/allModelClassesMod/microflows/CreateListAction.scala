...
class CreateListAction protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CreateListAction {
  def this(
    model: AbstractModel,
...
object CreateListAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CreateListAction = js.native
  /**
    * Creates and returns a new CreateListAction instance in the SDK and on the server.
    * The new CreateListAction will be automatically stored in the 'action' property
    * of the parent ActionActivity element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CreateListAction = js.native
}
