...
object nativepages extends js.Object {
  ...
  class BottomBarItem protected ()
    extends typingsJapgolly.mendixmodelsdk.nativepagesMod.nativepages.BottomBarItem {
    def this(
      model: AbstractModel,
  ...
  class NativeLayout protected ()
    extends typingsJapgolly.mendixmodelsdk.nativepagesMod.nativepages.NativeLayout {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativeLayoutCallArgument protected ()
    extends typingsJapgolly.mendixmodelsdk.nativepagesMod.nativepages.NativeLayoutCallArgument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePage protected ()
    extends typingsJapgolly.mendixmodelsdk.nativepagesMod.nativepages.NativePage {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePageClientAction protected ()
    extends typingsJapgolly.mendixmodelsdk.nativepagesMod.nativepages.NativePageClientAction {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NativePlaceholder protected ()
    extends typingsJapgolly.mendixmodelsdk.nativepagesMod.nativepages.NativePlaceholder {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
