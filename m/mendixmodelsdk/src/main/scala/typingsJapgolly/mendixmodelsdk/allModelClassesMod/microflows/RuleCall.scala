...
class RuleCall protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.RuleCall {
  def this(
    model: AbstractModel,
...
object RuleCall extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.RuleCall = js.native
  /**
    * Creates and returns a new RuleCall instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.RuleSplitCondition): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.RuleCall = js.native
}
