...
class GridSortItem protected ()
  extends typingsJapgolly.mendixmodelsdk.documenttemplatesMod.documenttemplates.GridSortItem {
  def this(
    model: AbstractModel,
...
object GridSortItem extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.documenttemplatesMod.documenttemplates.GridSortItem = js.native
  /**
    * Creates and returns a new GridSortItem instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.documenttemplatesMod.documenttemplates.GridSortBar): typingsJapgolly.mendixmodelsdk.documenttemplatesMod.documenttemplates.GridSortItem = js.native
}
