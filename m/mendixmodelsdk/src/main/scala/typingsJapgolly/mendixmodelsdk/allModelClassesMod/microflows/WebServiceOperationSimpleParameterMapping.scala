...
class WebServiceOperationSimpleParameterMapping protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.WebServiceOperationSimpleParameterMapping {
  def this(
    model: AbstractModel,
...
object WebServiceOperationSimpleParameterMapping extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.WebServiceOperationSimpleParameterMapping = js.native
  /**
    * Creates and returns a new WebServiceOperationSimpleParameterMapping instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.SimpleRequestHandling): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.WebServiceOperationSimpleParameterMapping = js.native
}
