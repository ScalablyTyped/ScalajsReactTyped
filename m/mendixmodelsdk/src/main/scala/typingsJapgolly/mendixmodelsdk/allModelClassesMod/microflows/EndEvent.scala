...
class EndEvent protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.EndEvent {
  def this(
    model: AbstractModel,
...
object EndEvent extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.EndEvent = js.native
  /**
    * Creates and returns a new EndEvent instance in the SDK and on the server.
    * The new EndEvent will be automatically stored in the 'objects' property
    * of the parent MicroflowObjectCollection element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.MicroflowObjectCollection): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.EndEvent = js.native
}
