...
class ComparisonSearchField protected ()
  extends typingsJapgolly.mendixmodelsdk.pagesMod.pages.ComparisonSearchField {
  def this(
    model: AbstractModel,
...
object ComparisonSearchField extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.ComparisonSearchField = js.native
  /**
    * Creates and returns a new ComparisonSearchField instance in the SDK and on the server.
    * The new ComparisonSearchField will be automatically stored in the 'items' property
    * of the parent ControlBar element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.pagesMod.pages.ControlBar): typingsJapgolly.mendixmodelsdk.pagesMod.pages.ComparisonSearchField = js.native
}
