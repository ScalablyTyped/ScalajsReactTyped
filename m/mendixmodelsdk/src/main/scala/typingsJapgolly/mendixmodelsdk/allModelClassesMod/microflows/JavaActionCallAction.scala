...
/**
  ...
  */
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "microflows.JavaActionCallAction")
@js.native
class JavaActionCallAction protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.JavaActionCallAction {
  def this(
    model: AbstractModel,
