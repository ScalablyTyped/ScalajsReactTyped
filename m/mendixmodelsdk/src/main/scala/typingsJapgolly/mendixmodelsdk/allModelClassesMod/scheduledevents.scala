...
object scheduledevents extends js.Object {
  @js.native
  class IntervalType ()
    extends typingsJapgolly.mendixmodelsdk.scheduledeventsMod.scheduledevents.IntervalType
  ...
  class ScheduledEvent protected ()
    extends typingsJapgolly.mendixmodelsdk.scheduledeventsMod.scheduledevents.ScheduledEvent {
    def this(
      model: AbstractModel,
  ...
  @js.native
  class TimeZoneEnum ()
    extends typingsJapgolly.mendixmodelsdk.scheduledeventsMod.scheduledevents.TimeZoneEnum
