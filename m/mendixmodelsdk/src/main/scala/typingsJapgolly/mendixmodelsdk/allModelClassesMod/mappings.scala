...
object mappings extends js.Object {
  ...
  abstract class Element protected ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.Element {
    def this(
      model: AbstractModel,
  ...
  @js.native
  class ElementType ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.ElementType
  ...
  abstract class MappingDocument protected ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.MappingDocument {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class MappingElement protected ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.MappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class MappingMicroflowCall protected ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.MappingMicroflowCall {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class MappingMicroflowParameter protected ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.MappingMicroflowParameter {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ObjectHandlingBackupEnum ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.ObjectHandlingBackupEnum
  
  @js.native
  class ObjectHandlingEnum ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.ObjectHandlingEnum
  
  @js.native
  abstract class ObjectMappingElement protected ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.ObjectMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ValueMappingElement protected ()
    extends typingsJapgolly.mendixmodelsdk.mappingsMod.mappings.ValueMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
