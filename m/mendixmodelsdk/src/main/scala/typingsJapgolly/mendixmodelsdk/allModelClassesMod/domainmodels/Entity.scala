...
class Entity protected ()
  extends typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.Entity {
  def this(
    model: AbstractModel,
...
object Entity extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.Entity = js.native
  /**
    * Creates and returns a new Entity instance in the SDK and on the server.
    * The new Entity will be automatically stored in the 'entities' property
    * of the parent DomainModel element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.DomainModel): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.Entity = js.native
}
