...
class JavaActionParameter protected ()
  extends typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.JavaActionParameter {
  def this(
    model: AbstractModel,
...
object JavaActionParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.JavaActionParameter = js.native
  /**
    * Creates and returns a new JavaActionParameter instance in the SDK and on the server.
    ...
    *  7.21.0 and higher
    */
  def createInCodeActionUnderActionParameters(container: CodeAction): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.JavaActionParameter = js.native
  /**
    * Creates and returns a new JavaActionParameter instance in the SDK and on the server.
    ...
    *  6.0.0 to 7.20.0
    */
  def createInJavaActionUnderParameters(container: typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.JavaAction): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.JavaActionParameter = js.native
}
