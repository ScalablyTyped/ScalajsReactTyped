...
class JavaDataSetSource protected ()
  extends typingsJapgolly.mendixmodelsdk.datasetsMod.datasets.JavaDataSetSource {
  def this(
    model: AbstractModel,
...
object JavaDataSetSource extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.datasetsMod.datasets.JavaDataSetSource = js.native
  /**
    * Creates and returns a new JavaDataSetSource instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.datasetsMod.datasets.DataSet): typingsJapgolly.mendixmodelsdk.datasetsMod.datasets.JavaDataSetSource = js.native
}
