...
class LayoutGridColumn protected ()
  extends typingsJapgolly.mendixmodelsdk.pagesMod.pages.LayoutGridColumn {
  def this(
    model: AbstractModel,
...
object LayoutGridColumn extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.LayoutGridColumn = js.native
  /**
    * Creates and returns a new LayoutGridColumn instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.pagesMod.pages.LayoutGridRow): typingsJapgolly.mendixmodelsdk.pagesMod.pages.LayoutGridColumn = js.native
}
