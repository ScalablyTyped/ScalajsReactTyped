...
class NanoflowCallAction protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.NanoflowCallAction {
  def this(
    model: AbstractModel,
...
object NanoflowCallAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.NanoflowCallAction = js.native
  /**
    * Creates and returns a new NanoflowCallAction instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.NanoflowCallAction = js.native
}
