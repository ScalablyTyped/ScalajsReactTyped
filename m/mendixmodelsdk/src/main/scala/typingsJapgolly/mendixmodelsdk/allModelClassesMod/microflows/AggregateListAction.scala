...
class AggregateListAction protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.AggregateListAction {
  def this(
    model: AbstractModel,
...
object AggregateListAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.AggregateListAction = js.native
  /**
    * Creates and returns a new AggregateListAction instance in the SDK and on the server.
    * The new AggregateListAction will be automatically stored in the 'action' property
    * of the parent ActionActivity element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.AggregateListAction = js.native
}
