...
@JSImport("mendixmodelsdk/dist/gen/all-model-classes", "pages.SortableEntityPathSource")
@js.native
abstract class SortableEntityPathSource protected ()
  extends typingsJapgolly.mendixmodelsdk.pagesMod.pages.SortableEntityPathSource {
  def this(
    model: AbstractModel,
