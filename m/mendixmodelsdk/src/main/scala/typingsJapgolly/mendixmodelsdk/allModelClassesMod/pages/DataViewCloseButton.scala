...
class DataViewCloseButton protected ()
  extends typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataViewCloseButton {
  def this(
    model: AbstractModel,
...
object DataViewCloseButton extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataViewCloseButton = js.native
  /**
    * Creates and returns a new DataViewCloseButton instance in the SDK and on the server.
    ...
    *  6.0.0 to 6.6.0
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.pagesMod.pages.ControlBar): typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataViewCloseButton = js.native
}
