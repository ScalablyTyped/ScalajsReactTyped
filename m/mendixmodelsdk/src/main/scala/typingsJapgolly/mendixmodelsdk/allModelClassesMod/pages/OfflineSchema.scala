...
class OfflineSchema protected ()
  extends typingsJapgolly.mendixmodelsdk.pagesMod.pages.OfflineSchema {
  def this(
    model: AbstractModel,
...
object OfflineSchema extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.OfflineSchema = js.native
}
