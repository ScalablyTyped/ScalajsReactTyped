...
class UniqueRuleInfo protected ()
  extends typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.UniqueRuleInfo {
  def this(
    model: AbstractModel,
...
object UniqueRuleInfo extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.UniqueRuleInfo = js.native
  /**
    * Creates and returns a new UniqueRuleInfo instance in the SDK and on the server.
    * The new UniqueRuleInfo will be automatically stored in the 'ruleInfo' property
    * of the parent ValidationRule element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.ValidationRule): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.UniqueRuleInfo = js.native
}
