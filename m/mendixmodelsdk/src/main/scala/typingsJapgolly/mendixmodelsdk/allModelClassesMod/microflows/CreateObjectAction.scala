...
class CreateObjectAction protected ()
  extends typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CreateObjectAction {
  def this(
    model: AbstractModel,
...
object CreateObjectAction extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CreateObjectAction = js.native
  /**
    * Creates and returns a new CreateObjectAction instance in the SDK and on the server.
    * The new CreateObjectAction will be automatically stored in the 'action' property
    * of the parent ActionActivity element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.ActionActivity): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.CreateObjectAction = js.native
}
