...
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.Navigability
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RemoteAssociationSource
...
- typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IAssociationSource because Already inherited
- typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IRemoteAssociationSource because Already inherited
- typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.IODataRemoteAssociationSource because var conflicts: containerAsAssociationBase, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/rest", "rest.ODataRemoteAssociationSource")
@js.native
