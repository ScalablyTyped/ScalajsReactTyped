...
- typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.IPublishedODataService because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/rest", "rest.PublishedODataService")
@js.native
