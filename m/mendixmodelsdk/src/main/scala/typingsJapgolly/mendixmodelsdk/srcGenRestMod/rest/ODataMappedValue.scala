...
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.MappedValue
...
- typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.IODataMappedValue because var conflicts: containerAsAttribute, id, isLoaded, model, structureTypeName, unit. Inlined filterable, sortable, representsStream */ @JSImport("mendixmodelsdk/src/gen/rest", "rest.ODataMappedValue")
@js.native
