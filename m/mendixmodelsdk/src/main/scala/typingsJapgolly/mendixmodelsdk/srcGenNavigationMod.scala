...
object srcGenNavigationMod {
  ...
  object navigation {
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenNavigationMod.navigation.INavigationProfileBase because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenNavigationMod.navigation.INativeNavigationProfile because var conflicts: containerAsNavigationDocument, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/navigation", "navigation.NativeNavigationProfile")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenNavigationMod.navigation.INavigationDocument because var conflicts: containerAsProject, id, isLoaded, model, structureTypeName, unit. Inlined profiles */ @JSImport("mendixmodelsdk/src/gen/navigation", "navigation.NavigationDocument")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IElement because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenNavigationMod.navigation.INavigationProfileBase because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenNavigationMod.navigation.INavigationProfile because var conflicts: containerAsNavigationDocument, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/navigation", "navigation.NavigationProfile")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IAbstractElement because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IElement because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenNavigationMod.navigation.INavigationProfileBase because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsNavigationDocument, name */ @JSImport("mendixmodelsdk/src/gen/navigation", "navigation.NavigationProfileBase")
    @js.native
