...
- typingsJapgolly.mendixmodelsdk.srcGenDatatypesMod.datatypes.IIntegerType because var conflicts: containerAsAppServiceAction, containerAsAppServiceActionParameter, containerAsConstant, containerAsDataSetParameter, containerAsDocumentTemplateParameter, containerAsImportMapping, containerAsMicroflowBase, containerAsMicroflowParameterBase, containerAsPageParameter, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.IntegerType")
@js.native
open class IntegerType protected () extends DataType {
  def this(
    model: AbstractModel,
  ...
  def containerAsPageParameter_MIntegerType: PageParameter = js.native
}
object IntegerType {
  
  @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.IntegerType")
  @js.native
  ...
  /**
    ...
    */
  /* static member */
  inline def createInMLModelCallParameterMappingUnderParameterType(container: MLModelCallParameterMapping): IntegerType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInMLModelCallParameterMappingUnderParameterType")(container.asInstanceOf[js.Any]).asInstanceOf[IntegerType]
  ...
  /**
    ...
    */
  /* static member */
  inline def createInPageParameterUnderParameterType(container: PageParameter): IntegerType = ^.asInstanceOf[js.Dynamic].applyDynamic("createInPageParameterUnderParameterType")(container.asInstanceOf[js.Any]).asInstanceOf[IntegerType]
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.IntegerType.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/datatypes", "datatypes.IntegerType.versionInfo")
  @js.native
