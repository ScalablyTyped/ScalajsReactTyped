...
/**
  ...
  */
@JSImport("mendixmodelsdk", "workflows.JumpToActivity")
@js.native
open class JumpToActivity protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.workflows.JumpToActivity {
  def this(
    model: AbstractModel,
...
object JumpToActivity {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.JumpToActivity.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.JumpToActivity.versionInfo")
  @js.native
