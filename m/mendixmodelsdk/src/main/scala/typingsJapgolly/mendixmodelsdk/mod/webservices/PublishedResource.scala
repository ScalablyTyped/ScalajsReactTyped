...
/* note: abstract class */ @JSImport("mendixmodelsdk", "webservices.PublishedResource")
@js.native
open class PublishedResource protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.webservices.PublishedResource {
  def this(
    model: AbstractModel,
