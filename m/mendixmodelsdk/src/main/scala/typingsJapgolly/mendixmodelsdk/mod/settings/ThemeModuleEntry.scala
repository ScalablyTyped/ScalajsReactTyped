...
/**
  ...
  */
@JSImport("mendixmodelsdk", "settings.ThemeModuleEntry")
@js.native
open class ThemeModuleEntry protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.settings.ThemeModuleEntry {
  def this(
    model: AbstractModel,
...
object ThemeModuleEntry {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "settings.ThemeModuleEntry.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "settings.ThemeModuleEntry.versionInfo")
  @js.native
