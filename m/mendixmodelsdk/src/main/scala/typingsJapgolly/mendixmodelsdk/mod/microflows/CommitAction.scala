...
open class CommitAction protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.microflows.CommitAction {
  def this(
    model: AbstractModel,
...
object CommitAction {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.CommitAction.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.CommitAction.versionInfo")
  @js.native
