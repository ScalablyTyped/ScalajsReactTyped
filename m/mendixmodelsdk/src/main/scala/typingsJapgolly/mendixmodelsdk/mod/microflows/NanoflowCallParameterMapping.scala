...
class NanoflowCallParameterMapping protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.microflows.NanoflowCallParameterMapping {
  def this(
    model: AbstractModel,
...
object NanoflowCallParameterMapping extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.NanoflowCallParameterMapping = js.native
  /**
    * Creates and returns a new NanoflowCallParameterMapping instance in the SDK and on the server.
    ...
    *  8.0.0 and higher
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.NanoflowCall): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.NanoflowCallParameterMapping = js.native
}
