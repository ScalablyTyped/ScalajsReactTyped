...
class CustomWidgetType protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.customwidgets.CustomWidgetType {
  def this(
    model: AbstractModel,
...
object CustomWidgetType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.customwidgetsMod.customwidgets.CustomWidgetType = js.native
  /**
    * Creates and returns a new CustomWidgetType instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.customwidgetsMod.customwidgets.CustomWidget): typingsJapgolly.mendixmodelsdk.customwidgetsMod.customwidgets.CustomWidgetType = js.native
}
