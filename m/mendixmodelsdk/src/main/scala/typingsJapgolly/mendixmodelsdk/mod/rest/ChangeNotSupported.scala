...
open class ChangeNotSupported protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.rest.ChangeNotSupported {
  def this(
    model: AbstractModel,
...
object ChangeNotSupported {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.ChangeNotSupported = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.ChangeNotSupported]
