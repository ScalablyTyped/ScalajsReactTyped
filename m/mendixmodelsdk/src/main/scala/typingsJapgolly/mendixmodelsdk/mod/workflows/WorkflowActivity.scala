...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk", "workflows.WorkflowActivity")
@js.native
open class WorkflowActivity protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.workflows.WorkflowActivity {
  def this(
    model: AbstractModel,
