...
class TypeParameter protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.javaactions.TypeParameter {
  def this(
    model: AbstractModel,
...
object TypeParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.TypeParameter = js.native
  /**
    * Creates and returns a new TypeParameter instance in the SDK and on the server.
    ...
    *  6.6.0 to 7.20.0
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.JavaAction): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.TypeParameter = js.native
}
