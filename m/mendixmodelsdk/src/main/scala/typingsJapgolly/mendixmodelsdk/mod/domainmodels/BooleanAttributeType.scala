...
class BooleanAttributeType protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.domainmodels.BooleanAttributeType {
  def this(
    model: AbstractModel,
...
object BooleanAttributeType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.BooleanAttributeType = js.native
  /**
    * Creates and returns a new BooleanAttributeType instance in the SDK and on the server.
    * The new BooleanAttributeType will be automatically stored in the 'type' property
    * of the parent Attribute element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.Attribute): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.BooleanAttributeType = js.native
}
