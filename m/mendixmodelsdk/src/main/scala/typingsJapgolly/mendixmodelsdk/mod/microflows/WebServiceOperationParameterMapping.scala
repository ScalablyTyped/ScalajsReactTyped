...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk", "microflows.WebServiceOperationParameterMapping")
@js.native
open class WebServiceOperationParameterMapping protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.microflows.WebServiceOperationParameterMapping {
  def this(
    model: AbstractModel,
