...
class MsdDomainModel protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.appservices.MsdDomainModel {
  def this(
    model: AbstractModel,
...
object MsdDomainModel extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.appservicesMod.appservices.MsdDomainModel = js.native
  /**
    * Creates and returns a new MsdDomainModel instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.appservicesMod.appservices.Msd): typingsJapgolly.mendixmodelsdk.appservicesMod.appservices.MsdDomainModel = js.native
}
