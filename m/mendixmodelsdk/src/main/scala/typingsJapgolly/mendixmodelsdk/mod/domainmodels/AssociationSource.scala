...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk", "domainmodels.AssociationSource")
@js.native
open class AssociationSource protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.AssociationSource {
  def this(
    model: AbstractModel,
