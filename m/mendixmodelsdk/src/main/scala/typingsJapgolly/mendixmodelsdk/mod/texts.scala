...
object texts extends js.Object {
  ...
  class SystemText protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.texts.SystemText {
    def this(
  ...
  class SystemTextCollection protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.texts.SystemTextCollection {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Text protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.texts.Text {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Translation protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.texts.Translation {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
