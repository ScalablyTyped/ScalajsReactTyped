...
class ConfigurationSettings protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.settings.ConfigurationSettings {
  def this(
    model: AbstractModel,
...
object ConfigurationSettings extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.settingsMod.settings.ConfigurationSettings = js.native
  /**
    * Creates and returns a new ConfigurationSettings instance in the SDK and on the server.
    * The new ConfigurationSettings will be automatically stored in the 'settingsParts' property
    * of the parent ProjectSettings element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.settingsMod.settings.ProjectSettings): typingsJapgolly.mendixmodelsdk.settingsMod.settings.ConfigurationSettings = js.native
}
