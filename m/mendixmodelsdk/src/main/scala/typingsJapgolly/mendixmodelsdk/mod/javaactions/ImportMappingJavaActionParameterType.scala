...
class ImportMappingJavaActionParameterType protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.javaactions.ImportMappingJavaActionParameterType {
  def this(
    model: AbstractModel,
...
object ImportMappingJavaActionParameterType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.ImportMappingJavaActionParameterType = js.native
}
