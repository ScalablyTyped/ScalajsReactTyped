...
class LongAttributeType protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.domainmodels.LongAttributeType {
  def this(
    model: AbstractModel,
...
object LongAttributeType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.LongAttributeType = js.native
  /**
    * Creates and returns a new LongAttributeType instance in the SDK and on the server.
    * The new LongAttributeType will be automatically stored in the 'type' property
    * of the parent Attribute element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.Attribute): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.LongAttributeType = js.native
}
