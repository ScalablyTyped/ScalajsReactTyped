...
class AssociationDeleteBehavior protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.domainmodels.AssociationDeleteBehavior {
  def this(
    model: AbstractModel,
...
object AssociationDeleteBehavior extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.AssociationDeleteBehavior = js.native
  /**
    * Creates and returns a new AssociationDeleteBehavior instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.AssociationBase): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.AssociationDeleteBehavior = js.native
}
