...
class DataGridExportToCSVButton protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.pages.DataGridExportToCSVButton {
  def this(
    model: AbstractModel,
...
object DataGridExportToCSVButton extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataGridExportToCSVButton = js.native
  /**
    * Creates and returns a new DataGridExportToCSVButton instance in the SDK and on the server.
    * The new DataGridExportToCSVButton will be automatically stored in the 'items' property
    * of the parent ControlBar element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.pagesMod.pages.ControlBar): typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataGridExportToCSVButton = js.native
}
