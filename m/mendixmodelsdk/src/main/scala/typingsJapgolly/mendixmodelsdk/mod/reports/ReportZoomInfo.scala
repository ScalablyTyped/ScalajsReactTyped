...
class ReportZoomInfo protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.reports.ReportZoomInfo {
  def this(
    model: AbstractModel,
...
object ReportZoomInfo extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.reportsMod.reports.ReportZoomInfo = js.native
  /**
    * Creates and returns a new ReportZoomInfo instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.reportsMod.reports.BasicReport): typingsJapgolly.mendixmodelsdk.reportsMod.reports.ReportZoomInfo = js.native
}
