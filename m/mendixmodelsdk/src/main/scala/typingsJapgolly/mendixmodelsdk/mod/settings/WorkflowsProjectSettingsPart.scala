...
open class WorkflowsProjectSettingsPart protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.settings.WorkflowsProjectSettingsPart {
  def this(
    model: AbstractModel,
...
object WorkflowsProjectSettingsPart {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "settings.WorkflowsProjectSettingsPart.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "settings.WorkflowsProjectSettingsPart.versionInfo")
  @js.native
