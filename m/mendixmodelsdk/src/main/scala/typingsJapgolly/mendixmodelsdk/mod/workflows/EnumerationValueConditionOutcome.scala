...
/**
  ...
  */
@JSImport("mendixmodelsdk", "workflows.EnumerationValueConditionOutcome")
@js.native
open class EnumerationValueConditionOutcome protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.workflows.EnumerationValueConditionOutcome {
  def this(
    model: AbstractModel,
...
object EnumerationValueConditionOutcome {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.EnumerationValueConditionOutcome.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.EnumerationValueConditionOutcome.versionInfo")
  @js.native
