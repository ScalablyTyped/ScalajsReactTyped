...
open class MappingRequestHandling protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.microflows.MappingRequestHandling {
  def this(
    model: AbstractModel,
...
object MappingRequestHandling {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.MappingRequestHandling.versionInfo")
  @js.native
