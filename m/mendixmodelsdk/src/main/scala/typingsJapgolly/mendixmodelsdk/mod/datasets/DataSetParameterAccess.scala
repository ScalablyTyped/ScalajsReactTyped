...
class DataSetParameterAccess protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.datasets.DataSetParameterAccess {
  def this(
    model: AbstractModel,
...
object DataSetParameterAccess extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.datasetsMod.datasets.DataSetParameterAccess = js.native
  /**
    * Creates and returns a new DataSetParameterAccess instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.datasetsMod.datasets.DataSetModuleRoleAccess): typingsJapgolly.mendixmodelsdk.datasetsMod.datasets.DataSetParameterAccess = js.native
}
