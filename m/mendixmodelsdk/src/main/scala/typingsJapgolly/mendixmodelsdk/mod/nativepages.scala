...
object nativepages {
  ...
  open class BottomBarItem protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.BottomBarItem {
    def this(
  ...
  open class NativeLayout protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativeLayout {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NativeLayoutCallArgument protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativeLayoutCallArgument {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NativePage protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativePage {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NativePageClientAction protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativePageClientAction {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NativePlaceholder protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.nativepages.NativePlaceholder {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
