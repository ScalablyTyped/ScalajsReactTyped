...
object javascriptactions extends js.Object {
  ...
  class JavaScriptAction protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.javascriptactions.JavaScriptAction {
    def this(
  ...
  class JavaScriptActionParameter protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.javascriptactions.JavaScriptActionParameter {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class NanoflowJavaScriptActionParameterType protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.javascriptactions.NanoflowJavaScriptActionParameterType {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
