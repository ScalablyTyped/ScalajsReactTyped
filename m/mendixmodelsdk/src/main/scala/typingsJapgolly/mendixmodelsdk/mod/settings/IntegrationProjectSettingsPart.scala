...
class IntegrationProjectSettingsPart protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.settings.IntegrationProjectSettingsPart {
  def this(
    model: AbstractModel,
...
object IntegrationProjectSettingsPart extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.settingsMod.settings.IntegrationProjectSettingsPart = js.native
  /**
    * Creates and returns a new IntegrationProjectSettingsPart instance in the SDK and on the server.
    * The new IntegrationProjectSettingsPart will be automatically stored in the 'settingsParts' property
    * of the parent ProjectSettings element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.settingsMod.settings.ProjectSettings): typingsJapgolly.mendixmodelsdk.settingsMod.settings.IntegrationProjectSettingsPart = js.native
}
