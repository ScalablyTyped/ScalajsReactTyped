...
class CalculatedValue protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.domainmodels.CalculatedValue {
  def this(
    model: AbstractModel,
...
object CalculatedValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.CalculatedValue = js.native
  /**
    * Creates and returns a new CalculatedValue instance in the SDK and on the server.
    * The new CalculatedValue will be automatically stored in the 'value' property
    * of the parent Attribute element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.Attribute): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.CalculatedValue = js.native
}
