...
object security extends js.Object {
  ...
  abstract class AccessRuleContainerBase protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.AccessRuleContainerBase {
    def this(
  ...
  class DemoUser protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.DemoUser {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class FileDocumentAccessRuleContainer protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.FileDocumentAccessRuleContainer {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ImageAccessRuleContainer protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.ImageAccessRuleContainer {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ModuleRole protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.ModuleRole {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ModuleSecurity protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.ModuleSecurity {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class PasswordPolicySettings protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.PasswordPolicySettings {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ProjectSecurity protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.ProjectSecurity {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  @js.native
  class SecurityLevel ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.SecurityLevel
  ...
  class UserRole protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.security.UserRole {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
