...
class TypeParameter protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.codeactions.TypeParameter {
  def this(
    model: AbstractModel,
...
object TypeParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.codeactionsMod.codeactions.TypeParameter = js.native
}
