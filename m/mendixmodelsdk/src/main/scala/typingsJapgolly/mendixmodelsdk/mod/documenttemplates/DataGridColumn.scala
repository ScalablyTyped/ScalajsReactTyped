...
class DataGridColumn protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.documenttemplates.DataGridColumn {
  def this(
    model: AbstractModel,
...
object DataGridColumn extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.documenttemplatesMod.documenttemplates.DataGridColumn = js.native
  /**
    * Creates and returns a new DataGridColumn instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.documenttemplatesMod.documenttemplates.DataGrid): typingsJapgolly.mendixmodelsdk.documenttemplatesMod.documenttemplates.DataGridColumn = js.native
}
