...
class MicroflowActionInfo protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.javaactions.MicroflowActionInfo {
  def this(
    model: AbstractModel,
...
object MicroflowActionInfo extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.MicroflowActionInfo = js.native
  /**
    * Creates and returns a new MicroflowActionInfo instance in the SDK and on the server.
    ...
    *  6.6.0 to 7.20.0
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.JavaAction): typingsJapgolly.mendixmodelsdk.javaactionsMod.javaactions.MicroflowActionInfo = js.native
}
