...
open class MicroflowJavaActionParameterType protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.javaactions.MicroflowJavaActionParameterType {
  def this(
    model: AbstractModel,
...
object MicroflowJavaActionParameterType {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenJavaactionsMod.javaactions.MicroflowJavaActionParameterType = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenJavaactionsMod.javaactions.MicroflowJavaActionParameterType]
