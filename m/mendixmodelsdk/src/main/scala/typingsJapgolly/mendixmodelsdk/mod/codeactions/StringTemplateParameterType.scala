...
class StringTemplateParameterType protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.codeactions.StringTemplateParameterType {
  def this(
    model: AbstractModel,
...
object StringTemplateParameterType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.codeactionsMod.codeactions.StringTemplateParameterType = js.native
}
