...
class EntityTypeCodeActionParameterValue protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.microflows.EntityTypeCodeActionParameterValue {
  def this(
    model: AbstractModel,
...
object EntityTypeCodeActionParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.EntityTypeCodeActionParameterValue = js.native
  /**
    * Creates and returns a new EntityTypeCodeActionParameterValue instance in the SDK and on the server.
    ...
    *  7.21.0 and higher
    */
  def createInJavaActionParameterMappingUnderParameterValue(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.JavaActionParameterMapping): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.EntityTypeCodeActionParameterValue = js.native
  /**
    * Creates and returns a new EntityTypeCodeActionParameterValue instance in the SDK and on the server.
    * The new EntityTypeCodeActionParameterValue will be automatically stored in the 'parameterValue' property
  ...
  ): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.EntityTypeCodeActionParameterValue = js.native
}
