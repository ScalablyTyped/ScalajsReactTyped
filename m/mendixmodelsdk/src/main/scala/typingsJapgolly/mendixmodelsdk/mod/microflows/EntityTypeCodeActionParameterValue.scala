...
open class EntityTypeCodeActionParameterValue protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.microflows.EntityTypeCodeActionParameterValue {
  def this(
    model: AbstractModel,
...
object EntityTypeCodeActionParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue]
  ...
  ): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createInJavaActionParameterMappingUnderParameterValue")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue]
  ...
  ): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createInJavaScriptActionParameterMappingUnderParameterValue")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeCodeActionParameterValue]
