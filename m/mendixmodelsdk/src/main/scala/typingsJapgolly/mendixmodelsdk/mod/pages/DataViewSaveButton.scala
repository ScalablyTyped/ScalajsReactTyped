...
class DataViewSaveButton protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.pages.DataViewSaveButton {
  def this(
    model: AbstractModel,
...
object DataViewSaveButton extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataViewSaveButton = js.native
  /**
    * Creates and returns a new DataViewSaveButton instance in the SDK and on the server.
    ...
    *  6.0.0 to 6.6.0
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.pagesMod.pages.ControlBar): typingsJapgolly.mendixmodelsdk.pagesMod.pages.DataViewSaveButton = js.native
}
