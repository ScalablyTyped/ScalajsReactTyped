...
object projects extends js.Object {
  ...
  abstract class Document protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.Document {
    def this(
  ...
  class Folder protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.Folder {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class FolderBase protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.FolderBase {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Module protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.Module {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ModuleDocument protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.ModuleDocument {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class OneTimeConversionMarker protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.OneTimeConversionMarker {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class Project protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.Project {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  class ProjectConversion protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.ProjectConversion {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  abstract class ProjectDocument protected ()
    extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.projects.ProjectDocument {
    def this(
      model: typingsJapgolly.mendixmodelsdk.internalMod.AbstractModel,
      structureTypeName: String,
      id: String,
