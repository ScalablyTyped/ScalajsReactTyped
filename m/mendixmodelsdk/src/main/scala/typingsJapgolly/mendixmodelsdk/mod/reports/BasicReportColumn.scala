...
class BasicReportColumn protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.reports.BasicReportColumn {
  def this(
    model: AbstractModel,
...
object BasicReportColumn extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.reportsMod.reports.BasicReportColumn = js.native
  /**
    * Creates and returns a new BasicReportColumn instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.reportsMod.reports.BasicReport): typingsJapgolly.mendixmodelsdk.reportsMod.reports.BasicReportColumn = js.native
}
