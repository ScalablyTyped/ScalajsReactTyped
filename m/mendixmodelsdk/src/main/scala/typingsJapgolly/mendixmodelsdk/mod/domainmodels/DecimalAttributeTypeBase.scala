...
/* note: abstract class */ @JSImport("mendixmodelsdk", "domainmodels.DecimalAttributeTypeBase")
@js.native
open class DecimalAttributeTypeBase protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.domainmodels.DecimalAttributeTypeBase {
  def this(
    model: AbstractModel,
