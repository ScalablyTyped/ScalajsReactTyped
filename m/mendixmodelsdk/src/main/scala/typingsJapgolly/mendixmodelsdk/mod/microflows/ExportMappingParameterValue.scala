...
class ExportMappingParameterValue protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.microflows.ExportMappingParameterValue {
  def this(
    model: AbstractModel,
...
object ExportMappingParameterValue extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.ExportMappingParameterValue = js.native
  /**
    * Creates and returns a new ExportMappingParameterValue instance in the SDK and on the server.
    ...
    *  7.21.0 and higher
    */
  def createInJavaActionParameterMappingUnderParameterValue(container: typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.JavaActionParameterMapping): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.ExportMappingParameterValue = js.native
  /**
    * Creates and returns a new ExportMappingParameterValue instance in the SDK and on the server.
    * The new ExportMappingParameterValue will be automatically stored in the 'parameterValue' property
  ...
  ): typingsJapgolly.mendixmodelsdk.microflowsMod.microflows.ExportMappingParameterValue = js.native
}
