...
@js.native
open class ExportMappingParameterValue protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.microflows.ExportMappingParameterValue {
  def this(
    model: AbstractModel,
...
object ExportMappingParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.ExportMappingParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.ExportMappingParameterValue]
  ...
  ): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.ExportMappingParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createInJavaActionParameterMappingUnderParameterValue")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.ExportMappingParameterValue]
  ...
  ): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.ExportMappingParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createInJavaScriptActionParameterMappingUnderParameterValue")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.ExportMappingParameterValue]
