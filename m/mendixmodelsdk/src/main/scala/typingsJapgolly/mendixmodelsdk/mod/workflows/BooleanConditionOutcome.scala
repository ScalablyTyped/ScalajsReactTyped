...
/**
  ...
  */
@JSImport("mendixmodelsdk", "workflows.BooleanConditionOutcome")
@js.native
open class BooleanConditionOutcome protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.workflows.BooleanConditionOutcome {
  def this(
    model: AbstractModel,
...
object BooleanConditionOutcome {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.BooleanConditionOutcome.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.BooleanConditionOutcome.versionInfo")
  @js.native
