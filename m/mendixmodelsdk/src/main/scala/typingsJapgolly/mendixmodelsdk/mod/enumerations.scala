...
object enumerations {
  ...
  open class Condition protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.enumerations.Condition {
    def this(
  ...
  open class Enumeration protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.enumerations.Enumeration {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class EnumerationValue protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.enumerations.EnumerationValue {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
