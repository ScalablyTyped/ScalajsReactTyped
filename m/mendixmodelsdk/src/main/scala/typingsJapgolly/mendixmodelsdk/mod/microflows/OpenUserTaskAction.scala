...
open class OpenUserTaskAction protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.microflows.OpenUserTaskAction {
  def this(
    model: AbstractModel,
...
object OpenUserTaskAction {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "microflows.OpenUserTaskAction.versionInfo")
  @js.native
