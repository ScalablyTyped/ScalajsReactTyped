...
object queues {
  ...
  open class BasicQueueConfig protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.queues.BasicQueueConfig {
    def this(
  ...
  open class Queue protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.queues.Queue {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueConfig protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.queues.QueueConfig {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueExponentialRetry protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.queues.QueueExponentialRetry {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueFixedRetry protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.queues.QueueFixedRetry {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueRetry protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.queues.QueueRetry {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class QueueRetryIntervalType protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.queues.QueueRetryIntervalType {
  ...
  open class QueueSettings protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.queues.QueueSettings {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
