...
class RetrievalQueryParameter protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.pages.RetrievalQueryParameter {
  def this(
    model: AbstractModel,
...
object RetrievalQueryParameter extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.RetrievalQueryParameter = js.native
  /**
    * Creates and returns a new RetrievalQueryParameter instance in the SDK and on the server.
    ...
    *  8.6.0 and higher
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.pagesMod.pages.RetrievalQuery): typingsJapgolly.mendixmodelsdk.pagesMod.pages.RetrievalQueryParameter = js.native
}
