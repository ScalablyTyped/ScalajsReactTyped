...
object businessevents {
  ...
  open class ConsumedBusinessEvent protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.businessevents.ConsumedBusinessEvent {
    def this(
  ...
  open class ConsumedBusinessEventService protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.businessevents.ConsumedBusinessEventService {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedBusinessEventService protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.businessevents.PublishedBusinessEventService {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedChannel protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.businessevents.PublishedChannel {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedMessage protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.businessevents.PublishedMessage {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedMessageAttribute protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.businessevents.PublishedMessageAttribute {
    def this(
      model: typingsJapgolly.mendixmodelsdk.srcSdkInternalMod.AbstractModel,
      structureTypeName: String,
      id: String,
