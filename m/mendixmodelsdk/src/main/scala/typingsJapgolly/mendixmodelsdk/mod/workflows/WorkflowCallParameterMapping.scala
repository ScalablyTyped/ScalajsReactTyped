...
/**
  ...
  */
@JSImport("mendixmodelsdk", "workflows.WorkflowCallParameterMapping")
@js.native
open class WorkflowCallParameterMapping protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.workflows.WorkflowCallParameterMapping {
  def this(
    model: AbstractModel,
...
object WorkflowCallParameterMapping {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.WorkflowCallParameterMapping.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.WorkflowCallParameterMapping.versionInfo")
  @js.native
