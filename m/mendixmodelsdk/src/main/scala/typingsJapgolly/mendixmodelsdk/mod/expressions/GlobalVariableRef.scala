...
class GlobalVariableRef protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.expressions.GlobalVariableRef {
  def this(
    model: AbstractModel,
...
object GlobalVariableRef extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.expressionsMod.expressions.GlobalVariableRef = js.native
  /**
    * Creates and returns a new GlobalVariableRef instance in the SDK and on the server.
    ...
    *  7.9.0 and higher
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.expressionsMod.expressions.VariableRefExpression): typingsJapgolly.mendixmodelsdk.expressionsMod.expressions.GlobalVariableRef = js.native
}
