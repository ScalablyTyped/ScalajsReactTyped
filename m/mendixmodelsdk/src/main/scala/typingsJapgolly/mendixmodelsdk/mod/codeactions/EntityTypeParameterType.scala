...
class EntityTypeParameterType protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.codeactions.EntityTypeParameterType {
  def this(
    model: AbstractModel,
...
object EntityTypeParameterType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.codeactionsMod.codeactions.EntityTypeParameterType = js.native
}
