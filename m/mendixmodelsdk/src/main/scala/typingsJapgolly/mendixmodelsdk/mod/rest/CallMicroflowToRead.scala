...
open class CallMicroflowToRead protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.rest.CallMicroflowToRead {
  def this(
    model: AbstractModel,
...
object CallMicroflowToRead {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.CallMicroflowToRead = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.CallMicroflowToRead]
