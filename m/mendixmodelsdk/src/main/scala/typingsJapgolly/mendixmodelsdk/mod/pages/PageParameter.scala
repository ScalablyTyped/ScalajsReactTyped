...
/**
  ...
  */
@JSImport("mendixmodelsdk", "pages.PageParameter")
@js.native
open class PageParameter protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.pages.PageParameter {
  def this(
    model: AbstractModel,
...
object PageParameter {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "pages.PageParameter.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "pages.PageParameter.versionInfo")
  @js.native
