...
class MaxLengthRuleInfo protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.domainmodels.MaxLengthRuleInfo {
  def this(
    model: AbstractModel,
...
object MaxLengthRuleInfo extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.MaxLengthRuleInfo = js.native
  /**
    * Creates and returns a new MaxLengthRuleInfo instance in the SDK and on the server.
    * The new MaxLengthRuleInfo will be automatically stored in the 'ruleInfo' property
    * of the parent ValidationRule element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.ValidationRule): typingsJapgolly.mendixmodelsdk.domainmodelsMod.domainmodels.MaxLengthRuleInfo = js.native
}
