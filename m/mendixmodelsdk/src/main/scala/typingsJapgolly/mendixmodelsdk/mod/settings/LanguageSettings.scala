...
class LanguageSettings protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.settings.LanguageSettings {
  def this(
    model: AbstractModel,
...
object LanguageSettings extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.settingsMod.settings.LanguageSettings = js.native
  /**
    * Creates and returns a new LanguageSettings instance in the SDK and on the server.
    * The new LanguageSettings will be automatically stored in the 'settingsParts' property
    * of the parent ProjectSettings element passed as argument.
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.settingsMod.settings.ProjectSettings): typingsJapgolly.mendixmodelsdk.settingsMod.settings.LanguageSettings = js.native
}
