...
class TabPage protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.pages.TabPage {
  def this(
    model: AbstractModel,
...
object TabPage extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.pagesMod.pages.TabPage = js.native
  /**
    * Creates and returns a new TabPage instance in the SDK and on the server.
    ...
    */
  def createIn(container: typingsJapgolly.mendixmodelsdk.pagesMod.pages.TabContainer): typingsJapgolly.mendixmodelsdk.pagesMod.pages.TabPage = js.native
}
