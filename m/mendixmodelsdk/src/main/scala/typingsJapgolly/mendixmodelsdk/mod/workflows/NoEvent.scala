...
/**
  ...
  */
@JSImport("mendixmodelsdk", "workflows.NoEvent")
@js.native
open class NoEvent protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenAllModelClassesMod.workflows.NoEvent {
  def this(
    model: AbstractModel,
...
object NoEvent {
  ...
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.NoEvent.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk", "workflows.NoEvent.versionInfo")
  @js.native
