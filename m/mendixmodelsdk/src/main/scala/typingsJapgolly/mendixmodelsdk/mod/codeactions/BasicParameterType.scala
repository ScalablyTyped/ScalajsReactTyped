...
class BasicParameterType protected ()
  extends typingsJapgolly.mendixmodelsdk.allModelClassesMod.codeactions.BasicParameterType {
  def this(
    model: AbstractModel,
...
object BasicParameterType extends js.Object {
  ...
  /**
    ...
    */
  def create(model: IModel): typingsJapgolly.mendixmodelsdk.codeactionsMod.codeactions.BasicParameterType = js.native
}
