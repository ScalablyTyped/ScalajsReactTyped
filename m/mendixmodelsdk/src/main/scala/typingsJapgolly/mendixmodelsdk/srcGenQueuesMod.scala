...
object srcGenQueuesMod {
  ...
  object queues {
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenQueuesMod.queues.IQueue because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/queues", "queues.Queue")
    @js.native
