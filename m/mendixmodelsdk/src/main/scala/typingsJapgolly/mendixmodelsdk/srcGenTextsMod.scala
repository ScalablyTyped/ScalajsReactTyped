...
object srcGenTextsMod {
  ...
  object texts {
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenTextsMod.texts.ISystemTextCollection because var conflicts: containerAsProject, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/texts", "texts.SystemTextCollection")
    @js.native
