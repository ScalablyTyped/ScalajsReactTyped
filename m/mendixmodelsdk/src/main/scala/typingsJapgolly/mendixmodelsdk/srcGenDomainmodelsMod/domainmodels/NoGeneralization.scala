...
- typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.INoGeneralization because var conflicts: containerAsEntity, id, isLoaded, model, structureTypeName, unit. Inlined hasChangedDate, hasCreatedDate, hasOwner, hasChangedBy, persistable */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.NoGeneralization")
@js.native
