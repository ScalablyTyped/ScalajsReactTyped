...
- typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IEntityKeyPart because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsEntityKey, name, `type` */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.EntityKeyPart")
@js.native
