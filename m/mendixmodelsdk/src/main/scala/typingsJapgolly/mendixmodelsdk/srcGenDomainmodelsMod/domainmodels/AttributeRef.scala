...
- typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IAttributeRef because var conflicts: entityRef, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.AttributeRef")
@js.native
...
object AttributeRef {
  ...
  /**
    ...
    */
  /* static member */
  inline def createInPagesGridSortItemUnderAttributeRef(container: typingsJapgolly.mendixmodelsdk.srcGenPagesMod.pages.GridSortItem): AttributeRef = ^.asInstanceOf[js.Dynamic].applyDynamic("createInPagesGridSortItemUnderAttributeRef")(container.asInstanceOf[js.Any]).asInstanceOf[AttributeRef]
