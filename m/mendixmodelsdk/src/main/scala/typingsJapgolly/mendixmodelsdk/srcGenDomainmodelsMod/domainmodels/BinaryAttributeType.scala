...
- typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IBinaryAttributeType because var conflicts: containerAsAttribute, containerAsEntityKeyPart, containerAsODataKeyPart, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.BinaryAttributeType")
@js.native
