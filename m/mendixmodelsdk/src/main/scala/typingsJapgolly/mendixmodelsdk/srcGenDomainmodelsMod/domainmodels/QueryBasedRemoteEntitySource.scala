...
- typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IQueryBasedRemoteEntitySource because var conflicts: containerAsEntity, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/domainmodels", "domainmodels.QueryBasedRemoteEntitySource")
@js.native
open class QueryBasedRemoteEntitySource protected () extends RemoteEntitySource {
  def this(
    model: AbstractModel,
