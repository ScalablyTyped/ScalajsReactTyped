...
object srcGenBusinesseventsMod {
  ...
  object businessevents {
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenBusinesseventsMod.businessevents.IConsumedBusinessEventService because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/businessevents", "businessevents.ConsumedBusinessEventService")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenProjectsMod.projects.IModuleDocument because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenProjectsMod.projects.IDocument because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenBusinesseventsMod.businessevents.IPublishedBusinessEventService because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/businessevents", "businessevents.PublishedBusinessEventService")
    @js.native
