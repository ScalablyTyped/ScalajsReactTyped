...
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.CachedMappedValue
...
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.ICachedMappedValue
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IEntity
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IMaterializedRemoteEntitySource
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IRemoteEntitySourceDocument
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.MaterializedRemoteEntitySource
import typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.RemoteEntitySourceDocument
...
object srcGenKafkaMod {
  ...
  object kafka {
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IRemoteEntitySourceDocument because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.IConsumedKafkaService because var conflicts: applicationId, containerAsFolderBase, endpointId, environmentType, icon, id, isLoaded, metadataHash, minimumMxVersion, model, recommendedMxVersion, serviceName, structureTypeName, unit, validated, validatedEntities, version. Inlined  */ @JSImport("mendixmodelsdk/src/gen/kafka", "kafka.ConsumedKafkaService")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IMappedValue because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.ICachedMappedValue because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.IKafkaMappedValue because var conflicts: containerAsAttribute, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/kafka", "kafka.KafkaMappedValue")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.IMaterializedRemoteEntitySource because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.IKafkaRemoteEntitySource because var conflicts: containerAsEntity, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/kafka", "kafka.KafkaRemoteEntitySource")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenProjectsMod.projects.IModuleDocument because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenProjectsMod.projects.IDocument because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.IPublishedKafkaService because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/kafka", "kafka.PublishedKafkaService")
    @js.native
