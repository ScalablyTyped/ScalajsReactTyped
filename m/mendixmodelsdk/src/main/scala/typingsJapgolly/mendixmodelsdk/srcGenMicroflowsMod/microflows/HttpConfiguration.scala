...
open class HttpConfiguration protected () extends Element[IModel] {
  ...
  /**
    ...
    */
  def newHttpMethod: typingsJapgolly.mendixmodelsdk.srcGenServicesMod.services.HttpMethod = js.native
  def newHttpMethod_=(newValue: typingsJapgolly.mendixmodelsdk.srcGenServicesMod.services.HttpMethod): Unit = js.native
