...
object AggregateListAction {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): AggregateListAction = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[AggregateListAction]
