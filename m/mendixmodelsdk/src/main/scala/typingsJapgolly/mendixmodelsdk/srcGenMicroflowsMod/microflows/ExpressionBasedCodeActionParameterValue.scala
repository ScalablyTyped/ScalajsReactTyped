...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.ExpressionBasedCodeActionParameterValue")
@js.native
open class ExpressionBasedCodeActionParameterValue protected () extends CodeActionParameterValue {
  def this(
    model: AbstractModel,
