...
- typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.IMicroflowParameterBase because Already inherited
- typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.INanoflowParameter because var conflicts: containerAsMicroflow, containerAsRule, id, isLoaded, model, name, parameterType, qualifiedName, structureTypeName, `type`, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/microflows", "microflows.NanoflowParameter")
@js.native
