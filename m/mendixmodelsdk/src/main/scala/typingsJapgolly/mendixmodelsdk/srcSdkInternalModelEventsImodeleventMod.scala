...
object srcSdkInternalModelEventsImodeleventMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalModelEventsImodeleventMod.IFileEvent
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalModelEventsImodeleventMod.IDeltaEvent
  */
  trait IModelEvent extends StObject
  object IModelEvent {
    
    inline def IDeltaEvent(deltas: js.Array[Delta], id: Double): typingsJapgolly.mendixmodelsdk.srcSdkInternalModelEventsImodeleventMod.IDeltaEvent = {
      val __obj = js.Dynamic.literal(deltas = deltas.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("deltas")
      __obj.asInstanceOf[typingsJapgolly.mendixmodelsdk.srcSdkInternalModelEventsImodeleventMod.IDeltaEvent]
    }
    
    inline def IFileEvent(files: js.Array[String], id: Double): typingsJapgolly.mendixmodelsdk.srcSdkInternalModelEventsImodeleventMod.IFileEvent = {
      val __obj = js.Dynamic.literal(files = files.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("fileChanges")
      __obj.asInstanceOf[typingsJapgolly.mendixmodelsdk.srcSdkInternalModelEventsImodeleventMod.IFileEvent]
    }
  }
}
