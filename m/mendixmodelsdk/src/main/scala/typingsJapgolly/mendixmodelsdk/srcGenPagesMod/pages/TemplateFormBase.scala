...
- typingsJapgolly.mendixmodelsdk.srcGenPagesMod.pages.ITemplateFormBase because var conflicts: containerAsFolderBase, id, isLoaded, model, structureTypeName, unit. Inlined displayName, documentationUrl, templateCategory, templateCategoryWeight */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.TemplateFormBase")
@js.native
