...
@JSImport("mendixmodelsdk/src/gen/pages", "pages.LayoutModeType")
@js.native
open class LayoutModeType protected () extends AbstractEnum {
...
object LayoutModeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.LayoutModeType.Headline")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.LayoutModeType.Sidebar")
  @js.native
