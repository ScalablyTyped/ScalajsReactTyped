...
- typingsJapgolly.mendixmodelsdk.srcGenPagesMod.pages.IPageParameter because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsPage, name, parameterType */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.PageParameter")
@js.native
