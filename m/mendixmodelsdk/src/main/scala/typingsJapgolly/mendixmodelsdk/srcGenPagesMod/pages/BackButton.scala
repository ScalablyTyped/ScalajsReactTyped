...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/pages", "pages.BackButton")
@js.native
open class BackButton protected () extends Button {
  def this(
    model: AbstractModel,
...
object BackButton {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.BackButton.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.BackButton.versionInfo")
  @js.native
