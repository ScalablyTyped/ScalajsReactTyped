...
@JSImport("mendixmodelsdk/src/gen/pages", "pages.ClickTypeType")
@js.native
open class ClickTypeType protected () extends AbstractEnum {
...
object ClickTypeType {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.ClickTypeType.Double")
  @js.native
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/pages", "pages.ClickTypeType.Single")
  @js.native
