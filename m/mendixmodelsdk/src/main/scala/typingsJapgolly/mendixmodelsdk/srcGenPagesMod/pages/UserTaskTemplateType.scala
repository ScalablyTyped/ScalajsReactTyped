...
- typingsJapgolly.mendixmodelsdk.srcGenPagesMod.pages.IUserTaskTemplateType because var conflicts: containerAsPageTemplate, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.UserTaskTemplateType")
@js.native
