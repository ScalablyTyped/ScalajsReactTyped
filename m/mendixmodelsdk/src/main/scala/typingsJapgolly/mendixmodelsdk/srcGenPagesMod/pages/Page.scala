...
- typingsJapgolly.mendixmodelsdk.srcGenPagesMod.pages.IPage because var conflicts: containerAsFolderBase, id, isLoaded, model, structureTypeName, unit. Inlined parameters, layoutCall, allowedRoles, allowedRolesQualifiedNames */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.Page")
@js.native
