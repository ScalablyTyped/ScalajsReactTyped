...
- typingsJapgolly.mendixmodelsdk.srcGenPagesMod.pages.IWorkflowTemplateType because Already inherited
- typingsJapgolly.mendixmodelsdk.srcGenPagesMod.pages.IWorkflowOverviewTemplateType because var conflicts: containerAsPageTemplate, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/pages", "pages.WorkflowOverviewTemplateType")
@js.native
