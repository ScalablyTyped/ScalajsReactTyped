...
object srcGenSecurityMod {
  ...
  object security {
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.IModuleRole because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsModuleSecurity, name */ @JSImport("mendixmodelsdk/src/gen/security", "security.ModuleRole")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.IModuleSecurity because var conflicts: id, isLoadable, isLoaded, isReadOnly, model, structureTypeName, unit. Inlined containerAsModule, moduleRoles */ @JSImport("mendixmodelsdk/src/gen/security", "security.ModuleSecurity")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.IProjectSecurity because var conflicts: containerAsProject, id, isLoaded, model, structureTypeName, unit. Inlined userRoles */ @JSImport("mendixmodelsdk/src/gen/security", "security.ProjectSecurity")
    @js.native
    ...
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IAbstractElement because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcSdkInternalElementsMod.IElement because Already inherited
    - typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.IUserRole because var conflicts: id, isLoaded, model, structureTypeName, unit. Inlined containerAsProjectSecurity, name */ @JSImport("mendixmodelsdk/src/gen/security", "security.UserRole")
    @js.native
