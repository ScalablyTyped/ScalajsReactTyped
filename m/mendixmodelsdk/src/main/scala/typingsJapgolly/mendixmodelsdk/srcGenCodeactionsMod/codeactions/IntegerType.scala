...
- typingsJapgolly.mendixmodelsdk.srcGenCodeactionsMod.codeactions.IIntegerType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/codeactions", "codeactions.IntegerType")
@js.native
