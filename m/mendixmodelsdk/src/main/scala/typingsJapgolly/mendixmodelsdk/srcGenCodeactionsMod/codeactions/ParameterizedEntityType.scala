...
- typingsJapgolly.mendixmodelsdk.srcGenCodeactionsMod.codeactions.IEntityType because Already inherited
- typingsJapgolly.mendixmodelsdk.srcGenCodeactionsMod.codeactions.IParameterizedEntityType because var conflicts: containerAsBasicParameterType, containerAsCodeAction, containerAsListType, id, isLoaded, model, structureTypeName, unit. Inlined typeParameter */ @JSImport("mendixmodelsdk/src/gen/codeactions", "codeactions.ParameterizedEntityType")
@js.native
