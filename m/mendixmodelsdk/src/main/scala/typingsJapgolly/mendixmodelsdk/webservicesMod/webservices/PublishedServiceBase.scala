...
- typingsJapgolly.mendixmodelsdk.webservicesMod.webservices.IPublishedServiceBase because var conflicts: containerAsFolderBase, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/dist/gen/webservices", "webservices.PublishedServiceBase")
@js.native
