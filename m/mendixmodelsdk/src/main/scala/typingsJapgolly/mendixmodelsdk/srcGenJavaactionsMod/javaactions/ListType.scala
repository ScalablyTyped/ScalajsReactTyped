...
- typingsJapgolly.mendixmodelsdk.srcGenJavaactionsMod.javaactions.IListType because var conflicts: containerAsBasicParameterType, containerAsJavaAction, containerAsJavaActionParameter, containerAsListType, id, isLoaded, model, structureTypeName, unit. Inlined parameter */ @JSImport("mendixmodelsdk/src/gen/javaactions", "javaactions.ListType")
@js.native
