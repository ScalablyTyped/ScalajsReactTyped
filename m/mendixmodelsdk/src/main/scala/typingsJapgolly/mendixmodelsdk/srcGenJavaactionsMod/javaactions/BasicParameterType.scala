...
- typingsJapgolly.mendixmodelsdk.srcGenJavaactionsMod.javaactions.IBasicParameterType because var conflicts: containerAsJavaActionParameter, id, isLoaded, model, structureTypeName, unit. Inlined `type` */ @JSImport("mendixmodelsdk/src/gen/javaactions", "javaactions.BasicParameterType")
@js.native
