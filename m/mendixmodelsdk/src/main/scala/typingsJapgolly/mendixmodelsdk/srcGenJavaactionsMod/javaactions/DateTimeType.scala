...
- typingsJapgolly.mendixmodelsdk.srcGenJavaactionsMod.javaactions.IDateTimeType because var conflicts: containerAsBasicParameterType, containerAsJavaAction, containerAsJavaActionParameter, id, isLoaded, model, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/javaactions", "javaactions.DateTimeType")
@js.native
