...
open class EntityTypeJavaActionParameterValue protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue {
  def this(
    model: AbstractModel,
...
object EntityTypeJavaActionParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue]
  ...
  ): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.EntityTypeJavaActionParameterValue]
