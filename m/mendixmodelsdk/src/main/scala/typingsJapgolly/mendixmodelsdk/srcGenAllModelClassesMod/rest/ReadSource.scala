...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ReadSource")
@js.native
open class ReadSource protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.ReadSource {
  def this(
    model: AbstractModel,
...
object ReadSource {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.ReadSource = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.ReadSource]
