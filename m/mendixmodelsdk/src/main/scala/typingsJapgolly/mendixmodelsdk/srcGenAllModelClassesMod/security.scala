...
object security {
  ...
  open class AccessRuleContainerBase protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.AccessRuleContainerBase {
    def this(
      model: AbstractModel,
  ...
  open class DemoUser protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.DemoUser {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class FileDocumentAccessRuleContainer protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.FileDocumentAccessRuleContainer {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class ImageAccessRuleContainer protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.ImageAccessRuleContainer {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class ModuleRole protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.ModuleRole {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class ModuleSecurity protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.ModuleSecurity {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PasswordPolicySettings protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.PasswordPolicySettings {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class ProjectSecurity protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.ProjectSecurity {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class SecurityLevel protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.SecurityLevel {
  ...
  open class UserRole protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenSecurityMod.security.UserRole {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
