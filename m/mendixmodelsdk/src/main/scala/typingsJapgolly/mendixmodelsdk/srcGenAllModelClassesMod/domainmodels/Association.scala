...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.Association")
@js.native
open class Association protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenDomainmodelsMod.domainmodels.Association {
  def this(
    model: AbstractModel,
...
object Association {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.Association.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "domainmodels.Association.versionInfo")
  @js.native
