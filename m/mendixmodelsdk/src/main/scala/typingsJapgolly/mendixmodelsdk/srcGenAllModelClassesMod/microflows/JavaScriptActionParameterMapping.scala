...
open class JavaScriptActionParameterMapping protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.JavaScriptActionParameterMapping {
  def this(
    model: AbstractModel,
...
object JavaScriptActionParameterMapping {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.JavaScriptActionParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.JavaScriptActionParameterMapping]
  ...
  /* static member */
  inline def createIn(
    container: typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.JavaScriptActionCallAction
  ): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.JavaScriptActionParameterMapping = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.JavaScriptActionParameterMapping]
