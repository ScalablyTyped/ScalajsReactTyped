...
object texts {
  ...
  open class SystemText protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenTextsMod.texts.SystemText {
    def this(
      model: AbstractModel,
  ...
  open class SystemTextCollection protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenTextsMod.texts.SystemTextCollection {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class Text protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenTextsMod.texts.Text {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class Translation protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenTextsMod.texts.Translation {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
