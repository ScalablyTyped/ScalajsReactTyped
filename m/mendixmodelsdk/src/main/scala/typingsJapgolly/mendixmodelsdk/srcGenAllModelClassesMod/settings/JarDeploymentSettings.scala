...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.JarDeploymentSettings")
@js.native
open class JarDeploymentSettings protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenSettingsMod.settings.JarDeploymentSettings {
  def this(
    model: AbstractModel,
...
object JarDeploymentSettings {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.JarDeploymentSettings.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "settings.JarDeploymentSettings.versionInfo")
  @js.native
