...
/**
  ...
  */
/* note: abstract class */ @JSImport("mendixmodelsdk/src/gen/all-model-classes", "expressions.Expression")
@js.native
open class Expression protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenExpressionsMod.expressions.Expression {
  def this(
    model: AbstractModel,
