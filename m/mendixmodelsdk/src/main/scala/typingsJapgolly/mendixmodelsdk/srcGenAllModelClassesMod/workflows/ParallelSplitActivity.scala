...
open class ParallelSplitActivity protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.ParallelSplitActivity {
  def this(
    model: AbstractModel,
...
object ParallelSplitActivity {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.ParallelSplitActivity = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.ParallelSplitActivity]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.Flow): typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.ParallelSplitActivity = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenWorkflowsMod.workflows.ParallelSplitActivity]
