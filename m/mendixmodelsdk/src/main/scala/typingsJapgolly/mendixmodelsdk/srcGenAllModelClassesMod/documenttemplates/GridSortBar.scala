...
open class GridSortBar protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar {
  def this(
    model: AbstractModel,
...
object GridSortBar {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar]
  ...
  /**
    ...
    */
  /* static member */
  inline def createIn(container: typingsJapgolly.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.Grid): typingsJapgolly.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.GridSortBar]
