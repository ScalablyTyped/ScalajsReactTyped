...
open class MicroflowJavaActionParameterValue protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.MicroflowJavaActionParameterValue {
  def this(
    model: AbstractModel,
...
object MicroflowJavaActionParameterValue {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.MicroflowJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.MicroflowJavaActionParameterValue]
  ...
  ): typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.MicroflowJavaActionParameterValue = ^.asInstanceOf[js.Dynamic].applyDynamic("createIn")(container.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenMicroflowsMod.microflows.MicroflowJavaActionParameterValue]
