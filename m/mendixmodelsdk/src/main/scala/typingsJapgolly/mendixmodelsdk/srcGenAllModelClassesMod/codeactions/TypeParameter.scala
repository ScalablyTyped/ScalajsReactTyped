...
open class TypeParameter protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenCodeactionsMod.codeactions.TypeParameter {
  def this(
    model: AbstractModel,
...
object TypeParameter {
  ...
  /**
    ...
    */
  /* static member */
  inline def create(model: IModel): typingsJapgolly.mendixmodelsdk.srcGenCodeactionsMod.codeactions.TypeParameter = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(model.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mendixmodelsdk.srcGenCodeactionsMod.codeactions.TypeParameter]
