...
object mlmappings {
  ...
  open class MLMappingDocument protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.MLMappingDocument {
    def this(
      model: AbstractModel,
  ...
  open class MLModelEntityMappings protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.MLModelEntityMappings {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class MLModelMappings protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.MLModelMappings {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class TensorDimension protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.TensorDimension {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class TensorMappingElement protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.TensorMappingElement {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class TensorType protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenMlmappingsMod.mlmappings.TensorType {
