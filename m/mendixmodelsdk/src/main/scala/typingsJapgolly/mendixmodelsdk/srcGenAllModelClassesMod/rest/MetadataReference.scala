...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.MetadataReference")
@js.native
open class MetadataReference protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.MetadataReference {
  def this(
    model: AbstractModel,
...
object MetadataReference {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.MetadataReference.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.MetadataReference.versionInfo")
  @js.native
