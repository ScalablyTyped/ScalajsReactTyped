...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.Title")
@js.native
open class Title protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenDocumenttemplatesMod.documenttemplates.Title {
  def this(
    model: AbstractModel,
...
object Title {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.Title.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "documenttemplates.Title.versionInfo")
  @js.native
