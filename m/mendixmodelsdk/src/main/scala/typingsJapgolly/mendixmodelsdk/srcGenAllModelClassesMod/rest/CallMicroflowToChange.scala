...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.CallMicroflowToChange")
@js.native
open class CallMicroflowToChange protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.CallMicroflowToChange {
  def this(
    model: AbstractModel,
...
object CallMicroflowToChange {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.CallMicroflowToChange.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.CallMicroflowToChange.versionInfo")
  @js.native
