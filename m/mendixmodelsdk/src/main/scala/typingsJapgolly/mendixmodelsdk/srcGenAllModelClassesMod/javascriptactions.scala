...
object javascriptactions {
  ...
  open class JavaScriptAction protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenJavascriptactionsMod.javascriptactions.JavaScriptAction {
    def this(
      model: AbstractModel,
  ...
  open class JavaScriptActionParameter protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenJavascriptactionsMod.javascriptactions.JavaScriptActionParameter {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class NanoflowJavaScriptActionParameterType protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenJavascriptactionsMod.javascriptactions.NanoflowJavaScriptActionParameterType {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
