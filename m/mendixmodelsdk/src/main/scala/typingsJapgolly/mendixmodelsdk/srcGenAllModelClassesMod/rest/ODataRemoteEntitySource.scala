...
/**
  ...
  */
@JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ODataRemoteEntitySource")
@js.native
open class ODataRemoteEntitySource protected ()
  extends typingsJapgolly.mendixmodelsdk.srcGenRestMod.rest.ODataRemoteEntitySource {
  def this(
    model: AbstractModel,
...
object ODataRemoteEntitySource {
  ...
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ODataRemoteEntitySource.structureTypeName")
  @js.native
  def structureTypeName: String = js.native
  inline def structureTypeName_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("structureTypeName")(x.asInstanceOf[js.Any])
  
  /* static member */
  @JSImport("mendixmodelsdk/src/gen/all-model-classes", "rest.ODataRemoteEntitySource.versionInfo")
  @js.native
