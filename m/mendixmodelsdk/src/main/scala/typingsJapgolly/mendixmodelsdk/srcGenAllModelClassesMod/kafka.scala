...
object kafka {
  ...
  open class ConsumedKafkaService protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.ConsumedKafkaService {
    def this(
      model: AbstractModel,
  ...
  open class KafkaMappedValue protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.KafkaMappedValue {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class KafkaRemoteEntitySource protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.KafkaRemoteEntitySource {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedKafkaResource protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.PublishedKafkaResource {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedKafkaResourceAttribute protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.PublishedKafkaResourceAttribute {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
  ...
  open class PublishedKafkaService protected ()
    extends typingsJapgolly.mendixmodelsdk.srcGenKafkaMod.kafka.PublishedKafkaService {
    def this(
      model: AbstractModel,
      structureTypeName: String,
      id: String,
