...
object srcGenScheduledeventsMod {
  ...
  object scheduledevents {
    ...
    - typingsJapgolly.mendixmodelsdk.srcGenScheduledeventsMod.scheduledevents.IScheduledEvent because var conflicts: containerAsFolderBase, documentation, excluded, id, isLoaded, model, name, qualifiedName, structureTypeName, unit. Inlined  */ @JSImport("mendixmodelsdk/src/gen/scheduledevents", "scheduledevents.ScheduledEvent")
    @js.native
