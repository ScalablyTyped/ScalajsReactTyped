...
object meteorAccountsBaseMod {
  ...
  object Accounts {
    ...
    @js.native
    def emailTemplates: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailTemplates = js.native
    inline def emailTemplates_=(x: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailTemplates): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("emailTemplates")(x.asInstanceOf[js.Any])
    ...
    @js.native
    def urls: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.URLS = js.native
    inline def urls_=(x: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.URLS): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("urls")(x.asInstanceOf[js.Any])
  ...
  object EmailFields {
    ...
    inline def apply(): typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields]
    }
    
    extension [Self <: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields](x: Self) {
  ...
  trait EmailTemplates extends StObject {
    ...
    var enrollAccount: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields
    
    var from: String
    
    var headers: js.UndefOr[typingsJapgolly.meteorTypings.meteorAccountsBaseMod.Header] = js.undefined
    
    var resetPassword: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields
    
    var siteName: String
    
    var verifyEmail: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields
  }
  object EmailTemplates {
    
    inline def apply(
      enrollAccount: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields,
      from: String,
      resetPassword: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields,
      siteName: String,
      verifyEmail: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields
    ): typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailTemplates = {
      ...
      __obj.asInstanceOf[typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailTemplates]
    }
    
    extension [Self <: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailTemplates](x: Self) {
      
      inline def setEnrollAccount(value: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields): Self = StObject.set(x, "enrollAccount", value.asInstanceOf[js.Any])
      
      inline def setFrom(value: String): Self = StObject.set(x, "from", value.asInstanceOf[js.Any])
      
      inline def setHeaders(value: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.Header): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
      
      inline def setHeadersUndefined: Self = StObject.set(x, "headers", js.undefined)
      
      inline def setResetPassword(value: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields): Self = StObject.set(x, "resetPassword", value.asInstanceOf[js.Any])
      
      inline def setSiteName(value: String): Self = StObject.set(x, "siteName", value.asInstanceOf[js.Any])
      
      inline def setVerifyEmail(value: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.EmailFields): Self = StObject.set(x, "verifyEmail", value.asInstanceOf[js.Any])
    }
  }
  ...
  object URLS {
    ...
    inline def apply(enrollAccount: String => String, resetPassword: String => String, verifyEmail: String => String): typingsJapgolly.meteorTypings.meteorAccountsBaseMod.URLS = {
      ...
      __obj.asInstanceOf[typingsJapgolly.meteorTypings.meteorAccountsBaseMod.URLS]
    }
    
    extension [Self <: typingsJapgolly.meteorTypings.meteorAccountsBaseMod.URLS](x: Self) {
