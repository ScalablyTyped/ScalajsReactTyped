...
object meteorTinyTestMod {
  ...
  object Tinytest {
    ...
    inline def add(
      description: String,
      func: js.Function1[
          /* test */ typingsJapgolly.meteorTypings.meteorTinyTestMod.ITinytestAssertions, 
          Unit
        ]
  ...
  object ILengthAble {
    ...
    inline def apply(length: Double): typingsJapgolly.meteorTypings.meteorTinyTestMod.ILengthAble = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.meteorTypings.meteorTinyTestMod.ILengthAble]
    }
    
    extension [Self <: typingsJapgolly.meteorTypings.meteorTinyTestMod.ILengthAble](x: Self) {
  ...
  trait ITinytestAssertions extends StObject {
    ...
    def length(obj: typingsJapgolly.meteorTypings.meteorTinyTestMod.ILengthAble, expected_length: Double): Unit = js.native
    def length(
      obj: typingsJapgolly.meteorTypings.meteorTinyTestMod.ILengthAble,
