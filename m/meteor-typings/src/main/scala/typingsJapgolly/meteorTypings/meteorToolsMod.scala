...
import typingsJapgolly.meteorTypings.anon.Bare
...
import typingsJapgolly.meteorTypings.anon.Unordered
...
object meteorToolsMod {
  ...
  object Package {
    ...
    inline def onTest(func: js.Function1[/* api */ typingsJapgolly.meteorTypings.meteorToolsMod.PackageAPI, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onTest")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
    
    inline def onUse(func: js.Function1[/* api */ typingsJapgolly.meteorTypings.meteorToolsMod.PackageAPI, Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("onUse")(func.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  trait PackageAPI
    extends StObject
       with Instantiable0[typingsJapgolly.meteorTypings.meteorToolsMod.PackageAPI] {
