...
import typingsJapgolly.mobservable.libInterfacesMod.IArrayChange
import typingsJapgolly.mobservable.libInterfacesMod.IArraySplice
import typingsJapgolly.mobservable.libInterfacesMod.IDependencyTree
import typingsJapgolly.mobservable.libInterfacesMod.IObjectChange
import typingsJapgolly.mobservable.libInterfacesMod.IObservableArray
import typingsJapgolly.mobservable.libInterfacesMod.IObservableValue
import typingsJapgolly.mobservable.libInterfacesMod.IObserverTree
import typingsJapgolly.mobservable.libInterfacesMod.ITransitionEvent
import typingsJapgolly.mobservable.libInterfacesMod.Lambda
import typingsJapgolly.mobservable.libObservablemapMod.Entries
import typingsJapgolly.mobservable.libObservablemapMod.KeyValueMap
import typingsJapgolly.mobservable.libSimpleeventemitterMod.default
import typingsJapgolly.mobservable.libTransformMod.ITransformer
...
object mod {
  ...
  open class ObservableMap[V] ()
    extends typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V] {
  ...
  inline def map[V](): typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("map")().asInstanceOf[typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V]]
  inline def map[V](initialValues: Unit, valueModifier: js.Function): typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("map")(initialValues.asInstanceOf[js.Any], valueModifier.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V]]
  inline def map[V](initialValues: KeyValueMap[V]): typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V] = ^.asInstanceOf[js.Dynamic].applyDynamic("map")(initialValues.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V]]
  inline def map[V](initialValues: KeyValueMap[V], valueModifier: js.Function): typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V] = (^.asInstanceOf[js.Dynamic].applyDynamic("map")(initialValues.asInstanceOf[js.Any], valueModifier.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[V]]
  ...
  inline def observe[T](
    observableMap: typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[T],
    listener: js.Function1[
      /* change */ IObjectChange[T, typingsJapgolly.mobservable.libObservablemapMod.ObservableMap[T]], 
      Unit
    ]
