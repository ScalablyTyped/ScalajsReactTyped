...
object observe extends js.Object {
  ...
  def apply[T](
    observableMap: typingsJapgolly.mobservable.observablemapMod.ObservableMap[T],
    listener: js.Function1[
      /* change */ IObjectChange[T, typingsJapgolly.mobservable.observablemapMod.ObservableMap[T]], 
      Unit
    ]
  ): Lambda = js.native
