...
import typingsJapgolly.minizlib.minizlibStrings.buffer
...
object mod {
  ...
  open class Deflate protected ()
    extends StObject
       with Zlib {
    def this(opts: ZlibOptions & typingsJapgolly.node.zlibMod.ZlibOptions) = this()
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.minizlib.minizlibStrings.BrotliCompress
    - typingsJapgolly.minizlib.minizlibStrings.BrotliDecompress
  */
  trait BrotliMode extends StObject
  object BrotliMode {
    
    inline def BrotliCompress: typingsJapgolly.minizlib.minizlibStrings.BrotliCompress = "BrotliCompress".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.BrotliCompress]
    
    inline def BrotliDecompress: typingsJapgolly.minizlib.minizlibStrings.BrotliDecompress = "BrotliDecompress".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.BrotliDecompress]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.minizlib.minizlibStrings.Gzip
    - typingsJapgolly.minizlib.minizlibStrings.Gunzip
    - typingsJapgolly.minizlib.minizlibStrings.Deflate
    - typingsJapgolly.minizlib.minizlibStrings.Inflate
    - typingsJapgolly.minizlib.minizlibStrings.DeflateRaw
    - typingsJapgolly.minizlib.minizlibStrings.InflateRaw
    - typingsJapgolly.minizlib.minizlibStrings.Unzip
  */
  trait ZlibMode extends StObject
  object ZlibMode {
    
    inline def Deflate: typingsJapgolly.minizlib.minizlibStrings.Deflate = "Deflate".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.Deflate]
    
    inline def DeflateRaw: typingsJapgolly.minizlib.minizlibStrings.DeflateRaw = "DeflateRaw".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.DeflateRaw]
    
    inline def Gunzip: typingsJapgolly.minizlib.minizlibStrings.Gunzip = "Gunzip".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.Gunzip]
    
    inline def Gzip: typingsJapgolly.minizlib.minizlibStrings.Gzip = "Gzip".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.Gzip]
    
    inline def Inflate: typingsJapgolly.minizlib.minizlibStrings.Inflate = "Inflate".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.Inflate]
    
    inline def InflateRaw: typingsJapgolly.minizlib.minizlibStrings.InflateRaw = "InflateRaw".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.InflateRaw]
    
    inline def Unzip: typingsJapgolly.minizlib.minizlibStrings.Unzip = "Unzip".asInstanceOf[typingsJapgolly.minizlib.minizlibStrings.Unzip]
  }
