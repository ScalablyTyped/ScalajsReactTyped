...
import typingsJapgolly.maximMazurokGapiClientTesting.gapi.client.testing.FileReference
import typingsJapgolly.maximMazurokGapiClientTesting.gapi.client.testing.TestMatrix
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(resource: FileReference): Accesstoken = {
    ...
    extension [Self <: Accesstoken](x: Self) {
      ...
      inline def setResource(value: FileReference): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Callback {
    ...
    inline def apply(projectId: String, testMatrixId: String): Callback = {
  ...
  object Fields {
    ...
    inline def apply(projectId: String, resource: TestMatrix): Fields = {
    ...
    extension [Self <: Fields](x: Self) {
      ...
      inline def setResource(value: TestMatrix): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    inline def apply(projectId: String): Key = {
