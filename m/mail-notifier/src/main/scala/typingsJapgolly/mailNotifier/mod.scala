package typingsJapgolly.mailNotifier

import japgolly.scalajs.react.Callback
import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.mailNotifier.mailNotifierStrings.connected
import typingsJapgolly.mailNotifier.mailNotifierStrings.end
import typingsJapgolly.mailNotifier.mailNotifierStrings.error
import typingsJapgolly.mailNotifier.mailNotifierStrings.high
import typingsJapgolly.mailNotifier.mailNotifierStrings.low
import typingsJapgolly.mailNotifier.mailNotifierStrings.mail
import typingsJapgolly.mailNotifier.mailNotifierStrings.normal
...
object mod {
  ...
  trait Config
    extends StObject
       with typingsJapgolly.imap.mod.Config {
  ...
  object NotifierEvents {
    ...
    inline def apply(connected: Callback, end: Callback, error: js.Error => Callback, mail: EmailContent => Callback): NotifierEvents = {
      val __obj = js.Dynamic.literal(connected = connected.toJsFn, end = end.toJsFn, error = js.Any.fromFunction1((t0: js.Error) => error(t0).runNow()), mail = js.Any.fromFunction1((t0: EmailContent) => mail(t0).runNow()))
    ...
    extension [Self <: NotifierEvents](x: Self) {
      ...
      inline def setMail(value: EmailContent => Callback): Self = StObject.set(x, "mail", js.Any.fromFunction1((t0: EmailContent) => value(t0).runNow()))
    }
  }
}
