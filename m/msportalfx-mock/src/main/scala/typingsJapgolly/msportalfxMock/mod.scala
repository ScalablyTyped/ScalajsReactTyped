...
import typingsJapgolly.msportalfxMock.libSrcHttpsProxyHttpsProxyMod.HttpsProxy.ProxyOptions
import typingsJapgolly.msportalfxMock.libSrcHttpsProxyHttpsProxyMod.HttpsProxy.ProxyServer
import typingsJapgolly.msportalfxMock.libSrcHttpsProxyHttpsProxyMod.HttpsProxy.ServerOptions
import typingsJapgolly.msportalfxMock.libSrcMockFxLoggerMod.LoggerType
import typingsJapgolly.msportalfxMock.libSrcMockFxMod.MockFx.Configuration
import typingsJapgolly.msportalfxMock.libSrcMockFxMod.MockFx.Endpoints
import typingsJapgolly.msportalfxMock.libSrcMockFxMod.MockFx.TargetDefinition
import typingsJapgolly.msportalfxMock.libSrcMockFxTargetsArmMod.ARMDefinitionConfiguration
import typingsJapgolly.msportalfxMock.libSrcMockFxTargetsStorageMod.StorageDefinitionConfiguration
...
object mod {
  ...
  /* private */ open class MockFx ()
    extends typingsJapgolly.msportalfxMock.libSrcMockFxMod.MockFx
  /* static members */
  object MockFx {
    ...
    /**
      ...
      * @memberof MockFx
      */
    inline def create(config: Configuration): js.Promise[typingsJapgolly.msportalfxMock.libSrcMockFxMod.MockFx] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.msportalfxMock.libSrcMockFxMod.MockFx]]
  ...
  object RdfeProxy {
    ...
    inline def create(
      rdfeEndpoint: String,
      serverPort: Double,
      rdfeManager: typingsJapgolly.msportalfxMock.libSrcRdfeProxyRdfeManagerMod.RdfeManager.Manager
