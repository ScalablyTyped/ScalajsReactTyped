...
import typingsJapgolly.msportalfxMock.libSrcMockFxSystemMod.SSLCertificate
...
object libSrcMockFxServerMod {
  ...
  */
  ...
  - typingsJapgolly.node.httpMod.ServerOptions because var conflicts: keepAlive, keepAliveInitialDelay, noDelay. Inlined IncomingMessage, ServerResponse, maxHeaderSize, insecureHTTPParser */ trait ServerOptions
    extends StObject
       with TlsOptions {
  ...
  object ServerOptions {
    ...
    extension [Self <: ServerOptions](x: Self) {
      ...
      inline def setIncomingMessage(value: Instantiable1[/* socket */ Socket, typingsJapgolly.node.httpMod.IncomingMessage]): Self = StObject.set(x, "IncomingMessage", value.asInstanceOf[js.Any])
