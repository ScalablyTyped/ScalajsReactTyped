...
object anon {
  ...
  object PartialMDCToolbarAdapter {
    ...
    extension [Self <: PartialMDCToolbarAdapter](x: Self) {
      ...
      inline def setDeregisterScrollHandler(value: /* handler */ SpecificEventListener[scroll] => Callback): Self = StObject.set(x, "deregisterScrollHandler", js.Any.fromFunction1((t0: /* handler */ SpecificEventListener[scroll]) => value(t0).runNow()))
      ...
      inline def setNotifyChange(value: /* evtData */ MDCToolbarEventDetail => Callback): Self = StObject.set(x, "notifyChange", js.Any.fromFunction1((t0: /* evtData */ MDCToolbarEventDetail) => value(t0).runNow()))
      ...
      inline def setRegisterScrollHandler(value: /* handler */ SpecificEventListener[scroll] => Callback): Self = StObject.set(x, "registerScrollHandler", js.Any.fromFunction1((t0: /* handler */ SpecificEventListener[scroll]) => value(t0).runNow()))
      ...
      inline def setSetStyleForFixedAdjustElement(value: (/* property */ String, /* value */ String) => Callback): Self = StObject.set(x, "setStyleForFixedAdjustElement", js.Any.fromFunction2((t0: /* property */ String, t1: /* value */ String) => (value(t0, t1)).runNow()))
      
      inline def setSetStyleForFixedAdjustElementUndefined: Self = StObject.set(x, "setStyleForFixedAdjustElement", js.undefined)
      
      inline def setSetStyleForFlexibleRowElement(value: (/* property */ String, /* value */ String) => Callback): Self = StObject.set(x, "setStyleForFlexibleRowElement", js.Any.fromFunction2((t0: /* property */ String, t1: /* value */ String) => (value(t0, t1)).runNow()))
      
      inline def setSetStyleForFlexibleRowElementUndefined: Self = StObject.set(x, "setStyleForFlexibleRowElement", js.undefined)
      
      inline def setSetStyleForTitleElement(value: (/* property */ String, /* value */ String) => Callback): Self = StObject.set(x, "setStyleForTitleElement", js.Any.fromFunction2((t0: /* property */ String, t1: /* value */ String) => (value(t0, t1)).runNow()))
