...
import typingsJapgolly.mapboxGl.anon.Signal
import typingsJapgolly.mapboxGl.anon.X
...
object CustomSourceInterface {
  ...
  extension [Self <: CustomSourceInterface[?], T](x: Self & CustomSourceInterface[T]) {
    ...
    inline def setOnAdd(value: /* map */ Map => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction1((t0: /* map */ Map) => value(t0).runNow()))
    
    inline def setOnAddUndefined: Self = StObject.set(x, "onAdd", js.undefined)
    
    inline def setOnRemove(value: /* map */ Map => Callback): Self = StObject.set(x, "onRemove", js.Any.fromFunction1((t0: /* map */ Map) => value(t0).runNow()))
    ...
    inline def setUnloadTile(value: /* tileID */ X => Callback): Self = StObject.set(x, "unloadTile", js.Any.fromFunction1((t0: /* tileID */ X) => value(t0).runNow()))
