...
import typingsJapgolly.mapboxGl.mod.PositionOptions
...
trait FitBoundsOptions extends StObject {
  ...
  var fitBoundsOptions: js.UndefOr[typingsJapgolly.mapboxGl.mod.FitBoundsOptions] = js.undefined
...
object FitBoundsOptions {
  ...
  extension [Self <: FitBoundsOptions](x: Self) {
    ...
    inline def setFitBoundsOptions(value: typingsJapgolly.mapboxGl.mod.FitBoundsOptions): Self = StObject.set(x, "fitBoundsOptions", value.asInstanceOf[js.Any])
