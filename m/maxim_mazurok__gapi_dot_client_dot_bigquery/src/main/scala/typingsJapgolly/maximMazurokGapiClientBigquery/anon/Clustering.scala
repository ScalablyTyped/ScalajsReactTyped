package typingsJapgolly.maximMazurokGapiClientBigquery.anon

import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.RangePartitioning
import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.TableReference
import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.TimePartitioning
...
trait Clustering extends StObject {
  ...
  var clustering: js.UndefOr[typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.Clustering] = js.undefined
...
object Clustering {
  ...
  extension [Self <: Clustering](x: Self) {
    ...
    inline def setClustering(value: typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.Clustering): Self = StObject.set(x, "clustering", value.asInstanceOf[js.Any])
