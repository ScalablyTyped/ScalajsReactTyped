...
import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.QueryRequest
...
object ProjectId {
  ...
  inline def apply(projectId: String, resource: QueryRequest): ProjectId = {
