...
import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.Table
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait Autodetectschema extends StObject {
...
object Autodetectschema {
  ...
  inline def apply(datasetId: String, projectId: String, resource: Table, tableId: String): Autodetectschema = {
    ...
    __obj.asInstanceOf[Autodetectschema]
  }
  
  extension [Self <: Autodetectschema](x: Self) {
