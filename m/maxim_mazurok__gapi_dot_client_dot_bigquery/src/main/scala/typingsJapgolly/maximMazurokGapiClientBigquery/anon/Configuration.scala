...
import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.JobConfiguration
import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.JobReference
import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.JobStatistics
import typingsJapgolly.maximMazurokGapiClientBigquery.gapi.client.bigquery.JobStatus
