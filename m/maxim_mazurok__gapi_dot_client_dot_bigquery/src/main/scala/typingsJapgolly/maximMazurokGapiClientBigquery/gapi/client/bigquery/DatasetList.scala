...
trait DatasetList extends StObject {
  ...
  /**
    ...
    */
  var datasets: js.UndefOr[js.Array[typingsJapgolly.maximMazurokGapiClientBigquery.anon.DatasetReference]] = js.undefined
...
object DatasetList {
  ...
  extension [Self <: DatasetList](x: Self) {
    ...
    inline def setDatasets(value: js.Array[typingsJapgolly.maximMazurokGapiClientBigquery.anon.DatasetReference]): Self = StObject.set(x, "datasets", value.asInstanceOf[js.Any])
    
    inline def setDatasetsUndefined: Self = StObject.set(x, "datasets", js.undefined)
    
    inline def setDatasetsVarargs(value: typingsJapgolly.maximMazurokGapiClientBigquery.anon.DatasetReference*): Self = StObject.set(x, "datasets", js.Array(value*))
