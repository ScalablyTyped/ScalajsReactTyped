...
import typingsJapgolly.maximMazurokGapiClientCloudiot.gapi.client.cloudiot.Device
...
object Oauthtoken {
  ...
  inline def apply(name: String, resource: Device): Oauthtoken = {
  ...
  extension [Self <: Oauthtoken](x: Self) {
    ...
    inline def setResource(value: Device): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
