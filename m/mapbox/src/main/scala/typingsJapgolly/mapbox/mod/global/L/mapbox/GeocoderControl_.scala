...
object GeocoderControl_ {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(getURL = getURL.toJsFn, on = js.Any.fromFunction2(on), onAdd = js.Any.fromFunction1(onAdd), setID = js.Any.fromFunction1(setID), setTileJSON = js.Any.fromFunction1(setTileJSON), setURL = js.Any.fromFunction1(setURL))
