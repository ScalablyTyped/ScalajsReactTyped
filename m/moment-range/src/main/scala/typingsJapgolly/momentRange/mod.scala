package typingsJapgolly.momentRange

import typingsJapgolly.moment.mod.Moment
import typingsJapgolly.moment.mod.unitOfTime.Diff
import typingsJapgolly.momentRange.anon.Adjacent
import typingsJapgolly.momentRange.anon.ExcludeEnd
import typingsJapgolly.momentRange.anon.ExcludeStart
import typingsJapgolly.momentRange.anon.Exclusive
import typingsJapgolly.momentRange.anon.FnCall
import typingsJapgolly.momentRange.anon.MomentRangeNoneinpundefin
import typingsJapgolly.momentRange.anon.Step
import typingsJapgolly.momentRange.anon.`0`
...
object mod {
  ...
  object momentAugmentingMod {
    ...
    object Moment {
      ...
      inline def apply(isRange: Any => Boolean, within: DateRange => Boolean): typingsJapgolly.momentRange.mod.momentAugmentingMod.Moment = {
        val __obj = js.Dynamic.literal(isRange = js.Any.fromFunction1(isRange), within = js.Any.fromFunction1(within))
        __obj.asInstanceOf[typingsJapgolly.momentRange.mod.momentAugmentingMod.Moment]
      }
      
      extension [Self <: typingsJapgolly.momentRange.mod.momentAugmentingMod.Moment](x: Self) {
