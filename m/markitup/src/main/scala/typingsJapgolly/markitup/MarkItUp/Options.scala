package typingsJapgolly.markitup.MarkItUp
...
object Options {
  @scala.inline
  def apply(
    afterInsert: /* h */ MarkupSet => CallbackTo[String] = null,
    beforeInsert: /* h */ MarkupSet => CallbackTo[String] = null,
    ...
    if (afterInsert != null) __obj.updateDynamic("afterInsert")(js.Any.fromFunction1((t0: /* h */ typingsJapgolly.markitup.MarkItUp.MarkupSet) => afterInsert(t0).runNow()))
    if (beforeInsert != null) __obj.updateDynamic("beforeInsert")(js.Any.fromFunction1((t0: /* h */ typingsJapgolly.markitup.MarkItUp.MarkupSet) => beforeInsert(t0).runNow()))
