...
object MarkupSet {
  ...
  def apply(
    ...
    afterMultiInsert: /* h */ MarkupSet => CallbackTo[String] = null,
    altKey: js.UndefOr[Boolean] = js.undefined,
    beforeInsert: /* h */ MarkupSet => CallbackTo[String] = null,
    beforeMultiInsert: /* h */ MarkupSet => CallbackTo[String] = null,
    ...
    if (afterMultiInsert != null) __obj.updateDynamic("afterMultiInsert")(js.Any.fromFunction1((t0: /* h */ typingsJapgolly.markitup.MarkItUp.MarkupSet) => afterMultiInsert(t0).runNow()))
    ...
    if (beforeMultiInsert != null) __obj.updateDynamic("beforeMultiInsert")(js.Any.fromFunction1((t0: /* h */ typingsJapgolly.markitup.MarkItUp.MarkupSet) => beforeMultiInsert(t0).runNow()))
