package typingsJapgolly.memdown
...
object mod extends Shortcut {
  ...
  Instantiable0[typingsJapgolly.memdown.mod.MemDown[js.Object, js.Object]] {
    
    // tslint:disable-next-line no-unnecessary-generics
    def apply[K, V](): typingsJapgolly.memdown.mod.MemDown[K, V] = js.native
  }
