...
object Job {
  ...
  extension [Self <: Job](x: Self) {
    ...
    inline def setHttpTarget(value: HttpTarget): Self = StObject.set(x, "httpTarget", value.asInstanceOf[js.Any])
    ...
    inline def setPubsubTarget(value: PubsubTarget): Self = StObject.set(x, "pubsubTarget", value.asInstanceOf[js.Any])
