...
import typingsJapgolly.maximMazurokGapiClientRealtimebidding.gapi.client.realtimebidding.AddTargetedAppsRequest
...
trait PretargetingConfig extends StObject {
  ...
  /** Request body */
  var resource: AddTargetedAppsRequest
...
object PretargetingConfig {
  ...
  inline def apply(pretargetingConfig: String, resource: AddTargetedAppsRequest): PretargetingConfig = {
  ...
  extension [Self <: PretargetingConfig](x: Self) {
    ...
    inline def setResource(value: AddTargetedAppsRequest): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
