package typingsJapgolly.matrixAppservice

import typingsJapgolly.matrixAppservice.anon.Errcode
import typingsJapgolly.matrixAppservice.anon.HomeserverToken
...
object mod {
  ...
  open class AppService protected ()
    extends typingsJapgolly.matrixAppservice.libAppServiceMod.AppService {
    /**
  ...
  open class AppServiceRegistration ()
    extends typingsJapgolly.matrixAppservice.libAppServiceRegistrationMod.AppServiceRegistration {
  ...
  open class AppserviceHttpError protected ()
    extends typingsJapgolly.matrixAppservice.libAppserviceHttpErrorMod.AppserviceHttpError {
    /**
