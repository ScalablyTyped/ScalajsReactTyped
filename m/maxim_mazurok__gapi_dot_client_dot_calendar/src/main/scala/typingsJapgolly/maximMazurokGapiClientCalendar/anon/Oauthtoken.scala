...
import typingsJapgolly.maximMazurokGapiClientCalendar.gapi.client.calendar.AclRule
...
object Oauthtoken {
  ...
  inline def apply(calendarId: String, resource: AclRule, ruleId: String): Oauthtoken = {
    val __obj = js.Dynamic.literal(calendarId = calendarId.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any], ruleId = ruleId.asInstanceOf[js.Any])
