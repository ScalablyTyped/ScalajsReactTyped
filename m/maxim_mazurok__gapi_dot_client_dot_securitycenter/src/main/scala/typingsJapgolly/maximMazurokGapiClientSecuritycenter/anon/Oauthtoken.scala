...
import typingsJapgolly.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.RunAssetDiscoveryRequest
...
object Oauthtoken {
  ...
  inline def apply(parent: String, resource: RunAssetDiscoveryRequest): Oauthtoken = {
