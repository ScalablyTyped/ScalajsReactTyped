...
import typingsJapgolly.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.OrganizationSettings
...
object PrettyPrintQuotaUser {
  ...
  inline def apply(name: String, resource: OrganizationSettings): PrettyPrintQuotaUser = {
