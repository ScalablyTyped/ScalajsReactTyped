...
import typingsJapgolly.maximMazurokGapiClientSecuritycenter.gapi.client.securitycenter.GoogleCloudSecuritycenterV1BigQueryExport
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait BigQueryExportId extends StObject {
...
object BigQueryExportId {
  ...
  inline def apply(parent: String, resource: GoogleCloudSecuritycenterV1BigQueryExport): BigQueryExportId = {
    val __obj = js.Dynamic.literal(parent = parent.asInstanceOf[js.Any], resource = resource.asInstanceOf[js.Any])
    __obj.asInstanceOf[BigQueryExportId]
  }
  
  extension [Self <: BigQueryExportId](x: Self) {
