...
import typingsJapgolly.maximMazurokGapiClientYoutubereporting.gapi.client.youtubereporting.Job
...
object anon {
  ...
  object Accesstoken {
    ...
    inline def apply(jobId: String, reportId: String): Accesstoken = {
  ...
  object Alt {
    ...
    inline def apply(jobId: String): Alt = {
  ...
  object Callback {
    ...
    inline def apply(resource: Job): Callback = {
  ...
  trait IncludeSystemManaged extends StObject {
  ...
  object IncludeSystemManaged {
    
    inline def apply(): IncludeSystemManaged = {
      val __obj = js.Dynamic.literal()
  ...
  object JobId {
    ...
    inline def apply(jobId: String): JobId = {
      val __obj = js.Dynamic.literal(jobId = jobId.asInstanceOf[js.Any])
  ...
  object Key {
    ...
    inline def apply(resourceName: String): Key = {
