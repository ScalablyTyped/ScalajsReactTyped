package typingsJapgolly.metroSourceMap

import typingsJapgolly.metroSourceMap.anon.Column
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.metroSourceMap.mod.IndexMap
    - typingsJapgolly.metroSourceMap.mod.BasicSourceMap
  */
  trait MixedSourceMap extends StObject
  object MixedSourceMap {
    
    inline def BasicSourceMap(mappings: String, names: js.Array[String], sources: js.Array[String], version: Double): typingsJapgolly.metroSourceMap.mod.BasicSourceMap = {
      val __obj = js.Dynamic.literal(mappings = mappings.asInstanceOf[js.Any], names = names.asInstanceOf[js.Any], sources = sources.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.metroSourceMap.mod.BasicSourceMap]
    }
    
    inline def IndexMap(sections: js.Array[IndexMapSection], version: Double): typingsJapgolly.metroSourceMap.mod.IndexMap = {
      val __obj = js.Dynamic.literal(sections = sections.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.metroSourceMap.mod.IndexMap]
    }
  }
