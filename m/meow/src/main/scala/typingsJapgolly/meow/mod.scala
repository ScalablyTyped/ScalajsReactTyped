...
import typingsJapgolly.meow.meowBooleans.`false`
import typingsJapgolly.meow.meowBooleans.`true`
import typingsJapgolly.meow.meowStrings.boolean
import typingsJapgolly.meow.meowStrings.number
import typingsJapgolly.meow.meowStrings.string
import typingsJapgolly.std.ImportMeta
import typingsJapgolly.std.Record
import typingsJapgolly.typeFest.sourceCamelCasedPropertiesMod.CamelCasedProperties
import typingsJapgolly.typeFest.sourcePackageJsonMod.PackageJson
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.meow.meowStrings.string
    - typingsJapgolly.meow.meowStrings.boolean
    - typingsJapgolly.meow.meowStrings.number
  */
  trait FlagType extends StObject
  object FlagType {
    
    inline def boolean: typingsJapgolly.meow.meowStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.meow.meowStrings.boolean]
    
    inline def number: typingsJapgolly.meow.meowStrings.number = "number".asInstanceOf[typingsJapgolly.meow.meowStrings.number]
    
    inline def string: typingsJapgolly.meow.meowStrings.string = "string".asInstanceOf[typingsJapgolly.meow.meowStrings.string]
  }
