...
import typingsJapgolly.moment.ts3Dot1TypingsMomentMod.^
import typingsJapgolly.moment.ts3Dot1TypingsMomentMod.unitOfTime.All
import typingsJapgolly.moment.ts3Dot1TypingsMomentMod.unitOfTime.DurationConstructor
...
inline def ISO_8601: MomentBuiltinFormat = ^.asInstanceOf[js.Dynamic].selectDynamic("ISO_8601").asInstanceOf[MomentBuiltinFormat]
inline def ISO_8601_=(x: MomentBuiltinFormat): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ISO_8601")(x.asInstanceOf[js.Any])

inline def RFC_2822: MomentBuiltinFormat = ^.asInstanceOf[js.Dynamic].selectDynamic("RFC_2822").asInstanceOf[MomentBuiltinFormat]
...
inline def defaultFormat: String = ^.asInstanceOf[js.Dynamic].selectDynamic("defaultFormat").asInstanceOf[String]

inline def defaultFormatUtc: String = ^.asInstanceOf[js.Dynamic].selectDynamic("defaultFormatUtc").asInstanceOf[String]
...
inline def defineLocale(language: String): Locale_ = ^.asInstanceOf[js.Dynamic].applyDynamic("defineLocale")(language.asInstanceOf[js.Any]).asInstanceOf[Locale_]
...
inline def deprecationHandler: js.UndefOr[(js.Function2[/* name */ String | Null, /* msg */ String, Unit]) | Null] = ^.asInstanceOf[js.Dynamic].selectDynamic("deprecationHandler").asInstanceOf[js.UndefOr[(js.Function2[/* name */ String | Null, /* msg */ String, Unit]) | Null]]
inline def deprecationHandler_=(x: js.UndefOr[(js.Function2[/* name */ String | Null, /* msg */ String, Unit]) | Null]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("deprecationHandler")(x.asInstanceOf[js.Any])
...
inline def fn: Moment = ^.asInstanceOf[js.Dynamic].selectDynamic("fn").asInstanceOf[Moment]
...
inline def isDuration(d: Any): /* is moment.moment/ts3.1-typings/moment.Duration */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDuration")(d.asInstanceOf[js.Any]).asInstanceOf[/* is moment.moment/ts3.1-typings/moment.Duration */ Boolean]

inline def isMoment(m: Any): /* is moment.moment/ts3.1-typings/moment.Moment */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isMoment")(m.asInstanceOf[js.Any]).asInstanceOf[/* is moment.moment/ts3.1-typings/moment.Moment */ Boolean]
...
inline def suppressDeprecationWarnings: Boolean = ^.asInstanceOf[js.Dynamic].selectDynamic("suppressDeprecationWarnings").asInstanceOf[Boolean]
...
inline def updateLocale(language: String): Locale_ = ^.asInstanceOf[js.Dynamic].applyDynamic("updateLocale")(language.asInstanceOf[js.Any]).asInstanceOf[Locale_]
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Duration_
  - scala.Double
  - java.lang.String
  - typingsJapgolly.moment.ts3Dot1TypingsMomentMod.FromTo
  - typingsJapgolly.moment.ts3Dot1TypingsMomentMod.DurationInputObject
  - scala.Null
  - scala.Unit
*/
...
/* Rewritten from type alias, can be one of: 
  - java.lang.String
  - typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment
  - typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Duration_
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.moment.ts3Dot1TypingsMomentMod.MomentInputObject
  - scala.Null
  - scala.Unit
*/
type MomentInput = js.UndefOr[_MomentInput | (js.Array[Double | String]) | js.Date | String | Double | Null]
