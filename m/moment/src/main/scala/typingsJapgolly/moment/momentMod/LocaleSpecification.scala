package typingsJapgolly.moment.momentMod
...
object LocaleSpecification {
  ...
  /* x */ StringDictionary[js.Any] = null,
    ...
    isPM: /* input */ String => CallbackTo[Boolean] = null,
    longDateFormat: LongDateFormatSpec = null,
    meridiem: (/* hour */ Double, /* minute */ Double, /* isLower */ Boolean) => CallbackTo[String] = null,
    ...
    ordinal: /* n */ Double => CallbackTo[String] = null,
    ...
    if (isPM != null) __obj.updateDynamic("isPM")(js.Any.fromFunction1((t0: /* input */ java.lang.String) => isPM(t0).runNow()))
    if (longDateFormat != null) __obj.updateDynamic("longDateFormat")(longDateFormat.asInstanceOf[js.Any])
    if (meridiem != null) __obj.updateDynamic("meridiem")(js.Any.fromFunction3((t0: /* hour */ scala.Double, t1: /* minute */ scala.Double, t2: /* isLower */ scala.Boolean) => meridiem(t0, t1, t2).runNow()))
    ...
    if (ordinal != null) __obj.updateDynamic("ordinal")(js.Any.fromFunction1((t0: /* n */ scala.Double) => ordinal(t0).runNow()))
