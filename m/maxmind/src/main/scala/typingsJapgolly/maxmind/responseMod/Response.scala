...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.maxmind.responseMod.CountryResponse
  - typingsJapgolly.maxmind.responseMod.CityResponse
  - typingsJapgolly.maxmind.responseMod.AnonymousIPResponse
  - typingsJapgolly.maxmind.responseMod.AsnResponse
  - typingsJapgolly.maxmind.responseMod.ConnectionTypeResponse
  - typingsJapgolly.maxmind.responseMod.DomainResponse
  - typingsJapgolly.maxmind.responseMod.IspResponse
*/
