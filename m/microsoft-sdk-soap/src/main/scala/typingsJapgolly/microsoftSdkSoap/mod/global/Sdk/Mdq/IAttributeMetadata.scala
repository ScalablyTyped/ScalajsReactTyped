...
import typingsJapgolly.microsoftSdkSoap.microsoftSdkSoapStrings.`StateType    StatusType`
...
object IAttributeMetadata {
  ...
  extension [Self <: IAttributeMetadata](x: Self) {
    ...
    inline def setAttributeType(
      value: Customer | DateTime | Decimal | Double | EntityName | Integer | Lookup | typingsJapgolly.microsoftSdkSoap.microsoftSdkSoapStrings.ManagedProperty | Memo | Money | Owner | PartyList | Picklist | State | Status | Uniqueidentifier | Virtual
