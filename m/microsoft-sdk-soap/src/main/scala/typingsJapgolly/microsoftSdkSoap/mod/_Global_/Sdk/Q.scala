...
import typingsJapgolly.microsoftSdkSoap.mod._Global_.Sdk.Query.FetchExpression
import typingsJapgolly.microsoftSdkSoap.mod._Global_.Sdk.Query.QueryByAttribute
