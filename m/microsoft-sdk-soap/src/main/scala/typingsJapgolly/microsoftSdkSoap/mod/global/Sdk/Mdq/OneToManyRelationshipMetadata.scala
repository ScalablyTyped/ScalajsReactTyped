...
trait OneToManyRelationshipMetadata extends StObject {
  ...
  var AssociatedMenuConfiguration: typingsJapgolly.microsoftSdkSoap.mod.global.Sdk.Mdq.AssociatedMenuConfiguration
  
  var CascadeConfiguration: typingsJapgolly.microsoftSdkSoap.mod.global.Sdk.Mdq.CascadeConfiguration
