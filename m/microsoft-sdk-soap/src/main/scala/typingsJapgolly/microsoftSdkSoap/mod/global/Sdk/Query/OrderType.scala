...
object OrderType extends StObject {
  ...
  sealed trait Ascending
    extends StObject
       with OrderType
  /* 0 */ val Ascending: typingsJapgolly.microsoftSdkSoap.mod.global.Sdk.Query.OrderType.Ascending & Double = js.native
  
  @js.native
  sealed trait Descending
    extends StObject
       with OrderType
  /* 1 */ val Descending: typingsJapgolly.microsoftSdkSoap.mod.global.Sdk.Query.OrderType.Descending & Double = js.native
}
