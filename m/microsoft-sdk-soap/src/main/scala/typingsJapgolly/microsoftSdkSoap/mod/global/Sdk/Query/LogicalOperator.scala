...
object LogicalOperator extends StObject {
  ...
  /* 1 */ val And: typingsJapgolly.microsoftSdkSoap.mod.global.Sdk.Query.LogicalOperator.And & Double = js.native
  
  @js.native
  sealed trait Or
    extends StObject
       with LogicalOperator
  /* 0 */ val Or: typingsJapgolly.microsoftSdkSoap.mod.global.Sdk.Query.LogicalOperator.Or & Double = js.native
}
