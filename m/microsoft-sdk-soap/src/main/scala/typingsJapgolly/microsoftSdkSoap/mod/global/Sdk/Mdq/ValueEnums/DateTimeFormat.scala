...
object DateTimeFormat extends StObject {
  ...
  sealed trait DateAndTime
    extends StObject
       with DateTimeFormat
  /* 0 */ val DateAndTime: typingsJapgolly.microsoftSdkSoap.mod.global.Sdk.Mdq.ValueEnums.DateTimeFormat.DateAndTime & Double = js.native
  
  @js.native
  sealed trait DateOnly
    extends StObject
       with DateTimeFormat
  /* 1 */ val DateOnly: typingsJapgolly.microsoftSdkSoap.mod.global.Sdk.Mdq.ValueEnums.DateTimeFormat.DateOnly & Double = js.native
}
