...
trait MaxAgeOnExpireUpdateExpire[MaxAge /* <: Double */, ExpireHandler /* <: typingsJapgolly.moize.mod.OnExpire */, UpdateExpire /* <: Boolean */] extends StObject {
...
object MaxAgeOnExpireUpdateExpire {
  ...
  inline def apply[MaxAge /* <: Double */, ExpireHandler /* <: typingsJapgolly.moize.mod.OnExpire */, UpdateExpire /* <: Boolean */](maxAge: MaxAge, onExpire: ExpireHandler, updateExpire: UpdateExpire): MaxAgeOnExpireUpdateExpire[MaxAge, ExpireHandler, UpdateExpire] = {
  ...
  extension [Self <: MaxAgeOnExpireUpdateExpire[?, ?, ?], MaxAge /* <: Double */, ExpireHandler /* <: typingsJapgolly.moize.mod.OnExpire */, UpdateExpire /* <: Boolean */](x: Self & (MaxAgeOnExpireUpdateExpire[MaxAge, ExpireHandler, UpdateExpire])) {
