...
trait OnExpire[MaxAge /* <: Double */, ExpireHandler /* <: typingsJapgolly.moize.mod.OnExpire */] extends StObject {
...
object OnExpire {
  ...
  inline def apply[MaxAge /* <: Double */, ExpireHandler /* <: typingsJapgolly.moize.mod.OnExpire */](maxAge: MaxAge, onExpire: ExpireHandler): OnExpire[MaxAge, ExpireHandler] = {
  ...
  extension [Self <: OnExpire[?, ?], MaxAge /* <: Double */, ExpireHandler /* <: typingsJapgolly.moize.mod.OnExpire */](x: Self & (OnExpire[MaxAge, ExpireHandler])) {
