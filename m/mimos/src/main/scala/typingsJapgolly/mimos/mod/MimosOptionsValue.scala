package typingsJapgolly.mimos.mod
...
object MimosOptionsValue {
  ...
  def apply(
    ...
    if (predicate != null) __obj.updateDynamic("predicate")(js.Any.fromFunction1((t0: /* mime */ typingsJapgolly.mimos.mod.MimosOptionsValue) => predicate(t0).runNow()))
