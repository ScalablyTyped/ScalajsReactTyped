...
trait Fields extends StObject {
  ...
  var messageTypes: js.UndefOr[String | js.Array[String]] = js.undefined
...
object Fields {
  ...
  extension [Self <: Fields](x: Self) {
    ...
    inline def setMessageTypes(value: String | js.Array[String]): Self = StObject.set(x, "messageTypes", value.asInstanceOf[js.Any])
