...
import typingsJapgolly.maximMazurokGapiClientDatacatalog.gapi.client.datacatalog.GoogleCloudDatacatalogV1TagTemplateField
...
object KeyName {
  ...
  inline def apply(name: String, resource: GoogleCloudDatacatalogV1TagTemplateField): KeyName = {
