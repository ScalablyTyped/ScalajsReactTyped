package typingsJapgolly.maximMazurokGapiClientDatacatalog.anon

import typingsJapgolly.maximMazurokGapiClientDatacatalog.gapi.client.datacatalog.GoogleCloudDatacatalogV1Entry
...
trait EntryId extends StObject {
  ...
  /** Request body */
  var resource: GoogleCloudDatacatalogV1Entry
...
object EntryId {
  ...
  inline def apply(parent: String, resource: GoogleCloudDatacatalogV1Entry): EntryId = {
  ...
  extension [Self <: EntryId](x: Self) {
    ...
    inline def setResource(value: GoogleCloudDatacatalogV1Entry): Self = StObject.set(x, "resource", value.asInstanceOf[js.Any])
