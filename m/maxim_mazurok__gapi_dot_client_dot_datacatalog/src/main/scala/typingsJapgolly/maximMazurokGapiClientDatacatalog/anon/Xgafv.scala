...
import typingsJapgolly.maximMazurokGapiClientDatacatalog.gapi.client.datacatalog.GoogleCloudDatacatalogV1Tag
...
object Xgafv {
  ...
  inline def apply(name: String, resource: GoogleCloudDatacatalogV1Tag): Xgafv = {
