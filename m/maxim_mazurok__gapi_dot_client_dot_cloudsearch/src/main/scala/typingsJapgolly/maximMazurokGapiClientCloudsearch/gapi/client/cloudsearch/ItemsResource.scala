...
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.Brief
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.Callback
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.ConnectorName
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.DebugOptionsenableDebugging
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.Fields
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.GroupResourceName
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.Key
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.Oauthtoken
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.PrettyPrint
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.QuotaUser
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.Resource
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.UploadType
import typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.Uploadprotocol
...
trait ItemsResource extends StObject {
  ...
  /**
    ...
    */
  def deleteQueueItems(request: typingsJapgolly.maximMazurokGapiClientCloudsearch.anon.Name): Request[Operation] = js.native
