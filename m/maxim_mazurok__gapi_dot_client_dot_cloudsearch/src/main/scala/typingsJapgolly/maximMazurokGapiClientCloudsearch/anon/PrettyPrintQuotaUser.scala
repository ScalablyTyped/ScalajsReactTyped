...
import typingsJapgolly.maximMazurokGapiClientCloudsearch.gapi.client.cloudsearch.SearchApplication
...
object PrettyPrintQuotaUser {
  ...
  inline def apply(resource: SearchApplication): PrettyPrintQuotaUser = {
