...
object AutocompleteOptions {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(allowUnsafeHTML = allowUnsafeHTML.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any], limit = limit.asInstanceOf[js.Any], minLength = minLength.asInstanceOf[js.Any], onAutocomplete = js.Any.fromFunction1((t0: String) => onAutocomplete(t0).runNow()), sortFunction = js.Any.fromFunction3(sortFunction))
