...
import typingsJapgolly.materializecssMaterialize.M.Toast
import typingsJapgolly.materializecssMaterialize.M.ToastOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("@materializecss/materialize", "Toast")
@js.native
open class Toast_ ()
  extends StObject
     with Toast {
