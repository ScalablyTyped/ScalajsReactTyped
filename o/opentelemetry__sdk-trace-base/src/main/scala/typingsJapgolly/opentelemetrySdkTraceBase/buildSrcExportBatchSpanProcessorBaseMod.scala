...
object buildSrcExportBatchSpanProcessorBaseMod {
  
  /* note: abstract class */ @JSImport("@opentelemetry/sdk-trace-base/build/src/export/BatchSpanProcessorBase", "BatchSpanProcessorBase")
  @js.native
  open class BatchSpanProcessorBase[T /* <: BufferConfig */] protected ()
    extends StObject
       with SpanProcessor {
