...
object buildSrcSamplerTraceIdRatioBasedSamplerMod {
  
  @JSImport("@opentelemetry/sdk-trace-base/build/src/sampler/TraceIdRatioBasedSampler", "TraceIdRatioBasedSampler")
  @js.native
