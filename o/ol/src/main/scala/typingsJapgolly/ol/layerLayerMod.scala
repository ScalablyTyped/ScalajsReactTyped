...
object layerLayerMod {
  ...
  @js.native
  open class default[SourceType /* <: typingsJapgolly.ol.sourceSourceMod.default */] protected () extends Layer[SourceType] {
    def this(options: Options) = this()
  }
  
  inline def inView(layerState: State, viewState: typingsJapgolly.ol.viewMod.State): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("inView")(layerState.asInstanceOf[js.Any], viewState.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  trait Options extends StObject {
    ...
    var source: js.UndefOr[typingsJapgolly.ol.sourceSourceMod.default] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setSource(value: typingsJapgolly.ol.sourceSourceMod.default): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
  ...
  trait State extends StObject {
    ...
    var layer: Layer[typingsJapgolly.ol.sourceSourceMod.default]
    ...
    var sourceState: typingsJapgolly.ol.sourceStateMod.State
  ...
  object State {
    ...
    inline def apply(
      layer: Layer[typingsJapgolly.ol.sourceSourceMod.default],
      managed: Boolean,
      ...
      minZoom: Double,
      opacity: Double,
      sourceState: typingsJapgolly.ol.sourceStateMod.State,
      visible: Boolean,
      zIndex: Double
    ): State = {
    ...
    extension [Self <: State](x: Self) {
      ...
      inline def setLayer(value: Layer[typingsJapgolly.ol.sourceSourceMod.default]): Self = StObject.set(x, "layer", value.asInstanceOf[js.Any])
      ...
      inline def setSourceState(value: typingsJapgolly.ol.sourceStateMod.State): Self = StObject.set(x, "sourceState", value.asInstanceOf[js.Any])
