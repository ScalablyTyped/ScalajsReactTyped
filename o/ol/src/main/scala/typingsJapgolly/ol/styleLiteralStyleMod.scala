...
object styleLiteralStyleMod {
  ...
  object SymbolType extends StObject {
    ...
    sealed trait CIRCLE
      extends StObject
         with SymbolType
    /* "circle" */ val CIRCLE: typingsJapgolly.ol.styleLiteralStyleMod.SymbolType.CIRCLE & String = js.native
    
    @js.native
    sealed trait IMAGE
      extends StObject
         with SymbolType
    /* "image" */ val IMAGE: typingsJapgolly.ol.styleLiteralStyleMod.SymbolType.IMAGE & String = js.native
    
    @js.native
    sealed trait SQUARE
      extends StObject
         with SymbolType
    /* "square" */ val SQUARE: typingsJapgolly.ol.styleLiteralStyleMod.SymbolType.SQUARE & String = js.native
    
    @js.native
    sealed trait TRIANGLE
      extends StObject
         with SymbolType
    /* "triangle" */ val TRIANGLE: typingsJapgolly.ol.styleLiteralStyleMod.SymbolType.TRIANGLE & String = js.native
  }
  
  type ExpressionValue = typingsJapgolly.ol.styleExpressionsMod.ExpressionValue
