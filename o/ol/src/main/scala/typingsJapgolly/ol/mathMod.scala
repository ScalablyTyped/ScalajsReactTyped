...
object mathMod {
  ...
  inline def lerp(a: Double, b: Double, x: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("lerp")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], x.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def solveLinearSystem(mat: js.Array[js.Array[Double]]): js.Array[Double] = ^.asInstanceOf[js.Dynamic].applyDynamic("solveLinearSystem")(mat.asInstanceOf[js.Any]).asInstanceOf[js.Array[Double]]
  
  inline def squaredDistance(x1: Double, y1: Double, x2: Double, y2: Double): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("squaredDistance")(x1.asInstanceOf[js.Any], y1.asInstanceOf[js.Any], x2.asInstanceOf[js.Any], y2.asInstanceOf[js.Any])).asInstanceOf[Double]
