...
object styleIconAnchorUnitsMod {
  ...
  object default extends StObject {
    ...
    /* "fraction" */ val FRACTION: typingsJapgolly.ol.styleIconAnchorUnitsMod.IconAnchorUnits.FRACTION & String = js.native
    
    /* "pixels" */ val PIXELS: typingsJapgolly.ol.styleIconAnchorUnitsMod.IconAnchorUnits.PIXELS & String = js.native
  }
