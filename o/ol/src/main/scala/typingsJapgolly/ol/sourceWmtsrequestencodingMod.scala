...
object sourceWmtsrequestencodingMod {
  ...
  object default extends StObject {
    ...
    /* "KVP" */ val KVP: typingsJapgolly.ol.sourceWmtsrequestencodingMod.WMTSRequestEncoding.KVP & String = js.native
    
    /* "REST" */ val REST: typingsJapgolly.ol.sourceWmtsrequestencodingMod.WMTSRequestEncoding.REST & String = js.native
  }
