...
object layerBaseImageMod {
  ...
  trait BaseImageLayer
    extends typingsJapgolly.ol.layerLayerMod.default[typingsJapgolly.ol.sourceImageMod.default]
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setSource(value: typingsJapgolly.ol.sourceImageMod.default): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
