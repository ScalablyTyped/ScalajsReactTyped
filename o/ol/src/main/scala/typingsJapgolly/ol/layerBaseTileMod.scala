...
object layerBaseTileMod {
  ...
  trait Options extends StObject {
    ...
    var source: js.UndefOr[typingsJapgolly.ol.sourceTileMod.default] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setSource(value: typingsJapgolly.ol.sourceTileMod.default): Self = StObject.set(x, "source", value.asInstanceOf[js.Any])
