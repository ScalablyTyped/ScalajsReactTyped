...
object renderCanvasBuilderGroupMod {
  ...
  trait BuilderGroup extends StObject {
    ...
    def getBuilder(zIndex: Double, builderType: BuilderType): typingsJapgolly.ol.renderVectorContextMod.default = js.native
    def getBuilder(zIndex: Unit, builderType: BuilderType): typingsJapgolly.ol.renderVectorContextMod.default = js.native
  }
}
