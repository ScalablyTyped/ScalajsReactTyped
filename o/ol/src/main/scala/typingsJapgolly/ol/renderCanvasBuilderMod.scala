...
import typingsJapgolly.ol.renderCanvasMod.FillStrokeState
import typingsJapgolly.ol.renderCanvasMod.SerializableInstructions
...
object renderCanvasBuilderMod {
  ...
  trait CanvasBuilder
    ...
    /* protected */ def beginGeometry(geometry: typingsJapgolly.ol.geomGeometryMod.default, feature: FeatureLike): Unit = js.native
    /* protected */ def beginGeometry(geometry: typingsJapgolly.ol.renderFeatureMod.default, feature: FeatureLike): Unit = js.native
