...
object coordinateMod {
  ...
  inline def getWorldsAway(coordinate: Coordinate, projection: typingsJapgolly.ol.projProjectionMod.default): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("getWorldsAway")(coordinate.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def wrapX(coordinate: Coordinate, projection: typingsJapgolly.ol.projProjectionMod.default): Coordinate = (^.asInstanceOf[js.Dynamic].applyDynamic("wrapX")(coordinate.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[Coordinate]
