...
object formatPolylineMod {
  ...
  @js.native
  trait Polyline
    extends typingsJapgolly.ol.formatTextFeatureMod.default {
    
    /* protected */ def writeGeometryText(geometry: typingsJapgolly.ol.geomLineStringMod.default): String = js.native
    /* protected */ def writeGeometryText(geometry: typingsJapgolly.ol.geomLineStringMod.default, opt_options: WriteOptions): String = js.native
  }
}
