...
object styleImageMod {
  ...
  trait ImageStyle extends StObject {
    ...
    def listenImageChange(listener: js.Function1[/* p0 */ typingsJapgolly.ol.eventsEventMod.default, Unit]): Unit = js.native
    ...
    def unlistenImageChange(listener: js.Function1[/* p0 */ typingsJapgolly.ol.eventsEventMod.default, Unit]): Unit = js.native
  }
