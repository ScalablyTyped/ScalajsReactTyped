...
object webglHelperMod {
  ...
  object AttributeType extends StObject {
    ...
    sealed trait FLOAT
      extends StObject
         with AttributeType
    /* 5126 */ val FLOAT: typingsJapgolly.ol.webglHelperMod.AttributeType.FLOAT & Double = js.native
    
    @js.native
    sealed trait UNSIGNED_BYTE
      extends StObject
         with AttributeType
    /* 5121 */ val UNSIGNED_BYTE: typingsJapgolly.ol.webglHelperMod.AttributeType.UNSIGNED_BYTE & Double = js.native
    
    @js.native
    sealed trait UNSIGNED_INT
      extends StObject
         with AttributeType
    /* 5125 */ val UNSIGNED_INT: typingsJapgolly.ol.webglHelperMod.AttributeType.UNSIGNED_INT & Double = js.native
    
    @js.native
    sealed trait UNSIGNED_SHORT
      extends StObject
         with AttributeType
    /* 5123 */ val UNSIGNED_SHORT: typingsJapgolly.ol.webglHelperMod.AttributeType.UNSIGNED_SHORT & Double = js.native
  }
  ...
  object DefaultUniform extends StObject {
    ...
    sealed trait OFFSET_ROTATION_MATRIX
      extends StObject
         with DefaultUniform
    /* "u_offsetRotateMatrix" */ val OFFSET_ROTATION_MATRIX: typingsJapgolly.ol.webglHelperMod.DefaultUniform.OFFSET_ROTATION_MATRIX & String = js.native
    
    @js.native
    sealed trait OFFSET_SCALE_MATRIX
      extends StObject
         with DefaultUniform
    /* "u_offsetScaleMatrix" */ val OFFSET_SCALE_MATRIX: typingsJapgolly.ol.webglHelperMod.DefaultUniform.OFFSET_SCALE_MATRIX & String = js.native
    
    @js.native
    sealed trait PROJECTION_MATRIX
      extends StObject
         with DefaultUniform
    /* "u_projectionMatrix" */ val PROJECTION_MATRIX: typingsJapgolly.ol.webglHelperMod.DefaultUniform.PROJECTION_MATRIX & String = js.native
    
    @js.native
    sealed trait RESOLUTION
      extends StObject
         with DefaultUniform
    /* "u_resolution" */ val RESOLUTION: typingsJapgolly.ol.webglHelperMod.DefaultUniform.RESOLUTION & String = js.native
    
    @js.native
    sealed trait TIME
      extends StObject
         with DefaultUniform
    /* "u_time" */ val TIME: typingsJapgolly.ol.webglHelperMod.DefaultUniform.TIME & String = js.native
    
    @js.native
    sealed trait ZOOM
      extends StObject
         with DefaultUniform
    /* "u_zoom" */ val ZOOM: typingsJapgolly.ol.webglHelperMod.DefaultUniform.ZOOM & String = js.native
  }
  ...
  object ShaderType extends StObject {
    ...
    sealed trait FRAGMENT_SHADER
      extends StObject
         with ShaderType
    /* 35632 */ val FRAGMENT_SHADER: typingsJapgolly.ol.webglHelperMod.ShaderType.FRAGMENT_SHADER & Double = js.native
    
    @js.native
    sealed trait VERTEX_SHADER
      extends StObject
         with ShaderType
    /* 35633 */ val VERTEX_SHADER: typingsJapgolly.ol.webglHelperMod.ShaderType.VERTEX_SHADER & Double = js.native
  }
  ...
  trait BufferCacheEntry extends StObject {
    ...
    var buffer: typingsJapgolly.ol.webglBufferMod.default
    
    var webGlBuffer: WebGLBuffer
  }
  object BufferCacheEntry {
    
    inline def apply(buffer: typingsJapgolly.ol.webglBufferMod.default, webGlBuffer: WebGLBuffer): BufferCacheEntry = {
    ...
    extension [Self <: BufferCacheEntry](x: Self) {
      ...
      inline def setBuffer(value: typingsJapgolly.ol.webglBufferMod.default): Self = StObject.set(x, "buffer", value.asInstanceOf[js.Any])
  ...
  trait WebGLHelper
    ...
    /**
      ...
      * the cache.
      */
    def bindBuffer(buffer: typingsJapgolly.ol.webglBufferMod.default): Unit = js.native
    ...
    def deleteBuffer(buf: typingsJapgolly.ol.webglBufferMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def flushBufferData(buffer: typingsJapgolly.ol.webglBufferMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def prepareDrawToRenderTarget(frameState: FrameState, renderTarget: typingsJapgolly.ol.webglRenderTargetMod.default): Unit = js.native
    def prepareDrawToRenderTarget(
      frameState: FrameState,
      renderTarget: typingsJapgolly.ol.webglRenderTargetMod.default,
