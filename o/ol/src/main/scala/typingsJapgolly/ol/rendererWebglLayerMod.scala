...
object rendererWebglLayerMod {
  ...
  @js.native
  open class default[LayerType /* <: typingsJapgolly.ol.layerLayerMod.default[typingsJapgolly.ol.sourceSourceMod.default] */] protected () extends WebGLLayerRenderer[LayerType] {
  ...
  object WebGLWorkerMessageType extends StObject {
    ...
    /* "GENERATE_BUFFERS" */ val GENERATE_BUFFERS: typingsJapgolly.ol.rendererWebglLayerMod.WebGLWorkerMessageType.GENERATE_BUFFERS & String = js.native
  }
  ...
  @js.native
  trait WebGLLayerRenderer[LayerType /* <: typingsJapgolly.ol.layerLayerMod.default[typingsJapgolly.ol.sourceSourceMod.default] */]
    ...
    /* protected */ var helper: typingsJapgolly.ol.webglHelperMod.default = js.native
