...
import typingsJapgolly.ol.imageMod.ImageWrapper
...
import typingsJapgolly.ol.sourceWmsservertypeMod.WMSServerType
...
object sourceImageWMSMod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setImageLoadFunction(value: (/* p0 */ ImageWrapper, /* p1 */ String) => Callback): Self = StObject.set(x, "imageLoadFunction", js.Any.fromFunction2((t0: /* p0 */ ImageWrapper, t1: /* p1 */ String) => (value(t0, t1)).runNow()))
