...
object layerGraticuleMod {
  ...
  trait Graticule
    ...
    /**
      ...
      */
    def getMeridians(): js.Array[typingsJapgolly.ol.geomLineStringMod.default] = js.native
    
    /**
      * Get the list of parallels.  Parallels are lines of equal latitude.
      */
    def getParallels(): js.Array[typingsJapgolly.ol.geomLineStringMod.default] = js.native
    
    /**
      * Update geometries in the source based on current view
      */
    def loaderFunction(extent: Extent, resolution: Double, projection: typingsJapgolly.ol.projProjectionMod.default): Unit = js.native
  ...
  trait GraticuleLabelDataType extends StObject {
    ...
    var geom: typingsJapgolly.ol.geomPointMod.default
    
    var text: String
  }
  object GraticuleLabelDataType {
    
    inline def apply(geom: typingsJapgolly.ol.geomPointMod.default, text: String): GraticuleLabelDataType = {
    ...
    extension [Self <: GraticuleLabelDataType](x: Self) {
      ...
      inline def setGeom(value: typingsJapgolly.ol.geomPointMod.default): Self = StObject.set(x, "geom", value.asInstanceOf[js.Any])
  ...
  trait Options extends StObject {
    ...
    var latLabelStyle: js.UndefOr[typingsJapgolly.ol.styleTextMod.default] = js.undefined
    ...
    var lonLabelStyle: js.UndefOr[typingsJapgolly.ol.styleTextMod.default] = js.undefined
    ...
    var strokeStyle: js.UndefOr[typingsJapgolly.ol.styleStrokeMod.default] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setLatLabelStyle(value: typingsJapgolly.ol.styleTextMod.default): Self = StObject.set(x, "latLabelStyle", value.asInstanceOf[js.Any])
      ...
      inline def setLonLabelStyle(value: typingsJapgolly.ol.styleTextMod.default): Self = StObject.set(x, "lonLabelStyle", value.asInstanceOf[js.Any])
      ...
      inline def setStrokeStyle(value: typingsJapgolly.ol.styleStrokeMod.default): Self = StObject.set(x, "strokeStyle", value.asInstanceOf[js.Any])
