...
import typingsJapgolly.ol.olStrings.changeColoncenter
import typingsJapgolly.ol.olStrings.changeColonresolution
import typingsJapgolly.ol.olStrings.changeColonrotation
...
import typingsJapgolly.ol.viewHintMod.ViewHint
...
object viewMod {
  ...
  inline def createRotationConstraint(options: ViewOptions): typingsJapgolly.ol.rotationconstraintMod.Type = ^.asInstanceOf[js.Dynamic].applyDynamic("createRotationConstraint")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.ol.rotationconstraintMod.Type]
  ...
  object Animation {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(callback = js.Any.fromFunction1((t0: Boolean) => callback(t0).runNow()), complete = complete.asInstanceOf[js.Any], duration = duration.asInstanceOf[js.Any], easing = js.Any.fromFunction1(easing), start = start.asInstanceOf[js.Any])
    ...
    extension [Self <: Animation](x: Self) {
      ...
      inline def setCallback(value: Boolean => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
  ...
  trait Constraints extends StObject {
    ...
    @JSName("resolution")
    var resolution_Original: typingsJapgolly.ol.resolutionconstraintMod.Type
    ...
    @JSName("rotation")
    var rotation_Original: typingsJapgolly.ol.rotationconstraintMod.Type
  }
  object Constraints {
  ...
  object FitOptions {
    ...
    extension [Self <: FitOptions](x: Self) {
      ...
      inline def setCallback(value: /* p0 */ Boolean => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* p0 */ Boolean) => value(t0).runNow()))
  ...
  trait State extends StObject {
    ...
    var projection: typingsJapgolly.ol.projProjectionMod.default
  ...
  object State {
    ...
    extension [Self <: State](x: Self) {
      ...
      inline def setProjection(value: typingsJapgolly.ol.projProjectionMod.default): Self = StObject.set(x, "projection", value.asInstanceOf[js.Any])
  ...
  trait View
    ...
    /**
      ...
      */
    def fit(geometryOrExtent: typingsJapgolly.ol.geomSimpleGeometryMod.default): Unit = js.native
    def fit(geometryOrExtent: typingsJapgolly.ol.geomSimpleGeometryMod.default, opt_options: FitOptions): Unit = js.native
    
    def fitInternal(geometry: typingsJapgolly.ol.geomSimpleGeometryMod.default): Unit = js.native
    def fitInternal(geometry: typingsJapgolly.ol.geomSimpleGeometryMod.default, opt_options: FitOptions): Unit = js.native
