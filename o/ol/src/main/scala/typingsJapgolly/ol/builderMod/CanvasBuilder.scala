package typingsJapgolly.ol.builderMod

import typingsJapgolly.ol.canvasMod.FillStrokeState
...
trait CanvasBuilder
  ...
  /* protected */ def beginGeometry(geometry: typingsJapgolly.ol.geometryMod.default, feature: FeatureLike): Unit = js.native
