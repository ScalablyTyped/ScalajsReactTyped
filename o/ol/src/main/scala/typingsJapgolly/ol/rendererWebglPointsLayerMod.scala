...
import typingsJapgolly.ol.rendererWebglLayerMod.PostProcessesOptions
...
object rendererWebglPointsLayerMod {
  ...
  object CustomAttribute {
    ...
    inline def apply(
      callback: (typingsJapgolly.ol.featureMod.default[typingsJapgolly.ol.geomGeometryMod.default], StringDictionary[Any]) => Double,
      name: String
    ): CustomAttribute = {
    ...
    extension [Self <: CustomAttribute](x: Self) {
      ...
      inline def setCallback(
        value: (typingsJapgolly.ol.featureMod.default[typingsJapgolly.ol.geomGeometryMod.default], StringDictionary[Any]) => Double
  ...
  trait FeatureCacheItem extends StObject {
    ...
    var geometry: typingsJapgolly.ol.geomGeometryMod.default
  ...
  object FeatureCacheItem {
    ...
    extension [Self <: FeatureCacheItem](x: Self) {
      ...
      inline def setGeometry(value: typingsJapgolly.ol.geomGeometryMod.default): Self = StObject.set(x, "geometry", value.asInstanceOf[js.Any])
  ...
  trait WebGLPointsLayerRenderer
    extends typingsJapgolly.ol.rendererWebglLayerMod.default[
