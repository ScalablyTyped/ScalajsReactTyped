...
object formatWfsMod {
  ...
  inline def writeFilter(filter: typingsJapgolly.ol.formatFilterFilterMod.default, version: String): Node = (^.asInstanceOf[js.Dynamic].applyDynamic("writeFilter")(filter.asInstanceOf[js.Any], version.asInstanceOf[js.Any])).asInstanceOf[Node]
  ...
  trait Options extends StObject {
    ...
    var gmlFormat: js.UndefOr[typingsJapgolly.ol.formatGmlbaseMod.default] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setGmlFormat(value: typingsJapgolly.ol.formatGmlbaseMod.default): Self = StObject.set(x, "gmlFormat", value.asInstanceOf[js.Any])
  ...
  trait WFS
    ...
    /**
      ...
      */
    def combineBboxAndFilter(geometryName: String, extent: Extent): typingsJapgolly.ol.formatFilterFilterMod.default = js.native
    def combineBboxAndFilter(geometryName: String, extent: Extent, opt_srsName: String): typingsJapgolly.ol.formatFilterFilterMod.default = js.native
    def combineBboxAndFilter(
      geometryName: String,
      extent: Extent,
      opt_srsName: String,
      opt_filter: typingsJapgolly.ol.formatFilterFilterMod.default
    ): typingsJapgolly.ol.formatFilterFilterMod.default = js.native
    def combineBboxAndFilter(
      geometryName: String,
      extent: Extent,
      opt_srsName: Unit,
  ...
  trait WriteGetFeatureOptions extends StObject {
    ...
    var filter: js.UndefOr[typingsJapgolly.ol.formatFilterFilterMod.default] = js.undefined
  ...
  object WriteGetFeatureOptions {
    ...
    extension [Self <: WriteGetFeatureOptions](x: Self) {
      ...
      inline def setFilter(value: typingsJapgolly.ol.formatFilterFilterMod.default): Self = StObject.set(x, "filter", value.asInstanceOf[js.Any])
  ...
  trait WriteTransactionOptions extends StObject {
    ...
    var gmlOptions: js.UndefOr[typingsJapgolly.ol.formatGmlbaseMod.Options] = js.undefined
  ...
  object WriteTransactionOptions {
    ...
    extension [Self <: WriteTransactionOptions](x: Self) {
      ...
      inline def setGmlOptions(value: typingsJapgolly.ol.formatGmlbaseMod.Options): Self = StObject.set(x, "gmlOptions", value.asInstanceOf[js.Any])
