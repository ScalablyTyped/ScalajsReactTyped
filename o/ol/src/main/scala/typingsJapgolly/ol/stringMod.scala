...
object stringMod {
  ...
  inline def padNumber(number: Double, width: Double, opt_precision: Double): String = (^.asInstanceOf[js.Dynamic].applyDynamic("padNumber")(number.asInstanceOf[js.Any], width.asInstanceOf[js.Any], opt_precision.asInstanceOf[js.Any])).asInstanceOf[String]
}
