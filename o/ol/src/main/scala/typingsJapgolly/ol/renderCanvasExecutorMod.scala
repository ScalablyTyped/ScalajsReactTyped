...
import typingsJapgolly.ol.renderCanvasMod.Label
...
object renderCanvasExecutorMod {
  ...
  type FeatureCallback[T] = js.Function2[/* p0 */ FeatureLike, /* p1 */ typingsJapgolly.ol.geomSimpleGeometryMod.default, T]
