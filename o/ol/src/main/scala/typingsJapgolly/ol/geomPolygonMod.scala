...
object geomPolygonMod {
  ...
  inline def fromCircle(circle: typingsJapgolly.ol.geomCircleMod.default): Polygon = ^.asInstanceOf[js.Dynamic].applyDynamic("fromCircle")(circle.asInstanceOf[js.Any]).asInstanceOf[Polygon]
  inline def fromCircle(circle: typingsJapgolly.ol.geomCircleMod.default, opt_sides: Double): Polygon = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCircle")(circle.asInstanceOf[js.Any], opt_sides.asInstanceOf[js.Any])).asInstanceOf[Polygon]
  inline def fromCircle(circle: typingsJapgolly.ol.geomCircleMod.default, opt_sides: Double, opt_angle: Double): Polygon = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCircle")(circle.asInstanceOf[js.Any], opt_sides.asInstanceOf[js.Any], opt_angle.asInstanceOf[js.Any])).asInstanceOf[Polygon]
  inline def fromCircle(circle: typingsJapgolly.ol.geomCircleMod.default, opt_sides: Unit, opt_angle: Double): Polygon = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCircle")(circle.asInstanceOf[js.Any], opt_sides.asInstanceOf[js.Any], opt_angle.asInstanceOf[js.Any])).asInstanceOf[Polygon]
  ...
  trait Polygon
    ...
    /**
      ...
      */
    def appendLinearRing(linearRing: typingsJapgolly.ol.geomLinearRingMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def getInteriorPoint(): typingsJapgolly.ol.geomPointMod.default = js.native
    ...
    /**
      ...
      */
    def getLinearRing(index: Double): typingsJapgolly.ol.geomLinearRingMod.default = js.native
    ...
    /**
      ...
      */
    def getLinearRings(): js.Array[typingsJapgolly.ol.geomLinearRingMod.default] = js.native
