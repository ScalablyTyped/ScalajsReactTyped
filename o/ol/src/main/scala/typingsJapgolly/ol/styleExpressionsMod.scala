...
object styleExpressionsMod {
  ...
  object ValueTypes extends StObject {
    ...
    sealed trait ANY
      extends StObject
         with ValueTypes
    /* 31 */ val ANY: typingsJapgolly.ol.styleExpressionsMod.ValueTypes.ANY & Double = js.native
    
    @js.native
    sealed trait BOOLEAN
      extends StObject
         with ValueTypes
    /* 8 */ val BOOLEAN: typingsJapgolly.ol.styleExpressionsMod.ValueTypes.BOOLEAN & Double = js.native
    
    @js.native
    sealed trait COLOR
      extends StObject
         with ValueTypes
    /* 4 */ val COLOR: typingsJapgolly.ol.styleExpressionsMod.ValueTypes.COLOR & Double = js.native
    
    @js.native
    sealed trait NONE
      extends StObject
         with ValueTypes
    /* 0 */ val NONE: typingsJapgolly.ol.styleExpressionsMod.ValueTypes.NONE & Double = js.native
    
    @js.native
    sealed trait NUMBER
      extends StObject
         with ValueTypes
    /* 1 */ val NUMBER: typingsJapgolly.ol.styleExpressionsMod.ValueTypes.NUMBER & Double = js.native
    
    @js.native
    sealed trait NUMBER_ARRAY
      extends StObject
         with ValueTypes
    /* 16 */ val NUMBER_ARRAY: typingsJapgolly.ol.styleExpressionsMod.ValueTypes.NUMBER_ARRAY & Double = js.native
    
    @js.native
    sealed trait STRING
      extends StObject
         with ValueTypes
    /* 2 */ val STRING: typingsJapgolly.ol.styleExpressionsMod.ValueTypes.STRING & Double = js.native
  }
