...
import typingsJapgolly.ol.olStrings.enterfullscreen
import typingsJapgolly.ol.olStrings.leavefullscreen
...
object controlFullScreenMod {
  ...
  trait FullScreen
    ...
    @JSName("on")
    def on_enterfullscreen(
      `type`: enterfullscreen,
      listener: js.Function1[/* evt */ typingsJapgolly.ol.eventsEventMod.default, Unit]
    ): EventsKey = js.native
    @JSName("on")
    def on_leavefullscreen(
      `type`: leavefullscreen,
      listener: js.Function1[/* evt */ typingsJapgolly.ol.eventsEventMod.default, Unit]
    ): EventsKey = js.native
    
    @JSName("once")
    def once_enterfullscreen(
      `type`: enterfullscreen,
      listener: js.Function1[/* evt */ typingsJapgolly.ol.eventsEventMod.default, Unit]
    ): EventsKey = js.native
    @JSName("once")
    def once_leavefullscreen(
      `type`: leavefullscreen,
      listener: js.Function1[/* evt */ typingsJapgolly.ol.eventsEventMod.default, Unit]
    ): EventsKey = js.native
    
    @JSName("un")
    def un_enterfullscreen(
      `type`: enterfullscreen,
      listener: js.Function1[/* evt */ typingsJapgolly.ol.eventsEventMod.default, Unit]
    ): Unit = js.native
    @JSName("un")
    def un_leavefullscreen(
      `type`: leavefullscreen,
      listener: js.Function1[/* evt */ typingsJapgolly.ol.eventsEventMod.default, Unit]
    ): Unit = js.native
  }
