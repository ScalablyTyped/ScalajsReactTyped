...
trait Options extends js.Object {
  ...
  var onBoxEnd: js.UndefOr[
    js.ThisFunction1[/* this */ DragBox, /* p0 */ typingsJapgolly.ol.mapBrowserEventMod.default, Unit]
  ] = js.undefined
}
...
object Options {
  ...
  def apply(
    ...
    onBoxEnd: js.ThisFunction1[/* this */ DragBox, /* p0 */ typingsJapgolly.ol.mapBrowserEventMod.default, Unit] = null
  ): Options = {
