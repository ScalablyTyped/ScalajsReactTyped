...
import typingsJapgolly.ol.styleTextPlacementMod.TextPlacement
...
object styleTextMod {
  ...
  trait Options extends StObject {
    ...
    var backgroundFill: js.UndefOr[typingsJapgolly.ol.styleFillMod.default] = js.undefined
    
    var backgroundStroke: js.UndefOr[typingsJapgolly.ol.styleStrokeMod.default] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setBackgroundFill(value: typingsJapgolly.ol.styleFillMod.default): Self = StObject.set(x, "backgroundFill", value.asInstanceOf[js.Any])
      
      inline def setBackgroundFillUndefined: Self = StObject.set(x, "backgroundFill", js.undefined)
      
      inline def setBackgroundStroke(value: typingsJapgolly.ol.styleStrokeMod.default): Self = StObject.set(x, "backgroundStroke", value.asInstanceOf[js.Any])
  ...
  trait Text extends StObject {
    ...
    /**
      ...
      */
    def getBackgroundFill(): typingsJapgolly.ol.styleFillMod.default = js.native
    
    /**
      * Get the background stroke style for the text.
      */
    def getBackgroundStroke(): typingsJapgolly.ol.styleStrokeMod.default = js.native
    ...
    /**
      ...
      */
    def setBackgroundFill(fill: typingsJapgolly.ol.styleFillMod.default): Unit = js.native
    
    /**
      * Set the background stroke.
      */
    def setBackgroundStroke(stroke: typingsJapgolly.ol.styleStrokeMod.default): Unit = js.native
