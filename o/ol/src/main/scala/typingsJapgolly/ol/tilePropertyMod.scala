...
object tilePropertyMod extends js.Object {
  ...
  object default extends js.Object {
    /* "preload" */ val PRELOAD: typingsJapgolly.ol.tilePropertyMod.TileProperty.PRELOAD with String = js.native
    /* "useInterimTilesOnError" */ val USE_INTERIM_TILES_ON_ERROR: typingsJapgolly.ol.tilePropertyMod.TileProperty.USE_INTERIM_TILES_ON_ERROR with String = js.native
    @JSBracketAccess
