...
object Options {
  ...
  def apply(
    ...
    render: /* p0 */ FrameState => CallbackTo[HTMLElement] = null,
    source: typingsJapgolly.ol.sourceSourceMod.default = null,
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction1((t0: /* p0 */ typingsJapgolly.ol.pluggableMapMod.FrameState) => render(t0).runNow()))
