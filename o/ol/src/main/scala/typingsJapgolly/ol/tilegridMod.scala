...
import typingsJapgolly.ol.extentCornerMod.Corner
...
object tilegridMod {
  ...
  inline def getForProjection(projection: typingsJapgolly.ol.projProjectionMod.default): default = ^.asInstanceOf[js.Dynamic].applyDynamic("getForProjection")(projection.asInstanceOf[js.Any]).asInstanceOf[default]
  
  inline def wrapX(tileGrid: default, tileCoord: TileCoord, projection: typingsJapgolly.ol.projProjectionMod.default): TileCoord = (^.asInstanceOf[js.Dynamic].applyDynamic("wrapX")(tileGrid.asInstanceOf[js.Any], tileCoord.asInstanceOf[js.Any], projection.asInstanceOf[js.Any])).asInstanceOf[TileCoord]
