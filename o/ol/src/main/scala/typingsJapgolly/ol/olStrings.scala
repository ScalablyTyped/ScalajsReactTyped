...
object olStrings {
  ...
  inline def changeColonblur: changeColonblur = "change:blur".asInstanceOf[changeColonblur]
  ...
  inline def changeColongradient: changeColongradient = "change:gradient".asInstanceOf[changeColongradient]
  ...
  inline def changeColonradius: changeColonradius = "change:radius".asInstanceOf[changeColonradius]
