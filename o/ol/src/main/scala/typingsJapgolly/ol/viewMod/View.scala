...
trait View
  ...
  def fit(geometryOrExtent: typingsJapgolly.ol.simpleGeometryMod.default): Unit = js.native
  def fit(geometryOrExtent: typingsJapgolly.ol.simpleGeometryMod.default, opt_options: FitOptions): Unit = js.native
  def fitInternal(geometry: typingsJapgolly.ol.simpleGeometryMod.default): Unit = js.native
  def fitInternal(geometry: typingsJapgolly.ol.simpleGeometryMod.default, opt_options: FitOptions): Unit = js.native
