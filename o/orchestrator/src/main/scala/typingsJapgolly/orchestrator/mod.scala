...
import typingsJapgolly.orchestrator.anon.Dep
import typingsJapgolly.orchestrator.anon.MissingTasks
...
object mod {
  ...
  */
  ...
  object EventNames {
    ...
    inline def err: typingsJapgolly.orchestrator.orchestratorStrings.err = "err".asInstanceOf[typingsJapgolly.orchestrator.orchestratorStrings.err]
    
    inline def start: typingsJapgolly.orchestrator.orchestratorStrings.start = "start".asInstanceOf[typingsJapgolly.orchestrator.orchestratorStrings.start]
    
    inline def stop: typingsJapgolly.orchestrator.orchestratorStrings.stop = "stop".asInstanceOf[typingsJapgolly.orchestrator.orchestratorStrings.stop]
    
    inline def task_err: typingsJapgolly.orchestrator.orchestratorStrings.task_err = "task_err".asInstanceOf[typingsJapgolly.orchestrator.orchestratorStrings.task_err]
    
    inline def task_not_found: typingsJapgolly.orchestrator.orchestratorStrings.task_not_found = "task_not_found".asInstanceOf[typingsJapgolly.orchestrator.orchestratorStrings.task_not_found]
    
    inline def task_recursion: typingsJapgolly.orchestrator.orchestratorStrings.task_recursion = "task_recursion".asInstanceOf[typingsJapgolly.orchestrator.orchestratorStrings.task_recursion]
    
    inline def task_start: typingsJapgolly.orchestrator.orchestratorStrings.task_start = "task_start".asInstanceOf[typingsJapgolly.orchestrator.orchestratorStrings.task_start]
    
    inline def task_stop: typingsJapgolly.orchestrator.orchestratorStrings.task_stop = "task_stop".asInstanceOf[typingsJapgolly.orchestrator.orchestratorStrings.task_stop]
  }
