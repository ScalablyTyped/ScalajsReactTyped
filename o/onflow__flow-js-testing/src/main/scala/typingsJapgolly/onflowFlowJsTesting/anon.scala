...
import typingsJapgolly.onflowFlowJsTesting.srcAccountMod.PublicKey
...
import typingsJapgolly.onflowFlowJsTesting.srcTransformersMod.CadenceTransformer
...
object anon {
  ...
  trait AddressMap extends StObject {
    ...
    var addressMap: js.UndefOr[typingsJapgolly.onflowFlowJsTesting.srcAccountMod.AddressMap] = js.undefined
  ...
  object AddressMap {
    ...
    extension [Self <: AddressMap](x: Self) {
      ...
      inline def setAddressMap(value: typingsJapgolly.onflowFlowJsTesting.srcAccountMod.AddressMap): Self = StObject.set(x, "addressMap", value.asInstanceOf[js.Any])
