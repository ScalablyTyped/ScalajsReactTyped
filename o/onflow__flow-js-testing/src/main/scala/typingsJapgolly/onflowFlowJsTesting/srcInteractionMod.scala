...
object srcInteractionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.onflowFlowJsTesting.anon.Code
    - typingsJapgolly.onflowFlowJsTesting.anon.Transformers
  */
  trait ScriptProps extends StObject
  object ScriptProps {
    
    inline def Code(name: String): typingsJapgolly.onflowFlowJsTesting.anon.Code = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.onflowFlowJsTesting.anon.Code]
    }
    
    inline def Transformers(code: String): typingsJapgolly.onflowFlowJsTesting.anon.Transformers = {
      val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.onflowFlowJsTesting.anon.Transformers]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.onflowFlowJsTesting.anon.Signers
    - typingsJapgolly.onflowFlowJsTesting.anon.AddressMapArgs
  */
  trait TransactionProps extends StObject
  object TransactionProps {
    
    inline def AddressMapArgs(code: String, signers: js.Array[Address | SignerInfo]): typingsJapgolly.onflowFlowJsTesting.anon.AddressMapArgs = {
      val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any], signers = signers.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.onflowFlowJsTesting.anon.AddressMapArgs]
    }
    
    inline def Signers(name: String, signers: js.Array[Address | SignerInfo]): typingsJapgolly.onflowFlowJsTesting.anon.Signers = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], signers = signers.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.onflowFlowJsTesting.anon.Signers]
    }
  }
