...
import typingsJapgolly.openlayers.mod.olx.render.ToContextOptions
import typingsJapgolly.openlayers.mod.render.EventType
import typingsJapgolly.openlayers.mod.render.canvas.Immediate
...
object render {
  ...
  open class Event protected ()
    extends typingsJapgolly.openlayers.mod.render.Event {
    /**
      * @param type Type.
      * @param opt_vectorContext Vector context.
      * @param opt_frameState Frame state.
    ...
    def this(`type`: EventType, opt_vectorContext: typingsJapgolly.openlayers.mod.render.VectorContext) = this()
    def this(`type`: EventType, opt_vectorContext: Unit, opt_frameState: FrameState) = this()
    def this(
      `type`: EventType,
      opt_vectorContext: typingsJapgolly.openlayers.mod.render.VectorContext,
  ...
  open class Feature protected ()
    extends typingsJapgolly.openlayers.mod.render.Feature {
    /**
      * Lightweight, read-only, {@link ol.Feature} and {@link ol.geom.Geometry} like
      * structure, optimized for rendering and styling. Geometry access through the
      * API is limited to getting the type and extent of the geometry.
  ...
  open class VectorContext ()
    extends typingsJapgolly.openlayers.mod.render.VectorContext
  ...
  object canvas {
    ...
    open class Immediate protected ()
      extends typingsJapgolly.openlayers.mod.render.canvas.Immediate {
      /**
        * @classdesc
        * A concrete subclass of {@link ol.render.VectorContext} that implements
        * direct rendering of features and geometries to an HTML5 Canvas context.
