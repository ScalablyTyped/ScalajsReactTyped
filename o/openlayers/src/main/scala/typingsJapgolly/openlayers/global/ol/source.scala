...
import typingsJapgolly.openlayers.mod.SourceUrlTileOptions
import typingsJapgolly.openlayers.mod.olx.FrameState
import typingsJapgolly.openlayers.mod.olx.source.BingMapsOptions
import typingsJapgolly.openlayers.mod.olx.source.CartoDBOptions
import typingsJapgolly.openlayers.mod.olx.source.ClusterOptions
import typingsJapgolly.openlayers.mod.olx.source.ImageArcGISRestOptions
...
import typingsJapgolly.openlayers.mod.olx.source.ImageWMSOptions
...
import typingsJapgolly.openlayers.mod.olx.source.TileWMSOptions
import typingsJapgolly.openlayers.mod.olx.source.VectorOptions
...
object source {
  ...
  open class BingMaps protected ()
    extends typingsJapgolly.openlayers.mod.source.BingMaps {
    /**
      * @classdesc
      * Layer source for Bing Maps tile data.
      *
  ...
  object BingMaps {
    ...
    @js.native
    def TOS_ATTRIBUTION: typingsJapgolly.openlayers.mod.Attribution = js.native
    inline def TOS_ATTRIBUTION_=(x: typingsJapgolly.openlayers.mod.Attribution): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TOS_ATTRIBUTION")(x.asInstanceOf[js.Any])
  }
  ...
  open class CartoDB protected ()
    extends typingsJapgolly.openlayers.mod.source.CartoDB {
    /**
      * @classdesc
      * Layer source for the CartoDB tiles.
      *
  ...
  open class Cluster protected ()
    extends typingsJapgolly.openlayers.mod.source.Cluster {
    /**
      * @classdesc
      * Layer source to cluster vector data. Works out of the box with point
      * geometries. For other geometry types, or if not all geometries should be
  ...
  open class Image protected ()
    extends typingsJapgolly.openlayers.mod.source.Image {
    /**
      * @classdesc
      * Abstract base class; normally only used for creating subclasses and not
      * instantiated in apps.
  ...
  open class ImageArcGISRest ()
    extends typingsJapgolly.openlayers.mod.source.ImageArcGISRest {
  ...
  open class ImageCanvas protected ()
    extends typingsJapgolly.openlayers.mod.source.ImageCanvas {
    /**
      * @classdesc
      * Base class for image sources where a canvas element is the image.
      *
  ...
  open class ImageEvent protected ()
    extends typingsJapgolly.openlayers.mod.source.ImageEvent {
    /**
      * @classdesc
      * Events emitted by {@link ol.source.Image} instances are instances of this
      * type.
  ...
  open class ImageMapGuide protected ()
    extends typingsJapgolly.openlayers.mod.source.ImageMapGuide {
    /**
      * @classdesc
      * Source for images from Mapguide servers
      *
  ...
  open class ImageStatic protected ()
    extends typingsJapgolly.openlayers.mod.source.ImageStatic {
    /**
      * @classdesc
      * A layer source for displaying a single, static image.
      *
  ...
  open class ImageVector protected ()
    extends typingsJapgolly.openlayers.mod.source.ImageVector {
    /**
      * @classdesc
      * An image source whose images are canvas elements into which vector features
      * read from a vector source (`ol.source.Vector`) are drawn. An
  ...
  /**
    ...
    */
  open class ImageWMS ()
    extends typingsJapgolly.openlayers.mod.source.ImageWMS {
  ...
  /**
    ...
    */
  open class OSM ()
    extends typingsJapgolly.openlayers.mod.source.OSM {
  ...
  object OSM {
    ...
    @js.native
    def ATTRIBUTION: typingsJapgolly.openlayers.mod.Attribution = js.native
    inline def ATTRIBUTION_=(x: typingsJapgolly.openlayers.mod.Attribution): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ATTRIBUTION")(x.asInstanceOf[js.Any])
  }
  ...
  open class Raster protected ()
    extends typingsJapgolly.openlayers.mod.source.Raster {
    /**
      * @classdesc
      * A source that transforms data from any number of input sources using an array
      * of {@link ol.RasterOperation} functions to transform input pixel values into
  ...
  open class RasterEvent protected ()
    extends typingsJapgolly.openlayers.mod.source.RasterEvent {
    /**
      * @classdesc
      * Events emitted by {@link ol.source.Raster} instances are instances of this
      * type.
  ...
  open class Source protected ()
    extends typingsJapgolly.openlayers.mod.source.Source {
    /**
      * @classdesc
      * Abstract base class; normally only used for creating subclasses and not
      * instantiated in apps.
  ...
  open class Stamen protected ()
    extends typingsJapgolly.openlayers.mod.source.Stamen {
    /**
      * @classdesc
      * Layer source for the Stamen tile server.
      *
  ...
  open class Tile protected ()
    extends typingsJapgolly.openlayers.mod.source.Tile {
    /**
      * @classdesc
      * Abstract base class; normally only used for creating subclasses and not
      * instantiated in apps.
  ...
  open class TileArcGISRest ()
    extends typingsJapgolly.openlayers.mod.source.TileArcGISRest {
  ...
  open class TileDebug protected ()
    extends typingsJapgolly.openlayers.mod.source.TileDebug {
    /**
      * @classdesc
      * A pseudo tile source, which does not fetch tiles from a server, but renders
      * a grid outline for the tile grid/projection along with the coordinates for
  ...
  open class TileEvent protected ()
    extends typingsJapgolly.openlayers.mod.source.TileEvent {
    /**
      * @classdesc
      * Events emitted by {@link ol.source.Tile} instances are instances of this
      * type.
  ...
  open class TileImage protected ()
    extends typingsJapgolly.openlayers.mod.source.TileImage {
    /**
      * @classdesc
      * Base class for sources providing images divided into a tile grid.
      *
  ...
  open class TileJSON protected ()
    extends typingsJapgolly.openlayers.mod.source.TileJSON {
    /**
      * @classdesc
      * Layer source for tile data in TileJSON format.
      *
  ...
  open class TileUTFGrid protected ()
    extends typingsJapgolly.openlayers.mod.source.TileUTFGrid {
    /**
      * @classdesc
      * Layer source for UTFGrid interaction data loaded from TileJSON format.
      *
  ...
  /**
    ...
    */
  open class TileWMS ()
    extends typingsJapgolly.openlayers.mod.source.TileWMS {
  ...
  open class UrlTile protected ()
    extends typingsJapgolly.openlayers.mod.source.UrlTile {
    /**
      * @classdesc
      * Base class for sources providing tiles divided into a tile grid over http.
      *
  ...
  /**
    ...
    */
  open class Vector ()
    extends typingsJapgolly.openlayers.mod.source.Vector {
  ...
  open class VectorEvent protected ()
    extends typingsJapgolly.openlayers.mod.source.VectorEvent {
    /**
      * @classdesc
      * Events emitted by {@link ol.source.Vector} instances are instances of this
      * type.
    ...
    def this(`type`: String, opt_feature: typingsJapgolly.openlayers.mod.Feature) = this()
  }
  ...
  open class VectorTile protected ()
    extends typingsJapgolly.openlayers.mod.source.VectorTile {
    /**
      * @classdesc
      * Class for layer sources providing vector data divided into a tile grid, to be
      * used with {@link ol.layer.VectorTile}. Although this source receives tiles
  ...
  open class WMTS protected ()
    extends typingsJapgolly.openlayers.mod.source.WMTS {
    /**
      * @classdesc
      * Layer source for tile data from WMTS servers.
      *
  ...
  /**
    ...
    */
  open class XYZ ()
    extends typingsJapgolly.openlayers.mod.source.XYZ {
  ...
  /**
    ...
    */
  open class Zoomify ()
    extends typingsJapgolly.openlayers.mod.source.Zoomify {
