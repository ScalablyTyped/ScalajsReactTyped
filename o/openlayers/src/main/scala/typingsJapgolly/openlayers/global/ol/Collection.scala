...
import typingsJapgolly.openlayers.mod.Collection.EventType
...
open class Collection[T] ()
  extends typingsJapgolly.openlayers.mod.Collection[T] {
...
object Collection {
  ...
  open class Event protected ()
    extends typingsJapgolly.openlayers.mod.Collection.Event {
    /**
      * @classdesc
      * Events emitted by {@link ol.Collection} instances are instances of this
      * type.
