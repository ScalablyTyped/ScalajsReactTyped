...
object control {
  ...
  object AttributionOptions {
    ...
    inline def apply(): typingsJapgolly.openlayers.mod.olx.control.AttributionOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.openlayers.mod.olx.control.AttributionOptions]
    }
    
    extension [Self <: typingsJapgolly.openlayers.mod.olx.control.AttributionOptions](x: Self) {
  ...
  trait DefaultsOptions extends StObject {
    ...
    var attributionOptions: js.UndefOr[typingsJapgolly.openlayers.mod.olx.control.AttributionOptions] = js.undefined
  ...
  object DefaultsOptions {
    ...
    extension [Self <: DefaultsOptions](x: Self) {
      ...
      inline def setAttributionOptions(value: typingsJapgolly.openlayers.mod.olx.control.AttributionOptions): Self = StObject.set(x, "attributionOptions", value.asInstanceOf[js.Any])
  ...
  object RotateOptions {
    ...
    extension [Self <: RotateOptions](x: Self) {
      ...
      inline def setResetNorth(value: CallbackTo[Any]): Self = StObject.set(x, "resetNorth", value.toJsFn)
