...
import typingsJapgolly.openlayers.mod.style.AtlasManager
...
object style {
  ...
  object StyleOptions {
    ...
    extension [Self <: StyleOptions](x: Self) {
      ...
      inline def setGeometryFunction1(
        value: /* feature */ Feature | typingsJapgolly.openlayers.mod.render.Feature => Geometry | typingsJapgolly.openlayers.mod.render.Feature
  ...
  */
  ...
  object TextPlacement {
    ...
    inline def line: typingsJapgolly.openlayers.openlayersStrings.line = "line".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.line]
