package typingsJapgolly.openlayers.mod.olx.view

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.openlayers.mod.Size
import typingsJapgolly.openlayers.mod.olx.animation.AnimateCallback
...
object FitOptions {
  @scala.inline
  def apply(
    callback: /* completed */ Boolean => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: /* completed */ scala.Boolean) => callback(t0).runNow()))
