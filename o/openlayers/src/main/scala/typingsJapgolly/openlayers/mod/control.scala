  ...
  object ScaleLine {
    ...
    */
    ...
    object Units {
      ...
      inline def degrees: typingsJapgolly.openlayers.openlayersStrings.degrees = "degrees".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.degrees]
      
      inline def imperial: typingsJapgolly.openlayers.openlayersStrings.imperial = "imperial".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.imperial]
      
      inline def metric: typingsJapgolly.openlayers.openlayersStrings.metric = "metric".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.metric]
      
      inline def nautical: typingsJapgolly.openlayers.openlayersStrings.nautical = "nautical".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.nautical]
      
      inline def us: typingsJapgolly.openlayers.openlayersStrings.us = "us".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.us]
    }
  }
