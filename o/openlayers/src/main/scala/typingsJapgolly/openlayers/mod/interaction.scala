...
import typingsJapgolly.openlayers.mod.geom.Polygon
import typingsJapgolly.openlayers.mod.layer.Vector
...
object interaction {
  ...
  open class Select () extends Interaction {
    ...
    def getLayer(feature: typingsJapgolly.openlayers.mod.render.Feature): Vector = js.native
