...
object style {
  ...
  open class Icon ()
    ...
    /**
      ...
      * @api
      */
    def getImage(pixelRatio: Double): typingsJapgolly.openlayers.mod.style.Image | HTMLCanvasElement = js.native
  ...
  open class RegularShape protected ()
    ...
    /**
      ...
      * @api
      */
    def getImage(pixelRatio: Double): HTMLCanvasElement | HTMLVideoElement | typingsJapgolly.openlayers.mod.style.Image = js.native
  ...
  open class Style () extends StObject {
    ...
    /**
      ...
      * @api
      */
    def getImage(): typingsJapgolly.openlayers.mod.style.Image = js.native
    ...
    /**
      ...
      * @api
      */
    def setImage(image: typingsJapgolly.openlayers.mod.style.Image): Unit = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.openlayers.openlayersStrings.fraction
    - typingsJapgolly.openlayers.openlayersStrings.pixels
  */
  trait IconAnchorUnits extends StObject
  object IconAnchorUnits {
    
    inline def fraction: typingsJapgolly.openlayers.openlayersStrings.fraction = "fraction".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.fraction]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.openlayers.openlayersStrings.`bottom-right`
    - typingsJapgolly.openlayers.openlayersStrings.`top-left`
