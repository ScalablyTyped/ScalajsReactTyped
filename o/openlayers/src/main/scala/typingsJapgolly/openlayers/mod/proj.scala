...
object proj {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.openlayers.openlayersStrings.ft
    - typingsJapgolly.openlayers.openlayersStrings.m
    - typingsJapgolly.openlayers.openlayersStrings.pixels
    - typingsJapgolly.openlayers.openlayersStrings.`tile-pixels`
    - typingsJapgolly.openlayers.openlayersStrings.`us-ft`
  */
  ...
  object Units {
    ...
    inline def ft: typingsJapgolly.openlayers.openlayersStrings.ft = "ft".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.ft]
    
    inline def m: typingsJapgolly.openlayers.openlayersStrings.m = "m".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.m]
    
    inline def pixels: typingsJapgolly.openlayers.openlayersStrings.pixels = "pixels".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.pixels]
    
    inline def `tile-pixels`: typingsJapgolly.openlayers.openlayersStrings.`tile-pixels` = "tile-pixels".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.`tile-pixels`]
    
    inline def `us-ft`: typingsJapgolly.openlayers.openlayersStrings.`us-ft` = "us-ft".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.`us-ft`]
  }
}
