...
import typingsJapgolly.openlayers.mod.source.Image
...
import typingsJapgolly.openlayers.mod.source.VectorTile
...
object layer {
  ...
  */
  ...
  object VectorRenderType {
    ...
    inline def vector: typingsJapgolly.openlayers.openlayersStrings.vector = "vector".asInstanceOf[typingsJapgolly.openlayers.openlayersStrings.vector]
  }
