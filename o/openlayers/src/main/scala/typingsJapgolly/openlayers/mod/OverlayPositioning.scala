...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.openlayers.openlayersStrings.`bottom-center`
  - typingsJapgolly.openlayers.openlayersStrings.`bottom-right`
  - typingsJapgolly.openlayers.openlayersStrings.`center-left`
  - typingsJapgolly.openlayers.openlayersStrings.`center-center`
  - typingsJapgolly.openlayers.openlayersStrings.`center-right`
