package typingsJapgolly.opentelemetryPropagatorB3

import typingsJapgolly.opentelemetryPropagatorB3.buildSrcTypesMod.B3PropagatorConfig
...
object mod {
  ...
  object B3InjectEncoding extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.opentelemetryPropagatorB3.buildSrcTypesMod.B3InjectEncoding & Double
      ] = js.native
    
    /* 1 */ val MULTI_HEADER: typingsJapgolly.opentelemetryPropagatorB3.buildSrcTypesMod.B3InjectEncoding.MULTI_HEADER & Double = js.native
    
    /* 0 */ val SINGLE_HEADER: typingsJapgolly.opentelemetryPropagatorB3.buildSrcTypesMod.B3InjectEncoding.SINGLE_HEADER & Double = js.native
  }
  
  @JSImport("@opentelemetry/propagator-b3", "B3Propagator")
  @js.native
  open class B3Propagator ()
    extends typingsJapgolly.opentelemetryPropagatorB3.buildSrcB3PropagatorMod.B3Propagator {
