...
import typingsJapgolly.optimism.libDepMod.EntryMethodName
...
object anon {
  ...
  object DirtyKey {
    ...
    inline def apply[TKeyArgs /* <: js.Array[Any] */, TCacheKey, TResult, TArgs /* <: js.Array[Any] */](
      dirty: TKeyArgs => Callback,
      dirtyKey: TCacheKey => Callback,
    ...
    extension [Self <: DirtyKey[?, ?, ?, ?], TKeyArgs /* <: js.Array[Any] */, TCacheKey, TResult, TArgs /* <: js.Array[Any] */](x: Self & (DirtyKey[TKeyArgs, TCacheKey, TResult, TArgs])) {
      ...
      inline def setDirty(value: TKeyArgs => Callback): Self = StObject.set(x, "dirty", js.Any.fromFunction1((t0: TKeyArgs) => value(t0).runNow()))
      
      inline def setDirtyKey(value: TCacheKey => Callback): Self = StObject.set(x, "dirtyKey", js.Any.fromFunction1((t0: TCacheKey) => value(t0).runNow()))
