...
import typingsJapgolly.oauthJs.anon.Instantiable
...
object OAuth {
  ...
  object SignatureMethod {
    ...
    inline def apply(
      ...
      initialize: (String, Accessor) => Callback,
      key: String,
      sign: Message => String
    ): SignatureMethod = {
      val __obj = js.Dynamic.literal(getSignature = js.Any.fromFunction1(getSignature), initialize = js.Any.fromFunction2((t0: String, t1: Accessor) => (initialize(t0, t1)).runNow()), key = key.asInstanceOf[js.Any], sign = js.Any.fromFunction1(sign))
    ...
    extension [Self <: SignatureMethod](x: Self) {
      ...
      inline def setInitialize(value: (String, Accessor) => Callback): Self = StObject.set(x, "initialize", js.Any.fromFunction2((t0: String, t1: Accessor) => (value(t0, t1)).runNow()))
  ...
  object SignatureMethodStatic {
    ...
    extension [Self <: SignatureMethodStatic](x: Self) {
      ...
      inline def setRegisterMethodClass(value: (js.Array[String], Instantiable) => Callback): Self = StObject.set(x, "registerMethodClass", js.Any.fromFunction2((t0: js.Array[String], t1: Instantiable) => (value(t0, t1)).runNow()))
      
      inline def setSign(value: (Message, Accessor) => Callback): Self = StObject.set(x, "sign", js.Any.fromFunction2((t0: Message, t1: Accessor) => (value(t0, t1)).runNow()))
    }
  }
