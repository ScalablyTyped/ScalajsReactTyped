package typingsJapgolly.openapiFactory
...
object mod {
  ...
  object ApiOptions {
    ...
    extension [Self <: ApiOptions](x: Self) {
      ...
      inline def setErrorMiddleware(value: CallbackTo[Any]): Self = StObject.set(x, "errorMiddleware", value.toJsFn)
      
      inline def setErrorMiddlewareUndefined: Self = StObject.set(x, "errorMiddleware", js.undefined)
      
      inline def setRequestMiddleware(value: CallbackTo[Any]): Self = StObject.set(x, "requestMiddleware", value.toJsFn)
      
      inline def setRequestMiddlewareUndefined: Self = StObject.set(x, "requestMiddleware", js.undefined)
      
      inline def setResponseMiddleware(value: CallbackTo[Any]): Self = StObject.set(x, "responseMiddleware", value.toJsFn)
