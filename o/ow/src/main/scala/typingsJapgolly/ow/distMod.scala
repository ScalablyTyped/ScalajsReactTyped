...
import typingsJapgolly.ow.distModifiersMod.Modifiers
...
object distMod {
  ...
  open class AnyPredicate[T] protected ()
    extends typingsJapgolly.ow.distPredicatesMod.AnyPredicate[T] {
  ...
  open class ArgumentError protected ()
    extends typingsJapgolly.ow.distArgumentErrorMod.ArgumentError {
  ...
  open class ArrayBufferPredicate[T /* <: ArrayBufferLike */] protected ()
    extends typingsJapgolly.ow.distPredicatesMod.ArrayBufferPredicate[T] {
  ...
  open class ArrayPredicate[T] ()
    extends typingsJapgolly.ow.distPredicatesMod.ArrayPredicate[T] {
  ...
  open class BigIntPredicate ()
    extends typingsJapgolly.ow.distPredicatesMod.BigIntPredicate {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class BooleanPredicate ()
    extends typingsJapgolly.ow.distPredicatesMod.BooleanPredicate {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class DataViewPredicate ()
    extends typingsJapgolly.ow.distPredicatesMod.DataViewPredicate {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class DatePredicate ()
    extends typingsJapgolly.ow.distPredicatesMod.DatePredicate {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class ErrorPredicate ()
    extends typingsJapgolly.ow.distPredicatesMod.ErrorPredicate {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class MapPredicate[T1, T2] ()
    extends typingsJapgolly.ow.distPredicatesMod.MapPredicate[T1, T2] {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class NumberPredicate ()
    extends typingsJapgolly.ow.distPredicatesMod.NumberPredicate {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class ObjectPredicate[T /* <: js.Object */] ()
    extends typingsJapgolly.ow.distPredicatesMod.ObjectPredicate[T] {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class Predicate[T] protected ()
    extends typingsJapgolly.ow.distPredicatesPredicateMod.Predicate[T] {
    def this(`type`: String) = this()
    def this(`type`: String, options: PredicateOptions) = this()
  }
  ...
  open class SetPredicate[T] ()
    extends typingsJapgolly.ow.distPredicatesMod.SetPredicate[T] {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class StringPredicate ()
    extends typingsJapgolly.ow.distPredicatesMod.StringPredicate {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class TypedArrayPredicate[T /* <: TypedArray */] protected ()
    extends typingsJapgolly.ow.distPredicatesMod.TypedArrayPredicate[T] {
    def this(`type`: String) = this()
    def this(`type`: String, options: PredicateOptions) = this()
  }
  ...
  open class WeakMapPredicate[KeyType /* <: js.Object */] ()
    extends typingsJapgolly.ow.distPredicatesMod.WeakMapPredicate[KeyType] {
    def this(options: PredicateOptions) = this()
  }
  ...
  open class WeakSetPredicate[T /* <: js.Object */] ()
    extends typingsJapgolly.ow.distPredicatesMod.WeakSetPredicate[T] {
    def this(options: PredicateOptions) = this()
  }
