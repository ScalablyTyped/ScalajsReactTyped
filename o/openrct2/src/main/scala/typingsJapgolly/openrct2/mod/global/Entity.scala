...
object Entity {
  ...
  inline def apply(id: Double, remove: Callback, `type`: EntityType, x: Double, y: Double, z: Double): Entity = {
    val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], remove = remove.toJsFn, x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any], z = z.asInstanceOf[js.Any])
