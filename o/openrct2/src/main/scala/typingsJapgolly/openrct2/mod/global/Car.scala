...
object Car {
  ...
  extension [Self <: Car](x: Self) {
    ...
    inline def setTravelBy(value: Double => Callback): Self = StObject.set(x, "travelBy", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
