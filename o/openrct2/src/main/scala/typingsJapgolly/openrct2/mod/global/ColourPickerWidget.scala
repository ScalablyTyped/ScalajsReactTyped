...
import typingsJapgolly.openrct2.openrct2Strings.colourpicker
...
object ColourPickerWidget {
  ...
  extension [Self <: ColourPickerWidget](x: Self) {
    ...
    inline def setOnChange(value: /* colour */ Double => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* colour */ Double) => value(t0).runNow()))
