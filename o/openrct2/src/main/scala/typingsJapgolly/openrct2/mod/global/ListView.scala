...
import typingsJapgolly.openrct2.openrct2Strings.listview
...
object ListView {
  ...
  extension [Self <: ListView](x: Self) {
    ...
    inline def setOnClick(value: (/* item */ Double, /* column */ Double) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* item */ Double, t1: /* column */ Double) => (value(t0, t1)).runNow()))
    
    inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
    
    inline def setOnHighlight(value: (/* item */ Double, /* column */ Double) => Callback): Self = StObject.set(x, "onHighlight", js.Any.fromFunction2((t0: /* item */ Double, t1: /* column */ Double) => (value(t0, t1)).runNow()))
