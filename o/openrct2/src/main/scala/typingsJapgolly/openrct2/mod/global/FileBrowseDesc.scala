...
import typingsJapgolly.openrct2.openrct2Strings.game
import typingsJapgolly.openrct2.openrct2Strings.heightmap
...
object FileBrowseDesc {
  ...
  inline def apply(callback: String => Callback, fileType: game | heightmap): FileBrowseDesc = {
    val __obj = js.Dynamic.literal(callback = js.Any.fromFunction1((t0: String) => callback(t0).runNow()), fileType = fileType.asInstanceOf[js.Any])
