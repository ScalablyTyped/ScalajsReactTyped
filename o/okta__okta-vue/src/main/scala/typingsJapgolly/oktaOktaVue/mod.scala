...
import typingsJapgolly.oktaOktaVue.bundlesTypesTypesMod.OktaVueOptions
import typingsJapgolly.vueRouter.mod.RouteLocationNormalized
...
object mod {
  ...
  object vueRuntimeCoreAugmentingMod {
    ...
    object ComponentCustomProperties {
      ...
      inline def apply(
        $_oktaVue_handleAuthStateUpdate: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AuthState */ Any => Callback,
        $auth: OktaAuth,
        authState: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AuthState */ Any
      ): ComponentCustomProperties = {
        val __obj = js.Dynamic.literal($_oktaVue_handleAuthStateUpdate = js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AuthState */ Any) => $_oktaVue_handleAuthStateUpdate(t0).runNow()), $auth = $auth.asInstanceOf[js.Any], authState = authState.asInstanceOf[js.Any])
      ...
      extension [Self <: ComponentCustomProperties](x: Self) {
        ...
        inline def set$_oktaVue_handleAuthStateUpdate(
          value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AuthState */ Any => Callback
        ): Self = StObject.set(x, "$_oktaVue_handleAuthStateUpdate", js.Any.fromFunction1((t0: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AuthState */ Any) => value(t0).runNow()))
