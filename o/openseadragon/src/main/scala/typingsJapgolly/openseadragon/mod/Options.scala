...
import typingsJapgolly.openseadragon.anon.Image
import typingsJapgolly.openseadragon.anon.Levels
import typingsJapgolly.openseadragon.anon.Type
import typingsJapgolly.openseadragon.openseadragonBooleans.`false`
import typingsJapgolly.openseadragon.openseadragonStrings.ABSOLUTE
import typingsJapgolly.openseadragon.openseadragonStrings.Anonymous
import typingsJapgolly.openseadragon.openseadragonStrings.BOTTOM_LEFT
import typingsJapgolly.openseadragon.openseadragonStrings.BOTTOM_RIGHT
import typingsJapgolly.openseadragon.openseadragonStrings.TOP_LEFT
import typingsJapgolly.openseadragon.openseadragonStrings.TOP_RIGHT
import typingsJapgolly.openseadragon.openseadragonStrings.`destination-atop`
import typingsJapgolly.openseadragon.openseadragonStrings.`destination-in`
import typingsJapgolly.openseadragon.openseadragonStrings.`destination-out`
import typingsJapgolly.openseadragon.openseadragonStrings.`destination-over`
import typingsJapgolly.openseadragon.openseadragonStrings.`source-atop`
import typingsJapgolly.openseadragon.openseadragonStrings.`source-in`
import typingsJapgolly.openseadragon.openseadragonStrings.`source-out`
import typingsJapgolly.openseadragon.openseadragonStrings.`source-over`
import typingsJapgolly.openseadragon.openseadragonStrings.`use-credentials`
import typingsJapgolly.openseadragon.openseadragonStrings.copy
import typingsJapgolly.openseadragon.openseadragonStrings.horizontal
import typingsJapgolly.openseadragon.openseadragonStrings.lighter
import typingsJapgolly.openseadragon.openseadragonStrings.vertical
import typingsJapgolly.openseadragon.openseadragonStrings.xor
