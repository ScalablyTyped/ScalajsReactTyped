...
object OverlayOptions {
  ...
  extension [Self <: OverlayOptions](x: Self) {
    ...
    inline def setOnDraw(value: (/* position */ Point, /* size */ Point, /* element */ HTMLElement) => Callback): Self = StObject.set(x, "onDraw", js.Any.fromFunction3((t0: /* position */ Point, t1: /* size */ Point, t2: /* element */ HTMLElement) => (value(t0, t1, t2)).runNow()))
