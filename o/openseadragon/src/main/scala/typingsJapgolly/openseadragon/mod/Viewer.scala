...
import typingsJapgolly.openseadragon.openseadragonStrings.`add-item-failed`
import typingsJapgolly.openseadragon.openseadragonStrings.`add-overlay`
import typingsJapgolly.openseadragon.openseadragonStrings.`animation-finish`
import typingsJapgolly.openseadragon.openseadragonStrings.`animation-start`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-click`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-contextmenu`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-double-click`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-drag-end`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-drag`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-enter`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-exit`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-key`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-nonprimary-press`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-nonprimary-release`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-pinch`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-press`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-release`
import typingsJapgolly.openseadragon.openseadragonStrings.`canvas-scroll`
import typingsJapgolly.openseadragon.openseadragonStrings.`clear-overlay`
import typingsJapgolly.openseadragon.openseadragonStrings.`container-enter`
import typingsJapgolly.openseadragon.openseadragonStrings.`container-exit`
import typingsJapgolly.openseadragon.openseadragonStrings.`controls-enabled`
import typingsJapgolly.openseadragon.openseadragonStrings.`full-page`
import typingsJapgolly.openseadragon.openseadragonStrings.`full-screen`
import typingsJapgolly.openseadragon.openseadragonStrings.`mouse-enabled`
import typingsJapgolly.openseadragon.openseadragonStrings.`navigator-click`
import typingsJapgolly.openseadragon.openseadragonStrings.`navigator-drag`
import typingsJapgolly.openseadragon.openseadragonStrings.`navigator-scroll`
import typingsJapgolly.openseadragon.openseadragonStrings.`open-failed`
import typingsJapgolly.openseadragon.openseadragonStrings.`pre-full-page`
import typingsJapgolly.openseadragon.openseadragonStrings.`pre-full-screen`
import typingsJapgolly.openseadragon.openseadragonStrings.`remove-overlay`
import typingsJapgolly.openseadragon.openseadragonStrings.`reset-size`
import typingsJapgolly.openseadragon.openseadragonStrings.`tile-drawing`
import typingsJapgolly.openseadragon.openseadragonStrings.`tile-drawn`
import typingsJapgolly.openseadragon.openseadragonStrings.`tile-load-failed`
import typingsJapgolly.openseadragon.openseadragonStrings.`tile-loaded`
import typingsJapgolly.openseadragon.openseadragonStrings.`tile-unloaded`
import typingsJapgolly.openseadragon.openseadragonStrings.`update-level`
import typingsJapgolly.openseadragon.openseadragonStrings.`update-overlay`
import typingsJapgolly.openseadragon.openseadragonStrings.`update-tile`
import typingsJapgolly.openseadragon.openseadragonStrings.`update-viewport`
import typingsJapgolly.openseadragon.openseadragonStrings.`viewport-change`
import typingsJapgolly.openseadragon.openseadragonStrings.animation
import typingsJapgolly.openseadragon.openseadragonStrings.close
import typingsJapgolly.openseadragon.openseadragonStrings.constrain
import typingsJapgolly.openseadragon.openseadragonStrings.flip
import typingsJapgolly.openseadragon.openseadragonStrings.home
import typingsJapgolly.openseadragon.openseadragonStrings.open
import typingsJapgolly.openseadragon.openseadragonStrings.page
import typingsJapgolly.openseadragon.openseadragonStrings.pan
import typingsJapgolly.openseadragon.openseadragonStrings.resize
import typingsJapgolly.openseadragon.openseadragonStrings.rotate
import typingsJapgolly.openseadragon.openseadragonStrings.visible
import typingsJapgolly.openseadragon.openseadragonStrings.zoom
...
open class Viewer protected () extends ControlDock {
  ...
  def removeAllHandlers(
    eventName: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 55, starting with typingsJapgolly.openseadragon.openseadragonStrings.`add-item-failed`, typingsJapgolly.openseadragon.openseadragonStrings.`add-overlay`, typingsJapgolly.openseadragon.openseadragonStrings.animation */ Any
  ): Unit = js.native
