...
import typingsJapgolly.openseadragon.openseadragonStrings.`bounds-change`
import typingsJapgolly.openseadragon.openseadragonStrings.`clip-change`
import typingsJapgolly.openseadragon.openseadragonStrings.`composite-operation-change`
import typingsJapgolly.openseadragon.openseadragonStrings.`fully-loaded-change`
import typingsJapgolly.openseadragon.openseadragonStrings.`opacity-change`
