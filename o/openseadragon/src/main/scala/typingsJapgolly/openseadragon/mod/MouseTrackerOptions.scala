...
object MouseTrackerOptions {
  ...
  extension [Self <: MouseTrackerOptions](x: Self) {
    ...
    inline def setBlurHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "blurHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    ...
    inline def setClickHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "clickHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    ...
    inline def setContextMenuHandler(value: ContextMenuMouseTrackerEvent => Callback): Self = StObject.set(x, "contextMenuHandler", js.Any.fromFunction1((t0: ContextMenuMouseTrackerEvent) => value(t0).runNow()))
    ...
    inline def setDblClickHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "dblClickHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    ...
    inline def setDragEndHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "dragEndHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setDragEndHandlerUndefined: Self = StObject.set(x, "dragEndHandler", js.undefined)
    
    inline def setDragHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "dragHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    ...
    inline def setEnterHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "enterHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setEnterHandlerUndefined: Self = StObject.set(x, "enterHandler", js.undefined)
    
    inline def setExitHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "exitHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setExitHandlerUndefined: Self = StObject.set(x, "exitHandler", js.undefined)
    
    inline def setFocusHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "focusHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setFocusHandlerUndefined: Self = StObject.set(x, "focusHandler", js.undefined)
    
    inline def setKeyDownHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "keyDownHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setKeyDownHandlerUndefined: Self = StObject.set(x, "keyDownHandler", js.undefined)
    
    inline def setKeyHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "keyHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setKeyHandlerUndefined: Self = StObject.set(x, "keyHandler", js.undefined)
    
    inline def setKeyUpHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "keyUpHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setKeyUpHandlerUndefined: Self = StObject.set(x, "keyUpHandler", js.undefined)
    
    inline def setLeaveHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "leaveHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setLeaveHandlerUndefined: Self = StObject.set(x, "leaveHandler", js.undefined)
    
    inline def setMoveHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "moveHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setMoveHandlerUndefined: Self = StObject.set(x, "moveHandler", js.undefined)
    
    inline def setNonPrimaryPressHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "nonPrimaryPressHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setNonPrimaryPressHandlerUndefined: Self = StObject.set(x, "nonPrimaryPressHandler", js.undefined)
    
    inline def setNonPrimaryReleaseHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "nonPrimaryReleaseHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setNonPrimaryReleaseHandlerUndefined: Self = StObject.set(x, "nonPrimaryReleaseHandler", js.undefined)
    
    inline def setOutHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "outHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setOutHandlerUndefined: Self = StObject.set(x, "outHandler", js.undefined)
    
    inline def setOverHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "overHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setOverHandlerUndefined: Self = StObject.set(x, "overHandler", js.undefined)
    
    inline def setPinchHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "pinchHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setPinchHandlerUndefined: Self = StObject.set(x, "pinchHandler", js.undefined)
    
    inline def setPreProcessEventHandler(value: /* event */ EventProcessInfo => Callback): Self = StObject.set(x, "preProcessEventHandler", js.Any.fromFunction1((t0: /* event */ EventProcessInfo) => value(t0).runNow()))
    
    inline def setPreProcessEventHandlerUndefined: Self = StObject.set(x, "preProcessEventHandler", js.undefined)
    
    inline def setPressHandler(value: PressMouseTrackerEvent => Callback): Self = StObject.set(x, "pressHandler", js.Any.fromFunction1((t0: PressMouseTrackerEvent) => value(t0).runNow()))
    
    inline def setPressHandlerUndefined: Self = StObject.set(x, "pressHandler", js.undefined)
    
    inline def setReleaseHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "releaseHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
    
    inline def setReleaseHandlerUndefined: Self = StObject.set(x, "releaseHandler", js.undefined)
    
    inline def setScrollHandler(value: MouseTrackerEvent[Event] => Callback): Self = StObject.set(x, "scrollHandler", js.Any.fromFunction1((t0: MouseTrackerEvent[Event]) => value(t0).runNow()))
