package typingsJapgolly.oktaJwtVerifier
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS256
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS384
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS512
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS256
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS384
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS512
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES256
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES384
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES512
    - typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.none
  */
  trait Algorithm extends StObject
  object Algorithm {
    
    inline def ES256: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES256 = "ES256".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES256]
    
    inline def ES384: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES384 = "ES384".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES384]
    
    inline def ES512: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES512 = "ES512".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.ES512]
    
    inline def HS256: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS256 = "HS256".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS256]
    
    inline def HS384: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS384 = "HS384".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS384]
    
    inline def HS512: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS512 = "HS512".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.HS512]
    
    inline def RS256: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS256 = "RS256".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS256]
    
    inline def RS384: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS384 = "RS384".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS384]
    
    inline def RS512: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS512 = "RS512".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.RS512]
    
    inline def none: typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.none = "none".asInstanceOf[typingsJapgolly.oktaJwtVerifier.oktaJwtVerifierStrings.none]
  }
  ...
  object Jwt {
    ...
    inline def apply(
      ...
      isNotBefore: CallbackTo[Boolean]
    ): Jwt = {
      val __obj = js.Dynamic.literal(claims = claims.asInstanceOf[js.Any], header = header.asInstanceOf[js.Any], isExpired = isExpired.toJsFn, isNotBefore = isNotBefore.toJsFn)
    ...
    extension [Self <: Jwt](x: Self) {
      ...
      inline def setIsNotBefore(value: CallbackTo[Boolean]): Self = StObject.set(x, "isNotBefore", value.toJsFn)
    }
  }
  ...
  trait VerifierOptions extends StObject {
    ...
    /**
      ...
      */
    var requestAgentOptions: js.UndefOr[AgentOptions | typingsJapgolly.node.httpsMod.AgentOptions] = js.undefined
  }
  object VerifierOptions {
    ...
    extension [Self <: VerifierOptions](x: Self) {
      ...
      inline def setRequestAgentOptions(value: AgentOptions | typingsJapgolly.node.httpsMod.AgentOptions): Self = StObject.set(x, "requestAgentOptions", value.asInstanceOf[js.Any])
