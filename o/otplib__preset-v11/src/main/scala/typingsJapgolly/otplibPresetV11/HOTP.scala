...
trait HOTP extends StObject {
  ...
  var HOTP: Instantiable0[typingsJapgolly.otplibPresetV11.HOTP]
...
object HOTP {
  ...
  extension [Self <: HOTP](x: Self) {
    ...
    inline def setResetOptions(value: CallbackTo[HOTP]): Self = StObject.set(x, "resetOptions", value.toJsFn)
