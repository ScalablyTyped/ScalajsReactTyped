package typingsJapgolly.optionalJs
...
object mod {
  ...
  object Optional {
    ...
    extension [Self <: Optional[?], T](x: Self & Optional[T]) {
      ...
      inline def setIfPresent(value: js.Function1[/* value */ T, Unit] => Callback): Self = StObject.set(x, "ifPresent", js.Any.fromFunction1((t0: js.Function1[/* value */ T, Unit]) => value(t0).runNow()))
      
      inline def setIfPresentOrElse(value: (js.Function1[/* value */ T, Unit], js.Function0[Unit]) => Callback): Self = StObject.set(x, "ifPresentOrElse", js.Any.fromFunction2((t0: js.Function1[/* value */ T, Unit], t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
