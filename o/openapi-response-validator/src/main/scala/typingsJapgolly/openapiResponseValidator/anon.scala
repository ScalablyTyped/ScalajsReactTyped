...
object anon {
  ...
  trait Schema extends StObject {
    ...
    var schema: typingsJapgolly.openapiTypes.mod.OpenAPIV2.Schema | SchemaObject
  }
  object Schema {
    
    inline def apply(schema: typingsJapgolly.openapiTypes.mod.OpenAPIV2.Schema | SchemaObject): Schema = {
    ...
    extension [Self <: Schema](x: Self) {
      ...
      inline def setSchema(value: typingsJapgolly.openapiTypes.mod.OpenAPIV2.Schema | SchemaObject): Self = StObject.set(x, "schema", value.asInstanceOf[js.Any])
    }
  }
}
