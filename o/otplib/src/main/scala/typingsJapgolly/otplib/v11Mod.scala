...
import typingsJapgolly.otplibPresetV11.HotpOptionsInterface
import typingsJapgolly.otplibPresetV11.HotpVerifyOptionsInterface
import typingsJapgolly.otplibPresetV11.TotpOptionsInterface
import typingsJapgolly.otplibPresetV11.TotpVerifyOptionsInterface
...
object v11Mod {
  ...
  object authenticator extends Shortcut {
    ...
    @js.native
    val ^ : typingsJapgolly.otplibPresetV11.Authenticator = js.native
    ...
    open class Authenticator ()
      extends StObject
         with typingsJapgolly.otplibPresetV11.Authenticator {
      
      /* CompleteClass */
      var HOTP: Instantiable0[typingsJapgolly.otplibPresetV11.HOTP] = js.native
      
      /* CompleteClass */
      var TOTP: Instantiable0[typingsJapgolly.otplibPresetV11.TOTP] = js.native
    ...
    open class HOTP ()
      extends StObject
         with typingsJapgolly.otplibPresetV11.HOTP {
    ...
    open class TOTP ()
      extends StObject
         with typingsJapgolly.otplibPresetV11.TOTP {
    ...
    type _To = typingsJapgolly.otplibPresetV11.Authenticator
    
    /* This means you don't have to write `^`, but can instead just say `authenticator.foo` */
    override def _to: typingsJapgolly.otplibPresetV11.Authenticator = ^
  }
  ...
  object hotp extends Shortcut {
    ...
    @js.native
    val ^ : typingsJapgolly.otplibPresetV11.HOTP = js.native
    ...
    type _To = typingsJapgolly.otplibPresetV11.HOTP
    
    /* This means you don't have to write `^`, but can instead just say `hotp.foo` */
    override def _to: typingsJapgolly.otplibPresetV11.HOTP = ^
  }
  ...
  object totp extends Shortcut {
    ...
    @js.native
    val ^ : typingsJapgolly.otplibPresetV11.TOTP = js.native
    ...
    type _To = typingsJapgolly.otplibPresetV11.TOTP
    
    /* This means you don't have to write `^`, but can instead just say `totp.foo` */
    override def _to: typingsJapgolly.otplibPresetV11.TOTP = ^
  }
}
