...
object sapMViewSettingsCustomItemMod {
  ...
  trait ViewSettingsCustomItem
    ...
    /**
      ...
      */
    def getCustomControl(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
  ...
  trait ViewSettingsCustomItemSettings
    ...
    /**
      ...
      */
    var customControl: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object ViewSettingsCustomItemSettings {
    ...
    extension [Self <: ViewSettingsCustomItemSettings](x: Self) {
      ...
      inline def setCustomControl(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "customControl", value.asInstanceOf[js.Any])
