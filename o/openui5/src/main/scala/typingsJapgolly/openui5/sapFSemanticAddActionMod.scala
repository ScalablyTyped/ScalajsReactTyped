...
object sapFSemanticAddActionMod {
  
  @JSImport("sap/f/semantic/AddAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: AddActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, AddAction]
  ...
  type AddAction = typingsJapgolly.openui5.sapFSemanticSemanticButtonMod.default
  
  type AddActionSettings = SemanticButtonSettings
}
