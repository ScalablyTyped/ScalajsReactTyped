...
object sapFSemanticExitFullScreenActionMod {
  
  @JSImport("sap/f/semantic/ExitFullScreenAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: ExitFullScreenActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ExitFullScreenAction]
  ...
  type ExitFullScreenAction = typingsJapgolly.openui5.sapFSemanticSemanticButtonMod.default
  
  type ExitFullScreenActionSettings = SemanticButtonSettings
}
