...
import typingsJapgolly.openui5.anon.Top
...
object sapUiCorePopupMod {
  ...
  open class default protected () extends Popup {
    ...
    def this(/**
      ...
      * in the page (i.e. rendered). In case of sap.ui.core.Control, the Popup ensures rendering before opening.
      */
    oContent: typingsJapgolly.openui5.sapUiCoreControlMod.default) = this()
    def this(/**
      * the content to render in the popup. In case of sap.ui.core.Element or DOMNode, the content must be present
      * in the page (i.e. rendered). In case of sap.ui.core.Control, the Popup ensures rendering before opening.
      */
    oContent: typingsJapgolly.openui5.sapUiCoreElementMod.default) = this()
    def this(
      /**
      * the content to render in the popup. In case of sap.ui.core.Element or DOMNode, the content must be present
      * in the page (i.e. rendered). In case of sap.ui.core.Control, the Popup ensures rendering before opening.
  ...
  object default {
    ...
    /**
      ...
      */
    inline def getWithinArea(): String | Element | typingsJapgolly.openui5.sapUiCoreElementMod.default | Window = ^.asInstanceOf[js.Dynamic].applyDynamic("getWithinArea")().asInstanceOf[String | Element | typingsJapgolly.openui5.sapUiCoreElementMod.default | Window]
    ...
    inline def setWithinArea(/**
      * The within area
      */
    vValue: typingsJapgolly.openui5.sapUiCoreElementMod.default): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setWithinArea")(vValue.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
  ...
  object Dock extends StObject {
    ...
    sealed trait BeginBottom
      extends StObject
         with Dock
    /* "begin bottom" */ val BeginBottom: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.BeginBottom & String = js.native
    
    @js.native
    sealed trait BeginCenter
      extends StObject
         with Dock
    /* "begin center" */ val BeginCenter: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.BeginCenter & String = js.native
    
    @js.native
    sealed trait BeginTop
      extends StObject
         with Dock
    /* "begin top" */ val BeginTop: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.BeginTop & String = js.native
    
    @js.native
    sealed trait CenterBottom
      extends StObject
         with Dock
    /* "center bottom" */ val CenterBottom: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.CenterBottom & String = js.native
    
    @js.native
    sealed trait CenterCenter
      extends StObject
         with Dock
    /* "center center" */ val CenterCenter: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.CenterCenter & String = js.native
    
    @js.native
    sealed trait CenterTop
      extends StObject
         with Dock
    /* "center top" */ val CenterTop: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.CenterTop & String = js.native
    
    @js.native
    sealed trait EndBottom
      extends StObject
         with Dock
    /* "end bottom" */ val EndBottom: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.EndBottom & String = js.native
    
    @js.native
    sealed trait EndCenter
      extends StObject
         with Dock
    /* "end center" */ val EndCenter: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.EndCenter & String = js.native
    
    @js.native
    sealed trait EndTop
      extends StObject
         with Dock
    /* "end top" */ val EndTop: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.EndTop & String = js.native
    
    @js.native
    sealed trait LeftBottom
      extends StObject
         with Dock
    /* "left bottom" */ val LeftBottom: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.LeftBottom & String = js.native
    
    @js.native
    sealed trait LeftCenter
      extends StObject
         with Dock
    /* "left center" */ val LeftCenter: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.LeftCenter & String = js.native
    
    @js.native
    sealed trait LeftTop
      extends StObject
         with Dock
    /* "left top" */ val LeftTop: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.LeftTop & String = js.native
    
    @js.native
    sealed trait RightBottom
      extends StObject
         with Dock
    /* "right bottom" */ val RightBottom: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.RightBottom & String = js.native
    
    @js.native
    sealed trait RightCenter
      extends StObject
         with Dock
    /* "right center" */ val RightCenter: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.RightCenter & String = js.native
    
    @js.native
    sealed trait RightTop
      extends StObject
         with Dock
    /* "right top" */ val RightTop: typingsJapgolly.openui5.sapUiCorePopupMod.Dock.RightTop & String = js.native
  }
  ...
  trait Popup
    ...
    /**
      ...
      */
    def getContent(): typingsJapgolly.openui5.sapUiCoreControlMod.default | Element = js.native
    ...
    at: js.UndefOr[Dock],
      ...
      */
    of: js.UndefOr[
          String | typingsJapgolly.openui5.sapUiCoreElementMod.default | Element | jQuery[HTMLElement] | Event
        ],
      /**
    ...
    collision: js.UndefOr[Collision],
      ...
      */
    within: js.UndefOr[String | typingsJapgolly.openui5.sapUiCoreElementMod.default | Element | Window],
      /**
    ...
    def setExtraContent(
      ...
      */
    aContent: js.Array[Element | String | typingsJapgolly.openui5.sapUiCoreElementMod.default]
    ): this.type = js.native
