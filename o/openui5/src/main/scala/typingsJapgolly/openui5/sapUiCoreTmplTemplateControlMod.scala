...
object sapUiCoreTmplTemplateControlMod {
  ...
  trait TemplateControl
    ...
    def createDOMElement(/**
      ...
      */
    mSettings: js.Object): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    def createDOMElement(
      /**
      * the settings for the new DOM element
      */
    ...
    def setTemplate(
      ...
      * instance may be given
      */
    oTemplate: typingsJapgolly.openui5.sapUiCoreTmplTemplateMod.default
    ): this.type = js.native
  ...
  trait TemplateControlSettings
    ...
    /**
      ...
      */
    var template: js.UndefOr[typingsJapgolly.openui5.sapUiCoreTmplTemplateMod.default | String] = js.undefined
  }
  object TemplateControlSettings {
    ...
    extension [Self <: TemplateControlSettings](x: Self) {
      ...
      inline def setTemplate(value: typingsJapgolly.openui5.sapUiCoreTmplTemplateMod.default | String): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
