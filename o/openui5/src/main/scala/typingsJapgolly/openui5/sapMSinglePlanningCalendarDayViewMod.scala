...
object sapMSinglePlanningCalendarDayViewMod {
  
  @JSImport("sap/m/SinglePlanningCalendarDayView", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: SinglePlanningCalendarDayViewSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SinglePlanningCalendarDayView]
  ...
  type SinglePlanningCalendarDayView = typingsJapgolly.openui5.sapMSinglePlanningCalendarViewMod.default
  
  type SinglePlanningCalendarDayViewSettings = SinglePlanningCalendarViewSettings
}
