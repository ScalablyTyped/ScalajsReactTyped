...
object sapUiUx3OverlayDialogMod {
  
  @JSImport("sap/ui/ux3/OverlayDialog", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends OverlayDialog {
    def this(/**
      * Initial settings for the new control.
      */
    mSettings: OverlayDialogSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, OverlayDialog]
  ...
  trait OverlayDialog
    ...
    /**
      ...
      */
    def setHeight(sHeight: CSSSize): Unit = js.native
    
    /**
      * The width for the OverlayDialog.
      */
    def setWidth(sWidth: CSSSize): Unit = js.native
  }
  
  trait OverlayDialogSettings
    extends StObject
  ...
  object OverlayDialogSettings {
    
    inline def apply(): OverlayDialogSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[OverlayDialogSettings]
    }
    
    extension [Self <: OverlayDialogSettings](x: Self) {
