...
import typingsJapgolly.openui5.anon.Dates
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.CalendarSelectionMode
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ICalendarDate
...
object sapUiWebcMainCalendarMod {
  ...
  object CalendarSettings {
    ...
    extension [Self <: CalendarSettings](x: Self) {
      ...
      inline def setSelectedDatesChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "selectedDatesChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
