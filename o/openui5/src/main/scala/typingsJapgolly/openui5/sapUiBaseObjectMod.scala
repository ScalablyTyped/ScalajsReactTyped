...
import typingsJapgolly.openui5.anon.BaseType
...
object sapUiBaseObjectMod {
  ...
  object default {
    ...
    ): typingsJapgolly.openui5.sapUiBaseMetadataMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("defineClass")(sClassName.asInstanceOf[js.Any], oStaticInfo.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.openui5.sapUiBaseMetadataMod.default]
    inline def defineClass(
      /**
      * name of an (already declared) constructor function
      */
    ...
    ): typingsJapgolly.openui5.sapUiBaseMetadataMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("defineClass")(sClassName.asInstanceOf[js.Any], oStaticInfo.asInstanceOf[js.Any], FNMetaImpl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.openui5.sapUiBaseMetadataMod.default]
