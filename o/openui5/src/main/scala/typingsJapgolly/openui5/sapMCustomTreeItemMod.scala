...
object sapMCustomTreeItemMod {
  
  @JSImport("sap/m/CustomTreeItem", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends CustomTreeItem {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: CustomTreeItemSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, CustomTreeItem]
  ...
  @js.native
  trait CustomTreeItem
    extends typingsJapgolly.openui5.sapMTreeItemBaseMod.default {
  ...
  object CustomTreeItemSettings {
    
    inline def apply(): CustomTreeItemSettings = {
