...
import typingsJapgolly.openui5.sapMLibraryMod.MenuButtonMode
...
object sapMMenuButtonMod {
  ...
  object MenuButtonSettings {
    ...
    extension [Self <: MenuButtonSettings](x: Self) {
      ...
      inline def setBeforeMenuOpen(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "beforeMenuOpen", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setDefaultAction(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "defaultAction", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
