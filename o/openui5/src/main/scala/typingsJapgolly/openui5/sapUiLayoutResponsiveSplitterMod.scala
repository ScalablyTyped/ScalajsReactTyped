...
object sapUiLayoutResponsiveSplitterMod {
  ...
  trait ResponsiveSplitter
    ...
    /**
      ...
      */
    def getRootPaneContainer(): typingsJapgolly.openui5.sapUiLayoutPaneContainerMod.default = js.native
    ...
    def setDefaultPane(
      ...
      * instance may be given
      */
    oDefaultPane: typingsJapgolly.openui5.sapUiLayoutSplitPaneMod.default
    ): this.type = js.native
    ...
    def setRootPaneContainer(
      ...
      */
    oRootPaneContainer: typingsJapgolly.openui5.sapUiLayoutPaneContainerMod.default
    ): this.type = js.native
  ...
  trait ResponsiveSplitterSettings
    ...
    /**
      ...
      * as default pane.
      */
    var defaultPane: js.UndefOr[typingsJapgolly.openui5.sapUiLayoutSplitPaneMod.default | String] = js.undefined
    ...
    /**
      * The root PaneContainer of the ResponsiveSplitter
      */
    var rootPaneContainer: js.UndefOr[typingsJapgolly.openui5.sapUiLayoutPaneContainerMod.default] = js.undefined
  ...
  object ResponsiveSplitterSettings {
    ...
    extension [Self <: ResponsiveSplitterSettings](x: Self) {
      ...
      inline def setDefaultPane(value: typingsJapgolly.openui5.sapUiLayoutSplitPaneMod.default | String): Self = StObject.set(x, "defaultPane", value.asInstanceOf[js.Any])
      ...
      inline def setRootPaneContainer(value: typingsJapgolly.openui5.sapUiLayoutPaneContainerMod.default): Self = StObject.set(x, "rootPaneContainer", value.asInstanceOf[js.Any])
