...
object sapUiCommonsFormFormContainerMod {
  
  @JSImport("sap/ui/commons/form/FormContainer", JSImport.Default)
  @js.native
  /**
  ...
  @js.native
  trait FormContainer
    extends typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default
  
  type FormContainerSettings = typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.FormContainerSettings
}
