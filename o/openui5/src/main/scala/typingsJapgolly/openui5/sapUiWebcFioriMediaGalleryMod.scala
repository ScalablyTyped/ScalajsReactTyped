...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IMediaGalleryItem
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryLayout
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryMenuHorizontalAlign
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryMenuVerticalAlign
...
object sapUiWebcFioriMediaGalleryMod {
  ...
  object MediaGallerySettings {
    ...
    extension [Self <: MediaGallerySettings](x: Self) {
      ...
      inline def setDisplayAreaClick(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "displayAreaClick", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setOverflowClick(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "overflowClick", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
