...
import typingsJapgolly.openui5.anon.ChangeWithClick
...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IWizardStep
...
object sapUiWebcFioriWizardMod {
  ...
  object WizardSettings {
    ...
    extension [Self <: WizardSettings](x: Self) {
      ...
      inline def setStepChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "stepChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
