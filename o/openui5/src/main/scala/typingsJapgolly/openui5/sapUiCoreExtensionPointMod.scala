...
import typingsJapgolly.openui5.anon.Container
...
object sapUiCoreExtensionPointMod extends Shortcut {
  ...
  trait ExtensionPoint extends StObject {
    ...
    def load(/**
      ...
      */
    mOptions: Container): js.Promise[js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default]]
  }
  object ExtensionPoint {
    
    inline def apply(load: Container => js.Promise[js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default]]): ExtensionPoint = {
    ...
    extension [Self <: ExtensionPoint](x: Self) {
      ...
      inline def setLoad(value: Container => js.Promise[js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default]]): Self = StObject.set(x, "load", js.Any.fromFunction1(value))
    }
  }
