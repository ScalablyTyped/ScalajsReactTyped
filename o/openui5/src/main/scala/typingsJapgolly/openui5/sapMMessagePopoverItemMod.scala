...
import typingsJapgolly.openui5.sapMMessageItemMod.MessageItemSettings
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapMMessagePopoverItemMod {
  
  @JSImport("sap/m/MessagePopoverItem", JSImport.Default)
  @js.native
  /**
    * Constructor for a new MessagePopoverItem.
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMMessageItemMod.default {
    def this(/**
      * initial settings for the new control
      */
    mSettings: MessagePopoverItemSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, MessagePopoverItem]
  ...
  type MessagePopoverItem = typingsJapgolly.openui5.sapMMessageItemMod.default
  
  type MessagePopoverItemSettings = MessageItemSettings
}
