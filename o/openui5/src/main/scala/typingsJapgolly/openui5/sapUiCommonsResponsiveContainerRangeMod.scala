...
object sapUiCommonsResponsiveContainerRangeMod {
  ...
  trait ResponsiveContainerRangeSettings
    ...
    /**
      ...
      */
    var content: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
  ...
  object ResponsiveContainerRangeSettings {
    ...
    extension [Self <: ResponsiveContainerRangeSettings](x: Self) {
      ...
      inline def setContent(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
