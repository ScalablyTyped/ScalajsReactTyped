...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ITableCell
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapUiWebcMainTableCellMod {
  
  @JSImport("sap/ui/webc/main/TableCell", JSImport.Default)
  @js.native
  /**
  ...
  open class default () extends TableCell {
    def this(/**
      ...
      */
    mSettings: TableCellSettings) = this()
    def this(/**
    ...
    /* CompleteClass */
    var __implements__sap_ui_webc_main_ITableCell: Boolean = js.native
  }
  /* static members */
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, TableCell]
  ...
  object TableCellSettings {
    
    inline def apply(): TableCellSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TableCellSettings]
    }
    
    extension [Self <: TableCellSettings](x: Self) {
