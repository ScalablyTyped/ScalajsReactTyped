...
import typingsJapgolly.openui5.anon.Def
import typingsJapgolly.openui5.anon.Execute
import typingsJapgolly.openui5.anon.Key
...
object sapUiFlVariantsVariantManagementMod {
  ...
  trait VariantManagement
    ...
    def addFor(
      ...
      */
    vFor: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): js.Object = js.native
    /**
  ...
  trait VariantManagementSettings
    ...
    /**
      ...
      */
    var `for`: js.UndefOr[js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default | String]] = js.undefined
  ...
  object VariantManagementSettings {
    ...
    extension [Self <: VariantManagementSettings](x: Self) {
      ...
      inline def setFor(value: js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default | String]): Self = StObject.set(x, "for", value.asInstanceOf[js.Any])
      
      inline def setForUndefined: Self = StObject.set(x, "for", js.undefined)
      
      inline def setForVarargs(value: (typingsJapgolly.openui5.sapUiCoreControlMod.default | String)*): Self = StObject.set(x, "for", js.Array(value*))
      ...
      inline def setInitialized(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "initialized", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setInitializedUndefined: Self = StObject.set(x, "initialized", js.undefined)
      
      inline def setManage(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "manage", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setSave(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "save", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
