...
object sapUiModelMetaModelMod {
  
  @JSImport("sap/ui/model/MetaModel", JSImport.Default)
  @js.native
  /**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, MetaModel]
  ...
  type MetaModel = typingsJapgolly.openui5.sapUiModelModelMod.default
}
