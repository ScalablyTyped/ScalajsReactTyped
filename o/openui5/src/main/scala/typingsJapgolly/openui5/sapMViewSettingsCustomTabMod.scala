...
object sapMViewSettingsCustomTabMod {
  
  @JSImport("sap/m/ViewSettingsCustomTab", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends ViewSettingsCustomTab {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: ViewSettingsCustomTabSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ViewSettingsCustomTab]
  ...
  trait ViewSettingsCustomTabSettings
    extends StObject
       with ItemSettings {
  ...
  object ViewSettingsCustomTabSettings {
    
    inline def apply(): ViewSettingsCustomTabSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[ViewSettingsCustomTabSettings]
    }
    
    extension [Self <: ViewSettingsCustomTabSettings](x: Self) {
