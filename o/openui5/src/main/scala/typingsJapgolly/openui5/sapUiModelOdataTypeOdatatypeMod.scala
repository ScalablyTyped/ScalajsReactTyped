...
object sapUiModelOdataTypeOdatatypeMod {
  
  @JSImport("sap/ui/model/odata/type/ODataType", JSImport.Default)
  @js.native
  /**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ODataType]
  ...
  type ODataType = typingsJapgolly.openui5.sapUiModelSimpleTypeMod.default
}
