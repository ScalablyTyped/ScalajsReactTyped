...
import typingsJapgolly.openui5.sapMListItemBaseMod.ListItemBaseSettings
...
object sapMObjectListItemMod {
  ...
  trait ObjectListItem
    extends typingsJapgolly.openui5.sapMListItemBaseMod.default {
    ...
    /**
      ...
      */
    def getFirstStatus(): typingsJapgolly.openui5.sapMObjectStatusMod.default = js.native
    ...
    /**
      ...
      */
    def getSecondStatus(): typingsJapgolly.openui5.sapMObjectStatusMod.default = js.native
    ...
    def setFirstStatus(
      ...
      */
    oFirstStatus: typingsJapgolly.openui5.sapMObjectStatusMod.default
    ): this.type = js.native
    ...
    def setSecondStatus(
      ...
      */
    oSecondStatus: typingsJapgolly.openui5.sapMObjectStatusMod.default
    ): this.type = js.native
  ...
  trait ObjectListItemSettings
    ...
    /**
      * First status text field displayed on the right side of the attributes.
      */
    var firstStatus: js.UndefOr[typingsJapgolly.openui5.sapMObjectStatusMod.default] = js.undefined
    ...
    /**
      * Second status text field displayed on the right side of the attributes.
      */
    var secondStatus: js.UndefOr[typingsJapgolly.openui5.sapMObjectStatusMod.default] = js.undefined
  ...
  object ObjectListItemSettings {
    ...
    extension [Self <: ObjectListItemSettings](x: Self) {
      ...
      inline def setFirstStatus(value: typingsJapgolly.openui5.sapMObjectStatusMod.default): Self = StObject.set(x, "firstStatus", value.asInstanceOf[js.Any])
      ...
      inline def setSecondStatus(value: typingsJapgolly.openui5.sapMObjectStatusMod.default): Self = StObject.set(x, "secondStatus", value.asInstanceOf[js.Any])
