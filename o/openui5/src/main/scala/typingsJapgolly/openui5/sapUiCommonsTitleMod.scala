...
object sapUiCommonsTitleMod {
  
  @JSImport("sap/ui/commons/Title", JSImport.Default)
  @js.native
  /**
  ...
  @js.native
  trait Title
    extends typingsJapgolly.openui5.sapUiCoreTitleMod.default
  
  type TitleSettings = typingsJapgolly.openui5.sapUiCoreTitleMod.TitleSettings
}
