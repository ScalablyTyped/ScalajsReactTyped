...
object sapUiCommonsLayoutHorizontalLayoutMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiLayoutHorizontalLayoutMod.default {
    def this(/**
  ...
  type HorizontalLayout = typingsJapgolly.openui5.sapUiLayoutHorizontalLayoutMod.default
  
  type HorizontalLayoutSettings = typingsJapgolly.openui5.sapUiLayoutHorizontalLayoutMod.HorizontalLayoutSettings
}
