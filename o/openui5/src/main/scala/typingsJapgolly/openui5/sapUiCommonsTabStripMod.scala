...
import typingsJapgolly.openui5.anon.Index
...
object sapUiCommonsTabStripMod {
  ...
  trait TabStrip
    ...
    def addTab(
      ...
      */
    oTab: typingsJapgolly.openui5.sapUiCommonsTabMod.default
    ): this.type = js.native
    ...
    ): typingsJapgolly.openui5.sapUiCommonsTabMod.default = js.native
    ...
    /**
      ...
      */
    def getTabs(): js.Array[typingsJapgolly.openui5.sapUiCommonsTabMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllTabs(): js.Array[typingsJapgolly.openui5.sapUiCommonsTabMod.default] = js.native
    
    def removeTab(/**
      * The tab to remove or its index or id
      */
    vTab: String): typingsJapgolly.openui5.sapUiCommonsTabMod.default | Null = js.native
    /**
    ...
    def removeTab(/**
      * The tab to remove or its index or id
      */
    vTab: int): typingsJapgolly.openui5.sapUiCommonsTabMod.default | Null = js.native
    def removeTab(
      /**
      * The tab to remove or its index or id
      */
    vTab: typingsJapgolly.openui5.sapUiCommonsTabMod.default
    ): typingsJapgolly.openui5.sapUiCommonsTabMod.default | Null = js.native
  ...
  trait TabStripSettings
    ...
    /**
      ...
      */
    var tabs: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCommonsTabMod.default] | typingsJapgolly.openui5.sapUiCommonsTabMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object TabStripSettings {
    ...
    extension [Self <: TabStripSettings](x: Self) {
      ...
      inline def setTabs(
        value: js.Array[typingsJapgolly.openui5.sapUiCommonsTabMod.default] | typingsJapgolly.openui5.sapUiCommonsTabMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "tabs", value.asInstanceOf[js.Any])
      
      inline def setTabsUndefined: Self = StObject.set(x, "tabs", js.undefined)
      
      inline def setTabsVarargs(value: typingsJapgolly.openui5.sapUiCommonsTabMod.default*): Self = StObject.set(x, "tabs", js.Array(value*))
