...
object sapUiLayoutVerticalLayoutMod {
  
  @JSImport("sap/ui/layout/VerticalLayout", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends VerticalLayout {
    def this(/**
      * initial settings for the new control
      */
    mSettings: VerticalLayoutSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, VerticalLayout]
  ...
  object VerticalLayoutSettings {
    
    inline def apply(): VerticalLayoutSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[VerticalLayoutSettings]
    }
    
    extension [Self <: VerticalLayoutSettings](x: Self) {
