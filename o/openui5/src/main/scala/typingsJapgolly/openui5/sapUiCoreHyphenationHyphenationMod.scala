...
import typingsJapgolly.openui5.anon.SErrorMessage
...
object sapUiCoreHyphenationHyphenationMod {
  ...
  object HyphenationSettings {
    ...
    extension [Self <: HyphenationSettings](x: Self) {
      ...
      inline def setError(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
