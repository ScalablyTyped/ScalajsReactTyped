...
object sapUiPerformanceTraceInteractionMod extends Shortcut {
  ...
  object Interaction {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(filter = js.Any.fromFunction1(filter), getActive = getActive.toJsFn, getAll = js.Any.fromFunction1(getAll), setActive = js.Any.fromFunction1((t0: Boolean) => setActive(t0).runNow()))
