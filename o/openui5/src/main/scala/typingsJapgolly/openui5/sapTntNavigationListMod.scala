...
import typingsJapgolly.openui5.anon.Item
...
object sapTntNavigationListMod {
  ...
  trait NavigationList
    ...
    def addItem(
      ...
      */
    oItem: typingsJapgolly.openui5.sapTntNavigationListItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapTntNavigationListItemMod.default] = js.native
    ...
    /**
      ...
      */
    def getSelectedItem(): typingsJapgolly.openui5.sapTntNavigationListItemMod.default | Null = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllItems(): js.Array[typingsJapgolly.openui5.sapTntNavigationListItemMod.default] = js.native
    ...
    def removeItem(/**
      ...
      */
    vItem: String): typingsJapgolly.openui5.sapTntNavigationListItemMod.default | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: int): typingsJapgolly.openui5.sapTntNavigationListItemMod.default | Null = js.native
    def removeItem(
      /**
      * The item to remove or its index or id
      */
    vItem: typingsJapgolly.openui5.sapTntNavigationListItemMod.default
    ): typingsJapgolly.openui5.sapTntNavigationListItemMod.default | Null = js.native
    ...
    def setSelectedItem(
      ...
      * The control to be set as selected
      */
    selectedItem: typingsJapgolly.openui5.sapTntNavigationListItemMod.default
  ...
  trait NavigationListSettings
    ...
    var items: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapTntNavigationListItemMod.default] | typingsJapgolly.openui5.sapTntNavigationListItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      */
    var selectedItem: js.UndefOr[typingsJapgolly.openui5.sapTntNavigationListItemMod.default | String] = js.undefined
  ...
  object NavigationListSettings {
    ...
    extension [Self <: NavigationListSettings](x: Self) {
      ...
      inline def setItems(
        value: js.Array[typingsJapgolly.openui5.sapTntNavigationListItemMod.default] | typingsJapgolly.openui5.sapTntNavigationListItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapTntNavigationListItemMod.default*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setSelectedItem(value: typingsJapgolly.openui5.sapTntNavigationListItemMod.default | String): Self = StObject.set(x, "selectedItem", value.asInstanceOf[js.Any])
