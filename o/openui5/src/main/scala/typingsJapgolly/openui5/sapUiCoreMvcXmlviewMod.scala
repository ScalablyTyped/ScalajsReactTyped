...
import typingsJapgolly.openui5.anon.Cache
...
object sapUiCoreMvcXmlviewMod {
  ...
  object PreprocessorType extends StObject {
    ...
    /* "controls" */ val CONTROLS: typingsJapgolly.openui5.sapUiCoreMvcXmlviewMod.PreprocessorType.CONTROLS & String = js.native
    ...
    sealed trait VIEWXML
      extends StObject
         with PreprocessorType
    /* "viewxml" */ val VIEWXML: typingsJapgolly.openui5.sapUiCoreMvcXmlviewMod.PreprocessorType.VIEWXML & String = js.native
    ...
    sealed trait XML
      extends StObject
         with PreprocessorType
    /* "xml" */ val XML: typingsJapgolly.openui5.sapUiCoreMvcXmlviewMod.PreprocessorType.XML & String = js.native
  }
  
  type XMLView = typingsJapgolly.openui5.sapUiCoreMvcViewMod.default
