...
object sapMQuickViewGroupMod {
  ...
  trait QuickViewGroup
    ...
    def addElement(
      ...
      */
    oElement: typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getElements(): js.Array[typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllElements(): js.Array[typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default] = js.native
    
    def removeElement(/**
      * The element to remove or its index or id
      */
    vElement: String): typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default | Null = js.native
    /**
    ...
    def removeElement(/**
      * The element to remove or its index or id
      */
    vElement: int): typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default | Null = js.native
    def removeElement(
      /**
      * The element to remove or its index or id
      */
    vElement: typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default
    ): typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default | Null = js.native
  ...
  trait QuickViewGroupSettings
    ...
    var elements: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default] | typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object QuickViewGroupSettings {
    ...
    extension [Self <: QuickViewGroupSettings](x: Self) {
      ...
      inline def setElements(
        value: js.Array[typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default] | typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "elements", value.asInstanceOf[js.Any])
      
      inline def setElementsUndefined: Self = StObject.set(x, "elements", js.undefined)
      
      inline def setElementsVarargs(value: typingsJapgolly.openui5.sapMQuickViewGroupElementMod.default*): Self = StObject.set(x, "elements", js.Array(value*))
