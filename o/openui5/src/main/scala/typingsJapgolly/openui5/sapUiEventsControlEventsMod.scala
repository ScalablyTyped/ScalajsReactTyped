...
object sapUiEventsControlEventsMod extends Shortcut {
  ...
  object ControlEvents {
    ...
    inline def apply(bindAnyEvent: js.Function => Callback, events: Unit, unbindAnyEvent: js.Function => Callback): ControlEvents = {
      val __obj = js.Dynamic.literal(bindAnyEvent = js.Any.fromFunction1((t0: js.Function) => bindAnyEvent(t0).runNow()), events = events.asInstanceOf[js.Any], unbindAnyEvent = js.Any.fromFunction1((t0: js.Function) => unbindAnyEvent(t0).runNow()))
      __obj.asInstanceOf[ControlEvents]
    }
    
    extension [Self <: ControlEvents](x: Self) {
      
      inline def setBindAnyEvent(value: js.Function => Callback): Self = StObject.set(x, "bindAnyEvent", js.Any.fromFunction1((t0: js.Function) => value(t0).runNow()))
      
      inline def setEvents(value: Unit): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
      
      inline def setUnbindAnyEvent(value: js.Function => Callback): Self = StObject.set(x, "unbindAnyEvent", js.Any.fromFunction1((t0: js.Function) => value(t0).runNow()))
    }
  }
