...
import typingsJapgolly.openui5.anon.ItemTargetRef
import typingsJapgolly.openui5.anon.Token
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.InputType
...
object sapUiWebcMainMultiInputMod {
  ...
  object MultiInputSettings {
    ...
    extension [Self <: MultiInputSettings](x: Self) {
      ...
      inline def setSuggestionItemPreview(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "suggestionItemPreview", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setSuggestionItemPreviewUndefined: Self = StObject.set(x, "suggestionItemPreview", js.undefined)
      
      inline def setSuggestionItemSelect(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "suggestionItemSelect", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setValueHelpTrigger(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "valueHelpTrigger", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
