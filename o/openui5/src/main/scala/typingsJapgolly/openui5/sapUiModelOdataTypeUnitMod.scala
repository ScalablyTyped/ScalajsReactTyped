...
import typingsJapgolly.openui5.anon.CustomUnits
import typingsJapgolly.openui5.anon.SkipDecimalsValidation
...
object sapUiModelOdataTypeUnitMod {
  ...
  @js.native
  trait Unit
    extends typingsJapgolly.openui5.sapUiModelTypeUnitMod.default {
