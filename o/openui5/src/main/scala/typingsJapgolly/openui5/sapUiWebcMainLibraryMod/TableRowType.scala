...
object TableRowType extends StObject {
  ...
  sealed trait Active
    extends StObject
       with TableRowType
  /* "Active" */ val Active: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableRowType.Active & String = js.native
  ...
  sealed trait Inactive
    extends StObject
       with TableRowType
  /* "Inactive" */ val Inactive: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableRowType.Inactive & String = js.native
}
