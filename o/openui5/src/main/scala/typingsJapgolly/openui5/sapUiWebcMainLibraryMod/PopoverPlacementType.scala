...
object PopoverPlacementType extends StObject {
  ...
  /* "Bottom" */ val Bottom: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.PopoverPlacementType.Bottom & String = js.native
  ...
  sealed trait Left
    extends StObject
       with PopoverPlacementType
  /* "Left" */ val Left: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.PopoverPlacementType.Left & String = js.native
  ...
  sealed trait Right
    extends StObject
       with PopoverPlacementType
  /* "Right" */ val Right: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.PopoverPlacementType.Right & String = js.native
  ...
  sealed trait Top
    extends StObject
       with PopoverPlacementType
  /* "Top" */ val Top: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.PopoverPlacementType.Top & String = js.native
}
