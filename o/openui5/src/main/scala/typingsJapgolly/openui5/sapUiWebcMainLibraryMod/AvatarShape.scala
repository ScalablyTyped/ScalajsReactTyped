...
object AvatarShape extends StObject {
  ...
  sealed trait Circle
    extends StObject
       with AvatarShape
  /* "Circle" */ val Circle: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.AvatarShape.Circle & String = js.native
  ...
  sealed trait Square
    extends StObject
       with AvatarShape
  /* "Square" */ val Square: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.AvatarShape.Square & String = js.native
}
