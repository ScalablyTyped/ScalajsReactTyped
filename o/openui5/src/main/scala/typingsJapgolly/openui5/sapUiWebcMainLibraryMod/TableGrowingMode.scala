...
object TableGrowingMode extends StObject {
  ...
  /* "Button" */ val Button: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableGrowingMode.Button & String = js.native
  ...
  sealed trait None
    extends StObject
       with TableGrowingMode
  /* "None" */ val None: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableGrowingMode.None & String = js.native
  ...
  sealed trait Scroll
    extends StObject
       with TableGrowingMode
  /* "Scroll" */ val Scroll: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableGrowingMode.Scroll & String = js.native
}
