...
object WrappingType extends StObject {
  ...
  sealed trait None
    extends StObject
       with WrappingType
  /* "None" */ val None: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.WrappingType.None & String = js.native
  ...
  sealed trait Normal
    extends StObject
       with WrappingType
  /* "Normal" */ val Normal: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.WrappingType.Normal & String = js.native
}
