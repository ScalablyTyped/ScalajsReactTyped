...
object BreadcrumbsDesign extends StObject {
  ...
  /* "NoCurrentPage" */ val NoCurrentPage: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.BreadcrumbsDesign.NoCurrentPage & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with BreadcrumbsDesign
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.BreadcrumbsDesign.Standard & String = js.native
}
