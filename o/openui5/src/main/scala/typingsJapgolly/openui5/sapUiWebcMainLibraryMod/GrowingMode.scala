...
object GrowingMode extends StObject {
  ...
  sealed trait Button
    extends StObject
       with GrowingMode
  /* "Button" */ val Button: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.GrowingMode.Button & String = js.native
  ...
  sealed trait None
    extends StObject
       with GrowingMode
  /* "None" */ val None: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.GrowingMode.None & String = js.native
  ...
  sealed trait Scroll
    extends StObject
       with GrowingMode
  /* "Scroll" */ val Scroll: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.GrowingMode.Scroll & String = js.native
}
