...
object TabLayout extends StObject {
  ...
  sealed trait Inline
    extends StObject
       with TabLayout
  /* "Inline" */ val Inline: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TabLayout.Inline & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with TabLayout
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TabLayout.Standard & String = js.native
}
