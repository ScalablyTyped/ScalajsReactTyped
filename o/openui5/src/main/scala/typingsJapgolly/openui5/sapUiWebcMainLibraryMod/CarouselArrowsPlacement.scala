...
object CarouselArrowsPlacement extends StObject {
  ...
  /* "Content" */ val Content: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.CarouselArrowsPlacement.Content & String = js.native
  ...
  sealed trait Navigation
    extends StObject
       with CarouselArrowsPlacement
  /* "Navigation" */ val Navigation: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.CarouselArrowsPlacement.Navigation & String = js.native
}
