...
object TableMode extends StObject {
  ...
  sealed trait MultiSelect
    extends StObject
       with TableMode
  /* "MultiSelect" */ val MultiSelect: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableMode.MultiSelect & String = js.native
  ...
  sealed trait None
    extends StObject
       with TableMode
  /* "None" */ val None: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableMode.None & String = js.native
  ...
  sealed trait SingleSelect
    extends StObject
       with TableMode
  /* "SingleSelect" */ val SingleSelect: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableMode.SingleSelect & String = js.native
}
