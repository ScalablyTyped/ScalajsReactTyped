...
object CalendarSelectionMode extends StObject {
  ...
  /* "Multiple" */ val Multiple: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.CalendarSelectionMode.Multiple & String = js.native
  ...
  sealed trait Range
    extends StObject
       with CalendarSelectionMode
  /* "Range" */ val Range: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.CalendarSelectionMode.Range & String = js.native
  ...
  sealed trait Single
    extends StObject
       with CalendarSelectionMode
  /* "Single" */ val Single: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.CalendarSelectionMode.Single & String = js.native
}
