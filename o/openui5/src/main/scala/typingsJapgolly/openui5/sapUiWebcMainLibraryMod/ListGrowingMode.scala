...
object ListGrowingMode extends StObject {
  ...
  /* "Button" */ val Button: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ListGrowingMode.Button & String = js.native
  ...
  sealed trait None
    extends StObject
       with ListGrowingMode
  /* "None" */ val None: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ListGrowingMode.None & String = js.native
  ...
  sealed trait Scroll
    extends StObject
       with ListGrowingMode
  /* "Scroll" */ val Scroll: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ListGrowingMode.Scroll & String = js.native
}
