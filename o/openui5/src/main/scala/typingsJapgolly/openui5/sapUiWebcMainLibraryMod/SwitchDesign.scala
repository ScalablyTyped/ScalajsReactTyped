...
object SwitchDesign extends StObject {
  ...
  sealed trait Graphical
    extends StObject
       with SwitchDesign
  /* "Graphical" */ val Graphical: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.SwitchDesign.Graphical & String = js.native
  ...
  sealed trait Textual
    extends StObject
       with SwitchDesign
  /* "Textual" */ val Textual: typingsJapgolly.openui5.sapUiWebcMainLibraryMod.SwitchDesign.Textual & String = js.native
}
