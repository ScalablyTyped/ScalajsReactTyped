...
object sapMTablePersoDialogMod {
  ...
  trait TablePersoDialog
    ...
    def setPersoDialogFor(
      ...
      */
    oPersoDialogFor: typingsJapgolly.openui5.sapMTableMod.default
    ): this.type = js.native
    /**
  ...
  trait TablePersoDialogSettings
    ...
    /**
      ...
      */
    var persoDialogFor: js.UndefOr[typingsJapgolly.openui5.sapMTableMod.default | String] = js.undefined
  ...
  object TablePersoDialogSettings {
    ...
    extension [Self <: TablePersoDialogSettings](x: Self) {
      ...
      inline def setPersoDialogFor(value: typingsJapgolly.openui5.sapMTableMod.default | String): Self = StObject.set(x, "persoDialogFor", value.asInstanceOf[js.Any])
