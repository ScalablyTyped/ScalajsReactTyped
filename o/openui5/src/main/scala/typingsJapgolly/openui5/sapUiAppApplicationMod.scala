...
object sapUiAppApplicationMod {
  ...
  trait Application
    ...
    /**
      ...
      */
    def createRootComponent(): typingsJapgolly.openui5.sapUiCoreUicomponentMod.default = js.native
    ...
    /**
      ...
      */
    def getRootComponent(): typingsJapgolly.openui5.sapUiCoreUicomponentMod.default = js.native
    ...
    /**
      ...
      * @returns The root component
      */
    def getView(): typingsJapgolly.openui5.sapUiCoreUicomponentMod.default = js.native
    ...
    def setConfig(
      ...
      * the configuration model, the configuration object or a URI string to load a JSON configuration file.
      */
    vConfig: typingsJapgolly.openui5.sapUiModelModelMod.default
    ): Unit = js.native
    ...
    def setRootComponent(
      ...
      */
    oRootComponent: typingsJapgolly.openui5.sapUiCoreUicomponentMod.default
    ): this.type = js.native
  }
  ...
  trait ApplicationSettings
    ...
    var rootComponent: js.UndefOr[typingsJapgolly.openui5.sapUiCoreUicomponentMod.default] = js.undefined
  }
  object ApplicationSettings {
    ...
    extension [Self <: ApplicationSettings](x: Self) {
      ...
      inline def setRootComponent(value: typingsJapgolly.openui5.sapUiCoreUicomponentMod.default): Self = StObject.set(x, "rootComponent", value.asInstanceOf[js.Any])
