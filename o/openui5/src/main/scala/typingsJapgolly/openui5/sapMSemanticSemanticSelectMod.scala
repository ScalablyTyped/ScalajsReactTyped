...
import typingsJapgolly.openui5.sapMSemanticSemanticControlMod.SemanticControlSettings
...
object sapMSemanticSemanticSelectMod {
  ...
  trait SemanticSelect
    extends typingsJapgolly.openui5.sapMSemanticSemanticControlMod.default {
    ...
    def setSelectedItem(
      ...
      */
    oSelectedItem: typingsJapgolly.openui5.sapUiCoreItemMod.default
    ): this.type = js.native
    /**
