...
import typingsJapgolly.openui5.anon.DefaultThreeColumnLayoutType
...
object sapFFlexibleColumnLayoutSemanticHelperMod {
  ...
  open class default protected ()
    ...
    def this(
      ...
      */
    oFlexibleColumnLayout: typingsJapgolly.openui5.sapFFlexibleColumnLayoutMod.default,
      /**
  ...
  object FlexibleColumnLayoutSemanticHelper {
    ...
    inline def apply(
      getCurrentUIState: CallbackTo[UIState],
      getDefaultLayouts: CallbackTo[js.Object],
      getNextUIState: int => UIState,
      isDOMReady: CallbackTo[Boolean],
      isReady: CallbackTo[Boolean],
      whenDOMReady: CallbackTo[js.Promise[Any]],
      whenReady: CallbackTo[js.Promise[Any]]
    ): FlexibleColumnLayoutSemanticHelper = {
      val __obj = js.Dynamic.literal(getCurrentUIState = getCurrentUIState.toJsFn, getDefaultLayouts = getDefaultLayouts.toJsFn, getNextUIState = js.Any.fromFunction1(getNextUIState), isDOMReady = isDOMReady.toJsFn, isReady = isReady.toJsFn, whenDOMReady = whenDOMReady.toJsFn, whenReady = whenReady.toJsFn)
      __obj.asInstanceOf[FlexibleColumnLayoutSemanticHelper]
    }
    
    extension [Self <: FlexibleColumnLayoutSemanticHelper](x: Self) {
      
      inline def setGetCurrentUIState(value: CallbackTo[UIState]): Self = StObject.set(x, "getCurrentUIState", value.toJsFn)
      
      inline def setGetDefaultLayouts(value: CallbackTo[js.Object]): Self = StObject.set(x, "getDefaultLayouts", value.toJsFn)
      
      inline def setGetNextUIState(value: int => UIState): Self = StObject.set(x, "getNextUIState", js.Any.fromFunction1(value))
      
      inline def setIsDOMReady(value: CallbackTo[Boolean]): Self = StObject.set(x, "isDOMReady", value.toJsFn)
      
      inline def setIsReady(value: CallbackTo[Boolean]): Self = StObject.set(x, "isReady", value.toJsFn)
      
      inline def setWhenDOMReady(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "whenDOMReady", value.toJsFn)
      
      inline def setWhenReady(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "whenReady", value.toJsFn)
    }
  }
