...
import typingsJapgolly.openui5.anon.ControlType
import typingsJapgolly.openui5.anon.Editable
...
object sapUiTestOpaPluginMod {
  ...
  trait OpaPlugin
    ...
    def getControlByGlobalId(/**
      ...
      */
    oOptions: ControlType): typingsJapgolly.openui5.sapUiCoreElementMod.default | js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] | Null = js.native
    ...
    def getControlInView(
      ...
      */
    oOptions: js.Object
    ): typingsJapgolly.openui5.sapUiCoreElementMod.default | js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] | Null = js.native
    ...
    /**
      ...
      * 	 - otherwise, will return an array of matching controls, or an empty array, if no controls match
      */
    def getMatchingControls(): typingsJapgolly.openui5.sapUiCoreElementMod.default | js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] | Null = js.native
    def getMatchingControls(/**
      * a map of options used to describe the control you are looking for.
      */
    oOptions: Editable): typingsJapgolly.openui5.sapUiCoreElementMod.default | js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] | Null = js.native
    ...
    def getView(/**
      * Name of the view
      */
    sViewName: String): js.UndefOr[typingsJapgolly.openui5.sapUiCoreMvcViewMod.default] = js.native
  }
}
