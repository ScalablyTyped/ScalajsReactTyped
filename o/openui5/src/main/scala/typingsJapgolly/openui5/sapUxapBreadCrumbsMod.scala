...
object sapUxapBreadCrumbsMod {
  ...
  trait BreadCrumbs
    ...
    def addLink(
      ...
      */
    oLink: typingsJapgolly.openui5.sapMLinkMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCurrentLocation(): typingsJapgolly.openui5.sapMTextMod.default = js.native
    ...
    /**
      ...
      */
    def getLinks(): js.Array[typingsJapgolly.openui5.sapMLinkMod.default] = js.native
    ...
    def indexOfLink(/**
      ...
      */
    oLink: typingsJapgolly.openui5.sapMLinkMod.default): int = js.native
    ...
    /**
      ...
      */
    def removeAllLinks(): js.Array[typingsJapgolly.openui5.sapMLinkMod.default] = js.native
    
    def removeLink(/**
      * The link to remove or its index or id
      */
    vLink: String): typingsJapgolly.openui5.sapMLinkMod.default | Null = js.native
    /**
    ...
    def removeLink(/**
      * The link to remove or its index or id
      */
    vLink: int): typingsJapgolly.openui5.sapMLinkMod.default | Null = js.native
    def removeLink(
      /**
      * The link to remove or its index or id
      */
    vLink: typingsJapgolly.openui5.sapMLinkMod.default
    ...
    def setCurrentLocation(
      ...
      */
    oCurrentLocation: typingsJapgolly.openui5.sapMTextMod.default
    ): this.type = js.native
  ...
  trait BreadCrumbsSettings
    ...
    /**
      * The current/last element in the BreadCrumbs path.
      */
    var currentLocation: js.UndefOr[typingsJapgolly.openui5.sapMTextMod.default] = js.undefined
  ...
  object BreadCrumbsSettings {
    ...
    extension [Self <: BreadCrumbsSettings](x: Self) {
      ...
      inline def setCurrentLocation(value: typingsJapgolly.openui5.sapMTextMod.default): Self = StObject.set(x, "currentLocation", value.asInstanceOf[js.Any])
      ...
      inline def setLinksVarargs(value: typingsJapgolly.openui5.sapMLinkMod.default*): Self = StObject.set(x, "links", js.Array(value*))
