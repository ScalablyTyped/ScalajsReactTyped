...
object sapUiCommonsLayoutMatrixLayoutMod {
  ...
  trait MatrixLayout
    ...
    def addRow(
      ...
      */
    oRow: typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getRows(): js.Array[typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllRows(): js.Array[typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default] = js.native
    
    def removeRow(/**
      * The row to remove or its index or id
      */
    vRow: String): typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default | Null = js.native
    /**
    ...
    def removeRow(/**
      * The row to remove or its index or id
      */
    vRow: int): typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default | Null = js.native
    def removeRow(
      /**
      * The row to remove or its index or id
      */
    vRow: typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default
    ): typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default | Null = js.native
  ...
  trait MatrixLayoutSettings
    ...
    /**
      ...
      */
    var rows: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default] | typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object MatrixLayoutSettings {
    ...
    extension [Self <: MatrixLayoutSettings](x: Self) {
      ...
      inline def setRows(
        value: js.Array[typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default] | typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "rows", value.asInstanceOf[js.Any])
      
      inline def setRowsUndefined: Self = StObject.set(x, "rows", js.undefined)
      
      inline def setRowsVarargs(value: typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutRowMod.default*): Self = StObject.set(x, "rows", js.Array(value*))
