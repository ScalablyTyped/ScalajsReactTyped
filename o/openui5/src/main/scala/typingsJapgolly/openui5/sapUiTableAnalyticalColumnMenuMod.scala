...
import typingsJapgolly.openui5.sapUiTableColumnMenuMod.ColumnMenuSettings
...
object sapUiTableAnalyticalColumnMenuMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiTableColumnMenuMod.default {
    def this(/**
  ...
  type AnalyticalColumnMenu = typingsJapgolly.openui5.sapUiTableColumnMenuMod.default
