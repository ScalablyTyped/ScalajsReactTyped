...
import typingsJapgolly.openui5.sapUiUnifiedDateTypeRangeMod.DateTypeRangeSettings
...
object sapUiUnifiedCalendarAppointmentMod {
  ...
  trait CalendarAppointment
    extends typingsJapgolly.openui5.sapUiUnifiedDateTypeRangeMod.default {
    ...
    /**
      ...
      */
    def getCustomContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllCustomContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeCustomContent(/**
      * The customContent to remove or its index or id
      */
    vCustomContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
      * @SINCE 1.93.0
      * @EXPERIMENTAL (since 1.93)
      *
    ...
    def removeCustomContent(/**
      * The customContent to remove or its index or id
      */
    vCustomContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeCustomContent(
      /**
      * The customContent to remove or its index or id
      */
    vCustomContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
  ...
  object CalendarAppointmentSettings {
    ...
    extension [Self <: CalendarAppointmentSettings](x: Self) {
      ...
      inline def setCustomContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "customContent", js.Array(value*))
