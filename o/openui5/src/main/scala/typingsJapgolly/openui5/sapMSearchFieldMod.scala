...
import typingsJapgolly.openui5.anon.RefreshButtonPressed
import typingsJapgolly.openui5.anon.SuggestValue
...
object sapMSearchFieldMod {
  ...
  trait SearchField
    ...
    def addSuggestionItem(
      ...
      */
    oSuggestionItem: typingsJapgolly.openui5.sapMSuggestionItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getSuggestionItems(): js.Array[typingsJapgolly.openui5.sapMSuggestionItemMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllSuggestionItems(): js.Array[typingsJapgolly.openui5.sapMSuggestionItemMod.default] = js.native
    ...
    def removeSuggestionItem(/**
      ...
      */
    vSuggestionItem: String): typingsJapgolly.openui5.sapMSuggestionItemMod.default | Null = js.native
    /**
      * @SINCE 1.34
      *
    ...
    def removeSuggestionItem(/**
      * The suggestionItem to remove or its index or id
      */
    vSuggestionItem: int): typingsJapgolly.openui5.sapMSuggestionItemMod.default | Null = js.native
    def removeSuggestionItem(
      /**
      * The suggestionItem to remove or its index or id
      */
    vSuggestionItem: typingsJapgolly.openui5.sapMSuggestionItemMod.default
    ): typingsJapgolly.openui5.sapMSuggestionItemMod.default | Null = js.native
  ...
  trait SearchFieldSettings
    ...
    var suggestionItems: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMSuggestionItemMod.default] | typingsJapgolly.openui5.sapMSuggestionItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object SearchFieldSettings {
    ...
    extension [Self <: SearchFieldSettings](x: Self) {
      ...
      inline def setSuggestionItems(
        value: js.Array[typingsJapgolly.openui5.sapMSuggestionItemMod.default] | typingsJapgolly.openui5.sapMSuggestionItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setSuggestionItemsVarargs(value: typingsJapgolly.openui5.sapMSuggestionItemMod.default*): Self = StObject.set(x, "suggestionItems", js.Array(value*))
