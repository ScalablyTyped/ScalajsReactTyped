...
object sapUiLayoutFixFlexMod {
  ...
  trait FixFlex
    ...
    def addFixContent(
      ...
      */
    oFixContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFixContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getFlexContent(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    /**
      ...
      */
    def removeAllFixContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeFixContent(/**
      * The fixContent to remove or its index or id
      */
    vFixContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeFixContent(/**
      * The fixContent to remove or its index or id
      */
    vFixContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeFixContent(
      /**
      * The fixContent to remove or its index or id
      */
    vFixContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ...
    def setFlexContent(
      ...
      */
    oFlexContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
  ...
  trait FixFlexSettings
    ...
    /**
      * Control in the stretching part of the layout.
      */
    var flexContent: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object FixFlexSettings {
    ...
    extension [Self <: FixFlexSettings](x: Self) {
      ...
      inline def setFixContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "fixContent", js.Array(value*))
      ...
      inline def setFlexContent(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "flexContent", value.asInstanceOf[js.Any])
