...
import typingsJapgolly.openui5.sapMSemanticSemanticToggleButtonMod.SemanticToggleButtonSettings
...
object sapMSemanticMultiSelectActionMod {
  ...
  type MultiSelectAction = typingsJapgolly.openui5.sapMSemanticSemanticToggleButtonMod.default
