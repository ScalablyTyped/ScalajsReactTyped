...
object sapUiCommonsLayoutVerticalLayoutMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiLayoutVerticalLayoutMod.default {
    def this(/**
  ...
  type VerticalLayout = typingsJapgolly.openui5.sapUiLayoutVerticalLayoutMod.default
  
  type VerticalLayoutSettings = typingsJapgolly.openui5.sapUiLayoutVerticalLayoutMod.VerticalLayoutSettings
}
