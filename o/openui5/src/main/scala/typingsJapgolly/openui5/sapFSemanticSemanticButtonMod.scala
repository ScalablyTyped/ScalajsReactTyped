...
object sapFSemanticSemanticButtonMod {
  ...
  type SemanticButton = typingsJapgolly.openui5.sapMSemanticSemanticButtonMod.default
  
  type SemanticButtonSettings = typingsJapgolly.openui5.sapMSemanticSemanticButtonMod.SemanticButtonSettings
}
