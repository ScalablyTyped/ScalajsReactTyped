...
object sapUiModelJsonJsonpropertybindingMod {
  ...
  open class default protected ()
    extends typingsJapgolly.openui5.sapUiModelClientPropertyBindingMod.default {
    /**
  ...
  type JSONPropertyBinding = typingsJapgolly.openui5.sapUiModelClientPropertyBindingMod.default
}
