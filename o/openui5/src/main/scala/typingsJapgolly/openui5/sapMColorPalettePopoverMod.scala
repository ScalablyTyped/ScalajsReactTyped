...
import typingsJapgolly.openui5.anon.DefaultAction
...
object sapMColorPalettePopoverMod {
  ...
  trait ColorPalettePopover
    ...
    /**
      ...
      */
    def close(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def openBy(
      ...
      * control
      */
    oCpntrol: typingsJapgolly.openui5.sapUiCoreControlMod.default
  ...
  object ColorPalettePopoverSettings {
    ...
    extension [Self <: ColorPalettePopoverSettings](x: Self) {
      ...
      inline def setColorSelect(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "colorSelect", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
