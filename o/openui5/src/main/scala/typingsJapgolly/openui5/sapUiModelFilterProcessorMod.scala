...
object sapUiModelFilterProcessorMod extends Shortcut {
  ...
  trait FilterProcessor extends StObject {
    ...
    ): typingsJapgolly.openui5.sapUiModelFilterMod.default
  }
  object FilterProcessor {
    
    inline def apply(
      groupFilters: js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.default] => typingsJapgolly.openui5.sapUiModelFilterMod.default
    ): FilterProcessor = {
    ...
    extension [Self <: FilterProcessor](x: Self) {
      ...
      inline def setGroupFilters(
        value: js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.default] => typingsJapgolly.openui5.sapUiModelFilterMod.default
