...
import typingsJapgolly.openui5.sapUiTableLibraryMod.ResetAllMode
...
object sapUiTableTablePersoControllerMod {
  ...
  trait TablePersoController
    ...
    def setTable(
      ...
      * may be given
      */
    oTable: typingsJapgolly.openui5.sapUiTableTableMod.default
    ): this.type = js.native
  }
  ...
  trait TablePersoControllerSettings
    ...
    /**
      ...
      */
    var table: js.UndefOr[typingsJapgolly.openui5.sapUiTableTableMod.default | String] = js.undefined
  }
  object TablePersoControllerSettings {
    ...
    extension [Self <: TablePersoControllerSettings](x: Self) {
      ...
      inline def setTable(value: typingsJapgolly.openui5.sapUiTableTableMod.default | String): Self = StObject.set(x, "table", value.asInstanceOf[js.Any])
