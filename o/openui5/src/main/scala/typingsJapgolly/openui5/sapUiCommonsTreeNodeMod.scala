...
import typingsJapgolly.openui5.anon.Opened
...
object sapUiCommonsTreeNodeMod {
  ...
  object TreeNodeSettings {
    ...
    extension [Self <: TreeNodeSettings](x: Self) {
      ...
      inline def setSelected(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "selected", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setToggleOpenState(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "toggleOpenState", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
