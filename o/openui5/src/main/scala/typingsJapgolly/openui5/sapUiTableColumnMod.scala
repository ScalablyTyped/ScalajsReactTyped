...
import typingsJapgolly.openui5.anon.Menu
...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.HorizontalAlign
...
object sapUiTableColumnMod {
  ...
  trait Column
    ...
    def addMultiLabel(
      ...
      */
    oMultiLabel: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getLabel(): typingsJapgolly.openui5.sapUiCoreControlMod.default | String = js.native
    ...
    /**
      ...
      */
    def getMultiLabels(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getTemplate(): typingsJapgolly.openui5.sapUiCoreControlMod.default | String = js.native
    ...
    def getTemplateClone(/**
      ...
      */
    iIndex: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    ...
    /**
      ...
      */
    def removeAllMultiLabels(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeMultiLabel(/**
      * The multiLabel to remove or its index or id
      */
    vMultiLabel: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
      * @SINCE 1.13.1
      *
    ...
    def removeMultiLabel(/**
      * The multiLabel to remove or its index or id
      */
    vMultiLabel: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeMultiLabel(
      /**
      * The multiLabel to remove or its index or id
      */
    vMultiLabel: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ...
    def setLabel(/**
      * The label to set
      */
    vLabel: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
    ...
    def setMenu(/**
      * The menu to set
      */
    oMenu: typingsJapgolly.openui5.sapUiUnifiedMenuMod.default): this.type = js.native
    ...
    def setTemplate(/**
      * The template to set
      */
    vTemplate: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  ...
  object ColumnSettings {
    ...
    extension [Self <: ColumnSettings](x: Self) {
      ...
      inline def setColumnMenuOpen(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "columnMenuOpen", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setLabel(value: String | typingsJapgolly.openui5.sapUiCoreControlMod.default | PropertyBindingInfo): Self = StObject.set(x, "label", value.asInstanceOf[js.Any])
      ...
      inline def setMultiLabelsVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "multiLabels", js.Array(value*))
      ...
      inline def setTemplate(value: String | typingsJapgolly.openui5.sapUiCoreControlMod.default | PropertyBindingInfo): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
