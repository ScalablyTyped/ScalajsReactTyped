...
object sapMUploadUploaderHttpRequestMethodMod {
  ...
  object default extends StObject {
    ...
    /* "POST" */ val Post: typingsJapgolly.openui5.sapMUploadUploaderHttpRequestMethodMod.UploaderHttpRequestMethod.Post & String = js.native
    
    /* "PUT" */ val Put: typingsJapgolly.openui5.sapMUploadUploaderHttpRequestMethodMod.UploaderHttpRequestMethod.Put & String = js.native
  }
