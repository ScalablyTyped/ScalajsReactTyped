...
import typingsJapgolly.openui5.anon.SelectedButtonId
...
object sapUiCommonsSegmentedButtonMod {
  ...
  trait SegmentedButton
    ...
    def addButton(
      ...
      */
    oButton: typingsJapgolly.openui5.sapUiCommonsButtonMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * Buttons
      */
    def getButtons(): js.Array[typingsJapgolly.openui5.sapUiCommonsButtonMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllButtons(): js.Array[typingsJapgolly.openui5.sapUiCommonsButtonMod.default] = js.native
    
    def removeButton(/**
      * The button to remove or its index or id
      */
    vButton: String): typingsJapgolly.openui5.sapUiCommonsButtonMod.default | Null = js.native
    /**
    ...
    def removeButton(/**
      * The button to remove or its index or id
      */
    vButton: int): typingsJapgolly.openui5.sapUiCommonsButtonMod.default | Null = js.native
    def removeButton(
      /**
      * The button to remove or its index or id
      */
    vButton: typingsJapgolly.openui5.sapUiCommonsButtonMod.default
    ): typingsJapgolly.openui5.sapUiCommonsButtonMod.default | Null = js.native
    ...
    def setSelectedButton(
      ...
      */
    oSelectedButton: typingsJapgolly.openui5.sapUiCommonsButtonMod.default
    ): this.type = js.native
    /**
  ...
  trait SegmentedButtonSettings
    ...
    var buttons: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCommonsButtonMod.default] | typingsJapgolly.openui5.sapUiCommonsButtonMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      * Selected Button
      */
    var selectedButton: js.UndefOr[typingsJapgolly.openui5.sapUiCommonsButtonMod.default | String] = js.undefined
  }
  object SegmentedButtonSettings {
    ...
    extension [Self <: SegmentedButtonSettings](x: Self) {
      ...
      inline def setButtons(
        value: js.Array[typingsJapgolly.openui5.sapUiCommonsButtonMod.default] | typingsJapgolly.openui5.sapUiCommonsButtonMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
      
      inline def setButtonsUndefined: Self = StObject.set(x, "buttons", js.undefined)
      
      inline def setButtonsVarargs(value: typingsJapgolly.openui5.sapUiCommonsButtonMod.default*): Self = StObject.set(x, "buttons", js.Array(value*))
      ...
      inline def setSelectedButton(value: typingsJapgolly.openui5.sapUiCommonsButtonMod.default | String): Self = StObject.set(x, "selectedButton", value.asInstanceOf[js.Any])
