...
import typingsJapgolly.openui5.anon.Aggregation
import typingsJapgolly.openui5.anon.Apply
import typingsJapgolly.openui5.anon.AutoExpandSelect
import typingsJapgolly.openui5.anon.CanonicalPath
import typingsJapgolly.openui5.anon.PatchWithoutSideEffects
...
object sapUiModelOdataV4OdatamodelMod {
  ...
  trait ODataModel
    ...
    ): typingsJapgolly.openui5.sapUiModelOdataV4OdatacontextbindingMod.default = js.native
    def bindContext(
      /**
      * The binding path in the model; must not end with a slash
      */
    sPath: String,
      ...
      * The context which is required as base for a relative path
      */
    oContext: typingsJapgolly.openui5.sapUiModelOdataV4ContextMod.default
    ): typingsJapgolly.openui5.sapUiModelOdataV4OdatacontextbindingMod.default = js.native
    def bindContext(
      /**
      * The binding path in the model; must not end with a slash
    ...
    oContext: Unit,
      ...
      */
    vSorters: js.Array[typingsJapgolly.openui5.sapUiModelSorterMod.default],
      /**
      ...
      */
    vFilters: js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.default],
      /**
    ...
    ): typingsJapgolly.openui5.sapUiModelOdataV4OdatalistbindingMod.default = js.native
    def bindList(
      /**
      * The binding path in the model; must not end with a slash
      */
    ...
    vSorters: js.Array[typingsJapgolly.openui5.sapUiModelSorterMod.default],
      ...
      * the dynamic filters using a logical `AND`. Supported since 1.39.0.
      */
    vFilters: typingsJapgolly.openui5.sapUiModelFilterMod.default,
      /**
      * Map of binding parameters which can be OData query options as specified in "OData Version 4.0 Part 2: URL Conventions" or binding-specific parameters as specified below. Note:
      * The binding creates its own data service request if it is absolute or if it has any parameters or if
      * it is relative and has a context created via {@link #createBindingContext} or if it has sorters or filters.
    ...
    oContext: Unit,
      ...
      * the dynamic sorters. Supported since 1.39.0.
      */
    vSorters: typingsJapgolly.openui5.sapUiModelSorterMod.default,
      /**
      * The dynamic application filters to be used initially. Call {@link sap.ui.model.odata.v4.ODataListBinding#filter}
      * to replace them. Static filters, as defined in the '$filter' binding parameter, are always combined with
      * the dynamic filters using a logical `AND`. Supported since 1.39.0.
    ...
    oContext: Unit,
      ...
      */
    mParameters: Apply
    ): typingsJapgolly.openui5.sapUiModelOdataV4OdatapropertybindingMod.default = js.native
    def bindProperty(
      /**
      * The binding path in the model; must not end with a slash
      */
    ...
    /**
      ...
      */
    def getAllBindings(): js.Array[typingsJapgolly.openui5.sapUiModelBindingMod.default] = js.native
    ...
    def requestCanonicalPath(
      ...
      */
    oEntityContext: typingsJapgolly.openui5.sapUiModelOdataV4ContextMod.default
    ): js.Promise[Any] = js.native
