...
import typingsJapgolly.openui5.anon.Loaded
import typingsJapgolly.openui5.anon.ResponseXHR
...
object sapMUploadUploaderMod {
  ...
  object default {
    ...
    sUrl: String,
      ...
      */
    aHeaderFields: js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default]
  ...
  object UploaderSettings {
    ...
    extension [Self <: UploaderSettings](x: Self) {
      ...
      inline def setUploadProgressed(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "uploadProgressed", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setUploadProgressedUndefined: Self = StObject.set(x, "uploadProgressed", js.undefined)
      
      inline def setUploadStarted(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "uploadStarted", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
