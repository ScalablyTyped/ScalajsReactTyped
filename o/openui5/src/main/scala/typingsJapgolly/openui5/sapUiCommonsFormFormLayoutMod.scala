...
object sapUiCommonsFormFormLayoutMod {
  ...
  type FormLayout = typingsJapgolly.openui5.sapUiLayoutFormFormLayoutMod.default
  
  type FormLayoutSettings = typingsJapgolly.openui5.sapUiLayoutFormFormLayoutMod.FormLayoutSettings
}
