...
object sapUiCommonsFormFormMod {
  
  @JSImport("sap/ui/commons/form/Form", JSImport.Default)
  @js.native
  /**
  ...
  @js.native
  trait Form
    extends typingsJapgolly.openui5.sapUiLayoutFormFormMod.default
  
  type FormSettings = typingsJapgolly.openui5.sapUiLayoutFormFormMod.FormSettings
}
