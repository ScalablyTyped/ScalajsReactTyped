...
object sapUiUnifiedSplitContainerMod {
  ...
  trait SplitContainer
    ...
    def addSecondaryContent(
      ...
      */
    oSecondaryContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getSecondaryContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllSecondaryContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def removeSecondaryContent(/**
      ...
      */
    vSecondaryContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeSecondaryContent(/**
      * The secondaryContent to remove or its index or id
      */
    vSecondaryContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeSecondaryContent(
      /**
      * The secondaryContent to remove or its index or id
      */
    vSecondaryContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
  ...
  object SplitContainerSettings {
    ...
    extension [Self <: SplitContainerSettings](x: Self) {
      ...
      inline def setSecondaryContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "secondaryContent", js.Array(value*))
