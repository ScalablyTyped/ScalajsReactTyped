...
object sapUiUx3CollectionMod {
  ...
  trait Collection
    ...
    def addSelectedItem(
      ...
      * a selectedItem instance may be given.
      */
    vSelectedItem: typingsJapgolly.openui5.sapUiCoreItemMod.default
    ): this.type = js.native
  ...
  object CollectionSettings {
    ...
    extension [Self <: CollectionSettings](x: Self) {
      ...
      inline def setPropertyChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "propertyChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
