...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.Label
...
object sapUiLayoutFormFormElementMod {
  ...
  trait FormElement
    ...
    def addField(
      ...
      */
    oField: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFields(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllFields(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeField(/**
      * The field to remove or its index or id
      */
    vField: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeField(/**
      * The field to remove or its index or id
      */
    vField: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeField(
      /**
      * The field to remove or its index or id
      */
    vField: typingsJapgolly.openui5.sapUiCoreControlMod.default
  ...
  object FormElementSettings {
    ...
    extension [Self <: FormElementSettings](x: Self) {
      ...
      inline def setFieldsVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "fields", js.Array(value*))
