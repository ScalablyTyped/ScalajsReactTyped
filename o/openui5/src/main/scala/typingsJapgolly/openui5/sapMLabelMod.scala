...
import typingsJapgolly.openui5.sapMLibraryMod.LabelDesign
import typingsJapgolly.openui5.sapMLibraryMod.WrappingType
...
object sapMLabelMod {
  ...
  trait Label
    extends typingsJapgolly.openui5.sapUiCoreControlMod.default
       with typingsJapgolly.openui5.sapUiCoreLibraryMod.Label
       with IShrinkable
    ...
    def setLabelFor(
      ...
      */
    oLabelFor: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
  ...
  trait LabelSettings
    ...
    /**
      ...
      */
    var labelFor: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
  ...
  object LabelSettings {
    ...
    extension [Self <: LabelSettings](x: Self) {
      ...
      inline def setLabelFor(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "labelFor", value.asInstanceOf[js.Any])
