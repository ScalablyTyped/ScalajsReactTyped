...
object sapUiCommonsFileUploaderParameterMod {
  
  @JSImport("sap/ui/commons/FileUploaderParameter", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiUnifiedFileUploaderParameterMod.default {
    def this(/**
  ...
  type FileUploaderParameter = typingsJapgolly.openui5.sapUiUnifiedFileUploaderParameterMod.default
  
  type FileUploaderParameterSettings = typingsJapgolly.openui5.sapUiUnifiedFileUploaderParameterMod.FileUploaderParameterSettings
}
