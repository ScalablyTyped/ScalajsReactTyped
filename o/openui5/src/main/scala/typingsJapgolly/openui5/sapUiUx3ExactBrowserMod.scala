...
import typingsJapgolly.openui5.sapUiUx3LibraryMod.ExactOrder
...
object sapUiUx3ExactBrowserMod {
  ...
  trait ExactBrowser
    ...
    /**
      ...
      */
    def getOptionsMenu(): typingsJapgolly.openui5.sapUiCommonsMenuMod.default = js.native
    ...
    def setFollowUpControl(
      ...
      */
    oFollowUpControl: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
    ...
    def setOptionsMenu(
      ...
      */
    oOptionsMenu: typingsJapgolly.openui5.sapUiCommonsMenuMod.default
    ): this.type = js.native
  ...
  trait ExactBrowserSettings
    ...
    /**
      ...
      * the control.
      */
    var followUpControl: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
    ...
    /**
      * Menu with options. The menu can not used when the property showTopList is set to false.
      */
    var optionsMenu: js.UndefOr[typingsJapgolly.openui5.sapUiCommonsMenuMod.default] = js.undefined
  ...
  object ExactBrowserSettings {
    ...
    extension [Self <: ExactBrowserSettings](x: Self) {
      ...
      inline def setFollowUpControl(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "followUpControl", value.asInstanceOf[js.Any])
      ...
      inline def setOptionsMenu(value: typingsJapgolly.openui5.sapUiCommonsMenuMod.default): Self = StObject.set(x, "optionsMenu", value.asInstanceOf[js.Any])
