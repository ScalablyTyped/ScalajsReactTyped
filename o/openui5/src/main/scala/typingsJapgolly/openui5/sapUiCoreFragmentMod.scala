...
import typingsJapgolly.openui5.anon.ContainingView
import typingsJapgolly.openui5.anon.Init
...
object sapUiCoreFragmentMod {
  ...
  object default {
    ...
    sFragmentId: String,
      ...
      */
    sId: String
    ): js.UndefOr[typingsJapgolly.openui5.sapUiCoreElementMod.default] = (^.asInstanceOf[js.Dynamic].applyDynamic("byId")(sFragmentId.asInstanceOf[js.Any], sId.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[typingsJapgolly.openui5.sapUiCoreElementMod.default]]
