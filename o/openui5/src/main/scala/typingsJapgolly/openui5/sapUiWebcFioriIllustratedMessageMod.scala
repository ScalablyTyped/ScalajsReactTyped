...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IllustrationMessageSize
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IllustrationMessageType
...
object sapUiWebcFioriIllustratedMessageMod {
  ...
  trait IllustratedMessage
    ...
    /**
      ...
      */
    def getSubtitle(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setSubtitle(/**
      * The subtitle to set
      */
    oSubtitle: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  ...
  trait IllustratedMessageSettings
    ...
    /**
      ...
      * property will be overwritten.
      */
    var subtitle: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object IllustratedMessageSettings {
    ...
    extension [Self <: IllustratedMessageSettings](x: Self) {
      ...
      inline def setSubtitle(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "subtitle", value.asInstanceOf[js.Any])
