...
import typingsJapgolly.openui5.sapFSemanticSemanticToggleButtonMod.SemanticToggleButtonSettings
...
object sapFSemanticFlagActionMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapFSemanticSemanticToggleButtonMod.default {
    def this(/**
  ...
  type FlagAction = typingsJapgolly.openui5.sapFSemanticSemanticToggleButtonMod.default
