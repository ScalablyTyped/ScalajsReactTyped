...
object sapUiUnifiedCalendarYearPickerMod {
  ...
  object YearPickerSettings {
    ...
    extension [Self <: YearPickerSettings](x: Self) {
      ...
      inline def setPageChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pageChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
