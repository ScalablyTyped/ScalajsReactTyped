...
import typingsJapgolly.openui5.anon.Controls
import typingsJapgolly.openui5.anon.ElementException
import typingsJapgolly.openui5.anon.Exception
import typingsJapgolly.openui5.anon.Name
import typingsJapgolly.openui5.anon.Url
...
object sapUiCoreCoreMod extends Shortcut {
  ...
  trait Core extends StObject {
    ...
    /**
      ...
      */
    def byFieldGroupId(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    def byFieldGroupId(/**
      * ID of the field group or an array of field group IDs to match
      */
    vFieldGroupIds: String): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    def byFieldGroupId(
      /**
      * ID of the field group or an array of field group IDs to match
      */
    ...
    /**
      ...
      */
    def byId(): js.UndefOr[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    def byId(/**
      * ID of the element to search for
      */
    sId: ID): js.UndefOr[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    ...
    def createComponent(
      ...
      */
    vComponent: String
    ): typingsJapgolly.openui5.sapUiCoreComponentMod.default | js.Promise[typingsJapgolly.openui5.sapUiCoreComponentMod.default] = js.native
    def createComponent(
      /**
      * name of the component to import or object containing all needed parameters
      */
    ...
    /**
      ...
      */
    def createRenderManager(): typingsJapgolly.openui5.sapUiCoreRenderManagerMod.default = js.native
    ...
    def createUIArea(/**
      ...
      */
    oDomRef: String): typingsJapgolly.openui5.sapUiCoreUiareaMod.default = js.native
    def createUIArea(/**
      * a DOM Element or ID string of the UIArea
      */
    oDomRef: Element): typingsJapgolly.openui5.sapUiCoreUiareaMod.default = js.native
    ...
    /**
      ...
      */
    def getApplication(): typingsJapgolly.openui5.sapUiAppApplicationMod.default = js.native
    ...
    /**
      ...
      */
    def getComponent(sId: String): typingsJapgolly.openui5.sapUiCoreComponentMod.default = js.native
    ...
    /**
      ...
      */
    def getConfiguration(): typingsJapgolly.openui5.sapUiCoreConfigurationMod.default = js.native
    ...
    /**
      ...
      */
    def getControl(): js.UndefOr[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    def getControl(/**
    ...
    /**
      ...
      * @returns Element for the given ID or `undefined`
      */
    def getElementById(): js.UndefOr[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    def getElementById(/**
    ...
    /**
      ...
      * @returns the event bus
      */
    def getEventBus(): typingsJapgolly.openui5.sapUiCoreEventBusMod.default = js.native
    ...
    def getLibraryResourceBundle(): js.UndefOr[
        typingsJapgolly.openui5.sapBaseI18nResourceBundleMod.default | js.Promise[js.UndefOr[typingsJapgolly.openui5.sapBaseI18nResourceBundleMod.default]]
      ] = js.native
    ...
    /**
      ...
      */
    def getMessageManager(): typingsJapgolly.openui5.sapUiCoreMessageMessageManagerMod.default = js.native
    ...
    /**
      ...
      */
    def getMetadata(): typingsJapgolly.openui5.sapUiBaseMetadataMod.default = js.native
    ...
    def getModel(/**
      ...
      */
    sName: String): typingsJapgolly.openui5.sapUiModelModelMod.default = js.native
    ...
    /**
      ...
      */
    def getRenderManager(): typingsJapgolly.openui5.sapUiCoreRenderManagerMod.default = js.native
    ...
    /**
      ...
      */
    def getRootComponent(): typingsJapgolly.openui5.sapUiCoreComponentMod.default = js.native
    ...
    /**
      ...
      */
    def getTemplate(sId: String): typingsJapgolly.openui5.sapUiCoreComponentMod.default = js.native
    ...
    def getUIArea(/**
      ...
      */
    o: String): js.UndefOr[typingsJapgolly.openui5.sapUiCoreUiareaMod.default | Null] = js.native
    def getUIArea(/**
      * DOM element or ID of the UIArea
      */
    o: Element): js.UndefOr[typingsJapgolly.openui5.sapUiCoreUiareaMod.default | Null] = js.native
