...
import typingsJapgolly.openui5.anon.AggregationName
import typingsJapgolly.openui5.anon.PropertyKey
...
object sapMMenuItemMod {
  ...
  object MenuItemSettings {
    ...
    extension [Self <: MenuItemSettings](x: Self) {
      ...
      inline def setAggregationChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "aggregationChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
