...
import typingsJapgolly.openui5.sapMInputMod.InputSettings
...
object sapMMultiInputMod {
  ...
  @js.native
  trait MultiInput
    extends typingsJapgolly.openui5.sapMInputMod.default
    ...
    /**
      ...
      */
    def getDialogTitle(): typingsJapgolly.openui5.sapMTitleMod.default | Null = js.native
    ...
    def setTokens(/**
      * The new token set
      */
    aTokens: js.Array[typingsJapgolly.openui5.sapMTokenMod.default]): this.type = js.native
  }
