...
import typingsJapgolly.openui5.sapUiLayoutLibraryMod.cssgrid.CSSGridAutoFlow
import typingsJapgolly.openui5.sapUiLayoutLibraryMod.cssgrid.CSSGridGapShortHand
import typingsJapgolly.openui5.sapUiLayoutLibraryMod.cssgrid.CSSGridTrack
...
object sapUiLayoutCssgridCssgridMod {
  ...
  trait CSSGrid
    ...
    def removeItem(
      ...
      * The item to remove or its index or id
      */
    vItem: typingsJapgolly.openui5.sapUiCoreControlMod.default
