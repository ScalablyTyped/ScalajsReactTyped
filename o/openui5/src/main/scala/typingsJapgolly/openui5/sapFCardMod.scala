...
import typingsJapgolly.openui5.sapFCardBaseMod.CardBaseSettings
import typingsJapgolly.openui5.sapFLibraryMod.cards.HeaderPosition
...
object sapFCardMod {
  ...
  @js.native
  trait Card
    extends typingsJapgolly.openui5.sapFCardBaseMod.default {
