...
import typingsJapgolly.openui5.anon.Landscape
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMSplitContainerMod.SplitContainerSettings
...
object sapMSplitAppMod {
  ...
  @js.native
  trait SplitApp
    extends typingsJapgolly.openui5.sapMSplitContainerMod.default {
  ...
  object SplitAppSettings {
    ...
    extension [Self <: SplitAppSettings](x: Self) {
      ...
      inline def setOrientationChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "orientationChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
