...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropEffect
import typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropLayout
import typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropPosition
import typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.IDropInfo
...
object sapUiCoreDndDropInfoMod {
  ...
  object DropInfoSettings {
    ...
    extension [Self <: DropInfoSettings](x: Self) {
      ...
      inline def setDragEnter(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "dragEnter", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setDragEnterUndefined: Self = StObject.set(x, "dragEnter", js.undefined)
      
      inline def setDragOver(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "dragOver", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setDragOverUndefined: Self = StObject.set(x, "dragOver", js.undefined)
      
      inline def setDrop(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "drop", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
