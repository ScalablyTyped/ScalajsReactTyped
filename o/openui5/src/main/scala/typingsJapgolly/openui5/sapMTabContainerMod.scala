...
import typingsJapgolly.openui5.anon.`22`
...
object sapMTabContainerMod {
  ...
  trait TabContainer
    ...
    def addItem(
      ...
      */
    oItem: typingsJapgolly.openui5.sapMTabContainerItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapMTabContainerItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllItems(): js.Array[typingsJapgolly.openui5.sapMTabContainerItemMod.default] = js.native
    
    def removeItem(/**
      * The item to remove or its index or ID
      */
    vItem: String): typingsJapgolly.openui5.sapMTabContainerItemMod.default | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or ID
      */
    vItem: int): typingsJapgolly.openui5.sapMTabContainerItemMod.default | Null = js.native
    def removeItem(
      /**
      * The item to remove or its index or ID
      */
    vItem: typingsJapgolly.openui5.sapMTabContainerItemMod.default
    ): typingsJapgolly.openui5.sapMTabContainerItemMod.default | Null = js.native
    ...
    def setSelectedItem(
      ...
      */
    oSelectedItem: typingsJapgolly.openui5.sapMTabContainerItemMod.default
    ): this.type = js.native
    /**
  ...
  trait TabContainerSettings
    ...
    var items: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMTabContainerItemMod.default] | typingsJapgolly.openui5.sapMTabContainerItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    
    /**
      * Sets or retrieves the selected item from the `items` aggregation.
      */
    var selectedItem: js.UndefOr[typingsJapgolly.openui5.sapMTabContainerItemMod.default | String] = js.undefined
  ...
  object TabContainerSettings {
    ...
    extension [Self <: TabContainerSettings](x: Self) {
      ...
      inline def setAddNewButtonPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "addNewButtonPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setItemClose(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "itemClose", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setItems(
        value: js.Array[typingsJapgolly.openui5.sapMTabContainerItemMod.default] | typingsJapgolly.openui5.sapMTabContainerItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapMTabContainerItemMod.default*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setSelectedItem(value: typingsJapgolly.openui5.sapMTabContainerItemMod.default | String): Self = StObject.set(x, "selectedItem", value.asInstanceOf[js.Any])
