...
import typingsJapgolly.openui5.anon.View
...
import typingsJapgolly.openui5.sapUxapLibraryMod.BlockBaseColumnLayout
import typingsJapgolly.openui5.sapUxapLibraryMod.BlockBaseFormAdjustment
...
object sapUxapBlockBaseMod {
  ...
  trait BlockBase
    ...
    def addMapping(
      ...
      */
    oMapping: typingsJapgolly.openui5.sapUxapModelMappingMod.default
    ): this.type = js.native
    ...
    mParameter: js.Object,
      ...
      */
    sMode: String
    ): js.Promise[typingsJapgolly.openui5.sapUiCoreMvcViewMod.default] = js.native
    ...
    /**
      ...
      */
    def getMappings(): js.Array[typingsJapgolly.openui5.sapUxapModelMappingMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllMappings(): js.Array[typingsJapgolly.openui5.sapUxapModelMappingMod.default] = js.native
    
    def removeMapping(/**
      * The mapping to remove or its index or id
      */
    vMapping: String): typingsJapgolly.openui5.sapUxapModelMappingMod.default | Null = js.native
    /**
    ...
    def removeMapping(/**
      * The mapping to remove or its index or id
      */
    vMapping: int): typingsJapgolly.openui5.sapUxapModelMappingMod.default | Null = js.native
    def removeMapping(
      /**
      * The mapping to remove or its index or id
      */
    vMapping: typingsJapgolly.openui5.sapUxapModelMappingMod.default
    ): typingsJapgolly.openui5.sapUxapModelMappingMod.default | Null = js.native
    ...
    def setSelectedView(
      ...
      */
    oSelectedView: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
  ...
  trait BlockBaseSettings
    ...
    var mappings: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUxapModelMappingMod.default] | typingsJapgolly.openui5.sapUxapModelMappingMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      */
    var selectedView: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
  ...
  object BlockBaseSettings {
    ...
    extension [Self <: BlockBaseSettings](x: Self) {
      ...
      inline def setMappings(
        value: js.Array[typingsJapgolly.openui5.sapUxapModelMappingMod.default] | typingsJapgolly.openui5.sapUxapModelMappingMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setMappingsVarargs(value: typingsJapgolly.openui5.sapUxapModelMappingMod.default*): Self = StObject.set(x, "mappings", js.Array(value*))
      
      inline def setMode(value: String | PropertyBindingInfo): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
      
      inline def setModeUndefined: Self = StObject.set(x, "mode", js.undefined)
      
      inline def setSelectedView(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "selectedView", value.asInstanceOf[js.Any])
      ...
      inline def setViewInit(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "viewInit", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
