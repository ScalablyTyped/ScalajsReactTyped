...
import typingsJapgolly.openui5.sapMSemanticSemanticPageMod.SemanticPageSettings
...
object sapMSemanticShareMenuPageMod {
  ...
  @js.native
  trait ShareMenuPage
    extends typingsJapgolly.openui5.sapMSemanticSemanticPageMod.default {
    ...
    def addCustomShareMenuContent(
      ...
      */
    oCustomShareMenuContent: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCustomShareMenuContent(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllCustomShareMenuContent(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    def removeCustomShareMenuContent(/**
      * The customShareMenuContent to remove or its index or id
      */
    vCustomShareMenuContent: int): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    def removeCustomShareMenuContent(
      /**
      * The customShareMenuContent to remove or its index or id
      */
    vCustomShareMenuContent: typingsJapgolly.openui5.sapMButtonMod.default
    ): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
  }
  ...
  object ShareMenuPageSettings {
    ...
    extension [Self <: ShareMenuPageSettings](x: Self) {
      ...
      inline def setCustomShareMenuContentVarargs(value: typingsJapgolly.openui5.sapMButtonMod.default*): Self = StObject.set(x, "customShareMenuContent", js.Array(value*))
    }
  }
}
