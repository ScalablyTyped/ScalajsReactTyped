...
object sapUiModelOdataUpdateMethodMod {
  ...
  object default extends StObject {
    ...
    /* "MERGE" */ val Merge: typingsJapgolly.openui5.sapUiModelOdataUpdateMethodMod.UpdateMethod.Merge & String = js.native
    
    /* "PUT" */ val Put: typingsJapgolly.openui5.sapUiModelOdataUpdateMethodMod.UpdateMethod.Put & String = js.native
  }
