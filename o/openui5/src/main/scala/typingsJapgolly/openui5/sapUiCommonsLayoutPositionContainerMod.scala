...
object sapUiCommonsLayoutPositionContainerMod {
  ...
  trait PositionContainer
    ...
    /**
      ...
      */
    def getControl(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setControl(/**
      * The control to set
      */
    oControl: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  ...
  trait PositionContainerSettings
    ...
    /**
      * Child control of the position container
      */
    var control: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object PositionContainerSettings {
    ...
    extension [Self <: PositionContainerSettings](x: Self) {
      ...
      inline def setControl(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "control", value.asInstanceOf[js.Any])
