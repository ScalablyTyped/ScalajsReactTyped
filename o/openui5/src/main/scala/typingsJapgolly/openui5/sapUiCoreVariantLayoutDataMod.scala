...
object sapUiCoreVariantLayoutDataMod {
  ...
  trait VariantLayoutData
    extends typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default {
    ...
    def addMultipleLayoutData(
      ...
      */
    oMultipleLayoutData: typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getMultipleLayoutData(): js.Array[typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllMultipleLayoutData(): js.Array[typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default] = js.native
    
    def removeMultipleLayoutData(/**
      * The multipleLayoutData to remove or its index or id
      */
    vMultipleLayoutData: String): typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default | Null = js.native
    /**
    ...
    def removeMultipleLayoutData(/**
      * The multipleLayoutData to remove or its index or id
      */
    vMultipleLayoutData: int): typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default | Null = js.native
    def removeMultipleLayoutData(
      /**
      * The multipleLayoutData to remove or its index or id
      */
    vMultipleLayoutData: typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default
    ): typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default | Null = js.native
  }
  ...
  trait VariantLayoutDataSettings
    ...
    var multipleLayoutData: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default] | typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  }
  object VariantLayoutDataSettings {
    ...
    extension [Self <: VariantLayoutDataSettings](x: Self) {
      ...
      inline def setMultipleLayoutData(
        value: js.Array[typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default] | typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setMultipleLayoutDataVarargs(value: typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default*): Self = StObject.set(x, "multipleLayoutData", js.Array(value*))
    }
  }
}
