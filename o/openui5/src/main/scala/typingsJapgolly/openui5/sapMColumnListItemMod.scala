...
object sapMColumnListItemMod {
  ...
  trait ColumnListItem
    ...
    def addCell(
      ...
      */
    oCell: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCells(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllCells(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeCell(/**
      * The cell to remove or its index or id
      */
    vCell: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeCell(/**
      * The cell to remove or its index or id
      */
    vCell: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeCell(
      /**
      * The cell to remove or its index or id
      */
    vCell: typingsJapgolly.openui5.sapUiCoreControlMod.default
  ...
  object ColumnListItemSettings {
    ...
    extension [Self <: ColumnListItemSettings](x: Self) {
      ...
      inline def setCellsVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "cells", js.Array(value*))
