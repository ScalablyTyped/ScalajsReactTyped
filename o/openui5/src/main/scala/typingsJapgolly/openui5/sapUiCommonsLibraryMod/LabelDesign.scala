...
object LabelDesign extends StObject {
  ...
  sealed trait Bold
    extends StObject
       with LabelDesign
  /* "Bold" */ val Bold: typingsJapgolly.openui5.sapUiCommonsLibraryMod.LabelDesign.Bold & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with LabelDesign
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiCommonsLibraryMod.LabelDesign.Standard & String = js.native
}
