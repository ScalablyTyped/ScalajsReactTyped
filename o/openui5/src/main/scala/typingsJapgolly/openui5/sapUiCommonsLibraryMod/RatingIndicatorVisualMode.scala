...
object RatingIndicatorVisualMode extends StObject {
  ...
  /* "Continuous" */ val Continuous: typingsJapgolly.openui5.sapUiCommonsLibraryMod.RatingIndicatorVisualMode.Continuous & String = js.native
  ...
  sealed trait Full
    extends StObject
       with RatingIndicatorVisualMode
  /* "Full" */ val Full: typingsJapgolly.openui5.sapUiCommonsLibraryMod.RatingIndicatorVisualMode.Full & String = js.native
  ...
  sealed trait Half
    extends StObject
       with RatingIndicatorVisualMode
  /* "Half" */ val Half: typingsJapgolly.openui5.sapUiCommonsLibraryMod.RatingIndicatorVisualMode.Half & String = js.native
}
