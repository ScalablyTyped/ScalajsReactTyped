...
object ToolbarSeparatorDesign extends StObject {
  ...
  /* "FullHeight" */ val FullHeight: typingsJapgolly.openui5.sapUiCommonsLibraryMod.ToolbarSeparatorDesign.FullHeight & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with ToolbarSeparatorDesign
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiCommonsLibraryMod.ToolbarSeparatorDesign.Standard & String = js.native
}
