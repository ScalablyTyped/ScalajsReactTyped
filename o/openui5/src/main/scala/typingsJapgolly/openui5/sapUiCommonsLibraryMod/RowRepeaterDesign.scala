...
object RowRepeaterDesign extends StObject {
  ...
  /* "BareShell" */ val BareShell: typingsJapgolly.openui5.sapUiCommonsLibraryMod.RowRepeaterDesign.BareShell & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with RowRepeaterDesign
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiCommonsLibraryMod.RowRepeaterDesign.Standard & String = js.native
  ...
  sealed trait Transparent
    extends StObject
       with RowRepeaterDesign
  /* "Transparent" */ val Transparent: typingsJapgolly.openui5.sapUiCommonsLibraryMod.RowRepeaterDesign.Transparent & String = js.native
}
