...
object TriStateCheckBoxState extends StObject {
  ...
  /* "Checked" */ val Checked: typingsJapgolly.openui5.sapUiCommonsLibraryMod.TriStateCheckBoxState.Checked & String = js.native
  ...
  sealed trait Mixed
    extends StObject
       with TriStateCheckBoxState
  /* "Mixed" */ val Mixed: typingsJapgolly.openui5.sapUiCommonsLibraryMod.TriStateCheckBoxState.Mixed & String = js.native
  ...
  sealed trait Unchecked
    extends StObject
       with TriStateCheckBoxState
  /* "Unchecked" */ val Unchecked: typingsJapgolly.openui5.sapUiCommonsLibraryMod.TriStateCheckBoxState.Unchecked & String = js.native
}
