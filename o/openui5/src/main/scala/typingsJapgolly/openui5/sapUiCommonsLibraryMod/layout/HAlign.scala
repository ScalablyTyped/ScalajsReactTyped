...
object HAlign extends StObject {
  ...
  sealed trait Begin
    extends StObject
       with HAlign
  /* "Begin" */ val Begin: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.HAlign.Begin & String = js.native
  ...
  sealed trait Center
    extends StObject
       with HAlign
  /* "Center" */ val Center: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.HAlign.Center & String = js.native
  ...
  sealed trait End
    extends StObject
       with HAlign
  /* "End" */ val End: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.HAlign.End & String = js.native
  ...
  sealed trait Left
    extends StObject
       with HAlign
  /* "Left" */ val Left: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.HAlign.Left & String = js.native
  ...
  sealed trait Right
    extends StObject
       with HAlign
  /* "Right" */ val Right: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.HAlign.Right & String = js.native
}
