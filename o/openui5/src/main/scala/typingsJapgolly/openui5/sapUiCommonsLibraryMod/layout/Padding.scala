...
object Padding extends StObject {
  ...
  sealed trait Begin
    extends StObject
       with Padding
  /* "Begin" */ val Begin: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.Padding.Begin & String = js.native
  ...
  sealed trait Both
    extends StObject
       with Padding
  /* "Both" */ val Both: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.Padding.Both & String = js.native
  ...
  sealed trait End
    extends StObject
       with Padding
  /* "End" */ val End: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.Padding.End & String = js.native
  ...
  sealed trait Neither
    extends StObject
       with Padding
  /* "Neither" */ val Neither: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.Padding.Neither & String = js.native
  ...
  sealed trait None
    extends StObject
       with Padding
  /* "None" */ val None: typingsJapgolly.openui5.sapUiCommonsLibraryMod.layout.Padding.None & String = js.native
}
