...
object HorizontalDividerHeight extends StObject {
  ...
  /* "Large" */ val Large: typingsJapgolly.openui5.sapUiCommonsLibraryMod.HorizontalDividerHeight.Large & String = js.native
  ...
  sealed trait Medium
    extends StObject
       with HorizontalDividerHeight
  /* "Medium" */ val Medium: typingsJapgolly.openui5.sapUiCommonsLibraryMod.HorizontalDividerHeight.Medium & String = js.native
  ...
  sealed trait Ruleheight
    extends StObject
       with HorizontalDividerHeight
  /* "Ruleheight" */ val Ruleheight: typingsJapgolly.openui5.sapUiCommonsLibraryMod.HorizontalDividerHeight.Ruleheight & String = js.native
  ...
  sealed trait Small
    extends StObject
       with HorizontalDividerHeight
  /* "Small" */ val Small: typingsJapgolly.openui5.sapUiCommonsLibraryMod.HorizontalDividerHeight.Small & String = js.native
}
