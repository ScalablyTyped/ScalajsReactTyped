...
object MenuBarDesign extends StObject {
  ...
  sealed trait Header
    extends StObject
       with MenuBarDesign
  /* "Header" */ val Header: typingsJapgolly.openui5.sapUiCommonsLibraryMod.MenuBarDesign.Header & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with MenuBarDesign
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiCommonsLibraryMod.MenuBarDesign.Standard & String = js.native
}
