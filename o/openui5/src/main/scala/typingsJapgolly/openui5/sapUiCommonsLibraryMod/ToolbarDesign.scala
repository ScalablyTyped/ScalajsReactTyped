...
object ToolbarDesign extends StObject {
  ...
  sealed trait Flat
    extends StObject
       with ToolbarDesign
  /* "Flat" */ val Flat: typingsJapgolly.openui5.sapUiCommonsLibraryMod.ToolbarDesign.Flat & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with ToolbarDesign
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiCommonsLibraryMod.ToolbarDesign.Standard & String = js.native
  ...
  sealed trait Transparent
    extends StObject
       with ToolbarDesign
  /* "Transparent" */ val Transparent: typingsJapgolly.openui5.sapUiCommonsLibraryMod.ToolbarDesign.Transparent & String = js.native
}
