...
object HorizontalDividerType extends StObject {
  ...
  /* "Area" */ val Area: typingsJapgolly.openui5.sapUiCommonsLibraryMod.HorizontalDividerType.Area & String = js.native
  ...
  sealed trait Page
    extends StObject
       with HorizontalDividerType
  /* "Page" */ val Page: typingsJapgolly.openui5.sapUiCommonsLibraryMod.HorizontalDividerType.Page & String = js.native
}
