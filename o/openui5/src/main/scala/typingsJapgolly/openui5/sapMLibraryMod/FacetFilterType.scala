...
object FacetFilterType extends StObject {
  ...
  /* "Light" */ val Light: typingsJapgolly.openui5.sapMLibraryMod.FacetFilterType.Light & String = js.native
  ...
  sealed trait Simple
    extends StObject
       with FacetFilterType
  /* "Simple" */ val Simple: typingsJapgolly.openui5.sapMLibraryMod.FacetFilterType.Simple & String = js.native
}
