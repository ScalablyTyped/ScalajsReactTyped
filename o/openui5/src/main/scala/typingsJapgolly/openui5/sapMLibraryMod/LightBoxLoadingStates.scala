...
object LightBoxLoadingStates extends StObject {
  ...
  /* "ERROR" */ val Error: typingsJapgolly.openui5.sapMLibraryMod.LightBoxLoadingStates.Error & String = js.native
  ...
  sealed trait Loaded
    extends StObject
       with LightBoxLoadingStates
  /* "LOADED" */ val Loaded: typingsJapgolly.openui5.sapMLibraryMod.LightBoxLoadingStates.Loaded & String = js.native
  ...
  sealed trait Loading
    extends StObject
       with LightBoxLoadingStates
  /* "LOADING" */ val Loading: typingsJapgolly.openui5.sapMLibraryMod.LightBoxLoadingStates.Loading & String = js.native
  ...
  sealed trait TimeOutError
    extends StObject
       with LightBoxLoadingStates
  /* "TIME_OUT_ERROR" */ val TimeOutError: typingsJapgolly.openui5.sapMLibraryMod.LightBoxLoadingStates.TimeOutError & String = js.native
}
