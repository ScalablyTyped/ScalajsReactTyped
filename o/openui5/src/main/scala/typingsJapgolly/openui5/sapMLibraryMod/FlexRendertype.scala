...
object FlexRendertype extends StObject {
  ...
  sealed trait Bare
    extends StObject
       with FlexRendertype
  /* "Bare" */ val Bare: typingsJapgolly.openui5.sapMLibraryMod.FlexRendertype.Bare & String = js.native
  ...
  sealed trait Div
    extends StObject
       with FlexRendertype
  /* "Div" */ val Div: typingsJapgolly.openui5.sapMLibraryMod.FlexRendertype.Div & String = js.native
  ...
  sealed trait List
    extends StObject
       with FlexRendertype
  /* "List" */ val List: typingsJapgolly.openui5.sapMLibraryMod.FlexRendertype.List & String = js.native
}
