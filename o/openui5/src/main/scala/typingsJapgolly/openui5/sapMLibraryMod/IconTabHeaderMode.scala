...
object IconTabHeaderMode extends StObject {
  ...
  /* "Inline" */ val Inline: typingsJapgolly.openui5.sapMLibraryMod.IconTabHeaderMode.Inline & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with IconTabHeaderMode
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapMLibraryMod.IconTabHeaderMode.Standard & String = js.native
}
