...
object FlexDirection extends StObject {
  ...
  sealed trait Column
    extends StObject
       with FlexDirection
  /* "Column" */ val Column: typingsJapgolly.openui5.sapMLibraryMod.FlexDirection.Column & String = js.native
  ...
  sealed trait ColumnReverse
    extends StObject
       with FlexDirection
  /* "ColumnReverse" */ val ColumnReverse: typingsJapgolly.openui5.sapMLibraryMod.FlexDirection.ColumnReverse & String = js.native
  ...
  sealed trait Inherit
    extends StObject
       with FlexDirection
  /* "Inherit" */ val Inherit: typingsJapgolly.openui5.sapMLibraryMod.FlexDirection.Inherit & String = js.native
  ...
  sealed trait Row
    extends StObject
       with FlexDirection
  /* "Row" */ val Row: typingsJapgolly.openui5.sapMLibraryMod.FlexDirection.Row & String = js.native
  ...
  sealed trait RowReverse
    extends StObject
       with FlexDirection
  /* "RowReverse" */ val RowReverse: typingsJapgolly.openui5.sapMLibraryMod.FlexDirection.RowReverse & String = js.native
}
