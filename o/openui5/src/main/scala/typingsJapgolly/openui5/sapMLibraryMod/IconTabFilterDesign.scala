...
object IconTabFilterDesign extends StObject {
  ...
  /* "Horizontal" */ val Horizontal: typingsJapgolly.openui5.sapMLibraryMod.IconTabFilterDesign.Horizontal & String = js.native
  ...
  sealed trait Vertical
    extends StObject
       with IconTabFilterDesign
  /* "Vertical" */ val Vertical: typingsJapgolly.openui5.sapMLibraryMod.IconTabFilterDesign.Vertical & String = js.native
}
