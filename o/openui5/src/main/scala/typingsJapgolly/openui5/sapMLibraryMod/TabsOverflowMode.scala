...
object TabsOverflowMode extends StObject {
  ...
  /* "End" */ val End: typingsJapgolly.openui5.sapMLibraryMod.TabsOverflowMode.End & String = js.native
  ...
  sealed trait StartAndEnd
    extends StObject
       with TabsOverflowMode
  /* "StartAndEnd" */ val StartAndEnd: typingsJapgolly.openui5.sapMLibraryMod.TabsOverflowMode.StartAndEnd & String = js.native
}
