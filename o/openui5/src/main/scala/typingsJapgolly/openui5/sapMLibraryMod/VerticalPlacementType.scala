...
object VerticalPlacementType extends StObject {
  ...
  /* "Bottom" */ val Bottom: typingsJapgolly.openui5.sapMLibraryMod.VerticalPlacementType.Bottom & String = js.native
  ...
  sealed trait Top
    extends StObject
       with VerticalPlacementType
  /* "Top" */ val Top: typingsJapgolly.openui5.sapMLibraryMod.VerticalPlacementType.Top & String = js.native
  ...
  sealed trait Vertical
    extends StObject
       with VerticalPlacementType
  /* "Vertical" */ val Vertical: typingsJapgolly.openui5.sapMLibraryMod.VerticalPlacementType.Vertical & String = js.native
}
