...
object ObjectMarkerVisibility extends StObject {
  ...
  /* "IconAndText" */ val IconAndText: typingsJapgolly.openui5.sapMLibraryMod.ObjectMarkerVisibility.IconAndText & String = js.native
  ...
  sealed trait IconOnly
    extends StObject
       with ObjectMarkerVisibility
  /* "IconOnly" */ val IconOnly: typingsJapgolly.openui5.sapMLibraryMod.ObjectMarkerVisibility.IconOnly & String = js.native
  ...
  sealed trait TextOnly
    extends StObject
       with ObjectMarkerVisibility
  /* "TextOnly" */ val TextOnly: typingsJapgolly.openui5.sapMLibraryMod.ObjectMarkerVisibility.TextOnly & String = js.native
}
