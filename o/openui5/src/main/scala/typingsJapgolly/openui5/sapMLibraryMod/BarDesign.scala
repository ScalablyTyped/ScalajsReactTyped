...
object BarDesign extends StObject {
  ...
  sealed trait Auto
    extends StObject
       with BarDesign
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapMLibraryMod.BarDesign.Auto & String = js.native
  ...
  sealed trait Footer
    extends StObject
       with BarDesign
  /* "Footer" */ val Footer: typingsJapgolly.openui5.sapMLibraryMod.BarDesign.Footer & String = js.native
  ...
  sealed trait Header
    extends StObject
       with BarDesign
  /* "Header" */ val Header: typingsJapgolly.openui5.sapMLibraryMod.BarDesign.Header & String = js.native
  ...
  sealed trait SubHeader
    extends StObject
       with BarDesign
  /* "SubHeader" */ val SubHeader: typingsJapgolly.openui5.sapMLibraryMod.BarDesign.SubHeader & String = js.native
}
