...
object ToolbarDesign extends StObject {
  ...
  sealed trait Auto
    extends StObject
       with ToolbarDesign
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapMLibraryMod.ToolbarDesign.Auto & String = js.native
  ...
  sealed trait Info
    extends StObject
       with ToolbarDesign
  /* "Info" */ val Info: typingsJapgolly.openui5.sapMLibraryMod.ToolbarDesign.Info & String = js.native
  ...
  sealed trait Solid
    extends StObject
       with ToolbarDesign
  /* "Solid" */ val Solid: typingsJapgolly.openui5.sapMLibraryMod.ToolbarDesign.Solid & String = js.native
  ...
  sealed trait Transparent
    extends StObject
       with ToolbarDesign
  /* "Transparent" */ val Transparent: typingsJapgolly.openui5.sapMLibraryMod.ToolbarDesign.Transparent & String = js.native
}
