...
object BadgeState extends StObject {
  ...
  sealed trait Appear
    extends StObject
       with BadgeState
  /* "Appear" */ val Appear: typingsJapgolly.openui5.sapMLibraryMod.BadgeState.Appear & String = js.native
  ...
  sealed trait Disappear
    extends StObject
       with BadgeState
  /* "Disappear" */ val Disappear: typingsJapgolly.openui5.sapMLibraryMod.BadgeState.Disappear & String = js.native
  ...
  sealed trait Updated
    extends StObject
       with BadgeState
  /* "Updated" */ val Updated: typingsJapgolly.openui5.sapMLibraryMod.BadgeState.Updated & String = js.native
}
