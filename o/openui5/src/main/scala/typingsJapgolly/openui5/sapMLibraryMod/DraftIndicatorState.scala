...
object DraftIndicatorState extends StObject {
  ...
  /* "Clear" */ val Clear: typingsJapgolly.openui5.sapMLibraryMod.DraftIndicatorState.Clear & String = js.native
  ...
  sealed trait Saved
    extends StObject
       with DraftIndicatorState
  /* "Saved" */ val Saved: typingsJapgolly.openui5.sapMLibraryMod.DraftIndicatorState.Saved & String = js.native
  ...
  sealed trait Saving
    extends StObject
       with DraftIndicatorState
  /* "Saving" */ val Saving: typingsJapgolly.openui5.sapMLibraryMod.DraftIndicatorState.Saving & String = js.native
}
