...
object P13nPopupMode extends StObject {
  ...
  sealed trait Dialog
    extends StObject
       with P13nPopupMode
  /* "Dialog" */ val Dialog: typingsJapgolly.openui5.sapMLibraryMod.P13nPopupMode.Dialog & String = js.native
  ...
  sealed trait ResponsivePopover
    extends StObject
       with P13nPopupMode
  /* "ResponsivePopover" */ val ResponsivePopover: typingsJapgolly.openui5.sapMLibraryMod.P13nPopupMode.ResponsivePopover & String = js.native
}
