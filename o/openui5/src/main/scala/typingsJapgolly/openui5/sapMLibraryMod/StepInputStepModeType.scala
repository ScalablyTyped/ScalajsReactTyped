...
object StepInputStepModeType extends StObject {
  ...
  /* "AdditionAndSubtraction" */ val AdditionAndSubtraction: typingsJapgolly.openui5.sapMLibraryMod.StepInputStepModeType.AdditionAndSubtraction & String = js.native
  ...
  sealed trait Multiple
    extends StObject
       with StepInputStepModeType
  /* "Multiple" */ val Multiple: typingsJapgolly.openui5.sapMLibraryMod.StepInputStepModeType.Multiple & String = js.native
}
