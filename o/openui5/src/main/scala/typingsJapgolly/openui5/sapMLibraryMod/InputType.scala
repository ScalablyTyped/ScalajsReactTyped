...
object InputType extends StObject {
  ...
  sealed trait Date
    extends StObject
       with InputType
  /* "Date" */ val Date: typingsJapgolly.openui5.sapMLibraryMod.InputType.Date & String = js.native
  ...
  sealed trait Datetime
    extends StObject
       with InputType
  /* "Datetime" */ val Datetime: typingsJapgolly.openui5.sapMLibraryMod.InputType.Datetime & String = js.native
  ...
  sealed trait DatetimeLocale
    extends StObject
       with InputType
  /* "DatetimeLocale" */ val DatetimeLocale: typingsJapgolly.openui5.sapMLibraryMod.InputType.DatetimeLocale & String = js.native
  ...
  sealed trait Email
    extends StObject
       with InputType
  /* "Email" */ val Email: typingsJapgolly.openui5.sapMLibraryMod.InputType.Email & String = js.native
  ...
  sealed trait Month
    extends StObject
       with InputType
  /* "Month" */ val Month: typingsJapgolly.openui5.sapMLibraryMod.InputType.Month & String = js.native
  ...
  sealed trait Number
    extends StObject
       with InputType
  /* "Number" */ val Number: typingsJapgolly.openui5.sapMLibraryMod.InputType.Number & String = js.native
  ...
  sealed trait Password
    extends StObject
       with InputType
  /* "Password" */ val Password: typingsJapgolly.openui5.sapMLibraryMod.InputType.Password & String = js.native
  ...
  sealed trait Tel
    extends StObject
       with InputType
  /* "Tel" */ val Tel: typingsJapgolly.openui5.sapMLibraryMod.InputType.Tel & String = js.native
  ...
  sealed trait Text
    extends StObject
       with InputType
  /* "Text" */ val Text: typingsJapgolly.openui5.sapMLibraryMod.InputType.Text & String = js.native
  ...
  sealed trait Time
    extends StObject
       with InputType
  /* "Time" */ val Time: typingsJapgolly.openui5.sapMLibraryMod.InputType.Time & String = js.native
  ...
  sealed trait Url
    extends StObject
       with InputType
  /* "Url" */ val Url: typingsJapgolly.openui5.sapMLibraryMod.InputType.Url & String = js.native
  ...
  sealed trait Week
    extends StObject
       with InputType
  /* "Week" */ val Week: typingsJapgolly.openui5.sapMLibraryMod.InputType.Week & String = js.native
}
