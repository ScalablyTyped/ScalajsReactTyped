...
import typingsJapgolly.openui5.sapMSliderMod.default
...
trait IScale extends StObject {
  ...
  var getLabel: js.UndefOr[
    js.Function2[
      /* fValue */ float, 
      /* oSlider */ default | typingsJapgolly.openui5.sapMRangeSliderMod.default, 
      String | Double
    ]
  ] = js.undefined
...
object IScale {
  ...
  extension [Self <: IScale](x: Self) {
    ...
    inline def setGetLabel(
      value: (/* fValue */ float, /* oSlider */ default | typingsJapgolly.openui5.sapMRangeSliderMod.default) => String | Double
    ...
    inline def setHandleResize(value: /* oEvent */ Event => Callback): Self = StObject.set(x, "handleResize", js.Any.fromFunction1((t0: /* oEvent */ Event) => value(t0).runNow()))
