...
object GenericTagValueState extends StObject {
  ...
  /* "Error" */ val Error: typingsJapgolly.openui5.sapMLibraryMod.GenericTagValueState.Error & String = js.native
  ...
  sealed trait None
    extends StObject
       with GenericTagValueState
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.GenericTagValueState.None & String = js.native
}
