...
object ObjectHeaderPictureShape extends StObject {
  ...
  /* "Circle" */ val Circle: typingsJapgolly.openui5.sapMLibraryMod.ObjectHeaderPictureShape.Circle & String = js.native
  ...
  sealed trait Square
    extends StObject
       with ObjectHeaderPictureShape
  /* "Square" */ val Square: typingsJapgolly.openui5.sapMLibraryMod.ObjectHeaderPictureShape.Square & String = js.native
}
