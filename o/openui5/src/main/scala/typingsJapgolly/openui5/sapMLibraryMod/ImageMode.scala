...
object ImageMode extends StObject {
  ...
  sealed trait Background
    extends StObject
       with ImageMode
  /* "Background" */ val Background: typingsJapgolly.openui5.sapMLibraryMod.ImageMode.Background & String = js.native
  ...
  sealed trait Image
    extends StObject
       with ImageMode
  /* "Image" */ val Image: typingsJapgolly.openui5.sapMLibraryMod.ImageMode.Image & String = js.native
  ...
  sealed trait InlineSvg
    extends StObject
       with ImageMode
  /* "InlineSvg" */ val InlineSvg: typingsJapgolly.openui5.sapMLibraryMod.ImageMode.InlineSvg & String = js.native
}
