...
object FlexWrap extends StObject {
  ...
  sealed trait NoWrap
    extends StObject
       with FlexWrap
  /* "NoWrap" */ val NoWrap: typingsJapgolly.openui5.sapMLibraryMod.FlexWrap.NoWrap & String = js.native
  ...
  sealed trait Wrap
    extends StObject
       with FlexWrap
  /* "Wrap" */ val Wrap: typingsJapgolly.openui5.sapMLibraryMod.FlexWrap.Wrap & String = js.native
  ...
  sealed trait WrapReverse
    extends StObject
       with FlexWrap
  /* "WrapReverse" */ val WrapReverse: typingsJapgolly.openui5.sapMLibraryMod.FlexWrap.WrapReverse & String = js.native
}
