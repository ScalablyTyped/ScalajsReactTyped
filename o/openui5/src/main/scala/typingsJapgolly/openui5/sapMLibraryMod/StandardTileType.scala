...
object StandardTileType extends StObject {
  ...
  /* "Create" */ val Create: typingsJapgolly.openui5.sapMLibraryMod.StandardTileType.Create & String = js.native
  ...
  sealed trait Monitor
    extends StObject
       with StandardTileType
  /* "Monitor" */ val Monitor: typingsJapgolly.openui5.sapMLibraryMod.StandardTileType.Monitor & String = js.native
  ...
  sealed trait None
    extends StObject
       with StandardTileType
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.StandardTileType.None & String = js.native
}
