...
object SwitchType extends StObject {
  ...
  sealed trait AcceptReject
    extends StObject
       with SwitchType
  /* "AcceptReject" */ val AcceptReject: typingsJapgolly.openui5.sapMLibraryMod.SwitchType.AcceptReject & String = js.native
  ...
  sealed trait Default
    extends StObject
       with SwitchType
  /* "Default" */ val Default: typingsJapgolly.openui5.sapMLibraryMod.SwitchType.Default & String = js.native
}
