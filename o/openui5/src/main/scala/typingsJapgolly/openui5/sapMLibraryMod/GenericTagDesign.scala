...
object GenericTagDesign extends StObject {
  ...
  /* "Full" */ val Full: typingsJapgolly.openui5.sapMLibraryMod.GenericTagDesign.Full & String = js.native
  ...
  sealed trait StatusIconHidden
    extends StObject
       with GenericTagDesign
  /* "StatusIconHidden" */ val StatusIconHidden: typingsJapgolly.openui5.sapMLibraryMod.GenericTagDesign.StatusIconHidden & String = js.native
}
