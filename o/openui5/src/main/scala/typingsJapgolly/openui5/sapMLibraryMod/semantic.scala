...
object semantic {
  ...
  object SemanticRuleSetType extends StObject {
    ...
    /* "Classic" */ val Classic: typingsJapgolly.openui5.sapMLibraryMod.semantic.SemanticRuleSetType.Classic & String = js.native
    ...
    sealed trait Optimized
      extends StObject
         with SemanticRuleSetType
    /* "Optimized" */ val Optimized: typingsJapgolly.openui5.sapMLibraryMod.semantic.SemanticRuleSetType.Optimized & String = js.native
  }
