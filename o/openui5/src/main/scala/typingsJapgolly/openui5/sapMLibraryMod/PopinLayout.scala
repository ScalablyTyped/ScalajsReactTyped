...
object PopinLayout extends StObject {
  ...
  sealed trait Block
    extends StObject
       with PopinLayout
  /* "Block" */ val Block: typingsJapgolly.openui5.sapMLibraryMod.PopinLayout.Block & String = js.native
  ...
  sealed trait GridLarge
    extends StObject
       with PopinLayout
  /* "GridLarge" */ val GridLarge: typingsJapgolly.openui5.sapMLibraryMod.PopinLayout.GridLarge & String = js.native
  ...
  sealed trait GridSmall
    extends StObject
       with PopinLayout
  /* "GridSmall" */ val GridSmall: typingsJapgolly.openui5.sapMLibraryMod.PopinLayout.GridSmall & String = js.native
}
