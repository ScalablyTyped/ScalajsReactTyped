...
object SplitAppMode extends StObject {
  ...
  sealed trait HideMode
    extends StObject
       with SplitAppMode
  /* "HideMode" */ val HideMode: typingsJapgolly.openui5.sapMLibraryMod.SplitAppMode.HideMode & String = js.native
  ...
  sealed trait PopoverMode
    extends StObject
       with SplitAppMode
  /* "PopoverMode" */ val PopoverMode: typingsJapgolly.openui5.sapMLibraryMod.SplitAppMode.PopoverMode & String = js.native
  ...
  sealed trait ShowHideMode
    extends StObject
       with SplitAppMode
  /* "ShowHideMode" */ val ShowHideMode: typingsJapgolly.openui5.sapMLibraryMod.SplitAppMode.ShowHideMode & String = js.native
  ...
  sealed trait StretchCompressMode
    extends StObject
       with SplitAppMode
  /* "StretchCompressMode" */ val StretchCompressMode: typingsJapgolly.openui5.sapMLibraryMod.SplitAppMode.StretchCompressMode & String = js.native
}
