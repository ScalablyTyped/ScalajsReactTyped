...
object PopinDisplay extends StObject {
  ...
  sealed trait Block
    extends StObject
       with PopinDisplay
  /* "Block" */ val Block: typingsJapgolly.openui5.sapMLibraryMod.PopinDisplay.Block & String = js.native
  ...
  sealed trait Inline
    extends StObject
       with PopinDisplay
  /* "Inline" */ val Inline: typingsJapgolly.openui5.sapMLibraryMod.PopinDisplay.Inline & String = js.native
  ...
  sealed trait WithoutHeader
    extends StObject
       with PopinDisplay
  /* "WithoutHeader" */ val WithoutHeader: typingsJapgolly.openui5.sapMLibraryMod.PopinDisplay.WithoutHeader & String = js.native
}
