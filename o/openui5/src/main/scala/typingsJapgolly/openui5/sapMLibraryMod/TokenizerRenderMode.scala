...
object TokenizerRenderMode extends StObject {
  ...
  /* "Loose" */ val Loose: typingsJapgolly.openui5.sapMLibraryMod.TokenizerRenderMode.Loose & String = js.native
  ...
  sealed trait Narrow
    extends StObject
       with TokenizerRenderMode
  /* "Narrow" */ val Narrow: typingsJapgolly.openui5.sapMLibraryMod.TokenizerRenderMode.Narrow & String = js.native
}
