...
object SwipeDirection extends StObject {
  ...
  sealed trait BeginToEnd
    extends StObject
       with SwipeDirection
  /* "BeginToEnd" */ val BeginToEnd: typingsJapgolly.openui5.sapMLibraryMod.SwipeDirection.BeginToEnd & String = js.native
  ...
  sealed trait Both
    extends StObject
       with SwipeDirection
  /* "Both" */ val Both: typingsJapgolly.openui5.sapMLibraryMod.SwipeDirection.Both & String = js.native
  ...
  sealed trait EndToBegin
    extends StObject
       with SwipeDirection
  /* "EndToBegin" */ val EndToBegin: typingsJapgolly.openui5.sapMLibraryMod.SwipeDirection.EndToBegin & String = js.native
  ...
  sealed trait LeftToRight
    extends StObject
       with SwipeDirection
  /* "LeftToRight" */ val LeftToRight: typingsJapgolly.openui5.sapMLibraryMod.SwipeDirection.LeftToRight & String = js.native
  ...
  sealed trait RightToLeft
    extends StObject
       with SwipeDirection
  /* "RightToLeft" */ val RightToLeft: typingsJapgolly.openui5.sapMLibraryMod.SwipeDirection.RightToLeft & String = js.native
}
