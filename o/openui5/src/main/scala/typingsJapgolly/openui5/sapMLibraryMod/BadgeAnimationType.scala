...
object BadgeAnimationType extends StObject {
  ...
  /* "Full" */ val Full: typingsJapgolly.openui5.sapMLibraryMod.BadgeAnimationType.Full & String = js.native
  ...
  sealed trait None
    extends StObject
       with BadgeAnimationType
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.BadgeAnimationType.None & String = js.native
  ...
  sealed trait Update
    extends StObject
       with BadgeAnimationType
  /* "Update" */ val Update: typingsJapgolly.openui5.sapMLibraryMod.BadgeAnimationType.Update & String = js.native
}
