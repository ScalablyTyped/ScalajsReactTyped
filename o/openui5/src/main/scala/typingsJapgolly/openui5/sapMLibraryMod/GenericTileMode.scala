...
object GenericTileMode extends StObject {
  ...
  /* "ActionMode" */ val ActionMode: typingsJapgolly.openui5.sapMLibraryMod.GenericTileMode.ActionMode & String = js.native
  ...
  sealed trait ArticleMode
    extends StObject
       with GenericTileMode
  /* "ArticleMode" */ val ArticleMode: typingsJapgolly.openui5.sapMLibraryMod.GenericTileMode.ArticleMode & String = js.native
  ...
  sealed trait ContentMode
    extends StObject
       with GenericTileMode
  /* "ContentMode" */ val ContentMode: typingsJapgolly.openui5.sapMLibraryMod.GenericTileMode.ContentMode & String = js.native
  ...
  sealed trait HeaderMode
    extends StObject
       with GenericTileMode
  /* "HeaderMode" */ val HeaderMode: typingsJapgolly.openui5.sapMLibraryMod.GenericTileMode.HeaderMode & String = js.native
  ...
  sealed trait IconMode
    extends StObject
       with GenericTileMode
  /* "IconMode" */ val IconMode: typingsJapgolly.openui5.sapMLibraryMod.GenericTileMode.IconMode & String = js.native
  ...
  sealed trait LineMode
    extends StObject
       with GenericTileMode
  /* "LineMode" */ val LineMode: typingsJapgolly.openui5.sapMLibraryMod.GenericTileMode.LineMode & String = js.native
}
