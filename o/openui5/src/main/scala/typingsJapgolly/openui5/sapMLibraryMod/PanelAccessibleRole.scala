...
object PanelAccessibleRole extends StObject {
  ...
  /* "Complementary" */ val Complementary: typingsJapgolly.openui5.sapMLibraryMod.PanelAccessibleRole.Complementary & String = js.native
  ...
  sealed trait Form
    extends StObject
       with PanelAccessibleRole
  /* "Form" */ val Form: typingsJapgolly.openui5.sapMLibraryMod.PanelAccessibleRole.Form & String = js.native
  ...
  sealed trait Region
    extends StObject
       with PanelAccessibleRole
  /* "Region" */ val Region: typingsJapgolly.openui5.sapMLibraryMod.PanelAccessibleRole.Region & String = js.native
}
