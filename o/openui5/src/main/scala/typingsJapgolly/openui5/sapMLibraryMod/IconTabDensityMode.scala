...
object IconTabDensityMode extends StObject {
  ...
  /* "Compact" */ val Compact: typingsJapgolly.openui5.sapMLibraryMod.IconTabDensityMode.Compact & String = js.native
  ...
  sealed trait Cozy
    extends StObject
       with IconTabDensityMode
  /* "Cozy" */ val Cozy: typingsJapgolly.openui5.sapMLibraryMod.IconTabDensityMode.Cozy & String = js.native
  ...
  sealed trait Inherit
    extends StObject
       with IconTabDensityMode
  /* "Inherit" */ val Inherit: typingsJapgolly.openui5.sapMLibraryMod.IconTabDensityMode.Inherit & String = js.native
}
