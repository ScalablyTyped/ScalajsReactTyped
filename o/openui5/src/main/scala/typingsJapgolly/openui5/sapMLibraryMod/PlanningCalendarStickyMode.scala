...
object PlanningCalendarStickyMode extends StObject {
  ...
  /* "All" */ val All: typingsJapgolly.openui5.sapMLibraryMod.PlanningCalendarStickyMode.All & String = js.native
  ...
  sealed trait NavBarAndColHeaders
    extends StObject
       with PlanningCalendarStickyMode
  /* "NavBarAndColHeaders" */ val NavBarAndColHeaders: typingsJapgolly.openui5.sapMLibraryMod.PlanningCalendarStickyMode.NavBarAndColHeaders & String = js.native
  ...
  sealed trait None
    extends StObject
       with PlanningCalendarStickyMode
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.PlanningCalendarStickyMode.None & String = js.native
}
