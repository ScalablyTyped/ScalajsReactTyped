...
object TileSizeBehavior extends StObject {
  ...
  /* "Responsive" */ val Responsive: typingsJapgolly.openui5.sapMLibraryMod.TileSizeBehavior.Responsive & String = js.native
  ...
  sealed trait Small
    extends StObject
       with TileSizeBehavior
  /* "Small" */ val Small: typingsJapgolly.openui5.sapMLibraryMod.TileSizeBehavior.Small & String = js.native
}
