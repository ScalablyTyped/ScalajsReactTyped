...
object ListSeparators extends StObject {
  ...
  sealed trait All
    extends StObject
       with ListSeparators
  /* "All" */ val All: typingsJapgolly.openui5.sapMLibraryMod.ListSeparators.All & String = js.native
  ...
  sealed trait Inner
    extends StObject
       with ListSeparators
  /* "Inner" */ val Inner: typingsJapgolly.openui5.sapMLibraryMod.ListSeparators.Inner & String = js.native
  ...
  sealed trait None
    extends StObject
       with ListSeparators
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.ListSeparators.None & String = js.native
}
