...
object IBarHTMLTag extends StObject {
  ...
  sealed trait Div
    extends StObject
       with IBarHTMLTag
  /* "Div" */ val Div: typingsJapgolly.openui5.sapMLibraryMod.IBarHTMLTag.Div & String = js.native
  ...
  sealed trait Footer
    extends StObject
       with IBarHTMLTag
  /* "Footer" */ val Footer: typingsJapgolly.openui5.sapMLibraryMod.IBarHTMLTag.Footer & String = js.native
  ...
  sealed trait Header
    extends StObject
       with IBarHTMLTag
  /* "Header" */ val Header: typingsJapgolly.openui5.sapMLibraryMod.IBarHTMLTag.Header & String = js.native
}
