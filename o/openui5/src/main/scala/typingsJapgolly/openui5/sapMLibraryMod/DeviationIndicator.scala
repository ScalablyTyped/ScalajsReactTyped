...
object DeviationIndicator extends StObject {
  ...
  /* "Down" */ val Down: typingsJapgolly.openui5.sapMLibraryMod.DeviationIndicator.Down & String = js.native
  ...
  sealed trait None
    extends StObject
       with DeviationIndicator
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.DeviationIndicator.None & String = js.native
  ...
  sealed trait Up
    extends StObject
       with DeviationIndicator
  /* "Up" */ val Up: typingsJapgolly.openui5.sapMLibraryMod.DeviationIndicator.Up & String = js.native
}
