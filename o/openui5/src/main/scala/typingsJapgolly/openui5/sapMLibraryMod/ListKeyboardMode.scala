...
object ListKeyboardMode extends StObject {
  ...
  /* "Edit" */ val Edit: typingsJapgolly.openui5.sapMLibraryMod.ListKeyboardMode.Edit & String = js.native
  ...
  sealed trait Navigation
    extends StObject
       with ListKeyboardMode
  /* "Navigation" */ val Navigation: typingsJapgolly.openui5.sapMLibraryMod.ListKeyboardMode.Navigation & String = js.native
}
