...
object ListType extends StObject {
  ...
  sealed trait Active
    extends StObject
       with ListType
  /* "Active" */ val Active: typingsJapgolly.openui5.sapMLibraryMod.ListType.Active & String = js.native
  ...
  sealed trait Detail
    extends StObject
       with ListType
  /* "Detail" */ val Detail: typingsJapgolly.openui5.sapMLibraryMod.ListType.Detail & String = js.native
  ...
  sealed trait DetailAndActive
    extends StObject
       with ListType
  /* "DetailAndActive" */ val DetailAndActive: typingsJapgolly.openui5.sapMLibraryMod.ListType.DetailAndActive & String = js.native
  ...
  sealed trait Inactive
    extends StObject
       with ListType
  /* "Inactive" */ val Inactive: typingsJapgolly.openui5.sapMLibraryMod.ListType.Inactive & String = js.native
  ...
  sealed trait Navigation
    extends StObject
       with ListType
  /* "Navigation" */ val Navigation: typingsJapgolly.openui5.sapMLibraryMod.ListType.Navigation & String = js.native
}
