...
object StringFilterOperator extends StObject {
  ...
  /* "AnyWordStartsWith" */ val AnyWordStartsWith: typingsJapgolly.openui5.sapMLibraryMod.StringFilterOperator.AnyWordStartsWith & String = js.native
  ...
  sealed trait Contains
    extends StObject
       with StringFilterOperator
  /* "Contains" */ val Contains: typingsJapgolly.openui5.sapMLibraryMod.StringFilterOperator.Contains & String = js.native
  ...
  sealed trait Equals
    extends StObject
       with StringFilterOperator
  /* "Equals" */ val Equals: typingsJapgolly.openui5.sapMLibraryMod.StringFilterOperator.Equals & String = js.native
  ...
  sealed trait StartsWith
    extends StObject
       with StringFilterOperator
  /* "StartsWith" */ val StartsWith: typingsJapgolly.openui5.sapMLibraryMod.StringFilterOperator.StartsWith & String = js.native
}
