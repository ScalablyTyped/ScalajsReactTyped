...
object TitleAlignment extends StObject {
  ...
  sealed trait Auto
    extends StObject
       with TitleAlignment
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapMLibraryMod.TitleAlignment.Auto & String = js.native
  ...
  sealed trait Center
    extends StObject
       with TitleAlignment
  /* "Center" */ val Center: typingsJapgolly.openui5.sapMLibraryMod.TitleAlignment.Center & String = js.native
  ...
  sealed trait None
    extends StObject
       with TitleAlignment
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.TitleAlignment.None & String = js.native
  ...
  sealed trait Start
    extends StObject
       with TitleAlignment
  /* "Start" */ val Start: typingsJapgolly.openui5.sapMLibraryMod.TitleAlignment.Start & String = js.native
}
