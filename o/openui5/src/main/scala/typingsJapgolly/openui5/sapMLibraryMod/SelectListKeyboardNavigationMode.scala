...
object SelectListKeyboardNavigationMode extends StObject {
  ...
  /* "Delimited" */ val Delimited: typingsJapgolly.openui5.sapMLibraryMod.SelectListKeyboardNavigationMode.Delimited & String = js.native
  ...
  sealed trait None
    extends StObject
       with SelectListKeyboardNavigationMode
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.SelectListKeyboardNavigationMode.None & String = js.native
}
