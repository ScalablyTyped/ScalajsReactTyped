...
object FlexAlignSelf extends StObject {
  ...
  sealed trait Auto
    extends StObject
       with FlexAlignSelf
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignSelf.Auto & String = js.native
  ...
  sealed trait Baseline
    extends StObject
       with FlexAlignSelf
  /* "Baseline" */ val Baseline: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignSelf.Baseline & String = js.native
  ...
  sealed trait Center
    extends StObject
       with FlexAlignSelf
  /* "Center" */ val Center: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignSelf.Center & String = js.native
  ...
  sealed trait End
    extends StObject
       with FlexAlignSelf
  /* "End" */ val End: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignSelf.End & String = js.native
  ...
  sealed trait Inherit
    extends StObject
       with FlexAlignSelf
  /* "Inherit" */ val Inherit: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignSelf.Inherit & String = js.native
  ...
  sealed trait Start
    extends StObject
       with FlexAlignSelf
  /* "Start" */ val Start: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignSelf.Start & String = js.native
  ...
  sealed trait Stretch
    extends StObject
       with FlexAlignSelf
  /* "Stretch" */ val Stretch: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignSelf.Stretch & String = js.native
}
