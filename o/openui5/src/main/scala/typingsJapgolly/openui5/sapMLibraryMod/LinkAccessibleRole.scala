...
object LinkAccessibleRole extends StObject {
  ...
  /* "Button" */ val Button: typingsJapgolly.openui5.sapMLibraryMod.LinkAccessibleRole.Button & String = js.native
  ...
  sealed trait Default
    extends StObject
       with LinkAccessibleRole
  /* "Default" */ val Default: typingsJapgolly.openui5.sapMLibraryMod.LinkAccessibleRole.Default & String = js.native
}
