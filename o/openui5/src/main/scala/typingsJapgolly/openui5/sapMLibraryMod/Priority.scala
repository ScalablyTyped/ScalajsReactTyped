...
object Priority extends StObject {
  ...
  sealed trait High
    extends StObject
       with Priority
  /* "High" */ val High: typingsJapgolly.openui5.sapMLibraryMod.Priority.High & String = js.native
  ...
  sealed trait Low
    extends StObject
       with Priority
  /* "Low" */ val Low: typingsJapgolly.openui5.sapMLibraryMod.Priority.Low & String = js.native
  ...
  sealed trait Medium
    extends StObject
       with Priority
  /* "Medium" */ val Medium: typingsJapgolly.openui5.sapMLibraryMod.Priority.Medium & String = js.native
  ...
  sealed trait None
    extends StObject
       with Priority
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.Priority.None & String = js.native
  ...
  sealed trait VeryHigh
    extends StObject
       with Priority
  /* "VeryHigh" */ val VeryHigh: typingsJapgolly.openui5.sapMLibraryMod.Priority.VeryHigh & String = js.native
}
