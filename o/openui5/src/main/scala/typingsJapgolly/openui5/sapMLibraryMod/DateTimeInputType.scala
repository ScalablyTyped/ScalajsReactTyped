...
object DateTimeInputType extends StObject {
  ...
  /* "Date" */ val Date: typingsJapgolly.openui5.sapMLibraryMod.DateTimeInputType.Date & String = js.native
  ...
  sealed trait DateTime
    extends StObject
       with DateTimeInputType
  /* "DateTime" */ val DateTime: typingsJapgolly.openui5.sapMLibraryMod.DateTimeInputType.DateTime & String = js.native
  ...
  sealed trait Time
    extends StObject
       with DateTimeInputType
  /* "Time" */ val Time: typingsJapgolly.openui5.sapMLibraryMod.DateTimeInputType.Time & String = js.native
}
