...
object ListGrowingDirection extends StObject {
  ...
  /* "Downwards" */ val Downwards: typingsJapgolly.openui5.sapMLibraryMod.ListGrowingDirection.Downwards & String = js.native
  ...
  sealed trait Upwards
    extends StObject
       with ListGrowingDirection
  /* "Upwards" */ val Upwards: typingsJapgolly.openui5.sapMLibraryMod.ListGrowingDirection.Upwards & String = js.native
}
