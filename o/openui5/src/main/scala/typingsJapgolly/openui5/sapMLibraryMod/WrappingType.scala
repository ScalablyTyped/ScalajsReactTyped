...
object WrappingType extends StObject {
  ...
  sealed trait Hyphenated
    extends StObject
       with WrappingType
  /* "Hyphenated" */ val Hyphenated: typingsJapgolly.openui5.sapMLibraryMod.WrappingType.Hyphenated & String = js.native
  ...
  sealed trait Normal
    extends StObject
       with WrappingType
  /* "Normal" */ val Normal: typingsJapgolly.openui5.sapMLibraryMod.WrappingType.Normal & String = js.native
}
