...
object ToolbarStyle extends StObject {
  ...
  sealed trait Clear
    extends StObject
       with ToolbarStyle
  /* "Clear" */ val Clear: typingsJapgolly.openui5.sapMLibraryMod.ToolbarStyle.Clear & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with ToolbarStyle
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapMLibraryMod.ToolbarStyle.Standard & String = js.native
}
