...
object LinkConversion extends StObject {
  ...
  sealed trait All
    extends StObject
       with LinkConversion
  /* "All" */ val All: typingsJapgolly.openui5.sapMLibraryMod.LinkConversion.All & String = js.native
  ...
  sealed trait None
    extends StObject
       with LinkConversion
  /* "None" */ val None: typingsJapgolly.openui5.sapMLibraryMod.LinkConversion.None & String = js.native
  ...
  sealed trait ProtocolOnly
    extends StObject
       with LinkConversion
  /* "ProtocolOnly" */ val ProtocolOnly: typingsJapgolly.openui5.sapMLibraryMod.LinkConversion.ProtocolOnly & String = js.native
}
