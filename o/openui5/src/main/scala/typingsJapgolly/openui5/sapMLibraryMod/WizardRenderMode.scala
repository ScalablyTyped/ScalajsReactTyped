...
object WizardRenderMode extends StObject {
  ...
  /* "Page" */ val Page: typingsJapgolly.openui5.sapMLibraryMod.WizardRenderMode.Page & String = js.native
  ...
  sealed trait Scroll
    extends StObject
       with WizardRenderMode
  /* "Scroll" */ val Scroll: typingsJapgolly.openui5.sapMLibraryMod.WizardRenderMode.Scroll & String = js.native
}
