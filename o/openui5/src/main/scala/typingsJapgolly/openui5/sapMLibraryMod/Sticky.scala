...
object Sticky extends StObject {
  ...
  sealed trait ColumnHeaders
    extends StObject
       with Sticky
  /* "ColumnHeaders" */ val ColumnHeaders: typingsJapgolly.openui5.sapMLibraryMod.Sticky.ColumnHeaders & String = js.native
  ...
  sealed trait HeaderToolbar
    extends StObject
       with Sticky
  /* "HeaderToolbar" */ val HeaderToolbar: typingsJapgolly.openui5.sapMLibraryMod.Sticky.HeaderToolbar & String = js.native
  ...
  sealed trait InfoToolbar
    extends StObject
       with Sticky
  /* "InfoToolbar" */ val InfoToolbar: typingsJapgolly.openui5.sapMLibraryMod.Sticky.InfoToolbar & String = js.native
}
