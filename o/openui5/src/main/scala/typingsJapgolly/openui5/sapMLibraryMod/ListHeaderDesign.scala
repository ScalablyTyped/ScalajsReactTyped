...
object ListHeaderDesign extends StObject {
  ...
  /* "Plain" */ val Plain: typingsJapgolly.openui5.sapMLibraryMod.ListHeaderDesign.Plain & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with ListHeaderDesign
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapMLibraryMod.ListHeaderDesign.Standard & String = js.native
}
