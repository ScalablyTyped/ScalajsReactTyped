...
object SelectType extends StObject {
  ...
  sealed trait Default
    extends StObject
       with SelectType
  /* "Default" */ val Default: typingsJapgolly.openui5.sapMLibraryMod.SelectType.Default & String = js.native
  ...
  sealed trait IconOnly
    extends StObject
       with SelectType
  /* "IconOnly" */ val IconOnly: typingsJapgolly.openui5.sapMLibraryMod.SelectType.IconOnly & String = js.native
}
