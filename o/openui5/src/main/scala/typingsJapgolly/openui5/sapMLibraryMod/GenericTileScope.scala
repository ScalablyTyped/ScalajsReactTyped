...
object GenericTileScope extends StObject {
  ...
  /* "ActionMore" */ val ActionMore: typingsJapgolly.openui5.sapMLibraryMod.GenericTileScope.ActionMore & String = js.native
  ...
  sealed trait ActionRemove
    extends StObject
       with GenericTileScope
  /* "ActionRemove" */ val ActionRemove: typingsJapgolly.openui5.sapMLibraryMod.GenericTileScope.ActionRemove & String = js.native
  ...
  sealed trait Actions
    extends StObject
       with GenericTileScope
  /* "Actions" */ val Actions: typingsJapgolly.openui5.sapMLibraryMod.GenericTileScope.Actions & String = js.native
  ...
  sealed trait Display
    extends StObject
       with GenericTileScope
  /* "Display" */ val Display: typingsJapgolly.openui5.sapMLibraryMod.GenericTileScope.Display & String = js.native
}
