...
object MenuButtonMode extends StObject {
  ...
  sealed trait Regular
    extends StObject
       with MenuButtonMode
  /* "Regular" */ val Regular: typingsJapgolly.openui5.sapMLibraryMod.MenuButtonMode.Regular & String = js.native
  ...
  sealed trait Split
    extends StObject
       with MenuButtonMode
  /* "Split" */ val Split: typingsJapgolly.openui5.sapMLibraryMod.MenuButtonMode.Split & String = js.native
}
