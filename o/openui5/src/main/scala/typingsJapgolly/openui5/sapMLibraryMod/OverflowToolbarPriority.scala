...
object OverflowToolbarPriority extends StObject {
  ...
  /* "Always" */ val Always: typingsJapgolly.openui5.sapMLibraryMod.OverflowToolbarPriority.Always & String = js.native
  ...
  sealed trait AlwaysOverflow
    extends StObject
       with OverflowToolbarPriority
  /* "AlwaysOverflow" */ val AlwaysOverflow: typingsJapgolly.openui5.sapMLibraryMod.OverflowToolbarPriority.AlwaysOverflow & String = js.native
  ...
  sealed trait Disappear
    extends StObject
       with OverflowToolbarPriority
  /* "Disappear" */ val Disappear: typingsJapgolly.openui5.sapMLibraryMod.OverflowToolbarPriority.Disappear & String = js.native
  ...
  sealed trait High
    extends StObject
       with OverflowToolbarPriority
  /* "High" */ val High: typingsJapgolly.openui5.sapMLibraryMod.OverflowToolbarPriority.High & String = js.native
  ...
  sealed trait Low
    extends StObject
       with OverflowToolbarPriority
  /* "Low" */ val Low: typingsJapgolly.openui5.sapMLibraryMod.OverflowToolbarPriority.Low & String = js.native
  ...
  sealed trait Never
    extends StObject
       with OverflowToolbarPriority
  /* "Never" */ val Never: typingsJapgolly.openui5.sapMLibraryMod.OverflowToolbarPriority.Never & String = js.native
  ...
  sealed trait NeverOverflow
    extends StObject
       with OverflowToolbarPriority
  /* "NeverOverflow" */ val NeverOverflow: typingsJapgolly.openui5.sapMLibraryMod.OverflowToolbarPriority.NeverOverflow & String = js.native
}
