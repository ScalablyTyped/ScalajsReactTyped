...
object EmptyIndicatorMode extends StObject {
  ...
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapMLibraryMod.EmptyIndicatorMode.Auto & String = js.native
  ...
  sealed trait Off
    extends StObject
       with EmptyIndicatorMode
  /* "Off" */ val Off: typingsJapgolly.openui5.sapMLibraryMod.EmptyIndicatorMode.Off & String = js.native
  ...
  sealed trait On
    extends StObject
       with EmptyIndicatorMode
  /* "On" */ val On: typingsJapgolly.openui5.sapMLibraryMod.EmptyIndicatorMode.On & String = js.native
}
