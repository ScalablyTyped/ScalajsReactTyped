...
object FlexAlignItems extends StObject {
  ...
  sealed trait Baseline
    extends StObject
       with FlexAlignItems
  /* "Baseline" */ val Baseline: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignItems.Baseline & String = js.native
  ...
  sealed trait Center
    extends StObject
       with FlexAlignItems
  /* "Center" */ val Center: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignItems.Center & String = js.native
  ...
  sealed trait End
    extends StObject
       with FlexAlignItems
  /* "End" */ val End: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignItems.End & String = js.native
  ...
  sealed trait Inherit
    extends StObject
       with FlexAlignItems
  /* "Inherit" */ val Inherit: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignItems.Inherit & String = js.native
  ...
  sealed trait Start
    extends StObject
       with FlexAlignItems
  /* "Start" */ val Start: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignItems.Start & String = js.native
  ...
  sealed trait Stretch
    extends StObject
       with FlexAlignItems
  /* "Stretch" */ val Stretch: typingsJapgolly.openui5.sapMLibraryMod.FlexAlignItems.Stretch & String = js.native
}
