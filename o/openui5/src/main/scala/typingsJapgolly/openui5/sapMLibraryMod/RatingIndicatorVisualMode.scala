...
object RatingIndicatorVisualMode extends StObject {
  ...
  /* "Full" */ val Full: typingsJapgolly.openui5.sapMLibraryMod.RatingIndicatorVisualMode.Full & String = js.native
  ...
  sealed trait Half
    extends StObject
       with RatingIndicatorVisualMode
  /* "Half" */ val Half: typingsJapgolly.openui5.sapMLibraryMod.RatingIndicatorVisualMode.Half & String = js.native
}
