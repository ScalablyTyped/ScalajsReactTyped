...
object ResetAllMode extends StObject {
  ...
  sealed trait Default
    extends StObject
       with ResetAllMode
  /* "Default" */ val Default: typingsJapgolly.openui5.sapMLibraryMod.ResetAllMode.Default & String = js.native
  ...
  sealed trait ServiceDefault
    extends StObject
       with ResetAllMode
  /* "ServiceDefault" */ val ServiceDefault: typingsJapgolly.openui5.sapMLibraryMod.ResetAllMode.ServiceDefault & String = js.native
  ...
  sealed trait ServiceReset
    extends StObject
       with ResetAllMode
  /* "ServiceReset" */ val ServiceReset: typingsJapgolly.openui5.sapMLibraryMod.ResetAllMode.ServiceReset & String = js.native
}
