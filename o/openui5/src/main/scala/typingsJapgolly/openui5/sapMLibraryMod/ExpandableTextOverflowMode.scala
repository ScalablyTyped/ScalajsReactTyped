...
object ExpandableTextOverflowMode extends StObject {
  ...
  /* "InPlace" */ val InPlace: typingsJapgolly.openui5.sapMLibraryMod.ExpandableTextOverflowMode.InPlace & String = js.native
  ...
  sealed trait Popover
    extends StObject
       with ExpandableTextOverflowMode
  /* "Popover" */ val Popover: typingsJapgolly.openui5.sapMLibraryMod.ExpandableTextOverflowMode.Popover & String = js.native
}
