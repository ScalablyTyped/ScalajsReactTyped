...
object DialogType extends StObject {
  ...
  sealed trait Message
    extends StObject
       with DialogType
  /* "Message" */ val Message: typingsJapgolly.openui5.sapMLibraryMod.DialogType.Message & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with DialogType
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapMLibraryMod.DialogType.Standard & String = js.native
}
