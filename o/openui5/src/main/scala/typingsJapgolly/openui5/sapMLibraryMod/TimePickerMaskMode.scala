...
object TimePickerMaskMode extends StObject {
  ...
  /* "Off" */ val Off: typingsJapgolly.openui5.sapMLibraryMod.TimePickerMaskMode.Off & String = js.native
  ...
  sealed trait On
    extends StObject
       with TimePickerMaskMode
  /* "On" */ val On: typingsJapgolly.openui5.sapMLibraryMod.TimePickerMaskMode.On & String = js.native
}
