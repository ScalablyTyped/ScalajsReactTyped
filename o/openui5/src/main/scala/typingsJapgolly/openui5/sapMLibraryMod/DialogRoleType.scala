...
object DialogRoleType extends StObject {
  ...
  sealed trait AlertDialog
    extends StObject
       with DialogRoleType
  /* "alertdialog" */ val AlertDialog: typingsJapgolly.openui5.sapMLibraryMod.DialogRoleType.AlertDialog & String = js.native
  ...
  sealed trait Dialog
    extends StObject
       with DialogRoleType
  /* "dialog" */ val Dialog: typingsJapgolly.openui5.sapMLibraryMod.DialogRoleType.Dialog & String = js.native
}
