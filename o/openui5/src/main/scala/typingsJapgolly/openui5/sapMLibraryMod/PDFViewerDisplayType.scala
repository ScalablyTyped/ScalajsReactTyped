...
object PDFViewerDisplayType extends StObject {
  ...
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapMLibraryMod.PDFViewerDisplayType.Auto & String = js.native
  ...
  sealed trait Embedded
    extends StObject
       with PDFViewerDisplayType
  /* "Embedded" */ val Embedded: typingsJapgolly.openui5.sapMLibraryMod.PDFViewerDisplayType.Embedded & String = js.native
  ...
  sealed trait Link
    extends StObject
       with PDFViewerDisplayType
  /* "Link" */ val Link: typingsJapgolly.openui5.sapMLibraryMod.PDFViewerDisplayType.Link & String = js.native
}
