...
object PlanningCalendarBuiltInView extends StObject {
  ...
  /* "Day" */ val Day: typingsJapgolly.openui5.sapMLibraryMod.PlanningCalendarBuiltInView.Day & String = js.native
  ...
  sealed trait Hour
    extends StObject
       with PlanningCalendarBuiltInView
  /* "Hour" */ val Hour: typingsJapgolly.openui5.sapMLibraryMod.PlanningCalendarBuiltInView.Hour & String = js.native
  ...
  sealed trait Month
    extends StObject
       with PlanningCalendarBuiltInView
  /* "Month" */ val Month: typingsJapgolly.openui5.sapMLibraryMod.PlanningCalendarBuiltInView.Month & String = js.native
  ...
  sealed trait OneMonth
    extends StObject
       with PlanningCalendarBuiltInView
  /* "One Month" */ val OneMonth: typingsJapgolly.openui5.sapMLibraryMod.PlanningCalendarBuiltInView.OneMonth & String = js.native
  ...
  sealed trait Week
    extends StObject
       with PlanningCalendarBuiltInView
  /* "Week" */ val Week: typingsJapgolly.openui5.sapMLibraryMod.PlanningCalendarBuiltInView.Week & String = js.native
}
