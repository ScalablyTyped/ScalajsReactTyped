...
object SelectionDetailsActionLevel extends StObject {
  ...
  /* "Group" */ val Group: typingsJapgolly.openui5.sapMLibraryMod.SelectionDetailsActionLevel.Group & String = js.native
  ...
  sealed trait Item
    extends StObject
       with SelectionDetailsActionLevel
  /* "Item" */ val Item: typingsJapgolly.openui5.sapMLibraryMod.SelectionDetailsActionLevel.Item & String = js.native
  ...
  sealed trait List
    extends StObject
       with SelectionDetailsActionLevel
  /* "List" */ val List: typingsJapgolly.openui5.sapMLibraryMod.SelectionDetailsActionLevel.List & String = js.native
}
