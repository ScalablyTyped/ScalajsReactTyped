...
import typingsJapgolly.openui5.anon.PoppedColumns
import typingsJapgolly.openui5.anon.PreviouslySelectedRows
import typingsJapgolly.openui5.anon.Row
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ITableColumn
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ITableRow
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableGrowingMode
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TableMode
...
object sapUiWebcMainTableMod {
  ...
  object TableSettings {
    ...
    extension [Self <: TableSettings](x: Self) {
      ...
      inline def setLoadMore(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "loadMore", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setPopinChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "popinChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setPopinChangeUndefined: Self = StObject.set(x, "popinChange", js.undefined)
      
      inline def setRowClick(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "rowClick", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
