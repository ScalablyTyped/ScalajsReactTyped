...
object sapUiCommonsComboBoxMod {
  ...
  trait ComboBox
    ...
    def setListBox(
      ...
      */
    oListBox: typingsJapgolly.openui5.sapUiCommonsListBoxMod.default
    ): this.type = js.native
    /**
  ...
  trait ComboBoxSettings
    ...
    /**
      ...
      */
    var listBox: js.UndefOr[typingsJapgolly.openui5.sapUiCommonsListBoxMod.default | String] = js.undefined
  ...
  object ComboBoxSettings {
    ...
    extension [Self <: ComboBoxSettings](x: Self) {
      ...
      inline def setListBox(value: typingsJapgolly.openui5.sapUiCommonsListBoxMod.default | String): Self = StObject.set(x, "listBox", value.asInstanceOf[js.Any])
