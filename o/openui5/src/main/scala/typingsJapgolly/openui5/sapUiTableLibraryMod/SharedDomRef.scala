...
object SharedDomRef extends StObject {
  ...
  sealed trait HorizontalScrollBar
    extends StObject
       with SharedDomRef
  /* "hsb" */ val HorizontalScrollBar: typingsJapgolly.openui5.sapUiTableLibraryMod.SharedDomRef.HorizontalScrollBar & String = js.native
  ...
  sealed trait VerticalScrollBar
    extends StObject
       with SharedDomRef
  /* "vsb" */ val VerticalScrollBar: typingsJapgolly.openui5.sapUiTableLibraryMod.SharedDomRef.VerticalScrollBar & String = js.native
}
