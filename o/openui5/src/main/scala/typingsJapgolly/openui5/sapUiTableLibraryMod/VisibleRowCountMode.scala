...
object VisibleRowCountMode extends StObject {
  ...
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapUiTableLibraryMod.VisibleRowCountMode.Auto & String = js.native
  ...
  sealed trait Fixed
    extends StObject
       with VisibleRowCountMode
  /* "Fixed" */ val Fixed: typingsJapgolly.openui5.sapUiTableLibraryMod.VisibleRowCountMode.Fixed & String = js.native
  ...
  sealed trait Interactive
    extends StObject
       with VisibleRowCountMode
  /* "Interactive" */ val Interactive: typingsJapgolly.openui5.sapUiTableLibraryMod.VisibleRowCountMode.Interactive & String = js.native
}
