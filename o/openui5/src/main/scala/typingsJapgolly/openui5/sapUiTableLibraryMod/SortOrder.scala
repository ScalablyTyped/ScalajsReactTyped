...
object SortOrder extends StObject {
  ...
  sealed trait Ascending
    extends StObject
       with SortOrder
  /* "Ascending" */ val Ascending: typingsJapgolly.openui5.sapUiTableLibraryMod.SortOrder.Ascending & String = js.native
  ...
  sealed trait Descending
    extends StObject
       with SortOrder
  /* "Descending" */ val Descending: typingsJapgolly.openui5.sapUiTableLibraryMod.SortOrder.Descending & String = js.native
}
