...
object NavigationMode extends StObject {
  ...
  sealed trait Paginator
    extends StObject
       with NavigationMode
  /* "Paginator" */ val Paginator: typingsJapgolly.openui5.sapUiTableLibraryMod.NavigationMode.Paginator & String = js.native
  ...
  sealed trait Scrollbar
    extends StObject
       with NavigationMode
  /* "Scrollbar" */ val Scrollbar: typingsJapgolly.openui5.sapUiTableLibraryMod.NavigationMode.Scrollbar & String = js.native
}
