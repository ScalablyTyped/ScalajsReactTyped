...
object SelectionBehavior extends StObject {
  ...
  /* "Row" */ val Row: typingsJapgolly.openui5.sapUiTableLibraryMod.SelectionBehavior.Row & String = js.native
  ...
  sealed trait RowOnly
    extends StObject
       with SelectionBehavior
  /* "RowOnly" */ val RowOnly: typingsJapgolly.openui5.sapUiTableLibraryMod.SelectionBehavior.RowOnly & String = js.native
  ...
  sealed trait RowSelector
    extends StObject
       with SelectionBehavior
  /* "RowSelector" */ val RowSelector: typingsJapgolly.openui5.sapUiTableLibraryMod.SelectionBehavior.RowSelector & String = js.native
}
