...
object sapMSlideTileMod {
  ...
  trait SlideTile
    ...
    def addTile(
      ...
      */
    oTile: typingsJapgolly.openui5.sapMGenericTileMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getTiles(): js.Array[typingsJapgolly.openui5.sapMGenericTileMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllTiles(): js.Array[typingsJapgolly.openui5.sapMGenericTileMod.default] = js.native
    
    def removeTile(/**
      * The tile to remove or its index or id
      */
    vTile: String): typingsJapgolly.openui5.sapMGenericTileMod.default | Null = js.native
    /**
    ...
    def removeTile(/**
      * The tile to remove or its index or id
      */
    vTile: int): typingsJapgolly.openui5.sapMGenericTileMod.default | Null = js.native
    def removeTile(
      /**
      * The tile to remove or its index or id
      */
    vTile: typingsJapgolly.openui5.sapMGenericTileMod.default
    ): typingsJapgolly.openui5.sapMGenericTileMod.default | Null = js.native
  ...
  trait SlideTileSettings
    ...
    var tiles: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMGenericTileMod.default] | typingsJapgolly.openui5.sapMGenericTileMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object SlideTileSettings {
    ...
    extension [Self <: SlideTileSettings](x: Self) {
      ...
      inline def setTiles(
        value: js.Array[typingsJapgolly.openui5.sapMGenericTileMod.default] | typingsJapgolly.openui5.sapMGenericTileMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "tiles", value.asInstanceOf[js.Any])
      
      inline def setTilesUndefined: Self = StObject.set(x, "tiles", js.undefined)
      
      inline def setTilesVarargs(value: typingsJapgolly.openui5.sapMGenericTileMod.default*): Self = StObject.set(x, "tiles", js.Array(value*))
