...
import typingsJapgolly.openui5.sapMLibraryMod.ListType
...
object sapMListItemBaseMod {
  ...
  object ListItemBaseSettings {
    ...
    extension [Self <: ListItemBaseSettings](x: Self) {
      ...
      inline def setDetailPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "detailPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setDetailPressUndefined: Self = StObject.set(x, "detailPress", js.undefined)
      
      inline def setDetailTap(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "detailTap", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setTap(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "tap", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
