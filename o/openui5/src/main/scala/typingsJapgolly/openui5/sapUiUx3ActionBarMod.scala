...
object sapUiUx3ActionBarMod {
  ...
  trait ActionBar
    ...
    /**
      ...
      */
    def getBusinessActions(): js.Array[typingsJapgolly.openui5.sapUiUx3ThingActionMod.default] = js.native
    ...
    def indexOfBusinessAction(
      ...
      */
    oBusinessAction: typingsJapgolly.openui5.sapUiUx3ThingActionMod.default
    ): int = js.native
  ...
  object ActionBarSettings {
    ...
    extension [Self <: ActionBarSettings](x: Self) {
      ...
      inline def setBusinessActionsVarargs(value: typingsJapgolly.openui5.sapUiUx3ThingActionMod.default*): Self = StObject.set(x, "businessActions", js.Array(value*))
