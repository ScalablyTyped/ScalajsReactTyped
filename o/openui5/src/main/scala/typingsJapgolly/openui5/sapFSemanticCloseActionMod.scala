...
object sapFSemanticCloseActionMod {
  
  @JSImport("sap/f/semantic/CloseAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: CloseActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, CloseAction]
  ...
  type CloseAction = typingsJapgolly.openui5.sapFSemanticSemanticButtonMod.default
  
  type CloseActionSettings = SemanticButtonSettings
}
