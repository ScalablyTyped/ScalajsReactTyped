...
object sapUiWebcMainCardHeaderMod {
  ...
  trait CardHeader
    ...
    def addAvatar(
      ...
      */
    oAvatar: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getAction(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getAvatar(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllAction(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllAvatar(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeAvatar(/**
      * The avatar to remove or its index or id
      */
    vAvatar: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeAvatar(/**
      * The avatar to remove or its index or id
      */
    vAvatar: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeAvatar(
      /**
      * The avatar to remove or its index or id
      */
    vAvatar: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
  ...
  object CardHeaderSettings {
    ...
    extension [Self <: CardHeaderSettings](x: Self) {
      ...
      inline def setActionVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "action", js.Array(value*))
      ...
      inline def setAvatarVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "avatar", js.Array(value*))
