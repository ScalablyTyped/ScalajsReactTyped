...
import typingsJapgolly.openui5.anon.NewPosition
...
object sapMPagingButtonMod {
  ...
  object PagingButtonSettings {
    ...
    extension [Self <: PagingButtonSettings](x: Self) {
      ...
      inline def setPositionChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "positionChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
