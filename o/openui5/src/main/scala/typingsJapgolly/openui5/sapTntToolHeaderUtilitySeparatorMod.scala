...
object sapTntToolHeaderUtilitySeparatorMod {
  
  @JSImport("sap/tnt/ToolHeaderUtilitySeparator", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: ToolHeaderUtilitySeparatorSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ToolHeaderUtilitySeparator]
  ...
  type ToolHeaderUtilitySeparator = typingsJapgolly.openui5.sapUiCoreControlMod.default
  
  type ToolHeaderUtilitySeparatorSettings = ControlSettings
}
