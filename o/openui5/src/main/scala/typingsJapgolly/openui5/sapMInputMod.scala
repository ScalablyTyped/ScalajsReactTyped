...
import typingsJapgolly.openui5.anon.EscPressedPreviousValue
import typingsJapgolly.openui5.anon.FromSuggestions
import typingsJapgolly.openui5.anon.SelectedRow
import typingsJapgolly.openui5.anon.SuggestionColumns
import typingsJapgolly.openui5.anon.Value
import typingsJapgolly.openui5.jQuery.Event
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMInputBaseMod.InputBaseSettings
import typingsJapgolly.openui5.sapMLibraryMod.InputTextFormatMode
import typingsJapgolly.openui5.sapMLibraryMod.InputType
...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.IAccessKeySupport
...
object sapMInputMod {
  ...
  @js.native
  trait Input
    extends typingsJapgolly.openui5.sapMInputBaseMod.default
    ...
    def addSuggestionColumn(
      ...
      */
    oSuggestionColumn: typingsJapgolly.openui5.sapMColumnMod.default
    ): this.type = js.native
    ...
    def addSuggestionItem(/**
      * Suggestion item.
      */
    oItem: typingsJapgolly.openui5.sapUiCoreItemMod.default): this.type = js.native
    ...
    def addSuggestionRow(
      ...
      */
    vSuggestionRow: typingsJapgolly.openui5.sapMColumnListItemMod.default
    ): this.type = js.native
    def addSuggestionRow(
      /**
      * The suggestionRow to add; if empty, nothing is inserted
      */
    vSuggestionRow: typingsJapgolly.openui5.sapMGroupHeaderListItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getSuggestionColumns(): js.Array[typingsJapgolly.openui5.sapMColumnMod.default] = js.native
    ...
    def getSuggestionItemByKey(/**
      ...
      */
    sKey: String): typingsJapgolly.openui5.sapUiCoreItemMod.default = js.native
    ...
    /**
      ...
      */
    def getSuggestionItems(): js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default] = js.native
    ...
    def getSuggestionRows(): js.Array[
        typingsJapgolly.openui5.sapMColumnListItemMod.default | typingsJapgolly.openui5.sapMGroupHeaderListItemMod.default
      ] = js.native
    ...
    def indexOfSuggestionItem(
      ...
      */
    oSuggestionItem: typingsJapgolly.openui5.sapUiCoreItemMod.default
    ): int = js.native
    ...
    def insertSuggestionItem(
      ...
      * Suggestion item.
      */
    oItem: typingsJapgolly.openui5.sapUiCoreItemMod.default,
      /**
    ...
    /**
      ...
      */
    def removeAllSuggestionColumns(): js.Array[typingsJapgolly.openui5.sapMColumnMod.default] = js.native
    ...
    def removeSuggestionColumn(/**
      ...
      */
    vSuggestionColumn: String): typingsJapgolly.openui5.sapMColumnMod.default | Null = js.native
    /**
      * @SINCE 1.21.1
      *
    ...
    def removeSuggestionColumn(/**
      * The suggestionColumn to remove or its index or id
      */
    vSuggestionColumn: int): typingsJapgolly.openui5.sapMColumnMod.default | Null = js.native
    def removeSuggestionColumn(
      /**
      * The suggestionColumn to remove or its index or id
      */
    vSuggestionColumn: typingsJapgolly.openui5.sapMColumnMod.default
    ...
    def removeSuggestionItem(/**
      * Suggestion item.
      */
    oItem: typingsJapgolly.openui5.sapUiCoreItemMod.default): Boolean = js.native
    
    def removeSuggestionRow(/**
      * The suggestionRow to remove or its index or id
      */
    vSuggestionRow: String): typingsJapgolly.openui5.sapMColumnListItemMod.default | typingsJapgolly.openui5.sapMGroupHeaderListItemMod.default | Null = js.native
    /**
      * @SINCE 1.21.1
      *
    ...
    def removeSuggestionRow(/**
      * The suggestionRow to remove or its index or id
      */
    vSuggestionRow: int): typingsJapgolly.openui5.sapMColumnListItemMod.default | typingsJapgolly.openui5.sapMGroupHeaderListItemMod.default | Null = js.native
    def removeSuggestionRow(
      /**
      * The suggestionRow to remove or its index or id
      */
    vSuggestionRow: typingsJapgolly.openui5.sapMColumnListItemMod.default
    ): typingsJapgolly.openui5.sapMColumnListItemMod.default | typingsJapgolly.openui5.sapMGroupHeaderListItemMod.default | Null = js.native
    def removeSuggestionRow(
      /**
      * The suggestionRow to remove or its index or id
      */
    ...
    def setSelectedRow(
      ...
      */
    oListItem: typingsJapgolly.openui5.sapMColumnListItemMod.default
    ): this.type = js.native
  ...
  trait InputSettings
    ...
    /**
      ...
      */
    var selectedItem: js.UndefOr[typingsJapgolly.openui5.sapUiCoreItemMod.default | String] = js.undefined
    ...
    /**
      ...
      */
    var selectedRow: js.UndefOr[typingsJapgolly.openui5.sapMColumnListItemMod.default | String] = js.undefined
    ...
    var suggestionRows: js.UndefOr[
        (js.Array[
          typingsJapgolly.openui5.sapMGroupHeaderListItemMod.default | typingsJapgolly.openui5.sapMColumnListItemMod.default
        ]) | typingsJapgolly.openui5.sapMGroupHeaderListItemMod.default | typingsJapgolly.openui5.sapMColumnListItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object InputSettings {
    ...
    extension [Self <: InputSettings](x: Self) {
      ...
      inline def setSelectedItem(value: typingsJapgolly.openui5.sapUiCoreItemMod.default | String): Self = StObject.set(x, "selectedItem", value.asInstanceOf[js.Any])
      ...
      inline def setSelectedRow(value: typingsJapgolly.openui5.sapMColumnListItemMod.default | String): Self = StObject.set(x, "selectedRow", value.asInstanceOf[js.Any])
      ...
      inline def setSubmit(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "submit", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setSubmitUndefined: Self = StObject.set(x, "submit", js.undefined)
      
      inline def setSuggest(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "suggest", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setSuggestionColumnsVarargs(value: typingsJapgolly.openui5.sapMColumnMod.default*): Self = StObject.set(x, "suggestionColumns", js.Array(value*))
      
      inline def setSuggestionItemSelected(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "suggestionItemSelected", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setSuggestionItemsVarargs(value: typingsJapgolly.openui5.sapUiCoreItemMod.default*): Self = StObject.set(x, "suggestionItems", js.Array(value*))
      ...
      inline def setSuggestionRowsVarargs(
        value: (typingsJapgolly.openui5.sapMGroupHeaderListItemMod.default | typingsJapgolly.openui5.sapMColumnListItemMod.default)*
