...
import typingsJapgolly.openui5.sapMLibraryMod.semantic.IFilter
...
object sapMSemanticMasterPageMod {
  ...
  trait MasterPage
    ...
    /**
      ...
      * MultiSelect action
      */
    def getMultiSelectAction(): typingsJapgolly.openui5.sapMSemanticMultiSelectActionMod.default = js.native
    ...
    def setMultiSelectAction(
      ...
      */
    oMultiSelectAction: typingsJapgolly.openui5.sapMSemanticMultiSelectActionMod.default
    ): this.type = js.native
  ...
  trait MasterPageSettings
    ...
    /**
      * MultiSelect action
      */
    var multiSelectAction: js.UndefOr[typingsJapgolly.openui5.sapMSemanticMultiSelectActionMod.default] = js.undefined
  ...
  object MasterPageSettings {
    ...
    extension [Self <: MasterPageSettings](x: Self) {
      ...
      inline def setMultiSelectAction(value: typingsJapgolly.openui5.sapMSemanticMultiSelectActionMod.default): Self = StObject.set(x, "multiSelectAction", value.asInstanceOf[js.Any])
