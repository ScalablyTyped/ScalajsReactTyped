...
import typingsJapgolly.openui5.anon.AEntitySetsNames
import typingsJapgolly.openui5.anon.AutoRespond
...
object sapUiCoreUtilMockServerMod {
  ...
  object HTTPMETHOD extends StObject {
    ...
    sealed trait DELETE
      extends StObject
         with HTTPMETHOD
    /* "DELETE" */ val DELETE: typingsJapgolly.openui5.sapUiCoreUtilMockServerMod.HTTPMETHOD.DELETE & String = js.native
    
    @js.native
    sealed trait GET
      extends StObject
         with HTTPMETHOD
    /* "GET" */ val GET: typingsJapgolly.openui5.sapUiCoreUtilMockServerMod.HTTPMETHOD.GET & String = js.native
    
    @js.native
    sealed trait MERGE
      extends StObject
         with HTTPMETHOD
    /* "MERGE" */ val MERGE: typingsJapgolly.openui5.sapUiCoreUtilMockServerMod.HTTPMETHOD.MERGE & String = js.native
    
    @js.native
    sealed trait PATCH
      extends StObject
         with HTTPMETHOD
    /* "PATCH" */ val PATCH: typingsJapgolly.openui5.sapUiCoreUtilMockServerMod.HTTPMETHOD.PATCH & String = js.native
    
    @js.native
    sealed trait POST
      extends StObject
         with HTTPMETHOD
    /* "POST" */ val POST: typingsJapgolly.openui5.sapUiCoreUtilMockServerMod.HTTPMETHOD.POST & String = js.native
    
    @js.native
    sealed trait PUT
      extends StObject
         with HTTPMETHOD
    /* "PUT" */ val PUT: typingsJapgolly.openui5.sapUiCoreUtilMockServerMod.HTTPMETHOD.PUT & String = js.native
  }
  ...
  object RequestHandler {
    ...
    inline def apply(
      ...
      response: (Response, Any) => Callback
    ): RequestHandler = {
      val __obj = js.Dynamic.literal(method = method.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], response = js.Any.fromFunction2((t0: Response, t1: Any) => (response(t0, t1)).runNow()))
    ...
    extension [Self <: RequestHandler](x: Self) {
      ...
      inline def setResponse(value: (Response, Any) => Callback): Self = StObject.set(x, "response", js.Any.fromFunction2((t0: Response, t1: Any) => (value(t0, t1)).runNow()))
    }
  }
