...
object sapUiLayoutCssgridGridSettingsMod {
  
  @JSImport("sap/ui/layout/cssgrid/GridSettings", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends GridSettings {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: GridSettingsSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, GridSettings]
  ...
  object GridSettingsSettings {
    
    inline def apply(): GridSettingsSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[GridSettingsSettings]
    }
    
    extension [Self <: GridSettingsSettings](x: Self) {
