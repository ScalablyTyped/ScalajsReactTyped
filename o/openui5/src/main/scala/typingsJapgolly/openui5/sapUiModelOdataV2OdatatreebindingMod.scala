...
object sapUiModelOdataV2OdatatreebindingMod {
  ...
  trait ODataTreeBinding
    ...
    iLength: int,
      ...
      */
    iThreshold: int
    ): js.Array[typingsJapgolly.openui5.sapUiModelOdataV2ContextMod.default] = js.native
    ...
    /**
      ...
      */
    def getRootContexts(): js.Array[typingsJapgolly.openui5.sapUiModelOdataV2ContextMod.default] = js.native
    def getRootContexts(
      /**
      * The start index of the requested contexts
      */
    ...
    def getRootContexts(/**
      * The start index of the requested contexts
      */
    iStartIndex: int): js.Array[typingsJapgolly.openui5.sapUiModelOdataV2ContextMod.default] = js.native
    def getRootContexts(
      /**
      * The start index of the requested contexts
      */
