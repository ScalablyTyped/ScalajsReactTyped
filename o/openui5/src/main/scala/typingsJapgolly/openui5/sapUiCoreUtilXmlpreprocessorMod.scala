...
object sapUiCoreUtilXmlpreprocessorMod extends Shortcut {
  ...
  trait IContext extends StObject {
    ...
    /**
      ...
      */
    def getModel(): js.UndefOr[typingsJapgolly.openui5.sapUiModelModelMod.default] = js.native
    def getModel(
      /**
      * index of part in case of the root formatter of a composite binding (since 1.31.0)
      */
    iPart: Double
    ): js.UndefOr[typingsJapgolly.openui5.sapUiModelModelMod.default] = js.native
