...
import typingsJapgolly.openui5.sapUiUnifiedCalendarLegendMod.CalendarLegendSettings
...
object sapMPlanningCalendarLegendMod {
  ...
  trait PlanningCalendarLegend
    extends typingsJapgolly.openui5.sapUiUnifiedCalendarLegendMod.default {
    ...
    def addAppointmentItem(
      ...
      */
    oAppointmentItem: typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getAppointmentItems(): js.Array[typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllAppointmentItems(): js.Array[typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default] = js.native
    
    def removeAppointmentItem(/**
      * The appointmentItem to remove or its index or id
      */
    vAppointmentItem: String): typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default | Null = js.native
    /**
    ...
    def removeAppointmentItem(/**
      * The appointmentItem to remove or its index or id
      */
    vAppointmentItem: int): typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default | Null = js.native
    def removeAppointmentItem(
      /**
      * The appointmentItem to remove or its index or id
      */
    vAppointmentItem: typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default
    ): typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default | Null = js.native
  ...
  trait PlanningCalendarLegendSettings
    ...
    var appointmentItems: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default] | typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object PlanningCalendarLegendSettings {
    ...
    extension [Self <: PlanningCalendarLegendSettings](x: Self) {
      ...
      inline def setAppointmentItems(
        value: js.Array[typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default] | typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setAppointmentItemsVarargs(value: typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default*): Self = StObject.set(x, "appointmentItems", js.Array(value*))
