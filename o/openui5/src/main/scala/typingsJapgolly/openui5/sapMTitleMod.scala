...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.ITitleContent
...
object sapMTitleMod {
  ...
  trait Title
    ...
    def setTitle(
      ...
      * Given variant of the a title which can be `sap.m.Title` or `sap.ui.core.Title`.
      */
    vTitle: typingsJapgolly.openui5.sapUiCoreTitleMod.default
    ): this.type = js.native
  ...
  trait TitleSettings
    ...
    /**
      ...
      */
    var title: js.UndefOr[typingsJapgolly.openui5.sapUiCoreTitleMod.default | String] = js.undefined
  ...
  object TitleSettings {
    ...
    extension [Self <: TitleSettings](x: Self) {
      ...
      inline def setTitle(value: typingsJapgolly.openui5.sapUiCoreTitleMod.default | String): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
