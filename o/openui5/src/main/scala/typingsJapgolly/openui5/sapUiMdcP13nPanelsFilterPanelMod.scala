...
object sapUiMdcP13nPanelsFilterPanelMod {
  ...
  object FilterPanel {
    ...
    inline def apply(
      ...
      getItemFactory: CallbackTo[js.Function],
      hasOwnProperty: PropertyKey => Boolean,
      propertyIsEnumerable: PropertyKey => Boolean,
      setItemFactory: js.Function => FilterPanel
    ): FilterPanel = {
      val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any], getItemFactory = getItemFactory.toJsFn, hasOwnProperty = js.Any.fromFunction1(hasOwnProperty), propertyIsEnumerable = js.Any.fromFunction1(propertyIsEnumerable), setItemFactory = js.Any.fromFunction1(setItemFactory))
      __obj.asInstanceOf[FilterPanel]
    }
    
    extension [Self <: FilterPanel](x: Self) {
      
      inline def setGetItemFactory(value: CallbackTo[js.Function]): Self = StObject.set(x, "getItemFactory", value.toJsFn)
