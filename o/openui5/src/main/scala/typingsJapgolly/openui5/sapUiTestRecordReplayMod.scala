...
import typingsJapgolly.openui5.anon.ClearTextFirst
import typingsJapgolly.openui5.anon.DomElement
import typingsJapgolly.openui5.anon.Interval
import typingsJapgolly.openui5.anon.Selector
...
object sapUiTestRecordReplayMod {
  ...
  object InteractionType extends StObject {
    ...
    /* "ENTER_TEXT" */ val EnterText: typingsJapgolly.openui5.sapUiTestRecordReplayMod.InteractionType.EnterText & String = js.native
    
    @js.native
    sealed trait Press
      extends StObject
         with InteractionType
    /* "PRESS" */ val Press: typingsJapgolly.openui5.sapUiTestRecordReplayMod.InteractionType.Press & String = js.native
  }
  ...
  type RecordReplay = typingsJapgolly.openui5.sapUiBaseObjectMod.default
}
