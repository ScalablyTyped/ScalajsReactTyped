...
import typingsJapgolly.openui5.anon.AppointmentCalendarRow
import typingsJapgolly.openui5.anon.AppointmentEndDate
import typingsJapgolly.openui5.anon.CalendarRow
import typingsJapgolly.openui5.anon.Copy
...
object sapMPlanningCalendarRowMod {
  ...
  trait PlanningCalendarRow
    ...
    def addIntervalHeader(
      ...
      */
    oIntervalHeader: typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * **Note:** For performance reasons, only appointments in the visible time range or nearby should be assigned.
      */
    def getIntervalHeaders(): js.Array[typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllIntervalHeaders(): js.Array[typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default] = js.native
    ...
    def removeIntervalHeader(/**
      ...
      */
    vIntervalHeader: String): typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default | Null = js.native
    /**
    ...
    def removeIntervalHeader(/**
      * The intervalHeader to remove or its index or id
      */
    vIntervalHeader: int): typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default | Null = js.native
    def removeIntervalHeader(
      /**
      * The intervalHeader to remove or its index or id
      */
    vIntervalHeader: typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default
    ): typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default | Null = js.native
  ...
  object PlanningCalendarRowSettings {
    ...
    extension [Self <: PlanningCalendarRowSettings](x: Self) {
      ...
      inline def setAppointmentDragEnter(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "appointmentDragEnter", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setIntervalHeadersVarargs(value: typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default*): Self = StObject.set(x, "intervalHeaders", js.Array(value*))
