...
object sapMP13nGroupPanelMod_ {
  ...
  trait P13nGroupPanel
    ...
    def addGroupItem(
      ...
      */
    oGroupItem: typingsJapgolly.openui5.sapMP13nGroupItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * Defined group items.
      */
    def getGroupItems(): js.Array[typingsJapgolly.openui5.sapMP13nGroupItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllGroupItems(): js.Array[typingsJapgolly.openui5.sapMP13nGroupItemMod.default] = js.native
    
    def removeGroupItem(/**
      * The groupItem to remove or its index or id
      */
    vGroupItem: String): typingsJapgolly.openui5.sapMP13nGroupItemMod.default | Null = js.native
    /**
    ...
    def removeGroupItem(/**
      * The groupItem to remove or its index or id
      */
    vGroupItem: int): typingsJapgolly.openui5.sapMP13nGroupItemMod.default | Null = js.native
    def removeGroupItem(
      /**
      * The groupItem to remove or its index or id
      */
    vGroupItem: typingsJapgolly.openui5.sapMP13nGroupItemMod.default
    ): typingsJapgolly.openui5.sapMP13nGroupItemMod.default | Null = js.native
  ...
  trait P13nGroupPanelSettings
    ...
    var groupItems: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMP13nGroupItemMod.default] | typingsJapgolly.openui5.sapMP13nGroupItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object P13nGroupPanelSettings {
    ...
    extension [Self <: P13nGroupPanelSettings](x: Self) {
      ...
      inline def setAddGroupItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "addGroupItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setGroupItems(
        value: js.Array[typingsJapgolly.openui5.sapMP13nGroupItemMod.default] | typingsJapgolly.openui5.sapMP13nGroupItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setGroupItemsVarargs(value: typingsJapgolly.openui5.sapMP13nGroupItemMod.default*): Self = StObject.set(x, "groupItems", js.Array(value*))
      ...
      inline def setRemoveGroupItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "removeGroupItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setRemoveGroupItemUndefined: Self = StObject.set(x, "removeGroupItem", js.undefined)
      
      inline def setUpdateGroupItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "updateGroupItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
