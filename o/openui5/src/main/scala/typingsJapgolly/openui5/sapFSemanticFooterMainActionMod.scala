...
object sapFSemanticFooterMainActionMod {
  
  @JSImport("sap/f/semantic/FooterMainAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: FooterMainActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, FooterMainAction]
  ...
  type FooterMainAction = typingsJapgolly.openui5.sapFSemanticMainActionMod.default
  
  type FooterMainActionSettings = MainActionSettings
}
