...
import typingsJapgolly.openui5.anon.AllAttributes
...
object sapUiUx3ExactListMod {
  ...
  trait ExactList
    ...
    def setData(
      ...
      * may be given
      */
    oData: typingsJapgolly.openui5.sapUiUx3ExactAttributeMod.default
    ): this.type = js.native
  ...
  trait ExactListSettings
    ...
    /**
      ...
      */
    var data: js.UndefOr[typingsJapgolly.openui5.sapUiUx3ExactAttributeMod.default | String] = js.undefined
  ...
  object ExactListSettings {
    ...
    extension [Self <: ExactListSettings](x: Self) {
      
      inline def setAttributeSelected(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "attributeSelected", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setAttributeSelectedUndefined: Self = StObject.set(x, "attributeSelected", js.undefined)
      
      inline def setData(value: typingsJapgolly.openui5.sapUiUx3ExactAttributeMod.default | String): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
