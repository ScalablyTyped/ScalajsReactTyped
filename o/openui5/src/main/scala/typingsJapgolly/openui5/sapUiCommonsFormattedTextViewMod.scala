...
object sapUiCommonsFormattedTextViewMod {
  ...
  trait FormattedTextView
    ...
    /**
      ...
      */
    def getControls(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllControls(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeControl(/**
      * The control to remove or its index or id
      */
    vControl: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeControl(/**
      * The control to remove or its index or id
      */
    vControl: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeControl(
      /**
      * The control to remove or its index or id
      */
    vControl: typingsJapgolly.openui5.sapUiCoreControlMod.default
  ...
  object FormattedTextViewSettings {
    ...
    extension [Self <: FormattedTextViewSettings](x: Self) {
      ...
      inline def setControlsVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "controls", js.Array(value*))
