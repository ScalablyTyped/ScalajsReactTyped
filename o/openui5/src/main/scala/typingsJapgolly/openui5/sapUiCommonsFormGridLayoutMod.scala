...
object sapUiCommonsFormGridLayoutMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiLayoutFormGridLayoutMod.default {
    def this(/**
  ...
  type GridLayout = typingsJapgolly.openui5.sapUiLayoutFormGridLayoutMod.default
  
  type GridLayoutSettings = typingsJapgolly.openui5.sapUiLayoutFormGridLayoutMod.GridLayoutSettings
}
