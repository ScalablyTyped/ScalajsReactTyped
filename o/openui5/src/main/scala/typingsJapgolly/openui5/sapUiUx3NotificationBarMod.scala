...
import typingsJapgolly.openui5.anon.Show
import typingsJapgolly.openui5.anon.Status
...
import typingsJapgolly.openui5.sapUiUx3LibraryMod.NotificationBarStatus
...
object sapUiUx3NotificationBarMod {
  ...
  trait NotificationBar
    ...
    def addNotifier(
      ...
      */
    oNotifier: typingsJapgolly.openui5.sapUiCoreElementMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getMessageNotifier(): typingsJapgolly.openui5.sapUiCoreElementMod.default = js.native
    ...
    /**
      ...
      */
    def getNotifiers(): js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllNotifiers(): js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    
    def removeNotifier(/**
      * The notifier to remove or its index or id
      */
    vNotifier: String): typingsJapgolly.openui5.sapUiCoreElementMod.default | Null = js.native
    /**
    ...
    def removeNotifier(/**
      * The notifier to remove or its index or id
      */
    vNotifier: int): typingsJapgolly.openui5.sapUiCoreElementMod.default | Null = js.native
    def removeNotifier(
      /**
      * The notifier to remove or its index or id
      */
    vNotifier: typingsJapgolly.openui5.sapUiCoreElementMod.default
    ...
    def setMessageNotifier(
      ...
      */
    oMessageNotifier: typingsJapgolly.openui5.sapUiCoreElementMod.default
    ): this.type = js.native
  ...
  trait NotificationBarSettings
    ...
    /**
      * Notifier that shows messages
      */
    var messageNotifier: js.UndefOr[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.undefined
  ...
  object NotificationBarSettings {
    ...
    extension [Self <: NotificationBarSettings](x: Self) {
      ...
      inline def setDisplay(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "display", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setDisplayUndefined: Self = StObject.set(x, "display", js.undefined)
      
      inline def setMessageNotifier(value: typingsJapgolly.openui5.sapUiCoreElementMod.default): Self = StObject.set(x, "messageNotifier", value.asInstanceOf[js.Any])
      ...
      inline def setNotifiersVarargs(value: typingsJapgolly.openui5.sapUiCoreElementMod.default*): Self = StObject.set(x, "notifiers", js.Array(value*))
