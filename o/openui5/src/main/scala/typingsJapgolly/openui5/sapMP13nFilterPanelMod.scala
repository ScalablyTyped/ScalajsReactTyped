...
import typingsJapgolly.openui5.anon.ItemData
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.P13nConditionOperation
import typingsJapgolly.openui5.sapMP13nPanelMod.P13nPanelSettings
...
object sapMP13nFilterPanelMod {
  ...
  trait P13nFilterPanel
    extends typingsJapgolly.openui5.sapMP13nPanelMod.default {
    ...
    def addFilterItem(
      ...
      */
    oFilterItem: typingsJapgolly.openui5.sapMP13nFilterItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFilterItems(): js.Array[typingsJapgolly.openui5.sapMP13nFilterItemMod.default] = js.native
    ...
    /**
      ...
      */
    def getMessageStrip(): typingsJapgolly.openui5.sapMMessageStripMod.default = js.native
    ...
    /**
      ...
      */
    def removeAllFilterItems(): js.Array[typingsJapgolly.openui5.sapMP13nFilterItemMod.default] = js.native
    
    def removeFilterItem(/**
      * The filterItem to remove or its index or id
      */
    vFilterItem: String): typingsJapgolly.openui5.sapMP13nFilterItemMod.default | Null = js.native
    /**
    ...
    def removeFilterItem(/**
      * The filterItem to remove or its index or id
      */
    vFilterItem: int): typingsJapgolly.openui5.sapMP13nFilterItemMod.default | Null = js.native
    def removeFilterItem(
      /**
      * The filterItem to remove or its index or id
      */
    vFilterItem: typingsJapgolly.openui5.sapMP13nFilterItemMod.default
    ): typingsJapgolly.openui5.sapMP13nFilterItemMod.default | Null = js.native
    ...
    def setMessageStrip(
      ...
      */
    oMessageStrip: typingsJapgolly.openui5.sapMMessageStripMod.default
    ): this.type = js.native
  ...
  trait P13nFilterPanelSettings
    ...
    var filterItems: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMP13nFilterItemMod.default] | typingsJapgolly.openui5.sapMP13nFilterItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      * Defines an optional message strip to be displayed in the content area
      */
    var messageStrip: js.UndefOr[typingsJapgolly.openui5.sapMMessageStripMod.default] = js.undefined
  ...
  object P13nFilterPanelSettings {
    ...
    extension [Self <: P13nFilterPanelSettings](x: Self) {
      ...
      inline def setAddFilterItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "addFilterItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setFilterItemChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "filterItemChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setFilterItemChangedUndefined: Self = StObject.set(x, "filterItemChanged", js.undefined)
      
      inline def setFilterItems(
        value: js.Array[typingsJapgolly.openui5.sapMP13nFilterItemMod.default] | typingsJapgolly.openui5.sapMP13nFilterItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setFilterItemsVarargs(value: typingsJapgolly.openui5.sapMP13nFilterItemMod.default*): Self = StObject.set(x, "filterItems", js.Array(value*))
      ...
      inline def setMessageStrip(value: typingsJapgolly.openui5.sapMMessageStripMod.default): Self = StObject.set(x, "messageStrip", value.asInstanceOf[js.Any])
      
      inline def setMessageStripUndefined: Self = StObject.set(x, "messageStrip", js.undefined)
      
      inline def setRemoveFilterItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "removeFilterItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setRemoveFilterItemUndefined: Self = StObject.set(x, "removeFilterItem", js.undefined)
      
      inline def setUpdateFilterItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "updateFilterItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
