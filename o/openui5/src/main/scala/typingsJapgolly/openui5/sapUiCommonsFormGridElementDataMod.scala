...
object sapUiCommonsFormGridElementDataMod {
  
  @JSImport("sap/ui/commons/form/GridElementData", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiLayoutFormGridElementDataMod.default {
    def this(/**
  ...
  type GridElementData = typingsJapgolly.openui5.sapUiLayoutFormGridElementDataMod.default
  
  type GridElementDataSettings = typingsJapgolly.openui5.sapUiLayoutFormGridElementDataMod.GridElementDataSettings
}
