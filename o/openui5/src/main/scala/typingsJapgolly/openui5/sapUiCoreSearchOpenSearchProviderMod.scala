...
import typingsJapgolly.openui5.sapUiCoreSearchSearchProviderMod.SearchProviderSettings
...
object sapUiCoreSearchOpenSearchProviderMod {
  ...
  trait OpenSearchProvider
    extends typingsJapgolly.openui5.sapUiCoreSearchSearchProviderMod.default {
