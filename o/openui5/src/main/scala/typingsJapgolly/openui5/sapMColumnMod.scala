...
import typingsJapgolly.openui5.sapMLibraryMod.PopinDisplay
...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.IColumnHeaderMenu
import typingsJapgolly.openui5.sapUiCoreLibraryMod.Priority
import typingsJapgolly.openui5.sapUiCoreLibraryMod.SortOrder
import typingsJapgolly.openui5.sapUiCoreLibraryMod.TextAlign
import typingsJapgolly.openui5.sapUiCoreLibraryMod.VerticalAlign
...
object sapMColumnMod {
  ...
  trait Column
    ...
    /**
      ...
      */
    def getHeader(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setHeader(/**
      * The header to set
      */
    oHeader: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  ...
  trait ColumnSettings
    ...
    /**
      * Control to be displayed in the column header.
      */
    var header: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object ColumnSettings {
    ...
    extension [Self <: ColumnSettings](x: Self) {
      ...
      inline def setHeader(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
