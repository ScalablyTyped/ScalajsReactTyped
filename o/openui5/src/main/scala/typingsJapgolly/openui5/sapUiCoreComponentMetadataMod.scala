...
object sapUiCoreComponentMetadataMod {
  ...
  trait ComponentMetadata
    extends typingsJapgolly.openui5.sapUiBaseManagedObjectMetadataMod.default {
    ...
    /**
      ...
      * @returns manifest.
      */
    def getManifestObject(): typingsJapgolly.openui5.sapUiCoreManifestMod.default = js.native
