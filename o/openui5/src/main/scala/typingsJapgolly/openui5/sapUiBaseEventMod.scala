...
import typingsJapgolly.openui5.sapUiBaseObjectPoolMod.Poolable
...
object sapUiBaseEventMod {
  ...
  open class default protected () extends Event {
    ...
    sId: String,
      ...
      * Source of the event
      */
    oSource: typingsJapgolly.openui5.sapUiBaseEventProviderMod.default,
      /**
  ...
  trait Event
    ...
    /**
      ...
      */
    def getSource(): typingsJapgolly.openui5.sapUiBaseEventProviderMod.default = js.native
