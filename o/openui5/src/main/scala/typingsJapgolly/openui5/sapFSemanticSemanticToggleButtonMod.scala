...
object sapFSemanticSemanticToggleButtonMod {
  
  @JSImport("sap/f/semantic/SemanticToggleButton", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMSemanticSemanticToggleButtonMod.default {
    def this(/**
  ...
  type SemanticToggleButton = typingsJapgolly.openui5.sapMSemanticSemanticToggleButtonMod.default
  
  type SemanticToggleButtonSettings = typingsJapgolly.openui5.sapMSemanticSemanticToggleButtonMod.SemanticToggleButtonSettings
}
