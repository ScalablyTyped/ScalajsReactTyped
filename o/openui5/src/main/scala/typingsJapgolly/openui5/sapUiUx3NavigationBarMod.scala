...
import typingsJapgolly.openui5.anon.ItemItemId
...
object sapUiUx3NavigationBarMod {
  ...
  trait NavigationBar
    ...
    def addAssociatedItem(
      ...
      * The associatedItems to add; if empty, nothing is inserted
      */
    vAssociatedItem: typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default
    ): this.type = js.native
    ...
    def addItem(
      ...
      */
    oItem: typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllItems(): js.Array[typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default] = js.native
    ...
    def removeItem(/**
      ...
      */
    vItem: String): typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: int): typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default | Null = js.native
    def removeItem(
      /**
      * The item to remove or its index or id
      */
    vItem: typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default
    ...
    def setAssociatedItems(
      ...
      */
    aItems: js.Array[typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default]
    ): this.type = js.native
    ...
    def setSelectedItem(
      ...
      * instance may be given
      */
    oSelectedItem: typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default
    ): this.type = js.native
  ...
  trait NavigationBarSettings
    ...
    /**
      ...
      */
    var associatedItems: js.UndefOr[js.Array[typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default | String]] = js.undefined
    ...
    /**
      ...
      */
    var selectedItem: js.UndefOr[typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default | String] = js.undefined
  ...
  object NavigationBarSettings {
    ...
    extension [Self <: NavigationBarSettings](x: Self) {
      ...
      inline def setAssociatedItems(value: js.Array[typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default | String]): Self = StObject.set(x, "associatedItems", value.asInstanceOf[js.Any])
      
      inline def setAssociatedItemsUndefined: Self = StObject.set(x, "associatedItems", js.undefined)
      
      inline def setAssociatedItemsVarargs(value: (typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default | String)*): Self = StObject.set(x, "associatedItems", js.Array(value*))
      ...
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default*): Self = StObject.set(x, "items", js.Array(value*))
      ...
      inline def setSelectedItem(value: typingsJapgolly.openui5.sapUiUx3NavigationItemMod.default | String): Self = StObject.set(x, "selectedItem", value.asInstanceOf[js.Any])
