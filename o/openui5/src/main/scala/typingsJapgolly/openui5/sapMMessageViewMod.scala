...
import typingsJapgolly.openui5.anon.AsyncDescriptionHandler
import typingsJapgolly.openui5.anon.ItemMessageTypeFilter
import typingsJapgolly.openui5.anon.OpenBy
import typingsJapgolly.openui5.anon.`15`
import typingsJapgolly.openui5.anon.`16`
...
object sapMMessageViewMod {
  ...
  trait MessageView
    ...
    def addItem(
      ...
      */
    oItem: typingsJapgolly.openui5.sapMMessageItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getHeaderButton(): typingsJapgolly.openui5.sapMButtonMod.default = js.native
    ...
    /**
      ...
      * the item.
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapMMessageItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllItems(): js.Array[typingsJapgolly.openui5.sapMMessageItemMod.default] = js.native
    
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: String): typingsJapgolly.openui5.sapMMessageItemMod.default | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: int): typingsJapgolly.openui5.sapMMessageItemMod.default | Null = js.native
    def removeItem(
      /**
      * The item to remove or its index or id
      */
    vItem: typingsJapgolly.openui5.sapMMessageItemMod.default
    ): typingsJapgolly.openui5.sapMMessageItemMod.default | Null = js.native
    ...
    def setHeaderButton(/**
      ...
      */
    oHeaderButton: typingsJapgolly.openui5.sapMButtonMod.default): this.type = js.native
  ...
  trait MessageViewSettings
    ...
    /**
      * Sets a custom header button.
      */
    var headerButton: js.UndefOr[typingsJapgolly.openui5.sapMButtonMod.default] = js.undefined
    ...
    var items: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMMessageItemMod.default] | typingsJapgolly.openui5.sapMMessageItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object MessageViewSettings {
    ...
    extension [Self <: MessageViewSettings](x: Self) {
      ...
      inline def setActiveTitlePress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "activeTitlePress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setHeaderButton(value: typingsJapgolly.openui5.sapMButtonMod.default): Self = StObject.set(x, "headerButton", value.asInstanceOf[js.Any])
      
      inline def setHeaderButtonUndefined: Self = StObject.set(x, "headerButton", js.undefined)
      
      inline def setItemSelect(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "itemSelect", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setItemSelectUndefined: Self = StObject.set(x, "itemSelect", js.undefined)
      
      inline def setItems(
        value: js.Array[typingsJapgolly.openui5.sapMMessageItemMod.default] | typingsJapgolly.openui5.sapMMessageItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapMMessageItemMod.default*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setListSelect(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "listSelect", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setListSelectUndefined: Self = StObject.set(x, "listSelect", js.undefined)
      
      inline def setLongtextLoaded(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "longtextLoaded", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setUrlValidated(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "urlValidated", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
