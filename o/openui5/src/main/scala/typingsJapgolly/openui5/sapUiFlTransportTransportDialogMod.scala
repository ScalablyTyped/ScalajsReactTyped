...
import typingsJapgolly.openui5.sapMDialogMod.DialogSettings
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapUiFlTransportTransportDialogMod {
  
  @JSImport("sap/ui/fl/transport/TransportDialog", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMDialogMod.default {
    def this(/**
      * initial settings for the new control
      */
    mSettings: TransportDialogSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, TransportDialog]
  ...
  type TransportDialog = typingsJapgolly.openui5.sapMDialogMod.default
  
  type TransportDialogSettings = DialogSettings
}
