...
import typingsJapgolly.openui5.anon.GetDomRef
...
import typingsJapgolly.openui5.sapMLibraryMod.LinkConversion
...
object sapMFeedListItemMod {
  ...
  trait FeedListItem
    ...
    def addAction(
      ...
      */
    oAction: typingsJapgolly.openui5.sapMFeedListItemActionMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getActions(): js.Array[typingsJapgolly.openui5.sapMFeedListItemActionMod.default] = js.native
    ...
    def removeAction(/**
      ...
      */
    vAction: String): typingsJapgolly.openui5.sapMFeedListItemActionMod.default | Null = js.native
    /**
      * @SINCE 1.52.0
      *
    ...
    def removeAction(/**
      * The action to remove or its index or id
      */
    vAction: int): typingsJapgolly.openui5.sapMFeedListItemActionMod.default | Null = js.native
    def removeAction(
      /**
      * The action to remove or its index or id
      */
    vAction: typingsJapgolly.openui5.sapMFeedListItemActionMod.default
    ): typingsJapgolly.openui5.sapMFeedListItemActionMod.default | Null = js.native
    ...
    /**
      ...
      */
    def removeAllActions(): js.Array[typingsJapgolly.openui5.sapMFeedListItemActionMod.default] = js.native
  ...
  trait FeedListItemSettings
    ...
    var actions: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMFeedListItemActionMod.default] | typingsJapgolly.openui5.sapMFeedListItemActionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object FeedListItemSettings {
    ...
    extension [Self <: FeedListItemSettings](x: Self) {
      ...
      inline def setActions(
        value: js.Array[typingsJapgolly.openui5.sapMFeedListItemActionMod.default] | typingsJapgolly.openui5.sapMFeedListItemActionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
      
      inline def setActionsUndefined: Self = StObject.set(x, "actions", js.undefined)
      
      inline def setActionsVarargs(value: typingsJapgolly.openui5.sapMFeedListItemActionMod.default*): Self = StObject.set(x, "actions", js.Array(value*))
      ...
      inline def setIconPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "iconPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setSenderPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "senderPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
