...
import typingsJapgolly.openui5.sapUxapLibraryMod.Importance
...
object sapUxapObjectPageSectionBaseMod {
  ...
  trait ObjectPageSectionBase
    ...
    /**
      ...
      */
    def getCustomAnchorBarButton(): typingsJapgolly.openui5.sapMButtonMod.default = js.native
    ...
    def setCustomAnchorBarButton(
      ...
      */
    oCustomAnchorBarButton: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
  ...
  trait ObjectPageSectionBaseSettings
    ...
    /**
      ...
      * If you want to change some of the button properties, you would need to bind them to a model.
      */
    var customAnchorBarButton: js.UndefOr[typingsJapgolly.openui5.sapMButtonMod.default] = js.undefined
  ...
  object ObjectPageSectionBaseSettings {
    ...
    extension [Self <: ObjectPageSectionBaseSettings](x: Self) {
      ...
      inline def setCustomAnchorBarButton(value: typingsJapgolly.openui5.sapMButtonMod.default): Self = StObject.set(x, "customAnchorBarButton", value.asInstanceOf[js.Any])
