...
import typingsJapgolly.openui5.sapUiCoreTmplTemplateMod.TemplateSettings
...
object sapUiCoreTmplHandlebarsTemplateMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiCoreTmplTemplateMod.default {
    def this(/**
  ...
  type HandlebarsTemplate = typingsJapgolly.openui5.sapUiCoreTmplTemplateMod.default
