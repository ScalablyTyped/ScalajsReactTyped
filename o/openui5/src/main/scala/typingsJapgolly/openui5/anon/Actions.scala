...
trait Actions extends StObject {
  ...
  var actions: js.UndefOr[
    typingsJapgolly.openui5.sapMMessageBoxMod.Action | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof Action * / any */ String) | (js.Array[
      typingsJapgolly.openui5.sapMMessageBoxMod.Action | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof Action * / any */ String)
    ])
  ] = js.undefined
  ...
  /**
    ...
    */
  var initialFocus: js.UndefOr[String | typingsJapgolly.openui5.sapMMessageBoxMod.Action] = js.undefined
...
object Actions {
  ...
  extension [Self <: Actions](x: Self) {
    ...
    inline def setActions(
      value: typingsJapgolly.openui5.sapMMessageBoxMod.Action | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof Action * / any */ String) | (js.Array[
          typingsJapgolly.openui5.sapMMessageBoxMod.Action | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof Action * / any */ String)
        ])
    ...
    inline def setActionsVarargs(
      value: (typingsJapgolly.openui5.sapMMessageBoxMod.Action | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof Action * / any */ String))*
    ...
    inline def setDetailsCallbackTo(value: CallbackTo[js.Promise[String | js.Object]]): Self = StObject.set(x, "details", value.toJsFn)
    ...
    inline def setInitialFocus(value: String | typingsJapgolly.openui5.sapMMessageBoxMod.Action): Self = StObject.set(x, "initialFocus", value.asInstanceOf[js.Any])
