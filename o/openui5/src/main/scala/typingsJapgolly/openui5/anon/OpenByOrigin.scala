...
trait OpenByOrigin extends StObject {
  ...
  /**
    ...
    */
  var origin: js.UndefOr[typingsJapgolly.openui5.sapMButtonMod.default] = js.undefined
}
object OpenByOrigin {
  ...
  extension [Self <: OpenByOrigin](x: Self) {
    ...
    inline def setOrigin(value: typingsJapgolly.openui5.sapMButtonMod.default): Self = StObject.set(x, "origin", value.asInstanceOf[js.Any])
