...
trait SelectedRow extends StObject {
  ...
  /**
    ...
    */
  var selectedRow: js.UndefOr[typingsJapgolly.openui5.sapMColumnListItemMod.default] = js.undefined
}
object SelectedRow {
  ...
  extension [Self <: SelectedRow](x: Self) {
    ...
    inline def setSelectedRow(value: typingsJapgolly.openui5.sapMColumnListItemMod.default): Self = StObject.set(x, "selectedRow", value.asInstanceOf[js.Any])
