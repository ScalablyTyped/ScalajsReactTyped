...
trait And extends StObject {
  ...
  /**
    ...
    */
  var condition: js.UndefOr[typingsJapgolly.openui5.sapUiModelFilterMod.Filter] = js.undefined
  
  /**
    * An array of filters on which the logical conjunction is applied
    */
  var filters: js.UndefOr[js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.Filter]] = js.undefined
...
object And {
  ...
  extension [Self <: And](x: Self) {
    ...
    inline def setCondition(value: typingsJapgolly.openui5.sapUiModelFilterMod.Filter): Self = StObject.set(x, "condition", value.asInstanceOf[js.Any])
    
    inline def setConditionUndefined: Self = StObject.set(x, "condition", js.undefined)
    
    inline def setFilters(value: js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.Filter]): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
    
    inline def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
    
    inline def setFiltersVarargs(value: typingsJapgolly.openui5.sapUiModelFilterMod.Filter*): Self = StObject.set(x, "filters", js.Array(value*))
