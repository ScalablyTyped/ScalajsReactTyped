...
trait CloseOnNavigation extends StObject {
  ...
  /**
    ...
    */
  var icon: js.UndefOr[typingsJapgolly.openui5.sapMMessageBoxMod.Icon] = js.undefined
...
object CloseOnNavigation {
  ...
  extension [Self <: CloseOnNavigation](x: Self) {
    ...
    inline def setIcon(value: typingsJapgolly.openui5.sapMMessageBoxMod.Icon): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
