...
import typingsJapgolly.openui5.sapMLibraryMod.SwipeDirection
import typingsJapgolly.openui5.sapMListItemBaseMod.default
...
trait SwipeContent extends StObject {
  ...
  /**
    ...
    */
  var srcControl: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  
  /**
    * Aggregated `swipeContent` control that is shown on the right hand side of the item.
    */
  var swipeContent: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
...
object SwipeContent {
  ...
  extension [Self <: SwipeContent](x: Self) {
    ...
    inline def setSrcControl(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "srcControl", value.asInstanceOf[js.Any])
    
    inline def setSrcControlUndefined: Self = StObject.set(x, "srcControl", js.undefined)
    
    inline def setSwipeContent(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "swipeContent", value.asInstanceOf[js.Any])
