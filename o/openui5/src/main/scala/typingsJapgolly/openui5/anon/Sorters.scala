...
import typingsJapgolly.openui5.sapUiModelFilterMod.default
...
trait Sorters extends StObject {
  ...
  /**
    ...
    */
  var sorters: js.UndefOr[js.Array[typingsJapgolly.openui5.sapUiModelSorterMod.default]] = js.undefined
...
object Sorters {
  ...
  extension [Self <: Sorters](x: Self) {
    ...
    inline def setSorters(value: js.Array[typingsJapgolly.openui5.sapUiModelSorterMod.default]): Self = StObject.set(x, "sorters", value.asInstanceOf[js.Any])
    
    inline def setSortersUndefined: Self = StObject.set(x, "sorters", js.undefined)
    
    inline def setSortersVarargs(value: typingsJapgolly.openui5.sapUiModelSorterMod.default*): Self = StObject.set(x, "sorters", js.Array(value*))
