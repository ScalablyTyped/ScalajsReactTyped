...
trait Container extends StObject {
  ...
  /**
    ...
    */
  var container: default | typingsJapgolly.openui5.sapUiCoreFragmentMod.default
...
object Container {
  ...
  inline def apply(container: default | typingsJapgolly.openui5.sapUiCoreFragmentMod.default, name: String): Container = {
  ...
  extension [Self <: Container](x: Self) {
    ...
    inline def setContainer(value: default | typingsJapgolly.openui5.sapUiCoreFragmentMod.default): Self = StObject.set(x, "container", value.asInstanceOf[js.Any])
