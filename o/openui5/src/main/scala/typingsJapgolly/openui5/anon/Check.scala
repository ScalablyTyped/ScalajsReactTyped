...
import typingsJapgolly.openui5.sapUiTestActionsActionMod.default
...
trait Check extends StObject {
  ...
  var matchers: js.UndefOr[
    js.Function | js.Array[Any] | js.Object | typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default
  ] = js.undefined
...
object Check {
  ...
  extension [Self <: Check](x: Self) {
    ...
    inline def setMatchers(
      value: js.Function | js.Array[Any] | js.Object | typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default
