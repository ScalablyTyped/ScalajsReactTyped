...
import typingsJapgolly.openui5.sapUiModelBindingModeMod.BindingMode
import typingsJapgolly.openui5.sapUiModelOdataOperationModeMod.OperationMode
import typingsJapgolly.openui5.sapUiModelOdataUpdateMethodMod.UpdateMethod
...
trait BindableResponseHeaders extends StObject {
  ...
  var defaultCountMode: js.UndefOr[
    typingsJapgolly.openui5.sapUiModelOdataCountModeMod.CountMode | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof CountMode * / any */ String)
  ] = js.undefined
...
object BindableResponseHeaders {
  ...
  extension [Self <: BindableResponseHeaders](x: Self) {
    ...
    inline def setDefaultCountMode(
      value: typingsJapgolly.openui5.sapUiModelOdataCountModeMod.CountMode | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof CountMode * / any */ String)
