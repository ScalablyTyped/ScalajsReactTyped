...
trait CalendarType extends StObject {
  ...
  var calendarType: js.UndefOr[
    typingsJapgolly.openui5.sapUiCoreCalendarTypeMod.CalendarType | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof CalendarType * / any */ String)
  ] = js.undefined
...
object CalendarType {
  ...
  extension [Self <: CalendarType](x: Self) {
    
    inline def setCalendarType(
      value: typingsJapgolly.openui5.sapUiCoreCalendarTypeMod.CalendarType | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof CalendarType * / any */ String)
