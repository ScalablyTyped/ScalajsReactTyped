...
trait ContainingView extends StObject {
  ...
  /**
    ...
    */
  var controller: js.UndefOr[typingsJapgolly.openui5.sapUiCoreMvcControllerMod.default | js.Object] = js.undefined
...
object ContainingView {
  ...
  extension [Self <: ContainingView](x: Self) {
    ...
    inline def setController(value: typingsJapgolly.openui5.sapUiCoreMvcControllerMod.default | js.Object): Self = StObject.set(x, "controller", value.asInstanceOf[js.Any])
