...
trait AnimationDuration extends StObject {
  ...
  /**
    ...
    */
  var of: js.UndefOr[default | org.scalajs.dom.Element | jQuery[HTMLElement] | Window] = js.undefined
...
object AnimationDuration {
  ...
  extension [Self <: AnimationDuration](x: Self) {
    ...
    inline def setOf(value: default | org.scalajs.dom.Element | jQuery[HTMLElement] | Window): Self = StObject.set(x, "of", value.asInstanceOf[js.Any])
