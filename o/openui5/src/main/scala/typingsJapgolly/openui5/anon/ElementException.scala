...
trait ElementException extends StObject {
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.openui5.sapUiModelTypeMod.default
}
object ElementException {
  ...
  inline def apply(
    ...
    oldValue: js.Object,
    property: String,
    `type`: typingsJapgolly.openui5.sapUiModelTypeMod.default
  ): ElementException = {
  ...
  extension [Self <: ElementException](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.openui5.sapUiModelTypeMod.default): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
