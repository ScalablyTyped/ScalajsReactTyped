...
trait DomElement extends StObject {
  ...
  /**
    ...
    */
  var domElement: org.scalajs.dom.Element
...
object DomElement {
  ...
  inline def apply(domElement: org.scalajs.dom.Element, settings: PreferViewId): DomElement = {
  ...
  extension [Self <: DomElement](x: Self) {
    ...
    inline def setDomElement(value: org.scalajs.dom.Element): Self = StObject.set(x, "domElement", value.asInstanceOf[js.Any])
