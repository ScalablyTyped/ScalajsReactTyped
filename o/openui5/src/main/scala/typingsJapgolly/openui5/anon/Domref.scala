...
trait Domref extends StObject {
  ...
  /**
    ...
    */
  var domref: org.scalajs.dom.Element
...
object Domref {
  ...
  inline def apply(control: String, domref: org.scalajs.dom.Element, id: String): Domref = {
  ...
  extension [Self <: Domref](x: Self) {
    ...
    inline def setDomref(value: org.scalajs.dom.Element): Self = StObject.set(x, "domref", value.asInstanceOf[js.Any])
