...
import typingsJapgolly.openui5.sapMLibraryMod.SelectionDetailsActionLevel
...
trait Level extends StObject {
  ...
  /**
    ...
    * items}
    */
  var items: js.UndefOr[typingsJapgolly.openui5.sapMSelectionDetailsItemMod.default] = js.undefined
...
object Level {
  ...
  extension [Self <: Level](x: Self) {
    ...
    inline def setItems(value: typingsJapgolly.openui5.sapMSelectionDetailsItemMod.default): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
