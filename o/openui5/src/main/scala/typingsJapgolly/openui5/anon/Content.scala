...
trait Content extends StObject {
  ...
  /**
    ...
    */
  var item: js.UndefOr[typingsJapgolly.openui5.sapMSelectionDetailsItemMod.default] = js.undefined
}
object Content {
  ...
  extension [Self <: Content](x: Self) {
    ...
    inline def setItem(value: typingsJapgolly.openui5.sapMSelectionDetailsItemMod.default): Self = StObject.set(x, "item", value.asInstanceOf[js.Any])
