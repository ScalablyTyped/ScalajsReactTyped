...
import typingsJapgolly.openui5.sapMLibraryMod.GenericTagDesign
import typingsJapgolly.openui5.sapMLibraryMod.GenericTagValueState
...
object sapMGenericTagMod {
  ...
  trait GenericTag
    ...
    /**
      ...
      */
    def getValue(): typingsJapgolly.openui5.sapMObjectNumberMod.default = js.native
    ...
    def setValue(/**
      * The value to set
      */
    oValue: typingsJapgolly.openui5.sapMObjectNumberMod.default): this.type = js.native
  ...
  trait GenericTagSettings
    ...
    /**
      * Numeric value rendered by the control.
      */
    var value: js.UndefOr[typingsJapgolly.openui5.sapMObjectNumberMod.default] = js.undefined
  ...
  object GenericTagSettings {
    ...
    extension [Self <: GenericTagSettings](x: Self) {
      ...
      inline def setValue(value: typingsJapgolly.openui5.sapMObjectNumberMod.default): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
