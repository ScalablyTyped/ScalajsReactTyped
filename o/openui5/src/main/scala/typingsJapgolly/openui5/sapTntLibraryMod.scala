...
object sapTntLibraryMod {
  ...
  object RenderMode extends StObject {
    ...
    sealed trait Loose
      extends StObject
         with RenderMode
    /* "Loose" */ val Loose: typingsJapgolly.openui5.sapTntLibraryMod.RenderMode.Loose & String = js.native
    ...
    sealed trait Narrow
      extends StObject
         with RenderMode
    /* "Narrow" */ val Narrow: typingsJapgolly.openui5.sapTntLibraryMod.RenderMode.Narrow & String = js.native
  }
