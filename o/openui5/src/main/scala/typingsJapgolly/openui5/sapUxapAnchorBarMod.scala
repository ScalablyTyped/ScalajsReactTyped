...
import typingsJapgolly.openui5.sapMToolbarMod.ToolbarSettings
...
object sapUxapAnchorBarMod {
  ...
  @js.native
  trait AnchorBar
    extends typingsJapgolly.openui5.sapMToolbarMod.default {
    ...
    def setSelectedButton(
      ...
      */
    oSelectedButton: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    /**
