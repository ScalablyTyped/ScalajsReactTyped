...
import typingsJapgolly.openui5.anon.Context
import typingsJapgolly.openui5.anon.Info
...
object sapUiModelModelMod {
  ...
  @js.native
  trait Model
    extends typingsJapgolly.openui5.sapUiCoreMessageMessageProcessorMod.default {
    ...
    def bindContext(/**
      ...
      */
    sPath: String): typingsJapgolly.openui5.sapUiModelContextBindingMod.default = js.native
    def bindContext(
      /**
      * The path pointing to the property that should be bound
      */
    ...
    ): typingsJapgolly.openui5.sapUiModelContextBindingMod.default = js.native
    def bindContext(
      /**
      * The path pointing to the property that should be bound
      */
    ...
    def bindList(/**
      ...
      */
    sPath: String): typingsJapgolly.openui5.sapUiModelListBindingMod.default = js.native
    def bindList(
      /**
      * The path pointing to the list / array that should be bound
      */
    ...
    def bindProperty(/**
      * The path pointing to the property that should be bound
      */
    sPath: String): typingsJapgolly.openui5.sapUiModelPropertyBindingMod.default = js.native
    def bindProperty(
      /**
      * The path pointing to the property that should be bound
      */
    ...
    def bindTree(/**
      ...
      */
    sPath: String): typingsJapgolly.openui5.sapUiModelTreeBindingMod.default = js.native
    def bindTree(
      /**
      * The path pointing to the tree / array that should be bound
      */
    ...
    oContext: Unit,
      ...
      */
    aFilters: js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.default]
    ): typingsJapgolly.openui5.sapUiModelTreeBindingMod.default = js.native
    def bindTree(
      /**
      * The path pointing to the tree / array that should be bound
      */
    ...
    def createBindingContext(/**
      ...
      */
    sPath: String): js.UndefOr[typingsJapgolly.openui5.sapUiModelContextMod.default] = js.native
    def createBindingContext(
      /**
      * The path to create the new context from
      */
    ...
    oContext: Unit,
      ...
      */
    mParameters: js.Object
    ): js.UndefOr[typingsJapgolly.openui5.sapUiModelContextMod.default] = js.native
    def createBindingContext(
      /**
      * The path to create the new context from
      */
    ...
    def destroyBindingContext(/**
      ...
      */
    oContext: typingsJapgolly.openui5.sapUiModelContextMod.default): Unit = js.native
    ...
    def getMessages(
      ...
      */
    oContext: typingsJapgolly.openui5.sapUiModelContextMod.default
    ): js.Array[typingsJapgolly.openui5.sapUiCoreMessageMessageMod.default] = js.native
    ...
    def getMessagesByPath(/**
      ...
      */
    sPath: String): js.Array[typingsJapgolly.openui5.sapUiCoreMessageMessageMod.default] = js.native
    def getMessagesByPath(
      /**
      * The resolved binding path
      */
    ...
    /**
      ...
      */
    def getMetaModel(): js.UndefOr[typingsJapgolly.openui5.sapUiModelMetaModelMod.default] = js.native
