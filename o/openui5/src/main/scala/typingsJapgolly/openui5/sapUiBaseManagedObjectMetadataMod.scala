...
object sapUiBaseManagedObjectMetadataMod {
  ...
  object default {
    ...
    inline def addAPIParentInfoBegin(
      ...
      */
    oAggregatedObject: typingsJapgolly.openui5.sapUiBaseManagedObjectMod.default,
      /**
      * Object that is a new API parent
      */
    oParent: typingsJapgolly.openui5.sapUiBaseManagedObjectMod.default,
      /**
  ...
  trait ManagedObjectMetadata
    extends typingsJapgolly.openui5.sapUiBaseMetadataMod.default {
