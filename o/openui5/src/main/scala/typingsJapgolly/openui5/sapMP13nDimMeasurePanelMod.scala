...
object sapMP13nDimMeasurePanelMod {
  ...
  trait P13nDimMeasurePanel
    ...
    def addAvailableChartType(
      ...
      */
    oAvailableChartType: typingsJapgolly.openui5.sapUiCoreItemMod.default
    ): this.type = js.native
    ...
    def addDimMeasureItem(
      ...
      */
    oDimMeasureItem: typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getAvailableChartTypes(): js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default] = js.native
    ...
    /**
      ...
      */
    def getDimMeasureItems(): js.Array[typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllAvailableChartTypes(): js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllDimMeasureItems(): js.Array[typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default] = js.native
    
    def removeAvailableChartType(/**
      * The availableChartType to remove or its index or id
      */
    vAvailableChartType: String): typingsJapgolly.openui5.sapUiCoreItemMod.default | Null = js.native
    /**
    ...
    def removeAvailableChartType(/**
      * The availableChartType to remove or its index or id
      */
    vAvailableChartType: int): typingsJapgolly.openui5.sapUiCoreItemMod.default | Null = js.native
    def removeAvailableChartType(
      /**
      * The availableChartType to remove or its index or id
      */
    vAvailableChartType: typingsJapgolly.openui5.sapUiCoreItemMod.default
    ...
    def removeDimMeasureItem(/**
      ...
      */
    vDimMeasureItem: String): typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default | Null = js.native
    /**
    ...
    def removeDimMeasureItem(/**
      * The dimMeasureItem to remove or its index or id
      */
    vDimMeasureItem: int): typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default | Null = js.native
    def removeDimMeasureItem(
      /**
      * The dimMeasureItem to remove or its index or id
      */
    vDimMeasureItem: typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default
    ): typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default | Null = js.native
  ...
  trait P13nDimMeasurePanelSettings
    ...
    var dimMeasureItems: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default] | typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  }
  object P13nDimMeasurePanelSettings {
    ...
    extension [Self <: P13nDimMeasurePanelSettings](x: Self) {
      ...
      inline def setAvailableChartTypesVarargs(value: typingsJapgolly.openui5.sapUiCoreItemMod.default*): Self = StObject.set(x, "availableChartTypes", js.Array(value*))
      
      inline def setChangeChartType(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "changeChartType", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setChangeChartTypeUndefined: Self = StObject.set(x, "changeChartType", js.undefined)
      
      inline def setChangeDimMeasureItems(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "changeDimMeasureItems", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setDimMeasureItems(
        value: js.Array[typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default] | typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setDimMeasureItemsVarargs(value: typingsJapgolly.openui5.sapMP13nDimMeasureItemMod.default*): Self = StObject.set(x, "dimMeasureItems", js.Array(value*))
    }
  }
}
