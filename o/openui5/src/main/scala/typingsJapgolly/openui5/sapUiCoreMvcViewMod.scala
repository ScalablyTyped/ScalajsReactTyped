...
import typingsJapgolly.openui5.anon.Caller
import typingsJapgolly.openui5.anon.ComponentId
import typingsJapgolly.openui5.anon.Preprocessors
...
object sapUiCoreMvcViewMod {
  ...
  trait View
    ...
    /**
      ...
      */
    def createContent(): typingsJapgolly.openui5.sapUiCoreControlMod.default | js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] | (js.Promise[
        typingsJapgolly.openui5.sapUiCoreControlMod.default | js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default]
      ]) = js.native
    ...
    /**
      ...
      */
    def getController(): typingsJapgolly.openui5.sapUiCoreMvcControllerMod.default = js.native
  ...
  object ViewSettings {
    ...
    extension [Self <: ViewSettings](x: Self) {
      ...
      inline def setAfterInit(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "afterInit", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setAfterInitUndefined: Self = StObject.set(x, "afterInit", js.undefined)
      
      inline def setAfterRendering(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "afterRendering", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setAfterRenderingUndefined: Self = StObject.set(x, "afterRendering", js.undefined)
      
      inline def setBeforeExit(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "beforeExit", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setBeforeExitUndefined: Self = StObject.set(x, "beforeExit", js.undefined)
      
      inline def setBeforeRendering(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "beforeRendering", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
