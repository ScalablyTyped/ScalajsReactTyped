...
import typingsJapgolly.openui5.sapFCardsBaseHeaderMod.BaseHeaderSettings
import typingsJapgolly.openui5.sapFLibraryMod.cards.IHeader
import typingsJapgolly.openui5.sapFLibraryMod.cards.NumericHeaderSideIndicatorsAlignment
import typingsJapgolly.openui5.sapMLibraryMod.DeviationIndicator
import typingsJapgolly.openui5.sapMLibraryMod.ValueColor
...
object sapFCardsNumericHeaderMod {
  ...
  @js.native
  trait NumericHeader
    extends typingsJapgolly.openui5.sapFCardsBaseHeaderMod.default
       with IHeader {
    ...
    def addSideIndicator(
      ...
      */
    oSideIndicator: typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default
    ): this.type = js.native
    ...
    def enhanceAccessibilityState(
      ...
      */
    oElement: typingsJapgolly.openui5.sapUiCoreControlMod.default,
      /**
    ...
    /**
      ...
      * should be used.
      */
    def getSideIndicators(): js.Array[typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllSideIndicators(): js.Array[typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default] = js.native
    
    def removeSideIndicator(/**
      * The sideIndicator to remove or its index or id
      */
    vSideIndicator: String): typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default | Null = js.native
    /**
    ...
    def removeSideIndicator(/**
      * The sideIndicator to remove or its index or id
      */
    vSideIndicator: int): typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default | Null = js.native
    def removeSideIndicator(
      /**
      * The sideIndicator to remove or its index or id
      */
    vSideIndicator: typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default
    ): typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default | Null = js.native
  ...
  trait NumericHeaderSettings
    ...
    var sideIndicators: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default] | typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object NumericHeaderSettings {
    ...
    extension [Self <: NumericHeaderSettings](x: Self) {
      ...
      inline def setSideIndicators(
        value: js.Array[typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default] | typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setSideIndicatorsVarargs(value: typingsJapgolly.openui5.sapFCardsNumericSideIndicatorMod.default*): Self = StObject.set(x, "sideIndicators", js.Array(value*))
