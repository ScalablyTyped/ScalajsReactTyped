...
import typingsJapgolly.openui5.anon.NotVisible
...
object sapUiUnifiedCalendarTimesRowMod {
  
  @JSImport("sap/ui/unified/calendar/TimesRow", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends TimesRow {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: TimesRowSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, TimesRow]
  ...
  trait TimesRow
    ...
    def addSelectedDate(
      ...
      */
    oSelectedDate: typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getSelectedDates(): js.Array[typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllSelectedDates(): js.Array[typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default] = js.native
    ...
    def removeSelectedDate(/**
      ...
      */
    vSelectedDate: String): typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default | Null = js.native
    /**
    ...
    def removeSelectedDate(/**
      * The selectedDate to remove or its index or id
      */
    vSelectedDate: int): typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default | Null = js.native
    def removeSelectedDate(
      /**
      * The selectedDate to remove or its index or id
      */
    vSelectedDate: typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default
    ): typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default | Null = js.native
  ...
  trait TimesRowSettings
    ...
    var selectedDates: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default] | typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object TimesRowSettings {
    
    inline def apply(): TimesRowSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[TimesRowSettings]
    }
    
    extension [Self <: TimesRowSettings](x: Self) {
      ...
      inline def setFocus(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "focus", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setSelect(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setSelectUndefined: Self = StObject.set(x, "select", js.undefined)
      
      inline def setSelectedDates(
        value: js.Array[typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default] | typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setSelectedDatesVarargs(value: typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default*): Self = StObject.set(x, "selectedDates", js.Array(value*))
