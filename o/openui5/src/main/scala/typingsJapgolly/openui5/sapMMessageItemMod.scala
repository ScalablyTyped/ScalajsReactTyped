...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.MessageType
...
object sapMMessageItemMod {
  ...
  trait MessageItem
    ...
    /**
      ...
      */
    def getLink(): typingsJapgolly.openui5.sapMLinkMod.default = js.native
    ...
    def setLink(/**
      * The link to set
      */
    oLink: typingsJapgolly.openui5.sapMLinkMod.default): this.type = js.native
  ...
  trait MessageItemSettings
    ...
    /**
      * Adds an sap.m.Link control which will be displayed at the end of the description of a message.
      */
    var link: js.UndefOr[typingsJapgolly.openui5.sapMLinkMod.default] = js.undefined
  ...
  object MessageItemSettings {
    ...
    extension [Self <: MessageItemSettings](x: Self) {
      ...
      inline def setLink(value: typingsJapgolly.openui5.sapMLinkMod.default): Self = StObject.set(x, "link", value.asInstanceOf[js.Any])
