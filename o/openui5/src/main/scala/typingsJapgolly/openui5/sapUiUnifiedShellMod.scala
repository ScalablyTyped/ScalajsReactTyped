...
import typingsJapgolly.openui5.sapUiUnifiedShellLayoutMod.ShellLayoutSettings
...
object sapUiUnifiedShellMod {
  ...
  @js.native
  trait Shell
    extends typingsJapgolly.openui5.sapUiUnifiedShellLayoutMod.default {
    ...
    def addCurtainContent(
      ...
      */
    oCurtainContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addCurtainPaneContent(
      ...
      */
    oCurtainPaneContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addHeadEndItem(
      ...
      */
    oHeadEndItem: typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default
    ): this.type = js.native
    ...
    def addHeadItem(
      ...
      */
    oHeadItem: typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCurtainContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getCurtainPaneContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getHeadEndItems(): js.Array[typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default] = js.native
    ...
    /**
      ...
      */
    def getHeadItems(): js.Array[typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default] = js.native
    ...
    /**
      ...
      */
    def getSearch(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    /**
      ...
      */
    def getUser(): typingsJapgolly.openui5.sapUiUnifiedShellHeadUserItemMod.default = js.native
    ...
    /**
      ...
      */
    def removeAllCurtainContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllCurtainPaneContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllHeadEndItems(): js.Array[typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllHeadItems(): js.Array[typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default] = js.native
    
    def removeCurtainContent(/**
      * The curtainContent to remove or its index or id
      */
    vCurtainContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeCurtainContent(/**
      * The curtainContent to remove or its index or id
      */
    vCurtainContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeCurtainContent(
      /**
      * The curtainContent to remove or its index or id
      */
    vCurtainContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ...
    def removeCurtainPaneContent(/**
      ...
      */
    vCurtainPaneContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeCurtainPaneContent(/**
      * The curtainPaneContent to remove or its index or id
      */
    vCurtainPaneContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeCurtainPaneContent(
      /**
      * The curtainPaneContent to remove or its index or id
      */
    vCurtainPaneContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    
    def removeHeadEndItem(/**
      * The headEndItem to remove or its index or id
      */
    vHeadEndItem: String): typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default | Null = js.native
    /**
    ...
    def removeHeadEndItem(/**
      * The headEndItem to remove or its index or id
      */
    vHeadEndItem: int): typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default | Null = js.native
    def removeHeadEndItem(
      /**
      * The headEndItem to remove or its index or id
      */
    vHeadEndItem: typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default
    ): typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default | Null = js.native
    
    def removeHeadItem(/**
      * The headItem to remove or its index or id
      */
    vHeadItem: String): typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default | Null = js.native
    /**
    ...
    def removeHeadItem(/**
      * The headItem to remove or its index or id
      */
    vHeadItem: int): typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default | Null = js.native
    def removeHeadItem(
      /**
      * The headItem to remove or its index or id
      */
    vHeadItem: typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default
    ): typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default | Null = js.native
    ...
    def setSearch(/**
      * The search to set
      */
    oSearch: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
    ...
    def setUser(
      ...
      * The user to set
      */
    oUser: typingsJapgolly.openui5.sapUiUnifiedShellHeadUserItemMod.default
    ): this.type = js.native
  }
  ...
  trait ShellSettings
    ...
    var headEndItems: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default] | typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      * in the shell header. If a custom header is set this aggregation has no effect.
      */
    var search: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
    ...
    /**
      ...
      * aggregation has no effect.
      */
    var user: js.UndefOr[typingsJapgolly.openui5.sapUiUnifiedShellHeadUserItemMod.default] = js.undefined
  }
  object ShellSettings {
    ...
    extension [Self <: ShellSettings](x: Self) {
      ...
      inline def setCurtainContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "curtainContent", js.Array(value*))
      ...
      inline def setCurtainPaneContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "curtainPaneContent", js.Array(value*))
      
      inline def setHeadEndItems(
        value: js.Array[typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default] | typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setHeadEndItemsVarargs(value: typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default*): Self = StObject.set(x, "headEndItems", js.Array(value*))
      ...
      inline def setHeadItemsVarargs(value: typingsJapgolly.openui5.sapUiUnifiedShellHeadItemMod.default*): Self = StObject.set(x, "headItems", js.Array(value*))
      ...
      inline def setSearch(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "search", value.asInstanceOf[js.Any])
      ...
      inline def setUser(value: typingsJapgolly.openui5.sapUiUnifiedShellHeadUserItemMod.default): Self = StObject.set(x, "user", value.asInstanceOf[js.Any])
