...
import typingsJapgolly.openui5.anon.Chunk
import typingsJapgolly.openui5.anon.ItemId
import typingsJapgolly.openui5.anon.Live
import typingsJapgolly.openui5.anon.NewValue
...
object sapUiUx3FeedMod {
  ...
  trait Feed
    ...
    def addChunk(
      ...
      */
    oChunk: typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default
    ): this.type = js.native
    ...
    def addFilterItem(
      ...
      */
    oFilterItem: typingsJapgolly.openui5.sapUiCoreListItemMod.default
    ): this.type = js.native
    ...
    def addToolsMenuItem(
      ...
      */
    oToolsMenuItem: typingsJapgolly.openui5.sapUiCommonsMenuItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * The chunks
      */
    def getChunks(): js.Array[typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default] = js.native
    ...
    /**
      ...
      * Items of the filter
      */
    def getFilterItems(): js.Array[typingsJapgolly.openui5.sapUiCoreListItemMod.default] = js.native
    ...
    /**
      ...
      */
    def getToolsMenuItems(): js.Array[typingsJapgolly.openui5.sapUiCommonsMenuItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllChunks(): js.Array[typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllFilterItems(): js.Array[typingsJapgolly.openui5.sapUiCoreListItemMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllToolsMenuItems(): js.Array[typingsJapgolly.openui5.sapUiCommonsMenuItemMod.default] = js.native
    
    def removeChunk(/**
      * The chunk to remove or its index or id
      */
    vChunk: String): typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default | Null = js.native
    /**
    ...
    def removeChunk(/**
      * The chunk to remove or its index or id
      */
    vChunk: int): typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default | Null = js.native
    def removeChunk(
      /**
      * The chunk to remove or its index or id
      */
    vChunk: typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default
    ): typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default | Null = js.native
    
    def removeFilterItem(/**
      * The filterItem to remove or its index or id
      */
    vFilterItem: String): typingsJapgolly.openui5.sapUiCoreListItemMod.default | Null = js.native
    /**
    ...
    def removeFilterItem(/**
      * The filterItem to remove or its index or id
      */
    vFilterItem: int): typingsJapgolly.openui5.sapUiCoreListItemMod.default | Null = js.native
    def removeFilterItem(
      /**
      * The filterItem to remove or its index or id
      */
    vFilterItem: typingsJapgolly.openui5.sapUiCoreListItemMod.default
    ...
    def removeToolsMenuItem(/**
      ...
      */
    vToolsMenuItem: String): typingsJapgolly.openui5.sapUiCommonsMenuItemMod.default | Null = js.native
    /**
    ...
    def removeToolsMenuItem(/**
      * The toolsMenuItem to remove or its index or id
      */
    vToolsMenuItem: int): typingsJapgolly.openui5.sapUiCommonsMenuItemMod.default | Null = js.native
    def removeToolsMenuItem(
      /**
      * The toolsMenuItem to remove or its index or id
      */
    vToolsMenuItem: typingsJapgolly.openui5.sapUiCommonsMenuItemMod.default
  ...
  trait FeedSettings
    ...
    var chunks: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default] | typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object FeedSettings {
    ...
    extension [Self <: FeedSettings](x: Self) {
      ...
      inline def setChunkAdded(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "chunkAdded", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setChunkAddedUndefined: Self = StObject.set(x, "chunkAdded", js.undefined)
      
      inline def setChunks(
        value: js.Array[typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default] | typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setChunksVarargs(value: typingsJapgolly.openui5.sapUiUx3FeedChunkMod.default*): Self = StObject.set(x, "chunks", js.Array(value*))
      ...
      inline def setFilterChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "filterChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setFilterItemsVarargs(value: typingsJapgolly.openui5.sapUiCoreListItemMod.default*): Self = StObject.set(x, "filterItems", js.Array(value*))
      ...
      inline def setToggleLive(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "toggleLive", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setToggleLiveUndefined: Self = StObject.set(x, "toggleLive", js.undefined)
      
      inline def setToolsItemSelected(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "toolsItemSelected", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setToolsMenuItemsVarargs(value: typingsJapgolly.openui5.sapUiCommonsMenuItemMod.default*): Self = StObject.set(x, "toolsMenuItems", js.Array(value*))
    }
  }
}
