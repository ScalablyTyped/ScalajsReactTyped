...
import typingsJapgolly.openui5.anon.`18`
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.BackgroundDesign
import typingsJapgolly.openui5.sapMLibraryMod.ObjectHeaderContainer
import typingsJapgolly.openui5.sapMLibraryMod.ObjectHeaderPictureShape
...
object sapMObjectHeaderMod {
  ...
  trait ObjectHeader
    ...
    def addAdditionalNumber(
      ...
      */
    oAdditionalNumber: typingsJapgolly.openui5.sapMObjectNumberMod.default
    ): this.type = js.native
    ...
    def addStatus(
      ...
      */
    oStatus: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getAdditionalNumbers(): js.Array[typingsJapgolly.openui5.sapMObjectNumberMod.default] = js.native
    ...
    /**
      ...
      * controls.
      */
    def getStatuses(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def removeAdditionalNumber(/**
      ...
      */
    vAdditionalNumber: String): typingsJapgolly.openui5.sapMObjectNumberMod.default | Null = js.native
    /**
      * @SINCE 1.38.0
      *
    ...
    def removeAdditionalNumber(/**
      * The additionalNumber to remove or its index or id
      */
    vAdditionalNumber: int): typingsJapgolly.openui5.sapMObjectNumberMod.default | Null = js.native
    def removeAdditionalNumber(
      /**
      * The additionalNumber to remove or its index or id
      */
    vAdditionalNumber: typingsJapgolly.openui5.sapMObjectNumberMod.default
    ): typingsJapgolly.openui5.sapMObjectNumberMod.default | Null = js.native
    ...
    /**
      ...
      */
    def removeAllAdditionalNumbers(): js.Array[typingsJapgolly.openui5.sapMObjectNumberMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllStatuses(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def removeStatus(/**
      ...
      */
    vStatus: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
      * @SINCE 1.16.0
      *
    ...
    def removeStatus(/**
      * The status to remove or its index or id
      */
    vStatus: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeStatus(
      /**
      * The status to remove or its index or id
      */
    vStatus: typingsJapgolly.openui5.sapUiCoreControlMod.default
  ...
  trait ObjectHeaderSettings
    ...
    var additionalNumbers: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMObjectNumberMod.default] | typingsJapgolly.openui5.sapMObjectNumberMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object ObjectHeaderSettings {
    ...
    extension [Self <: ObjectHeaderSettings](x: Self) {
      ...
      inline def setAdditionalNumbers(
        value: js.Array[typingsJapgolly.openui5.sapMObjectNumberMod.default] | typingsJapgolly.openui5.sapMObjectNumberMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setAdditionalNumbersVarargs(value: typingsJapgolly.openui5.sapMObjectNumberMod.default*): Self = StObject.set(x, "additionalNumbers", js.Array(value*))
      ...
      inline def setIntroPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "introPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setStatusesVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "statuses", js.Array(value*))
      ...
      inline def setTitlePress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "titlePress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
