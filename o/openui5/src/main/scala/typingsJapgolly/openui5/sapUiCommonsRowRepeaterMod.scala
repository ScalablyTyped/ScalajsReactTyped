...
import typingsJapgolly.openui5.anon.CurrentPage
import typingsJapgolly.openui5.anon.FilterId
import typingsJapgolly.openui5.anon.NumberOfRows
import typingsJapgolly.openui5.anon.SorterId
...
import typingsJapgolly.openui5.sapUiCommonsLibraryMod.RowRepeaterDesign
...
object sapUiCommonsRowRepeaterMod {
  ...
  trait RowRepeater
    ...
    def addFilter(
      ...
      */
    oFilter: typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default
    ): this.type = js.native
    ...
    def addRow(
      ...
      */
    oRow: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addSorter(
      ...
      */
    oSorter: typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFilters(): js.Array[typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default] = js.native
    ...
    /**
      ...
      */
    def getNoData(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    /**
      ...
      * Rows to be repeated.
      */
    def getRows(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getSorters(): js.Array[typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default] = js.native
    ...
    /**
      ...
      */
    def getTitle(): typingsJapgolly.openui5.sapUiCoreTitleMod.default = js.native
    ...
    /**
      ...
      */
    def removeAllFilters(): js.Array[typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllRows(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllSorters(): js.Array[typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default] = js.native
    
    def removeFilter(/**
      * The filter to remove or its index or id
      */
    vFilter: String): typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default | Null = js.native
    /**
    ...
    def removeFilter(/**
      * The filter to remove or its index or id
      */
    vFilter: int): typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default | Null = js.native
    def removeFilter(
      /**
      * The filter to remove or its index or id
      */
    vFilter: typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default
    ): typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default | Null = js.native
    
    def removeRow(/**
      * The row to remove or its index or id
      */
    vRow: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeRow(/**
      * The row to remove or its index or id
      */
    vRow: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeRow(
      /**
      * The row to remove or its index or id
      */
    vRow: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    
    def removeSorter(/**
      * The sorter to remove or its index or id
      */
    vSorter: String): typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default | Null = js.native
    /**
    ...
    def removeSorter(/**
      * The sorter to remove or its index or id
      */
    vSorter: int): typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default | Null = js.native
    def removeSorter(
      /**
      * The sorter to remove or its index or id
      */
    vSorter: typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default
    ): typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default | Null = js.native
    ...
    def setNoData(/**
      * The noData to set
      */
    oNoData: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
    ...
    def setTitle(/**
      * The title to set
      */
    oTitle: typingsJapgolly.openui5.sapUiCoreTitleMod.default): this.type = js.native
  ...
  trait RowRepeaterSettings
    ...
    var filters: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default] | typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      * This control is shown, in case there is no data available to be displayed in the RowRepeater.
      */
    var noData: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
    ...
    var sorters: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default] | typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      * Title to be displayed in top left corner. Either text or icon.
      */
    var title: js.UndefOr[typingsJapgolly.openui5.sapUiCoreTitleMod.default] = js.undefined
  }
  object RowRepeaterSettings {
    ...
    extension [Self <: RowRepeaterSettings](x: Self) {
      ...
      inline def setFilters(
        value: js.Array[typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default] | typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "filters", value.asInstanceOf[js.Any])
      
      inline def setFiltersUndefined: Self = StObject.set(x, "filters", js.undefined)
      
      inline def setFiltersVarargs(value: typingsJapgolly.openui5.sapUiCommonsRowRepeaterFilterMod.default*): Self = StObject.set(x, "filters", js.Array(value*))
      ...
      inline def setNoData(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "noData", value.asInstanceOf[js.Any])
      ...
      inline def setPage(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "page", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setRowsVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "rows", js.Array(value*))
      ...
      inline def setSorters(
        value: js.Array[typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default] | typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setSortersVarargs(value: typingsJapgolly.openui5.sapUiCommonsRowRepeaterSorterMod.default*): Self = StObject.set(x, "sorters", js.Array(value*))
      ...
      inline def setTitle(value: typingsJapgolly.openui5.sapUiCoreTitleMod.default): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
