...
object sapUiLayoutFormFormMod {
  ...
  trait Form
    ...
    def addFormContainer(
      ...
      */
    oFormContainer: typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFormContainers(): js.Array[typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default] = js.native
    ...
    /**
      ...
      */
    def getLayout(): typingsJapgolly.openui5.sapUiLayoutFormFormLayoutMod.default = js.native
    ...
    /**
      ...
      */
    def getTitle(): typingsJapgolly.openui5.sapUiCoreTitleMod.default | String = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllFormContainers(): js.Array[typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default] = js.native
    ...
    def removeFormContainer(/**
      ...
      */
    vFormContainer: String): typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default | Null = js.native
    /**
    ...
    def removeFormContainer(/**
      * The formContainer to remove or its index or id
      */
    vFormContainer: int): typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default | Null = js.native
    def removeFormContainer(
      /**
      * The formContainer to remove or its index or id
      */
    vFormContainer: typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default
    ): typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default | Null = js.native
    ...
    def setLayout(
      ...
      * The layout to set
      */
    oLayout: typingsJapgolly.openui5.sapUiLayoutFormFormLayoutMod.default
    ): this.type = js.native
    ...
    def setTitle(/**
      * The title to set
      */
    vTitle: typingsJapgolly.openui5.sapUiCoreTitleMod.default): this.type = js.native
  ...
  trait FormSettings
    ...
    var formContainers: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default] | typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      * the best way possible.
      */
    var layout: js.UndefOr[typingsJapgolly.openui5.sapUiLayoutFormFormLayoutMod.default] = js.undefined
    ...
    /**
      ...
      * level} to the needed value.
      */
    var title: js.UndefOr[String | typingsJapgolly.openui5.sapUiCoreTitleMod.default | PropertyBindingInfo] = js.undefined
  ...
  object FormSettings {
    ...
    extension [Self <: FormSettings](x: Self) {
      ...
      inline def setFormContainers(
        value: js.Array[typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default] | typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setFormContainersVarargs(value: typingsJapgolly.openui5.sapUiLayoutFormFormContainerMod.default*): Self = StObject.set(x, "formContainers", js.Array(value*))
      
      inline def setLayout(value: typingsJapgolly.openui5.sapUiLayoutFormFormLayoutMod.default): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
      
      inline def setLayoutUndefined: Self = StObject.set(x, "layout", js.undefined)
      
      inline def setTitle(value: String | typingsJapgolly.openui5.sapUiCoreTitleMod.default | PropertyBindingInfo): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
