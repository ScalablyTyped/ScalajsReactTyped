...
object sapUiCoreCommandExecutionMod {
  ...
  trait CommandExecution
    ...
    def setEnabled(/**
      ...
      */
    bValue: Boolean): typingsJapgolly.openui5.sapUiCoreElementMod.default = js.native
  ...
  object CommandExecutionSettings {
    ...
    extension [Self <: CommandExecutionSettings](x: Self) {
      ...
      inline def setExecute(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "execute", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
