...
import typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator
...
object sapUiModelAnalyticsOdata4analyticsMod extends Shortcut {
  ...
  open class FilterExpression protected () extends StObject {
    ...
    def addUI5FilterConditions(
      ...
      */
    aUI5Filter: js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.default]
    ): FilterExpression = js.native
    ...
    /**
      ...
      */
    def getExpressionAsUI5FilterArray(): js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.default] = js.native
  ...
  open class SortExpression protected () extends StObject {
    ...
    /**
      ...
      */
    def getExpressionAsUI5Sorter(): typingsJapgolly.openui5.sapUiModelSorterMod.default = js.native
    ...
    /**
      ...
      */
    def getExpressionsAsUI5SorterArray(): js.Array[typingsJapgolly.openui5.sapUiModelSorterMod.default] = js.native
  ...
  object SortOrder extends StObject {
    ...
    sealed trait Ascending
      extends StObject
         with SortOrder
    /* "asc" */ val Ascending: typingsJapgolly.openui5.sapUiModelAnalyticsOdata4analyticsMod.SortOrder.Ascending & String = js.native
    ...
    sealed trait Descending
      extends StObject
         with SortOrder
    /* "desc" */ val Descending: typingsJapgolly.openui5.sapUiModelAnalyticsOdata4analyticsMod.SortOrder.Descending & String = js.native
  }
  ...
  object odata4analytics {
    ...
    inline def apply(includeDimensionTextAttributes: (Boolean, Boolean) => Callback): odata4analytics = {
      val __obj = js.Dynamic.literal(includeDimensionTextAttributes = js.Any.fromFunction2((t0: Boolean, t1: Boolean) => (includeDimensionTextAttributes(t0, t1)).runNow()))
      __obj.asInstanceOf[odata4analytics]
    }
    
    extension [Self <: odata4analytics](x: Self) {
      
      inline def setIncludeDimensionTextAttributes(value: (Boolean, Boolean) => Callback): Self = StObject.set(x, "includeDimensionTextAttributes", js.Any.fromFunction2((t0: Boolean, t1: Boolean) => (value(t0, t1)).runNow()))
    }
  }
}
