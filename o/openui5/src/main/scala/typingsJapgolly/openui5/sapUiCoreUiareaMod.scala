...
object sapUiCoreUiareaMod {
  ...
  @js.native
  val registry: typingsJapgolly.openui5.sapUiCoreUiareaMod.registry = js.native
  ...
  trait UIArea
    ...
    def addDependent(
      ...
      */
    oDependent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * the UIArea.
      */
    def getDependents(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def getRootControl(/**
      ...
      */
    idx: int): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllDependents(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def removeDependent(/**
      ...
      */
    vDependent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeDependent(/**
      * The dependent to remove or its index or id
      */
    vDependent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeDependent(
      /**
      * The dependent to remove or its index or id
      */
    vDependent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    ...
    def setRootControl(
      ...
      */
    oRootControl: typingsJapgolly.openui5.sapUiBaseInterfaceMod.default
    ): Unit = js.native
    def setRootControl(
      /**
      * the Control that should be the Root for this `UIArea`.
      */
    oRootControl: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): Unit = js.native
  ...
  object UIAreaSettings {
    ...
    extension [Self <: UIAreaSettings](x: Self) {
      ...
      inline def setDependentsVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "dependents", js.Array(value*))
    }
  }
}
