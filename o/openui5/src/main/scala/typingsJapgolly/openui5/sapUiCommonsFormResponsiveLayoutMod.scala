...
object sapUiCommonsFormResponsiveLayoutMod {
  
  @JSImport("sap/ui/commons/form/ResponsiveLayout", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiLayoutFormResponsiveLayoutMod.default {
    def this(/**
      * initial settings for the new control
      */
    mSettings: ResponsiveLayoutSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ResponsiveLayout]
  ...
  type ResponsiveLayout = typingsJapgolly.openui5.sapUiLayoutFormResponsiveLayoutMod.default
  
  type ResponsiveLayoutSettings = typingsJapgolly.openui5.sapUiLayoutFormResponsiveLayoutMod.ResponsiveLayoutSettings
}
