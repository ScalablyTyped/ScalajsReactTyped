package typingsJapgolly.openui5.sapUiLayoutLibraryMod
...
object cssgrid {
  ...
  object CSSGridAutoFlow extends StObject {
    ...
    /* "Column" */ val Column: typingsJapgolly.openui5.sapUiLayoutLibraryMod.cssgrid.CSSGridAutoFlow.Column & String = js.native
    ...
    sealed trait ColumnDense
      extends StObject
         with CSSGridAutoFlow
    /* "ColumnDense" */ val ColumnDense: typingsJapgolly.openui5.sapUiLayoutLibraryMod.cssgrid.CSSGridAutoFlow.ColumnDense & String = js.native
    ...
    sealed trait Row
      extends StObject
         with CSSGridAutoFlow
    /* "Row" */ val Row: typingsJapgolly.openui5.sapUiLayoutLibraryMod.cssgrid.CSSGridAutoFlow.Row & String = js.native
    ...
    sealed trait RowDense
      extends StObject
         with CSSGridAutoFlow
    /* "RowDense" */ val RowDense: typingsJapgolly.openui5.sapUiLayoutLibraryMod.cssgrid.CSSGridAutoFlow.RowDense & String = js.native
  }
  ...
  trait IGridConfigurable extends StObject {
    ...
    /**
      ...
      */
    def getGridLayoutConfiguration(): typingsJapgolly.openui5.sapUiLayoutCssgridGridLayoutBaseMod.default
  }
  object IGridConfigurable {
    
    inline def apply(
      __implements__sap_ui_layout_cssgrid_IGridConfigurable: Boolean,
      getGridDomRefs: CallbackTo[js.Array[HTMLElement | default]],
      getGridLayoutConfiguration: CallbackTo[typingsJapgolly.openui5.sapUiLayoutCssgridGridLayoutBaseMod.default]
    ): IGridConfigurable = {
      val __obj = js.Dynamic.literal(__implements__sap_ui_layout_cssgrid_IGridConfigurable = __implements__sap_ui_layout_cssgrid_IGridConfigurable.asInstanceOf[js.Any], getGridDomRefs = getGridDomRefs.toJsFn, getGridLayoutConfiguration = getGridLayoutConfiguration.toJsFn)
      __obj.asInstanceOf[IGridConfigurable]
    }
    
    extension [Self <: IGridConfigurable](x: Self) {
      
      inline def setGetGridDomRefs(value: CallbackTo[js.Array[HTMLElement | default]]): Self = StObject.set(x, "getGridDomRefs", value.toJsFn)
      
      inline def setGetGridLayoutConfiguration(value: CallbackTo[typingsJapgolly.openui5.sapUiLayoutCssgridGridLayoutBaseMod.default]): Self = StObject.set(x, "getGridLayoutConfiguration", value.toJsFn)
