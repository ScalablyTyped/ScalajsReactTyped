...
object SideContentPosition extends StObject {
  ...
  /* "Begin" */ val Begin: typingsJapgolly.openui5.sapUiLayoutLibraryMod.SideContentPosition.Begin & String = js.native
  ...
  sealed trait End
    extends StObject
       with SideContentPosition
  /* "End" */ val End: typingsJapgolly.openui5.sapUiLayoutLibraryMod.SideContentPosition.End & String = js.native
}
