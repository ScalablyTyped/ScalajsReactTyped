...
object BlockRowColorSets extends StObject {
  ...
  /* "ColorSet1" */ val ColorSet1: typingsJapgolly.openui5.sapUiLayoutLibraryMod.BlockRowColorSets.ColorSet1 & String = js.native
  ...
  sealed trait ColorSet2
    extends StObject
       with BlockRowColorSets
  /* "ColorSet2" */ val ColorSet2: typingsJapgolly.openui5.sapUiLayoutLibraryMod.BlockRowColorSets.ColorSet2 & String = js.native
  ...
  sealed trait ColorSet3
    extends StObject
       with BlockRowColorSets
  /* "ColorSet3" */ val ColorSet3: typingsJapgolly.openui5.sapUiLayoutLibraryMod.BlockRowColorSets.ColorSet3 & String = js.native
  ...
  sealed trait ColorSet4
    extends StObject
       with BlockRowColorSets
  /* "ColorSet4" */ val ColorSet4: typingsJapgolly.openui5.sapUiLayoutLibraryMod.BlockRowColorSets.ColorSet4 & String = js.native
}
