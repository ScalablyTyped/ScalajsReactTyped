...
object form {
  ...
  object SimpleFormLayout extends StObject {
    ...
    /* "ColumnLayout" */ val ColumnLayout: typingsJapgolly.openui5.sapUiLayoutLibraryMod.form.SimpleFormLayout.ColumnLayout & String = js.native
    ...
    sealed trait GridLayout
      extends StObject
         with SimpleFormLayout
    /* "GridLayout" */ val GridLayout: typingsJapgolly.openui5.sapUiLayoutLibraryMod.form.SimpleFormLayout.GridLayout & String = js.native
    ...
    sealed trait ResponsiveGridLayout
      extends StObject
         with SimpleFormLayout
    /* "ResponsiveGridLayout" */ val ResponsiveGridLayout: typingsJapgolly.openui5.sapUiLayoutLibraryMod.form.SimpleFormLayout.ResponsiveGridLayout & String = js.native
    ...
    sealed trait ResponsiveLayout
      extends StObject
         with SimpleFormLayout
    /* "ResponsiveLayout" */ val ResponsiveLayout: typingsJapgolly.openui5.sapUiLayoutLibraryMod.form.SimpleFormLayout.ResponsiveLayout & String = js.native
  }
