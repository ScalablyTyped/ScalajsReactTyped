...
import typingsJapgolly.openui5.sapMIllustratedMessageSizeMod.IllustratedMessageSize
...
object sapMIllustratedMessageMod {
  ...
  trait IllustratedMessage
    ...
    def addAdditionalContent(
      ...
      */
    oAdditionalContent: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    ...
    def addIllustrationAriaLabelledBy(
      ...
      */
    vIllustrationAriaLabelledBy: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
      * @SINCE 1.106.0
      *
    ...
    /**
      ...
      */
    def getAdditionalContent(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    def removeAdditionalContent(/**
      ...
      */
    vAdditionalContent: String): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    /**
      * @SINCE 1.98
      *
    ...
    def removeAdditionalContent(/**
      * The additionalContent to remove or its index or id
      */
    vAdditionalContent: int): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    def removeAdditionalContent(
      /**
      * The additionalContent to remove or its index or id
      */
    vAdditionalContent: typingsJapgolly.openui5.sapMButtonMod.default
    ...
    /**
      ...
      */
    def removeAllAdditionalContent(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
  ...
  trait IllustratedMessageSettings
    ...
    /**
      ...
      */
    var illustrationAriaLabelledBy: js.UndefOr[js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default | String]] = js.undefined
  ...
  object IllustratedMessageSettings {
    ...
    extension [Self <: IllustratedMessageSettings](x: Self) {
      ...
      inline def setAdditionalContentVarargs(value: typingsJapgolly.openui5.sapMButtonMod.default*): Self = StObject.set(x, "additionalContent", js.Array(value*))
      ...
      inline def setIllustrationAriaLabelledBy(value: js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default | String]): Self = StObject.set(x, "illustrationAriaLabelledBy", value.asInstanceOf[js.Any])
      
      inline def setIllustrationAriaLabelledByUndefined: Self = StObject.set(x, "illustrationAriaLabelledBy", js.undefined)
      
      inline def setIllustrationAriaLabelledByVarargs(value: (typingsJapgolly.openui5.sapUiCoreControlMod.default | String)*): Self = StObject.set(x, "illustrationAriaLabelledBy", js.Array(value*))
