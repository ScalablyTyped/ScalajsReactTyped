...
import typingsJapgolly.openui5.sapMComboBoxTextFieldMod.ComboBoxTextFieldSettings
...
object sapMComboBoxBaseMod {
  ...
  @js.native
  trait ComboBoxBase
    extends typingsJapgolly.openui5.sapMComboBoxTextFieldMod.default {
    ...
    def configPicker(/**
      * Picker instance
      */
    oPicker: typingsJapgolly.openui5.sapMDialogMod.default): Unit = js.native
    /**
    ...
    def configPicker(/**
      * Picker instance
      */
    oPicker: typingsJapgolly.openui5.sapMPopoverMod.default): Unit = js.native
    ...
    def createPicker(/**
      * The picker type
      */
    sPickerType: String): typingsJapgolly.openui5.sapMPopoverMod.default | typingsJapgolly.openui5.sapMDialogMod.default = js.native
    ...
    /**
      ...
      */
    def getEnabledItems(): js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default] = js.native
    def getEnabledItems(/**
      * Items to filter.
      */
    aItems: js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default]): js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default] = js.native
    ...
    /**
      ...
      */
    def getFirstItem(): typingsJapgolly.openui5.sapUiCoreItemMod.default | Null = js.native
    ...
    def getItemAt(/**
      ...
      */
    iIndex: int): typingsJapgolly.openui5.sapUiCoreItemMod.default | Null = js.native
    ...
    /**
      ...
      */
    def getLastItem(): typingsJapgolly.openui5.sapUiCoreItemMod.default | Null = js.native
    ...
    /**
      ...
      */
    def getList(): typingsJapgolly.openui5.sapMListMod.default | Null = js.native
    ...
    /**
      ...
      */
    def getPicker(): typingsJapgolly.openui5.sapMDialogMod.default | typingsJapgolly.openui5.sapMPopoverMod.default | Null = js.native
    ...
    /**
      ...
      */
    def getPickerTextField(): typingsJapgolly.openui5.sapMComboBoxTextFieldMod.default | typingsJapgolly.openui5.sapMInputMod.default | Null = js.native
    ...
    def intersectItems(
      ...
      * Array of Items
      */
    aItems: js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default],
      /**
      * Second array of items
      */
    aOtherItems: js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default]
    ): js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default] = js.native
    ...
    def onItemChange(
      ...
      * The change event
      */
    oControlEvent: typingsJapgolly.openui5.sapUiBaseEventMod.default,
      /**
    ...
    def setTextFieldHandler(
      ...
      * Text field instance
      */
    oTextField: typingsJapgolly.openui5.sapMComboBoxTextFieldMod.default
    ): Unit = js.native
    def setTextFieldHandler(/**
      * Text field instance
      */
    oTextField: typingsJapgolly.openui5.sapMInputMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def syncPickerContent(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
  ...
  object ComboBoxBaseSettings {
    ...
    extension [Self <: ComboBoxBaseSettings](x: Self) {
      ...
      inline def setLoadItems(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "loadItems", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
