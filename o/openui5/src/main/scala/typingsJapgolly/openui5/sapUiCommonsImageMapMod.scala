...
import typingsJapgolly.openui5.anon.AreaId
...
object sapUiCommonsImageMapMod {
  ...
  trait ImageMap
    ...
    def addArea(
      ...
      */
    oArea: typingsJapgolly.openui5.sapUiCommonsAreaMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getAreas(): js.Array[typingsJapgolly.openui5.sapUiCommonsAreaMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllAreas(): js.Array[typingsJapgolly.openui5.sapUiCommonsAreaMod.default] = js.native
    
    def removeArea(/**
      * The area to remove or its index or id
      */
    vArea: String): typingsJapgolly.openui5.sapUiCommonsAreaMod.default | Null = js.native
    /**
    ...
    def removeArea(/**
      * The area to remove or its index or id
      */
    vArea: int): typingsJapgolly.openui5.sapUiCommonsAreaMod.default | Null = js.native
    def removeArea(
      /**
      * The area to remove or its index or id
      */
    vArea: typingsJapgolly.openui5.sapUiCommonsAreaMod.default
    ): typingsJapgolly.openui5.sapUiCommonsAreaMod.default | Null = js.native
  ...
  trait ImageMapSettings
    ...
    var areas: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCommonsAreaMod.default] | typingsJapgolly.openui5.sapUiCommonsAreaMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object ImageMapSettings {
    ...
    extension [Self <: ImageMapSettings](x: Self) {
      ...
      inline def setAreas(
        value: js.Array[typingsJapgolly.openui5.sapUiCommonsAreaMod.default] | typingsJapgolly.openui5.sapUiCommonsAreaMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "areas", value.asInstanceOf[js.Any])
      
      inline def setAreasUndefined: Self = StObject.set(x, "areas", js.undefined)
      
      inline def setAreasVarargs(value: typingsJapgolly.openui5.sapUiCommonsAreaMod.default*): Self = StObject.set(x, "areas", js.Array(value*))
