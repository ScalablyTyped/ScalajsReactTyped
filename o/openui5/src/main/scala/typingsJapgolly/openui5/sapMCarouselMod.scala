...
import typingsJapgolly.openui5.anon.ActivePages
import typingsJapgolly.openui5.anon.NewActivePageId
import typingsJapgolly.openui5.anon.PageId
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.CarouselArrowsPlacement
...
object sapMCarouselMod {
  ...
  trait Carousel
    ...
    def addPage(
      ...
      */
    oPage: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCustomLayout(): typingsJapgolly.openui5.sapMCarouselLayoutMod.default = js.native
    ...
    /**
      ...
      */
    def getPages(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllPages(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removePage(/**
      * The page to remove or its index or id
      */
    vPage: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removePage(/**
      * The page to remove or its index or id
      */
    vPage: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removePage(
      /**
      * The page to remove or its index or id
      */
    vPage: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ...
    def setActivePage(
      ...
      */
    oActivePage: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
    ...
    def setCustomLayout(
      ...
      */
    oCustomLayout: typingsJapgolly.openui5.sapMCarouselLayoutMod.default
    ): this.type = js.native
  ...
  trait CarouselSettings
    ...
    /**
      ...
      * the control id
      */
    var activePage: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
    ...
    /**
      ...
      * **Note:** When this property is used, the `loop` property is ignored.
      */
    var customLayout: js.UndefOr[typingsJapgolly.openui5.sapMCarouselLayoutMod.default] = js.undefined
  ...
  object CarouselSettings {
    ...
    extension [Self <: CarouselSettings](x: Self) {
      ...
      inline def setActivePage(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "activePage", value.asInstanceOf[js.Any])
      ...
      inline def setBeforePageChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "beforePageChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setBeforePageChangedUndefined: Self = StObject.set(x, "beforePageChanged", js.undefined)
      
      inline def setCustomLayout(value: typingsJapgolly.openui5.sapMCarouselLayoutMod.default): Self = StObject.set(x, "customLayout", value.asInstanceOf[js.Any])
      ...
      inline def setLoadPage(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "loadPage", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setPageChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pageChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setPagesVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "pages", js.Array(value*))
      ...
      inline def setUnloadPage(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "unloadPage", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
