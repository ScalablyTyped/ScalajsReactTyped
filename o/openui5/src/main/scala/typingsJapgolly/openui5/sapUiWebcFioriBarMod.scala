...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.BarDesign
...
object sapUiWebcFioriBarMod {
  ...
  trait Bar
    ...
    def addEndContent(
      ...
      */
    oEndContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addMiddleContent(
      ...
      */
    oMiddleContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addStartContent(
      ...
      */
    oStartContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getEndContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getMiddleContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getStartContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllEndContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllMiddleContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllStartContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeEndContent(/**
      * The endContent to remove or its index or id
      */
    vEndContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeEndContent(/**
      * The endContent to remove or its index or id
      */
    vEndContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeEndContent(
      /**
      * The endContent to remove or its index or id
      */
    vEndContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ...
    def removeMiddleContent(/**
      ...
      */
    vMiddleContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeMiddleContent(/**
      * The middleContent to remove or its index or id
      */
    vMiddleContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeMiddleContent(
      /**
      * The middleContent to remove or its index or id
      */
    vMiddleContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    
    def removeStartContent(/**
      * The startContent to remove or its index or id
      */
    vStartContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeStartContent(/**
      * The startContent to remove or its index or id
      */
    vStartContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeStartContent(
      /**
      * The startContent to remove or its index or id
      */
    vStartContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
  ...
  object BarSettings {
    ...
    extension [Self <: BarSettings](x: Self) {
      ...
      inline def setEndContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "endContent", js.Array(value*))
      ...
      inline def setMiddleContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "middleContent", js.Array(value*))
      ...
      inline def setStartContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "startContent", js.Array(value*))
