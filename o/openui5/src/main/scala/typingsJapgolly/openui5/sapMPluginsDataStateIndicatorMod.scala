...
import typingsJapgolly.openui5.anon.DataState
import typingsJapgolly.openui5.anon.Filter
...
object sapMPluginsDataStateIndicatorMod {
  ...
  object DataStateIndicatorSettings {
    ...
    extension [Self <: DataStateIndicatorSettings](x: Self) {
      ...
      inline def setApplyFilter(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "applyFilter", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setApplyFilterUndefined: Self = StObject.set(x, "applyFilter", js.undefined)
      
      inline def setClearFilter(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "clearFilter", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setDataStateChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "dataStateChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
