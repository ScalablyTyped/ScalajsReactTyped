...
import typingsJapgolly.openui5.anon.ButtonId
import typingsJapgolly.openui5.anon.`20`
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.IOverflowToolbarContent
...
object sapMSegmentedButtonMod {
  ...
  trait SegmentedButton
    ...
    def addItem(
      ...
      */
    oItem: typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default
    ): this.type = js.native
    ...
    sText: String,
      ...
      */
    sURI: URI
    ): typingsJapgolly.openui5.sapMButtonMod.default = js.native
    def createButton(
      /**
      * Defines the title text of the newly created Button
      */
    ...
    /**
      ...
      * in the page.
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default] = js.native
    ...
    def setSelectedItem(
      ...
      * item will be selected.
      */
    vItem: typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default
    ): this.type = js.native
  ...
  trait SegmentedButtonSettings
    ...
    var items: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default] | typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      * be removed.
      */
    var selectedButton: js.UndefOr[typingsJapgolly.openui5.sapMButtonMod.default | String] = js.undefined
    ...
    /**
      ...
      */
    var selectedItem: js.UndefOr[typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default | String] = js.undefined
  ...
  object SegmentedButtonSettings {
    ...
    extension [Self <: SegmentedButtonSettings](x: Self) {
      ...
      inline def setItems(
        value: js.Array[typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default] | typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default*): Self = StObject.set(x, "items", js.Array(value*))
      ...
      inline def setSelectedButton(value: typingsJapgolly.openui5.sapMButtonMod.default | String): Self = StObject.set(x, "selectedButton", value.asInstanceOf[js.Any])
      
      inline def setSelectedButtonUndefined: Self = StObject.set(x, "selectedButton", js.undefined)
      
      inline def setSelectedItem(value: typingsJapgolly.openui5.sapMSegmentedButtonItemMod.default | String): Self = StObject.set(x, "selectedItem", value.asInstanceOf[js.Any])
