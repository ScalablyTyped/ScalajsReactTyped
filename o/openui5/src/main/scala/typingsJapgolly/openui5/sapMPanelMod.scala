...
import typingsJapgolly.openui5.anon.Expand
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.BackgroundDesign
import typingsJapgolly.openui5.sapMLibraryMod.PanelAccessibleRole
...
object sapMPanelMod {
  ...
  object PanelSettings {
    ...
    extension [Self <: PanelSettings](x: Self) {
      ...
      inline def setExpand(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "expand", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
