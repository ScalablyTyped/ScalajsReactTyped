...
object sapMP13nSortPanelMod_ {
  ...
  trait P13nSortPanel
    ...
    def addSortItem(
      ...
      */
    oSortItem: typingsJapgolly.openui5.sapMP13nSortItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * defined Sort Items
      */
    def getSortItems(): js.Array[typingsJapgolly.openui5.sapMP13nSortItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllSortItems(): js.Array[typingsJapgolly.openui5.sapMP13nSortItemMod.default] = js.native
    ...
    def removeSortItem(/**
      ...
      */
    vSortItem: String): typingsJapgolly.openui5.sapMP13nSortItemMod.default | Null = js.native
    /**
    ...
    def removeSortItem(/**
      * The sortItem to remove or its index or id
      */
    vSortItem: int): typingsJapgolly.openui5.sapMP13nSortItemMod.default | Null = js.native
    def removeSortItem(
      /**
      * The sortItem to remove or its index or id
      */
    vSortItem: typingsJapgolly.openui5.sapMP13nSortItemMod.default
    ): typingsJapgolly.openui5.sapMP13nSortItemMod.default | Null = js.native
  ...
  trait P13nSortPanelSettings
    ...
    var sortItems: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMP13nSortItemMod.default] | typingsJapgolly.openui5.sapMP13nSortItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object P13nSortPanelSettings {
    ...
    extension [Self <: P13nSortPanelSettings](x: Self) {
      ...
      inline def setAddSortItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "addSortItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setRemoveSortItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "removeSortItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setRemoveSortItemUndefined: Self = StObject.set(x, "removeSortItem", js.undefined)
      
      inline def setSortItems(
        value: js.Array[typingsJapgolly.openui5.sapMP13nSortItemMod.default] | typingsJapgolly.openui5.sapMP13nSortItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setSortItemsVarargs(value: typingsJapgolly.openui5.sapMP13nSortItemMod.default*): Self = StObject.set(x, "sortItems", js.Array(value*))
      
      inline def setUpdateSortItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "updateSortItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
