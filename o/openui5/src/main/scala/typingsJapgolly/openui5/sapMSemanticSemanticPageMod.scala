...
import typingsJapgolly.openui5.sapMLibraryMod.PageBackgroundDesign
import typingsJapgolly.openui5.sapMLibraryMod.semantic.SemanticRuleSetType
...
object sapMSemanticSemanticPageMod {
  ...
  trait SemanticPage
    ...
    def addCustomFooterContent(
      ...
      */
    oCustomFooterContent: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    ...
    def addCustomHeaderContent(
      ...
      */
    oCustomHeaderContent: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCustomFooterContent(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    /**
      ...
      */
    def getCustomHeaderContent(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    /**
      ...
      */
    def getLandmarkInfo(): typingsJapgolly.openui5.sapMPageAccessibleLandmarkInfoMod.default = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllCustomFooterContent(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllCustomHeaderContent(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    def removeCustomFooterContent(/**
      ...
      */
    vCustomFooterContent: String): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    /**
    ...
    def removeCustomFooterContent(/**
      * The customFooterContent to remove or its index or id
      */
    vCustomFooterContent: int): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    def removeCustomFooterContent(
      /**
      * The customFooterContent to remove or its index or id
      */
    vCustomFooterContent: typingsJapgolly.openui5.sapMButtonMod.default
    ...
    def removeCustomHeaderContent(/**
      ...
      */
    vCustomHeaderContent: String): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    /**
    ...
    def removeCustomHeaderContent(/**
      * The customHeaderContent to remove or its index or id
      */
    vCustomHeaderContent: int): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    def removeCustomHeaderContent(
      /**
      * The customHeaderContent to remove or its index or id
      */
    vCustomHeaderContent: typingsJapgolly.openui5.sapMButtonMod.default
    ): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    ...
    def setLandmarkInfo(
      ...
      */
    oLandmarkInfo: typingsJapgolly.openui5.sapMPageAccessibleLandmarkInfoMod.default
    ): this.type = js.native
  ...
  trait SemanticPageSettings
    ...
    /**
      ...
      * If not set, no landmarks will be written.
      */
    var landmarkInfo: js.UndefOr[typingsJapgolly.openui5.sapMPageAccessibleLandmarkInfoMod.default] = js.undefined
  ...
  object SemanticPageSettings {
    ...
    extension [Self <: SemanticPageSettings](x: Self) {
      ...
      inline def setCustomFooterContentVarargs(value: typingsJapgolly.openui5.sapMButtonMod.default*): Self = StObject.set(x, "customFooterContent", js.Array(value*))
      ...
      inline def setCustomHeaderContentVarargs(value: typingsJapgolly.openui5.sapMButtonMod.default*): Self = StObject.set(x, "customHeaderContent", js.Array(value*))
      ...
      inline def setLandmarkInfo(value: typingsJapgolly.openui5.sapMPageAccessibleLandmarkInfoMod.default): Self = StObject.set(x, "landmarkInfo", value.asInstanceOf[js.Any])
      
      inline def setLandmarkInfoUndefined: Self = StObject.set(x, "landmarkInfo", js.undefined)
      
      inline def setNavButtonPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "navButtonPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
