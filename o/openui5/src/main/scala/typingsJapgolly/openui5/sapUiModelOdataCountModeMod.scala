...
object sapUiModelOdataCountModeMod {
  ...
  object default extends StObject {
    ...
    /* "Both" */ val Both: typingsJapgolly.openui5.sapUiModelOdataCountModeMod.CountMode.Both & String = js.native
    
    /* "Inline" */ val Inline: typingsJapgolly.openui5.sapUiModelOdataCountModeMod.CountMode.Inline & String = js.native
    
    /* "InlineRepeat" */ val InlineRepeat: typingsJapgolly.openui5.sapUiModelOdataCountModeMod.CountMode.InlineRepeat & String = js.native
    
    /* "None" */ val None: typingsJapgolly.openui5.sapUiModelOdataCountModeMod.CountMode.None & String = js.native
    
    /* "Request" */ val Request: typingsJapgolly.openui5.sapUiModelOdataCountModeMod.CountMode.Request & String = js.native
  }
