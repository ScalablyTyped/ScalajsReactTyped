...
object sapUiCoreUtilExportRowMod {
  ...
  trait ExportRow
    ...
    def addCell(
      ...
      */
    oCell: typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCells(): js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllCells(): js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default] = js.native
    
    def removeCell(/**
      * The cell to remove or its index or id
      */
    vCell: String): typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default | Null = js.native
    /**
    ...
    def removeCell(/**
      * The cell to remove or its index or id
      */
    vCell: int): typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default | Null = js.native
    def removeCell(
      /**
      * The cell to remove or its index or id
      */
    vCell: typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default
    ): typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default | Null = js.native
  }
  ...
  trait ExportRowSettings
    ...
    var cells: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default] | typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  }
  object ExportRowSettings {
    ...
    extension [Self <: ExportRowSettings](x: Self) {
      ...
      inline def setCells(
        value: js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default] | typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "cells", value.asInstanceOf[js.Any])
      
      inline def setCellsUndefined: Self = StObject.set(x, "cells", js.undefined)
      
      inline def setCellsVarargs(value: typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default*): Self = StObject.set(x, "cells", js.Array(value*))
    }
  }
}
