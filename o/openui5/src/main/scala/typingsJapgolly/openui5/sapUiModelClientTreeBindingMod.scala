...
object sapUiModelClientTreeBindingMod {
  ...
  open class default protected () extends ClientTreeBinding {
    ...
    oContext: Unit,
      ...
      */
    aApplicationFilters: js.Array[typingsJapgolly.openui5.sapUiModelFilterMod.default]
    ) = this()
    def this(
      /**
      * Model instance that this binding is created for and that it belongs to
    ...
    oContext: Unit,
      ...
      * Predefined application filter, either a single instance or an array
      */
    aApplicationFilters: typingsJapgolly.openui5.sapUiModelFilterMod.default
    ) = this()
    def this(
      /**
      * Model instance that this binding is created for and that it belongs to
  ...
  trait ClientTreeBinding
    extends typingsJapgolly.openui5.sapUiModelTreeBindingMod.default {
