...
import typingsJapgolly.openui5.anon.ChangedItem
import typingsJapgolly.openui5.anon.`17`
...
object sapMMultiComboBoxMod {
  ...
  trait MultiComboBox
    ...
    def removeSelectedItem(/**
      * The item to be removed or its ID
      */
    oItem: ID): typingsJapgolly.openui5.sapUiCoreItemMod.default | Null = js.native
    ...
    def removeSelectedKeys(/**
      ...
      */
    aKeys: js.Array[String]): js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default] = js.native
    ...
    def setSelectedItems(
      ...
      * or null.
      */
    aItems: js.Array[String | typingsJapgolly.openui5.sapUiCoreItemMod.default]
    ): this.type = js.native
    ...
    def syncPickerContent(/**
      ...
      */
    bForceListSync: Boolean): typingsJapgolly.openui5.sapMDialogMod.default | typingsJapgolly.openui5.sapMPopoverMod.default = js.native
  }
  ...
  trait MultiComboBoxSettings
    ...
    /**
      ...
      */
    var selectedItems: js.UndefOr[js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default | String]] = js.undefined
  ...
  object MultiComboBoxSettings {
    ...
    extension [Self <: MultiComboBoxSettings](x: Self) {
      ...
      inline def setSelectedItems(value: js.Array[typingsJapgolly.openui5.sapUiCoreItemMod.default | String]): Self = StObject.set(x, "selectedItems", value.asInstanceOf[js.Any])
      
      inline def setSelectedItemsUndefined: Self = StObject.set(x, "selectedItems", js.undefined)
      
      inline def setSelectedItemsVarargs(value: (typingsJapgolly.openui5.sapUiCoreItemMod.default | String)*): Self = StObject.set(x, "selectedItems", js.Array(value*))
      ...
      inline def setSelectionFinish(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "selectionFinish", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
