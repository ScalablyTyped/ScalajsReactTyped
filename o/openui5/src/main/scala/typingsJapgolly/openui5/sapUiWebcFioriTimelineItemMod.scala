...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.ITimelineItem
...
object sapUiWebcFioriTimelineItemMod {
  ...
  object TimelineItemSettings {
    ...
    extension [Self <: TimelineItemSettings](x: Self) {
      ...
      inline def setNameClick(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "nameClick", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
