...
object sapUiCommonsMenuItemMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiUnifiedMenuItemMod.default {
    def this(/**
  ...
  type MenuItem = typingsJapgolly.openui5.sapUiUnifiedMenuItemMod.default
  
  type MenuItemSettings = typingsJapgolly.openui5.sapUiUnifiedMenuItemMod.MenuItemSettings
}
