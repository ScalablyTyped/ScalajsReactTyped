...
object sapUiModelStaticBindingMod {
  
  @JSImport("sap/ui/model/StaticBinding", JSImport.Default)
  @js.native
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, StaticBinding]
  ...
  type StaticBinding = typingsJapgolly.openui5.sapUiModelPropertyBindingMod.default
}
