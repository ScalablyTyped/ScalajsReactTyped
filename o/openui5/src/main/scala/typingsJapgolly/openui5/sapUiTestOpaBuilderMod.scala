...
object sapUiTestOpaBuilderMod {
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    oOpaInstance: typingsJapgolly.openui5.sapUiTestOpa5Mod.default) = this()
    def this(
      /**
      * the Opa5 instance to operate on
      */
    ...
    def this(
      ...
      * the Opa5 instance to operate on
      */
    oOpaInstance: typingsJapgolly.openui5.sapUiTestOpa5Mod.default,
      /**
      * the initial {@link sap.ui.test.Opa5#waitFor} options
      */
    oOptions: js.Object
  ...
  object default {
    ...
    inline def create(
      ...
      * the Opa5 instance to operate on
      */
    oOpaInstance: js.UndefOr[typingsJapgolly.openui5.sapUiTestOpa5Mod.default],
      /**
    ...
    vMatchers: js.UndefOr[
          typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default | js.Function | js.Array[Any] | js.Object
        ],
      /**
      * the actions to be performed on target control(s)
      */
    vActions: js.UndefOr[
          typingsJapgolly.openui5.sapUiTestActionsActionMod.default | js.Function | js.Array[Any]
        ],
      /**
  ...
  trait Actions extends StObject {
    ...
    def conditional(
      ...
      */
    vConditions: typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default | js.Function | js.Array[Any] | js.Object | Boolean,
      /**
      * the actions to be performed when conditions are fulfilled
      */
    vSuccessBuilderOrOptions: typingsJapgolly.openui5.sapUiTestActionsActionMod.default | js.Function | js.Array[Any] | OpaBuilder,
      /**
      * the action(s) to be performed when conditions are not fulfilled
      */
    vElseBuilderOptions: js.UndefOr[
          typingsJapgolly.openui5.sapUiTestActionsActionMod.default | js.Function | js.Array[Any] | OpaBuilder
        ]
    ...
    def enterText(/**
      ...
      */
    sText: String): typingsJapgolly.openui5.sapUiTestActionsEnterTextMod.default = js.native
    def enterText(
      /**
      * defines the {@link sap.ui.test.actions.EnterText#setText} setting
      */
    ...
    ): typingsJapgolly.openui5.sapUiTestActionsEnterTextMod.default = js.native
    def enterText(
      /**
      * defines the {@link sap.ui.test.actions.EnterText#setText} setting
      */
    ...
    def executor(
      ...
      * the actions to be executed
      */
    vActions: typingsJapgolly.openui5.sapUiTestActionsActionMod.default
    ): js.Function = js.native
    ...
    /**
      ...
      */
    def press(): typingsJapgolly.openui5.sapUiTestActionsPressMod.default = js.native
    def press(
      /**
      * the id suffix of the DOM Element the press action will be executed on
      */
    sIdSuffix: String
    ): typingsJapgolly.openui5.sapUiTestActionsPressMod.default = js.native
  }
  @JSImport("sap/ui/test/OpaBuilder", "Actions")
  @js.native
  val Actions: typingsJapgolly.openui5.sapUiTestOpaBuilderMod.Actions = js.native
  ...
  trait Matchers extends StObject {
    ...
    sAggregationName: String,
      ...
      * the matchers to filter aggregation items
      */
    vMatchers: typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default
    ): js.Function = js.native
    ...
    iIndex: int
        ...
        /* p1 */ typingsJapgolly.openui5.sapUiCoreControlMod.default, 
        typingsJapgolly.openui5.sapUiBaseManagedObjectMod.default
      ] = js.native
    ...
    def children(
      ...
      * the matchers to filter child items
      */
    vBuilderOrMatcher: typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default
    ): js.Function = js.native
    def children(
      /**
      * the matchers to filter child items
    ...
    vConditions: typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default | js.Function | js.Array[Any] | js.Object | Boolean,
      ...
      */
    vSuccessMatcher: typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default | js.Function | js.Array[Any] | js.Object,
      /**
    ...
    def some(
      ...
      * aMatchers list of matchers were one must be met
      */
    aMatchers: typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default
    ): js.Function = js.native
  }
  @JSImport("sap/ui/test/OpaBuilder", "Matchers")
  @js.native
  val Matchers: typingsJapgolly.openui5.sapUiTestOpaBuilderMod.Matchers = js.native
  ...
  trait OpaBuilder extends StObject {
    ...
    vConditions: typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default | js.Function | js.Array[Any] | js.Object | Boolean,
      ...
      * the actions to be performed when conditions are fulfilled
      */
    vSuccessActions: typingsJapgolly.openui5.sapUiTestActionsActionMod.default | js.Function | js.Array[Any],
      /**
      * the action(s) to be performed when conditions are not fulfilled
      */
    vElseActions: js.UndefOr[
          typingsJapgolly.openui5.sapUiTestActionsActionMod.default | js.Function | js.Array[Any]
        ]
    ): this.type = js.native
    ...
    def doOnChildren(
      ...
      * the child builder or child matcher
      */
    vChildBuilderOrMatcher: typingsJapgolly.openui5.sapUiTestMatchersMatcherMod.default
    ): this.type = js.native
    def doOnChildren(
      /**
      * the child builder or child matcher
    ...
    /**
      ...
      */
    def getOpaInstance(): typingsJapgolly.openui5.sapUiTestOpa5Mod.default = js.native
