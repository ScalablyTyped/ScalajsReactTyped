...
import typingsJapgolly.openui5.anon.SelectedIndex
...
object sapMRadioButtonGroupMod {
  ...
  trait RadioButtonGroup
    ...
    def addButton(
      ...
      */
    oButton: typingsJapgolly.openui5.sapMRadioButtonMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getButtons(): js.Array[typingsJapgolly.openui5.sapMRadioButtonMod.default] = js.native
    ...
    /**
      ...
      * @returns The selected radio button.
      */
    def getSelectedButton(): typingsJapgolly.openui5.sapMRadioButtonMod.default = js.native
    ...
    /**
      ...
      */
    def removeAllButtons(): js.Array[typingsJapgolly.openui5.sapMRadioButtonMod.default] = js.native
    ...
    /**
      ...
      */
    def removeButton(): typingsJapgolly.openui5.sapMRadioButtonMod.default = js.native
    ...
    def setSelectedButton(
      ...
      */
    oSelectedButton: typingsJapgolly.openui5.sapMRadioButtonMod.default
    ): this.type = js.native
  ...
  trait RadioButtonGroupSettings
    ...
    var buttons: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMRadioButtonMod.default] | typingsJapgolly.openui5.sapMRadioButtonMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object RadioButtonGroupSettings {
    ...
    extension [Self <: RadioButtonGroupSettings](x: Self) {
      ...
      inline def setButtons(
        value: js.Array[typingsJapgolly.openui5.sapMRadioButtonMod.default] | typingsJapgolly.openui5.sapMRadioButtonMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
      
      inline def setButtonsUndefined: Self = StObject.set(x, "buttons", js.undefined)
      
      inline def setButtonsVarargs(value: typingsJapgolly.openui5.sapMRadioButtonMod.default*): Self = StObject.set(x, "buttons", js.Array(value*))
