...
object sapMObjectAttributeMod {
  ...
  trait ObjectAttribute
    ...
    /**
      ...
      */
    def getCustomContent(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setCustomContent(
      ...
      */
    oCustomContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
  ...
  trait ObjectAttributeSettings
    ...
    /**
      ...
      * **Note:** It will only allow sap.m.Text and sap.m.Link controls.
      */
    var customContent: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object ObjectAttributeSettings {
    ...
    extension [Self <: ObjectAttributeSettings](x: Self) {
      ...
      inline def setCustomContent(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "customContent", value.asInstanceOf[js.Any])
