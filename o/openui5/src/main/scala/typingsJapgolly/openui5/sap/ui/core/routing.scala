...
object routing extends js.Object {
  ...
  class History protected () extends js.Object {
    ...
    /**
      ...
      */
    def getInstance(): typingsJapgolly.openui5.sap.ui.core.routing.History = js.native
    /**
  ...
  class Route protected () extends EventProvider {
    /**
      ...
      * provided).
      */
    def this(The: typingsJapgolly.openui5.sap.m.routing.Router, oConfig: js.Any) = this()
    def this(The: typingsJapgolly.openui5.sap.m.routing.Router, oConfig: js.Any, oParent: Route) = this()
    /**
  ...
  class Router protected () extends EventProvider {
    ...
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def attachBypassed(oData: js.Any, fnFunction: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    def attachBypassed(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def attachRouteMatched(oData: js.Any, fnFunction: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    def attachRouteMatched(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def attachRoutePatternMatched(oData: js.Any, fnFunction: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    def attachRoutePatternMatched(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def attachViewCreated(oData: js.Any, fnFunction: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    def attachViewCreated(oData: js.Any, fnFunction: js.Any, oListener: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      * Removes the router from the hash changer @see sap.ui.core.routing.HashChanger
      * @returns this for chaining.
      */
    def destroy(): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def detachBypassed(fnFunction: js.Any, oListener: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def detachRouteMatched(fnFunction: js.Any, oListener: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def detachRoutePatternMatched(fnFunction: js.Any, oListener: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def detachViewCreated(fnFunction: js.Any, oListener: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def fireBypassed(mArguments: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      * Fire event routeMatched to attached listeners.
      * @param mArguments the arguments to pass along with the event.
      * @returns <code>this</code> to allow method chaining
      */
    def fireRouteMatched(mArguments: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns <code>this</code> to allow method chaining
      */
    def fireRoutePatternMatched(mArguments: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      * Fire event viewCreated to attached listeners.
      * @param mArguments the arguments to pass along with the event.
      * @returns <code>this</code> to allow method chaining
      */
    def fireViewCreated(mArguments: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
    ...
    /**
      ...
      */
    def getRouter(sName: String): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
    ...
    /**
      ...
      * @returns this for chaining.
      */
    def initialize(): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      ...
      * @returns this for chaining.
      */
    def navTo(sName: String): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    def navTo(sName: String, oParameters: js.Any): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    def navTo(sName: String, oParameters: js.Any, bReplace: Boolean): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
    ...
    /**
      ...
      */
    def setView(sViewName: String, oView: View): typingsJapgolly.openui5.sap.m.routing.Router = js.native
    /**
      * Stops to listen to the hashChange of the browser.</br>If you want the router to start again, call
      * initialize again.
      * @returns this for chaining.
      */
    def stop(): typingsJapgolly.openui5.sap.m.routing.Router = js.native
  }
