...
object AccessibleRole extends js.Object {
  ...
  /* 22 */ @js.native
  object ListItem
    extends TopLevel[typingsJapgolly.openui5.sap.ui.core.AccessibleRole.ListItem with Double]
  ...
  /* 53 */ @js.native
  object Toolbar
    extends TopLevel[typingsJapgolly.openui5.sap.ui.core.AccessibleRole.Toolbar with Double]
