...
import typingsJapgolly.openui5.sapMLibraryMod.IBadge
import typingsJapgolly.openui5.sapMLibraryMod.IconTab
import typingsJapgolly.openui5.sapMLibraryMod.IconTabFilterDesign
...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.IconColor
...
object sapMIconTabFilterMod {
  ...
  object IconTabFilterSettings {
    ...
    extension [Self <: IconTabFilterSettings](x: Self) {
