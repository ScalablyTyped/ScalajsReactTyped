...
object sapMActionSheetMod {
  ...
  object ActionSheetSettings {
    ...
    extension [Self <: ActionSheetSettings](x: Self) {
      ...
      inline def setCancelButtonPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "cancelButtonPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setCancelButtonPressUndefined: Self = StObject.set(x, "cancelButtonPress", js.undefined)
      
      inline def setCancelButtonTap(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "cancelButtonTap", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
