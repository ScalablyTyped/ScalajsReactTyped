...
import typingsJapgolly.openui5.anon.Height
...
import typingsJapgolly.openui5.sapUiCommonsLibraryMod.enums.BorderDesign
import typingsJapgolly.openui5.sapUiCoreControlMod.ControlSettings
import typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleRole
import typingsJapgolly.openui5.sapUiCoreLibraryMod.CSSSize
import typingsJapgolly.openui5.sapUiCoreLibraryMod.ID
import typingsJapgolly.openui5.sapUiCoreLibraryMod.OpenState
...
object sapUiCommonsDialogMod {
  ...
  trait Dialog
    ...
    def setDefaultButton(
      ...
      */
    oDefaultButton: typingsJapgolly.openui5.sapUiCommonsButtonMod.default
    ): this.type = js.native
    /**
  ...
  trait DialogSettings
    ...
    /**
      ...
      */
    var defaultButton: js.UndefOr[typingsJapgolly.openui5.sapUiCommonsButtonMod.default | String] = js.undefined
  ...
  object DialogSettings {
    ...
    extension [Self <: DialogSettings](x: Self) {
      ...
      inline def setDefaultButton(value: typingsJapgolly.openui5.sapUiCommonsButtonMod.default | String): Self = StObject.set(x, "defaultButton", value.asInstanceOf[js.Any])
