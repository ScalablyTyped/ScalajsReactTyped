...
object sapUiUx3DataSetSimpleViewMod {
  ...
  trait DataSetSimpleView
    ...
    /**
      ...
      */
    def exitView(aItems: js.Array[typingsJapgolly.openui5.sapUiUx3DataSetItemMod.default]): Unit = js.native
    ...
    /**
      ...
      * template
      */
    def getTemplate(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def handleSelection(/**
      ...
      */
    oEvent: typingsJapgolly.openui5.sapUiBaseEventMod.default): Unit = js.native
    ...
    def isItemSelected(/**
      ...
      */
    oItem: typingsJapgolly.openui5.sapUiUx3DataSetItemMod.default): Unit = js.native
    ...
    def setTemplate(/**
      * The template to set
      */
    oTemplate: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
    ...
    def updateView(
      ...
      * Array of DataSetItems added to the parent DataSet
      */
    aDiff: js.Array[typingsJapgolly.openui5.sapUiUx3DataSetItemMod.default]
    ): Unit = js.native
  }
  ...
  trait DataSetSimpleViewSettings
    ...
    /**
      * template
      */
    var template: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  }
  object DataSetSimpleViewSettings {
    ...
    extension [Self <: DataSetSimpleViewSettings](x: Self) {
      ...
      inline def setTemplate(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
