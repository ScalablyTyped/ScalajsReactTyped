...
import typingsJapgolly.openui5.sapMLibraryMod.FacetFilterType
...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.IShrinkable
...
object sapMFacetFilterMod {
  ...
  trait FacetFilter
    ...
    def addList(
      ...
      */
    oList: typingsJapgolly.openui5.sapMFacetFilterListMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getLists(): js.Array[typingsJapgolly.openui5.sapMFacetFilterListMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllLists(): js.Array[typingsJapgolly.openui5.sapMFacetFilterListMod.default] = js.native
    
    def removeList(/**
      * The list to remove or its index or id
      */
    vList: String): typingsJapgolly.openui5.sapMFacetFilterListMod.default | Null = js.native
    /**
    ...
    def removeList(/**
      * The list to remove or its index or id
      */
    vList: int): typingsJapgolly.openui5.sapMFacetFilterListMod.default | Null = js.native
    def removeList(
      /**
      * The list to remove or its index or id
      */
    vList: typingsJapgolly.openui5.sapMFacetFilterListMod.default
    ): typingsJapgolly.openui5.sapMFacetFilterListMod.default | Null = js.native
  ...
  trait FacetFilterSettings
    ...
    var lists: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMFacetFilterListMod.default] | typingsJapgolly.openui5.sapMFacetFilterListMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object FacetFilterSettings {
    ...
    extension [Self <: FacetFilterSettings](x: Self) {
      ...
      inline def setLists(
        value: js.Array[typingsJapgolly.openui5.sapMFacetFilterListMod.default] | typingsJapgolly.openui5.sapMFacetFilterListMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "lists", value.asInstanceOf[js.Any])
      
      inline def setListsUndefined: Self = StObject.set(x, "lists", js.undefined)
      
      inline def setListsVarargs(value: typingsJapgolly.openui5.sapMFacetFilterListMod.default*): Self = StObject.set(x, "lists", js.Array(value*))
