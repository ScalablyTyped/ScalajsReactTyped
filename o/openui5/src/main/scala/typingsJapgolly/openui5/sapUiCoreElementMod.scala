...
import typingsJapgolly.openui5.anon.PreventScroll
import typingsJapgolly.openui5.anon.`27`
...
import typingsJapgolly.openui5.sapUiBaseManagedObjectMod.ObjectBindingInfo
...
object sapUiCoreElementMod {
  ...
  object default {
    ...
    ): typingsJapgolly.openui5.sapUiCoreElementMetadataMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("defineClass")(sClassName.asInstanceOf[js.Any], oStaticInfo.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.openui5.sapUiCoreElementMetadataMod.default]
    inline def defineClass(
      /**
      * name of the class to build the metadata for
      */
    ...
    ): typingsJapgolly.openui5.sapUiCoreElementMetadataMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("defineClass")(sClassName.asInstanceOf[js.Any], oStaticInfo.asInstanceOf[js.Any], fnMetaImpl.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.openui5.sapUiCoreElementMetadataMod.default]
  ...
  @js.native
  val registry: typingsJapgolly.openui5.sapUiCoreElementMod.registry = js.native
  ...
  trait ElementSettings
    ...
    var customData: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCoreCustomDataMod.default] | typingsJapgolly.openui5.sapUiCoreCustomDataMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    var dragDropConfig: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default] | typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      */
    var layoutData: js.UndefOr[typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default] = js.undefined
  ...
  object ElementSettings {
    ...
    extension [Self <: ElementSettings](x: Self) {
      ...
      inline def setCustomData(
        value: js.Array[typingsJapgolly.openui5.sapUiCoreCustomDataMod.default] | typingsJapgolly.openui5.sapUiCoreCustomDataMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "customData", value.asInstanceOf[js.Any])
      
      inline def setCustomDataUndefined: Self = StObject.set(x, "customData", js.undefined)
      
      inline def setCustomDataVarargs(value: typingsJapgolly.openui5.sapUiCoreCustomDataMod.default*): Self = StObject.set(x, "customData", js.Array(value*))
      ...
      inline def setDragDropConfig(
        value: js.Array[typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default] | typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setDragDropConfigVarargs(value: typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default*): Self = StObject.set(x, "dragDropConfig", js.Array(value*))
      
      inline def setLayoutData(value: typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default): Self = StObject.set(x, "layoutData", value.asInstanceOf[js.Any])
      
      inline def setLayoutDataUndefined: Self = StObject.set(x, "layoutData", js.undefined)
      
      inline def setTooltip(value: String | typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default | PropertyBindingInfo): Self = StObject.set(x, "tooltip", value.asInstanceOf[js.Any])
  ...
  trait UI5Element
    ...
    def addCustomData(
      ...
      */
    oCustomData: typingsJapgolly.openui5.sapUiCoreCustomDataMod.default
    ): this.type = js.native
    ...
    def addDragDropConfig(
      ...
      */
    oDragDropConfig: typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * Custom Data, a data structure like a map containing arbitrary key value pairs.
      */
    def getCustomData(): js.Array[typingsJapgolly.openui5.sapUiCoreCustomDataMod.default] = js.native
    ...
    /**
      ...
      * {@link sap.ui.core.Element.extend metadata} restrictions.
      */
    def getDragDropConfig(): js.Array[typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default] = js.native
    ...
    /**
      ...
      */
    def getElementBinding(): js.UndefOr[typingsJapgolly.openui5.sapUiModelContextBindingMod.default] = js.native
    def getElementBinding(/**
      * Name of the model or `undefined`
      */
    sModelName: String): js.UndefOr[typingsJapgolly.openui5.sapUiModelContextBindingMod.default] = js.native
    ...
    /**
      ...
      * LayoutData instances to a single Element.
      */
    def getLayoutData(): typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default = js.native
    ...
    /**
      ...
      */
    def getTooltip(): String | typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default | Null = js.native
    ...
    /**
      ...
      */
    def removeAllCustomData(): js.Array[typingsJapgolly.openui5.sapUiCoreCustomDataMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllDragDropConfig(): js.Array[typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default] = js.native
    
    def removeCustomData(/**
      * The customData to remove or its index or id
      */
    vCustomData: String): typingsJapgolly.openui5.sapUiCoreCustomDataMod.default | Null = js.native
    /**
    ...
    def removeCustomData(/**
      * The customData to remove or its index or id
      */
    vCustomData: int): typingsJapgolly.openui5.sapUiCoreCustomDataMod.default | Null = js.native
    def removeCustomData(
      /**
      * The customData to remove or its index or id
      */
    vCustomData: typingsJapgolly.openui5.sapUiCoreCustomDataMod.default
    ): typingsJapgolly.openui5.sapUiCoreCustomDataMod.default | Null = js.native
    ...
    def removeDragDropConfig(/**
      ...
      */
    vDragDropConfig: String): typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default | Null = js.native
    /**
      * @SINCE 1.56
      *
    ...
    def removeDragDropConfig(/**
      * The dragDropConfig to remove or its index or id
      */
    vDragDropConfig: int): typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default | Null = js.native
    def removeDragDropConfig(
      /**
      * The dragDropConfig to remove or its index or id
      */
    vDragDropConfig: typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default
    ): typingsJapgolly.openui5.sapUiCoreDndDragDropBaseMod.default | Null = js.native
    ...
    def setLayoutData(
      ...
      * which should be set
      */
    oLayoutData: typingsJapgolly.openui5.sapUiCoreLayoutDataMod.default
    ): this.type = js.native
    ...
    def setTooltip(/**
      * New tooltip
      */
    vTooltip: typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default): this.type = js.native
    ...
    /**
      ...
      * @returns reference to the instance itself
      */
    def unbindElement(sModelName: String): typingsJapgolly.openui5.sapUiBaseManagedObjectMod.default = js.native
  }
}
