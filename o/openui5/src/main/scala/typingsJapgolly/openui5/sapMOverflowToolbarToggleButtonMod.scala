...
import typingsJapgolly.openui5.sapMToggleButtonMod.ToggleButtonSettings
...
object sapMOverflowToolbarToggleButtonMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMToggleButtonMod.default {
    def this(/**
  ...
  type OverflowToolbarToggleButton = typingsJapgolly.openui5.sapMToggleButtonMod.default
