...
import typingsJapgolly.openui5.sapMLibraryMod.ResetAllMode
...
object sapMTablePersoControllerMod {
  ...
  trait TablePersoController
    ...
    def addTable(
      ...
      */
    vTable: typingsJapgolly.openui5.sapMTableMod.default
    ): this.type = js.native
    /**
    ...
    def applyPersonalizations(/**
      ...
      */
    oTable: typingsJapgolly.openui5.sapMTableMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def getTablePersoDialog(): typingsJapgolly.openui5.sapMTablePersoDialogMod.default = js.native
    ...
    def setTable(
      ...
      * may be given
      */
    oTable: typingsJapgolly.openui5.sapMTableMod.default
    ): this.type = js.native
    /**
  ...
  trait TablePersoControllerSettings
    ...
    var table: js.UndefOr[typingsJapgolly.openui5.sapMTableMod.default | String] = js.undefined
    
    /**
      * Also several tables may be personalized at once given they have same columns.
      */
    var tables: js.UndefOr[js.Array[typingsJapgolly.openui5.sapMTableMod.default | String]] = js.undefined
  }
  object TablePersoControllerSettings {
    ...
    extension [Self <: TablePersoControllerSettings](x: Self) {
      ...
      inline def setPersonalizationsDone(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "personalizationsDone", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setTable(value: typingsJapgolly.openui5.sapMTableMod.default | String): Self = StObject.set(x, "table", value.asInstanceOf[js.Any])
      
      inline def setTableUndefined: Self = StObject.set(x, "table", js.undefined)
      
      inline def setTables(value: js.Array[typingsJapgolly.openui5.sapMTableMod.default | String]): Self = StObject.set(x, "tables", value.asInstanceOf[js.Any])
      
      inline def setTablesUndefined: Self = StObject.set(x, "tables", js.undefined)
      
      inline def setTablesVarargs(value: (typingsJapgolly.openui5.sapMTableMod.default | String)*): Self = StObject.set(x, "tables", js.Array(value*))
    }
  }
}
