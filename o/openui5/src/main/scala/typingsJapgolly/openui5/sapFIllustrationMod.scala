...
object sapFIllustrationMod {
  
  @JSImport("sap/f/Illustration", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMIllustrationMod.default {
    def this(/**
  ...
  type Illustration = typingsJapgolly.openui5.sapMIllustrationMod.default
  
  type IllustrationSettings = typingsJapgolly.openui5.sapMIllustrationMod.IllustrationSettings
}
