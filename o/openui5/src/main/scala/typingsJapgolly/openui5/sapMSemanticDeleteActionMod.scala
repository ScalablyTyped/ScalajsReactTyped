...
object sapMSemanticDeleteActionMod {
  
  @JSImport("sap/m/semantic/DeleteAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: DeleteActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, DeleteAction]
  ...
  type DeleteAction = typingsJapgolly.openui5.sapMSemanticSemanticButtonMod.default
  
  type DeleteActionSettings = SemanticButtonSettings
}
