...
object ISemanticFormContent {
  ...
  extension [Self <: ISemanticFormContent](x: Self) {
    ...
    inline def setGetFormFormattedValue(value: CallbackTo[String | js.Promise[Any]]): Self = StObject.set(x, "getFormFormattedValue", value.toJsFn)
    
    inline def setGetFormFormattedValueUndefined: Self = StObject.set(x, "getFormFormattedValue", js.undefined)
    
    inline def setGetFormValueProperty(value: CallbackTo[String]): Self = StObject.set(x, "getFormValueProperty", value.toJsFn)
