...
object TextDirection extends StObject {
  ...
  sealed trait Inherit
    extends StObject
       with TextDirection
  /* "Inherit" */ val Inherit: typingsJapgolly.openui5.sapUiCoreLibraryMod.TextDirection.Inherit & String = js.native
  ...
  sealed trait LTR
    extends StObject
       with TextDirection
  /* "LTR" */ val LTR: typingsJapgolly.openui5.sapUiCoreLibraryMod.TextDirection.LTR & String = js.native
  ...
  sealed trait RTL
    extends StObject
       with TextDirection
  /* "RTL" */ val RTL: typingsJapgolly.openui5.sapUiCoreLibraryMod.TextDirection.RTL & String = js.native
}
