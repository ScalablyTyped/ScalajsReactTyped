...
object dnd {
  ...
  object DropEffect extends StObject {
    ...
    sealed trait Copy
      extends StObject
         with DropEffect
    /* "Copy" */ val Copy: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropEffect.Copy & String = js.native
    ...
    sealed trait Link
      extends StObject
         with DropEffect
    /* "Link" */ val Link: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropEffect.Link & String = js.native
    ...
    sealed trait Move
      extends StObject
         with DropEffect
    /* "Move" */ val Move: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropEffect.Move & String = js.native
    ...
    sealed trait None
      extends StObject
         with DropEffect
    /* "None" */ val None: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropEffect.None & String = js.native
  }
  ...
  object DropLayout extends StObject {
    ...
    sealed trait Default
      extends StObject
         with DropLayout
    /* "Default" */ val Default: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropLayout.Default & String = js.native
    ...
    sealed trait Horizontal
      extends StObject
         with DropLayout
    /* "Horizontal" */ val Horizontal: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropLayout.Horizontal & String = js.native
    ...
    sealed trait Vertical
      extends StObject
         with DropLayout
    /* "Vertical" */ val Vertical: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropLayout.Vertical & String = js.native
  }
  ...
  object DropPosition extends StObject {
    ...
    sealed trait Between
      extends StObject
         with DropPosition
    /* "Between" */ val Between: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropPosition.Between & String = js.native
    ...
    sealed trait On
      extends StObject
         with DropPosition
    /* "On" */ val On: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropPosition.On & String = js.native
    ...
    sealed trait OnOrBetween
      extends StObject
         with DropPosition
    /* "OnOrBetween" */ val OnOrBetween: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.DropPosition.OnOrBetween & String = js.native
  }
  ...
  object RelativeDropPosition extends StObject {
    ...
    /* "After" */ val After: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.RelativeDropPosition.After & String = js.native
    ...
    sealed trait Before
      extends StObject
         with RelativeDropPosition
    /* "Before" */ val Before: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.RelativeDropPosition.Before & String = js.native
    ...
    sealed trait On
      extends StObject
         with RelativeDropPosition
    /* "On" */ val On: typingsJapgolly.openui5.sapUiCoreLibraryMod.dnd.RelativeDropPosition.On & String = js.native
  }
