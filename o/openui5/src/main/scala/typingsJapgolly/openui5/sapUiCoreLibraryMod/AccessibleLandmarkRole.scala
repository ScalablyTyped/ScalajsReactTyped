...
object AccessibleLandmarkRole extends StObject {
  ...
  /* "Banner" */ val Banner: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.Banner & String = js.native
  ...
  sealed trait Complementary
    extends StObject
       with AccessibleLandmarkRole
  /* "Complementary" */ val Complementary: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.Complementary & String = js.native
  ...
  sealed trait ContentInfo
    extends StObject
       with AccessibleLandmarkRole
  /* "ContentInfo" */ val ContentInfo: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.ContentInfo & String = js.native
  ...
  sealed trait Form
    extends StObject
       with AccessibleLandmarkRole
  /* "Form" */ val Form: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.Form & String = js.native
  ...
  sealed trait Main
    extends StObject
       with AccessibleLandmarkRole
  /* "Main" */ val Main: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.Main & String = js.native
  ...
  sealed trait Navigation
    extends StObject
       with AccessibleLandmarkRole
  /* "Navigation" */ val Navigation: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.Navigation & String = js.native
  ...
  sealed trait None
    extends StObject
       with AccessibleLandmarkRole
  /* "None" */ val None: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.None & String = js.native
  ...
  sealed trait Region
    extends StObject
       with AccessibleLandmarkRole
  /* "Region" */ val Region: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.Region & String = js.native
  ...
  sealed trait Search
    extends StObject
       with AccessibleLandmarkRole
  /* "Search" */ val Search: typingsJapgolly.openui5.sapUiCoreLibraryMod.AccessibleLandmarkRole.Search & String = js.native
}
