...
object Design extends StObject {
  ...
  sealed trait Monospace
    extends StObject
       with Design
  /* "Monospace" */ val Monospace: typingsJapgolly.openui5.sapUiCoreLibraryMod.Design.Monospace & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with Design
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiCoreLibraryMod.Design.Standard & String = js.native
}
