...
object OpenState extends StObject {
  ...
  sealed trait CLOSED
    extends StObject
       with OpenState
  /* "CLOSED" */ val CLOSED: typingsJapgolly.openui5.sapUiCoreLibraryMod.OpenState.CLOSED & String = js.native
  ...
  sealed trait CLOSING
    extends StObject
       with OpenState
  /* "CLOSING" */ val CLOSING: typingsJapgolly.openui5.sapUiCoreLibraryMod.OpenState.CLOSING & String = js.native
  ...
  sealed trait OPEN
    extends StObject
       with OpenState
  /* "OPEN" */ val OPEN: typingsJapgolly.openui5.sapUiCoreLibraryMod.OpenState.OPEN & String = js.native
  ...
  sealed trait OPENING
    extends StObject
       with OpenState
  /* "OPENING" */ val OPENING: typingsJapgolly.openui5.sapUiCoreLibraryMod.OpenState.OPENING & String = js.native
}
