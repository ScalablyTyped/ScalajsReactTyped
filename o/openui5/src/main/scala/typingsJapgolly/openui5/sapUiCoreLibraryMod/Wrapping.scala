...
object Wrapping extends StObject {
  ...
  sealed trait Hard
    extends StObject
       with Wrapping
  /* "Hard" */ val Hard: typingsJapgolly.openui5.sapUiCoreLibraryMod.Wrapping.Hard & String = js.native
  ...
  sealed trait None
    extends StObject
       with Wrapping
  /* "None" */ val None: typingsJapgolly.openui5.sapUiCoreLibraryMod.Wrapping.None & String = js.native
  ...
  sealed trait Off
    extends StObject
       with Wrapping
  /* "Off" */ val Off: typingsJapgolly.openui5.sapUiCoreLibraryMod.Wrapping.Off & String = js.native
  ...
  sealed trait Soft
    extends StObject
       with Wrapping
  /* "Soft" */ val Soft: typingsJapgolly.openui5.sapUiCoreLibraryMod.Wrapping.Soft & String = js.native
}
