...
object routing {
  ...
  object HistoryDirection extends StObject {
    ...
    /* "Backwards" */ val Backwards: typingsJapgolly.openui5.sapUiCoreLibraryMod.routing.HistoryDirection.Backwards & String = js.native
    ...
    sealed trait Forwards
      extends StObject
         with HistoryDirection
    /* "Forwards" */ val Forwards: typingsJapgolly.openui5.sapUiCoreLibraryMod.routing.HistoryDirection.Forwards & String = js.native
    ...
    sealed trait NewEntry
      extends StObject
         with HistoryDirection
    /* "NewEntry" */ val NewEntry: typingsJapgolly.openui5.sapUiCoreLibraryMod.routing.HistoryDirection.NewEntry & String = js.native
    ...
    sealed trait Unknown
      extends StObject
         with HistoryDirection
    /* "Unknown" */ val Unknown: typingsJapgolly.openui5.sapUiCoreLibraryMod.routing.HistoryDirection.Unknown & String = js.native
  }
}
