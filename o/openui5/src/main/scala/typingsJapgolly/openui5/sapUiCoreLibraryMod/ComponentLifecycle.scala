...
object ComponentLifecycle extends StObject {
  ...
  /* "Application" */ val Application: typingsJapgolly.openui5.sapUiCoreLibraryMod.ComponentLifecycle.Application & String = js.native
  ...
  sealed trait Container
    extends StObject
       with ComponentLifecycle
  /* "Container" */ val Container: typingsJapgolly.openui5.sapUiCoreLibraryMod.ComponentLifecycle.Container & String = js.native
  ...
  sealed trait Legacy
    extends StObject
       with ComponentLifecycle
  /* "Legacy" */ val Legacy: typingsJapgolly.openui5.sapUiCoreLibraryMod.ComponentLifecycle.Legacy & String = js.native
}
