...
object ScrollBarAction extends StObject {
  ...
  /* "Drag" */ val Drag: typingsJapgolly.openui5.sapUiCoreLibraryMod.ScrollBarAction.Drag & String = js.native
  ...
  sealed trait MouseWheel
    extends StObject
       with ScrollBarAction
  /* "MouseWheel" */ val MouseWheel: typingsJapgolly.openui5.sapUiCoreLibraryMod.ScrollBarAction.MouseWheel & String = js.native
  ...
  sealed trait Page
    extends StObject
       with ScrollBarAction
  /* "Page" */ val Page: typingsJapgolly.openui5.sapUiCoreLibraryMod.ScrollBarAction.Page & String = js.native
  ...
  sealed trait Step
    extends StObject
       with ScrollBarAction
  /* "Step" */ val Step: typingsJapgolly.openui5.sapUiCoreLibraryMod.ScrollBarAction.Step & String = js.native
}
