...
object InvisibleMessageMode extends StObject {
  ...
  /* "Assertive" */ val Assertive: typingsJapgolly.openui5.sapUiCoreLibraryMod.InvisibleMessageMode.Assertive & String = js.native
  ...
  sealed trait Polite
    extends StObject
       with InvisibleMessageMode
  /* "Polite" */ val Polite: typingsJapgolly.openui5.sapUiCoreLibraryMod.InvisibleMessageMode.Polite & String = js.native
}
