...
object sapMQuickViewPageMod {
  ...
  trait QuickViewPage
    ...
    def addGroup(
      ...
      */
    oGroup: typingsJapgolly.openui5.sapMQuickViewGroupMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getGroups(): js.Array[typingsJapgolly.openui5.sapMQuickViewGroupMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllGroups(): js.Array[typingsJapgolly.openui5.sapMQuickViewGroupMod.default] = js.native
    
    def removeGroup(/**
      * The group to remove or its index or id
      */
    vGroup: String): typingsJapgolly.openui5.sapMQuickViewGroupMod.default | Null = js.native
    /**
    ...
    def removeGroup(/**
      * The group to remove or its index or id
      */
    vGroup: int): typingsJapgolly.openui5.sapMQuickViewGroupMod.default | Null = js.native
    def removeGroup(
      /**
      * The group to remove or its index or id
      */
    vGroup: typingsJapgolly.openui5.sapMQuickViewGroupMod.default
    ): typingsJapgolly.openui5.sapMQuickViewGroupMod.default | Null = js.native
  ...
  trait QuickViewPageSettings
    ...
    var groups: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMQuickViewGroupMod.default] | typingsJapgolly.openui5.sapMQuickViewGroupMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object QuickViewPageSettings {
    ...
    extension [Self <: QuickViewPageSettings](x: Self) {
      ...
      inline def setGroups(
        value: js.Array[typingsJapgolly.openui5.sapMQuickViewGroupMod.default] | typingsJapgolly.openui5.sapMQuickViewGroupMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "groups", value.asInstanceOf[js.Any])
      
      inline def setGroupsUndefined: Self = StObject.set(x, "groups", js.undefined)
      
      inline def setGroupsVarargs(value: typingsJapgolly.openui5.sapMQuickViewGroupMod.default*): Self = StObject.set(x, "groups", js.Array(value*))
