...
import typingsJapgolly.openui5.anon.ClearTarget
...
object sapUiCoreRoutingRouteMod {
  ...
  open class default protected () extends Route {
    ...
    def this(
      ...
      */
    oRouter: typingsJapgolly.openui5.sapUiCoreRoutingRouterMod.default,
      /**
  ...
  trait Route
    ...
    /**
      ...
      * @returns Reference to `this` in order to allow method chaining
      */
    def fireBeforeMatched(): typingsJapgolly.openui5.sapUiCoreRoutingRouterMod.default = js.native
    def fireBeforeMatched(/**
      * Parameters to pass along with the event
      */
    oParameters: js.Object): typingsJapgolly.openui5.sapUiCoreRoutingRouterMod.default = js.native
