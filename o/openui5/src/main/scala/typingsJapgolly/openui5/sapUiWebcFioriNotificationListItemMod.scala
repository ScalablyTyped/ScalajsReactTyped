...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.INotificationAction
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.INotificationListItem
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.Priority
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.WrappingType
...
object sapUiWebcFioriNotificationListItemMod {
  ...
  trait NotificationListItem
    ...
    def addFootnote(
      ...
      */
    oFootnote: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFootnotes(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllFootnotes(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeFootnote(/**
      * The footnote to remove or its index or id
      */
    vFootnote: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeFootnote(/**
      * The footnote to remove or its index or id
      */
    vFootnote: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeFootnote(
      /**
      * The footnote to remove or its index or id
      */
    vFootnote: typingsJapgolly.openui5.sapUiCoreControlMod.default
  ...
  object NotificationListItemSettings {
    ...
    extension [Self <: NotificationListItemSettings](x: Self) {
      ...
      inline def setFootnotesVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "footnotes", js.Array(value*))
