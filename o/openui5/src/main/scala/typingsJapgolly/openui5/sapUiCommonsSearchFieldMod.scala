...
object sapUiCommonsSearchFieldMod {
  ...
  trait SearchField
    ...
    /**
      ...
      */
    def getSearchProvider(): typingsJapgolly.openui5.sapUiCoreSearchSearchProviderMod.default = js.native
    ...
    def setSearchProvider(
      ...
      */
    oSearchProvider: typingsJapgolly.openui5.sapUiCoreSearchSearchProviderMod.default
    ): this.type = js.native
  ...
  trait SearchFieldSettings
    ...
    /**
      * Search provider instance which handles the suggestions for this SearchField (e.g. Open Search Protocol).
      */
    var searchProvider: js.UndefOr[typingsJapgolly.openui5.sapUiCoreSearchSearchProviderMod.default] = js.undefined
  ...
  object SearchFieldSettings {
    ...
    extension [Self <: SearchFieldSettings](x: Self) {
      ...
      inline def setSearchProvider(value: typingsJapgolly.openui5.sapUiCoreSearchSearchProviderMod.default): Self = StObject.set(x, "searchProvider", value.asInstanceOf[js.Any])
