...
import typingsJapgolly.openui5.anon.Component
import typingsJapgolly.openui5.anon.`26`
...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.ComponentLifecycle
...
object sapUiCoreComponentContainerMod {
  ...
  trait ComponentContainer
    ...
    def setComponent(
      ...
      * instance may be given.
      */
    vComponent: typingsJapgolly.openui5.sapUiCoreUicomponentMod.default
    ): this.type = js.native
  ...
  trait ComponentContainerSettings
    ...
    /**
      ...
      */
    var component: js.UndefOr[typingsJapgolly.openui5.sapUiCoreUicomponentMod.default | String] = js.undefined
  ...
  object ComponentContainerSettings {
    ...
    extension [Self <: ComponentContainerSettings](x: Self) {
      ...
      inline def setComponent(value: typingsJapgolly.openui5.sapUiCoreUicomponentMod.default | String): Self = StObject.set(x, "component", value.asInstanceOf[js.Any])
      
      inline def setComponentCreated(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "componentCreated", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setComponentCreatedUndefined: Self = StObject.set(x, "componentCreated", js.undefined)
      
      inline def setComponentFailed(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "componentFailed", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
