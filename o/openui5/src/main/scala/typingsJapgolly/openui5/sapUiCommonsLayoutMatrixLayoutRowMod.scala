...
object sapUiCommonsLayoutMatrixLayoutRowMod {
  ...
  trait MatrixLayoutRow
    ...
    def addCell(
      ...
      */
    oCell: typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCells(): js.Array[typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllCells(): js.Array[typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default] = js.native
    
    def removeCell(/**
      * The cell to remove or its index or id
      */
    vCell: String): typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default | Null = js.native
    /**
    ...
    def removeCell(/**
      * The cell to remove or its index or id
      */
    vCell: int): typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default | Null = js.native
    def removeCell(
      /**
      * The cell to remove or its index or id
      */
    vCell: typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default
    ): typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default | Null = js.native
  ...
  trait MatrixLayoutRowSettings
    ...
    var cells: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default] | typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object MatrixLayoutRowSettings {
    ...
    extension [Self <: MatrixLayoutRowSettings](x: Self) {
      ...
      inline def setCells(
        value: js.Array[typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default] | typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "cells", value.asInstanceOf[js.Any])
      
      inline def setCellsUndefined: Self = StObject.set(x, "cells", js.undefined)
      
      inline def setCellsVarargs(value: typingsJapgolly.openui5.sapUiCommonsLayoutMatrixLayoutCellMod.default*): Self = StObject.set(x, "cells", js.Array(value*))
