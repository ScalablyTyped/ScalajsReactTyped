...
import typingsJapgolly.openui5.anon.FirstTime
import typingsJapgolly.openui5.anon.From
...
object sapMQuickViewBaseMod {
  ...
  trait QuickViewBase
    ...
    def addPage(
      ...
      */
    oPage: typingsJapgolly.openui5.sapMQuickViewPageMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * divided in groups
      */
    def getPages(): js.Array[typingsJapgolly.openui5.sapMQuickViewPageMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllPages(): js.Array[typingsJapgolly.openui5.sapMQuickViewPageMod.default] = js.native
    
    def removePage(/**
      * The page to remove or its index or id
      */
    vPage: String): typingsJapgolly.openui5.sapMQuickViewPageMod.default | Null = js.native
    /**
    ...
    def removePage(/**
      * The page to remove or its index or id
      */
    vPage: int): typingsJapgolly.openui5.sapMQuickViewPageMod.default | Null = js.native
    def removePage(
      /**
      * The page to remove or its index or id
      */
    vPage: typingsJapgolly.openui5.sapMQuickViewPageMod.default
    ): typingsJapgolly.openui5.sapMQuickViewPageMod.default | Null = js.native
  ...
  trait QuickViewBaseSettings
    ...
    var pages: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMQuickViewPageMod.default] | typingsJapgolly.openui5.sapMQuickViewPageMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  }
  object QuickViewBaseSettings {
    ...
    extension [Self <: QuickViewBaseSettings](x: Self) {
      ...
      inline def setAfterNavigate(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "afterNavigate", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setPages(
        value: js.Array[typingsJapgolly.openui5.sapMQuickViewPageMod.default] | typingsJapgolly.openui5.sapMQuickViewPageMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "pages", value.asInstanceOf[js.Any])
      
      inline def setPagesUndefined: Self = StObject.set(x, "pages", js.undefined)
      
      inline def setPagesVarargs(value: typingsJapgolly.openui5.sapMQuickViewPageMod.default*): Self = StObject.set(x, "pages", js.Array(value*))
    }
  }
}
