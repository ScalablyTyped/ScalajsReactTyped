...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ITableRow
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapUiWebcMainTableGroupRowMod {
  
  @JSImport("sap/ui/webc/main/TableGroupRow", JSImport.Default)
  @js.native
  /**
  ...
  open class default () extends TableGroupRow {
    def this(/**
      ...
      */
    mSettings: TableGroupRowSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, TableGroupRow]
  ...
  object TableGroupRowSettings {
    
    inline def apply(): TableGroupRowSettings = {
