...
import typingsJapgolly.openui5.anon.Target
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.PDFViewerDisplayType
...
object sapMPdfviewerMod {
  ...
  trait PDFViewer
    ...
    def addPopupButton(
      ...
      */
    oPopupButton: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * property.
      */
    def getErrorPlaceholder(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    /**
      ...
      */
    def getPopupButtons(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllPopupButtons(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    
    def removePopupButton(/**
      * The popupButton to remove or its index or id
      */
    vPopupButton: String): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    /**
    ...
    def removePopupButton(/**
      * The popupButton to remove or its index or id
      */
    vPopupButton: int): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    def removePopupButton(
      /**
      * The popupButton to remove or its index or id
      */
    vPopupButton: typingsJapgolly.openui5.sapMButtonMod.default
    ...
    def setErrorPlaceholder(
      ...
      */
    oErrorPlaceholder: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
  ...
  trait PDFViewerSettings
    ...
    /**
      ...
      * property.
      */
    var errorPlaceholder: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object PDFViewerSettings {
    ...
    extension [Self <: PDFViewerSettings](x: Self) {
      ...
      inline def setErrorPlaceholder(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "errorPlaceholder", value.asInstanceOf[js.Any])
      ...
      inline def setLoaded(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "loaded", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setPopupButtonsVarargs(value: typingsJapgolly.openui5.sapMButtonMod.default*): Self = StObject.set(x, "popupButtons", js.Array(value*))
      ...
      inline def setSourceValidationFailed(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "sourceValidationFailed", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
