...
object sapUiCoreMvcOverrideExecutionMod {
  ...
  object default extends StObject {
    ...
    /* "After" */ val After: typingsJapgolly.openui5.sapUiCoreMvcOverrideExecutionMod.OverrideExecution.After & String = js.native
    
    /* "Before" */ val Before: typingsJapgolly.openui5.sapUiCoreMvcOverrideExecutionMod.OverrideExecution.Before & String = js.native
    
    /* "Instead" */ val Instead: typingsJapgolly.openui5.sapUiCoreMvcOverrideExecutionMod.OverrideExecution.Instead & String = js.native
  }
