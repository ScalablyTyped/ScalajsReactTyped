...
object sapMInputBaseMod {
  ...
  trait InputBase
    ...
    def addBeginIcon(/**
      ...
      */
    oIconSettings: js.Object): Null | typingsJapgolly.openui5.sapUiCoreIconMod.default = js.native
    ...
    oIconSettings: js.Object,
      ...
      */
    iPosition: int
    ): Null | typingsJapgolly.openui5.sapUiCoreIconMod.default = js.native
    ...
    /**
      ...
      */
    def getFormattedValueStateText(): typingsJapgolly.openui5.sapMFormattedTextMod.default = js.native
    ...
    /**
      ...
      */
    def getLabels(): js.Array[typingsJapgolly.openui5.sapMLabelMod.default] = js.native
    ...
    def setFormattedValueStateText(
      ...
      */
    oFormattedValueStateText: typingsJapgolly.openui5.sapMFormattedTextMod.default
    ): this.type = js.native
  ...
  trait InputBaseSettings
    ...
    /**
      ...
      * `valueStateText` and `formattedValueStateText` are set - the latter is shown.
      */
    var formattedValueStateText: js.UndefOr[typingsJapgolly.openui5.sapMFormattedTextMod.default] = js.undefined
  ...
  object InputBaseSettings {
    ...
    extension [Self <: InputBaseSettings](x: Self) {
      ...
      inline def setFormattedValueStateText(value: typingsJapgolly.openui5.sapMFormattedTextMod.default): Self = StObject.set(x, "formattedValueStateText", value.asInstanceOf[js.Any])
