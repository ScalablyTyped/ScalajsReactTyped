...
import typingsJapgolly.openui5.anon.ContentWidth
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.P13nPopupMode
...
object sapMP13nPopupMod {
  ...
  trait Popup
    ...
    def addAdditionalButton(
      ...
      */
    oAdditionalButton: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getAdditionalButtons(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    def open(
      ...
      */
    oSource: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): Unit = js.native
    def open(
      /**
      * The referenced control instance (used as anchor, for example, on popovers)
    ...
    def removeAdditionalButton(/**
      ...
      */
    vAdditionalButton: String): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    /**
    ...
    def removeAdditionalButton(/**
      * The additionalButton to remove or its index or id
      */
    vAdditionalButton: int): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    def removeAdditionalButton(
      /**
      * The additionalButton to remove or its index or id
      */
    vAdditionalButton: typingsJapgolly.openui5.sapMButtonMod.default
    ...
    /**
      ...
      */
    def removeAllAdditionalButtons(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
  ...
  object PopupSettings {
    ...
    extension [Self <: PopupSettings](x: Self) {
      ...
      inline def setAdditionalButtonsVarargs(value: typingsJapgolly.openui5.sapMButtonMod.default*): Self = StObject.set(x, "additionalButtons", js.Array(value*))
