...
import typingsJapgolly.openui5.anon.StepId
...
object sapUiCommonsRoadMapMod {
  ...
  trait RoadMap
    ...
    def addStep(
      ...
      */
    oStep: typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getSteps(): js.Array[typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllSteps(): js.Array[typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default] = js.native
    
    def removeStep(/**
      * The step to remove or its index or id
      */
    vStep: String): typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default | Null = js.native
    /**
    ...
    def removeStep(/**
      * The step to remove or its index or id
      */
    vStep: int): typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default | Null = js.native
    def removeStep(
      /**
      * The step to remove or its index or id
      */
    vStep: typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default
    ): typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default | Null = js.native
  ...
  trait RoadMapSettings
    ...
    var steps: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default] | typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object RoadMapSettings {
    ...
    extension [Self <: RoadMapSettings](x: Self) {
      ...
      inline def setStepExpanded(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "stepExpanded", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setStepExpandedUndefined: Self = StObject.set(x, "stepExpanded", js.undefined)
      
      inline def setStepSelected(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "stepSelected", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setStepSelectedUndefined: Self = StObject.set(x, "stepSelected", js.undefined)
      
      inline def setSteps(
        value: js.Array[typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default] | typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
      
      inline def setStepsUndefined: Self = StObject.set(x, "steps", js.undefined)
      
      inline def setStepsVarargs(value: typingsJapgolly.openui5.sapUiCommonsRoadMapStepMod.default*): Self = StObject.set(x, "steps", js.Array(value*))
