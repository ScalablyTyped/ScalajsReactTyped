...
import typingsJapgolly.openui5.anon.Action
import typingsJapgolly.openui5.anon.Href
...
import typingsJapgolly.openui5.sapUiCommonsCalloutBaseMod.CalloutBaseSettings
import typingsJapgolly.openui5.sapUiCoreLibraryMod.CSSSize
import typingsJapgolly.openui5.sapUiCoreLibraryMod.URI
import typingsJapgolly.openui5.sapUiUx3LibraryMod.FollowActionState
...
object sapUiUx3QuickViewMod {
  ...
  @js.native
  trait QuickView
    extends typingsJapgolly.openui5.sapUiCommonsCalloutBaseMod.default {
    ...
    def addAction(
      ...
      */
    oAction: typingsJapgolly.openui5.sapUiUx3ThingActionMod.default
    ): this.type = js.native
    ...
    def addContent(
      ...
      */
    oContent: typingsJapgolly.openui5.sapUiCoreElementMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * Actions of a Thing
      */
    def getActions(): js.Array[typingsJapgolly.openui5.sapUiUx3ThingActionMod.default] = js.native
    ...
    /**
      ...
      */
    def getContent(): js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    ...
    def removeAction(/**
      ...
      */
    vAction: String): typingsJapgolly.openui5.sapUiUx3ThingActionMod.default | Null = js.native
    /**
    ...
    def removeAction(/**
      * The action to remove or its index or id
      */
    vAction: int): typingsJapgolly.openui5.sapUiUx3ThingActionMod.default | Null = js.native
    def removeAction(
      /**
      * The action to remove or its index or id
      */
    vAction: typingsJapgolly.openui5.sapUiUx3ThingActionMod.default
    ): typingsJapgolly.openui5.sapUiUx3ThingActionMod.default | Null = js.native
    ...
    /**
      ...
      */
    def removeAllActions(): js.Array[typingsJapgolly.openui5.sapUiUx3ThingActionMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllContent(): js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    
    def removeContent(/**
      * The content to remove or its index or id
      */
    vContent: String): typingsJapgolly.openui5.sapUiCoreElementMod.default | Null = js.native
    /**
    ...
    def removeContent(/**
      * The content to remove or its index or id
      */
    vContent: int): typingsJapgolly.openui5.sapUiCoreElementMod.default | Null = js.native
    def removeContent(
      /**
      * The content to remove or its index or id
      */
    vContent: typingsJapgolly.openui5.sapUiCoreElementMod.default
    ): typingsJapgolly.openui5.sapUiCoreElementMod.default | Null = js.native
  ...
  trait QuickViewSettings
    ...
    var actions: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiUx3ThingActionMod.default] | typingsJapgolly.openui5.sapUiUx3ThingActionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object QuickViewSettings {
    ...
    extension [Self <: QuickViewSettings](x: Self) {
      ...
      inline def setActionSelected(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "actionSelected", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setActionSelectedUndefined: Self = StObject.set(x, "actionSelected", js.undefined)
      
      inline def setActions(
        value: js.Array[typingsJapgolly.openui5.sapUiUx3ThingActionMod.default] | typingsJapgolly.openui5.sapUiUx3ThingActionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
      
      inline def setActionsUndefined: Self = StObject.set(x, "actions", js.undefined)
      
      inline def setActionsVarargs(value: typingsJapgolly.openui5.sapUiUx3ThingActionMod.default*): Self = StObject.set(x, "actions", js.Array(value*))
      ...
      inline def setContentVarargs(value: typingsJapgolly.openui5.sapUiCoreElementMod.default*): Self = StObject.set(x, "content", js.Array(value*))
      ...
      inline def setFeedSubmit(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "feedSubmit", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
