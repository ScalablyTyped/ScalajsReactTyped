...
object sapUiCoreAppCacheBusterMod extends Shortcut {
  ...
  object AppCacheBuster {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(convertURL = js.Any.fromFunction1(convertURL), handleURL = js.Any.fromFunction1(handleURL), normalizeURL = js.Any.fromFunction1(normalizeURL), register = js.Any.fromFunction1((t0: String) => register(t0).runNow()))
