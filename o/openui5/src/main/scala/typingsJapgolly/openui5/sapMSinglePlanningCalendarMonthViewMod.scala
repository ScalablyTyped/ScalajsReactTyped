...
import typingsJapgolly.openui5.sapMSinglePlanningCalendarViewMod.SinglePlanningCalendarViewSettings
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapMSinglePlanningCalendarMonthViewMod {
  
  @JSImport("sap/m/SinglePlanningCalendarMonthView", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMSinglePlanningCalendarViewMod.default {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: SinglePlanningCalendarMonthViewSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SinglePlanningCalendarMonthView]
  ...
  type SinglePlanningCalendarMonthView = typingsJapgolly.openui5.sapMSinglePlanningCalendarViewMod.default
  
  type SinglePlanningCalendarMonthViewSettings = SinglePlanningCalendarViewSettings
}
