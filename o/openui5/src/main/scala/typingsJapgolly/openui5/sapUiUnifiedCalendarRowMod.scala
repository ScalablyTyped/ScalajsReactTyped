...
import typingsJapgolly.openui5.anon.EndDate
import typingsJapgolly.openui5.anon.Type
...
object sapUiUnifiedCalendarRowMod {
  ...
  trait CalendarRow
    ...
    /**
      ...
      */
    def getFocusedAppointment(): typingsJapgolly.openui5.sapUiUnifiedCalendarAppointmentMod.default = js.native
  ...
  object CalendarRowSettings {
    ...
    extension [Self <: CalendarRowSettings](x: Self) {
      ...
      inline def setLeaveRow(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "leaveRow", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
