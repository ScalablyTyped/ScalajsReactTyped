...
object sapMP13nDialogMod {
  ...
  trait P13nDialog
    ...
    def addPanel(
      ...
      */
    oPanel: typingsJapgolly.openui5.sapMP13nPanelMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getPanels(): js.Array[typingsJapgolly.openui5.sapMP13nPanelMod.default] = js.native
    ...
    /**
      ...
      * @returns panel
      */
    def getVisiblePanel(): typingsJapgolly.openui5.sapMP13nPanelMod.default | Null = js.native
    ...
    /**
      ...
      */
    def removeAllPanels(): js.Array[typingsJapgolly.openui5.sapMP13nPanelMod.default] = js.native
    
    def removePanel(/**
      * The panel to remove or its index or id
      */
    vPanel: String): typingsJapgolly.openui5.sapMP13nPanelMod.default | Null = js.native
    /**
    ...
    def removePanel(/**
      * The panel to remove or its index or id
      */
    vPanel: int): typingsJapgolly.openui5.sapMP13nPanelMod.default | Null = js.native
    def removePanel(
      /**
      * The panel to remove or its index or id
      */
    vPanel: typingsJapgolly.openui5.sapMP13nPanelMod.default
    ): typingsJapgolly.openui5.sapMP13nPanelMod.default | Null = js.native
  ...
  trait P13nDialogSettings
    ...
    var panels: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMP13nPanelMod.default] | typingsJapgolly.openui5.sapMP13nPanelMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object P13nDialogSettings {
    ...
    extension [Self <: P13nDialogSettings](x: Self) {
      ...
      inline def setOk(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "ok", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setOkUndefined: Self = StObject.set(x, "ok", js.undefined)
      
      inline def setPanels(
        value: js.Array[typingsJapgolly.openui5.sapMP13nPanelMod.default] | typingsJapgolly.openui5.sapMP13nPanelMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setPanelsVarargs(value: typingsJapgolly.openui5.sapMP13nPanelMod.default*): Self = StObject.set(x, "panels", js.Array(value*))
