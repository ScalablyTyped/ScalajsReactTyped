...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IUploadCollectionItem
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.UploadState
...
object sapUiWebcFioriUploadCollectionItemMod {
  ...
  trait UploadCollectionItem
    ...
    /**
      ...
      */
    def getThumbnail(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setThumbnail(/**
      ...
      */
    oThumbnail: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  ...
  trait UploadCollectionItemSettings
    ...
    /**
      ...
      *  **Note:** Use `sap.ui.webc.main.Icon` or `img` for the intended design.
      */
    var thumbnail: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object UploadCollectionItemSettings {
    ...
    extension [Self <: UploadCollectionItemSettings](x: Self) {
      ...
      inline def setFileNameClick(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "fileNameClick", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setRename(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "rename", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setRenameUndefined: Self = StObject.set(x, "rename", js.undefined)
      
      inline def setRetry(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "retry", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setRetryUndefined: Self = StObject.set(x, "retry", js.undefined)
      
      inline def setTerminate(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "terminate", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setTerminateUndefined: Self = StObject.set(x, "terminate", js.undefined)
      
      inline def setThumbnail(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "thumbnail", value.asInstanceOf[js.Any])
