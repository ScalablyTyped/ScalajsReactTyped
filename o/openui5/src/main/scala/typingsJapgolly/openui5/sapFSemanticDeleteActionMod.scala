...
object sapFSemanticDeleteActionMod {
  
  @JSImport("sap/f/semantic/DeleteAction", JSImport.Default)
  @js.native
  /**
  ...
  type DeleteAction = typingsJapgolly.openui5.sapFSemanticSemanticButtonMod.default
