...
import typingsJapgolly.openui5.anon.OriginalEvent
...
import typingsJapgolly.openui5.sapUiCorePopupMod.Dock
...
object sapUiUx3ToolPopupMod {
  ...
  trait ToolPopup
    ...
    def addButton(
      ...
      */
    oButton: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getButtons(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllButtons(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def removeButton(/**
      ...
      */
    vButton: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeButton(/**
      * The button to remove or its index or id
      */
    vButton: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeButton(
      /**
      * The button to remove or its index or id
      */
    vButton: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ...
    def setDefaultButton(
      ...
      */
    oDefaultButton: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
      * @SINCE 1.20.1
      *
    ...
    def setOpener(
      ...
      * may be given
      */
    oOpener: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
  ...
  trait ToolPopupSettings
    ...
    /**
      ...
      */
    var defaultButton: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
    ...
    /**
      ...
      */
    var opener: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
  ...
  object ToolPopupSettings {
    ...
    extension [Self <: ToolPopupSettings](x: Self) {
      ...
      inline def setButtonsVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "buttons", js.Array(value*))
      ...
      inline def setDefaultButton(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "defaultButton", value.asInstanceOf[js.Any])
      
      inline def setDefaultButtonUndefined: Self = StObject.set(x, "defaultButton", js.undefined)
      
      inline def setEnter(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "enter", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setIconChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "iconChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setOpener(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "opener", value.asInstanceOf[js.Any])
