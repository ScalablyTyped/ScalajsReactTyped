...
import typingsJapgolly.openui5.anon.Items
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.IIcon
...
object sapUiWebcMainMultiComboBoxMod {
  ...
  object MultiComboBoxSettings {
    ...
    extension [Self <: MultiComboBoxSettings](x: Self) {
      ...
      inline def setOpenChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "openChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
