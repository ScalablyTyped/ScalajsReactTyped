...
import typingsJapgolly.openui5.sapUiUnifiedMenuMod.MenuSettings
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapUiTableColumnMenuMod {
  
  @JSImport("sap/ui/table/ColumnMenu", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiUnifiedMenuMod.default {
    def this(/**
      * initial settings for the new control
      */
    mSettings: ColumnMenuSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ColumnMenu]
  ...
  type ColumnMenu = typingsJapgolly.openui5.sapUiUnifiedMenuMod.default
  
  type ColumnMenuSettings = MenuSettings
}
