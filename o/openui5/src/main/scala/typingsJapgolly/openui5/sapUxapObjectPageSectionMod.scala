...
import typingsJapgolly.openui5.sapUxapObjectPageSectionBaseMod.ObjectPageSectionBaseSettings
...
object sapUxapObjectPageSectionMod {
  ...
  trait ObjectPageSection
    extends typingsJapgolly.openui5.sapUxapObjectPageSectionBaseMod.default {
    ...
    def addSubSection(
      ...
      */
    oSubSection: typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getSubSections(): js.Array[typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllSubSections(): js.Array[typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default] = js.native
    
    def removeSubSection(/**
      * The subSection to remove or its index or id
      */
    vSubSection: String): typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default | Null = js.native
    /**
    ...
    def removeSubSection(/**
      * The subSection to remove or its index or id
      */
    vSubSection: int): typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default | Null = js.native
    def removeSubSection(
      /**
      * The subSection to remove or its index or id
      */
    vSubSection: typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default
    ): typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default | Null = js.native
    ...
    def setSelectedSubSection(
      ...
      * an element instance may be given
      */
    oSelectedSubSection: typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default
    ): this.type = js.native
  ...
  trait ObjectPageSectionSettings
    ...
    /**
      ...
      */
    var selectedSubSection: js.UndefOr[typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default | String] = js.undefined
    ...
    var subSections: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default] | typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object ObjectPageSectionSettings {
    ...
    extension [Self <: ObjectPageSectionSettings](x: Self) {
      ...
      inline def setSelectedSubSection(value: typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default | String): Self = StObject.set(x, "selectedSubSection", value.asInstanceOf[js.Any])
      ...
      inline def setSubSections(
        value: js.Array[typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default] | typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setSubSectionsVarargs(value: typingsJapgolly.openui5.sapUxapObjectPageSubSectionMod.default*): Self = StObject.set(x, "subSections", js.Array(value*))
