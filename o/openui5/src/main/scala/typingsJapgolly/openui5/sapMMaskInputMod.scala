...
import typingsJapgolly.openui5.anon.PreviousValue
...
object sapMMaskInputMod {
  ...
  trait MaskInput
    ...
    def addRule(
      ...
      */
    oRule: typingsJapgolly.openui5.sapMMaskInputRuleMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getRules(): js.Array[typingsJapgolly.openui5.sapMMaskInputRuleMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllRules(): js.Array[typingsJapgolly.openui5.sapMMaskInputRuleMod.default] = js.native
    
    def removeRule(/**
      * The rule to remove or its index or id
      */
    vRule: String): typingsJapgolly.openui5.sapMMaskInputRuleMod.default | Null = js.native
    /**
    ...
    def removeRule(/**
      * The rule to remove or its index or id
      */
    vRule: int): typingsJapgolly.openui5.sapMMaskInputRuleMod.default | Null = js.native
    def removeRule(
      /**
      * The rule to remove or its index or id
      */
    vRule: typingsJapgolly.openui5.sapMMaskInputRuleMod.default
    ): typingsJapgolly.openui5.sapMMaskInputRuleMod.default | Null = js.native
  ...
  trait MaskInputSettings
    ...
    var rules: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMMaskInputRuleMod.default] | typingsJapgolly.openui5.sapMMaskInputRuleMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object MaskInputSettings {
    ...
    extension [Self <: MaskInputSettings](x: Self) {
      ...
      inline def setRules(
        value: js.Array[typingsJapgolly.openui5.sapMMaskInputRuleMod.default] | typingsJapgolly.openui5.sapMMaskInputRuleMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "rules", value.asInstanceOf[js.Any])
      
      inline def setRulesUndefined: Self = StObject.set(x, "rules", js.undefined)
      
      inline def setRulesVarargs(value: typingsJapgolly.openui5.sapMMaskInputRuleMod.default*): Self = StObject.set(x, "rules", js.Array(value*))
