...
import typingsJapgolly.openui5.anon.CurrentBreakpoint
...
import typingsJapgolly.openui5.sapUiLayoutLibraryMod.SideContentFallDown
import typingsJapgolly.openui5.sapUiLayoutLibraryMod.SideContentPosition
import typingsJapgolly.openui5.sapUiLayoutLibraryMod.SideContentVisibility
...
object sapUiLayoutDynamicSideContentMod {
  ...
  trait DynamicSideContent
    ...
    def getScrollDelegate(/**
      ...
      */
    oControl: js.Object): typingsJapgolly.openui5.sapUiCoreDelegateScrollEnablementMod.default = js.native
    ...
    /**
      ...
      */
    def getSideContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def indexOfSideContent(
      ...
      */
    oSideContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): int = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllSideContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def removeSideContent(/**
      ...
      */
    vSideContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeSideContent(/**
      * The sideContent to remove or its index or id
      */
    vSideContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeSideContent(
      /**
      * The sideContent to remove or its index or id
      */
    vSideContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
  ...
  object DynamicSideContentSettings {
    ...
    extension [Self <: DynamicSideContentSettings](x: Self) {
      ...
      inline def setBreakpointChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "breakpointChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setSideContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "sideContent", js.Array(value*))
