...
import typingsJapgolly.openui5.anon.`6`
...
object sapUiUnifiedMenuItemBaseMod {
  ...
  trait MenuItemBase
    ...
    /**
      ...
      */
    def getSubmenu(): typingsJapgolly.openui5.sapUiUnifiedMenuMod.default = js.native
    ...
    def setSubmenu(/**
      * The submenu to set
      */
    oSubmenu: typingsJapgolly.openui5.sapUiUnifiedMenuMod.default): this.type = js.native
  ...
  trait MenuItemBaseSettings
    ...
    /**
      * An optional submenu of the item which is opened when the item is selected by the user.
      */
    var submenu: js.UndefOr[typingsJapgolly.openui5.sapUiUnifiedMenuMod.default] = js.undefined
  ...
  object MenuItemBaseSettings {
    ...
    extension [Self <: MenuItemBaseSettings](x: Self) {
      ...
      inline def setSubmenu(value: typingsJapgolly.openui5.sapUiUnifiedMenuMod.default): Self = StObject.set(x, "submenu", value.asInstanceOf[js.Any])
