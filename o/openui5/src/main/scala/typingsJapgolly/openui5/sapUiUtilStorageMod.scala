...
object sapUiUtilStorageMod {
  ...
  object Type extends StObject {
    ...
    sealed trait local
      extends StObject
         with Type
    /* "local" */ val local: typingsJapgolly.openui5.sapUiUtilStorageMod.Type.local & String = js.native
    ...
    sealed trait session
      extends StObject
         with Type
    /* "session" */ val session: typingsJapgolly.openui5.sapUiUtilStorageMod.Type.session & String = js.native
  }
