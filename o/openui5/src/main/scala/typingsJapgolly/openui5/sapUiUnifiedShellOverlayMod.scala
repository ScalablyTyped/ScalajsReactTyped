...
object sapUiUnifiedShellOverlayMod {
  ...
  trait ShellOverlay
    ...
    def setShell(
      ...
      * may be given
      */
    oShell: typingsJapgolly.openui5.sapUiUnifiedShellLayoutMod.default
    ): this.type = js.native
  }
  ...
  trait ShellOverlaySettings
    ...
    /**
      ...
      */
    var shell: js.UndefOr[typingsJapgolly.openui5.sapUiUnifiedShellLayoutMod.default | String] = js.undefined
  }
  object ShellOverlaySettings {
    ...
    extension [Self <: ShellOverlaySettings](x: Self) {
      ...
      inline def setShell(value: typingsJapgolly.openui5.sapUiUnifiedShellLayoutMod.default | String): Self = StObject.set(x, "shell", value.asInstanceOf[js.Any])
