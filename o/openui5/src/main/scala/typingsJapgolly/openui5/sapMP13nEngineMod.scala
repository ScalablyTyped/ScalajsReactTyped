...
import typingsJapgolly.openui5.anon.ContentHeight
...
object sapMP13nEngineMod extends Shortcut {
  ...
  trait EngineRegistrationConfig extends StObject {
    ...
    def apply(oControl: typingsJapgolly.openui5.sapUiCoreControlMod.default, oConfig: EngineRegistrationConfig): js.Object = js.native
  }
