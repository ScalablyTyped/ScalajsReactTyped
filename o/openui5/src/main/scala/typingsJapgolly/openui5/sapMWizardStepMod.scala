...
object sapMWizardStepMod {
  ...
  object WizardStepSettings {
    ...
    extension [Self <: WizardStepSettings](x: Self) {
      ...
      inline def setActivate(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "activate", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
