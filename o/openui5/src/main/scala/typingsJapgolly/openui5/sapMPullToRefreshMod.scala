...
object sapMPullToRefreshMod {
  ...
  object PullToRefreshSettings {
    ...
    extension [Self <: PullToRefreshSettings](x: Self) {
      ...
      inline def setRefresh(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "refresh", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
