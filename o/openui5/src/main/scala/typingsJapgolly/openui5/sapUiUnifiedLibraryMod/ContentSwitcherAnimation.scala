...
object ContentSwitcherAnimation extends StObject {
  ...
  /* "Fade" */ val Fade: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ContentSwitcherAnimation.Fade & String = js.native
  ...
  sealed trait None
    extends StObject
       with ContentSwitcherAnimation
  /* "None" */ val None: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ContentSwitcherAnimation.None & String = js.native
  ...
  sealed trait Rotate
    extends StObject
       with ContentSwitcherAnimation
  /* "Rotate" */ val Rotate: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ContentSwitcherAnimation.Rotate & String = js.native
  ...
  sealed trait SlideOver
    extends StObject
       with ContentSwitcherAnimation
  /* "SlideOver" */ val SlideOver: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ContentSwitcherAnimation.SlideOver & String = js.native
  ...
  sealed trait SlideRight
    extends StObject
       with ContentSwitcherAnimation
  /* "SlideRight" */ val SlideRight: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ContentSwitcherAnimation.SlideRight & String = js.native
  ...
  sealed trait ZoomIn
    extends StObject
       with ContentSwitcherAnimation
  /* "ZoomIn" */ val ZoomIn: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ContentSwitcherAnimation.ZoomIn & String = js.native
  ...
  sealed trait ZoomOut
    extends StObject
       with ContentSwitcherAnimation
  /* "ZoomOut" */ val ZoomOut: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ContentSwitcherAnimation.ZoomOut & String = js.native
}
