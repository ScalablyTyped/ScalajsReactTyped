...
object CalendarAppointmentRoundWidth extends StObject {
  ...
  /* "HalfColumn" */ val HalfColumn: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.CalendarAppointmentRoundWidth.HalfColumn & String = js.native
  ...
  sealed trait None
    extends StObject
       with CalendarAppointmentRoundWidth
  /* "None" */ val None: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.CalendarAppointmentRoundWidth.None & String = js.native
}
