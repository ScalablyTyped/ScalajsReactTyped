...
object StandardCalendarLegendItem extends StObject {
  ...
  /* "NonWorkingDay" */ val NonWorkingDay: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.StandardCalendarLegendItem.NonWorkingDay & String = js.native
  ...
  sealed trait Selected
    extends StObject
       with StandardCalendarLegendItem
  /* "Selected" */ val Selected: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.StandardCalendarLegendItem.Selected & String = js.native
  ...
  sealed trait Today
    extends StObject
       with StandardCalendarLegendItem
  /* "Today" */ val Today: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.StandardCalendarLegendItem.Today & String = js.native
  ...
  sealed trait WorkingDay
    extends StObject
       with StandardCalendarLegendItem
  /* "WorkingDay" */ val WorkingDay: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.StandardCalendarLegendItem.WorkingDay & String = js.native
}
