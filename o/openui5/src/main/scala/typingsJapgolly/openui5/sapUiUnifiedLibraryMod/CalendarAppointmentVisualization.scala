...
object CalendarAppointmentVisualization extends StObject {
  ...
  /* "Filled" */ val Filled: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.CalendarAppointmentVisualization.Filled & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with CalendarAppointmentVisualization
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.CalendarAppointmentVisualization.Standard & String = js.native
}
