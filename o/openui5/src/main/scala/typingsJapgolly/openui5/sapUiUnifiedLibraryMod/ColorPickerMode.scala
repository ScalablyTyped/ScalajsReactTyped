...
object ColorPickerMode extends StObject {
  ...
  /* "HSL" */ val HSL: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ColorPickerMode.HSL & String = js.native
  ...
  sealed trait HSV
    extends StObject
       with ColorPickerMode
  /* "HSV" */ val HSV: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.ColorPickerMode.HSV & String = js.native
}
