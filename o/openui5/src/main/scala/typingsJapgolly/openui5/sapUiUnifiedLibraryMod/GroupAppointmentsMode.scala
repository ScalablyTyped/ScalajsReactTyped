...
object GroupAppointmentsMode extends StObject {
  ...
  /* "Collapsed" */ val Collapsed: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.GroupAppointmentsMode.Collapsed & String = js.native
  ...
  sealed trait Expanded
    extends StObject
       with GroupAppointmentsMode
  /* "Expanded" */ val Expanded: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.GroupAppointmentsMode.Expanded & String = js.native
}
