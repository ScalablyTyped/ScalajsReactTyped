...
object FileUploaderHttpRequestMethod extends StObject {
  ...
  /* "POST" */ val Post: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.FileUploaderHttpRequestMethod.Post & String = js.native
  ...
  sealed trait Put
    extends StObject
       with FileUploaderHttpRequestMethod
  /* "PUT" */ val Put: typingsJapgolly.openui5.sapUiUnifiedLibraryMod.FileUploaderHttpRequestMethod.Put & String = js.native
}
