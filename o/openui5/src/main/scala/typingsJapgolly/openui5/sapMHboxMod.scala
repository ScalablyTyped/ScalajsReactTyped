...
import typingsJapgolly.openui5.sapMFlexBoxMod.FlexBoxSettings
...
object sapMHboxMod {
  ...
  @JSImport("sap/m/HBox", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMFlexBoxMod.default {
    def this(/**
      * initial settings for the new control
      */
    mSettings: HBoxSettings) = this()
    def this(/**
  ...
  type HBox = typingsJapgolly.openui5.sapMFlexBoxMod.default
  
  type HBoxSettings = FlexBoxSettings
}
