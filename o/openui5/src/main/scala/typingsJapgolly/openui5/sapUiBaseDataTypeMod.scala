...
import typingsJapgolly.openui5.anon.DefaultValue
...
object sapUiBaseDataTypeMod {
  ...
  object DataType {
    ...
    inline def apply(
      getBaseType: CallbackTo[js.UndefOr[DataType]],
      getComponentType: CallbackTo[js.UndefOr[DataType]],
      getDefaultValue: CallbackTo[Any],
      getEnumValues: CallbackTo[js.UndefOr[js.Object]],
      getName: CallbackTo[String],
      getPrimitiveType: CallbackTo[DataType],
      isArrayType: CallbackTo[Boolean],
      isEnumType: CallbackTo[Boolean],
      isValid: Any => Boolean,
      normalize: Any => Any,
      parseValue: String => Any,
      setNormalizer: js.Function => Callback
    ): DataType = {
      val __obj = js.Dynamic.literal(getBaseType = getBaseType.toJsFn, getComponentType = getComponentType.toJsFn, getDefaultValue = getDefaultValue.toJsFn, getEnumValues = getEnumValues.toJsFn, getName = getName.toJsFn, getPrimitiveType = getPrimitiveType.toJsFn, isArrayType = isArrayType.toJsFn, isEnumType = isEnumType.toJsFn, isValid = js.Any.fromFunction1(isValid), normalize = js.Any.fromFunction1(normalize), parseValue = js.Any.fromFunction1(parseValue), setNormalizer = js.Any.fromFunction1((t0: js.Function) => setNormalizer(t0).runNow()))
      __obj.asInstanceOf[DataType]
    }
    
    extension [Self <: DataType](x: Self) {
      
      inline def setGetBaseType(value: CallbackTo[js.UndefOr[DataType]]): Self = StObject.set(x, "getBaseType", value.toJsFn)
      
      inline def setGetComponentType(value: CallbackTo[js.UndefOr[DataType]]): Self = StObject.set(x, "getComponentType", value.toJsFn)
      
      inline def setGetDefaultValue(value: CallbackTo[Any]): Self = StObject.set(x, "getDefaultValue", value.toJsFn)
      
      inline def setGetEnumValues(value: CallbackTo[js.UndefOr[js.Object]]): Self = StObject.set(x, "getEnumValues", value.toJsFn)
      
      inline def setGetName(value: CallbackTo[String]): Self = StObject.set(x, "getName", value.toJsFn)
      
      inline def setGetPrimitiveType(value: CallbackTo[DataType]): Self = StObject.set(x, "getPrimitiveType", value.toJsFn)
      
      inline def setIsArrayType(value: CallbackTo[Boolean]): Self = StObject.set(x, "isArrayType", value.toJsFn)
      
      inline def setIsEnumType(value: CallbackTo[Boolean]): Self = StObject.set(x, "isEnumType", value.toJsFn)
      ...
      inline def setSetNormalizer(value: js.Function => Callback): Self = StObject.set(x, "setNormalizer", js.Any.fromFunction1((t0: js.Function) => value(t0).runNow()))
    }
  }
}
