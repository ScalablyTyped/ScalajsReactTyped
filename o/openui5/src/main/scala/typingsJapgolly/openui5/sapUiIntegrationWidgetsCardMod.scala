...
import typingsJapgolly.openui5.anon.ActionSource
import typingsJapgolly.openui5.anon.Changes
import typingsJapgolly.openui5.anon.Headers
import typingsJapgolly.openui5.anon.Parameters
...
import typingsJapgolly.openui5.sapUiIntegrationLibraryMod.CardArea
import typingsJapgolly.openui5.sapUiIntegrationLibraryMod.CardDataMode
...
object sapUiIntegrationWidgetsCardMod {
  ...
  trait Card
    ...
    def addActionDefinition(
      ...
      */
    oActionDefinition: typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getActionDefinitions(): js.Array[typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default] = js.native
    ...
    /**
      ...
      */
    def getHostInstance(): typingsJapgolly.openui5.sapUiIntegrationHostMod.default = js.native
    ...
    def removeActionDefinition(/**
      ...
      */
    vActionDefinition: String): typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default | Null = js.native
    /**
      * @SINCE 1.85
      * @EXPERIMENTAL (since 1.85)
      *
    ...
    def removeActionDefinition(/**
      * The actionDefinition to remove or its index or id
      */
    vActionDefinition: int): typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default | Null = js.native
    def removeActionDefinition(
      /**
      * The actionDefinition to remove or its index or id
      */
    vActionDefinition: typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default
    ): typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default | Null = js.native
    ...
    /**
      ...
      */
    def removeAllActionDefinitions(): js.Array[typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default] = js.native
    ...
    def setHost(
      ...
      * may be given
      */
    oHost: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
  ...
  trait CardSettings
    ...
    var actionDefinitions: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default] | typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      * The host.
      */
    var host: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
  ...
  object CardSettings {
    ...
    extension [Self <: CardSettings](x: Self) {
      ...
      inline def setAction(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "action", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setActionDefinitions(
        value: js.Array[typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default] | typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setActionDefinitionsVarargs(value: typingsJapgolly.openui5.sapUiIntegrationActionDefinitionMod.default*): Self = StObject.set(x, "actionDefinitions", js.Array(value*))
      ...
      inline def setConfigurationChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "configurationChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setHost(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "host", value.asInstanceOf[js.Any])
      ...
      inline def setManifestApplied(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "manifestApplied", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setManifestReady(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "manifestReady", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setStateChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "stateChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
