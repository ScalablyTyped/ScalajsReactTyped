...
import typingsJapgolly.openui5.anon.Config
...
object sapMRoutingTargetsMod {
  
  @JSImport("sap/m/routing/Targets", JSImport.Default)
  @js.native
  open class default protected () extends Targets {
    /**
      * Constructor for a new `Targets` class.
      */
    def this(oOptions: Config) = this()
  }
  /* static members */
  object default {
  ...
  @js.native
  trait Targets
    extends typingsJapgolly.openui5.sapUiCoreRoutingTargetsMod.default {
    ...
    /**
      ...
      * @returns the TargetHandler instance
      */
    def getTargetHandler(): typingsJapgolly.openui5.sapMRoutingTargetHandlerMod.default = js.native
  }
}
