...
import typingsJapgolly.openui5.anon.Collapsed
...
object sapMNotificationListGroupMod {
  ...
  trait NotificationListGroup
    ...
    def addItem(
      ...
      */
    oItem: typingsJapgolly.openui5.sapMNotificationListItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapMNotificationListItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllItems(): js.Array[typingsJapgolly.openui5.sapMNotificationListItemMod.default] = js.native
    
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: String): typingsJapgolly.openui5.sapMNotificationListItemMod.default | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: int): typingsJapgolly.openui5.sapMNotificationListItemMod.default | Null = js.native
    def removeItem(
      /**
      * The item to remove or its index or id
      */
    vItem: typingsJapgolly.openui5.sapMNotificationListItemMod.default
    ): typingsJapgolly.openui5.sapMNotificationListItemMod.default | Null = js.native
  ...
  trait NotificationListGroupSettings
    ...
    var items: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMNotificationListItemMod.default] | typingsJapgolly.openui5.sapMNotificationListItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object NotificationListGroupSettings {
    ...
    extension [Self <: NotificationListGroupSettings](x: Self) {
      ...
      inline def setItems(
        value: js.Array[typingsJapgolly.openui5.sapMNotificationListItemMod.default] | typingsJapgolly.openui5.sapMNotificationListItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapMNotificationListItemMod.default*): Self = StObject.set(x, "items", js.Array(value*))
      
      inline def setOnCollapse(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "onCollapse", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
