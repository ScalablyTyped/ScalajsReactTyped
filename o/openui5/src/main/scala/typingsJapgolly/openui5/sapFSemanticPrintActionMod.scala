...
object sapFSemanticPrintActionMod {
  
  @JSImport("sap/f/semantic/PrintAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: PrintActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, PrintAction]
  ...
  type PrintAction = typingsJapgolly.openui5.sapFSemanticSemanticButtonMod.default
  
  type PrintActionSettings = SemanticButtonSettings
}
