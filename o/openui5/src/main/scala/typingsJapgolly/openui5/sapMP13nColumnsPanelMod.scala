...
import typingsJapgolly.openui5.anon.ExistingItems
import typingsJapgolly.openui5.anon.NewItem
...
object sapMP13nColumnsPanelMod {
  ...
  trait P13nColumnsPanel
    ...
    def addColumnsItem(
      ...
      */
    oColumnsItem: typingsJapgolly.openui5.sapMP13nColumnsItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getColumnsItems(): js.Array[typingsJapgolly.openui5.sapMP13nColumnsItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllColumnsItems(): js.Array[typingsJapgolly.openui5.sapMP13nColumnsItemMod.default] = js.native
    
    def removeColumnsItem(/**
      * The columnsItem to remove or its index or id
      */
    vColumnsItem: String): typingsJapgolly.openui5.sapMP13nColumnsItemMod.default | Null = js.native
    /**
      * @SINCE 1.26.0
      *
    ...
    def removeColumnsItem(/**
      * The columnsItem to remove or its index or id
      */
    vColumnsItem: int): typingsJapgolly.openui5.sapMP13nColumnsItemMod.default | Null = js.native
    def removeColumnsItem(
      /**
      * The columnsItem to remove or its index or id
      */
    vColumnsItem: typingsJapgolly.openui5.sapMP13nColumnsItemMod.default
    ): typingsJapgolly.openui5.sapMP13nColumnsItemMod.default | Null = js.native
  ...
  trait P13nColumnsPanelSettings
    ...
    var columnsItems: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMP13nColumnsItemMod.default] | typingsJapgolly.openui5.sapMP13nColumnsItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object P13nColumnsPanelSettings {
    ...
    extension [Self <: P13nColumnsPanelSettings](x: Self) {
      ...
      inline def setAddColumnsItem(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "addColumnsItem", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setAddColumnsItemUndefined: Self = StObject.set(x, "addColumnsItem", js.undefined)
      
      inline def setChangeColumnsItems(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "changeColumnsItems", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setChangeColumnsItemsUndefined: Self = StObject.set(x, "changeColumnsItems", js.undefined)
      
      inline def setColumnsItems(
        value: js.Array[typingsJapgolly.openui5.sapMP13nColumnsItemMod.default] | typingsJapgolly.openui5.sapMP13nColumnsItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setColumnsItemsVarargs(value: typingsJapgolly.openui5.sapMP13nColumnsItemMod.default*): Self = StObject.set(x, "columnsItems", js.Array(value*))
      
      inline def setSetData(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "setData", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
