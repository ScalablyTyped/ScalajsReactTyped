...
import typingsJapgolly.openui5.anon.TargetAggregation
...
object sapMP13nSelectionControllerMod {
  
  @JSImport("sap/m/p13n/SelectionController", JSImport.Default)
  @js.native
  /**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SelectionController]
  ...
  type SelectionController = typingsJapgolly.openui5.sapUiBaseObjectMod.default
}
