...
object sapUiCommonsLayoutResponsiveFlowLayoutDataMod {
  ...
  trait ResponsiveFlowLayoutData
    extends typingsJapgolly.openui5.sapUiLayoutResponsiveFlowLayoutDataMod.default
  
  type ResponsiveFlowLayoutDataSettings = typingsJapgolly.openui5.sapUiLayoutResponsiveFlowLayoutDataMod.ResponsiveFlowLayoutDataSettings
}
