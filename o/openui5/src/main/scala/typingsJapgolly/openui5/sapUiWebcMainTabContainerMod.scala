...
import typingsJapgolly.openui5.anon.Tab
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ITab
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TabLayout
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.TabsOverflowMode
...
object sapUiWebcMainTabContainerMod {
  ...
  object TabContainerSettings {
    ...
    extension [Self <: TabContainerSettings](x: Self) {
      ...
      inline def setTabSelect(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "tabSelect", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
