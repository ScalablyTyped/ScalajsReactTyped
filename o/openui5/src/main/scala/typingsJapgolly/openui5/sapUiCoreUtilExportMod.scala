...
object sapUiCoreUtilExportMod {
  ...
  trait Export
    ...
    def addColumn(
      ...
      */
    oColumn: typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default
    ): this.type = js.native
    ...
    def addRow(
      ...
      */
    oRow: typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getColumns(): js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default] = js.native
    ...
    /**
      ...
      */
    def getExportType(): typingsJapgolly.openui5.sapUiCoreUtilExportTypeMod.default = js.native
    ...
    /**
      ...
      * Rows of the Export.
      */
    def getRows(): js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllColumns(): js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllRows(): js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default] = js.native
    
    def removeColumn(/**
      * The column to remove or its index or id
      */
    vColumn: String): typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default | Null = js.native
    /**
    ...
    def removeColumn(/**
      * The column to remove or its index or id
      */
    vColumn: int): typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default | Null = js.native
    def removeColumn(
      /**
      * The column to remove or its index or id
      */
    vColumn: typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default
    ): typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default | Null = js.native
    
    def removeRow(/**
      * The row to remove or its index or id
      */
    vRow: String): typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default | Null = js.native
    /**
    ...
    def removeRow(/**
      * The row to remove or its index or id
      */
    vRow: int): typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default | Null = js.native
    def removeRow(
      /**
      * The row to remove or its index or id
      */
    vRow: typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default
    ): typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default | Null = js.native
    ...
    def setExportType(
      ...
      */
    oExportType: typingsJapgolly.openui5.sapUiCoreUtilExportTypeMod.default
    ): this.type = js.native
  ...
  trait ExportSettings
    ...
    var columns: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default] | typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    
    /**
      * Type that generates the content.
      */
    var exportType: js.UndefOr[typingsJapgolly.openui5.sapUiCoreUtilExportTypeMod.default] = js.undefined
    
    /**
      * Rows of the Export.
      */
    var rows: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default] | typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  }
  object ExportSettings {
    ...
    extension [Self <: ExportSettings](x: Self) {
      ...
      inline def setColumns(
        value: js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default] | typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
      
      inline def setColumnsUndefined: Self = StObject.set(x, "columns", js.undefined)
      
      inline def setColumnsVarargs(value: typingsJapgolly.openui5.sapUiCoreUtilExportColumnMod.default*): Self = StObject.set(x, "columns", js.Array(value*))
      
      inline def setExportType(value: typingsJapgolly.openui5.sapUiCoreUtilExportTypeMod.default): Self = StObject.set(x, "exportType", value.asInstanceOf[js.Any])
      
      inline def setExportTypeUndefined: Self = StObject.set(x, "exportType", js.undefined)
      
      inline def setRows(
        value: js.Array[typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default] | typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "rows", value.asInstanceOf[js.Any])
      
      inline def setRowsUndefined: Self = StObject.set(x, "rows", js.undefined)
      
      inline def setRowsVarargs(value: typingsJapgolly.openui5.sapUiCoreUtilExportRowMod.default*): Self = StObject.set(x, "rows", js.Array(value*))
    }
  }
}
