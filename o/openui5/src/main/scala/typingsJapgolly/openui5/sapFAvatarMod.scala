...
object sapFAvatarMod {
  
  @JSImport("sap/f/Avatar", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMAvatarMod.default {
    def this(/**
  ...
  type Avatar = typingsJapgolly.openui5.sapMAvatarMod.default
  
  type AvatarSettings = typingsJapgolly.openui5.sapMAvatarMod.AvatarSettings
}
