...
object sapUiIntegrationEditorExtensionMod {
  ...
  @js.native
  trait Extension
    extends typingsJapgolly.openui5.sapUiIntegrationExtensionMod.default {
  ...
  type ExtensionSettings = typingsJapgolly.openui5.sapUiIntegrationExtensionMod.ExtensionSettings
}
