...
import typingsJapgolly.openui5.sapUiCoreDndDropInfoMod.DropInfoSettings
...
object sapUiCoreDndDragDropInfoMod {
  ...
  @js.native
  trait DragDropInfo
    extends typingsJapgolly.openui5.sapUiCoreDndDropInfoMod.default
       with IDragInfo {
    ...
    def setTargetElement(
      ...
      */
    oTargetElement: typingsJapgolly.openui5.sapUiCoreElementMod.default
    ): this.type = js.native
    /**
  ...
  trait DragDropInfoSettings
    ...
    /**
      ...
      */
    var targetElement: js.UndefOr[typingsJapgolly.openui5.sapUiCoreElementMod.default | String] = js.undefined
  }
  object DragDropInfoSettings {
    ...
    extension [Self <: DragDropInfoSettings](x: Self) {
      ...
      inline def setTargetElement(value: typingsJapgolly.openui5.sapUiCoreElementMod.default | String): Self = StObject.set(x, "targetElement", value.asInstanceOf[js.Any])
