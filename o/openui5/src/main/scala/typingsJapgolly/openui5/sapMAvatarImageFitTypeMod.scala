...
object sapMAvatarImageFitTypeMod {
  ...
  object default extends StObject {
    ...
    /* "Contain" */ val Contain: typingsJapgolly.openui5.sapMAvatarImageFitTypeMod.AvatarImageFitType.Contain & String = js.native
    
    /* "Cover" */ val Cover: typingsJapgolly.openui5.sapMAvatarImageFitTypeMod.AvatarImageFitType.Cover & String = js.native
  }
