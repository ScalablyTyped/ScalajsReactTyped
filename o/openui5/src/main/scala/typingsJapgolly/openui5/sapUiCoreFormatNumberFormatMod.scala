...
import typingsJapgolly.openui5.anon.AllowedUnits
import typingsJapgolly.openui5.anon.CurrencyCode
import typingsJapgolly.openui5.anon.DecimalSeparator
import typingsJapgolly.openui5.anon.Decimals
...
object sapUiCoreFormatNumberFormatMod {
  ...
  object default {
    ...
    oFormatOptions: Unit,
      ...
      */
    oLocale: typingsJapgolly.openui5.sapUiCoreLocaleMod.default
  ...
  object RoundingMode extends StObject {
    ...
    sealed trait AWAY_FROM_ZERO
      extends StObject
         with RoundingMode
    /* "AWAY_FROM_ZERO" */ val AWAY_FROM_ZERO: typingsJapgolly.openui5.sapUiCoreFormatNumberFormatMod.RoundingMode.AWAY_FROM_ZERO & String = js.native
    ...
    sealed trait CEILING
      extends StObject
         with RoundingMode
    /* "CEILING" */ val CEILING: typingsJapgolly.openui5.sapUiCoreFormatNumberFormatMod.RoundingMode.CEILING & String = js.native
    ...
    sealed trait FLOOR
      extends StObject
         with RoundingMode
    /* "FLOOR" */ val FLOOR: typingsJapgolly.openui5.sapUiCoreFormatNumberFormatMod.RoundingMode.FLOOR & String = js.native
    ...
    sealed trait HALF_AWAY_FROM_ZERO
      extends StObject
         with RoundingMode
    /* "HALF_AWAY_FROM_ZERO" */ val HALF_AWAY_FROM_ZERO: typingsJapgolly.openui5.sapUiCoreFormatNumberFormatMod.RoundingMode.HALF_AWAY_FROM_ZERO & String = js.native
    ...
    sealed trait HALF_CEILING
      extends StObject
         with RoundingMode
    /* "HALF_CEILING" */ val HALF_CEILING: typingsJapgolly.openui5.sapUiCoreFormatNumberFormatMod.RoundingMode.HALF_CEILING & String = js.native
    ...
    sealed trait HALF_FLOOR
      extends StObject
         with RoundingMode
    /* "HALF_FLOOR" */ val HALF_FLOOR: typingsJapgolly.openui5.sapUiCoreFormatNumberFormatMod.RoundingMode.HALF_FLOOR & String = js.native
    ...
    sealed trait HALF_TOWARDS_ZERO
      extends StObject
         with RoundingMode
    /* "HALF_TOWARDS_ZERO" */ val HALF_TOWARDS_ZERO: typingsJapgolly.openui5.sapUiCoreFormatNumberFormatMod.RoundingMode.HALF_TOWARDS_ZERO & String = js.native
    ...
    sealed trait TOWARDS_ZERO
      extends StObject
         with RoundingMode
    /* "TOWARDS_ZERO" */ val TOWARDS_ZERO: typingsJapgolly.openui5.sapUiCoreFormatNumberFormatMod.RoundingMode.TOWARDS_ZERO & String = js.native
  }
