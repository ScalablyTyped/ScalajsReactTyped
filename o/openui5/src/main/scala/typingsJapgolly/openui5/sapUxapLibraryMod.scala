...
object sapUxapLibraryMod {
  ...
  object BlockBaseFormAdjustment extends StObject {
    ...
    /* "BlockColumns" */ val BlockColumns: typingsJapgolly.openui5.sapUxapLibraryMod.BlockBaseFormAdjustment.BlockColumns & String = js.native
    ...
    sealed trait None
      extends StObject
         with BlockBaseFormAdjustment
    /* "None" */ val None: typingsJapgolly.openui5.sapUxapLibraryMod.BlockBaseFormAdjustment.None & String = js.native
    ...
    sealed trait OneColumn
      extends StObject
         with BlockBaseFormAdjustment
    /* "OneColumn" */ val OneColumn: typingsJapgolly.openui5.sapUxapLibraryMod.BlockBaseFormAdjustment.OneColumn & String = js.native
  }
  ...
  object Importance extends StObject {
    ...
    sealed trait High
      extends StObject
         with Importance
    /* "High" */ val High: typingsJapgolly.openui5.sapUxapLibraryMod.Importance.High & String = js.native
    ...
    sealed trait Low
      extends StObject
         with Importance
    /* "Low" */ val Low: typingsJapgolly.openui5.sapUxapLibraryMod.Importance.Low & String = js.native
    ...
    sealed trait Medium
      extends StObject
         with Importance
    /* "Medium" */ val Medium: typingsJapgolly.openui5.sapUxapLibraryMod.Importance.Medium & String = js.native
  }
  ...
  object ObjectPageConfigurationMode extends StObject {
    ...
    /* "JsonModel" */ val JsonModel: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageConfigurationMode.JsonModel & String = js.native
    ...
    sealed trait JsonURL
      extends StObject
         with ObjectPageConfigurationMode
    /* "JsonURL" */ val JsonURL: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageConfigurationMode.JsonURL & String = js.native
  }
  ...
  object ObjectPageHeaderDesign extends StObject {
    ...
    /* "Dark" */ val Dark: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageHeaderDesign.Dark & String = js.native
    ...
    sealed trait Light
      extends StObject
         with ObjectPageHeaderDesign
    /* "Light" */ val Light: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageHeaderDesign.Light & String = js.native
  }
  ...
  object ObjectPageHeaderPictureShape extends StObject {
    ...
    /* "Circle" */ val Circle: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageHeaderPictureShape.Circle & String = js.native
    ...
    sealed trait Square
      extends StObject
         with ObjectPageHeaderPictureShape
    /* "Square" */ val Square: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageHeaderPictureShape.Square & String = js.native
  }
  ...
  object ObjectPageSubSectionLayout extends StObject {
    ...
    /* "TitleOnLeft" */ val TitleOnLeft: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageSubSectionLayout.TitleOnLeft & String = js.native
    ...
    sealed trait TitleOnTop
      extends StObject
         with ObjectPageSubSectionLayout
    /* "TitleOnTop" */ val TitleOnTop: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageSubSectionLayout.TitleOnTop & String = js.native
  }
  ...
  object ObjectPageSubSectionMode extends StObject {
    ...
    /* "Collapsed" */ val Collapsed: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageSubSectionMode.Collapsed & String = js.native
    ...
    sealed trait Expanded
      extends StObject
         with ObjectPageSubSectionMode
    /* "Expanded" */ val Expanded: typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageSubSectionMode.Expanded & String = js.native
  }
