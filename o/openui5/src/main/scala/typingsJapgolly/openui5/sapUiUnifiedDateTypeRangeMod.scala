...
import typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.DateRangeSettings
import typingsJapgolly.openui5.sapUiUnifiedLibraryMod.CalendarDayType
...
object sapUiUnifiedDateTypeRangeMod {
  ...
  @js.native
  trait DateTypeRange
    extends typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default {
