...
object sapUiCommonsMessageToastMod {
  ...
  trait MessageToast
    ...
    def toast(
      ...
      */
    oMessage: typingsJapgolly.openui5.sapUiCommonsMessageMod.default,
      /**
  ...
  object MessageToastSettings {
    ...
    extension [Self <: MessageToastSettings](x: Self) {
      ...
      inline def setNext(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "next", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
