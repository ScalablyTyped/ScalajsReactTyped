...
object sapUiUx3CollectionInspectorMod {
  ...
  trait CollectionInspector
    ...
    def addCollection(
      ...
      */
    oCollection: typingsJapgolly.openui5.sapUiUx3CollectionMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getCollections(): js.Array[typingsJapgolly.openui5.sapUiUx3CollectionMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllCollections(): js.Array[typingsJapgolly.openui5.sapUiUx3CollectionMod.default] = js.native
    ...
    def removeCollection(/**
      ...
      */
    vCollection: String): typingsJapgolly.openui5.sapUiUx3CollectionMod.default | Null = js.native
    /**
    ...
    def removeCollection(/**
      * the collection to remove or its index or ID
      */
    vCollection: int): typingsJapgolly.openui5.sapUiUx3CollectionMod.default | Null = js.native
    def removeCollection(
      /**
      * the collection to remove or its index or ID
      */
    vCollection: typingsJapgolly.openui5.sapUiUx3CollectionMod.default
    ): typingsJapgolly.openui5.sapUiUx3CollectionMod.default | Null = js.native
    ...
    def setSelectedCollection(
      ...
      * an element instance may be given
      */
    oSelectedCollection: typingsJapgolly.openui5.sapUiUx3CollectionMod.default
    ): this.type = js.native
  ...
  trait CollectionInspectorSettings
    ...
    var collections: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiUx3CollectionMod.default] | typingsJapgolly.openui5.sapUiUx3CollectionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      */
    var selectedCollection: js.UndefOr[typingsJapgolly.openui5.sapUiUx3CollectionMod.default | String] = js.undefined
  ...
  object CollectionInspectorSettings {
    ...
    extension [Self <: CollectionInspectorSettings](x: Self) {
      ...
      inline def setCollectionSelected(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "collectionSelected", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setCollectionSelectedUndefined: Self = StObject.set(x, "collectionSelected", js.undefined)
      
      inline def setCollections(
        value: js.Array[typingsJapgolly.openui5.sapUiUx3CollectionMod.default] | typingsJapgolly.openui5.sapUiUx3CollectionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setCollectionsVarargs(value: typingsJapgolly.openui5.sapUiUx3CollectionMod.default*): Self = StObject.set(x, "collections", js.Array(value*))
      ...
      inline def setEditCollection(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "editCollection", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setItemSelectionChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "itemSelectionChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setItemSelectionChangedUndefined: Self = StObject.set(x, "itemSelectionChanged", js.undefined)
      
      inline def setSelectedCollection(value: typingsJapgolly.openui5.sapUiUx3CollectionMod.default | String): Self = StObject.set(x, "selectedCollection", value.asInstanceOf[js.Any])
