...
object sapMShellMod {
  ...
  trait Shell
    ...
    /**
      ...
      */
    def getApp(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setApp(/**
      * The app to set
      */
    oApp: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  ...
  trait ShellSettings
    ...
    /**
      * A Shell contains an App or a SplitApp (they may be wrapped in a View). Other control types are not allowed.
      */
    var app: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object ShellSettings {
    ...
    extension [Self <: ShellSettings](x: Self) {
      ...
      inline def setApp(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "app", value.asInstanceOf[js.Any])
