...
object sapMFeedInputMod {
  ...
  trait FeedInput
    ...
    /**
      ...
      */
    def getButtonTooltip(): typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default = js.native
    ...
    def setButtonTooltip(
      ...
      */
    sButtonTooltip: typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default
    ): this.type = js.native
  ...
  trait FeedInputSettings
    ...
    var buttonTooltip: js.UndefOr[
        typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default | PropertyBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object FeedInputSettings {
    ...
    extension [Self <: FeedInputSettings](x: Self) {
      ...
      inline def setButtonTooltip(
        value: typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default | PropertyBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setPost(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "post", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
