...
object sapUiModelOdataMessageScopeMod {
  ...
  object default extends StObject {
    ...
    /* "BusinessObject" */ val BusinessObject: typingsJapgolly.openui5.sapUiModelOdataMessageScopeMod.MessageScope.BusinessObject & String = js.native
    
    /* "RequestedObjects" */ val RequestedObjects: typingsJapgolly.openui5.sapUiModelOdataMessageScopeMod.MessageScope.RequestedObjects & String = js.native
  }
