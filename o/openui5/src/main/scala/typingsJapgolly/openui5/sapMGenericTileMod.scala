...
import typingsJapgolly.openui5.anon.Scope
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.FrameType
import typingsJapgolly.openui5.sapMLibraryMod.GenericTileMode
import typingsJapgolly.openui5.sapMLibraryMod.GenericTileScope
import typingsJapgolly.openui5.sapMLibraryMod.LoadState
import typingsJapgolly.openui5.sapMLibraryMod.Size
import typingsJapgolly.openui5.sapMLibraryMod.TileSizeBehavior
...
object sapMGenericTileMod {
  ...
  trait GenericTile
    ...
    def addActionButton(
      ...
      */
    oActionButton: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    ...
    def addTileContent(
      ...
      */
    oTileContent: typingsJapgolly.openui5.sapMTileContentMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getActionButtons(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    /**
      ...
      */
    def getIcon(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    /**
      ...
      */
    def getTileContent(): js.Array[typingsJapgolly.openui5.sapMTileContentMod.default] = js.native
    ...
    def removeActionButton(/**
      ...
      */
    vActionButton: String): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    /**
      * @EXPERIMENTAL (since 1.96)
      *
    ...
    def removeActionButton(/**
      * The actionButton to remove or its index or id
      */
    vActionButton: int): typingsJapgolly.openui5.sapMButtonMod.default | Null = js.native
    def removeActionButton(
      /**
      * The actionButton to remove or its index or id
      */
    vActionButton: typingsJapgolly.openui5.sapMButtonMod.default
    ...
    /**
      ...
      */
    def removeAllActionButtons(): js.Array[typingsJapgolly.openui5.sapMButtonMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllTileContent(): js.Array[typingsJapgolly.openui5.sapMTileContentMod.default] = js.native
    
    def removeTileContent(/**
      * The tileContent to remove or its index or id
      */
    vTileContent: String): typingsJapgolly.openui5.sapMTileContentMod.default | Null = js.native
    /**
    ...
    def removeTileContent(/**
      * The tileContent to remove or its index or id
      */
    vTileContent: int): typingsJapgolly.openui5.sapMTileContentMod.default | Null = js.native
    def removeTileContent(
      /**
      * The tileContent to remove or its index or id
      */
    vTileContent: typingsJapgolly.openui5.sapMTileContentMod.default
    ): typingsJapgolly.openui5.sapMTileContentMod.default | Null = js.native
    ...
    def setIcon(/**
      * The icon to set
      */
    oIcon: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  ...
  trait GenericTileSettings
    ...
    /**
      ...
      * to display an icon or image use sap.m.ImageContent control instead.
      */
    var icon: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
    ...
    var tileContent: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMTileContentMod.default] | typingsJapgolly.openui5.sapMTileContentMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object GenericTileSettings {
    ...
    extension [Self <: GenericTileSettings](x: Self) {
      ...
      inline def setActionButtonsVarargs(value: typingsJapgolly.openui5.sapMButtonMod.default*): Self = StObject.set(x, "actionButtons", js.Array(value*))
      ...
      inline def setIcon(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      ...
      inline def setTileContent(
        value: js.Array[typingsJapgolly.openui5.sapMTileContentMod.default] | typingsJapgolly.openui5.sapMTileContentMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setTileContentVarargs(value: typingsJapgolly.openui5.sapMTileContentMod.default*): Self = StObject.set(x, "tileContent", js.Array(value*))
