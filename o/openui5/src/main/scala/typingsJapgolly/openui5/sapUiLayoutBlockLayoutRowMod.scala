...
import typingsJapgolly.openui5.sapUiLayoutLibraryMod.BlockRowColorSets
...
object sapUiLayoutBlockLayoutRowMod {
  ...
  trait BlockLayoutRow
    ...
    def addAccentCell(
      ...
      * The accentCells to add; if empty, nothing is inserted
      */
    vAccentCell: typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default
    ): this.type = js.native
    ...
    def addContent(
      ...
      */
    oContent: typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getContent(): js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllContent(): js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default] = js.native
    
    def removeContent(/**
      * The content to remove or its index or id
      */
    vContent: String): typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default | Null = js.native
    /**
    ...
    def removeContent(/**
      * The content to remove or its index or id
      */
    vContent: int): typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default | Null = js.native
    def removeContent(
      /**
      * The content to remove or its index or id
      */
    vContent: typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default
    ): typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default | Null = js.native
  ...
  trait BlockLayoutRowSettings
    ...
    /**
      ...
      * with the bright one
      */
    var accentCells: js.UndefOr[js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default | String]] = js.undefined
    
    /**
      * The content cells to be included in the row.
      */
    var content: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default] | typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object BlockLayoutRowSettings {
    ...
    extension [Self <: BlockLayoutRowSettings](x: Self) {
      ...
      inline def setAccentCells(value: js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default | String]): Self = StObject.set(x, "accentCells", value.asInstanceOf[js.Any])
      
      inline def setAccentCellsUndefined: Self = StObject.set(x, "accentCells", js.undefined)
      
      inline def setAccentCellsVarargs(value: (typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default | String)*): Self = StObject.set(x, "accentCells", js.Array(value*))
      
      inline def setContent(
        value: js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default] | typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
      
      inline def setContentUndefined: Self = StObject.set(x, "content", js.undefined)
      
      inline def setContentVarargs(value: typingsJapgolly.openui5.sapUiLayoutBlockLayoutCellMod.default*): Self = StObject.set(x, "content", js.Array(value*))
