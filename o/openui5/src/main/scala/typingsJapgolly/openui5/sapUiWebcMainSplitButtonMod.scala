...
object sapUiWebcMainSplitButtonMod {
  ...
  object SplitButtonSettings {
    ...
    extension [Self <: SplitButtonSettings](x: Self) {
      ...
      inline def setArrowClick(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "arrowClick", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
