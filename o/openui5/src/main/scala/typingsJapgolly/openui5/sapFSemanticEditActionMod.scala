...
object sapFSemanticEditActionMod {
  
  @JSImport("sap/f/semantic/EditAction", JSImport.Default)
  @js.native
  /**
  ...
  type EditAction = typingsJapgolly.openui5.sapFSemanticSemanticButtonMod.default
