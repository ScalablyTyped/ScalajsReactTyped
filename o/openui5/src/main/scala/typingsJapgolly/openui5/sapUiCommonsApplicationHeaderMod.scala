...
object sapUiCommonsApplicationHeaderMod {
  ...
  object ApplicationHeaderSettings {
    ...
    extension [Self <: ApplicationHeaderSettings](x: Self) {
      ...
      inline def setLogoff(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "logoff", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
