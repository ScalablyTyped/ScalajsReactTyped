...
object sapMWheelSliderContainerMod {
  ...
  trait WheelSliderContainer
    ...
    def addSlider(
      ...
      */
    oSlider: typingsJapgolly.openui5.sapMWheelSliderMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getSliders(): js.Array[typingsJapgolly.openui5.sapMWheelSliderMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllSliders(): js.Array[typingsJapgolly.openui5.sapMWheelSliderMod.default] = js.native
    
    def removeSlider(/**
      * The slider to remove or its index or id
      */
    vSlider: String): typingsJapgolly.openui5.sapMWheelSliderMod.default | Null = js.native
    /**
    ...
    def removeSlider(/**
      * The slider to remove or its index or id
      */
    vSlider: int): typingsJapgolly.openui5.sapMWheelSliderMod.default | Null = js.native
    def removeSlider(
      /**
      * The slider to remove or its index or id
      */
    vSlider: typingsJapgolly.openui5.sapMWheelSliderMod.default
    ): typingsJapgolly.openui5.sapMWheelSliderMod.default | Null = js.native
  ...
  trait WheelSliderContainerSettings
    ...
    var sliders: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMWheelSliderMod.default] | typingsJapgolly.openui5.sapMWheelSliderMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object WheelSliderContainerSettings {
    ...
    extension [Self <: WheelSliderContainerSettings](x: Self) {
      ...
      inline def setSliders(
        value: js.Array[typingsJapgolly.openui5.sapMWheelSliderMod.default] | typingsJapgolly.openui5.sapMWheelSliderMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setSlidersVarargs(value: typingsJapgolly.openui5.sapMWheelSliderMod.default*): Self = StObject.set(x, "sliders", js.Array(value*))
