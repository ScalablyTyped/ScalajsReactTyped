...
import typingsJapgolly.openui5.sapUiUx3LibraryMod.VisibleItemCountMode
...
object sapUiUx3FacetFilterMod {
  ...
  trait FacetFilter
    ...
    def addList(
      ...
      */
    oList: typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getLists(): js.Array[typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllLists(): js.Array[typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default] = js.native
    
    def removeList(/**
      * The list to remove or its index or id
      */
    vList: String): typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default | Null = js.native
    /**
    ...
    def removeList(/**
      * The list to remove or its index or id
      */
    vList: int): typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default | Null = js.native
    def removeList(
      /**
      * The list to remove or its index or id
      */
    vList: typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default
    ): typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default | Null = js.native
  ...
  trait FacetFilterSettings
    ...
    var lists: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default] | typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object FacetFilterSettings {
    ...
    extension [Self <: FacetFilterSettings](x: Self) {
      ...
      inline def setLists(
        value: js.Array[typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default] | typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "lists", value.asInstanceOf[js.Any])
      
      inline def setListsUndefined: Self = StObject.set(x, "lists", js.undefined)
      
      inline def setListsVarargs(value: typingsJapgolly.openui5.sapUiUx3FacetFilterListMod.default*): Self = StObject.set(x, "lists", js.Array(value*))
