...
object sapFIllustratedMessageMod {
  
  @JSImport("sap/f/IllustratedMessage", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapMIllustratedMessageMod.default {
    def this(/**
  ...
  type IllustratedMessage = typingsJapgolly.openui5.sapMIllustratedMessageMod.default
  
  type IllustratedMessageSettings = typingsJapgolly.openui5.sapMIllustratedMessageMod.IllustratedMessageSettings
}
