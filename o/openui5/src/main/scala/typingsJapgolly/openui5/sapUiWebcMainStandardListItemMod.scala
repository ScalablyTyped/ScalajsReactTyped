...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ListItemType
...
object sapUiWebcMainStandardListItemMod {
  ...
  object StandardListItemSettings {
    ...
    extension [Self <: StandardListItemSettings](x: Self) {
      ...
      inline def setDetailClick(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "detailClick", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
