...
object sapMNotificationListMod {
  
  @JSImport("sap/m/NotificationList", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: NotificationListSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, NotificationList]
  ...
  type NotificationList = typingsJapgolly.openui5.sapMListBaseMod.default
  
  type NotificationListSettings = ListBaseSettings
}
