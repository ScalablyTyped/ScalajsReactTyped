...
object MediaGalleryItemLayout extends StObject {
  ...
  /* "Square" */ val Square: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryItemLayout.Square & String = js.native
  ...
  sealed trait Wide
    extends StObject
       with MediaGalleryItemLayout
  /* "Wide" */ val Wide: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryItemLayout.Wide & String = js.native
}
