...
object FCLLayout extends StObject {
  ...
  sealed trait EndColumnFullScreen
    extends StObject
       with FCLLayout
  /* "EndColumnFullScreen" */ val EndColumnFullScreen: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.EndColumnFullScreen & String = js.native
  ...
  sealed trait MidColumnFullScreen
    extends StObject
       with FCLLayout
  /* "MidColumnFullScreen" */ val MidColumnFullScreen: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.MidColumnFullScreen & String = js.native
  ...
  sealed trait OneColumn
    extends StObject
       with FCLLayout
  /* "OneColumn" */ val OneColumn: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.OneColumn & String = js.native
  ...
  sealed trait ThreeColumnsEndExpanded
    extends StObject
       with FCLLayout
  /* "ThreeColumnsEndExpanded" */ val ThreeColumnsEndExpanded: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.ThreeColumnsEndExpanded & String = js.native
  ...
  sealed trait ThreeColumnsMidExpanded
    extends StObject
       with FCLLayout
  /* "ThreeColumnsMidExpanded" */ val ThreeColumnsMidExpanded: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.ThreeColumnsMidExpanded & String = js.native
  ...
  sealed trait ThreeColumnsMidExpandedEndHidden
    extends StObject
       with FCLLayout
  /* "ThreeColumnsMidExpandedEndHidden" */ val ThreeColumnsMidExpandedEndHidden: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.ThreeColumnsMidExpandedEndHidden & String = js.native
  ...
  sealed trait ThreeColumnsStartExpandedEndHidden
    extends StObject
       with FCLLayout
  /* "ThreeColumnsStartExpandedEndHidden" */ val ThreeColumnsStartExpandedEndHidden: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.ThreeColumnsStartExpandedEndHidden & String = js.native
  ...
  sealed trait TwoColumnsMidExpanded
    extends StObject
       with FCLLayout
  /* "TwoColumnsMidExpanded" */ val TwoColumnsMidExpanded: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.TwoColumnsMidExpanded & String = js.native
  ...
  sealed trait TwoColumnsStartExpanded
    extends StObject
       with FCLLayout
  /* "TwoColumnsStartExpanded" */ val TwoColumnsStartExpanded: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.FCLLayout.TwoColumnsStartExpanded & String = js.native
}
