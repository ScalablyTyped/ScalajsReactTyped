...
object IllustrationMessageSize extends StObject {
  ...
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IllustrationMessageSize.Auto & String = js.native
  ...
  sealed trait Base
    extends StObject
       with IllustrationMessageSize
  /* "Base" */ val Base: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IllustrationMessageSize.Base & String = js.native
  ...
  sealed trait Dialog
    extends StObject
       with IllustrationMessageSize
  /* "Dialog" */ val Dialog: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IllustrationMessageSize.Dialog & String = js.native
  ...
  sealed trait Scene
    extends StObject
       with IllustrationMessageSize
  /* "Scene" */ val Scene: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IllustrationMessageSize.Scene & String = js.native
  ...
  sealed trait Spot
    extends StObject
       with IllustrationMessageSize
  /* "Spot" */ val Spot: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IllustrationMessageSize.Spot & String = js.native
}
