...
object MediaGalleryMenuVerticalAlign extends StObject {
  ...
  /* "Bottom" */ val Bottom: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryMenuVerticalAlign.Bottom & String = js.native
  ...
  sealed trait Top
    extends StObject
       with MediaGalleryMenuVerticalAlign
  /* "Top" */ val Top: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryMenuVerticalAlign.Top & String = js.native
}
