...
object MediaGalleryLayout extends StObject {
  ...
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryLayout.Auto & String = js.native
  ...
  sealed trait Horizontal
    extends StObject
       with MediaGalleryLayout
  /* "Horizontal" */ val Horizontal: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryLayout.Horizontal & String = js.native
  ...
  sealed trait Vertical
    extends StObject
       with MediaGalleryLayout
  /* "Vertical" */ val Vertical: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryLayout.Vertical & String = js.native
}
