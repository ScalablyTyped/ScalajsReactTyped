...
object SideContentPosition extends StObject {
  ...
  /* "End" */ val End: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.SideContentPosition.End & String = js.native
  ...
  sealed trait Start
    extends StObject
       with SideContentPosition
  /* "Start" */ val Start: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.SideContentPosition.Start & String = js.native
}
