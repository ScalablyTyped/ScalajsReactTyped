...
object TimelineLayout extends StObject {
  ...
  sealed trait Horizontal
    extends StObject
       with TimelineLayout
  /* "Horizontal" */ val Horizontal: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.TimelineLayout.Horizontal & String = js.native
  ...
  sealed trait Vertical
    extends StObject
       with TimelineLayout
  /* "Vertical" */ val Vertical: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.TimelineLayout.Vertical & String = js.native
}
