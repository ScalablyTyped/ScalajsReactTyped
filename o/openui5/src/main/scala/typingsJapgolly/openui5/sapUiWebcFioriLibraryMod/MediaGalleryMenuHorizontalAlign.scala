...
object MediaGalleryMenuHorizontalAlign extends StObject {
  ...
  /* "Left" */ val Left: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryMenuHorizontalAlign.Left & String = js.native
  ...
  sealed trait Right
    extends StObject
       with MediaGalleryMenuHorizontalAlign
  /* "Right" */ val Right: typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.MediaGalleryMenuHorizontalAlign.Right & String = js.native
}
