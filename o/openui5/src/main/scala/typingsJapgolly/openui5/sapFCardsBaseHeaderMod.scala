...
object sapFCardsBaseHeaderMod {
  ...
  trait BaseHeader
    ...
    /**
      ...
      * Defines the toolbar.
      */
    def getToolbar(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setToolbar(/**
      * The toolbar to set
      */
    oToolbar: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  }
  ...
  trait BaseHeaderSettings
    ...
    /**
      ...
      * Defines the toolbar.
      */
    var toolbar: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  }
  object BaseHeaderSettings {
    ...
    extension [Self <: BaseHeaderSettings](x: Self) {
      ...
      inline def setToolbar(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "toolbar", value.asInstanceOf[js.Any])
