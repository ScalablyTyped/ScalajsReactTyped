...
object sapUiCommonsLayoutResponsiveFlowLayoutMod {
  
  @JSImport("sap/ui/commons/layout/ResponsiveFlowLayout", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiLayoutResponsiveFlowLayoutMod.default {
    def this(/**
  ...
  type ResponsiveFlowLayout = typingsJapgolly.openui5.sapUiLayoutResponsiveFlowLayoutMod.default
  
  type ResponsiveFlowLayoutSettings = typingsJapgolly.openui5.sapUiLayoutResponsiveFlowLayoutMod.ResponsiveFlowLayoutSettings
}
