...
import typingsJapgolly.openui5.sapMViewSettingsItemMod.ViewSettingsItemSettings
...
object sapMViewSettingsFilterItemMod {
  ...
  trait ViewSettingsFilterItem
    extends typingsJapgolly.openui5.sapMViewSettingsItemMod.default {
    ...
    /**
      ...
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapMViewSettingsItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllItems(): js.Array[typingsJapgolly.openui5.sapMViewSettingsItemMod.default] = js.native
    
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: String): typingsJapgolly.openui5.sapMViewSettingsItemMod.default | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: int): typingsJapgolly.openui5.sapMViewSettingsItemMod.default | Null = js.native
    def removeItem(
      /**
      * The item to remove or its index or id
      */
    vItem: typingsJapgolly.openui5.sapMViewSettingsItemMod.default
  ...
  object ViewSettingsFilterItemSettings {
    ...
    extension [Self <: ViewSettingsFilterItemSettings](x: Self) {
      ...
      inline def setFilterDetailItemsAggregationChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "filterDetailItemsAggregationChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapMViewSettingsItemMod.default*): Self = StObject.set(x, "items", js.Array(value*))
