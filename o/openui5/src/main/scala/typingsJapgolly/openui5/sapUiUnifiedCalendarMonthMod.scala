...
import typingsJapgolly.openui5.anon.Date
import typingsJapgolly.openui5.anon.WeekDays
...
object sapUiUnifiedCalendarMonthMod {
  ...
  trait Month
    ...
    def addDisabledDate(
      ...
      */
    oDisabledDate: typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getDisabledDates(): js.Array[typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllDisabledDates(): js.Array[typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default] = js.native
    ...
    def removeDisabledDate(/**
      ...
      */
    vDisabledDate: String): typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default | Null = js.native
    /**
      * @SINCE 1.38.0
      *
    ...
    def removeDisabledDate(/**
      * The disabledDate to remove or its index or id
      */
    vDisabledDate: int): typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default | Null = js.native
    def removeDisabledDate(
      /**
      * The disabledDate to remove or its index or id
      */
    vDisabledDate: typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default
  ...
  object MonthSettings {
    ...
    extension [Self <: MonthSettings](x: Self) {
      ...
      inline def setDisabledDatesVarargs(value: typingsJapgolly.openui5.sapUiUnifiedDateRangeMod.default*): Self = StObject.set(x, "disabledDates", js.Array(value*))
      ...
      inline def setWeekNumberSelect(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "weekNumberSelect", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
