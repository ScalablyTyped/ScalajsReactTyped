...
object sapUiCommonsFormFormElementMod {
  
  @JSImport("sap/ui/commons/form/FormElement", JSImport.Default)
  @js.native
  /**
  ...
  @js.native
  trait FormElement
    extends typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default
  
  type FormElementSettings = typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.FormElementSettings
}
