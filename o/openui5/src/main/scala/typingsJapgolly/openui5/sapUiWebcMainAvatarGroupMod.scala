...
import typingsJapgolly.openui5.anon.OverflowButtonClicked
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.AvatarGroupType
...
object sapUiWebcMainAvatarGroupMod {
  ...
  trait AvatarGroup
    ...
    /**
      ...
      */
    def getOverflowButton(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setOverflowButton(
      ...
      */
    oOverflowButton: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
  ...
  trait AvatarGroupSettings
    ...
    /**
      ...
      *  **Note:** If this slot is not used, the component will display the built-in overflow button.
      */
    var overflowButton: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object AvatarGroupSettings {
    ...
    extension [Self <: AvatarGroupSettings](x: Self) {
      ...
      inline def setOverflow(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "overflow", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setOverflowButton(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "overflowButton", value.asInstanceOf[js.Any])
