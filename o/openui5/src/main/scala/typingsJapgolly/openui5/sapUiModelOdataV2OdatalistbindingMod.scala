...
import typingsJapgolly.openui5.anon.CreatedEntitiesKey
import typingsJapgolly.openui5.anon.GroupId
...
object sapUiModelOdataV2OdatalistbindingMod {
  ...
  open class default protected () extends ODataListBinding {
    def this(
      ...
      * The OData V2 model
      */
    oModel: typingsJapgolly.openui5.sapUiModelOdataV2OdatamodelMod.default,
      /**
  ...
  trait ODataListBinding
    ...
    bAtEnd: Boolean,
      ...
      */
    mParameters: GroupId
    ): typingsJapgolly.openui5.sapUiModelOdataV2ContextMod.default = js.native
    /**
      * @SINCE 1.98.0
      *
      * Creates a new entity for this binding's collection via {@link sap.ui.model.odata.v2.ODataModel#createEntry}
