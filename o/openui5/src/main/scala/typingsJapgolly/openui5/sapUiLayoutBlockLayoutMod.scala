...
import typingsJapgolly.openui5.sapUiLayoutLibraryMod.BlockBackgroundType
...
object sapUiLayoutBlockLayoutMod {
  ...
  trait BlockLayout
    ...
    def addContent(
      ...
      */
    oContent: typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getContent(): js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllContent(): js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default] = js.native
    
    def removeContent(/**
      * The content to remove or its index or id
      */
    vContent: String): typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default | Null = js.native
    /**
    ...
    def removeContent(/**
      * The content to remove or its index or id
      */
    vContent: int): typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default | Null = js.native
    def removeContent(
      /**
      * The content to remove or its index or id
      */
    vContent: typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default
    ): typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default | Null = js.native
  ...
  trait BlockLayoutSettings
    ...
    var content: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default] | typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object BlockLayoutSettings {
    ...
    extension [Self <: BlockLayoutSettings](x: Self) {
      ...
      inline def setContent(
        value: js.Array[typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default] | typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
      
      inline def setContentUndefined: Self = StObject.set(x, "content", js.undefined)
      
      inline def setContentVarargs(value: typingsJapgolly.openui5.sapUiLayoutBlockLayoutRowMod.default*): Self = StObject.set(x, "content", js.Array(value*))
