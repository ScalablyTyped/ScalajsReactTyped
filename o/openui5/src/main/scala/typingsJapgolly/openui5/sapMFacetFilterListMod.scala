...
import typingsJapgolly.openui5.anon.AllSelected
import typingsJapgolly.openui5.anon.Term
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMLibraryMod.FacetFilterListDataType
import typingsJapgolly.openui5.sapMListMod.ListSettings
...
object sapMFacetFilterListMod {
  ...
  trait FacetFilterList
    extends typingsJapgolly.openui5.sapMListMod.default {
  ...
  object FacetFilterListSettings {
    ...
    extension [Self <: FacetFilterListSettings](x: Self) {
      ...
      inline def setListClose(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "listClose", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setListCloseUndefined: Self = StObject.set(x, "listClose", js.undefined)
      
      inline def setListOpen(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "listOpen", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
