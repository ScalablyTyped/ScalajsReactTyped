...
object sapUiCommonsFileUploaderMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiUnifiedFileUploaderMod.default {
    def this(/**
  ...
  type FileUploader = typingsJapgolly.openui5.sapUiUnifiedFileUploaderMod.default
  
  type FileUploaderSettings = typingsJapgolly.openui5.sapUiUnifiedFileUploaderMod.FileUploaderSettings
}
