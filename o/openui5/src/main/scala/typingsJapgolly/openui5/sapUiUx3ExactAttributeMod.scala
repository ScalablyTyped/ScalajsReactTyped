...
import typingsJapgolly.openui5.anon.Attribute
...
object sapUiUx3ExactAttributeMod {
  ...
  object ExactAttributeSettings {
    ...
    extension [Self <: ExactAttributeSettings](x: Self) {
      ...
      inline def setSupplyAttributes(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "supplyAttributes", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
