...
object sapUiUnifiedCalendarHeaderMod {
  ...
  object HeaderSettings {
    ...
    extension [Self <: HeaderSettings](x: Self) {
      ...
      inline def setPressButton0(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pressButton0", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setPressButton0Undefined: Self = StObject.set(x, "pressButton0", js.undefined)
      
      inline def setPressButton1(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pressButton1", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setPressButton1Undefined: Self = StObject.set(x, "pressButton1", js.undefined)
      
      inline def setPressButton2(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pressButton2", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setPressButton2Undefined: Self = StObject.set(x, "pressButton2", js.undefined)
      
      inline def setPressCurrentDate(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pressCurrentDate", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setPressCurrentDateUndefined: Self = StObject.set(x, "pressCurrentDate", js.undefined)
      
      inline def setPressNext(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pressNext", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setPressNextUndefined: Self = StObject.set(x, "pressNext", js.undefined)
      
      inline def setPressPrevious(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pressPrevious", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
