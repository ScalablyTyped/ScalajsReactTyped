...
import typingsJapgolly.openui5.anon.AfterPopupOpened
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMDateTimeFieldMod.DateTimeFieldSettings
...
object sapMDatePickerMod {
  ...
  @js.native
  trait DatePicker
    extends typingsJapgolly.openui5.sapMDateTimeFieldMod.default {
    ...
    /**
      ...
      */
    def getSpecialDates(): js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
    ...
    def indexOfSpecialDate(
      ...
      */
    oSpecialDate: typingsJapgolly.openui5.sapUiCoreElementMod.default
    ): int = js.native
    ...
    /**
      ...
      */
    def removeAllSpecialDates(): js.Array[typingsJapgolly.openui5.sapUiCoreElementMod.default] = js.native
  ...
  trait DatePickerSettings
    ...
    /**
      ...
      */
    var legend: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default | String] = js.undefined
  ...
  object DatePickerSettings {
    ...
    extension [Self <: DatePickerSettings](x: Self) {
      ...
      inline def setAfterValueHelpClose(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "afterValueHelpClose", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setAfterValueHelpCloseUndefined: Self = StObject.set(x, "afterValueHelpClose", js.undefined)
      
      inline def setAfterValueHelpOpen(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "afterValueHelpOpen", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setLegend(value: typingsJapgolly.openui5.sapUiCoreControlMod.default | String): Self = StObject.set(x, "legend", value.asInstanceOf[js.Any])
      ...
      inline def setSpecialDatesVarargs(value: typingsJapgolly.openui5.sapUiCoreElementMod.default*): Self = StObject.set(x, "specialDates", js.Array(value*))
    }
  }
}
