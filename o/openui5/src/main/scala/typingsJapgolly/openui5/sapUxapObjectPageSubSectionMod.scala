...
import typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageSubSectionMode
...
object sapUxapObjectPageSubSectionMod {
  ...
  trait ObjectPageSubSection
    ...
    def addBlock(
      ...
      */
    oBlock: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addMoreBlock(
      ...
      */
    oMoreBlock: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      * ```
      */
    def getBlocks(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getMoreBlocks(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def insertBlock(
      ...
      */
    oObject: typingsJapgolly.openui5.sapUxapBlockBaseMod.default,
      /**
      * The insertion index
      */
    iIndex: int
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllBlocks(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllMoreBlocks(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeBlock(/**
      * The block to remove or its index or id
      */
    vBlock: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeBlock(/**
      * The block to remove or its index or id
      */
    vBlock: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeBlock(
      /**
      * The block to remove or its index or id
      */
    vBlock: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    
    def removeMoreBlock(/**
      * The moreBlock to remove or its index or id
      */
    vMoreBlock: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeMoreBlock(/**
      * The moreBlock to remove or its index or id
      */
    vMoreBlock: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeMoreBlock(
      /**
      * The moreBlock to remove or its index or id
      */
    vMoreBlock: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
  ...
  object ObjectPageSubSectionSettings {
    ...
    extension [Self <: ObjectPageSubSectionSettings](x: Self) {
      ...
      inline def setBlocksVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "blocks", js.Array(value*))
      ...
      inline def setMoreBlocksVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "moreBlocks", js.Array(value*))
