...
object sapUiUnifiedColorPickerDisplayModeMod {
  ...
  object default extends StObject {
    ...
    /* "Default" */ val Default: typingsJapgolly.openui5.sapUiUnifiedColorPickerDisplayModeMod.ColorPickerDisplayMode.Default & String = js.native
    
    /* "Large" */ val Large: typingsJapgolly.openui5.sapUiUnifiedColorPickerDisplayModeMod.ColorPickerDisplayMode.Large & String = js.native
    
    /* "Simplified" */ val Simplified: typingsJapgolly.openui5.sapUiUnifiedColorPickerDisplayModeMod.ColorPickerDisplayMode.Simplified & String = js.native
  }
