...
import typingsJapgolly.openui5.sapUiCommonsComboBoxMod.ComboBoxSettings
...
object sapUiCommonsDropdownBoxMod {
  ...
  @js.native
  trait DropdownBox
    extends typingsJapgolly.openui5.sapUiCommonsComboBoxMod.default {
  ...
  object DropdownBoxSettings {
    ...
    extension [Self <: DropdownBoxSettings](x: Self) {
      ...
      inline def setSearchHelp(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "searchHelp", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
