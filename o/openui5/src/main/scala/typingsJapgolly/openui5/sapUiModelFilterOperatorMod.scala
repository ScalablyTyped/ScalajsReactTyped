...
object sapUiModelFilterOperatorMod {
  ...
  object default extends StObject {
    ...
    /* "All" */ val All: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.All & String = js.native
    
    /* "Any" */ val Any: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.Any & String = js.native
    
    /* "BT" */ val BT: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.BT & String = js.native
    
    /* "Contains" */ val Contains: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.Contains & String = js.native
    
    /* "EQ" */ val EQ: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.EQ & String = js.native
    
    /* "EndsWith" */ val EndsWith: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.EndsWith & String = js.native
    
    /* "GE" */ val GE: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.GE & String = js.native
    
    /* "GT" */ val GT: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.GT & String = js.native
    
    /* "LE" */ val LE: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.LE & String = js.native
    
    /* "LT" */ val LT: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.LT & String = js.native
    
    /* "NB" */ val NB: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.NB & String = js.native
    
    /* "NE" */ val NE: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.NE & String = js.native
    
    /* "NotContains" */ val NotContains: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.NotContains & String = js.native
    
    /* "NotEndsWith" */ val NotEndsWith: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.NotEndsWith & String = js.native
    
    /* "NotStartsWith" */ val NotStartsWith: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.NotStartsWith & String = js.native
    
    /* "StartsWith" */ val StartsWith: typingsJapgolly.openui5.sapUiModelFilterOperatorMod.FilterOperator.StartsWith & String = js.native
  }
