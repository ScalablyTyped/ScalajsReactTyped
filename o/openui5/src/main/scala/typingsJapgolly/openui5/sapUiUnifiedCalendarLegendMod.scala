...
object sapUiUnifiedCalendarLegendMod {
  ...
  trait CalendarLegend
    ...
    def addItem(
      ...
      */
    oItem: typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllItems(): js.Array[typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default] = js.native
    
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: String): typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: int): typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default | Null = js.native
    def removeItem(
      /**
      * The item to remove or its index or id
      */
    vItem: typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default
  ...
  object CalendarLegendSettings {
    ...
    extension [Self <: CalendarLegendSettings](x: Self) {
      ...
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapUiUnifiedCalendarLegendItemMod.default*): Self = StObject.set(x, "items", js.Array(value*))
