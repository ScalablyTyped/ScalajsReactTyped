...
object sapMSemanticSendEmailActionMod {
  
  @JSImport("sap/m/semantic/SendEmailAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: SendEmailActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, SendEmailAction]
  ...
  type SendEmailAction = typingsJapgolly.openui5.sapMSemanticSemanticButtonMod.default
  
  type SendEmailActionSettings = SemanticButtonSettings
}
