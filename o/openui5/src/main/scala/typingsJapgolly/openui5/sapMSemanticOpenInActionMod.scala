...
object sapMSemanticOpenInActionMod {
  
  @JSImport("sap/m/semantic/OpenInAction", JSImport.Default)
  @js.native
  /**
  ...
  open class default ()
    ...
    def this(/**
      ...
      */
    mSettings: OpenInActionSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, OpenInAction]
  ...
  type OpenInAction = typingsJapgolly.openui5.sapMSemanticSemanticButtonMod.default
  
  type OpenInActionSettings = SemanticButtonSettings
}
