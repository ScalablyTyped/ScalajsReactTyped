...
import typingsJapgolly.openui5.anon.NewIndex
import typingsJapgolly.openui5.anon.Tile
...
object sapMTileContainerMod {
  ...
  trait TileContainer
    ...
    def addTile(/**
      * The tile to add
      */
    oTile: typingsJapgolly.openui5.sapMTileMod.default): this.type = js.native
    ...
    /**
      ...
      */
    def getTiles(): js.Array[typingsJapgolly.openui5.sapMTileMod.default] = js.native
    ...
    def indexOfTile(/**
      ...
      */
    oTile: typingsJapgolly.openui5.sapMTileMod.default): int = js.native
    ...
    def insertTile(
      ...
      * The Tile to insert
      */
    oTile: typingsJapgolly.openui5.sapMTileMod.default,
      /**
    ...
    def moveTile(
      ...
      * The tile to move
      */
    vTile: typingsJapgolly.openui5.sapMTileMod.default,
      /**
      * The new Tile position in the tiles aggregation
      */
    iNewIndex: int
    ...
    /**
      ...
      */
    def removeAllTiles(): js.Array[typingsJapgolly.openui5.sapMTileMod.default] = js.native
    
    def removeTile(/**
      * The tile to remove or its index or id
      */
    vTile: String): typingsJapgolly.openui5.sapMTileMod.default | Null = js.native
    /**
    ...
    def removeTile(/**
      * The tile to remove or its index or id
      */
    vTile: int): typingsJapgolly.openui5.sapMTileMod.default | Null = js.native
    def removeTile(
      /**
      * The tile to remove or its index or id
      */
    vTile: typingsJapgolly.openui5.sapMTileMod.default
    ): typingsJapgolly.openui5.sapMTileMod.default | Null = js.native
    ...
    bAnimated: Boolean,
      ...
      */
    aVisibleTiles: js.Array[typingsJapgolly.openui5.sapMTileMod.default]
    ): Unit = js.native
    /**
  ...
  trait TileContainerSettings
    ...
    var tiles: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMTileMod.default] | typingsJapgolly.openui5.sapMTileMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object TileContainerSettings {
    ...
    extension [Self <: TileContainerSettings](x: Self) {
      ...
      inline def setTileAdd(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "tileAdd", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setTileAddUndefined: Self = StObject.set(x, "tileAdd", js.undefined)
      
      inline def setTileDelete(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "tileDelete", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setTileDeleteUndefined: Self = StObject.set(x, "tileDelete", js.undefined)
      
      inline def setTileMove(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "tileMove", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setTileMoveUndefined: Self = StObject.set(x, "tileMove", js.undefined)
      
      inline def setTiles(
        value: js.Array[typingsJapgolly.openui5.sapMTileMod.default] | typingsJapgolly.openui5.sapMTileMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "tiles", value.asInstanceOf[js.Any])
      
      inline def setTilesUndefined: Self = StObject.set(x, "tiles", js.undefined)
      
      inline def setTilesVarargs(value: typingsJapgolly.openui5.sapMTileMod.default*): Self = StObject.set(x, "tiles", js.Array(value*))
