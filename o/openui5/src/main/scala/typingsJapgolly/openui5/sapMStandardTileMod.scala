...
import typingsJapgolly.openui5.sapMLibraryMod.StandardTileType
import typingsJapgolly.openui5.sapMTileMod.TileSettings
...
object sapMStandardTileMod {
  ...
  @js.native
  trait StandardTile
    extends typingsJapgolly.openui5.sapMTileMod.default {
