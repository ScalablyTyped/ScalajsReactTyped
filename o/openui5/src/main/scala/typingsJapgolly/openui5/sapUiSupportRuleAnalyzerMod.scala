...
import typingsJapgolly.openui5.anon.Components
import typingsJapgolly.openui5.sapUiSupportLibraryMod.HistoryFormats
import typingsJapgolly.openui5.sapUiSupportSupportRulesHistoryMod.AnalysisResult
