...
object sapUiCommonsFormGridContainerDataMod {
  
  @JSImport("sap/ui/commons/form/GridContainerData", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiLayoutFormGridContainerDataMod.default {
    def this(/**
  ...
  type GridContainerData = typingsJapgolly.openui5.sapUiLayoutFormGridContainerDataMod.default
  
  type GridContainerDataSettings = typingsJapgolly.openui5.sapUiLayoutFormGridContainerDataMod.GridContainerDataSettings
}
