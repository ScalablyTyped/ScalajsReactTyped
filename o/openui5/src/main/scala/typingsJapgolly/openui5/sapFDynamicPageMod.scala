...
object sapFDynamicPageMod {
  ...
  trait DynamicPage
    ...
    /**
      ...
      * `DynamicPage` header.
      */
    def getHeader(): typingsJapgolly.openui5.sapFDynamicPageHeaderMod.default = js.native
    ...
    /**
      ...
      * `DynamicPage` title.
      */
    def getTitle(): typingsJapgolly.openui5.sapFDynamicPageTitleMod.default = js.native
    ...
    def setHeader(/**
      * The header to set
      */
    oHeader: typingsJapgolly.openui5.sapFDynamicPageHeaderMod.default): this.type = js.native
    ...
    def setTitle(/**
      * The title to set
      */
    oTitle: typingsJapgolly.openui5.sapFDynamicPageTitleMod.default): this.type = js.native
  ...
  trait DynamicPageSettings
    ...
    /**
      * `DynamicPage` header.
      */
    var header: js.UndefOr[typingsJapgolly.openui5.sapFDynamicPageHeaderMod.default] = js.undefined
    ...
    /**
      * `DynamicPage` title.
      */
    var title: js.UndefOr[typingsJapgolly.openui5.sapFDynamicPageTitleMod.default] = js.undefined
  ...
  object DynamicPageSettings {
    ...
    extension [Self <: DynamicPageSettings](x: Self) {
      ...
      inline def setHeader(value: typingsJapgolly.openui5.sapFDynamicPageHeaderMod.default): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
      ...
      inline def setPinnedStateChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "pinnedStateChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setTitle(value: typingsJapgolly.openui5.sapFDynamicPageTitleMod.default): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
