...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.AvatarColorScheme
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.AvatarShape
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.AvatarSize
...
object sapUiWebcMainAvatarMod {
  ...
  trait Avatar
    ...
    /**
      ...
      *  }  `
      */
    def getImage(): typingsJapgolly.openui5.sapUiCoreControlMod.default = js.native
    ...
    def setImage(/**
      * The image to set
      */
    oImage: typingsJapgolly.openui5.sapUiCoreControlMod.default): this.type = js.native
  ...
  trait AvatarSettings
    ...
    /**
      ...
      *  }  `
      */
    var image: js.UndefOr[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.undefined
  ...
  object AvatarSettings {
    ...
    extension [Self <: AvatarSettings](x: Self) {
      ...
      inline def setImage(value: typingsJapgolly.openui5.sapUiCoreControlMod.default): Self = StObject.set(x, "image", value.asInstanceOf[js.Any])
