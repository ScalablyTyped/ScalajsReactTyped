...
object sapUiModelOdataV4OdatapropertybindingMod {
  ...
  trait ODataPropertyBinding
    ...
    def getRootBinding(): js.UndefOr[
        typingsJapgolly.openui5.sapUiModelOdataV4OdatacontextbindingMod.default | typingsJapgolly.openui5.sapUiModelOdataV4OdatalistbindingMod.default | ODataPropertyBinding
      ] = js.native
