...
import typingsJapgolly.openui5.anon.SelectedContexts
...
object sapMSelectDialogMod {
  ...
  trait SelectDialog
    ...
    def addItem(
      ...
      */
    oItem: typingsJapgolly.openui5.sapMListItemBaseMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getItems(): js.Array[typingsJapgolly.openui5.sapMListItemBaseMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllItems(): js.Array[typingsJapgolly.openui5.sapMListItemBaseMod.default] = js.native
    
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: String): typingsJapgolly.openui5.sapMListItemBaseMod.default | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: int): typingsJapgolly.openui5.sapMListItemBaseMod.default | Null = js.native
    def removeItem(
      /**
      * The item to remove or its index or id
      */
    vItem: typingsJapgolly.openui5.sapMListItemBaseMod.default
    ): typingsJapgolly.openui5.sapMListItemBaseMod.default | Null = js.native
  ...
  trait SelectDialogSettings
    ...
    var items: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMListItemBaseMod.default] | typingsJapgolly.openui5.sapMListItemBaseMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object SelectDialogSettings {
    ...
    extension [Self <: SelectDialogSettings](x: Self) {
      ...
      inline def setItems(
        value: js.Array[typingsJapgolly.openui5.sapMListItemBaseMod.default] | typingsJapgolly.openui5.sapMListItemBaseMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
      
      inline def setItemsVarargs(value: typingsJapgolly.openui5.sapMListItemBaseMod.default*): Self = StObject.set(x, "items", js.Array(value*))
