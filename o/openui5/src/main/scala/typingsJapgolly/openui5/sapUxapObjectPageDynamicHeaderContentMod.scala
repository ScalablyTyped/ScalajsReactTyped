...
import typingsJapgolly.openui5.sapFDynamicPageHeaderMod.DynamicPageHeaderSettings
import typingsJapgolly.openui5.sapUxapLibraryMod.IHeaderContent
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapUxapObjectPageDynamicHeaderContentMod {
  
  @JSImport("sap/uxap/ObjectPageDynamicHeaderContent", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends ObjectPageDynamicHeaderContent {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: ObjectPageDynamicHeaderContentSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, ObjectPageDynamicHeaderContent]
  ...
  @js.native
  trait ObjectPageDynamicHeaderContent
    extends typingsJapgolly.openui5.sapFDynamicPageHeaderMod.default
       with IHeaderContent
  
  type ObjectPageDynamicHeaderContentSettings = DynamicPageHeaderSettings
}
