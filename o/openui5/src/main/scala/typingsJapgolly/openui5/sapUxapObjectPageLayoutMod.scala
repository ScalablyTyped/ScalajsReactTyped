...
import typingsJapgolly.openui5.anon.Fixed
import typingsJapgolly.openui5.anon.Pinned
import typingsJapgolly.openui5.anon.Section
import typingsJapgolly.openui5.anon.VisibleSubSections
...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.TitleLevel
import typingsJapgolly.openui5.sapUxapLibraryMod.IHeaderTitle
import typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageSubSectionLayout
...
object sapUxapObjectPageLayoutMod {
  ...
  trait ObjectPageLayout
    ...
    def addSection(
      ...
      */
    oSection: typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getLandmarkInfo(): typingsJapgolly.openui5.sapUxapObjectPageAccessibleLandmarkInfoMod.default = js.native
    ...
    /**
      ...
      */
    def getSections(): js.Array[typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllSections(): js.Array[typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default] = js.native
    ...
    def removeSection(/**
      ...
      */
    vSection: String): typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default | Null = js.native
    /**
    ...
    def removeSection(/**
      * The section to remove or its index or id
      */
    vSection: int): typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default | Null = js.native
    def removeSection(
      /**
      * The section to remove or its index or id
      */
    vSection: typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default
    ): typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default | Null = js.native
    ...
    def setLandmarkInfo(
      ...
      */
    oLandmarkInfo: typingsJapgolly.openui5.sapUxapObjectPageAccessibleLandmarkInfoMod.default
    ): this.type = js.native
    ...
    def setSelectedSection(
      ...
      * The ID or the section instance that should be selected Note that `undefined` is not a valid argument
      */
    sId: typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default
    ): this.type = js.native
  ...
  trait ObjectPageLayoutSettings
    ...
    /**
      ...
      * If not set, no landmarks will be written.
      */
    var landmarkInfo: js.UndefOr[typingsJapgolly.openui5.sapUxapObjectPageAccessibleLandmarkInfoMod.default] = js.undefined
    ...
    var sections: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default] | typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      */
    var selectedSection: js.UndefOr[typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default | String] = js.undefined
  ...
  object ObjectPageLayoutSettings {
    ...
    extension [Self <: ObjectPageLayoutSettings](x: Self) {
      ...
      inline def setEditHeaderButtonPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "editHeaderButtonPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setHeaderContentPinnedStateChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "headerContentPinnedStateChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setLandmarkInfo(value: typingsJapgolly.openui5.sapUxapObjectPageAccessibleLandmarkInfoMod.default): Self = StObject.set(x, "landmarkInfo", value.asInstanceOf[js.Any])
      
      inline def setLandmarkInfoUndefined: Self = StObject.set(x, "landmarkInfo", js.undefined)
      
      inline def setNavigate(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "navigate", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setSectionChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "sectionChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setSections(
        value: js.Array[typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default] | typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setSectionsVarargs(value: typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default*): Self = StObject.set(x, "sections", js.Array(value*))
      
      inline def setSelectedSection(value: typingsJapgolly.openui5.sapUxapObjectPageSectionMod.default | String): Self = StObject.set(x, "selectedSection", value.asInstanceOf[js.Any])
      ...
      inline def setSubSectionVisibilityChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "subSectionVisibilityChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setSubSectionVisibilityChangeUndefined: Self = StObject.set(x, "subSectionVisibilityChange", js.undefined)
      
      inline def setToggleAnchorBar(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "toggleAnchorBar", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
