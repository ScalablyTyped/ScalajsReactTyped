...
object sapUiModelOdataV4SubmitModeMod {
  ...
  object default extends StObject {
    ...
    /* "API" */ val API: typingsJapgolly.openui5.sapUiModelOdataV4SubmitModeMod.SubmitMode.API & String = js.native
    
    /* "Auto" */ val Auto: typingsJapgolly.openui5.sapUiModelOdataV4SubmitModeMod.SubmitMode.Auto & String = js.native
    
    /* "Direct" */ val Direct: typingsJapgolly.openui5.sapUiModelOdataV4SubmitModeMod.SubmitMode.Direct & String = js.native
  }
