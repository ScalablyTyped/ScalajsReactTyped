...
object sapUiModelBindingModeMod {
  ...
  object default extends StObject {
    ...
    /* "Default" */ val Default: typingsJapgolly.openui5.sapUiModelBindingModeMod.BindingMode.Default & String = js.native
    
    /* "OneTime" */ val OneTime: typingsJapgolly.openui5.sapUiModelBindingModeMod.BindingMode.OneTime & String = js.native
    
    /* "OneWay" */ val OneWay: typingsJapgolly.openui5.sapUiModelBindingModeMod.BindingMode.OneWay & String = js.native
    
    /* "TwoWay" */ val TwoWay: typingsJapgolly.openui5.sapUiModelBindingModeMod.BindingMode.TwoWay & String = js.native
  }
