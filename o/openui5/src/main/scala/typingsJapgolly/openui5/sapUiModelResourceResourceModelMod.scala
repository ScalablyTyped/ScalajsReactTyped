...
import typingsJapgolly.openui5.anon.Bundle
import typingsJapgolly.openui5.anon.BundleLocale
...
object sapUiModelResourceResourceModelMod {
  ...
  trait ResourceModel
    ...
    def enhance(
      ...
      * if both are set, `bundleName` wins
      */
    oData: typingsJapgolly.openui5.sapBaseI18nResourceBundleMod.default
    ): js.Promise[Any] | Null = js.native
    ...
    /**
      ...
      */
    def getResourceBundle(): typingsJapgolly.openui5.sapBaseI18nResourceBundleMod.default | js.Promise[typingsJapgolly.openui5.sapBaseI18nResourceBundleMod.default] = js.native
  }
}
