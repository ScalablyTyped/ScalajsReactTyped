...
import typingsJapgolly.openui5.sapMLibraryMod.ImageMode
...
object sapMImageMod {
  ...
  trait Image
    ...
    def addAriaDetails(
      ...
      */
    vAriaDetails: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    /**
      * @SINCE 1.79
      *
    ...
    /**
      ...
      */
    def getDetailBox(): typingsJapgolly.openui5.sapMLightBoxMod.default = js.native
  ...
  trait ImageSettings
    ...
    /**
      ...
      */
    var ariaDetails: js.UndefOr[js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default | String]] = js.undefined
    ...
    /**
      ...
      * The `tap` event will still be fired.
      */
    var detailBox: js.UndefOr[typingsJapgolly.openui5.sapMLightBoxMod.default] = js.undefined
  ...
  object ImageSettings {
    ...
    extension [Self <: ImageSettings](x: Self) {
      ...
      inline def setAriaDetails(value: js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default | String]): Self = StObject.set(x, "ariaDetails", value.asInstanceOf[js.Any])
      
      inline def setAriaDetailsUndefined: Self = StObject.set(x, "ariaDetails", js.undefined)
      
      inline def setAriaDetailsVarargs(value: (typingsJapgolly.openui5.sapUiCoreControlMod.default | String)*): Self = StObject.set(x, "ariaDetails", js.Array(value*))
      ...
      inline def setDetailBox(value: typingsJapgolly.openui5.sapMLightBoxMod.default): Self = StObject.set(x, "detailBox", value.asInstanceOf[js.Any])
      ...
      inline def setLoad(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "load", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
