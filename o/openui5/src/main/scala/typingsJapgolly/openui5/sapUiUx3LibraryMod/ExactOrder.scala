...
object ExactOrder extends StObject {
  ...
  sealed trait Fixed
    extends StObject
       with ExactOrder
  /* "Fixed" */ val Fixed: typingsJapgolly.openui5.sapUiUx3LibraryMod.ExactOrder.Fixed & String = js.native
  ...
  sealed trait Select
    extends StObject
       with ExactOrder
  /* "Select" */ val Select: typingsJapgolly.openui5.sapUiUx3LibraryMod.ExactOrder.Select & String = js.native
}
