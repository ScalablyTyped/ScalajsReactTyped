...
object ThingViewerHeaderType extends StObject {
  ...
  /* "Horizontal" */ val Horizontal: typingsJapgolly.openui5.sapUiUx3LibraryMod.ThingViewerHeaderType.Horizontal & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with ThingViewerHeaderType
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiUx3LibraryMod.ThingViewerHeaderType.Standard & String = js.native
}
