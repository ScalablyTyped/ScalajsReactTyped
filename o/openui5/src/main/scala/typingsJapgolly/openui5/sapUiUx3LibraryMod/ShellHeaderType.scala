...
object ShellHeaderType extends StObject {
  ...
  /* "BrandOnly" */ val BrandOnly: typingsJapgolly.openui5.sapUiUx3LibraryMod.ShellHeaderType.BrandOnly & String = js.native
  ...
  sealed trait NoNavigation
    extends StObject
       with ShellHeaderType
  /* "NoNavigation" */ val NoNavigation: typingsJapgolly.openui5.sapUiUx3LibraryMod.ShellHeaderType.NoNavigation & String = js.native
  ...
  sealed trait SlimNavigation
    extends StObject
       with ShellHeaderType
  /* "SlimNavigation" */ val SlimNavigation: typingsJapgolly.openui5.sapUiUx3LibraryMod.ShellHeaderType.SlimNavigation & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with ShellHeaderType
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiUx3LibraryMod.ShellHeaderType.Standard & String = js.native
}
