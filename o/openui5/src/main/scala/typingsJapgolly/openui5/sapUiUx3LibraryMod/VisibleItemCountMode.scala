...
object VisibleItemCountMode extends StObject {
  ...
  /* "Auto" */ val Auto: typingsJapgolly.openui5.sapUiUx3LibraryMod.VisibleItemCountMode.Auto & String = js.native
  ...
  sealed trait Fixed
    extends StObject
       with VisibleItemCountMode
  /* "Fixed" */ val Fixed: typingsJapgolly.openui5.sapUiUx3LibraryMod.VisibleItemCountMode.Fixed & String = js.native
}
