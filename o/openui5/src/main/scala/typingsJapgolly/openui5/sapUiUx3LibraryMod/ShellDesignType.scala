...
object ShellDesignType extends StObject {
  ...
  /* "Crystal" */ val Crystal: typingsJapgolly.openui5.sapUiUx3LibraryMod.ShellDesignType.Crystal & String = js.native
  ...
  sealed trait Light
    extends StObject
       with ShellDesignType
  /* "Light" */ val Light: typingsJapgolly.openui5.sapUiUx3LibraryMod.ShellDesignType.Light & String = js.native
  ...
  sealed trait Standard
    extends StObject
       with ShellDesignType
  /* "Standard" */ val Standard: typingsJapgolly.openui5.sapUiUx3LibraryMod.ShellDesignType.Standard & String = js.native
}
