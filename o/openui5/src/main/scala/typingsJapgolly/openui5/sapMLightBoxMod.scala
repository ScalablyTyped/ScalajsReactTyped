...
object sapMLightBoxMod {
  ...
  trait LightBox
    ...
    def addImageContent(
      ...
      */
    oImageContent: typingsJapgolly.openui5.sapMLightBoxItemMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getImageContent(): js.Array[typingsJapgolly.openui5.sapMLightBoxItemMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllImageContent(): js.Array[typingsJapgolly.openui5.sapMLightBoxItemMod.default] = js.native
    
    def removeImageContent(/**
      * The imageContent to remove or its index or id
      */
    vImageContent: String): typingsJapgolly.openui5.sapMLightBoxItemMod.default | Null = js.native
    /**
    ...
    def removeImageContent(/**
      * The imageContent to remove or its index or id
      */
    vImageContent: int): typingsJapgolly.openui5.sapMLightBoxItemMod.default | Null = js.native
    def removeImageContent(
      /**
      * The imageContent to remove or its index or id
      */
    vImageContent: typingsJapgolly.openui5.sapMLightBoxItemMod.default
    ): typingsJapgolly.openui5.sapMLightBoxItemMod.default | Null = js.native
  ...
  trait LightBoxSettings
    ...
    var imageContent: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMLightBoxItemMod.default] | typingsJapgolly.openui5.sapMLightBoxItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  }
  object LightBoxSettings {
    ...
    extension [Self <: LightBoxSettings](x: Self) {
      ...
      inline def setImageContent(
        value: js.Array[typingsJapgolly.openui5.sapMLightBoxItemMod.default] | typingsJapgolly.openui5.sapMLightBoxItemMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setImageContentVarargs(value: typingsJapgolly.openui5.sapMLightBoxItemMod.default*): Self = StObject.set(x, "imageContent", js.Array(value*))
    }
  }
}
