...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.ISideNavigationItem
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.ISideNavigationSubItem
