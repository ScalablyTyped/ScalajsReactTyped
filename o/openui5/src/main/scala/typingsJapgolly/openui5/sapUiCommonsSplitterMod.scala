...
import typingsJapgolly.openui5.sapUiCommonsLibraryMod.SplitterSize
...
import typingsJapgolly.openui5.sapUiCoreLibraryMod.Percentage
...
object sapUiCommonsSplitterMod {
  ...
  trait Splitter
    ...
    def addFirstPaneContent(
      ...
      */
    oFirstPaneContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addSecondPaneContent(
      ...
      */
    oSecondPaneContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFirstPaneContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getSecondPaneContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllFirstPaneContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllSecondPaneContent(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeFirstPaneContent(/**
      * The firstPaneContent to remove or its index or id
      */
    vFirstPaneContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeFirstPaneContent(/**
      * The firstPaneContent to remove or its index or id
      */
    vFirstPaneContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeFirstPaneContent(
      /**
      * The firstPaneContent to remove or its index or id
      */
    vFirstPaneContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ...
    def removeSecondPaneContent(/**
      ...
      */
    vSecondPaneContent: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeSecondPaneContent(/**
      * The secondPaneContent to remove or its index or id
      */
    vSecondPaneContent: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeSecondPaneContent(
      /**
      * The secondPaneContent to remove or its index or id
      */
    vSecondPaneContent: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
  ...
  object SplitterSettings {
    ...
    extension [Self <: SplitterSettings](x: Self) {
      ...
      inline def setFirstPaneContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "firstPaneContent", js.Array(value*))
      ...
      inline def setSecondPaneContentVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "secondPaneContent", js.Array(value*))
