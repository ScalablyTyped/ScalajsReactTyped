...
import typingsJapgolly.openui5.sapUiCommonsLibraryMod.HorizontalDividerHeight
import typingsJapgolly.openui5.sapUiCommonsLibraryMod.HorizontalDividerType
