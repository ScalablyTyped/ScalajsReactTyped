...
object sapMUploadCollectionItemMod {
  ...
  trait UploadCollectionItem
    ...
    def setFileUploader(
      ...
      * instance may be given
      */
    oFileUploader: typingsJapgolly.openui5.sapUiUnifiedFileUploaderMod.default
    ): this.type = js.native
  ...
  trait UploadCollectionItemSettings
    ...
    /**
      ...
      */
    var fileUploader: js.UndefOr[typingsJapgolly.openui5.sapUiUnifiedFileUploaderMod.default | String] = js.undefined
  ...
  object UploadCollectionItemSettings {
    ...
    extension [Self <: UploadCollectionItemSettings](x: Self) {
      ...
      inline def setDeletePress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "deletePress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setFileUploader(value: typingsJapgolly.openui5.sapUiUnifiedFileUploaderMod.default | String): Self = StObject.set(x, "fileUploader", value.asInstanceOf[js.Any])
