...
object sapUiLayoutCssgridGridLayoutBaseMod {
  ...
  trait GridLayoutBase
    ...
    oElement: HTMLElement,
      ...
      */
    oGridSettings: typingsJapgolly.openui5.sapUiLayoutCssgridGridSettingsMod.default
    ): Unit = js.native
    ...
    def applyGridLayout(
      ...
      */
    aElements: js.Array[HTMLElement | typingsJapgolly.openui5.sapUiCoreControlMod.default]
    ): Unit = js.native
    
    /**
      * Should return the active GridSettings. Must be implemented by child classes.
      */
    def getActiveGridSettings(): typingsJapgolly.openui5.sapUiLayoutCssgridGridSettingsMod.default = js.native
