...
object sapMStandardListItemMod {
  ...
  trait StandardListItem
    ...
    /**
      ...
      */
    def getAvatar(): typingsJapgolly.openui5.sapMAvatarMod.default = js.native
    ...
    def setAvatar(/**
      * The avatar to set
      */
    oAvatar: typingsJapgolly.openui5.sapMAvatarMod.default): this.type = js.native
  ...
  trait StandardListItemSettings
    ...
    /**
      ...
      * is set to `false`, the size of the `Avatar` control is set to "S".
      */
    var avatar: js.UndefOr[typingsJapgolly.openui5.sapMAvatarMod.default] = js.undefined
  ...
  object StandardListItemSettings {
    ...
    extension [Self <: StandardListItemSettings](x: Self) {
      ...
      inline def setAvatar(value: typingsJapgolly.openui5.sapMAvatarMod.default): Self = StObject.set(x, "avatar", value.asInstanceOf[js.Any])
