...
object sapMFormattedTextMod {
  ...
  trait FormattedText
    ...
    def addControl(
      ...
      */
    oControl: typingsJapgolly.openui5.sapMLinkMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getControls(): js.Array[typingsJapgolly.openui5.sapMLinkMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllControls(): js.Array[typingsJapgolly.openui5.sapMLinkMod.default] = js.native
    
    def removeControl(/**
      * The control to remove or its index or id
      */
    vControl: String): typingsJapgolly.openui5.sapMLinkMod.default | Null = js.native
    /**
    ...
    def removeControl(/**
      * The control to remove or its index or id
      */
    vControl: int): typingsJapgolly.openui5.sapMLinkMod.default | Null = js.native
    def removeControl(
      /**
      * The control to remove or its index or id
      */
    vControl: typingsJapgolly.openui5.sapMLinkMod.default
  ...
  object FormattedTextSettings {
    ...
    extension [Self <: FormattedTextSettings](x: Self) {
      ...
      inline def setControlsVarargs(value: typingsJapgolly.openui5.sapMLinkMod.default*): Self = StObject.set(x, "controls", js.Array(value*))
