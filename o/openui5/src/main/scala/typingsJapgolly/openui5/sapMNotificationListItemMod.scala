...
import typingsJapgolly.openui5.sapMNotificationListBaseMod.NotificationListBaseSettings
...
object sapMNotificationListItemMod {
  ...
  trait NotificationListItem
    extends typingsJapgolly.openui5.sapMNotificationListBaseMod.default {
    ...
    /**
      ...
      */
    def getProcessingMessage(): typingsJapgolly.openui5.sapMMessageStripMod.default = js.native
    ...
    def setProcessingMessage(
      ...
      */
    oProcessingMessage: typingsJapgolly.openui5.sapMMessageStripMod.default
    ): this.type = js.native
  ...
  trait NotificationListItemSettings
    ...
    /**
      ...
      * the notification buttons
      */
    var processingMessage: js.UndefOr[typingsJapgolly.openui5.sapMMessageStripMod.default] = js.undefined
  ...
  object NotificationListItemSettings {
    ...
    extension [Self <: NotificationListItemSettings](x: Self) {
      ...
      inline def setProcessingMessage(value: typingsJapgolly.openui5.sapMMessageStripMod.default): Self = StObject.set(x, "processingMessage", value.asInstanceOf[js.Any])
