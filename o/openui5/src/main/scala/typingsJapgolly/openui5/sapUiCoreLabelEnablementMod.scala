...
object sapUiCoreLabelEnablementMod extends Shortcut {
  ...
  object LabelEnablement {
    ...
    inline def apply(
      enrich: typingsJapgolly.openui5.sapUiCoreControlMod.default => Callback,
      getReferencingLabels: typingsJapgolly.openui5.sapUiCoreElementMod.default => js.Array[String],
      isRequired: typingsJapgolly.openui5.sapUiCoreElementMod.default => Boolean,
      writeLabelForAttribute: (typingsJapgolly.openui5.sapUiCoreRenderManagerMod.default, Label) => Callback
    ): LabelEnablement = {
      val __obj = js.Dynamic.literal(enrich = js.Any.fromFunction1((t0: typingsJapgolly.openui5.sapUiCoreControlMod.default) => enrich(t0).runNow()), getReferencingLabels = js.Any.fromFunction1(getReferencingLabels), isRequired = js.Any.fromFunction1(isRequired), writeLabelForAttribute = js.Any.fromFunction2((t0: typingsJapgolly.openui5.sapUiCoreRenderManagerMod.default, t1: Label) => (writeLabelForAttribute(t0, t1)).runNow()))
      __obj.asInstanceOf[LabelEnablement]
    }
    
    extension [Self <: LabelEnablement](x: Self) {
      
      inline def setEnrich(value: typingsJapgolly.openui5.sapUiCoreControlMod.default => Callback): Self = StObject.set(x, "enrich", js.Any.fromFunction1((t0: typingsJapgolly.openui5.sapUiCoreControlMod.default) => value(t0).runNow()))
      
      inline def setGetReferencingLabels(value: typingsJapgolly.openui5.sapUiCoreElementMod.default => js.Array[String]): Self = StObject.set(x, "getReferencingLabels", js.Any.fromFunction1(value))
      
      inline def setIsRequired(value: typingsJapgolly.openui5.sapUiCoreElementMod.default => Boolean): Self = StObject.set(x, "isRequired", js.Any.fromFunction1(value))
      
      inline def setWriteLabelForAttribute(value: (typingsJapgolly.openui5.sapUiCoreRenderManagerMod.default, Label) => Callback): Self = StObject.set(x, "writeLabelForAttribute", js.Any.fromFunction2((t0: typingsJapgolly.openui5.sapUiCoreRenderManagerMod.default, t1: Label) => (value(t0, t1)).runNow()))
    }
  }
