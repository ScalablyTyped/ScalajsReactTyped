package typingsJapgolly.openui5.sapMIllustratedMessageTypeMod
...
/**
  ...
  */
@JSImport("sap/m/IllustratedMessageType", "IllustratedMessageType")
@js.native
object IllustratedMessageType extends StObject {
  ...
  /**
    ...
    */
  @js.native
  sealed trait EmptyPlanningCalendar
    extends StObject
       with IllustratedMessageType
  ...
  /**
    ...
    */
  @js.native
  sealed trait UnableToLoadImage
    extends StObject
       with IllustratedMessageType
