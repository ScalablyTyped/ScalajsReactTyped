...
object sapFGridListItemMod {
  
  @JSImport("sap/f/GridListItem", JSImport.Default)
  @js.native
  /**
    ...
    */
  open class default () extends GridListItem {
    def this(/**
      * Initial settings for the new control
      */
    mSettings: GridListItemSettings) = this()
    def this(/**
  ...
  object default {
    ...
    sClassName: String,
      ...
      * Object literal with information about the class
      */
    oClassInfo: ClassInfo[T, GridListItem]
  ...
  object GridListItemSettings {
    
    inline def apply(): GridListItemSettings = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[GridListItemSettings]
    }
    
    extension [Self <: GridListItemSettings](x: Self) {
