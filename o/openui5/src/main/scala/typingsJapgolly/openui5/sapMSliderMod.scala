...
object sapMSliderMod {
  ...
  trait Slider
    ...
    def addCustomTooltip(
      ...
      */
    oCustomTooltip: typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default
    ): this.type = js.native
    ...
    aProperties: js.Array[Any],
      ...
      */
    oControl: typingsJapgolly.openui5.sapUiCoreElementMod.default
    ): Unit = js.native
    def forwardProperties(
      /**
      * Array of properties to forward
    ...
    /**
      ...
      * used
      */
    def getCustomTooltips(): js.Array[typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default] = js.native
    ...
    /**
      ...
      */
    def getUsedTooltips(): js.Array[typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllCustomTooltips(): js.Array[typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default] = js.native
    ...
    def removeCustomTooltip(/**
      ...
      */
    vCustomTooltip: String): typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default | Null = js.native
    /**
      * @SINCE 1.56
      *
    ...
    def removeCustomTooltip(/**
      * The customTooltip to remove or its index or id
      */
    vCustomTooltip: int): typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default | Null = js.native
    def removeCustomTooltip(
      /**
      * The customTooltip to remove or its index or id
      */
    vCustomTooltip: typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default
    ): typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default | Null = js.native
  ...
  trait SliderSettings
    ...
    var customTooltips: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default] | typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object SliderSettings {
    ...
    extension [Self <: SliderSettings](x: Self) {
      ...
      inline def setCustomTooltips(
        value: js.Array[typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default] | typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setCustomTooltipsVarargs(value: typingsJapgolly.openui5.sapMSliderTooltipBaseMod.default*): Self = StObject.set(x, "customTooltips", js.Array(value*))
