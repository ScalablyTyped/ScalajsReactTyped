...
import typingsJapgolly.openui5.anon.Arguments
import typingsJapgolly.openui5.anon.SchemaChildName
import typingsJapgolly.openui5.anon.ValueAsPromise
...
object sapUiModelOdataV4AnnotationHelperMod extends Shortcut {
  ...
  object AnnotationHelper {
    ...
    inline def apply(
      ...
      resolve$Path: typingsJapgolly.openui5.sapUiModelContextMod.default => String,
    ...
    extension [Self <: AnnotationHelper](x: Self) {
      ...
      inline def setResolve$Path(value: typingsJapgolly.openui5.sapUiModelContextMod.default => String): Self = StObject.set(x, "resolve$Path", js.Any.fromFunction1(value))
