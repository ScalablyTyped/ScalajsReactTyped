...
import typingsJapgolly.openui5.anon.PreviouslySelectedItems
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ITreeItem
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.ListMode
...
object sapUiWebcMainTreeMod {
  ...
  object TreeSettings {
    ...
    extension [Self <: TreeSettings](x: Self) {
      ...
      inline def setItemClick(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "itemClick", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setItemClickUndefined: Self = StObject.set(x, "itemClick", js.undefined)
      
      inline def setItemDelete(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "itemDelete", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setItemDeleteUndefined: Self = StObject.set(x, "itemDelete", js.undefined)
      
      inline def setItemMouseout(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "itemMouseout", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setItemMouseoutUndefined: Self = StObject.set(x, "itemMouseout", js.undefined)
      
      inline def setItemMouseover(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "itemMouseover", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setItemMouseoverUndefined: Self = StObject.set(x, "itemMouseover", js.undefined)
      
      inline def setItemToggle(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "itemToggle", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
