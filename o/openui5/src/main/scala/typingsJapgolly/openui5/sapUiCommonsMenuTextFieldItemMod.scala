...
object sapUiCommonsMenuTextFieldItemMod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.openui5.sapUiUnifiedMenuTextFieldItemMod.default {
    def this(/**
  ...
  type MenuTextFieldItem = typingsJapgolly.openui5.sapUiUnifiedMenuTextFieldItemMod.default
  
  type MenuTextFieldItemSettings = typingsJapgolly.openui5.sapUiUnifiedMenuTextFieldItemMod.MenuTextFieldItemSettings
}
