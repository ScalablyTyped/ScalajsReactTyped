...
object sapUiCoreUtilExportColumnMod {
  ...
  trait ExportColumn
    ...
    /**
      ...
      */
    def getTemplate(): typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default = js.native
    ...
    def setTemplate(
      ...
      * The template to set
      */
    oTemplate: typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default
    ): this.type = js.native
  }
  ...
  trait ExportColumnSettings
    ...
    /**
      * Cell template for column.
      */
    var template: js.UndefOr[typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default] = js.undefined
  }
  object ExportColumnSettings {
    ...
    extension [Self <: ExportColumnSettings](x: Self) {
      ...
      inline def setTemplate(value: typingsJapgolly.openui5.sapUiCoreUtilExportCellMod.default): Self = StObject.set(x, "template", value.asInstanceOf[js.Any])
