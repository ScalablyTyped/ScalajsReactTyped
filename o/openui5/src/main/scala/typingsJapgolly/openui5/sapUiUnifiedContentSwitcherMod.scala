...
object sapUiUnifiedContentSwitcherMod {
  ...
  trait ContentSwitcher
    ...
    def addContent1(
      ...
      */
    oContent1: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addContent2(
      ...
      */
    oContent2: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getContent1(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getContent2(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllContent1(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllContent2(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    
    def removeContent1(/**
      * The content1 to remove or its index or id
      */
    vContent1: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeContent1(/**
      * The content1 to remove or its index or id
      */
    vContent1: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeContent1(
      /**
      * The content1 to remove or its index or id
      */
    vContent1: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    
    def removeContent2(/**
      * The content2 to remove or its index or id
      */
    vContent2: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeContent2(/**
      * The content2 to remove or its index or id
      */
    vContent2: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeContent2(
      /**
      * The content2 to remove or its index or id
      */
    vContent2: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
  ...
  object ContentSwitcherSettings {
    ...
    extension [Self <: ContentSwitcherSettings](x: Self) {
      ...
      inline def setContent1Varargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "content1", js.Array(value*))
      ...
      inline def setContent2Varargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "content2", js.Array(value*))
    }
  }
}
