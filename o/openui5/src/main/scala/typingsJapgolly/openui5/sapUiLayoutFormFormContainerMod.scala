...
object sapUiLayoutFormFormContainerMod {
  ...
  trait FormContainer
    ...
    def addFormElement(
      ...
      */
    oFormElement: typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFormElements(): js.Array[typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllFormElements(): js.Array[typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default] = js.native
    ...
    def removeFormElement(/**
      ...
      */
    vFormElement: String): typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default | Null = js.native
    /**
    ...
    def removeFormElement(/**
      * The formElement to remove or its index or id
      */
    vFormElement: int): typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default | Null = js.native
    def removeFormElement(
      /**
      * The formElement to remove or its index or id
      */
    vFormElement: typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default
    ): typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default | Null = js.native
  ...
  trait FormContainerSettings
    ...
    var formElements: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default] | typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object FormContainerSettings {
    ...
    extension [Self <: FormContainerSettings](x: Self) {
      ...
      inline def setFormElements(
        value: js.Array[typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default] | typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setFormElementsVarargs(value: typingsJapgolly.openui5.sapUiLayoutFormFormElementMod.default*): Self = StObject.set(x, "formElements", js.Array(value*))
