...
object sapUiCoreFormatDateFormatTimezoneDisplayMod {
  ...
  object default extends StObject {
    ...
    /* "Hide" */ val Hide: typingsJapgolly.openui5.sapUiCoreFormatDateFormatTimezoneDisplayMod.DateFormatTimezoneDisplay.Hide & String = js.native
    
    /* "Only" */ val Only: typingsJapgolly.openui5.sapUiCoreFormatDateFormatTimezoneDisplayMod.DateFormatTimezoneDisplay.Only & String = js.native
    
    /* "Show" */ val Show: typingsJapgolly.openui5.sapUiCoreFormatDateFormatTimezoneDisplayMod.DateFormatTimezoneDisplay.Show & String = js.native
  }
