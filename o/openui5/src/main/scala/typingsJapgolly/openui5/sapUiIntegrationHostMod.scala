...
import typingsJapgolly.openui5.anon.ActionConfig
import typingsJapgolly.openui5.anon.Card
import typingsJapgolly.openui5.anon.Data
import typingsJapgolly.openui5.anon.`2`
...
import typingsJapgolly.openui5.sapUiIntegrationLibraryMod.CardMenuAction
...
object sapUiIntegrationHostMod {
  ...
  trait Host
    ...
    sDestinationName: String,
      ...
      */
    oCard: typingsJapgolly.openui5.sapUiIntegrationWidgetsCardMod.default
  ...
  object HostSettings {
    ...
    extension [Self <: HostSettings](x: Self) {
      ...
      inline def setCardConfigurationChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "cardConfigurationChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setCardConfigurationChangeUndefined: Self = StObject.set(x, "cardConfigurationChange", js.undefined)
      
      inline def setCardStateChanged(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "cardStateChanged", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setCardStateChangedUndefined: Self = StObject.set(x, "cardStateChanged", js.undefined)
      
      inline def setMessage(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "message", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
