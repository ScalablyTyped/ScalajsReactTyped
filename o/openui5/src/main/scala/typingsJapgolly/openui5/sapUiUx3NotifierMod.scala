...
import typingsJapgolly.openui5.anon.Message
...
object sapUiUx3NotifierMod {
  ...
  trait Notifier
    ...
    def addMessage(
      ...
      */
    oMessage: typingsJapgolly.openui5.sapUiCoreMessageMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getMessages(): js.Array[typingsJapgolly.openui5.sapUiCoreMessageMod.default] = js.native
    ...
    /**
      ...
      */
    def removeAllMessages(): js.Array[typingsJapgolly.openui5.sapUiCoreMessageMod.default] = js.native
    
    def removeMessage(/**
      * The message to remove or its index or id
      */
    vMessage: String): typingsJapgolly.openui5.sapUiCoreMessageMod.default | Null = js.native
    /**
    ...
    def removeMessage(/**
      * The message to remove or its index or id
      */
    vMessage: int): typingsJapgolly.openui5.sapUiCoreMessageMod.default | Null = js.native
    def removeMessage(
      /**
      * The message to remove or its index or id
      */
    vMessage: typingsJapgolly.openui5.sapUiCoreMessageMod.default
    ): typingsJapgolly.openui5.sapUiCoreMessageMod.default | Null = js.native
  ...
  trait NotifierSettings
    ...
    var messages: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapUiCoreMessageMod.default] | typingsJapgolly.openui5.sapUiCoreMessageMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object NotifierSettings {
    ...
    extension [Self <: NotifierSettings](x: Self) {
      ...
      inline def setMessageSelected(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "messageSelected", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setMessageSelectedUndefined: Self = StObject.set(x, "messageSelected", js.undefined)
      
      inline def setMessages(
        value: js.Array[typingsJapgolly.openui5.sapUiCoreMessageMod.default] | typingsJapgolly.openui5.sapUiCoreMessageMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "messages", value.asInstanceOf[js.Any])
      
      inline def setMessagesUndefined: Self = StObject.set(x, "messages", js.undefined)
      
      inline def setMessagesVarargs(value: typingsJapgolly.openui5.sapUiCoreMessageMod.default*): Self = StObject.set(x, "messages", js.Array(value*))
