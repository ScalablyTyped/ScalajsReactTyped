...
import typingsJapgolly.openui5.sapMLibraryMod.OverflowToolbarPriority
import typingsJapgolly.openui5.sapMToolbarLayoutDataMod.ToolbarLayoutDataSettings
...
object sapMOverflowToolbarLayoutDataMod {
  ...
  trait OverflowToolbarLayoutData
    extends typingsJapgolly.openui5.sapMToolbarLayoutDataMod.default {
