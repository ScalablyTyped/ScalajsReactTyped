...
import typingsJapgolly.openui5.anon.DomRef_
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapMAvatarColorMod.AvatarColor
import typingsJapgolly.openui5.sapMAvatarShapeMod.AvatarShape
...
import typingsJapgolly.openui5.sapUxapLibraryMod.IHeaderTitle
import typingsJapgolly.openui5.sapUxapLibraryMod.ObjectPageHeaderDesign
...
object sapUxapObjectPageHeaderMod {
  ...
  trait ObjectPageHeader
    ...
    def addBreadCrumbLink(
      ...
      */
    oBreadCrumbLink: typingsJapgolly.openui5.sapMLinkMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getBreadCrumbsLinks(): js.Array[typingsJapgolly.openui5.sapMLinkMod.default] = js.native
    ...
    /**
      ...
      */
    def getBreadcrumbs(): typingsJapgolly.openui5.sapMBreadcrumbsMod.default = js.native
    ...
    /**
      ...
      */
    def getNavigationBar(): typingsJapgolly.openui5.sapMBarMod.default = js.native
    ...
    /**
      ...
      */
    def getSideContentButton(): typingsJapgolly.openui5.sapMButtonMod.default = js.native
    ...
    /**
      ...
      */
    def getTitleSelectorTooltip(): typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default | String = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllBreadCrumbsLinks(): js.Array[typingsJapgolly.openui5.sapMLinkMod.default] = js.native
    
    def removeBreadCrumbLink(/**
      * The breadCrumbLink to remove or its index or id
      */
    vBreadCrumbLink: String): typingsJapgolly.openui5.sapMLinkMod.default | Null = js.native
    /**
      * @deprecated (since 1.50) - use the `breadcrumbs` aggregation instead.
      *
    ...
    def removeBreadCrumbLink(/**
      * The breadCrumbLink to remove or its index or id
      */
    vBreadCrumbLink: int): typingsJapgolly.openui5.sapMLinkMod.default | Null = js.native
    def removeBreadCrumbLink(
      /**
      * The breadCrumbLink to remove or its index or id
      */
    vBreadCrumbLink: typingsJapgolly.openui5.sapMLinkMod.default
    ): typingsJapgolly.openui5.sapMLinkMod.default | Null = js.native
    ...
    def setBreadcrumbs(
      ...
      */
    oBreadcrumbs: typingsJapgolly.openui5.sapMBreadcrumbsMod.default
    ): this.type = js.native
    ...
    def setNavigationBar(/**
      ...
      */
    oNavigationBar: typingsJapgolly.openui5.sapMBarMod.default): this.type = js.native
    ...
    def setSideContentButton(
      ...
      */
    oSideContentButton: typingsJapgolly.openui5.sapMButtonMod.default
    ): this.type = js.native
    ...
    def setTitleSelectorTooltip(
      ...
      * The titleSelectorTooltip to set
      */
    vTitleSelectorTooltip: typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default
    ): this.type = js.native
  }
  ...
  trait ObjectPageHeaderSettings
    ...
    var breadCrumbsLinks: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMLinkMod.default] | typingsJapgolly.openui5.sapMLinkMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
    ...
    /**
      ...
      * aggregation is omitted.
      */
    var breadcrumbs: js.UndefOr[typingsJapgolly.openui5.sapMBreadcrumbsMod.default] = js.undefined
    ...
    /**
      * An instance of sap.m.Bar to be embedded in the header
      */
    var navigationBar: js.UndefOr[typingsJapgolly.openui5.sapMBarMod.default] = js.undefined
    ...
    /**
      ...
      * A button that is used for opening the side content of the page or some additional content.
      */
    var sideContentButton: js.UndefOr[typingsJapgolly.openui5.sapMButtonMod.default] = js.undefined
    ...
    /**
      ...
      * default tooltip text is "Related options".
      */
    var titleSelectorTooltip: js.UndefOr[
        String | typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default | PropertyBindingInfo
      ] = js.undefined
  }
  object ObjectPageHeaderSettings {
    ...
    extension [Self <: ObjectPageHeaderSettings](x: Self) {
      ...
      inline def setBreadCrumbsLinks(
        value: js.Array[typingsJapgolly.openui5.sapMLinkMod.default] | typingsJapgolly.openui5.sapMLinkMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ...
      inline def setBreadCrumbsLinksVarargs(value: typingsJapgolly.openui5.sapMLinkMod.default*): Self = StObject.set(x, "breadCrumbsLinks", js.Array(value*))
      
      inline def setBreadcrumbs(value: typingsJapgolly.openui5.sapMBreadcrumbsMod.default): Self = StObject.set(x, "breadcrumbs", value.asInstanceOf[js.Any])
      ...
      inline def setMarkChangesPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "markChangesPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setMarkLockedPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "markLockedPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setNavigationBar(value: typingsJapgolly.openui5.sapMBarMod.default): Self = StObject.set(x, "navigationBar", value.asInstanceOf[js.Any])
      ...
      inline def setSideContentButton(value: typingsJapgolly.openui5.sapMButtonMod.default): Self = StObject.set(x, "sideContentButton", value.asInstanceOf[js.Any])
      
      inline def setSideContentButtonUndefined: Self = StObject.set(x, "sideContentButton", js.undefined)
      
      inline def setTitleSelectorPress(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "titleSelectorPress", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setTitleSelectorPressUndefined: Self = StObject.set(x, "titleSelectorPress", js.undefined)
      
      inline def setTitleSelectorTooltip(value: String | typingsJapgolly.openui5.sapUiCoreTooltipBaseMod.default | PropertyBindingInfo): Self = StObject.set(x, "titleSelectorTooltip", value.asInstanceOf[js.Any])
