...
object cards {
  ...
  object HeaderPosition extends StObject {
    ...
    sealed trait Bottom
      extends StObject
         with HeaderPosition
    /* "Bottom" */ val Bottom: typingsJapgolly.openui5.sapFLibraryMod.cards.HeaderPosition.Bottom & String = js.native
    ...
    sealed trait Top
      extends StObject
         with HeaderPosition
    /* "Top" */ val Top: typingsJapgolly.openui5.sapFLibraryMod.cards.HeaderPosition.Top & String = js.native
  }
  ...
  object NumericHeaderSideIndicatorsAlignment extends StObject {
    ...
    /* "Begin" */ val Begin: typingsJapgolly.openui5.sapFLibraryMod.cards.NumericHeaderSideIndicatorsAlignment.Begin & String = js.native
    ...
    sealed trait End
      extends StObject
         with NumericHeaderSideIndicatorsAlignment
    /* "End" */ val End: typingsJapgolly.openui5.sapFLibraryMod.cards.NumericHeaderSideIndicatorsAlignment.End & String = js.native
  }
