...
object DynamicPageTitleArea extends StObject {
  ...
  /* "Begin" */ val Begin: typingsJapgolly.openui5.sapFLibraryMod.DynamicPageTitleArea.Begin & String = js.native
  ...
  sealed trait Middle
    extends StObject
       with DynamicPageTitleArea
  /* "Middle" */ val Middle: typingsJapgolly.openui5.sapFLibraryMod.DynamicPageTitleArea.Middle & String = js.native
}
