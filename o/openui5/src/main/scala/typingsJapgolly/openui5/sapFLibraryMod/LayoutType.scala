...
object LayoutType extends StObject {
  ...
  sealed trait EndColumnFullScreen
    extends StObject
       with LayoutType
  /* "EndColumnFullScreen" */ val EndColumnFullScreen: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.EndColumnFullScreen & String = js.native
  ...
  sealed trait MidColumnFullScreen
    extends StObject
       with LayoutType
  /* "MidColumnFullScreen" */ val MidColumnFullScreen: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.MidColumnFullScreen & String = js.native
  ...
  sealed trait OneColumn
    extends StObject
       with LayoutType
  /* "OneColumn" */ val OneColumn: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.OneColumn & String = js.native
  ...
  sealed trait ThreeColumnsBeginExpandedEndHidden
    extends StObject
       with LayoutType
  /* "ThreeColumnsBeginExpandedEndHidden" */ val ThreeColumnsBeginExpandedEndHidden: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.ThreeColumnsBeginExpandedEndHidden & String = js.native
  ...
  sealed trait ThreeColumnsEndExpanded
    extends StObject
       with LayoutType
  /* "ThreeColumnsEndExpanded" */ val ThreeColumnsEndExpanded: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.ThreeColumnsEndExpanded & String = js.native
  ...
  sealed trait ThreeColumnsMidExpanded
    extends StObject
       with LayoutType
  /* "ThreeColumnsMidExpanded" */ val ThreeColumnsMidExpanded: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.ThreeColumnsMidExpanded & String = js.native
  ...
  sealed trait ThreeColumnsMidExpandedEndHidden
    extends StObject
       with LayoutType
  /* "ThreeColumnsMidExpandedEndHidden" */ val ThreeColumnsMidExpandedEndHidden: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.ThreeColumnsMidExpandedEndHidden & String = js.native
  ...
  sealed trait TwoColumnsBeginExpanded
    extends StObject
       with LayoutType
  /* "TwoColumnsBeginExpanded" */ val TwoColumnsBeginExpanded: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.TwoColumnsBeginExpanded & String = js.native
  ...
  sealed trait TwoColumnsMidExpanded
    extends StObject
       with LayoutType
  /* "TwoColumnsMidExpanded" */ val TwoColumnsMidExpanded: typingsJapgolly.openui5.sapFLibraryMod.LayoutType.TwoColumnsMidExpanded & String = js.native
}
