...
object AvatarGroupType extends StObject {
  ...
  /* "Group" */ val Group: typingsJapgolly.openui5.sapFLibraryMod.AvatarGroupType.Group & String = js.native
  ...
  sealed trait Individual
    extends StObject
       with AvatarGroupType
  /* "Individual" */ val Individual: typingsJapgolly.openui5.sapFLibraryMod.AvatarGroupType.Individual & String = js.native
}
