...
object sapMAvatarTypeMod {
  ...
  object default extends StObject {
    ...
    /* "Icon" */ val Icon: typingsJapgolly.openui5.sapMAvatarTypeMod.AvatarType.Icon & String = js.native
    
    /* "Image" */ val Image: typingsJapgolly.openui5.sapMAvatarTypeMod.AvatarType.Image & String = js.native
    
    /* "Initials" */ val Initials: typingsJapgolly.openui5.sapMAvatarTypeMod.AvatarType.Initials & String = js.native
  }
