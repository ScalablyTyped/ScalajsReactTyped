...
import typingsJapgolly.openui5.anon.Step
import typingsJapgolly.openui5.sap.ClassInfo
import typingsJapgolly.openui5.sapFLibraryMod.IDynamicPageStickyContent
import typingsJapgolly.openui5.sapMLibraryMod.PageBackgroundDesign
import typingsJapgolly.openui5.sapMLibraryMod.WizardRenderMode
...
object sapMWizardMod {
  ...
  trait Wizard
    ...
    def addStep(
      ...
      */
    oWizardStep: typingsJapgolly.openui5.sapMWizardStepMod.default
    ): this.type = js.native
    ...
    def discardProgress(
      ...
      */
    oStep: typingsJapgolly.openui5.sapMWizardStepMod.default,
      /**
    ...
    /**
      ...
      * @returns Pointer to the control instance for chaining.
      */
    def getProgressStep(): typingsJapgolly.openui5.sapMWizardStepMod.default = js.native
    ...
    /**
      ...
      */
    def getSteps(): js.Array[typingsJapgolly.openui5.sapMWizardStepMod.default] = js.native
    ...
    def invalidateStep(/**
      ...
      */
    oStep: typingsJapgolly.openui5.sapMWizardStepMod.default): this.type = js.native
    ...
    /**
      ...
      */
    def removeAllSteps(): js.Array[typingsJapgolly.openui5.sapMWizardStepMod.default] = js.native
    ...
    def setCurrentStep(
      ...
      */
    vStepId: typingsJapgolly.openui5.sapMWizardStepMod.default
    ): this.type = js.native
    def setCurrentStep(
      /**
      * The step of the wizard that will be currently activated (meaning the last step).
  ...
  trait WizardSettings
    ...
    /**
      ...
      */
    var currentStep: js.UndefOr[typingsJapgolly.openui5.sapMWizardStepMod.default | String] = js.undefined
    ...
    var steps: js.UndefOr[
        js.Array[typingsJapgolly.openui5.sapMWizardStepMod.default] | typingsJapgolly.openui5.sapMWizardStepMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  ...
  object WizardSettings {
    ...
    extension [Self <: WizardSettings](x: Self) {
      ...
      inline def setComplete(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setCompleteUndefined: Self = StObject.set(x, "complete", js.undefined)
      
      inline def setCurrentStep(value: typingsJapgolly.openui5.sapMWizardStepMod.default | String): Self = StObject.set(x, "currentStep", value.asInstanceOf[js.Any])
      ...
      inline def setNavigationChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "navigationChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      ...
      inline def setStepActivate(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "stepActivate", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
      
      inline def setStepActivateUndefined: Self = StObject.set(x, "stepActivate", js.undefined)
      
      inline def setSteps(
        value: js.Array[typingsJapgolly.openui5.sapMWizardStepMod.default] | typingsJapgolly.openui5.sapMWizardStepMod.default | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ): Self = StObject.set(x, "steps", value.asInstanceOf[js.Any])
      
      inline def setStepsUndefined: Self = StObject.set(x, "steps", js.undefined)
      
      inline def setStepsVarargs(value: typingsJapgolly.openui5.sapMWizardStepMod.default*): Self = StObject.set(x, "steps", js.Array(value*))
