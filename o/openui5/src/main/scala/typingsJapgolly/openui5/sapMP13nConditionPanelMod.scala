...
object sapMP13nConditionPanelMod {
  ...
  object P13nConditionPanelSettings {
    ...
    extension [Self <: P13nConditionPanelSettings](x: Self) {
      ...
      inline def setDataChange(value: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default => Callback): Self = StObject.set(x, "dataChange", js.Any.fromFunction1((t0: /* oEvent */ typingsJapgolly.openui5.sapUiBaseEventMod.default) => value(t0).runNow()))
