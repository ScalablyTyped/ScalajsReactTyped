...
import typingsJapgolly.openui5.anon.EscPressed
...
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.PopoverHorizontalAlign
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.PopoverPlacementType
import typingsJapgolly.openui5.sapUiWebcMainLibraryMod.PopoverVerticalAlign
...
object sapUiWebcMainResponsivePopoverMod {
  ...
  trait ResponsivePopover
    ...
    def addFooter(
      ...
      */
    oFooter: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    def addHeader(
      ...
      */
    oHeader: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): this.type = js.native
    ...
    /**
      ...
      */
    def getFooter(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      */
    def getHeader(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllFooter(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    /**
      ...
      * @returns An array of the removed elements (might be empty)
      */
    def removeAllHeader(): js.Array[typingsJapgolly.openui5.sapUiCoreControlMod.default] = js.native
    ...
    def removeFooter(/**
      ...
      */
    vFooter: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeFooter(/**
      * The footer to remove or its index or id
      */
    vFooter: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeFooter(
      /**
      * The footer to remove or its index or id
      */
    vFooter: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    
    def removeHeader(/**
      * The header to remove or its index or id
      */
    vHeader: String): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    /**
    ...
    def removeHeader(/**
      * The header to remove or its index or id
      */
    vHeader: int): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
    def removeHeader(
      /**
      * The header to remove or its index or id
      */
    vHeader: typingsJapgolly.openui5.sapUiCoreControlMod.default
    ): typingsJapgolly.openui5.sapUiCoreControlMod.default | Null = js.native
  ...
  object ResponsivePopoverSettings {
    ...
    extension [Self <: ResponsivePopoverSettings](x: Self) {
      ...
      inline def setFooterVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "footer", js.Array(value*))
      ...
      inline def setHeaderVarargs(value: typingsJapgolly.openui5.sapUiCoreControlMod.default*): Self = StObject.set(x, "header", js.Array(value*))
