...
import typingsJapgolly.openui5.sapUiWebcFioriLibraryMod.IProductSwitchItem
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object sapUiWebcFioriProductSwitchMod {
  
  @JSImport("sap/ui/webc/fiori/ProductSwitch", JSImport.Default)
  @js.native
  /**
  ...
  trait ProductSwitch
    ...
    def addItem(/**
      ...
      */
    oItem: IProductSwitchItem): this.type = js.native
    ...
    /**
      ...
      */
    def getItems(): js.Array[IProductSwitchItem] = js.native
    ...
    def indexOfItem(/**
      ...
      */
    oItem: IProductSwitchItem): int = js.native
    ...
    /**
      ...
      */
    def removeAllItems(): js.Array[IProductSwitchItem] = js.native
    
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: String): IProductSwitchItem | Null = js.native
    /**
    ...
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: int): IProductSwitchItem | Null = js.native
    def removeItem(/**
      * The item to remove or its index or id
      */
    vItem: IProductSwitchItem): IProductSwitchItem | Null = js.native
  }
  ...
  trait ProductSwitchSettings
    ...
    var items: js.UndefOr[
        js.Array[IProductSwitchItem] | IProductSwitchItem | AggregationBindingInfo | (/* template literal string: {${string}} */ String)
      ] = js.undefined
  }
  object ProductSwitchSettings {
    ...
    extension [Self <: ProductSwitchSettings](x: Self) {
      ...
      inline def setItemsVarargs(value: IProductSwitchItem*): Self = StObject.set(x, "items", js.Array(value*))
    }
  }
}
