...
import typingsJapgolly.octokitTypes.anon.Previews
import typingsJapgolly.octokitTypes.distTypesRequestHeadersMod.RequestHeaders
...
object distTypesRequestParametersMod {
