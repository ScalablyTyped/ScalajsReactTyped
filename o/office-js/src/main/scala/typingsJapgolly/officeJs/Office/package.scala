...
package object Office {
  /**
    ...
    */
  type Appointment = typingsJapgolly.officeJs.Office.Item
  /**
    ...
    */
  type ItemCompose = typingsJapgolly.officeJs.Office.Item
  /**
    ...
    */
  type ItemRead = typingsJapgolly.officeJs.Office.Item
  /**
    ...
    * - {@link Office.MessageRead | MessageRead}
    */
  type Message = typingsJapgolly.officeJs.Office.Item
  /**
    ...
    */
  type TextBinding = typingsJapgolly.officeJs.Office.Binding
}
