...
object ReplyFormData {
  ...
  def apply(
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: /* asyncResult */ typingsJapgolly.officeJs.Office.AsyncResult[js.Any]) => callback(t0).runNow()))
