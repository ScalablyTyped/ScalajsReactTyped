...
import typingsJapgolly.officeJs.Office.MailboxEnums.Days
import typingsJapgolly.officeJs.Office.MailboxEnums.Month
import typingsJapgolly.officeJs.Office.MailboxEnums.WeekNumber
