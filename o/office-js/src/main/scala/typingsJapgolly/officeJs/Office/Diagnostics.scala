...
import typingsJapgolly.officeJs.Office.MailboxEnums.OWAView
import typingsJapgolly.officeJs.officeJsStrings.OneColumn
import typingsJapgolly.officeJs.officeJsStrings.ThreeColumns
import typingsJapgolly.officeJs.officeJsStrings.TwoColumns
...
trait Diagnostics extends StObject {
  ...
  /**
    ...
    * **{@link https://learn.microsoft.com/office/dev/add-ins/outlook/outlook-add-ins-overview#extension-points | Applicable Outlook mode}**: Compose or Read
    */
  var OWAView: typingsJapgolly.officeJs.Office.MailboxEnums.OWAView | OneColumn | TwoColumns | ThreeColumns
