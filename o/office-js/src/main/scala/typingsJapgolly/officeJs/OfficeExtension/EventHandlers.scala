...
object EventHandlers {
  ...
  inline def apply[T](
    ...
    remove: js.Function1[/* args */ T, js.Promise[Any]] => Callback
  ): EventHandlers[T] = {
    val __obj = js.Dynamic.literal(add = js.Any.fromFunction1(add), remove = js.Any.fromFunction1((t0: js.Function1[/* args */ T, js.Promise[Any]]) => remove(t0).runNow()))
  ...
  extension [Self <: EventHandlers[?], T](x: Self & EventHandlers[T]) {
    ...
    inline def setRemove(value: js.Function1[/* args */ T, js.Promise[Any]] => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: js.Function1[/* args */ T, js.Promise[Any]]) => value(t0).runNow()))
  }
}
