...
import typingsJapgolly.officeJs.Office.Actions
import typingsJapgolly.officeJs.Office.Addin
import typingsJapgolly.officeJs.Office.AsyncResult
import typingsJapgolly.officeJs.Office.Auth
import typingsJapgolly.officeJs.Office.Binding
import typingsJapgolly.officeJs.Office.Context
import typingsJapgolly.officeJs.Office.IPromiseConstructor
import typingsJapgolly.officeJs.Office.Ribbon
import typingsJapgolly.officeJs.anon.Host
import typingsJapgolly.officeJs.global.Office.^
...
/**
  ...
  */
inline def initialize(reason: typingsJapgolly.officeJs.Office.InitializationReason): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("initialize")(reason.asInstanceOf[js.Any]).asInstanceOf[Unit]
