...
import typingsJapgolly.officeJs.Excel.IconCollections
import typingsJapgolly.officeJs.Excel.RunOptions
import typingsJapgolly.officeJs.OfficeExtension.ClientObject
import typingsJapgolly.officeJs.OfficeExtension.ClientRequestContext
import typingsJapgolly.officeJs.global.Excel.^
...
/**
  ...
  */
inline def run[T](batch: js.Function1[/* context */ typingsJapgolly.officeJs.Excel.RequestContext, js.Promise[T]]): js.Promise[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("run")(batch.asInstanceOf[js.Any]).asInstanceOf[js.Promise[T]]
/**
...
inline def run[T](
  ...
  batch: js.Function1[/* context */ typingsJapgolly.officeJs.Excel.RequestContext, js.Promise[T]]
