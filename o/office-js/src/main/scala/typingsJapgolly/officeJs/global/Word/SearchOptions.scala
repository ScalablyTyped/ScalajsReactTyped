...
open class SearchOptions ()
  extends StObject
     with typingsJapgolly.officeJs.Word.SearchOptions {
...
object SearchOptions {
  ...
  /**
    ...
    */
  /* static member */
  inline def newObject(context: ClientRequestContext): typingsJapgolly.officeJs.Word.SearchOptions = ^.asInstanceOf[js.Dynamic].applyDynamic("newObject")(context.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.officeJs.Word.SearchOptions]
}
