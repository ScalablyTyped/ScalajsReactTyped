...
import typingsJapgolly.officeJs.Office.IPromiseConstructor
import typingsJapgolly.officeJs.OfficeExtension.DebugInfo
import typingsJapgolly.officeJs.OfficeExtension.EmbeddedOptions
import typingsJapgolly.officeJs.OfficeExtension.EventInfo
...
object OfficeExtension {
  ...
  open class ClientObject ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.ClientObject {
    
    /** The request context associated with the object */
    /* CompleteClass */
    var context: typingsJapgolly.officeJs.OfficeExtension.ClientRequestContext = js.native
  ...
  open class ClientRequestContext ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.ClientRequestContext {
  ...
  open class ClientResult[T] ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.ClientResult[T] {
  ...
  open class EmbeddedSession protected ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.EmbeddedSession {
    def this(url: String) = this()
  ...
  open class Error ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.Error {
    ...
    /* CompleteClass */
    var innerError: typingsJapgolly.officeJs.OfficeExtension.Error = js.native
  ...
  open class ErrorCodes ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.ErrorCodes
  object ErrorCodes {
  ...
  open class EventHandlerResult[T] protected ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.EventHandlerResult[T] {
    def this(
      context: typingsJapgolly.officeJs.OfficeExtension.ClientRequestContext,
      handlers: typingsJapgolly.officeJs.OfficeExtension.EventHandlers[T],
  ...
  open class EventHandlers[T] protected ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.EventHandlers[T] {
    def this(
      context: typingsJapgolly.officeJs.OfficeExtension.ClientRequestContext,
      parentObject: typingsJapgolly.officeJs.OfficeExtension.ClientObject,
      name: String,
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def add(handler: js.Function1[T, js.Promise[Any]]): typingsJapgolly.officeJs.OfficeExtension.EventHandlerResult[T] = js.native
  ...
  open class TrackedObjects ()
    extends StObject
       with typingsJapgolly.officeJs.OfficeExtension.TrackedObjects
