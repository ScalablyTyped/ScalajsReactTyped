...
open class DataConnectionCollection ()
  extends StObject
     with typingsJapgolly.officeJs.Excel.DataConnectionCollection {
  ...
  /* CompleteClass */
  @JSName("context")
  var context_DataConnectionCollection: typingsJapgolly.officeJs.Excel.RequestContext = js.native
