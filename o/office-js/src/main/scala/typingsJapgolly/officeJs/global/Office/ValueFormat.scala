...
object ValueFormat extends StObject {
  ...
  @JSBracketAccess
  def apply(value: Double): js.UndefOr[typingsJapgolly.officeJs.Office.ValueFormat & Double] = js.native
  
  /* 1 */ val Formatted: typingsJapgolly.officeJs.Office.ValueFormat.Formatted & Double = js.native
  
  /* 0 */ val Unformatted: typingsJapgolly.officeJs.Office.ValueFormat.Unformatted & Double = js.native
}
