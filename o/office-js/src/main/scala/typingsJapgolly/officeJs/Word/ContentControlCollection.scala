...
import typingsJapgolly.officeJs.Word.Interfaces.ContentControlCollectionData
import typingsJapgolly.officeJs.Word.Interfaces.ContentControlCollectionLoadOptions
