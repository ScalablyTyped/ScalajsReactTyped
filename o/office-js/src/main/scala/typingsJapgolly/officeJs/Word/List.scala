...
trait List
  ...
  /**
    ...
    */
  def load(): typingsJapgolly.officeJs.Word.List = js.native
  def load(options: ListLoadOptions): typingsJapgolly.officeJs.Word.List = js.native
  def load(propertyNamesAndPaths: Expand): typingsJapgolly.officeJs.Word.List = js.native
  def load(propertyNames: String): typingsJapgolly.officeJs.Word.List = js.native
  def load(propertyNames: js.Array[String]): typingsJapgolly.officeJs.Word.List = js.native
  ...
  /**
    ...
    */
  def track(): typingsJapgolly.officeJs.Word.List = js.native
  
  /**
    * Release the memory associated with this object, if it has previously been tracked. This call is shorthand for {@link https://docs.microsoft.com/javascript/api/office/officeextension.clientrequestcontext#office-officeextension-clientrequestcontext-trackedobjects-member | context.trackedObjects.remove(thisObject)}. Having many tracked objects slows down the host application, so please remember to free any objects you add, once you're done using them. You will need to call `context.sync()` before the memory release takes effect.
    */
  def untrack(): typingsJapgolly.officeJs.Word.List = js.native
}
