...
import typingsJapgolly.officeJs.Word.Interfaces.NoteItemData
import typingsJapgolly.officeJs.Word.Interfaces.NoteItemLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.NoteItemUpdateData
