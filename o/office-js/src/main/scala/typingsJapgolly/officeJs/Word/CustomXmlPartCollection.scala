...
import typingsJapgolly.officeJs.Word.Interfaces.CustomXmlPartCollectionData
import typingsJapgolly.officeJs.Word.Interfaces.CustomXmlPartCollectionLoadOptions
