...
import typingsJapgolly.officeJs.Word.Interfaces.TableRowData
import typingsJapgolly.officeJs.Word.Interfaces.TableRowLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.TableRowUpdateData
