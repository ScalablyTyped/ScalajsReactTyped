...
import typingsJapgolly.officeJs.Word.Interfaces.SearchOptionsData
import typingsJapgolly.officeJs.Word.Interfaces.SearchOptionsLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.SearchOptionsUpdateData
