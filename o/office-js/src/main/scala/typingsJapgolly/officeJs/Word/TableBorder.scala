...
import typingsJapgolly.officeJs.Word.Interfaces.TableBorderData
import typingsJapgolly.officeJs.Word.Interfaces.TableBorderLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.TableBorderUpdateData
