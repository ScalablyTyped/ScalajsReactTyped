...
import typingsJapgolly.officeJs.Word.Interfaces.TableData
import typingsJapgolly.officeJs.Word.Interfaces.TableLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.TableUpdateData
...
trait Table
  ...
  def getRange(rangeLocation: typingsJapgolly.officeJs.Word.RangeLocation.end): Range = js.native
  def getRange(rangeLocation: typingsJapgolly.officeJs.Word.RangeLocation.start): Range = js.native
