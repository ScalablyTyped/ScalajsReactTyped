...
import typingsJapgolly.officeJs.Word.DocumentPropertyType
...
trait CustomPropertyData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    DocumentPropertyType | typingsJapgolly.officeJs.officeJsStrings.String | Number | Date | Boolean
  ] = js.undefined
  /**
    *
...
object CustomPropertyData {
  ...
  def apply(
    key: String = null,
    `type`: DocumentPropertyType | typingsJapgolly.officeJs.officeJsStrings.String | Number | Date | Boolean = null,
    value: js.Any = null
  ): CustomPropertyData = {
