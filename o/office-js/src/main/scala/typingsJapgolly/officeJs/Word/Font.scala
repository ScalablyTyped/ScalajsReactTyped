...
import typingsJapgolly.officeJs.Word.Interfaces.FontData
import typingsJapgolly.officeJs.Word.Interfaces.FontLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.FontUpdateData
...
class Font () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.1]
    */
  var underline: UnderlineType | Mixed | None | Hidden | DotLine | Single | typingsJapgolly.officeJs.officeJsStrings.Word | typingsJapgolly.officeJs.officeJsStrings.Double | Thick | Dotted | DottedHeavy | DashLine | DashLineHeavy | DashLineLong | DashLineLongHeavy | DotDashLine | DotDashLineHeavy | TwoDotDashLine | TwoDotDashLineHeavy | Wave | WaveHeavy | WaveDouble = js.native
  /**
