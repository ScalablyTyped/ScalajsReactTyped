...
import typingsJapgolly.officeJs.Word.Interfaces.DocumentPropertiesData
import typingsJapgolly.officeJs.Word.Interfaces.DocumentPropertiesLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.DocumentPropertiesUpdateData
