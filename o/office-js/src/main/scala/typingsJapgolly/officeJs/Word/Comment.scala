...
import typingsJapgolly.officeJs.Word.Interfaces.CommentData
import typingsJapgolly.officeJs.Word.Interfaces.CommentLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.CommentUpdateData
