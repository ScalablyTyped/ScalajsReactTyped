...
import typingsJapgolly.officeJs.Word.Interfaces.SettingData
import typingsJapgolly.officeJs.Word.Interfaces.SettingLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.SettingUpdateData
