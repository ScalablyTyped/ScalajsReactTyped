...
import typingsJapgolly.officeJs.Word.Interfaces.CustomPropertyData
import typingsJapgolly.officeJs.Word.Interfaces.CustomPropertyLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.CustomPropertyUpdateData
...
trait CustomProperty
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: DocumentPropertyType | typingsJapgolly.officeJs.officeJsStrings.String | Number | Date | Boolean = js.native
