...
import typingsJapgolly.officeJs.Word.Interfaces.CommentReplyData
import typingsJapgolly.officeJs.Word.Interfaces.CommentReplyLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.CommentReplyUpdateData
