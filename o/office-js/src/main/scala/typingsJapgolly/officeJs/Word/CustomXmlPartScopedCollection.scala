...
import typingsJapgolly.officeJs.Word.Interfaces.CustomXmlPartScopedCollectionData
import typingsJapgolly.officeJs.Word.Interfaces.CustomXmlPartScopedCollectionLoadOptions
