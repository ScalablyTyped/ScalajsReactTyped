...
class Body () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: BodyType | Unknown_ | MainDoc | typingsJapgolly.officeJs.officeJsStrings.Section | Header | Footer | typingsJapgolly.officeJs.officeJsStrings.TableCell = js.native
  /**
    *
