...
import typingsJapgolly.officeJs.Word.Interfaces.BodyData
import typingsJapgolly.officeJs.Word.Interfaces.BodyLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.BodyUpdateData
...
import typingsJapgolly.officeJs.officeJsStrings.Endnote
import typingsJapgolly.officeJs.officeJsStrings.Footer
import typingsJapgolly.officeJs.officeJsStrings.Footnote
import typingsJapgolly.officeJs.officeJsStrings.Header
import typingsJapgolly.officeJs.officeJsStrings.Line
import typingsJapgolly.officeJs.officeJsStrings.MainDoc
...
trait Body
  ...
  def insertBreak(breakType: BreakType, insertLocation: typingsJapgolly.officeJs.Word.InsertLocation.end): Unit = js.native
  /**
    ...
    */
  def insertBreak(breakType: BreakType, insertLocation: typingsJapgolly.officeJs.Word.InsertLocation.start): Unit = js.native
  ...
  def insertParagraph(paragraphText: String, insertLocation: typingsJapgolly.officeJs.Word.InsertLocation.end): Paragraph = js.native
  /**
    ...
    * @param insertLocation Required. The value must be 'Start' or 'End'.
    */
  def insertParagraph(paragraphText: String, insertLocation: typingsJapgolly.officeJs.Word.InsertLocation.start): Paragraph = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: BodyType | Unknown_ | MainDoc | typingsJapgolly.officeJs.officeJsStrings.Section | Header | Footer | typingsJapgolly.officeJs.officeJsStrings.TableCell | Footnote | Endnote | typingsJapgolly.officeJs.officeJsStrings.NoteItem = js.native
