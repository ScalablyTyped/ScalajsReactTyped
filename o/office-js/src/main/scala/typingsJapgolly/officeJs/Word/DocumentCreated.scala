...
import typingsJapgolly.officeJs.Word.Interfaces.DocumentCreatedData
import typingsJapgolly.officeJs.Word.Interfaces.DocumentCreatedLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.DocumentCreatedUpdateData
