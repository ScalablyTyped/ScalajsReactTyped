...
import typingsJapgolly.officeJs.Word.Interfaces.InlinePictureCollectionData
import typingsJapgolly.officeJs.Word.Interfaces.InlinePictureCollectionLoadOptions
