...
import typingsJapgolly.officeJs.Word.Interfaces.CustomPropertyCollectionData
import typingsJapgolly.officeJs.Word.Interfaces.CustomPropertyCollectionLoadOptions
