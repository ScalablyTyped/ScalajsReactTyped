...
import typingsJapgolly.officeJs.Word.Interfaces.InlinePictureData
import typingsJapgolly.officeJs.Word.Interfaces.InlinePictureLoadOptions
import typingsJapgolly.officeJs.Word.Interfaces.InlinePictureUpdateData
