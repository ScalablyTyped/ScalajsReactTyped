...
import typingsJapgolly.officeJs.Excel.CellPropertiesBorderLoadOptions
import typingsJapgolly.officeJs.Excel.CellPropertiesFillLoadOptions
import typingsJapgolly.officeJs.Excel.CellPropertiesFontLoadOptions
