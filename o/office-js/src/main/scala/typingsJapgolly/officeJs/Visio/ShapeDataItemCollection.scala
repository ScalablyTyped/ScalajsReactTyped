...
import typingsJapgolly.officeJs.Visio.Interfaces.ShapeDataItemCollectionData
import typingsJapgolly.officeJs.Visio.Interfaces.ShapeDataItemCollectionLoadOptions
