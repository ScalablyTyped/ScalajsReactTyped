...
import typingsJapgolly.officeJs.Visio.Interfaces.HyperlinkCollectionData
import typingsJapgolly.officeJs.Visio.Interfaces.HyperlinkCollectionLoadOptions
