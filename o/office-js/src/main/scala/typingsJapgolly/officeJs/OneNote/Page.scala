...
import typingsJapgolly.officeJs.OneNote.Interfaces.PageData
import typingsJapgolly.officeJs.OneNote.Interfaces.PageLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.PageUpdateData
