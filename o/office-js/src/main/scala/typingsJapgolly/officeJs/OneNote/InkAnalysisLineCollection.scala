...
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisLineCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisLineCollectionLoadOptions
