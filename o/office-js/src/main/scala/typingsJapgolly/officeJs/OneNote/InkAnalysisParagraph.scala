...
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisParagraphData
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisParagraphLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisParagraphUpdateData
