...
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisParagraphCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisParagraphCollectionLoadOptions
