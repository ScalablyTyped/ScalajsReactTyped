...
import typingsJapgolly.officeJs.OneNote.Interfaces.TableCellData
import typingsJapgolly.officeJs.OneNote.Interfaces.TableCellLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.TableCellUpdateData
