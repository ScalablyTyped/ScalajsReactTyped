...
import typingsJapgolly.officeJs.OneNote.Interfaces.PageContentData
import typingsJapgolly.officeJs.OneNote.Interfaces.PageContentLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.PageContentUpdateData
...
trait PageContent
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: PageContentType | typingsJapgolly.officeJs.officeJsStrings.Outline | typingsJapgolly.officeJs.officeJsStrings.Image | Ink | Other = js.native
