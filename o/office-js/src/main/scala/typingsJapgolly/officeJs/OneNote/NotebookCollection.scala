...
import typingsJapgolly.officeJs.OneNote.Interfaces.NotebookCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.NotebookCollectionLoadOptions
