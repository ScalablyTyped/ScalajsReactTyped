...
import typingsJapgolly.officeJs.OneNote.Interfaces.TableCellCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.TableCellCollectionLoadOptions
