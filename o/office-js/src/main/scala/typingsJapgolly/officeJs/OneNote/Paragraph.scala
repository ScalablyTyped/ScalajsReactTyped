...
import typingsJapgolly.officeJs.OneNote.Interfaces.ParagraphData
import typingsJapgolly.officeJs.OneNote.Interfaces.ParagraphLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.ParagraphUpdateData
...
class Paragraph () extends ClientObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  val `type`: ParagraphType | typingsJapgolly.officeJs.officeJsStrings.RichText | typingsJapgolly.officeJs.officeJsStrings.Image | typingsJapgolly.officeJs.officeJsStrings.Table | Ink | Other = js.native
  def addNoteTag(
