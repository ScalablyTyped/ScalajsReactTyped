...
import typingsJapgolly.officeJs.OneNote.Interfaces.TableData
import typingsJapgolly.officeJs.OneNote.Interfaces.TableLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.TableUpdateData
