...
import typingsJapgolly.officeJs.OneNote.Interfaces.SectionGroupCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.SectionGroupCollectionLoadOptions
