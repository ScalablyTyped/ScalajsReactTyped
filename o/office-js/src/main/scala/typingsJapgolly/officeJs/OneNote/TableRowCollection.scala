...
import typingsJapgolly.officeJs.OneNote.Interfaces.TableRowCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.TableRowCollectionLoadOptions
