...
import typingsJapgolly.officeJs.OneNote.Interfaces.SectionCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.SectionCollectionLoadOptions
