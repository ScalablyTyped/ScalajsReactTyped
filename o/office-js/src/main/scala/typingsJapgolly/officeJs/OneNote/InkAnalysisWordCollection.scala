...
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisWordCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisWordCollectionLoadOptions
