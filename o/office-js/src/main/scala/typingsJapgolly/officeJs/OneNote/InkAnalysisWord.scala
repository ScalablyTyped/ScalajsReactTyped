...
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisWordData
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisWordLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisWordUpdateData
