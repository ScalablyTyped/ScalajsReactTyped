...
import typingsJapgolly.officeJs.OneNote.Interfaces.ApplicationData
import typingsJapgolly.officeJs.OneNote.Interfaces.ApplicationLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.ApplicationUpdateData
