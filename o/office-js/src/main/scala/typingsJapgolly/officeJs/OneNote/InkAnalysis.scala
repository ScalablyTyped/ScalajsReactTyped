...
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisData
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.InkAnalysisUpdateData
