...
import typingsJapgolly.officeJs.OneNote.Interfaces.InkWordCollectionData
import typingsJapgolly.officeJs.OneNote.Interfaces.InkWordCollectionLoadOptions
