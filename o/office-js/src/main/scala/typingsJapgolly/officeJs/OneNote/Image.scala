...
import typingsJapgolly.officeJs.OneNote.Interfaces.ImageData
import typingsJapgolly.officeJs.OneNote.Interfaces.ImageLoadOptions
import typingsJapgolly.officeJs.OneNote.Interfaces.ImageUpdateData
