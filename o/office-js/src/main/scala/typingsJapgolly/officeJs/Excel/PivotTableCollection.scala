...
import typingsJapgolly.officeJs.Excel.Interfaces.PivotTableCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.PivotTableCollectionLoadOptions
