...
import typingsJapgolly.officeJs.Excel.Interfaces.LinkedWorkbookCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.LinkedWorkbookCollectionLoadOptions
