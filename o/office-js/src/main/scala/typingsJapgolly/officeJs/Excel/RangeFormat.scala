...
import typingsJapgolly.officeJs.Excel.Interfaces.RangeFormatData
import typingsJapgolly.officeJs.Excel.Interfaces.RangeFormatLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.RangeFormatUpdateData
