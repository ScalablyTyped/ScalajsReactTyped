...
import typingsJapgolly.officeJs.Excel.Interfaces.BindingData
import typingsJapgolly.officeJs.Excel.Interfaces.BindingLoadOptions
...
trait Binding
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  val `type`: BindingType | typingsJapgolly.officeJs.officeJsStrings.Range | typingsJapgolly.officeJs.officeJsStrings.Table | Text = js.native
}
