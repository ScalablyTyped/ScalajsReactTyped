...
import typingsJapgolly.officeJs.Excel.Interfaces.DataValidationData
import typingsJapgolly.officeJs.Excel.Interfaces.DataValidationLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.DataValidationUpdateData
...
trait DataValidation
  ...
  /**
    ...
    * [Api set: ExcelApi 1.8]
    */
  val `type`: DataValidationType | None | WholeNumber | Decimal | typingsJapgolly.officeJs.officeJsStrings.List | Date | Time | TextLength | Custom | Inconsistent | MixedCriteria = js.native
