...
import typingsJapgolly.officeJs.Excel.Interfaces.TimelineStyleCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.TimelineStyleCollectionLoadOptions
