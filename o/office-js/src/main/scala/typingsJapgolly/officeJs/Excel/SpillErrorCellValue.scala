...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.spill
import typingsJapgolly.officeJs.Excel.RangeValueType.error
import typingsJapgolly.officeJs.officeJsStrings.Collision
import typingsJapgolly.officeJs.officeJsStrings.Error
import typingsJapgolly.officeJs.officeJsStrings.IndeterminateSize
import typingsJapgolly.officeJs.officeJsStrings.MergedCell
import typingsJapgolly.officeJs.officeJsStrings.NumbersignSPILLExclamationmark
import typingsJapgolly.officeJs.officeJsStrings.OutOfMemoryWhileCalc
import typingsJapgolly.officeJs.officeJsStrings.Spill
import typingsJapgolly.officeJs.officeJsStrings.Unknown_
import typingsJapgolly.officeJs.officeJsStrings.WorksheetEdge
...
trait SpillErrorCellValue
  ...
  var errorSubType: js.UndefOr[
    SpillErrorCellValueSubType | Unknown_ | Collision | IndeterminateSize | WorksheetEdge | OutOfMemoryWhileCalc | typingsJapgolly.officeJs.officeJsStrings.Table | MergedCell
  ] = js.undefined
...
object SpillErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error): SpillErrorCellValue = {
  ...
  extension [Self <: SpillErrorCellValue](x: Self) {
    ...
    inline def setErrorSubType(
      value: SpillErrorCellValueSubType | Unknown_ | Collision | IndeterminateSize | WorksheetEdge | OutOfMemoryWhileCalc | typingsJapgolly.officeJs.officeJsStrings.Table | MergedCell
