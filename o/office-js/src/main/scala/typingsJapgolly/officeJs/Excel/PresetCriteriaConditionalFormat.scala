...
import typingsJapgolly.officeJs.Excel.Interfaces.PresetCriteriaConditionalFormatData
import typingsJapgolly.officeJs.Excel.Interfaces.PresetCriteriaConditionalFormatLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.PresetCriteriaConditionalFormatUpdateData
