...
import typingsJapgolly.officeJs.Excel.Interfaces.WorksheetCustomPropertyData
import typingsJapgolly.officeJs.Excel.Interfaces.WorksheetCustomPropertyLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.WorksheetCustomPropertyUpdateData
