...
import typingsJapgolly.officeJs.Excel.Interfaces.TableColumnCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.TableColumnCollectionLoadOptions
