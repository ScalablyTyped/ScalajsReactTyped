...
import typingsJapgolly.officeJs.Excel.Interfaces.PivotTableStyleCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.PivotTableStyleCollectionLoadOptions
