...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.ref
import typingsJapgolly.officeJs.Excel.RangeValueType.error
import typingsJapgolly.officeJs.officeJsStrings.Error
import typingsJapgolly.officeJs.officeJsStrings.ExternalLinksCalculatedRef
import typingsJapgolly.officeJs.officeJsStrings.ExternalLinksStructuredRef
import typingsJapgolly.officeJs.officeJsStrings.NumbersignREFExclamationmark
import typingsJapgolly.officeJs.officeJsStrings.Ref
...
object RefErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error): RefErrorCellValue = {
