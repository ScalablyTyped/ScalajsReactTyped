...
import typingsJapgolly.officeJs.Excel.Interfaces.HeaderFooterData
import typingsJapgolly.officeJs.Excel.Interfaces.HeaderFooterLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.HeaderFooterUpdateData
