...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.field
import typingsJapgolly.officeJs.Excel.RangeValueType.error
import typingsJapgolly.officeJs.officeJsStrings.DataProviderError
import typingsJapgolly.officeJs.officeJsStrings.Error
import typingsJapgolly.officeJs.officeJsStrings.Field
import typingsJapgolly.officeJs.officeJsStrings.NumbersignFIELDExclamationmark
import typingsJapgolly.officeJs.officeJsStrings.Unknown_
import typingsJapgolly.officeJs.officeJsStrings.WebImageMissingFilePart
...
object FieldErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error): FieldErrorCellValue = {
