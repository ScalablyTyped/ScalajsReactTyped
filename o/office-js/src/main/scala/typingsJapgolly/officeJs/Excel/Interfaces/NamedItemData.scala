...
import typingsJapgolly.officeJs.Excel.NamedItemScope
import typingsJapgolly.officeJs.Excel.NamedItemType
...
import typingsJapgolly.officeJs.officeJsStrings.Workbook
import typingsJapgolly.officeJs.officeJsStrings.Worksheet
...
trait NamedItemData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    NamedItemType | typingsJapgolly.officeJs.officeJsStrings.String | Integer | Double | Boolean | Range | Error | Array
  ] = js.undefined
  /**
    *
...
object NamedItemData {
  ...
  def apply(
    ...
    `type`: NamedItemType | typingsJapgolly.officeJs.officeJsStrings.String | Integer | Double | Boolean | Range | Error | Array = null,
    value: js.Any = null,
