...
import typingsJapgolly.officeJs.Excel.Interfaces.DataPivotHierarchyCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.DataPivotHierarchyCollectionLoadOptions
