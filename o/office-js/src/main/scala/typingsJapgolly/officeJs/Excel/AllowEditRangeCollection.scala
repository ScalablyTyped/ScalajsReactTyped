...
import typingsJapgolly.officeJs.Excel.Interfaces.AllowEditRangeCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.AllowEditRangeCollectionLoadOptions
