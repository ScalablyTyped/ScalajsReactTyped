...
import typingsJapgolly.officeJs.Excel.Interfaces.DocumentPropertiesData
import typingsJapgolly.officeJs.Excel.Interfaces.DocumentPropertiesLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.DocumentPropertiesUpdateData
