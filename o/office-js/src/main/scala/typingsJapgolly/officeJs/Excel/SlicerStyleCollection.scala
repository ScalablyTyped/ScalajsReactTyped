...
import typingsJapgolly.officeJs.Excel.Interfaces.SlicerStyleCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.SlicerStyleCollectionLoadOptions
