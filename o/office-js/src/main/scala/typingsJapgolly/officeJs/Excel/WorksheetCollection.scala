...
import typingsJapgolly.officeJs.Excel.Interfaces.WorksheetCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.WorksheetCollectionLoadOptions
