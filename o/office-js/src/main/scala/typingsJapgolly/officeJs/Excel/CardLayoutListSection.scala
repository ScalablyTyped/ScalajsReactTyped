...
trait CardLayoutListSection
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var layout: typingsJapgolly.officeJs.officeJsStrings.List
}
object CardLayoutListSection {
  ...
  extension [Self <: CardLayoutListSection](x: Self) {
    ...
    inline def setLayout(value: typingsJapgolly.officeJs.officeJsStrings.List): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
  }
}
