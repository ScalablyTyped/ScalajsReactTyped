...
import typingsJapgolly.officeJs.Excel.RangeValueType.string
...
trait StringCellValue extends StObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var `type`: typingsJapgolly.officeJs.Excel.CellValueType.string | String
}
object StringCellValue {
  
  inline def apply(basicValue: java.lang.String, `type`: typingsJapgolly.officeJs.Excel.CellValueType.string | String): StringCellValue = {
  ...
  extension [Self <: StringCellValue](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.officeJs.Excel.CellValueType.string | String): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
