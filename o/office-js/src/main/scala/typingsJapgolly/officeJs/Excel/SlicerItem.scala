...
import typingsJapgolly.officeJs.Excel.Interfaces.SlicerItemData
import typingsJapgolly.officeJs.Excel.Interfaces.SlicerItemLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.SlicerItemUpdateData
