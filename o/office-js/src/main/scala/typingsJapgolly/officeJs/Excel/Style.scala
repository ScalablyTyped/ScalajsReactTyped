...
import typingsJapgolly.officeJs.Excel.Interfaces.StyleData
import typingsJapgolly.officeJs.Excel.Interfaces.StyleLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.StyleUpdateData
