...
import typingsJapgolly.officeJs.officeJsStrings.TextAsNumber
...
trait SortField extends StObject {
  ...
  var sortOn: js.UndefOr[
    SortOn | Value | CellColor | FontColor | typingsJapgolly.officeJs.officeJsStrings.Icon
  ] = js.undefined
...
object SortField {
  ...
  extension [Self <: SortField](x: Self) {
    ...
    inline def setSortOn(value: SortOn | Value | CellColor | FontColor | typingsJapgolly.officeJs.officeJsStrings.Icon): Self = StObject.set(x, "sortOn", value.asInstanceOf[js.Any])
