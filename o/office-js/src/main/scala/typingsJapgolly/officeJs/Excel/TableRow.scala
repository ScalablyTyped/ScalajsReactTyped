...
import typingsJapgolly.officeJs.Excel.Interfaces.TableRowData
import typingsJapgolly.officeJs.Excel.Interfaces.TableRowLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.TableRowUpdateData
