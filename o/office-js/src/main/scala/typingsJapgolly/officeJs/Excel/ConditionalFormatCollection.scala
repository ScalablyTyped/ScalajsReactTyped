...
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalFormatCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalFormatCollectionLoadOptions
...
trait ConditionalFormatCollection
  ...
  /**
    ...
    */
  def add(
    `type`: Custom | DataBar | ColorScale | typingsJapgolly.officeJs.officeJsStrings.IconSet | TopBottom | PresetCriteria | ContainsText | typingsJapgolly.officeJs.officeJsStrings.CellValue
