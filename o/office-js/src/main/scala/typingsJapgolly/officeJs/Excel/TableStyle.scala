...
import typingsJapgolly.officeJs.Excel.Interfaces.TableStyleData
import typingsJapgolly.officeJs.Excel.Interfaces.TableStyleLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.TableStyleUpdateData
