...
import typingsJapgolly.officeJs.Excel.Interfaces.TableScopedCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.TableScopedCollectionLoadOptions
