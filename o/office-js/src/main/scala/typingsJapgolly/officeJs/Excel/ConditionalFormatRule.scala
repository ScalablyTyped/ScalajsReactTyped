...
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalFormatRuleData
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalFormatRuleLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalFormatRuleUpdateData
