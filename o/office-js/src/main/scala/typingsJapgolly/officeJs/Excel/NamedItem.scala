...
import typingsJapgolly.officeJs.Excel.Interfaces.NamedItemData
import typingsJapgolly.officeJs.Excel.Interfaces.NamedItemLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.NamedItemUpdateData
...
class NamedItem () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.4]
    */
  val scope: NamedItemScope | typingsJapgolly.officeJs.officeJsStrings.Worksheet | typingsJapgolly.officeJs.officeJsStrings.Workbook = js.native
  /**
    *
    ...
    */
  val `type`: NamedItemType | typingsJapgolly.officeJs.officeJsStrings.String | Integer | Double | Boolean | typingsJapgolly.officeJs.officeJsStrings.Range | Error | Array = js.native
  /**
    *
