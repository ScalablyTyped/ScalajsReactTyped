...
trait CardLayoutTableSection
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var layout: typingsJapgolly.officeJs.officeJsStrings.Table
}
object CardLayoutTableSection {
  ...
  extension [Self <: CardLayoutTableSection](x: Self) {
    ...
    inline def setLayout(value: typingsJapgolly.officeJs.officeJsStrings.Table): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
  }
}
