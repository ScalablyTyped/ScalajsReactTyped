...
import typingsJapgolly.officeJs.Excel.ConditionalDataBarAxisFormat
import typingsJapgolly.officeJs.Excel.ConditionalDataBarDirection
import typingsJapgolly.officeJs.Excel.ConditionalDataBarRule
