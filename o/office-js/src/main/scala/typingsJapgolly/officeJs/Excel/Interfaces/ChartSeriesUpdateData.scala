...
import typingsJapgolly.officeJs.Excel.ChartAxisGroup
import typingsJapgolly.officeJs.Excel.ChartGradientStyle
import typingsJapgolly.officeJs.Excel.ChartGradientStyleType
import typingsJapgolly.officeJs.Excel.ChartMarkerStyle
import typingsJapgolly.officeJs.Excel.ChartParentLabelStrategy
import typingsJapgolly.officeJs.Excel.ChartSplitType
