...
import typingsJapgolly.officeJs.Excel.Interfaces.RangeAreasCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.RangeAreasCollectionLoadOptions
