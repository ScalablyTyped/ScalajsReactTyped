...
import typingsJapgolly.officeJs.Excel.Interfaces.NamedItemCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.NamedItemCollectionLoadOptions
