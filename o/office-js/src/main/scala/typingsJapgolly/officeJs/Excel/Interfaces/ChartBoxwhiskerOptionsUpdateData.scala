...
import typingsJapgolly.officeJs.Excel.ChartBoxQuartileCalculation
import typingsJapgolly.officeJs.officeJsStrings.Exclusive
import typingsJapgolly.officeJs.officeJsStrings.Inclusive
