...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.notAvailable
...
import typingsJapgolly.officeJs.officeJsStrings.NumbersignNSlashAExclamationmark
...
object NotAvailableErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error): NotAvailableErrorCellValue = {
