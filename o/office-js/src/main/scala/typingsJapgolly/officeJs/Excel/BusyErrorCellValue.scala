...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.busy
import typingsJapgolly.officeJs.Excel.RangeValueType.error
import typingsJapgolly.officeJs.officeJsStrings.Busy
...
import typingsJapgolly.officeJs.officeJsStrings.LoadingImage
import typingsJapgolly.officeJs.officeJsStrings.NumbersignBUSYExclamationmark
...
object BusyErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error): BusyErrorCellValue = {
