...
import typingsJapgolly.officeJs.Excel.Interfaces.RangeFontData
import typingsJapgolly.officeJs.Excel.Interfaces.RangeFontLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.RangeFontUpdateData
import typingsJapgolly.officeJs.OfficeExtension.ClientObject
import typingsJapgolly.officeJs.OfficeExtension.UpdateOptions
import typingsJapgolly.officeJs.anon.Expand
import typingsJapgolly.officeJs.officeJsStrings.DoubleAccountant
...
trait RangeFont
  ...
  /**
    ...
    * [Api set: ExcelApi 1.1]
    */
  var underline: RangeUnderlineStyle | None | Single | typingsJapgolly.officeJs.officeJsStrings.Double | SingleAccountant | DoubleAccountant = js.native
}
