...
import typingsJapgolly.officeJs.Excel.Interfaces.TextConditionalFormatData
import typingsJapgolly.officeJs.Excel.Interfaces.TextConditionalFormatLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.TextConditionalFormatUpdateData
