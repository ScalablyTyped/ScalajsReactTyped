...
import typingsJapgolly.officeJs.Excel.Interfaces.ChartBorderData
import typingsJapgolly.officeJs.Excel.Interfaces.ChartBorderLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.ChartBorderUpdateData
