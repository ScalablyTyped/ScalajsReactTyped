...
import typingsJapgolly.officeJs.Excel.Interfaces.BindingCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.BindingCollectionLoadOptions
...
class BindingCollection () extends ClientObject {
  ...
  def addFromNamedItem_Range(name: String, bindingType: typingsJapgolly.officeJs.officeJsStrings.Range, id: String): Binding = js.native
  @JSName("addFromNamedItem")
  def addFromNamedItem_Table(name: String, bindingType: typingsJapgolly.officeJs.officeJsStrings.Table, id: String): Binding = js.native
  @JSName("addFromNamedItem")
  ...
  def addFromSelection_Range(bindingType: typingsJapgolly.officeJs.officeJsStrings.Range, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Table(bindingType: typingsJapgolly.officeJs.officeJsStrings.Table, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Text(bindingType: Text, id: String): Binding = js.native
  @JSName("add")
  def add_Range(range: String, bindingType: typingsJapgolly.officeJs.officeJsStrings.Range, id: String): Binding = js.native
  /**
    *
    * Add a new binding to a particular Range.
    *
    ...
    */
  @JSName("add")
  def add_Range(range: Range, bindingType: typingsJapgolly.officeJs.officeJsStrings.Range, id: String): Binding = js.native
  @JSName("add")
  def add_Table(range: String, bindingType: typingsJapgolly.officeJs.officeJsStrings.Table, id: String): Binding = js.native
  @JSName("add")
  def add_Table(range: Range, bindingType: typingsJapgolly.officeJs.officeJsStrings.Table, id: String): Binding = js.native
  @JSName("add")
