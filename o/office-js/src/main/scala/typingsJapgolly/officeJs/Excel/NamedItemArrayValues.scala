...
import typingsJapgolly.officeJs.Excel.Interfaces.NamedItemArrayValuesData
import typingsJapgolly.officeJs.Excel.Interfaces.NamedItemArrayValuesLoadOptions
