...
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalRangeBorderCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalRangeBorderCollectionLoadOptions
