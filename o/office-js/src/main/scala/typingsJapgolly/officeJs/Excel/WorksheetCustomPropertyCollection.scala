...
import typingsJapgolly.officeJs.Excel.Interfaces.WorksheetCustomPropertyCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.WorksheetCustomPropertyCollectionLoadOptions
