...
import typingsJapgolly.officeJs.Excel.Interfaces.CellValueConditionalFormatData
import typingsJapgolly.officeJs.Excel.Interfaces.CellValueConditionalFormatLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.CellValueConditionalFormatUpdateData
...
/**
  ...
  */
@js.native
trait CellValueConditionalFormat
  extends StObject
     with ClientObject {
