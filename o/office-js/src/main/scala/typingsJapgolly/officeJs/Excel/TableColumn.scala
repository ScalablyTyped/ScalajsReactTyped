...
import typingsJapgolly.officeJs.Excel.Interfaces.TableColumnData
import typingsJapgolly.officeJs.Excel.Interfaces.TableColumnLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.TableColumnUpdateData
