...
import typingsJapgolly.officeJs.Excel.Interfaces.ChartTrendlineLabelFormatData
import typingsJapgolly.officeJs.Excel.Interfaces.ChartTrendlineLabelFormatLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.ChartTrendlineLabelFormatUpdateData
...
/**
  ...
  */
@js.native
trait ChartTrendlineLabelFormat
  extends StObject
     with ClientObject {
