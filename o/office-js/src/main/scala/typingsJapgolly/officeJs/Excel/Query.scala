...
import typingsJapgolly.officeJs.Excel.Interfaces.QueryData
import typingsJapgolly.officeJs.Excel.Interfaces.QueryLoadOptions
...
trait Query
  ...
  /**
    ...
    * [Api set: ExcelApi 1.14]
    */
  val loadedTo: LoadToType | ConnectionOnly | typingsJapgolly.officeJs.officeJsStrings.Table | typingsJapgolly.officeJs.officeJsStrings.PivotTable | PivotChart = js.native
