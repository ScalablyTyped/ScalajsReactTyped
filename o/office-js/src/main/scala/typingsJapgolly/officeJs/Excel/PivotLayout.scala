...
import typingsJapgolly.officeJs.Excel.Interfaces.PivotLayoutData
import typingsJapgolly.officeJs.Excel.Interfaces.PivotLayoutLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.PivotLayoutUpdateData
...
import typingsJapgolly.officeJs.officeJsStrings.Column
import typingsJapgolly.officeJs.officeJsStrings.Compact
import typingsJapgolly.officeJs.officeJsStrings.Data
...
import typingsJapgolly.officeJs.officeJsStrings.Row
...
class PivotLayout () extends ClientObject {
  ...
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typingsJapgolly.officeJs.officeJsStrings.Filter, cell: String): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typingsJapgolly.officeJs.officeJsStrings.Filter, cell: Range): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
