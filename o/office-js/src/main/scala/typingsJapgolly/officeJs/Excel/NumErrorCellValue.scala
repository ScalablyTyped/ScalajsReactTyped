...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.num
import typingsJapgolly.officeJs.Excel.RangeValueType.error
import typingsJapgolly.officeJs.officeJsStrings.ArrayTooLarge
import typingsJapgolly.officeJs.officeJsStrings.Error
import typingsJapgolly.officeJs.officeJsStrings.Num
import typingsJapgolly.officeJs.officeJsStrings.NumbersignNUMExclamationmark
...
object NumErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error): NumErrorCellValue = {
