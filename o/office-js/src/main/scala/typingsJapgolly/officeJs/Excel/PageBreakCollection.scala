...
import typingsJapgolly.officeJs.Excel.Interfaces.PageBreakCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.PageBreakCollectionLoadOptions
