...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.`null`
import typingsJapgolly.officeJs.Excel.RangeValueType.error
import typingsJapgolly.officeJs.officeJsStrings.Error
import typingsJapgolly.officeJs.officeJsStrings.Null
import typingsJapgolly.officeJs.officeJsStrings.NumbersignNULLExclamationmark
...
object NullErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error): NullErrorCellValue = {
