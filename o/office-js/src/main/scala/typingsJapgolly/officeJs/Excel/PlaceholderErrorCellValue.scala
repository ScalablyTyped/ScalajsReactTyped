...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.placeholder
...
import typingsJapgolly.officeJs.officeJsStrings.Placeholder
...
object PlaceholderErrorCellValue {
  ...
  inline def apply(
    ...
    `type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error
