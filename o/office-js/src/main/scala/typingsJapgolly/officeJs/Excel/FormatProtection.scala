...
import typingsJapgolly.officeJs.Excel.Interfaces.FormatProtectionData
import typingsJapgolly.officeJs.Excel.Interfaces.FormatProtectionLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.FormatProtectionUpdateData
