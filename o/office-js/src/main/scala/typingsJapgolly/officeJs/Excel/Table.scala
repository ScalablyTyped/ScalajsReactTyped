...
import typingsJapgolly.officeJs.Excel.Interfaces.TableData
import typingsJapgolly.officeJs.Excel.Interfaces.TableLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.TableUpdateData
