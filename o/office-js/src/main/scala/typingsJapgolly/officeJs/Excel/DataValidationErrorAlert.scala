...
import typingsJapgolly.officeJs.officeJsStrings.Information
import typingsJapgolly.officeJs.officeJsStrings.Stop
import typingsJapgolly.officeJs.officeJsStrings.Warning
