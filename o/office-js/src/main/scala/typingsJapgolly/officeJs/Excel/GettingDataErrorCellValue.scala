...
import typingsJapgolly.officeJs.Excel.ErrorCellValueType.gettingData
import typingsJapgolly.officeJs.Excel.RangeValueType.error
import typingsJapgolly.officeJs.officeJsStrings.Error
import typingsJapgolly.officeJs.officeJsStrings.GettingData
import typingsJapgolly.officeJs.officeJsStrings.NumbersignGETTING_DATA
...
object GettingDataErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJs.Excel.CellValueType.error | Error): GettingDataErrorCellValue = {
