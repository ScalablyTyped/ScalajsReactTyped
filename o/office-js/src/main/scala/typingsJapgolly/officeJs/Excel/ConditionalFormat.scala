...
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalFormatData
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalFormatLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalFormatUpdateData
...
trait ConditionalFormat
  ...
  /**
    ...
    * [Api set: ExcelApi 1.6]
    */
  val `type`: ConditionalFormatType | Custom | DataBar | ColorScale | typingsJapgolly.officeJs.officeJsStrings.IconSet | TopBottom | PresetCriteria | ContainsText | typingsJapgolly.officeJs.officeJsStrings.CellValue = js.native
}
