...
import typingsJapgolly.officeJs.Excel.Interfaces.CustomPropertyData
import typingsJapgolly.officeJs.Excel.Interfaces.CustomPropertyLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.CustomPropertyUpdateData
...
class CustomProperty () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  val `type`: DocumentPropertyType | Number | Boolean | Date | typingsJapgolly.officeJs.officeJsStrings.String | Float = js.native
  /**
    *
