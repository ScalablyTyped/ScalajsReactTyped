...
import typingsJapgolly.officeJs.Excel.Interfaces.SettingData
import typingsJapgolly.officeJs.Excel.Interfaces.SettingLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.SettingUpdateData
