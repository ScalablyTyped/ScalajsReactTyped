...
import typingsJapgolly.officeJs.Excel.Interfaces.RowColumnPivotHierarchyCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.RowColumnPivotHierarchyCollectionLoadOptions
