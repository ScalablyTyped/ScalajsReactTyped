...
import typingsJapgolly.officeJs.Excel.Interfaces.GroupShapeCollectionData
import typingsJapgolly.officeJs.Excel.Interfaces.GroupShapeCollectionLoadOptions
