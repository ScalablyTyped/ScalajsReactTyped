...
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalRangeFormatData
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalRangeFormatLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.ConditionalRangeFormatUpdateData
