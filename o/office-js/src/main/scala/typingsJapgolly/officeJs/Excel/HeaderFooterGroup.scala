...
import typingsJapgolly.officeJs.Excel.Interfaces.HeaderFooterGroupData
import typingsJapgolly.officeJs.Excel.Interfaces.HeaderFooterGroupLoadOptions
import typingsJapgolly.officeJs.Excel.Interfaces.HeaderFooterGroupUpdateData
