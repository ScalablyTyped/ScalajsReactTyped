...
import typingsJapgolly.officeJs.PowerPoint.Interfaces.ParagraphFormatData
import typingsJapgolly.officeJs.PowerPoint.Interfaces.ParagraphFormatLoadOptions
