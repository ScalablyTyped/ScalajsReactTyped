...
import typingsJapgolly.officeJs.PowerPoint.Interfaces.ShapeLineFormatData
import typingsJapgolly.officeJs.PowerPoint.Interfaces.ShapeLineFormatLoadOptions
