...
import typingsJapgolly.officeJs.PowerPoint.Interfaces.CollectionLoadOptions
import typingsJapgolly.officeJs.PowerPoint.Interfaces.SlideLayoutCollectionData
import typingsJapgolly.officeJs.PowerPoint.Interfaces.SlideLayoutCollectionLoadOptions
