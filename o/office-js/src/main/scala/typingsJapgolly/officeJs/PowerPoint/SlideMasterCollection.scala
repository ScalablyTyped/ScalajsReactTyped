...
import typingsJapgolly.officeJs.PowerPoint.Interfaces.SlideMasterCollectionData
import typingsJapgolly.officeJs.PowerPoint.Interfaces.SlideMasterCollectionLoadOptions
