...
import typingsJapgolly.officeJs.PowerPoint.Interfaces.SlideCollectionData
import typingsJapgolly.officeJs.PowerPoint.Interfaces.SlideCollectionLoadOptions
