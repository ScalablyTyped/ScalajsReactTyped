...
import typingsJapgolly.officeJs.PowerPoint.Interfaces.ShapeCollectionData
import typingsJapgolly.officeJs.PowerPoint.Interfaces.ShapeCollectionLoadOptions
...
trait ShapeCollection
  ...
  def addGeometricShape(
    geometricShapeType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typingsJapgolly.officeJs.officeJsStrings.LineInverse, typingsJapgolly.officeJs.officeJsStrings.Triangle, typingsJapgolly.officeJs.officeJsStrings.RightTriangle */ Any
  ): Shape = js.native
  def addGeometricShape(
    geometricShapeType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typingsJapgolly.officeJs.officeJsStrings.LineInverse, typingsJapgolly.officeJs.officeJsStrings.Triangle, typingsJapgolly.officeJs.officeJsStrings.RightTriangle */ Any,
