...
object Application {
  ...
  inline def apply(context: RequestContext, isNullObject: Boolean, toJSON: CallbackTo[StringDictionary[String]]): Application = {
    val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], isNullObject = isNullObject.asInstanceOf[js.Any], toJSON = toJSON.toJsFn)
