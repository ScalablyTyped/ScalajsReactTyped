...
import typingsJapgolly.officeJs.PowerPoint.Interfaces.ShapeFillData
import typingsJapgolly.officeJs.PowerPoint.Interfaces.ShapeFillLoadOptions
...
import typingsJapgolly.officeJs.officeJsStrings.SlideBackground
