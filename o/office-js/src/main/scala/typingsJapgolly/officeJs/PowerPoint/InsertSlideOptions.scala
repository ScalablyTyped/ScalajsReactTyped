...
import typingsJapgolly.officeJs.officeJsStrings.KeepSourceFormatting
import typingsJapgolly.officeJs.officeJsStrings.UseDestinationTheme
...
object InsertSlideOptions {
  ...
  extension [Self <: InsertSlideOptions](x: Self) {
    ...
    inline def setSourceSlideIdsVarargs(value: String*): Self = StObject.set(x, "sourceSlideIds", js.Array(value*))
