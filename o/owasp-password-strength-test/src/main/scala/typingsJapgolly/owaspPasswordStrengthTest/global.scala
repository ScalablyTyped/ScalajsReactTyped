...
import typingsJapgolly.owaspPasswordStrengthTest.anon.PartialTestConfig
import typingsJapgolly.owaspPasswordStrengthTest.mod.PasswordTest
import typingsJapgolly.owaspPasswordStrengthTest.mod.TestResult
