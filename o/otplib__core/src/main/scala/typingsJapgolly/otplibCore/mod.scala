package typingsJapgolly.otplibCore
...
import typingsJapgolly.otplibCore.otplibCoreStrings.createRandomBytes
import typingsJapgolly.otplibCore.otplibCoreStrings.encoding
import typingsJapgolly.otplibCore.otplibCoreStrings.keyDecoder
import typingsJapgolly.otplibCore.otplibCoreStrings.keyEncoder
...
object mod {
  ...
  open class Authenticator[T /* <: AuthenticatorOptions_[String] */] ()
    extends typingsJapgolly.otplibCore.authenticatorMod.Authenticator[T] {
  ...
  open class HOTP[T /* <: HOTPOptions_[String] */] ()
    extends typingsJapgolly.otplibCore.hotpMod.HOTP[T] {
    def this(defaultOptions: Partial[T]) = this()
  }
  ...
  open class OTP[T /* <: OTPOptions */] ()
    extends typingsJapgolly.otplibCore.utilsMod.OTP[T] {
    def this(defaultOptions: Partial[T]) = this()
  }
  ...
  open class TOTP[T /* <: TOTPOptions_[String] */] ()
    extends typingsJapgolly.otplibCore.totpMod.TOTP[T] {
    def this(defaultOptions: Partial[T]) = this()
  }
