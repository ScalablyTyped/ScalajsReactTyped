package typingsJapgolly.onChange

import typingsJapgolly.onChange.mod.ApplyData
import typingsJapgolly.onChange.onChangeBooleans.`false`
import typingsJapgolly.onChange.onChangeBooleans.`true`
