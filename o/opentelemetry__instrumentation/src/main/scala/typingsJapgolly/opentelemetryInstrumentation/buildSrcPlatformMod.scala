...
import typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformNodeTypesMod.InstrumentationModuleFile
...
object buildSrcPlatformMod {
  ...
  open class InstrumentationBase[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformNodeMod.InstrumentationBase[T] {
  ...
  open class InstrumentationNodeModuleDefinition[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformNodeMod.InstrumentationNodeModuleDefinition[T] {
  ...
  open class InstrumentationNodeModuleFile[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformNodeMod.InstrumentationNodeModuleFile[T] {
    def this(
      name: String,
      supportedVersions: js.Array[String],
