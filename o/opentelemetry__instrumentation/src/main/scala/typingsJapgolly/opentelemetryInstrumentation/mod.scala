...
object mod {
  ...
  open class InstrumentationBase[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformMod.InstrumentationBase[T] {
  ...
  open class InstrumentationNodeModuleDefinition[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformMod.InstrumentationNodeModuleDefinition[T] {
  ...
  open class InstrumentationNodeModuleFile[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformMod.InstrumentationNodeModuleFile[T] {
    def this(
      name: String,
      supportedVersions: js.Array[String],
