...
object buildSrcPlatformNodeMod {
  ...
  open class InstrumentationBase[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformNodeInstrumentationMod.InstrumentationBase[T] {
  ...
  open class InstrumentationNodeModuleDefinition[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformNodeInstrumentationNodeModuleDefinitionMod.InstrumentationNodeModuleDefinition[T] {
  ...
  open class InstrumentationNodeModuleFile[T] protected ()
    extends typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformNodeInstrumentationNodeModuleFileMod.InstrumentationNodeModuleFile[T] {
    def this(
      name: String,
      supportedVersions: js.Array[String],
