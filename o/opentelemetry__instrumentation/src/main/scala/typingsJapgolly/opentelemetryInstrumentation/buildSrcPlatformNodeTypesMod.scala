...
object buildSrcPlatformNodeTypesMod {
  ...
  object InstrumentationModuleDefinition {
    ...
    extension [Self <: InstrumentationModuleDefinition[?], T](x: Self & InstrumentationModuleDefinition[T]) {
      ...
      inline def setUnpatch(value: (/* moduleExports */ T, /* moduleVersion */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "unpatch", js.Any.fromFunction2((t0: /* moduleExports */ T, t1: /* moduleVersion */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
