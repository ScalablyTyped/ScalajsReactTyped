...
import typingsJapgolly.opentelemetryInstrumentation.buildSrcPlatformNodeTypesMod.InstrumentationModuleDefinition
...
object buildSrcPlatformNodeInstrumentationNodeModuleDefinitionMod {
