...
object Options {
  ...
  def apply(
    ...
    normalizeQuery: /* graphQLResolveInfo */ js.Any => CallbackTo[String] = null,
    ...
    if (normalizeQuery != null) __obj.updateDynamic("normalizeQuery")(js.Any.fromFunction1((t0: /* graphQLResolveInfo */ js.Any) => normalizeQuery(t0).runNow()))
