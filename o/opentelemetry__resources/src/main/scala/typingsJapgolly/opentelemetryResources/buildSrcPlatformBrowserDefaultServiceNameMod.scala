...
object buildSrcPlatformBrowserDefaultServiceNameMod {
  
  @JSImport("@opentelemetry/resources/build/src/platform/browser/default-service-name", JSImport.Namespace)
  @js.native
