...
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcResourceSemanticResourceAttributesMod.AwsEcsLaunchtypeValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcResourceSemanticResourceAttributesMod.CloudPlatformValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcResourceSemanticResourceAttributesMod.CloudProviderValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcResourceSemanticResourceAttributesMod.HostArchValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcResourceSemanticResourceAttributesMod.OsTypeValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcResourceSemanticResourceAttributesMod.TelemetrySdkLanguageValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.DbCassandraConsistencyLevelValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.DbSystemValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.FaasDocumentOperationValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.FaasInvokedProviderValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.FaasTriggerValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.HttpFlavorValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.MessageTypeValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.MessagingDestinationKindValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.MessagingOperationValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.NetHostConnectionSubtypeValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.NetHostConnectionTypeValues
import typingsJapgolly.opentelemetrySemanticConventions.buildSrcTraceSemanticAttributesMod.NetTransportValues
