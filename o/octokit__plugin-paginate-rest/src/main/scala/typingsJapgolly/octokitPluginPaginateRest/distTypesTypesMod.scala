...
import typingsJapgolly.octokitPluginPaginateRest.anon.DataGetResultsType
...
object distTypesTypesMod {
  ...
  trait ComposePaginateInterface extends StObject {
    ...
    def iterator[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 185, starting with typingsJapgolly.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typingsJapgolly.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, / * GET /enterprises/{enterprise}/actions/permissions/organizations * / java.lang.String */ Any */](octokit: Octokit, route: R): AsyncIterableIterator[
        OctokitResponse[
          DataType[
            /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['response'] */ js.Any
          ], 
    ...
    @JSName("iterator")
    def iterator_parameters[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 185, starting with typingsJapgolly.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typingsJapgolly.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, / * GET /enterprises/{enterprise}/actions/permissions/organizations * / java.lang.String */ Any */](
      octokit: Octokit,
      route: R,
