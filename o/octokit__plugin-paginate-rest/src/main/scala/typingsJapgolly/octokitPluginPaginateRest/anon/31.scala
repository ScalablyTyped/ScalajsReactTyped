...
trait `31` extends StObject {
  ...
  var parameters: (ToOctokitParameters[
    /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/organizations/{org}/codespaces/secrets/{secret_name}/repositories']['get'] */ js.Any
  ]) & RequiredPreview[Any]
