...
import typingsJapgolly.octokitPluginPaginateRest.distTypesTypesMod.DataType
import typingsJapgolly.octokitPluginPaginateRest.distTypesTypesMod.MapFunction
import typingsJapgolly.octokitPluginPaginateRest.distTypesTypesMod.NormalizeResponse
import typingsJapgolly.octokitPluginPaginateRest.distTypesTypesMod.PaginateInterface
...
import typingsJapgolly.octokitTypes.distTypesGetResponseTypeFromEndpointMethodMod.GetResponseTypeFromEndpointMethod
...
trait Paginate extends StObject {
  ...
  @JSName("paginate")
  def paginate_parameters[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 185, starting with typingsJapgolly.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typingsJapgolly.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, / * GET /enterprises/{enterprise}/actions/permissions/organizations * / java.lang.String */ Any */](
    route: R,
    parameters: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['parameters'] */ js.Any
  ): js.Promise[
    DataType[
  ...
  /**
    ...
    */
  @JSName("paginate")
  def paginate_response[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 185, starting with typingsJapgolly.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashhookSlashdeliveries`, typingsJapgolly.octokitPluginPaginateRest.octokitPluginPaginateRestStrings.`GET SlashappSlashinstallations`, / * GET /enterprises/{enterprise}/actions/permissions/organizations * / java.lang.String */ Any */, M /* <: js.Array[Any] */](
    route: R,
    mapFn: MapFunction[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['response'] */ js.Any, 
      M
