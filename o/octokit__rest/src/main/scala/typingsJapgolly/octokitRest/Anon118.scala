...
import typingsJapgolly.octokitRest.mod.Octokit.GistsListPublicForUserParams
import typingsJapgolly.octokitRest.mod.Octokit.GistsListPublicForUserResponse
