...
import typingsJapgolly.octokitRest.mod.Octokit.UsersUpdateAuthenticatedParams
import typingsJapgolly.octokitRest.mod.Octokit.UsersUpdateAuthenticatedResponse
