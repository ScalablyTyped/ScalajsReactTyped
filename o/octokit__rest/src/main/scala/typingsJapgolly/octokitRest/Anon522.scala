...
import typingsJapgolly.octokitRest.mod.Octokit.TeamsCreateDiscussionLegacyParams
import typingsJapgolly.octokitRest.mod.Octokit.TeamsCreateDiscussionLegacyResponse
