...
trait AppsListAccountsUserOrOrgOnPlanParams extends js.Object {
  /**
...
object AppsListAccountsUserOrOrgOnPlanParams {
  @scala.inline
  def apply(
    plan_id: Double,
    ...
    __obj.asInstanceOf[AppsListAccountsUserOrOrgOnPlanParams]
  }
}
