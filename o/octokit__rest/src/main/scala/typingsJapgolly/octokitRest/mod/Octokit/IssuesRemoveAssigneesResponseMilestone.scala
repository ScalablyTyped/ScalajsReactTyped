...
trait IssuesRemoveAssigneesResponseMilestone extends js.Object {
  var closed_at: String
  var closed_issues: Double
  var created_at: String
  var creator: IssuesRemoveAssigneesResponseMilestoneCreator
...
object IssuesRemoveAssigneesResponseMilestone {
  @scala.inline
  def apply(
    closed_at: String,
    ...
    __obj.asInstanceOf[IssuesRemoveAssigneesResponseMilestone]
  }
}
