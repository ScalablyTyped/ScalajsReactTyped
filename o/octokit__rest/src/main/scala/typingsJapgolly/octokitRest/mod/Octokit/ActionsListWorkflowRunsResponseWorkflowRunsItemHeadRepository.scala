...
trait ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository extends js.Object {
  ...
  var owner: ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepositoryOwner
  var `private`: Boolean
...
object ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository {
  @scala.inline
  def apply(
    archive_url: String,
    ...
    __obj.asInstanceOf[ActionsListWorkflowRunsResponseWorkflowRunsItemHeadRepository]
  }
}
