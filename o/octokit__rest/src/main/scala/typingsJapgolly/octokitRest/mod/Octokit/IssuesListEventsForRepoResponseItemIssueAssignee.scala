...
trait IssuesListEventsForRepoResponseItemIssueAssignee extends js.Object {
...
object IssuesListEventsForRepoResponseItemIssueAssignee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesListEventsForRepoResponseItemIssueAssignee]
  }
}
