...
import typingsJapgolly.octokitRest.octokitRestStrings.newest
import typingsJapgolly.octokitRest.octokitRestStrings.oldest
import typingsJapgolly.octokitRest.octokitRestStrings.stargazers
