...
trait PullsGetCommentsForReviewResponseItemUser extends js.Object {
...
object PullsGetCommentsForReviewResponseItemUser {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsGetCommentsForReviewResponseItemUser]
  }
}
