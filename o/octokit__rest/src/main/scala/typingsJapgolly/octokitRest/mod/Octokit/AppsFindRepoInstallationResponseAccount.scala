...
trait AppsFindRepoInstallationResponseAccount extends js.Object {
...
object AppsFindRepoInstallationResponseAccount {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsFindRepoInstallationResponseAccount]
  }
}
