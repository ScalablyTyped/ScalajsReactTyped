...
trait TeamsListChildResponseItem extends js.Object {
  var description: String
  var id: Double
  var members_url: String
  var name: String
  var node_id: String
  var parent: TeamsListChildResponseItemParent
...
object TeamsListChildResponseItem {
  @scala.inline
  def apply(
    description: String,
    id: Double,
    ...
    __obj.asInstanceOf[TeamsListChildResponseItem]
  }
}
