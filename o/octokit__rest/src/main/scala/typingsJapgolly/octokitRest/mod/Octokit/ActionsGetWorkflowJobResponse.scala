...
trait ActionsGetWorkflowJobResponse extends js.Object {
  ...
  var status: String
  var steps: js.Array[ActionsGetWorkflowJobResponseStepsItem]
  var url: String
}

object ActionsGetWorkflowJobResponse {
  @scala.inline
  def apply(
    ...
    started_at: String,
    status: String,
    steps: js.Array[ActionsGetWorkflowJobResponseStepsItem],
    url: String
    ...
    __obj.asInstanceOf[ActionsGetWorkflowJobResponse]
  }
}
