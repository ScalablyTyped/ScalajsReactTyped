...
import typingsJapgolly.octokitRest.octokitRestStrings.LEFT
import typingsJapgolly.octokitRest.octokitRestStrings.RIGHT
import typingsJapgolly.octokitRest.octokitRestStrings.side
