...
trait IssuesRemoveAssigneesResponseMilestoneCreator extends js.Object {
...
object IssuesRemoveAssigneesResponseMilestoneCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesRemoveAssigneesResponseMilestoneCreator]
  }
}
