...
trait TeamsCheckManagesRepoInOrgResponseOwner extends js.Object {
...
object TeamsCheckManagesRepoInOrgResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoInOrgResponseOwner]
  }
}
