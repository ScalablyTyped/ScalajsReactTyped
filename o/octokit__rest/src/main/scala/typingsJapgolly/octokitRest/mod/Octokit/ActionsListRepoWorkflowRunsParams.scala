...
import typingsJapgolly.octokitRest.octokitRestStrings.conclusion
import typingsJapgolly.octokitRest.octokitRestStrings.status
...
trait ActionsListRepoWorkflowRunsParams extends js.Object {
  ...
  /**
    ...
    */
  var status: js.UndefOr[completed | typingsJapgolly.octokitRest.octokitRestStrings.status | conclusion] = js.undefined
}
