...
trait TeamsListProjectsInOrgResponseItemCreator extends js.Object {
...
object TeamsListProjectsInOrgResponseItemCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListProjectsInOrgResponseItemCreator]
  }
}
