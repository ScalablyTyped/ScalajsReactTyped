...
import typingsJapgolly.octokitRest.octokitRestStrings.`off-topic`
import typingsJapgolly.octokitRest.octokitRestStrings.`too heated`
import typingsJapgolly.octokitRest.octokitRestStrings.resolved
import typingsJapgolly.octokitRest.octokitRestStrings.spam
