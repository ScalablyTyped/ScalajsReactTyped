...
import typingsJapgolly.octokitRest.octokitRestStrings.APPROVE
import typingsJapgolly.octokitRest.octokitRestStrings.COMMENT
import typingsJapgolly.octokitRest.octokitRestStrings.REQUEST_CHANGES
