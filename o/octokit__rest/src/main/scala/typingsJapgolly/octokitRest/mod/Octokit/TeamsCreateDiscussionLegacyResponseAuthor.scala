...
trait TeamsCreateDiscussionLegacyResponseAuthor extends js.Object {
...
object TeamsCreateDiscussionLegacyResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionLegacyResponseAuthor]
  }
}
