...
import typingsJapgolly.octokitRest.octokitRestStrings.merge
import typingsJapgolly.octokitRest.octokitRestStrings.rebase
import typingsJapgolly.octokitRest.octokitRestStrings.squash
