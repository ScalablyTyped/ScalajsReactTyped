...
trait ReposListPullRequestsAssociatedWithCommitResponseItemLabelsItem extends js.Object {
  var color: String
  var default: Boolean
...
object ReposListPullRequestsAssociatedWithCommitResponseItemLabelsItem {
  @scala.inline
  def apply(
    color: String,
    default: Boolean,
    ...
    __obj.asInstanceOf[ReposListPullRequestsAssociatedWithCommitResponseItemLabelsItem]
  }
}
