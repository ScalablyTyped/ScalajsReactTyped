...
trait TeamsCreateDiscussionLegacyResponse extends js.Object {
  var author: TeamsCreateDiscussionLegacyResponseAuthor
  var body: String
  ...
  var pinned: Boolean
  var `private`: Boolean
  var reactions: TeamsCreateDiscussionLegacyResponseReactions
  var team_url: String
  var title: String
...
object TeamsCreateDiscussionLegacyResponse {
  @scala.inline
  def apply(
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionLegacyResponse]
  }
}
