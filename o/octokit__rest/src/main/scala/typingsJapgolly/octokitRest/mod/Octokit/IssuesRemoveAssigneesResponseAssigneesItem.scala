...
trait IssuesRemoveAssigneesResponseAssigneesItem extends js.Object {
...
object IssuesRemoveAssigneesResponseAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesRemoveAssigneesResponseAssigneesItem]
  }
}
