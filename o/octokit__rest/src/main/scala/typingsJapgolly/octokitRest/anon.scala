...
import typingsJapgolly.octokitCore.anon.Plugins
import typingsJapgolly.octokitCore.distTypesTypesMod.Constructor
import typingsJapgolly.octokitCore.distTypesTypesMod.OctokitOptions
import typingsJapgolly.octokitCore.distTypesTypesMod.OctokitPlugin
import typingsJapgolly.octokitCore.distTypesTypesMod.ReturnTypeOf
import typingsJapgolly.octokitCore.distTypesTypesMod.UnionToIntersection
...
object anon {
  ...
  trait paginatePaginateInterface extends StObject {
    ...
    /**
      ...
      * @param {object} parameters? URL, query or body parameters, as well as `headers`, `mediaType.{format|previews}`, `request`, or `baseUrl`.
      */
    def paginate[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 185, starting with typingsJapgolly.octokitRest.octokitRestStrings.`GET SlashappSlashhookSlashdeliveries`, typingsJapgolly.octokitRest.octokitRestStrings.`GET SlashappSlashinstallations`, / * GET /enterprises/{enterprise}/actions/permissions/organizations * / java.lang.String */ Any */](route: R): js.Promise[
        DataType[
    ...
    @JSName("paginate")
    def paginate_parameters[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 185, starting with typingsJapgolly.octokitRest.octokitRestStrings.`GET SlashappSlashhookSlashdeliveries`, typingsJapgolly.octokitRest.octokitRestStrings.`GET SlashappSlashinstallations`, / * GET /enterprises/{enterprise}/actions/permissions/organizations * / java.lang.String */ Any */](
      route: R,
      parameters: /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['parameters'] */ js.Any
    ): js.Promise[
        DataType[
    ...
    /**
      ...
      */
    @JSName("paginate")
    def paginate_response[R /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 185, starting with typingsJapgolly.octokitRest.octokitRestStrings.`GET SlashappSlashhookSlashdeliveries`, typingsJapgolly.octokitRest.octokitRestStrings.`GET SlashappSlashinstallations`, / * GET /enterprises/{enterprise}/actions/permissions/organizations * / java.lang.String */ Any */, M /* <: js.Array[Any] */](
      route: R,
      mapFn: MapFunction[
          /* import warning: importer.ImportType#apply Failed type conversion: @octokit/plugin-paginate-rest.@octokit/plugin-paginate-rest/dist-types/generated/paginating-endpoints.PaginatingEndpoints[R]['response'] */ js.Any, 
          M
