...
import typingsJapgolly.octokitRest.mod.Octokit.TeamsListDiscussionCommentsInOrgParams
import typingsJapgolly.octokitRest.mod.Octokit.TeamsListDiscussionCommentsInOrgResponse
