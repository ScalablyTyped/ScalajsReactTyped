...
import typingsJapgolly.octokitRest.mod.Octokit.TeamsCreateDiscussionCommentLegacyParams
import typingsJapgolly.octokitRest.mod.Octokit.TeamsCreateDiscussionCommentLegacyResponse
