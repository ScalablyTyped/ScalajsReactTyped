...
import typingsJapgolly.octokitRest.mod.Octokit.TeamsUpdateDiscussionCommentParams
import typingsJapgolly.octokitRest.mod.Octokit.TeamsUpdateDiscussionCommentResponse
