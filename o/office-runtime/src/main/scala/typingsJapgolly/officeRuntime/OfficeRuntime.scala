package typingsJapgolly.officeRuntime
...
object OfficeRuntime {
  ...
  object Dialog {
    ...
    inline def apply(close: CallbackTo[js.Promise[Unit]]): Dialog = {
  ...
  object DisplayWebDialogOptions {
    ...
    extension [Self <: DisplayWebDialogOptions](x: Self) {
      ...
      inline def setOnMessage(value: (/* message */ String, /* dialog */ js.UndefOr[Dialog]) => Callback): Self = StObject.set(x, "onMessage", js.Any.fromFunction2((t0: /* message */ String, t1: /* dialog */ js.UndefOr[Dialog]) => (value(t0, t1)).runNow()))
      
      inline def setOnMessageUndefined: Self = StObject.set(x, "onMessage", js.undefined)
      
      inline def setOnRuntimeError(value: (/* error */ js.Error, /* dialog */ js.UndefOr[Dialog]) => Callback): Self = StObject.set(x, "onRuntimeError", js.Any.fromFunction2((t0: /* error */ js.Error, t1: /* dialog */ js.UndefOr[Dialog]) => (value(t0, t1)).runNow()))
  ...
  object Storage {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getItem = js.Any.fromFunction1(getItem), getItems = js.Any.fromFunction1(getItems), getKeys = getKeys.toJsFn, removeItem = js.Any.fromFunction1(removeItem), removeItems = js.Any.fromFunction1(removeItems), setItem = js.Any.fromFunction2(setItem), setItems = js.Any.fromFunction1(setItems))
    ...
    extension [Self <: Storage](x: Self) {
      ...
      inline def setGetKeys(value: CallbackTo[js.Promise[js.Array[String]]]): Self = StObject.set(x, "getKeys", value.toJsFn)
