...
object createWorkerMod {
  ...
  inline def apply(canvas: HTMLCanvasElement, workerUrl: String, listener: js.Function1[/* ev */ MessageEvent, Any]): WorkerInterface = (^.asInstanceOf[js.Dynamic].apply(canvas.asInstanceOf[js.Any], workerUrl.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[WorkerInterface]
