...
object insideWorkerMod {
  ...
  inline def apply(listener: js.Function1[/* ev */ MessageEvent, Any]): WorkerInterface = ^.asInstanceOf[js.Dynamic].apply(listener.asInstanceOf[js.Any]).asInstanceOf[WorkerInterface]
