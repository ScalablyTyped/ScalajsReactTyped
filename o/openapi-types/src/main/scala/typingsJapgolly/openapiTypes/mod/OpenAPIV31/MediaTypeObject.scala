...
trait MediaTypeObject extends StObject {
  ...
  var encoding: js.UndefOr[StringDictionary[typingsJapgolly.openapiTypes.mod.OpenAPIV3.EncodingObject]] = js.undefined
...
object MediaTypeObject {
  ...
  extension [Self <: MediaTypeObject](x: Self) {
    ...
    inline def setEncoding(value: StringDictionary[typingsJapgolly.openapiTypes.mod.OpenAPIV3.EncodingObject]): Self = StObject.set(x, "encoding", value.asInstanceOf[js.Any])
