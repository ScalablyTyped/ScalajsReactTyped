...
/* Inlined openapi-types.openapi-types.OpenAPIV3_1.Modify<openapi-types.openapi-types.OpenAPIV3.InfoObject, {  summary :string | undefined,   license :openapi-types.openapi-types.OpenAPIV3_1.LicenseObject | undefined}> */
trait InfoObject extends StObject {
  
  var contact: js.UndefOr[typingsJapgolly.openapiTypes.mod.OpenAPIV3.ContactObject] = js.undefined
...
object InfoObject {
  ...
  extension [Self <: InfoObject](x: Self) {
    ...
    inline def setContact(value: typingsJapgolly.openapiTypes.mod.OpenAPIV3.ContactObject): Self = StObject.set(x, "contact", value.asInstanceOf[js.Any])
