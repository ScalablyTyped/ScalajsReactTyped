...
import typingsJapgolly.openapiTypes.mod.OpenAPIV2.OperationObject
...
object OpenAPI {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.openapiTypes.mod.OpenAPIV2.Document[T]
    - typingsJapgolly.openapiTypes.mod.OpenAPIV3.Document[T]
    - typingsJapgolly.openapiTypes.mod.OpenAPIV31.Document[T]
  */
  type Document[T /* <: js.Object */] = _Document[T] | typingsJapgolly.openapiTypes.mod.OpenAPIV31.Document[T]
  
  type Operation[T /* <: js.Object */] = OperationObject[T] | typingsJapgolly.openapiTypes.mod.OpenAPIV3.OperationObject[T] | typingsJapgolly.openapiTypes.mod.OpenAPIV31.OperationObject[T]
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.openapiTypes.mod.OpenAPIV31.ReferenceObject
    - typingsJapgolly.openapiTypes.mod.OpenAPIV31.ParameterObject
    - typingsJapgolly.openapiTypes.mod.OpenAPIV3.ReferenceObject
    - typingsJapgolly.openapiTypes.mod.OpenAPIV3.ParameterObject
    - typingsJapgolly.openapiTypes.mod.OpenAPIV2.ReferenceObject
    - typingsJapgolly.openapiTypes.mod.OpenAPIV2.Parameter
  */
  type Parameter = _Parameter | ParameterObject
  
  type Parameters = js.Array[
    typingsJapgolly.openapiTypes.mod.OpenAPIV2.Parameter | ParameterObject | typingsJapgolly.openapiTypes.mod.OpenAPIV3.ParameterObject | ReferenceObject | typingsJapgolly.openapiTypes.mod.OpenAPIV3.ReferenceObject | typingsJapgolly.openapiTypes.mod.OpenAPIV2.ReferenceObject
  ]
  ...
  object _Parameter {
    ...
    inline def ParameterObject(in: String, name: String): typingsJapgolly.openapiTypes.mod.OpenAPIV3.ParameterObject = {
      val __obj = js.Dynamic.literal(in = in.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.openapiTypes.mod.OpenAPIV3.ParameterObject]
    }
    
    inline def ReferenceObject($ref: String): typingsJapgolly.openapiTypes.mod.OpenAPIV2.ReferenceObject = {
      val __obj = js.Dynamic.literal($ref = $ref.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.openapiTypes.mod.OpenAPIV2.ReferenceObject]
    }
  }
}
