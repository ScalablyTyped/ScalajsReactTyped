...
import typingsJapgolly.onscanJs.anon.Key
...
object mod extends Shortcut {
  ...
  type ScanErrorEvent = CustomEvent
  ...
  object ScanOptions {
    ...
    extension [Self <: ScanOptions](x: Self) {
      ...
      inline def setOnKeyProcess(value: (/* char */ String, /* event */ KeyboardEvent) => Callback): Self = StObject.set(x, "onKeyProcess", js.Any.fromFunction2((t0: /* char */ String, t1: /* event */ KeyboardEvent) => (value(t0, t1)).runNow()))
      
      inline def setOnKeyProcessUndefined: Self = StObject.set(x, "onKeyProcess", js.undefined)
      
      inline def setOnPaste(value: (/* pasted */ String, /* event */ Event) => Callback): Self = StObject.set(x, "onPaste", js.Any.fromFunction2((t0: /* pasted */ String, t1: /* event */ Event) => (value(t0, t1)).runNow()))
      
      inline def setOnPasteUndefined: Self = StObject.set(x, "onPaste", js.undefined)
      
      inline def setOnScan(value: (/* scanned */ String, /* qty */ Double) => Callback): Self = StObject.set(x, "onScan", js.Any.fromFunction2((t0: /* scanned */ String, t1: /* qty */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnScanButtonLongPress(value: Callback): Self = StObject.set(x, "onScanButtonLongPress", value.toJsFn)
      
      inline def setOnScanButtonLongPressUndefined: Self = StObject.set(x, "onScanButtonLongPress", js.undefined)
      
      inline def setOnScanError(value: /* debug */ Any => Callback): Self = StObject.set(x, "onScanError", js.Any.fromFunction1((t0: /* debug */ Any) => value(t0).runNow()))
  ...
  object global {
    ...
    trait DocumentEventMap extends StObject {
      ...
      var scan: CustomEvent
      
      var scanError: CustomEvent
    }
    object DocumentEventMap {
      
      inline def apply(scan: CustomEvent, scanError: CustomEvent): DocumentEventMap = {
      ...
      extension [Self <: DocumentEventMap](x: Self) {
        ...
        inline def setScan(value: CustomEvent): Self = StObject.set(x, "scan", value.asInstanceOf[js.Any])
        
        inline def setScanError(value: CustomEvent): Self = StObject.set(x, "scanError", value.asInstanceOf[js.Any])
      }
    }
  }
}
