package typingsJapgolly.owlCarousel.OwlCarousel
...
object Options {
  ...
  def apply(
    ...
    dotsData: js.UndefOr[Boolean] = js.undefined,
    ...
    onDrag: /* repeated */ js.Any => Callback = null,
    ...
    onRefresh: /* repeated */ js.Any => Callback = null,
    onRefreshed: /* repeated */ js.Any => Callback = null,
    onResize: /* repeated */ js.Any => Callback = null,
    onResized: /* repeated */ js.Any => Callback = null,
    onStopVideo: /* repeated */ js.Any => Callback = null,
    onTranslate: /* repeated */ js.Any => Callback = null,
    onTranslated: /* repeated */ js.Any => Callback = null,
    ...
    if (onDrag != null) __obj.updateDynamic("onDrag")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onDrag(t0).runNow()))
    ...
    if (onRefresh != null) __obj.updateDynamic("onRefresh")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onRefresh(t0).runNow()))
    if (onRefreshed != null) __obj.updateDynamic("onRefreshed")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onRefreshed(t0).runNow()))
    if (onResize != null) __obj.updateDynamic("onResize")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onResize(t0).runNow()))
    if (onResized != null) __obj.updateDynamic("onResized")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onResized(t0).runNow()))
    if (onStopVideo != null) __obj.updateDynamic("onStopVideo")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onStopVideo(t0).runNow()))
    if (onTranslate != null) __obj.updateDynamic("onTranslate")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onTranslate(t0).runNow()))
    if (onTranslated != null) __obj.updateDynamic("onTranslated")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onTranslated(t0).runNow()))
