package typingsJapgolly.officeUiFabricReact.documentCardLogoTypesMod

import typingsJapgolly.officeUiFabricReact.documentCardLogoBaseMod.DocumentCardLogoBase
