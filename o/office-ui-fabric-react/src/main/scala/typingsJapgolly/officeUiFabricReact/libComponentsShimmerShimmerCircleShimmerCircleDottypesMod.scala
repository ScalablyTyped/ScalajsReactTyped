...
object libComponentsShimmerShimmerCircleShimmerCircleDottypesMod {
  ...
  object IShimmerCircleProps {
    ...
    extension [Self <: IShimmerCircleProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IShimmerCircle | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmerCircle | Null) => value(t0).runNow()))
