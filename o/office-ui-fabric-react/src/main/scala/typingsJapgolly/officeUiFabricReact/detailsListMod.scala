...
object detailsListMod extends js.Object {
  ...
  class DetailsColumnBase protected ()
    extends typingsJapgolly.officeUiFabricReact.detailsColumnBaseMod.DetailsColumnBase {
    def this(props: IDetailsColumnProps) = this()
  }
  
  @js.native
  class DetailsHeaderBase protected ()
    extends typingsJapgolly.officeUiFabricReact.detailsHeaderBaseMod.DetailsHeaderBase {
    def this(props: IDetailsHeaderBaseProps) = this()
  }
  
  @js.native
  class DetailsListBase protected ()
    extends typingsJapgolly.officeUiFabricReact.detailsListBaseMod.DetailsListBase {
    def this(props: IDetailsListProps) = this()
  }
  
  @js.native
  class DetailsRowBase protected ()
    extends typingsJapgolly.officeUiFabricReact.detailsRowBaseMod.DetailsRowBase {
