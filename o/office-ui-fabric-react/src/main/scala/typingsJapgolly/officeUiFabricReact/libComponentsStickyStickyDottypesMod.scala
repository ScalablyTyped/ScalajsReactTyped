...
object libComponentsStickyStickyDottypesMod {
  ...
  object IStickyProps {
    ...
    extension [Self <: IStickyProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IStickyProps | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IStickyProps | Null) => value(t0).runNow()))
