...
object libComponentsMessageBarMessageBarDottypesMod {
  ...
  trait IMessageBarProps
    ...
    var onDismiss: js.UndefOr[
        js.Function1[
          /* ev */ js.UndefOr[
            ReactMouseEventFrom[(HTMLElement | BaseButton | Button) & org.scalajs.dom.Element]
          ], 
          Any
        ]
      ] = js.undefined
  ...
  object IMessageBarProps {
    ...
    extension [Self <: IMessageBarProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IMessageBar | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IMessageBar | Null) => value(t0).runNow()))
