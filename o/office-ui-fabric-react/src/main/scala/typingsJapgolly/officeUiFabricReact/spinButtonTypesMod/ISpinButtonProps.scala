...
import typingsJapgolly.officeUiFabricReact.PartialISpinButtonStyles
...
import typingsJapgolly.officeUiFabricReact.positioningTypesMod.Position
import typingsJapgolly.officeUiFabricReact.spinButtonClassNamesMod.ISpinButtonClassNames
import typingsJapgolly.officeUiFabricReact.spinButtonSpinButtonMod.KeyboardSpinDirection
...
trait ISpinButtonProps extends HTMLAttributes[HTMLDivElement] {
  ...
  var onValidate: js.UndefOr[
    js.Function2[
      /* value */ String, 
      /* event */ js.UndefOr[ReactEventFrom[HTMLElement]], 
      String | Unit
    ]
  ] = js.undefined
  /**
...
object ISpinButtonProps {
  ...
  def apply(
    ...
    getClassNames: (/* theme */ ITheme, /* disabled */ Boolean, /* isFocused */ Boolean, /* keyboardSpinDirection */ KeyboardSpinDirection, /* labelPosition */ js.UndefOr[Position], /* className */ js.UndefOr[String]) => CallbackTo[ISpinButtonClassNames] = null,
    ...
    onChange: ReactEventFrom[org.scalajs.dom.raw.HTMLDivElement] => Callback = null,
    ...
    onDecrement: /* value */ String => CallbackTo[String | Unit] = null,
    ...
    onIncrement: /* value */ String => CallbackTo[String | Unit] = null,
    ...
    onValidate: (/* value */ String, /* event */ js.UndefOr[ReactEventFrom[HTMLElement]]) => CallbackTo[String | Unit] = null,
    ...
    if (getClassNames != null) __obj.updateDynamic("getClassNames")(js.Any.fromFunction6((t0: /* theme */ typingsJapgolly.uifabricStyling.ithemeMod.ITheme, t1: /* disabled */ scala.Boolean, t2: /* isFocused */ scala.Boolean, t3: /* keyboardSpinDirection */ typingsJapgolly.officeUiFabricReact.spinButtonSpinButtonMod.KeyboardSpinDirection, t4: /* labelPosition */ js.UndefOr[typingsJapgolly.officeUiFabricReact.positioningTypesMod.Position], t5: /* className */ js.UndefOr[java.lang.String]) => getClassNames(t0, t1, t2, t3, t4, t5).runNow()))
    ...
    if (onDecrement != null) __obj.updateDynamic("onDecrement")(js.Any.fromFunction1((t0: /* value */ java.lang.String) => onDecrement(t0).runNow()))
    ...
    if (onIncrement != null) __obj.updateDynamic("onIncrement")(js.Any.fromFunction1((t0: /* value */ java.lang.String) => onIncrement(t0).runNow()))
    ...
    if (onValidate != null) __obj.updateDynamic("onValidate")(js.Any.fromFunction2((t0: /* value */ java.lang.String, t1: /* event */ js.UndefOr[japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLElement]]) => onValidate(t0, t1).runNow()))
