...
import typingsJapgolly.officeUiFabricReact.libComponentsSliderSliderDotbaseMod.SliderBase
...
object libComponentsSliderSliderDottypesMod {
  ...
  object ISlider {
    ...
    inline def apply(focus: Callback): ISlider = {
  ...
  object ISliderProps {
    ...
    extension [Self <: ISliderProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ISlider | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ISlider | Null) => value(t0).runNow()))
      ...
      inline def setOnChange(value: (/* value */ Double, /* range */ js.UndefOr[js.Tuple2[Double, Double]]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ Double, t1: /* range */ js.UndefOr[js.Tuple2[Double, Double]]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnChanged(value: (/* event */ MouseEvent | TouchEvent | KeyboardEvent, /* value */ Double) => Callback): Self = StObject.set(x, "onChanged", js.Any.fromFunction2((t0: /* event */ MouseEvent | TouchEvent | KeyboardEvent, t1: /* value */ Double) => (value(t0, t1)).runNow()))
