...
import typingsJapgolly.officeUiFabricReact.libComponentsCommandBarCommandBarDotbaseMod.ICommandBarData
...
object libComponentsCommandBarCommandBarDottypesMod {
  ...
  object ICommandBar {
    ...
    inline def apply(focus: Callback, remeasure: Callback): ICommandBar = {
      val __obj = js.Dynamic.literal(focus = focus.toJsFn, remeasure = remeasure.toJsFn)
  ...
  object ICommandBarProps {
    ...
    extension [Self <: ICommandBarProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ICommandBar | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ICommandBar | Null) => value(t0).runNow()))
      ...
      inline def setOnDataGrown(value: /* movedItem */ ICommandBarItemProps => Callback): Self = StObject.set(x, "onDataGrown", js.Any.fromFunction1((t0: /* movedItem */ ICommandBarItemProps) => value(t0).runNow()))
      
      inline def setOnDataGrownUndefined: Self = StObject.set(x, "onDataGrown", js.undefined)
      
      inline def setOnDataReduced(value: /* movedItem */ ICommandBarItemProps => Callback): Self = StObject.set(x, "onDataReduced", js.Any.fromFunction1((t0: /* movedItem */ ICommandBarItemProps) => value(t0).runNow()))
