...
object PickIIconPropsExcludekeyo {
  ...
  extension [Self <: PickIIconPropsExcludekeyo](x: Self) {
    ...
    inline def setOnChange(value: ReactEventFrom[HTMLElement & org.scalajs.dom.Element] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLElement & org.scalajs.dom.Element]) => value(t0).runNow()))
