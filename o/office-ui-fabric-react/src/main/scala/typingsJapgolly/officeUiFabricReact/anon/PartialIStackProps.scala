...
object PartialIStackProps {
  ...
  inline def apply(): PartialIStackProps = {
  ...
  extension [Self <: PartialIStackProps](x: Self) {
    ...
    inline def setStyles(value: IStylesFunctionOrObject[IStackProps, IStackTokens, IStackStyles]): Self = StObject.set(x, "styles", value.asInstanceOf[js.Any])
    
    inline def setStylesFunction3(value: (IStackProps, /* theme */ ITheme, IStackTokens) => IStackStyles): Self = StObject.set(x, "styles", js.Any.fromFunction3(value))
    ...
    inline def setTokens(value: ITokenFunctionOrObject[IStackProps, IStackTokens]): Self = StObject.set(x, "tokens", value.asInstanceOf[js.Any])
