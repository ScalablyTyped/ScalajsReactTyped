...
import typingsJapgolly.officeUiFabricReact.libUtilitiesDraggableZoneDraggableZoneDottypesMod.ICoordinates
import typingsJapgolly.officeUiFabricReact.libUtilitiesDraggableZoneDraggableZoneDottypesMod.IDraggableZoneProps
...
object libUtilitiesDraggableZoneDraggableZoneMod {
  ...
  - typingsJapgolly.react.mod.BaseSyntheticEvent because Already inherited
  - typingsJapgolly.react.mod.UIEvent because Already inherited
  - typingsJapgolly.std.Event because var conflicts: bubbles, cancelable, currentTarget, defaultPrevented, eventPhase, isTrusted, target, timeStamp, `type`. Inlined BUBBLING_PHASE, NONE, cancelBubble, composed, returnValue, AT_TARGET, CAPTURING_PHASE, srcElement, composedPath, initEvent, initEvent, initEvent, initEvent, stopImmediatePropagation
  - typingsJapgolly.react.mod.TouchEvent because var conflicts: altKey, bubbles, cancelable, ctrlKey, currentTarget, defaultPrevented, detail, eventPhase, isTrusted, metaKey, nativeEvent, shiftKey, target, timeStamp, `type`, view. Inlined touches, changedTouches, targetTouches */ @js.native
