...
object libComponentsDocumentCardDocumentCardImageDottypesMod {
  ...
  object IDocumentCardImageProps {
    ...
    extension [Self <: IDocumentCardImageProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDocumentCardImage | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDocumentCardImage | Null) => value(t0).runNow()))
