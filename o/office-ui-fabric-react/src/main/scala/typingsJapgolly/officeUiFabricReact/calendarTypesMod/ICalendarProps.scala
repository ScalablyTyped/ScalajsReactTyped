...
trait ICalendarProps
  ...
  /**
    ...
    */
  var dateRangeType: js.UndefOr[typingsJapgolly.officeUiFabricReact.dateValuesMod.DateRangeType] = js.undefined
  /**
  ...
  /**
    ...
    */
  var firstDayOfWeek: js.UndefOr[typingsJapgolly.officeUiFabricReact.dateValuesMod.DayOfWeek] = js.undefined
  /**
    * Defines when the first week of the year should start, FirstWeekOfYear.FirstDay,
    * FirstWeekOfYear.FirstFullWeek or FirstWeekOfYear.FirstFourDayWeek are the possible values
    * @defaultvalue FirstWeekOfYear.FirstDay
    */
  var firstWeekOfYear: js.UndefOr[typingsJapgolly.officeUiFabricReact.dateValuesMod.FirstWeekOfYear] = js.undefined
  /**
  ...
  /**
    ...
    */
  var workWeekDays: js.UndefOr[js.Array[typingsJapgolly.officeUiFabricReact.dateValuesMod.DayOfWeek]] = js.undefined
  /**
...
object ICalendarProps {
  ...
  def apply(
    ...
    dateRangeType: typingsJapgolly.officeUiFabricReact.dateValuesMod.DateRangeType = null,
    dateTimeFormatter: ICalendarFormatDateCallbacks = null,
    defaultChecked: js.UndefOr[Boolean] = js.undefined,
    defaultValue: String | Double | js.Array[String] = null,
    dir: String = null,
    draggable: js.UndefOr[Boolean] = js.undefined,
    firstDayOfWeek: typingsJapgolly.officeUiFabricReact.dateValuesMod.DayOfWeek = null,
    firstWeekOfYear: typingsJapgolly.officeUiFabricReact.dateValuesMod.FirstWeekOfYear = null,
    ...
    onSelectDate: (/* date */ js.Date, /* selectedDateRangeArray */ js.UndefOr[js.Array[js.Date]]) => Callback = null,
    ...
    value: js.Date = null,
    vocab: String = null,
    workWeekDays: js.Array[typingsJapgolly.officeUiFabricReact.dateValuesMod.DayOfWeek] = null,
    ...
    if (onSelectDate != null) __obj.updateDynamic("onSelectDate")(js.Any.fromFunction2((t0: /* date */ js.Date, t1: /* selectedDateRangeArray */ js.UndefOr[js.Array[js.Date]]) => onSelectDate(t0, t1).runNow()))
