...
object libComponentsButtonButtonDottypesMod {
  ...
  object IButtonProps {
    ...
    extension [Self <: IButtonProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IButton | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IButton | Null) => value(t0).runNow()))
      ...
      inline def setOnAfterMenuDismiss(value: Callback): Self = StObject.set(x, "onAfterMenuDismiss", value.toJsFn)
