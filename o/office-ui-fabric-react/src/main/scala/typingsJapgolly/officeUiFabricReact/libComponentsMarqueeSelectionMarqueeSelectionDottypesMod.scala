...
object libComponentsMarqueeSelectionMarqueeSelectionDottypesMod {
  ...
  object IMarqueeSelectionProps {
    ...
    extension [Self <: IMarqueeSelectionProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IMarqueeSelection | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IMarqueeSelection | Null) => value(t0).runNow()))
