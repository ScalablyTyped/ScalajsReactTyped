package typingsJapgolly.officeUiFabricReact.overlayTypesMod
...
object IOverlayProps {
  ...
  def apply(
    ...
    if (!js.isUndefined(isDarkThemed)) __obj.updateDynamic("isDarkThemed")(isDarkThemed.asInstanceOf[js.Any])
