...
object libUtilitiesButtonGridButtonGridDottypesMod {
  ...
  object IButtonGridProps {
    ...
    extension [Self <: IButtonGridProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IButtonGrid | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IButtonGrid | Null) => value(t0).runNow()))
