...
object libComponentsKeytipKeytipDottypesMod {
  ...
  object IKeytipProps {
    ...
    extension [Self <: IKeytipProps](x: Self) {
      ...
      inline def setOnExecute(value: (/* executeTarget */ HTMLElement | Null, /* target */ HTMLElement | Null) => Callback): Self = StObject.set(x, "onExecute", js.Any.fromFunction2((t0: /* executeTarget */ HTMLElement | Null, t1: /* target */ HTMLElement | Null) => (value(t0, t1)).runNow()))
      
      inline def setOnExecuteUndefined: Self = StObject.set(x, "onExecute", js.undefined)
      
      inline def setOnReturn(value: (/* executeTarget */ HTMLElement | Null, /* target */ HTMLElement | Null) => Callback): Self = StObject.set(x, "onReturn", js.Any.fromFunction2((t0: /* executeTarget */ HTMLElement | Null, t1: /* target */ HTMLElement | Null) => (value(t0, t1)).runNow()))
