...
object dialogMod extends js.Object {
  ...
  class DialogBase protected ()
    extends typingsJapgolly.officeUiFabricReact.dialogBaseMod.DialogBase {
    def this(props: IDialogProps) = this()
  }
  
  @js.native
  class DialogContentBase protected ()
    extends typingsJapgolly.officeUiFabricReact.dialogContentBaseMod.DialogContentBase {
