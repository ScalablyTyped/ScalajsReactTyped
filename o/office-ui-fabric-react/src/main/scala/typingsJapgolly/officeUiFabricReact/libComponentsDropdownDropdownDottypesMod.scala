...
import typingsJapgolly.officeUiFabricReact.libComponentsLabelLabelDottypesMod.ILabelStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsLabelLabelDottypesMod.ILabelStyles
...
object libComponentsDropdownDropdownDottypesMod {
  ...
  trait IDropdownProps
    ...
    var onChange_IDropdownProps: js.UndefOr[
        js.Function3[
          /* event */ ReactEventFrom[HTMLDivElement], 
  ...
  object IDropdownProps {
    ...
    extension [Self <: IDropdownProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction3((t0: /* event */ ReactEventFrom[HTMLDivElement], t1: /* option */ js.UndefOr[IDropdownOption], t2: /* index */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnChanged(value: (/* option */ IDropdownOption, /* index */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onChanged", js.Any.fromFunction2((t0: /* option */ IDropdownOption, t1: /* index */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
