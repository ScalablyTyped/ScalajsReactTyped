...
import typingsJapgolly.officeUiFabricReact.libComponentsGroupedListGroupFooterDottypesMod.IGroupFooterStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsGroupedListGroupFooterDottypesMod.IGroupFooterStyles
...
@scala.inline
open class SharedBuilder_IGroupFooterProps_1171671166 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def styles(value: IStyleFunctionOrObject[IGroupFooterStyleProps, IGroupFooterStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: IGroupFooterStyleProps => DeepPartial[IGroupFooterStyles]): this.type = set("styles", js.Any.fromFunction1(value))
