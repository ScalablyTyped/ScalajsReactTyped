...
object SpinButtonBasicDisabledExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.spinButtonBasicDisabledExampleMod.SpinButtonBasicDisabledExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.spinButtonBasicDisabledExampleMod.SpinButtonBasicDisabledExample](this.componentImport)
