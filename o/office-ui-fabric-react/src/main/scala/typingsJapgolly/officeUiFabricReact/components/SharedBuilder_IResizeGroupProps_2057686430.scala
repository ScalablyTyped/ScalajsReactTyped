...
import typingsJapgolly.officeUiFabricReact.libComponentsResizeGroupResizeGroupDottypesMod.IResizeGroup
import typingsJapgolly.officeUiFabricReact.libComponentsResizeGroupResizeGroupDottypesMod.IResizeGroupStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsResizeGroupResizeGroupDottypesMod.IResizeGroupStyles
import typingsJapgolly.officeUiFabricReact.libComponentsResizeGroupResizeGroupDottypesMod.ResizeGroupDirection
...
@scala.inline
open class SharedBuilder_IResizeGroupProps_2057686430[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def componentRef(value: IRefObject[IResizeGroup]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IResizeGroup | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IResizeGroup | Null) => value(t0).runNow()))
  ...
  inline def direction(value: ResizeGroupDirection): this.type = set("direction", value.asInstanceOf[js.Any])
  ...
  inline def onAbort(
    value: ReactEventFrom[
      (typingsJapgolly.officeUiFabricReact.libComponentsResizeGroupResizeGroupDotbaseMod.ResizeGroupBase | HTMLElement) & Element
    ] => Callback
  ...
  inline def onGrowData(value: /* prevData */ Any => Any): this.type = set("onGrowData", js.Any.fromFunction1(value))
  ...
  inline def styles(value: IStyleFunctionOrObject[IResizeGroupStyleProps, IResizeGroupStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: IResizeGroupStyleProps => DeepPartial[IResizeGroupStyles]): this.type = set("styles", js.Any.fromFunction1(value))
