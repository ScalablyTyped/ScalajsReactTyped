...
abstract class SharedApply_IPeoplePickerProps1594752007[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IBasePickerProps[IPersonaProps], ComponentRef, Unit, IBasePickerProps[IPersonaProps]] = {
