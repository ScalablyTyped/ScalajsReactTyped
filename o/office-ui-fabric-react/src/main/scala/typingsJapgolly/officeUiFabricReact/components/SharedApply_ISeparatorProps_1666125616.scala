...
import typingsJapgolly.officeUiFabricReact.separatorTypesMod.ISeparatorStyleProps
import typingsJapgolly.officeUiFabricReact.separatorTypesMod.ISeparatorStyles
...
abstract class SharedApply_ISeparatorProps_1666125616 () {
  ...
  def apply(
    ...
    ISeparatorProps, 
    MountedWithRawType[ISeparatorProps, js.Object, RawMounted[ISeparatorProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.separatorTypesMod.ISeparatorProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.separatorTypesMod.ISeparatorProps])(children: _*)
  }
}
