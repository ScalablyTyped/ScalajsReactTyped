...
import typingsJapgolly.officeUiFabricReact.libComponentsImageImageDottypesMod.IImageStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsImageImageDottypesMod.IImageStyles
import typingsJapgolly.officeUiFabricReact.libComponentsImageImageDottypesMod.ImageCoverStyle
...
object ImageBase {
  ...
  @JSImport("office-ui-fabric-react", "ImageBase")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.ImageBase] {
    ...
    inline def coverStyle(value: ImageCoverStyle): this.type = set("coverStyle", value.asInstanceOf[js.Any])
    ...
    inline def errorSrc(value: String): this.type = set("errorSrc", value.asInstanceOf[js.Any])
    ...
    inline def maximizeFrame(value: Boolean): this.type = set("maximizeFrame", value.asInstanceOf[js.Any])
    ...
    inline def onLoadingStateChange(value: /* loadState */ ImageLoadState => Callback): this.type = set("onLoadingStateChange", js.Any.fromFunction1((t0: /* loadState */ ImageLoadState) => value(t0).runNow()))
    ...
    inline def shouldFadeIn(value: Boolean): this.type = set("shouldFadeIn", value.asInstanceOf[js.Any])
    
    inline def shouldStartVisible(value: Boolean): this.type = set("shouldStartVisible", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IImageStyleProps, IImageStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IImageStyleProps => DeepPartial[IImageStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: ImageBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IImageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
