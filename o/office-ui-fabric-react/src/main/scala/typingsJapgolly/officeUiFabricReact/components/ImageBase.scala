...
import typingsJapgolly.officeUiFabricReact.imageTypesMod.IImageStyleProps
import typingsJapgolly.officeUiFabricReact.imageTypesMod.IImageStyles
import typingsJapgolly.officeUiFabricReact.imageTypesMod.ImageCoverStyle
...
object ImageBase {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IImageProps, typingsJapgolly.officeUiFabricReact.mod.ImageBase, Unit, IImageProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.imageTypesMod.IImageProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.ImageBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.imageTypesMod.IImageProps])(children: _*)
  }
