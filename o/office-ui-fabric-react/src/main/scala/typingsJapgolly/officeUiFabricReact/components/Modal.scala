...
object Modal {
  def apply(
    ...
    IModalProps, 
    LegacyRef[typingsJapgolly.officeUiFabricReact.modalBaseMod.ModalBase], 
    Unit, 
    IModalProps
  ] = {
  ...
  typingsJapgolly.react.mod.LegacyRef[typingsJapgolly.officeUiFabricReact.modalBaseMod.ModalBase]](this.componentImport)
