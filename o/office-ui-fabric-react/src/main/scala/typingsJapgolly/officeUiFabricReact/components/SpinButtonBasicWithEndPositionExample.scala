...
object SpinButtonBasicWithEndPositionExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.spinButtonBasicWithEndPositionExampleMod.SpinButtonBasicWithEndPositionExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.spinButtonBasicWithEndPositionExampleMod.SpinButtonBasicWithEndPositionExample](this.componentImport)
