...
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.ITooltip
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.ITooltipProps
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.ITooltipStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.ITooltipStyles
...
object TooltipBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.TooltipBase] {
    ...
    inline def componentRef(value: IRefObject[ITooltip]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ITooltip | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ITooltip | Null) => value(t0).runNow()))
    ...
    inline def maxWidth(value: String): this.type = set("maxWidth", value.asInstanceOf[js.Any])
    
    inline def maxWidthNull: this.type = set("maxWidth", null)
    
    inline def onAbort(
      value: ReactEventFrom[
          (HTMLDivElement | typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDotbaseMod.TooltipBase) & org.scalajs.dom.Element
        ] => Callback
    ...
    ): this.type = set("onRenderContent", js.Any.fromFunction2(value))
    ...
    inline def styles(value: IStyleFunctionOrObject[ITooltipStyleProps, ITooltipStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: ITooltipStyleProps => DeepPartial[ITooltipStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: TooltipBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
