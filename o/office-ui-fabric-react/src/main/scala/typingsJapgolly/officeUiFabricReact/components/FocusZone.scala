...
import typingsJapgolly.officeUiFabricReact.focusZoneTypesMod.FocusZoneDirection
...
object FocusZone {
  def apply(
    ...
    isInnerZoneKeystroke: /* ev */ ReactKeyboardEventFrom[HTMLElement] => CallbackTo[Boolean] = null,
    itemID: String = null,
    ...
    onAbort: ReactEventFrom[
      (HTMLElement | typingsJapgolly.officeUiFabricReact.focusZoneFocusZoneMod.FocusZone) with Element
    ] => Callback = null,
    onActiveElementChanged: (/* element */ js.UndefOr[HTMLElement], /* ev */ js.UndefOr[ReactFocusEventFrom[HTMLElement]]) => Callback = null,
    ...
    onBeforeFocus: /* childElement */ js.UndefOr[HTMLElement] => CallbackTo[Boolean] = null,
    ...
    IFocusZoneProps, 
    typingsJapgolly.officeUiFabricReact.mod.FocusZone, 
    Unit, 
    IFocusZoneProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.focusZoneTypesMod.IFocusZoneProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.FocusZone](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.focusZoneTypesMod.IFocusZoneProps])(children: _*)
  }
