...
import typingsJapgolly.officeUiFabricReact.pivotTypesMod.IPivot
import typingsJapgolly.officeUiFabricReact.pivotTypesMod.IPivotProps
import typingsJapgolly.officeUiFabricReact.pivotTypesMod.IPivotStyleProps
import typingsJapgolly.officeUiFabricReact.pivotTypesMod.IPivotStyles
import typingsJapgolly.officeUiFabricReact.pivotTypesMod.PivotLinkFormat
import typingsJapgolly.officeUiFabricReact.pivotTypesMod.PivotLinkSize
...
object Pivot {
  def apply(
    ...
    getTabId: (/* itemKey */ String, /* index */ Double) => CallbackTo[String] = null,
    ...
    onLinkClick: (/* item */ js.UndefOr[typingsJapgolly.officeUiFabricReact.pivotItemMod.PivotItem], /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => Callback = null,
    ...
    IPivotProps, 
    LegacyRef[typingsJapgolly.officeUiFabricReact.pivotBaseMod.PivotBase], 
    Unit, 
    IPivotProps
  ] = {
    ...
    if (getTabId != null) __obj.updateDynamic("getTabId")(js.Any.fromFunction2((t0: /* itemKey */ java.lang.String, t1: /* index */ scala.Double) => getTabId(t0, t1).runNow()))
    ...
    if (onLinkClick != null) __obj.updateDynamic("onLinkClick")(js.Any.fromFunction2((t0: /* item */ js.UndefOr[typingsJapgolly.officeUiFabricReact.pivotItemMod.PivotItem], t1: /* ev */ js.UndefOr[japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement]]) => onLinkClick(t0, t1).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.pivotTypesMod.IPivotProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[typingsJapgolly.officeUiFabricReact.pivotBaseMod.PivotBase]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.pivotTypesMod.IPivotProps])(children: _*)
  }
