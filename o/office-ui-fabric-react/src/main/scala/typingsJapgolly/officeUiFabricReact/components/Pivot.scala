...
import typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDottypesMod.IPivot
import typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDottypesMod.IPivotProps
import typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDottypesMod.IPivotStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDottypesMod.IPivotStyles
import typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDottypesMod.PivotLinkFormat
import typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDottypesMod.PivotLinkSize
...
object Pivot {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDotbaseMod.PivotBase] {
    ...
    inline def componentRef(value: IRefObject[IPivot]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IPivot | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IPivot | Null) => value(t0).runNow()))
    ...
    inline def defaultSelectedIndex(value: Double): this.type = set("defaultSelectedIndex", value.asInstanceOf[js.Any])
    ...
    inline def getTabId(value: (/* itemKey */ String, /* index */ Double) => String): this.type = set("getTabId", js.Any.fromFunction2(value))
    
    inline def headersOnly(value: Boolean): this.type = set("headersOnly", value.asInstanceOf[js.Any])
    ...
    inline def linkFormat(value: PivotLinkFormat): this.type = set("linkFormat", value.asInstanceOf[js.Any])
    
    inline def linkSize(value: PivotLinkSize): this.type = set("linkSize", value.asInstanceOf[js.Any])
    ...
    inline def onLinkClick(
      value: (/* item */ js.UndefOr[typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotItemMod.PivotItem], /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => Callback
    ): this.type = set("onLinkClick", js.Any.fromFunction2((t0: /* item */ js.UndefOr[typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotItemMod.PivotItem], t1: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => (value(t0, t1)).runNow()))
    ...
    inline def styles(value: IStyleFunctionOrObject[IPivotStyleProps, IPivotStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IPivotStyleProps => DeepPartial[IPivotStyles]): this.type = set("styles", js.Any.fromFunction1(value))
