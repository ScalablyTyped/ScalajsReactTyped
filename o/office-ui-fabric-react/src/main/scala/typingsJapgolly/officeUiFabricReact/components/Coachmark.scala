...
object Coachmark {
  def apply(
    ...
    ICoachmarkProps, 
    LegacyRef[typingsJapgolly.officeUiFabricReact.coachmarkBaseMod.CoachmarkBase], 
    Unit, 
    ICoachmarkProps
  ] = {
  ...
  typingsJapgolly.react.mod.LegacyRef[typingsJapgolly.officeUiFabricReact.coachmarkBaseMod.CoachmarkBase]](this.componentImport)
