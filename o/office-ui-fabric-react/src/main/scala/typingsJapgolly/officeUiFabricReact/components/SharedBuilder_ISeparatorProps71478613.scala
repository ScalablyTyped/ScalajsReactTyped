...
import typingsJapgolly.officeUiFabricReact.libComponentsSeparatorSeparatorDottypesMod.ISeparatorStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsSeparatorSeparatorDottypesMod.ISeparatorStyles
...
@scala.inline
open class SharedBuilder_ISeparatorProps71478613 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def alignContent(value: start | center | end): this.type = set("alignContent", value.asInstanceOf[js.Any])
  ...
  inline def styles(value: IStyleFunctionOrObject[ISeparatorStyleProps, ISeparatorStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: ISeparatorStyleProps => DeepPartial[ISeparatorStyles]): this.type = set("styles", js.Any.fromFunction1(value))
