...
import typingsJapgolly.officeUiFabricReact.libComponentsAnnouncedAnnouncedDottypesMod.IAnnouncedStyles
...
object AnnouncedBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.AnnouncedBase] {
    ...
    inline def `aria-live`(value: off | polite | assertive): this.type = set("aria-live", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[js.Object, IAnnouncedStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: js.Object => DeepPartial[IAnnouncedStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    ...
    inline def unselectable(value: on | typingsJapgolly.react.reactStrings.off): this.type = set("unselectable", value.asInstanceOf[js.Any])
