...
abstract class SharedApply_IAutofillProps_644938080[ComponentRef] () {
  ...
  def apply(
    ...
    onAbort: ReactEventFrom[
      (HTMLInputElement | typingsJapgolly.officeUiFabricReact.autofillAutofillMod.Autofill) with Element
    ] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IAutofillProps, ComponentRef, Unit, IAutofillProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.autofillTypesMod.IAutofillProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.autofillTypesMod.IAutofillProps])(children: _*)
  }
}
