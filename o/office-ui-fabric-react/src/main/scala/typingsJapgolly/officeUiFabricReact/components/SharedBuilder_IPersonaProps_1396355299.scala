...
@scala.inline
open class SharedBuilder_IPersonaProps_1396355299 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def componentRef(value: IRefObject[IPersona]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IPersona | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IPersona | Null) => value(t0).runNow()))
  ...
  inline def onRenderOptionalText(
  ...
  inline def onRenderPrimaryText(
    value: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IPersonaProps], 
        typingsJapgolly.react.mod.global.JSX.Element | Null
  ...
  inline def onRenderSecondaryText(
    value: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IPersonaProps], 
        typingsJapgolly.react.mod.global.JSX.Element | Null
  ...
  inline def onRenderTertiaryText(
    value: (/* props */ js.UndefOr[IPersonaProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IPersonaProps], 
        typingsJapgolly.react.mod.global.JSX.Element | Null
  ...
  inline def styles(value: IStyleFunctionOrObject[IPersonaStyleProps, IPersonaStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: IPersonaStyleProps => DeepPartial[IPersonaStyles]): this.type = set("styles", js.Any.fromFunction1(value))
