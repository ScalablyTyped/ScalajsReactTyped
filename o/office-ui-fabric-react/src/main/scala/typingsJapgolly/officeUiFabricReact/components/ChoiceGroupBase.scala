...
import typingsJapgolly.officeUiFabricReact.libComponentsChoiceGroupChoiceGroupDottypesMod.IChoiceGroup
...
object ChoiceGroupBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.ChoiceGroupBase] {
    ...
    inline def componentRef(value: IRefObject[IChoiceGroup]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IChoiceGroup | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IChoiceGroup | Null) => value(t0).runNow()))
    ...
    inline def defaultSelectedKey(value: String | Double): this.type = set("defaultSelectedKey", value.asInstanceOf[js.Any])
    ...
    inline def onChange(
      value: (/* ev */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & Element]], /* option */ js.UndefOr[IChoiceGroupOption]) => Callback
    ): this.type = set("onChange", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & Element]], t1: /* option */ js.UndefOr[IChoiceGroupOption]) => (value(t0, t1)).runNow()))
    
    inline def onChanged(
      value: (/* option */ IChoiceGroupOption, /* evt */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & Element]]) => Callback
    ): this.type = set("onChanged", js.Any.fromFunction2((t0: /* option */ IChoiceGroupOption, t1: /* evt */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & Element]]) => (value(t0, t1)).runNow()))
    ...
    inline def options(value: js.Array[IChoiceGroupOption]): this.type = set("options", value.asInstanceOf[js.Any])
    
    inline def optionsVarargs(value: IChoiceGroupOption*): this.type = set("options", js.Array(value*))
    ...
    inline def selectedKey(value: String | Double): this.type = set("selectedKey", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IChoiceGroupStyleProps, IChoiceGroupStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IChoiceGroupStyleProps => DeepPartial[IChoiceGroupStyles]): this.type = set("styles", js.Any.fromFunction1(value))
