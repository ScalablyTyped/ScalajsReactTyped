...
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerCircleShimmerCircleDottypesMod.IShimmerCircle
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerCircleShimmerCircleDottypesMod.IShimmerCircleStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerCircleShimmerCircleDottypesMod.IShimmerCircleStyles
...
@scala.inline
open class SharedBuilder_IShimmerCircleProps1941960323 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def borderStyle(value: IRawStyle): this.type = set("borderStyle", value.asInstanceOf[js.Any])
  ...
  inline def componentRef(value: IRefObject[IShimmerCircle]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IShimmerCircle | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmerCircle | Null) => value(t0).runNow()))
  ...
  inline def styles(value: IStyleFunctionOrObject[IShimmerCircleStyleProps, IShimmerCircleStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: IShimmerCircleStyleProps => DeepPartial[IShimmerCircleStyles]): this.type = set("styles", js.Any.fromFunction1(value))
