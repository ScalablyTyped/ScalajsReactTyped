...
object VerticalDividerBasicExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.verticalDividerBasicExampleMod.VerticalDividerBasicExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.verticalDividerBasicExampleMod.VerticalDividerBasicExample](this.componentImport)
