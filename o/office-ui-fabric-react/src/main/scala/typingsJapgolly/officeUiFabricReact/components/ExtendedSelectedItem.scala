...
object ExtendedSelectedItem {
  ...
  inline def apply(index: Double, item: IExtendedPersonaProps, onCopyItem: IExtendedPersonaProps => Callback): Builder = {
    val __props = js.Dynamic.literal(index = index.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any], onCopyItem = js.Any.fromFunction1((t0: IExtendedPersonaProps) => onCopyItem(t0).runNow()))
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.ExtendedSelectedItem] {
