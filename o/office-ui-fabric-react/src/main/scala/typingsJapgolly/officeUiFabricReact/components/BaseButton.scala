...
object BaseButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.BaseButton] {
    ...
    inline def onMenuClick(
      value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement] | ReactKeyboardEventFrom[HTMLElement]], /* button */ js.UndefOr[IBaseButtonProps]) => Callback
    ): this.type = set("onMenuClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement] | ReactKeyboardEventFrom[HTMLElement]], t1: /* button */ js.UndefOr[IBaseButtonProps]) => (value(t0, t1)).runNow()))
    ...
    inline def variantClassName(value: String): this.type = set("variantClassName", value.asInstanceOf[js.Any])
