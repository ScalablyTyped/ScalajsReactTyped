...
import typingsJapgolly.officeUiFabricReact.libComponentsScrollablePaneScrollablePaneDottypesMod.IScrollablePane
import typingsJapgolly.officeUiFabricReact.libComponentsScrollablePaneScrollablePaneDottypesMod.IScrollablePaneProps
import typingsJapgolly.officeUiFabricReact.libComponentsScrollablePaneScrollablePaneDottypesMod.IScrollablePaneStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsScrollablePaneScrollablePaneDottypesMod.IScrollablePaneStyles
import typingsJapgolly.officeUiFabricReact.libComponentsScrollablePaneScrollablePaneDottypesMod.ScrollbarVisibility
...
object ScrollablePane {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def componentRef(value: IRefObject[IScrollablePane]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IScrollablePane | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IScrollablePane | Null) => value(t0).runNow()))
    ...
    inline def initialScrollPosition(value: Double): this.type = set("initialScrollPosition", value.asInstanceOf[js.Any])
    ...
    inline def onAbort(
      value: ReactEventFrom[
          (HTMLElement | typingsJapgolly.officeUiFabricReact.libComponentsScrollablePaneScrollablePaneDotbaseMod.ScrollablePaneBase) & Element
        ] => Callback
    ...
    inline def scrollbarVisibility(value: ScrollbarVisibility): this.type = set("scrollbarVisibility", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IScrollablePaneStyleProps, IScrollablePaneStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IScrollablePaneStyleProps => DeepPartial[IScrollablePaneStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: ScrollablePane.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
