...
object SearchBoxDisabledExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.searchBoxDisabledExampleMod.SearchBoxDisabledExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.searchBoxDisabledExampleMod.SearchBoxDisabledExample](this.componentImport)
