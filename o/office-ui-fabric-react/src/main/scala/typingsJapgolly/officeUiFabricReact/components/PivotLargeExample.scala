...
object PivotLargeExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.pivotLargeExampleMod.PivotLargeExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.pivotLargeExampleMod.PivotLargeExample](this.componentImport)
