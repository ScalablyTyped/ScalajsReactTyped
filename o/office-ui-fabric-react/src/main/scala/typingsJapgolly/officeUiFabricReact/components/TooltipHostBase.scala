...
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.TooltipDelay
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDottypesMod.ITooltipHost
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDottypesMod.ITooltipHostProps
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDottypesMod.ITooltipHostStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDottypesMod.ITooltipHostStyles
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDottypesMod.TooltipOverflowMode
...
object TooltipHostBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.TooltipHostBase] {
    ...
    inline def closeDelay(value: Double): this.type = set("closeDelay", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def componentRef(value: IRefObject[ITooltipHost]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ITooltipHost | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ITooltipHost | Null) => value(t0).runNow()))
    
    inline def content(value: String | Element | js.Array[Element]): this.type = set("content", value.asInstanceOf[js.Any])
    
    inline def contentEditable(value: Booleanish | inherit): this.type = set("contentEditable", value.asInstanceOf[js.Any])
    
    inline def contentVarargs(value: Element*): this.type = set("content", js.Array(value*))
    ...
    inline def delay(value: TooltipDelay): this.type = set("delay", value.asInstanceOf[js.Any])
    ...
    inline def hostClassName(value: String): this.type = set("hostClassName", value.asInstanceOf[js.Any])
    ...
    inline def onAbort(
      value: ReactEventFrom[
          (HTMLDivElement | typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDotbaseMod.TooltipHostBase) & org.scalajs.dom.Element
        ] => Callback
    ...
    inline def onTooltipToggle(value: /* isTooltipVisible */ Boolean => Callback): this.type = set("onTooltipToggle", js.Any.fromFunction1((t0: /* isTooltipVisible */ Boolean) => value(t0).runNow()))
    ...
    inline def overflowMode(value: TooltipOverflowMode): this.type = set("overflowMode", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[ITooltipHostStyleProps, ITooltipHostStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: ITooltipHostStyleProps => DeepPartial[ITooltipHostStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    ...
    inline def tooltipProps(value: ITooltipProps): this.type = set("tooltipProps", value.asInstanceOf[js.Any])
