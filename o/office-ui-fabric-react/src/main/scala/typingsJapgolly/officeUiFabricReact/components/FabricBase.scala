...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.ltr
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.rtl
...
object FabricBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.FabricBase] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def applyTheme(value: Boolean): this.type = set("applyTheme", value.asInstanceOf[js.Any])
    
    inline def applyThemeToBody(value: Boolean): this.type = set("applyThemeToBody", value.asInstanceOf[js.Any])
    ...
    inline def dir(value: rtl | ltr | auto): this.type = set("dir", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IFabricStyleProps, IFabricStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IFabricStyleProps => DeepPartial[IFabricStyles]): this.type = set("styles", js.Any.fromFunction1(value))
