...
import typingsJapgolly.officeUiFabricReact.fabricTypesMod.IFabricStyleProps
import typingsJapgolly.officeUiFabricReact.fabricTypesMod.IFabricStyles
...
object FabricBase {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IFabricProps, typingsJapgolly.officeUiFabricReact.mod.FabricBase, Unit, IFabricProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.fabricTypesMod.IFabricProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.FabricBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.fabricTypesMod.IFabricProps])(children: _*)
  }
