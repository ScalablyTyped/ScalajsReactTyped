...
object EditingItem {
  ...
  inline def apply(
    ...
    onCopyItem: IExtendedPersonaProps => Callback,
    onEditingComplete: (Any, Any) => Callback
  ): Builder = {
    val __props = js.Dynamic.literal(index = index.asInstanceOf[js.Any], item = item.asInstanceOf[js.Any], onCopyItem = js.Any.fromFunction1((t0: IExtendedPersonaProps) => onCopyItem(t0).runNow()), onEditingComplete = js.Any.fromFunction2((t0: Any, t1: Any) => (onEditingComplete(t0, t1)).runNow()))
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.officeUiFabricReact.libComponentsSelectedItemsListSelectedPeopleListItemsEditingItemMod.EditingItem
        ] {
    ...
    inline def onExpandItem(value: Callback): this.type = set("onExpandItem", value.toJsFn)
    ...
    inline def onItemChange(value: (IExtendedPersonaProps, /* index */ Double) => Callback): this.type = set("onItemChange", js.Any.fromFunction2((t0: IExtendedPersonaProps, t1: /* index */ Double) => (value(t0, t1)).runNow()))
