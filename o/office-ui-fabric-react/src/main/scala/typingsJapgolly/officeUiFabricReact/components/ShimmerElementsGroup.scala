...
object ShimmerElementsGroup {
  ...
  implicit def make(companion: ShimmerElementsGroup.type): SharedBuilder_IShimmerElementsGroupProps_1570679509 = new SharedBuilder_IShimmerElementsGroupProps_1570679509(js.Array(this.component, js.Dictionary.empty))()
