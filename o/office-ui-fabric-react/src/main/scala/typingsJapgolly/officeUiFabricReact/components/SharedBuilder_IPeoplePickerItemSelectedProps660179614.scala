...
import typingsJapgolly.officeUiFabricReact.libComponentsPickersPickerItemDottypesMod.IPickerItem
...
@scala.inline
open class SharedBuilder_IPeoplePickerItemSelectedProps660179614 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def componentRef(value: IRefObject[IPickerItem]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IPickerItem | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IPickerItem | Null) => value(t0).runNow()))
  ...
  inline def onItemChange(value: (IPersonaPropsValidationSt, /* index */ Double) => Callback): this.type = set("onItemChange", js.Any.fromFunction2((t0: IPersonaPropsValidationSt, t1: /* index */ Double) => (value(t0, t1)).runNow()))
  ...
  inline def onRemoveItem(value: Callback): this.type = set("onRemoveItem", value.toJsFn)
  ...
  inline def stylesFunction1(value: IPeoplePickerItemSelectedStyleProps => DeepPartial[IPeoplePickerItemSelectedStyles]): this.type = set("styles", js.Any.fromFunction1(value))
