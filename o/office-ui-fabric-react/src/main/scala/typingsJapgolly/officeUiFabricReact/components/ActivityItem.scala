...
object ActivityItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.ActivityItem] {
    ...
    inline def activityDescription(value: js.Array[Node] | Node): this.type = set("activityDescription", value.asInstanceOf[js.Any])
    
    inline def activityDescriptionNull: this.type = set("activityDescription", null)
    
    inline def activityDescriptionText(value: String): this.type = set("activityDescriptionText", value.asInstanceOf[js.Any])
    
    inline def activityDescriptionVarargs(value: (Element | Empty | JsNumber | Node | String)*): this.type = set("activityDescription", js.Array(value*))
    
    inline def activityDescriptionVdomElement(value: VdomElement): this.type = set("activityDescription", value.rawElement.asInstanceOf[js.Any])
    
    inline def activityIcon(value: VdomNode): this.type = set("activityIcon", value.rawNode.asInstanceOf[js.Any])
    
    inline def activityIconNull: this.type = set("activityIcon", null)
    
    inline def activityIconVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("activityIcon", js.Array(value*))
    
    inline def activityIconVdomElement(value: VdomElement): this.type = set("activityIcon", value.rawElement.asInstanceOf[js.Any])
    
    inline def activityPersonas(value: js.Array[IPersonaSharedProps]): this.type = set("activityPersonas", value.asInstanceOf[js.Any])
    
    inline def activityPersonasVarargs(value: IPersonaSharedProps*): this.type = set("activityPersonas", js.Array(value*))
    ...
    inline def animateBeaconSignal(value: Boolean): this.type = set("animateBeaconSignal", value.asInstanceOf[js.Any])
    ...
    inline def commentText(value: String): this.type = set("commentText", value.asInstanceOf[js.Any])
    
    inline def comments(value: js.Array[Node] | Node): this.type = set("comments", value.asInstanceOf[js.Any])
    
    inline def commentsNull: this.type = set("comments", null)
    
    inline def commentsVarargs(value: (Element | Empty | JsNumber | Node | String)*): this.type = set("comments", js.Array(value*))
    
    inline def commentsVdomElement(value: VdomElement): this.type = set("comments", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def isCompact(value: Boolean): this.type = set("isCompact", value.asInstanceOf[js.Any])
    ...
    inline def onRenderActivityDescription(
      value: (/* props */ js.UndefOr[IActivityItemProps], /* defaultRender */ js.UndefOr[
          js.Function1[
            /* props */ js.UndefOr[IActivityItemProps], 
            typingsJapgolly.react.mod.global.JSX.Element | Null
          ]
        ]) => typingsJapgolly.react.mod.global.JSX.Element | Null
    ): this.type = set("onRenderActivityDescription", js.Any.fromFunction2(value))
    
    inline def onRenderComments(
      value: (/* props */ js.UndefOr[IActivityItemProps], /* defaultRender */ js.UndefOr[
          js.Function1[
            /* props */ js.UndefOr[IActivityItemProps], 
            typingsJapgolly.react.mod.global.JSX.Element | Null
    ...
    ): this.type = set("onRenderComments", js.Any.fromFunction2(value))
    ...
    ): this.type = set("onRenderTimeStamp", js.Any.fromFunction2(value))
    ...
    inline def styles(value: IActivityItemStyles): this.type = set("styles", value.asInstanceOf[js.Any])
    ...
    inline def timeStamp(value: String | js.Array[Node] | Node): this.type = set("timeStamp", value.asInstanceOf[js.Any])
    
    inline def timeStampNull: this.type = set("timeStamp", null)
    
    inline def timeStampVarargs(value: (Element | Empty | JsNumber | Node | String)*): this.type = set("timeStamp", js.Array(value*))
    
    inline def timeStampVdomElement(value: VdomElement): this.type = set("timeStamp", value.rawElement.asInstanceOf[js.Any])
