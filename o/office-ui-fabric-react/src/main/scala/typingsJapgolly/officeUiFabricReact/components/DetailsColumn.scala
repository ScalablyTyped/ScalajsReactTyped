...
object DetailsColumn {
  def apply(
    ...
    IDetailsColumnProps, 
    LegacyRef[typingsJapgolly.officeUiFabricReact.detailsColumnBaseMod.DetailsColumnBase], 
    Unit, 
    IDetailsColumnProps
  ] = {
  ...
  typingsJapgolly.react.mod.LegacyRef[typingsJapgolly.officeUiFabricReact.detailsColumnBaseMod.DetailsColumnBase]](this.componentImport)
