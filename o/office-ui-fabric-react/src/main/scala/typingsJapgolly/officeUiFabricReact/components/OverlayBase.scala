...
import typingsJapgolly.officeUiFabricReact.libComponentsOverlayOverlayDottypesMod.IOverlay
...
object OverlayBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.OverlayBase] {
    ...
    inline def componentRef(value: IRefObject[IOverlay]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IOverlay | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IOverlay | Null) => value(t0).runNow()))
    ...
    inline def isDarkThemed(value: Boolean): this.type = set("isDarkThemed", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IOverlayStyleProps, IOverlayStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IOverlayStyleProps => DeepPartial[IOverlayStyles]): this.type = set("styles", js.Any.fromFunction1(value))
