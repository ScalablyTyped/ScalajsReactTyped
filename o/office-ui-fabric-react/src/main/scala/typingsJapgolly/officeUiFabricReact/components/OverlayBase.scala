...
import typingsJapgolly.officeUiFabricReact.overlayTypesMod.IOverlay
...
object OverlayBase {
  def apply(
    ...
    IOverlayProps, 
    typingsJapgolly.officeUiFabricReact.mod.OverlayBase, 
    Unit, 
    IOverlayProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.overlayTypesMod.IOverlayProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.OverlayBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.overlayTypesMod.IOverlayProps])(children: _*)
  }
