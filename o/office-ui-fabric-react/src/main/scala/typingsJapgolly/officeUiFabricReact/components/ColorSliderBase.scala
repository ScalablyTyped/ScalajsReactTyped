...
object ColorSliderBase {
  def apply(
    ...
    IColorSliderProps, 
    typingsJapgolly.officeUiFabricReact.colorSliderBaseMod.ColorSliderBase, 
    Unit, 
    IColorSliderProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.colorSliderBaseMod.ColorSliderBase](this.componentImport)
