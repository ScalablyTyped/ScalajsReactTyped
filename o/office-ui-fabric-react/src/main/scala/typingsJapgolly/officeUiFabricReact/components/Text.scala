...
import typingsJapgolly.officeUiFabricReact.textTypesMod.ITextSlots
...
import typingsJapgolly.uifabricFoundation.uifabricFoundationStrings.AnonSlots
...
object Text {
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ AnonSlots with ITextSlots = null,
    ...
    ITextProps, 
    MountedWithRawType[ITextProps, js.Object, RawMounted[ITextProps, js.Object]]
  ] = {
  ...
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.textTypesMod.ITextProps])(children: _*)
  }
