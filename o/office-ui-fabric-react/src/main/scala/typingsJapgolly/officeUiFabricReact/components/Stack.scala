...
import typingsJapgolly.officeUiFabricReact.libComponentsStackStackDottypesMod.Alignment
import typingsJapgolly.officeUiFabricReact.libComponentsStackStackDottypesMod.IStackProps
import typingsJapgolly.officeUiFabricReact.libComponentsStackStackDottypesMod.IStackStyles
import typingsJapgolly.officeUiFabricReact.libComponentsStackStackDottypesMod.IStackTokens
...
object Stack {
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): SharedBuilder_IStackItemProps1963601193 = new SharedBuilder_IStackItemProps1963601193(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: IStackItemProps): SharedBuilder_IStackItemProps1963601193 = new SharedBuilder_IStackItemProps1963601193(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def horizontalAlign(value: Alignment): this.type = set("horizontalAlign", value.asInstanceOf[js.Any])
    
    inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    
    inline def inlist(value: Any): this.type = set("inlist", value.asInstanceOf[js.Any])
    
    inline def inner(value: IHTMLSlot): this.type = set("inner", value.asInstanceOf[js.Any])
    ...
    inline def padding(value: Double | String): this.type = set("padding", value.asInstanceOf[js.Any])
    ...
    inline def root(value: IHTMLSlot): this.type = set("root", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStylesFunctionOrObject[IStackProps, IStackTokens, IStackStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction3(value: (IStackProps, /* theme */ ITheme, IStackTokens) => IStackStyles): this.type = set("styles", js.Any.fromFunction3(value))
    ...
    inline def tokens(value: ITokenFunctionOrObject[IStackProps, IStackTokens]): this.type = set("tokens", value.asInstanceOf[js.Any])
    ...
    inline def verticalAlign(value: Alignment): this.type = set("verticalAlign", value.asInstanceOf[js.Any])
    
    inline def verticalFill(value: Boolean): this.type = set("verticalFill", value.asInstanceOf[js.Any])
  ...
  def withProps(p: IStackProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
