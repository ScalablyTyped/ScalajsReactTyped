...
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerLineShimmerLineDottypesMod.IShimmerLine
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerLineShimmerLineDottypesMod.IShimmerLineStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerLineShimmerLineDottypesMod.IShimmerLineStyles
...
@scala.inline
open class SharedBuilder_IShimmerLineProps1631356153 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def componentRef(value: IRefObject[IShimmerLine]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IShimmerLine | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmerLine | Null) => value(t0).runNow()))
  ...
  inline def styles(value: IStyleFunctionOrObject[IShimmerLineStyleProps, IShimmerLineStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: IShimmerLineStyleProps => DeepPartial[IShimmerLineStyles]): this.type = set("styles", js.Any.fromFunction1(value))
