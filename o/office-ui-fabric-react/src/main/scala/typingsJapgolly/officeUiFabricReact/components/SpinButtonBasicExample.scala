...
object SpinButtonBasicExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.spinButtonBasicExampleMod.SpinButtonBasicExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.spinButtonBasicExampleMod.SpinButtonBasicExample](this.componentImport)
