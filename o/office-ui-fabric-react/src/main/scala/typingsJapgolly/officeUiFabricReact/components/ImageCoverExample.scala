...
object ImageCoverExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.imageCoverExampleMod.ImageCoverExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.imageCoverExampleMod.ImageCoverExample](this.componentImport)
