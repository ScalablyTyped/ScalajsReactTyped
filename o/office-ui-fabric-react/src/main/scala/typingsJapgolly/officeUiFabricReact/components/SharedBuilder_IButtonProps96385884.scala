...
import typingsJapgolly.officeUiFabricReact.libComponentsButtonBaseButtonDotclassNamesMod.IButtonClassNames
import typingsJapgolly.officeUiFabricReact.libComponentsButtonButtonDottypesMod.ButtonType
...
@scala.inline
open class SharedBuilder_IButtonProps96385884[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def allowDisabledFocus(value: Boolean): this.type = set("allowDisabledFocus", value.asInstanceOf[js.Any])
  ...
  inline def componentRef(value: IRefObject[IButton]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IButton | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IButton | Null) => value(t0).runNow()))
  ...
  inline def defaultRender(value: Any): this.type = set("defaultRender", value.asInstanceOf[js.Any])
  ...
  inline def description(value: IStyle): this.type = set("description", value.asInstanceOf[js.Any])
  ...
  inline def elementRef(value: Ref[HTMLElement]): this.type = set("elementRef", value.asInstanceOf[js.Any])
  
  inline def elementRefFunction1(value: HTMLElement | Null => Callback): this.type = set("elementRef", js.Any.fromFunction1((t0: HTMLElement | Null) => value(t0).runNow()))
  ...
  ): this.type = set("getClassNames", js.Any.fromFunction11(value))
  ...
  ): this.type = set("getSplitButtonClassNames", js.Any.fromFunction4(value))
  ...
  inline def menuAs(value: IComponentAs[IContextualMenuProps]): this.type = set("menuAs", value.asInstanceOf[js.Any])
  
  inline def menuIconProps(value: IIconProps): this.type = set("menuIconProps", value.asInstanceOf[js.Any])
  
  inline def menuProps(value: IContextualMenuProps): this.type = set("menuProps", value.asInstanceOf[js.Any])
  
  inline def menuTriggerKeyCode(value: KeyCodes): this.type = set("menuTriggerKeyCode", value.asInstanceOf[js.Any])
  
  inline def menuTriggerKeyCodeNull: this.type = set("menuTriggerKeyCode", null)
  ...
  inline def onAbort(
    value: ReactEventFrom[
      (HTMLAnchorElement | HTMLButtonElement | HTMLDivElement | typingsJapgolly.officeUiFabricReact.libComponentsButtonBaseButtonMod.BaseButton | typingsJapgolly.officeUiFabricReact.libComponentsButtonButtonMod.Button | HTMLSpanElement) & Element
    ] => Callback
  ): this.type = set("onAbort", js.Any.fromFunction1((t0: ReactEventFrom[
      (HTMLAnchorElement | HTMLButtonElement | HTMLDivElement | typingsJapgolly.officeUiFabricReact.libComponentsButtonBaseButtonMod.BaseButton | typingsJapgolly.officeUiFabricReact.libComponentsButtonButtonMod.Button | HTMLSpanElement) & Element
    ]) => value(t0).runNow()))
  
  inline def onAfterMenuDismiss(value: Callback): this.type = set("onAfterMenuDismiss", value.toJsFn)
  ...
  inline def onMenuClick(
    value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement] | ReactKeyboardEventFrom[HTMLElement]], /* button */ js.UndefOr[IButtonProps]) => Callback
  ): this.type = set("onMenuClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement] | ReactKeyboardEventFrom[HTMLElement]], t1: /* button */ js.UndefOr[IButtonProps]) => (value(t0, t1)).runNow()))
  ...
  inline def onRenderAriaDescription(
    value: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsJapgolly.react.mod.global.JSX.Element | Null
      ]
    ]) => typingsJapgolly.react.mod.global.JSX.Element | Null
  ): this.type = set("onRenderAriaDescription", js.Any.fromFunction2(value))
  
  inline def onRenderChildren(
    value: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsJapgolly.react.mod.global.JSX.Element | Null
  ...
  ): this.type = set("onRenderChildren", js.Any.fromFunction2(value))
  ...
  ): this.type = set("onRenderIcon", js.Any.fromFunction2(value))
  
  inline def onRenderMenu(
  ...
  ): this.type = set("onRenderMenu", js.Any.fromFunction2(value))
  
  inline def onRenderMenuIcon(
    value: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsJapgolly.react.mod.global.JSX.Element | Null
  ...
  ): this.type = set("onRenderMenuIcon", js.Any.fromFunction2(value))
  
  inline def onRenderText(
    value: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[
      js.Function1[
        /* props */ js.UndefOr[IButtonProps], 
        typingsJapgolly.react.mod.global.JSX.Element | Null
  ...
  ): this.type = set("onRenderText", js.Any.fromFunction2(value))
  ...
  inline def primaryActionButtonProps(value: IButtonProps): this.type = set("primaryActionButtonProps", value.asInstanceOf[js.Any])
  
  inline def primaryDisabled(value: Boolean): this.type = set("primaryDisabled", value.asInstanceOf[js.Any])
  ...
  inline def renderPersistedMenuHiddenOnMount(value: Boolean): this.type = set("renderPersistedMenuHiddenOnMount", value.asInstanceOf[js.Any])
  ...
  inline def rootProps(value: ButtonHTMLAttributes[HTMLButtonElement] | AnchorHTMLAttributes[HTMLAnchorElement]): this.type = set("rootProps", value.asInstanceOf[js.Any])
  ...
  inline def splitButtonAriaLabel(value: String): this.type = set("splitButtonAriaLabel", value.asInstanceOf[js.Any])
  
  inline def splitButtonMenuProps(value: IButtonProps): this.type = set("splitButtonMenuProps", value.asInstanceOf[js.Any])
  ...
  inline def styles(value: IButtonStyles): this.type = set("styles", value.asInstanceOf[js.Any])
  ...
  inline def toggled(value: Boolean): this.type = set("toggled", value.asInstanceOf[js.Any])
  ...
  inline def uniqueId(value: String | Double): this.type = set("uniqueId", value.asInstanceOf[js.Any])
