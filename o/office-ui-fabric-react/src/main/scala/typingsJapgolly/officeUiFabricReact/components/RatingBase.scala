...
import typingsJapgolly.officeUiFabricReact.libComponentsRatingRatingDottypesMod.IRating
import typingsJapgolly.officeUiFabricReact.libComponentsRatingRatingDottypesMod.IRatingProps
import typingsJapgolly.officeUiFabricReact.libComponentsRatingRatingDottypesMod.IRatingStarProps
import typingsJapgolly.officeUiFabricReact.libComponentsRatingRatingDottypesMod.IRatingStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsRatingRatingDottypesMod.IRatingStyles
import typingsJapgolly.officeUiFabricReact.libComponentsRatingRatingDottypesMod.RatingSize
...
object RatingBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.RatingBase] {
    ...
    inline def allowZeroStars(value: Boolean): this.type = set("allowZeroStars", value.asInstanceOf[js.Any])
    ...
    inline def ariaLabelId(value: String): this.type = set("ariaLabelId", value.asInstanceOf[js.Any])
    ...
    inline def componentRef(value: IRefObject[IRating]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IRating | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IRating | Null) => value(t0).runNow()))
    ...
    inline def getAriaLabel(value: (/* rating */ Double, /* max */ Double) => String): this.type = set("getAriaLabel", js.Any.fromFunction2(value))
    ...
    inline def onChange(value: (/* event */ ReactFocusEventFrom[HTMLElement], /* rating */ js.UndefOr[Double]) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactFocusEventFrom[HTMLElement], t1: /* rating */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
    
    inline def onChanged(value: /* rating */ Double => Callback): this.type = set("onChanged", js.Any.fromFunction1((t0: /* rating */ Double) => value(t0).runNow()))
    ...
    ): this.type = set("onRenderStar", js.Any.fromFunction2(value))
    ...
    inline def size(value: RatingSize): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IRatingStyleProps, IRatingStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IRatingStyleProps => DeepPartial[IRatingStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    ...
    inline def unselectedIcon(value: String): this.type = set("unselectedIcon", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: RatingBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IRatingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
