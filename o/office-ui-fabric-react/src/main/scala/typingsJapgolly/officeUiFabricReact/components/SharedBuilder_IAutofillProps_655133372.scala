...
@scala.inline
open class SharedBuilder_IAutofillProps_655133372[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def componentRef(value: IRefObject[IAutofill]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IAutofill | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IAutofill | Null) => value(t0).runNow()))
  ...
  inline def defaultVisibleValue(value: String): this.type = set("defaultVisibleValue", value.asInstanceOf[js.Any])
  ...
  inline def enableAutofillOnKeyPress(value: js.Array[KeyCodes]): this.type = set("enableAutofillOnKeyPress", value.asInstanceOf[js.Any])
  
  inline def enableAutofillOnKeyPressVarargs(value: KeyCodes*): this.type = set("enableAutofillOnKeyPress", js.Array(value*))
  ...
  inline def onAbort(
    value: ReactEventFrom[
      (HTMLInputElement | typingsJapgolly.officeUiFabricReact.libComponentsAutofillAutofillMod.Autofill) & Element
    ] => Callback
  ...
  inline def onInputChange(value: (/* value */ String, /* composing */ Boolean) => String): this.type = set("onInputChange", js.Any.fromFunction2(value))
  
  inline def onInputValueChange(value: (/* newValue */ js.UndefOr[String], /* composing */ js.UndefOr[Boolean]) => Callback): this.type = set("onInputValueChange", js.Any.fromFunction2((t0: /* newValue */ js.UndefOr[String], t1: /* composing */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
  ...
  inline def preventValueSelection(value: Boolean): this.type = set("preventValueSelection", value.asInstanceOf[js.Any])
  ...
  inline def shouldSelectFullInputValueInComponentDidUpdate(value: CallbackTo[Boolean]): this.type = set("shouldSelectFullInputValueInComponentDidUpdate", value.toJsFn)
  ...
  inline def suggestedDisplayValue(value: String): this.type = set("suggestedDisplayValue", value.asInstanceOf[js.Any])
  ...
  inline def updateValueInWillReceiveProps(value: CallbackTo[String | Null]): this.type = set("updateValueInWillReceiveProps", value.toJsFn)
