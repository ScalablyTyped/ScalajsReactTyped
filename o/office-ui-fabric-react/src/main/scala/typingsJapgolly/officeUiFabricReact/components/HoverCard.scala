...
import typingsJapgolly.officeUiFabricReact.hoverCardTypesMod.HoverCardType
import typingsJapgolly.officeUiFabricReact.hoverCardTypesMod.IHoverCard
import typingsJapgolly.officeUiFabricReact.hoverCardTypesMod.IHoverCardProps
import typingsJapgolly.officeUiFabricReact.hoverCardTypesMod.IHoverCardStyleProps
import typingsJapgolly.officeUiFabricReact.hoverCardTypesMod.IHoverCardStyles
...
object HoverCard {
  def apply(
    ...
    onCardExpand: js.UndefOr[Callback] = js.undefined,
    onCardHide: js.UndefOr[Callback] = js.undefined,
    onCardVisible: js.UndefOr[Callback] = js.undefined,
    ...
    shouldBlockHoverCard: js.UndefOr[Callback] = js.undefined,
    slot: String = null,
    ...
    IHoverCardProps, 
    MountedWithRawType[IHoverCardProps, js.Object, RawMounted[IHoverCardProps, js.Object]]
  ] = {
    ...
    if (expandingCardProps != null) __obj.updateDynamic("expandingCardProps")(expandingCardProps.asInstanceOf[js.Any])
    if (!js.isUndefined(hidden)) __obj.updateDynamic("hidden")(hidden.asInstanceOf[js.Any])
    if (id != null) __obj.updateDynamic("id")(id.asInstanceOf[js.Any])
    if (inlist != null) __obj.updateDynamic("inlist")(inlist.asInstanceOf[js.Any])
    if (inputMode != null) __obj.updateDynamic("inputMode")(inputMode.asInstanceOf[js.Any])
    if (!js.isUndefined(instantOpenOnClick)) __obj.updateDynamic("instantOpenOnClick")(instantOpenOnClick.asInstanceOf[js.Any])
    ...
    onCardExpand.foreach(p => __obj.updateDynamic("onCardExpand")(p.toJsFn))
    onCardHide.foreach(p => __obj.updateDynamic("onCardHide")(p.toJsFn))
    onCardVisible.foreach(p => __obj.updateDynamic("onCardVisible")(p.toJsFn))
    ...
    if (plainCardProps != null) __obj.updateDynamic("plainCardProps")(plainCardProps.asInstanceOf[js.Any])
    ...
    shouldBlockHoverCard.foreach(p => __obj.updateDynamic("shouldBlockHoverCard")(p.toJsFn))
  ...
  typingsJapgolly.officeUiFabricReact.hoverCardTypesMod.IHoverCardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.hoverCardTypesMod.IHoverCardProps])(children: _*)
  }
