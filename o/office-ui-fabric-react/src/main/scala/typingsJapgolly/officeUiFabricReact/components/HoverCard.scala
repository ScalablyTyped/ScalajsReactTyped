...
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardHoverCardDottypesMod.HoverCardType
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardHoverCardDottypesMod.IHoverCard
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardHoverCardDottypesMod.IHoverCardProps
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardHoverCardDottypesMod.IHoverCardStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardHoverCardDottypesMod.IHoverCardStyles
...
object HoverCard {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def cardDismissDelay(value: Double): this.type = set("cardDismissDelay", value.asInstanceOf[js.Any])
    
    inline def cardOpenDelay(value: Double): this.type = set("cardOpenDelay", value.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def componentRef(value: IRefObject[IHoverCard]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IHoverCard | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IHoverCard | Null) => value(t0).runNow()))
    ...
    inline def eventListenerTarget(value: HTMLElement | String): this.type = set("eventListenerTarget", value.asInstanceOf[js.Any])
    
    inline def eventListenerTargetNull: this.type = set("eventListenerTarget", null)
    
    inline def expandedCardOpenDelay(value: Double): this.type = set("expandedCardOpenDelay", value.asInstanceOf[js.Any])
    
    inline def expandingCardProps(value: IExpandingCardProps): this.type = set("expandingCardProps", value.asInstanceOf[js.Any])
    ...
    inline def instantOpenOnClick(value: Boolean): this.type = set("instantOpenOnClick", value.asInstanceOf[js.Any])
    ...
    inline def onCardExpand(value: Callback): this.type = set("onCardExpand", value.toJsFn)
    
    inline def onCardHide(value: Callback): this.type = set("onCardHide", value.toJsFn)
    
    inline def onCardVisible(value: Callback): this.type = set("onCardVisible", value.toJsFn)
    ...
    inline def openHotKey(value: KeyCodes): this.type = set("openHotKey", value.asInstanceOf[js.Any])
    
    inline def placeholder(value: String): this.type = set("placeholder", value.asInstanceOf[js.Any])
    
    inline def plainCardProps(value: IPlainCardProps): this.type = set("plainCardProps", value.asInstanceOf[js.Any])
    ...
    inline def setAriaDescribedBy(value: Boolean): this.type = set("setAriaDescribedBy", value.asInstanceOf[js.Any])
    
    inline def setInitialFocus(value: Boolean): this.type = set("setInitialFocus", value.asInstanceOf[js.Any])
    
    inline def shouldBlockHoverCard(value: Callback): this.type = set("shouldBlockHoverCard", value.toJsFn)
    ...
    inline def styles(value: IStyleFunctionOrObject[IHoverCardStyleProps, IHoverCardStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IHoverCardStyleProps => DeepPartial[IHoverCardStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    ...
    inline def trapFocus(value: Boolean): this.type = set("trapFocus", value.asInstanceOf[js.Any])
    
    inline def `type`(value: HoverCardType): this.type = set("type", value.asInstanceOf[js.Any])
