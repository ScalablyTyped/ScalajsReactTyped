...
object SearchBoxFullSizeExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.searchBoxFullSizeExampleMod.SearchBoxFullSizeExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.searchBoxFullSizeExampleMod.SearchBoxFullSizeExample](this.componentImport)
