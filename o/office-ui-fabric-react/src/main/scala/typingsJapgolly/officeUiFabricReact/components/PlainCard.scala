...
import typingsJapgolly.officeUiFabricReact.plainCardTypesMod.IPlainCard
import typingsJapgolly.officeUiFabricReact.plainCardTypesMod.IPlainCardProps
import typingsJapgolly.officeUiFabricReact.plainCardTypesMod.IPlainCardStyleProps
...
object PlainCard {
  def apply(
    ...
    color: String = null,
    componentRef: IRefObject[IPlainCard] = null,
    ...
    onRenderPlainCard: (/* props */ js.UndefOr[js.Any], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[js.Any], Element | Null]]) => CallbackTo[Element | Null] = null,
  ...
  {[ P in keyof TStyles ]: @uifabric/merge-styles.@uifabric/merge-styles/lib/IStyle.IStyle}
    */ IBaseCardProps with js.Any
    ...
    IPlainCardProps, 
    MountedWithRawType[IPlainCardProps, js.Object, RawMounted[IPlainCardProps, js.Object]]
  ] = {
    ...
    if (onRenderPlainCard != null) __obj.updateDynamic("onRenderPlainCard")(js.Any.fromFunction2((t0: /* props */ js.UndefOr[js.Any], t1: /* defaultRender */ js.UndefOr[
  js.Function1[
    /* props */ js.UndefOr[js.Any], 
    japgolly.scalajs.react.raw.React.Element | scala.Null
  ]]) => onRenderPlainCard(t0, t1).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.plainCardTypesMod.IPlainCardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.plainCardTypesMod.IPlainCardProps])(children: _*)
  }
