...
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardPlainCardPlainCardDottypesMod.IPlainCard
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardPlainCardPlainCardDottypesMod.IPlainCardProps
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardPlainCardPlainCardDottypesMod.IPlainCardStyleProps
...
object PlainCard {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def componentRef(value: IRefObject[IPlainCard]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IPlainCard | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IPlainCard | Null) => value(t0).runNow()))
    ...
    ): this.type = set("onRenderPlainCard", js.Any.fromFunction2(value))
    ...
    inline def stylesFunction1(
      value: IPlainCardStyleProps => DeepPartial[
          /* import warning: importer.ImportType#apply Failed type conversion: {[ P in keyof TStyles ]: @uifabric/merge-styles.@uifabric/merge-styles/lib/IStyle.IStyle} */ js.Any
        ]
  ...
  implicit def make(companion: PlainCard.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: IPlainCardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
