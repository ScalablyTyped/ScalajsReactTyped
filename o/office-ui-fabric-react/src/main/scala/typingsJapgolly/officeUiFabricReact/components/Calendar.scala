...
object Calendar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.Calendar] {
    ...
    inline def autoNavigateOnSelection(value: Boolean): this.type = set("autoNavigateOnSelection", value.asInstanceOf[js.Any])
    ...
    inline def componentRef(value: IRefObject[ICalendar]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ICalendar | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ICalendar | Null) => value(t0).runNow()))
    ...
    inline def dateRangeType(value: DateRangeType): this.type = set("dateRangeType", value.asInstanceOf[js.Any])
    ...
    inline def isDayPickerVisible(value: Boolean): this.type = set("isDayPickerVisible", value.asInstanceOf[js.Any])
    ...
    inline def onSelectDate(
      value: (/* date */ js.Date, /* selectedDateRangeArray */ js.UndefOr[js.Array[js.Date]]) => Callback
    ): this.type = set("onSelectDate", js.Any.fromFunction2((t0: /* date */ js.Date, t1: /* selectedDateRangeArray */ js.UndefOr[js.Array[js.Date]]) => (value(t0, t1)).runNow()))
    ...
    inline def selectDateOnClick(value: Boolean): this.type = set("selectDateOnClick", value.asInstanceOf[js.Any])
    ...
    inline def strings(value: ICalendarStrings): this.type = set("strings", value.asInstanceOf[js.Any])
    
    inline def stringsNull: this.type = set("strings", null)
