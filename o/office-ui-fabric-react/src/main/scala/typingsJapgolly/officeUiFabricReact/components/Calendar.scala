...
object Calendar {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ICalendarProps, typingsJapgolly.officeUiFabricReact.mod.Calendar, Unit, ICalendarProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.calendarTypesMod.ICalendarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.Calendar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.calendarTypesMod.ICalendarProps])(children: _*)
  }
