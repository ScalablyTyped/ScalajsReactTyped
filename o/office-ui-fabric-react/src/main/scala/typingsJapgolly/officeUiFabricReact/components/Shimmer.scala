...
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerDottypesMod.IShimmer
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerDottypesMod.IShimmerColors
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerDottypesMod.IShimmerElement
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerDottypesMod.IShimmerProps
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerDottypesMod.IShimmerStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerDottypesMod.IShimmerStyles
...
object Shimmer {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def componentRef(value: IRefObject[IShimmer]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IShimmer | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmer | Null) => value(t0).runNow()))
    ...
    inline def customElementsGroup(value: VdomNode): this.type = set("customElementsGroup", value.rawNode.asInstanceOf[js.Any])
    
    inline def customElementsGroupNull: this.type = set("customElementsGroup", null)
    
    inline def customElementsGroupVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("customElementsGroup", js.Array(value*))
    
    inline def customElementsGroupVdomElement(value: VdomElement): this.type = set("customElementsGroup", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def isDataLoaded(value: Boolean): this.type = set("isDataLoaded", value.asInstanceOf[js.Any])
    ...
    inline def shimmerColors(value: IShimmerColors): this.type = set("shimmerColors", value.asInstanceOf[js.Any])
    
    inline def shimmerElements(value: js.Array[IShimmerElement]): this.type = set("shimmerElements", value.asInstanceOf[js.Any])
    
    inline def shimmerElementsVarargs(value: IShimmerElement*): this.type = set("shimmerElements", js.Array(value*))
    ...
    inline def styles(value: IStyleFunctionOrObject[IShimmerStyleProps, IShimmerStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IShimmerStyleProps => DeepPartial[IShimmerStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: Shimmer.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
