...
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardExpandingCardDottypesMod.ExpandingCardMode
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardExpandingCardDottypesMod.IExpandingCard
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardExpandingCardDottypesMod.IExpandingCardProps
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardExpandingCardDottypesMod.IExpandingCardStyleProps
...
object ExpandingCard {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def compactCardHeight(value: Double): this.type = set("compactCardHeight", value.asInstanceOf[js.Any])
    
    inline def componentRef(value: IRefObject[IExpandingCard]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IExpandingCard | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IExpandingCard | Null) => value(t0).runNow()))
    ...
    inline def expandedCardHeight(value: Double): this.type = set("expandedCardHeight", value.asInstanceOf[js.Any])
    
    inline def firstFocus(value: Boolean): this.type = set("firstFocus", value.asInstanceOf[js.Any])
    ...
    inline def mode(value: ExpandingCardMode): this.type = set("mode", value.asInstanceOf[js.Any])
    ...
    inline def onEnter(value: /* ev */ js.UndefOr[Any] => Callback): this.type = set("onEnter", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def onLeave(value: /* ev */ js.UndefOr[Any] => Callback): this.type = set("onLeave", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def onRenderCompactCard(
      value: (/* props */ js.UndefOr[Any], /* defaultRender */ js.UndefOr[
          js.Function1[/* props */ js.UndefOr[Any], typingsJapgolly.react.mod.global.JSX.Element | Null]
        ]) => typingsJapgolly.react.mod.global.JSX.Element | Null
    ): this.type = set("onRenderCompactCard", js.Any.fromFunction2(value))
    
    inline def onRenderExpandedCard(
      value: (/* props */ js.UndefOr[Any], /* defaultRender */ js.UndefOr[
          js.Function1[/* props */ js.UndefOr[Any], typingsJapgolly.react.mod.global.JSX.Element | Null]
        ]) => typingsJapgolly.react.mod.global.JSX.Element | Null
    ...
    inline def renderData(value: Any): this.type = set("renderData", value.asInstanceOf[js.Any])
