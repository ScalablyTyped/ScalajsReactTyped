...
import typingsJapgolly.officeUiFabricReact.expandingCardTypesMod.ExpandingCardMode
import typingsJapgolly.officeUiFabricReact.expandingCardTypesMod.IExpandingCard
import typingsJapgolly.officeUiFabricReact.expandingCardTypesMod.IExpandingCardProps
import typingsJapgolly.officeUiFabricReact.expandingCardTypesMod.IExpandingCardStyleProps
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.IBaseCardProps
...
object ExpandingCard {
  def apply(
    ...
    onRenderCompactCard: (/* props */ js.UndefOr[js.Any], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[js.Any], Element | Null]]) => CallbackTo[Element | Null] = null,
    onRenderExpandedCard: (/* props */ js.UndefOr[js.Any], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[js.Any], Element | Null]]) => CallbackTo[Element | Null] = null,
  ...
  {[ P in keyof TStyles ]: @uifabric/merge-styles.@uifabric/merge-styles/lib/IStyle.IStyle}
    */ IBaseCardProps with js.Any
    ...
    IExpandingCardProps, 
    MountedWithRawType[IExpandingCardProps, js.Object, RawMounted[IExpandingCardProps, js.Object]]
  ] = {
    ...
    if (onRenderCompactCard != null) __obj.updateDynamic("onRenderCompactCard")(js.Any.fromFunction2((t0: /* props */ js.UndefOr[js.Any], t1: /* defaultRender */ js.UndefOr[
  js.Function1[
    /* props */ js.UndefOr[js.Any], 
    japgolly.scalajs.react.raw.React.Element | scala.Null
  ]]) => onRenderCompactCard(t0, t1).runNow()))
    if (onRenderExpandedCard != null) __obj.updateDynamic("onRenderExpandedCard")(js.Any.fromFunction2((t0: /* props */ js.UndefOr[js.Any], t1: /* defaultRender */ js.UndefOr[
  js.Function1[
    /* props */ js.UndefOr[js.Any], 
    japgolly.scalajs.react.raw.React.Element | scala.Null
  ]]) => onRenderExpandedCard(t0, t1).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.expandingCardTypesMod.IExpandingCardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.expandingCardTypesMod.IExpandingCardProps])(children: _*)
  }
