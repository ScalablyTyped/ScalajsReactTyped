...
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerElementsGroupShimmerElementsGroupDottypesMod.IShimmerElementsGroup
...
@scala.inline
open class SharedBuilder_IShimmerElementsGroupProps_1570679509 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def componentRef(value: IRefObject[IShimmerElementsGroup]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IShimmerElementsGroup | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmerElementsGroup | Null) => value(t0).runNow()))
  ...
  inline def flexWrap(value: Boolean): this.type = set("flexWrap", value.asInstanceOf[js.Any])
  ...
  inline def styles(value: IStyleFunctionOrObject[IShimmerElementsGroupStyleProps, IShimmerElementsGroupStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: IShimmerElementsGroupStyleProps => DeepPartial[IShimmerElementsGroupStyles]): this.type = set("styles", js.Any.fromFunction1(value))
