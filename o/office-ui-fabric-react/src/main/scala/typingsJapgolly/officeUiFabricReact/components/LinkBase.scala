...
import typingsJapgolly.officeUiFabricReact.libComponentsLinkLinkDottypesMod.ILink
import typingsJapgolly.officeUiFabricReact.libComponentsLinkLinkDottypesMod.ILinkProps
import typingsJapgolly.officeUiFabricReact.libComponentsLinkLinkDottypesMod.ILinkStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsLinkLinkDottypesMod.ILinkStyles
...
object LinkBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.LinkBase] {
    ...
    inline def as(value: String | ComponentClassP[js.Object] | FunctionComponent[js.Object]): this.type = set("as", value.asInstanceOf[js.Any])
    ...
    inline def componentRef(value: IRefObject[ILink]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ILink | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ILink | Null) => value(t0).runNow()))
    ...
    inline def onAbort(
      value: ReactEventFrom[
          (HTMLAnchorElement | HTMLButtonElement | HTMLElement | typingsJapgolly.officeUiFabricReact.libComponentsLinkLinkDotbaseMod.LinkBase) & Element
        ] => Callback
    ...
    inline def styles(value: IStyleFunctionOrObject[ILinkStyleProps, ILinkStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: ILinkStyleProps => DeepPartial[ILinkStyles]): this.type = set("styles", js.Any.fromFunction1(value))
