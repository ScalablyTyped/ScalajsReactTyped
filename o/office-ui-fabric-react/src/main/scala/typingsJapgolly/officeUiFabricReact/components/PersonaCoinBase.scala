...
import typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaCoinStyles
...
object PersonaCoinBase {
  def apply(
    ...
    IPersonaCoinProps, 
    typingsJapgolly.officeUiFabricReact.mod.PersonaCoinBase, 
    Unit, 
    IPersonaCoinProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaCoinProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.PersonaCoinBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaCoinProps])(children: _*)
  }
