...
object PivotTabsExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.pivotTabsExampleMod.PivotTabsExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.pivotTabsExampleMod.PivotTabsExample](this.componentImport)
