...
import typingsJapgolly.officeUiFabricReact.commandBarTypesMod.ICommandBar
...
import typingsJapgolly.officeUiFabricReact.commandBarTypesMod.ICommandBarStyleProps
import typingsJapgolly.officeUiFabricReact.commandBarTypesMod.ICommandBarStyles
...
object CommandBarBase {
  def apply(
    ...
    ICommandBarProps, 
    typingsJapgolly.officeUiFabricReact.mod.CommandBarBase, 
    Unit, 
    ICommandBarProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.commandBarTypesMod.ICommandBarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.CommandBarBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.commandBarTypesMod.ICommandBarProps])(children: _*)
  }
