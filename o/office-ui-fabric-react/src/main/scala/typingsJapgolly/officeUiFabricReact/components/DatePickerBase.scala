...
import typingsJapgolly.officeUiFabricReact.libComponentsDatePickerDatePickerDottypesMod.IDatePicker
import typingsJapgolly.officeUiFabricReact.libComponentsDatePickerDatePickerDottypesMod.IDatePickerProps
import typingsJapgolly.officeUiFabricReact.libComponentsDatePickerDatePickerDottypesMod.IDatePickerStrings
import typingsJapgolly.officeUiFabricReact.libComponentsDatePickerDatePickerDottypesMod.IDatePickerStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsDatePickerDatePickerDottypesMod.IDatePickerStyles
...
object DatePickerBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.DatePickerBase] {
    ...
    inline def allowTextInput(value: Boolean): this.type = set("allowTextInput", value.asInstanceOf[js.Any])
    ...
    inline def calendarAs(value: IComponentAs[ICalendarProps]): this.type = set("calendarAs", value.asInstanceOf[js.Any])
    
    inline def calendarProps(value: ICalendarProps): this.type = set("calendarProps", value.asInstanceOf[js.Any])
    ...
    inline def componentRef(value: IRefObject[IDatePicker]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IDatePicker | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IDatePicker | Null) => value(t0).runNow()))
    ...
    inline def dateTimeFormatter(value: ICalendarFormatDateCallbacks): this.type = set("dateTimeFormatter", value.asInstanceOf[js.Any])
    ...
    inline def firstDayOfWeek(value: DayOfWeek): this.type = set("firstDayOfWeek", value.asInstanceOf[js.Any])
    
    inline def firstWeekOfYear(value: FirstWeekOfYear): this.type = set("firstWeekOfYear", value.asInstanceOf[js.Any])
    
    inline def formatDate(value: /* date */ js.UndefOr[js.Date] => String): this.type = set("formatDate", js.Any.fromFunction1(value))
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def highlightCurrentMonth(value: Boolean): this.type = set("highlightCurrentMonth", value.asInstanceOf[js.Any])
    
    inline def highlightSelectedMonth(value: Boolean): this.type = set("highlightSelectedMonth", value.asInstanceOf[js.Any])
    
    inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    
    inline def initialPickerDate(value: js.Date): this.type = set("initialPickerDate", value.asInstanceOf[js.Any])
    ...
    inline def isMonthPickerVisible(value: Boolean): this.type = set("isMonthPickerVisible", value.asInstanceOf[js.Any])
    ...
    inline def onSelectDate(value: /* date */ js.UndefOr[js.Date | Null] => Callback): this.type = set("onSelectDate", js.Any.fromFunction1((t0: /* date */ js.UndefOr[js.Date | Null]) => value(t0).runNow()))
    ...
    inline def parseDateFromString(value: /* dateStr */ String => js.Date | Null): this.type = set("parseDateFromString", js.Any.fromFunction1(value))
    
    inline def pickerAriaLabel(value: String): this.type = set("pickerAriaLabel", value.asInstanceOf[js.Any])
    ...
    inline def showGoToToday(value: Boolean): this.type = set("showGoToToday", value.asInstanceOf[js.Any])
    
    inline def showMonthPickerAsOverlay(value: Boolean): this.type = set("showMonthPickerAsOverlay", value.asInstanceOf[js.Any])
    ...
    inline def strings(value: IDatePickerStrings): this.type = set("strings", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSProperties): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def styles(value: IStyleFunctionOrObject[IDatePickerStyleProps, IDatePickerStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IDatePickerStyleProps => DeepPartial[IDatePickerStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    ...
    inline def textField(value: ITextFieldProps): this.type = set("textField", value.asInstanceOf[js.Any])
