...
import typingsJapgolly.officeUiFabricReact.datePickerTypesMod.IDatePicker
import typingsJapgolly.officeUiFabricReact.datePickerTypesMod.IDatePickerProps
import typingsJapgolly.officeUiFabricReact.datePickerTypesMod.IDatePickerStrings
import typingsJapgolly.officeUiFabricReact.datePickerTypesMod.IDatePickerStyleProps
import typingsJapgolly.officeUiFabricReact.datePickerTypesMod.IDatePickerStyles
...
object DatePickerBase {
  def apply(
    ...
    formatDate: /* date */ js.UndefOr[js.Date] => CallbackTo[String] = null,
    ...
    onSelectDate: /* date */ js.UndefOr[js.Date | Null] => Callback = null,
    ...
    parseDateFromString: /* dateStr */ String => CallbackTo[js.Date | Null] = null,
    ...
    IDatePickerProps, 
    typingsJapgolly.officeUiFabricReact.mod.DatePickerBase, 
    Unit, 
    IDatePickerProps
  ] = {
    ...
    if (formatDate != null) __obj.updateDynamic("formatDate")(js.Any.fromFunction1((t0: /* date */ js.UndefOr[js.Date]) => formatDate(t0).runNow()))
    ...
    if (onSelectDate != null) __obj.updateDynamic("onSelectDate")(js.Any.fromFunction1((t0: /* date */ js.UndefOr[js.Date | scala.Null]) => onSelectDate(t0).runNow()))
    ...
    if (parseDateFromString != null) __obj.updateDynamic("parseDateFromString")(js.Any.fromFunction1((t0: /* dateStr */ java.lang.String) => parseDateFromString(t0).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.datePickerTypesMod.IDatePickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.DatePickerBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.datePickerTypesMod.IDatePickerProps])(children: _*)
  }
