...
@scala.inline
open class SharedBuilder_ITagItemSuggestionProps1155745662 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def styles(value: IStyleFunctionOrObject[ITagItemSuggestionStyleProps, ITagItemSuggestionStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: ITagItemSuggestionStyleProps => DeepPartial[ITagItemSuggestionStyles]): this.type = set("styles", js.Any.fromFunction1(value))
