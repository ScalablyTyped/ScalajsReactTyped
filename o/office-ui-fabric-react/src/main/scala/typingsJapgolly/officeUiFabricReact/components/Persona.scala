...
object Persona {
  ...
  implicit def make(companion: Persona.type): SharedBuilder_IPersonaProps_1396355299 = new SharedBuilder_IPersonaProps_1396355299(js.Array(this.component, js.Dictionary.empty))()
