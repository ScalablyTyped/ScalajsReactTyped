...
object BaseSelectedItemsList {
  ...
  @scala.inline
  open class Builder[T, P /* <: IBaseSelectedItemsListProps[T] */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.BaseSelectedItemsList[T, P]]
