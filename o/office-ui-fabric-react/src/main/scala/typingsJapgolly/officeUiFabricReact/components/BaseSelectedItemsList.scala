...
object BaseSelectedItemsList {
  def apply[T, P /* <: IBaseSelectedItemsListProps[T] */](
    ...
    P with js.Object, 
    typingsJapgolly.officeUiFabricReact.mod.BaseSelectedItemsList[T, P], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.mod.BaseSelectedItemsList[T, P]](this.componentImport)
