...
import typingsJapgolly.officeUiFabricReact.libComponentsBreadcrumbBreadcrumbDottypesMod.IBreadcrumb
import typingsJapgolly.officeUiFabricReact.libComponentsBreadcrumbBreadcrumbDottypesMod.IBreadcrumbData
import typingsJapgolly.officeUiFabricReact.libComponentsBreadcrumbBreadcrumbDottypesMod.IBreadcrumbItem
import typingsJapgolly.officeUiFabricReact.libComponentsBreadcrumbBreadcrumbDottypesMod.IBreadcrumbProps
import typingsJapgolly.officeUiFabricReact.libComponentsBreadcrumbBreadcrumbDottypesMod.IBreadcrumbStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsBreadcrumbBreadcrumbDottypesMod.IBreadcrumbStyles
import typingsJapgolly.officeUiFabricReact.libComponentsBreadcrumbBreadcrumbDottypesMod.IDividerAsProps
...
object BreadcrumbBase {
  ...
  inline def apply(items: js.Array[IBreadcrumbItem]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.BreadcrumbBase] {
    ...
    inline def componentRef(value: IRefObject[IBreadcrumb]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IBreadcrumb | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IBreadcrumb | Null) => value(t0).runNow()))
    ...
    inline def dividerAs(value: IComponentAs[IDividerAsProps]): this.type = set("dividerAs", value.asInstanceOf[js.Any])
    ...
    inline def maxDisplayedItems(value: Double): this.type = set("maxDisplayedItems", value.asInstanceOf[js.Any])
    ...
    inline def onGrowData(value: /* data */ IBreadcrumbData => js.UndefOr[IBreadcrumbData]): this.type = set("onGrowData", js.Any.fromFunction1(value))
    ...
    inline def onReduceData(value: /* data */ IBreadcrumbData => js.UndefOr[IBreadcrumbData]): this.type = set("onReduceData", js.Any.fromFunction1(value))
    
    inline def onRenderItem(
      value: (/* props */ js.UndefOr[IBreadcrumbItem], /* defaultRender */ js.UndefOr[
          js.Function1[
    ...
    inline def onRenderItemContent(
      value: (/* props */ js.UndefOr[IBreadcrumbItem], /* defaultRender */ js.UndefOr[
          js.Function1[
            /* props */ js.UndefOr[IBreadcrumbItem], 
            typingsJapgolly.react.mod.global.JSX.Element | Null
    ...
    ): this.type = set("onRenderItemContent", js.Any.fromFunction2(value))
    
    inline def onRenderOverflowIcon(
    ...
    ): this.type = set("onRenderOverflowIcon", js.Any.fromFunction2(value))
    ...
    inline def overflowAriaLabel(value: String): this.type = set("overflowAriaLabel", value.asInstanceOf[js.Any])
    
    inline def overflowButtonAs(value: IComponentAs[IButtonProps]): this.type = set("overflowButtonAs", value.asInstanceOf[js.Any])
    
    inline def overflowIndex(value: Double): this.type = set("overflowIndex", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IBreadcrumbStyleProps, IBreadcrumbStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IBreadcrumbStyleProps => DeepPartial[IBreadcrumbStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    ...
    inline def tooltipHostProps(value: ITooltipHostProps): this.type = set("tooltipHostProps", value.asInstanceOf[js.Any])
