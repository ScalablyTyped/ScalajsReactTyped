...
import typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumb
import typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbData
import typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbItem
import typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbProps
import typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbStyleProps
import typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbStyles
import typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IDividerAsProps
...
object BreadcrumbBase {
  def apply(
    ...
    onReduceData: /* data */ IBreadcrumbData => CallbackTo[js.UndefOr[IBreadcrumbData]] = null,
    onRenderItem: (/* props */ js.UndefOr[IBreadcrumbItem], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IBreadcrumbItem], Element | Null]]) => CallbackTo[Element | Null] = null,
    onRenderOverflowIcon: (/* props */ js.UndefOr[IButtonProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IButtonProps], Element | Null]]) => CallbackTo[Element | Null] = null,
    ...
    IBreadcrumbProps, 
    typingsJapgolly.officeUiFabricReact.mod.BreadcrumbBase, 
    Unit, 
    IBreadcrumbProps
  ] = {
    ...
    if (onReduceData != null) __obj.updateDynamic("onReduceData")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbData) => onReduceData(t0).runNow()))
    if (onRenderItem != null) __obj.updateDynamic("onRenderItem")(js.Any.fromFunction2((t0: /* props */ js.UndefOr[typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbItem], t1: /* defaultRender */ js.UndefOr[
  js.Function1[
    /* props */ js.UndefOr[typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbItem], 
    japgolly.scalajs.react.raw.React.Element | scala.Null
  ]]) => onRenderItem(t0, t1).runNow()))
    if (onRenderOverflowIcon != null) __obj.updateDynamic("onRenderOverflowIcon")(js.Any.fromFunction2((t0: /* props */ js.UndefOr[typingsJapgolly.officeUiFabricReact.buttonTypesMod.IButtonProps], t1: /* defaultRender */ js.UndefOr[
  js.Function1[
    /* props */ js.UndefOr[typingsJapgolly.officeUiFabricReact.buttonTypesMod.IButtonProps], 
    japgolly.scalajs.react.raw.React.Element | scala.Null
  ]]) => onRenderOverflowIcon(t0, t1).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.BreadcrumbBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.breadcrumbTypesMod.IBreadcrumbProps])(children: _*)
  }
