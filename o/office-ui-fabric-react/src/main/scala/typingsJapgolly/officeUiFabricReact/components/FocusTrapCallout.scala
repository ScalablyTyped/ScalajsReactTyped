...
object FocusTrapCallout {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def calloutMaxHeight(value: Double): this.type = set("calloutMaxHeight", value.asInstanceOf[js.Any])
    
    inline def calloutMaxWidth(value: Double): this.type = set("calloutMaxWidth", value.asInstanceOf[js.Any])
    
    inline def calloutMinWidth(value: Double): this.type = set("calloutMinWidth", value.asInstanceOf[js.Any])
    ...
    inline def dismissOnTargetClick(value: Boolean): this.type = set("dismissOnTargetClick", value.asInstanceOf[js.Any])
    ...
    inline def focusTrapProps(value: IFocusTrapZoneProps): this.type = set("focusTrapProps", value.asInstanceOf[js.Any])
    ...
    inline def onPositioned(value: /* positions */ js.UndefOr[ICalloutPositionedInfo] => Callback): this.type = set("onPositioned", js.Any.fromFunction1((t0: /* positions */ js.UndefOr[ICalloutPositionedInfo]) => value(t0).runNow()))
    ...
    inline def onScroll(value: Callback): this.type = set("onScroll", value.toJsFn)
    ...
    inline def preventDismissOnEvent(
    ...
    inline def preventDismissOnResize(value: Boolean): this.type = set("preventDismissOnResize", value.asInstanceOf[js.Any])
    ...
    inline def shouldDismissOnWindowFocus(value: Boolean): this.type = set("shouldDismissOnWindowFocus", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[ICalloutContentStyleProps, ICalloutContentStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: ICalloutContentStyleProps => DeepPartial[ICalloutContentStyles]): this.type = set("styles", js.Any.fromFunction1(value))
