...
object ColorRectangleBase {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.colorRectangleBaseMod.ColorRectangleBase, 
    Unit, 
    IColorRectangleProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.colorRectangleBaseMod.ColorRectangleBase](this.componentImport)
