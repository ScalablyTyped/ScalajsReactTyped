...
import typingsJapgolly.officeUiFabricReact.PickIIconPropsExcludekeyo
import typingsJapgolly.officeUiFabricReact.buttonTypesMod.IButtonProps
import typingsJapgolly.officeUiFabricReact.searchBoxTypesMod.ISearchBox
import typingsJapgolly.officeUiFabricReact.searchBoxTypesMod.ISearchBoxProps
import typingsJapgolly.officeUiFabricReact.searchBoxTypesMod.ISearchBoxStyleProps
import typingsJapgolly.officeUiFabricReact.searchBoxTypesMod.ISearchBoxStyles
...
object SearchBoxBase {
  def apply(
    ...
    onChange: (/* event */ js.UndefOr[ReactEventFrom[HTMLInputElement]], /* newValue */ js.UndefOr[String]) => Callback = null,
    onChanged: /* newValue */ js.Any => Callback = null,
    onClear: /* ev */ js.UndefOr[js.Any] => Callback = null,
    ...
    onEscape: /* ev */ js.UndefOr[js.Any] => Callback = null,
    ...
    onSearch: /* newValue */ js.Any => Callback = null,
    ...
    ISearchBoxProps, 
    typingsJapgolly.officeUiFabricReact.mod.SearchBoxBase, 
    Unit, 
    ISearchBoxProps
  ] = {
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ js.UndefOr[japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement]], t1: /* newValue */ js.UndefOr[java.lang.String]) => onChange(t0, t1).runNow()))
    if (onChanged != null) __obj.updateDynamic("onChanged")(js.Any.fromFunction1((t0: /* newValue */ js.Any) => onChanged(t0).runNow()))
    if (onClear != null) __obj.updateDynamic("onClear")(js.Any.fromFunction1((t0: /* ev */ js.UndefOr[js.Any]) => onClear(t0).runNow()))
    ...
    if (onEscape != null) __obj.updateDynamic("onEscape")(js.Any.fromFunction1((t0: /* ev */ js.UndefOr[js.Any]) => onEscape(t0).runNow()))
    ...
    if (onSearch != null) __obj.updateDynamic("onSearch")(js.Any.fromFunction1((t0: /* newValue */ js.Any) => onSearch(t0).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.searchBoxTypesMod.ISearchBoxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.SearchBoxBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.searchBoxTypesMod.ISearchBoxProps])(children: _*)
  }
