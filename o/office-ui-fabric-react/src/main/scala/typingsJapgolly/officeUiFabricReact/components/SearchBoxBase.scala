...
import typingsJapgolly.officeUiFabricReact.anon.PickIIconPropsExcludekeyo
import typingsJapgolly.officeUiFabricReact.libComponentsButtonButtonDottypesMod.IButtonProps
import typingsJapgolly.officeUiFabricReact.libComponentsSearchBoxSearchBoxDottypesMod.ISearchBox
import typingsJapgolly.officeUiFabricReact.libComponentsSearchBoxSearchBoxDottypesMod.ISearchBoxProps
import typingsJapgolly.officeUiFabricReact.libComponentsSearchBoxSearchBoxDottypesMod.ISearchBoxStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsSearchBoxSearchBoxDottypesMod.ISearchBoxStyles
...
object SearchBoxBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.SearchBoxBase] {
    ...
    inline def clearButtonProps(value: IButtonProps): this.type = set("clearButtonProps", value.asInstanceOf[js.Any])
    
    inline def color(value: String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def componentRef(value: IRefObject[ISearchBox]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ISearchBox | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ISearchBox | Null) => value(t0).runNow()))
    ...
    inline def iconProps(value: PickIIconPropsExcludekeyo): this.type = set("iconProps", value.asInstanceOf[js.Any])
    ...
    inline def labelText(value: String): this.type = set("labelText", value.asInstanceOf[js.Any])
    ...
    inline def onChange(
      value: (/* event */ js.UndefOr[ReactEventFrom[HTMLInputElement]], /* newValue */ js.UndefOr[String]) => Callback
    ): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ js.UndefOr[ReactEventFrom[HTMLInputElement]], t1: /* newValue */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
    
    inline def onChanged(value: /* newValue */ Any => Callback): this.type = set("onChanged", js.Any.fromFunction1((t0: /* newValue */ Any) => value(t0).runNow()))
    
    inline def onClear(value: /* ev */ js.UndefOr[Any] => Callback): this.type = set("onClear", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def onEscape(value: /* ev */ js.UndefOr[Any] => Callback): this.type = set("onEscape", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def onSearch(value: /* newValue */ Any => Callback): this.type = set("onSearch", js.Any.fromFunction1((t0: /* newValue */ Any) => value(t0).runNow()))
    ...
    inline def styles(value: IStyleFunctionOrObject[ISearchBoxStyleProps, ISearchBoxStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: ISearchBoxStyleProps => DeepPartial[ISearchBoxStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: SearchBoxBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ISearchBoxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
