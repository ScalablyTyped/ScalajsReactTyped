...
import typingsJapgolly.officeUiFabricReact.libComponentsMessageBarMessageBarDottypesMod.IMessageBar
...
import typingsJapgolly.officeUiFabricReact.libComponentsMessageBarMessageBarDottypesMod.MessageBarType
...
object MessageBarBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.MessageBarBase] {
    
    inline def about(value: String): this.type = set("about", value.asInstanceOf[js.Any])
    
    inline def accessKey(value: String): this.type = set("accessKey", value.asInstanceOf[js.Any])
    
    inline def actions(value: VdomElement): this.type = set("actions", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def componentRef(value: IRefObject[IMessageBar]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IMessageBar | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IMessageBar | Null) => value(t0).runNow()))
    ...
    inline def dismissButtonAriaLabel(value: String): this.type = set("dismissButtonAriaLabel", value.asInstanceOf[js.Any])
    
    inline def dismissIconProps(value: IIconProps): this.type = set("dismissIconProps", value.asInstanceOf[js.Any])
    ...
    inline def messageBarIconProps(value: IIconProps): this.type = set("messageBarIconProps", value.asInstanceOf[js.Any])
    
    inline def messageBarType(value: MessageBarType): this.type = set("messageBarType", value.asInstanceOf[js.Any])
    ...
    inline def onDismiss(
      value: /* ev */ js.UndefOr[
          ReactMouseEventFrom[
            (HTMLElement | typingsJapgolly.officeUiFabricReact.libButtonMod.BaseButton | typingsJapgolly.officeUiFabricReact.libButtonMod.Button) & Element
          ]
        ] => Any
    ...
    inline def overflowButtonAriaLabel(value: String): this.type = set("overflowButtonAriaLabel", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IMessageBarStyleProps, IMessageBarStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IMessageBarStyleProps => DeepPartial[IMessageBarStyles]): this.type = set("styles", js.Any.fromFunction1(value))
