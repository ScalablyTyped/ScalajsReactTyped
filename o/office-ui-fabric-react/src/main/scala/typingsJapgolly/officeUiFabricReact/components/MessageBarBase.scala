...
import typingsJapgolly.officeUiFabricReact.messageBarTypesMod.IMessageBar
...
import typingsJapgolly.officeUiFabricReact.messageBarTypesMod.MessageBarType
...
object MessageBarBase {
  def apply(
    ...
    onDismiss: /* ev */ js.UndefOr[
      ReactMouseEventFrom[
        (HTMLElement | typingsJapgolly.officeUiFabricReact.libButtonMod.BaseButton | typingsJapgolly.officeUiFabricReact.libButtonMod.Button) with Element
      ]
    ...
    IMessageBarProps, 
    typingsJapgolly.officeUiFabricReact.mod.MessageBarBase, 
    Unit, 
    IMessageBarProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.messageBarTypesMod.IMessageBarProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.MessageBarBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.messageBarTypesMod.IMessageBarProps])(children: _*)
  }
