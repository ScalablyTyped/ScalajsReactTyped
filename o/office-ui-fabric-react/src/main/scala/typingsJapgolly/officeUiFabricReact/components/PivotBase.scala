...
object PivotBase {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IPivotProps, typingsJapgolly.officeUiFabricReact.mod.PivotBase, Unit, IPivotProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.mod.PivotBase](this.componentImport)
