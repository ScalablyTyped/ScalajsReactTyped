...
import typingsJapgolly.officeUiFabricReact.calloutTypesMod.ICalloutContentStyles
...
abstract class SharedApply_ICalloutProps854520063[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ICalloutProps, ComponentRef, Unit, ICalloutProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.calloutTypesMod.ICalloutProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.calloutTypesMod.ICalloutProps])(children: _*)
  }
}
