...
@scala.inline
open class SharedBuilder_ITagItemProps522051606 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def enableTagFocusInDisabledPicker(value: Boolean): this.type = set("enableTagFocusInDisabledPicker", value.asInstanceOf[js.Any])
  ...
  inline def onItemChange(value: (ITag, /* index */ Double) => Callback): this.type = set("onItemChange", js.Any.fromFunction2((t0: ITag, t1: /* index */ Double) => (value(t0, t1)).runNow()))
  ...
  inline def styles(value: IStyleFunctionOrObject[ITagItemStyleProps, ITagItemStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: ITagItemStyleProps => DeepPartial[ITagItemStyles]): this.type = set("styles", js.Any.fromFunction1(value))
