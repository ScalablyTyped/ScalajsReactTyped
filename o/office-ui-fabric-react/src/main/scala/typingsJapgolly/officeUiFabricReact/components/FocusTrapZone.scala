...
import typingsJapgolly.officeUiFabricReact.focusTrapZoneTypesMod.IFocusTrapZone
...
object FocusTrapZone {
  def apply(
    ...
    IFocusTrapZoneProps, 
    typingsJapgolly.officeUiFabricReact.mod.FocusTrapZone, 
    Unit, 
    IFocusTrapZoneProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.focusTrapZoneTypesMod.IFocusTrapZoneProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.FocusTrapZone](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.focusTrapZoneTypesMod.IFocusTrapZoneProps])(children: _*)
  }
