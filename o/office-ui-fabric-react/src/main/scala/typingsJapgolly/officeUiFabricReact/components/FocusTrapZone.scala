...
import typingsJapgolly.officeUiFabricReact.libComponentsFocusTrapZoneFocusTrapZoneDottypesMod.IFocusTrapZone
...
object FocusTrapZone {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.FocusTrapZone] {
    ...
    inline def componentRef(value: IRefObject[IFocusTrapZone]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IFocusTrapZone | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IFocusTrapZone | Null) => value(t0).runNow()))
    ...
    inline def disableFirstFocus(value: Boolean): this.type = set("disableFirstFocus", value.asInstanceOf[js.Any])
    ...
    inline def firstFocusableTarget(value: String | (js.Function1[/* element */ HTMLElement, HTMLElement | Null])): this.type = set("firstFocusableTarget", value.asInstanceOf[js.Any])
    
    inline def firstFocusableTargetFunction1(value: /* element */ HTMLElement => HTMLElement | Null): this.type = set("firstFocusableTarget", js.Any.fromFunction1(value))
    
    inline def focusPreviouslyFocusedInnerElement(value: Boolean): this.type = set("focusPreviouslyFocusedInnerElement", value.asInstanceOf[js.Any])
