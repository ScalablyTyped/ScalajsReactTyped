...
import typingsJapgolly.officeUiFabricReact.libComponentsLabelLabelDottypesMod.ILabel
...
object LabelBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.LabelBase] {
    ...
    inline def as(value: IComponentAs[AllHTMLAttributes[HTMLElement]]): this.type = set("as", value.asInstanceOf[js.Any])
    ...
    inline def componentRef(value: IRefObject[ILabel]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ILabel | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ILabel | Null) => value(t0).runNow()))
    ...
    inline def styles(value: IStyleFunctionOrObject[ILabelStyleProps, ILabelStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: ILabelStyleProps => DeepPartial[ILabelStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  ...
  implicit def make(companion: LabelBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
