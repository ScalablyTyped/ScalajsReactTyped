...
import typingsJapgolly.officeUiFabricReact.labelTypesMod.ILabel
import typingsJapgolly.officeUiFabricReact.labelTypesMod.ILabelProps
...
object LabelBase {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ILabelProps, typingsJapgolly.officeUiFabricReact.mod.LabelBase, Unit, ILabelProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.labelTypesMod.ILabelProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.LabelBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.labelTypesMod.ILabelProps])(children: _*)
  }
