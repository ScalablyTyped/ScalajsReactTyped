...
import typingsJapgolly.officeUiFabricReact.comboBoxTypesMod.IComboBoxOption
import typingsJapgolly.officeUiFabricReact.comboBoxTypesMod.IComboBoxProps
import typingsJapgolly.officeUiFabricReact.comboBoxTypesMod.IOnRenderComboBoxLabelProps
...
abstract class SharedApply_IComboBoxProps1956028297[ComponentRef] () {
  ...
  def apply(
    ...
    autoComplete: on | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.off = null,
    ...
    typeof: String = null,
    unselectable: typingsJapgolly.react.reactStrings.on | off = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IComboBoxProps, ComponentRef, Unit, IComboBoxProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.comboBoxTypesMod.IComboBoxProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.comboBoxTypesMod.IComboBoxProps])(children: _*)
  }
}
