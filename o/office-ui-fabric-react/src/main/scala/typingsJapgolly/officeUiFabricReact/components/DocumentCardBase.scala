...
import typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardDottypesMod.DocumentCardType
import typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardDottypesMod.IDocumentCard
import typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardDottypesMod.IDocumentCardProps
import typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardDottypesMod.IDocumentCardStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardDottypesMod.IDocumentCardStyles
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardDotbaseMod.DocumentCardBase
        ] {
    ...
    inline def componentRef(value: IRefObject[IDocumentCard]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IDocumentCard | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IDocumentCard | Null) => value(t0).runNow()))
    ...
    inline def onClick(value: /* ev */ js.UndefOr[ReactEventFrom[HTMLElement]] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[ReactEventFrom[HTMLElement]]) => value(t0).runNow()))
    
    inline def onClickHref(value: String): this.type = set("onClickHref", value.asInstanceOf[js.Any])
    
    inline def onClickTarget(value: String): this.type = set("onClickTarget", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IDocumentCardStyleProps, IDocumentCardStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IDocumentCardStyleProps => DeepPartial[IDocumentCardStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    ...
    inline def `type`(value: DocumentCardType): this.type = set("type", value.asInstanceOf[js.Any])
