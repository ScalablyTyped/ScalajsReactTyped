...
import typingsJapgolly.officeUiFabricReact.documentCardTypesMod.DocumentCardType
import typingsJapgolly.officeUiFabricReact.documentCardTypesMod.IDocumentCard
import typingsJapgolly.officeUiFabricReact.documentCardTypesMod.IDocumentCardProps
import typingsJapgolly.officeUiFabricReact.documentCardTypesMod.IDocumentCardStyleProps
import typingsJapgolly.officeUiFabricReact.documentCardTypesMod.IDocumentCardStyles
...
object DocumentCardBase {
  def apply(
    ...
    IDocumentCardProps, 
    typingsJapgolly.officeUiFabricReact.documentCardBaseMod.DocumentCardBase, 
    Unit, 
    IDocumentCardProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.documentCardTypesMod.IDocumentCardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.documentCardBaseMod.DocumentCardBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.documentCardTypesMod.IDocumentCardProps])(children: _*)
  }
