...
object Facepile {
  def apply(
    ...
    IFacepileProps, 
    LegacyRef[typingsJapgolly.officeUiFabricReact.facepileBaseMod.FacepileBase], 
    Unit, 
    IFacepileProps
  ] = {
  ...
  typingsJapgolly.react.mod.LegacyRef[typingsJapgolly.officeUiFabricReact.facepileBaseMod.FacepileBase]](this.componentImport)
