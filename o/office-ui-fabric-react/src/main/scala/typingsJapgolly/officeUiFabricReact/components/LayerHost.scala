...
import typingsJapgolly.officeUiFabricReact.layerHostTypesMod.ILayerHost
import typingsJapgolly.officeUiFabricReact.layerHostTypesMod.ILayerHostProps
...
object LayerHost {
  def apply(
    ...
    ILayerHostProps, 
    typingsJapgolly.officeUiFabricReact.mod.LayerHost, 
    Unit, 
    ILayerHostProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.layerHostTypesMod.ILayerHostProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.LayerHost](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.layerHostTypesMod.ILayerHostProps])(children: _*)
  }
