...
object LayerHost {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.LayerHost] {
    ...
    inline def componentRef(value: IRefObject[ILayerHost]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ILayerHost | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ILayerHost | Null) => value(t0).runNow()))
  ...
  implicit def make(companion: LayerHost.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ILayerHostProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
