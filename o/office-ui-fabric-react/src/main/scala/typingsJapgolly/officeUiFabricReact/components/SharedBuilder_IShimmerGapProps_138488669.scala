...
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerGapShimmerGapDottypesMod.IShimmerGap
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerGapShimmerGapDottypesMod.IShimmerGapStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsShimmerShimmerGapShimmerGapDottypesMod.IShimmerGapStyles
...
@scala.inline
open class SharedBuilder_IShimmerGapProps_138488669 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def componentRef(value: IRefObject[IShimmerGap]): this.type = set("componentRef", value.asInstanceOf[js.Any])
  
  inline def componentRefFunction1(value: /* ref */ IShimmerGap | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmerGap | Null) => value(t0).runNow()))
  ...
  inline def styles(value: IStyleFunctionOrObject[IShimmerGapStyleProps, IShimmerGapStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction1(value: IShimmerGapStyleProps => DeepPartial[IShimmerGapStyles]): this.type = set("styles", js.Any.fromFunction1(value))
