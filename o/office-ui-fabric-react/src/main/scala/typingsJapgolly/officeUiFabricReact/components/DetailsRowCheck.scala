...
import typingsJapgolly.officeUiFabricReact.detailsRowCheckTypesMod.IDetailsRowCheckStyleProps
import typingsJapgolly.officeUiFabricReact.detailsRowCheckTypesMod.IDetailsRowCheckStyles
...
object DetailsRowCheck {
  def apply(
    ...
    MountedWithRawType[IDetailsRowCheckProps, js.Object, RawMounted[IDetailsRowCheckProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.detailsRowCheckTypesMod.IDetailsRowCheckProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.detailsRowCheckTypesMod.IDetailsRowCheckProps])(children: _*)
  }
