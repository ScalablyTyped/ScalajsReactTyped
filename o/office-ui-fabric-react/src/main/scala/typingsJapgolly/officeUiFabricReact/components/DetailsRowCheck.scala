...
object DetailsRowCheck {
  ...
  inline def apply(canSelect: Boolean): Builder = {
    val __props = js.Dynamic.literal(canSelect = canSelect.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[IDetailsRowCheckProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def anySelected(value: Boolean): this.type = set("anySelected", value.asInstanceOf[js.Any])
    ...
    inline def checkClassName(value: String): this.type = set("checkClassName", value.asInstanceOf[js.Any])
    ...
    inline def isHeader(value: Boolean): this.type = set("isHeader", value.asInstanceOf[js.Any])
    ...
    inline def onRenderDetailsCheckbox(
      value: (/* props */ js.UndefOr[IDetailsCheckboxProps], /* defaultRender */ js.UndefOr[
          js.Function1[
    ...
    inline def styles(value: IStyleFunctionOrObject[IDetailsRowCheckStyleProps, IDetailsRowCheckStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IDetailsRowCheckStyleProps => DeepPartial[IDetailsRowCheckStyles]): this.type = set("styles", js.Any.fromFunction1(value))
  ...
  def withProps(p: IDetailsRowCheckProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
