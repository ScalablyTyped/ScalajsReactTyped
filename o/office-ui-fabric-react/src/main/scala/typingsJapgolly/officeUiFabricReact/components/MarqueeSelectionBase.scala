...
import typingsJapgolly.officeUiFabricReact.libComponentsMarqueeSelectionMarqueeSelectionDottypesMod.IMarqueeSelection
...
import typingsJapgolly.officeUiFabricReact.libComponentsMarqueeSelectionMarqueeSelectionDottypesMod.IMarqueeSelectionStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsMarqueeSelectionMarqueeSelectionDottypesMod.IMarqueeSelectionStyles
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[
          typingsJapgolly.officeUiFabricReact.libComponentsMarqueeSelectionMarqueeSelectionDotbaseMod.MarqueeSelectionBase
        ] {
    ...
    inline def componentRef(value: IRefObject[IMarqueeSelection]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IMarqueeSelection | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IMarqueeSelection | Null) => value(t0).runNow()))
    ...
    inline def isDraggingConstrainedToRoot(value: Boolean): this.type = set("isDraggingConstrainedToRoot", value.asInstanceOf[js.Any])
    ...
    inline def onShouldStartSelection(value: /* ev */ MouseEvent => Boolean): this.type = set("onShouldStartSelection", js.Any.fromFunction1(value))
    ...
    inline def styles(value: IMarqueeSelectionStyleProps => DeepPartial[IMarqueeSelectionStyles]): this.type = set("styles", js.Any.fromFunction1(value))
