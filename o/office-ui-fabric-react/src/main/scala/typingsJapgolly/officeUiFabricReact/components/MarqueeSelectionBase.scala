...
import typingsJapgolly.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelection
import typingsJapgolly.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionProps
import typingsJapgolly.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionStyleProps
import typingsJapgolly.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionStyles
...
object MarqueeSelectionBase {
  def apply(
    ...
    onShouldStartSelection: /* ev */ MouseEvent => CallbackTo[Boolean] = null,
    ...
    styles: IMarqueeSelectionStyleProps => CallbackTo[Partial[IMarqueeSelectionStyles]] = null,
    ...
    typingsJapgolly.officeUiFabricReact.marqueeSelectionBaseMod.MarqueeSelectionBase, 
    Unit, 
    IMarqueeSelectionProps
  ] = {
    ...
    if (onShouldStartSelection != null) __obj.updateDynamic("onShouldStartSelection")(js.Any.fromFunction1((t0: /* ev */ org.scalajs.dom.raw.MouseEvent) => onShouldStartSelection(t0).runNow()))
    ...
    if (styles != null) __obj.updateDynamic("styles")(js.Any.fromFunction1((t0: typingsJapgolly.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionStyleProps) => styles(t0).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.marqueeSelectionBaseMod.MarqueeSelectionBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.marqueeSelectionTypesMod.IMarqueeSelectionProps])(children: _*)
  }
