...
object OverflowSet {
  def apply(
    ...
    IOverflowSetProps, 
    LegacyRef[typingsJapgolly.officeUiFabricReact.overflowSetBaseMod.OverflowSetBase], 
    Unit, 
    IOverflowSetProps
  ] = {
  ...
  typingsJapgolly.react.mod.LegacyRef[typingsJapgolly.officeUiFabricReact.overflowSetBaseMod.OverflowSetBase]](this.componentImport)
