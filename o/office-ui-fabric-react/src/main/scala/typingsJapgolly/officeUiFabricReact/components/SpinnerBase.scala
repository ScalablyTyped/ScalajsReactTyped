...
import typingsJapgolly.officeUiFabricReact.libComponentsSpinnerSpinnerDottypesMod.ISpinner
import typingsJapgolly.officeUiFabricReact.libComponentsSpinnerSpinnerDottypesMod.ISpinnerProps
import typingsJapgolly.officeUiFabricReact.libComponentsSpinnerSpinnerDottypesMod.ISpinnerStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsSpinnerSpinnerDottypesMod.ISpinnerStyles
import typingsJapgolly.officeUiFabricReact.libComponentsSpinnerSpinnerDottypesMod.SpinnerLabelPosition
import typingsJapgolly.officeUiFabricReact.libComponentsSpinnerSpinnerDottypesMod.SpinnerSize
import typingsJapgolly.officeUiFabricReact.libComponentsSpinnerSpinnerDottypesMod.SpinnerType
...
object SpinnerBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.SpinnerBase] {
    ...
    inline def ariaLive(
      value: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.assertive | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.polite | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.off
    ): this.type = set("ariaLive", value.asInstanceOf[js.Any])
    ...
    inline def componentRef(value: IRefObject[ISpinner]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ISpinner | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ISpinner | Null) => value(t0).runNow()))
    ...
    inline def labelPosition(value: SpinnerLabelPosition): this.type = set("labelPosition", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[ISpinnerStyleProps, ISpinnerStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: ISpinnerStyleProps => DeepPartial[ISpinnerStyles]): this.type = set("styles", js.Any.fromFunction1(value))
    ...
    inline def `type`(value: SpinnerType): this.type = set("type", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: SpinnerBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
