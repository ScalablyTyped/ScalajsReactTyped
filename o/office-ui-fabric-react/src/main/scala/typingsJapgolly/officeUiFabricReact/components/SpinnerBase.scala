...
import typingsJapgolly.officeUiFabricReact.spinnerTypesMod.ISpinner
...
import typingsJapgolly.officeUiFabricReact.spinnerTypesMod.ISpinnerStyles
import typingsJapgolly.officeUiFabricReact.spinnerTypesMod.SpinnerLabelPosition
import typingsJapgolly.officeUiFabricReact.spinnerTypesMod.SpinnerSize
import typingsJapgolly.officeUiFabricReact.spinnerTypesMod.SpinnerType
...
object SpinnerBase {
  def apply(
    ...
    ariaLive: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.assertive | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.polite | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.off = null,
    ...
    ISpinnerProps, 
    typingsJapgolly.officeUiFabricReact.mod.SpinnerBase, 
    Unit, 
    ISpinnerProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.spinnerTypesMod.ISpinnerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.SpinnerBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.spinnerTypesMod.ISpinnerProps])(children: _*)
  }
