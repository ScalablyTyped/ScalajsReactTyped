...
object PivotItem {
  def apply(
    ...
    onRenderItemLink: (/* props */ js.UndefOr[IPivotItemProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IPivotItemProps], Element | Null]]) => CallbackTo[Element | Null] = null,
    ...
    IPivotItemProps, 
    typingsJapgolly.officeUiFabricReact.mod.PivotItem, 
    Unit, 
    IPivotItemProps
  ] = {
    ...
    if (onRenderItemLink != null) __obj.updateDynamic("onRenderItemLink")(js.Any.fromFunction2((t0: /* props */ js.UndefOr[typingsJapgolly.officeUiFabricReact.pivotItemTypesMod.IPivotItemProps], t1: /* defaultRender */ js.UndefOr[
  js.Function1[
    /* props */ js.UndefOr[typingsJapgolly.officeUiFabricReact.pivotItemTypesMod.IPivotItemProps], 
    japgolly.scalajs.react.raw.React.Element | scala.Null
  ]]) => onRenderItemLink(t0, t1).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.pivotItemTypesMod.IPivotItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.PivotItem](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.pivotItemTypesMod.IPivotItemProps])(children: _*)
  }
