...
object PivotItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.PivotItem] {
    ...
    inline def headerButtonProps(value: IButtonProps | (StringDictionary[String | Double | Boolean])): this.type = set("headerButtonProps", value.asInstanceOf[js.Any])
    ...
    inline def itemCount(value: Double | String): this.type = set("itemCount", value.asInstanceOf[js.Any])
    
    inline def itemID(value: String): this.type = set("itemID", value.asInstanceOf[js.Any])
    
    inline def itemIcon(value: String): this.type = set("itemIcon", value.asInstanceOf[js.Any])
    ...
    inline def onRenderItemLink(
      value: (/* props */ js.UndefOr[IPivotItemProps], /* defaultRender */ js.UndefOr[
          js.Function1[
