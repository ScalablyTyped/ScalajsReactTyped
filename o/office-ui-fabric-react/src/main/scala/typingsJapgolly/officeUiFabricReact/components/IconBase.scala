...
import typingsJapgolly.officeUiFabricReact.iconTypesMod.IIconStyleProps
import typingsJapgolly.officeUiFabricReact.iconTypesMod.IIconStyles
import typingsJapgolly.officeUiFabricReact.iconTypesMod.IconType
...
object IconBase {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IIconProps, typingsJapgolly.officeUiFabricReact.mod.IconBase, Unit, IIconProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.iconTypesMod.IIconProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.IconBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.iconTypesMod.IIconProps])(children: _*)
  }
