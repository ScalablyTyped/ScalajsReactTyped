...
import typingsJapgolly.officeUiFabricReact.libComponentsIconIconDottypesMod.IconType
...
object IconBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.IconBase] {
    ...
    inline def iconName(value: String): this.type = set("iconName", value.asInstanceOf[js.Any])
    
    inline def iconType(value: IconType): this.type = set("iconType", value.asInstanceOf[js.Any])
    
    inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    
    inline def imageErrorAs(value: ComponentType[IImageProps]): this.type = set("imageErrorAs", value.asInstanceOf[js.Any])
    
    inline def imageProps(value: IImageProps): this.type = set("imageProps", value.asInstanceOf[js.Any])
    ...
    inline def styles(value: IStyleFunctionOrObject[IIconStyleProps, IIconStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IIconStyleProps => DeepPartial[IIconStyles]): this.type = set("styles", js.Any.fromFunction1(value))
