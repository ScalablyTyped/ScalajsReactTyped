...
import typingsJapgolly.officeUiFabricReact.layerTypesMod.ILayer
import typingsJapgolly.officeUiFabricReact.layerTypesMod.ILayerProps
import typingsJapgolly.officeUiFabricReact.layerTypesMod.ILayerStyleProps
import typingsJapgolly.officeUiFabricReact.layerTypesMod.ILayerStyles
...
object LayerBase {
  def apply(
    ...
    onAbort: ReactEventFrom[
      (HTMLDivElement | typingsJapgolly.officeUiFabricReact.layerBaseMod.LayerBase) with Element
    ] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ILayerProps, typingsJapgolly.officeUiFabricReact.mod.LayerBase, Unit, ILayerProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.layerTypesMod.ILayerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.LayerBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.layerTypesMod.ILayerProps])(children: _*)
  }
