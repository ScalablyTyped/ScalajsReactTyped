...
import typingsJapgolly.officeUiFabricReact.libComponentsLayerLayerDottypesMod.ILayer
...
object LayerBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.LayerBase] {
    ...
    inline def componentRef(value: IRefObject[ILayer]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ILayer | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ILayer | Null) => value(t0).runNow()))
    ...
    inline def eventBubblingEnabled(value: Boolean): this.type = set("eventBubblingEnabled", value.asInstanceOf[js.Any])
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def hostId(value: String): this.type = set("hostId", value.asInstanceOf[js.Any])
    ...
    inline def insertFirst(value: Boolean): this.type = set("insertFirst", value.asInstanceOf[js.Any])
    ...
    inline def onAbort(
      value: ReactEventFrom[
          (HTMLDivElement | typingsJapgolly.officeUiFabricReact.libComponentsLayerLayerDotbaseMod.LayerBase) & Element
        ] => Callback
    ...
    inline def onLayerWillUnmount(value: Callback): this.type = set("onLayerWillUnmount", value.toJsFn)
    ...
    inline def styles(value: IStyleFunctionOrObject[ILayerStyleProps, ILayerStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: ILayerStyleProps => DeepPartial[ILayerStyles]): this.type = set("styles", js.Any.fromFunction1(value))
