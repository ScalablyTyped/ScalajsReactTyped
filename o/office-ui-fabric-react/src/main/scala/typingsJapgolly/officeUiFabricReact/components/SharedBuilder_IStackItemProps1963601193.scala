...
import typingsJapgolly.officeUiFabricReact.libComponentsStackStackItemStackItemDottypesMod.IStackItemStyles
import typingsJapgolly.officeUiFabricReact.libComponentsStackStackItemStackItemDottypesMod.IStackItemTokens
...
@scala.inline
open class SharedBuilder_IStackItemProps1963601193 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def align(value: auto | stretch | baseline | start | center | end): this.type = set("align", value.asInstanceOf[js.Any])
  ...
  inline def shrink(
    value: Boolean | Double | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.inherit | initial | unset
  ): this.type = set("shrink", value.asInstanceOf[js.Any])
  ...
  inline def styles(value: IStylesFunctionOrObject[IStackItemProps, IStackItemTokens, IStackItemStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction3(value: (IStackItemProps, /* theme */ ITheme, IStackItemTokens) => IStackItemStyles): this.type = set("styles", js.Any.fromFunction3(value))
  ...
  inline def tokens(value: ITokenFunctionOrObject[IStackItemProps, IStackItemTokens]): this.type = set("tokens", value.asInstanceOf[js.Any])
