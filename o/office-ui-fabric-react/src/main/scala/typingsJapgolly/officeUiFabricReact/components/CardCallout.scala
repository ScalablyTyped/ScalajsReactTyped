...
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardCardCalloutCardCalloutMod.ICardCalloutProps
...
object CardCallout {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def content(value: VdomElement): this.type = set("content", value.rawElement.asInstanceOf[js.Any])
