...
import typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaPresenceStyleProps
import typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaPresenceStyles
...
object PersonaPresenceBase {
  def apply(
    ...
    onAbort: ReactEventFrom[
      (typingsJapgolly.officeUiFabricReact.personaBaseMod.PersonaBase | typingsJapgolly.officeUiFabricReact.personaCoinBaseMod.PersonaCoinBase | HTMLDivElement) with Element
    ] => Callback = null,
    ...
    prefix: String = null,
    presence: typingsJapgolly.officeUiFabricReact.personaTypesMod.PersonaPresence = null,
    ...
    typingsJapgolly.officeUiFabricReact.libPersonaPresenceMod.PersonaPresenceBase, 
    Unit, 
    IPersonaPresenceProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaPresenceProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.libPersonaPresenceMod.PersonaPresenceBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaPresenceProps])(children: _*)
  }
