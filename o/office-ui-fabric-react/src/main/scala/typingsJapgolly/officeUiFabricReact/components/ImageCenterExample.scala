...
object ImageCenterExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.imageCenterExampleMod.ImageCenterExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.imageCenterExampleMod.ImageCenterExample](this.componentImport)
