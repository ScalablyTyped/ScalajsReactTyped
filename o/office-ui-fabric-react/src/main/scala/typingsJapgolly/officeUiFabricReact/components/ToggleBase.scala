...
import typingsJapgolly.officeUiFabricReact.toggleTypesMod.IToggleStyleProps
import typingsJapgolly.officeUiFabricReact.toggleTypesMod.IToggleStyles
...
object ToggleBase {
  def apply(
    ...
    onChange: (/* event */ ReactMouseEventFrom[HTMLElement], /* checked */ js.UndefOr[Boolean]) => Callback = null,
    onChanged: /* checked */ Boolean => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IToggleProps, typingsJapgolly.officeUiFabricReact.mod.ToggleBase, Unit, IToggleProps] = {
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement], t1: /* checked */ js.UndefOr[scala.Boolean]) => onChange(t0, t1).runNow()))
    if (onChanged != null) __obj.updateDynamic("onChanged")(js.Any.fromFunction1((t0: /* checked */ scala.Boolean) => onChanged(t0).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.toggleTypesMod.IToggleProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.ToggleBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.toggleTypesMod.IToggleProps])(children: _*)
  }
