...
object ToggleBase {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.ToggleBase] {
  ...
  implicit def make(companion: ToggleBase.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
