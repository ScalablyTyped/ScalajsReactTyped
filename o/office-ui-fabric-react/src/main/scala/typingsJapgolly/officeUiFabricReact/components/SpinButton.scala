...
import typingsJapgolly.officeUiFabricReact.libComponentsSpinButtonSpinButtonDottypesMod.ISpinButton
import typingsJapgolly.officeUiFabricReact.libComponentsSpinButtonSpinButtonDottypesMod.ISpinButtonClassNames
import typingsJapgolly.officeUiFabricReact.libComponentsSpinButtonSpinButtonDottypesMod.ISpinButtonProps
import typingsJapgolly.officeUiFabricReact.libComponentsSpinButtonSpinButtonMod.KeyboardSpinDirection
import typingsJapgolly.officeUiFabricReact.libUtilitiesPositioningPositioningDottypesMod.Position
...
object SpinButton {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.SpinButton] {
    ...
    inline def ariaPositionInSet(value: Double): this.type = set("ariaPositionInSet", value.asInstanceOf[js.Any])
    
    inline def ariaSetSize(value: Double): this.type = set("ariaSetSize", value.asInstanceOf[js.Any])
    
    inline def ariaValueNow(value: Double): this.type = set("ariaValueNow", value.asInstanceOf[js.Any])
    ...
    inline def componentRef(value: IRefObject[ISpinButton]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ ISpinButton | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ ISpinButton | Null) => value(t0).runNow()))
    ...
    inline def decrementButtonAriaLabel(value: String): this.type = set("decrementButtonAriaLabel", value.asInstanceOf[js.Any])
    
    inline def decrementButtonIcon(value: IIconProps): this.type = set("decrementButtonIcon", value.asInstanceOf[js.Any])
    ...
    inline def downArrowButtonStyles(value: PartialIButtonStyles): this.type = set("downArrowButtonStyles", value.asInstanceOf[js.Any])
    ...
    inline def incrementButtonAriaLabel(value: String): this.type = set("incrementButtonAriaLabel", value.asInstanceOf[js.Any])
    
    inline def incrementButtonIcon(value: IIconProps): this.type = set("incrementButtonIcon", value.asInstanceOf[js.Any])
    
    inline def inlist(value: Any): this.type = set("inlist", value.asInstanceOf[js.Any])
    
    inline def inputMode(value: none | text | tel | url | email | numeric | decimal | search): this.type = set("inputMode", value.asInstanceOf[js.Any])
    
    inline def inputProps(value: InputHTMLAttributes[HTMLElement | HTMLInputElement]): this.type = set("inputProps", value.asInstanceOf[js.Any])
    ...
    inline def onDecrement(
      value: (/* value */ String, /* event */ js.UndefOr[ReactMouseEventFrom[HTMLElement] | ReactKeyboardEventFrom[HTMLElement]]) => String | Unit
    ...
    inline def onValidate(value: (/* value */ String, /* event */ js.UndefOr[ReactEventFrom[HTMLElement]]) => String | Unit): this.type = set("onValidate", js.Any.fromFunction2(value))
    ...
    inline def styles(value: PartialISpinButtonStyles): this.type = set("styles", value.asInstanceOf[js.Any])
    ...
    inline def upArrowButtonStyles(value: PartialIButtonStyles): this.type = set("upArrowButtonStyles", value.asInstanceOf[js.Any])
