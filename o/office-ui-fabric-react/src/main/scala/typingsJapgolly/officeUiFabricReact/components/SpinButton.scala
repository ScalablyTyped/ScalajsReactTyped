...
import typingsJapgolly.officeUiFabricReact.spinButtonTypesMod.ISpinButton
...
object SpinButton {
  def apply(
    ...
    ISpinButtonProps, 
    typingsJapgolly.officeUiFabricReact.mod.SpinButton, 
    Unit, 
    ISpinButtonProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.spinButtonTypesMod.ISpinButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.SpinButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.spinButtonTypesMod.ISpinButtonProps])(children: _*)
  }
