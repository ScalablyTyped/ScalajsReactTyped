...
object BasePickerListBelow {
  ...
  @scala.inline
  open class Builder[T, P /* <: IBasePickerProps[T] */] (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.BasePickerListBelow[T, P]]
