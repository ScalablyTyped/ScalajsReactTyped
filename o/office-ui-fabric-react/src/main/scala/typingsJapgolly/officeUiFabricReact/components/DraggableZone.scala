...
import typingsJapgolly.officeUiFabricReact.libUtilitiesDraggableZoneDraggableZoneDottypesMod.IDragData
...
object DraggableZone {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.libUtilitiesDraggableZoneMod.DraggableZone] {
    ...
    inline def handleSelector(value: String): this.type = set("handleSelector", value.asInstanceOf[js.Any])
    ...
    inline def onDragChange(
      value: (/* event */ ReactMouseEventFrom[HTMLElement] & ReactTouchEventFrom[HTMLElement], /* dragData */ IDragData) => Callback
    ): this.type = set("onDragChange", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLElement] & ReactTouchEventFrom[HTMLElement], t1: /* dragData */ IDragData) => (value(t0, t1)).runNow()))
    ...
    inline def onStart(
      value: (/* event */ ReactMouseEventFrom[HTMLElement] & ReactTouchEventFrom[HTMLElement], /* dragData */ IDragData) => Callback
    ): this.type = set("onStart", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLElement] & ReactTouchEventFrom[HTMLElement], t1: /* dragData */ IDragData) => (value(t0, t1)).runNow()))
    
    inline def onStop(
      value: (/* event */ ReactMouseEventFrom[HTMLElement] & ReactTouchEventFrom[HTMLElement], /* dragData */ IDragData) => Callback
    ): this.type = set("onStop", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLElement] & ReactTouchEventFrom[HTMLElement], t1: /* dragData */ IDragData) => (value(t0, t1)).runNow()))
    ...
    inline def position(value: ICoordinates): this.type = set("position", value.asInstanceOf[js.Any])
    
    inline def prefix(value: String): this.type = set("prefix", value.asInstanceOf[js.Any])
    
    inline def preventDragSelector(value: String): this.type = set("preventDragSelector", value.asInstanceOf[js.Any])
