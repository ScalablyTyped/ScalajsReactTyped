...
import typingsJapgolly.officeUiFabricReact.draggableZoneTypesMod.IDragData
...
object DraggableZone {
  def apply(
    ...
    onDragChange: (/* event */ ReactMouseEventFrom[HTMLElement] with ReactTouchEventFrom[HTMLElement], /* dragData */ IDragData) => Callback = null,
    ...
    onStart: (/* event */ ReactMouseEventFrom[HTMLElement] with ReactTouchEventFrom[HTMLElement], /* dragData */ IDragData) => Callback = null,
    onStop: (/* event */ ReactMouseEventFrom[HTMLElement] with ReactTouchEventFrom[HTMLElement], /* dragData */ IDragData) => Callback = null,
    ...
    IDraggableZoneProps, 
    typingsJapgolly.officeUiFabricReact.draggableZoneMod.DraggableZone, 
    Unit, 
    IDraggableZoneProps
  ] = {
    ...
    if (onDragChange != null) __obj.updateDynamic("onDragChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement] with japgolly.scalajs.react.ReactTouchEventFrom[org.scalajs.dom.raw.HTMLElement], t1: /* dragData */ typingsJapgolly.officeUiFabricReact.draggableZoneTypesMod.IDragData) => onDragChange(t0, t1).runNow()))
    ...
    if (onStart != null) __obj.updateDynamic("onStart")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement] with japgolly.scalajs.react.ReactTouchEventFrom[org.scalajs.dom.raw.HTMLElement], t1: /* dragData */ typingsJapgolly.officeUiFabricReact.draggableZoneTypesMod.IDragData) => onStart(t0, t1).runNow()))
    if (onStop != null) __obj.updateDynamic("onStop")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement] with japgolly.scalajs.react.ReactTouchEventFrom[org.scalajs.dom.raw.HTMLElement], t1: /* dragData */ typingsJapgolly.officeUiFabricReact.draggableZoneTypesMod.IDragData) => onStop(t0, t1).runNow()))
  ...
  typingsJapgolly.officeUiFabricReact.draggableZoneTypesMod.IDraggableZoneProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.draggableZoneMod.DraggableZone](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.draggableZoneTypesMod.IDraggableZoneProps])(children: _*)
  }
