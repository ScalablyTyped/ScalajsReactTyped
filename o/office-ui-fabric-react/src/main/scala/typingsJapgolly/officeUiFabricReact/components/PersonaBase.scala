...
object PersonaBase {
  def apply(
    ...
    IPersonaProps, 
    typingsJapgolly.officeUiFabricReact.mod.PersonaBase, 
    Unit, 
    IPersonaProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.PersonaBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.personaTypesMod.IPersonaProps])(children: _*)
  }
