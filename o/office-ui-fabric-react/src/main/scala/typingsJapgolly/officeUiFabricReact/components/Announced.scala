...
object Announced {
  def apply(
    ...
    IAnnouncedProps, 
    LegacyRef[typingsJapgolly.officeUiFabricReact.announcedBaseMod.AnnouncedBase], 
    Unit, 
    IAnnouncedProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.announcedTypesMod.IAnnouncedProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[typingsJapgolly.officeUiFabricReact.announcedBaseMod.AnnouncedBase]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.announcedTypesMod.IAnnouncedProps])(children: _*)
  }
