...
object SpinButtonStatefulExample {
  def apply(
    ...
    typingsJapgolly.officeUiFabricReact.spinButtonStatefulExampleMod.SpinButtonStatefulExample, 
    Unit, 
    js.Any with js.Object
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.spinButtonStatefulExampleMod.SpinButtonStatefulExample](this.componentImport)
