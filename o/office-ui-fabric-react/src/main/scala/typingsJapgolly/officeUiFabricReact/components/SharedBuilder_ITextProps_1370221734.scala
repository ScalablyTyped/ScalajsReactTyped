...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.large
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.medium
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.mediumPlus
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.mega
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.small
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.smallPlus
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.superLarge
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.tiny
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.xLarge
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.xLargePlus
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.xSmall
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.xxLarge
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.xxLargePlus
...
@scala.inline
open class SharedBuilder_ITextProps_1370221734 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def styles(value: IStylesFunctionOrObject[ITextProps, ITextTokens, ITextStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
  
  inline def stylesFunction3(value: (ITextProps, /* theme */ ITheme, ITextTokens) => ITextStyles): this.type = set("styles", js.Any.fromFunction3(value))
  ...
  inline def tokens(value: ITokenFunctionOrObject[ITextProps, ITextTokens]): this.type = set("tokens", value.asInstanceOf[js.Any])
