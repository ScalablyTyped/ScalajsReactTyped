...
object TagPicker {
  ...
  inline def apply(
    onResolveSuggestions: (String, js.UndefOr[js.Array[ITag]]) => js.Array[ITag] | PromiseLike[js.Array[ITag]]
  ): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def componentRef(value: IRefObject[IBasePicker[ITag]]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IBasePicker[ITag] | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IBasePicker[ITag] | Null) => value(t0).runNow()))
    ...
    inline def defaultSelectedItems(value: js.Array[ITag]): this.type = set("defaultSelectedItems", value.asInstanceOf[js.Any])
    
    inline def defaultSelectedItemsVarargs(value: ITag*): this.type = set("defaultSelectedItems", js.Array(value*))
    ...
    inline def getTextFromItem(value: (ITag, /* currentValue */ js.UndefOr[String]) => String): this.type = set("getTextFromItem", js.Any.fromFunction2(value))
    ...
    inline def onChange(value: /* items */ js.UndefOr[js.Array[ITag]] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* items */ js.UndefOr[js.Array[ITag]]) => value(t0).runNow()))
    
    inline def onDismiss(value: (/* ev */ js.UndefOr[Any], /* selectedItem */ js.UndefOr[ITag]) => Boolean | Unit): this.type = set("onDismiss", js.Any.fromFunction2(value))
    
    inline def onEmptyInputFocus(
      value: /* selectedItems */ js.UndefOr[js.Array[ITag]] => js.Array[ITag] | PromiseLike[js.Array[ITag]]
    ...
    inline def onGetMoreResults(
      value: (/* filter */ String, /* selectedItems */ js.UndefOr[js.Array[ITag]]) => js.Array[ITag] | PromiseLike[js.Array[ITag]]
    ...
    inline def onItemSelected(value: /* selectedItem */ js.UndefOr[ITag] => ITag | PromiseLike[ITag] | Null): this.type = set("onItemSelected", js.Any.fromFunction1(value))
    
    inline def onRemoveSuggestion(value: ITag => Callback): this.type = set("onRemoveSuggestion", js.Any.fromFunction1((t0: ITag) => value(t0).runNow()))
    
    inline def onRenderItem(value: /* props */ IPickerItemProps[ITag] => typingsJapgolly.react.mod.global.JSX.Element): this.type = set("onRenderItem", js.Any.fromFunction1(value))
    
    inline def onRenderSuggestionsItem(
      value: (ITag, /* itemProps */ ISuggestionItemProps[ITag]) => typingsJapgolly.react.mod.global.JSX.Element
    ...
    inline def selectedItems(value: js.Array[ITag]): this.type = set("selectedItems", value.asInstanceOf[js.Any])
    
    inline def selectedItemsVarargs(value: ITag*): this.type = set("selectedItems", js.Array(value*))
