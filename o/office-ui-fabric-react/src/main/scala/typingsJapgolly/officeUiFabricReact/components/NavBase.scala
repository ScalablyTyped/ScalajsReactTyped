...
object NavBase {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[INavProps, typingsJapgolly.officeUiFabricReact.mod.NavBase, Unit, INavProps] = {
  ...
  typingsJapgolly.officeUiFabricReact.mod.NavBase](this.componentImport)
