...
import typingsJapgolly.officeUiFabricReact.dropdownBaseMod.IDropdownInternalProps
import typingsJapgolly.officeUiFabricReact.dropdownTypesMod.IDropdown
import typingsJapgolly.officeUiFabricReact.dropdownTypesMod.IDropdownOption
import typingsJapgolly.officeUiFabricReact.dropdownTypesMod.IDropdownProps
import typingsJapgolly.officeUiFabricReact.dropdownTypesMod.IDropdownStyleProps
import typingsJapgolly.officeUiFabricReact.dropdownTypesMod.IDropdownStyles
...
object DropdownBase {
  def apply(
    ...
    onChange: (/* event */ ReactEventFrom[HTMLDivElement], /* option */ js.UndefOr[IDropdownOption], /* index */ js.UndefOr[Double]) => Callback = null,
    ...
    typingsJapgolly.officeUiFabricReact.mod.DropdownBase, 
    Unit, 
    IDropdownInternalProps
  ] = {
  ...
  typingsJapgolly.officeUiFabricReact.dropdownBaseMod.IDropdownInternalProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.officeUiFabricReact.mod.DropdownBase](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.officeUiFabricReact.dropdownBaseMod.IDropdownInternalProps])(children: _*)
  }
