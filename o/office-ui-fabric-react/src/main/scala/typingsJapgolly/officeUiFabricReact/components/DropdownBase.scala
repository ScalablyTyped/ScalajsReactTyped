...
import typingsJapgolly.officeUiFabricReact.libComponentsDropdownDropdownDotbaseMod.IDropdownInternalProps
import typingsJapgolly.officeUiFabricReact.libComponentsDropdownDropdownDottypesMod.IDropdown
import typingsJapgolly.officeUiFabricReact.libComponentsDropdownDropdownDottypesMod.IDropdownOption
import typingsJapgolly.officeUiFabricReact.libComponentsDropdownDropdownDottypesMod.IDropdownProps
import typingsJapgolly.officeUiFabricReact.libComponentsDropdownDropdownDottypesMod.IDropdownStyleProps
import typingsJapgolly.officeUiFabricReact.libComponentsDropdownDropdownDottypesMod.IDropdownStyles
...
object DropdownBase {
  ...
  inline def apply(options: js.Array[IDropdownOption]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.officeUiFabricReact.mod.DropdownBase] {
    ...
    inline def componentRef(value: IRefObject[IDropdown]): this.type = set("componentRef", value.asInstanceOf[js.Any])
    
    inline def componentRefFunction1(value: /* ref */ IDropdown | Null => Callback): this.type = set("componentRef", js.Any.fromFunction1((t0: /* ref */ IDropdown | Null) => value(t0).runNow()))
    ...
    inline def defaultSelectedKeys(value: js.Array[Double | String]): this.type = set("defaultSelectedKeys", value.asInstanceOf[js.Any])
    
    inline def defaultSelectedKeysVarargs(value: (Double | String)*): this.type = set("defaultSelectedKeys", js.Array(value*))
    ...
    inline def dropdownWidth(value: Double | auto): this.type = set("dropdownWidth", value.asInstanceOf[js.Any])
    ...
    inline def notifyOnReselect(value: Boolean): this.type = set("notifyOnReselect", value.asInstanceOf[js.Any])
    ...
    inline def onChange(
      value: (/* event */ ReactEventFrom[HTMLDivElement], /* option */ js.UndefOr[IDropdownOption], /* index */ js.UndefOr[Double]) => Callback
    ): this.type = set("onChange", js.Any.fromFunction3((t0: /* event */ ReactEventFrom[HTMLDivElement], t1: /* option */ js.UndefOr[IDropdownOption], t2: /* index */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
    
    inline def onChanged(value: (/* option */ IDropdownOption, /* index */ js.UndefOr[Double]) => Callback): this.type = set("onChanged", js.Any.fromFunction2((t0: /* option */ IDropdownOption, t1: /* index */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
    ...
    inline def onRenderCaretDown(
      value: (/* props */ js.UndefOr[IDropdownProps], /* defaultRender */ js.UndefOr[
          js.Function1[
            /* props */ js.UndefOr[IDropdownProps], 
    ...
    inline def onRenderPlaceHolder(
      value: (/* props */ js.UndefOr[IDropdownProps], /* defaultRender */ js.UndefOr[
          js.Function1[
            /* props */ js.UndefOr[IDropdownProps], 
            typingsJapgolly.react.mod.global.JSX.Element | Null
    ...
    inline def onRenderTitle(
      value: (/* props */ js.UndefOr[js.Array[IDropdownOption]], /* defaultRender */ js.UndefOr[
          js.Function1[
            /* props */ js.UndefOr[js.Array[IDropdownOption]], 
            typingsJapgolly.react.mod.global.JSX.Element | Null
          ]
        ]) => typingsJapgolly.react.mod.global.JSX.Element | Null
    ...
    inline def selectedKeys(value: js.Array[Double | String]): this.type = set("selectedKeys", value.asInstanceOf[js.Any])
    
    inline def selectedKeysNull: this.type = set("selectedKeys", null)
    
    inline def selectedKeysVarargs(value: (Double | String)*): this.type = set("selectedKeys", js.Array(value*))
    ...
    inline def styles(value: IStyleFunctionOrObject[IDropdownStyleProps, IDropdownStyles]): this.type = set("styles", value.asInstanceOf[js.Any])
    
    inline def stylesFunction1(value: IDropdownStyleProps => DeepPartial[IDropdownStyles]): this.type = set("styles", js.Any.fromFunction1(value))
