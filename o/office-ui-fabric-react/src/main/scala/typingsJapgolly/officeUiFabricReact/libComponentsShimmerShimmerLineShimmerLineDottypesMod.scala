...
object libComponentsShimmerShimmerLineShimmerLineDottypesMod {
  ...
  object IShimmerLineProps {
    ...
    extension [Self <: IShimmerLineProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IShimmerLine | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmerLine | Null) => value(t0).runNow()))
