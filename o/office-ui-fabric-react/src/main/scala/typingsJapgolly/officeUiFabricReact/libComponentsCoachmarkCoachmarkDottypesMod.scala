...
import typingsJapgolly.officeUiFabricReact.libComponentsCoachmarkCoachmarkDotbaseMod.CoachmarkBase
...
object libComponentsCoachmarkCoachmarkDottypesMod {
  ...
  object ICoachmark {
    ...
    extension [Self <: ICoachmark](x: Self) {
      ...
      inline def setDismiss(value: /* ev */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "dismiss", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object ICoachmarkProps {
    ...
    extension [Self <: ICoachmarkProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ICoachmark | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ICoachmark | Null) => value(t0).runNow()))
      ...
      inline def setOnAnimationOpenEnd(value: Callback): Self = StObject.set(x, "onAnimationOpenEnd", value.toJsFn)
      
      inline def setOnAnimationOpenEndUndefined: Self = StObject.set(x, "onAnimationOpenEnd", js.undefined)
      
      inline def setOnAnimationOpenStart(value: Callback): Self = StObject.set(x, "onAnimationOpenStart", value.toJsFn)
      ...
      inline def setOnMouseMove(value: /* e */ MouseEvent => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1((t0: /* e */ MouseEvent) => value(t0).runNow()))
