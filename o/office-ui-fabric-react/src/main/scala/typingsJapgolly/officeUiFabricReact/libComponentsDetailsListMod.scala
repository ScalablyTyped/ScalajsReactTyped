...
object libComponentsDetailsListMod {
  ...
  open class DetailsColumnBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsColumnDotbaseMod.DetailsColumnBase {
  ...
  open class DetailsHeaderBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsHeaderDotbaseMod.DetailsHeaderBase {
  ...
  open class DetailsListBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsListDotbaseMod.DetailsListBase {
  ...
  open class DetailsRowBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsRowDotbaseMod.DetailsRowBase {
