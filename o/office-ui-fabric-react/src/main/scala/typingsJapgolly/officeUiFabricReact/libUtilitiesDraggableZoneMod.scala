...
import typingsJapgolly.officeUiFabricReact.libUtilitiesDraggableZoneDraggableZoneDotstylesMod.IDraggableZoneStyles
...
object libUtilitiesDraggableZoneMod {
  ...
  open class DraggableZone protected ()
    extends typingsJapgolly.officeUiFabricReact.libUtilitiesDraggableZoneDraggableZoneMod.DraggableZone {
