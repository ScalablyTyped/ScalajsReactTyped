...
object libComponentsSearchBoxSearchBoxDottypesMod {
  ...
  object ISearchBox {
    ...
    inline def apply(focus: Callback, hasFocus: CallbackTo[Boolean]): ISearchBox = {
      val __obj = js.Dynamic.literal(focus = focus.toJsFn, hasFocus = hasFocus.toJsFn)
  ...
  object ISearchBoxProps {
    ...
    extension [Self <: ISearchBoxProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ISearchBox | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ISearchBox | Null) => value(t0).runNow()))
      ...
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ js.UndefOr[ReactEventFrom[HTMLInputElement]], t1: /* newValue */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnChanged(value: /* newValue */ Any => Callback): Self = StObject.set(x, "onChanged", js.Any.fromFunction1((t0: /* newValue */ Any) => value(t0).runNow()))
      
      inline def setOnChangedUndefined: Self = StObject.set(x, "onChanged", js.undefined)
      
      inline def setOnClear(value: /* ev */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onClear", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setOnClearUndefined: Self = StObject.set(x, "onClear", js.undefined)
      
      inline def setOnEscape(value: /* ev */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onEscape", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setOnEscapeUndefined: Self = StObject.set(x, "onEscape", js.undefined)
      
      inline def setOnSearch(value: /* newValue */ Any => Callback): Self = StObject.set(x, "onSearch", js.Any.fromFunction1((t0: /* newValue */ Any) => value(t0).runNow()))
