...
import typingsJapgolly.officeUiFabricReact.libComponentsGroupedListGroupedListDotbaseMod.GroupedListBase
...
object libComponentsGroupedListGroupedListDottypesMod {
  ...
  trait IGroupDividerProps extends StObject {
    ...
    var onGroupHeaderKeyUp: js.UndefOr[
        js.Function2[/* ev */ ReactKeyboardEventFrom[HTMLElement], /* group */ IGroup, Unit]
      ] = js.undefined
  ...
  object IGroupDividerProps {
    ...
    extension [Self <: IGroupDividerProps](x: Self) {
      ...
      inline def setOnGroupHeaderClick(value: /* group */ IGroup => Callback): Self = StObject.set(x, "onGroupHeaderClick", js.Any.fromFunction1((t0: /* group */ IGroup) => value(t0).runNow()))
      
      inline def setOnGroupHeaderClickUndefined: Self = StObject.set(x, "onGroupHeaderClick", js.undefined)
      
      inline def setOnGroupHeaderKeyUp(value: (/* ev */ ReactKeyboardEventFrom[HTMLElement], /* group */ IGroup) => Callback): Self = StObject.set(x, "onGroupHeaderKeyUp", js.Any.fromFunction2((t0: /* ev */ ReactKeyboardEventFrom[HTMLElement], t1: /* group */ IGroup) => (value(t0, t1)).runNow()))
      ...
      inline def setOnToggleCollapse(value: /* group */ IGroup => Callback): Self = StObject.set(x, "onToggleCollapse", js.Any.fromFunction1((t0: /* group */ IGroup) => value(t0).runNow()))
      
      inline def setOnToggleCollapseUndefined: Self = StObject.set(x, "onToggleCollapse", js.undefined)
      
      inline def setOnToggleSelectGroup(value: /* group */ IGroup => Callback): Self = StObject.set(x, "onToggleSelectGroup", js.Any.fromFunction1((t0: /* group */ IGroup) => value(t0).runNow()))
      
      inline def setOnToggleSelectGroupUndefined: Self = StObject.set(x, "onToggleSelectGroup", js.undefined)
      
      inline def setOnToggleSummarize(value: /* group */ IGroup => Callback): Self = StObject.set(x, "onToggleSummarize", js.Any.fromFunction1((t0: /* group */ IGroup) => value(t0).runNow()))
  ...
  trait IGroupedListProps
    ...
    var eventsToRegister: js.UndefOr[js.Array[typingsJapgolly.officeUiFabricReact.anon.Callback]] = js.native
