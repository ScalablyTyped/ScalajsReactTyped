...
import typingsJapgolly.officeUiFabricReact.commandBarBaseMod.ICommandBarData
...
object ICommandBarProps {
  ...
  def apply(
    ...
    onDataGrown: /* movedItem */ ICommandBarItemProps => Callback = null,
    onDataReduced: /* movedItem */ ICommandBarItemProps => Callback = null,
    ...
    onGrowData: /* data */ ICommandBarData => CallbackTo[js.UndefOr[ICommandBarData]] = null,
    ...
    onReduceData: /* data */ ICommandBarData => CallbackTo[js.UndefOr[ICommandBarData]] = null,
    ...
    if (onDataGrown != null) __obj.updateDynamic("onDataGrown")(js.Any.fromFunction1((t0: /* movedItem */ typingsJapgolly.officeUiFabricReact.commandBarTypesMod.ICommandBarItemProps) => onDataGrown(t0).runNow()))
    if (onDataReduced != null) __obj.updateDynamic("onDataReduced")(js.Any.fromFunction1((t0: /* movedItem */ typingsJapgolly.officeUiFabricReact.commandBarTypesMod.ICommandBarItemProps) => onDataReduced(t0).runNow()))
    ...
    if (onGrowData != null) __obj.updateDynamic("onGrowData")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.officeUiFabricReact.commandBarBaseMod.ICommandBarData) => onGrowData(t0).runNow()))
    ...
    if (onReduceData != null) __obj.updateDynamic("onReduceData")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.officeUiFabricReact.commandBarBaseMod.ICommandBarData) => onReduceData(t0).runNow()))
