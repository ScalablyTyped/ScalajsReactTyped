...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`data-is-scrollable`
...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`data-portal-element`
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`ms-Fabric--isFocusVisible`
...
import typingsJapgolly.uifabricUtilities.AnonAsyncPlaceholder
import typingsJapgolly.uifabricUtilities.AnonConfigurable
import typingsJapgolly.uifabricUtilities.AnonFocus
import typingsJapgolly.uifabricUtilities.AnonRtl
import typingsJapgolly.uifabricUtilities.asAsyncMod.IAsAsyncOptions
...
import typingsJapgolly.uifabricUtilities.mathMod.IFitContentToBoundsOptions
...
object utilitiesMod extends js.Object {
  @js.native
  class Async ()
    extends typingsJapgolly.uifabricUtilities.mod.Async {
  ...
  class AutoScroll protected ()
    extends typingsJapgolly.uifabricUtilities.mod.AutoScroll {
    def this(element: HTMLElement) = this()
  }
  
  @js.native
  class BaseComponent[TProps /* <: IBaseProps[_] */, TState] protected ()
    extends typingsJapgolly.uifabricUtilities.mod.BaseComponent[TProps, TState] {
    /**
  ...
  class Customizations ()
    extends typingsJapgolly.uifabricUtilities.mod.Customizations
  ...
  class DelayedRender protected ()
    extends typingsJapgolly.uifabricUtilities.mod.DelayedRender {
    def this(props: IDelayedRenderProps) = this()
  }
  
  @js.native
  class EventGroup protected ()
    extends typingsJapgolly.uifabricUtilities.mod.EventGroup {
  ...
  class FabricPerformance ()
    extends typingsJapgolly.uifabricUtilities.mod.FabricPerformance
  
  @js.native
  class GlobalSettings ()
    extends typingsJapgolly.uifabricUtilities.mod.GlobalSettings
  
  @js.native
  class Rectangle ()
    extends typingsJapgolly.uifabricUtilities.mod.Rectangle {
  ...
  def allowOverscrollOnElement(element: Null, events: typingsJapgolly.uifabricUtilities.eventGroupMod.EventGroup): Unit = js.native
  def allowOverscrollOnElement(
    element: typingsJapgolly.std.HTMLElement,
    events: typingsJapgolly.uifabricUtilities.eventGroupMod.EventGroup
  ): Unit = js.native
  def allowScrollOnElement(element: Null, events: typingsJapgolly.uifabricUtilities.eventGroupMod.EventGroup): Unit = js.native
  ...
  def elementContains(parent: Null, child: typingsJapgolly.std.HTMLElement): Boolean = js.native
  def elementContains(parent: Null, child: typingsJapgolly.std.HTMLElement, allowVirtualParents: Boolean): Boolean = js.native
  def elementContains(parent: typingsJapgolly.std.HTMLElement): Boolean = js.native
  def elementContains(parent: typingsJapgolly.std.HTMLElement, child: Null, allowVirtualParents: Boolean): Boolean = js.native
  def elementContains(parent: typingsJapgolly.std.HTMLElement, child: typingsJapgolly.std.HTMLElement): Boolean = js.native
  def elementContains(
    parent: typingsJapgolly.std.HTMLElement,
    child: typingsJapgolly.std.HTMLElement,
  ...
  def extendComponent[T /* <: Component[js.Object, js.Object] */](
    parent: T,
    methods: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ key in keyof T ]:? T[key]}
    */ typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.extendComponent with T
  ): Unit = js.native
  ...
  def getRect(element: typingsJapgolly.std.HTMLElement): js.UndefOr[IRectangle] = js.native
  ...
  def initializeComponentRef[TProps /* <: IBaseProps[_] */, TState](obj: Component[TProps with js.Object, js.Object]): Unit = js.native
  ...
  def isVirtualElement(element: typingsJapgolly.std.HTMLElement): /* is @uifabric/utilities.@uifabric/utilities/lib/dom/IVirtualElement.IVirtualElement */ Boolean = js.native
  ...
  def nullRender(): japgolly.scalajs.react.raw.React.Element | Null = js.native
  def on(
  ...
  def safeRequestAnimationFrame(component: Component[js.Object, js.Object]): js.Function1[/* cb */ js.Function, Unit] = js.native
  ...
  object DelayedRender extends js.Object {
    var defaultProps: typingsJapgolly.uifabricUtilities.AnonDelay = js.native
  }
