...
trait IDocumentCardProps
  ...
  /**
    ...
    */
  @JSName("onClick")
  var onClick_IDocumentCardProps: js.UndefOr[js.Function1[/* ev */ js.UndefOr[ReactEventFrom[HTMLElement]], Unit]] = js.undefined
  /**
...
object IDocumentCardProps {
  ...
  def apply(
    ...
    onClick: /* ev */ js.UndefOr[ReactEventFrom[HTMLElement]] => Callback = null,
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: /* ev */ js.UndefOr[japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLElement]]) => onClick(t0).runNow()))
