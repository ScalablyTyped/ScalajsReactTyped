...
trait IContextualMenuProps
  ...
  /**
    ...
    */
  var directionalHint: js.UndefOr[typingsJapgolly.officeUiFabricReact.directionalHintMod.DirectionalHint] = js.undefined
  /**
  ...
  /**
    ...
    */
  var directionalHintForRTL: js.UndefOr[typingsJapgolly.officeUiFabricReact.directionalHintMod.DirectionalHint] = js.undefined
  /**
  ...
  var onDismiss: js.UndefOr[
    js.Function2[
      /* ev */ js.UndefOr[ReactMouseEventFrom[Element] | ReactKeyboardEventFrom[Element]], 
...
object IContextualMenuProps {
  ...
  def apply(
    ...
    directionalHint: typingsJapgolly.officeUiFabricReact.directionalHintMod.DirectionalHint = null,
    directionalHintFixed: js.UndefOr[Boolean] = js.undefined,
    directionalHintForRTL: typingsJapgolly.officeUiFabricReact.directionalHintMod.DirectionalHint = null,
