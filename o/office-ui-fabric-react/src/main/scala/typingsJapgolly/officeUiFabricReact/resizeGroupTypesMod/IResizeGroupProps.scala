...
import typingsJapgolly.officeUiFabricReact.resizeGroupBaseMod.ResizeGroupBase
...
object IResizeGroupProps {
  ...
  def apply(
    ...
    onAbort: ReactEventFrom[
      (ResizeGroupBase | org.scalajs.dom.raw.HTMLElement) with org.scalajs.dom.raw.Element
    ] => Callback = null,
