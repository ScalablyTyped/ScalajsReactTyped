...
object libComponentsContextualMenuMod {
  ...
  open class ContextualMenuBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsContextualMenuContextualMenuDotbaseMod.ContextualMenuBase {
  ...
  open class ContextualMenuItemBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsContextualMenuContextualMenuItemDotbaseMod.ContextualMenuItemBase {
