...
object libComponentsCalendarCalendarDayMod {
  ...
  object ICalendarDay {
    ...
    inline def apply(focus: Callback): ICalendarDay = {
  ...
  object IDayInfo {
    ...
    extension [Self <: IDayInfo](x: Self) {
      ...
      inline def setOnSelected(value: ReactEventFrom[HTMLElement] => Callback): Self = StObject.set(x, "onSelected", js.Any.fromFunction1((t0: ReactEventFrom[HTMLElement]) => value(t0).runNow()))
