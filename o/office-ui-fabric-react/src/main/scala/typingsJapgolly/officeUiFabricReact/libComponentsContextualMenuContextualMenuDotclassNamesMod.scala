...
import typingsJapgolly.officeUiFabricReact.libComponentsContextualMenuContextualMenuDottypesMod.IContextualMenuSubComponentStyles
...
object libComponentsContextualMenuContextualMenuDotclassNamesMod {
