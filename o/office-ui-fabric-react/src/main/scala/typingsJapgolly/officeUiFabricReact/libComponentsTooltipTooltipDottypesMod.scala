...
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDotbaseMod.TooltipBase
...
object libComponentsTooltipTooltipDottypesMod {
  ...
  object TooltipDelay extends StObject {
    ...
    sealed trait long
      extends StObject
         with TooltipDelay
    /* 2 */ val long: typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.TooltipDelay.long & Double = js.native
    ...
    sealed trait medium
      extends StObject
         with TooltipDelay
    /* 1 */ val medium: typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.TooltipDelay.medium & Double = js.native
    
    @js.native
    sealed trait zero
      extends StObject
         with TooltipDelay
    /* 0 */ val zero: typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.TooltipDelay.zero & Double = js.native
  }
  ...
  object ITooltipProps {
    ...
    extension [Self <: ITooltipProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ITooltip | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ITooltip | Null) => value(t0).runNow()))
