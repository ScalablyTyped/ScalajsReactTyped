...
object libComponentsToggleToggleDottypesMod {
  ...
  object IToggle {
    ...
    inline def apply(focus: Callback): IToggle = {
  ...
  object IToggleProps {
    ...
    extension [Self <: IToggleProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IToggle | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IToggle | Null) => value(t0).runNow()))
      ...
      inline def setOnChanged(value: /* checked */ Boolean => Callback): Self = StObject.set(x, "onChanged", js.Any.fromFunction1((t0: /* checked */ Boolean) => value(t0).runNow()))
