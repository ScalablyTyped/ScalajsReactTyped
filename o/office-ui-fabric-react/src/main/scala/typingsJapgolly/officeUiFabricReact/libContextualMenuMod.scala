...
object libContextualMenuMod {
  ...
  open class ContextualMenuBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsContextualMenuMod.ContextualMenuBase {
  ...
  open class ContextualMenuItemBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsContextualMenuMod.ContextualMenuItemBase {
