...
object libComponentsDocumentCardDocumentCardStatusDottypesMod {
  ...
  object IDocumentCardStatusProps {
    ...
    extension [Self <: IDocumentCardStatusProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDocumentCardStatus | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDocumentCardStatus | Null) => value(t0).runNow()))
