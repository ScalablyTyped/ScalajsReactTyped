...
import typingsJapgolly.officeUiFabricReact.anon.Root
import typingsJapgolly.officeUiFabricReact.anon.Section
import typingsJapgolly.officeUiFabricReact.anon.Theme
import typingsJapgolly.officeUiFabricReact.anon.Value
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.defaultValue
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.kind
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.method
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.property
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.required
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.typeTokens
import typingsJapgolly.react.mod.global.JSX.Element
import typingsJapgolly.uifabricMergeStyles.libDeepPartialMod.DeepPartial
import typingsJapgolly.uifabricMergeStyles.libIstylefunctionMod.IStyleFunctionOrObject
import typingsJapgolly.uifabricMergeStyles.libIstylesetMod.Omit
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libCommonDocPageDottypesMod {
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.interface
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`enum`
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`class`
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.typeAlias
  */
  trait ApiKind extends StObject
  object ApiKind {
    
    inline def `class`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`class` = "class".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`class`]
    
    inline def `enum`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`enum` = "enum".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`enum`]
    
    inline def interface: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.interface = "interface".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.interface]
    
    inline def typeAlias: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.typeAlias = "typeAlias".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.typeAlias]
  }
  ...
  object IDocPageProps {
    ...
    extension [Self <: IDocPageProps](x: Self) {
      ...
      inline def setExampleKnobs(value: VdomElement): Self = StObject.set(x, "exampleKnobs", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setRelated(value: VdomElement): Self = StObject.set(x, "related", value.rawElement.asInstanceOf[js.Any])
  ...
  object IExample {
    ...
    inline def apply(code: String, title: String, view: VdomElement): IExample = {
      val __obj = js.Dynamic.literal(code = code.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], view = view.rawElement.asInstanceOf[js.Any])
    ...
    extension [Self <: IExample](x: Self) {
      ...
      inline def setView(value: VdomElement): Self = StObject.set(x, "view", value.rawElement.asInstanceOf[js.Any])
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.References
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.Components
  */
  trait PageKind extends StObject
  object PageKind {
    
    inline def Components: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.Components = "Components".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.Components]
    
    inline def References: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.References = "References".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.References]
  }
}
