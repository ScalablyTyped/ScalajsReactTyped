...
import typingsJapgolly.officeUiFabricReact.teachingBubbleBaseMod.TeachingBubbleBase
import typingsJapgolly.officeUiFabricReact.teachingBubbleContentBaseMod.TeachingBubbleContentBase
