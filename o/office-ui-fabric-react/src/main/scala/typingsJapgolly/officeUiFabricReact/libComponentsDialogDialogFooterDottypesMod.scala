...
object libComponentsDialogDialogFooterDottypesMod {
  ...
  object IDialogFooterProps {
    ...
    extension [Self <: IDialogFooterProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDialogFooter | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDialogFooter | Null) => value(t0).runNow()))
