...
import typingsJapgolly.officeUiFabricReact.anon.PartialIColorSliderProps
import typingsJapgolly.officeUiFabricReact.anon.ReadonlyIColorSliderProps
import typingsJapgolly.officeUiFabricReact.anon.ReadonlyIColorSliderState
