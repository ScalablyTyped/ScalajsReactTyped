...
import typingsJapgolly.officeUiFabricReact.shadesMod.Shade
...
object colorMod extends js.Object {
  ...
  object Shade extends js.Object {
    /* 1 */ val Shade1: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Shade1 with Double = js.native
    /* 2 */ val Shade2: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Shade2 with Double = js.native
    /* 3 */ val Shade3: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Shade3 with Double = js.native
    /* 4 */ val Shade4: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Shade4 with Double = js.native
    /* 5 */ val Shade5: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Shade5 with Double = js.native
    /* 6 */ val Shade6: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Shade6 with Double = js.native
    /* 7 */ val Shade7: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Shade7 with Double = js.native
    /* 8 */ val Shade8: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Shade8 with Double = js.native
    /* 0 */ val Unshaded: typingsJapgolly.officeUiFabricReact.shadesMod.Shade.Unshaded with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.officeUiFabricReact.shadesMod.Shade with Double] = js.native
  }
