...
import typingsJapgolly.officeUiFabricReact.libComponentsDialogDialogContentDotbaseMod.DialogContentBase
...
object libComponentsDialogDialogContentDottypesMod {
  ...
  object IDialogContentProps {
    ...
    extension [Self <: IDialogContentProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDialogContent | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDialogContent | Null) => value(t0).runNow()))
