...
object libLayerMod {
  ...
  open class LayerBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsLayerMod.LayerBase {
  ...
  open class LayerHost protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsLayerMod.LayerHost {
