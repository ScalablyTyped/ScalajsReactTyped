...
object libComponentsTextFieldTextFieldDottypesMod {
  ...
  object ITextField {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(blur = blur.toJsFn, focus = focus.toJsFn, select = select.toJsFn, setSelectionEnd = js.Any.fromFunction1((t0: Double) => setSelectionEnd(t0).runNow()), setSelectionRange = js.Any.fromFunction2((t0: Double, t1: Double) => (setSelectionRange(t0, t1)).runNow()), setSelectionStart = js.Any.fromFunction1((t0: Double) => setSelectionStart(t0).runNow()), selectionEnd = null, selectionStart = null)
    ...
    extension [Self <: ITextField](x: Self) {
      ...
      inline def setSetSelectionEnd(value: Double => Callback): Self = StObject.set(x, "setSelectionEnd", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setSetSelectionRange(value: (Double, Double) => Callback): Self = StObject.set(x, "setSelectionRange", js.Any.fromFunction2((t0: Double, t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setSetSelectionStart(value: Double => Callback): Self = StObject.set(x, "setSelectionStart", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  ...
  object ITextFieldProps {
    ...
    extension [Self <: ITextFieldProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ITextField | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ITextField | Null) => value(t0).runNow()))
      ...
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[(HTMLInputElement | HTMLTextAreaElement) & org.scalajs.dom.Element], t1: /* newValue */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnNotifyValidationResult(value: (/* errorMessage */ String | Element, /* value */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "onNotifyValidationResult", js.Any.fromFunction2((t0: /* errorMessage */ String | Element, t1: /* value */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
