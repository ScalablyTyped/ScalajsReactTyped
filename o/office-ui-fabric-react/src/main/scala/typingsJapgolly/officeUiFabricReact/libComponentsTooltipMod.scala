...
object libComponentsTooltipMod {
  ...
  open class TooltipBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDotbaseMod.TooltipBase {
  ...
  object TooltipDelay extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipDottypesMod.TooltipDelay & Double
      ] = js.native
  ...
  open class TooltipHostBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDotbaseMod.TooltipHostBase {
