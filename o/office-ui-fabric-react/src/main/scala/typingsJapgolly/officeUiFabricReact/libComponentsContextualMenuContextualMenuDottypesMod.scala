...
import typingsJapgolly.officeUiFabricReact.anon.PartialIContextualMenuIte
...
import typingsJapgolly.officeUiFabricReact.libComponentsContextualMenuContextualMenuItemDottypesMod.IContextualMenuItemRenderFunctions
...
object libComponentsContextualMenuContextualMenuDottypesMod {
  ...
  /* propertyName */ StringDictionary[Any] {
    ...
    var onMouseDown: js.UndefOr[
        js.Function2[/* item */ this.type, /* event */ ReactMouseEventFrom[HTMLElement], Unit]
      ] = js.undefined
  ...
  object IContextualMenuItem {
    ...
    extension [Self <: IContextualMenuItem](x: Self) {
      ...
      inline def setOnMouseDown(value: (IContextualMenuItem, /* event */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction2((t0: IContextualMenuItem, t1: /* event */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseDownUndefined: Self = StObject.set(x, "onMouseDown", js.undefined)
      
      inline def setOnRender(
        value: (/* item */ Any, /* dismissMenu */ js.Function2[/* ev */ js.UndefOr[Any], /* dismissAll */ js.UndefOr[Boolean], Unit]) => Node
      ): Self = StObject.set(x, "onRender", js.Any.fromFunction2(value))
      
      inline def setOnRenderContent(
        value: (/* props */ IContextualMenuItemProps, /* defaultRenders */ IContextualMenuItemRenderFunctions) => Node
  ...
  trait IContextualMenuListProps extends StObject {
    ...
    def defaultMenuItemRenderer(item: IContextualMenuItemRenderProps): Node
  ...
  object IContextualMenuListProps {
    ...
    inline def apply(
      defaultMenuItemRenderer: IContextualMenuItemRenderProps => Node,
      hasCheckmarks: Boolean,
      hasIcons: Boolean,
    ...
    extension [Self <: IContextualMenuListProps](x: Self) {
      ...
      inline def setDefaultMenuItemRenderer(value: IContextualMenuItemRenderProps => Node): Self = StObject.set(x, "defaultMenuItemRenderer", js.Any.fromFunction1(value))
  ...
  trait IContextualMenuProps
    ...
    var onDismiss: js.UndefOr[
        js.Function2[
          /* ev */ js.UndefOr[
            ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element]
          ], 
  ...
  object IContextualMenuProps {
    ...
    extension [Self <: IContextualMenuProps](x: Self) {
      ...
      inline def setOnDismiss(
        value: (/* ev */ js.UndefOr[
              ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element]
            ], /* dismissAll */ js.UndefOr[Boolean]) => Callback
      ): Self = StObject.set(x, "onDismiss", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[
              ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element]
            ], t1: /* dismissAll */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnMenuDismissed(value: /* contextualMenu */ js.UndefOr[IContextualMenuProps] => Callback): Self = StObject.set(x, "onMenuDismissed", js.Any.fromFunction1((t0: /* contextualMenu */ js.UndefOr[IContextualMenuProps]) => value(t0).runNow()))
      
      inline def setOnMenuDismissedUndefined: Self = StObject.set(x, "onMenuDismissed", js.undefined)
      
      inline def setOnMenuOpened(value: /* contextualMenu */ js.UndefOr[IContextualMenuProps] => Callback): Self = StObject.set(x, "onMenuOpened", js.Any.fromFunction1((t0: /* contextualMenu */ js.UndefOr[IContextualMenuProps]) => value(t0).runNow()))
