...
object libComponentsShimmerShimmerDottypesMod {
  ...
  object IShimmerProps {
    ...
    extension [Self <: IShimmerProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IShimmer | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmer | Null) => value(t0).runNow()))
      
      inline def setComponentRefUndefined: Self = StObject.set(x, "componentRef", js.undefined)
      
      inline def setCustomElementsGroup(value: VdomNode): Self = StObject.set(x, "customElementsGroup", value.rawNode.asInstanceOf[js.Any])
      
      inline def setCustomElementsGroupNull: Self = StObject.set(x, "customElementsGroup", null)
      
      inline def setCustomElementsGroupUndefined: Self = StObject.set(x, "customElementsGroup", js.undefined)
      
      inline def setCustomElementsGroupVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "customElementsGroup", js.Array(value*))
      
      inline def setCustomElementsGroupVdomElement(value: VdomElement): Self = StObject.set(x, "customElementsGroup", value.rawElement.asInstanceOf[js.Any])
