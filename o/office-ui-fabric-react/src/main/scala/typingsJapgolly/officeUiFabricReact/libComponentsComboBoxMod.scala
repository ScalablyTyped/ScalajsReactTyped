...
object libComponentsComboBoxMod {
  ...
  open class ComboBox protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsComboBoxComboBoxMod.ComboBox {
  ...
  open class VirtualizedComboBox protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsComboBoxVirtualizedComboBoxMod.VirtualizedComboBox {
    def this(props: IComboBoxProps) = this()
  }
}
