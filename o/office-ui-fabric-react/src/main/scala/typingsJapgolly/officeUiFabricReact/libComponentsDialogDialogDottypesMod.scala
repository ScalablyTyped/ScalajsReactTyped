...
import typingsJapgolly.officeUiFabricReact.libComponentsDialogDialogDotbaseMod.DialogBase
...
object libComponentsDialogDialogDottypesMod {
  ...
  object IDialogProps {
    ...
    extension [Self <: IDialogProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDialog | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDialog | Null) => value(t0).runNow()))
