...
object libUtilitiesPositioningPositioningDottypesMod {
  ...
  trait IRelativePositions extends StObject {
    ...
    var beakPosition: typingsJapgolly.officeUiFabricReact.anon.Position
  ...
  object IRelativePositions {
    ...
    inline def apply(
      beakPosition: typingsJapgolly.officeUiFabricReact.anon.Position,
    ...
    extension [Self <: IRelativePositions](x: Self) {
      ...
      inline def setBeakPosition(value: typingsJapgolly.officeUiFabricReact.anon.Position): Self = StObject.set(x, "beakPosition", value.asInstanceOf[js.Any])
