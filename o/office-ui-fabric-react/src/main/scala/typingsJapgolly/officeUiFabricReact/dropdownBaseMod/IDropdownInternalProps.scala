package typingsJapgolly.officeUiFabricReact.dropdownBaseMod
...
- typingsJapgolly.officeUiFabricReact.withResponsiveModeMod.IWithResponsiveModeState because var conflicts: responsiveMode. Inlined  */ trait IDropdownInternalProps extends IDropdownProps
