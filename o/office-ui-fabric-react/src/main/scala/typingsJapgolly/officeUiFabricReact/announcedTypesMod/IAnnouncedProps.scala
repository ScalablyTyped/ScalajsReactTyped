package typingsJapgolly.officeUiFabricReact.announcedTypesMod
...
import typingsJapgolly.officeUiFabricReact.announcedBaseMod.AnnouncedBase
...
- typingsJapgolly.react.mod.Props because var conflicts: children. Inlined key, ref */ trait IAnnouncedProps extends HTMLAttributes[HTMLDivElement] {
  /**
...
object IAnnouncedProps {
  ...
  def apply(
    ...
    typeof: String = null,
    unselectable: on | typingsJapgolly.react.reactStrings.off = null,
    vocab: String = null
  ): IAnnouncedProps = {
