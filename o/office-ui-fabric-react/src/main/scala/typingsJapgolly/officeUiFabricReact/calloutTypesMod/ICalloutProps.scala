package typingsJapgolly.officeUiFabricReact.calloutTypesMod
...
object ICalloutProps {
  ...
  def apply(
    ...
    onPositioned: /* positions */ js.UndefOr[ICalloutPositionedInfo] => Callback = null,
    ...
    if (onPositioned != null) __obj.updateDynamic("onPositioned")(js.Any.fromFunction1((t0: /* positions */ js.UndefOr[typingsJapgolly.officeUiFabricReact.positioningTypesMod.ICalloutPositionedInfo]) => onPositioned(t0).runNow()))
