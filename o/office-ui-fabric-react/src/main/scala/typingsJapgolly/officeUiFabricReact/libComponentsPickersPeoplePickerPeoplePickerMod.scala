...
import typingsJapgolly.officeUiFabricReact.libComponentsPickersBasePickerMod.BasePickerListBelow
...
object libComponentsPickersPeoplePickerPeoplePickerMod {
  ...
  trait IGenericItem extends StObject {
    ...
    var ValidationState: typingsJapgolly.officeUiFabricReact.libComponentsPickersBasePickerDottypesMod.ValidationState
