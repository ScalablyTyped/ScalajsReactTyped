...
object libComponentsSwatchColorPickerSwatchColorPickerDottypesMod {
  ...
  object ISwatchColorPickerProps {
    ...
    extension [Self <: ISwatchColorPickerProps](x: Self) {
      ...
      inline def setOnCellFocused(value: (/* id */ js.UndefOr[String], /* color */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "onCellFocused", js.Any.fromFunction2((t0: /* id */ js.UndefOr[String], t1: /* color */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      
      inline def setOnCellFocusedUndefined: Self = StObject.set(x, "onCellFocused", js.undefined)
      
      inline def setOnCellHovered(value: (/* id */ js.UndefOr[String], /* color */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "onCellHovered", js.Any.fromFunction2((t0: /* id */ js.UndefOr[String], t1: /* color */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      
      inline def setOnCellHoveredUndefined: Self = StObject.set(x, "onCellHovered", js.undefined)
      
      inline def setOnColorChanged(value: (/* id */ js.UndefOr[String], /* color */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "onColorChanged", js.Any.fromFunction2((t0: /* id */ js.UndefOr[String], t1: /* color */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
