...
object libComponentsStackStackItemStackItemDottypesMod {
  ...
  object IStackItemProps {
    ...
    extension [Self <: IStackItemProps](x: Self) {
      ...
      inline def setShrink(
        value: Boolean | Double | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.inherit | initial | unset
      ): Self = StObject.set(x, "shrink", value.asInstanceOf[js.Any])
