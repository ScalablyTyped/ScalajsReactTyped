...
object libComponentsChoiceGroupChoiceGroupDottypesMod {
  ...
  object IChoiceGroup {
    ...
    inline def apply(focus: Callback): IChoiceGroup = {
  ...
  trait IChoiceGroupProps
    ...
    var onChange_IChoiceGroupProps: js.UndefOr[
        js.Function2[
          /* ev */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & org.scalajs.dom.Element]], 
    ...
    var onChanged: js.UndefOr[
        js.Function2[
          ...
          /* evt */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & org.scalajs.dom.Element]], 
          Unit
        ]
      ] = js.undefined
  ...
  object IChoiceGroupProps {
    ...
    extension [Self <: IChoiceGroupProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IChoiceGroup | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IChoiceGroup | Null) => value(t0).runNow()))
      ...
      inline def setOnChange(
        value: (/* ev */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & org.scalajs.dom.Element]], /* option */ js.UndefOr[IChoiceGroupOption]) => Callback
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & org.scalajs.dom.Element]], t1: /* option */ js.UndefOr[IChoiceGroupOption]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnChanged(
        value: (/* option */ IChoiceGroupOption, /* evt */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & org.scalajs.dom.Element]]) => Callback
      ): Self = StObject.set(x, "onChanged", js.Any.fromFunction2((t0: /* option */ IChoiceGroupOption, t1: /* evt */ js.UndefOr[ReactEventFrom[(HTMLElement | HTMLInputElement) & org.scalajs.dom.Element]]) => (value(t0, t1)).runNow()))
