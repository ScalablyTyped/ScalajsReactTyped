...
- typingsJapgolly.uifabricFoundation.libIcomponentMod.IStyleableComponentProps because var conflicts: className. Inlined styles, theme, tokens */ trait ITextProps
...
object ITextProps {
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ typingsJapgolly.uifabricFoundation.uifabricFoundationStrings.AnonSlots with ITextSlots = null,
