...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`true`
...
object libComponentsNavNavDottypesMod {
  ...
  object INavLink {
    ...
    extension [Self <: INavLink](x: Self) {
      ...
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* item */ js.UndefOr[INavLink]) => (value(t0, t1)).runNow()))
  ...
  object INavLinkGroup {
    ...
    extension [Self <: INavLinkGroup](x: Self) {
      ...
      inline def setOnHeaderClick(
        value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* isCollapsing */ js.UndefOr[Boolean]) => Callback
      ): Self = StObject.set(x, "onHeaderClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* isCollapsing */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
  ...
  object INavProps {
    ...
    extension [Self <: INavProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ INav | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ INav | Null) => value(t0).runNow()))
      ...
      inline def setOnLinkClick(
        value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* item */ js.UndefOr[INavLink]) => Callback
      ): Self = StObject.set(x, "onLinkClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* item */ js.UndefOr[INavLink]) => (value(t0, t1)).runNow()))
      
      inline def setOnLinkClickUndefined: Self = StObject.set(x, "onLinkClick", js.undefined)
      
      inline def setOnLinkExpandClick(
        value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* item */ js.UndefOr[INavLink]) => Callback
      ): Self = StObject.set(x, "onLinkExpandClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* item */ js.UndefOr[INavLink]) => (value(t0, t1)).runNow()))
