...
import typingsJapgolly.officeUiFabricReact.libComponentsSelectedItemsListBaseSelectedItemsListMod.BaseSelectedItemsList
...
object libComponentsSelectedItemsListSelectedPeopleListSelectedPeopleListMod {
  ...
  object ISelectedPeopleItemProps {
    ...
    extension [Self <: ISelectedPeopleItemProps](x: Self) {
      ...
      inline def setOnExpandItem(value: Callback): Self = StObject.set(x, "onExpandItem", value.toJsFn)
  ...
  object ISelectedPeopleProps {
    ...
    extension [Self <: ISelectedPeopleProps](x: Self) {
      ...
      inline def setOnExpandGroup(value: /* item */ IExtendedPersonaProps => Callback): Self = StObject.set(x, "onExpandGroup", js.Any.fromFunction1((t0: /* item */ IExtendedPersonaProps) => value(t0).runNow()))
