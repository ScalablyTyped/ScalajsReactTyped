package typingsJapgolly.officeUiFabricReact.keytipsOverflowExampleMod
...
trait IKeytipsOverflowExampleState extends js.Object {
  var items: js.Array[IOverflowSetItemProps]
  var overflowItems: js.Array[IOverflowSetItemProps]
}
