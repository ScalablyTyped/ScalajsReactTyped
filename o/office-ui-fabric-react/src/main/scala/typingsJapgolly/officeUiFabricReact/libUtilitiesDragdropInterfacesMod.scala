...
import typingsJapgolly.officeUiFabricReact.anon.Dispose
import typingsJapgolly.officeUiFabricReact.libUtilitiesMod.EventGroup
...
object libUtilitiesDragdropInterfacesMod {
  ...
  object IDragDropEvents {
    ...
    extension [Self <: IDragDropEvents](x: Self) {
      ...
      inline def setOnDragEnd(value: (/* item */ js.UndefOr[Any], /* event */ js.UndefOr[DragEvent]) => Callback): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction2((t0: /* item */ js.UndefOr[Any], t1: /* event */ js.UndefOr[DragEvent]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnDragLeave(value: (/* item */ js.UndefOr[Any], /* event */ js.UndefOr[DragEvent]) => Callback): Self = StObject.set(x, "onDragLeave", js.Any.fromFunction2((t0: /* item */ js.UndefOr[Any], t1: /* event */ js.UndefOr[DragEvent]) => (value(t0, t1)).runNow()))
      
      inline def setOnDragLeaveUndefined: Self = StObject.set(x, "onDragLeave", js.undefined)
      
      inline def setOnDragOver(value: (/* item */ js.UndefOr[Any], /* event */ js.UndefOr[DragEvent]) => Callback): Self = StObject.set(x, "onDragOver", js.Any.fromFunction2((t0: /* item */ js.UndefOr[Any], t1: /* event */ js.UndefOr[DragEvent]) => (value(t0, t1)).runNow()))
      
      inline def setOnDragOverUndefined: Self = StObject.set(x, "onDragOver", js.undefined)
      
      inline def setOnDragStart(
        value: (/* item */ js.UndefOr[Any], /* itemIndex */ js.UndefOr[Double], /* selectedItems */ js.UndefOr[js.Array[Any]], /* event */ js.UndefOr[MouseEvent]) => Callback
      ): Self = StObject.set(x, "onDragStart", js.Any.fromFunction4((t0: /* item */ js.UndefOr[Any], t1: /* itemIndex */ js.UndefOr[Double], t2: /* selectedItems */ js.UndefOr[js.Array[Any]], t3: /* event */ js.UndefOr[MouseEvent]) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setOnDragStartUndefined: Self = StObject.set(x, "onDragStart", js.undefined)
      
      inline def setOnDrop(value: (/* item */ js.UndefOr[Any], /* event */ js.UndefOr[DragEvent]) => Callback): Self = StObject.set(x, "onDrop", js.Any.fromFunction2((t0: /* item */ js.UndefOr[Any], t1: /* event */ js.UndefOr[DragEvent]) => (value(t0, t1)).runNow()))
  ...
  object IDragDropHelper {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(dispose = dispose.toJsFn, subscribe = js.Any.fromFunction3(subscribe), unsubscribe = js.Any.fromFunction2((t0: HTMLElement, t1: String) => (unsubscribe(t0, t1)).runNow()))
    ...
    extension [Self <: IDragDropHelper](x: Self) {
      ...
      inline def setUnsubscribe(value: (HTMLElement, String) => Callback): Self = StObject.set(x, "unsubscribe", js.Any.fromFunction2((t0: HTMLElement, t1: String) => (value(t0, t1)).runNow()))
    }
  }
  ...
  trait IDragDropOptions extends StObject {
    ...
    /**
      ...
      */
    var eventMap: js.UndefOr[js.Array[typingsJapgolly.officeUiFabricReact.anon.Callback]] = js.undefined
  ...
  object IDragDropOptions {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], selectionIndex = selectionIndex.asInstanceOf[js.Any], updateDropState = js.Any.fromFunction2((t0: Boolean, t1: DragEvent) => (updateDropState(t0, t1)).runNow()))
    ...
    extension [Self <: IDragDropOptions](x: Self) {
      ...
      inline def setEventMap(value: js.Array[typingsJapgolly.officeUiFabricReact.anon.Callback]): Self = StObject.set(x, "eventMap", value.asInstanceOf[js.Any])
      
      inline def setEventMapUndefined: Self = StObject.set(x, "eventMap", js.undefined)
      
      inline def setEventMapVarargs(value: typingsJapgolly.officeUiFabricReact.anon.Callback*): Self = StObject.set(x, "eventMap", js.Array(value*))
      ...
      inline def setUpdateDropState(value: (Boolean, DragEvent) => Callback): Self = StObject.set(x, "updateDropState", js.Any.fromFunction2((t0: Boolean, t1: DragEvent) => (value(t0, t1)).runNow()))
    }
  }
