...
object libComponentsCoachmarkPositioningContainerPositioningContainerDottypesMod {
  ...
  object IPositioningContainerProps {
    ...
    extension [Self <: IPositioningContainerProps](x: Self) {
      ...
      inline def setOnPositioned(value: /* positions */ js.UndefOr[IPositionedData] => Callback): Self = StObject.set(x, "onPositioned", js.Any.fromFunction1((t0: /* positions */ js.UndefOr[IPositionedData]) => value(t0).runNow()))
