...
@JSImport("office-ui-fabric-react/lib/index.bundle", "DialogBase")
@js.native
open class DialogBase protected ()
  extends typingsJapgolly.officeUiFabricReact.mod.DialogBase {
...
object DialogBase {
  ...
  @JSImport("office-ui-fabric-react/lib/index.bundle", "DialogBase.defaultProps")
  @js.native
