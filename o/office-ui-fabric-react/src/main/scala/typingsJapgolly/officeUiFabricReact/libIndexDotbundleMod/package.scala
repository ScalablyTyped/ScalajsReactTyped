...
import typingsJapgolly.fluentuiTheme.libTypesIanimationstylesMod.IAnimationStyles
import typingsJapgolly.fluentuiTheme.libTypesIanimationstylesMod.IAnimationVariables
...
import typingsJapgolly.officeUiFabricReact.anon.IsAvailable
import typingsJapgolly.officeUiFabricReact.anon.IsMeasured
import typingsJapgolly.officeUiFabricReact.anon.IsSize10
import typingsJapgolly.officeUiFabricReact.anon.PickIPersonaPropsprimaryT
import typingsJapgolly.officeUiFabricReact.anon.RequiredPickIShimmeredDet
import typingsJapgolly.officeUiFabricReact.anon.Target
...
import typingsJapgolly.officeUiFabricReact.libComponentsCalloutFocusTrapCalloutDottypesMod.IFocusTrapCalloutProps
...
import typingsJapgolly.officeUiFabricReact.libComponentsContextualMenuContextualMenuDottypesMod.IMenuItemStyles
...
import typingsJapgolly.officeUiFabricReact.libComponentsDividerVerticalDividerDottypesMod.IVerticalDividerProps
...
import typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardDottypesMod.IDocumentCardProps
...
import typingsJapgolly.officeUiFabricReact.libComponentsHoverCardPlainCardPlainCardDottypesMod.IPlainCardProps
...
import typingsJapgolly.officeUiFabricReact.libComponentsMarqueeSelectionMarqueeSelectionDottypesMod.IMarqueeSelectionProps
...
import typingsJapgolly.officeUiFabricReact.libComponentsSeparatorSeparatorDottypesMod.ISeparatorProps
...
import typingsJapgolly.officeUiFabricReact.libComponentsThemeGeneratorIthemerulesMod.IThemeRules
...
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDottypesMod.ITooltipHostProps
import typingsJapgolly.officeUiFabricReact.libIndexDotbundleMod.^
...
import typingsJapgolly.officeUiFabricReact.libUtilitiesKeytipsKeytipConfigMod.IKeytipConfig
import typingsJapgolly.officeUiFabricReact.libUtilitiesKeytipsKeytipConfigMod.IKeytipConfigItem
import typingsJapgolly.officeUiFabricReact.libUtilitiesKeytipsKeytipConfigMod.IKeytipConfigMap
...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`data-no-horizontal-wrap`
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`data-no-vertical-wrap`
...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.border
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.borderBottom
...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.localStorage
...
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.sessionStorage
...
import typingsJapgolly.uifabricMergeStyles.libIrawstylebaseMod.IFontFace
import typingsJapgolly.uifabricMergeStyles.libIstyleMod.IStyle
import typingsJapgolly.uifabricMergeStyles.libIstyleMod.IStyleBaseArray
import typingsJapgolly.uifabricMergeStyles.libIstylefunctionMod.IStyleFunctionOrObject
import typingsJapgolly.uifabricMergeStyles.libIstylesetMod.IConcatenatedStyleSet
...
import typingsJapgolly.uifabricMergeStyles.libObjectOnlyMod.ObjectOnly
import typingsJapgolly.uifabricStyling.anon.PartialIIconOptions
import typingsJapgolly.uifabricStyling.libClassNamesColorClassNamesMod.IColorClassNames
import typingsJapgolly.uifabricStyling.libInterfacesIgetfocusstylesMod.IGetFocusStylesOptions
import typingsJapgolly.uifabricStyling.libStylesGetGlobalClassNamesMod.GlobalClassNames
import typingsJapgolly.uifabricStyling.libUtilitiesIconsMod.IIconOptions
...
import typingsJapgolly.uifabricUtilities.anon.AsyncPlaceholder
import typingsJapgolly.uifabricUtilities.anon.Configurable
import typingsJapgolly.uifabricUtilities.anon.Focus
import typingsJapgolly.uifabricUtilities.anon.RootRef
import typingsJapgolly.uifabricUtilities.anon.Rtl
import typingsJapgolly.uifabricUtilities.libAsAsyncMod.IAsAsyncOptions
import typingsJapgolly.uifabricUtilities.libBaseComponentDottypesMod.IBaseProps
import typingsJapgolly.uifabricUtilities.libClassNamesFunctionMod.IClassNamesFunctionOptions
import typingsJapgolly.uifabricUtilities.libCssMod.ICssInput
...
import typingsJapgolly.uifabricUtilities.libIsizeMod.ISize
import typingsJapgolly.uifabricUtilities.libMathMod.IFitContentToBoundsOptions
...
import typingsJapgolly.uifabricUtilities.libWarnWarnControlledUsageMod.IWarnControlledUsageParams
import typingsJapgolly.uifabricUtilities.libWarnWarnMod.ISettingsMap
...
])] = ^.asInstanceOf[js.Dynamic].selectDynamic("Fabric").asInstanceOf[ForwardRefExoticComponent[
IFabricProps & (RefAttributes[
  typingsJapgolly.officeUiFabricReact.libComponentsFabricFabricDotbaseMod.FabricBase
])]]
...
inline def allowOverscrollOnElement(element: HTMLElement, events: typingsJapgolly.uifabricUtilities.libEventGroupMod.EventGroup): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("allowOverscrollOnElement")(element.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def allowOverscrollOnElement(element: Null, events: typingsJapgolly.uifabricUtilities.libEventGroupMod.EventGroup): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("allowOverscrollOnElement")(element.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[Unit]

inline def allowScrollOnElement(element: HTMLElement, events: typingsJapgolly.uifabricUtilities.libEventGroupMod.EventGroup): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("allowScrollOnElement")(element.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[Unit]
inline def allowScrollOnElement(element: Null, events: typingsJapgolly.uifabricUtilities.libEventGroupMod.EventGroup): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("allowScrollOnElement")(element.asInstanceOf[js.Any], events.asInstanceOf[js.Any])).asInstanceOf[Unit]
...
(PropsWithoutRef[TProps & AsyncPlaceholder]) & RefAttributes[japgolly.scalajs.react.facade.React.ElementType]] = ^.asInstanceOf[js.Dynamic].applyDynamic("asAsync")(options.asInstanceOf[js.Any]).asInstanceOf[ForwardRefExoticComponent[
(PropsWithoutRef[TProps & AsyncPlaceholder]) & RefAttributes[japgolly.scalajs.react.facade.React.ElementType]]]
...
inline def createGenericItem(
  name: String,
  currentValidationState: typingsJapgolly.officeUiFabricReact.libComponentsPickersBasePickerDottypesMod.ValidationState
...
/* repeated */ js.UndefOr[
  (js.Function1[/* instance */ TType | TValue | Null, Unit]) | (RefHandle[TType | TValue | Null]) | Null
], 
...
inline def getBackgroundShade(color: IColor, shade: typingsJapgolly.officeUiFabricReact.libUtilitiesColorShadesMod.Shade): IColor | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getBackgroundShade")(color.asInstanceOf[js.Any], shade.asInstanceOf[js.Any])).asInstanceOf[IColor | Null]
inline def getBackgroundShade(
  color: IColor,
  shade: typingsJapgolly.officeUiFabricReact.libUtilitiesColorShadesMod.Shade,
  isInverted: Boolean
): IColor | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getBackgroundShade")(color.asInstanceOf[js.Any], shade.asInstanceOf[js.Any], isInverted.asInstanceOf[js.Any])).asInstanceOf[IColor | Null]
...
inline def getBoundsFromTargetWindow(target: org.scalajs.dom.Element, targetWindow: IWindowWithSegments): IRectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("getBoundsFromTargetWindow")(target.asInstanceOf[js.Any], targetWindow.asInstanceOf[js.Any])).asInstanceOf[IRectangle]
...
inline def getBoundsFromTargetWindow(
  target: typingsJapgolly.officeUiFabricReact.libUtilitiesMod.Rectangle,
  targetWindow: IWindowWithSegments
): IRectangle = (^.asInstanceOf[js.Dynamic].applyDynamic("getBoundsFromTargetWindow")(target.asInstanceOf[js.Any], targetWindow.asInstanceOf[js.Any])).asInstanceOf[IRectangle]
...
inline def getDateRangeArray(
  date: js.Date,
  dateRangeType: typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DateRangeType,
  firstDayOfWeek: typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek
...
inline def getDateRangeArray(
  ...
  dateRangeType: typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DateRangeType,
  firstDayOfWeek: typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek,
  workWeekDays: js.Array[typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek]
...
inline def getEdgeChromiumNoHighContrastAdjustSelector(): typingsJapgolly.uifabricStyling.anon.EdgeChromiumHighContrastSelector = ^.asInstanceOf[js.Dynamic].applyDynamic("getEdgeChromiumNoHighContrastAdjustSelector")().asInstanceOf[typingsJapgolly.uifabricStyling.anon.EdgeChromiumHighContrastSelector]
...
inline def getEndDateOfWeek(
  date: js.Date,
  firstDayOfWeek: typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek
): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("getEndDateOfWeek")(date.asInstanceOf[js.Any], firstDayOfWeek.asInstanceOf[js.Any])).asInstanceOf[js.Date]

inline def getFadedOverflowStyle(
  theme: ITheme,
  color: js.UndefOr[
  /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 124, starting with typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.bodyBackground, typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.bodyBackgroundHovered, typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.bodyBackgroundChecked */ Any
],
...
inline def getFontIcon(iconName: String): japgolly.scalajs.react.facade.React.Element | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("getFontIcon")(iconName.asInstanceOf[js.Any]).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
inline def getFontIcon(iconName: String, className: String): japgolly.scalajs.react.facade.React.Element | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getFontIcon")(iconName.asInstanceOf[js.Any], className.asInstanceOf[js.Any])).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
inline def getFontIcon(iconName: String, className: String, ariaLabel: String): japgolly.scalajs.react.facade.React.Element | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getFontIcon")(iconName.asInstanceOf[js.Any], className.asInstanceOf[js.Any], ariaLabel.asInstanceOf[js.Any])).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
inline def getFontIcon(iconName: String, className: Unit, ariaLabel: String): japgolly.scalajs.react.facade.React.Element | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getFontIcon")(iconName.asInstanceOf[js.Any], className.asInstanceOf[js.Any], ariaLabel.asInstanceOf[js.Any])).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
...
inline def getInitialResponsiveMode(): typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode = ^.asInstanceOf[js.Dynamic].applyDynamic("getInitialResponsiveMode")().asInstanceOf[typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode]
...
inline def getMaxHeight(
  ...
  targetEdge: typingsJapgolly.officeUiFabricReact.libCommonDirectionalHintMod.DirectionalHint
...
inline def getOppositeEdge(
  edge: typingsJapgolly.officeUiFabricReact.libUtilitiesPositioningPositioningDottypesMod.RectangleEdge
): typingsJapgolly.officeUiFabricReact.libUtilitiesPositioningPositioningDottypesMod.RectangleEdge = ^.asInstanceOf[js.Dynamic].applyDynamic("getOppositeEdge")(edge.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.officeUiFabricReact.libUtilitiesPositioningPositioningDottypesMod.RectangleEdge]
...
inline def getResponsiveMode(): typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode = ^.asInstanceOf[js.Dynamic].applyDynamic("getResponsiveMode")().asInstanceOf[typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode]
inline def getResponsiveMode(currentWindow: Window): typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode = ^.asInstanceOf[js.Dynamic].applyDynamic("getResponsiveMode")(currentWindow.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode]
...
inline def getShade(color: IColor, shade: typingsJapgolly.officeUiFabricReact.libUtilitiesColorShadesMod.Shade): IColor | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getShade")(color.asInstanceOf[js.Any], shade.asInstanceOf[js.Any])).asInstanceOf[IColor | Null]
inline def getShade(
  color: IColor,
  shade: typingsJapgolly.officeUiFabricReact.libUtilitiesColorShadesMod.Shade,
  isInverted: Boolean
): IColor | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getShade")(color.asInstanceOf[js.Any], shade.asInstanceOf[js.Any], isInverted.asInstanceOf[js.Any])).asInstanceOf[IColor | Null]
...
inline def getStartDateOfWeek(
  date: js.Date,
  firstDayOfWeek: typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek
): js.Date = (^.asInstanceOf[js.Dynamic].applyDynamic("getStartDateOfWeek")(date.asInstanceOf[js.Any], firstDayOfWeek.asInstanceOf[js.Any])).asInstanceOf[js.Date]
...
inline def getWeekNumber(
  date: js.Date,
  firstDayOfWeek: typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.DayOfWeek,
  firstWeekOfYear: typingsJapgolly.fluentuiDateTimeUtilities.libDateValuesDateValuesMod.FirstWeekOfYear
...
inline def getWindow(rootElement: org.scalajs.dom.Element): js.UndefOr[Window] = ^.asInstanceOf[js.Dynamic].applyDynamic("getWindow")(rootElement.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Window]]
...
inline def isValidShade(shade: typingsJapgolly.officeUiFabricReact.libUtilitiesColorShadesMod.Shade): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isValidShade")(shade.asInstanceOf[js.Any]).asInstanceOf[Boolean]
...
inline def on(element: org.scalajs.dom.Element, eventName: String, callback: js.Function1[/* ev */ Event, Unit]): js.Function0[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(element.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Unit]]
inline def on(
...
inline def presenceBoolean(
  presence: typingsJapgolly.officeUiFabricReact.libComponentsPersonaPersonaDottypesMod.PersonaPresence
): IsAvailable = ^.asInstanceOf[js.Dynamic].applyDynamic("presenceBoolean")(presence.asInstanceOf[js.Any]).asInstanceOf[IsAvailable]

inline def raiseClick(target: org.scalajs.dom.Element): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("raiseClick")(target.asInstanceOf[js.Any]).asInstanceOf[Unit]
...
inline def setFocusVisibility(enabled: Boolean, target: org.scalajs.dom.Element): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setFocusVisibility")(enabled.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[Unit]
...
inline def setResponsiveMode(
  responsiveMode: typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode
): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setResponsiveMode")(responsiveMode.asInstanceOf[js.Any]).asInstanceOf[Unit]
...
inline def useResponsiveMode(elementRef: RefHandle[HTMLElement | Null]): typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode = ^.asInstanceOf[js.Dynamic].applyDynamic("useResponsiveMode")(elementRef.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.ResponsiveMode]
