...
object libComponentsCoachmarkCoachmarkDotbaseMod {
  ...
  open class CoachmarkBase protected ()
    ...
    @JSName("dismiss")
    def dismiss_MCoachmarkBase(ev: ReactKeyboardEventFrom[HTMLElement]): Unit = js.native
    @JSName("dismiss")
    def dismiss_MCoachmarkBase(ev: ReactMouseEventFrom[HTMLElement]): Unit = js.native
    @JSName("dismiss")
