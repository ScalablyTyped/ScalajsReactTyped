...
import typingsJapgolly.officeUiFabricReact.AnonSection
...
object IDocPageProps {
  ...
  def apply(
    ...
    if (exampleKnobs != null) __obj.updateDynamic("exampleKnobs")(exampleKnobs.rawElement.asInstanceOf[js.Any])
    ...
    if (related != null) __obj.updateDynamic("related")(related.rawElement.asInstanceOf[js.Any])
