...
object libComponentsColorPickerColorSliderColorSliderDottypesMod {
  ...
  object IColorSliderProps {
    ...
    extension [Self <: IColorSliderProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IColorSlider | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IColorSlider | Null) => value(t0).runNow()))
