...
import typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDotbaseMod.PivotBase
import typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotItemMod.PivotItem
...
object libComponentsPivotPivotDottypesMod {
  ...
  object IPivot {
    ...
    inline def apply(focus: Callback): IPivot = {
  ...
  object IPivotProps {
    ...
    extension [Self <: IPivotProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IPivot | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IPivot | Null) => value(t0).runNow()))
      ...
      inline def setOnLinkClick(
        value: (/* item */ js.UndefOr[PivotItem], /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => Callback
      ): Self = StObject.set(x, "onLinkClick", js.Any.fromFunction2((t0: /* item */ js.UndefOr[PivotItem], t1: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.links
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.tabs
  */
  trait PivotLinkFormatType extends StObject
  object PivotLinkFormatType {
    
    inline def links: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.links = "links".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.links]
    
    inline def tabs: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.tabs = "tabs".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.tabs]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.normal
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.large
  */
  trait PivotLinkSizeType extends StObject
  object PivotLinkSizeType {
    
    inline def large: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.large = "large".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.large]
    
    inline def normal: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.normal = "normal".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.normal]
  }
}
