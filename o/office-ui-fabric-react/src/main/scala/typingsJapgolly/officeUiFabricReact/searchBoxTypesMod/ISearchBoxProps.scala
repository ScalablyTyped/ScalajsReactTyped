...
trait ISearchBoxProps extends InputHTMLAttributes[HTMLInputElement] {
  ...
  var onChange_ISearchBoxProps: js.UndefOr[
    js.Function2[
      /* event */ js.UndefOr[ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement]], 
...
object ISearchBoxProps {
  ...
  def apply(
    ...
    onChange: (/* event */ js.UndefOr[ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement]], /* newValue */ js.UndefOr[String]) => Callback = null,
