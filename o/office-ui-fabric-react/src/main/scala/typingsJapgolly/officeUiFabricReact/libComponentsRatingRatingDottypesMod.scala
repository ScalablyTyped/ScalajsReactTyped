...
object libComponentsRatingRatingDottypesMod {
  ...
  trait IRatingProps
    ...
    var onChange_IRatingProps: js.UndefOr[
        js.Function2[/* event */ ReactFocusEventFrom[HTMLElement], /* rating */ js.UndefOr[Double], Unit]
      ] = js.undefined
  ...
  object IRatingProps {
    ...
    extension [Self <: IRatingProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IRating | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IRating | Null) => value(t0).runNow()))
      ...
      inline def setOnChange(value: (/* event */ ReactFocusEventFrom[HTMLElement], /* rating */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* event */ ReactFocusEventFrom[HTMLElement], t1: /* rating */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnChanged(value: /* rating */ Double => Callback): Self = StObject.set(x, "onChanged", js.Any.fromFunction1((t0: /* rating */ Double) => value(t0).runNow()))
      
      inline def setOnChangedUndefined: Self = StObject.set(x, "onChanged", js.undefined)
      
      inline def setOnRenderStar(
        value: (/* props */ js.UndefOr[IRatingStarProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IRatingStarProps], Element | Null]]) => Element | Null
