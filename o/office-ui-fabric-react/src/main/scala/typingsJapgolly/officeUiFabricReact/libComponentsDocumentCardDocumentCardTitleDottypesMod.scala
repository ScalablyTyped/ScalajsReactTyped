...
import typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardTitleDotbaseMod.DocumentCardTitleBase
...
object libComponentsDocumentCardDocumentCardTitleDottypesMod {
  ...
  object IDocumentCardTitleProps {
    ...
    extension [Self <: IDocumentCardTitleProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDocumentCardTitle | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDocumentCardTitle | Null) => value(t0).runNow()))
