...
object libComponentsShimmerShimmerElementsGroupShimmerElementsGroupDottypesMod {
  ...
  object IShimmerElementsGroupProps {
    ...
    extension [Self <: IShimmerElementsGroupProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IShimmerElementsGroup | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmerElementsGroup | Null) => value(t0).runNow()))
