...
object libComponentsBreadcrumbBreadcrumbDottypesMod {
  ...
  object IBreadcrumb {
    ...
    inline def apply(focus: Callback): IBreadcrumb = {
  ...
  object IBreadcrumbItem {
    ...
    extension [Self <: IBreadcrumbItem](x: Self) {
      ...
      inline def setOnClick(
        value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* item */ js.UndefOr[IBreadcrumbItem]) => Callback
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* item */ js.UndefOr[IBreadcrumbItem]) => (value(t0, t1)).runNow()))
  ...
  object IBreadcrumbProps {
    ...
    extension [Self <: IBreadcrumbProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IBreadcrumb | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IBreadcrumb | Null) => value(t0).runNow()))
