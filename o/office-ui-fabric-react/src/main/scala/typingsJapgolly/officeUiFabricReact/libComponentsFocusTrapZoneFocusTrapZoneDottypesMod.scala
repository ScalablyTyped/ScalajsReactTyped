...
object libComponentsFocusTrapZoneFocusTrapZoneDottypesMod {
  ...
  object IFocusTrapZone {
    ...
    inline def apply(focus: Callback): IFocusTrapZone = {
  ...
  object IFocusTrapZoneProps {
    ...
    extension [Self <: IFocusTrapZoneProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IFocusTrapZone | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IFocusTrapZone | Null) => value(t0).runNow()))
      ...
      inline def setFirstFocusableSelectorCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "firstFocusableSelector", value.toJsFn)
