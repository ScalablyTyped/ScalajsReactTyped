...
object libComponentsPivotMod {
  ...
  open class PivotBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotDotbaseMod.PivotBase {
  ...
  open class PivotItem protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsPivotPivotItemMod.PivotItem {
