...
object IColumn {
  ...
  def apply(
    ...
    getValueKey: (/* item */ js.UndefOr[js.Any], /* index */ js.UndefOr[Double], /* column */ js.UndefOr[IColumn]) => CallbackTo[String] = null,
    ...
    onColumnContextMenu: (/* column */ js.UndefOr[IColumn], /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => Callback = null,
    onColumnResize: /* width */ js.UndefOr[Double] => Callback = null,
    onRender: (/* item */ js.UndefOr[js.Any], /* index */ js.UndefOr[Double], /* column */ js.UndefOr[IColumn]) => CallbackTo[js.Any] = null,
    onRenderDivider: (/* props */ js.UndefOr[IDetailsColumnProps], /* defaultRender */ js.UndefOr[js.Function1[/* props */ js.UndefOr[IDetailsColumnProps], Element | Null]]) => CallbackTo[Element | Null] = null,
    ...
    if (getValueKey != null) __obj.updateDynamic("getValueKey")(js.Any.fromFunction3((t0: /* item */ js.UndefOr[js.Any], t1: /* index */ js.UndefOr[scala.Double], t2: /* column */ js.UndefOr[typingsJapgolly.officeUiFabricReact.detailsListTypesMod.IColumn]) => getValueKey(t0, t1, t2).runNow()))
    ...
    if (onColumnContextMenu != null) __obj.updateDynamic("onColumnContextMenu")(js.Any.fromFunction2((t0: /* column */ js.UndefOr[typingsJapgolly.officeUiFabricReact.detailsListTypesMod.IColumn], t1: /* ev */ js.UndefOr[japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement]]) => onColumnContextMenu(t0, t1).runNow()))
    if (onColumnResize != null) __obj.updateDynamic("onColumnResize")(js.Any.fromFunction1((t0: /* width */ js.UndefOr[scala.Double]) => onColumnResize(t0).runNow()))
    if (onRender != null) __obj.updateDynamic("onRender")(js.Any.fromFunction3((t0: /* item */ js.UndefOr[js.Any], t1: /* index */ js.UndefOr[scala.Double], t2: /* column */ js.UndefOr[typingsJapgolly.officeUiFabricReact.detailsListTypesMod.IColumn]) => onRender(t0, t1, t2).runNow()))
    if (onRenderDivider != null) __obj.updateDynamic("onRenderDivider")(js.Any.fromFunction2((t0: /* props */ js.UndefOr[typingsJapgolly.officeUiFabricReact.detailsColumnTypesMod.IDetailsColumnProps], t1: /* defaultRender */ js.UndefOr[
  js.Function1[
    /* props */ js.UndefOr[typingsJapgolly.officeUiFabricReact.detailsColumnTypesMod.IDetailsColumnProps], 
    japgolly.scalajs.react.raw.React.Element | scala.Null
  ]]) => onRenderDivider(t0, t1).runNow()))
