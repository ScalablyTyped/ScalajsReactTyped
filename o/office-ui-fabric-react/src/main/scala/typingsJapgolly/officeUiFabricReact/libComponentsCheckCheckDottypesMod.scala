...
object libComponentsCheckCheckDottypesMod {
  ...
  object ICheckProps {
    ...
    extension [Self <: ICheckProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ICheckProps | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ICheckProps | Null) => value(t0).runNow()))
