...
object libComponentsSwatchColorPickerColorPickerGridCellDottypesMod {
  ...
  object IColorPickerGridCellProps {
    ...
    extension [Self <: IColorPickerGridCellProps](x: Self) {
      ...
      inline def setOnClick(value: /* item */ IColorCellProps => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* item */ IColorCellProps) => value(t0).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnFocus(value: /* item */ IColorCellProps => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* item */ IColorCellProps) => value(t0).runNow()))
      
      inline def setOnFocusUndefined: Self = StObject.set(x, "onFocus", js.undefined)
      
      inline def setOnHover(value: /* item */ js.UndefOr[IColorCellProps] => Callback): Self = StObject.set(x, "onHover", js.Any.fromFunction1((t0: /* item */ js.UndefOr[IColorCellProps]) => value(t0).runNow()))
