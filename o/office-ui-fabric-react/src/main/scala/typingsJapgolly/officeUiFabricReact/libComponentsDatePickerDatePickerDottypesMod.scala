...
object libComponentsDatePickerDatePickerDottypesMod {
  ...
  object IDatePicker {
    ...
    inline def apply(focus: Callback, reset: Callback): IDatePicker = {
      val __obj = js.Dynamic.literal(focus = focus.toJsFn, reset = reset.toJsFn)
  ...
  object IDatePickerProps {
    ...
    extension [Self <: IDatePickerProps](x: Self) {
      ...
      inline def setOnSelectDate(value: /* date */ js.UndefOr[js.Date | Null] => Callback): Self = StObject.set(x, "onSelectDate", js.Any.fromFunction1((t0: /* date */ js.UndefOr[js.Date | Null]) => value(t0).runNow()))
