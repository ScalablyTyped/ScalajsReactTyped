...
object libComponentsFloatingPickerBaseFloatingPickerDottypesMod {
  ...
  object IBaseFloatingPickerSuggestionProps {
    ...
    extension [Self <: IBaseFloatingPickerSuggestionProps](x: Self) {
      ...
      inline def setShouldSelectFirstItem(value: CallbackTo[Boolean]): Self = StObject.set(x, "shouldSelectFirstItem", value.toJsFn)
