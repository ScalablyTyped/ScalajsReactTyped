...
object libComponentsImageImageDottypesMod {
  ...
  object IImageProps {
    ...
    extension [Self <: IImageProps](x: Self) {
      ...
      inline def setOnLoadingStateChange(value: /* loadState */ ImageLoadState => Callback): Self = StObject.set(x, "onLoadingStateChange", js.Any.fromFunction1((t0: /* loadState */ ImageLoadState) => value(t0).runNow()))
