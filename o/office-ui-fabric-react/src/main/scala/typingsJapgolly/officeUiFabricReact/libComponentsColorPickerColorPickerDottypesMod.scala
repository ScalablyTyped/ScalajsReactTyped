...
object libComponentsColorPickerColorPickerDottypesMod {
  ...
  object IColorPickerProps {
    ...
    extension [Self <: IColorPickerProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IColorPicker | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IColorPicker | Null) => value(t0).runNow()))
      ...
      inline def setOnChange(value: (/* ev */ ReactEventFrom[HTMLElement], /* color */ IColor) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* ev */ ReactEventFrom[HTMLElement], t1: /* color */ IColor) => (value(t0, t1)).runNow()))
