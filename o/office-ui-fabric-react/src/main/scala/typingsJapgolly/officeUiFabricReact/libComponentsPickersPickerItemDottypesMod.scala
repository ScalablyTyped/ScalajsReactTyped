...
object libComponentsPickersPickerItemDottypesMod {
  ...
  object IPickerItemProps {
    ...
    extension [Self <: IPickerItemProps[?], T](x: Self & IPickerItemProps[T]) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IPickerItem | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IPickerItem | Null) => value(t0).runNow()))
      ...
      inline def setOnItemChange(value: (/* item */ T, /* index */ Double) => Callback): Self = StObject.set(x, "onItemChange", js.Any.fromFunction2((t0: /* item */ T, t1: /* index */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnItemChangeUndefined: Self = StObject.set(x, "onItemChange", js.undefined)
      
      inline def setOnRemoveItem(value: Callback): Self = StObject.set(x, "onRemoveItem", value.toJsFn)
