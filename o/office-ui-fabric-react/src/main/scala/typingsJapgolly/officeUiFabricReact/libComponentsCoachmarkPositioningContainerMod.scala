...
object libComponentsCoachmarkPositioningContainerMod {
  ...
  open class PositioningContainer protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsCoachmarkPositioningContainerPositioningContainerMod.PositioningContainer {
