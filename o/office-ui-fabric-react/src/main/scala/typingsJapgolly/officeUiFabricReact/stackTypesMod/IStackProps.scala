package typingsJapgolly.officeUiFabricReact.stackTypesMod
...
import typingsJapgolly.uifabricFoundation.AnonSlots
...
- typingsJapgolly.uifabricFoundation.libIcomponentMod.IStyleableComponentProps because var conflicts: className. Inlined styles, theme, tokens */ trait IStackProps
  ...
  /**
    ...
    */
  var as: js.UndefOr[ReactType[HTMLAttributes[org.scalajs.dom.raw.HTMLElement]]] = js.undefined
  /**
...
object IStackProps {
  ...
  def apply(
    ...
    as: ReactType[HTMLAttributes[org.scalajs.dom.raw.HTMLElement]] = null,
    ...
    color: String = null,
    contentEditable: Booleanish | typingsJapgolly.react.reactStrings.inherit = null,
  ...
  {[ key in keyof TSlots ]:? @uifabric/foundation.@uifabric/foundation/lib/ISlots.ISlotOptions<@uifabric/foundation.@uifabric/foundation/lib/ISlots.ExtractProps<TSlots[key]>>}
    */ typingsJapgolly.uifabricFoundation.uifabricFoundationStrings.AnonSlots with IStackSlots = null,
