...
object libUtilitiesKeytipsMod {
  ...
  open class KeytipManager ()
    extends typingsJapgolly.officeUiFabricReact.libUtilitiesKeytipsKeytipManagerMod.KeytipManager
  /* static members */
  object KeytipManager {
    ...
    /**
      ...
      */
    inline def getInstance(): typingsJapgolly.officeUiFabricReact.libUtilitiesKeytipsKeytipManagerMod.KeytipManager = ^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")().asInstanceOf[typingsJapgolly.officeUiFabricReact.libUtilitiesKeytipsKeytipManagerMod.KeytipManager]
  }
