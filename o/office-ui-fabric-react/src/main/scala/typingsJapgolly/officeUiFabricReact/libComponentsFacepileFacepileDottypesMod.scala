...
import typingsJapgolly.officeUiFabricReact.libComponentsFacepileFacepileDotbaseMod.FacepileBase
...
object libComponentsFacepileFacepileDottypesMod {
  ...
  object IFacepilePersona {
    ...
    extension [Self <: IFacepilePersona](x: Self) {
      ...
      inline def setOnClick(
        value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* persona */ js.UndefOr[IFacepilePersona]) => Callback
      ): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* persona */ js.UndefOr[IFacepilePersona]) => (value(t0, t1)).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnMouseMove(
        value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* persona */ js.UndefOr[IFacepilePersona]) => Callback
      ): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* persona */ js.UndefOr[IFacepilePersona]) => (value(t0, t1)).runNow()))
      
      inline def setOnMouseMoveUndefined: Self = StObject.set(x, "onMouseMove", js.undefined)
      
      inline def setOnMouseOut(
        value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* persona */ js.UndefOr[IFacepilePersona]) => Callback
      ): Self = StObject.set(x, "onMouseOut", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* persona */ js.UndefOr[IFacepilePersona]) => (value(t0, t1)).runNow()))
  ...
  object IFacepileProps {
    ...
    extension [Self <: IFacepileProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IFacepile | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IFacepile | Null) => value(t0).runNow()))
