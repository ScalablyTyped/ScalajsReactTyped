...
import typingsJapgolly.officeUiFabricReact.libComponentsLayerLayerDotbaseMod.LayerBase
...
object libComponentsLayerLayerDottypesMod {
  ...
  object ILayerProps {
    ...
    extension [Self <: ILayerProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ILayer | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ILayer | Null) => value(t0).runNow()))
      ...
      inline def setOnLayerWillUnmount(value: Callback): Self = StObject.set(x, "onLayerWillUnmount", value.toJsFn)
