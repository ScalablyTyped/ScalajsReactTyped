...
object libSwatchColorPickerMod {
  ...
  open class ColorPickerGridCellBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsSwatchColorPickerMod.ColorPickerGridCellBase {
  ...
  open class SwatchColorPickerBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsSwatchColorPickerMod.SwatchColorPickerBase {
