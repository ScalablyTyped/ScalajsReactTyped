...
object libComponentsCheckboxCheckboxDottypesMod {
  ...
  object ICheckbox {
    ...
    inline def apply(checked: Boolean, focus: Callback, indeterminate: Boolean): ICheckbox = {
      val __obj = js.Dynamic.literal(checked = checked.asInstanceOf[js.Any], focus = focus.toJsFn, indeterminate = indeterminate.asInstanceOf[js.Any])
  ...
  object ICheckboxProps {
    ...
    extension [Self <: ICheckboxProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ICheckbox | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ICheckbox | Null) => value(t0).runNow()))
