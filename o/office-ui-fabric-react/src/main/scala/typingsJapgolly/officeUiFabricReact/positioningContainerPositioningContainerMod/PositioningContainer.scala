package typingsJapgolly.officeUiFabricReact.positioningContainerPositioningContainerMod
...
class PositioningContainer protected () extends BaseComponent[IPositioningContainerProps, IPositioningContainerState] {
  ...
  def onResize(ev: typingsJapgolly.react.mod.MouseEvent[HTMLElement, MouseEvent]): Unit = js.native
  def onResize(ev: Event_): Unit = js.native
}
