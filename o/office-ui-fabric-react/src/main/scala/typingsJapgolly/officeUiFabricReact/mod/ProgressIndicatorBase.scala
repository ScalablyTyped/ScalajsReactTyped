...
open class ProgressIndicatorBase protected ()
  extends typingsJapgolly.officeUiFabricReact.libProgressIndicatorMod.ProgressIndicatorBase {
...
object ProgressIndicatorBase {
  ...
  @JSImport("office-ui-fabric-react", "ProgressIndicatorBase.defaultProps")
  @js.native
