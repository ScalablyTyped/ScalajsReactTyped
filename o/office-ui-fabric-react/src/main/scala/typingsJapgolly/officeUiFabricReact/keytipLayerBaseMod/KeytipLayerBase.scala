package typingsJapgolly.officeUiFabricReact.keytipLayerBaseMod
...
import typingsJapgolly.officeUiFabricReact.keytipTreeMod.KeytipTree
...
class KeytipLayerBase protected () extends BaseComponent[IKeytipLayerProps, IKeytipLayerState] {
  ...
  def processInput(key: String, ev: ReactKeyboardEventFrom[HTMLElement]): Unit = js.native
  /**
  ...
  def processTransitionInput(transitionKey: IKeytipTransitionKey, ev: ReactKeyboardEventFrom[HTMLElement]): Unit = js.native
  /**
