...
object libComponentsColorPickerColorRectangleColorRectangleDottypesMod {
  ...
  object IColorRectangleProps {
    ...
    extension [Self <: IColorRectangleProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IColorRectangle | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IColorRectangle | Null) => value(t0).runNow()))
