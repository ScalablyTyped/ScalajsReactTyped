...
object libTextFieldMod {
  ...
  open class MaskedTextField protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsTextFieldMod.MaskedTextField {
  ...
  open class TextFieldBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsTextFieldMod.TextFieldBase {
