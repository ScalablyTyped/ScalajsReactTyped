...
import typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsColumnDotbaseMod.DetailsColumnBase
...
object libComponentsDetailsListDetailsColumnDottypesMod {
  ...
  trait IDetailsColumnProps
    ...
    /**
      ...
      */
    var updateDragInfo: js.UndefOr[js.Function2[/* props */ ItemIndex, /* event */ js.UndefOr[MouseEvent], Unit]] = js.undefined
  ...
  object IDetailsColumnProps {
    ...
    extension [Self <: IDetailsColumnProps](x: Self) {
      ...
      inline def setComponentRef(value: Callback): Self = StObject.set(x, "componentRef", value.toJsFn)
      ...
      inline def setOnColumnClick(value: (/* ev */ ReactMouseEventFrom[HTMLElement], /* column */ IColumn) => Callback): Self = StObject.set(x, "onColumnClick", js.Any.fromFunction2((t0: /* ev */ ReactMouseEventFrom[HTMLElement], t1: /* column */ IColumn) => (value(t0, t1)).runNow()))
      
      inline def setOnColumnClickUndefined: Self = StObject.set(x, "onColumnClick", js.undefined)
      
      inline def setOnColumnContextMenu(value: (/* column */ IColumn, /* ev */ ReactMouseEventFrom[HTMLElement]) => Callback): Self = StObject.set(x, "onColumnContextMenu", js.Any.fromFunction2((t0: /* column */ IColumn, t1: /* ev */ ReactMouseEventFrom[HTMLElement]) => (value(t0, t1)).runNow()))
      ...
      inline def setSetDraggedItemIndex(value: /* itemIndex */ Double => Callback): Self = StObject.set(x, "setDraggedItemIndex", js.Any.fromFunction1((t0: /* itemIndex */ Double) => value(t0).runNow()))
      ...
      inline def setUpdateDragInfo(value: (/* props */ ItemIndex, /* event */ js.UndefOr[MouseEvent]) => Callback): Self = StObject.set(x, "updateDragInfo", js.Any.fromFunction2((t0: /* props */ ItemIndex, t1: /* event */ js.UndefOr[MouseEvent]) => (value(t0, t1)).runNow()))
