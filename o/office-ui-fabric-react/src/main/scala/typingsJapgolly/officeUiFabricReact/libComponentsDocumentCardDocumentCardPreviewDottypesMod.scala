...
object libComponentsDocumentCardDocumentCardPreviewDottypesMod {
  ...
  object IDocumentCardPreviewProps {
    ...
    extension [Self <: IDocumentCardPreviewProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDocumentCardPreview | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDocumentCardPreview | Null) => value(t0).runNow()))
