...
import typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDotbaseMod.TooltipHostBase
...
object libComponentsTooltipTooltipHostDottypesMod {
  ...
  object TooltipOverflowMode extends StObject {
    ...
    /* 0 */ val Parent: typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDottypesMod.TooltipOverflowMode.Parent & Double = js.native
    ...
    sealed trait Self
      extends StObject
         with TooltipOverflowMode
    /* 1 */ val Self: typingsJapgolly.officeUiFabricReact.libComponentsTooltipTooltipHostDottypesMod.TooltipOverflowMode.Self & Double = js.native
  }
  ...
  object ITooltipHost {
    ...
    inline def apply(dismiss: Callback, show: Callback): ITooltipHost = {
      val __obj = js.Dynamic.literal(dismiss = dismiss.toJsFn, show = show.toJsFn)
  ...
  object ITooltipHostProps {
    ...
    extension [Self <: ITooltipHostProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ITooltipHost | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ITooltipHost | Null) => value(t0).runNow()))
      ...
      inline def setOnTooltipToggle(value: /* isTooltipVisible */ Boolean => Callback): Self = StObject.set(x, "onTooltipToggle", js.Any.fromFunction1((t0: /* isTooltipVisible */ Boolean) => value(t0).runNow()))
