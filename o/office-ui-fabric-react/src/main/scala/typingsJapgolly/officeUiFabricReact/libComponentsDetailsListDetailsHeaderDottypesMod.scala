...
import typingsJapgolly.officeUiFabricReact.anon.DropLocation
...
import typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsHeaderDotbaseMod.DetailsHeaderBase
...
import typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsRowDottypesMod.IDetailsItemProps
...
object libComponentsDetailsListDetailsHeaderDottypesMod {
  ...
  object IColumnReorderHeaderProps {
    ...
    extension [Self <: IColumnReorderHeaderProps](x: Self) {
      ...
      inline def setOnColumnDragEnd(value: (/* props */ DropLocation, /* event */ MouseEvent) => Callback): Self = StObject.set(x, "onColumnDragEnd", js.Any.fromFunction2((t0: /* props */ DropLocation, t1: /* event */ MouseEvent) => (value(t0, t1)).runNow()))
  ...
  object IDetailsHeader {
    ...
    inline def apply(focus: CallbackTo[Boolean]): IDetailsHeader = {
    ...
    extension [Self <: IDetailsHeader](x: Self) {
      ...
      inline def setFocus(value: CallbackTo[Boolean]): Self = StObject.set(x, "focus", value.toJsFn)
    }
  }
  ...
  object IDetailsHeaderBaseProps {
    ...
    extension [Self <: IDetailsHeaderBaseProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDetailsHeader | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDetailsHeader | Null) => value(t0).runNow()))
      ...
      inline def setOnColumnAutoResized(value: (/* column */ IColumn, /* columnIndex */ Double) => Callback): Self = StObject.set(x, "onColumnAutoResized", js.Any.fromFunction2((t0: /* column */ IColumn, t1: /* columnIndex */ Double) => (value(t0, t1)).runNow()))
      ...
      inline def setOnColumnIsSizingChanged(value: (/* column */ IColumn, /* isSizing */ Boolean) => Callback): Self = StObject.set(x, "onColumnIsSizingChanged", js.Any.fromFunction2((t0: /* column */ IColumn, t1: /* isSizing */ Boolean) => (value(t0, t1)).runNow()))
      
      inline def setOnColumnIsSizingChangedUndefined: Self = StObject.set(x, "onColumnIsSizingChanged", js.undefined)
      
      inline def setOnColumnResized(value: (/* column */ IColumn, /* newWidth */ Double, /* columnIndex */ Double) => Callback): Self = StObject.set(x, "onColumnResized", js.Any.fromFunction3((t0: /* column */ IColumn, t1: /* newWidth */ Double, t2: /* columnIndex */ Double) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnToggleCollapseAll(value: /* isAllCollapsed */ Boolean => Callback): Self = StObject.set(x, "onToggleCollapseAll", js.Any.fromFunction1((t0: /* isAllCollapsed */ Boolean) => value(t0).runNow()))
