...
object libComponentsSpinButtonSpinButtonDottypesMod {
  ...
  object ISpinButton {
    ...
    inline def apply(focus: Callback): ISpinButton = {
  ...
  object ISpinButtonProps {
    ...
    extension [Self <: ISpinButtonProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ISpinButton | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ISpinButton | Null) => value(t0).runNow()))
      ...
      inline def setOnValidate(value: (/* value */ String, /* event */ js.UndefOr[ReactEventFrom[HTMLElement]]) => String | Unit): Self = StObject.set(x, "onValidate", js.Any.fromFunction2(value))
