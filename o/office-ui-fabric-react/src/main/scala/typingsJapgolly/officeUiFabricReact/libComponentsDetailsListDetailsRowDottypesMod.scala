...
import typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsRowDotbaseMod.DetailsRowBase
...
object libComponentsDetailsListDetailsRowDottypesMod {
  ...
  object IDetailsRowBaseProps {
    ...
    extension [Self <: IDetailsRowBaseProps](x: Self) {
      ...
      inline def setCellsByColumn(value: StringDictionary[Node]): Self = StObject.set(x, "cellsByColumn", value.asInstanceOf[js.Any])
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDetailsRow | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDetailsRow | Null) => value(t0).runNow()))
      ...
      inline def setOnDidMount(value: /* row */ js.UndefOr[DetailsRowBase] => Callback): Self = StObject.set(x, "onDidMount", js.Any.fromFunction1((t0: /* row */ js.UndefOr[DetailsRowBase]) => value(t0).runNow()))
      ...
      inline def setOnWillUnmount(value: /* row */ js.UndefOr[DetailsRowBase] => Callback): Self = StObject.set(x, "onWillUnmount", js.Any.fromFunction1((t0: /* row */ js.UndefOr[DetailsRowBase]) => value(t0).runNow()))
