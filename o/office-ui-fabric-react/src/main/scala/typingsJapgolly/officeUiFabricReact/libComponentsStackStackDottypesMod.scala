...
import typingsJapgolly.uifabricFoundation.libIcomponentMod.IComponent
import typingsJapgolly.uifabricFoundation.libIcomponentMod.IStyleableComponentProps
...
import typingsJapgolly.uifabricFoundation.libIhtmlslotsMod.IHTMLSlot
import typingsJapgolly.uifabricFoundation.libIslotsMod.ISlotProp
...
object libComponentsStackStackDottypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.start
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.end
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.center
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-between`
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-around`
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-evenly`
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.baseline
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.stretch
  */
  trait Alignment extends StObject
  object Alignment {
    
    inline def baseline: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.baseline = "baseline".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.baseline]
    
    inline def center: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.center = "center".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.center]
    
    inline def end: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.end = "end".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.end]
    
    inline def `space-around`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-around` = "space-around".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-around`]
    
    inline def `space-between`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-between` = "space-between".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-between`]
    
    inline def `space-evenly`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-evenly` = "space-evenly".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.`space-evenly`]
    
    inline def start: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.start = "start".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.start]
    
    inline def stretch: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.stretch = "stretch".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.stretch]
  }
  ...
  - typingsJapgolly.react.mod.HTMLAttributes because var conflicts: className. Inlined contextMenu, vocab, typeof, inputMode, is, about, accessKey, itemScope, style, security, defaultValue, autoSave, prefix, resource, suppressHydrationWarning, itemType, spellCheck, tabIndex, slot, autoCapitalize, placeholder, radioGroup, id, lang, color, suppressContentEditableWarning, translate, itemID, dir, draggable, contentEditable, itemRef, hidden, inlist, property, defaultChecked, unselectable, role, datatype, itemProp, title, autoCorrect, results */ trait IStackProps
    ...
    /**
      ...
      */
    var grow: js.UndefOr[
        Boolean | Double | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.inherit | initial | unset
      ] = js.undefined
  ...
  object IStackProps {
    ...
    extension [Self <: IStackProps](x: Self) {
      ...
      inline def setGrow(
        value: Boolean | Double | typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.inherit | initial | unset
