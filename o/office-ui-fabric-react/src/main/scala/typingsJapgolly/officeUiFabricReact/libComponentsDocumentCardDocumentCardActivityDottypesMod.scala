...
import typingsJapgolly.officeUiFabricReact.libComponentsDocumentCardDocumentCardActivityDotbaseMod.DocumentCardActivityBase
...
object libComponentsDocumentCardDocumentCardActivityDottypesMod {
  ...
  object IDocumentCardActivityProps {
    ...
    extension [Self <: IDocumentCardActivityProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IDocumentCardActivity | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IDocumentCardActivity | Null) => value(t0).runNow()))
