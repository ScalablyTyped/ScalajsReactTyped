...
object libComponentsCalloutCalloutDottypesMod {
  ...
  trait ICalloutProps
    ...
    var preventDismissOnEvent: js.UndefOr[
        js.Function1[
          /* ev */ Event | ReactFocusEventFrom[Element] | ReactKeyboardEventFrom[Element] | ReactMouseEventFrom[Element], 
          Boolean
        ]
      ] = js.undefined
  ...
  object ICalloutProps {
    ...
    extension [Self <: ICalloutProps](x: Self) {
      ...
      inline def setOnLayerMounted(value: Callback): Self = StObject.set(x, "onLayerMounted", value.toJsFn)
      
      inline def setOnLayerMountedUndefined: Self = StObject.set(x, "onLayerMounted", js.undefined)
      
      inline def setOnPositioned(value: /* positions */ js.UndefOr[ICalloutPositionedInfo] => Callback): Self = StObject.set(x, "onPositioned", js.Any.fromFunction1((t0: /* positions */ js.UndefOr[ICalloutPositionedInfo]) => value(t0).runNow()))
      ...
      inline def setPreventDismissOnEvent(
        value: /* ev */ Event | ReactFocusEventFrom[Element] | ReactKeyboardEventFrom[Element] | ReactMouseEventFrom[Element] => Boolean
