package typingsJapgolly.officeUiFabricReact.baseCardTypesMod
...
trait IBaseCardProps[TComponent, TStyles, TStyleProps] extends HTMLAttributes[HTMLDivElement] {
  ...
  {[ P in keyof TStyles ]: @uifabric/merge-styles.@uifabric/merge-styles/lib/IStyle.IStyle}
    */ typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.IBaseCardProps with js.Any
    ]
  ] = js.undefined
  /**
...
object IBaseCardProps {
  ...
  def apply[TComponent, TStyles, TStyleProps](
    ...
    onEnter: /* ev */ js.UndefOr[js.Any] => Callback = null,
    ...
    onLeave: /* ev */ js.UndefOr[js.Any] => Callback = null,
  ...
  {[ P in keyof TStyles ]: @uifabric/merge-styles.@uifabric/merge-styles/lib/IStyle.IStyle}
    */ typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.IBaseCardProps with js.Any
    ...
    if (onEnter != null) __obj.updateDynamic("onEnter")(js.Any.fromFunction1((t0: /* ev */ js.UndefOr[js.Any]) => onEnter(t0).runNow()))
    ...
    if (onLeave != null) __obj.updateDynamic("onLeave")(js.Any.fromFunction1((t0: /* ev */ js.UndefOr[js.Any]) => onLeave(t0).runNow()))
