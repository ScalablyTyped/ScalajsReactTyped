...
object floatingPickerMod extends js.Object {
  ...
  class BaseFloatingPicker[T, P /* <: IBaseFloatingPickerProps[T] */] protected ()
    extends typingsJapgolly.officeUiFabricReact.baseFloatingPickerMod.BaseFloatingPicker[T, P] {
    def this(basePickerProps: P) = this()
  }
  
  @js.native
  class FloatingPeoplePicker ()
    extends typingsJapgolly.officeUiFabricReact.floatingPeoplePickerMod.FloatingPeoplePicker
  
  @js.native
  class SuggestionsControl[T] protected ()
    extends typingsJapgolly.officeUiFabricReact.suggestionsControlMod.SuggestionsControl[T] {
    def this(suggestionsProps: ISuggestionsControlProps[T]) = this()
  }
  
  @js.native
  class SuggestionsCore[T] protected ()
    extends typingsJapgolly.officeUiFabricReact.suggestionsCoreMod.SuggestionsCore[T] {
  ...
  class SuggestionsStore[T] ()
    extends typingsJapgolly.officeUiFabricReact.suggestionsStoreMod.SuggestionsStore[T] {
