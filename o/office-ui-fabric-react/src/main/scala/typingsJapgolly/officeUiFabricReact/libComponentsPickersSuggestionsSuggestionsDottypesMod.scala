...
object libComponentsPickersSuggestionsSuggestionsDottypesMod {
  ...
  object ISuggestions {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(executeSelectedAction = executeSelectedAction.toJsFn, focusAboveSuggestions = focusAboveSuggestions.toJsFn, focusBelowSuggestions = focusBelowSuggestions.toJsFn, focusSearchForMoreButton = focusSearchForMoreButton.toJsFn, hasSuggestedAction = hasSuggestedAction.toJsFn, hasSuggestedActionSelected = hasSuggestedActionSelected.toJsFn, tryHandleKeyDown = js.Any.fromFunction2(tryHandleKeyDown))
      __obj.asInstanceOf[ISuggestions[T]]
    }
    
    extension [Self <: ISuggestions[?], T](x: Self & ISuggestions[T]) {
      
      inline def setExecuteSelectedAction(value: Callback): Self = StObject.set(x, "executeSelectedAction", value.toJsFn)
      
      inline def setFocusAboveSuggestions(value: Callback): Self = StObject.set(x, "focusAboveSuggestions", value.toJsFn)
      
      inline def setFocusBelowSuggestions(value: Callback): Self = StObject.set(x, "focusBelowSuggestions", value.toJsFn)
      
      inline def setFocusSearchForMoreButton(value: Callback): Self = StObject.set(x, "focusSearchForMoreButton", value.toJsFn)
      
      inline def setHasSuggestedAction(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasSuggestedAction", value.toJsFn)
      
      inline def setHasSuggestedActionSelected(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasSuggestedActionSelected", value.toJsFn)
