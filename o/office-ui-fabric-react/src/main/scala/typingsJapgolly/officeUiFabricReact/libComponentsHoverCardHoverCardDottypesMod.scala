...
object libComponentsHoverCardHoverCardDottypesMod {
  ...
  object IHoverCardProps {
    ...
    extension [Self <: IHoverCardProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IHoverCard | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IHoverCard | Null) => value(t0).runNow()))
      ...
      inline def setOnCardExpand(value: Callback): Self = StObject.set(x, "onCardExpand", value.toJsFn)
      
      inline def setOnCardExpandUndefined: Self = StObject.set(x, "onCardExpand", js.undefined)
      
      inline def setOnCardHide(value: Callback): Self = StObject.set(x, "onCardHide", value.toJsFn)
      
      inline def setOnCardHideUndefined: Self = StObject.set(x, "onCardHide", js.undefined)
      
      inline def setOnCardVisible(value: Callback): Self = StObject.set(x, "onCardVisible", value.toJsFn)
      ...
      inline def setShouldBlockHoverCard(value: Callback): Self = StObject.set(x, "shouldBlockHoverCard", value.toJsFn)
