...
object INavLinkGroup {
  ...
  def apply(
    ...
    name: String = null,
    onHeaderClick: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* isCollapsing */ js.UndefOr[Boolean]) => Callback = null
  ): INavLinkGroup = {
    ...
    if (onHeaderClick != null) __obj.updateDynamic("onHeaderClick")(js.Any.fromFunction2((t0: /* ev */ js.UndefOr[japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement]], t1: /* isCollapsing */ js.UndefOr[scala.Boolean]) => onHeaderClick(t0, t1).runNow()))
