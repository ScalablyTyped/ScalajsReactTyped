...
object INavLink {
  ...
  /* propertyName */ StringDictionary[js.Any] = null,
    ...
    onClick: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* item */ js.UndefOr[INavLink]) => Callback = null,
    target: String = null,
    title: String = null
  ): INavLink = {
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2((t0: /* ev */ js.UndefOr[japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement]], t1: /* item */ js.UndefOr[typingsJapgolly.officeUiFabricReact.navTypesMod.INavLink]) => onClick(t0, t1).runNow()))
