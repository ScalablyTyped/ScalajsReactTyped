...
import typingsJapgolly.officeUiFabricReact.libComponentsAutofillAutofillMod.Autofill
...
object libComponentsAutofillAutofillDottypesMod {
  ...
  object IAutofill {
    ...
    inline def apply(clear: Callback, focus: Callback, isValueSelected: Boolean, value: String): IAutofill = {
      val __obj = js.Dynamic.literal(clear = clear.toJsFn, focus = focus.toJsFn, isValueSelected = isValueSelected.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any], cursorLocation = null, inputElement = null, selectionEnd = null, selectionStart = null)
  ...
  object IAutofillProps {
    ...
    extension [Self <: IAutofillProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IAutofill | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IAutofill | Null) => value(t0).runNow()))
      ...
      inline def setOnInputValueChange(value: (/* newValue */ js.UndefOr[String], /* composing */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "onInputValueChange", js.Any.fromFunction2((t0: /* newValue */ js.UndefOr[String], t1: /* composing */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
      ...
      inline def setShouldSelectFullInputValueInComponentDidUpdate(value: CallbackTo[Boolean]): Self = StObject.set(x, "shouldSelectFullInputValueInComponentDidUpdate", value.toJsFn)
      ...
      inline def setUpdateValueInWillReceiveProps(value: CallbackTo[String | Null]): Self = StObject.set(x, "updateValueInWillReceiveProps", value.toJsFn)
