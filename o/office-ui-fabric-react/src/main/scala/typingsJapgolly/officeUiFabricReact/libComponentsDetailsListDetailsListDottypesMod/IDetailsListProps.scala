...
import typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsListDotbaseMod.DetailsListBase
...
import typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithViewportMod.IWithViewportProps
...
object IDetailsListProps {
  ...
  extension [Self <: IDetailsListProps](x: Self) {
    ...
    inline def setOnActiveItemChanged(
      value: (/* item */ js.UndefOr[Any], /* index */ js.UndefOr[Double], /* ev */ js.UndefOr[ReactFocusEventFrom[HTMLElement]]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onActiveItemChanged", js.Any.fromFunction3((t0: /* item */ js.UndefOr[Any], t1: /* index */ js.UndefOr[Double], t2: /* ev */ js.UndefOr[ReactFocusEventFrom[HTMLElement]]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOnColumnHeaderClick(
      value: (/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], /* column */ js.UndefOr[IColumn]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onColumnHeaderClick", js.Any.fromFunction2((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]], t1: /* column */ js.UndefOr[IColumn]) => (value(t0, t1)).runNow()))
    ...
    inline def setOnColumnHeaderContextMenu(
      value: (/* column */ js.UndefOr[IColumn], /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onColumnHeaderContextMenu", js.Any.fromFunction2((t0: /* column */ js.UndefOr[IColumn], t1: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => (value(t0, t1)).runNow()))
    ...
    inline def setOnColumnResize(
      value: (/* column */ js.UndefOr[IColumn], /* newWidth */ js.UndefOr[Double], /* columnIndex */ js.UndefOr[Double]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onColumnResize", js.Any.fromFunction3((t0: /* column */ js.UndefOr[IColumn], t1: /* newWidth */ js.UndefOr[Double], t2: /* columnIndex */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnColumnResizeUndefined: Self = StObject.set(x, "onColumnResize", js.undefined)
    
    inline def setOnDidUpdate(value: /* detailsList */ js.UndefOr[DetailsListBase] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onDidUpdate", js.Any.fromFunction1((t0: /* detailsList */ js.UndefOr[DetailsListBase]) => value(t0).runNow()))
    ...
    inline def setOnItemInvoked(
      value: (/* item */ js.UndefOr[Any], /* index */ js.UndefOr[Double], /* ev */ js.UndefOr[Event]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onItemInvoked", js.Any.fromFunction3((t0: /* item */ js.UndefOr[Any], t1: /* index */ js.UndefOr[Double], t2: /* ev */ js.UndefOr[Event]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOnRenderMissingItem(value: (/* index */ js.UndefOr[Double], /* rowProps */ js.UndefOr[IDetailsRowProps]) => Node): Self = StObject.set(x, "onRenderMissingItem", js.Any.fromFunction2(value))
    ...
    inline def setOnRowDidMount(
      value: (/* item */ js.UndefOr[Any], /* index */ js.UndefOr[Double]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onRowDidMount", js.Any.fromFunction2((t0: /* item */ js.UndefOr[Any], t1: /* index */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
    
    inline def setOnRowDidMountUndefined: Self = StObject.set(x, "onRowDidMount", js.undefined)
    
    inline def setOnRowWillUnmount(
      value: (/* item */ js.UndefOr[Any], /* index */ js.UndefOr[Double]) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "onRowWillUnmount", js.Any.fromFunction2((t0: /* item */ js.UndefOr[Any], t1: /* index */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
