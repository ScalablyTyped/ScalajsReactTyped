...
import typingsJapgolly.officeUiFabricReact.libComponentsDetailsListDetailsColumnDottypesMod.IDetailsColumnFilterIconProps
...
trait IColumn extends StObject {
  ...
  var onColumnClick: js.UndefOr[
    js.Function2[/* ev */ ReactMouseEventFrom[HTMLElement], /* column */ this.type, Unit]
  ] = js.undefined
...
object IColumn {
  ...
  extension [Self <: IColumn](x: Self) {
    ...
    inline def setOnColumnClick(value: (/* ev */ ReactMouseEventFrom[HTMLElement], IColumn) => Callback): Self = StObject.set(x, "onColumnClick", js.Any.fromFunction2((t0: /* ev */ ReactMouseEventFrom[HTMLElement], t1: IColumn) => (value(t0, t1)).runNow()))
    ...
    ): Self = StObject.set(x, "onColumnContextMenu", js.Any.fromFunction2((t0: /* column */ js.UndefOr[IColumn], t1: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => (value(t0, t1)).runNow()))
    
    inline def setOnColumnContextMenuUndefined: Self = StObject.set(x, "onColumnContextMenu", js.undefined)
    
    inline def setOnColumnResize(value: /* width */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "onColumnResize", js.Any.fromFunction1((t0: /* width */ js.UndefOr[Double]) => value(t0).runNow()))
