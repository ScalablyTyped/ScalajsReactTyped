...
object libUtilitiesKeytipsIkeytiptransitionkeyMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`16`
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`17`
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`18`
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`91`
  */
  trait KeytipTransitionModifier extends StObject
  object KeytipTransitionModifier {
    
    inline def `16`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`16` = 16.asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`16`]
    
    inline def `17`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`17` = 17.asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`17`]
    
    inline def `18`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`18` = 18.asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`18`]
    
    inline def `91`: typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`91` = 91.asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactInts.`91`]
  }
}
