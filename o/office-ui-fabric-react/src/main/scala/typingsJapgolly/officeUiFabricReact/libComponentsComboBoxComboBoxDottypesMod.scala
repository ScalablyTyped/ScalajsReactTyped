...
object libComponentsComboBoxComboBoxDottypesMod {
  ...
  trait IComboBoxProps
    ...
    var onChange_IComboBoxProps: js.UndefOr[
        js.Function4[
          /* event */ ReactEventFrom[IComboBox & Element], 
  ...
  object IComboBoxProps {
    ...
    extension [Self <: IComboBoxProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction4((t0: /* event */ ReactEventFrom[IComboBox & Element], t1: /* option */ js.UndefOr[IComboBoxOption], t2: /* index */ js.UndefOr[Double], t3: /* value */ js.UndefOr[String]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      ): Self = StObject.set(x, "onItemClick", js.Any.fromFunction3((t0: /* event */ ReactEventFrom[IComboBox & Element], t1: /* option */ js.UndefOr[IComboBoxOption], t2: /* index */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnItemClickUndefined: Self = StObject.set(x, "onItemClick", js.undefined)
      
      inline def setOnMenuDismiss(value: Callback): Self = StObject.set(x, "onMenuDismiss", value.toJsFn)
      
      inline def setOnMenuDismissUndefined: Self = StObject.set(x, "onMenuDismiss", js.undefined)
      
      inline def setOnMenuDismissed(value: Callback): Self = StObject.set(x, "onMenuDismissed", value.toJsFn)
      ...
      ): Self = StObject.set(x, "onPendingValueChanged", js.Any.fromFunction3((t0: /* option */ js.UndefOr[IComboBoxOption], t1: /* index */ js.UndefOr[Double], t2: /* value */ js.UndefOr[String]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnScrollToItem(value: /* itemIndex */ Double => Callback): Self = StObject.set(x, "onScrollToItem", js.Any.fromFunction1((t0: /* itemIndex */ Double) => value(t0).runNow()))
