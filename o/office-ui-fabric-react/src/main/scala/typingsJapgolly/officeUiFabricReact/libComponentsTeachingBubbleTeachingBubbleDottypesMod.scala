...
import typingsJapgolly.officeUiFabricReact.libComponentsTeachingBubbleTeachingBubbleContentDotbaseMod.TeachingBubbleContentBase
import typingsJapgolly.officeUiFabricReact.libComponentsTeachingBubbleTeachingBubbleDotbaseMod.TeachingBubbleBase
...
object libComponentsTeachingBubbleTeachingBubbleDottypesMod {
  ...
  object ITeachingBubble {
    ...
    inline def apply(focus: Callback): ITeachingBubble = {
  ...
  object ITeachingBubbleProps {
    ...
    extension [Self <: ITeachingBubbleProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ITeachingBubble | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ITeachingBubble | Null) => value(t0).runNow()))
      ...
      inline def setFooterContentVdomElement(value: VdomElement): Self = StObject.set(x, "footerContent", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnDismiss(value: /* ev */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onDismiss", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
