...
object libComponentsCalendarCalendarDottypesMod {
  ...
  object ICalendar {
    ...
    inline def apply(focus: Callback): ICalendar = {
  ...
  object ICalendarProps {
    ...
    extension [Self <: ICalendarProps](x: Self) {
      ...
      inline def setOnSelectDate(
        value: (/* date */ js.Date, /* selectedDateRangeArray */ js.UndefOr[js.Array[js.Date]]) => Callback
      ): Self = StObject.set(x, "onSelectDate", js.Any.fromFunction2((t0: /* date */ js.Date, t1: /* selectedDateRangeArray */ js.UndefOr[js.Array[js.Date]]) => (value(t0, t1)).runNow()))
