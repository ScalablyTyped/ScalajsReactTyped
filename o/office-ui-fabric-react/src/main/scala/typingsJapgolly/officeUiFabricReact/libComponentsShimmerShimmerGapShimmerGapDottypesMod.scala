...
object libComponentsShimmerShimmerGapShimmerGapDottypesMod {
  ...
  object IShimmerGapProps {
    ...
    extension [Self <: IShimmerGapProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IShimmerGap | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IShimmerGap | Null) => value(t0).runNow()))
