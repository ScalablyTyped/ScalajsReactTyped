package typingsJapgolly.officeUiFabricReact.resizeGroupBaseMod

import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.grow
import typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.shrink
