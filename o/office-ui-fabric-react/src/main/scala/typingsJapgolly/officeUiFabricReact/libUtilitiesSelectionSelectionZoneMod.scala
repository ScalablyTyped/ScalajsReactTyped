...
object libUtilitiesSelectionSelectionZoneMod {
  ...
  object ISelectionZone {
    ...
    inline def apply(ignoreNextFocus: Callback): ISelectionZone = {
      val __obj = js.Dynamic.literal(ignoreNextFocus = ignoreNextFocus.toJsFn)
      __obj.asInstanceOf[ISelectionZone]
    }
    
    extension [Self <: ISelectionZone](x: Self) {
      
      inline def setIgnoreNextFocus(value: Callback): Self = StObject.set(x, "ignoreNextFocus", value.toJsFn)
    }
  }
  ...
  object ISelectionZoneProps {
    ...
    extension [Self <: ISelectionZoneProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onItemInvoked", js.Any.fromFunction3((t0: /* item */ js.UndefOr[IObjectWithKey], t1: /* index */ js.UndefOr[Double], t2: /* ev */ js.UndefOr[Event]) => (value(t0, t1, t2)).runNow()))
