...
import typingsJapgolly.officeUiFabricReact.tooltipHostBaseMod.TooltipHostBase
...
object ITooltipHostProps {
  ...
  def apply(
    ...
    onAbort: ReactEventFrom[
      (org.scalajs.dom.raw.HTMLDivElement | TooltipHostBase) with org.scalajs.dom.raw.Element
    ] => Callback = null,
