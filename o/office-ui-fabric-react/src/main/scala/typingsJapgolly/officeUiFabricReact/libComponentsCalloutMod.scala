...
object libComponentsCalloutMod {
  ...
  open class Callout protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsCalloutCalloutMod.Callout {
  ...
  open class CalloutContentBase protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsCalloutCalloutContentDotbaseMod.CalloutContentBase {
    def this(props: ICalloutProps) = this()
  }
  /* static members */
