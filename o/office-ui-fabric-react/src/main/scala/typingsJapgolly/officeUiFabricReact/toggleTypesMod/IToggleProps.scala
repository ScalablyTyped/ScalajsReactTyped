...
trait IToggleProps extends HTMLAttributes[HTMLElement] {
  ...
  var onChange_IToggleProps: js.UndefOr[
    js.Function2[
      /* event */ ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement], 
...
object IToggleProps {
  ...
  def apply(
    ...
    onChange: (/* event */ ReactMouseEventFrom[org.scalajs.dom.raw.HTMLElement], /* checked */ js.UndefOr[Boolean]) => Callback = null,
