...
object libComponentsDocumentCardDocumentCardDottypesMod {
  ...
  object IDocumentCard {
    ...
    inline def apply(focus: Callback): IDocumentCard = {
  ...
  object IDocumentCardProps {
    ...
    extension [Self <: IDocumentCardProps](x: Self) {
      ...
      inline def setOnClick(value: /* ev */ js.UndefOr[ReactEventFrom[HTMLElement]] => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[ReactEventFrom[HTMLElement]]) => value(t0).runNow()))
