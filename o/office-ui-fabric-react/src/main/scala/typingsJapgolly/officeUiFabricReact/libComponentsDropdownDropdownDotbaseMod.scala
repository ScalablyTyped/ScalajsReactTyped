...
object libComponentsDropdownDropdownDotbaseMod {
  ...
  open class DropdownBase protected ()
    ...
    def setSelectedIndex(event: ReactEventFrom[HTMLDivElement], index: Double): Unit = js.native
  }
  /* static members */
  object DropdownBase {
  ...
  - typingsJapgolly.officeUiFabricReact.libUtilitiesDecoratorsWithResponsiveModeMod.IWithResponsiveModeState because var conflicts: responsiveMode. Inlined  */ trait IDropdownInternalProps
    extends StObject
       with IDropdownProps
