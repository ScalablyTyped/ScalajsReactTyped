...
object libComponentsSpinnerSpinnerDottypesMod {
  ...
  object ISpinnerProps {
    ...
    extension [Self <: ISpinnerProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ ISpinner | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ ISpinner | Null) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.top
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.right
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.bottom
    - typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.left
  */
  trait SpinnerLabelPosition extends StObject
  object SpinnerLabelPosition {
    
    inline def bottom: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.bottom]
    
    inline def left: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.left = "left".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.left]
    
    inline def right: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.right = "right".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.right]
    
    inline def top: typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.top = "top".asInstanceOf[typingsJapgolly.officeUiFabricReact.officeUiFabricReactStrings.top]
  }
}
