...
object swatchColorPickerMod extends js.Object {
  ...
  class ColorPickerGridCellBase ()
    extends typingsJapgolly.officeUiFabricReact.colorPickerGridCellBaseMod.ColorPickerGridCellBase
  
  @js.native
  class SwatchColorPickerBase protected ()
    extends typingsJapgolly.officeUiFabricReact.swatchColorPickerBaseMod.SwatchColorPickerBase {
