...
object libComponentsHoverCardBaseCardDottypesMod {
  ...
  object IBaseCardProps {
    ...
    extension [Self <: IBaseCardProps[?, ?, ?], TComponent, TStyles, TStyleProps](x: Self & (IBaseCardProps[TComponent, TStyles, TStyleProps])) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ TComponent | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ TComponent | Null) => value(t0).runNow()))
      ...
      inline def setOnEnter(value: /* ev */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onEnter", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setOnEnterUndefined: Self = StObject.set(x, "onEnter", js.undefined)
      
      inline def setOnLeave(value: /* ev */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onLeave", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[Any]) => value(t0).runNow()))
