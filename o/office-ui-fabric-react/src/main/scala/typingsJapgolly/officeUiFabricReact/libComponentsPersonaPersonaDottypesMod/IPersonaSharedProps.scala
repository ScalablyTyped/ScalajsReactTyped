...
import typingsJapgolly.officeUiFabricReact.libComponentsPersonaPersonaCoinPersonaCoinDotbaseMod.PersonaCoinBase
import typingsJapgolly.officeUiFabricReact.libComponentsPersonaPersonaDotbaseMod.PersonaBase
...
object IPersonaSharedProps {
  ...
  extension [Self <: IPersonaSharedProps](x: Self) {
    ...
    inline def setOnPhotoLoadingStateChange(value: /* newImageLoadState */ ImageLoadState => Callback): Self = StObject.set(x, "onPhotoLoadingStateChange", js.Any.fromFunction1((t0: /* newImageLoadState */ ImageLoadState) => value(t0).runNow()))
