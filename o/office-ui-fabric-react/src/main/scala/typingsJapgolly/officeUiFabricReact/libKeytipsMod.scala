...
object libKeytipsMod {
  ...
  open class Keytip protected ()
    extends typingsJapgolly.officeUiFabricReact.libComponentsKeytipMod.Keytip {
  ...
  open class KeytipManager ()
    extends typingsJapgolly.officeUiFabricReact.libUtilitiesKeytipsMod.KeytipManager
  /* static members */
