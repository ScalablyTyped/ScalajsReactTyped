  ...
  */
  ...
  object IListOnRenderRootProps {
    ...
    extension [Self <: IListOnRenderRootProps[?], T](x: Self & IListOnRenderRootProps[T]) {
      ...
      inline def setRootRefFunction1(value: HTMLDivElement | Null => Callback): Self = StObject.set(x, "rootRef", js.Any.fromFunction1((t0: HTMLDivElement | Null) => value(t0).runNow()))
      
      inline def setRootRefNull: Self = StObject.set(x, "rootRef", null)
      
      inline def setSurfaceElement(value: VdomElement): Self = StObject.set(x, "surfaceElement", value.rawElement.asInstanceOf[js.Any])
  ...
  object IListOnRenderSurfaceProps {
    ...
    extension [Self <: IListOnRenderSurfaceProps[?], T](x: Self & IListOnRenderSurfaceProps[T]) {
      ...
      inline def setSurfaceRefFunction1(value: HTMLDivElement | Null => Callback): Self = StObject.set(x, "surfaceRef", js.Any.fromFunction1((t0: HTMLDivElement | Null) => value(t0).runNow()))
  ...
  trait IListProps[T]
    extends StObject
       with HTMLAttributes[
          typingsJapgolly.officeUiFabricReact.libComponentsListListMod.List[T] | HTMLDivElement
        ] {
  ...
  object IListProps {
    ...
    extension [Self <: IListProps[?], T](x: Self & IListProps[T]) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IList | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IList | Null) => value(t0).runNow()))
      ...
      inline def setOnPageAdded(value: /* page */ IPage[T] => Callback): Self = StObject.set(x, "onPageAdded", js.Any.fromFunction1((t0: /* page */ IPage[T]) => value(t0).runNow()))
      
      inline def setOnPageAddedUndefined: Self = StObject.set(x, "onPageAdded", js.undefined)
      
      inline def setOnPageRemoved(value: /* page */ IPage[T] => Callback): Self = StObject.set(x, "onPageRemoved", js.Any.fromFunction1((t0: /* page */ IPage[T]) => value(t0).runNow()))
      
      inline def setOnPageRemovedUndefined: Self = StObject.set(x, "onPageRemoved", js.undefined)
      
      inline def setOnPagesUpdated(value: /* pages */ js.Array[IPage[T]] => Callback): Self = StObject.set(x, "onPagesUpdated", js.Any.fromFunction1((t0: /* pages */ js.Array[IPage[T]]) => value(t0).runNow()))
