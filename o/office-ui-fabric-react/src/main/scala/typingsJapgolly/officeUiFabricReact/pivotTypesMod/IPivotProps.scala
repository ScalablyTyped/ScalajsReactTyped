...
import typingsJapgolly.officeUiFabricReact.pivotBaseMod.PivotBase
import typingsJapgolly.officeUiFabricReact.pivotItemMod.PivotItem
...
object IPivotProps {
  ...
  def apply(
    ...
    onLinkClick: (/* item */ js.UndefOr[PivotItem], /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLElement]]) => Callback = null,
