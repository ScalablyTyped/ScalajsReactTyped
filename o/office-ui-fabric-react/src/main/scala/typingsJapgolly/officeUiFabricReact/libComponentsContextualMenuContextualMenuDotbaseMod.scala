...
object libComponentsContextualMenuContextualMenuDotbaseMod {
  ...
  inline def getSubmenuItems(item: IContextualMenuItem, options: typingsJapgolly.officeUiFabricReact.anon.Target): js.UndefOr[js.Array[IContextualMenuItem]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getSubmenuItems")(item.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[js.Array[IContextualMenuItem]]]
