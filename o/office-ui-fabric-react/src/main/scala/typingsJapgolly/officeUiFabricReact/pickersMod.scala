...
object pickersMod extends js.Object {
  ...
  class Autofill protected ()
    extends typingsJapgolly.officeUiFabricReact.baseAutoFillMod.Autofill {
  ...
  class BasePicker[T, P /* <: IBasePickerProps[T] */] protected ()
    extends typingsJapgolly.officeUiFabricReact.basePickerMod.BasePicker[T, P] {
  ...
  class CompactPeoplePickerBase ()
    extends typingsJapgolly.officeUiFabricReact.peoplePickerMod.CompactPeoplePickerBase
  
  @js.native
  class ListPeoplePickerBase ()
    extends typingsJapgolly.officeUiFabricReact.peoplePickerMod.ListPeoplePickerBase
  ...
  class NormalPeoplePickerBase ()
    extends typingsJapgolly.officeUiFabricReact.peoplePickerMod.NormalPeoplePickerBase
  
  @js.native
  class Suggestions[T] protected ()
    extends typingsJapgolly.officeUiFabricReact.suggestionsMod.Suggestions[T] {
    def this(suggestionsProps: ISuggestionsProps[T]) = this()
  }
  
  @js.native
  class SuggestionsController[T] ()
    extends typingsJapgolly.officeUiFabricReact.suggestionsControllerMod.SuggestionsController[T]
  ...
  @js.native
  class TagPickerBase ()
    extends typingsJapgolly.officeUiFabricReact.tagPickerMod.TagPickerBase
