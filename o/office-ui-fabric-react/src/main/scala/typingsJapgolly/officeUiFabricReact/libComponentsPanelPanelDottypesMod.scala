...
object libComponentsPanelPanelDottypesMod {
  ...
  trait IPanelProps
    ...
    /**
      ...
      */
    var onDismiss: js.UndefOr[js.Function1[/* ev */ js.UndefOr[ReactEventFrom[HTMLElement]], Unit]] = js.undefined
    ...
    /**
      ...
      */
    var onOuterClick: js.UndefOr[js.Function1[/* ev */ js.UndefOr[ReactMouseEventFrom[HTMLDivElement]], Unit]] = js.undefined
  ...
  object IPanelProps {
    ...
    extension [Self <: IPanelProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IPanel | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IPanel | Null) => value(t0).runNow()))
      ...
      inline def setOnDismiss(value: /* ev */ js.UndefOr[ReactEventFrom[HTMLElement]] => Callback): Self = StObject.set(x, "onDismiss", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[ReactEventFrom[HTMLElement]]) => value(t0).runNow()))
      
      inline def setOnDismissUndefined: Self = StObject.set(x, "onDismiss", js.undefined)
      
      inline def setOnDismissed(value: Callback): Self = StObject.set(x, "onDismissed", value.toJsFn)
      
      inline def setOnDismissedUndefined: Self = StObject.set(x, "onDismissed", js.undefined)
      
      inline def setOnLightDismissClick(value: Callback): Self = StObject.set(x, "onLightDismissClick", value.toJsFn)
      ...
      inline def setOnOuterClick(value: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLDivElement]] => Callback): Self = StObject.set(x, "onOuterClick", js.Any.fromFunction1((t0: /* ev */ js.UndefOr[ReactMouseEventFrom[HTMLDivElement]]) => value(t0).runNow()))
