...
import typingsJapgolly.officeUiFabricReact.libButtonMod.BaseButton
import typingsJapgolly.officeUiFabricReact.libButtonMod.Button
...
trait IMessageBarProps extends HTMLAttributes[HTMLElement] {
  ...
  var onDismiss: js.UndefOr[
    js.Function1[
      /* ev */ js.UndefOr[
        ReactMouseEventFrom[
          (org.scalajs.dom.raw.HTMLElement | BaseButton | Button) with org.scalajs.dom.raw.Element
        ]
      ], 
      _
    ]
...
object IMessageBarProps {
  ...
  def apply(
    ...
    if (actions != null) __obj.updateDynamic("actions")(actions.rawElement.asInstanceOf[js.Any])
  ...
  japgolly.scalajs.react.ReactMouseEventFrom[
    (org.scalajs.dom.raw.HTMLElement | typingsJapgolly.officeUiFabricReact.libButtonMod.BaseButton | typingsJapgolly.officeUiFabricReact.libButtonMod.Button) with org.scalajs.dom.raw.Element
  ]]) => onDismiss(t0).runNow()))
