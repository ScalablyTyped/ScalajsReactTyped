...
import typingsJapgolly.officeUiFabricReact.libComponentsOverflowSetOverflowSetDotbaseMod.OverflowSetBase
...
object libComponentsOverflowSetOverflowSetDottypesMod {
  ...
  object IOverflowSetProps {
    ...
    extension [Self <: IOverflowSetProps](x: Self) {
      ...
      inline def setComponentRefFunction1(value: /* ref */ IOverflowSet | Null => Callback): Self = StObject.set(x, "componentRef", js.Any.fromFunction1((t0: /* ref */ IOverflowSet | Null) => value(t0).runNow()))
