...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-dom" % "16.9-dt-20200227Z-712121",
  "org.scalablytyped.japgolly" %%% "sinon" % "7.5-dt-20200225Z-52d6ed",
  "org.scalablytyped.japgolly" %%% "std" % "3.8-8884a5",
  "org.scalablytyped.japgolly" %%% "uifabric__foundation" % "7.5.9-ef082a",
  "org.scalablytyped.japgolly" %%% "uifabric__icons" % "7.3.8-d4ee39",
