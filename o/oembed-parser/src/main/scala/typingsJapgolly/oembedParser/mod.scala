...
import typingsJapgolly.oembedParser.oembedParserStrings.link
import typingsJapgolly.oembedParser.oembedParserStrings.photo
import typingsJapgolly.oembedParser.oembedParserStrings.rich
import typingsJapgolly.oembedParser.oembedParserStrings.video
