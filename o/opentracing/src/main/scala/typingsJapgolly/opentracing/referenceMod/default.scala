...
class default protected () extends Reference {
  ...
  /* CompleteClass */
  override var _referencedContext: typingsJapgolly.opentracing.spanContextMod.default = js.native
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def referencedContext(): typingsJapgolly.opentracing.spanContextMod.default = js.native
  /**
