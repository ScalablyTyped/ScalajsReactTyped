...
object libSpanMod {
  ...
  open class Span () extends StObject {
    ...
    /* protected */ def _context(): typingsJapgolly.opentracing.libSpanContextMod.default = js.native
    ...
    /* protected */ def _tracer(): typingsJapgolly.opentracing.libTracerMod.default = js.native
    ...
    /**
      ...
      * @return {SpanContext}
      */
    def context(): typingsJapgolly.opentracing.libSpanContextMod.default = js.native
    ...
    /**
      ...
      * @return {Tracer}
      */
    def tracer(): typingsJapgolly.opentracing.libTracerMod.default = js.native
  }
}
