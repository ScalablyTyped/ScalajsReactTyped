...
object libMockTracerMockTracerMod {
  ...
  open class MockTracer () extends Tracer {
    ...
    /* protected */ def _inject(span: typingsJapgolly.opentracing.libMockTracerMockContextMod.default, format: Any, carrier: Any): scala.Nothing = js.native
    ...
    /**
      ...
      * assertions.
      */
    def report(): typingsJapgolly.opentracing.libMockTracerMockReportMod.default = js.native
  }
}
