...
import typingsJapgolly.opentok.opentokStrings.`1280x720`
import typingsJapgolly.opentok.opentokStrings.`640x480`
...
object Broadcast {
  ...
  extension [Self <: Broadcast](x: Self) {
    ...
    inline def setStop(value: js.Function2[/* error */ js.Error | Null, Broadcast, Unit] => Callback): Self = StObject.set(x, "stop", js.Any.fromFunction1((t0: js.Function2[/* error */ js.Error | Null, Broadcast, Unit]) => value(t0).runNow()))
