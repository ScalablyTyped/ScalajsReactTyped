...
trait Address[ExtendedAddress /* <: js.Object */] extends StObject {
  ...
  var address: js.UndefOr[typingsJapgolly.openidClient.mod.Address[ExtendedAddress]] = js.undefined
...
object Address {
  ...
  extension [Self <: Address[?], ExtendedAddress /* <: js.Object */](x: Self & Address[ExtendedAddress]) {
    ...
    inline def setAddress(value: typingsJapgolly.openidClient.mod.Address[ExtendedAddress]): Self = StObject.set(x, "address", value.asInstanceOf[js.Any])
