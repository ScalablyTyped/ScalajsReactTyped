...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ora.oraStrings.black
    - typingsJapgolly.ora.oraStrings.red
    - typingsJapgolly.ora.oraStrings.green
    - typingsJapgolly.ora.oraStrings.yellow
    - typingsJapgolly.ora.oraStrings.blue
    - typingsJapgolly.ora.oraStrings.magenta
    - typingsJapgolly.ora.oraStrings.cyan
    - typingsJapgolly.ora.oraStrings.white
    - typingsJapgolly.ora.oraStrings.gray
  */
  trait Color extends StObject
  object Color {
    
    inline def black: typingsJapgolly.ora.oraStrings.black = "black".asInstanceOf[typingsJapgolly.ora.oraStrings.black]
    
    inline def blue: typingsJapgolly.ora.oraStrings.blue = "blue".asInstanceOf[typingsJapgolly.ora.oraStrings.blue]
    
    inline def cyan: typingsJapgolly.ora.oraStrings.cyan = "cyan".asInstanceOf[typingsJapgolly.ora.oraStrings.cyan]
    
    inline def gray: typingsJapgolly.ora.oraStrings.gray = "gray".asInstanceOf[typingsJapgolly.ora.oraStrings.gray]
    
    inline def green: typingsJapgolly.ora.oraStrings.green = "green".asInstanceOf[typingsJapgolly.ora.oraStrings.green]
    
    inline def magenta: typingsJapgolly.ora.oraStrings.magenta = "magenta".asInstanceOf[typingsJapgolly.ora.oraStrings.magenta]
    
    inline def red: typingsJapgolly.ora.oraStrings.red = "red".asInstanceOf[typingsJapgolly.ora.oraStrings.red]
    
    inline def white: typingsJapgolly.ora.oraStrings.white = "white".asInstanceOf[typingsJapgolly.ora.oraStrings.white]
    
    inline def yellow: typingsJapgolly.ora.oraStrings.yellow = "yellow".asInstanceOf[typingsJapgolly.ora.oraStrings.yellow]
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setPrefixTextCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "prefixText", value.toJsFn)
