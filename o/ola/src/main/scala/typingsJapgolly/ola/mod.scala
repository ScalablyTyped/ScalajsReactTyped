package typingsJapgolly.ola

import typingsJapgolly.ola.anon.Get
import typingsJapgolly.ola.anon.Set
import typingsJapgolly.ola.anon.Value
import typingsJapgolly.ola.olaStrings.value
