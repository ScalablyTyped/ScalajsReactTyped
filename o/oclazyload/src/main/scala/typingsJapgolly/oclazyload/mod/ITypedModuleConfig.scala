...
import typingsJapgolly.angular.mod.IHttpRequestConfigHeaders
import typingsJapgolly.angular.mod.IHttpRequestTransformer
import typingsJapgolly.angular.mod.IHttpResponseTransformer
