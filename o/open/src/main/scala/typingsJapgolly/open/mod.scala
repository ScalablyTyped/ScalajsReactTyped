...
import typingsJapgolly.open.anon.RecordAppNamestringArrays
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.open.openStrings.chrome
    - typingsJapgolly.open.openStrings.firefox
    - typingsJapgolly.open.openStrings.edge
  */
  trait AppName extends StObject
  object AppName {
    
    inline def chrome: typingsJapgolly.open.openStrings.chrome = "chrome".asInstanceOf[typingsJapgolly.open.openStrings.chrome]
    
    inline def edge: typingsJapgolly.open.openStrings.edge = "edge".asInstanceOf[typingsJapgolly.open.openStrings.edge]
    
    inline def firefox: typingsJapgolly.open.openStrings.firefox = "firefox".asInstanceOf[typingsJapgolly.open.openStrings.firefox]
  }
