...
object buildSrcTypesMod {
  ...
  object SpanKind extends StObject {
    ...
    sealed trait CLIENT
      extends StObject
         with SpanKind
    /* "CLIENT" */ val CLIENT: typingsJapgolly.opentelemetryExporterZipkin.buildSrcTypesMod.SpanKind.CLIENT & String = js.native
    
    @js.native
    sealed trait CONSUMER
      extends StObject
         with SpanKind
    /* "CONSUMER" */ val CONSUMER: typingsJapgolly.opentelemetryExporterZipkin.buildSrcTypesMod.SpanKind.CONSUMER & String = js.native
    
    @js.native
    sealed trait PRODUCER
      extends StObject
         with SpanKind
    /* "PRODUCER" */ val PRODUCER: typingsJapgolly.opentelemetryExporterZipkin.buildSrcTypesMod.SpanKind.PRODUCER & String = js.native
    
    @js.native
    sealed trait SERVER
      extends StObject
         with SpanKind
    /* "SERVER" */ val SERVER: typingsJapgolly.opentelemetryExporterZipkin.buildSrcTypesMod.SpanKind.SERVER & String = js.native
  }
  ...
  object ExporterConfig {
    ...
    extension [Self <: ExporterConfig](x: Self) {
      ...
      inline def setGetExportRequestHeaders(value: CallbackTo[js.UndefOr[Record[String, String]]]): Self = StObject.set(x, "getExportRequestHeaders", value.toJsFn)
