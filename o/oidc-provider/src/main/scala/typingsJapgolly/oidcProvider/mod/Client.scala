...
object Client {
  ...
  inline def apply(
    ...
    includeSid: CallbackTo[Boolean],
    metadata: CallbackTo[ClientMetadata],
  ...
  extension [Self <: Client](x: Self) {
    ...
    inline def setIncludeSid(value: CallbackTo[Boolean]): Self = StObject.set(x, "includeSid", value.toJsFn)
    ...
    inline def setMetadata(value: CallbackTo[ClientMetadata]): Self = StObject.set(x, "metadata", value.toJsFn)
