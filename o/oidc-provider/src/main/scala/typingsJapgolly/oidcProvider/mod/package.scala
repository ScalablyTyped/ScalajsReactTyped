...
import typingsJapgolly.oidcProvider.oidcProviderStrings.none
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.oidcProvider.mod.AsymmetricSigningAlgorithm
  - typingsJapgolly.oidcProvider.mod.SymmetricSigningAlgorithm
  - typingsJapgolly.oidcProvider.mod.NoneAlg
*/
