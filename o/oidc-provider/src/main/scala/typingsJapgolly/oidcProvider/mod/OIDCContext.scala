...
import typingsJapgolly.oidcProvider.anon.AcceptDPoP
import typingsJapgolly.oidcProvider.anon.Get
...
trait OIDCContext extends StObject {
  ...
  val entities: typingsJapgolly.oidcProvider.anon.AccessToken = js.native
