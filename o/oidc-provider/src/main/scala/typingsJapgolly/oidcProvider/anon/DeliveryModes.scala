...
import typingsJapgolly.oidcProvider.mod.CIBADeliveryMode
...
object DeliveryModes {
  ...
  extension [Self <: DeliveryModes](x: Self) {
    ...
    inline def setTriggerAuthenticationDevice(
      value: (/* ctx */ KoaContextWithOIDC, /* request */ BackchannelAuthenticationRequest, /* account */ Account, /* client */ typingsJapgolly.oidcProvider.mod.Client) => CanBePromise[Unit]
