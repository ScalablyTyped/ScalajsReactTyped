...
import typingsJapgolly.oidcProvider.mod.IssueRegistrationAccessTokenFunction
import typingsJapgolly.oidcProvider.mod.KoaContextWithOIDC
import typingsJapgolly.oidcProvider.mod.RotateRegistrationAccessTokenFunction
...
object IssueRegistrationAccessToken {
  ...
  extension [Self <: IssueRegistrationAccessToken](x: Self) {
    ...
    inline def setIssueRegistrationAccessTokenFunction2(
      value: (/* ctx */ KoaContextWithOIDC, /* client */ typingsJapgolly.oidcProvider.mod.Client) => Boolean
    ): Self = StObject.set(x, "issueRegistrationAccessToken", js.Any.fromFunction2(value))
