...
import typingsJapgolly.oidcProvider.mod.ErrorOut
import typingsJapgolly.oidcProvider.mod.KoaContextWithOIDC
import typingsJapgolly.oidcProvider.mod.UnknownObject
import typingsJapgolly.oidcProvider.mod.errors.OIDCProviderError
import typingsJapgolly.oidcProvider.oidcProviderStrings.`base-20`
import typingsJapgolly.oidcProvider.oidcProviderStrings.digits
...
object Charset {
  ...
  extension [Self <: Charset](x: Self) {
    ...
    inline def setUserCodeConfirmSource(
      value: (/* ctx */ KoaContextWithOIDC, /* form */ String, /* client */ typingsJapgolly.oidcProvider.mod.Client, /* deviceInfo */ UnknownObject, /* userCode */ String) => CanBePromise[js.UndefOr[Unit]]
