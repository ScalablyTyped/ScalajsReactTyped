...
import typingsJapgolly.onfleetNodeOnfleet.resourcesDestinationsMod.CreateDestinationProps
import typingsJapgolly.onfleetNodeOnfleet.resourcesRecipientsMod.CreateRecipientProps
import typingsJapgolly.onfleetNodeOnfleet.resourcesTasksMod.Barcode
import typingsJapgolly.onfleetNodeOnfleet.resourcesTasksMod.TaskAutoAssign
import typingsJapgolly.onfleetNodeOnfleet.resourcesTasksMod.TaskCompletionRequirements
import typingsJapgolly.onfleetNodeOnfleet.resourcesTasksMod.TaskContainer
...
object PartialCreateTaskProps {
  ...
  inline def apply(): PartialCreateTaskProps = {
