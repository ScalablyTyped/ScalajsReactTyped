...
import typingsJapgolly.onfleetNodeOnfleet.anon.PartialCreateRecipientPro
...
object resourcesRecipientsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.onfleetNodeOnfleet.onfleetNodeOnfleetStrings.phone
    - typingsJapgolly.onfleetNodeOnfleet.onfleetNodeOnfleetStrings.name
  */
  trait RecipientQueryKey extends StObject
  object RecipientQueryKey {
    
    inline def name: typingsJapgolly.onfleetNodeOnfleet.onfleetNodeOnfleetStrings.name = "name".asInstanceOf[typingsJapgolly.onfleetNodeOnfleet.onfleetNodeOnfleetStrings.name]
    
    inline def phone: typingsJapgolly.onfleetNodeOnfleet.onfleetNodeOnfleetStrings.phone = "phone".asInstanceOf[typingsJapgolly.onfleetNodeOnfleet.onfleetNodeOnfleetStrings.phone]
  }
}
