...
object ojDiagramSettablePropertiesLenient {
  ...
  extension [Self <: ojDiagramSettablePropertiesLenient[?, ?, ?, ?], K1, K2, D1, D2](x: Self & (ojDiagramSettablePropertiesLenient[K1, K2, D1, D2])) {
    ...
    inline def setLayout(value: /* param0 */ DvtDiagramLayoutContext => Callback): Self = StObject.set(x, "layout", js.Any.fromFunction1((t0: /* param0 */ DvtDiagramLayoutContext) => value(t0).runNow()))
