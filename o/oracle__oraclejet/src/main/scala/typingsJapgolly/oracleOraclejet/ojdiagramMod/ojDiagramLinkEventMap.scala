...
object ojDiagramLinkEventMap {
  ...
  inline def apply(
    ...
    emptied: Event,
    endConnectorTypeChanged: CustomEvent,
    endNodeChanged: CustomEvent,
    ended: Event,
    error: ErrorEvent,
    focus: FocusEvent,
    focusin: FocusEvent,
    ...
    slotchange: Event,
    stalled: Event,
    startConnectorTypeChanged: CustomEvent,
    startNodeChanged: CustomEvent,
    submit: SubmitEvent,
    suspend: Event,
  ...
  extension [Self <: ojDiagramLinkEventMap](x: Self) {
    ...
    inline def setEndConnectorTypeChanged(value: CustomEvent): Self = StObject.set(x, "endConnectorTypeChanged", value.asInstanceOf[js.Any])
    
    inline def setEndNodeChanged(value: CustomEvent): Self = StObject.set(x, "endNodeChanged", value.asInstanceOf[js.Any])
    
    inline def setLabelChanged(value: CustomEvent): Self = StObject.set(x, "labelChanged", value.asInstanceOf[js.Any])
    
    inline def setLabelStyleChanged(value: CustomEvent): Self = StObject.set(x, "labelStyleChanged", value.asInstanceOf[js.Any])
    ...
    inline def setStartConnectorTypeChanged(value: CustomEvent): Self = StObject.set(x, "startConnectorTypeChanged", value.asInstanceOf[js.Any])
    
    inline def setStartNodeChanged(value: CustomEvent): Self = StObject.set(x, "startNodeChanged", value.asInstanceOf[js.Any])
