...
object ojDiagramNodeEventMap {
  ...
  extension [Self <: ojDiagramNodeEventMap](x: Self) {
    ...
    inline def setDescendantsConnectivityChanged(value: CustomEvent): Self = StObject.set(x, "descendantsConnectivityChanged", value.asInstanceOf[js.Any])
    
    inline def setIconChanged(value: CustomEvent): Self = StObject.set(x, "iconChanged", value.asInstanceOf[js.Any])
    ...
    inline def setShowDisclosureChanged(value: CustomEvent): Self = StObject.set(x, "showDisclosureChanged", value.asInstanceOf[js.Any])
  }
}
