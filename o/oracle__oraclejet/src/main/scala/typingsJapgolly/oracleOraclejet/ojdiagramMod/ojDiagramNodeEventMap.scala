...
trait ojDiagramNodeEventMap
  ...
  var descendantsConnectivityChanged: CustomEvent
  var iconChanged: CustomEvent
...
object ojDiagramNodeEventMap {
  ...
  def apply(
    ...
    cut: ClipboardEvent,
    dblclick: MouseEvent,
    descendantsConnectivityChanged: CustomEvent,
    drag: DragEvent,
    dragend: DragEvent,
    dragenter: DragEvent,
    dragexit: Event_,
