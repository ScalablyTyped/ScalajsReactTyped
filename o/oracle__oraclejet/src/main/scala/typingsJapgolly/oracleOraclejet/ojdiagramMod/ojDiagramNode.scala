...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.descendantsConnectivity
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.descendantsConnectivityChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.iconChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.showDisclosure
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.showDisclosureChanged
...
trait ojDiagramNode
  extends StObject
     with JetElement[ojDiagramNodeSettableProperties] {
  ...
  @JSName("addEventListener")
  def addEventListener_iconChanged(`type`: iconChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  var onDescendantsConnectivityChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  
  var onIconChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  ...
  var onShowDisclosureChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  ...
  def setProperty(property: descendantsConnectivity, value: connected | disjoint | unknown): Unit = js.native
  def setProperty(property: selectable, value: auto | off): Unit = js.native
  def setProperty(property: showDisclosure, value: on | off): Unit = js.native
