...
import typingsJapgolly.oracleOraclejet.ojinputtextMod.inputBaseEventMap
...
trait ojInputDateEventMap[SP /* <: ojInputDateSettableProperties */]
  extends StObject
     with inputBaseEventMap[String, SP, String, String] {
...
object ojInputDateEventMap {
  ...
  inline def apply[SP /* <: ojInputDateSettableProperties */](
    abort: UIEvent,
  ...
  extension [Self <: ojInputDateEventMap[?], SP /* <: ojInputDateSettableProperties */](x: Self & ojInputDateEventMap[SP]) {
    ...
    inline def setDatePickerChanged(value: CustomEvent): Self = StObject.set(x, "datePickerChanged", value.asInstanceOf[js.Any])
    
    inline def setDayFormatterChanged(value: CustomEvent): Self = StObject.set(x, "dayFormatterChanged", value.asInstanceOf[js.Any])
    
    inline def setDayMetaDataChanged(value: CustomEvent): Self = StObject.set(x, "dayMetaDataChanged", value.asInstanceOf[js.Any])
    
    inline def setKeyboardEditChanged(value: CustomEvent): Self = StObject.set(x, "keyboardEditChanged", value.asInstanceOf[js.Any])
    ...
    inline def setRenderModeChanged(value: CustomEvent): Self = StObject.set(x, "renderModeChanged", value.asInstanceOf[js.Any])
  }
}
