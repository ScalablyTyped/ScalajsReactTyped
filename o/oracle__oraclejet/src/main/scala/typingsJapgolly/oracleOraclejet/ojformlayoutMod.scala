...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.direction
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.directionChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.labelWrapping
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.labelWrappingChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.maxColumns
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.maxColumnsChanged
...
object ojformlayoutMod {
  ...
  trait ojFormLayout
    ...
    def addEventListener(`type`: directionChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    def addEventListener(
      `type`: directionChanged,
      listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any],
      useCapture: Boolean
    ): Unit = js.native
    def addEventListener(`type`: labelEdgeChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    def addEventListener(
      `type`: labelEdgeChanged,
      listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any],
      useCapture: Boolean
    ): Unit = js.native
    def addEventListener(`type`: labelWrappingChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    def addEventListener(
    ...
    @JSName("addEventListener")
    def addEventListener_labelWidthChanged(`type`: labelWidthChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    @JSName("addEventListener")
    def addEventListener_maxColumnsChanged(`type`: maxColumnsChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    var onDirectionChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onLabelEdgeChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onLabelWidthChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onLabelWrappingChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onMaxColumnsChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  ...
  object ojFormLayoutEventMap {
    ...
    extension [Self <: ojFormLayoutEventMap](x: Self) {
      ...
      inline def setDirectionChanged(value: CustomEvent): Self = StObject.set(x, "directionChanged", value.asInstanceOf[js.Any])
      
      inline def setLabelEdgeChanged(value: CustomEvent): Self = StObject.set(x, "labelEdgeChanged", value.asInstanceOf[js.Any])
      
      inline def setLabelWidthChanged(value: CustomEvent): Self = StObject.set(x, "labelWidthChanged", value.asInstanceOf[js.Any])
      
      inline def setLabelWrappingChanged(value: CustomEvent): Self = StObject.set(x, "labelWrappingChanged", value.asInstanceOf[js.Any])
      
      inline def setMaxColumnsChanged(value: CustomEvent): Self = StObject.set(x, "maxColumnsChanged", value.asInstanceOf[js.Any])
    }
  }
