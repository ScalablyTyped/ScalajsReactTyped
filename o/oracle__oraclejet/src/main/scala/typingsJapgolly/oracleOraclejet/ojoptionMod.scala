...
object ojoptionMod {
  ...
  trait ojOption
    extends StObject
       with JetElement[ojOptionSettableProperties] {
  ...
  object ojOptionSettableProperties {
    ...
    inline def apply(disabled: Boolean, value: Any): ojOptionSettableProperties = {
  ...
  object ojOptionSettablePropertiesLenient {
    ...
    inline def apply(): ojOptionSettablePropertiesLenient = {
