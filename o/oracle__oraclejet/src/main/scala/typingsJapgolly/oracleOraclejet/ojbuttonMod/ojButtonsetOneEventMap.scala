...
trait ojButtonsetOneEventMap
  extends StObject
     with baseComponentEventMap[ojButtonsetOneSettableProperties] {
  ...
  var focusManagementChanged: CustomEvent
...
object ojButtonsetOneEventMap {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ojButtonsetOneEventMap]
  }
  
  extension [Self <: ojButtonsetOneEventMap](x: Self) {
    
    inline def setChromingChanged(value: CustomEvent): Self = StObject.set(x, "chromingChanged", value.asInstanceOf[js.Any])
    ...
    inline def setFocusManagementChanged(value: CustomEvent): Self = StObject.set(x, "focusManagementChanged", value.asInstanceOf[js.Any])
