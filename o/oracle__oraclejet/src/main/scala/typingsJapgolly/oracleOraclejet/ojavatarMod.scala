...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.initials
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.initialsChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.src
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.srcChanged
...
object ojavatarMod {
  ...
  trait ojAvatar
    extends StObject
       with JetElement[ojAvatarSettableProperties] {
    ...
    def addEventListener(`type`: sizeChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    ...
    @JSName("addEventListener")
    def addEventListener_initialsChanged(`type`: initialsChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    @JSName("addEventListener")
    def addEventListener_srcChanged(`type`: srcChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    var onInitialsChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onSizeChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onSrcChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    ...
    def setProperty(property: size, value: xxs | xs | sm | md | lg | xl | xxl): Unit = js.native
  ...
  object ojAvatarSettableProperties {
    ...
    inline def apply(initials: String, size: xxs | xs | sm | md | lg | xl | xxl, src: String): ojAvatarSettableProperties = {
    ...
    extension [Self <: ojAvatarSettableProperties](x: Self) {
      ...
      inline def setSize(value: xxs | xs | sm | md | lg | xl | xxl): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
  ...
  object ojAvatarSettablePropertiesLenient {
    ...
    inline def apply(): ojAvatarSettablePropertiesLenient = {
