...
import typingsJapgolly.oracleOraclejet.anon.CleanupMode
import typingsJapgolly.oracleOraclejet.anon.InsertNewView
import typingsJapgolly.oracleOraclejet.anon.IsInitial
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.animation
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.animationChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.config
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.configChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.ojTransitionEnd
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.ojTransitionStart
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.ojViewConnected
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.ojViewDisconnected
...
object ojmoduleElementMod {
  
  trait ModuleElementAnimation extends StObject {
    
    def animate(context: InsertNewView): js.Promise[Any]
  ...
  object ModuleElementAnimation {
    ...
    inline def apply(
      animate: InsertNewView => js.Promise[Any],
    ...
    extension [Self <: ModuleElementAnimation](x: Self) {
      ...
      inline def setCanAnimate(value: IsInitial => Boolean): Self = StObject.set(x, "canAnimate", js.Any.fromFunction1(value))
      
      inline def setPrepareAnimation(value: IsInitial => js.Object): Self = StObject.set(x, "prepareAnimation", js.Any.fromFunction1(value))
    }
  }
  ...
  trait ojModule
    extends StObject
       with JetElement[ojModuleSettableProperties] {
    ...
    def addEventListener(`type`: animationChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    ...
    @JSName("addEventListener")
    def addEventListener_configChanged(`type`: configChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    @JSName("addEventListener")
    def addEventListener_ojTransitionEnd(`type`: ojTransitionEnd, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    @JSName("addEventListener")
    def addEventListener_ojTransitionStart(`type`: ojTransitionStart, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    @JSName("addEventListener")
    def addEventListener_ojViewConnected(`type`: ojViewConnected, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    @JSName("addEventListener")
    def addEventListener_ojViewDisconnected(`type`: ojViewDisconnected, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    var onAnimationChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onConfigChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onOjTransitionEnd: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onOjTransitionStart: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onOjViewConnected: (js.Function1[CustomEvent, Any]) | Null = js.native
    
    var onOjViewDisconnected: (js.Function1[CustomEvent, Any]) | Null = js.native
  ...
  object ojModuleSettableProperties {
    ...
    inline def apply(animation: js.Object, config: CleanupMode): ojModuleSettableProperties = {
    ...
    extension [Self <: ojModuleSettableProperties](x: Self) {
      ...
      inline def setConfig(value: CleanupMode): Self = StObject.set(x, "config", value.asInstanceOf[js.Any])
    }
  }
  ...
  object ojModuleSettablePropertiesLenient {
    ...
    inline def apply(): ojModuleSettablePropertiesLenient = {
