...
object ojoptgroupMod {
  
  @js.native
  trait ojOptgroup
    extends StObject
       with JetElement[ojOptgroupSettableProperties] {
  ...
  object ojOptgroupSettableProperties {
    ...
    inline def apply(disabled: Boolean, label: String): ojOptgroupSettableProperties = {
  ...
  object ojOptgroupSettablePropertiesLenient {
    ...
    inline def apply(): ojOptgroupSettablePropertiesLenient = {
