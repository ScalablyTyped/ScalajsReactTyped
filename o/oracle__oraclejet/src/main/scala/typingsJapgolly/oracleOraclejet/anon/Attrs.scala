...
object Attrs {
  ...
  extension [Self <: Attrs](x: Self) {
    ...
    inline def setError(value: (Attrs, /* xhr */ Any, /* options */ js.Object) => Callback): Self = StObject.set(x, "error", js.Any.fromFunction3((t0: Attrs, t1: /* xhr */ Any, t2: /* options */ js.Object) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setSuccess(value: (Attrs, /* response */ Any, /* options */ js.Object) => Callback): Self = StObject.set(x, "success", js.Any.fromFunction3((t0: Attrs, t1: /* response */ Any, t2: /* options */ js.Object) => (value(t0, t1, t2)).runNow()))
