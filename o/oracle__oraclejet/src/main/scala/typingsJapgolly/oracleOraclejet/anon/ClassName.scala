...
trait ClassName[K, D] extends StObject {
  ...
  var className: js.UndefOr[
    (js.Function1[
      /* context */ typingsJapgolly.oracleOraclejet.ojdatagridMod.ojDataGrid.CellContext[K, D], 
      String | Unit | Null
    ]) | String | Null
  ] = js.undefined
...
object ClassName {
  ...
  extension [Self <: ClassName[?, ?], K, D](x: Self & (ClassName[K, D])) {
    ...
    inline def setClassNameFunction1(
      value: /* context */ typingsJapgolly.oracleOraclejet.ojdatagridMod.ojDataGrid.CellContext[K, D] => String | Unit | Null
    ...
    inline def setRenderer(
      value: /* context */ typingsJapgolly.oracleOraclejet.ojdatagridMod.ojDataGrid.CellContext[K, D] => `1` | Unit | Null
