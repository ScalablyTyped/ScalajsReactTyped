...
trait FetchSize extends StObject {
  ...
  var scroller: js.UndefOr[org.scalajs.dom.Element] = js.undefined
}
object FetchSize {
  ...
  extension [Self <: FetchSize](x: Self) {
    ...
    inline def setScroller(value: org.scalajs.dom.Element): Self = StObject.set(x, "scroller", value.asInstanceOf[js.Any])
