...
trait ConverterTooltipDisplayTooltipLabel extends StObject {
  ...
  var converter: js.UndefOr[typingsJapgolly.oracleOraclejet.ojvalidationBaseMod.Converter[Double]] = js.undefined
...
object ConverterTooltipDisplayTooltipLabel {
  ...
  extension [Self <: ConverterTooltipDisplayTooltipLabel](x: Self) {
    ...
    inline def setConverter(value: typingsJapgolly.oracleOraclejet.ojvalidationBaseMod.Converter[Double]): Self = StObject.set(x, "converter", value.asInstanceOf[js.Any])
