...
object Comparator {
  ...
  extension [Self <: Comparator](x: Self) {
    ...
    inline def setInitialize(value: (/* models */ js.Array[Model], /* options */ js.Object) => Callback): Self = StObject.set(x, "initialize", js.Any.fromFunction2((t0: /* models */ js.Array[Model], t1: /* options */ js.Object) => (value(t0, t1)).runNow()))
