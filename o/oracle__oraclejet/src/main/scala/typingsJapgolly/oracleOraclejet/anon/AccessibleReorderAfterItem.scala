...
object AccessibleReorderAfterItem {
  ...
  inline def apply(): AccessibleReorderAfterItem = {
  ...
  extension [Self <: AccessibleReorderAfterItem](x: Self) {
    ...
    inline def setAccessibleReorderAfterItemUndefined: Self = StObject.set(x, "accessibleReorderAfterItem", js.undefined)
    
    inline def setAccessibleReorderBeforeItem(value: String): Self = StObject.set(x, "accessibleReorderBeforeItem", value.asInstanceOf[js.Any])
    
    inline def setAccessibleReorderBeforeItemUndefined: Self = StObject.set(x, "accessibleReorderBeforeItem", js.undefined)
    
    inline def setAccessibleReorderTouchInstructionText(value: String): Self = StObject.set(x, "accessibleReorderTouchInstructionText", value.asInstanceOf[js.Any])
    
    inline def setAccessibleReorderTouchInstructionTextUndefined: Self = StObject.set(x, "accessibleReorderTouchInstructionText", js.undefined)
    ...
    inline def setLabelRemove(value: String): Self = StObject.set(x, "labelRemove", value.asInstanceOf[js.Any])
    
    inline def setLabelRemoveUndefined: Self = StObject.set(x, "labelRemove", js.undefined)
    ...
    inline def setOverflowItemLabel(value: String): Self = StObject.set(x, "overflowItemLabel", value.asInstanceOf[js.Any])
    
    inline def setOverflowItemLabelUndefined: Self = StObject.set(x, "overflowItemLabel", js.undefined)
    
    inline def setRemoveCueText(value: String): Self = StObject.set(x, "removeCueText", value.asInstanceOf[js.Any])
    
    inline def setRemoveCueTextUndefined: Self = StObject.set(x, "removeCueText", js.undefined)
