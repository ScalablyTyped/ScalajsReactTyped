...
object Initialize {
  ...
  extension [Self <: Initialize](x: Self) {
    ...
    inline def setInitialize(value: (/* models */ js.Array[Initialize], /* options */ js.Object) => Callback): Self = StObject.set(x, "initialize", js.Any.fromFunction2((t0: /* models */ js.Array[Initialize], t1: /* options */ js.Object) => (value(t0, t1)).runNow()))
