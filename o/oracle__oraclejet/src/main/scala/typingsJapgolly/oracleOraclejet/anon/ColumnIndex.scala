...
trait ColumnIndex[K] extends StObject {
...
object ColumnIndex {
  ...
  inline def apply[K](): ColumnIndex[K] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ColumnIndex[K]]
  }
  
  extension [Self <: ColumnIndex[?], K](x: Self & ColumnIndex[K]) {
    
    inline def setColumnIndex(value: Double): Self = StObject.set(x, "columnIndex", value.asInstanceOf[js.Any])
    
    inline def setColumnIndexUndefined: Self = StObject.set(x, "columnIndex", js.undefined)
    
    inline def setColumnKey(value: K): Self = StObject.set(x, "columnKey", value.asInstanceOf[js.Any])
