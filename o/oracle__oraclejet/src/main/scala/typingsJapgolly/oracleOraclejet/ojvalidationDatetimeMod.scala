...
import typingsJapgolly.oracleOraclejet.anon.DateField
import typingsJapgolly.oracleOraclejet.anon.Min
import typingsJapgolly.oracleOraclejet.anon.RangeOverflowRangeUnderflow
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.`2-digit`
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.all
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.auto
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.date
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.datetime
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.full
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.local
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.long
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.medium
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.narrow
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.none
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.numeric
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.offset
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.short
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.time
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.zulu
...
object ojvalidationDatetimeMod {
  ...
  open class DateTimeRangeValidator ()
    extends StObject
       with Validator[String] {
    def this(options: typingsJapgolly.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions) = this()
  ...
  object DateTimeRangeValidator {
    ...
    object ValidatorOptions {
      ...
      inline def apply(converter: DateTimeConverter): typingsJapgolly.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions = {
        val __obj = js.Dynamic.literal(converter = converter.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions]
      }
      
      extension [Self <: typingsJapgolly.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions](x: Self) {
  ...
  trait DateTimeRangeValidatorFactory extends StObject {
    ...
    def createValidator(
      options: typingsJapgolly.oracleOraclejet.ojvalidationDatetimeMod.DateTimeRangeValidator.ValidatorOptions
