...
trait ojRatingGaugeEventMap
  ...
  var changedChanged: CustomEvent
  
  var changedStateChanged: CustomEvent
  
  var hoverStateChanged: CustomEvent
  ...
  var preserveAspectRatioChanged: CustomEvent
  
  var readonlyChanged: CustomEvent
  
  var selectedStateChanged: CustomEvent
  ...
  var unselectedStateChanged: CustomEvent
...
object ojRatingGaugeEventMap {
  ...
  extension [Self <: ojRatingGaugeEventMap](x: Self) {
    ...
    inline def setChangedChanged(value: CustomEvent): Self = StObject.set(x, "changedChanged", value.asInstanceOf[js.Any])
    
    inline def setChangedStateChanged(value: CustomEvent): Self = StObject.set(x, "changedStateChanged", value.asInstanceOf[js.Any])
    
    inline def setHoverStateChanged(value: CustomEvent): Self = StObject.set(x, "hoverStateChanged", value.asInstanceOf[js.Any])
    ...
    inline def setPreserveAspectRatioChanged(value: CustomEvent): Self = StObject.set(x, "preserveAspectRatioChanged", value.asInstanceOf[js.Any])
    
    inline def setReadonlyChanged(value: CustomEvent): Self = StObject.set(x, "readonlyChanged", value.asInstanceOf[js.Any])
    
    inline def setSelectedStateChanged(value: CustomEvent): Self = StObject.set(x, "selectedStateChanged", value.asInstanceOf[js.Any])
    
    inline def setStepChanged(value: CustomEvent): Self = StObject.set(x, "stepChanged", value.asInstanceOf[js.Any])
    
    inline def setThresholdsChanged(value: CustomEvent): Self = StObject.set(x, "thresholdsChanged", value.asInstanceOf[js.Any])
    ...
    inline def setUnselectedStateChanged(value: CustomEvent): Self = StObject.set(x, "unselectedStateChanged", value.asInstanceOf[js.Any])
