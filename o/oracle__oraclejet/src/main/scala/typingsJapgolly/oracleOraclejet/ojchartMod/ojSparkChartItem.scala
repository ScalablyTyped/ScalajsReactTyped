...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.dateChanged
...
trait ojSparkChartItem
  ...
  @JSName("addEventListener")
  def addEventListener_dateChanged(`type`: dateChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  var onDateChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
