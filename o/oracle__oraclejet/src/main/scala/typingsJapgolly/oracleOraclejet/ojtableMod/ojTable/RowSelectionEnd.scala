...
import typingsJapgolly.oracleOraclejet.Anon23
import typingsJapgolly.oracleOraclejet.AnonRowNumber
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.oracleOraclejet.AnonEndIndexEndKey[K]
  - typingsJapgolly.oracleOraclejet.AnonEndIndexAnonRowNumber[K]
*/
