...
object ojaccordionMod {
  ...
  trait ojAccordion
    ...
    @JSName("addEventListener")
    def addEventListener_multipleChanged(`type`: multipleChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    @JSName("addEventListener")
    ...
    var onMultipleChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  ...
  trait ojAccordionEventMap
    ...
    var multipleChanged: CustomEvent
  ...
  object ojAccordionEventMap {
    ...
    extension [Self <: ojAccordionEventMap](x: Self) {
      ...
      inline def setMultipleChanged(value: CustomEvent): Self = StObject.set(x, "multipleChanged", value.asInstanceOf[js.Any])
  ...
  object ojAccordionSettableProperties {
    ...
    extension [Self <: ojAccordionSettableProperties](x: Self) {
      ...
      inline def setExpandedVarargs(value: (Double | Id | String)*): Self = StObject.set(x, "expanded", js.Array(value*))
