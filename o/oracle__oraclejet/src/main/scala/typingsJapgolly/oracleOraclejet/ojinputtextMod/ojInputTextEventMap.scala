...
trait ojInputTextEventMap
  ...
  var clearIconChanged: CustomEvent
  
  var converterChanged: CustomEvent
  
  var listChanged: CustomEvent
...
object ojInputTextEventMap {
  ...
  extension [Self <: ojInputTextEventMap](x: Self) {
    ...
    inline def setClearIconChanged(value: CustomEvent): Self = StObject.set(x, "clearIconChanged", value.asInstanceOf[js.Any])
    
    inline def setConverterChanged(value: CustomEvent): Self = StObject.set(x, "converterChanged", value.asInstanceOf[js.Any])
    
    inline def setListChanged(value: CustomEvent): Self = StObject.set(x, "listChanged", value.asInstanceOf[js.Any])
