...
trait ojGanttTask
  ...
  @JSName("addEventListener")
  def addEventListener_baselineChanged(`type`: baselineChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_progressChanged(`type`: progressChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_rowIdChanged(`type`: rowIdChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  var onBaselineChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  ...
  var onProgressChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  
  var onRowIdChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
