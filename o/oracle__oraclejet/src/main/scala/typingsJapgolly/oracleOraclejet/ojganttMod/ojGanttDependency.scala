...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.predecessorTaskId
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.predecessorTaskIdChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.successorTaskId
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.successorTaskIdChanged
...
trait ojGanttDependency
  ...
  var onPredecessorTaskIdChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  
  var onShortDescChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  
  var onSuccessorTaskIdChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
