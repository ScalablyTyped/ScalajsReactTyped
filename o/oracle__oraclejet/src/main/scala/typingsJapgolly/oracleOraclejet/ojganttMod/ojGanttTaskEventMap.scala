...
object ojGanttTaskEventMap {
  ...
  extension [Self <: ojGanttTaskEventMap](x: Self) {
    ...
    inline def setBaselineChanged(value: CustomEvent): Self = StObject.set(x, "baselineChanged", value.asInstanceOf[js.Any])
    
    inline def setBorderRadiusChanged(value: CustomEvent): Self = StObject.set(x, "borderRadiusChanged", value.asInstanceOf[js.Any])
    ...
    inline def setProgressChanged(value: CustomEvent): Self = StObject.set(x, "progressChanged", value.asInstanceOf[js.Any])
    
    inline def setRowIdChanged(value: CustomEvent): Self = StObject.set(x, "rowIdChanged", value.asInstanceOf[js.Any])
