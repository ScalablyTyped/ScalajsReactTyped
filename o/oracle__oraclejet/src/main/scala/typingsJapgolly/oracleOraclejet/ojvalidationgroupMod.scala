...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.`@firstInvalidShown`
...
object ojvalidationgroupMod {
  ...
  @js.native
  trait ojValidationGroup
    extends StObject
       with JetElement[ojValidationGroupSettableProperties] {
  ...
  object ojValidationGroupSettableProperties {
    ...
    inline def apply(valid: valid | pending | invalidHidden | invalidShown): ojValidationGroupSettableProperties = {
  ...
  object ojValidationGroupSettablePropertiesLenient {
    ...
    inline def apply(): ojValidationGroupSettablePropertiesLenient = {
