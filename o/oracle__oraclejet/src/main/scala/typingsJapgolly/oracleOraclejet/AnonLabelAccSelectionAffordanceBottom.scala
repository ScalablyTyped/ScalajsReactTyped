...
trait AnonLabelAccSelectionAffordanceBottom extends js.Object {
...
object AnonLabelAccSelectionAffordanceBottom {
  @scala.inline
  def apply(
  ...
  ): AnonLabelAccSelectionAffordanceBottom = {
    ...
    __obj.asInstanceOf[AnonLabelAccSelectionAffordanceBottom]
  }
}
