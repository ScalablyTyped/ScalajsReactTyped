...
object ojThematicMapAreaEventMap {
  ...
  extension [Self <: ojThematicMapAreaEventMap](x: Self) {
    ...
    inline def setLocationChanged(value: CustomEvent): Self = StObject.set(x, "locationChanged", value.asInstanceOf[js.Any])
    
    inline def setOpacityChanged(value: CustomEvent): Self = StObject.set(x, "opacityChanged", value.asInstanceOf[js.Any])
