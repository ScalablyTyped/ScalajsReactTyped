...
import typingsJapgolly.oracleOraclejet.anon.Location
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.endLocation
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.endLocationChanged
...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.startLocation
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.startLocationChanged
...
@js.native
trait ojThematicMapLink
  extends StObject
     with JetElement[ojThematicMapLinkSettableProperties] {
  ...
  @JSName("addEventListener")
  def addEventListener_endLocationChanged(`type`: endLocationChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  @JSName("addEventListener")
  def addEventListener_startLocationChanged(`type`: startLocationChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
  @JSName("addEventListener")
  ...
  var onEndLocationChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  ...
  var onStartLocationChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
