...
object ojprogresslistMod {
  ...
  object ProgressItem {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2((t0: EventType, t1: EventListener) => (addEventListener(t0, t1)).runNow()), removeEventListener = js.Any.fromFunction2((t0: EventType, t1: EventListener) => (removeEventListener(t0, t1)).runNow()))
    ...
    */
    ...
    object EventType {
      ...
      inline def abort: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.abort = "abort".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.abort]
      ...
      inline def load: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.load = "load".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.load]
      
      inline def loadend: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.loadend = "loadend".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.loadend]
      
      inline def loadstart: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.loadstart = "loadstart".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.loadstart]
      
      inline def progress: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.progress = "progress".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.progress]
      
      inline def timeout: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.timeout = "timeout".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.timeout]
    }
    
    extension [Self <: ProgressItem](x: Self) {
      
      inline def setAddEventListener(value: (EventType, EventListener) => Callback): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: EventType, t1: EventListener) => (value(t0, t1)).runNow()))
      
      inline def setRemoveEventListener(value: (EventType, EventListener) => Callback): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: EventType, t1: EventListener) => (value(t0, t1)).runNow()))
    }
    ...
    */
    ...
    object Status {
      ...
      inline def aborted: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.aborted = "aborted".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.aborted]
      
      inline def errored: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.errored = "errored".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.errored]
      
      inline def loaded: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.loaded = "loaded".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.loaded]
      
      inline def loadstarted: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.loadstarted = "loadstarted".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.loadstarted]
      
      inline def queued: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.queued = "queued".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.queued]
      
      inline def timedout: typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.timedout = "timedout".asInstanceOf[typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.timedout]
    }
  }
