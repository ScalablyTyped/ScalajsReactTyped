...
object ojLegendSectionEventMap {
  ...
  extension [Self <: ojLegendSectionEventMap](x: Self) {
    ...
    inline def setCollapsibleChanged(value: CustomEvent): Self = StObject.set(x, "collapsibleChanged", value.asInstanceOf[js.Any])
    
    inline def setTextChanged(value: CustomEvent): Self = StObject.set(x, "textChanged", value.asInstanceOf[js.Any])
    
    inline def setTextHalignChanged(value: CustomEvent): Self = StObject.set(x, "textHalignChanged", value.asInstanceOf[js.Any])
    
    inline def setTextStyleChanged(value: CustomEvent): Self = StObject.set(x, "textStyleChanged", value.asInstanceOf[js.Any])
  }
}
