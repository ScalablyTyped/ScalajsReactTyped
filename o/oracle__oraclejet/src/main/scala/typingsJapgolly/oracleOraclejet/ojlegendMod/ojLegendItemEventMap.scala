...
object ojLegendItemEventMap {
  ...
  extension [Self <: ojLegendItemEventMap](x: Self) {
    ...
    inline def setCategoryVisibilityChanged(value: CustomEvent): Self = StObject.set(x, "categoryVisibilityChanged", value.asInstanceOf[js.Any])
    ...
    inline def setMarkerColorChanged(value: CustomEvent): Self = StObject.set(x, "markerColorChanged", value.asInstanceOf[js.Any])
    
    inline def setMarkerShapeChanged(value: CustomEvent): Self = StObject.set(x, "markerShapeChanged", value.asInstanceOf[js.Any])
    
    inline def setMarkerSvgClassNameChanged(value: CustomEvent): Self = StObject.set(x, "markerSvgClassNameChanged", value.asInstanceOf[js.Any])
    
    inline def setMarkerSvgStyleChanged(value: CustomEvent): Self = StObject.set(x, "markerSvgStyleChanged", value.asInstanceOf[js.Any])
    
    inline def setPatternChanged(value: CustomEvent): Self = StObject.set(x, "patternChanged", value.asInstanceOf[js.Any])
    ...
    inline def setSymbolTypeChanged(value: CustomEvent): Self = StObject.set(x, "symbolTypeChanged", value.asInstanceOf[js.Any])
