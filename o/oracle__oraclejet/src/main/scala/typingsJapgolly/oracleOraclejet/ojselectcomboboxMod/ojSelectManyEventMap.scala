...
object ojSelectManyEventMap {
  ...
  extension [Self <: ojSelectManyEventMap[?, ?], K, D](x: Self & (ojSelectManyEventMap[K, D])) {
    ...
    inline def setMinimumResultsForSearchChanged(value: CustomEvent): Self = StObject.set(x, "minimumResultsForSearchChanged", value.asInstanceOf[js.Any])
    ...
    inline def setValueOptionsChanged(value: CustomEvent): Self = StObject.set(x, "valueOptionsChanged", value.asInstanceOf[js.Any])
  }
}
