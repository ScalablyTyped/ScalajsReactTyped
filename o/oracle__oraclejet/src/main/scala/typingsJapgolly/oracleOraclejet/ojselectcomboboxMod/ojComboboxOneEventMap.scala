...
trait ojComboboxOneEventMap[K, D]
  extends StObject
     with ojComboboxEventMap[Any, ojComboboxOneSettableProperties[K, D], Any, String] {
  
  var asyncValidatorsChanged: CustomEvent
  
  var converterChanged: CustomEvent
  
  var filterOnOpenChanged: CustomEvent
  
  var minLengthChanged: CustomEvent
  
  var ojValueUpdated: CustomEvent
...
object ojComboboxOneEventMap {
  ...
  extension [Self <: ojComboboxOneEventMap[?, ?], K, D](x: Self & (ojComboboxOneEventMap[K, D])) {
    ...
    inline def setFilterOnOpenChanged(value: CustomEvent): Self = StObject.set(x, "filterOnOpenChanged", value.asInstanceOf[js.Any])
    
    inline def setMinLengthChanged(value: CustomEvent): Self = StObject.set(x, "minLengthChanged", value.asInstanceOf[js.Any])
    
    inline def setOjValueUpdated(value: CustomEvent): Self = StObject.set(x, "ojValueUpdated", value.asInstanceOf[js.Any])
    ...
    inline def setPickerAttributesChanged(value: CustomEvent): Self = StObject.set(x, "pickerAttributesChanged", value.asInstanceOf[js.Any])
    ...
    inline def setValueOptionChanged(value: CustomEvent): Self = StObject.set(x, "valueOptionChanged", value.asInstanceOf[js.Any])
  }
}
