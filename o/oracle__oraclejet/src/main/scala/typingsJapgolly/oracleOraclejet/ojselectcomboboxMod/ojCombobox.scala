...
object ojCombobox {
  ...
  object Optgroup {
    ...
    inline def apply(
      ...
      label: String
    ): typingsJapgolly.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Optgroup = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Optgroup]
    }
    
    extension [Self <: typingsJapgolly.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Optgroup](x: Self) {
  ...
  object Option {
    ...
    inline def apply(value: Any): typingsJapgolly.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Option = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Option]
    }
    
    extension [Self <: typingsJapgolly.oracleOraclejet.ojselectcomboboxMod.ojCombobox.Option](x: Self) {
