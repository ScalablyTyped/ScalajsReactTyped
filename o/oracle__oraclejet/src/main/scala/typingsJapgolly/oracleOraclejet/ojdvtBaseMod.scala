...
object ojdvtBaseMod {
  ...
  trait dvtBaseComponent[SP /* <: dvtBaseComponentSettableProperties */]
    ...
    def addEventListener(`type`: trackResizeChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, Any]): Unit = js.native
    ...
    var onTrackResizeChanged: (js.Function1[CustomEvent, Any]) | Null = js.native
  ...
  object dvtBaseComponentEventMap {
    ...
    extension [Self <: dvtBaseComponentEventMap[?], SP /* <: dvtBaseComponentSettableProperties */](x: Self & dvtBaseComponentEventMap[SP]) {
      ...
      inline def setTrackResizeChanged(value: CustomEvent): Self = StObject.set(x, "trackResizeChanged", value.asInstanceOf[js.Any])
    }
  }
