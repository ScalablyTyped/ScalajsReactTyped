...
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.labelEdge
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.labelEdgeChanged
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.labelWidth
import typingsJapgolly.oracleOraclejet.oracleOraclejetStrings.labelWidthChanged
...
trait ojLabelValue extends JetElement[ojLabelValueSettableProperties] {
  ...
  @JSName("addEventListener")
  def addEventListener_labelWidthChanged(`type`: labelWidthChanged, listener: js.ThisFunction1[/* this */ HTMLElement, CustomEvent, _]): Unit = js.native
  @JSName("addEventListener")
  ...
  def setProperty[T /* <: String */](property: T, value: JetSetPropertyType[T, ojLabelValueSettableProperties]): Unit = js.native
  @JSName("setProperty")
