...
import typingsJapgolly.oracleOraclejet.ojlistviewMod.ojListView.ItemContext
...
object AnonFocusable {
  ...
  def apply[K, D](
    ...
    renderer: /* param0 */ ItemContext[K, D] => CallbackTo[js.UndefOr[AnonInsert]] = null,
    ...
    if (renderer != null) __obj.updateDynamic("renderer")(js.Any.fromFunction1((t0: /* param0 */ typingsJapgolly.oracleOraclejet.ojlistviewMod.ojListView.ItemContext[K, D]) => renderer(t0).runNow()))
