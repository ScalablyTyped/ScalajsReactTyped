...
import typingsJapgolly.onfidoSdkUi.anon.PartialSdkConfiguration
import typingsJapgolly.onfidoSdkUi.anon.SmsNumber
...
object NormalisedSdkOptions {
  ...
  extension [Self <: NormalisedSdkOptions](x: Self) {
    ...
    inline def setOnComplete(value: /* data */ SdkResponse => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: /* data */ SdkResponse) => value(t0).runNow()))
    
    inline def setOnCompleteUndefined: Self = StObject.set(x, "onComplete", js.undefined)
    
    inline def setOnError(value: /* error */ SdkError => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* error */ SdkError) => value(t0).runNow()))
    
    inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
    
    inline def setOnModalRequestClose(value: Callback): Self = StObject.set(x, "onModalRequestClose", value.toJsFn)
    
    inline def setOnModalRequestCloseUndefined: Self = StObject.set(x, "onModalRequestClose", js.undefined)
    
    inline def setOnUserExit(value: /* data */ UserExitCode => Callback): Self = StObject.set(x, "onUserExit", js.Any.fromFunction1((t0: /* data */ UserExitCode) => value(t0).runNow()))
