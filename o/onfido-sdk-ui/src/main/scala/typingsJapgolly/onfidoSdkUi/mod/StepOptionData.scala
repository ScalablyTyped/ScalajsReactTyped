...
import typingsJapgolly.onfidoSdkUi.anon.Addressenabled
import typingsJapgolly.onfidoSdkUi.anon.Country
...
object StepOptionData {
  ...
  inline def apply(getPersonalData: CallbackTo[Record[String, Any]]): StepOptionData = {
    val __obj = js.Dynamic.literal(getPersonalData = getPersonalData.toJsFn)
  ...
  extension [Self <: StepOptionData](x: Self) {
    ...
    inline def setGetPersonalData(value: CallbackTo[Record[String, Any]]): Self = StObject.set(x, "getPersonalData", value.toJsFn)
