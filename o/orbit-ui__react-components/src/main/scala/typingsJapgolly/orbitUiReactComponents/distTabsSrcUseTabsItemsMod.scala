...
object distTabsSrcUseTabsItemsMod {
  ...
  open class TabsBuilder protected () extends StObject {
    ...
    def build(children: Node): js.Tuple2[js.Array[TabType], js.Array[PanelType]] = js.native
  ...
  inline def useTabsItems(children: Node, rootId: String): js.Tuple2[js.Array[TabType], js.Array[PanelType]] = (^.asInstanceOf[js.Dynamic].applyDynamic("useTabsItems")(children.asInstanceOf[js.Any], rootId.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[js.Array[TabType], js.Array[PanelType]]]
