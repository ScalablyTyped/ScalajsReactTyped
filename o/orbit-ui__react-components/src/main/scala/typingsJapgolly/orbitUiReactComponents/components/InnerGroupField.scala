...
object InnerGroupField {
  
  @JSImport("@orbit-ui/react-components", "InnerGroupField")
  @js.native
  ...
  implicit def make(companion: InnerGroupField.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerGroupFieldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
