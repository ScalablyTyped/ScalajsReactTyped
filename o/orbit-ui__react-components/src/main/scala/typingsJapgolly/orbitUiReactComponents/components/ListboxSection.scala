...
object ListboxSection {
  
  inline def apply(title: String): Builder = {
    val __props = js.Dynamic.literal(title = title.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerListboxSectionProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerListboxSectionProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
