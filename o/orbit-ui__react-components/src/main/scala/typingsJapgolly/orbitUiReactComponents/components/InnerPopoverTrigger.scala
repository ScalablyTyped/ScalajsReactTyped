...
object InnerPopoverTrigger {
  
  @JSImport("@orbit-ui/react-components", "InnerPopoverTrigger")
  @js.native
  ...
  implicit def make(companion: InnerPopoverTrigger.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerPopoverTriggerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
