...
object InnerUnderlay {
  
  @JSImport("@orbit-ui/react-components", "InnerUnderlay")
  @js.native
  ...
  implicit def make(companion: InnerUnderlay.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerUnderlayProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
