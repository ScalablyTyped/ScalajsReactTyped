...
object Fieldset {
  ...
  inline def apply(label: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerFieldsetProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerFieldsetProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
