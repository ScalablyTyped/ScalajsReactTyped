...
object ListboxOption {
  
  inline def apply(item: CollectionItem): Builder = {
    val __props = js.Dynamic.literal(item = item.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerListboxOptionProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerListboxOptionProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
