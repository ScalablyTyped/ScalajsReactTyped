...
object AccordionHeader {
  ...
  implicit def make(companion: AccordionHeader.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerAccordionHeaderProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
