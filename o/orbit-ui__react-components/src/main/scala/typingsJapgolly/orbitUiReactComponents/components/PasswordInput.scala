...
object PasswordInput {
  ...
  implicit def make(companion: PasswordInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[input, InnerPasswordInputProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
