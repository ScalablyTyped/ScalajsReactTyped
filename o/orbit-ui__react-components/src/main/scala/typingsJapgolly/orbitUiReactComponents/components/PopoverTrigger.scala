...
object PopoverTrigger {
  ...
  implicit def make(companion: PopoverTrigger.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerPopoverTriggerProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
