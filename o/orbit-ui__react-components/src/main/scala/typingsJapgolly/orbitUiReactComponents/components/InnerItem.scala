...
object InnerItem {
  ...
  @JSImport("@orbit-ui/react-components", "InnerItem")
  @js.native
  ...
  implicit def make(companion: InnerItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
