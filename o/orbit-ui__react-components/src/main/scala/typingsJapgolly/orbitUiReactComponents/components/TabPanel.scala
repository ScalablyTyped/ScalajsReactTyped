...
object TabPanel {
  ...
  inline def apply(panel: PanelType): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerTabPanelProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerTabPanelProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
