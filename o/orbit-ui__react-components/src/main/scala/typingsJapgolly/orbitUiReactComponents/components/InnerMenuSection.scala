...
object InnerMenuSection {
  
  @JSImport("@orbit-ui/react-components", "InnerMenuSection")
  @js.native
  ...
  implicit def make(companion: InnerMenuSection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerMenuSectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
