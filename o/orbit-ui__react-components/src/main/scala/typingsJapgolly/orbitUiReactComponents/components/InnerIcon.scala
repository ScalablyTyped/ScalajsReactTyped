...
object InnerIcon {
  ...
  inline def apply(src: ElementType): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerIconProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerIcon")
  @js.native
  ...
  def withProps(p: InnerIconProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
