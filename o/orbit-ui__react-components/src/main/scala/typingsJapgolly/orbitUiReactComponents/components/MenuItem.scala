...
object MenuItem {
  ...
  inline def apply(item: CollectionItem): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerMenuItemProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerMenuItemProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
