...
object InnerTooltip {
  ...
  @JSImport("@orbit-ui/react-components", "InnerTooltip")
  @js.native
  ...
  implicit def make(companion: InnerTooltip.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerTooltipProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
