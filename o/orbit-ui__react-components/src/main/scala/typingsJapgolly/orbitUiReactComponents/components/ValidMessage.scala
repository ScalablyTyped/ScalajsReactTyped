...
object ValidMessage {
  ...
  implicit def make(companion: ValidMessage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerValidMessageProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
