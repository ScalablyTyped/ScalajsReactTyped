...
object Underlay {
  ...
  implicit def make(companion: Underlay.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerUnderlayProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
