...
object InnerTextLink {
  
  @JSImport("@orbit-ui/react-components", "InnerTextLink")
  @js.native
  ...
  implicit def make(companion: InnerTextLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerTextLinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
