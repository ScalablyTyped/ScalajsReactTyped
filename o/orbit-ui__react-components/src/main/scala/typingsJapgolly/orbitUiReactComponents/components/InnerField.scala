...
object InnerField {
  ...
  @JSImport("@orbit-ui/react-components", "InnerField")
  @js.native
  ...
  implicit def make(companion: InnerField.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerFieldProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
