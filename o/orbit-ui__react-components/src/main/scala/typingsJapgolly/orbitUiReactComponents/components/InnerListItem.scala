...
object InnerListItem {
  
  @JSImport("@orbit-ui/react-components", "InnerListItem")
  @js.native
  ...
  implicit def make(companion: InnerListItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerListItemProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
