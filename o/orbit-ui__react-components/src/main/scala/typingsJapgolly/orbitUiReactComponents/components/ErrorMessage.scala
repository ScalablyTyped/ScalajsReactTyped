...
object ErrorMessage {
  ...
  implicit def make(companion: ErrorMessage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerErrorMessageProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
