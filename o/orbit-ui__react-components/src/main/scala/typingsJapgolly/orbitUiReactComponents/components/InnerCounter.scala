...
object InnerCounter {
  ...
  @JSImport("@orbit-ui/react-components", "InnerCounter")
  @js.native
  ...
  implicit def make(companion: InnerCounter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerCounterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
