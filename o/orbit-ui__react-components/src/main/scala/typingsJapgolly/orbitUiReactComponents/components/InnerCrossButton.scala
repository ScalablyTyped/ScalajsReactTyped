...
object InnerCrossButton {
  
  inline def apply(`aria-label`: String): Builder = {
    val __props = js.Dynamic.literal()
    __props.updateDynamic("aria-label")(`aria-label`.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerCrossButtonProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerCrossButton")
  @js.native
  ...
  def withProps(p: InnerCrossButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
