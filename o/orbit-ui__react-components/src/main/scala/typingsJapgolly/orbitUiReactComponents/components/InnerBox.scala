...
object InnerBox {
  ...
  @JSImport("@orbit-ui/react-components", "InnerBox")
  @js.native
  ...
  implicit def make(companion: InnerBox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerBoxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
