...
object HelpMessage {
  ...
  implicit def make(companion: HelpMessage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerHelpMessageProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
