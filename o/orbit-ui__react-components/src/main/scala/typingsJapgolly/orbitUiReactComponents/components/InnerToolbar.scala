...
object InnerToolbar {
  ...
  @JSImport("@orbit-ui/react-components", "InnerToolbar")
  @js.native
  ...
  implicit def make(companion: InnerToolbar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerToolbarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
