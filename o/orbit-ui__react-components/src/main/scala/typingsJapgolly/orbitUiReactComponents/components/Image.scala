...
object Image {
  ...
  inline def apply(alt: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerImageProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerImageProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
