...
object SvgImage {
  ...
  inline def apply(`aria-label`: String, src: ElementType): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerSvgImageProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerSvgImageProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
