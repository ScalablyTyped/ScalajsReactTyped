...
object InnerMenu {
  ...
  @JSImport("@orbit-ui/react-components", "InnerMenu")
  @js.native
  ...
  implicit def make(companion: InnerMenu.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerMenuProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
