...
object DialogTrigger {
  ...
  implicit def make(companion: DialogTrigger.type): SharedBuilder_MergeWithAs421531106 = new SharedBuilder_MergeWithAs421531106(js.Array(this.component, js.Dictionary.empty))()
