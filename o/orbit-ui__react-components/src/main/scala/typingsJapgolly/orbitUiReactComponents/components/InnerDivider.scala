...
object InnerDivider {
  ...
  @JSImport("@orbit-ui/react-components", "InnerDivider")
  @js.native
  ...
  implicit def make(companion: InnerDivider.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerDividerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
