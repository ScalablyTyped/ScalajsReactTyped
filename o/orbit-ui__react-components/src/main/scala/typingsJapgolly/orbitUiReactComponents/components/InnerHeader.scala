...
object InnerHeader {
  ...
  @JSImport("@orbit-ui/react-components", "InnerHeader")
  @js.native
  ...
  implicit def make(companion: InnerHeader.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerHeaderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
