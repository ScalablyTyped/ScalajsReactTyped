...
object Alert {
  ...
  inline def apply(primaryButtonLabel: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerAlertProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerAlertProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
