...
object InnerIllustration {
  
  @JSImport("@orbit-ui/react-components", "InnerIllustration")
  @js.native
  ...
  implicit def make(companion: InnerIllustration.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerIllustrationProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
