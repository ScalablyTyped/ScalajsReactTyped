...
object MultiVariantIcon {
  ...
  inline def apply(src24: ElementType, src32: ElementType): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[svg, InnerMultiVariantIconProps]]))
  }
  ...
  def withProps(p: MergeWithAs[svg, InnerMultiVariantIconProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
