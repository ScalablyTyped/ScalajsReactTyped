...
object InnerAutocomplete {
  
  @JSImport("@orbit-ui/react-components", "InnerAutocomplete")
  @js.native
  ...
  implicit def make(companion: InnerAutocomplete.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerAutocompleteProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
