...
object InnerAccordionPanel {
  
  @JSImport("@orbit-ui/react-components", "InnerAccordionPanel")
  @js.native
  ...
  implicit def make(companion: InnerAccordionPanel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerAccordionPanelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
