...
object IconLink {
  ...
  implicit def make(companion: IconLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerIconLinkProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
