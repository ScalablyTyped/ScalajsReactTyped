...
object InnerButtonGroup {
  
  @JSImport("@orbit-ui/react-components", "InnerButtonGroup")
  @js.native
  ...
  implicit def make(companion: InnerButtonGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerButtonGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
