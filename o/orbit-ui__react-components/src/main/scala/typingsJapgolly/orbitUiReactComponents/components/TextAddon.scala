...
object TextAddon {
  ...
  implicit def make(companion: TextAddon.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerTextAddonProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
