...
object InnerHelpMessage {
  
  @JSImport("@orbit-ui/react-components", "InnerHelpMessage")
  @js.native
  ...
  implicit def make(companion: InnerHelpMessage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerHelpMessageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
