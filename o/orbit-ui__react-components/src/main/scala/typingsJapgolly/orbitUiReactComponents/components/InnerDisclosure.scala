...
object InnerDisclosure {
  
  @JSImport("@orbit-ui/react-components", "InnerDisclosure")
  @js.native
  ...
  implicit def make(companion: InnerDisclosure.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerDisclosureProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
