...
object InnerIconList {
  
  @JSImport("@orbit-ui/react-components", "InnerIconList")
  @js.native
  ...
  implicit def make(companion: InnerIconList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerIconListProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
