...
object InnerGroup {
  ...
  @JSImport("@orbit-ui/react-components", "InnerGroup")
  @js.native
  ...
  implicit def make(companion: InnerGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
