...
object InnerLozenge {
  ...
  @JSImport("@orbit-ui/react-components", "InnerLozenge")
  @js.native
  ...
  implicit def make(companion: InnerLozenge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerLozengeProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
