...
object InnerDialog {
  ...
  @JSImport("@orbit-ui/react-components", "InnerDialog")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def role(value: dialog | alertdialog): this.type = set("role", value.asInstanceOf[js.Any])
    
    inline def size(value: sm | md | lg | fullscreen): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: InnerDialog.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerDialogProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
