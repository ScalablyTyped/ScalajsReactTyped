...
object Lozenge {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: primary): this.type = set("color", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: Lozenge.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerLozengeProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
