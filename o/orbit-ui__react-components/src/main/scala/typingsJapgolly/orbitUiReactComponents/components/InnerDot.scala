...
object InnerDot {
  ...
  @JSImport("@orbit-ui/react-components", "InnerDot")
  @js.native
  ...
  implicit def make(companion: InnerDot.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerDotProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
