...
object InnerValidMessage {
  
  @JSImport("@orbit-ui/react-components", "InnerValidMessage")
  @js.native
  ...
  implicit def make(companion: InnerValidMessage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerValidMessageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
