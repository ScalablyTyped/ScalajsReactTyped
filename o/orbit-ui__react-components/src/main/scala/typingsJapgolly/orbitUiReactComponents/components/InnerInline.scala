...
object InnerInline {
  ...
  @JSImport("@orbit-ui/react-components", "InnerInline")
  @js.native
  ...
  implicit def make(companion: InnerInline.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerInlineProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
