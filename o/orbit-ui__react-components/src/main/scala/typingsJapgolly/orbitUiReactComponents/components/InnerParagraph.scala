...
object InnerParagraph {
  
  @JSImport("@orbit-ui/react-components", "InnerParagraph")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def size(value: xs | sm | md | lg | xl | `2xl` | inherit): this.type = set("size", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: InnerParagraph.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerParagraphProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
