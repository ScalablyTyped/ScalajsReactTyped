...
object InnerNumberInput {
  
  @JSImport("@orbit-ui/react-components", "InnerNumberInput")
  @js.native
  ...
  implicit def make(companion: InnerNumberInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerNumberInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
