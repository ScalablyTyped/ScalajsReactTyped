...
object InnerTileLink {
  
  @JSImport("@orbit-ui/react-components", "InnerTileLink")
  @js.native
  ...
  implicit def make(companion: InnerTileLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerTileLinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
