...
object InnerSearchInput {
  
  @JSImport("@orbit-ui/react-components", "InnerSearchInput")
  @js.native
  ...
  implicit def make(companion: InnerSearchInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerSearchInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
