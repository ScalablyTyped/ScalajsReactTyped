...
object InnerButton {
  ...
  @JSImport("@orbit-ui/react-components", "InnerButton")
  @js.native
  ...
  implicit def make(companion: InnerButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
