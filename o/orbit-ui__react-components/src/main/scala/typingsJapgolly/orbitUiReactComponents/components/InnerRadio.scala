...
object InnerRadio {
  ...
  @JSImport("@orbit-ui/react-components", "InnerRadio")
  @js.native
  ...
  implicit def make(companion: InnerRadio.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerRadioProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
