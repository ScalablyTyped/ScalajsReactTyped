...
object InnerListboxSection {
  
  inline def apply(title: String): Builder = {
    val __props = js.Dynamic.literal(title = title.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerListboxSectionProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerListboxSection")
  @js.native
  ...
  def withProps(p: InnerListboxSectionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
