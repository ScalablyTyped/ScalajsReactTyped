...
object InnerVisuallyHidden {
  
  @JSImport("@orbit-ui/react-components", "InnerVisuallyHidden")
  @js.native
  ...
  implicit def make(companion: InnerVisuallyHidden.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerVisuallyHiddenProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
