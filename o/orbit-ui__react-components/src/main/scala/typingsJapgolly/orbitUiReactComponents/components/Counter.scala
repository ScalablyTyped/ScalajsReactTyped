...
object Counter {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def pushed(value: Boolean): this.type = set("pushed", value.asInstanceOf[js.Any])
    ...
    inline def variant(value: basic | divider): this.type = set("variant", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: Counter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerCounterProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
