...
object InnerAvatarGroup {
  
  @JSImport("@orbit-ui/react-components", "InnerAvatarGroup")
  @js.native
  ...
  implicit def make(companion: InnerAvatarGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerAvatarGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
