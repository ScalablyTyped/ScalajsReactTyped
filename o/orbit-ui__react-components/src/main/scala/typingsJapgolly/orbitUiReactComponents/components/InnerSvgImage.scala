...
object InnerSvgImage {
  
  inline def apply(`aria-label`: String, src: ElementType): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerSvgImageProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerSvgImage")
  @js.native
  ...
  def withProps(p: InnerSvgImageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
