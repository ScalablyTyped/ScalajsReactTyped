...
object InnerSelect {
  ...
  @JSImport("@orbit-ui/react-components", "InnerSelect")
  @js.native
  ...
  implicit def make(companion: InnerSelect.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerSelectProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
