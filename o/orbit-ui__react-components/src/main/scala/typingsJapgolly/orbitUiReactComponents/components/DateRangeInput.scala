...
object DateRangeInput {
  ...
  implicit def make(companion: DateRangeInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerDateRangeInputProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
