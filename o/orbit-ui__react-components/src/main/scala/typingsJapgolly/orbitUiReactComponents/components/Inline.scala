...
object Inline {
  ...
  implicit def make(companion: Inline.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerInlineProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
