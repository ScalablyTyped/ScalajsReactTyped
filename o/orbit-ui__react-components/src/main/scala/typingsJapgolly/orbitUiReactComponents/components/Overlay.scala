...
object Overlay {
  ...
  inline def apply(show: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerOverlayProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerOverlayProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
