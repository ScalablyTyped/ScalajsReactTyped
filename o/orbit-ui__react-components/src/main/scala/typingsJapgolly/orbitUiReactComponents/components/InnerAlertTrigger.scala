...
object InnerAlertTrigger {
  
  @JSImport("@orbit-ui/react-components", "InnerAlertTrigger")
  @js.native
  ...
  implicit def make(companion: InnerAlertTrigger.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
