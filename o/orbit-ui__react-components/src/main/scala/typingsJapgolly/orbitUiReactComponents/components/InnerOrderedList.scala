...
object InnerOrderedList {
  
  @JSImport("@orbit-ui/react-components", "InnerOrderedList")
  @js.native
  ...
  implicit def make(companion: InnerOrderedList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerListProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
