...
object OverlayArrow {
  ...
  implicit def make(companion: OverlayArrow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerOverlayArrowProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
