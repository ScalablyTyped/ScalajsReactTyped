...
object InnerRow {
  ...
  @JSImport("@orbit-ui/react-components", "InnerRow")
  @js.native
  ...
  implicit def make(companion: InnerRow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerRowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
