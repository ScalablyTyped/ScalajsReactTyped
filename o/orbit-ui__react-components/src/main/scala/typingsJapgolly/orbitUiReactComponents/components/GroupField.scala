...
object GroupField {
  ...
  implicit def make(companion: GroupField.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerGroupFieldProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
