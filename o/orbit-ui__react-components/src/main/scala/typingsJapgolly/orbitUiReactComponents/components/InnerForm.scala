...
object InnerForm {
  ...
  @JSImport("@orbit-ui/react-components", "InnerForm")
  @js.native
  ...
  implicit def make(companion: InnerForm.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerFormProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
