...
object TileGroup {
  ...
  implicit def make(companion: TileGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerTileGroupProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
