...
import typingsJapgolly.orbitUiReactComponents.orbitUiReactComponentsStrings.box
...
object InnerLink {
  ...
  @JSImport("@orbit-ui/react-components", "InnerLink")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def shape(value: rounded | circular | box): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def target(value: String): this.type = set("target", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: InnerLink.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerLinkProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
