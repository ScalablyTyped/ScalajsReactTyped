...
object InnerLabel {
  ...
  @JSImport("@orbit-ui/react-components", "InnerLabel")
  @js.native
  ...
  implicit def make(companion: InnerLabel.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerLabelProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
