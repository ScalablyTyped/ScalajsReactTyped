...
object InnerFooter {
  ...
  @JSImport("@orbit-ui/react-components", "InnerFooter")
  @js.native
  ...
  implicit def make(companion: InnerFooter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerFooterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
