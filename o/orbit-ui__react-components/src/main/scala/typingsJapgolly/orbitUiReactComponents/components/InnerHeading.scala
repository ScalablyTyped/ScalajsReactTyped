...
object InnerHeading {
  ...
  @JSImport("@orbit-ui/react-components", "InnerHeading")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def size(value: `2xs` | xs | sm | md | lg | xl): this.type = set("size", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: InnerHeading.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerHeadingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
