...
object InnerTabs {
  ...
  inline def apply(`aria-label`: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerTabsProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerTabs")
  @js.native
  ...
  def withProps(p: InnerTabsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
