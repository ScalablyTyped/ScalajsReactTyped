...
object Icon {
  ...
  inline def apply(src: ElementType): Builder = {
    val __props = js.Dynamic.literal(src = src.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[svg, InnerIconProps]]))
  }
  ...
  def withProps(p: MergeWithAs[svg, InnerIconProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
