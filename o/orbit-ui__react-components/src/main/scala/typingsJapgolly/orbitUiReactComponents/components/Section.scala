...
object Section {
  ...
  implicit def make(companion: Section.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerSectionProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
