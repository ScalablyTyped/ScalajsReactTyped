...
object InnerAvatar {
  ...
  inline def apply(name: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerAvatarProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerAvatar")
  @js.native
  ...
  def withProps(p: InnerAvatarProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
