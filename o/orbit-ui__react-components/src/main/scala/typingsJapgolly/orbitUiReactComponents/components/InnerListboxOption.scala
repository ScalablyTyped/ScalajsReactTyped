...
import typingsJapgolly.orbitUiReactComponents.distListboxSrcListboxOptionMod.CollectionItem
...
object InnerListboxOption {
  
  inline def apply(item: CollectionItem): Builder = {
    val __props = js.Dynamic.literal(item = item.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerListboxOptionProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerListboxOption")
  @js.native
  ...
  def withProps(p: InnerListboxOptionProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
