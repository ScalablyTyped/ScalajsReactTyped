...
object MenuSection {
  ...
  implicit def make(companion: MenuSection.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerMenuSectionProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
