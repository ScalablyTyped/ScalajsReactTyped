...
object InnerTextInput {
  
  @JSImport("@orbit-ui/react-components", "InnerTextInput")
  @js.native
  ...
  implicit def make(companion: InnerTextInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerTextInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
