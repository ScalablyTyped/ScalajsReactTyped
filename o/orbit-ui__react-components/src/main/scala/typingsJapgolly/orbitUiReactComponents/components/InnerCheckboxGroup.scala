...
object InnerCheckboxGroup {
  
  @JSImport("@orbit-ui/react-components", "InnerCheckboxGroup")
  @js.native
  ...
  implicit def make(companion: InnerCheckboxGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerCheckboxGroupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
