...
object Tab {
  ...
  inline def apply(tab: TabType): Builder = {
    val __props = js.Dynamic.literal(tab = tab.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerTabProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerTabProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
