...
object Transition {
  ...
  inline def apply(show: Boolean): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[MergeWithAs[HTMLElement, InnerTransitionProps]]))
  }
  ...
  def withProps(p: MergeWithAs[HTMLElement, InnerTransitionProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
