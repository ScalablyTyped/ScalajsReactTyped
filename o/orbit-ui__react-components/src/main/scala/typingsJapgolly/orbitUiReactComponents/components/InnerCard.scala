...
object InnerCard {
  ...
  @JSImport("@orbit-ui/react-components", "InnerCard")
  @js.native
  ...
  implicit def make(companion: InnerCard.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerCardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
