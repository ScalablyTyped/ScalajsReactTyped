...
object InnerTile {
  ...
  @JSImport("@orbit-ui/react-components", "InnerTile")
  @js.native
  ...
  implicit def make(companion: InnerTile.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerTileProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
