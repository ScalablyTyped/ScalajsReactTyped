...
import typingsJapgolly.orbitUiReactComponents.distDateInputSrcButtonPresetsMod.ButtonPresetsProps
...
object ButtonPresets {
  ...
  inline def apply(onSelectionChange: (ReactEventFrom[Element], Double) => Callback, values: js.Array[String]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ButtonPresetsProps]))
  }
  
  @JSImport("@orbit-ui/react-components/dist/date-input/src/ButtonPresets", "ButtonPresets")
  @js.native
  ...
  def withProps(p: ButtonPresetsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
