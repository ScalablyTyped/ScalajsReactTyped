...
object IconList {
  ...
  implicit def make(companion: IconList.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerIconListProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
