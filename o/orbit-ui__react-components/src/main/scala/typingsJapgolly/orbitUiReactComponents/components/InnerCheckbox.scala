...
object InnerCheckbox {
  
  @JSImport("@orbit-ui/react-components", "InnerCheckbox")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def indeterminateNull: this.type = set("indeterminate", null)
  ...
  implicit def make(companion: InnerCheckbox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerCheckboxProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
