...
object InnerFlex {
  ...
  @JSImport("@orbit-ui/react-components", "InnerFlex")
  @js.native
  ...
  implicit def make(companion: InnerFlex.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerFlexProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
