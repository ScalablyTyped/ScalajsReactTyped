...
object Disclosure {
  ...
  implicit def make(companion: Disclosure.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerDisclosureProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
