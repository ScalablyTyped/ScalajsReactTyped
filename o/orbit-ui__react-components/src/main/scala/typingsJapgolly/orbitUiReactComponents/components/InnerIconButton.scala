...
object InnerIconButton {
  
  @JSImport("@orbit-ui/react-components", "InnerIconButton")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def size(value: `2xs` | xs | sm | md): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: InnerIconButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerIconButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
