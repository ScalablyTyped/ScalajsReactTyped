...
object InnerTab {
  ...
  inline def apply(tab: TabType): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerTabProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerTab")
  @js.native
  ...
  def withProps(p: InnerTabProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
