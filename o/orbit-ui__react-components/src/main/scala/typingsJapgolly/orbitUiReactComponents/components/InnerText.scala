...
object InnerText {
  ...
  @JSImport("@orbit-ui/react-components", "InnerText")
  @js.native
  ...
  implicit def make(companion: InnerText.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerTextProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
