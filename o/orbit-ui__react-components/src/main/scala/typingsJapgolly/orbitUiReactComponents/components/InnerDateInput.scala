...
object InnerDateInput {
  
  @JSImport("@orbit-ui/react-components", "InnerDateInput")
  @js.native
  ...
  implicit def make(companion: InnerDateInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerDateInputProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
