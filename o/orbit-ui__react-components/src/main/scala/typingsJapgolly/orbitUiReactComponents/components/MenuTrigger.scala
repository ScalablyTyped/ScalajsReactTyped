...
object MenuTrigger {
  ...
  implicit def make(companion: MenuTrigger.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerMenuTriggerProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
