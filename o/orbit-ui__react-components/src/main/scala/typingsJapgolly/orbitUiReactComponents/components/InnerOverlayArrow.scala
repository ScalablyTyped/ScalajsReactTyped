...
object InnerOverlayArrow {
  
  @JSImport("@orbit-ui/react-components", "InnerOverlayArrow")
  @js.native
  ...
  implicit def make(companion: InnerOverlayArrow.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerOverlayArrowProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
