...
object InnerMenuTrigger {
  
  @JSImport("@orbit-ui/react-components", "InnerMenuTrigger")
  @js.native
  ...
  implicit def make(companion: InnerMenuTrigger.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerMenuTriggerProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
