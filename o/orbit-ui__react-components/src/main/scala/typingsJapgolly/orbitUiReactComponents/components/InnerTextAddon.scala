...
object InnerTextAddon {
  
  @JSImport("@orbit-ui/react-components", "InnerTextAddon")
  @js.native
  ...
  implicit def make(companion: InnerTextAddon.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerTextAddonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
