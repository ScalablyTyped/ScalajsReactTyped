...
object InnerToggleIconButton {
  
  inline def apply(`aria-label`: String): Builder = {
    val __props = js.Dynamic.literal()
    __props.updateDynamic("aria-label")(`aria-label`.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[InnerToggleIconButtonProps]))
  }
  
  @JSImport("@orbit-ui/react-components", "InnerToggleIconButton")
  @js.native
  ...
  def withProps(p: InnerToggleIconButtonProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
