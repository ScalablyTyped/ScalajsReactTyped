...
object CheckboxGroup {
  ...
  implicit def make(companion: CheckboxGroup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: MergeWithAs[HTMLElement, InnerCheckboxGroupProps]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
