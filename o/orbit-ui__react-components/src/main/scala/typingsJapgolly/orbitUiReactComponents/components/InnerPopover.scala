...
object InnerPopover {
  ...
  @JSImport("@orbit-ui/react-components", "InnerPopover")
  @js.native
  ...
  implicit def make(companion: InnerPopover.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: InnerPopoverProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
