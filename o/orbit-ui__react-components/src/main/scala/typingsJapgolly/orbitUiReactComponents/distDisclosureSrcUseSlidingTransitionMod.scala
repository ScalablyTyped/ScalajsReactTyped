...
import typingsJapgolly.orbitUiReactComponents.anon.OnTransitionEnd
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distDisclosureSrcUseSlidingTransitionMod {
  ...
  inline def useSlidingTransition(isOpen: Boolean, ref: RefHandle[Any]): SlidingTransition = (^.asInstanceOf[js.Dynamic].applyDynamic("useSlidingTransition")(isOpen.asInstanceOf[js.Any], ref.asInstanceOf[js.Any])).asInstanceOf[SlidingTransition]
