...
object distListboxSrcListboxOptionMod {
  ...
  type CollectionItem = typingsJapgolly.orbitUiReactComponents.distCollectionSrcUseCollectionMod.CollectionItem
  ...
  object InnerListboxOptionProps {
    ...
    inline def apply(item: CollectionItem): InnerListboxOptionProps = {
      val __obj = js.Dynamic.literal(item = item.asInstanceOf[js.Any], children = null, forwardedRef = null)
