...
object distModalSrcUseModalTriggerContextMod {
  
  @JSImport("@orbit-ui/react-components/dist/modal/src/useModalTriggerContext", JSImport.Namespace)
  @js.native
  ...
  type ModalTriggerContextType = DialogTriggerContextType
}
