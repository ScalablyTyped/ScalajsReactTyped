...
object distSharedSrcMod {
  ...
  open class CompositeKeyWeakMap[T] ()
    extends typingsJapgolly.orbitUiReactComponents.distSharedSrcMergePropsMod.CompositeKeyWeakMap[T]
  
  @JSImport("@orbit-ui/react-components/dist/shared/src", "DomScope")
  @js.native
  open class DomScope protected ()
    extends typingsJapgolly.orbitUiReactComponents.distSharedSrcUseFocusScopeMod.DomScope {
  ...
  open class ElementIterator[T] protected ()
    extends typingsJapgolly.orbitUiReactComponents.distSharedSrcUseFocusManagerMod.ElementIterator[T] {
  ...
  open class FocusManager protected ()
    extends typingsJapgolly.orbitUiReactComponents.distSharedSrcUseFocusManagerMod.FocusManager {
