...
import typingsJapgolly.orbitUiReactComponents.distLayoutSrcAdaptersMod.Direction
...
object orbitUiReactComponentsStrings {
  ...
  @js.native
  sealed trait apricot
    extends StObject
       with Theme
  inline def apricot: apricot = "apricot".asInstanceOf[apricot]
  ...
  @js.native
  sealed trait borderless extends StObject
  inline def borderless: borderless = "borderless".asInstanceOf[borderless]
  ...
  @js.native
  sealed trait checkable extends StObject
  inline def checkable: checkable = "checkable".asInstanceOf[checkable]
  ...
  sealed trait multiple
    extends StObject
       with SelectionMode
       with typingsJapgolly.orbitUiReactComponents.distListboxSrcListboxMod.SelectionMode
