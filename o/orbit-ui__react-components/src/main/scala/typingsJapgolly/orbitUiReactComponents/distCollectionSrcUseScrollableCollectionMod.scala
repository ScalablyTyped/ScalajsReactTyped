...
object distCollectionSrcUseScrollableCollectionMod {
  ...
  inline def useScrollableCollection(containerRef: RefHandle[Element]): Style | StyleHeight = ^.asInstanceOf[js.Dynamic].applyDynamic("useScrollableCollection")(containerRef.asInstanceOf[js.Any]).asInstanceOf[Style | StyleHeight]
  inline def useScrollableCollection(
    containerRef: RefHandle[Element],
