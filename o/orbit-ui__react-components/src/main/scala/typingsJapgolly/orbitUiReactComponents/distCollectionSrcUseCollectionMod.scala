...
import typingsJapgolly.orbitUiReactComponents.anon.Props
import typingsJapgolly.orbitUiReactComponents.distCollectionSrcUseCollectionMod.NodeType.divider
import typingsJapgolly.orbitUiReactComponents.distCollectionSrcUseCollectionMod.NodeType.item
import typingsJapgolly.orbitUiReactComponents.distCollectionSrcUseCollectionMod.NodeType.section
...
object distCollectionSrcUseCollectionMod {
  ...
  open class CollectionBuilder () extends StObject {
    ...
    def build(children: Node): js.Array[CollectionNode] = js.native
  ...
  trait CollectionNode extends StObject {
    ...
    var elementType: js.UndefOr[ElementType | String] = js.undefined
  ...
  object CollectionNode {
    ...
    extension [Self <: CollectionNode](x: Self) {
      ...
      inline def setElementType(value: ElementType | String): Self = StObject.set(x, "elementType", value.asInstanceOf[js.Any])
