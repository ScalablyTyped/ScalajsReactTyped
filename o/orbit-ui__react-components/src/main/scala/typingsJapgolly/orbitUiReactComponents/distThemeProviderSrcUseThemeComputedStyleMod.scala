...
object distThemeProviderSrcUseThemeComputedStyleMod {
  ...
  inline def useThemeComputedStyle(componentRef: RefHandle[Element]): ThemeComputedStyle = ^.asInstanceOf[js.Dynamic].applyDynamic("useThemeComputedStyle")(componentRef.asInstanceOf[js.Any]).asInstanceOf[ThemeComputedStyle]
}
