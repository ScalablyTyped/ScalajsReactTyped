...
object distAccordionSrcUseAccordionItemsMod {
  ...
  open class AccordionBuilder protected () extends StObject {
    ...
    def build(children: Node): js.Array[AccordionBuilderItem] = js.native
    
    /* private */ var rootId: Any = js.native
  }
  
  inline def useAccordionItems(children: Node, rootId: String): js.Array[AccordionBuilderItem] = (^.asInstanceOf[js.Dynamic].applyDynamic("useAccordionItems")(children.asInstanceOf[js.Any], rootId.asInstanceOf[js.Any])).asInstanceOf[js.Array[AccordionBuilderItem]]
