...
object distTextInputSrcSearchInputMod {
  
  @JSImport("@orbit-ui/react-components/dist/text-input/src/SearchInput", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@orbit-ui/react-components/dist/text-input/src/SearchInput", "SearchInput")
  @js.native
  ...
  trait InnerSearchInputProps
    ...
    /**
      * @ignore
      */
    var onKeyDown: js.UndefOr[KeyboardEventHandler[org.scalajs.dom.Element]] = js.undefined
  ...
  object InnerSearchInputProps {
    
    inline def apply(): InnerSearchInputProps = {
    ...
    extension [Self <: InnerSearchInputProps](x: Self) {
      ...
      inline def setOnValueChange(value: (/* event */ ReactEventFrom[org.scalajs.dom.Element], /* value */ String) => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[org.scalajs.dom.Element], t1: /* value */ String) => (value(t0, t1)).runNow()))
  ...
  type SearchInputProps = ComponentProps[OrbitComponent[input, InnerSearchInputProps]]
}
