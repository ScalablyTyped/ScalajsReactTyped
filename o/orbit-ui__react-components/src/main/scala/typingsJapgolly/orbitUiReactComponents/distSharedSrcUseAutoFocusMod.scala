...
import typingsJapgolly.orbitUiReactComponents.distSharedSrcUseFocusManagerMod.FocusOptions
...
object distSharedSrcUseAutoFocusMod {
  ...
  object AbstractAutoFocusOptions {
    ...
    extension [Self <: AbstractAutoFocusOptions](x: Self) {
      ...
      inline def setOnFocus(value: /* element */ js.UndefOr[HTMLElement] => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* element */ js.UndefOr[HTMLElement]) => value(t0).runNow()))
