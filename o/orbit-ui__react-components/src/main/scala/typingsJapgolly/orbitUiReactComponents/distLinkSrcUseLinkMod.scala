...
import typingsJapgolly.orbitUiReactComponents.anon.LinkProps
...
object distLinkSrcUseLinkMod {
  ...
  object UseLinkProps {
    ...
    extension [Self <: UseLinkProps](x: Self) {
      ...
      inline def setForwardedRefFunction1(value: /* instance */ HTMLElement | Null => Callback): Self = StObject.set(x, "forwardedRef", js.Any.fromFunction1((t0: /* instance */ HTMLElement | Null) => value(t0).runNow()))
