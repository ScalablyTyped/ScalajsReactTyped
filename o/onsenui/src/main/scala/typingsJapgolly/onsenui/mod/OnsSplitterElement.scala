...
trait OnsSplitterElement extends HTMLElement {
  /**
    ...
    */
  var content: org.scalajs.dom.raw.HTMLElement = js.native
  /**
    * @description Left `<ons-splitter-side>` element.
    */
  var left: org.scalajs.dom.raw.HTMLElement = js.native
  /**
  ...
  /**
    ...
    */
  var right: org.scalajs.dom.raw.HTMLElement = js.native
