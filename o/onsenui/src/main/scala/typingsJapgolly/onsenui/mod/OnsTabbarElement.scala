...
trait OnsTabbarElement
  ...
  /**
    ...
    */
  def loadPage(page: Any): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  def loadPage(page: Any, options: TabbarOptions): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def setActiveTab(index: Double): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  def setActiveTab(index: Double, options: TabbarOptions): js.Promise[org.scalajs.dom.HTMLElement] = js.native
