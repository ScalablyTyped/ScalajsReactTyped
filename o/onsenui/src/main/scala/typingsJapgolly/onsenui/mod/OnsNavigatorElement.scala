...
trait OnsNavigatorElement
  ...
  /**
    ...
    */
  def bringPageTop(item: Any): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  def bringPageTop(item: Any, options: js.Object): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def insertPage(index: Double, page: Any): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  def insertPage(index: Double, page: Any, options: NavigatorOptions): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def popPage(): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  def popPage(options: NavigatorOptions): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def pushPage(page: Any): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  def pushPage(page: Any, options: PushPageOptions): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def replacePage(page: Any): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  def replacePage(page: Any, options: PushPageOptions): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def resetToPage(page: Any): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  def resetToPage(page: Any, options: NavigatorOptions): js.Promise[org.scalajs.dom.HTMLElement] = js.native
  
  /**
    * @return {HTMLElement}
    * @description Current top page element. Use this method to access options passed by `pushPage()`-like methods.
    */
  var topPage: org.scalajs.dom.HTMLElement = js.native
}
