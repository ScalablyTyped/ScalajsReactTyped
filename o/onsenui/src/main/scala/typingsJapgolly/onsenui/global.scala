...
import typingsJapgolly.onsenui.mod.AlertOptions
import typingsJapgolly.onsenui.mod.OnsOptions
...
object global {
  ...
  object ons {
    ...
    open class PageLoader protected ()
      extends typingsJapgolly.onsenui.mod.PageLoader {
    ...
    @js.native
    def defaultPageLoader: typingsJapgolly.onsenui.mod.PageLoader = js.native
    inline def defaultPageLoader_=(x: typingsJapgolly.onsenui.mod.PageLoader): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("defaultPageLoader")(x.asInstanceOf[js.Any])
