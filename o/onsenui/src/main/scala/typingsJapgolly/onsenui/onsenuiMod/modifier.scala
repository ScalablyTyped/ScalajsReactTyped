...
object modifier extends js.Object {
  ...
  /**
    ...
    */
  def toggle(element: typingsJapgolly.std.HTMLElement, modifier: String): Unit = js.native
  def toggle(element: typingsJapgolly.std.HTMLElement, modifier: String, force: Boolean): Unit = js.native
}
