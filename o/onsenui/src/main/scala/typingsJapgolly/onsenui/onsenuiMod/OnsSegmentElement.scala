...
trait OnsSegmentElement extends HTMLElement {
  ...
  /**
    ...
    */
  def setActiveButton(index: Double): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def setActiveButton(index: Double, options: TabbarOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
}
