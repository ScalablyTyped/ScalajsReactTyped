...
trait OnsTabbarElement extends HTMLElement {
  ...
  /**
    ...
    */
  def loadPage(page: js.Any): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def loadPage(page: js.Any, options: TabbarOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  /**
    ...
    */
  def setActiveTab(index: Double): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def setActiveTab(index: Double, options: TabbarOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  /**
