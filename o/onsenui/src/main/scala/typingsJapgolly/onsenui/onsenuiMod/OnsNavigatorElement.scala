...
trait OnsNavigatorElement extends HTMLElement {
  ...
  /**
    ...
    */
  var topPage: org.scalajs.dom.raw.HTMLElement = js.native
  /**
    * @param {any} item
    * @param {Object} [options]
    * @description Page URL or index of an existing page in navigator's stack.
    */
  def bringPageTop(item: js.Any): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def bringPageTop(item: js.Any, options: js.Object): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  /**
    ...
    */
  def insertPage(index: Double, page: js.Any): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def insertPage(index: Double, page: js.Any, options: NavigatorOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  /**
    * @param {Object} [options] Parameter object
    ...
    */
  def popPage(): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def popPage(options: NavigatorOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  /**
    * @param {*} page Page URL. Can be either a HTML document or a <code>&lt;ons-template&gt;</code>
    * @param {Object} [options] Parameter object
    * @param {String} [options.animation] Animation name. Available animations are "slide", "simpleslide", "lift", "fade" and "none"
    ...
    */
  def pushPage(page: js.Any): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def pushPage(page: js.Any, options: PushPageOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  ...
  /**
    ...
    */
  def replacePage(page: js.Any): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def replacePage(page: js.Any, options: PushPageOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  /**
    ...
    */
  def resetToPage(page: js.Any): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
  def resetToPage(page: js.Any, options: NavigatorOptions): js.Promise[org.scalajs.dom.raw.HTMLElement] = js.native
}
