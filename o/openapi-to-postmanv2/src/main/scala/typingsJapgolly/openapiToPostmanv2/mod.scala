package typingsJapgolly.openapiToPostmanv2

import typingsJapgolly.openapiToPostmanv2.anon.Data
import typingsJapgolly.openapiToPostmanv2.anon.MissingEndpoints
import typingsJapgolly.openapiToPostmanv2.anon.Name
import typingsJapgolly.openapiToPostmanv2.anon.Output
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Booleans.`false`
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Booleans.`true`
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.CONVERSION
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Fallback
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Paths
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Space
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Tab
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Tags
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.URL
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.VALIDATION
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.`enum`
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.array
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.boolean
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.document
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.file
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.integer
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.json
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.string
import typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.use
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.`3Dot0`
    - typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.`3Dot1`
  */
  trait OptionsVersion extends StObject
  object OptionsVersion {
    
    inline def `3Dot0`: typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.`3Dot0` = "3.0".asInstanceOf[typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.`3Dot0`]
    
    inline def `3Dot1`: typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.`3Dot1` = "3.1".asInstanceOf[typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.`3Dot1`]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Example
    - typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Schema
  */
  trait ParametersResolution extends StObject
  object ParametersResolution {
    
    inline def Example: typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Example = "Example".asInstanceOf[typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Example]
    
    inline def Schema: typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Schema = "Schema".asInstanceOf[typingsJapgolly.openapiToPostmanv2.openapiToPostmanv2Strings.Schema]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.openapiToPostmanv2.mod.SuccessfulValidationResult
    - typingsJapgolly.openapiToPostmanv2.mod.UnsuccessfulValidationResult
  */
  trait ValidateResult extends StObject
  object ValidateResult {
    
    inline def SuccessfulValidationResult(): typingsJapgolly.openapiToPostmanv2.mod.SuccessfulValidationResult = {
      val __obj = js.Dynamic.literal(result = true)
      __obj.asInstanceOf[typingsJapgolly.openapiToPostmanv2.mod.SuccessfulValidationResult]
    }
    
    inline def UnsuccessfulValidationResult(reason: String): typingsJapgolly.openapiToPostmanv2.mod.UnsuccessfulValidationResult = {
      val __obj = js.Dynamic.literal(reason = reason.asInstanceOf[js.Any], result = false)
      __obj.asInstanceOf[typingsJapgolly.openapiToPostmanv2.mod.UnsuccessfulValidationResult]
    }
  }
}
