...
import typingsJapgolly.openjscad.anon.BoundLen
...
object threeMod {
  ...
  object CSG {
    ...
    inline def fromCSG(csg: typingsJapgolly.openjscad.CSG, defaultColor: Any): BoundLen = (^.asInstanceOf[js.Dynamic].applyDynamic("fromCSG")(csg.asInstanceOf[js.Any], defaultColor.asInstanceOf[js.Any])).asInstanceOf[BoundLen]
