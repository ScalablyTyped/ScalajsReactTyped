...
import typingsJapgolly.openjscad.OpenJsCad.EventHandler
import typingsJapgolly.openjscad.OpenJsCad.ILog
import typingsJapgolly.openjscad.OpenJsCad.IViewerOptions
import typingsJapgolly.openjscad.OpenJsCad.ProcessorOptions
...
object OpenJsCad {
  ...
  open class Processor protected ()
    extends StObject
       with typingsJapgolly.openjscad.OpenJsCad.Processor {
  ...
  open class Viewer protected ()
    extends StObject
       with typingsJapgolly.openjscad.OpenJsCad.Viewer {
