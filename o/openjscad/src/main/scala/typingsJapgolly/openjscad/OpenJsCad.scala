...
object OpenJsCad {
  ...
  trait Viewer extends StObject {
    ...
    def getUserMeshes(): js.Array[Object3D[typingsJapgolly.three.srcCoreEventDispatcherMod.Event]] = js.native
    def getUserMeshes(str: Any): js.Array[Object3D[typingsJapgolly.three.srcCoreEventDispatcherMod.Event]] = js.native
