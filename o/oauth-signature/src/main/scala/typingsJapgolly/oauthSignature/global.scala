...
object global {
  ...
  object oauthSignature {
    ...
    @js.native
    open class HmacSha1 ()
      extends typingsJapgolly.oauthSignature.mod.HmacSha1 {
    ...
    open class HmacSha1Signature protected ()
      extends typingsJapgolly.oauthSignature.mod.HmacSha1Signature {
    ...
    open class HttpMethodElement protected ()
      extends typingsJapgolly.oauthSignature.mod.HttpMethodElement {
    ...
    open class ParametersElement protected ()
      extends typingsJapgolly.oauthSignature.mod.ParametersElement {
    ...
    open class ParametersLoader protected ()
      extends typingsJapgolly.oauthSignature.mod.ParametersLoader {
      def this(parameters: StringDictionary[Any]) = this()
    }
    ...
    @js.native
    open class Rfc3986 ()
      extends typingsJapgolly.oauthSignature.mod.Rfc3986
    
    @JSGlobal("oauthSignature.SignatureBaseString")
    @js.native
    open class SignatureBaseString protected ()
      extends typingsJapgolly.oauthSignature.mod.SignatureBaseString {
    ...
    open class UrlElement protected ()
      extends typingsJapgolly.oauthSignature.mod.UrlElement {
