...
object IOptions {
  ...
  def apply(
    ...
    excludeKeys: /* key */ String => CallbackTo[Boolean] = null,
    excludeValues: js.UndefOr[Boolean] = js.undefined,
    ignoreUnknown: js.UndefOr[Boolean] = js.undefined,
    replacer: /* value */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (excludeKeys != null) __obj.updateDynamic("excludeKeys")(js.Any.fromFunction1((t0: /* key */ java.lang.String) => excludeKeys(t0).runNow()))
    ...
    if (replacer != null) __obj.updateDynamic("replacer")(js.Any.fromFunction1((t0: /* value */ js.Any) => replacer(t0).runNow()))
