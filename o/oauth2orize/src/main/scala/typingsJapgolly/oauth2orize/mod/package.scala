package typingsJapgolly.oauth2orize
...
package object mod {
  type DecisionParseFunction = js.Function2[
    /* req */ typingsJapgolly.oauth2orize.mod.MiddlewareRequest, 
  ...
  type DeserializeClientFunction = js.Function2[
    /* id */ java.lang.String, 
    /* done */ typingsJapgolly.oauth2orize.mod.DeserializeClientDoneFunction, 
    scala.Unit
  ]
  ...
  type IssueExchangeCodeFunction = js.Function4[
    ...
    /* issued */ typingsJapgolly.oauth2orize.mod.ExchangeDoneFunction, 
    scala.Unit
  ]
  ...
  type MiddlewareErrorFunction = js.Function4[
    ...
    /* next */ typingsJapgolly.oauth2orize.mod.MiddlewareNextFunction, 
    scala.Unit
  ]
  ...
  type SerializeClientFunction = js.Function2[
    /* client */ js.Any, 
    /* done */ typingsJapgolly.oauth2orize.mod.SerializeClientDoneFunction, 
    scala.Unit
  ]
