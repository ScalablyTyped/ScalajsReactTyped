...
import typingsJapgolly.openfin.applicationMod.Application
import typingsJapgolly.openfin.externalWindowExternalWindowMod.ExternalWindow
import typingsJapgolly.openfin.identityMod.Identity
import typingsJapgolly.openfin.shapesMod.AnchorType
import typingsJapgolly.openfin.shapesMod.Bounds
import typingsJapgolly.openfin.shapesMod.Transition
import typingsJapgolly.openfin.shapesMod.TransitionOptions
import typingsJapgolly.openfin.viewViewMod.View
import typingsJapgolly.openfin.webcontentsWebcontentsMod.WebContents
import typingsJapgolly.openfin.windowMod.WindowEvents
...
class Window protected () extends WebContents[WindowEvents] {
  def this(wire: typingsJapgolly.openfin.transportMod.default, identity: Identity) = this()
