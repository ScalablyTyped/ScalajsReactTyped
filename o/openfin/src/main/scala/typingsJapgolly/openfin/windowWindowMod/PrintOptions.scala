...
import typingsJapgolly.openfin.openfinStrings.longEdge
import typingsJapgolly.openfin.openfinStrings.shortEdge
import typingsJapgolly.openfin.openfinStrings.simplex
