...
import typingsJapgolly.openfin.openfinStrings.`disabled-frame-bounds-changed`
import typingsJapgolly.openfin.openfinStrings.`disabled-frame-bounds-changing`
