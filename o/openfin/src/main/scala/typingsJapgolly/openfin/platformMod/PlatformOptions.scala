package typingsJapgolly.openfin.platformMod

import typingsJapgolly.openfin.applicationOptionMod.ApplicationOption
import typingsJapgolly.openfin.downloadPreloadMod.DownloadPreloadOption
import typingsJapgolly.openfin.viewViewMod.ViewCreationOptions
import typingsJapgolly.openfin.windowOptionMod.Accelerator
import typingsJapgolly.openfin.windowOptionMod.Api
import typingsJapgolly.openfin.windowOptionMod.ContentNavigation
import typingsJapgolly.openfin.windowOptionMod.CornerRounding
import typingsJapgolly.openfin.windowOptionMod.CustomRequestHeaders
import typingsJapgolly.openfin.windowOptionMod.ResizeRegion
