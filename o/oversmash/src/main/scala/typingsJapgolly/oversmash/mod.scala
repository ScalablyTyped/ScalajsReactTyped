...
import typingsJapgolly.oversmash.anon.Options
...
object mod {
  ...
  object NormalizeNamesAs extends StObject {
    ...
    /* "camel" */ val camel: typingsJapgolly.oversmash.mod.NormalizeNamesAs.camel & String = js.native
    
    @js.native
    sealed trait snake
      extends StObject
         with NormalizeNamesAs
    /* "snake" */ val snake: typingsJapgolly.oversmash.mod.NormalizeNamesAs.snake & String = js.native
  }
