...
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.IssuesCreateParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.IssuesCreateParamsDeprecatedAssignee
