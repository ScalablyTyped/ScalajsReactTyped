...
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.IssuesAddLabelsParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.IssuesAddLabelsParamsDeprecatedNumber
