...
trait `1139` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/license']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1139` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1139`]
  }
  
  extension [Self <: `1139`](x: Self) {
