...
trait `1531` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/emails']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1531` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1531`]
  }
  
  extension [Self <: `1531`](x: Self) {
