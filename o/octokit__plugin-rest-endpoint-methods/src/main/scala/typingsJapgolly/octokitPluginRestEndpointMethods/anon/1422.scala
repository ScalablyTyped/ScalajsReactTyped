...
trait `1422` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/hooks/{hook_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1422`]
  }
  
  extension [Self <: `1422`](x: Self) {
