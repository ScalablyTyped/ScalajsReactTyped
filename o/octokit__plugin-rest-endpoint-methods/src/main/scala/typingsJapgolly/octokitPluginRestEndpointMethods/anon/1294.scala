...
trait `1294` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/comments/{comment_id}']['patch'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1294` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1294`]
  }
  
  extension [Self <: `1294`](x: Self) {
