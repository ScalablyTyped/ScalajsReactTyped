...
trait `907` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/installations/{installation_id}/repositories/{repository_id}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
