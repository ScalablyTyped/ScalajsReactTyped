...
trait `1345` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/tags/protection']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1345` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1345`]
  }
  
  extension [Self <: `1345`](x: Self) {
