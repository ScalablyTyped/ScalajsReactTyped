...
trait `1347` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/hooks']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1347` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1347`]
  }
  
  extension [Self <: `1347`](x: Self) {
