...
trait `1179` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/hooks/{hook_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1179` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1179`]
  }
  
  extension [Self <: `1179`](x: Self) {
