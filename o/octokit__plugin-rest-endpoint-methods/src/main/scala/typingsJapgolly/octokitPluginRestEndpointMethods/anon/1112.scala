...
trait `1112` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/milestones/{milestone_number}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1112` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1112`]
  }
  
  extension [Self <: `1112`](x: Self) {
