...
trait `1346` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{template_owner}/{template_repo}/generate']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1346` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1346`]
  }
  
  extension [Self <: `1346`](x: Self) {
