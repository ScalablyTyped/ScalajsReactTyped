...
trait `1332` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/keys']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1332` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1332`]
  }
  
  extension [Self <: `1332`](x: Self) {
