...
trait `1405` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pages']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1405` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1405`]
  }
  
  extension [Self <: `1405`](x: Self) {
