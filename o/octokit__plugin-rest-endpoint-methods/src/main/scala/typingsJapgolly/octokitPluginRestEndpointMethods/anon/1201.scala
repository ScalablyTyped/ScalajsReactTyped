...
trait `1201` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/security-managers']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1201` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1201`]
  }
  
  extension [Self <: `1201`](x: Self) {
