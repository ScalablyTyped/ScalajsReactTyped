...
trait `1101` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1101` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1101`]
  }
  
  extension [Self <: `1101`](x: Self) {
