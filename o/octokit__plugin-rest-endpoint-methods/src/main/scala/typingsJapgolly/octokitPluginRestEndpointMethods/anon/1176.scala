...
trait `1176` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/invitations']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1176` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1176`]
  }
  
  extension [Self <: `1176`](x: Self) {
