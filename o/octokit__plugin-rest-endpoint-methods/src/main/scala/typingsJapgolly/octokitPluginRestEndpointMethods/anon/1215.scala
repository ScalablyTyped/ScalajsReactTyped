...
trait `1215` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/custom_roles/{role_id}']['patch'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1215` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1215`]
  }
  
  extension [Self <: `1215`](x: Self) {
