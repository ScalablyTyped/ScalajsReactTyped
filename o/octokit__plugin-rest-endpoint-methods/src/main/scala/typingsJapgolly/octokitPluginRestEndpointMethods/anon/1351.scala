...
trait `1351` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/protection/enforce_admins']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1351` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1351`]
  }
  
  extension [Self <: `1351`](x: Self) {
