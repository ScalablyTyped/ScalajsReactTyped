...
trait `1403` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pages/builds/latest']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1403` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1403`]
  }
  
  extension [Self <: `1403`](x: Self) {
