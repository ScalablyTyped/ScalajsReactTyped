...
trait `1130` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/{issue_number}/labels/{name}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1130` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1130`]
  }
  
  extension [Self <: `1130`](x: Self) {
