...
trait `1161` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/import/lfs']['patch'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1161` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1161`]
  }
  
  extension [Self <: `1161`](x: Self) {
