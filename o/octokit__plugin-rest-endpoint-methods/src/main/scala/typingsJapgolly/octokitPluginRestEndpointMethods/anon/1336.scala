...
trait `1336` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/dispatches']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1336` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1336`]
  }
  
  extension [Self <: `1336`](x: Self) {
