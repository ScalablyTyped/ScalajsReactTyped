...
trait `1419` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/traffic/popular/referrers']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1419` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1419`]
  }
  
  extension [Self <: `1419`](x: Self) {
