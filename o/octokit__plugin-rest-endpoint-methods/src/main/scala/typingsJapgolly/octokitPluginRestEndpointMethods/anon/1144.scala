...
trait `1144` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/zen']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1144` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1144`]
  }
  
  extension [Self <: `1144`](x: Self) {
