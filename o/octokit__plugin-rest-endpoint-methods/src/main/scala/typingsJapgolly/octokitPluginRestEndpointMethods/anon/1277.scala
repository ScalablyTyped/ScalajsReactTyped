...
trait `1277` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/{pull_number}/reviews/{review_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1277` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1277`]
  }
  
  extension [Self <: `1277`](x: Self) {
