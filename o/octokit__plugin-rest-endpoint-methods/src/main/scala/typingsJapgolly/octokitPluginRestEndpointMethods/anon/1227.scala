...
trait `1227` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/users/{username}/packages/{package_type}/{package_name}/versions']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1227` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1227`]
  }
  
  extension [Self <: `1227`](x: Self) {
