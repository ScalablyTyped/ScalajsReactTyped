...
trait `1310` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/comments/{comment_id}/reactions']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1310` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1310`]
  }
  
  extension [Self <: `1310`](x: Self) {
