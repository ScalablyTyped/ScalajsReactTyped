...
trait `1399` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/deployments/{deployment_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1399` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1399`]
  }
  
  extension [Self <: `1399`](x: Self) {
