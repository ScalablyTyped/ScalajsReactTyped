...
trait `1540` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/gpg_keys/{gpg_key_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1540` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1540`]
  }
  
  extension [Self <: `1540`](x: Self) {
