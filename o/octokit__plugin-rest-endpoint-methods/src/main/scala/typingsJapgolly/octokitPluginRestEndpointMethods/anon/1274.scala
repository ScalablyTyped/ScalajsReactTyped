...
trait `1274` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/comments/{comment_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1274` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1274`]
  }
  
  extension [Self <: `1274`](x: Self) {
