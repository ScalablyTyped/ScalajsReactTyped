...
trait `1263` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/projects/columns/{column_id}/moves']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1263` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1263`]
  }
  
  extension [Self <: `1263`](x: Self) {
