...
trait `1264` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/projects/{project_id}/collaborators/{username}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1264` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1264`]
  }
  
  extension [Self <: `1264`](x: Self) {
