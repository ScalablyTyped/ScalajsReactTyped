...
trait `1174` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/outside_collaborators/{username}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1174` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1174`]
  }
  
  extension [Self <: `1174`](x: Self) {
