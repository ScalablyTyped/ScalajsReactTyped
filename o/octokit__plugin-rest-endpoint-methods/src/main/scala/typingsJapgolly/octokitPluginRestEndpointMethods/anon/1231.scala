...
trait `1231` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/packages/{package_type}/{package_name}/versions/{package_version_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1231` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1231`]
  }
  
  extension [Self <: `1231`](x: Self) {
