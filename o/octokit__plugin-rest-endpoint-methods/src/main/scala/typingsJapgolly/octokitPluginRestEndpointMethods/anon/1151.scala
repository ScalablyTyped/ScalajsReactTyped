...
trait `1151` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/import/authors']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1151` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1151`]
  }
  
  extension [Self <: `1151`](x: Self) {
