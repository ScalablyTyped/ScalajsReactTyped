...
trait `1344` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/releases']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1344` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1344`]
  }
  
  extension [Self <: `1344`](x: Self) {
