...
trait `1173` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/public_members/{username}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1173` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1173`]
  }
  
  extension [Self <: `1173`](x: Self) {
