...
trait `1177` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/hooks']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1177` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1177`]
  }
  
  extension [Self <: `1177`](x: Self) {
