...
trait `1268` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/{pull_number}/merge']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1268` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1268`]
  }
  
  extension [Self <: `1268`](x: Self) {
