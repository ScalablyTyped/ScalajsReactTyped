...
trait `1271` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/{pull_number}/reviews']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1271` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1271`]
  }
  
  extension [Self <: `1271`](x: Self) {
