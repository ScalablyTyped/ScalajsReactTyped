...
trait `1224` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/users/{username}/packages/{package_type}/{package_name}/versions/{package_version_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1224` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1224`]
  }
  
  extension [Self <: `1224`](x: Self) {
