...
trait `1564` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/email/visibility']['patch'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1564` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1564`]
  }
  
  extension [Self <: `1564`](x: Self) {
