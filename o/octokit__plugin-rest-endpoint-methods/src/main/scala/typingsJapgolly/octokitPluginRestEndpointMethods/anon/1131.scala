...
trait `1131` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/{issue_number}/labels']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1131` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1131`]
  }
  
  extension [Self <: `1131`](x: Self) {
