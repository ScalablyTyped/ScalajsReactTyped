...
trait `1205` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/hooks/{hook_id}/deliveries/{delivery_id}/attempts']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1205` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1205`]
  }
  
  extension [Self <: `1205`](x: Self) {
