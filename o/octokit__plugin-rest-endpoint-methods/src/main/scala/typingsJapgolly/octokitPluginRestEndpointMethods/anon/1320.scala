...
trait `1320` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/branches/{branch}/protection/required_status_checks/contexts']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1320` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1320`]
  }
  
  extension [Self <: `1320`](x: Self) {
