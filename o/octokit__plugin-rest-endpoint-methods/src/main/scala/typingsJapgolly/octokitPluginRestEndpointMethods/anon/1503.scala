...
trait `1503` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/teams/{team_slug}/repos/{owner}/{repo}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1503` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1503`]
  }
  
  extension [Self <: `1503`](x: Self) {
