...
trait `1106` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/labels/{name}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1106` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1106`]
  }
  
  extension [Self <: `1106`](x: Self) {
