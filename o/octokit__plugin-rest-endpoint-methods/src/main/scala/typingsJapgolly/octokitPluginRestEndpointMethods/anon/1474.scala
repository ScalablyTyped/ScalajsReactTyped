...
trait `1474` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/transfer']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1474` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1474`]
  }
  
  extension [Self <: `1474`](x: Self) {
