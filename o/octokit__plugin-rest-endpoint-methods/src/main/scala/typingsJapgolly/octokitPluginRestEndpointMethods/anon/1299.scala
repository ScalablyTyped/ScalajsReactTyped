...
trait `1299` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/pulls/comments/{comment_id}/reactions']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1299` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1299`]
  }
  
  extension [Self <: `1299`](x: Self) {
