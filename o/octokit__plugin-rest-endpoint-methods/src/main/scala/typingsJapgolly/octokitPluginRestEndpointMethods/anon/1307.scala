...
trait `1307` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/releases/{release_id}/reactions/{reaction_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1307` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1307`]
  }
  
  extension [Self <: `1307`](x: Self) {
