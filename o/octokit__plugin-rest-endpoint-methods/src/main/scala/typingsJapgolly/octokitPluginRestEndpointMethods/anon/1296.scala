...
trait `1296` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/comments/{comment_id}/reactions']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1296` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1296`]
  }
  
  extension [Self <: `1296`](x: Self) {
