...
trait `1207` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/orgs/{org}/memberships/{username}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1207` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1207`]
  }
  
  extension [Self <: `1207`](x: Self) {
