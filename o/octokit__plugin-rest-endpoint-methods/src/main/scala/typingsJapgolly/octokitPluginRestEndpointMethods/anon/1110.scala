...
trait `1110` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/issues/events/{event_id}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1110` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1110`]
  }
  
  extension [Self <: `1110`](x: Self) {
