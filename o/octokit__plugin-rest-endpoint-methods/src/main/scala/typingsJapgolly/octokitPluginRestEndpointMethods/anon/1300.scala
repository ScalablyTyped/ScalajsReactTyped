...
trait `1300` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/releases/{release_id}/reactions']['post'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1300` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1300`]
  }
  
  extension [Self <: `1300`](x: Self) {
