...
trait `1543` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/user/following/{username}']['put'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1543` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1543`]
  }
  
  extension [Self <: `1543`](x: Self) {
