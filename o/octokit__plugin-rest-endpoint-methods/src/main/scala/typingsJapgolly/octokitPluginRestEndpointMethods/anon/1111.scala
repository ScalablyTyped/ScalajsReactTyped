...
trait `1111` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/repos/{owner}/{repo}/labels/{name}']['get'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1111` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1111`]
  }
  
  extension [Self <: `1111`](x: Self) {
