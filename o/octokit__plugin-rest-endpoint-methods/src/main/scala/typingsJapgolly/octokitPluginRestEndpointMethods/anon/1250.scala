...
trait `1250` extends StObject {
  
  var parameters: RequestParameters & (Omit[
    (ToOctokitParameters[
      /* import warning: importer.ImportType#apply Failed type conversion: @octokit/openapi-types.@octokit/openapi-types.paths['/projects/columns/cards/{card_id}']['delete'] */ js.Any
    ]) & RequiredPreview[Any], 
...
object `1250` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`1250`]
  }
  
  extension [Self <: `1250`](x: Self) {
