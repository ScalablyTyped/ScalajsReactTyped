...
trait AnonCreateForCommitComment extends js.Object {
  var createForCommitComment: AnonParamsAnonCommentidContent
  var createForIssue: AnonParamsAnonContentIssuenumber
  var createForIssueComment: AnonParamsAnonCommentidContent
  var createForPullRequestReviewComment: AnonParamsAnonCommentidContent
  var createForTeamDiscussion: AnonParamsAnonDiscussionnumber
  var createForTeamDiscussionComment: AnonParamsAnonCommentnumber
  var createForTeamDiscussionCommentInOrg: AnonParamsAnonTeamslug
  var createForTeamDiscussionCommentLegacy: AnonParamsAnonCommentnumber
  var createForTeamDiscussionInOrg: AnonParamsAnonContentDiscussionnumber
  var createForTeamDiscussionLegacy: AnonParamsAnonDiscussionnumber
  var delete: AnonParamsAnonReactionid
  var listForCommitComment: AnonParamsAnonContentOwner
  var listForIssue: AnonParamsAnonContentIssuenumberNumber
  var listForIssueComment: AnonParamsAnonContentOwner
  var listForPullRequestReviewComment: AnonParamsAnonContentOwner
  var listForTeamDiscussion: AnonParamsAnonTeamid
  var listForTeamDiscussionComment: AnonParamsAnonCommentnumberContent
  var listForTeamDiscussionCommentInOrg: AnonParamsAnonDiscussionnumberOrg
  var listForTeamDiscussionCommentLegacy: AnonParamsAnonCommentnumberContent
  var listForTeamDiscussionInOrg: AnonParamsAnonPerpageTeamslug
  var listForTeamDiscussionLegacy: AnonParamsAnonTeamid
}
