...
trait ProjectsCreateForAuthenticatedUserResponse extends js.Object {
  var body: String
  var columns_url: String
  var created_at: String
  var creator: ProjectsCreateForAuthenticatedUserResponseCreator
  var html_url: String
  var id: Double
  var name: String
  var node_id: String
...
object ProjectsCreateForAuthenticatedUserResponse {
  @scala.inline
  def apply(
    body: String,
    columns_url: String,
    ...
    __obj.asInstanceOf[ProjectsCreateForAuthenticatedUserResponse]
  }
}
