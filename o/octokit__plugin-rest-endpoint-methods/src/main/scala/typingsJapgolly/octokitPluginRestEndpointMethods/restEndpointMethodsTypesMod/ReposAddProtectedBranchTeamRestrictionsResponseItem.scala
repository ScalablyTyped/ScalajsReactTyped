...
trait ReposAddProtectedBranchTeamRestrictionsResponseItem extends js.Object {
...
object ReposAddProtectedBranchTeamRestrictionsResponseItem {
  @scala.inline
  def apply(
    description: String,
    html_url: String,
    ...
    __obj.asInstanceOf[ReposAddProtectedBranchTeamRestrictionsResponseItem]
  }
}
