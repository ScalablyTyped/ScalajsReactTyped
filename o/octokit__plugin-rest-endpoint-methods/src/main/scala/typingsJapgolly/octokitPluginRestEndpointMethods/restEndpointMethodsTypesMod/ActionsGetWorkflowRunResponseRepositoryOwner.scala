...
trait ActionsGetWorkflowRunResponseRepositoryOwner extends js.Object {
...
object ActionsGetWorkflowRunResponseRepositoryOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActionsGetWorkflowRunResponseRepositoryOwner]
  }
}
