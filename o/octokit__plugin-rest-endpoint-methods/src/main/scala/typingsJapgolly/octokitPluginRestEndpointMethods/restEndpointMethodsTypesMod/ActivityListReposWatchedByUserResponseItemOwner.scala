...
trait ActivityListReposWatchedByUserResponseItemOwner extends js.Object {
...
object ActivityListReposWatchedByUserResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ActivityListReposWatchedByUserResponseItemOwner]
  }
}
