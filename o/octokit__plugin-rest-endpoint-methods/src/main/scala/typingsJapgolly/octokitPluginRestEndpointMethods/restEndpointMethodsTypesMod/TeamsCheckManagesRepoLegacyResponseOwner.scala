...
trait TeamsCheckManagesRepoLegacyResponseOwner extends js.Object {
...
object TeamsCheckManagesRepoLegacyResponseOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsCheckManagesRepoLegacyResponseOwner]
  }
}
