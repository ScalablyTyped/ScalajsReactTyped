...
trait TeamsListForAuthenticatedUserResponseItem extends js.Object {
  ...
  var name: String
  var node_id: String
  var organization: TeamsListForAuthenticatedUserResponseItemOrganization
  var parent: Null
...
object TeamsListForAuthenticatedUserResponseItem {
  @scala.inline
  def apply(
    created_at: String,
    description: String,
    ...
    __obj.asInstanceOf[TeamsListForAuthenticatedUserResponseItem]
  }
}
