...
trait ChecksListSuitesForRefResponseCheckSuitesItemAppOwner extends js.Object {
...
object ChecksListSuitesForRefResponseCheckSuitesItemAppOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[ChecksListSuitesForRefResponseCheckSuitesItemAppOwner]
  }
}
