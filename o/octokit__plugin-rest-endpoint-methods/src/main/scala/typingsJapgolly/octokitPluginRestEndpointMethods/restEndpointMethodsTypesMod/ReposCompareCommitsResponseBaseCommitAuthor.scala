...
trait ReposCompareCommitsResponseBaseCommitAuthor extends js.Object {
...
object ReposCompareCommitsResponseBaseCommitAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCompareCommitsResponseBaseCommitAuthor]
  }
}
