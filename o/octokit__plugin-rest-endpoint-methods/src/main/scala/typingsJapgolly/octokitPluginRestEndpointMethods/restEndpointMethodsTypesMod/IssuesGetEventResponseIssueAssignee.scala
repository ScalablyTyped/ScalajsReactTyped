...
trait IssuesGetEventResponseIssueAssignee extends js.Object {
...
object IssuesGetEventResponseIssueAssignee {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesGetEventResponseIssueAssignee]
  }
}
