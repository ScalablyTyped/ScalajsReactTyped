...
trait ReposCreateDeploymentStatusResponseCreator extends js.Object {
...
object ReposCreateDeploymentStatusResponseCreator {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[ReposCreateDeploymentStatusResponseCreator]
  }
}
