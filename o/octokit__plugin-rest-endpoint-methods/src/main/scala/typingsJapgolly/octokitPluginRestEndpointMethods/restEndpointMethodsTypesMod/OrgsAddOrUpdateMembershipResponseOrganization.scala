...
trait OrgsAddOrUpdateMembershipResponseOrganization extends js.Object {
...
object OrgsAddOrUpdateMembershipResponseOrganization {
  @scala.inline
  def apply(
    avatar_url: String,
    description: String,
    ...
    __obj.asInstanceOf[OrgsAddOrUpdateMembershipResponseOrganization]
  }
}
