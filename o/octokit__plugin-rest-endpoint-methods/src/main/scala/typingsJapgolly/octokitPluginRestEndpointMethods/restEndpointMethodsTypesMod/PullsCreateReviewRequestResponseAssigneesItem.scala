...
trait PullsCreateReviewRequestResponseAssigneesItem extends js.Object {
...
object PullsCreateReviewRequestResponseAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseAssigneesItem]
  }
}
