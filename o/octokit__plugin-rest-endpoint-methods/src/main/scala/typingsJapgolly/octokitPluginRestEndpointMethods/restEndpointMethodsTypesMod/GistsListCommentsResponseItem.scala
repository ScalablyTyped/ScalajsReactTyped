...
trait GistsListCommentsResponseItem extends js.Object {
  var body: String
  ...
  var url: String
  var user: GistsListCommentsResponseItemUser
}

object GistsListCommentsResponseItem {
  @scala.inline
  def apply(
    body: String,
    created_at: String,
    ...
    __obj.asInstanceOf[GistsListCommentsResponseItem]
  }
}
