...
trait MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemOwner extends js.Object {
...
object MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[MigrationsGetStatusForAuthenticatedUserResponseRepositoriesItemOwner]
  }
}
