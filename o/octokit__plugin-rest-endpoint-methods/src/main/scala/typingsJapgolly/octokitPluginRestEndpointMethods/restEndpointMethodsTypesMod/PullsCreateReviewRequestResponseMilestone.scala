...
trait PullsCreateReviewRequestResponseMilestone extends js.Object {
  var closed_at: String
  var closed_issues: Double
  var created_at: String
  var creator: PullsCreateReviewRequestResponseMilestoneCreator
...
object PullsCreateReviewRequestResponseMilestone {
  @scala.inline
  def apply(
    closed_at: String,
    ...
    __obj.asInstanceOf[PullsCreateReviewRequestResponseMilestone]
  }
}
