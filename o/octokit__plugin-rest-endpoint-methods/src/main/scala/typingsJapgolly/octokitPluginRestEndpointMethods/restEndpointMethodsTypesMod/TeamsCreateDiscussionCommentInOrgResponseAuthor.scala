...
trait TeamsCreateDiscussionCommentInOrgResponseAuthor extends js.Object {
...
object TeamsCreateDiscussionCommentInOrgResponseAuthor {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsCreateDiscussionCommentInOrgResponseAuthor]
  }
}
