...
trait IssuesAddAssigneesResponseAssigneesItem extends js.Object {
...
object IssuesAddAssigneesResponseAssigneesItem {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[IssuesAddAssigneesResponseAssigneesItem]
  }
}
