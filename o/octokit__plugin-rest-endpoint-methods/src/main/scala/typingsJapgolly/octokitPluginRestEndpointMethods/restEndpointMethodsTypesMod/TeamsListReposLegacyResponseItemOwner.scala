...
trait TeamsListReposLegacyResponseItemOwner extends js.Object {
...
object TeamsListReposLegacyResponseItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[TeamsListReposLegacyResponseItemOwner]
  }
}
