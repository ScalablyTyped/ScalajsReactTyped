...
trait AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwner extends js.Object {
...
object AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwner {
  @scala.inline
  def apply(
    avatar_url: String,
    events_url: String,
    ...
    __obj.asInstanceOf[AppsListInstallationReposForAuthenticatedUserResponseRepositoriesItemOwner]
  }
}
