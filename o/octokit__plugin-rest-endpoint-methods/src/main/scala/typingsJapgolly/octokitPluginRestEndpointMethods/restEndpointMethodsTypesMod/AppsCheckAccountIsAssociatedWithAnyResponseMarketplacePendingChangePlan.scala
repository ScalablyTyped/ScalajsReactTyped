...
trait AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePendingChangePlan extends js.Object {
...
object AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePendingChangePlan {
  @scala.inline
  def apply(
    accounts_url: String,
    ...
    __obj.asInstanceOf[AppsCheckAccountIsAssociatedWithAnyResponseMarketplacePendingChangePlan]
  }
}
