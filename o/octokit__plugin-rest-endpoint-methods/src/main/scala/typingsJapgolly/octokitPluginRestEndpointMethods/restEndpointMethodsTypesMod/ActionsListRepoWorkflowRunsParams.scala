...
import typingsJapgolly.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.conclusion
import typingsJapgolly.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.status
...
trait ActionsListRepoWorkflowRunsParams extends js.Object {
  ...
  var status: js.UndefOr[
    completed | typingsJapgolly.octokitPluginRestEndpointMethods.octokitPluginRestEndpointMethodsStrings.status | conclusion
  ] = js.undefined
}
