...
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsAddOrUpdateMembershipParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsBlockUserParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsCheckBlockedUserParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsCheckMembershipParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsCheckPublicMembershipParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsConcealMembershipParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsConvertMemberToOutsideCollaboratorParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsCreateHookParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsCreateInvitationParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsDeleteHookParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsGetHookParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsGetMembershipForAuthenticatedUserParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsGetMembershipParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsGetParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListBlockedUsersParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListForAuthenticatedUserParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListForUserParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListHooksParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListInstallationsParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListInvitationTeamsParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListMembersParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListMembershipsParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListOutsideCollaboratorsParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListPendingInvitationsParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsListPublicMembersParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsPingHookParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsPublicizeMembershipParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsRemoveMemberParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsRemoveMembershipParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsRemoveOutsideCollaboratorParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsUnblockUserParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsUpdateHookParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsUpdateMembershipParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsUpdateParams
import typingsJapgolly.octokitPluginRestEndpointMethods.restEndpointMethodsTypesMod.OrgsUpdateParamsDeprecatedMembersAllowedRepositoryCreationType
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

@js.native
trait AnonBlockUser extends js.Object {
  /**
  ...
  var addOrUpdateMembership_Original: Anon224 = js.native
  @JSName("blockUser")
  var blockUser_Original: Anon225 = js.native
  /**
  ...
  var checkBlockedUser_Original: Anon226 = js.native
  /**
    * Check if a user is, publicly or privately, a member of the organization.
    */
  @JSName("checkMembership")
  var checkMembership_Original: Anon227 = js.native
  @JSName("checkPublicMembership")
  var checkPublicMembership_Original: Anon228 = js.native
  @JSName("concealMembership")
  var concealMembership_Original: Anon229 = js.native
  /**
    * When an organization member is converted to an outside collaborator, they'll only have access to the repositories that their current team membership allows. The user will no longer be a member of the organization. For more information, see "[Converting an organization member to an outside collaborator](https://help.github.com/articles/converting-an-organization-member-to-an-outside-collaborator/)".
    */
  @JSName("convertMemberToOutsideCollaborator")
  var convertMemberToOutsideCollaborator_Original: Anon230 = js.native
  /**
    * Here's how you can create a hook that posts payloads in JSON format:
    */
  @JSName("createHook")
  var createHook_Original: Anon231 = js.native
  /**
  ...
  var createInvitation_Original: Anon232 = js.native
  @JSName("deleteHook")
  var deleteHook_Original: Anon233 = js.native
  @JSName("getHook")
  var getHook_Original: Anon235 = js.native
  @JSName("getMembershipForAuthenticatedUser")
  var getMembershipForAuthenticatedUser_Original: Anon237 = js.native
  /**
    * In order to get a user's membership with an organization, the authenticated user must be an organization member.
    */
  @JSName("getMembership")
  var getMembership_Original: Anon236 = js.native
  /**
    ...
    */
  @JSName("get")
  var get_Original: Anon234 = js.native
  /**
    * List the users blocked by an organization.
    */
  @JSName("listBlockedUsers")
  var listBlockedUsers_Original: Anon239 = js.native
  /**
  ...
  var listForAuthenticatedUser_Original: Anon240 = js.native
  /**
    ...
    */
  @JSName("listForUser")
  var listForUser_Original: Anon241 = js.native
  @JSName("listHooks")
  var listHooks_Original: Anon242 = js.native
  /**
    * Lists all GitHub Apps in an organization. The installation count includes all GitHub Apps installed on repositories in the organization. You must be an organization owner with `admin:read` scope to use this endpoint.
    */
  @JSName("listInstallations")
  var listInstallations_Original: Anon243 = js.native
  /**
    * List all teams associated with an invitation. In order to see invitations in an organization, the authenticated user must be an organization owner.
    */
  @JSName("listInvitationTeams")
  var listInvitationTeams_Original: Anon244 = js.native
  /**
    * List all users who are members of an organization. If the authenticated user is also a member of this organization then both concealed and public members will be returned.
    */
  @JSName("listMembers")
  var listMembers_Original: Anon245 = js.native
  @JSName("listMemberships")
  var listMemberships_Original: Anon246 = js.native
  /**
    * List all users who are outside collaborators of an organization.
    */
  @JSName("listOutsideCollaborators")
  var listOutsideCollaborators_Original: Anon247 = js.native
  /**
    * The return hash contains a `role` field which refers to the Organization Invitation role and will be one of the following values: `direct_member`, `admin`, `billing_manager`, `hiring_manager`, or `reinstate`. If the invitee is not a GitHub member, the `login` field in the return hash will be `null`.
    */
  @JSName("listPendingInvitations")
  var listPendingInvitations_Original: Anon248 = js.native
  /**
    * Members of an organization can choose to have their membership publicized or not.
    */
  @JSName("listPublicMembers")
  var listPublicMembers_Original: Anon249 = js.native
  /**
    ...
    */
  @JSName("list")
  var list_Original: Anon238 = js.native
  /**
    * This will trigger a [ping event](https://developer.github.com/webhooks/#ping-event) to be sent to the hook.
    */
  @JSName("pingHook")
  var pingHook_Original: Anon250 = js.native
  /**
  ...
  var publicizeMembership_Original: Anon251 = js.native
  /**
    * Removing a user from this list will remove them from all teams and they will no longer have any access to the organization's repositories.
    */
  @JSName("removeMember")
  var removeMember_Original: Anon252 = js.native
  /**
  ...
  var removeMembership_Original: Anon253 = js.native
  /**
    * Removing a user from this list will remove them from all the organization's repositories.
    */
  @JSName("removeOutsideCollaborator")
  var removeOutsideCollaborator_Original: Anon254 = js.native
  @JSName("unblockUser")
  var unblockUser_Original: Anon255 = js.native
  @JSName("updateHook")
  var updateHook_Original: Anon257 = js.native
  @JSName("updateMembership")
  var updateMembership_Original: Anon258 = js.native
  /**
    ...
    */
  @JSName("update")
  var update_Original: Anon256 = js.native
  /**
    * Only authenticated organization owners can add a member to the organization or update the member's role.
    *
    * *   If the authenticated user is _adding_ a member to the organization, the invited user will receive an email inviting them to the organization. The user's [membership status](https://developer.github.com/v3/orgs/members/#get-organization-membership) will be `pending` until they accept the invitation.
