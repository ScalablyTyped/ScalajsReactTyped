package typingsJapgolly.openapiFramework.mod

import japgolly.scalajs.react.Callback
import typingsJapgolly.openapiFramework.typesMod.IOpenAPIFramework
import typingsJapgolly.openapiFramework.typesMod.OpenAPIFrameworkConstructorArgs
import typingsJapgolly.openapiFramework.typesMod.OpenAPIFrameworkVisitor
...
trait OpenAPIFramework extends IOpenAPIFramework {
  ...
  val basePaths: js.Array[typingsJapgolly.openapiFramework.basePathMod.default]
...
object OpenAPIFramework {
  ...
  def apply(
    ...
    basePaths: js.Array[typingsJapgolly.openapiFramework.basePathMod.default],
    ...
    featureType: String,
    initialize: OpenAPIFrameworkVisitor => Callback,
    logger: js.Any,
    ...
    val __obj = js.Dynamic.literal(apiDoc = apiDoc.asInstanceOf[js.Any], args = args.asInstanceOf[js.Any], basePaths = basePaths.asInstanceOf[js.Any], customFormats = customFormats.asInstanceOf[js.Any], dependencies = dependencies.asInstanceOf[js.Any], enableObjectCoercion = enableObjectCoercion.asInstanceOf[js.Any], errorTransformer = errorTransformer.asInstanceOf[js.Any], externalSchemas = externalSchemas.asInstanceOf[js.Any], featureType = featureType.asInstanceOf[js.Any], logger = logger.asInstanceOf[js.Any], loggingPrefix = loggingPrefix.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], operations = operations.asInstanceOf[js.Any], originalApiDoc = originalApiDoc.asInstanceOf[js.Any], pathSecurity = pathSecurity.asInstanceOf[js.Any], paths = paths.asInstanceOf[js.Any], pathsIgnore = pathsIgnore.asInstanceOf[js.Any], routesGlob = routesGlob.asInstanceOf[js.Any], routesIndexFileRegExp = routesIndexFileRegExp.asInstanceOf[js.Any], securityHandlers = securityHandlers.asInstanceOf[js.Any], validateApiDoc = validateApiDoc.asInstanceOf[js.Any], validator = validator.asInstanceOf[js.Any])
    __obj.updateDynamic("initialize")(js.Any.fromFunction1((t0: typingsJapgolly.openapiFramework.typesMod.OpenAPIFrameworkVisitor) => initialize(t0).runNow()))
