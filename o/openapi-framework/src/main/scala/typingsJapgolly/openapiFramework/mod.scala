...
import typingsJapgolly.openapiFramework.distSrcTypesMod.OpenAPIFrameworkConstructorArgs
import typingsJapgolly.openapiFramework.distSrcTypesMod.OpenAPIFrameworkVisitor
...
object mod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override val basePaths: js.Array[typingsJapgolly.openapiFramework.distSrcBasePathMod.default] = js.native
  ...
  open class BasePath protected ()
    extends typingsJapgolly.openapiFramework.distSrcBasePathMod.default {
  ...
  trait OpenAPIFramework
    ...
    val basePaths: js.Array[typingsJapgolly.openapiFramework.distSrcBasePathMod.default]
  ...
  object OpenAPIFramework {
    ...
    inline def apply(
      ...
      basePaths: js.Array[typingsJapgolly.openapiFramework.distSrcBasePathMod.default],
      customFormats: Any,
      customKeywords: Any,
      dependencies: Any,
    ...
    extension [Self <: OpenAPIFramework](x: Self) {
      ...
      inline def setBasePaths(value: js.Array[typingsJapgolly.openapiFramework.distSrcBasePathMod.default]): Self = StObject.set(x, "basePaths", value.asInstanceOf[js.Any])
      
      inline def setBasePathsVarargs(value: typingsJapgolly.openapiFramework.distSrcBasePathMod.default*): Self = StObject.set(x, "basePaths", js.Array(value*))
