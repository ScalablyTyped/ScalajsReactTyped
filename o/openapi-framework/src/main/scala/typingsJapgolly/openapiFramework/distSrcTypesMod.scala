...
import typingsJapgolly.openapiFramework.anon.Coercer
import typingsJapgolly.openapiFramework.anon.DefaultSetter
import typingsJapgolly.openapiFramework.distSrcBasePathMod.default
...
object distSrcTypesMod {
  ...
  object OpenAPIFrameworkAPIContext {
    ...
    inline def apply(basePaths: js.Array[default], getApiDoc: CallbackTo[Any]): OpenAPIFrameworkAPIContext = {
      val __obj = js.Dynamic.literal(basePaths = basePaths.asInstanceOf[js.Any], getApiDoc = getApiDoc.toJsFn)
    ...
    extension [Self <: OpenAPIFrameworkAPIContext](x: Self) {
      ...
      inline def setGetApiDoc(value: CallbackTo[Any]): Self = StObject.set(x, "getApiDoc", value.toJsFn)
    }
  }
  
  trait OpenAPIFrameworkArgs extends StObject {
    
    var apiDoc: Document[js.Object] | typingsJapgolly.openapiTypes.mod.OpenAPIV3.Document[js.Object] | String
  ...
  object OpenAPIFrameworkArgs {
    ...
    extension [Self <: OpenAPIFrameworkArgs](x: Self) {
      ...
      inline def setApiDoc(
        value: Document[js.Object] | typingsJapgolly.openapiTypes.mod.OpenAPIV3.Document[js.Object] | String
      ): Self = StObject.set(x, "apiDoc", value.asInstanceOf[js.Any])
  ...
  object OpenAPIFrameworkPathContext {
    ...
    inline def apply(basePaths: js.Array[default], getApiDoc: CallbackTo[Any], getPathDoc: CallbackTo[Any]): OpenAPIFrameworkPathContext = {
      val __obj = js.Dynamic.literal(basePaths = basePaths.asInstanceOf[js.Any], getApiDoc = getApiDoc.toJsFn, getPathDoc = getPathDoc.toJsFn)
    ...
    extension [Self <: OpenAPIFrameworkPathContext](x: Self) {
      ...
      inline def setGetPathDoc(value: CallbackTo[Any]): Self = StObject.set(x, "getPathDoc", value.toJsFn)
    }
  }
  ...
  object OpenAPIFrameworkVisitor {
    ...
    extension [Self <: OpenAPIFrameworkVisitor](x: Self) {
      ...
      inline def setVisitApi(value: /* context */ OpenAPIFrameworkAPIContext => Callback): Self = StObject.set(x, "visitApi", js.Any.fromFunction1((t0: /* context */ OpenAPIFrameworkAPIContext) => value(t0).runNow()))
      
      inline def setVisitApiUndefined: Self = StObject.set(x, "visitApi", js.undefined)
      
      inline def setVisitOperation(value: /* context */ OpenAPIFrameworkOperationContext => Callback): Self = StObject.set(x, "visitOperation", js.Any.fromFunction1((t0: /* context */ OpenAPIFrameworkOperationContext) => value(t0).runNow()))
      
      inline def setVisitOperationUndefined: Self = StObject.set(x, "visitOperation", js.undefined)
      
      inline def setVisitPath(value: /* context */ OpenAPIFrameworkPathContext => Callback): Self = StObject.set(x, "visitPath", js.Any.fromFunction1((t0: /* context */ OpenAPIFrameworkPathContext) => value(t0).runNow()))
