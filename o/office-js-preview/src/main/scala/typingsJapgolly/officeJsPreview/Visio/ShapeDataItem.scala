...
import typingsJapgolly.officeJsPreview.Visio.Interfaces.ShapeDataItemData
import typingsJapgolly.officeJsPreview.Visio.Interfaces.ShapeDataItemLoadOptions
