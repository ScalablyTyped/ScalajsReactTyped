...
import typingsJapgolly.officeJsPreview.Visio.Interfaces.HyperlinkCollectionData
import typingsJapgolly.officeJsPreview.Visio.Interfaces.HyperlinkCollectionLoadOptions
