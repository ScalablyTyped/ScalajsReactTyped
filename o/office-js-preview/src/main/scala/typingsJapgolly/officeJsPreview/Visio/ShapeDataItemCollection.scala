...
import typingsJapgolly.officeJsPreview.Visio.Interfaces.ShapeDataItemCollectionData
import typingsJapgolly.officeJsPreview.Visio.Interfaces.ShapeDataItemCollectionLoadOptions
