...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideLayoutCollectionData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideLayoutCollectionLoadOptions
