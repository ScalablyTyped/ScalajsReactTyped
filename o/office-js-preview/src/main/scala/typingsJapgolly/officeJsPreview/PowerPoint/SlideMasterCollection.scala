...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideMasterCollectionData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideMasterCollectionLoadOptions
