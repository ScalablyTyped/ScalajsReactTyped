...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.ShapeCollectionData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.ShapeCollectionLoadOptions
...
trait ShapeCollection
  ...
  def addGeometricShape(
    geometricShapeType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typingsJapgolly.officeJsPreview.officeJsPreviewStrings.LineInverse, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Triangle, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.RightTriangle */ Any
  ): Shape = js.native
  def addGeometricShape(
    geometricShapeType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typingsJapgolly.officeJsPreview.officeJsPreviewStrings.LineInverse, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Triangle, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.RightTriangle */ Any,
