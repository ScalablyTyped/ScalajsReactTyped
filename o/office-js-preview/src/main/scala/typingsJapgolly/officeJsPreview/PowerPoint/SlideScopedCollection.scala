...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideScopedCollectionData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideScopedCollectionLoadOptions
