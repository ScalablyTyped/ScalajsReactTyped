...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.PresentationData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.PresentationLoadOptions
