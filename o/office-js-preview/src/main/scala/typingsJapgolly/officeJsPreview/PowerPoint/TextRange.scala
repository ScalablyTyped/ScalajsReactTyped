...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.TextRangeData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.TextRangeLoadOptions
