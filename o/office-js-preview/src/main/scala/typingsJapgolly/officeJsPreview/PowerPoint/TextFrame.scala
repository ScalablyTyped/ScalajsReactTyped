...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.TextFrameData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.TextFrameLoadOptions
