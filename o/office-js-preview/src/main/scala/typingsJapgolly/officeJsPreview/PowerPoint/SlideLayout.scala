...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideLayoutData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideLayoutLoadOptions
