...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.ShapeFillData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.ShapeFillLoadOptions
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.SlideBackground
