...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.ParagraphFormatData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.ParagraphFormatLoadOptions
