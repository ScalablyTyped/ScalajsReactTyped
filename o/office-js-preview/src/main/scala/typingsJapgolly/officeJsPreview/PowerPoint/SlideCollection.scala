...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideCollectionData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideCollectionLoadOptions
