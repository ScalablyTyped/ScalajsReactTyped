...
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideMasterData
import typingsJapgolly.officeJsPreview.PowerPoint.Interfaces.SlideMasterLoadOptions
