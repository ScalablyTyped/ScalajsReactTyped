...
import typingsJapgolly.officeJsPreview.Word.Interfaces.DocumentPropertiesData
import typingsJapgolly.officeJsPreview.Word.Interfaces.DocumentPropertiesLoadOptions
import typingsJapgolly.officeJsPreview.Word.Interfaces.DocumentPropertiesUpdateData
