...
import typingsJapgolly.officeJsPreview.Word.Interfaces.TableCollectionData
import typingsJapgolly.officeJsPreview.Word.Interfaces.TableCollectionLoadOptions
