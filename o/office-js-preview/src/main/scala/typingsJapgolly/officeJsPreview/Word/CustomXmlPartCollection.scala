...
import typingsJapgolly.officeJsPreview.Word.Interfaces.CustomXmlPartCollectionData
import typingsJapgolly.officeJsPreview.Word.Interfaces.CustomXmlPartCollectionLoadOptions
