...
trait ListCollection
  ...
  /**
    ...
    */
  def getById(id: Double): typingsJapgolly.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * @param id Required. A list identifier.
    */
  def getByIdOrNullObject(id: Double): typingsJapgolly.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  def getFirst(): typingsJapgolly.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  def getFirstOrNullObject(): typingsJapgolly.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    */
  def getItem(id: Double): typingsJapgolly.officeJsPreview.Word.List = js.native
  
  /** Gets the loaded child items in this collection. */
  val items: js.Array[typingsJapgolly.officeJsPreview.Word.List] = js.native
