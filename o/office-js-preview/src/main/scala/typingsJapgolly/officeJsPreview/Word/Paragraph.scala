...
import typingsJapgolly.officeJsPreview.Word.InsertLocation.replace
import typingsJapgolly.officeJsPreview.Word.Interfaces.ParagraphData
import typingsJapgolly.officeJsPreview.Word.Interfaces.ParagraphLoadOptions
import typingsJapgolly.officeJsPreview.Word.Interfaces.ParagraphUpdateData
import typingsJapgolly.officeJsPreview.Word.RangeLocation.after
import typingsJapgolly.officeJsPreview.Word.RangeLocation.content
import typingsJapgolly.officeJsPreview.Word.RangeLocation.end
import typingsJapgolly.officeJsPreview.Word.RangeLocation.start
import typingsJapgolly.officeJsPreview.Word.RangeLocation.whole
import typingsJapgolly.officeJsPreview.anon.Expand
import typingsJapgolly.officeJsPreview.anon.IgnorePunct
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Content
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Current
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Next
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Original
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Page
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.SectionContinuous
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.SectionEven
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.SectionNext
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.SectionOdd
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Select
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Whole
...
trait Paragraph
  ...
  /**
    ...
    */
  def attachToList(listId: Double, level: Double): typingsJapgolly.officeJsPreview.Word.List = js.native
  ...
  def insertBreak(
    breakType: Page | Next | SectionNext | SectionContinuous | SectionEven | SectionOdd | Line,
    insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.after
  ): Unit = js.native
  def insertBreak(
    breakType: Page | Next | SectionNext | SectionContinuous | SectionEven | SectionOdd | Line,
  ...
  def insertBreak(breakType: BreakType, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.after): Unit = js.native
  /**
  ...
  def insertFileFromBase64(base64File: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.end): Range = js.native
  def insertFileFromBase64(
    base64File: String,
    insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.end,
  ...
  def insertFileFromBase64(base64File: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.start): Range = js.native
  def insertFileFromBase64(
    base64File: String,
    insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.start,
    asNewParagraph: Boolean
  ): Range = js.native
  
  def insertHtml(html: String, insertLocation: Replace | Start | End): Range = js.native
  def insertHtml(html: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.end): Range = js.native
  /**
  ...
  def insertHtml(html: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.start): Range = js.native
  
  def insertInlinePictureFromBase64(base64EncodedImage: String, insertLocation: Replace | Start | End): InlinePicture = js.native
  def insertInlinePictureFromBase64(
  ...
  def insertOoxml(ooxml: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.end): Range = js.native
  def insertOoxml(
    ooxml: String,
    insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.end,
    asNewParagraph: Boolean
  ...
  def insertOoxml(ooxml: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.start): Range = js.native
  def insertOoxml(
    ooxml: String,
    insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.start,
    asNewParagraph: Boolean
  ...
  def insertParagraph(paragraphText: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.after): Paragraph = js.native
  /**
  ...
  def insertText(text: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.end): Range = js.native
  /**
  ...
  def insertText(text: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.start): Range = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val list: typingsJapgolly.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val listOrNullObject: typingsJapgolly.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  def startNewList(): typingsJapgolly.officeJsPreview.Word.List = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  var styleBuiltIn: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 149, starting with typingsJapgolly.officeJsPreview.Word.Style, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Other, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Normal */ Any = js.native
