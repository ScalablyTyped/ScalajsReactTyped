...
import typingsJapgolly.officeJsPreview.Word.Interfaces.TableData
import typingsJapgolly.officeJsPreview.Word.Interfaces.TableLoadOptions
import typingsJapgolly.officeJsPreview.Word.Interfaces.TableUpdateData
...
trait Table
  ...
  def getRange(rangeLocation: typingsJapgolly.officeJsPreview.Word.RangeLocation.end): Range = js.native
  def getRange(rangeLocation: typingsJapgolly.officeJsPreview.Word.RangeLocation.start): Range = js.native
