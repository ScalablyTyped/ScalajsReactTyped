...
import typingsJapgolly.officeJsPreview.Word.Interfaces.CustomXmlPartData
import typingsJapgolly.officeJsPreview.Word.Interfaces.CustomXmlPartLoadOptions
