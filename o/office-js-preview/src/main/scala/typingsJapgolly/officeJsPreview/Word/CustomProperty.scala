...
import typingsJapgolly.officeJsPreview.Word.Interfaces.CustomPropertyData
import typingsJapgolly.officeJsPreview.Word.Interfaces.CustomPropertyLoadOptions
import typingsJapgolly.officeJsPreview.Word.Interfaces.CustomPropertyUpdateData
...
trait CustomProperty
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: DocumentPropertyType | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.String | Number | Date | Boolean = js.native
