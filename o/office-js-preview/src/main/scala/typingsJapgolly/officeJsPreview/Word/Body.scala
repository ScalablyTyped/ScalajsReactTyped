...
class Body () extends ClientObject {
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: BodyType | Unknown_ | MainDoc | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Section | Header | Footer | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.TableCell = js.native
  /**
    *
