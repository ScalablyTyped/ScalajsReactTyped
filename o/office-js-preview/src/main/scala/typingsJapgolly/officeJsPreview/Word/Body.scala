...
import typingsJapgolly.officeJsPreview.Word.Interfaces.BodyData
import typingsJapgolly.officeJsPreview.Word.Interfaces.BodyLoadOptions
import typingsJapgolly.officeJsPreview.Word.Interfaces.BodyUpdateData
...
trait Body
  ...
  def insertBreak(breakType: BreakType, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.end): Unit = js.native
  /**
    ...
    */
  def insertBreak(breakType: BreakType, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.start): Unit = js.native
  ...
  def insertParagraph(paragraphText: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.end): Paragraph = js.native
  /**
    ...
    * @param insertLocation Required. The value must be 'Start' or 'End'.
    */
  def insertParagraph(paragraphText: String, insertLocation: typingsJapgolly.officeJsPreview.Word.InsertLocation.start): Paragraph = js.native
  ...
  /**
    ...
    * [Api set: WordApi 1.3]
    */
  val `type`: BodyType | Unknown_ | MainDoc | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Section | Header | Footer | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.TableCell | Footnote | Endnote | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.NoteItem = js.native
