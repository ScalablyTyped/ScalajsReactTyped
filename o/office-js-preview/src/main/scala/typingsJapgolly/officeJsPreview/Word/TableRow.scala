...
import typingsJapgolly.officeJsPreview.Word.Interfaces.TableRowData
import typingsJapgolly.officeJsPreview.Word.Interfaces.TableRowLoadOptions
import typingsJapgolly.officeJsPreview.Word.Interfaces.TableRowUpdateData
