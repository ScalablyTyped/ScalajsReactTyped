...
import typingsJapgolly.officeJsPreview.Excel.IconCollections
import typingsJapgolly.officeJsPreview.Excel.RunOptions
import typingsJapgolly.officeJsPreview.OfficeExtension.ClientObject
import typingsJapgolly.officeJsPreview.OfficeExtension.ClientRequestContext
import typingsJapgolly.officeJsPreview.global.Excel.^
...
/**
  ...
  */
inline def run[T](
  batch: js.Function1[/* context */ typingsJapgolly.officeJsPreview.Excel.RequestContext, js.Promise[T]]
