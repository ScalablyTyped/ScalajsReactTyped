...
import typingsJapgolly.officeJsPreview.OfficeExtension.DebugInfo
import typingsJapgolly.officeJsPreview.OfficeExtension.EmbeddedOptions
import typingsJapgolly.officeJsPreview.OfficeExtension.EventInfo
...
object OfficeExtension {
  ...
  open class ClientObject ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.ClientObject {
    
    /** The request context associated with the object */
    /* CompleteClass */
    var context: typingsJapgolly.officeJsPreview.OfficeExtension.ClientRequestContext = js.native
  ...
  open class ClientRequestContext ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.ClientRequestContext {
  ...
  open class ClientResult[T] ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.ClientResult[T] {
  ...
  open class EmbeddedSession protected ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.EmbeddedSession {
    def this(url: String) = this()
  ...
  open class Error ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.Error {
    ...
    /* CompleteClass */
    var innerError: typingsJapgolly.officeJsPreview.OfficeExtension.Error = js.native
  ...
  open class ErrorCodes ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.ErrorCodes
  object ErrorCodes {
  ...
  open class EventHandlerResult[T] protected ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.EventHandlerResult[T] {
    def this(
      context: typingsJapgolly.officeJsPreview.OfficeExtension.ClientRequestContext,
      handlers: typingsJapgolly.officeJsPreview.OfficeExtension.EventHandlers[T],
  ...
  open class EventHandlers[T] protected ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.EventHandlers[T] {
    def this(
      context: typingsJapgolly.officeJsPreview.OfficeExtension.ClientRequestContext,
      parentObject: typingsJapgolly.officeJsPreview.OfficeExtension.ClientObject,
      name: String,
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def add(handler: js.Function1[T, js.Promise[Any]]): typingsJapgolly.officeJsPreview.OfficeExtension.EventHandlerResult[T] = js.native
  ...
  open class TrackedObjects ()
    extends StObject
       with typingsJapgolly.officeJsPreview.OfficeExtension.TrackedObjects
