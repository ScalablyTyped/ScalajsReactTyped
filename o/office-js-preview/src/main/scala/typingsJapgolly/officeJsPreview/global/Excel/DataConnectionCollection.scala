...
open class DataConnectionCollection ()
  extends StObject
     with typingsJapgolly.officeJsPreview.Excel.DataConnectionCollection {
  ...
  /* CompleteClass */
  @JSName("context")
  var context_DataConnectionCollection: typingsJapgolly.officeJsPreview.Excel.RequestContext = js.native
