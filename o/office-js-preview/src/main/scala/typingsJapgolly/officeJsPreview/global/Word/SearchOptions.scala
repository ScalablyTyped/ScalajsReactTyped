...
open class SearchOptions ()
  extends StObject
     with typingsJapgolly.officeJsPreview.Word.SearchOptions {
...
object SearchOptions {
  ...
  /**
    ...
    */
  /* static member */
  inline def newObject(context: ClientRequestContext): typingsJapgolly.officeJsPreview.Word.SearchOptions = ^.asInstanceOf[js.Dynamic].applyDynamic("newObject")(context.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.officeJsPreview.Word.SearchOptions]
}
