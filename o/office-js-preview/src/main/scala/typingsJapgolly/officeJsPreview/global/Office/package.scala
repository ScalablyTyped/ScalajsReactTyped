...
import typingsJapgolly.officeJsPreview.Office.Actions
import typingsJapgolly.officeJsPreview.Office.Addin
import typingsJapgolly.officeJsPreview.Office.AsyncResult
import typingsJapgolly.officeJsPreview.Office.Auth
import typingsJapgolly.officeJsPreview.Office.Binding
import typingsJapgolly.officeJsPreview.Office.Context
import typingsJapgolly.officeJsPreview.Office.IPromiseConstructor
import typingsJapgolly.officeJsPreview.Office.Ribbon
import typingsJapgolly.officeJsPreview.anon.Host
...
/**
  ...
  */
inline def initialize(reason: typingsJapgolly.officeJsPreview.Office.InitializationReason): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("initialize")(reason.asInstanceOf[js.Any]).asInstanceOf[Unit]
