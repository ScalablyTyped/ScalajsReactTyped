...
package object Office {
  /**
    ...
    */
  type Appointment = typingsJapgolly.officeJsPreview.Office.Item
  /**
    ...
    */
  type ItemCompose = typingsJapgolly.officeJsPreview.Office.Item
  /**
    ...
    */
  type ItemRead = typingsJapgolly.officeJsPreview.Office.Item
  /**
    ...
    * - {@link Office.MessageRead | MessageRead}
    */
  type Message = typingsJapgolly.officeJsPreview.Office.Item
  /**
  ...
  /**
    ...
    */
  type TextBinding = typingsJapgolly.officeJsPreview.Office.Binding
}
