...
trait RecurrenceTimeZone extends StObject {
  ...
  /**
    ...
    */
  var name: typingsJapgolly.officeJsPreview.Office.MailboxEnums.RecurrenceTimeZone | String
...
object RecurrenceTimeZone {
  ...
  inline def apply(name: typingsJapgolly.officeJsPreview.Office.MailboxEnums.RecurrenceTimeZone | String): RecurrenceTimeZone = {
  ...
  extension [Self <: RecurrenceTimeZone](x: Self) {
    ...
    inline def setName(value: typingsJapgolly.officeJsPreview.Office.MailboxEnums.RecurrenceTimeZone | String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
