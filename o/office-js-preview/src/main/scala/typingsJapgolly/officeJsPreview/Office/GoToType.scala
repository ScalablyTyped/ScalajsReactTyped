...
object GoToType extends js.Object {
  ...
  /* 0 */ @js.native
  object Binding
    extends TopLevel[typingsJapgolly.officeJsPreview.Office.GoToType.Binding with Double]
  
  /* 3 */ @js.native
  object Index
    extends TopLevel[typingsJapgolly.officeJsPreview.Office.GoToType.Index with Double]
