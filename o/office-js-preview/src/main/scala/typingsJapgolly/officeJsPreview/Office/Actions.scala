...
import typingsJapgolly.officeJsPreview.anon.InUse
...
object Actions {
  ...
  inline def apply(
    ...
    associate: (String, js.Function1[/* arg */ js.UndefOr[Any], Unit]) => Callback,
    getShortcuts: CallbackTo[js.Promise[StringDictionary[String | Null]]],
    replaceShortcuts: StringDictionary[String] => js.Promise[Unit]
  ): Actions = {
    val __obj = js.Dynamic.literal(areShortcutsInUse = js.Any.fromFunction1(areShortcutsInUse), associate = js.Any.fromFunction2((t0: String, t1: js.Function1[/* arg */ js.UndefOr[Any], Unit]) => (associate(t0, t1)).runNow()), getShortcuts = getShortcuts.toJsFn, replaceShortcuts = js.Any.fromFunction1(replaceShortcuts))
  ...
  extension [Self <: Actions](x: Self) {
    ...
    inline def setAssociate(value: (String, js.Function1[/* arg */ js.UndefOr[Any], Unit]) => Callback): Self = StObject.set(x, "associate", js.Any.fromFunction2((t0: String, t1: js.Function1[/* arg */ js.UndefOr[Any], Unit]) => (value(t0, t1)).runNow()))
    
    inline def setGetShortcuts(value: CallbackTo[js.Promise[StringDictionary[String | Null]]]): Self = StObject.set(x, "getShortcuts", value.toJsFn)
