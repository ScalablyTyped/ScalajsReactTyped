...
object Ribbon_ {
  @scala.inline
  def apply(requestUpdate: RibbonUpdaterData => CallbackTo[js.Promise[Unit]]): Ribbon_ = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("requestUpdate")(js.Any.fromFunction1((t0: typingsJapgolly.officeJsPreview.Office.RibbonUpdaterData) => requestUpdate(t0).runNow()))
