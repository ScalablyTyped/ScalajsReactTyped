...
object Addin {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(beforeDocumentCloseNotification = beforeDocumentCloseNotification.asInstanceOf[js.Any], getStartupBehavior = getStartupBehavior.toJsFn, hide = hide.toJsFn, onVisibilityModeChanged = js.Any.fromFunction1(onVisibilityModeChanged), setStartupBehavior = js.Any.fromFunction1(setStartupBehavior), showAsTaskpane = showAsTaskpane.toJsFn)
