...
import typingsJapgolly.officeJsPreview.Office.MailboxEnums.Days
import typingsJapgolly.officeJsPreview.Office.MailboxEnums.Month
import typingsJapgolly.officeJsPreview.Office.MailboxEnums.WeekNumber
