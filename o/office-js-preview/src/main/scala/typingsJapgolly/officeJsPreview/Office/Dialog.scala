...
object Dialog {
  ...
  def apply(
    ...
    __obj.updateDynamic("addEventHandler")(js.Any.fromFunction2((t0: typingsJapgolly.officeJsPreview.Office.EventType, t1: js.Function) => addEventHandler(t0, t1).runNow()))
