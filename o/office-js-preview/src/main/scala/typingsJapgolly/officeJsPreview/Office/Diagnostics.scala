...
import typingsJapgolly.officeJsPreview.Office.MailboxEnums.OWAView
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.OneColumn
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.ThreeColumns
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.TwoColumns
...
trait Diagnostics extends StObject {
  ...
  /**
    ...
    * **{@link https://learn.microsoft.com/office/dev/add-ins/outlook/outlook-add-ins-overview#extension-points | Applicable Outlook mode}**: Compose or Read
    */
  var OWAView: typingsJapgolly.officeJsPreview.Office.MailboxEnums.OWAView | OneColumn | TwoColumns | ThreeColumns
