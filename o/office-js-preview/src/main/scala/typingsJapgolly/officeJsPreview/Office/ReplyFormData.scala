...
object ReplyFormData {
  ...
  extension [Self <: ReplyFormData](x: Self) {
    ...
    inline def setCallback(value: /* asyncResult */ AsyncResult[Any] => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* asyncResult */ AsyncResult[Any]) => value(t0).runNow()))
