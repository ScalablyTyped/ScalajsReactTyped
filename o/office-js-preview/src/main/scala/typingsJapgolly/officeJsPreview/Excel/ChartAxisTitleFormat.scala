...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartAxisTitleFormatData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartAxisTitleFormatLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartAxisTitleFormatUpdateData
...
class ChartAxisTitleFormat () extends ClientObject {
  ...
  def load(propertyNamesAndPaths: AnonExpand): ChartAxisTitleFormat = js.native
