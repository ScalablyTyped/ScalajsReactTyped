...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.NamedItemData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.NamedItemLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.NamedItemUpdateData
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Integer
...
class NamedItem () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.4]
    */
  val scope: NamedItemScope | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Worksheet | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Workbook = js.native
  /**
    *
    ...
    */
  val `type`: NamedItemType | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.String | Integer | Double | Boolean | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Range | Error | Array = js.native
  /**
    *
