...
trait CardLayoutTableSection
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var layout: typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Table
}
object CardLayoutTableSection {
  ...
  extension [Self <: CardLayoutTableSection](x: Self) {
    ...
    inline def setLayout(value: typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Table): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
  }
}
