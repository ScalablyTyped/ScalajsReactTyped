...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.TextAsNumber
...
trait SortField extends js.Object {
  ...
  var sortOn: js.UndefOr[
    SortOn | Value | CellColor | FontColor | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Icon
  ] = js.undefined
  /**
    *
...
object SortField {
  ...
  def apply(
    ...
    icon: Icon = null,
    sortOn: SortOn | Value | CellColor | FontColor | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Icon = null,
