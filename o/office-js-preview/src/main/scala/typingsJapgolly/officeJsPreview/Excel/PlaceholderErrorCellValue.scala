...
import typingsJapgolly.officeJsPreview.Excel.ErrorCellValueType.placeholder
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Placeholder
...
object PlaceholderErrorCellValue {
  ...
  inline def apply(
    ...
    `type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.error | Error
