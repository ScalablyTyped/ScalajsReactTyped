...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.WorkbookProtectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.WorkbookProtectionLoadOptions
