...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.TextConditionalFormatData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.TextConditionalFormatLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.TextConditionalFormatUpdateData
