...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.SettingCollectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.SettingCollectionLoadOptions
