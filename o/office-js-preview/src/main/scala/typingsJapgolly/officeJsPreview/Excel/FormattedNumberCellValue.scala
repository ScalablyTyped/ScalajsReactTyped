...
import typingsJapgolly.officeJsPreview.Excel.CellValueType.formattedNumber
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.FormattedNumber
