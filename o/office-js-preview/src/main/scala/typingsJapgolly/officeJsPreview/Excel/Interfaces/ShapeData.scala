...
import typingsJapgolly.officeJsPreview.Excel.Placement
import typingsJapgolly.officeJsPreview.Excel.ShapeType
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Absolute
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.OneCell
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.TwoCell
...
trait ShapeData extends StObject {
  ...
  var geometricShapeType: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 179, starting with typingsJapgolly.officeJsPreview.Excel.GeometricShapeType, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.LineInverse, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Triangle */ Any
  ] = js.undefined
...
object ShapeData {
  ...
  extension [Self <: ShapeData](x: Self) {
    ...
    inline def setGeometricShapeType(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 179, starting with typingsJapgolly.officeJsPreview.Excel.GeometricShapeType, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.LineInverse, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Triangle */ Any
