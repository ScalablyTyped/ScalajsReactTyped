...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DatetimeFormatInfoData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DatetimeFormatInfoLoadOptions
