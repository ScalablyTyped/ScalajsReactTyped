...
import typingsJapgolly.officeJsPreview.Excel.ErrorCellValueType.busy
import typingsJapgolly.officeJsPreview.Excel.RangeValueType.error
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Busy
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.LoadingImage
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.NumbersignBUSYExclamationmark
...
object BusyErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.error | Error): BusyErrorCellValue = {
