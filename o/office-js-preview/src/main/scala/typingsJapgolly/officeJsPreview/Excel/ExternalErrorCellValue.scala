...
import typingsJapgolly.officeJsPreview.Excel.ErrorCellValueType.external
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.External
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.NumbersignEXTERNALExclamationmark
...
object ExternalErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.error | Error): ExternalErrorCellValue = {
