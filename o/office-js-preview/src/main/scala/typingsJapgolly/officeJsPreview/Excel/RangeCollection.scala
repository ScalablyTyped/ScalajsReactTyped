...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.RangeCollectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.RangeCollectionLoadOptions
