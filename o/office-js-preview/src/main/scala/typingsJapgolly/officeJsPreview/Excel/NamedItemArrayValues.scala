...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.NamedItemArrayValuesData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.NamedItemArrayValuesLoadOptions
