...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.GeometricShapeData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.GeometricShapeLoadOptions
