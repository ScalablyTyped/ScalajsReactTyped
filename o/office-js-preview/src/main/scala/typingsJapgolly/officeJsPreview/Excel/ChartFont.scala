...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartFontData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartFontLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartFontUpdateData
