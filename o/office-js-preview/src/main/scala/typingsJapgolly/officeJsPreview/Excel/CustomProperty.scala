...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CustomPropertyData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CustomPropertyLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CustomPropertyUpdateData
...
class CustomProperty () extends ClientObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.7]
    */
  val `type`: DocumentPropertyType | Number | Boolean | Date | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.String | Float = js.native
  /**
    *
