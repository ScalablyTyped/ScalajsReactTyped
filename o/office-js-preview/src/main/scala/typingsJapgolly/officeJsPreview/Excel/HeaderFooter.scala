...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.HeaderFooterData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.HeaderFooterLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.HeaderFooterUpdateData
