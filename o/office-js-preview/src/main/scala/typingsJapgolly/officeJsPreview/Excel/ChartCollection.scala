...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartCollectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartCollectionLoadOptions
...
trait ChartCollection
  ...
  /**
    ...
    */
  def add(
    `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 82, starting with typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Invalid, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.ColumnClustered, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.ColumnStacked */ Any,
    sourceData: Range
  ): Chart = js.native
  def add(
    `type`: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 82, starting with typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Invalid, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.ColumnClustered, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.ColumnStacked */ Any,
