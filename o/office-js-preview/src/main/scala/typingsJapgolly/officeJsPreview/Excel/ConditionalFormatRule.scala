...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ConditionalFormatRuleData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ConditionalFormatRuleLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ConditionalFormatRuleUpdateData
