...
import typingsJapgolly.officeJsPreview.Excel.ErrorCellValueType.ref
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.ExternalLinksCalculatedRef
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.ExternalLinksStructuredRef
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.NumbersignREFExclamationmark
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Ref
...
object RefErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.error | Error): RefErrorCellValue = {
