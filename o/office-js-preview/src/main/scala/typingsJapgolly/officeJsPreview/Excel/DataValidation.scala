...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DataValidationData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DataValidationLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DataValidationUpdateData
...
trait DataValidation
  ...
  /**
    ...
    * [Api set: ExcelApi 1.8]
    */
  val `type`: DataValidationType | None | WholeNumber | Decimal | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.List | Date | Time | TextLength | Custom | Inconsistent | MixedCriteria = js.native
