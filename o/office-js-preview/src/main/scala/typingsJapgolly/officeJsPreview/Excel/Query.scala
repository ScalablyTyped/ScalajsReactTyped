...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.QueryData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.QueryLoadOptions
...
trait Query
  ...
  /**
    ...
    * [Api set: ExcelApi 1.14]
    */
  val loadedTo: LoadToType | ConnectionOnly | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Table | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.PivotTable | PivotChart = js.native
