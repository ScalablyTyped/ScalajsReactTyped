...
/**
  ...
  * @beta
  */
trait DocumentTaskChangeCollectionLoadOptions extends StObject {
  ...
  /**
    * For EACH ITEM in the collection: Represents the action type of the task change record. Some examples of action types are `assign`, `undo`, and `setPriority`.
    *
    * @remarks
    * [Api set: ExcelApi BETA (PREVIEW ONLY)]
    * @beta
...
object DocumentTaskChangeCollectionLoadOptions {
  
  inline def apply(): DocumentTaskChangeCollectionLoadOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DocumentTaskChangeCollectionLoadOptions]
  }
  
  extension [Self <: DocumentTaskChangeCollectionLoadOptions](x: Self) {
