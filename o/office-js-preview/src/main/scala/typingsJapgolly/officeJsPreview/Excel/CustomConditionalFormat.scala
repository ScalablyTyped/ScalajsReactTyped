...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CustomConditionalFormatData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CustomConditionalFormatLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CustomConditionalFormatUpdateData
