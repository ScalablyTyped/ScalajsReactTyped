...
trait ConditionalFormatCollection
  ...
  /**
    ...
    */
  def add(
    `type`: Custom | DataBar | ColorScale | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.IconSet | TopBottom | PresetCriteria | ContainsText | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.CellValue
