...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ColorScaleConditionalFormatData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ColorScaleConditionalFormatLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ColorScaleConditionalFormatUpdateData
