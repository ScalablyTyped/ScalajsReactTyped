...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DocumentPropertiesData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DocumentPropertiesLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DocumentPropertiesUpdateData
