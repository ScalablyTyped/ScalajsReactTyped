...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartDataTableFormatData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartDataTableFormatLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartDataTableFormatUpdateData
