...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.QueryCollectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.QueryCollectionLoadOptions
