...
import typingsJapgolly.officeJsPreview.Excel.ErrorCellValueType.div0
import typingsJapgolly.officeJsPreview.Excel.RangeValueType.error
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Div0
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Error
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.NumbersignDIVSlash0Exclamationmark
...
object Div0ErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.error | Error): Div0ErrorCellValue = {
