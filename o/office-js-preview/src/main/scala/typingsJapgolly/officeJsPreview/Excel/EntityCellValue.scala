...
trait EntityCellValue
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var `type`: entity | typingsJapgolly.officeJsPreview.Excel.ReferenceValueType.entity | Entity
}
object EntityCellValue {
  
  inline def apply(`type`: entity | typingsJapgolly.officeJsPreview.Excel.ReferenceValueType.entity | Entity): EntityCellValue = {
  ...
  extension [Self <: EntityCellValue](x: Self) {
    ...
    inline def setType(value: entity | typingsJapgolly.officeJsPreview.Excel.ReferenceValueType.entity | Entity): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
