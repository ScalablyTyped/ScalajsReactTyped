...
trait ArrayCellValue
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var `type`: array | typingsJapgolly.officeJsPreview.Excel.ReferenceValueType.array | Array
}
object ArrayCellValue {
  ...
  extension [Self <: ArrayCellValue](x: Self) {
    ...
    inline def setType(value: array | typingsJapgolly.officeJsPreview.Excel.ReferenceValueType.array | Array): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
