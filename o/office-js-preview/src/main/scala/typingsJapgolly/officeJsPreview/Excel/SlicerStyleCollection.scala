...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.SlicerStyleCollectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.SlicerStyleCollectionLoadOptions
