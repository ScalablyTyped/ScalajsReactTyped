...
import typingsJapgolly.officeJsPreview.Excel.ErrorCellValueType.gettingData
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.GettingData
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.NumbersignGETTING_DATA
...
object GettingDataErrorCellValue {
  ...
  inline def apply(`type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.error | Error): GettingDataErrorCellValue = {
