...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.BindingCollectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.BindingCollectionLoadOptions
...
class BindingCollection () extends ClientObject {
  ...
  def addFromNamedItem_Range(
    name: String,
    bindingType: typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Range,
    id: String
  ): Binding = js.native
  @JSName("addFromNamedItem")
  def addFromNamedItem_Table(
    name: String,
    bindingType: typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Table,
    id: String
  ): Binding = js.native
  @JSName("addFromNamedItem")
  ...
  def addFromSelection_Range(bindingType: typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Range, id: String): Binding = js.native
  @JSName("addFromSelection")
  def addFromSelection_Table(bindingType: typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Table, id: String): Binding = js.native
  @JSName("addFromSelection")
