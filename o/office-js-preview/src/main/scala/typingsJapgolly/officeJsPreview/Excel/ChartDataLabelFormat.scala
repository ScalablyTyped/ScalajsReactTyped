...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartDataLabelFormatData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartDataLabelFormatLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.ChartDataLabelFormatUpdateData
