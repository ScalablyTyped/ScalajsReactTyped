...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CellValueConditionalFormatData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CellValueConditionalFormatLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.CellValueConditionalFormatUpdateData
