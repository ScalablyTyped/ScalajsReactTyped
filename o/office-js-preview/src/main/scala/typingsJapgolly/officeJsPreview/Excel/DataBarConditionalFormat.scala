...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DataBarConditionalFormatData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DataBarConditionalFormatLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.DataBarConditionalFormatUpdateData
