...
import typingsJapgolly.officeJsPreview.Excel.NamedItemScope
import typingsJapgolly.officeJsPreview.Excel.NamedItemType
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Workbook
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Worksheet
...
trait NamedItemData extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    NamedItemType | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.String | Integer | Double | Boolean | Range | Error | Array
  ] = js.undefined
  /**
    *
...
object NamedItemData {
  ...
  def apply(
    ...
    `type`: NamedItemType | typingsJapgolly.officeJsPreview.officeJsPreviewStrings.String | Integer | Double | Boolean | Range | Error | Array = null,
    value: js.Any = null,
