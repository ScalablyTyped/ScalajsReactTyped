...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.WorksheetProtectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.WorksheetProtectionLoadOptions
