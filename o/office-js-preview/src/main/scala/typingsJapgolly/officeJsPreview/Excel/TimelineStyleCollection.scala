...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.TimelineStyleCollectionData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.TimelineStyleCollectionLoadOptions
