...
import typingsJapgolly.officeJsPreview.Excel.RangeValueType.boolean
...
trait BooleanCellValue extends StObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var `type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.boolean | Boolean
}
object BooleanCellValue {
  
  inline def apply(
    basicValue: scala.Boolean,
    `type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.boolean | Boolean
  ): BooleanCellValue = {
  ...
  extension [Self <: BooleanCellValue](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.officeJsPreview.Excel.CellValueType.boolean | Boolean): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
