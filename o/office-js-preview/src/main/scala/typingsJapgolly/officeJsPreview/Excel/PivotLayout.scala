...
class PivotLayout () extends ClientObject {
  ...
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Filter, cell: String): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
  def getPivotItems_Filter(axis: typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Filter, cell: Range): ClientResult[js.Array[PivotItem]] = js.native
  @JSName("getPivotItems")
