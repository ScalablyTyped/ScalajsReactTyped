...
object ChartTrendlineLabelData {
  ...
  inline def apply(): ChartTrendlineLabelData = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ChartTrendlineLabelData]
  }
  
  extension [Self <: ChartTrendlineLabelData](x: Self) {
    ...
    inline def setFormat(value: ChartTrendlineLabelFormatData): Self = StObject.set(x, "format", value.asInstanceOf[js.Any])
