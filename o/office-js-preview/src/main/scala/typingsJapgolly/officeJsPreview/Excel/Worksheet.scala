...
import typingsJapgolly.officeJsPreview.Excel.Interfaces.WorksheetData
import typingsJapgolly.officeJsPreview.Excel.Interfaces.WorksheetLoadOptions
import typingsJapgolly.officeJsPreview.Excel.Interfaces.WorksheetUpdateData
...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Beginning
...
trait Worksheet
  ...
  /**
    ...
    * @beta
    */
  val tasks: DocumentTaskCollection = js.native
