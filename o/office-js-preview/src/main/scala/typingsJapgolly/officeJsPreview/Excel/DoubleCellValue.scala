...
import typingsJapgolly.officeJsPreview.Excel.RangeValueType.double
...
trait DoubleCellValue extends StObject {
  ...
  /**
    ...
    * [Api set: ExcelApi 1.16]
    */
  var `type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.double | Double
}
object DoubleCellValue {
  
  inline def apply(
    basicValue: scala.Double,
    `type`: typingsJapgolly.officeJsPreview.Excel.CellValueType.double | Double
  ): DoubleCellValue = {
  ...
  extension [Self <: DoubleCellValue](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.officeJsPreview.Excel.CellValueType.double | Double): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
