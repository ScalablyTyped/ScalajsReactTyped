...
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.PageData
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.PageLoadOptions
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.PageUpdateData
