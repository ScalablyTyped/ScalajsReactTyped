...
import typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Bullet
...
trait ParagraphInfo extends StObject {
  ...
  /**
    ...
    * [Api set: OneNoteApi 1.1]
    */
  var numberType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 63, starting with typingsJapgolly.officeJsPreview.OneNote.NumberType, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.None, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Arabic */ Any
}
object ParagraphInfo {
  ...
  inline def apply(
    ...
    numberType: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 63, starting with typingsJapgolly.officeJsPreview.OneNote.NumberType, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.None, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Arabic */ Any
  ): ParagraphInfo = {
  ...
  extension [Self <: ParagraphInfo](x: Self) {
    ...
    inline def setNumberType(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 63, starting with typingsJapgolly.officeJsPreview.OneNote.NumberType, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.None, typingsJapgolly.officeJsPreview.officeJsPreviewStrings.Arabic */ Any
