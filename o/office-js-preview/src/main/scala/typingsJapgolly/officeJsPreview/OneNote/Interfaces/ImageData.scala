...
import typingsJapgolly.officeJsPreview.OneNote.ImageOcrData
...
object ImageData {
  ...
  extension [Self <: ImageData](x: Self) {
    ...
    inline def setOcrData(value: ImageOcrData): Self = StObject.set(x, "ocrData", value.asInstanceOf[js.Any])
