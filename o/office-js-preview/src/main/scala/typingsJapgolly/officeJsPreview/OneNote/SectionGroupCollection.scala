...
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.SectionGroupCollectionData
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.SectionGroupCollectionLoadOptions
