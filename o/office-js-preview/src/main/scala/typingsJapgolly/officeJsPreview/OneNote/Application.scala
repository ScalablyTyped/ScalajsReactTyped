...
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.ApplicationData
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.ApplicationLoadOptions
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.ApplicationUpdateData
