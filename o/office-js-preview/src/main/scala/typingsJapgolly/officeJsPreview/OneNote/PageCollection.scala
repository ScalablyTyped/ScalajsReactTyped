...
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.PageCollectionData
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.PageCollectionLoadOptions
