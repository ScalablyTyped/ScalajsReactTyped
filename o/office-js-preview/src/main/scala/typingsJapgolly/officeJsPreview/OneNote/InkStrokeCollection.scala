...
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.InkStrokeCollectionData
import typingsJapgolly.officeJsPreview.OneNote.Interfaces.InkStrokeCollectionLoadOptions
