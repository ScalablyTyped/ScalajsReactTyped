...
object distComponentsVideoFrameMod {
  ...
  object Props {
    ...
    inline def apply(
      ...
      setScanComplete: Boolean => Callback,
      warningMessage: String
    ): Props = {
      val __obj = js.Dynamic.literal(instructionMessage = instructionMessage.asInstanceOf[js.Any], ready = ready.asInstanceOf[js.Any], scanComplete = scanComplete.asInstanceOf[js.Any], setScanComplete = js.Any.fromFunction1((t0: Boolean) => setScanComplete(t0).runNow()), warningMessage = warningMessage.asInstanceOf[js.Any])
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setSetScanComplete(value: Boolean => Callback): Self = StObject.set(x, "setScanComplete", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
