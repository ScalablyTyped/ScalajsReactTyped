...
import typingsJapgolly.odata.distTypesOdataConfigMod.OdataBatchConfig
import typingsJapgolly.odata.distTypesOdataQueryMod.OdataQuery
import typingsJapgolly.odata.distTypesOhandlerMod.OHandler
...
object anon {
  ...
  /* Inlined std.Partial<odata.odata/dist/types/OdataConfig.OdataConfig> */
