...
object buildSrcBaggageTypesMod {
  ...
  object Baggage {
    ...
    inline def apply(
      clear: CallbackTo[Baggage],
      getAllEntries: CallbackTo[js.Array[js.Tuple2[String, BaggageEntry]]],
      ...
      val __obj = js.Dynamic.literal(clear = clear.toJsFn, getAllEntries = getAllEntries.toJsFn, getEntry = js.Any.fromFunction1(getEntry), removeEntries = js.Any.fromFunction1(removeEntries), removeEntry = js.Any.fromFunction1(removeEntry), setEntry = js.Any.fromFunction2(setEntry))
      __obj.asInstanceOf[Baggage]
    }
    
    extension [Self <: Baggage](x: Self) {
      
      inline def setClear(value: CallbackTo[Baggage]): Self = StObject.set(x, "clear", value.toJsFn)
      
      inline def setGetAllEntries(value: CallbackTo[js.Array[js.Tuple2[String, BaggageEntry]]]): Self = StObject.set(x, "getAllEntries", value.toJsFn)
