...
import typingsJapgolly.observableWebworkers.anon.Workerportanyundefined
...
object mod {
  ...
  object default {
    ...
    inline def dispatchEvent(`type`: String, worker: Worker, event: MessageEvent): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("dispatchEvent")(`type`.asInstanceOf[js.Any], worker.asInstanceOf[js.Any], event.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  type WebworkerEventListener[T] = js.Function2[/* worker */ Worker, /* event */ MessageEvent, Unit]
}
