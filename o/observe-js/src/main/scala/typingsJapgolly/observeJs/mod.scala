...
import typingsJapgolly.observeJs.mod.observejs.CompoundObserverInstance
import typingsJapgolly.observeJs.mod.observejs.CompoundObserverStatic
...
import typingsJapgolly.observeJs.mod.observejs.Observable
import typingsJapgolly.observeJs.mod.observejs.ObserverTransformInstance
import typingsJapgolly.observeJs.mod.observejs.ObserverTransformStatic
import typingsJapgolly.observeJs.mod.observejs.Path
import typingsJapgolly.observeJs.mod.observejs.PathObserverInstance
import typingsJapgolly.observeJs.mod.observejs.PathObserverStatic
...
object mod {
  ...
  @js.native
  def Path: typingsJapgolly.observeJs.mod.observejs.Path = js.native
