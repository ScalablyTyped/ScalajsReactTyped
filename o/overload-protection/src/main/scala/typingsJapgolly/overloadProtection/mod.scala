package typingsJapgolly.overloadProtection

import japgolly.scalajs.react.Callback
import typingsJapgolly.overloadProtection.overloadProtectionBooleans.`false`
import typingsJapgolly.overloadProtection.overloadProtectionStrings.koa
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.overloadProtection.overloadProtectionStrings.express
    - typingsJapgolly.overloadProtection.overloadProtectionStrings.http
    - typingsJapgolly.overloadProtection.overloadProtectionStrings.restify
  */
  trait HttpFrameworkSelection extends StObject
  object HttpFrameworkSelection {
    
    inline def express: typingsJapgolly.overloadProtection.overloadProtectionStrings.express = "express".asInstanceOf[typingsJapgolly.overloadProtection.overloadProtectionStrings.express]
    
    inline def http: typingsJapgolly.overloadProtection.overloadProtectionStrings.http = "http".asInstanceOf[typingsJapgolly.overloadProtection.overloadProtectionStrings.http]
    
    inline def restify: typingsJapgolly.overloadProtection.overloadProtectionStrings.restify = "restify".asInstanceOf[typingsJapgolly.overloadProtection.overloadProtectionStrings.restify]
  }
  ...
  object ProtectionConfig {
    ...
    extension [Self <: ProtectionConfig](x: Self) {
      ...
      inline def setLoggingFunction1(value: /* msg */ String => Callback): Self = StObject.set(x, "logging", js.Any.fromFunction1((t0: /* msg */ String) => value(t0).runNow()))
