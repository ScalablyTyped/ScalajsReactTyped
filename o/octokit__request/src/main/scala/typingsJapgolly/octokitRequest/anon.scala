...
import typingsJapgolly.octokitRequest.octokitRequestStrings.error
import typingsJapgolly.octokitRequest.octokitRequestStrings.follow
import typingsJapgolly.octokitRequest.octokitRequestStrings.manual
