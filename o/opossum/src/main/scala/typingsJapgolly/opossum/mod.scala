...
import typingsJapgolly.opossum.opossumBooleans.`false`
import typingsJapgolly.opossum.opossumStrings.cacheHit
import typingsJapgolly.opossum.opossumStrings.cacheMiss
import typingsJapgolly.opossum.opossumStrings.close
import typingsJapgolly.opossum.opossumStrings.failure
import typingsJapgolly.opossum.opossumStrings.fallback
import typingsJapgolly.opossum.opossumStrings.fire
import typingsJapgolly.opossum.opossumStrings.healthCheckFailed
import typingsJapgolly.opossum.opossumStrings.open
import typingsJapgolly.opossum.opossumStrings.reject
import typingsJapgolly.opossum.opossumStrings.semaphoreLocked
import typingsJapgolly.opossum.opossumStrings.shutdown
import typingsJapgolly.opossum.opossumStrings.snapshot
import typingsJapgolly.opossum.opossumStrings.success
import typingsJapgolly.opossum.opossumStrings.timeout
...
object mod {
  ...
  trait CircuitBreaker[TI /* <: js.Array[Any] */, TR] extends EventEmitter {
    ...
    @JSName("on")
    def on_halfOpen(
      event: typingsJapgolly.opossum.opossumStrings.halfOpen,
