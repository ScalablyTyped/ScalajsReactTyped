...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.`help-wanted-issues`
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.forks
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.stars
