...
trait `200Content240422` extends StObject {
...
object `200Content240422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content240422`]
  }
  
  extension [Self <: `200Content240422`](x: Self) {
    
    inline def set200(value: Content240): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
