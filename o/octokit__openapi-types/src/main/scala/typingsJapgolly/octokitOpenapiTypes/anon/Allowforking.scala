...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.BLANK
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.COMMIT_MESSAGES
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.COMMIT_OR_PR_TITLE
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.MERGE_MESSAGE
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.PR_BODY
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.PR_TITLE
...
trait Allowforking extends StObject {
  ...
  var template_repository: js.UndefOr[Allowautomerge | Null] = js.undefined
...
object Allowforking {
  ...
  extension [Self <: Allowforking](x: Self) {
    ...
    inline def setTemplate_repository(value: Allowautomerge): Self = StObject.set(x, "template_repository", value.asInstanceOf[js.Any])
