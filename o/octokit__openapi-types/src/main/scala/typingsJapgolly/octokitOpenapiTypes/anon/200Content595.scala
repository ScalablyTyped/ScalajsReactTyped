...
trait `200Content595` extends StObject {
...
object `200Content595` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content595`]
  }
  
  extension [Self <: `200Content595`](x: Self) {
    
    inline def set200(value: Content595): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
