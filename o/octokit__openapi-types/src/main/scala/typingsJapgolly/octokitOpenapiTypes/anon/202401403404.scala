...
trait `202401403404` extends StObject {
...
object `202401403404` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`202401403404`]
  }
  
  extension [Self <: `202401403404`](x: Self) {
    
    inline def set202(value: Content623): Self = StObject.set(x, "202", value.asInstanceOf[js.Any])
