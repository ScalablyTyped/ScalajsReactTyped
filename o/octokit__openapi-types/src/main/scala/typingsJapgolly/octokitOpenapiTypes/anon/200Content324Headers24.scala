...
trait `200Content324Headers24` extends StObject {
  
  /** Response */
  var `200`: Content324Headers24
...
object `200Content324Headers24` {
  
  inline def apply(
    `200`: Content324Headers24,
  ...
  ): `200Content324Headers24` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content324Headers24`]
  }
  
  extension [Self <: `200Content324Headers24`](x: Self) {
    
    inline def set200(value: Content324Headers24): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
