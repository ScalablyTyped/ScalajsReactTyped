...
trait `201Content339` extends StObject {
...
object `201Content339` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content339`]
  }
  
  extension [Self <: `201Content339`](x: Self) {
    
    inline def set201(value: Content339): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
