...
trait Restrictedtoworkflows extends StObject {
...
object Restrictedtoworkflows {
  
  inline def apply(name: String): Restrictedtoworkflows = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[Restrictedtoworkflows]
  }
  
  extension [Self <: Restrictedtoworkflows](x: Self) {
