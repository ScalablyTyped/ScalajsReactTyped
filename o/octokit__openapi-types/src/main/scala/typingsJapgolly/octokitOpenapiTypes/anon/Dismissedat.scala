...
object Dismissedat {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(created_at = created_at.asInstanceOf[js.Any], html_url = html_url.asInstanceOf[js.Any], instances_url = instances_url.asInstanceOf[js.Any], most_recent_instance = most_recent_instance.asInstanceOf[js.Any], number = number.asInstanceOf[js.Any], repository = repository.asInstanceOf[js.Any], rule = rule.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any], tool = tool.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], dismissed_at = null, dismissed_by = null, dismissed_reason = null)
  ...
  extension [Self <: Dismissedat](x: Self) {
    ...
    inline def setRule(value: Fulldescription): Self = StObject.set(x, "rule", value.asInstanceOf[js.Any])
