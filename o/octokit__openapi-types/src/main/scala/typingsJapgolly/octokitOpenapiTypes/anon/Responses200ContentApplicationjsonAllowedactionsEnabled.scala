...
object Responses200ContentApplicationjsonAllowedactionsEnabled {
  ...
  inline def apply(parameters: `76`, responses: `200ContentApplicationjsonAllowedactionsEnabled`): Responses200ContentApplicationjsonAllowedactionsEnabled = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200ContentApplicationjsonAllowedactionsEnabled]
  }
  
  extension [Self <: Responses200ContentApplicationjsonAllowedactionsEnabled](x: Self) {
