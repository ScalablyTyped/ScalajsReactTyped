...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.disabled
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.enabled
