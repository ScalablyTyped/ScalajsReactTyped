...
trait `200Content387304` extends StObject {
...
object `200Content387304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content387304`]
  }
  
  extension [Self <: `200Content387304`](x: Self) {
    
    inline def set200(value: Content387): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
