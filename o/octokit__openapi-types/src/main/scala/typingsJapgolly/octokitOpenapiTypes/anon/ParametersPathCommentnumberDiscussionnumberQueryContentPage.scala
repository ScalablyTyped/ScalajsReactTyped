...
object ParametersPathCommentnumberDiscussionnumberQueryContentPage {
  ...
  inline def apply(parameters: PathCommentnumberDiscussionnumberQueryContentPage, responses: `200Content61`): ParametersPathCommentnumberDiscussionnumberQueryContentPage = {
