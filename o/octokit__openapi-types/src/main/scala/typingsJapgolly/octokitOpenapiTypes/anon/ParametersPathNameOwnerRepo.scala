...
trait ParametersPathNameOwnerRepo extends StObject {
  ...
  var responses: `200157`
}
object ParametersPathNameOwnerRepo {
  
  inline def apply(parameters: PathNameOwnerRepo, responses: `200157`): ParametersPathNameOwnerRepo = {
  ...
  extension [Self <: ParametersPathNameOwnerRepo](x: Self) {
    ...
    inline def setResponses(value: `200157`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
