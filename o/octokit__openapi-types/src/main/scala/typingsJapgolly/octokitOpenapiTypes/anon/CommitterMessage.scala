...
trait CommitterMessage extends StObject {
...
object CommitterMessage {
  
  inline def apply(message: String, tree: String): CommitterMessage = {
    val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], tree = tree.asInstanceOf[js.Any])
    __obj.asInstanceOf[CommitterMessage]
  }
  
  extension [Self <: CommitterMessage](x: Self) {
