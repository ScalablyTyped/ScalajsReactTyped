...
object Responses200ContentApplicationjsonEnvironmentsTotalcount {
  ...
  inline def apply(parameters: PathOwnerRepo, responses: `200ContentApplicationjsonEnvironmentsTotalcount`): Responses200ContentApplicationjsonEnvironmentsTotalcount = {
