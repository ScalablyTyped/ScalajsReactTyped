...
trait PartialidnumbernodeidstriId extends StObject {
...
object PartialidnumbernodeidstriId {
  
  inline def apply(): PartialidnumbernodeidstriId = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialidnumbernodeidstriId]
  }
  
  extension [Self <: PartialidnumbernodeidstriId](x: Self) {
