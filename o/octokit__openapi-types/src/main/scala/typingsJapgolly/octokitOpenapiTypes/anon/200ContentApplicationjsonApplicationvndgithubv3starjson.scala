...
trait `200ContentApplicationjsonApplicationvndgithubv3starjson` extends StObject {
  
  /** Response */
  var `200`: ContentApplicationjsonApplicationvndgithubv3starjson
...
object `200ContentApplicationjsonApplicationvndgithubv3starjson` {
  
  inline def apply(
    `200`: ContentApplicationjsonApplicationvndgithubv3starjson,
  ...
  ): `200ContentApplicationjsonApplicationvndgithubv3starjson` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjsonApplicationvndgithubv3starjson`]
  }
  
  extension [Self <: `200ContentApplicationjsonApplicationvndgithubv3starjson`](x: Self) {
    
    inline def set200(value: ContentApplicationjsonApplicationvndgithubv3starjson): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
