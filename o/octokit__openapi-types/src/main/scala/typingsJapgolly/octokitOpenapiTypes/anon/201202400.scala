...
object `201202400` {
  ...
  extension [Self <: `201202400`](x: Self) {
    
    inline def set201(value: Content343): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
    
    inline def set202(value: Content343): Self = StObject.set(x, "202", value.asInstanceOf[js.Any])
