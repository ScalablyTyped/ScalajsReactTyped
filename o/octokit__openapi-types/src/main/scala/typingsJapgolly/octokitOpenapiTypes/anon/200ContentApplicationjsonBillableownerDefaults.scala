...
trait `200ContentApplicationjsonBillableownerDefaults` extends StObject {
  
  /** Response when a user is able to create codespaces from the repository. */
  var `200`: ContentApplicationjsonBillableownerDefaults
...
object `200ContentApplicationjsonBillableownerDefaults` {
  
  inline def apply(
    `200`: ContentApplicationjsonBillableownerDefaults,
  ...
  ): `200ContentApplicationjsonBillableownerDefaults` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjsonBillableownerDefaults`]
  }
  
  extension [Self <: `200ContentApplicationjsonBillableownerDefaults`](x: Self) {
    
    inline def set200(value: ContentApplicationjsonBillableownerDefaults): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
