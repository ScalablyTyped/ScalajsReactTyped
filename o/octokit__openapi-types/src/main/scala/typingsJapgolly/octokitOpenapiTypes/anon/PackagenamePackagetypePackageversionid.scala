...
trait PackagenamePackagetypePackageversionid extends StObject {
...
object PackagenamePackagetypePackageversionid {
  ...
  inline def apply(
    ...
    username: String
  ): PackagenamePackagetypePackageversionid = {
    ...
    __obj.asInstanceOf[PackagenamePackagetypePackageversionid]
  }
  
  extension [Self <: PackagenamePackagetypePackageversionid](x: Self) {
