...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.opt_in
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.opt_out
