...
object Responses200ContentApplicationjsonInstallationsTotalcount304 {
  ...
  inline def apply(parameters: `267`, responses: `200ContentApplicationjsonInstallationsTotalcount304`): Responses200ContentApplicationjsonInstallationsTotalcount304 = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200ContentApplicationjsonInstallationsTotalcount304]
  }
  
  extension [Self <: Responses200ContentApplicationjsonInstallationsTotalcount304](x: Self) {
