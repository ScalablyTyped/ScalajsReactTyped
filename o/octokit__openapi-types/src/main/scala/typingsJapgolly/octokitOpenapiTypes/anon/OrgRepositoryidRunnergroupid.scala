...
trait OrgRepositoryidRunnergroupid extends StObject {
...
object OrgRepositoryidRunnergroupid {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OrgRepositoryidRunnergroupid]
  }
  
  extension [Self <: OrgRepositoryidRunnergroupid](x: Self) {
