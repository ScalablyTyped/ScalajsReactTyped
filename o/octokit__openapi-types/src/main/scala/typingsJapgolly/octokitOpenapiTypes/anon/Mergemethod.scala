...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.merge
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.rebase
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.squash
