...
object Responses200ContentApplicationjsonAuthorscount {
  ...
  inline def apply(parameters: `76`, responses: `200ContentApplicationjsonAuthorscount`): Responses200ContentApplicationjsonAuthorscount = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200ContentApplicationjsonAuthorscount]
  }
  
  extension [Self <: Responses200ContentApplicationjsonAuthorscount](x: Self) {
