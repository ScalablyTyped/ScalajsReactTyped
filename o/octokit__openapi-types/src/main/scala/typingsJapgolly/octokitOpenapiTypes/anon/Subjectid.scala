...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.issue
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.organization
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.pull_request
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.repository
