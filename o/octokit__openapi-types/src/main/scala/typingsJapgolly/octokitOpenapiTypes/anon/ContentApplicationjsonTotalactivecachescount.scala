...
object ContentApplicationjsonTotalactivecachescount {
  ...
  inline def apply(content: ApplicationjsonTotalactivecachescount): ContentApplicationjsonTotalactivecachescount = {
    val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any])
    __obj.asInstanceOf[ContentApplicationjsonTotalactivecachescount]
  }
  
  extension [Self <: ContentApplicationjsonTotalactivecachescount](x: Self) {
