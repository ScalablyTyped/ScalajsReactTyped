...
trait `403ContentApplicationjsonDocumentationurlMessage404` extends StObject {
...
object `403ContentApplicationjsonDocumentationurlMessage404` {
  ...
  ): `403ContentApplicationjsonDocumentationurlMessage404` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`403ContentApplicationjsonDocumentationurlMessage404`]
  }
  
  extension [Self <: `403ContentApplicationjsonDocumentationurlMessage404`](x: Self) {
