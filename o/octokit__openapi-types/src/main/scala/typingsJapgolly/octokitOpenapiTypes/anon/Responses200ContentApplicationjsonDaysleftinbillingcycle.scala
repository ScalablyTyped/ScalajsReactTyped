...
object Responses200ContentApplicationjsonDaysleftinbillingcycle {
  ...
  inline def apply(parameters: `37`, responses: `200ContentApplicationjsonDaysleftinbillingcycle`): Responses200ContentApplicationjsonDaysleftinbillingcycle = {
    val __obj = js.Dynamic.literal(parameters = parameters.asInstanceOf[js.Any], responses = responses.asInstanceOf[js.Any])
    __obj.asInstanceOf[Responses200ContentApplicationjsonDaysleftinbillingcycle]
  }
  
  extension [Self <: Responses200ContentApplicationjsonDaysleftinbillingcycle](x: Self) {
