...
trait `202ContentApplicationjsonMessageUrl` extends StObject {
...
object `202ContentApplicationjsonMessageUrl` {
  
  inline def apply(
    `202`: ContentApplicationjsonMessageUrl,
  ...
  ): `202ContentApplicationjsonMessageUrl` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("202")(`202`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`202ContentApplicationjsonMessageUrl`]
  }
  
  extension [Self <: `202ContentApplicationjsonMessageUrl`](x: Self) {
