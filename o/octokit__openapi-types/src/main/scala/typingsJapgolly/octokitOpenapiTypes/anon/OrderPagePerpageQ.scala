...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.`author-date`
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.`committer-date`
...
object OrderPagePerpageQ {
  ...
  extension [Self <: OrderPagePerpageQ](x: Self) {
