...
trait ParametersPathRepoStatusid extends StObject {
  ...
  var responses: `200491`
}
object ParametersPathRepoStatusid {
  
  inline def apply(parameters: PathRepoStatusid, responses: `200491`): ParametersPathRepoStatusid = {
  ...
  extension [Self <: ParametersPathRepoStatusid](x: Self) {
    ...
    inline def setResponses(value: `200491`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
