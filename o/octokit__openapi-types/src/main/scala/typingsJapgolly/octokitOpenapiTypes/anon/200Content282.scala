...
trait `200Content282` extends StObject {
...
object `200Content282` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content282`]
  }
  
  extension [Self <: `200Content282`](x: Self) {
    
    inline def set200(value: Content282): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
