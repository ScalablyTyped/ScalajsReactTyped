...
trait `200ContentApplicationjsonRepositoriesArrayRepositoryselection` extends StObject {
  
  /** The access the user has to each repository is included in the hash under the `permissions` key. */
  var `200`: ContentApplicationjsonRepositoriesArrayRepositoryselection
...
object `200ContentApplicationjsonRepositoriesArrayRepositoryselection` {
  
  inline def apply(
    `200`: ContentApplicationjsonRepositoriesArrayRepositoryselection,
  ...
  ): `200ContentApplicationjsonRepositoriesArrayRepositoryselection` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.updateDynamic("404")(`404`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjsonRepositoriesArrayRepositoryselection`]
  }
  
  extension [Self <: `200ContentApplicationjsonRepositoriesArrayRepositoryselection`](x: Self) {
    
    inline def set200(value: ContentApplicationjsonRepositoriesArrayRepositoryselection): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
