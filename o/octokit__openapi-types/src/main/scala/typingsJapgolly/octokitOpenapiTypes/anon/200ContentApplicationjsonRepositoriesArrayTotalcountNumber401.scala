...
trait `200ContentApplicationjsonRepositoriesArrayTotalcountNumber401` extends StObject {
...
object `200ContentApplicationjsonRepositoriesArrayTotalcountNumber401` {
  ...
  inline def apply(
  ...
  ): `200ContentApplicationjsonRepositoriesArrayTotalcountNumber401` = {
    ...
    __obj.asInstanceOf[`200ContentApplicationjsonRepositoriesArrayTotalcountNumber401`]
  }
  
  extension [Self <: `200ContentApplicationjsonRepositoriesArrayTotalcountNumber401`](x: Self) {
