...
trait ParametersPathHookidOrg extends StObject {
  ...
  var responses: `200334`
}
object ParametersPathHookidOrg {
  
  inline def apply(parameters: PathHookidOrg, responses: `200334`): ParametersPathHookidOrg = {
  ...
  extension [Self <: ParametersPathHookidOrg](x: Self) {
    ...
    inline def setResponses(value: `200334`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
