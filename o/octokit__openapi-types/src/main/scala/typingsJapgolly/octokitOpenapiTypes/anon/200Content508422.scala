...
trait `200Content508422` extends StObject {
...
object `200Content508422` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content508422`]
  }
  
  extension [Self <: `200Content508422`](x: Self) {
    
    inline def set200(value: Content508): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
