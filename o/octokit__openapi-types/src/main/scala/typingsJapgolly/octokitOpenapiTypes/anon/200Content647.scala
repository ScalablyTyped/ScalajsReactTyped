...
trait `200Content647` extends StObject {
...
object `200Content647` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content647`]
  }
  
  extension [Self <: `200Content647`](x: Self) {
    
    inline def set200(value: Content647): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
