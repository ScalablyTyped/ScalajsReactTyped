...
trait Accountid extends StObject {
  ...
  var per: typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings._empty | day | week
...
object Accountid {
  ...
  inline def apply(
    ...
    per: typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings._empty | day | week,
    `per-page`: Double,
    `plan-id`: Double,
    `project-id`: Double,
    `pull-number`: Double,
