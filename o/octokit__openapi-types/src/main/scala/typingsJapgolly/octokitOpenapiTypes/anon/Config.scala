...
object Config {
  ...
  extension [Self <: Config](x: Self) {
    ...
    inline def setLast_response(value: CodeMessage): Self = StObject.set(x, "last_response", value.asInstanceOf[js.Any])
