...
trait `200Content324Headers304` extends StObject {
...
object `200Content324Headers304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content324Headers304`]
  }
  
  extension [Self <: `200Content324Headers304`](x: Self) {
