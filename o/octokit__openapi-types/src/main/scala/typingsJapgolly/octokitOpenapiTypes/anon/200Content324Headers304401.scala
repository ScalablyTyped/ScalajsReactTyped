...
trait `200Content324Headers304401` extends StObject {
...
object `200Content324Headers304401` {
  
  inline def apply(
    `200`: Content324Headers,
  ...
  ): `200Content324Headers304401` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("401")(`401`.asInstanceOf[js.Any])
    __obj.updateDynamic("403")(`403`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content324Headers304401`]
  }
  
  extension [Self <: `200Content324Headers304401`](x: Self) {
