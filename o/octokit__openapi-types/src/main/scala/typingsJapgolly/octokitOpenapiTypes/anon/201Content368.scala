...
trait `201Content368` extends StObject {
...
object `201Content368` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content368`]
  }
  
  extension [Self <: `201Content368`](x: Self) {
    
    inline def set201(value: Content368): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
