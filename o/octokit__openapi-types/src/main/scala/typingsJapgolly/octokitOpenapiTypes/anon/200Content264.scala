...
trait `200Content264` extends StObject {
...
object `200Content264` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content264`]
  }
  
  extension [Self <: `200Content264`](x: Self) {
    
    inline def set200(value: Content264): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
