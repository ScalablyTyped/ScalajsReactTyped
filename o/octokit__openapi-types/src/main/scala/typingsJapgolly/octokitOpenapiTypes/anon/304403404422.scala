...
object `304403404422` {
  ...
  inline def apply(`200`: Content118, `304`: Any, `403`: Content6, `404`: Content6, `422`: Content7): `304403404422` = {
    ...
    __obj.asInstanceOf[`304403404422`]
  }
  
  extension [Self <: `304403404422`](x: Self) {
