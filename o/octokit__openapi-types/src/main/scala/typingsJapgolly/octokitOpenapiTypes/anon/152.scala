...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.`off-topic`
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.`too heated`
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.resolved
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.spam
