...
trait `201Content624` extends StObject {
...
object `201Content624` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content624`]
  }
  
  extension [Self <: `201Content624`](x: Self) {
    
    inline def set201(value: Content624): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
