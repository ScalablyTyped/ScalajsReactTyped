...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.`gh-pages`
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.`master Slashdocs`
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.legacy
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.master
