...
trait `201Content277` extends StObject {
...
object `201Content277` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content277`]
  }
  
  extension [Self <: `201Content277`](x: Self) {
    
    inline def set201(value: Content277): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
