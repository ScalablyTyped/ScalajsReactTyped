...
trait `201Content546` extends StObject {
...
object `201Content546` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content546`]
  }
  
  extension [Self <: `201Content546`](x: Self) {
    
    inline def set201(value: Content546): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
