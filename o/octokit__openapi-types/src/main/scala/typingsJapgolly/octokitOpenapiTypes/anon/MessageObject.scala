...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.blob
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.commit
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.tree
