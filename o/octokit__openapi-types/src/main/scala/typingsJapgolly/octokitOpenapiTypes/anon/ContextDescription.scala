...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.error
...
trait ContextDescription extends StObject {
...
object ContextDescription {
  ...
  inline def apply(state: error | failure | pending | success): ContextDescription = {
    val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any])
    __obj.asInstanceOf[ContextDescription]
  }
  
  extension [Self <: ContextDescription](x: Self) {
