...
trait `200Content393` extends StObject {
...
object `200Content393` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content393`]
  }
  
  extension [Self <: `200Content393`](x: Self) {
    
    inline def set200(value: Content393): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
