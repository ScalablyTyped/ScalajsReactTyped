...
trait `200Content439` extends StObject {
...
object `200Content439` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content439`]
  }
  
  extension [Self <: `200Content439`](x: Self) {
    
    inline def set200(value: Content439): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
