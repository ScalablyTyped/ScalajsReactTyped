...
trait `200Content347304` extends StObject {
...
object `200Content347304` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content347304`]
  }
  
  extension [Self <: `200Content347304`](x: Self) {
    
    inline def set200(value: Content347): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
