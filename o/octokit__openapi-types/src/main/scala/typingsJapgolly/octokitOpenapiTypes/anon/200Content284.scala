...
trait `200Content284` extends StObject {
...
object `200Content284` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content284`]
  }
  
  extension [Self <: `200Content284`](x: Self) {
    
    inline def set200(value: Content284): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
