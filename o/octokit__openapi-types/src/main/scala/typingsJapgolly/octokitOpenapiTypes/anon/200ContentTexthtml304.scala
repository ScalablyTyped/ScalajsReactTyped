...
trait `200ContentTexthtml304` extends StObject {
...
object `200ContentTexthtml304` {
  ...
  ): `200ContentTexthtml304` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentTexthtml304`]
  }
  
  extension [Self <: `200ContentTexthtml304`](x: Self) {
