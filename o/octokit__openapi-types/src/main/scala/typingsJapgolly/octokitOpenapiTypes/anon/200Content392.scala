...
trait `200Content392` extends StObject {
...
object `200Content392` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content392`]
  }
  
  extension [Self <: `200Content392`](x: Self) {
    
    inline def set200(value: Content392): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
