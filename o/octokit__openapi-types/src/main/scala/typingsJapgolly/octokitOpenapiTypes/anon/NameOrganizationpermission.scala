...
trait NameOrganizationpermission extends StObject {
...
object NameOrganizationpermission {
  
  inline def apply(): NameOrganizationpermission = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[NameOrganizationpermission]
  }
  
  extension [Self <: NameOrganizationpermission](x: Self) {
