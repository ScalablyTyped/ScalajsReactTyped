...
trait RequestBodyContentApplicationjsonRefSha extends StObject {
  ...
  var responses: `201ContentApplicationjsonObjectHeadersLocation`
}
object RequestBodyContentApplicationjsonRefSha {
  ...
  inline def apply(
    ...
    responses: `201ContentApplicationjsonObjectHeadersLocation`
  ...
  extension [Self <: RequestBodyContentApplicationjsonRefSha](x: Self) {
    ...
    inline def setResponses(value: `201ContentApplicationjsonObjectHeadersLocation`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
