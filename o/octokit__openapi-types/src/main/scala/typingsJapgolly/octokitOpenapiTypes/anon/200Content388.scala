...
trait `200Content388` extends StObject {
...
object `200Content388` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content388`]
  }
  
  extension [Self <: `200Content388`](x: Self) {
    
    inline def set200(value: Content388): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
