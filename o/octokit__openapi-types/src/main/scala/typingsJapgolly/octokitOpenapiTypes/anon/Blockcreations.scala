...
trait Blockcreations extends StObject {
  ...
  var required_status_checks: js.UndefOr[Contexts] = js.undefined
...
object Blockcreations {
  ...
  extension [Self <: Blockcreations](x: Self) {
    ...
    inline def setRequired_pull_request_reviews(value: Dismissstalereviews): Self = StObject.set(x, "required_pull_request_reviews", value.asInstanceOf[js.Any])
