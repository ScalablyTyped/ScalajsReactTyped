...
trait ParametersPathCommentidOwnerQueryContentPage extends StObject {
  ...
  var responses: `200Content61404Content6`
}
object ParametersPathCommentidOwnerQueryContentPage {
  
  inline def apply(parameters: PathCommentidOwnerQueryContentPage, responses: `200Content61404Content6`): ParametersPathCommentidOwnerQueryContentPage = {
  ...
  extension [Self <: ParametersPathCommentidOwnerQueryContentPage](x: Self) {
    ...
    inline def setResponses(value: `200Content61404Content6`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
