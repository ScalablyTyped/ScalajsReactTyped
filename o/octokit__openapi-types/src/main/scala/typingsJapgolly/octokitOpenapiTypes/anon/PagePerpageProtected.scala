...
trait PagePerpageProtected extends StObject {
...
object PagePerpageProtected {
  
  inline def apply(): PagePerpageProtected = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PagePerpageProtected]
  }
  
  extension [Self <: PagePerpageProtected](x: Self) {
