...
trait `200ContentApplicationjson604` extends StObject {
  
  /** Response */
  var `200`: ContentApplicationjson604
...
object `200ContentApplicationjson604` {
  
  inline def apply(
    `200`: ContentApplicationjson604,
  ...
  ): `200ContentApplicationjson604` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.updateDynamic("503")(`503`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjson604`]
  }
  
  extension [Self <: `200ContentApplicationjson604`](x: Self) {
    
    inline def set200(value: ContentApplicationjson604): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
