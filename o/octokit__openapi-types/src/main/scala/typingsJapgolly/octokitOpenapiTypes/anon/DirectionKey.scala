...
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.last_accessed_at
import typingsJapgolly.octokitOpenapiTypes.octokitOpenapiTypesStrings.size_in_bytes
...
object DirectionKey {
  ...
  extension [Self <: DirectionKey](x: Self) {
