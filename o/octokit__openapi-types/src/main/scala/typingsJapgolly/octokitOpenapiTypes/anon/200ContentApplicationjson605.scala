...
trait `200ContentApplicationjson605` extends StObject {
  
  /** Response */
  var `200`: ContentApplicationjson605
...
object `200ContentApplicationjson605` {
  
  inline def apply(
    `200`: ContentApplicationjson605,
  ...
  ): `200ContentApplicationjson605` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("304")(`304`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200ContentApplicationjson605`]
  }
  
  extension [Self <: `200ContentApplicationjson605`](x: Self) {
    
    inline def set200(value: ContentApplicationjson605): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
