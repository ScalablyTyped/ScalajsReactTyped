...
trait `201Content648` extends StObject {
...
object `201Content648` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content648`]
  }
  
  extension [Self <: `201Content648`](x: Self) {
    
    inline def set201(value: Content648): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
