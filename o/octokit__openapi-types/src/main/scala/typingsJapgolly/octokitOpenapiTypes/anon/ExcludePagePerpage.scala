...
trait ExcludePagePerpage extends StObject {
...
object ExcludePagePerpage {
  
  inline def apply(): ExcludePagePerpage = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExcludePagePerpage]
  }
  
  extension [Self <: ExcludePagePerpage](x: Self) {
