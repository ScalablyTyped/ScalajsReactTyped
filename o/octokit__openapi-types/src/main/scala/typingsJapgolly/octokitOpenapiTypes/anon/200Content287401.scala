...
trait `200Content287401` extends StObject {
...
object `200Content287401` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`200Content287401`]
  }
  
  extension [Self <: `200Content287401`](x: Self) {
    
    inline def set200(value: Content287): Self = StObject.set(x, "200", value.asInstanceOf[js.Any])
