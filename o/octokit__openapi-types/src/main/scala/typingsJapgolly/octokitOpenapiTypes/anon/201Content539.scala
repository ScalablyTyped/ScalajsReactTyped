...
trait `201Content539` extends StObject {
...
object `201Content539` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content539`]
  }
  
  extension [Self <: `201Content539`](x: Self) {
    
    inline def set201(value: Content539): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
