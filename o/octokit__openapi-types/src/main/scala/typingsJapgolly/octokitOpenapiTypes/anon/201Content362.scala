...
trait `201Content362` extends StObject {
...
object `201Content362` {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[`201Content362`]
  }
  
  extension [Self <: `201Content362`](x: Self) {
    
    inline def set201(value: Content362): Self = StObject.set(x, "201", value.asInstanceOf[js.Any])
