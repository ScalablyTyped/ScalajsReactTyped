...
object DirectionPagePerpageSince {
  
  inline def apply(): DirectionPagePerpageSince = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DirectionPagePerpageSince]
  }
  
  extension [Self <: DirectionPagePerpageSince](x: Self) {
