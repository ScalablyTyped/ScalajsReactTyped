...
trait `200Content324Headers` extends StObject {
...
object `200Content324Headers` {
  ...
  ): `200Content324Headers` = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("200")(`200`.asInstanceOf[js.Any])
    __obj.updateDynamic("422")(`422`.asInstanceOf[js.Any])
    __obj.asInstanceOf[`200Content324Headers`]
  }
  
  extension [Self <: `200Content324Headers`](x: Self) {
