...
trait ParametersPathAutolinkidOwner extends StObject {
  ...
  var responses: `200435`
}
object ParametersPathAutolinkidOwner {
  
  inline def apply(parameters: PathAutolinkidOwner, responses: `200435`): ParametersPathAutolinkidOwner = {
  ...
  extension [Self <: ParametersPathAutolinkidOwner](x: Self) {
    ...
    inline def setResponses(value: `200435`): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
  }
}
