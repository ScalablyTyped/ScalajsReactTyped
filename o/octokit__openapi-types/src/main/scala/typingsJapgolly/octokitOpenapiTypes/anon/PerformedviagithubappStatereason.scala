...
trait PerformedviagithubappStatereason extends StObject {
...
object PerformedviagithubappStatereason {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[PerformedviagithubappStatereason]
  }
  
  extension [Self <: PerformedviagithubappStatereason](x: Self) {
