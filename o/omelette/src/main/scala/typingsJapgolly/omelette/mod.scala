...
import typingsJapgolly.omelette.omeletteStrings.complete
...
object mod extends Shortcut {
  ...
  object CallbackAsyncValue {
    ...
    inline def apply(
      ...
      fragment: Double,
      line: String,
      reply: js.Promise[Choices] => japgolly.scalajs.react.Callback
    ): CallbackAsyncValue = {
      val __obj = js.Dynamic.literal(before = before.asInstanceOf[js.Any], fragment = fragment.asInstanceOf[js.Any], line = line.asInstanceOf[js.Any], reply = js.Any.fromFunction1((t0: js.Promise[Choices]) => reply(t0).runNow()))
    ...
    extension [Self <: CallbackAsyncValue](x: Self) {
      ...
      inline def setReply(value: js.Promise[Choices] => japgolly.scalajs.react.Callback): Self = StObject.set(x, "reply", js.Any.fromFunction1((t0: js.Promise[Choices]) => value(t0).runNow()))
    }
  }
  ...
  object CallbackValue {
    ...
    inline def apply(before: String, fragment: Double, line: String, reply: Choices => japgolly.scalajs.react.Callback): CallbackValue = {
      val __obj = js.Dynamic.literal(before = before.asInstanceOf[js.Any], fragment = fragment.asInstanceOf[js.Any], line = line.asInstanceOf[js.Any], reply = js.Any.fromFunction1((t0: Choices) => reply(t0).runNow()))
    ...
    extension [Self <: CallbackValue](x: Self) {
      ...
      inline def setReply(value: Choices => japgolly.scalajs.react.Callback): Self = StObject.set(x, "reply", js.Any.fromFunction1((t0: Choices) => value(t0).runNow()))
    }
  }
