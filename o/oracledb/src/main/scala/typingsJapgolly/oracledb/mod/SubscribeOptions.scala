...
object SubscribeOptions {
  @scala.inline
  def apply(
    callback: SubscriptionMessage => Callback,
    sql: String,
    ...
    __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: typingsJapgolly.oracledb.mod.SubscriptionMessage) => callback(t0).runNow()))
