...
object SubscribeOptions {
  ...
  inline def apply(callback: SubscriptionMessage => Callback, sql: String): SubscribeOptions = {
    val __obj = js.Dynamic.literal(callback = js.Any.fromFunction1((t0: SubscriptionMessage) => callback(t0).runNow()), sql = sql.asInstanceOf[js.Any])
  ...
  extension [Self <: SubscribeOptions](x: Self) {
    ...
    inline def setCallback(value: SubscriptionMessage => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: SubscriptionMessage) => value(t0).runNow()))
