...
/* Inlined openpgp.openpgp.SignOptions & {  armor ? :true,   detached  :true} */
trait SignOptionsarmortruedetacArmor extends js.Object {
  /**
...
object SignOptionsarmortruedetacArmor {
  @scala.inline
  def apply(
  ...
  ): SignOptionsarmortruedetacArmor = {
    ...
    __obj.asInstanceOf[SignOptionsarmortruedetacArmor]
  }
}
