...
object openpgpStrings {
  ...
  inline def aead: aead = "aead".asInstanceOf[aead]
  ...
  inline def encrypt_sign: encrypt_sign = "encrypt_sign".asInstanceOf[encrypt_sign]
  
  @js.native
  sealed trait mime extends StObject
  inline def mime: mime = "mime".asInstanceOf[mime]
