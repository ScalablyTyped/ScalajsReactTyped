...
object encoding {
  ...
  object armor {
    ...
    /**
      ...
      */
    inline def addheader(customComment: String): String = ^.asInstanceOf[js.Dynamic].applyDynamic("addheader")(customComment.asInstanceOf[js.Any]).asInstanceOf[String]
    ...
    /**
      ...
      */
    inline def dearmor(text: String): js.Promise[js.Object] = ^.asInstanceOf[js.Dynamic].applyDynamic("dearmor")(text.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Object]]
    ...
    /**
      ...
      */
    inline def getCheckSum(data: String): String | ReadableStream[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getCheckSum")(data.asInstanceOf[js.Any]).asInstanceOf[String | ReadableStream[String]]
    inline def getCheckSum(data: ReadableStream[String]): String | ReadableStream[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("getCheckSum")(data.asInstanceOf[js.Any]).asInstanceOf[String | ReadableStream[String]]
    ...
    /**
      ...
      */
    inline def splitChecksum(text: String): js.Object = ^.asInstanceOf[js.Dynamic].applyDynamic("splitChecksum")(text.asInstanceOf[js.Any]).asInstanceOf[js.Object]
  }
