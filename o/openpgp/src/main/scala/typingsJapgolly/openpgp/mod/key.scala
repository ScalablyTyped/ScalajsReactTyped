...
import typingsJapgolly.openpgp.anon.SelfCertification
import typingsJapgolly.openpgp.anon.Userid
...
import typingsJapgolly.openpgp.openpgpStrings.aead
import typingsJapgolly.openpgp.openpgpStrings.encrypt_sign
import typingsJapgolly.openpgp.openpgpStrings.symmetric
...
object key {
  ...
  open class Key protected () extends StObject {
    ...
    /**
      ...
      */
    def getEncryptionKey(): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getEncryptionKey(keyId: Unit, date: js.Date): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getEncryptionKey(keyId: Unit, date: js.Date, userId: String): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getEncryptionKey(keyId: Unit, date: Unit, userId: String): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getEncryptionKey(keyId: Keyid): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getEncryptionKey(keyId: Keyid, date: js.Date): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getEncryptionKey(keyId: Keyid, date: js.Date, userId: String): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getEncryptionKey(keyId: Keyid, date: Unit, userId: String): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    ...
    def getExpirationTime(
      capabilities: typingsJapgolly.openpgp.openpgpStrings.encrypt | typingsJapgolly.openpgp.openpgpStrings.sign | encrypt_sign
    ...
    /**
      ...
      */
    def getSigningKey(keyId: Keyid): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getSigningKey(keyId: Keyid, date: js.Date): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getSigningKey(keyId: Keyid, date: js.Date, userId: js.Object): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    def getSigningKey(keyId: Keyid, date: Unit, userId: js.Object): js.Promise[Key | typingsJapgolly.openpgp.mod.key.SubKey | Null] = js.native
    ...
    /**
      ...
      */
    def packetlist2structure(packetlist: typingsJapgolly.openpgp.mod.packet.List): Unit = js.native
  ...
  open class SubKey () extends StObject {
    ...
    /**
      ...
      */
    def revoke(primaryKey: SecretKey, reasonForRevocation: revokeReasonForRevocation, date: js.Date): js.Promise[typingsJapgolly.openpgp.mod.key.SubKey] = js.native
    ...
    /**
      ...
      * @returns
      */
    def update(subKey: typingsJapgolly.openpgp.mod.key.SubKey, primaryKey: SecretKey): js.Promise[Unit] = js.native
    def update(subKey: typingsJapgolly.openpgp.mod.key.SubKey, primaryKey: SecretSubkey): js.Promise[Unit] = js.native
  ...
  open class User () extends StObject {
    ...
    var userId: typingsJapgolly.openpgp.mod.packet.Userid = js.native
  ...
  /**
    ...
    */
  inline def getPreferredAlgo(`type`: symmetric | aead, keys: js.Array[Any], date: js.Date, userIds: js.Array[Any]): js.Promise[typingsJapgolly.openpgp.mod.enums.symmetric] = (^.asInstanceOf[js.Dynamic].applyDynamic("getPreferredAlgo")(`type`.asInstanceOf[js.Any], keys.asInstanceOf[js.Any], date.asInstanceOf[js.Any], userIds.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.openpgp.mod.enums.symmetric]]
