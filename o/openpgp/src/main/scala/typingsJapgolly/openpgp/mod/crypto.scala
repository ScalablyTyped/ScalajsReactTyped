...
import typingsJapgolly.openpgp.anon.C
import typingsJapgolly.openpgp.anon.S
import typingsJapgolly.openpgp.mod.`type`.kdfParams.KDFParams
import typingsJapgolly.openpgp.mod.`type`.mpi.MPI
import typingsJapgolly.openpgp.mod.`type`.oid.OID
import typingsJapgolly.openpgp.mod.crypto.publicKey.elliptic.curve.Curve
import typingsJapgolly.openpgp.mod.enums.hash
import typingsJapgolly.openpgp.mod.enums.publicKey
...
object crypto {
  ...
  object hash {
    ...
    /**
      ...
      * @returns hash value
      */
    inline def digest(algo: typingsJapgolly.openpgp.mod.enums.hash, data: js.typedarray.Uint8Array): js.Promise[js.typedarray.Uint8Array] = (^.asInstanceOf[js.Dynamic].applyDynamic("digest")(algo.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.typedarray.Uint8Array]]
    ...
    /**
      ...
      */
    inline def getHashByteLength(algo: typingsJapgolly.openpgp.mod.enums.hash): Integer = ^.asInstanceOf[js.Dynamic].applyDynamic("getHashByteLength")(algo.asInstanceOf[js.Any]).asInstanceOf[Integer]
