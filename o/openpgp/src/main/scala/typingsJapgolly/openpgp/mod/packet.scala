...
object packet {
  ...
  open class Compressed ()
    ...
    /**
      * Packet type
      */
    var tag: typingsJapgolly.openpgp.mod.enums.packet = js.native
  ...
  open class List () extends StObject {
    ...
    def concat(packets: typingsJapgolly.openpgp.mod.packet.List): Unit = js.native
    
    /**
      * Creates a new PacketList with all packets from the given types
      */
    def filterByTag(tags: typingsJapgolly.openpgp.mod.enums.packet*): typingsJapgolly.openpgp.mod.packet.List = js.native
    ...
    /**
      ...
      * @returns
      */
    def findPacket(`type`: typingsJapgolly.openpgp.mod.enums.packet): js.UndefOr[AnyPacket] = js.native
    
    /**
      * Returns array of found indices by tag
      */
    def indexOfTag(tags: typingsJapgolly.openpgp.mod.enums.packet*): js.Array[Double] = js.native
  ...
  open class Signature protected ()
    ...
    def verify(key: PublicKey, signatureType: typingsJapgolly.openpgp.mod.enums.signature, data: String): js.Promise[Boolean] = js.native
    def verify(key: PublicKey, signatureType: typingsJapgolly.openpgp.mod.enums.signature, data: js.Object): js.Promise[Boolean] = js.native
    /**
      ...
      */
    def verify(key: PublicSubkey, signatureType: typingsJapgolly.openpgp.mod.enums.signature, data: String): js.Promise[Boolean] = js.native
    def verify(key: PublicSubkey, signatureType: typingsJapgolly.openpgp.mod.enums.signature, data: js.Object): js.Promise[Boolean] = js.native
    def verify(key: SecretKey, signatureType: typingsJapgolly.openpgp.mod.enums.signature, data: String): js.Promise[Boolean] = js.native
    def verify(key: SecretKey, signatureType: typingsJapgolly.openpgp.mod.enums.signature, data: js.Object): js.Promise[Boolean] = js.native
    def verify(key: SecretSubkey, signatureType: typingsJapgolly.openpgp.mod.enums.signature, data: String): js.Promise[Boolean] = js.native
    def verify(key: SecretSubkey, signatureType: typingsJapgolly.openpgp.mod.enums.signature, data: js.Object): js.Promise[Boolean] = js.native
  ...
  open class SymEncryptedAEADProtected ()
    ...
    /**
      ...
      */
    def crypt(
      fn: typingsJapgolly.openpgp.openpgpStrings.encrypt | typingsJapgolly.openpgp.openpgpStrings.decrypt,
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.openpgp.mod.packet.Compressed
    - typingsJapgolly.openpgp.mod.packet.Literal
    - typingsJapgolly.openpgp.mod.packet.Marker
    - typingsJapgolly.openpgp.mod.packet.OnePassSignature
    - typingsJapgolly.openpgp.mod.packet.PublicKey
    - typingsJapgolly.openpgp.mod.packet.PublicKeyEncryptedSessionKey
    - typingsJapgolly.openpgp.mod.packet.PublicSubkey
    - typingsJapgolly.openpgp.mod.packet.SecretKey
    - typingsJapgolly.openpgp.mod.packet.SecretSubkey
    - typingsJapgolly.openpgp.mod.packet.Signature
    - typingsJapgolly.openpgp.mod.packet.SymEncryptedAEADProtected
    - typingsJapgolly.openpgp.mod.packet.SymEncryptedIntegrityProtected
    - typingsJapgolly.openpgp.mod.packet.SymEncryptedSessionKey
    - typingsJapgolly.openpgp.mod.packet.SymmetricallyEncrypted
    - typingsJapgolly.openpgp.mod.packet.Trust
    - typingsJapgolly.openpgp.mod.packet.UserAttribute
    - typingsJapgolly.openpgp.mod.packet.Userid
  */
