...
import typingsJapgolly.openpgp.AnonSelfCertification
import typingsJapgolly.openpgp.AnonUserid
import typingsJapgolly.openpgp.mod.Infinity
...
import typingsJapgolly.openpgp.mod.revokeReasonForRevocation
