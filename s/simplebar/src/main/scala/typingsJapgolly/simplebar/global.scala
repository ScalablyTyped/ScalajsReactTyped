...
import typingsJapgolly.simplebar.mod.Options
...
object global {
  ...
  object SimpleBar {
    ...
    open class ^ protected ()
      extends typingsJapgolly.simplebar.mod.^ {
    ...
    object instances {
      ...
      @js.native
      def get: js.Function1[/* key */ HTMLElement, js.UndefOr[typingsJapgolly.simplebar.mod.SimpleBar]] = js.native
      inline def get(key: HTMLElement): js.UndefOr[typingsJapgolly.simplebar.mod.SimpleBar] = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(key.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.simplebar.mod.SimpleBar]]
      inline def get_=(x: js.Function1[/* key */ HTMLElement, js.UndefOr[typingsJapgolly.simplebar.mod.SimpleBar]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("get")(x.asInstanceOf[js.Any])
