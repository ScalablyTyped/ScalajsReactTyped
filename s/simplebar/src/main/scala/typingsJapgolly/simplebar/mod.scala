...
import typingsJapgolly.simplebar.simplebarStrings.ltr
import typingsJapgolly.simplebar.simplebarStrings.rtl
import typingsJapgolly.simplebar.simplebarStrings.x
import typingsJapgolly.simplebar.simplebarStrings.y
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setForceVisible(value: Boolean | typingsJapgolly.simplebar.simplebarStrings.x | y): Self = StObject.set(x, "forceVisible", value.asInstanceOf[js.Any])
  ...
  object SimpleBar {
    ...
    inline def apply(
      ...
      getScrollElement: CallbackTo[HTMLElement],
      recalculate: Callback,
      unMount: Callback
    ): SimpleBar = {
      val __obj = js.Dynamic.literal(el = el.asInstanceOf[js.Any], getContentElement = getContentElement.toJsFn, getScrollElement = getScrollElement.toJsFn, recalculate = recalculate.toJsFn, unMount = unMount.toJsFn)
    ...
    extension [Self <: SimpleBar](x: Self) {
      ...
      inline def setGetScrollElement(value: CallbackTo[HTMLElement]): Self = StObject.set(x, "getScrollElement", value.toJsFn)
