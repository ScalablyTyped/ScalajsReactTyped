...
object soundmanager {
  ...
  object DefaultOptions {
    ...
    extension [Self <: DefaultOptions](x: Self) {
      ...
      inline def setOnid3(value: Callback): Self = StObject.set(x, "onid3", value.toJsFn)
      ...
      inline def setOnposition(value: Callback): Self = StObject.set(x, "onposition", value.toJsFn)
      ...
      inline def setWhileloading(value: Callback): Self = StObject.set(x, "whileloading", value.toJsFn)
      ...
      inline def setWhileplaying(value: Callback): Self = StObject.set(x, "whileplaying", value.toJsFn)
  ...
  object Flash9Options {
    ...
    extension [Self <: Flash9Options](x: Self) {
      ...
      inline def setOndataerror(value: Callback): Self = StObject.set(x, "ondataerror", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.soundmanager2.soundmanager2Strings.always
    - typingsJapgolly.soundmanager2.soundmanager2Strings.sameDomain
  */
  trait ScriptAccess extends StObject
  object ScriptAccess {
    
    inline def always: typingsJapgolly.soundmanager2.soundmanager2Strings.always = "always".asInstanceOf[typingsJapgolly.soundmanager2.soundmanager2Strings.always]
    
    inline def sameDomain: typingsJapgolly.soundmanager2.soundmanager2Strings.sameDomain = "sameDomain".asInstanceOf[typingsJapgolly.soundmanager2.soundmanager2Strings.sameDomain]
  }
  ...
  object SoundManagerProps {
    ...
    extension [Self <: SoundManagerProps](x: Self) {
      ...
      inline def setOntimeout(value: Callback): Self = StObject.set(x, "ontimeout", value.toJsFn)
