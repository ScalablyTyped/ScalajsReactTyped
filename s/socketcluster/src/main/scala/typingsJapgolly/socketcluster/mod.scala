...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.socketcluster.socketclusterStrings.red
    - typingsJapgolly.socketcluster.socketclusterStrings.green
    - typingsJapgolly.socketcluster.socketclusterStrings.yellow
  */
  trait ColorCodes extends StObject
  object ColorCodes {
    
    inline def green: typingsJapgolly.socketcluster.socketclusterStrings.green = "green".asInstanceOf[typingsJapgolly.socketcluster.socketclusterStrings.green]
    
    inline def red: typingsJapgolly.socketcluster.socketclusterStrings.red = "red".asInstanceOf[typingsJapgolly.socketcluster.socketclusterStrings.red]
    
    inline def yellow: typingsJapgolly.socketcluster.socketclusterStrings.yellow = "yellow".asInstanceOf[typingsJapgolly.socketcluster.socketclusterStrings.yellow]
  }
