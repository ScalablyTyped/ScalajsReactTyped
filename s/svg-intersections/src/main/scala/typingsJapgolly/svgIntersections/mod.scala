...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.svgIntersections.svgIntersectionsStrings.line
    - typingsJapgolly.svgIntersections.svgIntersectionsStrings.rect
    - typingsJapgolly.svgIntersections.svgIntersectionsStrings.circle
    - typingsJapgolly.svgIntersections.svgIntersectionsStrings.ellipse
    - typingsJapgolly.svgIntersections.svgIntersectionsStrings.polygon
    - typingsJapgolly.svgIntersections.svgIntersectionsStrings.polyline
    - typingsJapgolly.svgIntersections.svgIntersectionsStrings.path
  */
  trait SvgElements extends StObject
  object SvgElements {
    
    inline def circle: typingsJapgolly.svgIntersections.svgIntersectionsStrings.circle = "circle".asInstanceOf[typingsJapgolly.svgIntersections.svgIntersectionsStrings.circle]
    
    inline def ellipse: typingsJapgolly.svgIntersections.svgIntersectionsStrings.ellipse = "ellipse".asInstanceOf[typingsJapgolly.svgIntersections.svgIntersectionsStrings.ellipse]
    
    inline def line: typingsJapgolly.svgIntersections.svgIntersectionsStrings.line = "line".asInstanceOf[typingsJapgolly.svgIntersections.svgIntersectionsStrings.line]
    
    inline def path: typingsJapgolly.svgIntersections.svgIntersectionsStrings.path = "path".asInstanceOf[typingsJapgolly.svgIntersections.svgIntersectionsStrings.path]
    
    inline def polygon: typingsJapgolly.svgIntersections.svgIntersectionsStrings.polygon = "polygon".asInstanceOf[typingsJapgolly.svgIntersections.svgIntersectionsStrings.polygon]
    
    inline def polyline: typingsJapgolly.svgIntersections.svgIntersectionsStrings.polyline = "polyline".asInstanceOf[typingsJapgolly.svgIntersections.svgIntersectionsStrings.polyline]
    
    inline def rect: typingsJapgolly.svgIntersections.svgIntersectionsStrings.rect = "rect".asInstanceOf[typingsJapgolly.svgIntersections.svgIntersectionsStrings.rect]
  }
