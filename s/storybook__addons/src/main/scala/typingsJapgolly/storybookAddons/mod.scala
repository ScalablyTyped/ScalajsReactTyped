...
import typingsJapgolly.storybookAddons.distTs3Dot9HooksMod.EventMap
import typingsJapgolly.storybookAddons.distTs3Dot9MakeDecoratorMod.MakeDecoratorOptions
import typingsJapgolly.storybookAddons.distTs3Dot9MakeDecoratorMod.MakeDecoratorResult
import typingsJapgolly.storybookAddons.distTs3Dot9TypesMod.Types_
import typingsJapgolly.storybookChannels.mod.ChannelArgs
...
object mod {
  ...
  @js.native
  val default: typingsJapgolly.storybookAddons.distTs3Dot9Mod.AddonStore = js.native
  
  @JSImport("@storybook/addons", "AddonStore")
  @js.native
  open class AddonStore ()
    extends typingsJapgolly.storybookAddons.distTs3Dot9Mod.AddonStore
  
  @JSImport("@storybook/addons", "Channel")
  @js.native
  open class Channel ()
    extends typingsJapgolly.storybookAddons.distTs3Dot9Mod.Channel {
  ...
  open class HooksContext[TFramework /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AnyFramework */ Any */] ()
    extends typingsJapgolly.storybookAddons.distTs3Dot9HooksMod.HooksContext[TFramework]
  
  @JSImport("@storybook/addons", "addons")
  @js.native
  val addons: typingsJapgolly.storybookAddons.distTs3Dot9Mod.AddonStore = js.native
  ...
  inline def mockChannel(): typingsJapgolly.storybookChannels.mod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("mockChannel")().asInstanceOf[typingsJapgolly.storybookChannels.mod.default]
  ...
  object types extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.storybookAddons.distTs3Dot9TypesMod.types & String] = js.native
