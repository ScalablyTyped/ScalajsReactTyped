...
import typingsJapgolly.storybookAddons.anon.Current
...
object distTs3Dot9HooksMod {
  ...
  object Effect {
    ...
    inline def apply(create: CallbackTo[js.Function0[Unit] | Unit]): Effect = {
    ...
    extension [Self <: Effect](x: Self) {
      ...
      inline def setCreate(value: CallbackTo[js.Function0[Unit] | Unit]): Self = StObject.set(x, "create", value.toJsFn)
      
      inline def setDestroy(value: js.Function0[Unit] | Unit): Self = StObject.set(x, "destroy", value.asInstanceOf[js.Any])
      
      inline def setDestroyCallback(value: Callback): Self = StObject.set(x, "destroy", value.toJsFn)
