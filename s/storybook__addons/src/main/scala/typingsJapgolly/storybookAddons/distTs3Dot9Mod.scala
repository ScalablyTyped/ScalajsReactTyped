...
object distTs3Dot9Mod {
  ...
  open class AddonStore () extends StObject {
    ...
    def getChannel(): typingsJapgolly.storybookChannels.mod.Channel = js.native
    
    def getConfig(): Config = js.native
    
    def getElements(`type`: Types_): Collection = js.native
    
    def getServerChannel(): typingsJapgolly.storybookChannels.mod.Channel = js.native
    ...
    def ready(): js.Promise[typingsJapgolly.storybookChannels.mod.Channel] = js.native
    ...
    def setChannel(channel: typingsJapgolly.storybookChannels.mod.Channel): Unit = js.native
    
    def setConfig(value: Config): Unit = js.native
    
    def setServerChannel(channel: typingsJapgolly.storybookChannels.mod.Channel): Unit = js.native
  }
  
  @JSImport("@storybook/addons/dist/ts3.9", "Channel")
  @js.native
  open class Channel ()
    extends typingsJapgolly.storybookChannels.mod.Channel {
  ...
  object Addon {
    ...
    inline def apply(render: RenderOptions => Element, title: js.Function0[String] | String): Addon = {
