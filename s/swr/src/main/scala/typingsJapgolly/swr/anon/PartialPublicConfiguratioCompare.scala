...
object PartialPublicConfiguratioCompare {
  ...
  extension [Self <: PartialPublicConfiguratioCompare](x: Self) {
    ...
    inline def setOnError(
      value: (/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfiguratiDedupingInterval) => Callback
    ): Self = StObject.set(x, "onError", js.Any.fromFunction3((t0: /* err */ Any, t1: /* key */ String, t2: /* config */ ReadonlyPublicConfiguratiDedupingInterval) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnErrorRetry(
      value: (/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfiguratiDedupingInterval, /* revalidate */ Revalidator, /* revalidateOpts */ RequiredRevalidatorOption) => Callback
    ): Self = StObject.set(x, "onErrorRetry", js.Any.fromFunction5((t0: /* err */ Any, t1: /* key */ String, t2: /* config */ ReadonlyPublicConfiguratiDedupingInterval, t3: /* revalidate */ Revalidator, t4: /* revalidateOpts */ RequiredRevalidatorOption) => (value(t0, t1, t2, t3, t4)).runNow()))
    
    inline def setOnErrorRetryUndefined: Self = StObject.set(x, "onErrorRetry", js.undefined)
    
    inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
    
    inline def setOnLoadingSlow(value: (/* key */ String, /* config */ ReadonlyPublicConfiguratiDedupingInterval) => Callback): Self = StObject.set(x, "onLoadingSlow", js.Any.fromFunction2((t0: /* key */ String, t1: /* config */ ReadonlyPublicConfiguratiDedupingInterval) => (value(t0, t1)).runNow()))
    
    inline def setOnLoadingSlowUndefined: Self = StObject.set(x, "onLoadingSlow", js.undefined)
    
    inline def setOnSuccess(
      value: (/* data */ Any, /* key */ String, /* config */ ReadonlyPublicConfiguratiDedupingInterval) => Callback
    ): Self = StObject.set(x, "onSuccess", js.Any.fromFunction3((t0: /* data */ Any, t1: /* key */ String, t2: /* config */ ReadonlyPublicConfiguratiDedupingInterval) => (value(t0, t1, t2)).runNow()))
