...
/* Inlined std.Partial<swr.swr/dist/types.FullConfiguration> */
trait PartialFullConfiguration extends StObject {
  
  var cache: js.UndefOr[Cache[Any]] = js.undefined
  ...
  var mutate: js.UndefOr[ScopedMutator[Any]] = js.undefined
  
  var onDiscarded: js.UndefOr[js.Function1[/* key */ String, Unit]] = js.undefined
  
  var onError: js.UndefOr[
    js.Function3[/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfigurati, Unit]
  ] = js.undefined
  ...
  var onErrorRetry: js.UndefOr[
    js.Function5[
      /* err */ Any, 
      /* key */ String, 
      /* config */ ReadonlyPublicConfigurati, 
  ...
  var onLoadingSlow: js.UndefOr[js.Function2[/* key */ String, /* config */ ReadonlyPublicConfigurati, Unit]] = js.undefined
  
  var onSuccess: js.UndefOr[
    js.Function3[/* data */ Any, /* key */ String, /* config */ ReadonlyPublicConfigurati, Unit]
  ] = js.undefined
...
object PartialFullConfiguration {
  
  inline def apply(): PartialFullConfiguration = {
  ...
  extension [Self <: PartialFullConfiguration](x: Self) {
    ...
    inline def setOnError(value: (/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfigurati) => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction3((t0: /* err */ Any, t1: /* key */ String, t2: /* config */ ReadonlyPublicConfigurati) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnErrorRetry(
      value: (/* err */ Any, /* key */ String, /* config */ ReadonlyPublicConfigurati, /* revalidate */ Revalidator, /* revalidateOpts */ RequiredRevalidatorOption) => Callback
    ): Self = StObject.set(x, "onErrorRetry", js.Any.fromFunction5((t0: /* err */ Any, t1: /* key */ String, t2: /* config */ ReadonlyPublicConfigurati, t3: /* revalidate */ Revalidator, t4: /* revalidateOpts */ RequiredRevalidatorOption) => (value(t0, t1, t2, t3, t4)).runNow()))
    
    inline def setOnErrorRetryUndefined: Self = StObject.set(x, "onErrorRetry", js.undefined)
    
    inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
    
    inline def setOnLoadingSlow(value: (/* key */ String, /* config */ ReadonlyPublicConfigurati) => Callback): Self = StObject.set(x, "onLoadingSlow", js.Any.fromFunction2((t0: /* key */ String, t1: /* config */ ReadonlyPublicConfigurati) => (value(t0, t1)).runNow()))
    
    inline def setOnLoadingSlowUndefined: Self = StObject.set(x, "onLoadingSlow", js.undefined)
    
    inline def setOnSuccess(value: (/* data */ Any, /* key */ String, /* config */ ReadonlyPublicConfigurati) => Callback): Self = StObject.set(x, "onSuccess", js.Any.fromFunction3((t0: /* data */ Any, t1: /* key */ String, t2: /* config */ ReadonlyPublicConfigurati) => (value(t0, t1, t2)).runNow()))
