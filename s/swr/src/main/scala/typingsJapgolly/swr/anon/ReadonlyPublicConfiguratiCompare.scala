...
import typingsJapgolly.swr.distTypesMod.RevalidatorOptions
...
object ReadonlyPublicConfiguratiCompare {
  ...
  inline def apply(
    ...
    onErrorRetry: (/* err */ Any, /* key */ String, /* config */ PublicConfiguration[Any, Any, BareFetcher[Any]], /* revalidate */ Revalidator, /* revalidateOpts */ Required[RevalidatorOptions]) => Callback,
  ...
  extension [Self <: ReadonlyPublicConfiguratiCompare](x: Self) {
    ...
    inline def setOnErrorRetry(
      value: (/* err */ Any, /* key */ String, /* config */ PublicConfiguration[Any, Any, BareFetcher[Any]], /* revalidate */ Revalidator, /* revalidateOpts */ Required[RevalidatorOptions]) => Callback
    ): Self = StObject.set(x, "onErrorRetry", js.Any.fromFunction5((t0: /* err */ Any, t1: /* key */ String, t2: /* config */ PublicConfiguration[Any, Any, BareFetcher[Any]], t3: /* revalidate */ Revalidator, t4: /* revalidateOpts */ Required[RevalidatorOptions]) => (value(t0, t1, t2, t3, t4)).runNow()))
