...
import typingsJapgolly.swr.anon.RequiredRevalidatorOption
import typingsJapgolly.swr.swrBooleans.`false`
...
object distTypesMod {
  ...
  object Cache {
    ...
    inline def apply[Data](delete: Key => Callback, get: Key => js.UndefOr[Data | Null], set: (Key, Data) => Callback): Cache[Data] = {
      val __obj = js.Dynamic.literal(delete = js.Any.fromFunction1((t0: Key) => delete(t0).runNow()), get = js.Any.fromFunction1(get), set = js.Any.fromFunction2((t0: Key, t1: Data) => (set(t0, t1)).runNow()))
      __obj.asInstanceOf[Cache[Data]]
    }
    
    extension [Self <: Cache[?], Data](x: Self & Cache[Data]) {
      
      inline def setDelete(value: Key => Callback): Self = StObject.set(x, "delete", js.Any.fromFunction1((t0: Key) => value(t0).runNow()))
      
      inline def setGet(value: Key => js.UndefOr[Data | Null]): Self = StObject.set(x, "get", js.Any.fromFunction1(value))
      
      inline def setSet(value: (Key, Data) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: Key, t1: Data) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object SWRConfiguration {
    ...
    extension [Self <: SWRConfiguration[?, ?, ?], Data, Error, Fn /* <: BareFetcher[Any] */](x: Self & (SWRConfiguration[Data, Error, Fn])) {
      ...
      inline def setOnError(
        value: (/* err */ Error, /* key */ String, /* config */ PublicConfiguration[Data, Error, Fn]) => Callback
      ): Self = StObject.set(x, "onError", js.Any.fromFunction3((t0: /* err */ Error, t1: /* key */ String, t2: /* config */ PublicConfiguration[Data, Error, Fn]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnErrorRetry(
        value: (/* err */ Error, /* key */ String, /* config */ PublicConfiguration[Data, Error, Fn], /* revalidate */ Revalidator, /* revalidateOpts */ RequiredRevalidatorOption) => Callback
      ): Self = StObject.set(x, "onErrorRetry", js.Any.fromFunction5((t0: /* err */ Error, t1: /* key */ String, t2: /* config */ PublicConfiguration[Data, Error, Fn], t3: /* revalidate */ Revalidator, t4: /* revalidateOpts */ RequiredRevalidatorOption) => (value(t0, t1, t2, t3, t4)).runNow()))
      
      inline def setOnErrorRetryUndefined: Self = StObject.set(x, "onErrorRetry", js.undefined)
      
      inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
      
      inline def setOnLoadingSlow(value: (/* key */ String, /* config */ PublicConfiguration[Data, Error, Fn]) => Callback): Self = StObject.set(x, "onLoadingSlow", js.Any.fromFunction2((t0: /* key */ String, t1: /* config */ PublicConfiguration[Data, Error, Fn]) => (value(t0, t1)).runNow()))
      
      inline def setOnLoadingSlowUndefined: Self = StObject.set(x, "onLoadingSlow", js.undefined)
      
      inline def setOnSuccess(
        value: (/* data */ Data, /* key */ String, /* config */ PublicConfiguration[Data, Error, Fn]) => Callback
      ): Self = StObject.set(x, "onSuccess", js.Any.fromFunction3((t0: /* data */ Data, t1: /* key */ String, t2: /* config */ PublicConfiguration[Data, Error, Fn]) => (value(t0, t1, t2)).runNow()))
