package typingsJapgolly.styledSystemCore
...
object mod {
  ...
  trait ConfigStyle extends StObject {
    ...
    var properties: js.UndefOr[
        js.Array[
          /* keyof csstype.csstype.Properties<string & {} | 0, string & {}> */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 788, starting with typingsJapgolly.styledSystemCore.styledSystemCoreStrings.accentColor, typingsJapgolly.styledSystemCore.styledSystemCoreStrings.alignContent, typingsJapgolly.styledSystemCore.styledSystemCoreStrings.alignItems */ Any
        ]
      ] = js.undefined
    
    /** The CSS property to use in the returned style object (overridden by `properties` if present). */
    var property: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 789, starting with typingsJapgolly.styledSystemCore.styledSystemCoreStrings.accentColor, typingsJapgolly.styledSystemCore.styledSystemCoreStrings.alignContent, typingsJapgolly.styledSystemCore.styledSystemCoreStrings.alignItems */ Any
      ] = js.undefined
  ...
  object ConfigStyle {
    ...
    extension [Self <: ConfigStyle](x: Self) {
      ...
      inline def setProperty(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 789, starting with typingsJapgolly.styledSystemCore.styledSystemCoreStrings.accentColor, typingsJapgolly.styledSystemCore.styledSystemCoreStrings.alignContent, typingsJapgolly.styledSystemCore.styledSystemCoreStrings.alignItems */ Any
