package typingsJapgolly.structuredHeaders

import typingsJapgolly.structuredHeaders.distTypesMod.BareItem
import typingsJapgolly.structuredHeaders.distTypesMod.Dictionary
import typingsJapgolly.structuredHeaders.distTypesMod.InnerList
import typingsJapgolly.structuredHeaders.distTypesMod.Item
import typingsJapgolly.structuredHeaders.distTypesMod.Parameters
...
object distMod {
  ...
  open class default protected ()
    extends typingsJapgolly.structuredHeaders.distParserMod.default {
  ...
  open class ByteSequence protected ()
    extends typingsJapgolly.structuredHeaders.distTypesMod.ByteSequence {
  ...
  open class ParseError protected ()
    extends typingsJapgolly.structuredHeaders.distParserMod.ParseError {
  ...
  open class SerializeError ()
    extends typingsJapgolly.structuredHeaders.distSerializerMod.SerializeError
  
  @JSImport("structured-headers/dist", "Token")
  @js.native
  open class Token protected ()
    extends typingsJapgolly.structuredHeaders.distTokenMod.Token {
  ...
  inline def parseList(input: String): typingsJapgolly.structuredHeaders.distTypesMod.List = ^.asInstanceOf[js.Dynamic].applyDynamic("parseList")(input.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.structuredHeaders.distTypesMod.List]
  ...
  inline def serializeByteSequence(input: typingsJapgolly.structuredHeaders.distTypesMod.ByteSequence): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serializeByteSequence")(input.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def serializeList(input: typingsJapgolly.structuredHeaders.distTypesMod.List): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serializeList")(input.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  inline def serializeToken(input: typingsJapgolly.structuredHeaders.distTokenMod.Token): String = ^.asInstanceOf[js.Dynamic].applyDynamic("serializeToken")(input.asInstanceOf[js.Any]).asInstanceOf[String]
}
