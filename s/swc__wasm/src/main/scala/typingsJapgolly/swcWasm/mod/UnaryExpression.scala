...
trait UnaryExpression
  ...
  @JSName("type")
  var type_UnaryExpression: typingsJapgolly.swcWasm.swcWasmStrings.UnaryExpression
}
object UnaryExpression {
  ...
  extension [Self <: UnaryExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.UnaryExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
