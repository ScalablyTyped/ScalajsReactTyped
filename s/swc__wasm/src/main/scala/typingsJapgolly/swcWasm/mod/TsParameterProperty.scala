...
trait TsParameterProperty
  ...
  @JSName("type")
  var type_TsParameterProperty: typingsJapgolly.swcWasm.swcWasmStrings.TsParameterProperty
}
object TsParameterProperty {
  ...
  extension [Self <: TsParameterProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsParameterProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
