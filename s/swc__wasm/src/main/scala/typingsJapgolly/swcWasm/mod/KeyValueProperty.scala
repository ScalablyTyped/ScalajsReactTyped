...
trait KeyValueProperty
  ...
  @JSName("type")
  var type_KeyValueProperty: typingsJapgolly.swcWasm.swcWasmStrings.KeyValueProperty
...
object KeyValueProperty {
  ...
  extension [Self <: KeyValueProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.KeyValueProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
