...
trait NamedExportSpecifier
  ...
  @JSName("type")
  var type_NamedExportSpecifier: typingsJapgolly.swcWasm.swcWasmStrings.ExportSpecifier
}
object NamedExportSpecifier {
  ...
  extension [Self <: NamedExportSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ExportSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
