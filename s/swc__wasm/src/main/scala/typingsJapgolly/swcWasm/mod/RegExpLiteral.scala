...
trait RegExpLiteral
  ...
  @JSName("type")
  var type_RegExpLiteral: typingsJapgolly.swcWasm.swcWasmStrings.RegExpLiteral
}
object RegExpLiteral {
  ...
  extension [Self <: RegExpLiteral](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.RegExpLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
