...
trait ClassMethod
  ...
  @JSName("type")
  var type_ClassMethod: typingsJapgolly.swcWasm.swcWasmStrings.ClassMethod
}
object ClassMethod {
  ...
  extension [Self <: ClassMethod](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ClassMethod): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
