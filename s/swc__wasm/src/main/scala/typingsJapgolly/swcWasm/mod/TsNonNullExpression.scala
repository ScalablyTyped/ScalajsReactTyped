...
trait TsNonNullExpression
  ...
  @JSName("type")
  var type_TsNonNullExpression: typingsJapgolly.swcWasm.swcWasmStrings.TsNonNullExpression
}
object TsNonNullExpression {
  ...
  extension [Self <: TsNonNullExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsNonNullExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
