...
trait SpreadElement
  ...
  @JSName("type")
  var type_SpreadElement: typingsJapgolly.swcWasm.swcWasmStrings.SpreadElement
}
object SpreadElement {
  ...
  extension [Self <: SpreadElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.SpreadElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
