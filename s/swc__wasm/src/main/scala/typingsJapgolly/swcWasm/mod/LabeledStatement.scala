...
trait LabeledStatement
  ...
  @JSName("type")
  var type_LabeledStatement: typingsJapgolly.swcWasm.swcWasmStrings.LabeledStatement
}
object LabeledStatement {
  ...
  extension [Self <: LabeledStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.LabeledStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
