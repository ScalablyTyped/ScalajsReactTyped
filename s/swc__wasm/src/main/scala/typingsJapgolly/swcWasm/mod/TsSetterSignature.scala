...
trait TsSetterSignature
  ...
  @JSName("type")
  var type_TsSetterSignature: typingsJapgolly.swcWasm.swcWasmStrings.TsSetterSignature
}
object TsSetterSignature {
  ...
  extension [Self <: TsSetterSignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsSetterSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
