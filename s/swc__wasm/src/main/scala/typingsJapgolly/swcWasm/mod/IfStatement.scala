...
trait IfStatement
  ...
  @JSName("type")
  var type_IfStatement: typingsJapgolly.swcWasm.swcWasmStrings.IfStatement
}
object IfStatement {
  ...
  extension [Self <: IfStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.IfStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
