...
trait KeyValuePatternProperty
  ...
  @JSName("type")
  var type_KeyValuePatternProperty: typingsJapgolly.swcWasm.swcWasmStrings.KeyValuePatternProperty
...
object KeyValuePatternProperty {
  ...
  extension [Self <: KeyValuePatternProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.KeyValuePatternProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
