...
trait TsConditionalType
  ...
  @JSName("type")
  var type_TsConditionalType: typingsJapgolly.swcWasm.swcWasmStrings.TsConditionalType
}
object TsConditionalType {
  ...
  extension [Self <: TsConditionalType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsConditionalType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
