...
trait DoWhileStatement
  ...
  @JSName("type")
  var type_DoWhileStatement: typingsJapgolly.swcWasm.swcWasmStrings.DoWhileStatement
}
object DoWhileStatement {
  ...
  extension [Self <: DoWhileStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.DoWhileStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
