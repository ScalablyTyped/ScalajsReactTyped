...
trait ExportAllDeclaration
  ...
  @JSName("type")
  var type_ExportAllDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.ExportAllDeclaration
}
object ExportAllDeclaration {
  ...
  extension [Self <: ExportAllDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ExportAllDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
