...
trait TaggedTemplateExpression
  ...
  @JSName("type")
  var type_TaggedTemplateExpression: typingsJapgolly.swcWasm.swcWasmStrings.TaggedTemplateExpression
}
object TaggedTemplateExpression {
  ...
  extension [Self <: TaggedTemplateExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TaggedTemplateExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
