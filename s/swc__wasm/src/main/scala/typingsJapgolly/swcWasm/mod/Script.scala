...
trait Script
  ...
  @JSName("type")
  var type_Script: typingsJapgolly.swcWasm.swcWasmStrings.Script
}
object Script {
  ...
  extension [Self <: Script](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.Script): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
