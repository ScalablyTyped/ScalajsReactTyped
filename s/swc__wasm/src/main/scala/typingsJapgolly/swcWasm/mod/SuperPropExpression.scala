...
trait SuperPropExpression
  ...
  @JSName("type")
  var type_SuperPropExpression: typingsJapgolly.swcWasm.swcWasmStrings.SuperPropExpression
}
object SuperPropExpression {
  ...
  extension [Self <: SuperPropExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.SuperPropExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
