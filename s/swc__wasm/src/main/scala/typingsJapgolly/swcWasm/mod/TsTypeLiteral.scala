...
trait TsTypeLiteral
  ...
  @JSName("type")
  var type_TsTypeLiteral: typingsJapgolly.swcWasm.swcWasmStrings.TsTypeLiteral
}
object TsTypeLiteral {
  ...
  extension [Self <: TsTypeLiteral](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsTypeLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
