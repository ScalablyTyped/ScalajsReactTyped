...
trait ObjectExpression
  ...
  @JSName("type")
  var type_ObjectExpression: typingsJapgolly.swcWasm.swcWasmStrings.ObjectExpression
}
object ObjectExpression {
  ...
  extension [Self <: ObjectExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ObjectExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
