...
trait TsExpressionWithTypeArguments
  ...
  @JSName("type")
  var type_TsExpressionWithTypeArguments: typingsJapgolly.swcWasm.swcWasmStrings.TsExpressionWithTypeArguments
}
object TsExpressionWithTypeArguments {
  ...
  extension [Self <: TsExpressionWithTypeArguments](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsExpressionWithTypeArguments): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
