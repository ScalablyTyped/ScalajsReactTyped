...
trait TsGetterSignature
  ...
  @JSName("type")
  var type_TsGetterSignature: typingsJapgolly.swcWasm.swcWasmStrings.TsGetterSignature
}
object TsGetterSignature {
  ...
  extension [Self <: TsGetterSignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsGetterSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
