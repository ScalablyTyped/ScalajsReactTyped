...
trait JSXNamespacedName
  ...
  @JSName("type")
  var type_JSXNamespacedName: typingsJapgolly.swcWasm.swcWasmStrings.JSXNamespacedName
}
object JSXNamespacedName {
  ...
  extension [Self <: JSXNamespacedName](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXNamespacedName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
