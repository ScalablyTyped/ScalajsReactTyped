...
trait TsKeywordType
  ...
  @JSName("type")
  var type_TsKeywordType: typingsJapgolly.swcWasm.swcWasmStrings.TsKeywordType
}
object TsKeywordType {
  ...
  extension [Self <: TsKeywordType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsKeywordType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
