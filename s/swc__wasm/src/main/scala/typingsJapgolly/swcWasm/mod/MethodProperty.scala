...
trait MethodProperty
  ...
  @JSName("type")
  var type_MethodProperty: typingsJapgolly.swcWasm.swcWasmStrings.MethodProperty
}
object MethodProperty {
  ...
  extension [Self <: MethodProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.MethodProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
