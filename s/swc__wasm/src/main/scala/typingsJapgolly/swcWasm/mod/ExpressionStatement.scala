...
trait ExpressionStatement
  ...
  @JSName("type")
  var type_ExpressionStatement: typingsJapgolly.swcWasm.swcWasmStrings.ExpressionStatement
}
object ExpressionStatement {
  ...
  extension [Self <: ExpressionStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ExpressionStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
