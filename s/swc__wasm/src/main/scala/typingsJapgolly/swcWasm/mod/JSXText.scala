...
trait JSXText
  ...
  @JSName("type")
  var type_JSXText: typingsJapgolly.swcWasm.swcWasmStrings.JSXText
...
object JSXText {
  ...
  extension [Self <: JSXText](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXText): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
