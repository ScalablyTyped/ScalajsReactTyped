...
trait BigIntLiteral
  ...
  @JSName("type")
  var type_BigIntLiteral: typingsJapgolly.swcWasm.swcWasmStrings.BigIntLiteral
...
object BigIntLiteral {
  ...
  extension [Self <: BigIntLiteral](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.BigIntLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
