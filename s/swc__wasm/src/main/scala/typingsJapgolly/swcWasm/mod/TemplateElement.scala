...
trait TemplateElement
  ...
  @JSName("type")
  var type_TemplateElement: typingsJapgolly.swcWasm.swcWasmStrings.TemplateElement
}
object TemplateElement {
  ...
  extension [Self <: TemplateElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TemplateElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
