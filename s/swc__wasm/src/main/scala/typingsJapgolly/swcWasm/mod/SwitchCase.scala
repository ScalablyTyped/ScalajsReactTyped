...
trait SwitchCase
  ...
  @JSName("type")
  var type_SwitchCase: typingsJapgolly.swcWasm.swcWasmStrings.SwitchCase
}
object SwitchCase {
  ...
  extension [Self <: SwitchCase](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.SwitchCase): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
