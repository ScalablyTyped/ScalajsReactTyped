...
trait TsConstructorType
  ...
  @JSName("type")
  var type_TsConstructorType: typingsJapgolly.swcWasm.swcWasmStrings.TsConstructorType
}
object TsConstructorType {
  ...
  extension [Self <: TsConstructorType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsConstructorType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
