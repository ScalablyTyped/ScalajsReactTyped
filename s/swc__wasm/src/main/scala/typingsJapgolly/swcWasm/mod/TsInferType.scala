...
trait TsInferType
  ...
  @JSName("type")
  var type_TsInferType: typingsJapgolly.swcWasm.swcWasmStrings.TsInferType
}
object TsInferType {
  ...
  extension [Self <: TsInferType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsInferType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
