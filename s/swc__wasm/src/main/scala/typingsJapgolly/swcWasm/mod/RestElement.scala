...
trait RestElement
  ...
  @JSName("type")
  var type_RestElement: typingsJapgolly.swcWasm.swcWasmStrings.RestElement
}
object RestElement {
  ...
  extension [Self <: RestElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.RestElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
