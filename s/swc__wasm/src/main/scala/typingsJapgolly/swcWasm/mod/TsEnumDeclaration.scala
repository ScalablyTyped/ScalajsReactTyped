...
trait TsEnumDeclaration
  ...
  @JSName("type")
  var type_TsEnumDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.TsEnumDeclaration
}
object TsEnumDeclaration {
  ...
  extension [Self <: TsEnumDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsEnumDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
