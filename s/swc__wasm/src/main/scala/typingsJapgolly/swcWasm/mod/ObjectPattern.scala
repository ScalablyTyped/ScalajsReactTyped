...
trait ObjectPattern
  ...
  @JSName("type")
  var type_ObjectPattern: typingsJapgolly.swcWasm.swcWasmStrings.ObjectPattern
}
object ObjectPattern {
  ...
  extension [Self <: ObjectPattern](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ObjectPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
