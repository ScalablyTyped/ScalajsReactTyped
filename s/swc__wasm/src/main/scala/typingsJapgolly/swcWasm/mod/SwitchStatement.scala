...
trait SwitchStatement
  ...
  @JSName("type")
  var type_SwitchStatement: typingsJapgolly.swcWasm.swcWasmStrings.SwitchStatement
}
object SwitchStatement {
  ...
  extension [Self <: SwitchStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.SwitchStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
