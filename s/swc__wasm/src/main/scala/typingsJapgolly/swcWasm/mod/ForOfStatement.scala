...
trait ForOfStatement
  ...
  @JSName("type")
  var type_ForOfStatement: typingsJapgolly.swcWasm.swcWasmStrings.ForOfStatement
}
object ForOfStatement {
  ...
  extension [Self <: ForOfStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ForOfStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
