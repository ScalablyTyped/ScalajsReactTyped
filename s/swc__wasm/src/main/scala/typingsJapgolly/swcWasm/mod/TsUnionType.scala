...
trait TsUnionType
  ...
  @JSName("type")
  var type_TsUnionType: typingsJapgolly.swcWasm.swcWasmStrings.TsUnionType
...
object TsUnionType {
  ...
  extension [Self <: TsUnionType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsUnionType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
