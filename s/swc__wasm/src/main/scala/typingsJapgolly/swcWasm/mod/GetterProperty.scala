...
trait GetterProperty
  ...
  @JSName("type")
  var type_GetterProperty: typingsJapgolly.swcWasm.swcWasmStrings.GetterProperty
}
object GetterProperty {
  ...
  extension [Self <: GetterProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.GetterProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
