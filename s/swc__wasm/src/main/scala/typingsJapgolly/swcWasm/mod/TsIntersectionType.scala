...
trait TsIntersectionType
  ...
  @JSName("type")
  var type_TsIntersectionType: typingsJapgolly.swcWasm.swcWasmStrings.TsIntersectionType
...
object TsIntersectionType {
  ...
  extension [Self <: TsIntersectionType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsIntersectionType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
