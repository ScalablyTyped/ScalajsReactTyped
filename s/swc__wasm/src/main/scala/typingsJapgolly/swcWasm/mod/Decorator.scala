...
trait Decorator
  ...
  @JSName("type")
  var type_Decorator: typingsJapgolly.swcWasm.swcWasmStrings.Decorator
}
object Decorator {
  ...
  extension [Self <: Decorator](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.Decorator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
