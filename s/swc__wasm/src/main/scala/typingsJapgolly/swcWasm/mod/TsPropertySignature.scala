...
trait TsPropertySignature
  ...
  @JSName("type")
  var type_TsPropertySignature: typingsJapgolly.swcWasm.swcWasmStrings.TsPropertySignature
}
object TsPropertySignature {
  ...
  extension [Self <: TsPropertySignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsPropertySignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
