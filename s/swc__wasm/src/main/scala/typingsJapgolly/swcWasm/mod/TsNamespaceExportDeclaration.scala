...
trait TsNamespaceExportDeclaration
  ...
  @JSName("type")
  var type_TsNamespaceExportDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.TsNamespaceExportDeclaration
}
object TsNamespaceExportDeclaration {
  ...
  extension [Self <: TsNamespaceExportDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsNamespaceExportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
