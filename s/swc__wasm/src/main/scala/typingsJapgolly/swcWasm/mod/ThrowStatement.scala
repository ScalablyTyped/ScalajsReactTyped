...
trait ThrowStatement
  ...
  @JSName("type")
  var type_ThrowStatement: typingsJapgolly.swcWasm.swcWasmStrings.ThrowStatement
}
object ThrowStatement {
  ...
  extension [Self <: ThrowStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ThrowStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
