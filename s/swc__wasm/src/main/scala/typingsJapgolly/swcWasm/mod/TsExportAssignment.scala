...
trait TsExportAssignment
  ...
  @JSName("type")
  var type_TsExportAssignment: typingsJapgolly.swcWasm.swcWasmStrings.TsExportAssignment
}
object TsExportAssignment {
  ...
  extension [Self <: TsExportAssignment](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsExportAssignment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
