...
trait TsModuleBlock
  ...
  @JSName("type")
  var type_TsModuleBlock: typingsJapgolly.swcWasm.swcWasmStrings.TsModuleBlock
}
object TsModuleBlock {
  ...
  extension [Self <: TsModuleBlock](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsModuleBlock): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
