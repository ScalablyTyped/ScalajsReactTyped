...
trait SetterProperty
  ...
  @JSName("type")
  var type_SetterProperty: typingsJapgolly.swcWasm.swcWasmStrings.SetterProperty
}
object SetterProperty {
  ...
  extension [Self <: SetterProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.SetterProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
