...
trait TsAsExpression
  ...
  @JSName("type")
  var type_TsAsExpression: typingsJapgolly.swcWasm.swcWasmStrings.TsAsExpression
}
object TsAsExpression {
  ...
  extension [Self <: TsAsExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsAsExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
