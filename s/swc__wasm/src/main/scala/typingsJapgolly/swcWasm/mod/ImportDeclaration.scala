...
trait ImportDeclaration
  ...
  @JSName("type")
  var type_ImportDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.ImportDeclaration
}
object ImportDeclaration {
  ...
  extension [Self <: ImportDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ImportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
