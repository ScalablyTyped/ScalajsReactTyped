...
trait ExportDefaultDeclaration
  ...
  @JSName("type")
  var type_ExportDefaultDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.ExportDefaultDeclaration
}
object ExportDefaultDeclaration {
  ...
  extension [Self <: ExportDefaultDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ExportDefaultDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
