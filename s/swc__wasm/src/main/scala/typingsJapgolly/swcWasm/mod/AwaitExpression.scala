...
trait AwaitExpression
  ...
  @JSName("type")
  var type_AwaitExpression: typingsJapgolly.swcWasm.swcWasmStrings.AwaitExpression
}
object AwaitExpression {
  ...
  extension [Self <: AwaitExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.AwaitExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
