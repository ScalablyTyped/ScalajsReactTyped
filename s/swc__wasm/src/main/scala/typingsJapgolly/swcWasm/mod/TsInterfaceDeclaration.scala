...
trait TsInterfaceDeclaration
  ...
  @JSName("type")
  var type_TsInterfaceDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.TsInterfaceDeclaration
}
object TsInterfaceDeclaration {
  ...
  extension [Self <: TsInterfaceDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsInterfaceDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
