...
trait ExportNamespaceSpecifier
  ...
  @JSName("type")
  var type_ExportNamespaceSpecifier: typingsJapgolly.swcWasm.swcWasmStrings.ExportNamespaceSpecifier
}
object ExportNamespaceSpecifier {
  ...
  extension [Self <: ExportNamespaceSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ExportNamespaceSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
