...
import typingsJapgolly.swcWasm.swcWasmBooleans.`false`
import typingsJapgolly.swcWasm.swcWasmStrings.all
import typingsJapgolly.swcWasm.swcWasmStrings.some
