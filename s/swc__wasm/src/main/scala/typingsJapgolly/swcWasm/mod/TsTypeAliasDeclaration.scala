...
trait TsTypeAliasDeclaration
  ...
  @JSName("type")
  var type_TsTypeAliasDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.TsTypeAliasDeclaration
}
object TsTypeAliasDeclaration {
  ...
  extension [Self <: TsTypeAliasDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsTypeAliasDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
