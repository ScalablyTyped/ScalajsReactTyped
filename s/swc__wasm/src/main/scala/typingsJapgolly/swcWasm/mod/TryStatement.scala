...
trait TryStatement
  ...
  @JSName("type")
  var type_TryStatement: typingsJapgolly.swcWasm.swcWasmStrings.TryStatement
}
object TryStatement {
  ...
  extension [Self <: TryStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TryStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
