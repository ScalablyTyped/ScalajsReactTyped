...
trait OptionalChainingCall
  ...
  @JSName("type")
  var type_OptionalChainingCall: typingsJapgolly.swcWasm.swcWasmStrings.CallExpression
}
object OptionalChainingCall {
  ...
  extension [Self <: OptionalChainingCall](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.CallExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
