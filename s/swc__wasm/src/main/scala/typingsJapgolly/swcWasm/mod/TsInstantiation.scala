...
trait TsInstantiation
  ...
  @JSName("type")
  var type_TsInstantiation: typingsJapgolly.swcWasm.swcWasmStrings.TsInstantiation
}
object TsInstantiation {
  ...
  extension [Self <: TsInstantiation](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsInstantiation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
