...
trait TsParenthesizedType
  ...
  @JSName("type")
  var type_TsParenthesizedType: typingsJapgolly.swcWasm.swcWasmStrings.TsParenthesizedType
}
object TsParenthesizedType {
  ...
  extension [Self <: TsParenthesizedType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsParenthesizedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
