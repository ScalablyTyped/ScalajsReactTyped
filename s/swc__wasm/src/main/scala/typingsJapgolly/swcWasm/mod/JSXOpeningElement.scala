...
trait JSXOpeningElement
  ...
  @JSName("type")
  var type_JSXOpeningElement: typingsJapgolly.swcWasm.swcWasmStrings.JSXOpeningElement
}
object JSXOpeningElement {
  ...
  extension [Self <: JSXOpeningElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXOpeningElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
