...
trait FunctionDeclaration
  ...
  var `type`: typingsJapgolly.swcWasm.swcWasmStrings.FunctionDeclaration
}
object FunctionDeclaration {
  ...
  extension [Self <: FunctionDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.FunctionDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
