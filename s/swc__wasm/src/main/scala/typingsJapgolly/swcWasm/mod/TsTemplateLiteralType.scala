...
trait TsTemplateLiteralType
  ...
  @JSName("type")
  var type_TsTemplateLiteralType: typingsJapgolly.swcWasm.swcWasmStrings.TemplateLiteral
...
object TsTemplateLiteralType {
  ...
  extension [Self <: TsTemplateLiteralType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TemplateLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
