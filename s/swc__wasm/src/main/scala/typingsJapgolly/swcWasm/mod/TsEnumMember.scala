...
trait TsEnumMember
  ...
  @JSName("type")
  var type_TsEnumMember: typingsJapgolly.swcWasm.swcWasmStrings.TsEnumMember
}
object TsEnumMember {
  ...
  extension [Self <: TsEnumMember](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsEnumMember): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
