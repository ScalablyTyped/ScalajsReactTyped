...
trait JSXMemberExpression
  ...
  @JSName("type")
  var type_JSXMemberExpression: typingsJapgolly.swcWasm.swcWasmStrings.JSXMemberExpression
}
object JSXMemberExpression {
  ...
  extension [Self <: JSXMemberExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXMemberExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
