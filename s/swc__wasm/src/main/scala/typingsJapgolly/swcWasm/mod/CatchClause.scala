...
trait CatchClause
  ...
  @JSName("type")
  var type_CatchClause: typingsJapgolly.swcWasm.swcWasmStrings.CatchClause
}
object CatchClause {
  ...
  extension [Self <: CatchClause](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.CatchClause): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
