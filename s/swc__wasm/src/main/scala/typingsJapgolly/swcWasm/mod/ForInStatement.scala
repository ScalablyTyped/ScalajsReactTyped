...
trait ForInStatement
  ...
  @JSName("type")
  var type_ForInStatement: typingsJapgolly.swcWasm.swcWasmStrings.ForInStatement
}
object ForInStatement {
  ...
  extension [Self <: ForInStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ForInStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
