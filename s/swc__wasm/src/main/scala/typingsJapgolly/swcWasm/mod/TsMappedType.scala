...
trait TsMappedType
  ...
  @JSName("type")
  var type_TsMappedType: typingsJapgolly.swcWasm.swcWasmStrings.TsMappedType
}
object TsMappedType {
  ...
  extension [Self <: TsMappedType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsMappedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
