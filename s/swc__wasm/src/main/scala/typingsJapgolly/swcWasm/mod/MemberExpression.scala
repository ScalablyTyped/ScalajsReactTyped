...
trait MemberExpression
  ...
  @JSName("type")
  var type_MemberExpression: typingsJapgolly.swcWasm.swcWasmStrings.MemberExpression
}
object MemberExpression {
  ...
  extension [Self <: MemberExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.MemberExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
