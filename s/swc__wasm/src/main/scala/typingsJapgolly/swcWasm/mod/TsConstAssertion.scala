...
trait TsConstAssertion
  ...
  @JSName("type")
  var type_TsConstAssertion: typingsJapgolly.swcWasm.swcWasmStrings.TsConstAssertion
}
object TsConstAssertion {
  ...
  extension [Self <: TsConstAssertion](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsConstAssertion): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
