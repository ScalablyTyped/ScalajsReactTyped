...
trait Module
  ...
  @JSName("type")
  var type_Module: typingsJapgolly.swcWasm.swcWasmStrings.Module
}
object Module {
  ...
  extension [Self <: Module](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.Module): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
