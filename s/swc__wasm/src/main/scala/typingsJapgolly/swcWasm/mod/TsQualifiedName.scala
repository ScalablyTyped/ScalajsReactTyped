...
trait TsQualifiedName
  ...
  @JSName("type")
  var type_TsQualifiedName: typingsJapgolly.swcWasm.swcWasmStrings.TsQualifiedName
}
object TsQualifiedName {
  ...
  extension [Self <: TsQualifiedName](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsQualifiedName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
