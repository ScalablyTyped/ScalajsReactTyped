...
trait TsRestType
  ...
  @JSName("type")
  var type_TsRestType: typingsJapgolly.swcWasm.swcWasmStrings.TsRestType
}
object TsRestType {
  ...
  extension [Self <: TsRestType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsRestType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
