...
trait BreakStatement
  ...
  @JSName("type")
  var type_BreakStatement: typingsJapgolly.swcWasm.swcWasmStrings.BreakStatement
}
object BreakStatement {
  ...
  extension [Self <: BreakStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.BreakStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
