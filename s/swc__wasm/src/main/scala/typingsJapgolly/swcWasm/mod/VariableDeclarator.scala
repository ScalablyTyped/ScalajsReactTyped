...
trait VariableDeclarator
  ...
  @JSName("type")
  var type_VariableDeclarator: typingsJapgolly.swcWasm.swcWasmStrings.VariableDeclarator
}
object VariableDeclarator {
  ...
  extension [Self <: VariableDeclarator](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.VariableDeclarator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
