...
trait UpdateExpression
  ...
  @JSName("type")
  var type_UpdateExpression: typingsJapgolly.swcWasm.swcWasmStrings.UpdateExpression
}
object UpdateExpression {
  ...
  extension [Self <: UpdateExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.UpdateExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
