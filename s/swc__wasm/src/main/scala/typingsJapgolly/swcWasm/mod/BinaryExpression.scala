...
trait BinaryExpression
  ...
  @JSName("type")
  var type_BinaryExpression: typingsJapgolly.swcWasm.swcWasmStrings.BinaryExpression
}
object BinaryExpression {
  ...
  extension [Self <: BinaryExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.BinaryExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
