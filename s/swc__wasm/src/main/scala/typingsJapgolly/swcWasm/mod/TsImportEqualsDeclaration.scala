...
trait TsImportEqualsDeclaration
  ...
  @JSName("type")
  var type_TsImportEqualsDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.TsImportEqualsDeclaration
}
object TsImportEqualsDeclaration {
  ...
  extension [Self <: TsImportEqualsDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsImportEqualsDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
