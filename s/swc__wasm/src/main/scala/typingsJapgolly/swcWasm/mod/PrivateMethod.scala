...
trait PrivateMethod
  ...
  @JSName("type")
  var type_PrivateMethod: typingsJapgolly.swcWasm.swcWasmStrings.PrivateMethod
}
object PrivateMethod {
  ...
  extension [Self <: PrivateMethod](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.PrivateMethod): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
