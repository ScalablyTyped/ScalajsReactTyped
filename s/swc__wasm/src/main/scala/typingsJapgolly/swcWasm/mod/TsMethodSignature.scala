...
trait TsMethodSignature
  ...
  @JSName("type")
  var type_TsMethodSignature: typingsJapgolly.swcWasm.swcWasmStrings.TsMethodSignature
}
object TsMethodSignature {
  ...
  extension [Self <: TsMethodSignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsMethodSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
