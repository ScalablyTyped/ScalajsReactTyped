...
trait WhileStatement
  ...
  @JSName("type")
  var type_WhileStatement: typingsJapgolly.swcWasm.swcWasmStrings.WhileStatement
}
object WhileStatement {
  ...
  extension [Self <: WhileStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.WhileStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
