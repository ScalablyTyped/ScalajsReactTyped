...
trait TsModuleDeclaration
  ...
  @JSName("type")
  var type_TsModuleDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.TsModuleDeclaration
}
object TsModuleDeclaration {
  ...
  extension [Self <: TsModuleDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsModuleDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
