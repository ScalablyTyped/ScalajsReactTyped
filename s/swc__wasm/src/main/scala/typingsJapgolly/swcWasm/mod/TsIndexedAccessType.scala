...
trait TsIndexedAccessType
  ...
  @JSName("type")
  var type_TsIndexedAccessType: typingsJapgolly.swcWasm.swcWasmStrings.TsIndexedAccessType
}
object TsIndexedAccessType {
  ...
  extension [Self <: TsIndexedAccessType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsIndexedAccessType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
