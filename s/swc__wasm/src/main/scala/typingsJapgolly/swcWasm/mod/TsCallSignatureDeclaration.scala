...
trait TsCallSignatureDeclaration
  ...
  @JSName("type")
  var type_TsCallSignatureDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.TsCallSignatureDeclaration
}
object TsCallSignatureDeclaration {
  ...
  extension [Self <: TsCallSignatureDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsCallSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
