...
trait ImportNamespaceSpecifier
  ...
  @JSName("type")
  var type_ImportNamespaceSpecifier: typingsJapgolly.swcWasm.swcWasmStrings.ImportNamespaceSpecifier
}
object ImportNamespaceSpecifier {
  ...
  extension [Self <: ImportNamespaceSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ImportNamespaceSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
