...
trait ForStatement
  ...
  @JSName("type")
  var type_ForStatement: typingsJapgolly.swcWasm.swcWasmStrings.ForStatement
...
object ForStatement {
  ...
  extension [Self <: ForStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ForStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
