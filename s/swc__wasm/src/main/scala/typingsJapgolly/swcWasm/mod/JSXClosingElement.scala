...
trait JSXClosingElement
  ...
  @JSName("type")
  var type_JSXClosingElement: typingsJapgolly.swcWasm.swcWasmStrings.JSXClosingElement
}
object JSXClosingElement {
  ...
  extension [Self <: JSXClosingElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXClosingElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
