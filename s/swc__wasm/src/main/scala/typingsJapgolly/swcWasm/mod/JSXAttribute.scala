...
trait JSXAttribute
  ...
  @JSName("type")
  var type_JSXAttribute: typingsJapgolly.swcWasm.swcWasmStrings.JSXAttribute
...
object JSXAttribute {
  ...
  extension [Self <: JSXAttribute](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXAttribute): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
