...
trait TsImportType
  ...
  @JSName("type")
  var type_TsImportType: typingsJapgolly.swcWasm.swcWasmStrings.TsImportType
}
object TsImportType {
  ...
  extension [Self <: TsImportType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsImportType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
