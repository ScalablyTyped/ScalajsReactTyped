...
trait AssignmentProperty
  ...
  @JSName("type")
  var type_AssignmentProperty: typingsJapgolly.swcWasm.swcWasmStrings.AssignmentProperty
...
object AssignmentProperty {
  ...
  extension [Self <: AssignmentProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.AssignmentProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
