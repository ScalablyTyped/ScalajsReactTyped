...
trait ImportDefaultSpecifier
  ...
  @JSName("type")
  var type_ImportDefaultSpecifier: typingsJapgolly.swcWasm.swcWasmStrings.ImportDefaultSpecifier
}
object ImportDefaultSpecifier {
  ...
  extension [Self <: ImportDefaultSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ImportDefaultSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
