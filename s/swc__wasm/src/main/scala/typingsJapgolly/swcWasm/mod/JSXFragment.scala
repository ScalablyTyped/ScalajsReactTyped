...
trait JSXFragment
  ...
  @JSName("type")
  var type_JSXFragment: typingsJapgolly.swcWasm.swcWasmStrings.JSXFragment
}
object JSXFragment {
  ...
  extension [Self <: JSXFragment](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXFragment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
