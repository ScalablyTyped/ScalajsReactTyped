...
trait TsTypeOperator
  ...
  @JSName("type")
  var type_TsTypeOperator: typingsJapgolly.swcWasm.swcWasmStrings.TsTypeOperator
}
object TsTypeOperator {
  ...
  extension [Self <: TsTypeOperator](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsTypeOperator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
