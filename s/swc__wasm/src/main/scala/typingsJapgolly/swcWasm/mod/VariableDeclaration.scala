...
trait VariableDeclaration
  ...
  @JSName("type")
  var type_VariableDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.VariableDeclaration
}
object VariableDeclaration {
  ...
  extension [Self <: VariableDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.VariableDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
