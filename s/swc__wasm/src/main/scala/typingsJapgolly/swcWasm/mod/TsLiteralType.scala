...
trait TsLiteralType
  ...
  @JSName("type")
  var type_TsLiteralType: typingsJapgolly.swcWasm.swcWasmStrings.TsLiteralType
}
object TsLiteralType {
  ...
  extension [Self <: TsLiteralType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsLiteralType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
