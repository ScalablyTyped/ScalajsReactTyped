...
trait TsTupleElement
  ...
  @JSName("type")
  var type_TsTupleElement: typingsJapgolly.swcWasm.swcWasmStrings.TsTupleElement
}
object TsTupleElement {
  ...
  extension [Self <: TsTupleElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsTupleElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
