...
trait JSXElement
  ...
  @JSName("type")
  var type_JSXElement: typingsJapgolly.swcWasm.swcWasmStrings.JSXElement
}
object JSXElement {
  ...
  extension [Self <: JSXElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
