...
trait TsIndexSignature
  ...
  @JSName("type")
  var type_TsIndexSignature: typingsJapgolly.swcWasm.swcWasmStrings.TsIndexSignature
}
object TsIndexSignature {
  ...
  extension [Self <: TsIndexSignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsIndexSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
