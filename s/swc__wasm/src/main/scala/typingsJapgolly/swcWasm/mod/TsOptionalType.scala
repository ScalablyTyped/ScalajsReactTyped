...
trait TsOptionalType
  ...
  @JSName("type")
  var type_TsOptionalType: typingsJapgolly.swcWasm.swcWasmStrings.TsOptionalType
}
object TsOptionalType {
  ...
  extension [Self <: TsOptionalType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsOptionalType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
