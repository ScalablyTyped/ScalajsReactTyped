...
trait MetaProperty
  ...
  @JSName("type")
  var type_MetaProperty: typingsJapgolly.swcWasm.swcWasmStrings.MetaProperty
}
object MetaProperty {
  ...
  extension [Self <: MetaProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.MetaProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
