...
- typingsJapgolly.swcWasm.mod.ExpressionBase because var conflicts: span. Inlined  */ trait FunctionExpression
  extends StObject
     with Fn
     with DefaultDecl
     with Expression
  ...
  @JSName("type")
  var type_FunctionExpression: typingsJapgolly.swcWasm.swcWasmStrings.FunctionExpression
}
object FunctionExpression {
  ...
  extension [Self <: FunctionExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.FunctionExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
