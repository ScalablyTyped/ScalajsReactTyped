...
trait NamedImportSpecifier
  ...
  @JSName("type")
  var type_NamedImportSpecifier: typingsJapgolly.swcWasm.swcWasmStrings.ImportSpecifier
}
object NamedImportSpecifier {
  ...
  extension [Self <: NamedImportSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ImportSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
