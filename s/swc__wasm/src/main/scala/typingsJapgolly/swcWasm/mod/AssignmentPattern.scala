...
trait AssignmentPattern
  ...
  @JSName("type")
  var type_AssignmentPattern: typingsJapgolly.swcWasm.swcWasmStrings.AssignmentPattern
}
object AssignmentPattern {
  ...
  extension [Self <: AssignmentPattern](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.AssignmentPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
