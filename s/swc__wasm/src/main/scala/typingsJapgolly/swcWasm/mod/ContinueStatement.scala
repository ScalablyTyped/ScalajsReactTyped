...
trait ContinueStatement
  ...
  @JSName("type")
  var type_ContinueStatement: typingsJapgolly.swcWasm.swcWasmStrings.ContinueStatement
}
object ContinueStatement {
  ...
  extension [Self <: ContinueStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ContinueStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
