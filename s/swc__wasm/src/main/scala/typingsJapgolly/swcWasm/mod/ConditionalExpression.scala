...
trait ConditionalExpression
  ...
  @JSName("type")
  var type_ConditionalExpression: typingsJapgolly.swcWasm.swcWasmStrings.ConditionalExpression
}
object ConditionalExpression {
  ...
  extension [Self <: ConditionalExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ConditionalExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
