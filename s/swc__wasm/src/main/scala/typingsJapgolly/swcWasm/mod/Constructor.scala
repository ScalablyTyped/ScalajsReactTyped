...
trait Constructor
  ...
  @JSName("type")
  var type_Constructor: typingsJapgolly.swcWasm.swcWasmStrings.Constructor
}
object Constructor {
  ...
  extension [Self <: Constructor](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.Constructor): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
