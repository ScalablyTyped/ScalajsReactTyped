...
trait AssignmentPatternProperty
  ...
  @JSName("type")
  var type_AssignmentPatternProperty: typingsJapgolly.swcWasm.swcWasmStrings.AssignmentPatternProperty
...
object AssignmentPatternProperty {
  ...
  extension [Self <: AssignmentPatternProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.AssignmentPatternProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
