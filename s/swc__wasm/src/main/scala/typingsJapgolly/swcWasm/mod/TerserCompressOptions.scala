...
import typingsJapgolly.swcWasm.swcWasmInts.`0`
import typingsJapgolly.swcWasm.swcWasmInts.`1`
import typingsJapgolly.swcWasm.swcWasmInts.`2`
import typingsJapgolly.swcWasm.swcWasmInts.`3`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait TerserCompressOptions extends StObject {
  ...
  var global_defs: js.UndefOr[Any] = js.undefined
  ...
  var `inline`: js.UndefOr[`0` | `1` | `2` | `3`] = js.undefined
  ...
  var unsafe_passes: js.UndefOr[Boolean] = js.undefined
...
object TerserCompressOptions {
  
  inline def apply(): TerserCompressOptions = {
  ...
  extension [Self <: TerserCompressOptions](x: Self) {
    ...
    inline def setGlobal_defs(value: Any): Self = StObject.set(x, "global_defs", value.asInstanceOf[js.Any])
    ...
    inline def setInline(value: `0` | `1` | `2` | `3`): Self = StObject.set(x, "inline", value.asInstanceOf[js.Any])
    ...
    inline def setPure_getters(value: Any): Self = StObject.set(x, "pure_getters", value.asInstanceOf[js.Any])
    ...
    inline def setSequences(value: Any): Self = StObject.set(x, "sequences", value.asInstanceOf[js.Any])
    ...
    inline def setTop_retain(value: Any): Self = StObject.set(x, "top_retain", value.asInstanceOf[js.Any])
    
    inline def setTop_retainUndefined: Self = StObject.set(x, "top_retain", js.undefined)
    
    inline def setToplevel(value: Any): Self = StObject.set(x, "toplevel", value.asInstanceOf[js.Any])
    ...
    inline def setUnsafe_passes(value: Boolean): Self = StObject.set(x, "unsafe_passes", value.asInstanceOf[js.Any])
    
    inline def setUnsafe_passesUndefined: Self = StObject.set(x, "unsafe_passes", js.undefined)
