...
trait TsTypePredicate
  ...
  @JSName("type")
  var type_TsTypePredicate: typingsJapgolly.swcWasm.swcWasmStrings.TsTypePredicate
}
object TsTypePredicate {
  ...
  extension [Self <: TsTypePredicate](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsTypePredicate): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
