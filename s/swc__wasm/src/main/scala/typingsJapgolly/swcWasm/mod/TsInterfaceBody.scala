...
trait TsInterfaceBody
  ...
  @JSName("type")
  var type_TsInterfaceBody: typingsJapgolly.swcWasm.swcWasmStrings.TsInterfaceBody
}
object TsInterfaceBody {
  ...
  extension [Self <: TsInterfaceBody](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsInterfaceBody): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
