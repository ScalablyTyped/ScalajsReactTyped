...
trait JSXExpressionContainer
  ...
  @JSName("type")
  var type_JSXExpressionContainer: typingsJapgolly.swcWasm.swcWasmStrings.JSXExpressionContainer
}
object JSXExpressionContainer {
  ...
  extension [Self <: JSXExpressionContainer](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.JSXExpressionContainer): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
