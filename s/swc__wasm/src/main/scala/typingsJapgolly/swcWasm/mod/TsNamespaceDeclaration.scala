...
trait TsNamespaceDeclaration
  ...
  @JSName("type")
  var type_TsNamespaceDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.TsNamespaceDeclaration
}
object TsNamespaceDeclaration {
  ...
  extension [Self <: TsNamespaceDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsNamespaceDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
