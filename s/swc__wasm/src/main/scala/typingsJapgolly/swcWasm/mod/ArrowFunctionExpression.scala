...
trait ArrowFunctionExpression
  ...
  @JSName("type")
  var type_ArrowFunctionExpression: typingsJapgolly.swcWasm.swcWasmStrings.ArrowFunctionExpression
}
object ArrowFunctionExpression {
  ...
  extension [Self <: ArrowFunctionExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ArrowFunctionExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
