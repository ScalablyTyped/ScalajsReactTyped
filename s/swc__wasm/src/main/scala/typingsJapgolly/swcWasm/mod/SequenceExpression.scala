...
trait SequenceExpression
  ...
  @JSName("type")
  var type_SequenceExpression: typingsJapgolly.swcWasm.swcWasmStrings.SequenceExpression
}
object SequenceExpression {
  ...
  extension [Self <: SequenceExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.SequenceExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
