...
trait TsTypeParameter
  ...
  @JSName("type")
  var type_TsTypeParameter: typingsJapgolly.swcWasm.swcWasmStrings.TsTypeParameter
}
object TsTypeParameter {
  ...
  extension [Self <: TsTypeParameter](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.TsTypeParameter): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
