...
trait PrivateProperty
  ...
  @JSName("type")
  var type_PrivateProperty: typingsJapgolly.swcWasm.swcWasmStrings.PrivateProperty
}
object PrivateProperty {
  ...
  extension [Self <: PrivateProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.PrivateProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
