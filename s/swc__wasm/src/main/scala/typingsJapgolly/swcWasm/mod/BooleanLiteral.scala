...
trait BooleanLiteral
  ...
  @JSName("type")
  var type_BooleanLiteral: typingsJapgolly.swcWasm.swcWasmStrings.BooleanLiteral
...
object BooleanLiteral {
  ...
  extension [Self <: BooleanLiteral](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.BooleanLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
