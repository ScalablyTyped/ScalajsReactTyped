...
trait ExportDeclaration
  ...
  @JSName("type")
  var type_ExportDeclaration: typingsJapgolly.swcWasm.swcWasmStrings.ExportDeclaration
}
object ExportDeclaration {
  ...
  extension [Self <: ExportDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcWasm.swcWasmStrings.ExportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
