...
object mod {
  ...
  */
  ...
  object SyntaxFeatureOption {
    ...
    inline def check: typingsJapgolly.styleSearch.styleSearchStrings.check = "check".asInstanceOf[typingsJapgolly.styleSearch.styleSearchStrings.check]
    
    inline def only: typingsJapgolly.styleSearch.styleSearchStrings.only = "only".asInstanceOf[typingsJapgolly.styleSearch.styleSearchStrings.only]
    
    inline def skip: typingsJapgolly.styleSearch.styleSearchStrings.skip = "skip".asInstanceOf[typingsJapgolly.styleSearch.styleSearchStrings.skip]
  }
}
