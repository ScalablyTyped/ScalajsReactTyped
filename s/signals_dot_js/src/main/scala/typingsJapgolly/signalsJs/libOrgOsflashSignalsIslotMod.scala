...
object libOrgOsflashSignalsIslotMod {
  ...
  object ISlot {
    ...
    extension [Self <: ISlot](x: Self) {
      ...
      inline def setExecute0(value: Callback): Self = StObject.set(x, "execute0", value.toJsFn)
      
      inline def setExecute1(value: js.Object => Callback): Self = StObject.set(x, "execute1", js.Any.fromFunction1((t0: js.Object) => value(t0).runNow()))
