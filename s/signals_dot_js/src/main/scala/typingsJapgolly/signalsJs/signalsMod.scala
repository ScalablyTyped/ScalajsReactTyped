...
import typingsJapgolly.signalsJs.libOrgOsflashSignalsIoncesignalMod.IOnceSignal
...
object signalsMod {
  ...
  open class DeluxeSignal protected ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsDeluxeSignalMod.DeluxeSignal {
    /**
  ...
  open class GenericEvent ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsEventsGenericEventMod.GenericEvent {
  ...
  open class MonoSignal protected ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsMonoSignalMod.MonoSignal {
    /**
  ...
  open class OnceSignal protected ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsOnceSignalMod.OnceSignal {
    /**
  ...
  open class PrioritySignal protected ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsPrioritySignalMod.PrioritySignal {
    def this(valueClasses: Any*) = this()
  }
  ...
  open class Promise protected ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsPromiseMod.Promise {
    /**
      * Creates a Signal instance to dispatch value objects.
      * @param    valueClasses Any number of class references that enable type checks in dispatch().
      * For example, new Signal(String, uint)
  ...
  open class Signal protected ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsSignalMod.Signal {
    /**
      * Creates a Signal instance to dispatch value objects.
      * @param    valueClasses Any number of class references that enable type checks in dispatch().
      * For example, new Signal(String, uint)
  ...
  open class Slot protected ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsSlotMod.Slot {
    /**
  ...
  open class SlotList protected ()
    extends typingsJapgolly.signalsJs.libOrgOsflashSignalsSlotListMod.SlotList {
    /**
    ...
    def this(head: ISlot, tail: typingsJapgolly.signalsJs.libOrgOsflashSignalsSlotListMod.SlotList) = this()
  }
  /* static members */
  object SlotList {
    ...
    @js.native
    def NIL: typingsJapgolly.signalsJs.libOrgOsflashSignalsSlotListMod.SlotList = js.native
    inline def NIL_=(x: typingsJapgolly.signalsJs.libOrgOsflashSignalsSlotListMod.SlotList): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NIL")(x.asInstanceOf[js.Any])
  }
}
