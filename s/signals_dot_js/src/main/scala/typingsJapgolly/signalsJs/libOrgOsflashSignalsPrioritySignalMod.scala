...
import typingsJapgolly.signalsJs.libOrgOsflashSignalsSignalMod.Signal
...
object libOrgOsflashSignalsPrioritySignalMod {
  ...
  - typingsJapgolly.signalsJs.libOrgOsflashSignalsIsignalMod.ISignal because Already inherited
  - typingsJapgolly.signalsJs.libOrgOsflashSignalsIprioritysignalMod.IPrioritySignal because var conflicts: numListeners, valueClasses. Inlined addWithPriority, addOnceWithPriority */ @JSImport("signals.js/lib/org/osflash/signals/PrioritySignal", "PrioritySignal")
  @js.native
