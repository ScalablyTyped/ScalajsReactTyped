...
object libTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.styleValueTypes.libTypesMod.HSLA
    - typingsJapgolly.styleValueTypes.libTypesMod.RGBA
  */
  trait Color extends StObject
  object Color {
    
    inline def HSLA(hue: Double, lightness: Double, saturation: Double): typingsJapgolly.styleValueTypes.libTypesMod.HSLA = {
      ...
      __obj.asInstanceOf[typingsJapgolly.styleValueTypes.libTypesMod.HSLA]
    }
    
    inline def RGBA(blue: Double, green: Double, red: Double): typingsJapgolly.styleValueTypes.libTypesMod.RGBA = {
      val __obj = js.Dynamic.literal(blue = blue.asInstanceOf[js.Any], green = green.asInstanceOf[js.Any], red = red.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.styleValueTypes.libTypesMod.RGBA]
    }
  }
