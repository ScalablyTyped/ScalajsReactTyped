...
import typingsJapgolly.sketchHqSketchFileFormatTs.sketchHqSketchFileFormatTsStrings.oval
...
object Oval {
  ...
  extension [Self <: Oval](x: Self) {
    ...
    inline def set_class(value: oval): Self = StObject.set(x, "_class", value.asInstanceOf[js.Any])
  }
}
