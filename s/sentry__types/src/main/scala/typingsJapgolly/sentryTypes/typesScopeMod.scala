...
import typingsJapgolly.sentryTypes.typesContextMod.Context
...
object typesScopeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sentryTypes.typesScopeMod.Scope
    - typingsJapgolly.sentryTypes.anon.PartialScopeContext
    - js.Function1[
  / * scope * / typingsJapgolly.sentryTypes.typesScopeMod.Scope, 
  typingsJapgolly.sentryTypes.typesScopeMod.Scope]
  */
