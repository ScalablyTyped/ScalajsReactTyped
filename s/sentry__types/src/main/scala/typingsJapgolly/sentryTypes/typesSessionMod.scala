...
import typingsJapgolly.sentryTypes.anon.Environment
import typingsJapgolly.sentryTypes.anon.Release
...
object typesSessionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sentryTypes.sentryTypesStrings.ok
    - typingsJapgolly.sentryTypes.sentryTypesStrings.errored
    - typingsJapgolly.sentryTypes.sentryTypesStrings.crashed
  */
  trait RequestSessionStatus extends StObject
  object RequestSessionStatus {
    
    inline def crashed: typingsJapgolly.sentryTypes.sentryTypesStrings.crashed = "crashed".asInstanceOf[typingsJapgolly.sentryTypes.sentryTypesStrings.crashed]
    
    inline def errored: typingsJapgolly.sentryTypes.sentryTypesStrings.errored = "errored".asInstanceOf[typingsJapgolly.sentryTypes.sentryTypesStrings.errored]
    
    inline def ok: typingsJapgolly.sentryTypes.sentryTypesStrings.ok = "ok".asInstanceOf[typingsJapgolly.sentryTypes.sentryTypesStrings.ok]
  }
  ...
  object Session {
    ...
    extension [Self <: Session](x: Self) {
      ...
      inline def setToJSON(value: CallbackTo[SerializedSession]): Self = StObject.set(x, "toJSON", value.toJsFn)
  ...
  object SessionFlusherLike {
    ...
    inline def apply(close: Callback, flush: Callback, incrementSessionStatusCount: Callback): SessionFlusherLike = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, flush = flush.toJsFn, incrementSessionStatusCount = incrementSessionStatusCount.toJsFn)
    ...
    extension [Self <: SessionFlusherLike](x: Self) {
      ...
      inline def setIncrementSessionStatusCount(value: Callback): Self = StObject.set(x, "incrementSessionStatusCount", value.toJsFn)
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sentryTypes.sentryTypesStrings.ok
    - typingsJapgolly.sentryTypes.sentryTypesStrings.exited
    - typingsJapgolly.sentryTypes.sentryTypesStrings.crashed
    - typingsJapgolly.sentryTypes.sentryTypesStrings.abnormal
  */
  trait SessionStatus extends StObject
  object SessionStatus {
    
    inline def abnormal: typingsJapgolly.sentryTypes.sentryTypesStrings.abnormal = "abnormal".asInstanceOf[typingsJapgolly.sentryTypes.sentryTypesStrings.abnormal]
    
    inline def crashed: typingsJapgolly.sentryTypes.sentryTypesStrings.crashed = "crashed".asInstanceOf[typingsJapgolly.sentryTypes.sentryTypesStrings.crashed]
    
    inline def exited: typingsJapgolly.sentryTypes.sentryTypesStrings.exited = "exited".asInstanceOf[typingsJapgolly.sentryTypes.sentryTypesStrings.exited]
