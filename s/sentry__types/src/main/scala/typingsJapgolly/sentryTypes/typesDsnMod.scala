...
object typesDsnMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sentryTypes.sentryTypesStrings.http
    - typingsJapgolly.sentryTypes.sentryTypesStrings.https
  */
  trait DsnProtocol extends StObject
  object DsnProtocol {
    
    inline def http: typingsJapgolly.sentryTypes.sentryTypesStrings.http = "http".asInstanceOf[typingsJapgolly.sentryTypes.sentryTypesStrings.http]
    
    inline def https: typingsJapgolly.sentryTypes.sentryTypesStrings.https = "https".asInstanceOf[typingsJapgolly.sentryTypes.sentryTypesStrings.https]
  }
}
