...
import typingsJapgolly.sentryTypes.anon.Encrypted
import typingsJapgolly.sentryTypes.anon.Path
...
object typesPolymorphicsMod {
  ...
  - typingsJapgolly.sentryTypes.typesPolymorphicsMod.BaseRequest because Already inherited
  - typingsJapgolly.sentryTypes.typesPolymorphicsMod.NodeRequest because Already inherited
  - typingsJapgolly.sentryTypes.typesPolymorphicsMod.NextjsRequest because var conflicts: headers, method, protocol, query, socket, url. Inlined cookies
  - typingsJapgolly.sentryTypes.typesPolymorphicsMod.KoaRequest because var conflicts: headers, host, hostname, ip, method, originalUrl, protocol, socket, url. Inlined  */ trait PolymorphicRequest
    extends StObject
       with ExpressRequest {
