...
object global {
  ...
  object Architect {
    ...
    open class Hopfield protected ()
      extends typingsJapgolly.synaptic.mod.Architect.Hopfield {
      /**
        * The Hopfield architecture serves as content-addressable memory. They are trained to remember patterns and then when feeding new patterns to the network it returns the most similar one from the patterns it was trained to remember.
    ...
    open class LSTM protected ()
      extends typingsJapgolly.synaptic.mod.Architect.LSTM {
      /**
        * The long short-term memory is an architecture well-suited to learn from experience to classify, process and predict time series when there are very long time lags of unknown size between important events.
    ...
    open class Liquid protected ()
      extends typingsJapgolly.synaptic.mod.Architect.Liquid {
      /**
        * The Liquid architecture allows you to create Liquid State Machines. In these networks, neurons are randomly connected to each other. The recurrent nature of the connections turns the time varying input into a spatio-temporal pattern of activations in the network nodes.
    ...
    open class Perceptron protected ()
      extends typingsJapgolly.synaptic.mod.Architect.Perceptron {
      /**
        * This architecture allows you to create multilayer perceptrons, also known as feed-forward neural networks. They consist of a sequence of layers, each fully connected to the next one.
  ...
  open class Layer protected ()
    extends typingsJapgolly.synaptic.mod.Layer {
    /**
  ...
  object Layer {
    ...
    open class LayerConnection ()
      extends typingsJapgolly.synaptic.mod.Layer.LayerConnection
    ...
    object connectionType extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.synaptic.mod.Layer.connectionType & Double] = js.native
      
      /* 0 */ val ALL_TO_ALL: typingsJapgolly.synaptic.mod.Layer.connectionType.ALL_TO_ALL & Double = js.native
      
      /* 2 */ val ALL_TO_ELSE: typingsJapgolly.synaptic.mod.Layer.connectionType.ALL_TO_ELSE & Double = js.native
      
      /* 1 */ val ONE_TO_ONE: typingsJapgolly.synaptic.mod.Layer.connectionType.ONE_TO_ONE & Double = js.native
    }
    ...
    object gateType extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.synaptic.mod.Layer.gateType & Double] = js.native
      
      /* 0 */ val INPUT: typingsJapgolly.synaptic.mod.Layer.gateType.INPUT & Double = js.native
      
      /* 2 */ val ONE_TO_ONE: typingsJapgolly.synaptic.mod.Layer.gateType.ONE_TO_ONE & Double = js.native
      
      /* 1 */ val OUTPUT: typingsJapgolly.synaptic.mod.Layer.gateType.OUTPUT & Double = js.native
    }
  }
