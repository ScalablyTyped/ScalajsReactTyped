...
object Architect extends js.Object {
  ...
  object Hopfield
    extends TopLevel[
          Instantiable1[/* patternSize */ Double, typingsJapgolly.synaptic.mod.Architect.Hopfield]
        ]
  ...
  object LSTM
    extends TopLevel[
          Instantiable1[
            ...
            typingsJapgolly.synaptic.mod.Architect.LSTM
          ]
        ]
  ...
  object Liquid
    extends TopLevel[
          Instantiable5[
            ...
            /* connections */ Double, 
            /* gates */ Double, 
            typingsJapgolly.synaptic.mod.Architect.Liquid
          ]
        ]
  ...
  object Perceptron
    extends TopLevel[
          Instantiable1[
            /* numberOfNeurons (repeated) */ Double, 
            typingsJapgolly.synaptic.mod.Architect.Perceptron
          ]
        ]
