...
import typingsJapgolly.stompit.anon.Abort
import typingsJapgolly.stompit.libConnectFailoverGetAddressInfoMod.AddressInfo
  ...
  trait ConnectFailoverOptions extends StObject {
    ...
    var connectFunction: js.UndefOr[
        js.Function2[
          ...
          typingsJapgolly.stompit.libClientMod.^
        ]
      ] = js.undefined
  ...
  object ConnectFailoverOptions {
    ...
    extension [Self <: ConnectFailoverOptions](x: Self) {
      ...
      inline def setConnectFunction(
        value: (/* options */ ConnectOptions, /* connectionListener */ js.UndefOr[ConnectionListener]) => typingsJapgolly.stompit.libClientMod.^
