...
object buildDatabaseMod {
  ...
  @js.native
  open class Database[Driver /* <: typingsJapgolly.sqlite.sqlite3Mod.Database */, Stmt /* <: Statement */] protected () extends StObject {
    ...
    /**
      ...
      */
    def prepare(sql: SqlType, params: Any*): js.Promise[typingsJapgolly.sqlite.buildStatementMod.Statement[Stmt]] = js.native
