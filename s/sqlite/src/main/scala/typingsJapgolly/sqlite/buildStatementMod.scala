...
import typingsJapgolly.sqlite.buildInterfacesMod.ISqlite.RunResult
...
object buildStatementMod {
  ...
  @js.native
  open class Statement[S /* <: typingsJapgolly.sqlite.sqlite3Mod.Statement */] protected () extends StObject {
    ...
    /**
      ...
      * parameters. This automatically sanitizes inputs.
      */
    def run(params: Any*): js.Promise[RunResult[typingsJapgolly.sqlite.sqlite3Mod.Statement]] = js.native
