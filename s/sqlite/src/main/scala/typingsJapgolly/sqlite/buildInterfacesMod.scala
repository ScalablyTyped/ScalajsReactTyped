...
import typingsJapgolly.sqlite.sqlTemplateStringsMod.SQLStatement
...
object buildInterfacesMod {
  ...
  object ISqlite {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.sqlite.sqliteStrings.trace
      - typingsJapgolly.sqlite.sqliteStrings.profile
      - typingsJapgolly.sqlite.sqliteStrings.busyTimeout
    */
    trait ConfigureOption extends StObject
    object ConfigureOption {
      
      inline def busyTimeout: typingsJapgolly.sqlite.sqliteStrings.busyTimeout = "busyTimeout".asInstanceOf[typingsJapgolly.sqlite.sqliteStrings.busyTimeout]
      
      inline def profile: typingsJapgolly.sqlite.sqliteStrings.profile = "profile".asInstanceOf[typingsJapgolly.sqlite.sqliteStrings.profile]
      
      inline def trace: typingsJapgolly.sqlite.sqliteStrings.trace = "trace".asInstanceOf[typingsJapgolly.sqlite.sqliteStrings.trace]
    }
    ...
    trait RunResult[Stmt /* <: Statement */] extends StObject {
      ...
      /**
        ...
        */
      var stmt: typingsJapgolly.sqlite.buildStatementMod.Statement[Stmt]
    }
    object RunResult {
      
      inline def apply[Stmt /* <: Statement */](stmt: typingsJapgolly.sqlite.buildStatementMod.Statement[Stmt]): RunResult[Stmt] = {
      ...
      extension [Self <: RunResult[?], Stmt /* <: Statement */](x: Self & RunResult[Stmt]) {
        ...
        inline def setStmt(value: typingsJapgolly.sqlite.buildStatementMod.Statement[Stmt]): Self = StObject.set(x, "stmt", value.asInstanceOf[js.Any])
      }
    }
