package typingsJapgolly.svgInjector.mod
...
object SVGInjectorOptions {
  @scala.inline
  def apply(
    each: /* svg */ SVGElement | String => Callback = null,
    evalScripts: String = null,
    pngFallback: String = null
  ): SVGInjectorOptions = {
    val __obj = js.Dynamic.literal()
    if (each != null) __obj.updateDynamic("each")(js.Any.fromFunction1((t0: /* svg */ org.scalajs.dom.raw.SVGElement | java.lang.String) => each(t0).runNow()))
