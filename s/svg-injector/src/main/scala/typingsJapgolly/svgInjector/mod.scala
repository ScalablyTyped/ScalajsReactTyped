package typingsJapgolly.svgInjector
...
object mod extends Shortcut {
  ...
  type SVGInjector = js.Function3[
    /* elements */ Node | NodeList[Node] | js.Array[Node], 
  ...
  object SVGInjectorOptions {
    ...
    extension [Self <: SVGInjectorOptions](x: Self) {
      ...
      inline def setEach(value: /* svg */ SVGElement | String => Callback): Self = StObject.set(x, "each", js.Any.fromFunction1((t0: /* svg */ SVGElement | String) => value(t0).runNow()))
