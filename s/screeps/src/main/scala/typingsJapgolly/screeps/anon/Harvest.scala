...
trait Harvest extends StObject {
  ...
  var harvest: typingsJapgolly.screeps.screepsInts.`3`
}
object Harvest {
  ...
  extension [Self <: Harvest](x: Self) {
    ...
    inline def setHarvest(value: typingsJapgolly.screeps.screepsInts.`3`): Self = StObject.set(x, "harvest", value.asInstanceOf[js.Any])
  }
}
