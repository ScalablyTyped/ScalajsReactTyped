...
trait StoreRESOURCEENERGYRESOUR extends StObject {
  ...
  /**
    ...
    */
  def getCapacity[R /* <: js.UndefOr[ResourceConstant] */](): /* import warning: importer.ImportType#apply Failed type conversion: false extends true ? null : R extends undefined ? screeps.ResourceConstant extends screeps.RESOURCE_ENERGY | screeps.RESOURCE_POWER ? number : null : R extends screeps.RESOURCE_ENERGY | screeps.RESOURCE_POWER ? number : null */ js.Any = js.native
  def getCapacity[R /* <: js.UndefOr[ResourceConstant] */](resource: R): /* import warning: importer.ImportType#apply Failed type conversion: false extends true ? null : R extends undefined ? screeps.ResourceConstant extends screeps.RESOURCE_ENERGY | screeps.RESOURCE_POWER ? number : null : R extends screeps.RESOURCE_ENERGY | screeps.RESOURCE_POWER ? number : null */ js.Any = js.native
  ...
  /**
    ...
    */
  def getFreeCapacity[R /* <: js.UndefOr[ResourceConstant] */](): /* import warning: importer.ImportType#apply Failed type conversion: R extends undefined ? screeps.ResourceConstant extends screeps.RESOURCE_ENERGY | screeps.RESOURCE_POWER ? number : null : R extends screeps.RESOURCE_ENERGY | screeps.RESOURCE_POWER ? number : null */ js.Any = js.native
  def getFreeCapacity[R /* <: js.UndefOr[ResourceConstant] */](resource: R): /* import warning: importer.ImportType#apply Failed type conversion: R extends undefined ? screeps.ResourceConstant extends screeps.RESOURCE_ENERGY | screeps.RESOURCE_POWER ? number : null : R extends screeps.RESOURCE_ENERGY | screeps.RESOURCE_POWER ? number : null */ js.Any = js.native
