...
import typingsJapgolly.screeps.StructurePortalConstructor
import typingsJapgolly.screeps.anon.Shard
...
@js.native
open class StructurePortal protected ()
  extends StObject
     with typingsJapgolly.screeps.StructurePortal {
  def this(id: Id[typingsJapgolly.screeps.StructurePortal]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var destination: typingsJapgolly.screeps.RoomPosition | Shard = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_PORTAL = js.native
}
object StructurePortal {
  
  inline def apply: StructurePortalConstructor = js.Dynamic.global.selectDynamic("StructurePortal").asInstanceOf[StructurePortalConstructor]
}
