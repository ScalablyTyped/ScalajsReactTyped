...
import typingsJapgolly.screeps.StructureTerminalConstructor
...
open class StructureTerminal protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureTerminal {
  def this(id: Id[typingsJapgolly.screeps.StructureTerminal]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_TERMINAL = js.native
}
