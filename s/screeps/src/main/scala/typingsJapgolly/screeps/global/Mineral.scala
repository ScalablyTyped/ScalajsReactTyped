...
import typingsJapgolly.screeps.MineralConstructor
...
open class Mineral protected ()
  extends StObject
     with typingsJapgolly.screeps.Mineral[MineralConstant] {
  def this(id: Id[typingsJapgolly.screeps.Mineral[MineralConstant]]) = this()
