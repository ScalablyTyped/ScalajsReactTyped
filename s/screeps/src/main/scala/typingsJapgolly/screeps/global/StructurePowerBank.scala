...
import typingsJapgolly.screeps.StructurePowerBankConstructor
...
@js.native
open class StructurePowerBank protected ()
  extends StObject
     with typingsJapgolly.screeps.StructurePowerBank {
  def this(id: Id[typingsJapgolly.screeps.StructurePowerBank]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_POWER_BANK = js.native
