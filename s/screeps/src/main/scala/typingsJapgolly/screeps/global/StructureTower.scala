...
import typingsJapgolly.screeps.StructureTowerConstructor
...
open class StructureTower protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureTower {
  def this(id: Id[typingsJapgolly.screeps.StructureTower]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_TOWER = js.native
}
