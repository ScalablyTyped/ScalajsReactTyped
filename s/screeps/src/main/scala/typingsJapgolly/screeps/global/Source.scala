...
import typingsJapgolly.screeps.SourceConstructor
...
open class Source protected ()
  extends StObject
     with typingsJapgolly.screeps.Source {
  def this(id: Id[typingsJapgolly.screeps.Source]) = this()
  ...
  /* CompleteClass */
  @JSName("room")
  var room_Source: typingsJapgolly.screeps.Room = js.native
