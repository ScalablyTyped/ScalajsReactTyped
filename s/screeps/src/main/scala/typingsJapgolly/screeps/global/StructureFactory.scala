...
import typingsJapgolly.screeps.StructureFactoryConstructor
...
@js.native
open class StructureFactory protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureFactory {
  def this(id: Id[typingsJapgolly.screeps.StructureFactory]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_FACTORY = js.native
}
object StructureFactory {
  
  inline def apply: StructureFactoryConstructor = js.Dynamic.global.selectDynamic("StructureFactory").asInstanceOf[StructureFactoryConstructor]
}
