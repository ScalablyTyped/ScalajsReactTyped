...
import typingsJapgolly.screeps.StructureStorageConstructor
...
@js.native
open class StructureStorage protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureStorage {
  def this(id: Id[typingsJapgolly.screeps.StructureStorage]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_STORAGE = js.native
}
