...
import typingsJapgolly.screeps.StructureControllerConstructor
...
@js.native
open class StructureController protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureController {
  def this(id: Id[typingsJapgolly.screeps.StructureController]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_CONTROLLER = js.native
