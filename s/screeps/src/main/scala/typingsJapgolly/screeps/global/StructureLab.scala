...
import typingsJapgolly.screeps.StructureLabConstructor
...
open class StructureLab protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureLab {
  def this(id: Id[typingsJapgolly.screeps.StructureLab]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_LAB = js.native
}
object StructureLab {
