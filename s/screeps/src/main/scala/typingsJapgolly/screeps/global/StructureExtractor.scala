...
import typingsJapgolly.screeps.StructureExtractorConstructor
...
open class StructureExtractor protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureExtractor {
  def this(id: Id[typingsJapgolly.screeps.StructureExtractor]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_EXTRACTOR = js.native
}
