...
import typingsJapgolly.screeps.StructureNukerConstructor
...
open class StructureNuker protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureNuker {
  def this(id: Id[typingsJapgolly.screeps.StructureNuker]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def launchNuke(pos: typingsJapgolly.screeps.RoomPosition): ScreepsReturnCode = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_NUKER = js.native
}
