...
import typingsJapgolly.screeps.StructureWallConstructor
...
open class StructureWall protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureWall {
  def this(id: Id[typingsJapgolly.screeps.StructureWall]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_WALL = js.native
