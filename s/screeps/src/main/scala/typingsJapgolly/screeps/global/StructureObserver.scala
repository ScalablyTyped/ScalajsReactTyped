...
import typingsJapgolly.screeps.StructureObserverConstructor
...
open class StructureObserver protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureObserver {
  def this(id: Id[typingsJapgolly.screeps.StructureObserver]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_OBSERVER = js.native
}
