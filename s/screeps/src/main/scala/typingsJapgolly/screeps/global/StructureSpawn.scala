...
import typingsJapgolly.screeps.DirectionConstant
...
import typingsJapgolly.screeps.StructureSpawnConstructor
...
@js.native
open class StructureSpawn protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureSpawn {
  def this(id: Id[typingsJapgolly.screeps.StructureSpawn]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_SPAWN = js.native
}
object StructureSpawn extends Shortcut {
  ...
  open class Spawning protected ()
    extends StObject
       with typingsJapgolly.screeps.Spawning {
    def this(id: Id[typingsJapgolly.screeps.StructureSpawn]) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def cancel(): (typingsJapgolly.screeps.OK & ScreepsReturnCode) | (typingsJapgolly.screeps.ERR_NOT_OWNER & ScreepsReturnCode) = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def setDirections(directions: js.Array[DirectionConstant]): (typingsJapgolly.screeps.OK & ScreepsReturnCode) | (typingsJapgolly.screeps.ERR_NOT_OWNER & ScreepsReturnCode) | (typingsJapgolly.screeps.ERR_INVALID_ARGS & ScreepsReturnCode) = js.native
    
    /**
      * A link to the spawn
      */
    /* CompleteClass */
    var spawn: typingsJapgolly.screeps.StructureSpawn = js.native
  }
