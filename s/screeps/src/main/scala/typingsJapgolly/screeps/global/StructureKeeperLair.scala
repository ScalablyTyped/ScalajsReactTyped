...
import typingsJapgolly.screeps.StructureKeeperLairConstructor
...
open class StructureKeeperLair protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureKeeperLair {
  def this(id: Id[typingsJapgolly.screeps.StructureKeeperLair]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_KEEPER_LAIR = js.native
}
