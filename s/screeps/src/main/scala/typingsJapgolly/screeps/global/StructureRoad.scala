...
import typingsJapgolly.screeps.StructureRoadConstructor
...
@js.native
open class StructureRoad protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureRoad {
  def this(id: Id[typingsJapgolly.screeps.StructureRoad]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_ROAD = js.native
