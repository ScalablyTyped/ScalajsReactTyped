...
import typingsJapgolly.screeps.StructureRampartConstructor
...
open class StructureRampart protected ()
  extends StObject
     with typingsJapgolly.screeps.StructureRampart {
  def this(id: Id[typingsJapgolly.screeps.StructureRampart]) = this()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var structureType: typingsJapgolly.screeps.STRUCTURE_RAMPART = js.native
