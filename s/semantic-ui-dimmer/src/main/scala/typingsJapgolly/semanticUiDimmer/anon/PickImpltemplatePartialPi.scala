...
/* Inlined std.Pick<semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl, 'template'> & std.Partial<std.Pick<semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl, keyof semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl>> */
trait PickImpltemplatePartialPi
  extends StObject
     with Param {
...
object PickImpltemplatePartialPi {
  ...
  extension [Self <: PickImpltemplatePartialPi](x: Self) {
