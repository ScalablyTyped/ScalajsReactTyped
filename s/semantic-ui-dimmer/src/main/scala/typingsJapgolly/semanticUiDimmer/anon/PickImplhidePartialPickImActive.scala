...
/* Inlined std.Pick<semantic-ui-dimmer.SemanticUI.Dimmer.ClassNameSettings._Impl, 'hide'> & std.Partial<std.Pick<semantic-ui-dimmer.SemanticUI.Dimmer.ClassNameSettings._Impl, keyof semantic-ui-dimmer.SemanticUI.Dimmer.ClassNameSettings._Impl>> */
trait PickImplhidePartialPickImActive
  extends StObject
     with Param {
...
object PickImplhidePartialPickImActive {
  
  inline def apply(hide: String & js.UndefOr[String]): PickImplhidePartialPickImActive = {
    val __obj = js.Dynamic.literal(hide = hide.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplhidePartialPickImActive]
  }
  
  extension [Self <: PickImplhidePartialPickImActive](x: Self) {
