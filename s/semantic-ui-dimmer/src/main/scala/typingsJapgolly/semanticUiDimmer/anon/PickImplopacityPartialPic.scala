...
/* Inlined std.Pick<semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl, 'opacity'> & std.Partial<std.Pick<semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl, keyof semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl>> */
trait PickImplopacityPartialPic
  extends StObject
     with Param {
...
object PickImplopacityPartialPic {
  ...
  extension [Self <: PickImplopacityPartialPic](x: Self) {
