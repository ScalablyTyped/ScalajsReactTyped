...
/* Inlined std.Pick<semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl, 'dimmerName'> & std.Partial<std.Pick<semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl, keyof semantic-ui-dimmer.SemanticUI.DimmerSettings._Impl>> */
trait PickImpldimmerNamePartial
  extends StObject
     with Param {
...
object PickImpldimmerNamePartial {
  ...
  extension [Self <: PickImpldimmerNamePartial](x: Self) {
