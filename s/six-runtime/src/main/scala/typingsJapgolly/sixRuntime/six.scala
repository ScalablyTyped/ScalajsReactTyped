...
import typingsJapgolly.sixRuntime.Six.PluginsMap
import typingsJapgolly.sixRuntime.Six.plugins.dataProvider.DataProvider
import typingsJapgolly.sixRuntime.Six.plugins.http
import typingsJapgolly.sixRuntime.Six.plugins.log
import typingsJapgolly.sixRuntime.Six.plugins.rpc
import typingsJapgolly.sixRuntime.Six.plugins.sso.ssoConf
import typingsJapgolly.sixRuntime.Six.plugins.sso.ssoFactory
import typingsJapgolly.sixRuntime.Six.plugins.static.staticConf
import typingsJapgolly.sixRuntime.Six.plugins.static.staticFactory
import typingsJapgolly.sixRuntime.Six.plugins.time.timmer
import typingsJapgolly.sixRuntime.Six.plugins.uac.uacConf
import typingsJapgolly.sixRuntime.Six.plugins.uac.uacFactory
import typingsJapgolly.sixRuntime.Six.plugins.upm.upmConf
import typingsJapgolly.sixRuntime.Six.plugins.upm.upmFactory
import typingsJapgolly.sixRuntime.Six.plugins.view.render
import typingsJapgolly.sixRuntime.Six.plugins.view.runtimeConf
...
trait Six extends StObject {
  ...
  /**
    ...
    */
  var DataProvider: typingsJapgolly.sixRuntime.Six.plugins.dataProvider.DataProvider
  ...
  /**
    ...
    */
  var http: typingsJapgolly.sixRuntime.Six.plugins.http
  
  /**
    * 打日志方法
    */
  var log: typingsJapgolly.sixRuntime.Six.plugins.log
  ...
  object plugins {
    ...
    object sso {
      ...
      trait ssoClientConf extends StObject {
        ...
        var token: typingsJapgolly.sixRuntime.Six.plugins.sso.token
      }
      object ssoClientConf {
        ...
        inline def apply(
          ...
          val __obj = js.Dynamic.literal(callbackUrl = callbackUrl.asInstanceOf[js.Any], clientId = clientId.asInstanceOf[js.Any], env = env.asInstanceOf[js.Any], errorHook = js.Any.fromFunction1((t0: js.Error) => errorHook(t0).runNow()), protocol = protocol.asInstanceOf[js.Any], secret = secret.asInstanceOf[js.Any], token = token.asInstanceOf[js.Any])
        ...
        extension [Self <: ssoClientConf](x: Self) {
          ...
          inline def setErrorHook(value: js.Error => Callback): Self = StObject.set(x, "errorHook", js.Any.fromFunction1((t0: js.Error) => value(t0).runNow()))
      ...
      trait ssoConf extends StObject {
        ...
        var whiteList: String | js.RegExp | js.Array[String] | typingsJapgolly.sixRuntime.Six.plugins.whiteList
      }
      object ssoConf {
    ...
    object static {
      ...
      trait staticConf extends StObject {
        ...
        var cacheConf: typingsJapgolly.sixRuntime.Six.plugins.static.cacheConf
