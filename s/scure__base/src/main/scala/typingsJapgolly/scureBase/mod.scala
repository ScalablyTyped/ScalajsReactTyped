package typingsJapgolly.scureBase

import typingsJapgolly.scureBase.anon.FnCall
import typingsJapgolly.scureBase.scureBaseBooleans.`false`
...
object mod {
  ...
  /* keyof @scure/base.anon.Base16 */ /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.scureBase.scureBaseStrings.utf8
    - typingsJapgolly.scureBase.scureBaseStrings.hex
    - typingsJapgolly.scureBase.scureBaseStrings.base16
    - typingsJapgolly.scureBase.scureBaseStrings.base32
    - typingsJapgolly.scureBase.scureBaseStrings.base64
    - typingsJapgolly.scureBase.scureBaseStrings.base64url
    - typingsJapgolly.scureBase.scureBaseStrings.base58
    - typingsJapgolly.scureBase.scureBaseStrings.base58xmr
  */
