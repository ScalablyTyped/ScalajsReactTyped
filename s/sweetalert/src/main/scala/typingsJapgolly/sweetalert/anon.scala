...
import typingsJapgolly.sweetalert.typingsModulesOptionsButtonsMod.ButtonList
import typingsJapgolly.sweetalert.typingsModulesOptionsContentMod.ContentOptions
...
object anon {
  ...
  object Reject {
    ...
    extension [Self <: Reject](x: Self) {
      ...
      inline def setResolve(value: /* value */ String => Callback): Self = StObject.set(x, "resolve", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
