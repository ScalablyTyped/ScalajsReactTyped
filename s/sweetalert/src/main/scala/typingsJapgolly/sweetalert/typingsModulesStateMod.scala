...
import typingsJapgolly.sweetalert.anon.CloseModal
import typingsJapgolly.sweetalert.anon.Reject
import typingsJapgolly.sweetalert.anon.Value
import typingsJapgolly.sweetalert.anon.`0`
