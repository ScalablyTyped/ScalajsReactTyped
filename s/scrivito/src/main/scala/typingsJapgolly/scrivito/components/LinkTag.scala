...
import typingsJapgolly.scrivito.mod.Link
import typingsJapgolly.scrivito.mod.LinkTagProps
...
object LinkTag {
  ...
  inline def apply(to: Obj | Link): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.scrivito.mod.LinkTag] {
    ...
    inline def onClick(value: /* event */ ReactMouseEventFrom[Element] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[Element]) => value(t0).runNow()))
    ...
    inline def params(value: js.Object): this.type = set("params", value.asInstanceOf[js.Any])
