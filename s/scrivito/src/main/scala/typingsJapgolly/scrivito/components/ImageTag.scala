...
import typingsJapgolly.scrivito.mod.Binary
import typingsJapgolly.scrivito.mod.ImageTagProps
...
object ImageTag {
  ...
  inline def apply(content: Binary | Obj | Widget): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.scrivito.mod.ImageTag] {
