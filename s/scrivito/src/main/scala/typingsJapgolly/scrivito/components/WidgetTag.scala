...
import typingsJapgolly.scrivito.mod.WidgetTagProps
...
object WidgetTag {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.scrivito.mod.WidgetTag] {
  ...
  implicit def make(companion: WidgetTag.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: WidgetTagProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
