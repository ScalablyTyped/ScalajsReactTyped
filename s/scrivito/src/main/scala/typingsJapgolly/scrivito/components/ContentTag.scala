...
import typingsJapgolly.scrivito.mod.ContentTagProps
import typingsJapgolly.scrivito.mod.Obj
import typingsJapgolly.scrivito.mod.Widget
...
object ContentTag {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.scrivito.mod.ContentTag] {
    ...
    inline def content(value: Obj | Widget): this.type = set("content", value.asInstanceOf[js.Any])
    ...
    inline def page(value: Any): this.type = set("page", value.asInstanceOf[js.Any])
    ...
    inline def widgetProps(value: js.Object): this.type = set("widgetProps", value.asInstanceOf[js.Any])
