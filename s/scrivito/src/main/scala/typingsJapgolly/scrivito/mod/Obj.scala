...
import typingsJapgolly.scrivito.scrivitoStrings.`new`
import typingsJapgolly.scrivito.scrivitoStrings.deleted
import typingsJapgolly.scrivito.scrivitoStrings.edited
