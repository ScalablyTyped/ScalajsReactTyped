...
import typingsJapgolly.scrivito.scrivitoStrings.`additions removals`
import typingsJapgolly.scrivito.scrivitoStrings.`additions text`
import typingsJapgolly.scrivito.scrivitoStrings.`inline`
import typingsJapgolly.scrivito.scrivitoStrings.`removals additions`
import typingsJapgolly.scrivito.scrivitoStrings.`removals text`
import typingsJapgolly.scrivito.scrivitoStrings.`text additions`
import typingsJapgolly.scrivito.scrivitoStrings.`text removals`
import typingsJapgolly.scrivito.scrivitoStrings.additions
import typingsJapgolly.scrivito.scrivitoStrings.all
import typingsJapgolly.scrivito.scrivitoStrings.ascending
import typingsJapgolly.scrivito.scrivitoStrings.assertive
import typingsJapgolly.scrivito.scrivitoStrings.both
import typingsJapgolly.scrivito.scrivitoStrings.copy
import typingsJapgolly.scrivito.scrivitoStrings.date
import typingsJapgolly.scrivito.scrivitoStrings.decimal
import typingsJapgolly.scrivito.scrivitoStrings.descending
import typingsJapgolly.scrivito.scrivitoStrings.dialog
import typingsJapgolly.scrivito.scrivitoStrings.email
import typingsJapgolly.scrivito.scrivitoStrings.environment
import typingsJapgolly.scrivito.scrivitoStrings.execute
import typingsJapgolly.scrivito.scrivitoStrings.grammar
import typingsJapgolly.scrivito.scrivitoStrings.grid
import typingsJapgolly.scrivito.scrivitoStrings.horizontal
import typingsJapgolly.scrivito.scrivitoStrings.inherit
import typingsJapgolly.scrivito.scrivitoStrings.link
import typingsJapgolly.scrivito.scrivitoStrings.list
import typingsJapgolly.scrivito.scrivitoStrings.listbox
import typingsJapgolly.scrivito.scrivitoStrings.location
import typingsJapgolly.scrivito.scrivitoStrings.menu
import typingsJapgolly.scrivito.scrivitoStrings.mixed
import typingsJapgolly.scrivito.scrivitoStrings.move
import typingsJapgolly.scrivito.scrivitoStrings.no
import typingsJapgolly.scrivito.scrivitoStrings.none
import typingsJapgolly.scrivito.scrivitoStrings.numeric
import typingsJapgolly.scrivito.scrivitoStrings.off
import typingsJapgolly.scrivito.scrivitoStrings.on
import typingsJapgolly.scrivito.scrivitoStrings.other
import typingsJapgolly.scrivito.scrivitoStrings.page
import typingsJapgolly.scrivito.scrivitoStrings.polite
import typingsJapgolly.scrivito.scrivitoStrings.popup
import typingsJapgolly.scrivito.scrivitoStrings.removals
import typingsJapgolly.scrivito.scrivitoStrings.search
import typingsJapgolly.scrivito.scrivitoStrings.spelling
import typingsJapgolly.scrivito.scrivitoStrings.step
import typingsJapgolly.scrivito.scrivitoStrings.tel
import typingsJapgolly.scrivito.scrivitoStrings.text
import typingsJapgolly.scrivito.scrivitoStrings.time
import typingsJapgolly.scrivito.scrivitoStrings.tree
import typingsJapgolly.scrivito.scrivitoStrings.url
import typingsJapgolly.scrivito.scrivitoStrings.user
import typingsJapgolly.scrivito.scrivitoStrings.vertical
import typingsJapgolly.scrivito.scrivitoStrings.yes
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined parent std.Omit<react.react.AllHTMLAttributes<any>, 'content'> */
trait ContentTagProps extends StObject {
  ...
  var content: js.UndefOr[Obj | Widget] = js.undefined
...
object ContentTagProps {
  ...
  inline def apply(attribute: String): ContentTagProps = {
  ...
  extension [Self <: ContentTagProps](x: Self) {
    ...
    inline def setContent(value: Obj | Widget): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
    ...
    inline def setWidgetProps(value: js.Object): Self = StObject.set(x, "widgetProps", value.asInstanceOf[js.Any])
    
    inline def setWidgetPropsUndefined: Self = StObject.set(x, "widgetProps", js.undefined)
