...
import typingsJapgolly.scrivito.anon.Content
import typingsJapgolly.scrivito.anon.DumpLoaded
import typingsJapgolly.scrivito.anon.Hash
import typingsJapgolly.scrivito.anon.Length
import typingsJapgolly.scrivito.anon.Message
import typingsJapgolly.scrivito.anon.PreloadDump
import typingsJapgolly.scrivito.anon.Query
import typingsJapgolly.scrivito.mod.^
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.scrivito.scrivitoStrings.Asterisk
  - typingsJapgolly.scrivito.scrivitoStrings.id
  - typingsJapgolly.scrivito.scrivitoStrings._createdAt
  - typingsJapgolly.scrivito.scrivitoStrings._lastChanged
  - typingsJapgolly.scrivito.scrivitoStrings._objClass
  - typingsJapgolly.scrivito.scrivitoStrings._path
  - typingsJapgolly.scrivito.scrivitoStrings._permalink
  - typingsJapgolly.scrivito.scrivitoStrings._restriction
  - typingsJapgolly.scrivito.scrivitoStrings.MetadataCollection
  - java.lang.String
*/
