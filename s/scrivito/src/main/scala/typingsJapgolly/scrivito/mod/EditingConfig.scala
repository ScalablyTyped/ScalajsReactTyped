...
object EditingConfig {
  ...
  extension [Self <: EditingConfig](x: Self) {
    ...
    inline def setInitialize(value: /* instance */ Obj => Callback): Self = StObject.set(x, "initialize", js.Any.fromFunction1((t0: /* instance */ Obj) => value(t0).runNow()))
    
    inline def setInitializeCopy(value: /* originalInstance */ Obj => Callback): Self = StObject.set(x, "initializeCopy", js.Any.fromFunction1((t0: /* originalInstance */ Obj) => value(t0).runNow()))
