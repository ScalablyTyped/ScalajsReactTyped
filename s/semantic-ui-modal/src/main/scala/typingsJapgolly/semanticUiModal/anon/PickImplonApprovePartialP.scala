...
/* Inlined std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, 'onApprove'> & std.Partial<std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, keyof semantic-ui-modal.SemanticUI.ModalSettings._Impl>> */
trait PickImplonApprovePartialP
  extends StObject
     with Param {
...
object PickImplonApprovePartialP {
  ...
  extension [Self <: PickImplonApprovePartialP](x: Self) {
