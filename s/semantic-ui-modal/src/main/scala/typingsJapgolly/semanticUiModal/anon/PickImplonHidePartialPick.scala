...
/* Inlined std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, 'onHide'> & std.Partial<std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, keyof semantic-ui-modal.SemanticUI.ModalSettings._Impl>> */
trait PickImplonHidePartialPick
  ...
  @JSName("onHide")
  var onHide_Original: (js.ThisFunction1[/* this */ JQuery, /* $element */ JQuery, `false` | Unit]) & (js.UndefOr[js.ThisFunction1[/* this */ JQuery, /* $element */ JQuery, `false` | Unit]])
