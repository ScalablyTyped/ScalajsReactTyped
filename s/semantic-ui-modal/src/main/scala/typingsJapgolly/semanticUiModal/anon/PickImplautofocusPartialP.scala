...
import typingsJapgolly.semanticUiModal.SemanticUI.ModalSettings.Param
import typingsJapgolly.semanticUiModal.semanticUiModalBooleans.`false`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, 'autofocus'> & std.Partial<std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, keyof semantic-ui-modal.SemanticUI.ModalSettings._Impl>> */
trait PickImplautofocusPartialP
  extends StObject
     with Param {
...
object PickImplautofocusPartialP {
  ...
  extension [Self <: PickImplautofocusPartialP](x: Self) {
