...
/* Inlined std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, 'verbose'> & std.Partial<std.Pick<semantic-ui-modal.SemanticUI.ModalSettings._Impl, keyof semantic-ui-modal.SemanticUI.ModalSettings._Impl>> */
