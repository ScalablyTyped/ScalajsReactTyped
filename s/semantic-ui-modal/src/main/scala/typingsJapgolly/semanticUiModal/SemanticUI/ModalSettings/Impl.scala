package typingsJapgolly.semanticUiModal.SemanticUI.ModalSettings
...
object Impl {
  ...
  def apply(
    ...
    offset: Double,
    onApprove: JQuery => CallbackTo[`false` | Unit],
    onDeny: JQuery => CallbackTo[`false` | Unit],
    onHidden: Callback,
    ...
    val __obj = js.Dynamic.literal(allowMultiple = allowMultiple.asInstanceOf[js.Any], autofocus = autofocus.asInstanceOf[js.Any], className = className.asInstanceOf[js.Any], closable = closable.asInstanceOf[js.Any], context = context.asInstanceOf[js.Any], debug = debug.asInstanceOf[js.Any], detachable = detachable.asInstanceOf[js.Any], dimmerSettings = dimmerSettings.asInstanceOf[js.Any], duration = duration.asInstanceOf[js.Any], error = error.asInstanceOf[js.Any], keyboardShortcuts = keyboardShortcuts.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], namespace = namespace.asInstanceOf[js.Any], observeChanges = observeChanges.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], performance = performance.asInstanceOf[js.Any], queue = queue.asInstanceOf[js.Any], selector = selector.asInstanceOf[js.Any], silent = silent.asInstanceOf[js.Any], transition = transition.asInstanceOf[js.Any], verbose = verbose.asInstanceOf[js.Any])
    __obj.updateDynamic("onApprove")(js.Any.fromFunction1((t0: typingsJapgolly.semanticUiModal.JQuery) => onApprove(t0).runNow()))
    __obj.updateDynamic("onDeny")(js.Any.fromFunction1((t0: typingsJapgolly.semanticUiModal.JQuery) => onDeny(t0).runNow()))
    __obj.updateDynamic("onHidden")(onHidden.toJsFn)
    __obj.updateDynamic("onHide")(js.Any.fromFunction1((t0: typingsJapgolly.semanticUiModal.JQuery) => onHide(t0).runNow()))
