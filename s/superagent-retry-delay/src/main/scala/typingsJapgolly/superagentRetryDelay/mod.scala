package typingsJapgolly.superagentRetryDelay
...
import typingsJapgolly.superagent.mod.MultipartValue
import typingsJapgolly.superagent.mod.MultipartValueSingle
...
import typingsJapgolly.superagent.mod.SuperAgentStatic
import typingsJapgolly.superagentRetryDelay.superagentRetryDelayStrings.error
...
object mod {
  ...
  trait EnhancedSuperAgentRequest extends StObject {
    ...
    def parse(parser: typingsJapgolly.superagent.mod.Parser): this.type = js.native
    @JSName("parse")
    var parse_Original: js.Function1[/* parser */ typingsJapgolly.superagent.mod.Parser, this.type] = js.native
    ...
    def serialize(serializer: typingsJapgolly.superagent.mod.Serializer): this.type = js.native
    @JSName("serialize")
    var serialize_Original: js.Function1[/* serializer */ typingsJapgolly.superagent.mod.Serializer, this.type] = js.native
