...
object storybookReactStrings {
  ...
  @js.native
  sealed trait __esModule extends StObject
  inline def __esModule: __esModule = "__esModule".asInstanceOf[__esModule]
  
  @js.native
  sealed trait __namedExportsOrder extends StObject
  inline def __namedExportsOrder: __namedExportsOrder = "__namedExportsOrder".asInstanceOf[__namedExportsOrder]
