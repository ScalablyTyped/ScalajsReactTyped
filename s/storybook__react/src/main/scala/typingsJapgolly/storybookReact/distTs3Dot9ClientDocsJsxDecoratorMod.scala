...
import typingsJapgolly.reactElementToJsxString.mod.ReactElementToJSXStringOptions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTs3Dot9ClientDocsJsxDecoratorMod {
  ...
  ): Element = (^.asInstanceOf[js.Dynamic].applyDynamic("jsxDecorator")(storyFn.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Element]
  
  inline def renderJsx(code: Element, options: JSXOptions): String = (^.asInstanceOf[js.Dynamic].applyDynamic("renderJsx")(code.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  trait JSXOptions
    ...
    @JSName("displayName")
    var displayName_JSXOptions: js.UndefOr[String | (js.Function1[/* element */ Node, String])] = js.undefined
  ...
  object JSXOptions {
    ...
    extension [Self <: JSXOptions](x: Self) {
      ...
      inline def setDisplayName(value: String | (js.Function1[/* element */ Node, String])): Self = StObject.set(x, "displayName", value.asInstanceOf[js.Any])
      
      inline def setDisplayNameFunction1(value: /* element */ Node => String): Self = StObject.set(x, "displayName", js.Any.fromFunction1(value))
