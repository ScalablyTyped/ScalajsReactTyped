...
import typingsJapgolly.storybookDocsTools.distTs3Dot9ArgTypesDocgenPropDefMod.PropDefaultValue
import typingsJapgolly.storybookDocsTools.distTs3Dot9ArgTypesDocgenTypesMod.ArgTypesExtractor
import typingsJapgolly.storybookDocsTools.distTs3Dot9ArgTypesTypesMod.Component
import typingsJapgolly.storybookReact.distTs3Dot9ClientDocsLibDefaultValuesCreateFromRawDefaultPropMod.TypeResolver
import typingsJapgolly.storybookStore.distTs3Dot9CsfTestingUtilsTypesMod.ComposedStoryPlayFn
...
object anon {
  ...
  trait Call[TArgs] extends StObject {
    ...
    def apply(extraArgs: Partial[TArgs]): Element = js.native
  ...
  object ExtractArgTypes {
    ...
    inline def apply(
      ...
      prepareForInline: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PartialStoryFn<ReactFramework> */ Any => Element
    ): ExtractArgTypes = {
    ...
    extension [Self <: ExtractArgTypes](x: Self) {
      ...
      inline def setPrepareForInline(
        value: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify PartialStoryFn<ReactFramework> */ Any => Element
