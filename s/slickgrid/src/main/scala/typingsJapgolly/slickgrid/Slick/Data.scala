...
object Data {
  ...
  object Aggregators {
    ...
    object Aggregator {
      ...
      inline def apply[T /* <: SlickData */](accumulate: T => Callback, field: String, init: Callback, storeResult: GroupTotals[T] => Callback): Aggregator[T] = {
        val __obj = js.Dynamic.literal(accumulate = js.Any.fromFunction1((t0: T) => accumulate(t0).runNow()), field = field.asInstanceOf[js.Any], init = init.toJsFn, storeResult = js.Any.fromFunction1((t0: GroupTotals[T]) => storeResult(t0).runNow()))
        __obj.asInstanceOf[Aggregator[T]]
      }
      
      extension [Self <: Aggregator[?], T /* <: SlickData */](x: Self & Aggregator[T]) {
        
        inline def setAccumulate(value: T => Callback): Self = StObject.set(x, "accumulate", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
        
        inline def setField(value: String): Self = StObject.set(x, "field", value.asInstanceOf[js.Any])
        
        inline def setInit(value: Callback): Self = StObject.set(x, "init", value.toJsFn)
        
        inline def setStoreResult(value: GroupTotals[T] => Callback): Self = StObject.set(x, "storeResult", js.Any.fromFunction1((t0: GroupTotals[T]) => value(t0).runNow()))
      }
    }
