...
import typingsJapgolly.slickgrid.anon.CancelCurrentEdit
import typingsJapgolly.slickgrid.anon.ColumnId
...
trait Grid[T /* <: SlickData */] extends StObject {
  ...
  /**
    ...
    * @return
    **/
  def getCellFromEvent(e: org.scalajs.dom.Event): Cell = js.native
