...
import typingsJapgolly.slickgrid.Slick.ColumnMetadata
import typingsJapgolly.slickgrid.Slick.Controls.SlickColumnPickerOptions
import typingsJapgolly.slickgrid.Slick.Data.DataViewOptions
import typingsJapgolly.slickgrid.Slick.DataProvider
import typingsJapgolly.slickgrid.Slick.Editors.Editor
import typingsJapgolly.slickgrid.Slick.Editors.EditorOptions
import typingsJapgolly.slickgrid.Slick.Formatter
import typingsJapgolly.slickgrid.Slick.GridOptions
import typingsJapgolly.slickgrid.Slick.OnCommandEventArgs
import typingsJapgolly.slickgrid.Slick.PluginOptions
import typingsJapgolly.slickgrid.Slick.Position
import typingsJapgolly.slickgrid.Slick.SlickData
import typingsJapgolly.slickgrid.Slick.SlickGridAutoTooltipsOption
import typingsJapgolly.slickgrid.Slick.SlickGridCheckBoxSelectColumnOptions
import typingsJapgolly.slickgrid.Slick.ValidateResults
import typingsJapgolly.slickgrid.anon.SelectActiveRow
...
object global {
  ...
  object Slick {
    ...
    open class AutoTooltips ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.Plugin[SlickData] {
      ...
      /* CompleteClass */
      override def init(grid: typingsJapgolly.slickgrid.Slick.Grid[SlickData]): Unit = js.native
    }
    ...
    open class CheckboxSelectColumn[T /* <: SlickData */] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.CheckboxSelectColumn[T] {
      ...
      /* CompleteClass */
      override def init(grid: typingsJapgolly.slickgrid.Slick.Grid[T]): Unit = js.native
    }
    ...
    object Controls {
      ...
      open class ColumnPicker[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Controls.ColumnPicker[T] {
        def this(
          columns: js.Array[Column[T]],
          grid: typingsJapgolly.slickgrid.Slick.Grid[T],
    ...
    object Data {
      ...
      object Aggregators {
        ...
        open class Aggregator[T /* <: SlickData */] ()
          extends StObject
             with typingsJapgolly.slickgrid.Slick.Data.Aggregators.Aggregator[T] {
          ...
          /* CompleteClass */
          override def storeResult(groupTotals: typingsJapgolly.slickgrid.Slick.GroupTotals[T]): Unit = js.native
        }
      ...
      open class DataView[T /* <: SlickData */] ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Data.DataView[T] {
      ...
      open class GroupItemMetadataProvider[T /* <: SlickData */] ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Data.GroupItemMetadataProvider[T]
    }
    ...
    open class EditorLock[T /* <: SlickData */] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.EditorLock[T] {
    ...
    object Editors {
      ...
      open class Checkbox[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Editors.Checkbox[T] {
      ...
      open class Date[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Editors.Date[T] {
        def this(args: EditorOptions[T]) = this()
      ...
      open class Editor[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Editors.Editor[T] {
        def this(args: EditorOptions[T]) = this()
      ...
      open class Integer[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Editors.Integer[T] {
        def this(args: EditorOptions[T]) = this()
      ...
      open class LongText[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Editors.LongText[T] {
        def this(args: EditorOptions[T]) = this()
        ...
        /* CompleteClass */
        override def handleKeyDown(e: org.scalajs.dom.Event): Unit = js.native
      ...
      open class PercentComplete[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Editors.PercentComplete[T] {
        def this(args: EditorOptions[T]) = this()
      ...
      open class Text[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Editors.Text[T] {
        def this(args: EditorOptions[T]) = this()
      ...
      open class YesNoSelect[T /* <: SlickData */] protected ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Editors.YesNoSelect[T] {
        def this(args: EditorOptions[T]) = this()
    ...
    open class Event[T] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.Event[T]
    
    @JSGlobal("Slick.EventData")
    @js.native
    open class EventData ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.EventData {
    ...
    open class EventHandler[T] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.EventHandler[T] {
      
      /* CompleteClass */
      override def subscribe(
        event: typingsJapgolly.slickgrid.Slick.Event[T],
        handler: js.Function2[/* e */ typingsJapgolly.slickgrid.Slick.EventData, T, Unit]
      ): typingsJapgolly.slickgrid.Slick.EventHandler[Any] = js.native
      ...
      /* CompleteClass */
      override def unsubscribeAll(): typingsJapgolly.slickgrid.Slick.EventHandler[Any] = js.native
    }
    ...
    @js.native
    def GlobalEditorLock: typingsJapgolly.slickgrid.Slick.EditorLock[SlickData] = js.native
    inline def GlobalEditorLock_=(x: typingsJapgolly.slickgrid.Slick.EditorLock[SlickData]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GlobalEditorLock")(x.asInstanceOf[js.Any])
    
    @JSGlobal("Slick.Grid")
    @js.native
    open class Grid[T /* <: SlickData */] protected ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.Grid[T] {
      /**
    ...
    open class Group[T /* <: SlickData */] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.Group[T] {
      ...
      /***
        ...
        */
      /* CompleteClass */
      override def equals(group: typingsJapgolly.slickgrid.Slick.Group[T]): Boolean = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      var groups: js.Array[typingsJapgolly.slickgrid.Slick.Group[T]] = js.native
      ...
      /***
        ...
        */
      /* CompleteClass */
      var totals: typingsJapgolly.slickgrid.Slick.GroupTotals[T] = js.native
    ...
    open class GroupTotals[T /* <: SlickData */] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.GroupTotals[T] {
      ...
      /***
        ...
        */
      /* CompleteClass */
      var group: typingsJapgolly.slickgrid.Slick.Group[T] = js.native
    }
    ...
    open class NonDataRow ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.NonDataRow
    
    @JSGlobal("Slick.Plugin")
    @js.native
    open class Plugin[T /* <: SlickData */] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.Plugin[T] {
    ...
    object Plugins {
      ...
      open class HeaderButtons[T /* <: SlickData */] ()
        extends StObject
           with typingsJapgolly.slickgrid.Slick.Plugins.HeaderButtons[T] {
        ...
        /* CompleteClass */
        var onCommand: typingsJapgolly.slickgrid.Slick.Event[OnCommandEventArgs[T]] = js.native
      }
    }
    ...
    open class Range protected ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.Range {
      /**
    ...
    open class RowSelectionModel[T /* <: SlickData */, E] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.RowSelectionModel[T, E] {
      ...
      /* CompleteClass */
      var onSelectedRangesChanged: typingsJapgolly.slickgrid.Slick.Event[E] = js.native
    ...
    open class SelectionModel[T /* <: SlickData */, E] ()
      extends StObject
         with typingsJapgolly.slickgrid.Slick.SelectionModel[T, E] {
