...
import typingsJapgolly.scriptExtHtmlWebpackPlugin.scriptExtHtmlWebpackPluginStrings.defer
import typingsJapgolly.scriptExtHtmlWebpackPlugin.scriptExtHtmlWebpackPluginStrings.sync
...
object mod {
  ...
  object ScriptExtHtmlWebpackPlugin {
    ...
    inline def apply(apply: Compiler => Callback): ScriptExtHtmlWebpackPlugin = {
  ...
  type ScriptMatchingPatternPre = ScriptMatchingPatternBase | typingsJapgolly.scriptExtHtmlWebpackPlugin.anon.ScriptMatchingPatternHash
}
