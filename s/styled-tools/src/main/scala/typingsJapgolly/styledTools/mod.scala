package typingsJapgolly.styledTools

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.std.Exclude
import typingsJapgolly.styledTools.anon.Palette
import typingsJapgolly.styledTools.anon.PaletteTheme
import typingsJapgolly.styledTools.anon.ThemeTheme
import typingsJapgolly.styledTools.anon.Tone
import typingsJapgolly.styledTools.anon.`0`
...
object mod {
  ...
  @JSImport("styled-tools", JSImport.Namespace)
  @js.native
  ...
  @js.native
  val palette: Palette_ = js.native
  
  inline def prop[T](path: String): js.Function1[
    /* props */ js.UndefOr[Any], 
    (/* import warning: importer.ImportType#apply Failed type conversion: any[keyof any] */ js.Any) | T
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("prop")(path.asInstanceOf[js.Any]).asInstanceOf[js.Function1[
    /* props */ js.UndefOr[Any], 
    (/* import warning: importer.ImportType#apply Failed type conversion: any[keyof any] */ js.Any) | T
  ]]
  inline def prop[T](path: String, defaultValue: T): js.Function1[
    /* props */ js.UndefOr[Any], 
    (/* import warning: importer.ImportType#apply Failed type conversion: any[keyof any] */ js.Any) | T
  ] = (^.asInstanceOf[js.Dynamic].applyDynamic("prop")(path.asInstanceOf[js.Any], defaultValue.asInstanceOf[js.Any])).asInstanceOf[js.Function1[
    /* props */ js.UndefOr[Any], 
    (/* import warning: importer.ImportType#apply Failed type conversion: any[keyof any] */ js.Any) | T
  ]]
  
  inline def switchProp[Props, T, DefaultCase](needle: Needle[Props], cases: js.Function1[/* props */ Props, StringDictionary[T]]): js.Function1[/* props */ js.UndefOr[Props], T | DefaultCase] = (^.asInstanceOf[js.Dynamic].applyDynamic("switchProp")(needle.asInstanceOf[js.Any], cases.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* props */ js.UndefOr[Props], T | DefaultCase]]
  inline def switchProp[Props, T, DefaultCase](
    needle: Needle[Props],
    cases: js.Function1[/* props */ Props, StringDictionary[T]],
    defaultCase: DefaultCase
  ): js.Function1[/* props */ js.UndefOr[Props], T | DefaultCase] = (^.asInstanceOf[js.Dynamic].applyDynamic("switchProp")(needle.asInstanceOf[js.Any], cases.asInstanceOf[js.Any], defaultCase.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* props */ js.UndefOr[Props], T | DefaultCase]]
  inline def switchProp[Props, T, DefaultCase](needle: Needle[Props], cases: StringDictionary[T]): js.Function1[/* props */ js.UndefOr[Props], T | DefaultCase] = (^.asInstanceOf[js.Dynamic].applyDynamic("switchProp")(needle.asInstanceOf[js.Any], cases.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* props */ js.UndefOr[Props], T | DefaultCase]]
  ...
  inline def withProp[Props, T](needle: js.Array[Needle[Props]], fn: js.Function1[/* repeated */ Any, T]): js.Function1[/* props */ js.UndefOr[Props], T] = (^.asInstanceOf[js.Dynamic].applyDynamic("withProp")(needle.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* props */ js.UndefOr[Props], T]]
  inline def withProp[Props, T](needle: Needle[Props], fn: js.Function1[/* repeated */ Any, T]): js.Function1[/* props */ js.UndefOr[Props], T] = (^.asInstanceOf[js.Dynamic].applyDynamic("withProp")(needle.asInstanceOf[js.Any], fn.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* props */ js.UndefOr[Props], T]]
  
  type Needle[Props] = String | (js.Function1[/* props */ js.UndefOr[Props], Any])
  
  @js.native
  trait Palette_ extends StObject {
    
    def apply(): js.Function1[/* props */ Any & Palette[ThemeWithPalette], Any] = js.native
  ...
  trait ThemeWithPalette extends StObject {
    
    var palette: js.UndefOr[StringDictionary[Any]] = js.undefined
  }
  object ThemeWithPalette {
    
    inline def apply(): ThemeWithPalette = {
