...
object mod {
  ...
  object Saml11 {
    ...
    inline def create(opts: SamlSignedOpts): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(opts.asInstanceOf[js.Any]).asInstanceOf[Any]
    inline def create(
      opts: SamlSignedOpts,
      cb: js.Function3[/* err */ js.Error | Null, /* result */ js.Array[Any], /* proofSecret */ Buffer, Unit]
    ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(opts.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Any]
    
    inline def createUnsignedAssertion(opts: SamlUnassignedOpts): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("createUnsignedAssertion")(opts.asInstanceOf[js.Any]).asInstanceOf[Any]
    inline def createUnsignedAssertion(
      opts: SamlUnassignedOpts,
      cb: js.Function3[/* err */ js.Error | Null, /* result */ js.Array[Any], /* proofSecret */ Buffer, Unit]
    ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("createUnsignedAssertion")(opts.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Any]
  }
  ...
  object Saml20 {
    ...
    inline def create(opts: SamlUnassignedOpts): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(opts.asInstanceOf[js.Any]).asInstanceOf[Any]
    inline def create(opts: SamlUnassignedOpts, cb: js.Function2[/* err */ js.Error | Null, /* signed */ String, Unit]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(opts.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Any]
    
    inline def createUnsignedAssertion(opts: SamlUnassignedOpts): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("createUnsignedAssertion")(opts.asInstanceOf[js.Any]).asInstanceOf[Any]
    inline def createUnsignedAssertion(opts: SamlUnassignedOpts, cb: js.Function2[/* err */ js.Error | Null, /* signed */ String, Unit]): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("createUnsignedAssertion")(opts.asInstanceOf[js.Any], cb.asInstanceOf[js.Any])).asInstanceOf[Any]
  }
  ...
  trait SamlSignedOpts extends StObject {
    ...
    var keyEncryptionAlgorithm: js.UndefOr[String] = js.undefined
  ...
  object SamlSignedOpts {
    
    inline def apply(cert: Buffer, key: Buffer): SamlSignedOpts = {
    ...
    extension [Self <: SamlSignedOpts](x: Self) {
      ...
      inline def setKeyEncryptionAlgorithm(value: String): Self = StObject.set(x, "keyEncryptionAlgorithm", value.asInstanceOf[js.Any])
  ...
  trait SamlUnassignedOpts extends StObject {
  ...
  object SamlUnassignedOpts {
    
    inline def apply(): SamlUnassignedOpts = {
