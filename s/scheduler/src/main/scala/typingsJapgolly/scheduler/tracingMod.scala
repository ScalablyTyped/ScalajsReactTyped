...
import typingsJapgolly.scheduler.anon.Cancel
...
object tracingMod {
  ...
  object Subscriber {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(onInteractionScheduledWorkCompleted = js.Any.fromFunction1((t0: Interaction) => onInteractionScheduledWorkCompleted(t0).runNow()), onInteractionTraced = js.Any.fromFunction1((t0: Interaction) => onInteractionTraced(t0).runNow()), onWorkCanceled = js.Any.fromFunction2((t0: Set[Interaction], t1: Double) => (onWorkCanceled(t0, t1)).runNow()), onWorkScheduled = js.Any.fromFunction2((t0: Set[Interaction], t1: Double) => (onWorkScheduled(t0, t1)).runNow()), onWorkStarted = js.Any.fromFunction2((t0: Set[Interaction], t1: Double) => (onWorkStarted(t0, t1)).runNow()), onWorkStopped = js.Any.fromFunction2((t0: Set[Interaction], t1: Double) => (onWorkStopped(t0, t1)).runNow()))
      __obj.asInstanceOf[Subscriber]
    }
    
    extension [Self <: Subscriber](x: Self) {
      
      inline def setOnInteractionScheduledWorkCompleted(value: Interaction => Callback): Self = StObject.set(x, "onInteractionScheduledWorkCompleted", js.Any.fromFunction1((t0: Interaction) => value(t0).runNow()))
      
      inline def setOnInteractionTraced(value: Interaction => Callback): Self = StObject.set(x, "onInteractionTraced", js.Any.fromFunction1((t0: Interaction) => value(t0).runNow()))
      
      inline def setOnWorkCanceled(value: (Set[Interaction], Double) => Callback): Self = StObject.set(x, "onWorkCanceled", js.Any.fromFunction2((t0: Set[Interaction], t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOnWorkScheduled(value: (Set[Interaction], Double) => Callback): Self = StObject.set(x, "onWorkScheduled", js.Any.fromFunction2((t0: Set[Interaction], t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOnWorkStarted(value: (Set[Interaction], Double) => Callback): Self = StObject.set(x, "onWorkStarted", js.Any.fromFunction2((t0: Set[Interaction], t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setOnWorkStopped(value: (Set[Interaction], Double) => Callback): Self = StObject.set(x, "onWorkStopped", js.Any.fromFunction2((t0: Set[Interaction], t1: Double) => (value(t0, t1)).runNow()))
    }
  }
