...
object ClientOptions {
  @scala.inline
  def apply(
    connectionCallback: (/* error */ js.Array[js.Error], /* result */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (connectionCallback != null) __obj.updateDynamic("connectionCallback")(js.Any.fromFunction2((t0: /* error */ js.Array[js.Error], t1: /* result */ js.UndefOr[js.Any]) => connectionCallback(t0, t1).runNow()))
