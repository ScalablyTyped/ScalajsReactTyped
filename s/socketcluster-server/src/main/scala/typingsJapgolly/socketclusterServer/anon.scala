...
import typingsJapgolly.socketclusterServer.serversocketMod.^
...
object anon {
  ...
  trait Server extends StObject {
    ...
    var Server: typingsJapgolly.ws.mod.Server[WebSocket]
  }
  object Server {
    
    inline def apply(Server: typingsJapgolly.ws.mod.Server[WebSocket]): Server = {
    ...
    extension [Self <: Server](x: Self) {
      ...
      inline def setServer(value: typingsJapgolly.ws.mod.Server[WebSocket]): Self = StObject.set(x, "Server", value.asInstanceOf[js.Any])
    }
  }
