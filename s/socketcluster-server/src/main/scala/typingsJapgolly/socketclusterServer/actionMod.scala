...
import typingsJapgolly.scErrors.mod.AuthTokenExpiredError
import typingsJapgolly.socketclusterServer.serversocketMod.AuthToken
import typingsJapgolly.socketclusterServer.socketclusterServerStrings.allowed
import typingsJapgolly.socketclusterServer.socketclusterServerStrings.blocked
...
object actionMod {
  ...
  trait AGAction extends StObject {
    ...
    var socket: js.UndefOr[typingsJapgolly.socketclusterServer.serversocketMod.^] = js.undefined
  ...
  object AGAction {
    ...
    extension [Self <: AGAction](x: Self) {
      ...
      inline def setAllow(value: Any => Callback): Self = StObject.set(x, "allow", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      ...
      inline def setBlock(value: js.Error => Callback): Self = StObject.set(x, "block", js.Any.fromFunction1((t0: js.Error) => value(t0).runNow()))
  ...
  trait AGActionAuthenticate
    ...
    var socket: typingsJapgolly.socketclusterServer.serversocketMod.^ = js.native
