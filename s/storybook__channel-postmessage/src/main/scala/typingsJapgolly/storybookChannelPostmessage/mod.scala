...
import typingsJapgolly.storybookChannels.mod.ChannelEvent
...
object mod {
  ...
  inline def default(hasPage: Config): typingsJapgolly.storybookChannels.mod.default = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(hasPage.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.storybookChannels.mod.default]
