...
import typingsJapgolly.statsdClient.anon.GetExpressMiddleware
...
object mod {
  ...
  object ExpressMiddlewareOptions {
    ...
    extension [Self <: ExpressMiddlewareOptions](x: Self) {
      ...
      ): Self = StObject.set(x, "onResponseEnd", js.Any.fromFunction4((t0: /* client */ StatsdClient, t1: /* startTime */ js.Date, t2: /* req */ Request_[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
              Any, 
              Any, 
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
