...
object privacy {
  ...
  object network {
    ...
    @JSGlobal("SinonChrome.privacy.network")
    @js.native
    val ^ : js.Any = js.native
    
    @JSGlobal("SinonChrome.privacy.network.networkPredictionEnabled")
    @js.native
  ...
  object services {
    ...
    @JSGlobal("SinonChrome.privacy.services")
    @js.native
    val ^ : js.Any = js.native
    
    @JSGlobal("SinonChrome.privacy.services.alternateErrorPagesEnabled")
    @js.native
    ...
    @JSGlobal("SinonChrome.privacy.services.autofillEnabled")
    @js.native
    ...
    @JSGlobal("SinonChrome.privacy.services.passwordSavingEnabled")
    @js.native
    ...
    @JSGlobal("SinonChrome.privacy.services.safeBrowsingEnabled")
    @js.native
    ...
    @JSGlobal("SinonChrome.privacy.services.searchSuggestEnabled")
    @js.native
    ...
    @JSGlobal("SinonChrome.privacy.services.spellingServiceEnabled")
    @js.native
    ...
    @JSGlobal("SinonChrome.privacy.services.translationServiceEnabled")
    @js.native
  ...
  object website {
    ...
    @JSGlobal("SinonChrome.privacy.website")
    @js.native
    val ^ : js.Any = js.native
    
    @JSGlobal("SinonChrome.privacy.website.hyperlinkAuditingEnabled")
    @js.native
    ...
    @JSGlobal("SinonChrome.privacy.website.referrersEnabled")
    @js.native
    ...
    @JSGlobal("SinonChrome.privacy.website.thirdPartyCookiesAllowed")
    @js.native
