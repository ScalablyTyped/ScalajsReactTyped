...
object windows {
  ...
  @JSGlobal("SinonChrome.windows")
  @js.native
  val ^ : js.Any = js.native
  
  @JSGlobal("SinonChrome.windows.create")
  @js.native
  ...
  @JSGlobal("SinonChrome.windows.get")
  @js.native
  def get: SinonChromeStub = js.native
  
  @JSGlobal("SinonChrome.windows.getAll")
  @js.native
  ...
  @JSGlobal("SinonChrome.windows.getCurrent")
  @js.native
  ...
  @JSGlobal("SinonChrome.windows.getLastFocused")
  @js.native
  ...
  @JSGlobal("SinonChrome.windows.onCreated")
  @js.native
  ...
  @JSGlobal("SinonChrome.windows.onFocusChanged")
  @js.native
  ...
  @JSGlobal("SinonChrome.windows.onRemoved")
  @js.native
  ...
  @JSGlobal("SinonChrome.windows.remove")
  @js.native
  ...
  @JSGlobal("SinonChrome.windows.update")
  @js.native
