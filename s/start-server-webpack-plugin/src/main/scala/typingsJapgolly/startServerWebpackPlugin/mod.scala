...
import typingsJapgolly.startServerWebpackPlugin.startServerWebpackPluginBooleans.`false`
import typingsJapgolly.startServerWebpackPlugin.startServerWebpackPluginBooleans.`true`
import typingsJapgolly.startServerWebpackPlugin.startServerWebpackPluginStrings.SIGUSR2
