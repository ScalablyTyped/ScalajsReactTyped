...
object Game {
  ...
  open class CreateSFSGameRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.Game.CreateSFSGameRequest {
    /**
      ...
      */
    def this(settings: typingsJapgolly.smartFoxServer.SFS2X.Requests.Game.SFSGameSettings) = this()
  }
  ...
  open class InvitationReplyRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.Game.InvitationReplyRequest {
    /**
  ...
  open class InviteUsersRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.Game.InviteUsersRequest {
    /**
  ...
  open class QuickJoinGameRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.Game.QuickJoinGameRequest {
    /**
  ...
  open class SFSGameSettings protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.Game.SFSGameSettings {
    /**
    ...
    /* CompleteClass */
    var events: typingsJapgolly.smartFoxServer.SFS2X.Requests.RoomEvents = js.native
    
    /** @type {RoomExtension} Sets the Extension that must be attached to the Room on the server-side, and its settings. */
    /* CompleteClass */
    var `extension`: typingsJapgolly.smartFoxServer.SFS2X.Requests.RoomExtension = js.native
    ...
    /* CompleteClass */
    var permissions: typingsJapgolly.smartFoxServer.SFS2X.Requests.RoomPermissions = js.native
