...
object BuddyList {
  ...
  open class AddBuddyRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.BuddyList.AddBuddyRequest {
    /**
  ...
  open class BlockBuddyRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.BuddyList.BlockBuddyRequest {
    /**
  ...
  open class BuddyMessageRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.BuddyList.BuddyMessageRequest {
    /**
  ...
  open class GoOnlineRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.BuddyList.GoOnlineRequest {
    /**
  ...
  open class InitBuddyListRequest ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.BuddyList.InitBuddyListRequest
  
  @JSGlobal("SFS2X.Requests.BuddyList.RemoveBuddyRequest")
  @js.native
  open class RemoveBuddyRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.BuddyList.RemoveBuddyRequest {
    /**
  ...
  open class SetBuddyVariablesRequest protected ()
    extends StObject
       with typingsJapgolly.smartFoxServer.SFS2X.Requests.BuddyList.SetBuddyVariablesRequest {
    /**
