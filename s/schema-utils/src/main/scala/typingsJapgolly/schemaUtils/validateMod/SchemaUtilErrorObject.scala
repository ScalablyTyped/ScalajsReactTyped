...
import typingsJapgolly.ajv.mod.ErrorParameters
...
trait SchemaUtilErrorObject extends js.Object {
  var children: js.UndefOr[js.Array[typingsJapgolly.ajv.mod.ErrorObject]] = js.undefined
...
object SchemaUtilErrorObject {
  ...
  def apply(
    ...
    schemaPath: String,
    children: js.Array[typingsJapgolly.ajv.mod.ErrorObject] = null,
    data: js.Any = null,
    message: String = null,
