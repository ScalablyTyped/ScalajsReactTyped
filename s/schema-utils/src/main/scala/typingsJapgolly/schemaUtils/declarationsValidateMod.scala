...
object declarationsValidateMod {
  ...
  open class ValidationError protected () extends default {
    /**
      ...
      */
    def this(
      errors: js.Array[typingsJapgolly.schemaUtils.declarationsValidationErrorMod.SchemaUtilErrorObject],
      schema: typingsJapgolly.schemaUtils.declarationsValidationErrorMod.Schema
    ) = this()
    def this(
      errors: js.Array[typingsJapgolly.schemaUtils.declarationsValidationErrorMod.SchemaUtilErrorObject],
      schema: typingsJapgolly.schemaUtils.declarationsValidationErrorMod.Schema,
      configuration: typingsJapgolly.schemaUtils.declarationsValidationErrorMod.ValidationErrorConfiguration
    ) = this()
  }
  ...
  type ErrorObject = typingsJapgolly.ajv.distTypesMod.ErrorObject[String, Record[String, Any], Any]
  ...
  trait SchemaUtilErrorObject
    extends StObject
       with typingsJapgolly.ajv.distTypesMod.ErrorObject[String, Record[String, Any], Any] {
