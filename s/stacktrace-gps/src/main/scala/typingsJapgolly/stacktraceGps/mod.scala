package typingsJapgolly.stacktraceGps

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.sourceMap.mod.SourceMapConsumer
...
object mod {
  ...
  open class ^ ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def findFunctionName(stackframe: typingsJapgolly.stackframe.mod.^): js.Promise[typingsJapgolly.stackframe.mod.^] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getMappedLocation(stackframe: typingsJapgolly.stackframe.mod.^): js.Promise[typingsJapgolly.stackframe.mod.^] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def pinpoint(stackframe: typingsJapgolly.stackframe.mod.^): js.Promise[typingsJapgolly.stackframe.mod.^] = js.native
  }
  ...
  trait StackTraceGPS extends StObject {
    ...
    /**
      ...
      * @returns Promise that resolves with enhanced StackFrame
      */
    def findFunctionName(stackframe: typingsJapgolly.stackframe.mod.^): js.Promise[typingsJapgolly.stackframe.mod.^]
    ...
    /**
      ...
      * @returns Promise that resolves with enhanced StackFrame
      */
    def getMappedLocation(stackframe: typingsJapgolly.stackframe.mod.^): js.Promise[typingsJapgolly.stackframe.mod.^]
    ...
    /**
      ...
      * @returns Promise that resolves with with source-mapped StackFrame
      */
    def pinpoint(stackframe: typingsJapgolly.stackframe.mod.^): js.Promise[typingsJapgolly.stackframe.mod.^]
  }
  object StackTraceGPS {
    
    inline def apply(
      findFunctionName: typingsJapgolly.stackframe.mod.^ => js.Promise[typingsJapgolly.stackframe.mod.^],
      getMappedLocation: typingsJapgolly.stackframe.mod.^ => js.Promise[typingsJapgolly.stackframe.mod.^],
      pinpoint: typingsJapgolly.stackframe.mod.^ => js.Promise[typingsJapgolly.stackframe.mod.^]
    ): StackTraceGPS = {
    ...
    extension [Self <: StackTraceGPS](x: Self) {
      ...
      inline def setFindFunctionName(value: typingsJapgolly.stackframe.mod.^ => js.Promise[typingsJapgolly.stackframe.mod.^]): Self = StObject.set(x, "findFunctionName", js.Any.fromFunction1(value))
      
      inline def setGetMappedLocation(value: typingsJapgolly.stackframe.mod.^ => js.Promise[typingsJapgolly.stackframe.mod.^]): Self = StObject.set(x, "getMappedLocation", js.Any.fromFunction1(value))
      
      inline def setPinpoint(value: typingsJapgolly.stackframe.mod.^ => js.Promise[typingsJapgolly.stackframe.mod.^]): Self = StObject.set(x, "pinpoint", js.Any.fromFunction1(value))
    }
  }
}
