...
import typingsJapgolly.sharp.anon.Text
...
trait OverlayOptions extends StObject {
  ...
  var input: js.UndefOr[String | Buffer | typingsJapgolly.sharp.anon.Create | Text] = js.undefined
...
object OverlayOptions {
  ...
  extension [Self <: OverlayOptions](x: Self) {
    ...
    inline def setInput(value: String | Buffer | typingsJapgolly.sharp.anon.Create | Text): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
