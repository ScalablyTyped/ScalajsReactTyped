...
import typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.Error
import typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.Null
import typingsJapgolly.sassEmbedded.distTypesLegacyPluginThisMod.LegacyPluginThis
...
object distTypesLegacyFunctionMod {
  
  @JSImport("sass-embedded/dist/types/legacy/function", "FALSE")
  @js.native
  val FALSE: Boolean[`false`] = js.native
  
  @JSImport("sass-embedded/dist/types/legacy/function", "NULL")
  @js.native
  val NULL: Null = js.native
  
  @JSImport("sass-embedded/dist/types/legacy/function", "TRUE")
  @js.native
  val TRUE: Boolean[`true`] = js.native
  
  object types {
    
    @JSImport("sass-embedded/dist/types/legacy/function", "types.Boolean")
    @js.native
    ...
    object Boolean {
      ...
      /** Sass's `false` value. */
      @JSImport("sass-embedded/dist/types/legacy/function", "types.Boolean.FALSE")
      @js.native
      val FALSE: Boolean[`false`] = js.native
      
      /** Sass's `true` value. */
      @JSImport("sass-embedded/dist/types/legacy/function", "types.Boolean.TRUE")
      @js.native
      val TRUE: Boolean[`true`] = js.native
    }
    
    @JSImport("sass-embedded/dist/types/legacy/function", "types.Color")
    @js.native
    ...
    @JSImport("sass-embedded/dist/types/legacy/function", "types.Error")
    @js.native
    open class Error protected () extends StObject {
      def this(message: java.lang.String) = this()
    }
    
    @JSImport("sass-embedded/dist/types/legacy/function", "types.List")
    @js.native
    ...
    @JSImport("sass-embedded/dist/types/legacy/function", "types.Map")
    @js.native
    ...
    @JSImport("sass-embedded/dist/types/legacy/function", "types.Null")
    @js.native
    open class Null ()
      extends StObject
         with _LegacyValue
    ...
    object Null {
      ...
      @JSImport("sass-embedded/dist/types/legacy/function", "types.Null.NULL")
      @js.native
      val NULL: Null = js.native
    }
    
    @JSImport("sass-embedded/dist/types/legacy/function", "types.Number")
    @js.native
    ...
    @JSImport("sass-embedded/dist/types/legacy/function", "types.String")
    @js.native
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait LegacyFunction[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.Null
    - typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.Number
    - typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.String
    - typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.Boolean[scala.Boolean]
    - typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.Color
    - typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.List
    - typingsJapgolly.sassEmbedded.distTypesLegacyFunctionMod.types.Map
  */
