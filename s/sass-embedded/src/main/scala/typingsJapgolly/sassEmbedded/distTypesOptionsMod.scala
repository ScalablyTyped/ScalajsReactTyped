...
import typingsJapgolly.sassEmbedded.distTypesImporterMod.FileImporter
import typingsJapgolly.sassEmbedded.distTypesImporterMod.Importer
...
object distTypesOptionsMod {
  ...
  type CustomFunction[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */] = js.Function1[/* args */ js.Array[Value], PromiseOr[Value, sync]]
  
  trait Options[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject {
  ...
  object Options {
    ...
    inline def apply[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](): Options[sync] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[Options[sync]]
    }
    
    extension [Self <: Options[?], sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](x: Self & Options[sync]) {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sassEmbedded.sassEmbeddedStrings.expanded
    - typingsJapgolly.sassEmbedded.sassEmbeddedStrings.compressed
  */
  trait OutputStyle extends StObject
  object OutputStyle {
    
    inline def compressed: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.compressed = "compressed".asInstanceOf[typingsJapgolly.sassEmbedded.sassEmbeddedStrings.compressed]
    
    inline def expanded: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.expanded = "expanded".asInstanceOf[typingsJapgolly.sassEmbedded.sassEmbeddedStrings.expanded]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sassEmbedded.distTypesOptionsMod.StringOptionsWithImporter[sync]
    - typingsJapgolly.sassEmbedded.distTypesOptionsMod.StringOptionsWithoutImporter[sync]
  */
  trait StringOptions[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject
  object StringOptions {
    
    inline def StringOptionsWithImporter[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](importer: Importer[sync] | FileImporter[sync], url: URL): typingsJapgolly.sassEmbedded.distTypesOptionsMod.StringOptionsWithImporter[sync] = {
      val __obj = js.Dynamic.literal(importer = importer.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.sassEmbedded.distTypesOptionsMod.StringOptionsWithImporter[sync]]
    }
    
    inline def StringOptionsWithoutImporter[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](): typingsJapgolly.sassEmbedded.distTypesOptionsMod.StringOptionsWithoutImporter[sync] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.sassEmbedded.distTypesOptionsMod.StringOptionsWithoutImporter[sync]]
    }
  }
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.sassEmbedded.distTypesOptionsMod.StringOptions because Already inherited */ trait StringOptionsWithImporter[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */]
    extends StObject
  ...
  object StringOptionsWithImporter {
    ...
    inline def apply[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](importer: Importer[sync] | FileImporter[sync], url: URL): StringOptionsWithImporter[sync] = {
      val __obj = js.Dynamic.literal(importer = importer.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
      __obj.asInstanceOf[StringOptionsWithImporter[sync]]
    }
    
    extension [Self <: StringOptionsWithImporter[?], sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](x: Self & StringOptionsWithImporter[sync]) {
  ...
  trait StringOptionsWithoutImporter[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */]
    extends StObject
       with Options[sync]
  ...
  object StringOptionsWithoutImporter {
    ...
    inline def apply[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](): StringOptionsWithoutImporter[sync] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[StringOptionsWithoutImporter[sync]]
    }
    
    extension [Self <: StringOptionsWithoutImporter[?], sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](x: Self & StringOptionsWithoutImporter[sync]) {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sassEmbedded.sassEmbeddedStrings.scss
    - typingsJapgolly.sassEmbedded.sassEmbeddedStrings.indented
    - typingsJapgolly.sassEmbedded.sassEmbeddedStrings.css
  */
  trait Syntax extends StObject
  object Syntax {
    
    inline def css: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.css = "css".asInstanceOf[typingsJapgolly.sassEmbedded.sassEmbeddedStrings.css]
    
    inline def indented: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.indented = "indented".asInstanceOf[typingsJapgolly.sassEmbedded.sassEmbeddedStrings.indented]
    
    inline def scss: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.scss = "scss".asInstanceOf[typingsJapgolly.sassEmbedded.sassEmbeddedStrings.scss]
  }
}
