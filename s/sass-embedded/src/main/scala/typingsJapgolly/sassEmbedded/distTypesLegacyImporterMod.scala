...
import typingsJapgolly.sassEmbedded.anon.Context
...
object distTypesLegacyImporterMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sassEmbedded.anon.File
    - typingsJapgolly.sassEmbedded.anon.Contents
    - js.Error
    - scala.Null
  */
  ...
  object _LegacyImporterResult {
    ...
    inline def Contents(contents: String): typingsJapgolly.sassEmbedded.anon.Contents = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.sassEmbedded.anon.Contents]
    }
    
    inline def File(file: String): typingsJapgolly.sassEmbedded.anon.File = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.sassEmbedded.anon.File]
    }
  }
}
