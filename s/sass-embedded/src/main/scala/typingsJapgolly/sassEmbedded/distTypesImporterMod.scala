...
import typingsJapgolly.sassEmbedded.anon.FromImport
import typingsJapgolly.sassEmbedded.distTypesOptionsMod.Syntax
import typingsJapgolly.sassEmbedded.distTypesUtilPromiseOrMod.PromiseOr
import typingsJapgolly.sassEmbedded.sassEmbeddedStrings.async
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTypesImporterMod {
  
  trait FileImporter[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject {
  ...
  object FileImporter {
    ...
    inline def apply[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](findFileUrl: (String, FromImport) => PromiseOr[URL | Null, sync]): FileImporter[sync] = {
      val __obj = js.Dynamic.literal(findFileUrl = js.Any.fromFunction2(findFileUrl))
      __obj.asInstanceOf[FileImporter[sync]]
    }
    
    extension [Self <: FileImporter[?], sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](x: Self & FileImporter[sync]) {
  ...
  trait Importer[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */] extends StObject {
  ...
  object Importer {
    ...
    inline def apply[sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](
    ...
    extension [Self <: Importer[?], sync /* <: typingsJapgolly.sassEmbedded.sassEmbeddedStrings.sync | async */](x: Self & Importer[sync]) {
