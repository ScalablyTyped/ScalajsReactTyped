package typingsJapgolly.serveStatic

import typingsJapgolly.node.httpMod.IncomingMessage
import typingsJapgolly.node.httpMod.ServerResponse
import typingsJapgolly.serveStatic.serveStaticBooleans.`false`
...
object mod {
  ...
  @js.native
  def mime: typingsJapgolly.mime.mimeMod.^ = js.native
  inline def mime_=(x: typingsJapgolly.mime.mimeMod.^): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("mime")(x.asInstanceOf[js.Any])
  ...
  trait RequestHandlerConstructor[R /* <: ServerResponse[IncomingMessage] */] extends StObject {
    ...
    var mime: typingsJapgolly.mime.mimeMod.^ = js.native
  }
