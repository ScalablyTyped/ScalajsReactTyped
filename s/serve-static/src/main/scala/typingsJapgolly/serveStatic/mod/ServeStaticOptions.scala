package typingsJapgolly.serveStatic.mod
...
object ServeStaticOptions {
  ...
  def apply(
    ...
    if (setHeaders != null) __obj.updateDynamic("setHeaders")(js.Any.fromFunction3((t0: /* res */ typingsJapgolly.expressServeStaticCore.mod.Response[js.Any], t1: /* path */ java.lang.String, t2: /* stat */ js.Any) => setHeaders(t0, t1, t2).runNow()))
