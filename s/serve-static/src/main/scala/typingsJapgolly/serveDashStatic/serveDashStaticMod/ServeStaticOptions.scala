package typingsJapgolly.serveDashStatic.serveDashStaticMod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.expressDashServeDashStaticDashCore.expressDashServeDashStaticDashCoreMod.Response
