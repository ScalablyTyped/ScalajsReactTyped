...
object StripeCheckoutOptions {
  ...
  extension [Self <: StripeCheckoutOptions](x: Self) {
    ...
    inline def setOpened(value: Callback): Self = StObject.set(x, "opened", value.toJsFn)
    ...
    inline def setSource(value: /* source */ Source => Callback): Self = StObject.set(x, "source", js.Any.fromFunction1((t0: /* source */ Source) => value(t0).runNow()))
    
    inline def setSourceUndefined: Self = StObject.set(x, "source", js.undefined)
    
    inline def setToken(value: /* token */ Token => Callback): Self = StObject.set(x, "token", js.Any.fromFunction1((t0: /* token */ Token) => value(t0).runNow()))
