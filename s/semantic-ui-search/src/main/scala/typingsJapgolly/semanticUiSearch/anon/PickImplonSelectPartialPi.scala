...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'onSelect'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplonSelectPartialPi
  extends StObject
     with Param {
...
object PickImplonSelectPartialPi {
  ...
  extension [Self <: PickImplonSelectPartialPi](x: Self) {
