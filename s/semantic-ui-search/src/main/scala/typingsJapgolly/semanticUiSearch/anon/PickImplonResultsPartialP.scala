...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'onResults'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplonResultsPartialP
  extends StObject
     with Param {
...
object PickImplonResultsPartialP {
  ...
  extension [Self <: PickImplonResultsPartialP](x: Self) {
