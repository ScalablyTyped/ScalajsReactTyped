...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl, 'results'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl, keyof semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl>> */
trait PickImplresultsPartialPic
  extends StObject
     with Param {
...
object PickImplresultsPartialPic {
  
  inline def apply(results: String & js.UndefOr[String]): PickImplresultsPartialPic = {
    val __obj = js.Dynamic.literal(results = results.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplresultsPartialPic]
  }
  
  extension [Self <: PickImplresultsPartialPic](x: Self) {
