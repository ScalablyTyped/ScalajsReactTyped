...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'hideDelay'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplhideDelayPartialP
  extends StObject
     with Param {
...
object PickImplhideDelayPartialP {
  ...
  extension [Self <: PickImplhideDelayPartialP](x: Self) {
