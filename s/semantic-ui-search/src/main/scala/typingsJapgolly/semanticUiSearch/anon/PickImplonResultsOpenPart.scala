...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'onResultsOpen'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplonResultsOpenPart
  extends StObject
     with Param {
...
object PickImplonResultsOpenPart {
  ...
  extension [Self <: PickImplonResultsOpenPart](x: Self) {
