...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'maxResults'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
trait PickImplmaxResultsPartial
  extends StObject
     with Param {
...
object PickImplmaxResultsPartial {
  ...
  extension [Self <: PickImplmaxResultsPartial](x: Self) {
