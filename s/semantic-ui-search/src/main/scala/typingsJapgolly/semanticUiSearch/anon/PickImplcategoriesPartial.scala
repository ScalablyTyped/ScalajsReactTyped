...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl, 'categories'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl, keyof semantic-ui-search.SemanticUI.Search.FieldsSettings._Impl>> */
trait PickImplcategoriesPartial
  extends StObject
     with Param {
...
object PickImplcategoriesPartial {
  ...
  extension [Self <: PickImplcategoriesPartial](x: Self) {
