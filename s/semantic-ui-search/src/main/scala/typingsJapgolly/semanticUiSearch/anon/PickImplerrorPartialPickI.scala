...
/* Inlined std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, 'error'> & std.Partial<std.Pick<semantic-ui-search.SemanticUI.SearchSettings._Impl, keyof semantic-ui-search.SemanticUI.SearchSettings._Impl>> */
