package typingsJapgolly.sinonjsCommons

import typingsJapgolly.sinonjsCommons.typesCalledInOrderMod.SinonProxy
...
object mod {
  ...
  val orderByFirstCall: js.Function1[
    /* spies */ js.Array[typingsJapgolly.sinonjsCommons.typesOrderByFirstCallMod.SinonProxy] | typingsJapgolly.sinonjsCommons.typesOrderByFirstCallMod.SinonProxy, 
    js.Array[typingsJapgolly.sinonjsCommons.typesOrderByFirstCallMod.SinonProxy]
  ] = js.native
