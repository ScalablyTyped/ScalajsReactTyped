...
import typingsJapgolly.seatsio.Seatsio.ChartManager
import typingsJapgolly.seatsio.Seatsio.EventManager
import typingsJapgolly.seatsio.Seatsio.SeatingChart
import typingsJapgolly.seatsio.Seatsio.SeatingChartDesigner
import typingsJapgolly.seatsio.anon.Amount
import typingsJapgolly.seatsio.anon.ConfirmSelectionOnMobile
import typingsJapgolly.seatsio.anon.DictticketType
import typingsJapgolly.seatsio.anon.Disabled
import typingsJapgolly.seatsio.anon.Enabled
import typingsJapgolly.seatsio.anon.HideNonSelectableCategories
import typingsJapgolly.seatsio.anon.Label
import typingsJapgolly.seatsio.anon.LabelPrice
import typingsJapgolly.seatsio.anon.Own
import typingsJapgolly.seatsio.anon.Price
import typingsJapgolly.seatsio.anon.TicketType
import typingsJapgolly.seatsio.anon.X
import typingsJapgolly.seatsio.anon.`0`
import typingsJapgolly.seatsio.seatsioInts.`5`
import typingsJapgolly.seatsio.seatsioStrings.Lato
import typingsJapgolly.seatsio.seatsioStrings.Montserrat
import typingsJapgolly.seatsio.seatsioStrings.NotoSansHK
import typingsJapgolly.seatsio.seatsioStrings.Roboto
import typingsJapgolly.seatsio.seatsioStrings.WorkSans
import typingsJapgolly.seatsio.seatsioStrings.`3d`
import typingsJapgolly.seatsio.seatsioStrings.asymmetrical
import typingsJapgolly.seatsio.seatsioStrings.bolder
import typingsJapgolly.seatsio.seatsioStrings.continue
import typingsJapgolly.seatsio.seatsioStrings.fillEnabled
import typingsJapgolly.seatsio.seatsioStrings.fillHighlightedOption
import typingsJapgolly.seatsio.seatsioStrings.manageChannels
import typingsJapgolly.seatsio.seatsioStrings.manageForSaleConfig
import typingsJapgolly.seatsio.seatsioStrings.manageObjectStatuses
import typingsJapgolly.seatsio.seatsioStrings.manageRulesets
import typingsJapgolly.seatsio.seatsioStrings.manageTableBooking
import typingsJapgolly.seatsio.seatsioStrings.manual
import typingsJapgolly.seatsio.seatsioStrings.max
import typingsJapgolly.seatsio.seatsioStrings.minMax
import typingsJapgolly.seatsio.seatsioStrings.none
import typingsJapgolly.seatsio.seatsioStrings.normal
import typingsJapgolly.seatsio.seatsioStrings.print
import typingsJapgolly.seatsio.seatsioStrings.spacious
import typingsJapgolly.seatsio.seatsioStrings.start
import typingsJapgolly.seatsio.seatsioStrings.static
import typingsJapgolly.seatsio.seatsioStrings.thick
import typingsJapgolly.seatsio.seatsioStrings.width
import typingsJapgolly.seatsio.seatsioStrings.widthAndHeight
...
object Seatsio {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.seatsio.Seatsio.Seat
    - typingsJapgolly.seatsio.Seatsio.GeneralAdmissionArea
    - typingsJapgolly.seatsio.Seatsio.Section
  */
  ...
  trait ChangeableSeatingChartConfig extends StObject {
    ...
    var maxSelectedObjects: js.UndefOr[Double | js.Array[typingsJapgolly.seatsio.anon.Category]] = js.undefined
  ...
  object ChangeableSeatingChartConfig {
    ...
    extension [Self <: ChangeableSeatingChartConfig](x: Self) {
      ...
      inline def setMaxSelectedObjects(value: Double | js.Array[typingsJapgolly.seatsio.anon.Category]): Self = StObject.set(x, "maxSelectedObjects", value.asInstanceOf[js.Any])
      
      inline def setMaxSelectedObjectsUndefined: Self = StObject.set(x, "maxSelectedObjects", js.undefined)
      
      inline def setMaxSelectedObjectsVarargs(value: typingsJapgolly.seatsio.anon.Category*): Self = StObject.set(x, "maxSelectedObjects", js.Array(value*))
  ...
  object ChartManagerConfig {
    ...
    extension [Self <: ChartManagerConfig](x: Self) {
      ...
      inline def setOnChartRendered(value: /* chart */ ChartManager => Callback): Self = StObject.set(x, "onChartRendered", js.Any.fromFunction1((t0: /* chart */ ChartManager) => value(t0).runNow()))
      
      inline def setOnChartRenderedUndefined: Self = StObject.set(x, "onChartRendered", js.undefined)
      
      inline def setOnChartRenderingFailed(value: /* chart */ ChartManager => Callback): Self = StObject.set(x, "onChartRenderingFailed", js.Any.fromFunction1((t0: /* chart */ ChartManager) => value(t0).runNow()))
      
      inline def setOnChartRenderingFailedUndefined: Self = StObject.set(x, "onChartRenderingFailed", js.undefined)
      
      inline def setOnFullScreenClosed(value: Callback): Self = StObject.set(x, "onFullScreenClosed", value.toJsFn)
      
      inline def setOnFullScreenClosedUndefined: Self = StObject.set(x, "onFullScreenClosed", js.undefined)
      
      inline def setOnFullScreenOpened(value: Callback): Self = StObject.set(x, "onFullScreenOpened", value.toJsFn)
      
      inline def setOnFullScreenOpenedUndefined: Self = StObject.set(x, "onFullScreenOpened", js.undefined)
      
      inline def setOnObjectClicked(value: /* object */ BookableObject => Callback): Self = StObject.set(x, "onObjectClicked", js.Any.fromFunction1((t0: /* object */ BookableObject) => value(t0).runNow()))
      
      inline def setOnObjectClickedUndefined: Self = StObject.set(x, "onObjectClicked", js.undefined)
      
      inline def setOnObjectDeselected(value: (/* object */ BookableObject, /* deselectedTicketType */ js.UndefOr[Price]) => Callback): Self = StObject.set(x, "onObjectDeselected", js.Any.fromFunction2((t0: /* object */ BookableObject, t1: /* deselectedTicketType */ js.UndefOr[Price]) => (value(t0, t1)).runNow()))
      
      inline def setOnObjectDeselectedUndefined: Self = StObject.set(x, "onObjectDeselected", js.undefined)
      
      inline def setOnObjectSelected(value: (/* object */ BookableObject, /* selectedTicketType */ js.UndefOr[Price]) => Callback): Self = StObject.set(x, "onObjectSelected", js.Any.fromFunction2((t0: /* object */ BookableObject, t1: /* selectedTicketType */ js.UndefOr[Price]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.seatsio.seatsioStrings.light
    - typingsJapgolly.seatsio.seatsioStrings.dark
  */
  trait ColorScheme extends StObject
  object ColorScheme {
    
    inline def dark: typingsJapgolly.seatsio.seatsioStrings.dark = "dark".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.dark]
    
    inline def light: typingsJapgolly.seatsio.seatsioStrings.light = "light".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.light]
  }
  ...
  object EventManagerConfig {
    ...
    extension [Self <: EventManagerConfig](x: Self) {
      ...
      inline def setOnChartRendered(value: /* chart */ EventManager => Callback): Self = StObject.set(x, "onChartRendered", js.Any.fromFunction1((t0: /* chart */ EventManager) => value(t0).runNow()))
      
      inline def setOnChartRenderedUndefined: Self = StObject.set(x, "onChartRendered", js.undefined)
      
      inline def setOnChartRenderingFailed(value: /* chart */ EventManager => Callback): Self = StObject.set(x, "onChartRenderingFailed", js.Any.fromFunction1((t0: /* chart */ EventManager) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.seatsio.Seatsio.PricingConfigSimple
    - typingsJapgolly.seatsio.Seatsio.PricingConfigMulti
  */
  trait PricingConfig extends StObject
  object PricingConfig {
    
    inline def PricingConfigMulti(category: String, ticketTypes: js.Array[LabelPrice]): typingsJapgolly.seatsio.Seatsio.PricingConfigMulti = {
      val __obj = js.Dynamic.literal(category = category.asInstanceOf[js.Any], ticketTypes = ticketTypes.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.seatsio.Seatsio.PricingConfigMulti]
    }
    
    inline def PricingConfigSimple(category: String, price: Double): typingsJapgolly.seatsio.Seatsio.PricingConfigSimple = {
      val __obj = js.Dynamic.literal(category = category.asInstanceOf[js.Any], price = price.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.seatsio.Seatsio.PricingConfigSimple]
    }
  }
  ...
  object SeatingChartConfig {
    ...
    extension [Self <: SeatingChartConfig](x: Self) {
      ...
      inline def setOnBestAvailableSelected(value: (/* objects */ js.Array[BookableObject], /* nextToEachOther */ Boolean | Null) => Callback): Self = StObject.set(x, "onBestAvailableSelected", js.Any.fromFunction2((t0: /* objects */ js.Array[BookableObject], t1: /* nextToEachOther */ Boolean | Null) => (value(t0, t1)).runNow()))
      
      inline def setOnBestAvailableSelectedUndefined: Self = StObject.set(x, "onBestAvailableSelected", js.undefined)
      
      inline def setOnBestAvailableSelectionFailed(value: Callback): Self = StObject.set(x, "onBestAvailableSelectionFailed", value.toJsFn)
      
      inline def setOnBestAvailableSelectionFailedUndefined: Self = StObject.set(x, "onBestAvailableSelectionFailed", js.undefined)
      
      inline def setOnChartRendered(value: /* chart */ SeatingChart => Callback): Self = StObject.set(x, "onChartRendered", js.Any.fromFunction1((t0: /* chart */ SeatingChart) => value(t0).runNow()))
      
      inline def setOnChartRenderedUndefined: Self = StObject.set(x, "onChartRendered", js.undefined)
      
      inline def setOnChartRenderingFailed(value: /* chart */ SeatingChart => Callback): Self = StObject.set(x, "onChartRenderingFailed", js.Any.fromFunction1((t0: /* chart */ SeatingChart) => value(t0).runNow()))
      ...
      inline def setOnHoldFailed(
        value: (/* objects */ js.Array[BookableObject], /* ticketTypes */ js.UndefOr[js.Array[TicketType]]) => Callback
      ): Self = StObject.set(x, "onHoldFailed", js.Any.fromFunction2((t0: /* objects */ js.Array[BookableObject], t1: /* ticketTypes */ js.UndefOr[js.Array[TicketType]]) => (value(t0, t1)).runNow()))
      
      inline def setOnHoldFailedUndefined: Self = StObject.set(x, "onHoldFailed", js.undefined)
      
      inline def setOnHoldSucceeded(
        value: (/* objects */ js.Array[BookableObject], /* ticketTypes */ js.UndefOr[js.Array[TicketType]]) => Callback
      ): Self = StObject.set(x, "onHoldSucceeded", js.Any.fromFunction2((t0: /* objects */ js.Array[BookableObject], t1: /* ticketTypes */ js.UndefOr[js.Array[TicketType]]) => (value(t0, t1)).runNow()))
      
      inline def setOnHoldSucceededUndefined: Self = StObject.set(x, "onHoldSucceeded", js.undefined)
      
      inline def setOnHoldTokenExpired(value: Callback): Self = StObject.set(x, "onHoldTokenExpired", value.toJsFn)
      ...
      inline def setOnObjectMouseOut(value: /* object */ BookableObject => Callback): Self = StObject.set(x, "onObjectMouseOut", js.Any.fromFunction1((t0: /* object */ BookableObject) => value(t0).runNow()))
      
      inline def setOnObjectMouseOutUndefined: Self = StObject.set(x, "onObjectMouseOut", js.undefined)
      
      inline def setOnObjectMouseOver(value: /* object */ BookableObject => Callback): Self = StObject.set(x, "onObjectMouseOver", js.Any.fromFunction1((t0: /* object */ BookableObject) => value(t0).runNow()))
      ...
      inline def setOnReleaseHoldFailed(
        value: (/* objects */ js.Array[BookableObject], /* ticketTypes */ js.UndefOr[js.Array[TicketType]]) => Callback
      ): Self = StObject.set(x, "onReleaseHoldFailed", js.Any.fromFunction2((t0: /* objects */ js.Array[BookableObject], t1: /* ticketTypes */ js.UndefOr[js.Array[TicketType]]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnReleaseHoldSucceeded(
        value: (/* objects */ js.Array[BookableObject], /* ticketTypes */ js.UndefOr[js.Array[TicketType]]) => Callback
      ): Self = StObject.set(x, "onReleaseHoldSucceeded", js.Any.fromFunction2((t0: /* objects */ js.Array[BookableObject], t1: /* ticketTypes */ js.UndefOr[js.Array[TicketType]]) => (value(t0, t1)).runNow()))
      
      inline def setOnReleaseHoldSucceededUndefined: Self = StObject.set(x, "onReleaseHoldSucceeded", js.undefined)
      
      inline def setOnSelectedObjectBooked(value: /* object */ BookableObject => Callback): Self = StObject.set(x, "onSelectedObjectBooked", js.Any.fromFunction1((t0: /* object */ BookableObject) => value(t0).runNow()))
      
      inline def setOnSelectedObjectBookedUndefined: Self = StObject.set(x, "onSelectedObjectBooked", js.undefined)
      
      inline def setOnSelectionInvalid(value: /* violations */ js.Array[Violations] => Callback): Self = StObject.set(x, "onSelectionInvalid", js.Any.fromFunction1((t0: /* violations */ js.Array[Violations]) => value(t0).runNow()))
      
      inline def setOnSelectionInvalidUndefined: Self = StObject.set(x, "onSelectionInvalid", js.undefined)
      
      inline def setOnSelectionValid(value: Callback): Self = StObject.set(x, "onSelectionValid", value.toJsFn)
  ...
  object SeatingChartDesignerConfig {
    ...
    extension [Self <: SeatingChartDesignerConfig](x: Self) {
      ...
      inline def setOnChartCreated(value: /* chartKey */ String => Callback): Self = StObject.set(x, "onChartCreated", js.Any.fromFunction1((t0: /* chartKey */ String) => value(t0).runNow()))
      
      inline def setOnChartCreatedUndefined: Self = StObject.set(x, "onChartCreated", js.undefined)
      
      inline def setOnChartPublished(value: /* chartKey */ String => Callback): Self = StObject.set(x, "onChartPublished", js.Any.fromFunction1((t0: /* chartKey */ String) => value(t0).runNow()))
      
      inline def setOnChartPublishedUndefined: Self = StObject.set(x, "onChartPublished", js.undefined)
      
      inline def setOnChartUpdated(value: /* chartKey */ String => Callback): Self = StObject.set(x, "onChartUpdated", js.Any.fromFunction1((t0: /* chartKey */ String) => value(t0).runNow()))
      
      inline def setOnChartUpdatedUndefined: Self = StObject.set(x, "onChartUpdated", js.undefined)
      
      inline def setOnDesignerRendered(value: /* designer */ SeatingChartDesigner => Callback): Self = StObject.set(x, "onDesignerRendered", js.Any.fromFunction1((t0: /* designer */ SeatingChartDesigner) => value(t0).runNow()))
      
      inline def setOnDesignerRenderedUndefined: Self = StObject.set(x, "onDesignerRendered", js.undefined)
      
      inline def setOnDesignerRenderingFailed(value: /* designer */ SeatingChartDesigner => Callback): Self = StObject.set(x, "onDesignerRenderingFailed", js.Any.fromFunction1((t0: /* designer */ SeatingChartDesigner) => value(t0).runNow()))
      
      inline def setOnDesignerRenderingFailedUndefined: Self = StObject.set(x, "onDesignerRenderingFailed", js.undefined)
      
      inline def setOnExitRequested(value: Callback): Self = StObject.set(x, "onExitRequested", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.seatsio.anon.Highlight
    - typingsJapgolly.seatsio.anon.Type
  */
  trait SelectionValidator extends StObject
  object SelectionValidator {
    
    inline def Highlight(): typingsJapgolly.seatsio.anon.Highlight = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("noOrphanSeats")
      __obj.asInstanceOf[typingsJapgolly.seatsio.anon.Highlight]
    }
    
    inline def Type(): typingsJapgolly.seatsio.anon.Type = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("consecutiveSeats")
      __obj.asInstanceOf[typingsJapgolly.seatsio.anon.Type]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.seatsio.seatsioStrings.balance
    - typingsJapgolly.seatsio.seatsioStrings.bubblegum
    - typingsJapgolly.seatsio.seatsioStrings.flathead
    - typingsJapgolly.seatsio.seatsioStrings.bezels
    - typingsJapgolly.seatsio.seatsioStrings.leaf
  */
  trait StylePreset extends StObject
  object StylePreset {
    
    inline def balance: typingsJapgolly.seatsio.seatsioStrings.balance = "balance".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.balance]
    
    inline def bezels: typingsJapgolly.seatsio.seatsioStrings.bezels = "bezels".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.bezels]
    
    inline def bubblegum: typingsJapgolly.seatsio.seatsioStrings.bubblegum = "bubblegum".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.bubblegum]
    
    inline def flathead: typingsJapgolly.seatsio.seatsioStrings.flathead = "flathead".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.flathead]
    
    inline def leaf: typingsJapgolly.seatsio.seatsioStrings.leaf = "leaf".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.leaf]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.seatsio.seatsioStrings.noOrphanSeats
    - typingsJapgolly.seatsio.seatsioStrings.consecutiveSeats
  */
  trait Violations extends StObject
  object Violations {
    
    inline def consecutiveSeats: typingsJapgolly.seatsio.seatsioStrings.consecutiveSeats = "consecutiveSeats".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.consecutiveSeats]
    
    inline def noOrphanSeats: typingsJapgolly.seatsio.seatsioStrings.noOrphanSeats = "noOrphanSeats".asInstanceOf[typingsJapgolly.seatsio.seatsioStrings.noOrphanSeats]
  }
}
