package typingsJapgolly.saslAnonymous
...
object mod {
  ...
  object AnonymousMechanism {
    ...
    inline def apply(challenge: String => Callback, response: Credentials => String): AnonymousMechanism = {
      val __obj = js.Dynamic.literal(challenge = js.Any.fromFunction1((t0: String) => challenge(t0).runNow()), clientFirst = true, name = "ANONYMOUS", response = js.Any.fromFunction1(response))
