...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.streamtest.streamtestStrings.v1
    - typingsJapgolly.streamtest.streamtestStrings.v2
  */
  trait VersionName extends StObject
  object VersionName {
    
    inline def v1: typingsJapgolly.streamtest.streamtestStrings.v1 = "v1".asInstanceOf[typingsJapgolly.streamtest.streamtestStrings.v1]
    
    inline def v2: typingsJapgolly.streamtest.streamtestStrings.v2 = "v2".asInstanceOf[typingsJapgolly.streamtest.streamtestStrings.v2]
  }
}
