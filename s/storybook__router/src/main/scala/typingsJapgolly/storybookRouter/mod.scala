...
import typingsJapgolly.storybookRouter.anon.Path
import typingsJapgolly.storybookRouter.anon.Plain
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterDomIndexMod.BrowserRouterProps
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.NavigateFunction
...
object mod {
  ...
  object Link {
    ...
    inline def apply(hasToChildrenRest: LinkProps): typingsJapgolly.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].apply(hasToChildrenRest.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  ...
  object Location {
    ...
    inline def apply(hasChildren: LocationProps): typingsJapgolly.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].apply(hasChildren.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  ...
  @js.native
  val LocationProvider: js.Function1[
    /* hasBasenameChildrenWindow */ BrowserRouterProps, 
  ...
  object Match {
    ...
    inline def apply(hasChildrenTargetPathStartsWith: MatchProps): typingsJapgolly.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].apply(hasChildrenTargetPathStartsWith.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  ...
  object Route {
    ...
    inline def apply(hasPathChildrenStartsWithHideOnly: RouteProps): typingsJapgolly.react.mod.global.JSX.Element = ^.asInstanceOf[js.Dynamic].apply(hasPathChildrenStartsWithHideOnly.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.react.mod.global.JSX.Element]
  ...
  object LocationProps {
    ...
    inline def apply(children: RenderData => Node): LocationProps = {
    ...
    extension [Self <: LocationProps](x: Self) {
      ...
      inline def setChildren(value: RenderData => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
  ...
  object MatchProps {
    ...
    inline def apply(children: MatchingData => Node, path: String, startsWith: Boolean): MatchProps = {
    ...
    extension [Self <: MatchProps](x: Self) {
      ...
      inline def setChildren(value: MatchingData => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  object RouteProps {
    ...
    inline def apply(path: String): RouteProps = {
      val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any], children = null)
