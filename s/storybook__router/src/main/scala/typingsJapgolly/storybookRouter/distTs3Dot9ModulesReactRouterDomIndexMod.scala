...
import typingsJapgolly.storybookRouter.anon.Replace
import typingsJapgolly.storybookRouter.anon.State
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.IndexRouteProps
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.LayoutRouteProps
...
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.NavigateProps
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.OutletProps
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.Params
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.PathMatch
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.PathPattern
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.PathRouteProps
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.RouteMatch
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterIndexMod.RouteObject
...
object distTs3Dot9ModulesReactRouterDomIndexMod {
  ...
  inline def Outlet(_props: OutletProps): japgolly.scalajs.react.facade.React.Element | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("Outlet")(_props.asInstanceOf[js.Any]).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
  
  inline def Route(_props: IndexRouteProps): japgolly.scalajs.react.facade.React.Element | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("Route")(_props.asInstanceOf[js.Any]).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
  inline def Route(_props: LayoutRouteProps): japgolly.scalajs.react.facade.React.Element | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("Route")(_props.asInstanceOf[js.Any]).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
  inline def Route(_props: PathRouteProps): japgolly.scalajs.react.facade.React.Element | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("Route")(_props.asInstanceOf[js.Any]).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
  ...
  inline def renderMatches(matches: js.Array[RouteMatch[String]]): japgolly.scalajs.react.facade.React.Element | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("renderMatches")(matches.asInstanceOf[js.Any]).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
  ...
  inline def useLinkClickHandler[E /* <: org.scalajs.dom.Element */](to: To, hasTargetReplacePropState: Replace): js.Function1[/* event */ ReactMouseEventFrom[E & org.scalajs.dom.Element], Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("useLinkClickHandler")(to.asInstanceOf[js.Any], hasTargetReplacePropState.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* event */ ReactMouseEventFrom[E & org.scalajs.dom.Element], Unit]]
  ...
  inline def useRoutes(routes: js.Array[RouteObject], locationArg: PartialLocation): japgolly.scalajs.react.facade.React.Element | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("useRoutes")(routes.asInstanceOf[js.Any], locationArg.asInstanceOf[js.Any])).asInstanceOf[japgolly.scalajs.react.facade.React.Element | Null]
