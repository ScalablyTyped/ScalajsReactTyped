...
import typingsJapgolly.storybookRouter.anon.IsActive
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterDomIndexMod.NavLinkProps
import typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.To
import typingsJapgolly.storybookRouter.storybookRouterStrings.`additions removals`
import typingsJapgolly.storybookRouter.storybookRouterStrings.`additions text`
import typingsJapgolly.storybookRouter.storybookRouterStrings.`inline`
import typingsJapgolly.storybookRouter.storybookRouterStrings.`removals additions`
import typingsJapgolly.storybookRouter.storybookRouterStrings.`removals text`
import typingsJapgolly.storybookRouter.storybookRouterStrings.`text additions`
import typingsJapgolly.storybookRouter.storybookRouterStrings.`text removals`
import typingsJapgolly.storybookRouter.storybookRouterStrings.additions
import typingsJapgolly.storybookRouter.storybookRouterStrings.all
import typingsJapgolly.storybookRouter.storybookRouterStrings.ascending
import typingsJapgolly.storybookRouter.storybookRouterStrings.assertive
import typingsJapgolly.storybookRouter.storybookRouterStrings.both
import typingsJapgolly.storybookRouter.storybookRouterStrings.copy
import typingsJapgolly.storybookRouter.storybookRouterStrings.date
import typingsJapgolly.storybookRouter.storybookRouterStrings.decimal
import typingsJapgolly.storybookRouter.storybookRouterStrings.descending
import typingsJapgolly.storybookRouter.storybookRouterStrings.dialog
import typingsJapgolly.storybookRouter.storybookRouterStrings.email
import typingsJapgolly.storybookRouter.storybookRouterStrings.execute
import typingsJapgolly.storybookRouter.storybookRouterStrings.grammar
import typingsJapgolly.storybookRouter.storybookRouterStrings.grid
import typingsJapgolly.storybookRouter.storybookRouterStrings.horizontal
import typingsJapgolly.storybookRouter.storybookRouterStrings.inherit
import typingsJapgolly.storybookRouter.storybookRouterStrings.link
import typingsJapgolly.storybookRouter.storybookRouterStrings.list
import typingsJapgolly.storybookRouter.storybookRouterStrings.listbox
import typingsJapgolly.storybookRouter.storybookRouterStrings.location
import typingsJapgolly.storybookRouter.storybookRouterStrings.menu
import typingsJapgolly.storybookRouter.storybookRouterStrings.mixed
import typingsJapgolly.storybookRouter.storybookRouterStrings.move
import typingsJapgolly.storybookRouter.storybookRouterStrings.no
import typingsJapgolly.storybookRouter.storybookRouterStrings.none
import typingsJapgolly.storybookRouter.storybookRouterStrings.numeric
import typingsJapgolly.storybookRouter.storybookRouterStrings.off
import typingsJapgolly.storybookRouter.storybookRouterStrings.on
import typingsJapgolly.storybookRouter.storybookRouterStrings.other
import typingsJapgolly.storybookRouter.storybookRouterStrings.page
import typingsJapgolly.storybookRouter.storybookRouterStrings.polite
import typingsJapgolly.storybookRouter.storybookRouterStrings.popup
import typingsJapgolly.storybookRouter.storybookRouterStrings.removals
import typingsJapgolly.storybookRouter.storybookRouterStrings.search
import typingsJapgolly.storybookRouter.storybookRouterStrings.spelling
import typingsJapgolly.storybookRouter.storybookRouterStrings.step
import typingsJapgolly.storybookRouter.storybookRouterStrings.tel
import typingsJapgolly.storybookRouter.storybookRouterStrings.text
import typingsJapgolly.storybookRouter.storybookRouterStrings.time
import typingsJapgolly.storybookRouter.storybookRouterStrings.tree
import typingsJapgolly.storybookRouter.storybookRouterStrings.url
import typingsJapgolly.storybookRouter.storybookRouterStrings.vertical
import typingsJapgolly.storybookRouter.storybookRouterStrings.yes
...
object NavLink {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def className(value: String | (js.Function1[/* props */ IsActive, String])): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def classNameFunction1(value: /* props */ IsActive => String): this.type = set("className", js.Any.fromFunction1(value))
    ...
    inline def style(value: CSSProperties | (js.Function1[/* props */ IsActive, CSSProperties])): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def styleFunction1(value: /* props */ IsActive => CSSProperties): this.type = set("style", js.Any.fromFunction1(value))
