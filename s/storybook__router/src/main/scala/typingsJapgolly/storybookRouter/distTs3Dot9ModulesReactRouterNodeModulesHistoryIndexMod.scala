...
object distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod {
  ...
  object Action extends StObject {
    ...
    sealed trait Pop
      extends StObject
         with Action
    /* "POP" */ val Pop: typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.Action.Pop & String = js.native
    ...
    sealed trait Push
      extends StObject
         with Action
    /* "PUSH" */ val Push: typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.Action.Push & String = js.native
    ...
    sealed trait Replace
      extends StObject
         with Action
    /* "REPLACE" */ val Replace: typingsJapgolly.storybookRouter.distTs3Dot9ModulesReactRouterNodeModulesHistoryIndexMod.Action.Replace & String = js.native
  }
  ...
  inline def createPath(hasPathnameSearchHash: typingsJapgolly.storybookRouter.anon.PartialPath): String = ^.asInstanceOf[js.Dynamic].applyDynamic("createPath")(hasPathnameSearchHash.asInstanceOf[js.Any]).asInstanceOf[String]
  
  inline def parsePath(path: String): typingsJapgolly.storybookRouter.anon.PartialPath = ^.asInstanceOf[js.Dynamic].applyDynamic("parsePath")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.storybookRouter.anon.PartialPath]
  ...
  type InitialEntry = String | typingsJapgolly.storybookRouter.anon.PartialLocation
  ...
  type To = String | typingsJapgolly.storybookRouter.anon.PartialPath
  ...
  object Transition {
    ...
    inline def apply(action: Action, location: Location, retry: Callback): Transition = {
      val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any], location = location.asInstanceOf[js.Any], retry = retry.toJsFn)
