...
object distTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sindresorhusIs.sindresorhusIsBooleans.`false`
    - typingsJapgolly.sindresorhusIs.sindresorhusIsInts.`0`
    - typingsJapgolly.sindresorhusIs.sindresorhusIsStrings._empty
    - scala.Null
    - scala.Unit
  */
  ...
  trait WeakRef[T /* <: js.Object */] extends StObject {
    ...
    val toStringTag: typingsJapgolly.sindresorhusIs.sindresorhusIsStrings.WeakRef = js.native
  }
