...
import typingsJapgolly.spotifyApi.spotifyApiStrings.ALBUM
import typingsJapgolly.spotifyApi.spotifyApiStrings.COMPILATION
import typingsJapgolly.spotifyApi.spotifyApiStrings.SINGLE
import typingsJapgolly.spotifyApi.spotifyApiStrings.album_
import typingsJapgolly.spotifyApi.spotifyApiStrings.appears_on
import typingsJapgolly.spotifyApi.spotifyApiStrings.compilation_
import typingsJapgolly.spotifyApi.spotifyApiStrings.day
import typingsJapgolly.spotifyApi.spotifyApiStrings.month
import typingsJapgolly.spotifyApi.spotifyApiStrings.single_
import typingsJapgolly.spotifyApi.spotifyApiStrings.year
...
object RecommendationAlbumObject {
  ...
  extension [Self <: RecommendationAlbumObject](x: Self) {
