...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'refreshOnLoad'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplrefreshOnLoadPart
  extends StObject
     with Param {
...
object PickImplrefreshOnLoadPart {
  ...
  extension [Self <: PickImplrefreshOnLoadPart](x: Self) {
