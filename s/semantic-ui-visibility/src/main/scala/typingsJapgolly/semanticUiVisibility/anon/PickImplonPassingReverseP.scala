...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onPassingReverse'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonPassingReverseP
  extends StObject
     with Param {
  ...
  var onPassingReverse_Original: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
...
object PickImplonPassingReverseP {
  ...
  extension [Self <: PickImplonPassingReverseP](x: Self) {
    ...
    inline def setOnPassingReverse(
      value: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
    ): Self = StObject.set(x, "onPassingReverse", value.asInstanceOf[js.Any])
