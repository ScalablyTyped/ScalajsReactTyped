...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onBottomVisibleReverse'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonBottomVisibleRe
  extends StObject
     with Param {
  ...
  var onBottomVisibleReverse_Original: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
...
object PickImplonBottomVisibleRe {
  ...
  extension [Self <: PickImplonBottomVisibleRe](x: Self) {
    ...
    inline def setOnBottomVisibleReverse(
      value: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
    ): Self = StObject.set(x, "onBottomVisibleReverse", value.asInstanceOf[js.Any])
