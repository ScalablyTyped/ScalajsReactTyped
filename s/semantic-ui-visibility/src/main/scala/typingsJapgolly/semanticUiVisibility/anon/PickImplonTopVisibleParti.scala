package typingsJapgolly.semanticUiVisibility.anon
...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onTopVisible'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonTopVisibleParti
  extends StObject
     with Param {
  ...
  @JSName("onTopVisible")
  var onTopVisible_Original: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
...
object PickImplonTopVisibleParti {
  ...
  extension [Self <: PickImplonTopVisibleParti](x: Self) {
    ...
    inline def setOnTopVisible(
      value: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
    ): Self = StObject.set(x, "onTopVisible", value.asInstanceOf[js.Any])
