...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onTopPassedReverse'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonTopPassedRevers
  extends StObject
     with Param {
  ...
  var onTopPassedReverse_Original: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
...
object PickImplonTopPassedRevers {
  ...
  extension [Self <: PickImplonTopPassedRevers](x: Self) {
    ...
    inline def setOnTopPassedReverse(
      value: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
    ): Self = StObject.set(x, "onTopPassedReverse", value.asInstanceOf[js.Any])
