...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onRefresh'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonRefreshPartialP
  extends StObject
     with Param {
...
object PickImplonRefreshPartialP {
  ...
  extension [Self <: PickImplonRefreshPartialP](x: Self) {
