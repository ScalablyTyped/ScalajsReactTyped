...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onTopVisibleReverse'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonTopVisibleRever
  extends StObject
     with Param {
  ...
  var onTopVisibleReverse_Original: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
...
object PickImplonTopVisibleRever {
  ...
  extension [Self <: PickImplonTopVisibleRever](x: Self) {
    ...
    inline def setOnTopVisibleReverse(
      value: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
    ): Self = StObject.set(x, "onTopVisibleReverse", value.asInstanceOf[js.Any])
