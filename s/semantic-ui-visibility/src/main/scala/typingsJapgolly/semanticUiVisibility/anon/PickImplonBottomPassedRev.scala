...
/* Inlined std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, 'onBottomPassedReverse'> & std.Partial<std.Pick<semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl, keyof semantic-ui-visibility.SemanticUI.VisibilitySettings._Impl>> */
trait PickImplonBottomPassedRev
  extends StObject
     with Param {
  ...
  var onBottomPassedReverse_Original: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
...
object PickImplonBottomPassedRev {
  ...
  extension [Self <: PickImplonBottomPassedRev](x: Self) {
    ...
    inline def setOnBottomPassedReverse(
      value: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
    ): Self = StObject.set(x, "onBottomPassedReverse", value.asInstanceOf[js.Any])
