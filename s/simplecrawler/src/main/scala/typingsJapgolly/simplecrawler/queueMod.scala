...
import typingsJapgolly.simplecrawler.anon.ActualDataSize
import typingsJapgolly.simplecrawler.simplecrawlerInts.`0`
import typingsJapgolly.simplecrawler.simplecrawlerInts.`1`
...
object queueMod {
  ...
  */
  ...
  object QueueItemStatus {
    ...
    inline def downloaded: typingsJapgolly.simplecrawler.simplecrawlerStrings.downloaded = "downloaded".asInstanceOf[typingsJapgolly.simplecrawler.simplecrawlerStrings.downloaded]
    
    inline def failed: typingsJapgolly.simplecrawler.simplecrawlerStrings.failed = "failed".asInstanceOf[typingsJapgolly.simplecrawler.simplecrawlerStrings.failed]
    
    inline def headers: typingsJapgolly.simplecrawler.simplecrawlerStrings.headers = "headers".asInstanceOf[typingsJapgolly.simplecrawler.simplecrawlerStrings.headers]
    
    inline def notfound: typingsJapgolly.simplecrawler.simplecrawlerStrings.notfound = "notfound".asInstanceOf[typingsJapgolly.simplecrawler.simplecrawlerStrings.notfound]
    
    inline def queued: typingsJapgolly.simplecrawler.simplecrawlerStrings.queued = "queued".asInstanceOf[typingsJapgolly.simplecrawler.simplecrawlerStrings.queued]
    
    inline def redirected: typingsJapgolly.simplecrawler.simplecrawlerStrings.redirected = "redirected".asInstanceOf[typingsJapgolly.simplecrawler.simplecrawlerStrings.redirected]
    
    inline def spooled: typingsJapgolly.simplecrawler.simplecrawlerStrings.spooled = "spooled".asInstanceOf[typingsJapgolly.simplecrawler.simplecrawlerStrings.spooled]
  }
}
