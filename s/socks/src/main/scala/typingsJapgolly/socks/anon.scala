...
import typingsJapgolly.socks.typingsCommonConstantsMod.SocksProxyType
...
object anon {
  ...
  object Customauthmethod {
    ...
    extension [Self <: Customauthmethod](x: Self) {
      ...
      inline def setCustom_auth_request_handler(value: CallbackTo[js.Promise[Buffer]]): Self = StObject.set(x, "custom_auth_request_handler", value.toJsFn)
