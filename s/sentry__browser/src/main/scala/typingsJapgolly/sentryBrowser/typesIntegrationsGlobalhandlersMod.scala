...
object typesIntegrationsGlobalhandlersMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sentryBrowser.sentryBrowserStrings.onerror
    - typingsJapgolly.sentryBrowser.sentryBrowserStrings.onunhandledrejection
  */
  trait GlobalHandlersIntegrationsOptionKeys extends StObject
  object GlobalHandlersIntegrationsOptionKeys {
    
    inline def onerror: typingsJapgolly.sentryBrowser.sentryBrowserStrings.onerror = "onerror".asInstanceOf[typingsJapgolly.sentryBrowser.sentryBrowserStrings.onerror]
    
    inline def onunhandledrejection: typingsJapgolly.sentryBrowser.sentryBrowserStrings.onunhandledrejection = "onunhandledrejection".asInstanceOf[typingsJapgolly.sentryBrowser.sentryBrowserStrings.onunhandledrejection]
  }
}
