...
object anon {
  ...
  trait Mechanism extends StObject {
    ...
    var mechanism: js.UndefOr[typingsJapgolly.sentryTypes.typesMechanismMod.Mechanism] = js.undefined
  }
  object Mechanism {
    ...
    extension [Self <: Mechanism](x: Self) {
      ...
      inline def setMechanism(value: typingsJapgolly.sentryTypes.typesMechanismMod.Mechanism): Self = StObject.set(x, "mechanism", value.asInstanceOf[js.Any])
