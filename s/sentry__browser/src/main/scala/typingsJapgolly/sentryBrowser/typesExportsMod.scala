...
object typesExportsMod {
  ...
  open class BrowserClient protected ()
    extends typingsJapgolly.sentryBrowser.typesClientMod.BrowserClient {
    /**
  ...
  open class FunctionToString ()
    extends typingsJapgolly.sentryCore.mod.FunctionToString
  /* static members */
  ...
  open class InboundFilters ()
    extends typingsJapgolly.sentryCore.mod.InboundFilters {
