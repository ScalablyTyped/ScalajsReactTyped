...
object Run {
  ...
  */
  ...
  object columnKind {
    ...
    inline def unicodeCodePoints: typingsJapgolly.sarif.sarifStrings.unicodeCodePoints = "unicodeCodePoints".asInstanceOf[typingsJapgolly.sarif.sarifStrings.unicodeCodePoints]
    
    inline def utf16CodeUnits: typingsJapgolly.sarif.sarifStrings.utf16CodeUnits = "utf16CodeUnits".asInstanceOf[typingsJapgolly.sarif.sarifStrings.utf16CodeUnits]
  }
}
