...
import typingsJapgolly.sarif.mod.ThreadFlowLocation.importance
...
object ThreadFlowLocation {
  ...
  */
  ...
  object importance {
    ...
    inline def essential: typingsJapgolly.sarif.sarifStrings.essential = "essential".asInstanceOf[typingsJapgolly.sarif.sarifStrings.essential]
    
    inline def important: typingsJapgolly.sarif.sarifStrings.important = "important".asInstanceOf[typingsJapgolly.sarif.sarifStrings.important]
    
    inline def unimportant: typingsJapgolly.sarif.sarifStrings.unimportant = "unimportant".asInstanceOf[typingsJapgolly.sarif.sarifStrings.unimportant]
  }
}
