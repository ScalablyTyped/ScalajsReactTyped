...
import typingsJapgolly.sarif.mod.Result.kind
import typingsJapgolly.sarif.mod.Result.level
...
object Result {
  ...
  */
  ...
  object baselineState {
    ...
    inline def absent: typingsJapgolly.sarif.sarifStrings.absent = "absent".asInstanceOf[typingsJapgolly.sarif.sarifStrings.absent]
    
    inline def `new`: typingsJapgolly.sarif.sarifStrings.`new` = "new".asInstanceOf[typingsJapgolly.sarif.sarifStrings.`new`]
    
    inline def unchanged: typingsJapgolly.sarif.sarifStrings.unchanged = "unchanged".asInstanceOf[typingsJapgolly.sarif.sarifStrings.unchanged]
    
    inline def updated: typingsJapgolly.sarif.sarifStrings.updated = "updated".asInstanceOf[typingsJapgolly.sarif.sarifStrings.updated]
  }
  ...
  */
  ...
  object kind {
    ...
    inline def fail: typingsJapgolly.sarif.sarifStrings.fail = "fail".asInstanceOf[typingsJapgolly.sarif.sarifStrings.fail]
    
    inline def informational: typingsJapgolly.sarif.sarifStrings.informational = "informational".asInstanceOf[typingsJapgolly.sarif.sarifStrings.informational]
    
    inline def notApplicable: typingsJapgolly.sarif.sarifStrings.notApplicable = "notApplicable".asInstanceOf[typingsJapgolly.sarif.sarifStrings.notApplicable]
    
    inline def open: typingsJapgolly.sarif.sarifStrings.open = "open".asInstanceOf[typingsJapgolly.sarif.sarifStrings.open]
    
    inline def pass: typingsJapgolly.sarif.sarifStrings.pass = "pass".asInstanceOf[typingsJapgolly.sarif.sarifStrings.pass]
    
    inline def review: typingsJapgolly.sarif.sarifStrings.review = "review".asInstanceOf[typingsJapgolly.sarif.sarifStrings.review]
  }
