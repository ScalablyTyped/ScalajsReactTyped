...
object ToolComponent {
  ...
  */
  ...
  object contents {
    ...
    inline def localizedData: typingsJapgolly.sarif.sarifStrings.localizedData = "localizedData".asInstanceOf[typingsJapgolly.sarif.sarifStrings.localizedData]
    
    inline def nonLocalizedData: typingsJapgolly.sarif.sarifStrings.nonLocalizedData = "nonLocalizedData".asInstanceOf[typingsJapgolly.sarif.sarifStrings.nonLocalizedData]
  }
}
