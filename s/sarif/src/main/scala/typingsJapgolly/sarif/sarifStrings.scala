package typingsJapgolly.sarif

import typingsJapgolly.sarif.mod.Artifact.roles
import typingsJapgolly.sarif.mod.ReportingConfiguration.level
import typingsJapgolly.sarif.mod.Result.baselineState
import typingsJapgolly.sarif.mod.Run.columnKind
import typingsJapgolly.sarif.mod.Suppression.kind
import typingsJapgolly.sarif.mod.Suppression.state
import typingsJapgolly.sarif.mod.ThreadFlowLocation.importance
import typingsJapgolly.sarif.mod.ToolComponent.contents
...
object sarifStrings {
  ...
  sealed trait error
    extends level
       with typingsJapgolly.sarif.mod.Notification.level
       with typingsJapgolly.sarif.mod.Result.level
  ...
  @js.native
  sealed trait fail
    extends typingsJapgolly.sarif.mod.Result.kind
