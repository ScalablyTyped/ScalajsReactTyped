...
object Options {
  ...
  def apply(
    ...
    rename: (/* fileName */ String, /* fileInfo */ FileInfo) => CallbackTo[String] = null,
    ...
    if (rename != null) __obj.updateDynamic("rename")(js.Any.fromFunction2((t0: /* fileName */ java.lang.String, t1: /* fileInfo */ typingsJapgolly.socketIoFile.mod.FileInfo) => rename(t0, t1).runNow()))
