...
object distTypesParserTokenizerMod {
  ...
  object IdentifierRole extends StObject {
    ...
    sealed trait Access
      extends StObject
         with IdentifierRole
    /* 0 */ val Access: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.Access & Double = js.native
    
    @js.native
    sealed trait BlockScopedDeclaration
      extends StObject
         with IdentifierRole
    /* 4 */ val BlockScopedDeclaration: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.BlockScopedDeclaration & Double = js.native
    
    @js.native
    sealed trait ExportAccess
      extends StObject
         with IdentifierRole
    /* 1 */ val ExportAccess: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.ExportAccess & Double = js.native
    
    @js.native
    sealed trait FunctionScopedDeclaration
      extends StObject
         with IdentifierRole
    /* 3 */ val FunctionScopedDeclaration: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.FunctionScopedDeclaration & Double = js.native
    
    @js.native
    sealed trait ImportAccess
      extends StObject
         with IdentifierRole
    /* 11 */ val ImportAccess: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.ImportAccess & Double = js.native
    
    @js.native
    sealed trait ImportDeclaration
      extends StObject
         with IdentifierRole
    /* 9 */ val ImportDeclaration: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.ImportDeclaration & Double = js.native
    
    @js.native
    sealed trait ObjectKey
      extends StObject
         with IdentifierRole
    /* 10 */ val ObjectKey: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.ObjectKey & Double = js.native
    
    @js.native
    sealed trait ObjectShorthand
      extends StObject
         with IdentifierRole
    /* 8 */ val ObjectShorthand: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.ObjectShorthand & Double = js.native
    
    @js.native
    sealed trait ObjectShorthandBlockScopedDeclaration
      extends StObject
         with IdentifierRole
    /* 7 */ val ObjectShorthandBlockScopedDeclaration: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.ObjectShorthandBlockScopedDeclaration & Double = js.native
    
    @js.native
    sealed trait ObjectShorthandFunctionScopedDeclaration
      extends StObject
         with IdentifierRole
    /* 6 */ val ObjectShorthandFunctionScopedDeclaration: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.ObjectShorthandFunctionScopedDeclaration & Double = js.native
    
    @js.native
    sealed trait ObjectShorthandTopLevelDeclaration
      extends StObject
         with IdentifierRole
    /* 5 */ val ObjectShorthandTopLevelDeclaration: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.ObjectShorthandTopLevelDeclaration & Double = js.native
    
    @js.native
    sealed trait TopLevelDeclaration
      extends StObject
         with IdentifierRole
    /* 2 */ val TopLevelDeclaration: typingsJapgolly.sucrase.distTypesParserTokenizerMod.IdentifierRole.TopLevelDeclaration & Double = js.native
  }
  ...
  object JSXRole extends StObject {
    ...
    sealed trait KeyAfterPropSpread
      extends StObject
         with JSXRole
    /* 3 */ val KeyAfterPropSpread: typingsJapgolly.sucrase.distTypesParserTokenizerMod.JSXRole.KeyAfterPropSpread & Double = js.native
    
    @js.native
    sealed trait NoChildren
      extends StObject
         with JSXRole
    /* 0 */ val NoChildren: typingsJapgolly.sucrase.distTypesParserTokenizerMod.JSXRole.NoChildren & Double = js.native
    
    @js.native
    sealed trait OneChild
      extends StObject
         with JSXRole
    /* 1 */ val OneChild: typingsJapgolly.sucrase.distTypesParserTokenizerMod.JSXRole.OneChild & Double = js.native
    
    @js.native
    sealed trait StaticChildren
      extends StObject
         with JSXRole
    /* 2 */ val StaticChildren: typingsJapgolly.sucrase.distTypesParserTokenizerMod.JSXRole.StaticChildren & Double = js.native
  }
