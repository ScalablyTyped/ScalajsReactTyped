...
object distTypesCjsimportprocessorMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override val nameManager: typingsJapgolly.sucrase.distTypesNameManagerMod.default = js.native
    ...
    /* CompleteClass */
    override val tokens: typingsJapgolly.sucrase.distTypesTokenProcessorMod.default = js.native
  }
  ...
  trait CJSImportProcessor extends StObject {
    ...
    val nameManager: typingsJapgolly.sucrase.distTypesNameManagerMod.default
    ...
    val tokens: typingsJapgolly.sucrase.distTypesTokenProcessorMod.default
  }
  object CJSImportProcessor {
    ...
    inline def apply(
      ...
      getGlobalNames: CallbackTo[Set[String]],
      ...
      preprocessTokens: Callback,
      preprocessVarExportAtIndex: Any,
      pruneTypeOnlyImports: Callback,
      resolveExportBinding: String => String | Null,
      tokens: typingsJapgolly.sucrase.distTypesTokenProcessorMod.default
    ): CJSImportProcessor = {
      val __obj = js.Dynamic.literal(addExportBinding = addExportBinding.asInstanceOf[js.Any], claimImportCode = js.Any.fromFunction1(claimImportCode), enableLegacyTypeScriptModuleInterop = enableLegacyTypeScriptModuleInterop.asInstanceOf[js.Any], exportBindingsByLocalName = exportBindingsByLocalName.asInstanceOf[js.Any], generateImportReplacements = generateImportReplacements.asInstanceOf[js.Any], getFreeIdentifierForPath = js.Any.fromFunction1(getFreeIdentifierForPath), getGlobalNames = getGlobalNames.toJsFn, getIdentifierReplacement = js.Any.fromFunction1(getIdentifierReplacement), getImportInfo = getImportInfo.asInstanceOf[js.Any], getNamedImports = getNamedImports.asInstanceOf[js.Any], helperManager = helperManager.asInstanceOf[js.Any], identifierReplacements = identifierReplacements.asInstanceOf[js.Any], importInfoByPath = importInfoByPath.asInstanceOf[js.Any], importsToReplace = importsToReplace.asInstanceOf[js.Any], isTypeName = js.Any.fromFunction1(isTypeName), isTypeScriptTransformEnabled = isTypeScriptTransformEnabled.asInstanceOf[js.Any], nameManager = nameManager.asInstanceOf[js.Any], nonTypeIdentifiers = nonTypeIdentifiers.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], preprocessExportAtIndex = preprocessExportAtIndex.asInstanceOf[js.Any], preprocessExportStarAtIndex = preprocessExportStarAtIndex.asInstanceOf[js.Any], preprocessImportAtIndex = preprocessImportAtIndex.asInstanceOf[js.Any], preprocessNamedExportAtIndex = preprocessNamedExportAtIndex.asInstanceOf[js.Any], preprocessTokens = preprocessTokens.toJsFn, preprocessVarExportAtIndex = preprocessVarExportAtIndex.asInstanceOf[js.Any], pruneTypeOnlyImports = pruneTypeOnlyImports.toJsFn, resolveExportBinding = js.Any.fromFunction1(resolveExportBinding), tokens = tokens.asInstanceOf[js.Any])
    ...
    extension [Self <: CJSImportProcessor](x: Self) {
      ...
      inline def setGetGlobalNames(value: CallbackTo[Set[String]]): Self = StObject.set(x, "getGlobalNames", value.toJsFn)
      ...
      inline def setPreprocessTokens(value: Callback): Self = StObject.set(x, "preprocessTokens", value.toJsFn)
      ...
      inline def setPruneTypeOnlyImports(value: Callback): Self = StObject.set(x, "pruneTypeOnlyImports", value.toJsFn)
      ...
      inline def setTokens(value: typingsJapgolly.sucrase.distTypesTokenProcessorMod.default): Self = StObject.set(x, "tokens", value.asInstanceOf[js.Any])
    }
  }
}
