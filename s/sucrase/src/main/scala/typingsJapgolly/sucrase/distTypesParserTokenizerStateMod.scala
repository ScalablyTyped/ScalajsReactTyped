...
object distTypesParserTokenizerStateMod {
  ...
  object State {
    ...
    extension [Self <: State](x: Self) {
      ...
      inline def setRestoreFromSnapshot(value: StateSnapshot => Callback): Self = StObject.set(x, "restoreFromSnapshot", js.Any.fromFunction1((t0: StateSnapshot) => value(t0).runNow()))
      ...
      inline def setSnapshot(value: CallbackTo[StateSnapshot]): Self = StObject.set(x, "snapshot", value.toJsFn)
