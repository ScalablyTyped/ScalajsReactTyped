...
object rangesToComparatorsMod {
  ...
  inline def apply(range: typingsJapgolly.semver.classesRangeMod.^): js.Array[js.Array[String]] = ^.asInstanceOf[js.Dynamic].apply(range.asInstanceOf[js.Any]).asInstanceOf[js.Array[js.Array[String]]]
  inline def apply(range: typingsJapgolly.semver.classesRangeMod.^, optionsOrLoose: Boolean): js.Array[js.Array[String]] = (^.asInstanceOf[js.Dynamic].apply(range.asInstanceOf[js.Any], optionsOrLoose.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Array[String]]]
  inline def apply(range: typingsJapgolly.semver.classesRangeMod.^, optionsOrLoose: Options): js.Array[js.Array[String]] = (^.asInstanceOf[js.Dynamic].apply(range.asInstanceOf[js.Any], optionsOrLoose.asInstanceOf[js.Any])).asInstanceOf[js.Array[js.Array[String]]]
