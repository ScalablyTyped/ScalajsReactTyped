...
object classesRangeMod {
  ...
  trait Range extends StObject {
    ...
    def parseRange(range: String): js.Array[typingsJapgolly.semver.classesComparatorMod.^] = js.native
    
    var range: String = js.native
    
    var raw: String = js.native
    
    var set: js.Array[js.Array[typingsJapgolly.semver.classesComparatorMod.^]] = js.native
