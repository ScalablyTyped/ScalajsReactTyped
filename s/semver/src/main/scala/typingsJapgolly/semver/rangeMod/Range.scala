package typingsJapgolly.semver.rangeMod
...
trait Range extends js.Object {
  ...
  var set: js.Array[js.Array[typingsJapgolly.semver.comparatorMod.^]] = js.native
  ...
  def parseRange(range: String): js.Array[typingsJapgolly.semver.comparatorMod.^] = js.native
