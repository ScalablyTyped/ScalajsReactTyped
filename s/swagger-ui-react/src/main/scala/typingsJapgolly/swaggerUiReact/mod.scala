package typingsJapgolly.swaggerUiReact
...
object mod {
  ...
  object SwaggerUIProps {
    ...
    extension [Self <: SwaggerUIProps](x: Self) {
      ...
      inline def setOnComplete(value: /* system */ System => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: /* system */ System) => value(t0).runNow()))
