...
import typingsJapgolly.seleniumWebdriver.seleniumWebdriverStrings.denied
import typingsJapgolly.seleniumWebdriver.seleniumWebdriverStrings.granted
import typingsJapgolly.seleniumWebdriver.seleniumWebdriverStrings.prompt
