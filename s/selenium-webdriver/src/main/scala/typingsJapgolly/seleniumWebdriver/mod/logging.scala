...
object logging {
  ...
  open class Entry protected ()
    extends typingsJapgolly.seleniumWebdriver.libLoggingMod.Entry {
  ...
  open class Level protected ()
    extends typingsJapgolly.seleniumWebdriver.libLoggingMod.Level {
    /**
  ...
  open class LogManager ()
    extends typingsJapgolly.seleniumWebdriver.libLoggingMod.LogManager
  
  @JSImport("selenium-webdriver", "logging.Logger")
  @js.native
  open class Logger protected ()
    extends typingsJapgolly.seleniumWebdriver.libLoggingMod.Logger {
    /**
  ...
  open class Preferences ()
    extends typingsJapgolly.seleniumWebdriver.libLoggingMod.Preferences
