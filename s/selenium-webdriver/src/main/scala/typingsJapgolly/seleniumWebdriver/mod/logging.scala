...
object logging extends js.Object {
  ...
  class Entry protected ()
    extends typingsJapgolly.seleniumWebdriver.loggingMod.Entry {
  ...
  class Level protected ()
    extends typingsJapgolly.seleniumWebdriver.loggingMod.Level {
    /**
  ...
  class Logger protected ()
    extends typingsJapgolly.seleniumWebdriver.loggingMod.Logger {
    /**
  ...
  @js.native
  class Preferences ()
    extends typingsJapgolly.seleniumWebdriver.loggingMod.Preferences
