...
object byMod extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.seleniumWebdriver.AnonClassName
    - typingsJapgolly.seleniumWebdriver.AnonCss
    - typingsJapgolly.seleniumWebdriver.AnonId
    - typingsJapgolly.seleniumWebdriver.AnonJs
    - typingsJapgolly.seleniumWebdriver.AnonLinkText
    - typingsJapgolly.seleniumWebdriver.AnonName
    - typingsJapgolly.seleniumWebdriver.AnonPartialLinkText
    - typingsJapgolly.seleniumWebdriver.AnonTagName
    - typingsJapgolly.seleniumWebdriver.AnonXpath
  */
