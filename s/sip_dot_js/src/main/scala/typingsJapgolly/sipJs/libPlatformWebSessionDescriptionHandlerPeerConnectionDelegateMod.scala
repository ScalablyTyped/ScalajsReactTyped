...
import org.scalajs.dom.RTCDataChannelEvent
import org.scalajs.dom.RTCPeerConnectionIceEvent
import typingsJapgolly.std.RTCPeerConnectionIceErrorEvent
...
object libPlatformWebSessionDescriptionHandlerPeerConnectionDelegateMod {
  ...
  object PeerConnectionDelegate {
    ...
    extension [Self <: PeerConnectionDelegate](x: Self) {
      ...
      inline def setOnconnectionstatechange(value: /* event */ Event => Callback): Self = StObject.set(x, "onconnectionstatechange", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      
      inline def setOnconnectionstatechangeUndefined: Self = StObject.set(x, "onconnectionstatechange", js.undefined)
      
      inline def setOndatachannel(value: /* event */ RTCDataChannelEvent => Callback): Self = StObject.set(x, "ondatachannel", js.Any.fromFunction1((t0: /* event */ RTCDataChannelEvent) => value(t0).runNow()))
      
      inline def setOndatachannelUndefined: Self = StObject.set(x, "ondatachannel", js.undefined)
      
      inline def setOnicecandidate(value: /* event */ RTCPeerConnectionIceEvent => Callback): Self = StObject.set(x, "onicecandidate", js.Any.fromFunction1((t0: /* event */ RTCPeerConnectionIceEvent) => value(t0).runNow()))
      
      inline def setOnicecandidateUndefined: Self = StObject.set(x, "onicecandidate", js.undefined)
      
      inline def setOnicecandidateerror(value: /* event */ RTCPeerConnectionIceErrorEvent => Callback): Self = StObject.set(x, "onicecandidateerror", js.Any.fromFunction1((t0: /* event */ RTCPeerConnectionIceErrorEvent) => value(t0).runNow()))
      
      inline def setOnicecandidateerrorUndefined: Self = StObject.set(x, "onicecandidateerror", js.undefined)
      
      inline def setOniceconnectionstatechange(value: /* event */ Event => Callback): Self = StObject.set(x, "oniceconnectionstatechange", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      
      inline def setOniceconnectionstatechangeUndefined: Self = StObject.set(x, "oniceconnectionstatechange", js.undefined)
      
      inline def setOnicegatheringstatechange(value: /* event */ Event => Callback): Self = StObject.set(x, "onicegatheringstatechange", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      
      inline def setOnicegatheringstatechangeUndefined: Self = StObject.set(x, "onicegatheringstatechange", js.undefined)
      
      inline def setOnnegotiationneeded(value: /* event */ Event => Callback): Self = StObject.set(x, "onnegotiationneeded", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      
      inline def setOnnegotiationneededUndefined: Self = StObject.set(x, "onnegotiationneeded", js.undefined)
      
      inline def setOnsignalingstatechange(value: /* event */ Event => Callback): Self = StObject.set(x, "onsignalingstatechange", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      
      inline def setOnsignalingstatechangeUndefined: Self = StObject.set(x, "onsignalingstatechange", js.undefined)
      
      inline def setOntrack(value: /* event */ Event => Callback): Self = StObject.set(x, "ontrack", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
