...
import typingsJapgolly.sipJs.libUtilsMod.Utils.Deferred
...
object Utils extends js.Object {
  ...
  def normalizeTarget(target: String): js.UndefOr[typingsJapgolly.sipJs.uriMod.URI] = js.native
  def normalizeTarget(target: String, domain: String): js.UndefOr[typingsJapgolly.sipJs.uriMod.URI] = js.native
  def normalizeTarget(target: typingsJapgolly.sipJs.uriMod.URI): js.UndefOr[typingsJapgolly.sipJs.uriMod.URI] = js.native
  def normalizeTarget(target: typingsJapgolly.sipJs.uriMod.URI, domain: String): js.UndefOr[typingsJapgolly.sipJs.uriMod.URI] = js.native
