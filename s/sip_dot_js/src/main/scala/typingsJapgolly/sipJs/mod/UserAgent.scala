...
open class UserAgent ()
  extends typingsJapgolly.sipJs.libApiMod.UserAgent {
...
object UserAgent {
  ...
  /**
    ...
    * ```
    */
  inline def makeURI(uri: String): js.UndefOr[typingsJapgolly.sipJs.libCoreMod.URI] = ^.asInstanceOf[js.Dynamic].applyDynamic("makeURI")(uri.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[typingsJapgolly.sipJs.libCoreMod.URI]]
