...
object Web {
  ...
  open class SessionDescriptionHandler protected ()
    extends typingsJapgolly.sipJs.libPlatformWebMod.SessionDescriptionHandler {
    /**
      * Constructor
  ...
  open class SimpleUser protected ()
    extends typingsJapgolly.sipJs.libPlatformWebMod.SimpleUser {
    /**
  ...
  open class Transport protected ()
    extends typingsJapgolly.sipJs.libPlatformWebMod.Transport {
