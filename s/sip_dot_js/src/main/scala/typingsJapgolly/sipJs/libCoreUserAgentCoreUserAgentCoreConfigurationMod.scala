...
import typingsJapgolly.sipJs.anon.Anonymous
import typingsJapgolly.sipJs.libCoreLogMod.LoggerFactory
import typingsJapgolly.sipJs.libCoreMessagesMod.DigestAuthentication
...
object libCoreUserAgentCoreUserAgentCoreConfigurationMod {
  ...
  object UserAgentCoreConfiguration {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(aor = aor.asInstanceOf[js.Any], authenticationFactory = authenticationFactory.toJsFn, contact = contact.asInstanceOf[js.Any], displayName = displayName.asInstanceOf[js.Any], hackViaTcp = hackViaTcp.asInstanceOf[js.Any], loggerFactory = loggerFactory.asInstanceOf[js.Any], routeSet = routeSet.asInstanceOf[js.Any], sipjsId = sipjsId.asInstanceOf[js.Any], supportedOptionTags = supportedOptionTags.asInstanceOf[js.Any], supportedOptionTagsResponse = supportedOptionTagsResponse.asInstanceOf[js.Any], transportAccessor = transportAccessor.toJsFn, viaForceRport = viaForceRport.asInstanceOf[js.Any], viaHost = viaHost.asInstanceOf[js.Any])
    ...
    extension [Self <: UserAgentCoreConfiguration](x: Self) {
      ...
      inline def setAuthenticationFactory(value: CallbackTo[js.UndefOr[DigestAuthentication]]): Self = StObject.set(x, "authenticationFactory", value.toJsFn)
      ...
      inline def setTransportAccessor(value: CallbackTo[js.UndefOr[Transport]]): Self = StObject.set(x, "transportAccessor", value.toJsFn)
