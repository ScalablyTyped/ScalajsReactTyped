...
import typingsJapgolly.sipJs.anon.Duration
...
import typingsJapgolly.sipJs.libPlatformWebSessionDescriptionHandlerPeerConnectionDelegateMod.PeerConnectionDelegate
...
import typingsJapgolly.sipJs.libPlatformWebSessionDescriptionHandlerSessionDescriptionHandlerOptionsMod.SessionDescriptionHandlerOptions
...
object libPlatformWebSessionDescriptionHandlerSessionDescriptionHandlerMod {
  ...
  open class SessionDescriptionHandler protected ()
    extends StObject
       with typingsJapgolly.sipJs.libApiSessionDescriptionHandlerMod.SessionDescriptionHandler {
    /**
      * Constructor
