...
object libGrammarMod {
  ...
  open class NameAddrHeader protected ()
    extends typingsJapgolly.sipJs.libGrammarNameAddrHeaderMod.NameAddrHeader {
    /**
      * Constructor
      * @param uri -
      * @param displayName -
  ...
  open class Parameters protected ()
    extends typingsJapgolly.sipJs.libGrammarParametersMod.Parameters {
  ...
  open class URI protected ()
    extends typingsJapgolly.sipJs.libGrammarUriMod.URI {
    /**
      * Constructor
      * @param scheme -
      * @param user -
