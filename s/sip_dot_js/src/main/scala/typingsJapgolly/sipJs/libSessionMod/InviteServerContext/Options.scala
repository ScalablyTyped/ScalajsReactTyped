package typingsJapgolly.sipJs.libSessionMod.InviteServerContext
...
object Options {
  ...
  def apply(
    ...
    onInfo: /* request */ IncomingRequestMessage => Callback = null,
    ...
    if (onInfo != null) __obj.updateDynamic("onInfo")(js.Any.fromFunction1((t0: /* request */ typingsJapgolly.sipJs.coreMod.IncomingRequestMessage) => onInfo(t0).runNow()))
