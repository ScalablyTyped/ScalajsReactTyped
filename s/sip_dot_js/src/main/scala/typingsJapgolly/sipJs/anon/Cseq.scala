...
trait Cseq extends StObject {
  ...
  var body: js.UndefOr[typingsJapgolly.sipJs.libCoreMessagesBodyMod.Body] = js.undefined
...
object Cseq {
  ...
  extension [Self <: Cseq](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.sipJs.libCoreMessagesBodyMod.Body): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
