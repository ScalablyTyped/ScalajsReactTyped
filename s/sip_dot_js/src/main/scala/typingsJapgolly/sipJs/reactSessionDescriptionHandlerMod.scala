...
import typingsJapgolly.sipJs.apiSessionDescriptionHandlerMod.BodyAndContentType
...
@js.native
object reactSessionDescriptionHandlerMod extends js.Object {
  @js.native
  class SessionDescriptionHandler protected ()
    extends EventEmitter
       with typingsJapgolly.sipJs.apiSessionDescriptionHandlerMod.SessionDescriptionHandler {
