package typingsJapgolly.sipJs.webTransportMod
...
import typingsJapgolly.sipJs.sipJsStrings.connected
import typingsJapgolly.sipJs.sipJsStrings.connecting
import typingsJapgolly.sipJs.sipJsStrings.disconnected
import typingsJapgolly.sipJs.sipJsStrings.disconnecting
...
class Transport protected ()
  extends EventEmitter
     with typingsJapgolly.sipJs.transportMod.Transport {
