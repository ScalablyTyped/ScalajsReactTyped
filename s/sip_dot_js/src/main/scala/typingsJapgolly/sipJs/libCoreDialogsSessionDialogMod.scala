...
import typingsJapgolly.sipJs.libCoreDialogsDialogMod.Dialog
...
import typingsJapgolly.sipJs.libCoreSessionSessionMod.SessionState
import typingsJapgolly.sipJs.libCoreSessionSessionMod.SignalingState
...
import typingsJapgolly.sipJs.libCoreUserAgentsReInviteUserAgentClientMod.ReInviteUserAgentClient
import typingsJapgolly.sipJs.libCoreUserAgentsReInviteUserAgentServerMod.ReInviteUserAgentServer
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libCoreDialogsSessionDialogMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.sipJs.libCoreSessionSessionMod.Session because var conflicts: callId, id, localTag, localURI, remoteTag, remoteTarget, remoteURI. Inlined delegate, sessionState, signalingState, answer, offer, bye, bye, bye, bye, info, info, info, info, invite, invite, invite, invite, message, message, message, message, notify, notify, notify, notify, prack, prack, prack, prack, refer, refer, refer, refer */ @JSImport("sip.js/lib/core/dialogs/session-dialog", "SessionDialog")
  @js.native
