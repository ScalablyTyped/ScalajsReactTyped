...
import typingsJapgolly.sipJs.libCoreUserAgentsNotifyUserAgentServerMod.NotifyUserAgentServer
...
object libCoreUserAgentsSubscribeUserAgentClientMod {
  ...
  - typingsJapgolly.sipJs.libCoreMessagesMethodsSubscribeMod.OutgoingSubscribeRequest because var conflicts: delegate, message. Inlined waitNotifyStop */ @JSImport("sip.js/lib/core/user-agents/subscribe-user-agent-client", "SubscribeUserAgentClient")
  @js.native
