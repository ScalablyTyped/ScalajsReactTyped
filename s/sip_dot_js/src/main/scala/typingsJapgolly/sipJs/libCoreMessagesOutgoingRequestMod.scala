...
object libCoreMessagesOutgoingRequestMod {
  ...
  object OutgoingRequestDelegate {
    ...
    extension [Self <: OutgoingRequestDelegate](x: Self) {
      ...
      inline def setOnAccept(value: /* response */ IncomingResponse => Callback): Self = StObject.set(x, "onAccept", js.Any.fromFunction1((t0: /* response */ IncomingResponse) => value(t0).runNow()))
      
      inline def setOnAcceptUndefined: Self = StObject.set(x, "onAccept", js.undefined)
      
      inline def setOnProgress(value: /* response */ IncomingResponse => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction1((t0: /* response */ IncomingResponse) => value(t0).runNow()))
      
      inline def setOnProgressUndefined: Self = StObject.set(x, "onProgress", js.undefined)
      
      inline def setOnRedirect(value: /* response */ IncomingResponse => Callback): Self = StObject.set(x, "onRedirect", js.Any.fromFunction1((t0: /* response */ IncomingResponse) => value(t0).runNow()))
      
      inline def setOnRedirectUndefined: Self = StObject.set(x, "onRedirect", js.undefined)
      
      inline def setOnReject(value: /* response */ IncomingResponse => Callback): Self = StObject.set(x, "onReject", js.Any.fromFunction1((t0: /* response */ IncomingResponse) => value(t0).runNow()))
      
      inline def setOnRejectUndefined: Self = StObject.set(x, "onReject", js.undefined)
      
      inline def setOnTrying(value: /* response */ IncomingResponse => Callback): Self = StObject.set(x, "onTrying", js.Any.fromFunction1((t0: /* response */ IncomingResponse) => value(t0).runNow()))
