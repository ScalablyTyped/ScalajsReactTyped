...
object connectionsClientMod {
  ...
  trait Connection extends StObject {
    ...
    var status: typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.REJECTED | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.ACCEPTED | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_INCOMING | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_OUTGOING
  ...
  object Connection {
    ...
    inline def apply(
      status: typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.REJECTED | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.ACCEPTED | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_INCOMING | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_OUTGOING,
      userId: Double
    ): Connection = {
    ...
    extension [Self <: Connection](x: Self) {
      ...
      inline def setStatus(
        value: typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.REJECTED | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.ACCEPTED | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_INCOMING | typingsJapgolly.symphonyApiClientNode.symphonyApiClientNodeStrings.PENDING_OUTGOING
