package typingsJapgolly.sentryWebpackPlugin.mod
...
trait Options extends js.Object {
  ...
  var entries: js.UndefOr[js.Array[_] | js.RegExp | EntriesFunction] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    entries: js.Array[_] | js.RegExp | EntriesFunction = null,
    errorHandler: (/* err */ js.Error, /* invokeErr */ js.Function0[Unit]) => Callback = null,
    ...
    if (errorHandler != null) __obj.updateDynamic("errorHandler")(js.Any.fromFunction2((t0: /* err */ js.Error, t1: /* invokeErr */ js.Function0[scala.Unit]) => errorHandler(t0, t1).runNow()))
