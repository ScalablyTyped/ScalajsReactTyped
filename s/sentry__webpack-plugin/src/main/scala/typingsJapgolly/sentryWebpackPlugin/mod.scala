...
import typingsJapgolly.sentryCli.mod.SentryCliCommitsOptions
import typingsJapgolly.sentryCli.mod.SentryCliNewDeployOptions
import typingsJapgolly.sentryCli.mod.SourceMapsPathDescriptor
...
object mod {
  ...
  object SentryCliPlugin {
    ...
    inline def apply(apply: Compiler => Callback, options: SentryCliPluginOptions): SentryCliPlugin = {
  ...
  object SentryCliPluginOptions {
    ...
    extension [Self <: SentryCliPluginOptions](x: Self) {
      ...
      inline def setErrorHandler(value: (/* err */ js.Error, /* invokeErr */ js.Function0[Unit], /* compilation */ Any) => Callback): Self = StObject.set(x, "errorHandler", js.Any.fromFunction3((t0: /* err */ js.Error, t1: /* invokeErr */ js.Function0[Unit], t2: /* compilation */ Any) => (value(t0, t1, t2)).runNow()))
