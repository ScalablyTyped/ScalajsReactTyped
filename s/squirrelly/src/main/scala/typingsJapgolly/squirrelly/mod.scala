...
import typingsJapgolly.squirrelly.squirrellyStrings.clear
...
object mod {
  ...
  object NativeHelper {
    ...
    extension [Self <: NativeHelper](x: Self) {
      ...
      inline def setHelperEnd(value: CallbackTo[String]): Self = StObject.set(x, "helperEnd", value.toJsFn)
  ...
  type SqrlFn = js.Function2[/* options */ js.Object, /* Sqrl */ Any, String]
}
