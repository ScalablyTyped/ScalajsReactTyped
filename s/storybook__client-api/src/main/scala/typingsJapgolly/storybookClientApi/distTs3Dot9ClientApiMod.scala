...
import typingsJapgolly.storybookClientApi.anon.ImportFn
import typingsJapgolly.storybookClientApi.anon.Stories
import typingsJapgolly.storybookClientApi.anon.StoryStore
import typingsJapgolly.storybookClientApi.distTs3Dot9StoryStoreFacadeMod.StoryStoreFacade
...
object distTs3Dot9ClientApiMod {
  ...
  open class ClientApi[TFramework /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AnyFramework */ Any */] () extends StObject {
    ...
    def _storyStore: typingsJapgolly.storybookStore.mod.StoryStore[TFramework] = js.native
    ...
    var storyStore: js.UndefOr[typingsJapgolly.storybookStore.mod.StoryStore[TFramework]] = js.native
  }
