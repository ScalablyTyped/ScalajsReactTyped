...
import typingsJapgolly.storybookClientApi.distTs3Dot9TypesMod._StorySpecifier
...
object anon {
  ...
  trait StoryStore[TFramework /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AnyFramework */ Any */] extends StObject {
    ...
    var storyStore: js.UndefOr[typingsJapgolly.storybookStore.mod.StoryStore[TFramework]] = js.undefined
  }
  object StoryStore {
    ...
    extension [Self <: StoryStore[?], TFramework /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AnyFramework */ Any */](x: Self & StoryStore[TFramework]) {
      ...
      inline def setStoryStore(value: typingsJapgolly.storybookStore.mod.StoryStore[TFramework]): Self = StObject.set(x, "storyStore", value.asInstanceOf[js.Any])
