package typingsJapgolly.sx127xDriver

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`10Dot4E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`125E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`15Dot6E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`20Dot8E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`250E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`31Dot25E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`41Dot7E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`433E6`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`4Slash5`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`4Slash6`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`4Slash7`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`4Slash8`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`500E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`62Dot5E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`7Dot8E3`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`866E6`
import typingsJapgolly.sx127xDriver.sx127xDriverStrings.`915E6`
...
object mod {
  ...
  object SX127x {
    ...
    inline def apply(
      ...
      read: CallbackTo[js.Promise[Double]],
      receiveSingle: CallbackTo[js.Promise[Double]],
      setCodingRate: `4Slash5` | `4Slash6` | `4Slash7` | `4Slash8` => js.Promise[Unit],
      setContinuousReceiveMode: CallbackTo[js.Promise[Unit]],
      ...
      sleep: CallbackTo[js.Promise[Unit]],
      standBy: CallbackTo[js.Promise[Unit]],
      write: js.typedarray.ArrayBuffer => js.Promise[Unit]
    ): SX127x = {
      val __obj = js.Dynamic.literal(available = available.toJsFn, close = close.toJsFn, open = open.toJsFn, read = read.toJsFn, receiveSingle = receiveSingle.toJsFn, setCodingRate = js.Any.fromFunction1(setCodingRate), setContinuousReceiveMode = setContinuousReceiveMode.toJsFn, setCrc = js.Any.fromFunction1(setCrc), setFrequency = js.Any.fromFunction1(setFrequency), setPreambleLength = js.Any.fromFunction1(setPreambleLength), setSignalBandwidth = js.Any.fromFunction1(setSignalBandwidth), setSpreadingFactor = js.Any.fromFunction1(setSpreadingFactor), setSyncWord = js.Any.fromFunction1(setSyncWord), setTxPower = js.Any.fromFunction1(setTxPower), sleep = sleep.toJsFn, standBy = standBy.toJsFn, write = js.Any.fromFunction1(write))
    ...
    extension [Self <: SX127x](x: Self) {
      ...
      inline def setOpen(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "open", value.toJsFn)
      
      inline def setRead(value: CallbackTo[js.Promise[Double]]): Self = StObject.set(x, "read", value.toJsFn)
      
      inline def setReceiveSingle(value: CallbackTo[js.Promise[Double]]): Self = StObject.set(x, "receiveSingle", value.toJsFn)
      ...
      inline def setSetContinuousReceiveMode(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "setContinuousReceiveMode", value.toJsFn)
      ...
      inline def setSleep(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "sleep", value.toJsFn)
      
      inline def setStandBy(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "standBy", value.toJsFn)
