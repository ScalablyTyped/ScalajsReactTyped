...
import typingsJapgolly.sailsIoJs.sailsIoJsStrings.polling
import typingsJapgolly.sailsIoJs.sailsIoJsStrings.production
import typingsJapgolly.sailsIoJs.sailsIoJsStrings.websocket
