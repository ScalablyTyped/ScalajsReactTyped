...
import typingsJapgolly.sailsIoJs.anon.Body
...
object mod {
  ...
  object JWR {
    ...
    inline def apply(
      ...
      statusCode: Double,
      toPOJO: CallbackTo[Body]
    ): JWR = {
      val __obj = js.Dynamic.literal(body = body.asInstanceOf[js.Any], headers = headers.asInstanceOf[js.Any], pipe = pipe.toJsFn, statusCode = statusCode.asInstanceOf[js.Any], toPOJO = toPOJO.toJsFn)
    ...
    extension [Self <: JWR](x: Self) {
      ...
      inline def setPipe(value: CallbackTo[js.Error]): Self = StObject.set(x, "pipe", value.toJsFn)
      
      inline def setStatusCode(value: Double): Self = StObject.set(x, "statusCode", value.asInstanceOf[js.Any])
      
      inline def setToPOJO(value: CallbackTo[Body]): Self = StObject.set(x, "toPOJO", value.toJsFn)
    }
  }
