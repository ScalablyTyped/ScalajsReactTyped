...
import typingsJapgolly.sqlFormatter.libSrcParserAstMod.AstNode
...
object libSrcFormatterExpressionFormatterMod {
  ...
  open class default protected ()
    ...
    /* CompleteClass */
    override def format(nodes: js.Array[AstNode]): typingsJapgolly.sqlFormatter.libSrcFormatterLayoutMod.default = js.native
  ...
  trait ExpressionFormatter extends StObject {
    ...
    def format(nodes: js.Array[AstNode]): typingsJapgolly.sqlFormatter.libSrcFormatterLayoutMod.default
  ...
  object ExpressionFormatter {
    ...
    inline def apply(
      cfg: Any,
      dialectCfg: Any,
      format: js.Array[AstNode] => typingsJapgolly.sqlFormatter.libSrcFormatterLayoutMod.default,
    ...
    extension [Self <: ExpressionFormatter](x: Self) {
      ...
      inline def setFormat(value: js.Array[AstNode] => typingsJapgolly.sqlFormatter.libSrcFormatterLayoutMod.default): Self = StObject.set(x, "format", js.Any.fromFunction1(value))
  ...
  trait ExpressionFormatterParams extends StObject {
    ...
    var layout: typingsJapgolly.sqlFormatter.libSrcFormatterLayoutMod.default
    
    var params: typingsJapgolly.sqlFormatter.libSrcFormatterParamsMod.default
  }
  object ExpressionFormatterParams {
    ...
    inline def apply(
      ...
      layout: typingsJapgolly.sqlFormatter.libSrcFormatterLayoutMod.default,
      params: typingsJapgolly.sqlFormatter.libSrcFormatterParamsMod.default
    ...
    extension [Self <: ExpressionFormatterParams](x: Self) {
      ...
      inline def setLayout(value: typingsJapgolly.sqlFormatter.libSrcFormatterLayoutMod.default): Self = StObject.set(x, "layout", value.asInstanceOf[js.Any])
      
      inline def setParams(value: typingsJapgolly.sqlFormatter.libSrcFormatterParamsMod.default): Self = StObject.set(x, "params", value.asInstanceOf[js.Any])
    }
  }
}
