...
import typingsJapgolly.synchronousPromise.synchronousPromiseStrings.fulfilled
import typingsJapgolly.synchronousPromise.synchronousPromiseStrings.rejected
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.synchronousPromise.mod.FulfilledOutcome[T]
    - typingsJapgolly.synchronousPromise.mod.RejectedOutcome
  */
  trait SettledOutcome[T] extends StObject
  object SettledOutcome {
    
    inline def FulfilledOutcome[T](value: T): typingsJapgolly.synchronousPromise.mod.FulfilledOutcome[T] = {
      val __obj = js.Dynamic.literal(status = "fulfilled", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.synchronousPromise.mod.FulfilledOutcome[T]]
    }
    
    inline def RejectedOutcome(reason: Any): typingsJapgolly.synchronousPromise.mod.RejectedOutcome = {
      val __obj = js.Dynamic.literal(reason = reason.asInstanceOf[js.Any], status = "rejected")
      __obj.asInstanceOf[typingsJapgolly.synchronousPromise.mod.RejectedOutcome]
    }
  }
