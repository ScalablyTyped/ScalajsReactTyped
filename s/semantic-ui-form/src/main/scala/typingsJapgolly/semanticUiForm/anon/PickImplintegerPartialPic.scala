...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'integer'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplintegerPartialPic
  extends StObject
     with Param {
...
object PickImplintegerPartialPic {
  ...
  extension [Self <: PickImplintegerPartialPic](x: Self) {
