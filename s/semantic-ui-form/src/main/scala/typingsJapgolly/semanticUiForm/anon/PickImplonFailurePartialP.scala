...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'onFailure'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
trait PickImplonFailurePartialP
  extends StObject
     with Param {
