...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'number'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplnumberPartialPick
  extends StObject
     with Param {
...
object PickImplnumberPartialPick {
  ...
  extension [Self <: PickImplnumberPartialPick](x: Self) {
