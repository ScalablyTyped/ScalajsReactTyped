...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'maxCount'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplmaxCountPartialPi
  extends StObject
     with Param {
...
object PickImplmaxCountPartialPi {
  ...
  extension [Self <: PickImplmaxCountPartialPi](x: Self) {
