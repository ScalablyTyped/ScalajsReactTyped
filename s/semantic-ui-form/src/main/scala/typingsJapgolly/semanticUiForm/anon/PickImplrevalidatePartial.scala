...
import typingsJapgolly.semanticUiForm.SemanticUI.FormSettings.Param
...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'revalidate'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
trait PickImplrevalidatePartial
  extends StObject
     with Param {
...
object PickImplrevalidatePartial {
  ...
  extension [Self <: PickImplrevalidatePartial](x: Self) {
