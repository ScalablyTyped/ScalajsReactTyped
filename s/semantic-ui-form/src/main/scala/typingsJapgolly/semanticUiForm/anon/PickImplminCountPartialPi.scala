...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'minCount'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplminCountPartialPi
  extends StObject
     with Param {
...
object PickImplminCountPartialPi {
  ...
  extension [Self <: PickImplminCountPartialPi](x: Self) {
