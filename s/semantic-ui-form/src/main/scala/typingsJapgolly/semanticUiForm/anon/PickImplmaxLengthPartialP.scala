...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'maxLength'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplmaxLengthPartialP
  extends StObject
     with Param {
  ...
  var maxLength: String & js.UndefOr[String]
...
object PickImplmaxLengthPartialP {
  
  inline def apply(maxLength: String & js.UndefOr[String]): PickImplmaxLengthPartialP = {
  ...
  extension [Self <: PickImplmaxLengthPartialP](x: Self) {
    ...
    inline def setMaxLength(value: String & js.UndefOr[String]): Self = StObject.set(x, "maxLength", value.asInstanceOf[js.Any])
