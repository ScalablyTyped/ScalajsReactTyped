...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'not'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplnotPartialPickImp
  extends StObject
     with Param {
...
object PickImplnotPartialPickImp {
  ...
  extension [Self <: PickImplnotPartialPickImp](x: Self) {
