...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'notExactly'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplnotExactlyPartial
  extends StObject
     with Param {
...
object PickImplnotExactlyPartial {
  ...
  extension [Self <: PickImplnotExactlyPartial](x: Self) {
