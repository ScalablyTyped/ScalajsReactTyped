...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'email'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplemailPartialPickI
  extends StObject
     with Param {
...
object PickImplemailPartialPickI {
  ...
  extension [Self <: PickImplemailPartialPickI](x: Self) {
