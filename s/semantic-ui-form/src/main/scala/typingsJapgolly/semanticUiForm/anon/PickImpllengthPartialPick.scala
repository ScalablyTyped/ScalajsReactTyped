...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'length'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImpllengthPartialPick
  extends StObject
     with Param {
...
object PickImpllengthPartialPick {
  ...
  extension [Self <: PickImpllengthPartialPick](x: Self) {
