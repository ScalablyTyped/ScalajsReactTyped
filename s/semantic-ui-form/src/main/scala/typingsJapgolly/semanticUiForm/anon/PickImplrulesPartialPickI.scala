...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'rules'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
trait PickImplrulesPartialPickI
  extends StObject
     with Param {
...
object PickImplrulesPartialPickI {
  ...
  extension [Self <: PickImplrulesPartialPickI](x: Self) {
