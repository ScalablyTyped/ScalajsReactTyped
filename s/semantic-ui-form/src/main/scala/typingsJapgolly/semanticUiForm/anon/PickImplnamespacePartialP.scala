...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, 'namespace'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.FormSettings._Impl, keyof semantic-ui-form.SemanticUI.FormSettings._Impl>> */
