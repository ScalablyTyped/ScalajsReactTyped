...
/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'is'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplisPartialPickImpl
  extends StObject
     with Param {
...
object PickImplisPartialPickImpl {
  ...
  extension [Self <: PickImplisPartialPickImpl](x: Self) {
