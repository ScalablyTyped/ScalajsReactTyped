...
import typingsJapgolly.semanticUiForm.SemanticUI.Form.PromptSettings.Param
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, 'exactCount'> & std.Partial<std.Pick<semantic-ui-form.SemanticUI.Form.PromptSettings._Impl, keyof semantic-ui-form.SemanticUI.Form.PromptSettings._Impl>> */
trait PickImplexactCountPartial
  extends StObject
     with Param {
  ...
  var exactCount: String & js.UndefOr[String]
...
object PickImplexactCountPartial {
  
  inline def apply(exactCount: String & js.UndefOr[String]): PickImplexactCountPartial = {
    val __obj = js.Dynamic.literal(exactCount = exactCount.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplexactCountPartial]
  }
  
  extension [Self <: PickImplexactCountPartial](x: Self) {
    ...
    inline def setExactCount(value: String & js.UndefOr[String]): Self = StObject.set(x, "exactCount", value.asInstanceOf[js.Any])
