...
import typingsJapgolly.slate.AnonMatch
import typingsJapgolly.slate.AnonType
...
object Rules {
  ...
  def apply(
    ...
    normalize: (/* editor */ Editor, /* error */ SlateError) => Callback = null,
    ...
    if (normalize != null) __obj.updateDynamic("normalize")(js.Any.fromFunction2((t0: /* editor */ typingsJapgolly.slate.mod.Editor, t1: /* error */ typingsJapgolly.slate.mod.SlateError) => normalize(t0, t1).runNow()))
