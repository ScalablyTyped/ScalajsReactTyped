...
import typingsJapgolly.slate.AnonEnd
import typingsJapgolly.slate.IterableOptionsonlyLeaves
import typingsJapgolly.slate.IterableOptionsonlyTypesA
...
trait BaseNode extends js.Object {
  ...
  var `object`: document | block | `inline` | typingsJapgolly.slate.slateStrings.text = js.native
