...
import typingsJapgolly.slate.AnonOperations
import typingsJapgolly.slate.slateStrings.editor
...
object EditorProperties {
  ...
  def apply[T /* <: Controller */](
    `object`: editor = null,
    onChange: /* change */ AnonOperations => Callback = null,
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* change */ typingsJapgolly.slate.AnonOperations) => onChange(t0).runNow()))
