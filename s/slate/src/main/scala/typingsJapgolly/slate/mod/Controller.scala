...
import typingsJapgolly.slate.AnonTarget
...
trait Controller extends js.Object {
  ...
  def addMarksAtRange(range: RangeTypeJSON, marks: Set_[MarkProperties | MarkJSON | Mark | String]): Controller = js.native
  def addMarksAtRange(range: RangeTypeProperties, marks: js.Array[MarkProperties | MarkJSON | Mark | String]): Controller = js.native
  def addMarksAtRange(range: RangeTypeProperties, marks: Set_[MarkProperties | MarkJSON | Mark | String]): Controller = js.native
  def addMarksAtRange(range: RangeType, marks: js.Array[MarkProperties | MarkJSON | Mark | String]): Controller = js.native
  def addMarksAtRange(range: RangeType, marks: Set_[MarkProperties | MarkJSON | Mark | String]): Controller = js.native
  def addMarksByPath(
    path: List[Double],
    offset: Double,
    length: Double,
  ...
  def insertTextByKey(key: String, offset: Double, text: String, marks: Set_[MarkProperties | MarkJSON | Mark | String]): Controller = js.native
  /**
  ...
  def replaceTextByPath(path: List[Double], offset: Double, length: Double, text: String, marks: Set_[Mark]): Controller = js.native
  /**
  ...
  def select(properties: String, options: AnonSnapshot): Controller = js.native
  def select(properties: RangeType): Controller = js.native
  def select(properties: RangeTypeJSON): Controller = js.native
  def select(properties: RangeTypeJSON, options: AnonSnapshot): Controller = js.native
  /**
    * Merge the current selection with the provided properties
    */
  def select(properties: RangeTypeProperties): Controller = js.native
  def select(properties: RangeTypeProperties, options: AnonSnapshot): Controller = js.native
  def select(properties: RangeType, options: AnonSnapshot): Controller = js.native
  ...
  /**
    ...
    */
  def setTextByKey(key: String, text: String, marks: Set_[Mark]): Controller = js.native
  /**
    *  Insert `text` at `offset` in node by `path`.
    */
  def setTextByPath(path: List[Double], text: String, marks: Set_[Mark]): Controller = js.native
  /**
  ...
  def splitNodeByPath(path: List[Double], position: Double, options: AnonTarget): Controller = js.native
