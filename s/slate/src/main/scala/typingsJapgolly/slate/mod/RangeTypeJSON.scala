...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.slate.mod.RangeJSON
  - typingsJapgolly.slate.mod.SelectionJSON
  - typingsJapgolly.slate.mod.DecorationJSON
  - typingsJapgolly.slate.mod.AnnotationJSON
*/
