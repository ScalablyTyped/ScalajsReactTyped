...
import typingsJapgolly.slate.AnonPreserveAnnotations
import typingsJapgolly.slate.slateStrings.value
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

/* import warning: RemoveDifficultInheritance.summarizeChanges 
- Dropped / * import warning: parser.TsParser#tsDeclClass functionCall class extends from : Immutable.Record(object) * / any */ @JSImport("slate", "Value")
@js.native
class Value () extends js.Object {
  ...
  def toJS(options: AnonPreserveAnnotations): ValueJSON = js.native
  def toJSON(): ValueJSON = js.native
  def toJSON(options: AnonPreserveAnnotations): ValueJSON = js.native
}
