...
object QueryList {
  ...
  def apply(
    ...
    lineno: Double,
    merge: QueryList => CallbackTo[QueryList],
    ...
    __obj.updateDynamic("merge")(js.Any.fromFunction1((t0: typingsJapgolly.stylus.mod.Stylus.Nodes.QueryList) => merge(t0).runNow()))
