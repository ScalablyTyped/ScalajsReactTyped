...
object Query {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(column = column.asInstanceOf[js.Any], filename = filename.asInstanceOf[js.Any], first = first.asInstanceOf[js.Any], hash = hash.asInstanceOf[js.Any], lineno = lineno.asInstanceOf[js.Any], nodeName = nodeName.asInstanceOf[js.Any], nodes = nodes.asInstanceOf[js.Any], predicate = predicate.asInstanceOf[js.Any], resolvedPredicate = resolvedPredicate.asInstanceOf[js.Any], resolvedType = resolvedType.asInstanceOf[js.Any])
    ...
    __obj.updateDynamic("merge")(js.Any.fromFunction1((t0: typingsJapgolly.stylus.mod.Stylus.Nodes.Query) => merge(t0).runNow()))
    ...
    __obj.updateDynamic("push")(js.Any.fromFunction1((t0: typingsJapgolly.stylus.mod.Stylus.Nodes.QueryExpr) => push(t0).runNow()))
