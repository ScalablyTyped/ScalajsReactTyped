package typingsJapgolly.stylus.mod
...
trait RenderOptions extends StObject {
  ...
  var Evaluator: js.UndefOr[Instantiable0[typingsJapgolly.stylus.mod.Stylus.Evaluator]] = js.undefined
...
object RenderOptions {
  ...
  extension [Self <: RenderOptions](x: Self) {
    ...
    inline def setEvaluator(value: Instantiable0[typingsJapgolly.stylus.mod.Stylus.Evaluator]): Self = StObject.set(x, "Evaluator", value.asInstanceOf[js.Any])
