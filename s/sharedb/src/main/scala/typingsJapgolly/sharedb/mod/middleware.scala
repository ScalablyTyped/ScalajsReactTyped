...
import typingsJapgolly.sharedb.anon.Source
import typingsJapgolly.sharedb.libSharedbMod.ClientRequest
...
object middleware {
  ...
  trait BaseContext extends StObject {
    ...
    var agent: typingsJapgolly.sharedb.libAgentMod.^[Any]
  ...
  */
  ...
  object SnapshotType {
    ...
    inline def byTimestamp: typingsJapgolly.sharedb.sharedbStrings.byTimestamp = "byTimestamp".asInstanceOf[typingsJapgolly.sharedb.sharedbStrings.byTimestamp]
    
    inline def byVersion: typingsJapgolly.sharedb.sharedbStrings.byVersion = "byVersion".asInstanceOf[typingsJapgolly.sharedb.sharedbStrings.byVersion]
    
    inline def current: typingsJapgolly.sharedb.sharedbStrings.current = "current".asInstanceOf[typingsJapgolly.sharedb.sharedbStrings.current]
  }
