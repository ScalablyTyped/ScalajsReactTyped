...
import typingsJapgolly.sharedb.libClientMod.Connection
import typingsJapgolly.sharedb.sharedbStrings.qf
import typingsJapgolly.sharedb.sharedbStrings.qs
