...
object StyledComponentInterpolation {
  ...
  def apply(
    ...
    if (withComponent != null) __obj.updateDynamic("withComponent")(js.Any.fromFunction1((t0: /* component */ typingsJapgolly.styledDashComponents.styledDashComponentsMod.AnyStyledComponent) => withComponent(t0).runNow()))
