...
trait Anon_SuppressMultiMountWarning extends js.Object {
  var suppressMultiMountWarning: js.UndefOr[Boolean] = js.undefined
}

object Anon_SuppressMultiMountWarning {
  @scala.inline
  def apply(suppressMultiMountWarning: js.UndefOr[Boolean] = js.undefined): Anon_SuppressMultiMountWarning = {
    ...
    __obj.asInstanceOf[Anon_SuppressMultiMountWarning]
  }
}
