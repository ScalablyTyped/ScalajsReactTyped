...
object nativeDistModelsComponentStyleMod {
  ...
  object ComponentStyle {
    ...
    inline def apply(
      baseHash: Double,
      componentId: String,
      generateAndInjectStyles: (js.Object, typingsJapgolly.styledComponents.nativeDistSheetMod.default, Stringifier) => String,
      isStatic: Boolean,
    ...
    extension [Self <: ComponentStyle](x: Self) {
      ...
      inline def setGenerateAndInjectStyles(
        value: (js.Object, typingsJapgolly.styledComponents.nativeDistSheetMod.default, Stringifier) => String
