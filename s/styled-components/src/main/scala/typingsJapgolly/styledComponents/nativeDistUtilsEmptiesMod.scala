...
import typingsJapgolly.styledComponents.nativeDistTypesMod.KnownTarget
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nativeDistUtilsEmptiesMod {
  
  @JSImport("styled-components/native/dist/utils/empties", "EMPTY_ARRAY")
  @js.native
  val EMPTY_ARRAY: js.Array[Any] = js.native
  
  /* Inlined std.Readonly<styled-components.styled-components/native/dist/types.ExtensibleObject> */
  object EMPTY_OBJECT {
    ...
    @js.native
    val theme: js.UndefOr[DefaultTheme] = js.native
  }
}
