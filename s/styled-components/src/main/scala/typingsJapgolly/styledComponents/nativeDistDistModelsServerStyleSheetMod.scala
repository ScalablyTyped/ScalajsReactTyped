...
object nativeDistDistModelsServerStyleSheetMod {
  
  @JSImport("styled-components/native/dist/dist/models/ServerStyleSheet", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
    ...
    /* CompleteClass */
    var instance: typingsJapgolly.styledComponents.nativeDistDistSheetMod.default = js.native
  ...
  trait ServerStyleSheet extends StObject {
    ...
    var instance: typingsJapgolly.styledComponents.nativeDistDistSheetMod.default
  ...
  object ServerStyleSheet {
    ...
    inline def apply(
      ...
      instance: typingsJapgolly.styledComponents.nativeDistDistSheetMod.default,
    ...
    extension [Self <: ServerStyleSheet](x: Self) {
      ...
      inline def setInstance(value: typingsJapgolly.styledComponents.nativeDistDistSheetMod.default): Self = StObject.set(x, "instance", value.asInstanceOf[js.Any])
