...
object nativeDistDistModelsComponentStyleMod {
  ...
  object ComponentStyle {
    ...
    inline def apply(
      baseHash: Double,
      componentId: String,
      generateAndInjectStyles: (js.Object, typingsJapgolly.styledComponents.nativeDistDistSheetMod.default, Stringifier) => String,
      isStatic: Boolean,
      rules: RuleSet[Any],
    ...
    extension [Self <: ComponentStyle](x: Self) {
      ...
      inline def setGenerateAndInjectStyles(
        value: (js.Object, typingsJapgolly.styledComponents.nativeDistDistSheetMod.default, Stringifier) => String
      ): Self = StObject.set(x, "generateAndInjectStyles", js.Any.fromFunction3(value))
