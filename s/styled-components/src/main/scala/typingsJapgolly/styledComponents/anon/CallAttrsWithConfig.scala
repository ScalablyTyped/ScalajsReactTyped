...
@js.native
trait CallAttrsWithConfig[OuterProps, Environment /* <: web | native */, // used for styled<{}>().attrs() so attrs() gets the generic prop context
