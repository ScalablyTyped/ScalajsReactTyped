...
object DeleteRule {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(deleteRule = js.Any.fromFunction1((t0: Double) => deleteRule(t0).runNow()), element = element.asInstanceOf[js.Any], getRule = js.Any.fromFunction1(getRule), insertRule = js.Any.fromFunction2(insertRule), length = length.asInstanceOf[js.Any], sheet = sheet.asInstanceOf[js.Any])
