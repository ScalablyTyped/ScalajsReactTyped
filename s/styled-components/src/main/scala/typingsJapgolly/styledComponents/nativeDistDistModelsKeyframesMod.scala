...
object nativeDistDistModelsKeyframesMod {
  ...
  trait Keyframes
    extends StObject
       with typingsJapgolly.styledComponents.nativeDistDistTypesMod.Keyframes {
    
    def getName(): String = js.native
    def getName(stylisInstance: Stringifier): String = js.native
    
    def inject(styleSheet: typingsJapgolly.styledComponents.nativeDistDistSheetMod.default): Unit = js.native
    def inject(
