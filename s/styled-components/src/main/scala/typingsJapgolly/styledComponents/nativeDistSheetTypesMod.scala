...
object nativeDistSheetTypesMod {
  ...
  object Tag {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(deleteRule = js.Any.fromFunction1((t0: Double) => deleteRule(t0).runNow()), getRule = js.Any.fromFunction1(getRule), insertRule = js.Any.fromFunction2(insertRule), length = length.asInstanceOf[js.Any])
