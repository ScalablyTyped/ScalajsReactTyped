...
import typingsJapgolly.styledComponents.nativeDistDistSheetTypesMod.GroupedTag
import typingsJapgolly.styledComponents.nativeDistDistSheetTypesMod.Sheet
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object nativeDistDistSheetSheetMod {
  
  @JSImport("styled-components/native/dist/dist/sheet/Sheet", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with StyleSheet {
