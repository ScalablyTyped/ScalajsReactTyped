...
import typingsJapgolly.spectacle.mod.TextProps
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_TextProps1291211885[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextProps, ComponentRef, Unit, TextProps] = {
  ...
  typingsJapgolly.spectacle.mod.TextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.spectacle.mod.TextProps])(children: _*)
  }
}
