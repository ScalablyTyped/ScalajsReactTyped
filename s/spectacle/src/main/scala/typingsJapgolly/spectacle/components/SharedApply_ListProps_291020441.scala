...
import typingsJapgolly.spectacle.mod.ListProps
import typingsJapgolly.spectacle.mod.bulletStyleType
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_ListProps_291020441[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ListProps, ComponentRef, Unit, ListProps] = {
  ...
  typingsJapgolly.spectacle.mod.ListProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.spectacle.mod.ListProps])(children: _*)
  }
}
