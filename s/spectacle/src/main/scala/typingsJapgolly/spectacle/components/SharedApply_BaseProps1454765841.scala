...
import typingsJapgolly.spectacle.mod.BaseProps
import typingsJapgolly.spectacle.mod.CSSProperties
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_BaseProps1454765841[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BaseProps, ComponentRef, Unit, BaseProps] = {
  ...
  typingsJapgolly.spectacle.mod.BaseProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.spectacle.mod.BaseProps])(children: _*)
  }
}
