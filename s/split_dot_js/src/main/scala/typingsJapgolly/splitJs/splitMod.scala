...
import typingsJapgolly.splitJs.splitMod.Split.Instance
import typingsJapgolly.splitJs.splitMod.Split.Options
  ...
  object Split {
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setOnDrag(value: /* sizes */ js.Array[Double] => Callback): Self = StObject.set(x, "onDrag", js.Any.fromFunction1((t0: /* sizes */ js.Array[Double]) => value(t0).runNow()))
        
        inline def setOnDragEnd(value: /* sizes */ js.Array[Double] => Callback): Self = StObject.set(x, "onDragEnd", js.Any.fromFunction1((t0: /* sizes */ js.Array[Double]) => value(t0).runNow()))
        
        inline def setOnDragEndUndefined: Self = StObject.set(x, "onDragEnd", js.undefined)
        
        inline def setOnDragStart(value: /* sizes */ js.Array[Double] => Callback): Self = StObject.set(x, "onDragStart", js.Any.fromFunction1((t0: /* sizes */ js.Array[Double]) => value(t0).runNow()))
