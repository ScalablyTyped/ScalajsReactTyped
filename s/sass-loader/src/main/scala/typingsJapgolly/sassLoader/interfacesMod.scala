...
import typingsJapgolly.sassLoader.interfacesMod.LoaderOptions.Callback
import typingsJapgolly.sassLoader.interfacesMod.LoaderOptions.SassOptions
import typingsJapgolly.sassLoader.sassLoaderStrings.async
import typingsJapgolly.sassLoader.sassLoaderStrings.sync
...
object interfacesMod {
  ...
  object LoaderOptions {
    ...
    type SassOptions = Options | (typingsJapgolly.sass.typesOptionsMod.Options[sync | async])
  }
}
