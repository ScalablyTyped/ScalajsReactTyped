...
object Js2SvgOptions {
  ...
  def apply(
    ...
    encodeEntity: /* char */ js.UndefOr[String] => CallbackTo[String] = null,
    ...
    if (encodeEntity != null) __obj.updateDynamic("encodeEntity")(js.Any.fromFunction1((t0: /* char */ js.UndefOr[java.lang.String]) => encodeEntity(t0).runNow()))
