...
object ServerOptions {
  ...
  def apply(
    ...
    log: (/* severity */ String, /* message */ String) => Callback = null,
    prefix: String = null,
    ...
    if (log != null) __obj.updateDynamic("log")(js.Any.fromFunction2((t0: /* severity */ java.lang.String, t1: /* message */ java.lang.String) => log(t0, t1).runNow()))
