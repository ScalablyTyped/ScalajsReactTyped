...
import typingsJapgolly.stripeV3.anon.Country
import typingsJapgolly.stripeV3.anon.Iban
import typingsJapgolly.stripeV3.anon.Returnurl
...
trait SourceOptions extends StObject {
  ...
  var three_d_secure: js.UndefOr[typingsJapgolly.stripeV3.anon.Card] = js.undefined
...
object SourceOptions {
  ...
  extension [Self <: SourceOptions](x: Self) {
    ...
    inline def setThree_d_secure(value: typingsJapgolly.stripeV3.anon.Card): Self = StObject.set(x, "three_d_secure", value.asInstanceOf[js.Any])
