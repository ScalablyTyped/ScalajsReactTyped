...
import typingsJapgolly.stripeV3.anon.Destination
import typingsJapgolly.stripeV3.anon.Networkstatus
import typingsJapgolly.stripeV3.anon.Stripereport
import typingsJapgolly.stripeV3.anon.Url
import typingsJapgolly.stripeV3.stripe.paymentMethod.PaymentMethodDetails
import typingsJapgolly.stripeV3.stripeV3Strings.automatic
import typingsJapgolly.stripeV3.stripeV3Strings.canceled
import typingsJapgolly.stripeV3.stripeV3Strings.charge
import typingsJapgolly.stripeV3.stripeV3Strings.duplicate
import typingsJapgolly.stripeV3.stripeV3Strings.expired_or_canceled_card
import typingsJapgolly.stripeV3.stripeV3Strings.failed
import typingsJapgolly.stripeV3.stripeV3Strings.fraudulent
import typingsJapgolly.stripeV3.stripeV3Strings.lost_or_stolen_card
import typingsJapgolly.stripeV3.stripeV3Strings.manual
import typingsJapgolly.stripeV3.stripeV3Strings.payment_intent
import typingsJapgolly.stripeV3.stripeV3Strings.pending
import typingsJapgolly.stripeV3.stripeV3Strings.redirect_to_url
import typingsJapgolly.stripeV3.stripeV3Strings.refund
import typingsJapgolly.stripeV3.stripeV3Strings.requested_by_customer
import typingsJapgolly.stripeV3.stripeV3Strings.succeeded
...
object paymentIntents {
  ...
  trait Charge extends StObject {
    ...
    /**
      ...
      */
    var refunds: typingsJapgolly.stripeV3.stripe.List[Refund]
  ...
  object Charge {
    ...
    inline def apply(
      ...
      receipt_url: String,
      refunded: Boolean,
      refunds: typingsJapgolly.stripeV3.stripe.List[Refund],
    ...
    extension [Self <: Charge](x: Self) {
      ...
      inline def setRefunds(value: typingsJapgolly.stripeV3.stripe.List[Refund]): Self = StObject.set(x, "refunds", value.asInstanceOf[js.Any])
  ...
  trait PaymentIntent extends StObject {
    ...
    /**
      ...
      */
    var charges: typingsJapgolly.stripeV3.stripe.List[Charge]
  ...
  object PaymentIntent {
    ...
    inline def apply(
      ...
      charges: typingsJapgolly.stripeV3.stripe.List[Charge],
    ...
    extension [Self <: PaymentIntent](x: Self) {
      ...
      inline def setCharges(value: typingsJapgolly.stripeV3.stripe.List[Charge]): Self = StObject.set(x, "charges", value.asInstanceOf[js.Any])
  ...
  */
  ...
  object PaymentIntentCancelationReason {
    ...
    inline def abandoned: typingsJapgolly.stripeV3.stripeV3Strings.abandoned = "abandoned".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.abandoned]
    
    inline def automatic: typingsJapgolly.stripeV3.stripeV3Strings.automatic = "automatic".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.automatic]
    
    inline def duplicate: typingsJapgolly.stripeV3.stripeV3Strings.duplicate = "duplicate".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.duplicate]
    
    inline def failed_invoice: typingsJapgolly.stripeV3.stripeV3Strings.failed_invoice = "failed_invoice".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.failed_invoice]
    
    inline def fraudulent: typingsJapgolly.stripeV3.stripeV3Strings.fraudulent = "fraudulent".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.fraudulent]
    
    inline def requested_by_customer: typingsJapgolly.stripeV3.stripeV3Strings.requested_by_customer = "requested_by_customer".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.requested_by_customer]
    
    inline def void_invoice: typingsJapgolly.stripeV3.stripeV3Strings.void_invoice = "void_invoice".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.void_invoice]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.stripeV3.stripeV3Strings.requires_capture
  ...
  */
  ...
  object PaymentIntentStatus {
    ...
    inline def canceled: typingsJapgolly.stripeV3.stripeV3Strings.canceled = "canceled".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.canceled]
    
    inline def processing: typingsJapgolly.stripeV3.stripeV3Strings.processing = "processing".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.processing]
    
    inline def requires_action: typingsJapgolly.stripeV3.stripeV3Strings.requires_action = "requires_action".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.requires_action]
    
    inline def requires_capture: typingsJapgolly.stripeV3.stripeV3Strings.requires_capture = "requires_capture".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.requires_capture]
    
    inline def requires_confirmation: typingsJapgolly.stripeV3.stripeV3Strings.requires_confirmation = "requires_confirmation".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.requires_confirmation]
    
    inline def requires_payment_method: typingsJapgolly.stripeV3.stripeV3Strings.requires_payment_method = "requires_payment_method".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.requires_payment_method]
    
    inline def succeeded: typingsJapgolly.stripeV3.stripeV3Strings.succeeded = "succeeded".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.succeeded]
  }
