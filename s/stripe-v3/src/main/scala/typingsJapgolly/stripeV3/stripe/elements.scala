...
import typingsJapgolly.stripeV3.anon.PostalCode
import typingsJapgolly.stripeV3.anon.PreventDefault
...
import typingsJapgolly.stripeV3.stripeV3Strings.click
...
object elements {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.stripeV3.stripeV3Strings.cardNumber
    - typingsJapgolly.stripeV3.stripeV3Strings.cardExpiry
    - typingsJapgolly.stripeV3.stripeV3Strings.cardCvc
    - typingsJapgolly.stripeV3.stripeV3Strings.postalCode
    - typingsJapgolly.stripeV3.stripeV3Strings.paymentRequestButton
    - typingsJapgolly.stripeV3.stripeV3Strings.iban
    - typingsJapgolly.stripeV3.stripeV3Strings.idealBank
    - typingsJapgolly.stripeV3.stripeV3Strings.auBankAccount
  */
  trait elementsType extends StObject
  object elementsType {
    
    inline def auBankAccount: typingsJapgolly.stripeV3.stripeV3Strings.auBankAccount = "auBankAccount".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.auBankAccount]
    ...
    inline def cardCvc: typingsJapgolly.stripeV3.stripeV3Strings.cardCvc = "cardCvc".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.cardCvc]
    
    inline def cardExpiry: typingsJapgolly.stripeV3.stripeV3Strings.cardExpiry = "cardExpiry".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.cardExpiry]
    
    inline def cardNumber: typingsJapgolly.stripeV3.stripeV3Strings.cardNumber = "cardNumber".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.cardNumber]
    
    inline def iban: typingsJapgolly.stripeV3.stripeV3Strings.iban = "iban".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.iban]
    
    inline def idealBank: typingsJapgolly.stripeV3.stripeV3Strings.idealBank = "idealBank".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.idealBank]
    
    inline def paymentRequestButton: typingsJapgolly.stripeV3.stripeV3Strings.paymentRequestButton = "paymentRequestButton".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.paymentRequestButton]
    
    inline def postalCode: typingsJapgolly.stripeV3.stripeV3Strings.postalCode = "postalCode".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.postalCode]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.stripeV3.stripeV3Strings.blur
    - typingsJapgolly.stripeV3.stripeV3Strings.change
    - typingsJapgolly.stripeV3.stripeV3Strings.focus
    - typingsJapgolly.stripeV3.stripeV3Strings.ready
  */
  trait eventTypes extends StObject
  object eventTypes {
    
    inline def blur: typingsJapgolly.stripeV3.stripeV3Strings.blur = "blur".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.blur]
    
    inline def change: typingsJapgolly.stripeV3.stripeV3Strings.change = "change".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.change]
    
    inline def focus: typingsJapgolly.stripeV3.stripeV3Strings.focus = "focus".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.focus]
    
    inline def ready: typingsJapgolly.stripeV3.stripeV3Strings.ready = "ready".asInstanceOf[typingsJapgolly.stripeV3.stripeV3Strings.ready]
  }
