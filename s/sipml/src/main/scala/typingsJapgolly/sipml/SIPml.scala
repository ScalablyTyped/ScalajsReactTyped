...
import typingsJapgolly.sipml.anon.Audio
import typingsJapgolly.sipml.anon.Events
import typingsJapgolly.sipml.anon.Listener
import typingsJapgolly.sipml.anon.MaxHeight
...
object SIPml {
  ...
  object Event {
    ...
    inline def apply(
      description: String,
      getContent: CallbackTo[js.Object],
      getContentString: CallbackTo[String],
      getContentType: CallbackTo[js.Object],
      getSipResponseCode: CallbackTo[Double],
      `type`: String
    ): Event = {
      val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], getContent = getContent.toJsFn, getContentString = getContentString.toJsFn, getContentType = getContentType.toJsFn, getSipResponseCode = getSipResponseCode.toJsFn)
    ...
    extension [Self <: Event](x: Self) {
      ...
      inline def setGetContent(value: CallbackTo[js.Object]): Self = StObject.set(x, "getContent", value.toJsFn)
      
      inline def setGetContentString(value: CallbackTo[String]): Self = StObject.set(x, "getContentString", value.toJsFn)
      
      inline def setGetContentType(value: CallbackTo[js.Object]): Self = StObject.set(x, "getContentType", value.toJsFn)
      
      inline def setGetSipResponseCode(value: CallbackTo[Double]): Self = StObject.set(x, "getSipResponseCode", value.toJsFn)
  ...
  object EventTarget {
    ...
    inline def apply[EventSubscriptionType /* <: String */, EventType /* <: Event */](
      addEventListener: (EventSubscriptionType, js.Function1[/* e */ EventType, Unit]) => Callback,
      removeEventListener: EventSubscriptionType => Callback
    ): EventTarget[EventSubscriptionType, EventType] = {
      val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2((t0: EventSubscriptionType, t1: js.Function1[/* e */ EventType, Unit]) => (addEventListener(t0, t1)).runNow()), removeEventListener = js.Any.fromFunction1((t0: EventSubscriptionType) => removeEventListener(t0).runNow()))
    ...
    extension [Self <: EventTarget[?, ?], EventSubscriptionType /* <: String */, EventType /* <: Event */](x: Self & (EventTarget[EventSubscriptionType, EventType])) {
      ...
      inline def setAddEventListener(value: (EventSubscriptionType, js.Function1[/* e */ EventType, Unit]) => Callback): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: EventSubscriptionType, t1: js.Function1[/* e */ EventType, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setRemoveEventListener(value: EventSubscriptionType => Callback): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction1((t0: EventSubscriptionType) => value(t0).runNow()))
    }
  }
  ...
  trait Session
    extends StObject
       with EventTarget[EventSubscriptionType, typingsJapgolly.sipml.SIPml.Session.Event] {
  ...
  object Session {
    ...
    object Event {
      ...
      inline def apply(
        ...
        getContentType: CallbackTo[js.Object],
        getSipResponseCode: CallbackTo[Double],
        getTransferDestinationFriendlyName: CallbackTo[String],
        session: Session,
        `type`: String
      ): typingsJapgolly.sipml.SIPml.Session.Event = {
        val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], getContent = getContent.toJsFn, getContentString = getContentString.toJsFn, getContentType = getContentType.toJsFn, getSipResponseCode = getSipResponseCode.toJsFn, getTransferDestinationFriendlyName = getTransferDestinationFriendlyName.toJsFn, session = session.asInstanceOf[js.Any])
        __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.sipml.SIPml.Session.Event]
      }
      
      extension [Self <: typingsJapgolly.sipml.SIPml.Session.Event](x: Self) {
        
        inline def setGetTransferDestinationFriendlyName(value: CallbackTo[String]): Self = StObject.set(x, "getTransferDestinationFriendlyName", value.toJsFn)
  ...
  trait Stack
    extends StObject
       with EventTarget[
          typingsJapgolly.sipml.SIPml.Stack.EventSubscriptionType, 
          typingsJapgolly.sipml.SIPml.Stack.Event
        ] {
    
    def newSession(`type`: String): Any = js.native
    def newSession(`type`: String, configuration: Configuration): Any = js.native
    
    def setConfiguration(configuration: typingsJapgolly.sipml.SIPml.Stack.Configuration): Double = js.native
  ...
  object Stack {
    ...
    object Configuration {
      ...
      inline def apply(): typingsJapgolly.sipml.SIPml.Stack.Configuration = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.sipml.SIPml.Stack.Configuration]
      }
      
      extension [Self <: typingsJapgolly.sipml.SIPml.Stack.Configuration](x: Self) {
    ...
    object Event {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], getContent = getContent.toJsFn, getContentString = getContentString.toJsFn, getContentType = getContentType.toJsFn, getSipResponseCode = getSipResponseCode.toJsFn, newSession = newSession.asInstanceOf[js.Any])
        __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.sipml.SIPml.Stack.Event]
      }
      
      extension [Self <: typingsJapgolly.sipml.SIPml.Stack.Event](x: Self) {
