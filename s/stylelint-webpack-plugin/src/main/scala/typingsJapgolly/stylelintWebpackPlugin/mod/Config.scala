package typingsJapgolly.stylelintWebpackPlugin.mod

import typingsJapgolly.stylelintWebpackPlugin.stylelintWebpackPluginStrings.error
import typingsJapgolly.stylelintWebpackPlugin.stylelintWebpackPluginStrings.warning
