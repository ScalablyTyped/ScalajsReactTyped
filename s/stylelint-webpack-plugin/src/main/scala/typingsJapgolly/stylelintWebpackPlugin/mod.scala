...
import typingsJapgolly.stylelintWebpackPlugin.anon.Timestamp
...
object mod {
  ...
  object StylelintWebpackPlugin {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), getContext = js.Any.fromFunction1(getContext), key = key.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], prevTimestamps = prevTimestamps.asInstanceOf[js.Any], run = js.Any.fromFunction4(run), startTime = startTime.asInstanceOf[js.Any])
