...
import typingsJapgolly.stylelint.mod.LinterOptions
import typingsJapgolly.stylelint.mod.LinterResult
import typingsJapgolly.stylelint.mod.Plugin
import typingsJapgolly.stylelint.mod.PostcssPluginOptions
import typingsJapgolly.stylelintWebpackPlugin.anon.Api
import typingsJapgolly.stylelintWebpackPlugin.anon.CheckAgainstRule
import typingsJapgolly.stylelintWebpackPlugin.anon.PickLinterOptionscwdconfi
import typingsJapgolly.stylelintWebpackPlugin.anon.Rule
...
object typesLinterMod {
  ...
  type FormatterType = typingsJapgolly.stylelintWebpackPlugin.typesOptionsMod.FormatterType
  
  type GenerateReport = js.Function1[/* compilation */ Compilation, js.Promise[Unit]]
  
  type InternalApi = typingsJapgolly.stylelint.mod.InternalApi
  
  type LintResult = typingsJapgolly.stylelint.mod.LintResult
  
  type LintResultMap = StringDictionary[typingsJapgolly.stylelint.mod.LintResult]
  ...
  trait Options extends StObject {
    ...
    var formatter: js.UndefOr[typingsJapgolly.stylelintWebpackPlugin.typesOptionsMod.FormatterType] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setFormatter(value: typingsJapgolly.stylelintWebpackPlugin.typesOptionsMod.FormatterType): Self = StObject.set(x, "formatter", value.asInstanceOf[js.Any])
  ...
  trait Report extends StObject {
    ...
    var errors: js.UndefOr[typingsJapgolly.stylelintWebpackPlugin.typesStylelintErrorMod.^] = js.undefined
    
    var generateReportAsset: js.UndefOr[GenerateReport] = js.undefined
    
    var warnings: js.UndefOr[typingsJapgolly.stylelintWebpackPlugin.typesStylelintErrorMod.^] = js.undefined
  }
  object Report {
    ...
    extension [Self <: Report](x: Self) {
      ...
      inline def setErrors(value: typingsJapgolly.stylelintWebpackPlugin.typesStylelintErrorMod.^): Self = StObject.set(x, "errors", value.asInstanceOf[js.Any])
      ...
      inline def setWarnings(value: typingsJapgolly.stylelintWebpackPlugin.typesStylelintErrorMod.^): Self = StObject.set(x, "warnings", value.asInstanceOf[js.Any])
  ...
  trait Stylelint
    ...
    def createLinter(options: LinterOptions): typingsJapgolly.stylelint.mod.InternalApi = js.native
    ...
    var rules: StringDictionary[typingsJapgolly.stylelint.mod.Rule[Any, Any]] = js.native
