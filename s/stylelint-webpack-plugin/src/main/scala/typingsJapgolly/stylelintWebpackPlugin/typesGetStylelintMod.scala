...
object typesGetStylelintMod {
  ...
  object Linter {
    ...
    inline def apply(
      api: InternalApi,
      cleanup: CallbackTo[js.Promise[Unit]],
      lintFiles: /* files */ String | js.Array[String] => js.Promise[js.Array[LintResult]],
      stylelint: Stylelint,
      threads: Double
    ): Linter = {
      val __obj = js.Dynamic.literal(api = api.asInstanceOf[js.Any], cleanup = cleanup.toJsFn, lintFiles = js.Any.fromFunction1(lintFiles), stylelint = stylelint.asInstanceOf[js.Any], threads = threads.asInstanceOf[js.Any])
  ...
  trait Stylelint
    ...
    def createPlugin(ruleName: String, plugin: typingsJapgolly.stylelint.mod.Plugin): Rule = js.native
  ...
  @js.native
  trait Worker
    extends typingsJapgolly.jestWorker.mod.Worker {
