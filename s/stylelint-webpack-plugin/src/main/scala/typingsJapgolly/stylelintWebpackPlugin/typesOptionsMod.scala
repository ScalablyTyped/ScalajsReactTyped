...
import typingsJapgolly.stylelint.mod.InternalApi
...
import typingsJapgolly.stylelintWebpackPlugin.anon.PartialPluginOptions
import typingsJapgolly.stylelintWebpackPlugin.anon.PartialStylelintOptions
...
object typesOptionsMod {
  ...
  type FormatterType = typingsJapgolly.stylelint.mod.FormatterType
