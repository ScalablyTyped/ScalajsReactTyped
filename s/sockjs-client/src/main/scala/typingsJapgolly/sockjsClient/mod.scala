...
import typingsJapgolly.sockjsClient.sockjsClientInts.`0`
import typingsJapgolly.sockjsClient.sockjsClientInts.`1`
import typingsJapgolly.sockjsClient.sockjsClientInts.`2`
import typingsJapgolly.sockjsClient.sockjsClientInts.`3`
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setSessionIdCallbackTo(value: CallbackTo[String]): Self = StObject.set(x, "sessionId", value.toJsFn)
