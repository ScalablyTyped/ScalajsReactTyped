...
trait LiteralStem
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.LiteralStem
}
object LiteralStem {
  ...
  extension [Self <: LiteralStem](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.LiteralStem): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
