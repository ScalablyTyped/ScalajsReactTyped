...
trait IriStem
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.IriStem
}
object IriStem {
  ...
  extension [Self <: IriStem](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.IriStem): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
