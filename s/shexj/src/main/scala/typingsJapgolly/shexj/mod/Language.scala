...
trait Language
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.Language
}
object Language {
  ...
  extension [Self <: Language](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.Language): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
