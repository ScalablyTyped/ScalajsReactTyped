...
trait ShapeDecl extends StObject {
  ...
  /**
    ...
    */
  var shapeExpr: typingsJapgolly.shexj.mod.shapeExpr
  
  /**
    * Mandatory type "ShapeDecl".
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.ShapeDecl
}
object ShapeDecl {
  ...
  extension [Self <: ShapeDecl](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.ShapeDecl): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
