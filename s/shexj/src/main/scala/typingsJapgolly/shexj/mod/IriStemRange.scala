...
trait IriStemRange
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.IriStemRange
}
object IriStemRange {
  ...
  extension [Self <: IriStemRange](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.IriStemRange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
