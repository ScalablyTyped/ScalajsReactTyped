...
trait OneOf
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.OneOf
}
object OneOf {
  ...
  extension [Self <: OneOf](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.OneOf): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
