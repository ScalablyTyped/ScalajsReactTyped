...
trait TripleConstraint
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.TripleConstraint
...
object TripleConstraint {
  ...
  extension [Self <: TripleConstraint](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.TripleConstraint): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
