...
trait LanguageStemRange
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.LanguageStemRange
}
object LanguageStemRange {
  ...
  extension [Self <: LanguageStemRange](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.LanguageStemRange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
