...
trait EachOf
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.EachOf
}
object EachOf {
  ...
  extension [Self <: EachOf](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.EachOf): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
