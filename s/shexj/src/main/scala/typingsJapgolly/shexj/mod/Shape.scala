...
trait Shape
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.Shape
}
object Shape {
  ...
  extension [Self <: Shape](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.Shape): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
