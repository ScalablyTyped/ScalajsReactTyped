...
trait Annotation extends StObject {
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.Annotation
}
object Annotation {
  ...
  extension [Self <: Annotation](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.Annotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
