...
trait ShapeAnd
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.ShapeAnd
}
object ShapeAnd {
  ...
  extension [Self <: ShapeAnd](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.ShapeAnd): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
