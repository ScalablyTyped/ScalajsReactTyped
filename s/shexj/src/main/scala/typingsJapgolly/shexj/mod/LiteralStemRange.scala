...
trait LiteralStemRange
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.LiteralStemRange
}
object LiteralStemRange {
  ...
  extension [Self <: LiteralStemRange](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.LiteralStemRange): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
