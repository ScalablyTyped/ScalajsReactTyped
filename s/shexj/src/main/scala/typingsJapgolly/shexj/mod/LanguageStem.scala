...
trait LanguageStem
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.LanguageStem
}
object LanguageStem {
  ...
  extension [Self <: LanguageStem](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.LanguageStem): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
