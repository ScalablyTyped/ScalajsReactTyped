...
import typingsJapgolly.shexj.shexjStrings.httpColonSlashSlashwwwDotw3DotorgSlashnsSlashshexDotjsonld
...
trait Schema extends StObject {
  ...
  /**
    ...
    */
  var `type`: typingsJapgolly.shexj.shexjStrings.Schema
}
object Schema {
  ...
  extension [Self <: Schema](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.shexj.shexjStrings.Schema): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
