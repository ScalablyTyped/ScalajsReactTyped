...
import typingsJapgolly.storybookApi.anon.CustomQueryParams
import typingsJapgolly.storybookApi.distTs3Dot9LibStoriesMod.Item
import typingsJapgolly.storybookApi.distTs3Dot9LibStoriesMod.StoriesHash
import typingsJapgolly.storybookApi.distTs3Dot9ModulesAddonsMod.SubAPI
import typingsJapgolly.storybookApi.distTs3Dot9ModulesLayoutMod.Layout
import typingsJapgolly.storybookApi.distTs3Dot9ModulesLayoutMod.SubState
import typingsJapgolly.storybookApi.distTs3Dot9ModulesLayoutMod.UI
import typingsJapgolly.storybookApi.distTs3Dot9ModulesNotificationsMod.Notification
import typingsJapgolly.storybookApi.distTs3Dot9ModulesRefsMod.Refs
import typingsJapgolly.storybookApi.distTs3Dot9ModulesSettingsMod.Settings
import typingsJapgolly.storybookApi.distTs3Dot9ModulesShortcutsMod.Shortcuts
import typingsJapgolly.storybookApi.distTs3Dot9ModulesUrlMod.QueryParams
import typingsJapgolly.storybookApi.distTs3Dot9ModulesVersionsMod.UnknownEntries
import typingsJapgolly.storybookApi.distTs3Dot9ModulesVersionsMod.Versions
import typingsJapgolly.storybookApi.distTs3Dot9StoreMod.Options
import typingsJapgolly.storybookApi.distTs3Dot9StoreMod.default
...
import typingsJapgolly.storybookApi.storybookApiStrings.development
import typingsJapgolly.storybookApi.storybookApiStrings.production
...
import typingsJapgolly.storybookRouter.mod.RouterData
...
object mod {
  ...
  inline def Consumer[P](hasFilterChildren: ManagerConsumerProps[P]): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("Consumer")(hasFilterChildren.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  trait API
    extends StObject
       with SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesChannelMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesProviderMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesStoriesMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesRefsMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesGlobalsMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesLayoutMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesNotificationsMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesShortcutsMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesReleaseNotesMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesSettingsMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesVersionsMod.SubAPI
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesUrlMod.SubAPI
       with Other
  ...
  trait ManagerConsumerProps[P] extends StObject {
    ...
    var children: FunctionComponent[P] | Node
  ...
  object ManagerConsumerProps {
    ...
    extension [Self <: ManagerConsumerProps[?], P](x: Self & ManagerConsumerProps[P]) {
      ...
      inline def setChildren(value: FunctionComponent[P] | Node): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
  ...
  trait ManagerProviderProps
    ...
    var children: Node | (js.Function1[/* props */ Combo, Node])
  ...
  object ManagerProviderProps {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(docsMode = docsMode.asInstanceOf[js.Any], location = location.asInstanceOf[js.Any], navigate = navigate.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], provider = provider.asInstanceOf[js.Any], children = null)
      __obj.asInstanceOf[ManagerProviderProps]
    }
    
    extension [Self <: ManagerProviderProps](x: Self) {
      
      inline def setChildren(value: Node | (js.Function1[/* props */ Combo, Node])): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
      
      inline def setChildrenFunction1(value: /* props */ Combo => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  object ProviderData {
    ...
    inline def apply(provider: typingsJapgolly.storybookApi.distTs3Dot9ModulesProviderMod.Provider): ProviderData = {
  ...
  - typingsJapgolly.storybookRouter.mod.StoryData because var conflicts: storyId, viewMode. Inlined refId
  - typingsJapgolly.storybookRouter.mod.Other because var conflicts: storyId, viewMode. Inlined path, singleStory
  - typingsJapgolly.storybookRouter.mod.RouterData because var conflicts: storyId, viewMode. Inlined location, navigate */ trait State
    extends StObject
       with SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesStoriesMod.SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesRefsMod.SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesNotificationsMod.SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesVersionsMod.SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesUrlMod.SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesShortcutsMod.SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesReleaseNotesMod.SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesSettingsMod.SubState
       with typingsJapgolly.storybookApi.distTs3Dot9ModulesGlobalsMod.SubState
       with Other {
