...
object distTs3Dot9ModulesAddonsMod {
  ...
  object types extends StObject {
    ...
    sealed trait NOTES_ELEMENT
      extends StObject
         with types
    /* "notes-element" */ val NOTES_ELEMENT: typingsJapgolly.storybookApi.distTs3Dot9ModulesAddonsMod.types.NOTES_ELEMENT & String = js.native
    
    @js.native
    sealed trait PANEL
      extends StObject
         with types
    /* "panel" */ val PANEL: typingsJapgolly.storybookApi.distTs3Dot9ModulesAddonsMod.types.PANEL & String = js.native
    
    @js.native
    sealed trait PREVIEW
      extends StObject
         with types
    /* "preview" */ val PREVIEW: typingsJapgolly.storybookApi.distTs3Dot9ModulesAddonsMod.types.PREVIEW & String = js.native
    
    @js.native
    sealed trait TAB
      extends StObject
         with types
    /* "tab" */ val TAB: typingsJapgolly.storybookApi.distTs3Dot9ModulesAddonsMod.types.TAB & String = js.native
    
    @js.native
    sealed trait TOOL
      extends StObject
         with types
    /* "tool" */ val TOOL: typingsJapgolly.storybookApi.distTs3Dot9ModulesAddonsMod.types.TOOL & String = js.native
  }
  ...
  object Addon {
    ...
    inline def apply(render: RenderOptions => Element, title: String): Addon = {
    ...
    extension [Self <: Addon](x: Self) {
      ...
      inline def setRender(value: RenderOptions => Element): Self = StObject.set(x, "render", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.storybookApi.storybookApiStrings.page
    - scala.Unit
    - java.lang.String
  */
