...
object distTs3Dot9StoreMod {
  ...
  object Upstream {
    ...
    inline def apply(getState: CallbackTo[State], setState: (/* a */ Any, /* b */ Any) => Any): Upstream = {
      val __obj = js.Dynamic.literal(getState = getState.toJsFn, setState = js.Any.fromFunction2(setState))
