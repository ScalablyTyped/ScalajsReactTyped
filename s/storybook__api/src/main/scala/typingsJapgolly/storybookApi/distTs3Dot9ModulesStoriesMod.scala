...
import typingsJapgolly.storybookApi.anon.RefId
...
import typingsJapgolly.storybookApi.distTs3Dot9LibStoriesMod.StoryIndex
import typingsJapgolly.storybookApi.distTs3Dot9ModulesRefsMod.ComposedRef
import typingsJapgolly.storybookApi.mod.Args
...
object distTs3Dot9ModulesStoriesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.storybookApi.storybookApiInts.`-1`
    - typingsJapgolly.storybookApi.storybookApiInts.`1`
  */
  trait Direction extends StObject
  object Direction {
    
    inline def `-1`: typingsJapgolly.storybookApi.storybookApiInts.`-1` = -1.asInstanceOf[typingsJapgolly.storybookApi.storybookApiInts.`-1`]
  ...
  trait SubAPI extends StObject {
    ...
    def selectStory(kindOrId: String, story: String, obj: typingsJapgolly.storybookApi.anon.ViewMode): Unit = js.native
    def selectStory(kindOrId: String, story: Unit, obj: typingsJapgolly.storybookApi.anon.ViewMode): Unit = js.native
