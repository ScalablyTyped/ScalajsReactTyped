...
trait DocsOnly extends StObject {
  ...
  var viewMode: js.UndefOr[typingsJapgolly.storybookApi.distTs3Dot9ModulesAddonsMod.ViewMode] = js.undefined
}
object DocsOnly {
  ...
  extension [Self <: DocsOnly](x: Self) {
    ...
    inline def setViewMode(value: typingsJapgolly.storybookApi.distTs3Dot9ModulesAddonsMod.ViewMode): Self = StObject.set(x, "viewMode", value.asInstanceOf[js.Any])
