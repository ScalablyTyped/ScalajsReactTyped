...
object ServiceWorkerWebpackPluginOptions {
  ...
  def apply[T](
    ...
    template: /* serviceWorkerOption */ T => CallbackTo[js.Promise[Unit]] = null,
    transformOptions: /* serviceWorkerOption */ ServiceWorkerOption => CallbackTo[T] = null
    ...
    if (template != null) __obj.updateDynamic("template")(js.Any.fromFunction1((t0: /* serviceWorkerOption */ T) => template(t0).runNow()))
    if (transformOptions != null) __obj.updateDynamic("transformOptions")(js.Any.fromFunction1((t0: /* serviceWorkerOption */ typingsJapgolly.serviceworkerWebpackPlugin.mod.ServiceWorkerOption) => transformOptions(t0).runNow()))
