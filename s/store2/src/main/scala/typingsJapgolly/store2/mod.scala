package typingsJapgolly.store2

import org.scalablytyped.runtime.Shortcut
import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.Storage
import typingsJapgolly.store2.anon._empty
import typingsJapgolly.store2.store2Booleans.`false`
import typingsJapgolly.store2.store2Booleans.`true`
...
object mod extends Shortcut {
  ...
  - typingsJapgolly.store2.mod.BaseClear because Already inherited
  - typingsJapgolly.store2.mod.BaseTransact because Already inherited
  - typingsJapgolly.store2.mod.BaseSetAll because Already inherited */ @js.native
  trait Base
    extends BaseSet
       with BaseGet
       with BaseGetAll {
