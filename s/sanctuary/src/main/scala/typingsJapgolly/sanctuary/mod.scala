...
import typingsJapgolly.sanctuary.anon.CheckTypes
import typingsJapgolly.sanctuary.anon.Fn0
import typingsJapgolly.sanctuary.anon.FnCall
import typingsJapgolly.sanctuary.anon.FnCallContravariant
import typingsJapgolly.sanctuary.anon.FnCallF
import typingsJapgolly.sanctuary.anon.FnCallFoldable
import typingsJapgolly.sanctuary.anon.FnCallM
import typingsJapgolly.sanctuary.anon.FnCallQ
import typingsJapgolly.sanctuary.anon.FnCallR
import typingsJapgolly.sanctuary.anon.FnCallX
import typingsJapgolly.sanctuary.anon.FnCallXs
import typingsJapgolly.sanctuary.anon.Name
import typingsJapgolly.sanctuary.mod.Sanctuary.Environment
import typingsJapgolly.sanctuary.sanctuaryStrings.sanctuarySlashEither
import typingsJapgolly.sanctuary.sanctuaryStrings.sanctuarySlashMaybe
import typingsJapgolly.sanctuary.sanctuaryStrings.sanctuarySlashPair
...
object mod extends Shortcut {
  ...
  object Sanctuary {
    ...
    trait Static extends StObject {
      ...
      // Pair
      def Pair[A](a: A): js.Function1[/* b */ Any, typingsJapgolly.sanctuary.mod.Pair[A, Any]] = js.native
