package typingsJapgolly.send.mod

import typingsJapgolly.send.sendStrings.allow
import typingsJapgolly.send.sendStrings.deny
import typingsJapgolly.send.sendStrings.ignore
