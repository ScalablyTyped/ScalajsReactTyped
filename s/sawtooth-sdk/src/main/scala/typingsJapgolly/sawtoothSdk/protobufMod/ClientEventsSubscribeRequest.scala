...
object ClientEventsSubscribeRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ClientEventsSubscribeRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsSubscribeRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ClientEventsSubscribeRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientEventsSubscribeRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ClientEventsSubscribeRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsSubscribeRequest]
  /**
  ...
  /**
    ...
    * @returns ClientEventsSubscribeRequest
    */
  inline def fromObject(`object`: StringDictionary[Any]): ClientEventsSubscribeRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientEventsSubscribeRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientEventsSubscribeRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ClientEventsSubscribeRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
