...
object ClientStateGetRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ClientStateGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientStateGetRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ClientStateGetRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientStateGetRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ClientStateGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientStateGetRequest]
  /**
  ...
  /**
    ...
    * @returns ClientStateGetRequest
    */
  inline def fromObject(`object`: StringDictionary[Any]): ClientStateGetRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientStateGetRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientStateGetRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ClientStateGetRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
