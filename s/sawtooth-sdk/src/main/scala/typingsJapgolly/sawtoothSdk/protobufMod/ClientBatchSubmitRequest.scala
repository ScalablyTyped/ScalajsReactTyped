...
object ClientBatchSubmitRequest {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): ClientBatchSubmitRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBatchSubmitRequest]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ClientBatchSubmitRequest = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientBatchSubmitRequest]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ClientBatchSubmitRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientBatchSubmitRequest]
  /**
  ...
  /**
    ...
    * @returns ClientBatchSubmitRequest
    */
  inline def fromObject(`object`: StringDictionary[Any]): ClientBatchSubmitRequest = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientBatchSubmitRequest]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientBatchSubmitRequest): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ClientBatchSubmitRequest, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
