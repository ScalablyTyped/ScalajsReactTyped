...
object NetworkAcknowledgement {
  ...
  object Status extends StObject {
    ...
    sealed trait ERROR
      extends StObject
         with Status
    /* 2 */ val ERROR: typingsJapgolly.sawtoothSdk.protobufMod.NetworkAcknowledgement.Status.ERROR & Double = js.native
    
    @js.native
    sealed trait OK
      extends StObject
         with Status
    /* 1 */ val OK: typingsJapgolly.sawtoothSdk.protobufMod.NetworkAcknowledgement.Status.OK & Double = js.native
    
    @js.native
    sealed trait STATUS_UNSET
      extends StObject
         with Status
    /* 0 */ val STATUS_UNSET: typingsJapgolly.sawtoothSdk.protobufMod.NetworkAcknowledgement.Status.STATUS_UNSET & Double = js.native
  }
