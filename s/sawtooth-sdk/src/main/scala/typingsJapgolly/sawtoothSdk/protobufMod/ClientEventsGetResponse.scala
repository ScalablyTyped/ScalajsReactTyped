...
import typingsJapgolly.sawtoothSdk.protobufMod.ClientEventsGetResponse.Status
...
object ClientEventsGetResponse {
  ...
  /**
    ...
    */
  inline def create(): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[ClientEventsGetResponse]
  inline def create(properties: IClientEventsGetResponse): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  
  inline def decode(reader: js.typedarray.Uint8Array): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ClientEventsGetResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientEventsGetResponse]
  /**
    ...
    */
  inline def decode(reader: Reader): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  inline def decode(reader: Reader, length: Double): ClientEventsGetResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientEventsGetResponse]
  
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  inline def decodeDelimited(reader: Reader): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  ...
  /**
    ...
    * @returns ClientEventsGetResponse
    */
  inline def fromObject(`object`: StringDictionary[Any]): ClientEventsGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientEventsGetResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientEventsGetResponse): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ClientEventsGetResponse, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
