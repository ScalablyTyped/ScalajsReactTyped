...
import typingsJapgolly.sawtoothSdk.protobufMod.ClientPeersGetResponse.Status
...
object ClientPeersGetResponse {
  ...
  /**
    ...
    */
  inline def create(): ClientPeersGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[ClientPeersGetResponse]
  inline def create(properties: IClientPeersGetResponse): ClientPeersGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(properties.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetResponse]
  
  inline def decode(reader: js.typedarray.Uint8Array): ClientPeersGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetResponse]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): ClientPeersGetResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientPeersGetResponse]
  /**
    ...
    */
  inline def decode(reader: Reader): ClientPeersGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetResponse]
  inline def decode(reader: Reader, length: Double): ClientPeersGetResponse = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[ClientPeersGetResponse]
  
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): ClientPeersGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetResponse]
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  inline def decodeDelimited(reader: Reader): ClientPeersGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetResponse]
  ...
  /**
    ...
    * @returns ClientPeersGetResponse
    */
  inline def fromObject(`object`: StringDictionary[Any]): ClientPeersGetResponse = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[ClientPeersGetResponse]
  ...
  /**
    ...
    */
  inline def toObject(message: ClientPeersGetResponse): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: ClientPeersGetResponse, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
