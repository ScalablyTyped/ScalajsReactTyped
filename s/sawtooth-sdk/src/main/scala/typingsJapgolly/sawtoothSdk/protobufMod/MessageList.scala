...
object MessageList {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): MessageList = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[MessageList]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): MessageList = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[MessageList]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): MessageList = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[MessageList]
  /**
  ...
  /**
    ...
    * @returns MessageList
    */
  inline def fromObject(`object`: StringDictionary[Any]): MessageList = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[MessageList]
  ...
  /**
    ...
    */
  inline def toObject(message: MessageList): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: MessageList, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
