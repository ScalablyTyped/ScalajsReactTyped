...
@JSGlobal("sawtooth.protobuf.ClientBatchSubmitResponse")
@js.native
/**
...
open class ClientBatchSubmitResponse ()
  extends typingsJapgolly.sawtoothSdk.mod.protobuf.ClientBatchSubmitResponse {
...
object ClientBatchSubmitResponse {
  ...
  /** Status enum. */
  @JSGlobal("sawtooth.protobuf.ClientBatchSubmitResponse.Status")
  @js.native
