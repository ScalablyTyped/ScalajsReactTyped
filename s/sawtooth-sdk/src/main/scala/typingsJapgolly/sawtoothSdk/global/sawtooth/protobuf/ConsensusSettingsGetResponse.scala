...
@JSGlobal("sawtooth.protobuf.ConsensusSettingsGetResponse")
@js.native
/**
...
open class ConsensusSettingsGetResponse ()
  extends typingsJapgolly.sawtoothSdk.mod.protobuf.ConsensusSettingsGetResponse {
...
object ConsensusSettingsGetResponse {
  ...
  /** Status enum. */
  @JSGlobal("sawtooth.protobuf.ConsensusSettingsGetResponse.Status")
  @js.native
