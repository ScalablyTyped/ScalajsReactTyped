...
@JSGlobal("sawtooth.protobuf.ClientStateGetResponse")
@js.native
/**
...
open class ClientStateGetResponse ()
  extends typingsJapgolly.sawtoothSdk.mod.protobuf.ClientStateGetResponse {
...
object ClientStateGetResponse {
  ...
  /** Status enum. */
  @JSGlobal("sawtooth.protobuf.ClientStateGetResponse.Status")
  @js.native
