...
@JSGlobal("sawtooth.protobuf.ConsensusIgnoreBlockResponse")
@js.native
/**
...
open class ConsensusIgnoreBlockResponse ()
  extends typingsJapgolly.sawtoothSdk.mod.protobuf.ConsensusIgnoreBlockResponse {
...
object ConsensusIgnoreBlockResponse {
  ...
  /** Status enum. */
  @JSGlobal("sawtooth.protobuf.ConsensusIgnoreBlockResponse.Status")
  @js.native
