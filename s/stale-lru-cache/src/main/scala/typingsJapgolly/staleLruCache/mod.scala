...
object mod {
  ...
  object CacheOptions {
    ...
    extension [Self <: CacheOptions[?, ?], K, V](x: Self & (CacheOptions[K, V])) {
      ...
      inline def setRevalidate(value: (K, /* callback */ OptionsCallback[K, V]) => Callback): Self = StObject.set(x, "revalidate", js.Any.fromFunction2((t0: K, t1: /* callback */ OptionsCallback[K, V]) => (value(t0, t1)).runNow()))
