...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, 'pushed'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl>> */
trait PickImplpushedPartialPick
  extends StObject
     with Param {
...
object PickImplpushedPartialPick {
  ...
  extension [Self <: PickImplpushedPartialPick](x: Self) {
