...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl, 'useLegacy'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl>> */
trait PickImpluseLegacyPartialP
  extends StObject
     with Param {
...
object PickImpluseLegacyPartialP {
  ...
  extension [Self <: PickImpluseLegacyPartialP](x: Self) {
