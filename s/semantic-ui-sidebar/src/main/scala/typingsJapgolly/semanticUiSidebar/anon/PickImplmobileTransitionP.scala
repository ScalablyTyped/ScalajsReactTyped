...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl, 'mobileTransition'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.SidebarSettings._Impl>> */
trait PickImplmobileTransitionP
  extends StObject
     with Param {
...
object PickImplmobileTransitionP {
  ...
  extension [Self <: PickImplmobileTransitionP](x: Self) {
