...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, 'bottom'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl>> */
trait PickImplbottomPartialPickActive
  extends StObject
     with Param {
...
object PickImplbottomPartialPickActive {
  ...
  extension [Self <: PickImplbottomPartialPickActive](x: Self) {
