...
/* Inlined std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, 'top'> & std.Partial<std.Pick<semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl, keyof semantic-ui-sidebar.SemanticUI.Sidebar.ClassNameSettings._Impl>> */
trait PickImpltopPartialPickImpActive
  extends StObject
     with Param {
...
object PickImpltopPartialPickImpActive {
  ...
  extension [Self <: PickImpltopPartialPickImpActive](x: Self) {
