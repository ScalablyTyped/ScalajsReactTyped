...
import typingsJapgolly.scBroker.mod.QueryOptions
import typingsJapgolly.scBroker.mod.SpliceOptions
import typingsJapgolly.scBrokerCluster.anon.Targets
import typingsJapgolly.scBrokerCluster.clientclusterMod.ClientCluster
...
import typingsJapgolly.scChannel.mod.SCChannel
...
object mod {
  ...
  object ServerSocket {
    ...
    inline def apply(emit: (String, /* repeated */ Any) => Callback, id: String): ServerSocket = {
      val __obj = js.Dynamic.literal(emit = js.Any.fromFunction2((t0: String, t1: /* repeated */ Any) => (emit(t0, t1)).runNow()), id = id.asInstanceOf[js.Any])
