...
import typingsJapgolly.socketioJwt.anon.Code
import typingsJapgolly.socketioJwt.anon.Message
import typingsJapgolly.socketioJwt.socketioJwtBooleans.`false`
import typingsJapgolly.socketioJwt.socketioJwtStrings.authenticated
  ...
  object IOptions {
    ...
    extension [Self <: IOptions](x: Self) {
      ...
      inline def setAdditional_auth(
        value: (/* decoded */ js.Object, /* onSuccess */ js.Function0[Unit], /* onError */ js.Function2[/* err */ String | ISocketIOError, /* code */ String, Unit]) => Callback
      ): Self = StObject.set(x, "additional_auth", js.Any.fromFunction3((t0: /* decoded */ js.Object, t1: /* onSuccess */ js.Function0[Unit], t2: /* onError */ js.Function2[/* err */ String | ISocketIOError, /* code */ String, Unit]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setSecretFunction3(
        value: (/* request */ Any, /* decodedToken */ js.Object, /* callback */ ISocketCallback) => Callback
      ): Self = StObject.set(x, "secret", js.Any.fromFunction3((t0: /* request */ Any, t1: /* decodedToken */ js.Object, t2: /* callback */ ISocketCallback) => (value(t0, t1, t2)).runNow()))
