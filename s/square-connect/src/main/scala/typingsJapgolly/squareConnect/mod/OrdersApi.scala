...
/**
  ...
  */
open class OrdersApi () extends StObject {
  ...
  /**
    ...
    */
  def batchRetrieveOrders(body: BatchRetrieveOrdersRequest): js.Promise[BatchRetrieveOrdersResponse] = js.native
  
  /**
    * Calculates an [Order](#type-order).
    */
  def calculateOrder(body: CalculateOrderRequest): js.Promise[CalculateOrderResponse] = js.native
  ...
  /**
    ...
    */
  def createOrder(body: CreateOrderRequest): js.Promise[CreateOrderResponse] = js.native
  ...
  /**
    ...
    */
  def retrieveOrder(orderId: String): js.Promise[RetrieveOrderResponse] = js.native
  ...
  /**
    ...
    */
  def updateOrder(orderId: String, body: UpdateOrderRequest): js.Promise[UpdateOrderResponse] = js.native
}
