...
import typingsJapgolly.squareConnect.squareConnectStrings.FAILURE
import typingsJapgolly.squareConnect.squareConnectStrings.SUCCESS
import typingsJapgolly.squareConnect.squareConnectStrings.UNKNOWN
