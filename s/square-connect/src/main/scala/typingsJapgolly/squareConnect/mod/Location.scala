...
import typingsJapgolly.squareConnect.squareConnectStrings.CREDIT_CARD_PROCESSING
import typingsJapgolly.squareConnect.squareConnectStrings.MOBILE
import typingsJapgolly.squareConnect.squareConnectStrings.PHYSICAL
