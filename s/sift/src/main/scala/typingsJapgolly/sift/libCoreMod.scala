...
import typingsJapgolly.sift.libUtilsMod.Comparator
...
object libCoreMod {
  ...
  - typingsJapgolly.sift.libCoreMod.NamedOperation because var conflicts: name. Inlined  */ @JSImport("sift/lib/core", "NamedGroupOperation")
  @js.native
