...
import typingsJapgolly.sift.srcCoreMod.EqualsOperation
import typingsJapgolly.sift.srcCoreMod.NamedBaseOperation
import typingsJapgolly.sift.srcCoreMod.NamedGroupOperation
