...
import typingsJapgolly.simpleReactLightbox.mod.SRLWrapperProps
import typingsJapgolly.simpleReactLightbox.mod.Slide
...
object anon {
  ...
  object WrapperWithElementsoption {
    ...
    extension [Self <: WrapperWithElementsoption](x: Self) {
      ...
      inline def setElementsVarargs(value: typingsJapgolly.simpleReactLightbox.mod.Element*): Self = StObject.set(x, "elements", js.Array(value*))
