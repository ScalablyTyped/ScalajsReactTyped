...
object ScrollIntoView {
  ...
  */
  ...
  object callbackParameterType {
    ...
    inline def canceled: typingsJapgolly.scrollIntoView.scrollIntoViewStrings.canceled = "canceled".asInstanceOf[typingsJapgolly.scrollIntoView.scrollIntoViewStrings.canceled]
    
    inline def complete: typingsJapgolly.scrollIntoView.scrollIntoViewStrings.complete = "complete".asInstanceOf[typingsJapgolly.scrollIntoView.scrollIntoViewStrings.complete]
  }
}
