...
import typingsJapgolly.sinon.AnonAbort
...
object SinonFakeUploadProgress {
  ...
  def apply(
    ...
    __obj.updateDynamic("addEventListener")(js.Any.fromFunction2((t0: java.lang.String, t1: js.Function1[/* e */ typingsJapgolly.sinon.mod.Event, js.Any]) => addEventListener(t0, t1).runNow()))
    __obj.updateDynamic("dispatchEvent")(js.Any.fromFunction1((t0: typingsJapgolly.sinon.mod.Event) => dispatchEvent(t0).runNow()))
    __obj.updateDynamic("removeEventListener")(js.Any.fromFunction2((t0: java.lang.String, t1: js.Function1[/* e */ typingsJapgolly.sinon.mod.Event, js.Any]) => removeEventListener(t0, t1).runNow()))
