...
import typingsJapgolly.sinon.anon.DeepPartialOrMatcherArray
import typingsJapgolly.sinon.anon.MatchArgumentsArrayany
import typingsJapgolly.sinon.anon.PartialMatchArgumentsArra
