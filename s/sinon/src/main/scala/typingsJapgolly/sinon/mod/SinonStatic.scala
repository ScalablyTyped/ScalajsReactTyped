...
import typingsJapgolly.sinon.anon.PartialSinonSandboxConfig
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
- typingsJapgolly.sinon.mod.SinonApi because var conflicts: clock. Inlined expectation, FakeXMLHttpRequest, fakeServer, fakeServerWithClock, createSandbox, createSandbox, defaultConfig, addBehavior, setFormatter, promise, promise */ @js.native
trait SinonStatic
  extends StObject
     with SinonSandbox {
