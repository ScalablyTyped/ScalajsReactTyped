...
import typingsJapgolly.sinon.mod.SinonMatcher
import typingsJapgolly.sinon.mod.SinonSpy
import typingsJapgolly.sinon.sinonInts.`1`
...
object anon {
  ...
  object PartialMatchArgumentsArra {
    ...
    extension [Self <: PartialMatchArgumentsArra](x: Self) {
      ...
      inline def setSortCallbackTo(value: CallbackTo[PartialMatchArgumentsArra]): Self = StObject.set(x, "sort", value.toJsFn)
