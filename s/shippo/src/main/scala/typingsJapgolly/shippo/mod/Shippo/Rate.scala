...
import typingsJapgolly.shippo.shippoStrings.BESTVALUE
import typingsJapgolly.shippo.shippoStrings.CHEAPEST
import typingsJapgolly.shippo.shippoStrings.FASTEST
