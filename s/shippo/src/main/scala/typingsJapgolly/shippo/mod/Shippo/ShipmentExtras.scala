...
import typingsJapgolly.shippo.shippoStrings.ADULT
import typingsJapgolly.shippo.shippoStrings.CARRIER_CONFIRMATION
import typingsJapgolly.shippo.shippoStrings.CERTIFIED
import typingsJapgolly.shippo.shippoStrings.INDIRECT
import typingsJapgolly.shippo.shippoStrings.STANDARD
