...
object mod {
  ...
  @js.native
  val SwaggerUIBundle: typingsJapgolly.swaggerUiDist.mod.SwaggerUIBundle = js.native
  ...
  object SwaggerConfigs {
    ...
    extension [Self <: SwaggerConfigs](x: Self) {
      ...
      inline def setOperationsSorter(value: Callback): Self = StObject.set(x, "operationsSorter", value.toJsFn)
