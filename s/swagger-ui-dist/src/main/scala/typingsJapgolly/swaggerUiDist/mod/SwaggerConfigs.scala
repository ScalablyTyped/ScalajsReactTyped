package typingsJapgolly.swaggerUiDist.mod

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.raw.HTMLElement
import typingsJapgolly.swaggerUiDist.swaggerUiDistStrings.full
import typingsJapgolly.swaggerUiDist.swaggerUiDistStrings.list
import typingsJapgolly.swaggerUiDist.swaggerUiDistStrings.none
...
object SwaggerConfigs {
  ...
  def apply(
    ...
    operationsSorter: js.UndefOr[Callback] = js.undefined,
    plugins: js.Any = null,
    presets: js.Array[_] = null,
    requestInterceptor: /* request */ SwaggerRequest => CallbackTo[SwaggerRequest] = null,
    responseInterceptor: /* response */ SwaggerResponse => CallbackTo[SwaggerResponse] = null,
    spec: Spec = null,
    url: String = null,
    ...
    operationsSorter.foreach(p => __obj.updateDynamic("operationsSorter")(p.toJsFn))
    if (plugins != null) __obj.updateDynamic("plugins")(plugins.asInstanceOf[js.Any])
    if (presets != null) __obj.updateDynamic("presets")(presets.asInstanceOf[js.Any])
    if (requestInterceptor != null) __obj.updateDynamic("requestInterceptor")(js.Any.fromFunction1((t0: /* request */ typingsJapgolly.swaggerUiDist.mod.SwaggerRequest) => requestInterceptor(t0).runNow()))
    if (responseInterceptor != null) __obj.updateDynamic("responseInterceptor")(js.Any.fromFunction1((t0: /* response */ typingsJapgolly.swaggerUiDist.mod.SwaggerResponse) => responseInterceptor(t0).runNow()))
