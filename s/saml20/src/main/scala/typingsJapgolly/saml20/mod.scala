...
object mod {
  ...
  */
  ...
  object ValidationOptions {
    ...
    inline def ValidationOptionsWithKey(publicKey: String): typingsJapgolly.saml20.mod.ValidationOptionsWithKey = {
      val __obj = js.Dynamic.literal(publicKey = publicKey.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.saml20.mod.ValidationOptionsWithKey]
    }
    
    inline def ValidationOptionsWithPrint(thumbprint: String): typingsJapgolly.saml20.mod.ValidationOptionsWithPrint = {
      val __obj = js.Dynamic.literal(thumbprint = thumbprint.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.saml20.mod.ValidationOptionsWithPrint]
    }
  }
