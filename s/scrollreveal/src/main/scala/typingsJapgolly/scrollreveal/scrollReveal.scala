...
object scrollReveal {
  ...
  trait ScrollRevealObject extends StObject {
    ...
    def clean(selector: NodeList[Element & Node]): Unit = js.native
    ...
    def reveal(selector: NodeList[Element & Node]): ScrollRevealObject = js.native
    def reveal(selector: NodeList[Element & Node], interval: Double): ScrollRevealObject = js.native
    def reveal(selector: NodeList[Element & Node], options: ScrollRevealObjectOptions): ScrollRevealObject = js.native
    def reveal(selector: NodeList[Element & Node], options: ScrollRevealObjectOptions, interval: Double): ScrollRevealObject = js.native
  ...
  trait ScrollRevealObjectOptions extends StObject {
    ...
    var afterReset: js.UndefOr[js.Function1[/* domEl */ HTMLElement | (NodeList[Element & Node]), Unit]] = js.undefined
    
    var afterReveal: js.UndefOr[js.Function1[/* domEl */ HTMLElement | (NodeList[Element & Node]), Unit]] = js.undefined
    
    var beforeReset: js.UndefOr[js.Function1[/* domEl */ HTMLElement | (NodeList[Element & Node]), Unit]] = js.undefined
    
    var beforeReveal: js.UndefOr[js.Function1[/* domEl */ HTMLElement | (NodeList[Element & Node]), Unit]] = js.undefined
  ...
  object ScrollRevealObjectOptions {
    ...
    extension [Self <: ScrollRevealObjectOptions](x: Self) {
      ...
      inline def setAfterReset(value: /* domEl */ HTMLElement | (NodeList[Element & Node]) => Callback): Self = StObject.set(x, "afterReset", js.Any.fromFunction1((t0: /* domEl */ HTMLElement | (NodeList[Element & Node])) => value(t0).runNow()))
      
      inline def setAfterResetUndefined: Self = StObject.set(x, "afterReset", js.undefined)
      
      inline def setAfterReveal(value: /* domEl */ HTMLElement | (NodeList[Element & Node]) => Callback): Self = StObject.set(x, "afterReveal", js.Any.fromFunction1((t0: /* domEl */ HTMLElement | (NodeList[Element & Node])) => value(t0).runNow()))
      
      inline def setAfterRevealUndefined: Self = StObject.set(x, "afterReveal", js.undefined)
      
      inline def setBeforeReset(value: /* domEl */ HTMLElement | (NodeList[Element & Node]) => Callback): Self = StObject.set(x, "beforeReset", js.Any.fromFunction1((t0: /* domEl */ HTMLElement | (NodeList[Element & Node])) => value(t0).runNow()))
      
      inline def setBeforeResetUndefined: Self = StObject.set(x, "beforeReset", js.undefined)
      
      inline def setBeforeReveal(value: /* domEl */ HTMLElement | (NodeList[Element & Node]) => Callback): Self = StObject.set(x, "beforeReveal", js.Any.fromFunction1((t0: /* domEl */ HTMLElement | (NodeList[Element & Node])) => value(t0).runNow()))
