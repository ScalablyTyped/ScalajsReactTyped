...
import typingsJapgolly.sqlite3.sqlite3Strings.change
import typingsJapgolly.sqlite3.sqlite3Strings.close
import typingsJapgolly.sqlite3.sqlite3Strings.error
import typingsJapgolly.sqlite3.sqlite3Strings.limit
...
object mod {
  ...
  inline def verbose(): typingsJapgolly.sqlite3.mod.sqlite3 = ^.asInstanceOf[js.Dynamic].applyDynamic("verbose")().asInstanceOf[typingsJapgolly.sqlite3.mod.sqlite3]
  ...
  trait sqlite3 extends StObject {
    ...
    var cached: typingsJapgolly.sqlite3.anon.Database
  ...
  object sqlite3 {
    ...
    extension [Self <: typingsJapgolly.sqlite3.mod.sqlite3](x: Self) {
      ...
      inline def setCached(value: typingsJapgolly.sqlite3.anon.Database): Self = StObject.set(x, "cached", value.asInstanceOf[js.Any])
      ...
      inline def setVerbose(value: CallbackTo[typingsJapgolly.sqlite3.mod.sqlite3]): Self = StObject.set(x, "verbose", value.toJsFn)
    }
  }
}
