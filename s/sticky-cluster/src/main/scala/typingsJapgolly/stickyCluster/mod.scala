...
import typingsJapgolly.stickyCluster.anon.Stickyclusterworkerindex
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setErrorHandler(value: /* err */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "errorHandler", js.Any.fromFunction1((t0: /* err */ Any) => value(t0).runNow()))
