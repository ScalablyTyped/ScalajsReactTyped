...
name := "server"
version := "1.0-dt-20191126Z-bfbaf3"
scalaVersion := "2.13.1"
...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "csurf" % "1.9.0-dt-20200226Z-16c221",
  ...
  "org.scalablytyped.japgolly" %%% "helmet" % "0.0-unknown-dt-20200226Z-c99854",
