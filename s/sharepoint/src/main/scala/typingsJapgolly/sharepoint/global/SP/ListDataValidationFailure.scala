...
@js.native
open class ListDataValidationFailure ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.ListDataValidationFailure {
  ...
  /* CompleteClass */
  override def get_reason(): typingsJapgolly.sharepoint.SP.ListDataValidationFailureReason = js.native
  
  /* CompleteClass */
  override def get_typeId(): String = js.native
  
  /* CompleteClass */
  override def get_validationType(): typingsJapgolly.sharepoint.SP.ListDataValidationType = js.native
