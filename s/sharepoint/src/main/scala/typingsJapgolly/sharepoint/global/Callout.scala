...
open class Callout ()
  extends StObject
     with typingsJapgolly.sharepoint.Callout {
  
  /** Adds a link to the actions panel in the bottom part of the callout window */
  /* CompleteClass */
  override def addAction(action: typingsJapgolly.sharepoint.CalloutAction): Unit = js.native
  ...
  /* CompleteClass */
  override def getActionMenu(): typingsJapgolly.sharepoint.CalloutActionMenu = js.native
  ...
  /* CompleteClass */
  override def getOpenOptions(): typingsJapgolly.sharepoint.CalloutOpenOptions = js.native
  ...
  /* CompleteClass */
  override def set(options: typingsJapgolly.sharepoint.CalloutOptions): Any = js.native
