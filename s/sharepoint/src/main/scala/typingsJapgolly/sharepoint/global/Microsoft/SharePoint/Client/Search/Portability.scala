...
object Portability {
  ...
  open class SearchConfigurationPortability protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Portability.SearchConfigurationPortability {
  ...
  open class SearchConfigurationPortabilityPropertyNames ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Portability.SearchConfigurationPortabilityPropertyNames
