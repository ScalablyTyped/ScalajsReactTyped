...
open class Tab protected ()
  extends StObject
     with typingsJapgolly.sharepoint.CUI.Tab {
  def this(
    ribbon: typingsJapgolly.sharepoint.CUI.Ribbon,
    id: String,
    title: String,
    description: String,
    command: String,
  ...
  /* CompleteClass */
  override def get_contextual(): Boolean = js.native
  
  /* CompleteClass */
  override def get_contextualGroupId(): String = js.native
  
  /* CompleteClass */
  override def get_cssClass(): String = js.native
  
  /* CompleteClass */
  override def get_currentScalingIndex(): Double = js.native
  ...
  /* CompleteClass */
  override def get_scaling(): String = js.native
  
  /* CompleteClass */
  override def get_selected(): Boolean = js.native
  ...
  /* CompleteClass */
  override def scaleDown(): scala.Unit = js.native
  
  /* CompleteClass */
  override def scaleMax(): scala.Unit = js.native
  
  /* CompleteClass */
  override def scaleUp(): scala.Unit = js.native
  ...
  /* CompleteClass */
  override def set_selected(isSelected: Boolean): scala.Unit = js.native
