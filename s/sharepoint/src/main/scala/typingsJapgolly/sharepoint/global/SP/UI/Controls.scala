...
import typingsJapgolly.sharepoint.SP.UI.Controls.INavigationOptions
import typingsJapgolly.sharepoint.SP.UI.Controls.ISettingsLink
...
object Controls {
  ...
  open class ControlManager ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.UI.Controls.ControlManager
  ...
  open class Navigation protected ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.UI.Controls.Navigation {
  ...
  open class SettingsLink ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.UI.Controls.SettingsLink {
