...
open class DialogOptions ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.UI.DialogOptions {
  ...
  override def dialogReturnValueCallback_MDialogOptions(dialogResult: typingsJapgolly.sharepoint.SP.UI.DialogResult, returnValue: Any): Unit = js.native
  /** callback that is called after dialog is closed */
  /* CompleteClass */
  @JSName("dialogReturnValueCallback")
