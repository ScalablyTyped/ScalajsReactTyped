...
open class SPClientPeoplePickerMRU ()
  extends StObject
     with typingsJapgolly.sharepoint.SPClientPeoplePickerMRU {
...
object SPClientPeoplePickerMRU {
  ...
  /* static member */
  inline def GetSPClientPeoplePickerMRU(): typingsJapgolly.sharepoint.SPClientPeoplePickerMRU = ^.asInstanceOf[js.Dynamic].applyDynamic("GetSPClientPeoplePickerMRU")().asInstanceOf[typingsJapgolly.sharepoint.SPClientPeoplePickerMRU]
