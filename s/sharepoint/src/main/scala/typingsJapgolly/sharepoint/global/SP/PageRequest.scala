...
open class PageRequest ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.PageRequest {
  
  /* CompleteClass */
  override def add_failed(
    value: js.Function2[
      /* sender */ Any, 
      /* args */ typingsJapgolly.sharepoint.SP.PageRequestFailedEventArgs, 
      Unit
    ]
  ): Unit = js.native
  ...
  override def add_succeeded(
    value: js.Function2[
      /* sender */ Any, 
      /* args */ typingsJapgolly.sharepoint.SP.PageRequestSucceededEventArgs, 
      Unit
    ]
  ): Unit = js.native
