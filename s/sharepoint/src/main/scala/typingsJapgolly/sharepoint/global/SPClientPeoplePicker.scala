...
import typingsJapgolly.sharepoint.ISPClientPeoplePickerSchema
...
@js.native
open class SPClientPeoplePicker ()
  extends StObject
     with typingsJapgolly.sharepoint.SPClientPeoplePicker
object SPClientPeoplePicker {
  ...
  inline def AddAutoFillMetaData(
    pickerObj: typingsJapgolly.sharepoint.SPClientPeoplePicker,
  ...
  /* static member */
  inline def BuildAutoFillMenuItems(
    pickerObj: typingsJapgolly.sharepoint.SPClientPeoplePicker,
    options: js.Array[ISPClientPeoplePickerEntity]
  ): js.Array[ISPClientPeoplePickerEntity] = (^.asInstanceOf[js.Dynamic].applyDynamic("BuildAutoFillMenuItems")(pickerObj.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Array[ISPClientPeoplePickerEntity]]
  ...
  /* static member */
  inline def PickerObjectFromSubElement(elmSubElement: HTMLElement): typingsJapgolly.sharepoint.SPClientPeoplePicker = ^.asInstanceOf[js.Dynamic].applyDynamic("PickerObjectFromSubElement")(elmSubElement.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sharepoint.SPClientPeoplePicker]
