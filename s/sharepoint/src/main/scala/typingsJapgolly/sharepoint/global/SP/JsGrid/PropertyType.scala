...
import typingsJapgolly.sharepoint.SP.JsGrid.IEditControl
import typingsJapgolly.sharepoint.SP.JsGrid.IEditControlGridContext
import typingsJapgolly.sharepoint.SP.JsGrid.IPropertyType
import typingsJapgolly.sharepoint.SP.JsGrid.IRecord
...
open class PropertyType ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.JsGrid.PropertyType
object PropertyType {
  ...
  open class CheckBoxBoolean ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.JsGrid.PropertyType.CheckBoxBoolean {
  ...
  open class DropDownBoolean ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.JsGrid.PropertyType.DropDownBoolean {
  ...
  open class HyperLink ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.JsGrid.PropertyType.HyperLink {
  ...
  open class LookupTable protected ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.JsGrid.PropertyType.LookupTable {
  ...
  open class MultiValuePropType ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.JsGrid.PropertyType.MultiValuePropType {
  ...
  open class String ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.JsGrid.PropertyType.String {
  ...
  open class Utils ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.JsGrid.PropertyType.Utils
  object Utils {
