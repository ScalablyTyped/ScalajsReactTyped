...
import typingsJapgolly.microsoftAjax.Sys.StringBuilder
...
open class XmlWriter ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.XmlWriter {
...
object XmlWriter {
  ...
  /* static member */
  inline def create(sb: StringBuilder): typingsJapgolly.sharepoint.SP.XmlWriter = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(sb.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sharepoint.SP.XmlWriter]
}
