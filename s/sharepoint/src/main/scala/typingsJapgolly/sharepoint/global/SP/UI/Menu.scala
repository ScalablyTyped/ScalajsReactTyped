...
open class Menu ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.UI.Menu {
  ...
  override def addSubMenu(
    ...
    description: String,
    id: String
  ): typingsJapgolly.sharepoint.SP.UI.Menu = js.native
...
object Menu {
  ...
  /* static member */
  inline def create(id: String): typingsJapgolly.sharepoint.SP.UI.Menu = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(id.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sharepoint.SP.UI.Menu]
}
