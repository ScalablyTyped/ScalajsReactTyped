...
open class Group protected ()
  extends StObject
     with typingsJapgolly.sharepoint.CUI.Group {
  def this(
  ...
  /* CompleteClass */
  override def selectLayout(layoutType: String, popupLayoutTitle: String): scala.Unit = js.native
  ...
  /* CompleteClass */
  override def unselectLayout(): scala.Unit = js.native
