...
object Application {
  ...
  object UI {
    ...
    open class DefaultFormsInformation ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.DefaultFormsInformation {
      
      /* CompleteClass */
      var DefaultForms: typingsJapgolly.sharepoint.SP.Application.UI.FormsInfo = js.native
    ...
    open class DefaultFormsMenuBuilder ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.DefaultFormsMenuBuilder
    object DefaultFormsMenuBuilder {
      ...
      /* static member */
      inline def getDefaultFormsInformation(requestor: DefaultFormsInformationRequestor, listId: typingsJapgolly.sharepoint.SP.Guid): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("getDefaultFormsInformation")(requestor.asInstanceOf[js.Any], listId.asInstanceOf[js.Any])).asInstanceOf[Unit]
    }
    ...
    open class FormsInfo ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.FormsInfo {
    ...
    open class MoreColorsPage protected ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.MoreColorsPage {
      ...
      /* CompleteClass */
      override def get_moreColorsPicker(): typingsJapgolly.sharepoint.SP.Application.UI.MoreColorsPicker = js.native
      ...
      /* CompleteClass */
      override def set_moreColorsPicker(value: typingsJapgolly.sharepoint.SP.Application.UI.MoreColorsPicker): Unit = js.native
    ...
    open class MoreColorsPicker protected ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.MoreColorsPicker {
      def this(e: HTMLElement) = this()
    ...
    open class ThemeWebPage protected ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.ThemeWebPage {
      def this(e: HTMLElement) = this()
    ...
    open class ViewSelectorGroups ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.ViewSelectorGroups {
      
      /* CompleteClass */
      var DefaultView: typingsJapgolly.sharepoint.SP.Application.UI.ViewSelectorMenuItem = js.native
    ...
    open class ViewSelectorMenuBuilder ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.ViewSelectorMenuBuilder
    object ViewSelectorMenuBuilder {
      ...
      inline def getViewInformation(
        ...
        options: typingsJapgolly.sharepoint.SP.Application.UI.ViewSelectorMenuOptions
      ...
      /* static member */
      inline def showMenu(elem: HTMLElement, options: typingsJapgolly.sharepoint.SP.Application.UI.ViewSelectorMenuOptions): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("showMenu")(elem.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
    }
    ...
    open class ViewSelectorMenuItem ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.ViewSelectorMenuItem {
    ...
    open class ViewSelectorMenuOptions ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.ViewSelectorMenuOptions {
    ...
    open class ViewSelectorSubMenu ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.ViewSelectorSubMenu {
    ...
    open class WikiPageNameInPlaceEditor protected ()
      extends StObject
         with typingsJapgolly.sharepoint.SP.Application.UI.WikiPageNameInPlaceEditor {
