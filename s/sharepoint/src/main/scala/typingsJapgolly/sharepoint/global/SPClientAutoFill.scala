...
import typingsJapgolly.sharepoint.ISPClientAutoFillData
...
open class SPClientAutoFill protected ()
  extends StObject
     with typingsJapgolly.sharepoint.SPClientAutoFill {
  def this(
    elmTextId: String,
...
object SPClientAutoFill {
  ...
  /* static member */
  inline def GetAutoFillObjFromContainer(elmChild: HTMLElement): typingsJapgolly.sharepoint.SPClientAutoFill = ^.asInstanceOf[js.Dynamic].applyDynamic("GetAutoFillObjFromContainer")(elmChild.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sharepoint.SPClientAutoFill]
  
  // = 'AutoFillMenuOptionType';
  /* static member */
  inline def GetAutoFillObjFromInput(elmText: HTMLInputElement): typingsJapgolly.sharepoint.SPClientAutoFill = ^.asInstanceOf[js.Dynamic].applyDynamic("GetAutoFillObjFromInput")(elmText.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sharepoint.SPClientAutoFill]
