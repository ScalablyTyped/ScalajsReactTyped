...
open class DataConvert ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.DataConvert
object DataConvert {
  ...
  /* static member */
  inline def fixupType(context: typingsJapgolly.sharepoint.SP.ClientRuntimeContext, obj: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("fixupType")(context.asInstanceOf[js.Any], obj.asInstanceOf[js.Any])).asInstanceOf[Any]
  
  /* static member */
  inline def fixupTypes(context: typingsJapgolly.sharepoint.SP.ClientRuntimeContext, dict: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("fixupTypes")(context.asInstanceOf[js.Any], dict.asInstanceOf[js.Any])).asInstanceOf[Unit]
  
  /* static member */
  inline def getDateTimeKind(datetime: js.Date): typingsJapgolly.sharepoint.SP.DateTimeKind = ^.asInstanceOf[js.Dynamic].applyDynamic("getDateTimeKind")(datetime.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sharepoint.SP.DateTimeKind]
  ...
  /* static member */
  inline def populateArray(context: typingsJapgolly.sharepoint.SP.ClientRuntimeContext, dest: Any, jsonArrayFromServer: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("populateArray")(context.asInstanceOf[js.Any], dest.asInstanceOf[js.Any], jsonArrayFromServer.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /* static member */
  inline def specifyDateTimeKind(datetime: js.Date, kind: typingsJapgolly.sharepoint.SP.DateTimeKind): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("specifyDateTimeKind")(datetime.asInstanceOf[js.Any], kind.asInstanceOf[js.Any])).asInstanceOf[Unit]
