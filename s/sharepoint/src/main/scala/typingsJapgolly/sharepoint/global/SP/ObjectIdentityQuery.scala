...
open class ObjectIdentityQuery protected ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.ClientAction {
  def this(objectPath: typingsJapgolly.sharepoint.SP.ObjectPath) = this()
  ...
  /* CompleteClass */
  override def get_path(): typingsJapgolly.sharepoint.SP.ObjectPath = js.native
}
