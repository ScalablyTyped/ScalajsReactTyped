...
open class ClientContext ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.ClientContext {
...
object ClientContext {
  ...
  /* static member */
  inline def getCurrent(): typingsJapgolly.sharepoint.SP.ClientContext = ^.asInstanceOf[js.Dynamic].applyDynamic("get_current")().asInstanceOf[typingsJapgolly.sharepoint.SP.ClientContext]
}
