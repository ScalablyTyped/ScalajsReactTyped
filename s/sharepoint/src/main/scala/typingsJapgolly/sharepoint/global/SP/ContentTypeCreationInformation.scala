...
@js.native
open class ContentTypeCreationInformation ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.ContentTypeCreationInformation {
  ...
  /* CompleteClass */
  override def get_parentContentType(): typingsJapgolly.sharepoint.SP.ContentType = js.native
  ...
  /* CompleteClass */
  override def set_parentContentType(value: typingsJapgolly.sharepoint.SP.ContentType): Unit = js.native
