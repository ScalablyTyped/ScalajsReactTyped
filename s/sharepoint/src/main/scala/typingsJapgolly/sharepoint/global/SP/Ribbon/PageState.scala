...
object PageState {
  ...
  open class Handlers ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.Ribbon.PageState.Handlers
  
  @JSGlobal("SP.Ribbon.PageState.PageStateCommands")
  @js.native
  open class PageStateCommands ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.Ribbon.PageState.PageStateCommands
  
  @JSGlobal("SP.Ribbon.PageState.PageStateHandler")
  @js.native
  open class PageStateHandler ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.Ribbon.PageState.PageStateHandler {
  ...
  open class PageStateStrings ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.Ribbon.PageState.PageStateStrings
  
  @JSGlobal("SP.Ribbon.PageState.StateChangeDialogHandler")
  @js.native
  open class StateChangeDialogHandler ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.Ribbon.PageState.StateChangeDialogHandler
}
