...
open class ColumnInfo protected ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.JsGrid.ColumnInfo {
  ...
  /* CompleteClass */
  override def fnGetCellEditMode(record: IRecord, fieldKey: String): typingsJapgolly.sharepoint.SP.JsGrid.EditMode = js.native
