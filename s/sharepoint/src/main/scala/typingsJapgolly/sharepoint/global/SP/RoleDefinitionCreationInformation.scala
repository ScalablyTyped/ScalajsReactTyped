...
open class RoleDefinitionCreationInformation ()
  extends StObject
     with typingsJapgolly.sharepoint.SP.RoleDefinitionCreationInformation {
  ...
  /* CompleteClass */
  override def get_basePermissions(): typingsJapgolly.sharepoint.SP.BasePermissions = js.native
  ...
  /* CompleteClass */
  override def set_basePermissions(value: typingsJapgolly.sharepoint.SP.BasePermissions): Unit = js.native
