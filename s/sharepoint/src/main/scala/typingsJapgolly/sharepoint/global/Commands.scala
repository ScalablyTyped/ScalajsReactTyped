...
object Commands {
  ...
  open class CommandIds ()
    extends StObject
       with typingsJapgolly.sharepoint.Commands.CommandIds
  object CommandIds {
  ...
  open class GlobalRedoProperties ()
    extends StObject
       with typingsJapgolly.sharepoint.Commands.GlobalRedoProperties
  ...
  open class GlobalUndoProperties ()
    extends StObject
       with typingsJapgolly.sharepoint.Commands.GlobalUndoProperties
  ...
  open class RedoProperties ()
    extends StObject
       with typingsJapgolly.sharepoint.Commands.RedoProperties
  ...
  open class UndoProperties ()
    extends StObject
       with typingsJapgolly.sharepoint.Commands.UndoProperties
