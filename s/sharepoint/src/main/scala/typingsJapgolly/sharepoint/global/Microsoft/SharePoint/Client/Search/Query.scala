...
import typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValueType
import typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType
import typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.SortDirection
...
object Query {
  ...
  open class KeywordQuery protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.KeywordQuery {
  ...
  open class KeywordQueryObjectPropertyNames ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.KeywordQueryObjectPropertyNames
  ...
  open class KeywordQueryProperties ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.KeywordQueryProperties
  
  @JSGlobal("Microsoft.SharePoint.Client.Search.Query.KeywordQueryPropertyNames")
  @js.native
  open class KeywordQueryPropertyNames ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.KeywordQueryPropertyNames
  ...
  open class PersonalResultSuggestion ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.PersonalResultSuggestion {
  ...
  open class PopularQuery ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.PopularQuery {
  ...
  open class Query ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.Query
  
  @JSGlobal("Microsoft.SharePoint.Client.Search.Query.QueryObjectPropertyNames")
  @js.native
  open class QueryObjectPropertyNames ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryObjectPropertyNames
  ...
  open class QueryPropertyNames ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyNames
  ...
  open class QueryPropertyValue ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValue {
  ...
  object QueryPropertyValueType extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValueType & Double
      ] = js.native
    
    /* 3 */ val booleanType: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValueType.booleanType & Double = js.native
    
    /* 2 */ val int32TYpe: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValueType.int32TYpe & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValueType.none & Double = js.native
    
    /* 4 */ val stringArrayType: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValueType.stringArrayType & Double = js.native
    
    /* 1 */ val stringType: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValueType.stringType & Double = js.native
    
    /* 5 */ val unSupportedType: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValueType.unSupportedType & Double = js.native
  }
  ...
  open class QuerySuggestionQuery ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QuerySuggestionQuery {
  ...
  open class QuerySuggestionResults ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QuerySuggestionResults {
    ...
    override def get_personalResults(): js.Array[
        typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.PersonalResultSuggestion
      ] = js.native
    
    /* CompleteClass */
    override def get_queries(): js.Array[
        typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QuerySuggestionQuery
      ] = js.native
  ...
  open class QueryUtility ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryUtility
  object QueryUtility {
    ...
    def create: js.Function2[
        /* name */ String, 
        /* val */ Any, 
        typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValue
      ] = js.native
    inline def create_=(
      x: js.Function2[
          /* name */ String, 
    ...
    def getQueryPropertyValueType: js.Function1[
        /* val */ typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.QueryPropertyValue, 
  ...
  open class RankingLabeling protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.RankingLabeling {
    def this(context: ClientContext) = this()
  }
  ...
  open class ReorderingRule ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRule {
  ...
  object ReorderingRuleMatchType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType & Double
      ] = js.native
    
    /* 5 */ val contentTypeIs: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.contentTypeIs & Double = js.native
    
    /* 6 */ val fileExtensionMatches: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.fileExtensionMatches & Double = js.native
    
    /* 8 */ val manualCondition: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.manualCondition & Double = js.native
    
    /* 0 */ val resultContainsKeyword: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.resultContainsKeyword & Double = js.native
    
    /* 7 */ val resultHasTag: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.resultHasTag & Double = js.native
    
    /* 1 */ val titleContainsKeyword: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.titleContainsKeyword & Double = js.native
    
    /* 2 */ val titleMatchesKeyword: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.titleMatchesKeyword & Double = js.native
    
    /* 4 */ val urlExactlyMatches: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.urlExactlyMatches & Double = js.native
    
    /* 3 */ val urlStartsWith: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ReorderingRuleMatchType.urlStartsWith & Double = js.native
  }
  ...
  open class ResultTable ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ResultTable {
  ...
  open class ResultTableCollection ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ResultTableCollection {
    ...
    /* CompleteClass */
    override def getEnumerator(): IEnumerator[typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ResultTable] = js.native
    ...
    /* CompleteClass */
    override def get_item(index: Double): typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.ResultTable = js.native
  ...
  open class SearchExecutor protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.SearchExecutor {
    def this(context: ClientContext) = this()
  }
  ...
  open class Sort ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.Sort {
  ...
  object SortDirection extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.SortDirection & Double
      ] = js.native
    
    /* 0 */ val ascending: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.SortDirection.ascending & Double = js.native
    
    /* 1 */ val descending: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.SortDirection.descending & Double = js.native
    
    /* 2 */ val fqlFormula: typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.SortDirection.fqlFormula & Double = js.native
  }
  ...
  open class StringCollection protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Microsoft.SharePoint.Client.Search.Query.StringCollection {
    def this(context: ClientContext) = this()
