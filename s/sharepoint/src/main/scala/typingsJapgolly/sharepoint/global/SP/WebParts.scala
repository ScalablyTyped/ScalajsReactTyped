...
object WebParts {
  ...
  open class LimitedWebPartManager ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.WebParts.LimitedWebPartManager
  ...
  object PersonalizationScope extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.sharepoint.SP.WebParts.PersonalizationScope & Double] = js.native
    
    /* 1 */ val shared: typingsJapgolly.sharepoint.SP.WebParts.PersonalizationScope.shared & Double = js.native
    
    /* 0 */ val user: typingsJapgolly.sharepoint.SP.WebParts.PersonalizationScope.user & Double = js.native
  }
  ...
  open class TileData ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.WebParts.TileData {
  ...
  open class WebPart ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.WebParts.WebPart
  
  @JSGlobal("SP.WebParts.WebPartDefinition")
  @js.native
  open class WebPartDefinition ()
    extends StObject
       with typingsJapgolly.sharepoint.SP.WebParts.WebPartDefinition
}
