...
import typingsJapgolly.sharepoint.Srch.CSRRefinementControl
import typingsJapgolly.sharepoint.Srch.RefinementInfo
import typingsJapgolly.sharepoint.Srch.RenderFunction
import typingsJapgolly.sharepoint.sharepointStrings.Body
import typingsJapgolly.sharepoint.sharepointStrings.Group
import typingsJapgolly.sharepoint.sharepointStrings.IsFirstPinnedResultBlock
import typingsJapgolly.sharepoint.sharepointStrings.IsFirstRankedResultBlock
import typingsJapgolly.sharepoint.sharepointStrings.Item
import typingsJapgolly.sharepoint.sharepointStrings.ParentTableReference
import typingsJapgolly.sharepoint.sharepointStrings.Properties
import typingsJapgolly.sharepoint.sharepointStrings.QueryErrors
import typingsJapgolly.sharepoint.sharepointStrings.QueryId
import typingsJapgolly.sharepoint.sharepointStrings.QueryRuleId
import typingsJapgolly.sharepoint.sharepointStrings.RenderTemplateId
import typingsJapgolly.sharepoint.sharepointStrings.RenderTemplates
import typingsJapgolly.sharepoint.sharepointStrings.ResultRows
import typingsJapgolly.sharepoint.sharepointStrings.ResultTables
import typingsJapgolly.sharepoint.sharepointStrings.RowCount
import typingsJapgolly.sharepoint.sharepointStrings.TableType
import typingsJapgolly.sharepoint.sharepointStrings.TotalRows
import typingsJapgolly.sharepoint.sharepointStrings.TotalRowsIncludingDuplicates
import typingsJapgolly.sharepoint.sharepointStrings.View
import typingsJapgolly.sharepoint.sharepointStrings._deepLinks
import typingsJapgolly.sharepoint.sharepointStrings._discussions
import typingsJapgolly.sharepoint.sharepointStrings._group
import typingsJapgolly.sharepoint.sharepointStrings._groupContent
import typingsJapgolly.sharepoint.sharepointStrings._groupLink
import typingsJapgolly.sharepoint.sharepointStrings._groupTitle
import typingsJapgolly.sharepoint.sharepointStrings._hover
import typingsJapgolly.sharepoint.sharepointStrings._item
import typingsJapgolly.sharepoint.sharepointStrings._itemBody
import typingsJapgolly.sharepoint.sharepointStrings._itemIcon
import typingsJapgolly.sharepoint.sharepointStrings._itemPath
import typingsJapgolly.sharepoint.sharepointStrings._itemPreview
import typingsJapgolly.sharepoint.sharepointStrings._itemSummary
import typingsJapgolly.sharepoint.sharepointStrings._itemTitle
import typingsJapgolly.sharepoint.sharepointStrings._itemTitleLink
import typingsJapgolly.sharepoint.sharepointStrings._likes
import typingsJapgolly.sharepoint.sharepointStrings._members
import typingsJapgolly.sharepoint.sharepointStrings._postInfo
import typingsJapgolly.sharepoint.sharepointStrings._replies
import typingsJapgolly.sharepoint.sharepointStrings._visualBestBet
...
object Srch {
  ...
  open class ClientControl protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.ClientControl {
  ...
  open class DataProvider protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.DataProvider {
    def this(elem: Element) = this()
  ...
  object DateTimeKind extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.sharepoint.Srch.DateTimeKind & Double] = js.native
    
    /* 2 */ val local: typingsJapgolly.sharepoint.Srch.DateTimeKind.local & Double = js.native
    
    /* 0 */ val unspecified: typingsJapgolly.sharepoint.Srch.DateTimeKind.unspecified & Double = js.native
    
    /* 1 */ val utc: typingsJapgolly.sharepoint.Srch.DateTimeKind.utc & Double = js.native
  }
  ...
  open class DisplayControl ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.DisplayControl {
    ...
    /* CompleteClass */
    override def get_dataProvider(): typingsJapgolly.sharepoint.Srch.DataProvider = js.native
  ...
  object EventType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.sharepoint.Srch.EventType & Double] = js.native
    
    /* 3 */ val batchQueryIssuing: typingsJapgolly.sharepoint.Srch.EventType.batchQueryIssuing & Double = js.native
    
    /* 5 */ val batchResultReady: typingsJapgolly.sharepoint.Srch.EventType.batchResultReady & Double = js.native
    
    /* 9 */ val load: typingsJapgolly.sharepoint.Srch.EventType.load & Double = js.native
    
    /* 0 */ val none: typingsJapgolly.sharepoint.Srch.EventType.none & Double = js.native
    
    /* 10 */ val postLoad: typingsJapgolly.sharepoint.Srch.EventType.postLoad & Double = js.native
    
    /* 8 */ val preLoad: typingsJapgolly.sharepoint.Srch.EventType.preLoad & Double = js.native
    
    /* 2 */ val queryIssuing: typingsJapgolly.sharepoint.Srch.EventType.queryIssuing & Double = js.native
    
    /* 1 */ val queryReady: typingsJapgolly.sharepoint.Srch.EventType.queryReady & Double = js.native
    
    /* 6 */ val queryStateChanged: typingsJapgolly.sharepoint.Srch.EventType.queryStateChanged & Double = js.native
    
    /* 4 */ val resultReady: typingsJapgolly.sharepoint.Srch.EventType.resultReady & Double = js.native
    
    /* 7 */ val resultRendered: typingsJapgolly.sharepoint.Srch.EventType.resultRendered & Double = js.native
  }
  ...
  object MessageLevel extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.sharepoint.Srch.MessageLevel & Double] = js.native
    
    /* 2 */ val error: typingsJapgolly.sharepoint.Srch.MessageLevel.error & Double = js.native
    
    /* 0 */ val information: typingsJapgolly.sharepoint.Srch.MessageLevel.information & Double = js.native
    
    /* 1 */ val warning: typingsJapgolly.sharepoint.Srch.MessageLevel.warning & Double = js.native
  }
  ...
  open class Refinement protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.Refinement {
    def this(elem: Element) = this()
    ...
    /* CompleteClass */
    override def getRefinementControl(refinerName: String): typingsJapgolly.sharepoint.Srch.RefinementControl = js.native
    ...
    /* CompleteClass */
    override def get_selectedRefinementControls(): js.Array[typingsJapgolly.sharepoint.Srch.RefinementControl] = js.native
    ...
    /* CompleteClass */
    override def set_selectedRefinementControls(value: js.Array[typingsJapgolly.sharepoint.Srch.RefinementControl]): js.Array[typingsJapgolly.sharepoint.Srch.RefinementControl] = js.native
    ...
    /* CompleteClass */
    override def updateRefinementControls(newControls: js.Array[typingsJapgolly.sharepoint.Srch.RefinementControl]): Unit = js.native
  ...
  object Refinement {
    ...
    /* static member */
    inline def getRefinementTitle(currentRefinemntControl: typingsJapgolly.sharepoint.Srch.RefinementControl): String = ^.asInstanceOf[js.Dynamic].applyDynamic("getRefinementTitle")(currentRefinemntControl.asInstanceOf[js.Any]).asInstanceOf[String]
    
    /* static member */
    inline def multiRefinerSpecifyOtherFilterValue(
      refinerName: String,
      clientControl: typingsJapgolly.sharepoint.Srch.Refinement,
      useContains: Boolean,
      useKQL: Boolean
    ...
    /* static member */
    inline def submitMultiRefinement(
      name: String,
      control: typingsJapgolly.sharepoint.Srch.Refinement,
      useContains: Boolean,
      useKQL: Boolean
    ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("submitMultiRefinement")(name.asInstanceOf[js.Any], control.asInstanceOf[js.Any], useContains.asInstanceOf[js.Any], useKQL.asInstanceOf[js.Any])).asInstanceOf[Unit]
  }
  ...
  open class RefinementControl protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.RefinementControl {
  ...
  open class RefinementUtil ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.RefinementUtil
  object RefinementUtil {
    ...
    /* static member */
    inline def peoplePickerApplyIdPrefix(control: typingsJapgolly.sharepoint.Srch.ClientControl): String = ^.asInstanceOf[js.Dynamic].applyDynamic("peoplePickerApplyIdPrefix")(control.asInstanceOf[js.Any]).asInstanceOf[String]
    inline def peoplePickerApplyIdPrefix(control: typingsJapgolly.sharepoint.Srch.RefinementControl): String = ^.asInstanceOf[js.Dynamic].applyDynamic("peoplePickerApplyIdPrefix")(control.asInstanceOf[js.Any]).asInstanceOf[String]
    
    /* static member */
    inline def peoplePickerPrep(
      id: String,
      refiner: typingsJapgolly.sharepoint.Srch.RefinementControl,
      clientControl: typingsJapgolly.sharepoint.Srch.Refinement
  ...
  open class Res ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.Res
  object Res {
  ...
  open class Result protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.Result {
    def this(elem: Element) = this()
  ...
  open class ScriptApplicationManager ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.ScriptApplicationManager
  object ScriptApplicationManager {
    ...
    /* static member */
    inline def getCurrent(): typingsJapgolly.sharepoint.Srch.ScriptApplicationManager = ^.asInstanceOf[js.Dynamic].applyDynamic("get_current")().asInstanceOf[typingsJapgolly.sharepoint.Srch.ScriptApplicationManager]
  }
  ...
  open class SearchBox protected ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.SearchBox {
    def this(elem: Element) = this()
  ...
  open class U ()
    extends StObject
       with typingsJapgolly.sharepoint.Srch.U
  object U {
    ...
    open class Ids ()
      extends StObject
         with typingsJapgolly.sharepoint.Srch.U.Ids
    object Ids {
    ...
    object LoadScriptsProgress extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.sharepoint.Srch.U.LoadScriptsProgress & Double] = js.native
      
      /* 2 */ val failure: typingsJapgolly.sharepoint.Srch.U.LoadScriptsProgress.failure & Double = js.native
      
      /* 0 */ val loading: typingsJapgolly.sharepoint.Srch.U.LoadScriptsProgress.loading & Double = js.native
      
      /* 1 */ val success: typingsJapgolly.sharepoint.Srch.U.LoadScriptsProgress.success & Double = js.native
    }
    ...
    open class LoadScriptsState ()
      extends StObject
         with typingsJapgolly.sharepoint.Srch.U.LoadScriptsState {
    ...
    open class PropNames ()
      extends StObject
         with typingsJapgolly.sharepoint.Srch.U.PropNames
    object PropNames {
    ...
    /* static member */
    inline def animateResults(result: typingsJapgolly.sharepoint.Srch.Result, userAction: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("animateResults")(result.asInstanceOf[js.Any], userAction.asInstanceOf[js.Any])).asInstanceOf[Unit]
    ...
    /* static member */
    inline def getClientComponent(e: Element): typingsJapgolly.sharepoint.Srch.ClientControl = ^.asInstanceOf[js.Dynamic].applyDynamic("getClientComponent")(e.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sharepoint.Srch.ClientControl]
    ...
    inline def resolveRenderTemplate(
      renderCtx: Any,
      component: typingsJapgolly.sharepoint.Srch.ClientControl,
    ...
    /* static member */
    inline def trace(c: typingsJapgolly.sharepoint.Srch.ClientControl, method: String, message: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("trace")(c.asInstanceOf[js.Any], method.asInstanceOf[js.Any], message.asInstanceOf[js.Any])).asInstanceOf[Unit]
    
    /* static member */
    inline def traceFormatted(c: typingsJapgolly.sharepoint.Srch.ClientControl, method: String, format: String, values: String*): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("traceFormatted")((scala.List(c.asInstanceOf[js.Any], method.asInstanceOf[js.Any], format.asInstanceOf[js.Any])).`++`(values.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[Unit]
  ...
  object UserActionType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.sharepoint.Srch.UserActionType & Double] = js.native
    
    /* 5 */ val filterLanguage: typingsJapgolly.sharepoint.Srch.UserActionType.filterLanguage & Double = js.native
    
    /* 1 */ val pageNext: typingsJapgolly.sharepoint.Srch.UserActionType.pageNext & Double = js.native
    
    /* 2 */ val pagePrev: typingsJapgolly.sharepoint.Srch.UserActionType.pagePrev & Double = js.native
    
    /* 3 */ val refine: typingsJapgolly.sharepoint.Srch.UserActionType.refine & Double = js.native
    
    /* 0 */ val search: typingsJapgolly.sharepoint.Srch.UserActionType.search & Double = js.native
    
    /* 4 */ val sort: typingsJapgolly.sharepoint.Srch.UserActionType.sort & Double = js.native
  }
}
