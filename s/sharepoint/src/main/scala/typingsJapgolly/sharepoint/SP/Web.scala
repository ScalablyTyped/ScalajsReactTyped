...
import typingsJapgolly.sharepoint.SP.BusinessData.AppBdcCatalog
import typingsJapgolly.sharepoint.SP.BusinessData.Entity
import typingsJapgolly.sharepoint.SP.Utilities.IconSize
import typingsJapgolly.sharepoint.SP.Workflow.WorkflowAssociationCollection
import typingsJapgolly.sharepoint.SP.Workflow.WorkflowTemplateCollection
...
trait Web
  ...
  def getCatalog(typeCatalog: Double): typingsJapgolly.sharepoint.SP.List[Any] = js.native
  ...
  def getList(url: String): typingsJapgolly.sharepoint.SP.List[Any] = js.native
  ...
  def get_siteUserInfoList(): typingsJapgolly.sharepoint.SP.List[Any] = js.native
