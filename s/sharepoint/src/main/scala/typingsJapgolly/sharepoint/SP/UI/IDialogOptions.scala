...
object IDialogOptions {
  ...
  def apply(
    ...
    dialogReturnValueCallback: (/* dialogResult */ DialogResult, /* returnValue */ js.Any) => Callback = null,
    ...
    if (dialogReturnValueCallback != null) __obj.updateDynamic("dialogReturnValueCallback")(js.Any.fromFunction2((t0: /* dialogResult */ typingsJapgolly.sharepoint.SP.UI.DialogResult, t1: /* returnValue */ js.Any) => dialogReturnValueCallback(t0, t1).runNow()))
