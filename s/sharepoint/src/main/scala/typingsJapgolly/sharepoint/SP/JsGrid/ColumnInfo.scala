...
object ColumnInfo {
  ...
  inline def apply(
    ...
    fnSingleValueClicked: (IRecord, String, Any, Any) => Callback,
    imgRawSrc: String,
    imgSrc: String,
    ...
    val __obj = js.Dynamic.literal(ColumnType = ColumnType.toJsFn, bOpenMenuOnContentClick = bOpenMenuOnContentClick.asInstanceOf[js.Any], columnKey = columnKey.asInstanceOf[js.Any], fieldKeys = fieldKeys.asInstanceOf[js.Any], fnGetCellEditMode = js.Any.fromFunction2(fnGetCellEditMode), fnGetCellStyleId = js.Any.fromFunction3(fnGetCellStyleId), fnGetDisplayControlName = js.Any.fromFunction2(fnGetDisplayControlName), fnGetEditControlName = js.Any.fromFunction2(fnGetEditControlName), fnGetSingleValueTooltip = js.Any.fromFunction4(fnGetSingleValueTooltip), fnGetWidgetControlNames = js.Any.fromFunction2(fnGetWidgetControlNames), fnShouldLinkSingleValue = js.Any.fromFunction4(fnShouldLinkSingleValue), fnSingleValueClicked = js.Any.fromFunction4((t0: IRecord, t1: String, t2: Any, t3: Any) => (fnSingleValueClicked(t0, t1, t2, t3)).runNow()), imgRawSrc = imgRawSrc.asInstanceOf[js.Any], imgSrc = imgSrc.asInstanceOf[js.Any], isAutoFilterable = isAutoFilterable.asInstanceOf[js.Any], isFooter = isFooter.asInstanceOf[js.Any], isHidable = isHidable.asInstanceOf[js.Any], isResizable = isResizable.asInstanceOf[js.Any], isSortable = isSortable.asInstanceOf[js.Any], isVisible = isVisible.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
  ...
  extension [Self <: ColumnInfo](x: Self) {
    ...
    inline def setColumnType(value: CallbackTo[String]): Self = StObject.set(x, "ColumnType", value.toJsFn)
    ...
    inline def setFnSingleValueClicked(value: (IRecord, String, Any, Any) => Callback): Self = StObject.set(x, "fnSingleValueClicked", js.Any.fromFunction4((t0: IRecord, t1: String, t2: Any, t3: Any) => (value(t0, t1, t2, t3)).runNow()))
