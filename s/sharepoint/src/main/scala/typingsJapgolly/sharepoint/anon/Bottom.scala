...
object Bottom {
  ...
  inline def apply(bottom: Double, fight: Double, left: Double, top: Double): Bottom = {
  ...
  extension [Self <: Bottom](x: Self) {
    ...
    inline def setFight(value: Double): Self = StObject.set(x, "fight", value.asInstanceOf[js.Any])
