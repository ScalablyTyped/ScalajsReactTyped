...
object ContextInfo {
  ...
  inline def apply(
    ...
    TableCbxFocusHandler: (Any, Any) => Callback,
    TableMouseoverHandler: (Any, Any) => Callback,
    ...
    onRefreshFailed: (Any, Any, Any) => Callback,
  ...
  extension [Self <: ContextInfo](x: Self) {
    ...
    inline def setOnRefreshFailed(value: (Any, Any, Any) => Callback): Self = StObject.set(x, "onRefreshFailed", js.Any.fromFunction3((t0: Any, t1: Any, t2: Any) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setTableCbxFocusHandler(value: (Any, Any) => Callback): Self = StObject.set(x, "TableCbxFocusHandler", js.Any.fromFunction2((t0: Any, t1: Any) => (value(t0, t1)).runNow()))
    
    inline def setTableMouseoverHandler(value: (Any, Any) => Callback): Self = StObject.set(x, "TableMouseoverHandler", js.Any.fromFunction2((t0: Any, t1: Any) => (value(t0, t1)).runNow()))
