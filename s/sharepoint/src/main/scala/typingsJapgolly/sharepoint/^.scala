...
object ^ extends js.Object {
  var HP: typingsJapgolly.sharepoint.HP = js.native
  var MSOWebPartPageFormName: String = js.native
  var SPClientRenderer: typingsJapgolly.sharepoint.SPClientRenderer = js.native
  ...
  var spFriendlyUrlPageContextInfo: typingsJapgolly.sharepoint.spFriendlyUrlPageContextInfo = js.native
  var spMgr: SPMgr_ = js.native
  @JSName("_spPageContextInfo")
  var spPageContextInfo: typingsJapgolly.sharepoint.spPageContextInfo = js.native
}
