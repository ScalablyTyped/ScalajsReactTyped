...
object RenderContextFieldInView {
  ...
  def apply(
    ...
    RenderBody: RenderContextFieldInView => CallbackTo[String] = null,
    RenderFieldByName: (RenderContextFieldInView, /* fieldName */ String) => CallbackTo[String] = null,
    RenderFields: RenderContextFieldInView => CallbackTo[String] = null,
    RenderFooter: RenderContextFieldInView => CallbackTo[String] = null,
    RenderGroups: RenderContextFieldInView => CallbackTo[String] = null,
    RenderHeader: RenderContextFieldInView => CallbackTo[String] = null,
    RenderItems: RenderContextFieldInView => CallbackTo[String] = null,
    RenderView: RenderContextFieldInView => CallbackTo[String] = null,
    ...
    if (RenderBody != null) __obj.updateDynamic("RenderBody")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextFieldInView) => RenderBody(t0).runNow()))
    if (RenderFieldByName != null) __obj.updateDynamic("RenderFieldByName")(js.Any.fromFunction2((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextFieldInView, t1: /* fieldName */ java.lang.String) => RenderFieldByName(t0, t1).runNow()))
    if (RenderFields != null) __obj.updateDynamic("RenderFields")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextFieldInView) => RenderFields(t0).runNow()))
    if (RenderFooter != null) __obj.updateDynamic("RenderFooter")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextFieldInView) => RenderFooter(t0).runNow()))
    if (RenderGroups != null) __obj.updateDynamic("RenderGroups")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextFieldInView) => RenderGroups(t0).runNow()))
    if (RenderHeader != null) __obj.updateDynamic("RenderHeader")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextFieldInView) => RenderHeader(t0).runNow()))
    if (RenderItems != null) __obj.updateDynamic("RenderItems")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextFieldInView) => RenderItems(t0).runNow()))
    if (RenderView != null) __obj.updateDynamic("RenderView")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextFieldInView) => RenderView(t0).runNow()))
