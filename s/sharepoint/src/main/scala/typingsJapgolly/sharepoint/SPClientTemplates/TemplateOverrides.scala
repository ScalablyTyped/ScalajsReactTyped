...
object TemplateOverrides {
  ...
  extension [Self <: TemplateOverrides](x: Self) {
    ...
    inline def setBodyFunction1(value: /* ctx */ RenderContext => Callback): Self = StObject.set(x, "Body", js.Any.fromFunction1((t0: /* ctx */ RenderContext) => value(t0).runNow()))
    ...
    inline def setViewFunction1(value: /* ctx */ RenderContext => Callback): Self = StObject.set(x, "View", js.Any.fromFunction1((t0: /* ctx */ RenderContext) => value(t0).runNow()))
