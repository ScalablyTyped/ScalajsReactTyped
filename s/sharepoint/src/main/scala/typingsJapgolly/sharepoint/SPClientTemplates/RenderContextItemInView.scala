...
object RenderContextItemInView {
  ...
  def apply(
    ...
    RenderBody: RenderContextItemInView => CallbackTo[String] = null,
    RenderFieldByName: (RenderContextItemInView, /* fieldName */ String) => CallbackTo[String] = null,
    RenderFields: RenderContextItemInView => CallbackTo[String] = null,
    RenderFooter: RenderContextItemInView => CallbackTo[String] = null,
    RenderGroups: RenderContextItemInView => CallbackTo[String] = null,
    RenderHeader: RenderContextItemInView => CallbackTo[String] = null,
    RenderItems: RenderContextItemInView => CallbackTo[String] = null,
    RenderView: RenderContextItemInView => CallbackTo[String] = null,
    ...
    if (RenderBody != null) __obj.updateDynamic("RenderBody")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextItemInView) => RenderBody(t0).runNow()))
    if (RenderFieldByName != null) __obj.updateDynamic("RenderFieldByName")(js.Any.fromFunction2((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextItemInView, t1: /* fieldName */ java.lang.String) => RenderFieldByName(t0, t1).runNow()))
    if (RenderFields != null) __obj.updateDynamic("RenderFields")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextItemInView) => RenderFields(t0).runNow()))
    if (RenderFooter != null) __obj.updateDynamic("RenderFooter")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextItemInView) => RenderFooter(t0).runNow()))
    if (RenderGroups != null) __obj.updateDynamic("RenderGroups")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextItemInView) => RenderGroups(t0).runNow()))
    if (RenderHeader != null) __obj.updateDynamic("RenderHeader")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextItemInView) => RenderHeader(t0).runNow()))
    if (RenderItems != null) __obj.updateDynamic("RenderItems")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextItemInView) => RenderItems(t0).runNow()))
    if (RenderView != null) __obj.updateDynamic("RenderView")(js.Any.fromFunction1((t0: typingsJapgolly.sharepoint.SPClientTemplates.RenderContextItemInView) => RenderView(t0).runNow()))
