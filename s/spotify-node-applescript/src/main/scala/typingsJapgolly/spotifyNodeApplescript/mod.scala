...
object mod {
  ...
  */
  ...
  object SpotifyPlayingState {
    ...
    inline def paused: typingsJapgolly.spotifyNodeApplescript.spotifyNodeApplescriptStrings.paused = "paused".asInstanceOf[typingsJapgolly.spotifyNodeApplescript.spotifyNodeApplescriptStrings.paused]
    
    inline def playing: typingsJapgolly.spotifyNodeApplescript.spotifyNodeApplescriptStrings.playing = "playing".asInstanceOf[typingsJapgolly.spotifyNodeApplescript.spotifyNodeApplescriptStrings.playing]
  }
