...
import typingsJapgolly.swcNodeCore.anon.PartialReactConfig
import typingsJapgolly.swcNodeCore.swcNodeCoreStrings.`inline`
import typingsJapgolly.swcNodeCore.swcNodeCoreStrings.amd
import typingsJapgolly.swcNodeCore.swcNodeCoreStrings.commonjs
import typingsJapgolly.swcNodeCore.swcNodeCoreStrings.es6
import typingsJapgolly.swcNodeCore.swcNodeCoreStrings.umd
...
object mod {
  ...
  trait Options extends StObject {
    ...
    var swc: js.UndefOr[typingsJapgolly.swcCore.typesMod.Options] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setSwc(value: typingsJapgolly.swcCore.typesMod.Options): Self = StObject.set(x, "swc", value.asInstanceOf[js.Any])
