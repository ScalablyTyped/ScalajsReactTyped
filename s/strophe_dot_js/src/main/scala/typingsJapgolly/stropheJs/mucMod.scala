...
import typingsJapgolly.stropheJs.mucMod.global.Strophe.MUC.Plugin
import typingsJapgolly.stropheJs.stropheJsStrings.chat
import typingsJapgolly.stropheJs.stropheJsStrings.groupchat
import typingsJapgolly.stropheJs.stropheJsStrings.message
import typingsJapgolly.stropheJs.stropheJsStrings.presence
import typingsJapgolly.stropheJs.stropheJsStrings.roster
  ...
  object stropheAugmentingMod {
    ...
    object Strophe {
      ...
      trait Connection extends StObject {
        ...
        var muc: typingsJapgolly.stropheJs.mucMod.stropheAugmentingMod.Strophe.MUC.Plugin
      }
      object Connection {
        
        inline def apply(muc: typingsJapgolly.stropheJs.mucMod.stropheAugmentingMod.Strophe.MUC.Plugin): Connection = {
          val __obj = js.Dynamic.literal(muc = muc.asInstanceOf[js.Any])
          __obj.asInstanceOf[Connection]
        }
        ...
        extension [Self <: Connection](x: Self) {
          ...
          inline def setMuc(value: typingsJapgolly.stropheJs.mucMod.stropheAugmentingMod.Strophe.MUC.Plugin): Self = StObject.set(x, "muc", value.asInstanceOf[js.Any])
        }
      }
