package typingsJapgolly.stripe.mod.coupons

import typingsJapgolly.stripe.mod.IMetadata
import typingsJapgolly.stripe.mod.IResourceObject
import typingsJapgolly.stripe.stripeStrings.coupon
import typingsJapgolly.stripe.stripeStrings.forever
import typingsJapgolly.stripe.stripeStrings.once
import typingsJapgolly.stripe.stripeStrings.repeating
