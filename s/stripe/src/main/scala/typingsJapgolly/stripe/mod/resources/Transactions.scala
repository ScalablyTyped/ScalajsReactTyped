...
import typingsJapgolly.stripe.mod.issuing.transactions.ITransactionListOptions
import typingsJapgolly.stripe.mod.issuing.transactions.ITransactionUpdateOptions
