...
import typingsJapgolly.stripe.mod.issuing.authorizations.IAuthorization
import typingsJapgolly.stripe.mod.issuing.authorizations.IAuthorizationApproveOptions
import typingsJapgolly.stripe.mod.issuing.authorizations.IAuthorizationDeclineOptions
import typingsJapgolly.stripe.mod.issuing.authorizations.IAuthorizationListOptions
import typingsJapgolly.stripe.mod.issuing.authorizations.IAuthorizationUpdateOptions
