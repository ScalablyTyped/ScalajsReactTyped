...
import typingsJapgolly.stripe.stripeStrings.credit_note
import typingsJapgolly.stripe.stripeStrings.issued
import typingsJapgolly.stripe.stripeStrings.post_payment
import typingsJapgolly.stripe.stripeStrings.pre_payment
