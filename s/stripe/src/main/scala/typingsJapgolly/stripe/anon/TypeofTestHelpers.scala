...
import typingsJapgolly.stripe.mod.Stripe.TestHelpers.CustomersResource
import typingsJapgolly.stripe.mod.Stripe.TestHelpers.RefundsResource
import typingsJapgolly.stripe.mod.Stripe.TestHelpers.TestClocksResource
...
trait TypeofTestHelpers extends StObject {
  ...
  var CustomersResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.TestHelpers.CustomersResource]
  
  val Issuing: TypeofIssuingCardsResource
  
  var RefundsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.TestHelpers.RefundsResource]
  
  val Terminal: TypeofTerminalReaderPresentPaymentMethodParams
  
  val TestClock: Any
  
  var TestClocksResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.TestHelpers.TestClocksResource]
