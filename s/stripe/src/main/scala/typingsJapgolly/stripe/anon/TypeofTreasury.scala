...
import typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.InboundTransfersResource
import typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.OutboundPaymentsResource
import typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.OutboundTransfersResource
import typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.ReceivedCreditsResource
import typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.ReceivedDebitsResource
...
trait TypeofTreasury extends StObject {
  ...
  var InboundTransfersResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.InboundTransfersResource]
  
  val OutboundPaymentReturnOutboundPaymentParams: TypeofOutboundPaymentRetu
  
  var OutboundPaymentsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.OutboundPaymentsResource]
  
  val OutboundTransferReturnOutboundTransferParams: TypeofOutboundTransferRet
  
  var OutboundTransfersResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.OutboundTransfersResource]
  
  val ReceivedCreditCreateParams: TypeofReceivedCreditCreat
  
  var ReceivedCreditsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.ReceivedCreditsResource]
  
  val ReceivedDebitCreateParams: TypeofReceivedDebitCreate
  
  var ReceivedDebitsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.TestHelpers.Treasury.ReceivedDebitsResource]
}
