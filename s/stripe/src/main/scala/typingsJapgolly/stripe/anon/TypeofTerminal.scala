...
trait TypeofTerminal extends StObject {
  ...
  var ConfigurationsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.Terminal.ConfigurationsResource]
  
  var ConnectionTokensResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.Terminal.ConnectionTokensResource]
  
  val LocationCreateParams: Any
  
  var LocationsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.Terminal.LocationsResource]
  ...
  var ReadersResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.Terminal.ReadersResource]
}
