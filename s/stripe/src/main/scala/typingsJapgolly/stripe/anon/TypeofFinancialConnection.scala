...
trait TypeofFinancialConnection extends StObject {
  ...
  var AccountsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.FinancialConnections.AccountsResource]
  
  val Session: TypeofSessionAccountHolder
  
  val SessionCreateParams: TypeofSessionCreateParamsAccountHolder
  
  var SessionsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.FinancialConnections.SessionsResource]
}
