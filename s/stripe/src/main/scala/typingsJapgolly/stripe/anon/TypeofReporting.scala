...
trait TypeofReporting extends StObject {
  ...
  var ReportRunsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.Reporting.ReportRunsResource]
  
  var ReportTypesResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.Reporting.ReportTypesResource]
}
