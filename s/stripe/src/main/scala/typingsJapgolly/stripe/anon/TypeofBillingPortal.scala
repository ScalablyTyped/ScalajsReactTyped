...
trait TypeofBillingPortal extends StObject {
  ...
  var ConfigurationsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.BillingPortal.ConfigurationsResource]
  
  val Session: Any
  
  val SessionCreateParams: Any
  
  var SessionsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.BillingPortal.SessionsResource]
}
