...
trait TypeofPaymentMethodCreate extends StObject {
...
object TypeofPaymentMethodCreate {
  
  inline def apply(Eps: Any, Fpx: Any, Ideal: Any, Klarna: Any, P24: Any, Sofort: Any, UsBankAccount: Any): TypeofPaymentMethodCreate = {
    ...
    __obj.asInstanceOf[TypeofPaymentMethodCreate]
  }
  
  extension [Self <: TypeofPaymentMethodCreate](x: Self) {
