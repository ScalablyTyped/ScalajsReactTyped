...
import typingsJapgolly.stripe.mod.Stripe.Identity.VerificationReportsResource
import typingsJapgolly.stripe.mod.Stripe.Identity.VerificationSessionsResource
...
trait TypeofIdentity extends StObject {
  ...
  var VerificationReportsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.Identity.VerificationReportsResource]
  ...
  var VerificationSessionsResource: Instantiable0[typingsJapgolly.stripe.mod.Stripe.Identity.VerificationSessionsResource]
}
