package typingsJapgolly.storybookAddonCentered

import japgolly.scalajs.react.Callback
import org.scalajs.dom.CSSRule
import typingsJapgolly.storybookAddonCentered.storybookAddonCenteredStrings.`0`
import typingsJapgolly.storybookAddonCentered.storybookAddonCenteredStrings.`100Percentsign`
import typingsJapgolly.storybookAddonCentered.storybookAddonCenteredStrings.auto
import typingsJapgolly.storybookAddonCentered.storybookAddonCenteredStrings.center
import typingsJapgolly.storybookAddonCentered.storybookAddonCenteredStrings.fixed
import typingsJapgolly.storybookAddonCentered.storybookAddonCenteredStrings.flex
...
object anon {
  ...
  object AlignItems {
    ...
    inline def apply(): AlignItems = {
      val __obj = js.Dynamic.literal(alignItems = "center", bottom = "0", display = "flex", left = "0", overflow = "auto", position = "fixed", right = "0", top = "0")
    ...
    extension [Self <: AlignItems](x: Self) {
      ...
      inline def setOverflow(value: auto): Self = StObject.set(x, "overflow", value.asInstanceOf[js.Any])
  ...
  object Margin {
    ...
    inline def apply(): Margin = {
      val __obj = js.Dynamic.literal(margin = "auto", maxHeight = "100%")
    ...
    extension [Self <: Margin](x: Self) {
      ...
      inline def setMaxHeight(value: `100Percentsign`): Self = StObject.set(x, "maxHeight", value.asInstanceOf[js.Any])
    }
  }
  ...
  object PartialCSSStyleDeclaratio {
    ...
    extension [Self <: PartialCSSStyleDeclaratio](x: Self) {
      ...
      inline def setSetProperty(value: /* property */ String => Callback): Self = StObject.set(x, "setProperty", js.Any.fromFunction1((t0: /* property */ String) => value(t0).runNow()))
