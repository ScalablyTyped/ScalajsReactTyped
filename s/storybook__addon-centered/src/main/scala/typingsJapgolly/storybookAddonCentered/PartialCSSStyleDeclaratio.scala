...
object PartialCSSStyleDeclaratio {
  ...
  def apply(
    ...
    gap: String = null,
    getPropertyPriority: /* propertyName */ String => CallbackTo[String] = null,
    getPropertyValue: /* propertyName */ String => CallbackTo[String] = null,
    ...
    item: /* index */ Double => CallbackTo[String] = null,
    ...
    if (getPropertyPriority != null) __obj.updateDynamic("getPropertyPriority")(js.Any.fromFunction1((t0: /* propertyName */ java.lang.String) => getPropertyPriority(t0).runNow()))
    if (getPropertyValue != null) __obj.updateDynamic("getPropertyValue")(js.Any.fromFunction1((t0: /* propertyName */ java.lang.String) => getPropertyValue(t0).runNow()))
