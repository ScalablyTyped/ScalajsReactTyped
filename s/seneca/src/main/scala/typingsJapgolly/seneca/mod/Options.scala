...
import typingsJapgolly.seneca.AnonAct
import typingsJapgolly.seneca.AnonActcaller
import typingsJapgolly.seneca.AnonActive
import typingsJapgolly.seneca.AnonActrouter
import typingsJapgolly.seneca.AnonAdd
import typingsJapgolly.seneca.AnonBasic
import typingsJapgolly.seneca.AnonHost
import typingsJapgolly.seneca.AnonInterval
import typingsJapgolly.seneca.AnonLevel
import typingsJapgolly.seneca.AnonLocal
import typingsJapgolly.seneca.AnonRunning
...
object Options {
  ...
  def apply(
    ...
    errhandler: /* error */ js.Error => Callback = null,
    ...
    if (errhandler != null) __obj.updateDynamic("errhandler")(js.Any.fromFunction1((t0: /* error */ js.Error) => errhandler(t0).runNow()))
