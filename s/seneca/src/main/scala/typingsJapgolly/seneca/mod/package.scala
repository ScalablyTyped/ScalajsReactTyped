...
package object mod {
  ...
  type AddCallback[T] = js.Function2[
    /* msg */ typingsJapgolly.seneca.mod.MessagePayload[T], 
  ...
  type MessagePayload[T] = typingsJapgolly.seneca.mod.PartialMessagePayload with T
  type Pattern = java.lang.String | typingsJapgolly.seneca.mod.MinimalPattern
