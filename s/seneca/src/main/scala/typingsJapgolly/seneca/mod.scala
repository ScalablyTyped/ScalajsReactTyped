...
import typingsJapgolly.seneca.anon.Act
import typingsJapgolly.seneca.anon.Actcaller
import typingsJapgolly.seneca.anon.Active
import typingsJapgolly.seneca.anon.Actrouter
import typingsJapgolly.seneca.anon.Add
import typingsJapgolly.seneca.anon.Basic
import typingsJapgolly.seneca.anon.Host
import typingsJapgolly.seneca.anon.Interval
import typingsJapgolly.seneca.anon.Level
import typingsJapgolly.seneca.anon.Local
import typingsJapgolly.seneca.anon.Running
...
object mod {
  ...
  object Executor {
    ...
    inline def apply(
      cb: (/* err */ js.Error, /* result */ Any) => Callback,
      desc: String,
      execute: UnknownType,
      fn: /* callback */ Any => Callback,
      gate: Boolean,
      id: String,
      ungate: Boolean
    ): Executor = {
      val __obj = js.Dynamic.literal(cb = js.Any.fromFunction2((t0: /* err */ js.Error, t1: /* result */ Any) => (cb(t0, t1)).runNow()), desc = desc.asInstanceOf[js.Any], execute = execute.asInstanceOf[js.Any], fn = js.Any.fromFunction1((t0: /* callback */ Any) => fn(t0).runNow()), gate = gate.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], ungate = ungate.asInstanceOf[js.Any])
      __obj.asInstanceOf[Executor]
    }
    
    extension [Self <: Executor](x: Self) {
      
      inline def setCb(value: (/* err */ js.Error, /* result */ Any) => Callback): Self = StObject.set(x, "cb", js.Any.fromFunction2((t0: /* err */ js.Error, t1: /* result */ Any) => (value(t0, t1)).runNow()))
      
      inline def setDesc(value: String): Self = StObject.set(x, "desc", value.asInstanceOf[js.Any])
      
      inline def setExecute(value: UnknownType): Self = StObject.set(x, "execute", value.asInstanceOf[js.Any])
      
      inline def setFn(value: /* callback */ Any => Callback): Self = StObject.set(x, "fn", js.Any.fromFunction1((t0: /* callback */ Any) => value(t0).runNow()))
  ...
  */
  ...
  object LogLevel {
    ...
    inline def debugPlussign: typingsJapgolly.seneca.senecaStrings.debugPlussign = "debug+".asInstanceOf[typingsJapgolly.seneca.senecaStrings.debugPlussign]
    
    inline def infoPlussign: typingsJapgolly.seneca.senecaStrings.infoPlussign = "info+".asInstanceOf[typingsJapgolly.seneca.senecaStrings.infoPlussign]
    
    inline def none: typingsJapgolly.seneca.senecaStrings.none = "none".asInstanceOf[typingsJapgolly.seneca.senecaStrings.none]
    
    inline def warnPlussign: typingsJapgolly.seneca.senecaStrings.warnPlussign = "warn+".asInstanceOf[typingsJapgolly.seneca.senecaStrings.warnPlussign]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.seneca.senecaStrings.quiet
    - typingsJapgolly.seneca.senecaStrings.silent
    - typingsJapgolly.seneca.senecaStrings.any
    - typingsJapgolly.seneca.senecaStrings.all
    - typingsJapgolly.seneca.senecaStrings.print
    - typingsJapgolly.seneca.senecaStrings.standard
    - typingsJapgolly.seneca.senecaStrings.test
  */
  trait LogSpec extends StObject
  object LogSpec {
    
    inline def all: typingsJapgolly.seneca.senecaStrings.all = "all".asInstanceOf[typingsJapgolly.seneca.senecaStrings.all]
    
    inline def any: typingsJapgolly.seneca.senecaStrings.any = "any".asInstanceOf[typingsJapgolly.seneca.senecaStrings.any]
    
    inline def print: typingsJapgolly.seneca.senecaStrings.print = "print".asInstanceOf[typingsJapgolly.seneca.senecaStrings.print]
    
    inline def quiet: typingsJapgolly.seneca.senecaStrings.quiet = "quiet".asInstanceOf[typingsJapgolly.seneca.senecaStrings.quiet]
    
    inline def silent: typingsJapgolly.seneca.senecaStrings.silent = "silent".asInstanceOf[typingsJapgolly.seneca.senecaStrings.silent]
    
    inline def standard: typingsJapgolly.seneca.senecaStrings.standard = "standard".asInstanceOf[typingsJapgolly.seneca.senecaStrings.standard]
    
    inline def test: typingsJapgolly.seneca.senecaStrings.test = "test".asInstanceOf[typingsJapgolly.seneca.senecaStrings.test]
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setErrhandler(value: /* error */ js.Error => Callback): Self = StObject.set(x, "errhandler", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
