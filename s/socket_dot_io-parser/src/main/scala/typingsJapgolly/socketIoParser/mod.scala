package typingsJapgolly.socketIoParser
...
object mod {
  ...
  object PacketType extends StObject {
    ...
    sealed trait ACK
      extends StObject
         with PacketType
    /* 3 */ val ACK: typingsJapgolly.socketIoParser.mod.PacketType.ACK & Double = js.native
    
    @js.native
    sealed trait BINARY_ACK
      extends StObject
         with PacketType
    /* 6 */ val BINARY_ACK: typingsJapgolly.socketIoParser.mod.PacketType.BINARY_ACK & Double = js.native
    
    @js.native
    sealed trait BINARY_EVENT
      extends StObject
         with PacketType
    /* 5 */ val BINARY_EVENT: typingsJapgolly.socketIoParser.mod.PacketType.BINARY_EVENT & Double = js.native
    
    @js.native
    sealed trait CONNECT
      extends StObject
         with PacketType
    /* 0 */ val CONNECT: typingsJapgolly.socketIoParser.mod.PacketType.CONNECT & Double = js.native
    
    @js.native
    sealed trait CONNECT_ERROR
      extends StObject
         with PacketType
    /* 4 */ val CONNECT_ERROR: typingsJapgolly.socketIoParser.mod.PacketType.CONNECT_ERROR & Double = js.native
    
    @js.native
    sealed trait DISCONNECT
      extends StObject
         with PacketType
    /* 1 */ val DISCONNECT: typingsJapgolly.socketIoParser.mod.PacketType.DISCONNECT & Double = js.native
    
    @js.native
    sealed trait EVENT
      extends StObject
         with PacketType
    /* 2 */ val EVENT: typingsJapgolly.socketIoParser.mod.PacketType.EVENT & Double = js.native
  }
  ...
  object DecoderReservedEvents {
    ...
    inline def apply(decoded: Packet => Callback): DecoderReservedEvents = {
      val __obj = js.Dynamic.literal(decoded = js.Any.fromFunction1((t0: Packet) => decoded(t0).runNow()))
      __obj.asInstanceOf[DecoderReservedEvents]
    }
    
    extension [Self <: DecoderReservedEvents](x: Self) {
      
      inline def setDecoded(value: Packet => Callback): Self = StObject.set(x, "decoded", js.Any.fromFunction1((t0: Packet) => value(t0).runNow()))
    }
  }
