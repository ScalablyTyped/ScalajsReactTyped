...
import typingsJapgolly.scrollIntoViewIfNeeded.typingsTypesMod.CustomScrollAction
import typingsJapgolly.scrollIntoViewIfNeeded.typingsTypesMod.CustomScrollBehaviorCallback
import typingsJapgolly.scrollIntoViewIfNeeded.typingsTypesMod.ScrollBehavior
...
object mod {
  ...
  trait CustomBehaviorOptions[T]
    extends StObject
       with typingsJapgolly.scrollIntoViewIfNeeded.typingsTypesMod.Options {
