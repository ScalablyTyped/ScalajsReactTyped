...
object typingsTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.auto
    - typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.smooth
  */
  trait ScrollBehavior extends StObject
  object ScrollBehavior {
    
    inline def auto: typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.auto = "auto".asInstanceOf[typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.auto]
    
    inline def smooth: typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.smooth = "smooth".asInstanceOf[typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.smooth]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.start
    - typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.center
    - typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.end
    - typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.nearest
  */
  trait ScrollLogicalPosition extends StObject
  object ScrollLogicalPosition {
    
    inline def center: typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.center = "center".asInstanceOf[typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.center]
    
    inline def end: typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.end = "end".asInstanceOf[typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.end]
    
    inline def nearest: typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.nearest = "nearest".asInstanceOf[typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.nearest]
    
    inline def start: typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.start = "start".asInstanceOf[typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.start]
  }
  ...
  */
  ...
  object ScrollMode {
    ...
    inline def always: typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.always = "always".asInstanceOf[typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.always]
    
    inline def `if-needed`: typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.`if-needed` = "if-needed".asInstanceOf[typingsJapgolly.scrollIntoViewIfNeeded.scrollIntoViewIfNeededStrings.`if-needed`]
  }
