...
trait VariableDeclaration
  ...
  @JSName("type")
  var type_VariableDeclaration: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.VariableDeclaration
...
object VariableDeclaration {
  ...
  extension [Self <: VariableDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.VariableDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
