...
trait StateVariableDeclaration
  ...
  @JSName("type")
  var type_StateVariableDeclaration: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.StateVariableDeclaration
...
object StateVariableDeclaration {
  ...
  extension [Self <: StateVariableDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.StateVariableDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
