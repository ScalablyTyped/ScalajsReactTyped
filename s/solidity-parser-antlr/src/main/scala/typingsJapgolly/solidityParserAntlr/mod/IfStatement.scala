...
trait IfStatement
  ...
  @JSName("type")
  var type_IfStatement: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.IfStatement
}
object IfStatement {
  ...
  extension [Self <: IfStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.IfStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
