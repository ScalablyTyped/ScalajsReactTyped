...
trait AssemblyAssignment
  ...
  @JSName("type")
  var type_AssemblyAssignment: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.AssemblyAssignment
}
object AssemblyAssignment {
  ...
  extension [Self <: AssemblyAssignment](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.AssemblyAssignment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
