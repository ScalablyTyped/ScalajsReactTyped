...
trait ForStatement
  ...
  @JSName("type")
  var type_ForStatement: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.ForStatement
}
object ForStatement {
  ...
  extension [Self <: ForStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.ForStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
