...
trait InheritanceSpecifier
  ...
  @JSName("type")
  var type_InheritanceSpecifier: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.InheritanceSpecifier
}
object InheritanceSpecifier {
  ...
  extension [Self <: InheritanceSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.InheritanceSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
