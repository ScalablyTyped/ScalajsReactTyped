...
trait Block
  ...
  @JSName("type")
  var type_Block: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.Block
}
object Block {
  ...
  extension [Self <: Block](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.Block): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
