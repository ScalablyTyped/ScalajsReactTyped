...
trait ImportDirective
  ...
  @JSName("type")
  var type_ImportDirective: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.ImportDirective
...
object ImportDirective {
  ...
  extension [Self <: ImportDirective](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.ImportDirective): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
