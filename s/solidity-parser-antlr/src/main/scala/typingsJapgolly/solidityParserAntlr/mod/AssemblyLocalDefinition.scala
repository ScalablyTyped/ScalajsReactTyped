...
object AssemblyLocalDefinition {
  ...
  extension [Self <: AssemblyLocalDefinition](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.AssemblyLocalDefinition): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
