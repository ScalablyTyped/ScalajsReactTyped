...
trait ArrayTypeName
  ...
  @JSName("type")
  var type_ArrayTypeName: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.ArrayTypeName
}
object ArrayTypeName {
  ...
  extension [Self <: ArrayTypeName](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.ArrayTypeName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
