...
trait MemberAccess
  ...
  @JSName("type")
  var type_MemberAccess: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.MemberAccess
}
object MemberAccess {
  ...
  extension [Self <: MemberAccess](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.MemberAccess): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
