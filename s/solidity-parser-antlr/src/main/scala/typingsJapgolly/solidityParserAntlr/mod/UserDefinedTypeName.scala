...
trait UserDefinedTypeName
  ...
  @JSName("type")
  var type_UserDefinedTypeName: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.UserDefinedTypeName
}
object UserDefinedTypeName {
  ...
  extension [Self <: UserDefinedTypeName](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.solidityParserAntlr.solidityParserAntlrStrings.UserDefinedTypeName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
