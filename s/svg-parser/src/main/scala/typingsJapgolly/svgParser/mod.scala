...
import typingsJapgolly.svgParser.svgParserStrings.root
...
object mod {
  ...
  */
  ...
  object Node {
    ...
    inline def ElementNode(children: js.Array[Node | String]): typingsJapgolly.svgParser.mod.ElementNode = {
      val __obj = js.Dynamic.literal(children = children.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("element")
      __obj.asInstanceOf[typingsJapgolly.svgParser.mod.ElementNode]
    }
    
    inline def TextNode(): typingsJapgolly.svgParser.mod.TextNode = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("text")
      __obj.asInstanceOf[typingsJapgolly.svgParser.mod.TextNode]
    }
  }
