...
import typingsJapgolly.siege.mod.Stringifiable
...
object anon {
  ...
  trait Method extends StObject {
    ...
    var method: js.UndefOr[typingsJapgolly.siege.mod.Method] = js.undefined
  ...
  object Method {
    ...
    extension [Self <: Method](x: Self) {
      ...
      inline def setMethod(value: typingsJapgolly.siege.mod.Method): Self = StObject.set(x, "method", value.asInstanceOf[js.Any])
