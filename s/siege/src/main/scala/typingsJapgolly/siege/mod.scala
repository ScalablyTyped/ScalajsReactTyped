package typingsJapgolly.siege

import japgolly.scalajs.react.Callback
import typingsJapgolly.node.NodeJS.Dict
import typingsJapgolly.siege.anon.C2mem
import typingsJapgolly.siege.siegeStrings.color
import typingsJapgolly.siege.siegeStrings.json
import typingsJapgolly.siege.siegeStrings.plain
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.siege.siegeStrings.GET
    - typingsJapgolly.siege.siegeStrings.POST
  */
  trait Method extends StObject
  object Method {
    
    inline def GET: typingsJapgolly.siege.siegeStrings.GET = "GET".asInstanceOf[typingsJapgolly.siege.siegeStrings.GET]
    
    inline def POST: typingsJapgolly.siege.siegeStrings.POST = "POST".asInstanceOf[typingsJapgolly.siege.siegeStrings.POST]
  }
  ...
  trait Task extends StObject {
    ...
    def request(options: typingsJapgolly.siege.anon.Method): Unit
  ...
  object Task {
    ...
    inline def apply(
      ...
      `for`: Double => For[Task],
      report: ReportOptions => Callback,
      request: typingsJapgolly.siege.anon.Method => Callback,
      with304: Siege,
      withCookie: Siege,
      withoutCookie: Siege
    ): Task = {
      val __obj = js.Dynamic.literal(concurrent = js.Any.fromFunction1(concurrent), report = js.Any.fromFunction1((t0: ReportOptions) => report(t0).runNow()), request = js.Any.fromFunction1((t0: typingsJapgolly.siege.anon.Method) => request(t0).runNow()), with304 = with304.asInstanceOf[js.Any], withCookie = withCookie.asInstanceOf[js.Any], withoutCookie = withoutCookie.asInstanceOf[js.Any])
    ...
    extension [Self <: Task](x: Self) {
      ...
      inline def setReport(value: ReportOptions => Callback): Self = StObject.set(x, "report", js.Any.fromFunction1((t0: ReportOptions) => value(t0).runNow()))
      
      inline def setRequest(value: typingsJapgolly.siege.anon.Method => Callback): Self = StObject.set(x, "request", js.Any.fromFunction1((t0: typingsJapgolly.siege.anon.Method) => value(t0).runNow()))
