...
object mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.screenfull.screenfullStrings.change
    - typingsJapgolly.screenfull.screenfullStrings.error
  */
  trait EventName extends StObject
  object EventName {
    
    inline def change: typingsJapgolly.screenfull.screenfullStrings.change = "change".asInstanceOf[typingsJapgolly.screenfull.screenfullStrings.change]
    
    inline def error: typingsJapgolly.screenfull.screenfullStrings.error = "error".asInstanceOf[typingsJapgolly.screenfull.screenfullStrings.error]
  }
