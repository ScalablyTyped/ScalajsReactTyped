...
import typingsJapgolly.soap.AnonNamespaces
...
object IServerOptions {
  ...
  def apply(
    ...
    callback: (/* err */ js.Any, /* res */ js.Any) => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: /* err */ js.Any, t1: /* res */ js.Any) => callback(t0, t1).runNow()))
