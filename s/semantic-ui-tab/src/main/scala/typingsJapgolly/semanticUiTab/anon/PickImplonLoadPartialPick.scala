...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'onLoad'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplonLoadPartialPick
  extends StObject
     with Param {
...
object PickImplonLoadPartialPick {
  ...
  extension [Self <: PickImplonLoadPartialPick](x: Self) {
