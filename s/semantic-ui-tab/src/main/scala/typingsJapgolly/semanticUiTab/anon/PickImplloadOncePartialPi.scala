...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'loadOnce'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImplloadOncePartialPi
  extends StObject
     with Param {
...
object PickImplloadOncePartialPi {
  ...
  extension [Self <: PickImplloadOncePartialPi](x: Self) {
