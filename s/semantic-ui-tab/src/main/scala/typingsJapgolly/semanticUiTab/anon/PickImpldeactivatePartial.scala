...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'deactivate'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
trait PickImpldeactivatePartial
  extends StObject
     with Param {
...
object PickImpldeactivatePartial {
  ...
  extension [Self <: PickImpldeactivatePartial](x: Self) {
