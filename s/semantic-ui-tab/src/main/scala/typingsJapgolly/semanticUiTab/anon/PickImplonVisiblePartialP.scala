...
/* Inlined std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, 'onVisible'> & std.Partial<std.Pick<semantic-ui-tab.SemanticUI.TabSettings._Impl, keyof semantic-ui-tab.SemanticUI.TabSettings._Impl>> */
