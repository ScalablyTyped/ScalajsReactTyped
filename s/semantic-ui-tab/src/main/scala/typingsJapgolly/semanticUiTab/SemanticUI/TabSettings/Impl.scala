package typingsJapgolly.semanticUiTab.SemanticUI.TabSettings
...
object Impl {
  ...
  def apply(
    ...
    name: String,
    namespace: String,
    onFirstLoad: (String, js.Array[js.Any], js.Any) => Callback,
    onLoad: (String, js.Array[js.Any], js.Any) => Callback,
