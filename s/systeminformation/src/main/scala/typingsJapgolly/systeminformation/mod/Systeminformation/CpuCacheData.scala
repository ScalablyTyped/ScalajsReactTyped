...
object CpuCacheData {
  ...
  inline def apply(l1d: Double, l1i: Double, l2: Double, l3: Double): CpuCacheData = {
  ...
  extension [Self <: CpuCacheData](x: Self) {
    ...
    inline def setL1i(value: Double): Self = StObject.set(x, "l1i", value.asInstanceOf[js.Any])
