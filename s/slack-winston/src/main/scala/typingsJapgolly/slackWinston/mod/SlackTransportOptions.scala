package typingsJapgolly.slackWinston.mod
...
object SlackTransportOptions {
  ...
  def apply(
    ...
    level: String = null,
    log: (/* info */ js.Any, /* next */ js.Function0[Unit]) => CallbackTo[js.Any] = null,
    logv: (/* info */ js.Any, /* next */ js.Function0[Unit]) => CallbackTo[js.Any] = null,
    message: String = null,
    ...
    if (log != null) __obj.updateDynamic("log")(js.Any.fromFunction2((t0: /* info */ js.Any, t1: /* next */ js.Function0[scala.Unit]) => log(t0, t1).runNow()))
    if (logv != null) __obj.updateDynamic("logv")(js.Any.fromFunction2((t0: /* info */ js.Any, t1: /* next */ js.Function0[scala.Unit]) => logv(t0, t1).runNow()))
