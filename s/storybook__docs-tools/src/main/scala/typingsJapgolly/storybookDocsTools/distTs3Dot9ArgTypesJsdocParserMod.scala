...
object distTs3Dot9ArgTypesJsdocParserMod {
  ...
  object ExtractedJsDocParam {
    ...
    inline def apply(getPrettyName: CallbackTo[String], getTypeName: CallbackTo[String], name: String): ExtractedJsDocParam = {
      val __obj = js.Dynamic.literal(getPrettyName = getPrettyName.toJsFn, getTypeName = getTypeName.toJsFn, name = name.asInstanceOf[js.Any])
    ...
    extension [Self <: ExtractedJsDocParam](x: Self) {
      ...
      inline def setGetPrettyName(value: CallbackTo[String]): Self = StObject.set(x, "getPrettyName", value.toJsFn)
  ...
  object ExtractedJsDocReturns {
    ...
    inline def apply(getTypeName: CallbackTo[String]): ExtractedJsDocReturns = {
      val __obj = js.Dynamic.literal(getTypeName = getTypeName.toJsFn)
