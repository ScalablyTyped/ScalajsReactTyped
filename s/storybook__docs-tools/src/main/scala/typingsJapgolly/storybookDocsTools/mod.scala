...
import typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.StorybookConfigOptions
...
object mod {
  ...
  object SourceType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.storybookDocsTools.distTs3Dot9SharedMod.SourceType & String] = js.native
    
    /* "auto" */ val AUTO: typingsJapgolly.storybookDocsTools.distTs3Dot9SharedMod.SourceType.AUTO & String = js.native
    
    /* "code" */ val CODE: typingsJapgolly.storybookDocsTools.distTs3Dot9SharedMod.SourceType.CODE & String = js.native
    
    /* "dynamic" */ val DYNAMIC: typingsJapgolly.storybookDocsTools.distTs3Dot9SharedMod.SourceType.DYNAMIC & String = js.native
  }
