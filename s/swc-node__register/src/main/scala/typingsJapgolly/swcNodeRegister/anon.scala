...
import typingsJapgolly.typescript.mod.CompilerOptionsValue
...
object anon {
  ...
  /* Inlined typescript.typescript.CompilerOptions & {  fallbackToTs :(filename : string): boolean | undefined} */
  trait CompilerOptionsfallbackTo
    extends StObject
  ...
  object CompilerOptionsfallbackTo {
    ...
    inline def apply(): CompilerOptionsfallbackTo = {
    ...
    extension [Self <: CompilerOptionsfallbackTo](x: Self) {
      ...
      inline def setFallbackToTs(value: /* filename */ String => Boolean): Self = StObject.set(x, "fallbackToTs", js.Any.fromFunction1(value))
      
      inline def setFallbackToTsUndefined: Self = StObject.set(x, "fallbackToTs", js.undefined)
  ...
  object PartialCompilerOptionsfal {
    ...
    inline def apply(): PartialCompilerOptionsfal = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: PartialCompilerOptionsfal](x: Self) {
      ...
      inline def setFallbackToTs(value: /* path */ String => Boolean): Self = StObject.set(x, "fallbackToTs", js.Any.fromFunction1(value))
