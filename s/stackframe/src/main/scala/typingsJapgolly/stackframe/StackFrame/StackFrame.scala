...
class StackFrame protected () extends js.Object {
  ...
  def getEvalOrigin(): typingsJapgolly.stackframe.StackFrame.StackFrame = js.native
  ...
  def setEvalOrigin(stackframe: typingsJapgolly.stackframe.StackFrame.StackFrame): Unit = js.native
