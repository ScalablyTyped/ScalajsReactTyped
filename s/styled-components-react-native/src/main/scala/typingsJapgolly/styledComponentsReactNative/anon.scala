...
import typingsJapgolly.reactNative.mod.ListView
import typingsJapgolly.reactNative.mod.ListViewDataSource
...
import typingsJapgolly.reactNative.mod.RefreshControl
...
import typingsJapgolly.reactNative.mod.StatusBar
...
import typingsJapgolly.reactNative.mod.SwipeableListView
import typingsJapgolly.reactNative.mod.SwipeableListViewDataSource
import typingsJapgolly.reactNative.mod.TVParallaxProperties
import typingsJapgolly.reactNative.mod.TabBarIOS
import typingsJapgolly.reactNative.mod.TabBarIOSItem
import typingsJapgolly.reactNative.mod.TextInput
import typingsJapgolly.reactNative.mod.TextInputState
...
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.`box-none`
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.`box-only`
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.`landscape-left`
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.`landscape-right`
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.`no-hide-descendants`
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.`on-drag`
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.`portrait-upside-down`
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.always
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.assertive
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.auto
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.automatic
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.black
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.center
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.default
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.disk
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.diskSlashmemory
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.end
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.fade
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.fast
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.fill
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.formSheet
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.fullScreen
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.handled
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.interactive
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.landscape
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.memory
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.never
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.no
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.none
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.normal
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.overFullScreen
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.pageSheet
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.polite
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.portrait
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.scrollableAxes
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.slide
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.start
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.white
import typingsJapgolly.styledComponentsReactNative.styledComponentsReactNativeStrings.yes
...
object anon {
  ...
  trait ReadonlyFlatListPropsany extends StObject {
    ...
    val ListEmptyComponent: js.UndefOr[ComponentType[Any] | Element | Null] = js.undefined
    
    val ListFooterComponent: js.UndefOr[ComponentType[Any] | Element | Null] = js.undefined
    
    val ListFooterComponentStyle: js.UndefOr[StyleProp[ViewStyle]] = js.undefined
    
    val ListHeaderComponent: js.UndefOr[ComponentType[Any] | Element | Null] = js.undefined
    ...
    val refreshControl: js.UndefOr[Element] = js.undefined
    ...
    val renderScrollComponent: js.UndefOr[js.Function1[/* props */ ScrollViewProps, Element]] = js.undefined
  ...
  object ReadonlyFlatListPropsany {
    ...
    extension [Self <: ReadonlyFlatListPropsany](x: Self) {
      ...
      inline def setRenderItem(
        value: /* info */ ListRenderItemInfo[/* import warning: RewrittenClass.unapply cls was tparam ItemT */ Any] => Element | Null
  ...
  trait ReadonlySectionListPropsa extends StObject {
    ...
    val SectionSeparatorComponent: js.UndefOr[ComponentType[Any] | Element | Null] = js.undefined
  ...
  object ReadonlySectionListPropsa {
    ...
    extension [Self <: ReadonlySectionListPropsa](x: Self) {
      ...
      inline def setSectionSeparatorComponent(value: ComponentType[Any] | Element): Self = StObject.set(x, "SectionSeparatorComponent", value.asInstanceOf[js.Any])
  ...
  trait ReadonlySwipeableListView extends StObject {
    ...
    val renderQuickActions: js.Function3[/* rowData */ Any, /* sectionID */ String, /* rowID */ String, Element]
    
    val renderRow: js.Function3[/* rowData */ Any, /* sectionID */ String, /* rowID */ String, Element]
  }
  object ReadonlySwipeableListView {
    ...
    inline def apply(
      ...
      renderQuickActions: (/* rowData */ Any, /* sectionID */ String, /* rowID */ String) => Element,
      renderRow: (/* rowData */ Any, /* sectionID */ String, /* rowID */ String) => Element
    ...
    extension [Self <: ReadonlySwipeableListView](x: Self) {
      ...
      inline def setRenderQuickActions(value: (/* rowData */ Any, /* sectionID */ String, /* rowID */ String) => Element): Self = StObject.set(x, "renderQuickActions", js.Any.fromFunction3(value))
      
      inline def setRenderRow(value: (/* rowData */ Any, /* sectionID */ String, /* rowID */ String) => Element): Self = StObject.set(x, "renderRow", js.Any.fromFunction3(value))
    }
  }
  ...
  object ReadonlySwitchIOSProps {
    ...
    extension [Self <: ReadonlySwitchIOSProps](x: Self) {
      ...
      inline def setOnValueChange(value: /* value */ Boolean => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction1((t0: /* value */ Boolean) => value(t0).runNow()))
  ...
  object ReadonlyTabBarIOSProps {
    ...
    inline def apply(): ReadonlyTabBarIOSProps = {
      val __obj = js.Dynamic.literal()
  ...
  trait TypeofListView
    extends StObject
       with Instantiable0[ListView] {
    
    var DataSource: ListViewDataSource = js.native
  }
  
  @js.native
  trait TypeofRefreshControl
    extends StObject
       with Instantiable0[RefreshControl] {
