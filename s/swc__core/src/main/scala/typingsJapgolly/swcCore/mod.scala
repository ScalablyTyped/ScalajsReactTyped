...
import typingsJapgolly.swcCore.anon.FileName
import typingsJapgolly.swcCore.anon.IsModule
import typingsJapgolly.swcCore.anon.Target
import typingsJapgolly.swcCore.spackMod.BundleInput
import typingsJapgolly.swcCore.typesMod.JsMinifyOptions
import typingsJapgolly.swcCore.typesMod.Module
import typingsJapgolly.swcCore.typesMod.Options
import typingsJapgolly.swcCore.typesMod.Output
import typingsJapgolly.swcCore.typesMod.ParseOptions
import typingsJapgolly.swcCore.typesMod.Plugin
...
object mod {
  ...
  open class Compiler () extends StObject {
    ...
    def parseFileSync(path: String, options: ParseOptions): Module = js.native
    @JSName("parseFileSync")
    def parseFileSync_Script(path: String, options: ParseOptions & IsModule): Script = js.native
  ...
  inline def parseFileSync(path: String, options: ParseOptions): Module = (^.asInstanceOf[js.Dynamic].applyDynamic("parseFileSync")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Module]
  
  inline def parseFileSync_Script(path: String, options: ParseOptions & IsModule): Script = (^.asInstanceOf[js.Dynamic].applyDynamic("parseFileSync")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Script]
