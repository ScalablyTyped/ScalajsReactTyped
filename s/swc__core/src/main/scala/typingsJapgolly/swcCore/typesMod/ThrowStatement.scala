...
trait ThrowStatement
  ...
  @JSName("type")
  var type_ThrowStatement: typingsJapgolly.swcCore.swcCoreStrings.ThrowStatement
}
object ThrowStatement {
  ...
  extension [Self <: ThrowStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ThrowStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
