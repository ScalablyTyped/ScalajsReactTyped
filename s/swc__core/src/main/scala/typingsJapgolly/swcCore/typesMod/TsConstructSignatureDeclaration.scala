...
trait TsConstructSignatureDeclaration
  ...
  @JSName("type")
  var type_TsConstructSignatureDeclaration: typingsJapgolly.swcCore.swcCoreStrings.TsConstructSignatureDeclaration
}
object TsConstructSignatureDeclaration {
  ...
  extension [Self <: TsConstructSignatureDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsConstructSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
