...
trait JSXExpressionContainer
  ...
  @JSName("type")
  var type_JSXExpressionContainer: typingsJapgolly.swcCore.swcCoreStrings.JSXExpressionContainer
}
object JSXExpressionContainer {
  ...
  extension [Self <: JSXExpressionContainer](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXExpressionContainer): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
