...
trait TsInterfaceDeclaration
  ...
  @JSName("type")
  var type_TsInterfaceDeclaration: typingsJapgolly.swcCore.swcCoreStrings.TsInterfaceDeclaration
}
object TsInterfaceDeclaration {
  ...
  extension [Self <: TsInterfaceDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsInterfaceDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
