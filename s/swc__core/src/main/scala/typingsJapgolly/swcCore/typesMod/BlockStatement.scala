...
trait BlockStatement
  ...
  @JSName("type")
  var type_BlockStatement: typingsJapgolly.swcCore.swcCoreStrings.BlockStatement
}
object BlockStatement {
  ...
  extension [Self <: BlockStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.BlockStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
