...
trait OptionalChainingExpression
  ...
  @JSName("type")
  var type_OptionalChainingExpression: typingsJapgolly.swcCore.swcCoreStrings.OptionalChainingExpression
}
object OptionalChainingExpression {
  ...
  extension [Self <: OptionalChainingExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.OptionalChainingExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
