...
trait ArrayExpression
  ...
  @JSName("type")
  var type_ArrayExpression: typingsJapgolly.swcCore.swcCoreStrings.ArrayExpression
}
object ArrayExpression {
  ...
  extension [Self <: ArrayExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ArrayExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
