...
trait TsSetterSignature
  ...
  @JSName("type")
  var type_TsSetterSignature: typingsJapgolly.swcCore.swcCoreStrings.TsSetterSignature
}
object TsSetterSignature {
  ...
  extension [Self <: TsSetterSignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsSetterSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
