...
trait AssignmentProperty
  ...
  @JSName("type")
  var type_AssignmentProperty: typingsJapgolly.swcCore.swcCoreStrings.AssignmentProperty
...
object AssignmentProperty {
  ...
  extension [Self <: AssignmentProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.AssignmentProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
