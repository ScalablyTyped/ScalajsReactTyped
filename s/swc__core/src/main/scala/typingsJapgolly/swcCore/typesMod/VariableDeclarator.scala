...
trait VariableDeclarator
  ...
  @JSName("type")
  var type_VariableDeclarator: typingsJapgolly.swcCore.swcCoreStrings.VariableDeclarator
}
object VariableDeclarator {
  ...
  extension [Self <: VariableDeclarator](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.VariableDeclarator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
