...
trait TsParenthesizedType
  ...
  @JSName("type")
  var type_TsParenthesizedType: typingsJapgolly.swcCore.swcCoreStrings.TsParenthesizedType
}
object TsParenthesizedType {
  ...
  extension [Self <: TsParenthesizedType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsParenthesizedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
