...
trait ImportDefaultSpecifier
  ...
  @JSName("type")
  var type_ImportDefaultSpecifier: typingsJapgolly.swcCore.swcCoreStrings.ImportDefaultSpecifier
}
object ImportDefaultSpecifier {
  ...
  extension [Self <: ImportDefaultSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ImportDefaultSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
