...
trait TsTypePredicate
  ...
  @JSName("type")
  var type_TsTypePredicate: typingsJapgolly.swcCore.swcCoreStrings.TsTypePredicate
}
object TsTypePredicate {
  ...
  extension [Self <: TsTypePredicate](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTypePredicate): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
