...
trait TsTupleElement
  ...
  @JSName("type")
  var type_TsTupleElement: typingsJapgolly.swcCore.swcCoreStrings.TsTupleElement
}
object TsTupleElement {
  ...
  extension [Self <: TsTupleElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTupleElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
