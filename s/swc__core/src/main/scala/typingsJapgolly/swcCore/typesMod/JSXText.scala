...
trait JSXText
  ...
  @JSName("type")
  var type_JSXText: typingsJapgolly.swcCore.swcCoreStrings.JSXText
...
object JSXText {
  ...
  extension [Self <: JSXText](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXText): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
