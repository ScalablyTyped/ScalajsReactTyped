...
trait AssignmentPattern
  ...
  @JSName("type")
  var type_AssignmentPattern: typingsJapgolly.swcCore.swcCoreStrings.AssignmentPattern
}
object AssignmentPattern {
  ...
  extension [Self <: AssignmentPattern](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.AssignmentPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
