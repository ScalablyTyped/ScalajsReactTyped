...
trait BindingIdentifier
  ...
  @JSName("type")
  var type_BindingIdentifier: typingsJapgolly.swcCore.swcCoreStrings.Identifier
...
object BindingIdentifier {
  ...
  extension [Self <: BindingIdentifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.Identifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
