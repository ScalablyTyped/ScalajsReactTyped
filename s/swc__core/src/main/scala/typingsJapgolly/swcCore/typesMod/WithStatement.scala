...
trait WithStatement
  ...
  @JSName("type")
  var type_WithStatement: typingsJapgolly.swcCore.swcCoreStrings.WithStatement
}
object WithStatement {
  ...
  extension [Self <: WithStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.WithStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
