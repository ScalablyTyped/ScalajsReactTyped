...
trait GetterProperty
  ...
  @JSName("type")
  var type_GetterProperty: typingsJapgolly.swcCore.swcCoreStrings.GetterProperty
}
object GetterProperty {
  ...
  extension [Self <: GetterProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.GetterProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
