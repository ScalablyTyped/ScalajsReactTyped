...
trait ExportDefaultExpression
  ...
  @JSName("type")
  var type_ExportDefaultExpression: typingsJapgolly.swcCore.swcCoreStrings.ExportDefaultExpression
}
object ExportDefaultExpression {
  ...
  extension [Self <: ExportDefaultExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ExportDefaultExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
