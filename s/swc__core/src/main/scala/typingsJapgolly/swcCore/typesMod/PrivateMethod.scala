...
trait PrivateMethod
  ...
  @JSName("type")
  var type_PrivateMethod: typingsJapgolly.swcCore.swcCoreStrings.PrivateMethod
}
object PrivateMethod {
  ...
  extension [Self <: PrivateMethod](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.PrivateMethod): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
