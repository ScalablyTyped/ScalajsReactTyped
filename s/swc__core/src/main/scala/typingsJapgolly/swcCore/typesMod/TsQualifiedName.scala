...
trait TsQualifiedName
  ...
  @JSName("type")
  var type_TsQualifiedName: typingsJapgolly.swcCore.swcCoreStrings.TsQualifiedName
}
object TsQualifiedName {
  ...
  extension [Self <: TsQualifiedName](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsQualifiedName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
