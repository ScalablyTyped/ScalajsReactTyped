...
trait TsMethodSignature
  ...
  @JSName("type")
  var type_TsMethodSignature: typingsJapgolly.swcCore.swcCoreStrings.TsMethodSignature
}
object TsMethodSignature {
  ...
  extension [Self <: TsMethodSignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsMethodSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
