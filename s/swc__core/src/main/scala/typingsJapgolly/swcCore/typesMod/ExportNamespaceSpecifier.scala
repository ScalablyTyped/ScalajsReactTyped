...
trait ExportNamespaceSpecifier
  ...
  @JSName("type")
  var type_ExportNamespaceSpecifier: typingsJapgolly.swcCore.swcCoreStrings.ExportNamespaceSpecifier
}
object ExportNamespaceSpecifier {
  ...
  extension [Self <: ExportNamespaceSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ExportNamespaceSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
