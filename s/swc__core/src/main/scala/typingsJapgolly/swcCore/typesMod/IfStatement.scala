...
trait IfStatement
  ...
  @JSName("type")
  var type_IfStatement: typingsJapgolly.swcCore.swcCoreStrings.IfStatement
}
object IfStatement {
  ...
  extension [Self <: IfStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.IfStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
