...
trait ClassDeclaration
  ...
  @JSName("type")
  var type_ClassDeclaration: typingsJapgolly.swcCore.swcCoreStrings.ClassDeclaration
}
object ClassDeclaration {
  ...
  extension [Self <: ClassDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ClassDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
