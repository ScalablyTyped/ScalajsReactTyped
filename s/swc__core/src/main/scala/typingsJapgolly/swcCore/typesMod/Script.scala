...
trait Script
  ...
  @JSName("type")
  var type_Script: typingsJapgolly.swcCore.swcCoreStrings.Script
}
object Script {
  ...
  extension [Self <: Script](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.Script): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
