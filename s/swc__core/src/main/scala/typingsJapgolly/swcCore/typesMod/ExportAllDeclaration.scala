...
trait ExportAllDeclaration
  ...
  @JSName("type")
  var type_ExportAllDeclaration: typingsJapgolly.swcCore.swcCoreStrings.ExportAllDeclaration
}
object ExportAllDeclaration {
  ...
  extension [Self <: ExportAllDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ExportAllDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
