...
trait SuperPropExpression
  ...
  @JSName("type")
  var type_SuperPropExpression: typingsJapgolly.swcCore.swcCoreStrings.SuperPropExpression
}
object SuperPropExpression {
  ...
  extension [Self <: SuperPropExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.SuperPropExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
