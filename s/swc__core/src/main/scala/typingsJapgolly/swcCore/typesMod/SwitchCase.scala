...
trait SwitchCase
  ...
  @JSName("type")
  var type_SwitchCase: typingsJapgolly.swcCore.swcCoreStrings.SwitchCase
}
object SwitchCase {
  ...
  extension [Self <: SwitchCase](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.SwitchCase): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
