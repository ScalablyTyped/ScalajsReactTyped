...
trait TsFunctionType
  ...
  @JSName("type")
  var type_TsFunctionType: typingsJapgolly.swcCore.swcCoreStrings.TsFunctionType
}
object TsFunctionType {
  ...
  extension [Self <: TsFunctionType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsFunctionType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
