...
trait JSXSpreadChild
  ...
  @JSName("type")
  var type_JSXSpreadChild: typingsJapgolly.swcCore.swcCoreStrings.JSXSpreadChild
}
object JSXSpreadChild {
  ...
  extension [Self <: JSXSpreadChild](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXSpreadChild): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
