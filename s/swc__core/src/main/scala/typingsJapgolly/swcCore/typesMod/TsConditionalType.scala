...
trait TsConditionalType
  ...
  @JSName("type")
  var type_TsConditionalType: typingsJapgolly.swcCore.swcCoreStrings.TsConditionalType
}
object TsConditionalType {
  ...
  extension [Self <: TsConditionalType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsConditionalType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
