...
trait TsInterfaceBody
  ...
  @JSName("type")
  var type_TsInterfaceBody: typingsJapgolly.swcCore.swcCoreStrings.TsInterfaceBody
}
object TsInterfaceBody {
  ...
  extension [Self <: TsInterfaceBody](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsInterfaceBody): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
