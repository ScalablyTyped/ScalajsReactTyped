...
trait TsTypeAnnotation
  ...
  @JSName("type")
  var type_TsTypeAnnotation: typingsJapgolly.swcCore.swcCoreStrings.TsTypeAnnotation
}
object TsTypeAnnotation {
  ...
  extension [Self <: TsTypeAnnotation](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTypeAnnotation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
