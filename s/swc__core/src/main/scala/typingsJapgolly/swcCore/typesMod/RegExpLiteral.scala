...
trait RegExpLiteral
  ...
  @JSName("type")
  var type_RegExpLiteral: typingsJapgolly.swcCore.swcCoreStrings.RegExpLiteral
}
object RegExpLiteral {
  ...
  extension [Self <: RegExpLiteral](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.RegExpLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
