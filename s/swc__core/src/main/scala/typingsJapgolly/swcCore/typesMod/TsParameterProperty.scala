...
trait TsParameterProperty
  ...
  @JSName("type")
  var type_TsParameterProperty: typingsJapgolly.swcCore.swcCoreStrings.TsParameterProperty
}
object TsParameterProperty {
  ...
  extension [Self <: TsParameterProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsParameterProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
