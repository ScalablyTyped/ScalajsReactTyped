...
trait TsModuleBlock
  ...
  @JSName("type")
  var type_TsModuleBlock: typingsJapgolly.swcCore.swcCoreStrings.TsModuleBlock
}
object TsModuleBlock {
  ...
  extension [Self <: TsModuleBlock](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsModuleBlock): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
