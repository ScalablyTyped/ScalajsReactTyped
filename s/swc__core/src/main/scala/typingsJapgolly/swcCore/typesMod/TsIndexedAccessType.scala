...
trait TsIndexedAccessType
  ...
  @JSName("type")
  var type_TsIndexedAccessType: typingsJapgolly.swcCore.swcCoreStrings.TsIndexedAccessType
}
object TsIndexedAccessType {
  ...
  extension [Self <: TsIndexedAccessType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsIndexedAccessType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
