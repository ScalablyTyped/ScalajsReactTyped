...
trait TsNonNullExpression
  ...
  @JSName("type")
  var type_TsNonNullExpression: typingsJapgolly.swcCore.swcCoreStrings.TsNonNullExpression
}
object TsNonNullExpression {
  ...
  extension [Self <: TsNonNullExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsNonNullExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
