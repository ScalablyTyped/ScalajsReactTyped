...
trait ArrayPattern
  ...
  @JSName("type")
  var type_ArrayPattern: typingsJapgolly.swcCore.swcCoreStrings.ArrayPattern
}
object ArrayPattern {
  ...
  extension [Self <: ArrayPattern](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ArrayPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
