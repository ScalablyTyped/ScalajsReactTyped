...
trait WhileStatement
  ...
  @JSName("type")
  var type_WhileStatement: typingsJapgolly.swcCore.swcCoreStrings.WhileStatement
}
object WhileStatement {
  ...
  extension [Self <: WhileStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.WhileStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
