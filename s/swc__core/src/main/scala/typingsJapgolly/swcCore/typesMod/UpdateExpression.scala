...
trait UpdateExpression
  ...
  @JSName("type")
  var type_UpdateExpression: typingsJapgolly.swcCore.swcCoreStrings.UpdateExpression
}
object UpdateExpression {
  ...
  extension [Self <: UpdateExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.UpdateExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
