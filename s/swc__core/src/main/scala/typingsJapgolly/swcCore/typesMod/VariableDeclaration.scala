...
trait VariableDeclaration
  ...
  @JSName("type")
  var type_VariableDeclaration: typingsJapgolly.swcCore.swcCoreStrings.VariableDeclaration
}
object VariableDeclaration {
  ...
  extension [Self <: VariableDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.VariableDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
