...
trait AssignmentExpression
  ...
  @JSName("type")
  var type_AssignmentExpression: typingsJapgolly.swcCore.swcCoreStrings.AssignmentExpression
}
object AssignmentExpression {
  ...
  extension [Self <: AssignmentExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.AssignmentExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
