...
trait YieldExpression
  ...
  @JSName("type")
  var type_YieldExpression: typingsJapgolly.swcCore.swcCoreStrings.YieldExpression
}
object YieldExpression {
  ...
  extension [Self <: YieldExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.YieldExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
