...
trait TsTypeReference
  ...
  @JSName("type")
  var type_TsTypeReference: typingsJapgolly.swcCore.swcCoreStrings.TsTypeReference
}
object TsTypeReference {
  ...
  extension [Self <: TsTypeReference](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTypeReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
