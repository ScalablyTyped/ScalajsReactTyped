...
trait TsImportType
  ...
  @JSName("type")
  var type_TsImportType: typingsJapgolly.swcCore.swcCoreStrings.TsImportType
}
object TsImportType {
  ...
  extension [Self <: TsImportType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsImportType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
