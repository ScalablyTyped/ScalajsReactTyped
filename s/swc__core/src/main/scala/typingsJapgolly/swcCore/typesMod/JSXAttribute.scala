...
trait JSXAttribute
  ...
  @JSName("type")
  var type_JSXAttribute: typingsJapgolly.swcCore.swcCoreStrings.JSXAttribute
...
object JSXAttribute {
  ...
  extension [Self <: JSXAttribute](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXAttribute): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
