...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.swcCore.typesMod.Constructor
  - typingsJapgolly.swcCore.typesMod.ClassMethod
  - typingsJapgolly.swcCore.typesMod.PrivateMethod
  - typingsJapgolly.swcCore.typesMod.ClassProperty
  - typingsJapgolly.swcCore.typesMod.PrivateProperty
  - typingsJapgolly.swcCore.typesMod.TsIndexSignature
  - typingsJapgolly.swcCore.typesMod.EmptyStatement
  - typingsJapgolly.swcCore.typesMod.StaticBlock
*/
...
object ClassMember {
  ...
  inline def ClassMethod(
    ...
    __obj.asInstanceOf[typingsJapgolly.swcCore.typesMod.ClassMethod]
  }
  ...
  inline def ClassProperty(
    ...
    __obj.asInstanceOf[typingsJapgolly.swcCore.typesMod.ClassProperty]
  }
  
  inline def Constructor(isOptional: Boolean, key: PropertyName, params: js.Array[TsParameterProperty | Param], span: Span): typingsJapgolly.swcCore.typesMod.Constructor = {
    ...
    __obj.asInstanceOf[typingsJapgolly.swcCore.typesMod.Constructor]
  }
  ...
  inline def PrivateMethod(
    ...
    __obj.asInstanceOf[typingsJapgolly.swcCore.typesMod.PrivateMethod]
  }
  ...
  inline def PrivateProperty(
    ...
    __obj.asInstanceOf[typingsJapgolly.swcCore.typesMod.PrivateProperty]
  }
  
  inline def StaticBlock(body: BlockStatement, span: Span): typingsJapgolly.swcCore.typesMod.StaticBlock = {
    ...
    __obj.asInstanceOf[typingsJapgolly.swcCore.typesMod.StaticBlock]
  }
