...
trait BooleanLiteral
  ...
  @JSName("type")
  var type_BooleanLiteral: typingsJapgolly.swcCore.swcCoreStrings.BooleanLiteral
...
object BooleanLiteral {
  ...
  extension [Self <: BooleanLiteral](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.BooleanLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
