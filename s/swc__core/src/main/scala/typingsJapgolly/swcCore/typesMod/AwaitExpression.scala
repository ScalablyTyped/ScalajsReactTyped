...
trait AwaitExpression
  ...
  @JSName("type")
  var type_AwaitExpression: typingsJapgolly.swcCore.swcCoreStrings.AwaitExpression
}
object AwaitExpression {
  ...
  extension [Self <: AwaitExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.AwaitExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
