...
trait TemplateElement
  ...
  @JSName("type")
  var type_TemplateElement: typingsJapgolly.swcCore.swcCoreStrings.TemplateElement
}
object TemplateElement {
  ...
  extension [Self <: TemplateElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TemplateElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
