...
trait DoWhileStatement
  ...
  @JSName("type")
  var type_DoWhileStatement: typingsJapgolly.swcCore.swcCoreStrings.DoWhileStatement
}
object DoWhileStatement {
  ...
  extension [Self <: DoWhileStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.DoWhileStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
