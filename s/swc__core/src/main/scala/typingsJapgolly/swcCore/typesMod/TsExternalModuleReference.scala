...
trait TsExternalModuleReference
  ...
  @JSName("type")
  var type_TsExternalModuleReference: typingsJapgolly.swcCore.swcCoreStrings.TsExternalModuleReference
}
object TsExternalModuleReference {
  ...
  extension [Self <: TsExternalModuleReference](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsExternalModuleReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
