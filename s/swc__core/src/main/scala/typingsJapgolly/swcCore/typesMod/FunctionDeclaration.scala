...
trait FunctionDeclaration
  ...
  var `type`: typingsJapgolly.swcCore.swcCoreStrings.FunctionDeclaration
}
object FunctionDeclaration {
  ...
  extension [Self <: FunctionDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.FunctionDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
