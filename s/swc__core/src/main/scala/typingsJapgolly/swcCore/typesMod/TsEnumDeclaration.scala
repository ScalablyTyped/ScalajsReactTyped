...
trait TsEnumDeclaration
  ...
  @JSName("type")
  var type_TsEnumDeclaration: typingsJapgolly.swcCore.swcCoreStrings.TsEnumDeclaration
}
object TsEnumDeclaration {
  ...
  extension [Self <: TsEnumDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsEnumDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
