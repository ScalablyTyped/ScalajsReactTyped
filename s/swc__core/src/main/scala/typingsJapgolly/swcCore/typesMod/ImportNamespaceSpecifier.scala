...
trait ImportNamespaceSpecifier
  ...
  @JSName("type")
  var type_ImportNamespaceSpecifier: typingsJapgolly.swcCore.swcCoreStrings.ImportNamespaceSpecifier
}
object ImportNamespaceSpecifier {
  ...
  extension [Self <: ImportNamespaceSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ImportNamespaceSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
