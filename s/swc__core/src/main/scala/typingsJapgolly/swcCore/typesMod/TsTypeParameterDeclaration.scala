...
trait TsTypeParameterDeclaration
  ...
  @JSName("type")
  var type_TsTypeParameterDeclaration: typingsJapgolly.swcCore.swcCoreStrings.TsTypeParameterDeclaration
}
object TsTypeParameterDeclaration {
  ...
  extension [Self <: TsTypeParameterDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTypeParameterDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
