...
trait TsConstAssertion
  ...
  @JSName("type")
  var type_TsConstAssertion: typingsJapgolly.swcCore.swcCoreStrings.TsConstAssertion
}
object TsConstAssertion {
  ...
  extension [Self <: TsConstAssertion](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsConstAssertion): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
