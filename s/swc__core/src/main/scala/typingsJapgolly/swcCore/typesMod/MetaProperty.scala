...
trait MetaProperty
  ...
  @JSName("type")
  var type_MetaProperty: typingsJapgolly.swcCore.swcCoreStrings.MetaProperty
}
object MetaProperty {
  ...
  extension [Self <: MetaProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.MetaProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
