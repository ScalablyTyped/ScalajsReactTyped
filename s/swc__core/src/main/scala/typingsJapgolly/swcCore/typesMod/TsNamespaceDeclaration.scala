...
trait TsNamespaceDeclaration
  ...
  @JSName("type")
  var type_TsNamespaceDeclaration: typingsJapgolly.swcCore.swcCoreStrings.TsNamespaceDeclaration
}
object TsNamespaceDeclaration {
  ...
  extension [Self <: TsNamespaceDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsNamespaceDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
