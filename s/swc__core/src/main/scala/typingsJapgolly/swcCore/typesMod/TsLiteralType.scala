...
trait TsLiteralType
  ...
  @JSName("type")
  var type_TsLiteralType: typingsJapgolly.swcCore.swcCoreStrings.TsLiteralType
}
object TsLiteralType {
  ...
  extension [Self <: TsLiteralType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsLiteralType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
