...
trait TsTypeQuery
  ...
  @JSName("type")
  var type_TsTypeQuery: typingsJapgolly.swcCore.swcCoreStrings.TsTypeQuery
}
object TsTypeQuery {
  ...
  extension [Self <: TsTypeQuery](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTypeQuery): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
