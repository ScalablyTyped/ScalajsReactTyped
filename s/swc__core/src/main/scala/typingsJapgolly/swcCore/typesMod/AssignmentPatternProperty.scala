...
trait AssignmentPatternProperty
  ...
  @JSName("type")
  var type_AssignmentPatternProperty: typingsJapgolly.swcCore.swcCoreStrings.AssignmentPatternProperty
...
object AssignmentPatternProperty {
  ...
  extension [Self <: AssignmentPatternProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.AssignmentPatternProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
