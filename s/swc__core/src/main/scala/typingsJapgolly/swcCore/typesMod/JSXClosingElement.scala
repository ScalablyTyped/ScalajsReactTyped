...
trait JSXClosingElement
  ...
  @JSName("type")
  var type_JSXClosingElement: typingsJapgolly.swcCore.swcCoreStrings.JSXClosingElement
}
object JSXClosingElement {
  ...
  extension [Self <: JSXClosingElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXClosingElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
