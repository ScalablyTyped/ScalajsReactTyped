...
trait ClassProperty
  ...
  @JSName("type")
  var type_ClassProperty: typingsJapgolly.swcCore.swcCoreStrings.ClassProperty
}
object ClassProperty {
  ...
  extension [Self <: ClassProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ClassProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
