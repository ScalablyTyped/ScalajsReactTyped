...
trait JSXNamespacedName
  ...
  @JSName("type")
  var type_JSXNamespacedName: typingsJapgolly.swcCore.swcCoreStrings.JSXNamespacedName
}
object JSXNamespacedName {
  ...
  extension [Self <: JSXNamespacedName](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXNamespacedName): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
