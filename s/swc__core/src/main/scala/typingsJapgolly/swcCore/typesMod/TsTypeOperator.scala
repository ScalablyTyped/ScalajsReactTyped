...
trait TsTypeOperator
  ...
  @JSName("type")
  var type_TsTypeOperator: typingsJapgolly.swcCore.swcCoreStrings.TsTypeOperator
}
object TsTypeOperator {
  ...
  extension [Self <: TsTypeOperator](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTypeOperator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
