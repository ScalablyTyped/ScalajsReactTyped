...
trait TsIndexSignature
  ...
  @JSName("type")
  var type_TsIndexSignature: typingsJapgolly.swcCore.swcCoreStrings.TsIndexSignature
}
object TsIndexSignature {
  ...
  extension [Self <: TsIndexSignature](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsIndexSignature): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
