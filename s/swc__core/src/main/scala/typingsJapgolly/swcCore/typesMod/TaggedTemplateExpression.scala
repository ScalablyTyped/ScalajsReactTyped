...
trait TaggedTemplateExpression
  ...
  @JSName("type")
  var type_TaggedTemplateExpression: typingsJapgolly.swcCore.swcCoreStrings.TaggedTemplateExpression
}
object TaggedTemplateExpression {
  ...
  extension [Self <: TaggedTemplateExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TaggedTemplateExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
