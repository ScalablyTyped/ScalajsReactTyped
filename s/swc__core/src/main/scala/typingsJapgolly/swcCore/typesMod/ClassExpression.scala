...
- typingsJapgolly.swcCore.typesMod.ExpressionBase because var conflicts: span. Inlined  */ trait ClassExpression
  extends StObject
     with Class
     with DefaultDecl
     with Expression
  ...
  @JSName("type")
  var type_ClassExpression: typingsJapgolly.swcCore.swcCoreStrings.ClassExpression
}
object ClassExpression {
  ...
  extension [Self <: ClassExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ClassExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
