...
trait ConditionalExpression
  ...
  @JSName("type")
  var type_ConditionalExpression: typingsJapgolly.swcCore.swcCoreStrings.ConditionalExpression
}
object ConditionalExpression {
  ...
  extension [Self <: ConditionalExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ConditionalExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
