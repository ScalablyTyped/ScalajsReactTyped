...
trait ForInStatement
  ...
  @JSName("type")
  var type_ForInStatement: typingsJapgolly.swcCore.swcCoreStrings.ForInStatement
}
object ForInStatement {
  ...
  extension [Self <: ForInStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ForInStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
