...
trait ForOfStatement
  ...
  @JSName("type")
  var type_ForOfStatement: typingsJapgolly.swcCore.swcCoreStrings.ForOfStatement
}
object ForOfStatement {
  ...
  extension [Self <: ForOfStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ForOfStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
