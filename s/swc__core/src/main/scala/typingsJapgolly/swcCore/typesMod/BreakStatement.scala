...
trait BreakStatement
  ...
  @JSName("type")
  var type_BreakStatement: typingsJapgolly.swcCore.swcCoreStrings.BreakStatement
}
object BreakStatement {
  ...
  extension [Self <: BreakStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.BreakStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
