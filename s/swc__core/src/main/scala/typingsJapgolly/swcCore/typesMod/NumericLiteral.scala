...
trait NumericLiteral
  ...
  @JSName("type")
  var type_NumericLiteral: typingsJapgolly.swcCore.swcCoreStrings.NumericLiteral
...
object NumericLiteral {
  ...
  extension [Self <: NumericLiteral](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.NumericLiteral): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
