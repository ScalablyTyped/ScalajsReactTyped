...
trait OptionalChainingCall
  ...
  @JSName("type")
  var type_OptionalChainingCall: typingsJapgolly.swcCore.swcCoreStrings.CallExpression
}
object OptionalChainingCall {
  ...
  extension [Self <: OptionalChainingCall](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.CallExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
