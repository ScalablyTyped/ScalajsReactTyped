...
trait UnaryExpression
  ...
  @JSName("type")
  var type_UnaryExpression: typingsJapgolly.swcCore.swcCoreStrings.UnaryExpression
}
object UnaryExpression {
  ...
  extension [Self <: UnaryExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.UnaryExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
