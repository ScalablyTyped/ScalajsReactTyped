...
trait TsMappedType
  ...
  @JSName("type")
  var type_TsMappedType: typingsJapgolly.swcCore.swcCoreStrings.TsMappedType
}
object TsMappedType {
  ...
  extension [Self <: TsMappedType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsMappedType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
