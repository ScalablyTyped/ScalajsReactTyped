...
trait ExportNamedDeclaration
  ...
  @JSName("type")
  var type_ExportNamedDeclaration: typingsJapgolly.swcCore.swcCoreStrings.ExportNamedDeclaration
}
object ExportNamedDeclaration {
  ...
  extension [Self <: ExportNamedDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ExportNamedDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
