...
trait ExportDefaultSpecifier
  ...
  @JSName("type")
  var type_ExportDefaultSpecifier: typingsJapgolly.swcCore.swcCoreStrings.ExportDefaultSpecifier
}
object ExportDefaultSpecifier {
  ...
  extension [Self <: ExportDefaultSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ExportDefaultSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
