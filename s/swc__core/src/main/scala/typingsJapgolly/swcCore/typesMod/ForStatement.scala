...
trait ForStatement
  ...
  @JSName("type")
  var type_ForStatement: typingsJapgolly.swcCore.swcCoreStrings.ForStatement
...
object ForStatement {
  ...
  extension [Self <: ForStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ForStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
