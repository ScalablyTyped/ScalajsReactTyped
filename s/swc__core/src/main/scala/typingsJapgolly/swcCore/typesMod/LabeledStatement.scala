...
trait LabeledStatement
  ...
  @JSName("type")
  var type_LabeledStatement: typingsJapgolly.swcCore.swcCoreStrings.LabeledStatement
}
object LabeledStatement {
  ...
  extension [Self <: LabeledStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.LabeledStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
