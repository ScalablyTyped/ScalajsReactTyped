...
trait TsTypeParameter
  ...
  @JSName("type")
  var type_TsTypeParameter: typingsJapgolly.swcCore.swcCoreStrings.TsTypeParameter
}
object TsTypeParameter {
  ...
  extension [Self <: TsTypeParameter](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTypeParameter): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
