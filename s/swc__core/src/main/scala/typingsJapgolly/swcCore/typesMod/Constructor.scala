...
trait Constructor
  ...
  @JSName("type")
  var type_Constructor: typingsJapgolly.swcCore.swcCoreStrings.Constructor
}
object Constructor {
  ...
  extension [Self <: Constructor](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.Constructor): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
