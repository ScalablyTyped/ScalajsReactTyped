...
trait CatchClause
  ...
  @JSName("type")
  var type_CatchClause: typingsJapgolly.swcCore.swcCoreStrings.CatchClause
}
object CatchClause {
  ...
  extension [Self <: CatchClause](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.CatchClause): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
