...
trait TsImportEqualsDeclaration
  ...
  @JSName("type")
  var type_TsImportEqualsDeclaration: typingsJapgolly.swcCore.swcCoreStrings.TsImportEqualsDeclaration
}
object TsImportEqualsDeclaration {
  ...
  extension [Self <: TsImportEqualsDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsImportEqualsDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
