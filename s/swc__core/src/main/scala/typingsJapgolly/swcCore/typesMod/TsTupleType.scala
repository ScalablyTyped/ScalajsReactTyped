...
trait TsTupleType
  ...
  @JSName("type")
  var type_TsTupleType: typingsJapgolly.swcCore.swcCoreStrings.TsTupleType
}
object TsTupleType {
  ...
  extension [Self <: TsTupleType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsTupleType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
