...
trait ImportDeclaration
  ...
  @JSName("type")
  var type_ImportDeclaration: typingsJapgolly.swcCore.swcCoreStrings.ImportDeclaration
}
object ImportDeclaration {
  ...
  extension [Self <: ImportDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ImportDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
