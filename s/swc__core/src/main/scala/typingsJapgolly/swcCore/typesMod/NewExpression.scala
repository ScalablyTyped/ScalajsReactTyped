...
trait NewExpression
  ...
  @JSName("type")
  var type_NewExpression: typingsJapgolly.swcCore.swcCoreStrings.NewExpression
}
object NewExpression {
  ...
  extension [Self <: NewExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.NewExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
