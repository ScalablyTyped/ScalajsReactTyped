...
trait TsIntersectionType
  ...
  @JSName("type")
  var type_TsIntersectionType: typingsJapgolly.swcCore.swcCoreStrings.TsIntersectionType
...
object TsIntersectionType {
  ...
  extension [Self <: TsIntersectionType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsIntersectionType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
