...
trait JSXOpeningElement
  ...
  @JSName("type")
  var type_JSXOpeningElement: typingsJapgolly.swcCore.swcCoreStrings.JSXOpeningElement
}
object JSXOpeningElement {
  ...
  extension [Self <: JSXOpeningElement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXOpeningElement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
