...
trait TsAsExpression
  ...
  @JSName("type")
  var type_TsAsExpression: typingsJapgolly.swcCore.swcCoreStrings.TsAsExpression
}
object TsAsExpression {
  ...
  extension [Self <: TsAsExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsAsExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
