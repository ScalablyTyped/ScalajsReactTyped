...
trait ObjectPattern
  ...
  @JSName("type")
  var type_ObjectPattern: typingsJapgolly.swcCore.swcCoreStrings.ObjectPattern
}
object ObjectPattern {
  ...
  extension [Self <: ObjectPattern](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ObjectPattern): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
