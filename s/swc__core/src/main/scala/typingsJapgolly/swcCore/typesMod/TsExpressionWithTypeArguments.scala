...
trait TsExpressionWithTypeArguments
  ...
  @JSName("type")
  var type_TsExpressionWithTypeArguments: typingsJapgolly.swcCore.swcCoreStrings.TsExpressionWithTypeArguments
}
object TsExpressionWithTypeArguments {
  ...
  extension [Self <: TsExpressionWithTypeArguments](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsExpressionWithTypeArguments): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
