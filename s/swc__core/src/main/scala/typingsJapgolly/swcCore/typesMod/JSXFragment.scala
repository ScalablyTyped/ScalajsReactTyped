...
trait JSXFragment
  ...
  @JSName("type")
  var type_JSXFragment: typingsJapgolly.swcCore.swcCoreStrings.JSXFragment
}
object JSXFragment {
  ...
  extension [Self <: JSXFragment](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXFragment): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
