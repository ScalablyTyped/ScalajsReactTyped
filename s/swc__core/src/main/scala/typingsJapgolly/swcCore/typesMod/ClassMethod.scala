...
trait ClassMethod
  ...
  @JSName("type")
  var type_ClassMethod: typingsJapgolly.swcCore.swcCoreStrings.ClassMethod
}
object ClassMethod {
  ...
  extension [Self <: ClassMethod](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ClassMethod): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
