...
trait PrivateProperty
  ...
  @JSName("type")
  var type_PrivateProperty: typingsJapgolly.swcCore.swcCoreStrings.PrivateProperty
}
object PrivateProperty {
  ...
  extension [Self <: PrivateProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.PrivateProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
