...
trait NamedExportSpecifier
  ...
  @JSName("type")
  var type_NamedExportSpecifier: typingsJapgolly.swcCore.swcCoreStrings.ExportSpecifier
}
object NamedExportSpecifier {
  ...
  extension [Self <: NamedExportSpecifier](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ExportSpecifier): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
