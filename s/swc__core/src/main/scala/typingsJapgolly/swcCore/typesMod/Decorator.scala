...
trait Decorator
  ...
  @JSName("type")
  var type_Decorator: typingsJapgolly.swcCore.swcCoreStrings.Decorator
}
object Decorator {
  ...
  extension [Self <: Decorator](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.Decorator): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
