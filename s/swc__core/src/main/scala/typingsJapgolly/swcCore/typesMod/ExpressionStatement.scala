...
trait ExpressionStatement
  ...
  @JSName("type")
  var type_ExpressionStatement: typingsJapgolly.swcCore.swcCoreStrings.ExpressionStatement
}
object ExpressionStatement {
  ...
  extension [Self <: ExpressionStatement](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ExpressionStatement): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
