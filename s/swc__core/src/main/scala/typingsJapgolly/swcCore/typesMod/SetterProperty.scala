...
trait SetterProperty
  ...
  @JSName("type")
  var type_SetterProperty: typingsJapgolly.swcCore.swcCoreStrings.SetterProperty
}
object SetterProperty {
  ...
  extension [Self <: SetterProperty](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.SetterProperty): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
