...
trait TsKeywordType
  ...
  @JSName("type")
  var type_TsKeywordType: typingsJapgolly.swcCore.swcCoreStrings.TsKeywordType
}
object TsKeywordType {
  ...
  extension [Self <: TsKeywordType](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsKeywordType): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
