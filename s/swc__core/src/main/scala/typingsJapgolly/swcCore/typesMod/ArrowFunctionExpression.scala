...
trait ArrowFunctionExpression
  ...
  @JSName("type")
  var type_ArrowFunctionExpression: typingsJapgolly.swcCore.swcCoreStrings.ArrowFunctionExpression
}
object ArrowFunctionExpression {
  ...
  extension [Self <: ArrowFunctionExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ArrowFunctionExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
