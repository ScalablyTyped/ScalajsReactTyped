...
trait TsCallSignatureDeclaration
  ...
  @JSName("type")
  var type_TsCallSignatureDeclaration: typingsJapgolly.swcCore.swcCoreStrings.TsCallSignatureDeclaration
}
object TsCallSignatureDeclaration {
  ...
  extension [Self <: TsCallSignatureDeclaration](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.TsCallSignatureDeclaration): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
