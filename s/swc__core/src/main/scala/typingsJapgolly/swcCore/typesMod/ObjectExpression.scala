...
trait ObjectExpression
  ...
  @JSName("type")
  var type_ObjectExpression: typingsJapgolly.swcCore.swcCoreStrings.ObjectExpression
}
object ObjectExpression {
  ...
  extension [Self <: ObjectExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.ObjectExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
