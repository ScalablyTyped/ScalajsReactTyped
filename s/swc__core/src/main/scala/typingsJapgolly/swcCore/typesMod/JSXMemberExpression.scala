...
trait JSXMemberExpression
  ...
  @JSName("type")
  var type_JSXMemberExpression: typingsJapgolly.swcCore.swcCoreStrings.JSXMemberExpression
}
object JSXMemberExpression {
  ...
  extension [Self <: JSXMemberExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.swcCore.swcCoreStrings.JSXMemberExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
