...
import typingsJapgolly.swcCore.swcCoreBooleans.`false`
import typingsJapgolly.swcCore.swcCoreStrings.all
import typingsJapgolly.swcCore.swcCoreStrings.some
import typingsJapgolly.swcCore.swcCoreStrings.traceEvent
import typingsJapgolly.swcCore.typesMod.JscTarget
import typingsJapgolly.swcCore.typesMod.TerserEcmaVersion
...
object anon {
  ...
  object FileName {
    ...
    inline def apply(): FileName = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("traceEvent")
    ...
    extension [Self <: FileName](x: Self) {
      ...
      inline def setType(value: traceEvent): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
  ...
  /* Inlined @swc/core.@swc/core/types.JsFormatOptions & @swc/core.@swc/core/types.ToSnakeCaseProperties<@swc/core.@swc/core/types.JsFormatOptions> */
