...
import typingsJapgolly.skiaCanvas.libMod.CursorStyle
import typingsJapgolly.skiaCanvas.libMod.ExportFormat
import typingsJapgolly.skiaCanvas.libMod.FitStyle
