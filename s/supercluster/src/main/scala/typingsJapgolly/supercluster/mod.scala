...
import typingsJapgolly.supercluster.superclusterBooleans.`true`
import typingsJapgolly.supercluster.superclusterInts.`1`
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options[?, ?], P, C](x: Self & (Options[P, C])) {
      ...
      inline def setReduce(value: (/* accumulated */ C, /* props */ C) => Callback): Self = StObject.set(x, "reduce", js.Any.fromFunction2((t0: /* accumulated */ C, t1: /* props */ C) => (value(t0, t1)).runNow()))
