...
import typingsJapgolly.sugar.sugarjs.Array.mapFn
import typingsJapgolly.sugar.sugarjs.Array.searchFn
import typingsJapgolly.sugar.sugarjs.Array.sortMapFn
...
trait Array[T] extends js.Object {
  ...
  def everyFromIndex(startIndex: Double): T = js.native
  ...
  def filterFromIndex(startIndex: Double): T = js.native
  ...
  def findFromIndex(startIndex: Double): T = js.native
  ...
  def findIndexFromIndex(startIndex: Double): T = js.native
  ...
  def forEachFromIndex(startIndex: Double): T = js.native
  ...
  def mapFromIndex(startIndex: Double): T = js.native
  ...
  def reduceFromIndex(startIndex: Double): T = js.native
  ...
  def reduceRightFromIndex(startIndex: Double): T = js.native
  ...
  def someFromIndex(startIndex: Double): T = js.native
