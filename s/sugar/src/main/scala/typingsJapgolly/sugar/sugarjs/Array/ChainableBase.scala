...
trait ChainableBase[T, RawValue] extends js.Object {
  ...
  def filter(search: T, context: js.Any): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  def filter(
    search: (js.Function3[/* value */ T, /* index */ Double, /* array */ typingsJapgolly.sugar.Array[T], _]) | searchFn[T]
  ...
  def inGroups(num: Double, padding: js.Any): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  def inGroupsOf(num: Double): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  def inGroupsOf(num: Double, padding: js.Any): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  ...
  def least[U](all: Boolean, map: String): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  def least[U](all: Boolean, map: mapFn[T, U]): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  def least[U](map: String): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  ...
  def map[U](map: String): SugarDefaultChainable[typingsJapgolly.sugar.Array[U]] = js.native
  def map[U](map: String, context: js.Any): SugarDefaultChainable[typingsJapgolly.sugar.Array[U]] = js.native
  ...
  def most[U](all: Boolean, map: String): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  def most[U](all: Boolean, map: mapFn[T, U]): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  def most[U](map: String): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  ...
  def sortBy[U](map: String): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  def sortBy[U](map: String, desc: Boolean): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  ...
  def unique[U](map: String): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
  ...
  def zip(args: js.Any*): SugarDefaultChainable[typingsJapgolly.sugar.Array[T]] = js.native
}
