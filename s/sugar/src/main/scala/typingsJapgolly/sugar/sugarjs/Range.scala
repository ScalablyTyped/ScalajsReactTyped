...
trait Range extends StObject {
  ...
  def every[T](amount: java.lang.String): typingsJapgolly.sugar.Array[T] = js.native
  def every[T](
    amount: java.lang.String,
    everyFn: js.Function3[/* el */ T, /* i */ Double, /* r */ this.type, Unit]
  ): typingsJapgolly.sugar.Array[T] = js.native
  def every[T](amount: Double): typingsJapgolly.sugar.Array[T] = js.native
  def every[T](amount: Double, everyFn: js.Function3[/* el */ T, /* i */ Double, /* r */ this.type, Unit]): typingsJapgolly.sugar.Array[T] = js.native
  ...
  def toArray[T](): typingsJapgolly.sugar.Array[T] = js.native
