...
object String {
  ...
  trait ChainableBase[RawValue] extends StObject {
    ...
    def replaceAll(f: typingsJapgolly.sugar.RegExp, args: Any*): SugarDefaultChainable[java.lang.String] = js.native
  ...
  trait Constructor
    ...
    def replaceAll(instance: java.lang.String, f: typingsJapgolly.sugar.RegExp, args: Any*): java.lang.String = js.native
