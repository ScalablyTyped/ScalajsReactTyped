package typingsJapgolly.safeStableStringify

import typingsJapgolly.safeStableStringify.anon.FnCall
...
object esmWrapperMod {
  
  @JSImport("safe-stable-stringify/esm/wrapper", JSImport.Namespace)
  @js.native
  ...
  object default {
    ...
    @JSImport("safe-stable-stringify/esm/wrapper", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
  ...
  object stringify {
    ...
    @JSImport("safe-stable-stringify/esm/wrapper", "stringify")
    @js.native
    val ^ : js.Any = js.native
