...
import typingsJapgolly.sparkpost.sparkpostStrings.active
import typingsJapgolly.sparkpost.sparkpostStrings.suspended
import typingsJapgolly.sparkpost.sparkpostStrings.terminated
