...
import typingsJapgolly.sparkpost.sparkpostStrings.Compliance
import typingsJapgolly.sparkpost.sparkpostStrings.`Bounce Rule`
import typingsJapgolly.sparkpost.sparkpostStrings.`List Unsubscribe`
import typingsJapgolly.sparkpost.sparkpostStrings.`Manually Added`
import typingsJapgolly.sparkpost.sparkpostStrings.`Spam Complaint`
