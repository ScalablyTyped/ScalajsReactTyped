...
trait SparkPostError
  ...
  @JSName("name")
  var name_SparkPostError: typingsJapgolly.sparkpost.sparkpostStrings.SparkPostError
...
object SparkPostError {
  ...
  extension [Self <: SparkPostError](x: Self) {
    ...
    inline def setName(value: typingsJapgolly.sparkpost.sparkpostStrings.SparkPostError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
