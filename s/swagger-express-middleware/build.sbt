...
version := "1.x-dt-20211202Z-4c6b84"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.github.japgolly.scalajs-react" %%% "core" % "2.1.1",
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped.japgolly" %%% "apidevtools__swagger-parser" % "10.1.0-4ae9f4",
  ...
  "org.scalablytyped.japgolly" %%% "swagger-parser" % "10.0.3-ef7f46")
