...
object SwaggerMiddleware {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(CORS = CORS.toJsFn, files = files.asInstanceOf[js.Any], metadata = js.Any.fromFunction1(metadata), mock = js.Any.fromFunction2(mock), parseRequest = parseRequest.asInstanceOf[js.Any], validateRequest = validateRequest.toJsFn)
  ...
  extension [Self <: SwaggerMiddleware](x: Self) {
    ...
    ): Self = StObject.set(x, "CORS", value.toJsFn)
    ...
    ): Self = StObject.set(x, "validateRequest", value.toJsFn)
  }
}
