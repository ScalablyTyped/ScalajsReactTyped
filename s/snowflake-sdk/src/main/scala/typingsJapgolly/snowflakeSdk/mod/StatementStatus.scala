...
object StatementStatus extends StObject {
  ...
  /* "complete" */ val Complete: typingsJapgolly.snowflakeSdk.mod.StatementStatus.Complete & String = js.native
  
  @js.native
  sealed trait Fetching
    extends StObject
       with StatementStatus
  /* "fetching" */ val Fetching: typingsJapgolly.snowflakeSdk.mod.StatementStatus.Fetching & String = js.native
}
