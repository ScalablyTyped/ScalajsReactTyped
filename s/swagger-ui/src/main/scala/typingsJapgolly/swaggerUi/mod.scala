...
import typingsJapgolly.swaggerUi.anon.Activate
import typingsJapgolly.swaggerUi.anon.AfterLoad
import typingsJapgolly.swaggerUi.anon.DefaultExpanded
import typingsJapgolly.swaggerUi.anon.Name
import typingsJapgolly.swaggerUi.swaggerUiBooleans.`false`
import typingsJapgolly.swaggerUi.swaggerUiStrings.example
import typingsJapgolly.swaggerUi.swaggerUiStrings.full
import typingsJapgolly.swaggerUi.swaggerUiStrings.list
import typingsJapgolly.swaggerUi.swaggerUiStrings.model
import typingsJapgolly.swaggerUi.swaggerUiStrings.none
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.swaggerUi.swaggerUiStrings.legacy
    - typingsJapgolly.swaggerUi.swaggerUiStrings.chain
  */
  trait PluginLoadType extends StObject
  object PluginLoadType {
    
    inline def chain: typingsJapgolly.swaggerUi.swaggerUiStrings.chain = "chain".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.chain]
    
    inline def legacy: typingsJapgolly.swaggerUi.swaggerUiStrings.legacy = "legacy".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.legacy]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.swaggerUi.swaggerUiStrings.alpha
    - typingsJapgolly.swaggerUi.swaggerUiStrings.method
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.swaggerUi.swaggerUiStrings.get
    - typingsJapgolly.swaggerUi.swaggerUiStrings.put
    - typingsJapgolly.swaggerUi.swaggerUiStrings.post
    - typingsJapgolly.swaggerUi.swaggerUiStrings.delete
    - typingsJapgolly.swaggerUi.swaggerUiStrings.options
    - typingsJapgolly.swaggerUi.swaggerUiStrings.head
    - typingsJapgolly.swaggerUi.swaggerUiStrings.patch
    - typingsJapgolly.swaggerUi.swaggerUiStrings.trace
  */
  trait SupportedHTTPMethods extends StObject
  object SupportedHTTPMethods {
    
    inline def delete: typingsJapgolly.swaggerUi.swaggerUiStrings.delete = "delete".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.delete]
    
    inline def get: typingsJapgolly.swaggerUi.swaggerUiStrings.get = "get".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.get]
    
    inline def head: typingsJapgolly.swaggerUi.swaggerUiStrings.head = "head".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.head]
    
    inline def options: typingsJapgolly.swaggerUi.swaggerUiStrings.options = "options".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.options]
    
    inline def patch: typingsJapgolly.swaggerUi.swaggerUiStrings.patch = "patch".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.patch]
    
    inline def post: typingsJapgolly.swaggerUi.swaggerUiStrings.post = "post".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.post]
    
    inline def put: typingsJapgolly.swaggerUi.swaggerUiStrings.put = "put".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.put]
    
    inline def trace: typingsJapgolly.swaggerUi.swaggerUiStrings.trace = "trace".asInstanceOf[typingsJapgolly.swaggerUi.swaggerUiStrings.trace]
  }
  ...
  object SwaggerUI {
    ...
    inline def apply(
      initOAuth: Any => Callback,
      preauthorizeApiKey: (Any, Any) => Any,
      preauthorizeBasic: (Any, Any, Any) => Any
    ): SwaggerUI = {
      val __obj = js.Dynamic.literal(initOAuth = js.Any.fromFunction1((t0: Any) => initOAuth(t0).runNow()), preauthorizeApiKey = js.Any.fromFunction2(preauthorizeApiKey), preauthorizeBasic = js.Any.fromFunction3(preauthorizeBasic))
      __obj.asInstanceOf[SwaggerUI]
    }
    
    extension [Self <: SwaggerUI](x: Self) {
      
      inline def setInitOAuth(value: Any => Callback): Self = StObject.set(x, "initOAuth", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
