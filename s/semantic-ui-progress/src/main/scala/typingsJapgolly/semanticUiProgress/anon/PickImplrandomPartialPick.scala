...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'random'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
trait PickImplrandomPartialPick
  extends StObject
     with Param {
  ...
  var random: RandomSettings & js.UndefOr[RandomSettings]
...
object PickImplrandomPartialPick {
  
  inline def apply(random: RandomSettings & js.UndefOr[RandomSettings]): PickImplrandomPartialPick = {
  ...
  extension [Self <: PickImplrandomPartialPick](x: Self) {
    ...
    inline def setRandom(value: RandomSettings & js.UndefOr[RandomSettings]): Self = StObject.set(x, "random", value.asInstanceOf[js.Any])
