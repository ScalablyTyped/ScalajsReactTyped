...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'total'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
trait PickImpltotalPartialPickI
  extends StObject
     with Param {
...
object PickImpltotalPartialPickI {
  ...
  extension [Self <: PickImpltotalPartialPickI](x: Self) {
