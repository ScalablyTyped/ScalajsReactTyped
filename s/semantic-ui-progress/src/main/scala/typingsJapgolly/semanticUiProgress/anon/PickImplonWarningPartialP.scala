...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'onWarning'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
trait PickImplonWarningPartialP
  extends StObject
     with Param {
...
object PickImplonWarningPartialP {
  ...
  extension [Self <: PickImplonWarningPartialP](x: Self) {
