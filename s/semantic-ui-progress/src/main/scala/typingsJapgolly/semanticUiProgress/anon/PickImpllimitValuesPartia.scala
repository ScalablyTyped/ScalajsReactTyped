...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'limitValues'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
trait PickImpllimitValuesPartia
  extends StObject
     with Param {
...
object PickImpllimitValuesPartia {
  ...
  extension [Self <: PickImpllimitValuesPartia](x: Self) {
