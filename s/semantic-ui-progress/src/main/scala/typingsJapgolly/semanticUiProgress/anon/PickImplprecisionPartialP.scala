...
/* Inlined std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, 'precision'> & std.Partial<std.Pick<semantic-ui-progress.SemanticUI.ProgressSettings._Impl, keyof semantic-ui-progress.SemanticUI.ProgressSettings._Impl>> */
trait PickImplprecisionPartialP
  extends StObject
     with Param {
...
object PickImplprecisionPartialP {
  ...
  extension [Self <: PickImplprecisionPartialP](x: Self) {
