package typingsJapgolly.shelljsExecProxy.mod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.node.NodeJS.ProcessEnv
import typingsJapgolly.node.childProcessMod.ChildProcess
import typingsJapgolly.shelljs.ExecOptionsasyncfalse
import typingsJapgolly.shelljs.ExecOptionsasynctrue
...
import typingsJapgolly.shelljs.mod.ShellArray
import typingsJapgolly.shelljs.mod.ShellConfig
import typingsJapgolly.shelljs.mod.ShellString
...
import typingsJapgolly.shelljs.mod.TouchOptionsArray
import typingsJapgolly.shelljs.mod.TouchOptionsLiteral
import typingsJapgolly.shelljsExecProxy.shelljsExecProxyStrings.PlussignN
import typingsJapgolly.shelljsExecProxy.shelljsExecProxyStrings.`-N`
import typingsJapgolly.shelljsExecProxy.shelljsExecProxyStrings.`-c`
...
trait ShelljsExecProxy extends /* k */ StringDictionary[Exec] {
  ...
  /**
  	 ...
  	 */
  def ShellString(value: String): typingsJapgolly.shelljs.mod.ShellString = js.native
