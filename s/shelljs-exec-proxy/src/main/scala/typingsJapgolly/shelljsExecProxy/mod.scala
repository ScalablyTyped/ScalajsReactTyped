...
import typingsJapgolly.shelljs.mod.ExecOutputReturnValue
...
object mod extends Shortcut {
  ...
  trait ShelljsExecProxy
    ...
    def cat(files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Returns a string containing the given file, or a concatenated string
      * containing the files if more than one file is given (a new line character
      * is introduced between each file).
      ...
      *         (a new line character is introduced between each file).
      */
    def cat(files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def cd(): typingsJapgolly.shelljs.mod.ShellString = js.native
    def cd(dir: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    ...
    /**
      ...
      */
    def chmod(mode: String, file: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    def chmod(mode: Double, file: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Alters the permissions of a file or directory by either specifying the absolute
      * permissions in octal form or expressing the changes in symbols.
      *
      ...
      * @return        Object with shell exit code, stderr and stdout.
      */
    def chmod(options: String, mode: String, file: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    def chmod(options: String, mode: Double, file: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    ...
    /**
      ...
      * @return       Object with shell exit code, stderr and stdout.
      */
    def cp(options: String, source: String, dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    def cp(options: String, source: js.Array[String], dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Copies files. The wildcard `*` is accepted.
      *
      * @param source The source.
      ...
      * @return       Object with shell exit code, stderr and stdout.
      */
    def cp(source: String, dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    def cp(source: js.Array[String], dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    ...
    /**
      ...
      */
    def dirs(options: String): ShellArray | typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Displays the list of currently remembered directories.
      *
      ...
      */
    @JSName("dirs")
    def dirs_N(options: PlussignN): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Displays the list of currently remembered directories.
      *
      ...
      */
    @JSName("dirs")
    def dirs_N(options: `-N`): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
    ...
    /**
      ...
      */
    def echo(options: String, text: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Prints string to stdout, and returns string with additional utility methods like .to().
      *
      * @param text The text to print.
      * @return     Returns the string that was passed as argument.
      */
    def echo(text: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    val env: ProcessEnv = js.native
    
    def error(): typingsJapgolly.shelljs.mod.ShellString = js.native
    ...
    /**
      ...
      * @return        Returns an object containing the return code and output as string.
      */
    def exec(command: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Executes the given command synchronously.
      *
      * @param command The command to execute.
    ...
    /**
      ...
      *                or if `{async: true}` was passed, a `ChildProcess`.
      */
    def exec(command: String, options: ExecOptionsasyncfalseunde): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Executes the given command asynchronously.
      *
      * @param command The command to execute.
    ...
    /**
      ...
      *                or if `{async: true}` was passed, a `ChildProcess`.
      */
    def exec(command: String, options: ExecOptions): typingsJapgolly.shelljs.mod.ShellString | ChildProcess = js.native
    /**
      * Executes the given command synchronously.
      *
      * @param command The command to execute.
    ...
    def grep(options: String, regex_filter: String, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Reads input string from given files and returns a string containing all lines
      * of the file that match the given `regex_filter`. Wildcard `*` accepted.
      *
      ...
      * @return Returns a string containing all lines of the file that match the given regex_filter.
      */
    def grep(options: String, regex_filter: String, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def grep(options: String, regex_filter: js.RegExp, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def grep(options: String, regex_filter: js.RegExp, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def grep(regex_filter: String, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Reads input string from given files and returns a string containing all lines
      * of the file that match the given `regex_filter`. Wildcard `*` accepted.
      *
      ...
      * @return             Returns a string containing all lines of the file that match the given `regex_filter`.
      */
    def grep(regex_filter: String, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def grep(regex_filter: js.RegExp, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def grep(regex_filter: js.RegExp, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def head(files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def head(files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def head(options: HeadOptions, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def head(options: HeadOptions, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    ...
    /**
      ...
      * @return       Object with shell exit code, stderr and stdout.
      */
    def ln(options: String, source: String, dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Links source to dest. Use `-f` to force the link, should dest already exist.
      *
      * @param source The source.
      ...
      * @return       Object with shell exit code, stderr and stdout.
      */
    def ln(source: String, dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    ...
    def mkdir(dir: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Creates directories.
      *
      ...
      * @return    Object with shell exit code, stderr and stdout.
      */
    def mkdir(dir: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def mkdir(options: String, dir: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Creates directories.
      *
      * @param options Available options:
      ...
      * @return        Object with shell exit code, stderr and stdout.
      */
    def mkdir(options: String, dir: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    ...
    /**
      ...
      * @return       Object with shell exit code, stderr and stdout.
      */
    def mv(options: String, source: String, dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    def mv(options: String, source: js.Array[String], dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Moves files. The wildcard `*` is accepted.
      *
      * @param source The source.
      ...
      * @return       Object with shell exit code, stderr and stdout.
      */
    def mv(source: String, dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    def mv(source: js.Array[String], dest: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    ...
    def pwd(): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def rm(files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      ...
      * @return      Object with shell exit code, stderr and stdout.
      */
    def rm(files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def rm(options: String, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Removes files. The wildcard `*` is accepted.
      *
      * @param options Available options:
      ...
      * @return        Object with shell exit code, stderr and stdout.
      */
    def rm(options: String, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def sed(options: String, searchRegex: String, replacement: String, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Reads an input string from file and performs a JavaScript `replace()`
      * on the input using the given search regex and replacement string or function.
      *
      ...
      * @return            The new string after replacement.
      */
    def sed(options: String, searchRegex: String, replacement: String, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def sed(options: String, searchRegex: js.RegExp, replacement: String, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def sed(options: String, searchRegex: js.RegExp, replacement: String, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def sed(searchRegex: String, replacement: String, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Reads an input string from file and performs a JavaScript `replace()`
      * on the input using the given search regex and replacement string or function.
      *
      ...
      * @return            The new string after replacement.
      */
    def sed(searchRegex: String, replacement: String, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def sed(searchRegex: js.RegExp, replacement: String, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def sed(searchRegex: js.RegExp, replacement: String, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def set(options: String): Unit = js.native
    
    def sort(files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Return the contents of the files, sorted line-by-line.
      * Sorting multiple files mixes their content (just as unix sort does).
      */
    def sort(files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def sort(options: String, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Return the contents of the files, sorted line-by-line.
      * Sorting multiple files mixes their content (just as unix sort does).
      *
      ...
      *        - `-n`: Compare according to numerical value
      */
    def sort(options: String, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def tail(files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def tail(files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def tail(options: TailOptions, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def tail(options: TailOptions, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def tempdir(): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def test(option: TestOptions, path: String): Boolean = js.native
    
    def touch(files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def touch(files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def touch(options: TouchOptionsArray, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def touch(options: TouchOptionsArray, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    def touch(options: TouchOptionsLiteral, files: String*): typingsJapgolly.shelljs.mod.ShellString = js.native
    def touch(options: TouchOptionsLiteral, files: js.Array[String]): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    /**
      * Filter adjacent matching lines from input.
      */
    def uniq(input: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    /**
      * Filter adjacent matching lines from input.
      *
      * @param options Available options:
      ...
      *        - `-d`: Only print duplicate lines, one for each group of identical lines
      */
    def uniq(options: String, input: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    def uniq(options: String, input: String, output: String): typingsJapgolly.shelljs.mod.ShellString = js.native
    
    def which(command: String): typingsJapgolly.shelljs.mod.ShellString | Null = js.native
  }
