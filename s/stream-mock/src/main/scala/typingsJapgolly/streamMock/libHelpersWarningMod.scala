...
object libHelpersWarningMod {
  ...
  object WARNING_TYPES extends StObject {
    ...
    sealed trait DEPRECATED
      extends StObject
         with WARNING_TYPES
    /* "DeprecationWarning" */ val DEPRECATED: typingsJapgolly.streamMock.libHelpersWarningMod.WARNING_TYPES.DEPRECATED & String = js.native
  }
