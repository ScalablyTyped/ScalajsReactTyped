...
object libDuplexDuplexMockMod {
  ...
  - typingsJapgolly.streamMock.libReadableIreadablemockMod.IReadableMock because Inheritance from two classes. Inlined it
  - typingsJapgolly.streamMock.libWritableIwritablemockMod.IWritableMock because Inheritance from two classes. Inlined data, flatData */ @js.native
  trait DuplexMock
    extends Duplex
       with ReadableStream {
