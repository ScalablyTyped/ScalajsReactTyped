  ...
  object PartialMessageEventany {
    ...
    extension [Self <: PartialMessageEventany](x: Self) {
      ...
      inline def setInitMessageEvent(
        value: (/* type */ String, /* bubbles */ js.UndefOr[Boolean], /* cancelable */ js.UndefOr[Boolean], /* data */ js.UndefOr[Any], /* origin */ js.UndefOr[String], /* lastEventId */ js.UndefOr[String], /* source */ js.UndefOr[MessageEventSource | Null], /* ports */ js.UndefOr[js.Array[MessagePort]]) => Callback
      ): Self = StObject.set(x, "initMessageEvent", js.Any.fromFunction8((t0: /* type */ String, t1: /* bubbles */ js.UndefOr[Boolean], t2: /* cancelable */ js.UndefOr[Boolean], t3: /* data */ js.UndefOr[Any], t4: /* origin */ js.UndefOr[String], t5: /* lastEventId */ js.UndefOr[String], t6: /* source */ js.UndefOr[MessageEventSource | Null], t7: /* ports */ js.UndefOr[js.Array[MessagePort]]) => (value(t0, t1, t2, t3, t4, t5, t6, t7)).runNow()))
