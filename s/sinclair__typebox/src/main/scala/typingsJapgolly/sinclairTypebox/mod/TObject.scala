...
- typingsJapgolly.sinclairTypebox.mod.ObjectOptions because var conflicts: $id, $schema, default, description, examples, title. Inlined additionalProperties, minProperties, maxProperties */ @js.native
