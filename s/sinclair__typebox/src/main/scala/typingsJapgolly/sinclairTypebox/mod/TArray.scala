...
import typingsJapgolly.sinclairTypebox.sinclairTypeboxStrings.array
...
- typingsJapgolly.sinclairTypebox.mod.ArrayOptions because var conflicts: $id, $schema, default, description, examples, title. Inlined uniqueItems, minItems, maxItems */ @js.native
