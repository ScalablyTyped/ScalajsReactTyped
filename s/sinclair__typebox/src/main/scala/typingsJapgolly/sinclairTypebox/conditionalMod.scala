...
import typingsJapgolly.sinclairTypebox.conditionalConditionalMod.TExclude
import typingsJapgolly.sinclairTypebox.conditionalConditionalMod.TExtends
import typingsJapgolly.sinclairTypebox.conditionalConditionalMod.TExtract
import typingsJapgolly.sinclairTypebox.conditionalStructuralMod.StructuralResult
import typingsJapgolly.sinclairTypebox.mod.SchemaOptions
import typingsJapgolly.sinclairTypebox.mod.TSchema
import typingsJapgolly.sinclairTypebox.mod.TUnion
...
object conditionalMod {
  ...
  object StructuralResult extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.sinclairTypebox.conditionalStructuralMod.StructuralResult & Double
      ] = js.native
    
    /* 2 */ val False: typingsJapgolly.sinclairTypebox.conditionalStructuralMod.StructuralResult.False & Double = js.native
    
    /* 1 */ val True: typingsJapgolly.sinclairTypebox.conditionalStructuralMod.StructuralResult.True & Double = js.native
    
    /* 0 */ val Union: typingsJapgolly.sinclairTypebox.conditionalStructuralMod.StructuralResult.Union & Double = js.native
  }
}
