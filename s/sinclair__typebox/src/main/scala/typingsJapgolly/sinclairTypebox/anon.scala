...
import typingsJapgolly.sinclairTypebox.mod.TModifier
...
object anon {
  ...
  trait `0` extends StObject {
    ...
    var const: typingsJapgolly.sinclairTypebox.sinclairTypeboxInts.`1`
  }
  object `0` {
    ...
    extension [Self <: `0`](x: Self) {
      ...
      inline def setConst(value: typingsJapgolly.sinclairTypebox.sinclairTypeboxInts.`1`): Self = StObject.set(x, "const", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Const extends StObject {
    ...
    var const: typingsJapgolly.sinclairTypebox.sinclairTypeboxInts.`0`
  }
  object Const {
    ...
    extension [Self <: Const](x: Self) {
      ...
      inline def setConst(value: typingsJapgolly.sinclairTypebox.sinclairTypeboxInts.`0`): Self = StObject.set(x, "const", value.asInstanceOf[js.Any])
    }
  }
