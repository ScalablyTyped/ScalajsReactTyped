...
import typingsJapgolly.sinclairTypebox.sinclairTypeboxStrings.delete
import typingsJapgolly.sinclairTypebox.sinclairTypeboxStrings.insert
import typingsJapgolly.sinclairTypebox.sinclairTypeboxStrings.update
...
object valueDeltaMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sinclairTypebox.valueDeltaMod.Insert[T]
    - typingsJapgolly.sinclairTypebox.valueDeltaMod.Update[T]
    - typingsJapgolly.sinclairTypebox.valueDeltaMod.Delete[T]
  */
  trait Edit[T] extends StObject
  object Edit {
    
    inline def Delete[T](brand: T, path: String): typingsJapgolly.sinclairTypebox.valueDeltaMod.Delete[T] = {
      val __obj = js.Dynamic.literal(brand = brand.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("delete")
      __obj.asInstanceOf[typingsJapgolly.sinclairTypebox.valueDeltaMod.Delete[T]]
    }
    
    inline def Insert[T](brand: T, path: String, value: Any): typingsJapgolly.sinclairTypebox.valueDeltaMod.Insert[T] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.sinclairTypebox.valueDeltaMod.Insert[T]]
    }
    
    inline def Update[T](brand: T, path: String, value: Any): typingsJapgolly.sinclairTypebox.valueDeltaMod.Update[T] = {
      val __obj = js.Dynamic.literal(brand = brand.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("update")
      __obj.asInstanceOf[typingsJapgolly.sinclairTypebox.valueDeltaMod.Update[T]]
    }
  }
