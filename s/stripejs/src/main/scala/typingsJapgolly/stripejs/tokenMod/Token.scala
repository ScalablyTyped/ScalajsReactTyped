...
import typingsJapgolly.stripejs.customerMod.BankAccount
import typingsJapgolly.stripejs.customerMod.Card
import typingsJapgolly.stripejs.stripejsStrings.account
