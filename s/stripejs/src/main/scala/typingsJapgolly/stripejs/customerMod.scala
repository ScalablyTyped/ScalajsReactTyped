...
object customerMod {
  ...
  */
  ...
  object checkStatus {
    ...
    inline def pass: typingsJapgolly.stripejs.stripejsStrings.pass = "pass".asInstanceOf[typingsJapgolly.stripejs.stripejsStrings.pass]
    
    inline def unavailable: typingsJapgolly.stripejs.stripejsStrings.unavailable = "unavailable".asInstanceOf[typingsJapgolly.stripejs.stripejsStrings.unavailable]
    
    inline def unchecked: typingsJapgolly.stripejs.stripejsStrings.unchecked = "unchecked".asInstanceOf[typingsJapgolly.stripejs.stripejsStrings.unchecked]
  }
}
