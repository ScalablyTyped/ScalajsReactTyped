...
import typingsJapgolly.stripejs.anon.Base
import typingsJapgolly.stripejs.anon.Complete
import typingsJapgolly.stripejs.anon.Empty
import typingsJapgolly.stripejs.anon.Focus
import typingsJapgolly.stripejs.anon.PreventDefault
...
object elementMod {
  ...
  */
  ...
  object ElementType {
    ...
    inline def cardCvc: typingsJapgolly.stripejs.stripejsStrings.cardCvc = "cardCvc".asInstanceOf[typingsJapgolly.stripejs.stripejsStrings.cardCvc]
    
    inline def cardExpiry: typingsJapgolly.stripejs.stripejsStrings.cardExpiry = "cardExpiry".asInstanceOf[typingsJapgolly.stripejs.stripejsStrings.cardExpiry]
    
    inline def cardNumber: typingsJapgolly.stripejs.stripejsStrings.cardNumber = "cardNumber".asInstanceOf[typingsJapgolly.stripejs.stripejsStrings.cardNumber]
    
    inline def paymentRequestButton: typingsJapgolly.stripejs.stripejsStrings.paymentRequestButton = "paymentRequestButton".asInstanceOf[typingsJapgolly.stripejs.stripejsStrings.paymentRequestButton]
    
    inline def postalCode: typingsJapgolly.stripejs.stripejsStrings.postalCode = "postalCode".asInstanceOf[typingsJapgolly.stripejs.stripejsStrings.postalCode]
  }
