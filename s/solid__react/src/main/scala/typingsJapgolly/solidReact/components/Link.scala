...
import typingsJapgolly.solidReact.hrefstringHTMLAttributesH
...
object Link {
  def apply(
    ...
    typingsJapgolly.solidReact.mod.Link, 
    Unit, 
    hrefstringHTMLAttributesH
  ] = {
  ...
  typingsJapgolly.solidReact.hrefstringHTMLAttributesH, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.solidReact.mod.Link](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.solidReact.hrefstringHTMLAttributesH])(children: _*)
  }
