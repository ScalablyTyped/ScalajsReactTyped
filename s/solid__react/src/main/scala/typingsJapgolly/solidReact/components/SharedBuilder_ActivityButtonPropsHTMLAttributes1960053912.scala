...
@scala.inline
open class SharedBuilder_ActivityButtonPropsHTMLAttributes1960053912[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def activateLabel(value: String | (js.Tuple3[String, String, Node])): this.type = set("activateLabel", value.asInstanceOf[js.Any])
  
  inline def activateText(value: String): this.type = set("activateText", value.asInstanceOf[js.Any])
  ...
  inline def deactivateLabel(value: String | (js.Tuple3[String, String, Node])): this.type = set("deactivateLabel", value.asInstanceOf[js.Any])
  
  inline def deactivateText(value: String): this.type = set("deactivateText", value.asInstanceOf[js.Any])
  ...
  inline def `object`(value: String): this.type = set("object", value.asInstanceOf[js.Any])
  ...
  inline def shortName(value: String): this.type = set("shortName", value.asInstanceOf[js.Any])
