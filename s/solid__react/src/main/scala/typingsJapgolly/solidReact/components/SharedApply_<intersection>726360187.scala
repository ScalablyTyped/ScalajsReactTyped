...
abstract class `SharedApply_<intersection>726360187`[ComponentRef] () {
  ...
  def apply(
    ...
    ActivityButtonProps with HTMLAttributes[HTMLButtonElement], 
    ComponentRef, 
    Unit, 
    ActivityButtonProps with HTMLAttributes[HTMLButtonElement]
  ] = {
  ...
  typingsJapgolly.solidReact.mod.ActivityButtonProps with typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLButtonElement], 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.solidReact.mod.ActivityButtonProps with typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLButtonElement]])(children: _*)
  }
}
