...
import typingsJapgolly.solidReact.anon.srcstringdefaultSrcstring
import typingsJapgolly.solidReact.solidReactBooleans.`false`
import typingsJapgolly.solidReact.solidReactBooleans.`true`
...
object mod {
  ...
  object ActivityButtonProps {
    ...
    extension [Self <: ActivityButtonProps](x: Self) {
      ...
      inline def setActivateLabel(value: String | (js.Tuple3[String, String, Node])): Self = StObject.set(x, "activateLabel", value.asInstanceOf[js.Any])
      ...
      inline def setDeactivateLabel(value: String | (js.Tuple3[String, String, Node])): Self = StObject.set(x, "deactivateLabel", value.asInstanceOf[js.Any])
