...
import typingsJapgolly.simonwepSelectionJs.simonwepSelectionJsStrings.beforestart
import typingsJapgolly.simonwepSelectionJs.simonwepSelectionJsStrings.move
import typingsJapgolly.simonwepSelectionJs.simonwepSelectionJsStrings.start
import typingsJapgolly.simonwepSelectionJs.simonwepSelectionJsStrings.stop
