...
object EventTarget {
  ...
  extension [Self <: EventTarget[?], Events /* <: EventMap */](x: Self & EventTarget[Events]) {
    ...
    inline def setUnbindAllListeners(value: Callback): Self = StObject.set(x, "unbindAllListeners", value.toJsFn)
