...
import typingsJapgolly.stylelint.mod.FormatterType
import typingsJapgolly.stylelint.mod.SyntaxType
...
object PartialLinterOptions {
  ...
  def apply(
    ...
    if (!js.isUndefined(disableDefaultIgnores)) __obj.updateDynamic("disableDefaultIgnores")(disableDefaultIgnores.asInstanceOf[js.Any])
    if (files != null) __obj.updateDynamic("files")(files.asInstanceOf[js.Any])
    if (!js.isUndefined(fix)) __obj.updateDynamic("fix")(fix.asInstanceOf[js.Any])
    if (formatter != null) __obj.updateDynamic("formatter")(formatter.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreDisables)) __obj.updateDynamic("ignoreDisables")(ignoreDisables.asInstanceOf[js.Any])
    if (ignorePath != null) __obj.updateDynamic("ignorePath")(ignorePath.asInstanceOf[js.Any])
    if (maxWarnings != null) __obj.updateDynamic("maxWarnings")(maxWarnings.asInstanceOf[js.Any])
    if (!js.isUndefined(reportNeedlessDisables)) __obj.updateDynamic("reportNeedlessDisables")(reportNeedlessDisables.asInstanceOf[js.Any])
