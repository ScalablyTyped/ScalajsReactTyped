...
/* Inlined std.Omit<stylelint.stylelint.LinterOptions, 'syntax' | 'customSyntax'> */
trait OmitLinterOptionssyntaxcu
  extends StObject
  ...
  var config: js.UndefOr[typingsJapgolly.stylelint.mod.Config] = js.undefined
...
object OmitLinterOptionssyntaxcu {
  
  inline def apply(): OmitLinterOptionssyntaxcu = {
