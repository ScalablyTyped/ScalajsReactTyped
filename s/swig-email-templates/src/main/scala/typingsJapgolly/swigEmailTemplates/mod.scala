...
import typingsJapgolly.swigEmailTemplates.anon.Html
...
object mod {
  ...
  object SwigEmailTemplatesOptions {
    ...
    extension [Self <: SwigEmailTemplatesOptions](x: Self) {
      ...
      inline def setRewrite(value: /* $ */ JQueryStatic => Callback): Self = StObject.set(x, "rewrite", js.Any.fromFunction1((t0: /* $ */ JQueryStatic) => value(t0).runNow()))
