...
object EControllerLayoutType extends StObject {
  ...
  /* 0 */ val Phone: typingsJapgolly.steamUser.mod.EControllerLayoutType.Phone & Double = js.native
  
  @js.native
  sealed trait Tablet
    extends StObject
       with EControllerLayoutType
  /* 1 */ val Tablet: typingsJapgolly.steamUser.mod.EControllerLayoutType.Tablet & Double = js.native
}
