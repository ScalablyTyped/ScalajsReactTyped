...
object EIntroducerRouting extends StObject {
  ...
  /* 0 */ val FileShare: typingsJapgolly.steamUser.mod.EIntroducerRouting.FileShare & Double = js.native
  
  @js.native
  sealed trait P2PNetworking
    extends StObject
       with EIntroducerRouting
  /* 2 */ val P2PNetworking: typingsJapgolly.steamUser.mod.EIntroducerRouting.P2PNetworking & Double = js.native
  
  @js.native
  sealed trait P2PVoiceChat
    extends StObject
       with EIntroducerRouting
  /* 1 */ val P2PVoiceChat: typingsJapgolly.steamUser.mod.EIntroducerRouting.P2PVoiceChat & Double = js.native
}
