...
trait Events extends StObject {
  ...
  // not sure
  var friendRelationship: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* relationship */ EFriendRelationship]
  ...
  var group: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* group */ Record[String, Any]]
  
  // not sure
  var groupAnnouncement: js.Tuple3[
  ...
  var groupRelationship: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* relationship */ EClanRelationship]
  
  var licenses: js.Array[/* licenses */ js.Array[Record[String, Any]]]
  
  var lobbyInvite: js.Tuple2[
  ...
  var nickname: js.Tuple2[/* steamID */ typingsJapgolly.steamid.mod.^, /* newNickname */ String | Null]
  
  var nicknameList: js.Array[Any]
  
  var offlineMessages: js.Tuple2[/* count */ Double, /* friends */ js.Array[typingsJapgolly.steamid.mod.^]]
  ...
  var tradeStarted: js.Array[/* steamID */ typingsJapgolly.steamid.mod.^]
  
  var user: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* user */ Record[String, Any]]
...
object Events {
  ...
  inline def apply(
    ...
    friendRelationship: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* relationship */ EFriendRelationship],
    friendsGroupList: js.Array[/* groups */ Record[String, Members]],
    friendsList: js.Array[Any],
    gifts: js.Array[/* gifts */ js.Array[Gift]],
    group: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* group */ Record[String, Any]],
    groupAnnouncement: js.Tuple3[
      /* sid */ typingsJapgolly.steamid.mod.^, 
      /* headline */ String, 
      /* gid */ Double | String
    ],
    ...
    groupRelationship: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* relationship */ EClanRelationship],
    licenses: js.Array[/* licenses */ js.Array[Record[String, Any]]],
    lobbyInvite: js.Tuple2[
      /* inviterID */ typingsJapgolly.steamid.mod.^, 
      /* lobbyID */ typingsJapgolly.steamid.mod.^
    ],
    ...
    nickname: js.Tuple2[/* steamID */ typingsJapgolly.steamid.mod.^, /* newNickname */ String | Null],
    nicknameList: js.Array[Any],
    offlineMessages: js.Tuple2[/* count */ Double, /* friends */ js.Array[typingsJapgolly.steamid.mod.^]],
    ...
    tradeStarted: js.Array[/* steamID */ typingsJapgolly.steamid.mod.^],
    user: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* user */ Record[String, Any]],
  ...
  extension [Self <: Events](x: Self) {
    ...
    inline def setFriendRelationship(value: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* relationship */ EFriendRelationship]): Self = StObject.set(x, "friendRelationship", value.asInstanceOf[js.Any])
    ...
    inline def setGroup(value: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* group */ Record[String, Any]]): Self = StObject.set(x, "group", value.asInstanceOf[js.Any])
    ...
    inline def setGroupRelationship(value: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* relationship */ EClanRelationship]): Self = StObject.set(x, "groupRelationship", value.asInstanceOf[js.Any])
    ...
    inline def setLobbyInvite(
      value: js.Tuple2[
          /* inviterID */ typingsJapgolly.steamid.mod.^, 
          /* lobbyID */ typingsJapgolly.steamid.mod.^
        ]
    ): Self = StObject.set(x, "lobbyInvite", value.asInstanceOf[js.Any])
    ...
    inline def setNickname(value: js.Tuple2[/* steamID */ typingsJapgolly.steamid.mod.^, /* newNickname */ String | Null]): Self = StObject.set(x, "nickname", value.asInstanceOf[js.Any])
    ...
    inline def setOfflineMessages(value: js.Tuple2[/* count */ Double, /* friends */ js.Array[typingsJapgolly.steamid.mod.^]]): Self = StObject.set(x, "offlineMessages", value.asInstanceOf[js.Any])
    ...
    inline def setTradeStarted(value: js.Array[/* steamID */ typingsJapgolly.steamid.mod.^]): Self = StObject.set(x, "tradeStarted", value.asInstanceOf[js.Any])
    
    inline def setTradeStartedVarargs(value: (/* steamID */ typingsJapgolly.steamid.mod.^)*): Self = StObject.set(x, "tradeStarted", js.Array(value*))
    
    inline def setUser(value: js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* user */ Record[String, Any]]): Self = StObject.set(x, "user", value.asInstanceOf[js.Any])
