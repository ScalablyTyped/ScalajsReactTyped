...
trait Device extends StObject {
  ...
  var lastBorrower: typingsJapgolly.steamid.mod.^ | Null
...
object Device {
  ...
  extension [Self <: Device](x: Self) {
    ...
    inline def setLastBorrower(value: typingsJapgolly.steamid.mod.^): Self = StObject.set(x, "lastBorrower", value.asInstanceOf[js.Any])
