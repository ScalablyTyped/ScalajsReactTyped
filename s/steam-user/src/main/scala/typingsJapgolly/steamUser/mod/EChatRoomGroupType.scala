...
object EChatRoomGroupType extends StObject {
  ...
  /* 0 */ val Default: typingsJapgolly.steamUser.mod.EChatRoomGroupType.Default & Double = js.native
  
  @js.native
  sealed trait Unmoderated
    extends StObject
       with EChatRoomGroupType
  /* 1 */ val Unmoderated: typingsJapgolly.steamUser.mod.EChatRoomGroupType.Unmoderated & Double = js.native
}
