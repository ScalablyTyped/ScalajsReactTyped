...
object ETradeOfferConfirmationMethod extends StObject {
  ...
  /* 1 */ val Email: typingsJapgolly.steamUser.mod.ETradeOfferConfirmationMethod.Email & Double = js.native
  
  @js.native
  sealed trait Invalid
    extends StObject
       with ETradeOfferConfirmationMethod
  /* 0 */ val Invalid: typingsJapgolly.steamUser.mod.ETradeOfferConfirmationMethod.Invalid & Double = js.native
  
  @js.native
  sealed trait MobileApp
    extends StObject
       with ETradeOfferConfirmationMethod
  /* 2 */ val MobileApp: typingsJapgolly.steamUser.mod.ETradeOfferConfirmationMethod.MobileApp & Double = js.native
}
