...
object EStreamingDataType extends StObject {
  ...
  /* 0 */ val AudioData: typingsJapgolly.steamUser.mod.EStreamingDataType.AudioData & Double = js.native
  
  @js.native
  sealed trait MicrophoneData
    extends StObject
       with EStreamingDataType
  /* 2 */ val MicrophoneData: typingsJapgolly.steamUser.mod.EStreamingDataType.MicrophoneData & Double = js.native
  
  @js.native
  sealed trait VideoData
    extends StObject
       with EStreamingDataType
  /* 1 */ val VideoData: typingsJapgolly.steamUser.mod.EStreamingDataType.VideoData & Double = js.native
}
