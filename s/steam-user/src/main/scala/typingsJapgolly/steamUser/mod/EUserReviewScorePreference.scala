...
object EUserReviewScorePreference extends StObject {
  ...
  /* 2 */ val ExcludeBombs: typingsJapgolly.steamUser.mod.EUserReviewScorePreference.ExcludeBombs & Double = js.native
  
  @js.native
  sealed trait IncludeAll
    extends StObject
       with EUserReviewScorePreference
  /* 1 */ val IncludeAll: typingsJapgolly.steamUser.mod.EUserReviewScorePreference.IncludeAll & Double = js.native
  
  @js.native
  sealed trait Unset
    extends StObject
       with EUserReviewScorePreference
  /* 0 */ val Unset: typingsJapgolly.steamUser.mod.EUserReviewScorePreference.Unset & Double = js.native
}
