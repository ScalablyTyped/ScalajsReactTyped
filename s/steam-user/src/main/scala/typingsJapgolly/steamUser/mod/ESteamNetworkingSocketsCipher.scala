...
object ESteamNetworkingSocketsCipher extends StObject {
  ...
  /* 2 */ val AES_256_GCM: typingsJapgolly.steamUser.mod.ESteamNetworkingSocketsCipher.AES_256_GCM & Double = js.native
  
  @js.native
  sealed trait INVALID
    extends StObject
       with ESteamNetworkingSocketsCipher
  /* 0 */ val INVALID: typingsJapgolly.steamUser.mod.ESteamNetworkingSocketsCipher.INVALID & Double = js.native
  
  @js.native
  sealed trait NULL
    extends StObject
       with ESteamNetworkingSocketsCipher
  /* 1 */ val NULL: typingsJapgolly.steamUser.mod.ESteamNetworkingSocketsCipher.NULL & Double = js.native
}
