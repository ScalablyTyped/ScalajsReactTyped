...
trait QuickInviteLinkValidity extends StObject {
  ...
  var steamid: typingsJapgolly.steamid.mod.^
  
  var valid: Boolean
}
object QuickInviteLinkValidity {
  
  inline def apply(steamid: typingsJapgolly.steamid.mod.^, valid: Boolean): QuickInviteLinkValidity = {
  ...
  extension [Self <: QuickInviteLinkValidity](x: Self) {
    ...
    inline def setSteamid(value: typingsJapgolly.steamid.mod.^): Self = StObject.set(x, "steamid", value.asInstanceOf[js.Any])
