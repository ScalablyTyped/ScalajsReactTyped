...
object EWorkshopFileAction extends StObject {
  ...
  /* 1 */ val Completed: typingsJapgolly.steamUser.mod.EWorkshopFileAction.Completed & Double = js.native
  
  @js.native
  sealed trait Played
    extends StObject
       with EWorkshopFileAction
  /* 0 */ val Played: typingsJapgolly.steamUser.mod.EWorkshopFileAction.Played & Double = js.native
}
