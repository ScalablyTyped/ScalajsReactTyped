...
object EStreamDiscoveryMessage extends StObject {
  ...
  /* 1 */ val PingRequest: typingsJapgolly.steamUser.mod.EStreamDiscoveryMessage.PingRequest & Double = js.native
  
  @js.native
  sealed trait PingResponse
    extends StObject
       with EStreamDiscoveryMessage
  /* 2 */ val PingResponse: typingsJapgolly.steamUser.mod.EStreamDiscoveryMessage.PingResponse & Double = js.native
}
