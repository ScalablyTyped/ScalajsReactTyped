...
object EStreamBitrate extends StObject {
  ...
  sealed trait Autodetect
    extends StObject
       with EStreamBitrate
  /* -1 */ val Autodetect: typingsJapgolly.steamUser.mod.EStreamBitrate.Autodetect & Double = js.native
  
  @js.native
  sealed trait Unlimited
    extends StObject
       with EStreamBitrate
  /* 0 */ val Unlimited: typingsJapgolly.steamUser.mod.EStreamBitrate.Unlimited & Double = js.native
}
