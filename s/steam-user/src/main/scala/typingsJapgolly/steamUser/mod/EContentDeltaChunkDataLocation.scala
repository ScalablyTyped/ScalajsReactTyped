...
object EContentDeltaChunkDataLocation extends StObject {
  ...
  /* 1 */ val AfterProtobuf: typingsJapgolly.steamUser.mod.EContentDeltaChunkDataLocation.AfterProtobuf & Double = js.native
  
  @js.native
  sealed trait InProtobuf
    extends StObject
       with EContentDeltaChunkDataLocation
  /* 0 */ val InProtobuf: typingsJapgolly.steamUser.mod.EContentDeltaChunkDataLocation.InProtobuf & Double = js.native
}
