...
object EStreamHostPlayAudioPreference extends StObject {
  ...
  /* 1 */ val k_EStreamHostPlayAudioAlways: typingsJapgolly.steamUser.mod.EStreamHostPlayAudioPreference.k_EStreamHostPlayAudioAlways & Double = js.native
  
  @js.native
  sealed trait k_EStreamHostPlayAudioDefault
    extends StObject
       with EStreamHostPlayAudioPreference
  /* 0 */ val k_EStreamHostPlayAudioDefault: typingsJapgolly.steamUser.mod.EStreamHostPlayAudioPreference.k_EStreamHostPlayAudioDefault & Double = js.native
}
