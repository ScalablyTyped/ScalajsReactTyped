...
object EStreamVersion extends StObject {
  ...
  sealed trait Current
    extends StObject
       with EStreamVersion
  /* 1 */ val Current: typingsJapgolly.steamUser.mod.EStreamVersion.Current & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with EStreamVersion
  /* 0 */ val None: typingsJapgolly.steamUser.mod.EStreamVersion.None & Double = js.native
}
