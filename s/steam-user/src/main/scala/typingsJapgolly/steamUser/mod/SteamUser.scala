...
import typingsJapgolly.steamUser.anon.Adress
import typingsJapgolly.steamUser.anon.Append
import typingsJapgolly.steamUser.anon.Appids
import typingsJapgolly.steamUser.anon.Apps
import typingsJapgolly.steamUser.anon.Balance
import typingsJapgolly.steamUser.anon.Classid
import typingsJapgolly.steamUser.anon.Descriptions
import typingsJapgolly.steamUser.anon.DeviceToken
import typingsJapgolly.steamUser.anon.Devices
import typingsJapgolly.steamUser.anon.Emoticons
import typingsJapgolly.steamUser.anon.EncryptedAppTicket
import typingsJapgolly.steamUser.anon.ErroreresultEResult
import typingsJapgolly.steamUser.anon.Flags
import typingsJapgolly.steamUser.anon.FoilBadgeLavel
import typingsJapgolly.steamUser.anon.Friends
import typingsJapgolly.steamUser.anon.GrantedAppIds
import typingsJapgolly.steamUser.anon.GroupID
import typingsJapgolly.steamUser.anon.IncludeCanceled
import typingsJapgolly.steamUser.anon.IncludeCancelled
import typingsJapgolly.steamUser.anon.Language
import typingsJapgolly.steamUser.anon.Members
import typingsJapgolly.steamUser.anon.Name
import typingsJapgolly.steamUser.anon.Nicknames
import typingsJapgolly.steamUser.anon.PackageList
import typingsJapgolly.steamUser.anon.PersonaName
import typingsJapgolly.steamUser.anon.Personas
import typingsJapgolly.steamUser.anon.PlayerCount
import typingsJapgolly.steamUser.anon.PlayingApp
import typingsJapgolly.steamUser.anon.Servers
import typingsJapgolly.steamUser.anon.ServersRecord
import typingsJapgolly.steamUser.anon.Tags
import typingsJapgolly.steamUser.anon.Tokens
import typingsJapgolly.steamUser.anon.Users
import typingsJapgolly.steamUser.steamUserStrings.`steam-user`
import typingsJapgolly.steamUser.steamUserStrings.accountInfo
import typingsJapgolly.steamUser.steamUserStrings.accountLimitations
import typingsJapgolly.steamUser.steamUserStrings.additionalHeaders
import typingsJapgolly.steamUser.steamUserStrings.appLaunched
import typingsJapgolly.steamUser.steamUserStrings.appOwnershipCached
import typingsJapgolly.steamUser.steamUserStrings.appQuit
import typingsJapgolly.steamUser.steamUserStrings.appUpdate
import typingsJapgolly.steamUser.steamUserStrings.autoRelogin
import typingsJapgolly.steamUser.steamUserStrings.changelist
import typingsJapgolly.steamUser.steamUserStrings.changelistUpdateInterval
import typingsJapgolly.steamUser.steamUserStrings.communityMessages
import typingsJapgolly.steamUser.steamUserStrings.dataDirectory
import typingsJapgolly.steamUser.steamUserStrings.disconnected
import typingsJapgolly.steamUser.steamUserStrings.emailInfo
import typingsJapgolly.steamUser.steamUserStrings.enablePicsCache
import typingsJapgolly.steamUser.steamUserStrings.error
import typingsJapgolly.steamUser.steamUserStrings.friendPersonasLoad
import typingsJapgolly.steamUser.steamUserStrings.friendRelationship
import typingsJapgolly.steamUser.steamUserStrings.friendsGroupList
import typingsJapgolly.steamUser.steamUserStrings.friendsList
import typingsJapgolly.steamUser.steamUserStrings.gifts
import typingsJapgolly.steamUser.steamUserStrings.group
import typingsJapgolly.steamUser.steamUserStrings.groupAnnouncement
import typingsJapgolly.steamUser.steamUserStrings.groupEvent
import typingsJapgolly.steamUser.steamUserStrings.groupList
import typingsJapgolly.steamUser.steamUserStrings.groupRelationship
import typingsJapgolly.steamUser.steamUserStrings.httpProxy
import typingsJapgolly.steamUser.steamUserStrings.language
import typingsJapgolly.steamUser.steamUserStrings.licenses
import typingsJapgolly.steamUser.steamUserStrings.lobbyInvite
import typingsJapgolly.steamUser.steamUserStrings.localAddress
import typingsJapgolly.steamUser.steamUserStrings.localPort
import typingsJapgolly.steamUser.steamUserStrings.loggedOn
import typingsJapgolly.steamUser.steamUserStrings.loginKey
import typingsJapgolly.steamUser.steamUserStrings.machineIdFormat
import typingsJapgolly.steamUser.steamUserStrings.machineIdType
import typingsJapgolly.steamUser.steamUserStrings.marketingMessages
import typingsJapgolly.steamUser.steamUserStrings.newComments
import typingsJapgolly.steamUser.steamUserStrings.newItems
import typingsJapgolly.steamUser.steamUserStrings.nickname
import typingsJapgolly.steamUser.steamUserStrings.nicknameList
import typingsJapgolly.steamUser.steamUserStrings.offlineMessages
import typingsJapgolly.steamUser.steamUserStrings.ownershipCached
import typingsJapgolly.steamUser.steamUserStrings.ownershipFilter
import typingsJapgolly.steamUser.steamUserStrings.packageUpdate
import typingsJapgolly.steamUser.steamUserStrings.picsCacheAll
import typingsJapgolly.steamUser.steamUserStrings.playingState
import typingsJapgolly.steamUser.steamUserStrings.protocol
import typingsJapgolly.steamUser.steamUserStrings.receivedFromGC
import typingsJapgolly.steamUser.steamUserStrings.saveAppTickets
import typingsJapgolly.steamUser.steamUserStrings.sentry
import typingsJapgolly.steamUser.steamUserStrings.singleSentryfile
import typingsJapgolly.steamUser.steamUserStrings.steamGuard
import typingsJapgolly.steamUser.steamUserStrings.tradeOffers
import typingsJapgolly.steamUser.steamUserStrings.tradeRequest
import typingsJapgolly.steamUser.steamUserStrings.tradeResponse
import typingsJapgolly.steamUser.steamUserStrings.tradeStarted
import typingsJapgolly.steamUser.steamUserStrings.user
import typingsJapgolly.steamUser.steamUserStrings.vacBans
import typingsJapgolly.steamUser.steamUserStrings.vanityURL
import typingsJapgolly.steamUser.steamUserStrings.wallet
import typingsJapgolly.steamUser.steamUserStrings.webCompatibilityMode
import typingsJapgolly.steamUser.steamUserStrings.webSession
...
trait SteamUser
  ...
  /**
    ...
    * @param deviceToken
    */
  def activateSharingAuthorization(ownerSteamID: typingsJapgolly.steamid.mod.^, deviceToken: String): Unit = js.native
  def activateSharingAuthorization(ownerSteamID: typingsJapgolly.steamid.mod.^, deviceToken: DeviceToken): Unit = js.native
  ...
  /**
    ...
    * @param  [callback]
    */
  def addAuthorizedBorrowers(borrowersSteamID: js.Array[typingsJapgolly.steamid.mod.^ | String]): js.Promise[Unit] = js.native
  def addAuthorizedBorrowers(
    borrowersSteamID: js.Array[typingsJapgolly.steamid.mod.^ | String],
    callback: js.Function1[/* err */ js.Error | Null, Unit]
  ): js.Promise[Unit] = js.native
  def addAuthorizedBorrowers(borrowersSteamID: typingsJapgolly.steamid.mod.^): js.Promise[Unit] = js.native
  def addAuthorizedBorrowers(
    borrowersSteamID: typingsJapgolly.steamid.mod.^,
    callback: js.Function1[/* err */ js.Error | Null, Unit]
  ): js.Promise[Unit] = js.native
  ...
  /**
    ...
    */
  def addFriend(steamID: typingsJapgolly.steamid.mod.^): js.Promise[PersonaName] = js.native
  def addFriend(
  ...
  /**
    ...
    * @param [callback]
    */
  def addFriendToGroup(groupID: Double, userSteamID: typingsJapgolly.steamid.mod.^): js.Promise[Unit] = js.native
  def addFriendToGroup(
    groupID: Double,
    userSteamID: typingsJapgolly.steamid.mod.^,
    callback: js.Function1[/* err */ js.Error | Null, Unit]
  ): js.Promise[Unit] = js.native
  ...
  /**
    ...
    */
  def blockUser(steamID: typingsJapgolly.steamid.mod.^): js.Promise[Unit] = js.native
  def blockUser(steamID: typingsJapgolly.steamid.mod.^, callback: js.Function1[/* err */ js.Error | Null, Unit]): js.Promise[Unit] = js.native
  
  def cancelTradeRequest(steamID: String): Unit = js.native
  def cancelTradeRequest(steamID: typingsJapgolly.steamid.mod.^): Unit = js.native
  ...
  /**
    ...
    */
  var chat: typingsJapgolly.steamUser.componentsChatroomMod.^ = js.native
  ...
  /**
    ...
    * @param [callback]
    */
  def getAliases(userSteamIDs: js.Array[typingsJapgolly.steamid.mod.^ | String]): js.Promise[Record[String, Name]] = js.native
  def getAliases(
    userSteamIDs: js.Array[typingsJapgolly.steamid.mod.^ | String],
  ...
  /**
    ...
    * @param [callback]
    */
  def getAuthorizedBorrowers(): js.Promise[typingsJapgolly.steamUser.anon.Borrowers] = js.native
  def getAuthorizedBorrowers(
    options: Unit,
    callback: js.Function2[
      /* err */ js.Error | Null, 
      /* response */ typingsJapgolly.steamUser.anon.Borrowers, 
      Unit
    ]
  ): js.Promise[typingsJapgolly.steamUser.anon.Borrowers] = js.native
  def getAuthorizedBorrowers(options: IncludeCanceled): js.Promise[typingsJapgolly.steamUser.anon.Borrowers] = js.native
  def getAuthorizedBorrowers(
  ...
  /**
    ...
    * @param [callback]
    */
  def getEquippedProfileItems(steamID: typingsJapgolly.steamid.mod.^): js.Promise[ProfileItems] = js.native
  def getEquippedProfileItems(
    steamID: typingsJapgolly.steamid.mod.^,
    options: Unit,
    callback: js.Function2[/* err */ js.Error | Null, /* response */ ProfileItems, Unit]
  ): js.Promise[ProfileItems] = js.native
  def getEquippedProfileItems(steamID: typingsJapgolly.steamid.mod.^, options: Language): js.Promise[ProfileItems] = js.native
  def getEquippedProfileItems(
    steamID: typingsJapgolly.steamid.mod.^,
    options: Language,
    callback: js.Function2[/* err */ js.Error | Null, /* response */ ProfileItems, Unit]
  ...
  /**
    ...
    */
  def getPersonas(steamids: js.Array[typingsJapgolly.steamid.mod.^ | String]): js.Promise[Personas] = js.native
  def getPersonas(
    steamids: js.Array[typingsJapgolly.steamid.mod.^ | String],
  ...
  /**
    ...
    * @param link
    */
  def getQuickInviteLinkSteamID(link: String): typingsJapgolly.steamid.mod.^ | Null = js.native
  ...
  /**
    ...
    * @param [callback]
    */
  def getServerIPsBySteamID(steamids: js.Array[typingsJapgolly.steamid.mod.^ | String]): js.Promise[ServersRecord] = js.native
  ...
  def getServerSteamIDsByIP(
    ...
    callback: js.Function2[
      /* err */ js.Error | Null, 
      /* servers */ Record[String, typingsJapgolly.steamid.mod.^], 
      Unit
    ]
  ...
  /**
    ...
    */
  def getSteamLevels(steamids: js.Array[typingsJapgolly.steamid.mod.^ | String]): js.Promise[Record[String, Double]] = js.native
  def getSteamLevels(
    steamids: js.Array[typingsJapgolly.steamid.mod.^ | String],
  ...
  /**
    ...
    * @param [callback]
    */
  def getUserOwnedApps(steamID: typingsJapgolly.steamid.mod.^): js.Promise[UserOwnedApps] = js.native
  def getUserOwnedApps(
    steamID: typingsJapgolly.steamid.mod.^,
    options: Unit,
    callback: js.Function2[/* err */ js.Error | Null, /* response */ UserOwnedApps, Unit]
  ): js.Promise[UserOwnedApps] = js.native
  def getUserOwnedApps(steamID: typingsJapgolly.steamid.mod.^, options: GetUserOwnedAppsOptions): js.Promise[UserOwnedApps] = js.native
  def getUserOwnedApps(
    steamID: typingsJapgolly.steamid.mod.^,
    options: GetUserOwnedAppsOptions,
    callback: js.Function2[/* err */ js.Error | Null, /* response */ UserOwnedApps, Unit]
  ...
  def inviteToGroup(usersteamID: String, groupsteamID: typingsJapgolly.steamid.mod.^): Unit = js.native
  def inviteToGroup(usersteamID: typingsJapgolly.steamid.mod.^, groupsteamID: String): Unit = js.native
  /**
    ...
    */
  def inviteToGroup(usersteamID: typingsJapgolly.steamid.mod.^, groupsteamID: typingsJapgolly.steamid.mod.^): Unit = js.native
  ...
  def off_friendRelationship(
    ...
    listener: js.Function1[
      /* args */ js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* relationship */ EFriendRelationship], 
      Unit
    ]
  ): this.type = js.native
  @JSName("off")
  ...
  def off_group(
    event: group,
    listener: js.Function1[
      /* args */ js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* group */ Record[String, Any]], 
      Unit
    ]
  ): this.type = js.native
  @JSName("off")
  def off_groupAnnouncement(
    ...
    listener: js.Function1[
      /* args */ js.Tuple3[
        /* sid */ typingsJapgolly.steamid.mod.^, 
        /* headline */ String, 
        /* gid */ Double | String
      ], 
      Unit
  ...
  def off_groupRelationship(
    ...
    listener: js.Function1[
      /* args */ js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* relationship */ EClanRelationship], 
      Unit
    ]
  ): this.type = js.native
  @JSName("off")
  ...
  def off_lobbyInvite(
    ...
    listener: js.Function1[
      /* args */ js.Tuple2[
        /* inviterID */ typingsJapgolly.steamid.mod.^, 
        /* lobbyID */ typingsJapgolly.steamid.mod.^
      ], 
      Unit
    ]
  ): this.type = js.native
  ...
  def off_nickname(
    event: nickname,
    listener: js.Function1[
      /* args */ js.Tuple2[/* steamID */ typingsJapgolly.steamid.mod.^, /* newNickname */ String | Null], 
      Unit
    ]
  ): this.type = js.native
  @JSName("off")
  ...
  def off_offlineMessages(
    ...
    listener: js.Function1[
      /* args */ js.Tuple2[/* count */ Double, /* friends */ js.Array[typingsJapgolly.steamid.mod.^]], 
      Unit
    ]
  ): this.type = js.native
  @JSName("off")
  ...
  def off_tradeStarted(
    event: tradeStarted,
    listener: js.Function1[/* args */ js.Array[/* steamID */ typingsJapgolly.steamid.mod.^], Unit]
  ): this.type = js.native
  @JSName("off")
  def off_user(
    event: user,
    listener: js.Function1[
      /* args */ js.Tuple2[/* sid */ typingsJapgolly.steamid.mod.^, /* user */ Record[String, Any]], 
      Unit
    ]
  ): this.type = js.native
  @JSName("off")
  ...
  /**
    ...
    * @param [callback]
    */
  def removeAuthorizedBorrowers(borrowerssteamID: js.Array[typingsJapgolly.steamid.mod.^ | String]): js.Promise[Unit] = js.native
  ...
  /**
    ...
    */
  def removeFriend(steamID: typingsJapgolly.steamid.mod.^): Unit = js.native
  ...
  /**
    ...
    * @param [callback]
    */
  def removeFriendFromGroup(groupID: Any, usersteamID: typingsJapgolly.steamid.mod.^): js.Promise[Unit] = js.native
  ...
  /**
    ...
    */
  def requestRichPresence(appid: Double, steamIDs: js.Array[typingsJapgolly.steamid.mod.^ | String], language: String): js.Promise[Users] = js.native
  ...
  /**
    ...
    */
  def respondToGroupInvite(groupsteamID: typingsJapgolly.steamid.mod.^, accept: Boolean): Unit = js.native
  ...
  def sendToGC(appid: Double, msgType: Double, protoBufHeader: Null, payload: typingsJapgolly.bytebuffer.mod.^): Unit = js.native
  def sendToGC(
    appid: Double,
    msgType: Double,
    protoBufHeader: Null,
    payload: typingsJapgolly.bytebuffer.mod.^,
  ...
  /**
    ...
    * @param [callback]
    */
  def setNickname(steamID: typingsJapgolly.steamid.mod.^, nickname: String): js.Promise[Unit] = js.native
  def setNickname(
    steamID: typingsJapgolly.steamid.mod.^,
    nickname: String,
    callback: js.Function1[/* err */ js.Error | Null, Unit]
  ...
  /**
    ...
    */
  var steamID: typingsJapgolly.steamid.mod.^ | Null = js.native
  
  /**
    * The FileManager instance used by the SteamUser.
    */
  var storage: typingsJapgolly.fileManager.mod.^ = js.native
  
  def trade(steamID: String): Unit = js.native
  def trade(steamID: typingsJapgolly.steamid.mod.^): Unit = js.native
  ...
  /**
    ...
    * @param [callback] - Optional. Called with an `err` parameter on completion.
    */
  def unblockUser(steamID: typingsJapgolly.steamid.mod.^): js.Promise[Unit] = js.native
  def unblockUser(steamID: typingsJapgolly.steamid.mod.^, callback: js.Function1[/* err */ js.Error | Null, Unit]): js.Promise[Unit] = js.native
