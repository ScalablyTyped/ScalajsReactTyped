...
object ESteamPipeWorkType extends StObject {
  ...
  /* 0 */ val Invalid: typingsJapgolly.steamUser.mod.ESteamPipeWorkType.Invalid & Double = js.native
  
  @js.native
  sealed trait StageFromChunkStores
    extends StObject
       with ESteamPipeWorkType
  /* 1 */ val StageFromChunkStores: typingsJapgolly.steamUser.mod.ESteamPipeWorkType.StageFromChunkStores & Double = js.native
}
