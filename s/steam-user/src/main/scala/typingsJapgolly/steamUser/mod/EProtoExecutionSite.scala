...
object EProtoExecutionSite extends StObject {
  ...
  /* 2 */ val SteamClient: typingsJapgolly.steamUser.mod.EProtoExecutionSite.SteamClient & Double = js.native
  
  @js.native
  sealed trait Unknown
    extends StObject
       with EProtoExecutionSite
  /* 0 */ val Unknown: typingsJapgolly.steamUser.mod.EProtoExecutionSite.Unknown & Double = js.native
}
