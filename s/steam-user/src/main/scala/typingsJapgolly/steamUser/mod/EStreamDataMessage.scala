...
object EStreamDataMessage extends StObject {
  ...
  /* 2 */ val DataLost: typingsJapgolly.steamUser.mod.EStreamDataMessage.DataLost & Double = js.native
  
  @js.native
  sealed trait DataPacket
    extends StObject
       with EStreamDataMessage
  /* 1 */ val DataPacket: typingsJapgolly.steamUser.mod.EStreamDataMessage.DataPacket & Double = js.native
}
