...
object ShellReturnValue {
  ...
  extension [Self <: ShellReturnValue](x: Self) {
    ...
    inline def setTo(value: String => Callback): Self = StObject.set(x, "to", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    
    inline def setToEnd(value: String => Callback): Self = StObject.set(x, "toEnd", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
