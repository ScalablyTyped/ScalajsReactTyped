...
object WreckHttpOptions {
  ...
  def apply(
    ...
    redirected: (/* statusCode */ Double, /* location */ String, /* req */ js.Any) => Callback = null,
    ...
    if (redirected != null) __obj.updateDynamic("redirected")(js.Any.fromFunction3((t0: /* statusCode */ scala.Double, t1: /* location */ java.lang.String, t2: /* req */ js.Any) => redirected(t0, t1, t2).runNow()))
