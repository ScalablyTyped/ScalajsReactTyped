...
import typingsJapgolly.simpleOauth2.anon.AuthorizationMethod
import typingsJapgolly.simpleOauth2.anon.AuthorizeHost
import typingsJapgolly.simpleOauth2.anon.Id
import typingsJapgolly.simpleOauth2.anon.Redirecturi
import typingsJapgolly.simpleOauth2.simpleOauth2Booleans.`true`
import typingsJapgolly.simpleOauth2.simpleOauth2Strings.force
import typingsJapgolly.simpleOauth2.simpleOauth2Strings.strict
...
object mod {
  ...
  */
  ...
  object TokenType {
    ...
    inline def access_token: typingsJapgolly.simpleOauth2.simpleOauth2Strings.access_token = "access_token".asInstanceOf[typingsJapgolly.simpleOauth2.simpleOauth2Strings.access_token]
    
    inline def refresh_token: typingsJapgolly.simpleOauth2.simpleOauth2Strings.refresh_token = "refresh_token".asInstanceOf[typingsJapgolly.simpleOauth2.simpleOauth2Strings.refresh_token]
  }
  ...
  object WreckHttpOptions {
    ...
    extension [Self <: WreckHttpOptions](x: Self) {
      ...
      inline def setBeforeRedirect(
        value: (/* redirectMethod */ String, /* statusCode */ Double, /* location */ String, /* resHeaders */ StringDictionary[Any], /* redirectOptions */ Any, /* next */ js.Function0[js.Object]) => Callback
      ): Self = StObject.set(x, "beforeRedirect", js.Any.fromFunction6((t0: /* redirectMethod */ String, t1: /* statusCode */ Double, t2: /* location */ String, t3: /* resHeaders */ StringDictionary[Any], t4: /* redirectOptions */ Any, t5: /* next */ js.Function0[js.Object]) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
      ...
      inline def setRedirected(value: (/* statusCode */ Double, /* location */ String, /* req */ Any) => Callback): Self = StObject.set(x, "redirected", js.Any.fromFunction3((t0: /* statusCode */ Double, t1: /* location */ String, t2: /* req */ Any) => (value(t0, t1, t2)).runNow()))
