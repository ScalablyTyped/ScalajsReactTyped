package typingsJapgolly.srtparsejs
...
object mod {
  ...
  trait srtPlayer extends StObject {
    ...
    var srtArray: typingsJapgolly.srtparsejs.mod.srtArray
  ...
  object srtPlayer {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getEndTime = getEndTime.toJsFn, id = id.asInstanceOf[js.Any], setText = js.Any.fromFunction1((t0: String) => setText(t0).runNow()), srtArray = srtArray.asInstanceOf[js.Any], time = time.asInstanceOf[js.Any], update = js.Any.fromFunction1((t0: String) => update(t0).runNow()))
      __obj.asInstanceOf[srtPlayer]
    }
    
    extension [Self <: srtPlayer](x: Self) {
      
      inline def setGetEndTime(value: CallbackTo[String]): Self = StObject.set(x, "getEndTime", value.toJsFn)
