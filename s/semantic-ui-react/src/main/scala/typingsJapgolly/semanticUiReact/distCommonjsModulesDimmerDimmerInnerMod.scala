...
object distCommonjsModulesDimmerDimmerInnerMod {
  ...
  type DimmerInner = japgolly.scalajs.react.facade.React.Component[DimmerInnerProps & js.Object, js.Object]
  ...
  object StrictDimmerInnerProps {
    ...
    extension [Self <: StrictDimmerInnerProps](x: Self) {
      ...
      inline def setOnClick(value: (/* event */ ReactMouseEventFrom[HTMLDivElement], /* data */ DimmerInnerProps) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLDivElement], t1: /* data */ DimmerInnerProps) => (value(t0, t1)).runNow()))
      
      inline def setOnClickOutside(value: (/* event */ ReactMouseEventFrom[HTMLDivElement], /* data */ DimmerInnerProps) => Callback): Self = StObject.set(x, "onClickOutside", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLDivElement], t1: /* data */ DimmerInnerProps) => (value(t0, t1)).runNow()))
