...
object distCommonjsModulesDropdownDropdownSearchInputMod extends Shortcut {
  ...
  @JSImport("semantic-ui-react/dist/commonjs/modules/Dropdown/DropdownSearchInput", JSImport.Default)
  @js.native
  val default: ComponentClassP[DropdownSearchInputProps & js.Object] = js.native
  ...
  type _To = ComponentClassP[DropdownSearchInputProps & js.Object]
  
  /* This means you don't have to write `default`, but can instead just say `distCommonjsModulesDropdownDropdownSearchInputMod.foo` */
  override def _to: ComponentClassP[DropdownSearchInputProps & js.Object] = default
}
