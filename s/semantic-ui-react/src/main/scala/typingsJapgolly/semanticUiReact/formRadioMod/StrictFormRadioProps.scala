package typingsJapgolly.semanticUiReact.formRadioMod
...
import typingsJapgolly.semanticUiReact.radioRadioMod.StrictRadioProps
...
- typingsJapgolly.semanticUiReact.formFieldMod.StrictFormFieldProps because var conflicts: as, children, className, disabled, id, label, required, `type`, width. Inlined content, control, error, `inline` */ trait StrictFormRadioProps extends StrictRadioProps {
...
object StrictFormRadioProps {
  ...
  def apply(
    ...
    onChange: (/* event */ ReactEventFrom[HTMLInputElement], /* data */ CheckboxProps) => Callback = null,
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement], t1: /* data */ typingsJapgolly.semanticUiReact.checkboxCheckboxMod.CheckboxProps) => onChange(t0, t1).runNow()))
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLInputElement], t1: /* data */ typingsJapgolly.semanticUiReact.checkboxCheckboxMod.CheckboxProps) => onClick(t0, t1).runNow()))
    ...
    if (onMouseDown != null) __obj.updateDynamic("onMouseDown")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLInputElement], t1: /* data */ typingsJapgolly.semanticUiReact.checkboxCheckboxMod.CheckboxProps) => onMouseDown(t0, t1).runNow()))
    ...
    if (onMouseUp != null) __obj.updateDynamic("onMouseUp")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLInputElement], t1: /* data */ typingsJapgolly.semanticUiReact.checkboxCheckboxMod.CheckboxProps) => onMouseUp(t0, t1).runNow()))
