...
object distCommonjsCollectionsFormFormSelectMod extends Shortcut {
  ...
  - typingsJapgolly.semanticUiReact.distCommonjsAddonsSelectSelectMod.StrictSelectProps because var conflicts: as, children, className, disabled, error, `inline`. Inlined options */ trait StrictFormSelectProps
    extends StObject
