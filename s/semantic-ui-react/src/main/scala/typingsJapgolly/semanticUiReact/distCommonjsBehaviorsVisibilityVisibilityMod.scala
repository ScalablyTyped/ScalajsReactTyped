...
import typingsJapgolly.semanticUiReact.semanticUiReactStrings.down
...
import typingsJapgolly.semanticUiReact.semanticUiReactStrings.up
...
object distCommonjsBehaviorsVisibilityVisibilityMod extends Shortcut {
  ...
  object StrictVisibilityProps {
    ...
    extension [Self <: StrictVisibilityProps](x: Self) {
      ...
      inline def setOnBottomPassed(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onBottomPassed", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      
      inline def setOnBottomPassedReverse(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onBottomPassedReverse", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      ...
      inline def setOnBottomVisible(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onBottomVisible", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      
      inline def setOnBottomVisibleReverse(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onBottomVisibleReverse", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      ...
      inline def setOnOffScreen(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onOffScreen", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      
      inline def setOnOffScreenUndefined: Self = StObject.set(x, "onOffScreen", js.undefined)
      
      inline def setOnOnScreen(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onOnScreen", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      ...
      inline def setOnPassing(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onPassing", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      
      inline def setOnPassingReverse(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onPassingReverse", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      ...
      inline def setOnTopPassed(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onTopPassed", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      
      inline def setOnTopPassedReverse(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onTopPassedReverse", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      ...
      inline def setOnTopVisible(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onTopVisible", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      
      inline def setOnTopVisibleReverse(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onTopVisibleReverse", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
      ...
      inline def setOnUpdate(value: (/* nothing */ Null, /* data */ VisibilityEventData) => Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction2((t0: /* nothing */ Null, t1: /* data */ VisibilityEventData) => (value(t0, t1)).runNow()))
