...
object distCommonjsCollectionsMenuMenuItemMod extends Shortcut {
  ...
  @JSImport("semantic-ui-react/dist/commonjs/collections/Menu/MenuItem", JSImport.Default)
  @js.native
  val default: ComponentClassP[MenuItemProps & js.Object] = js.native
  ...
  object StrictMenuItemProps {
    ...
    extension [Self <: StrictMenuItemProps](x: Self) {
      ...
      inline def setOnClick(value: (/* event */ ReactMouseEventFrom[HTMLAnchorElement], /* data */ MenuItemProps) => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLAnchorElement], t1: /* data */ MenuItemProps) => (value(t0, t1)).runNow()))
  ...
  type _To = ComponentClassP[MenuItemProps & js.Object]
  
  /* This means you don't have to write `default`, but can instead just say `distCommonjsCollectionsMenuMenuItemMod.foo` */
  override def _to: ComponentClassP[MenuItemProps & js.Object] = default
}
