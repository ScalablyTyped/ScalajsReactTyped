package typingsJapgolly.semanticUiReact.formCheckboxMod
...
import typingsJapgolly.semanticUiReact.checkboxCheckboxMod.StrictCheckboxProps
...
- typingsJapgolly.semanticUiReact.formFieldMod.StrictFormFieldProps because var conflicts: as, children, className, disabled, id, label, required, `type`, width. Inlined content, control, error, `inline` */ trait StrictFormCheckboxProps extends StrictCheckboxProps {
