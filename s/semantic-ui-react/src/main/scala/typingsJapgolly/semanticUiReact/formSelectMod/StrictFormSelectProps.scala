package typingsJapgolly.semanticUiReact.formSelectMod
...
import typingsJapgolly.semanticUiReact.selectSelectMod.StrictSelectProps
...
- typingsJapgolly.semanticUiReact.formFieldMod.StrictFormFieldProps because var conflicts: as, children, className, disabled, error, `inline`. Inlined content, control, id, label, required, `type`, width */ trait StrictFormSelectProps extends StrictSelectProps {
