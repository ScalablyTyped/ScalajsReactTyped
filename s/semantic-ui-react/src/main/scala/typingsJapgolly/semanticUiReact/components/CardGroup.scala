...
object CardGroup {
  ...
  typingsJapgolly.semanticUiReact.cardGroupMod.CardGroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.cardGroupMod.CardGroupProps])(children: _*)
  }
