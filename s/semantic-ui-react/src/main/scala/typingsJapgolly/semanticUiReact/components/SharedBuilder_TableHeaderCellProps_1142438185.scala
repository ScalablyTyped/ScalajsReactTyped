...
@scala.inline
open class SharedBuilder_TableHeaderCellProps_1142438185 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def collapsing(value: Boolean): this.type = set("collapsing", value.asInstanceOf[js.Any])
  ...
  inline def singleLine(value: Boolean): this.type = set("singleLine", value.asInstanceOf[js.Any])
  
  inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
  
  inline def sorted(
    value: typingsJapgolly.semanticUiReact.semanticUiReactStrings.ascending | typingsJapgolly.semanticUiReact.semanticUiReactStrings.descending
  ...
  inline def textAlign(
    value: typingsJapgolly.semanticUiReact.semanticUiReactStrings.center | typingsJapgolly.semanticUiReact.semanticUiReactStrings.left | typingsJapgolly.semanticUiReact.semanticUiReactStrings.right
