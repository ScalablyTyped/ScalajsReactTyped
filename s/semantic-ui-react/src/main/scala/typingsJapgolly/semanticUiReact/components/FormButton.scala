...
object FormButton {
  ...
  typingsJapgolly.semanticUiReact.formButtonMod.FormButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.formButtonMod.FormButtonProps])(children: _*)
  }
