...
object FormSelect {
  ...
  typingsJapgolly.semanticUiReact.formSelectMod.FormSelectProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.formSelectMod.FormSelectProps])(children: _*)
  }
