...
@scala.inline
open class SharedBuilder_FeedLabelProps1476819622 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def image(value: SemanticShorthandItem[HtmlImageProps]): this.type = set("image", value.asInstanceOf[js.Any])
