...
@scala.inline
open class SharedBuilder_CommentGroupProps464793707 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def threaded(value: Boolean): this.type = set("threaded", value.asInstanceOf[js.Any])
}
