...
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsFormFormMod.FormProps
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsFormFormMod.StrictFormProps
...
object Form {
  ...
  object Checkbox {
    ...
    implicit def make(companion: Checkbox.type): SharedBuilder_FormCheckboxProps1990476196 = new SharedBuilder_FormCheckboxProps1990476196(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: FormCheckboxProps): SharedBuilder_FormCheckboxProps1990476196 = new SharedBuilder_FormCheckboxProps1990476196(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Dropdown {
    ...
    implicit def make(companion: Dropdown.type): SharedBuilder_FormDropdownProps721709752 = new SharedBuilder_FormDropdownProps721709752(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: FormDropdownProps): SharedBuilder_FormDropdownProps721709752 = new SharedBuilder_FormDropdownProps721709752(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Field {
    ...
    implicit def make(companion: Field.type): SharedBuilder_FormFieldProps_1529513900 = new SharedBuilder_FormFieldProps_1529513900(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: FormFieldProps): SharedBuilder_FormFieldProps_1529513900 = new SharedBuilder_FormFieldProps_1529513900(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Group {
    ...
    implicit def make(companion: Group.type): SharedBuilder_FormGroupProps_1149214278 = new SharedBuilder_FormGroupProps_1149214278(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: FormGroupProps): SharedBuilder_FormGroupProps_1149214278 = new SharedBuilder_FormGroupProps_1149214278(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Radio {
    ...
    implicit def make(companion: Radio.type): SharedBuilder_FormRadioProps1210173964 = new SharedBuilder_FormRadioProps1210173964(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: FormRadioProps): SharedBuilder_FormRadioProps1210173964 = new SharedBuilder_FormRadioProps1210173964(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object TextArea {
    ...
    implicit def make(companion: TextArea.type): SharedBuilder_FormTextAreaProps43198524 = new SharedBuilder_FormTextAreaProps43198524(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: FormTextAreaProps): SharedBuilder_FormTextAreaProps43198524 = new SharedBuilder_FormTextAreaProps43198524(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onSubmit(value: (/* event */ ReactEventFrom[HTMLFormElement], /* data */ FormProps) => Callback): this.type = set("onSubmit", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLFormElement], t1: /* data */ FormProps) => (value(t0, t1)).runNow()))
    ...
    inline def reply(value: Boolean): this.type = set("reply", value.asInstanceOf[js.Any])
    ...
    inline def widths(value: equal): this.type = set("widths", value.asInstanceOf[js.Any])
  }
