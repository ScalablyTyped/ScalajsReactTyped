...
object FeedEvent {
  ...
  typingsJapgolly.semanticUiReact.feedEventMod.FeedEventProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.feedEventMod.FeedEventProps])(children: _*)
  }
