...
import typingsJapgolly.semanticUiReact.confirmMod.default
...
object Confirm {
  ...
  typingsJapgolly.semanticUiReact.confirmConfirmMod.ConfirmProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.semanticUiReact.confirmMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.confirmConfirmMod.ConfirmProps])(children: _*)
  }
