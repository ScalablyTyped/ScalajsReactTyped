...
object HeaderSubheader {
  ...
  typingsJapgolly.semanticUiReact.headerSubheaderMod.HeaderSubheaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.headerSubheaderMod.HeaderSubheaderProps])(children: _*)
  }
