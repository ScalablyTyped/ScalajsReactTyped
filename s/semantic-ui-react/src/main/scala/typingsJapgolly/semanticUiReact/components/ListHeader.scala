...
object ListHeader {
  ...
  typingsJapgolly.semanticUiReact.listHeaderMod.ListHeaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.listHeaderMod.ListHeaderProps])(children: _*)
  }
