...
import typingsJapgolly.semanticUiReact.dropdownMod.default
...
object Dropdown {
  ...
  typingsJapgolly.semanticUiReact.dropdownDropdownMod.DropdownProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.semanticUiReact.dropdownMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.dropdownDropdownMod.DropdownProps])(children: _*)
  }
