...
object Dropdown {
  ...
  object Divider {
    ...
    implicit def make(companion: Divider.type): SharedBuilder_DropdownDividerProps1871322626[typingsJapgolly.semanticUiReact.mod.Dropdown.Divider] = new SharedBuilder_DropdownDividerProps1871322626[typingsJapgolly.semanticUiReact.mod.Dropdown.Divider](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownDividerProps): SharedBuilder_DropdownDividerProps1871322626[typingsJapgolly.semanticUiReact.mod.Dropdown.Divider] = new SharedBuilder_DropdownDividerProps1871322626[typingsJapgolly.semanticUiReact.mod.Dropdown.Divider](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Header {
    ...
    implicit def make(companion: Header.type): SharedBuilder_DropdownHeaderProps1359012144[typingsJapgolly.semanticUiReact.mod.Dropdown.Header] = new SharedBuilder_DropdownHeaderProps1359012144[typingsJapgolly.semanticUiReact.mod.Dropdown.Header](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownHeaderProps): SharedBuilder_DropdownHeaderProps1359012144[typingsJapgolly.semanticUiReact.mod.Dropdown.Header] = new SharedBuilder_DropdownHeaderProps1359012144[typingsJapgolly.semanticUiReact.mod.Dropdown.Header](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): SharedBuilder_DropdownItemProps_1093905647[typingsJapgolly.semanticUiReact.mod.Dropdown.Item] = new SharedBuilder_DropdownItemProps_1093905647[typingsJapgolly.semanticUiReact.mod.Dropdown.Item](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownItemProps): SharedBuilder_DropdownItemProps_1093905647[typingsJapgolly.semanticUiReact.mod.Dropdown.Item] = new SharedBuilder_DropdownItemProps_1093905647[typingsJapgolly.semanticUiReact.mod.Dropdown.Item](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object Menu {
    
    @JSImport("semantic-ui-react", "Dropdown.Menu")
    @js.native
    val component: js.Object = js.native
  ...
  object SearchInput {
    ...
    implicit def make(companion: SearchInput.type): SharedBuilder_DropdownSearchInputProps1337927924[typingsJapgolly.semanticUiReact.mod.Dropdown.SearchInput] = new SharedBuilder_DropdownSearchInputProps1337927924[typingsJapgolly.semanticUiReact.mod.Dropdown.SearchInput](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: DropdownSearchInputProps): SharedBuilder_DropdownSearchInputProps1337927924[typingsJapgolly.semanticUiReact.mod.Dropdown.SearchInput] = new SharedBuilder_DropdownSearchInputProps1337927924[typingsJapgolly.semanticUiReact.mod.Dropdown.SearchInput](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.semanticUiReact.mod.Dropdown] {
    ...
    inline def options(value: js.Array[DropdownItemProps]): this.type = set("options", value.asInstanceOf[js.Any])
    
    inline def optionsVarargs(value: DropdownItemProps*): this.type = set("options", js.Array(value*))
