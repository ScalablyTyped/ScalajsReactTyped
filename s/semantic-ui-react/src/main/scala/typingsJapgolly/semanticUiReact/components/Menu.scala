...
import typingsJapgolly.semanticUiReact.menuMod.default
...
object Menu {
  ...
  typingsJapgolly.semanticUiReact.menuMenuMod.MenuProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.semanticUiReact.menuMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.menuMenuMod.MenuProps])(children: _*)
  }
