...
object MessageItem {
  ...
  implicit def make(companion: MessageItem.type): SharedBuilder_MessageItemProps1591511845 = new SharedBuilder_MessageItemProps1591511845(js.Array(this.component, js.Dictionary.empty))()
