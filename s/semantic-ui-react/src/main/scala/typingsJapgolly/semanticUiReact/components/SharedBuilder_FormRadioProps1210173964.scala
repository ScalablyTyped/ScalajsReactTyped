...
@scala.inline
open class SharedBuilder_FormRadioProps1210173964 (val args: js.Array[Any])
  extends AnyVal
  ...
  ): this.type = set("onChange", value.asInstanceOf[js.Any])
  
  inline def onChangeFunction1(value: ReactEventFrom[HTMLInputElement & org.scalajs.dom.Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLInputElement & org.scalajs.dom.Element]) => value(t0).runNow()))
  
  inline def onChangeFunction2(value: (/* event */ ReactEventFrom[HTMLInputElement], /* data */ CheckboxProps) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLInputElement], t1: /* data */ CheckboxProps) => (value(t0, t1)).runNow()))
  
  inline def onClick(value: (/* event */ ReactMouseEventFrom[HTMLInputElement], /* data */ CheckboxProps) => Callback): this.type = set("onClick", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLInputElement], t1: /* data */ CheckboxProps) => (value(t0, t1)).runNow()))
  ...
  inline def onMouseDown(value: (/* event */ ReactMouseEventFrom[HTMLInputElement], /* data */ CheckboxProps) => Callback): this.type = set("onMouseDown", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLInputElement], t1: /* data */ CheckboxProps) => (value(t0, t1)).runNow()))
  ...
  inline def onMouseUp(value: (/* event */ ReactMouseEventFrom[HTMLInputElement], /* data */ CheckboxProps) => Callback): this.type = set("onMouseUp", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLInputElement], t1: /* data */ CheckboxProps) => (value(t0, t1)).runNow()))
  ...
  inline def radio(value: Boolean): this.type = set("radio", value.asInstanceOf[js.Any])
  ...
  inline def slider(value: Boolean): this.type = set("slider", value.asInstanceOf[js.Any])
  ...
  inline def `type`(value: checkbox | radio): this.type = set("type", value.asInstanceOf[js.Any])
