...
object Button {
  ...
  typingsJapgolly.semanticUiReact.buttonButtonMod.StrictButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.semanticUiReact.buttonMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.buttonButtonMod.StrictButtonProps])(children: _*)
  }
