...
@scala.inline
open class SharedBuilder_ItemGroupProps238763249 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def items(value: SemanticShorthandCollection[ItemProps]): this.type = set("items", value.asInstanceOf[js.Any])
  
  inline def itemsVarargs(value: SemanticShorthandItem[ItemProps]*): this.type = set("items", js.Array(value*))
