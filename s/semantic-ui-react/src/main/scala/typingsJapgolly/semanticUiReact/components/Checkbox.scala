...
object Checkbox {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.semanticUiReact.mod.Checkbox] {
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[HTMLInputElement], /* data */ CheckboxProps) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLInputElement], t1: /* data */ CheckboxProps) => (value(t0, t1)).runNow()))
