...
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsTableTableBodyMod.TableBodyProps
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsTableTableCellMod.StrictTableCellProps
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsTableTableFooterMod.TableFooterProps
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsTableTableHeaderCellMod.TableHeaderCellProps
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsTableTableHeaderMod.TableHeaderProps
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsTableTableMod.TableProps
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsTableTableRowMod.TableRowProps
...
object Table {
  ...
  object Body {
    ...
    implicit def make(companion: Body.type): SharedBuilder_TableBodyProps1236904577 = new SharedBuilder_TableBodyProps1236904577(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: TableBodyProps): SharedBuilder_TableBodyProps1236904577 = new SharedBuilder_TableBodyProps1236904577(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Cell {
    ...
    implicit def make(companion: Cell.type): typingsJapgolly.semanticUiReact.components.Table.Cell.Builder = new typingsJapgolly.semanticUiReact.components.Table.Cell.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: StrictTableCellProps): typingsJapgolly.semanticUiReact.components.Table.Cell.Builder = new typingsJapgolly.semanticUiReact.components.Table.Cell.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Footer {
    ...
    implicit def make(companion: Footer.type): SharedBuilder_TableFooterProps_717496252 = new SharedBuilder_TableFooterProps_717496252(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: TableFooterProps): SharedBuilder_TableFooterProps_717496252 = new SharedBuilder_TableFooterProps_717496252(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Header {
    ...
    implicit def make(companion: Header.type): SharedBuilder_TableHeaderProps1173468069 = new SharedBuilder_TableHeaderProps1173468069(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: TableHeaderProps): SharedBuilder_TableHeaderProps1173468069 = new SharedBuilder_TableHeaderProps1173468069(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object HeaderCell {
    ...
    implicit def make(companion: HeaderCell.type): SharedBuilder_TableHeaderCellProps_1142438185 = new SharedBuilder_TableHeaderCellProps_1142438185(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: TableHeaderCellProps): SharedBuilder_TableHeaderCellProps_1142438185 = new SharedBuilder_TableHeaderCellProps_1142438185(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object Row {
    ...
    implicit def make(companion: Row.type): SharedBuilder_TableRowProps1840000053 = new SharedBuilder_TableRowProps1840000053(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: TableRowProps): SharedBuilder_TableRowProps1840000053 = new SharedBuilder_TableRowProps1840000053(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def attached(
      value: Boolean | typingsJapgolly.semanticUiReact.semanticUiReactStrings.top | typingsJapgolly.semanticUiReact.semanticUiReactStrings.bottom
    ): this.type = set("attached", value.asInstanceOf[js.Any])
    
    inline def basic(value: Boolean | very): this.type = set("basic", value.asInstanceOf[js.Any])
    ...
    inline def columns(value: SemanticWIDTHS): this.type = set("columns", value.asInstanceOf[js.Any])
    
    inline def compact(value: Boolean | very): this.type = set("compact", value.asInstanceOf[js.Any])
    
    inline def definition(value: Boolean): this.type = set("definition", value.asInstanceOf[js.Any])
    
    inline def fixed(value: Boolean): this.type = set("fixed", value.asInstanceOf[js.Any])
    
    inline def footerRow(value: SemanticShorthandItem[TableRowProps]): this.type = set("footerRow", value.asInstanceOf[js.Any])
    
    inline def footerRowFunction3(
      value: (/* component */ ElementType, TableRowProps, /* children */ js.UndefOr[Node | ReactNodeArray]) => Element | Null
    ): this.type = set("footerRow", js.Any.fromFunction3(value))
    
    inline def footerRowNull: this.type = set("footerRow", null)
    
    inline def footerRowVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("footerRow", js.Array(value*))
    
    inline def footerRowVdomElement(value: VdomElement): this.type = set("footerRow", value.rawElement.asInstanceOf[js.Any])
    
    inline def headerRow(value: SemanticShorthandItem[TableRowProps]): this.type = set("headerRow", value.asInstanceOf[js.Any])
    
    inline def headerRowFunction3(
      value: (/* component */ ElementType, TableRowProps, /* children */ js.UndefOr[Node | ReactNodeArray]) => Element | Null
    ): this.type = set("headerRow", js.Any.fromFunction3(value))
    
    inline def headerRowNull: this.type = set("headerRow", null)
    
    inline def headerRowVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("headerRow", js.Array(value*))
    
    inline def headerRowVdomElement(value: VdomElement): this.type = set("headerRow", value.rawElement.asInstanceOf[js.Any])
    
    inline def headerRows(value: SemanticShorthandCollection[TableRowProps]): this.type = set("headerRows", value.asInstanceOf[js.Any])
    
    inline def headerRowsVarargs(value: SemanticShorthandItem[TableRowProps]*): this.type = set("headerRows", js.Array(value*))
    ...
    inline def renderBodyRow(value: (/* data */ Any, /* index */ Double) => Any): this.type = set("renderBodyRow", js.Any.fromFunction2(value))
    
    inline def selectable(value: Boolean): this.type = set("selectable", value.asInstanceOf[js.Any])
    
    inline def singleLine(value: Boolean): this.type = set("singleLine", value.asInstanceOf[js.Any])
    
    inline def size(value: small | large): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def structured(value: Boolean): this.type = set("structured", value.asInstanceOf[js.Any])
    
    inline def tableData(value: js.Array[Any]): this.type = set("tableData", value.asInstanceOf[js.Any])
    
    inline def tableDataVarargs(value: Any*): this.type = set("tableData", js.Array(value*))
