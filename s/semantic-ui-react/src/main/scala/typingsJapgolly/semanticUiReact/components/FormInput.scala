...
object FormInput {
  def apply(
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement], t1: /* data */ typingsJapgolly.semanticUiReact.inputInputMod.InputOnChangeData) => onChange(t0, t1).runNow()))
  ...
  typingsJapgolly.semanticUiReact.formInputMod.FormInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.formInputMod.FormInputProps])(children: _*)
  }
