...
import typingsJapgolly.semanticUiReact.distCommonjsElementsInputInputMod.StrictInputProps
...
object Input {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.semanticUiReact.mod.Input] {
