...
@scala.inline
open class SharedBuilder_FormTextAreaProps43198524 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def onChangeFunction1(value: ReactEventFrom[HTMLTextAreaElement & org.scalajs.dom.Element] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: ReactEventFrom[HTMLTextAreaElement & org.scalajs.dom.Element]) => value(t0).runNow()))
  
  inline def onChangeFunction2(value: (/* event */ ReactEventFrom[HTMLTextAreaElement], /* data */ TextAreaProps) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLTextAreaElement], t1: /* data */ TextAreaProps) => (value(t0, t1)).runNow()))
