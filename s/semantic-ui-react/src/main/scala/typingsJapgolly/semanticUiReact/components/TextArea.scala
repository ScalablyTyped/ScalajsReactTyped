...
import typingsJapgolly.semanticUiReact.textAreaMod.default
import typingsJapgolly.semanticUiReact.textAreaTextAreaMod.StrictTextAreaProps
import typingsJapgolly.semanticUiReact.textAreaTextAreaMod.TextAreaProps
...
object TextArea {
  def apply(
    ...
    onChange: (/* event */ ReactEventFrom[HTMLTextAreaElement], /* data */ TextAreaProps) => Callback = null,
    ...
    onInput: (/* event */ ReactEventFrom[HTMLTextAreaElement], /* data */ TextAreaProps) => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[StrictTextAreaProps, default, Unit, StrictTextAreaProps] = {
  ...
  typingsJapgolly.semanticUiReact.textAreaTextAreaMod.StrictTextAreaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.semanticUiReact.textAreaMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.semanticUiReact.textAreaTextAreaMod.StrictTextAreaProps])(children: _*)
  }
