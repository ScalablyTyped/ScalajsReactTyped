...
import typingsJapgolly.semanticUiReact.distCommonjsAddonsTextAreaTextAreaMod.StrictTextAreaProps
...
object TextArea {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.semanticUiReact.mod.TextArea] {
    ...
    inline def onChange(value: (/* event */ ReactEventFrom[HTMLTextAreaElement], /* data */ TextAreaProps) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLTextAreaElement], t1: /* data */ TextAreaProps) => (value(t0, t1)).runNow()))
    ...
    inline def onInput(value: (/* event */ ReactEventFrom[HTMLTextAreaElement], /* data */ TextAreaProps) => Callback): this.type = set("onInput", js.Any.fromFunction2((t0: /* event */ ReactEventFrom[HTMLTextAreaElement], t1: /* data */ TextAreaProps) => (value(t0, t1)).runNow()))
    ...
    inline def rows(value: Double | String): this.type = set("rows", value.asInstanceOf[js.Any])
