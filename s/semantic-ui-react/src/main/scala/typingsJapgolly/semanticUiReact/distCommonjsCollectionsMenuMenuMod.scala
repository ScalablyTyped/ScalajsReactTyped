...
object distCommonjsCollectionsMenuMenuMod {
  ...
  trait MenuComponent
    extends StObject
       with ComponentClass[MenuProps, js.Object] {
    
    var Header: ComponentClassP[MenuHeaderProps & js.Object] = js.native
    
    var Item: ComponentClassP[MenuItemProps & js.Object] = js.native
  ...
  object StrictMenuProps {
    ...
    extension [Self <: StrictMenuProps](x: Self) {
      ...
      inline def setOnItemClick(value: (/* event */ ReactMouseEventFrom[HTMLAnchorElement], /* data */ MenuItemProps) => Callback): Self = StObject.set(x, "onItemClick", js.Any.fromFunction2((t0: /* event */ ReactMouseEventFrom[HTMLAnchorElement], t1: /* data */ MenuItemProps) => (value(t0, t1)).runNow()))
