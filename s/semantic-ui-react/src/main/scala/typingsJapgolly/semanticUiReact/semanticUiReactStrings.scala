...
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsGridGridColumnMod._GridOnlyProp
import typingsJapgolly.semanticUiReact.distCommonjsCollectionsGridGridMod._GridReversedProp
...
import typingsJapgolly.semanticUiReact.distCommonjsGenericMod.SemanticDIRECTIONALTRANSITIONS
...
import typingsJapgolly.semanticUiReact.distCommonjsGenericMod.SemanticSTATICTRANSITIONS
...
import typingsJapgolly.semanticUiReact.distCommonjsGenericMod.SemanticWIDTHSSTRING
import typingsJapgolly.semanticUiReact.distCommonjsModulesTransitionTransitionMod.TRANSITION_STATUSES
...
object semanticUiReactStrings {
  ...
  @js.native
  sealed trait `16Colon9` extends StObject
  inline def `16Colon9`: `16Colon9` = "16:9".asInstanceOf[`16Colon9`]
  ...
  @js.native
  sealed trait `21Colon9` extends StObject
  inline def `21Colon9`: `21Colon9` = "21:9".asInstanceOf[`21Colon9`]
  ...
  @js.native
  sealed trait `4Colon3` extends StObject
  inline def `4Colon3`: `4Colon3` = "4:3".asInstanceOf[`4Colon3`]
  ...
  @js.native
  sealed trait billboard extends StObject
  inline def billboard: billboard = "billboard".asInstanceOf[billboard]
  ...
  @js.native
  sealed trait blurring extends StObject
  inline def blurring: blurring = "blurring".asInstanceOf[blurring]
  ...
  sealed trait bottom
    extends StObject
       with SemanticVERTICALALIGNMENTS
  ...
  sealed trait bounce
    extends StObject
       with SemanticSTATICTRANSITIONS
  ...
  sealed trait browse
    extends StObject
       with SemanticDIRECTIONALTRANSITIONS
       with SemanticTRANSITIONS
  ...
  @js.native
  sealed trait `central african republic`
    extends StObject
       with FlagNameValues
  ...
  @js.native
  sealed trait `computer vertically`
    extends StObject
       with _GridReversedProp
  inline def `computer vertically`: `computer vertically` = ("computer vertically").asInstanceOf[`computer vertically`]
  ...
  @js.native
  sealed trait `congo brazzaville`
    extends StObject
       with FlagNameValues
  ...
  @js.native
  sealed trait `dominican republic`
    extends StObject
       with FlagNameValues
  ...
  @js.native
  sealed trait ellipsisItem extends StObject
  inline def ellipsisItem: ellipsisItem = "ellipsisItem".asInstanceOf[ellipsisItem]
  ...
  @js.native
  sealed trait `equatorial guinea`
    extends StObject
       with FlagNameValues
  ...
  @js.native
  sealed trait firstItem extends StObject
  inline def firstItem: firstItem = "firstItem".asInstanceOf[firstItem]
  ...
  @js.native
  sealed trait `half banner` extends StObject
  inline def `half banner`: `half banner` = ("half banner").asInstanceOf[`half banner`]
  
  @js.native
  sealed trait `half page` extends StObject
  inline def `half page`: `half page` = ("half page").asInstanceOf[`half page`]
  ...
  @js.native
  sealed trait horizontally extends StObject
  inline def horizontally: horizontally = "horizontally".asInstanceOf[horizontally]
  ...
  @js.native
  sealed trait internally extends StObject
  inline def internally: internally = "internally".asInstanceOf[internally]
  ...
  @js.native
  sealed trait `large leaderboard` extends StObject
  inline def `large leaderboard`: `large leaderboard` = ("large leaderboard").asInstanceOf[`large leaderboard`]
  
  @js.native
  sealed trait `large rectangle` extends StObject
  inline def `large rectangle`: `large rectangle` = ("large rectangle").asInstanceOf[`large rectangle`]
  ...
  @js.native
  sealed trait lastItem extends StObject
  inline def lastItem: lastItem = "lastItem".asInstanceOf[lastItem]
  ...
  @js.native
  sealed trait leaderboard extends StObject
  ...
  inline def `left corner`: `left corner` = ("left corner").asInstanceOf[`left corner`]
  ...
  @js.native
  sealed trait `medium rectangle` extends StObject
  inline def `medium rectangle`: `medium rectangle` = ("medium rectangle").asInstanceOf[`medium rectangle`]
  ...
  @js.native
  sealed trait `mobile banner` extends StObject
  inline def `mobile banner`: `mobile banner` = ("mobile banner").asInstanceOf[`mobile banner`]
  
  @js.native
  sealed trait `mobile leaderboard` extends StObject
  inline def `mobile leaderboard`: `mobile leaderboard` = ("mobile leaderboard").asInstanceOf[`mobile leaderboard`]
  
  @js.native
  sealed trait `mobile vertically`
    extends StObject
       with _GridReversedProp
  inline def `mobile vertically`: `mobile vertically` = ("mobile vertically").asInstanceOf[`mobile vertically`]
  ...
  @js.native
  sealed trait `move down` extends StObject
  inline def `move down`: `move down` = ("move down").asInstanceOf[`move down`]
  
  @js.native
  sealed trait `move right` extends StObject
  inline def `move right`: `move right` = ("move right").asInstanceOf[`move right`]
  
  @js.native
  sealed trait `move up` extends StObject
  inline def `move up`: `move up` = ("move up").asInstanceOf[`move up`]
  
  @js.native
  sealed trait mozambique
    extends StObject
       with FlagNameValues
  ...
  @js.native
  sealed trait netboard extends StObject
  inline def netboard: netboard = "netboard".asInstanceOf[netboard]
  
  @js.native
  sealed trait netherlands
    extends StObject
       with FlagNameValues
  inline def netherlands: netherlands = "netherlands".asInstanceOf[netherlands]
  
  @js.native
  sealed trait `netherlands antilles`
    extends StObject
       with FlagNameValues
  ...
  @js.native
  sealed trait nextItem extends StObject
  inline def nextItem: nextItem = "nextItem".asInstanceOf[nextItem]
  ...
  @js.native
  sealed trait pageItem extends StObject
  inline def pageItem: pageItem = "pageItem".asInstanceOf[pageItem]
  ...
  @js.native
  sealed trait panorama extends StObject
  ...
  @js.native
  sealed trait prevItem extends StObject
  inline def prevItem: prevItem = "prevItem".asInstanceOf[prevItem]
  ...
  inline def `right corner`: `right corner` = ("right corner").asInstanceOf[`right corner`]
  ...
  @js.native
  sealed trait skyscraper extends StObject
  inline def skyscraper: skyscraper = "skyscraper".asInstanceOf[skyscraper]
  ...
  @js.native
  sealed trait `slide along` extends StObject
  inline def `slide along`: `slide along` = ("slide along").asInstanceOf[`slide along`]
  ...
  @js.native
  sealed trait `slide out` extends StObject
  inline def `slide out`: `slide out` = ("slide out").asInstanceOf[`slide out`]
  ...
  @js.native
  sealed trait `small button` extends StObject
  inline def `small button`: `small button` = ("small button").asInstanceOf[`small button`]
  
  @js.native
  sealed trait `small fade` extends StObject
  inline def `small fade`: `small fade` = ("small fade").asInstanceOf[`small fade`]
  
  @js.native
  sealed trait `small rectangle` extends StObject
  inline def `small rectangle`: `small rectangle` = ("small rectangle").asInstanceOf[`small rectangle`]
  ...
  @js.native
  sealed trait `square button` extends StObject
  ...
  sealed trait `tablet mobile`
    extends StObject
       with _GridOnlyProp
  inline def `tablet mobile`: `tablet mobile` = ("tablet mobile").asInstanceOf[`tablet mobile`]
  
  @js.native
  sealed trait `tablet vertically`
    extends StObject
       with _GridReversedProp
  inline def `tablet vertically`: `tablet vertically` = ("tablet vertically").asInstanceOf[`tablet vertically`]
  ...
  @js.native
  sealed trait `top banner` extends StObject
  inline def `top banner`: `top banner` = ("top banner").asInstanceOf[`top banner`]
  ...
  @js.native
  sealed trait uncover extends StObject
  inline def uncover: uncover = "uncover".asInstanceOf[uncover]
  ...
  @js.native
  sealed trait `vertical banner` extends StObject
  inline def `vertical banner`: `vertical banner` = ("vertical banner").asInstanceOf[`vertical banner`]
  ...
  @js.native
  sealed trait `vertical rectangle` extends StObject
  inline def `vertical rectangle`: `vertical rectangle` = ("vertical rectangle").asInstanceOf[`vertical rectangle`]
  
  @js.native
  sealed trait vertically extends StObject
  inline def vertically: vertically = "vertically".asInstanceOf[vertically]
  
  @js.native
  sealed trait very extends StObject
  inline def very: very = "very".asInstanceOf[very]
  
  @js.native
  sealed trait `very long` extends StObject
  inline def `very long`: `very long` = ("very long").asInstanceOf[`very long`]
  
  @js.native
  sealed trait `very short` extends StObject
  inline def `very short`: `very short` = ("very short").asInstanceOf[`very short`]
  
  @js.native
  sealed trait `very thin` extends StObject
  inline def `very thin`: `very thin` = ("very thin").asInstanceOf[`very thin`]
  
  @js.native
  sealed trait `very wide` extends StObject
  inline def `very wide`: `very wide` = ("very wide").asInstanceOf[`very wide`]
  ...
  @js.native
  sealed trait `wallis and futuna`
    extends StObject
       with FlagNameValues
  ...
  @js.native
  sealed trait `wide skyscraper` extends StObject
  inline def `wide skyscraper`: `wide skyscraper` = ("wide skyscraper").asInstanceOf[`wide skyscraper`]
  
  @js.native
  sealed trait widescreen
    extends StObject
       with _GridOnlyProp
  inline def widescreen: widescreen = "widescreen".asInstanceOf[widescreen]
