...
object distCommonjsViewsItemItemContentMod extends Shortcut {
  ...
  @JSImport("semantic-ui-react/dist/commonjs/views/Item/ItemContent", JSImport.Default)
  @js.native
  val default: ComponentClassP[ItemContentProps & js.Object] = js.native
  ...
  type _To = ComponentClassP[ItemContentProps & js.Object]
  
  /* This means you don't have to write `default`, but can instead just say `distCommonjsViewsItemItemContentMod.foo` */
  override def _to: ComponentClassP[ItemContentProps & js.Object] = default
}
