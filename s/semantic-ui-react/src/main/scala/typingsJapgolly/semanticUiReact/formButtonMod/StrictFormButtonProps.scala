package typingsJapgolly.semanticUiReact.formButtonMod
...
import typingsJapgolly.semanticUiReact.buttonButtonMod.StrictButtonProps
...
- typingsJapgolly.semanticUiReact.formFieldMod.StrictFormFieldProps because var conflicts: as, children, className, content, disabled, id, label, `type`. Inlined control, error, `inline`, required, width */ trait StrictFormButtonProps extends StrictButtonProps {
...
object StrictFormButtonProps {
  ...
  def apply(
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLButtonElement], t1: /* data */ typingsJapgolly.semanticUiReact.buttonButtonMod.ButtonProps) => onClick(t0, t1).runNow()))
