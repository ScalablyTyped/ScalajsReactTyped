...
object distCommonjsCollectionsTableTableMod extends Shortcut {
  ...
  object StrictTableProps {
    ...
    extension [Self <: StrictTableProps](x: Self) {
      ...
      inline def setFooterRowNull: Self = StObject.set(x, "footerRow", null)
      
      inline def setFooterRowUndefined: Self = StObject.set(x, "footerRow", js.undefined)
      
      inline def setFooterRowVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "footerRow", js.Array(value*))
      
      inline def setFooterRowVdomElement(value: VdomElement): Self = StObject.set(x, "footerRow", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setHeaderRowNull: Self = StObject.set(x, "headerRow", null)
      
      inline def setHeaderRowUndefined: Self = StObject.set(x, "headerRow", js.undefined)
      
      inline def setHeaderRowVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "headerRow", js.Array(value*))
      
      inline def setHeaderRowVdomElement(value: VdomElement): Self = StObject.set(x, "headerRow", value.rawElement.asInstanceOf[js.Any])
