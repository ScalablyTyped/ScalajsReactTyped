...
object distCommonjsCollectionsFormFormRadioMod extends Shortcut {
  ...
  - typingsJapgolly.semanticUiReact.distCommonjsModulesCheckboxCheckboxMod.StrictCheckboxProps because Inheritance from two classes. Inlined checked, defaultChecked, defaultIndeterminate, fitted, indeterminate, name, onChange, onClick, onMouseDown, onMouseUp, radio, readOnly, tabIndex, value
  - typingsJapgolly.semanticUiReact.distCommonjsAddonsRadioRadioMod.StrictRadioProps because Inheritance from two classes. Inlined slider, toggle */ trait StrictFormRadioProps
    extends StObject
