...
@js.native
open class MenuHeader protected ()
...
object MenuHeader {
  ...
  inline def apply: ComponentClassP[MenuHeaderProps & js.Object] = ^.asInstanceOf[js.Dynamic].selectDynamic("MenuHeader").asInstanceOf[ComponentClassP[MenuHeaderProps & js.Object]]
}
