package typingsJapgolly.semanticUiReact.formTextAreaMod
...
- typingsJapgolly.semanticUiReact.formFieldMod.StrictFormFieldProps because var conflicts: as, children, className, disabled, id, required. Inlined content, control, error, `inline`, label, `type`, width */ trait StrictFormTextAreaProps extends StrictTextAreaProps {
