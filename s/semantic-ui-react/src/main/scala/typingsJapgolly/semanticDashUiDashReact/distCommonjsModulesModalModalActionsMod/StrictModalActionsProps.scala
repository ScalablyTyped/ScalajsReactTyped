package typingsJapgolly.semanticDashUiDashReact.distCommonjsModulesModalModalActionsMod
...
object StrictModalActionsProps {
  ...
  def apply(
    ...
    if (onActionClick != null) __obj.updateDynamic("onActionClick")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLAnchorElement], t1: /* data */ typingsJapgolly.semanticDashUiDashReact.distCommonjsElementsButtonButtonMod.ButtonProps) => onActionClick(t0, t1).runNow()))
