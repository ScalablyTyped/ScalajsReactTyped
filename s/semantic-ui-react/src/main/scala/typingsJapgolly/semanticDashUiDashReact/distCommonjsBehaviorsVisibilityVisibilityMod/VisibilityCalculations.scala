...
import typingsJapgolly.semanticDashUiDashReact.semanticDashUiDashReactStrings.down
import typingsJapgolly.semanticDashUiDashReact.semanticDashUiDashReactStrings.up
