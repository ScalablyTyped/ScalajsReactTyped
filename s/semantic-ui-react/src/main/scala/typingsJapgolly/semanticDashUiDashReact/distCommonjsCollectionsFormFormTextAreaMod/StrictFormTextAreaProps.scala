package typingsJapgolly.semanticDashUiDashReact.distCommonjsCollectionsFormFormTextAreaMod
...
import typingsJapgolly.semanticDashUiDashReact.distCommonjsAddonsTextAreaTextAreaMod.StrictTextAreaProps
...
object StrictFormTextAreaProps {
  ...
  def apply(
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLTextAreaElement], t1: /* data */ typingsJapgolly.semanticDashUiDashReact.distCommonjsAddonsTextAreaTextAreaMod.TextAreaProps) => onChange(t0, t1).runNow()))
    ...
    if (onInput != null) __obj.updateDynamic("onInput")(js.Any.fromFunction2((t0: /* event */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLTextAreaElement], t1: /* data */ typingsJapgolly.semanticDashUiDashReact.distCommonjsAddonsTextAreaTextAreaMod.TextAreaProps) => onInput(t0, t1).runNow()))
