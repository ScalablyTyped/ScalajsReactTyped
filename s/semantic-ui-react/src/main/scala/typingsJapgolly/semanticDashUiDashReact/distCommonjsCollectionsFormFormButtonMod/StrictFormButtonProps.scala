package typingsJapgolly.semanticDashUiDashReact.distCommonjsCollectionsFormFormButtonMod
...
import typingsJapgolly.semanticDashUiDashReact.distCommonjsElementsButtonButtonMod.StrictButtonProps
