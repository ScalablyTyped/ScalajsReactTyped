package typingsJapgolly.semanticDashUiDashReact.distCommonjsAddonsRadioRadioMod
...
import typingsJapgolly.semanticDashUiDashReact.distCommonjsModulesCheckboxCheckboxMod.StrictCheckboxProps
