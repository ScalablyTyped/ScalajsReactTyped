...
import typingsJapgolly.semanticDashUiDashReact.distCommonjsAddonsRadioRadioMod.RadioProps
...
object Radio {
  def apply(
    ...
    RadioProps, 
    MountedWithRawType[RadioProps, js.Object, RawMounted[RadioProps, js.Object]]
  ] = {
