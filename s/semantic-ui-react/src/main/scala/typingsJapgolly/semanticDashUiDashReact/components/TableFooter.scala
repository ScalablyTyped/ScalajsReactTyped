...
import typingsJapgolly.semanticDashUiDashReact.distCommonjsCollectionsTableTableFooterMod.TableFooterProps
...
object TableFooter {
  def apply(
    ...
    TableFooterProps, 
    MountedWithRawType[TableFooterProps, js.Object, RawMounted[TableFooterProps, js.Object]]
  ] = {
