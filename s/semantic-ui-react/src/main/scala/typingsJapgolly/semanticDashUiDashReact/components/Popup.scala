...
import typingsJapgolly.semanticDashUiDashReact.distCommonjsModulesPopupMod.default
...
import typingsJapgolly.semanticDashUiDashReact.distCommonjsModulesPopupPopupMod.PopupProps
