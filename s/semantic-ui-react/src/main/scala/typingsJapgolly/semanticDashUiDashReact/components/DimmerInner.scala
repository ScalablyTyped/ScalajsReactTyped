...
object DimmerInner {
  ...
  typingsJapgolly.semanticDashUiDashReact.distCommonjsModulesDimmerDimmerInnerMod.default](js.constructorOf[typingsJapgolly.semanticDashUiDashReact.distCommonjsModulesDimmerDimmerInnerMod.default])
