...
object Menu {
  ...
  typingsJapgolly.semanticDashUiDashReact.distCommonjsCollectionsMenuMod.default](js.constructorOf[typingsJapgolly.semanticDashUiDashReact.distCommonjsCollectionsMenuMod.default])
