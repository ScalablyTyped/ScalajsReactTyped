...
object Input {
  ...
  typingsJapgolly.semanticDashUiDashReact.distCommonjsElementsInputMod.default](js.constructorOf[typingsJapgolly.semanticDashUiDashReact.distCommonjsElementsInputMod.default])
