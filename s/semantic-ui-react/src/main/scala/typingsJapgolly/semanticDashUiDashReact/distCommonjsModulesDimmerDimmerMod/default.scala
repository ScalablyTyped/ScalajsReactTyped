package typingsJapgolly.semanticDashUiDashReact.distCommonjsModulesDimmerDimmerMod
...
object default extends TopLevel[DimmerComponent] {
  @js.native
  class Inner ()
    extends typingsJapgolly.semanticDashUiDashReact.distCommonjsModulesDimmerDimmerInnerMod.default
