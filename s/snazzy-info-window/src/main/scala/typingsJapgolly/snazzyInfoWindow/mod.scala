...
object mod {
  ...
  object Callbacks {
    ...
    extension [Self <: Callbacks](x: Self) {
      ...
      inline def setAfterClose(value: CallbackTo[Boolean | Unit]): Self = StObject.set(x, "afterClose", value.toJsFn)
      
      inline def setAfterCloseUndefined: Self = StObject.set(x, "afterClose", js.undefined)
      
      inline def setAfterOpen(value: CallbackTo[Boolean | Unit]): Self = StObject.set(x, "afterOpen", value.toJsFn)
      
      inline def setAfterOpenUndefined: Self = StObject.set(x, "afterOpen", js.undefined)
      
      inline def setBeforeClose(value: CallbackTo[Boolean | Unit]): Self = StObject.set(x, "beforeClose", value.toJsFn)
      
      inline def setBeforeCloseUndefined: Self = StObject.set(x, "beforeClose", js.undefined)
      
      inline def setBeforeOpen(value: CallbackTo[Boolean | Unit]): Self = StObject.set(x, "beforeOpen", value.toJsFn)
      
      inline def setBeforeOpenUndefined: Self = StObject.set(x, "beforeOpen", js.undefined)
      
      inline def setClose(value: CallbackTo[Boolean | Unit]): Self = StObject.set(x, "close", value.toJsFn)
      
      inline def setCloseUndefined: Self = StObject.set(x, "close", js.undefined)
      
      inline def setOpen(value: CallbackTo[Boolean | Unit]): Self = StObject.set(x, "open", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.top
    - typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.bottom
    - typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.left
    - typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.right
  */
  trait PlacementOptions extends StObject
  object PlacementOptions {
    
    inline def bottom: typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.bottom]
    
    inline def left: typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.left = "left".asInstanceOf[typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.left]
    
    inline def right: typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.right = "right".asInstanceOf[typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.right]
    
    inline def top: typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.top = "top".asInstanceOf[typingsJapgolly.snazzyInfoWindow.snazzyInfoWindowStrings.top]
  }
