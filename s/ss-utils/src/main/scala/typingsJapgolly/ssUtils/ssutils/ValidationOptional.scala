...
object ValidationOptional {
  ...
  extension [Self <: ValidationOptional](x: Self) {
    ...
    inline def setErrorFilter(value: (/* errorMsg */ String, /* errorCode */ String, /* type */ String) => Callback): Self = StObject.set(x, "errorFilter", js.Any.fromFunction3((t0: /* errorMsg */ String, t1: /* errorCode */ String, t2: /* type */ String) => (value(t0, t1, t2)).runNow()))
