...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'url'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplurlPartialPickImp
  extends StObject
     with Param {
...
object PickImplurlPartialPickImp {
  ...
  extension [Self <: PickImplurlPartialPickImp](x: Self) {
