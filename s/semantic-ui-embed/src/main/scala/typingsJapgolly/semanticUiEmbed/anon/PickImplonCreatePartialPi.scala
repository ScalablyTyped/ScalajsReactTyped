...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'onCreate'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplonCreatePartialPi
  extends StObject
     with Param {
...
object PickImplonCreatePartialPi {
  ...
  extension [Self <: PickImplonCreatePartialPi](x: Self) {
