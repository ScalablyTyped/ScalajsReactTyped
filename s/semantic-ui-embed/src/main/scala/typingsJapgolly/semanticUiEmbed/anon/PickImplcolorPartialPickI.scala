...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'color'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplcolorPartialPickI
  extends StObject
     with Param {
...
object PickImplcolorPartialPickI {
  ...
  extension [Self <: PickImplcolorPartialPickI](x: Self) {
