...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'hd'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplhdPartialPickImpl
  extends StObject
     with Param {
...
object PickImplhdPartialPickImpl {
  ...
  extension [Self <: PickImplhdPartialPickImpl](x: Self) {
