...
import typingsJapgolly.semanticUiEmbed.SemanticUI.EmbedSettings.Param
...
/* Inlined std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, 'onDisplay'> & std.Partial<std.Pick<semantic-ui-embed.SemanticUI.EmbedSettings._Impl, keyof semantic-ui-embed.SemanticUI.EmbedSettings._Impl>> */
trait PickImplonDisplayPartialP
  extends StObject
     with Param {
  ...
  def onDisplay(): Unit
  @JSName("onDisplay")
  var onDisplay_Original: (js.ThisFunction0[/* this */ JQuery, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ JQuery, Unit]])
