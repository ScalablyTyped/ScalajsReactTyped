...
object protocol {
  ...
  open class ClientDriver protected ()
    extends typingsJapgolly.samchon.mod.protocol.ClientDriver {
    /**
  ...
  open class DedicatedWorkerClientDriver ()
    extends typingsJapgolly.samchon.mod.protocol.DedicatedWorkerClientDriver
  
  /* note: abstract class */ @JSImport("samchon-framework", "protocol.DedicatedWorkerServer")
  @js.native
  open class DedicatedWorkerServer ()
    extends typingsJapgolly.samchon.mod.protocol.DedicatedWorkerServer
  ...
  open class DedicatedWorkerServerConnector protected ()
    extends typingsJapgolly.samchon.mod.protocol.DedicatedWorkerServerConnector {
    /**
  ...
  /**
    ...
    */
  open class Invoke ()
    extends typingsJapgolly.samchon.mod.protocol.Invoke {
    /**
      * Copy Constructor.
      *
      * @param invoke
  ...
  open class InvokeParameter ()
    extends typingsJapgolly.samchon.mod.protocol.InvokeParameter {
  ...
  @js.native
  open class Server ()
    extends typingsJapgolly.samchon.mod.protocol.Server
  ...
  open class ServerConnector protected ()
    extends typingsJapgolly.samchon.mod.protocol.ServerConnector {
    /**
      * Construct from *listener*.
      *
      * @param listener A listener object to listen replied message from newly connected client in
  ...
  open class SharedWorkerClientDriver protected ()
    extends typingsJapgolly.samchon.mod.protocol.SharedWorkerClientDriver {
    /**
  ...
  open class SharedWorkerServer ()
    extends typingsJapgolly.samchon.mod.protocol.SharedWorkerServer
  ...
  open class SharedWorkerServerConnector protected ()
    extends typingsJapgolly.samchon.mod.protocol.SharedWorkerServerConnector {
    /**
      * Construct from *listener*.
      *
      * @param listener A listener object to listen replied message from newly connected client in
  ...
  open class WebClientDriver protected ()
    extends typingsJapgolly.samchon.mod.protocol.WebClientDriver {
    /**
  ...
  open class WebServer ()
    extends typingsJapgolly.samchon.mod.protocol.WebServer
