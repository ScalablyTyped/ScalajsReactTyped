package typingsJapgolly.samchonFramework.mod.collections
...
class ListCollection[T] ()
  extends typingsJapgolly.ecol.listCollectionMod.ListCollection[T]
...
object ListCollection extends js.Object {
  ...
  class Iterator[T] protected ()
    extends typingsJapgolly.samchon.mod.collections.ListCollection.Iterator[T]
  ...
  class ReverseIterator[T] ()
    extends typingsJapgolly.ecol.listCollectionMod.ListCollection.ReverseIterator[T]
