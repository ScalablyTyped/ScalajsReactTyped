...
object libCoreFormatterMod {
  ...
  open class default protected ()
    extends StObject
       with Formatter {
    def this(cfg: Config, tokenizer: typingsJapgolly.sqltoolsFormatter.libCoreTokenizerMod.default) = this()
    def this(
      cfg: Config,
      tokenizer: typingsJapgolly.sqltoolsFormatter.libCoreTokenizerMod.default,
    ...
    /* CompleteClass */
    var tokenizer: typingsJapgolly.sqltoolsFormatter.libCoreTokenizerMod.default = js.native
  ...
  trait Formatter extends StObject {
    ...
    var tokenizer: typingsJapgolly.sqltoolsFormatter.libCoreTokenizerMod.default
  ...
  object Formatter {
    ...
    inline def apply(
      ...
      getFormattedQueryFromTokens: CallbackTo[String],
    ...
    extension [Self <: Formatter](x: Self) {
      ...
      inline def setGetFormattedQueryFromTokens(value: CallbackTo[String]): Self = StObject.set(x, "getFormattedQueryFromTokens", value.toJsFn)
      ...
      inline def setPreviousToken(value: CallbackTo[Token]): Self = StObject.set(x, "previousToken", value.toJsFn)
      
      inline def setTokenOverride(value: Any): Self = StObject.set(x, "tokenOverride", value.asInstanceOf[js.Any])
      
      inline def setTokenizer(value: typingsJapgolly.sqltoolsFormatter.libCoreTokenizerMod.default): Self = StObject.set(x, "tokenizer", value.asInstanceOf[js.Any])
