...
import typingsJapgolly.sqltoolsFormatter.sqltoolsFormatterStrings.db2
import typingsJapgolly.sqltoolsFormatter.sqltoolsFormatterStrings.lower
import typingsJapgolly.sqltoolsFormatter.sqltoolsFormatterStrings.n1ql
import typingsJapgolly.sqltoolsFormatter.sqltoolsFormatterStrings.plSlashsql
import typingsJapgolly.sqltoolsFormatter.sqltoolsFormatterStrings.preserve
import typingsJapgolly.sqltoolsFormatter.sqltoolsFormatterStrings.sql
import typingsJapgolly.sqltoolsFormatter.sqltoolsFormatterStrings.upper
...
object libCoreTypesMod {
  ...
  object TokenTypes extends StObject {
    ...
    sealed trait BLOCK_COMMENT
      extends StObject
         with TokenTypes
    /* "block-comment" */ val BLOCK_COMMENT: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.BLOCK_COMMENT & String = js.native
    
    @js.native
    sealed trait CLOSE_PAREN
      extends StObject
         with TokenTypes
    /* "close-paren" */ val CLOSE_PAREN: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.CLOSE_PAREN & String = js.native
    
    @js.native
    sealed trait LINE_COMMENT
      extends StObject
         with TokenTypes
    /* "line-comment" */ val LINE_COMMENT: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.LINE_COMMENT & String = js.native
    
    @js.native
    sealed trait NO_SPACE_OPERATOR
      extends StObject
         with TokenTypes
    /* "no-space-operator" */ val NO_SPACE_OPERATOR: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.NO_SPACE_OPERATOR & String = js.native
    
    @js.native
    sealed trait NUMBER
      extends StObject
         with TokenTypes
    /* "number" */ val NUMBER: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.NUMBER & String = js.native
    
    @js.native
    sealed trait OPEN_PAREN
      extends StObject
         with TokenTypes
    /* "open-paren" */ val OPEN_PAREN: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.OPEN_PAREN & String = js.native
    
    @js.native
    sealed trait OPERATOR
      extends StObject
         with TokenTypes
    /* "operator" */ val OPERATOR: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.OPERATOR & String = js.native
    
    @js.native
    sealed trait PLACEHOLDER
      extends StObject
         with TokenTypes
    /* "placeholder" */ val PLACEHOLDER: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.PLACEHOLDER & String = js.native
    
    @js.native
    sealed trait RESERVED
      extends StObject
         with TokenTypes
    /* "reserved" */ val RESERVED: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.RESERVED & String = js.native
    
    @js.native
    sealed trait RESERVED_NEWLINE
      extends StObject
         with TokenTypes
    /* "reserved-newline" */ val RESERVED_NEWLINE: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.RESERVED_NEWLINE & String = js.native
    
    @js.native
    sealed trait RESERVED_TOP_LEVEL
      extends StObject
         with TokenTypes
    /* "reserved-top-level" */ val RESERVED_TOP_LEVEL: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.RESERVED_TOP_LEVEL & String = js.native
    
    @js.native
    sealed trait RESERVED_TOP_LEVEL_NO_INDENT
      extends StObject
         with TokenTypes
    /* "reserved-top-level-no-indent" */ val RESERVED_TOP_LEVEL_NO_INDENT: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.RESERVED_TOP_LEVEL_NO_INDENT & String = js.native
    
    @js.native
    sealed trait SERVERVARIABLE
      extends StObject
         with TokenTypes
    /* "servervariable" */ val SERVERVARIABLE: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.SERVERVARIABLE & String = js.native
    
    @js.native
    sealed trait STRING
      extends StObject
         with TokenTypes
    /* "string" */ val STRING: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.STRING & String = js.native
    
    @js.native
    sealed trait WHITESPACE
      extends StObject
         with TokenTypes
    /* "whitespace" */ val WHITESPACE: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.WHITESPACE & String = js.native
    
    @js.native
    sealed trait WORD
      extends StObject
         with TokenTypes
    /* "word" */ val WORD: typingsJapgolly.sqltoolsFormatter.libCoreTypesMod.TokenTypes.WORD & String = js.native
  }
