package typingsJapgolly.saywhen
...
object mod {
  ...
  inline def apply[T /* <: Func */](spy: T & Spy[typingsJapgolly.jasmine.jasmine.Func]): CallHandler[T] = ^.asInstanceOf[js.Dynamic].apply(spy.asInstanceOf[js.Any]).asInstanceOf[CallHandler[T]]
