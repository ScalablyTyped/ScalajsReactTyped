...
import typingsJapgolly.speedMeasureWebpackPlugin.anon.FilePath
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOutputTargetFunction2(value: (/* output */ String, /* repeated */ Any) => Callback): Self = StObject.set(x, "outputTarget", js.Any.fromFunction2((t0: /* output */ String, t1: /* repeated */ Any) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.speedMeasureWebpackPlugin.speedMeasureWebpackPluginStrings.json
    - typingsJapgolly.speedMeasureWebpackPlugin.speedMeasureWebpackPluginStrings.human
    - typingsJapgolly.speedMeasureWebpackPlugin.speedMeasureWebpackPluginStrings.humanVerbose
  ...
  */
  ...
  object SpeedMeasurePlugin {
    ...
    inline def apply(apply: Compiler => Callback, wrap: Configuration => Configuration): SpeedMeasurePlugin = {
      val __obj = js.Dynamic.literal(apply = js.Any.fromFunction1((t0: Compiler) => apply(t0).runNow()), wrap = js.Any.fromFunction1(wrap))
