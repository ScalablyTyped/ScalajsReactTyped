...
object typesIntegrationsMod {
  ...
  open class FunctionToString ()
    extends typingsJapgolly.sentryCore.typesIntegrationsFunctiontostringMod.FunctionToString
  /* static members */
  ...
  open class InboundFilters ()
    extends typingsJapgolly.sentryCore.typesIntegrationsInboundfiltersMod.InboundFilters {
