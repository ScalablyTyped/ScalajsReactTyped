...
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMIBlank
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMIBoolean
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMIDecimal
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMIFeedback
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMIIdentifier
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMIInteger
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMISInteger
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMIString255
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMIString4096
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMITime
import typingsJapgolly.scormBrowser.`1Dot2CmidatatypesMod`.CMITimeSpan
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementComments
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCommentsFromLMS
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreChildren
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreCredit
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreEntry
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreExit
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreLessonLocation
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreLessonMode
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreLessonStatus
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreScoreChildren
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreScoreMax
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreScoreMin
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreScoreRaw
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreSessionTime
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreStudentId
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreStudentName
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementCoreTotalTime
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsChildren
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsCount
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNCorrectResponsesCount
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNCorrectResponsesNPattern
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNID
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNLatency
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNObjectivesCount
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNResult
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNStudentResponse
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNTime
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNType
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementInteractionsNWeighting
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementLaunchData
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesChildren
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesCount
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNID
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNScoreChildren
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNScoreMax
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNScoreMin
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNScoreRaw
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementObjectivesNStatus
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentDataChildren
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentDataMasteryScore
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentDataMaxTimeAllowed
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentDataTimeLimitAction
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceAudio
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceChildren
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceLanguage
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceSpeed
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementStudentPreferenceText
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementSuspendData
import typingsJapgolly.scormBrowser.`1Dot2CmielementMod`.CMIElementVersion
import typingsJapgolly.scormBrowser.`1Dot2CmierrorcodeMod`.CMIErrorCode
...
import typingsJapgolly.scormBrowser.`1Dot2CmivocabularyMod`.CMIVocabularyResult
import typingsJapgolly.scormBrowser.`1Dot2CmivocabularyMod`.CMIVocabularyStatus
import typingsJapgolly.scormBrowser.`1Dot2CmivocabularyMod`.CMIVocabularyTimeLimitAction
