...
import typingsJapgolly.semanticUiDropdown.SemanticUI.Dropdown.SelectorSettings.Param
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'input'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImplinputPartialPickI
  ...
  var input: String & js.UndefOr[String]
...
object PickImplinputPartialPickI {
  ...
  inline def apply(input: String & js.UndefOr[String]): PickImplinputPartialPickI = {
  ...
  extension [Self <: PickImplinputPartialPickI](x: Self) {
    ...
    inline def setInput(value: String & js.UndefOr[String]): Self = StObject.set(x, "input", value.asInstanceOf[js.Any])
