...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'menu'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImplmenuPartialPickIm
  extends StObject
     with Param {
...
object PickImplmenuPartialPickIm {
  ...
  extension [Self <: PickImplmenuPartialPickIm](x: Self) {
