...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'onAdd'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplonAddPartialPickI
  extends StObject
     with Param {
...
object PickImplonAddPartialPickI {
  ...
  extension [Self <: PickImplonAddPartialPickI](x: Self) {
