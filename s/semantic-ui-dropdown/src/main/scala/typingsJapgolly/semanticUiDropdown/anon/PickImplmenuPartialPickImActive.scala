...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'menu'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImplmenuPartialPickImActive
  extends StObject
     with Param {
...
object PickImplmenuPartialPickImActive {
  ...
  extension [Self <: PickImplmenuPartialPickImActive](x: Self) {
