...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'allowCategorySelection'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplallowCategorySele
  extends StObject
     with Param {
  ...
  var allowCategorySelection: Boolean & js.UndefOr[Boolean]
...
object PickImplallowCategorySele {
  ...
  inline def apply(allowCategorySelection: Boolean & js.UndefOr[Boolean]): PickImplallowCategorySele = {
  ...
  extension [Self <: PickImplallowCategorySele](x: Self) {
    ...
    inline def setAllowCategorySelection(value: Boolean & js.UndefOr[Boolean]): Self = StObject.set(x, "allowCategorySelection", value.asInstanceOf[js.Any])
