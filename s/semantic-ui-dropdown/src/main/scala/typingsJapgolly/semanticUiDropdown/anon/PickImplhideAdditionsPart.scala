...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'hideAdditions'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplhideAdditionsPart
  extends StObject
     with Param {
...
object PickImplhideAdditionsPart {
  ...
  extension [Self <: PickImplhideAdditionsPart](x: Self) {
