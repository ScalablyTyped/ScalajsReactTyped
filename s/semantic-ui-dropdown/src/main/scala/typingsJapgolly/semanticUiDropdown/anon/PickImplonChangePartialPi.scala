...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'onChange'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplonChangePartialPi
  ...
  @JSName("onChange")
  var onChange_Original: (js.ThisFunction3[/* this */ JQuery, /* value */ Any, /* text */ String, /* $choice */ JQuery, Unit]) & (js.UndefOr[
...
object PickImplonChangePartialPi {
  ...
  extension [Self <: PickImplonChangePartialPi](x: Self) {
    ...
    inline def setOnChange(
      value: (js.ThisFunction3[/* this */ JQuery, /* value */ Any, /* text */ String, /* $choice */ JQuery, Unit]) & (js.UndefOr[
          js.ThisFunction3[/* this */ JQuery, /* value */ Any, /* text */ String, /* $choice */ JQuery, Unit]
        ])
