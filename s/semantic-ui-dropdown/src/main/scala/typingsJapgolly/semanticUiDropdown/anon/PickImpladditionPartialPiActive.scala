...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'addition'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImpladditionPartialPiActive
  extends StObject
     with Param {
...
object PickImpladditionPartialPiActive {
  ...
  extension [Self <: PickImpladditionPartialPiActive](x: Self) {
