...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'message'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImplmessagePartialPicAddition
  extends StObject
     with Param {
...
object PickImplmessagePartialPicAddition {
  ...
  extension [Self <: PickImplmessagePartialPicAddition](x: Self) {
