...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'sortSelect'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplsortSelectPartial
  extends StObject
     with Param {
...
object PickImplsortSelectPartial {
  ...
  extension [Self <: PickImplsortSelectPartial](x: Self) {
