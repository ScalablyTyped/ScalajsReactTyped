...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'allowReselection'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplallowReselectionP
  extends StObject
     with Param {
...
object PickImplallowReselectionP {
  ...
  extension [Self <: PickImplallowReselectionP](x: Self) {
