...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'filterRemoteData'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplfilterRemoteDataP
  extends StObject
     with Param {
...
object PickImplfilterRemoteDataP {
  ...
  extension [Self <: PickImplfilterRemoteDataP](x: Self) {
