...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, 'placeholder'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.ClassNameSettings._Impl>> */
trait PickImplplaceholderPartiaActive
  extends StObject
     with Param {
...
object PickImplplaceholderPartiaActive {
  ...
  extension [Self <: PickImplplaceholderPartiaActive](x: Self) {
