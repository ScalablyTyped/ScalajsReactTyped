...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'allowTab'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplallowTabPartialPi
  extends StObject
     with Param {
...
object PickImplallowTabPartialPi {
  ...
  extension [Self <: PickImplallowTabPartialPi](x: Self) {
