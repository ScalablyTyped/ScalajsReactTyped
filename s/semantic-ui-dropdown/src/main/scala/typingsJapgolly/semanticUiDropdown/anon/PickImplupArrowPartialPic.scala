...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, 'upArrow'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl>> */
trait PickImplupArrowPartialPic
  extends StObject
     with Param {
...
object PickImplupArrowPartialPic {
  ...
  extension [Self <: PickImplupArrowPartialPic](x: Self) {
