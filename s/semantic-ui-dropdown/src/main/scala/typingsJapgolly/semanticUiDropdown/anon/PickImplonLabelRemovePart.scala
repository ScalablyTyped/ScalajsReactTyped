...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'onLabelRemove'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplonLabelRemovePart
  extends StObject
     with Param {
...
object PickImplonLabelRemovePart {
  ...
  extension [Self <: PickImplonLabelRemovePart](x: Self) {
