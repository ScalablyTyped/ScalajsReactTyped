...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, 'search'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.SelectorSettings._Impl>> */
trait PickImplsearchPartialPickAddition
  extends StObject
     with Param {
...
object PickImplsearchPartialPickAddition {
  ...
  extension [Self <: PickImplsearchPartialPickAddition](x: Self) {
