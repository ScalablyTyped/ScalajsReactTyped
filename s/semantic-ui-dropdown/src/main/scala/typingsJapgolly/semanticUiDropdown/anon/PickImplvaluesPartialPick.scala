...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, 'values'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl, keyof semantic-ui-dropdown.SemanticUI.DropdownSettings._Impl>> */
trait PickImplvaluesPartialPick
  extends StObject
     with Param {
  ...
  var values: Any & js.UndefOr[Any]
  
  var verbose: js.UndefOr[Boolean] = js.undefined
}
object PickImplvaluesPartialPick {
  
  inline def apply(values: Any & js.UndefOr[Any]): PickImplvaluesPartialPick = {
    val __obj = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
    __obj.asInstanceOf[PickImplvaluesPartialPick]
  }
  
  extension [Self <: PickImplvaluesPartialPick](x: Self) {
    ...
    inline def setValues(value: Any & js.UndefOr[Any]): Self = StObject.set(x, "values", value.asInstanceOf[js.Any])
