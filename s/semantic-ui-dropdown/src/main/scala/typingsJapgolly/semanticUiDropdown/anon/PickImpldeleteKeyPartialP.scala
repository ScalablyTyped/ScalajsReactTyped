...
/* Inlined std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, 'deleteKey'> & std.Partial<std.Pick<semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl, keyof semantic-ui-dropdown.SemanticUI.Dropdown.KeySettings._Impl>> */
trait PickImpldeleteKeyPartialP
  extends StObject
     with Param {
...
object PickImpldeleteKeyPartialP {
  ...
  extension [Self <: PickImpldeleteKeyPartialP](x: Self) {
