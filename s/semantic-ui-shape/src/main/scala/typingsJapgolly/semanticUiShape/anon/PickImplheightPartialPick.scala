...
/* Inlined std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, 'height'> & std.Partial<std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, keyof semantic-ui-shape.SemanticUI.ShapeSettings._Impl>> */
trait PickImplheightPartialPick
  extends StObject
     with Param {
...
object PickImplheightPartialPick {
  ...
  extension [Self <: PickImplheightPartialPick](x: Self) {
