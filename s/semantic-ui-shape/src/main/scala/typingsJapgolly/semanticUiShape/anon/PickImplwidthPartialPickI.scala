...
/* Inlined std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, 'width'> & std.Partial<std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, keyof semantic-ui-shape.SemanticUI.ShapeSettings._Impl>> */
trait PickImplwidthPartialPickI
  extends StObject
     with Param {
...
object PickImplwidthPartialPickI {
  ...
  extension [Self <: PickImplwidthPartialPickI](x: Self) {
