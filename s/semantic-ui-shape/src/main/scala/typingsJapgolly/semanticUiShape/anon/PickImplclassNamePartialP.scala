...
/* Inlined std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, 'className'> & std.Partial<std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, keyof semantic-ui-shape.SemanticUI.ShapeSettings._Impl>> */
