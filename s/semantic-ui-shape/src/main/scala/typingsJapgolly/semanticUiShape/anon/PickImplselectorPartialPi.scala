...
/* Inlined std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, 'selector'> & std.Partial<std.Pick<semantic-ui-shape.SemanticUI.ShapeSettings._Impl, keyof semantic-ui-shape.SemanticUI.ShapeSettings._Impl>> */
