...
import typingsJapgolly.styletronReact.anon.Base
import typingsJapgolly.styletronReact.anon.ClassName
import typingsJapgolly.styletronReact.anon.Ref
import typingsJapgolly.styletronReact.anon.StackInfo
...
import typingsJapgolly.styletronReact.styletronReactStrings.$style
import typingsJapgolly.styletronReact.styletronReactStrings.className
...
object libTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.styletronReact.libTypesMod.AssignmentCommutativeReducerContainer
    - typingsJapgolly.styletronReact.libTypesMod.NonAssignmentCommutativeReducerContainer
  */
  trait ReducerContainer extends StObject
  object ReducerContainer {
    
    inline def AssignmentCommutativeReducerContainer(
      factory: StyleObject => typingsJapgolly.styletronReact.libTypesMod.AssignmentCommutativeReducerContainer,
      reducer: StyleObject => StyleObject,
      style: StyleObject
    ): typingsJapgolly.styletronReact.libTypesMod.AssignmentCommutativeReducerContainer = {
      val __obj = js.Dynamic.literal(assignmentCommutative = true, factory = js.Any.fromFunction1(factory), reducer = js.Any.fromFunction1(reducer), style = style.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.styletronReact.libTypesMod.AssignmentCommutativeReducerContainer]
    }
    
    inline def NonAssignmentCommutativeReducerContainer(reducer: (StyleObject, Any) => StyleObject): typingsJapgolly.styletronReact.libTypesMod.NonAssignmentCommutativeReducerContainer = {
      val __obj = js.Dynamic.literal(assignmentCommutative = false, reducer = js.Any.fromFunction2(reducer))
      __obj.asInstanceOf[typingsJapgolly.styletronReact.libTypesMod.NonAssignmentCommutativeReducerContainer]
    }
  }
  ...
  type StyledFn = js.Function2[
    ...
    StyletronComponent[ElementType, Any]
  ]
  ...
  @js.native
  trait StyletronComponent[D /* <: ElementType */, P /* <: js.Object */] extends StObject {
    
    def apply[C /* <: ElementType */](props: As[C] & (OverrideProps[C, P])): Element = js.native
  ...
  trait StyletronProps[Props] extends StObject {
    ...
    @JSName("$as")
    var $as: js.UndefOr[
        /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typingsJapgolly.react.mod.ComponentType[scala.Any], typingsJapgolly.styletronReact.styletronReactStrings.a, typingsJapgolly.styletronReact.styletronReactStrings.abbr */ Any
      ] = js.undefined
  ...
  object StyletronProps {
    ...
    extension [Self <: StyletronProps[?], Props](x: Self & StyletronProps[Props]) {
      ...
      inline def set$as(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 177, starting with typingsJapgolly.react.mod.ComponentType[scala.Any], typingsJapgolly.styletronReact.styletronReactStrings.a, typingsJapgolly.styletronReact.styletronReactStrings.abbr */ Any
