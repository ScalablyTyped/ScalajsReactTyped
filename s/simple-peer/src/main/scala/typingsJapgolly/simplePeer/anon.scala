...
import typingsJapgolly.simplePeer.mod._SignalData
import typingsJapgolly.simplePeer.simplePeerBooleans.`true`
import typingsJapgolly.simplePeer.simplePeerStrings.IPv4
import typingsJapgolly.simplePeer.simplePeerStrings.IPv6
import typingsJapgolly.simplePeer.simplePeerStrings.candidate
import typingsJapgolly.simplePeer.simplePeerStrings.renegotiate
import typingsJapgolly.simplePeer.simplePeerStrings.transceiverRequest
import typingsJapgolly.std.AlgorithmIdentifier
import typingsJapgolly.std.RTCCertificate
...
object anon {
  ...
  trait Candidate
    ...
    var candidate: org.scalajs.dom.RTCIceCandidate
    
    var `type`: candidate
  }
  object Candidate {
    
    inline def apply(candidate: org.scalajs.dom.RTCIceCandidate): Candidate = {
