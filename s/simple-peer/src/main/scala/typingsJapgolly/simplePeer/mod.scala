package typingsJapgolly.simplePeer
...
import typingsJapgolly.simplePeer.anon.Address
import typingsJapgolly.simplePeer.anon.Family
import typingsJapgolly.simplePeer.anon.Init
import typingsJapgolly.simplePeer.anon.RTCIceCandidate
import typingsJapgolly.simplePeer.simplePeerStrings.close
import typingsJapgolly.simplePeer.simplePeerStrings.connect
import typingsJapgolly.simplePeer.simplePeerStrings.data
import typingsJapgolly.simplePeer.simplePeerStrings.end
import typingsJapgolly.simplePeer.simplePeerStrings.error
import typingsJapgolly.simplePeer.simplePeerStrings.pause
import typingsJapgolly.simplePeer.simplePeerStrings.readable
import typingsJapgolly.simplePeer.simplePeerStrings.resume
import typingsJapgolly.simplePeer.simplePeerStrings.signal
import typingsJapgolly.simplePeer.simplePeerStrings.stream
import typingsJapgolly.simplePeer.simplePeerStrings.track
import typingsJapgolly.std.RTCAnswerOptions
import typingsJapgolly.std.RTCRtpTransceiverInit
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.simplePeer.anon.TransceiverRequest
    - typingsJapgolly.simplePeer.anon.Renegotiate
    - typingsJapgolly.simplePeer.anon.Candidate
    - org.scalajs.dom.RTCSessionDescriptionInit
  */
  ...
  object _SignalData {
    ...
    inline def Candidate(candidate: org.scalajs.dom.RTCIceCandidate): typingsJapgolly.simplePeer.anon.Candidate = {
      val __obj = js.Dynamic.literal(candidate = candidate.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("candidate")
      __obj.asInstanceOf[typingsJapgolly.simplePeer.anon.Candidate]
    }
    
    inline def Renegotiate(): typingsJapgolly.simplePeer.anon.Renegotiate = {
      val __obj = js.Dynamic.literal(renegotiate = true)
      __obj.updateDynamic("type")("renegotiate")
      __obj.asInstanceOf[typingsJapgolly.simplePeer.anon.Renegotiate]
    }
    
    inline def TransceiverRequest(transceiverRequest: Init): typingsJapgolly.simplePeer.anon.TransceiverRequest = {
      ...
      __obj.asInstanceOf[typingsJapgolly.simplePeer.anon.TransceiverRequest]
    }
  }
