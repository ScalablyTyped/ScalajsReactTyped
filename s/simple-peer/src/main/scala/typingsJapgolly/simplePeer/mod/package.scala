...
package object mod {
  type SimplePeerData = java.lang.String | typingsJapgolly.node.Buffer | typingsJapgolly.simplePeer.mod.TypedArray | scala.scalajs.js.typedarray.ArrayBuffer | org.scalajs.dom.raw.Blob
