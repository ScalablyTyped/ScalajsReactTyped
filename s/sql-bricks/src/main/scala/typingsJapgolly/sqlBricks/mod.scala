...
import typingsJapgolly.sqlBricks.anon.Placeholder
...
object mod extends Shortcut {
  ...
  */
  ...
  object _WhereExpression {
    ...
    inline def WhereBinary(col: String | SelectStatement, op: String, quantifier: String, `val`: Any): typingsJapgolly.sqlBricks.mod.WhereBinary = {
      val __obj = js.Dynamic.literal(col = col.asInstanceOf[js.Any], op = op.asInstanceOf[js.Any], quantifier = quantifier.asInstanceOf[js.Any])
      __obj.updateDynamic("val")(`val`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.sqlBricks.mod.WhereBinary]
    }
    
    inline def WhereGroup(expressions: js.Array[WhereExpression]): typingsJapgolly.sqlBricks.mod.WhereGroup = {
      val __obj = js.Dynamic.literal(expressions = expressions.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.sqlBricks.mod.WhereGroup]
    }
  }
