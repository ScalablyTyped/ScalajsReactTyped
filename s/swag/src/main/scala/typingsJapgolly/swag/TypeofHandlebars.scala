...
trait TypeofHandlebars extends js.Object {
  ...
  var Exception: Instantiable1[/* message */ String, typingsJapgolly.handlebars.Handlebars.Exception] = js.native
  ...
  def create(): typingsJapgolly.handlebars.TypeofHandlebars = js.native
  ...
  def noConflict(): typingsJapgolly.handlebars.TypeofHandlebars = js.native
