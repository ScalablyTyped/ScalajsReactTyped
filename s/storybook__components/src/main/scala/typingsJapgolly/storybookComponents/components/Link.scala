...
import typingsJapgolly.storybookComponents.linkMod.AProps
import typingsJapgolly.storybookComponents.linkMod.LinkProps
...
object Link {
  def apply(
    ...
    LinkProps with AProps, 
    MountedWithRawType[LinkProps with AProps, js.Object, RawMounted[LinkProps with AProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.storybookComponents.linkMod.LinkProps with typingsJapgolly.storybookComponents.linkMod.AProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.storybookComponents.linkMod.LinkProps with typingsJapgolly.storybookComponents.linkMod.AProps])(children: _*)
  }
