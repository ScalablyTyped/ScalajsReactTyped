...
import typingsJapgolly.storybookComponents.inputMod.InputStyleProps
...
trait StyledComponentPickPickHT extends js.Object {
  ...
  def apply(props: PropsWithChildrenPickPick): Element | Null = js.native
  def apply(props: PropsWithChildrenPickPick, context: js.Any): Element | Null = js.native
