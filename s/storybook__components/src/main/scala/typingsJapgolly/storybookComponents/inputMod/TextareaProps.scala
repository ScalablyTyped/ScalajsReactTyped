...
/* Inlined std.Omit<react-textarea-autosize.react-textarea-autosize.TextareaAutosizeProps, keyof @storybook/components.@storybook/components/dist/form/input/input.InputStyleProps> & @storybook/components.@storybook/components/dist/form/input/input.InputStyleProps */
@js.native
trait TextareaProps extends js.Object {
  ...
  var inputRef: js.UndefOr[
    (js.Function1[/* node */ HTMLTextAreaElement, Unit]) | RefHandle[HTMLTextAreaElement]
  ] = js.native
  ...
  var onChange: js.UndefOr[js.Function1[/* event */ ReactEventFrom[HTMLTextAreaElement], Unit]] = js.native
...
object TextareaProps {
  ...
  def apply(
    ...
    ref: LegacyRef[HTMLTextAreaElement] = null,
    rel: String = null,
