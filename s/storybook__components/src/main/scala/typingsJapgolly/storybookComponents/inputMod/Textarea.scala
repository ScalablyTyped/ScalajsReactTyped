...
import typingsJapgolly.storybookComponents.PartialPickTextareaPropsc
import typingsJapgolly.storybookComponents.PropsWithChildrenPickText
import typingsJapgolly.storybookComponents.WeakValidationMapPickText
...
object Textarea extends js.Object {
  ...
  def apply(props: PropsWithChildrenPickText): Element | Null = js.native
  def apply(props: PropsWithChildrenPickText, context: js.Any): Element | Null = js.native
