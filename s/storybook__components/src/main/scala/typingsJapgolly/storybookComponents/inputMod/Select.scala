...
import typingsJapgolly.storybookComponents.PartialPickSelectHTMLAttr
import typingsJapgolly.storybookComponents.PropsWithChildrenPickSeleAbout
import typingsJapgolly.storybookComponents.WeakValidationMapPickSele
...
object Select extends js.Object {
  ...
  def apply(props: PropsWithChildrenPickSeleAbout): Element | Null = js.native
  def apply(props: PropsWithChildrenPickSeleAbout, context: js.Any): Element | Null = js.native
