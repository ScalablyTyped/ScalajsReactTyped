...
object global {
  ...
  open class Builder ()
    extends StObject
       with typingsJapgolly.spacePen.Builder {
    ...
    /* CompleteClass */
    override def subview(outletName: Any, subview: typingsJapgolly.spacePen.View): Unit = js.native
  ...
  open class View protected ()
    extends StObject
       with typingsJapgolly.spacePen.View {
    def this(args: Any*) = this()
    
    /* CompleteClass */
    override def bindEventHandlers(view: typingsJapgolly.spacePen.View): Unit = js.native
    ...
    // tag end
    /* CompleteClass */
    override def initialize(view: typingsJapgolly.spacePen.View, args: Any): Unit = js.native
    ...
    /* CompleteClass */
    override def wireOutlets(view: typingsJapgolly.spacePen.View): Unit = js.native
  }
  object View {
    ...
    @js.native
    def builderStack: js.Array[typingsJapgolly.spacePen.Builder] = js.native
    inline def builderStack_=(x: js.Array[typingsJapgolly.spacePen.Builder]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("builderStack")(x.asInstanceOf[js.Any])
    ...
    /* static member */
    inline def popBuilder(): typingsJapgolly.spacePen.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("popBuilder")().asInstanceOf[typingsJapgolly.spacePen.Builder]
