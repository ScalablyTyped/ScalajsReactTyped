...
object mod {
  ...
  open class Builder () extends StObject {
    ...
    def subview(outletName: Any, subview: typingsJapgolly.spacePen.mod.View): Unit = js.native
  ...
  open class View protected () extends StObject {
    ...
    def bindEventHandlers(view: typingsJapgolly.spacePen.mod.View): Unit = js.native
    ...
    // tag end
    def initialize(view: typingsJapgolly.spacePen.mod.View, args: Any): Unit = js.native
    
    def preempt(eventName: Any, handler: Any): Any = js.native
    
    def pushStack(elems: Any): Any = js.native
    
    def wireOutlets(view: typingsJapgolly.spacePen.mod.View): Unit = js.native
  }
  object View {
    ...
    @js.native
    def builderStack: js.Array[typingsJapgolly.spacePen.mod.Builder] = js.native
    inline def builderStack_=(x: js.Array[typingsJapgolly.spacePen.mod.Builder]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("builderStack")(x.asInstanceOf[js.Any])
    ...
    /* static member */
    inline def popBuilder(): typingsJapgolly.spacePen.mod.Builder = ^.asInstanceOf[js.Dynamic].applyDynamic("popBuilder")().asInstanceOf[typingsJapgolly.spacePen.mod.Builder]
