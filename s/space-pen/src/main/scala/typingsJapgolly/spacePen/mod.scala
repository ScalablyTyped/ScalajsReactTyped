...
object mod extends js.Object {
  ...
  class Builder () extends js.Object {
    ...
    def subview(outletName: js.Any, subview: typingsJapgolly.spacePen.mod.View): Unit = js.native
  ...
  class View protected () extends js.Object {
    ...
    // tag end
    def initialize(view: typingsJapgolly.spacePen.mod.View, args: js.Any): Unit = js.native
  ...
  object View extends js.Object {
    var builderStack: js.Array[typingsJapgolly.spacePen.mod.Builder] = js.native
    // tag start
    ...
    def popBuilder(): typingsJapgolly.spacePen.mod.Builder = js.native
