...
object typesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.shevyjs.shevyjsStrings.h1
    - typingsJapgolly.shevyjs.shevyjsStrings.h2
    - typingsJapgolly.shevyjs.shevyjsStrings.h3
    - typingsJapgolly.shevyjs.shevyjsStrings.h4
    - typingsJapgolly.shevyjs.shevyjsStrings.h5
    - typingsJapgolly.shevyjs.shevyjsStrings.h6
  */
  trait Heading extends StObject
  object Heading {
    
    inline def h1: typingsJapgolly.shevyjs.shevyjsStrings.h1 = "h1".asInstanceOf[typingsJapgolly.shevyjs.shevyjsStrings.h1]
    
    inline def h2: typingsJapgolly.shevyjs.shevyjsStrings.h2 = "h2".asInstanceOf[typingsJapgolly.shevyjs.shevyjsStrings.h2]
    
    inline def h3: typingsJapgolly.shevyjs.shevyjsStrings.h3 = "h3".asInstanceOf[typingsJapgolly.shevyjs.shevyjsStrings.h3]
    
    inline def h4: typingsJapgolly.shevyjs.shevyjsStrings.h4 = "h4".asInstanceOf[typingsJapgolly.shevyjs.shevyjsStrings.h4]
    
    inline def h5: typingsJapgolly.shevyjs.shevyjsStrings.h5 = "h5".asInstanceOf[typingsJapgolly.shevyjs.shevyjsStrings.h5]
    
    inline def h6: typingsJapgolly.shevyjs.shevyjsStrings.h6 = "h6".asInstanceOf[typingsJapgolly.shevyjs.shevyjsStrings.h6]
  }
