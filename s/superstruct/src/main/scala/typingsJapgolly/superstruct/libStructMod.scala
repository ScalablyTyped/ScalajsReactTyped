...
import typingsJapgolly.superstruct.anon.Coerce
import typingsJapgolly.superstruct.anon.PartialFailure
import typingsJapgolly.superstruct.anon.`0`
import typingsJapgolly.superstruct.libErrorMod.Failure
import typingsJapgolly.superstruct.libErrorMod.StructError
import typingsJapgolly.superstruct.libUtilsMod.StructSchema
...
object libStructMod {
  ...
  open class Struct[T, S] protected () extends StObject {
    def this(props: typingsJapgolly.superstruct.anon.Coercer[S, T]) = this()
