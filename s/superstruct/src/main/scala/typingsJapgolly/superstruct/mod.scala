...
import typingsJapgolly.superstruct.anon.Coercer
import typingsJapgolly.superstruct.anon.Exclusive
import typingsJapgolly.superstruct.anon.Instantiable
import typingsJapgolly.superstruct.anon.Strict
import typingsJapgolly.superstruct.libErrorMod.Failure
import typingsJapgolly.superstruct.libStructMod.Context
...
import typingsJapgolly.superstruct.libStructMod.Validator
import typingsJapgolly.superstruct.libUtilsMod.AnyStruct
import typingsJapgolly.superstruct.libUtilsMod.Assign
import typingsJapgolly.superstruct.libUtilsMod.ObjectSchema
import typingsJapgolly.superstruct.libUtilsMod.ObjectType
import typingsJapgolly.superstruct.libUtilsMod.PartialObjectSchema
import typingsJapgolly.superstruct.libUtilsMod.UnionToIntersection
...
object mod {
  ...
  open class StructError protected ()
    extends typingsJapgolly.superstruct.libErrorMod.StructError {
  ...
  inline def coerce[T, S, C](
    ...
    coercer: typingsJapgolly.superstruct.libStructMod.Coercer[C]
  ...
  inline def validate[T, S](value: Any, struct: Struct[T, S]): js.Tuple2[typingsJapgolly.superstruct.libErrorMod.StructError | Unit, T | Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("validate")(value.asInstanceOf[js.Any], struct.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[typingsJapgolly.superstruct.libErrorMod.StructError | Unit, T | Unit]]
  inline def validate[T, S](value: Any, struct: Struct[T, S], options: Coerce): js.Tuple2[typingsJapgolly.superstruct.libErrorMod.StructError | Unit, T | Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("validate")(value.asInstanceOf[js.Any], struct.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Tuple2[typingsJapgolly.superstruct.libErrorMod.StructError | Unit, T | Unit]]
}
