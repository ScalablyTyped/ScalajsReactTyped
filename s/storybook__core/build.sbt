...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "storybook__client-api" % "6.5.12-3ca99e",
  "org.scalablytyped.japgolly" %%% "storybook__core-client" % "6.5.12-18bfb1",
  ...
  "org.scalablytyped.japgolly" %%% "storybook__ui" % "6.5.12-d8007a",
