...
object mod extends js.Object {
  ...
  def fromError(error: js.Error): js.Promise[js.Array[StackFrame]] = js.native
  def fromError(error: js.Error, options: StackTraceOptions): js.Promise[js.Array[StackFrame]] = js.native
