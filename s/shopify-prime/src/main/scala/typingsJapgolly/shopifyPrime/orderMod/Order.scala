package typingsJapgolly.shopifyPrime.orderMod

import typingsJapgolly.shopifyPrime.AnonName
import typingsJapgolly.shopifyPrime.addressMod.Address
import typingsJapgolly.shopifyPrime.baseMod.ShopifyObject
import typingsJapgolly.shopifyPrime.clientDetailsMod.ClientDetails
import typingsJapgolly.shopifyPrime.customerMod.Customer
import typingsJapgolly.shopifyPrime.discountCodeMod.DiscountCode
import typingsJapgolly.shopifyPrime.financialStatusMod.FinancialStatus
import typingsJapgolly.shopifyPrime.fulfillmentMod.Fulfillment
import typingsJapgolly.shopifyPrime.lineItemMod.LineItem
import typingsJapgolly.shopifyPrime.paymentDetailsMod.PaymentDetails
import typingsJapgolly.shopifyPrime.refundMod.Refund
import typingsJapgolly.shopifyPrime.shippingLineMod.ShippingLine
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.fulfilled
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.partial
