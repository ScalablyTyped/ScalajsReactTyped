package typingsJapgolly.shopifyPrime.discountMod

import typingsJapgolly.shopifyPrime.baseMod.ShopifyObject
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.applies_to_resource
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.custom_collection
...
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.shipping
...
trait Discount extends ShopifyObject {
  ...
  var applies_to_resource: js.UndefOr[
    typingsJapgolly.shopifyPrime.shopifyPrimeStrings.applies_to_resource | custom_collection | String
  ] = js.undefined
  /**
