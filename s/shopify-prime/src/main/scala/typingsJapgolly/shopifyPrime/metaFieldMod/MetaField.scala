package typingsJapgolly.shopifyPrime.metaFieldMod

import typingsJapgolly.shopifyPrime.baseMod.ShopifyObject
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.integer
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.string
