package typingsJapgolly.shopifyPrime.priceRuleMod

import typingsJapgolly.shopifyPrime.AnonGreaterthanorequalto
import typingsJapgolly.shopifyPrime.AnonLessthanorequalto
import typingsJapgolly.shopifyPrime.baseMod.ShopifyObject
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.across
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.all
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.each
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.entitled
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.fixed_amount
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.line_item
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.percentage
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.prerequisite
import typingsJapgolly.shopifyPrime.shopifyPrimeStrings.shipping_line
