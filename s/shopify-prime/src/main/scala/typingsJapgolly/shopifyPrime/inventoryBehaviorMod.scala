...
object inventoryBehaviorMod extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.shopifyPrime.shopifyPrimeStrings.bypass
    - typingsJapgolly.shopifyPrime.shopifyPrimeStrings.decrement_ignoring_policy
    - typingsJapgolly.shopifyPrime.shopifyPrimeStrings.decrement_obeying_policy
    - java.lang.String
  */
