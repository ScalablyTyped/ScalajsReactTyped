package typingsJapgolly.shopifyPrime.giftCardMod
...
trait GiftCard extends ShopifyObject {
  ...
  /**
    ...
    */
  var disabled_at: js.UndefOr[js.Date] = js.undefined
  /**
    * The date and time when the gift card expires. The format must be YYYY-MM-DD.
    */
  var expires_on: js.UndefOr[js.Date] = js.undefined
  /**
    * Initial card value
    */
...
object GiftCard {
  ...
  def apply(
    ...
    code: String = null,
    created_at: js.Date = null,
    currency: String = null,
    disabled_at: js.Date = null,
    expires_on: js.Date = null,
    id: Int | Double = null,
