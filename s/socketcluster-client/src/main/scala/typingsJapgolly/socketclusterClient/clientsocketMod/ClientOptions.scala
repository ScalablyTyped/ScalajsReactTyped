...
object ClientOptions {
  ...
  def apply(
    ...
    callIdGenerator: js.UndefOr[CallbackTo[Double]] = js.undefined,
    ...
    version: String = null,
    wsOptions: typingsJapgolly.ws.mod.ClientOptions = null
  ): ClientOptions = {
    ...
    callIdGenerator.foreach(p => __obj.updateDynamic("callIdGenerator")(p.toJsFn))
