...
import typingsJapgolly.socketclusterClient.libClientsocketMod.CallIdGenerator
import typingsJapgolly.socketclusterClient.libClientsocketMod.ClientOptions
import typingsJapgolly.socketclusterClient.libClientsocketMod.ProtocolVersions
...
object libTransportMod {
  ...
  object EventObject {
    ...
    extension [Self <: EventObject](x: Self) {
      ...
      inline def setCallback(value: (/* error */ js.Error, /* eventObject */ EventObject) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* error */ js.Error, t1: /* eventObject */ EventObject) => (value(t0, t1)).runNow()))
