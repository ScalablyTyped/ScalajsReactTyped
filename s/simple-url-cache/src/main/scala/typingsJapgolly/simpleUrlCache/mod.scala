package typingsJapgolly.simpleUrlCache
...
import typingsJapgolly.simpleUrlCache.mod.privateN.StorageConfig
  ...
  object privateN {
    ...
    object CacheCategory {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(getCacheCategory = getCacheCategory.toJsFn, getCategory = getCategory.toJsFn, getCurrentUrl = getCurrentUrl.toJsFn, getRegexTest = js.Any.fromFunction1(getRegexTest))
        __obj.asInstanceOf[CacheCategory]
      }
      
      extension [Self <: CacheCategory](x: Self) {
        
        inline def setGetCacheCategory(value: CallbackTo[String]): Self = StObject.set(x, "getCacheCategory", value.toJsFn)
        
        inline def setGetCategory(value: CallbackTo[String]): Self = StObject.set(x, "getCategory", value.toJsFn)
        
        inline def setGetCurrentUrl(value: CallbackTo[String]): Self = StObject.set(x, "getCurrentUrl", value.toJsFn)
