package typingsJapgolly.snakecaseKeys

import typingsJapgolly.snakecaseKeys.snakecaseKeysBooleans.`true`
import typingsJapgolly.snakecaseKeys.snakecaseKeysStrings._empty
  ...
  */
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      @default {}
      */
    val parsingOptions: js.UndefOr[typingsJapgolly.noCase.mod.Options] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setParsingOptions(value: typingsJapgolly.noCase.mod.Options): Self = StObject.set(x, "parsingOptions", value.asInstanceOf[js.Any])
