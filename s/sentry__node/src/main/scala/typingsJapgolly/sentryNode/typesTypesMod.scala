...
import typingsJapgolly.sentryTypes.typesTracingMod.TracePropagationTargets
...
object typesTypesMod {
  ...
  object BaseNodeOptions {
    ...
    extension [Self <: BaseNodeOptions](x: Self) {
      ...
      inline def setOnFatalError(value: /* error */ js.Error => Callback): Self = StObject.set(x, "onFatalError", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
