...
import typingsJapgolly.sammy.Sammy.DataLocationProxy
import typingsJapgolly.sammy.Sammy.FormBuilder
import typingsJapgolly.sammy.Sammy.Store
...
object mod {
  ...
  @js.native
  def DataLocationProxy: typingsJapgolly.sammy.Sammy.DataLocationProxy = js.native
  ...
  @js.native
  def FormBuilder: typingsJapgolly.sammy.Sammy.FormBuilder = js.native
  ...
  open class Object protected ()
    extends StObject
       with typingsJapgolly.sammy.Sammy.Object {
  ...
  @js.native
  def Store: typingsJapgolly.sammy.Sammy.Store = js.native
