package typingsJapgolly.saveCsv
...
object mod {
  ...
  object SaveCsvProps {
    ...
    extension [Self <: SaveCsvProps](x: Self) {
      ...
      inline def setFormatter(value: /* value */ String | JSON => Callback): Self = StObject.set(x, "formatter", js.Any.fromFunction1((t0: /* value */ String | JSON) => value(t0).runNow()))
