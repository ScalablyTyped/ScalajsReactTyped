...
object pluginMod {
  ...
  open class ScrollbarPlugin protected ()
    extends StObject
       with typingsJapgolly.smoothScrollbar.interfacesPluginMod.ScrollbarPlugin {
    ...
    /* CompleteClass */
    override val scrollbar: typingsJapgolly.smoothScrollbar.interfacesScrollbarMod.Scrollbar = js.native
