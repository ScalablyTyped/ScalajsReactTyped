...
import typingsJapgolly.smoothScrollbar.mod.ScrollbarPlugin
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object pluginsOverscrollMod {
  ...
  object OverscrollEffect extends StObject {
    ...
    /* "bounce" */ val BOUNCE: typingsJapgolly.smoothScrollbar.pluginsOverscrollMod.OverscrollEffect.BOUNCE & String = js.native
    
    @js.native
    sealed trait GLOW
      extends StObject
         with OverscrollEffect
    /* "glow" */ val GLOW: typingsJapgolly.smoothScrollbar.pluginsOverscrollMod.OverscrollEffect.GLOW & String = js.native
  }
