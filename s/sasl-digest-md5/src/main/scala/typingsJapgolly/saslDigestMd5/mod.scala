package typingsJapgolly.saslDigestMd5
...
object mod {
  ...
  object DigestMd5Mechanism {
    ...
    inline def apply(challenge: String => Callback, response: Credentials => String): DigestMd5Mechanism = {
      val __obj = js.Dynamic.literal(challenge = js.Any.fromFunction1((t0: String) => challenge(t0).runNow()), clientFirst = false, name = "DIGEST-MD5", response = js.Any.fromFunction1(response))
