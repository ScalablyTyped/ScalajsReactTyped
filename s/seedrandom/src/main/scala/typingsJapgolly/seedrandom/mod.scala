...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsJapgolly.seedrandom.mod.seedrandom = js.native
  ...
  type _To = typingsJapgolly.seedrandom.mod.seedrandom
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsJapgolly.seedrandom.mod.seedrandom = ^
