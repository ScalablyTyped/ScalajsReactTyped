...
import typingsJapgolly.simmerjs.anon.SimmernoConflictany
...
object mod extends Shortcut {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setErrorHandlingFunction2(value: (/* error */ Any, /* element */ Element) => Callback): Self = StObject.set(x, "errorHandling", js.Any.fromFunction2((t0: /* error */ Any, t1: /* element */ Element) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.simmerjs.mod.Queryable
    - typingsJapgolly.simmerjs.mod.WindowLike
  */
  ...
  object Scope {
    ...
    inline def Queryable(
      ...
      val __obj = js.Dynamic.literal(querySelectorAll = js.Any.fromFunction2(querySelectorAll))
      __obj.asInstanceOf[typingsJapgolly.simmerjs.mod.Queryable]
    }
    
    inline def WindowLike(document: Queryable): typingsJapgolly.simmerjs.mod.WindowLike = {
      val __obj = js.Dynamic.literal(document = document.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.simmerjs.mod.WindowLike]
    }
  }
