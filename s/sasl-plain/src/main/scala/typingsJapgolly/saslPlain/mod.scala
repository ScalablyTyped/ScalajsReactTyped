package typingsJapgolly.saslPlain
...
object mod {
  ...
  object PlainMechanism {
    ...
    inline def apply(challenge: String => Callback, response: Credentials => String): PlainMechanism = {
      val __obj = js.Dynamic.literal(challenge = js.Any.fromFunction1((t0: String) => challenge(t0).runNow()), clientFirst = true, name = "PLAIN", response = js.Any.fromFunction1(response))
