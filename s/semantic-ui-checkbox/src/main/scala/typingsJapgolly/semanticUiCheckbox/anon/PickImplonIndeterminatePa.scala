...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'onIndeterminate'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
trait PickImplonIndeterminatePa
  extends StObject
     with Param {
...
object PickImplonIndeterminatePa {
  ...
  extension [Self <: PickImplonIndeterminatePa](x: Self) {
