...
import typingsJapgolly.semanticUiCheckbox.SemanticUI.CheckboxSettings.Param
...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'onDisable'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
trait PickImplonDisablePartialP
  extends StObject
     with Param {
  ...
  def onDisable(): Unit
  @JSName("onDisable")
  var onDisable_Original: (js.ThisFunction0[/* this */ HTMLInputElement, Unit]) & (js.UndefOr[js.ThisFunction0[/* this */ HTMLInputElement, Unit]])
