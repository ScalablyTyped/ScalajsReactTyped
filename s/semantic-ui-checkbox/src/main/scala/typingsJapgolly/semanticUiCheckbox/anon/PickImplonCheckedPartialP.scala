...
/* Inlined std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, 'onChecked'> & std.Partial<std.Pick<semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl, keyof semantic-ui-checkbox.SemanticUI.CheckboxSettings._Impl>> */
trait PickImplonCheckedPartialP
  extends StObject
     with Param {
...
object PickImplonCheckedPartialP {
  ...
  extension [Self <: PickImplonCheckedPartialP](x: Self) {
