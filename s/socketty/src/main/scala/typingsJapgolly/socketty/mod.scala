...
object mod extends Shortcut {
  ...
  object SockettyServer {
    ...
    inline def apply(connection: js.Function1[/* socket */ SockettySocket, Unit] => Callback): SockettyServer = {
      val __obj = js.Dynamic.literal(connection = js.Any.fromFunction1((t0: js.Function1[/* socket */ SockettySocket, Unit]) => connection(t0).runNow()))
      __obj.asInstanceOf[SockettyServer]
    }
    
    extension [Self <: SockettyServer](x: Self) {
      
      inline def setConnection(value: js.Function1[/* socket */ SockettySocket, Unit] => Callback): Self = StObject.set(x, "connection", js.Any.fromFunction1((t0: js.Function1[/* socket */ SockettySocket, Unit]) => value(t0).runNow()))
    }
  }
