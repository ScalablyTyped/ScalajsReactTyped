...
import typingsJapgolly.sketchapp.anon.Data
import typingsJapgolly.sketchapp.sketchappStrings.imageData
import typingsJapgolly.sketchapp.sketchappStrings.jSONOriginalDataReference
