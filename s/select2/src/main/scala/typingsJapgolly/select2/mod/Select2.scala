...
trait Select2 extends StObject {
  ...
  var options: typingsJapgolly.select2.anon.Options
...
object Select2 {
  ...
  inline def apply(
    ...
    dropdown: Any,
    id: String,
    options: typingsJapgolly.select2.anon.Options,
    results: Any,
    selection: Any
  ): Select2 = {
  ...
  extension [Self <: Select2](x: Self) {
    ...
    inline def setOptions(value: typingsJapgolly.select2.anon.Options): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
