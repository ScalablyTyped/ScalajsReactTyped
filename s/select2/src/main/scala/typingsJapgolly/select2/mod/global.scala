...
import typingsJapgolly.select2.select2Strings.select2
import typingsJapgolly.select2.select2Strings.select2Colonclose
import typingsJapgolly.select2.select2Strings.select2Colonclosing
import typingsJapgolly.select2.select2Strings.select2Colonopen
import typingsJapgolly.select2.select2Strings.select2Colonopening
import typingsJapgolly.select2.select2Strings.select2Colonselect
import typingsJapgolly.select2.select2Strings.select2Colonselecting
import typingsJapgolly.select2.select2Strings.select2Colonunselect
import typingsJapgolly.select2.select2Strings.select2Colonunselecting
