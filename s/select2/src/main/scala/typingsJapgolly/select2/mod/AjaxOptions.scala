...
object AjaxOptions {
  ...
  extension [Self <: AjaxOptions[?, ?], Result, RemoteResult](x: Self & (AjaxOptions[Result, RemoteResult])) {
    ...
    inline def setTransport(
      value: (/* settings */ JQueryAjaxSettings, /* success */ js.Function1[/* data */ RemoteResult, Unit], /* failure */ js.Function0[Unit]) => Callback
    ): Self = StObject.set(x, "transport", js.Any.fromFunction3((t0: /* settings */ JQueryAjaxSettings, t1: /* success */ js.Function1[/* data */ RemoteResult, Unit], t2: /* failure */ js.Function0[Unit]) => (value(t0, t1, t2)).runNow()))
