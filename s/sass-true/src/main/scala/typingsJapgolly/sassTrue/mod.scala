...
import typingsJapgolly.sassTrue.anon.ReadonlyAssertion
import typingsJapgolly.sassTrue.anon.TypeofimportedSass
...
object mod {
  ...
  object TrueOptions {
    ...
    inline def apply(describe: (String, js.Function0[Unit]) => Callback, it: (String, js.Function0[Unit]) => Callback): TrueOptions = {
      val __obj = js.Dynamic.literal(describe = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (describe(t0, t1)).runNow()), it = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (it(t0, t1)).runNow()))
    ...
    extension [Self <: TrueOptions](x: Self) {
      ...
      inline def setDescribe(value: (String, js.Function0[Unit]) => Callback): Self = StObject.set(x, "describe", js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
      
      inline def setIt(value: (String, js.Function0[Unit]) => Callback): Self = StObject.set(x, "it", js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
