package typingsJapgolly.svgArcToCubicBezier

import typingsJapgolly.svgArcToCubicBezier.svgArcToCubicBezierInts.`0`
import typingsJapgolly.svgArcToCubicBezier.svgArcToCubicBezierInts.`1`
