package typingsJapgolly.swaggerExpressValidator
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setRequestValidationFn(
        value: (/* req */ Request_[
              ...
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], /* data */ Any, /* errors */ Any) => Callback
      ): Self = StObject.set(x, "requestValidationFn", js.Any.fromFunction3((t0: /* req */ Request_[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
              Any, 
              Any, 
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t1: /* data */ Any, t2: /* errors */ Any) => (value(t0, t1, t2)).runNow()))
      ...
      ): Self = StObject.set(x, "responseValidationFn", js.Any.fromFunction3((t0: /* req */ Request_[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
              Any, 
              Any, 
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
