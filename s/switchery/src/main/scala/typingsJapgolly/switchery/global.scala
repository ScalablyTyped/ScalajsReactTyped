package typingsJapgolly.switchery

import org.scalajs.dom.Node
import typingsJapgolly.switchery.mod.Switchery.Options
import typingsJapgolly.switchery.mod.Switchery.SwitcheryStatic
...
object global {
  ...
  @JSGlobal("Switchery")
  @js.native
  open class Switchery protected ()
    extends StObject
       with typingsJapgolly.switchery.mod.Switchery {
