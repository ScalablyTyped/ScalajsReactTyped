...
object mod {
  ...
  object Switchery {
    ...
    inline def apply(destroy: Callback, disable: Callback, enable: Callback, isDisabled: CallbackTo[Boolean]): Switchery = {
      val __obj = js.Dynamic.literal(destroy = destroy.toJsFn, disable = disable.toJsFn, enable = enable.toJsFn, isDisabled = isDisabled.toJsFn)
