...
object PeerOpts {
  ...
  def apply(
    ...
    sdpTransfrom: /* sdp */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (sdpTransfrom != null) __obj.updateDynamic("sdpTransfrom")(js.Any.fromFunction1((t0: /* sdp */ js.Any) => sdpTransfrom(t0).runNow()))
