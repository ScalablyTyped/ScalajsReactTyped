...
object Seamless {
  ...
  object ConnectOptions {
    ...
    extension [Self <: ConnectOptions](x: Self) {
      ...
      inline def setOnConnect(value: /* data */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onConnect", js.Any.fromFunction1((t0: /* data */ Any) => value(t0).runNow()))
      
      inline def setOnConnectUndefined: Self = StObject.set(x, "onConnect", js.undefined)
      
      inline def setOnUpdate(value: /* data */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onUpdate", js.Any.fromFunction1((t0: /* data */ Any) => value(t0).runNow()))
