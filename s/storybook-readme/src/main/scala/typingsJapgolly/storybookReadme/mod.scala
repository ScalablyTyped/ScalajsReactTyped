...
import typingsJapgolly.storybookReadme.anon.Children
import typingsJapgolly.storybookReadme.anon.ChildrenElement
...
object mod {
  ...
  trait ConfigureReadmeConfig extends StObject {
    ...
    var DocPreview: js.UndefOr[js.Function1[/* props */ Children, Node]] = js.undefined
    
    var FooterPreview: js.UndefOr[js.Function1[/* props */ Children, Node]] = js.undefined
    
    var HeaderPreview: js.UndefOr[js.Function1[/* props */ Children, Node]] = js.undefined
    
    var StoryPreview: js.UndefOr[js.Function1[/* props */ Children, Node]] = js.undefined
  ...
  object ConfigureReadmeConfig {
    ...
    extension [Self <: ConfigureReadmeConfig](x: Self) {
      ...
      inline def setDocPreview(value: /* props */ Children => Node): Self = StObject.set(x, "DocPreview", js.Any.fromFunction1(value))
      ...
      inline def setFooterPreview(value: /* props */ Children => Node): Self = StObject.set(x, "FooterPreview", js.Any.fromFunction1(value))
      ...
      inline def setHeaderPreview(value: /* props */ Children => Node): Self = StObject.set(x, "HeaderPreview", js.Any.fromFunction1(value))
      
      inline def setHeaderPreviewUndefined: Self = StObject.set(x, "HeaderPreview", js.undefined)
      
      inline def setHeaderUndefined: Self = StObject.set(x, "header", js.undefined)
      
      inline def setStoryPreview(value: /* props */ Children => Node): Self = StObject.set(x, "StoryPreview", js.Any.fromFunction1(value))
