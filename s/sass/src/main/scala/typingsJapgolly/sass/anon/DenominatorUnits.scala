...
trait DenominatorUnits extends StObject {
  ...
  var denominatorUnits: js.UndefOr[js.Array[String] | typingsJapgolly.immutable.mod.List[String]] = js.undefined
  
  var numeratorUnits: js.UndefOr[js.Array[String] | typingsJapgolly.immutable.mod.List[String]] = js.undefined
}
object DenominatorUnits {
  ...
  extension [Self <: DenominatorUnits](x: Self) {
    ...
    inline def setDenominatorUnits(value: js.Array[String] | typingsJapgolly.immutable.mod.List[String]): Self = StObject.set(x, "denominatorUnits", value.asInstanceOf[js.Any])
    ...
    inline def setNumeratorUnits(value: js.Array[String] | typingsJapgolly.immutable.mod.List[String]): Self = StObject.set(x, "numeratorUnits", value.asInstanceOf[js.Any])
