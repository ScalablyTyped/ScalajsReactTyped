...
object typesLegacyImporterMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    * TS definition: {{{
    sync extends 'async' ? sass.sass/types/legacy/importer.LegacySyncImporter | sass.sass/types/legacy/importer.LegacyAsyncImporter : sass.sass/types/legacy/importer.LegacySyncImporter
    }}}
    */
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sass.anon.File
    - typingsJapgolly.sass.anon.Contents
    - js.Error
    - scala.Null
  */
  ...
  object _LegacyImporterResult {
    ...
    inline def Contents(contents: String): typingsJapgolly.sass.anon.Contents = {
      val __obj = js.Dynamic.literal(contents = contents.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.sass.anon.Contents]
    }
    
    inline def File(file: String): typingsJapgolly.sass.anon.File = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.sass.anon.File]
    }
  }
}
