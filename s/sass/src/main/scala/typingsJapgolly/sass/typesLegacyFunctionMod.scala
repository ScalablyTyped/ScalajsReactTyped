...
import typingsJapgolly.sass.typesLegacyFunctionMod.types.Error
import typingsJapgolly.sass.typesLegacyFunctionMod.types.Null
import typingsJapgolly.sass.typesLegacyPluginThisMod.LegacyPluginThis
...
object typesLegacyFunctionMod {
  ...
  /** NOTE: Conditional type definitions are impossible to translate to Scala.
    ...
    */
  @js.native
  trait LegacyFunction[sync /* <: typingsJapgolly.sass.sassStrings.sync | async */] extends StObject
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sass.typesLegacyFunctionMod.types.Null
    - typingsJapgolly.sass.typesLegacyFunctionMod.types.Number
    - typingsJapgolly.sass.typesLegacyFunctionMod.types.String
    - typingsJapgolly.sass.typesLegacyFunctionMod.types.Boolean[scala.Boolean]
    - typingsJapgolly.sass.typesLegacyFunctionMod.types.Color
    - typingsJapgolly.sass.typesLegacyFunctionMod.types.List
    - typingsJapgolly.sass.typesLegacyFunctionMod.types.Map
  */
