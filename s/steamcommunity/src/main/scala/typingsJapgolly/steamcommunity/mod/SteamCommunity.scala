...
import typingsJapgolly.steamcommunity.anon.Appid
import typingsJapgolly.steamcommunity.componentsChatMod.Chat
import typingsJapgolly.steamcommunity.componentsConfirmationsMod.Confirmations
import typingsJapgolly.steamcommunity.componentsGroupsMod.Groups
import typingsJapgolly.steamcommunity.componentsHelpMod.Help
import typingsJapgolly.steamcommunity.componentsHelpersMod.Helpers
import typingsJapgolly.steamcommunity.componentsHttpMod.Http
import typingsJapgolly.steamcommunity.componentsInventoryhistoryMod.InventoryHistory
import typingsJapgolly.steamcommunity.componentsMarketMod.Market
import typingsJapgolly.steamcommunity.componentsProfileMod.Profile
import typingsJapgolly.steamcommunity.componentsTwofactorMod.TwoFactor
import typingsJapgolly.steamcommunity.componentsUsersMod.Users
import typingsJapgolly.steamcommunity.componentsWebapiMod.WebApi
import typingsJapgolly.steamcommunity.steamcommunityStrings.chatLogOnFailed
import typingsJapgolly.steamcommunity.steamcommunityStrings.chatLoggedOff
import typingsJapgolly.steamcommunity.steamcommunityStrings.chatLoggedOn
import typingsJapgolly.steamcommunity.steamcommunityStrings.chatMessage
import typingsJapgolly.steamcommunity.steamcommunityStrings.chatPersonaState
import typingsJapgolly.steamcommunity.steamcommunityStrings.chatTyping
import typingsJapgolly.steamcommunity.steamcommunityStrings.confKeyNeeded
import typingsJapgolly.steamcommunity.steamcommunityStrings.confirmationAccepted
import typingsJapgolly.steamcommunity.steamcommunityStrings.debug
import typingsJapgolly.steamcommunity.steamcommunityStrings.newConfirmation
import typingsJapgolly.steamcommunity.steamcommunityStrings.sessionExpired
...
trait SteamCommunity
  ...
  def getMarketItem(
    ...
    callback: js.Function2[
      /* err */ CallbackError, 
      /* item */ typingsJapgolly.steamcommunity.classesCmarketitemMod.^, 
      Any
    ]
  ): Unit = js.native
  ...
  def getSteamGroup(
    ...
    callback: js.Function2[
      /* err */ CallbackError, 
      /* group */ typingsJapgolly.steamcommunity.classesCsteamgroupMod.^, 
      Any
    ]
  ): Unit = js.native
  /**
  ...
  def getSteamUser(
    ...
    callback: js.Function2[
      /* err */ CallbackError, 
      /* group */ typingsJapgolly.steamcommunity.classesCsteamuserMod.^, 
      Any
    ]
  ): Unit = js.native
  /**
  ...
  def marketSearch(
    ...
    callback: js.Function2[
      /* err */ CallbackError, 
      /* items */ js.Array[typingsJapgolly.steamcommunity.classesCmarketsearchresultMod.^], 
      Any
    ]
  ): Unit = js.native
  def marketSearch(
  ...
  /**
    ...
    */
  @JSName("on")
  def on_chatLogOnFailed(event: chatLogOnFailed, listener: typingsJapgolly.steamcommunity.mod.Events.chatLogOnFailed): this.type = js.native
  /**
    ...
    */
  @JSName("on")
  def on_chatMessage(event: chatMessage, listener: typingsJapgolly.steamcommunity.mod.Events.chatMessage): this.type = js.native
  /**
    ...
    */
  @JSName("on")
  def on_chatPersonaState(event: chatPersonaState, listener: typingsJapgolly.steamcommunity.mod.Events.chatPersonaState): this.type = js.native
  /**
    ...
    */
  @JSName("on")
  def on_chatTyping(event: chatTyping, listener: typingsJapgolly.steamcommunity.mod.Events.chatTyping): this.type = js.native
  /**
    ...
    */
  @JSName("on")
  def on_confKeyNeeded(event: confKeyNeeded, listener: typingsJapgolly.steamcommunity.mod.Events.confKeyNeeded): this.type = js.native
  /**
    ...
    */
  @JSName("on")
  def on_confirmationAccepted(
    event: confirmationAccepted,
    listener: typingsJapgolly.steamcommunity.mod.Events.confirmationAccepted
  ): this.type = js.native
  @JSName("on")
  ...
  /**
    ...
    */
  @JSName("on")
  def on_newConfirmation(event: newConfirmation, listener: typingsJapgolly.steamcommunity.mod.Events.newConfirmation): this.type = js.native
  /**
    ...
    */
  @JSName("on")
  def on_sessionExpired(event: sessionExpired, listener: typingsJapgolly.steamcommunity.mod.Events.sessionExpired): this.type = js.native
