...
object Events {
  ...
  /**
    ...
    */
  type confirmationAccepted = js.Function1[/* confirmation */ typingsJapgolly.steamcommunity.classesCconfirmationMod.^, Unit]
  
  /**
    * @param confirmation A `CConfirmation` object.
    */
  type newConfirmation = js.Function1[/* confirmation */ typingsJapgolly.steamcommunity.classesCconfirmationMod.^, Unit]
