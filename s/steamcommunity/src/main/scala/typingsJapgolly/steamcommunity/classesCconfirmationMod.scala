...
import typingsJapgolly.steamcommunity.mod.ConfirmationType
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object classesCconfirmationMod {
  ...
  object CConfirmation {
    ...
    inline def apply(
      creator: String,
      getOfferID: (Any, Any, Any) => japgolly.scalajs.react.Callback,
      icon: String,
      id: Any,
      key: String,
      receiving: String,
      respond: (Any, Any, Boolean, Callback) => japgolly.scalajs.react.Callback,
      time: String,
      title: String,
      `type`: ConfirmationType
    ): CConfirmation = {
      val __obj = js.Dynamic.literal(creator = creator.asInstanceOf[js.Any], getOfferID = js.Any.fromFunction3((t0: Any, t1: Any, t2: Any) => (getOfferID(t0, t1, t2)).runNow()), icon = icon.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any], receiving = receiving.asInstanceOf[js.Any], respond = js.Any.fromFunction4((t0: Any, t1: Any, t2: Boolean, t3: Callback) => (respond(t0, t1, t2, t3)).runNow()), time = time.asInstanceOf[js.Any], title = title.asInstanceOf[js.Any], offerID = null)
    ...
    extension [Self <: CConfirmation](x: Self) {
      ...
      inline def setGetOfferID(value: (Any, Any, Any) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "getOfferID", js.Any.fromFunction3((t0: Any, t1: Any, t2: Any) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setRespond(value: (Any, Any, Boolean, Callback) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "respond", js.Any.fromFunction4((t0: Any, t1: Any, t2: Boolean, t3: Callback) => (value(t0, t1, t2, t3)).runNow()))
