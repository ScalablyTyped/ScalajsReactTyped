...
import typingsJapgolly.steamcommunity.mod.classid
import typingsJapgolly.steamcommunity.mod.contextid
import typingsJapgolly.steamcommunity.mod.instanceid
...
object classesCeconitemMod {
  ...
  open class ^ protected ()
    ...
    /** Alias of id. */
    /* CompleteClass */
    var assetid: typingsJapgolly.steamcommunity.mod.assetid = js.native
    ...
    /* CompleteClass */
    var classid: typingsJapgolly.steamcommunity.mod.classid = js.native
    ...
    /* CompleteClass */
    var contextid: typingsJapgolly.steamcommunity.mod.contextid = js.native
    ...
    /* CompleteClass */
    var instanceid: typingsJapgolly.steamcommunity.mod.instanceid = js.native
  ...
  trait CEconItem extends StObject {
    ...
    /** Alias of id. */
    var assetid: typingsJapgolly.steamcommunity.mod.assetid
    ...
    /** The first half of the item cache identifier. The classid is enough to get you basic details about the item. */
    var classid: typingsJapgolly.steamcommunity.mod.classid
    
    /** true if, on the Steam Community Market, this item will use buy orders. false if not. */
    var commodity: Boolean
    
    /** The ID of the context within the app in which the item resides. */
    var contextid: typingsJapgolly.steamcommunity.mod.contextid
    ...
    /** The second half of the item cache identifier. */
    var instanceid: typingsJapgolly.steamcommunity.mod.instanceid
  ...
  object CEconItem {
    ...
    inline def apply(
      ...
      getLargeImageURL: CallbackTo[String],
      getTag: String => Any,
      id: String,
    ...
    extension [Self <: CEconItem](x: Self) {
      ...
      inline def setGetLargeImageURL(value: CallbackTo[String]): Self = StObject.set(x, "getLargeImageURL", value.toJsFn)
