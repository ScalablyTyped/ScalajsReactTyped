...
import typingsJapgolly.steamcommunity.anon.BackgroundUrl
import typingsJapgolly.steamcommunity.anon.Count
import typingsJapgolly.steamcommunity.anon.Spoiler
import typingsJapgolly.steamcommunity.mod.Callback
import typingsJapgolly.steamcommunity.mod.CallbackError
import typingsJapgolly.steamcommunity.mod.UserComment
import typingsJapgolly.steamcommunity.mod.appid
import typingsJapgolly.steamcommunity.mod.contextid
import typingsJapgolly.steamcommunity.mod.gid
import typingsJapgolly.steamcommunity.steamcommunityInts.`0`
import typingsJapgolly.steamcommunity.steamcommunityInts.`1`
import typingsJapgolly.steamcommunity.steamcommunityStrings.Banned
import typingsJapgolly.steamcommunity.steamcommunityStrings.None
import typingsJapgolly.steamcommunity.steamcommunityStrings.Probation
import typingsJapgolly.steamcommunity.steamcommunityStrings.`in-game`
import typingsJapgolly.steamcommunity.steamcommunityStrings.`private`
import typingsJapgolly.steamcommunity.steamcommunityStrings.friendsonly
import typingsJapgolly.steamcommunity.steamcommunityStrings.httpColonSlashSlash
import typingsJapgolly.steamcommunity.steamcommunityStrings.httpsColonSlashSlash
import typingsJapgolly.steamcommunity.steamcommunityStrings.offline
import typingsJapgolly.steamcommunity.steamcommunityStrings.online
import typingsJapgolly.steamcommunity.steamcommunityStrings.public
...
object classesCsteamuserMod {
  ...
  trait CSteamUser extends StObject {
    ...
    def getInventory(
      ...
      callback: js.Function3[
          /* err */ CallbackError, 
          /* inventory */ js.Array[typingsJapgolly.steamcommunity.classesCeconitemMod.^], 
          /* currency */ js.Array[typingsJapgolly.steamcommunity.classesCeconitemMod.^], 
          Any
        ]
    ): Unit = js.native
    ...
    var groups: js.Array[typingsJapgolly.steamid.mod.^] = js.native
    ...
    var primaryGroup: typingsJapgolly.steamid.mod.^ = js.native
    ...
    var steamID: typingsJapgolly.steamid.mod.^ = js.native
