...
import typingsJapgolly.steamcommunity.mod.Announcement
import typingsJapgolly.steamcommunity.mod.Callback
import typingsJapgolly.steamcommunity.mod.CallbackError
import typingsJapgolly.steamcommunity.mod.GroupComment
import typingsJapgolly.steamcommunity.mod.GroupEventType
import typingsJapgolly.steamcommunity.mod.GroupHistory
import typingsJapgolly.steamcommunity.mod.appid
import typingsJapgolly.steamcommunity.mod.cid
...
object classesCsteamgroupMod {
  ...
  trait CSteamGroup extends StObject {
    ...
    def getMembers(
      ...
      callback: js.Function2[/* err */ CallbackError, /* memebers */ js.Array[typingsJapgolly.steamid.mod.^], Any]
    ): Unit = js.native
    ...
    /**
      ...
      * @param callback Called when the request completes.
      */
    def kick(steamID: typingsJapgolly.steamid.mod.^, callback: Callback): Unit = js.native
    ...
    def respondToJoinRequests(steamIDs: js.Array[String | typingsJapgolly.steamid.mod.^], approve: Boolean, callback: Callback): Unit = js.native
    /**
      ...
      * @param callback - Takes only an Error object/null as the first argument
      */
    def respondToJoinRequests(steamIDs: typingsJapgolly.steamid.mod.^, approve: Boolean, callback: Callback): Unit = js.native
    ...
    def setPlayerOfTheWeek(
      steamID: typingsJapgolly.steamid.mod.^,
      callback: js.Function3[
          /* err */ CallbackError, 
          /* oldPOTW */ typingsJapgolly.steamid.mod.^, 
          /* newPOTW */ typingsJapgolly.steamid.mod.^, 
          Any
        ]
    ): Unit = js.native
