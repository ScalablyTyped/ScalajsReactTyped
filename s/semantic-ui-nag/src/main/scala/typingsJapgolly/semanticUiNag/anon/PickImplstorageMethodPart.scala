...
import typingsJapgolly.semanticUiNag.SemanticUI.NagSettings.Param
...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'storageMethod'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
trait PickImplstorageMethodPart
  extends StObject
     with Param {
...
object PickImplstorageMethodPart {
  ...
  extension [Self <: PickImplstorageMethodPart](x: Self) {
