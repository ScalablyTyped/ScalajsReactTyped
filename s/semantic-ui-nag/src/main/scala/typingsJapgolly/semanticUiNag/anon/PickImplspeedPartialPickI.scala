...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'speed'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
trait PickImplspeedPartialPickI
  extends StObject
     with Param {
