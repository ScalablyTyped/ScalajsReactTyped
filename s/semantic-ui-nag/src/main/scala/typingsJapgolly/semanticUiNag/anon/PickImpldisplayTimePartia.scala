...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'displayTime'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
trait PickImpldisplayTimePartia
  extends StObject
     with Param {
