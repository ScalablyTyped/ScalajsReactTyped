...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'persist'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
trait PickImplpersistPartialPic
  extends StObject
     with Param {
...
object PickImplpersistPartialPic {
  ...
  extension [Self <: PickImplpersistPartialPic](x: Self) {
