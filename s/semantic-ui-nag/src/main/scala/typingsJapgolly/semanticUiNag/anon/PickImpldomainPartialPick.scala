...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'domain'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
trait PickImpldomainPartialPick
  extends StObject
     with Param {
...
object PickImpldomainPartialPick {
  ...
  extension [Self <: PickImpldomainPartialPick](x: Self) {
