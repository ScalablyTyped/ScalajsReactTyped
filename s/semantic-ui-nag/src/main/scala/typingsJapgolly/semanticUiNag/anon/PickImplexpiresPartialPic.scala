...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'expires'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
trait PickImplexpiresPartialPic
  extends StObject
     with Param {
...
object PickImplexpiresPartialPic {
  ...
  extension [Self <: PickImplexpiresPartialPic](x: Self) {
