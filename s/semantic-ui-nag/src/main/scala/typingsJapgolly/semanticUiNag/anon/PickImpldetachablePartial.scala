...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'detachable'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
trait PickImpldetachablePartial
  extends StObject
     with Param {
...
object PickImpldetachablePartial {
  ...
  extension [Self <: PickImpldetachablePartial](x: Self) {
