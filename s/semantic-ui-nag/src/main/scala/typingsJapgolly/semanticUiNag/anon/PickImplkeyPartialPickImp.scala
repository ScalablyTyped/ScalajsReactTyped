...
/* Inlined std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, 'key'> & std.Partial<std.Pick<semantic-ui-nag.SemanticUI.NagSettings._Impl, keyof semantic-ui-nag.SemanticUI.NagSettings._Impl>> */
trait PickImplkeyPartialPickImp
  extends StObject
     with Param {
...
object PickImplkeyPartialPickImp {
  ...
  extension [Self <: PickImplkeyPartialPickImp](x: Self) {
