...
@js.native
trait Occupant
  extends typingsJapgolly.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.OccupantInfo {
  ...
  def update(data: typingsJapgolly.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.OccupantInfo): Unit = js.native
