package typingsJapgolly.strophe.mod.Strophe

import org.scalajs.dom.raw.Element
import typingsJapgolly.strophe.AnonMatchBare
import typingsJapgolly.strophe.mucMod.stropheAugmentingMod.Strophe.MUC.Plugin
...
class Connection protected () extends js.Object {
  ...
  def send(elem: js.Array[typingsJapgolly.std.Element]): Unit = js.native
  /** Function: send
    *  Send a stanza.
    *
    ...
    */
  def send(elem: typingsJapgolly.std.Element): Unit = js.native
  ...
  /** Function: sendIQ
    ...
    */
  def sendIQ(elem: typingsJapgolly.std.Element): String = js.native
  def sendIQ(elem: typingsJapgolly.std.Element, callback: js.Function1[/* stanza */ Element, _]): String = js.native
  def sendIQ(
    elem: typingsJapgolly.std.Element,
