...
import typingsJapgolly.strophe.mod.Strophe.ConnectionOptions
import typingsJapgolly.strophe.mod.Strophe.LogLevel
import typingsJapgolly.strophe.mod.Strophe.SASLMechanism
...
object stropheAugmentingMod extends js.Object {
  ...
  class Builder protected ()
    extends typingsJapgolly.strophe.mod.Strophe.Builder {
  ...
  def serialize(elem: typingsJapgolly.strophe.mod.Strophe.Builder): String = js.native
  ...
  object LogLevel extends js.Object {
    /* 0 */ val DEBUG: typingsJapgolly.strophe.mod.Strophe.LogLevel.DEBUG with Double = js.native
    /* 3 */ val ERROR: typingsJapgolly.strophe.mod.Strophe.LogLevel.ERROR with Double = js.native
    /* 4 */ val FATAL: typingsJapgolly.strophe.mod.Strophe.LogLevel.FATAL with Double = js.native
    /* 1 */ val INFO: typingsJapgolly.strophe.mod.Strophe.LogLevel.INFO with Double = js.native
    /* 2 */ val WARN: typingsJapgolly.strophe.mod.Strophe.LogLevel.WARN with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.strophe.mod.Strophe.LogLevel with Double] = js.native
  }
  ...
  object Status extends js.Object {
    /* 8 */ val ATTACHED: typingsJapgolly.strophe.mod.Strophe.Status.ATTACHED with Double = js.native
    /* 3 */ val AUTHENTICATING: typingsJapgolly.strophe.mod.Strophe.Status.AUTHENTICATING with Double = js.native
    /* 4 */ val AUTHFAIL: typingsJapgolly.strophe.mod.Strophe.Status.AUTHFAIL with Double = js.native
    /* 5 */ val CONNECTED: typingsJapgolly.strophe.mod.Strophe.Status.CONNECTED with Double = js.native
    /* 1 */ val CONNECTING: typingsJapgolly.strophe.mod.Strophe.Status.CONNECTING with Double = js.native
    /* 2 */ val CONNFAIL: typingsJapgolly.strophe.mod.Strophe.Status.CONNFAIL with Double = js.native
    /* 10 */ val CONNTIMEOUT: typingsJapgolly.strophe.mod.Strophe.Status.CONNTIMEOUT with Double = js.native
    /* 6 */ val DISCONNECTED: typingsJapgolly.strophe.mod.Strophe.Status.DISCONNECTED with Double = js.native
    /* 7 */ val DISCONNECTING: typingsJapgolly.strophe.mod.Strophe.Status.DISCONNECTING with Double = js.native
    /* 0 */ val ERROR: typingsJapgolly.strophe.mod.Strophe.Status.ERROR with Double = js.native
    /* 9 */ val REDIRECT: typingsJapgolly.strophe.mod.Strophe.Status.REDIRECT with Double = js.native
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.strophe.mod.Strophe.Status with Double] = js.native
  }
