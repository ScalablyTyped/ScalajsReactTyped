...
import typingsJapgolly.strophe.AnonAUTH
...
object ^ extends js.Object {
  ...
  var Builder: Instantiable2[
    ...
    typingsJapgolly.strophe.mod.Strophe.Builder
  ] = js.native
  ...
  var Connection: Instantiable2[
    /* service */ String, 
    js.UndefOr[/* options */ typingsJapgolly.strophe.mod.Strophe.ConnectionOptions], 
    typingsJapgolly.strophe.mod.Strophe.Connection
  ] = js.native
  ...
  /** Constants: SASL mechanisms
    ...
    */
  var SASLAnonymous: typingsJapgolly.strophe.mod.Strophe.SASLMechanism = js.native
  var SASLMD5: typingsJapgolly.strophe.mod.Strophe.SASLMechanism = js.native
  var SASLPlain: typingsJapgolly.strophe.mod.Strophe.SASLMechanism = js.native
  var SASLSHA1: typingsJapgolly.strophe.mod.Strophe.SASLMechanism = js.native
  /** Constant: VERSION
  ...
  /** Function: log
    ...
    *    (String) msg - The log message.
    */
  def log(level: typingsJapgolly.strophe.mod.Strophe.LogLevel, msg: String): Unit = js.native
  /** Function: serialize
