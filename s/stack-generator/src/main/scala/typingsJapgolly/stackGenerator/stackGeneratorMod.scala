package typingsJapgolly.stackGenerator
...
object stackGeneratorMod {
  ...
  inline def backtrace(opts: StackGeneratorOptions): js.Array[typingsJapgolly.stackframe.mod.^] = ^.asInstanceOf[js.Dynamic].applyDynamic("backtrace")(opts.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.stackframe.mod.^]]
