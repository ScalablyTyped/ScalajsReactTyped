...
object distTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ssimJs.distTypesMod.Matrix
    - typingsJapgolly.ssimJs.distTypesMod.ImageData
    - typingsJapgolly.ssimJs.anon.Height
  */
  ...
  object ImageMatrix {
    ...
    inline def Height(
      ...
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ssimJs.anon.Height]
    }
    
    inline def ImageData(data: js.typedarray.Uint8ClampedArray, height: Double, width: Double): typingsJapgolly.ssimJs.distTypesMod.ImageData = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ssimJs.distTypesMod.ImageData]
    }
    
    inline def Matrix(data: js.Array[Double], height: Double, width: Double): typingsJapgolly.ssimJs.distTypesMod.Matrix = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], height = height.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.ssimJs.distTypesMod.Matrix]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.ssimJs.ssimJsStrings.full
    - typingsJapgolly.ssimJs.ssimJsStrings.same
    - typingsJapgolly.ssimJs.ssimJsStrings.valid
  */
  trait Shape extends StObject
  object Shape {
    
    inline def full: typingsJapgolly.ssimJs.ssimJsStrings.full = "full".asInstanceOf[typingsJapgolly.ssimJs.ssimJsStrings.full]
    
    inline def same: typingsJapgolly.ssimJs.ssimJsStrings.same = "same".asInstanceOf[typingsJapgolly.ssimJs.ssimJsStrings.same]
    
    inline def valid: typingsJapgolly.ssimJs.ssimJsStrings.valid = "valid".asInstanceOf[typingsJapgolly.ssimJs.ssimJsStrings.valid]
  }
}
