...
import typingsJapgolly.apidevtoolsSwaggerParser.mod.ApiCallback
import typingsJapgolly.apidevtoolsSwaggerParser.mod.Options
import typingsJapgolly.apidevtoolsSwaggerParser.mod.RefsCallback
...
object mod {
  ...
  @js.native
  open class ^ ()
    extends typingsJapgolly.apidevtoolsSwaggerParser.mod.^
  @JSImport("swagger-parser", JSImport.Namespace)
  @js.native
  ...
  @js.native
  open class Refs ()
    extends typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs
  ...
  /* static member */
  inline def resolve(api: String): js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(api.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs]]
  /**
    * *This method is used internally by other methods, such as `bundle` and `dereference`. You probably won't need to call this method yourself.*
    *
  ...
  /* static member */
  inline def resolve(api: String, options: Options): js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(api.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs]]
  /* static member */
  ...
  inline def resolve(api: Document[js.Object]): js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs] = ^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(api.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs]]
  ...
  inline def resolve(api: Document[js.Object], options: Options): js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(api.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs]]
  ...
  /* static member */
  inline def resolve(baseUrl: String, api: String, options: Options): js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(baseUrl.asInstanceOf[js.Any], api.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs]]
  /* static member */
  ...
  inline def resolve(baseUrl: String, api: Document[js.Object], options: Options): js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs] = (^.asInstanceOf[js.Dynamic].applyDynamic("resolve")(baseUrl.asInstanceOf[js.Any], api.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.apidevtoolsSwaggerParser.mod.Refs]]
