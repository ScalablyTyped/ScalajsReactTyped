package typingsJapgolly.smoothie.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.smoothie.AnonIndex
import typingsJapgolly.smoothie.AnonLineWidth
import typingsJapgolly.smoothie.smoothieStrings.bezier
import typingsJapgolly.smoothie.smoothieStrings.linear
import typingsJapgolly.smoothie.smoothieStrings.step
...
object IChartOptions {
  ...
  def apply(
    ...
    tooltipFormatter: (/* timestamp */ Double, /* data */ js.Array[AnonIndex]) => CallbackTo[String] = null,
    tooltipLine: AnonLineWidth = null,
    yIntermediateFormatter: (/* intermediate */ Double, /* precision */ Double) => CallbackTo[String] = null,
    yMaxFormatter: (/* max */ Double, /* precision */ Double) => CallbackTo[String] = null,
    yMinFormatter: (/* min */ Double, /* precision */ Double) => CallbackTo[String] = null,
    yRangeFunction: /* range */ IRange => CallbackTo[IRange] = null
  ): IChartOptions = {
    ...
    if (tooltipFormatter != null) __obj.updateDynamic("tooltipFormatter")(js.Any.fromFunction2((t0: /* timestamp */ scala.Double, t1: /* data */ js.Array[typingsJapgolly.smoothie.AnonIndex]) => tooltipFormatter(t0, t1).runNow()))
    if (tooltipLine != null) __obj.updateDynamic("tooltipLine")(tooltipLine.asInstanceOf[js.Any])
    if (yIntermediateFormatter != null) __obj.updateDynamic("yIntermediateFormatter")(js.Any.fromFunction2((t0: /* intermediate */ scala.Double, t1: /* precision */ scala.Double) => yIntermediateFormatter(t0, t1).runNow()))
    if (yMaxFormatter != null) __obj.updateDynamic("yMaxFormatter")(js.Any.fromFunction2((t0: /* max */ scala.Double, t1: /* precision */ scala.Double) => yMaxFormatter(t0, t1).runNow()))
    if (yMinFormatter != null) __obj.updateDynamic("yMinFormatter")(js.Any.fromFunction2((t0: /* min */ scala.Double, t1: /* precision */ scala.Double) => yMinFormatter(t0, t1).runNow()))
    if (yRangeFunction != null) __obj.updateDynamic("yRangeFunction")(js.Any.fromFunction1((t0: /* range */ typingsJapgolly.smoothie.mod.IRange) => yRangeFunction(t0).runNow()))
