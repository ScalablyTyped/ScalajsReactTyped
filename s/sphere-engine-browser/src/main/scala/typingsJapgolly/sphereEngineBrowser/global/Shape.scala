...
import typingsJapgolly.sphereEngineBrowser.Vertex
...
open class Shape protected ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Shape {
  def this(`type`: Double, texture: Null, vertices: typingsJapgolly.sphereEngineBrowser.VertexList) = this()
  /**
  ...
  def this(
    `type`: Double,
    texture: typingsJapgolly.sphereEngineBrowser.Texture,
    vertices: typingsJapgolly.sphereEngineBrowser.VertexList
  ) = this()
  def this(
    `type`: Double,
    texture: Null,
    vertices: typingsJapgolly.sphereEngineBrowser.VertexList,
    indices: typingsJapgolly.sphereEngineBrowser.IndexList
  ) = this()
  def this(
    `type`: Double,
    texture: typingsJapgolly.sphereEngineBrowser.Texture,
...
object Shape {
  ...
  inline def drawImmediate(
    surface: typingsJapgolly.sphereEngineBrowser.Surface,
    `type`: typingsJapgolly.sphereEngineBrowser.ShapeType,
    texture: Null,
  ...
  inline def drawImmediate(`type`: typingsJapgolly.sphereEngineBrowser.ShapeType, texture: Null, vertices: js.Array[Vertex]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("drawImmediate")(`type`.asInstanceOf[js.Any], texture.asInstanceOf[js.Any], vertices.asInstanceOf[js.Any])).asInstanceOf[Unit]
  /**
  ...
  /**
    ...
    */
  /* static member */
  inline def drawImmediate(`type`: typingsJapgolly.sphereEngineBrowser.ShapeType, vertices: js.Array[Vertex]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("drawImmediate")(`type`.asInstanceOf[js.Any], vertices.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
