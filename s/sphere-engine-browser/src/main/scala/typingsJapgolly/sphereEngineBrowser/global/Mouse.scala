...
import typingsJapgolly.sphereEngineBrowser.MouseEvent
...
open class Mouse ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Mouse {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def isPressed(key: typingsJapgolly.sphereEngineBrowser.MouseKey): Boolean = js.native
...
object Mouse {
  ...
  @js.native
  val Default: typingsJapgolly.sphereEngineBrowser.Mouse = js.native
}
