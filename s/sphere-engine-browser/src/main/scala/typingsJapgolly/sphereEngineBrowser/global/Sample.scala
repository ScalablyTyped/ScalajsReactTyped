...
open class Sample protected ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Sample {
  /**
...
object Sample {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromFile(fileName: String): js.Promise[typingsJapgolly.sphereEngineBrowser.Sample] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromFile")(fileName.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.sphereEngineBrowser.Sample]]
}
