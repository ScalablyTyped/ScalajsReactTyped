...
open class Server protected ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Server {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def accept(): typingsJapgolly.sphereEngineBrowser.Socket = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def acceptNext(): js.Promise[typingsJapgolly.sphereEngineBrowser.Socket] = js.native
