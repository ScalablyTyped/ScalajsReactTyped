...
open class Sound protected ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Sound {
  /**
...
object Sound {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromFile(fileName: String): js.Promise[typingsJapgolly.sphereEngineBrowser.Sound] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromFile")(fileName.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.sphereEngineBrowser.Sound]]
}
