...
open class RNG ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.RNG
object RNG {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromSeed(seed: Double): typingsJapgolly.sphereEngineBrowser.RNG = ^.asInstanceOf[js.Dynamic].applyDynamic("fromSeed")(seed.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sphereEngineBrowser.RNG]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromState(state: String): typingsJapgolly.sphereEngineBrowser.RNG = ^.asInstanceOf[js.Dynamic].applyDynamic("fromState")(state.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.sphereEngineBrowser.RNG]
}
