...
import typingsJapgolly.sphereEngineBrowser.ShaderOptions
...
open class Shader protected ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Shader {
  /**
...
object Shader {
  ...
  @js.native
  val Default: typingsJapgolly.sphereEngineBrowser.Shader = js.native
  ...
  /**
    ...
    */
  /* static member */
  inline def fromFiles(options: ShaderOptions): js.Promise[typingsJapgolly.sphereEngineBrowser.Shader] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromFiles")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.sphereEngineBrowser.Shader]]
}
