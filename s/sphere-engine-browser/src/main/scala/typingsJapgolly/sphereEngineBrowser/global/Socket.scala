...
open class Socket ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Socket {
  /**
...
object Socket {
  ...
  /**
    ...
    */
  /* static member */
  inline def connectTo(hostName: String, port: Double): js.Promise[typingsJapgolly.sphereEngineBrowser.Socket] = (^.asInstanceOf[js.Dynamic].applyDynamic("connectTo")(hostName.asInstanceOf[js.Any], port.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.sphereEngineBrowser.Socket]]
}
