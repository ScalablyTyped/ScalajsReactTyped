...
import typingsJapgolly.sphereEngineBrowser.sphereEngineBrowserInts.`16`
import typingsJapgolly.sphereEngineBrowser.sphereEngineBrowserInts.`24`
import typingsJapgolly.sphereEngineBrowser.sphereEngineBrowserInts.`32`
import typingsJapgolly.sphereEngineBrowser.sphereEngineBrowserInts.`8`
...
open class Mixer protected ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Mixer {
  /**
...
object Mixer {
  ...
  @js.native
  val Default: typingsJapgolly.sphereEngineBrowser.Mixer = js.native
}
