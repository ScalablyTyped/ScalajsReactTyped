...
open class BlendOp ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.BlendOp {
...
object BlendOp {
  ...
  @js.native
  val Add: typingsJapgolly.sphereEngineBrowser.BlendOp = js.native
  ...
  @js.native
  val Average: typingsJapgolly.sphereEngineBrowser.BlendOp = js.native
  ...
  @js.native
  val Default: typingsJapgolly.sphereEngineBrowser.BlendOp = js.native
  ...
  @js.native
  val Multiply: typingsJapgolly.sphereEngineBrowser.BlendOp = js.native
  ...
  @js.native
  val Replace: typingsJapgolly.sphereEngineBrowser.BlendOp = js.native
  ...
  @js.native
  val Subtract: typingsJapgolly.sphereEngineBrowser.BlendOp = js.native
}
