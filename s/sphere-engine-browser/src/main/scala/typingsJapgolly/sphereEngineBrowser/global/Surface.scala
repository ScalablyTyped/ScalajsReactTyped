...
open class Surface protected ()
  extends StObject
     with typingsJapgolly.sphereEngineBrowser.Surface {
  /**
  ...
  def this(width: Double, height: Double, content: typingsJapgolly.sphereEngineBrowser.Color) = this()
}
object Surface {
  ...
  @js.native
  val Screen: typingsJapgolly.sphereEngineBrowser.Surface = js.native
  ...
  /**
    ...
    */
  /* static member */
  inline def fromFile(fileName: String): js.Promise[typingsJapgolly.sphereEngineBrowser.Surface] = ^.asInstanceOf[js.Dynamic].applyDynamic("fromFile")(fileName.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.sphereEngineBrowser.Surface]]
}
