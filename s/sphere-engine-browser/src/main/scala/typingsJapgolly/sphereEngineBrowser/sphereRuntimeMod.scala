...
import typingsJapgolly.sphereEngineBrowser.consoleMod.ConsoleOptions
import typingsJapgolly.sphereEngineBrowser.consoleMod.default
import typingsJapgolly.sphereEngineBrowser.focusTargetMod.FocusTargetOptions
import typingsJapgolly.sphereEngineBrowser.tweenMod.Easing
...
object sphereRuntimeMod {
  ...
  open class DataStream protected ()
    extends typingsJapgolly.sphereEngineBrowser.dataStreamMod.default {
  ...
  object DataStream {
    ...
    /**
      ...
      */
    /* static member */
    inline def fromFile(filename: String, fileOp: FileOp): js.Promise[typingsJapgolly.sphereEngineBrowser.dataStreamMod.DataStream] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromFile")(filename.asInstanceOf[js.Any], fileOp.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.sphereEngineBrowser.dataStreamMod.DataStream]]
  }
  ...
  object Easing extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.sphereEngineBrowser.tweenMod.Easing & Double] = js.native
    
    /* 0 */ val Back: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Back & Double = js.native
    
    /* 1 */ val Bounce: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Bounce & Double = js.native
    
    /* 2 */ val Circular: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Circular & Double = js.native
    
    /* 3 */ val Cubic: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Cubic & Double = js.native
    
    /* 4 */ val Elastic: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Elastic & Double = js.native
    
    /* 5 */ val Exponential: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Exponential & Double = js.native
    
    /* 6 */ val Linear: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Linear & Double = js.native
    
    /* 7 */ val Quadratic: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Quadratic & Double = js.native
    
    /* 8 */ val Quartic: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Quartic & Double = js.native
    
    /* 9 */ val Quintic: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Quintic & Double = js.native
    
    /* 10 */ val Sine: typingsJapgolly.sphereEngineBrowser.tweenMod.Easing.Sine & Double = js.native
  }
  ...
  open class FocusTarget ()
    extends typingsJapgolly.sphereEngineBrowser.focusTargetMod.default {
  ...
  open class Logger protected ()
    extends typingsJapgolly.sphereEngineBrowser.loggerMod.default {
    /**
  ...
  @js.native
  open class Query[T] ()
    extends typingsJapgolly.sphereEngineBrowser.fromMod.Query[T]
  ...
  /**
    ...
    */
  open class Thread ()
    extends typingsJapgolly.sphereEngineBrowser.threadMod.default {
  ...
  object Thread {
    ...
    /**
      ...
      */
    /* static member */
    inline def join(threads: typingsJapgolly.sphereEngineBrowser.threadMod.Thread*): js.Promise[Unit] = ^.asInstanceOf[js.Dynamic].applyDynamic("join")(threads.asInstanceOf[Seq[js.Any]]*).asInstanceOf[js.Promise[Unit]]
  }
  ...
  open class Tween[T /* <: js.Object */] protected ()
    extends typingsJapgolly.sphereEngineBrowser.tweenMod.default[T] {
    /**
  ...
  /**
    ...
    */
  inline def from[T](sources: js.Iterable[T]*): typingsJapgolly.sphereEngineBrowser.fromMod.Query[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(sources.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typingsJapgolly.sphereEngineBrowser.fromMod.Query[T]]
}
