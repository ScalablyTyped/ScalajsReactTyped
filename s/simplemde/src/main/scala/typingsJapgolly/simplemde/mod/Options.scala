...
object Options {
  ...
  def apply(
    ...
    previewRender: (/* markdownPlaintext */ String, /* previewElement */ js.UndefOr[HTMLElement]) => CallbackTo[String] = null,
    ...
    if (previewRender != null) __obj.updateDynamic("previewRender")(js.Any.fromFunction2((t0: /* markdownPlaintext */ java.lang.String, t1: /* previewElement */ js.UndefOr[org.scalajs.dom.raw.HTMLElement]) => previewRender(t0, t1).runNow()))
