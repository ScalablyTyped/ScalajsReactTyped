...
object distSrcWidgetsDiagramWidgetMod {
  ...
  open class DiagramWidget protected () extends BaseWidget[DiagramProps, DiagramState] {
    ...
    /**
      ...
      */
    def getMouseElement(event: Any): typingsJapgolly.stormReactDiagrams.anon.Element = js.native
  ...
  object DiagramProps {
    ...
    extension [Self <: DiagramProps](x: Self) {
      ...
      inline def setActionStillFiring(value: /* action */ BaseAction => Callback): Self = StObject.set(x, "actionStillFiring", js.Any.fromFunction1((t0: /* action */ BaseAction) => value(t0).runNow()))
      
      inline def setActionStillFiringUndefined: Self = StObject.set(x, "actionStillFiring", js.undefined)
      
      inline def setActionStoppedFiring(value: /* action */ BaseAction => Callback): Self = StObject.set(x, "actionStoppedFiring", js.Any.fromFunction1((t0: /* action */ BaseAction) => value(t0).runNow()))
