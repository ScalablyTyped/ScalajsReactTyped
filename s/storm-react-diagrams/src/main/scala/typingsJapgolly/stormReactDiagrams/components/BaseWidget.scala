...
object BaseWidget {
  def apply[P /* <: BaseWidgetProps */, S](
    ...
    P with js.Object, 
    typingsJapgolly.stormReactDiagrams.mod.BaseWidget[P, S], 
    Unit, 
    P with js.Object
  ] = {
  ...
  typingsJapgolly.stormReactDiagrams.mod.BaseWidget[P, S]](this.componentImport)
