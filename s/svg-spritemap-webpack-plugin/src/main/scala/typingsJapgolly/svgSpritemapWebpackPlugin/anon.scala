...
import typingsJapgolly.svgSpritemapWebpackPlugin.svgSpritemapWebpackPluginBooleans.`false`
import typingsJapgolly.svgSpritemapWebpackPlugin.svgSpritemapWebpackPluginStrings.data
import typingsJapgolly.svgSpritemapWebpackPlugin.svgSpritemapWebpackPluginStrings.fragment
