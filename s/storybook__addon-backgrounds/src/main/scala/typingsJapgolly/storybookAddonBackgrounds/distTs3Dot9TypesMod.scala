...
object distTs3Dot9TypesMod {
  ...
  object BackgroundSelectorItem {
    ...
    inline def apply(active: Boolean, id: String, onClick: Callback, title: String, value: String): BackgroundSelectorItem = {
      val __obj = js.Dynamic.literal(active = active.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], onClick = onClick.toJsFn, title = title.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
