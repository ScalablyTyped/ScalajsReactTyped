...
import typingsJapgolly.storybookAddonKnobs.distComponentsTypesObjectMod.ObjectTypeProps
import typingsJapgolly.storybookAddonKnobs.distComponentsTypesObjectMod.ObjectTypeState
