...
import typingsJapgolly.storybookAddonKnobs.anon.PartialSelectTypePropsSel
import typingsJapgolly.storybookAddonKnobs.anon.WeakValidationMapSelectTy
...
object distComponentsTypesSelectMod {
  ...
  object default {
    ...
    inline def apply(props: SelectTypeProps[SelectTypeKnobValue]): Element | Null = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[Element | Null]
    inline def apply(props: SelectTypeProps[SelectTypeKnobValue], context: Any): Element | Null = (^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Element | Null]
