...
import typingsJapgolly.svgPanZoom.anon.Height
...
object SvgPanZoom {
  ...
  object CustomEventHandler {
    ...
    inline def apply(destroy: js.Function, haltEventListeners: js.Array[String], init: CustomEventOptions => Callback): CustomEventHandler = {
      val __obj = js.Dynamic.literal(destroy = destroy.asInstanceOf[js.Any], haltEventListeners = haltEventListeners.asInstanceOf[js.Any], init = js.Any.fromFunction1((t0: CustomEventOptions) => init(t0).runNow()))
    ...
    extension [Self <: CustomEventHandler](x: Self) {
      ...
      inline def setInit(value: CustomEventOptions => Callback): Self = StObject.set(x, "init", js.Any.fromFunction1((t0: CustomEventOptions) => value(t0).runNow()))
    }
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnPan(value: /* newPan */ Point => Callback): Self = StObject.set(x, "onPan", js.Any.fromFunction1((t0: /* newPan */ Point) => value(t0).runNow()))
      
      inline def setOnPanUndefined: Self = StObject.set(x, "onPan", js.undefined)
      
      inline def setOnUpdatedCTM(value: /* newCTM */ SVGMatrix => Callback): Self = StObject.set(x, "onUpdatedCTM", js.Any.fromFunction1((t0: /* newCTM */ SVGMatrix) => value(t0).runNow()))
      
      inline def setOnUpdatedCTMUndefined: Self = StObject.set(x, "onUpdatedCTM", js.undefined)
      
      inline def setOnZoom(value: /* newScale */ Double => Callback): Self = StObject.set(x, "onZoom", js.Any.fromFunction1((t0: /* newScale */ Double) => value(t0).runNow()))
