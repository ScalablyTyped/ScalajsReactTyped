...
object mod extends Shortcut {
  ...
  object Mechanism {
    ...
    inline def apply(challenge: String => Callback, name: String, response: StringDictionary[Any] => String): Mechanism = {
      val __obj = js.Dynamic.literal(challenge = js.Any.fromFunction1((t0: String) => challenge(t0).runNow()), name = name.asInstanceOf[js.Any], response = js.Any.fromFunction1(response))
      __obj.asInstanceOf[Mechanism]
    }
    
    extension [Self <: Mechanism](x: Self) {
      
      inline def setChallenge(value: String => Callback): Self = StObject.set(x, "challenge", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
