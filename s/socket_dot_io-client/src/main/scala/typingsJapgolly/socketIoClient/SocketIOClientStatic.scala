...
import typingsJapgolly.socketIoClient.SocketIOClient.ConnectOpts
import typingsJapgolly.socketIoClient.SocketIOClient.Manager
import typingsJapgolly.socketIoClient.SocketIOClient.ManagerStatic
...
trait SocketIOClientStatic extends js.Object {
  ...
  /**
  	 ...
  	 */
  var Socket: typingsJapgolly.socketIoClient.SocketIOClient.Socket = js.native
  /**
    * Managers cache
    */
  ...
  /**
  	 * Manager constructor - exposed for the standalone build
  	 */
  def Manager(opts: ConnectOpts): typingsJapgolly.socketIoClient.SocketIOClient.Manager = js.native
  /**
  ...
  /**
  	 * Manager constructor - exposed for the standalone build
  	 */
  def Manager(uri: String): typingsJapgolly.socketIoClient.SocketIOClient.Manager = js.native
  def Manager(uri: String, opts: ConnectOpts): typingsJapgolly.socketIoClient.SocketIOClient.Manager = js.native
  /**
