...
import typingsJapgolly.engineIoClient.anon.Threshold
import typingsJapgolly.socketIoParser.mod.PacketType
...
object anon {
  ...
  object PartialManagerOptionsSock {
    ...
    extension [Self <: PartialManagerOptionsSock](x: Self) {
      ...
      inline def setAuthFunction1(value: /* cb */ js.Function1[/* data */ js.Object, Unit] => Callback): Self = StObject.set(x, "auth", js.Any.fromFunction1((t0: /* cb */ js.Function1[/* data */ js.Object, Unit]) => value(t0).runNow()))
