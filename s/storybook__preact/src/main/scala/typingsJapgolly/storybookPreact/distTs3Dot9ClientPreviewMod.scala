...
object distTs3Dot9ClientPreviewMod {
  ...
  object ClientApi {
    ...
    extension [Self <: ClientApi](x: Self) {
      ...
      inline def setLoad(value: /* repeated */ Any => Callback): Self = StObject.set(x, "load", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
