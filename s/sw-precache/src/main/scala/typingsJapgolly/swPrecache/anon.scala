...
import typingsJapgolly.swToolbox.mod.Request
import typingsJapgolly.swToolbox.mod.Response
...
object anon {
  ...
  trait Handler extends StObject {
    ...
    var handler: typingsJapgolly.swPrecache.mod.Handler
  ...
  object Handler {
    ...
    inline def apply(handler: typingsJapgolly.swPrecache.mod.Handler, urlPattern: js.RegExp | String): Handler = {
    ...
    extension [Self <: Handler](x: Self) {
      ...
      inline def setHandler(value: typingsJapgolly.swPrecache.mod.Handler): Self = StObject.set(x, "handler", value.asInstanceOf[js.Any])
