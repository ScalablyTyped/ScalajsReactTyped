...
import typingsJapgolly.sanitizeHtml.anon.Multiple
import typingsJapgolly.sanitizeHtml.sanitizeHtmlBooleans.`false`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.discard
    - typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.escape
    - typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.recursiveEscape
  */
  trait DisallowedTagsModes extends StObject
  object DisallowedTagsModes {
    
    inline def discard: typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.discard = "discard".asInstanceOf[typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.discard]
    
    inline def escape: typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.escape = "escape".asInstanceOf[typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.escape]
    
    inline def recursiveEscape: typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.recursiveEscape = "recursiveEscape".asInstanceOf[typingsJapgolly.sanitizeHtml.sanitizeHtmlStrings.recursiveEscape]
  }
