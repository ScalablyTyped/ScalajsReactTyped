...
import typingsJapgolly.htmlparser2.mod.Options
...
object IOptions {
  ...
  def apply(
    ...
    exclusiveFilter: /* frame */ IFrame => CallbackTo[Boolean] = null,
    nonTextTags: js.Array[String] = null,
    parser: Options = null,
    selfClosing: js.Array[String] = null,
    textFilter: /* text */ String => CallbackTo[String] = null,
    ...
    if (exclusiveFilter != null) __obj.updateDynamic("exclusiveFilter")(js.Any.fromFunction1((t0: /* frame */ typingsJapgolly.sanitizeHtml.mod.IFrame) => exclusiveFilter(t0).runNow()))
    ...
    if (textFilter != null) __obj.updateDynamic("textFilter")(js.Any.fromFunction1((t0: /* text */ java.lang.String) => textFilter(t0).runNow()))
