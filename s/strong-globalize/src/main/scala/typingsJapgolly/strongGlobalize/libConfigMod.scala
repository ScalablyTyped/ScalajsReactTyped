...
object libConfigMod {
  ...
  object GlobalizeConfig {
    ...
    inline def apply(reset: Callback): GlobalizeConfig = {
    ...
    extension [Self <: GlobalizeConfig](x: Self) {
      ...
      inline def setLOG_FN(value: (/* level */ String, /* message */ Any) => Callback): Self = StObject.set(x, "LOG_FN", js.Any.fromFunction2((t0: /* level */ String, t1: /* message */ Any) => (value(t0, t1)).runNow()))
      
      inline def setLOG_FNUndefined: Self = StObject.set(x, "LOG_FN", js.undefined)
      
      inline def setLoad(value: /* obj */ AnyObject[Any] => Callback): Self = StObject.set(x, "load", js.Any.fromFunction1((t0: /* obj */ AnyObject[Any]) => value(t0).runNow()))
      
      inline def setLoadMessages(value: /* messages */ AnyObject[Any] => Callback): Self = StObject.set(x, "loadMessages", js.Any.fromFunction1((t0: /* messages */ AnyObject[Any]) => value(t0).runNow()))
      
      inline def setLoadMessagesUndefined: Self = StObject.set(x, "loadMessages", js.undefined)
      
      inline def setLoadUndefined: Self = StObject.set(x, "load", js.undefined)
      
      inline def setLocale(value: /* lang */ js.UndefOr[String] => Callback): Self = StObject.set(x, "locale", js.Any.fromFunction1((t0: /* lang */ js.UndefOr[String]) => value(t0).runNow()))
