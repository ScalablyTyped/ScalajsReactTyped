...
import typingsJapgolly.strongGlobalize.anon.Headers
import typingsJapgolly.strongGlobalize.libConfigMod.AnyObject
import typingsJapgolly.strongGlobalize.strongGlobalizeBooleans.`false`
import typingsJapgolly.strongGlobalize.strongGlobalizeStrings.all
import typingsJapgolly.strongGlobalize.strongGlobalizeStrings.none
