...
import typingsJapgolly.strongGlobalize.anon.HeadersAnyObject
import typingsJapgolly.strongGlobalize.anon.Typeofglobalize
import typingsJapgolly.strongGlobalize.anon.Typeofhelper
