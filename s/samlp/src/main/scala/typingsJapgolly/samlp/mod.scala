...
import typingsJapgolly.samlp.anon.Post
...
object mod {
  ...
  */
  ...
  object DigestAlgorithmType {
    ...
    inline def sha1: typingsJapgolly.samlp.samlpStrings.sha1 = "sha1".asInstanceOf[typingsJapgolly.samlp.samlpStrings.sha1]
    
    inline def sha256: typingsJapgolly.samlp.samlpStrings.sha256 = "sha256".asInstanceOf[typingsJapgolly.samlp.samlpStrings.sha256]
  }
  ...
  object IdPOptions {
    ...
    inline def apply(
      ...
      getPostURL: (String, Any, Request_[
          ...
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
          Record[String, Any]
        ], js.Function2[/* err */ Any, /* url */ String, Unit]) => Callback,
      issuer: String,
      key: String | Buffer
    ): IdPOptions = {
      val __obj = js.Dynamic.literal(cert = cert.asInstanceOf[js.Any], getPostURL = js.Any.fromFunction4((t0: String, t1: Any, t2: Request_[
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
          Any, 
          Any, 
          /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
          Record[String, Any]
        ], t3: js.Function2[/* err */ Any, /* url */ String, Unit]) => (getPostURL(t0, t1, t2, t3)).runNow()), issuer = issuer.asInstanceOf[js.Any], key = key.asInstanceOf[js.Any])
    ...
    extension [Self <: IdPOptions](x: Self) {
      ...
      ): Self = StObject.set(x, "getPostURL", js.Any.fromFunction4((t0: String, t1: Any, t2: Request_[
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.ParamsDictionary */ Any, 
              Any, 
              Any, 
              /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify core.Query */ Any, 
              Record[String, Any]
            ], t3: js.Function2[/* err */ Any, /* url */ String, Unit]) => (value(t0, t1, t2, t3)).runNow()))
  ...
  object ProfileMapper {
    ...
    inline def apply(getClaims: CallbackTo[Any], getNameIdentifier: CallbackTo[Any], metadata: js.Array[MetadataItem]): ProfileMapper = {
      val __obj = js.Dynamic.literal(getClaims = getClaims.toJsFn, getNameIdentifier = getNameIdentifier.toJsFn, metadata = metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[ProfileMapper]
    }
    
    extension [Self <: ProfileMapper](x: Self) {
      
      inline def setGetClaims(value: CallbackTo[Any]): Self = StObject.set(x, "getClaims", value.toJsFn)
      
      inline def setGetNameIdentifier(value: CallbackTo[Any]): Self = StObject.set(x, "getNameIdentifier", value.toJsFn)
  ...
  */
  ...
  object SignatureAlgorithmType {
    ...
    inline def `rsa-sha1`: typingsJapgolly.samlp.samlpStrings.`rsa-sha1` = "rsa-sha1".asInstanceOf[typingsJapgolly.samlp.samlpStrings.`rsa-sha1`]
    
    inline def `rsa-sha256`: typingsJapgolly.samlp.samlpStrings.`rsa-sha256` = "rsa-sha256".asInstanceOf[typingsJapgolly.samlp.samlpStrings.`rsa-sha256`]
  }
}
