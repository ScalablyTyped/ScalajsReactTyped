...
import typingsJapgolly.serverless.serverlessStrings.AUTHORIZER
import typingsJapgolly.serverless.serverlessStrings.HEADER
import typingsJapgolly.serverless.serverlessStrings.authorizer_
import typingsJapgolly.serverless.serverlessStrings.header_
