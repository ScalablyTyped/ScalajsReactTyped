...
import typingsJapgolly.serverless.anon.DefineCustomProperties
import typingsJapgolly.serverless.anon.Log
import typingsJapgolly.serverless.anon.PopulateService
import typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.Resources
...
object mod {
  ...
  open class ^ ()
    ...
    /* CompleteClass */
    override def getProvider(name: String): typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.^ = js.native
    ...
    /* CompleteClass */
    var pluginManager: typingsJapgolly.serverless.classesPluginManagerMod.^ = js.native
    ...
    /* CompleteClass */
    var service: typingsJapgolly.serverless.classesServiceMod.^ = js.native
    
    /* CompleteClass */
    override def setProvider(name: String, provider: typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.^): Null = js.native
    
    /* CompleteClass */
    var utils: typingsJapgolly.serverless.classesUtilsMod.^ = js.native
    ...
    /* CompleteClass */
    var yamlParser: typingsJapgolly.serverless.classesYamlParserMod.^ = js.native
  }
  ...
  type Event = typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.Event | js.Object
  ...
  trait FunctionDefinition extends StObject {
    ...
    var events: js.Array[typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.Event]
  ...
  object FunctionDefinition {
    ...
    inline def apply(events: js.Array[typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.Event]): FunctionDefinition = {
    ...
    extension [Self <: FunctionDefinition](x: Self) {
      ...
      inline def setEvents(value: js.Array[typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.Event]): Self = StObject.set(x, "events", value.asInstanceOf[js.Any])
      
      inline def setEventsVarargs(value: typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.Event*): Self = StObject.set(x, "events", js.Array(value*))
  ...
  object FunctionDefinitionHandler {
    ...
    inline def apply(
      events: js.Array[typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.Event],
      handler: String
  ...
  object FunctionDefinitionImage {
    ...
    inline def apply(events: js.Array[typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.Event], image: String): FunctionDefinitionImage = {
  ...
  trait Serverless extends StObject {
    ...
    def getProvider(name: String): typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.^
    
    def getVersion(): String
    
    def init(): js.Promise[Any]
    
    var pluginManager: typingsJapgolly.serverless.classesPluginManagerMod.^
    ...
    var service: typingsJapgolly.serverless.classesServiceMod.^
    
    def setProvider(name: String, provider: typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.^): Null
    
    var utils: typingsJapgolly.serverless.classesUtilsMod.^
    
    var variables: PopulateService
    
    var version: String
    
    var yamlParser: typingsJapgolly.serverless.classesYamlParserMod.^
  }
  object Serverless {
    ...
    inline def apply(
      ...
      getProvider: String => typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.^,
      getVersion: CallbackTo[String],
      init: CallbackTo[js.Promise[Any]],
      pluginManager: typingsJapgolly.serverless.classesPluginManagerMod.^,
      resources: Resources,
      run: CallbackTo[js.Promise[Any]],
      serverlessDirPath: String,
      service: typingsJapgolly.serverless.classesServiceMod.^,
      setProvider: (String, typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.^) => Null,
      utils: typingsJapgolly.serverless.classesUtilsMod.^,
      variables: PopulateService,
      version: String,
      yamlParser: typingsJapgolly.serverless.classesYamlParserMod.^
    ): Serverless = {
      val __obj = js.Dynamic.literal(cli = cli.asInstanceOf[js.Any], config = config.asInstanceOf[js.Any], configSchemaHandler = configSchemaHandler.asInstanceOf[js.Any], getProvider = js.Any.fromFunction1(getProvider), getVersion = getVersion.toJsFn, init = init.toJsFn, pluginManager = pluginManager.asInstanceOf[js.Any], resources = resources.asInstanceOf[js.Any], run = run.toJsFn, serverlessDirPath = serverlessDirPath.asInstanceOf[js.Any], service = service.asInstanceOf[js.Any], setProvider = js.Any.fromFunction2(setProvider), utils = utils.asInstanceOf[js.Any], variables = variables.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any], yamlParser = yamlParser.asInstanceOf[js.Any])
    ...
    extension [Self <: Serverless](x: Self) {
      ...
      inline def setGetProvider(value: String => typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.^): Self = StObject.set(x, "getProvider", js.Any.fromFunction1(value))
      ...
      inline def setPluginManager(value: typingsJapgolly.serverless.classesPluginManagerMod.^): Self = StObject.set(x, "pluginManager", value.asInstanceOf[js.Any])
      
      inline def setResources(value: Resources): Self = StObject.set(x, "resources", value.asInstanceOf[js.Any])
      
      inline def setRun(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "run", value.toJsFn)
      
      inline def setServerlessDirPath(value: String): Self = StObject.set(x, "serverlessDirPath", value.asInstanceOf[js.Any])
      
      inline def setService(value: typingsJapgolly.serverless.classesServiceMod.^): Self = StObject.set(x, "service", value.asInstanceOf[js.Any])
      
      inline def setSetProvider(value: (String, typingsJapgolly.serverless.pluginsAwsProviderAwsProviderMod.^) => Null): Self = StObject.set(x, "setProvider", js.Any.fromFunction2(value))
      
      inline def setUtils(value: typingsJapgolly.serverless.classesUtilsMod.^): Self = StObject.set(x, "utils", value.asInstanceOf[js.Any])
      
      inline def setVariables(value: PopulateService): Self = StObject.set(x, "variables", value.asInstanceOf[js.Any])
      
      inline def setVersion(value: String): Self = StObject.set(x, "version", value.asInstanceOf[js.Any])
      
      inline def setYamlParser(value: typingsJapgolly.serverless.classesYamlParserMod.^): Self = StObject.set(x, "yamlParser", value.asInstanceOf[js.Any])
    }
  }
}
