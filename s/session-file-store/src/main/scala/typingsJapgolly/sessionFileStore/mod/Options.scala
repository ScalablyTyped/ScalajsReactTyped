package typingsJapgolly.sessionFileStore.mod
...
object Options {
  @scala.inline
  def apply(
    decoder: /* repeated */ js.Any => Callback = null,
    encoder: /* repeated */ js.Any => Callback = null,
    encoding: String = null,
    encryptEncoding: String = null,
    factor: Int | Double = null,
    fallbackSessionFn: /* repeated */ js.Any => Callback = null,
    fileExtension: String = null,
    filePattern: js.RegExp = null,
    keyFunction: (/* secret */ String, /* sessionId */ String) => CallbackTo[String] = null,
    logFn: /* repeated */ js.Any => Callback = null,
    ...
    if (decoder != null) __obj.updateDynamic("decoder")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => decoder(t0).runNow()))
    if (encoder != null) __obj.updateDynamic("encoder")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => encoder(t0).runNow()))
    ...
    if (fallbackSessionFn != null) __obj.updateDynamic("fallbackSessionFn")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => fallbackSessionFn(t0).runNow()))
    ...
    if (keyFunction != null) __obj.updateDynamic("keyFunction")(js.Any.fromFunction2((t0: /* secret */ java.lang.String, t1: /* sessionId */ java.lang.String) => keyFunction(t0, t1).runNow()))
    if (logFn != null) __obj.updateDynamic("logFn")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => logFn(t0).runNow()))
