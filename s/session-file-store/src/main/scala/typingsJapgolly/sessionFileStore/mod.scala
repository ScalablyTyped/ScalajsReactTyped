package typingsJapgolly.sessionFileStore
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDecoder(value: /* repeated */ Any => Callback): Self = StObject.set(x, "decoder", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      
      inline def setDecoderUndefined: Self = StObject.set(x, "decoder", js.undefined)
      
      inline def setEncoder(value: /* repeated */ Any => Callback): Self = StObject.set(x, "encoder", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      ...
      inline def setFallbackSessionFn(value: /* repeated */ Any => Callback): Self = StObject.set(x, "fallbackSessionFn", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      ...
      inline def setLogFn(value: /* repeated */ Any => Callback): Self = StObject.set(x, "logFn", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
