...
object pluginsMod {
  ...
  object MultiDragOptions {
    ...
    extension [Self <: MultiDragOptions](x: Self) {
      ...
      inline def setOnDeselect(value: /* event */ SortableEvent => Callback): Self = StObject.set(x, "onDeselect", js.Any.fromFunction1((t0: /* event */ SortableEvent) => value(t0).runNow()))
      
      inline def setOnDeselectUndefined: Self = StObject.set(x, "onDeselect", js.undefined)
      
      inline def setOnSelect(value: /* event */ SortableEvent => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* event */ SortableEvent) => value(t0).runNow()))
  ...
  object OnSpillOptions {
    ...
    extension [Self <: OnSpillOptions](x: Self) {
      ...
      inline def setOnSpill(value: /* evt */ SortableEvent => Callback): Self = StObject.set(x, "onSpill", js.Any.fromFunction1((t0: /* evt */ SortableEvent) => value(t0).runNow()))
