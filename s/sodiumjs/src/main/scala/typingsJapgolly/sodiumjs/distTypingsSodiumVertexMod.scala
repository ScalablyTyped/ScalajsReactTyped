...
object distTypingsSodiumVertexMod {
  ...
  object Color extends StObject {
    ...
    sealed trait black
      extends StObject
         with Color
    /* 0 */ val black: typingsJapgolly.sodiumjs.distTypingsSodiumVertexMod.Color.black & Double = js.native
    
    @js.native
    sealed trait gray
      extends StObject
         with Color
    /* 1 */ val gray: typingsJapgolly.sodiumjs.distTypingsSodiumVertexMod.Color.gray & Double = js.native
    
    @js.native
    sealed trait purple
      extends StObject
         with Color
    /* 3 */ val purple: typingsJapgolly.sodiumjs.distTypingsSodiumVertexMod.Color.purple & Double = js.native
    
    @js.native
    sealed trait white
      extends StObject
         with Color
    /* 2 */ val white: typingsJapgolly.sodiumjs.distTypingsSodiumVertexMod.Color.white & Double = js.native
  }
