...
import typingsJapgolly.sodiumjs.distTypingsSodiumListenerMod.Listener
import typingsJapgolly.sodiumjs.distTypingsSodiumTuple2Mod.Tuple2
import typingsJapgolly.sodiumjs.distTypingsSodiumVertexMod.Vertex
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distTypingsSodiumStreamMod {
  
  @JSImport("sodiumjs/dist/typings/sodium/Stream", "Stream")
  @js.native
  open class Stream[A] () extends StObject {
  ...
  @js.native
  open class StreamLoop[A] () extends StreamWithSend[A] {
  ...
  @js.native
  open class StreamWithSend[A] () extends Stream[A] {
    def this(vertex: Vertex) = this()
