...
import typingsJapgolly.storybookTheming.storybookThemingStrings.`lazy`
...
import typingsJapgolly.storybookTheming.storybookThemingStrings.async
...
import typingsJapgolly.storybookTheming.storybookThemingStrings.eager
...
import typingsJapgolly.storybookTheming.storybookThemingStrings.sync
...
/* Inlined react.react.DetailedHTMLProps<react.react.ImgHTMLAttributes<std.HTMLImageElement>, std.HTMLImageElement> & {  css :@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-serialize-types-index.Interpolation<@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-types-index.Theme> | undefined} */
