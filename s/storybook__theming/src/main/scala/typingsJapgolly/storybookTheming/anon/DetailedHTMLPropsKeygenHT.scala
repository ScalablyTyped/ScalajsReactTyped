...
/* Inlined react.react.DetailedHTMLProps<react.react.KeygenHTMLAttributes<std.HTMLElement>, std.HTMLElement> & {  css :@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-serialize-types-index.Interpolation<@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-types-index.Theme> | undefined} */
trait DetailedHTMLPropsKeygenHT extends StObject {
...
object DetailedHTMLPropsKeygenHT {
  
  inline def apply(): DetailedHTMLPropsKeygenHT = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DetailedHTMLPropsKeygenHT]
  }
  
  extension [Self <: DetailedHTMLPropsKeygenHT](x: Self) {
