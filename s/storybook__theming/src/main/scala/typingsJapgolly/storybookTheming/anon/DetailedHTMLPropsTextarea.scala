...
/* Inlined react.react.DetailedHTMLProps<react.react.TextareaHTMLAttributes<std.HTMLTextAreaElement>, std.HTMLTextAreaElement> & {  css :@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-serialize-types-index.Interpolation<@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-types-index.Theme> | undefined} */
trait DetailedHTMLPropsTextarea extends StObject {
  ...
  var ref: js.UndefOr[LegacyRef[HTMLTextAreaElement]] = js.undefined
...
object DetailedHTMLPropsTextarea {
  
  inline def apply(): DetailedHTMLPropsTextarea = {
  ...
  extension [Self <: DetailedHTMLPropsTextarea](x: Self) {
    ...
    inline def setRef(value: LegacyRef[HTMLTextAreaElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
