...
/* Inlined react.react.SVGProps<std.SVGElement> & {  css :@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-serialize-types-index.Interpolation<@storybook/theming.@storybook/theming/dist/ts3.9/_modules/@emotion-react-types-index.Theme> | undefined} */
...
object SVGPropsSVGElementcssInte {
  ...
  inline def apply(): SVGPropsSVGElementcssInte = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SVGPropsSVGElementcssInte]
  }
  
  extension [Self <: SVGPropsSVGElementcssInte](x: Self) {
    ...
    inline def setOnError(value: ReactEventFrom[SVGElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: ReactEventFrom[SVGElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def setOnLoad(value: ReactEventFrom[SVGElement & org.scalajs.dom.Element] => Callback): Self = StObject.set(x, "onLoad", js.Any.fromFunction1((t0: ReactEventFrom[SVGElement & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def setRef(value: LegacyRef[SVGElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: SVGElement | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: SVGElement | Null) => value(t0).runNow()))
