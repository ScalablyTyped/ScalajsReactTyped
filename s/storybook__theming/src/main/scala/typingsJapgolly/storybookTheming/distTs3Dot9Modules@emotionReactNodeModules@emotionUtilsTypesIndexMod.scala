...
import typingsJapgolly.storybookTheming.storybookThemingBooleans.`true`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object `distTs3Dot9Modules@emotionReactNodeModules@emotionUtilsTypesIndexMod` {
  
  @JSImport("@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-utils-types-index", JSImport.Namespace)
  @js.native
  ...
  @JSImport("@storybook/theming/dist/ts3.9/_modules/@emotion-react-node_modules-@emotion-utils-types-index", "isBrowser")
  @js.native
