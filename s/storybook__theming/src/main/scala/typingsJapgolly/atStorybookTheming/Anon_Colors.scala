package typingsJapgolly.atStorybookTheming

import typingsJapgolly.atStorybookTheming.distModulesSyntaxMod.ColorsHash
...
object Anon_Colors {
  @scala.inline
  def apply(colors: ColorsHash, mono: String): Anon_Colors = {
