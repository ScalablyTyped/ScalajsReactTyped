package typingsJapgolly.scalike
...
object mod {
  ...
  object Future {
    ...
    extension [Self <: Future[?], A](x: Self & Future[A]) {
      ...
      inline def setFailed(value: CallbackTo[Future[js.Error]]): Self = StObject.set(x, "failed", value.toJsFn)
      ...
      inline def setForeach(value: js.Function1[/* a */ A, Any] => Callback): Self = StObject.set(x, "foreach", js.Any.fromFunction1((t0: js.Function1[/* a */ A, Any]) => value(t0).runNow()))
      
      inline def setGetPromise(value: CallbackTo[js.Promise[A]]): Self = StObject.set(x, "getPromise", value.toJsFn)
      ...
      inline def setOnComplete(value: js.Function1[/* t */ Try[A], Any] => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction1((t0: js.Function1[/* t */ Try[A], Any]) => value(t0).runNow()))
      ...
      inline def setValue(value: CallbackTo[Optional[Try[A]]]): Self = StObject.set(x, "value", value.toJsFn)
  ...
  object Optional {
    ...
    extension [Self <: Optional[?], A](x: Self & Optional[A]) {
      ...
      inline def setFlatten(value: CallbackTo[Optional[A]]): Self = StObject.set(x, "flatten", value.toJsFn)
      ...
      inline def setForeach(value: js.Function1[/* a */ A, Unit] => Callback): Self = StObject.set(x, "foreach", js.Any.fromFunction1((t0: js.Function1[/* a */ A, Unit]) => value(t0).runNow()))
      
      inline def setGet(value: CallbackTo[A]): Self = StObject.set(x, "get", value.toJsFn)
  ...
  object Try {
    ...
    extension [Self <: Try[?], A](x: Self & Try[A]) {
      ...
      inline def setFailed(value: CallbackTo[Try[A]]): Self = StObject.set(x, "failed", value.toJsFn)
      ...
      inline def setToOptional(value: CallbackTo[Optional[A]]): Self = StObject.set(x, "toOptional", value.toJsFn)
  ...
  object Either {
    ...
    inline def apply[A, B](
      ...
      val __obj = js.Dynamic.literal(fold = js.Any.fromFunction2(fold), isLeft = isLeft.asInstanceOf[js.Any], isRight = isRight.asInstanceOf[js.Any], left = left.toJsFn, right = right.toJsFn, swap = swap.toJsFn, value = value.asInstanceOf[js.Any])
    ...
    extension [Self <: Either[?, ?], A, B](x: Self & (Either[A, B])) {
      ...
      inline def setLeft(value: CallbackTo[LeftProjection[A, B]]): Self = StObject.set(x, "left", value.toJsFn)
      
      inline def setRight(value: CallbackTo[RightProjection[A, B]]): Self = StObject.set(x, "right", value.toJsFn)
      
      inline def setSwap(value: CallbackTo[Either[B, A]]): Self = StObject.set(x, "swap", value.toJsFn)
