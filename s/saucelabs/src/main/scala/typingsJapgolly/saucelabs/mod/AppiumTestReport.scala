...
trait AppiumTestReport
  ...
  var hasWdaLogs: js.UndefOr[Boolean] = js.undefined
  ...
  var vitalsLogRecordingEnabled: js.UndefOr[Boolean] = js.undefined
  
  var withSystemError: js.UndefOr[Boolean] = js.undefined
}
object AppiumTestReport {
  
  inline def apply(): AppiumTestReport = {
  ...
  extension [Self <: AppiumTestReport](x: Self) {
    ...
    inline def setHasWdaLogs(value: Boolean): Self = StObject.set(x, "hasWdaLogs", value.asInstanceOf[js.Any])
    
    inline def setHasWdaLogsUndefined: Self = StObject.set(x, "hasWdaLogs", js.undefined)
    ...
    inline def setVitalsLogRecordingEnabled(value: Boolean): Self = StObject.set(x, "vitalsLogRecordingEnabled", value.asInstanceOf[js.Any])
    
    inline def setVitalsLogRecordingEnabledUndefined: Self = StObject.set(x, "vitalsLogRecordingEnabled", js.undefined)
