...
object XCUITestReport {
  ...
  inline def apply(): XCUITestReport = {
  ...
  extension [Self <: XCUITestReport](x: Self) {
    ...
    inline def setScreenshots(value: js.Array[Double]): Self = StObject.set(x, "screenshots", value.asInstanceOf[js.Any])
    ...
    inline def setTestCaseGroups(value: js.Array[TestCaseGroup]): Self = StObject.set(x, "testCaseGroups", value.asInstanceOf[js.Any])
