...
import typingsJapgolly.saucelabs.saucelabsStrings.ANDROID_INSTRUMENTATION
import typingsJapgolly.saucelabs.saucelabsStrings.APPIUM
import typingsJapgolly.saucelabs.saucelabsStrings.BATCH
import typingsJapgolly.saucelabs.saucelabsStrings.MANUAL
