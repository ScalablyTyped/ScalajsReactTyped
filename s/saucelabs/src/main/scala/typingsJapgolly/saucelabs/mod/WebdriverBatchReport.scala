...
import typingsJapgolly.saucelabs.saucelabsStrings.APPIUM
import typingsJapgolly.saucelabs.saucelabsStrings.CANCELED
import typingsJapgolly.saucelabs.saucelabsStrings.FAILURE
import typingsJapgolly.saucelabs.saucelabsStrings.INSTALL_LAUNCH
import typingsJapgolly.saucelabs.saucelabsStrings.NONE
import typingsJapgolly.saucelabs.saucelabsStrings.PIRANHA
import typingsJapgolly.saucelabs.saucelabsStrings.SCREENSHOTS
import typingsJapgolly.saucelabs.saucelabsStrings.SKIPPED
import typingsJapgolly.saucelabs.saucelabsStrings.STRESS_TEST
import typingsJapgolly.saucelabs.saucelabsStrings.SUCCESS
import typingsJapgolly.saucelabs.saucelabsStrings.TENKOD
...
trait WebdriverBatchReport
  ...
  var automationFramework: js.UndefOr[APPIUM | TENKOD | PIRANHA] = js.undefined
...
object WebdriverBatchReport {
  ...
  inline def apply(): WebdriverBatchReport = {
  ...
  extension [Self <: WebdriverBatchReport](x: Self) {
    ...
    inline def setAutomationFramework(value: APPIUM | TENKOD | PIRANHA): Self = StObject.set(x, "automationFramework", value.asInstanceOf[js.Any])
