package typingsJapgolly.sindresorhusJimp.Jimp

import typingsJapgolly.node.Buffer
import typingsJapgolly.sindresorhusJimp.AnonB
import typingsJapgolly.sindresorhusJimp.AnonDiff
...
class Jimp protected () extends js.Object {
  ...
  def this(image: typingsJapgolly.sindresorhusJimp.Jimp.Jimp) = this()
  def this(path: String) = this()
  def this(data: Buffer, cb: ImageCallback) = this()
  def this(image: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, cb: ImageCallback) = this()
  ...
  def blit(src: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def blit(src: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double, srcx: Double): this.type = js.native
  def blit(src: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double, srcx: Double, srcy: Double): this.type = js.native
  def blit(
    src: typingsJapgolly.sindresorhusJimp.Jimp.Jimp,
    x: Double,
    y: Double,
    srcx: Double,
    srcy: Double,
  ...
  def clone(cb: ImageCallback): typingsJapgolly.sindresorhusJimp.Jimp.Jimp = js.native
  ...
  def composite(src: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def composite(src: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double, cb: ImageCallback): this.type = js.native
  ...
  def displace(map: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, offset: Double): this.type = js.native
  def displace(map: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, offset: Double, cb: ImageCallback): this.type = js.native
  ...
  def mask(src: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double): this.type = js.native
  def mask(src: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, x: Double, y: Double, cb: ImageCallback): this.type = js.native
...
object Jimp extends js.Object {
  ...
  def diff(img1: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, img2: typingsJapgolly.sindresorhusJimp.Jimp.Jimp): AnonDiff = js.native
  def diff(
    img1: typingsJapgolly.sindresorhusJimp.Jimp.Jimp,
    img2: typingsJapgolly.sindresorhusJimp.Jimp.Jimp,
    threshold: Double
  ): AnonDiff = js.native
  def distance(img1: typingsJapgolly.sindresorhusJimp.Jimp.Jimp, img2: typingsJapgolly.sindresorhusJimp.Jimp.Jimp): Double = js.native
  ...
  /* These are constructors, have already moved up, TODO: remove it in the future
    ...
    */
  def read(src: String): js.Promise[typingsJapgolly.sindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: String, cb: ImageCallback): js.Promise[typingsJapgolly.sindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: Buffer): js.Promise[typingsJapgolly.sindresorhusJimp.Jimp.Jimp] = js.native
  def read(src: Buffer, cb: ImageCallback): js.Promise[typingsJapgolly.sindresorhusJimp.Jimp.Jimp] = js.native
