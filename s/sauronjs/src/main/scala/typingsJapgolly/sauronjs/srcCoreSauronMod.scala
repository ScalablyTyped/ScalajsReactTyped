...
import typingsJapgolly.sauronjs.anon.TypeofComponent
...
object srcCoreSauronMod {
  ...
  type SauronComponentMap = StringDictionary[
    TypeofComponent & (Instantiable1[/* params */ ComponentParameters, typingsJapgolly.sauronjs.srcCoreComponentMod.^])
  ]
  ...
  trait SauronInstance extends StObject {
    ...
    def service(Service: Instantiable1[/* options */ Any, typingsJapgolly.sauronjs.srcCoreServiceMod.^]): SauronInstance = js.native
    def service(
      Service: Instantiable1[/* options */ Any, typingsJapgolly.sauronjs.srcCoreServiceMod.^],
      options: Any
