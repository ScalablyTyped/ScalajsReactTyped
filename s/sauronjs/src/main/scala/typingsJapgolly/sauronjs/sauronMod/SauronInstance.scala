package typingsJapgolly.sauronjs.sauronMod
...
trait SauronInstance extends js.Object {
  ...
  def service(Service: Instantiable1[/* options */ js.Any, typingsJapgolly.sauronjs.serviceMod.^]): SauronInstance = js.native
  def service(
    Service: Instantiable1[/* options */ js.Any, typingsJapgolly.sauronjs.serviceMod.^],
    options: js.Any
