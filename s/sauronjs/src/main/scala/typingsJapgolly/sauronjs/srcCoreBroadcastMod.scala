...
object srcCoreBroadcastMod {
  ...
  inline def attachSubject(`object`: typingsJapgolly.sauronjs.srcCoreServiceMod.^): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("attachSubject")(`object`.asInstanceOf[js.Any]).asInstanceOf[Any]
