...
import typingsJapgolly.showdown.anon.Codeblock
import typingsJapgolly.showdown.anon.Format
import typingsJapgolly.showdown.anon.Height
...
object mod {
  ...
  */
  ...
  object Flavor {
    ...
    inline def allOn: typingsJapgolly.showdown.showdownStrings.allOn = "allOn".asInstanceOf[typingsJapgolly.showdown.showdownStrings.allOn]
    
    inline def ghost: typingsJapgolly.showdown.showdownStrings.ghost = "ghost".asInstanceOf[typingsJapgolly.showdown.showdownStrings.ghost]
    
    inline def github: typingsJapgolly.showdown.showdownStrings.github = "github".asInstanceOf[typingsJapgolly.showdown.showdownStrings.github]
    
    inline def original: typingsJapgolly.showdown.showdownStrings.original = "original".asInstanceOf[typingsJapgolly.showdown.showdownStrings.original]
    
    inline def vanilla: typingsJapgolly.showdown.showdownStrings.vanilla = "vanilla".asInstanceOf[typingsJapgolly.showdown.showdownStrings.vanilla]
  }
  ...
  - typingsJapgolly.showdown.mod.FilterExtension because var conflicts: listeners, `type`. Inlined filter */ trait ShowdownExtension
    extends StObject
