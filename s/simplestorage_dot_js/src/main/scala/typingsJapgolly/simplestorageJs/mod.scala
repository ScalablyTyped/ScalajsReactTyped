...
import typingsJapgolly.simplestorageJs.mod.simplestoragejs.SimpleStorage
import typingsJapgolly.simplestorageJs.simplestorageJsBooleans.`false`
...
object mod extends Shortcut {
  ...
  object simplestoragejs {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.simplestorageJs.simplestorageJsStrings.OK
      - typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_NOT_AVAILABLE
      - typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_DISABLED
      - typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_QUOTA_EXCEEDED
    */
    trait StatusCode extends StObject
    object StatusCode {
      
      inline def LS_DISABLED: typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_DISABLED = "LS_DISABLED".asInstanceOf[typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_DISABLED]
      
      inline def LS_NOT_AVAILABLE: typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_NOT_AVAILABLE = "LS_NOT_AVAILABLE".asInstanceOf[typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_NOT_AVAILABLE]
      
      inline def LS_QUOTA_EXCEEDED: typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_QUOTA_EXCEEDED = "LS_QUOTA_EXCEEDED".asInstanceOf[typingsJapgolly.simplestorageJs.simplestorageJsStrings.LS_QUOTA_EXCEEDED]
      
      inline def OK: typingsJapgolly.simplestorageJs.simplestorageJsStrings.OK = "OK".asInstanceOf[typingsJapgolly.simplestorageJs.simplestorageJsStrings.OK]
    }
  }
}
