package typingsJapgolly.sodiumNative

import japgolly.scalajs.react.Callback
import typingsJapgolly.node.bufferMod.global.Buffer
import typingsJapgolly.sodiumNative.sodiumNativeInts.`-1`
import typingsJapgolly.sodiumNative.sodiumNativeInts.`0`
import typingsJapgolly.sodiumNative.sodiumNativeInts.`1`
...
object mod {
  ...
  object CryptoGenericHashWrap {
    ...
    inline def apply(`final`: Buffer => Callback, update: Buffer => Callback): CryptoGenericHashWrap = {
      val __obj = js.Dynamic.literal(update = js.Any.fromFunction1((t0: Buffer) => update(t0).runNow()))
      __obj.updateDynamic("final")(js.Any.fromFunction1((t0: Buffer) => `final`(t0).runNow()))
      __obj.asInstanceOf[CryptoGenericHashWrap]
    }
    
    extension [Self <: CryptoGenericHashWrap](x: Self) {
      
      inline def setFinal(value: Buffer => Callback): Self = StObject.set(x, "final", js.Any.fromFunction1((t0: Buffer) => value(t0).runNow()))
      
      inline def setUpdate(value: Buffer => Callback): Self = StObject.set(x, "update", js.Any.fromFunction1((t0: Buffer) => value(t0).runNow()))
    }
  }
  ...
  object CryptoHashSha256Wrap {
    ...
    inline def apply(`final`: Buffer => Callback, update: Buffer => Callback): CryptoHashSha256Wrap = {
      val __obj = js.Dynamic.literal(update = js.Any.fromFunction1((t0: Buffer) => update(t0).runNow()))
      __obj.updateDynamic("final")(js.Any.fromFunction1((t0: Buffer) => `final`(t0).runNow()))
  ...
  object CryptoHashSha512Wrap {
    ...
    inline def apply(`final`: Buffer => Callback, update: Buffer => Callback): CryptoHashSha512Wrap = {
      val __obj = js.Dynamic.literal(update = js.Any.fromFunction1((t0: Buffer) => update(t0).runNow()))
      __obj.updateDynamic("final")(js.Any.fromFunction1((t0: Buffer) => `final`(t0).runNow()))
  ...
  object CryptoOneTimeAuthWrap {
    ...
    inline def apply(`final`: Buffer => Callback, update: Buffer => Callback): CryptoOneTimeAuthWrap = {
      val __obj = js.Dynamic.literal(update = js.Any.fromFunction1((t0: Buffer) => update(t0).runNow()))
      __obj.updateDynamic("final")(js.Any.fromFunction1((t0: Buffer) => `final`(t0).runNow()))
  ...
  object CryptoStreamChacha20XorWrap {
    ...
    inline def apply(`final`: Callback, update: (Buffer, Buffer) => Callback): CryptoStreamChacha20XorWrap = {
      val __obj = js.Dynamic.literal(update = js.Any.fromFunction2((t0: Buffer, t1: Buffer) => (update(t0, t1)).runNow()))
    ...
    extension [Self <: CryptoStreamChacha20XorWrap](x: Self) {
      ...
      inline def setFinal(value: Callback): Self = StObject.set(x, "final", value.toJsFn)
      
      inline def setUpdate(value: (Buffer, Buffer) => Callback): Self = StObject.set(x, "update", js.Any.fromFunction2((t0: Buffer, t1: Buffer) => (value(t0, t1)).runNow()))
    }
  }
