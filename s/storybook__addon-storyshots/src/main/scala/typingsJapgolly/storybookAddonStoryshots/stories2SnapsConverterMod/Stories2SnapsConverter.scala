package typingsJapgolly.storybookAddonStoryshots.stories2SnapsConverterMod

import typingsJapgolly.storybookAddonStoryshots.AnonFileName
import typingsJapgolly.storybookAddonStoryshots.PartialStories2SnapsConve
