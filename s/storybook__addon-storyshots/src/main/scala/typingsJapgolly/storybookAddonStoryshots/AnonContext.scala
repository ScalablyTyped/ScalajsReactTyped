...
object AnonContext {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], snapshotFileName = snapshotFileName.asInstanceOf[js.Any], story = story.asInstanceOf[js.Any])
