...
import typingsJapgolly.strange.strangeInts.`-1`
import typingsJapgolly.strange.strangeInts.`0`
import typingsJapgolly.strange.strangeInts.`1`
import typingsJapgolly.strange.strangeStrings.`[]`
...
object mod extends Shortcut {
  ...
  object Bounds {
    ...
    inline def `[]`: typingsJapgolly.strange.strangeStrings.`[]` = "[]".asInstanceOf[typingsJapgolly.strange.strangeStrings.`[]`]
  }
  type Bounds = (/* () */ String) | `[]`
  ...
  trait RangeConstructor
    ...
    * @param bounds Range's bounds.
    */
  Instantiable0[org.scalajs.dom.Range]
       with Instantiable1[/* begin */ Endpoint, org.scalajs.dom.Range]
       with Instantiable2[
          (/* begin */ Endpoint) | (/* begin */ Null) | (/* begin */ Unit), 
          /* end */ Endpoint, 
          org.scalajs.dom.Range
        ]
       with Instantiable3[
          (/* begin */ Endpoint) | (/* begin */ Null) | (/* begin */ Unit), 
    ...
    /**
      ...
      * @param bounds Range's bounds.
      */
    def apply[T /* <: Endpoint */](): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: T): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: T, end: T): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: T, end: T, bounds: Bounds): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: T, end: Null, bounds: Bounds): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: T, end: Unit, bounds: Bounds): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: Null, end: T): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: Null, end: T, bounds: Bounds): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: Null, end: Null, bounds: Bounds): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: Null, end: Unit, bounds: Bounds): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: Unit, end: T): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: Unit, end: T, bounds: Bounds): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: Unit, end: Null, bounds: Bounds): org.scalajs.dom.Range = js.native
    def apply[T /* <: Endpoint */](begin: Unit, end: Unit, bounds: Bounds): org.scalajs.dom.Range = js.native
    ...
    /**
      ...
      */
    def compareBeginToBegin[U /* <: Endpoint */](a: org.scalajs.dom.Range, b: org.scalajs.dom.Range): `-1` | `0` | `1` = js.native
    ...
    /**
      ...
      */
    def compareBeginToEnd[U /* <: Endpoint */](a: org.scalajs.dom.Range, b: org.scalajs.dom.Range): `-1` | `0` | `1` = js.native
    ...
    /**
      ...
      */
    def compareEndToEnd[U /* <: Endpoint */](a: org.scalajs.dom.Range, b: org.scalajs.dom.Range): `-1` | `0` | `1` = js.native
    ...
    /**
      ...
      */
    def parse(range: String): org.scalajs.dom.Range = js.native
    /**
      * Parses a string stringified by
      * [`Range.prototype.toString`](#Range.prototype.toString).
      *
      ...
      */
    def parse[U /* <: Endpoint */](range: String, parse: js.Function1[/* endpoint */ String, U]): org.scalajs.dom.Range = js.native
    ...
    /**
      ...
      */
    def union[U /* <: Endpoint */](a: org.scalajs.dom.Range, b: org.scalajs.dom.Range): org.scalajs.dom.Range = js.native
  }
