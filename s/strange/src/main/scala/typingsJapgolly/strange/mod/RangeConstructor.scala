...
import typingsJapgolly.strange.strangeNumbers.`-1`
import typingsJapgolly.strange.strangeNumbers.`0`
import typingsJapgolly.strange.strangeNumbers.`1`
...
trait RangeConstructor
  ...
  */
Instantiable0[typingsJapgolly.std.Range]
     with Instantiable1[/* begin */ Endpoint, typingsJapgolly.std.Range]
     with Instantiable2[
      (/* begin */ Endpoint) | (/* begin */ Null), 
      /* end */ Endpoint, 
      typingsJapgolly.std.Range
    ]
     with Instantiable3[
      (/* begin */ Endpoint) | (/* begin */ Null), 
