...
import typingsJapgolly.salesforceCanvasJsSdk.salesforceCanvasJsSdkStrings.sfdcDotstreamingapi
...
object client {
  ...
  object AjaxSettings {
    ...
    inline def apply(client: Client_, success: Response[Any] => Callback): AjaxSettings = {
      val __obj = js.Dynamic.literal(client = client.asInstanceOf[js.Any], success = js.Any.fromFunction1((t0: Response[Any]) => success(t0).runNow()))
  ...
  object EventSubscription {
    ...
    inline def apply(name: String, onData: Any => Callback): EventSubscription = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], onData = js.Any.fromFunction1((t0: Any) => onData(t0).runNow()))
      __obj.asInstanceOf[EventSubscription]
    }
    
    extension [Self <: EventSubscription](x: Self) {
      
      inline def setOnData(value: Any => Callback): Self = StObject.set(x, "onData", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
  ...
  object StreamSubscription {
    ...
    inline def apply(onComplete: Any => Callback, onData: Any => Callback, params: StreamSubscriptionParams): StreamSubscription = {
      val __obj = js.Dynamic.literal(name = "sfdc.streamingapi", onComplete = js.Any.fromFunction1((t0: Any) => onComplete(t0).runNow()), onData = js.Any.fromFunction1((t0: Any) => onData(t0).runNow()), params = params.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.EventSubscription
    - typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.StreamSubscription
  */
  trait Subscription extends StObject
  object Subscription {
    
    inline def EventSubscription(name: String, onData: Any => Callback): typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.EventSubscription = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], onData = js.Any.fromFunction1((t0: Any) => onData(t0).runNow()))
      __obj.asInstanceOf[typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.EventSubscription]
    }
    
    inline def StreamSubscription(onComplete: Any => Callback, onData: Any => Callback, params: StreamSubscriptionParams): typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.StreamSubscription = {
      val __obj = js.Dynamic.literal(name = "sfdc.streamingapi", onComplete = js.Any.fromFunction1((t0: Any) => onComplete(t0).runNow()), onData = js.Any.fromFunction1((t0: Any) => onData(t0).runNow()), params = params.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.StreamSubscription]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.EventSubscriptionRef
    - typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.StreamSubscriptionRef
  */
  ...
  object _SubscriptionRef {
    ...
    inline def EventSubscriptionRef(name: String): typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.EventSubscriptionRef = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.EventSubscriptionRef]
    }
    
    inline def StreamSubscriptionRef(params: StreamSubscriptionParams): typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.StreamSubscriptionRef = {
      val __obj = js.Dynamic.literal(name = "sfdc.streamingapi", params = params.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.client.StreamSubscriptionRef]
    }
  }
}
