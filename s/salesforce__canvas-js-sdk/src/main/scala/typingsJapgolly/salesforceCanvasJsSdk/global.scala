...
import typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.Response
...
import typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.xd.Callback
import typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.xd.OriginCheckFn
import typingsJapgolly.salesforceCanvasJsSdk.anon.Height
import typingsJapgolly.salesforceCanvasJsSdk.anon.Typeofcanvas
  ...
  object Sfdc {
    ...
    object canvas {
      ...
      object ApplicationAuthType extends StObject {
        ...
        @JSBracketAccess
        def apply(value: String): js.UndefOr[typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.ApplicationAuthType & String] = js.native
        
        /* "OAUTH" */ val OAUTH: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.ApplicationAuthType.OAUTH & String = js.native
        
        /* "SIGNED_REQUEST" */ val SIGNED_REQUEST: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.ApplicationAuthType.SIGNED_REQUEST & String = js.native
      }
      ...
      object ApplicationOptions extends StObject {
        ...
        @JSBracketAccess
        def apply(value: String): js.UndefOr[typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.ApplicationOptions & String] = js.native
        
        /* "HideHeader" */ val HIDE_HEADER: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.ApplicationOptions.HIDE_HEADER & String = js.native
        
        /* "HideShare" */ val HIDE_SHARE: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.ApplicationOptions.HIDE_SHARE & String = js.native
        
        /* "PersonalEnabled" */ val PERSONAL_ENABLED: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.ApplicationOptions.PERSONAL_ENABLED & String = js.native
      }
      ...
      object EnvironmentDisplayLocation extends StObject {
        ...
        def apply(value: String): js.UndefOr[
                typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation & String
              ] = js.native
        
        /* "Chatter" */ val CHATTER: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.CHATTER & String = js.native
        
        /* "ChatterFeed" */ val CHATTER_FEED: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.CHATTER_FEED & String = js.native
        
        /* "MobileNav" */ val MOBILE_NAV: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.MOBILE_NAV & String = js.native
        
        /* "None" */ val NONE: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.NONE & String = js.native
        
        /* "OpenCTI" */ val OPEN_CTI: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.OPEN_CTI & String = js.native
        
        /* "PageLayout" */ val PAGE_LAYOUT: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.PAGE_LAYOUT & String = js.native
        
        /* "Publisher" */ val PUBLISHER: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.PUBLISHER & String = js.native
        
        /* "ServiceDesk" */ val SERVICE_DESK: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.SERVICE_DESK & String = js.native
        
        /* "Visualforce" */ val VISUAL_FORCE: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplayLocation.VISUAL_FORCE & String = js.native
      }
      ...
      object EnvironmentDisplaySubLocation extends StObject {
        ...
        @JSBracketAccess
        def apply(value: String): js.UndefOr[
                typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplaySubLocation & String
              ] = js.native
        
        /* "S1MobileCardFullview" */ val MOBILE_CARD_FULLVIEW: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplaySubLocation.MOBILE_CARD_FULLVIEW & String = js.native
        
        /* "S1MobileCardPreview" */ val MOBILE_CARD_PREVIEW: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplaySubLocation.MOBILE_CARD_PREVIEW & String = js.native
        
        /* "S1RecordHomeFullview" */ val RECORD_HOME_FULLVIEW: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplaySubLocation.RECORD_HOME_FULLVIEW & String = js.native
        
        /* "S1RecordHomePreview" */ val RECORD_HOME_PREVIEW: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.EnvironmentDisplaySubLocation.RECORD_HOME_PREVIEW & String = js.native
      }
      ...
      object UserType extends StObject {
        ...
        @JSBracketAccess
        def apply(value: String): js.UndefOr[typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.UserType & String] = js.native
        
        /* "STANDARD" */ val STANDARD: typingsJapgolly.salesforceCanvasJsSdk.Sfdc.canvas.UserType.STANDARD & String = js.native
      }
      ...
      object client {
        ...
        inline def refreshSignedRequest(cb: js.Function1[/* data */ Response[typingsJapgolly.salesforceCanvasJsSdk.anon.Response], Unit]): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("refreshSignedRequest")(cb.asInstanceOf[js.Any]).asInstanceOf[Unit]
