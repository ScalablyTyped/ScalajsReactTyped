...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setTemplateFunction2(value: (/* locals */ Locals, /* callback */ TemplateCallback) => Callback): Self = StObject.set(x, "template", js.Any.fromFunction2((t0: /* locals */ Locals, t1: /* callback */ TemplateCallback) => (value(t0, t1)).runNow()))
