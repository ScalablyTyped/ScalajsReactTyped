...
object mod {
  ...
  open class Stubby () extends StObject {
    ...
    var tlsPortal: typingsJapgolly.node.tlsMod.Server = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.stubby.stubbyStrings.GET
    - typingsJapgolly.stubby.stubbyStrings.PUT
    - typingsJapgolly.stubby.stubbyStrings.POST
    - typingsJapgolly.stubby.stubbyStrings.HEAD
    - typingsJapgolly.stubby.stubbyStrings.PATCH
    - typingsJapgolly.stubby.stubbyStrings.TRACE
    - typingsJapgolly.stubby.stubbyStrings.DELETE
    - typingsJapgolly.stubby.stubbyStrings.CONNECT
    - typingsJapgolly.stubby.stubbyStrings.OPTIONS
  */
  trait StubbyMethod extends StObject
  object StubbyMethod {
    
    inline def CONNECT: typingsJapgolly.stubby.stubbyStrings.CONNECT = "CONNECT".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.CONNECT]
    
    inline def DELETE: typingsJapgolly.stubby.stubbyStrings.DELETE = "DELETE".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.DELETE]
    
    inline def GET: typingsJapgolly.stubby.stubbyStrings.GET = "GET".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.GET]
    
    inline def HEAD: typingsJapgolly.stubby.stubbyStrings.HEAD = "HEAD".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.HEAD]
    
    inline def OPTIONS: typingsJapgolly.stubby.stubbyStrings.OPTIONS = "OPTIONS".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.OPTIONS]
    
    inline def PATCH: typingsJapgolly.stubby.stubbyStrings.PATCH = "PATCH".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.PATCH]
    
    inline def POST: typingsJapgolly.stubby.stubbyStrings.POST = "POST".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.POST]
    
    inline def PUT: typingsJapgolly.stubby.stubbyStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.PUT]
    
    inline def TRACE: typingsJapgolly.stubby.stubbyStrings.TRACE = "TRACE".asInstanceOf[typingsJapgolly.stubby.stubbyStrings.TRACE]
  }
  ...
  */
  ...
  object StubbyOptions {
    ...
    inline def StubbyWithKeyCertOptions(
      ...
      __obj.asInstanceOf[typingsJapgolly.stubby.mod.StubbyWithKeyCertOptions]
    }
    
    inline def StubbyWithPfxOptions(): typingsJapgolly.stubby.mod.StubbyWithPfxOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.stubby.mod.StubbyWithPfxOptions]
    }
  }
