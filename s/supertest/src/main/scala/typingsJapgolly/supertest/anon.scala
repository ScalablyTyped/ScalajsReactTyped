...
import typingsJapgolly.superagent.mod.Parser
import typingsJapgolly.superagent.mod.Plugin
import typingsJapgolly.superagent.mod.Response
import typingsJapgolly.superagent.mod.Serializer
import typingsJapgolly.supertest.supertestStrings.error
...
object anon {
  ...
  object PickRequestuseonsetqueryt {
    ...
    inline def apply(
      ...
      buffer: CallbackTo[PickRequestuseonsetqueryt],
      ...
      retry: CallbackTo[PickRequestuseonsetqueryt],
    ...
    extension [Self <: PickRequestuseonsetqueryt](x: Self) {
      ...
      inline def setBuffer(value: CallbackTo[PickRequestuseonsetqueryt]): Self = StObject.set(x, "buffer", value.toJsFn)
      ...
      inline def setRetry(value: CallbackTo[PickRequestuseonsetqueryt]): Self = StObject.set(x, "retry", value.toJsFn)
      ...
      inline def setWithCredentials(value: CallbackTo[PickRequestuseonsetqueryt]): Self = StObject.set(x, "withCredentials", value.toJsFn)
    }
  }
}
