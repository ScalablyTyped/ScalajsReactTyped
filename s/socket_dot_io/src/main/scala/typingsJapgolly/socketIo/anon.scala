...
import typingsJapgolly.engineIo.buildServerMod.Transport
...
import typingsJapgolly.socketIo.mod.AdapterConstructor
import typingsJapgolly.socketIoAdapter.mod.Adapter
import typingsJapgolly.socketIoParser.mod.Decoder
...
object anon {
  ...
  trait Typeofparser extends StObject {
    ...
    var Encoder: Instantiable0[typingsJapgolly.socketIoParser.mod.Encoder]
