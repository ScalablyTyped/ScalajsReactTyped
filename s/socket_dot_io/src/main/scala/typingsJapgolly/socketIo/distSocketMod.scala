...
import typingsJapgolly.socketIo.distBroadcastOperatorMod.BroadcastOperator
...
import typingsJapgolly.socketIoParser.mod.Packet
...
object distSocketMod {
  ...
  open class Socket[ListenEvents /* <: EventsMap */, EmitEvents /* <: EventsMap */, ServerSideEvents /* <: EventsMap */, SocketData] protected () extends StrictEventEmitter[ListenEvents, EmitEvents, SocketReservedEventsMap] {
    ...
    /**
      ...
      * });
      */
    def conn: typingsJapgolly.engineIo.mod.Socket = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.socketIo.socketIoStrings.`transport error`
    - typingsJapgolly.socketIo.socketIoStrings.`transport close`
    - typingsJapgolly.socketIo.socketIoStrings.`forced close`
    - typingsJapgolly.socketIo.socketIoStrings.`ping timeout`
    - typingsJapgolly.socketIo.socketIoStrings.`parse error`
    - typingsJapgolly.socketIo.socketIoStrings.`server shutting down`
    - typingsJapgolly.socketIo.socketIoStrings.`forced server close`
    - typingsJapgolly.socketIo.socketIoStrings.`client namespace disconnect`
    - typingsJapgolly.socketIo.socketIoStrings.`server namespace disconnect`
  */
  trait DisconnectReason extends StObject
  object DisconnectReason {
    
    inline def `client namespace disconnect`: typingsJapgolly.socketIo.socketIoStrings.`client namespace disconnect` = ("client namespace disconnect").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`client namespace disconnect`]
    
    inline def `forced close`: typingsJapgolly.socketIo.socketIoStrings.`forced close` = ("forced close").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`forced close`]
    
    inline def `forced server close`: typingsJapgolly.socketIo.socketIoStrings.`forced server close` = ("forced server close").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`forced server close`]
    
    inline def `parse error`: typingsJapgolly.socketIo.socketIoStrings.`parse error` = ("parse error").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`parse error`]
    
    inline def `ping timeout`: typingsJapgolly.socketIo.socketIoStrings.`ping timeout` = ("ping timeout").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`ping timeout`]
    
    inline def `server namespace disconnect`: typingsJapgolly.socketIo.socketIoStrings.`server namespace disconnect` = ("server namespace disconnect").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`server namespace disconnect`]
    
    inline def `server shutting down`: typingsJapgolly.socketIo.socketIoStrings.`server shutting down` = ("server shutting down").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`server shutting down`]
    
    inline def `transport close`: typingsJapgolly.socketIo.socketIoStrings.`transport close` = ("transport close").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`transport close`]
    
    inline def `transport error`: typingsJapgolly.socketIo.socketIoStrings.`transport error` = ("transport error").asInstanceOf[typingsJapgolly.socketIo.socketIoStrings.`transport error`]
  }
  ...
  object SocketReservedEventsMap {
    ...
    inline def apply(
      disconnect: DisconnectReason => Callback,
      disconnecting: DisconnectReason => Callback,
      error: js.Error => Callback
    ): SocketReservedEventsMap = {
      val __obj = js.Dynamic.literal(disconnect = js.Any.fromFunction1((t0: DisconnectReason) => disconnect(t0).runNow()), disconnecting = js.Any.fromFunction1((t0: DisconnectReason) => disconnecting(t0).runNow()), error = js.Any.fromFunction1((t0: js.Error) => error(t0).runNow()))
      __obj.asInstanceOf[SocketReservedEventsMap]
    }
    
    extension [Self <: SocketReservedEventsMap](x: Self) {
      
      inline def setDisconnect(value: DisconnectReason => Callback): Self = StObject.set(x, "disconnect", js.Any.fromFunction1((t0: DisconnectReason) => value(t0).runNow()))
      
      inline def setDisconnecting(value: DisconnectReason => Callback): Self = StObject.set(x, "disconnecting", js.Any.fromFunction1((t0: DisconnectReason) => value(t0).runNow()))
