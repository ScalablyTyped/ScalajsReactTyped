...
import typingsJapgolly.socketIo.distBroadcastOperatorMod.RemoteSocket
import typingsJapgolly.socketIo.distClientMod.Client
import typingsJapgolly.socketIo.distSocketMod.Socket
...
object distNamespaceMod {
  ...
  object NamespaceReservedEventsMap {
    ...
    inline def apply[ListenEvents /* <: EventsMap */, EmitEvents /* <: EventsMap */, ServerSideEvents /* <: EventsMap */, SocketData](
      connect: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData] => Callback,
      connection: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData] => Callback
    ): NamespaceReservedEventsMap[ListenEvents, EmitEvents, ServerSideEvents, SocketData] = {
      val __obj = js.Dynamic.literal(connect = js.Any.fromFunction1((t0: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData]) => connect(t0).runNow()), connection = js.Any.fromFunction1((t0: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData]) => connection(t0).runNow()))
    ...
    extension [Self <: NamespaceReservedEventsMap[?, ?, ?, ?], ListenEvents /* <: EventsMap */, EmitEvents /* <: EventsMap */, ServerSideEvents /* <: EventsMap */, SocketData](x: Self & (NamespaceReservedEventsMap[ListenEvents, EmitEvents, ServerSideEvents, SocketData])) {
      ...
      inline def setConnect(value: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData] => Callback): Self = StObject.set(x, "connect", js.Any.fromFunction1((t0: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData]) => value(t0).runNow()))
      
      inline def setConnection(value: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData] => Callback): Self = StObject.set(x, "connection", js.Any.fromFunction1((t0: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData]) => value(t0).runNow()))
    }
  }
  ...
  object ServerReservedEventsMap {
    ...
    inline def apply[ListenEvents /* <: EventsMap */, EmitEvents /* <: EventsMap */, ServerSideEvents /* <: EventsMap */, SocketData](
      connect: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData] => Callback,
      connection: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData] => Callback,
      new_namespace: Namespace[ListenEvents, EmitEvents, ServerSideEvents, SocketData] => Callback
    ): ServerReservedEventsMap[ListenEvents, EmitEvents, ServerSideEvents, SocketData] = {
      val __obj = js.Dynamic.literal(connect = js.Any.fromFunction1((t0: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData]) => connect(t0).runNow()), connection = js.Any.fromFunction1((t0: Socket[ListenEvents, EmitEvents, ServerSideEvents, SocketData]) => connection(t0).runNow()), new_namespace = js.Any.fromFunction1((t0: Namespace[ListenEvents, EmitEvents, ServerSideEvents, SocketData]) => new_namespace(t0).runNow()))
    ...
    extension [Self <: ServerReservedEventsMap[?, ?, ?, ?], ListenEvents /* <: EventsMap */, EmitEvents /* <: EventsMap */, ServerSideEvents /* <: EventsMap */, SocketData](x: Self & (ServerReservedEventsMap[ListenEvents, EmitEvents, ServerSideEvents, SocketData])) {
      ...
      inline def setNew_namespace(value: Namespace[ListenEvents, EmitEvents, ServerSideEvents, SocketData] => Callback): Self = StObject.set(x, "new_namespace", js.Any.fromFunction1((t0: Namespace[ListenEvents, EmitEvents, ServerSideEvents, SocketData]) => value(t0).runNow()))
    }
  }
}
