...
import typingsJapgolly.stremioAddonSdk.anon.Id
import typingsJapgolly.stremioAddonSdk.anon.addonsArrayAddonCatalogCa
import typingsJapgolly.stremioAddonSdk.anon.metaMetaDetailCache
import typingsJapgolly.stremioAddonSdk.anon.metasArrayMetaPreviewCach
import typingsJapgolly.stremioAddonSdk.anon.streamsArrayStreamCache
import typingsJapgolly.stremioAddonSdk.anon.subtitlesArraySubtitleCac
...
open class addonBuilder protected () extends StObject {
  ...
  def defineSubtitlesHandler(
    handler: js.Function1[
      /* args */ typingsJapgolly.stremioAddonSdk.anon.Extra, 
