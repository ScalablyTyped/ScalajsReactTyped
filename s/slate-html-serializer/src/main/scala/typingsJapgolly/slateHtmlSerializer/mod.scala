package typingsJapgolly.slateHtmlSerializer

import org.scalajs.dom.Element
import org.scalajs.dom.HTMLElement
import org.scalajs.dom.NodeList
import typingsJapgolly.slate.distInterfacesNodeMod.Node
import typingsJapgolly.slateHtmlSerializer.anon.Render
import typingsJapgolly.slateHtmlSerializer.anon.ToJSON
import typingsJapgolly.slateHtmlSerializer.anon.`0`
import typingsJapgolly.slateHtmlSerializer.anon.`1`
  ...
  trait Rule extends StObject {
    ...
    var deserialize: js.UndefOr[
        js.Function2[
          /* el */ Element, 
          /* next */ js.Function1[
            /* elements */ (js.Array[(org.scalajs.dom.Node & ChildNode) | Element]) | NodeList[org.scalajs.dom.Node], 
            Any
          ], 
          Any
        ]
    ...
    var serialize: js.UndefOr[
        js.Function2[/* obj */ Any, /* children */ String, japgolly.scalajs.react.facade.React.Node]
      ] = js.undefined
  }
  object Rule {
    ...
    extension [Self <: Rule](x: Self) {
      ...
      inline def setSerialize(value: (/* obj */ Any, /* children */ String) => japgolly.scalajs.react.facade.React.Node): Self = StObject.set(x, "serialize", js.Any.fromFunction2(value))
