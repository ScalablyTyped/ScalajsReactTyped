...
import typingsJapgolly.subscribeUiEvent.subscribeUiEventStrings._empty
import typingsJapgolly.subscribeUiEvent.subscribeUiEventStrings.x
import typingsJapgolly.subscribeUiEvent.subscribeUiEventStrings.y
...
object anon {
  ...
  object AxisIntention {
    ...
    extension [Self <: AxisIntention](x: Self) {
      ...
      inline def setAxisIntention(value: typingsJapgolly.subscribeUiEvent.subscribeUiEventStrings.x | y | _empty): Self = StObject.set(x, "axisIntention", value.asInstanceOf[js.Any])
