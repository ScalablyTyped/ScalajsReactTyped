...
import typingsJapgolly.subscribeUiEvent.mod.EventType
import typingsJapgolly.subscribeUiEvent.mod.TouchEventType
import typingsJapgolly.subscribeUiEvent.mod.UIEventType
