...
object Options {
  ...
  extension [Self <: Options](x: Self) {
    ...
    inline def setProgress(value: /* event */ js.UndefOr[SpeedTestEvent] => Callback): Self = StObject.set(x, "progress", js.Any.fromFunction1((t0: /* event */ js.UndefOr[SpeedTestEvent]) => value(t0).runNow()))
