...
- typingsJapgolly.surveyKnockout.mod.IParentElement because Already inherited
...
- typingsJapgolly.surveyKnockout.mod.IPanel because Already inherited
- typingsJapgolly.surveyKnockout.mod.IPage because var conflicts: containsErrors, elements, isPage, isPanel, isReadOnly, isVisible, name, parent, shortcutText, skeletonComponentName. Inlined isStarted */ @JSImport("survey-knockout", "PageModel")
@js.native
