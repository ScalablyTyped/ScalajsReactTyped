...
- typingsJapgolly.surveyKnockout.mod.IPage because var conflicts: containsErrors, elements, isPage, isPanel, isReadOnly, isVisible, name, parent. Inlined isStarted */ @JSImport("survey-knockout", "PageModel")
@js.native
