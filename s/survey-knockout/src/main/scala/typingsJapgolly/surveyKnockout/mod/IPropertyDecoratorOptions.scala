...
object IPropertyDecoratorOptions {
  ...
  extension [Self <: IPropertyDecoratorOptions[?], T](x: Self & IPropertyDecoratorOptions[T]) {
    ...
    inline def setOnSet(value: (/* val */ T, /* objectInstance */ Any) => Callback): Self = StObject.set(x, "onSet", js.Any.fromFunction2((t0: /* val */ T, t1: /* objectInstance */ Any) => (value(t0, t1)).runNow()))
