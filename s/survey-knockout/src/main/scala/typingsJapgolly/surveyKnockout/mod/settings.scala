...
import typingsJapgolly.surveyKnockout.anon.CaseSensitive
import typingsJapgolly.surveyKnockout.anon.Checkbox
import typingsJapgolly.surveyKnockout.anon.DataList
...
object settings {
  ...
  @js.native
  def titleTags: typingsJapgolly.surveyKnockout.anon.Page = js.native
  inline def titleTags_=(x: typingsJapgolly.surveyKnockout.anon.Page): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("titleTags")(x.asInstanceOf[js.Any])
