...
trait Answered extends StObject {
...
object Answered {
  ...
  extension [Self <: Answered](x: Self) {
    ...
    inline def setComposite(value: String): Self = StObject.set(x, "composite", value.asInstanceOf[js.Any])
