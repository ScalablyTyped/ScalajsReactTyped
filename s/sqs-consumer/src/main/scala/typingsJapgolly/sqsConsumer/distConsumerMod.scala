...
import typingsJapgolly.awsSdk.clientsSqsMod.Message
import typingsJapgolly.awsSdk.clientsSqsMod.^
import typingsJapgolly.events.mod.EventEmitter
import typingsJapgolly.sqsConsumer.sqsConsumerStrings.empty
import typingsJapgolly.sqsConsumer.sqsConsumerStrings.error
import typingsJapgolly.sqsConsumer.sqsConsumerStrings.message_processed
import typingsJapgolly.sqsConsumer.sqsConsumerStrings.message_received
import typingsJapgolly.sqsConsumer.sqsConsumerStrings.processing_error
import typingsJapgolly.sqsConsumer.sqsConsumerStrings.response_processed
import typingsJapgolly.sqsConsumer.sqsConsumerStrings.stopped
import typingsJapgolly.sqsConsumer.sqsConsumerStrings.timeout_error
