package typingsJapgolly.subleveldown
...
import typingsJapgolly.std.ErrorCallback
...
object mod {
  ...
  object SubDownOptions {
    ...
    extension [Self <: SubDownOptions](x: Self) {
      ...
      inline def setOpen(value: /* callback */ ErrorCallback => Callback): Self = StObject.set(x, "open", js.Any.fromFunction1((t0: /* callback */ ErrorCallback) => value(t0).runNow()))
