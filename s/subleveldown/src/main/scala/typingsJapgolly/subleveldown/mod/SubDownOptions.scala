package typingsJapgolly.subleveldown.mod
...
object SubDownOptions {
  ...
  /* key */ StringDictionary[js.Any] = null,
    ...
    open: /* callback */ ErrorCallback => Callback = null,
    ...
    if (open != null) __obj.updateDynamic("open")(js.Any.fromFunction1((t0: /* callback */ typingsJapgolly.abstractLeveldown.mod.ErrorCallback) => open(t0).runNow()))
