package typingsJapgolly.signale.mod

import typingsJapgolly.signale.AnonLabel
import typingsJapgolly.signale.SignaleDefaultMethodsAwait
...
object ^ extends js.Object {
  var DefaultMethods: typingsJapgolly.signale.mod.DefaultMethods = js.native
  var Signale: SignaleConstructor = js.native
  var SignaleConfig: typingsJapgolly.signale.mod.SignaleConfig = js.native
  var SignaleOptions: typingsJapgolly.signale.mod.SignaleOptions[DefaultMethods] = js.native
  @JSName("await")
