...
import typingsJapgolly.storybookTelemetry.anon.NameOptions
import typingsJapgolly.storybookTelemetry.anon.PackageName
import typingsJapgolly.storybookTelemetry.anon.PartialTypescriptOptions
import typingsJapgolly.storybookTelemetry.anon.Type
import typingsJapgolly.storybookTelemetry.distTs3Dot9GetMonorepoTypeMod.MonorepoType
import typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.javascript
import typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.typescript
...
object distTs3Dot9TypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.start
    - typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.build
    - typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.upgrade
    - typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.init
    - typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-build`
    - typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-dev`
    - typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-metadata`
  */
  trait EventType extends StObject
  object EventType {
    
    inline def build: typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.build = "build".asInstanceOf[typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.build]
    
    inline def `error-build`: typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-build` = "error-build".asInstanceOf[typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-build`]
    
    inline def `error-dev`: typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-dev` = "error-dev".asInstanceOf[typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-dev`]
    
    inline def `error-metadata`: typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-metadata` = "error-metadata".asInstanceOf[typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.`error-metadata`]
    
    inline def init: typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.init = "init".asInstanceOf[typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.init]
    
    inline def start: typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.start = "start".asInstanceOf[typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.start]
    
    inline def upgrade: typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.upgrade = "upgrade".asInstanceOf[typingsJapgolly.storybookTelemetry.storybookTelemetryStrings.upgrade]
  }
  ...
  trait StorybookMetadata extends StObject {
    ...
    var framework: typingsJapgolly.storybookTelemetry.anon.Options
  ...
  object StorybookMetadata {
    ...
    inline def apply(
      framework: typingsJapgolly.storybookTelemetry.anon.Options,
    ...
    extension [Self <: StorybookMetadata](x: Self) {
      ...
      inline def setFramework(value: typingsJapgolly.storybookTelemetry.anon.Options): Self = StObject.set(x, "framework", value.asInstanceOf[js.Any])
