...
object buildModulesEventlistenersMod {
  ...
  trait On
    ...
    var progress: js.UndefOr[Listener[ProgressEvent] | js.Array[Listener[ProgressEvent]]] = js.undefined
  ...
  object On {
    ...
    extension [Self <: On](x: Self) {
      ...
      inline def setProgress(value: Listener[ProgressEvent] | js.Array[Listener[ProgressEvent]]): Self = StObject.set(x, "progress", value.asInstanceOf[js.Any])
      
      inline def setProgressUndefined: Self = StObject.set(x, "progress", js.undefined)
      
      inline def setProgressVarargs(value: Listener[ProgressEvent]*): Self = StObject.set(x, "progress", js.Array(value*))
