...
object ClientApi {
  @scala.inline
  def apply(
    addDecorator: DecoratorFunction[StoryFnVueReturnType] => CallbackTo[StoryApi[StoryFnVueReturnType]],
    addParameters: Parameters => CallbackTo[StoryApi[StoryFnVueReturnType]],
    ...
    storiesOf: (String, NodeModule) => CallbackTo[StoryApi[StoryFnVueReturnType]]
  ): ClientApi = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("addDecorator")(js.Any.fromFunction1((t0: typingsJapgolly.storybookAddons.typesMod.DecoratorFunction[typingsJapgolly.storybookVue.typesMod.StoryFnVueReturnType]) => addDecorator(t0).runNow()))
