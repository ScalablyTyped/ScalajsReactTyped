...
import typingsJapgolly.storybookHtml.distTs3Dot9ClientPreviewTypesMod.StoryFnHtmlReturnType
...
object distTs3Dot9ClientPreviewMod {
  ...
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "addDecorator")
  @js.native
  ...
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "addParameters")
  @js.native
  ...
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "clearDecorators")
  @js.native
  val clearDecorators: js.Function0[Unit] = js.native
  
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "configure")
  @js.native
  val configure: js.Function2[/* loader */ Loadable, /* module */ NodeModule, Unit] = js.native
  
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "forceReRender")
  @js.native
  val forceReRender: js.Function0[Unit] = js.native
  
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "getStorybook")
  @js.native
  val getStorybook: js.Function0[js.Array[IStorybookSection]] = js.native
  
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "raw")
  @js.native
  val raw: js.Function0[Any] = js.native
  
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "setAddon")
  @js.native
  val setAddon: js.Function1[/* addon */ Any, Unit] = js.native
  
  @JSImport("@storybook/html/dist/ts3.9/client/preview", "storiesOf")
  @js.native
  ...
  object ClientApi {
    ...
    inline def apply(
      ...
      storiesOf: (/* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify StoryKind */ Any, NodeModule) => StoryApi[StoryFnHtmlReturnType]
    ): ClientApi = {
