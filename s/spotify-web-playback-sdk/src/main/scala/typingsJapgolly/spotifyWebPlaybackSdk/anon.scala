...
import typingsJapgolly.spotifyWebPlaybackSdk.Spotify.Player
...
object anon {
  ...
  object PlayerInitidstring {
    ...
    inline def apply(getOAuthToken: js.Function1[/* token */ String, Unit] => Callback, id: String, name: String): PlayerInitidstring = {
      val __obj = js.Dynamic.literal(getOAuthToken = js.Any.fromFunction1((t0: js.Function1[/* token */ String, Unit]) => getOAuthToken(t0).runNow()), id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
  ...
  trait TypeofSpotify extends StObject {
    ...
    var Player: Instantiable1[/* options */ PlayerInit, typingsJapgolly.spotifyWebPlaybackSdk.Spotify.Player]
  }
