...
object mod {
  ...
  trait Params_ extends StObject {
    ...
    var N: typingsJapgolly.bignum.mod.^
    
    var N_length_bits: Double
    
    var g: typingsJapgolly.bignum.mod.^
  ...
  object Params_ {
    ...
    inline def apply(
      N: typingsJapgolly.bignum.mod.^,
      N_length_bits: Double,
      g: typingsJapgolly.bignum.mod.^,
      hash: String
    ): Params_ = {
    ...
    extension [Self <: Params_](x: Self) {
      ...
      inline def setG(value: typingsJapgolly.bignum.mod.^): Self = StObject.set(x, "g", value.asInstanceOf[js.Any])
      
      inline def setHash(value: String): Self = StObject.set(x, "hash", value.asInstanceOf[js.Any])
      
      inline def setN(value: typingsJapgolly.bignum.mod.^): Self = StObject.set(x, "N", value.asInstanceOf[js.Any])
