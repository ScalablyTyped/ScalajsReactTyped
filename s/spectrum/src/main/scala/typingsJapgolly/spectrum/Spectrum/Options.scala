package typingsJapgolly.spectrum.Spectrum
...
object Options {
  ...
  def apply(
    ...
    beforeShow: /* color */ Instance => Callback = null,
    cancelText: String = null,
    change: /* color */ Instance => Callback = null,
    ...
    if (beforeShow != null) __obj.updateDynamic("beforeShow")(js.Any.fromFunction1((t0: /* color */ typingsJapgolly.tinycolor2.mod.Instance) => beforeShow(t0).runNow()))
    if (cancelText != null) __obj.updateDynamic("cancelText")(cancelText.asInstanceOf[js.Any])
    if (change != null) __obj.updateDynamic("change")(js.Any.fromFunction1((t0: /* color */ typingsJapgolly.tinycolor2.mod.Instance) => change(t0).runNow()))
    ...
    if (hide != null) __obj.updateDynamic("hide")(js.Any.fromFunction1((t0: /* color */ typingsJapgolly.tinycolor2.mod.Instance) => hide(t0).runNow()))
    ...
    if (move != null) __obj.updateDynamic("move")(js.Any.fromFunction1((t0: /* color */ typingsJapgolly.tinycolor2.mod.Instance) => move(t0).runNow()))
    ...
    if (show != null) __obj.updateDynamic("show")(js.Any.fromFunction1((t0: /* color */ typingsJapgolly.tinycolor2.mod.Instance) => show(t0).runNow()))
