package typingsJapgolly.spectrum

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import org.scalajs.dom.DocumentFragment
import org.scalajs.dom.Element
import typingsJapgolly.jquery.JQuery.CoordinatesPartial
import typingsJapgolly.jquery.JQuery.EventBase
...
import typingsJapgolly.spectrum.spectrumBooleans.`false`
import typingsJapgolly.spectrum.spectrumStrings.beforeShow
import typingsJapgolly.spectrum.spectrumStrings.dragstart
import typingsJapgolly.spectrum.spectrumStrings.dragstop
import typingsJapgolly.spectrum.spectrumStrings.hide
import typingsJapgolly.spectrum.spectrumStrings.move
import typingsJapgolly.spectrum.spectrumStrings.show
import typingsJapgolly.tinycolor2.mod.Instance
...
object Spectrum {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.spectrum.spectrumStrings.hex
    - typingsJapgolly.spectrum.spectrumStrings.hex3
    - typingsJapgolly.spectrum.spectrumStrings.hsl
    - typingsJapgolly.spectrum.spectrumStrings.rgb
    - typingsJapgolly.spectrum.spectrumStrings.name
  */
  trait ColorFormatName extends StObject
  object ColorFormatName {
    
    inline def hex: typingsJapgolly.spectrum.spectrumStrings.hex = "hex".asInstanceOf[typingsJapgolly.spectrum.spectrumStrings.hex]
    
    inline def hex3: typingsJapgolly.spectrum.spectrumStrings.hex3 = "hex3".asInstanceOf[typingsJapgolly.spectrum.spectrumStrings.hex3]
    
    inline def hsl: typingsJapgolly.spectrum.spectrumStrings.hsl = "hsl".asInstanceOf[typingsJapgolly.spectrum.spectrumStrings.hsl]
    
    inline def name: typingsJapgolly.spectrum.spectrumStrings.name = "name".asInstanceOf[typingsJapgolly.spectrum.spectrumStrings.name]
    
    inline def rgb: typingsJapgolly.spectrum.spectrumStrings.rgb = "rgb".asInstanceOf[typingsJapgolly.spectrum.spectrumStrings.rgb]
  }
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setChange(value: /* color */ Instance => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* color */ Instance) => value(t0).runNow()))
      ...
      inline def setHide(value: /* color */ Instance => Callback): Self = StObject.set(x, "hide", js.Any.fromFunction1((t0: /* color */ Instance) => value(t0).runNow()))
      ...
      inline def setMove(value: /* color */ Instance => Callback): Self = StObject.set(x, "move", js.Any.fromFunction1((t0: /* color */ Instance) => value(t0).runNow()))
      ...
      inline def setShow(value: /* color */ Instance => Callback): Self = StObject.set(x, "show", js.Any.fromFunction1((t0: /* color */ Instance) => value(t0).runNow()))
