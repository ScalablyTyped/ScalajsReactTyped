...
import typingsJapgolly.svgToPdfkit.anon.FauxBold
...
object mod {
  ...
  object SVGtoPDFOptions {
    ...
    extension [Self <: SVGtoPDFOptions](x: Self) {
      ...
      inline def setWarningCallback(value: /* str */ String => Callback): Self = StObject.set(x, "warningCallback", js.Any.fromFunction1((t0: /* str */ String) => value(t0).runNow()))
