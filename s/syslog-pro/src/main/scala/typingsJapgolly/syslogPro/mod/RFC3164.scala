...
import typingsJapgolly.syslogPro.mod.RFC3164.MessageOptions
import typingsJapgolly.syslogPro.mod.RFC3164.Options
...
- typingsJapgolly.syslogPro.mod.RFC3164.Options because var conflicts: extendedColor. Inlined applicationName, hostname, facility, color, colors, server */ @JSImport("syslog-pro", "RFC3164")
@js.native
/**
