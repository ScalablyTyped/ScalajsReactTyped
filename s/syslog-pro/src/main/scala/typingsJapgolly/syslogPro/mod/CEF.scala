package typingsJapgolly.syslogPro.mod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.syslogPro.mod.CEF.Extensions
import typingsJapgolly.syslogPro.mod.CEF.Options
import typingsJapgolly.syslogPro.mod.CEF.Severity
import typingsJapgolly.syslogPro.syslogProBooleans.`false`
import typingsJapgolly.syslogPro.syslogProBooleans.`true`
...
open class CEF ()
  ...
  def send(syslogOptions: typingsJapgolly.syslogPro.mod.Syslog.Options): js.Promise[String] = js.native
  @JSName("send")
...
object CEF {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.syslogPro.syslogProInts.`0`
    - typingsJapgolly.syslogPro.syslogProInts.`1`
    - typingsJapgolly.syslogPro.syslogProInts.`2`
    - typingsJapgolly.syslogPro.syslogProInts.`3`
  */
  trait ExtensionType extends StObject
  object ExtensionType {
    
    inline def `0`: typingsJapgolly.syslogPro.syslogProInts.`0` = 0.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`0`]
    
    inline def `1`: typingsJapgolly.syslogPro.syslogProInts.`1` = 1.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`1`]
    
    inline def `2`: typingsJapgolly.syslogPro.syslogProInts.`2` = 2.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`2`]
    
    inline def `3`: typingsJapgolly.syslogPro.syslogProInts.`3` = 3.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`3`]
  }
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      * @default false
      */
    var server: js.UndefOr[typingsJapgolly.syslogPro.mod.Syslog.Options | `false`] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setServer(value: typingsJapgolly.syslogPro.mod.Syslog.Options | `false`): Self = StObject.set(x, "server", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.syslogPro.syslogProInts.`2`
    - typingsJapgolly.syslogPro.syslogProInts.`3`
    - typingsJapgolly.syslogPro.syslogProInts.`4`
    - typingsJapgolly.syslogPro.syslogProInts.`5`
    - typingsJapgolly.syslogPro.syslogProInts.`6`
    - typingsJapgolly.syslogPro.syslogProInts.`7`
    - typingsJapgolly.syslogPro.syslogProInts.`8`
    - typingsJapgolly.syslogPro.syslogProInts.`9`
    - typingsJapgolly.syslogPro.syslogProInts.`10`
    - typingsJapgolly.syslogPro.syslogProStrings.Unknown
    - typingsJapgolly.syslogPro.syslogProStrings.Low
    - typingsJapgolly.syslogPro.syslogProStrings.Medium
    - typingsJapgolly.syslogPro.syslogProStrings.High
    - typingsJapgolly.syslogPro.syslogProStrings.`Very-High`
  */
  ...
  object Severity {
    ...
    inline def `10`: typingsJapgolly.syslogPro.syslogProInts.`10` = 10.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`10`]
    
    inline def `2`: typingsJapgolly.syslogPro.syslogProInts.`2` = 2.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`2`]
    
    inline def `3`: typingsJapgolly.syslogPro.syslogProInts.`3` = 3.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`3`]
    
    inline def `4`: typingsJapgolly.syslogPro.syslogProInts.`4` = 4.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`4`]
    
    inline def `5`: typingsJapgolly.syslogPro.syslogProInts.`5` = 5.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`5`]
    
    inline def `6`: typingsJapgolly.syslogPro.syslogProInts.`6` = 6.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`6`]
    
    inline def `7`: typingsJapgolly.syslogPro.syslogProInts.`7` = 7.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`7`]
    
    inline def `8`: typingsJapgolly.syslogPro.syslogProInts.`8` = 8.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`8`]
    
    inline def `9`: typingsJapgolly.syslogPro.syslogProInts.`9` = 9.asInstanceOf[typingsJapgolly.syslogPro.syslogProInts.`9`]
    
    inline def High: typingsJapgolly.syslogPro.syslogProStrings.High = "High".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.High]
    
    inline def Low: typingsJapgolly.syslogPro.syslogProStrings.Low = "Low".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.Low]
    
    inline def Medium: typingsJapgolly.syslogPro.syslogProStrings.Medium = "Medium".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.Medium]
    
    inline def Unknown: typingsJapgolly.syslogPro.syslogProStrings.Unknown = "Unknown".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.Unknown]
    
    inline def `Very-High`: typingsJapgolly.syslogPro.syslogProStrings.`Very-High` = "Very-High".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.`Very-High`]
  }
