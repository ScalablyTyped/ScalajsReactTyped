...
import typingsJapgolly.syslogPro.mod.Syslog.Format
import typingsJapgolly.syslogPro.mod.Syslog.Options
import typingsJapgolly.syslogPro.mod.Syslog.Protocol
...
object Syslog {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.syslogPro.syslogProStrings.none
    - typingsJapgolly.syslogPro.syslogProStrings.rfc3164
    - typingsJapgolly.syslogPro.syslogProStrings.rfc5424
    - typingsJapgolly.syslogPro.syslogProStrings.leef
    - typingsJapgolly.syslogPro.syslogProStrings.cef
  */
  trait Format extends StObject
  object Format {
    
    inline def cef: typingsJapgolly.syslogPro.syslogProStrings.cef = "cef".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.cef]
    
    inline def leef: typingsJapgolly.syslogPro.syslogProStrings.leef = "leef".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.leef]
    
    inline def none: typingsJapgolly.syslogPro.syslogProStrings.none = "none".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.none]
    
    inline def rfc3164: typingsJapgolly.syslogPro.syslogProStrings.rfc3164 = "rfc3164".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.rfc3164]
    
    inline def rfc5424: typingsJapgolly.syslogPro.syslogProStrings.rfc5424 = "rfc5424".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.rfc5424]
  }
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var cef: js.UndefOr[typingsJapgolly.syslogPro.mod.CEF.Options] = js.undefined
    ...
    /**
      ...
      */
    var leef: js.UndefOr[typingsJapgolly.syslogPro.mod.LEEF.Options] = js.undefined
    ...
    /**
      ...
      */
    var rfc3164: js.UndefOr[typingsJapgolly.syslogPro.mod.RFC3164.Options] = js.undefined
    
    /**
      * RFC5424 related settings.
      */
    var rfc5424: js.UndefOr[typingsJapgolly.syslogPro.mod.RFC5424.Options] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setCef(value: typingsJapgolly.syslogPro.mod.CEF.Options): Self = StObject.set(x, "cef", value.asInstanceOf[js.Any])
      ...
      inline def setLeef(value: typingsJapgolly.syslogPro.mod.LEEF.Options): Self = StObject.set(x, "leef", value.asInstanceOf[js.Any])
      ...
      inline def setRfc3164(value: typingsJapgolly.syslogPro.mod.RFC3164.Options): Self = StObject.set(x, "rfc3164", value.asInstanceOf[js.Any])
      
      inline def setRfc3164Undefined: Self = StObject.set(x, "rfc3164", js.undefined)
      
      inline def setRfc5424(value: typingsJapgolly.syslogPro.mod.RFC5424.Options): Self = StObject.set(x, "rfc5424", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.syslogPro.syslogProStrings.udp
    - typingsJapgolly.syslogPro.syslogProStrings.tcp
    - typingsJapgolly.syslogPro.syslogProStrings.tls
  */
  trait Protocol extends StObject
  object Protocol {
    
    inline def tcp: typingsJapgolly.syslogPro.syslogProStrings.tcp = "tcp".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.tcp]
    
    inline def tls: typingsJapgolly.syslogPro.syslogProStrings.tls = "tls".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.tls]
    
    inline def udp: typingsJapgolly.syslogPro.syslogProStrings.udp = "udp".asInstanceOf[typingsJapgolly.syslogPro.syslogProStrings.udp]
  }
}
