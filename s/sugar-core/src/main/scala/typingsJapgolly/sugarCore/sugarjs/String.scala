...
object String extends js.Object {
  ...
  trait ChainableBase[RawValue] extends js.Object {
    ...
    def `match`(regexp: typingsJapgolly.std.RegExp): SugarDefaultChainable[RegExpMatchArray | Null] = js.native
    ...
    def replace(searchValue: typingsJapgolly.std.RegExp, replaceValue: java.lang.String): SugarDefaultChainable[java.lang.String] = js.native
    def replace(
      searchValue: typingsJapgolly.std.RegExp,
      replacer: js.Function2[/* substring */ java.lang.String, /* repeated */ js.Any, java.lang.String]
    ): SugarDefaultChainable[java.lang.String] = js.native
    def search(regexp: java.lang.String): SugarDefaultChainable[Double] = js.native
    def search(regexp: typingsJapgolly.std.RegExp): SugarDefaultChainable[Double] = js.native
    ...
    def split(separator: typingsJapgolly.std.RegExp): SugarDefaultChainable[js.Array[java.lang.String]] = js.native
    def split(separator: typingsJapgolly.std.RegExp, limit: Double): SugarDefaultChainable[js.Array[java.lang.String]] = js.native
