...
object angularSwiperAngularMod {
  ...
  open class SwiperComponent protected ()
    extends typingsJapgolly.swiper.angularAngularSrcPublicApiMod.SwiperComponent {
    def this(
      _ngZone: NgZone,
  ...
  open class SwiperModule ()
    extends typingsJapgolly.swiper.angularAngularSrcPublicApiMod.SwiperModule
  /* static members */
  object SwiperModule {
  ...
  open class SwiperSlideDirective protected ()
    extends typingsJapgolly.swiper.angularAngularSrcPublicApiMod.SwiperSlideDirective {
