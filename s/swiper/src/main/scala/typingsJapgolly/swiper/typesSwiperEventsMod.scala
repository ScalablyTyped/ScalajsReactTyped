...
import typingsJapgolly.swiper.typesModulesA11yMod.A11yEvents
import typingsJapgolly.swiper.typesModulesAutoplayMod.AutoplayEvents
import typingsJapgolly.swiper.typesModulesControllerMod.ControllerEvents
import typingsJapgolly.swiper.typesModulesEffectCardsMod.CardsEffectEvents
import typingsJapgolly.swiper.typesModulesEffectCoverflowMod.CoverflowEffectEvents
import typingsJapgolly.swiper.typesModulesEffectCreativeMod.CreativeEffectEvents
import typingsJapgolly.swiper.typesModulesEffectCubeMod.CubeEffectEvents
import typingsJapgolly.swiper.typesModulesEffectFadeMod.FadeEffectEvents
import typingsJapgolly.swiper.typesModulesEffectFlipMod.FlipEffectEvents
import typingsJapgolly.swiper.typesModulesFreeModeMod.FreeModeEvents
import typingsJapgolly.swiper.typesModulesHashNavigationMod.HashNavigationEvents
import typingsJapgolly.swiper.typesModulesHistoryMod.HistoryEvents
import typingsJapgolly.swiper.typesModulesKeyboardMod.KeyboardEvents
import typingsJapgolly.swiper.typesModulesLazyMod.LazyEvents
import typingsJapgolly.swiper.typesModulesMousewheelMod.MousewheelEvents
import typingsJapgolly.swiper.typesModulesNavigationMod.NavigationEvents
import typingsJapgolly.swiper.typesModulesPaginationMod.PaginationEvents
import typingsJapgolly.swiper.typesModulesParallaxMod.ParallaxEvents
import typingsJapgolly.swiper.typesModulesScrollbarMod.ScrollbarEvents
import typingsJapgolly.swiper.typesModulesThumbsMod.ThumbsEvents
import typingsJapgolly.swiper.typesModulesVirtualMod.VirtualEvents
import typingsJapgolly.swiper.typesModulesZoomMod.ZoomEvents
