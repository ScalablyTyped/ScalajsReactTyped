...
object SwiperSlide {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def children(value: Node | (js.Function1[/* slideData */ SlideData, Node])): this.type = set("children", value.asInstanceOf[js.Any])
    
    inline def childrenFunction1(value: /* slideData */ SlideData => Node): this.type = set("children", js.Any.fromFunction1(value))
    ...
    inline def virtualIndex(value: Double): this.type = set("virtualIndex", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: SwiperSlide.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SwiperSlideProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
