...
import typingsJapgolly.swiper.AnonCurrentX
import typingsJapgolly.swiper.swiperBooleans.`true`
import typingsJapgolly.swiper.swiperEsmMod.A11y
import typingsJapgolly.swiper.swiperEsmMod.Autoplay
import typingsJapgolly.swiper.swiperEsmMod.Controller
import typingsJapgolly.swiper.swiperEsmMod.EffectCoverflow
import typingsJapgolly.swiper.swiperEsmMod.EffectCube
import typingsJapgolly.swiper.swiperEsmMod.EffectFade
import typingsJapgolly.swiper.swiperEsmMod.EffectFlip
import typingsJapgolly.swiper.swiperEsmMod.HashNavigation
import typingsJapgolly.swiper.swiperEsmMod.History
import typingsJapgolly.swiper.swiperEsmMod.Keyboard
import typingsJapgolly.swiper.swiperEsmMod.Lazy
import typingsJapgolly.swiper.swiperEsmMod.Mousewheel
import typingsJapgolly.swiper.swiperEsmMod.Navigation
import typingsJapgolly.swiper.swiperEsmMod.Pagination
import typingsJapgolly.swiper.swiperEsmMod.Parallax
import typingsJapgolly.swiper.swiperEsmMod.Scrollbar
import typingsJapgolly.swiper.swiperEsmMod.Virtual
import typingsJapgolly.swiper.swiperEsmMod.Zoom
...
trait Swiper extends js.Object {
  ...
  /**
    ...
    * ]);
    */
  def addSlide(index: Double, slides: typingsJapgolly.std.HTMLElement): Unit = js.native
  ...
  /**
    ...
    * ]);
    */
  def appendSlide(slides: typingsJapgolly.std.HTMLElement): Unit = js.native
  /**
  ...
  /**
    ...
    * ]);
    */
  def prependSlide(slides: typingsJapgolly.std.HTMLElement): Unit = js.native
  /**
    * Remove all slides
    */
