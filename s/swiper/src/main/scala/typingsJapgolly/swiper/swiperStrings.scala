...
import typingsJapgolly.swiper.mod.AutoplayEvent
import typingsJapgolly.swiper.mod.CommonEvent
import typingsJapgolly.swiper.mod.LazyLoadingEvent
import typingsJapgolly.swiper.mod.PaginationEvent
import typingsJapgolly.swiper.mod.SwiperEvent
