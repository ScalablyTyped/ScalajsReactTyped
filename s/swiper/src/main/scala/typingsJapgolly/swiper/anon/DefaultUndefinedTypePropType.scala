...
object DefaultUndefinedTypePropType {
  ...
  extension [Self <: DefaultUndefinedTypePropType](x: Self) {
    ...
    inline def setTypeCallbackTo(value: CallbackTo[js.UndefOr[container | wrapper]]): Self = StObject.set(x, "type", value.toJsFn)
