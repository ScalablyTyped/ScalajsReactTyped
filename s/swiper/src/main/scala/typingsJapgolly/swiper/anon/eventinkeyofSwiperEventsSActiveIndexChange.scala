...
object eventinkeyofSwiperEventsSActiveIndexChange {
  
  inline def apply(): eventinkeyofSwiperEventsSActiveIndexChange = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[eventinkeyofSwiperEventsSActiveIndexChange]
  }
  
  extension [Self <: eventinkeyofSwiperEventsSActiveIndexChange](x: Self) {
    ...
    inline def setBreakpoint(value: (/* swiper */ default, /* breakpointParams */ SwiperOptions) => Callback): Self = StObject.set(x, "breakpoint", js.Any.fromFunction2((t0: /* swiper */ default, t1: /* breakpointParams */ SwiperOptions) => (value(t0, t1)).runNow()))
    ...
    inline def set_beforeBreakpoint(value: (/* swiper */ default, /* breakpointParams */ SwiperOptions) => Callback): Self = StObject.set(x, "_beforeBreakpoint", js.Any.fromFunction2((t0: /* swiper */ default, t1: /* breakpointParams */ SwiperOptions) => (value(t0, t1)).runNow()))
