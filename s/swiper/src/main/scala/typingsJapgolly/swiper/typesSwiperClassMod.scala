...
import typingsJapgolly.swiper.anon.CurrentX
import typingsJapgolly.swiper.swiperStrings.horizontal
import typingsJapgolly.swiper.swiperStrings.ltr
import typingsJapgolly.swiper.swiperStrings.rtl
import typingsJapgolly.swiper.swiperStrings.vertical
import typingsJapgolly.swiper.typesModulesA11yMod.A11yMethods
import typingsJapgolly.swiper.typesModulesAutoplayMod.AutoplayMethods
import typingsJapgolly.swiper.typesModulesControllerMod.ControllerMethods
import typingsJapgolly.swiper.typesModulesEffectCardsMod.CardsEffectMethods
import typingsJapgolly.swiper.typesModulesEffectCoverflowMod.CoverflowEffectMethods
import typingsJapgolly.swiper.typesModulesEffectCreativeMod.CreativeEffectMethods
import typingsJapgolly.swiper.typesModulesEffectCubeMod.CubeEffectMethods
import typingsJapgolly.swiper.typesModulesEffectFadeMod.FadeEffectMethods
import typingsJapgolly.swiper.typesModulesEffectFlipMod.FlipEffectMethods
import typingsJapgolly.swiper.typesModulesFreeModeMod.FreeModeMethods
import typingsJapgolly.swiper.typesModulesHashNavigationMod.HashNavigationMethods
import typingsJapgolly.swiper.typesModulesHistoryMod.HistoryMethods
import typingsJapgolly.swiper.typesModulesKeyboardMod.KeyboardMethods
import typingsJapgolly.swiper.typesModulesLazyMod.LazyMethods
import typingsJapgolly.swiper.typesModulesManipulationMod.ManipulationMethods
import typingsJapgolly.swiper.typesModulesMousewheelMod.MousewheelMethods
import typingsJapgolly.swiper.typesModulesNavigationMod.NavigationMethods
import typingsJapgolly.swiper.typesModulesPaginationMod.PaginationMethods
import typingsJapgolly.swiper.typesModulesParallaxMod.ParallaxMethods
import typingsJapgolly.swiper.typesModulesScrollbarMod.ScrollbarMethods
import typingsJapgolly.swiper.typesModulesThumbsMod.ThumbsMethods
import typingsJapgolly.swiper.typesModulesVirtualMod.VirtualMethods
import typingsJapgolly.swiper.typesModulesZoomMod.ZoomMethods
import typingsJapgolly.swiper.typesSharedMod.CSSSelector
import typingsJapgolly.swiper.typesSharedMod.SwiperModule
import typingsJapgolly.swiper.typesSwiperEventsMod.SwiperEvents
