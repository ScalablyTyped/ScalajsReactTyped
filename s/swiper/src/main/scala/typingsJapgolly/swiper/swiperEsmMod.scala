...
import typingsJapgolly.swiper.mod.DOM7Element
import typingsJapgolly.swiper.mod.SelectableElement
import typingsJapgolly.swiper.mod.SwiperModule
import typingsJapgolly.swiper.mod.SwiperOptions
...
object swiperEsmMod extends js.Object {
  ...
  class Virtual () extends SwiperModule {
    ...
    /**
      ...
      * ]);
      */
    def appendSlide(slide: typingsJapgolly.std.HTMLElement): Unit = js.native
    ...
    /**
      ...
      * ]);
      */
    def prependSlide(slide: typingsJapgolly.std.HTMLElement): Unit = js.native
    /**
