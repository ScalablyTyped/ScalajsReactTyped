...
object typesModulesAutoplayMod {
  ...
  object AutoplayEvents {
    ...
    inline def apply(
      autoplay: default => Callback,
      autoplayPause: default => Callback,
      autoplayResume: default => Callback,
      autoplayStart: default => Callback,
      autoplayStop: default => Callback
    ): AutoplayEvents = {
      val __obj = js.Dynamic.literal(autoplay = js.Any.fromFunction1((t0: default) => autoplay(t0).runNow()), autoplayPause = js.Any.fromFunction1((t0: default) => autoplayPause(t0).runNow()), autoplayResume = js.Any.fromFunction1((t0: default) => autoplayResume(t0).runNow()), autoplayStart = js.Any.fromFunction1((t0: default) => autoplayStart(t0).runNow()), autoplayStop = js.Any.fromFunction1((t0: default) => autoplayStop(t0).runNow()))
      __obj.asInstanceOf[AutoplayEvents]
    }
    
    extension [Self <: AutoplayEvents](x: Self) {
      
      inline def setAutoplay(value: default => Callback): Self = StObject.set(x, "autoplay", js.Any.fromFunction1((t0: default) => value(t0).runNow()))
      
      inline def setAutoplayPause(value: default => Callback): Self = StObject.set(x, "autoplayPause", js.Any.fromFunction1((t0: default) => value(t0).runNow()))
      
      inline def setAutoplayResume(value: default => Callback): Self = StObject.set(x, "autoplayResume", js.Any.fromFunction1((t0: default) => value(t0).runNow()))
      
      inline def setAutoplayStart(value: default => Callback): Self = StObject.set(x, "autoplayStart", js.Any.fromFunction1((t0: default) => value(t0).runNow()))
      
      inline def setAutoplayStop(value: default => Callback): Self = StObject.set(x, "autoplayStop", js.Any.fromFunction1((t0: default) => value(t0).runNow()))
    }
  }
