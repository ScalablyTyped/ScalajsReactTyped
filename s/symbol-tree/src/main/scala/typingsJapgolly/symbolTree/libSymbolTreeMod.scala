...
import typingsJapgolly.symbolTree.anon.Filter
...
object libSymbolTreeMod {
  ...
  trait SymbolTree[T /* <: js.Object */] extends StObject {
    ...
    /**
      ...
      */
    def ancestorsIterator(`object`: T): typingsJapgolly.symbolTree.libTreeIteratorMod.^[T] = js.native
    ...
    /**
      ...
      * @return An iterable iterator (ES6)
      */
    def childrenIterator(parent: T): typingsJapgolly.symbolTree.libTreeIteratorMod.^[T] = js.native
    def childrenIterator(parent: T, options: IteratorOptions): typingsJapgolly.symbolTree.libTreeIteratorMod.^[T] = js.native
    ...
    /**
      ...
      * @return An iterable iterator (ES6)
      */
    def nextSiblingsIterator(`object`: T): typingsJapgolly.symbolTree.libTreeIteratorMod.^[T] = js.native
    ...
    /**
      ...
      * @return An iterable iterator (ES6)
      */
    def previousSiblingsIterator(`object`: T): typingsJapgolly.symbolTree.libTreeIteratorMod.^[T] = js.native
    ...
    /**
      ...
      * @return An iterable iterator (ES6)
      */
    def treeIterator(`object`: T): typingsJapgolly.symbolTree.libTreeIteratorMod.^[T] = js.native
    def treeIterator(`object`: T, options: IteratorOptions): typingsJapgolly.symbolTree.libTreeIteratorMod.^[T] = js.native
