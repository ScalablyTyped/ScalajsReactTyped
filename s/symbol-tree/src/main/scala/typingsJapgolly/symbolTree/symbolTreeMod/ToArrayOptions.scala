...
object ToArrayOptions {
  ...
  def apply[T /* <: js.Object */](
    array: js.Array[T] = null,
    filter: /* object */ T => CallbackTo[js.Any] = null,
    thisArg: js.Any = null
  ): ToArrayOptions[T] = {
    val __obj = js.Dynamic.literal()
    if (array != null) __obj.updateDynamic("array")(array.asInstanceOf[js.Any])
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction1((t0: /* object */ T) => filter(t0).runNow()))
