package typingsJapgolly.symbolTree.symbolTreeMod

import typingsJapgolly.symbolTree.AnonFilter
...
trait SymbolTree[T /* <: js.Object */] extends js.Object {
  /**
  	 ...
  	 */
  def ancestorsIterator(`object`: T): typingsJapgolly.symbolTree.treeIteratorMod.^[T] = js.native
  ...
  /**
  	 ...
  	 * @return An iterable iterator (ES6)
  	 */
  def childrenIterator(parent: T): typingsJapgolly.symbolTree.treeIteratorMod.^[T] = js.native
  def childrenIterator(parent: T, options: IteratorOptions): typingsJapgolly.symbolTree.treeIteratorMod.^[T] = js.native
  ...
  /**
  	 ...
  	 * @return An iterable iterator (ES6)
  	 */
  def nextSiblingsIterator(`object`: T): typingsJapgolly.symbolTree.treeIteratorMod.^[T] = js.native
  /**
  ...
  /**
  	 ...
  	 * @return An iterable iterator (ES6)
  	 */
  def previousSiblingsIterator(`object`: T): typingsJapgolly.symbolTree.treeIteratorMod.^[T] = js.native
  /**
  ...
  /**
  	 ...
  	 * @return An iterable iterator (ES6)
  	 */
  def treeIterator(`object`: T): typingsJapgolly.symbolTree.treeIteratorMod.^[T] = js.native
  def treeIterator(`object`: T, options: IteratorOptions): typingsJapgolly.symbolTree.treeIteratorMod.^[T] = js.native
