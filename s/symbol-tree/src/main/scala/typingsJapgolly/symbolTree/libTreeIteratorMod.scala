...
import typingsJapgolly.symbolTree.symbolTreeInts.`3`
import typingsJapgolly.symbolTree.symbolTreeInts.`4`
import typingsJapgolly.symbolTree.symbolTreeInts.`5`
...
object libTreeIteratorMod {
  ...
  open class ^[T /* <: js.Object */] protected ()
    extends StObject
       with TreeIterator[T] {
    def this(
      tree: typingsJapgolly.symbolTree.libSymbolTreeMod.^[Any],
      root: T,
      firstResult: T,
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.symbolTree.symbolTreeInts.`1`
    - typingsJapgolly.symbolTree.symbolTreeInts.`2`
    - typingsJapgolly.symbolTree.symbolTreeInts.`3`
    - typingsJapgolly.symbolTree.symbolTreeInts.`4`
    - typingsJapgolly.symbolTree.symbolTreeInts.`5`
  */
  trait IterateFunction extends StObject
  object IterateFunction {
    
    inline def `1`: typingsJapgolly.symbolTree.symbolTreeInts.`1` = 1.asInstanceOf[typingsJapgolly.symbolTree.symbolTreeInts.`1`]
    
    inline def `2`: typingsJapgolly.symbolTree.symbolTreeInts.`2` = 2.asInstanceOf[typingsJapgolly.symbolTree.symbolTreeInts.`2`]
    
    inline def `3`: typingsJapgolly.symbolTree.symbolTreeInts.`3` = 3.asInstanceOf[typingsJapgolly.symbolTree.symbolTreeInts.`3`]
    
    inline def `4`: typingsJapgolly.symbolTree.symbolTreeInts.`4` = 4.asInstanceOf[typingsJapgolly.symbolTree.symbolTreeInts.`4`]
    
    inline def `5`: typingsJapgolly.symbolTree.symbolTreeInts.`5` = 5.asInstanceOf[typingsJapgolly.symbolTree.symbolTreeInts.`5`]
  }
