...
object JQuerySmartwizard {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.smartwizard.smartwizardStrings.left
    - typingsJapgolly.smartwizard.smartwizardStrings.right
    - typingsJapgolly.smartwizard.smartwizardStrings.center
  */
  trait ToolbarButtonPosition extends StObject
  object ToolbarButtonPosition {
    
    inline def center: typingsJapgolly.smartwizard.smartwizardStrings.center = "center".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.center]
    
    inline def left: typingsJapgolly.smartwizard.smartwizardStrings.left = "left".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.left]
    
    inline def right: typingsJapgolly.smartwizard.smartwizardStrings.right = "right".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.right]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.smartwizard.smartwizardStrings.none
    - typingsJapgolly.smartwizard.smartwizardStrings.top
    - typingsJapgolly.smartwizard.smartwizardStrings.bottom
    - typingsJapgolly.smartwizard.smartwizardStrings.both
  */
  trait ToolbarPosition extends StObject
  object ToolbarPosition {
    
    inline def both: typingsJapgolly.smartwizard.smartwizardStrings.both = "both".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.both]
    
    inline def bottom: typingsJapgolly.smartwizard.smartwizardStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.bottom]
    
    inline def none: typingsJapgolly.smartwizard.smartwizardStrings.none = "none".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.none]
    
    inline def top: typingsJapgolly.smartwizard.smartwizardStrings.top = "top".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.top]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.smartwizard.smartwizardStrings.`slide-horizontal`
    - typingsJapgolly.smartwizard.smartwizardStrings.`slide-vertical`
    - typingsJapgolly.smartwizard.smartwizardStrings.`slide-swing`
  */
  trait TransitionAnimation extends StObject
  object TransitionAnimation {
    
    inline def fade: typingsJapgolly.smartwizard.smartwizardStrings.fade = "fade".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.fade]
    
    inline def none: typingsJapgolly.smartwizard.smartwizardStrings.none = "none".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.none]
    
    inline def `slide-horizontal`: typingsJapgolly.smartwizard.smartwizardStrings.`slide-horizontal` = "slide-horizontal".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.`slide-horizontal`]
    
    inline def `slide-swing`: typingsJapgolly.smartwizard.smartwizardStrings.`slide-swing` = "slide-swing".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.`slide-swing`]
    
    inline def `slide-vertical`: typingsJapgolly.smartwizard.smartwizardStrings.`slide-vertical` = "slide-vertical".asInstanceOf[typingsJapgolly.smartwizard.smartwizardStrings.`slide-vertical`]
  }
