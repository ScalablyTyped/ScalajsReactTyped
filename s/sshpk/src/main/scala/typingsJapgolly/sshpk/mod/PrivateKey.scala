...
import typingsJapgolly.sshpk.anon.keyinAlgorithmTypeKeyPart
import typingsJapgolly.sshpk.mod.Format.WriteOptions
import typingsJapgolly.sshpk.sshpkStrings.curve25519
import typingsJapgolly.sshpk.sshpkStrings.ecdsa_
import typingsJapgolly.sshpk.sshpkStrings.ed25519
...
object PrivateKey {
  ...
  inline def generate_ecdsa(`type`: ecdsa_, options: typingsJapgolly.sshpk.anon.Curve): PrivateKey = (^.asInstanceOf[js.Dynamic].applyDynamic("generate")(`type`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[PrivateKey]
