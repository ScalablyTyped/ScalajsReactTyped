...
import typingsJapgolly.sshpk.anon.ReadOptionsfilenamestring
import typingsJapgolly.sshpk.mod.Format.SshPrivateCipher
import typingsJapgolly.sshpk.sshpkStrings.`aes-128-cbc`
import typingsJapgolly.sshpk.sshpkStrings.`aes-256-cbc`
import typingsJapgolly.sshpk.sshpkStrings.`des-ede3-cbc`
...
inline def generatePrivateKey_ecdsa(`type`: ecdsa_, options: typingsJapgolly.sshpk.anon.Curve): PrivateKey = (^.asInstanceOf[js.Dynamic].applyDynamic("generatePrivateKey")(`type`.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[PrivateKey]
