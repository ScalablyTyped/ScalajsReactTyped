package typingsJapgolly.sshpk

import typingsJapgolly.sshpk.mod.CurveType
import typingsJapgolly.sshpk.mod.Format.OpenSshSignature
import typingsJapgolly.sshpk.mod.Format.SshPrivateCipher
import typingsJapgolly.sshpk.mod.Format.x509Signature
import typingsJapgolly.sshpk.mod.Format.x509SignatureExt
import typingsJapgolly.sshpk.mod.IdentityComponent
import typingsJapgolly.sshpk.mod.IdentityType
import typingsJapgolly.sshpk.mod.KeyPart
import typingsJapgolly.sshpk.mod.Signature
import typingsJapgolly.sshpk.mod.SignaturePart
...
object anon {
  ...
  trait Buffer extends StObject {
    ...
    var buffer: js.UndefOr[typingsJapgolly.node.bufferMod.global.Buffer] = js.undefined
  }
  object Buffer {
  ...
  trait Exts extends StObject {
    ...
    var issuerUniqueID: typingsJapgolly.node.bufferMod.global.Buffer
    
    var subjectUniqueID: typingsJapgolly.node.bufferMod.global.Buffer
  }
  object Exts {
    
    inline def apply(
      exts: js.Array[x509SignatureExt],
      issuerUniqueID: typingsJapgolly.node.bufferMod.global.Buffer,
      subjectUniqueID: typingsJapgolly.node.bufferMod.global.Buffer
    ): Exts = {
    ...
    extension [Self <: Exts](x: Self) {
      ...
      inline def setIssuerUniqueID(value: typingsJapgolly.node.bufferMod.global.Buffer): Self = StObject.set(x, "issuerUniqueID", value.asInstanceOf[js.Any])
      
      inline def setSubjectUniqueID(value: typingsJapgolly.node.bufferMod.global.Buffer): Self = StObject.set(x, "subjectUniqueID", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Passphrase extends StObject {
    ...
    var passphrase: String | typingsJapgolly.node.bufferMod.global.Buffer
  }
  object Passphrase {
    
    inline def apply(passphrase: String | typingsJapgolly.node.bufferMod.global.Buffer): Passphrase = {
    ...
    extension [Self <: Passphrase](x: Self) {
      ...
      inline def setPassphrase(value: String | typingsJapgolly.node.bufferMod.global.Buffer): Self = StObject.set(x, "passphrase", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait ReadOptionsfilenamestring extends StObject {
    ...
    var passphrase: js.UndefOr[String | typingsJapgolly.node.bufferMod.global.Buffer] = js.undefined
  }
