...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, 'interval'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, keyof semantic-ui-transition.SemanticUI.TransitionSettings._Impl>> */
trait PickImplintervalPartialPi
  extends StObject
     with Param {
...
object PickImplintervalPartialPi {
  ...
  extension [Self <: PickImplintervalPartialPi](x: Self) {
