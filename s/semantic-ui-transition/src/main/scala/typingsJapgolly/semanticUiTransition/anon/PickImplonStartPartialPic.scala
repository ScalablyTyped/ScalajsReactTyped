...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, 'onStart'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, keyof semantic-ui-transition.SemanticUI.TransitionSettings._Impl>> */
trait PickImplonStartPartialPic
  extends StObject
     with Param {
...
object PickImplonStartPartialPic {
  ...
  extension [Self <: PickImplonStartPartialPic](x: Self) {
