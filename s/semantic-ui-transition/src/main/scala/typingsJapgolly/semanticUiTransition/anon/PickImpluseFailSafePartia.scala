...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, 'useFailSafe'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.TransitionSettings._Impl, keyof semantic-ui-transition.SemanticUI.TransitionSettings._Impl>> */
trait PickImpluseFailSafePartia
  extends StObject
     with Param {
...
object PickImpluseFailSafePartia {
  ...
  extension [Self <: PickImpluseFailSafePartia](x: Self) {
