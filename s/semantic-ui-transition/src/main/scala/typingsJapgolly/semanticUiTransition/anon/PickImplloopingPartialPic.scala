...
/* Inlined std.Pick<semantic-ui-transition.SemanticUI.Transition.ClassNameSettings._Impl, 'looping'> & std.Partial<std.Pick<semantic-ui-transition.SemanticUI.Transition.ClassNameSettings._Impl, keyof semantic-ui-transition.SemanticUI.Transition.ClassNameSettings._Impl>> */
trait PickImplloopingPartialPic
  extends StObject
     with Param {
...
object PickImplloopingPartialPic {
  ...
  extension [Self <: PickImplloopingPartialPic](x: Self) {
