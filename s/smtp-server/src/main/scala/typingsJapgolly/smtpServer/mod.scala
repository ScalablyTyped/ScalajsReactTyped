...
import typingsJapgolly.smtpServer.smtpServerStrings.LOGIN
import typingsJapgolly.smtpServer.smtpServerStrings.PLAIN
import typingsJapgolly.smtpServer.smtpServerStrings.XOAUTH2
...
object mod {
  ...
  object SMTPServerOptions {
    ...
    extension [Self <: SMTPServerOptions](x: Self) {
      ...
      ): Self = StObject.set(x, "onAuth", js.Any.fromFunction3((t0: /* auth */ SMTPServerAuthentication, t1: /* session */ SMTPServerSession, t2: /* callback */ js.Function2[
              /* err */ js.UndefOr[js.Error | Null], 
              /* response */ js.UndefOr[SMTPServerAuthenticationResponse], 
              Unit
      ...
      inline def setOnClose(
        value: (/* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback
      ): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* session */ SMTPServerSession, t1: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => (value(t0, t1)).runNow()))
      
      inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
      
      inline def setOnConnect(
        value: (/* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback
      ): Self = StObject.set(x, "onConnect", js.Any.fromFunction2((t0: /* session */ SMTPServerSession, t1: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => (value(t0, t1)).runNow()))
      
      inline def setOnConnectUndefined: Self = StObject.set(x, "onConnect", js.undefined)
      
      inline def setOnData(
        value: (/* stream */ SMTPServerDataStream, /* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback
      ): Self = StObject.set(x, "onData", js.Any.fromFunction3((t0: /* stream */ SMTPServerDataStream, t1: /* session */ SMTPServerSession, t2: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnDataUndefined: Self = StObject.set(x, "onData", js.undefined)
      
      inline def setOnMailFrom(
        value: (/* address */ SMTPServerAddress, /* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback
      ): Self = StObject.set(x, "onMailFrom", js.Any.fromFunction3((t0: /* address */ SMTPServerAddress, t1: /* session */ SMTPServerSession, t2: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnMailFromUndefined: Self = StObject.set(x, "onMailFrom", js.undefined)
      
      inline def setOnRcptTo(
        value: (/* address */ SMTPServerAddress, /* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback
      ): Self = StObject.set(x, "onRcptTo", js.Any.fromFunction3((t0: /* address */ SMTPServerAddress, t1: /* session */ SMTPServerSession, t2: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => (value(t0, t1, t2)).runNow()))
