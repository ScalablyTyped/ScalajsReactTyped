...
object SMTPServerOptions {
  ...
  def apply(
    ...
    onClose: (/* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback = null,
    onConnect: (/* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback = null,
    onData: (/* stream */ SMTPServerDataStream, /* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback = null,
    onMailFrom: (/* address */ SMTPServerAddress, /* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback = null,
    onRcptTo: (/* address */ SMTPServerAddress, /* session */ SMTPServerSession, /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | Null], Unit]) => Callback = null,
  ...
  scala.Unit]) => SNICallback(t0, t1).runNow()))
    ...
    if (onAuth != null) __obj.updateDynamic("onAuth")(js.Any.fromFunction3((t0: /* auth */ typingsJapgolly.smtpServer.mod.SMTPServerAuthentication, t1: /* session */ typingsJapgolly.smtpServer.mod.SMTPServerSession, t2: /* callback */ js.Function2[
  /* err */ js.UndefOr[js.Error | scala.Null], 
  /* response */ js.UndefOr[typingsJapgolly.smtpServer.mod.SMTPServerAuthenticationResponse], 
  scala.Unit]) => onAuth(t0, t1, t2).runNow()))
    if (onClose != null) __obj.updateDynamic("onClose")(js.Any.fromFunction2((t0: /* session */ typingsJapgolly.smtpServer.mod.SMTPServerSession, t1: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | scala.Null], scala.Unit]) => onClose(t0, t1).runNow()))
    if (onConnect != null) __obj.updateDynamic("onConnect")(js.Any.fromFunction2((t0: /* session */ typingsJapgolly.smtpServer.mod.SMTPServerSession, t1: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | scala.Null], scala.Unit]) => onConnect(t0, t1).runNow()))
    if (onData != null) __obj.updateDynamic("onData")(js.Any.fromFunction3((t0: /* stream */ typingsJapgolly.smtpServer.mod.SMTPServerDataStream, t1: /* session */ typingsJapgolly.smtpServer.mod.SMTPServerSession, t2: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | scala.Null], scala.Unit]) => onData(t0, t1, t2).runNow()))
    if (onMailFrom != null) __obj.updateDynamic("onMailFrom")(js.Any.fromFunction3((t0: /* address */ typingsJapgolly.smtpServer.mod.SMTPServerAddress, t1: /* session */ typingsJapgolly.smtpServer.mod.SMTPServerSession, t2: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | scala.Null], scala.Unit]) => onMailFrom(t0, t1, t2).runNow()))
    if (onRcptTo != null) __obj.updateDynamic("onRcptTo")(js.Any.fromFunction3((t0: /* address */ typingsJapgolly.smtpServer.mod.SMTPServerAddress, t1: /* session */ typingsJapgolly.smtpServer.mod.SMTPServerSession, t2: /* callback */ js.Function1[/* err */ js.UndefOr[js.Error | scala.Null], scala.Unit]) => onRcptTo(t0, t1, t2).runNow()))
