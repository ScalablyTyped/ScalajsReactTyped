...
object EffectRecord {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typingsJapgolly.stellarSdk.stellarSdkStrings.BaseResponse with js.Any,
    ...
    operation: js.UndefOr[CallbackTo[js.Promise[OperationRecord]]] = js.undefined,
    precedes: js.UndefOr[CallbackTo[js.Promise[EffectRecord]]] = js.undefined,
    ...
    succeeds: js.UndefOr[CallbackTo[js.Promise[EffectRecord]]] = js.undefined,
    trustor: String = null,
    ...
    operation.foreach(p => __obj.updateDynamic("operation")(p.toJsFn))
    precedes.foreach(p => __obj.updateDynamic("precedes")(p.toJsFn))
    ...
    succeeds.foreach(p => __obj.updateDynamic("succeeds")(p.toJsFn))
