...
import typingsJapgolly.stellarSdk.horizonApiMod.Horizon.TransactionFailedExtras
import typingsJapgolly.stellarSdk.stellarSdkNumbers.`400`
import typingsJapgolly.stellarSdk.stellarSdkStrings.`Transaction Failed`
