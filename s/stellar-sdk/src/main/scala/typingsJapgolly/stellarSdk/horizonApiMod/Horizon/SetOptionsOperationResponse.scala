...
import typingsJapgolly.stellarSdk.horizonApiMod.Horizon.OperationResponseType.setOptions
import typingsJapgolly.stellarSdk.stellarSdkNumbers.`1`
import typingsJapgolly.stellarSdk.stellarSdkNumbers.`2`
import typingsJapgolly.stellarSdk.stellarSdkStrings.auth_required_flag
import typingsJapgolly.stellarSdk.stellarSdkStrings.auth_revocable_flag
...
trait SetOptionsOperationResponse
  extends BaseOperationResponse[
      setOptions, 
      typingsJapgolly.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.setOptions
    ] {
...
object SetOptionsOperationResponse {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typingsJapgolly.stellarSdk.stellarSdkStrings.BaseResponse with js.Any,
    ...
    `type`: setOptions,
    type_i: typingsJapgolly.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.setOptions,
