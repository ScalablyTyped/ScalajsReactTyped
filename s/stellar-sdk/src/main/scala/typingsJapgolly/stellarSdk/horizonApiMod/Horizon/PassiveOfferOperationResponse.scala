...
import typingsJapgolly.stellarSdk.horizonApiMod.Horizon.OperationResponseType.createPassiveOffer
...
trait PassiveOfferOperationResponse
  extends BaseOperationResponse[
      createPassiveOffer, 
      typingsJapgolly.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.createPassiveOffer
    ] {
  var amount: String
...
object PassiveOfferOperationResponse {
  ...
  {[ key in T | 'self' ]: stellar-sdk.stellar-sdk/lib/horizon_api.Horizon.ResponseLink}
    */ typingsJapgolly.stellarSdk.stellarSdkStrings.BaseResponse with js.Any,
    ...
    type_i: typingsJapgolly.stellarSdk.horizonApiMod.Horizon.OperationResponseTypeI.createPassiveOffer,
