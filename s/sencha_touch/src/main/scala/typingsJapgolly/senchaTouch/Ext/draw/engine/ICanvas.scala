...
object ICanvas {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[ICanvas]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ICanvas] = null,
    ...
    initElement: js.UndefOr[Callback] = js.undefined,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ICanvas] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ICanvas], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    uses: Array = null,
    waitFor: /* surface */ js.UndefOr[ICanvas] => Callback = null,
    width: js.Any = null,
    xtype: String = null,
    ...
    initElement.foreach(p => __obj.updateDynamic("initElement")(p.toJsFn))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.engine.ICanvas], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
    ...
    if (waitFor != null) __obj.updateDynamic("waitFor")(js.Any.fromFunction1((t0: /* surface */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.engine.ICanvas]) => waitFor(t0).runNow()))
