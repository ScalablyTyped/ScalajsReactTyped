...
object IFieldSet {
  ...
  extension [Self <: IFieldSet](x: Self) {
    ...
    inline def setSetInstructions(value: /* instructions */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setInstructions", js.Any.fromFunction1((t0: /* instructions */ js.UndefOr[String]) => value(t0).runNow()))
