...
object IView {
  ...
  def apply(
    ...
    getIndicators: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getIndicatorsHidingDelay: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getIndicatorsUi: js.UndefOr[CallbackTo[String]] = js.undefined,
    getInitialConfig: /* name */ js.UndefOr[String] => CallbackTo[js.Any] = null,
    getListeners: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getScroller: js.UndefOr[CallbackTo[IView]] = js.undefined,
    ...
    setIndicators: /* indicators */ js.UndefOr[js.Any] => Callback = null,
    setIndicatorsHidingDelay: /* indicatorsHidingDelay */ js.UndefOr[Double] => Callback = null,
    setIndicatorsUi: /* indicatorsUi */ js.UndefOr[String] => Callback = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => Callback = null,
    setScroller: /* scroller */ js.UndefOr[js.Any] => Callback = null,
    ...
    getIndicators.foreach(p => __obj.updateDynamic("getIndicators")(p.toJsFn))
    getIndicatorsHidingDelay.foreach(p => __obj.updateDynamic("getIndicatorsHidingDelay")(p.toJsFn))
    getIndicatorsUi.foreach(p => __obj.updateDynamic("getIndicatorsUi")(p.toJsFn))
    if (getInitialConfig != null) __obj.updateDynamic("getInitialConfig")(js.Any.fromFunction1((t0: /* name */ js.UndefOr[java.lang.String]) => getInitialConfig(t0).runNow()))
    getListeners.foreach(p => __obj.updateDynamic("getListeners")(p.toJsFn))
    getScroller.foreach(p => __obj.updateDynamic("getScroller")(p.toJsFn))
    ...
    if (setIndicators != null) __obj.updateDynamic("setIndicators")(js.Any.fromFunction1((t0: /* indicators */ js.UndefOr[js.Any]) => setIndicators(t0).runNow()))
    if (setIndicatorsHidingDelay != null) __obj.updateDynamic("setIndicatorsHidingDelay")(js.Any.fromFunction1((t0: /* indicatorsHidingDelay */ js.UndefOr[scala.Double]) => setIndicatorsHidingDelay(t0).runNow()))
    if (setIndicatorsUi != null) __obj.updateDynamic("setIndicatorsUi")(js.Any.fromFunction1((t0: /* indicatorsUi */ js.UndefOr[java.lang.String]) => setIndicatorsUi(t0).runNow()))
    ...
    if (setScroller != null) __obj.updateDynamic("setScroller")(js.Any.fromFunction1((t0: /* scroller */ js.UndefOr[js.Any]) => setScroller(t0).runNow()))
