  ...
  object card {
    ...
    object IAbstract {
      ...
      extension [Self <: IAbstract](x: Self) {
        ...
        inline def setSetDuration(value: /* duration */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setDuration", js.Any.fromFunction1((t0: /* duration */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    object IStyle {
      ...
      extension [Self <: IStyle](x: Self) {
        ...
        inline def setGetInAnimation(value: CallbackTo[Any]): Self = StObject.set(x, "getInAnimation", value.toJsFn)
        
        inline def setGetInAnimationUndefined: Self = StObject.set(x, "getInAnimation", js.undefined)
        
        inline def setGetOutAnimation(value: CallbackTo[Any]): Self = StObject.set(x, "getOutAnimation", value.toJsFn)
        
        inline def setGetOutAnimationUndefined: Self = StObject.set(x, "getOutAnimation", js.undefined)
        
        inline def setSetInAnimation(value: /* inAnimation */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setInAnimation", js.Any.fromFunction1((t0: /* inAnimation */ js.UndefOr[Any]) => value(t0).runNow()))
        
        inline def setSetInAnimationUndefined: Self = StObject.set(x, "setInAnimation", js.undefined)
        
        inline def setSetOutAnimation(value: /* outAnimation */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setOutAnimation", js.Any.fromFunction1((t0: /* outAnimation */ js.UndefOr[Any]) => value(t0).runNow()))
