...
object IWebStorage {
  ...
  def apply(
    ...
    if (setRecord != null) __obj.updateDynamic("setRecord")(js.Any.fromFunction2((t0: /* record */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.data.IModel], t1: /* id */ js.UndefOr[java.lang.String]) => setRecord(t0, t1).runNow()))
