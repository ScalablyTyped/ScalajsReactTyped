package typingsJapgolly.senchaTouch.Ext.device.device
...
object IAbstract {
  ...
  def apply(
    ...
    openURL: /* url */ js.UndefOr[String] => Callback = null,
    ...
    if (openURL != null) __obj.updateDynamic("openURL")(js.Any.fromFunction1((t0: /* url */ js.UndefOr[java.lang.String]) => openURL(t0).runNow()))
