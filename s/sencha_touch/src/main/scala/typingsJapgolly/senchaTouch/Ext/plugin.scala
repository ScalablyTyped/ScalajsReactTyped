...
object plugin {
  ...
  object IBufferedList {
    ...
    extension [Self <: IBufferedList](x: Self) {
      ...
      inline def setGetList(value: CallbackTo[Any]): Self = StObject.set(x, "getList", value.toJsFn)
      
      inline def setGetListUndefined: Self = StObject.set(x, "getList", js.undefined)
      
      inline def setSetList(value: /* list */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setList", js.Any.fromFunction1((t0: /* list */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object IListPaging {
    ...
    extension [Self <: IListPaging](x: Self) {
      ...
      inline def setGetAutoPaging(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAutoPaging", value.toJsFn)
      
      inline def setGetAutoPagingUndefined: Self = StObject.set(x, "getAutoPaging", js.undefined)
      
      inline def setGetLoadMoreText(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getLoadMoreText", value.toJsFn)
      
      inline def setGetLoadMoreTextUndefined: Self = StObject.set(x, "getLoadMoreText", js.undefined)
      
      inline def setGetNoMoreRecordsText(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getNoMoreRecordsText", value.toJsFn)
      ...
      inline def setSetAutoPaging(value: /* autoPaging */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAutoPaging", js.Any.fromFunction1((t0: /* autoPaging */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setSetAutoPagingUndefined: Self = StObject.set(x, "setAutoPaging", js.undefined)
      
      inline def setSetLoadMoreText(value: /* loadMoreText */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setLoadMoreText", js.Any.fromFunction1((t0: /* loadMoreText */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetLoadMoreTextUndefined: Self = StObject.set(x, "setLoadMoreText", js.undefined)
      
      inline def setSetNoMoreRecordsText(value: /* noMoreRecordsText */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setNoMoreRecordsText", js.Any.fromFunction1((t0: /* noMoreRecordsText */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
  ...
  trait IPullRefresh
    ...
    /** [Method] Returns the value of list
      ...
      */
    var getList: js.UndefOr[js.Function0[typingsJapgolly.senchaTouch.Ext.dataview.IList]] = js.undefined
    ...
    var list: js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.IList] = js.undefined
    ...
    var setList: js.UndefOr[
        js.Function1[/* list */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.IList], Unit]
      ] = js.undefined
  ...
  object IPullRefresh {
    ...
    extension [Self <: IPullRefresh](x: Self) {
      ...
      inline def setGetAutoSnapBack(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAutoSnapBack", value.toJsFn)
      
      inline def setGetAutoSnapBackUndefined: Self = StObject.set(x, "getAutoSnapBack", js.undefined)
      
      inline def setGetLastUpdatedDateFormat(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getLastUpdatedDateFormat", value.toJsFn)
      
      inline def setGetLastUpdatedDateFormatUndefined: Self = StObject.set(x, "getLastUpdatedDateFormat", js.undefined)
      
      inline def setGetLastUpdatedText(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getLastUpdatedText", value.toJsFn)
      
      inline def setGetLastUpdatedTextUndefined: Self = StObject.set(x, "getLastUpdatedText", js.undefined)
      
      inline def setGetList(value: CallbackTo[typingsJapgolly.senchaTouch.Ext.dataview.IList]): Self = StObject.set(x, "getList", value.toJsFn)
      
      inline def setGetListUndefined: Self = StObject.set(x, "getList", js.undefined)
      
      inline def setGetLoadedText(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getLoadedText", value.toJsFn)
      ...
      inline def setGetOverpullSnapBackDuration(value: CallbackTo[Double]): Self = StObject.set(x, "getOverpullSnapBackDuration", value.toJsFn)
      
      inline def setGetOverpullSnapBackDurationUndefined: Self = StObject.set(x, "getOverpullSnapBackDuration", js.undefined)
      
      inline def setGetPullText(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getPullText", value.toJsFn)
      
      inline def setGetPullTextUndefined: Self = StObject.set(x, "getPullText", js.undefined)
      
      inline def setGetPullTpl(value: CallbackTo[Any]): Self = StObject.set(x, "getPullTpl", value.toJsFn)
      
      inline def setGetPullTplUndefined: Self = StObject.set(x, "getPullTpl", js.undefined)
      
      inline def setGetReleaseText(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getReleaseText", value.toJsFn)
      
      inline def setGetReleaseTextUndefined: Self = StObject.set(x, "getReleaseText", js.undefined)
      
      inline def setGetScrollerAutoRefresh(value: CallbackTo[Boolean]): Self = StObject.set(x, "getScrollerAutoRefresh", value.toJsFn)
      
      inline def setGetScrollerAutoRefreshUndefined: Self = StObject.set(x, "getScrollerAutoRefresh", js.undefined)
      
      inline def setGetSnappingAnimationDuration(value: CallbackTo[Double]): Self = StObject.set(x, "getSnappingAnimationDuration", value.toJsFn)
      ...
      inline def setList(value: typingsJapgolly.senchaTouch.Ext.dataview.IList): Self = StObject.set(x, "list", value.asInstanceOf[js.Any])
      ...
      inline def setSetAutoSnapBack(value: /* autoSnapBack */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAutoSnapBack", js.Any.fromFunction1((t0: /* autoSnapBack */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setSetAutoSnapBackUndefined: Self = StObject.set(x, "setAutoSnapBack", js.undefined)
      
      inline def setSetLastUpdatedDateFormat(value: /* lastUpdatedDateFormat */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setLastUpdatedDateFormat", js.Any.fromFunction1((t0: /* lastUpdatedDateFormat */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetLastUpdatedDateFormatUndefined: Self = StObject.set(x, "setLastUpdatedDateFormat", js.undefined)
      
      inline def setSetLastUpdatedText(value: /* lastUpdatedText */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setLastUpdatedText", js.Any.fromFunction1((t0: /* lastUpdatedText */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetLastUpdatedTextUndefined: Self = StObject.set(x, "setLastUpdatedText", js.undefined)
      
      inline def setSetList(value: /* list */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.IList] => Callback): Self = StObject.set(x, "setList", js.Any.fromFunction1((t0: /* list */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.IList]) => value(t0).runNow()))
      
      inline def setSetListUndefined: Self = StObject.set(x, "setList", js.undefined)
      
      inline def setSetLoadedText(value: /* loadedText */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setLoadedText", js.Any.fromFunction1((t0: /* loadedText */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      ...
      inline def setSetOverpullSnapBackDuration(value: /* overpullSnapBackDuration */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setOverpullSnapBackDuration", js.Any.fromFunction1((t0: /* overpullSnapBackDuration */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setSetOverpullSnapBackDurationUndefined: Self = StObject.set(x, "setOverpullSnapBackDuration", js.undefined)
      
      inline def setSetPullRefreshText(value: /* text */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setPullRefreshText", js.Any.fromFunction1((t0: /* text */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetPullRefreshTextUndefined: Self = StObject.set(x, "setPullRefreshText", js.undefined)
      
      inline def setSetPullText(value: /* pullText */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setPullText", js.Any.fromFunction1((t0: /* pullText */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetPullTextUndefined: Self = StObject.set(x, "setPullText", js.undefined)
      
      inline def setSetPullTpl(value: /* pullTpl */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setPullTpl", js.Any.fromFunction1((t0: /* pullTpl */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetPullTplUndefined: Self = StObject.set(x, "setPullTpl", js.undefined)
      
      inline def setSetReleaseRefreshText(value: /* text */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setReleaseRefreshText", js.Any.fromFunction1((t0: /* text */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetReleaseRefreshTextUndefined: Self = StObject.set(x, "setReleaseRefreshText", js.undefined)
      
      inline def setSetReleaseText(value: /* releaseText */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setReleaseText", js.Any.fromFunction1((t0: /* releaseText */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetReleaseTextUndefined: Self = StObject.set(x, "setReleaseText", js.undefined)
      
      inline def setSetScrollerAutoRefresh(value: /* scrollerAutoRefresh */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setScrollerAutoRefresh", js.Any.fromFunction1((t0: /* scrollerAutoRefresh */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setSetScrollerAutoRefreshUndefined: Self = StObject.set(x, "setScrollerAutoRefresh", js.undefined)
      
      inline def setSetSnappingAnimationDuration(value: /* snappingAnimationDuration */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setSnappingAnimationDuration", js.Any.fromFunction1((t0: /* snappingAnimationDuration */ js.UndefOr[Double]) => value(t0).runNow()))
      ...
      inline def setSnapBack(value: /* force */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "snapBack", js.Any.fromFunction1((t0: /* force */ js.UndefOr[Boolean]) => value(t0).runNow()))
  ...
  object ISortableList {
    ...
    extension [Self <: ISortableList](x: Self) {
      ...
      inline def setGetHandleSelector(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getHandleSelector", value.toJsFn)
      ...
      inline def setSetHandleSelector(value: /* handleSelector */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setHandleSelector", js.Any.fromFunction1((t0: /* handleSelector */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
