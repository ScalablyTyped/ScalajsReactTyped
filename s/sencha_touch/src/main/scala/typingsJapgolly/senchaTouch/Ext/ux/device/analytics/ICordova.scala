...
object ICordova {
  ...
  def apply(
    ...
    trackPageview: /* page */ js.UndefOr[js.Any] => Callback = null,
    uses: Array = null
  ): ICordova = {
    ...
    if (trackPageview != null) __obj.updateDynamic("trackPageview")(js.Any.fromFunction1((t0: /* page */ js.UndefOr[js.Any]) => trackPageview(t0).runNow()))
