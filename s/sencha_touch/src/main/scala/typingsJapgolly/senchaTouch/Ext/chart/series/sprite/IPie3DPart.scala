...
object IPie3DPart {
  ...
  def apply(
    ...
    hide: js.UndefOr[CallbackTo[IPie3DPart]] = js.undefined,
    ...
    show: js.UndefOr[CallbackTo[IPie3DPart]] = js.undefined,
    ...
    updatePath: /* path */ js.UndefOr[js.Any] => Callback = null,
    ...
    if (updatePath != null) __obj.updateDynamic("updatePath")(js.Any.fromFunction1((t0: /* path */ js.UndefOr[js.Any]) => updatePath(t0).runNow()))
