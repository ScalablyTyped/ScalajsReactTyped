package typingsJapgolly.senchaTouch.Ext.device.media
...
object IAbstract {
  ...
  def apply(
    ...
    getSrc: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    setSrc: /* src */ js.UndefOr[js.Any] => Callback = null,
    ...
    if (setSrc != null) __obj.updateDynamic("setSrc")(js.Any.fromFunction1((t0: /* src */ js.UndefOr[js.Any]) => setSrc(t0).runNow()))
