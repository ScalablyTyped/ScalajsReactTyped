...
object modifier {
  ...
  - typingsJapgolly.senchaTouch.Ext.mixin.IObservable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined bubbleEvents, listeners, addAfterListener, addBeforeListener, addEvents, addListener, addManagedListener, clearListeners, enableBubble, fireAction, fireEvent, getBubbleEvents, getId, getListeners, hasListener, mon, mun, on, onAfter, onBefore, relayEvents, removeAfterListener, removeBeforeListener, removeListener, removeManagedListener, resumeEvents, setBubbleEvents, setListeners, suspendEvents, un, unAfter, unBefore */ trait IAnimation
    ...
    var addManagedListener: js.UndefOr[
        js.Function5[js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], Unit]
      ] = js.undefined
    ...
    /** [Method] Remove special easings on the given attributes
      ...
      */
    var clearDurationOn: js.UndefOr[js.Function1[/* attrs */ js.UndefOr[Any], Unit]] = js.undefined
    
    /** [Method] Remove special easings on the given attributes
      * @param attrs String/Array The source attribute(s).
      */
    var clearEasingOn: js.UndefOr[js.Function1[/* attrs */ js.UndefOr[Any], Unit]] = js.undefined
    
    /** [Method] Removes all listeners for this object  */
    var clearListeners: js.UndefOr[js.Function0[Unit]] = js.undefined
    
    /** [Config Option] (Object) */
    var customDuration: js.UndefOr[Any] = js.undefined
    
    /** [Config Option] (Object) */
    var customEasings: js.UndefOr[Any] = js.undefined
    ...
    var fireAction: js.UndefOr[
        js.Function4[js.UndefOr[String], js.UndefOr[Array], js.UndefOr[Any], js.UndefOr[Any], Any]
      ] = js.undefined
    ...
    /** [Method] Returns the value of customDuration
      * @returns Object
      */
    var getCustomDuration: js.UndefOr[js.Function0[Any]] = js.undefined
    
    /** [Method] Returns the value of customEasings
      * @returns Object
      */
    var getCustomEasings: js.UndefOr[js.Function0[Any]] = js.undefined
    ...
    /** [Method] Relays selected events from the specified Observable as if the events were fired by this
      ...
      */
    var relayEvents: js.UndefOr[js.Function2[js.UndefOr[Any], js.UndefOr[Any], this.type | IObservable]] = js.undefined
    ...
    /** [Method] Sets the value of bubbleEvents
      ...
      */
    var setBubbleEvents: js.UndefOr[js.Function1[js.UndefOr[Any], Unit]] = js.undefined
    
    /** [Method] Sets the value of customDuration
      * @param customDuration Object The new value.
      */
    var setCustomDuration: js.UndefOr[js.Function1[/* customDuration */ js.UndefOr[Any], Unit]] = js.undefined
    
    /** [Method] Sets the value of customEasings
      * @param customEasings Object The new value.
      */
    var setCustomEasings: js.UndefOr[js.Function1[/* customEasings */ js.UndefOr[Any], Unit]] = js.undefined
    ...
    var setDurationOn: js.UndefOr[
        js.Function2[/* attrs */ js.UndefOr[Any], /* duration */ js.UndefOr[Double], Unit]
      ] = js.undefined
    ...
    /** [Method] Set special easings on the given attributes
      ...
      */
    var setEasingOn: js.UndefOr[js.Function2[/* attrs */ js.UndefOr[Any], /* easing */ js.UndefOr[String], Unit]] = js.undefined
    
    /** [Method] Sets the value of listeners
      * @param listeners Object The new value.
      */
    var setListeners: js.UndefOr[js.Function1[js.UndefOr[Any], Unit]] = js.undefined
  ...
  object IAnimation {
    ...
    extension [Self <: IAnimation](x: Self) {
      ...
      inline def setAddAfterListener(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "addAfterListener", js.Any.fromFunction4((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setAddAfterListenerUndefined: Self = StObject.set(x, "addAfterListener", js.undefined)
      
      inline def setAddBeforeListener(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "addBeforeListener", js.Any.fromFunction4((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setAddListener(
        value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[String]) => Callback
      ): Self = StObject.set(x, "addListener", js.Any.fromFunction5((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any], t4: js.UndefOr[String]) => (value(t0, t1, t2, t3, t4)).runNow()))
      
      inline def setAddListenerUndefined: Self = StObject.set(x, "addListener", js.undefined)
      
      inline def setAddManagedListener(
        value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "addManagedListener", js.Any.fromFunction5((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any], t4: js.UndefOr[Any]) => (value(t0, t1, t2, t3, t4)).runNow()))
      ...
      inline def setClearDurationOn(value: /* attrs */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "clearDurationOn", js.Any.fromFunction1((t0: /* attrs */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setClearDurationOnUndefined: Self = StObject.set(x, "clearDurationOn", js.undefined)
      
      inline def setClearEasingOn(value: /* attrs */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "clearEasingOn", js.Any.fromFunction1((t0: /* attrs */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setCustomDuration(value: Any): Self = StObject.set(x, "customDuration", value.asInstanceOf[js.Any])
      
      inline def setCustomDurationUndefined: Self = StObject.set(x, "customDuration", js.undefined)
      
      inline def setCustomEasings(value: Any): Self = StObject.set(x, "customEasings", value.asInstanceOf[js.Any])
      ...
      inline def setFireAction(value: (js.UndefOr[String], js.UndefOr[Array], js.UndefOr[Any], js.UndefOr[Any]) => Any): Self = StObject.set(x, "fireAction", js.Any.fromFunction4(value))
      ...
      inline def setGetBubbleEvents(value: CallbackTo[Any]): Self = StObject.set(x, "getBubbleEvents", value.toJsFn)
      
      inline def setGetBubbleEventsUndefined: Self = StObject.set(x, "getBubbleEvents", js.undefined)
      
      inline def setGetCustomDuration(value: CallbackTo[Any]): Self = StObject.set(x, "getCustomDuration", value.toJsFn)
      
      inline def setGetCustomDurationUndefined: Self = StObject.set(x, "getCustomDuration", js.undefined)
      
      inline def setGetCustomEasings(value: CallbackTo[Any]): Self = StObject.set(x, "getCustomEasings", value.toJsFn)
      ...
      inline def setGetListeners(value: CallbackTo[Any]): Self = StObject.set(x, "getListeners", value.toJsFn)
      ...
      inline def setMon(
        value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback
      ): Self = StObject.set(x, "mon", js.Any.fromFunction5((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any], t4: js.UndefOr[Any]) => (value(t0, t1, t2, t3, t4)).runNow()))
      ...
      inline def setOn(
        value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[String]) => Callback
      ): Self = StObject.set(x, "on", js.Any.fromFunction5((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any], t4: js.UndefOr[String]) => (value(t0, t1, t2, t3, t4)).runNow()))
      
      inline def setOnAfter(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "onAfter", js.Any.fromFunction4((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setOnAfterUndefined: Self = StObject.set(x, "onAfter", js.undefined)
      
      inline def setOnBefore(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "onBefore", js.Any.fromFunction4((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setOnBeforeUndefined: Self = StObject.set(x, "onBefore", js.undefined)
      
      inline def setOnUndefined: Self = StObject.set(x, "on", js.undefined)
      
      inline def setRelayEvents(value: (js.UndefOr[Any], js.UndefOr[Any]) => IAnimation | IObservable): Self = StObject.set(x, "relayEvents", js.Any.fromFunction2(value))
      
      inline def setRelayEventsUndefined: Self = StObject.set(x, "relayEvents", js.undefined)
      
      inline def setRemoveAfterListener(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "removeAfterListener", js.Any.fromFunction4((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setRemoveAfterListenerUndefined: Self = StObject.set(x, "removeAfterListener", js.undefined)
      
      inline def setRemoveBeforeListener(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "removeBeforeListener", js.Any.fromFunction4((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      ...
      inline def setRemoveListener(
        value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[String]) => Callback
      ): Self = StObject.set(x, "removeListener", js.Any.fromFunction5((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any], t4: js.UndefOr[String]) => (value(t0, t1, t2, t3, t4)).runNow()))
      ...
      inline def setResumeEvents(value: js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "resumeEvents", js.Any.fromFunction1((t0: js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setResumeEventsUndefined: Self = StObject.set(x, "resumeEvents", js.undefined)
      
      inline def setSetBubbleEvents(value: js.UndefOr[Any] => Callback): Self = StObject.set(x, "setBubbleEvents", js.Any.fromFunction1((t0: js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetBubbleEventsUndefined: Self = StObject.set(x, "setBubbleEvents", js.undefined)
      
      inline def setSetCustomDuration(value: /* customDuration */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setCustomDuration", js.Any.fromFunction1((t0: /* customDuration */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetCustomDurationUndefined: Self = StObject.set(x, "setCustomDuration", js.undefined)
      
      inline def setSetCustomEasings(value: /* customEasings */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setCustomEasings", js.Any.fromFunction1((t0: /* customEasings */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setSetDurationOn(value: (/* attrs */ js.UndefOr[Any], /* duration */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "setDurationOn", js.Any.fromFunction2((t0: /* attrs */ js.UndefOr[Any], t1: /* duration */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
      ...
      inline def setSetEasingOn(value: (/* attrs */ js.UndefOr[Any], /* easing */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "setEasingOn", js.Any.fromFunction2((t0: /* attrs */ js.UndefOr[Any], t1: /* easing */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
      ...
      inline def setSetListeners(value: js.UndefOr[Any] => Callback): Self = StObject.set(x, "setListeners", js.Any.fromFunction1((t0: js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setSuspendEvents(value: Callback): Self = StObject.set(x, "suspendEvents", value.toJsFn)
      
      inline def setSuspendEventsUndefined: Self = StObject.set(x, "suspendEvents", js.undefined)
      
      inline def setUn(
        value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[String]) => Callback
      ): Self = StObject.set(x, "un", js.Any.fromFunction5((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any], t4: js.UndefOr[String]) => (value(t0, t1, t2, t3, t4)).runNow()))
      
      inline def setUnAfter(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "unAfter", js.Any.fromFunction4((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setUnAfterUndefined: Self = StObject.set(x, "unAfter", js.undefined)
      
      inline def setUnBefore(value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback): Self = StObject.set(x, "unBefore", js.Any.fromFunction4((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
  ...
  trait IHighlight
    ...
    /** [Method] Filter modifier changes if overriding source attributes
      ...
      */
    var filterChanges: js.UndefOr[js.Function2[/* attr */ js.UndefOr[Any], /* changes */ js.UndefOr[Any], Any]] = js.undefined
    ...
    /** [Method] Returns the value of highlightStyle
      * @returns Object
      */
    var getHighlightStyle: js.UndefOr[js.Function0[Any]] = js.undefined
    
    /** [Config Option] (Object) */
    var highlightStyle: js.UndefOr[Any] = js.undefined
    ...
    /** [Method] Sets the value of highlightStyle
      ...
      */
    var setHighlightStyle: js.UndefOr[js.Function1[/* highlightStyle */ js.UndefOr[Any], Unit]] = js.undefined
  }
  object IHighlight {
    ...
    extension [Self <: IHighlight](x: Self) {
      ...
      inline def setFilterChanges(value: (/* attr */ js.UndefOr[Any], /* changes */ js.UndefOr[Any]) => Any): Self = StObject.set(x, "filterChanges", js.Any.fromFunction2(value))
      ...
      inline def setGetHighlightStyle(value: CallbackTo[Any]): Self = StObject.set(x, "getHighlightStyle", value.toJsFn)
      
      inline def setGetHighlightStyleUndefined: Self = StObject.set(x, "getHighlightStyle", js.undefined)
      
      inline def setHighlightStyle(value: Any): Self = StObject.set(x, "highlightStyle", value.asInstanceOf[js.Any])
      ...
      inline def setSetHighlightStyle(value: /* highlightStyle */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setHighlightStyle", js.Any.fromFunction1((t0: /* highlightStyle */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  trait IModifier
    ...
    var popUp: js.UndefOr[
        js.Function2[/* attributes */ js.UndefOr[Any], /* changes */ js.UndefOr[Any], Unit]
      ] = js.undefined
    ...
    /** [Method] Validate attribute set before use
      ...
      */
    var prepareAttributes: js.UndefOr[js.Function1[/* attr */ js.UndefOr[Any], Unit]] = js.undefined
    ...
    /** [Method] Invoked when changes need to be pushed down to the sprite
      ...
      * @returns Mixed
      */
    var pushDown: js.UndefOr[js.Function2[/* attr */ js.UndefOr[Any], /* changes */ js.UndefOr[Any], Any]] = js.undefined
  ...
  object IModifier {
    ...
    extension [Self <: IModifier](x: Self) {
      ...
      inline def setGetNext(value: CallbackTo[IModifier]): Self = StObject.set(x, "getNext", value.toJsFn)
      
      inline def setGetNextUndefined: Self = StObject.set(x, "getNext", js.undefined)
      
      inline def setGetPrevious(value: CallbackTo[IModifier]): Self = StObject.set(x, "getPrevious", value.toJsFn)
      
      inline def setGetPreviousUndefined: Self = StObject.set(x, "getPrevious", js.undefined)
      
      inline def setGetSprite(value: CallbackTo[ISprite]): Self = StObject.set(x, "getSprite", value.toJsFn)
      ...
      inline def setPopUp(value: (/* attributes */ js.UndefOr[Any], /* changes */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "popUp", js.Any.fromFunction2((t0: /* attributes */ js.UndefOr[Any], t1: /* changes */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
      
      inline def setPopUpUndefined: Self = StObject.set(x, "popUp", js.undefined)
      
      inline def setPrepareAttributes(value: /* attr */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "prepareAttributes", js.Any.fromFunction1((t0: /* attr */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setPushDown(value: (/* attr */ js.UndefOr[Any], /* changes */ js.UndefOr[Any]) => Any): Self = StObject.set(x, "pushDown", js.Any.fromFunction2(value))
      
      inline def setPushDownUndefined: Self = StObject.set(x, "pushDown", js.undefined)
      
      inline def setSetNext(value: /* next */ js.UndefOr[IModifier] => Callback): Self = StObject.set(x, "setNext", js.Any.fromFunction1((t0: /* next */ js.UndefOr[IModifier]) => value(t0).runNow()))
      
      inline def setSetNextUndefined: Self = StObject.set(x, "setNext", js.undefined)
      
      inline def setSetPrevious(value: /* previous */ js.UndefOr[IModifier] => Callback): Self = StObject.set(x, "setPrevious", js.Any.fromFunction1((t0: /* previous */ js.UndefOr[IModifier]) => value(t0).runNow()))
      
      inline def setSetPreviousUndefined: Self = StObject.set(x, "setPrevious", js.undefined)
      
      inline def setSetSprite(value: /* sprite */ js.UndefOr[ISprite] => Callback): Self = StObject.set(x, "setSprite", js.Any.fromFunction1((t0: /* sprite */ js.UndefOr[ISprite]) => value(t0).runNow()))
