...
object IImg {
  ...
  def apply(
    ...
    getBackgroundCls: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    ...
    getImageCls: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    ...
    getMode: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    getPadding: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getParent: js.UndefOr[CallbackTo[IImg]] = js.undefined,
    ...
    getSrc: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    ...
    scroll: js.Any = null,
    self: IClass = null,
    setBackgroundCls: /* backgroundCls */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    setImageCls: /* imageCls */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    setMode: /* mode */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    setSrc: /* src */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    showBy: (/* component */ js.UndefOr[IImg], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    getBackgroundCls.foreach(p => __obj.updateDynamic("getBackgroundCls")(p.toJsFn))
    ...
    getImageCls.foreach(p => __obj.updateDynamic("getImageCls")(p.toJsFn))
    ...
    getSrc.foreach(p => __obj.updateDynamic("getSrc")(p.toJsFn))
    ...
    if (setBackgroundCls != null) __obj.updateDynamic("setBackgroundCls")(js.Any.fromFunction1((t0: /* backgroundCls */ js.UndefOr[java.lang.String]) => setBackgroundCls(t0).runNow()))
    ...
    if (setImageCls != null) __obj.updateDynamic("setImageCls")(js.Any.fromFunction1((t0: /* imageCls */ js.UndefOr[java.lang.String]) => setImageCls(t0).runNow()))
    ...
    if (setSrc != null) __obj.updateDynamic("setSrc")(js.Any.fromFunction1((t0: /* src */ js.UndefOr[java.lang.String]) => setSrc(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IImg], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
