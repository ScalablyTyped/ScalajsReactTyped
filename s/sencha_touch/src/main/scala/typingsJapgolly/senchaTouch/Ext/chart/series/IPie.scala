...
object IPie {
  ...
  extension [Self <: IPie](x: Self) {
    ...
    inline def setGetLabelField(value: CallbackTo[String]): Self = StObject.set(x, "getLabelField", value.toJsFn)
    
    inline def setGetLabelFieldUndefined: Self = StObject.set(x, "getLabelField", js.undefined)
    
    inline def setGetTotalAngle(value: CallbackTo[Double]): Self = StObject.set(x, "getTotalAngle", value.toJsFn)
    ...
    inline def setSetLabelField(value: /* labelField */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setLabelField", js.Any.fromFunction1((t0: /* labelField */ js.UndefOr[String]) => value(t0).runNow()))
    
    inline def setSetLabelFieldUndefined: Self = StObject.set(x, "setLabelField", js.undefined)
    
    inline def setSetTotalAngle(value: /* totalAngle */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setTotalAngle", js.Any.fromFunction1((t0: /* totalAngle */ js.UndefOr[Double]) => value(t0).runNow()))
