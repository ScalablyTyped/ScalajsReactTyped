...
object IAudio {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IAudio]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IAudio] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IAudio] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IAudio], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IAudio], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
