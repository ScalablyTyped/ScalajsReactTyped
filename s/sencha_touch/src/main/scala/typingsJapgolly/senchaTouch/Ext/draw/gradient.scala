...
object gradient {
  ...
  object IRadial {
    ...
    extension [Self <: IRadial](x: Self) {
      ...
      inline def setGetEnd(value: CallbackTo[Any]): Self = StObject.set(x, "getEnd", value.toJsFn)
      
      inline def setGetEndUndefined: Self = StObject.set(x, "getEnd", js.undefined)
      
      inline def setGetStart(value: CallbackTo[Any]): Self = StObject.set(x, "getStart", value.toJsFn)
      
      inline def setGetStartUndefined: Self = StObject.set(x, "getStart", js.undefined)
      
      inline def setSetEnd(value: /* end */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setEnd", js.Any.fromFunction1((t0: /* end */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetEndUndefined: Self = StObject.set(x, "setEnd", js.undefined)
      
      inline def setSetStart(value: /* start */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setStart", js.Any.fromFunction1((t0: /* start */ js.UndefOr[Any]) => value(t0).runNow()))
