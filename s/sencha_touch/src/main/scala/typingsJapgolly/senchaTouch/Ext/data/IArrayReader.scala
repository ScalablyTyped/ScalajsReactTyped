...
object IArrayReader {
  ...
  def apply(
    ...
    getUseSimpleAccessors: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    setSuccessProperty: /* successProperty */ js.UndefOr[js.Any] => Callback = null,
    setTotalProperty: /* totalProperty */ js.UndefOr[js.Any] => Callback = null,
    setUseSimpleAccessors: /* useSimpleAccessors */ js.UndefOr[Boolean] => Callback = null,
    ...
    getUseSimpleAccessors.foreach(p => __obj.updateDynamic("getUseSimpleAccessors")(p.toJsFn))
    ...
    if (setSuccessProperty != null) __obj.updateDynamic("setSuccessProperty")(js.Any.fromFunction1((t0: /* successProperty */ js.UndefOr[js.Any]) => setSuccessProperty(t0).runNow()))
    if (setTotalProperty != null) __obj.updateDynamic("setTotalProperty")(js.Any.fromFunction1((t0: /* totalProperty */ js.UndefOr[js.Any]) => setTotalProperty(t0).runNow()))
    if (setUseSimpleAccessors != null) __obj.updateDynamic("setUseSimpleAccessors")(js.Any.fromFunction1((t0: /* useSimpleAccessors */ js.UndefOr[scala.Boolean]) => setUseSimpleAccessors(t0).runNow()))
