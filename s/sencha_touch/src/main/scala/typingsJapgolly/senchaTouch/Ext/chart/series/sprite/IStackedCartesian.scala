...
object IStackedCartesian {
  ...
  def apply(
    ...
    getIndexNearPoint: (/* x */ js.UndefOr[js.Any], /* y */ js.UndefOr[js.Any]) => CallbackTo[Double] = null,
    ...
    hide: js.UndefOr[CallbackTo[IStackedCartesian]] = js.undefined,
    ...
    show: js.UndefOr[CallbackTo[IStackedCartesian]] = js.undefined,
    ...
    if (getIndexNearPoint != null) __obj.updateDynamic("getIndexNearPoint")(js.Any.fromFunction2((t0: /* x */ js.UndefOr[js.Any], t1: /* y */ js.UndefOr[js.Any]) => getIndexNearPoint(t0, t1).runNow()))
