...
object device {
  ...
  object IAbstract {
    ...
    extension [Self <: IAbstract](x: Self) {
      ...
      inline def setOpenURL(value: /* url */ js.UndefOr[String] => Callback): Self = StObject.set(x, "openURL", js.Any.fromFunction1((t0: /* url */ js.UndefOr[String]) => value(t0).runNow()))
  ...
  object ISencha {
    ...
    extension [Self <: ISencha](x: Self) {
      ...
      inline def setOpenURL(value: /* url */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "openURL", js.Any.fromFunction1((t0: /* url */ js.UndefOr[Any]) => value(t0).runNow()))
