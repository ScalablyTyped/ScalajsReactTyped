...
object IRest {
  ...
  def apply(
    ...
    format: String = null,
    getActionMethods: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getApi: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getAppendId: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    getFormat: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    self: IClass = null,
    setActionMethods: /* actionMethods */ js.UndefOr[js.Any] => Callback = null,
    setApi: /* api */ js.UndefOr[js.Any] => Callback = null,
    setAppendId: /* appendId */ js.UndefOr[Boolean] => Callback = null,
    ...
    setFormat: /* format */ js.UndefOr[String] => Callback = null,
    ...
    getActionMethods.foreach(p => __obj.updateDynamic("getActionMethods")(p.toJsFn))
    getApi.foreach(p => __obj.updateDynamic("getApi")(p.toJsFn))
    getAppendId.foreach(p => __obj.updateDynamic("getAppendId")(p.toJsFn))
    ...
    getFormat.foreach(p => __obj.updateDynamic("getFormat")(p.toJsFn))
    ...
    if (setActionMethods != null) __obj.updateDynamic("setActionMethods")(js.Any.fromFunction1((t0: /* actionMethods */ js.UndefOr[js.Any]) => setActionMethods(t0).runNow()))
    if (setApi != null) __obj.updateDynamic("setApi")(js.Any.fromFunction1((t0: /* api */ js.UndefOr[js.Any]) => setApi(t0).runNow()))
    if (setAppendId != null) __obj.updateDynamic("setAppendId")(js.Any.fromFunction1((t0: /* appendId */ js.UndefOr[scala.Boolean]) => setAppendId(t0).runNow()))
    ...
    if (setFormat != null) __obj.updateDynamic("setFormat")(js.Any.fromFunction1((t0: /* format */ js.UndefOr[java.lang.String]) => setFormat(t0).runNow()))
