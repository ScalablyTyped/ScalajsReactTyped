...
object IThumb {
  ...
  def apply(
    ...
    getDraggable: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    getParent: js.UndefOr[CallbackTo[IThumb]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IThumb] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IThumb] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IThumb], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    getDraggable.foreach(p => __obj.updateDynamic("getDraggable")(p.toJsFn))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.slider.IThumb], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
