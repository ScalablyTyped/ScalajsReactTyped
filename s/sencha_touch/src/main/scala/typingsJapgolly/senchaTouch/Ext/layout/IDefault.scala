...
object IDefault {
  ...
  def apply(
    ...
    onItemInnerStateChange: (/* item */ js.UndefOr[IComponent], /* isInner */ js.UndefOr[Boolean], /* destroying */ js.UndefOr[Boolean]) => Callback = null,
    ...
    if (onItemInnerStateChange != null) __obj.updateDynamic("onItemInnerStateChange")(js.Any.fromFunction3((t0: /* item */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IComponent], t1: /* isInner */ js.UndefOr[scala.Boolean], t2: /* destroying */ js.UndefOr[scala.Boolean]) => onItemInnerStateChange(t0, t1, t2).runNow()))
