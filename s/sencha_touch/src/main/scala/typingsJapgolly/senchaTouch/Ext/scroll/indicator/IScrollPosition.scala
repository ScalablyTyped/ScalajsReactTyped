package typingsJapgolly.senchaTouch.Ext.scroll.indicator
...
trait IScrollPosition extends IAbstract {
  /** [Method] Returns the value of cls
  		...
  		*/
  @JSName("getCls")
  var getCls_IScrollPosition: js.UndefOr[js.Function0[String]] = js.undefined
  /** [Method] Sets the value of cls
  		* @param cls String The new value.
  		*/
  @JSName("setCls")
  var setCls_IScrollPosition: js.UndefOr[js.Function1[/* cls */ js.UndefOr[String], Unit]] = js.undefined
}
...
object IScrollPosition {
  ...
  def apply(
    ...
    getAutoHide: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    getAxis: js.UndefOr[CallbackTo[String]] = js.undefined,
    getBarCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getLength: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    getMinLength: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getMinWidth: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getPadding: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getParent: js.UndefOr[CallbackTo[IScrollPosition]] = js.undefined,
    getPlugins: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getRatio: js.UndefOr[CallbackTo[Double]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IScrollPosition] = null,
    ...
    setAutoHide: /* autoHide */ js.UndefOr[Boolean] => Callback = null,
    setAxis: /* axis */ js.UndefOr[String] => Callback = null,
    setBarCls: /* barCls */ js.UndefOr[String] => Callback = null,
    ...
    setLength: /* length */ js.UndefOr[js.Any] => Callback = null,
    ...
    setMinLength: /* minLength */ js.UndefOr[Double] => Callback = null,
    ...
    setRatio: /* ratio */ js.UndefOr[Double] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IScrollPosition] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IScrollPosition], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    getAutoHide.foreach(p => __obj.updateDynamic("getAutoHide")(p.toJsFn))
    getAxis.foreach(p => __obj.updateDynamic("getAxis")(p.toJsFn))
    getBarCls.foreach(p => __obj.updateDynamic("getBarCls")(p.toJsFn))
    ...
    getLength.foreach(p => __obj.updateDynamic("getLength")(p.toJsFn))
    ...
    getMinLength.foreach(p => __obj.updateDynamic("getMinLength")(p.toJsFn))
    ...
    getRatio.foreach(p => __obj.updateDynamic("getRatio")(p.toJsFn))
    ...
    if (setAutoHide != null) __obj.updateDynamic("setAutoHide")(js.Any.fromFunction1((t0: /* autoHide */ js.UndefOr[scala.Boolean]) => setAutoHide(t0).runNow()))
    if (setAxis != null) __obj.updateDynamic("setAxis")(js.Any.fromFunction1((t0: /* axis */ js.UndefOr[java.lang.String]) => setAxis(t0).runNow()))
    if (setBarCls != null) __obj.updateDynamic("setBarCls")(js.Any.fromFunction1((t0: /* barCls */ js.UndefOr[java.lang.String]) => setBarCls(t0).runNow()))
    ...
    if (setLength != null) __obj.updateDynamic("setLength")(js.Any.fromFunction1((t0: /* length */ js.UndefOr[js.Any]) => setLength(t0).runNow()))
    ...
    if (setMinLength != null) __obj.updateDynamic("setMinLength")(js.Any.fromFunction1((t0: /* minLength */ js.UndefOr[scala.Double]) => setMinLength(t0).runNow()))
    ...
    if (setRatio != null) __obj.updateDynamic("setRatio")(js.Any.fromFunction1((t0: /* ratio */ js.UndefOr[scala.Double]) => setRatio(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.scroll.indicator.IScrollPosition], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
