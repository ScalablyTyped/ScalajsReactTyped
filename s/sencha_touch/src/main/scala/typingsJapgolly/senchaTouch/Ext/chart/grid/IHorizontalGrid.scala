package typingsJapgolly.senchaTouch.Ext.chart.grid
...
object IHorizontalGrid {
  ...
  def apply(
    ...
    hide: js.UndefOr[CallbackTo[IHorizontalGrid]] = js.undefined,
    ...
    show: js.UndefOr[CallbackTo[IHorizontalGrid]] = js.undefined,
