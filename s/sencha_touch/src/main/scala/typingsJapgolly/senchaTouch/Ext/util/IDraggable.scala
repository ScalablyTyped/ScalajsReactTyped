...
object IDraggable {
  ...
  def apply(
    ...
    disable: js.UndefOr[CallbackTo[IDraggable]] = js.undefined,
    enable: js.UndefOr[CallbackTo[IDraggable]] = js.undefined,
    ...
    getConstraint: js.UndefOr[CallbackTo[String]] = js.undefined,
    getDirection: js.UndefOr[CallbackTo[String]] = js.undefined,
    getDisabled: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getDraggingCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    setConstraint: /* constraint */ js.UndefOr[String] => Callback = null,
    setDirection: /* direction */ js.UndefOr[String] => Callback = null,
    setDisabled: /* disabled */ js.UndefOr[js.Any] => Callback = null,
    setDraggingCls: /* draggingCls */ js.UndefOr[String] => Callback = null,
    ...
    getConstraint.foreach(p => __obj.updateDynamic("getConstraint")(p.toJsFn))
    ...
    getDraggingCls.foreach(p => __obj.updateDynamic("getDraggingCls")(p.toJsFn))
    ...
    if (setConstraint != null) __obj.updateDynamic("setConstraint")(js.Any.fromFunction1((t0: /* constraint */ js.UndefOr[java.lang.String]) => setConstraint(t0).runNow()))
    ...
    if (setDisabled != null) __obj.updateDynamic("setDisabled")(js.Any.fromFunction1((t0: /* disabled */ js.UndefOr[js.Any]) => setDisabled(t0).runNow()))
    if (setDraggingCls != null) __obj.updateDynamic("setDraggingCls")(js.Any.fromFunction1((t0: /* draggingCls */ js.UndefOr[java.lang.String]) => setDraggingCls(t0).runNow()))
