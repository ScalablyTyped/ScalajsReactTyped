...
object IInstancing {
  ...
  extension [Self <: IInstancing](x: Self) {
    ...
    inline def setGetTemplate(value: CallbackTo[Any]): Self = StObject.set(x, "getTemplate", value.toJsFn)
    ...
    inline def setSetAttributesFor(
      value: (/* index */ js.UndefOr[Double], /* changes */ js.UndefOr[Any], /* bypassNormalization */ js.UndefOr[Boolean]) => Callback
    ): Self = StObject.set(x, "setAttributesFor", js.Any.fromFunction3((t0: /* index */ js.UndefOr[Double], t1: /* changes */ js.UndefOr[Any], t2: /* bypassNormalization */ js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
    
    inline def setSetAttributesForUndefined: Self = StObject.set(x, "setAttributesFor", js.undefined)
    
    inline def setSetTemplate(value: /* template */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setTemplate", js.Any.fromFunction1((t0: /* template */ js.UndefOr[Any]) => value(t0).runNow()))
