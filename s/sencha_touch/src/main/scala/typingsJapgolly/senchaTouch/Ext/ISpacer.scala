...
object ISpacer {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[ISpacer]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISpacer] = null,
    ...
    setWidth: /* width */ js.UndefOr[Double] => Callback = null,
    setZIndex: /* zIndex */ js.UndefOr[Double] => Callback = null,
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISpacer] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISpacer], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.ISpacer], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
