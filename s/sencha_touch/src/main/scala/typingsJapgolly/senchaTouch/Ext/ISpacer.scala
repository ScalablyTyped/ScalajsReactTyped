...
object ISpacer {
  ...
  extension [Self <: ISpacer](x: Self) {
    ...
    inline def setSetWidth(value: /* width */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setWidth", js.Any.fromFunction1((t0: /* width */ js.UndefOr[Double]) => value(t0).runNow()))
