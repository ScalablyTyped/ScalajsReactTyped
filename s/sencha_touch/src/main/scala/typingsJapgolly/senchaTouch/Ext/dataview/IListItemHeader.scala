...
object IListItemHeader {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IListItemHeader]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IListItemHeader] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IListItemHeader] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IListItemHeader], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.IListItemHeader], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
