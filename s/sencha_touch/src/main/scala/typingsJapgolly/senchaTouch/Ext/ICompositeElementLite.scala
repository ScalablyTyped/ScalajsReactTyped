...
trait ICompositeElementLite
  extends typingsJapgolly.senchaTouch.Ext.dom.IElement {
  ...
  var appendChild_ICompositeElementLite: js.UndefOr[
    js.Function1[/* element */ js.UndefOr[js.Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
  ] = js.undefined
  ...
  var appendTo_ICompositeElementLite: js.UndefOr[
    js.Function1[/* el */ js.UndefOr[js.Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
  ] = js.undefined
  ...
  var applyStyles_ICompositeElementLite: js.UndefOr[
    js.Function1[/* styles */ js.UndefOr[js.Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
  ] = js.undefined
  ...
  var radioCls_ICompositeElementLite: js.UndefOr[
    js.Function1[/* className */ js.UndefOr[js.Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
  ] = js.undefined
  ...
  var setBox_ICompositeElementLite: js.UndefOr[
    js.Function1[/* box */ js.UndefOr[js.Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
  ] = js.undefined
  ...
  var setHeight_ICompositeElementLite: js.UndefOr[
    js.Function1[/* height */ js.UndefOr[js.Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
  ] = js.undefined
  ...
  var setMaxWidth_ICompositeElementLite: js.UndefOr[
    js.Function1[/* width */ js.UndefOr[js.Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
  ] = js.undefined
  ...
  var setVisibilityMode_ICompositeElementLite: js.UndefOr[
    js.Function1[/* mode */ js.UndefOr[js.Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
  ] = js.undefined
