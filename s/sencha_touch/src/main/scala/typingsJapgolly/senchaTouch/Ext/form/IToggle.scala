...
trait IToggle
  extends StObject
     with typingsJapgolly.senchaTouch.Ext.field.ISlider {
...
object IToggle {
  ...
  extension [Self <: IToggle](x: Self) {
    ...
    inline def setGetActiveLabel(value: CallbackTo[String]): Self = StObject.set(x, "getActiveLabel", value.toJsFn)
    
    inline def setGetActiveLabelUndefined: Self = StObject.set(x, "getActiveLabel", js.undefined)
    
    inline def setGetInactiveLabel(value: CallbackTo[String]): Self = StObject.set(x, "getInactiveLabel", value.toJsFn)
    
    inline def setGetInactiveLabelUndefined: Self = StObject.set(x, "getInactiveLabel", js.undefined)
    
    inline def setGetMaxValueCls(value: CallbackTo[String]): Self = StObject.set(x, "getMaxValueCls", value.toJsFn)
    
    inline def setGetMaxValueClsUndefined: Self = StObject.set(x, "getMaxValueCls", js.undefined)
    
    inline def setGetMinValueCls(value: CallbackTo[String]): Self = StObject.set(x, "getMinValueCls", value.toJsFn)
    ...
    inline def setSetActiveLabel(value: /* activeLabel */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setActiveLabel", js.Any.fromFunction1((t0: /* activeLabel */ js.UndefOr[String]) => value(t0).runNow()))
    
    inline def setSetActiveLabelUndefined: Self = StObject.set(x, "setActiveLabel", js.undefined)
    
    inline def setSetInactiveLabel(value: /* inactiveLabel */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setInactiveLabel", js.Any.fromFunction1((t0: /* inactiveLabel */ js.UndefOr[String]) => value(t0).runNow()))
    
    inline def setSetInactiveLabelUndefined: Self = StObject.set(x, "setInactiveLabel", js.undefined)
    
    inline def setSetMaxValueCls(value: /* maxValueCls */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setMaxValueCls", js.Any.fromFunction1((t0: /* maxValueCls */ js.UndefOr[String]) => value(t0).runNow()))
    
    inline def setSetMaxValueClsUndefined: Self = StObject.set(x, "setMaxValueCls", js.undefined)
    
    inline def setSetMinValueCls(value: /* minValueCls */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setMinValueCls", js.Any.fromFunction1((t0: /* minValueCls */ js.UndefOr[String]) => value(t0).runNow()))
    ...
    inline def setToggle(value: CallbackTo[Any]): Self = StObject.set(x, "toggle", value.toJsFn)
