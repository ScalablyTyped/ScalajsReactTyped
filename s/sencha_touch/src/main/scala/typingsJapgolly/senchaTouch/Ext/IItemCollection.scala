...
- typingsJapgolly.senchaTouch.Ext.IBase because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined 
- typingsJapgolly.senchaTouch.Ext.mixin.IIdentifiable because var conflicts: callOverridden, callParent, callSuper, destroy, getId, getInitialConfig, initConfig, self. Inlined 
...
object IItemCollection {
  ...
  extension [Self <: IItemCollection](x: Self) {
    ...
    inline def setAddListener(
      value: (/* eventName */ js.UndefOr[Any], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any], /* options */ js.UndefOr[Any], /* order */ js.UndefOr[java.lang.String]) => Callback
    ): Self = StObject.set(x, "addListener", js.Any.fromFunction5((t0: /* eventName */ js.UndefOr[Any], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any], t3: /* options */ js.UndefOr[Any], t4: /* order */ js.UndefOr[java.lang.String]) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def setOn(
      value: (/* eventName */ js.UndefOr[Any], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any], /* options */ js.UndefOr[Any], /* order */ js.UndefOr[java.lang.String]) => Callback
    ): Self = StObject.set(x, "on", js.Any.fromFunction5((t0: /* eventName */ js.UndefOr[Any], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any], t3: /* options */ js.UndefOr[Any], t4: /* order */ js.UndefOr[java.lang.String]) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def setRemoveListener(
      value: (/* eventName */ js.UndefOr[Any], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any], /* options */ js.UndefOr[Any], /* order */ js.UndefOr[java.lang.String]) => Callback
    ): Self = StObject.set(x, "removeListener", js.Any.fromFunction5((t0: /* eventName */ js.UndefOr[Any], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any], t3: /* options */ js.UndefOr[Any], t4: /* order */ js.UndefOr[java.lang.String]) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def setSortByKey(value: (/* dir */ js.UndefOr[java.lang.String], /* fn */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "sortByKey", js.Any.fromFunction2((t0: /* dir */ js.UndefOr[java.lang.String], t1: /* fn */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setUn(
      value: (/* eventName */ js.UndefOr[Any], /* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any], /* options */ js.UndefOr[Any], /* order */ js.UndefOr[java.lang.String]) => Callback
    ): Self = StObject.set(x, "un", js.Any.fromFunction5((t0: /* eventName */ js.UndefOr[Any], t1: /* fn */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any], t3: /* options */ js.UndefOr[Any], t4: /* order */ js.UndefOr[java.lang.String]) => (value(t0, t1, t2, t3, t4)).runNow()))
