...
object navigation {
  ...
  object IBar {
    ...
    extension [Self <: IBar](x: Self) {
      ...
      inline def setGetAndroidAnimation(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAndroidAnimation", value.toJsFn)
      
      inline def setGetAndroidAnimationUndefined: Self = StObject.set(x, "getAndroidAnimation", js.undefined)
      
      inline def setSetAndroidAnimation(value: /* androidAnimation */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAndroidAnimation", js.Any.fromFunction1((t0: /* androidAnimation */ js.UndefOr[Boolean]) => value(t0).runNow()))
  ...
  object IView {
    ...
    extension [Self <: IView](x: Self) {
      ...
      inline def setGetDefaultBackButtonText(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getDefaultBackButtonText", value.toJsFn)
      ...
      inline def setGetNavigationBar(value: CallbackTo[Any]): Self = StObject.set(x, "getNavigationBar", value.toJsFn)
      
      inline def setGetNavigationBarUndefined: Self = StObject.set(x, "getNavigationBar", js.undefined)
      
      inline def setGetPreviousItem(value: CallbackTo[Any]): Self = StObject.set(x, "getPreviousItem", value.toJsFn)
      
      inline def setGetPreviousItemUndefined: Self = StObject.set(x, "getPreviousItem", js.undefined)
      
      inline def setGetUseTitleForBackButtonText(value: CallbackTo[Boolean]): Self = StObject.set(x, "getUseTitleForBackButtonText", value.toJsFn)
      ...
      inline def setReset(value: CallbackTo[IComponent]): Self = StObject.set(x, "reset", value.toJsFn)
      
      inline def setResetUndefined: Self = StObject.set(x, "reset", js.undefined)
      
      inline def setSetDefaultBackButtonText(value: /* defaultBackButtonText */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setDefaultBackButtonText", js.Any.fromFunction1((t0: /* defaultBackButtonText */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetDefaultBackButtonTextUndefined: Self = StObject.set(x, "setDefaultBackButtonText", js.undefined)
      
      inline def setSetNavigationBar(value: /* navigationBar */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setNavigationBar", js.Any.fromFunction1((t0: /* navigationBar */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetNavigationBarUndefined: Self = StObject.set(x, "setNavigationBar", js.undefined)
      
      inline def setSetUseTitleForBackButtonText(value: /* useTitleForBackButtonText */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setUseTitleForBackButtonText", js.Any.fromFunction1((t0: /* useTitleForBackButtonText */ js.UndefOr[Boolean]) => value(t0).runNow()))
