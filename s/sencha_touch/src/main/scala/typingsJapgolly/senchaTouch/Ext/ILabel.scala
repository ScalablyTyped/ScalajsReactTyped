...
object ILabel {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[ILabel]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ILabel] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ILabel] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ILabel], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.ILabel], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
