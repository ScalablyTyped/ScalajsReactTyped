package typingsJapgolly.senchaTouch.Ext.chart.series.sprite

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.senchaTouch.Ext.Array
import typingsJapgolly.senchaTouch.Ext.IClass
import typingsJapgolly.senchaTouch.Ext.chart.IMarkers
...
object ICartesian {
  ...
  def apply(
    ...
    attr: js.Any = null,
    binarySearch: /* key */ js.UndefOr[String] => CallbackTo[js.Any] = null,
    bindMarker: (js.UndefOr[String], js.UndefOr[IMarkers]) => Callback = null,
    ...
    getIndexNearPoint: (/* x */ js.UndefOr[Double], /* y */ js.UndefOr[Double]) => CallbackTo[Double] = null,
    ...
    hide: js.UndefOr[CallbackTo[ICartesian]] = js.undefined,
    ...
    render: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* region */ js.UndefOr[js.Any]) => CallbackTo[js.Any] = null,
    renderClipped: (/* surface */ js.UndefOr[ISurface], /* ctx */ js.UndefOr[js.Any], /* clip */ js.UndefOr[Array], /* region */ js.UndefOr[Array]) => Callback = null,
    ...
    show: js.UndefOr[CallbackTo[ICartesian]] = js.undefined,
    ...
    if (binarySearch != null) __obj.updateDynamic("binarySearch")(js.Any.fromFunction1((t0: /* key */ js.UndefOr[java.lang.String]) => binarySearch(t0).runNow()))
    if (bindMarker != null) __obj.updateDynamic("bindMarker")(js.Any.fromFunction2((t0: js.UndefOr[java.lang.String], t1: js.UndefOr[typingsJapgolly.senchaTouch.Ext.chart.IMarkers]) => bindMarker(t0, t1).runNow()))
    ...
    if (getIndexNearPoint != null) __obj.updateDynamic("getIndexNearPoint")(js.Any.fromFunction2((t0: /* x */ js.UndefOr[scala.Double], t1: /* y */ js.UndefOr[scala.Double]) => getIndexNearPoint(t0, t1).runNow()))
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction3((t0: /* surface */ js.UndefOr[js.Any], t1: /* ctx */ js.UndefOr[js.Any], t2: /* region */ js.UndefOr[js.Any]) => render(t0, t1, t2).runNow()))
    if (renderClipped != null) __obj.updateDynamic("renderClipped")(js.Any.fromFunction4((t0: /* surface */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.ISurface], t1: /* ctx */ js.UndefOr[js.Any], t2: /* clip */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.Array], t3: /* region */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.Array]) => renderClipped(t0, t1, t2, t3).runNow()))
