...
- typingsJapgolly.senchaTouch.Ext.mixin.IFilterable because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, currentSortFn, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined filterRoot, filters, dirtyFilterFn, filtered, addFilter, addFilters, filter, getFilterFn, getFilterRoot, getFilters, insertFilter, insertFilters, removeFilters, setFilterRoot, setFilters */ trait ICollection
  extends StObject
     with typingsJapgolly.senchaTouch.Ext.mixin.ISortable {
  ...
  /** [Method] This method adds a filter
    ...
    */
  var addFilter: js.UndefOr[js.Function1[js.UndefOr[Any], Unit]] = js.undefined
  
  /** [Method] This method adds all the filters in a passed array
    * @param filters Object
    * @returns Object
    */
  var addFilters: js.UndefOr[js.Function1[js.UndefOr[Any | Array], Any]] = js.undefined
  ...
  /** [Method] This method adds a filter at a given index
    ...
    * @returns Object
    */
  var insertFilter: js.UndefOr[js.Function2[js.UndefOr[Double], js.UndefOr[Any], Any]] = js.undefined
  ...
  /** [Method] This method removes all the filters in a passed array
    ...
    * @returns Ext.util.Collection this
    */
  var removeFilters: js.UndefOr[js.Function1[js.UndefOr[Any | Array], this.type | Unit]] = js.undefined
  ...
  var removeSorters_ICollection: js.UndefOr[js.Function1[/* sorters */ js.UndefOr[Any], this.type]] = js.undefined
...
object ICollection {
  ...
  extension [Self <: ICollection](x: Self) {
    ...
    inline def setAddFilter(value: js.UndefOr[Any] => Callback): Self = StObject.set(x, "addFilter", js.Any.fromFunction1((t0: js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setAddFilterUndefined: Self = StObject.set(x, "addFilter", js.undefined)
    
    inline def setAddFilters(value: js.UndefOr[Any | Array] => Any): Self = StObject.set(x, "addFilters", js.Any.fromFunction1(value))
    ...
    inline def setClone_(value: CallbackTo[IMixedCollection]): Self = StObject.set(x, "clone", value.toJsFn)
    ...
    inline def setInsertFilter(value: (js.UndefOr[Double], js.UndefOr[Any]) => Any): Self = StObject.set(x, "insertFilter", js.Any.fromFunction2(value))
    ...
    inline def setInsertSorters(value: CallbackTo[ICollection]): Self = StObject.set(x, "insertSorters", value.toJsFn)
    ...
    inline def setRemoveFilters(value: js.UndefOr[Any | Array] => ICollection | Unit): Self = StObject.set(x, "removeFilters", js.Any.fromFunction1(value))
    
    inline def setRemoveFiltersUndefined: Self = StObject.set(x, "removeFilters", js.undefined)
    
    inline def setRemoveSorters(value: /* sorters */ js.UndefOr[Any] => ICollection): Self = StObject.set(x, "removeSorters", js.Any.fromFunction1(value))
    ...
    inline def setSetFilterRoot(value: js.UndefOr[String] => Callback): Self = StObject.set(x, "setFilterRoot", js.Any.fromFunction1((t0: js.UndefOr[String]) => value(t0).runNow()))
    
    inline def setSetFilterRootUndefined: Self = StObject.set(x, "setFilterRoot", js.undefined)
    
    inline def setSetFilters(value: js.UndefOr[Array] => Callback): Self = StObject.set(x, "setFilters", js.Any.fromFunction1((t0: js.UndefOr[Array]) => value(t0).runNow()))
