...
object IVersion {
  ...
  extension [Self <: IVersion](x: Self) {
    ...
    inline def setDeprecate(
      value: (/* packageName */ js.UndefOr[java.lang.String], /* since */ js.UndefOr[java.lang.String], /* closure */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "deprecate", js.Any.fromFunction4((t0: /* packageName */ js.UndefOr[java.lang.String], t1: /* since */ js.UndefOr[java.lang.String], t2: /* closure */ js.UndefOr[Any], t3: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setGetBuild(value: CallbackTo[Double]): Self = StObject.set(x, "getBuild", value.toJsFn)
    
    inline def setGetBuildUndefined: Self = StObject.set(x, "getBuild", js.undefined)
    
    inline def setGetMajor(value: CallbackTo[Double]): Self = StObject.set(x, "getMajor", value.toJsFn)
    
    inline def setGetMajorUndefined: Self = StObject.set(x, "getMajor", js.undefined)
    
    inline def setGetMinor(value: CallbackTo[Double]): Self = StObject.set(x, "getMinor", value.toJsFn)
    
    inline def setGetMinorUndefined: Self = StObject.set(x, "getMinor", js.undefined)
    
    inline def setGetPatch(value: CallbackTo[Double]): Self = StObject.set(x, "getPatch", value.toJsFn)
    
    inline def setGetPatchUndefined: Self = StObject.set(x, "getPatch", js.undefined)
    
    inline def setGetRelease(value: CallbackTo[Double]): Self = StObject.set(x, "getRelease", value.toJsFn)
    
    inline def setGetReleaseUndefined: Self = StObject.set(x, "getRelease", js.undefined)
    
    inline def setGetShortVersion(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getShortVersion", value.toJsFn)
