...
object ICssTransform {
  ...
  def apply(
    ...
    getUseWrapper: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    setUseWrapper: /* useWrapper */ js.UndefOr[js.Any] => Callback = null,
    ...
    if (setUseWrapper != null) __obj.updateDynamic("setUseWrapper")(js.Any.fromFunction1((t0: /* useWrapper */ js.UndefOr[js.Any]) => setUseWrapper(t0).runNow()))
