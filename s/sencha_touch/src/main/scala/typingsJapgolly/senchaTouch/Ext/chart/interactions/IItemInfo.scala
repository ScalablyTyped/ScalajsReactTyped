...
object IItemInfo {
  ...
  def apply(
    ...
    getPanel: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    onGesture: (/* series */ js.UndefOr[js.Any], /* item */ js.UndefOr[js.Any]) => Callback = null,
    panel: js.Any = null,
    ...
    setPanel: /* panel */ js.UndefOr[js.Any] => Callback = null,
    ...
    getPanel.foreach(p => __obj.updateDynamic("getPanel")(p.toJsFn))
    ...
    if (onGesture != null) __obj.updateDynamic("onGesture")(js.Any.fromFunction2((t0: /* series */ js.UndefOr[js.Any], t1: /* item */ js.UndefOr[js.Any]) => onGesture(t0, t1).runNow()))
    ...
    if (setPanel != null) __obj.updateDynamic("setPanel")(js.Any.fromFunction1((t0: /* panel */ js.UndefOr[js.Any]) => setPanel(t0).runNow()))
