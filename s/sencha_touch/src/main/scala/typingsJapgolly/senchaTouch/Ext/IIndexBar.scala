...
object IIndexBar {
  ...
  def apply(
    ...
    getLetters: js.UndefOr[CallbackTo[Array]] = js.undefined,
    getListPrefix: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    ...
    getParent: js.UndefOr[CallbackTo[IIndexBar]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IIndexBar] = null,
    ...
    isHorizontal: js.UndefOr[Callback] = js.undefined,
    isVertical: js.UndefOr[Callback] = js.undefined,
    ...
    setLetters: /* letters */ js.UndefOr[Array] => Callback = null,
    setListPrefix: /* listPrefix */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IIndexBar] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IIndexBar], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    getLetters.foreach(p => __obj.updateDynamic("getLetters")(p.toJsFn))
    getListPrefix.foreach(p => __obj.updateDynamic("getListPrefix")(p.toJsFn))
    ...
    if (setLetters != null) __obj.updateDynamic("setLetters")(js.Any.fromFunction1((t0: /* letters */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.Array]) => setLetters(t0).runNow()))
    if (setListPrefix != null) __obj.updateDynamic("setListPrefix")(js.Any.fromFunction1((t0: /* listPrefix */ js.UndefOr[java.lang.String]) => setListPrefix(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IIndexBar], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
