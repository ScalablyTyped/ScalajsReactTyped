...
object IMask {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IMask]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IMask] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IMask] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IMask], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IMask], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
