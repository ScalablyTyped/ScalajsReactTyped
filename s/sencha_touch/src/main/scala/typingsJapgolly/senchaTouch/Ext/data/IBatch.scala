...
object IBatch {
  ...
  extension [Self <: IBatch](x: Self) {
    ...
    inline def setAdd(value: /* operation */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "add", js.Any.fromFunction1((t0: /* operation */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setGetAutoStart(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAutoStart", value.toJsFn)
    
    inline def setGetAutoStartUndefined: Self = StObject.set(x, "getAutoStart", js.undefined)
    
    inline def setGetPauseOnException(value: CallbackTo[Boolean]): Self = StObject.set(x, "getPauseOnException", value.toJsFn)
    
    inline def setGetPauseOnExceptionUndefined: Self = StObject.set(x, "getPauseOnException", js.undefined)
    
    inline def setGetProxy(value: CallbackTo[IProxy]): Self = StObject.set(x, "getProxy", value.toJsFn)
    ...
    inline def setRunOperation(value: /* index */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "runOperation", js.Any.fromFunction1((t0: /* index */ js.UndefOr[Double]) => value(t0).runNow()))
    
    inline def setRunOperationUndefined: Self = StObject.set(x, "runOperation", js.undefined)
    
    inline def setSetAutoStart(value: /* autoStart */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAutoStart", js.Any.fromFunction1((t0: /* autoStart */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetAutoStartUndefined: Self = StObject.set(x, "setAutoStart", js.undefined)
    
    inline def setSetPauseOnException(value: /* pauseOnException */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setPauseOnException", js.Any.fromFunction1((t0: /* pauseOnException */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetPauseOnExceptionUndefined: Self = StObject.set(x, "setPauseOnException", js.undefined)
    
    inline def setSetProxy(value: /* proxy */ js.UndefOr[IProxy] => Callback): Self = StObject.set(x, "setProxy", js.Any.fromFunction1((t0: /* proxy */ js.UndefOr[IProxy]) => value(t0).runNow()))
