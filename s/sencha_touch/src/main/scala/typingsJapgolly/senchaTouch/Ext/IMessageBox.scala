...
object IMessageBox {
  ...
  extension [Self <: IMessageBox](x: Self) {
    ...
    inline def setGetButtons(value: CallbackTo[Any]): Self = StObject.set(x, "getButtons", value.toJsFn)
    
    inline def setGetButtonsUndefined: Self = StObject.set(x, "getButtons", js.undefined)
    
    inline def setGetDefaultTextHeight(value: CallbackTo[Double]): Self = StObject.set(x, "getDefaultTextHeight", value.toJsFn)
    ...
    inline def setGetPrompt(value: CallbackTo[Any]): Self = StObject.set(x, "getPrompt", value.toJsFn)
    ...
    inline def setSetButtons(value: /* buttons */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setButtons", js.Any.fromFunction1((t0: /* buttons */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetButtonsUndefined: Self = StObject.set(x, "setButtons", js.undefined)
    
    inline def setSetDefaultTextHeight(value: /* defaultTextHeight */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setDefaultTextHeight", js.Any.fromFunction1((t0: /* defaultTextHeight */ js.UndefOr[Double]) => value(t0).runNow()))
    ...
    inline def setSetPrompt(value: /* prompt */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setPrompt", js.Any.fromFunction1((t0: /* prompt */ js.UndefOr[Any]) => value(t0).runNow()))
