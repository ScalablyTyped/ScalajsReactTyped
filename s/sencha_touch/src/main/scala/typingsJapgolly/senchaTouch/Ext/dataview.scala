...
object dataview {
  ...
  object IDataView {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.dataview.IDataView = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dataview.IDataView]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.dataview.IDataView](x: Self) {
  ...
  object IIndexBar {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.dataview.IIndexBar = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dataview.IIndexBar]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.dataview.IIndexBar](x: Self) {
  ...
  object IList {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.dataview.IList = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dataview.IList]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.dataview.IList](x: Self) {
  ...
  object INestedList {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.dataview.INestedList = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dataview.INestedList]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.dataview.INestedList](x: Self) {
      ...
      inline def setOnItemTap(
        value: (/* list */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IList], /* index */ js.UndefOr[Double], /* target */ js.UndefOr[IElement], /* record */ js.UndefOr[IRecord], /* e */ js.UndefOr[IEvent]) => Callback
      ): Self = StObject.set(x, "onItemTap", js.Any.fromFunction5((t0: /* list */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IList], t1: /* index */ js.UndefOr[Double], t2: /* target */ js.UndefOr[IElement], t3: /* record */ js.UndefOr[IRecord], t4: /* e */ js.UndefOr[IEvent]) => (value(t0, t1, t2, t3, t4)).runNow()))
  ...
  object component {
    ...
    object IContainer {
      ...
      inline def apply(): typingsJapgolly.senchaTouch.Ext.dataview.component.IContainer = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dataview.component.IContainer]
      }
    }
    ...
    object IDataItem {
      ...
      extension [Self <: IDataItem](x: Self) {
        ...
        inline def setGetDataMap(value: CallbackTo[Any]): Self = StObject.set(x, "getDataMap", value.toJsFn)
        ...
        inline def setSetDataMap(value: /* dataMap */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setDataMap", js.Any.fromFunction1((t0: /* dataMap */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    object IListItem {
      ...
      extension [Self <: IListItem](x: Self) {
        ...
        inline def setGetBody(value: CallbackTo[Any]): Self = StObject.set(x, "getBody", value.toJsFn)
        
        inline def setGetBodyUndefined: Self = StObject.set(x, "getBody", js.undefined)
        
        inline def setGetDisclosure(value: CallbackTo[Any]): Self = StObject.set(x, "getDisclosure", value.toJsFn)
        
        inline def setGetDisclosureUndefined: Self = StObject.set(x, "getDisclosure", js.undefined)
        
        inline def setGetHeader(value: CallbackTo[Any]): Self = StObject.set(x, "getHeader", value.toJsFn)
        
        inline def setGetHeaderUndefined: Self = StObject.set(x, "getHeader", js.undefined)
        
        inline def setSetBody(value: /* body */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setBody", js.Any.fromFunction1((t0: /* body */ js.UndefOr[Any]) => value(t0).runNow()))
        
        inline def setSetBodyUndefined: Self = StObject.set(x, "setBody", js.undefined)
        
        inline def setSetDisclosure(value: /* disclosure */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setDisclosure", js.Any.fromFunction1((t0: /* disclosure */ js.UndefOr[Any]) => value(t0).runNow()))
        
        inline def setSetDisclosureUndefined: Self = StObject.set(x, "setDisclosure", js.undefined)
        
        inline def setSetHeader(value: /* header */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setHeader", js.Any.fromFunction1((t0: /* header */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object element {
    ...
    object IContainer {
      ...
      inline def apply(): typingsJapgolly.senchaTouch.Ext.dataview.element.IContainer = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dataview.element.IContainer]
      }
    }
    
    trait IList
      extends StObject
         with typingsJapgolly.senchaTouch.Ext.dataview.element.IContainer
    object IList {
      
      inline def apply(): typingsJapgolly.senchaTouch.Ext.dataview.element.IList = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dataview.element.IList]
      }
    }
  }
}
