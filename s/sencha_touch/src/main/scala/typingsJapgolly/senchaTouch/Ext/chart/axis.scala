...
object axis {
  ...
  object IAxis {
    ...
    extension [Self <: IAxis](x: Self) {
      ...
      inline def setGetFields(value: CallbackTo[Array]): Self = StObject.set(x, "getFields", value.toJsFn)
      
      inline def setGetFieldsUndefined: Self = StObject.set(x, "getFields", js.undefined)
      
      inline def setGetGrid(value: CallbackTo[Any]): Self = StObject.set(x, "getGrid", value.toJsFn)
      ...
      inline def setGetLabelInSpan(value: CallbackTo[Boolean]): Self = StObject.set(x, "getLabelInSpan", value.toJsFn)
      ...
      inline def setGetMajorTickSteps(value: CallbackTo[Double]): Self = StObject.set(x, "getMajorTickSteps", value.toJsFn)
      ...
      inline def setGetMinorTickSteps(value: CallbackTo[Double]): Self = StObject.set(x, "getMinorTickSteps", value.toJsFn)
      
      inline def setGetMinorTickStepsUndefined: Self = StObject.set(x, "getMinorTickSteps", js.undefined)
      
      inline def setGetNeedHighPrecision(value: CallbackTo[Boolean]): Self = StObject.set(x, "getNeedHighPrecision", value.toJsFn)
      
      inline def setGetNeedHighPrecisionUndefined: Self = StObject.set(x, "getNeedHighPrecision", js.undefined)
      
      inline def setGetPosition(value: CallbackTo[String]): Self = StObject.set(x, "getPosition", value.toJsFn)
      
      inline def setGetPositionUndefined: Self = StObject.set(x, "getPosition", js.undefined)
      
      inline def setGetRange(value: CallbackTo[Array]): Self = StObject.set(x, "getRange", value.toJsFn)
      
      inline def setGetRangeUndefined: Self = StObject.set(x, "getRange", js.undefined)
      
      inline def setGetRenderer(value: CallbackTo[Any]): Self = StObject.set(x, "getRenderer", value.toJsFn)
      
      inline def setGetRendererUndefined: Self = StObject.set(x, "getRenderer", js.undefined)
      
      inline def setGetSegmenter(value: CallbackTo[Any]): Self = StObject.set(x, "getSegmenter", value.toJsFn)
      ...
      inline def setGetTitleMargin(value: CallbackTo[Double]): Self = StObject.set(x, "getTitleMargin", value.toJsFn)
      ...
      inline def setGetVisibleRange(value: CallbackTo[Array]): Self = StObject.set(x, "getVisibleRange", value.toJsFn)
      ...
      inline def setProcessData(value: Callback): Self = StObject.set(x, "processData", value.toJsFn)
      ...
      inline def setSetFields(value: /* fields */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setFields", js.Any.fromFunction1((t0: /* fields */ js.UndefOr[Array]) => value(t0).runNow()))
      
      inline def setSetFieldsUndefined: Self = StObject.set(x, "setFields", js.undefined)
      
      inline def setSetGrid(value: /* grid */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setGrid", js.Any.fromFunction1((t0: /* grid */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setSetLabel(value: /* label */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setLabel", js.Any.fromFunction1((t0: /* label */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetLabelInSpan(value: /* labelInSpan */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setLabelInSpan", js.Any.fromFunction1((t0: /* labelInSpan */ js.UndefOr[Boolean]) => value(t0).runNow()))
      ...
      inline def setSetLayout(value: /* layout */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setLayout", js.Any.fromFunction1((t0: /* layout */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetLayoutUndefined: Self = StObject.set(x, "setLayout", js.undefined)
      
      inline def setSetMajorTickSteps(value: /* majorTickSteps */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMajorTickSteps", js.Any.fromFunction1((t0: /* majorTickSteps */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setSetMajorTickStepsUndefined: Self = StObject.set(x, "setMajorTickSteps", js.undefined)
      
      inline def setSetMaxZoom(value: /* maxZoom */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMaxZoom", js.Any.fromFunction1((t0: /* maxZoom */ js.UndefOr[Double]) => value(t0).runNow()))
      ...
      inline def setSetMinZoom(value: /* minZoom */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMinZoom", js.Any.fromFunction1((t0: /* minZoom */ js.UndefOr[Double]) => value(t0).runNow()))
      ...
      inline def setSetMinorTickSteps(value: /* minorTickSteps */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMinorTickSteps", js.Any.fromFunction1((t0: /* minorTickSteps */ js.UndefOr[Double]) => value(t0).runNow()))
      
      inline def setSetMinorTickStepsUndefined: Self = StObject.set(x, "setMinorTickSteps", js.undefined)
      
      inline def setSetNeedHighPrecision(value: /* needHighPrecision */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setNeedHighPrecision", js.Any.fromFunction1((t0: /* needHighPrecision */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setSetNeedHighPrecisionUndefined: Self = StObject.set(x, "setNeedHighPrecision", js.undefined)
      
      inline def setSetPosition(value: /* position */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setPosition", js.Any.fromFunction1((t0: /* position */ js.UndefOr[String]) => value(t0).runNow()))
      ...
      inline def setSetSegmenter(value: /* segmenter */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setSegmenter", js.Any.fromFunction1((t0: /* segmenter */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setSetTitleMargin(value: /* titleMargin */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setTitleMargin", js.Any.fromFunction1((t0: /* titleMargin */ js.UndefOr[Double]) => value(t0).runNow()))
      ...
      inline def setSetVisibleRange(value: /* visibleRange */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setVisibleRange", js.Any.fromFunction1((t0: /* visibleRange */ js.UndefOr[Array]) => value(t0).runNow()))
  ...
  object ICategory {
    ...
    extension [Self <: ICategory](x: Self) {
      ...
      inline def setGetLayout(value: CallbackTo[String]): Self = StObject.set(x, "getLayout", value.toJsFn)
      
      inline def setGetLayoutUndefined: Self = StObject.set(x, "getLayout", js.undefined)
      
      inline def setGetSegmenter(value: CallbackTo[String]): Self = StObject.set(x, "getSegmenter", value.toJsFn)
      
      inline def setGetSegmenterUndefined: Self = StObject.set(x, "getSegmenter", js.undefined)
      
      inline def setSetLayout(value: /* layout */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setLayout", js.Any.fromFunction1((t0: /* layout */ js.UndefOr[String]) => value(t0).runNow()))
      
      inline def setSetLayoutUndefined: Self = StObject.set(x, "setLayout", js.undefined)
      
      inline def setSetSegmenter(value: /* segmenter */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setSegmenter", js.Any.fromFunction1((t0: /* segmenter */ js.UndefOr[String]) => value(t0).runNow()))
  ...
  object INumeric {
    ...
    extension [Self <: INumeric](x: Self) {
      ...
      inline def setGetAggregator(value: CallbackTo[String]): Self = StObject.set(x, "getAggregator", value.toJsFn)
      ...
      inline def setSetAggregator(value: /* aggregator */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setAggregator", js.Any.fromFunction1((t0: /* aggregator */ js.UndefOr[String]) => value(t0).runNow()))
  ...
  object ITime {
    ...
    extension [Self <: ITime](x: Self) {
      ...
      inline def setGetCalculateByLabelSize(value: CallbackTo[Boolean]): Self = StObject.set(x, "getCalculateByLabelSize", value.toJsFn)
      ...
      inline def setGetDateFormat(value: CallbackTo[Any]): Self = StObject.set(x, "getDateFormat", value.toJsFn)
      
      inline def setGetDateFormatUndefined: Self = StObject.set(x, "getDateFormat", js.undefined)
      
      inline def setGetFromDate(value: CallbackTo[Any]): Self = StObject.set(x, "getFromDate", value.toJsFn)
      
      inline def setGetFromDateUndefined: Self = StObject.set(x, "getFromDate", js.undefined)
      
      inline def setGetStep(value: CallbackTo[Array]): Self = StObject.set(x, "getStep", value.toJsFn)
      
      inline def setGetStepUndefined: Self = StObject.set(x, "getStep", js.undefined)
      
      inline def setGetToDate(value: CallbackTo[Any]): Self = StObject.set(x, "getToDate", value.toJsFn)
      
      inline def setGetToDateUndefined: Self = StObject.set(x, "getToDate", js.undefined)
      
      inline def setSetCalculateByLabelSize(value: /* calculateByLabelSize */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setCalculateByLabelSize", js.Any.fromFunction1((t0: /* calculateByLabelSize */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setSetCalculateByLabelSizeUndefined: Self = StObject.set(x, "setCalculateByLabelSize", js.undefined)
      
      inline def setSetDateFormat(value: /* dateFormat */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setDateFormat", js.Any.fromFunction1((t0: /* dateFormat */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetDateFormatUndefined: Self = StObject.set(x, "setDateFormat", js.undefined)
      
      inline def setSetFromDate(value: /* fromDate */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setFromDate", js.Any.fromFunction1((t0: /* fromDate */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetFromDateUndefined: Self = StObject.set(x, "setFromDate", js.undefined)
      
      inline def setSetStep(value: /* step */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setStep", js.Any.fromFunction1((t0: /* step */ js.UndefOr[Array]) => value(t0).runNow()))
      
      inline def setSetStepUndefined: Self = StObject.set(x, "setStep", js.undefined)
      
      inline def setSetToDate(value: /* toDate */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setToDate", js.Any.fromFunction1((t0: /* toDate */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object layout {
    ...
    object IContinuous {
      ...
      extension [Self <: IContinuous](x: Self) {
        ...
        inline def setGetAdjustMaximumByMajorUnit(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAdjustMaximumByMajorUnit", value.toJsFn)
        
        inline def setGetAdjustMaximumByMajorUnitUndefined: Self = StObject.set(x, "getAdjustMaximumByMajorUnit", js.undefined)
        
        inline def setGetAdjustMinimumByMajorUnit(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAdjustMinimumByMajorUnit", value.toJsFn)
        
        inline def setGetAdjustMinimumByMajorUnitUndefined: Self = StObject.set(x, "getAdjustMinimumByMajorUnit", js.undefined)
        
        inline def setSetAdjustMaximumByMajorUnit(value: /* adjustMaximumByMajorUnit */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAdjustMaximumByMajorUnit", js.Any.fromFunction1((t0: /* adjustMaximumByMajorUnit */ js.UndefOr[Boolean]) => value(t0).runNow()))
        
        inline def setSetAdjustMaximumByMajorUnitUndefined: Self = StObject.set(x, "setAdjustMaximumByMajorUnit", js.undefined)
        
        inline def setSetAdjustMinimumByMajorUnit(value: /* adjustMinimumByMajorUnit */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAdjustMinimumByMajorUnit", js.Any.fromFunction1((t0: /* adjustMinimumByMajorUnit */ js.UndefOr[Boolean]) => value(t0).runNow()))
        ...
        inline def setSnapEnds(
          value: (/* context */ js.UndefOr[Any], /* min */ js.UndefOr[Any], /* max */ js.UndefOr[Any], /* estStepSize */ js.UndefOr[Any]) => Callback
        ): Self = StObject.set(x, "snapEnds", js.Any.fromFunction4((t0: /* context */ js.UndefOr[Any], t1: /* min */ js.UndefOr[Any], t2: /* max */ js.UndefOr[Any], t3: /* estStepSize */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
    ...
    object IDiscrete {
      ...
      extension [Self <: IDiscrete](x: Self) {
        ...
        inline def setTrimByRange(
          value: (/* context */ js.UndefOr[Any], /* out */ js.UndefOr[Any], /* trimMin */ js.UndefOr[Any], /* trimMax */ js.UndefOr[Any]) => Callback
        ): Self = StObject.set(x, "trimByRange", js.Any.fromFunction4((t0: /* context */ js.UndefOr[Any], t1: /* out */ js.UndefOr[Any], t2: /* trimMin */ js.UndefOr[Any], t3: /* trimMax */ js.UndefOr[Any]) => (value(t0, t1, t2, t3)).runNow()))
    ...
    object ILayout {
      ...
      extension [Self <: ILayout](x: Self) {
        ...
        inline def setCalculateMajorTicks(value: /* context */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "calculateMajorTicks", js.Any.fromFunction1((t0: /* context */ js.UndefOr[Any]) => value(t0).runNow()))
        
        inline def setCalculateMajorTicksUndefined: Self = StObject.set(x, "calculateMajorTicks", js.undefined)
        
        inline def setCalculateMinorTicks(value: /* context */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "calculateMinorTicks", js.Any.fromFunction1((t0: /* context */ js.UndefOr[Any]) => value(t0).runNow()))
        
        inline def setCalculateMinorTicksUndefined: Self = StObject.set(x, "calculateMinorTicks", js.undefined)
        
        inline def setGetAxis(value: CallbackTo[IAxis]): Self = StObject.set(x, "getAxis", value.toJsFn)
        
        inline def setGetAxisUndefined: Self = StObject.set(x, "getAxis", js.undefined)
        
        inline def setProcessData(value: /* series */ js.UndefOr[ISeries] => Callback): Self = StObject.set(x, "processData", js.Any.fromFunction1((t0: /* series */ js.UndefOr[ISeries]) => value(t0).runNow()))
        
        inline def setProcessDataUndefined: Self = StObject.set(x, "processData", js.undefined)
        
        inline def setSetAxis(value: /* axis */ js.UndefOr[IAxis] => Callback): Self = StObject.set(x, "setAxis", js.Any.fromFunction1((t0: /* axis */ js.UndefOr[IAxis]) => value(t0).runNow()))
        
        inline def setSetAxisUndefined: Self = StObject.set(x, "setAxis", js.undefined)
        
        inline def setSnapEnds(
          value: (/* context */ js.UndefOr[Any], /* min */ js.UndefOr[Double], /* max */ js.UndefOr[Double], /* estStepSize */ js.UndefOr[Double]) => Callback
        ): Self = StObject.set(x, "snapEnds", js.Any.fromFunction4((t0: /* context */ js.UndefOr[Any], t1: /* min */ js.UndefOr[Double], t2: /* max */ js.UndefOr[Double], t3: /* estStepSize */ js.UndefOr[Double]) => (value(t0, t1, t2, t3)).runNow()))
        
        inline def setSnapEndsUndefined: Self = StObject.set(x, "snapEnds", js.undefined)
        
        inline def setTrimByRange(
          value: (/* context */ js.UndefOr[Any], /* out */ js.UndefOr[Any], /* trimMin */ js.UndefOr[Double], /* trimMax */ js.UndefOr[Double]) => Callback
        ): Self = StObject.set(x, "trimByRange", js.Any.fromFunction4((t0: /* context */ js.UndefOr[Any], t1: /* out */ js.UndefOr[Any], t2: /* trimMin */ js.UndefOr[Double], t3: /* trimMax */ js.UndefOr[Double]) => (value(t0, t1, t2, t3)).runNow()))
  ...
  object segmenter {
    ...
    object INames {
      ...
      extension [Self <: INames](x: Self) {
        ...
        inline def setAdd(
          value: (/* value */ js.UndefOr[Any], /* step */ js.UndefOr[Any], /* unit */ js.UndefOr[Any]) => Callback
        ): Self = StObject.set(x, "add", js.Any.fromFunction3((t0: /* value */ js.UndefOr[Any], t1: /* step */ js.UndefOr[Any], t2: /* unit */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    ...
    object INumeric {
      ...
      inline def apply(): typingsJapgolly.senchaTouch.Ext.chart.axis.segmenter.INumeric = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.chart.axis.segmenter.INumeric]
      }
      
      extension [Self <: typingsJapgolly.senchaTouch.Ext.chart.axis.segmenter.INumeric](x: Self) {
    ...
    object ISegmenter {
      ...
      extension [Self <: ISegmenter](x: Self) {
        ...
        inline def setAdd(
          value: (/* value */ js.UndefOr[Any], /* step */ js.UndefOr[Double], /* unit */ js.UndefOr[Any]) => Callback
        ): Self = StObject.set(x, "add", js.Any.fromFunction3((t0: /* value */ js.UndefOr[Any], t1: /* step */ js.UndefOr[Double], t2: /* unit */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    ...
    object ITime {
      ...
      inline def apply(): typingsJapgolly.senchaTouch.Ext.chart.axis.segmenter.ITime = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.chart.axis.segmenter.ITime]
      }
      
      extension [Self <: typingsJapgolly.senchaTouch.Ext.chart.axis.segmenter.ITime](x: Self) {
        ...
        inline def setGetStep(value: CallbackTo[Any]): Self = StObject.set(x, "getStep", value.toJsFn)
        
        inline def setGetStepUndefined: Self = StObject.set(x, "getStep", js.undefined)
        
        inline def setSetStep(value: /* step */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setStep", js.Any.fromFunction1((t0: /* step */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object sprite {
    ...
    - typingsJapgolly.senchaTouch.Ext.chart.IMarkerHolder because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined bindMarker */ trait IAxis
      extends StObject
         with ISprite {
      ...
      /** [Config Option] (Ext.chart.axis.Axis) */
      var axis: js.UndefOr[typingsJapgolly.senchaTouch.Ext.chart.axis.IAxis] = js.undefined
    ...
    object IAxis {
      ...
      inline def apply(): typingsJapgolly.senchaTouch.Ext.chart.axis.sprite.IAxis = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.chart.axis.sprite.IAxis]
      }
      
      extension [Self <: typingsJapgolly.senchaTouch.Ext.chart.axis.sprite.IAxis](x: Self) {
        
        inline def setAxis(value: typingsJapgolly.senchaTouch.Ext.chart.axis.IAxis): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
        ...
        inline def setBindMarker(value: (js.UndefOr[String], js.UndefOr[IMarkers]) => Callback): Self = StObject.set(x, "bindMarker", js.Any.fromFunction2((t0: js.UndefOr[String], t1: js.UndefOr[IMarkers]) => (value(t0, t1)).runNow()))
        ...
        inline def setGetAxis(value: CallbackTo[typingsJapgolly.senchaTouch.Ext.chart.axis.sprite.IAxis]): Self = StObject.set(x, "getAxis", value.toJsFn)
        
        inline def setGetAxisUndefined: Self = StObject.set(x, "getAxis", js.undefined)
        
        inline def setGetBBox(value: Callback): Self = StObject.set(x, "getBBox", value.toJsFn)
        ...
        inline def setSetAxis(value: /* axis */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.chart.axis.sprite.IAxis] => Callback): Self = StObject.set(x, "setAxis", js.Any.fromFunction1((t0: /* axis */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.chart.axis.sprite.IAxis]) => value(t0).runNow()))
        ...
        inline def setSetRenderer(value: /* renderer */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setRenderer", js.Any.fromFunction1((t0: /* renderer */ js.UndefOr[Any]) => value(t0).runNow()))
