...
object IDomHelper {
  ...
  def apply(
    ...
    insertHtml: (/* where */ js.UndefOr[java.lang.String], /* el */ js.UndefOr[js.Any], /* html */ js.UndefOr[java.lang.String]) => CallbackTo[HTMLElement] = null,
    markup: /* spec */ js.UndefOr[js.Any] => CallbackTo[java.lang.String] = null,
