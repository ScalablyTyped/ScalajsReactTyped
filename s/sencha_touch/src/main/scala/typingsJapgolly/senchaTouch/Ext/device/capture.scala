...
object capture {
  ...
  object IAbstract {
    ...
    extension [Self <: IAbstract](x: Self) {
      ...
      inline def setCaptureAudio(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "captureAudio", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setCaptureAudioUndefined: Self = StObject.set(x, "captureAudio", js.undefined)
      
      inline def setCaptureVideo(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "captureVideo", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
