...
object IContainer {
  ...
  def apply(
    ...
    add: /* newItems */ js.UndefOr[js.Any] => CallbackTo[IComponent] = null,
    ...
    child: /* selector */ js.UndefOr[java.lang.String] => CallbackTo[IComponent] = null,
    control: js.Any = null,
    defaultType: java.lang.String = null,
    defaults: js.Any = null,
    down: /* selector */ js.UndefOr[java.lang.String] => CallbackTo[IComponent] = null,
    getActiveItem: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getAt: /* index */ js.UndefOr[Double] => CallbackTo[IComponent] = null,
    getAutoDestroy: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    getComponent: /* component */ js.UndefOr[js.Any] => CallbackTo[IComponent] = null,
    getControl: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getDefaultType: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    ...
    remove: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => CallbackTo[IComponent] = null,
    removeAll: (/* destroy */ js.UndefOr[Boolean], /* everything */ js.UndefOr[Boolean]) => CallbackTo[IComponent] = null,
    removeAt: /* index */ js.UndefOr[Double] => CallbackTo[IContainer] = null,
    removeDocked: (/* item */ js.UndefOr[js.Any], /* destroy */ js.UndefOr[Boolean]) => CallbackTo[IComponent] = null,
    ...
    setDefaultType: /* defaultType */ js.UndefOr[java.lang.String] => Callback = null,
