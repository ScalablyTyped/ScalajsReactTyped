...
object IContainer {
  ...
  extension [Self <: IContainer](x: Self) {
    ...
    inline def setAnimateActiveItem(value: (/* activeItem */ js.UndefOr[Any], /* animation */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "animateActiveItem", js.Any.fromFunction2((t0: /* activeItem */ js.UndefOr[Any], t1: /* animation */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setGetActiveItem(value: CallbackTo[Any]): Self = StObject.set(x, "getActiveItem", value.toJsFn)
    ...
    inline def setGetAutoDestroy(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAutoDestroy", value.toJsFn)
    ...
    inline def setGetDefaultType(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getDefaultType", value.toJsFn)
    ...
    inline def setGetDockedItems(value: CallbackTo[Array]): Self = StObject.set(x, "getDockedItems", value.toJsFn)
    
    inline def setGetDockedItemsUndefined: Self = StObject.set(x, "getDockedItems", js.undefined)
    
    inline def setGetHideOnMaskTap(value: CallbackTo[Boolean]): Self = StObject.set(x, "getHideOnMaskTap", value.toJsFn)
    
    inline def setGetHideOnMaskTapUndefined: Self = StObject.set(x, "getHideOnMaskTap", js.undefined)
    
    inline def setGetInnerItems(value: CallbackTo[Array]): Self = StObject.set(x, "getInnerItems", value.toJsFn)
    
    inline def setGetInnerItemsUndefined: Self = StObject.set(x, "getInnerItems", js.undefined)
    
    inline def setGetItems(value: CallbackTo[Any]): Self = StObject.set(x, "getItems", value.toJsFn)
    
    inline def setGetItemsUndefined: Self = StObject.set(x, "getItems", js.undefined)
    
    inline def setGetMasked(value: CallbackTo[Any]): Self = StObject.set(x, "getMasked", value.toJsFn)
    
    inline def setGetMaskedUndefined: Self = StObject.set(x, "getMasked", js.undefined)
    
    inline def setGetModal(value: CallbackTo[Boolean]): Self = StObject.set(x, "getModal", value.toJsFn)
    
    inline def setGetModalUndefined: Self = StObject.set(x, "getModal", js.undefined)
    
    inline def setGetScrollable(value: CallbackTo[IView]): Self = StObject.set(x, "getScrollable", value.toJsFn)
    ...
    inline def setInsert(value: (/* index */ js.UndefOr[Double], /* item */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "insert", js.Any.fromFunction2((t0: /* index */ js.UndefOr[Double], t1: /* item */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    ...
    inline def setMask(value: /* mask */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "mask", js.Any.fromFunction1((t0: /* mask */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetActiveItem(value: /* activeItem */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setActiveItem", js.Any.fromFunction1((t0: /* activeItem */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetActiveItemUndefined: Self = StObject.set(x, "setActiveItem", js.undefined)
    
    inline def setSetAutoDestroy(value: /* autoDestroy */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAutoDestroy", js.Any.fromFunction1((t0: /* autoDestroy */ js.UndefOr[Boolean]) => value(t0).runNow()))
    ...
    inline def setSetDefaultType(value: /* defaultType */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setDefaultType", js.Any.fromFunction1((t0: /* defaultType */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
    ...
    inline def setSetHideOnMaskTap(value: /* hideOnMaskTap */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setHideOnMaskTap", js.Any.fromFunction1((t0: /* hideOnMaskTap */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetHideOnMaskTapUndefined: Self = StObject.set(x, "setHideOnMaskTap", js.undefined)
    
    inline def setSetItems(value: /* items */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setItems", js.Any.fromFunction1((t0: /* items */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetMasked(value: /* masked */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setMasked", js.Any.fromFunction1((t0: /* masked */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetMaskedUndefined: Self = StObject.set(x, "setMasked", js.undefined)
    
    inline def setSetModal(value: /* modal */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setModal", js.Any.fromFunction1((t0: /* modal */ js.UndefOr[Boolean]) => value(t0).runNow()))
