...
object IItem {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IItem]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IItem] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IItem] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IItem], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.carousel.IItem], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
