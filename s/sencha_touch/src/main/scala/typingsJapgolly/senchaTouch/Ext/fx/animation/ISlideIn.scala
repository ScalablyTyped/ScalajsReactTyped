...
object ISlideIn {
  ...
  def apply(
    ...
    getIsElementBoxFit: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    getUseCssTransform: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    setContainerBox: /* containerBox */ js.UndefOr[String] => Callback = null,
    ...
    setElementBox: /* elementBox */ js.UndefOr[String] => Callback = null,
    setIsElementBoxFit: /* isElementBoxFit */ js.UndefOr[Boolean] => Callback = null,
    ...
    setOffset: /* offset */ js.UndefOr[Double] => Callback = null,
    ...
    setUseCssTransform: /* useCssTransform */ js.UndefOr[Boolean] => Callback = null,
    ...
    getIsElementBoxFit.foreach(p => __obj.updateDynamic("getIsElementBoxFit")(p.toJsFn))
    ...
    getUseCssTransform.foreach(p => __obj.updateDynamic("getUseCssTransform")(p.toJsFn))
    ...
    if (setContainerBox != null) __obj.updateDynamic("setContainerBox")(js.Any.fromFunction1((t0: /* containerBox */ js.UndefOr[java.lang.String]) => setContainerBox(t0).runNow()))
    ...
    if (setElementBox != null) __obj.updateDynamic("setElementBox")(js.Any.fromFunction1((t0: /* elementBox */ js.UndefOr[java.lang.String]) => setElementBox(t0).runNow()))
    if (setIsElementBoxFit != null) __obj.updateDynamic("setIsElementBoxFit")(js.Any.fromFunction1((t0: /* isElementBoxFit */ js.UndefOr[scala.Boolean]) => setIsElementBoxFit(t0).runNow()))
    ...
    if (setOffset != null) __obj.updateDynamic("setOffset")(js.Any.fromFunction1((t0: /* offset */ js.UndefOr[scala.Double]) => setOffset(t0).runNow()))
    ...
    if (setUseCssTransform != null) __obj.updateDynamic("setUseCssTransform")(js.Any.fromFunction1((t0: /* useCssTransform */ js.UndefOr[scala.Boolean]) => setUseCssTransform(t0).runNow()))
