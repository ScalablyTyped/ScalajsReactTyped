...
object ISeries {
  ...
  extension [Self <: ISeries](x: Self) {
    ...
    inline def setGetAnimate(value: CallbackTo[Any]): Self = StObject.set(x, "getAnimate", value.toJsFn)
    ...
    inline def setGetColors(value: CallbackTo[Array]): Self = StObject.set(x, "getColors", value.toJsFn)
    
    inline def setGetColorsUndefined: Self = StObject.set(x, "getColors", js.undefined)
    
    inline def setGetHidden(value: CallbackTo[Any]): Self = StObject.set(x, "getHidden", value.toJsFn)
    
    inline def setGetHiddenUndefined: Self = StObject.set(x, "getHidden", js.undefined)
    
    inline def setGetHighlightCfg(value: CallbackTo[Any]): Self = StObject.set(x, "getHighlightCfg", value.toJsFn)
    
    inline def setGetHighlightCfgUndefined: Self = StObject.set(x, "getHighlightCfg", js.undefined)
    
    inline def setGetHighlightItem(value: CallbackTo[Any]): Self = StObject.set(x, "getHighlightItem", value.toJsFn)
    ...
    inline def setGetItemInstancing(value: CallbackTo[Any]): Self = StObject.set(x, "getItemInstancing", value.toJsFn)
    ...
    inline def setGetLabelField(value: CallbackTo[Any]): Self = StObject.set(x, "getLabelField", value.toJsFn)
    
    inline def setGetLabelFieldUndefined: Self = StObject.set(x, "getLabelField", js.undefined)
    
    inline def setGetLabelOverflowPadding(value: CallbackTo[Double]): Self = StObject.set(x, "getLabelOverflowPadding", value.toJsFn)
    ...
    inline def setGetMarker(value: CallbackTo[Any]): Self = StObject.set(x, "getMarker", value.toJsFn)
    
    inline def setGetMarkerSubStyle(value: CallbackTo[Any]): Self = StObject.set(x, "getMarkerSubStyle", value.toJsFn)
    ...
    inline def setGetOverlaySurface(value: CallbackTo[Any]): Self = StObject.set(x, "getOverlaySurface", value.toJsFn)
    ...
    inline def setGetShowInLegend(value: CallbackTo[Boolean]): Self = StObject.set(x, "getShowInLegend", value.toJsFn)
    
    inline def setGetShowInLegendUndefined: Self = StObject.set(x, "getShowInLegend", js.undefined)
    
    inline def setGetSprites(value: Callback): Self = StObject.set(x, "getSprites", value.toJsFn)
    ...
    inline def setGetSubStyle(value: CallbackTo[Any]): Self = StObject.set(x, "getSubStyle", value.toJsFn)
    ...
    inline def setProvideLegendInfo(value: /* target */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "provideLegendInfo", js.Any.fromFunction1((t0: /* target */ js.UndefOr[Array]) => value(t0).runNow()))
    ...
    inline def setSetAnimate(value: /* animate */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setAnimate", js.Any.fromFunction1((t0: /* animate */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetColors(value: /* colors */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setColors", js.Any.fromFunction1((t0: /* colors */ js.UndefOr[Array]) => value(t0).runNow()))
    
    inline def setSetColorsUndefined: Self = StObject.set(x, "setColors", js.undefined)
    
    inline def setSetHidden(value: /* hidden */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setHidden", js.Any.fromFunction1((t0: /* hidden */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetHiddenByIndex(value: (/* index */ js.UndefOr[Double], /* value */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "setHiddenByIndex", js.Any.fromFunction2((t0: /* index */ js.UndefOr[Double], t1: /* value */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
    ...
    inline def setSetHighlightCfg(value: /* highlightCfg */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setHighlightCfg", js.Any.fromFunction1((t0: /* highlightCfg */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetHighlightCfgUndefined: Self = StObject.set(x, "setHighlightCfg", js.undefined)
    
    inline def setSetHighlightItem(value: /* highlightItem */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setHighlightItem", js.Any.fromFunction1((t0: /* highlightItem */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetHighlightItemUndefined: Self = StObject.set(x, "setHighlightItem", js.undefined)
    
    inline def setSetItemInstancing(value: /* itemInstancing */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setItemInstancing", js.Any.fromFunction1((t0: /* itemInstancing */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetLabelField(value: /* labelField */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setLabelField", js.Any.fromFunction1((t0: /* labelField */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetLabelFieldUndefined: Self = StObject.set(x, "setLabelField", js.undefined)
    
    inline def setSetLabelOverflowPadding(value: /* labelOverflowPadding */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setLabelOverflowPadding", js.Any.fromFunction1((t0: /* labelOverflowPadding */ js.UndefOr[Double]) => value(t0).runNow()))
    ...
    inline def setSetMarker(value: /* marker */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setMarker", js.Any.fromFunction1((t0: /* marker */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetMarkerSubStyle(value: /* markerSubStyle */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setMarkerSubStyle", js.Any.fromFunction1((t0: /* markerSubStyle */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetOverlaySurface(value: /* overlaySurface */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setOverlaySurface", js.Any.fromFunction1((t0: /* overlaySurface */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetShowInLegend(value: /* showInLegend */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setShowInLegend", js.Any.fromFunction1((t0: /* showInLegend */ js.UndefOr[Boolean]) => value(t0).runNow()))
    ...
    inline def setSetSubStyle(value: /* subStyle */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setSubStyle", js.Any.fromFunction1((t0: /* subStyle */ js.UndefOr[Any]) => value(t0).runNow()))
