...
object IIndexBar {
  ...
  def apply(
    ...
    getListPrefix: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    setListPrefix: /* listPrefix */ js.UndefOr[String] => Callback = null,
    ...
    showBy: (/* component */ js.UndefOr[IIndexBar], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.IIndexBar], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
