package typingsJapgolly.senchaTouch.Ext.plugin
...
import typingsJapgolly.senchaTouch.Ext.dataview.IList
...
object IPullRefresh {
  ...
  def apply(
    ...
    addCls: (/* cls */ js.UndefOr[String], /* prefix */ js.UndefOr[String], /* suffix */ js.UndefOr[String]) => Callback = null,
    ...
    getAutoSnapBack: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    getBaseCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getDisabledCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    getDocked: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getFloatingCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    getHeight: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getHidden: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    getHiddenCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getItemId: js.UndefOr[CallbackTo[String]] = js.undefined,
    getLastUpdatedDateFormat: js.UndefOr[CallbackTo[String]] = js.undefined,
    getLastUpdatedText: js.UndefOr[CallbackTo[String]] = js.undefined,
    getLeft: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getList: js.UndefOr[CallbackTo[IList]] = js.undefined,
    getListeners: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getLoadedText: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getOverpullSnapBackDuration: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getPadding: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getParent: js.UndefOr[CallbackTo[IPullRefresh]] = js.undefined,
    getPlugins: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getPullText: js.UndefOr[CallbackTo[String]] = js.undefined,
    getPullTpl: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getRecord: js.UndefOr[CallbackTo[IModel]] = js.undefined,
    getReleaseText: js.UndefOr[CallbackTo[String]] = js.undefined,
    getRenderTo: js.UndefOr[CallbackTo[typingsJapgolly.senchaTouch.Ext.IElement]] = js.undefined,
    getRight: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getScrollerAutoRefresh: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    getShowAnimation: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getSize: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getSnappingAnimationDuration: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getStyle: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getStyleHtmlCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getTplWriteMode: js.UndefOr[CallbackTo[String]] = js.undefined,
    getTranslatable: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    getUi: js.UndefOr[CallbackTo[String]] = js.undefined,
    getWidth: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getXTypes: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IPullRefresh] = null,
    ...
    isXType: (/* xtype */ js.UndefOr[String], /* shallow */ js.UndefOr[Boolean]) => CallbackTo[Boolean] = null,
    itemId: String = null,
    ...
    removeCls: (/* cls */ js.UndefOr[String], /* prefix */ js.UndefOr[String], /* suffix */ js.UndefOr[String]) => Callback = null,
    ...
    renderTo: typingsJapgolly.senchaTouch.Ext.IElement = null,
    replaceCls: (/* oldCls */ js.UndefOr[String], /* newCls */ js.UndefOr[String], /* prefix */ js.UndefOr[String], /* suffix */ js.UndefOr[String]) => Callback = null,
    ...
    self: IClass = null,
    setAutoSnapBack: /* autoSnapBack */ js.UndefOr[Boolean] => Callback = null,
    setBaseCls: /* baseCls */ js.UndefOr[String] => Callback = null,
    ...
    setDisabledCls: /* disabledCls */ js.UndefOr[String] => Callback = null,
    setDocked: /* docked */ js.UndefOr[String] => Callback = null,
    ...
    setFloatingCls: /* floatingCls */ js.UndefOr[String] => Callback = null,
    setHeight: /* height */ js.UndefOr[js.Any] => Callback = null,
    setHidden: /* hidden */ js.UndefOr[Boolean] => Callback = null,
    setHiddenCls: /* hiddenCls */ js.UndefOr[String] => Callback = null,
    setHideAnimation: /* hideAnimation */ js.UndefOr[js.Any] => Callback = null,
    setHtml: /* html */ js.UndefOr[js.Any] => Callback = null,
    setItemId: /* itemId */ js.UndefOr[String] => Callback = null,
    setLastUpdatedDateFormat: /* lastUpdatedDateFormat */ js.UndefOr[String] => Callback = null,
    setLastUpdatedText: /* lastUpdatedText */ js.UndefOr[String] => Callback = null,
    setLeft: /* left */ js.UndefOr[js.Any] => Callback = null,
    setList: /* list */ js.UndefOr[IList] => Callback = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => Callback = null,
    setLoadedText: /* loadedText */ js.UndefOr[String] => Callback = null,
    ...
    setOverpullSnapBackDuration: /* overpullSnapBackDuration */ js.UndefOr[Double] => Callback = null,
    setPadding: /* padding */ js.UndefOr[js.Any] => Callback = null,
    setPlugins: /* plugins */ js.UndefOr[js.Any] => Callback = null,
    setPullRefreshText: /* text */ js.UndefOr[String] => Callback = null,
    setPullText: /* pullText */ js.UndefOr[String] => Callback = null,
    setPullTpl: /* pullTpl */ js.UndefOr[js.Any] => Callback = null,
    setRecord: /* record */ js.UndefOr[IModel] => Callback = null,
    setReleaseRefreshText: /* text */ js.UndefOr[String] => Callback = null,
    setReleaseText: /* releaseText */ js.UndefOr[String] => Callback = null,
    setRenderTo: /* renderTo */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IElement] => Callback = null,
    setRight: /* right */ js.UndefOr[js.Any] => Callback = null,
    setScrollable: js.UndefOr[Callback] = js.undefined,
    setScrollerAutoRefresh: /* scrollerAutoRefresh */ js.UndefOr[Boolean] => Callback = null,
    ...
    setSnappingAnimationDuration: /* snappingAnimationDuration */ js.UndefOr[Double] => Callback = null,
    setStyle: /* style */ js.UndefOr[js.Any] => Callback = null,
    setStyleHtmlCls: /* styleHtmlCls */ js.UndefOr[String] => Callback = null,
    ...
    setTplWriteMode: /* tplWriteMode */ js.UndefOr[String] => Callback = null,
    setTranslatable: /* translatable */ js.UndefOr[Boolean] => Callback = null,
    setUi: /* ui */ js.UndefOr[String] => Callback = null,
    setWidth: /* width */ js.UndefOr[js.Any] => Callback = null,
    setZIndex: /* zIndex */ js.UndefOr[Double] => Callback = null,
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IPullRefresh] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IPullRefresh], /* alignment */ js.UndefOr[String]) => Callback = null,
    singleton: js.UndefOr[Boolean] = js.undefined,
    snapBack: /* force */ js.UndefOr[Boolean] => Callback = null,
    ...
    up: /* selector */ js.UndefOr[String] => CallbackTo[IContainer] = null,
    ...
    getAutoSnapBack.foreach(p => __obj.updateDynamic("getAutoSnapBack")(p.toJsFn))
    ...
    getLastUpdatedDateFormat.foreach(p => __obj.updateDynamic("getLastUpdatedDateFormat")(p.toJsFn))
    getLastUpdatedText.foreach(p => __obj.updateDynamic("getLastUpdatedText")(p.toJsFn))
    getLeft.foreach(p => __obj.updateDynamic("getLeft")(p.toJsFn))
    getList.foreach(p => __obj.updateDynamic("getList")(p.toJsFn))
    getListeners.foreach(p => __obj.updateDynamic("getListeners")(p.toJsFn))
    getLoadedText.foreach(p => __obj.updateDynamic("getLoadedText")(p.toJsFn))
    ...
    getOverpullSnapBackDuration.foreach(p => __obj.updateDynamic("getOverpullSnapBackDuration")(p.toJsFn))
    ...
    getPullText.foreach(p => __obj.updateDynamic("getPullText")(p.toJsFn))
    getPullTpl.foreach(p => __obj.updateDynamic("getPullTpl")(p.toJsFn))
    getRecord.foreach(p => __obj.updateDynamic("getRecord")(p.toJsFn))
    getReleaseText.foreach(p => __obj.updateDynamic("getReleaseText")(p.toJsFn))
    getRenderTo.foreach(p => __obj.updateDynamic("getRenderTo")(p.toJsFn))
    getRight.foreach(p => __obj.updateDynamic("getRight")(p.toJsFn))
    getScrollerAutoRefresh.foreach(p => __obj.updateDynamic("getScrollerAutoRefresh")(p.toJsFn))
    ...
    getSnappingAnimationDuration.foreach(p => __obj.updateDynamic("getSnappingAnimationDuration")(p.toJsFn))
    ...
    if (setAutoSnapBack != null) __obj.updateDynamic("setAutoSnapBack")(js.Any.fromFunction1((t0: /* autoSnapBack */ js.UndefOr[scala.Boolean]) => setAutoSnapBack(t0).runNow()))
    ...
    if (setLastUpdatedDateFormat != null) __obj.updateDynamic("setLastUpdatedDateFormat")(js.Any.fromFunction1((t0: /* lastUpdatedDateFormat */ js.UndefOr[java.lang.String]) => setLastUpdatedDateFormat(t0).runNow()))
    if (setLastUpdatedText != null) __obj.updateDynamic("setLastUpdatedText")(js.Any.fromFunction1((t0: /* lastUpdatedText */ js.UndefOr[java.lang.String]) => setLastUpdatedText(t0).runNow()))
    if (setLeft != null) __obj.updateDynamic("setLeft")(js.Any.fromFunction1((t0: /* left */ js.UndefOr[js.Any]) => setLeft(t0).runNow()))
    if (setList != null) __obj.updateDynamic("setList")(js.Any.fromFunction1((t0: /* list */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.IList]) => setList(t0).runNow()))
    ...
    if (setLoadedText != null) __obj.updateDynamic("setLoadedText")(js.Any.fromFunction1((t0: /* loadedText */ js.UndefOr[java.lang.String]) => setLoadedText(t0).runNow()))
    ...
    if (setOverpullSnapBackDuration != null) __obj.updateDynamic("setOverpullSnapBackDuration")(js.Any.fromFunction1((t0: /* overpullSnapBackDuration */ js.UndefOr[scala.Double]) => setOverpullSnapBackDuration(t0).runNow()))
    ...
    if (setPullRefreshText != null) __obj.updateDynamic("setPullRefreshText")(js.Any.fromFunction1((t0: /* text */ js.UndefOr[java.lang.String]) => setPullRefreshText(t0).runNow()))
    if (setPullText != null) __obj.updateDynamic("setPullText")(js.Any.fromFunction1((t0: /* pullText */ js.UndefOr[java.lang.String]) => setPullText(t0).runNow()))
    if (setPullTpl != null) __obj.updateDynamic("setPullTpl")(js.Any.fromFunction1((t0: /* pullTpl */ js.UndefOr[js.Any]) => setPullTpl(t0).runNow()))
    ...
    if (setReleaseRefreshText != null) __obj.updateDynamic("setReleaseRefreshText")(js.Any.fromFunction1((t0: /* text */ js.UndefOr[java.lang.String]) => setReleaseRefreshText(t0).runNow()))
    if (setReleaseText != null) __obj.updateDynamic("setReleaseText")(js.Any.fromFunction1((t0: /* releaseText */ js.UndefOr[java.lang.String]) => setReleaseText(t0).runNow()))
    ...
    if (setScrollerAutoRefresh != null) __obj.updateDynamic("setScrollerAutoRefresh")(js.Any.fromFunction1((t0: /* scrollerAutoRefresh */ js.UndefOr[scala.Boolean]) => setScrollerAutoRefresh(t0).runNow()))
    ...
    if (setSnappingAnimationDuration != null) __obj.updateDynamic("setSnappingAnimationDuration")(js.Any.fromFunction1((t0: /* snappingAnimationDuration */ js.UndefOr[scala.Double]) => setSnappingAnimationDuration(t0).runNow()))
    ...
    if (setTranslatable != null) __obj.updateDynamic("setTranslatable")(js.Any.fromFunction1((t0: /* translatable */ js.UndefOr[scala.Boolean]) => setTranslatable(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.plugin.IPullRefresh], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
    if (!js.isUndefined(singleton)) __obj.updateDynamic("singleton")(singleton.asInstanceOf[js.Any])
    if (snapBack != null) __obj.updateDynamic("snapBack")(js.Any.fromFunction1((t0: /* force */ js.UndefOr[scala.Boolean]) => snapBack(t0).runNow()))
