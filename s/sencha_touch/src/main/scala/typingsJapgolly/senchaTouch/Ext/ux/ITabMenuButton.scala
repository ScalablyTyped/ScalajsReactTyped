...
object ITabMenuButton {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[ITabMenuButton]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ITabMenuButton] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ITabMenuButton] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ITabMenuButton], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.ux.ITabMenuButton], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
