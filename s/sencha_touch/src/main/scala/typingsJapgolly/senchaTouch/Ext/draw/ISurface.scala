...
object ISurface {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[ISurface]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISurface] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISurface] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISurface], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    uses: Array = null,
    waitFor: /* surface */ js.UndefOr[ISurface] => Callback = null,
    width: js.Any = null,
    xtype: String = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.ISurface], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
    ...
    if (waitFor != null) __obj.updateDynamic("waitFor")(js.Any.fromFunction1((t0: /* surface */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.ISurface]) => waitFor(t0).runNow()))
