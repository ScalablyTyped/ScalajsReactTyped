...
trait ISurface
  extends StObject
     with typingsJapgolly.senchaTouch.Ext.IComponent {
...
object ISurface {
  ...
  extension [Self <: ISurface](x: Self) {
    ...
    inline def setGetDirty(value: CallbackTo[Boolean]): Self = StObject.set(x, "getDirty", value.toJsFn)
    ...
    inline def setGetGroups(value: CallbackTo[Array]): Self = StObject.set(x, "getGroups", value.toJsFn)
    
    inline def setGetGroupsUndefined: Self = StObject.set(x, "getGroups", js.undefined)
    
    inline def setGetItems(value: CallbackTo[IGroup]): Self = StObject.set(x, "getItems", value.toJsFn)
    ...
    inline def setOnAdd(value: /* sprite */ js.UndefOr[ISprite] => Callback): Self = StObject.set(x, "onAdd", js.Any.fromFunction1((t0: /* sprite */ js.UndefOr[ISprite]) => value(t0).runNow()))
    ...
    inline def setResetTransform(value: Callback): Self = StObject.set(x, "resetTransform", value.toJsFn)
    ...
    inline def setSetGroups(value: /* groups */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setGroups", js.Any.fromFunction1((t0: /* groups */ js.UndefOr[Array]) => value(t0).runNow()))
    
    inline def setSetGroupsUndefined: Self = StObject.set(x, "setGroups", js.undefined)
    
    inline def setSetItems(value: /* items */ js.UndefOr[IGroup] => Callback): Self = StObject.set(x, "setItems", js.Any.fromFunction1((t0: /* items */ js.UndefOr[IGroup]) => value(t0).runNow()))
    ...
    inline def setWaitFor(value: /* surface */ js.UndefOr[ISurface] => Callback): Self = StObject.set(x, "waitFor", js.Any.fromFunction1((t0: /* surface */ js.UndefOr[ISurface]) => value(t0).runNow()))
