...
object IProduct {
  ...
  def apply(
    ...
    config: js.Any = null,
    copy: /* id */ js.UndefOr[String] => CallbackTo[IProduct] = null,
    ...
    erase: (/* options */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[IProduct] = null,
    extend: String = null,
    fields: js.Any = null,
    ...
    proxy: js.Any = null,
    purchase: /* config */ js.UndefOr[js.Any] => Callback = null,
    raw: js.Any = null,
    ...
    save: (/* options */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[IProduct] = null,
    self: IClass = null,
    ...
    setConvertedData: /* data */ js.UndefOr[js.Any] => CallbackTo[IProduct] = null,
    setData: /* rawData */ js.UndefOr[js.Any] => CallbackTo[IProduct] = null,
    ...
    if (purchase != null) __obj.updateDynamic("purchase")(js.Any.fromFunction1((t0: /* config */ js.UndefOr[js.Any]) => purchase(t0).runNow()))
