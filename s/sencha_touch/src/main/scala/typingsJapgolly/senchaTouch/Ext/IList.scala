...
trait IList
  extends typingsJapgolly.senchaTouch.Ext.dataview.IDataView {
  /** [Property] (Number) */
...
object IList {
  @scala.inline
  def apply(
    IDataView: typingsJapgolly.senchaTouch.Ext.dataview.IDataView = null,
    bufferSize: Int | Double = null,
    disclosureProperty: java.lang.String = null,
    getDisclosureProperty: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    ...
    setDisclosureProperty: /* disclosureProperty */ js.UndefOr[java.lang.String] => Callback = null,
