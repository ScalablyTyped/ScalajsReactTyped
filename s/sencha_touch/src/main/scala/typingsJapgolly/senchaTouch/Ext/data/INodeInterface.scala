...
object INodeInterface {
  ...
  extension [Self <: INodeInterface](x: Self) {
    ...
    ): Self = StObject.set(x, "collapse", js.Any.fromFunction3((t0: /* recursive */ js.UndefOr[Any], t1: /* callback */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setExpand(
      value: (/* recursive */ js.UndefOr[Any], /* callback */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "expand", js.Any.fromFunction3((t0: /* recursive */ js.UndefOr[Any], t1: /* callback */ js.UndefOr[Any], t2: /* scope */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setSort(
      value: (/* sortFn */ js.UndefOr[Any], /* recursive */ js.UndefOr[Boolean], /* suppressEvent */ js.UndefOr[Boolean]) => Callback
    ): Self = StObject.set(x, "sort", js.Any.fromFunction3((t0: /* sortFn */ js.UndefOr[Any], t1: /* recursive */ js.UndefOr[Boolean], t2: /* suppressEvent */ js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
