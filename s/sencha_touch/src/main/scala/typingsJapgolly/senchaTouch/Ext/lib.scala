...
object lib {
  ...
  trait IComponent
    ...
    var up: js.UndefOr[
        js.Function1[
          ...
          typingsJapgolly.senchaTouch.Ext.IContainer
        ]
      ] = js.undefined
  ...
  object IComponent {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.lib.IComponent = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.lib.IComponent]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.lib.IComponent](x: Self) {
      ...
      inline def setGetParent(value: CallbackTo[typingsJapgolly.senchaTouch.Ext.lib.IComponent]): Self = StObject.set(x, "getParent", value.toJsFn)
      ...
      inline def setHide(value: /* animation */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.lib.IComponent): Self = StObject.set(x, "hide", js.Any.fromFunction1(value))
      ...
      inline def setShow(value: /* animation */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.lib.IComponent): Self = StObject.set(x, "show", js.Any.fromFunction1(value))
      ...
      inline def setShowBy(
        value: (/* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.lib.IComponent], /* alignment */ js.UndefOr[java.lang.String]) => Callback
      ): Self = StObject.set(x, "showBy", js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.lib.IComponent], t1: /* alignment */ js.UndefOr[java.lang.String]) => (value(t0, t1)).runNow()))
      ...
      inline def setUp(value: /* selector */ js.UndefOr[java.lang.String] => typingsJapgolly.senchaTouch.Ext.IContainer): Self = StObject.set(x, "up", js.Any.fromFunction1(value))
  ...
  trait IContainer
    ...
    /** [Method] Adds one or more Components to this Container
      ...
      */
    var add: js.UndefOr[
        js.Function1[/* newItems */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.IComponent]
      ] = js.undefined
    ...
    var getComponent: js.UndefOr[
        js.Function1[/* component */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.IComponent]
      ] = js.undefined
  ...
  object IContainer {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.lib.IContainer = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.lib.IContainer]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.lib.IContainer](x: Self) {
      ...
      inline def setAdd(value: /* newItems */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.IComponent): Self = StObject.set(x, "add", js.Any.fromFunction1(value))
      ...
      inline def setChild(value: /* selector */ js.UndefOr[java.lang.String] => typingsJapgolly.senchaTouch.Ext.IComponent): Self = StObject.set(x, "child", js.Any.fromFunction1(value))
      ...
      inline def setDown(value: /* selector */ js.UndefOr[java.lang.String] => typingsJapgolly.senchaTouch.Ext.IComponent): Self = StObject.set(x, "down", js.Any.fromFunction1(value))
      ...
      inline def setGetAt(value: /* index */ js.UndefOr[Double] => typingsJapgolly.senchaTouch.Ext.IComponent): Self = StObject.set(x, "getAt", js.Any.fromFunction1(value))
      ...
      inline def setGetComponent(value: /* component */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.IComponent): Self = StObject.set(x, "getComponent", js.Any.fromFunction1(value))
      ...
      inline def setHide(value: CallbackTo[typingsJapgolly.senchaTouch.Ext.IComponent]): Self = StObject.set(x, "hide", value.toJsFn)
      ...
      inline def setRemove(
        value: (/* item */ js.UndefOr[Any], /* destroy */ js.UndefOr[Boolean]) => typingsJapgolly.senchaTouch.Ext.IComponent
      ): Self = StObject.set(x, "remove", js.Any.fromFunction2(value))
      
      inline def setRemoveAll(
        value: (/* destroy */ js.UndefOr[Boolean], /* everything */ js.UndefOr[Boolean]) => typingsJapgolly.senchaTouch.Ext.IComponent
      ...
      inline def setRemoveAt(value: /* index */ js.UndefOr[Double] => typingsJapgolly.senchaTouch.Ext.lib.IContainer): Self = StObject.set(x, "removeAt", js.Any.fromFunction1(value))
      ...
      inline def setRemoveInnerAt(value: /* index */ js.UndefOr[Double] => typingsJapgolly.senchaTouch.Ext.lib.IContainer): Self = StObject.set(x, "removeInnerAt", js.Any.fromFunction1(value))
      ...
      inline def setShow(value: CallbackTo[typingsJapgolly.senchaTouch.Ext.IComponent]): Self = StObject.set(x, "show", value.toJsFn)
  ...
  trait IPanel
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.IContainer {
  ...
  object IPanel {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.lib.IPanel = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.lib.IPanel]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.lib.IPanel](x: Self) {
