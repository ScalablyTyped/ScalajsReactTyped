...
object ITarget {
  ...
  def apply(
    ...
    getNext: js.UndefOr[CallbackTo[ITarget]] = js.undefined,
    getPrevious: js.UndefOr[CallbackTo[ITarget]] = js.undefined,
    ...
    self: IClass = null,
    setNext: /* next */ js.UndefOr[ITarget] => Callback = null,
    setPrevious: /* previous */ js.UndefOr[ITarget] => Callback = null,
    ...
    if (setNext != null) __obj.updateDynamic("setNext")(js.Any.fromFunction1((t0: /* next */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.modifier.ITarget]) => setNext(t0).runNow()))
    if (setPrevious != null) __obj.updateDynamic("setPrevious")(js.Any.fromFunction1((t0: /* previous */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.modifier.ITarget]) => setPrevious(t0).runNow()))
