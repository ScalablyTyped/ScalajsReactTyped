package typingsJapgolly.senchaTouch.Ext.device.globalization
...
object IAbstract {
  ...
  def apply(
    ...
    getCurrencyCode: js.UndefOr[CallbackTo[String]] = js.undefined,
    getDateType: js.UndefOr[CallbackTo[String]] = js.undefined,
    getFormatLength: js.UndefOr[CallbackTo[String]] = js.undefined,
    getId: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getInitialConfig: /* name */ js.UndefOr[String] => CallbackTo[js.Any] = null,
    getItems: js.UndefOr[CallbackTo[String]] = js.undefined,
    getListeners: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getNumberType: js.UndefOr[CallbackTo[String]] = js.undefined,
    getSelector: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    setCurrencyCode: /* currencyCode */ js.UndefOr[String] => Callback = null,
    setDateType: /* dateType */ js.UndefOr[String] => Callback = null,
    setFormatLength: /* formatLength */ js.UndefOr[String] => Callback = null,
    setItems: /* items */ js.UndefOr[String] => Callback = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => Callback = null,
    setNumberType: /* numberType */ js.UndefOr[String] => Callback = null,
    setSelector: /* selector */ js.UndefOr[String] => Callback = null,
    ...
    getCurrencyCode.foreach(p => __obj.updateDynamic("getCurrencyCode")(p.toJsFn))
    getDateType.foreach(p => __obj.updateDynamic("getDateType")(p.toJsFn))
    getFormatLength.foreach(p => __obj.updateDynamic("getFormatLength")(p.toJsFn))
    ...
    getNumberType.foreach(p => __obj.updateDynamic("getNumberType")(p.toJsFn))
    getSelector.foreach(p => __obj.updateDynamic("getSelector")(p.toJsFn))
    ...
    if (setCurrencyCode != null) __obj.updateDynamic("setCurrencyCode")(js.Any.fromFunction1((t0: /* currencyCode */ js.UndefOr[java.lang.String]) => setCurrencyCode(t0).runNow()))
    if (setDateType != null) __obj.updateDynamic("setDateType")(js.Any.fromFunction1((t0: /* dateType */ js.UndefOr[java.lang.String]) => setDateType(t0).runNow()))
    if (setFormatLength != null) __obj.updateDynamic("setFormatLength")(js.Any.fromFunction1((t0: /* formatLength */ js.UndefOr[java.lang.String]) => setFormatLength(t0).runNow()))
    if (setItems != null) __obj.updateDynamic("setItems")(js.Any.fromFunction1((t0: /* items */ js.UndefOr[java.lang.String]) => setItems(t0).runNow()))
    ...
    if (setNumberType != null) __obj.updateDynamic("setNumberType")(js.Any.fromFunction1((t0: /* numberType */ js.UndefOr[java.lang.String]) => setNumberType(t0).runNow()))
    if (setSelector != null) __obj.updateDynamic("setSelector")(js.Any.fromFunction1((t0: /* selector */ js.UndefOr[java.lang.String]) => setSelector(t0).runNow()))
