package typingsJapgolly.senchaTouch.Ext.fx.layout.card
...
object IReveal {
  ...
  def apply(
    ...
    getDuration: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getId: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getInAnimation: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getInitialConfig: /* name */ js.UndefOr[String] => CallbackTo[js.Any] = null,
    getLayout: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getListeners: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getOutAnimation: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    setDuration: /* duration */ js.UndefOr[js.Any] => Callback = null,
    setInAnimation: /* inAnimation */ js.UndefOr[js.Any] => Callback = null,
    setLayout: /* layout */ js.UndefOr[js.Any] => Callback = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => Callback = null,
    setOutAnimation: /* outAnimation */ js.UndefOr[js.Any] => Callback = null,
    ...
    getInAnimation.foreach(p => __obj.updateDynamic("getInAnimation")(p.toJsFn))
    ...
    getOutAnimation.foreach(p => __obj.updateDynamic("getOutAnimation")(p.toJsFn))
    ...
    if (setDuration != null) __obj.updateDynamic("setDuration")(js.Any.fromFunction1((t0: /* duration */ js.UndefOr[js.Any]) => setDuration(t0).runNow()))
    if (setInAnimation != null) __obj.updateDynamic("setInAnimation")(js.Any.fromFunction1((t0: /* inAnimation */ js.UndefOr[js.Any]) => setInAnimation(t0).runNow()))
    ...
    if (setOutAnimation != null) __obj.updateDynamic("setOutAnimation")(js.Any.fromFunction1((t0: /* outAnimation */ js.UndefOr[js.Any]) => setOutAnimation(t0).runNow()))
