...
import typingsJapgolly.senchaTouch.Ext.data.IRequest
...
object IJsonP {
  ...
  def apply(
    ...
    getAutoAppendParams: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    getDefaultWriterType: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getRecordParam: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    setAutoAppendParams: /* autoAppendParams */ js.UndefOr[Boolean] => Callback = null,
    ...
    setDefaultWriterType: /* defaultWriterType */ js.UndefOr[String] => Callback = null,
    ...
    setRecordParam: /* recordParam */ js.UndefOr[String] => Callback = null,
    ...
    getAutoAppendParams.foreach(p => __obj.updateDynamic("getAutoAppendParams")(p.toJsFn))
    ...
    getDefaultWriterType.foreach(p => __obj.updateDynamic("getDefaultWriterType")(p.toJsFn))
    ...
    getRecordParam.foreach(p => __obj.updateDynamic("getRecordParam")(p.toJsFn))
    ...
    if (setAutoAppendParams != null) __obj.updateDynamic("setAutoAppendParams")(js.Any.fromFunction1((t0: /* autoAppendParams */ js.UndefOr[scala.Boolean]) => setAutoAppendParams(t0).runNow()))
    ...
    if (setDefaultWriterType != null) __obj.updateDynamic("setDefaultWriterType")(js.Any.fromFunction1((t0: /* defaultWriterType */ js.UndefOr[java.lang.String]) => setDefaultWriterType(t0).runNow()))
    ...
    if (setRecordParam != null) __obj.updateDynamic("setRecordParam")(js.Any.fromFunction1((t0: /* recordParam */ js.UndefOr[java.lang.String]) => setRecordParam(t0).runNow()))
