package typingsJapgolly.senchaTouch.Ext.device.contacts
...
object ICordova {
  ...
  def apply(
    ...
    getContacts: /* config */ js.UndefOr[js.Any] => CallbackTo[Array] = null,
    getId: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getIncludeImages: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    getInitialConfig: /* name */ js.UndefOr[String] => CallbackTo[js.Any] = null,
    getListeners: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getLocalizedLabel: /* config */ js.UndefOr[js.Any] => CallbackTo[String] = null,
    getThumbnail: /* config */ js.UndefOr[js.Any] => CallbackTo[String] = null,
    ...
    setIncludeImages: /* includeImages */ js.UndefOr[Boolean] => Callback = null,
    ...
    if (getContacts != null) __obj.updateDynamic("getContacts")(js.Any.fromFunction1((t0: /* config */ js.UndefOr[js.Any]) => getContacts(t0).runNow()))
    getId.foreach(p => __obj.updateDynamic("getId")(p.toJsFn))
    getIncludeImages.foreach(p => __obj.updateDynamic("getIncludeImages")(p.toJsFn))
    if (getInitialConfig != null) __obj.updateDynamic("getInitialConfig")(js.Any.fromFunction1((t0: /* name */ js.UndefOr[java.lang.String]) => getInitialConfig(t0).runNow()))
    getListeners.foreach(p => __obj.updateDynamic("getListeners")(p.toJsFn))
    if (getLocalizedLabel != null) __obj.updateDynamic("getLocalizedLabel")(js.Any.fromFunction1((t0: /* config */ js.UndefOr[js.Any]) => getLocalizedLabel(t0).runNow()))
    if (getThumbnail != null) __obj.updateDynamic("getThumbnail")(js.Any.fromFunction1((t0: /* config */ js.UndefOr[js.Any]) => getThumbnail(t0).runNow()))
    ...
    if (setIncludeImages != null) __obj.updateDynamic("setIncludeImages")(js.Any.fromFunction1((t0: /* includeImages */ js.UndefOr[scala.Boolean]) => setIncludeImages(t0).runNow()))
