...
object purchases {
  ...
  object IProduct {
    ...
    extension [Self <: IProduct](x: Self) {
      ...
      inline def setPurchase(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "purchase", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object IPurchase {
    ...
    extension [Self <: IPurchase](x: Self) {
      ...
      inline def setComplete(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "complete", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object ISencha {
    ...
    extension [Self <: ISencha](x: Self) {
      ...
      inline def setCanMakePayments(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "canMakePayments", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setCanMakePaymentsUndefined: Self = StObject.set(x, "canMakePayments", js.undefined)
      
      inline def setGetCompletedPurchases(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getCompletedPurchases", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setGetCompletedPurchasesUndefined: Self = StObject.set(x, "getCompletedPurchases", js.undefined)
      
      inline def setGetProducts(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getProducts", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setGetProductsUndefined: Self = StObject.set(x, "getProducts", js.undefined)
      
      inline def setGetPurchases(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getPurchases", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
