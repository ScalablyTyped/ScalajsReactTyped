...
trait ISlider
  extends StObject
     with typingsJapgolly.senchaTouch.Ext.field.IField {
  ...
  /** [Method] Resets the current field value back to the original value on this field when it was created
    ...
    */
  @JSName("reset")
  var reset_ISlider: js.UndefOr[js.Function0[typingsJapgolly.senchaTouch.Ext.field.IField]] = js.undefined
...
object ISlider {
  ...
  extension [Self <: ISlider](x: Self) {
    ...
    inline def setReset(value: CallbackTo[typingsJapgolly.senchaTouch.Ext.field.IField]): Self = StObject.set(x, "reset", value.toJsFn)
