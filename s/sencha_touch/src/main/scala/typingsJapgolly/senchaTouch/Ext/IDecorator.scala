...
object IDecorator {
  ...
  def apply(
    ...
    getComponent: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    getParent: js.UndefOr[CallbackTo[IDecorator]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IDecorator] = null,
    ...
    setComponent: /* component */ js.UndefOr[js.Any] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IDecorator] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IDecorator], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    getComponent.foreach(p => __obj.updateDynamic("getComponent")(p.toJsFn))
    ...
    if (setComponent != null) __obj.updateDynamic("setComponent")(js.Any.fromFunction1((t0: /* component */ js.UndefOr[js.Any]) => setComponent(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IDecorator], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
