...
object IFile {
  ...
  extension [Self <: IFile](x: Self) {
    ...
    inline def setGetAccept(value: CallbackTo[String]): Self = StObject.set(x, "getAccept", value.toJsFn)
    
    inline def setGetAcceptUndefined: Self = StObject.set(x, "getAccept", js.undefined)
    
    inline def setGetCapture(value: CallbackTo[String]): Self = StObject.set(x, "getCapture", value.toJsFn)
    ...
    inline def setSetAccept(value: /* accept */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setAccept", js.Any.fromFunction1((t0: /* accept */ js.UndefOr[String]) => value(t0).runNow()))
    
    inline def setSetAcceptUndefined: Self = StObject.set(x, "setAccept", js.undefined)
    
    inline def setSetCapture(value: /* capture */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setCapture", js.Any.fromFunction1((t0: /* capture */ js.UndefOr[String]) => value(t0).runNow()))
