...
object IMarkers {
  ...
  def apply(
    ...
    clear: /* category */ js.UndefOr[String] => Callback = null,
    ...
    getMarkerBBoxFor: (/* category */ js.UndefOr[String], /* index */ js.UndefOr[js.Any], /* isWithoutTransform */ js.UndefOr[Boolean]) => Callback = null,
    ...
    hide: js.UndefOr[CallbackTo[IMarkers]] = js.undefined,
    ...
    putMarkerFor: (/* category */ js.UndefOr[String], /* markerAttr */ js.UndefOr[js.Any], /* index */ js.UndefOr[js.Any], /* canonical */ js.UndefOr[Boolean], /* keepRevision */ js.UndefOr[Boolean]) => Callback = null,
    ...
    render: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* clipRegion */ js.UndefOr[js.Any]) => CallbackTo[js.Any] = null,
    ...
    show: js.UndefOr[CallbackTo[IMarkers]] = js.undefined,
    ...
    if (clear != null) __obj.updateDynamic("clear")(js.Any.fromFunction1((t0: /* category */ js.UndefOr[java.lang.String]) => clear(t0).runNow()))
    ...
    if (getMarkerBBoxFor != null) __obj.updateDynamic("getMarkerBBoxFor")(js.Any.fromFunction3((t0: /* category */ js.UndefOr[java.lang.String], t1: /* index */ js.UndefOr[js.Any], t2: /* isWithoutTransform */ js.UndefOr[scala.Boolean]) => getMarkerBBoxFor(t0, t1, t2).runNow()))
    ...
    if (putMarkerFor != null) __obj.updateDynamic("putMarkerFor")(js.Any.fromFunction5((t0: /* category */ js.UndefOr[java.lang.String], t1: /* markerAttr */ js.UndefOr[js.Any], t2: /* index */ js.UndefOr[js.Any], t3: /* canonical */ js.UndefOr[scala.Boolean], t4: /* keepRevision */ js.UndefOr[scala.Boolean]) => putMarkerFor(t0, t1, t2, t3, t4).runNow()))
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction3((t0: /* surface */ js.UndefOr[js.Any], t1: /* ctx */ js.UndefOr[js.Any], t2: /* clipRegion */ js.UndefOr[js.Any]) => render(t0, t1, t2).runNow()))
