...
object ISencha {
  ...
  def apply(
    ...
    openURL: /* url */ js.UndefOr[js.Any] => Callback = null,
    ...
    if (openURL != null) __obj.updateDynamic("openURL")(js.Any.fromFunction1((t0: /* url */ js.UndefOr[js.Any]) => openURL(t0).runNow()))
