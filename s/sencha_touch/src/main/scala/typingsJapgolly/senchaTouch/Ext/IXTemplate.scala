...
object IXTemplate {
  ...
  def apply(
    ...
    applyOut: (/* values */ js.UndefOr[js.Any], /* out */ js.UndefOr[Array], /* parent */ js.UndefOr[js.Any]) => CallbackTo[Array] = null,
    ...
    if (applyOut != null) __obj.updateDynamic("applyOut")(js.Any.fromFunction3((t0: /* values */ js.UndefOr[js.Any], t1: /* out */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.Array], t2: /* parent */ js.UndefOr[js.Any]) => applyOut(t0, t1, t2).runNow()))
