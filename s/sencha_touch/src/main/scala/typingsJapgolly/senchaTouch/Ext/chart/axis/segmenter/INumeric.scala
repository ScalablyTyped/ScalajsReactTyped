...
object INumeric {
  ...
  def apply(
    ...
    exactStep: (/* start */ js.UndefOr[js.Any], /* estStepSize */ js.UndefOr[js.Any]) => CallbackTo[js.Any] = null,
    extend: String = null,
    ...
    if (exactStep != null) __obj.updateDynamic("exactStep")(js.Any.fromFunction2((t0: /* start */ js.UndefOr[js.Any], t1: /* estStepSize */ js.UndefOr[js.Any]) => exactStep(t0, t1).runNow()))
