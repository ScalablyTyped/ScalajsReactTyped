...
object tunnel {
  ...
  object IAbstract {
    ...
    extension [Self <: IAbstract](x: Self) {
      ...
      inline def setOnConnect(value: /* callback */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onConnect", js.Any.fromFunction1((t0: /* callback */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setOnConnectUndefined: Self = StObject.set(x, "onConnect", js.undefined)
      
      inline def setOnMessage(value: /* callback */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "onMessage", js.Any.fromFunction1((t0: /* callback */ js.UndefOr[Any]) => value(t0).runNow()))
