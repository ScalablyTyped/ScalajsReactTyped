...
import typingsJapgolly.senchaTouch.Ext.draw.IGroup
...
object ISvg {
  @scala.inline
  def apply(
    add: js.UndefOr[Callback] = js.undefined,
    ...
    clearTransform: js.UndefOr[Callback] = js.undefined,
    cls: js.Any = null,
    componentCls: String = null,
    config: js.Any = null,
    contentEl: js.Any = null,
    createSvgNode: /* type */ js.UndefOr[String] => CallbackTo[js.Any] = null,
    data: js.Any = null,
    destroy: (/* path */ js.UndefOr[js.Any], /* matrix */ js.UndefOr[js.Any], /* band */ js.UndefOr[js.Any]) => Callback = null,
    ...
    getBBox: (/* sprite */ js.UndefOr[ISprite], /* isWithoutTransform */ js.UndefOr[Boolean]) => CallbackTo[js.Any] = null,
    ...
    getDirty: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    getGroup: /* id */ js.UndefOr[String] => CallbackTo[IGroup] = null,
    getGroups: js.UndefOr[CallbackTo[Array]] = js.undefined,
    ...
    getHighPrecision: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    getItems: js.UndefOr[CallbackTo[IGroup]] = js.undefined,
    ...
    getParent: js.UndefOr[CallbackTo[ISvg]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISvg] = null,
    ...
    onAdd: /* sprite */ js.UndefOr[ISprite] => Callback = null,
    ...
    remove: (/* sprite */ js.UndefOr[js.Any], /* destroySprite */ js.UndefOr[js.Any]) => Callback = null,
    ...
    renderSprite: /* sprite */ js.UndefOr[ISprite] => CallbackTo[Boolean] = null,
    renderTo: typingsJapgolly.senchaTouch.Ext.IElement = null,
    repaint: js.UndefOr[Callback] = js.undefined,
    ...
    resetTransform: js.UndefOr[Callback] = js.undefined,
    resumeEvents: /* discardQueuedEvents */ js.UndefOr[Boolean] => Callback = null,
    right: js.Any = null,
    roundPixel: /* num */ js.UndefOr[Double] => CallbackTo[Double] = null,
    scroll: js.Any = null,
    self: IClass = null,
    ...
    setGroups: /* groups */ js.UndefOr[Array] => Callback = null,
    ...
    setHighPrecision: /* highPrecision */ js.UndefOr[Boolean] => Callback = null,
    setHtml: /* html */ js.UndefOr[js.Any] => Callback = null,
    setItemId: /* itemId */ js.UndefOr[String] => Callback = null,
    setItems: /* items */ js.UndefOr[IGroup] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISvg] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISvg], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    uses: Array = null,
    waitFor: /* surface */ js.UndefOr[ISvg] => Callback = null,
    width: js.Any = null,
    xtype: String = null,
    ...
    clearTransform.foreach(p => __obj.updateDynamic("clearTransform")(p.toJsFn))
    ...
    if (createSvgNode != null) __obj.updateDynamic("createSvgNode")(js.Any.fromFunction1((t0: /* type */ js.UndefOr[java.lang.String]) => createSvgNode(t0).runNow()))
    if (data != null) __obj.updateDynamic("data")(data.asInstanceOf[js.Any])
    if (destroy != null) __obj.updateDynamic("destroy")(js.Any.fromFunction3((t0: /* path */ js.UndefOr[js.Any], t1: /* matrix */ js.UndefOr[js.Any], t2: /* band */ js.UndefOr[js.Any]) => destroy(t0, t1, t2).runNow()))
    ...
    if (getBBox != null) __obj.updateDynamic("getBBox")(js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.sprite.ISprite], t1: /* isWithoutTransform */ js.UndefOr[scala.Boolean]) => getBBox(t0, t1).runNow()))
    ...
    getDirty.foreach(p => __obj.updateDynamic("getDirty")(p.toJsFn))
    ...
    getGroups.foreach(p => __obj.updateDynamic("getGroups")(p.toJsFn))
    ...
    getHighPrecision.foreach(p => __obj.updateDynamic("getHighPrecision")(p.toJsFn))
    ...
    if (onAdd != null) __obj.updateDynamic("onAdd")(js.Any.fromFunction1((t0: /* sprite */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.sprite.ISprite]) => onAdd(t0).runNow()))
    ...
    if (remove != null) __obj.updateDynamic("remove")(js.Any.fromFunction2((t0: /* sprite */ js.UndefOr[js.Any], t1: /* destroySprite */ js.UndefOr[js.Any]) => remove(t0, t1).runNow()))
    ...
    if (renderSprite != null) __obj.updateDynamic("renderSprite")(js.Any.fromFunction1((t0: /* sprite */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.sprite.ISprite]) => renderSprite(t0).runNow()))
    ...
    resetTransform.foreach(p => __obj.updateDynamic("resetTransform")(p.toJsFn))
    ...
    if (roundPixel != null) __obj.updateDynamic("roundPixel")(js.Any.fromFunction1((t0: /* num */ js.UndefOr[scala.Double]) => roundPixel(t0).runNow()))
    ...
    if (setGroups != null) __obj.updateDynamic("setGroups")(js.Any.fromFunction1((t0: /* groups */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.Array]) => setGroups(t0).runNow()))
    ...
    if (setHighPrecision != null) __obj.updateDynamic("setHighPrecision")(js.Any.fromFunction1((t0: /* highPrecision */ js.UndefOr[scala.Boolean]) => setHighPrecision(t0).runNow()))
    ...
    if (setItems != null) __obj.updateDynamic("setItems")(js.Any.fromFunction1((t0: /* items */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.IGroup]) => setItems(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.engine.ISvg], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
    ...
    if (waitFor != null) __obj.updateDynamic("waitFor")(js.Any.fromFunction1((t0: /* surface */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.engine.ISvg]) => waitFor(t0).runNow()))
