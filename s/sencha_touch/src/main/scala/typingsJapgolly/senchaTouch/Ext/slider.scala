...
object slider {
  ...
  object ISlider {
    ...
    extension [Self <: ISlider](x: Self) {
      ...
      inline def setGetAllowThumbsOverlapping(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAllowThumbsOverlapping", value.toJsFn)
      ...
      inline def setGetThumbConfig(value: CallbackTo[Any]): Self = StObject.set(x, "getThumbConfig", value.toJsFn)
      ...
      inline def setGetThumbs(value: CallbackTo[Array]): Self = StObject.set(x, "getThumbs", value.toJsFn)
      ...
      inline def setSetAllowThumbsOverlapping(value: /* allowThumbsOverlapping */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAllowThumbsOverlapping", js.Any.fromFunction1((t0: /* allowThumbsOverlapping */ js.UndefOr[Boolean]) => value(t0).runNow()))
      ...
      inline def setSetThumbConfig(value: /* thumbConfig */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setThumbConfig", js.Any.fromFunction1((t0: /* thumbConfig */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setUpdateValue(value: (/* newValue */ js.UndefOr[Any], /* oldValue */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "updateValue", js.Any.fromFunction2((t0: /* newValue */ js.UndefOr[Any], t1: /* oldValue */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
  ...
  object IThumb {
    ...
    extension [Self <: IThumb](x: Self) {
      ...
      inline def setGetDraggable(value: CallbackTo[Any]): Self = StObject.set(x, "getDraggable", value.toJsFn)
  ...
  object IToggle {
    ...
    extension [Self <: IToggle](x: Self) {
      ...
      inline def setApplyIncrement(value: CallbackTo[Double]): Self = StObject.set(x, "applyIncrement", value.toJsFn)
      
      inline def setApplyIncrementUndefined: Self = StObject.set(x, "applyIncrement", js.undefined)
      
      inline def setGetMaxValueCls(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getMaxValueCls", value.toJsFn)
      
      inline def setGetMaxValueClsUndefined: Self = StObject.set(x, "getMaxValueCls", js.undefined)
      
      inline def setGetMinValueCls(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getMinValueCls", value.toJsFn)
      ...
      inline def setSetMaxValueCls(value: /* maxValueCls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setMaxValueCls", js.Any.fromFunction1((t0: /* maxValueCls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetMaxValueClsUndefined: Self = StObject.set(x, "setMaxValueCls", js.undefined)
      
      inline def setSetMinValueCls(value: /* minValueCls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setMinValueCls", js.Any.fromFunction1((t0: /* minValueCls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetMinValueClsUndefined: Self = StObject.set(x, "setMinValueCls", js.undefined)
      
      inline def setSetValue(value: (/* newValue */ js.UndefOr[Any], /* oldValue */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "setValue", js.Any.fromFunction2((t0: /* newValue */ js.UndefOr[Any], t1: /* oldValue */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
