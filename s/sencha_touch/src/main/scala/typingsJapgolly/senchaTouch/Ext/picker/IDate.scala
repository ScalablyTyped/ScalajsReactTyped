...
object IDate {
  ...
  def apply(
    ...
    dayText: String = null,
    getDayText: js.UndefOr[CallbackTo[String]] = js.undefined,
    getMonthText: js.UndefOr[CallbackTo[String]] = js.undefined,
    getSlotOrder: js.UndefOr[CallbackTo[Array]] = js.undefined,
    getYearFrom: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getYearText: js.UndefOr[CallbackTo[String]] = js.undefined,
    getYearTo: js.UndefOr[CallbackTo[Double]] = js.undefined,
    monthText: String = null,
    setDayText: /* dayText */ js.UndefOr[String] => Callback = null,
    setMonthText: /* monthText */ js.UndefOr[String] => Callback = null,
    setSlotOrder: /* slotOrder */ js.UndefOr[Array] => Callback = null,
    setValue: (/* value */ js.UndefOr[js.Any], /* animated */ js.UndefOr[js.Any]) => CallbackTo[typingsJapgolly.senchaTouch.Ext.IPicker] = null,
    setYearFrom: /* yearFrom */ js.UndefOr[Double] => Callback = null,
    setYearText: /* yearText */ js.UndefOr[String] => Callback = null,
