...
object ITreeStore {
  ...
  def apply(
    ...
    getById: /* id */ js.UndefOr[js.Any] => CallbackTo[js.Any] = null,
    getClearOnLoad: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    getDefaultRootId: js.UndefOr[CallbackTo[String]] = js.undefined,
    getDefaultRootProperty: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getNodeParam: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getRoot: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getRootNode: /* node */ js.UndefOr[js.Any] => CallbackTo[IModel] = null,
    ...
    load: /* options */ js.UndefOr[js.Any] => CallbackTo[js.Any] = null,
    ...
    onProxyLoad: /* operation */ js.UndefOr[js.Any] => Callback = null,
    ...
    setClearOnLoad: /* clearOnLoad */ js.UndefOr[Boolean] => Callback = null,
    setClearOnPageLoad: /* clearOnPageLoad */ js.UndefOr[Boolean] => Callback = null,
    setData: /* data */ js.UndefOr[js.Any] => Callback = null,
    setDefaultRootId: /* defaultRootId */ js.UndefOr[String] => Callback = null,
    setDefaultRootProperty: /* defaultRootProperty */ js.UndefOr[String] => Callback = null,
    ...
    setNodeParam: /* nodeParam */ js.UndefOr[String] => Callback = null,
    ...
    setRoot: /* root */ js.UndefOr[js.Any] => Callback = null,
    setRootNode: /* node */ js.UndefOr[IModel] => CallbackTo[IModel] = null,
    ...
    getClearOnLoad.foreach(p => __obj.updateDynamic("getClearOnLoad")(p.toJsFn))
    ...
    getDefaultRootId.foreach(p => __obj.updateDynamic("getDefaultRootId")(p.toJsFn))
    getDefaultRootProperty.foreach(p => __obj.updateDynamic("getDefaultRootProperty")(p.toJsFn))
    ...
    getNodeParam.foreach(p => __obj.updateDynamic("getNodeParam")(p.toJsFn))
    ...
    if (getRootNode != null) __obj.updateDynamic("getRootNode")(js.Any.fromFunction1((t0: /* node */ js.UndefOr[js.Any]) => getRootNode(t0).runNow()))
    ...
    if (onProxyLoad != null) __obj.updateDynamic("onProxyLoad")(js.Any.fromFunction1((t0: /* operation */ js.UndefOr[js.Any]) => onProxyLoad(t0).runNow()))
    ...
    if (setClearOnLoad != null) __obj.updateDynamic("setClearOnLoad")(js.Any.fromFunction1((t0: /* clearOnLoad */ js.UndefOr[scala.Boolean]) => setClearOnLoad(t0).runNow()))
    ...
    if (setDefaultRootId != null) __obj.updateDynamic("setDefaultRootId")(js.Any.fromFunction1((t0: /* defaultRootId */ js.UndefOr[java.lang.String]) => setDefaultRootId(t0).runNow()))
    if (setDefaultRootProperty != null) __obj.updateDynamic("setDefaultRootProperty")(js.Any.fromFunction1((t0: /* defaultRootProperty */ js.UndefOr[java.lang.String]) => setDefaultRootProperty(t0).runNow()))
    ...
    if (setNodeParam != null) __obj.updateDynamic("setNodeParam")(js.Any.fromFunction1((t0: /* nodeParam */ js.UndefOr[java.lang.String]) => setNodeParam(t0).runNow()))
    ...
    if (setRoot != null) __obj.updateDynamic("setRoot")(js.Any.fromFunction1((t0: /* root */ js.UndefOr[js.Any]) => setRoot(t0).runNow()))
    if (setRootNode != null) __obj.updateDynamic("setRootNode")(js.Any.fromFunction1((t0: /* node */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.data.IModel]) => setRootNode(t0).runNow()))
