...
object IAttributeDefinition {
  ...
  extension [Self <: IAttributeDefinition](x: Self) {
    ...
    inline def setGetAliases(value: CallbackTo[Any]): Self = StObject.set(x, "getAliases", value.toJsFn)
    
    inline def setGetAliasesUndefined: Self = StObject.set(x, "getAliases", js.undefined)
    
    inline def setGetAnimationProcessors(value: CallbackTo[Any]): Self = StObject.set(x, "getAnimationProcessors", value.toJsFn)
    ...
    inline def setGetProcessors(value: CallbackTo[Any]): Self = StObject.set(x, "getProcessors", value.toJsFn)
    
    inline def setGetProcessorsUndefined: Self = StObject.set(x, "getProcessors", js.undefined)
    
    inline def setGetUpdaters(value: CallbackTo[Any]): Self = StObject.set(x, "getUpdaters", value.toJsFn)
    ...
    inline def setSetAliases(value: /* aliases */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setAliases", js.Any.fromFunction1((t0: /* aliases */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetAliasesUndefined: Self = StObject.set(x, "setAliases", js.undefined)
    
    inline def setSetAnimationProcessors(value: /* animationProcessors */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setAnimationProcessors", js.Any.fromFunction1((t0: /* animationProcessors */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetProcessors(value: /* processors */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setProcessors", js.Any.fromFunction1((t0: /* processors */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetProcessorsUndefined: Self = StObject.set(x, "setProcessors", js.undefined)
    
    inline def setSetUpdaters(value: /* updaters */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setUpdaters", js.Any.fromFunction1((t0: /* updaters */ js.UndefOr[Any]) => value(t0).runNow()))
