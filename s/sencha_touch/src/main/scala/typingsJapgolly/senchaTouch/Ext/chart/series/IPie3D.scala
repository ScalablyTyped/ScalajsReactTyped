...
object IPie3D {
  ...
  def apply(
    ...
    getDistortion: js.UndefOr[CallbackTo[Double]] = js.undefined,
    ...
    getThickness: js.UndefOr[CallbackTo[Double]] = js.undefined,
    ...
    setDistortion: /* distortion */ js.UndefOr[Double] => Callback = null,
    ...
    setThickness: /* thickness */ js.UndefOr[Double] => Callback = null,
    ...
    getDistortion.foreach(p => __obj.updateDynamic("getDistortion")(p.toJsFn))
    ...
    getThickness.foreach(p => __obj.updateDynamic("getThickness")(p.toJsFn))
    ...
    if (setDistortion != null) __obj.updateDynamic("setDistortion")(js.Any.fromFunction1((t0: /* distortion */ js.UndefOr[scala.Double]) => setDistortion(t0).runNow()))
    ...
    if (setThickness != null) __obj.updateDynamic("setThickness")(js.Any.fromFunction1((t0: /* thickness */ js.UndefOr[scala.Double]) => setThickness(t0).runNow()))
