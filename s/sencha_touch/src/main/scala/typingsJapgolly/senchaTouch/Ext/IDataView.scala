...
object IDataView {
  ...
  extension [Self <: IDataView](x: Self) {
    ...
    inline def setBindStore(value: Callback): Self = StObject.set(x, "bindStore", value.toJsFn)
    ...
    inline def setCollectData(value: Callback): Self = StObject.set(x, "collectData", value.toJsFn)
    ...
    inline def setDeselect(value: (js.UndefOr[Any], js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "deselect", js.Any.fromFunction2((t0: js.UndefOr[Any], t1: js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
    
    inline def setDeselectAll(value: js.UndefOr[Any] => Callback): Self = StObject.set(x, "deselectAll", js.Any.fromFunction1((t0: js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setDoDeselect(value: (js.UndefOr[Any], js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "doDeselect", js.Any.fromFunction2((t0: js.UndefOr[Any], t1: js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
    
    inline def setDoDeselectUndefined: Self = StObject.set(x, "doDeselect", js.undefined)
    
    inline def setDoSelect(value: (js.UndefOr[Any], js.UndefOr[Boolean], js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "doSelect", js.Any.fromFunction3((t0: js.UndefOr[Any], t1: js.UndefOr[Boolean], t2: js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setFindItemByChild(value: Callback): Self = StObject.set(x, "findItemByChild", value.toJsFn)
    
    inline def setFindItemByChildUndefined: Self = StObject.set(x, "findItemByChild", js.undefined)
    
    inline def setFindTargetByEvent(value: Callback): Self = StObject.set(x, "findTargetByEvent", value.toJsFn)
    ...
    inline def setGetData(value: CallbackTo[Array]): Self = StObject.set(x, "getData", value.toJsFn)
    
    inline def setGetDataUndefined: Self = StObject.set(x, "getData", js.undefined)
    
    inline def setGetDeferEmptyText(value: CallbackTo[Boolean]): Self = StObject.set(x, "getDeferEmptyText", value.toJsFn)
    
    inline def setGetDeferEmptyTextUndefined: Self = StObject.set(x, "getDeferEmptyText", js.undefined)
    
    inline def setGetDeselectOnContainerClick(value: CallbackTo[Boolean]): Self = StObject.set(x, "getDeselectOnContainerClick", value.toJsFn)
    ...
    inline def setGetInline(value: CallbackTo[Any]): Self = StObject.set(x, "getInline", value.toJsFn)
    ...
    inline def setGetItemCls(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getItemCls", value.toJsFn)
    ...
    inline def setGetItemTpl(value: CallbackTo[Any]): Self = StObject.set(x, "getItemTpl", value.toJsFn)
    
    inline def setGetItemTplUndefined: Self = StObject.set(x, "getItemTpl", js.undefined)
    
    inline def setGetLastSelected(value: CallbackTo[Array]): Self = StObject.set(x, "getLastSelected", value.toJsFn)
    
    inline def setGetLastSelectedUndefined: Self = StObject.set(x, "getLastSelected", js.undefined)
    
    inline def setGetLoadingText(value: CallbackTo[Any]): Self = StObject.set(x, "getLoadingText", value.toJsFn)
    
    inline def setGetLoadingTextUndefined: Self = StObject.set(x, "getLoadingText", js.undefined)
    
    inline def setGetMaxItemCache(value: CallbackTo[Double]): Self = StObject.set(x, "getMaxItemCache", value.toJsFn)
    ...
    inline def setGetNode(value: Callback): Self = StObject.set(x, "getNode", value.toJsFn)
    
    inline def setGetNodeUndefined: Self = StObject.set(x, "getNode", js.undefined)
    
    inline def setGetNodes(value: Callback): Self = StObject.set(x, "getNodes", value.toJsFn)
    ...
    inline def setGetPressedDelay(value: CallbackTo[Double]): Self = StObject.set(x, "getPressedDelay", value.toJsFn)
    
    inline def setGetPressedDelayUndefined: Self = StObject.set(x, "getPressedDelay", js.undefined)
    
    inline def setGetRecords(value: Callback): Self = StObject.set(x, "getRecords", value.toJsFn)
    
    inline def setGetRecordsUndefined: Self = StObject.set(x, "getRecords", js.undefined)
    
    inline def setGetScrollToTopOnRefresh(value: CallbackTo[Boolean]): Self = StObject.set(x, "getScrollToTopOnRefresh", value.toJsFn)
    
    inline def setGetScrollToTopOnRefreshUndefined: Self = StObject.set(x, "getScrollToTopOnRefresh", js.undefined)
    
    inline def setGetSelectedCls(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getSelectedCls", value.toJsFn)
    
    inline def setGetSelectedClsUndefined: Self = StObject.set(x, "getSelectedCls", js.undefined)
    
    inline def setGetSelectedNodes(value: Callback): Self = StObject.set(x, "getSelectedNodes", value.toJsFn)
    
    inline def setGetSelectedNodesUndefined: Self = StObject.set(x, "getSelectedNodes", js.undefined)
    
    inline def setGetSelectedRecords(value: Callback): Self = StObject.set(x, "getSelectedRecords", value.toJsFn)
    ...
    inline def setGetTriggerCtEvent(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getTriggerCtEvent", value.toJsFn)
    
    inline def setGetTriggerCtEventUndefined: Self = StObject.set(x, "getTriggerCtEvent", js.undefined)
    
    inline def setGetTriggerEvent(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getTriggerEvent", value.toJsFn)
    
    inline def setGetTriggerEventUndefined: Self = StObject.set(x, "getTriggerEvent", js.undefined)
    
    inline def setGetUseComponents(value: CallbackTo[Boolean]): Self = StObject.set(x, "getUseComponents", value.toJsFn)
    
    inline def setGetUseComponentsUndefined: Self = StObject.set(x, "getUseComponents", js.undefined)
    
    inline def setGetViewItems(value: CallbackTo[Any]): Self = StObject.set(x, "getViewItems", value.toJsFn)
    
    inline def setGetViewItemsUndefined: Self = StObject.set(x, "getViewItems", js.undefined)
    
    inline def setHandleException(value: Callback): Self = StObject.set(x, "handleException", value.toJsFn)
    ...
    inline def setIndexOf(value: Callback): Self = StObject.set(x, "indexOf", value.toJsFn)
    ...
    inline def setRefreshNode(value: Callback): Self = StObject.set(x, "refreshNode", value.toJsFn)
    ...
    inline def setSelect(value: (js.UndefOr[Any], js.UndefOr[Boolean], js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "select", js.Any.fromFunction3((t0: js.UndefOr[Any], t1: js.UndefOr[Boolean], t2: js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
    
    inline def setSelectAll(value: js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "selectAll", js.Any.fromFunction1((t0: js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSelectAllUndefined: Self = StObject.set(x, "selectAll", js.undefined)
    
    inline def setSelectRange(value: (js.UndefOr[Double], js.UndefOr[Double], js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "selectRange", js.Any.fromFunction3((t0: js.UndefOr[Double], t1: js.UndefOr[Double], t2: js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setSetAllowDeselect(value: js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAllowDeselect", js.Any.fromFunction1((t0: js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetAllowDeselectUndefined: Self = StObject.set(x, "setAllowDeselect", js.undefined)
    
    inline def setSetData(value: /* data */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setData", js.Any.fromFunction1((t0: /* data */ js.UndefOr[Array]) => value(t0).runNow()))
    
    inline def setSetDataUndefined: Self = StObject.set(x, "setData", js.undefined)
    
    inline def setSetDeferEmptyText(value: /* deferEmptyText */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setDeferEmptyText", js.Any.fromFunction1((t0: /* deferEmptyText */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetDeferEmptyTextUndefined: Self = StObject.set(x, "setDeferEmptyText", js.undefined)
    
    inline def setSetDeselectOnContainerClick(value: js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setDeselectOnContainerClick", js.Any.fromFunction1((t0: js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetDeselectOnContainerClickUndefined: Self = StObject.set(x, "setDeselectOnContainerClick", js.undefined)
    
    inline def setSetDisableSelection(value: js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setDisableSelection", js.Any.fromFunction1((t0: js.UndefOr[Boolean]) => value(t0).runNow()))
    ...
    inline def setSetInline(value: /* inline */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setInline", js.Any.fromFunction1((t0: /* inline */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetInlineUndefined: Self = StObject.set(x, "setInline", js.undefined)
    
    inline def setSetItemCls(value: /* itemCls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setItemCls", js.Any.fromFunction1((t0: /* itemCls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
    ...
    inline def setSetItemTpl(value: /* itemTpl */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setItemTpl", js.Any.fromFunction1((t0: /* itemTpl */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetItemTplUndefined: Self = StObject.set(x, "setItemTpl", js.undefined)
    
    inline def setSetLastFocused(value: Callback): Self = StObject.set(x, "setLastFocused", value.toJsFn)
    ...
    inline def setSetMaxItemCache(value: /* maxItemCache */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMaxItemCache", js.Any.fromFunction1((t0: /* maxItemCache */ js.UndefOr[Double]) => value(t0).runNow()))
    
    inline def setSetMaxItemCacheUndefined: Self = StObject.set(x, "setMaxItemCache", js.undefined)
    
    inline def setSetMode(value: js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setMode", js.Any.fromFunction1((t0: js.UndefOr[java.lang.String]) => value(t0).runNow()))
    ...
    inline def setSetPressedDelay(value: /* pressedDelay */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setPressedDelay", js.Any.fromFunction1((t0: /* pressedDelay */ js.UndefOr[Double]) => value(t0).runNow()))
    
    inline def setSetPressedDelayUndefined: Self = StObject.set(x, "setPressedDelay", js.undefined)
    
    inline def setSetScrollToTopOnRefresh(value: /* scrollToTopOnRefresh */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setScrollToTopOnRefresh", js.Any.fromFunction1((t0: /* scrollToTopOnRefresh */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetScrollToTopOnRefreshUndefined: Self = StObject.set(x, "setScrollToTopOnRefresh", js.undefined)
    
    inline def setSetSelectedCls(value: /* selectedCls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setSelectedCls", js.Any.fromFunction1((t0: /* selectedCls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
    ...
    inline def setSetTriggerCtEvent(value: /* triggerCtEvent */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setTriggerCtEvent", js.Any.fromFunction1((t0: /* triggerCtEvent */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
    
    inline def setSetTriggerCtEventUndefined: Self = StObject.set(x, "setTriggerCtEvent", js.undefined)
    
    inline def setSetTriggerEvent(value: /* triggerEvent */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setTriggerEvent", js.Any.fromFunction1((t0: /* triggerEvent */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
    
    inline def setSetTriggerEventUndefined: Self = StObject.set(x, "setTriggerEvent", js.undefined)
    
    inline def setSetUseComponents(value: /* useComponents */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setUseComponents", js.Any.fromFunction1((t0: /* useComponents */ js.UndefOr[Boolean]) => value(t0).runNow()))
    ...
    inline def setUpdateLastFocused(value: (js.UndefOr[IRecord], js.UndefOr[IRecord]) => Callback): Self = StObject.set(x, "updateLastFocused", js.Any.fromFunction2((t0: js.UndefOr[IRecord], t1: js.UndefOr[IRecord]) => (value(t0, t1)).runNow()))
