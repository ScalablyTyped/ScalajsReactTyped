...
object ILongPress {
  ...
  def apply(
    ...
    getMinDuration: js.UndefOr[CallbackTo[Double]] = js.undefined,
    ...
    setMinDuration: /* minDuration */ js.UndefOr[Double] => Callback = null,
    ...
    getMinDuration.foreach(p => __obj.updateDynamic("getMinDuration")(p.toJsFn))
    ...
    if (setMinDuration != null) __obj.updateDynamic("setMinDuration")(js.Any.fromFunction1((t0: /* minDuration */ js.UndefOr[scala.Double]) => setMinDuration(t0).runNow()))
