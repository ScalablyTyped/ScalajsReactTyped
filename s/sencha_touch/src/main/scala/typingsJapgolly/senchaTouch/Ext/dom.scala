...
object dom {
  ...
  type ICompositeElement = typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite
  
  trait ICompositeElementLite
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.dom.IElement {
    ...
    var addCls_ICompositeElementLite: js.UndefOr[
        js.Function3[
          ...
          typingsJapgolly.senchaTouch.Ext.dom.IElement
        ]
      ] = js.undefined
    ...
    var appendChild_ICompositeElementLite: js.UndefOr[
        js.Function1[/* element */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var appendTo_ICompositeElementLite: js.UndefOr[
        js.Function1[/* el */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var applyStyles_ICompositeElementLite: js.UndefOr[
        js.Function1[/* styles */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    /** [Method] Returns a flyweight Element of the dom element object at the specified index
      ...
      */
    var item: js.UndefOr[
        js.Function1[/* index */ js.UndefOr[Double], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var radioCls_ICompositeElementLite: js.UndefOr[
        js.Function1[/* className */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    /** [Method] Forces the browser to repaint this element
      ...
      */
    @JSName("repaint")
    var repaint_ICompositeElementLite: js.UndefOr[js.Function0[typingsJapgolly.senchaTouch.Ext.dom.IElement]] = js.undefined
    ...
    var setBox_ICompositeElementLite: js.UndefOr[
        js.Function1[/* box */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var setHeight_ICompositeElementLite: js.UndefOr[
        js.Function1[/* height */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var setMaxWidth_ICompositeElementLite: js.UndefOr[
        js.Function1[/* width */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var setVisibilityMode_ICompositeElementLite: js.UndefOr[
        js.Function1[/* mode */ js.UndefOr[Any], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var setXY_ICompositeElementLite: js.UndefOr[
        js.Function1[/* pos */ js.UndefOr[Array], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var setX_ICompositeElementLite: js.UndefOr[
        js.Function1[/* x */ js.UndefOr[Double], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
    ...
    var setY_ICompositeElementLite: js.UndefOr[
        js.Function1[/* y */ js.UndefOr[Double], typingsJapgolly.senchaTouch.Ext.dom.IElement]
      ] = js.undefined
  ...
  object ICompositeElementLite {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite](x: Self) {
      
      inline def setAdd(
        value: (/* els */ js.UndefOr[Any], /* root */ js.UndefOr[Any]) => typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite
      ): Self = StObject.set(x, "add", js.Any.fromFunction2(value))
      
      inline def setAddCls(
        value: (/* names */ js.UndefOr[java.lang.String], /* prefix */ js.UndefOr[java.lang.String], /* suffix */ js.UndefOr[java.lang.String]) => typingsJapgolly.senchaTouch.Ext.dom.IElement
      ...
      inline def setAddListener(
        value: (/* eventName */ js.UndefOr[Any], /* handler */ js.UndefOr[Any], /* scope */ js.UndefOr[Any], /* opt */ js.UndefOr[Any]) => typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite
      ...
      inline def setAppendChild(value: /* element */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "appendChild", js.Any.fromFunction1(value))
      
      inline def setAppendChildUndefined: Self = StObject.set(x, "appendChild", js.undefined)
      
      inline def setAppendTo(value: /* el */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
      
      inline def setAppendToUndefined: Self = StObject.set(x, "appendTo", js.undefined)
      
      inline def setApplyStyles(value: /* styles */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "applyStyles", js.Any.fromFunction1(value))
      ...
      inline def setCreateChild(
        value: (/* config */ js.UndefOr[Any], /* insertBefore */ js.UndefOr[HTMLElement], /* returnDom */ js.UndefOr[Boolean]) => typingsJapgolly.senchaTouch.Ext.dom.IElement
      ...
      inline def setEach(
        value: (/* fn */ js.UndefOr[Any], /* scope */ js.UndefOr[Any]) => typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite
      ...
      inline def setFill(value: /* els */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite): Self = StObject.set(x, "fill", js.Any.fromFunction1(value))
      
      inline def setFillUndefined: Self = StObject.set(x, "fill", js.undefined)
      
      inline def setFilter(value: /* selector */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite): Self = StObject.set(x, "filter", js.Any.fromFunction1(value))
      ...
      inline def setInsertAfter(value: /* el */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
      
      inline def setInsertAfterUndefined: Self = StObject.set(x, "insertAfter", js.undefined)
      
      inline def setInsertBefore(value: /* el */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
      
      inline def setInsertBeforeUndefined: Self = StObject.set(x, "insertBefore", js.undefined)
      
      inline def setInsertFirst(value: /* element */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "insertFirst", js.Any.fromFunction1(value))
      
      inline def setInsertFirstUndefined: Self = StObject.set(x, "insertFirst", js.undefined)
      
      inline def setInsertSibling(
        value: (/* el */ js.UndefOr[Any], /* where */ js.UndefOr[java.lang.String], /* returnDom */ js.UndefOr[Boolean]) => typingsJapgolly.senchaTouch.Ext.dom.IElement
      ...
      inline def setItem(value: /* index */ js.UndefOr[Double] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "item", js.Any.fromFunction1(value))
      
      inline def setItemUndefined: Self = StObject.set(x, "item", js.undefined)
      
      inline def setRadioCls(value: /* className */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "radioCls", js.Any.fromFunction1(value))
      ...
      inline def setRemoveElement(
        value: (/* el */ js.UndefOr[Any], /* removeDom */ js.UndefOr[Boolean]) => typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite
      ...
      inline def setRepaint(value: CallbackTo[typingsJapgolly.senchaTouch.Ext.dom.IElement]): Self = StObject.set(x, "repaint", value.toJsFn)
      
      inline def setRepaintUndefined: Self = StObject.set(x, "repaint", js.undefined)
      
      inline def setReplace(value: /* element */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "replace", js.Any.fromFunction1(value))
      
      inline def setReplaceCls(
        value: (/* oldName */ js.UndefOr[java.lang.String], /* newName */ js.UndefOr[java.lang.String], /* prefix */ js.UndefOr[java.lang.String], /* suffix */ js.UndefOr[java.lang.String]) => typingsJapgolly.senchaTouch.Ext.dom.IElement
      ...
      inline def setReplaceElement(
        value: (/* el */ js.UndefOr[Any], /* replacement */ js.UndefOr[Any], /* domReplace */ js.UndefOr[Boolean]) => typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite
      ...
      inline def setReplaceWith(value: /* el */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "replaceWith", js.Any.fromFunction1(value))
      
      inline def setReplaceWithUndefined: Self = StObject.set(x, "replaceWith", js.undefined)
      
      inline def setSelect(
        value: (/* selector */ js.UndefOr[Any], /* composite */ js.UndefOr[Boolean]) => typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite
      ): Self = StObject.set(x, "select", js.Any.fromFunction2(value))
      
      inline def setSelectUndefined: Self = StObject.set(x, "select", js.undefined)
      
      inline def setSet(
        value: (/* attributes */ js.UndefOr[Any], /* useSet */ js.UndefOr[Boolean]) => typingsJapgolly.senchaTouch.Ext.dom.IElement
      ): Self = StObject.set(x, "set", js.Any.fromFunction2(value))
      
      inline def setSetBottom(value: /* bottom */ js.UndefOr[java.lang.String] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setBottom", js.Any.fromFunction1(value))
      
      inline def setSetBottomUndefined: Self = StObject.set(x, "setBottom", js.undefined)
      
      inline def setSetBox(value: /* box */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setBox", js.Any.fromFunction1(value))
      
      inline def setSetBoxUndefined: Self = StObject.set(x, "setBox", js.undefined)
      
      inline def setSetHeight(value: /* height */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setHeight", js.Any.fromFunction1(value))
      
      inline def setSetHeightUndefined: Self = StObject.set(x, "setHeight", js.undefined)
      
      inline def setSetLeft(value: /* left */ js.UndefOr[java.lang.String] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setLeft", js.Any.fromFunction1(value))
      
      inline def setSetLeftUndefined: Self = StObject.set(x, "setLeft", js.undefined)
      
      inline def setSetMaxHeight(value: /* height */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setMaxHeight", js.Any.fromFunction1(value))
      
      inline def setSetMaxHeightUndefined: Self = StObject.set(x, "setMaxHeight", js.undefined)
      
      inline def setSetMaxWidth(value: /* width */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setMaxWidth", js.Any.fromFunction1(value))
      
      inline def setSetMaxWidthUndefined: Self = StObject.set(x, "setMaxWidth", js.undefined)
      
      inline def setSetMinHeight(value: /* height */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setMinHeight", js.Any.fromFunction1(value))
      
      inline def setSetMinHeightUndefined: Self = StObject.set(x, "setMinHeight", js.undefined)
      
      inline def setSetMinWidth(value: /* width */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setMinWidth", js.Any.fromFunction1(value))
      
      inline def setSetMinWidthUndefined: Self = StObject.set(x, "setMinWidth", js.undefined)
      
      inline def setSetRight(value: /* right */ js.UndefOr[java.lang.String] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setRight", js.Any.fromFunction1(value))
      
      inline def setSetRightUndefined: Self = StObject.set(x, "setRight", js.undefined)
      
      inline def setSetSize(
        value: (/* width */ js.UndefOr[Any], /* height */ js.UndefOr[Any]) => typingsJapgolly.senchaTouch.Ext.dom.IElement
      ...
      inline def setSetStyle(
        value: (/* property */ js.UndefOr[Any], /* value */ js.UndefOr[java.lang.String]) => typingsJapgolly.senchaTouch.Ext.dom.IElement
      ...
      inline def setSetTop(value: /* top */ js.UndefOr[java.lang.String] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setTop", js.Any.fromFunction1(value))
      
      inline def setSetTopUndefined: Self = StObject.set(x, "setTop", js.undefined)
      
      inline def setSetUndefined: Self = StObject.set(x, "set", js.undefined)
      
      inline def setSetVisibilityMode(value: /* mode */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setVisibilityMode", js.Any.fromFunction1(value))
      
      inline def setSetVisibilityModeUndefined: Self = StObject.set(x, "setVisibilityMode", js.undefined)
      
      inline def setSetVisible(value: /* visible */ js.UndefOr[Boolean] => typingsJapgolly.senchaTouch.Ext.IElement): Self = StObject.set(x, "setVisible", js.Any.fromFunction1(value))
      
      inline def setSetVisibleUndefined: Self = StObject.set(x, "setVisible", js.undefined)
      
      inline def setSetWidth(value: /* width */ js.UndefOr[Any] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setWidth", js.Any.fromFunction1(value))
      
      inline def setSetWidthUndefined: Self = StObject.set(x, "setWidth", js.undefined)
      
      inline def setSetX(value: /* x */ js.UndefOr[Double] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setX", js.Any.fromFunction1(value))
      
      inline def setSetXUndefined: Self = StObject.set(x, "setX", js.undefined)
      
      inline def setSetXY(value: /* pos */ js.UndefOr[Array] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setXY", js.Any.fromFunction1(value))
      
      inline def setSetXYUndefined: Self = StObject.set(x, "setXY", js.undefined)
      
      inline def setSetY(value: /* y */ js.UndefOr[Double] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setY", js.Any.fromFunction1(value))
      
      inline def setSetYUndefined: Self = StObject.set(x, "setY", js.undefined)
      
      inline def setToggleCls(
        value: /* className */ js.UndefOr[java.lang.String] => typingsJapgolly.senchaTouch.Ext.dom.IElement
      ): Self = StObject.set(x, "toggleCls", js.Any.fromFunction1(value))
  ...
  object IElement {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.dom.IElement = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.dom.IElement]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.dom.IElement](x: Self) {
      ...
      inline def setCssTranslate(value: Callback): Self = StObject.set(x, "cssTranslate", value.toJsFn)
      ...
      inline def setGetHTML(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getHTML", value.toJsFn)
      ...
      inline def setGetOuterHeight(value: Callback): Self = StObject.set(x, "getOuterHeight", value.toJsFn)
      
      inline def setGetOuterHeightUndefined: Self = StObject.set(x, "getOuterHeight", js.undefined)
      
      inline def setGetOuterWidth(value: Callback): Self = StObject.set(x, "getOuterWidth", value.toJsFn)
      ...
      inline def setGetScrollParent(value: Callback): Self = StObject.set(x, "getScrollParent", value.toJsFn)
      ...
      inline def setIsDescendent(value: Callback): Self = StObject.set(x, "isDescendent", value.toJsFn)
      ...
      inline def setMask(value: Callback): Self = StObject.set(x, "mask", value.toJsFn)
      ...
      inline def setPurgeAllListeners(value: Callback): Self = StObject.set(x, "purgeAllListeners", value.toJsFn)
      ...
      inline def setSetCls(value: /* className */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setCls", js.Any.fromFunction1((t0: /* className */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setSetClsUndefined: Self = StObject.set(x, "setCls", js.undefined)
      
      inline def setSetHTML(value: /* html */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setHTML", js.Any.fromFunction1((t0: /* html */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      ...
      inline def setSetTopLeft(value: Callback): Self = StObject.set(x, "setTopLeft", value.toJsFn)
      ...
      inline def setSetVisible(value: /* visible */ js.UndefOr[Boolean] => typingsJapgolly.senchaTouch.Ext.dom.IElement): Self = StObject.set(x, "setVisible", js.Any.fromFunction1(value))
      ...
      inline def setUpdate(value: /* html */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "update", js.Any.fromFunction1((t0: /* html */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
