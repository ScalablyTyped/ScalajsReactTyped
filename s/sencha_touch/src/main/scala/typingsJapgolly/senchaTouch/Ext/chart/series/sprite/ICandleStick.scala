...
object ICandleStick {
  ...
  def apply(
    ...
    hide: js.UndefOr[CallbackTo[ICandleStick]] = js.undefined,
    ...
    renderClipped: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* clip */ js.UndefOr[js.Any], /* region */ js.UndefOr[js.Any]) => Callback = null,
    ...
    show: js.UndefOr[CallbackTo[ICandleStick]] = js.undefined,
    ...
    if (ohlcType != null) __obj.updateDynamic("ohlcType")(ohlcType.asInstanceOf[js.Any])
    ...
    if (renderClipped != null) __obj.updateDynamic("renderClipped")(js.Any.fromFunction4((t0: /* surface */ js.UndefOr[js.Any], t1: /* ctx */ js.UndefOr[js.Any], t2: /* clip */ js.UndefOr[js.Any], t3: /* region */ js.UndefOr[js.Any]) => renderClipped(t0, t1, t2, t3).runNow()))
