...
object ISimpleListItem {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[ISimpleListItem]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISimpleListItem] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISimpleListItem] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISimpleListItem], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.component.ISimpleListItem], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
