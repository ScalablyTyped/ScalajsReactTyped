package typingsJapgolly.senchaTouch.Ext.layout
...
object IVBox {
  ...
  def apply(
    ...
    animation: typingsJapgolly.senchaTouch.Ext.fx.layout.ICard = null,
    ...
    getAnimation: js.UndefOr[CallbackTo[typingsJapgolly.senchaTouch.Ext.fx.layout.ICard]] = js.undefined,
    ...
    getOrient: js.UndefOr[CallbackTo[String]] = js.undefined,
    getPack: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    onItemInnerStateChange: (/* item */ js.UndefOr[js.Any], /* isInner */ js.UndefOr[js.Any]) => Callback = null,
    pack: String = null,
    ...
    setAnimation: /* animation */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.fx.layout.ICard] => Callback = null,
    setBubbleEvents: /* bubbleEvents */ js.UndefOr[js.Any] => Callback = null,
    setItemFlex: (/* item */ js.UndefOr[IComponent], /* flex */ js.UndefOr[Double]) => Callback = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => Callback = null,
    setOrient: /* orient */ js.UndefOr[String] => Callback = null,
    setPack: /* pack */ js.UndefOr[String] => Callback = null,
    ...
    getOrient.foreach(p => __obj.updateDynamic("getOrient")(p.toJsFn))
    getPack.foreach(p => __obj.updateDynamic("getPack")(p.toJsFn))
    ...
    if (onItemInnerStateChange != null) __obj.updateDynamic("onItemInnerStateChange")(js.Any.fromFunction2((t0: /* item */ js.UndefOr[js.Any], t1: /* isInner */ js.UndefOr[js.Any]) => onItemInnerStateChange(t0, t1).runNow()))
    ...
    if (setAnimation != null) __obj.updateDynamic("setAnimation")(js.Any.fromFunction1((t0: /* animation */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.fx.layout.ICard]) => setAnimation(t0).runNow()))
    ...
    if (setItemFlex != null) __obj.updateDynamic("setItemFlex")(js.Any.fromFunction2((t0: /* item */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IComponent], t1: /* flex */ js.UndefOr[scala.Double]) => setItemFlex(t0, t1).runNow()))
    ...
    if (setOrient != null) __obj.updateDynamic("setOrient")(js.Any.fromFunction1((t0: /* orient */ js.UndefOr[java.lang.String]) => setOrient(t0).runNow()))
    if (setPack != null) __obj.updateDynamic("setPack")(js.Any.fromFunction1((t0: /* pack */ js.UndefOr[java.lang.String]) => setPack(t0).runNow()))
