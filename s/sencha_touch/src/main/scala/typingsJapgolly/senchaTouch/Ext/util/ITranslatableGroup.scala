...
object ITranslatableGroup {
  ...
  def apply(
    ...
    self: IClass = null,
    setActiveIndex: /* activeIndex */ js.UndefOr[Double] => Callback = null,
    ...
    if (setActiveIndex != null) __obj.updateDynamic("setActiveIndex")(js.Any.fromFunction1((t0: /* activeIndex */ js.UndefOr[scala.Double]) => setActiveIndex(t0).runNow()))
