...
object IHistory {
  ...
  def apply(
    actions: Array = null,
    add: (/* action */ js.UndefOr[IAction], /* silent */ js.UndefOr[Boolean]) => Callback = null,
    ...
    back: js.UndefOr[Callback] = js.undefined,
    ...
    getActions: js.UndefOr[CallbackTo[Array]] = js.undefined,
    ...
    getToken: js.UndefOr[CallbackTo[String]] = js.undefined,
    getUpdateUrl: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    self: IClass = null,
    setActions: /* actions */ js.UndefOr[Array] => Callback = null,
    setBubbleEvents: /* bubbleEvents */ js.UndefOr[js.Any] => Callback = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => Callback = null,
    setToken: /* token */ js.UndefOr[String] => Callback = null,
    setUpdateUrl: /* updateUrl */ js.UndefOr[Boolean] => Callback = null,
    ...
    if (add != null) __obj.updateDynamic("add")(js.Any.fromFunction2((t0: /* action */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.app.IAction], t1: /* silent */ js.UndefOr[scala.Boolean]) => add(t0, t1).runNow()))
    ...
    back.foreach(p => __obj.updateDynamic("back")(p.toJsFn))
    ...
    getUpdateUrl.foreach(p => __obj.updateDynamic("getUpdateUrl")(p.toJsFn))
    ...
    if (setActions != null) __obj.updateDynamic("setActions")(js.Any.fromFunction1((t0: /* actions */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.Array]) => setActions(t0).runNow()))
    ...
    if (setToken != null) __obj.updateDynamic("setToken")(js.Any.fromFunction1((t0: /* token */ js.UndefOr[java.lang.String]) => setToken(t0).runNow()))
    if (setUpdateUrl != null) __obj.updateDynamic("setUpdateUrl")(js.Any.fromFunction1((t0: /* updateUrl */ js.UndefOr[scala.Boolean]) => setUpdateUrl(t0).runNow()))
