...
object contacts {
  ...
  object IAbstract {
    ...
    extension [Self <: IAbstract](x: Self) {
      ...
      inline def setGetIncludeImages(value: CallbackTo[Boolean]): Self = StObject.set(x, "getIncludeImages", value.toJsFn)
      ...
      inline def setSetIncludeImages(value: /* includeImages */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setIncludeImages", js.Any.fromFunction1((t0: /* includeImages */ js.UndefOr[Boolean]) => value(t0).runNow()))
