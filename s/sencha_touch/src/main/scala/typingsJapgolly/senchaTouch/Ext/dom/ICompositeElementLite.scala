...
trait ICompositeElementLite extends IElement {
  ...
  var setVisible_ICompositeElementLite: js.UndefOr[
    js.Function1[/* visible */ js.UndefOr[Boolean], typingsJapgolly.senchaTouch.Ext.IElement]
  ] = js.undefined
...
object ICompositeElementLite {
  ...
  def apply(
    ...
    add: (/* els */ js.UndefOr[js.Any], /* root */ js.UndefOr[js.Any]) => CallbackTo[ICompositeElementLite] = null,
    ...
    addListener: (/* eventName */ js.UndefOr[js.Any], /* handler */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any], /* opt */ js.UndefOr[js.Any]) => CallbackTo[ICompositeElementLite] = null,
    ...
    each: (/* fn */ js.UndefOr[js.Any], /* scope */ js.UndefOr[js.Any]) => CallbackTo[ICompositeElementLite] = null,
    elements: Array = null,
    enableBubble: /* events */ js.UndefOr[js.Any] => Callback = null,
    extend: String = null,
    fill: /* els */ js.UndefOr[js.Any] => CallbackTo[ICompositeElementLite] = null,
    filter: /* selector */ js.UndefOr[js.Any] => CallbackTo[ICompositeElementLite] = null,
    ...
    item: /* index */ js.UndefOr[Double] => CallbackTo[IElement] = null,
    ...
    removeElement: (/* el */ js.UndefOr[js.Any], /* removeDom */ js.UndefOr[Boolean]) => CallbackTo[ICompositeElementLite] = null,
    ...
    replaceElement: (/* el */ js.UndefOr[js.Any], /* replacement */ js.UndefOr[js.Any], /* domReplace */ js.UndefOr[Boolean]) => CallbackTo[ICompositeElementLite] = null,
    ...
    select: (/* selector */ js.UndefOr[js.Any], /* composite */ js.UndefOr[Boolean]) => CallbackTo[ICompositeElementLite] = null,
    self: IClass = null,
    ...
    setVisible: /* visible */ js.UndefOr[Boolean] => CallbackTo[typingsJapgolly.senchaTouch.Ext.IElement] = null,
