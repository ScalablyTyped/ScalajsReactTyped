...
object IPath {
  ...
  extension [Self <: IPath](x: Self) {
    ...
    inline def setUpdatePath(value: (/* path */ js.UndefOr[IPath], /* attr */ js.UndefOr[Any]) => Callback): Self = StObject.set(x, "updatePath", js.Any.fromFunction2((t0: /* path */ js.UndefOr[IPath], t1: /* attr */ js.UndefOr[Any]) => (value(t0, t1)).runNow()))
    
    inline def setUpdatePathUndefined: Self = StObject.set(x, "updatePath", js.undefined)
    
    inline def setUpdateTransformedBBox(value: /* transform */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "updateTransformedBBox", js.Any.fromFunction1((t0: /* transform */ js.UndefOr[Any]) => value(t0).runNow()))
