...
object IPath {
  ...
  def apply(
    ...
    hide: js.UndefOr[CallbackTo[IPath]] = js.undefined,
    ...
    show: js.UndefOr[CallbackTo[IPath]] = js.undefined,
    ...
    updatePath: (/* path */ js.UndefOr[IPath], /* attr */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (updatePath != null) __obj.updateDynamic("updatePath")(js.Any.fromFunction2((t0: /* path */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.draw.sprite.IPath], t1: /* attr */ js.UndefOr[js.Any]) => updatePath(t0, t1).runNow()))
