...
object ICrosshair {
  ...
  def apply(
    ...
    getLines: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    setLines: /* lines */ js.UndefOr[js.Any] => Callback = null,
    ...
    getLines.foreach(p => __obj.updateDynamic("getLines")(p.toJsFn))
    ...
    if (setLines != null) __obj.updateDynamic("setLines")(js.Any.fromFunction1((t0: /* lines */ js.UndefOr[js.Any]) => setLines(t0).runNow()))
