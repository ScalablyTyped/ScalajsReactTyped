...
object ICandleStick {
  ...
  def apply(
    ...
    getCloseField: js.UndefOr[CallbackTo[String]] = js.undefined,
    getColors: js.UndefOr[CallbackTo[Array]] = js.undefined,
    getHidden: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getHighField: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    setCloseField: /* closeField */ js.UndefOr[String] => Callback = null,
    ...
    setHighField: /* highField */ js.UndefOr[String] => Callback = null,
    ...
    getCloseField.foreach(p => __obj.updateDynamic("getCloseField")(p.toJsFn))
    getColors.foreach(p => __obj.updateDynamic("getColors")(p.toJsFn))
    getHidden.foreach(p => __obj.updateDynamic("getHidden")(p.toJsFn))
    getHighField.foreach(p => __obj.updateDynamic("getHighField")(p.toJsFn))
    ...
    getLowField.foreach(p => __obj.updateDynamic("getLowField")(p.toJsFn))
    ...
    getOpenField.foreach(p => __obj.updateDynamic("getOpenField")(p.toJsFn))
    ...
    if (setCloseField != null) __obj.updateDynamic("setCloseField")(js.Any.fromFunction1((t0: /* closeField */ js.UndefOr[java.lang.String]) => setCloseField(t0).runNow()))
    ...
    if (setHighField != null) __obj.updateDynamic("setHighField")(js.Any.fromFunction1((t0: /* highField */ js.UndefOr[java.lang.String]) => setHighField(t0).runNow()))
    ...
    if (setLowField != null) __obj.updateDynamic("setLowField")(js.Any.fromFunction1((t0: /* lowField */ js.UndefOr[java.lang.String]) => setLowField(t0).runNow()))
    ...
    if (setOpenField != null) __obj.updateDynamic("setOpenField")(js.Any.fromFunction1((t0: /* openField */ js.UndefOr[java.lang.String]) => setOpenField(t0).runNow()))
