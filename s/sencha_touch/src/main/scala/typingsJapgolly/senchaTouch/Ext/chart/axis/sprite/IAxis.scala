package typingsJapgolly.senchaTouch.Ext.chart.axis.sprite
...
- typingsJapgolly.senchaTouch.Ext.chart.IMarkerHolder because var conflicts: alias, alternateClassName, callOverridden, callParent, callSuper, config, destroy, extend, getInitialConfig, inheritableStatics, initConfig, mixins, platformConfig, self, singleton, statics, uses. Inlined bindMarker */ trait IAxis extends ISprite {
...
object IAxis {
  ...
  def apply(
    ...
    attr: js.Any = null,
    axis: typingsJapgolly.senchaTouch.Ext.chart.axis.IAxis = null,
    ...
    getBBox: js.UndefOr[Callback] = js.undefined,
    ...
    hide: js.UndefOr[CallbackTo[IAxis]] = js.undefined,
    ...
    setRenderer: /* renderer */ js.UndefOr[js.Any] => Callback = null,
    setSegmenter: /* segmenter */ js.UndefOr[js.Any] => Callback = null,
    shadowBlur: Int | Double = null,
    shadowColor: String = null,
    shadowOffsetX: Int | Double = null,
    shadowOffsetY: Int | Double = null,
    show: js.UndefOr[CallbackTo[IAxis]] = js.undefined,
    ...
    if (setAxis != null) __obj.updateDynamic("setAxis")(js.Any.fromFunction1((t0: /* axis */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.chart.axis.sprite.IAxis]) => setAxis(t0).runNow()))
