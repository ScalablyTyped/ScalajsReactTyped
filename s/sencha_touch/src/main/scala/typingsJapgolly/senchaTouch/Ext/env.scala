...
object env {
  ...
  object IBrowser {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.env.IBrowser = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.env.IBrowser]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.env.IBrowser](x: Self) {
