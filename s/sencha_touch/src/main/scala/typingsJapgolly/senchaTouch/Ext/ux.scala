...
object ux {
  ...
  object IMenuButton {
    ...
    extension [Self <: IMenuButton](x: Self) {
      ...
      inline def setGetMenuItems(value: CallbackTo[Array]): Self = StObject.set(x, "getMenuItems", value.toJsFn)
      
      inline def setGetMenuItemsUndefined: Self = StObject.set(x, "getMenuItems", js.undefined)
      
      inline def setSetMenuItems(value: /* menuItems */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setMenuItems", js.Any.fromFunction1((t0: /* menuItems */ js.UndefOr[Array]) => value(t0).runNow()))
  ...
  object device {
    ...
    trait ITwitter
      extends StObject
         with typingsJapgolly.senchaTouch.Ext.ux.device.twitter.IAbstract
    object ITwitter {
    ...
    object analytics {
      ...
      object IAbstract {
        ...
        extension [Self <: IAbstract](x: Self) {
          ...
          inline def setGetAccountID(value: CallbackTo[Any]): Self = StObject.set(x, "getAccountID", value.toJsFn)
          
          inline def setGetAccountIDUndefined: Self = StObject.set(x, "getAccountID", js.undefined)
          
          inline def setRegisterAccount(value: /* accountID */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "registerAccount", js.Any.fromFunction1((t0: /* accountID */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
          
          inline def setRegisterAccountUndefined: Self = StObject.set(x, "registerAccount", js.undefined)
          
          inline def setSetAccountID(value: /* accountID */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setAccountID", js.Any.fromFunction1((t0: /* accountID */ js.UndefOr[Any]) => value(t0).runNow()))
          
          inline def setSetAccountIDUndefined: Self = StObject.set(x, "setAccountID", js.undefined)
          
          inline def setTrackEvent(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "trackEvent", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
          
          inline def setTrackEventUndefined: Self = StObject.set(x, "trackEvent", js.undefined)
          
          inline def setTrackPageview(value: /* config */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "trackPageview", js.Any.fromFunction1((t0: /* config */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      ...
      object ICordova {
        ...
        extension [Self <: ICordova](x: Self) {
          ...
          inline def setTrackPageview(value: /* page */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "trackPageview", js.Any.fromFunction1((t0: /* page */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    object twitter {
      ...
      object IAbstract {
        ...
        inline def apply(): typingsJapgolly.senchaTouch.Ext.ux.device.twitter.IAbstract = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.ux.device.twitter.IAbstract]
        }
        
        extension [Self <: typingsJapgolly.senchaTouch.Ext.ux.device.twitter.IAbstract](x: Self) {
          
          inline def setCompose(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "compose", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
          
          inline def setComposeUndefined: Self = StObject.set(x, "compose", js.undefined)
          
          inline def setGetMentions(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getMentions", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
          
          inline def setGetMentionsUndefined: Self = StObject.set(x, "getMentions", js.undefined)
          
          inline def setGetPublicTimeline(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getPublicTimeline", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
          
          inline def setGetPublicTimelineUndefined: Self = StObject.set(x, "getPublicTimeline", js.undefined)
          
          inline def setGetTwitterRequest(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getTwitterRequest", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
          
          inline def setGetTwitterRequestUndefined: Self = StObject.set(x, "getTwitterRequest", js.undefined)
          
          inline def setGetTwitterUsername(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getTwitterUsername", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
