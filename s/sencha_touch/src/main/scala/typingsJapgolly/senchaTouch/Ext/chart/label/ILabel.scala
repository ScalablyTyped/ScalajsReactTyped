...
object ILabel {
  ...
  def apply(
    ...
    getField: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getFx: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    hide: js.UndefOr[CallbackTo[ILabel]] = js.undefined,
    ...
    setField: /* field */ js.UndefOr[js.Any] => Callback = null,
    setFx: /* fx */ js.UndefOr[js.Any] => Callback = null,
    ...
    show: js.UndefOr[CallbackTo[ILabel]] = js.undefined,
    ...
    getFx.foreach(p => __obj.updateDynamic("getFx")(p.toJsFn))
    ...
    if (setField != null) __obj.updateDynamic("setField")(js.Any.fromFunction1((t0: /* field */ js.UndefOr[js.Any]) => setField(t0).runNow()))
    if (setFx != null) __obj.updateDynamic("setFx")(js.Any.fromFunction1((t0: /* fx */ js.UndefOr[js.Any]) => setFx(t0).runNow()))
