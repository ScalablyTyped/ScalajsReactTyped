...
import typingsJapgolly.senchaTouch.Ext.ISheet
...
object IPicker {
  ...
  def apply(
    ...
    getToolbarPosition: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    setToolbarPosition: /* toolbarPosition */ js.UndefOr[String] => Callback = null,
