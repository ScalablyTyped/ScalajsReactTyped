...
object IProfile {
  ...
  def apply(
    ...
    launch: js.UndefOr[Callback] = js.undefined,
    ...
    setNamespace: /* namespace */ js.UndefOr[String] => Callback = null,
    ...
    launch.foreach(p => __obj.updateDynamic("launch")(p.toJsFn))
    ...
    if (setNamespace != null) __obj.updateDynamic("setNamespace")(js.Any.fromFunction1((t0: /* namespace */ js.UndefOr[java.lang.String]) => setNamespace(t0).runNow()))
