...
object Element extends js.Object {
  ...
  /** [Method] Gets the globally shared flyweight Element with the passed node as the active element
  		...
  		*/
  def fly(): typingsJapgolly.senchaTouch.Ext.dom.IElement = js.native
  def fly(element: js.Any): typingsJapgolly.senchaTouch.Ext.dom.IElement = js.native
  def fly(element: js.Any, named: java.lang.String): typingsJapgolly.senchaTouch.Ext.dom.IElement = js.native
  ...
  /** [Method] Retrieves Ext dom Element objects
  		...
  		*/
  def get(): typingsJapgolly.senchaTouch.Ext.dom.IElement = js.native
  def get(element: js.Any): typingsJapgolly.senchaTouch.Ext.dom.IElement = js.native
  ...
  /** [Method] Selects elements based on the passed CSS selector to enable Element methods to be applied to many related elements in
  		...
  		*/
  def select(): typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite = js.native
  def select(selector: js.Any): typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite = js.native
  def select(selector: js.Any, composite: Boolean): typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite = js.native
  def select(selector: js.Any, composite: Boolean, root: js.Any): typingsJapgolly.senchaTouch.Ext.dom.ICompositeElementLite = js.native
