...
object IScatter {
  ...
  def apply(
    ...
    hide: js.UndefOr[CallbackTo[IScatter]] = js.undefined,
    ...
    renderClipped: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* clip */ js.UndefOr[js.Any], /* clipRegion */ js.UndefOr[js.Any]) => Callback = null,
    ...
    show: js.UndefOr[CallbackTo[IScatter]] = js.undefined,
    ...
    if (renderClipped != null) __obj.updateDynamic("renderClipped")(js.Any.fromFunction4((t0: /* surface */ js.UndefOr[js.Any], t1: /* ctx */ js.UndefOr[js.Any], t2: /* clip */ js.UndefOr[js.Any], t3: /* clipRegion */ js.UndefOr[js.Any]) => renderClipped(t0, t1, t2, t3).runNow()))
