...
object ISQLResultSet {
  ...
  def apply(
    ...
    getInsertId: js.UndefOr[CallbackTo[Double]] = js.undefined,
    getRows: js.UndefOr[CallbackTo[ISQLResultSetRowList]] = js.undefined,
    getRowsAffected: js.UndefOr[CallbackTo[Double]] = js.undefined,
    ...
    getInsertId.foreach(p => __obj.updateDynamic("getInsertId")(p.toJsFn))
    getRows.foreach(p => __obj.updateDynamic("getRows")(p.toJsFn))
    getRowsAffected.foreach(p => __obj.updateDynamic("getRowsAffected")(p.toJsFn))
