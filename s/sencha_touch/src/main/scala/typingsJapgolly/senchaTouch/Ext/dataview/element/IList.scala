...
object IList {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IList]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IList] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IList] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IList], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.element.IList], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
