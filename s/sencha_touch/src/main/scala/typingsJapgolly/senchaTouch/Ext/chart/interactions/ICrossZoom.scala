...
object ICrossZoom {
  ...
  def apply(
    ...
    getUndoButton: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    setUndoButton: /* undoButton */ js.UndefOr[js.Any] => Callback = null,
    ...
    getUndoButton.foreach(p => __obj.updateDynamic("getUndoButton")(p.toJsFn))
    ...
    if (setUndoButton != null) __obj.updateDynamic("setUndoButton")(js.Any.fromFunction1((t0: /* undoButton */ js.UndefOr[js.Any]) => setUndoButton(t0).runNow()))
