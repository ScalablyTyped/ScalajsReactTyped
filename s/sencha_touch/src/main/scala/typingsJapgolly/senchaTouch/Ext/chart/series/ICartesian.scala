...
object ICartesian {
  ...
  extension [Self <: ICartesian](x: Self) {
    ...
    inline def setGetXAxis(value: CallbackTo[IAxis]): Self = StObject.set(x, "getXAxis", value.toJsFn)
    ...
    inline def setGetYAxis(value: CallbackTo[IAxis]): Self = StObject.set(x, "getYAxis", value.toJsFn)
    ...
    inline def setProvideLegendInfo(value: /* target */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "provideLegendInfo", js.Any.fromFunction1((t0: /* target */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setProvideLegendInfoUndefined: Self = StObject.set(x, "provideLegendInfo", js.undefined)
    
    inline def setSetXAxis(value: /* xAxis */ js.UndefOr[IAxis] => Callback): Self = StObject.set(x, "setXAxis", js.Any.fromFunction1((t0: /* xAxis */ js.UndefOr[IAxis]) => value(t0).runNow()))
    ...
    inline def setSetYAxis(value: /* yAxis */ js.UndefOr[IAxis] => Callback): Self = StObject.set(x, "setYAxis", js.Any.fromFunction1((t0: /* yAxis */ js.UndefOr[IAxis]) => value(t0).runNow()))
