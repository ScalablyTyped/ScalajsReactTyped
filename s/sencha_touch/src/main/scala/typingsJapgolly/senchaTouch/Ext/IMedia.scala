...
object IMedia {
  ...
  extension [Self <: IMedia](x: Self) {
    ...
    inline def setGetAutoPause(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAutoPause", value.toJsFn)
    
    inline def setGetAutoPauseUndefined: Self = StObject.set(x, "getAutoPause", js.undefined)
    
    inline def setGetAutoResume(value: CallbackTo[Boolean]): Self = StObject.set(x, "getAutoResume", value.toJsFn)
    ...
    inline def setGetEnableControls(value: CallbackTo[Boolean]): Self = StObject.set(x, "getEnableControls", value.toJsFn)
    ...
    inline def setGetMedia(value: CallbackTo[IElement]): Self = StObject.set(x, "getMedia", value.toJsFn)
    
    inline def setGetMediaUndefined: Self = StObject.set(x, "getMedia", js.undefined)
    
    inline def setGetMuted(value: CallbackTo[Boolean]): Self = StObject.set(x, "getMuted", value.toJsFn)
    
    inline def setGetMutedUndefined: Self = StObject.set(x, "getMuted", js.undefined)
    
    inline def setGetPreload(value: CallbackTo[Boolean]): Self = StObject.set(x, "getPreload", value.toJsFn)
    ...
    inline def setSetAutoPause(value: /* autoPause */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAutoPause", js.Any.fromFunction1((t0: /* autoPause */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetAutoPauseUndefined: Self = StObject.set(x, "setAutoPause", js.undefined)
    
    inline def setSetAutoResume(value: /* autoResume */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAutoResume", js.Any.fromFunction1((t0: /* autoResume */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetAutoResumeUndefined: Self = StObject.set(x, "setAutoResume", js.undefined)
    
    inline def setSetEnableControls(value: /* enableControls */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setEnableControls", js.Any.fromFunction1((t0: /* enableControls */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetEnableControlsUndefined: Self = StObject.set(x, "setEnableControls", js.undefined)
    
    inline def setSetLoop(value: /* loop */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setLoop", js.Any.fromFunction1((t0: /* loop */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetLoopUndefined: Self = StObject.set(x, "setLoop", js.undefined)
    
    inline def setSetMedia(value: /* media */ js.UndefOr[IElement] => Callback): Self = StObject.set(x, "setMedia", js.Any.fromFunction1((t0: /* media */ js.UndefOr[IElement]) => value(t0).runNow()))
    
    inline def setSetMediaUndefined: Self = StObject.set(x, "setMedia", js.undefined)
    
    inline def setSetMuted(value: /* muted */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setMuted", js.Any.fromFunction1((t0: /* muted */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetMutedUndefined: Self = StObject.set(x, "setMuted", js.undefined)
    
    inline def setSetPreload(value: /* preload */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setPreload", js.Any.fromFunction1((t0: /* preload */ js.UndefOr[Boolean]) => value(t0).runNow()))
    ...
    inline def setSetVolume(value: /* volume */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setVolume", js.Any.fromFunction1((t0: /* volume */ js.UndefOr[Double]) => value(t0).runNow()))
    ...
    inline def setUpdateEnableControls(value: /* enableControls */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "updateEnableControls", js.Any.fromFunction1((t0: /* enableControls */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setUpdateEnableControlsUndefined: Self = StObject.set(x, "updateEnableControls", js.undefined)
    
    inline def setUpdateLoop(value: /* loop */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "updateLoop", js.Any.fromFunction1((t0: /* loop */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setUpdateLoopUndefined: Self = StObject.set(x, "updateLoop", js.undefined)
    
    inline def setUpdateUrl(value: /* newUrl */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "updateUrl", js.Any.fromFunction1((t0: /* newUrl */ js.UndefOr[Any]) => value(t0).runNow()))
