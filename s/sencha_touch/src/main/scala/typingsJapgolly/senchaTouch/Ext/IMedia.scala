...
object IMedia {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IMedia]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IMedia] = null,
    ...
    setUrl: /* url */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IMedia] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IMedia], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IMedia], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
