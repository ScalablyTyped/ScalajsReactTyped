...
object connection {
  ...
  object IAbstract {
    ...
    extension [Self <: IAbstract](x: Self) {
      ...
      inline def setGetOnline(value: CallbackTo[Boolean]): Self = StObject.set(x, "getOnline", value.toJsFn)
      ...
      inline def setSetOnline(value: /* online */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setOnline", js.Any.fromFunction1((t0: /* online */ js.UndefOr[Boolean]) => value(t0).runNow()))
