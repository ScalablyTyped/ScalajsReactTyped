...
object IActionOverFlowMenuButton {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IActionOverFlowMenuButton]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IActionOverFlowMenuButton] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IActionOverFlowMenuButton] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IActionOverFlowMenuButton], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.ux.IActionOverFlowMenuButton], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
