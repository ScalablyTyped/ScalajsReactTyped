...
object IIndicator {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IIndicator]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IIndicator] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IIndicator] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IIndicator], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.carousel.IIndicator], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
