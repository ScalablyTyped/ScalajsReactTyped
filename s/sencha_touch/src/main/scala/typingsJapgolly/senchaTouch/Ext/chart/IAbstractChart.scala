...
object IAbstractChart {
  ...
  extension [Self <: IAbstractChart](x: Self) {
    ...
    inline def setCancelLayout(value: Callback): Self = StObject.set(x, "cancelLayout", value.toJsFn)
    ...
    inline def setGetColors(value: CallbackTo[Any]): Self = StObject.set(x, "getColors", value.toJsFn)
    ...
    inline def setGetInnerPadding(value: CallbackTo[Any]): Self = StObject.set(x, "getInnerPadding", value.toJsFn)
    
    inline def setGetInnerPaddingUndefined: Self = StObject.set(x, "getInnerPadding", js.undefined)
    
    inline def setGetInsetPadding(value: CallbackTo[Any]): Self = StObject.set(x, "getInsetPadding", value.toJsFn)
    
    inline def setGetInsetPaddingUndefined: Self = StObject.set(x, "getInsetPadding", js.undefined)
    
    inline def setGetInteractions(value: CallbackTo[Array]): Self = StObject.set(x, "getInteractions", value.toJsFn)
    ...
    inline def setGetLegend(value: CallbackTo[Any]): Self = StObject.set(x, "getLegend", value.toJsFn)
    
    inline def setGetLegendStore(value: CallbackTo[IStore]): Self = StObject.set(x, "getLegendStore", value.toJsFn)
    ...
    inline def setGetSeries(value: CallbackTo[Any]): Self = StObject.set(x, "getSeries", value.toJsFn)
    
    inline def setGetSeriesUndefined: Self = StObject.set(x, "getSeries", js.undefined)
    
    inline def setGetShadow(value: CallbackTo[Any]): Self = StObject.set(x, "getShadow", value.toJsFn)
    ...
    inline def setResumeThicknessChanged(value: Callback): Self = StObject.set(x, "resumeThicknessChanged", value.toJsFn)
    
    inline def setResumeThicknessChangedUndefined: Self = StObject.set(x, "resumeThicknessChanged", js.undefined)
    
    inline def setScheduleLayout(value: Callback): Self = StObject.set(x, "scheduleLayout", value.toJsFn)
    ...
    inline def setSetColors(value: /* colors */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setColors", js.Any.fromFunction1((t0: /* colors */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setSetInnerPadding(value: /* innerPadding */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setInnerPadding", js.Any.fromFunction1((t0: /* innerPadding */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetInnerPaddingUndefined: Self = StObject.set(x, "setInnerPadding", js.undefined)
    
    inline def setSetInsetPadding(value: /* insetPadding */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setInsetPadding", js.Any.fromFunction1((t0: /* insetPadding */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetInsetPaddingUndefined: Self = StObject.set(x, "setInsetPadding", js.undefined)
    
    inline def setSetInteractions(value: /* interactions */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "setInteractions", js.Any.fromFunction1((t0: /* interactions */ js.UndefOr[Array]) => value(t0).runNow()))
    
    inline def setSetInteractionsUndefined: Self = StObject.set(x, "setInteractions", js.undefined)
    
    inline def setSetLegend(value: /* legend */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setLegend", js.Any.fromFunction1((t0: /* legend */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetLegendUndefined: Self = StObject.set(x, "setLegend", js.undefined)
    
    inline def setSetSeries(value: /* series */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setSeries", js.Any.fromFunction1((t0: /* series */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetSeriesUndefined: Self = StObject.set(x, "setSeries", js.undefined)
    
    inline def setSetShadow(value: /* shadow */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "setShadow", js.Any.fromFunction1((t0: /* shadow */ js.UndefOr[Any]) => value(t0).runNow()))
    
    inline def setSetShadowUndefined: Self = StObject.set(x, "setShadow", js.undefined)
    
    inline def setSetStore(value: /* store */ js.UndefOr[IStore] => Callback): Self = StObject.set(x, "setStore", js.Any.fromFunction1((t0: /* store */ js.UndefOr[IStore]) => value(t0).runNow()))
    ...
    inline def setSuspendThicknessChanged(value: Callback): Self = StObject.set(x, "suspendThicknessChanged", value.toJsFn)
