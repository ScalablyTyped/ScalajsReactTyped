...
object ILoadMask {
  ...
  def apply(
    ...
    getIndicator: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    getMessage: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    getMessageCls: js.UndefOr[CallbackTo[java.lang.String]] = js.undefined,
    ...
    getParent: js.UndefOr[CallbackTo[ILoadMask]] = js.undefined,
    ...
    getTransparent: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ILoadMask] = null,
    ...
    setMessageCls: /* messageCls */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    setTransparent: /* transparent */ js.UndefOr[Boolean] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ILoadMask] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ILoadMask], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    getMessageCls.foreach(p => __obj.updateDynamic("getMessageCls")(p.toJsFn))
    ...
    getTransparent.foreach(p => __obj.updateDynamic("getTransparent")(p.toJsFn))
    ...
    if (setMessageCls != null) __obj.updateDynamic("setMessageCls")(js.Any.fromFunction1((t0: /* messageCls */ js.UndefOr[java.lang.String]) => setMessageCls(t0).runNow()))
    ...
    if (setTransparent != null) __obj.updateDynamic("setTransparent")(js.Any.fromFunction1((t0: /* transparent */ js.UndefOr[scala.Boolean]) => setTransparent(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.ILoadMask], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
