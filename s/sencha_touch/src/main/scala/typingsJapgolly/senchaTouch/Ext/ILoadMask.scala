...
object ILoadMask {
  ...
  extension [Self <: ILoadMask](x: Self) {
    ...
    inline def setBindStore(value: /* store */ js.UndefOr[IStore] => Callback): Self = StObject.set(x, "bindStore", js.Any.fromFunction1((t0: /* store */ js.UndefOr[IStore]) => value(t0).runNow()))
    ...
    inline def setGetIndicator(value: CallbackTo[Boolean]): Self = StObject.set(x, "getIndicator", value.toJsFn)
    ...
    inline def setGetMessageCls(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getMessageCls", value.toJsFn)
    ...
    inline def setSetMessageCls(value: /* messageCls */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setMessageCls", js.Any.fromFunction1((t0: /* messageCls */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
