package typingsJapgolly.senchaTouch.Ext.device.connection
...
object IAbstract {
  ...
  def apply(
    ...
    getOnline: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    isOnline: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    setOnline: /* online */ js.UndefOr[Boolean] => Callback = null,
    ...
    if (CELL_2G != null) __obj.updateDynamic("CELL_2G")(CELL_2G.asInstanceOf[js.Any])
    if (CELL_3G != null) __obj.updateDynamic("CELL_3G")(CELL_3G.asInstanceOf[js.Any])
    if (CELL_4G != null) __obj.updateDynamic("CELL_4G")(CELL_4G.asInstanceOf[js.Any])
    ...
    getOnline.foreach(p => __obj.updateDynamic("getOnline")(p.toJsFn))
    ...
    isOnline.foreach(p => __obj.updateDynamic("isOnline")(p.toJsFn))
    ...
    if (setOnline != null) __obj.updateDynamic("setOnline")(js.Any.fromFunction1((t0: /* online */ js.UndefOr[scala.Boolean]) => setOnline(t0).runNow()))
