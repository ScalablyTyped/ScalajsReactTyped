...
object ICordova {
  ...
  def apply(
    ...
    capture: /* args */ js.UndefOr[js.Any] => Callback = null,
    config: js.Any = null,
    ...
    if (capture != null) __obj.updateDynamic("capture")(js.Any.fromFunction1((t0: /* args */ js.UndefOr[js.Any]) => capture(t0).runNow()))
