...
object IDroppable {
  ...
  extension [Self <: IDroppable](x: Self) {
    ...
    inline def setGetBaseCls(value: CallbackTo[String]): Self = StObject.set(x, "getBaseCls", value.toJsFn)
    ...
    inline def setIsMonitoring(value: CallbackTo[Boolean]): Self = StObject.set(x, "isMonitoring", value.toJsFn)
    ...
    inline def setSetBaseCls(value: /* baseCls */ js.UndefOr[String] => Callback): Self = StObject.set(x, "setBaseCls", js.Any.fromFunction1((t0: /* baseCls */ js.UndefOr[String]) => value(t0).runNow()))
