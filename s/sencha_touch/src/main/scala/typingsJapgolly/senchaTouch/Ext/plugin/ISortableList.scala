...
object ISortableList {
  ...
  def apply(
    ...
    getHandleSelector: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getList: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    getParent: js.UndefOr[CallbackTo[ISortableList]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISortableList] = null,
    ...
    setHandleSelector: /* handleSelector */ js.UndefOr[String] => Callback = null,
    ...
    setList: /* list */ js.UndefOr[js.Any] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ISortableList] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ISortableList], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    getHandleSelector.foreach(p => __obj.updateDynamic("getHandleSelector")(p.toJsFn))
    ...
    if (setHandleSelector != null) __obj.updateDynamic("setHandleSelector")(js.Any.fromFunction1((t0: /* handleSelector */ js.UndefOr[java.lang.String]) => setHandleSelector(t0).runNow()))
    ...
    if (setList != null) __obj.updateDynamic("setList")(js.Any.fromFunction1((t0: /* list */ js.UndefOr[js.Any]) => setList(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.plugin.ISortableList], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
