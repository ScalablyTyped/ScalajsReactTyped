package typingsJapgolly.senchaTouch.Ext.ux

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.senchaTouch.Ext.Array
import typingsJapgolly.senchaTouch.Ext.IButton
...
object IMenuButton {
  ...
  def apply(
    ...
    getAutoEvent: js.UndefOr[CallbackTo[String]] = js.undefined,
    getBadgeCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    getBadgeText: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getHandler: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    getIcon: js.UndefOr[CallbackTo[String]] = js.undefined,
    getIconAlign: js.UndefOr[CallbackTo[String]] = js.undefined,
    getIconCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getParent: js.UndefOr[CallbackTo[IMenuButton]] = js.undefined,
    getPlugins: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getPressedCls: js.UndefOr[CallbackTo[String]] = js.undefined,
    getPressedDelay: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    getText: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IMenuButton] = null,
    ...
    scroll: js.Any = null,
    self: IClass = null,
    setAutoEvent: /* autoEvent */ js.UndefOr[String] => Callback = null,
    setBadge: /* text */ js.UndefOr[String] => Callback = null,
    setBadgeCls: /* badgeCls */ js.UndefOr[String] => Callback = null,
    setBadgeText: /* badgeText */ js.UndefOr[String] => Callback = null,
    ...
    setHandler: /* handler */ js.UndefOr[js.Any] => Callback = null,
    ...
    setIconAlign: /* iconAlign */ js.UndefOr[String] => Callback = null,
    setIconClass: /* iconClass */ js.UndefOr[String] => Callback = null,
    ...
    setMenuItems: /* menuItems */ js.UndefOr[Array] => Callback = null,
    ...
    setPressedDelay: /* pressedDelay */ js.UndefOr[js.Any] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IMenuButton] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IMenuButton], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    getAutoEvent.foreach(p => __obj.updateDynamic("getAutoEvent")(p.toJsFn))
    getBadgeCls.foreach(p => __obj.updateDynamic("getBadgeCls")(p.toJsFn))
    getBadgeText.foreach(p => __obj.updateDynamic("getBadgeText")(p.toJsFn))
    ...
    getHandler.foreach(p => __obj.updateDynamic("getHandler")(p.toJsFn))
    ...
    getIconAlign.foreach(p => __obj.updateDynamic("getIconAlign")(p.toJsFn))
    ...
    if (setAutoEvent != null) __obj.updateDynamic("setAutoEvent")(js.Any.fromFunction1((t0: /* autoEvent */ js.UndefOr[java.lang.String]) => setAutoEvent(t0).runNow()))
    if (setBadge != null) __obj.updateDynamic("setBadge")(js.Any.fromFunction1((t0: /* text */ js.UndefOr[java.lang.String]) => setBadge(t0).runNow()))
    if (setBadgeCls != null) __obj.updateDynamic("setBadgeCls")(js.Any.fromFunction1((t0: /* badgeCls */ js.UndefOr[java.lang.String]) => setBadgeCls(t0).runNow()))
    if (setBadgeText != null) __obj.updateDynamic("setBadgeText")(js.Any.fromFunction1((t0: /* badgeText */ js.UndefOr[java.lang.String]) => setBadgeText(t0).runNow()))
    ...
    if (setHandler != null) __obj.updateDynamic("setHandler")(js.Any.fromFunction1((t0: /* handler */ js.UndefOr[js.Any]) => setHandler(t0).runNow()))
    ...
    if (setIconAlign != null) __obj.updateDynamic("setIconAlign")(js.Any.fromFunction1((t0: /* iconAlign */ js.UndefOr[java.lang.String]) => setIconAlign(t0).runNow()))
    if (setIconClass != null) __obj.updateDynamic("setIconClass")(js.Any.fromFunction1((t0: /* iconClass */ js.UndefOr[java.lang.String]) => setIconClass(t0).runNow()))
    ...
    if (setMenuItems != null) __obj.updateDynamic("setMenuItems")(js.Any.fromFunction1((t0: /* menuItems */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.Array]) => setMenuItems(t0).runNow()))
    ...
    if (setPressedDelay != null) __obj.updateDynamic("setPressedDelay")(js.Any.fromFunction1((t0: /* pressedDelay */ js.UndefOr[js.Any]) => setPressedDelay(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.ux.IMenuButton], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
