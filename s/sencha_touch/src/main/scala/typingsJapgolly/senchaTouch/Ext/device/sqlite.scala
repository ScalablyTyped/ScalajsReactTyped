...
object sqlite {
  ...
  object IDatabase {
    ...
    extension [Self <: IDatabase](x: Self) {
      ...
      inline def setChangeVersion(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "changeVersion", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setReadTransaction(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "readTransaction", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
      
      inline def setReadTransactionUndefined: Self = StObject.set(x, "readTransaction", js.undefined)
      
      inline def setTransaction(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "transaction", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object ISQLResultSet {
    ...
    extension [Self <: ISQLResultSet](x: Self) {
      ...
      inline def setGetInsertId(value: CallbackTo[Double]): Self = StObject.set(x, "getInsertId", value.toJsFn)
      
      inline def setGetInsertIdUndefined: Self = StObject.set(x, "getInsertId", js.undefined)
      
      inline def setGetRows(value: CallbackTo[ISQLResultSetRowList]): Self = StObject.set(x, "getRows", value.toJsFn)
      
      inline def setGetRowsAffected(value: CallbackTo[Double]): Self = StObject.set(x, "getRowsAffected", value.toJsFn)
  ...
  object ISQLTransaction {
    ...
    extension [Self <: ISQLTransaction](x: Self) {
      ...
      inline def setExecuteSql(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "executeSql", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
