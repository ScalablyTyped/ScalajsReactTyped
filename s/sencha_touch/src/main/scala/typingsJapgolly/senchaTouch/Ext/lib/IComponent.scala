...
trait IComponent extends IEvented {
  ...
  /** [Method] Returns the value of renderTo
  		* @returns Ext.Element
  		*/
  var getRenderTo: js.UndefOr[js.Function0[typingsJapgolly.senchaTouch.Ext.IElement]] = js.undefined
  ...
  var renderTo: js.UndefOr[typingsJapgolly.senchaTouch.Ext.IElement] = js.undefined
  ...
  var setRenderTo: js.UndefOr[
    js.Function1[/* renderTo */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.IElement], Unit]
  ] = js.undefined
  ...
  /** [Method] Walks up the ownerCt axis looking for an ancestor Container which matches the passed simple selector
  		...
  		*/
  var up: js.UndefOr[
    js.Function1[/* selector */ js.UndefOr[String], typingsJapgolly.senchaTouch.Ext.IContainer]
  ] = js.undefined
...
object IComponent {
  ...
  def apply(
    ...
    showBy: (/* component */ js.UndefOr[IComponent], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    up: /* selector */ js.UndefOr[String] => CallbackTo[typingsJapgolly.senchaTouch.Ext.IContainer] = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.lib.IComponent], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
