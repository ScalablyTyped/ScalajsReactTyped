...
object IComposite {
  ...
  def apply(
    A: Int | Double = null,
    An: Array = null,
    add: /* sprite */ js.UndefOr[js.Any] => Callback = null,
    ...
    hide: js.UndefOr[CallbackTo[IComposite]] = js.undefined,
    ...
    render: (/* surface */ js.UndefOr[js.Any], /* ctx */ js.UndefOr[js.Any], /* region */ js.UndefOr[js.Any]) => Callback = null,
    ...
    show: js.UndefOr[CallbackTo[IComposite]] = js.undefined,
    ...
    if (add != null) __obj.updateDynamic("add")(js.Any.fromFunction1((t0: /* sprite */ js.UndefOr[js.Any]) => add(t0).runNow()))
