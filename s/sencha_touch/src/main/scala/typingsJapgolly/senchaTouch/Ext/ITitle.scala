...
object ITitle {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[ITitle]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[ITitle] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[ITitle] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[ITitle], /* alignment */ js.UndefOr[java.lang.String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.ITitle], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
