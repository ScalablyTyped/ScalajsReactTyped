...
object IArea {
  ...
  def apply(
    ...
    getStacked: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    setStacked: /* stacked */ js.UndefOr[Boolean] => Callback = null,
    ...
    getStacked.foreach(p => __obj.updateDynamic("getStacked")(p.toJsFn))
    ...
    if (setStacked != null) __obj.updateDynamic("setStacked")(js.Any.fromFunction1((t0: /* stacked */ js.UndefOr[scala.Boolean]) => setStacked(t0).runNow()))
