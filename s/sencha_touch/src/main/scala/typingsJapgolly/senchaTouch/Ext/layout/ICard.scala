...
object ICard {
  ...
  def apply(
    ...
    onItemInnerStateChange: (/* item */ js.UndefOr[js.Any], /* isInner */ js.UndefOr[js.Any], /* destroying */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (onItemInnerStateChange != null) __obj.updateDynamic("onItemInnerStateChange")(js.Any.fromFunction3((t0: /* item */ js.UndefOr[js.Any], t1: /* isInner */ js.UndefOr[js.Any], t2: /* destroying */ js.UndefOr[js.Any]) => onItemInnerStateChange(t0, t1, t2).runNow()))
