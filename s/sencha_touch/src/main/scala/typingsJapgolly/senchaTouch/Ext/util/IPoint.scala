...
object IPoint {
  ...
  extension [Self <: IPoint](x: Self) {
    ...
    inline def setClone_(value: CallbackTo[IPoint]): Self = StObject.set(x, "clone", value.toJsFn)
    
    inline def setClone_Undefined: Self = StObject.set(x, "clone", js.undefined)
    
    inline def setCopy(value: CallbackTo[IPoint]): Self = StObject.set(x, "copy", value.toJsFn)
    ...
    inline def setIsWithin(value: CallbackTo[Boolean]): Self = StObject.set(x, "isWithin", value.toJsFn)
