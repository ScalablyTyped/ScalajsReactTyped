...
object geolocation {
  ...
  object IAbstract {
    ...
    extension [Self <: IAbstract](x: Self) {
      ...
      inline def setClearWatch(value: Callback): Self = StObject.set(x, "clearWatch", value.toJsFn)
      ...
      inline def setGetCurrentPosition(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "getCurrentPosition", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setWatchPosition(value: /* config */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "watchPosition", js.Any.fromFunction1((t0: /* config */ js.UndefOr[Any]) => value(t0).runNow()))
