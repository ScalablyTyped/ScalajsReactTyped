...
trait IDatePicker
  extends StObject
     with typingsJapgolly.senchaTouch.Ext.field.ISelect {
...
object IDatePicker {
  ...
  extension [Self <: IDatePicker](x: Self) {
    ...
    inline def setReset(value: CallbackTo[typingsJapgolly.senchaTouch.Ext.field.ISelect]): Self = StObject.set(x, "reset", value.toJsFn)
