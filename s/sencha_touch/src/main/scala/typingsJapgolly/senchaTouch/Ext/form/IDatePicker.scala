...
trait IDatePicker
  extends typingsJapgolly.senchaTouch.Ext.field.ISelect {
  ...
  /** [Method] Resets the Select field to the value of the first record in the store
  		...
  		*/
  @JSName("reset")
  var reset_IDatePicker: js.UndefOr[js.Function0[typingsJapgolly.senchaTouch.Ext.field.ISelect]] = js.undefined
...
object IDatePicker {
  @scala.inline
  def apply(
    ISelect: typingsJapgolly.senchaTouch.Ext.field.ISelect = null,
    ...
    picker: js.Any = null,
    reset: js.UndefOr[CallbackTo[typingsJapgolly.senchaTouch.Ext.field.ISelect]] = js.undefined,
