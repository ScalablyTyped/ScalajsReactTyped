...
object mixin {
  ...
  object IFilterable {
    ...
    extension [Self <: IFilterable](x: Self) {
      ...
      inline def setGetFilterRoot(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getFilterRoot", value.toJsFn)
      ...
      inline def setRemoveFilters(value: /* filters */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "removeFilters", js.Any.fromFunction1((t0: /* filters */ js.UndefOr[Array]) => value(t0).runNow()))
      
      inline def setRemoveFiltersUndefined: Self = StObject.set(x, "removeFilters", js.undefined)
      
      inline def setSetFilterRoot(value: /* filterRoot */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setFilterRoot", js.Any.fromFunction1((t0: /* filterRoot */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
  ...
  object IProgressable {
    ...
    extension [Self <: IProgressable](x: Self) {
      ...
      inline def setSetMaxProgressInput(value: /* maxProgressInput */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMaxProgressInput", js.Any.fromFunction1((t0: /* maxProgressInput */ js.UndefOr[Double]) => value(t0).runNow()))
      ...
      inline def setSetMinProgressInput(value: /* minProgressInput */ js.UndefOr[Double] => Callback): Self = StObject.set(x, "setMinProgressInput", js.Any.fromFunction1((t0: /* minProgressInput */ js.UndefOr[Double]) => value(t0).runNow()))
  ...
  object ISelectable {
    ...
    extension [Self <: ISelectable](x: Self) {
      ...
      inline def setDeselectAll(value: /* supress */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "deselectAll", js.Any.fromFunction1((t0: /* supress */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setDoDeselect(value: (/* records */ js.UndefOr[Any], /* suppressEvent */ js.UndefOr[Boolean]) => Callback): Self = StObject.set(x, "doDeselect", js.Any.fromFunction2((t0: /* records */ js.UndefOr[Any], t1: /* suppressEvent */ js.UndefOr[Boolean]) => (value(t0, t1)).runNow()))
      ...
      ): Self = StObject.set(x, "doSelect", js.Any.fromFunction3((t0: /* records */ js.UndefOr[Any], t1: /* keepExisting */ js.UndefOr[Boolean], t2: /* suppressEvent */ js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setSelectAll(value: /* silent */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "selectAll", js.Any.fromFunction1((t0: /* silent */ js.UndefOr[Boolean]) => value(t0).runNow()))
      
      inline def setSelectAllUndefined: Self = StObject.set(x, "selectAll", js.undefined)
      
      inline def setSelectRange(
        value: (/* startRecord */ js.UndefOr[Double], /* endRecord */ js.UndefOr[Double], /* keepExisting */ js.UndefOr[Boolean]) => Callback
      ): Self = StObject.set(x, "selectRange", js.Any.fromFunction3((t0: /* startRecord */ js.UndefOr[Double], t1: /* endRecord */ js.UndefOr[Double], t2: /* keepExisting */ js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setSetDeselectOnContainerClick(value: /* deselectOnContainerClick */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setDeselectOnContainerClick", js.Any.fromFunction1((t0: /* deselectOnContainerClick */ js.UndefOr[Boolean]) => value(t0).runNow()))
      ...
      inline def setUpdateLastFocused(value: (/* newRecord */ js.UndefOr[IRecord], /* oldRecord */ js.UndefOr[IRecord]) => Callback): Self = StObject.set(x, "updateLastFocused", js.Any.fromFunction2((t0: /* newRecord */ js.UndefOr[IRecord], t1: /* oldRecord */ js.UndefOr[IRecord]) => (value(t0, t1)).runNow()))
  ...
  object ISortable {
    ...
    extension [Self <: ISortable](x: Self) {
      ...
      inline def setAddSorter(
        value: (/* sorter */ js.UndefOr[Any], /* defaultDirection */ js.UndefOr[java.lang.String]) => Callback
      ): Self = StObject.set(x, "addSorter", js.Any.fromFunction2((t0: /* sorter */ js.UndefOr[Any], t1: /* defaultDirection */ js.UndefOr[java.lang.String]) => (value(t0, t1)).runNow()))
      
      inline def setAddSorterUndefined: Self = StObject.set(x, "addSorter", js.undefined)
      
      inline def setAddSorters(
        value: (/* sorters */ js.UndefOr[Array], /* defaultDirection */ js.UndefOr[java.lang.String]) => Callback
      ): Self = StObject.set(x, "addSorters", js.Any.fromFunction2((t0: /* sorters */ js.UndefOr[Array], t1: /* defaultDirection */ js.UndefOr[java.lang.String]) => (value(t0, t1)).runNow()))
      ...
      inline def setGetDefaultSortDirection(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getDefaultSortDirection", value.toJsFn)
      ...
      inline def setGetSortRoot(value: CallbackTo[java.lang.String]): Self = StObject.set(x, "getSortRoot", value.toJsFn)
      ...
      inline def setInsertSorter(
        value: (/* index */ js.UndefOr[Double], /* sorter */ js.UndefOr[Any], /* defaultDirection */ js.UndefOr[java.lang.String]) => Callback
      ): Self = StObject.set(x, "insertSorter", js.Any.fromFunction3((t0: /* index */ js.UndefOr[Double], t1: /* sorter */ js.UndefOr[Any], t2: /* defaultDirection */ js.UndefOr[java.lang.String]) => (value(t0, t1, t2)).runNow()))
      
      inline def setInsertSorterUndefined: Self = StObject.set(x, "insertSorter", js.undefined)
      
      inline def setInsertSorters(
        value: (/* index */ js.UndefOr[Double], /* sorters */ js.UndefOr[Array], /* defaultDirection */ js.UndefOr[java.lang.String]) => Callback
      ): Self = StObject.set(x, "insertSorters", js.Any.fromFunction3((t0: /* index */ js.UndefOr[Double], t1: /* sorters */ js.UndefOr[Array], t2: /* defaultDirection */ js.UndefOr[java.lang.String]) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setRemoveSorters(value: /* sorters */ js.UndefOr[Array] => Callback): Self = StObject.set(x, "removeSorters", js.Any.fromFunction1((t0: /* sorters */ js.UndefOr[Array]) => value(t0).runNow()))
      
      inline def setRemoveSortersUndefined: Self = StObject.set(x, "removeSorters", js.undefined)
      
      inline def setSetDefaultSortDirection(value: /* defaultSortDirection */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setDefaultSortDirection", js.Any.fromFunction1((t0: /* defaultSortDirection */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
      
      inline def setSetDefaultSortDirectionUndefined: Self = StObject.set(x, "setDefaultSortDirection", js.undefined)
      
      inline def setSetSortRoot(value: /* sortRoot */ js.UndefOr[java.lang.String] => Callback): Self = StObject.set(x, "setSortRoot", js.Any.fromFunction1((t0: /* sortRoot */ js.UndefOr[java.lang.String]) => value(t0).runNow()))
