package typingsJapgolly.senchaTouch.Ext.util.translatable
...
object IScrollPosition {
  ...
  def apply(
    ...
    getEasingX: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getEasingY: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    ...
    getUseWrapper: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    setEasingX: /* easingX */ js.UndefOr[js.Any] => Callback = null,
    setEasingY: /* easingY */ js.UndefOr[js.Any] => Callback = null,
    setElement: /* element */ js.UndefOr[js.Any] => Callback = null,
    setListeners: /* listeners */ js.UndefOr[js.Any] => Callback = null,
    setUseWrapper: /* useWrapper */ js.UndefOr[Boolean] => Callback = null,
    ...
    getEasingX.foreach(p => __obj.updateDynamic("getEasingX")(p.toJsFn))
    getEasingY.foreach(p => __obj.updateDynamic("getEasingY")(p.toJsFn))
    ...
    getUseWrapper.foreach(p => __obj.updateDynamic("getUseWrapper")(p.toJsFn))
    ...
    if (setEasingX != null) __obj.updateDynamic("setEasingX")(js.Any.fromFunction1((t0: /* easingX */ js.UndefOr[js.Any]) => setEasingX(t0).runNow()))
    if (setEasingY != null) __obj.updateDynamic("setEasingY")(js.Any.fromFunction1((t0: /* easingY */ js.UndefOr[js.Any]) => setEasingY(t0).runNow()))
    ...
    if (setUseWrapper != null) __obj.updateDynamic("setUseWrapper")(js.Any.fromFunction1((t0: /* useWrapper */ js.UndefOr[scala.Boolean]) => setUseWrapper(t0).runNow()))
