...
object ILineSegment {
  ...
  def apply(
    ...
    intersects: /* lineSegment */ js.UndefOr[ILineSegment] => CallbackTo[IPoint] = null,
    mixins: js.Any = null,
    ...
    if (intersects != null) __obj.updateDynamic("intersects")(js.Any.fromFunction1((t0: /* lineSegment */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.util.ILineSegment]) => intersects(t0).runNow()))
