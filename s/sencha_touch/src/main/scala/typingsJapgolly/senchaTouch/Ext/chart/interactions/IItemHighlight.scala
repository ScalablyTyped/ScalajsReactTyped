...
object IItemHighlight {
  ...
  def apply(
    ...
    onGesture: (/* series */ js.UndefOr[js.Any], /* item */ js.UndefOr[js.Any], /* e */ js.UndefOr[js.Any]) => Callback = null,
    ...
    if (onGesture != null) __obj.updateDynamic("onGesture")(js.Any.fromFunction3((t0: /* series */ js.UndefOr[js.Any], t1: /* item */ js.UndefOr[js.Any], t2: /* e */ js.UndefOr[js.Any]) => onGesture(t0, t1, t2).runNow()))
