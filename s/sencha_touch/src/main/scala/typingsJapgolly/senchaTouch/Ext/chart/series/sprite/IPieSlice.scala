...
import typingsJapgolly.senchaTouch.Ext.draw.sprite.ISector
...
object IPieSlice {
  ...
  def apply(
    ...
    getRendererIndex: js.UndefOr[CallbackTo[Double]] = js.undefined,
    globalAlpha: Int | Double = null,
    hasListener: /* eventName */ js.UndefOr[String] => CallbackTo[Boolean] = null,
    hidden: js.UndefOr[Boolean] = js.undefined,
    hide: js.UndefOr[CallbackTo[IPieSlice]] = js.undefined,
    ...
    render: (/* ctx */ js.UndefOr[js.Any], /* surface */ js.UndefOr[js.Any], /* clipRegion */ js.UndefOr[js.Any]) => CallbackTo[js.Any] = null,
    ...
    setRendererIndex: /* rendererIndex */ js.UndefOr[Double] => Callback = null,
    shadowBlur: Int | Double = null,
    shadowColor: String = null,
    shadowOffsetX: Int | Double = null,
    shadowOffsetY: Int | Double = null,
    show: js.UndefOr[CallbackTo[IPieSlice]] = js.undefined,
    ...
    getRendererIndex.foreach(p => __obj.updateDynamic("getRendererIndex")(p.toJsFn))
    ...
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction3((t0: /* ctx */ js.UndefOr[js.Any], t1: /* surface */ js.UndefOr[js.Any], t2: /* clipRegion */ js.UndefOr[js.Any]) => render(t0, t1, t2).runNow()))
    ...
    if (setRendererIndex != null) __obj.updateDynamic("setRendererIndex")(js.Any.fromFunction1((t0: /* rendererIndex */ js.UndefOr[scala.Double]) => setRendererIndex(t0).runNow()))
