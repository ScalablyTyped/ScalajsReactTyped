...
object IErrors {
  ...
  extension [Self <: IErrors](x: Self) {
    ...
    inline def setAddCallbackTo(value: CallbackTo[Any]): Self = StObject.set(x, "add", value.toJsFn)
    ...
    inline def setInsertSorters(value: CallbackTo[IErrors]): Self = StObject.set(x, "insertSorters", value.toJsFn)
    ...
    inline def setSetAutoFilter(value: /* autoFilter */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAutoFilter", js.Any.fromFunction1((t0: /* autoFilter */ js.UndefOr[Boolean]) => value(t0).runNow()))
    
    inline def setSetAutoFilterUndefined: Self = StObject.set(x, "setAutoFilter", js.undefined)
    
    inline def setSetAutoSort(value: /* autoSort */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "setAutoSort", js.Any.fromFunction1((t0: /* autoSort */ js.UndefOr[Boolean]) => value(t0).runNow()))
