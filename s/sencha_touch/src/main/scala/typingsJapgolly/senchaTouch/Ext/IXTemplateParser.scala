...
object IXTemplateParser {
  ...
  def apply(
    ...
    doTag: /* tag */ js.UndefOr[java.lang.String] => Callback = null,
    ...
    if (doTag != null) __obj.updateDynamic("doTag")(js.Any.fromFunction1((t0: /* tag */ js.UndefOr[java.lang.String]) => doTag(t0).runNow()))
