...
object IRounded {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IRounded]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IRounded] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IRounded] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IRounded], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.scroll.indicator.IRounded], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
