package typingsJapgolly.senchaTouch.Ext.dataview.element
...
object IContainer {
  ...
  def apply(
    ...
    getParent: js.UndefOr[CallbackTo[IContainer]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IContainer] = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IContainer] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IContainer], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.dataview.element.IContainer], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
