...
object reader {
  ...
  object IReader {
    ...
    inline def apply(): typingsJapgolly.senchaTouch.Ext.data.reader.IReader = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.senchaTouch.Ext.data.reader.IReader]
    }
    
    extension [Self <: typingsJapgolly.senchaTouch.Ext.data.reader.IReader](x: Self) {
