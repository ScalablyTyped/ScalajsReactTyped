...
object IListPaging {
  ...
  def apply(
    ...
    getAutoPaging: js.UndefOr[CallbackTo[Boolean]] = js.undefined,
    ...
    getLoadMoreText: js.UndefOr[CallbackTo[String]] = js.undefined,
    ...
    getNoMoreRecordsText: js.UndefOr[CallbackTo[String]] = js.undefined,
    getPadding: js.UndefOr[CallbackTo[js.Any]] = js.undefined,
    getParent: js.UndefOr[CallbackTo[IListPaging]] = js.undefined,
    ...
    hide: /* animation */ js.UndefOr[js.Any] => CallbackTo[IListPaging] = null,
    ...
    scroll: js.Any = null,
    self: IClass = null,
    setAutoPaging: /* autoPaging */ js.UndefOr[Boolean] => Callback = null,
    ...
    setLoadMoreText: /* loadMoreText */ js.UndefOr[String] => Callback = null,
    ...
    setNoMoreRecordsText: /* noMoreRecordsText */ js.UndefOr[String] => Callback = null,
    ...
    show: /* animation */ js.UndefOr[js.Any] => CallbackTo[IListPaging] = null,
    showAnimation: js.Any = null,
    showBy: (/* component */ js.UndefOr[IListPaging], /* alignment */ js.UndefOr[String]) => Callback = null,
    ...
    getAutoPaging.foreach(p => __obj.updateDynamic("getAutoPaging")(p.toJsFn))
    ...
    getLoadMoreText.foreach(p => __obj.updateDynamic("getLoadMoreText")(p.toJsFn))
    ...
    getNoMoreRecordsText.foreach(p => __obj.updateDynamic("getNoMoreRecordsText")(p.toJsFn))
    ...
    if (setAutoPaging != null) __obj.updateDynamic("setAutoPaging")(js.Any.fromFunction1((t0: /* autoPaging */ js.UndefOr[scala.Boolean]) => setAutoPaging(t0).runNow()))
    ...
    if (setLoadMoreText != null) __obj.updateDynamic("setLoadMoreText")(js.Any.fromFunction1((t0: /* loadMoreText */ js.UndefOr[java.lang.String]) => setLoadMoreText(t0).runNow()))
    ...
    if (setNoMoreRecordsText != null) __obj.updateDynamic("setNoMoreRecordsText")(js.Any.fromFunction1((t0: /* noMoreRecordsText */ js.UndefOr[java.lang.String]) => setNoMoreRecordsText(t0).runNow()))
    ...
    if (showBy != null) __obj.updateDynamic("showBy")(js.Any.fromFunction2((t0: /* component */ js.UndefOr[typingsJapgolly.senchaTouch.Ext.plugin.IListPaging], t1: /* alignment */ js.UndefOr[java.lang.String]) => showBy(t0, t1).runNow()))
