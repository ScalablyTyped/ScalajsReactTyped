...
object ux {
  ...
  object device {
    ...
    @js.native
    open class Analytics_ ()
      extends StObject
         with typingsJapgolly.senchaTouch.Ext.ux.device.Analytics_
    /* static members */
    object Analytics_ {
      ...
      /** [Method] Returns the value of accountID
        * @returns Object
        */
      inline def getAccountID(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getAccountID")().asInstanceOf[Any]
      ...
      inline def setAccountID(accountID: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setAccountID")(accountID.asInstanceOf[js.Any]).asInstanceOf[Unit]
      ...
      inline def trackEvent(config: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("trackEvent")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
    ...
    open class Twitter_ ()
      extends StObject
         with typingsJapgolly.senchaTouch.Ext.ux.device.Twitter_
    /* static members */
    object Twitter_ {
      ...
      inline def compose(config: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("compose")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      ...
      inline def getMentions(config: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getMentions")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      ...
      inline def getPublicTimeline(config: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getPublicTimeline")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      ...
      inline def getTwitterRequest(config: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTwitterRequest")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
      
      /** [Method] Gets a specific Twitter user info
        * @param config Object An object which contains the following config options:
        */
      inline def getTwitterUsername(): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTwitterUsername")().asInstanceOf[Unit]
      inline def getTwitterUsername(config: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("getTwitterUsername")(config.asInstanceOf[js.Any]).asInstanceOf[Unit]
