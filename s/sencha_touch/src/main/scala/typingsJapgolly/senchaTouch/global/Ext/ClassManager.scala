...
import typingsJapgolly.senchaTouch.Ext.IClassManager
...
open class ClassManager ()
  extends StObject
     with typingsJapgolly.senchaTouch.Ext.ClassManager
/* static members */
object ClassManager {
  ...
  /** [Method] Get the aliases of a class by the class name
    ...
    */
  inline def getAliasesByName(): typingsJapgolly.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getAliasesByName")().asInstanceOf[typingsJapgolly.senchaTouch.Ext.Array]
  inline def getAliasesByName(name: java.lang.String): typingsJapgolly.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getAliasesByName")(name.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.senchaTouch.Ext.Array]
  ...
  /** [Method] Converts a string expression to an array of matching class names
    ...
    */
  inline def getNamesByExpression(): typingsJapgolly.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getNamesByExpression")().asInstanceOf[typingsJapgolly.senchaTouch.Ext.Array]
  inline def getNamesByExpression(expression: java.lang.String): typingsJapgolly.senchaTouch.Ext.Array = ^.asInstanceOf[js.Dynamic].applyDynamic("getNamesByExpression")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.senchaTouch.Ext.Array]
