...
import typingsJapgolly.senchaTouch.Ext.draw.IColor
import typingsJapgolly.senchaTouch.Ext.draw.IMatrix
...
object draw {
  ...
  open class Animator ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.draw.Animator
  /* static members */
  object Animator {
  ...
  open class Color ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.draw.Color
  /* static members */
  object Color {
  ...
  open class Draw ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.draw.Draw
  /* static members */
  object Draw {
    ...
    inline def spline(points: typingsJapgolly.senchaTouch.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("spline")(points.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  open class Matrix ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.draw.Matrix
  /* static members */
  object Matrix {
    ...
    inline def fly(elements: typingsJapgolly.senchaTouch.Ext.Array): IMatrix = ^.asInstanceOf[js.Dynamic].applyDynamic("fly")(elements.asInstanceOf[js.Any]).asInstanceOf[IMatrix]
  ...
  open class Solver ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.draw.Solver
  /* static members */
  object Solver {
  ...
  open class Surface ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.draw.Surface
  /* static members */
  object Surface {
    ...
    inline def stableSort(list: typingsJapgolly.senchaTouch.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("stableSort")(list.asInstanceOf[js.Any]).asInstanceOf[Unit]
  }
  ...
  open class TextMeasurer ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.draw.TextMeasurer
  /* static members */
  object TextMeasurer {
  ...
  open class TimingFunctions ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.draw.TimingFunctions
  /* static members */
  ...
  object sprite {
    ...
    open class AnimationParser ()
      extends StObject
         with typingsJapgolly.senchaTouch.Ext.draw.sprite.AnimationParser
    /* static members */
    ...
    open class AttributeParser ()
      extends StObject
         with typingsJapgolly.senchaTouch.Ext.draw.sprite.AttributeParser
    /* static members */
