...
open class ComponentQuery ()
  extends StObject
     with typingsJapgolly.senchaTouch.Ext.ComponentQuery
/* static members */
object ComponentQuery {
  ...
  inline def query(selector: java.lang.String, root: IContainer): typingsJapgolly.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("query")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.senchaTouch.Ext.Array]
  inline def query(selector: Unit, root: IContainer): typingsJapgolly.senchaTouch.Ext.Array = (^.asInstanceOf[js.Dynamic].applyDynamic("query")(selector.asInstanceOf[js.Any], root.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.senchaTouch.Ext.Array]
}
