...
import typingsJapgolly.senchaTouch.Ext.ILoader
...
open class Loader ()
  extends StObject
     with typingsJapgolly.senchaTouch.Ext.Loader
/* static members */
object Loader {
  ...
  inline def addClassPathMappings(paths: typingsJapgolly.senchaTouch.Ext.Object): ILoader = ^.asInstanceOf[js.Dynamic].applyDynamic("addClassPathMappings")(paths.asInstanceOf[js.Any]).asInstanceOf[ILoader]
  ...
  @js.native
  def history: typingsJapgolly.senchaTouch.Ext.Array = js.native
  inline def history_=(x: typingsJapgolly.senchaTouch.Ext.Array): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("history")(x.asInstanceOf[js.Any])
