...
object direct {
  ...
  open class Manager ()
    extends StObject
       with typingsJapgolly.senchaTouch.Ext.direct.Manager
  /* static members */
  object Manager {
    ...
    /** [Method] Adds an Ext Direct Provider and creates the proxy or stub methods to execute server side methods
      ...
      * @returns Object
      */
    inline def addProvider(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("addProvider")().asInstanceOf[Any]
    inline def addProvider(provider: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("addProvider")(provider.asInstanceOf[js.Any]).asInstanceOf[Any]
    ...
    /** [Method] Retrieves a provider by the id specified when the provider is added
      ...
      * @returns Object
      */
    inline def getProvider(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getProvider")().asInstanceOf[Any]
    inline def getProvider(id: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("getProvider")(id.asInstanceOf[js.Any]).asInstanceOf[Any]
    ...
    /** [Method] Removes the provider
      ...
      */
    inline def removeProvider(): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("removeProvider")().asInstanceOf[Any]
    inline def removeProvider(provider: Any): Any = ^.asInstanceOf[js.Dynamic].applyDynamic("removeProvider")(provider.asInstanceOf[js.Any]).asInstanceOf[Any]
