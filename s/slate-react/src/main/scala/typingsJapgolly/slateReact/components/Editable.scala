...
object Editable {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def decorate(value: /* entry */ NodeEntry[Node] => js.Array[Range]): this.type = set("decorate", js.Any.fromFunction1(value))
    ...
    inline def onDOMBeforeInput(value: /* event */ InputEvent => Callback): this.type = set("onDOMBeforeInput", js.Any.fromFunction1((t0: /* event */ InputEvent) => value(t0).runNow()))
    ...
    inline def renderPlaceholder(value: /* props */ RenderPlaceholderProps => typingsJapgolly.react.mod.global.JSX.Element): this.type = set("renderPlaceholder", js.Any.fromFunction1(value))
    ...
    inline def scrollSelectionIntoView(
    ...
    ): this.type = set("scrollSelectionIntoView", js.Any.fromFunction2((t0: /* editor */ ReactEditor, t1: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify DOMRange */ /* domRange */ Any) => (value(t0, t1)).runNow()))
  ...
  implicit def make(companion: Editable.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
