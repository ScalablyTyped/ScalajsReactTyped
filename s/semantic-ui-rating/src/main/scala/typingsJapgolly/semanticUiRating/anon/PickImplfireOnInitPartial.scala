...
/* Inlined std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, 'fireOnInit'> & std.Partial<std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, keyof semantic-ui-rating.SemanticUI.RatingSettings._Impl>> */
trait PickImplfireOnInitPartial
  extends StObject
     with Param {
...
object PickImplfireOnInitPartial {
  ...
  extension [Self <: PickImplfireOnInitPartial](x: Self) {
