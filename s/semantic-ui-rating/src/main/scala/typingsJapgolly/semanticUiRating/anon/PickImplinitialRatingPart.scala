...
/* Inlined std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, 'initialRating'> & std.Partial<std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, keyof semantic-ui-rating.SemanticUI.RatingSettings._Impl>> */
trait PickImplinitialRatingPart
  extends StObject
     with Param {
