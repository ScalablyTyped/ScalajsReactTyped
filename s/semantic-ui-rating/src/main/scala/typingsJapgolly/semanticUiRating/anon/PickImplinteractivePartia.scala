...
/* Inlined std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, 'interactive'> & std.Partial<std.Pick<semantic-ui-rating.SemanticUI.RatingSettings._Impl, keyof semantic-ui-rating.SemanticUI.RatingSettings._Impl>> */
trait PickImplinteractivePartia
  extends StObject
     with Param {
...
object PickImplinteractivePartia {
  ...
  extension [Self <: PickImplinteractivePartia](x: Self) {
