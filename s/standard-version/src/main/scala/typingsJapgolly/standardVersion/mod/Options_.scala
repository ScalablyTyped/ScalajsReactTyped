package typingsJapgolly.standardVersion.mod

import org.scalajs.dom.experimental.URL
import typingsJapgolly.conventionalChangelogConfigSpec.`210SchemaJsonMod`.Config
import typingsJapgolly.conventionalChangelogConfigSpec.`210SchemaJsonMod`.Config.Type
