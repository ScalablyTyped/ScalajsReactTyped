...
object LowLevelStyleFunctionArguments {
  ...
  def apply[N, S](
    ...
    scale: S = null,
    transformValue: (/* n */ N, /* scale */ js.UndefOr[S]) => CallbackTo[js.Any] = null
    ...
    if (transformValue != null) __obj.updateDynamic("transformValue")(js.Any.fromFunction2((t0: /* n */ N, t1: /* scale */ js.UndefOr[S]) => transformValue(t0, t1).runNow()))
