...
object FaceRenderObjectProvider {
  ...
  extension [Self <: FaceRenderObjectProvider](x: Self) {
    ...
    inline def setGetExpressionNames(value: CallbackTo[js.Array[/* keyof snapchat-lens-studio.Expressions */ String]]): Self = StObject.set(x, "getExpressionNames", value.toJsFn)
    ...
    inline def setGetExpressionWeights(value: CallbackTo[js.typedarray.Float32Array]): Self = StObject.set(x, "getExpressionWeights", value.toJsFn)
