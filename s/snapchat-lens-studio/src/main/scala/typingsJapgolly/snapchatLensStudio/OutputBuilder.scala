...
import typingsJapgolly.snapchatLensStudio.MachineLearning.OutputMode
...
object OutputBuilder {
  ...
  inline def apply(
    build: CallbackTo[OutputPlaceholder],
    ...
    val __obj = js.Dynamic.literal(build = build.toJsFn, getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), setName = js.Any.fromFunction1(setName), setOutputMode = js.Any.fromFunction1(setOutputMode), setShape = js.Any.fromFunction1(setShape), setTransformer = js.Any.fromFunction1(setTransformer))
    __obj.asInstanceOf[OutputBuilder]
  }
  
  extension [Self <: OutputBuilder](x: Self) {
    
    inline def setBuild(value: CallbackTo[OutputPlaceholder]): Self = StObject.set(x, "build", value.toJsFn)
