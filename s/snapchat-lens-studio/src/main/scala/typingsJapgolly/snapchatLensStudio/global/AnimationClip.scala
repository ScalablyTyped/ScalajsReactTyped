...
object AnimationClip {
  ...
  object PostInfinity extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.snapchatLensStudio.AnimationClip.PostInfinity & Double] = js.native
    
    /* 0 */ val Cycle: typingsJapgolly.snapchatLensStudio.AnimationClip.PostInfinity.Cycle & Double = js.native
    
    /* 1 */ val Oscillate: typingsJapgolly.snapchatLensStudio.AnimationClip.PostInfinity.Oscillate & Double = js.native
  }
  ...
  object RangeType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.snapchatLensStudio.AnimationClip.RangeType & Double] = js.native
    
    /* 1 */ val Frames: typingsJapgolly.snapchatLensStudio.AnimationClip.RangeType.Frames & Double = js.native
    
    /* 0 */ val Time: typingsJapgolly.snapchatLensStudio.AnimationClip.RangeType.Time & Double = js.native
  }
}
