...
object ProceduralTextureProvider {
  ...
  inline def create(width: Double, height: Double, colorspace: typingsJapgolly.snapchatLensStudio.Colorspace): Texture = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(width.asInstanceOf[js.Any], height.asInstanceOf[js.Any], colorspace.asInstanceOf[js.Any])).asInstanceOf[Texture]
