...
object BackgroundSettings {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(enabled = enabled.asInstanceOf[js.Any], fill = fill.asInstanceOf[js.Any], getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), margins = margins.asInstanceOf[js.Any])
