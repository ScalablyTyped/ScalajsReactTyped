...
object WorldOptions {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(enableWorldMeshesClassificationTracking = enableWorldMeshesClassificationTracking.asInstanceOf[js.Any], enableWorldMeshesTracking = enableWorldMeshesTracking.asInstanceOf[js.Any], getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType))
