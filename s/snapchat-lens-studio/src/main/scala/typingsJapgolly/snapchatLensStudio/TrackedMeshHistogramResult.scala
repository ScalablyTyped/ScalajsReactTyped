...
object TrackedMeshHistogramResult {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(avgNormal = avgNormal.asInstanceOf[js.Any], getTypeName = getTypeName.toJsFn, histogram = histogram.asInstanceOf[js.Any], isOfType = js.Any.fromFunction1(isOfType))
