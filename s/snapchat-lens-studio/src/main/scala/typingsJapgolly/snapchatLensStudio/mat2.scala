...
object mat2 {
  ...
  inline def apply(
    ...
    div: mat2 => mat2,
    equal: mat2 => Boolean,
    inverse: CallbackTo[mat2],
    mult: mat2 => mat2,
    multiplyScalar: Double => mat2,
    sub: mat2 => mat2,
    transpose: CallbackTo[mat2]
  ): mat2 = {
    val __obj = js.Dynamic.literal(add = js.Any.fromFunction1(add), column0 = column0.asInstanceOf[js.Any], column1 = column1.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], determinant = determinant.toJsFn, div = js.Any.fromFunction1(div), equal = js.Any.fromFunction1(equal), inverse = inverse.toJsFn, mult = js.Any.fromFunction1(mult), multiplyScalar = js.Any.fromFunction1(multiplyScalar), sub = js.Any.fromFunction1(sub), transpose = transpose.toJsFn)
  ...
  extension [Self <: mat2](x: Self) {
    ...
    inline def setInverse(value: CallbackTo[mat2]): Self = StObject.set(x, "inverse", value.toJsFn)
    ...
    inline def setTranspose(value: CallbackTo[mat2]): Self = StObject.set(x, "transpose", value.toJsFn)
  }
}
