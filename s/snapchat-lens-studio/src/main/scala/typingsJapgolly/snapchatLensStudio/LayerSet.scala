...
object LayerSet {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(contains = js.Any.fromFunction1(contains), except = js.Any.fromFunction1(except), intersect = js.Any.fromFunction1(intersect), isEmpty = isEmpty.toJsFn, union = js.Any.fromFunction1(union))
