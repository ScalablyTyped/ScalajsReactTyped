...
object BasePlaceholder {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), name = name.asInstanceOf[js.Any], shape = shape.asInstanceOf[js.Any], transformer = transformer.asInstanceOf[js.Any])
