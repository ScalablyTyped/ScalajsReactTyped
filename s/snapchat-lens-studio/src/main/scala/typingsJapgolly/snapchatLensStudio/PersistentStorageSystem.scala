...
object PersistentStorageSystem {
  ...
  inline def apply(getTypeName: CallbackTo[String], isOfType: String => Boolean, store: GeneralDataStore): PersistentStorageSystem = {
    val __obj = js.Dynamic.literal(getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), store = store.asInstanceOf[js.Any])
