...
object TouchDataProvider {
  ...
  inline def apply(
    ...
    enableTouchBlockingException: (TouchTypeException, Boolean) => Callback,
    getTypeName: CallbackTo[String],
    isOfType: String => Boolean,
    touchBlocking: Boolean,
    touchBlockingExceptionMask: Double
  ): TouchDataProvider = {
    val __obj = js.Dynamic.literal(composeTouchBlockingExceptionMask = js.Any.fromFunction2(composeTouchBlockingExceptionMask), enableTouchBlockingException = js.Any.fromFunction2((t0: TouchTypeException, t1: Boolean) => (enableTouchBlockingException(t0, t1)).runNow()), getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), touchBlocking = touchBlocking.asInstanceOf[js.Any], touchBlockingExceptionMask = touchBlockingExceptionMask.asInstanceOf[js.Any])
  ...
  extension [Self <: TouchDataProvider](x: Self) {
    ...
    inline def setEnableTouchBlockingException(value: (TouchTypeException, Boolean) => Callback): Self = StObject.set(x, "enableTouchBlockingException", js.Any.fromFunction2((t0: TouchTypeException, t1: Boolean) => (value(t0, t1)).runNow()))
