...
object mat4 {
  ...
  inline def apply(
    ...
    div: mat4 => mat4,
    equal: mat4 => Boolean,
    extractEulerAngles: CallbackTo[vec3],
    inverse: CallbackTo[mat4],
    mult: mat4 => mat4,
    ...
    sub: mat4 => mat4,
    transpose: CallbackTo[mat4]
  ): mat4 = {
    val __obj = js.Dynamic.literal(add = js.Any.fromFunction1(add), column0 = column0.asInstanceOf[js.Any], column1 = column1.asInstanceOf[js.Any], column2 = column2.asInstanceOf[js.Any], column3 = column3.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], determinant = determinant.toJsFn, div = js.Any.fromFunction1(div), equal = js.Any.fromFunction1(equal), extractEulerAngles = extractEulerAngles.toJsFn, inverse = inverse.toJsFn, mult = js.Any.fromFunction1(mult), multiplyDirection = js.Any.fromFunction1(multiplyDirection), multiplyPoint = js.Any.fromFunction1(multiplyPoint), multiplyScalar = js.Any.fromFunction1(multiplyScalar), multiplyVector = js.Any.fromFunction1(multiplyVector), sub = js.Any.fromFunction1(sub), transpose = transpose.toJsFn)
    __obj.asInstanceOf[mat4]
  }
  
  extension [Self <: mat4](x: Self) {
    ...
    inline def setExtractEulerAngles(value: CallbackTo[vec3]): Self = StObject.set(x, "extractEulerAngles", value.toJsFn)
    
    inline def setInverse(value: CallbackTo[mat4]): Self = StObject.set(x, "inverse", value.toJsFn)
    ...
    inline def setTranspose(value: CallbackTo[mat4]): Self = StObject.set(x, "transpose", value.toJsFn)
  }
}
