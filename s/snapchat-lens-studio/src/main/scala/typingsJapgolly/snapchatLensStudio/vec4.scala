...
object vec4 {
  ...
  extension [Self <: vec4](x: Self) {
    ...
    inline def setNormalize(value: CallbackTo[vec4]): Self = StObject.set(x, "normalize", value.toJsFn)
