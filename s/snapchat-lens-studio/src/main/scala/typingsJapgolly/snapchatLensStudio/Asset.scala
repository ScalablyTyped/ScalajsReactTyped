...
object Asset {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), isSame = js.Any.fromFunction1(isSame), name = name.asInstanceOf[js.Any])
  ...
  object AnimationLayer {
    ...
    inline def apply(
      ...
      setBlendShapeTrack: (String, FloatAnimationTrack) => Callback,
      visibility: IntAnimationTrack
    ): AnimationLayer = {
      val __obj = js.Dynamic.literal(getBlendShapeTrack = js.Any.fromFunction1(getBlendShapeTrack), getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), isSame = js.Any.fromFunction1(isSame), name = name.asInstanceOf[js.Any], position = position.asInstanceOf[js.Any], rotation = rotation.asInstanceOf[js.Any], scale = scale.asInstanceOf[js.Any], setBlendShapeTrack = js.Any.fromFunction2((t0: String, t1: FloatAnimationTrack) => (setBlendShapeTrack(t0, t1)).runNow()), visibility = visibility.asInstanceOf[js.Any])
    ...
    extension [Self <: AnimationLayer](x: Self) {
      ...
      inline def setSetBlendShapeTrack(value: (String, FloatAnimationTrack) => Callback): Self = StObject.set(x, "setBlendShapeTrack", js.Any.fromFunction2((t0: String, t1: FloatAnimationTrack) => (value(t0, t1)).runNow()))
  ...
  object MarkerAsset {
    ...
    inline def apply(
      getAspectRatio: CallbackTo[Double],
      getTypeName: CallbackTo[String],
      isOfType: String => Boolean,
      isSame: SerializableWithUID => Boolean,
      name: String
    ): MarkerAsset = {
      val __obj = js.Dynamic.literal(getAspectRatio = getAspectRatio.toJsFn, getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), isSame = js.Any.fromFunction1(isSame), name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[MarkerAsset]
    }
    
    extension [Self <: MarkerAsset](x: Self) {
      
      inline def setGetAspectRatio(value: CallbackTo[Double]): Self = StObject.set(x, "getAspectRatio", value.toJsFn)
    }
  }
  ...
  object Material {
    ...
    inline def apply(
      getPass: Double => Pass,
      getPassCount: CallbackTo[Double],
      getTypeName: CallbackTo[String],
      isOfType: String => Boolean,
      isSame: SerializableWithUID => Boolean,
      mainPass: Pass,
      ...
      val __obj = js.Dynamic.literal(getPass = js.Any.fromFunction1(getPass), getPassCount = getPassCount.toJsFn, getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), isSame = js.Any.fromFunction1(isSame), mainPass = mainPass.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    ...
    extension [Self <: Material](x: Self) {
      ...
      inline def setGetPassCount(value: CallbackTo[Double]): Self = StObject.set(x, "getPassCount", value.toJsFn)
  ...
  object Texture {
    ...
    inline def apply(
      ...
      copyFrame: CallbackTo[Texture],
      getColorspace: CallbackTo[Colorspace],
      ...
      val __obj = js.Dynamic.literal(control = control.asInstanceOf[js.Any], copyFrame = copyFrame.toJsFn, getColorspace = getColorspace.toJsFn, getHeight = getHeight.toJsFn, getTypeName = getTypeName.toJsFn, getWidth = getWidth.toJsFn, isOfType = js.Any.fromFunction1(isOfType), isSame = js.Any.fromFunction1(isSame), name = name.asInstanceOf[js.Any])
    ...
    extension [Self <: Texture](x: Self) {
      ...
      inline def setCopyFrame(value: CallbackTo[Texture]): Self = StObject.set(x, "copyFrame", value.toJsFn)
      
      inline def setGetColorspace(value: CallbackTo[Colorspace]): Self = StObject.set(x, "getColorspace", value.toJsFn)
