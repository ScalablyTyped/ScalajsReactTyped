...
object TrackedMeshHitTestResult {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(classification = classification.asInstanceOf[js.Any], getTypeName = getTypeName.toJsFn, isOfType = js.Any.fromFunction1(isOfType), mesh = mesh.asInstanceOf[js.Any], normal = normal.asInstanceOf[js.Any], position = position.asInstanceOf[js.Any])
