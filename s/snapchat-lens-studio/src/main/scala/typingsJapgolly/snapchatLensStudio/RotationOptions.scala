...
object RotationOptions {
  ...
  inline def apply(getTypeName: CallbackTo[String], invertRotation: Boolean, isOfType: String => Boolean): RotationOptions = {
    val __obj = js.Dynamic.literal(getTypeName = getTypeName.toJsFn, invertRotation = invertRotation.asInstanceOf[js.Any], isOfType = js.Any.fromFunction1(isOfType))
