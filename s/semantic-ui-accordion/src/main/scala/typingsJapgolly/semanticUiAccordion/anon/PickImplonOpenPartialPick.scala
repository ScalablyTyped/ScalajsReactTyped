package typingsJapgolly.semanticUiAccordion.anon
...
import typingsJapgolly.semanticUiAccordion.SemanticUI.AccordionSettings.Param
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, 'onOpen'> & std.Partial<std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, keyof semantic-ui-accordion.SemanticUI.AccordionSettings._Impl>> */
trait PickImplonOpenPartialPick
  extends StObject
     with Param {
...
object PickImplonOpenPartialPick {
  ...
  extension [Self <: PickImplonOpenPartialPick](x: Self) {
