...
/* Inlined std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, 'collapsible'> & std.Partial<std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, keyof semantic-ui-accordion.SemanticUI.AccordionSettings._Impl>> */
trait PickImplcollapsiblePartia
  extends StObject
     with Param {
...
object PickImplcollapsiblePartia {
  ...
  extension [Self <: PickImplcollapsiblePartia](x: Self) {
