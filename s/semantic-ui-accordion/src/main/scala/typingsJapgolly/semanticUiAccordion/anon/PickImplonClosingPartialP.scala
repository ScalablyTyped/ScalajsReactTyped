...
/* Inlined std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, 'onClosing'> & std.Partial<std.Pick<semantic-ui-accordion.SemanticUI.AccordionSettings._Impl, keyof semantic-ui-accordion.SemanticUI.AccordionSettings._Impl>> */
trait PickImplonClosingPartialP
  extends StObject
     with Param {
...
object PickImplonClosingPartialP {
  ...
  extension [Self <: PickImplonClosingPartialP](x: Self) {
