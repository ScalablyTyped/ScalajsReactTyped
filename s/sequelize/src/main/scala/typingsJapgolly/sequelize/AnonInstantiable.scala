...
import typingsJapgolly.bluebird.AnonCancellation
import typingsJapgolly.bluebird.TypeofBluebird
...
trait AnonInstantiable
  ...
  /**
    ...
    */
  var AggregateError: Instantiable0[typingsJapgolly.bluebird.mod.AggregateError] = js.native
  /**
    * Signals that an operation has been aborted or cancelled. The default reason used by `.cancel`.
    */
  var CancellationError: Instantiable0[typingsJapgolly.bluebird.mod.CancellationError] = js.native
  /**
    * returned by `Bluebird.disposer()`.
    */
  var Disposer: Instantiable0[typingsJapgolly.bluebird.mod.Disposer[js.Object]] = js.native
  /**
    ...
    */
  var OperationalError: Instantiable0[typingsJapgolly.bluebird.mod.OperationalError] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeoutError: Instantiable0[typingsJapgolly.bluebird.mod.TimeoutError] = js.native
  /**
