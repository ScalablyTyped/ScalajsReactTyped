...
import typingsJapgolly.sequelize.AnonMsg
...
object DefineAttributeColumnOptions {
  ...
  def apply(
    ...
    if (set != null) __obj.updateDynamic("set")(js.Any.fromFunction1((t0: /* val */ js.Any) => set(t0).runNow()))
