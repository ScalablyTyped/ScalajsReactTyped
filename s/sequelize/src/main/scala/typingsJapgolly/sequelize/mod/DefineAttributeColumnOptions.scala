...
import typingsJapgolly.sequelize.anon.Msg
...
object DefineAttributeColumnOptions {
  ...
  extension [Self <: DefineAttributeColumnOptions](x: Self) {
    ...
    inline def setSet(value: /* val */ Any => Callback): Self = StObject.set(x, "set", js.Any.fromFunction1((t0: /* val */ Any) => value(t0).runNow()))
