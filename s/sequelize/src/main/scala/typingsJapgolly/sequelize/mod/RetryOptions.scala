...
object RetryOptions {
  ...
  extension [Self <: RetryOptions](x: Self) {
    ...
    inline def setMatch(value: js.Array[String | js.RegExp | js.Error]): Self = StObject.set(x, "match", value.asInstanceOf[js.Any])
    
    inline def setMatchUndefined: Self = StObject.set(x, "match", js.undefined)
    
    inline def setMatchVarargs(value: (String | js.RegExp | js.Error)*): Self = StObject.set(x, "match", js.Array(value*))
