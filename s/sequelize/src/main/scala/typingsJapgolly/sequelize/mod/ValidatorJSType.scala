...
trait ValidatorJSType extends StObject {
  ...
  val ibanLocales: js.Array[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 78, starting with typingsJapgolly.sequelize.sequelizeStrings.AD, typingsJapgolly.sequelize.sequelizeStrings.AE, typingsJapgolly.sequelize.sequelizeStrings.AL */ Any
  ] = js.native
  ...
  def isBoolean(str: String, options: typingsJapgolly.validator.libIsBooleanMod.Options): Boolean = js.native
