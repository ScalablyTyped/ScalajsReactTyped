...
import typingsJapgolly.sequelize.sequelizeStrings.`10`
import typingsJapgolly.sequelize.sequelizeStrings.`13`
import typingsJapgolly.sequelize.sequelizeStrings.`4`
import typingsJapgolly.sequelize.sequelizeStrings.`6`
import typingsJapgolly.sequelize.sequelizeStrings.all
import typingsJapgolly.sequelize.sequelizeStrings.any
...
trait ValidatorJSType extends js.Object {
  ...
  @JSName("isUUID")
  def isUUID_3(str: String, version: typingsJapgolly.sequelize.sequelizeStrings.`3`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_4(str: String, version: typingsJapgolly.sequelize.sequelizeNumbers.`4`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_4(str: String, version: `4`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_5(str: String, version: `5`): Boolean = js.native
  @JSName("isUUID")
  def isUUID_5(str: String, version: typingsJapgolly.sequelize.sequelizeStrings.`5`): Boolean = js.native
  @JSName("isUUID")
