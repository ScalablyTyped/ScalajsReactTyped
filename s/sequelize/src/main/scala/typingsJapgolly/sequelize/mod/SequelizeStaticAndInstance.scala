...
import typingsJapgolly.sequelize.AnonInstantiable
...
trait SequelizeStaticAndInstance extends Errors {
  ...
  /**
    ...
    */
  var Instance: typingsJapgolly.sequelize.mod.Instance[_] = js.native
  /**
    ...
    */
  var Model: typingsJapgolly.sequelize.mod.Model[_, _, _] = js.native
  ...
  /**
    ...
    */
  def cast(`val`: js.Any, `type`: String): typingsJapgolly.sequelize.mod.cast = js.native
  /**
  ...
  /**
    ...
    */
  def fn(fn: String, args: js.Any*): typingsJapgolly.sequelize.mod.fn = js.native
  /**
  ...
  /**
    ...
    * @param val
    */
  def literal(`val`: js.Any): typingsJapgolly.sequelize.mod.literal = js.native
  /**
    * An OR query
    *
