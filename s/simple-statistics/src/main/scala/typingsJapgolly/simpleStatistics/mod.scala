...
import typingsJapgolly.simpleStatistics.anon.B
import typingsJapgolly.simpleStatistics.anon.Centroids
import typingsJapgolly.simpleStatistics.anon.M
import typingsJapgolly.simpleStatistics.srcBayesianClassifierMod.default
import typingsJapgolly.simpleStatistics.srcChiSquaredDistributionTableMod.DistributionTable
import typingsJapgolly.simpleStatistics.srcKernelDensityEstimationMod.BandwidthMethods
import typingsJapgolly.simpleStatistics.srcKernelDensityEstimationMod.Kernels
...
object mod {
  ...
  open class PerceptronModel ()
    extends typingsJapgolly.simpleStatistics.srcPerceptronMod.default
