...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'hoverable'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplhoverablePartialP
  extends StObject
     with Param {
...
object PickImplhoverablePartialP {
  ...
  extension [Self <: PickImplhoverablePartialP](x: Self) {
