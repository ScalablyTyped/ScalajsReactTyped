...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'position'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplpositionPartialPi
  extends StObject
     with Param {
...
object PickImplpositionPartialPi {
  ...
  extension [Self <: PickImplpositionPartialPi](x: Self) {
