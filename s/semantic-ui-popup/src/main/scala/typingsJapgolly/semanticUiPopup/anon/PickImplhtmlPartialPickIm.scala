...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'html'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplhtmlPartialPickIm
  extends StObject
     with Param {
...
object PickImplhtmlPartialPickIm {
  ...
  extension [Self <: PickImplhtmlPartialPickIm](x: Self) {
