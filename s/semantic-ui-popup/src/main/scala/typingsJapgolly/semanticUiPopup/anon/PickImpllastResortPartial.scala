...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'lastResort'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImpllastResortPartial
  extends StObject
     with Param {
...
object PickImpllastResortPartial {
  ...
  extension [Self <: PickImpllastResortPartial](x: Self) {
