...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'hideOnScroll'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplhideOnScrollParti
  extends StObject
     with Param {
...
object PickImplhideOnScrollParti {
  ...
  extension [Self <: PickImplhideOnScrollParti](x: Self) {
