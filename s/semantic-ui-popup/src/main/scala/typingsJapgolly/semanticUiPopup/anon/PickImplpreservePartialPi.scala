...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'preserve'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplpreservePartialPi
  extends StObject
     with Param {
...
object PickImplpreservePartialPi {
  ...
  extension [Self <: PickImplpreservePartialPi](x: Self) {
