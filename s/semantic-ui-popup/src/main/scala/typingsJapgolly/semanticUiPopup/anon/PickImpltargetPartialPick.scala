...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'target'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImpltargetPartialPick
  extends StObject
     with Param {
...
object PickImpltargetPartialPick {
  ...
  extension [Self <: PickImpltargetPartialPick](x: Self) {
