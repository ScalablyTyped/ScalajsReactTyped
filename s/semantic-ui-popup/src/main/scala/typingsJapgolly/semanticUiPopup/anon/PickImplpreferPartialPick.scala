...
/* Inlined std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, 'prefer'> & std.Partial<std.Pick<semantic-ui-popup.SemanticUI.PopupSettings._Impl, keyof semantic-ui-popup.SemanticUI.PopupSettings._Impl>> */
trait PickImplpreferPartialPick
  extends StObject
     with Param {
...
object PickImplpreferPartialPick {
  ...
  extension [Self <: PickImplpreferPartialPick](x: Self) {
