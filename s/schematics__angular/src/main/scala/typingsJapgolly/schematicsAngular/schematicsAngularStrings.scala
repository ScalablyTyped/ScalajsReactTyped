...
import typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.RefactorTriggerReason
import typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.TypeOfTag
import typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod._CompletionsTriggerCharacter
import typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod._SignatureHelpRetriggerCharacter
import typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod._SignatureHelpTriggerCharacter
import typingsJapgolly.schematicsAngular.utilityWorkspaceModelsMod.OutputHashing
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object schematicsAngularStrings {
  ...
  sealed trait bundles
    extends StObject
       with OutputHashing
  inline def bundles: bundles = "bundles".asInstanceOf[bundles]
