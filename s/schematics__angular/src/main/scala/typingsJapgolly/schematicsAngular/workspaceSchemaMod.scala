...
object workspaceSchemaMod {
  ...
  object PackageManager extends StObject {
    ...
    sealed trait Cnpm
      extends StObject
         with PackageManager
    /* "cnpm" */ val Cnpm: typingsJapgolly.schematicsAngular.workspaceSchemaMod.PackageManager.Cnpm & String = js.native
    
    @js.native
    sealed trait Npm
      extends StObject
         with PackageManager
    /* "npm" */ val Npm: typingsJapgolly.schematicsAngular.workspaceSchemaMod.PackageManager.Npm & String = js.native
    
    @js.native
    sealed trait Pnpm
      extends StObject
         with PackageManager
    /* "pnpm" */ val Pnpm: typingsJapgolly.schematicsAngular.workspaceSchemaMod.PackageManager.Pnpm & String = js.native
    
    @js.native
    sealed trait Yarn
      extends StObject
         with PackageManager
    /* "yarn" */ val Yarn: typingsJapgolly.schematicsAngular.workspaceSchemaMod.PackageManager.Yarn & String = js.native
  }
