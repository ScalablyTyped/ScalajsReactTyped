...
object guardSchemaMod {
  ...
  object Implement extends StObject {
    ...
    sealed trait CanActivate
      extends StObject
         with Implement
    /* "CanActivate" */ val CanActivate: typingsJapgolly.schematicsAngular.guardSchemaMod.Implement.CanActivate & String = js.native
    
    @js.native
    sealed trait CanActivateChild
      extends StObject
         with Implement
    /* "CanActivateChild" */ val CanActivateChild: typingsJapgolly.schematicsAngular.guardSchemaMod.Implement.CanActivateChild & String = js.native
    
    @js.native
    sealed trait CanDeactivate
      extends StObject
         with Implement
    /* "CanDeactivate" */ val CanDeactivate: typingsJapgolly.schematicsAngular.guardSchemaMod.Implement.CanDeactivate & String = js.native
    
    @js.native
    sealed trait CanLoad
      extends StObject
         with Implement
    /* "CanLoad" */ val CanLoad: typingsJapgolly.schematicsAngular.guardSchemaMod.Implement.CanLoad & String = js.native
  }
