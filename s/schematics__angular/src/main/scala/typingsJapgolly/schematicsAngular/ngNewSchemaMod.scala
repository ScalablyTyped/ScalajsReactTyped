...
object ngNewSchemaMod {
  ...
  object PackageManager extends StObject {
    ...
    sealed trait Cnpm
      extends StObject
         with PackageManager
    /* "cnpm" */ val Cnpm: typingsJapgolly.schematicsAngular.ngNewSchemaMod.PackageManager.Cnpm & String = js.native
    
    @js.native
    sealed trait Npm
      extends StObject
         with PackageManager
    /* "npm" */ val Npm: typingsJapgolly.schematicsAngular.ngNewSchemaMod.PackageManager.Npm & String = js.native
    
    @js.native
    sealed trait Pnpm
      extends StObject
         with PackageManager
    /* "pnpm" */ val Pnpm: typingsJapgolly.schematicsAngular.ngNewSchemaMod.PackageManager.Pnpm & String = js.native
    
    @js.native
    sealed trait Yarn
      extends StObject
         with PackageManager
    /* "yarn" */ val Yarn: typingsJapgolly.schematicsAngular.ngNewSchemaMod.PackageManager.Yarn & String = js.native
  }
  ...
  object Style extends StObject {
    ...
    sealed trait Css
      extends StObject
         with Style
    /* "css" */ val Css: typingsJapgolly.schematicsAngular.ngNewSchemaMod.Style.Css & String = js.native
    
    @js.native
    sealed trait Less
      extends StObject
         with Style
    /* "less" */ val Less: typingsJapgolly.schematicsAngular.ngNewSchemaMod.Style.Less & String = js.native
    
    @js.native
    sealed trait Sass
      extends StObject
         with Style
    /* "sass" */ val Sass: typingsJapgolly.schematicsAngular.ngNewSchemaMod.Style.Sass & String = js.native
    
    @js.native
    sealed trait Scss
      extends StObject
         with Style
    /* "scss" */ val Scss: typingsJapgolly.schematicsAngular.ngNewSchemaMod.Style.Scss & String = js.native
  }
  ...
  object ViewEncapsulation extends StObject {
    ...
    /* "Emulated" */ val Emulated: typingsJapgolly.schematicsAngular.ngNewSchemaMod.ViewEncapsulation.Emulated & String = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with ViewEncapsulation
    /* "None" */ val None: typingsJapgolly.schematicsAngular.ngNewSchemaMod.ViewEncapsulation.None & String = js.native
    
    @js.native
    sealed trait ShadowDom
      extends StObject
         with ViewEncapsulation
    /* "ShadowDom" */ val ShadowDom: typingsJapgolly.schematicsAngular.ngNewSchemaMod.ViewEncapsulation.ShadowDom & String = js.native
  }
