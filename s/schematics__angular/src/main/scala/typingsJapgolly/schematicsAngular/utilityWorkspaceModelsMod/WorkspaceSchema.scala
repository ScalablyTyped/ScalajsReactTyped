...
import typingsJapgolly.schematicsAngular.utilityWorkspaceModelsMod.ProjectType.Application
import typingsJapgolly.schematicsAngular.utilityWorkspaceModelsMod.ProjectType.Library
