...
object applicationSchemaMod {
  ...
  object Style extends StObject {
    ...
    sealed trait Css
      extends StObject
         with Style
    /* "css" */ val Css: typingsJapgolly.schematicsAngular.applicationSchemaMod.Style.Css & String = js.native
    
    @js.native
    sealed trait Less
      extends StObject
         with Style
    /* "less" */ val Less: typingsJapgolly.schematicsAngular.applicationSchemaMod.Style.Less & String = js.native
    
    @js.native
    sealed trait Sass
      extends StObject
         with Style
    /* "sass" */ val Sass: typingsJapgolly.schematicsAngular.applicationSchemaMod.Style.Sass & String = js.native
    
    @js.native
    sealed trait Scss
      extends StObject
         with Style
    /* "scss" */ val Scss: typingsJapgolly.schematicsAngular.applicationSchemaMod.Style.Scss & String = js.native
  }
  ...
  object ViewEncapsulation extends StObject {
    ...
    /* "Emulated" */ val Emulated: typingsJapgolly.schematicsAngular.applicationSchemaMod.ViewEncapsulation.Emulated & String = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with ViewEncapsulation
    /* "None" */ val None: typingsJapgolly.schematicsAngular.applicationSchemaMod.ViewEncapsulation.None & String = js.native
    
    @js.native
    sealed trait ShadowDom
      extends StObject
         with ViewEncapsulation
    /* "ShadowDom" */ val ShadowDom: typingsJapgolly.schematicsAngular.applicationSchemaMod.ViewEncapsulation.ShadowDom & String = js.native
  }
