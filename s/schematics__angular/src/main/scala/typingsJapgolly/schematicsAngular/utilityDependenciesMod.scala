...
object utilityDependenciesMod {
  ...
  object NodeDependencyType extends StObject {
    ...
    /* "dependencies" */ val Default: typingsJapgolly.schematicsAngular.utilityDependenciesMod.NodeDependencyType.Default & String = js.native
    
    @js.native
    sealed trait Dev
      extends StObject
         with NodeDependencyType
    /* "devDependencies" */ val Dev: typingsJapgolly.schematicsAngular.utilityDependenciesMod.NodeDependencyType.Dev & String = js.native
    
    @js.native
    sealed trait Optional
      extends StObject
         with NodeDependencyType
    /* "optionalDependencies" */ val Optional: typingsJapgolly.schematicsAngular.utilityDependenciesMod.NodeDependencyType.Optional & String = js.native
    
    @js.native
    sealed trait Peer
      extends StObject
         with NodeDependencyType
    /* "peerDependencies" */ val Peer: typingsJapgolly.schematicsAngular.utilityDependenciesMod.NodeDependencyType.Peer & String = js.native
  }
