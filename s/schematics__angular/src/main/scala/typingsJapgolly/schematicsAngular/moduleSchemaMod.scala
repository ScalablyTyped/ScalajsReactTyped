...
object moduleSchemaMod {
  ...
  object RoutingScope extends StObject {
    ...
    sealed trait Child
      extends StObject
         with RoutingScope
    /* "Child" */ val Child: typingsJapgolly.schematicsAngular.moduleSchemaMod.RoutingScope.Child & String = js.native
    
    @js.native
    sealed trait Root
      extends StObject
         with RoutingScope
    /* "Root" */ val Root: typingsJapgolly.schematicsAngular.moduleSchemaMod.RoutingScope.Root & String = js.native
  }
