...
object componentSchemaMod {
  ...
  object ChangeDetection extends StObject {
    ...
    /* "Default" */ val Default: typingsJapgolly.schematicsAngular.componentSchemaMod.ChangeDetection.Default & String = js.native
    
    @js.native
    sealed trait OnPush
      extends StObject
         with ChangeDetection
    /* "OnPush" */ val OnPush: typingsJapgolly.schematicsAngular.componentSchemaMod.ChangeDetection.OnPush & String = js.native
  }
  ...
  object Style extends StObject {
    ...
    sealed trait Css
      extends StObject
         with Style
    /* "css" */ val Css: typingsJapgolly.schematicsAngular.componentSchemaMod.Style.Css & String = js.native
    
    @js.native
    sealed trait Less
      extends StObject
         with Style
    /* "less" */ val Less: typingsJapgolly.schematicsAngular.componentSchemaMod.Style.Less & String = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with Style
    /* "none" */ val None: typingsJapgolly.schematicsAngular.componentSchemaMod.Style.None & String = js.native
    
    @js.native
    sealed trait Sass
      extends StObject
         with Style
    /* "sass" */ val Sass: typingsJapgolly.schematicsAngular.componentSchemaMod.Style.Sass & String = js.native
    
    @js.native
    sealed trait Scss
      extends StObject
         with Style
    /* "scss" */ val Scss: typingsJapgolly.schematicsAngular.componentSchemaMod.Style.Scss & String = js.native
  }
  ...
  object ViewEncapsulation extends StObject {
    ...
    /* "Emulated" */ val Emulated: typingsJapgolly.schematicsAngular.componentSchemaMod.ViewEncapsulation.Emulated & String = js.native
    
    @js.native
    sealed trait None
      extends StObject
         with ViewEncapsulation
    /* "None" */ val None: typingsJapgolly.schematicsAngular.componentSchemaMod.ViewEncapsulation.None & String = js.native
    
    @js.native
    sealed trait ShadowDom
      extends StObject
         with ViewEncapsulation
    /* "ShadowDom" */ val ShadowDom: typingsJapgolly.schematicsAngular.componentSchemaMod.ViewEncapsulation.ShadowDom & String = js.native
  }
