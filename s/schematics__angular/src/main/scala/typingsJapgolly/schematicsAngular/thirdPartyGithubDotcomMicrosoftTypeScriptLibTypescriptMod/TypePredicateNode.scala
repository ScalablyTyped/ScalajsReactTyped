...
trait TypePredicateNode
  ...
  @JSName("kind")
  val kind_TypePredicateNode: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.TypePredicate = js.native
