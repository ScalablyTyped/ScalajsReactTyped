...
trait CallExpression
  ...
  @JSName("kind")
  val kind_CallExpression: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.CallExpression = js.native
