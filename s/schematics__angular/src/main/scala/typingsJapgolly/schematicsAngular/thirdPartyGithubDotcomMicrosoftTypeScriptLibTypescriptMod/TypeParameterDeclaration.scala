...
trait TypeParameterDeclaration
  ...
  @JSName("kind")
  val kind_TypeParameterDeclaration: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.TypeParameter = js.native
