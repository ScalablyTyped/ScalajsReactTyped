...
trait JsxSelfClosingElement
  ...
  @JSName("kind")
  val kind_JsxSelfClosingElement: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.JsxSelfClosingElement = js.native
