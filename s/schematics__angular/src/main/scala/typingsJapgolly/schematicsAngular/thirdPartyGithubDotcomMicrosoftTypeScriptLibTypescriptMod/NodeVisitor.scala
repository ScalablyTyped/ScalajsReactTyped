...
trait NodeVisitor extends StObject {
  ...
  def apply[T /* <: Node */](nodes: Unit, visitor: Unit, test: Unit, lift: js.Function1[/* node */ js.Array[Node], T]): js.UndefOr[T] = js.native
  ...
  def apply[T /* <: Node */](nodes: Unit, visitor: Visitor, test: Unit, lift: js.Function1[/* node */ js.Array[Node], T]): js.UndefOr[T] = js.native
}
