...
trait TemplateLiteralTypeSpan
  ...
  @JSName("kind")
  val kind_TemplateLiteralTypeSpan: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.TemplateLiteralTypeSpan = js.native
