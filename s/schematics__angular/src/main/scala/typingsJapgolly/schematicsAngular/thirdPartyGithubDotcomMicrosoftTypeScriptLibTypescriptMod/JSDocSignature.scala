...
trait JSDocSignature
  ...
  @JSName("kind")
  val kind_JSDocSignature: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.JSDocSignature = js.native
