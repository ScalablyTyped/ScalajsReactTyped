...
trait ShorthandPropertyAssignment
  ...
  @JSName("kind")
  val kind_ShorthandPropertyAssignment: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ShorthandPropertyAssignment = js.native
