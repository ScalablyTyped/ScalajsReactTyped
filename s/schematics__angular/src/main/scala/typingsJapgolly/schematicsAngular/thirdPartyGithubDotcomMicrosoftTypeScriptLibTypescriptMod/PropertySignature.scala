...
trait PropertySignature
  ...
  @JSName("kind")
  val kind_PropertySignature: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.PropertySignature = js.native
