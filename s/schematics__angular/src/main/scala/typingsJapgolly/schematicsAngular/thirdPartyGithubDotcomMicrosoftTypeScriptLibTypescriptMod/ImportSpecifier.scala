...
trait ImportSpecifier
  ...
  @JSName("kind")
  val kind_ImportSpecifier: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ImportSpecifier = js.native
