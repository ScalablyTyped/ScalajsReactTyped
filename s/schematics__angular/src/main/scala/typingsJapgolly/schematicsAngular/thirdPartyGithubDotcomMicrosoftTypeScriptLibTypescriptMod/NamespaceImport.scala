...
trait NamespaceImport
  ...
  @JSName("kind")
  val kind_NamespaceImport: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.NamespaceImport = js.native
