...
trait VariableDeclaration
  ...
  @JSName("kind")
  val kind_VariableDeclaration: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.VariableDeclaration = js.native
