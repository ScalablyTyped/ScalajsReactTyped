...
trait ModuleDeclaration
  ...
  @JSName("kind")
  val kind_ModuleDeclaration: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ModuleDeclaration = js.native
