...
trait PropertyAccessExpression
  ...
  @JSName("kind")
  val kind_PropertyAccessExpression: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.PropertyAccessExpression = js.native
