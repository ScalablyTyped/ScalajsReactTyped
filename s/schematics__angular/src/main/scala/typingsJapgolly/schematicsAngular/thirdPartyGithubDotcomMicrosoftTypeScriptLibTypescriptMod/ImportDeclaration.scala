...
trait ImportDeclaration
  ...
  @JSName("kind")
  val kind_ImportDeclaration: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ImportDeclaration = js.native
