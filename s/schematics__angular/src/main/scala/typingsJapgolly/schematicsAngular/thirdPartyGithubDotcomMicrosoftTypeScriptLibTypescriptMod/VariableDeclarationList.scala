...
trait VariableDeclarationList
  ...
  @JSName("kind")
  val kind_VariableDeclarationList: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.VariableDeclarationList = js.native
