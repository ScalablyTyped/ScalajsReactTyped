...
trait ObjectLiteralExpression
  ...
  @JSName("kind")
  val kind_ObjectLiteralExpression: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ObjectLiteralExpression = js.native
}
