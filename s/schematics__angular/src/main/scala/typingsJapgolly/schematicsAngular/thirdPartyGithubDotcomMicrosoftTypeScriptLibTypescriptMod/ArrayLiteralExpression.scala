...
trait ArrayLiteralExpression
  ...
  @JSName("kind")
  val kind_ArrayLiteralExpression: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ArrayLiteralExpression = js.native
}
