...
trait ForOfStatement
  ...
  @JSName("kind")
  val kind_ForOfStatement: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ForOfStatement = js.native
}
