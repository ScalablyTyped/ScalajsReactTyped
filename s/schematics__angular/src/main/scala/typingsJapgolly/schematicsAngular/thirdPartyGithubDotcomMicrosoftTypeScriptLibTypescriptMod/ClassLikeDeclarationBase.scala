...
trait ClassLikeDeclarationBase
  ...
  @JSName("kind")
  val kind_ClassLikeDeclarationBase: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ClassDeclaration | typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.ClassExpression = js.native
