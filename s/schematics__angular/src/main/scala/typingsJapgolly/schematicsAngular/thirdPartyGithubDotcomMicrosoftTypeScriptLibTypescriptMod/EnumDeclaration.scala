...
trait EnumDeclaration
  ...
  @JSName("kind")
  val kind_EnumDeclaration: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.EnumDeclaration = js.native
