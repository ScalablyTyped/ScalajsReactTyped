...
trait InterfaceDeclaration
  ...
  @JSName("kind")
  val kind_InterfaceDeclaration: typingsJapgolly.schematicsAngular.thirdPartyGithubDotcomMicrosoftTypeScriptLibTypescriptMod.SyntaxKind.InterfaceDeclaration = js.native
