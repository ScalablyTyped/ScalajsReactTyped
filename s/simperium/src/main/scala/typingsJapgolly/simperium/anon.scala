...
import typingsJapgolly.simperium.mod.Change
import typingsJapgolly.simperium.mod.DMPDiff
import typingsJapgolly.simperium.mod.DiffOp
import typingsJapgolly.simperium.mod.EntityId
import typingsJapgolly.simperium.mod.JSONDiff
import typingsJapgolly.simperium.mod.LocalQueuedChange
import typingsJapgolly.simperium.simperiumStrings.I
import typingsJapgolly.simperium.simperiumStrings.L
import typingsJapgolly.simperium.simperiumStrings.Plussign
import typingsJapgolly.simperium.simperiumStrings.`-_`
import typingsJapgolly.simperium.simperiumStrings.d
import typingsJapgolly.simperium.simperiumStrings.full
import typingsJapgolly.simperium.simperiumStrings.modify
import typingsJapgolly.simperium.simperiumStrings.r
import typingsJapgolly.simperium.simperiumStrings.remove
...
object anon {
  ...
  trait VJSONDiff[T]
    ...
    var o: typingsJapgolly.simperium.simperiumStrings.O
  ...
  object VJSONDiff {
    ...
    extension [Self <: VJSONDiff[?], T](x: Self & VJSONDiff[T]) {
      ...
      inline def setO(value: typingsJapgolly.simperium.simperiumStrings.O): Self = StObject.set(x, "o", value.asInstanceOf[js.Any])
