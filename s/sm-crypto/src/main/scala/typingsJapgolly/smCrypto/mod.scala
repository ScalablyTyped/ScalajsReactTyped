package typingsJapgolly.smCrypto

import typingsJapgolly.smCrypto.anon.Der
import typingsJapgolly.smCrypto.anon.Hash
import typingsJapgolly.smCrypto.smCryptoStrings.array
import typingsJapgolly.smCrypto.smCryptoStrings.cbc
import typingsJapgolly.smCrypto.smCryptoStrings.none
import typingsJapgolly.smCrypto.smCryptoStrings.pkcsNumbersign5
import typingsJapgolly.smCrypto.smCryptoStrings.string
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.smCrypto.smCryptoInts.`0`
    - typingsJapgolly.smCrypto.smCryptoInts.`1`
  */
  trait CipherMode extends StObject
  object CipherMode {
    
    inline def `0`: typingsJapgolly.smCrypto.smCryptoInts.`0` = 0.asInstanceOf[typingsJapgolly.smCrypto.smCryptoInts.`0`]
    
    inline def `1`: typingsJapgolly.smCrypto.smCryptoInts.`1` = 1.asInstanceOf[typingsJapgolly.smCrypto.smCryptoInts.`1`]
  }
  ...
  trait KeyPairPoint
    ...
    var k: typingsJapgolly.bigi.mod.^
    
    var x1: typingsJapgolly.bigi.mod.^
  }
  object KeyPairPoint {
    
    inline def apply(
      k: typingsJapgolly.bigi.mod.^,
      privateKey: String,
      publicKey: String,
      x1: typingsJapgolly.bigi.mod.^
    ): KeyPairPoint = {
    ...
    extension [Self <: KeyPairPoint](x: Self) {
      ...
      inline def setK(value: typingsJapgolly.bigi.mod.^): Self = StObject.set(x, "k", value.asInstanceOf[js.Any])
      
      inline def setX1(value: typingsJapgolly.bigi.mod.^): Self = StObject.set(x, "x1", value.asInstanceOf[js.Any])
    }
  }
