...
object global {
  ...
  inline def nlapiCreateSearch(
    ...
    columns: js.Array[typingsJapgolly.suitescript.nlobjSearchColumn]
  ...
  inline def nlapiCreateSearch(
    `type`: String,
    filters: js.Array[nlobjSearchFilter],
    columns: typingsJapgolly.suitescript.nlobjSearchColumn
  ): nlobjSearch = (js.Dynamic.global.applyDynamic("nlapiCreateSearch")(`type`.asInstanceOf[js.Any], filters.asInstanceOf[js.Any], columns.asInstanceOf[js.Any])).asInstanceOf[nlobjSearch]
  inline def nlapiCreateSearch(
    `type`: String,
  ...
  inline def nlapiCreateSearch(`type`: String, filters: nlobjSearchFilter, columns: typingsJapgolly.suitescript.nlobjSearchColumn): nlobjSearch = (js.Dynamic.global.applyDynamic("nlapiCreateSearch")(`type`.asInstanceOf[js.Any], filters.asInstanceOf[js.Any], columns.asInstanceOf[js.Any])).asInstanceOf[nlobjSearch]
  ...
  open class nlobjError protected ()
    extends StObject
       with typingsJapgolly.suitescript.nlobjError
       with /**
    *
    * @return
    */
  ...
  open class nlobjSearchColumn protected ()
    extends StObject
       with typingsJapgolly.suitescript.nlobjSearchColumn
       with /**
    *
    * @param name
    * @param join
    ...
    * @return
    */
  Instantiable1[/* name */ String, typingsJapgolly.suitescript.nlobjSearchColumn]
       with Instantiable2[/* name */ String, /* join */ String, typingsJapgolly.suitescript.nlobjSearchColumn]
       with Instantiable3[
          /* name */ String, 
          (/* join */ String) | (/* join */ Unit), 
          /* summary */ String, 
          typingsJapgolly.suitescript.nlobjSearchColumn
        ] {
    def this(name: String) = this()
    def this(name: String, join: String) = this()
    def this(name: String, join: String, summary: String) = this()
    ...
    /* CompleteClass */
    override def setLabel(label: String): typingsJapgolly.suitescript.nlobjSearchColumn = js.native
