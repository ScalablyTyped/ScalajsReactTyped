package typingsJapgolly.semanticUiReactEventStack.eventTargetMod
...
object EventTarget {
  ...
  def apply(
    ...
    __obj.updateDynamic("addHandlers")(js.Any.fromFunction3((t0: java.lang.String, t1: java.lang.String, t2: typingsJapgolly.semanticUiReactEventStack.typesMod.EventListeners) => addHandlers(t0, t1, t2).runNow()))
    __obj.updateDynamic("hasHandlers")(hasHandlers.toJsFn)
    __obj.updateDynamic("removeHandlers")(js.Any.fromFunction3((t0: java.lang.String, t1: java.lang.String, t2: typingsJapgolly.semanticUiReactEventStack.typesMod.EventListeners) => removeHandlers(t0, t1, t2).runNow()))
