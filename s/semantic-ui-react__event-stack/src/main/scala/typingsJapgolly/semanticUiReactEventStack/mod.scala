...
object mod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.semanticUiReactEventStack.libTypesEventStackMod.default
  /* static members */
  object default {
  ...
  @js.native
  val instance: typingsJapgolly.semanticUiReactEventStack.libTypesLibEventStackMod.default = js.native
}
