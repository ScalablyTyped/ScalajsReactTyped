...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-syntax-highlighter" % "11.0-dt-20200225Z-ca24a7",
  "org.scalablytyped.japgolly" %%% "std" % "3.8-8884a5",
  "org.scalablytyped.japgolly" %%% "storybook__addon-actions" % "5.3.13-fb084b",
  "org.scalablytyped.japgolly" %%% "storybook__api" % "5.3.13-9de0c2",
  "org.scalablytyped.japgolly" %%% "storybook__channels" % "5.3.13-402241",
  "org.scalablytyped.japgolly" %%% "storybook__components" % "5.3.13-98d6a0",
