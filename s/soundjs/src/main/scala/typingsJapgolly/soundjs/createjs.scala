...
import org.scalajs.dom.DynamicsCompressorNode
...
import typingsJapgolly.preloadjs.createjs.AbstractLoader
...
object createjs {
  ...
  object AbstractPlugin {
    ...
    inline def apply(
      ...
      preload: js.Object => Callback,
      register: (String, Double) => js.Object,
      removeAllSounds: String => Callback,
      removeSound: String => Callback,
      setMute: Boolean => Boolean,
      setVolume: Double => Boolean
    ): AbstractPlugin = {
      val __obj = js.Dynamic.literal(create = js.Any.fromFunction3(create), getVolume = getVolume.toJsFn, isPreloadComplete = js.Any.fromFunction1(isPreloadComplete), isPreloadStarted = js.Any.fromFunction1(isPreloadStarted), isSupported = isSupported.toJsFn, preload = js.Any.fromFunction1((t0: js.Object) => preload(t0).runNow()), register = js.Any.fromFunction2(register), removeAllSounds = js.Any.fromFunction1((t0: String) => removeAllSounds(t0).runNow()), removeSound = js.Any.fromFunction1((t0: String) => removeSound(t0).runNow()), setMute = js.Any.fromFunction1(setMute), setVolume = js.Any.fromFunction1(setVolume))
    ...
    extension [Self <: AbstractPlugin](x: Self) {
      ...
      inline def setPreload(value: js.Object => Callback): Self = StObject.set(x, "preload", js.Any.fromFunction1((t0: js.Object) => value(t0).runNow()))
      
      inline def setRegister(value: (String, Double) => js.Object): Self = StObject.set(x, "register", js.Any.fromFunction2(value))
      
      inline def setRemoveAllSounds(value: String => Callback): Self = StObject.set(x, "removeAllSounds", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setRemoveSound(value: String => Callback): Self = StObject.set(x, "removeSound", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  ...
  object FlashPlugin {
    ...
    inline def apply(
      ...
      getVolume: CallbackTo[Double],
      isPreloadStarted: String => Boolean,
      preload: (String, js.Object) => Callback,
      register: (String, Double) => js.Object,
      removeAllSounds: Callback,
      removeSound: String => Callback,
      setMute: Boolean => Boolean,
      setVolume: Double => Boolean,
      showOutput: Boolean
    ): FlashPlugin = {
      val __obj = js.Dynamic.literal(create = js.Any.fromFunction1(create), flashReady = flashReady.asInstanceOf[js.Any], getVolume = getVolume.toJsFn, isPreloadStarted = js.Any.fromFunction1(isPreloadStarted), preload = js.Any.fromFunction2((t0: String, t1: js.Object) => (preload(t0, t1)).runNow()), register = js.Any.fromFunction2(register), removeAllSounds = removeAllSounds.toJsFn, removeSound = js.Any.fromFunction1((t0: String) => removeSound(t0).runNow()), setMute = js.Any.fromFunction1(setMute), setVolume = js.Any.fromFunction1(setVolume), showOutput = showOutput.asInstanceOf[js.Any])
    ...
    extension [Self <: FlashPlugin](x: Self) {
      ...
      inline def setPreload(value: (String, js.Object) => Callback): Self = StObject.set(x, "preload", js.Any.fromFunction2((t0: String, t1: js.Object) => (value(t0, t1)).runNow()))
      
      inline def setRegister(value: (String, Double) => js.Object): Self = StObject.set(x, "register", js.Any.fromFunction2(value))
      
      inline def setRemoveAllSounds(value: Callback): Self = StObject.set(x, "removeAllSounds", value.toJsFn)
