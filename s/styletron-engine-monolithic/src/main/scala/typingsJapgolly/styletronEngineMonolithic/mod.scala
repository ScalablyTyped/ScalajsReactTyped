package typingsJapgolly.styletronEngineMonolithic
...
import typingsJapgolly.std.FontFace
import typingsJapgolly.std.HTMLCollectionOf
import typingsJapgolly.styletronEngineMonolithic.anon.Block
import typingsJapgolly.styletronStandard.libStyleTypesMod.KeyframesObject
...
object mod {
  ...
  open class Client ()
    ...
    /* CompleteClass */
    override def renderFontFace(fontFace: typingsJapgolly.styletronStandard.libStyleTypesMod.FontFace): String = js.native
  ...
  type HydrateType = HTMLCollectionOf[HTMLStyleElement] | js.Array[HTMLStyleElement] | (NodeList[HTMLStyleElement & Node])
  ...
  object MultiCache {
    ...
    extension [Self <: MultiCache[?], T](x: Self & MultiCache[T]) {
      ...
      inline def setGetSortedCacheKeys(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "getSortedCacheKeys", value.toJsFn)
  ...
  object SequentialIDGenerator {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(count = count.asInstanceOf[js.Any], increment = increment.toJsFn, msb = msb.asInstanceOf[js.Any], next = next.toJsFn, offset = offset.asInstanceOf[js.Any], power = power.asInstanceOf[js.Any], prefix = prefix.asInstanceOf[js.Any])
    ...
    extension [Self <: SequentialIDGenerator](x: Self) {
      ...
      inline def setIncrement(value: CallbackTo[Double]): Self = StObject.set(x, "increment", value.toJsFn)
