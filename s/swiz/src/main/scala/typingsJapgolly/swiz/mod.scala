...
import typingsJapgolly.swiz.mod.struct.IField
import typingsJapgolly.swiz.mod.struct.IObj
...
object mod {
  ...
  object SERIALIZATION extends StObject {
    ...
    sealed trait SERIALIZATION_JSON
      extends StObject
         with SERIALIZATION
    /* 0 */ val SERIALIZATION_JSON: typingsJapgolly.swiz.mod.SERIALIZATION.SERIALIZATION_JSON & Double = js.native
    
    @js.native
    sealed trait SERIALIZATION_XML
      extends StObject
         with SERIALIZATION
    /* 1 */ val SERIALIZATION_XML: typingsJapgolly.swiz.mod.SERIALIZATION.SERIALIZATION_XML & Double = js.native
  }
  ...
  object ISerializable {
    ...
    inline def apply(getSerializerType: CallbackTo[String]): ISerializable = {
      val __obj = js.Dynamic.literal(getSerializerType = getSerializerType.toJsFn)
      __obj.asInstanceOf[ISerializable]
    }
    
    extension [Self <: ISerializable](x: Self) {
      
      inline def setGetSerializerType(value: CallbackTo[String]): Self = StObject.set(x, "getSerializerType", value.toJsFn)
    }
  }
  ...
  object IValidator {
    ...
    inline def apply(func: (Any, Any, js.Function) => Callback, help: String, name: String): IValidator = {
      val __obj = js.Dynamic.literal(func = js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function) => (func(t0, t1, t2)).runNow()), help = help.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[IValidator]
    }
    
    extension [Self <: IValidator](x: Self) {
      
      inline def setFunc(value: (Any, Any, js.Function) => Callback): Self = StObject.set(x, "func", js.Any.fromFunction3((t0: Any, t1: Any, t2: js.Function) => (value(t0, t1, t2)).runNow()))
