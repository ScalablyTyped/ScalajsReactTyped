...
import typingsJapgolly.samchon.templatesSlaveSlaveSystemMod.SlaveSystem
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object templatesSlaveSlaveServerMod {
  
  /* note: abstract class */ @JSImport("samchon/templates/slave/SlaveServer", "SlaveServer")
  @js.native
  /**
    * Default Constructor.
    */
  open class SlaveServer () extends ISlaveServer {
