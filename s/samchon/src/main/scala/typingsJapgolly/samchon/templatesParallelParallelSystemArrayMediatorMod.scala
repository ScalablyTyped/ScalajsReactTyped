...
object templatesParallelParallelSystemArrayMediatorMod {
  
  /* note: abstract class */ @JSImport("samchon/templates/parallel/ParallelSystemArrayMediator", "ParallelSystemArrayMediator")
  @js.native
  /**
    * Default Constructor.
    */
  open class ParallelSystemArrayMediator[System /* <: ParallelSystem */] () extends ParallelSystemArray[System] {
