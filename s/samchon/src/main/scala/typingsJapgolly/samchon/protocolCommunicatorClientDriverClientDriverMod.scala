...
object protocolCommunicatorClientDriverClientDriverMod {
  ...
  - typingsJapgolly.samchon.protocolCommunicatorIclientdriverMod.IClientDriver because var conflicts: onClose. Inlined listen */ @JSImport("samchon/protocol/communicator/client_driver/ClientDriver", "ClientDriver")
  @js.native
