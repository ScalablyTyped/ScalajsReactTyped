...
object libraryMod {
  ...
  object default {
    ...
    @js.native
    open class XML ()
      extends typingsJapgolly.samchon.libraryXmlMod.default.XML {
    ...
    @js.native
    open class XMLList ()
      extends typingsJapgolly.samchon.libraryXmlMod.default.XMLList
  }
  
  @JSImport("samchon/library", "CartesianProduct")
  @js.native
  open class CartesianProduct protected ()
    extends typingsJapgolly.samchon.libraryCaseGeneratorsCartesianProductMod.CartesianProduct {
    /**
  ...
  open class Factorial protected ()
    extends typingsJapgolly.samchon.libraryCaseGeneratorsFactorialMod.Factorial {
    /**
  ...
  open class Permutation protected ()
    extends typingsJapgolly.samchon.libraryCaseGeneratorsPermutationMod.Permutation {
    /**
  ...
  open class RepeatedPermutation protected ()
    extends typingsJapgolly.samchon.libraryCaseGeneratorsRepeatedPermutationMod.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  open class StringUtil ()
    extends typingsJapgolly.samchon.libraryUtilsStringUtilMod.StringUtil
  /* static members */
  object StringUtil {
  ...
  open class URLVariables ()
    extends typingsJapgolly.samchon.libraryUrlvariablesMod.URLVariables {
    /**
  ...
  @js.native
  open class XML ()
    extends typingsJapgolly.samchon.libraryXmlMod.XML {
    def this(str: String) = this()
    def this(xml: typingsJapgolly.sxml.libModuleXmlMod.XML) = this()
  }
  /* static members */
  ...
  @js.native
  open class XMLList ()
    extends typingsJapgolly.samchon.libraryXmlMod.XMLList
}
