...
object libraryMod extends js.Object {
  ...
  class CartesianProduct protected ()
    extends typingsJapgolly.samchon.cartesianProductMod.CartesianProduct {
    /**
  ...
  class Factorial protected ()
    extends typingsJapgolly.samchon.factorialMod.Factorial {
    /**
  ...
  class Permutation protected ()
    extends typingsJapgolly.samchon.permutationMod.Permutation {
    /**
  ...
  class RepeatedPermutation protected ()
    extends typingsJapgolly.samchon.repeatedPermutationMod.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  @js.native
  class StringUtil ()
    extends typingsJapgolly.samchon.stringUtilMod.StringUtil
  ...
  /**
    ...
    */
  class URLVariables ()
    extends typingsJapgolly.samchon.urlvariablesMod.URLVariables {
    /**
  ...
  @js.native
  class XML ()
    extends typingsJapgolly.samchon.xmlMod.XML {
    def this(str: String) = this()
