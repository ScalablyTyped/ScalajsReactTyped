...
object templatesExternalMod {
  ...
  open class ExternalClientArray[T /* <: typingsJapgolly.samchon.templatesExternalExternalSystemMod.ExternalSystem */] ()
    extends typingsJapgolly.samchon.templatesExternalDerivedExternalClientArrayMod.ExternalClientArray[T]
  
  /* note: abstract class */ @JSImport("samchon/templates/external", "ExternalServer")
  @js.native
  open class ExternalServer protected ()
    extends typingsJapgolly.samchon.templatesExternalDerivedExternalServerMod.ExternalServer {
    /**
  ...
  open class ExternalServerArray[T /* <: IExternalServer */] ()
    extends typingsJapgolly.samchon.templatesExternalDerivedExternalServerArrayMod.ExternalServerArray[T]
  ...
  open class ExternalServerClientArray[T /* <: typingsJapgolly.samchon.templatesExternalExternalSystemMod.ExternalSystem */] ()
    extends typingsJapgolly.samchon.templatesExternalDerivedExternalServerClientArrayMod.ExternalServerClientArray[T]
  
  /* note: abstract class */ @JSImport("samchon/templates/external", "ExternalSystem")
  @js.native
  open class ExternalSystem protected ()
    extends typingsJapgolly.samchon.templatesExternalExternalSystemMod.ExternalSystem {
    /**
      * Construct from parent {@link ExternalSystemArray}.
      *
      * @param systemArray The parent {@link ExternalSystemArray} object.
  ...
  open class ExternalSystemArray[System /* <: typingsJapgolly.samchon.templatesExternalExternalSystemMod.ExternalSystem */] ()
    extends typingsJapgolly.samchon.templatesExternalExternalSystemArrayMod.ExternalSystemArray[System]
  
  /* note: abstract class */ @JSImport("samchon/templates/external", "ExternalSystemRole")
  @js.native
  open class ExternalSystemRole protected ()
    extends typingsJapgolly.samchon.templatesExternalExternalSystemRoleMod.ExternalSystemRole {
    /**
