...
object templatesParallelParallelSystemMod {
  
  /* note: abstract class */ @JSImport("samchon/templates/parallel/ParallelSystem", "ParallelSystem")
  @js.native
  open class ParallelSystem protected () extends ExternalSystem {
    /**
