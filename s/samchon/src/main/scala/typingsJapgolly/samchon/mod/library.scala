...
object library {
  ...
  object default {
    ...
    @js.native
    open class XML ()
      extends typingsJapgolly.samchon.libraryMod.default.XML {
    ...
    @js.native
    open class XMLList ()
      extends typingsJapgolly.samchon.libraryMod.default.XMLList
  }
  
  @JSImport("samchon", "library.CartesianProduct")
  @js.native
  open class CartesianProduct protected ()
    extends typingsJapgolly.samchon.libraryMod.CartesianProduct {
    /**
  ...
  open class Factorial protected ()
    extends typingsJapgolly.samchon.libraryMod.Factorial {
    /**
  ...
  open class Permutation protected ()
    extends typingsJapgolly.samchon.libraryMod.Permutation {
    /**
  ...
  open class RepeatedPermutation protected ()
    extends typingsJapgolly.samchon.libraryMod.RepeatedPermutation {
    /**
      * Construct from size of N and R.
      *
      * @param n Size of candidates.
  ...
  open class StringUtil ()
    extends typingsJapgolly.samchon.libraryMod.StringUtil
  /* static members */
  object StringUtil {
  ...
  open class URLVariables ()
    extends typingsJapgolly.samchon.libraryMod.URLVariables {
    /**
  ...
  @js.native
  open class XML ()
    extends typingsJapgolly.samchon.libraryMod.XML {
    def this(str: String) = this()
    def this(xml: typingsJapgolly.sxml.libModuleXmlMod.XML) = this()
  }
  /* static members */
  ...
  @js.native
  open class XMLList ()
    extends typingsJapgolly.samchon.libraryMod.XMLList
}
