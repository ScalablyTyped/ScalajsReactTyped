...
object service extends js.Object {
  ...
  abstract class Client protected ()
    extends typingsJapgolly.samchon.templatesMod.service.Client {
    /**
  ...
  abstract class Server ()
    extends typingsJapgolly.samchon.templatesMod.service.Server
  
  @js.native
  abstract class Service protected ()
    extends typingsJapgolly.samchon.templatesMod.service.Service {
    /**
  ...
  abstract class User protected ()
    extends typingsJapgolly.samchon.templatesMod.service.User {
    /**
