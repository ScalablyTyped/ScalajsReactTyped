...
object protocol {
  ...
  open class ClientDriver protected ()
    extends typingsJapgolly.samchon.protocolMod.ClientDriver {
    /**
  ...
  open class DedicatedWorkerClientDriver ()
    extends typingsJapgolly.samchon.protocolMod.DedicatedWorkerClientDriver
  
  /* note: abstract class */ @JSImport("samchon", "protocol.DedicatedWorkerServer")
  @js.native
  open class DedicatedWorkerServer ()
    extends typingsJapgolly.samchon.protocolMod.DedicatedWorkerServer
  ...
  @js.native
  open class Server ()
    extends typingsJapgolly.samchon.protocolMod.Server
  ...
  open class SharedWorkerClientDriver protected ()
    extends typingsJapgolly.samchon.protocolMod.SharedWorkerClientDriver {
    /**
  ...
  open class SharedWorkerServer ()
    extends typingsJapgolly.samchon.protocolMod.SharedWorkerServer
  ...
  open class WebServer ()
    extends typingsJapgolly.samchon.protocolMod.WebServer
