...
import typingsJapgolly.samchon.protocolEntityEntityCollectionMod.EntityDequeCollection
...
import typingsJapgolly.samchon.templatesExternalExternalSystemRoleMod.ExternalSystemRole
