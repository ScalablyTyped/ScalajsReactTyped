...
import typingsJapgolly.samchon.protocolCommunicatorClientDriverClientDriverMod.ClientDriver
...
object protocolServerServerMod {
  
  /* note: abstract class */ @JSImport("samchon/protocol/server/Server", "Server")
  @js.native
  open class Server ()
    extends StObject
       with IServer {
    ...
    /**
      * @hidden
      */
    /* private */ var net_driver_ : Any = js.native
