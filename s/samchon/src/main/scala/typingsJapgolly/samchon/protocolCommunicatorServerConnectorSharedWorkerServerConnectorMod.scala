...
object protocolCommunicatorServerConnectorSharedWorkerServerConnectorMod {
  ...
  - typingsJapgolly.samchon.protocolCommunicatorIserverconnectorMod.IServerConnector because var conflicts: onClose. Inlined onConnect, connect */ @JSImport("samchon/protocol/communicator/server_connector/SharedWorkerServerConnector", "SharedWorkerServerConnector")
  @js.native
