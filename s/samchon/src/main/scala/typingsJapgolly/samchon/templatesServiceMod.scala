...
object templatesServiceMod {
  ...
  open class Client protected ()
    extends typingsJapgolly.samchon.templatesServiceClientMod.Client {
    /**
  ...
  /**
    ...
    */
  open class Server ()
    extends typingsJapgolly.samchon.templatesServiceServerMod.Server
  
  /* note: abstract class */ @JSImport("samchon/templates/service", "Service")
  @js.native
  open class Service protected ()
    extends typingsJapgolly.samchon.templatesServiceServiceMod.Service {
    /**
  ...
  open class User protected ()
    extends typingsJapgolly.samchon.templatesServiceUserMod.User {
    /**
