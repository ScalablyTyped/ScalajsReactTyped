package typingsJapgolly.samchon.iserverconnectorMod
...
object IServerConnector {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(onClose = onClose.asInstanceOf[js.Any], onConnect = onConnect.asInstanceOf[js.Any])
    __obj.updateDynamic("close")(close.toJsFn)
    __obj.updateDynamic("connect")(js.Any.fromFunction2((t0: java.lang.String, t1: scala.Double) => connect(t0, t1).runNow()))
