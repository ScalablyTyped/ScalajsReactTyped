...
import typingsJapgolly.samchon.protocolCommunicatorClientDriverSharedWorkerClientDriverMod.SharedWorkerClientDriver
...
object protocolServerSharedWorkerServerMod {
  
  /* note: abstract class */ @JSImport("samchon/protocol/server/SharedWorkerServer", "SharedWorkerServer")
  @js.native
