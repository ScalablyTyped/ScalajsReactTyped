...
object templatesParallelDerivedParallelClientArrayMediatorMod {
  ...
  - typingsJapgolly.samchon.templatesExternalInterfacesIexternalclientarrayMod.IExternalClientArray because var conflicts: _Handle_system_erase, _Notify_erase, _Notify_insert, dispatcher_. Inlined  */ @JSImport("samchon/templates/parallel/derived/ParallelClientArrayMediator", "ParallelClientArrayMediator")
  @js.native
  /**
    * Default Constructor.
    */
