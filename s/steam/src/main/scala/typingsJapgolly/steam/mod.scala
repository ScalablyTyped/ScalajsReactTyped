...
object mod {
  ...
  object EChatEntryType extends StObject {
    ...
    sealed trait ChatMsg
      extends StObject
         with EChatEntryType
    /* 0 */ val ChatMsg: typingsJapgolly.steam.mod.EChatEntryType.ChatMsg & Double = js.native
  }
  ...
  object EChatMemberStateChange extends StObject {
    ...
    /* 0 */ val Kicked: typingsJapgolly.steam.mod.EChatMemberStateChange.Kicked & Double = js.native
  }
  ...
  object EPersonaState extends StObject {
    ...
    sealed trait Online
      extends StObject
         with EPersonaState
    /* 0 */ val Online: typingsJapgolly.steam.mod.EPersonaState.Online & Double = js.native
  }
  ...
  object EResult extends StObject {
    ...
    sealed trait AccountLogonDenied
      extends StObject
         with EResult
    /* 0 */ val AccountLogonDenied: typingsJapgolly.steam.mod.EResult.AccountLogonDenied & Double = js.native
  }
