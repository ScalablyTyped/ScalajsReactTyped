...
object distTs3Dot9ComponentsReportRulesMod {
  ...
  object ImpactValue extends StObject {
    ...
    sealed trait CRITICAL
      extends StObject
         with ImpactValue
    /* "critical" */ val CRITICAL: typingsJapgolly.storybookAddonA11y.distTs3Dot9ComponentsReportRulesMod.ImpactValue.CRITICAL & String = js.native
    
    @js.native
    sealed trait MINOR
      extends StObject
         with ImpactValue
    /* "minor" */ val MINOR: typingsJapgolly.storybookAddonA11y.distTs3Dot9ComponentsReportRulesMod.ImpactValue.MINOR & String = js.native
    
    @js.native
    sealed trait MODERATE
      extends StObject
         with ImpactValue
    /* "moderate" */ val MODERATE: typingsJapgolly.storybookAddonA11y.distTs3Dot9ComponentsReportRulesMod.ImpactValue.MODERATE & String = js.native
    
    @js.native
    sealed trait SERIOUS
      extends StObject
         with ImpactValue
    /* "serious" */ val SERIOUS: typingsJapgolly.storybookAddonA11y.distTs3Dot9ComponentsReportRulesMod.ImpactValue.SERIOUS & String = js.native
  }
