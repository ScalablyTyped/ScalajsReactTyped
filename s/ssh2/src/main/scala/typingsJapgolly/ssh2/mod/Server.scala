...
import typingsJapgolly.ssh2.AnonAddress
import typingsJapgolly.ssh2.AnonFd
import typingsJapgolly.ssh2.ssh2Strings.close
import typingsJapgolly.ssh2.ssh2Strings.connection
import typingsJapgolly.ssh2.ssh2Strings.error
import typingsJapgolly.ssh2.ssh2Strings.listening
...
class Server protected () extends EventEmitter {
  ...
  /**
    ...
    * @param callback An optional callback to add to the `listening` event of the server.
    */
  def listen(handle: typingsJapgolly.node.netMod.Server): this.type = js.native
  def listen(handle: typingsJapgolly.node.netMod.Server, backlog: Double): this.type = js.native
  def listen(handle: typingsJapgolly.node.netMod.Server, backlog: Double, callback: js.Function0[Unit]): this.type = js.native
  def listen(handle: typingsJapgolly.node.netMod.Server, callback: js.Function0[Unit]): this.type = js.native
