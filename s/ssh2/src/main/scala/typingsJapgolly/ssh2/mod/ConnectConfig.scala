...
import typingsJapgolly.ssh2.ssh2Strings.force
import typingsJapgolly.ssh2.ssh2Strings.md5
import typingsJapgolly.ssh2.ssh2Strings.sha1
...
object ConnectConfig {
  ...
  def apply(
    ...
    hostVerifier: /* keyHash */ String => CallbackTo[Boolean] = null,
    ...
    if (hostVerifier != null) __obj.updateDynamic("hostVerifier")(js.Any.fromFunction1((t0: /* keyHash */ java.lang.String) => hostVerifier(t0).runNow()))
