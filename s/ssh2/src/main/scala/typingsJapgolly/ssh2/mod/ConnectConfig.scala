...
object ConnectConfig {
  ...
  extension [Self <: ConnectConfig](x: Self) {
    ...
    inline def setAuthHandlerFunction3(
      value: (/* authsLeft */ js.Array[AuthenticationType], /* partialSuccess */ Boolean, /* next */ NextAuthHandler) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "authHandler", js.Any.fromFunction3((t0: /* authsLeft */ js.Array[AuthenticationType], t1: /* partialSuccess */ Boolean, t2: /* next */ NextAuthHandler) => (value(t0, t1, t2)).runNow()))
