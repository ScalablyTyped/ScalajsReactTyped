...
object TransferOptions {
  ...
  extension [Self <: TransferOptions](x: Self) {
    ...
    inline def setStep(
      value: (/* total */ Double, /* nb */ Double, /* fsize */ Double) => japgolly.scalajs.react.Callback
    ): Self = StObject.set(x, "step", js.Any.fromFunction3((t0: /* total */ Double, t1: /* nb */ Double, t2: /* fsize */ Double) => (value(t0, t1, t2)).runNow()))
