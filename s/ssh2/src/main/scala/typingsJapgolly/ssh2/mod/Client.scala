...
import typingsJapgolly.ssh2.ssh2Booleans.`false`
import typingsJapgolly.ssh2.ssh2Strings.`change password`
import typingsJapgolly.ssh2.ssh2Strings.`keyboard-interactive`
import typingsJapgolly.ssh2.ssh2Strings.`tcp connection`
import typingsJapgolly.ssh2.ssh2Strings.`unix connection`
import typingsJapgolly.ssh2.ssh2Strings.banner
import typingsJapgolly.ssh2.ssh2Strings.close_
import typingsJapgolly.ssh2.ssh2Strings.connect
...
import typingsJapgolly.ssh2.ssh2Strings.hostkeys
import typingsJapgolly.ssh2.ssh2Strings.ready
import typingsJapgolly.ssh2.ssh2Strings.timeout
