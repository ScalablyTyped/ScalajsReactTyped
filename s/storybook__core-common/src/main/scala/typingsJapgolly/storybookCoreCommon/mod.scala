...
import typingsJapgolly.storybookCoreCommon.anon.CLIOptionsLoadOptionsBuil
import typingsJapgolly.storybookCoreCommon.anon.ConfigDir
import typingsJapgolly.storybookCoreCommon.anon.Ext
import typingsJapgolly.storybookCoreCommon.anon.Handler
import typingsJapgolly.storybookCoreCommon.anon.Local
import typingsJapgolly.storybookCoreCommon.anon.Match
import typingsJapgolly.storybookCoreCommon.anon.NormalizeOptionsdirectory
import typingsJapgolly.storybookCoreCommon.anon.Production
import typingsJapgolly.storybookCoreCommon.anon.Raw
import typingsJapgolly.storybookCoreCommon.anon.Version
import typingsJapgolly.storybookCoreCommon.distTs3Dot9PresetsMod.InterPresetOptions
import typingsJapgolly.storybookCoreCommon.distTs3Dot9PresetsMod.ResolvedAddonPreset
import typingsJapgolly.storybookCoreCommon.distTs3Dot9PresetsMod.ResolvedAddonVirtual
import typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.LoadedPreset
import typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.NormalizedStoriesSpecifier
import typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.PackageJson
import typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.PresetConfig
import typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.Presets
import typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.StoriesEntry
import typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.StorybookConfig
...
import typingsJapgolly.storybookCoreCommon.distTs3Dot9UtilsGetStorybookInfoMod.StorybookInfo
import typingsJapgolly.storybookCoreCommon.distTs3Dot9UtilsNormalizeStoriesMod.NormalizeOptions
...
object mod {
  ...
  inline def createFileSystemCache(options: typingsJapgolly.storybookCoreCommon.distTs3Dot9UtilsFileCacheMod.Options): FileSystemCache = ^.asInstanceOf[js.Dynamic].applyDynamic("createFileSystemCache")(options.asInstanceOf[js.Any]).asInstanceOf[FileSystemCache]
