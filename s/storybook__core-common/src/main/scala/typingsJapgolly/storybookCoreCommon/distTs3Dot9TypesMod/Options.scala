...
- typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.BuilderOptions because var conflicts: configDir, ignorePreview. Inlined configType, cache, docsMode, features, versionCheck, releaseNotesData, disableWebpackDefaults, serverChannelUrl
- typingsJapgolly.storybookCoreCommon.distTs3Dot9TypesMod.CLIOptions because var conflicts: configDir, ignorePreview, outputDir. Inlined port, previewUrl, forceBuildPreview, disableTelemetry, enableCrashReports, host, staticDir, https, sslCa, sslCert, sslKey, smokeTest, managerCache, open, ci, loglevel, quiet, versionUpdates, releaseNotes, dll, docs, docsDll, uiDll, debugWebpack, webpackStatsJson, modern */ trait Options
  extends StObject
     with LoadOptions
