...
package object mod {
  ...
  /**
    ...
    */
  type StampChainables[Obj] = typingsJapgolly.stampit.mod.Chainables[
    typingsJapgolly.stampit.mod.StampObjectType[Obj], 
    typingsJapgolly.stampit.mod.StampType[Obj]
  ]
  /**
  ...
  /**
    ...
    */
  type StampType[Original] = (typingsJapgolly.stampit.mod.stampit.Stamp[js.Any | Original]) | Original | js.Any
}
