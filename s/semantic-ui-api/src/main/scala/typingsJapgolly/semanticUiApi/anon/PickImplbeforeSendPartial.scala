...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'beforeSend'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplbeforeSendPartial
  extends StObject
     with Param {
