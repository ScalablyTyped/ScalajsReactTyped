...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'successTest'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplsuccessTestPartia
  extends StObject
     with Param {
...
object PickImplsuccessTestPartia {
  ...
  extension [Self <: PickImplsuccessTestPartia](x: Self) {
