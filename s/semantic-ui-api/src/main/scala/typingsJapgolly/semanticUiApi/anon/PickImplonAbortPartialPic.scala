...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'onAbort'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplonAbortPartialPic
  extends StObject
     with Param {
