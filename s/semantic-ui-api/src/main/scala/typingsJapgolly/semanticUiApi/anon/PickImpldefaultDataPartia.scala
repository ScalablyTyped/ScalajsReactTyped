...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'defaultData'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImpldefaultDataPartia
  extends StObject
     with Param {
