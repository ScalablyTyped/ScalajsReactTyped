...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.Api.ErrorSettings._Impl, 'error'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.Api.ErrorSettings._Impl, keyof semantic-ui-api.SemanticUI.Api.ErrorSettings._Impl>> */
trait PickImplerrorPartialPickIBeforeSend
  extends StObject
     with Param {
...
object PickImplerrorPartialPickIBeforeSend {
  ...
  extension [Self <: PickImplerrorPartialPickIBeforeSend](x: Self) {
