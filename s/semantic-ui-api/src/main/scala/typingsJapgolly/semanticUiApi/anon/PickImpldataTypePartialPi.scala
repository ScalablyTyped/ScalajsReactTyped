...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'dataType'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImpldataTypePartialPi
  extends StObject
     with Param {
...
object PickImpldataTypePartialPi {
  ...
  extension [Self <: PickImpldataTypePartialPi](x: Self) {
