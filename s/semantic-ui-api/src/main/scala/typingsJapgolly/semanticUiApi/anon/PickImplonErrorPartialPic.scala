...
/* Inlined std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, 'onError'> & std.Partial<std.Pick<semantic-ui-api.SemanticUI.ApiSettings._Impl, keyof semantic-ui-api.SemanticUI.ApiSettings._Impl>> */
trait PickImplonErrorPartialPic
  extends StObject
     with Param {
...
object PickImplonErrorPartialPic {
  ...
  extension [Self <: PickImplonErrorPartialPic](x: Self) {
