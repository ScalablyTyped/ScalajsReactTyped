...
import typingsJapgolly.signaturePad.AnonColor
import typingsJapgolly.signaturePad.AnonCurve
import typingsJapgolly.signaturePad.AnonEnd
import typingsJapgolly.signaturePad.AnonPoint
