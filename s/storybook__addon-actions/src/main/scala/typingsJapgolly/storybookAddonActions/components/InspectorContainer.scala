...
object InspectorContainer {
  
  @JSImport("@storybook/addon-actions/dist/ts3.9/components/ActionLogger/style", "InspectorContainer")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: InspectorContainer.type): SharedBuilder_DetailedHTMLPropsDistributiveOmit0679140864[HTMLDivElement] = new SharedBuilder_DetailedHTMLPropsDistributiveOmit0679140864[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
