...
import typingsJapgolly.storybookAddonActions.storybookAddonActionsStrings.`additions removals`
...
import typingsJapgolly.storybookAddonActions.storybookAddonActionsStrings.`removals additions`
import typingsJapgolly.storybookAddonActions.storybookAddonActionsStrings.`removals text`
import typingsJapgolly.storybookAddonActions.storybookAddonActionsStrings.`text additions`
import typingsJapgolly.storybookAddonActions.storybookAddonActionsStrings.`text removals`
...
object anon {
  ...
  trait Action extends StObject {
    ...
    def withActions(): Unit
  }
  object Action {
    
    inline def apply(action: Callback, actions: Callback, withActions: Callback): Action = {
      val __obj = js.Dynamic.literal(action = action.toJsFn, actions = actions.toJsFn, withActions = withActions.toJsFn)
    ...
    extension [Self <: Action](x: Self) {
      ...
      inline def setActions(value: Callback): Self = StObject.set(x, "actions", value.toJsFn)
      
      inline def setWithActions(value: Callback): Self = StObject.set(x, "withActions", value.toJsFn)
    }
  }
  ...
  object Args {
    ...
    inline def apply(args: js.Array[Any], name: String): Args = {
