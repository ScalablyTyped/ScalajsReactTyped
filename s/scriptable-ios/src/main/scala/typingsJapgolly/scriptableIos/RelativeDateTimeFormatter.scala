...
object RelativeDateTimeFormatter {
  ...
  inline def apply(
    ...
    useNamedDateTimeStyle: Callback,
    useNumericDateTimeStyle: Callback
  ): RelativeDateTimeFormatter = {
    val __obj = js.Dynamic.literal(locale = locale.asInstanceOf[js.Any], string = js.Any.fromFunction2(string), useNamedDateTimeStyle = useNamedDateTimeStyle.toJsFn, useNumericDateTimeStyle = useNumericDateTimeStyle.toJsFn)
  ...
  extension [Self <: RelativeDateTimeFormatter](x: Self) {
    ...
    inline def setUseNamedDateTimeStyle(value: Callback): Self = StObject.set(x, "useNamedDateTimeStyle", value.toJsFn)
    
    inline def setUseNumericDateTimeStyle(value: Callback): Self = StObject.set(x, "useNumericDateTimeStyle", value.toJsFn)
  }
}
