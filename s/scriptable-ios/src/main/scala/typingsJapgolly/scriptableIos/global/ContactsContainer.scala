...
open class ContactsContainer ()
  extends StObject
     with typingsJapgolly.scriptableIos.ContactsContainer {
...
object ContactsContainer {
  ...
  /**
    ...
    */
  /* static member */
  inline def default(): js.Promise[typingsJapgolly.scriptableIos.ContactsContainer] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")().asInstanceOf[js.Promise[typingsJapgolly.scriptableIos.ContactsContainer]]
  ...
  /**
    ...
    */
  /* static member */
  inline def all(): js.Promise[js.Array[typingsJapgolly.scriptableIos.ContactsContainer]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")().asInstanceOf[js.Promise[js.Array[typingsJapgolly.scriptableIos.ContactsContainer]]]
  ...
  /**
    ...
    */
  /* static member */
  inline def withIdentifier(identifier: String): js.Promise[typingsJapgolly.scriptableIos.ContactsContainer] = ^.asInstanceOf[js.Dynamic].applyDynamic("withIdentifier")(identifier.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.scriptableIos.ContactsContainer]]
}
