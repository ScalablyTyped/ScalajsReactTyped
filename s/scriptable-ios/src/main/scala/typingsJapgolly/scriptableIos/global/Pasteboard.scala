...
object Pasteboard {
  ...
  /**
    ...
    */
  inline def copyImage(image: typingsJapgolly.scriptableIos.Image): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("copyImage")(image.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def pasteImage(): typingsJapgolly.scriptableIos.Image = ^.asInstanceOf[js.Dynamic].applyDynamic("pasteImage")().asInstanceOf[typingsJapgolly.scriptableIos.Image]
