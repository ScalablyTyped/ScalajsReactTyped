...
object Device {
  ...
  /**
    ...
    */
  inline def batteryLevel(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("batteryLevel")().asInstanceOf[Double]
  
  /**
    * _Whether the device is being charged._
    * @see https://docs.scriptable.app/device/#ischarging
    */
  inline def isCharging(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isCharging")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isDischarging(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isDischarging")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isFaceDown(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFaceDown")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isFaceUp(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFaceUp")().asInstanceOf[Boolean]
  
  /**
    * _Whether the device is fully charged._
    * @see https://docs.scriptable.app/device/#isfullycharged
    */
  inline def isFullyCharged(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isFullyCharged")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isInLandscapeLeft(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInLandscapeLeft")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isInLandscapeRight(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInLandscapeRight")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isInPortrait(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInPortrait")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isInPortraitUpsideDown(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInPortraitUpsideDown")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isPad(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isPad")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def isUsingDarkAppearance(): Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isUsingDarkAppearance")().asInstanceOf[Boolean]
  ...
  /**
    ...
    */
  inline def model(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("model")().asInstanceOf[String]
  ...
  /**
    ...
    */
  inline def preferredLanguages(): js.Array[String] = ^.asInstanceOf[js.Dynamic].applyDynamic("preferredLanguages")().asInstanceOf[js.Array[String]]
  ...
  /**
    ...
    */
  inline def screenBrightness(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("screenBrightness")().asInstanceOf[Double]
  ...
  /**
    ...
    */
  inline def screenResolution(): typingsJapgolly.scriptableIos.Size = ^.asInstanceOf[js.Dynamic].applyDynamic("screenResolution")().asInstanceOf[typingsJapgolly.scriptableIos.Size]
  ...
  /**
    ...
    */
  inline def screenScale(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("screenScale")().asInstanceOf[Double]
  ...
  /**
    ...
    */
  inline def screenSize(): typingsJapgolly.scriptableIos.Size = ^.asInstanceOf[js.Dynamic].applyDynamic("screenSize")().asInstanceOf[typingsJapgolly.scriptableIos.Size]
  ...
  /**
    ...
    */
  inline def setScreenBrightness(percentage: Double): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("setScreenBrightness")(percentage.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  /**
    * _Name of the operating system:_
    * @see https://docs.scriptable.app/device/#systemname
    */
  inline def systemName(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("systemName")().asInstanceOf[String]
  
  /**
    * _Version of the operating system._
    * @see https://docs.scriptable.app/device/#systemversion
    */
  inline def systemVersion(): String = ^.asInstanceOf[js.Dynamic].applyDynamic("systemVersion")().asInstanceOf[String]
  ...
  /**
    ...
    */
  inline def volume(): Double = ^.asInstanceOf[js.Dynamic].applyDynamic("volume")().asInstanceOf[Double]
}
