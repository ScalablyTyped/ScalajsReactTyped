...
open class ContactsGroup ()
  extends StObject
     with typingsJapgolly.scriptableIos.ContactsGroup {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addMember(contact: typingsJapgolly.scriptableIos.Contact): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def removeMember(contact: typingsJapgolly.scriptableIos.Contact): Unit = js.native
}
object ContactsGroup {
  ...
  /**
    ...
    */
  /* static member */
  inline def add(group: typingsJapgolly.scriptableIos.ContactsGroup): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("add")(group.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def add(group: typingsJapgolly.scriptableIos.ContactsGroup, containerIdentifier: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(group.asInstanceOf[js.Any], containerIdentifier.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def all(containers: js.Array[typingsJapgolly.scriptableIos.ContactsContainer]): js.Promise[js.Array[typingsJapgolly.scriptableIos.ContactsGroup]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")(containers.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typingsJapgolly.scriptableIos.ContactsGroup]]]
  ...
  /**
    ...
    */
  /* static member */
  inline def delete(group: typingsJapgolly.scriptableIos.ContactsGroup): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("delete")(group.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def update(group: typingsJapgolly.scriptableIos.ContactsGroup): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("update")(group.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
