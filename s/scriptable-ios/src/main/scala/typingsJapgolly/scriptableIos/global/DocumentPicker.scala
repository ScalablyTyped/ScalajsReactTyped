...
object DocumentPicker {
  ...
  /**
    ...
    */
  inline def exportData(data: typingsJapgolly.scriptableIos.Data): js.Promise[js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("exportData")(data.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[String]]]
  inline def exportData(data: typingsJapgolly.scriptableIos.Data, name: String): js.Promise[js.Array[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("exportData")(data.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[String]]]
  ...
  /**
    ...
    */
  inline def exportImage(image: typingsJapgolly.scriptableIos.Image): js.Promise[js.Array[String]] = ^.asInstanceOf[js.Dynamic].applyDynamic("exportImage")(image.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[String]]]
  inline def exportImage(image: typingsJapgolly.scriptableIos.Image, name: String): js.Promise[js.Array[String]] = (^.asInstanceOf[js.Dynamic].applyDynamic("exportImage")(image.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.Array[String]]]
