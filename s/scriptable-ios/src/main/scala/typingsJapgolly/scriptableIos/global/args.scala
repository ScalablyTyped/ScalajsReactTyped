...
object args {
  ...
  @js.native
  def images: js.Array[typingsJapgolly.scriptableIos.Image] = js.native
  inline def images_=(x: js.Array[typingsJapgolly.scriptableIos.Image]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("images")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def notification: typingsJapgolly.scriptableIos.Notification = js.native
  inline def notification_=(x: typingsJapgolly.scriptableIos.Notification): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("notification")(x.asInstanceOf[js.Any])
