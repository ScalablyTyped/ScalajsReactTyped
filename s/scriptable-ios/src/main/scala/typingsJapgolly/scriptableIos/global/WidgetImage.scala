...
open class WidgetImage ()
  extends StObject
     with typingsJapgolly.scriptableIos.WidgetImage {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var borderColor: typingsJapgolly.scriptableIos.Color = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var image: typingsJapgolly.scriptableIos.Image = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var imageSize: typingsJapgolly.scriptableIos.Size = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var tintColor: typingsJapgolly.scriptableIos.Color = js.native
