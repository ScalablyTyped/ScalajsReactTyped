...
open class UITableCell ()
  extends StObject
     with typingsJapgolly.scriptableIos.UITableCell {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var subtitleColor: typingsJapgolly.scriptableIos.Color = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var subtitleFont: typingsJapgolly.scriptableIos.Font = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var titleColor: typingsJapgolly.scriptableIos.Color = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var titleFont: typingsJapgolly.scriptableIos.Font = js.native
...
object UITableCell {
  ...
  /**
    ...
    */
  /* static member */
  inline def button(title: String): typingsJapgolly.scriptableIos.UITableCell = ^.asInstanceOf[js.Dynamic].applyDynamic("button")(title.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.UITableCell]
  ...
  /**
    ...
    */
  /* static member */
  inline def image(image: typingsJapgolly.scriptableIos.Image): typingsJapgolly.scriptableIos.UITableCell = ^.asInstanceOf[js.Dynamic].applyDynamic("image")(image.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.UITableCell]
  ...
  /**
    ...
    */
  /* static member */
  inline def imageAtURL(url: String): typingsJapgolly.scriptableIos.UITableCell = ^.asInstanceOf[js.Dynamic].applyDynamic("imageAtURL")(url.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.UITableCell]
  ...
  /**
    ...
    */
  /* static member */
  inline def text(): typingsJapgolly.scriptableIos.UITableCell = ^.asInstanceOf[js.Dynamic].applyDynamic("text")().asInstanceOf[typingsJapgolly.scriptableIos.UITableCell]
  inline def text(title: String): typingsJapgolly.scriptableIos.UITableCell = ^.asInstanceOf[js.Dynamic].applyDynamic("text")(title.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.UITableCell]
  inline def text(title: String, subtitle: String): typingsJapgolly.scriptableIos.UITableCell = (^.asInstanceOf[js.Dynamic].applyDynamic("text")(title.asInstanceOf[js.Any], subtitle.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.scriptableIos.UITableCell]
  inline def text(title: Unit, subtitle: String): typingsJapgolly.scriptableIos.UITableCell = (^.asInstanceOf[js.Dynamic].applyDynamic("text")(title.asInstanceOf[js.Any], subtitle.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.scriptableIos.UITableCell]
}
