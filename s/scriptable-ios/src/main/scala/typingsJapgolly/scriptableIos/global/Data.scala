...
open class Data ()
  extends StObject
     with typingsJapgolly.scriptableIos.Data {
...
object Data {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromBase64String(base64String: String): typingsJapgolly.scriptableIos.Data = ^.asInstanceOf[js.Dynamic].applyDynamic("fromBase64String")(base64String.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.Data]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromFile(filePath: String): typingsJapgolly.scriptableIos.Data = ^.asInstanceOf[js.Dynamic].applyDynamic("fromFile")(filePath.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.Data]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromJPEG(image: typingsJapgolly.scriptableIos.Image): typingsJapgolly.scriptableIos.Data = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJPEG")(image.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.Data]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromPNG(image: typingsJapgolly.scriptableIos.Image): typingsJapgolly.scriptableIos.Data = ^.asInstanceOf[js.Dynamic].applyDynamic("fromPNG")(image.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.Data]
  ...
  /**
    ...
    */
  /* static member */
  inline def fromString(string: String): typingsJapgolly.scriptableIos.Data = ^.asInstanceOf[js.Dynamic].applyDynamic("fromString")(string.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.Data]
}
