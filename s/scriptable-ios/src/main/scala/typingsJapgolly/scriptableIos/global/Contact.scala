...
import typingsJapgolly.scriptableIos.Contact.EmailAddresses
import typingsJapgolly.scriptableIos.Contact.PhoneNumbers
import typingsJapgolly.scriptableIos.Contact.PostalAddresses
import typingsJapgolly.scriptableIos.Contact.SocialProfiles
...
open class Contact ()
  extends StObject
     with typingsJapgolly.scriptableIos.Contact {
...
object Contact {
  ...
  /**
    ...
    */
  /* static member */
  inline def add(contact: typingsJapgolly.scriptableIos.Contact): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("add")(contact.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def add(contact: typingsJapgolly.scriptableIos.Contact, containerIdentifier: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("add")(contact.asInstanceOf[js.Any], containerIdentifier.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def all(containers: js.Array[typingsJapgolly.scriptableIos.ContactsContainer]): js.Promise[js.Array[typingsJapgolly.scriptableIos.Contact]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")(containers.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typingsJapgolly.scriptableIos.Contact]]]
  ...
  /**
    ...
    */
  /* static member */
  inline def delete(contact: typingsJapgolly.scriptableIos.Contact): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("delete")(contact.asInstanceOf[js.Any]).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  /* static member */
  inline def inGroups(groups: js.Array[typingsJapgolly.scriptableIos.ContactsGroup]): js.Promise[js.Array[typingsJapgolly.scriptableIos.Contact]] = ^.asInstanceOf[js.Dynamic].applyDynamic("inGroups")(groups.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typingsJapgolly.scriptableIos.Contact]]]
  ...
  /**
    ...
    */
  /* static member */
  inline def update(contact: typingsJapgolly.scriptableIos.Contact): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("update")(contact.asInstanceOf[js.Any]).asInstanceOf[Unit]
}
