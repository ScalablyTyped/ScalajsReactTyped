...
open class WidgetDate ()
  extends StObject
     with typingsJapgolly.scriptableIos.WidgetDate {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var shadowColor: typingsJapgolly.scriptableIos.Color = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var shadowOffset: typingsJapgolly.scriptableIos.Point = js.native
