...
open class LinearGradient ()
  extends StObject
     with typingsJapgolly.scriptableIos.LinearGradient {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var colors: js.Array[typingsJapgolly.scriptableIos.Color] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var endPoint: typingsJapgolly.scriptableIos.Point = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var startPoint: typingsJapgolly.scriptableIos.Point = js.native
}
