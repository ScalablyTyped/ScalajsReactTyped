...
open class DateFormatter ()
  extends StObject
     with typingsJapgolly.scriptableIos.DateFormatter {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useFullDateStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useFullTimeStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useLongDateStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useLongTimeStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useMediumDateStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useMediumTimeStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useNoDateStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useNoTimeStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useShortDateStyle(): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def useShortTimeStyle(): Unit = js.native
}
