...
/* private */ open class SFSymbol ()
  extends StObject
     with typingsJapgolly.scriptableIos.SFSymbol {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def applyFont(font: typingsJapgolly.scriptableIos.Font): Unit = js.native
...
object SFSymbol {
  ...
  /**
    ...
    */
  /* static member */
  inline def named(symbolName: String): typingsJapgolly.scriptableIos.SFSymbol = ^.asInstanceOf[js.Dynamic].applyDynamic("named")(symbolName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.scriptableIos.SFSymbol]
}
