...
open class Message ()
  extends StObject
     with typingsJapgolly.scriptableIos.Message {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addDataAttachment(data: typingsJapgolly.scriptableIos.Data, uti: String, filename: String): Unit = js.native
