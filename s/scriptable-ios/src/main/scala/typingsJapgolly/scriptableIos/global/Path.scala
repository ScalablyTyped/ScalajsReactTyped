...
open class Path ()
  extends StObject
     with typingsJapgolly.scriptableIos.Path {
  ...
  override def addCurve(
    point: typingsJapgolly.scriptableIos.Point,
    control1: typingsJapgolly.scriptableIos.Point,
    control2: typingsJapgolly.scriptableIos.Point
  ): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addEllipse(rect: typingsJapgolly.scriptableIos.Rect): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addLine(point: typingsJapgolly.scriptableIos.Point): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addLines(points: js.Array[typingsJapgolly.scriptableIos.Point]): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addQuadCurve(point: typingsJapgolly.scriptableIos.Point, control: typingsJapgolly.scriptableIos.Point): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addRect(rect: typingsJapgolly.scriptableIos.Rect): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addRects(rects: js.Array[typingsJapgolly.scriptableIos.Rect]): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def addRoundedRect(rect: typingsJapgolly.scriptableIos.Rect, cornerWidth: Double, cornerHeight: Double): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def move(point: typingsJapgolly.scriptableIos.Point): Unit = js.native
}
