...
open class Timer ()
  extends StObject
     with typingsJapgolly.scriptableIos.Timer {
...
object Timer {
  ...
  /**
    ...
    */
  /* static member */
  inline def schedule(timeInterval: Double, repeats: Boolean, callback: js.Function0[Unit]): typingsJapgolly.scriptableIos.Timer = (^.asInstanceOf[js.Dynamic].applyDynamic("schedule")(timeInterval.asInstanceOf[js.Any], repeats.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.scriptableIos.Timer]
}
