...
open class TextField ()
  extends StObject
     with typingsJapgolly.scriptableIos.TextField {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var font: typingsJapgolly.scriptableIos.Font = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var textColor: typingsJapgolly.scriptableIos.Color = js.native
}
