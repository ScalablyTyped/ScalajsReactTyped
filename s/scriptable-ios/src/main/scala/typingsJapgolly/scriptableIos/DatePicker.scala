...
object DatePicker {
  ...
  inline def apply(
    ...
    pickCountdownDuration: CallbackTo[js.Promise[Double]],
    pickDate: CallbackTo[js.Promise[js.Date]],
    pickDateAndTime: CallbackTo[js.Promise[js.Date]],
    pickTime: CallbackTo[js.Promise[js.Date]]
  ): DatePicker = {
    val __obj = js.Dynamic.literal(countdownDuration = countdownDuration.asInstanceOf[js.Any], initialDate = initialDate.asInstanceOf[js.Any], maximumDate = maximumDate.asInstanceOf[js.Any], minimumDate = minimumDate.asInstanceOf[js.Any], minuteInterval = minuteInterval.asInstanceOf[js.Any], pickCountdownDuration = pickCountdownDuration.toJsFn, pickDate = pickDate.toJsFn, pickDateAndTime = pickDateAndTime.toJsFn, pickTime = pickTime.toJsFn)
  ...
  extension [Self <: DatePicker](x: Self) {
    ...
    inline def setPickCountdownDuration(value: CallbackTo[js.Promise[Double]]): Self = StObject.set(x, "pickCountdownDuration", value.toJsFn)
    
    inline def setPickDate(value: CallbackTo[js.Promise[js.Date]]): Self = StObject.set(x, "pickDate", value.toJsFn)
    
    inline def setPickDateAndTime(value: CallbackTo[js.Promise[js.Date]]): Self = StObject.set(x, "pickDateAndTime", value.toJsFn)
    
    inline def setPickTime(value: CallbackTo[js.Promise[js.Date]]): Self = StObject.set(x, "pickTime", value.toJsFn)
  }
}
