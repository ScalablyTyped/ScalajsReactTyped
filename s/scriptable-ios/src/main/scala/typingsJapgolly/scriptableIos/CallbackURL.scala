...
object CallbackURL {
  ...
  inline def apply[T /* <: String */](
    addParameter: (String, String) => Callback,
    ...
    val __obj = js.Dynamic.literal(addParameter = js.Any.fromFunction2((t0: String, t1: String) => (addParameter(t0, t1)).runNow()), getURL = getURL.toJsFn, open = open.toJsFn)
    __obj.asInstanceOf[CallbackURL[T]]
  }
  
  extension [Self <: CallbackURL[?], T /* <: String */](x: Self & CallbackURL[T]) {
    
    inline def setAddParameter(value: (String, String) => Callback): Self = StObject.set(x, "addParameter", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
