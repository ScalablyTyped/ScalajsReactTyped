...
object WidgetDate {
  ...
  inline def apply(
    applyDateStyle: Callback,
    applyOffsetStyle: Callback,
    applyRelativeStyle: Callback,
    applyTimeStyle: Callback,
    applyTimerStyle: Callback,
    ...
    val __obj = js.Dynamic.literal(applyDateStyle = applyDateStyle.toJsFn, applyOffsetStyle = applyOffsetStyle.toJsFn, applyRelativeStyle = applyRelativeStyle.toJsFn, applyTimeStyle = applyTimeStyle.toJsFn, applyTimerStyle = applyTimerStyle.toJsFn, centerAlignText = centerAlignText.toJsFn, date = date.asInstanceOf[js.Any], font = font.asInstanceOf[js.Any], leftAlignText = leftAlignText.toJsFn, lineLimit = lineLimit.asInstanceOf[js.Any], minimumScaleFactor = minimumScaleFactor.asInstanceOf[js.Any], rightAlignText = rightAlignText.toJsFn, shadowColor = shadowColor.asInstanceOf[js.Any], shadowOffset = shadowOffset.asInstanceOf[js.Any], shadowRadius = shadowRadius.asInstanceOf[js.Any], textColor = textColor.asInstanceOf[js.Any], textOpacity = textOpacity.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.asInstanceOf[WidgetDate]
  }
  
  extension [Self <: WidgetDate](x: Self) {
    
    inline def setApplyDateStyle(value: Callback): Self = StObject.set(x, "applyDateStyle", value.toJsFn)
    
    inline def setApplyOffsetStyle(value: Callback): Self = StObject.set(x, "applyOffsetStyle", value.toJsFn)
    
    inline def setApplyRelativeStyle(value: Callback): Self = StObject.set(x, "applyRelativeStyle", value.toJsFn)
    
    inline def setApplyTimeStyle(value: Callback): Self = StObject.set(x, "applyTimeStyle", value.toJsFn)
    
    inline def setApplyTimerStyle(value: Callback): Self = StObject.set(x, "applyTimerStyle", value.toJsFn)
