...
object ContactsGroup {
  ...
  inline def apply(
    addMember: Contact => Callback,
    identifier: String,
    name: String,
    removeMember: Contact => Callback
  ): ContactsGroup = {
    val __obj = js.Dynamic.literal(addMember = js.Any.fromFunction1((t0: Contact) => addMember(t0).runNow()), identifier = identifier.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], removeMember = js.Any.fromFunction1((t0: Contact) => removeMember(t0).runNow()))
    __obj.asInstanceOf[ContactsGroup]
  }
  
  extension [Self <: ContactsGroup](x: Self) {
    
    inline def setAddMember(value: Contact => Callback): Self = StObject.set(x, "addMember", js.Any.fromFunction1((t0: Contact) => value(t0).runNow()))
    
    inline def setIdentifier(value: String): Self = StObject.set(x, "identifier", value.asInstanceOf[js.Any])
    
    inline def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    
    inline def setRemoveMember(value: Contact => Callback): Self = StObject.set(x, "removeMember", js.Any.fromFunction1((t0: Contact) => value(t0).runNow()))
  }
}
