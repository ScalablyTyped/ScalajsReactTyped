...
object CalendarEvent {
  ...
  inline def apply(
    ...
    location: String,
    notes: String,
    presentEdit: CallbackTo[js.Promise[CalendarEvent]],
    remove: Callback,
  ...
  extension [Self <: CalendarEvent](x: Self) {
    ...
    inline def setPresentEdit(value: CallbackTo[js.Promise[CalendarEvent]]): Self = StObject.set(x, "presentEdit", value.toJsFn)
