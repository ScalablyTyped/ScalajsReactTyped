...
import typingsJapgolly.std.stdStrings.encrypted
import typingsJapgolly.std.stdStrings.msneedkey
import typingsJapgolly.std.stdStrings.waitingforkey
...
trait HTMLMediaElement extends HTMLElement {
  ...
  /** @deprecated */
  var onmsneedkey: (js.ThisFunction1[/* this */ this.type, /* ev */ org.scalajs.dom.raw.Event, _]) | Null = js.native
