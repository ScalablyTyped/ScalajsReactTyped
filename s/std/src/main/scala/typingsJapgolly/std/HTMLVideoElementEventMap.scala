...
trait HTMLVideoElementEventMap
  extends StObject
     with HTMLMediaElementEventMap {
  
  /* standard dom */
  var enterpictureinpicture: org.scalajs.dom.Event
  
  /* standard dom */
  var leavepictureinpicture: org.scalajs.dom.Event
}
object HTMLVideoElementEventMap {
  ...
  inline def apply(
    ...
    enterpictureinpicture: org.scalajs.dom.Event,
    ...
    leavepictureinpicture: org.scalajs.dom.Event,
