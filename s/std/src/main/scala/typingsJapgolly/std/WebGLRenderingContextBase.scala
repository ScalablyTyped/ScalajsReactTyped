...
import typingsJapgolly.std.stdStrings.EXT_color_buffer_float
import typingsJapgolly.std.stdStrings.EXT_color_buffer_half_float
import typingsJapgolly.std.stdStrings.EXT_float_blend
...
import typingsJapgolly.std.stdStrings.KHR_parallel_shader_compile
...
import typingsJapgolly.std.stdStrings.OVR_multiview2
...
import typingsJapgolly.std.stdStrings.WEBGL_compressed_texture_etc
import typingsJapgolly.std.stdStrings.WEBGL_compressed_texture_etc1
