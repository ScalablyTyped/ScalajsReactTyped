...
object XPathResult {
  ...
  inline def apply(
    ...
    iterateNext: CallbackTo[org.scalajs.dom.Node | Null],
    numberValue: Double,
    resultType: Double,
  ...
  extension [Self <: XPathResult](x: Self) {
    ...
    inline def setIterateNext(value: CallbackTo[org.scalajs.dom.Node | Null]): Self = StObject.set(x, "iterateNext", value.toJsFn)
