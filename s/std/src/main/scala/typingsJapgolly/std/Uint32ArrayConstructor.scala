...
Instantiable0[js.typedarray.Uint32Array]
     with Instantiable2[/* buffer */ ArrayBufferLike, /* byteOffset */ Double, js.typedarray.Uint32Array]
     with Instantiable3[
  ...
  def from(arrayLike: js.Iterable[Double]): js.typedarray.Uint32Array = js.native
  def from(arrayLike: js.Iterable[Double], mapfn: js.Function2[/* v */ Double, /* k */ Double, Double]): js.typedarray.Uint32Array = js.native
  def from(
    arrayLike: js.Iterable[Double],
    mapfn: js.Function2[/* v */ Double, /* k */ Double, Double],
    thisArg: Any
  ): js.typedarray.Uint32Array = js.native
  def from(arrayLike: js.Iterable[Double], mapfn: Unit, thisArg: Any): js.typedarray.Uint32Array = js.native
  /**
    * Creates an array from an array-like or iterable object.
    * @param arrayLike An array-like or iterable object to convert to an array.
    */
