...
trait JSON extends StObject {
  ...
  def stringify(value: Any, replacer: js.Array[Double | java.lang.String]): java.lang.String = js.native
  def stringify(value: Any, replacer: js.Array[Double | java.lang.String], space: java.lang.String): java.lang.String = js.native
  def stringify(value: Any, replacer: js.Array[Double | java.lang.String], space: Double): java.lang.String = js.native
  def stringify(
    value: Any,
