...
import typingsJapgolly.std.Intl.DisplayNamesFallback
import typingsJapgolly.std.Intl.DisplayNamesLanguageDisplay
import typingsJapgolly.std.Intl.DisplayNamesType
import typingsJapgolly.std.Intl.ES2018NumberFormatPartType
import typingsJapgolly.std.Intl.ES2020NumberFormatPartType
import typingsJapgolly.std.Intl.LDMLPluralRule
import typingsJapgolly.std.Intl.ListFormatLocaleMatcher
import typingsJapgolly.std.Intl.ListFormatStyle
import typingsJapgolly.std.Intl.ListFormatType
import typingsJapgolly.std.Intl.LocaleCollationCaseFirst
import typingsJapgolly.std.Intl.LocaleHourCycleKey
import typingsJapgolly.std.Intl.NumberFormatPartTypes
import typingsJapgolly.std.Intl.PluralRuleType
import typingsJapgolly.std.Intl.RelativeTimeFormatLocaleMatcher
...
import typingsJapgolly.std.WebAssembly.TableKind
...
object stdStrings {
  ...
  @js.native
  sealed trait Atomics extends StObject
  ...
  @js.native
  sealed trait BigInt64Array extends StObject
  ...
  inline def FinalizationRegistry: FinalizationRegistry = "FinalizationRegistry".asInstanceOf[FinalizationRegistry]
  ...
  @js.native
  sealed trait WeakRef extends StObject
  ...
  @js.native
  sealed trait `timed-out` extends StObject
