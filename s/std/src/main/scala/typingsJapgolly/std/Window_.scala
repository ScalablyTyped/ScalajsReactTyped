...
trait Window_
  ...
  def open(url: java.lang.String): Window_ | Null = js.native
  def open(url: java.lang.String, target: java.lang.String): Window_ | Null = js.native
  def open(url: java.lang.String, target: java.lang.String, features: java.lang.String): Window_ | Null = js.native
  def open(
    url: java.lang.String,
    target: java.lang.String,
    features: java.lang.String,
    replace: scala.Boolean
  ): Window_ | Null = js.native
...
@JSGlobal("Window")
@js.native
object Window_ extends Instantiable0[Window_]
