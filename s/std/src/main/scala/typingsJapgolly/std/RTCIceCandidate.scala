...
object RTCIceCandidate {
  ...
  inline def apply(candidate: java.lang.String, toJSON: CallbackTo[org.scalajs.dom.RTCIceCandidateInit]): RTCIceCandidate = {
    val __obj = js.Dynamic.literal(candidate = candidate.asInstanceOf[js.Any], toJSON = toJSON.toJsFn, address = null, component = null, foundation = null, port = null, priority = null, protocol = null, relatedAddress = null, relatedPort = null, sdpMLineIndex = null, sdpMid = null, tcpType = null, usernameFragment = null)
  ...
  extension [Self <: RTCIceCandidate](x: Self) {
    ...
    inline def setToJSON(value: CallbackTo[org.scalajs.dom.RTCIceCandidateInit]): Self = StObject.set(x, "toJSON", value.toJsFn)
