...
trait DocumentEventMap
  ...
  var pointerlockchange: Event_
  var pointerlockerror: Event_
  var readystatechange: Event_
  var visibilitychange: Event_
}
...
object DocumentEventMap {
  ...
  def apply(
    ...
    pointerlockchange: Event_,
    pointerlockerror: Event_,
