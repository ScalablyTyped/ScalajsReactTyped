...
import typingsJapgolly.std.StorageEstimate
...
open class StorageManager ()
  extends StObject
     with typingsJapgolly.std.StorageManager {
  ...
  /* standard dom */
  /* CompleteClass */
  override def getDirectory(): js.Promise[typingsJapgolly.std.FileSystemDirectoryHandle] = js.native
