...
import typingsJapgolly.std.AuthenticationExtensionsClientOutputs
...
open class PublicKeyCredential ()
  extends StObject
     with typingsJapgolly.std.PublicKeyCredential {
  ...
  /* standard dom */
  /* CompleteClass */
  override val response: typingsJapgolly.std.AuthenticatorResponse = js.native
