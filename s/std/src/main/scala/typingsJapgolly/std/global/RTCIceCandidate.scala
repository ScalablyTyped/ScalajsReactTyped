...
import typingsJapgolly.std.RTCIceCandidateType
import typingsJapgolly.std.RTCIceComponent
import typingsJapgolly.std.RTCIceProtocol
import typingsJapgolly.std.RTCIceTcpCandidateType
...
open class RTCIceCandidate ()
  extends StObject
     with typingsJapgolly.std.RTCIceCandidate {
