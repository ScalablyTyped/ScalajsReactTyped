...
import typingsJapgolly.std.RTCEncodedVideoFrameMetadata
import typingsJapgolly.std.RTCEncodedVideoFrameType
...
open class RTCEncodedVideoFrame ()
  extends StObject
     with typingsJapgolly.std.RTCEncodedVideoFrame {
