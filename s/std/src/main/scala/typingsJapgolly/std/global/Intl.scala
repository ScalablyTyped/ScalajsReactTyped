...
import typingsJapgolly.std.Intl.BCP47LanguageTag
...
import typingsJapgolly.std.Intl.DisplayNames
import typingsJapgolly.std.Intl.DisplayNamesOptions
import typingsJapgolly.std.Intl.LDMLPluralRule
import typingsJapgolly.std.Intl.ListFormat
import typingsJapgolly.std.Intl.ListFormatOptions
import typingsJapgolly.std.Intl.Locale
import typingsJapgolly.std.Intl.LocaleOptions
...
import typingsJapgolly.std.Intl.RelativeTimeFormatUnit
import typingsJapgolly.std.Intl.ResolvedCollatorOptions
import typingsJapgolly.std.Intl.ResolvedDisplayNamesOptions
import typingsJapgolly.std.Intl.ResolvedPluralRulesOptions
import typingsJapgolly.std.Intl.ResolvedRelativeTimeFormatOptions
import typingsJapgolly.std.Intl.ResolvedSegmenterOptions
import typingsJapgolly.std.Intl.Segmenter
import typingsJapgolly.std.Intl.SegmenterOptions
import typingsJapgolly.std.Intl.Segments
...
import typingsJapgolly.std.anon.`1`
import typingsJapgolly.std.stdStrings.localeMatcher
...
object Intl {
  ...
  object Collator {
    ...
    /* standard es5 */
    inline def apply(): typingsJapgolly.std.Intl.Collator = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.std.Intl.Collator]
    inline def apply(locales: java.lang.String): typingsJapgolly.std.Intl.Collator = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.Intl.Collator]
    inline def apply(locales: java.lang.String, options: CollatorOptions): typingsJapgolly.std.Intl.Collator = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.Collator]
    inline def apply(locales: js.Array[java.lang.String]): typingsJapgolly.std.Intl.Collator = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.Intl.Collator]
    inline def apply(locales: js.Array[java.lang.String], options: CollatorOptions): typingsJapgolly.std.Intl.Collator = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.Collator]
    inline def apply(locales: Unit, options: CollatorOptions): typingsJapgolly.std.Intl.Collator = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.Collator]
  ...
  object DateTimeFormat {
    ...
    /* standard es5 */
    inline def apply(): typingsJapgolly.std.Intl.DateTimeFormat = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.std.Intl.DateTimeFormat]
    inline def apply(locales: java.lang.String): typingsJapgolly.std.Intl.DateTimeFormat = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.Intl.DateTimeFormat]
    inline def apply(locales: java.lang.String, options: DateTimeFormatOptions): typingsJapgolly.std.Intl.DateTimeFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.DateTimeFormat]
    inline def apply(locales: js.Array[java.lang.String]): typingsJapgolly.std.Intl.DateTimeFormat = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.Intl.DateTimeFormat]
    inline def apply(locales: js.Array[java.lang.String], options: DateTimeFormatOptions): typingsJapgolly.std.Intl.DateTimeFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.DateTimeFormat]
    inline def apply(locales: Unit, options: DateTimeFormatOptions): typingsJapgolly.std.Intl.DateTimeFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.DateTimeFormat]
  ...
  object NumberFormat {
    ...
    /* standard es5 */
    inline def apply(): typingsJapgolly.std.Intl.NumberFormat = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.std.Intl.NumberFormat]
    inline def apply(locales: java.lang.String): typingsJapgolly.std.Intl.NumberFormat = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.Intl.NumberFormat]
    inline def apply(locales: java.lang.String, options: NumberFormatOptions): typingsJapgolly.std.Intl.NumberFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.NumberFormat]
    inline def apply(locales: js.Array[java.lang.String]): typingsJapgolly.std.Intl.NumberFormat = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.Intl.NumberFormat]
    inline def apply(locales: js.Array[java.lang.String], options: NumberFormatOptions): typingsJapgolly.std.Intl.NumberFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.NumberFormat]
    inline def apply(locales: Unit, options: NumberFormatOptions): typingsJapgolly.std.Intl.NumberFormat = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.NumberFormat]
  ...
  object PluralRules {
    ...
    inline def apply(): typingsJapgolly.std.Intl.PluralRules = ^.asInstanceOf[js.Dynamic].apply().asInstanceOf[typingsJapgolly.std.Intl.PluralRules]
    inline def apply(locales: java.lang.String): typingsJapgolly.std.Intl.PluralRules = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.Intl.PluralRules]
    inline def apply(locales: java.lang.String, options: PluralRulesOptions): typingsJapgolly.std.Intl.PluralRules = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.PluralRules]
    inline def apply(locales: js.Array[java.lang.String]): typingsJapgolly.std.Intl.PluralRules = ^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.Intl.PluralRules]
    inline def apply(locales: js.Array[java.lang.String], options: PluralRulesOptions): typingsJapgolly.std.Intl.PluralRules = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.PluralRules]
    inline def apply(locales: Unit, options: PluralRulesOptions): typingsJapgolly.std.Intl.PluralRules = (^.asInstanceOf[js.Dynamic].apply(locales.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.std.Intl.PluralRules]
