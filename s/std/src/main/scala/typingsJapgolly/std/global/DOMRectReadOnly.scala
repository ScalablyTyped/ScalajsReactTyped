...
open class DOMRectReadOnly ()
  extends StObject
     with typingsJapgolly.std.DOMRectReadOnly {
...
object DOMRectReadOnly {
  ...
  /* standard dom */
  inline def fromRect(): typingsJapgolly.std.DOMRectReadOnly = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRect")().asInstanceOf[typingsJapgolly.std.DOMRectReadOnly]
  inline def fromRect(other: DOMRectInit): typingsJapgolly.std.DOMRectReadOnly = ^.asInstanceOf[js.Dynamic].applyDynamic("fromRect")(other.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.std.DOMRectReadOnly]
}
