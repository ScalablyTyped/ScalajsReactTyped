...
import typingsJapgolly.seleniumStandalone.anon.Dictx
import typingsJapgolly.seleniumStandalone.seleniumStandaloneStrings.ia32
import typingsJapgolly.seleniumStandalone.seleniumStandaloneStrings.x64
...
object mod {
  ...
  inline def start(): js.Promise[typingsJapgolly.node.childProcessMod.ChildProcess] = ^.asInstanceOf[js.Dynamic].applyDynamic("start")().asInstanceOf[js.Promise[typingsJapgolly.node.childProcessMod.ChildProcess]]
  inline def start(opts: StartOpts): js.Promise[typingsJapgolly.node.childProcessMod.ChildProcess] = ^.asInstanceOf[js.Dynamic].applyDynamic("start")(opts.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.node.childProcessMod.ChildProcess]]
  ...
  object InstallOpts {
    ...
    extension [Self <: InstallOpts](x: Self) {
      ...
      inline def setLogger(value: /* message */ String => Callback): Self = StObject.set(x, "logger", js.Any.fromFunction1((t0: /* message */ String) => value(t0).runNow()))
      
      inline def setLoggerUndefined: Self = StObject.set(x, "logger", js.undefined)
      
      inline def setProgressCb(
        value: (/* totalLength */ Double, /* progressLength */ Double, /* chunkLength */ Double) => Callback
      ): Self = StObject.set(x, "progressCb", js.Any.fromFunction3((t0: /* totalLength */ Double, t1: /* progressLength */ Double, t2: /* chunkLength */ Double) => (value(t0, t1, t2)).runNow()))
