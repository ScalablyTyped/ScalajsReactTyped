...
import typingsJapgolly.semanticRelease.semanticReleaseStrings.major
import typingsJapgolly.semanticRelease.semanticReleaseStrings.minor
import typingsJapgolly.semanticRelease.semanticReleaseStrings.patch
