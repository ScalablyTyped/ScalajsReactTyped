...
import typingsJapgolly.semanticRelease.anon.Await
import typingsJapgolly.semanticRelease.anon.Email
import typingsJapgolly.semanticRelease.anon.Long
import typingsJapgolly.semanticRelease.semanticReleaseBooleans.`false`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.semanticRelease.semanticReleaseStrings.prerelease
    - typingsJapgolly.semanticRelease.semanticReleaseStrings.prepatch
    - typingsJapgolly.semanticRelease.semanticReleaseStrings.patch
    - typingsJapgolly.semanticRelease.semanticReleaseStrings.preminor
    - typingsJapgolly.semanticRelease.semanticReleaseStrings.minor
    - typingsJapgolly.semanticRelease.semanticReleaseStrings.premajor
    - typingsJapgolly.semanticRelease.semanticReleaseStrings.major
  */
  trait ReleaseType extends StObject
  object ReleaseType {
    
    inline def major: typingsJapgolly.semanticRelease.semanticReleaseStrings.major = "major".asInstanceOf[typingsJapgolly.semanticRelease.semanticReleaseStrings.major]
    
    inline def minor: typingsJapgolly.semanticRelease.semanticReleaseStrings.minor = "minor".asInstanceOf[typingsJapgolly.semanticRelease.semanticReleaseStrings.minor]
    
    inline def patch: typingsJapgolly.semanticRelease.semanticReleaseStrings.patch = "patch".asInstanceOf[typingsJapgolly.semanticRelease.semanticReleaseStrings.patch]
    
    inline def premajor: typingsJapgolly.semanticRelease.semanticReleaseStrings.premajor = "premajor".asInstanceOf[typingsJapgolly.semanticRelease.semanticReleaseStrings.premajor]
    
    inline def preminor: typingsJapgolly.semanticRelease.semanticReleaseStrings.preminor = "preminor".asInstanceOf[typingsJapgolly.semanticRelease.semanticReleaseStrings.preminor]
    
    inline def prepatch: typingsJapgolly.semanticRelease.semanticReleaseStrings.prepatch = "prepatch".asInstanceOf[typingsJapgolly.semanticRelease.semanticReleaseStrings.prepatch]
    
    inline def prerelease: typingsJapgolly.semanticRelease.semanticReleaseStrings.prerelease = "prerelease".asInstanceOf[typingsJapgolly.semanticRelease.semanticReleaseStrings.prerelease]
  }
  ...
  /**
    ...
    */
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.semanticRelease.semanticReleaseBooleans.`false`
    - typingsJapgolly.semanticRelease.anon.Commits
  */
