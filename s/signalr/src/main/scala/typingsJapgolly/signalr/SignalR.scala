...
import typingsJapgolly.signalr.anon.Name
import typingsJapgolly.signalr.signalrInts.`0`
import typingsJapgolly.signalr.signalrInts.`1`
import typingsJapgolly.signalr.signalrInts.`2`
import typingsJapgolly.signalr.signalrInts.`4`
...
trait SignalR extends StObject {
  ...
  def hubConnection(url: Unit, options: Options): typingsJapgolly.signalr.SignalR.Hub.Connection = js.native
...
object SignalR {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.signalr.signalrInts.`0`
    - typingsJapgolly.signalr.signalrInts.`1`
    - typingsJapgolly.signalr.signalrInts.`2`
    - typingsJapgolly.signalr.signalrInts.`4`
  */
  ...
  object Hub {
    ...
    trait Connection
      extends StObject
         with typingsJapgolly.signalr.SignalR.Connection {
    ...
    object IHub {
      ...
      inline def apply(start: Callback): IHub = {
    ...
    trait Proxy extends StObject {
      ...
      var connection: typingsJapgolly.signalr.SignalR.Hub.Connection = js.native
      
      def hasSubscriptions(): Boolean = js.native
      
      var hubName: String = js.native
      
      def init(connection: typingsJapgolly.signalr.SignalR.Hub.Connection, hubName: String): Unit = js.native
  ...
  object Transport {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(abort = js.Any.fromFunction2((t0: Connection, t1: Boolean) => (abort(t0, t1)).runNow()), lostConnection = js.Any.fromFunction1((t0: Connection) => lostConnection(t0).runNow()), name = name.asInstanceOf[js.Any], reconnect = js.Any.fromFunction1((t0: Connection) => reconnect(t0).runNow()), send = js.Any.fromFunction2((t0: Connection, t1: Any) => (send(t0, t1)).runNow()), start = js.Any.fromFunction3((t0: Connection, t1: js.Function0[Unit], t2: js.Function1[/* error */ js.UndefOr[ConnectionError], Unit]) => (start(t0, t1, t2)).runNow()), stop = js.Any.fromFunction1((t0: Connection) => stop(t0).runNow()), supportsKeepAlive = supportsKeepAlive.toJsFn)
      __obj.asInstanceOf[Transport]
    }
    
    extension [Self <: Transport](x: Self) {
      
      inline def setAbort(value: (Connection, Boolean) => Callback): Self = StObject.set(x, "abort", js.Any.fromFunction2((t0: Connection, t1: Boolean) => (value(t0, t1)).runNow()))
      
      inline def setLostConnection(value: Connection => Callback): Self = StObject.set(x, "lostConnection", js.Any.fromFunction1((t0: Connection) => value(t0).runNow()))
      
      inline def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
      
      inline def setReconnect(value: Connection => Callback): Self = StObject.set(x, "reconnect", js.Any.fromFunction1((t0: Connection) => value(t0).runNow()))
      
      inline def setSend(value: (Connection, Any) => Callback): Self = StObject.set(x, "send", js.Any.fromFunction2((t0: Connection, t1: Any) => (value(t0, t1)).runNow()))
      
      inline def setStart(
        value: (Connection, js.Function0[Unit], js.Function1[/* error */ js.UndefOr[ConnectionError], Unit]) => Callback
      ): Self = StObject.set(x, "start", js.Any.fromFunction3((t0: Connection, t1: js.Function0[Unit], t2: js.Function1[/* error */ js.UndefOr[ConnectionError], Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setStop(value: Connection => Callback): Self = StObject.set(x, "stop", js.Any.fromFunction1((t0: Connection) => value(t0).runNow()))
