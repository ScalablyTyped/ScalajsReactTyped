package typingsJapgolly.stompjs

import japgolly.scalajs.react.Callback
import org.scalajs.dom.WebSocket
import typingsJapgolly.node.timersMod.global.NodeJS.Timer
import typingsJapgolly.stompjs.anon.Host
import typingsJapgolly.stompjs.anon.Incoming
...
object mod {
  ...
  object Subscription {
    ...
    inline def apply(id: String, unsubscribe: Callback): Subscription = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], unsubscribe = unsubscribe.toJsFn)
