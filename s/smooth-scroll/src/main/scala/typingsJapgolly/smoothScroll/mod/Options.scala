package typingsJapgolly.smoothScroll.mod
...
object Options {
  ...
  def apply(
    ...
    customEasing: /* time */ Double => CallbackTo[Double] = null,
    ...
    if (customEasing != null) __obj.updateDynamic("customEasing")(js.Any.fromFunction1((t0: /* time */ scala.Double) => customEasing(t0).runNow()))
