...
/* Inlined std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, 'silent'> & std.Partial<std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, keyof semantic-ui-sticky.SemanticUI.StickySettings._Impl>> */
