...
/* Inlined std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, 'setSize'> & std.Partial<std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, keyof semantic-ui-sticky.SemanticUI.StickySettings._Impl>> */
trait PickImplsetSizePartialPic
  extends StObject
     with Param {
...
object PickImplsetSizePartialPic {
  ...
  extension [Self <: PickImplsetSizePartialPic](x: Self) {
