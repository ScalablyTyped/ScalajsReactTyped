...
import typingsJapgolly.semanticUiSticky.SemanticUI.StickySettings.Param
import typingsJapgolly.semanticUiSticky.semanticUiStickyBooleans.`false`
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, 'onBottom'> & std.Partial<std.Pick<semantic-ui-sticky.SemanticUI.StickySettings._Impl, keyof semantic-ui-sticky.SemanticUI.StickySettings._Impl>> */
trait PickImplonBottomPartialPi
  extends StObject
     with Param {
...
object PickImplonBottomPartialPi {
  ...
  extension [Self <: PickImplonBottomPartialPi](x: Self) {
