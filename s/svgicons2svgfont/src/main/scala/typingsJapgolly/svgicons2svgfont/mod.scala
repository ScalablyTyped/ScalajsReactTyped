package typingsJapgolly.svgicons2svgfont
...
object mod {
  ...
  object SvgIcons2FontOptions {
    ...
    extension [Self <: SvgIcons2FontOptions](x: Self) {
      ...
      inline def setLog(value: /* message */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "log", js.Any.fromFunction1((t0: /* message */ js.UndefOr[Any]) => value(t0).runNow()))
      ...
      inline def setMetadataProvider(
        value: (/* file */ String, /* cb */ js.Function2[/* err */ Any, /* metadata */ Metadata, Unit]) => Callback
      ): Self = StObject.set(x, "metadataProvider", js.Any.fromFunction2((t0: /* file */ String, t1: /* cb */ js.Function2[/* err */ Any, /* metadata */ Metadata, Unit]) => (value(t0, t1)).runNow()))
