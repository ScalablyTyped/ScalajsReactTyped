...
object distLibErrorsFailedToLoadPolicyErrorMod {
  
  @JSImport("snyk/dist/lib/errors/failed-to-load-policy-error", "FailedToLoadPolicyError")
  @js.native
  open class FailedToLoadPolicyError () extends CustomError
  /* static members */
  object FailedToLoadPolicyError {
    ...
    @JSImport("snyk/dist/lib/errors/failed-to-load-policy-error", "FailedToLoadPolicyError.ERROR_CODE")
    @js.native
    ...
    @JSImport("snyk/dist/lib/errors/failed-to-load-policy-error", "FailedToLoadPolicyError.ERROR_MESSAGE")
    @js.native
    ...
    @JSImport("snyk/dist/lib/errors/failed-to-load-policy-error", "FailedToLoadPolicyError.ERROR_STRING_CODE")
    @js.native
