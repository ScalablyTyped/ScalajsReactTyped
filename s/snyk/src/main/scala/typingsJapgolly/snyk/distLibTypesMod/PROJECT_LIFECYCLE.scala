...
object PROJECT_LIFECYCLE extends StObject {
  ...
  /* "development" */ val DEVELOPMENT: typingsJapgolly.snyk.distLibTypesMod.PROJECT_LIFECYCLE.DEVELOPMENT & String = js.native
  
  @js.native
  sealed trait PRODUCTION
    extends StObject
       with PROJECT_LIFECYCLE
  /* "production" */ val PRODUCTION: typingsJapgolly.snyk.distLibTypesMod.PROJECT_LIFECYCLE.PRODUCTION & String = js.native
  
  @js.native
  sealed trait SANDBOX
    extends StObject
       with PROJECT_LIFECYCLE
  /* "sandbox" */ val SANDBOX: typingsJapgolly.snyk.distLibTypesMod.PROJECT_LIFECYCLE.SANDBOX & String = js.native
}
