...
import typingsJapgolly.snyk.distLibEcosystemsTypesMod.DepsFilePaths
import typingsJapgolly.snyk.distLibEcosystemsTypesMod.FileSignaturesDetails
...
trait TestDependenciesResult extends StObject {
  ...
  var docker: js.UndefOr[typingsJapgolly.snyk.anon.BaseImageRemediation] = js.undefined
...
object TestDependenciesResult {
  ...
  extension [Self <: TestDependenciesResult](x: Self) {
    ...
    inline def setDocker(value: typingsJapgolly.snyk.anon.BaseImageRemediation): Self = StObject.set(x, "docker", value.asInstanceOf[js.Any])
