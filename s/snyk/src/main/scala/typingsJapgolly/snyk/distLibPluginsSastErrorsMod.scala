...
object distLibPluginsSastErrorsMod {
  ...
  open class FeatureNotSupportedBySnykCodeError protected ()
    extends typingsJapgolly.snyk.distLibPluginsSastErrorsUnsupportedFeatureSnykCodeErrorMod.FeatureNotSupportedBySnykCodeError {
  ...
  open class MissingConfigurationError protected ()
    extends typingsJapgolly.snyk.distLibPluginsSastErrorsMissingConfigurationErrorMod.MissingConfigurationError {
