...
object distLibAlertsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.snyk.snykStrings.info
    - typingsJapgolly.snyk.snykStrings.warning
    - typingsJapgolly.snyk.snykStrings.error_
  */
  ...
  object AlertType {
    ...
    inline def info: typingsJapgolly.snyk.snykStrings.info = "info".asInstanceOf[typingsJapgolly.snyk.snykStrings.info]
    
    inline def warning: typingsJapgolly.snyk.snykStrings.warning = "warning".asInstanceOf[typingsJapgolly.snyk.snykStrings.warning]
  }
}
