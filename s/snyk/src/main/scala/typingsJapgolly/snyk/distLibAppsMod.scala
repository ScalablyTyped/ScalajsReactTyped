...
object distLibAppsMod {
  ...
  object EAppsURL extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.snyk.distLibAppsConstantsMod.EAppsURL & Double] = js.native
  ...
  object EValidSubCommands extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.snyk.distLibAppsConstantsMod.EValidSubCommands & String] = js.native
