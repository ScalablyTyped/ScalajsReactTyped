...
import typingsJapgolly.snyk.anon.Impact
import typingsJapgolly.snyk.anon.PartialRecordterraformclo
import typingsJapgolly.snyk.anon.ProjectType
import typingsJapgolly.snyk.distLibSnykTestLegacyMod.BasicResultData
...
object distLibSnykTestIacTestResultMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.snyk.snykStrings.cloudConfigPath
    - typingsJapgolly.snyk.snykStrings.name
    - typingsJapgolly.snyk.snykStrings.from
  */
  trait FILTERED_OUT_FIELDS extends StObject
  object FILTERED_OUT_FIELDS {
    
    inline def cloudConfigPath: typingsJapgolly.snyk.snykStrings.cloudConfigPath = "cloudConfigPath".asInstanceOf[typingsJapgolly.snyk.snykStrings.cloudConfigPath]
    
    inline def from: typingsJapgolly.snyk.snykStrings.from = "from".asInstanceOf[typingsJapgolly.snyk.snykStrings.from]
    
    inline def name: typingsJapgolly.snyk.snykStrings.name = "name".asInstanceOf[typingsJapgolly.snyk.snykStrings.name]
  }
