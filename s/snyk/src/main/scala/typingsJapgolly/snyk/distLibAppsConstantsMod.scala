...
import typingsJapgolly.snyk.anon.Message
...
object distLibAppsConstantsMod {
  ...
  object EAppsURL extends StObject {
    ...
    sealed trait CREATE_APP
      extends StObject
         with EAppsURL
    /* 0 */ val CREATE_APP: typingsJapgolly.snyk.distLibAppsConstantsMod.EAppsURL.CREATE_APP & Double = js.native
  }
  ...
  object EValidSubCommands extends StObject {
    ...
    /* "create" */ val CREATE: typingsJapgolly.snyk.distLibAppsConstantsMod.EValidSubCommands.CREATE & String = js.native
  }
