...
object distLibMetricsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.snyk.snykStrings.timer
    - typingsJapgolly.snyk.snykStrings.synthetic
  */
  trait MetricType extends StObject
  object MetricType {
    
    inline def synthetic: typingsJapgolly.snyk.snykStrings.synthetic = "synthetic".asInstanceOf[typingsJapgolly.snyk.snykStrings.synthetic]
    
    inline def timer: typingsJapgolly.snyk.snykStrings.timer = "timer".asInstanceOf[typingsJapgolly.snyk.snykStrings.timer]
  }
