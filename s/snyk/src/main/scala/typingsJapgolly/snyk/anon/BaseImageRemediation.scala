...
import typingsJapgolly.snyk.distLibSnykTestLegacyMod.TestDepGraphResult
...
trait BaseImageRemediation extends StObject {
  ...
  var baseImageRemediation: typingsJapgolly.snyk.distLibSnykTestLegacyMod.BaseImageRemediation
...
object BaseImageRemediation {
  ...
  inline def apply(
    baseImage: String,
    baseImageRemediation: typingsJapgolly.snyk.distLibSnykTestLegacyMod.BaseImageRemediation,
