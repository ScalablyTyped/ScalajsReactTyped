...
object TerraformPlanScanMode extends StObject {
  ...
  /* "resource-changes" */ val DeltaScan: typingsJapgolly.snyk.distCliCommandsTestIacLocalExecutionTypesMod.TerraformPlanScanMode.DeltaScan & String = js.native
  
  @js.native
  sealed trait FullScan
    extends StObject
       with TerraformPlanScanMode
  /* "planned-values" */ val FullScan: typingsJapgolly.snyk.distCliCommandsTestIacLocalExecutionTypesMod.TerraformPlanScanMode.FullScan & String = js.native
}
