...
import typingsJapgolly.storefrontUiVue.storefrontUiVueStrings.`Add to wishlist`
import typingsJapgolly.storefrontUiVue.storefrontUiVueStrings.`Remove from wishlist`
import typingsJapgolly.storefrontUiVue.storefrontUiVueStrings.`sf-button--pure sf-product-card__wishlist-icon`
...
object SfProductCard extends Shortcut {
  ...
  object Methods {
    ...
    inline def apply(onAddToCart: Event => Callback, toggleIsOnWishlist: Callback): Methods = {
      val __obj = js.Dynamic.literal(onAddToCart = js.Any.fromFunction1((t0: Event) => onAddToCart(t0).runNow()), toggleIsOnWishlist = toggleIsOnWishlist.toJsFn)
      __obj.asInstanceOf[Methods]
    }
    
    extension [Self <: Methods](x: Self) {
      
      inline def setOnAddToCart(value: Event => Callback): Self = StObject.set(x, "onAddToCart", js.Any.fromFunction1((t0: Event) => value(t0).runNow()))
      
      inline def setToggleIsOnWishlist(value: Callback): Self = StObject.set(x, "toggleIsOnWishlist", value.toJsFn)
    }
  }
