...
import typingsJapgolly.storefrontUiVue.storefrontUiVueStrings.`sf-button`
import typingsJapgolly.storefrontUiVue.storefrontUiVueStrings.`sf-link`
...
object SfPagination extends Shortcut {
  ...
  object Methods {
    ...
    inline def apply(getLinkTo: Any => Callback, go: Any => Callback): Methods = {
      val __obj = js.Dynamic.literal(getLinkTo = js.Any.fromFunction1((t0: Any) => getLinkTo(t0).runNow()), go = js.Any.fromFunction1((t0: Any) => go(t0).runNow()))
      __obj.asInstanceOf[Methods]
    }
    
    extension [Self <: Methods](x: Self) {
      
      inline def setGetLinkTo(value: Any => Callback): Self = StObject.set(x, "getLinkTo", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def setGo(value: Any => Callback): Self = StObject.set(x, "go", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
    }
  }
