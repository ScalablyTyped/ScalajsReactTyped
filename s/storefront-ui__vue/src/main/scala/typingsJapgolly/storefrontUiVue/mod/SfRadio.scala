...
object SfRadio extends Shortcut {
  
  @JSImport("@storefront-ui/vue", "SfRadio")
  @js.native
  ...
  object Methods {
    ...
    inline def apply(inputHandler: Callback): Methods = {
      val __obj = js.Dynamic.literal(inputHandler = inputHandler.toJsFn)
      __obj.asInstanceOf[Methods]
    }
    
    extension [Self <: Methods](x: Self) {
      
      inline def setInputHandler(value: Callback): Self = StObject.set(x, "inputHandler", value.toJsFn)
    }
  }
  ...
  object Props {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(description = description.asInstanceOf[js.Any], details = details.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], required = required.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `SfRadio.foo` */
