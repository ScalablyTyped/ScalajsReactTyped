...
import typingsJapgolly.storefrontUiVue.anon.Imageheight
...
object SfImage extends Shortcut {
  ...
  object Constructor {
    ...
    inline def apply(computed: Computed, data: CallbackTo[Data], props: Props): Constructor = {
      val __obj = js.Dynamic.literal(computed = computed.asInstanceOf[js.Any], data = data.toJsFn, props = props.asInstanceOf[js.Any])
