...
object SfMegaMenu extends Shortcut {
  ...
  object Methods {
    ...
    inline def apply(change: Any => Callback, updateItems: String => Callback): Methods = {
      val __obj = js.Dynamic.literal(change = js.Any.fromFunction1((t0: Any) => change(t0).runNow()), updateItems = js.Any.fromFunction1((t0: String) => updateItems(t0).runNow()))
    ...
    extension [Self <: Methods](x: Self) {
      ...
      inline def setUpdateItems(value: String => Callback): Self = StObject.set(x, "updateItems", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    }
  }
