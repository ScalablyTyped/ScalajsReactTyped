...
object SfContentPages extends Shortcut {
  ...
  object Methods {
    ...
    inline def apply(updatePage: String => Callback): Methods = {
      val __obj = js.Dynamic.literal(updatePage = js.Any.fromFunction1((t0: String) => updatePage(t0).runNow()))
      __obj.asInstanceOf[Methods]
    }
    
    extension [Self <: Methods](x: Self) {
      
      inline def setUpdatePage(value: String => Callback): Self = StObject.set(x, "updatePage", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    }
  }
