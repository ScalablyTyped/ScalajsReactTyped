...
object SfGroupedProduct extends Shortcut {
  ...
  object Methods {
    ...
    inline def apply(glideMount: Callback): Methods = {
      val __obj = js.Dynamic.literal(glideMount = glideMount.toJsFn)
      __obj.asInstanceOf[Methods]
    }
    
    extension [Self <: Methods](x: Self) {
      
      inline def setGlideMount(value: Callback): Self = StObject.set(x, "glideMount", value.toJsFn)
    }
  }
