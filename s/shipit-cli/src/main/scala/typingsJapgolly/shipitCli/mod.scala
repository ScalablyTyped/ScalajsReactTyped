...
import typingsJapgolly.shipitCli.anon.Typeofshipit
...
object mod {
  ...
  object Task_ {
    ...
    inline def apply(blocking: Boolean, dep: js.Array[String], fn: Callback, name: String): Task_ = {
      val __obj = js.Dynamic.literal(blocking = blocking.asInstanceOf[js.Any], dep = dep.asInstanceOf[js.Any], fn = fn.toJsFn, name = name.asInstanceOf[js.Any])
    ...
    extension [Self <: Task_](x: Self) {
      ...
      inline def setFn(value: Callback): Self = StObject.set(x, "fn", value.toJsFn)
