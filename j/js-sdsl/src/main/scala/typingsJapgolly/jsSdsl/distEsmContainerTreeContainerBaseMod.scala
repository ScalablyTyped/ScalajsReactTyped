...
import typingsJapgolly.jsSdsl.distEsmContainerContainerBaseMod.Container
...
object distEsmContainerTreeContainerBaseMod {
  ...
  trait TreeContainer[K, V]
    ...
    def eraseElementByIterator(iter: typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseTreeIteratorMod.default[K, V]): typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseTreeIteratorMod.default[K, V] = js.native
    ...
    /**
      ...
      */
    def lowerBound(_key: K): typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseTreeIteratorMod.default[K, V] = js.native
    
    /**
      * @param _key The given _key you want to compare.
      * @return An iterator to the first element not greater than the given _key.
      */
    def reverseLowerBound(_key: K): typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseTreeIteratorMod.default[K, V] = js.native
    
    /**
      * @param _key The given _key you want to compare.
      * @return An iterator to the first element less than the given _key.
      */
    def reverseUpperBound(_key: K): typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseTreeIteratorMod.default[K, V] = js.native
    ...
    /**
      ...
      */
    def updateKeyByIterator(
      iter: typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseTreeIteratorMod.default[K, V],
      _key: K
    ): Boolean = js.native
    ...
    /**
      ...
      */
    def upperBound(_key: K): typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseTreeIteratorMod.default[K, V] = js.native
  }
}
