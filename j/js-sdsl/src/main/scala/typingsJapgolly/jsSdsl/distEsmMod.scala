...
import typingsJapgolly.jsSdsl.distEsmContainerSequentialContainerDequeMod.default
...
object distEsmMod {
  ...
  open class Container[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerContainerBaseMod.Container[T]
  
  /* note: abstract class */ @JSImport("js-sdsl/dist/esm", "ContainerIterator")
  @js.native
  /* protected */ open class ContainerIterator[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerContainerBaseMod.ContainerIterator[T] {
  ...
  /* protected */ open class DequeIterator[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerSequentialContainerDequeMod.DequeIterator[T] {
    /* protected */ def this(iteratorType: IteratorType) = this()
  }
  ...
  open class HashMap[K, V] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerHashContainerHashMapMod.default[K, V] {
  ...
  open class HashSet[K] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerHashContainerHashSetMod.default[K] {
  ...
  open class LinkList[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerSequentialContainerLinkListMod.default[T] {
    def this(container: initContainer[T]) = this()
  }
  ...
  /* protected */ open class LinkListIterator[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerSequentialContainerLinkListMod.LinkListIterator[T] {
    /* protected */ def this(iteratorType: IteratorType) = this()
  }
  ...
  open class OrderedMap[K, V] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerTreeContainerOrderedMapMod.default[K, V] {
    def this(container: initContainer[js.Tuple2[K, V]]) = this()
  ...
  open class OrderedMapIterator[K, V] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerTreeContainerOrderedMapMod.OrderedMapIterator[K, V]
  ...
  open class OrderedSet[K] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerTreeContainerOrderedSetMod.default[K] {
    def this(container: initContainer[K]) = this()
    def this(container: Unit, cmp: js.Function2[/* x */ K, /* y */ K, Double]) = this()
  ...
  open class OrderedSetIterator[K] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerTreeContainerOrderedSetMod.OrderedSetIterator[K]
  ...
  open class PriorityQueue[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerOtherContainerPriorityQueueMod.default[T] {
    def this(container: initContainer[T]) = this()
  ...
  @js.native
  open class Queue[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerOtherContainerQueueMod.default[T] {
    def this(container: initContainer[T]) = this()
  }
  ...
  @js.native
  open class Stack[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerOtherContainerStackMod.default[T] {
    def this(container: initContainer[T]) = this()
  }
  ...
  /**
    ...
    */
  open class Vector[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerSequentialContainerVectorMod.default[T] {
    def this(container: initContainer[T]) = this()
  ...
  /* protected */ open class VectorIterator[T] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerSequentialContainerVectorMod.VectorIterator[T] {
    /* protected */ def this(iteratorType: IteratorType) = this()
  }
}
