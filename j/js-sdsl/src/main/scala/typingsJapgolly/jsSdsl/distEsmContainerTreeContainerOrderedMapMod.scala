...
object distEsmContainerTreeContainerOrderedMapMod {
  ...
  open class OrderedMapIterator[K, V] ()
    extends typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseTreeIteratorMod.default[K, V]
  
  @js.native
  trait OrderedMap[K, V]
    extends typingsJapgolly.jsSdsl.distEsmContainerTreeContainerBaseMod.default[K, V] {
