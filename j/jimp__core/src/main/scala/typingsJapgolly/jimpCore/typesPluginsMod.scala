...
import typingsJapgolly.jimpCore.anon.Class
import typingsJapgolly.jimpCore.jimpCoreStrings.`class`
import typingsJapgolly.jimpCore.jimpCoreStrings.constants
...
import typingsJapgolly.jimpCore.typesUtilsMod.Omit
