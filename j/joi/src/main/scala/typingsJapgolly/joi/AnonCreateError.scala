...
import typingsJapgolly.joi.mod.Context
import typingsJapgolly.joi.mod.Err
import typingsJapgolly.joi.mod.State
...
object AnonCreateError {
  ...
  def apply(createError: (String, Context, State, ValidationOptions) => CallbackTo[Err]): AnonCreateError = {
    ...
    __obj.updateDynamic("createError")(js.Any.fromFunction4((t0: java.lang.String, t1: typingsJapgolly.joi.mod.Context, t2: typingsJapgolly.joi.mod.State, t3: typingsJapgolly.joi.mod.ValidationOptions) => createError(t0, t1, t2, t3).runNow()))
