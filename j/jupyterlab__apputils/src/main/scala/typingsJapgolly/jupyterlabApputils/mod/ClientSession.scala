...
import typingsJapgolly.jupyterlabApputils.clientsessionMod.ClientSession.IKernelSearch
import typingsJapgolly.jupyterlabApputils.clientsessionMod.ClientSession.IOptions
...
class ClientSession protected ()
  extends typingsJapgolly.jupyterlabApputils.clientsessionMod.ClientSession {
  /**
