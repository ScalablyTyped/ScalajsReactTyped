...
trait IModelFactoryOptions extends js.Object {
  /**
    ...
    */
  var codeCellContentFactory: js.UndefOr[typingsJapgolly.jupyterlabCells.modelMod.CodeCellModel.IContentFactory] = js.undefined
}

object IModelFactoryOptions {
  @scala.inline
  def apply(
    codeCellContentFactory: typingsJapgolly.jupyterlabCells.modelMod.CodeCellModel.IContentFactory = null
