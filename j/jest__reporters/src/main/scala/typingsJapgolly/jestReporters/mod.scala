...
import typingsJapgolly.jestReporters.anon.Basename
import typingsJapgolly.jestTestResult.anon.Added
import typingsJapgolly.jestTestResult.mod.AggregatedResult
import typingsJapgolly.jestTestResult.mod.AssertionResult
import typingsJapgolly.jestTestResult.mod.SnapshotSummary
import typingsJapgolly.jestTestResult.mod.Suite
...
object mod {
  ...
  object Reporter {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getLastError = getLastError.toJsFn, onRunComplete = js.Any.fromFunction2(onRunComplete), onRunStart = js.Any.fromFunction2(onRunStart))
      __obj.asInstanceOf[Reporter]
    }
    
    extension [Self <: Reporter](x: Self) {
      
      inline def setGetLastError(value: CallbackTo[js.Error | Unit]): Self = StObject.set(x, "getLastError", value.toJsFn)
  ...
  trait SummaryOptions extends StObject {
    ...
    var currentTestCases: js.UndefOr[js.Array[typingsJapgolly.jestReporters.anon.Test]] = js.undefined
  ...
  object SummaryOptions {
    ...
    extension [Self <: SummaryOptions](x: Self) {
      ...
      inline def setCurrentTestCases(value: js.Array[typingsJapgolly.jestReporters.anon.Test]): Self = StObject.set(x, "currentTestCases", value.asInstanceOf[js.Any])
      
      inline def setCurrentTestCasesUndefined: Self = StObject.set(x, "currentTestCases", js.undefined)
      
      inline def setCurrentTestCasesVarargs(value: typingsJapgolly.jestReporters.anon.Test*): Self = StObject.set(x, "currentTestCases", js.Array(value*))
