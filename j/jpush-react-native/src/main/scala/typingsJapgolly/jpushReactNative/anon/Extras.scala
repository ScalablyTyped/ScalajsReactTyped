...
import typingsJapgolly.jpushReactNative.jpushReactNativeStrings.notificationArrived
import typingsJapgolly.jpushReactNative.jpushReactNativeStrings.notificationOpened
