...
import typingsJapgolly.jose.distTypesTypesMod.GeneralJWS
...
object distTypesJwsGeneralSignMod {
  ...
  object Signature {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addSignature = js.Any.fromFunction1(addSignature), done = done.toJsFn, setProtectedHeader = js.Any.fromFunction1(setProtectedHeader), setUnprotectedHeader = js.Any.fromFunction1(setUnprotectedHeader), sign = js.Any.fromFunction1(sign))
    ...
    extension [Self <: Signature](x: Self) {
      ...
      inline def setDone(value: CallbackTo[GeneralSign]): Self = StObject.set(x, "done", value.toJsFn)
