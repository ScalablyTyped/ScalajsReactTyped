...
import typingsJapgolly.jose.distTypesTypesMod.CritOption
import typingsJapgolly.jose.distTypesTypesMod.DeflateOption
...
object distTypesJweGeneralEncryptMod {
  ...
  object Recipient {
    ...
    inline def apply(
      ...
      done: CallbackTo[GeneralEncrypt],
      ...
      val __obj = js.Dynamic.literal(addRecipient = js.Any.fromFunction1(addRecipient), done = done.toJsFn, encrypt = js.Any.fromFunction1(encrypt), setUnprotectedHeader = js.Any.fromFunction1(setUnprotectedHeader))
    ...
    extension [Self <: Recipient](x: Self) {
      ...
      inline def setDone(value: CallbackTo[GeneralEncrypt]): Self = StObject.set(x, "done", value.toJsFn)
