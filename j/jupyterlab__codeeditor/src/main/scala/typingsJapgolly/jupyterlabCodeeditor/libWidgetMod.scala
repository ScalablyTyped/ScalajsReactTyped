...
import typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.Factory
import typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.IEditor
import typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.IModel
import typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.ISelectionStyle
import typingsJapgolly.jupyterlabCodeeditor.libWidgetMod.CodeEditorWrapper.IOptions
  ...
  object CodeEditorWrapper {
    ...
    trait IOptions extends StObject {
      ...
      /**
        ...
        */
      def factory(options: typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.IOptions): IEditor
      /**
        * A code editor factory.
        *
        * #### Notes
    ...
    object IOptions {
      ...
      inline def apply(
        factory: /* options */ typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.IOptions => IEditor,
        model: IModel
      ): IOptions = {
      ...
      extension [Self <: IOptions](x: Self) {
        ...
        inline def setFactory(
          value: /* options */ typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.IOptions => IEditor
        ): Self = StObject.set(x, "factory", js.Any.fromFunction1(value))
