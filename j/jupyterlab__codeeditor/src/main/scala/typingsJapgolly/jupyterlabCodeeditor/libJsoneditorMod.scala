...
import typingsJapgolly.jupyterlabCodeeditor.libJsoneditorMod.JSONEditor.IOptions
  ...
  object JSONEditor {
    ...
    trait IOptions extends StObject {
      ...
      /**
        ...
        */
      def editorFactory(options: typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.IOptions): IEditor
      /**
        * The editor factory used by the editor.
        */
    ...
    object IOptions {
      ...
      inline def apply(
        editorFactory: /* options */ typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.IOptions => IEditor
      ): IOptions = {
