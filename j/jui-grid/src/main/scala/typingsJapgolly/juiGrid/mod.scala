package typingsJapgolly.juiGrid

import typingsJapgolly.juiCore.mod.UIEvent
import typingsJapgolly.juiGrid.anon.Colshow
import typingsJapgolly.juiGrid.juiGridStrings.asc
import typingsJapgolly.juiGrid.juiGridStrings.avg
import typingsJapgolly.juiGrid.juiGridStrings.desc
import typingsJapgolly.juiGrid.juiGridStrings.fold
import typingsJapgolly.juiGrid.juiGridStrings.hide
import typingsJapgolly.juiGrid.juiGridStrings.open
import typingsJapgolly.juiGrid.juiGridStrings.resize
import typingsJapgolly.juiGrid.juiGridStrings.show
import typingsJapgolly.juiGrid.juiGridStrings.sum
...
object mod {
  ...
  trait GridBase extends StObject {
    ...
    def appendColumn(tplType: String, dataList: js.Array[Any]): Unit = js.native
  ...
  trait GridRow extends StObject {
    ...
    def insertChild(rownum: Double, row: GridRow, isReload: Any): Unit = js.native
    
    def isLeaf(): Boolean = js.native
    
    def lastChild(): GridRow = js.native
    
    def lastChildLeaf(lastRow: GridRow): GridRow | Any = js.native
    ...
    def reload(columns: js.Array[GridColumn], seq: Any, xssFilter: Any): Unit = js.native
  ...
  trait GridTable
    ...
    def apply(selector: Any, options: Colshow): this.type = js.native
    ...
    def append(rowOrIndex: Any): Unit = js.native
    def append(rowOrIndex: Any, row: Any): Unit = js.native
    def append(rowOrIndex: Double): Unit = js.native
    def append(rowOrIndex: Double, row: Any): Unit = js.native
    def append(rowOrIndex: Unit, row: Any): Unit = js.native
    ...
    def hideColumn(index: String): Unit = js.native
    def hideColumn(index: String, e: Any): Unit = js.native
    /**
      ...
      */
    def hideColumn(index: Double): Unit = js.native
    def hideColumn(index: Double, e: Any): Unit = js.native
    
    def hideColumnMenu(): Unit = js.native
    
    def hideEditRow(): Unit = js.native
    def hideEditRow(data: Any): Unit = js.native
    
    def hideExpand(): Unit = js.native
    def hideExpand(e: Any): Unit = js.native
    ...
    /**
      ...
      * @param key index or column name
      */
    def initColumns(keys: Any): Unit = js.native
    ...
    /**
      ...
      * @return datas
      */
    def listData(): js.Array[Any] = js.native
    ...
    def setCsv(csvOrKey: Any): Unit = js.native
    def setCsv(csvOrKey: Any, key: Any): Unit = js.native
    
    def setCsvFile(fileOrKey: Any): Unit = js.native
    def setCsvFile(fileOrKey: Any, key: Any): Unit = js.native
    
    def showColumn(index: String): Unit = js.native
    def showColumn(index: String, e: Any): Unit = js.native
    /**
      ...
      */
    def showColumn(index: Double): Unit = js.native
    def showColumn(index: Double, e: Any): Unit = js.native
    ...
    def showEditRow(index: Double, e: Any): Unit = js.native
    
    /**
      * Shows the extended row area of a specified index.
      */
    def showExpand(index: Double): Unit = js.native
    def showExpand(index: Double, obj: Any): Unit = js.native
    def showExpand(index: Double, obj: Any, e: Any): Unit = js.native
    def showExpand(index: Double, obj: Unit, e: Any): Unit = js.native
    ...
    def sort(index: Double, order: String, e: Any): Unit = js.native
    ...
    def update(indexOrRows: Any): Unit = js.native
    def update(indexOrRows: Any, rows: Any): Unit = js.native
    def update(indexOrRows: Unit, rows: Any): Unit = js.native
    
    /**
      * It is possible to configure a tree table using an object array with the index and data properties.
      */
    def updateTree(rows: js.Array[Any]): Unit = js.native
  }
  ...
  trait GridXTable
    ...
    def apply(selector: Any): this.type = js.native
    def apply(selector: Any, options: js.Object): this.type = js.native
    ...
    /**
      ...
      */
    def filter(callback: js.Function1[/* data */ Any, Unit]): Unit = js.native
    ...
    def getAll(index: Double): js.Array[GridRow] = js.native
    def getAll(index: Double, _result: Any): js.Array[GridRow] = js.native
    ...
    def getData(index: String): Any = js.native
    /**
      ...
      * @return data
      */
    def getData(index: Double): Any = js.native
    ...
    /**
      ...
      */
    def rowFunc(`type`: sum | avg, index: Double, callback: js.Function1[/* data */ Any, Unit]): Any = js.native
    ...
    def setCsvFile(file: Any): Unit = js.native
    ...
    /**
      ...
      * @param order  "asc" or "desc"
      */
    def sort(index: Double, order: asc | desc): Unit = js.native
    def sort(index: Double, order: asc | desc, e: Any): Unit = js.native
    def sort(index: Double, order: asc | desc, e: Any, isNotLoading: Any): Unit = js.native
    def sort(index: Double, order: asc | desc, e: Unit, isNotLoading: Any): Unit = js.native
    ...
    /**
      * Updates the list of rows or modifies the row at a specified index.
      */
    def update(dataList: js.Array[Any]): Unit = js.native
    
    /**
      * It is possible to configure a tree table using an object array with the index and data properties.
      */
    def updateTree(tree: js.Array[Any]): Unit = js.native
  }
}
