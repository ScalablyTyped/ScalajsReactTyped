package typingsJapgolly.justifiedgallery
...
import typingsJapgolly.justifiedgallery.justifiedgalleryBooleans.`false`
import typingsJapgolly.justifiedgallery.justifiedgalleryStrings.center
import typingsJapgolly.justifiedgallery.justifiedgalleryStrings.hide
import typingsJapgolly.justifiedgallery.justifiedgalleryStrings.justify
import typingsJapgolly.justifiedgallery.justifiedgalleryStrings.left
import typingsJapgolly.justifiedgallery.justifiedgalleryStrings.nojustify
import typingsJapgolly.justifiedgallery.justifiedgalleryStrings.right
import typingsJapgolly.justifiedgallery.mod.JustifiedGallery.Settings
import typingsJapgolly.justifiedgallery.mod.global.JQuery
  ...
  object JustifiedGallery {
    ...
    object Settings {
      ...
      extension [Self <: Settings](x: Self) {
        ...
        inline def setTriggerEvent(value: /* event */ String | Event => Callback): Self = StObject.set(x, "triggerEvent", js.Any.fromFunction1((t0: /* event */ String | Event) => value(t0).runNow()))
