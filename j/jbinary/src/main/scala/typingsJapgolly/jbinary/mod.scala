package typingsJapgolly.jbinary
...
object mod {
  ...
  open class ^ protected ()
    ...
    /**
      ...
      * @param typeSet Typeset object with all the defined types.
      */
    def this(data: typingsJapgolly.jdataview.mod.^) = this()
    ...
    def this(data: typingsJapgolly.jdataview.mod.^, typeSet: TypeSet) = this()
  }
  @JSImport("jbinary", JSImport.Namespace)
  @js.native
  ...
  object CustomTypeConfig {
    ...
    inline def apply(read: Any => Any, write: (Any, Any) => Callback): CustomTypeConfig = {
      val __obj = js.Dynamic.literal(read = js.Any.fromFunction1(read), write = js.Any.fromFunction2((t0: Any, t1: Any) => (write(t0, t1)).runNow()))
    ...
    extension [Self <: CustomTypeConfig](x: Self) {
      ...
      inline def setWrite(value: (Any, Any) => Callback): Self = StObject.set(x, "write", js.Any.fromFunction2((t0: Any, t1: Any) => (value(t0, t1)).runNow()))
    }
  }
  ...
  trait jBinary extends StObject {
    ...
    /**
      ...
      */
    var view: typingsJapgolly.jdataview.mod.^ = js.native
