...
import typingsJapgolly.jui.juiStrings.`bottom-left`
import typingsJapgolly.jui.juiStrings.`bottom-right`
import typingsJapgolly.jui.juiStrings.`top-lefet`
import typingsJapgolly.jui.juiStrings.`top-right`
