package typingsJapgolly.jqueryMaskPlugin
...
object jQueryMask {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnChange(value: (/* value */ String, /* e */ Event, /* $element */ JQuery, Options) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction4((t0: /* value */ String, t1: /* e */ Event, t2: /* $element */ JQuery, t3: Options) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnComplete(value: (/* value */ String, /* e */ Event, /* $element */ JQuery, Options) => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction4((t0: /* value */ String, t1: /* e */ Event, t2: /* $element */ JQuery, t3: Options) => (value(t0, t1, t2, t3)).runNow()))
      
      inline def setOnCompleteUndefined: Self = StObject.set(x, "onComplete", js.undefined)
      
      inline def setOnInvalid(
        value: (/* value */ String, /* e */ Event, /* $element */ JQuery, /* invalid */ js.Array[Invalid], Options) => Callback
      ): Self = StObject.set(x, "onInvalid", js.Any.fromFunction5((t0: /* value */ String, t1: /* e */ Event, t2: /* $element */ JQuery, t3: /* invalid */ js.Array[Invalid], t4: Options) => (value(t0, t1, t2, t3, t4)).runNow()))
      
      inline def setOnInvalidUndefined: Self = StObject.set(x, "onInvalid", js.undefined)
      
      inline def setOnKeyPress(value: (/* value */ String, /* e */ Event, /* $element */ JQuery, Options) => Callback): Self = StObject.set(x, "onKeyPress", js.Any.fromFunction4((t0: /* value */ String, t1: /* e */ Event, t2: /* $element */ JQuery, t3: Options) => (value(t0, t1, t2, t3)).runNow()))
