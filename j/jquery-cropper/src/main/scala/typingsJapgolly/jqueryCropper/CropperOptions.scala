package typingsJapgolly.jqueryCropper
...
object CropperOptions {
  ...
  extension [Self <: CropperOptions](x: Self) {
    ...
    inline def setCrop(value: /* data */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "crop", js.Any.fromFunction1((t0: /* data */ js.UndefOr[Any]) => value(t0).runNow()))
    ...
    inline def setCropend(value: CallbackTo[Any]): Self = StObject.set(x, "cropend", value.toJsFn)
    
    inline def setCropendUndefined: Self = StObject.set(x, "cropend", js.undefined)
    
    inline def setCropmove(value: CallbackTo[Any]): Self = StObject.set(x, "cropmove", value.toJsFn)
    
    inline def setCropmoveUndefined: Self = StObject.set(x, "cropmove", js.undefined)
    
    inline def setCropstart(value: CallbackTo[Any]): Self = StObject.set(x, "cropstart", value.toJsFn)
    ...
    inline def setReady(value: CallbackTo[Any]): Self = StObject.set(x, "ready", value.toJsFn)
    ...
    inline def setZoom(value: CallbackTo[Any]): Self = StObject.set(x, "zoom", value.toJsFn)
