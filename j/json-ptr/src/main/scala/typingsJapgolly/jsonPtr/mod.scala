package typingsJapgolly.jsonPtr

import typingsJapgolly.jsonPtr.distTypesPointerMod.Visitor
import typingsJapgolly.jsonPtr.distTypesTypesMod.Decoder
import typingsJapgolly.jsonPtr.distTypesTypesMod.JsonStringPointer
import typingsJapgolly.jsonPtr.distTypesTypesMod.JsonStringPointerListItem
import typingsJapgolly.jsonPtr.distTypesTypesMod.PathSegment
import typingsJapgolly.jsonPtr.distTypesTypesMod.PathSegments
import typingsJapgolly.jsonPtr.distTypesTypesMod.Pointer
import typingsJapgolly.jsonPtr.distTypesTypesMod.RelativeJsonPointer
import typingsJapgolly.jsonPtr.distTypesTypesMod.UriFragmentIdentifierPointer
import typingsJapgolly.jsonPtr.distTypesTypesMod.UriFragmentIdentifierPointerListItem
import typingsJapgolly.jsonPtr.distTypesUtilMod.Dereference
...
object mod {
  ...
  open class JsonPointer protected ()
    extends typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer {
  ...
  object JsonPointer {
    ...
    inline def create(pointer: PathSegments): typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(pointer.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer]
    /**
      ...
      */
    inline def create(pointer: Pointer): typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(pointer.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer]
    ...
    inline def get(target: Any, pointer: typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(target.asInstanceOf[js.Any], pointer.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    inline def has(target: Any, pointer: typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("has")(target.asInstanceOf[js.Any], pointer.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    ...
    inline def set(target: Any, pointer: typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer, `val`: Any): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("set")(target.asInstanceOf[js.Any], pointer.asInstanceOf[js.Any], `val`.asInstanceOf[js.Any])).asInstanceOf[Any]
    inline def set(
      target: Any,
      pointer: typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer,
      `val`: Any,
      force: Boolean
    ): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("set")(target.asInstanceOf[js.Any], pointer.asInstanceOf[js.Any], `val`.asInstanceOf[js.Any], force.asInstanceOf[js.Any])).asInstanceOf[Any]
    ...
    inline def unset(target: Any, pointer: typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer): Any = (^.asInstanceOf[js.Dynamic].applyDynamic("unset")(target.asInstanceOf[js.Any], pointer.asInstanceOf[js.Any])).asInstanceOf[Any]
  ...
  open class JsonReference protected ()
    extends typingsJapgolly.jsonPtr.distTypesPointerMod.JsonReference {
    /**
      * Creates a new instance.
      * @param pointer a JSON Pointer for the reference.
      */
    def this(pointer: typingsJapgolly.jsonPtr.distTypesPointerMod.JsonPointer) = this()
