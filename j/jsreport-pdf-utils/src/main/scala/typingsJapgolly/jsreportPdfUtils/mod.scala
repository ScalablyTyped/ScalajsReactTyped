...
import typingsJapgolly.jsreportPdfUtils.anon.Contrent
import typingsJapgolly.jsreportPdfUtils.jsreportPdfUtilsBooleans.`true`
import typingsJapgolly.jsreportPdfUtils.jsreportPdfUtilsStrings.HighResolution
import typingsJapgolly.jsreportPdfUtils.jsreportPdfUtilsStrings.LowResolution
import typingsJapgolly.jsreportPdfUtils.jsreportPdfUtilsStrings.NotAllowed
import typingsJapgolly.jsreportPdfUtils.jsreportPdfUtilsStrings.append
import typingsJapgolly.jsreportPdfUtils.jsreportPdfUtilsStrings.merge
import typingsJapgolly.jsreportPdfUtils.jsreportPdfUtilsStrings.prepend
...
object mod {
  ...
  object jsreportCoreAugmentingMod {
    ...
    trait TemplateRegistry extends StObject {
      ...
      var PdfTemplate: typingsJapgolly.jsreportPdfUtils.mod.PdfTemplate
    }
