package typingsJapgolly.jqueryTinycarousel.JQueryTinyCarousel
...
object JQueryTinyCarouselOptions {
  ...
  def apply(
    ...
    axis: String = null,
    callback: (/* element */ HTMLElement, /* index */ Double) => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: /* element */ org.scalajs.dom.raw.HTMLElement, t1: /* index */ scala.Double) => callback(t0, t1).runNow()))
