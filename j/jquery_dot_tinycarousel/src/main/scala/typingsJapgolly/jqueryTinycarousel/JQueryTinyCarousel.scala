...
object JQueryTinyCarousel {
  ...
  object JQueryTinyCarouselOptions {
    ...
    extension [Self <: JQueryTinyCarouselOptions](x: Self) {
      ...
      inline def setCallback(value: (/* element */ HTMLElement, /* index */ Double) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* element */ HTMLElement, t1: /* index */ Double) => (value(t0, t1)).runNow()))
