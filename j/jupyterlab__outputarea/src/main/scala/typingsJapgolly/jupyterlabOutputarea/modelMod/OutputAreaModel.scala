package typingsJapgolly.jupyterlabOutputarea.modelMod

import typingsJapgolly.jupyterlabObservables.observablelistMod.IObservableList
import typingsJapgolly.jupyterlabOutputarea.AnonLastModel
...
import typingsJapgolly.jupyterlabOutputarea.modelMod.IOutputAreaModel.IOptions
...
object OutputAreaModel extends js.Object {
  ...
  class ContentFactory () extends IContentFactory {
    /**
      ...
      */
    /* CompleteClass */
    override def createOutputModel(options: typingsJapgolly.jupyterlabRendermime.outputmodelMod.IOutputModel.IOptions): IOutputModel = js.native
  }
