package typingsJapgolly.jqueryJoyride
  ...
  object global {
    ...
    object JoyrideOptions {
      ...
      extension [Self <: JoyrideOptions](x: Self) {
        ...
        inline def setPostExposeCallback(value: (/* index */ Double, /* nextTip */ JQuery, /* el */ js.UndefOr[JQuery]) => Callback): Self = StObject.set(x, "postExposeCallback", js.Any.fromFunction3((t0: /* index */ Double, t1: /* nextTip */ JQuery, t2: /* el */ js.UndefOr[JQuery]) => (value(t0, t1, t2)).runNow()))
        
        inline def setPostExposeCallbackUndefined: Self = StObject.set(x, "postExposeCallback", js.undefined)
        
        inline def setPostRideCallback(
          value: (/* index */ Double, /* currentTip */ JQuery, /* isAborted */ js.UndefOr[Boolean]) => Callback
        ): Self = StObject.set(x, "postRideCallback", js.Any.fromFunction3((t0: /* index */ Double, t1: /* currentTip */ JQuery, t2: /* isAborted */ js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
        
        inline def setPostRideCallbackUndefined: Self = StObject.set(x, "postRideCallback", js.undefined)
        
        inline def setPostStepCallback(
          value: (/* index */ Double, /* currentTip */ JQuery, /* isAborted */ js.UndefOr[Boolean]) => Callback
        ): Self = StObject.set(x, "postStepCallback", js.Any.fromFunction3((t0: /* index */ Double, t1: /* currentTip */ JQuery, t2: /* isAborted */ js.UndefOr[Boolean]) => (value(t0, t1, t2)).runNow()))
        
        inline def setPostStepCallbackUndefined: Self = StObject.set(x, "postStepCallback", js.undefined)
        
        inline def setPreRideCallback(value: (/* index */ Double, /* currentTip */ JQuery, /* el */ js.UndefOr[JQuery]) => Callback): Self = StObject.set(x, "preRideCallback", js.Any.fromFunction3((t0: /* index */ Double, t1: /* currentTip */ JQuery, t2: /* el */ js.UndefOr[JQuery]) => (value(t0, t1, t2)).runNow()))
        
        inline def setPreRideCallbackUndefined: Self = StObject.set(x, "preRideCallback", js.undefined)
        
        inline def setPreStepCallback(value: (/* index */ Double, /* nextTip */ JQuery, /* el */ js.UndefOr[JQuery]) => Callback): Self = StObject.set(x, "preStepCallback", js.Any.fromFunction3((t0: /* index */ Double, t1: /* nextTip */ JQuery, t2: /* el */ js.UndefOr[JQuery]) => (value(t0, t1, t2)).runNow()))
