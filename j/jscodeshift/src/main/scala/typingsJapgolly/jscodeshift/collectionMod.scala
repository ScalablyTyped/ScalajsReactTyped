...
import typingsJapgolly.jscodeshift.nodeMod.MutationMethods
import typingsJapgolly.jscodeshift.nodeMod.TraversalMethods
import typingsJapgolly.jscodeshift.variableDeclaratorMod.GlobalMethods
import typingsJapgolly.jscodeshift.variableDeclaratorMod.TransformMethods
...
object collectionMod extends js.Object {
  ...
  trait Collection[N]
    extends TraversalMethods
       ...
       with typingsJapgolly.jscodeshift.jsxelementMod.GlobalMethods
       with typingsJapgolly.jscodeshift.jsxelementMod.TraversalMethods
       with /**
