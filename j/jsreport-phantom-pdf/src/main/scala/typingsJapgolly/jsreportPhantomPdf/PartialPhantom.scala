...
import typingsJapgolly.jsreportPhantomPdf.mod.Margin
...
object PartialPhantom {
  ...
  def apply(
    ...
    resourceTimeout: Int | Double = null,
    waitForJS: js.UndefOr[Boolean] = js.undefined,
    width: String = null
  ): PartialPhantom = {
    val __obj = js.Dynamic.literal()
    if (!js.isUndefined(blockJavaScript)) __obj.updateDynamic("blockJavaScript")(blockJavaScript.asInstanceOf[js.Any])
    if (!js.isUndefined(customPhantomJS)) __obj.updateDynamic("customPhantomJS")(customPhantomJS.asInstanceOf[js.Any])
    ...
    if (resourceTimeout != null) __obj.updateDynamic("resourceTimeout")(resourceTimeout.asInstanceOf[js.Any])
