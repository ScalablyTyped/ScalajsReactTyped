package typingsJapgolly.jsreportPhantomPdf
...
import typingsJapgolly.jsreportPhantomPdf.anon.PartialOptions
import typingsJapgolly.jsreportPhantomPdf.anon.PartialPhantom
import typingsJapgolly.jsreportPhantomPdf.jsreportPhantomPdfStrings.`dedicated-process`
import typingsJapgolly.jsreportPhantomPdf.jsreportPhantomPdfStrings.`phantom-pdf`
import typingsJapgolly.jsreportPhantomPdf.jsreportPhantomPdfStrings.`phantom-server`
import typingsJapgolly.jsreportPhantomPdf.jsreportPhantomPdfStrings.landscape
import typingsJapgolly.jsreportPhantomPdf.jsreportPhantomPdfStrings.portrait
...
object mod {
  ...
  object jsreportCoreAugmentingMod {
    ...
    trait TemplateRegistry extends StObject {
      ...
      var PhantomPDFTemplate: typingsJapgolly.jsreportPhantomPdf.mod.PhantomPDFTemplate
    }
