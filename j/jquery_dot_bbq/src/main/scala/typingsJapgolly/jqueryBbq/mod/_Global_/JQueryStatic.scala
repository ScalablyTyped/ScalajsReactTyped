package typingsJapgolly.jqueryBbq.mod._Global_

import typingsJapgolly.jqueryBbq.mod._Global_.JQueryBbq.JQueryDeparam
...
trait JQueryStatic extends js.Object {
  var bbq: typingsJapgolly.jqueryBbq.mod._Global_.JQueryBbq.JQuery = js.native
  @JSName("deparam")
