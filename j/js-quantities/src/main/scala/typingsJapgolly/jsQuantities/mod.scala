...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsQuantities.jsQuantitiesInts.`-1`
    - typingsJapgolly.jsQuantities.jsQuantitiesInts.`0`
    - typingsJapgolly.jsQuantities.jsQuantitiesInts.`1`
  */
  trait ComparisonResult extends StObject
  object ComparisonResult {
    
    inline def `-1`: typingsJapgolly.jsQuantities.jsQuantitiesInts.`-1` = -1.asInstanceOf[typingsJapgolly.jsQuantities.jsQuantitiesInts.`-1`]
    
    inline def `0`: typingsJapgolly.jsQuantities.jsQuantitiesInts.`0` = 0.asInstanceOf[typingsJapgolly.jsQuantities.jsQuantitiesInts.`0`]
