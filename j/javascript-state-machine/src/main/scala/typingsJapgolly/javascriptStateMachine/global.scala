package typingsJapgolly.javascriptStateMachine

import typingsJapgolly.javascriptStateMachine.mod.StateMachineConfig
...
object global {
  ...
  object StateMachine {
    ...
    object StateMachine {
      ...
      inline def create(config: StateMachineConfig): typingsJapgolly.javascriptStateMachine.mod.StateMachine = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.javascriptStateMachine.mod.StateMachine]
      inline def create(config: StateMachineConfig, target: typingsJapgolly.javascriptStateMachine.mod.StateMachine): typingsJapgolly.javascriptStateMachine.mod.StateMachine = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(config.asInstanceOf[js.Any], target.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.javascriptStateMachine.mod.StateMachine]
    }
