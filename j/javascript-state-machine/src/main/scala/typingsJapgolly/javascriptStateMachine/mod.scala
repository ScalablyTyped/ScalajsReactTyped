...
object mod {
  ...
  object StateMachine {
    ...
    inline def apply(
      ...
      current: String,
      error: (/* eventName */ js.UndefOr[String], /* from */ js.UndefOr[String], /* to */ js.UndefOr[String], /* args */ js.UndefOr[js.Array[Any]], /* errorCode */ js.UndefOr[Double], /* errorMessage */ js.UndefOr[String], /* ex */ js.UndefOr[js.Error]) => Callback,
      is: /* state */ String => Boolean,
      isFinished: /* state */ String => Boolean,
      transition: StateMachineTransition,
      transitions: CallbackTo[js.Array[String]]
    ): StateMachine = {
      val __obj = js.Dynamic.literal(can = js.Any.fromFunction1(can), cannot = js.Any.fromFunction1(cannot), current = current.asInstanceOf[js.Any], error = js.Any.fromFunction7((t0: /* eventName */ js.UndefOr[String], t1: /* from */ js.UndefOr[String], t2: /* to */ js.UndefOr[String], t3: /* args */ js.UndefOr[js.Array[Any]], t4: /* errorCode */ js.UndefOr[Double], t5: /* errorMessage */ js.UndefOr[String], t6: /* ex */ js.UndefOr[js.Error]) => (error(t0, t1, t2, t3, t4, t5, t6)).runNow()), is = js.Any.fromFunction1(is), isFinished = js.Any.fromFunction1(isFinished), transition = transition.asInstanceOf[js.Any], transitions = transitions.toJsFn)
    ...
    extension [Self <: StateMachine](x: Self) {
      ...
      inline def setError(
        value: (/* eventName */ js.UndefOr[String], /* from */ js.UndefOr[String], /* to */ js.UndefOr[String], /* args */ js.UndefOr[js.Array[Any]], /* errorCode */ js.UndefOr[Double], /* errorMessage */ js.UndefOr[String], /* ex */ js.UndefOr[js.Error]) => Callback
      ): Self = StObject.set(x, "error", js.Any.fromFunction7((t0: /* eventName */ js.UndefOr[String], t1: /* from */ js.UndefOr[String], t2: /* to */ js.UndefOr[String], t3: /* args */ js.UndefOr[js.Array[Any]], t4: /* errorCode */ js.UndefOr[Double], t5: /* errorMessage */ js.UndefOr[String], t6: /* ex */ js.UndefOr[js.Error]) => (value(t0, t1, t2, t3, t4, t5, t6)).runNow()))
      ...
      inline def setTransitions(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "transitions", value.toJsFn)
    }
  }
