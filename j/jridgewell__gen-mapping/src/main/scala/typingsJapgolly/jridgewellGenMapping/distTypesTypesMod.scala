...
import typingsJapgolly.jridgewellGenMapping.distTypesSourcemapSegmentMod.SourceMapSegment
import typingsJapgolly.jridgewellGenMapping.jridgewellGenMappingInts.`3`
...
object distTypesTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jridgewellGenMapping.anon.Original
    - typingsJapgolly.jridgewellGenMapping.anon.Source
    - typingsJapgolly.jridgewellGenMapping.anon.GeneratedName
  */
  trait Mapping extends StObject
  object Mapping {
    
    inline def GeneratedName(generated: Pos, name: Unit, original: Pos, source: String): typingsJapgolly.jridgewellGenMapping.anon.GeneratedName = {
      ...
      __obj.asInstanceOf[typingsJapgolly.jridgewellGenMapping.anon.GeneratedName]
    }
    
    inline def Original(generated: Pos, name: Unit, original: Unit, source: Unit): typingsJapgolly.jridgewellGenMapping.anon.Original = {
      val __obj = js.Dynamic.literal(generated = generated.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], original = original.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jridgewellGenMapping.anon.Original]
    }
    
    inline def Source(generated: Pos, name: String, original: Pos, source: String): typingsJapgolly.jridgewellGenMapping.anon.Source = {
      val __obj = js.Dynamic.literal(generated = generated.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], original = original.asInstanceOf[js.Any], source = source.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jridgewellGenMapping.anon.Source]
    }
  }
