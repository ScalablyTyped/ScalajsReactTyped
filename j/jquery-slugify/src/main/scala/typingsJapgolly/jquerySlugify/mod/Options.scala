package typingsJapgolly.jquerySlugify.mod
...
object Options {
  ...
  def apply(
    ...
    postSlug: /* source */ String => CallbackTo[String] = null,
    preSlug: /* source */ String => CallbackTo[String] = null,
    separator: String = null,
    slugFunc: (/* input */ String, Options) => CallbackTo[String] = null,
    ...
    if (postSlug != null) __obj.updateDynamic("postSlug")(js.Any.fromFunction1((t0: /* source */ java.lang.String) => postSlug(t0).runNow()))
    if (preSlug != null) __obj.updateDynamic("preSlug")(js.Any.fromFunction1((t0: /* source */ java.lang.String) => preSlug(t0).runNow()))
    if (separator != null) __obj.updateDynamic("separator")(separator.asInstanceOf[js.Any])
    if (slugFunc != null) __obj.updateDynamic("slugFunc")(js.Any.fromFunction2((t0: /* input */ java.lang.String, t1: typingsJapgolly.jquerySlugify.mod.Options) => slugFunc(t0, t1).runNow()))
