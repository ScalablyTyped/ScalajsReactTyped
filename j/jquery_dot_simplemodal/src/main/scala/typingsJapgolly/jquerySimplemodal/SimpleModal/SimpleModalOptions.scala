package typingsJapgolly.jquerySimplemodal.SimpleModal
...
object SimpleModalOptions {
  ...
  def apply(
    ...
    onClose: /* dialog */ SimpleModalDialog => Callback = null,
    onOpen: /* dialog */ SimpleModalDialog => Callback = null,
    onShow: /* dialog */ SimpleModalDialog => Callback = null,
    ...
    if (onClose != null) __obj.updateDynamic("onClose")(js.Any.fromFunction1((t0: /* dialog */ typingsJapgolly.jquerySimplemodal.SimpleModal.SimpleModalDialog) => onClose(t0).runNow()))
    if (onOpen != null) __obj.updateDynamic("onOpen")(js.Any.fromFunction1((t0: /* dialog */ typingsJapgolly.jquerySimplemodal.SimpleModal.SimpleModalDialog) => onOpen(t0).runNow()))
    if (onShow != null) __obj.updateDynamic("onShow")(js.Any.fromFunction1((t0: /* dialog */ typingsJapgolly.jquerySimplemodal.SimpleModal.SimpleModalDialog) => onShow(t0).runNow()))
