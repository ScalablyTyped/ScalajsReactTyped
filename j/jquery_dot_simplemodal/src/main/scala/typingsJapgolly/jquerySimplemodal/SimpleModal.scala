...
object SimpleModal {
  ...
  object SimpleModalOptions {
    ...
    extension [Self <: SimpleModalOptions](x: Self) {
      ...
      inline def setOnClose(value: /* dialog */ SimpleModalDialog => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction1((t0: /* dialog */ SimpleModalDialog) => value(t0).runNow()))
      
      inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
      
      inline def setOnOpen(value: /* dialog */ SimpleModalDialog => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction1((t0: /* dialog */ SimpleModalDialog) => value(t0).runNow()))
      
      inline def setOnOpenUndefined: Self = StObject.set(x, "onOpen", js.undefined)
      
      inline def setOnShow(value: /* dialog */ SimpleModalDialog => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* dialog */ SimpleModalDialog) => value(t0).runNow()))
