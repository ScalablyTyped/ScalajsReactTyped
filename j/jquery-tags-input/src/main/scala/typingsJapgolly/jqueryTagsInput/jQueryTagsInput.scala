...
object jQueryTagsInput {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnAddTag(value: /* addedValue */ String => Callback): Self = StObject.set(x, "onAddTag", js.Any.fromFunction1((t0: /* addedValue */ String) => value(t0).runNow()))
      
      inline def setOnAddTagUndefined: Self = StObject.set(x, "onAddTag", js.undefined)
      
      inline def setOnChange(value: (/* element */ JQuery, /* changedValue */ String) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* element */ JQuery, t1: /* changedValue */ String) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnRemoveTag(value: /* removedValue */ String => Callback): Self = StObject.set(x, "onRemoveTag", js.Any.fromFunction1((t0: /* removedValue */ String) => value(t0).runNow()))
