...
import typingsJapgolly.jjv.mod.Errors
...
object mod {
  ...
  inline def apply(jjv: typingsJapgolly.jjv.mod.Env): Env = ^.asInstanceOf[js.Dynamic].apply(jjv.asInstanceOf[js.Any]).asInstanceOf[Env]
