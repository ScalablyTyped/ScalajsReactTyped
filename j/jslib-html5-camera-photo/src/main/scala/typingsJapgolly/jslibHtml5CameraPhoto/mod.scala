package typingsJapgolly.jslibHtml5CameraPhoto

import org.scalajs.dom.HTMLVideoElement
import org.scalajs.dom.MediaDeviceInfo
import org.scalajs.dom.MediaDevices
import org.scalajs.dom.MediaStream
import org.scalajs.dom.MediaTrackSettings
import org.scalajs.dom.URL
import typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.environment
import typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.jpg
import typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.png
import typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.user
import typingsJapgolly.std.ConstrainULong
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.user
    - typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.environment
  */
  trait FacingMode extends StObject
  object FacingMode {
    
    inline def environment: typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.environment = "environment".asInstanceOf[typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.environment]
    
    inline def user: typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.user = "user".asInstanceOf[typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.user]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.png
    - typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.jpg
  */
  trait ImageType extends StObject
  object ImageType {
    
    inline def jpg: typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.jpg = "jpg".asInstanceOf[typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.jpg]
    
    inline def png: typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.png = "png".asInstanceOf[typingsJapgolly.jslibHtml5CameraPhoto.jslibHtml5CameraPhotoStrings.png]
  }
