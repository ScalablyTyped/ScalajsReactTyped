...
object JScrollPaneSettings {
  ...
  def apply(
    ...
    if (animateEase != null) __obj.updateDynamic("animateEase")(animateEase.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(arrowScrollOnHover)) __obj.updateDynamic("arrowScrollOnHover")(arrowScrollOnHover.asInstanceOf[js.Any])
    if (!js.isUndefined(autoReinitialise)) __obj.updateDynamic("autoReinitialise")(autoReinitialise.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(enableKeyboardNavigation)) __obj.updateDynamic("enableKeyboardNavigation")(enableKeyboardNavigation.asInstanceOf[js.Any])
    if (!js.isUndefined(hideFocus)) __obj.updateDynamic("hideFocus")(hideFocus.asInstanceOf[js.Any])
    if (!js.isUndefined(hijackInternalLinks)) __obj.updateDynamic("hijackInternalLinks")(hijackInternalLinks.asInstanceOf[js.Any])
    if (horizontalArrowPositions != null) __obj.updateDynamic("horizontalArrowPositions")(horizontalArrowPositions.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(maintainPosition)) __obj.updateDynamic("maintainPosition")(maintainPosition.asInstanceOf[js.Any])
    if (mouseWheelSpeed != null) __obj.updateDynamic("mouseWheelSpeed")(mouseWheelSpeed.asInstanceOf[js.Any])
    if (!js.isUndefined(showArrows)) __obj.updateDynamic("showArrows")(showArrows.asInstanceOf[js.Any])
    if (!js.isUndefined(stickToBottom)) __obj.updateDynamic("stickToBottom")(stickToBottom.asInstanceOf[js.Any])
    if (!js.isUndefined(stickToRight)) __obj.updateDynamic("stickToRight")(stickToRight.asInstanceOf[js.Any])
    ...
    if (verticalArrowPositions != null) __obj.updateDynamic("verticalArrowPositions")(verticalArrowPositions.asInstanceOf[js.Any])
