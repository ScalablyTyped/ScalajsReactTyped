...
object mod {
  ...
  */
  ...
  object MemberIndexFormat {
    ...
    inline def grouped: typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.grouped = "grouped".asInstanceOf[typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.grouped]
    
    inline def list: typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.list = "list".asInstanceOf[typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.list]
  }
  ...
  */
  ...
  object RenderListFormat {
    ...
    inline def table: typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.table = "table".asInstanceOf[typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.table]
  }
  ...
  */
  ...
  object StyleListFormat {
    ...
    inline def dl: typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.dl = "dl".asInstanceOf[typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.dl]
    
    inline def grouped: typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.grouped = "grouped".asInstanceOf[typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.grouped]
    
    inline def none: typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.none = "none".asInstanceOf[typingsJapgolly.jsdocToMarkdown.jsdocToMarkdownStrings.none]
