...
object JQueryFormOptions {
  ...
  extension [Self <: JQueryFormOptions](x: Self) {
    ...
    inline def setUploadProgress(
      value: (/* event */ ProgressEvent, /* position */ Double, /* total */ Double, /* percentComplete */ Double) => Callback
    ): Self = StObject.set(x, "uploadProgress", js.Any.fromFunction4((t0: /* event */ ProgressEvent, t1: /* position */ Double, t2: /* total */ Double, t3: /* percentComplete */ Double) => (value(t0, t1, t2, t3)).runNow()))
