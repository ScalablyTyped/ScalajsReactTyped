...
object mod {
  ...
  type TransformResult = typingsJapgolly.jestTypes.mod.TransformResult
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jestTransform.mod.SyncTransformer[TransformerConfig]
    - typingsJapgolly.jestTransform.mod.AsyncTransformer[TransformerConfig]
  */
  ...
  object Transformer2 {
    ...
    inline def AsyncTransformer[TransformerConfig](
      ...
      val __obj = js.Dynamic.literal(processAsync = js.Any.fromFunction3(processAsync))
      __obj.asInstanceOf[typingsJapgolly.jestTransform.mod.AsyncTransformer[TransformerConfig]]
    }
    
    inline def SyncTransformer[TransformerConfig](process: (String, String, TransformOptions[TransformerConfig]) => TransformedSource): typingsJapgolly.jestTransform.mod.SyncTransformer[TransformerConfig] = {
      val __obj = js.Dynamic.literal(process = js.Any.fromFunction3(process))
      __obj.asInstanceOf[typingsJapgolly.jestTransform.mod.SyncTransformer[TransformerConfig]]
    }
  }
