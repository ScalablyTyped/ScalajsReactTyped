...
object mod {
  ...
  object errors extends StObject {
    ...
    sealed trait correct_orientation
      extends StObject
         with errors
    /* "correct_orientation" */ val correct_orientation: typingsJapgolly.jpegAutorotate.mod.errors.correct_orientation & String = js.native
    
    @js.native
    sealed trait no_orientation
      extends StObject
         with errors
    /* "no_orientation" */ val no_orientation: typingsJapgolly.jpegAutorotate.mod.errors.no_orientation & String = js.native
    
    @js.native
    sealed trait read_exif
      extends StObject
         with errors
    /* "read_exif" */ val read_exif: typingsJapgolly.jpegAutorotate.mod.errors.read_exif & String = js.native
    
    @js.native
    sealed trait read_file
      extends StObject
         with errors
    /* "read_file" */ val read_file: typingsJapgolly.jpegAutorotate.mod.errors.read_file & String = js.native
    
    @js.native
    sealed trait rotate_file
      extends StObject
         with errors
    /* "rotate_file" */ val rotate_file: typingsJapgolly.jpegAutorotate.mod.errors.rotate_file & String = js.native
    
    @js.native
    sealed trait unknown_orientation
      extends StObject
         with errors
    /* "unknown_orientation" */ val unknown_orientation: typingsJapgolly.jpegAutorotate.mod.errors.unknown_orientation & String = js.native
  }
  ...
  inline def rotate_Promise(path_or_buffer: String, options: RotateOptions): js.Promise[typingsJapgolly.jpegAutorotate.anon.Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("rotate")(path_or_buffer.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jpegAutorotate.anon.Buffer]]
  inline def rotate_Promise(path_or_buffer: Buffer, options: RotateOptions): js.Promise[typingsJapgolly.jpegAutorotate.anon.Buffer] = (^.asInstanceOf[js.Dynamic].applyDynamic("rotate")(path_or_buffer.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jpegAutorotate.anon.Buffer]]
