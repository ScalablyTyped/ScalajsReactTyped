...
import typingsJapgolly.jsmockito.JsMockito.Verifier
import typingsJapgolly.jsmockito.anon.Instantiable
...
object global {
  ...
  object JsMockito {
    ...
    open class JsMockitoStubBuilder ()
      extends StObject
         with typingsJapgolly.jsmockito.JsMockito.JsMockitoStubBuilder {
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def `then`(func: (js.Function1[/* obj */ Any, Any])*): typingsJapgolly.jsmockito.JsMockito.JsMockitoStubBuilder = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def thenReturn(obj: Any*): typingsJapgolly.jsmockito.JsMockito.JsMockitoStubBuilder = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def thenThrow(obj: js.Error*): typingsJapgolly.jsmockito.JsMockito.JsMockitoStubBuilder = js.native
    }
