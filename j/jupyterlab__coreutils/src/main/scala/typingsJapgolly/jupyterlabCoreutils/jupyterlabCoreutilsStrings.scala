...
import typingsJapgolly.jupyterlabCoreutils.interfacesMod.IPoll._Phase
import typingsJapgolly.jupyterlabCoreutils.nbformatMod.nbformat.CellType
import typingsJapgolly.jupyterlabCoreutils.nbformatMod.nbformat.OutputType
import typingsJapgolly.jupyterlabCoreutils.nbformatMod.nbformat.StreamType
import typingsJapgolly.jupyterlabCoreutils.pollMod.Poll.Standby
import typingsJapgolly.jupyterlabCoreutils.tokensMod.ISettingRegistry.IPlugin.Phase
import typingsJapgolly.jupyterlabCoreutils.tokensMod.ISettingRegistry.Primitive
...
object jupyterlabCoreutilsStrings {
  ...
  @js.native
  sealed trait compose extends Phase
  ...
  @js.native
  sealed trait fetch extends Phase
  ...
  @js.native
  sealed trait number extends Primitive
  
  @js.native
  sealed trait `object` extends Primitive
