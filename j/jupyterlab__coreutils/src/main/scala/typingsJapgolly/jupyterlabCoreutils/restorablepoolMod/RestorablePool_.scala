package typingsJapgolly.jupyterlabCoreutils.restorablepoolMod

import typingsJapgolly.jupyterlabCoreutils.interfacesMod.IObjectPool
...
class RestorablePool_[T /* <: IObservableDisposable */] protected ()
  ...
  override def restore(options: typingsJapgolly.jupyterlabCoreutils.interfacesMod.IRestorable.IOptions[T]): js.Promise[js.Any] = js.native
  /**
