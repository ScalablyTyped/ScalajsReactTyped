...
import typingsJapgolly.jupyterlabCoreutils.anon.Download
import typingsJapgolly.jupyterlabCoreutils.libActivitymonitorMod.ActivityMonitor.IOptions
import typingsJapgolly.jupyterlabCoreutils.libPageconfigMod.PageConfig.IGetUrlOptions
import typingsJapgolly.jupyterlabCoreutils.libUrlMod.URLExt.IUrl
...
object mod {
  ...
  open class ActivityMonitor[Sender, Args] protected ()
    extends typingsJapgolly.jupyterlabCoreutils.libActivitymonitorMod.ActivityMonitor[Sender, Args] {
    /**
  ...
  object MarkdownCodeBlocks {
    ...
    open class MarkdownCodeBlock protected ()
      extends typingsJapgolly.jupyterlabCoreutils.libMarkdowncodeblocksMod.MarkdownCodeBlocks.MarkdownCodeBlock {
    ...
    inline def findMarkdownCodeBlocks(text: String): js.Array[
        typingsJapgolly.jupyterlabCoreutils.libMarkdowncodeblocksMod.MarkdownCodeBlocks.MarkdownCodeBlock
