...
import typingsJapgolly.jquery.JQuery_.Tween
import typingsJapgolly.jquery.JQuery_._PropHook
...
object AnonGet {
  ...
  def apply[TElement](get: Tween[TElement] => CallbackTo[js.Any]): AnonGet[TElement] = {
    ...
    __obj.updateDynamic("get")(js.Any.fromFunction1((t0: typingsJapgolly.jquery.JQuery_.Tween[TElement]) => get(t0).runNow()))
