...
object Tween {
  ...
  def apply[TElement](
    ...
    prop: String,
    run: Double => CallbackTo[Tween[TElement]],
    start: Double,
    unit: String,
    pos: Int | Double = null
  ): Tween[TElement] = {
    val __obj = js.Dynamic.literal(easing = easing.asInstanceOf[js.Any], elem = elem.asInstanceOf[js.Any], end = end.asInstanceOf[js.Any], now = now.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], prop = prop.asInstanceOf[js.Any], start = start.asInstanceOf[js.Any], unit = unit.asInstanceOf[js.Any])
    __obj.updateDynamic("cur")(cur.toJsFn)
    __obj.updateDynamic("run")(js.Any.fromFunction1((t0: scala.Double) => run(t0).runNow()))
