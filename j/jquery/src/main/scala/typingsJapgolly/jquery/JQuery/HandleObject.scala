...
object HandleObject {
  ...
  def apply[TTarget, TData](
    data: TData,
    handler: (TTarget, TriggeredEvent[TTarget, TData, js.Any, js.Any], /* repeated */ js.Any) => CallbackTo[js.Any],
    namespace: String,
    origType: String,
    `type`: String,
    ...
    __obj.updateDynamic("handler")(js.Any.fromFunction3((t0: TTarget, t1: typingsJapgolly.jquery.JQuery.TriggeredEvent[TTarget, TData, js.Any, js.Any], t2: /* repeated */ js.Any) => handler(t0, t1, t2).runNow()))
