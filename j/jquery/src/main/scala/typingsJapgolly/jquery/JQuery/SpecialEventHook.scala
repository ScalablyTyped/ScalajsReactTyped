...
import typingsJapgolly.jquery.Anon_HandleObj
...
trait SpecialEventHook[TTarget, TData]
  ...
  var _default: js.UndefOr[
    js.Function2[/* event */ TriggeredEvent[TTarget, TData, _, _], /* data */ TData, Unit | `false`]
  ] = js.undefined
  /**
    ...
    */
  var add: js.UndefOr[
    js.ThisFunction1[/* this */ TTarget, /* handleObj */ HandleObject[TTarget, TData], Unit]
  ] = js.undefined
  /**
  ...
  var handle: js.UndefOr[
    js.ThisFunction2[
      /* this */ TTarget, 
      /* event */ (TriggeredEvent[TTarget, TData, _, _]) with (Anon_HandleObj[TTarget, TData]), 
      /* repeated */ TData, 
      Unit
    ]
  ] = js.undefined
  ...
  var postDispatch: js.UndefOr[js.ThisFunction1[/* this */ TTarget, /* event */ Event, Unit]] = js.undefined
  var preDispatch: js.UndefOr[js.ThisFunction1[/* this */ TTarget, /* event */ Event, `false` | Unit]] = js.undefined
  /**
  ...
  /**
    ...
    */
  var teardown: js.UndefOr[js.ThisFunction0[/* this */ TTarget, Unit | `false`]] = js.undefined
  /**
  ...
  var trigger: js.UndefOr[
    js.ThisFunction2[/* this */ TTarget, /* event */ Event, /* data */ TData, Unit | `false`]
  ] = js.undefined
}
...
object SpecialEventHook {
  ...
  def apply[TTarget, TData](
    ...
    _default: (/* event */ TriggeredEvent[TTarget, TData, js.Any, js.Any], /* data */ TData) => CallbackTo[Unit | `false`] = null,
    add: js.ThisFunction1[/* this */ TTarget, /* handleObj */ HandleObject[TTarget, TData], Unit] = null,
    ...
    noBubble: js.UndefOr[Boolean] = js.undefined,
    postDispatch: js.ThisFunction1[/* this */ TTarget, /* event */ Event, Unit] = null,
    preDispatch: js.ThisFunction1[/* this */ TTarget, /* event */ Event, `false` | Unit] = null,
    remove: js.ThisFunction1[/* this */ TTarget, /* handleObj */ HandleObject[TTarget, TData], Unit] = null,
    ...
    teardown: js.ThisFunction0[/* this */ TTarget, Unit | `false`] = null,
    trigger: js.ThisFunction2[/* this */ TTarget, /* event */ Event, /* data */ TData, Unit | `false`] = null
  ): SpecialEventHook[TTarget, TData] = {
    val __obj = js.Dynamic.literal()
    if (StringDictionary != null) js.Dynamic.global.Object.assign(__obj, StringDictionary)
    if (_default != null) __obj.updateDynamic("_default")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.jquery.JQuery.TriggeredEvent[TTarget, TData, js.Any, js.Any], t1: /* data */ TData) => _default(t0, t1).runNow()))
    if (add != null) __obj.updateDynamic("add")(add.asInstanceOf[js.Any])
    if (bindType != null) __obj.updateDynamic("bindType")(bindType.asInstanceOf[js.Any])
    if (delegateType != null) __obj.updateDynamic("delegateType")(delegateType.asInstanceOf[js.Any])
    if (handle != null) __obj.updateDynamic("handle")(handle.asInstanceOf[js.Any])
    if (!js.isUndefined(noBubble)) __obj.updateDynamic("noBubble")(noBubble.asInstanceOf[js.Any])
    if (postDispatch != null) __obj.updateDynamic("postDispatch")(postDispatch.asInstanceOf[js.Any])
    if (preDispatch != null) __obj.updateDynamic("preDispatch")(preDispatch.asInstanceOf[js.Any])
