...
package object JQuery {
  ...
  import typingsJapgolly.jquery.Anon_0
  import typingsJapgolly.jquery.jqueryStrings.get
  import typingsJapgolly.jquery.jqueryStrings.left
  import typingsJapgolly.jquery.jqueryStrings.set
  import typingsJapgolly.jquery.jqueryStrings.top
  ...
  */
  ...
  {[ TType in keyof jquery.JQuery.TypeToTriggeredEventMap<TDelegateTarget, TData, TCurrentTarget, TTarget> ]:? jquery.JQuery.TypeEventHandler<TDelegateTarget, TData, TCurrentTarget, TTarget, TType> | false | object}
    */ typingsJapgolly.jquery.jqueryStrings._TypeEventHandlers with js.Any
  /**
