...
object _ValHook {
  @scala.inline
  def Anon_Elem[TElement](get: TElement => CallbackTo[js.Any]): _ValHook[TElement] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("get")(js.Any.fromFunction1((t0: TElement) => get(t0).runNow()))
    __obj.asInstanceOf[_ValHook[TElement]]
  }
  @scala.inline
  def Anon_ElemSet[TElement](set: (TElement, js.Any) => CallbackTo[js.Any]): _ValHook[TElement] = {
    val __obj = js.Dynamic.literal()
