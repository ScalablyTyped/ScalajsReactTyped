...
import typingsJapgolly.jquery.AnonHandleObj
...
object _SpecialEventHook {
  ...
  def AnonHandle[TTarget, TData](
    ...
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("handle")(js.Any.fromFunction2((t0: (typingsJapgolly.jquery.JQuery_.TriggeredEvent[TTarget, TData, js.Any, js.Any]) with (typingsJapgolly.jquery.AnonHandleObj[TTarget, TData]), t1: /* repeated */ TData) => handle(t0, t1).runNow()))
    __obj.asInstanceOf[_SpecialEventHook[TTarget, TData]]
  }
  @scala.inline
  ...
  def AnonTrigger[TTarget, TData](trigger: (Event, TData) => CallbackTo[Unit | `false`]): _SpecialEventHook[TTarget, TData] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("trigger")(js.Any.fromFunction2((t0: typingsJapgolly.jquery.JQuery_.Event, t1: TData) => trigger(t0, t1).runNow()))
    __obj.asInstanceOf[_SpecialEventHook[TTarget, TData]]
  }
  @scala.inline
  def AnonRemove[TTarget, TData](remove: HandleObject[TTarget, TData] => Callback): _SpecialEventHook[TTarget, TData] = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("remove")(js.Any.fromFunction1((t0: typingsJapgolly.jquery.JQuery_.HandleObject[TTarget, TData]) => remove(t0).runNow()))
    __obj.asInstanceOf[_SpecialEventHook[TTarget, TData]]
  }
  @scala.inline
