...
import typingsJapgolly.jquery.JQuery_.Ajax.ErrorTextStatus
import typingsJapgolly.jquery.JQuery_.Ajax.StatusCodeCallbacks
import typingsJapgolly.jquery.JQuery_.Ajax.SuccessTextStatus
import typingsJapgolly.jquery.JQuery_.Ajax.TextStatus
import typingsJapgolly.jquery.JQuery_.Deferred.Callback3
import typingsJapgolly.jquery.JQuery_.Deferred.CallbackBase
import typingsJapgolly.jquery.jqueryStrings.pending
import typingsJapgolly.jquery.jqueryStrings.rejected
import typingsJapgolly.jquery.jqueryStrings.resolved
...
trait jqXHR[TResolve] extends js.Object {
  ...
  val toStringTag: typingsJapgolly.jquery.jqueryStrings.Promise = js.native
  ...
  def `then`[TResult1, TResult2](onfulfilled: js.Function1[/* value */ TResolve, TResult1 | js.Thenable[TResult1]]): _Promise[TResult1 | TResult2] = js.native
  def `then`[TResult1, TResult2](
  ...
  @JSName("then")
  def then_TResult1TResult2_Thenable[TResult1, TResult2](onfulfilled: js.Function1[/* value */ TResolve, TResult1 | js.Thenable[TResult1]]): js.Thenable[TResult1 | TResult2] = js.native
  @JSName("then")
