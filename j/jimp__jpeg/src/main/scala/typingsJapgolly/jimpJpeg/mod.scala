...
import typingsJapgolly.jimpJpeg.anon.Imagejpeg
import typingsJapgolly.jimpJpeg.anon.ImagejpegDecoderFn
import typingsJapgolly.jimpJpeg.anon.ImagejpegEncoderFn
import typingsJapgolly.jimpJpeg.anon.MIMEJPEG
