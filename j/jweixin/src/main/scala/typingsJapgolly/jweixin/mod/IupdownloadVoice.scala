...
object IupdownloadVoice {
  ...
  inline def apply(isShowProgressTips: Double, localId: String, success: Resouce => Callback): IupdownloadVoice = {
    val __obj = js.Dynamic.literal(isShowProgressTips = isShowProgressTips.asInstanceOf[js.Any], localId = localId.asInstanceOf[js.Any], success = js.Any.fromFunction1((t0: Resouce) => success(t0).runNow()))
