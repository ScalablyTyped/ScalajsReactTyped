...
object IchooseWXPay {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(nonceStr = nonceStr.asInstanceOf[js.Any], paySign = paySign.asInstanceOf[js.Any], signType = signType.asInstanceOf[js.Any], success = js.Any.fromFunction1((t0: Any) => success(t0).runNow()), timestamp = timestamp.asInstanceOf[js.Any])
