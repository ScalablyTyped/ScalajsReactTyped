...
object IdownloadImage {
  ...
  inline def apply(isShowProgressTips: Double, serverId: String, success: Resouce => Callback): IdownloadImage = {
    val __obj = js.Dynamic.literal(isShowProgressTips = isShowProgressTips.asInstanceOf[js.Any], serverId = serverId.asInstanceOf[js.Any], success = js.Any.fromFunction1((t0: Resouce) => success(t0).runNow()))
