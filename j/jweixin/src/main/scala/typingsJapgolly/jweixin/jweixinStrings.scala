...
import typingsJapgolly.jweixin.mod.ApiMethod
import typingsJapgolly.jweixin.mod.ImageSizeType
import typingsJapgolly.jweixin.mod.ImageSourceType
import typingsJapgolly.jweixin.mod.VideoSourceType
import typingsJapgolly.jweixin.mod.menuBase
import typingsJapgolly.jweixin.mod.menuProtected
import typingsJapgolly.jweixin.mod.menuShare
import typingsJapgolly.jweixin.mod.networkType
import typingsJapgolly.jweixin.mod.scanType
