...
object mod {
  ...
  inline def And(name: js.RegExp, callback: CallBack): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("And")(name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def But(name: js.RegExp, callback: CallBack): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("But")(name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def Given(name: js.RegExp, callback: CallBack): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("Given")(name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def Then(name: js.RegExp, callback: CallBack): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("Then")(name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def When(name: js.RegExp, callback: CallBack): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("When")(name.asInstanceOf[js.Any], callback.asInstanceOf[js.Any])).asInstanceOf[Unit]
