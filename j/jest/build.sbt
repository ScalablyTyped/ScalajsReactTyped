...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "jest-changed-files" % "29.2.0-0b3e96",
  ...
  "org.scalablytyped.japgolly" %%% "jest-runner" % "29.2.0-f116c2",
  "org.scalablytyped.japgolly" %%% "jest-watcher" % "29.2.0-7179db",
  "org.scalablytyped.japgolly" %%% "jest__console" % "29.2.0-e4f0b3",
  "org.scalablytyped.japgolly" %%% "jest__core" % "29.2.0-749389",
  "org.scalablytyped.japgolly" %%% "jest__reporters" % "29.2.0-44d594",
