...
trait Matchers[R, T] extends js.Object {
  ...
  {[ P in keyof T ]: any}
    */ typingsJapgolly.jest.jestStrings.Matchers with js.Any */](propertyMatchers: Partial[U]): R = js.native
  def toMatchInlineSnapshot[U /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: any}
    */ typingsJapgolly.jest.jestStrings.Matchers with js.Any */](propertyMatchers: Partial[U], snapshot: String): R = js.native
  /**
  ...
  def toMatchSnapshot[U /* <: /* import warning: importer.ImportType#apply c Unsupported type mapping: 
  {[ P in keyof T ]: any}
    */ typingsJapgolly.jest.jestStrings.Matchers with js.Any */](propertyMatchers: Partial[U], snapshotName: String): R = js.native
  /**
