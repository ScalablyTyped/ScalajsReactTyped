...
import typingsJapgolly.jest.jestNumbers.`0`
import typingsJapgolly.jest.jestNumbers.`1`
import typingsJapgolly.jest.jestNumbers.`2`
import typingsJapgolly.jest.jestNumbers.`3`
