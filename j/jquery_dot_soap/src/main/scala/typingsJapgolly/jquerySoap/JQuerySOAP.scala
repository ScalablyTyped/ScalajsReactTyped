...
object JQuerySOAP {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setBeforeSend(value: /* SOAPEnvelope */ SOAPEnvelope => Callback): Self = StObject.set(x, "beforeSend", js.Any.fromFunction1((t0: /* SOAPEnvelope */ SOAPEnvelope) => value(t0).runNow()))
      ...
      inline def setError(value: /* SOAPResponse */ SOAPResponse => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: /* SOAPResponse */ SOAPResponse) => value(t0).runNow()))
      ...
      inline def setRequest(value: /* SOAPEnvelope */ SOAPEnvelope => Callback): Self = StObject.set(x, "request", js.Any.fromFunction1((t0: /* SOAPEnvelope */ SOAPEnvelope) => value(t0).runNow()))
      ...
      inline def setSuccess(value: /* SOAPResponse */ SOAPResponse => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* SOAPResponse */ SOAPResponse) => value(t0).runNow()))
  ...
  object SOAPResponse {
    ...
    inline def apply(toJSON: CallbackTo[Any], toXML: CallbackTo[XMLDocument]): SOAPResponse = {
      val __obj = js.Dynamic.literal(toJSON = toJSON.toJsFn, toXML = toXML.toJsFn)
    ...
    extension [Self <: SOAPResponse](x: Self) {
      ...
      inline def setToXML(value: CallbackTo[XMLDocument]): Self = StObject.set(x, "toXML", value.toJsFn)
    }
  }
}
