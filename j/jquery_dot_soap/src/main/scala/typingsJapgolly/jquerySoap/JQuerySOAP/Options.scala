...
object Options {
  ...
  def apply(
    ...
    if (beforeSend != null) __obj.updateDynamic("beforeSend")(js.Any.fromFunction1((t0: /* SOAPEnvelope */ typingsJapgolly.jquerySoap.JQuerySOAP.SOAPEnvelope) => beforeSend(t0).runNow()))
    ...
    if (error != null) __obj.updateDynamic("error")(js.Any.fromFunction1((t0: /* SOAPResponse */ typingsJapgolly.jquerySoap.JQuerySOAP.SOAPResponse) => error(t0).runNow()))
    ...
    if (request != null) __obj.updateDynamic("request")(js.Any.fromFunction1((t0: /* SOAPEnvelope */ typingsJapgolly.jquerySoap.JQuerySOAP.SOAPEnvelope) => request(t0).runNow()))
    if (!js.isUndefined(soap12)) __obj.updateDynamic("soap12")(soap12.asInstanceOf[js.Any])
    if (statusCode != null) __obj.updateDynamic("statusCode")(statusCode.asInstanceOf[js.Any])
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* SOAPResponse */ typingsJapgolly.jquerySoap.JQuerySOAP.SOAPResponse) => success(t0).runNow()))
