...
import typingsJapgolly.jupyterlabDocprovider.libYproviderMod.WebSocketProviderWithLocks.IOptions
...
object mod {
  ...
  @js.native
  val IDocumentProviderFactory: Token[typingsJapgolly.jupyterlabDocprovider.libTokensMod.IDocumentProviderFactory] = js.native
  
  @JSImport("@jupyterlab/docprovider", "ProviderMock")
  @js.native
  open class ProviderMock ()
    extends typingsJapgolly.jupyterlabDocprovider.libMockMod.ProviderMock
  
  @JSImport("@jupyterlab/docprovider", "WebSocketProviderWithLocks")
  @js.native
  open class WebSocketProviderWithLocks protected ()
    extends typingsJapgolly.jupyterlabDocprovider.libYproviderMod.WebSocketProviderWithLocks {
    /**
