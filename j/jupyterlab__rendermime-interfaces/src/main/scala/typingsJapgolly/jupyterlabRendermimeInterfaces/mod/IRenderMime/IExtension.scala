...
import typingsJapgolly.jupyterlabRendermimeInterfaces.jupyterlabRendermimeInterfacesStrings.json
import typingsJapgolly.jupyterlabRendermimeInterfaces.jupyterlabRendermimeInterfacesStrings.string
