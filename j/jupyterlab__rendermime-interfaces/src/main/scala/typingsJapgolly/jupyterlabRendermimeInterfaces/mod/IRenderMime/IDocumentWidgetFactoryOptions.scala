...
object IDocumentWidgetFactoryOptions {
  ...
  def apply(
    ...
    toolbarFactory: /* widget */ IRenderer => CallbackTo[js.Array[IToolbarItem]] = null
    ...
    if (toolbarFactory != null) __obj.updateDynamic("toolbarFactory")(js.Any.fromFunction1((t0: /* widget */ typingsJapgolly.jupyterlabRendermimeInterfaces.mod.IRenderMime.IRenderer) => toolbarFactory(t0).runNow()))
