...
object IMimeModel {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], metadata = metadata.asInstanceOf[js.Any], setData = js.Any.fromFunction1((t0: ISetDataOptions) => setData(t0).runNow()), trusted = trusted.asInstanceOf[js.Any])
  ...
  extension [Self <: IMimeModel](x: Self) {
    ...
    inline def setSetData(value: ISetDataOptions => Callback): Self = StObject.set(x, "setData", js.Any.fromFunction1((t0: ISetDataOptions) => value(t0).runNow()))
