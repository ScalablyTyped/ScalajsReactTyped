...
import typingsJapgolly.jqueryMousewheel.anon.AdjustOldDeltas
import typingsJapgolly.jqueryMousewheel.jqueryMousewheelStrings.mousewheel
import typingsJapgolly.jqueryMousewheel.mod.global.JQueryMousewheel.JQueryMousewheelEventData
import typingsJapgolly.jqueryMousewheel.mod.global.JQueryMousewheel.JQueryMousewheelEventHandler
import typingsJapgolly.jqueryMousewheel.mod.global.JQueryMousewheel.JQueryMousewheelEventHook
import typingsJapgolly.jqueryMousewheel.mod.global.JQueryMousewheel.JQueryMousewheelEventObject
  ...
  object global {
    ...
    object JQuery {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(mousewheel = js.Any.fromFunction1(mousewheel), on = js.Any.fromFunction2(on), unmousewheel = unmousewheel.toJsFn)
      ...
      extension [Self <: JQuery](x: Self) {
        ...
        inline def setUnmousewheel(value: CallbackTo[JQuery]): Self = StObject.set(x, "unmousewheel", value.toJsFn)
      }
