...
import typingsJapgolly.jestJasmine2.suiteMod.default
...
trait AnonAddReporter extends js.Object {
  ...
  def it(
    description: String,
    fn: js.Function1[/* done */ js.Function1[/* error */ js.UndefOr[js.Any], Unit], Unit]
  ): typingsJapgolly.jestJasmine2.specMod.default = js.native
  def it(
    description: String,
    fn: js.Function1[/* done */ js.Function1[/* error */ js.UndefOr[js.Any], Unit], Unit],
    timeout: Double
  ...
  def specFilter(spec: typingsJapgolly.jestJasmine2.specMod.default): Boolean = js.native
  ...
  def todo(): typingsJapgolly.jestJasmine2.specMod.default = js.native
