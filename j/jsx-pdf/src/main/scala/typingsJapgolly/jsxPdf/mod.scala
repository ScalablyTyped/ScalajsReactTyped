...
import typingsJapgolly.jsxPdf.anon.Content
import typingsJapgolly.jsxPdf.anon.EleNoChidlrenOmitContentI
import typingsJapgolly.jsxPdf.anon.EleNoChidlrenOmitContentQ
import typingsJapgolly.jsxPdf.anon.EleOmitContentColumnscolu
import typingsJapgolly.jsxPdf.anon.EleOmitContentOrderedList
import typingsJapgolly.jsxPdf.anon.EleOmitContentStackstack
import typingsJapgolly.jsxPdf.anon.EleOmitContentTabletableO
import typingsJapgolly.jsxPdf.anon.EleOmitContentTexttext
import typingsJapgolly.jsxPdf.anon.EleOmitContentUnorderedLi
import typingsJapgolly.jsxPdf.anon.EleOmitTDocumentDefinitio
import typingsJapgolly.jsxPdf.anon.Elewidthnumberstring
  ...
  object global {
    ...
    object JSX {
      ...
      trait IntrinsicElements extends StObject {
        ...
        var content: typingsJapgolly.jsxPdf.anon.Ele
        
        var document: EleOmitTDocumentDefinitio
        
        var footer: typingsJapgolly.jsxPdf.anon.Ele
        
        var header: typingsJapgolly.jsxPdf.anon.Ele
      ...
      object IntrinsicElements {
        ...
        inline def apply(
          ...
          content: typingsJapgolly.jsxPdf.anon.Ele,
          document: EleOmitTDocumentDefinitio,
          footer: typingsJapgolly.jsxPdf.anon.Ele,
          header: typingsJapgolly.jsxPdf.anon.Ele,
        ...
        extension [Self <: IntrinsicElements](x: Self) {
          ...
          inline def setContent(value: typingsJapgolly.jsxPdf.anon.Ele): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
          
          inline def setDocument(value: EleOmitTDocumentDefinitio): Self = StObject.set(x, "document", value.asInstanceOf[js.Any])
          
          inline def setFooter(value: typingsJapgolly.jsxPdf.anon.Ele): Self = StObject.set(x, "footer", value.asInstanceOf[js.Any])
          
          inline def setHeader(value: typingsJapgolly.jsxPdf.anon.Ele): Self = StObject.set(x, "header", value.asInstanceOf[js.Any])
