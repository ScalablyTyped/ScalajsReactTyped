...
object Settings {
  ...
  extension [Self <: Settings](x: Self) {
    ...
    inline def setRegisterEntity(value: Any => Callback): Self = StObject.set(x, "registerEntity", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
