...
import typingsJapgolly.jsreportCore.AnonAllowedModules
import typingsJapgolly.jsreportCore.AnonSilent
import typingsJapgolly.jsreportCore.PartialallowedModulesArra
