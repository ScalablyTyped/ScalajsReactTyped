...
import typingsJapgolly.jsforce.AnonCallCallback
import typingsJapgolly.jsforce.AnonCallCallbackClear
import typingsJapgolly.jsforce.AnonCallClear
import typingsJapgolly.jsforce.AnonCallLayoutNameCallback
import typingsJapgolly.jsforce.AnonExtIdField
...
class SObject[T] () extends js.Object {
  ...
  {[ P in keyof T ]: boolean}
    */ typingsJapgolly.jsforce.jsforceStrings.SObject with js.Any
