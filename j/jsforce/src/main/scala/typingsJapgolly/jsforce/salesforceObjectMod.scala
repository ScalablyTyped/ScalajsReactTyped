...
import typingsJapgolly.jsforce.anon.CallCallback
import typingsJapgolly.jsforce.anon.CallCallbackClear
import typingsJapgolly.jsforce.anon.CallClear
import typingsJapgolly.jsforce.anon.CallLayoutNameCallback
import typingsJapgolly.jsforce.anon.ExtIdField
...
import typingsJapgolly.jsforce.quickActionMod.QuickActionInfo
import typingsJapgolly.jsforce.recordMod.Record
import typingsJapgolly.jsforce.recordMod.RecordReference
...
object salesforceObjectMod {
  ...
  open class QuickAction ()
    extends typingsJapgolly.jsforce.quickActionMod.QuickAction
  ...
  open class SObject[T] () extends StObject {
    ...
    def quickAction(actionName: String): typingsJapgolly.jsforce.quickActionMod.QuickAction = js.native
