...
object recordResultMod {
  ...
  */
  ...
  object RecordResult {
    ...
    inline def ErrorResult(errors: js.Array[Error]): typingsJapgolly.jsforce.recordResultMod.ErrorResult = {
      val __obj = js.Dynamic.literal(errors = errors.asInstanceOf[js.Any], success = false)
      __obj.asInstanceOf[typingsJapgolly.jsforce.recordResultMod.ErrorResult]
    }
    
    inline def SuccessResult(id: SalesforceId): typingsJapgolly.jsforce.recordResultMod.SuccessResult = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], success = true)
      __obj.asInstanceOf[typingsJapgolly.jsforce.recordResultMod.SuccessResult]
    }
  }
