...
import typingsJapgolly.jsforce.PartialPartialOAuth2Optio
...
object ConnectionOptions {
  ...
  def apply(
    ...
    refreshFn: (/* conn */ Connection, /* callback */ Callback[UserInfo]) => CallbackTo[js.Promise[UserInfo]] = null,
    ...
    if (refreshFn != null) __obj.updateDynamic("refreshFn")(js.Any.fromFunction2((t0: /* conn */ typingsJapgolly.jsforce.connectionMod.Connection, t1: /* callback */ typingsJapgolly.jsforce.connectionMod.Callback[typingsJapgolly.jsforce.connectionMod.UserInfo]) => refreshFn(t0, t1).runNow()))
