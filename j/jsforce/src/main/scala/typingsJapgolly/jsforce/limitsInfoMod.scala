...
object limitsInfoMod {
  ...
  trait LimitInfo extends StObject {
    ...
    var apiUsage: typingsJapgolly.jsforce.anon.Limit
  }
  object LimitInfo {
    
    inline def apply(apiUsage: typingsJapgolly.jsforce.anon.Limit): LimitInfo = {
    ...
    extension [Self <: LimitInfo](x: Self) {
      ...
      inline def setApiUsage(value: typingsJapgolly.jsforce.anon.Limit): Self = StObject.set(x, "apiUsage", value.asInstanceOf[js.Any])
    }
  }
