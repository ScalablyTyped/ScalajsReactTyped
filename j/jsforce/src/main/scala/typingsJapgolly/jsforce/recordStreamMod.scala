...
object recordStreamMod {
  ...
  open class RecordStream[T] () extends Transform {
    ...
    def filter(fn: js.Function1[/* record */ Record[T], Boolean]): Serializable[T] = js.native
    @JSName("filter")
    def filter_RecordStream(fn: js.Function1[/* record */ Record[T], Boolean]): RecordStream[T] = js.native
    
    def map(fn: js.Function1[/* record */ Record[T], Record[T]]): Serializable[T] = js.native
    @JSName("map")
    def map_RecordStream(fn: js.Function1[/* record */ Record[T], Record[T]]): RecordStream[T] = js.native
