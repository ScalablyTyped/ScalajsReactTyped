...
object WizardOptions {
  ...
  extension [Self <: WizardOptions](x: Self) {
    ...
    inline def setOnInit(value: (/* activeTab */ Any, /* navigation */ Any, /* currentIndex */ Double) => Callback): Self = StObject.set(x, "onInit", js.Any.fromFunction3((t0: /* activeTab */ Any, t1: /* navigation */ Any, t2: /* currentIndex */ Double) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOnShow(value: (/* activeTab */ Any, /* navigation */ Any, /* nextIndex */ Double) => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction3((t0: /* activeTab */ Any, t1: /* navigation */ Any, t2: /* nextIndex */ Double) => (value(t0, t1, t2)).runNow()))
