...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jxon.jxonInts.`0`
    - typingsJapgolly.jxon.jxonInts.`1`
    - typingsJapgolly.jxon.jxonInts.`2`
    - typingsJapgolly.jxon.jxonInts.`3`
  */
  trait VerbosityType extends StObject
  object VerbosityType {
    
    inline def `0`: typingsJapgolly.jxon.jxonInts.`0` = 0.asInstanceOf[typingsJapgolly.jxon.jxonInts.`0`]
    
    inline def `1`: typingsJapgolly.jxon.jxonInts.`1` = 1.asInstanceOf[typingsJapgolly.jxon.jxonInts.`1`]
    
    inline def `2`: typingsJapgolly.jxon.jxonInts.`2` = 2.asInstanceOf[typingsJapgolly.jxon.jxonInts.`2`]
    
    inline def `3`: typingsJapgolly.jxon.jxonInts.`3` = 3.asInstanceOf[typingsJapgolly.jxon.jxonInts.`3`]
  }
}
