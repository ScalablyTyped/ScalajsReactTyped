...
object JQueryStatic {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(migrateMute = migrateMute.asInstanceOf[js.Any], migrateTrace = migrateTrace.asInstanceOf[js.Any], migrateVersion = migrateVersion.asInstanceOf[js.Any], migrateWarnings = migrateWarnings.asInstanceOf[js.Any])
    __obj.updateDynamic("migrateReset")(migrateReset.toJsFn)
