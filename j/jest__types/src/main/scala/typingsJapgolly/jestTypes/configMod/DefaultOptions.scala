...
import typingsJapgolly.jestTypes.AnonGlobal
import typingsJapgolly.jestTypes.jestTypesStrings.fake
import typingsJapgolly.jestTypes.jestTypesStrings.real
