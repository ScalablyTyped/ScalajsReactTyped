...
object SerializerOptions {
  ...
  def apply(
    ...
    typeForAttribute: (/* attribute */ String, /* object */ js.UndefOr[js.Any]) => CallbackTo[js.Any] = null
  ): SerializerOptions = {
    ...
    if (typeForAttribute != null) __obj.updateDynamic("typeForAttribute")(js.Any.fromFunction2((t0: /* attribute */ java.lang.String, t1: /* object */ js.UndefOr[js.Any]) => typeForAttribute(t0, t1).runNow()))
