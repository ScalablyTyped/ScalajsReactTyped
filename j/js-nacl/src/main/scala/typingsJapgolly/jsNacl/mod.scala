package typingsJapgolly.jsNacl
...
object mod {
  ...
  object Nacl {
    ...
    inline def apply(
      ...
      crypto_box_random_nonce: CallbackTo[js.typedarray.Uint8Array],
      ...
      crypto_secretbox_random_nonce: CallbackTo[js.typedarray.Uint8Array],
    ...
    extension [Self <: Nacl](x: Self) {
      ...
      inline def setCrypto_box_keypair(value: CallbackTo[BoxKeyPair]): Self = StObject.set(x, "crypto_box_keypair", value.toJsFn)
      ...
      inline def setCrypto_box_random_nonce(value: CallbackTo[js.typedarray.Uint8Array]): Self = StObject.set(x, "crypto_box_random_nonce", value.toJsFn)
      ...
      inline def setCrypto_secretbox_random_nonce(value: CallbackTo[js.typedarray.Uint8Array]): Self = StObject.set(x, "crypto_secretbox_random_nonce", value.toJsFn)
      ...
      inline def setCrypto_sign_keypair(value: CallbackTo[SignKeyPair]): Self = StObject.set(x, "crypto_sign_keypair", value.toJsFn)
