...
import typingsJapgolly.jsdevtoolsReaddirEnhanced.jsdevtoolsReaddirEnhancedBooleans.`false`
import typingsJapgolly.jsdevtoolsReaddirEnhanced.jsdevtoolsReaddirEnhancedBooleans.`true`
import typingsJapgolly.jsdevtoolsReaddirEnhanced.libTypesPublicMod.Callback
import typingsJapgolly.jsdevtoolsReaddirEnhanced.libTypesPublicMod.FilterFunction
...
object anon {
  ...
  trait PartialFileSystem extends StObject {
    ...
    var lstat: js.UndefOr[
        js.Function2[/* path */ String, /* callback */ Callback[typingsJapgolly.node.fsMod.Stats], Unit]
      ] = js.undefined
  ...
  object PartialFileSystem {
    ...
    extension [Self <: PartialFileSystem](x: Self) {
      ...
      inline def setLstat(
        value: (/* path */ String, /* callback */ Callback[typingsJapgolly.node.fsMod.Stats]) => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "lstat", js.Any.fromFunction2((t0: /* path */ String, t1: /* callback */ Callback[typingsJapgolly.node.fsMod.Stats]) => (value(t0, t1)).runNow()))
      
      inline def setLstatUndefined: Self = StObject.set(x, "lstat", js.undefined)
      
      inline def setReaddir(
        value: (/* path */ String, /* callback */ Callback[js.Array[String]]) => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "readdir", js.Any.fromFunction2((t0: /* path */ String, t1: /* callback */ Callback[js.Array[String]]) => (value(t0, t1)).runNow()))
      
      inline def setReaddirUndefined: Self = StObject.set(x, "readdir", js.undefined)
      
      inline def setStat(
        value: (/* path */ String, /* callback */ Callback[typingsJapgolly.node.fsMod.Stats]) => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "stat", js.Any.fromFunction2((t0: /* path */ String, t1: /* callback */ Callback[typingsJapgolly.node.fsMod.Stats]) => (value(t0, t1)).runNow()))
