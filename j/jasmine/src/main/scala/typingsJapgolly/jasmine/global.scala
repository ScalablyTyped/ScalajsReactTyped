...
import typingsJapgolly.jasmine.jasmine.ArrayContaining
import typingsJapgolly.jasmine.jasmine.ArrayLikeMatchers
import typingsJapgolly.jasmine.jasmine.AsymmetricMatcher
import typingsJapgolly.jasmine.jasmine.AsyncMatchers
import typingsJapgolly.jasmine.jasmine.Clock
import typingsJapgolly.jasmine.jasmine.Constructor
import typingsJapgolly.jasmine.jasmine.CustomAsyncMatcherFactories
import typingsJapgolly.jasmine.jasmine.CustomEqualityTester
import typingsJapgolly.jasmine.jasmine.CustomMatcherFactories
import typingsJapgolly.jasmine.jasmine.CustomObjectFormatter
import typingsJapgolly.jasmine.jasmine.Env
import typingsJapgolly.jasmine.jasmine.Func
import typingsJapgolly.jasmine.jasmine.FunctionMatchers
import typingsJapgolly.jasmine.jasmine.HtmlReporter
import typingsJapgolly.jasmine.jasmine.HtmlSpecFilter
import typingsJapgolly.jasmine.jasmine.Matchers
import typingsJapgolly.jasmine.jasmine.NothingMatcher
import typingsJapgolly.jasmine.jasmine.ObjectContaining
import typingsJapgolly.jasmine.jasmine.Spy
import typingsJapgolly.jasmine.jasmine.SpyAnd
import typingsJapgolly.jasmine.jasmine.SpyObj
import typingsJapgolly.jasmine.jasmine.SpyObjMethodNames
import typingsJapgolly.jasmine.jasmine.SpyObjPropertyNames
import typingsJapgolly.jasmine.jasmineStrings.get
import typingsJapgolly.jasmine.jasmineStrings.set
...
object global {
  ...
  /**
    ...
    */
  inline def afterAll(action: typingsJapgolly.jasmine.jasmine.ImplementationCallback): Unit = js.Dynamic.global.applyDynamic("afterAll")(action.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def afterAll(action: typingsJapgolly.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = (js.Dynamic.global.applyDynamic("afterAll")(action.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def afterEach(action: typingsJapgolly.jasmine.jasmine.ImplementationCallback): Unit = js.Dynamic.global.applyDynamic("afterEach")(action.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def afterEach(action: typingsJapgolly.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = (js.Dynamic.global.applyDynamic("afterEach")(action.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def beforeAll(action: typingsJapgolly.jasmine.jasmine.ImplementationCallback): Unit = js.Dynamic.global.applyDynamic("beforeAll")(action.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def beforeAll(action: typingsJapgolly.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = (js.Dynamic.global.applyDynamic("beforeAll")(action.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def beforeEach(action: typingsJapgolly.jasmine.jasmine.ImplementationCallback): Unit = js.Dynamic.global.applyDynamic("beforeEach")(action.asInstanceOf[js.Any]).asInstanceOf[Unit]
  inline def beforeEach(action: typingsJapgolly.jasmine.jasmine.ImplementationCallback, timeout: Double): Unit = (js.Dynamic.global.applyDynamic("beforeEach")(action.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /**
    ...
    */
  inline def expect[T](actual: T): Matchers[T] = js.Dynamic.global.applyDynamic("expect")(actual.asInstanceOf[js.Any]).asInstanceOf[Matchers[T]]
  /**
    * Create an expectation for a spec.
    * @checkReturnValue see https://tsetse.info/check-return-value
    * @param actual
  ...
  /**
    ...
    * @param spy
    */
  inline def expect_T_FunctionMatchers[T /* <: Func */](spy: T): FunctionMatchers[T] = js.Dynamic.global.applyDynamic("expect")(spy.asInstanceOf[js.Any]).asInstanceOf[FunctionMatchers[T]]
  ...
  inline def fit(expectation: String, assertion: typingsJapgolly.jasmine.jasmine.ImplementationCallback): Unit = (js.Dynamic.global.applyDynamic("fit")(expectation.asInstanceOf[js.Any], assertion.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def fit(
    expectation: String,
    assertion: typingsJapgolly.jasmine.jasmine.ImplementationCallback,
    timeout: Double
  ): Unit = (js.Dynamic.global.applyDynamic("fit")(expectation.asInstanceOf[js.Any], assertion.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def it(expectation: String, assertion: typingsJapgolly.jasmine.jasmine.ImplementationCallback): Unit = (js.Dynamic.global.applyDynamic("it")(expectation.asInstanceOf[js.Any], assertion.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def it(
    expectation: String,
    assertion: typingsJapgolly.jasmine.jasmine.ImplementationCallback,
    timeout: Double
  ...
  object jasmine {
    ...
    /**
      ...
      */
    inline def DiffBuilder(): typingsJapgolly.jasmine.jasmine.DiffBuilder = ^.asInstanceOf[js.Dynamic].applyDynamic("DiffBuilder")().asInstanceOf[typingsJapgolly.jasmine.jasmine.DiffBuilder]
    
    @JSGlobal("jasmine.HtmlReporter")
    @js.native
    def HtmlReporter: typingsJapgolly.jasmine.jasmine.HtmlReporter = js.native
    ...
    @js.native
    def HtmlSpecFilter: typingsJapgolly.jasmine.jasmine.HtmlSpecFilter = js.native
    ...
    inline def arrayContaining[T](sample: typingsJapgolly.jasmine.jasmine.ArrayLike[T]): ArrayContaining[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("arrayContaining")(sample.asInstanceOf[js.Any]).asInstanceOf[ArrayContaining[T]]
    
    inline def arrayWithExactContents[T](sample: typingsJapgolly.jasmine.jasmine.ArrayLike[T]): ArrayContaining[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("arrayWithExactContents")(sample.asInstanceOf[js.Any]).asInstanceOf[ArrayContaining[T]]
    ...
    object errors {
      ...
      open class ExpectationFailed ()
        extends StObject
           with typingsJapgolly.jasmine.jasmine.errors.ExpectationFailed {
  ...
  inline def xit(expectation: String, assertion: typingsJapgolly.jasmine.jasmine.ImplementationCallback): Unit = (js.Dynamic.global.applyDynamic("xit")(expectation.asInstanceOf[js.Any], assertion.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def xit(
    expectation: String,
    assertion: typingsJapgolly.jasmine.jasmine.ImplementationCallback,
    timeout: Double
  ): Unit = (js.Dynamic.global.applyDynamic("xit")(expectation.asInstanceOf[js.Any], assertion.asInstanceOf[js.Any], timeout.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
