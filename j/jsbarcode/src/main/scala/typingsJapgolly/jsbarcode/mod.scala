package typingsJapgolly.jsbarcode
...
object mod {
  ...
  object JsBarcodeOptions {
    ...
    extension [Self <: JsBarcodeOptions](x: Self) {
      ...
      inline def setValid(value: /* valid */ Boolean => Callback): Self = StObject.set(x, "valid", js.Any.fromFunction1((t0: /* valid */ Boolean) => value(t0).runNow()))
