...
import typingsJapgolly.jsonRpcEngine.jsonRpcEngineStrings.`2Dot0`
import typingsJapgolly.metamaskSafeEventEmitter.mod.default
...
object distJsonRpcEngineMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsonRpcEngine.distJsonRpcEngineMod.JsonRpcSuccess[T]
    - typingsJapgolly.jsonRpcEngine.distJsonRpcEngineMod.JsonRpcFailure
  */
  trait JsonRpcResponse[T] extends StObject
  object JsonRpcResponse {
    
    inline def JsonRpcFailure(error: JsonRpcError, id: JsonRpcId, jsonrpc: JsonRpcVersion): typingsJapgolly.jsonRpcEngine.distJsonRpcEngineMod.JsonRpcFailure = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], jsonrpc = jsonrpc.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonRpcEngine.distJsonRpcEngineMod.JsonRpcFailure]
    }
    
    inline def JsonRpcSuccess[T](id: JsonRpcId, jsonrpc: JsonRpcVersion): typingsJapgolly.jsonRpcEngine.distJsonRpcEngineMod.JsonRpcSuccess[T] = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], jsonrpc = jsonrpc.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonRpcEngine.distJsonRpcEngineMod.JsonRpcSuccess[T]]
    }
  }
