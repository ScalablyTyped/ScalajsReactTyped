...
import typingsJapgolly.jsonRpcEngine.distCreateAsyncMiddlewareMod.AsyncJsonrpcMiddleware
import typingsJapgolly.jsonRpcEngine.distCreateScaffoldMiddlewareMod.ScaffoldMiddlewareHandler
...
object distMod {
  ...
  open class JsonRpcEngine ()
    extends typingsJapgolly.jsonRpcEngine.distJsonRpcEngineMod.JsonRpcEngine
  /* static members */
