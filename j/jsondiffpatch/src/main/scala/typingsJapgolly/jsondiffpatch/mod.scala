package typingsJapgolly.jsondiffpatch

import org.scalablytyped.runtime.NumberDictionary
import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.Element
import typingsJapgolly.jsondiffpatch.anon.DetectMove
import typingsJapgolly.jsondiffpatch.anon.Diff
import typingsJapgolly.jsondiffpatch.anon.MinLength
import typingsJapgolly.jsondiffpatch.jsondiffpatchStrings.diff
import typingsJapgolly.jsondiffpatch.jsondiffpatchStrings.patch
import typingsJapgolly.jsondiffpatch.jsondiffpatchStrings.reverse
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsondiffpatch.mod.PatchContext
    - typingsJapgolly.jsondiffpatch.mod.DiffContext
    - typingsJapgolly.jsondiffpatch.mod.ReverseContext
  */
