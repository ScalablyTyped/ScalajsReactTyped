...
import typingsJapgolly.jsData.mod.Mapper
import typingsJapgolly.jsData.mod.Record
...
object anon {
  ...
  object AllOf {
    ...
    inline def apply(
      ...
      dependencies: (Any, Any, Any) => Callback,
    ...
    extension [Self <: AllOf](x: Self) {
      ...
      inline def setDependencies(value: (Any, Any, Any) => Callback): Self = StObject.set(x, "dependencies", js.Any.fromFunction3((t0: Any, t1: Any, t2: Any) => (value(t0, t1, t2)).runNow()))
