...
import typingsJapgolly.jsreportChromePdf.anon.Bottom
import typingsJapgolly.jsreportChromePdf.anon.Height
import typingsJapgolly.jsreportChromePdf.anon.PartialChrome
import typingsJapgolly.jsreportChromePdf.anon.PartialChromeImage
import typingsJapgolly.jsreportChromePdf.anon.PartialLaunchOptions
import typingsJapgolly.jsreportChromePdf.anon.PartialOptions
import typingsJapgolly.jsreportChromePdf.anon.Partialwidthstringheights
...
object mod {
  ...
  object jsreportCoreAugmentingMod {
    ...
    trait TemplateRegistry extends StObject {
      ...
      var ChromeTemplate: typingsJapgolly.jsreportChromePdf.mod.ChromeTemplate
    }
