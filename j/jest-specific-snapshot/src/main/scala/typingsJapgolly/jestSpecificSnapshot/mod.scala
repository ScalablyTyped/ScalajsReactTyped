...
import typingsJapgolly.jestSpecificSnapshot.anon.Message
...
object mod {
  ...
  inline def addSerializer(serializer: Any): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("addSerializer")(serializer.asInstanceOf[js.Any]).asInstanceOf[Unit]
  
  inline def toMatchSpecificSnapshot(data: Any, snapshotFile: String, testName: String): js.Function0[Message] = (^.asInstanceOf[js.Dynamic].applyDynamic("toMatchSpecificSnapshot")(data.asInstanceOf[js.Any], snapshotFile.asInstanceOf[js.Any], testName.asInstanceOf[js.Any])).asInstanceOf[js.Function0[Message]]
