...
object mod {
  ...
  object RandomGenerator {
    ...
    inline def apply(nextBytes: js.Array[Double] => Callback): RandomGenerator = {
      val __obj = js.Dynamic.literal(nextBytes = js.Any.fromFunction1((t0: js.Array[Double]) => nextBytes(t0).runNow()))
      __obj.asInstanceOf[RandomGenerator]
    }
    
    extension [Self <: RandomGenerator](x: Self) {
      
      inline def setNextBytes(value: js.Array[Double] => Callback): Self = StObject.set(x, "nextBytes", js.Any.fromFunction1((t0: js.Array[Double]) => value(t0).runNow()))
    }
  }
  ...
  object Reduction {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(convert = js.Any.fromFunction1(convert), mulTo = js.Any.fromFunction3((t0: BigInteger, t1: BigInteger, t2: BigInteger) => (mulTo(t0, t1, t2)).runNow()), reduce = js.Any.fromFunction1((t0: BigInteger) => reduce(t0).runNow()), revert = js.Any.fromFunction1(revert), sqrTo = js.Any.fromFunction2((t0: BigInteger, t1: BigInteger) => (sqrTo(t0, t1)).runNow()))
    ...
    extension [Self <: Reduction](x: Self) {
      ...
      inline def setMulTo(value: (BigInteger, BigInteger, BigInteger) => Callback): Self = StObject.set(x, "mulTo", js.Any.fromFunction3((t0: BigInteger, t1: BigInteger, t2: BigInteger) => (value(t0, t1, t2)).runNow()))
      
      inline def setReduce(value: BigInteger => Callback): Self = StObject.set(x, "reduce", js.Any.fromFunction1((t0: BigInteger) => value(t0).runNow()))
      
      inline def setRevert(value: BigInteger => BigInteger): Self = StObject.set(x, "revert", js.Any.fromFunction1(value))
      
      inline def setSqrTo(value: (BigInteger, BigInteger) => Callback): Self = StObject.set(x, "sqrTo", js.Any.fromFunction2((t0: BigInteger, t1: BigInteger) => (value(t0, t1)).runNow()))
    }
  }
}
