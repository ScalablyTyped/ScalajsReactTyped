...
import typingsJapgolly.jupyterlabTranslation.libBaseMod.NullTranslator_
...
object mod {
  ...
  @js.native
  val ITranslator: Token[typingsJapgolly.jupyterlabTranslation.libTokensMod.ITranslator] = js.native
  
  @JSImport("@jupyterlab/translation", "ITranslatorConnector")
  @js.native
  val ITranslatorConnector: Token[typingsJapgolly.jupyterlabTranslation.libTokensMod.ITranslatorConnector] = js.native
  
  @JSImport("@jupyterlab/translation", "TranslationManager")
  @js.native
  open class TranslationManager ()
    extends typingsJapgolly.jupyterlabTranslation.libManagerMod.TranslationManager {
  ...
  open class TranslatorConnector ()
    extends typingsJapgolly.jupyterlabTranslation.libTokensMod.TranslatorConnector {
    def this(translationsUrl: String) = this()
