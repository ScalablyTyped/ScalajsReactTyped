...
object libTokensMod {
  ...
  type ITranslatorConnector = IDataConnector[Language, Language, typingsJapgolly.jupyterlabTranslation.anon.Language, String]
  
  @JSImport("@jupyterlab/translation/lib/tokens", "TranslatorConnector")
  @js.native
  open class TranslatorConnector ()
    extends DataConnector[Language, Language, typingsJapgolly.jupyterlabTranslation.anon.Language, String] {
