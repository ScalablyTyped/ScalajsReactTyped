...
object libGettextMod {
  ...
  object Gettext {
    ...
    inline def apply(
      ...
      expandLocale: Any,
      getContextDelimiter: CallbackTo[String],
      getDomain: CallbackTo[String],
      getLocale: CallbackTo[String],
      getPluralFunc: Any,
      getStringsPrefix: CallbackTo[String],
      gettext: (String, /* repeated */ Any) => String,
      loadJSON: (IJsonData, String) => Callback,
      ...
      removeContext: Any,
      setContextDelimiter: String => Callback,
      setDomain: String => Callback,
      setLocale: String => Callback,
      setMessages: Any,
      setStringsPrefix: String => Callback,
      t: Any
    ): Gettext = {
      val __obj = js.Dynamic.literal(__ = js.Any.fromFunction2(__), _contextDelimiter = _contextDelimiter.asInstanceOf[js.Any], _defaults = _defaults.asInstanceOf[js.Any], _dictionary = _dictionary.asInstanceOf[js.Any], _domain = _domain.asInstanceOf[js.Any], _locale = _locale.asInstanceOf[js.Any], _n = js.Any.fromFunction4(_n), _np = js.Any.fromFunction5(_np), _p = js.Any.fromFunction3(_p), _pluralForms = _pluralForms.asInstanceOf[js.Any], _pluralFuncs = _pluralFuncs.asInstanceOf[js.Any], _stringsPrefix = _stringsPrefix.asInstanceOf[js.Any], dcnpgettext = js.Any.fromFunction6(dcnpgettext), expandLocale = expandLocale.asInstanceOf[js.Any], getContextDelimiter = getContextDelimiter.toJsFn, getDomain = getDomain.toJsFn, getLocale = getLocale.toJsFn, getPluralFunc = getPluralFunc.asInstanceOf[js.Any], getStringsPrefix = getStringsPrefix.toJsFn, gettext = js.Any.fromFunction2(gettext), loadJSON = js.Any.fromFunction2((t0: IJsonData, t1: String) => (loadJSON(t0, t1)).runNow()), ngettext = js.Any.fromFunction4(ngettext), npgettext = js.Any.fromFunction5(npgettext), pgettext = js.Any.fromFunction3(pgettext), removeContext = removeContext.asInstanceOf[js.Any], setContextDelimiter = js.Any.fromFunction1((t0: String) => setContextDelimiter(t0).runNow()), setDomain = js.Any.fromFunction1((t0: String) => setDomain(t0).runNow()), setLocale = js.Any.fromFunction1((t0: String) => setLocale(t0).runNow()), setMessages = setMessages.asInstanceOf[js.Any], setStringsPrefix = js.Any.fromFunction1((t0: String) => setStringsPrefix(t0).runNow()), t = t.asInstanceOf[js.Any])
    ...
    extension [Self <: Gettext](x: Self) {
      ...
      inline def setGetContextDelimiter(value: CallbackTo[String]): Self = StObject.set(x, "getContextDelimiter", value.toJsFn)
      ...
      inline def setGetStringsPrefix(value: CallbackTo[String]): Self = StObject.set(x, "getStringsPrefix", value.toJsFn)
      
      inline def setGettext(value: (String, /* repeated */ Any) => String): Self = StObject.set(x, "gettext", js.Any.fromFunction2(value))
      
      inline def setLoadJSON(value: (IJsonData, String) => Callback): Self = StObject.set(x, "loadJSON", js.Any.fromFunction2((t0: IJsonData, t1: String) => (value(t0, t1)).runNow()))
      ...
      inline def setSetContextDelimiter(value: String => Callback): Self = StObject.set(x, "setContextDelimiter", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setSetDomain(value: String => Callback): Self = StObject.set(x, "setDomain", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      ...
      inline def setSetStringsPrefix(value: String => Callback): Self = StObject.set(x, "setStringsPrefix", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
