...
import typingsJapgolly.jsend.anon.Code
import typingsJapgolly.jsend.anon.Strict
...
object jsend {
  ...
  trait jsendExport
    extends StObject
       with typingsJapgolly.jsend.jsend.jsend {
    
    def apply(): typingsJapgolly.jsend.jsend.jsend = js.native
    def apply(config: Unit, host: js.Object): typingsJapgolly.jsend.jsend.jsend = js.native
    def apply(config: Strict): typingsJapgolly.jsend.jsend.jsend = js.native
    def apply(config: Strict, host: js.Object): typingsJapgolly.jsend.jsend.jsend = js.native
  }
