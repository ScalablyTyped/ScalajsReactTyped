package typingsJapgolly.jsToJava
...
object mod {
  ...
  object array {
    ...
    inline def Currency(value: js.Array[Null | String | typingsJapgolly.jsToJava.mod.Currency]): js.Object = ^.asInstanceOf[js.Dynamic].applyDynamic("Currency")(value.asInstanceOf[js.Any]).asInstanceOf[js.Object]
