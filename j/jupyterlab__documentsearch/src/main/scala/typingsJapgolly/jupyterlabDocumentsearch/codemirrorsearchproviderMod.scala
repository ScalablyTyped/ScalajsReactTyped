...
import typingsJapgolly.jupyterlabCodemirror.mod.CodeMirrorEditor
import typingsJapgolly.jupyterlabDocumentsearch.interfacesMod.ISearchMatch
import typingsJapgolly.jupyterlabDocumentsearch.interfacesMod.ISearchProvider
import typingsJapgolly.jupyterlabDocumentsearch.jupyterlabDocumentsearchBooleans.`false`
import typingsJapgolly.jupyterlabFileeditor.mod.FileEditor
...
import typingsJapgolly.phosphorWidgets.layoutMod.Layout
...
import typingsJapgolly.phosphorWidgets.widgetMod.Widget.Flag
...
object codemirrorsearchproviderMod extends js.Object {
  ...
  trait CMMainAreaWidget extends js.Object {
    ...
    /**
      ...
      */
    val toolbar: Toolbar[typingsJapgolly.phosphorWidgets.mod.Widget] = js.native
    /**
  ...
  class CodeMirrorSearchProvider () extends ISearchProvider[CMMainAreaWidget] {
    ...
    /**
      ...
      * @returns A promise that resolves with a list of all matches
      */
    def startQuery(query: js.RegExp, searchTarget: typingsJapgolly.phosphorWidgets.mod.Widget): js.Promise[js.Array[ISearchMatch]] = js.native
    /**
  ...
  object CodeMirrorSearchProvider extends js.Object {
    /**
      ...
      */
    def canSearchOn(domain: typingsJapgolly.phosphorWidgets.mod.Widget): /* is @jupyterlab/documentsearch.@jupyterlab/documentsearch/lib/providers/codemirrorsearchprovider.CMMainAreaWidget */ Boolean = js.native
  }
