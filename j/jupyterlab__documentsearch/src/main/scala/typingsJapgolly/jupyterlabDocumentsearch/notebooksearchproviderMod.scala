...
import typingsJapgolly.jupyterlabNotebook.mod.NotebookPanel
...
object notebooksearchproviderMod extends js.Object {
  ...
  class NotebookSearchProvider () extends ISearchProvider[NotebookPanel] {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def startQuery(query: js.RegExp, searchTarget: NotebookPanel): js.Promise[js.Array[ISearchMatch]] = js.native
  }
