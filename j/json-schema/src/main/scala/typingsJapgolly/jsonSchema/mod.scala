...
object mod {
  ...
  */
  ...
  object JSONSchema4TypeName {
    ...
    inline def any: typingsJapgolly.jsonSchema.jsonSchemaStrings.any = "any".asInstanceOf[typingsJapgolly.jsonSchema.jsonSchemaStrings.any]
    
    inline def array: typingsJapgolly.jsonSchema.jsonSchemaStrings.array = "array".asInstanceOf[typingsJapgolly.jsonSchema.jsonSchemaStrings.array]
    
    inline def boolean: typingsJapgolly.jsonSchema.jsonSchemaStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.jsonSchema.jsonSchemaStrings.boolean]
    
    inline def integer: typingsJapgolly.jsonSchema.jsonSchemaStrings.integer = "integer".asInstanceOf[typingsJapgolly.jsonSchema.jsonSchemaStrings.integer]
    
    inline def `null`: typingsJapgolly.jsonSchema.jsonSchemaStrings.`null` = "null".asInstanceOf[typingsJapgolly.jsonSchema.jsonSchemaStrings.`null`]
    
    inline def number: typingsJapgolly.jsonSchema.jsonSchemaStrings.number = "number".asInstanceOf[typingsJapgolly.jsonSchema.jsonSchemaStrings.number]
    
    inline def `object`: typingsJapgolly.jsonSchema.jsonSchemaStrings.`object` = "object".asInstanceOf[typingsJapgolly.jsonSchema.jsonSchemaStrings.`object`]
    
    inline def string: typingsJapgolly.jsonSchema.jsonSchemaStrings.string = "string".asInstanceOf[typingsJapgolly.jsonSchema.jsonSchemaStrings.string]
  }
