...
import typingsJapgolly.jspdf.jspdfStrings.slice
import typingsJapgolly.jspdf.jspdfStrings.text
...
trait HTMLOptions extends StObject {
  ...
  var jsPDF: js.UndefOr[typingsJapgolly.jspdf.mod.jsPDF] = js.undefined
...
object HTMLOptions {
  ...
  extension [Self <: HTMLOptions](x: Self) {
    ...
    inline def setCallback(value: /* doc */ jsPDF => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* doc */ jsPDF) => value(t0).runNow()))
