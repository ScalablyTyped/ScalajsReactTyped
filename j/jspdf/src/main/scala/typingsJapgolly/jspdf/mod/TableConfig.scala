...
import typingsJapgolly.jspdf.anon.Fontsize
...
object TableConfig {
  ...
  extension [Self <: TableConfig](x: Self) {
    ...
    inline def setCellStart(value: (/* e */ TableCellData, /* doc */ jsPDF) => Callback): Self = StObject.set(x, "cellStart", js.Any.fromFunction2((t0: /* e */ TableCellData, t1: /* doc */ jsPDF) => (value(t0, t1)).runNow()))
    ...
    inline def setRowStart(value: (/* e */ TableRowData, /* doc */ jsPDF) => Callback): Self = StObject.set(x, "rowStart", js.Any.fromFunction2((t0: /* e */ TableRowData, t1: /* doc */ jsPDF) => (value(t0, t1)).runNow()))
