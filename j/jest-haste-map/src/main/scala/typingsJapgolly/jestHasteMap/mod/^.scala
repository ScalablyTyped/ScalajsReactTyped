...
import typingsJapgolly.jestHasteMap.TypeofHasteModuleMap
...
class ^ protected () extends HasteMap {
  ...
  /* CompleteClass */
  override def build(): js.Promise[typingsJapgolly.jestHasteMap.typesMod.HasteMap] = js.native
  /* CompleteClass */
...
object ^ extends js.Object {
  var DuplicateError: Instantiable2[
    /* mockPath1 */ String, 
    /* mockPath2 */ String, 
    typingsJapgolly.jestHasteMap.mod.DuplicateError
  ] = js.native
