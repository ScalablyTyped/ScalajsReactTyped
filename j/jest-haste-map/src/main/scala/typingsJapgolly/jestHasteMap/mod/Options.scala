package typingsJapgolly.jestHasteMap.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.jestHasteMap.typesMod.HasteRegExp
import typingsJapgolly.jestHasteMap.typesMod.Mapper
...
object Options {
  ...
  def apply(
    ...
    mapper: /* item */ String => CallbackTo[js.Array[String] | Null] = null,
    ...
    if (mapper != null) __obj.updateDynamic("mapper")(js.Any.fromFunction1((t0: /* item */ java.lang.String) => mapper(t0).runNow()))
