...
import typingsJapgolly.jestHasteMap.anon.FilePath
import typingsJapgolly.jestHasteMap.jestHasteMapInts.`0`
import typingsJapgolly.jestHasteMap.jestHasteMapInts.`1`
import typingsJapgolly.jestHasteMap.jestHasteMapInts.`2`
import typingsJapgolly.jestHasteMap.jestHasteMapInts.`3`
import typingsJapgolly.jestHasteMap.jestHasteMapInts.`4`
import typingsJapgolly.jestHasteMap.jestHasteMapInts.`5`
import typingsJapgolly.jestHasteMap.jestHasteMapStrings.change
...
object mod extends Shortcut {
  ...
  trait HType extends StObject {
    ...
    var DEPENDENCY_DELIM: typingsJapgolly.jestHasteMap.jestHasteMapStrings.Null
  ...
  object HType {
    ...
    extension [Self <: HType](x: Self) {
      ...
      inline def setDEPENDENCY_DELIM(value: typingsJapgolly.jestHasteMap.jestHasteMapStrings.Null): Self = StObject.set(x, "DEPENDENCY_DELIM", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jestHasteMap.jestHasteMapInts.`3`
    - typingsJapgolly.jestHasteMap.jestHasteMapInts.`2`
    - typingsJapgolly.jestHasteMap.jestHasteMapInts.`4`
    - typingsJapgolly.jestHasteMap.jestHasteMapInts.`0`
    - typingsJapgolly.jestHasteMap.jestHasteMapInts.`5`
    - typingsJapgolly.jestHasteMap.jestHasteMapInts.`1`
    - typingsJapgolly.jestHasteMap.jestHasteMapStrings.g
    - typingsJapgolly.jestHasteMap.jestHasteMapStrings.native
    - typingsJapgolly.jestHasteMap.jestHasteMapStrings.Null
  */
  trait HTypeValue extends StObject
  object HTypeValue {
    
    inline def `0`: typingsJapgolly.jestHasteMap.jestHasteMapInts.`0` = 0.asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapInts.`0`]
    
    inline def `1`: typingsJapgolly.jestHasteMap.jestHasteMapInts.`1` = 1.asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapInts.`1`]
    
    inline def `2`: typingsJapgolly.jestHasteMap.jestHasteMapInts.`2` = 2.asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapInts.`2`]
    
    inline def `3`: typingsJapgolly.jestHasteMap.jestHasteMapInts.`3` = 3.asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapInts.`3`]
    
    inline def `4`: typingsJapgolly.jestHasteMap.jestHasteMapInts.`4` = 4.asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapInts.`4`]
    
    inline def `5`: typingsJapgolly.jestHasteMap.jestHasteMapInts.`5` = 5.asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapInts.`5`]
    
    inline def Null: typingsJapgolly.jestHasteMap.jestHasteMapStrings.Null = "\u0000".asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapStrings.Null]
    
    inline def g: typingsJapgolly.jestHasteMap.jestHasteMapStrings.g = "g".asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapStrings.g]
    
    inline def native: typingsJapgolly.jestHasteMap.jestHasteMapStrings.native = "native".asInstanceOf[typingsJapgolly.jestHasteMap.jestHasteMapStrings.native]
  }
  ...
  trait IHasteMap extends StObject {
    ...
    def build(): js.Promise[typingsJapgolly.jestHasteMap.anon.HasteFS]
  ...
  object IHasteMap {
    ...
    inline def apply(
      build: CallbackTo[js.Promise[typingsJapgolly.jestHasteMap.anon.HasteFS]],
      on: (change, js.Function1[/* event */ ChangeEvent, Unit]) => Callback
    ): IHasteMap = {
      val __obj = js.Dynamic.literal(build = build.toJsFn, on = js.Any.fromFunction2((t0: change, t1: js.Function1[/* event */ ChangeEvent, Unit]) => (on(t0, t1)).runNow()))
      __obj.asInstanceOf[IHasteMap]
    }
    
    extension [Self <: IHasteMap](x: Self) {
      
      inline def setBuild(value: CallbackTo[js.Promise[typingsJapgolly.jestHasteMap.anon.HasteFS]]): Self = StObject.set(x, "build", value.toJsFn)
      
      inline def setOn(value: (change, js.Function1[/* event */ ChangeEvent, Unit]) => Callback): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: change, t1: js.Function1[/* event */ ChangeEvent, Unit]) => (value(t0, t1)).runNow()))
    }
  }
