...
import typingsJapgolly.jssha.anon.`16`
...
object distSha512Mod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jssha.anon.`13`
    - typingsJapgolly.jssha.anon.`14`
  */
  trait FixedLengthOptionsEncodingType extends StObject
  object FixedLengthOptionsEncodingType {
    
    inline def `13`(): typingsJapgolly.jssha.anon.`13` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.jssha.anon.`13`]
    }
    
    inline def `14`(): typingsJapgolly.jssha.anon.`14` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.jssha.anon.`14`]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jssha.anon.`15`
  ...
  */
  ...
  object FixedLengthOptionsNoEncodingType {
    ...
    inline def `15`(): typingsJapgolly.jssha.anon.`15` = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.jssha.anon.`15`]
    }
  }
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jssha.anon.FormatValueString
  ...
  */
  ...
  object GenericInputType {
    ...
    inline def FormatValueString(value: String): typingsJapgolly.jssha.anon.FormatValueString = {
      val __obj = js.Dynamic.literal(format = "TEXT", value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jssha.anon.FormatValueString]
    }
