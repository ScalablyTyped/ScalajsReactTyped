...
object Options {
  ...
  def apply(
    ...
    onStart: /* loading */ LoadingObject => Callback = null,
    onStop: /* loading */ LoadingObject => Callback = null,
    overlay: JQuery = null,
    ...
    if (onStart != null) __obj.updateDynamic("onStart")(js.Any.fromFunction1((t0: /* loading */ typingsJapgolly.jqueryEasyLoading.JQueryEasyLoading.LoadingObject) => onStart(t0).runNow()))
    if (onStop != null) __obj.updateDynamic("onStop")(js.Any.fromFunction1((t0: /* loading */ typingsJapgolly.jqueryEasyLoading.JQueryEasyLoading.LoadingObject) => onStop(t0).runNow()))
