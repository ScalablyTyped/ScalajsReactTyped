...
object AJaxSettings {
  ...
  def apply(
    ...
    always: (/* data */ js.UndefOr[JQuery], /* textStatus */ js.UndefOr[String], /* jqXHR */ js.UndefOr[JQueryXHR]) => japgolly.scalajs.react.Callback = null,
    ...
    done: (/* data */ js.UndefOr[JQuery], /* textStatus */ js.UndefOr[String], /* jqXHR */ js.UndefOr[JQueryXHR]) => japgolly.scalajs.react.Callback = null,
    ...
    fail: (/* jqXHR */ js.UndefOr[JQueryXHR], /* textStatus */ js.UndefOr[String], /* errorThrown */ js.UndefOr[js.Any]) => japgolly.scalajs.react.Callback = null,
    ...
    `then`: (/* jqXHR */ js.UndefOr[JQueryXHR], /* textStatus */ js.UndefOr[String]) => japgolly.scalajs.react.Callback = null,
    ...
    if (always != null) __obj.updateDynamic("always")(js.Any.fromFunction3((t0: /* data */ js.UndefOr[typingsJapgolly.jqueryTypeahead.JQuery], t1: /* textStatus */ js.UndefOr[java.lang.String], t2: /* jqXHR */ js.UndefOr[typingsJapgolly.jquery.JQueryXHR]) => always(t0, t1, t2).runNow()))
    ...
    if (done != null) __obj.updateDynamic("done")(js.Any.fromFunction3((t0: /* data */ js.UndefOr[typingsJapgolly.jqueryTypeahead.JQuery], t1: /* textStatus */ js.UndefOr[java.lang.String], t2: /* jqXHR */ js.UndefOr[typingsJapgolly.jquery.JQueryXHR]) => done(t0, t1, t2).runNow()))
    if (enctype != null) __obj.updateDynamic("enctype")(enctype.asInstanceOf[js.Any])
    if (error != null) __obj.updateDynamic("error")(error.asInstanceOf[js.Any])
    if (fail != null) __obj.updateDynamic("fail")(js.Any.fromFunction3((t0: /* jqXHR */ js.UndefOr[typingsJapgolly.jquery.JQueryXHR], t1: /* textStatus */ js.UndefOr[java.lang.String], t2: /* errorThrown */ js.UndefOr[js.Any]) => fail(t0, t1, t2).runNow()))
    ...
    if (`then` != null) __obj.updateDynamic("then")(js.Any.fromFunction2((t0: /* jqXHR */ js.UndefOr[typingsJapgolly.jquery.JQueryXHR], t1: /* textStatus */ js.UndefOr[java.lang.String]) => `then`(t0, t1).runNow()))
