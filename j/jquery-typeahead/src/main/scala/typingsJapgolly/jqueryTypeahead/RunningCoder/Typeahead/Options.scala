...
import typingsJapgolly.jqueryTypeahead.jqueryTypeaheadBooleans.`false`
import typingsJapgolly.jqueryTypeahead.jqueryTypeaheadBooleans.`true`
import typingsJapgolly.jqueryTypeahead.jqueryTypeaheadStrings.any
import typingsJapgolly.jqueryTypeahead.jqueryTypeaheadStrings.asc
import typingsJapgolly.jqueryTypeahead.jqueryTypeaheadStrings.desc
import typingsJapgolly.jqueryTypeahead.jqueryTypeaheadStrings.localStorage
import typingsJapgolly.jqueryTypeahead.jqueryTypeaheadStrings.sessionStorage
import typingsJapgolly.jqueryTypeahead.jqueryTypeaheadStrings.string
...
object Options {
  ...
  def apply(
    ...
    matcher: (/* item */ js.UndefOr[js.Any], /* displayKey */ js.UndefOr[String]) => CallbackTo[Boolean] = null,
    ...
    if (matcher != null) __obj.updateDynamic("matcher")(js.Any.fromFunction2((t0: /* item */ js.UndefOr[js.Any], t1: /* displayKey */ js.UndefOr[java.lang.String]) => matcher(t0, t1).runNow()))
