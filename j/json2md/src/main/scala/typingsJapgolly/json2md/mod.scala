package typingsJapgolly.json2md

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.json2md.mod.DefaultConverters.CodeInput
import typingsJapgolly.json2md.mod.DefaultConverters.ImgInput
import typingsJapgolly.json2md.mod.DefaultConverters.TableInput
...
object mod {
  ...
  type ConverterCallback[TInput] = js.Function2[/* input */ TInput, /* json2md */ typingsJapgolly.json2md.mod.json2md, String]
  ...
  trait ConvertersMethods extends StObject {
    ...
    def blockquote(input: String, json2md: typingsJapgolly.json2md.mod.json2md): String
    def blockquote(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("blockquote")
    var blockquote_Original: ConverterCallback[String | js.Array[String]]
    
    def code(input: CodeInput, json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("code")
    var code_Original: ConverterCallback[CodeInput]
    
    def h1(input: String, json2md: typingsJapgolly.json2md.mod.json2md): String
    def h1(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("h1")
    var h1_Original: ConverterCallback[String | js.Array[String]]
    
    def h2(input: String, json2md: typingsJapgolly.json2md.mod.json2md): String
    def h2(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("h2")
    var h2_Original: ConverterCallback[String | js.Array[String]]
    
    def h3(input: String, json2md: typingsJapgolly.json2md.mod.json2md): String
    def h3(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("h3")
    var h3_Original: ConverterCallback[String | js.Array[String]]
    
    def h4(input: String, json2md: typingsJapgolly.json2md.mod.json2md): String
    def h4(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("h4")
    var h4_Original: ConverterCallback[String | js.Array[String]]
    
    def h5(input: String, json2md: typingsJapgolly.json2md.mod.json2md): String
    def h5(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("h5")
    var h5_Original: ConverterCallback[String | js.Array[String]]
    
    def h6(input: String, json2md: typingsJapgolly.json2md.mod.json2md): String
    def h6(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("h6")
    var h6_Original: ConverterCallback[String | js.Array[String]]
    
    def img(input: js.Array[ImgInput], json2md: typingsJapgolly.json2md.mod.json2md): String
    def img(input: ImgInput, json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("img")
    var img_Original: ConverterCallback[ImgInput | js.Array[ImgInput]]
    
    def ol(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("ol")
    var ol_Original: ConverterCallback[js.Array[String]]
    
    def p(input: String, json2md: typingsJapgolly.json2md.mod.json2md): String
    def p(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("p")
    var p_Original: ConverterCallback[String | js.Array[String]]
    
    def table(input: TableInput, json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("table")
    var table_Original: ConverterCallback[TableInput]
    
    def ul(input: js.Array[String], json2md: typingsJapgolly.json2md.mod.json2md): String
    @JSName("ul")
  ...
  object ConvertersMethods {
    ...
    inline def apply(
      blockquote: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      code: (CodeInput, /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      h1: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      h2: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      h3: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      h4: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      h5: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      h6: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      img: (ImgInput | js.Array[ImgInput], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      ol: (js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      p: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      table: (TableInput, /* json2md */ typingsJapgolly.json2md.mod.json2md) => String,
      ul: (js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String
    ): ConvertersMethods = {
    ...
    extension [Self <: ConvertersMethods](x: Self) {
      ...
      inline def setBlockquote(value: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "blockquote", js.Any.fromFunction2(value))
      
      inline def setCode(value: (CodeInput, /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "code", js.Any.fromFunction2(value))
      
      inline def setH1(value: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "h1", js.Any.fromFunction2(value))
      
      inline def setH2(value: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "h2", js.Any.fromFunction2(value))
      
      inline def setH3(value: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "h3", js.Any.fromFunction2(value))
      
      inline def setH4(value: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "h4", js.Any.fromFunction2(value))
      
      inline def setH5(value: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "h5", js.Any.fromFunction2(value))
      
      inline def setH6(value: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "h6", js.Any.fromFunction2(value))
      
      inline def setImg(
        value: (ImgInput | js.Array[ImgInput], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String
      ): Self = StObject.set(x, "img", js.Any.fromFunction2(value))
      
      inline def setOl(value: (js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "ol", js.Any.fromFunction2(value))
      
      inline def setP(value: (String | js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "p", js.Any.fromFunction2(value))
      
      inline def setTable(value: (TableInput, /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "table", js.Any.fromFunction2(value))
      
      inline def setUl(value: (js.Array[String], /* json2md */ typingsJapgolly.json2md.mod.json2md) => String): Self = StObject.set(x, "ul", js.Any.fromFunction2(value))
    }
  }
