...
import typingsJapgolly.jupyterlabObservables.libObservablelistMod.IObservableList
import typingsJapgolly.jupyterlabObservables.libObservablelistMod.ObservableList
...
object libUndoablelistMod {
  ...
  - typingsJapgolly.jupyterlabObservables.libObservablelistMod.IObservableList because Already inherited
  - typingsJapgolly.jupyterlabObservables.libUndoablelistMod.IObservableUndoableList because var conflicts: changed, isDisposed, length, `type`. Inlined canRedo, canUndo, beginCompoundOperation, beginCompoundOperation, endCompoundOperation, undo, redo, clearUndo */ @JSImport("@jupyterlab/observables/lib/undoablelist", "ObservableUndoableList")
  @js.native
