...
trait ICreateOptions extends js.Object {
  /**
    ...
    */
  var baseDB: js.UndefOr[typingsJapgolly.jupyterlabObservables.modeldbMod.ModelDB] = js.undefined
  /**
...
object ICreateOptions {
  @scala.inline
  def apply(baseDB: typingsJapgolly.jupyterlabObservables.modeldbMod.ModelDB = null, basePath: String = null): ICreateOptions = {
