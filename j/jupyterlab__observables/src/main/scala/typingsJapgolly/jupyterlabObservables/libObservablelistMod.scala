...
import typingsJapgolly.jupyterlabObservables.libObservablelistMod.IObservableList.IChangedArgs
import typingsJapgolly.jupyterlabObservables.libObservablelistMod.ObservableList.IOptions
...
object libObservablelistMod {
  ...
  open class ObservableList[T] ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val `type`: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.List = js.native
    /**
      * The type of this object.
      */
    @JSName("type")
    def type_MObservableList: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.List = js.native
  }
  ...
  trait IObservableList[T]
    ...
    /**
      * The type of this object.
      */
    val `type`: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.List
  }
  object IObservableList {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(changed = changed.asInstanceOf[js.Any], clear = clear.toJsFn, dispose = dispose.toJsFn, get = js.Any.fromFunction1(get), insert = js.Any.fromFunction2((t0: Double, t1: T) => (insert(t0, t1)).runNow()), insertAll = js.Any.fromFunction2((t0: Double, t1: IterableOrArrayLike[T]) => (insertAll(t0, t1)).runNow()), isDisposed = isDisposed.asInstanceOf[js.Any], iter = iter.toJsFn, length = length.asInstanceOf[js.Any], move = js.Any.fromFunction2((t0: Double, t1: Double) => (move(t0, t1)).runNow()), push = js.Any.fromFunction1(push), pushAll = js.Any.fromFunction1(pushAll), remove = js.Any.fromFunction1(remove), removeRange = js.Any.fromFunction2(removeRange), removeValue = js.Any.fromFunction1(removeValue), set = js.Any.fromFunction2((t0: Double, t1: T) => (set(t0, t1)).runNow()))
    ...
    */
    ...
    object ChangeType {
      ...
      inline def move: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.move = "move".asInstanceOf[typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.move]
    ...
    extension [Self <: IObservableList[?], T](x: Self & IObservableList[T]) {
      ...
      inline def setInsertAll(value: (Double, IterableOrArrayLike[T]) => Callback): Self = StObject.set(x, "insertAll", js.Any.fromFunction2((t0: Double, t1: IterableOrArrayLike[T]) => (value(t0, t1)).runNow()))
      ...
      inline def setSet(value: (Double, T) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: Double, t1: T) => (value(t0, t1)).runNow()))
      
      inline def setType(value: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.List): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
}
