...
import typingsJapgolly.jupyterlabObservables.libModeldbMod.ObservableValue.IChangedArgs
import typingsJapgolly.jupyterlabObservables.libObservablejsonMod.IObservableJSON
...
import typingsJapgolly.jupyterlabObservables.libUndoablelistMod.IObservableUndoableList
...
object libModeldbMod {
  ...
  object ICollaboratorMap {
    ...
    inline def apply(
      changed: ISignal[
          ICollaboratorMap, 
          typingsJapgolly.jupyterlabObservables.libObservablemapMod.IObservableMap.IChangedArgs[ICollaborator]
        ],
      clear: Callback,
      ...
      val __obj = js.Dynamic.literal(changed = changed.asInstanceOf[js.Any], clear = clear.toJsFn, delete = js.Any.fromFunction1(delete), dispose = dispose.toJsFn, get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has), isDisposed = isDisposed.asInstanceOf[js.Any], keys = keys.toJsFn, localCollaborator = localCollaborator.asInstanceOf[js.Any], set = js.Any.fromFunction2(set), size = size.asInstanceOf[js.Any], values = values.toJsFn)
  ...
  object IModelDB {
    ...
    extension [Self <: IModelDB](x: Self) {
      ...
      inline def setSetValue(value: (String, JSONValue) => Callback): Self = StObject.set(x, "setValue", js.Any.fromFunction2((t0: String, t1: JSONValue) => (value(t0, t1)).runNow()))
  ...
  object IObservable {
    ...
    inline def apply(dispose: Callback, isDisposed: Boolean, `type`: ObservableType): IObservable = {
      val __obj = js.Dynamic.literal(dispose = dispose.toJsFn, isDisposed = isDisposed.asInstanceOf[js.Any])
  ...
  object IObservableValue {
    ...
    inline def apply(
      ...
      dispose: Callback,
      get: CallbackTo[js.UndefOr[PartialJSONValue]],
      isDisposed: Boolean,
      set: PartialJSONValue => Callback
    ): IObservableValue = {
      val __obj = js.Dynamic.literal(changed = changed.asInstanceOf[js.Any], dispose = dispose.toJsFn, get = get.toJsFn, isDisposed = isDisposed.asInstanceOf[js.Any], set = js.Any.fromFunction1((t0: PartialJSONValue) => set(t0).runNow()))
    ...
    extension [Self <: IObservableValue](x: Self) {
      ...
      inline def setGet(value: CallbackTo[js.UndefOr[PartialJSONValue]]): Self = StObject.set(x, "get", value.toJsFn)
      
      inline def setSet(value: PartialJSONValue => Callback): Self = StObject.set(x, "set", js.Any.fromFunction1((t0: PartialJSONValue) => value(t0).runNow()))
  ...
  */
  ...
  object ObservableType {
    ...
    inline def List: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.List = "List".asInstanceOf[typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.List]
    
    inline def Map: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.Map = "Map".asInstanceOf[typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.Map]
    
    inline def String: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.String = "String".asInstanceOf[typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.String]
    
    inline def Value: typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.Value = "Value".asInstanceOf[typingsJapgolly.jupyterlabObservables.jupyterlabObservablesStrings.Value]
  }
}
