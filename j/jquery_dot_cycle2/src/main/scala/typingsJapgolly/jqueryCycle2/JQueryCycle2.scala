...
object JQueryCycle2 {
  ...
  object Transition {
    ...
    inline def apply(before: (Options, Element, Element, Boolean) => Callback): Transition = {
      val __obj = js.Dynamic.literal(before = js.Any.fromFunction4((t0: Options, t1: Element, t2: Element, t3: Boolean) => (before(t0, t1, t2, t3)).runNow()))
      __obj.asInstanceOf[Transition]
    }
    
    extension [Self <: Transition](x: Self) {
      
      inline def setBefore(value: (Options, Element, Element, Boolean) => Callback): Self = StObject.set(x, "before", js.Any.fromFunction4((t0: Options, t1: Element, t2: Element, t3: Boolean) => (value(t0, t1, t2, t3)).runNow()))
    }
  }
}
