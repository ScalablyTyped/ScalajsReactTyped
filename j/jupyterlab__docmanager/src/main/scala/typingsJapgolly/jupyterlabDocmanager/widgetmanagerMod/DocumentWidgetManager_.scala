package typingsJapgolly.jupyterlabDocmanager.widgetmanagerMod

import typingsJapgolly.jupyterlabDocmanager.widgetmanagerMod.DocumentWidgetManager.IOptions
