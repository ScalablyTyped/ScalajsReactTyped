package typingsJapgolly.jexcel
...
import typingsJapgolly.jexcel.anon.Colspan
import typingsJapgolly.jexcel.anon.Id
import typingsJapgolly.jexcel.jexcelInts.`0`
import typingsJapgolly.jexcel.jexcelInts.`1`
import typingsJapgolly.jexcel.jexcelStrings.autocomplete
import typingsJapgolly.jexcel.jexcelStrings.calendar
import typingsJapgolly.jexcel.jexcelStrings.center
import typingsJapgolly.jexcel.jexcelStrings.checkbox
import typingsJapgolly.jexcel.jexcelStrings.color
import typingsJapgolly.jexcel.jexcelStrings.dropdown
import typingsJapgolly.jexcel.jexcelStrings.hidden
import typingsJapgolly.jexcel.jexcelStrings.html
import typingsJapgolly.jexcel.jexcelStrings.image
import typingsJapgolly.jexcel.jexcelStrings.left
import typingsJapgolly.jexcel.jexcelStrings.numeric
import typingsJapgolly.jexcel.jexcelStrings.radio
import typingsJapgolly.jexcel.jexcelStrings.right
import typingsJapgolly.jexcel.jexcelStrings.text
  ...
  object EventsOptions {
    ...
    extension [Self <: EventsOptions](x: Self) {
      ...
      inline def setOnchange(
        value: (/* instance */ HTMLElement, /* cell */ HTMLTableCellElement, /* columnIndex */ String, /* rowIndex */ String, /* value */ CellValue) => Callback
      ): Self = StObject.set(x, "onchange", js.Any.fromFunction5((t0: /* instance */ HTMLElement, t1: /* cell */ HTMLTableCellElement, t2: /* columnIndex */ String, t3: /* rowIndex */ String, t4: /* value */ CellValue) => (value(t0, t1, t2, t3, t4)).runNow()))
  ...
  object InitializationOptions {
    ...
    extension [Self <: InitializationOptions](x: Self) {
      ...
      inline def setUpdateTable(
        value: (/* instance */ Any, /* cell */ Any, /* col */ Any, /* row */ Any, /* val */ Any, /* label */ Any, /* cellName */ Any) => Callback
      ): Self = StObject.set(x, "updateTable", js.Any.fromFunction7((t0: /* instance */ Any, t1: /* cell */ Any, t2: /* col */ Any, t3: /* row */ Any, t4: /* val */ Any, t5: /* label */ Any, t6: /* cellName */ Any) => (value(t0, t1, t2, t3, t4, t5, t6)).runNow()))
