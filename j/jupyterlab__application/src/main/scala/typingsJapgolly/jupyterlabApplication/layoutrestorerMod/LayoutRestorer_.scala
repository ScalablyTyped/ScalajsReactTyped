...
import typingsJapgolly.jupyterlabApplication.layoutrestorerMod.LayoutRestorer.IOptions
...
class LayoutRestorer_ protected () extends ILayoutRestorer {
  ...
  override def restore(
    ...
    options: typingsJapgolly.jupyterlabCoreutils.interfacesMod.IRestorable.IOptions[IObservableDisposable]
  ...
  override def restore[T /* <: Widget */](
    ...
    options: typingsJapgolly.jupyterlabCoreutils.interfacesMod.IRestorer.IOptions[T]
