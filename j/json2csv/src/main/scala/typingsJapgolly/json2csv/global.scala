...
import typingsJapgolly.json2csv.mod.FlattenOptions
import typingsJapgolly.json2csv.mod.Json2CsvTransform
import typingsJapgolly.json2csv.mod.Options
import typingsJapgolly.json2csv.mod.UnwindOptions
...
object global {
  ...
  object json2csv {
    ...
    open class AsyncParser[T] ()
      extends typingsJapgolly.json2csv.mod.AsyncParser[T] {
    ...
    @js.native
    open class Parser[T] ()
      extends typingsJapgolly.json2csv.mod.Parser[T]
    
    @JSGlobal("json2csv.Transform")
    @js.native
    // implements JSON2CSVBase<T>
    open class Transform[T] ()
      extends typingsJapgolly.json2csv.mod.Transform[T] {
      def this(opts: Options[T]) = this()
      def this(opts: Unit, transformOpts: TransformOptions) = this()
      def this(opts: Options[T], transformOpts: TransformOptions) = this()
    }
