...
import typingsJapgolly.json2csv.json2csvasyncparserMod.default
import typingsJapgolly.json2csv.json2csvbaseMod.json2csv.Options
import typingsJapgolly.json2csv.json2csvparserMod.JSON2CSVParser
...
object mod extends js.Object {
  ...
  class Transform[T] ()
    extends typingsJapgolly.json2csv.json2csvtransformMod.default[T] {
    def this(opts: Options[T]) = this()
    def this(opts: Options[T], transformOpts: TransformOptions) = this()
  }
