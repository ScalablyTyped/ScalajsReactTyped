...
object JQueryKnob {
  ...
  object JQueryKnobOptions {
    ...
    extension [Self <: JQueryKnobOptions](x: Self) {
      ...
      inline def setChange(value: /* value */ Double => Callback): Self = StObject.set(x, "change", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
      ...
      inline def setFormat(value: /* value */ Double => Callback): Self = StObject.set(x, "format", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
      ...
      inline def setRelease(value: /* value */ Double => Callback): Self = StObject.set(x, "release", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
