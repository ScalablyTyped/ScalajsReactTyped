...
import typingsJapgolly.jquerySortable.anon.Bottom
  ...
  object GroupOptions {
    ...
    extension [Self <: GroupOptions](x: Self) {
      ...
      inline def setAfterMove(
        value: (/* $placeholder */ JQuery, /* container */ Container, /* $closestItemOrContainer */ JQuery) => Callback
      ): Self = StObject.set(x, "afterMove", js.Any.fromFunction3((t0: /* $placeholder */ JQuery, t1: /* container */ Container, t2: /* $closestItemOrContainer */ JQuery) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setSerialize(value: (/* $parent */ JQuery, /* $children */ Any, /* parentIsContainer */ Boolean) => Callback): Self = StObject.set(x, "serialize", js.Any.fromFunction3((t0: /* $parent */ JQuery, t1: /* $children */ Any, t2: /* parentIsContainer */ Boolean) => (value(t0, t1, t2)).runNow()))
