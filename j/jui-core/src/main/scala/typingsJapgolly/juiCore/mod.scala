...
import typingsJapgolly.juiCore.anon.Mozilla
...
object mod {
  ...
  object UICollection {
    ...
    inline def apply(destroy: Callback): UICollection = {
  ...
  object UICore {
    ...
    inline def apply(
      addValid: (String, js.Array[Any]) => Callback,
      ...
      setOption: (String, Any) => Callback,
      setTpl: (String, String) => Callback
    ): UICore = {
      val __obj = js.Dynamic.literal(addValid = js.Any.fromFunction2((t0: String, t1: js.Array[Any]) => (addValid(t0, t1)).runNow()), callAfter = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (callAfter(t0, t1)).runNow()), callBefore = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (callBefore(t0, t1)).runNow()), callDelay = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (callDelay(t0, t1)).runNow()), destroy = destroy.toJsFn, emit = js.Any.fromFunction2(emit), off = js.Any.fromFunction1((t0: String) => off(t0).runNow()), on = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (on(t0, t1)).runNow()), setOption = js.Any.fromFunction2((t0: String, t1: Any) => (setOption(t0, t1)).runNow()), setTpl = js.Any.fromFunction2((t0: String, t1: String) => (setTpl(t0, t1)).runNow()))
      __obj.asInstanceOf[UICore]
    }
    
    extension [Self <: UICore](x: Self) {
      
      inline def setAddValid(value: (String, js.Array[Any]) => Callback): Self = StObject.set(x, "addValid", js.Any.fromFunction2((t0: String, t1: js.Array[Any]) => (value(t0, t1)).runNow()))
      
      inline def setCallAfter(value: (String, js.Function0[Unit]) => Callback): Self = StObject.set(x, "callAfter", js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
      
      inline def setCallBefore(value: (String, js.Function0[Unit]) => Callback): Self = StObject.set(x, "callBefore", js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
      
      inline def setCallDelay(value: (String, js.Function0[Unit]) => Callback): Self = StObject.set(x, "callDelay", js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
      ...
      inline def setSetOption(value: (String, Any) => Callback): Self = StObject.set(x, "setOption", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
      
      inline def setSetTpl(value: (String, String) => Callback): Self = StObject.set(x, "setTpl", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
  ...
  object UIEvent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addValid = js.Any.fromFunction2((t0: String, t1: js.Array[Any]) => (addValid(t0, t1)).runNow()), callAfter = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (callAfter(t0, t1)).runNow()), callBefore = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (callBefore(t0, t1)).runNow()), callDelay = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (callDelay(t0, t1)).runNow()), destroy = destroy.toJsFn, emit = js.Any.fromFunction2(emit), find = js.Any.fromFunction1(find), off = js.Any.fromFunction1((t0: String) => off(t0).runNow()), on = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (on(t0, t1)).runNow()), setOption = js.Any.fromFunction2((t0: String, t1: Any) => (setOption(t0, t1)).runNow()), setTpl = js.Any.fromFunction2((t0: String, t1: String) => (setTpl(t0, t1)).runNow()))
  ...
  object UtilColor {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(HSVtoRGB = js.Any.fromFunction3(HSVtoRGB), RGBtoHSV = js.Any.fromFunction3(RGBtoHSV), darken = js.Any.fromFunction2(darken), format = js.Any.fromFunction2(format), lighten = js.Any.fromFunction2(lighten), map = js.Any.fromFunction2(map), rgb = js.Any.fromFunction1(rgb), scale = scale.toJsFn)
    ...
    extension [Self <: UtilColor](x: Self) {
      ...
      inline def setScale(value: CallbackTo[ColorScale]): Self = StObject.set(x, "scale", value.toJsFn)
    }
  }
