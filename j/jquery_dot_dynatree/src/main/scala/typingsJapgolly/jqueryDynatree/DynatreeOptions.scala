...
object DynatreeOptions {
  ...
  def apply(
    ...
    onActivate: /* dtnode */ DynaTreeNode => Callback = null,
    onBlur: (/* dtnode */ DynaTreeNode, /* event */ Event_) => CallbackTo[Boolean] = null,
    onClick: (/* dtnode */ DynaTreeNode, /* event */ Event_) => CallbackTo[Boolean] = null,
    onCreate: (/* dtnode */ DynaTreeNode, /* nodeSpan */ js.Any) => Callback = null,
    onCustomRender: /* dtnode */ DynaTreeNode => Callback = null,
    onDblClick: (/* dtnode */ DynaTreeNode, /* event */ Event_) => CallbackTo[Boolean] = null,
    onDeactivate: /* dtnode */ DynaTreeNode => Callback = null,
    onExpand: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback = null,
    onFocus: (/* dtnode */ DynaTreeNode, /* event */ Event_) => CallbackTo[Boolean] = null,
    onKeydown: (/* dtnode */ DynaTreeNode, /* event */ Event_) => CallbackTo[Boolean] = null,
    onKeypress: (/* dtnode */ DynaTreeNode, /* event */ Event_) => CallbackTo[Boolean] = null,
    onLazyRead: /* dtnode */ DynaTreeNode => Callback = null,
    onPostInit: (/* isReloading */ Boolean, /* isError */ Boolean) => Callback = null,
    onQueryActivate: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback = null,
    onQueryExpand: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback = null,
    onQuerySelect: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback = null,
    onRender: (/* dtnode */ DynaTreeNode, /* nodeSpan */ js.Any) => Callback = null,
    onSelect: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback = null,
    persist: js.UndefOr[Boolean] = js.undefined,
    postProcess: (/* data */ js.Any, /* dataType */ js.Any) => Callback = null,
    ...
    if (onActivate != null) __obj.updateDynamic("onActivate")(js.Any.fromFunction1((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onActivate(t0).runNow()))
    if (onBlur != null) __obj.updateDynamic("onBlur")(js.Any.fromFunction2((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode, t1: /* event */ typingsJapgolly.std.Event_) => onBlur(t0, t1).runNow()))
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction2((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode, t1: /* event */ typingsJapgolly.std.Event_) => onClick(t0, t1).runNow()))
    if (onCreate != null) __obj.updateDynamic("onCreate")(js.Any.fromFunction2((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode, t1: /* nodeSpan */ js.Any) => onCreate(t0, t1).runNow()))
    if (onCustomRender != null) __obj.updateDynamic("onCustomRender")(js.Any.fromFunction1((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onCustomRender(t0).runNow()))
    if (onDblClick != null) __obj.updateDynamic("onDblClick")(js.Any.fromFunction2((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode, t1: /* event */ typingsJapgolly.std.Event_) => onDblClick(t0, t1).runNow()))
    if (onDeactivate != null) __obj.updateDynamic("onDeactivate")(js.Any.fromFunction1((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onDeactivate(t0).runNow()))
    if (onExpand != null) __obj.updateDynamic("onExpand")(js.Any.fromFunction2((t0: /* flag */ java.lang.String, t1: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onExpand(t0, t1).runNow()))
    if (onFocus != null) __obj.updateDynamic("onFocus")(js.Any.fromFunction2((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode, t1: /* event */ typingsJapgolly.std.Event_) => onFocus(t0, t1).runNow()))
    if (onKeydown != null) __obj.updateDynamic("onKeydown")(js.Any.fromFunction2((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode, t1: /* event */ typingsJapgolly.std.Event_) => onKeydown(t0, t1).runNow()))
    if (onKeypress != null) __obj.updateDynamic("onKeypress")(js.Any.fromFunction2((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode, t1: /* event */ typingsJapgolly.std.Event_) => onKeypress(t0, t1).runNow()))
    if (onLazyRead != null) __obj.updateDynamic("onLazyRead")(js.Any.fromFunction1((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onLazyRead(t0).runNow()))
    if (onPostInit != null) __obj.updateDynamic("onPostInit")(js.Any.fromFunction2((t0: /* isReloading */ scala.Boolean, t1: /* isError */ scala.Boolean) => onPostInit(t0, t1).runNow()))
    if (onQueryActivate != null) __obj.updateDynamic("onQueryActivate")(js.Any.fromFunction2((t0: /* flag */ java.lang.String, t1: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onQueryActivate(t0, t1).runNow()))
    if (onQueryExpand != null) __obj.updateDynamic("onQueryExpand")(js.Any.fromFunction2((t0: /* flag */ java.lang.String, t1: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onQueryExpand(t0, t1).runNow()))
    if (onQuerySelect != null) __obj.updateDynamic("onQuerySelect")(js.Any.fromFunction2((t0: /* flag */ java.lang.String, t1: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onQuerySelect(t0, t1).runNow()))
    if (onRender != null) __obj.updateDynamic("onRender")(js.Any.fromFunction2((t0: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode, t1: /* nodeSpan */ js.Any) => onRender(t0, t1).runNow()))
    if (onSelect != null) __obj.updateDynamic("onSelect")(js.Any.fromFunction2((t0: /* flag */ java.lang.String, t1: /* dtnode */ typingsJapgolly.jqueryDynatree.DynaTreeNode) => onSelect(t0, t1).runNow()))
    if (!js.isUndefined(persist)) __obj.updateDynamic("persist")(persist.asInstanceOf[js.Any])
    if (postProcess != null) __obj.updateDynamic("postProcess")(js.Any.fromFunction2((t0: /* data */ js.Any, t1: /* dataType */ js.Any) => postProcess(t0, t1).runNow()))
