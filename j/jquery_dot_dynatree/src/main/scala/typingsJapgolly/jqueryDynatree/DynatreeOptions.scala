...
object DynatreeOptions {
  ...
  extension [Self <: DynatreeOptions](x: Self) {
    ...
    inline def setOnActivate(value: /* dtnode */ DynaTreeNode => Callback): Self = StObject.set(x, "onActivate", js.Any.fromFunction1((t0: /* dtnode */ DynaTreeNode) => value(t0).runNow()))
    ...
    inline def setOnCreate(value: (/* dtnode */ DynaTreeNode, /* nodeSpan */ Any) => Callback): Self = StObject.set(x, "onCreate", js.Any.fromFunction2((t0: /* dtnode */ DynaTreeNode, t1: /* nodeSpan */ Any) => (value(t0, t1)).runNow()))
    
    inline def setOnCreateUndefined: Self = StObject.set(x, "onCreate", js.undefined)
    
    inline def setOnCustomRender(value: /* dtnode */ DynaTreeNode => Callback): Self = StObject.set(x, "onCustomRender", js.Any.fromFunction1((t0: /* dtnode */ DynaTreeNode) => value(t0).runNow()))
    ...
    inline def setOnDeactivate(value: /* dtnode */ DynaTreeNode => Callback): Self = StObject.set(x, "onDeactivate", js.Any.fromFunction1((t0: /* dtnode */ DynaTreeNode) => value(t0).runNow()))
    
    inline def setOnDeactivateUndefined: Self = StObject.set(x, "onDeactivate", js.undefined)
    
    inline def setOnExpand(value: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback): Self = StObject.set(x, "onExpand", js.Any.fromFunction2((t0: /* flag */ String, t1: /* dtnode */ DynaTreeNode) => (value(t0, t1)).runNow()))
    ...
    inline def setOnLazyRead(value: /* dtnode */ DynaTreeNode => Callback): Self = StObject.set(x, "onLazyRead", js.Any.fromFunction1((t0: /* dtnode */ DynaTreeNode) => value(t0).runNow()))
    
    inline def setOnLazyReadUndefined: Self = StObject.set(x, "onLazyRead", js.undefined)
    
    inline def setOnPostInit(value: (/* isReloading */ Boolean, /* isError */ Boolean) => Callback): Self = StObject.set(x, "onPostInit", js.Any.fromFunction2((t0: /* isReloading */ Boolean, t1: /* isError */ Boolean) => (value(t0, t1)).runNow()))
    
    inline def setOnPostInitUndefined: Self = StObject.set(x, "onPostInit", js.undefined)
    
    inline def setOnQueryActivate(value: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback): Self = StObject.set(x, "onQueryActivate", js.Any.fromFunction2((t0: /* flag */ String, t1: /* dtnode */ DynaTreeNode) => (value(t0, t1)).runNow()))
    
    inline def setOnQueryActivateUndefined: Self = StObject.set(x, "onQueryActivate", js.undefined)
    
    inline def setOnQueryExpand(value: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback): Self = StObject.set(x, "onQueryExpand", js.Any.fromFunction2((t0: /* flag */ String, t1: /* dtnode */ DynaTreeNode) => (value(t0, t1)).runNow()))
    
    inline def setOnQueryExpandUndefined: Self = StObject.set(x, "onQueryExpand", js.undefined)
    
    inline def setOnQuerySelect(value: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback): Self = StObject.set(x, "onQuerySelect", js.Any.fromFunction2((t0: /* flag */ String, t1: /* dtnode */ DynaTreeNode) => (value(t0, t1)).runNow()))
    
    inline def setOnQuerySelectUndefined: Self = StObject.set(x, "onQuerySelect", js.undefined)
    
    inline def setOnRender(value: (/* dtnode */ DynaTreeNode, /* nodeSpan */ Any) => Callback): Self = StObject.set(x, "onRender", js.Any.fromFunction2((t0: /* dtnode */ DynaTreeNode, t1: /* nodeSpan */ Any) => (value(t0, t1)).runNow()))
    
    inline def setOnRenderUndefined: Self = StObject.set(x, "onRender", js.undefined)
    
    inline def setOnSelect(value: (/* flag */ String, /* dtnode */ DynaTreeNode) => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: /* flag */ String, t1: /* dtnode */ DynaTreeNode) => (value(t0, t1)).runNow()))
    ...
    inline def setPostProcess(value: (/* data */ Any, /* dataType */ Any) => Callback): Self = StObject.set(x, "postProcess", js.Any.fromFunction2((t0: /* data */ Any, t1: /* dataType */ Any) => (value(t0, t1)).runNow()))
