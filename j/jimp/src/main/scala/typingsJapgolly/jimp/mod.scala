...
import typingsJapgolly.jimp.anon.AlignmentX
import typingsJapgolly.jimp.anon.AutoGreyscale
import typingsJapgolly.jimp.anon.B
import typingsJapgolly.jimp.anon.CropOnlyFrames
import typingsJapgolly.jimp.anon.Idx
import typingsJapgolly.jimp.anon.Image
import typingsJapgolly.jimp.anon.Opacity
import typingsJapgolly.jimp.anon.R
import typingsJapgolly.jimp.anon.Radius
import typingsJapgolly.jimp.anon.X
import typingsJapgolly.jimp.jimpInts.`-1`
import typingsJapgolly.jimp.jimpInts.`0`
import typingsJapgolly.jimp.jimpInts.`16`
import typingsJapgolly.jimp.jimpInts.`1`
import typingsJapgolly.jimp.jimpInts.`2`
import typingsJapgolly.jimp.jimpInts.`32`
import typingsJapgolly.jimp.jimpInts.`3`
import typingsJapgolly.jimp.jimpInts.`4`
import typingsJapgolly.jimp.jimpInts.`8`
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jimp.jimpStrings.background
    - typingsJapgolly.jimp.jimpStrings.scan
    - typingsJapgolly.jimp.jimpStrings.crop
  */
  trait ChangeName extends StObject
  object ChangeName {
    
    inline def background: typingsJapgolly.jimp.jimpStrings.background = "background".asInstanceOf[typingsJapgolly.jimp.jimpStrings.background]
    
    inline def crop: typingsJapgolly.jimp.jimpStrings.crop = "crop".asInstanceOf[typingsJapgolly.jimp.jimpStrings.crop]
    
    inline def scan: typingsJapgolly.jimp.jimpStrings.scan = "scan".asInstanceOf[typingsJapgolly.jimp.jimpStrings.scan]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jimp.jimpStrings.mix
    - typingsJapgolly.jimp.jimpStrings.tint
    - typingsJapgolly.jimp.jimpStrings.shade
    - typingsJapgolly.jimp.jimpStrings.xor
    - typingsJapgolly.jimp.jimpStrings.red
    - typingsJapgolly.jimp.jimpStrings.green
    - typingsJapgolly.jimp.jimpStrings.blue
    - typingsJapgolly.jimp.jimpStrings.hue
  */
  trait ColorActionName extends StObject
  object ColorActionName {
    
    inline def blue: typingsJapgolly.jimp.jimpStrings.blue = "blue".asInstanceOf[typingsJapgolly.jimp.jimpStrings.blue]
    
    inline def green: typingsJapgolly.jimp.jimpStrings.green = "green".asInstanceOf[typingsJapgolly.jimp.jimpStrings.green]
    
    inline def hue: typingsJapgolly.jimp.jimpStrings.hue = "hue".asInstanceOf[typingsJapgolly.jimp.jimpStrings.hue]
    
    inline def mix: typingsJapgolly.jimp.jimpStrings.mix = "mix".asInstanceOf[typingsJapgolly.jimp.jimpStrings.mix]
    
    inline def red: typingsJapgolly.jimp.jimpStrings.red = "red".asInstanceOf[typingsJapgolly.jimp.jimpStrings.red]
    
    inline def shade: typingsJapgolly.jimp.jimpStrings.shade = "shade".asInstanceOf[typingsJapgolly.jimp.jimpStrings.shade]
    
    inline def tint: typingsJapgolly.jimp.jimpStrings.tint = "tint".asInstanceOf[typingsJapgolly.jimp.jimpStrings.tint]
    
    inline def xor: typingsJapgolly.jimp.jimpStrings.xor = "xor".asInstanceOf[typingsJapgolly.jimp.jimpStrings.xor]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jimp.jimpStrings.any
    - typingsJapgolly.jimp.jimpStrings.initialized
    - typingsJapgolly.jimp.jimpStrings.`before-change`
    - typingsJapgolly.jimp.jimpStrings.changed
    - typingsJapgolly.jimp.jimpStrings.`before-clone`
    - typingsJapgolly.jimp.jimpStrings.cloned
    - typingsJapgolly.jimp.jimpStrings.background
    - typingsJapgolly.jimp.jimpStrings.scan
    - typingsJapgolly.jimp.jimpStrings.crop
  */
  ...
  object ListenableName {
    ...
    inline def any: typingsJapgolly.jimp.jimpStrings.any = "any".asInstanceOf[typingsJapgolly.jimp.jimpStrings.any]
    
    inline def background: typingsJapgolly.jimp.jimpStrings.background = "background".asInstanceOf[typingsJapgolly.jimp.jimpStrings.background]
    
    inline def `before-change`: typingsJapgolly.jimp.jimpStrings.`before-change` = "before-change".asInstanceOf[typingsJapgolly.jimp.jimpStrings.`before-change`]
    
    inline def `before-clone`: typingsJapgolly.jimp.jimpStrings.`before-clone` = "before-clone".asInstanceOf[typingsJapgolly.jimp.jimpStrings.`before-clone`]
    
    inline def changed: typingsJapgolly.jimp.jimpStrings.changed = "changed".asInstanceOf[typingsJapgolly.jimp.jimpStrings.changed]
    
    inline def cloned: typingsJapgolly.jimp.jimpStrings.cloned = "cloned".asInstanceOf[typingsJapgolly.jimp.jimpStrings.cloned]
    
    inline def crop: typingsJapgolly.jimp.jimpStrings.crop = "crop".asInstanceOf[typingsJapgolly.jimp.jimpStrings.crop]
    
    inline def initialized: typingsJapgolly.jimp.jimpStrings.initialized = "initialized".asInstanceOf[typingsJapgolly.jimp.jimpStrings.initialized]
