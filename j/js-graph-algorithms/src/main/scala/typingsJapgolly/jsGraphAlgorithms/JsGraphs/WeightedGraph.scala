...
object WeightedGraph {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(V = V.asInstanceOf[js.Any], addEdge = js.Any.fromFunction1((t0: Edge) => addEdge(t0).runNow()), adj = js.Any.fromFunction1(adj), adjList = adjList.asInstanceOf[js.Any], edge = js.Any.fromFunction2(edge), node = js.Any.fromFunction1(node), nodeInfo = nodeInfo.asInstanceOf[js.Any])
    __obj.asInstanceOf[WeightedGraph]
  }
  
  extension [Self <: WeightedGraph](x: Self) {
    
    inline def setAddEdge(value: Edge => Callback): Self = StObject.set(x, "addEdge", js.Any.fromFunction1((t0: Edge) => value(t0).runNow()))
