...
object SessionDirection extends StObject {
  ...
  /* "incoming" */ val INCOMING: typingsJapgolly.jssip.libRtcsessionMod.SessionDirection.INCOMING & String = js.native
  
  @js.native
  sealed trait OUTGOING
    extends StObject
       with SessionDirection
  /* "outgoing" */ val OUTGOING: typingsJapgolly.jssip.libRtcsessionMod.SessionDirection.OUTGOING & String = js.native
}
