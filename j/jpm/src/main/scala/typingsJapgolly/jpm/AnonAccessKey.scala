...
object AnonAccessKey {
  ...
  def apply(
    ...
    data: js.Any = null,
    image: String = null,
    onMessage: /* message */ js.UndefOr[js.Any] => CallbackTo[js.Any] = null
  ): AnonAccessKey = {
    ...
    if (onMessage != null) __obj.updateDynamic("onMessage")(js.Any.fromFunction1((t0: /* message */ js.UndefOr[js.Any]) => onMessage(t0).runNow()))
