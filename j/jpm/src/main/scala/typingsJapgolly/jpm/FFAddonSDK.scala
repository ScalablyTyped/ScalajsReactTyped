...
import typingsJapgolly.jpm.anon.Checked
import typingsJapgolly.jpm.anon.ContentScriptOptions
import typingsJapgolly.jpm.anon.Disabled
import typingsJapgolly.jpm.anon.OnError
import typingsJapgolly.jpm.anon.`16`
...
import typingsJapgolly.jpm.sdkUiToolbarMod.ToolbarItem
...
object FFAddonSDK {
  ...
  object Frame {
    ...
    inline def apply(
      destroy: Callback,
      off: (attach | detach | load | ready | message, js.Function) => Callback,
      on: (attach | detach | load | ready | message, js.Function1[/* event */ FrameEvent, Any]) => Callback,
      once: (attach | detach | load | ready | message, js.Function1[/* event */ FrameEvent, Any]) => Callback,
      postMessage: (String, String) => Callback,
      removeListener: (attach | detach | load | ready | message, js.Function) => Callback,
      url: URL
    ): Frame = {
      val __obj = js.Dynamic.literal(destroy = destroy.toJsFn, off = js.Any.fromFunction2((t0: attach | detach | load | ready | message, t1: js.Function) => (off(t0, t1)).runNow()), on = js.Any.fromFunction2((t0: attach | detach | load | ready | message, t1: js.Function1[/* event */ FrameEvent, Any]) => (on(t0, t1)).runNow()), once = js.Any.fromFunction2((t0: attach | detach | load | ready | message, t1: js.Function1[/* event */ FrameEvent, Any]) => (once(t0, t1)).runNow()), postMessage = js.Any.fromFunction2((t0: String, t1: String) => (postMessage(t0, t1)).runNow()), removeListener = js.Any.fromFunction2((t0: attach | detach | load | ready | message, t1: js.Function) => (removeListener(t0, t1)).runNow()), url = url.asInstanceOf[js.Any])
    ...
    extension [Self <: Frame](x: Self) {
      ...
      inline def setOff(value: (attach | detach | load | ready | message, js.Function) => Callback): Self = StObject.set(x, "off", js.Any.fromFunction2((t0: attach | detach | load | ready | message, t1: js.Function) => (value(t0, t1)).runNow()))
      
      inline def setOn(
        value: (attach | detach | load | ready | message, js.Function1[/* event */ FrameEvent, Any]) => Callback
      ): Self = StObject.set(x, "on", js.Any.fromFunction2((t0: attach | detach | load | ready | message, t1: js.Function1[/* event */ FrameEvent, Any]) => (value(t0, t1)).runNow()))
      
      inline def setOnce(
        value: (attach | detach | load | ready | message, js.Function1[/* event */ FrameEvent, Any]) => Callback
      ): Self = StObject.set(x, "once", js.Any.fromFunction2((t0: attach | detach | load | ready | message, t1: js.Function1[/* event */ FrameEvent, Any]) => (value(t0, t1)).runNow()))
      
      inline def setPostMessage(value: (String, String) => Callback): Self = StObject.set(x, "postMessage", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
      
      inline def setRemoveListener(value: (attach | detach | load | ready | message, js.Function) => Callback): Self = StObject.set(x, "removeListener", js.Any.fromFunction2((t0: attach | detach | load | ready | message, t1: js.Function) => (value(t0, t1)).runNow()))
