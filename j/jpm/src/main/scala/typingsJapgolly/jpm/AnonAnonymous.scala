...
import typingsJapgolly.jpm.requestMod.Response
...
object AnonAnonymous {
  ...
  def apply(
    ...
    onComplete: /* response */ Response => CallbackTo[js.Any] = null,
    ...
    if (onComplete != null) __obj.updateDynamic("onComplete")(js.Any.fromFunction1((t0: /* response */ typingsJapgolly.jpm.requestMod.Response) => onComplete(t0).runNow()))
