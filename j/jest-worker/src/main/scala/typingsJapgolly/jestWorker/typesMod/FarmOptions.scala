...
object FarmOptions {
  @scala.inline
  def apply(
    WorkerPool: (/* workerPath */ String, /* options */ js.UndefOr[WorkerPoolOptions]) => CallbackTo[WorkerPoolInterface] = null,
    computeWorkerKey: (/* method */ String, /* repeated */ js.Any) => CallbackTo[String | Null] = null,
    ...
    if (WorkerPool != null) __obj.updateDynamic("WorkerPool")(js.Any.fromFunction2((t0: /* workerPath */ java.lang.String, t1: /* options */ js.UndefOr[typingsJapgolly.jestWorker.typesMod.WorkerPoolOptions]) => WorkerPool(t0, t1).runNow()))
    if (computeWorkerKey != null) __obj.updateDynamic("computeWorkerKey")(js.Any.fromFunction2((t0: /* method */ java.lang.String, t1: /* repeated */ js.Any) => computeWorkerKey(t0, t1).runNow()))
