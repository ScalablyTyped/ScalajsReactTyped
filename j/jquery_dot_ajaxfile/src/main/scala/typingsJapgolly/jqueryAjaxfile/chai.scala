...
object Chai {
  ...
  object ChaiStatic {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(assert = assert.asInstanceOf[js.Any], config = config.asInstanceOf[js.Any], expect = js.Any.fromFunction2(expect), should = should.toJsFn, use = js.Any.fromFunction1(use))
