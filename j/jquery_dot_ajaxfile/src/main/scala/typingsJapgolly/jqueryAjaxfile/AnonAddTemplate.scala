...
object AnonAddTemplate {
  ...
  def apply(
    ...
    renderTemplateSource: (Object, KnockoutBindingContext, Object) => CallbackTo[js.Array[Node]]
  ): AnonAddTemplate = {
    ...
    __obj.updateDynamic("renderTemplateSource")(js.Any.fromFunction3((t0: typingsJapgolly.jqueryAjaxfile.Object, t1: typingsJapgolly.jqueryAjaxfile.KnockoutBindingContext, t2: typingsJapgolly.jqueryAjaxfile.Object) => renderTemplateSource(t0, t1, t2).runNow()))
