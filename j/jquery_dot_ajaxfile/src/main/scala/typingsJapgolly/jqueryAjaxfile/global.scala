...
import typingsJapgolly.jqueryAjaxfile.Chai.ChaiStatic
import typingsJapgolly.jqueryAjaxfile.Mocha.IContextDefinition
import typingsJapgolly.jqueryAjaxfile.Mocha.IRunner
import typingsJapgolly.jqueryAjaxfile.Mocha.ITestDefinition
import typingsJapgolly.jqueryAjaxfile.anon.Bail
import typingsJapgolly.jqueryAjaxfile.anon.Close
...
object global {
  ...
  object Chai_ {
    ...
    open class AssertionError protected ()
      extends StObject
         with typingsJapgolly.jqueryAjaxfile.Chai.AssertionError {
  ...
  object DataType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.jqueryAjaxfile.DataType & Double] = js.native
    
    /* 0 */ val Json: typingsJapgolly.jqueryAjaxfile.DataType.Json & Double = js.native
    
    /* 2 */ val Text: typingsJapgolly.jqueryAjaxfile.DataType.Text & Double = js.native
    
    /* 1 */ val Xml: typingsJapgolly.jqueryAjaxfile.DataType.Xml & Double = js.native
  }
  ...
  object Mocha_ {
    ...
    object reporters {
      ...
      open class Base protected ()
        extends StObject
           with typingsJapgolly.jqueryAjaxfile.Mocha.reporters.Base {
