...
trait Assert extends js.Object {
  ...
  def `match`(exp: js.Any, re: js.RegExp): Unit = js.native
  def `match`(exp: js.Any, re: js.RegExp, msg: String): Unit = js.native
  ...
  def notMatch(exp: js.Any, re: js.RegExp): Unit = js.native
  def notMatch(exp: js.Any, re: js.RegExp, msg: String): Unit = js.native
