...
object ScrollToOptions {
  ...
  def apply(
    ...
    offset: js.Any = null,
    onAfter: js.UndefOr[Callback] = js.undefined,
    onAfterFirst: js.UndefOr[Callback] = js.undefined,
    over: js.Any = null,
    ...
    onAfter.foreach(p => __obj.updateDynamic("onAfter")(p.toJsFn))
    onAfterFirst.foreach(p => __obj.updateDynamic("onAfterFirst")(p.toJsFn))
