...
object ScrollToOptions {
  ...
  extension [Self <: ScrollToOptions](x: Self) {
    ...
    inline def setOnAfter(value: Callback): Self = StObject.set(x, "onAfter", value.toJsFn)
    
    inline def setOnAfterFirst(value: Callback): Self = StObject.set(x, "onAfterFirst", value.toJsFn)
