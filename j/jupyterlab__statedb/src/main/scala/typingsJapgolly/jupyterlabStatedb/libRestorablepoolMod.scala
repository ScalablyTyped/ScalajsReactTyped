...
import typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IObjectPool
import typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorable
...
object libRestorablepoolMod {
  ...
  open class RestorablePool[T /* <: IObservableDisposable */] protected ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def restore(options: typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorable.IOptions[T]): js.Promise[Any] = js.native
