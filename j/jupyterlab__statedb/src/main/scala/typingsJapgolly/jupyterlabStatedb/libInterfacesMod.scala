...
import typingsJapgolly.jupyterlabStatedb.anon.Ids
import typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorable.IOptions
...
object libInterfacesMod {
  ...
  object IObjectPool {
    ...
    extension [Self <: IObjectPool[?], T /* <: IObservableDisposable */](x: Self & IObjectPool[T]) {
      ...
      inline def setForEach(value: js.Function1[/* obj */ T, Unit] => Callback): Self = StObject.set(x, "forEach", js.Any.fromFunction1((t0: js.Function1[/* obj */ T, Unit]) => value(t0).runNow()))
  ...
  object IRestorable {
    ...
    trait IOptions[T /* <: IObservableDisposable */]
      extends StObject
         with typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorer.IOptions[T] {
  ...
  object IRestorer {
    ...
    inline def apply[T /* <: IRestorable[U, Any] */, U /* <: IObservableDisposable */, V](
      restore: (T, typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorable.IOptions[U]) => js.Promise[V],
    ...
    object IOptions {
      ...
      inline def apply[T /* <: IObservableDisposable */](command: String, name: T => String): typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorer.IOptions[T] = {
        val __obj = js.Dynamic.literal(command = command.asInstanceOf[js.Any], name = js.Any.fromFunction1(name))
        __obj.asInstanceOf[typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorer.IOptions[T]]
      }
      
      extension [Self <: typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorer.IOptions[?], T /* <: IObservableDisposable */](x: Self & typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorer.IOptions[T]) {
    ...
    extension [Self <: IRestorer[?, ?, ?], T /* <: IRestorable[U, Any] */, U /* <: IObservableDisposable */, V](x: Self & (IRestorer[T, U, V])) {
      ...
      inline def setRestore(
        value: (T, typingsJapgolly.jupyterlabStatedb.libInterfacesMod.IRestorable.IOptions[U]) => js.Promise[V]
      ): Self = StObject.set(x, "restore", js.Any.fromFunction2(value))
