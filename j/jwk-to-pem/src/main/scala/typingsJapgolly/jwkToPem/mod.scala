...
object mod {
  ...
  trait EC
    ...
    var kty: typingsJapgolly.jwkToPem.jwkToPemStrings.EC
  ...
  object EC {
    ...
    extension [Self <: EC](x: Self) {
      ...
      inline def setKty(value: typingsJapgolly.jwkToPem.jwkToPemStrings.EC): Self = StObject.set(x, "kty", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jwkToPem.mod.EC
    - typingsJapgolly.jwkToPem.mod.ECPrivate
    - typingsJapgolly.jwkToPem.mod.RSA
  */
  trait JWK extends StObject
  object JWK {
    
    inline def EC(crv: String, x: String, y: String): typingsJapgolly.jwkToPem.mod.EC = {
      val __obj = js.Dynamic.literal(crv = crv.asInstanceOf[js.Any], kty = "EC", x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jwkToPem.mod.EC]
    }
    
    inline def ECPrivate(crv: String, d: String): typingsJapgolly.jwkToPem.mod.ECPrivate = {
      val __obj = js.Dynamic.literal(crv = crv.asInstanceOf[js.Any], d = d.asInstanceOf[js.Any], kty = "EC")
      __obj.asInstanceOf[typingsJapgolly.jwkToPem.mod.ECPrivate]
    }
    
    inline def RSA(e: String, n: String): typingsJapgolly.jwkToPem.mod.RSA = {
      val __obj = js.Dynamic.literal(e = e.asInstanceOf[js.Any], kty = "RSA", n = n.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jwkToPem.mod.RSA]
    }
  }
  ...
  object RSA {
    ...
    extension [Self <: RSA](x: Self) {
      ...
      inline def setKty(value: typingsJapgolly.jwkToPem.jwkToPemStrings.RSA): Self = StObject.set(x, "kty", value.asInstanceOf[js.Any])
