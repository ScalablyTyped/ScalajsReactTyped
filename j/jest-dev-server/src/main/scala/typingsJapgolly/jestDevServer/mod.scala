...
import typingsJapgolly.jestDevServer.anon.PartialWaitOnOptions
import typingsJapgolly.jestDevServer.jestDevServerStrings.ask
import typingsJapgolly.jestDevServer.jestDevServerStrings.error
import typingsJapgolly.jestDevServer.jestDevServerStrings.http
import typingsJapgolly.jestDevServer.jestDevServerStrings.https
import typingsJapgolly.jestDevServer.jestDevServerStrings.ignore
import typingsJapgolly.jestDevServer.jestDevServerStrings.kill
import typingsJapgolly.jestDevServer.jestDevServerStrings.socket
import typingsJapgolly.jestDevServer.jestDevServerStrings.tcp
...
object mod {
  ...
  @js.native
  val ERROR_NO_COMMAND: typingsJapgolly.jestDevServer.jestDevServerStrings.ERROR_NO_COMMAND = js.native
  
  @JSImport("jest-dev-server", "ERROR_PORT_USED")
  @js.native
  val ERROR_PORT_USED: typingsJapgolly.jestDevServer.jestDevServerStrings.ERROR_PORT_USED = js.native
  
  @JSImport("jest-dev-server", "ERROR_TIMEOUT")
  @js.native
  val ERROR_TIMEOUT: typingsJapgolly.jestDevServer.jestDevServerStrings.ERROR_TIMEOUT = js.native
