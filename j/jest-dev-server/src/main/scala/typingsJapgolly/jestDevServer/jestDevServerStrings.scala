package typingsJapgolly.jestDevServer
...
object jestDevServerStrings {
  ...
  inline def ERROR_NO_COMMAND: ERROR_NO_COMMAND = "ERROR_NO_COMMAND".asInstanceOf[ERROR_NO_COMMAND]
  
  @js.native
  sealed trait ERROR_PORT_USED extends StObject
  inline def ERROR_PORT_USED: ERROR_PORT_USED = "ERROR_PORT_USED".asInstanceOf[ERROR_PORT_USED]
  
  @js.native
  sealed trait ERROR_TIMEOUT extends StObject
  inline def ERROR_TIMEOUT: ERROR_TIMEOUT = "ERROR_TIMEOUT".asInstanceOf[ERROR_TIMEOUT]
