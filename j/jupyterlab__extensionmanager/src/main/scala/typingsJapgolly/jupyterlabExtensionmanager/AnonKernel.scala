...
import typingsJapgolly.jupyterlabExtensionmanager.companionsMod.IInstallInfo
import typingsJapgolly.jupyterlabExtensionmanager.companionsMod.IKernelInstallInfo
