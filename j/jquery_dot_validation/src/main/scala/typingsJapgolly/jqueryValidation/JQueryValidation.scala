...
object JQueryValidation {
  ...
  object ValidationOptions {
    ...
    extension [Self <: ValidationOptions](x: Self) {
      ...
      inline def setErrorPlacement(value: (/* error */ JQuery, /* element */ JQuery) => Callback): Self = StObject.set(x, "errorPlacement", js.Any.fromFunction2((t0: /* error */ JQuery, t1: /* element */ JQuery) => (value(t0, t1)).runNow()))
      ...
      inline def setHighlight(value: (/* element */ HTMLElement, /* errorClass */ String, /* validClass */ String) => Callback): Self = StObject.set(x, "highlight", js.Any.fromFunction3((t0: /* element */ HTMLElement, t1: /* errorClass */ String, t2: /* validClass */ String) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setInvalidHandler(value: (/* event */ JQueryEventObject, /* validator */ Validator) => Callback): Self = StObject.set(x, "invalidHandler", js.Any.fromFunction2((t0: /* event */ JQueryEventObject, t1: /* validator */ Validator) => (value(t0, t1)).runNow()))
      ...
      inline def setOnclickFunction2(value: (/* element */ HTMLElement, /* event */ JQueryEventObject) => Callback): Self = StObject.set(x, "onclick", js.Any.fromFunction2((t0: /* element */ HTMLElement, t1: /* event */ JQueryEventObject) => (value(t0, t1)).runNow()))
      
      inline def setOnclickUndefined: Self = StObject.set(x, "onclick", js.undefined)
      
      inline def setOnfocusin(value: (/* element */ HTMLElement, /* event */ JQueryEventObject) => Callback): Self = StObject.set(x, "onfocusin", js.Any.fromFunction2((t0: /* element */ HTMLElement, t1: /* event */ JQueryEventObject) => (value(t0, t1)).runNow()))
      ...
      inline def setOnfocusoutFunction2(value: (/* element */ HTMLElement, /* event */ JQueryEventObject) => Callback): Self = StObject.set(x, "onfocusout", js.Any.fromFunction2((t0: /* element */ HTMLElement, t1: /* event */ JQueryEventObject) => (value(t0, t1)).runNow()))
      ...
      inline def setOnkeyupFunction2(value: (/* element */ HTMLElement, /* event */ JQueryEventObject) => Callback): Self = StObject.set(x, "onkeyup", js.Any.fromFunction2((t0: /* element */ HTMLElement, t1: /* event */ JQueryEventObject) => (value(t0, t1)).runNow()))
      ...
      inline def setShowErrors(value: (/* errorMap */ ErrorDictionary, /* errorList */ js.Array[ErrorListItem]) => Callback): Self = StObject.set(x, "showErrors", js.Any.fromFunction2((t0: /* errorMap */ ErrorDictionary, t1: /* errorList */ js.Array[ErrorListItem]) => (value(t0, t1)).runNow()))
      
      inline def setShowErrorsUndefined: Self = StObject.set(x, "showErrors", js.undefined)
      
      inline def setSubmitHandler(value: (/* form */ HTMLFormElement, /* event */ js.UndefOr[JQueryEventObject]) => Callback): Self = StObject.set(x, "submitHandler", js.Any.fromFunction2((t0: /* form */ HTMLFormElement, t1: /* event */ js.UndefOr[JQueryEventObject]) => (value(t0, t1)).runNow()))
      ...
      inline def setSuccessFunction2(value: (/* $label */ JQuery, /* validatedInput */ HTMLElement) => Callback): Self = StObject.set(x, "success", js.Any.fromFunction2((t0: /* $label */ JQuery, t1: /* validatedInput */ HTMLElement) => (value(t0, t1)).runNow()))
      
      inline def setSuccessUndefined: Self = StObject.set(x, "success", js.undefined)
      
      inline def setUnhighlight(value: (/* element */ HTMLElement, /* errorClass */ String, /* validClass */ String) => Callback): Self = StObject.set(x, "unhighlight", js.Any.fromFunction3((t0: /* element */ HTMLElement, t1: /* errorClass */ String, t2: /* validClass */ String) => (value(t0, t1, t2)).runNow()))
