package typingsJapgolly.jqueryValidation.JQueryValidation
...
import typingsJapgolly.jqueryValidation.JQuery
...
object ValidationOptions {
  ...
  def apply(
    ...
    errorPlacement: (/* error */ JQuery, /* element */ JQuery) => Callback = null,
    ...
    highlight: (/* element */ HTMLElement, /* errorClass */ String, /* validClass */ String) => Callback = null,
    ignore: String = null,
    ignoreTitle: js.UndefOr[Boolean] = js.undefined,
    invalidHandler: (/* event */ JQueryEventObject, /* validator */ Validator) => Callback = null,
    messages: js.Object = null,
    meta: String = null,
    onclick: ShouldValidatePredicate = null,
    onfocusin: (/* element */ HTMLElement, /* event */ JQueryEventObject) => Callback = null,
    ...
    showErrors: (/* errorMap */ ErrorDictionary, /* errorList */ js.Array[ErrorListItem]) => Callback = null,
    submitHandler: (/* form */ HTMLFormElement, /* event */ js.UndefOr[JQueryEventObject]) => Callback = null,
    success: String | (js.Function2[/* $label */ JQuery, /* validatedInput */ HTMLElement, Unit]) = null,
    unhighlight: (/* element */ HTMLElement, /* errorClass */ String, /* validClass */ String) => Callback = null,
    ...
    if (errorPlacement != null) __obj.updateDynamic("errorPlacement")(js.Any.fromFunction2((t0: /* error */ typingsJapgolly.jqueryValidation.JQuery, t1: /* element */ typingsJapgolly.jqueryValidation.JQuery) => errorPlacement(t0, t1).runNow()))
    ...
    if (highlight != null) __obj.updateDynamic("highlight")(js.Any.fromFunction3((t0: /* element */ org.scalajs.dom.raw.HTMLElement, t1: /* errorClass */ java.lang.String, t2: /* validClass */ java.lang.String) => highlight(t0, t1, t2).runNow()))
    if (ignore != null) __obj.updateDynamic("ignore")(ignore.asInstanceOf[js.Any])
    if (!js.isUndefined(ignoreTitle)) __obj.updateDynamic("ignoreTitle")(ignoreTitle.asInstanceOf[js.Any])
    if (invalidHandler != null) __obj.updateDynamic("invalidHandler")(js.Any.fromFunction2((t0: /* event */ typingsJapgolly.jquery.JQueryEventObject, t1: /* validator */ typingsJapgolly.jqueryValidation.JQueryValidation.Validator) => invalidHandler(t0, t1).runNow()))
    if (messages != null) __obj.updateDynamic("messages")(messages.asInstanceOf[js.Any])
    if (meta != null) __obj.updateDynamic("meta")(meta.asInstanceOf[js.Any])
    if (onclick != null) __obj.updateDynamic("onclick")(onclick.asInstanceOf[js.Any])
    if (onfocusin != null) __obj.updateDynamic("onfocusin")(js.Any.fromFunction2((t0: /* element */ org.scalajs.dom.raw.HTMLElement, t1: /* event */ typingsJapgolly.jquery.JQueryEventObject) => onfocusin(t0, t1).runNow()))
    ...
    if (showErrors != null) __obj.updateDynamic("showErrors")(js.Any.fromFunction2((t0: /* errorMap */ typingsJapgolly.jqueryValidation.JQueryValidation.ErrorDictionary, t1: /* errorList */ js.Array[typingsJapgolly.jqueryValidation.JQueryValidation.ErrorListItem]) => showErrors(t0, t1).runNow()))
    if (submitHandler != null) __obj.updateDynamic("submitHandler")(js.Any.fromFunction2((t0: /* form */ org.scalajs.dom.raw.HTMLFormElement, t1: /* event */ js.UndefOr[typingsJapgolly.jquery.JQueryEventObject]) => submitHandler(t0, t1).runNow()))
    if (success != null) __obj.updateDynamic("success")(success.asInstanceOf[js.Any])
    if (unhighlight != null) __obj.updateDynamic("unhighlight")(js.Any.fromFunction3((t0: /* element */ org.scalajs.dom.raw.HTMLElement, t1: /* errorClass */ java.lang.String, t2: /* validClass */ java.lang.String) => unhighlight(t0, t1, t2).runNow()))
