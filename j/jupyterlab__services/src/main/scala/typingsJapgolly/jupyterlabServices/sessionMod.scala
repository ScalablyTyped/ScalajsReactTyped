...
object sessionMod extends js.Object {
  ...
  class SessionManager ()
    extends typingsJapgolly.jupyterlabServices.sessionManagerMod.SessionManager {
  ...
  object Session extends js.Object {
    ...
    /**
      ...
      * rejected.
      */
    def startNew(options: typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IOptions): js.Promise[ISession] = js.native
  }
