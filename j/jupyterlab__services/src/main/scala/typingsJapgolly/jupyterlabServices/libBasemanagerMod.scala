...
import typingsJapgolly.jupyterlabServices.libBasemanagerMod.BaseManager.IOptions
...
object libBasemanagerMod {
  ...
  object IManager {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(connectionFailure = connectionFailure.asInstanceOf[js.Any], dispose = dispose.toJsFn, disposed = disposed.asInstanceOf[js.Any], isDisposed = isDisposed.asInstanceOf[js.Any], isReady = isReady.asInstanceOf[js.Any], ready = ready.asInstanceOf[js.Any], serverSettings = serverSettings.asInstanceOf[js.Any])
