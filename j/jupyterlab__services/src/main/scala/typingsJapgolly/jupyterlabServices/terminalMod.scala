...
import typingsJapgolly.jupyterlabServices.terminalManagerMod.TerminalManager.IOptions
import typingsJapgolly.jupyterlabServices.terminalTerminalMod.TerminalSession.IModel
...
object terminalMod extends js.Object {
  ...
  class TerminalManager ()
    extends typingsJapgolly.jupyterlabServices.terminalManagerMod.TerminalManager {
  ...
  object TerminalSession extends js.Object {
    ...
    def connectTo(
      name: String,
      options: typingsJapgolly.jupyterlabServices.terminalTerminalMod.TerminalSession.IOptions
    ...
    def startNew(options: typingsJapgolly.jupyterlabServices.terminalTerminalMod.TerminalSession.IOptions): js.Promise[ISession] = js.native
  }
