...
import typingsJapgolly.jupyterlabServices.libKernelspecKernelspecMod.IManager
import typingsJapgolly.jupyterlabServices.libKernelspecManagerMod.KernelSpecManager.IOptions
...
object libKernelspecManagerMod {
  ...
  - typingsJapgolly.jupyterlabServices.libKernelspecKernelspecMod.IManager because var conflicts: connectionFailure, disposed, isDisposed, isReady, ready. Inlined specsChanged, specs, refreshSpecs */ @JSImport("@jupyterlab/services/lib/kernelspec/manager", "KernelSpecManager")
  @js.native
  /**
