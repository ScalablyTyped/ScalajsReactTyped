...
import typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IOptions
...
object sessionDefaultMod extends js.Object {
  ...
  class DefaultSession protected () extends ISession {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override val model: typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel = js.native
    /**
    ...
    /**
      ...
      */
    def update(model: typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel): Unit = js.native
  }
  ...
  object DefaultSession extends js.Object {
    /**
      ...
      */
    def connectTo(model: typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel): ISession = js.native
    def connectTo(model: typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel, settings: ISettings): ISession = js.native
    /**
      * Find a session by id.
      */
    def findById(id: String): js.Promise[typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel] = js.native
    def findById(id: String, settings: ISettings): js.Promise[typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel] = js.native
    /**
      * Find a session by path.
      */
    def findByPath(path: String): js.Promise[typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel] = js.native
    def findByPath(path: String, settings: ISettings): js.Promise[typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel] = js.native
    /**
      * List the running sessions.
      */
    def listRunning(): js.Promise[js.Array[typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel]] = js.native
    def listRunning(settings: ISettings): js.Promise[js.Array[typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IModel]] = js.native
    /**
