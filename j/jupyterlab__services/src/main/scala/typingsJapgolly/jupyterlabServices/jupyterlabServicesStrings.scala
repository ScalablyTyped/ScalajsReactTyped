...
import typingsJapgolly.jupyterlabServices.contentsMod.Contents.ContentType
import typingsJapgolly.jupyterlabServices.contentsMod.Contents.FileFormat
...
object jupyterlabServicesStrings {
  ...
  sealed trait disconnect
    extends typingsJapgolly.jupyterlabServices.terminalTerminalMod.TerminalSession.MessageType
  ...
  sealed trait stdin
    extends Channel
       with typingsJapgolly.jupyterlabServices.terminalTerminalMod.TerminalSession.MessageType
