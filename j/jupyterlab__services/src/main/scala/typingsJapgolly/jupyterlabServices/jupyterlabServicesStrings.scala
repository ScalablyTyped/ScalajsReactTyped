...
import typingsJapgolly.jupyterlabServices.libContentsMod.Contents.ContentType
import typingsJapgolly.jupyterlabServices.libContentsMod.Contents._FileFormat
...
object jupyterlabServicesStrings {
  ...
  sealed trait connected
    extends StObject
       ...
       with typingsJapgolly.jupyterlabServices.libKernelKernelMod.ConnectionStatus
  ...
  sealed trait disconnect
    extends StObject
       with typingsJapgolly.jupyterlabServices.libTerminalTerminalMod.MessageType
