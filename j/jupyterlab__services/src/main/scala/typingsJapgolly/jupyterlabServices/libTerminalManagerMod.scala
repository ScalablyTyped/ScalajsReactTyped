...
import typingsJapgolly.jupyterlabServices.libTerminalTerminalMod.IManager
...
object libTerminalManagerMod {
  ...
  open class TerminalManager () extends BaseManager {
    ...
    def startNew(options: typingsJapgolly.jupyterlabServices.libTerminalTerminalMod.ITerminal.IOptions): js.Promise[ITerminalConnection] = js.native
  }
