...
import typingsJapgolly.jupyterlabServices.libConfigMod.ConfigSection.IOptions
import typingsJapgolly.jupyterlabServices.libConfigMod.IConfigSection
import typingsJapgolly.jupyterlabServices.libContentsMod.Contents.ICheckpointModel
import typingsJapgolly.jupyterlabServices.libContentsMod.Contents.IModel
import typingsJapgolly.jupyterlabServices.libKernelMessagesMod.IClearOutputMsg
...
object mod {
  ...
  open class ConfigWithDefaults protected ()
    extends typingsJapgolly.jupyterlabServices.libConfigMod.ConfigWithDefaults {
    /**
      * Create a new config with defaults.
      */
    def this(options: typingsJapgolly.jupyterlabServices.libConfigMod.ConfigWithDefaults.IOptions) = this()
  }
  ...
  open class ContentsManager ()
    extends typingsJapgolly.jupyterlabServices.libContentsMod.ContentsManager {
    def this(options: typingsJapgolly.jupyterlabServices.libContentsMod.ContentsManager.IOptions) = this()
  }
  ...
  /**
    ...
    */
  open class Drive ()
    extends typingsJapgolly.jupyterlabServices.libContentsMod.Drive {
  ...
  object KernelAPI {
    ...
    inline def getKernelModel(id: String): js.Promise[js.UndefOr[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getKernelModel")(id.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.UndefOr[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]]]
    inline def getKernelModel(id: String, settings: ISettings): js.Promise[js.UndefOr[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]] = (^.asInstanceOf[js.Dynamic].applyDynamic("getKernelModel")(id.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[js.Promise[js.UndefOr[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]]]
    ...
    inline def listRunning(): js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listRunning")().asInstanceOf[js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]]]
    inline def listRunning(settings: ISettings): js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listRunning")(settings.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]]]
    ...
    inline def startNew(): js.Promise[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel] = ^.asInstanceOf[js.Dynamic].applyDynamic("startNew")().asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]]
    inline def startNew(options: Unit, settings: ISettings): js.Promise[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(options.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]]
    inline def startNew(options: IKernelOptions): js.Promise[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel] = ^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]]
    inline def startNew(options: IKernelOptions, settings: ISettings): js.Promise[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(options.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel]]
  }
  
  @JSImport("@jupyterlab/services", "KernelConnection")
  @js.native
  open class KernelConnection protected ()
    extends typingsJapgolly.jupyterlabServices.libKernelMod.KernelConnection {
    /**
      * Construct a kernel object.
      */
    def this(options: typingsJapgolly.jupyterlabServices.libKernelKernelMod.IKernelConnection.IOptions) = this()
  }
  ...
  open class KernelManager ()
    extends typingsJapgolly.jupyterlabServices.libKernelMod.KernelManager {
    def this(options: typingsJapgolly.jupyterlabServices.libKernelManagerMod.KernelManager.IOptions) = this()
  }
  ...
  object KernelMessage {
    ...
    inline def createMessage[T /* <: IClearOutputMsg */](options: typingsJapgolly.jupyterlabServices.libKernelMessagesMod.IOptions[T]): T = ^.asInstanceOf[js.Dynamic].applyDynamic("createMessage")(options.asInstanceOf[js.Any]).asInstanceOf[T]
  ...
  open class KernelSpecManager ()
    extends typingsJapgolly.jupyterlabServices.libKernelspecMod.KernelSpecManager {
    def this(options: typingsJapgolly.jupyterlabServices.libKernelspecManagerMod.KernelSpecManager.IOptions) = this()
  }
  ...
  open class NbConvertManager ()
    extends typingsJapgolly.jupyterlabServices.libNbconvertMod.NbConvertManager {
    def this(options: typingsJapgolly.jupyterlabServices.libNbconvertMod.NbConvertManager.IOptions) = this()
  }
  ...
  object ServerConnection {
    ...
    open class NetworkError protected ()
      extends typingsJapgolly.jupyterlabServices.libServerconnectionMod.ServerConnection.NetworkError {
      /**
    ...
    open class ResponseError protected ()
      extends typingsJapgolly.jupyterlabServices.libServerconnectionMod.ServerConnection.ResponseError {
      /**
    ...
    object ResponseError {
      ...
      /**
        ...
        */
      /* static member */
      inline def create(response: Response): js.Promise[
            typingsJapgolly.jupyterlabServices.libServerconnectionMod.ServerConnection.ResponseError
          ] = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(response.asInstanceOf[js.Any]).asInstanceOf[js.Promise[
            typingsJapgolly.jupyterlabServices.libServerconnectionMod.ServerConnection.ResponseError
          ]]
    }
  ...
  open class ServiceManager ()
    extends typingsJapgolly.jupyterlabServices.libManagerMod.ServiceManager {
    def this(options: typingsJapgolly.jupyterlabServices.libManagerMod.ServiceManager.IOptions) = this()
  }
  ...
  object SessionAPI {
    ...
    inline def getSessionModel(id: String): js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel] = ^.asInstanceOf[js.Dynamic].applyDynamic("getSessionModel")(id.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]]
    inline def getSessionModel(id: String, settings: ISettings): js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("getSessionModel")(id.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]]
    ...
    inline def listRunning(): js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listRunning")().asInstanceOf[js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]]]
    inline def listRunning(settings: ISettings): js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listRunning")(settings.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]]]
    ...
    inline def startSession(options: ISessionOptions): js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel] = ^.asInstanceOf[js.Dynamic].applyDynamic("startSession")(options.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]]
    inline def startSession(options: ISessionOptions, settings: ISettings): js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startSession")(options.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]]
    
    inline def updateSession(model: PickIModelidDeepPartialOm): js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel] = ^.asInstanceOf[js.Dynamic].applyDynamic("updateSession")(model.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]]
    inline def updateSession(model: PickIModelidDeepPartialOm, settings: ISettings): js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("updateSession")(model.asInstanceOf[js.Any], settings.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libSessionSessionMod.IModel]]
  }
  
  @JSImport("@jupyterlab/services", "SessionManager")
  @js.native
  open class SessionManager protected ()
    extends typingsJapgolly.jupyterlabServices.libSessionMod.SessionManager {
    /**
      * Construct a new session manager.
      *
      * @param options - The default options for each session.
      */
    def this(options: typingsJapgolly.jupyterlabServices.libSessionManagerMod.SessionManager.IOptions) = this()
  }
  ...
  open class SettingManager ()
    extends typingsJapgolly.jupyterlabServices.libSettingMod.SettingManager {
    def this(options: typingsJapgolly.jupyterlabServices.libSettingMod.SettingManager.IOptions) = this()
  }
  ...
  object TerminalAPI {
    ...
    inline def listRunning(): js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listRunning")().asInstanceOf[js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]]
    inline def listRunning(settings: ISettings): js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]] = ^.asInstanceOf[js.Dynamic].applyDynamic("listRunning")(settings.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.Array[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]]
    ...
    inline def startNew(): js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel] = ^.asInstanceOf[js.Dynamic].applyDynamic("startNew")().asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]
    inline def startNew(settings: Unit, name: String): js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(settings.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]
    inline def startNew(settings: Unit, name: String, cwd: String): js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(settings.asInstanceOf[js.Any], name.asInstanceOf[js.Any], cwd.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]
    inline def startNew(settings: Unit, name: Unit, cwd: String): js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(settings.asInstanceOf[js.Any], name.asInstanceOf[js.Any], cwd.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]
    inline def startNew(settings: ISettings): js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel] = ^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(settings.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]
    inline def startNew(settings: ISettings, name: String): js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(settings.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]
    inline def startNew(settings: ISettings, name: String, cwd: String): js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(settings.asInstanceOf[js.Any], name.asInstanceOf[js.Any], cwd.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]
    inline def startNew(settings: ISettings, name: Unit, cwd: String): js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel] = (^.asInstanceOf[js.Dynamic].applyDynamic("startNew")(settings.asInstanceOf[js.Any], name.asInstanceOf[js.Any], cwd.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.jupyterlabServices.libTerminalRestapiMod.IModel]]
  }
  ...
  open class TerminalManager ()
    extends typingsJapgolly.jupyterlabServices.libTerminalMod.TerminalManager {
    def this(options: typingsJapgolly.jupyterlabServices.libTerminalManagerMod.TerminalManager.IOptions) = this()
  }
  ...
  open class WorkspaceManager ()
    extends typingsJapgolly.jupyterlabServices.libWorkspaceMod.WorkspaceManager {
    def this(options: typingsJapgolly.jupyterlabServices.libWorkspaceMod.WorkspaceManager.IOptions) = this()
  }
}
