...
import typingsJapgolly.jupyterlabObservables.libModeldbMod.ModelDB.IFactory
import typingsJapgolly.jupyterlabServices.anon.PartialIModel
...
import typingsJapgolly.jupyterlabServices.libContentsMod.Contents.IChangedArgs
import typingsJapgolly.jupyterlabServices.libContentsMod.Contents.IDrive
import typingsJapgolly.jupyterlabServices.libContentsMod.Contents.IManager
import typingsJapgolly.jupyterlabServices.libContentsMod.ContentsManager.IOptions
...
object libContentsMod {
  ...
  object Contents {
    ...
    */
    ...
    object ContentType {
      ...
      inline def directory: typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.directory = "directory".asInstanceOf[typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.directory]
      
      inline def file: typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.file = "file".asInstanceOf[typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.file]
      
      inline def notebook: typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.notebook = "notebook".asInstanceOf[typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.notebook]
    }
  ...
  open class Drive ()
    extends StObject
       with IDrive {
    def this(options: typingsJapgolly.jupyterlabServices.libContentsMod.Drive.IOptions) = this()
  ...
  object Drive {
    ...
    object IOptions {
      ...
      inline def apply(): typingsJapgolly.jupyterlabServices.libContentsMod.Drive.IOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.jupyterlabServices.libContentsMod.Drive.IOptions]
      }
      
      extension [Self <: typingsJapgolly.jupyterlabServices.libContentsMod.Drive.IOptions](x: Self) {
