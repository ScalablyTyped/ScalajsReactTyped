...
object libKernelMod {
  ...
  open class KernelConnection protected ()
    extends typingsJapgolly.jupyterlabServices.libKernelDefaultMod.KernelConnection {
    /**
  ...
  open class KernelManager ()
    extends typingsJapgolly.jupyterlabServices.libKernelManagerMod.KernelManager {
