package typingsJapgolly.jupyterlabServices.sessionManagerMod
...
class SessionManager_ () extends IManager {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def startNew(options: typingsJapgolly.jupyterlabServices.sessionSessionMod.Session.IOptions): js.Promise[ISession] = js.native
  /**
