...
import typingsJapgolly.jupyterlabServices.libSessionSessionMod.ISessionConnection.IKernelChangedArgs
import typingsJapgolly.jupyterlabServices.libSessionSessionMod.ISessionConnection.IOptions
...
object libSessionDefaultMod {
  ...
  open class SessionConnection protected ()
    ...
    /* protected */ def setupKernel(model: typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel): Unit = js.native
