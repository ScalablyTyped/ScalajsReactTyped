...
import typingsJapgolly.jupyterlabServices.anon.OmitIOptionsmodelusername
import typingsJapgolly.jupyterlabServices.anon.PartialIModelConnections
import typingsJapgolly.jupyterlabServices.anon.PartialPickIModelname
import typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.`type`
import typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.kernel
...
object libSessionSessionMod {
  ...
  trait IModel extends StObject {
    ...
    val kernel: typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel | Null
  ...
  object IModel {
    ...
    extension [Self <: IModel](x: Self) {
      ...
      inline def setKernel(value: typingsJapgolly.jupyterlabServices.libKernelRestapiMod.IModel): Self = StObject.set(x, "kernel", value.asInstanceOf[js.Any])
  ...
  trait ISessionConnection
    ...
    var kernelChanged: ISignal[
        ...
        IChangedArgs[
          ...
          IKernelConnection | Null, 
          typingsJapgolly.jupyterlabServices.jupyterlabServicesStrings.kernel
        ]
      ]
  ...
  object ISessionConnection {
    ...
    trait IOptions extends StObject {
      ...
      /**
        ...
        */
      def connectToKernel(options: typingsJapgolly.jupyterlabServices.libKernelKernelMod.IKernelConnection.IOptions): IKernelConnection
    ...
    object IOptions {
      ...
      inline def apply(
        connectToKernel: typingsJapgolly.jupyterlabServices.libKernelKernelMod.IKernelConnection.IOptions => IKernelConnection,
        model: IModel
      ): IOptions = {
      ...
      extension [Self <: IOptions](x: Self) {
        ...
        inline def setConnectToKernel(
          value: typingsJapgolly.jupyterlabServices.libKernelKernelMod.IKernelConnection.IOptions => IKernelConnection
