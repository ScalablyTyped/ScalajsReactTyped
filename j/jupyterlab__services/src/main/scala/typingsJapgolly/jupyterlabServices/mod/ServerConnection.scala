...
import typingsJapgolly.jupyterlabServices.PartialISettings
...
object ServerConnection extends js.Object {
  ...
  class NetworkError protected ()
    extends typingsJapgolly.jupyterlabServices.serverconnectionMod.ServerConnection.NetworkError {
    /**
  ...
  class ResponseError protected ()
    extends typingsJapgolly.jupyterlabServices.serverconnectionMod.ServerConnection.ResponseError {
    /**
