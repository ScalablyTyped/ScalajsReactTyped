package typingsJapgolly.jake

import japgolly.scalajs.react.Callback
import typingsJapgolly.jake.anon.Dictname
import typingsJapgolly.jake.mod.global.jake.DirectoryTask
import typingsJapgolly.jake.mod.global.jake.FileTask
import typingsJapgolly.jake.mod.global.jake.FileTaskOptions
import typingsJapgolly.jake.mod.global.jake.NpmPublishTask
import typingsJapgolly.jake.mod.global.jake.Task
import typingsJapgolly.jake.mod.global.jake.TaskOptions
...
object mod {
  ...
  object global {
    ...
    object jake {
      ...
      inline def addListener(event: String, listener: js.Function): typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter = (^.asInstanceOf[js.Dynamic].applyDynamic("addListener")(event.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter]
      ...
      inline def on(event: String, listener: js.Function): typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter = (^.asInstanceOf[js.Dynamic].applyDynamic("on")(event.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter]
      
      inline def once(event: String, listener: js.Function): typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter = (^.asInstanceOf[js.Dynamic].applyDynamic("once")(event.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter]
      ...
      inline def removeAllListener(event: String): typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter = ^.asInstanceOf[js.Dynamic].applyDynamic("removeAllListener")(event.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter]
      
      inline def removeListener(event: String, listener: js.Function): typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter = (^.asInstanceOf[js.Dynamic].applyDynamic("removeListener")(event.asInstanceOf[js.Any], listener.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.node.eventsMod.global.NodeJS.EventEmitter]
      ...
      object Logger_ {
        ...
        inline def apply(error: Any => Callback, log: Any => Callback): Logger_ = {
          val __obj = js.Dynamic.literal(error = js.Any.fromFunction1((t0: Any) => error(t0).runNow()), log = js.Any.fromFunction1((t0: Any) => log(t0).runNow()))
