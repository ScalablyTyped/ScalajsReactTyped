...
object distSrcReportingScenarioResultTrackingScenarioResultTrackerMod {
  ...
  object IScenarioResult {
    ...
    extension [Self <: IScenarioResult](x: Self) {
      ...
      inline def setStepResultsVarargs(value: IStepResult*): Self = StObject.set(x, "stepResults", js.Array(value*))
    }
  }
  ...
  object IStepResult {
    ...
    extension [Self <: IStepResult](x: Self) {
      ...
      inline def setStepArgumentsVarargs(value: String*): Self = StObject.set(x, "stepArguments", js.Array(value*))
