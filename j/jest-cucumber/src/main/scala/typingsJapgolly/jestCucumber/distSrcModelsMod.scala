...
object distSrcModelsMod {
  ...
  object FeatureFromStepDefinitions {
    ...
    extension [Self <: FeatureFromStepDefinitions](x: Self) {
      ...
      inline def setScenariosVarargs(value: ScenarioFromStepDefinitions*): Self = StObject.set(x, "scenarios", js.Array(value*))
  ...
  object ParsedFeature {
    ...
    extension [Self <: ParsedFeature](x: Self) {
      ...
      inline def setScenarioOutlinesVarargs(value: ParsedScenarioOutline*): Self = StObject.set(x, "scenarioOutlines", js.Array(value*))
      
      inline def setScenarios(value: js.Array[ParsedScenario]): Self = StObject.set(x, "scenarios", value.asInstanceOf[js.Any])
      
      inline def setScenariosVarargs(value: ParsedScenario*): Self = StObject.set(x, "scenarios", js.Array(value*))
  ...
  object ParsedScenario {
    ...
    extension [Self <: ParsedScenario](x: Self) {
      ...
      inline def setStepsVarargs(value: ParsedStep*): Self = StObject.set(x, "steps", js.Array(value*))
  ...
  object ScenarioFromStepDefinitions {
    ...
    extension [Self <: ScenarioFromStepDefinitions](x: Self) {
      ...
      inline def setStepsVarargs(value: StepFromStepDefinitions*): Self = StObject.set(x, "steps", js.Array(value*))
  ...
  object ScenarioNameTemplateVars {
    ...
    extension [Self <: ScenarioNameTemplateVars](x: Self) {
      ...
      inline def setFeatureTagsVarargs(value: String*): Self = StObject.set(x, "featureTags", js.Array(value*))
      ...
      inline def setScenarioTagsVarargs(value: String*): Self = StObject.set(x, "scenarioTags", js.Array(value*))
  ...
  trait StepFromStepDefinitions extends StObject {
    ...
    def stepFunction(): Unit | PromiseLike[Any] = js.native
    def stepFunction(stepArguments: Any): Unit | PromiseLike[Any] = js.native
    
    var stepMatcher: String | js.RegExp = js.native
  }
}
