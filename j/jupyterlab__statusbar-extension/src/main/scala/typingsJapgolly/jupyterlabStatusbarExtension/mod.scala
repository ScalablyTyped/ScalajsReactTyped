package typingsJapgolly.jupyterlabStatusbarExtension

import typingsJapgolly.jupyterlabApplication.frontendMod.JupyterFrontEndPlugin
import typingsJapgolly.jupyterlabStatusbarExtension.jupyterlabStatusbarExtensionStrings.`@jupyterlabSlashstatusbar-extensionColonplugin`
