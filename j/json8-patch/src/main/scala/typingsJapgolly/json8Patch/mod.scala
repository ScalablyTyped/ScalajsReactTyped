package typingsJapgolly.json8Patch

import typingsJapgolly.json8Patch.anon.Reversible
import typingsJapgolly.json8Patch.anon.`0`
...
object mod {
  ...
  inline def apply(doc: Any, patch: JsonPatch): ApplyResultWithRevert = (^.asInstanceOf[js.Dynamic].applyDynamic("apply")(doc.asInstanceOf[js.Any], patch.asInstanceOf[js.Any])).asInstanceOf[ApplyResultWithRevert]
  ...
  inline def apply_ApplyResult(doc: Any, patch: JsonPatch): ApplyResult = (^.asInstanceOf[js.Dynamic].applyDynamic("apply")(doc.asInstanceOf[js.Any], patch.asInstanceOf[js.Any])).asInstanceOf[ApplyResult]
  ...
  inline def patch(doc: Any, patch: JsonPatch): PatchResultWithRevert = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(doc.asInstanceOf[js.Any], patch.asInstanceOf[js.Any])).asInstanceOf[PatchResultWithRevert]
  ...
  inline def patch_PatchResult(doc: Any, patch: JsonPatch): PatchResult = (^.asInstanceOf[js.Dynamic].applyDynamic("patch")(doc.asInstanceOf[js.Any], patch.asInstanceOf[js.Any])).asInstanceOf[PatchResult]
  ...
  */
  ...
  object JsonPatchOperation {
    ...
    inline def AddOperation(path: String, value: Any): typingsJapgolly.json8Patch.mod.AddOperation = {
      val __obj = js.Dynamic.literal(op = "add", path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.json8Patch.mod.AddOperation]
    }
    
    inline def CopyOperation(from: Any, path: String): typingsJapgolly.json8Patch.mod.CopyOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = "copy", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.json8Patch.mod.CopyOperation]
    }
    
    inline def MoveOperation(from: Any, path: String): typingsJapgolly.json8Patch.mod.MoveOperation = {
      val __obj = js.Dynamic.literal(from = from.asInstanceOf[js.Any], op = "move", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.json8Patch.mod.MoveOperation]
    }
    
    inline def RemoveOperation(path: String): typingsJapgolly.json8Patch.mod.RemoveOperation = {
      val __obj = js.Dynamic.literal(op = "remove", path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.json8Patch.mod.RemoveOperation]
    }
    
    inline def ReplaceOperation(path: String, value: Any): typingsJapgolly.json8Patch.mod.ReplaceOperation = {
      val __obj = js.Dynamic.literal(op = "replace", path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.json8Patch.mod.ReplaceOperation]
    }
    
    inline def TestOperation(path: String, value: Any): typingsJapgolly.json8Patch.mod.TestOperation = {
      val __obj = js.Dynamic.literal(op = "test", path = path.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.json8Patch.mod.TestOperation]
    }
  }
