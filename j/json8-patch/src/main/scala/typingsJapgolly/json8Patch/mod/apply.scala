...
import typingsJapgolly.json8Patch.Anon0
import typingsJapgolly.json8Patch.AnonReversible
...
object apply extends js.Object {
  def apply(doc: js.Any, patch: JsonPatch): ApplyResultWithRevert = js.native
