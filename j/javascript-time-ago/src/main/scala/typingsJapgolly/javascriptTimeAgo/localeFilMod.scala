...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.fil
...
object localeFilMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeFilMod.foo` */
