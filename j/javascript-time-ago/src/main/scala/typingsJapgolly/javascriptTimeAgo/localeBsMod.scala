...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.bs
...
object localeBsMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeBsMod.foo` */
