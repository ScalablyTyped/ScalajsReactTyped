...
object localeKoMod extends Shortcut {
  ...
  object Locale {
    ...
    extension [Self <: Locale](x: Self) {
      ...
      inline def setLocale(value: ko): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `localeKoMod.foo` */
