...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.tk
...
object localeTkMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeTkMod.foo` */
