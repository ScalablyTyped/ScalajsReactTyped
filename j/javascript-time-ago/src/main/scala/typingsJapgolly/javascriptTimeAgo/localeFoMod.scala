...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.fo
...
object localeFoMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeFoMod.foo` */
