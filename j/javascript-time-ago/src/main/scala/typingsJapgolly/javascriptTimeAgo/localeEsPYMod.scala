...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.`es-PY`
...
object localeEsPYMod extends Shortcut {
  
  @JSImport("javascript-time-ago/locale/es-PY", JSImport.Namespace)
  @js.native
  ...
  object Locale {
    ...
    inline def apply(narrow: Duration, quantify: Double => one | two | few | other, short: Duration): Locale = {
      val __obj = js.Dynamic.literal(locale = "es-PY", narrow = narrow.asInstanceOf[js.Any], quantify = js.Any.fromFunction1(quantify), short = short.asInstanceOf[js.Any])
      __obj.asInstanceOf[Locale]
    }
    
    extension [Self <: Locale](x: Self) {
      
      inline def setLocale(value: `es-PY`): Self = StObject.set(x, "locale", value.asInstanceOf[js.Any])
  ...
  /* This means you don't have to write `^`, but can instead just say `localeEsPYMod.foo` */
