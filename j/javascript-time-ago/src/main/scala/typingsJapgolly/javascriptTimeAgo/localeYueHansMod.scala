...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.`yue-Hans`
...
object localeYueHansMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeYueHansMod.foo` */
