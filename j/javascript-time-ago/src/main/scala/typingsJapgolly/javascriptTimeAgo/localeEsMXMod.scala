...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.`es-MX`
...
object localeEsMXMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeEsMXMod.foo` */
