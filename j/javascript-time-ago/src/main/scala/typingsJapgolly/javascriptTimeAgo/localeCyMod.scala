...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.cy
...
object localeCyMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeCyMod.foo` */
