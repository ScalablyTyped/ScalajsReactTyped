...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.ku
...
object localeKuMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeKuMod.foo` */
