...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.`zh-Hant-HK`
...
object localeZhHantHKMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeZhHantHKMod.foo` */
