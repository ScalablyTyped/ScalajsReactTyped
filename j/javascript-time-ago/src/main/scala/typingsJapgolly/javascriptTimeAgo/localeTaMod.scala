...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.ta
...
object localeTaMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeTaMod.foo` */
