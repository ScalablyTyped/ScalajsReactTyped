...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.ja
...
object localeJaMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeJaMod.foo` */
