...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.ga
...
object localeGaMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeGaMod.foo` */
