...
import typingsJapgolly.javascriptTimeAgo.javascriptTimeAgoStrings.ast
...
object localeAstMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `localeAstMod.foo` */
