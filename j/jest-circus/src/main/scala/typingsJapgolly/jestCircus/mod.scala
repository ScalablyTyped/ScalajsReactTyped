...
import typingsJapgolly.jestCircus.anon.Call
import typingsJapgolly.jestCircus.anon.Each
...
import typingsJapgolly.jestTypes.mod.It
import typingsJapgolly.jestTypes.mod.RunResult
...
object mod {
  ...
  inline def getState(): typingsJapgolly.jestTypes.mod.State = ^.asInstanceOf[js.Dynamic].applyDynamic("getState")().asInstanceOf[typingsJapgolly.jestTypes.mod.State]
  ...
  inline def setState(state: typingsJapgolly.jestTypes.mod.State): typingsJapgolly.jestTypes.mod.State = ^.asInstanceOf[js.Dynamic].applyDynamic("setState")(state.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.jestTypes.mod.State]
  ...
  type State = typingsJapgolly.jestTypes.mod.State
