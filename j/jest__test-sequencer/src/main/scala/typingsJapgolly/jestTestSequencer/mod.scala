package typingsJapgolly.jestTestSequencer
...
import typingsJapgolly.jestTestSequencer.jestTestSequencerInts.`0`
import typingsJapgolly.jestTestSequencer.jestTestSequencerInts.`1`
...
object mod {
  ...
  object TestSequencer {
    ...
    inline def apply(
      ...
      cacheResults: (js.Array[Test], AggregatedResult) => Callback,
      hasFailed: Any,
      ...
      val __obj = js.Dynamic.literal(_cache = _cache.asInstanceOf[js.Any], _getCache = js.Any.fromFunction1(_getCache), _getCachePath = js.Any.fromFunction1(_getCachePath), allFailedTests = js.Any.fromFunction1(allFailedTests), cacheResults = js.Any.fromFunction2((t0: js.Array[Test], t1: AggregatedResult) => (cacheResults(t0, t1)).runNow()), hasFailed = hasFailed.asInstanceOf[js.Any], shard = js.Any.fromFunction2(shard), sort = js.Any.fromFunction1(sort), time = time.asInstanceOf[js.Any])
    ...
    extension [Self <: TestSequencer](x: Self) {
      ...
      inline def setCacheResults(value: (js.Array[Test], AggregatedResult) => Callback): Self = StObject.set(x, "cacheResults", js.Any.fromFunction2((t0: js.Array[Test], t1: AggregatedResult) => (value(t0, t1)).runNow()))
