...
object algorithm {
  ...
  object ConvexHull {
    ...
    inline def apply(getConvexHull: CallbackTo[Geometry]): ConvexHull = {
      val __obj = js.Dynamic.literal(getConvexHull = getConvexHull.toJsFn)
      __obj.asInstanceOf[ConvexHull]
    }
    
    extension [Self <: ConvexHull](x: Self) {
      
      inline def setGetConvexHull(value: CallbackTo[Geometry]): Self = StObject.set(x, "getConvexHull", value.toJsFn)
    }
  }
  ...
  object InteriorPointArea {
    ...
    inline def apply(getInteriorPoint: CallbackTo[Coordinate | Null]): InteriorPointArea = {
      val __obj = js.Dynamic.literal(getInteriorPoint = getInteriorPoint.toJsFn)
      __obj.asInstanceOf[InteriorPointArea]
    }
    
    extension [Self <: InteriorPointArea](x: Self) {
      
      inline def setGetInteriorPoint(value: CallbackTo[Coordinate | Null]): Self = StObject.set(x, "getInteriorPoint", value.toJsFn)
    }
  }
