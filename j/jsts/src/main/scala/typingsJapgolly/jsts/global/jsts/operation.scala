...
object operation {
  ...
  open class GeometryGraphOperation protected ()
    extends StObject
       with typingsJapgolly.jsts.jsts.operation.GeometryGraphOperation {
  ...
  object buffer {
    ...
    open class BufferOp protected ()
      extends StObject
         with typingsJapgolly.jsts.jsts.operation.buffer.BufferOp {
      /**
        ...
        * @constructor
        */
      def this(g: Geometry, bufParams: typingsJapgolly.jsts.jsts.operation.buffer.BufferParameters) = this()
    ...
    object BufferOp {
      ...
      /**
        ...
        *
        */
      inline def bufferOp2(g: Geometry, distance: Double, params: typingsJapgolly.jsts.jsts.operation.buffer.BufferParameters): Geometry = (^.asInstanceOf[js.Dynamic].applyDynamic("bufferOp2")(g.asInstanceOf[js.Any], distance.asInstanceOf[js.Any], params.asInstanceOf[js.Any])).asInstanceOf[Geometry]
    ...
    open class BufferParameters ()
      extends StObject
         with typingsJapgolly.jsts.jsts.operation.buffer.BufferParameters {
  ...
  object distance {
    ...
    open class DistanceOp protected ()
      extends StObject
         with typingsJapgolly.jsts.jsts.operation.distance.DistanceOp {
      /**
      ...
      override def nearestLocations(): js.Tuple2[
            typingsJapgolly.jsts.jsts.operation.distance.GeometryLocation, 
            typingsJapgolly.jsts.jsts.operation.distance.GeometryLocation
          ] = js.native
    ...
    open class GeometryLocation protected ()
      extends StObject
         with typingsJapgolly.jsts.jsts.operation.distance.GeometryLocation {
      /**
  ...
  object relate {
    ...
    open class RelateOp protected ()
      extends StObject
         with typingsJapgolly.jsts.jsts.operation.relate.RelateOp {
