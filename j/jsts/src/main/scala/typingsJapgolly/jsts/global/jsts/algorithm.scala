...
import typingsJapgolly.jsts.jsts.geom.Polygon
...
object algorithm {
  ...
  open class BoundaryNodeRule ()
    extends StObject
       with typingsJapgolly.jsts.jsts.algorithm.BoundaryNodeRule
  
  @JSGlobal("jsts.algorithm.ConvexHull")
  @js.native
  open class ConvexHull protected ()
    extends StObject
       with typingsJapgolly.jsts.jsts.algorithm.ConvexHull {
    /**
  ...
  open class InteriorPointArea protected ()
    extends StObject
       with typingsJapgolly.jsts.jsts.algorithm.InteriorPointArea {
    /**
  ...
  open class LineIntersector ()
    extends StObject
       with typingsJapgolly.jsts.jsts.algorithm.LineIntersector
  /* static members */
  ...
  open class Orientation ()
    extends StObject
       with typingsJapgolly.jsts.jsts.algorithm.Orientation
  /* static members */
  object Orientation {
  ...
  open class RobustLineIntersector ()
    extends StObject
       with typingsJapgolly.jsts.jsts.algorithm.RobustLineIntersector
  ...
  object locate {
    ...
    open class SimplePointInAreaLocator protected ()
      extends StObject
         with typingsJapgolly.jsts.jsts.algorithm.locate.SimplePointInAreaLocator {
      /**
