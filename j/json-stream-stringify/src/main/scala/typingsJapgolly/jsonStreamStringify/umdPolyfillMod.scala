package typingsJapgolly.jsonStreamStringify
...
object umdPolyfillMod {
  
  @JSImport("json-stream-stringify/umd/polyfill", "JsonStreamStringify")
  @js.native
  open class JsonStreamStringify protected ()
    extends typingsJapgolly.jsonStreamStringify.mod.JsonStreamStringify {
  ...
  @JSImport("json-stream-stringify/umd/polyfill", "Types")
  @js.native
  object Types extends StObject {
    
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.jsonStreamStringify.mod.Types & Double] = js.native
    
    /* 0 */ val Array: typingsJapgolly.jsonStreamStringify.mod.Types.Array & Double = js.native
    
    /* 1 */ val Object: typingsJapgolly.jsonStreamStringify.mod.Types.Object & Double = js.native
    
    /* 4 */ val Primitive: typingsJapgolly.jsonStreamStringify.mod.Types.Primitive & Double = js.native
    
    /* 5 */ val Promise: typingsJapgolly.jsonStreamStringify.mod.Types.Promise & Double = js.native
    
    /* 3 */ val ReadableObject: typingsJapgolly.jsonStreamStringify.mod.Types.ReadableObject & Double = js.native
    
    /* 2 */ val ReadableString: typingsJapgolly.jsonStreamStringify.mod.Types.ReadableString & Double = js.native
  }
}
