package typingsJapgolly.jestResolve
...
import typingsJapgolly.jestResolve.anon.FilePath
import typingsJapgolly.jestResolve.anon.RequireResolveFunction
import typingsJapgolly.jestResolve.anon.TypeofModuleNotFoundError
...
object mod {
  ...
  object default {
    ...
    open class ModuleNotFoundError protected ()
      extends StObject
         with typingsJapgolly.jestResolve.mod.ModuleNotFoundError {
    ...
    def ModuleNotFoundError: TypeofModuleNotFoundError & (Instantiable2[
        ...
        typingsJapgolly.jestResolve.mod.ModuleNotFoundError
      ]) = js.native
    ...
    /* static member */
    inline def tryCastModuleNotFoundError(error: Any): typingsJapgolly.jestResolve.mod.ModuleNotFoundError | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("tryCastModuleNotFoundError")(error.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.jestResolve.mod.ModuleNotFoundError | Null]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jestResolve.mod.ResolverSyncObject
    - typingsJapgolly.jestResolve.mod.ResolverAsyncObject
  */
  trait JestResolver extends StObject
  object JestResolver {
    
    inline def ResolverAsyncObject(async: (/* path */ String, /* options */ ResolverOptions) => js.Promise[String]): typingsJapgolly.jestResolve.mod.ResolverAsyncObject = {
      val __obj = js.Dynamic.literal(async = js.Any.fromFunction2(async))
      __obj.asInstanceOf[typingsJapgolly.jestResolve.mod.ResolverAsyncObject]
    }
    
    inline def ResolverSyncObject(sync: (/* path */ String, /* options */ ResolverOptions) => String): typingsJapgolly.jestResolve.mod.ResolverSyncObject = {
      val __obj = js.Dynamic.literal(sync = js.Any.fromFunction2(sync))
      __obj.asInstanceOf[typingsJapgolly.jestResolve.mod.ResolverSyncObject]
    }
  }
  ...
  object ModuleNotFoundError {
    ...
    inline def apply(
      ...
      buildMessage: String => Callback,
      code: String,
      message: String,
      name: String
    ): ModuleNotFoundError = {
      val __obj = js.Dynamic.literal(_originalMessage = _originalMessage.asInstanceOf[js.Any], buildMessage = js.Any.fromFunction1((t0: String) => buildMessage(t0).runNow()), code = code.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[ModuleNotFoundError]
    }
    
    extension [Self <: ModuleNotFoundError](x: Self) {
      
      inline def setBuildMessage(value: String => Callback): Self = StObject.set(x, "buildMessage", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
