...
object FilterTable {
  ...
  object FilterTableOptions {
    ...
    extension [Self <: FilterTableOptions](x: Self) {
      ...
      inline def setCallback(value: (/* term */ String, /* table */ JQuery) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* term */ String, t1: /* table */ JQuery) => (value(t0, t1)).runNow()))
