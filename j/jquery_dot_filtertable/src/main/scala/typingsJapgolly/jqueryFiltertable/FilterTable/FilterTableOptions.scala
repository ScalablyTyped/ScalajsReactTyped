package typingsJapgolly.jqueryFiltertable.FilterTable

import japgolly.scalajs.react.Callback
import typingsJapgolly.jqueryFiltertable.JQuery
...
object FilterTableOptions {
  ...
  def apply(
    ...
    callback: (/* term */ String, /* table */ JQuery) => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction2((t0: /* term */ java.lang.String, t1: /* table */ typingsJapgolly.jqueryFiltertable.JQuery) => callback(t0, t1).runNow()))
