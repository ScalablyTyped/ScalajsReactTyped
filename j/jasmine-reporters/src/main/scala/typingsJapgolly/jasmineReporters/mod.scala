package typingsJapgolly.jasmineReporters

import typingsJapgolly.jasmine.jasmine.CustomReporter
import typingsJapgolly.jasmine.jasmine.SpecResult
import typingsJapgolly.jasmine.jasmine.SuiteResult
import typingsJapgolly.jasmineReporters.jasmineReportersInts.`0`
import typingsJapgolly.jasmineReporters.jasmineReportersInts.`1`
import typingsJapgolly.jasmineReporters.jasmineReportersInts.`2`
import typingsJapgolly.jasmineReporters.jasmineReportersInts.`3`
import typingsJapgolly.jasmineReporters.mod.AppVeyorReporter.ConstructorOptions
...
object mod {
  ...
  open class JUnitXmlReporter ()
    extends StObject
       with CustomReporter {
    def this(options: typingsJapgolly.jasmineReporters.mod.JUnitXmlReporter.ConstructorOptions) = this()
  }
  object JUnitXmlReporter {
    ...
    object ConstructorOptions {
      ...
      inline def apply(): typingsJapgolly.jasmineReporters.mod.JUnitXmlReporter.ConstructorOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.jasmineReporters.mod.JUnitXmlReporter.ConstructorOptions]
      }
      
      extension [Self <: typingsJapgolly.jasmineReporters.mod.JUnitXmlReporter.ConstructorOptions](x: Self) {
  ...
  open class NUnitXmlReporter ()
    extends StObject
       with CustomReporter {
    def this(options: typingsJapgolly.jasmineReporters.mod.NUnitXmlReporter.ConstructorOptions) = this()
  }
  object NUnitXmlReporter {
    ...
    object ConstructorOptions {
      ...
      inline def apply(): typingsJapgolly.jasmineReporters.mod.NUnitXmlReporter.ConstructorOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.jasmineReporters.mod.NUnitXmlReporter.ConstructorOptions]
      }
      
      extension [Self <: typingsJapgolly.jasmineReporters.mod.NUnitXmlReporter.ConstructorOptions](x: Self) {
  ...
  open class TeamCityReporter ()
    extends StObject
       with CustomReporter {
    def this(options: typingsJapgolly.jasmineReporters.mod.TeamCityReporter.ConstructorOptions) = this()
  }
  object TeamCityReporter {
    ...
    object ConstructorOptions {
      ...
      inline def apply(): typingsJapgolly.jasmineReporters.mod.TeamCityReporter.ConstructorOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.jasmineReporters.mod.TeamCityReporter.ConstructorOptions]
      }
      
      extension [Self <: typingsJapgolly.jasmineReporters.mod.TeamCityReporter.ConstructorOptions](x: Self) {
  ...
  open class TerminalReporter ()
    extends StObject
       with CustomReporter {
    def this(options: typingsJapgolly.jasmineReporters.mod.TerminalReporter.ConstructorOptions) = this()
  }
  object TerminalReporter {
    ...
    object ConstructorOptions {
      ...
      inline def apply(): typingsJapgolly.jasmineReporters.mod.TerminalReporter.ConstructorOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.jasmineReporters.mod.TerminalReporter.ConstructorOptions]
      }
      
      extension [Self <: typingsJapgolly.jasmineReporters.mod.TerminalReporter.ConstructorOptions](x: Self) {
