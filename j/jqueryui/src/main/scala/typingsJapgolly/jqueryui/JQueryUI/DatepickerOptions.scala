...
object DatepickerOptions {
  ...
  extension [Self <: DatepickerOptions](x: Self) {
    ...
    inline def setOnChangeMonthYear(value: (/* year */ Double, /* month */ Double, /* inst */ Any) => Callback): Self = StObject.set(x, "onChangeMonthYear", js.Any.fromFunction3((t0: /* year */ Double, t1: /* month */ Double, t2: /* inst */ Any) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnChangeMonthYearUndefined: Self = StObject.set(x, "onChangeMonthYear", js.undefined)
    
    inline def setOnClose(value: (/* dateText */ String, /* inst */ Any) => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* dateText */ String, t1: /* inst */ Any) => (value(t0, t1)).runNow()))
    
    inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
    
    inline def setOnSelect(value: (/* dateText */ String, /* inst */ Any) => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: /* dateText */ String, t1: /* inst */ Any) => (value(t0, t1)).runNow()))
