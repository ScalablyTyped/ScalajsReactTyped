...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsonquery.mod.OrQueryCondition[T]
    - typingsJapgolly.jsonquery.mod.AndQueryCondition[T]
  */
  ...
  object BinaryQueryCondition {
    ...
    inline def AndQueryCondition[T]($and: js.Array[Query[T]]): typingsJapgolly.jsonquery.mod.AndQueryCondition[T] = {
      val __obj = js.Dynamic.literal($and = $and.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonquery.mod.AndQueryCondition[T]]
    }
    
    inline def OrQueryCondition[T]($or: js.Array[Query[T]]): typingsJapgolly.jsonquery.mod.OrQueryCondition[T] = {
      val __obj = js.Dynamic.literal($or = $or.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonquery.mod.OrQueryCondition[T]]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsonquery.mod.BinaryQueryCondition[T]
    - typingsJapgolly.jsonquery.mod.QueryValue[T]
    - typingsJapgolly.jsonquery.mod.PathQuery
  */
