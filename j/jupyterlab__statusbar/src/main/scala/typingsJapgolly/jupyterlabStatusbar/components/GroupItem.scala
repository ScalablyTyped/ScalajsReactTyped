...
object GroupItem {
  ...
  typingsJapgolly.jupyterlabStatusbar.groupMod.GroupItem.IProps with typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
  japgolly.scalajs.react.Children.None, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.jupyterlabStatusbar.groupMod.GroupItem.IProps with typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement]])
  }
