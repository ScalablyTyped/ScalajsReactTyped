...
import typingsJapgolly.jupyterlabStatusbar.deprecatedMod.IconItem.IProps
...
object IconItem {
  def apply(
    ...
    IProps with HTMLAttributes[HTMLDivElement], 
    MountedWithRawType[
      IProps with HTMLAttributes[HTMLDivElement], 
      js.Object, 
      RawMounted[IProps with HTMLAttributes[HTMLDivElement], js.Object]
    ]
  ] = {
  ...
  typingsJapgolly.jupyterlabStatusbar.deprecatedMod.IconItem.IProps with typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.jupyterlabStatusbar.deprecatedMod.IconItem.IProps with typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement]])(children: _*)
  }
  @JSImport("@jupyterlab/statusbar", "IconItem")
  @js.native
