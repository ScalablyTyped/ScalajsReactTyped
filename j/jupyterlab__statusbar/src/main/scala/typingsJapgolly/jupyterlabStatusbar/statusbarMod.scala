...
import typingsJapgolly.jupyterlabStatusbar.tokensMod.IStatusBar
...
object statusbarMod extends js.Object {
  ...
  class StatusBar ()
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def children(): IIterator[typingsJapgolly.phosphorWidgets.widgetMod.Widget] = js.native
    /**
    ...
    /**
      ...
      */
    /* InferMemberOverrides */
    override def contains(widget: typingsJapgolly.phosphorWidgets.widgetMod.Widget): Boolean = js.native
    /**
