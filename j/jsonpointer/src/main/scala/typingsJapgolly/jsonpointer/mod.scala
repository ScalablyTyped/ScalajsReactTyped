...
object mod {
  ...
  object JSONPointer {
    ...
    inline def apply(get: js.Object => Any, set: (js.Object, Any) => Callback): JSONPointer = {
      val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get), set = js.Any.fromFunction2((t0: js.Object, t1: Any) => (set(t0, t1)).runNow()))
    ...
    extension [Self <: JSONPointer](x: Self) {
      ...
      inline def setSet(value: (js.Object, Any) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: js.Object, t1: Any) => (value(t0, t1)).runNow()))
    }
  }
}
