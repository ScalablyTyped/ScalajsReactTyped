...
object Options {
  ...
  def apply(
    ...
    getSuffix: /* num */ Double => CallbackTo[String] = null,
    ...
    if (getSuffix != null) __obj.updateDynamic("getSuffix")(js.Any.fromFunction1((t0: /* num */ scala.Double) => getSuffix(t0).runNow()))
