...
trait EventData extends StObject {
  ...
  /** The tree instance */
  var tree: typingsJapgolly.jqueryFancytree.Fancytree.Fancytree
...
object EventData {
  ...
  inline def apply(
    ...
    result: Any,
    targetType: String,
    tree: typingsJapgolly.jqueryFancytree.Fancytree.Fancytree,
    widget: Any
  ): EventData = {
  ...
  extension [Self <: EventData](x: Self) {
    ...
    inline def setTree(value: typingsJapgolly.jqueryFancytree.Fancytree.Fancytree): Self = StObject.set(x, "tree", value.asInstanceOf[js.Any])
