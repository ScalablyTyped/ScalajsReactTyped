...
import typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode
...
object DragAndDrop5 {
  ...
  /* key */ StringDictionary[js.Any] = null,
    ...
    dragDrag: (/* sourceNode */ FancytreeNode, /* data */ js.Any) => Callback = null,
    dragDrop: (/* node */ FancytreeNode, /* data */ js.Any) => Callback = null,
    dragEnd: (/* sourceNode */ FancytreeNode, /* data */ js.Any) => Callback = null,
    dragEnter: (/* targetNode */ FancytreeNode, /* data */ js.Any) => Callback = null,
    dragExpand: (/* targetNode */ FancytreeNode, /* data */ js.Any) => Callback = null,
    dragLeave: (/* targetNode */ FancytreeNode, /* data */ js.Any) => Callback = null,
    dragOver: (/* targetNode */ FancytreeNode, /* data */ js.Any) => Callback = null,
    dragStart: (/* sourceNode */ FancytreeNode, /* data */ js.Any) => Callback = null,
    ...
    if (dragDrag != null) __obj.updateDynamic("dragDrag")(js.Any.fromFunction2((t0: /* sourceNode */ typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode, t1: /* data */ js.Any) => dragDrag(t0, t1).runNow()))
    if (dragDrop != null) __obj.updateDynamic("dragDrop")(js.Any.fromFunction2((t0: /* node */ typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode, t1: /* data */ js.Any) => dragDrop(t0, t1).runNow()))
    if (dragEnd != null) __obj.updateDynamic("dragEnd")(js.Any.fromFunction2((t0: /* sourceNode */ typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode, t1: /* data */ js.Any) => dragEnd(t0, t1).runNow()))
    if (dragEnter != null) __obj.updateDynamic("dragEnter")(js.Any.fromFunction2((t0: /* targetNode */ typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode, t1: /* data */ js.Any) => dragEnter(t0, t1).runNow()))
    if (dragExpand != null) __obj.updateDynamic("dragExpand")(js.Any.fromFunction2((t0: /* targetNode */ typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode, t1: /* data */ js.Any) => dragExpand(t0, t1).runNow()))
    if (dragLeave != null) __obj.updateDynamic("dragLeave")(js.Any.fromFunction2((t0: /* targetNode */ typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode, t1: /* data */ js.Any) => dragLeave(t0, t1).runNow()))
    if (dragOver != null) __obj.updateDynamic("dragOver")(js.Any.fromFunction2((t0: /* targetNode */ typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode, t1: /* data */ js.Any) => dragOver(t0, t1).runNow()))
    if (dragStart != null) __obj.updateDynamic("dragStart")(js.Any.fromFunction2((t0: /* sourceNode */ typingsJapgolly.jqueryFancytree.Fancytree.FancytreeNode, t1: /* data */ js.Any) => dragStart(t0, t1).runNow()))
