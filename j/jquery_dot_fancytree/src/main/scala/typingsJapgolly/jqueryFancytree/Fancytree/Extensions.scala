...
import typingsJapgolly.jqueryFancytree.jqueryFancytreeStrings.dimm
import typingsJapgolly.jqueryFancytree.jqueryFancytreeStrings.hide
...
object Extensions {
  ...
  object DragAndDrop5 {
    ...
    extension [Self <: DragAndDrop5](x: Self) {
      ...
      inline def setDragDrag(value: (/* sourceNode */ FancytreeNode, /* data */ Any) => Callback): Self = StObject.set(x, "dragDrag", js.Any.fromFunction2((t0: /* sourceNode */ FancytreeNode, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setDragDragUndefined: Self = StObject.set(x, "dragDrag", js.undefined)
      
      inline def setDragDrop(value: (/* node */ FancytreeNode, /* data */ Any) => Callback): Self = StObject.set(x, "dragDrop", js.Any.fromFunction2((t0: /* node */ FancytreeNode, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setDragDropUndefined: Self = StObject.set(x, "dragDrop", js.undefined)
      
      inline def setDragEnd(value: (/* sourceNode */ FancytreeNode, /* data */ Any) => Callback): Self = StObject.set(x, "dragEnd", js.Any.fromFunction2((t0: /* sourceNode */ FancytreeNode, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setDragEndUndefined: Self = StObject.set(x, "dragEnd", js.undefined)
      
      inline def setDragEnter(value: (/* targetNode */ FancytreeNode, /* data */ Any) => Callback): Self = StObject.set(x, "dragEnter", js.Any.fromFunction2((t0: /* targetNode */ FancytreeNode, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setDragEnterUndefined: Self = StObject.set(x, "dragEnter", js.undefined)
      
      inline def setDragExpand(value: (/* targetNode */ FancytreeNode, /* data */ Any) => Callback): Self = StObject.set(x, "dragExpand", js.Any.fromFunction2((t0: /* targetNode */ FancytreeNode, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setDragExpandUndefined: Self = StObject.set(x, "dragExpand", js.undefined)
      
      inline def setDragLeave(value: (/* targetNode */ FancytreeNode, /* data */ Any) => Callback): Self = StObject.set(x, "dragLeave", js.Any.fromFunction2((t0: /* targetNode */ FancytreeNode, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setDragLeaveUndefined: Self = StObject.set(x, "dragLeave", js.undefined)
      
      inline def setDragOver(value: (/* targetNode */ FancytreeNode, /* data */ Any) => Callback): Self = StObject.set(x, "dragOver", js.Any.fromFunction2((t0: /* targetNode */ FancytreeNode, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setDragOverUndefined: Self = StObject.set(x, "dragOver", js.undefined)
      
      inline def setDragStart(value: (/* sourceNode */ FancytreeNode, /* data */ Any) => Callback): Self = StObject.set(x, "dragStart", js.Any.fromFunction2((t0: /* sourceNode */ FancytreeNode, t1: /* data */ Any) => (value(t0, t1)).runNow()))
  ...
  object List {
    ...
    inline def apply(): typingsJapgolly.jqueryFancytree.Fancytree.Extensions.List = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.jqueryFancytree.Fancytree.Extensions.List]
    }
    
    extension [Self <: typingsJapgolly.jqueryFancytree.Fancytree.Extensions.List](x: Self) {
