package typingsJapgolly.jupyterlabCsvviewerExtension

import typingsJapgolly.jupyterlabCsvviewer.mod.CSVViewer
import typingsJapgolly.jupyterlabCsvviewerExtension.jupyterlabCsvviewerExtensionBooleans.`true`
...
object searchproviderMod extends js.Object {
  ...
  class CSVSearchProvider () extends ISearchProvider[CSVDocumentWidget] {
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def startQuery(query: js.RegExp, searchTarget: CSVDocumentWidget): js.Promise[js.Array[ISearchMatch]] = js.native
  }
