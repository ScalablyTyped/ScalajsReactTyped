package typingsJapgolly.jsspecJsspec

import typingsJapgolly.jsspecJsspec.JSSpec.Context
import typingsJapgolly.jsspecJsspec.JSSpec.Example
import typingsJapgolly.jsspecJsspec.JSSpec.Hook
import typingsJapgolly.jsspecJsspec.JSSpec.LazyEvaluated
import typingsJapgolly.jsspecJsspec.JSSpec.PendingContext
import typingsJapgolly.jsspecJsspec.JSSpec.PendingExample
import typingsJapgolly.jsspecJsspec.JSSpec.SharedContext
import typingsJapgolly.jsspecJsspec.JSSpec.SharedInvocation
import typingsJapgolly.jsspecJsspec.JSSpec.Subject
