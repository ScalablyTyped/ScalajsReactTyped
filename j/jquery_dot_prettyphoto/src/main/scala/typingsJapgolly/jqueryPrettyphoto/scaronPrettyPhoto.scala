...
object scaronPrettyPhoto {
  ...
  object PrettyPhotoSettings {
    ...
    extension [Self <: PrettyPhotoSettings](x: Self) {
      ...
      inline def setAjaxcallback(value: Callback): Self = StObject.set(x, "ajaxcallback", value.toJsFn)
      ...
      inline def setChangepicturecallback(value: Callback): Self = StObject.set(x, "changepicturecallback", value.toJsFn)
