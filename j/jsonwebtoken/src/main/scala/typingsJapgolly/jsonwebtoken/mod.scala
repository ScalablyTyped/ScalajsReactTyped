...
import typingsJapgolly.jsonwebtoken.anon.Key
...
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.alg
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.crit
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.cty
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.jku
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.kid
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.typ
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.x5c
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.x5t
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.x5tNumbersignS256
import typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.x5u
...
object mod {
  ...
  inline def verify(token: String, secretOrPublicKey: Secret, options: VerifyOptionscompletetrue): Jwt = (^.asInstanceOf[js.Dynamic].applyDynamic("verify")(token.asInstanceOf[js.Any], secretOrPublicKey.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Jwt]
  inline def verify(
    token: String,
    secretOrPublicKey: Secret,
    options: VerifyOptionscompletetrue,
  ...
  inline def verify_Unit(token: String, secretOrPublicKey: Secret, options: VerifyOptionscompletetrue): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("verify")(token.asInstanceOf[js.Any], secretOrPublicKey.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS256
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS384
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS512
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS256
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS384
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS512
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES256
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES384
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES512
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS256
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS384
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS512
    - typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.none
  */
  trait Algorithm extends StObject
  object Algorithm {
    
    inline def ES256: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES256 = "ES256".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES256]
    
    inline def ES384: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES384 = "ES384".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES384]
    
    inline def ES512: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES512 = "ES512".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.ES512]
    
    inline def HS256: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS256 = "HS256".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS256]
    
    inline def HS384: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS384 = "HS384".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS384]
    
    inline def HS512: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS512 = "HS512".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.HS512]
    
    inline def PS256: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS256 = "PS256".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS256]
    
    inline def PS384: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS384 = "PS384".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS384]
    
    inline def PS512: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS512 = "PS512".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.PS512]
    
    inline def RS256: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS256 = "RS256".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS256]
    
    inline def RS384: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS384 = "RS384".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS384]
    
    inline def RS512: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS512 = "RS512".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.RS512]
    
    inline def none: typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.none = "none".asInstanceOf[typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.none]
  }
  ...
  trait JwtHeader extends StObject {
    ...
    var crit: js.UndefOr[
        js.Array[
          String | (Exclude[
            alg | typ | cty | typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.crit | kid | jku | x5u | x5tNumbersignS256 | x5t | x5c, 
            typingsJapgolly.jsonwebtoken.jsonwebtokenStrings.crit
          ])
        ]
      ] = js.undefined
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsonwebtoken.mod.JsonWebTokenError
