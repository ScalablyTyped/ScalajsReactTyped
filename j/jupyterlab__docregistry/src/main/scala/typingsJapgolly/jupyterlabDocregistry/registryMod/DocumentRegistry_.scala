...
import typingsJapgolly.jupyterlabDocregistry.PartialIFileType
import typingsJapgolly.jupyterlabDocregistry.PartialIModel
import typingsJapgolly.jupyterlabDocregistry.PartialIModelChunk
import typingsJapgolly.jupyterlabDocregistry.registryMod.DocumentRegistry.IChangedArgs
import typingsJapgolly.jupyterlabDocregistry.registryMod.DocumentRegistry.IFileType
import typingsJapgolly.jupyterlabDocregistry.registryMod.DocumentRegistry.IOptions
import typingsJapgolly.jupyterlabDocregistry.registryMod.DocumentRegistry.ModelFactory
import typingsJapgolly.jupyterlabDocregistry.registryMod.DocumentRegistry.WidgetExtension
import typingsJapgolly.jupyterlabDocregistry.registryMod.DocumentRegistry.WidgetFactory
