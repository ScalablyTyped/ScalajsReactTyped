...
object IWidgetFactoryOptions {
  ...
  def apply[T /* <: Widget */](
    ...
    toolbarFactory: /* widget */ T => CallbackTo[js.Array[IToolbarItem]] = null
    ...
    if (toolbarFactory != null) __obj.updateDynamic("toolbarFactory")(js.Any.fromFunction1((t0: /* widget */ T) => toolbarFactory(t0).runNow()))
