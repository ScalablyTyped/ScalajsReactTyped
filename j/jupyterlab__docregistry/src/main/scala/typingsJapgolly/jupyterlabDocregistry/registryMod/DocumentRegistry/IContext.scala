...
trait IContext[T /* <: IModel */] extends IDisposable {
  /**
    ...
    */
  val contentsModel: typingsJapgolly.jupyterlabServices.contentsMod.Contents.IModel | Null = js.native
  /**
  ...
  /**
    ...
    */
  var fileChanged: ISignal[this.type, typingsJapgolly.jupyterlabServices.contentsMod.Contents.IModel] = js.native
  /**
