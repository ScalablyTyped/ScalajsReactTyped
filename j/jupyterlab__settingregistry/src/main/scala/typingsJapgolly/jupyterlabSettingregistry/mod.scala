...
object mod {
  ...
  open class DefaultSchemaValidator ()
    extends typingsJapgolly.jupyterlabSettingregistry.libSettingregistryMod.DefaultSchemaValidator
  
  @JSImport("@jupyterlab/settingregistry", "ISettingRegistry")
  @js.native
  val ISettingRegistry: Token[typingsJapgolly.jupyterlabSettingregistry.libTokensMod.ISettingRegistry] = js.native
  
  @JSImport("@jupyterlab/settingregistry", "SettingRegistry")
  @js.native
  open class SettingRegistry protected ()
    extends typingsJapgolly.jupyterlabSettingregistry.libSettingregistryMod.SettingRegistry {
    /**
  ...
  open class Settings protected ()
    extends typingsJapgolly.jupyterlabSettingregistry.libSettingregistryMod.Settings {
    /**
