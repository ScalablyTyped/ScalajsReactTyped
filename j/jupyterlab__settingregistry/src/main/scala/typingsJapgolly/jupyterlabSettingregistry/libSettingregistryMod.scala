...
import typingsJapgolly.jupyterlabSettingregistry.libSettingregistryMod.SettingRegistry.IOptions
import typingsJapgolly.jupyterlabSettingregistry.libTokensMod.ISettingRegistry
import typingsJapgolly.jupyterlabSettingregistry.libTokensMod.ISettingRegistry.IMenu
import typingsJapgolly.jupyterlabSettingregistry.libTokensMod.ISettingRegistry.IMenuItem
...
import typingsJapgolly.jupyterlabSettingregistry.libTokensMod.ISettingRegistry.IShortcut
import typingsJapgolly.jupyterlabSettingregistry.libTokensMod.ISettingRegistry.IToolbarItem
...
import typingsJapgolly.luminoCoreutils.typesJsonMod.ReadonlyJSONObject
...
object libSettingregistryMod {
  ...
  open class Settings protected ()
    ...
    /**
      ...
      */
    def this(options: typingsJapgolly.jupyterlabSettingregistry.libSettingregistryMod.Settings.IOptions) = this()
  ...
  object Settings {
    ...
    object IOptions {
      ...
      inline def apply(plugin: IPlugin, registry: ISettingRegistry): typingsJapgolly.jupyterlabSettingregistry.libSettingregistryMod.Settings.IOptions = {
        val __obj = js.Dynamic.literal(plugin = plugin.asInstanceOf[js.Any], registry = registry.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.jupyterlabSettingregistry.libSettingregistryMod.Settings.IOptions]
      }
      
      extension [Self <: typingsJapgolly.jupyterlabSettingregistry.libSettingregistryMod.Settings.IOptions](x: Self) {
