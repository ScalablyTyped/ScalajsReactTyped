...
import typingsJapgolly.jupyterlabSettingregistry.libTokensMod.ISettingRegistry.IContextMenuItem
...
import typingsJapgolly.jupyterlabSettingregistry.libTokensMod.ISettingRegistry.IPlugin.Transform
