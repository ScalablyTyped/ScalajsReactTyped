package typingsJapgolly.jwtExpress
...
object mod {
  ...
  object JWT {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(expired = expired.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], payload = payload.asInstanceOf[js.Any], resign = resign.toJsFn, revoke = revoke.toJsFn, secret = secret.asInstanceOf[js.Any], sign = js.Any.fromFunction1(sign), stale = stale.asInstanceOf[js.Any], store = js.Any.fromFunction1(store), toJSON = toJSON.toJsFn, token = token.asInstanceOf[js.Any], valid = valid.asInstanceOf[js.Any], verify = js.Any.fromFunction1(verify))
    ...
    extension [Self <: JWT](x: Self) {
      ...
      inline def setResign(value: CallbackTo[JWT]): Self = StObject.set(x, "resign", value.toJsFn)
      
      inline def setRevoke(value: CallbackTo[JWT]): Self = StObject.set(x, "revoke", value.toJsFn)
  ...
  object JWTExpressOptions {
    ...
    extension [Self <: JWTExpressOptions](x: Self) {
      ...
      inline def setRevoke(value: /* jwt */ JWT => Callback): Self = StObject.set(x, "revoke", js.Any.fromFunction1((t0: /* jwt */ JWT) => value(t0).runNow()))
