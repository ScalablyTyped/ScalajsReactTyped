...
import typingsJapgolly.jestExpect.mod.Inverse
import typingsJapgolly.jestExpect.mod.JestExpect_
import typingsJapgolly.jestExpect.mod.JestMatchers
import typingsJapgolly.jestExpect.mod.PromiseMatchers
import typingsJapgolly.jestHasteMap.mod.IHasteMap
import typingsJapgolly.jestHasteMap.mod.IModuleMap
import typingsJapgolly.jestHasteMap.mod.SerializableModuleMap
import typingsJapgolly.jestRuntime.anon.Console
import typingsJapgolly.jestRuntime.anon.Virtual
import typingsJapgolly.jestSourceMap.mod.SourceMapRegistry
import typingsJapgolly.jestTestResult.mod.TestContext
import typingsJapgolly.jestTestResult.mod.V8CoverageResult
import typingsJapgolly.jestTransform.mod.ScriptTransformer
import typingsJapgolly.jestTransform.mod.ShouldInstrumentOptions
...
import typingsJapgolly.jestTypes.mod.TestFrameworkGlobals
...
object mod {
  ...
  open class default protected ()
    ...
    def this(
      ...
      resolver: typingsJapgolly.jestResolve.mod.default,
  ...
  object default {
    ...
    /* static member */
    inline def createResolver(config: ProjectConfig, moduleMap: IModuleMap[SerializableModuleMap]): typingsJapgolly.jestResolve.mod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("createResolver")(config.asInstanceOf[js.Any], moduleMap.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.jestResolve.mod.default]
  ...
  trait HasteMapOptions extends StObject {
    ...
    var console: js.UndefOr[org.scalajs.dom.Console] = js.undefined
  ...
  object HasteMapOptions {
    ...
    extension [Self <: HasteMapOptions](x: Self) {
      ...
      inline def setConsole(value: org.scalajs.dom.Console): Self = StObject.set(x, "console", value.asInstanceOf[js.Any])
