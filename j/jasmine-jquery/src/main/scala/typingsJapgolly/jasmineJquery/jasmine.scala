...
import typingsJapgolly.jquery.JQueryCallback
...
object jasmine {
  ...
  object JQueryEventSpy {
    ...
    inline def apply(eventName: String, handler: JQueryEventObject => Any, reset: CallbackTo[Any], selector: String): JQueryEventSpy = {
      val __obj = js.Dynamic.literal(eventName = eventName.asInstanceOf[js.Any], handler = js.Any.fromFunction1(handler), reset = reset.toJsFn, selector = selector.asInstanceOf[js.Any])
    ...
    extension [Self <: JQueryEventSpy](x: Self) {
      ...
      inline def setReset(value: CallbackTo[Any]): Self = StObject.set(x, "reset", value.toJsFn)
  ...
  object JSONFixtures {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(clearCache = clearCache.toJsFn, fixturesPath = fixturesPath.asInstanceOf[js.Any], getFixtureData_ = js.Any.fromFunction1(getFixtureData_), load = js.Any.fromFunction1((t0: /* repeated */ String) => load(t0).runNow()), loadFixtureIntoCache_ = js.Any.fromFunction1((t0: String) => loadFixtureIntoCache_(t0).runNow()), proxyCallTo_ = js.Any.fromFunction2(proxyCallTo_), read = js.Any.fromFunction1(read))
    ...
    extension [Self <: JSONFixtures](x: Self) {
      ...
      inline def setLoadFixtureIntoCache_(value: String => Callback): Self = StObject.set(x, "loadFixtureIntoCache_", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  ...
  object JasmineJQueryEvents {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(args = js.Any.fromFunction2(args), cleanUp = cleanUp.toJsFn, spyOn = js.Any.fromFunction2(spyOn), wasPrevented = js.Any.fromFunction2(wasPrevented), wasStopped = js.Any.fromFunction2(wasStopped), wasTriggered = js.Any.fromFunction2(wasTriggered), wasTriggeredWith = js.Any.fromFunction4(wasTriggeredWith))
  ...
  object StyleFixtures {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(appendLoad = js.Any.fromFunction1((t0: /* repeated */ String) => appendLoad(t0).runNow()), appendSet = js.Any.fromFunction1((t0: String) => appendSet(t0).runNow()), cleanUp = cleanUp.toJsFn, clearCache = clearCache.toJsFn, createStyle_ = js.Any.fromFunction1((t0: String) => createStyle_(t0).runNow()), fixturesPath = fixturesPath.asInstanceOf[js.Any], getFixtureHtml_ = js.Any.fromFunction1(getFixtureHtml_), load = js.Any.fromFunction1((t0: /* repeated */ String) => load(t0).runNow()), loadFixtureIntoCache_ = js.Any.fromFunction1((t0: String) => loadFixtureIntoCache_(t0).runNow()), makeFixtureUrl_ = js.Any.fromFunction1(makeFixtureUrl_), preload = js.Any.fromFunction1((t0: /* repeated */ String) => preload(t0).runNow()), proxyCallTo_ = js.Any.fromFunction2(proxyCallTo_), read_ = js.Any.fromFunction1(read_), set = js.Any.fromFunction1(set))
    ...
    extension [Self <: StyleFixtures](x: Self) {
      ...
      inline def setCreateStyle_(value: String => Callback): Self = StObject.set(x, "createStyle_", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
