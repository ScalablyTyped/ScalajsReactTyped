...
import typingsJapgolly.jestRunner.jestRunnerBooleans.`true`
import typingsJapgolly.jestRunner.jestRunnerStrings.`test-case-result`
import typingsJapgolly.jestRunner.jestRunnerStrings.`test-file-failure`
import typingsJapgolly.jestRunner.jestRunnerStrings.`test-file-start`
import typingsJapgolly.jestRunner.jestRunnerStrings.`test-file-success`
import typingsJapgolly.jestTestResult.mod.AssertionResult
import typingsJapgolly.jestTestResult.mod.SerializableError
import typingsJapgolly.jestTestResult.mod.Test
import typingsJapgolly.jestTestResult.mod.TestResult
...
object mod {
  ...
  open class CallbackTestRunner ()
    ...
    override def runTests(
      tests: js.Array[Test],
      watcher: typingsJapgolly.jestWatcher.mod.TestWatcher,
      onStart: OnTestStart,
  ...
  open class TestWatcher protected ()
    extends typingsJapgolly.jestWatcher.mod.TestWatcher {
  ...
  object CallbackTestRunnerInterface {
    ...
    inline def apply(
      runTests: (js.Array[Test], typingsJapgolly.jestWatcher.mod.TestWatcher, OnTestStart, OnTestSuccess, OnTestFailure, TestRunnerOptions) => js.Promise[Unit]
    ...
    extension [Self <: CallbackTestRunnerInterface](x: Self) {
      ...
      inline def setRunTests(
        value: (js.Array[Test], typingsJapgolly.jestWatcher.mod.TestWatcher, OnTestStart, OnTestSuccess, OnTestFailure, TestRunnerOptions) => js.Promise[Unit]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jestRunner.mod.CallbackTestRunner
    - typingsJapgolly.jestRunner.mod.EmittingTestRunner
  */
