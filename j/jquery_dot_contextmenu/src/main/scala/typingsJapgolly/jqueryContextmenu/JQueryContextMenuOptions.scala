...
import typingsJapgolly.jqueryContextmenu.anon.Duration
import typingsJapgolly.jqueryContextmenu.anon.Hide
...
object JQueryContextMenuOptions {
  ...
  extension [Self <: JQueryContextMenuOptions](x: Self) {
    ...
    inline def setDeterminePosition(value: /* menu */ JQuery => Callback): Self = StObject.set(x, "determinePosition", js.Any.fromFunction1((t0: /* menu */ JQuery) => value(t0).runNow()))
    ...
    inline def setPosition(value: (/* opt */ JQuery, /* x */ Double, /* y */ Double) => Callback): Self = StObject.set(x, "position", js.Any.fromFunction3((t0: /* opt */ JQuery, t1: /* x */ Double, t2: /* y */ Double) => (value(t0, t1, t2)).runNow()))
    
    inline def setPositionSubmenu(value: /* menu */ JQuery => Callback): Self = StObject.set(x, "positionSubmenu", js.Any.fromFunction1((t0: /* menu */ JQuery) => value(t0).runNow()))
