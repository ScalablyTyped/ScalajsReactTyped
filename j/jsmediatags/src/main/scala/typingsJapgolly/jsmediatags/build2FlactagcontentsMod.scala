...
object build2FlactagcontentsMod {
  ...
  object FLACTagContents {
    ...
    inline def apply(blocks: js.Array[MetadataBlock], toArray: CallbackTo[ByteArray]): FLACTagContents = {
      val __obj = js.Dynamic.literal(blocks = blocks.asInstanceOf[js.Any], toArray = toArray.toJsFn)
    ...
    extension [Self <: FLACTagContents](x: Self) {
      ...
      inline def setToArray(value: CallbackTo[ByteArray]): Self = StObject.set(x, "toArray", value.toJsFn)
    }
  }
}
