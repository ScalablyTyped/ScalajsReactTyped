...
object build2Mp4tagcontentsMod {
  ...
  object MP4TagContents {
    ...
    inline def apply(_atoms: js.Array[Atom], toArray: CallbackTo[ByteArray]): MP4TagContents = {
      val __obj = js.Dynamic.literal(_atoms = _atoms.asInstanceOf[js.Any], toArray = toArray.toJsFn)
