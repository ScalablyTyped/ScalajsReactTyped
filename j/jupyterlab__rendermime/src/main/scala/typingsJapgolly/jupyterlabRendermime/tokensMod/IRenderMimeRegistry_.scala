package typingsJapgolly.jupyterlabRendermime.tokensMod

import typingsJapgolly.jupyterlabApputils.sanitizerMod.ISanitizer
import typingsJapgolly.jupyterlabRendermime.jupyterlabRendermimeStrings.any
import typingsJapgolly.jupyterlabRendermime.jupyterlabRendermimeStrings.ensure
import typingsJapgolly.jupyterlabRendermime.jupyterlabRendermimeStrings.prefer
import typingsJapgolly.jupyterlabRendermime.mimemodelMod.MimeModel
import typingsJapgolly.jupyterlabRendermime.mimemodelMod.MimeModel.IOptions
import typingsJapgolly.jupyterlabRendermime.tokensMod.IRenderMimeRegistry.ICloneOptions
...
trait IRenderMimeRegistry_ extends js.Object {
  /**
    ...
    */
  val latexTypesetter: typingsJapgolly.jupyterlabRendermimeInterfaces.mod.IRenderMime.ILatexTypesetter | Null = js.native
  /**
