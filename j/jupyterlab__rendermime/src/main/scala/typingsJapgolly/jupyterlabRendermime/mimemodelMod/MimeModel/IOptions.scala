package typingsJapgolly.jupyterlabRendermime.mimemodelMod.MimeModel
...
object IOptions {
  @scala.inline
  def apply(
    callback: /* options */ ISetDataOptions => Callback = null,
    data: ReadonlyJSONObject = null,
    metadata: ReadonlyJSONObject = null,
    trusted: js.UndefOr[Boolean] = js.undefined
  ): IOptions = {
    val __obj = js.Dynamic.literal()
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: /* options */ typingsJapgolly.jupyterlabRendermimeInterfaces.mod.IRenderMime.IMimeModel.ISetDataOptions) => callback(t0).runNow()))
