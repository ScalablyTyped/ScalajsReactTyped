...
object global {
  ...
  open class jo protected ()
    extends StObject
       with typingsJapgolly.jodata.jo {
  ...
  object jo {
    ...
    @js.native
    def loadLocal: js.Function1[/* key */ js.UndefOr[String], typingsJapgolly.jodata.jo] = js.native
    inline def loadLocal_=(x: js.Function1[/* key */ js.UndefOr[String], typingsJapgolly.jodata.jo]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("loadLocal")(x.asInstanceOf[js.Any])
