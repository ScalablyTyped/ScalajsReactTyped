...
object mod {
  ...
  open class Concat protected ()
    extends StObject
       with typingsJapgolly.jodata.jo.Concat {
    def this(value1: String, value2: String) = this()
    def this(value1: String, value2: typingsJapgolly.jodata.jo.Concat) = this()
    def this(value1: typingsJapgolly.jodata.jo.Concat, value2: String) = this()
    def this(value1: typingsJapgolly.jodata.jo.Concat, value2: typingsJapgolly.jodata.jo.Concat) = this()
    
    /* CompleteClass */
    var LeftSide: String | typingsJapgolly.jodata.jo.Concat = js.native
    
    /* CompleteClass */
    var RightSide: String | typingsJapgolly.jodata.jo.Concat = js.native
  }
  ...
  open class FilterClause ()
    extends StObject
       with typingsJapgolly.jodata.jo.FilterClause {
  ...
  open class PrecedenceGroup protected ()
    extends StObject
       with typingsJapgolly.jodata.jo.PrecedenceGroup {
    def this(filterClause: typingsJapgolly.jodata.jo.FilterClause) = this()
    
    /* CompleteClass */
    override def andFilter(filterClause: typingsJapgolly.jodata.jo.FilterClause): typingsJapgolly.jodata.jo.FilterClause = js.native
    
    /* CompleteClass */
    override def orFilter(filterClause: typingsJapgolly.jodata.jo.FilterClause): typingsJapgolly.jodata.jo.FilterClause = js.native
  }
