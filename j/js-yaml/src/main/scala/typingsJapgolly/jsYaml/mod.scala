...
import typingsJapgolly.jsYaml.jsYamlStrings.Quotationmark
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsYaml.jsYamlStrings.open
    - typingsJapgolly.jsYaml.jsYamlStrings.close
  */
  trait EventType extends StObject
  object EventType {
    
    inline def close: typingsJapgolly.jsYaml.jsYamlStrings.close = "close".asInstanceOf[typingsJapgolly.jsYaml.jsYamlStrings.close]
    
    inline def open: typingsJapgolly.jsYaml.jsYamlStrings.open = "open".asInstanceOf[typingsJapgolly.jsYaml.jsYamlStrings.open]
  }
  ...
  object State {
    ...
    extension [Self <: State](x: Self) {
      ...
      inline def setOnWarning(value: YAMLException => Callback): Self = StObject.set(x, "onWarning", js.Any.fromFunction1((t0: YAMLException) => value(t0).runNow()))
