...
import typingsJapgolly.jdenticon.anon.Color
import typingsJapgolly.jdenticon.anon.Grayscale
import typingsJapgolly.jdenticon.jdenticonStrings.`2d`
import typingsJapgolly.jdenticon.jdenticonStrings.never
import typingsJapgolly.jdenticon.jdenticonStrings.observe
import typingsJapgolly.jdenticon.jdenticonStrings.once
import typingsJapgolly.jdenticon.typesUmdMod.global.Jdenticon
import typingsJapgolly.node.bufferMod.global.Buffer
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object typesUmdMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `typesUmdMod.foo` */
