...
trait MemberExpression
  ...
  @JSName("type")
  var type_MemberExpression: typingsJapgolly.jsep.jsepStrings.MemberExpression
}
object MemberExpression {
  ...
  extension [Self <: MemberExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.jsep.jsepStrings.MemberExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
