...
trait ConditionalExpression
  ...
  @JSName("type")
  var type_ConditionalExpression: typingsJapgolly.jsep.jsepStrings.ConditionalExpression
}
object ConditionalExpression {
  ...
  extension [Self <: ConditionalExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.jsep.jsepStrings.ConditionalExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
