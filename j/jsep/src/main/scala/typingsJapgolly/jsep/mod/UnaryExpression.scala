...
trait UnaryExpression
  ...
  @JSName("type")
  var type_UnaryExpression: typingsJapgolly.jsep.jsepStrings.UnaryExpression
}
object UnaryExpression {
  ...
  extension [Self <: UnaryExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.jsep.jsepStrings.UnaryExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
