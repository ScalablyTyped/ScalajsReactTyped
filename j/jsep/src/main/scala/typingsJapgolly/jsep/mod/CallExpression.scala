...
trait CallExpression
  ...
  @JSName("type")
  var type_CallExpression: typingsJapgolly.jsep.jsepStrings.CallExpression
}
object CallExpression {
  ...
  extension [Self <: CallExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.jsep.jsepStrings.CallExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
