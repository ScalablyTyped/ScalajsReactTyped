...
trait BinaryExpression
  ...
  @JSName("type")
  var type_BinaryExpression: typingsJapgolly.jsep.jsepStrings.BinaryExpression
}
object BinaryExpression {
  ...
  extension [Self <: BinaryExpression](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.jsep.jsepStrings.BinaryExpression): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
