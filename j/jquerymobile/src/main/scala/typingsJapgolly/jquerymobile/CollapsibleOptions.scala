...
object CollapsibleOptions {
  ...
  extension [Self <: CollapsibleOptions](x: Self) {
    ...
    inline def setCollapseCueTextUndefined: Self = StObject.set(x, "collapseCueText", js.undefined)
    ...
    inline def setContentTheme(value: String): Self = StObject.set(x, "contentTheme", value.asInstanceOf[js.Any])
    
    inline def setContentThemeUndefined: Self = StObject.set(x, "contentTheme", js.undefined)
    
    inline def setExpandCueText(value: String): Self = StObject.set(x, "expandCueText", value.asInstanceOf[js.Any])
    
    inline def setExpandCueTextUndefined: Self = StObject.set(x, "expandCueText", js.undefined)
