...
object ListViewOptions {
  ...
  def apply(
    ...
    autodividersSelector: /* jq */ js.UndefOr[JQuery] => CallbackTo[String] = null,
    ...
    if (autodividersSelector != null) __obj.updateDynamic("autodividersSelector")(js.Any.fromFunction1((t0: /* jq */ js.UndefOr[typingsJapgolly.jquerymobile.JQuery]) => autodividersSelector(t0).runNow()))
