...
import typingsJapgolly.jsonld.jsonldMod.ContainerType
import typingsJapgolly.jsonld.jsonldMod.ContainerTypeArray
import typingsJapgolly.jsonld.jsonldMod.ContextDefinition
import typingsJapgolly.jsonld.jsonldMod.ExpandedTermDefinition
import typingsJapgolly.jsonld.jsonldMod.JsonArray
import typingsJapgolly.jsonld.jsonldMod.JsonObject
import typingsJapgolly.jsonld.jsonldMod.JsonValue
import typingsJapgolly.jsonld.jsonldMod.NodeObject
import typingsJapgolly.jsonld.jsonldMod.OrArray
import typingsJapgolly.jsonld.jsonldMod.ValueObject
import typingsJapgolly.jsonld.jsonldMod._JsonLdDocument
import typingsJapgolly.jsonld.jsonldStrings.`@id`
import typingsJapgolly.jsonld.jsonldStrings.`@index`
import typingsJapgolly.jsonld.jsonldStrings.`@json`
import typingsJapgolly.jsonld.jsonldStrings.`@list`
import typingsJapgolly.jsonld.jsonldStrings.`@nest`
import typingsJapgolly.jsonld.jsonldStrings.`@none`
import typingsJapgolly.jsonld.jsonldStrings.`@set`
import typingsJapgolly.jsonld.jsonldStrings.`@vocab`
...
object anon {
  ...
  trait idKeywordidnullundefinedn
    ...
    var `@nest`: js.UndefOr[typingsJapgolly.jsonld.jsonldStrings.`@nest` | String] = js.undefined
