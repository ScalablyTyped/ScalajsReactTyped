...
import typingsJapgolly.jsonld.jsonldMod.ContextDefinition
import typingsJapgolly.jsonld.jsonldMod.JsonLdDocument
...
import typingsJapgolly.jsonld.jsonldSpecMod.JsonLdProcessor
...
import typingsJapgolly.jsonld.jsonldStrings.`applicationSlashn-quads`
...
object mod {
  ...
  @js.native
  def JsonLdProcessor: typingsJapgolly.jsonld.jsonldSpecMod.JsonLdProcessor = js.native
  ...
  inline def frame(input: JsonLdDocument, frame: Frame, options: typingsJapgolly.jsonld.mod.Options.Frame): js.Promise[JsonLdObj] = (^.asInstanceOf[js.Dynamic].applyDynamic("frame")(input.asInstanceOf[js.Any], frame.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[js.Promise[JsonLdObj]]
  inline def frame(
  ...
  object Options {
    ...
    object Compact {
      ...
      extension [Self <: Compact](x: Self) {
        ...
        inline def setCompactionMap(value: /* info */ Any => japgolly.scalajs.react.Callback): Self = StObject.set(x, "compactionMap", js.Any.fromFunction1((t0: /* info */ Any) => value(t0).runNow()))
    ...
    object Frame {
      ...
      inline def apply(): typingsJapgolly.jsonld.mod.Options.Frame = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.jsonld.mod.Options.Frame]
      }
      
      extension [Self <: typingsJapgolly.jsonld.mod.Options.Frame](x: Self) {
