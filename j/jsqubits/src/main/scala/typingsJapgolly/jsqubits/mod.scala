...
import typingsJapgolly.jsqubits.anon.DecimalPlaces
import typingsJapgolly.jsqubits.jsqubitsBooleans.`false`
import typingsJapgolly.jsqubits.jsqubitsDoubles.`0.0000001`
import typingsJapgolly.jsqubits.mod.jsqubits.Complex
import typingsJapgolly.jsqubits.mod.jsqubits.Measurement
import typingsJapgolly.jsqubits.mod.jsqubits.QState
import typingsJapgolly.jsqubits.mod.jsqubits.StateWithAmplitude
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.jsqubits.jsqubitsStrings.ALL
    - typingsJapgolly.jsqubits.mod.BitsRange
  */
  ...
  object jsqubits {
    ...
    object Measurement {
      ...
      inline def apply(asBitString: CallbackTo[String], newState: QState, numBits: Double, result: Double): Measurement = {
        val __obj = js.Dynamic.literal(asBitString = asBitString.toJsFn, newState = newState.asInstanceOf[js.Any], numBits = numBits.asInstanceOf[js.Any], result = result.asInstanceOf[js.Any])
        __obj.asInstanceOf[Measurement]
      }
      
      extension [Self <: Measurement](x: Self) {
        
        inline def setAsBitString(value: CallbackTo[String]): Self = StObject.set(x, "asBitString", value.toJsFn)
    ...
    object StateWithAmplitude {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(amplitude = amplitude.asInstanceOf[js.Any], asBitString = asBitString.toJsFn, asNumber = asNumber.toJsFn, index = index.asInstanceOf[js.Any], numBits = numBits.asInstanceOf[js.Any])
