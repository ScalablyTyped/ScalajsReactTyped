...
class NotebookTrustStatus ()
  extends typingsJapgolly.jupyterlabNotebook.truststatusMod.NotebookTrustStatus
...
object NotebookTrustStatus extends js.Object {
  ...
  @js.native
  class Model ()
    extends typingsJapgolly.jupyterlabNotebook.truststatusMod.NotebookTrustStatus.Model
