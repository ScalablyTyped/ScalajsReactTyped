...
class CommandEditStatus ()
  extends typingsJapgolly.jupyterlabNotebook.modestatusMod.CommandEditStatus
...
object CommandEditStatus extends js.Object {
  ...
  @js.native
  class Model ()
    extends typingsJapgolly.jupyterlabNotebook.modestatusMod.CommandEditStatus.Model
