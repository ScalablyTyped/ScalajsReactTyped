...
object mod {
  ...
  object ISearchIndex {
    ...
    inline def apply(
      indexDocument: (String, String, js.Object) => Callback,
      search: (js.Array[String], js.Array[js.Object]) => js.Array[js.Object]
    ): ISearchIndex = {
      val __obj = js.Dynamic.literal(indexDocument = js.Any.fromFunction3((t0: String, t1: String, t2: js.Object) => (indexDocument(t0, t1, t2)).runNow()), search = js.Any.fromFunction2(search))
      __obj.asInstanceOf[ISearchIndex]
    }
    
    extension [Self <: ISearchIndex](x: Self) {
      
      inline def setIndexDocument(value: (String, String, js.Object) => Callback): Self = StObject.set(x, "indexDocument", js.Any.fromFunction3((t0: String, t1: String, t2: js.Object) => (value(t0, t1, t2)).runNow()))
