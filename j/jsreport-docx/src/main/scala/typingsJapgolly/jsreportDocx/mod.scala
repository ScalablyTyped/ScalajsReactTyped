package typingsJapgolly.jsreportDocx
...
import typingsJapgolly.jsreportDocx.anon.Content
import typingsJapgolly.jsreportDocx.anon.Enabled
import typingsJapgolly.jsreportDocx.mod.JsReportDocx.Configuration
import typingsJapgolly.jsreportDocx.mod.JsReportDocx.DocxTemplateModifier
...
object mod {
  ...
  object jsreportCoreAugmentingMod {
    ...
    trait TemplateRegistry extends StObject {
      ...
      var DocxTemplateModifier: typingsJapgolly.jsreportDocx.mod.JsReportDocx.DocxTemplateModifier
    }
