...
object JQueryLazyLoad {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setAppear(value: (/* elementsLeft */ Double, Options) => Callback): Self = StObject.set(x, "appear", js.Any.fromFunction2((t0: /* elementsLeft */ Double, t1: Options) => (value(t0, t1)).runNow()))
      ...
      inline def setLoad(value: (/* elementsLeft */ js.UndefOr[Double], /* options */ js.UndefOr[Options]) => Callback): Self = StObject.set(x, "load", js.Any.fromFunction2((t0: /* elementsLeft */ js.UndefOr[Double], t1: /* options */ js.UndefOr[Options]) => (value(t0, t1)).runNow()))
