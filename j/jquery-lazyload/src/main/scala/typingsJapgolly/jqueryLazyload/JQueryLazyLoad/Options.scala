package typingsJapgolly.jqueryLazyload.JQueryLazyLoad

import japgolly.scalajs.react.Callback
import typingsJapgolly.jqueryLazyload.JQuery
...
object Options {
  @scala.inline
  def apply(
    appear: (/* elementsLeft */ Double, Options) => Callback = null,
    container: JQuery = null,
    data_attribute: String = null,
    effect: String = null,
    event: String = null,
    failure_limit: Int | Double = null,
    load: (/* elementsLeft */ js.UndefOr[Double], /* options */ js.UndefOr[Options]) => Callback = null,
    placeholder: String = null,
    skip_invisible: js.UndefOr[Boolean] = js.undefined,
    threshold: Int | Double = null
  ): Options = {
    val __obj = js.Dynamic.literal()
    if (appear != null) __obj.updateDynamic("appear")(js.Any.fromFunction2((t0: /* elementsLeft */ scala.Double, t1: typingsJapgolly.jqueryLazyload.JQueryLazyLoad.Options) => appear(t0, t1).runNow()))
    ...
    if (load != null) __obj.updateDynamic("load")(js.Any.fromFunction2((t0: /* elementsLeft */ js.UndefOr[scala.Double], t1: /* options */ js.UndefOr[typingsJapgolly.jqueryLazyload.JQueryLazyLoad.Options]) => load(t0, t1).runNow()))
