...
import typingsJapgolly.jsonApiSerializer.anon.LinksObjectaboutLinkObjec
import typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.id
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.`kebab-case`
    - typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.snake_case
    - typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.camelCase
  */
  trait Case extends StObject
  object Case {
    
    inline def camelCase: typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.camelCase = "camelCase".asInstanceOf[typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.camelCase]
    
    inline def `kebab-case`: typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.`kebab-case` = "kebab-case".asInstanceOf[typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.`kebab-case`]
    
    inline def snake_case: typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.snake_case = "snake_case".asInstanceOf[typingsJapgolly.jsonApiSerializer.jsonApiSerializerStrings.snake_case]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsonApiSerializer.anon.Data
    - typingsJapgolly.jsonApiSerializer.anon.Links
    - typingsJapgolly.jsonApiSerializer.anon.Meta
  */
  trait Relationship extends StObject
  object Relationship {
    
    inline def Data(data: Linkage | js.Array[Linkage]): typingsJapgolly.jsonApiSerializer.anon.Data = {
      val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonApiSerializer.anon.Data]
    }
    
    inline def Links(meta: Meta): typingsJapgolly.jsonApiSerializer.anon.Links = {
      val __obj = js.Dynamic.literal(meta = meta.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonApiSerializer.anon.Links]
    }
    
    inline def Meta(): typingsJapgolly.jsonApiSerializer.anon.Meta = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.jsonApiSerializer.anon.Meta]
    }
  }
