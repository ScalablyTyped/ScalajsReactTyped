...
import typingsJapgolly.jsonApiSerializer.mod.LinkObject
import typingsJapgolly.jsonApiSerializer.mod.Linkage
import typingsJapgolly.jsonApiSerializer.mod.LinksCallback
import typingsJapgolly.jsonApiSerializer.mod.LinksObject
import typingsJapgolly.jsonApiSerializer.mod.Relationship
...
object anon {
  ...
  trait Data
    ...
    var meta: js.UndefOr[typingsJapgolly.jsonApiSerializer.mod.Meta] = js.undefined
  }
  object Data {
    ...
    extension [Self <: Data](x: Self) {
      ...
      inline def setMeta(value: typingsJapgolly.jsonApiSerializer.mod.Meta): Self = StObject.set(x, "meta", value.asInstanceOf[js.Any])
  ...
  trait Links
    ...
    var meta: typingsJapgolly.jsonApiSerializer.mod.Meta
  }
  object Links {
    
    inline def apply(meta: typingsJapgolly.jsonApiSerializer.mod.Meta): Links = {
