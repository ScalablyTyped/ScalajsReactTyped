...
import typingsJapgolly.jsoneditor.anon.PartialRecordTranslationK
...
object JSONEditorOptions {
  ...
  extension [Self <: JSONEditorOptions](x: Self) {
    ...
    inline def setOnChangeJSON(value: /* json */ Any => Callback): Self = StObject.set(x, "onChangeJSON", js.Any.fromFunction1((t0: /* json */ Any) => value(t0).runNow()))
    
    inline def setOnChangeJSONUndefined: Self = StObject.set(x, "onChangeJSON", js.undefined)
    
    inline def setOnChangeText(value: /* jsonString */ String => Callback): Self = StObject.set(x, "onChangeText", js.Any.fromFunction1((t0: /* jsonString */ String) => value(t0).runNow()))
    ...
    inline def setOnColorPicker(
      value: (/* parent */ HTMLElement, /* color */ String, /* onChange */ js.Function1[/* color */ Color, Unit]) => Callback
    ): Self = StObject.set(x, "onColorPicker", js.Any.fromFunction3((t0: /* parent */ HTMLElement, t1: /* color */ String, t2: /* onChange */ js.Function1[/* color */ Color, Unit]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOnEvent(value: (/* node */ EditableNode, /* event */ Event) => Callback): Self = StObject.set(x, "onEvent", js.Any.fromFunction2((t0: /* node */ EditableNode, t1: /* event */ Event) => (value(t0, t1)).runNow()))
    ...
    inline def setOnModeChange(value: (/* newMode */ JSONEditorMode, /* oldMode */ JSONEditorMode) => Callback): Self = StObject.set(x, "onModeChange", js.Any.fromFunction2((t0: /* newMode */ JSONEditorMode, t1: /* oldMode */ JSONEditorMode) => (value(t0, t1)).runNow()))
    ...
    inline def setOnSelectionChange(value: (/* start */ SerializableNode, /* end */ SerializableNode) => Callback): Self = StObject.set(x, "onSelectionChange", js.Any.fromFunction2((t0: /* start */ SerializableNode, t1: /* end */ SerializableNode) => (value(t0, t1)).runNow()))
    
    inline def setOnSelectionChangeUndefined: Self = StObject.set(x, "onSelectionChange", js.undefined)
    
    inline def setOnTextSelectionChange(value: (/* start */ SelectionPosition, /* end */ SelectionPosition, /* text */ String) => Callback): Self = StObject.set(x, "onTextSelectionChange", js.Any.fromFunction3((t0: /* start */ SelectionPosition, t1: /* end */ SelectionPosition, t2: /* text */ String) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setOnValidationError(value: /* errors */ js.Array[SchemaValidationError | ParseError] => Callback): Self = StObject.set(x, "onValidationError", js.Any.fromFunction1((t0: /* errors */ js.Array[SchemaValidationError | ParseError]) => value(t0).runNow()))
