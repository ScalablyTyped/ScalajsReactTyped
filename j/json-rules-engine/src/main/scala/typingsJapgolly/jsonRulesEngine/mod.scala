...
import typingsJapgolly.jsonRulesEngine.jsonRulesEngineStrings.failure
import typingsJapgolly.jsonRulesEngine.jsonRulesEngineStrings.success
...
object mod {
  ...
  trait ConditionProperties
    ...
    var value: typingsJapgolly.jsonRulesEngine.anon.Fact | Any
  }
  object ConditionProperties {
    
    inline def apply(fact: String, operator: String, value: typingsJapgolly.jsonRulesEngine.anon.Fact | Any): ConditionProperties = {
    ...
    extension [Self <: ConditionProperties](x: Self) {
      ...
      inline def setValue(value: typingsJapgolly.jsonRulesEngine.anon.Fact | Any): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.jsonRulesEngine.mod.ConditionProperties
    - typingsJapgolly.jsonRulesEngine.mod.TopLevelCondition
  */
  trait NestedCondition extends StObject
  object NestedCondition {
    
    inline def AllConditions(all: js.Array[NestedCondition]): typingsJapgolly.jsonRulesEngine.mod.AllConditions = {
      val __obj = js.Dynamic.literal(all = all.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonRulesEngine.mod.AllConditions]
    }
    
    inline def AnyConditions(any: js.Array[NestedCondition]): typingsJapgolly.jsonRulesEngine.mod.AnyConditions = {
      val __obj = js.Dynamic.literal(any = any.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonRulesEngine.mod.AnyConditions]
    }
    
    inline def ConditionProperties(fact: String, operator: String, value: typingsJapgolly.jsonRulesEngine.anon.Fact | Any): typingsJapgolly.jsonRulesEngine.mod.ConditionProperties = {
      val __obj = js.Dynamic.literal(fact = fact.asInstanceOf[js.Any], operator = operator.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.jsonRulesEngine.mod.ConditionProperties]
    }
  }
  ...
  object RuleProperties {
    ...
    extension [Self <: RuleProperties](x: Self) {
      ...
      inline def setOnFailure(value: (/* event */ Event, /* almanac */ Almanac, /* ruleResult */ RuleResult) => Callback): Self = StObject.set(x, "onFailure", js.Any.fromFunction3((t0: /* event */ Event, t1: /* almanac */ Almanac, t2: /* ruleResult */ RuleResult) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnFailureUndefined: Self = StObject.set(x, "onFailure", js.undefined)
      
      inline def setOnSuccess(value: (/* event */ Event, /* almanac */ Almanac, /* ruleResult */ RuleResult) => Callback): Self = StObject.set(x, "onSuccess", js.Any.fromFunction3((t0: /* event */ Event, t1: /* almanac */ Almanac, t2: /* ruleResult */ RuleResult) => (value(t0, t1, t2)).runNow()))
