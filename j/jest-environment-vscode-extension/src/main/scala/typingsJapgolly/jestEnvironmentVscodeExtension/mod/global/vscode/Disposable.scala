...
import typingsJapgolly.vscode.anon.Dispose
...
open class Disposable protected ()
  extends typingsJapgolly.vscode.mod.Disposable {
  /**
...
object Disposable {
  ...
  /**
    ...
    */
  inline def from(disposableLikes: Dispose*): typingsJapgolly.vscode.mod.Disposable = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(disposableLikes.asInstanceOf[Seq[js.Any]]*).asInstanceOf[typingsJapgolly.vscode.mod.Disposable]
}
