...
import typingsJapgolly.vscode.mod.ShellExecutionOptions
import typingsJapgolly.vscode.mod.ShellQuotedString
...
open class ShellExecution protected ()
  extends typingsJapgolly.vscode.mod.ShellExecution {
  /**
