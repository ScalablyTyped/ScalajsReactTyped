...
open class CompletionItem protected ()
  extends typingsJapgolly.vscode.mod.CompletionItem {
  /**
  ...
  def this(label: String, kind: typingsJapgolly.vscode.mod.CompletionItemKind) = this()
  def this(label: CompletionItemLabel, kind: typingsJapgolly.vscode.mod.CompletionItemKind) = this()
}
