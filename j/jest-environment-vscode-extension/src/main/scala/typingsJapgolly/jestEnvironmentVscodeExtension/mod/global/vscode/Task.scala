...
open class Task protected ()
  extends typingsJapgolly.vscode.mod.Task {
  /**
    * Creates a new task.
    *
  ...
  def this(
    ...
    name: String,
    source: String,
    execution: typingsJapgolly.vscode.mod.ProcessExecution
  ) = this()
  def this(
    taskDefinition: TaskDefinition,
    name: String,
    source: String,
    execution: typingsJapgolly.vscode.mod.ShellExecution
  ) = this()
  ...
  def this(
    ...
    name: String,
    source: String,
    execution: typingsJapgolly.vscode.mod.CustomExecution
  ) = this()
  def this(
    taskDefinition: TaskDefinition,
    scope: Global,
