...
open class InlineValueVariableLookup protected ()
  extends typingsJapgolly.vscode.mod.InlineValueVariableLookup {
  /**
  ...
  def this(range: typingsJapgolly.vscode.mod.Range, variableName: String) = this()
  def this(range: typingsJapgolly.vscode.mod.Range, variableName: String, caseSensitiveLookup: Boolean) = this()
  def this(range: typingsJapgolly.vscode.mod.Range, variableName: Unit, caseSensitiveLookup: Boolean) = this()
}
