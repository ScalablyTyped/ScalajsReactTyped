...
open class LinkedEditingRanges protected ()
  extends typingsJapgolly.vscode.mod.LinkedEditingRanges {
  /**
    ...
    */
  def this(ranges: js.Array[typingsJapgolly.vscode.mod.Range]) = this()
  def this(ranges: js.Array[typingsJapgolly.vscode.mod.Range], wordPattern: js.RegExp) = this()
}
