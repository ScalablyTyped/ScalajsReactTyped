...
open class ThemeIcon protected ()
  extends typingsJapgolly.vscode.mod.ThemeIcon {
  /**
  ...
  def this(id: String, color: typingsJapgolly.vscode.mod.ThemeColor) = this()
}
/* static members */
object ThemeIcon {
  ...
  @js.native
  val File: typingsJapgolly.vscode.mod.ThemeIcon = js.native
  ...
  @js.native
  val Folder: typingsJapgolly.vscode.mod.ThemeIcon = js.native
}
