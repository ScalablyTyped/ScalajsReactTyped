...
open class ParameterInformation protected ()
  extends typingsJapgolly.vscode.mod.ParameterInformation {
  /**
  ...
  def this(label: String, documentation: typingsJapgolly.vscode.mod.MarkdownString) = this()
  def this(label: js.Tuple2[Double, Double], documentation: String) = this()
  def this(label: js.Tuple2[Double, Double], documentation: typingsJapgolly.vscode.mod.MarkdownString) = this()
}
