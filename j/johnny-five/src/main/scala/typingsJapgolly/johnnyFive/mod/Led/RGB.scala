...
class RGB protected () extends js.Object {
  ...
  var blue: typingsJapgolly.johnnyFive.mod.Led = js.native
  var green: typingsJapgolly.johnnyFive.mod.Led = js.native
  val isAnode: Boolean = js.native
  var red: typingsJapgolly.johnnyFive.mod.Led = js.native
