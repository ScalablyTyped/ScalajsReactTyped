package typingsJapgolly.jqueryJcrop

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.jqueryJcrop.JQuery.Jcrop.Api
import typingsJapgolly.jqueryJcrop.JQuery.Jcrop.Options
  ...
  object Jcrop {
    ...
    object Api {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(animateTo = js.Any.fromFunction1((t0: js.Tuple4[Double, Double, Double, Double]) => animateTo(t0).runNow()), disable = disable.toJsFn, enable = enable.toJsFn, release = release.toJsFn, remove = remove.toJsFn, setSelect = js.Any.fromFunction1((t0: js.Tuple4[Double, Double, Double, Double]) => setSelect(t0).runNow()), tellScaled = tellScaled.toJsFn, tellSelect = tellSelect.toJsFn)
        __obj.asInstanceOf[Api]
      }
      
      extension [Self <: Api](x: Self) {
        
        inline def setAnimateTo(value: js.Tuple4[Double, Double, Double, Double] => Callback): Self = StObject.set(x, "animateTo", js.Any.fromFunction1((t0: js.Tuple4[Double, Double, Double, Double]) => value(t0).runNow()))
        ...
        inline def setSetSelect(value: js.Tuple4[Double, Double, Double, Double] => Callback): Self = StObject.set(x, "setSelect", js.Any.fromFunction1((t0: js.Tuple4[Double, Double, Double, Double]) => value(t0).runNow()))
        
        inline def setTellScaled(value: CallbackTo[SelectionInfo]): Self = StObject.set(x, "tellScaled", value.toJsFn)
        
        inline def setTellSelect(value: CallbackTo[SelectionInfo]): Self = StObject.set(x, "tellSelect", value.toJsFn)
      }
    }
    
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.jqueryJcrop.jqueryJcropStrings.n
      - typingsJapgolly.jqueryJcrop.jqueryJcropStrings.s
      - typingsJapgolly.jqueryJcrop.jqueryJcropStrings.e
      - typingsJapgolly.jqueryJcrop.jqueryJcropStrings.w
    */
    trait CardinalDirection extends StObject
    object CardinalDirection {
      
      inline def e: typingsJapgolly.jqueryJcrop.jqueryJcropStrings.e = "e".asInstanceOf[typingsJapgolly.jqueryJcrop.jqueryJcropStrings.e]
      
      inline def n: typingsJapgolly.jqueryJcrop.jqueryJcropStrings.n = "n".asInstanceOf[typingsJapgolly.jqueryJcrop.jqueryJcropStrings.n]
      
      inline def s: typingsJapgolly.jqueryJcrop.jqueryJcropStrings.s = "s".asInstanceOf[typingsJapgolly.jqueryJcrop.jqueryJcropStrings.s]
      
      inline def w: typingsJapgolly.jqueryJcrop.jqueryJcropStrings.w = "w".asInstanceOf[typingsJapgolly.jqueryJcrop.jqueryJcropStrings.w]
    }
    
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.jqueryJcrop.jqueryJcropStrings.nw
      - typingsJapgolly.jqueryJcrop.jqueryJcropStrings.ne
      - typingsJapgolly.jqueryJcrop.jqueryJcropStrings.se
      - typingsJapgolly.jqueryJcrop.jqueryJcropStrings.sw
    */
    trait IntermediateDirection extends StObject
    object IntermediateDirection {
      
      inline def ne: typingsJapgolly.jqueryJcrop.jqueryJcropStrings.ne = "ne".asInstanceOf[typingsJapgolly.jqueryJcrop.jqueryJcropStrings.ne]
      
      inline def nw: typingsJapgolly.jqueryJcrop.jqueryJcropStrings.nw = "nw".asInstanceOf[typingsJapgolly.jqueryJcrop.jqueryJcropStrings.nw]
      
      inline def se: typingsJapgolly.jqueryJcrop.jqueryJcropStrings.se = "se".asInstanceOf[typingsJapgolly.jqueryJcrop.jqueryJcropStrings.se]
      
      inline def sw: typingsJapgolly.jqueryJcrop.jqueryJcropStrings.sw = "sw".asInstanceOf[typingsJapgolly.jqueryJcrop.jqueryJcropStrings.sw]
    }
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setOnChange(value: /* c */ SelectionInfo => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* c */ SelectionInfo) => value(t0).runNow()))
        
        inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
        
        inline def setOnDblClick(value: /* c */ SelectionInfo => Callback): Self = StObject.set(x, "onDblClick", js.Any.fromFunction1((t0: /* c */ SelectionInfo) => value(t0).runNow()))
        
        inline def setOnDblClickUndefined: Self = StObject.set(x, "onDblClick", js.undefined)
        
        inline def setOnRelease(value: /* c */ SelectionInfo => Callback): Self = StObject.set(x, "onRelease", js.Any.fromFunction1((t0: /* c */ SelectionInfo) => value(t0).runNow()))
        
        inline def setOnReleaseUndefined: Self = StObject.set(x, "onRelease", js.undefined)
        
        inline def setOnSelect(value: /* c */ SelectionInfo => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction1((t0: /* c */ SelectionInfo) => value(t0).runNow()))
