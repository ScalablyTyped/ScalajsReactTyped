...
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`date-time`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`full-date`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`full-time`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`idn-email`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`idn-hostname`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`iri-reference`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`json-pointer-uri-fragment`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`json-pointer`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`relative-json-pointer`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`uri-reference`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.`uri-template`
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.date
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.email
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.hostname
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.ipv4
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.ipv6
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.iri
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.regex
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.time
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.uri
import typingsJapgolly.jsonSchemaTyped.jsonSchemaTypedStrings.uuid
