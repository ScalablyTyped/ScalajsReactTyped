...
import typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.ASNObject
...
open class ASN1Util ()
  extends StObject
     with typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.ASN1Util {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def newObject(param: ASNObject): typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.ASN1Object = js.native
}
object ASN1Util {
