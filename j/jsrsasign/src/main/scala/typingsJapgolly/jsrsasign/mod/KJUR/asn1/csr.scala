...
import typingsJapgolly.jsrsasign.anon.Ext
import typingsJapgolly.jsrsasign.anon.Tlv
import typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.csr.CertificationRequestInfoParams
import typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.csr.CertificationRequestParams
import typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.csr.PEMInfo
import typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.csr.ParamResponse
...
object csr {
  ...
  open class CertificationRequest ()
    extends StObject
       with typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.csr.CertificationRequest {
  ...
  open class CertificationRequestInfo ()
    extends StObject
       with typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.csr.CertificationRequestInfo {
