...
import typingsJapgolly.jsrsasign.AnonCsrinfo
...
object csr extends js.Object {
  ...
  class CertificationRequest ()
    extends typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.csr.CertificationRequest {
  ...
  class CertificationRequestInfo ()
    extends typingsJapgolly.jsrsasign.jsrsasign.KJUR.asn1.csr.CertificationRequestInfo
