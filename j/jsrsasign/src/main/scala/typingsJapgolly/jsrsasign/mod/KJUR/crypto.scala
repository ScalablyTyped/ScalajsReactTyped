...
import typingsJapgolly.jsrsasign.anon.Curve
import typingsJapgolly.jsrsasign.anon.Hmacmd5
import typingsJapgolly.jsrsasign.anon.Md2
import typingsJapgolly.jsrsasign.anon.Md5
import typingsJapgolly.jsrsasign.anon.Pass
import typingsJapgolly.jsrsasign.anon.Prov
import typingsJapgolly.jsrsasign.anon.`0`
import typingsJapgolly.jsrsasign.anon.`2a864886f70d010101`
...
object crypto {
  ...
  open class DSA ()
    extends StObject
       with typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.DSA
  ...
  open class ECDSA ()
    extends StObject
       with typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.ECDSA {
  ...
  open class Mac protected ()
    extends StObject
       with typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.Mac {
  ...
  open class MessageDigest protected ()
    extends StObject
       with typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.MessageDigest {
  ...
  open class Signature ()
    extends StObject
       with typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.Signature {
