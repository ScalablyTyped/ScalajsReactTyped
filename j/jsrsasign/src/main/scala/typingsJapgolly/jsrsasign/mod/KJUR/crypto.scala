...
import typingsJapgolly.jsrsasign.Anon2a864886f70d010101
import typingsJapgolly.jsrsasign.AnonAlgString
import typingsJapgolly.jsrsasign.AnonCurve
import typingsJapgolly.jsrsasign.AnonHmacmd5
import typingsJapgolly.jsrsasign.AnonMd2
import typingsJapgolly.jsrsasign.AnonMd5
import typingsJapgolly.jsrsasign.AnonPass
import typingsJapgolly.jsrsasign.AnonProv
import typingsJapgolly.jsrsasign.AnonRipemd160
import typingsJapgolly.jsrsasign.jsrsasign.BigInteger
import typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.ECParameter
import typingsJapgolly.jsrsasign.jsrsasign.RSAKey
import typingsJapgolly.jsrsasign.jsrsasignStrings.SIGN
import typingsJapgolly.jsrsasign.jsrsasignStrings.VERIFY
...
object crypto extends js.Object {
  ...
  @js.native
  class DSA ()
    extends typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.DSA
  ...
  @js.native
  class ECDSA ()
    extends typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.ECDSA {
  ...
  @js.native
  class Mac protected ()
    extends typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.Mac {
  ...
  class MessageDigest protected ()
    extends typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.MessageDigest {
  ...
  @js.native
  class Signature ()
    extends typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.Signature {
