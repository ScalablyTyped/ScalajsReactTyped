...
@js.native
class X509 ()
  extends typingsJapgolly.jsrsasign.jsrsasign.X509
...
object X509 extends js.Object {
  ...
  /**
    ...
    */
  def getPublicKeyFromCertHex(h: String): typingsJapgolly.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  /**
    ...
    */
  def getPublicKeyFromCertPEM(sCertPEM: String): typingsJapgolly.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = js.native
  /**
