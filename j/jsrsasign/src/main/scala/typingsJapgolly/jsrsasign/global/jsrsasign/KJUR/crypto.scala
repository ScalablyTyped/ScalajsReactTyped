...
object crypto {
  ...
  @js.native
  open class DSA ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.crypto.DSA
  ...
  @js.native
  open class ECDSA ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.crypto.ECDSA {
  ...
  open class Mac protected ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.crypto.Mac {
  ...
  open class MessageDigest protected ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.crypto.MessageDigest {
  ...
  open class Signature ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.crypto.Signature {
