...
object cades {
  ...
  open class CompleteCertificateRefs ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.asn1.cades.CompleteCertificateRefs {
  ...
  open class OtherCertID ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.asn1.cades.OtherCertID {
  ...
  open class OtherHash ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.asn1.cades.OtherHash {
    def this(params: String) = this()
  ...
  open class OtherHashAlgAndValue ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.asn1.cades.OtherHashAlgAndValue {
    def this(params: Alg) = this()
  }
  ...
  open class SignaturePolicyIdentifier ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.asn1.cades.SignaturePolicyIdentifier {
  ...
  open class SignatureTimeStamp ()
    extends typingsJapgolly.jsrsasign.mod.KJUR.asn1.cades.SignatureTimeStamp {
