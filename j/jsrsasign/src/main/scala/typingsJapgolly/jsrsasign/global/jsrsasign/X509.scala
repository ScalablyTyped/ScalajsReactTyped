package typingsJapgolly.jsrsasign.global.jsrsasign

import typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.DSA
import typingsJapgolly.jsrsasign.jsrsasign.KJUR.crypto.ECDSA
import typingsJapgolly.jsrsasign.jsrsasign.PublicKeyInfoPropOfCertPEMResult
...
@js.native
open class X509 ()
  extends typingsJapgolly.jsrsasign.mod.X509 {
...
object X509 {
  ...
  /**
    ...
    */
  /* static member */
  inline def getPublicKeyFromCertHex(h: String): typingsJapgolly.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = ^.asInstanceOf[js.Dynamic].applyDynamic("getPublicKeyFromCertHex")(h.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA]
  ...
  /**
    ...
    */
  /* static member */
  inline def getPublicKeyFromCertPEM(sCertPEM: String): typingsJapgolly.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA = ^.asInstanceOf[js.Dynamic].applyDynamic("getPublicKeyFromCertPEM")(sCertPEM.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.jsrsasign.jsrsasign.RSAKey | DSA | ECDSA]
