...
object ocsp {
  ...
  object TBSRequest {
    ...
    inline def apply(
      ...
      hV: String,
      isModified: String,
      setRequestListByParam: js.Array[CertificateRequest] => Callback
    ): TBSRequest = {
      val __obj = js.Dynamic.literal(getEncodedHex = getEncodedHex.toJsFn, getFreshValueHex = getFreshValueHex.toJsFn, getLengthHexFromValue = getLengthHexFromValue.toJsFn, getValueHex = getValueHex.toJsFn, hL = hL.asInstanceOf[js.Any], hT = hT.asInstanceOf[js.Any], hTLV = hTLV.asInstanceOf[js.Any], hV = hV.asInstanceOf[js.Any], isModified = isModified.asInstanceOf[js.Any], setRequestListByParam = js.Any.fromFunction1((t0: js.Array[CertificateRequest]) => setRequestListByParam(t0).runNow()), params = null)
      __obj.asInstanceOf[TBSRequest]
    }
    
    extension [Self <: TBSRequest](x: Self) {
      
      inline def setSetRequestListByParam(value: js.Array[CertificateRequest] => Callback): Self = StObject.set(x, "setRequestListByParam", js.Any.fromFunction1((t0: js.Array[CertificateRequest]) => value(t0).runNow()))
    }
  }
}
