...
object SubjectKeyIdentifier {
  ...
  inline def apply(
    ...
    hV: String,
    isModified: String,
    setKIDByParam: Any => Callback
  ): SubjectKeyIdentifier = {
    val __obj = js.Dynamic.literal(getEncodedHex = getEncodedHex.toJsFn, getFreshValueHex = getFreshValueHex.toJsFn, getLengthHexFromValue = getLengthHexFromValue.toJsFn, getValueHex = getValueHex.toJsFn, hL = hL.asInstanceOf[js.Any], hT = hT.asInstanceOf[js.Any], hTLV = hTLV.asInstanceOf[js.Any], hV = hV.asInstanceOf[js.Any], isModified = isModified.asInstanceOf[js.Any], setKIDByParam = js.Any.fromFunction1((t0: Any) => setKIDByParam(t0).runNow()), params = null)
    __obj.asInstanceOf[SubjectKeyIdentifier]
  }
  
  extension [Self <: SubjectKeyIdentifier](x: Self) {
    
    inline def setSetKIDByParam(value: Any => Callback): Self = StObject.set(x, "setKIDByParam", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
  }
}
