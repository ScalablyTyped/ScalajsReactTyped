...
object DERAbstractStructured {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(appendASN1Object = js.Any.fromFunction1((t0: ASN1Object) => appendASN1Object(t0).runNow()), asn1Array = asn1Array.asInstanceOf[js.Any], setByASN1ObjectArray = js.Any.fromFunction1(setByASN1ObjectArray))
    __obj.asInstanceOf[DERAbstractStructured]
  }
  
  extension [Self <: DERAbstractStructured](x: Self) {
    
    inline def setAppendASN1Object(value: ASN1Object => Callback): Self = StObject.set(x, "appendASN1Object", js.Any.fromFunction1((t0: ASN1Object) => value(t0).runNow()))
