package typingsJapgolly.jqueryFlagstrap.jQueryFlagStrap
...
object FlagStrapOptions {
  ...
  def apply(
    ...
    inputId: String = null,
    onSelect: (/* value */ js.Any, /* element */ js.Any) => Callback = null,
    ...
    if (onSelect != null) __obj.updateDynamic("onSelect")(js.Any.fromFunction2((t0: /* value */ js.Any, t1: /* element */ js.Any) => onSelect(t0, t1).runNow()))
