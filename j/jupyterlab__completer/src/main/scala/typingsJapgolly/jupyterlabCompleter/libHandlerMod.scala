...
import typingsJapgolly.jupyterlabCodeeditor.libEditorMod.CodeEditor.IPosition
import typingsJapgolly.jupyterlabCompleter.libHandlerMod.CompletionHandler.IOptions
...
import typingsJapgolly.jupyterlabCompleter.libWidgetMod.Completer
...
import typingsJapgolly.jupyterlabUiComponents.mod.LabIcon
...
object libHandlerMod {
  ...
  object CompletionHandler {
    ...
    @js.native
    val ICompletionItemsResponseType: typingsJapgolly.jupyterlabCompleter.jupyterlabCompleterStrings.ICompletionItemsReply = js.native
    ...
    trait ICompleterConnecterResponseType extends StObject {
      ...
      var responseType: typingsJapgolly.jupyterlabCompleter.jupyterlabCompleterStrings.ICompletionItemsReply
    }
    object ICompleterConnecterResponseType {
      ...
      extension [Self <: ICompleterConnecterResponseType](x: Self) {
        ...
        inline def setResponseType(value: typingsJapgolly.jupyterlabCompleter.jupyterlabCompleterStrings.ICompletionItemsReply): Self = StObject.set(x, "responseType", value.asInstanceOf[js.Any])
      }
    }
