...
import typingsJapgolly.jupyterlabCompleter.libHandlerMod.CompletionHandler.ICompletionItem
import typingsJapgolly.jupyterlabCompleter.libHandlerMod.CompletionHandler.ICompletionItems
