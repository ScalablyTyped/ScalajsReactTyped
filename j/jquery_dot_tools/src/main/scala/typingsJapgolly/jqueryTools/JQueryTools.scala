...
import typingsJapgolly.jqueryTools.JQueryTools.overlay.OverlayStatic
import typingsJapgolly.jqueryTools.jqueryToolsStrings.center
import typingsJapgolly.jqueryTools.jqueryToolsStrings.fast
import typingsJapgolly.jqueryTools.jqueryToolsStrings.normal
import typingsJapgolly.jqueryTools.jqueryToolsStrings.slow
  ...
  object overlay {
    ...
    object Overlay {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(close = close.toJsFn, getClosers = getClosers.toJsFn, getConf = getConf.toJsFn, getOverlay = getOverlay.toJsFn, getTrigger = getTrigger.toJsFn, isOpened = isOpened.toJsFn, load = load.toJsFn)
        __obj.asInstanceOf[Overlay]
      }
      
      extension [Self <: Overlay](x: Self) {
        
        inline def setClose(value: CallbackTo[Overlay]): Self = StObject.set(x, "close", value.toJsFn)
        
        inline def setGetClosers(value: CallbackTo[JQuery]): Self = StObject.set(x, "getClosers", value.toJsFn)
        
        inline def setGetConf(value: CallbackTo[OverlayOptions]): Self = StObject.set(x, "getConf", value.toJsFn)
        
        inline def setGetOverlay(value: CallbackTo[JQuery]): Self = StObject.set(x, "getOverlay", value.toJsFn)
        
        inline def setGetTrigger(value: CallbackTo[JQuery]): Self = StObject.set(x, "getTrigger", value.toJsFn)
        
        inline def setIsOpened(value: CallbackTo[Boolean]): Self = StObject.set(x, "isOpened", value.toJsFn)
        
        inline def setLoad(value: CallbackTo[Overlay]): Self = StObject.set(x, "load", value.toJsFn)
      }
    }
    ...
    object OverlayStatic {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(addEffect = js.Any.fromFunction3((t0: String, t1: js.ThisFunction2[/* this */ Overlay, /* position */ CssOptions, /* done */ js.Function0[Unit], Unit], t2: js.ThisFunction1[/* this */ Overlay, /* done */ js.Function0[Unit], Unit]) => (addEffect(t0, t1, t2)).runNow()))
      ...
      extension [Self <: OverlayStatic](x: Self) {
        ...
        inline def setAddEffect(
          value: (String, js.ThisFunction2[/* this */ Overlay, /* position */ CssOptions, /* done */ js.Function0[Unit], Unit], js.ThisFunction1[/* this */ Overlay, /* done */ js.Function0[Unit], Unit]) => Callback
        ): Self = StObject.set(x, "addEffect", js.Any.fromFunction3((t0: String, t1: js.ThisFunction2[/* this */ Overlay, /* position */ CssOptions, /* done */ js.Function0[Unit], Unit], t2: js.ThisFunction1[/* this */ Overlay, /* done */ js.Function0[Unit], Unit]) => (value(t0, t1, t2)).runNow()))
      }
    }
  }
}
