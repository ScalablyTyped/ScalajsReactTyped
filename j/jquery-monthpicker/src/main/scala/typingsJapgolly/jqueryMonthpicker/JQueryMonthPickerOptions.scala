...
import typingsJapgolly.jqueryMonthpicker.anon.BackTo
import typingsJapgolly.jqueryMonthpicker.jqueryMonthpickerStrings.fadeOut
import typingsJapgolly.jqueryMonthpicker.jqueryMonthpickerStrings.none
import typingsJapgolly.jqueryMonthpicker.jqueryMonthpickerStrings.slideUp
...
object JQueryMonthPickerOptions {
  ...
  extension [Self <: JQueryMonthPickerOptions](x: Self) {
    ...
    inline def setOnAfterMenuClose(value: Callback): Self = StObject.set(x, "OnAfterMenuClose", value.toJsFn)
    
    inline def setOnAfterMenuCloseUndefined: Self = StObject.set(x, "OnAfterMenuClose", js.undefined)
    
    inline def setOnAfterMenuOpen(value: Callback): Self = StObject.set(x, "OnAfterMenuOpen", value.toJsFn)
    
    inline def setOnAfterMenuOpenUndefined: Self = StObject.set(x, "OnAfterMenuOpen", js.undefined)
    
    inline def setOnBeforeMenuClose(value: Callback): Self = StObject.set(x, "OnBeforeMenuClose", value.toJsFn)
    
    inline def setOnBeforeMenuCloseUndefined: Self = StObject.set(x, "OnBeforeMenuClose", js.undefined)
    
    inline def setOnBeforeMenuOpen(value: Callback): Self = StObject.set(x, "OnBeforeMenuOpen", value.toJsFn)
