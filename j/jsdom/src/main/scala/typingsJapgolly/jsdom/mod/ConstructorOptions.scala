...
import typingsJapgolly.jsdom.jsdomStrings.`outside-only`
import typingsJapgolly.jsdom.jsdomStrings.dangerously
import typingsJapgolly.jsdom.jsdomStrings.usable
...
object ConstructorOptions {
  @scala.inline
  def apply(
    beforeParse: /* window */ DOMWindow => Callback = null,
    ...
    if (beforeParse != null) __obj.updateDynamic("beforeParse")(js.Any.fromFunction1((t0: /* window */ typingsJapgolly.jsdom.mod.DOMWindow) => beforeParse(t0).runNow()))
