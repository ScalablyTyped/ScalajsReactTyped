...
import typingsJapgolly.jestValidate.anon.Dicts
import typingsJapgolly.jestValidate.anon.HasDeprecationWarnings
...
object mod {
  ...
  inline def validateCLIOptions(argv: Argv, options: Dicts): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("validateCLIOptions")(argv.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  inline def validateCLIOptions(argv: Argv, options: Dicts, rawArgv: js.Array[String]): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("validateCLIOptions")(argv.asInstanceOf[js.Any], options.asInstanceOf[js.Any], rawArgv.asInstanceOf[js.Any])).asInstanceOf[Boolean]
  ...
  object ValidationOptions {
    ...
    extension [Self <: ValidationOptions](x: Self) {
      ...
      inline def setError(
        value: (/* option */ String, /* received */ Any, /* defaultValue */ Any, /* options */ ValidationOptions, /* path */ js.UndefOr[js.Array[String]]) => Callback
      ): Self = StObject.set(x, "error", js.Any.fromFunction5((t0: /* option */ String, t1: /* received */ Any, t2: /* defaultValue */ Any, t3: /* options */ ValidationOptions, t4: /* path */ js.UndefOr[js.Array[String]]) => (value(t0, t1, t2, t3, t4)).runNow()))
      ...
      inline def setUnknown(
        value: (/* config */ Record[String, Any], /* exampleConfig */ Record[String, Any], /* option */ String, /* options */ ValidationOptions, /* path */ js.UndefOr[js.Array[String]]) => Callback
      ): Self = StObject.set(x, "unknown", js.Any.fromFunction5((t0: /* config */ Record[String, Any], t1: /* exampleConfig */ Record[String, Any], t2: /* option */ String, t3: /* options */ ValidationOptions, t4: /* path */ js.UndefOr[js.Array[String]]) => (value(t0, t1, t2, t3, t4)).runNow()))
