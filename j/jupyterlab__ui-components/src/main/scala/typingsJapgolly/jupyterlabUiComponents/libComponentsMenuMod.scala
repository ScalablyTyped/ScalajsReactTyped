...
import typingsJapgolly.jupyterlabUiComponents.libComponentsMenuMod.IRankedMenu.IOptions
import typingsJapgolly.luminoCommands.mod.CommandRegistry
import typingsJapgolly.luminoCommands.mod.CommandRegistry.Dataset
...
import typingsJapgolly.luminoWidgets.typesMenuMod.Menu.IItem
import typingsJapgolly.luminoWidgets.typesMenuMod.Menu.IItemOptions
import typingsJapgolly.luminoWidgets.typesMenuMod.Menu.ItemType
...
object libComponentsMenuMod {
  ...
  trait IRankedMenu
    ...
    /**
      ...
      */
    def addItem(options: typingsJapgolly.jupyterlabUiComponents.libComponentsMenuMod.IRankedMenu.IItemOptions): IItem = js.native
  ...
  object IRankedMenu {
    ...
    trait IItemOptions
      extends StObject
         with typingsJapgolly.luminoWidgets.typesMenuMod.Menu.IItemOptions {
    ...
    object IItemOptions {
      ...
      inline def apply(): typingsJapgolly.jupyterlabUiComponents.libComponentsMenuMod.IRankedMenu.IItemOptions = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.jupyterlabUiComponents.libComponentsMenuMod.IRankedMenu.IItemOptions]
      }
      
      extension [Self <: typingsJapgolly.jupyterlabUiComponents.libComponentsMenuMod.IRankedMenu.IItemOptions](x: Self) {
    ...
    trait IOptions
      extends StObject
         with typingsJapgolly.luminoWidgets.typesMenuMod.Menu.IOptions {
  ...
  open class RankedMenu protected ()
    ...
    def insertItem(
      index: Double,
      options: typingsJapgolly.jupyterlabUiComponents.libComponentsMenuMod.IRankedMenu.IItemOptions
  ...
  object IDisposableMenuItem {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(args = args.asInstanceOf[js.Any], caption = caption.asInstanceOf[js.Any], className = className.asInstanceOf[js.Any], command = command.asInstanceOf[js.Any], dataset = dataset.asInstanceOf[js.Any], dispose = dispose.toJsFn, iconClass = iconClass.asInstanceOf[js.Any], iconLabel = iconLabel.asInstanceOf[js.Any], isDisposed = isDisposed.asInstanceOf[js.Any], isEnabled = isEnabled.asInstanceOf[js.Any], isToggled = isToggled.asInstanceOf[js.Any], isVisible = isVisible.asInstanceOf[js.Any], label = label.asInstanceOf[js.Any], mnemonic = mnemonic.asInstanceOf[js.Any], keyBinding = null, submenu = null)
