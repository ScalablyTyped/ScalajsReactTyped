...
import typingsJapgolly.jupyterlabUiComponents.anon.IIconPartialIRenderer
...
import typingsJapgolly.jupyterlabUiComponents.anon.PartialIRenderer
...
import typingsJapgolly.jupyterlabUiComponents.anon.Title
import typingsJapgolly.jupyterlabUiComponents.jupyterlabUiComponentsStrings.div
import typingsJapgolly.jupyterlabUiComponents.jupyterlabUiComponentsStrings.span
import typingsJapgolly.jupyterlabUiComponents.libIconLabiconMod.LabIcon.ILabIcon
import typingsJapgolly.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IProps
import typingsJapgolly.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IReact
import typingsJapgolly.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IReactProps
import typingsJapgolly.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IRendererOptions
  ...
  object LabIcon {
    ...
    object IOptions {
      ...
      extension [Self <: IOptions](x: Self) {
        ...
        inline def setRender(value: /* host */ HTMLElement => Callback): Self = StObject.set(x, "render", js.Any.fromFunction1((t0: /* host */ HTMLElement) => value(t0).runNow()))
        
        inline def setRenderUndefined: Self = StObject.set(x, "render", js.undefined)
        
        inline def setSvgstr(value: String): Self = StObject.set(x, "svgstr", value.asInstanceOf[js.Any])
        
        inline def setUnrender(value: (/* host */ HTMLElement, /* options */ js.UndefOr[Attrs]) => Callback): Self = StObject.set(x, "unrender", js.Any.fromFunction2((t0: /* host */ HTMLElement, t1: /* options */ js.UndefOr[Attrs]) => (value(t0, t1)).runNow()))
    ...
    trait IProps
      extends StObject
         with typingsJapgolly.jupyterlabUiComponents.libStyleIconMod.LabIconStyle.IProps {
    ...
    /**
      ...
      */
    type IReactRef = RefHandle[SVGElement]
