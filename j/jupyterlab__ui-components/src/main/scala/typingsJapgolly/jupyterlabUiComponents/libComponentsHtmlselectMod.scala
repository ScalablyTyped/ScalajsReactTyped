...
import typingsJapgolly.jupyterlabUiComponents.libComponentsInterfaceMod.IElementRefProps
import typingsJapgolly.jupyterlabUiComponents.libIconLabiconMod.LabIcon.IProps
import typingsJapgolly.jupyterlabUiComponents.libIconMod.LabIcon
