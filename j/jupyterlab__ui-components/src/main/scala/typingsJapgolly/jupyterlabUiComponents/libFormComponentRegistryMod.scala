...
object libFormComponentRegistryMod {
  ...
  object IFormComponentRegistry {
    ...
    extension [Self <: IFormComponentRegistry](x: Self) {
      ...
      inline def setAddRenderer(
        value: (String, /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Field */ Any) => Callback
      ): Self = StObject.set(x, "addRenderer", js.Any.fromFunction2((t0: String, t1: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify Field */ Any) => (value(t0, t1)).runNow()))
