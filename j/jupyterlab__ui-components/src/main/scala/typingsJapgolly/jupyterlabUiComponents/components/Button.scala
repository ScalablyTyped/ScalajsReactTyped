...
import typingsJapgolly.jupyterlabUiComponents.jupyterlabUiComponentsStrings.button
import typingsJapgolly.jupyterlabUiComponents.jupyterlabUiComponentsStrings.reset
import typingsJapgolly.jupyterlabUiComponents.jupyterlabUiComponentsStrings.submit
...
object Button {
  ...
  def withProps(p: IButtonProps & CommonProps[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
