...
object libComponentsMod {
  ...
  open class HTMLSelect protected ()
    extends typingsJapgolly.jupyterlabUiComponents.libComponentsHtmlselectMod.HTMLSelect {
  ...
  open class RankedMenu protected ()
    extends typingsJapgolly.jupyterlabUiComponents.libComponentsMenuMod.RankedMenu {
    /**
  ...
  @js.native
  open class Switch ()
    extends typingsJapgolly.jupyterlabUiComponents.libComponentsSwitchMod.Switch
}
