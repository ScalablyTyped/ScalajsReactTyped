...
import typingsJapgolly.uuid1345.anon.Encoding
import typingsJapgolly.uuid1345.anon.EncodingMac
import typingsJapgolly.uuid1345.anon.EncodingName
import typingsJapgolly.uuid1345.anon.Format
import typingsJapgolly.uuid1345.anon.Mac
import typingsJapgolly.uuid1345.anon.Name
import typingsJapgolly.uuid1345.anon.NameNamespace
import typingsJapgolly.uuid1345.anon.Namespace
import typingsJapgolly.uuid1345.anon.`0`
import typingsJapgolly.uuid1345.anon.`1`
import typingsJapgolly.uuid1345.anon.`2`
import typingsJapgolly.uuid1345.anon.`3`
...
object mod {
  ...
  object UUID {
    ...
    inline def apply(toBuffer: CallbackTo[Buffer], variant: String, version: String): UUID = {
      val __obj = js.Dynamic.literal(toBuffer = toBuffer.toJsFn, variant = variant.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
