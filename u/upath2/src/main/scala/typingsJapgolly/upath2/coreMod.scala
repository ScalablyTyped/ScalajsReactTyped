package typingsJapgolly.upath2

import org.scalablytyped.runtime.Instantiable2
import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.node.pathMod.PlatformPath
import typingsJapgolly.upath2.anon.PickPathWrapkeyofIPathNod
import typingsJapgolly.upath2.anon.TypeofPathWrap
import typingsJapgolly.upath2.libTypeMod.IPath
import typingsJapgolly.upath2.libTypeMod.IPathPlatform
...
object coreMod {
  ...
  object PathWrap {
    ...
    @js.native
    def fn: typingsJapgolly.upath2.libTypeMod.IPath = js.native
    inline def fn_=(x: typingsJapgolly.upath2.libTypeMod.IPath): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("fn")(x.asInstanceOf[js.Any])
    
    type IParse = typingsJapgolly.upath2.libTypeMod.IParse
    
    type IPath = typingsJapgolly.upath2.libTypeMod.IPath
    
    type IPathNode = typingsJapgolly.upath2.libTypeMod.IPathNode
  }
  ...
  trait IUPath extends PathWrap {
    ...
    var PathWrap: TypeofPathWrap & (Instantiable2[/* path */ Any, /* id */ String, typingsJapgolly.upath2.coreMod.PathWrap]) = js.native
