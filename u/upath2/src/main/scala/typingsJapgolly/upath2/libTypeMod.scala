...
import typingsJapgolly.node.pathMod.FormatInputPathObject
import typingsJapgolly.node.pathMod.ParsedPath
import typingsJapgolly.node.pathMod.PlatformPath
import typingsJapgolly.upath2.upath2Strings.Colon
import typingsJapgolly.upath2.upath2Strings.Semicolon
...
object libTypeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.upath2.upath2Strings.upath
    - typingsJapgolly.upath2.upath2Strings.node
    - typingsJapgolly.upath2.upath2Strings.win32
    - typingsJapgolly.upath2.upath2Strings.posix
  */
  trait IPathPlatform extends StObject
  object IPathPlatform {
    
    inline def node: typingsJapgolly.upath2.upath2Strings.node = "node".asInstanceOf[typingsJapgolly.upath2.upath2Strings.node]
    
    inline def posix: typingsJapgolly.upath2.upath2Strings.posix = "posix".asInstanceOf[typingsJapgolly.upath2.upath2Strings.posix]
    
    inline def upath: typingsJapgolly.upath2.upath2Strings.upath = "upath".asInstanceOf[typingsJapgolly.upath2.upath2Strings.upath]
    
    inline def win32: typingsJapgolly.upath2.upath2Strings.win32 = "win32".asInstanceOf[typingsJapgolly.upath2.upath2Strings.win32]
  }
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.node.pathMod.PlatformPath
    - typingsJapgolly.upath2.libTypeMod.IPath
    - typingsJapgolly.upath2.libTypeMod.IPathNode
  */
