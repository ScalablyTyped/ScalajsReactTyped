...
import typingsJapgolly.uifabricMergeStyles.uifabricMergeStylesInts.`1`
import typingsJapgolly.uifabricMergeStyles.uifabricMergeStylesInts.`2`
...
object libStylesheetMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.uifabricMergeStyles.uifabricMergeStylesInts.`0`
    - typingsJapgolly.uifabricMergeStyles.uifabricMergeStylesInts.`1`
    - typingsJapgolly.uifabricMergeStyles.uifabricMergeStylesInts.`2`
  */
  ...
  object IStyleSheetConfig {
    ...
    extension [Self <: IStyleSheetConfig](x: Self) {
      ...
      inline def setOnInsertRule(value: /* rule */ String => Callback): Self = StObject.set(x, "onInsertRule", js.Any.fromFunction1((t0: /* rule */ String) => value(t0).runNow()))
