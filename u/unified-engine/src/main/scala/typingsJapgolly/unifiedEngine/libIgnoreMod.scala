...
object libIgnoreMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.unifiedEngine.unifiedEngineStrings.cwd
    - typingsJapgolly.unifiedEngine.unifiedEngineStrings.dir
  */
  trait ResolveFrom extends StObject
  object ResolveFrom {
    
    inline def cwd: typingsJapgolly.unifiedEngine.unifiedEngineStrings.cwd = "cwd".asInstanceOf[typingsJapgolly.unifiedEngine.unifiedEngineStrings.cwd]
    
    inline def dir: typingsJapgolly.unifiedEngine.unifiedEngineStrings.dir = "dir".asInstanceOf[typingsJapgolly.unifiedEngine.unifiedEngineStrings.dir]
  }
}
