...
import typingsJapgolly.unifiedEngine.libFindUpMod.FindUp
...
object libConfigurationMod {
  ...
  trait Config extends StObject {
    ...
    var plugins: js.Array[
        Array[
          (typingsJapgolly.unified.mod.Plugin[js.Array[Any], Node[Data], Node[Data]]) | Any
        ]
      ]
  ...
  trait Options extends StObject {
    ...
    var plugins: js.UndefOr[typingsJapgolly.unified.mod.PluggableList | PluginIdObject | PluginIdList] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setPlugins(value: typingsJapgolly.unified.mod.PluggableList | PluginIdObject | PluginIdList): Self = StObject.set(x, "plugins", value.asInstanceOf[js.Any])
  ...
  type Plugin = typingsJapgolly.unified.mod.Plugin[js.Array[Any], Node[Data], Node[Data]]
  
  type PluginIdList = js.Array[String | (Array[String | Any])]
  
  type PluginIdObject = Record[String, js.UndefOr[Settings | Null]]
  
  type PluginTuple = typingsJapgolly.unified.mod.PluginTuple[js.Array[Any], Node[Data], Node[Data]]
