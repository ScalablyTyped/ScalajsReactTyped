...
object libFinderMod {
  ...
  type GitIgnore = typingsJapgolly.unifiedEngine.libIgnoreMod.Ignore
  
  type Ignore = typingsJapgolly.unifiedEngine.libIgnoreMod.Ignore
  ...
  trait SearchResults extends StObject {
    ...
    var stats: js.UndefOr[typingsJapgolly.node.nodeColonfsMod.Stats] = js.undefined
  }
  object SearchResults {
    ...
    extension [Self <: SearchResults](x: Self) {
      ...
      inline def setStats(value: typingsJapgolly.node.nodeColonfsMod.Stats): Self = StObject.set(x, "stats", value.asInstanceOf[js.Any])
