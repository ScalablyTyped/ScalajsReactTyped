...
import typingsJapgolly.unified.mod.Pluggable
import typingsJapgolly.unified.mod.PluggableList
import typingsJapgolly.unifiedEngine.libConfigurationMod.PluginIdList
import typingsJapgolly.unifiedEngine.libConfigurationMod.PluginIdObject
import typingsJapgolly.unifiedEngine.unifiedEngineInts.`0`
import typingsJapgolly.unifiedEngine.unifiedEngineInts.`1`
...
object libMod {
  ...
  type Completer = typingsJapgolly.unifiedEngine.libFileSetMod.Completer
  
  type ConfigTransform = typingsJapgolly.unifiedEngine.libConfigurationMod.ConfigTransform
  ...
  trait Context extends StObject {
    ...
    /**
      ...
      */
    var fileSet: js.UndefOr[typingsJapgolly.unifiedEngine.libFileSetMod.FileSet] = js.undefined
    
    /**
      * Processed files.
      */
    var files: js.UndefOr[js.Array[typingsJapgolly.vfile.mod.VFile]] = js.undefined
  }
  object Context {
    ...
    extension [Self <: Context](x: Self) {
      ...
      inline def setFileSet(value: typingsJapgolly.unifiedEngine.libFileSetMod.FileSet): Self = StObject.set(x, "fileSet", value.asInstanceOf[js.Any])
      
      inline def setFileSetUndefined: Self = StObject.set(x, "fileSet", js.undefined)
      
      inline def setFiles(value: js.Array[typingsJapgolly.vfile.mod.VFile]): Self = StObject.set(x, "files", value.asInstanceOf[js.Any])
      
      inline def setFilesUndefined: Self = StObject.set(x, "files", js.undefined)
      
      inline def setFilesVarargs(value: typingsJapgolly.vfile.mod.VFile*): Self = StObject.set(x, "files", js.Array(value*))
    }
  }
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var configTransform: js.UndefOr[typingsJapgolly.unifiedEngine.libConfigurationMod.ConfigTransform] = js.undefined
    ...
    /**
      ...
      */
    var defaultConfig: js.UndefOr[typingsJapgolly.unifiedEngine.libConfigurationMod.Preset] = js.undefined
    ...
    /**
      ...
      */
    var files: js.UndefOr[js.Array[String | typingsJapgolly.vfile.mod.VFile | URL]] = js.undefined
    ...
    /**
      ...
      */
    var ignorePathResolveFrom: js.UndefOr[typingsJapgolly.unifiedEngine.libIgnoreMod.ResolveFrom] = js.undefined
    ...
    /**
      ...
      */
    var settings: js.UndefOr[typingsJapgolly.unifiedEngine.libConfigurationMod.Settings] = js.undefined
    ...
    /**
      ...
      */
    var streamError: js.UndefOr[WritableStream] = js.undefined
    
    /**
      * Stream to read from if no files are found or given.
      * Defaults to `process.stdin`.
      */
    var streamIn: js.UndefOr[ReadableStream] = js.undefined
    
    /**
      * Stream to write processed files to.
      * Defaults to `process.stdout`.
      */
    var streamOut: js.UndefOr[WritableStream] = js.undefined
  ...
  object Options {
    ...
    inline def apply(processor: CallbackTo[Processor]): Options = {
      val __obj = js.Dynamic.literal(processor = processor.toJsFn)
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setConfigTransform(
        value: (/* config */ Any, /* filePath */ String) => typingsJapgolly.unifiedEngine.libConfigurationMod.Preset
      ): Self = StObject.set(x, "configTransform", js.Any.fromFunction2(value))
      ...
      inline def setDefaultConfig(value: typingsJapgolly.unifiedEngine.libConfigurationMod.Preset): Self = StObject.set(x, "defaultConfig", value.asInstanceOf[js.Any])
      ...
      inline def setFiles(value: js.Array[String | typingsJapgolly.vfile.mod.VFile | URL]): Self = StObject.set(x, "files", value.asInstanceOf[js.Any])
      
      inline def setFilesUndefined: Self = StObject.set(x, "files", js.undefined)
      
      inline def setFilesVarargs(value: (String | typingsJapgolly.vfile.mod.VFile | URL)*): Self = StObject.set(x, "files", js.Array(value*))
      ...
      inline def setIgnorePathResolveFrom(value: typingsJapgolly.unifiedEngine.libIgnoreMod.ResolveFrom): Self = StObject.set(x, "ignorePathResolveFrom", value.asInstanceOf[js.Any])
      ...
      inline def setProcessor(value: CallbackTo[Processor]): Self = StObject.set(x, "processor", value.toJsFn)
      ...
      inline def setSettings(value: typingsJapgolly.unifiedEngine.libConfigurationMod.Settings): Self = StObject.set(x, "settings", value.asInstanceOf[js.Any])
      ...
      inline def setStreamError(value: WritableStream): Self = StObject.set(x, "streamError", value.asInstanceOf[js.Any])
      
      inline def setStreamErrorUndefined: Self = StObject.set(x, "streamError", js.undefined)
      
      inline def setStreamIn(value: ReadableStream): Self = StObject.set(x, "streamIn", value.asInstanceOf[js.Any])
      
      inline def setStreamInUndefined: Self = StObject.set(x, "streamIn", js.undefined)
      
      inline def setStreamOut(value: WritableStream): Self = StObject.set(x, "streamOut", value.asInstanceOf[js.Any])
  ...
  type Preset = typingsJapgolly.unifiedEngine.libConfigurationMod.Preset
  
  type Processor = typingsJapgolly.unified.mod.Processor[Any, Any, Any, Any]
  
  type ResolveFrom = typingsJapgolly.unifiedEngine.libIgnoreMod.ResolveFrom
  ...
  trait Settings extends StObject {
    ...
    var streamError: Exclude[js.UndefOr[WritableStream], Unit]
    
    var streamIn: Exclude[js.UndefOr[ReadableStream], Unit]
    
    var streamOut: Exclude[js.UndefOr[WritableStream], Unit]
  ...
  object Settings {
    ...
    inline def apply(
      ...
      processor: CallbackTo[Processor],
      settings: Exclude[
          js.UndefOr[
            /* import warning: importer.ImportType#apply Failed type conversion: unified-engine.unified-engine/lib.Preset['settings'] */ js.Any
          ], 
