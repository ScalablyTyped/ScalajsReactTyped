...
import typingsJapgolly.useSidecar.anon.Default
...
object distEs5TypesMod {
  ...
  object SideMedium {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(assignMedium = js.Any.fromFunction1((t0: MediumCallback[T]) => assignMedium(t0).runNow()), assignSyncMedium = js.Any.fromFunction1((t0: MediumCallback[T]) => assignSyncMedium(t0).runNow()), read = read.toJsFn, useMedium = js.Any.fromFunction1(useMedium))
      __obj.asInstanceOf[SideMedium[T]]
    }
    
    extension [Self <: SideMedium[?], T](x: Self & SideMedium[T]) {
      
      inline def setAssignMedium(value: MediumCallback[T] => Callback): Self = StObject.set(x, "assignMedium", js.Any.fromFunction1((t0: MediumCallback[T]) => value(t0).runNow()))
      
      inline def setAssignSyncMedium(value: MediumCallback[T] => Callback): Self = StObject.set(x, "assignSyncMedium", js.Any.fromFunction1((t0: MediumCallback[T]) => value(t0).runNow()))
      
      inline def setOptions(value: Record[String, Any]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      
      inline def setOptionsUndefined: Self = StObject.set(x, "options", js.undefined)
      
      inline def setRead(value: CallbackTo[js.UndefOr[T]]): Self = StObject.set(x, "read", value.toJsFn)
  ...
  object SidePush {
    ...
    inline def apply[T](filter: js.Function1[/* x */ T, Boolean] => SidePush[T], push: T => Callback): SidePush[T] = {
      val __obj = js.Dynamic.literal(filter = js.Any.fromFunction1(filter), push = js.Any.fromFunction1((t0: T) => push(t0).runNow()))
