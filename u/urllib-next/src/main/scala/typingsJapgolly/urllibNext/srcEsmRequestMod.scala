...
import typingsJapgolly.urllibNext.urllibNextStrings.buffer
import typingsJapgolly.urllibNext.urllibNextStrings.json
import typingsJapgolly.urllibNext.urllibNextStrings.stream
import typingsJapgolly.urllibNext.urllibNextStrings.text
...
object srcEsmRequestMod {
  ...
  type HttpMethod = typingsJapgolly.undici.typesDispatcherMod.HttpMethod
  ...
  object RequestOptions {
    ...
    extension [Self <: RequestOptions](x: Self) {
      ...
      inline def setBeforeRequest(value: /* repeated */ Any => Callback): Self = StObject.set(x, "beforeRequest", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      ...
      inline def setFormatRedirectUrl(value: (/* a */ Any, /* b */ Any) => Callback): Self = StObject.set(x, "formatRedirectUrl", js.Any.fromFunction2((t0: /* a */ Any, t1: /* b */ Any) => (value(t0, t1)).runNow()))
