package typingsJapgolly.uifabricStyling.ithemeMod
...
import typingsJapgolly.uifabricStyling.isemanticcolorsMod.ISemanticColors
import typingsJapgolly.uifabricStyling.ispacingMod.ISpacing
