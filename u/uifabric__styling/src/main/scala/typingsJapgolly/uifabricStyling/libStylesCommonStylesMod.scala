...
object libStylesCommonStylesMod {
  ...
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "HighContrastSelector")
  @js.native
  val HighContrastSelector: /* "@media screen and (-ms-high-contrast: active), screen and (forced-colors: active)" */ String = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "HighContrastSelectorBlack")
  @js.native
  ...
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "HighContrastSelectorWhite")
  @js.native
  ...
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMaxLarge")
  @js.native
  val ScreenWidthMaxLarge: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMaxMedium")
  @js.native
  val ScreenWidthMaxMedium: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMaxSmall")
  @js.native
  val ScreenWidthMaxSmall: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMaxXLarge")
  @js.native
  val ScreenWidthMaxXLarge: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMaxXXLarge")
  @js.native
  val ScreenWidthMaxXXLarge: Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMinLarge")
  @js.native
  val ScreenWidthMinLarge: /* 640 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMinMedium")
  @js.native
  val ScreenWidthMinMedium: /* 480 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMinSmall")
  @js.native
  val ScreenWidthMinSmall: /* 320 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMinUhfMobile")
  @js.native
  val ScreenWidthMinUhfMobile: /* 768 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMinXLarge")
  @js.native
  val ScreenWidthMinXLarge: /* 1024 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMinXXLarge")
  @js.native
  val ScreenWidthMinXXLarge: /* 1366 */ Double = js.native
  
  @JSImport("@uifabric/styling/lib/styles/CommonStyles", "ScreenWidthMinXXXLarge")
  @js.native
