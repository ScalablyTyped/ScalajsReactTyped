...
object libStylesPulsingBeaconAnimationStylesMod {
  ...
  object PulsingBeaconAnimationStyles {
    ...
    @JSImport("@uifabric/styling/lib/styles/PulsingBeaconAnimationStyles", "PulsingBeaconAnimationStyles")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@uifabric/styling/lib/styles/PulsingBeaconAnimationStyles", "PulsingBeaconAnimationStyles.continuousPulseAnimationDouble")
    @js.native
    ...
    @JSImport("@uifabric/styling/lib/styles/PulsingBeaconAnimationStyles", "PulsingBeaconAnimationStyles.continuousPulseAnimationSingle")
    @js.native
