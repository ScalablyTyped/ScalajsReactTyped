...
import typingsJapgolly.unsplashJs.anon.Download
...
object distMethodsCollectionsTypesMod {
  
  trait Basic
    extends StObject
       with Entity {
    
    var cover_photo: Nullable[typingsJapgolly.unsplashJs.distMethodsPhotosTypesMod.Basic]
  ...
  object Basic {
    ...
    extension [Self <: Basic](x: Self) {
      ...
      inline def setCover_photo(value: Nullable[typingsJapgolly.unsplashJs.distMethodsPhotosTypesMod.Basic]): Self = StObject.set(x, "cover_photo", value.asInstanceOf[js.Any])
