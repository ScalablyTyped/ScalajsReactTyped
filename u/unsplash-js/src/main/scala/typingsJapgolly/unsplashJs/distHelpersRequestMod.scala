...
object distHelpersRequestMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.unsplashJs.anon.accessKeystringapiUrlneve
    - typingsJapgolly.unsplashJs.anon.apiUrlstringaccessKeyneve
  */
  trait InitParams extends StObject
  object InitParams {
    
    inline def accessKeystringapiUrlneve(accessKey: String): typingsJapgolly.unsplashJs.anon.accessKeystringapiUrlneve = {
      val __obj = js.Dynamic.literal(accessKey = accessKey.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.unsplashJs.anon.accessKeystringapiUrlneve]
    }
    
    inline def apiUrlstringaccessKeyneve(apiUrl: String): typingsJapgolly.unsplashJs.anon.apiUrlstringaccessKeyneve = {
      val __obj = js.Dynamic.literal(apiUrl = apiUrl.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.unsplashJs.anon.apiUrlstringaccessKeyneve]
    }
  }
