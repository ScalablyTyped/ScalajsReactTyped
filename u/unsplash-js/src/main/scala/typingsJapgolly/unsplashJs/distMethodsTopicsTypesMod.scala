...
import typingsJapgolly.unsplashJs.anon.Html
...
import typingsJapgolly.unsplashJs.unsplashJsStrings.closed
import typingsJapgolly.unsplashJs.unsplashJsStrings.open
...
object distMethodsTopicsTypesMod {
  ...
  trait Basic
    ...
    var cover_photo: typingsJapgolly.unsplashJs.distMethodsPhotosTypesMod.Basic | Null
    ...
    var owners: NonEmptyArray[typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic]
  ...
  object Basic {
    ...
    inline def apply(
      ...
      id: String,
      links: Html,
      owners: NonEmptyArray[typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic],
      published_at: String,
      slug: String,
      starts_at: String,
      status: open | closed,
    ...
    extension [Self <: Basic](x: Self) {
      ...
      inline def setCover_photo(value: typingsJapgolly.unsplashJs.distMethodsPhotosTypesMod.Basic): Self = StObject.set(x, "cover_photo", value.asInstanceOf[js.Any])
      ...
      inline def setOwners(value: NonEmptyArray[typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic]): Self = StObject.set(x, "owners", value.asInstanceOf[js.Any])
  ...
  trait Full
    ...
    var top_contributors: js.Array[typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic]
  }
  object Full {
    ...
    inline def apply(
      ...
      status: open | closed,
      title: String,
      top_contributors: js.Array[typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic],
      total_photos: Double,
      updated_at: String
    ): Full = {
    ...
    extension [Self <: Full](x: Self) {
      ...
      inline def setTop_contributors(value: js.Array[typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic]): Self = StObject.set(x, "top_contributors", value.asInstanceOf[js.Any])
      
      inline def setTop_contributorsVarargs(value: typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic*): Self = StObject.set(x, "top_contributors", js.Array(value*))
    }
  }
}
