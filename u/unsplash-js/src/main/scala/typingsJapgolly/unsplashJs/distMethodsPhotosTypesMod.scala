...
import typingsJapgolly.unsplashJs.anon.Aperture
import typingsJapgolly.unsplashJs.anon.Change
import typingsJapgolly.unsplashJs.anon.City
import typingsJapgolly.unsplashJs.anon.Downloadlocation
import typingsJapgolly.unsplashJs.anon.Type
import typingsJapgolly.unsplashJs.distHelpersTypescriptMod.Nullable
import typingsJapgolly.unsplashJs.distTypesEntitiesMod.Entity
...
object distMethodsPhotosTypesMod {
  ...
  trait Basic
    ...
    var user: typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic
  ...
  object Basic {
    ...
    inline def apply(
      ...
      updated_at: String,
      urls: typingsJapgolly.unsplashJs.anon.Full,
      user: typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic,
      width: Double
    ): Basic = {
    ...
    extension [Self <: Basic](x: Self) {
      ...
      inline def setUser(value: typingsJapgolly.unsplashJs.distMethodsUsersTypesMod.Basic): Self = StObject.set(x, "user", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.unsplashJs.unsplashJsStrings.related
    - typingsJapgolly.unsplashJs.unsplashJsStrings.collected
  */
  trait RelatedCollectionsType extends StObject
  object RelatedCollectionsType {
    
    inline def collected: typingsJapgolly.unsplashJs.unsplashJsStrings.collected = "collected".asInstanceOf[typingsJapgolly.unsplashJs.unsplashJsStrings.collected]
    
    inline def related: typingsJapgolly.unsplashJs.unsplashJsStrings.related = "related".asInstanceOf[typingsJapgolly.unsplashJs.unsplashJsStrings.related]
  }
  ...
  trait VeryBasic
    ...
    var urls: typingsJapgolly.unsplashJs.anon.Full
  }
  object VeryBasic {
    
    inline def apply(created_at: String, id: String, updated_at: String, urls: typingsJapgolly.unsplashJs.anon.Full): VeryBasic = {
    ...
    extension [Self <: VeryBasic](x: Self) {
      ...
      inline def setUrls(value: typingsJapgolly.unsplashJs.anon.Full): Self = StObject.set(x, "urls", value.asInstanceOf[js.Any])
    }
  }
}
