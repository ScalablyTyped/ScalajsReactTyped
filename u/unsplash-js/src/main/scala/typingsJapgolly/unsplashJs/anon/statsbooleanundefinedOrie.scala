...
import typingsJapgolly.unsplashJs.distTypesRequestMod.Orientation
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined {  stats :boolean | undefined} & unsplash-js.unsplash-js/dist/types/request.OrientationParam & unsplash-js.unsplash-js/dist/methods/users.Username & unsplash-js.unsplash-js/dist/types/request.PaginationParams */
trait statsbooleanundefinedOrie extends StObject {
...
object statsbooleanundefinedOrie {
  
  inline def apply(username: String): statsbooleanundefinedOrie = {
    val __obj = js.Dynamic.literal(username = username.asInstanceOf[js.Any])
    __obj.asInstanceOf[statsbooleanundefinedOrie]
  }
  
  extension [Self <: statsbooleanundefinedOrie](x: Self) {
