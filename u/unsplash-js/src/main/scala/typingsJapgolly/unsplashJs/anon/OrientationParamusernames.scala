...
/* Inlined unsplash-js.unsplash-js/dist/types/request.OrientationParam & {  username :string} & unsplash-js.unsplash-js/dist/types/request.PaginationParams */
trait OrientationParamusernames extends StObject {
...
object OrientationParamusernames {
  
  inline def apply(username: String): OrientationParamusernames = {
