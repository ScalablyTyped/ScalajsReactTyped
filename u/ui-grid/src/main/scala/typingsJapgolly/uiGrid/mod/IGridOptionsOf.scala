...
import typingsJapgolly.uiGrid.mod.treeBase.IGridTreeBaseCustomAggregation
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait IGridOptionsOf[TEntity]
  extends typingsJapgolly.uiGrid.mod.cellNav.IGridOptions
...
object IGridOptionsOf {
  ...
  def apply[TEntity](
    ...
    exporterAllDataFn: js.UndefOr[CallbackTo[IPromise[js.Array[TEntity]]]] = js.undefined,
    exporterAllDataPromise: js.UndefOr[CallbackTo[IPromise[js.Array[TEntity]]]] = js.undefined,
    exporterCsvColumnSeparator: String = null,
    exporterCsvFilename: String = null,
    exporterFieldCallback: (/* grid */ IGridInstanceOf[TEntity], /* row */ IGridRowOf[TEntity], /* col */ IGridColumnOf[TEntity], /* value */ js.Any) => CallbackTo[js.Any] = null,
    exporterHeaderFilter: /* displayName */ String => CallbackTo[String] = null,
    ...
    exporterPdfCustomFormatter: /* docDefinition */ js.Any => CallbackTo[js.Any] = null,
    ...
    getRowIdentity: /* row */ IGridRowOf[TEntity] => CallbackTo[js.Any] = null,
    ...
    importerDataAddCallback: (/* grid */ IGridInstanceOf[TEntity], /* newObjects */ js.Array[TEntity]) => Callback = null,
    importerErrorCallback: (/* grid */ IGridInstanceOf[TEntity], /* errorKey */ String, /* consoleMessage */ String, /* context */ js.Any) => Callback = null,
    importerHeaderFilter: /* displayName */ String => CallbackTo[String] = null,
    importerNewObject: js.Function = null,
    importerObjectCallback: (/* grid */ IGridInstanceOf[TEntity], TEntity) => CallbackTo[TEntity] = null,
    importerProcessHeaders: (/* grid */ IGridInstanceOf[TEntity], /* headerArray */ js.Array[String]) => CallbackTo[js.Array[String]] = null,
    ...
    isRowSelectable: /* row */ typingsJapgolly.uiGrid.mod.selection.IGridRow => CallbackTo[Boolean] = null,
    ...
    onRegisterApi: /* gridApi */ IGridApiOf[TEntity] => Callback = null,
    ...
    rowEquality: (/* entityA */ TEntity, /* entityB */ TEntity) => CallbackTo[Boolean] = null,
    rowHeight: Int | Double = null,
    rowIdentity: /* row */ IGridRowOf[TEntity] => CallbackTo[js.Any] = null,
    ...
    exporterAllDataFn.foreach(p => __obj.updateDynamic("exporterAllDataFn")(p.toJsFn))
    exporterAllDataPromise.foreach(p => __obj.updateDynamic("exporterAllDataPromise")(p.toJsFn))
    ...
    if (exporterFieldCallback != null) __obj.updateDynamic("exporterFieldCallback")(js.Any.fromFunction4((t0: /* grid */ typingsJapgolly.uiGrid.mod.IGridInstanceOf[TEntity], t1: /* row */ typingsJapgolly.uiGrid.mod.IGridRowOf[TEntity], t2: /* col */ typingsJapgolly.uiGrid.mod.IGridColumnOf[TEntity], t3: /* value */ js.Any) => exporterFieldCallback(t0, t1, t2, t3).runNow()))
    if (exporterHeaderFilter != null) __obj.updateDynamic("exporterHeaderFilter")(js.Any.fromFunction1((t0: /* displayName */ java.lang.String) => exporterHeaderFilter(t0).runNow()))
    ...
    if (exporterPdfCustomFormatter != null) __obj.updateDynamic("exporterPdfCustomFormatter")(js.Any.fromFunction1((t0: /* docDefinition */ js.Any) => exporterPdfCustomFormatter(t0).runNow()))
    ...
    if (getRowIdentity != null) __obj.updateDynamic("getRowIdentity")(js.Any.fromFunction1((t0: /* row */ typingsJapgolly.uiGrid.mod.IGridRowOf[TEntity]) => getRowIdentity(t0).runNow()))
    ...
    if (importerDataAddCallback != null) __obj.updateDynamic("importerDataAddCallback")(js.Any.fromFunction2((t0: /* grid */ typingsJapgolly.uiGrid.mod.IGridInstanceOf[TEntity], t1: /* newObjects */ js.Array[TEntity]) => importerDataAddCallback(t0, t1).runNow()))
    if (importerErrorCallback != null) __obj.updateDynamic("importerErrorCallback")(js.Any.fromFunction4((t0: /* grid */ typingsJapgolly.uiGrid.mod.IGridInstanceOf[TEntity], t1: /* errorKey */ java.lang.String, t2: /* consoleMessage */ java.lang.String, t3: /* context */ js.Any) => importerErrorCallback(t0, t1, t2, t3).runNow()))
    if (importerHeaderFilter != null) __obj.updateDynamic("importerHeaderFilter")(js.Any.fromFunction1((t0: /* displayName */ java.lang.String) => importerHeaderFilter(t0).runNow()))
    if (importerNewObject != null) __obj.updateDynamic("importerNewObject")(importerNewObject.asInstanceOf[js.Any])
    if (importerObjectCallback != null) __obj.updateDynamic("importerObjectCallback")(js.Any.fromFunction2((t0: /* grid */ typingsJapgolly.uiGrid.mod.IGridInstanceOf[TEntity], t1: TEntity) => importerObjectCallback(t0, t1).runNow()))
    if (importerProcessHeaders != null) __obj.updateDynamic("importerProcessHeaders")(js.Any.fromFunction2((t0: /* grid */ typingsJapgolly.uiGrid.mod.IGridInstanceOf[TEntity], t1: /* headerArray */ js.Array[java.lang.String]) => importerProcessHeaders(t0, t1).runNow()))
    ...
    if (isRowSelectable != null) __obj.updateDynamic("isRowSelectable")(js.Any.fromFunction1((t0: /* row */ typingsJapgolly.uiGrid.mod.selection.IGridRow) => isRowSelectable(t0).runNow()))
    ...
    if (onRegisterApi != null) __obj.updateDynamic("onRegisterApi")(js.Any.fromFunction1((t0: /* gridApi */ typingsJapgolly.uiGrid.mod.IGridApiOf[TEntity]) => onRegisterApi(t0).runNow()))
    ...
    if (rowEquality != null) __obj.updateDynamic("rowEquality")(js.Any.fromFunction2((t0: /* entityA */ TEntity, t1: /* entityB */ TEntity) => rowEquality(t0, t1).runNow()))
    if (rowHeight != null) __obj.updateDynamic("rowHeight")(rowHeight.asInstanceOf[js.Any])
    if (rowIdentity != null) __obj.updateDynamic("rowIdentity")(js.Any.fromFunction1((t0: /* row */ typingsJapgolly.uiGrid.mod.IGridRowOf[TEntity]) => rowIdentity(t0).runNow()))
