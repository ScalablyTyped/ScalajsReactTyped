...
import typingsJapgolly.uiGrid.mod.grouping.IGridGroupingConfiguration
import typingsJapgolly.uiGrid.mod.treeBase.ITreeState
...
object saveState {
  ...
  object IGridOptions {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.saveState.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.saveState.IGridOptions]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.saveState.IGridOptions](x: Self) {
  ...
  object IGridSaveStateApi {
    ...
    inline def apply(restore: (IScope, IGridSavedState) => Callback, save: CallbackTo[IGridSavedState]): IGridSaveStateApi = {
      val __obj = js.Dynamic.literal(restore = js.Any.fromFunction2((t0: IScope, t1: IGridSavedState) => (restore(t0, t1)).runNow()), save = save.toJsFn)
      __obj.asInstanceOf[IGridSaveStateApi]
    }
    
    extension [Self <: IGridSaveStateApi](x: Self) {
      
      inline def setRestore(value: (IScope, IGridSavedState) => Callback): Self = StObject.set(x, "restore", js.Any.fromFunction2((t0: IScope, t1: IGridSavedState) => (value(t0, t1)).runNow()))
      
      inline def setSave(value: CallbackTo[IGridSavedState]): Self = StObject.set(x, "save", value.toJsFn)
    }
  }
