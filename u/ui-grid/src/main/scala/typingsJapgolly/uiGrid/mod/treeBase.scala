...
import typingsJapgolly.uiGrid.anon.RowCollapsed
...
object treeBase {
  ...
  object IColumnDef {
    ...
    inline def apply[TEntity](): typingsJapgolly.uiGrid.mod.treeBase.IColumnDef[TEntity] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.treeBase.IColumnDef[TEntity]]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.treeBase.IColumnDef[?], TEntity](x: Self & typingsJapgolly.uiGrid.mod.treeBase.IColumnDef[TEntity]) {
      
      inline def setCustomTreeAggregationFinalizerFn(value: /* aggregation */ IGridTreeBaseAggregationObject => Callback): Self = StObject.set(x, "customTreeAggregationFinalizerFn", js.Any.fromFunction1((t0: /* aggregation */ IGridTreeBaseAggregationObject) => value(t0).runNow()))
      ...
      inline def setCustomTreeAggregationFn(
        value: (/* aggregation */ IGridTreeBaseAggregationObject, /* fieldValue */ Any, /* numValue */ Double, /* row */ IGridRowOf[TEntity]) => Callback
      ): Self = StObject.set(x, "customTreeAggregationFn", js.Any.fromFunction4((t0: /* aggregation */ IGridTreeBaseAggregationObject, t1: /* fieldValue */ Any, t2: /* numValue */ Double, t3: /* row */ IGridRowOf[TEntity]) => (value(t0, t1, t2, t3)).runNow()))
  ...
  object IGridOptions {
    ...
    inline def apply[TEntity](): typingsJapgolly.uiGrid.mod.treeBase.IGridOptions[TEntity] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.treeBase.IGridOptions[TEntity]]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.treeBase.IGridOptions[?], TEntity](x: Self & typingsJapgolly.uiGrid.mod.treeBase.IGridOptions[TEntity]) {
  ...
  object IGridTreeBaseApi {
    ...
    inline def apply[TEntity](
      ...
      expandRow: (IGridRowOf[TEntity], Boolean) => Callback,
      ...
      val __obj = js.Dynamic.literal(collapseAllRows = collapseAllRows.toJsFn, collapseRow = js.Any.fromFunction1((t0: IGridRowOf[TEntity]) => collapseRow(t0).runNow()), collapseRowChildren = js.Any.fromFunction1((t0: IGridRowOf[TEntity]) => collapseRowChildren(t0).runNow()), expandAllRows = expandAllRows.toJsFn, expandRow = js.Any.fromFunction2((t0: IGridRowOf[TEntity], t1: Boolean) => (expandRow(t0, t1)).runNow()), getRowChildren = js.Any.fromFunction1(getRowChildren), getTreeState = getTreeState.toJsFn, on = on.asInstanceOf[js.Any], setTreeState = js.Any.fromFunction1((t0: ITreeState) => setTreeState(t0).runNow()), toggleRowTreeState = js.Any.fromFunction1((t0: IGridRowOf[TEntity]) => toggleRowTreeState(t0).runNow()))
    ...
    extension [Self <: IGridTreeBaseApi[?], TEntity](x: Self & IGridTreeBaseApi[TEntity]) {
      ...
      inline def setCollapseRow(value: IGridRowOf[TEntity] => Callback): Self = StObject.set(x, "collapseRow", js.Any.fromFunction1((t0: IGridRowOf[TEntity]) => value(t0).runNow()))
      
      inline def setCollapseRowChildren(value: IGridRowOf[TEntity] => Callback): Self = StObject.set(x, "collapseRowChildren", js.Any.fromFunction1((t0: IGridRowOf[TEntity]) => value(t0).runNow()))
      
      inline def setExpandAllRows(value: Callback): Self = StObject.set(x, "expandAllRows", value.toJsFn)
      
      inline def setExpandRow(value: (IGridRowOf[TEntity], Boolean) => Callback): Self = StObject.set(x, "expandRow", js.Any.fromFunction2((t0: IGridRowOf[TEntity], t1: Boolean) => (value(t0, t1)).runNow()))
      ...
      inline def setGetTreeState(value: CallbackTo[ITreeState]): Self = StObject.set(x, "getTreeState", value.toJsFn)
      
      inline def setOn(value: RowCollapsed[TEntity]): Self = StObject.set(x, "on", value.asInstanceOf[js.Any])
      
      inline def setSetTreeState(value: ITreeState => Callback): Self = StObject.set(x, "setTreeState", js.Any.fromFunction1((t0: ITreeState) => value(t0).runNow()))
      
      inline def setToggleRowTreeState(value: IGridRowOf[TEntity] => Callback): Self = StObject.set(x, "toggleRowTreeState", js.Any.fromFunction1((t0: IGridRowOf[TEntity]) => value(t0).runNow()))
    }
  }
