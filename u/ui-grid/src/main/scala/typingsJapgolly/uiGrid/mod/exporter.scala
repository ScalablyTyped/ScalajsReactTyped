...
object exporter {
  ...
  object IColumnDef {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.exporter.IColumnDef = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.exporter.IColumnDef]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.exporter.IColumnDef](x: Self) {
  ...
  object IGridExporterApi {
    ...
    inline def apply(csvExport: (String, String) => Callback, pdfExport: (String, String) => Callback): IGridExporterApi = {
      val __obj = js.Dynamic.literal(csvExport = js.Any.fromFunction2((t0: String, t1: String) => (csvExport(t0, t1)).runNow()), pdfExport = js.Any.fromFunction2((t0: String, t1: String) => (pdfExport(t0, t1)).runNow()))
      __obj.asInstanceOf[IGridExporterApi]
    }
    
    extension [Self <: IGridExporterApi](x: Self) {
      
      inline def setCsvExport(value: (String, String) => Callback): Self = StObject.set(x, "csvExport", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
      
      inline def setPdfExport(value: (String, String) => Callback): Self = StObject.set(x, "pdfExport", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object IGridOptions {
    ...
    inline def apply[TEntity](): typingsJapgolly.uiGrid.mod.exporter.IGridOptions[TEntity] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.exporter.IGridOptions[TEntity]]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.exporter.IGridOptions[?], TEntity](x: Self & typingsJapgolly.uiGrid.mod.exporter.IGridOptions[TEntity]) {
      
      inline def setExporterAllDataFn(value: CallbackTo[IPromise[js.Array[TEntity]]]): Self = StObject.set(x, "exporterAllDataFn", value.toJsFn)
      
      inline def setExporterAllDataFnUndefined: Self = StObject.set(x, "exporterAllDataFn", js.undefined)
      
      inline def setExporterAllDataPromise(value: CallbackTo[IPromise[js.Array[TEntity]]]): Self = StObject.set(x, "exporterAllDataPromise", value.toJsFn)
  ...
  object IGridRow {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.exporter.IGridRow = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.exporter.IGridRow]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.exporter.IGridRow](x: Self) {
