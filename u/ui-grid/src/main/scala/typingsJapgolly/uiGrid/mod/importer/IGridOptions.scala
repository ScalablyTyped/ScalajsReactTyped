...
object IGridOptions {
  ...
  def apply[TEntity](
    ...
    importerObjectCallback: (/* grid */ IGridInstanceOf[TEntity], /* newObject */ TEntity) => CallbackTo[TEntity] = null,
    ...
    if (importerObjectCallback != null) __obj.updateDynamic("importerObjectCallback")(js.Any.fromFunction2((t0: /* grid */ typingsJapgolly.uiGrid.mod.IGridInstanceOf[TEntity], t1: /* newObject */ TEntity) => importerObjectCallback(t0, t1).runNow()))
