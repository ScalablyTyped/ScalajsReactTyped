...
import typingsJapgolly.uiGrid.anon.AfterCellEdit
import typingsJapgolly.uiGrid.anon.BEGINCELLEDIT
...
object edit {
  ...
  object IColumnDef {
    ...
    inline def apply[TEntity](): typingsJapgolly.uiGrid.mod.edit.IColumnDef[TEntity] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.edit.IColumnDef[TEntity]]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.edit.IColumnDef[?], TEntity](x: Self & typingsJapgolly.uiGrid.mod.edit.IColumnDef[TEntity]) {
      ...
      inline def setEditFileChooserCallback(
        value: (/* gridRow */ IGridRowOf[TEntity], /* gridCol */ IGridColumnOf[TEntity], /* files */ FileList) => Callback
      ): Self = StObject.set(x, "editFileChooserCallback", js.Any.fromFunction3((t0: /* gridRow */ IGridRowOf[TEntity], t1: /* gridCol */ IGridColumnOf[TEntity], t2: /* files */ FileList) => (value(t0, t1, t2)).runNow()))
  ...
  object IGridOptions {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.edit.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.edit.IGridOptions]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.edit.IGridOptions](x: Self) {
  ...
  object IGridRow {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.edit.IGridRow = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.edit.IGridRow]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.edit.IGridRow](x: Self) {
