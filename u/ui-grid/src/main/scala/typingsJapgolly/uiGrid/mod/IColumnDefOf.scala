...
import typingsJapgolly.uiGrid.AnonGroupPriority
import typingsJapgolly.uiGrid.mod.edit.IEditDropdown
import typingsJapgolly.uiGrid.mod.treeBase.IGridTreeBaseAggregationObject
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

trait IColumnDefOf[TEntity]
  extends typingsJapgolly.uiGrid.mod.cellNav.IColumnDef
     with typingsJapgolly.uiGrid.mod.edit.IColumnDef[TEntity]
     with typingsJapgolly.uiGrid.mod.exporter.IColumnDef
     with typingsJapgolly.uiGrid.mod.grouping.IColumnDef
     with typingsJapgolly.uiGrid.mod.moveColumns.IColumnDef
     with typingsJapgolly.uiGrid.mod.pinning.IColumnDef
     with typingsJapgolly.uiGrid.mod.resizeColumns.IColumnDef
     with typingsJapgolly.uiGrid.mod.treeBase.IColumnDef[TEntity] {
  /**
    * defaults to false
...
object IColumnDefOf {
  ...
  def apply[TEntity](
    ...
    customTreeAggregationFinalizerFn: /* aggregation */ IGridTreeBaseAggregationObject => Callback = null,
    customTreeAggregationFn: (/* aggregation */ IGridTreeBaseAggregationObject, /* fieldValue */ js.Any, /* numValue */ Double, /* row */ IGridRowOf[TEntity]) => Callback = null,
    ...
    if (customTreeAggregationFinalizerFn != null) __obj.updateDynamic("customTreeAggregationFinalizerFn")(js.Any.fromFunction1((t0: /* aggregation */ typingsJapgolly.uiGrid.mod.treeBase.IGridTreeBaseAggregationObject) => customTreeAggregationFinalizerFn(t0).runNow()))
    if (customTreeAggregationFn != null) __obj.updateDynamic("customTreeAggregationFn")(js.Any.fromFunction4((t0: /* aggregation */ typingsJapgolly.uiGrid.mod.treeBase.IGridTreeBaseAggregationObject, t1: /* fieldValue */ js.Any, t2: /* numValue */ scala.Double, t3: /* row */ typingsJapgolly.uiGrid.mod.IGridRowOf[TEntity]) => customTreeAggregationFn(t0, t1, t2, t3).runNow()))
