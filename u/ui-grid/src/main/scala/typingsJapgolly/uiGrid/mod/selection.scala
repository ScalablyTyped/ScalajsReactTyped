...
import typingsJapgolly.uiGrid.anon.RowSelectionChanged
...
object selection {
  ...
  trait IGridOptions extends StObject {
    ...
    /**
      ...
      * property.
      */
    var isRowSelectable: js.UndefOr[js.Function1[/* row */ typingsJapgolly.uiGrid.mod.selection.IGridRow, Boolean]] = js.undefined
  ...
  object IGridOptions {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.selection.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.selection.IGridOptions]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.selection.IGridOptions](x: Self) {
      ...
      inline def setIsRowSelectable(value: /* row */ typingsJapgolly.uiGrid.mod.selection.IGridRow => Boolean): Self = StObject.set(x, "isRowSelectable", js.Any.fromFunction1(value))
  ...
  object IGridRow {
    ...
    inline def apply(setSelected: Boolean => Callback): typingsJapgolly.uiGrid.mod.selection.IGridRow = {
      val __obj = js.Dynamic.literal(setSelected = js.Any.fromFunction1((t0: Boolean) => setSelected(t0).runNow()))
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.selection.IGridRow]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.selection.IGridRow](x: Self) {
