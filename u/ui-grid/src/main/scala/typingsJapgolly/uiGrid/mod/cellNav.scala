...
import typingsJapgolly.angular.JQueryKeyEventObject
import typingsJapgolly.angular.mod.IPromise
import typingsJapgolly.std.Number
import typingsJapgolly.uiGrid.anon.CLEAR
import typingsJapgolly.uiGrid.anon.LEFT
import typingsJapgolly.uiGrid.anon.Navigate
...
object cellNav {
  ...
  trait ICellNavApi[TEntity] extends StObject {
    ...
    /**
      ...
      */
    def scrollToFocus(rowEntity: TEntity, colDef: typingsJapgolly.uiGrid.mod.cellNav.IColumnDef): IPromise[Any]
  }
  object ICellNavApi {
    ...
    inline def apply[TEntity](
      ...
      scrollToFocus: (TEntity, typingsJapgolly.uiGrid.mod.cellNav.IColumnDef) => IPromise[Any]
    ): ICellNavApi[TEntity] = {
      val __obj = js.Dynamic.literal(getCurrentSelection = getCurrentSelection.toJsFn, getFocusedCell = getFocusedCell.toJsFn, on = on.asInstanceOf[js.Any], rowColSelectIndex = js.Any.fromFunction1(rowColSelectIndex), scrollToFocus = js.Any.fromFunction2(scrollToFocus))
      __obj.asInstanceOf[ICellNavApi[TEntity]]
    }
    
    extension [Self <: ICellNavApi[?], TEntity](x: Self & ICellNavApi[TEntity]) {
      
      inline def setGetCurrentSelection(value: CallbackTo[js.Array[IRowCol[TEntity]]]): Self = StObject.set(x, "getCurrentSelection", value.toJsFn)
      
      inline def setGetFocusedCell(value: CallbackTo[IRowCol[TEntity]]): Self = StObject.set(x, "getFocusedCell", value.toJsFn)
      ...
      inline def setScrollToFocus(value: (TEntity, typingsJapgolly.uiGrid.mod.cellNav.IColumnDef) => IPromise[Any]): Self = StObject.set(x, "scrollToFocus", js.Any.fromFunction2(value))
    }
  }
  ...
  object IColumnDef {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.cellNav.IColumnDef = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.cellNav.IColumnDef]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.cellNav.IColumnDef](x: Self) {
  ...
  object IGridOptions {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.cellNav.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.cellNav.IGridOptions]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.cellNav.IGridOptions](x: Self) {
  ...
  object IGridRow {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.cellNav.IGridRow = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.cellNav.IGridRow]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.cellNav.IGridRow](x: Self) {
  ...
  object IRowCol {
    ...
    inline def apply[TEntity](
      ...
      val __obj = js.Dynamic.literal(col = col.asInstanceOf[js.Any], getIntersectionValueFiltered = getIntersectionValueFiltered.toJsFn, getIntersectionValueRaw = getIntersectionValueRaw.toJsFn, row = row.asInstanceOf[js.Any])
    ...
    extension [Self <: IRowCol[?], TEntity](x: Self & IRowCol[TEntity]) {
      ...
      inline def setGetIntersectionValueFiltered(value: CallbackTo[String | Number | js.Object]): Self = StObject.set(x, "getIntersectionValueFiltered", value.toJsFn)
      
      inline def setGetIntersectionValueRaw(value: CallbackTo[String | Number | js.Object]): Self = StObject.set(x, "getIntersectionValueRaw", value.toJsFn)
