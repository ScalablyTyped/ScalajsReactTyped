...
trait IGridRowOf[TEntity]
  extends typingsJapgolly.uiGrid.mod.cellNav.IGridRow
     with typingsJapgolly.uiGrid.mod.edit.IGridRow
     with typingsJapgolly.uiGrid.mod.exporter.IGridRow
     with typingsJapgolly.uiGrid.mod.selection.IGridRow
     with typingsJapgolly.uiGrid.mod.expandable.IGridRow {
