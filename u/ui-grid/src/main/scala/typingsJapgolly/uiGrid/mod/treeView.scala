...
object treeView {
  ...
  object IGridOptions {
    ...
    inline def apply(): typingsJapgolly.uiGrid.mod.treeView.IGridOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uiGrid.mod.treeView.IGridOptions]
    }
    
    extension [Self <: typingsJapgolly.uiGrid.mod.treeView.IGridOptions](x: Self) {
