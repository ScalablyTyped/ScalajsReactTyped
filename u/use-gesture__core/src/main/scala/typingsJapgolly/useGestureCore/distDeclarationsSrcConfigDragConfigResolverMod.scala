...
import typingsJapgolly.useGestureCore.anon.Axis
import typingsJapgolly.useGestureCore.anon.Capture
import typingsJapgolly.useGestureCore.anon.Distance
import typingsJapgolly.useGestureCore.anon.Duration
import typingsJapgolly.useGestureCore.anon.Pointer
...
import typingsJapgolly.useGestureCore.distDeclarationsSrcTypesConfigMod.DragConfig
