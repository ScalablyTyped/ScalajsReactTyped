...
object distDeclarationsSrcConfigCoordinatesConfigResolverMod {
  
  object coordinatesConfigResolver {
    
    @JSImport("@use-gesture/core/dist/declarations/src/config/coordinatesConfigResolver", "coordinatesConfigResolver")
    @js.native
    ...
    inline def bounds(): (js.Function0[EventTarget | Null]) | HTMLElement | (js.Tuple2[Vector2, Vector2]) = ^.asInstanceOf[js.Dynamic].applyDynamic("bounds")().asInstanceOf[(js.Function0[EventTarget | Null]) | HTMLElement | (js.Tuple2[Vector2, Vector2])]
    inline def bounds(value: js.Function1[/* state */ State, DragBounds]): (js.Function0[EventTarget | Null]) | HTMLElement | (js.Tuple2[Vector2, Vector2]) = ^.asInstanceOf[js.Dynamic].applyDynamic("bounds")(value.asInstanceOf[js.Any]).asInstanceOf[(js.Function0[EventTarget | Null]) | HTMLElement | (js.Tuple2[Vector2, Vector2])]
    inline def bounds(value: DragBounds): (js.Function0[EventTarget | Null]) | HTMLElement | (js.Tuple2[Vector2, Vector2]) = ^.asInstanceOf[js.Dynamic].applyDynamic("bounds")(value.asInstanceOf[js.Any]).asInstanceOf[(js.Function0[EventTarget | Null]) | HTMLElement | (js.Tuple2[Vector2, Vector2])]
