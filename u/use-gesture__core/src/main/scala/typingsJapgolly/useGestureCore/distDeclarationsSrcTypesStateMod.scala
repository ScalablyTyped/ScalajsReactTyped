...
import typingsJapgolly.useGestureCore.anon.CoordinatesStateeventEven
import typingsJapgolly.useGestureCore.anon.CoordinatesStateeventEvenActive
import typingsJapgolly.useGestureCore.anon.CoordinatesStateeventEvenArgs
import typingsJapgolly.useGestureCore.anon.DragStateeventEventTypesd
import typingsJapgolly.useGestureCore.anon.PinchStateeventEventTypesActive
import typingsJapgolly.useGestureCore.distDeclarationsSrcTypesConfigMod.GestureKey
import typingsJapgolly.useGestureCore.distDeclarationsSrcTypesUtilsMod.NonUndefined
...
import typingsJapgolly.useGestureCore.useGestureCoreStrings.angle
import typingsJapgolly.useGestureCore.useGestureCoreStrings.scale
...
object distDeclarationsSrcTypesStateMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.useGestureCore.useGestureCoreStrings.dragging
    - typingsJapgolly.useGestureCore.useGestureCoreStrings.wheeling
    - typingsJapgolly.useGestureCore.useGestureCoreStrings.moving
    - typingsJapgolly.useGestureCore.useGestureCoreStrings.hovering
    - typingsJapgolly.useGestureCore.useGestureCoreStrings.scrolling
    - typingsJapgolly.useGestureCore.useGestureCoreStrings.pinching
  */
  trait IngKey extends StObject
  object IngKey {
    
    inline def dragging: typingsJapgolly.useGestureCore.useGestureCoreStrings.dragging = "dragging".asInstanceOf[typingsJapgolly.useGestureCore.useGestureCoreStrings.dragging]
    
    inline def hovering: typingsJapgolly.useGestureCore.useGestureCoreStrings.hovering = "hovering".asInstanceOf[typingsJapgolly.useGestureCore.useGestureCoreStrings.hovering]
    
    inline def moving: typingsJapgolly.useGestureCore.useGestureCoreStrings.moving = "moving".asInstanceOf[typingsJapgolly.useGestureCore.useGestureCoreStrings.moving]
    
    inline def pinching: typingsJapgolly.useGestureCore.useGestureCoreStrings.pinching = "pinching".asInstanceOf[typingsJapgolly.useGestureCore.useGestureCoreStrings.pinching]
    
    inline def scrolling: typingsJapgolly.useGestureCore.useGestureCoreStrings.scrolling = "scrolling".asInstanceOf[typingsJapgolly.useGestureCore.useGestureCoreStrings.scrolling]
    
    inline def wheeling: typingsJapgolly.useGestureCore.useGestureCoreStrings.wheeling = "wheeling".asInstanceOf[typingsJapgolly.useGestureCore.useGestureCoreStrings.wheeling]
  }
  ...
  object PinchState {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(_active = _active.asInstanceOf[js.Any], _blocked = _blocked.asInstanceOf[js.Any], _bounds = _bounds.asInstanceOf[js.Any], _delta = _delta.asInstanceOf[js.Any], _direction = _direction.asInstanceOf[js.Any], _distance = _distance.asInstanceOf[js.Any], _force = _force.asInstanceOf[js.Any], _initial = _initial.asInstanceOf[js.Any], _movement = _movement.asInstanceOf[js.Any], _movementBound = _movementBound.asInstanceOf[js.Any], _pointerEvents = _pointerEvents.asInstanceOf[js.Any], _step = _step.asInstanceOf[js.Any], _touchIds = _touchIds.asInstanceOf[js.Any], _values = _values.asInstanceOf[js.Any], active = active.asInstanceOf[js.Any], cancel = cancel.toJsFn, canceled = canceled.asInstanceOf[js.Any], currentTarget = currentTarget.asInstanceOf[js.Any], da = da.asInstanceOf[js.Any], delta = delta.asInstanceOf[js.Any], direction = direction.asInstanceOf[js.Any], distance = distance.asInstanceOf[js.Any], elapsedTime = elapsedTime.asInstanceOf[js.Any], event = event.asInstanceOf[js.Any], first = first.asInstanceOf[js.Any], initial = initial.asInstanceOf[js.Any], intentional = intentional.asInstanceOf[js.Any], last = last.asInstanceOf[js.Any], lastOffset = lastOffset.asInstanceOf[js.Any], movement = movement.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], origin = origin.asInstanceOf[js.Any], overflow = overflow.asInstanceOf[js.Any], startTime = startTime.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any], timeStamp = timeStamp.asInstanceOf[js.Any], turns = turns.asInstanceOf[js.Any], values = values.asInstanceOf[js.Any], velocity = velocity.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
