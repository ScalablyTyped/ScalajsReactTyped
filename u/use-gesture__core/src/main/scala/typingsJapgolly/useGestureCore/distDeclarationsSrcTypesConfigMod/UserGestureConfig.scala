...
import typingsJapgolly.useGestureCore.anon.enabledbooleanundefinedHo
...
trait UserGestureConfig
  ...
  var scroll: js.UndefOr[CoordinatesConfig[typingsJapgolly.useGestureCore.useGestureCoreStrings.scroll]] = js.undefined
  
  var wheel: js.UndefOr[CoordinatesConfig[typingsJapgolly.useGestureCore.useGestureCoreStrings.wheel]] = js.undefined
}
