...
import typingsJapgolly.useGestureCore.anon.DragStateeventEventTypesdActive
import typingsJapgolly.useGestureCore.anon.Keys
import typingsJapgolly.useGestureCore.anon.PartialRecordPointerTypen
import typingsJapgolly.useGestureCore.anon.Velocity
