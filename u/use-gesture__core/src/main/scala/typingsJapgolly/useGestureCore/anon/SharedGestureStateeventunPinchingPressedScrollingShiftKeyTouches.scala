...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onSuspend'> : any | undefined,   args :any} */
trait SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouches extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onSuspend'> : any | undefined */ js.Any
...
object SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouches {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onSuspend'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouches = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouches]
  }
  
  extension [Self <: SharedGestureStateeventunPinchingPressedScrollingShiftKeyTouches](x: Self) {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onSuspend'> : any | undefined */ js.Any
