...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onInvalid'> : any | undefined,   args :any} */
trait SharedGestureStateeventunMetaKeyMovingPinchingPressedScrolling extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onInvalid'> : any | undefined */ js.Any
...
object SharedGestureStateeventunMetaKeyMovingPinchingPressedScrolling {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onInvalid'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunMetaKeyMovingPinchingPressedScrolling = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunMetaKeyMovingPinchingPressedScrolling]
  }
  
  extension [Self <: SharedGestureStateeventunMetaKeyMovingPinchingPressedScrolling](x: Self) {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onInvalid'> : any | undefined */ js.Any
