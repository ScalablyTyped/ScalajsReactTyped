...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onLostPointerCaptureCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKey extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onLostPointerCaptureCapture'> : any | undefined */ js.Any
...
object SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKey {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onLostPointerCaptureCapture'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKey = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKey]
  }
  
  extension [Self <: SharedGestureStateeventunMetaKeyMovingPinchingPressedScrollingShiftKey](x: Self) {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onLostPointerCaptureCapture'> : any | undefined */ js.Any
