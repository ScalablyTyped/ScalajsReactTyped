...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onMouseOutCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunDownDraggingEventHoveringLocked extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onMouseOutCapture'> : any | undefined */ js.Any
...
object SharedGestureStateeventunDownDraggingEventHoveringLocked {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onMouseOutCapture'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunDownDraggingEventHoveringLocked = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunDownDraggingEventHoveringLocked]
  }
  
  extension [Self <: SharedGestureStateeventunDownDraggingEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onMouseOutCapture'> : any | undefined */ js.Any
