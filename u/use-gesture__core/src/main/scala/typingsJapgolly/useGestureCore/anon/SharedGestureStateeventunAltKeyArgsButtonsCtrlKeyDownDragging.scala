...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchCancel'> : any | undefined,   args :any} */
trait SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDragging extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchCancel'> : any | undefined */ js.Any
...
object SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDragging {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchCancel'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDragging = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDragging]
  }
  
  extension [Self <: SharedGestureStateeventunAltKeyArgsButtonsCtrlKeyDownDragging](x: Self) {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchCancel'> : any | undefined */ js.Any
