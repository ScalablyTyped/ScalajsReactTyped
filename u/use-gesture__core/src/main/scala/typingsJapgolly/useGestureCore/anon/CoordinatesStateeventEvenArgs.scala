...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.CoordinatesState & {  event :@use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.EventTypes['hover']} */
trait CoordinatesStateeventEvenArgs extends StObject {
  ...
  /**
    ...
    */
  var event: UIEvent & PointerEvent
...
object CoordinatesStateeventEvenArgs {
  ...
  extension [Self <: CoordinatesStateeventEvenArgs](x: Self) {
    ...
    inline def setEvent(value: UIEvent & PointerEvent): Self = StObject.set(x, "event", value.asInstanceOf[js.Any])
