...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onDoubleClickCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunHoveringLockedMetaKeyMoving extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onDoubleClickCapture'> : any | undefined */ js.Any
...
object SharedGestureStateeventunHoveringLockedMetaKeyMoving {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onDoubleClickCapture'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunHoveringLockedMetaKeyMoving = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunHoveringLockedMetaKeyMoving]
  }
  
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKeyMoving](x: Self) {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onDoubleClickCapture'> : any | undefined */ js.Any
