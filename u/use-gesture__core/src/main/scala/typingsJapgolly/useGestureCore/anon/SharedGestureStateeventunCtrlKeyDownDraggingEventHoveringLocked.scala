...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onCanPlayCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLocked extends StObject {
  ...
  var event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onCanPlayCapture'> : any | undefined */ js.Any
...
object SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLocked {
  ...
  inline def apply(
    ...
    ctrlKey: Boolean,
    down: Boolean,
    event: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onCanPlayCapture'> : any | undefined */ js.Any,
    locked: Boolean,
    metaKey: Boolean,
    pressed: Boolean,
    shiftKey: Boolean,
    touches: Double
  ): SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLocked = {
    ...
    __obj.asInstanceOf[SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLocked]
  }
  
  extension [Self <: SharedGestureStateeventunCtrlKeyDownDraggingEventHoveringLocked](x: Self) {
    ...
    inline def setEvent(
      value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onCanPlayCapture'> : any | undefined */ js.Any
