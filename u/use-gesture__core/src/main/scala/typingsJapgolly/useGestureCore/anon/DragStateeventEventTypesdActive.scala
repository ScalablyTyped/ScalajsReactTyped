...
import typingsJapgolly.useGestureCore.useGestureCoreBooleans.`false`
...
trait DragStateeventEventTypesdActive extends StObject {
...
object DragStateeventEventTypesdActive {
