...
/* Inlined @use-gesture/core.@use-gesture/core/dist/declarations/src/types/state.SharedGestureState & {  event :undefined extends any | undefined ? @use-gesture/core.@use-gesture/core/dist/declarations/src/types/handlers.GetEventType<'onTouchEndCapture'> : any | undefined,   args :any} */
trait SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressed extends StObject {
...
object SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressed {
  ...
  extension [Self <: SharedGestureStateeventunHoveringLockedMetaKeyMovingPinchingPressed](x: Self) {
