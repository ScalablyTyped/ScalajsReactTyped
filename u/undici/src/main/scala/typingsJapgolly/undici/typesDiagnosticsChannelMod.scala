...
import typingsJapgolly.undici.typesConnectorMod.Options
  ...
  object DiagnosticsChannel {
    ...
    object ClientBeforeConnectMessage {
      ...
      extension [Self <: ClientBeforeConnectMessage](x: Self) {
        ...
        inline def setConnectorFunction2(value: (/* options */ Options, /* callback */ Callback) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "connector", js.Any.fromFunction2((t0: /* options */ Options, t1: /* callback */ Callback) => (value(t0, t1)).runNow()))
      }
    }
