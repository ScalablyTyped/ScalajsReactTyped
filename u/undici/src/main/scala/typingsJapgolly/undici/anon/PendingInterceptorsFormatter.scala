...
trait PendingInterceptorsFormatter extends StObject {
  ...
  var pendingInterceptorsFormatter: js.UndefOr[typingsJapgolly.undici.typesMockAgentMod.PendingInterceptorsFormatter] = js.undefined
}
object PendingInterceptorsFormatter {
  ...
  extension [Self <: PendingInterceptorsFormatter](x: Self) {
    ...
    inline def setPendingInterceptorsFormatter(value: typingsJapgolly.undici.typesMockAgentMod.PendingInterceptorsFormatter): Self = StObject.set(x, "pendingInterceptorsFormatter", value.asInstanceOf[js.Any])
