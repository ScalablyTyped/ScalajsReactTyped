...
/* Inlined {  dispatcher :undici.undici/types/dispatcher.^ | undefined} & std.Omit<undici.undici/types/dispatcher.RequestOptions, 'origin' | 'path'> */
trait dispatcherundefinedOmitReBody extends StObject {
...
object dispatcherundefinedOmitReBody {
  
  inline def apply(method: HttpMethod): dispatcherundefinedOmitReBody = {
    val __obj = js.Dynamic.literal(method = method.asInstanceOf[js.Any])
    __obj.asInstanceOf[dispatcherundefinedOmitReBody]
  }
  
  extension [Self <: dispatcherundefinedOmitReBody](x: Self) {
