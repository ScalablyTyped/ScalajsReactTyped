...
/* Inlined {  dispatcher :undici.undici/types/dispatcher.^ | undefined} & std.Omit<undici.undici/types/dispatcher.PipelineOptions, 'origin' | 'path'> */
trait dispatcherundefinedOmitPi extends StObject {
...
object dispatcherundefinedOmitPi {
  
  inline def apply(method: HttpMethod): dispatcherundefinedOmitPi = {
