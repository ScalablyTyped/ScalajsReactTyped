...
trait ResponseData extends StObject {
  ...
  var body: typingsJapgolly.undici.typesReadableMod.^ & BodyMixin
...
object ResponseData {
  ...
  inline def apply(
    body: typingsJapgolly.undici.typesReadableMod.^ & BodyMixin,
    context: js.Object,
  ...
  extension [Self <: ResponseData](x: Self) {
    ...
    inline def setBody(value: typingsJapgolly.undici.typesReadableMod.^ & BodyMixin): Self = StObject.set(x, "body", value.asInstanceOf[js.Any])
