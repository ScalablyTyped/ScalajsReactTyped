...
import typingsJapgolly.undici.typesConnectorMod.Callback
...
object typesClientMod {
  ...
  trait Options extends StObject {
    ...
    var interceptors: js.UndefOr[typingsJapgolly.undici.anon.Client] = js.undefined
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setConnectFunction1(value: /* options */ typingsJapgolly.undici.typesConnectorMod.Options => Socket | TLSSocket): Self = StObject.set(x, "connect", js.Any.fromFunction1(value))
      
      inline def setConnectFunction2(
        value: (/* options */ typingsJapgolly.undici.typesConnectorMod.Options, /* callback */ Callback) => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "connect", js.Any.fromFunction2((t0: /* options */ typingsJapgolly.undici.typesConnectorMod.Options, t1: /* callback */ Callback) => (value(t0, t1)).runNow()))
      ...
      inline def setInterceptors(value: typingsJapgolly.undici.anon.Client): Self = StObject.set(x, "interceptors", value.asInstanceOf[js.Any])
