...
import typingsJapgolly.undici.typesMockInterceptorMod.MockInterceptor.MockDispatchData
...
object typesMockAgentMod {
  ...
  trait MockAgent[TMockAgentOptions /* <: Options */]
    ...
    def assertNoPendingInterceptors(options: typingsJapgolly.undici.anon.PendingInterceptorsFormatter): Unit = js.native
  ...
  trait Options
    ...
    var agent: js.UndefOr[typingsJapgolly.undici.typesAgentMod.^] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setAgent(value: typingsJapgolly.undici.typesAgentMod.^): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
