...
import typingsJapgolly.undici.undiciStrings.native
import typingsJapgolly.undici.undiciStrings.transparent
...
object typesFileMod {
  ...
  open class File protected ()
    ...
    /**
      ...
      */
    def this(fileBits: js.Array[String | ArrayBufferView | org.scalajs.dom.Blob], fileName: String) = this()
    def this(
      fileBits: js.Array[String | ArrayBufferView | org.scalajs.dom.Blob],
      fileName: String,
