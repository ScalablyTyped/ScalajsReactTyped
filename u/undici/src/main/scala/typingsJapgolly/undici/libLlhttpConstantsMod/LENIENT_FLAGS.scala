...
object LENIENT_FLAGS extends StObject {
  ...
  sealed trait CHUNKED_LENGTH
    extends StObject
       with LENIENT_FLAGS
  /* 2 */ val CHUNKED_LENGTH: typingsJapgolly.undici.libLlhttpConstantsMod.LENIENT_FLAGS.CHUNKED_LENGTH & Double = js.native
  
  @js.native
  sealed trait HEADERS
    extends StObject
       with LENIENT_FLAGS
  /* 1 */ val HEADERS: typingsJapgolly.undici.libLlhttpConstantsMod.LENIENT_FLAGS.HEADERS & Double = js.native
  
  @js.native
  sealed trait KEEP_ALIVE
    extends StObject
       with LENIENT_FLAGS
  /* 4 */ val KEEP_ALIVE: typingsJapgolly.undici.libLlhttpConstantsMod.LENIENT_FLAGS.KEEP_ALIVE & Double = js.native
}
