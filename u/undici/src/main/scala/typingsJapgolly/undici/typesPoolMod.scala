...
object typesPoolMod {
  ...
  trait Options
    ...
    var factory: js.UndefOr[
        js.Function2[/* origin */ URL_, /* opts */ js.Object, typingsJapgolly.undici.typesDispatcherMod.^]
      ] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setFactory(value: (/* origin */ URL_, /* opts */ js.Object) => typingsJapgolly.undici.typesDispatcherMod.^): Self = StObject.set(x, "factory", js.Any.fromFunction2(value))
  ...
  trait Pool
    ...
    val stats: typingsJapgolly.undici.typesPoolStatsMod.^ = js.native
  }
  
  type PoolStats = typingsJapgolly.undici.typesPoolStatsMod.^
}
