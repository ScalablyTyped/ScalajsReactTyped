...
object mod {
  ...
  trait FrozenProcessor[ParseTree /* <: Node[Data] | Unit */, CurrentTree /* <: Node[Data] | Unit */, CompileTree /* <: Node[Data] | Unit */, CompileResult] extends StObject {
    ...
    var Compiler: js.UndefOr[
        typingsJapgolly.unified.mod.Compiler[Specific[Node[Data], CompileTree], Specific[Any, CompileResult]]
      ] = js.native
    
    var Parser: js.UndefOr[typingsJapgolly.unified.mod.Parser[Specific[Node[Data], ParseTree]]] = js.native
