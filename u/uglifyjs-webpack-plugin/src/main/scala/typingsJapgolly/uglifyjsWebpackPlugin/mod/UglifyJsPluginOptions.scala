...
object UglifyJsPluginOptions {
  ...
  def apply(
    ...
    warningsFilter: /* source */ String => CallbackTo[Boolean] = null
    ...
    if (warningsFilter != null) __obj.updateDynamic("warningsFilter")(js.Any.fromFunction1((t0: /* source */ java.lang.String) => warningsFilter(t0).runNow()))
