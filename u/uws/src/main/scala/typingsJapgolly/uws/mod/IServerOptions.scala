...
trait IServerOptions extends js.Object {
  ...
  var server: js.UndefOr[typingsJapgolly.node.httpMod.Server | typingsJapgolly.node.httpsMod.Server] = js.undefined
...
object IServerOptions {
  ...
  def apply(
    ...
    server: typingsJapgolly.node.httpMod.Server | typingsJapgolly.node.httpsMod.Server = null,
