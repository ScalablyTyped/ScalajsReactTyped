...
import typingsJapgolly.uws.anon.Binary
import typingsJapgolly.uws.anon.BinaryBoolean
import typingsJapgolly.uws.anon.Code
import typingsJapgolly.uws.anon.Data
import typingsJapgolly.uws.anon.Origin
import typingsJapgolly.uws.anon.Reason
import typingsJapgolly.uws.anon.Target
import typingsJapgolly.uws.anon.Type
import typingsJapgolly.uws.anon.`0`
...
object mod {
  ...
  object IServerOptions {
    ...
    extension [Self <: IServerOptions](x: Self) {
      ...
      inline def setVerifyClientFunction2(value: (/* info */ Origin, /* callback */ js.Function1[/* res */ Boolean, Unit]) => Callback): Self = StObject.set(x, "verifyClient", js.Any.fromFunction2((t0: /* info */ Origin, t1: /* callback */ js.Function1[/* res */ Boolean, Unit]) => (value(t0, t1)).runNow()))
  ...
  trait UwsHttp extends StObject {
    ...
    def createServer(): typingsJapgolly.node.httpMod.Server[
        Instantiable1[/* socket */ typingsJapgolly.node.nodeColonnetMod.Socket, IncomingMessage], 
        Instantiable1[
          /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
          ServerResponse[IncomingMessage]
