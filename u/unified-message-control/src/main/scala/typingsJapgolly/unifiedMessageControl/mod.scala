package typingsJapgolly.unifiedMessageControl

import typingsJapgolly.std.Record
import typingsJapgolly.unifiedMessageControl.unifiedMessageControlBooleans.`false`
import typingsJapgolly.unifiedMessageControl.unifiedMessageControlBooleans.`true`
import typingsJapgolly.unist.mod.Data
import typingsJapgolly.unist.mod.NodeData
import typingsJapgolly.unistUtilIs.mod.Props
import typingsJapgolly.unistUtilIs.mod.TestFunctionAnything
import typingsJapgolly.unistUtilIs.mod.Type
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.unifiedMessageControl.mod.OptionsWithoutReset
    - typingsJapgolly.unifiedMessageControl.mod.OptionsWithReset
  */
  trait Options extends StObject
  object Options {
    
    inline def OptionsWithReset(marker: /* node */ Node => Any, name: String): typingsJapgolly.unifiedMessageControl.mod.OptionsWithReset = {
      val __obj = js.Dynamic.literal(marker = js.Any.fromFunction1(marker), name = name.asInstanceOf[js.Any], reset = true)
      __obj.asInstanceOf[typingsJapgolly.unifiedMessageControl.mod.OptionsWithReset]
    }
    
    inline def OptionsWithoutReset(marker: /* node */ Node => Any, name: String): typingsJapgolly.unifiedMessageControl.mod.OptionsWithoutReset = {
      val __obj = js.Dynamic.literal(marker = js.Any.fromFunction1(marker), name = name.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.unifiedMessageControl.mod.OptionsWithoutReset]
    }
  }
  ...
  object OptionsBaseFields {
    ...
    extension [Self <: OptionsBaseFields](x: Self) {
      ...
      inline def setTestFunction3(
        value: (/* node */ typingsJapgolly.unistUtilIs.mod.Node, /* index */ js.UndefOr[Double | Null], /* parent */ js.UndefOr[typingsJapgolly.unistUtilIs.mod.Parent | Null]) => Boolean | Unit
