...
import typingsJapgolly.unzipper.anon.CompressedSize
import typingsJapgolly.unzipper.anon.Disknum
import typingsJapgolly.unzipper.anon.Path
import typingsJapgolly.unzipper.anon.Promise
import typingsJapgolly.unzipper.anon.Size
import typingsJapgolly.unzipper.unzipperStrings.Directory
...
object mod {
  ...
  trait File extends StObject {
    ...
    var `type`: Directory | typingsJapgolly.unzipper.unzipperStrings.File = js.native
