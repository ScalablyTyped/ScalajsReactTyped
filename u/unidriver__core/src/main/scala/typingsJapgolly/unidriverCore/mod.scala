...
import typingsJapgolly.unidriverCore.distKeyTypesMod.KeyDefinitionType
...
object mod {
  ...
  object ErrorTypes extends StObject {
    ...
    sealed trait MULTIPLE_ELEMENTS_WITH_SELECTOR
      extends StObject
         with ErrorTypes
    /* "multiple-elements-with-selector" */ val MULTIPLE_ELEMENTS_WITH_SELECTOR: typingsJapgolly.unidriverCore.mod.ErrorTypes.MULTIPLE_ELEMENTS_WITH_SELECTOR & String = js.native
    
    @js.native
    sealed trait NO_ELEMENTS_WITH_SELECTOR
      extends StObject
         with ErrorTypes
    /* "no-elements-with-selector" */ val NO_ELEMENTS_WITH_SELECTOR: typingsJapgolly.unidriverCore.mod.ErrorTypes.NO_ELEMENTS_WITH_SELECTOR & String = js.native
  }
  ...
  object MouseUniDriver {
    ...
    inline def apply[T](
      leave: CallbackTo[js.Promise[Unit]],
      moveTo: UniDriver[T] => js.Promise[Unit],
      press: CallbackTo[js.Promise[Unit]],
      release: CallbackTo[js.Promise[Unit]]
    ): MouseUniDriver[T] = {
      val __obj = js.Dynamic.literal(leave = leave.toJsFn, moveTo = js.Any.fromFunction1(moveTo), press = press.toJsFn, release = release.toJsFn)
      __obj.asInstanceOf[MouseUniDriver[T]]
    }
    
    extension [Self <: MouseUniDriver[?], T](x: Self & MouseUniDriver[T]) {
      
      inline def setLeave(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "leave", value.toJsFn)
      
      inline def setMoveTo(value: UniDriver[T] => js.Promise[Unit]): Self = StObject.set(x, "moveTo", js.Any.fromFunction1(value))
      
      inline def setPress(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "press", value.toJsFn)
      
      inline def setRelease(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "release", value.toJsFn)
    }
  }
  ...
  object UniDriverList {
    ...
    inline def apply[T](
      ...
      text: CallbackTo[js.Promise[js.Array[String]]]
    ): UniDriverList[T] = {
      val __obj = js.Dynamic.literal(count = count.toJsFn, filter = js.Any.fromFunction1(filter), get = js.Any.fromFunction1(get), map = js.Any.fromFunction1(map), text = text.toJsFn)
    ...
    extension [Self <: UniDriverList[?], T](x: Self & UniDriverList[T]) {
      ...
      inline def setText(value: CallbackTo[js.Promise[js.Array[String]]]): Self = StObject.set(x, "text", value.toJsFn)
    }
  }
}
