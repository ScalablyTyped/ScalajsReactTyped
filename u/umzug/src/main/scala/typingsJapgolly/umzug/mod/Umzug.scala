...
import typingsJapgolly.umzug.umzugStrings.migrated
import typingsJapgolly.umzug.umzugStrings.migrating
import typingsJapgolly.umzug.umzugStrings.reverted
import typingsJapgolly.umzug.umzugStrings.reverting
