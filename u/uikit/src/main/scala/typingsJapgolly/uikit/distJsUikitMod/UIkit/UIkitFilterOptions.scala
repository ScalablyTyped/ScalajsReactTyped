...
import typingsJapgolly.uikit.uikitBooleans.`false`
import typingsJapgolly.uikit.uikitStrings.`delayed-fade`
import typingsJapgolly.uikit.uikitStrings.fade
import typingsJapgolly.uikit.uikitStrings.slide
