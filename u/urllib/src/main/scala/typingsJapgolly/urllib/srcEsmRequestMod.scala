...
import typingsJapgolly.urllib.urllibStrings.buffer
import typingsJapgolly.urllib.urllibStrings.json
import typingsJapgolly.urllib.urllibStrings.stream
import typingsJapgolly.urllib.urllibStrings.text
