...
object libParamsMod {
  ...
  open class Param protected ()
    extends typingsJapgolly.uirouterCore.libParamsParamMod.Param {
    def this(
      id: String,
  ...
  open class ParamType protected ()
    extends typingsJapgolly.uirouterCore.libParamsParamTypeMod.ParamType {
    /**
  ...
  open class ParamTypes ()
    extends typingsJapgolly.uirouterCore.libParamsParamTypesMod.ParamTypes
  /* static members */
  object ParamTypes {
  ...
  open class StateParams ()
    extends typingsJapgolly.uirouterCore.libParamsStateParamsMod.StateParams {
