...
import typingsJapgolly.uirouterCore.anon.TypeofParam
import typingsJapgolly.uirouterCore.anon.TypeofUrlMatcher
...
import typingsJapgolly.uirouterCore.libParamsMod.ParamType
...
object libUrlUrlMatcherFactoryMod {
