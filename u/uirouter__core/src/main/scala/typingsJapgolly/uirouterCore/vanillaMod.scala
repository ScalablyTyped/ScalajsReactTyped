...
object vanillaMod extends js.Object {
  ...
  abstract class BaseLocationServices protected ()
    extends typingsJapgolly.uirouterCore.indexMod.BaseLocationServices {
    def this(router: UIRouter, fireAfterUpdate: Boolean) = this()
  }
  
  @js.native
  class BrowserLocationConfig ()
    extends typingsJapgolly.uirouterCore.indexMod.BrowserLocationConfig {
  ...
  class HashLocationService protected ()
    extends typingsJapgolly.uirouterCore.indexMod.HashLocationService {
  ...
  class MemoryLocationService protected ()
    extends typingsJapgolly.uirouterCore.indexMod.MemoryLocationService {
    def this(router: UIRouter) = this()
  }
  
  @js.native
  class PushStateLocationService protected ()
    extends typingsJapgolly.uirouterCore.indexMod.PushStateLocationService {
    def this(router: UIRouter) = this()
  }
