...
import typingsJapgolly.uirouterCore.anon.To
...
import typingsJapgolly.uirouterCore.libTransitionRejectFactoryMod.Rejection
import typingsJapgolly.uirouterCore.libViewInterfaceMod.ViewConfig
import typingsJapgolly.uirouterCore.uirouterCoreStrings.SameAsCurrent
import typingsJapgolly.uirouterCore.uirouterCoreStrings.SameAsPending
