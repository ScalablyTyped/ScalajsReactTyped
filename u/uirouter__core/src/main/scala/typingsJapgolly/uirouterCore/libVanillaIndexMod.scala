...
object libVanillaIndexMod {
  ...
  open class BaseLocationServices protected ()
    extends typingsJapgolly.uirouterCore.libVanillaBaseLocationServiceMod.BaseLocationServices {
  ...
  open class BrowserLocationConfig ()
    extends typingsJapgolly.uirouterCore.libVanillaBrowserLocationConfigMod.BrowserLocationConfig {
  ...
  open class HashLocationService protected ()
    extends typingsJapgolly.uirouterCore.libVanillaHashLocationServiceMod.HashLocationService {
  ...
  open class MemoryLocationConfig ()
    extends typingsJapgolly.uirouterCore.libVanillaMemoryLocationConfigMod.MemoryLocationConfig
  
  @JSImport("@uirouter/core/lib/vanilla/index", "MemoryLocationService")
  @js.native
  open class MemoryLocationService protected ()
    extends typingsJapgolly.uirouterCore.libVanillaMemoryLocationServiceMod.MemoryLocationService {
    def this(router: UIRouter) = this()
  }
  ...
  open class PushStateLocationService protected ()
    extends typingsJapgolly.uirouterCore.libVanillaPushStateLocationServiceMod.PushStateLocationService {
    def this(router: UIRouter) = this()
  }
