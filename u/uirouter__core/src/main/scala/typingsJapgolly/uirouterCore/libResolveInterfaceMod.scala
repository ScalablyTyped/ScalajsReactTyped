...
import typingsJapgolly.uirouterCore.libStateInterfaceMod.ResolveTypes
...
object libResolveInterfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.uirouterCore.libResolveInterfaceMod.CustomAsyncPolicy
  */
  type PolicyAsync = _PolicyAsync | CustomAsyncPolicy
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.uirouterCore.uirouterCoreStrings.LAZY
    - typingsJapgolly.uirouterCore.uirouterCoreStrings.EAGER
  */
  trait PolicyWhen extends StObject
  object PolicyWhen {
    
    inline def EAGER: typingsJapgolly.uirouterCore.uirouterCoreStrings.EAGER = "EAGER".asInstanceOf[typingsJapgolly.uirouterCore.uirouterCoreStrings.EAGER]
    
    inline def LAZY: typingsJapgolly.uirouterCore.uirouterCoreStrings.LAZY = "LAZY".asInstanceOf[typingsJapgolly.uirouterCore.uirouterCoreStrings.LAZY]
  }
