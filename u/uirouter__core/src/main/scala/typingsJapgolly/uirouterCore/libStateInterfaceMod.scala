...
import typingsJapgolly.uirouterCore.libParamsInterfaceMod.ParamDeclaration
...
object libStateInterfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.uirouterCore.libStateTargetStateMod.TargetState
    - typingsJapgolly.uirouterCore.anon.Params
    - scala.Unit
  */
  type RedirectToResult = _RedirectToResult | String | Unit
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.uirouterCore.libResolveResolvableMod.Resolvable
    - typingsJapgolly.uirouterCore.libResolveInterfaceMod.ResolvableLiteral
    - typingsJapgolly.uirouterCore.libResolveInterfaceMod.ProviderLike
  */
  ...
  object StateDeclaration {
    ...
    extension [Self <: StateDeclaration](x: Self) {
      ...
      inline def setDollarDollarstate(value: CallbackTo[StateObject]): Self = StObject.set(x, "$$state", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.uirouterCore.libStateInterfaceMod.StateDeclaration
    - typingsJapgolly.uirouterCore.libStateStateObjectMod.StateObject
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.uirouterCore.libStateInterfaceMod.StateDeclaration
    - typingsJapgolly.uirouterCore.anon.InstantiableStateDeclaration
  */
