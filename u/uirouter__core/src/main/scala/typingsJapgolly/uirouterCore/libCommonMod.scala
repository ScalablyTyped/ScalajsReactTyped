...
object libCommonMod {
  ...
  open class Glob protected ()
    extends typingsJapgolly.uirouterCore.libCommonGlobMod.Glob {
  ...
  @js.native
  open class Queue[T] ()
    extends typingsJapgolly.uirouterCore.libCommonQueueMod.Queue[T] {
  ...
  /** @internal */
  open class Trace_ ()
    extends typingsJapgolly.uirouterCore.libCommonTraceMod.Trace_
  ...
  @JSImport("@uirouter/core/lib/common", "trace")
  @js.native
  val trace: typingsJapgolly.uirouterCore.libCommonTraceMod.Trace_ = js.native
