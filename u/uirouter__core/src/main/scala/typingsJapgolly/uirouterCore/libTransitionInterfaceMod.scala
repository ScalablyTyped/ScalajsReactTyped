...
import typingsJapgolly.uirouterCore.libCommonCommonMod.PredicateBinary
...
import typingsJapgolly.uirouterCore.uirouterCoreStrings.otherwise
import typingsJapgolly.uirouterCore.uirouterCoreStrings.redirect
import typingsJapgolly.uirouterCore.uirouterCoreStrings.replace
import typingsJapgolly.uirouterCore.uirouterCoreStrings.sref
import typingsJapgolly.uirouterCore.uirouterCoreStrings.unknown
import typingsJapgolly.uirouterCore.uirouterCoreStrings.url
...
object libTransitionInterfaceMod {
  ...
  object TransitionHookOptions {
    ...
    extension [Self <: TransitionHookOptions](x: Self) {
      ...
      inline def setCurrent(value: CallbackTo[Transition]): Self = StObject.set(x, "current", value.toJsFn)
