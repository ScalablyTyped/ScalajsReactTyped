...
object pathMod extends js.Object {
  ...
  class PathNode protected ()
    extends typingsJapgolly.uirouterCore.pathNodeMod.PathNode {
  ...
  @js.native
  class PathUtils ()
    extends typingsJapgolly.uirouterCore.pathUtilsMod.PathUtils
  ...
  object PathUtils extends js.Object {
    ...
    def buildPath(targetState: TargetState): js.Array[typingsJapgolly.uirouterCore.pathNodeMod.PathNode] = js.native
    /** Given a fromPath: PathNode[] and a TargetState, builds a toPath: PathNode[] */
    def buildToPath(fromPath: js.Array[typingsJapgolly.uirouterCore.pathNodeMod.PathNode], targetState: TargetState): js.Array[typingsJapgolly.uirouterCore.pathNodeMod.PathNode] = js.native
    /**
    ...
    def makeTargetState(registry: StateRegistry, path: js.Array[typingsJapgolly.uirouterCore.pathNodeMod.PathNode]): TargetState = js.native
    /**
    ...
    def nonDynamicParams(node: typingsJapgolly.uirouterCore.pathNodeMod.PathNode): js.Array[Param] = js.native
