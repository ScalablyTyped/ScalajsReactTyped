...
object libPathMod {
  ...
  open class PathNode protected ()
    extends typingsJapgolly.uirouterCore.libPathPathNodeMod.PathNode {
  ...
  open class PathUtils ()
    extends typingsJapgolly.uirouterCore.libPathPathUtilsMod.PathUtils
  /* static members */
  object PathUtils {
    ...
    inline def buildPath(targetState: TargetState): js.Array[typingsJapgolly.uirouterCore.libPathPathNodeMod.PathNode] = ^.asInstanceOf[js.Dynamic].applyDynamic("buildPath")(targetState.asInstanceOf[js.Any]).asInstanceOf[js.Array[typingsJapgolly.uirouterCore.libPathPathNodeMod.PathNode]]
    ...
    inline def makeTargetState(registry: StateRegistry, path: js.Array[typingsJapgolly.uirouterCore.libPathPathNodeMod.PathNode]): TargetState = (^.asInstanceOf[js.Dynamic].applyDynamic("makeTargetState")(registry.asInstanceOf[js.Any], path.asInstanceOf[js.Any])).asInstanceOf[TargetState]
    ...
    inline def nonDynamicParams(node: typingsJapgolly.uirouterCore.libPathPathNodeMod.PathNode): js.Array[Param] = ^.asInstanceOf[js.Dynamic].applyDynamic("nonDynamicParams")(node.asInstanceOf[js.Any]).asInstanceOf[js.Array[Param]]
