...
import typingsJapgolly.uirouterCore.commonCommonMod.Obj
import typingsJapgolly.uirouterCore.libUrlMod.UrlConfig
import typingsJapgolly.uirouterCore.paramMod.DefType
...
object paramsMod extends js.Object {
  ...
  class Param protected ()
    extends typingsJapgolly.uirouterCore.paramMod.Param {
    def this(
      id: String,
  ...
  class ParamType protected ()
    extends typingsJapgolly.uirouterCore.paramTypeMod.ParamType {
    /**
  ...
  /** @internalapi */
  class ParamTypes ()
    extends typingsJapgolly.uirouterCore.paramTypesMod.ParamTypes
  
  @js.native
  class StateParams ()
    extends typingsJapgolly.uirouterCore.stateParamsMod.StateParams {
