...
object libViewInterfaceMod {
  ...
  object ActiveUIView {
    ...
    inline def apply(
      $type: String,
      config: ViewConfig,
      configUpdated: ViewConfig => Callback,
      creationContext: ViewContext,
      fqn: String,
      id: Double,
      name: String
    ): ActiveUIView = {
      val __obj = js.Dynamic.literal($type = $type.asInstanceOf[js.Any], config = config.asInstanceOf[js.Any], configUpdated = js.Any.fromFunction1((t0: ViewConfig) => configUpdated(t0).runNow()), creationContext = creationContext.asInstanceOf[js.Any], fqn = fqn.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any])
    ...
    extension [Self <: ActiveUIView](x: Self) {
      ...
      inline def setConfigUpdated(value: ViewConfig => Callback): Self = StObject.set(x, "configUpdated", js.Any.fromFunction1((t0: ViewConfig) => value(t0).runNow()))
  ...
  object ViewConfig {
    ...
    inline def apply(
      $id: Double,
      load: CallbackTo[js.Promise[ViewConfig]],
      loaded: Boolean,
      path: js.Array[PathNode],
      viewDecl: ViewDeclaration
    ): ViewConfig = {
      val __obj = js.Dynamic.literal($id = $id.asInstanceOf[js.Any], load = load.toJsFn, loaded = loaded.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any], viewDecl = viewDecl.asInstanceOf[js.Any])
    ...
    extension [Self <: ViewConfig](x: Self) {
      ...
      inline def setLoad(value: CallbackTo[js.Promise[ViewConfig]]): Self = StObject.set(x, "load", value.toJsFn)
