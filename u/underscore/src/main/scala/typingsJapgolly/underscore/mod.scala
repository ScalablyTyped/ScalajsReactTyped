...
import typingsJapgolly.underscore.anon.Fn0
import typingsJapgolly.underscore.anon.Fn1
import typingsJapgolly.underscore.anon.FnCall
import typingsJapgolly.underscore.anon.FnCallCollectionIterateeContext
import typingsJapgolly.underscore.anon.FnCallCollectionIterateeMemoContext
import typingsJapgolly.underscore.anon.FnCallIsSortedIterateeContext
import typingsJapgolly.underscore.anon.FnCallIsSortedIterateeCotext
import typingsJapgolly.underscore.anon.FnCallIterateeContext
import typingsJapgolly.underscore.anon.FnCallIterateeMemoContext
import typingsJapgolly.underscore.anon.FnCallListIsSortedIterateeContext
import typingsJapgolly.underscore.anon.FnCallListN
import typingsJapgolly.underscore.anon.FnCallN
import typingsJapgolly.underscore.underscoreBooleans.`false`
import typingsJapgolly.underscore.underscoreBooleans.`true`
import typingsJapgolly.underscore.underscoreInts.`1`
...
object mod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Unit
    - scala.Null
    - typingsJapgolly.underscore.underscoreBooleans.`false`
    - typingsJapgolly.underscore.underscoreStrings._empty
    - typingsJapgolly.underscore.underscoreInts.`0`
  */
  ...
  trait Chain[T, V] extends StObject {
    ...
    /**
      ...
      **/
    def difference(others: typingsJapgolly.underscore.mod.List[T]*): Chain[T, js.Array[T]] = js.native
    ...
    /**
      ...
      **/
    def intersection(lists: typingsJapgolly.underscore.mod.List[T]*): Chain[T, js.Array[T]] = js.native
    ...
    /**
      ...
      * keys and values.
      **/
    def `object`[TValue](values: typingsJapgolly.underscore.mod.List[TValue]): Chain[js.UndefOr[TValue], Dictionary[js.UndefOr[TValue]]] = js.native
    ...
    /**
      ...
      **/
    def union(lists: typingsJapgolly.underscore.mod.List[T]*): Chain[T, js.Array[T]] = js.native
    ...
    /**
      ...
      * list and `lists`.
      **/
    def zip(arrays: typingsJapgolly.underscore.mod.List[Any]*): Chain[js.Array[Any], js.Array[js.Array[Any]]] = js.native
  }
  
  type ChainSingle[V] = Chain[TypeOfCollection[V, scala.Nothing], V]
  
  type Collection[T] = typingsJapgolly.underscore.mod.List[T] | Dictionary[T]
  ...
  object List {
    ...
    inline def apply[T](length: Double): typingsJapgolly.underscore.mod.List[T] = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.underscore.mod.List[T]]
    }
    
    extension [Self <: typingsJapgolly.underscore.mod.List[?], T](x: Self & typingsJapgolly.underscore.mod.List[T]) {
  ...
  trait Underscore[T, V] extends StObject {
    ...
    /**
      ...
      * `others`.
      **/
    def difference(others: typingsJapgolly.underscore.mod.List[T]*): js.Array[T] = js.native
    ...
    /**
      ...
      * and `lists`.
      **/
    def intersection(lists: typingsJapgolly.underscore.mod.List[T]*): js.Array[T] = js.native
    ...
    /**
      ...
      * @see _.matcher
      **/
    def matcher(): ListIterator[T, Boolean, typingsJapgolly.underscore.mod.List[T]] = js.native
    
    /**
      * Wrapped type `any[]`.
      * @see _.matches
      **/
    def matches(): ListIterator[T, Boolean, typingsJapgolly.underscore.mod.List[T]] = js.native
    ...
    /**
      ...
      **/
    def `object`[TValue](values: typingsJapgolly.underscore.mod.List[TValue]): Dictionary[js.UndefOr[TValue]] = js.native
    ...
    /**
      ...
      **/
    def union(lists: typingsJapgolly.underscore.mod.List[T]*): js.Array[T] = js.native
    ...
    /**
      ...
      **/
    def zip(lists: typingsJapgolly.underscore.mod.List[Any]*): js.Array[js.Array[Any]] = js.native
  }
  ...
  trait UnderscoreStatic extends StObject {
    ...
    /**
      ...
      * in size.
      **/
    def chunk[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, length: Double): js.Array[js.Array[TypeOfList[V]]] = js.native
    ...
    /**
      ...
      * values.
      **/
    def compact[V /* <: js.UndefOr[typingsJapgolly.underscore.mod.List[Any] | Null] */](list: V): js.Array[Truthy[TypeOfList[V]]] = js.native
    ...
    /**
      ...
      **/
    def difference[T](list: typingsJapgolly.underscore.mod.List[T], others: typingsJapgolly.underscore.mod.List[T]*): js.Array[T] = js.native
    
    /**
      * @see rest
      **/
    def drop[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.Array[TypeOfList[V]] = js.native
    def drop[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, index: Double): js.Array[TypeOfList[V]] = js.native
    /**
      * @see rest
      **/
    @JSName("drop")
    var drop_Original: js.Function2[
        /* list */ typingsJapgolly.underscore.mod.List[Any], 
        /* index */ js.UndefOr[Double], 
        js.Array[TypeOfList[typingsJapgolly.underscore.mod.List[Any]]]
      ] = js.native
    ...
    /**
      ...
      * truth test passes or -1 if no elements pass.
      **/
    def findIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): Double = js.native
    def findIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Unit, context: Any): Double = js.native
    def findIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Iteratee[V, Boolean, TypeOfCollection[V, scala.Nothing]]): Double = js.native
    def findIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Iteratee[V, Boolean, TypeOfCollection[V, scala.Nothing]], context: Any): Double = js.native
    ...
    /**
      ...
      * truth test passes or -1 if no elements pass.
      **/
    def findLastIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): Double = js.native
    def findLastIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Unit, context: Any): Double = js.native
    def findLastIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Iteratee[V, Boolean, TypeOfCollection[V, scala.Nothing]]): Double = js.native
    def findLastIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Iteratee[V, Boolean, TypeOfCollection[V, scala.Nothing]], context: Any): Double = js.native
    ...
    /**
      ...
      * `n` is omitted.
      **/
    def first[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.UndefOr[TypeOfList[V]] = js.native
    def first[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, n: Double): js.Array[TypeOfList[V]] = js.native
    
    def flatten[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.Array[DeepestListItemOrSelf[TypeOfList[V]]] = js.native
    /**
      * Flattens a nested `list` (the nesting can be to any depth). If you
      ...
      * @returns The flattened `list`.
      **/
    def flatten[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, depth: `1` | `true`): js.Array[ListItemOrSelf[TypeOfList[V]]] = js.native
    def flatten[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, depth: Double): js.Array[DeepestListItemOrSelf[TypeOfList[V]]] = js.native
    @JSName("flatten")
    def flatten_false[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, depth: `false`): js.Array[DeepestListItemOrSelf[TypeOfList[V]]] = js.native
    ...
    /**
      * @see first
      **/
    def head[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.UndefOr[TypeOfList[V]] = js.native
    /**
      * @see first
      **/
    def head[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, n: Double): js.Array[TypeOfList[V]] = js.native
    /**
      * @see first
      **/
    @JSName("head")
    ...
    /**
      ...
      **/
    def indexOf[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, value: TypeOfList[V]): Double = js.native
    def indexOf[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, value: TypeOfList[V], isSortedOrFromIndex: Boolean): Double = js.native
    def indexOf[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, value: TypeOfList[V], isSortedOrFromIndex: Double): Double = js.native
    ...
    /**
      ...
      **/
    def initial[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.Array[TypeOfList[V]] = js.native
    def initial[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, n: Double): js.Array[TypeOfList[V]] = js.native
    ...
    /**
      ...
      **/
    def intersection[T](lists: typingsJapgolly.underscore.mod.List[T]*): js.Array[T] = js.native
    ...
    /**
      ...
      * is omitted.
      **/
    def last[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.UndefOr[TypeOfList[V]] = js.native
    def last[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, n: Double): js.Array[TypeOfList[V]] = js.native
    ...
    /**
      ...
      * or -1 if `value` is not found.
      **/
    def lastIndexOf[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, value: TypeOfList[V]): Double = js.native
    def lastIndexOf[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, value: TypeOfList[V], fromIndex: Double): Double = js.native
    ...
    def `object`[TList /* <: typingsJapgolly.underscore.mod.List[typingsJapgolly.underscore.mod.List[Any]] */](list: TList): Dictionary[PairValue[TypeOfList[TList]]] = js.native
    /**
      ...
      * @returns An object comprised of the provided keys and values.
      **/
    def `object`[TList /* <: typingsJapgolly.underscore.mod.List[String | Double] */, TValue](list: TList, values: typingsJapgolly.underscore.mod.List[TValue]): Dictionary[js.UndefOr[TValue]] = js.native
    ...
    /**
      ...
      **/
    def rest[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.Array[TypeOfList[V]] = js.native
    def rest[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, index: Double): js.Array[TypeOfList[V]] = js.native
    ...
    /**
      ...
      **/
    def sortedIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, value: TypeOfList[V]): Double = js.native
    def sortedIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, value: TypeOfList[V], iteratee: Unit, context: Any): Double = js.native
    def sortedIndex[V /* <: typingsJapgolly.underscore.mod.List[Any] */](
      list: V,
      value: TypeOfList[V],
      iteratee: Iteratee[js.UndefOr[V], Any, TypeOfCollection[js.UndefOr[V], scala.Nothing]]
    ): Double = js.native
    ...
    /**
      * @see rest
      **/
    def tail[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.Array[TypeOfList[V]] = js.native
    def tail[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, index: Double): js.Array[TypeOfList[V]] = js.native
    /**
      * @see rest
      **/
    @JSName("tail")
    ...
    /**
      * @see first
      **/
    def take[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.UndefOr[TypeOfList[V]] = js.native
    /**
      * @see first
      **/
    def take[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, n: Double): js.Array[TypeOfList[V]] = js.native
    /**
      * @see first
      **/
    @JSName("take")
    ...
    def transpose(lists: typingsJapgolly.underscore.mod.List[typingsJapgolly.underscore.mod.List[Any]]): js.Array[js.Array[Any]] = js.native
    ...
    /**
      ...
      **/
    def union[T](lists: typingsJapgolly.underscore.mod.List[T]*): js.Array[T] = js.native
    ...
    /**
      ...
      **/
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.Array[TypeOfList[V]] = js.native
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Boolean): js.Array[TypeOfList[V]] = js.native
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Boolean, iteratee: Unit, context: Any): js.Array[TypeOfList[V]] = js.native
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Boolean, iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]]): js.Array[TypeOfList[V]] = js.native
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](
      list: V,
      isSorted: Boolean,
      iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]],
      context: Any
    ): js.Array[TypeOfList[V]] = js.native
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Unit, iteratee: Any | (Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]])): js.Array[TypeOfList[V]] = js.native
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Unit, iteratee: Unit, context: Any): js.Array[TypeOfList[V]] = js.native
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](
      list: V,
      isSorted: Unit,
      iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]],
    ...
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]]): js.Array[TypeOfList[V]] = js.native
    def uniq[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]], context: Any): js.Array[TypeOfList[V]] = js.native
    
    /**
      * @see uniq
      **/
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V): js.Array[TypeOfList[V]] = js.native
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Boolean): js.Array[TypeOfList[V]] = js.native
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Boolean, iteratee: Unit, context: Any): js.Array[TypeOfList[V]] = js.native
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Boolean, iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]]): js.Array[TypeOfList[V]] = js.native
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](
      list: V,
      isSorted: Boolean,
      iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]],
      context: Any
    ): js.Array[TypeOfList[V]] = js.native
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Unit, iteratee: Any | (Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]])): js.Array[TypeOfList[V]] = js.native
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, isSorted: Unit, iteratee: Unit, context: Any): js.Array[TypeOfList[V]] = js.native
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](
      list: V,
      isSorted: Unit,
      iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]],
    ...
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]]): js.Array[TypeOfList[V]] = js.native
    def unique[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, iteratee: Iteratee[V, Any, TypeOfCollection[V, scala.Nothing]], context: Any): js.Array[TypeOfList[V]] = js.native
    ...
    /**
      ...
      **/
    def unzip(lists: typingsJapgolly.underscore.mod.List[typingsJapgolly.underscore.mod.List[Any]]): js.Array[js.Array[Any]] = js.native
    ...
    /**
      ...
      * `values`.
      **/
    def without[V /* <: typingsJapgolly.underscore.mod.List[Any] */](list: V, values: TypeOfList[V]*): js.Array[TypeOfList[V]] = js.native
