...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.unlCore.unlCoreStrings.N
    - typingsJapgolly.unlCore.unlCoreStrings.S
    - typingsJapgolly.unlCore.unlCoreStrings.E
    - typingsJapgolly.unlCore.unlCoreStrings.W
  */
  trait Direction extends StObject
  object Direction {
    
    inline def E: typingsJapgolly.unlCore.unlCoreStrings.E = "E".asInstanceOf[typingsJapgolly.unlCore.unlCoreStrings.E]
    
    inline def N: typingsJapgolly.unlCore.unlCoreStrings.N = "N".asInstanceOf[typingsJapgolly.unlCore.unlCoreStrings.N]
    
    inline def S: typingsJapgolly.unlCore.unlCoreStrings.S = "S".asInstanceOf[typingsJapgolly.unlCore.unlCoreStrings.S]
    
    inline def W: typingsJapgolly.unlCore.unlCoreStrings.W = "W".asInstanceOf[typingsJapgolly.unlCore.unlCoreStrings.W]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.unlCore.unlCoreStrings.floor
    - typingsJapgolly.unlCore.unlCoreStrings.heightincm
  */
  trait ElevationType extends StObject
  object ElevationType {
    
    inline def floor: typingsJapgolly.unlCore.unlCoreStrings.floor = "floor".asInstanceOf[typingsJapgolly.unlCore.unlCoreStrings.floor]
    
    inline def heightincm: typingsJapgolly.unlCore.unlCoreStrings.heightincm = "heightincm".asInstanceOf[typingsJapgolly.unlCore.unlCoreStrings.heightincm]
  }
