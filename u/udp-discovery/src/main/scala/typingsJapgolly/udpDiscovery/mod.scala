...
object mod {
  ...
  object DiscoveryEvents {
    ...
    inline def apply(
      available: (String, Any, ReasonType) => Callback,
      unavailable: (String, Any, ReasonType) => Callback
    ): DiscoveryEvents = {
      val __obj = js.Dynamic.literal(available = js.Any.fromFunction3((t0: String, t1: Any, t2: ReasonType) => (available(t0, t1, t2)).runNow()), unavailable = js.Any.fromFunction3((t0: String, t1: Any, t2: ReasonType) => (unavailable(t0, t1, t2)).runNow()))
      __obj.asInstanceOf[DiscoveryEvents]
    }
    
    extension [Self <: DiscoveryEvents](x: Self) {
      
      inline def setAvailable(value: (String, Any, ReasonType) => Callback): Self = StObject.set(x, "available", js.Any.fromFunction3((t0: String, t1: Any, t2: ReasonType) => (value(t0, t1, t2)).runNow()))
      
      inline def setMessageBus(value: (/* eventName */ String, /* data */ Any) => Callback): Self = StObject.set(x, "MessageBus", js.Any.fromFunction2((t0: /* eventName */ String, t1: /* data */ Any) => (value(t0, t1)).runNow()))
      
      inline def setMessageBusUndefined: Self = StObject.set(x, "MessageBus", js.undefined)
      
      inline def setUnavailable(value: (String, Any, ReasonType) => Callback): Self = StObject.set(x, "unavailable", js.Any.fromFunction3((t0: String, t1: Any, t2: ReasonType) => (value(t0, t1, t2)).runNow()))
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.udpDiscovery.udpDiscoveryStrings.`new`
    - typingsJapgolly.udpDiscovery.udpDiscoveryStrings.availabilityChange
    - typingsJapgolly.udpDiscovery.udpDiscoveryStrings.timedOut
  */
  trait ReasonType extends StObject
  object ReasonType {
    
    inline def availabilityChange: typingsJapgolly.udpDiscovery.udpDiscoveryStrings.availabilityChange = "availabilityChange".asInstanceOf[typingsJapgolly.udpDiscovery.udpDiscoveryStrings.availabilityChange]
    
    inline def `new`: typingsJapgolly.udpDiscovery.udpDiscoveryStrings.`new` = "new".asInstanceOf[typingsJapgolly.udpDiscovery.udpDiscoveryStrings.`new`]
    
    inline def timedOut: typingsJapgolly.udpDiscovery.udpDiscoveryStrings.timedOut = "timedOut".asInstanceOf[typingsJapgolly.udpDiscovery.udpDiscoveryStrings.timedOut]
  }
}
