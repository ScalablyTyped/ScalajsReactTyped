...
object IContentEditingHelper {
  ...
  inline def apply(
    ...
    handleSaveError: /* repeated */ Any => Callback,
    handleSuccessfulSave: /* repeated */ Any => Callback,
    reBindChangedProperties: (Any, Any) => Callback,
    redirectToCreatedContent: (Double, Any) => Callback
  ): IContentEditingHelper = {
    val __obj = js.Dynamic.literal(getAllProps = js.Any.fromFunction1(getAllProps), getAllowedActions = js.Any.fromFunction2(getAllowedActions), getButtonFromAction = js.Any.fromFunction1(getButtonFromAction), handleSaveError = js.Any.fromFunction1((t0: /* repeated */ Any) => handleSaveError(t0).runNow()), handleSuccessfulSave = js.Any.fromFunction1((t0: /* repeated */ Any) => handleSuccessfulSave(t0).runNow()), reBindChangedProperties = js.Any.fromFunction2((t0: Any, t1: Any) => (reBindChangedProperties(t0, t1)).runNow()), redirectToCreatedContent = js.Any.fromFunction2((t0: Double, t1: Any) => (redirectToCreatedContent(t0, t1)).runNow()))
  ...
  extension [Self <: IContentEditingHelper](x: Self) {
    ...
    inline def setHandleSaveError(value: /* repeated */ Any => Callback): Self = StObject.set(x, "handleSaveError", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
    
    inline def setHandleSuccessfulSave(value: /* repeated */ Any => Callback): Self = StObject.set(x, "handleSuccessfulSave", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
    
    inline def setReBindChangedProperties(value: (Any, Any) => Callback): Self = StObject.set(x, "reBindChangedProperties", js.Any.fromFunction2((t0: Any, t1: Any) => (value(t0, t1)).runNow()))
    
    inline def setRedirectToCreatedContent(value: (Double, Any) => Callback): Self = StObject.set(x, "redirectToCreatedContent", js.Any.fromFunction2((t0: Double, t1: Any) => (value(t0, t1)).runNow()))
  }
}
