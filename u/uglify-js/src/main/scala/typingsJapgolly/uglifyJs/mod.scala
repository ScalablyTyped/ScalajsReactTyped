...
import typingsJapgolly.uglifyJs.uglifyJsBooleans.`false`
import typingsJapgolly.uglifyJs.uglifyJsStrings.`inline`
import typingsJapgolly.uglifyJs.uglifyJsStrings.all
import typingsJapgolly.uglifyJs.uglifyJsStrings.some
import typingsJapgolly.uglifyJs.uglifyJsStrings.strict
