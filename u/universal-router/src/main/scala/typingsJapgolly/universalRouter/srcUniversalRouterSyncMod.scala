...
import typingsJapgolly.pathToRegexp.mod.Match_
import typingsJapgolly.pathToRegexp.mod.ParseOptions
import typingsJapgolly.pathToRegexp.mod.Path
import typingsJapgolly.pathToRegexp.mod.RegexpToFunctionOptions
import typingsJapgolly.std.Error
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcUniversalRouterSyncMod {
  ...
  object Route {
    ...
    extension [Self <: Route[?, ?], R, C /* <: RouterContext */](x: Self & (Route[R, C])) {
      ...
      inline def setAction(value: (/* context */ RouteContext[R, C], /* params */ RouteParams) => RouteResultSync[R]): Self = StObject.set(x, "action", js.Any.fromFunction2(value))
  ...
  - typingsJapgolly.pathToRegexp.mod.TokensToRegexpOptions because var conflicts: delimiter. Inlined sensitive, start, encode, endsWith, end, strict */ trait RouterOptions[R, C /* <: RouterContext */]
    extends StObject
       with ParseOptions
  ...
  object RouterOptions {
    ...
    extension [Self <: RouterOptions[?, ?], R, C /* <: RouterContext */](x: Self & (RouterOptions[R, C])) {
      ...
      inline def setErrorHandler(value: (/* error */ RouteError, /* context */ ResolveContext) => RouteResultSync[R]): Self = StObject.set(x, "errorHandler", js.Any.fromFunction2(value))
      
      inline def setErrorHandlerUndefined: Self = StObject.set(x, "errorHandler", js.undefined)
      
      inline def setResolveRoute(value: (/* context */ RouteContext[R, C], /* params */ RouteParams) => RouteResultSync[R]): Self = StObject.set(x, "resolveRoute", js.Any.fromFunction2(value))
