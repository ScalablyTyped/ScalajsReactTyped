package typingsJapgolly.universalRouter.universalRouterSyncMod
...
object Route {
  ...
  def apply[C /* <: Context */, R](
    ...
    if (action != null) __obj.updateDynamic("action")(js.Any.fromFunction2((t0: /* context */ (typingsJapgolly.universalRouter.universalRouterSyncMod.RouteContext[C, R]) with C, t1: /* params */ typingsJapgolly.universalRouter.universalRouterSyncMod.QueryParams) => action(t0, t1).runNow()))
