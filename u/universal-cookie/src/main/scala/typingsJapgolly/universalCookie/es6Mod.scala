...
import typingsJapgolly.universalCookie.es6TypesMod.CookieParseOptions
...
object es6Mod {
  ...
  @JSImport("universal-cookie/es6", JSImport.Default)
  @js.native
  open class default ()
    extends typingsJapgolly.universalCookie.es6CookiesMod.default {
