...
object GetSystemInfoOptions {
  ...
  extension [Self <: GetSystemInfoOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetSystemInfoResult => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetSystemInfoResult) => value(t0).runNow()))
