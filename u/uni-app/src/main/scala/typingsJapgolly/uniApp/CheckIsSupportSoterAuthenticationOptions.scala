...
object CheckIsSupportSoterAuthenticationOptions {
  ...
  extension [Self <: CheckIsSupportSoterAuthenticationOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ CheckIsSupportSoterAuthenticationRes => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ CheckIsSupportSoterAuthenticationRes) => value(t0).runNow()))
