...
object GetBLEDeviceCharacteristicsOptions {
  ...
  extension [Self <: GetBLEDeviceCharacteristicsOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetBLEDeviceCharacteristicsSuccess => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetBLEDeviceCharacteristicsSuccess) => value(t0).runNow()))
