...
object GetLocationOptions {
  ...
  extension [Self <: GetLocationOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetLocationSuccess => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetLocationSuccess) => value(t0).runNow()))
