...
import typingsJapgolly.uniApp.App.AppInstance
...
import typingsJapgolly.uniApp.Page.PageInstanceBaseProps
...
object vueTypesOptionsMod {
  ...
  - typingsJapgolly.uniApp.Page.PageInstance because var conflicts: onHide, onShow. Inlined onLoad, onReady, onUnload, onPullDownRefresh, onReachBottom, onShareAppMessage, onPageScroll, onResize, onTabItemTap, onNavigationBarButtonTap, onBackPress, onNavigationBarSearchInputChanged, onNavigationBarSearchInputConfirmed, onNavigationBarSearchInputClicked */ trait Hooks
    extends StObject
  ...
  object Hooks {
    ...
    extension [Self <: Hooks](x: Self) {
      ...
      inline def setOnLoad(value: /* query */ js.UndefOr[AnyObject] => Callback): Self = StObject.set(x, "onLoad", js.Any.fromFunction1((t0: /* query */ js.UndefOr[AnyObject]) => value(t0).runNow()))
      
      inline def setOnLoadUndefined: Self = StObject.set(x, "onLoad", js.undefined)
      
      inline def setOnNavigationBarButtonTap(value: /* options */ NavigationBarButtonTapOption => Callback): Self = StObject.set(x, "onNavigationBarButtonTap", js.Any.fromFunction1((t0: /* options */ NavigationBarButtonTapOption) => value(t0).runNow()))
      
      inline def setOnNavigationBarButtonTapUndefined: Self = StObject.set(x, "onNavigationBarButtonTap", js.undefined)
      
      inline def setOnNavigationBarSearchInputChanged(value: /* event */ NavigationBarSearchInputEvent => Callback): Self = StObject.set(x, "onNavigationBarSearchInputChanged", js.Any.fromFunction1((t0: /* event */ NavigationBarSearchInputEvent) => value(t0).runNow()))
      ...
      inline def setOnNavigationBarSearchInputClicked(value: Callback): Self = StObject.set(x, "onNavigationBarSearchInputClicked", value.toJsFn)
      ...
      inline def setOnNavigationBarSearchInputConfirmed(value: /* event */ NavigationBarSearchInputEvent => Callback): Self = StObject.set(x, "onNavigationBarSearchInputConfirmed", js.Any.fromFunction1((t0: /* event */ NavigationBarSearchInputEvent) => value(t0).runNow()))
      ...
      inline def setOnPageScroll(value: /* options */ PageScrollOption => Callback): Self = StObject.set(x, "onPageScroll", js.Any.fromFunction1((t0: /* options */ PageScrollOption) => value(t0).runNow()))
      ...
      inline def setOnResize(value: /* options */ PageScrollOption => Callback): Self = StObject.set(x, "onResize", js.Any.fromFunction1((t0: /* options */ PageScrollOption) => value(t0).runNow()))
      ...
      inline def setOnTabItemTap(value: /* options */ TabItemTapOption => Callback): Self = StObject.set(x, "onTabItemTap", js.Any.fromFunction1((t0: /* options */ TabItemTapOption) => value(t0).runNow()))
