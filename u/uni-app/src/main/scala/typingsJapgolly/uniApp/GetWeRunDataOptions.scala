...
object GetWeRunDataOptions {
  ...
  def apply(
    ...
    success: /* result */ GetWeRunDataRes => Callback = null,
    timeout: Int | Double = null
  ): GetWeRunDataOptions = {
    val __obj = js.Dynamic.literal()
    complete.foreach(p => __obj.updateDynamic("complete")(p.toJsFn))
    fail.foreach(p => __obj.updateDynamic("fail")(p.toJsFn))
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.uniApp.GetWeRunDataRes) => success(t0).runNow()))
