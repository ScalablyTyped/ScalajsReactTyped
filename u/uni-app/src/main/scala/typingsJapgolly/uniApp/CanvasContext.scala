...
import typingsJapgolly.uniApp.uniAppStrings.`no-repeat`
import typingsJapgolly.uniApp.uniAppStrings.`repeat-x`
import typingsJapgolly.uniApp.uniAppStrings.`repeat-y`
import typingsJapgolly.uniApp.uniAppStrings.bevel
import typingsJapgolly.uniApp.uniAppStrings.bottom
import typingsJapgolly.uniApp.uniAppStrings.butt
import typingsJapgolly.uniApp.uniAppStrings.center
import typingsJapgolly.uniApp.uniAppStrings.left
import typingsJapgolly.uniApp.uniAppStrings.middle
import typingsJapgolly.uniApp.uniAppStrings.miter
import typingsJapgolly.uniApp.uniAppStrings.normal
import typingsJapgolly.uniApp.uniAppStrings.repeat
import typingsJapgolly.uniApp.uniAppStrings.right
import typingsJapgolly.uniApp.uniAppStrings.round
import typingsJapgolly.uniApp.uniAppStrings.square
import typingsJapgolly.uniApp.uniAppStrings.top
