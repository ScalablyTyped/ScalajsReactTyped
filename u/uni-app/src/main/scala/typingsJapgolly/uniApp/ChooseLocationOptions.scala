...
object ChooseLocationOptions {
  ...
  extension [Self <: ChooseLocationOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ ChooseLocationSuccess => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ ChooseLocationSuccess) => value(t0).runNow()))
