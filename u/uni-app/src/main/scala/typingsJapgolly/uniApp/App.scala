...
object App {
  ...
  type AppConstructor = js.Function1[
    /* options */ (AppInstance[AnyObject & AppInstance[js.Object]]) & AnyObject & AppInstance[js.Object], 
    Unit
  ]
  ...
  object AppInstance {
    ...
    extension [Self <: AppInstance[?], T /* <: AnyObject */](x: Self & AppInstance[T]) {
      ...
      inline def setOnLaunch(value: /* options */ js.UndefOr[LaunchShowOption] => Callback): Self = StObject.set(x, "onLaunch", js.Any.fromFunction1((t0: /* options */ js.UndefOr[LaunchShowOption]) => value(t0).runNow()))
      ...
      inline def setOnShow(value: /* options */ js.UndefOr[LaunchShowOption] => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* options */ js.UndefOr[LaunchShowOption]) => value(t0).runNow()))
      
      inline def setOnShowUndefined: Self = StObject.set(x, "onShow", js.undefined)
      
      inline def setOnUniNViewMessage(value: /* options */ AnyObject => Callback): Self = StObject.set(x, "onUniNViewMessage", js.Any.fromFunction1((t0: /* options */ AnyObject) => value(t0).runNow()))
      
      inline def setOnUniNViewMessageUndefined: Self = StObject.set(x, "onUniNViewMessage", js.undefined)
    }
  }
  
  type GetApp = js.Function1[/* opts */ js.UndefOr[GetAppOption], AppInstance[AnyObject] & AnyObject]
