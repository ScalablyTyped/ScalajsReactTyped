...
object CanvasToTempFilePathOptions {
  ...
  def apply(
    ...
    success: /* result */ CanvasToTempFilePathRes => Callback = null,
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.uniApp.CanvasToTempFilePathRes) => success(t0).runNow()))
