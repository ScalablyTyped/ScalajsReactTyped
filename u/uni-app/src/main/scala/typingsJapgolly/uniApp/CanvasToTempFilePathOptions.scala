...
object CanvasToTempFilePathOptions {
  ...
  extension [Self <: CanvasToTempFilePathOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ CanvasToTempFilePathRes => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ CanvasToTempFilePathRes) => value(t0).runNow()))
