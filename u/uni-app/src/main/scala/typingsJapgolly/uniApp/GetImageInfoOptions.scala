...
object GetImageInfoOptions {
  ...
  def apply(
    ...
    src: String = null,
    success: /* result */ GetImageInfoSuccessData => Callback = null
  ): GetImageInfoOptions = {
    val __obj = js.Dynamic.literal()
    complete.foreach(p => __obj.updateDynamic("complete")(p.toJsFn))
    fail.foreach(p => __obj.updateDynamic("fail")(p.toJsFn))
    if (src != null) __obj.updateDynamic("src")(src.asInstanceOf[js.Any])
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.uniApp.GetImageInfoSuccessData) => success(t0).runNow()))
