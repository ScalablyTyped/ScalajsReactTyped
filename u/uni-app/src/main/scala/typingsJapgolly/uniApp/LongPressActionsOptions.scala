...
object LongPressActionsOptions {
  ...
  extension [Self <: LongPressActionsOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ LongPressActionsSuccessData => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ LongPressActionsSuccessData) => value(t0).runNow()))
