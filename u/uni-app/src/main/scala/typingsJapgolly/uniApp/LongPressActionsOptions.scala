...
object LongPressActionsOptions {
  ...
  def apply(
    ...
    success: /* result */ LongPressActionsSuccessData => Callback = null
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.uniApp.LongPressActionsSuccessData) => success(t0).runNow()))
