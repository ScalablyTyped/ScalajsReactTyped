...
object CameraContextStartRecordOptions {
  ...
  extension [Self <: CameraContextStartRecordOptions](x: Self) {
    ...
    inline def setTimeoutCallback(value: /* result */ CameraContextStopRecordResult => Callback): Self = StObject.set(x, "timeoutCallback", js.Any.fromFunction1((t0: /* result */ CameraContextStopRecordResult) => value(t0).runNow()))
