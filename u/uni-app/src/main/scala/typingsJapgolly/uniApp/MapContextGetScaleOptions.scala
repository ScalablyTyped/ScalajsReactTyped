...
object MapContextGetScaleOptions {
  ...
  def apply(
    ...
    success: /* result */ MapContextGetScaleResult => Callback = null
  ): MapContextGetScaleOptions = {
    val __obj = js.Dynamic.literal()
    complete.foreach(p => __obj.updateDynamic("complete")(p.toJsFn))
    fail.foreach(p => __obj.updateDynamic("fail")(p.toJsFn))
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.uniApp.MapContextGetScaleResult) => success(t0).runNow()))
