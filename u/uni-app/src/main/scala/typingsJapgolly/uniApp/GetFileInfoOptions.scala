...
object GetFileInfoOptions {
  ...
  def apply(
    ...
    success: /* result */ GetFileInfoSuccess => Callback = null
  ): GetFileInfoOptions = {
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.uniApp.GetFileInfoSuccess) => success(t0).runNow()))
