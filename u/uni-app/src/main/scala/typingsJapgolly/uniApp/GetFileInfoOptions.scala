...
object GetFileInfoOptions {
  ...
  extension [Self <: GetFileInfoOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetFileInfoSuccess => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetFileInfoSuccess) => value(t0).runNow()))
