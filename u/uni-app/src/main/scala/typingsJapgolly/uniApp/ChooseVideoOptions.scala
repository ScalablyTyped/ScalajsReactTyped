...
trait ChooseVideoOptions extends StObject {
  ...
  /**
    ...
    */
  var sourceType: js.UndefOr[String | js.Array[Any]] = js.undefined
...
object ChooseVideoOptions {
  ...
  extension [Self <: ChooseVideoOptions](x: Self) {
    ...
    inline def setSourceType(value: String | js.Array[Any]): Self = StObject.set(x, "sourceType", value.asInstanceOf[js.Any])
    
    inline def setSourceTypeUndefined: Self = StObject.set(x, "sourceType", js.undefined)
    
    inline def setSourceTypeVarargs(value: Any*): Self = StObject.set(x, "sourceType", js.Array(value*))
    
    inline def setSuccess(value: /* result */ ChooseVideoSuccess => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ ChooseVideoSuccess) => value(t0).runNow()))
