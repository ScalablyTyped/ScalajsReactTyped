...
object DownloadFileOption {
  ...
  extension [Self <: DownloadFileOption](x: Self) {
    ...
    inline def setSuccess(value: /* result */ DownloadSuccessData => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ DownloadSuccessData) => value(t0).runNow()))
