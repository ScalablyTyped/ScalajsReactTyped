...
object MapContextGetCenterLocationOptions {
  ...
  def apply(
    ...
    success: /* result */ LocationObject => Callback = null
  ): MapContextGetCenterLocationOptions = {
    val __obj = js.Dynamic.literal()
    complete.foreach(p => __obj.updateDynamic("complete")(p.toJsFn))
    fail.foreach(p => __obj.updateDynamic("fail")(p.toJsFn))
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.uniApp.LocationObject) => success(t0).runNow()))
