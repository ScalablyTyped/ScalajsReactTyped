...
object MapContextGetCenterLocationOptions {
  ...
  inline def apply(): MapContextGetCenterLocationOptions = {
  ...
  extension [Self <: MapContextGetCenterLocationOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ LocationObject => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ LocationObject) => value(t0).runNow()))
