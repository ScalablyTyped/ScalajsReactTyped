...
object GetShareInfoOptions {
  ...
  extension [Self <: GetShareInfoOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetShareInfoRes => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetShareInfoRes) => value(t0).runNow()))
