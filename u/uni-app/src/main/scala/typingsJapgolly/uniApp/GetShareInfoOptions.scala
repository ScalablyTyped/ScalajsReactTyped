...
object GetShareInfoOptions {
  ...
  def apply(
    ...
    success: /* result */ GetShareInfoRes => Callback = null,
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* result */ typingsJapgolly.uniApp.GetShareInfoRes) => success(t0).runNow()))
