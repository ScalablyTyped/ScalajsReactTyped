...
object GetBLEDeviceServicesOptions {
  ...
  extension [Self <: GetBLEDeviceServicesOptions](x: Self) {
    ...
    inline def setSuccess(value: /* result */ GetBLEDeviceServicesSuccess => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* result */ GetBLEDeviceServicesSuccess) => value(t0).runNow()))
