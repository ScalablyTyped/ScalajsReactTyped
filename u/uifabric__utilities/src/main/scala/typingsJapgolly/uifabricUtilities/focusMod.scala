...
import typingsJapgolly.uifabricUtilities.uifabricUtilitiesStrings.`data-no-horizontal-wrap`
import typingsJapgolly.uifabricUtilities.uifabricUtilitiesStrings.`data-no-vertical-wrap`
...
object focusMod extends js.Object {
  ...
  def focusAsync(element: typingsJapgolly.std.HTMLElement): Unit = js.native
  ...
  def getNextElement(
    rootElement: HTMLElement,
    currentElement: typingsJapgolly.std.HTMLElement,
    checkNode: js.UndefOr[Boolean],
    suppressParentTraversal: js.UndefOr[Boolean],
    suppressChildTraversal: js.UndefOr[Boolean],
    includeElementsInFocusZones: js.UndefOr[Boolean],
