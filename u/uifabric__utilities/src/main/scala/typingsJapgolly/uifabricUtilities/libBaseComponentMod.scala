...
import typingsJapgolly.uifabricUtilities.libAsyncMod.Async
import typingsJapgolly.uifabricUtilities.libBaseComponentDottypesMod.IBaseProps
import typingsJapgolly.uifabricUtilities.libEventGroupMod.EventGroup
import typingsJapgolly.uifabricUtilities.libIdisposableMod.IDisposable
...
object libBaseComponentMod {
  ...
  open class BaseComponent[TProps /* <: IBaseProps[Any] */, TState] protected () extends Component[TProps, TState, Any] {
    ...
    /**
      ...
      */
    /* protected */ def _resolveRef(refName: String): js.Function1[/* ref */ Node, Node] = js.native
