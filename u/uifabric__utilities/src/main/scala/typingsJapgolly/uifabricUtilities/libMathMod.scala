...
object libMathMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.uifabricUtilities.uifabricUtilitiesStrings.contain
    - typingsJapgolly.uifabricUtilities.uifabricUtilitiesStrings.cover
  */
  trait FitMode extends StObject
  object FitMode {
    
    inline def contain: typingsJapgolly.uifabricUtilities.uifabricUtilitiesStrings.contain = "contain".asInstanceOf[typingsJapgolly.uifabricUtilities.uifabricUtilitiesStrings.contain]
    
    inline def cover: typingsJapgolly.uifabricUtilities.uifabricUtilitiesStrings.cover = "cover".asInstanceOf[typingsJapgolly.uifabricUtilities.uifabricUtilitiesStrings.cover]
  }
