...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.uint8arrayTools.uint8arrayToolsInts.`-1`
    - typingsJapgolly.uint8arrayTools.uint8arrayToolsInts.`0`
    - typingsJapgolly.uint8arrayTools.uint8arrayToolsInts.`1`
  */
  trait CompareResult extends StObject
  object CompareResult {
    
    inline def `-1`: typingsJapgolly.uint8arrayTools.uint8arrayToolsInts.`-1` = -1.asInstanceOf[typingsJapgolly.uint8arrayTools.uint8arrayToolsInts.`-1`]
    
    inline def `0`: typingsJapgolly.uint8arrayTools.uint8arrayToolsInts.`0` = 0.asInstanceOf[typingsJapgolly.uint8arrayTools.uint8arrayToolsInts.`0`]
