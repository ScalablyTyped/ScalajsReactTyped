...
import typingsJapgolly.usb.distUsbBindingsMod.LibUSBException
import typingsJapgolly.usb.distUsbCapabilityMod.Capability
...
import typingsJapgolly.usb.distUsbInterfaceMod.Interface
