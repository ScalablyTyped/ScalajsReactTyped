...
import typingsJapgolly.usb.distUsbDescriptorsMod.EndpointDescriptor
import typingsJapgolly.usb.distUsbDeviceMod.ExtendedDevice
import typingsJapgolly.usb.distUsbMod.DeviceIds
import typingsJapgolly.usb.distUsbMod.EventListeners
import typingsJapgolly.usb.distWebusbMod.USBOptions
import typingsJapgolly.usb.distWebusbMod.WebUSB
...
object distMod {
  ...
  open class Capability protected ()
    extends typingsJapgolly.usb.distUsbCapabilityMod.Capability {
    def this(device: typingsJapgolly.usb.distUsbBindingsMod.Device, id: Double) = this()
  }
  
  @JSImport("usb/dist", "Device")
  @js.native
  open class Device ()
    extends typingsJapgolly.usb.distUsbMod.Device
  
  /* note: abstract class */ @JSImport("usb/dist", "Endpoint")
  @js.native
  open class Endpoint protected ()
    extends typingsJapgolly.usb.distUsbEndpointMod.Endpoint {
    def this(device: typingsJapgolly.usb.distUsbBindingsMod.Device, descriptor: EndpointDescriptor) = this()
  }
  
  @JSImport("usb/dist", "InEndpoint")
  @js.native
  open class InEndpoint protected ()
    extends typingsJapgolly.usb.distUsbEndpointMod.InEndpoint {
    def this(device: typingsJapgolly.usb.distUsbBindingsMod.Device, descriptor: EndpointDescriptor) = this()
  }
  ...
  open class Interface protected ()
    extends typingsJapgolly.usb.distUsbInterfaceMod.Interface {
    def this(device: typingsJapgolly.usb.distUsbBindingsMod.Device, id: Double) = this()
  }
  ...
  open class LibUSBException ()
    extends typingsJapgolly.usb.distUsbMod.LibUSBException
  
  @JSImport("usb/dist", "OutEndpoint")
  @js.native
  open class OutEndpoint protected ()
    extends typingsJapgolly.usb.distUsbEndpointMod.OutEndpoint {
    def this(device: typingsJapgolly.usb.distUsbBindingsMod.Device, descriptor: EndpointDescriptor) = this()
  }
  ...
  open class Transfer protected ()
    extends typingsJapgolly.usb.distUsbMod.Transfer {
    def this(
  ...
  /* private */ open class WebUSBDevice ()
    extends typingsJapgolly.usb.distWebusbWebusbDeviceMod.WebUSBDevice
  /* static members */
  object WebUSBDevice {
    ...
    inline def createInstance(device: typingsJapgolly.usb.distUsbMod.Device): js.Promise[typingsJapgolly.usb.distWebusbWebusbDeviceMod.WebUSBDevice] = ^.asInstanceOf[js.Dynamic].applyDynamic("createInstance")(device.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.usb.distWebusbWebusbDeviceMod.WebUSBDevice]]
  }
  ...
  /**
    ...
    * @param pid
    */
  inline def findByIds(vid: Double, pid: Double): js.UndefOr[typingsJapgolly.usb.distUsbMod.Device] = (^.asInstanceOf[js.Dynamic].applyDynamic("findByIds")(vid.asInstanceOf[js.Any], pid.asInstanceOf[js.Any])).asInstanceOf[js.UndefOr[typingsJapgolly.usb.distUsbMod.Device]]
  
  /**
    * Convenience method to get the device with the specified serial number, or `undefined` if no such device is present.
    * @param serialNumber
    */
  inline def findBySerialNumber(serialNumber: String): js.Promise[js.UndefOr[typingsJapgolly.usb.distUsbMod.Device]] = ^.asInstanceOf[js.Dynamic].applyDynamic("findBySerialNumber")(serialNumber.asInstanceOf[js.Any]).asInstanceOf[js.Promise[js.UndefOr[typingsJapgolly.usb.distUsbMod.Device]]]
  ...
  object usb {
    ...
    object usbDistUsbBindingsAugmentingMod {
      ...
      trait DeviceEvents
        extends StObject
           with EventListeners[typingsJapgolly.usb.distUsbMod.usbDistUsbBindingsAugmentingMod.DeviceEvents] {
