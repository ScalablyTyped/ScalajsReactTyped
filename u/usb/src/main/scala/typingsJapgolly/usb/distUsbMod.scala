...
import typingsJapgolly.usb.distUsbDeviceMod.ExtendedDevice
...
object distUsbMod {
  ...
  @js.native
  open class Device ()
    extends typingsJapgolly.usb.distUsbBindingsMod.Device
  ...
  open class LibUSBException ()
    extends typingsJapgolly.usb.distUsbBindingsMod.LibUSBException
  
  @JSImport("usb/dist/usb", "Transfer")
  @js.native
  open class Transfer protected ()
    extends typingsJapgolly.usb.distUsbBindingsMod.Transfer {
    def this(
      device: typingsJapgolly.usb.distUsbBindingsMod.Device,
      endpointAddr: Double,
      `type`: Double,
      timeout: Double,
      callback: js.Function3[
            /* error */ typingsJapgolly.usb.distUsbBindingsMod.LibUSBException, 
            /* buf */ Buffer, 
            /* actual */ Double, 
            Unit
          ]
  ...
  inline def getDeviceList(): js.Array[typingsJapgolly.usb.distUsbBindingsMod.Device] = ^.asInstanceOf[js.Dynamic].applyDynamic("getDeviceList")().asInstanceOf[js.Array[typingsJapgolly.usb.distUsbBindingsMod.Device]]
  ...
  object usbDistUsbBindingsAugmentingMod {
    ...
    trait DeviceEvents
      ...
      var attach: typingsJapgolly.usb.distUsbMod.usbDistUsbBindingsAugmentingMod.Device
      
      var attachIds: DeviceIds
      
      var detach: typingsJapgolly.usb.distUsbMod.usbDistUsbBindingsAugmentingMod.Device
    ...
    object DeviceEvents {
      ...
      inline def apply(
        attach: typingsJapgolly.usb.distUsbMod.usbDistUsbBindingsAugmentingMod.Device,
        attachIds: DeviceIds,
        detach: typingsJapgolly.usb.distUsbMod.usbDistUsbBindingsAugmentingMod.Device,
        detachIds: DeviceIds,
      ...
      extension [Self <: DeviceEvents](x: Self) {
        ...
        inline def setAttach(value: typingsJapgolly.usb.distUsbMod.usbDistUsbBindingsAugmentingMod.Device): Self = StObject.set(x, "attach", value.asInstanceOf[js.Any])
        
        inline def setAttachIds(value: DeviceIds): Self = StObject.set(x, "attachIds", value.asInstanceOf[js.Any])
        
        inline def setDetach(value: typingsJapgolly.usb.distUsbMod.usbDistUsbBindingsAugmentingMod.Device): Self = StObject.set(x, "detach", value.asInstanceOf[js.Any])
