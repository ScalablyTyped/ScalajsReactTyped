...
import typingsJapgolly.usb.distUsbDescriptorsMod.BosDescriptor
import typingsJapgolly.usb.distUsbDescriptorsMod.ConfigDescriptor
import typingsJapgolly.usb.distUsbDescriptorsMod.DeviceDescriptor
