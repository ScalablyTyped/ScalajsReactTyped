...
object upnpMediarendererClientStrings {
  ...
  @js.native
  sealed trait speedChanged extends StObject
  inline def speedChanged: speedChanged = "speedChanged".asInstanceOf[speedChanged]
