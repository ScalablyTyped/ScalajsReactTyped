package typingsJapgolly.upnpMediarendererClient

import typingsJapgolly.upnpMediarendererClient.upnpMediarendererClientStrings.loading
import typingsJapgolly.upnpMediarendererClient.upnpMediarendererClientStrings.paused
import typingsJapgolly.upnpMediarendererClient.upnpMediarendererClientStrings.playing
import typingsJapgolly.upnpMediarendererClient.upnpMediarendererClientStrings.speedChanged
import typingsJapgolly.upnpMediarendererClient.upnpMediarendererClientStrings.status
import typingsJapgolly.upnpMediarendererClient.upnpMediarendererClientStrings.stopped
