...
import typingsJapgolly.uirouterAngularjs.libInterfaceMod.Ng1StateDeclaration
...
object anon {
  ...
  object Resolve {
    ...
    inline def apply(resolve: CallbackTo[Any]): Resolve = {
      val __obj = js.Dynamic.literal(resolve = resolve.toJsFn)
