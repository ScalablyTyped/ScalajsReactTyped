...
import typingsJapgolly.uirouterAngularjs.anon.Resolve
import typingsJapgolly.uirouterAngularjs.libDirectivesStateDirectivesMod.ng1Directive
import typingsJapgolly.uirouterAngularjs.libStatebuildersViewsMod.Ng1ViewConfig
