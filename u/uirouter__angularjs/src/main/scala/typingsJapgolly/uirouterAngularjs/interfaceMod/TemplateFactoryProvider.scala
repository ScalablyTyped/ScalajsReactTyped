...
object TemplateFactoryProvider {
  @scala.inline
  def apply(useHttpService: Boolean => CallbackTo[js.Any]): TemplateFactoryProvider = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("useHttpService")(js.Any.fromFunction1((t0: scala.Boolean) => useHttpService(t0).runNow()))
