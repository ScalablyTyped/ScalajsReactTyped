package typingsJapgolly.ukCoWorkingedgePhonegapPluginLaunchnavigator
...
object mod {
  ...
  object AppSelectionOptions {
    ...
    extension [Self <: AppSelectionOptions](x: Self) {
      ...
      inline def setCallback(value: /* app */ String => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* app */ String) => value(t0).runNow()))
  ...
  object LaunchNavigatorOptions {
    ...
    extension [Self <: LaunchNavigatorOptions](x: Self) {
      ...
      inline def setErrorCallback(value: /* error */ String => Callback): Self = StObject.set(x, "errorCallback", js.Any.fromFunction1((t0: /* error */ String) => value(t0).runNow()))
  ...
  object PromptsOptions {
    ...
    extension [Self <: PromptsOptions](x: Self) {
      ...
      inline def setCallback(value: /* rememberChoice */ Boolean => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* rememberChoice */ Boolean) => value(t0).runNow()))
  ...
  object RememberChoiceOptions {
    ...
    extension [Self <: RememberChoiceOptions](x: Self) {
      ...
      inline def setPromptFn(value: /* callback */ js.Function1[/* rememberChoice */ Boolean, Unit] => Callback): Self = StObject.set(x, "promptFn", js.Any.fromFunction1((t0: /* callback */ js.Function1[/* rememberChoice */ Boolean, Unit]) => value(t0).runNow()))
  ...
  object UserChoice {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(clear = js.Any.fromFunction1((t0: js.Function0[Unit]) => clear(t0).runNow()), exists = js.Any.fromFunction1((t0: js.Function1[/* exists */ Boolean, Unit]) => exists(t0).runNow()), get = js.Any.fromFunction1((t0: js.Function1[/* app */ String, Unit]) => get(t0).runNow()), set = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (set(t0, t1)).runNow()))
      __obj.asInstanceOf[UserChoice]
    }
    
    extension [Self <: UserChoice](x: Self) {
      
      inline def setClear(value: js.Function0[Unit] => Callback): Self = StObject.set(x, "clear", js.Any.fromFunction1((t0: js.Function0[Unit]) => value(t0).runNow()))
      
      inline def setExists(value: js.Function1[/* exists */ Boolean, Unit] => Callback): Self = StObject.set(x, "exists", js.Any.fromFunction1((t0: js.Function1[/* exists */ Boolean, Unit]) => value(t0).runNow()))
      
      inline def setGet(value: js.Function1[/* app */ String, Unit] => Callback): Self = StObject.set(x, "get", js.Any.fromFunction1((t0: js.Function1[/* app */ String, Unit]) => value(t0).runNow()))
      
      inline def setSet(value: (String, js.Function0[Unit]) => Callback): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object UserPrompted {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(clear = js.Any.fromFunction1((t0: js.Function0[Unit]) => clear(t0).runNow()), get = js.Any.fromFunction1((t0: js.Function1[/* exists */ Boolean, Unit]) => get(t0).runNow()), set = js.Any.fromFunction1((t0: js.Function0[Unit]) => set(t0).runNow()))
    ...
    extension [Self <: UserPrompted](x: Self) {
      ...
      inline def setGet(value: js.Function1[/* exists */ Boolean, Unit] => Callback): Self = StObject.set(x, "get", js.Any.fromFunction1((t0: js.Function1[/* exists */ Boolean, Unit]) => value(t0).runNow()))
      
      inline def setSet(value: js.Function0[Unit] => Callback): Self = StObject.set(x, "set", js.Any.fromFunction1((t0: js.Function0[Unit]) => value(t0).runNow()))
    }
  }
}
