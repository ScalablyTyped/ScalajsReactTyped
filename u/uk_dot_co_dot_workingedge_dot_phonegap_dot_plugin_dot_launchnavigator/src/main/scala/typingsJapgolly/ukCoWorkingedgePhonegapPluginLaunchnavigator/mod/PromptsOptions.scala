...
object PromptsOptions {
  ...
  def apply(
    ...
    callback: /* rememberChoice */ Boolean => Callback = null,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: /* rememberChoice */ scala.Boolean) => callback(t0).runNow()))
