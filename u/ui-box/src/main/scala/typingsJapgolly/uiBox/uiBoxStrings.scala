...
object uiBoxStrings {
  @js.native
  sealed trait BoxCssProps extends js.Object
  ...
  @js.native
  sealed trait clearfix extends js.Object
  ...
  @scala.inline
  def BoxCssProps: BoxCssProps = "BoxCssProps".asInstanceOf[BoxCssProps]
  @scala.inline
  ...
  @scala.inline
  def clearfix: clearfix = "clearfix".asInstanceOf[clearfix]
  @scala.inline
