...
object IStickyState {
  ...
  def apply(
    ...
    onInactivate: /* repeated */ js.Any => Callback = null,
    onReactivate: /* repeated */ js.Any => Callback = null,
    ...
    if (onInactivate != null) __obj.updateDynamic("onInactivate")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onInactivate(t0).runNow()))
    if (onReactivate != null) __obj.updateDynamic("onReactivate")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onReactivate(t0).runNow()))
