package typingsJapgolly.uiRouterExtras
...
import typingsJapgolly.uiRouterExtras.anon.Redirect
  ...
  object ui {
    ...
    object IFutureStateProvider {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(addResolve = js.Any.fromFunction1((t0: IResolveFunction) => addResolve(t0).runNow()), futureState = js.Any.fromFunction1((t0: IFutureState) => futureState(t0).runNow()), stateFactory = js.Any.fromFunction2((t0: String, t1: IFutureStateFactory) => (stateFactory(t0, t1)).runNow()))
        __obj.asInstanceOf[IFutureStateProvider]
      }
      
      extension [Self <: IFutureStateProvider](x: Self) {
        
        inline def setAddResolve(value: IResolveFunction => Callback): Self = StObject.set(x, "addResolve", js.Any.fromFunction1((t0: IResolveFunction) => value(t0).runNow()))
        
        inline def setFutureState(value: IFutureState => Callback): Self = StObject.set(x, "futureState", js.Any.fromFunction1((t0: IFutureState) => value(t0).runNow()))
        
        inline def setStateFactory(value: (String, IFutureStateFactory) => Callback): Self = StObject.set(x, "stateFactory", js.Any.fromFunction2((t0: String, t1: IFutureStateFactory) => (value(t0, t1)).runNow()))
      }
    }
    ...
    object IStickyState {
      ...
      extension [Self <: IStickyState](x: Self) {
        ...
        inline def setOnInactivate(value: /* repeated */ Any => Callback): Self = StObject.set(x, "onInactivate", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
        
        inline def setOnInactivateUndefined: Self = StObject.set(x, "onInactivate", js.undefined)
        
        inline def setOnReactivate(value: /* repeated */ Any => Callback): Self = StObject.set(x, "onReactivate", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
    ...
    object IStickyStateProvider {
      ...
      inline def apply(
        $get: Any,
        debugMode: CallbackTo[Boolean],
        enableDebug: Boolean => Boolean,
        registerStickyState: IStickyState => Callback
      ): IStickyStateProvider = {
        val __obj = js.Dynamic.literal($get = $get.asInstanceOf[js.Any], debugMode = debugMode.toJsFn, enableDebug = js.Any.fromFunction1(enableDebug), registerStickyState = js.Any.fromFunction1((t0: IStickyState) => registerStickyState(t0).runNow()))
        __obj.asInstanceOf[IStickyStateProvider]
      }
      
      extension [Self <: IStickyStateProvider](x: Self) {
        
        inline def setDebugMode(value: CallbackTo[Boolean]): Self = StObject.set(x, "debugMode", value.toJsFn)
        
        inline def setEnableDebug(value: Boolean => Boolean): Self = StObject.set(x, "enableDebug", js.Any.fromFunction1(value))
        
        inline def setRegisterStickyState(value: IStickyState => Callback): Self = StObject.set(x, "registerStickyState", js.Any.fromFunction1((t0: IStickyState) => value(t0).runNow()))
      }
    }
