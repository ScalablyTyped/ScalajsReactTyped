...
import typingsJapgolly.unixPermissions.mod.OctalDigit
import typingsJapgolly.unixPermissions.mod.OctalOperator
import typingsJapgolly.unixPermissions.mod.PermissionStatOthersBit
import typingsJapgolly.unixPermissions.mod.PermissionSymbolicAction
import typingsJapgolly.unixPermissions.mod.PermissionSymbolicClass
import typingsJapgolly.unixPermissions.mod.PermissionSymbolicOperator
import typingsJapgolly.unixPermissions.mod.PermissionType
import typingsJapgolly.unixPermissions.mod._OctalPrefix
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object unixPermissionsStrings {
  
  @js.native
  sealed trait `-_`
    extends StObject
       with OctalOperator
       with PermissionStatOthersBit
       with PermissionSymbolicOperator
  ...
  sealed trait `0o`
    extends StObject
       with _OctalPrefix
  inline def `0o`: `0o` = "0o".asInstanceOf[`0o`]
