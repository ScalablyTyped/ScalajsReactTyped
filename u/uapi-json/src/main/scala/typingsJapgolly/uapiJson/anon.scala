...
import typingsJapgolly.uapiJson.libAirMod.AddSegmentsParams
import typingsJapgolly.uapiJson.libAirMod.BookParams
import typingsJapgolly.uapiJson.libAirMod.CancelBookingParams
import typingsJapgolly.uapiJson.libAirMod.CancelTicketParams
import typingsJapgolly.uapiJson.libAirMod.FareRulesParams
import typingsJapgolly.uapiJson.libAirMod.FlightInfoParams
import typingsJapgolly.uapiJson.libAirMod.GetBookingParams
import typingsJapgolly.uapiJson.libAirMod.GetEMDItemParams
import typingsJapgolly.uapiJson.libAirMod.GetEMDListParams
import typingsJapgolly.uapiJson.libAirMod.GetTicketParams
import typingsJapgolly.uapiJson.libAirMod.GetTicketsParams
import typingsJapgolly.uapiJson.libAirMod.GetUniversalRecordByPNRParams
import typingsJapgolly.uapiJson.libAirMod.GetUniversalRecordParams
import typingsJapgolly.uapiJson.libAirMod.SearchBookingsByPassengerNameParams
import typingsJapgolly.uapiJson.libAirMod.ShopParams
import typingsJapgolly.uapiJson.libAirMod.TicketParams
import typingsJapgolly.uapiJson.libAirMod.ToQueueParams
import typingsJapgolly.uapiJson.libHotelsServiceMod.CancelBookParams
import typingsJapgolly.uapiJson.libHotelsServiceMod.RatesParams
import typingsJapgolly.uapiJson.libHotelsServiceMod.SearchParams
import typingsJapgolly.uapiJson.libUtilsServiceMod.CurrencyConvertParams
import typingsJapgolly.uapiJson.libUtilsServiceMod.ReferenceDataParams
import typingsJapgolly.uapiJson.uapiJsonBooleans.`true`
import typingsJapgolly.uapiJson.uapiJsonStrings.Cash
import typingsJapgolly.uapiJson.uapiJsonStrings.Z
import typingsJapgolly.uapiJson.uapiJsonStrings.ZA
...
object anon {
  ...
  object AddSegments {
    ...
    inline def apply(
      ...
      importPNR: CallbackTo[js.Promise[Any]],
    ...
    extension [Self <: AddSegments](x: Self) {
      ...
      inline def setImportPNR(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "importPNR", value.toJsFn)
  ...
  trait Book extends StObject {
    ...
    def book(params: typingsJapgolly.uapiJson.libHotelsServiceMod.BookParams): js.Promise[Any]
  ...
  object Book {
    ...
    inline def apply(
      book: typingsJapgolly.uapiJson.libHotelsServiceMod.BookParams => js.Promise[Any],
    ...
    extension [Self <: Book](x: Self) {
      ...
      inline def setBook(value: typingsJapgolly.uapiJson.libHotelsServiceMod.BookParams => js.Promise[Any]): Self = StObject.set(x, "book", js.Any.fromFunction1(value))
