...
import typingsJapgolly.uvu.mod.uvu.Test
...
object mod {
  ...
  type Callback[T] = typingsJapgolly.uvu.mod.uvu.Callback[T]
  ...
  object uvu {
    ...
    trait Hook[T] extends StObject {
      ...
      def apply(hook: typingsJapgolly.uvu.mod.uvu.Callback[T]): Unit = js.native
      
      def each(hook: typingsJapgolly.uvu.mod.uvu.Callback[T]): Unit = js.native
    }
    
    @js.native
    trait Test[T] extends StObject {
      
      def apply(name: String, test: typingsJapgolly.uvu.mod.uvu.Callback[T]): Unit = js.native
      
      def after(hook: typingsJapgolly.uvu.mod.uvu.Callback[T]): Unit = js.native
      @JSName("after")
      var after_Original: Hook[T] = js.native
      
      def before(hook: typingsJapgolly.uvu.mod.uvu.Callback[T]): Unit = js.native
      @JSName("before")
      var before_Original: Hook[T] = js.native
      
      def only(name: String, test: typingsJapgolly.uvu.mod.uvu.Callback[T]): Unit = js.native
      
      def run(): Unit = js.native
      
      def skip(): Unit = js.native
      def skip(name: String): Unit = js.native
      def skip(name: String, test: typingsJapgolly.uvu.mod.uvu.Callback[T]): Unit = js.native
      def skip(name: Unit, test: typingsJapgolly.uvu.mod.uvu.Callback[T]): Unit = js.native
    }
  }
}
