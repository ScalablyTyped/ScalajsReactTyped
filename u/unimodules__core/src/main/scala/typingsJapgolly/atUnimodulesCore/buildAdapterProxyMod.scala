...
object buildAdapterProxyMod extends js.Object {
  ...
  class CodedError protected ()
    extends typingsJapgolly.atUnimodulesReactDashNativeDashAdapter.atUnimodulesReactDashNativeDashAdapterMod.CodedError {
    def this(code: String, message: String) = this()
  }
  
  @js.native
  class EventEmitter protected ()
    extends typingsJapgolly.atUnimodulesReactDashNativeDashAdapter.atUnimodulesReactDashNativeDashAdapterMod.EventEmitter {
    def this(nativeModule: NativeModule) = this()
  }
  
  @js.native
  class UnavailabilityError protected ()
    extends typingsJapgolly.atUnimodulesReactDashNativeDashAdapter.atUnimodulesReactDashNativeDashAdapterMod.UnavailabilityError {
