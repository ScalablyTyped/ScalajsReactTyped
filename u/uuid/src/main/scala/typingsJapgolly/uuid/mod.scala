...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.uuid.mod.V1RandomOptions
    - typingsJapgolly.uuid.mod.V1RngOptions
  */
  trait V1Options extends StObject
  object V1Options {
    
    inline def V1RandomOptions(): typingsJapgolly.uuid.mod.V1RandomOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uuid.mod.V1RandomOptions]
    }
    
    inline def V1RngOptions(): typingsJapgolly.uuid.mod.V1RngOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uuid.mod.V1RngOptions]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.uuid.mod.RandomOptions
    - typingsJapgolly.uuid.mod.RngOptions
  */
  trait V4Options extends StObject
  object V4Options {
    
    inline def RandomOptions(): typingsJapgolly.uuid.mod.RandomOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uuid.mod.RandomOptions]
    }
    
    inline def RngOptions(): typingsJapgolly.uuid.mod.RngOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.uuid.mod.RngOptions]
    }
  }
