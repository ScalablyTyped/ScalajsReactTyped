...
object MaxZoomStatus extends StObject {
  ...
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typingsJapgolly.googleMaps.google.maps.MaxZoomStatus & String] = js.native
  
  /* "ERROR" */ val ERROR: typingsJapgolly.googleMaps.google.maps.MaxZoomStatus.ERROR & String = js.native
  
  /* "OK" */ val OK: typingsJapgolly.googleMaps.google.maps.MaxZoomStatus.OK & String = js.native
}
