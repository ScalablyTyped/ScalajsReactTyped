...
open class Settings ()
  extends StObject
     with typingsJapgolly.googleMaps.google.maps.Settings {
...
object Settings {
  ...
  /**
    ...
    */
  /* static member */
  inline def getInstance(): typingsJapgolly.googleMaps.google.maps.Settings = ^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")().asInstanceOf[typingsJapgolly.googleMaps.google.maps.Settings]
}
