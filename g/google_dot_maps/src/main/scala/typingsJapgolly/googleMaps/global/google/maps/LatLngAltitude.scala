...
import typingsJapgolly.googleMaps.google.maps.LatLngAltitudeLiteral
...
open class LatLngAltitude protected ()
  extends StObject
     with typingsJapgolly.googleMaps.google.maps.LatLngAltitude {
  def this(value: typingsJapgolly.googleMaps.google.maps.LatLng) = this()
  /**
    * A <code>LatLngAltitude</code> is a 3D point in geographical coordinates:
  ...
  def this(value: typingsJapgolly.googleMaps.google.maps.LatLng, noClampNoWrap: Boolean) = this()
