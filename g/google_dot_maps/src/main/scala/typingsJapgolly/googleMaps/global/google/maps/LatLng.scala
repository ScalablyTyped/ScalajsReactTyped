...
open class LatLng protected ()
  extends StObject
     with typingsJapgolly.googleMaps.google.maps.LatLng {
  /**
  ...
  def this(latOrLatLngOrLatLngLiteral: typingsJapgolly.googleMaps.google.maps.LatLng) = this()
  ...
  def this(
    latOrLatLngOrLatLngLiteral: typingsJapgolly.googleMaps.google.maps.LatLng,
