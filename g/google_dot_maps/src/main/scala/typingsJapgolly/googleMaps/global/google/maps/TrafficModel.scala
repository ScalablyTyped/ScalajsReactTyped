...
object TrafficModel extends StObject {
  ...
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typingsJapgolly.googleMaps.google.maps.TrafficModel & String] = js.native
  
  /* "bestguess" */ val BEST_GUESS: typingsJapgolly.googleMaps.google.maps.TrafficModel.BEST_GUESS & String = js.native
  
  /* "optimistic" */ val OPTIMISTIC: typingsJapgolly.googleMaps.google.maps.TrafficModel.OPTIMISTIC & String = js.native
  
  /* "pessimistic" */ val PESSIMISTIC: typingsJapgolly.googleMaps.google.maps.TrafficModel.PESSIMISTIC & String = js.native
}
