...
object StreetViewPreference extends StObject {
  ...
  @JSBracketAccess
  def apply(value: String): js.UndefOr[typingsJapgolly.googleMaps.google.maps.StreetViewPreference & String] = js.native
  
  /* "best" */ val BEST: typingsJapgolly.googleMaps.google.maps.StreetViewPreference.BEST & String = js.native
  
  /* "nearest" */ val NEAREST: typingsJapgolly.googleMaps.google.maps.StreetViewPreference.NEAREST & String = js.native
}
