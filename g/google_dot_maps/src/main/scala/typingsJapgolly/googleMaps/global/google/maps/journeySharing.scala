...
import typingsJapgolly.googleMaps.google.maps.journeySharing.AutomaticViewportMode
import typingsJapgolly.googleMaps.google.maps.journeySharing.DefaultMarkerSetupOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.DefaultPolylineSetupOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineDeliveryFleetLocationProviderOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineDeliveryVehicleLocationProviderOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineShipmentLocationProviderOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineTaskFilterOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineTripLocationProviderOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.JourneySharingMapViewOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.MarkerSetupOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.PolylineSetupOptions
import typingsJapgolly.googleMaps.google.maps.journeySharing.Task
...
object journeySharing {
  ...
  object AutomaticViewportMode extends StObject {
    ...
    def apply(value: String): js.UndefOr[
        typingsJapgolly.googleMaps.google.maps.journeySharing.AutomaticViewportMode & String
      ] = js.native
    
    /* "FIT_ANTICIPATED_ROUTE" */ val FIT_ANTICIPATED_ROUTE: typingsJapgolly.googleMaps.google.maps.journeySharing.AutomaticViewportMode.FIT_ANTICIPATED_ROUTE & String = js.native
    
    /* "NONE" */ val NONE: typingsJapgolly.googleMaps.google.maps.journeySharing.AutomaticViewportMode.NONE & String = js.native
  }
  ...
  open class FleetEngineDeliveryFleetLocationProvider protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineDeliveryFleetLocationProvider {
    /**
      * Available only in the v=beta channel: https://goo.gle/3oAthT3.
      * Delivery Fleet Location Provider.
  ...
  open class FleetEngineDeliveryVehicleLocationProvider protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineDeliveryVehicleLocationProvider {
    /**
      * Available only in the v=beta channel: https://goo.gle/3oAthT3.
      * Delivery Vehicle Location Provider.
      * @param options <p>{@link
  ...
  object FleetEngineServiceType extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[
        typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineServiceType & String
      ] = js.native
    
    /* "DELIVERY_VEHICLE_SERVICE" */ val DELIVERY_VEHICLE_SERVICE: typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineServiceType.DELIVERY_VEHICLE_SERVICE & String = js.native
    
    /* "TASK_SERVICE" */ val TASK_SERVICE: typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineServiceType.TASK_SERVICE & String = js.native
    
    /* "TRIP_SERVICE" */ val TRIP_SERVICE: typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineServiceType.TRIP_SERVICE & String = js.native
    
    /* "UNKNOWN_SERVICE" */ val UNKNOWN_SERVICE: typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineServiceType.UNKNOWN_SERVICE & String = js.native
  }
  ...
  open class FleetEngineShipmentLocationProvider protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineShipmentLocationProvider {
    /**
      * Available only in the v=beta channel: https://goo.gle/3oAthT3.
      * Shipment location provider.
      * @param options <p>{@link
  ...
  open class FleetEngineTripLocationProvider protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.journeySharing.FleetEngineTripLocationProvider {
    /**
      * Available only in the v=beta channel: https://goo.gle/3oAthT3.
      * Trip location provider.
      * @param options <p>{@link
  ...
  open class JourneySharingMapView protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.journeySharing.JourneySharingMapView {
    /**
      * Available only in the v=beta channel: https://goo.gle/3oAthT3.
      * The map view.
      * @param options <p>{@link
    ...
    /**
      ...
      */
    /* CompleteClass */
    var anticipatedRoutePolylines: js.Array[typingsJapgolly.googleMaps.google.maps.Polyline] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var destinationMarkers: js.Array[typingsJapgolly.googleMaps.google.maps.Marker_] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var locationProvider: typingsJapgolly.googleMaps.google.maps.journeySharing.LocationProvider = js.native
    
    /**
      * The map object contained in the map view.
      */
    /* CompleteClass */
    var map: typingsJapgolly.googleMaps.google.maps.Map = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var originMarkers: js.Array[typingsJapgolly.googleMaps.google.maps.Marker_] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var successfulTaskMarkers: js.Array[typingsJapgolly.googleMaps.google.maps.Marker_] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var takenRoutePolylines: js.Array[typingsJapgolly.googleMaps.google.maps.Polyline] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var taskOutcomeMarkers: js.Array[typingsJapgolly.googleMaps.google.maps.Marker_] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var unsuccessfulTaskMarkers: js.Array[typingsJapgolly.googleMaps.google.maps.Marker_] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var vehicleMarkers: js.Array[typingsJapgolly.googleMaps.google.maps.Marker_] = js.native
    ...
    /**
      ...
      */
    /* CompleteClass */
    var waypointMarkers: js.Array[typingsJapgolly.googleMaps.google.maps.Marker_] = js.native
  }
  ...
  open class LocationProvider ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.journeySharing.LocationProvider {
