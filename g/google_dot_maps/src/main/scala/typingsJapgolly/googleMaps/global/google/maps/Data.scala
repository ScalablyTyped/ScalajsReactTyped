...
open class Data ()
  extends StObject
     with typingsJapgolly.googleMaps.google.maps.Data {
...
object Data {
  ...
  open class Feature ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.Feature {
  ...
  open class GeometryCollection protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.GeometryCollection {
    /**
      * A GeometryCollection contains a number of geometry objects. Any
      * <code>LatLng</code> or <code>LatLngLiteral</code> objects are
      * automatically converted to <code>Data.Point</code> geometry objects.
      */
    def this(elements: js.Array[Geometry | typingsJapgolly.googleMaps.google.maps.LatLng | LatLngLiteral]) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def forEachLatLng(callback: js.Function1[/* a */ typingsJapgolly.googleMaps.google.maps.LatLng, Unit]): Unit = js.native
  ...
  open class LineString protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.LineString {
    /**
      * A LineString geometry contains a number of <code>LatLng</code>s.
      */
    def this(elements: js.Array[typingsJapgolly.googleMaps.google.maps.LatLng | LatLngLiteral]) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getArray(): js.Array[typingsJapgolly.googleMaps.google.maps.LatLng] = js.native
    
    /**
      * Returns the <code>n</code>-th contained <code>LatLng</code>.
      */
    /* CompleteClass */
    override def getAt(n: Double): typingsJapgolly.googleMaps.google.maps.LatLng = js.native
  ...
  open class LinearRing protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.LinearRing {
    /**
      * A LinearRing geometry contains a number of <code>LatLng</code>s,
      * representing a closed LineString. There is no need to make the first
      * <code>LatLng</code> equal to the last <code>LatLng</code>. The LinearRing
  ...
  open class MultiLineString protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.MultiLineString {
    /**
      * A MultiLineString geometry contains a number of <code>LineString</code>s.
      */
    def this(elements: js.Array[
            typingsJapgolly.googleMaps.google.maps.Data.LineString | (js.Array[typingsJapgolly.googleMaps.google.maps.LatLng | LatLngLiteral])
          ]) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getArray(): js.Array[typingsJapgolly.googleMaps.google.maps.Data.LineString] = js.native
    
    /**
      * Returns the <code>n</code>-th contained <code>Data.LineString</code>.
      */
    /* CompleteClass */
    override def getAt(n: Double): typingsJapgolly.googleMaps.google.maps.Data.LineString = js.native
  ...
  open class MultiPoint protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.MultiPoint {
    /**
      * A MultiPoint geometry contains a number of <code>LatLng</code>s.
      */
    def this(elements: js.Array[typingsJapgolly.googleMaps.google.maps.LatLng | LatLngLiteral]) = this()
  ...
  open class MultiPolygon protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.MultiPolygon {
    /**
      * A MultiPolygon geometry contains a number of <code>Data.Polygon</code>s.
      */
    def this(elements: js.Array[
            typingsJapgolly.googleMaps.google.maps.Data.Polygon | (js.Array[
              typingsJapgolly.googleMaps.google.maps.Data.LinearRing | (js.Array[typingsJapgolly.googleMaps.google.maps.LatLng | LatLngLiteral])
            ])
          ]) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getArray(): js.Array[typingsJapgolly.googleMaps.google.maps.Data.Polygon] = js.native
    
    /**
      * Returns the <code>n</code>-th contained <code>Data.Polygon</code>.
      */
    /* CompleteClass */
    override def getAt(n: Double): typingsJapgolly.googleMaps.google.maps.Data.Polygon = js.native
  ...
  open class Point protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.Point {
    /**
      * A Point geometry contains a single <code>LatLng</code>.
      */
    def this(latLng: typingsJapgolly.googleMaps.google.maps.LatLng) = this()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def get(): typingsJapgolly.googleMaps.google.maps.LatLng = js.native
  ...
  open class Polygon protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.Data.Polygon {
    /**
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def getArray(): js.Array[typingsJapgolly.googleMaps.google.maps.Data.LinearRing] = js.native
    
    /**
      * Returns the <code>n</code>-th contained <code>Data.LinearRing</code>.
      */
    /* CompleteClass */
    override def getAt(n: Double): typingsJapgolly.googleMaps.google.maps.Data.LinearRing = js.native
