...
import typingsJapgolly.googleMaps.google.maps.marker.AdvancedMarkerViewOptions
import typingsJapgolly.googleMaps.google.maps.marker.PinViewOptions
...
object marker {
  ...
  open class AdvancedMarkerView ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.marker.AdvancedMarkerView {
  ...
  open class PinView ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.marker.PinView {
