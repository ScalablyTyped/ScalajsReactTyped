...
import typingsJapgolly.googleMaps.google.maps.localContext.LocalContextMapViewOptions
import typingsJapgolly.googleMaps.google.maps.localContext.PlaceTypePreference
...
object localContext {
  ...
  open class LocalContextMapView protected ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.localContext.LocalContextMapView {
    /**
      * Available only in the v=beta channel: https://goo.gle/3oAthT3.
      * Shows a Local Context experience with a {@link google.maps.Map}.
      */
  ...
  open class MapDirectionsOptions ()
    extends StObject
       with typingsJapgolly.googleMaps.google.maps.localContext.MapDirectionsOptions {
    ...
    /**
      ...
      */
    /* CompleteClass */
    var origin: typingsJapgolly.googleMaps.google.maps.LatLng | LatLngLiteral = js.native
  }
  ...
  object PlaceChooserLayoutMode extends StObject {
    ...
    def apply(value: String): js.UndefOr[
        typingsJapgolly.googleMaps.google.maps.localContext.PlaceChooserLayoutMode & String
      ] = js.native
    
    /* "HIDDEN" */ val HIDDEN: typingsJapgolly.googleMaps.google.maps.localContext.PlaceChooserLayoutMode.HIDDEN & String = js.native
    
    /* "SHEET" */ val SHEET: typingsJapgolly.googleMaps.google.maps.localContext.PlaceChooserLayoutMode.SHEET & String = js.native
  }
  ...
  object PlaceChooserPosition extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[
        typingsJapgolly.googleMaps.google.maps.localContext.PlaceChooserPosition & String
      ] = js.native
    
    /* "BLOCK_END" */ val BLOCK_END: typingsJapgolly.googleMaps.google.maps.localContext.PlaceChooserPosition.BLOCK_END & String = js.native
    
    /* "INLINE_END" */ val INLINE_END: typingsJapgolly.googleMaps.google.maps.localContext.PlaceChooserPosition.INLINE_END & String = js.native
    
    /* "INLINE_START" */ val INLINE_START: typingsJapgolly.googleMaps.google.maps.localContext.PlaceChooserPosition.INLINE_START & String = js.native
  }
  ...
  object PlaceDetailsLayoutMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[
        typingsJapgolly.googleMaps.google.maps.localContext.PlaceDetailsLayoutMode & String
      ] = js.native
    
    /* "INFO_WINDOW" */ val INFO_WINDOW: typingsJapgolly.googleMaps.google.maps.localContext.PlaceDetailsLayoutMode.INFO_WINDOW & String = js.native
    
    /* "SHEET" */ val SHEET: typingsJapgolly.googleMaps.google.maps.localContext.PlaceDetailsLayoutMode.SHEET & String = js.native
  }
  ...
  object PlaceDetailsPosition extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[
        typingsJapgolly.googleMaps.google.maps.localContext.PlaceDetailsPosition & String
      ] = js.native
    
    /* "INLINE_END" */ val INLINE_END: typingsJapgolly.googleMaps.google.maps.localContext.PlaceDetailsPosition.INLINE_END & String = js.native
    
    /* "INLINE_START" */ val INLINE_START: typingsJapgolly.googleMaps.google.maps.localContext.PlaceDetailsPosition.INLINE_START & String = js.native
  }
}
