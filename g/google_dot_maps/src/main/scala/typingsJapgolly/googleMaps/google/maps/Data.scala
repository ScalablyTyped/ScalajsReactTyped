...
import typingsJapgolly.googleMaps.google.maps.Data.FeatureOptions
import typingsJapgolly.googleMaps.google.maps.Data.GeoJsonOptions
import typingsJapgolly.googleMaps.google.maps.Data.StyleOptions
import typingsJapgolly.googleMaps.google.maps.Data.StylingFunction
...
trait Data
  ...
  /**
    ...
    * vice versa.
    */
  def add(): typingsJapgolly.googleMaps.google.maps.Data.Feature = js.native
  def add(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature): typingsJapgolly.googleMaps.google.maps.Data.Feature = js.native
  def add(feature: FeatureOptions): typingsJapgolly.googleMaps.google.maps.Data.Feature = js.native
  ...
  /**
    ...
    */
  def addGeoJson(geoJson: js.Object): js.Array[typingsJapgolly.googleMaps.google.maps.Data.Feature] = js.native
  def addGeoJson(geoJson: js.Object, options: GeoJsonOptions): js.Array[typingsJapgolly.googleMaps.google.maps.Data.Feature] = js.native
  
  /**
    * Checks whether the given feature is in the collection.
    */
  def contains(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature): Boolean = js.native
  ...
  /**
    ...
    */
  def forEach(callback: js.Function1[/* a */ typingsJapgolly.googleMaps.google.maps.Data.Feature, Unit]): Unit = js.native
  ...
  def getFeatureById(id: String): js.UndefOr[typingsJapgolly.googleMaps.google.maps.Data.Feature] = js.native
  /**
    ...
    */
  def getFeatureById(id: Double): js.UndefOr[typingsJapgolly.googleMaps.google.maps.Data.Feature] = js.native
  ...
  def loadGeoJson(
    url: String,
    options: Null,
    callback: js.Function1[/* a */ js.Array[typingsJapgolly.googleMaps.google.maps.Data.Feature], Unit]
  ): Unit = js.native
  def loadGeoJson(
    url: String,
    options: Unit,
  ...
  /**
    ...
    * <code>setStyle()</code>.
    */
  def overrideStyle(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature, style: StyleOptions): Unit = js.native
  
  /**
    * Removes a feature from the collection.
    */
  def remove(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature): Unit = js.native
  ...
  def revertStyle(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature): Unit = js.native
...
object Data {
  ...
  trait AddFeatureEvent extends StObject {
    ...
    /**
      ...
      */
    var feature: typingsJapgolly.googleMaps.google.maps.Data.Feature
  }
  object AddFeatureEvent {
    
    inline def apply(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature): AddFeatureEvent = {
    ...
    extension [Self <: AddFeatureEvent](x: Self) {
      ...
      inline def setFeature(value: typingsJapgolly.googleMaps.google.maps.Data.Feature): Self = StObject.set(x, "feature", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait DataOptions extends StObject {
    ...
    var featureFactory: js.UndefOr[
        (js.Function1[/* a */ Geometry, typingsJapgolly.googleMaps.google.maps.Data.Feature]) | Null
      ] = js.undefined
  ...
  object DataOptions {
    ...
    extension [Self <: DataOptions](x: Self) {
      ...
      inline def setFeatureFactory(value: /* a */ Geometry => typingsJapgolly.googleMaps.google.maps.Data.Feature): Self = StObject.set(x, "featureFactory", js.Any.fromFunction1(value))
      ...
      inline def setStyleFunction1(value: /* a */ typingsJapgolly.googleMaps.google.maps.Data.Feature => StyleOptions): Self = StObject.set(x, "style", js.Any.fromFunction1(value))
  ...
  object Geometry {
    ...
    inline def apply(forEachLatLng: js.Function1[/* a */ LatLng, Unit] => Callback, getType: CallbackTo[String]): Geometry = {
      val __obj = js.Dynamic.literal(forEachLatLng = js.Any.fromFunction1((t0: js.Function1[/* a */ LatLng, Unit]) => forEachLatLng(t0).runNow()), getType = getType.toJsFn)
      __obj.asInstanceOf[Geometry]
    }
    
    extension [Self <: Geometry](x: Self) {
      
      inline def setForEachLatLng(value: js.Function1[/* a */ LatLng, Unit] => Callback): Self = StObject.set(x, "forEachLatLng", js.Any.fromFunction1((t0: js.Function1[/* a */ LatLng, Unit]) => value(t0).runNow()))
  ...
  object GeometryCollection {
    ...
    inline def apply(
      forEachLatLng: js.Function1[/* a */ LatLng, Unit] => Callback,
      getArray: CallbackTo[js.Array[Geometry]],
      getAt: Double => Geometry,
      getLength: CallbackTo[Double],
      getType: CallbackTo[String]
    ): GeometryCollection = {
      val __obj = js.Dynamic.literal(forEachLatLng = js.Any.fromFunction1((t0: js.Function1[/* a */ LatLng, Unit]) => forEachLatLng(t0).runNow()), getArray = getArray.toJsFn, getAt = js.Any.fromFunction1(getAt), getLength = getLength.toJsFn, getType = getType.toJsFn)
      __obj.asInstanceOf[GeometryCollection]
    }
    
    extension [Self <: GeometryCollection](x: Self) {
      
      inline def setGetArray(value: CallbackTo[js.Array[Geometry]]): Self = StObject.set(x, "getArray", value.toJsFn)
  ...
  object MouseEvent {
    ...
    inline def apply(
      domEvent: org.scalajs.dom.MouseEvent | TouchEvent | PointerEvent | KeyboardEvent | Event,
      feature: typingsJapgolly.googleMaps.google.maps.Data.Feature,
      stop: Callback
    ): MouseEvent = {
      val __obj = js.Dynamic.literal(domEvent = domEvent.asInstanceOf[js.Any], feature = feature.asInstanceOf[js.Any], stop = stop.toJsFn, latLng = null)
  ...
  trait MultiPolygon
    ...
    /**
      ...
      */
    def getArray(): js.Array[typingsJapgolly.googleMaps.google.maps.Data.Polygon]
    
    /**
      * Returns the <code>n</code>-th contained <code>Data.Polygon</code>.
      */
    def getAt(n: Double): typingsJapgolly.googleMaps.google.maps.Data.Polygon
  ...
  object MultiPolygon {
    ...
    inline def apply(
      forEachLatLng: js.Function1[/* a */ LatLng, Unit] => Callback,
      getArray: CallbackTo[js.Array[typingsJapgolly.googleMaps.google.maps.Data.Polygon]],
      getAt: Double => typingsJapgolly.googleMaps.google.maps.Data.Polygon,
      getLength: CallbackTo[Double],
      getType: CallbackTo[String]
    ): MultiPolygon = {
      val __obj = js.Dynamic.literal(forEachLatLng = js.Any.fromFunction1((t0: js.Function1[/* a */ LatLng, Unit]) => forEachLatLng(t0).runNow()), getArray = getArray.toJsFn, getAt = js.Any.fromFunction1(getAt), getLength = getLength.toJsFn, getType = getType.toJsFn)
    ...
    extension [Self <: MultiPolygon](x: Self) {
      ...
      inline def setGetArray(value: CallbackTo[js.Array[typingsJapgolly.googleMaps.google.maps.Data.Polygon]]): Self = StObject.set(x, "getArray", value.toJsFn)
      
      inline def setGetAt(value: Double => typingsJapgolly.googleMaps.google.maps.Data.Polygon): Self = StObject.set(x, "getAt", js.Any.fromFunction1(value))
  ...
  object Point {
    ...
    inline def apply(
      ...
      getType: CallbackTo[String]
    ): typingsJapgolly.googleMaps.google.maps.Data.Point = {
      val __obj = js.Dynamic.literal(forEachLatLng = js.Any.fromFunction1((t0: js.Function1[/* a */ LatLng, Unit]) => forEachLatLng(t0).runNow()), get = get.toJsFn, getType = getType.toJsFn)
      __obj.asInstanceOf[typingsJapgolly.googleMaps.google.maps.Data.Point]
    }
    
    extension [Self <: typingsJapgolly.googleMaps.google.maps.Data.Point](x: Self) {
  ...
  object Polygon {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(forEachLatLng = js.Any.fromFunction1((t0: js.Function1[/* a */ LatLng, Unit]) => forEachLatLng(t0).runNow()), getArray = getArray.toJsFn, getAt = js.Any.fromFunction1(getAt), getLength = getLength.toJsFn, getType = getType.toJsFn)
      __obj.asInstanceOf[typingsJapgolly.googleMaps.google.maps.Data.Polygon]
    }
    
    extension [Self <: typingsJapgolly.googleMaps.google.maps.Data.Polygon](x: Self) {
  ...
  object RemoveFeatureEvent {
    ...
    inline def apply(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature): RemoveFeatureEvent = {
      val __obj = js.Dynamic.literal(feature = feature.asInstanceOf[js.Any])
  ...
  object RemovePropertyEvent {
    ...
    inline def apply(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature, name: String, oldValue: Any): RemovePropertyEvent = {
  ...
  object SetGeometryEvent {
    ...
    inline def apply(feature: typingsJapgolly.googleMaps.google.maps.Data.Feature): SetGeometryEvent = {
      val __obj = js.Dynamic.literal(feature = feature.asInstanceOf[js.Any])
  ...
  type StylingFunction = js.Function1[/* a */ typingsJapgolly.googleMaps.google.maps.Data.Feature, StyleOptions]
}
