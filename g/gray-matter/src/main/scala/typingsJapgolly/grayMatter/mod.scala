...
import typingsJapgolly.grayMatter.anon.Content
import typingsJapgolly.grayMatter.anon.ContentString
import typingsJapgolly.grayMatter.anon.Name
import typingsJapgolly.grayMatter.anon.Parse
...
object mod {
  ...
  object GrayMatterOption {
    ...
    extension [Self <: GrayMatterOption[?, ?], I /* <: Input */, O /* <: GrayMatterOption[I, O] */](x: Self & (GrayMatterOption[I, O])) {
      ...
      inline def setParser(value: Callback): Self = StObject.set(x, "parser", value.toJsFn)
