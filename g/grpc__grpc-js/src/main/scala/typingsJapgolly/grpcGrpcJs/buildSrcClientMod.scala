...
import typingsJapgolly.grpcGrpcJs.buildSrcCallMod.SurfaceCall
...
import typingsJapgolly.grpcGrpcJs.buildSrcClientInterceptorsMod.Interceptor
import typingsJapgolly.grpcGrpcJs.buildSrcClientInterceptorsMod.InterceptorProvider
import typingsJapgolly.grpcGrpcJs.buildSrcCompressionAlgorithmsMod.CompressionAlgorithms
import typingsJapgolly.grpcGrpcJs.buildSrcMakeClientMod.ClientMethodDefinition
...
object buildSrcClientMod {
  ...
  object CallProperties {
    ...
    extension [Self <: CallProperties[?, ?], RequestType, ResponseType](x: Self & (CallProperties[RequestType, ResponseType])) {
      ...
      inline def setCallback(value: (/* err */ ServiceError | Null, /* value */ js.UndefOr[ResponseType]) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* err */ ServiceError | Null, t1: /* value */ js.UndefOr[ResponseType]) => (value(t0, t1)).runNow()))
