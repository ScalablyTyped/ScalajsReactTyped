...
import typingsJapgolly.grpcGrpcJs.buildSrcPickerMod.PickResultType.COMPLETE
import typingsJapgolly.grpcGrpcJs.buildSrcPickerMod.PickResultType.DROP
import typingsJapgolly.grpcGrpcJs.buildSrcPickerMod.PickResultType.QUEUE
import typingsJapgolly.grpcGrpcJs.buildSrcPickerMod.PickResultType.TRANSIENT_FAILURE
...
object buildSrcPickerMod {
  ...
  object PickResult {
    ...
    extension [Self <: PickResult](x: Self) {
      ...
      inline def setOnCallStarted(value: Callback): Self = StObject.set(x, "onCallStarted", value.toJsFn)
