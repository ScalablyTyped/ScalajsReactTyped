...
import typingsJapgolly.grpcGrpcJs.buildSrcLoadBalancingCallMod.LoadBalancingCall
import typingsJapgolly.grpcGrpcJs.buildSrcMetadataMod.Metadata
import typingsJapgolly.grpcGrpcJs.buildSrcPickerMod.PickResult
import typingsJapgolly.grpcGrpcJs.buildSrcResolverMod.CallConfig
import typingsJapgolly.grpcGrpcJs.buildSrcResolvingCallMod.ResolvingCall
import typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.ServerSurfaceCall
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.ERROR
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.NONE
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.SUCCESS
...
object buildSrcInternalChannelMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.NoneConfigResult
    - typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.SuccessConfigResult
    - typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.ErrorConfigResult
  */
  trait GetConfigResult extends StObject
  object GetConfigResult {
    
    inline def ErrorConfigResult(error: StatusObject): typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.ErrorConfigResult = {
      val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("ERROR")
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.ErrorConfigResult]
    }
    
    inline def NoneConfigResult(): typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.NoneConfigResult = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("NONE")
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.NoneConfigResult]
    }
    
    inline def SuccessConfigResult(config: CallConfig): typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.SuccessConfigResult = {
      val __obj = js.Dynamic.literal(config = config.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("SUCCESS")
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcInternalChannelMod.SuccessConfigResult]
    }
  }
