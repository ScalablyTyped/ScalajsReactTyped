...
import typingsJapgolly.grpcGrpcJs.anon.End
import typingsJapgolly.grpcGrpcJs.anon.EndRequest
import typingsJapgolly.grpcGrpcJs.anon.Request
import typingsJapgolly.grpcGrpcJs.buildSrcCallStreamMod.Deadline
...
import typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.ObjectReadable
import typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.ObjectWritable
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.data
import typingsJapgolly.node.NodeJS.ReadableStream
import typingsJapgolly.node.NodeJS.WritableStream
import typingsJapgolly.node.anon.Chunk
...
object buildSrcServerCallMod {
  ...
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.IntermediateObjectWritable because Inheritance from two classes. Inlined 
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.IntermediateObjectReadable because Inheritance from two classes. Inlined 
  - typingsJapgolly.node.eventsMod.EventEmitter because Inheritance from two classes. Inlined 
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.ObjectWritable because Inheritance from two classes. Inlined _write, write, write, write, write, write, setDefaultEncoding, end, end, end, end, end, end
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.ObjectReadable because Inheritance from two classes. Inlined read, read
  - typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.ServerSurfaceCall because Inheritance from two classes. Inlined cancelled, metadata, getPeer, sendMetadata, getDeadline, getPath */ @JSImport("@grpc/grpc-js/build/src/server-call", "ServerDuplexStreamImpl")
  @js.native
  open class ServerDuplexStreamImpl[RequestType, ResponseType] protected ()
    ...
    @JSName("addListener")
    def addListener_data(event: typingsJapgolly.node.nodeStrings.data, listener: js.Function1[/* chunk */ Any, Unit]): this.type = js.native
    @JSName("addListener")
    ...
    @JSName("emit")
    def emit_data(event: typingsJapgolly.node.nodeStrings.data, chunk: Any): Boolean = js.native
    @JSName("emit")
    ...
    @JSName("on")
    def on_data(event: typingsJapgolly.node.nodeStrings.data, listener: js.Function1[/* chunk */ Any, Unit]): this.type = js.native
    @JSName("on")
    ...
    @JSName("once")
    def once_data(event: typingsJapgolly.node.nodeStrings.data, listener: js.Function1[/* chunk */ Any, Unit]): this.type = js.native
    @JSName("once")
    ...
    @JSName("prependListener")
    def prependListener_data(event: typingsJapgolly.node.nodeStrings.data, listener: js.Function1[/* chunk */ Any, Unit]): this.type = js.native
    @JSName("prependListener")
    ...
    @JSName("prependOnceListener")
    def prependOnceListener_data(event: typingsJapgolly.node.nodeStrings.data, listener: js.Function1[/* chunk */ Any, Unit]): this.type = js.native
    @JSName("prependOnceListener")
    ...
    @JSName("removeListener")
    def removeListener_data(event: typingsJapgolly.node.nodeStrings.data, listener: js.Function1[/* chunk */ Any, Unit]): this.type = js.native
    @JSName("removeListener")
  ...
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.IntermediateObjectReadable because Inheritance from two classes. Inlined 
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.ObjectReadable because Inheritance from two classes. Inlined read, read */ @JSImport("@grpc/grpc-js/build/src/server-call", "ServerReadableStreamImpl")
  @js.native
  ...
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.IntermediateObjectWritable because Inheritance from two classes. Inlined 
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.ObjectWritable because Inheritance from two classes. Inlined _write, write, write, write, write, write, setDefaultEncoding, end, end, end, end, end, end */ @JSImport("@grpc/grpc-js/build/src/server-call", "ServerWritableStreamImpl")
  @js.native
  ...
  object BidiStreamingHandler {
    ...
    inline def apply[RequestType, ResponseType](
      ...
      func: /* call */ ServerDuplexStream[RequestType, ResponseType] => Callback,
      path: String,
      serialize: ResponseType => Buffer,
      `type`: HandlerType
    ): BidiStreamingHandler[RequestType, ResponseType] = {
      val __obj = js.Dynamic.literal(deserialize = js.Any.fromFunction1(deserialize), func = js.Any.fromFunction1((t0: /* call */ ServerDuplexStream[RequestType, ResponseType]) => func(t0).runNow()), path = path.asInstanceOf[js.Any], serialize = js.Any.fromFunction1(serialize))
    ...
    extension [Self <: BidiStreamingHandler[?, ?], RequestType, ResponseType](x: Self & (BidiStreamingHandler[RequestType, ResponseType])) {
      ...
      inline def setFunc(value: /* call */ ServerDuplexStream[RequestType, ResponseType] => Callback): Self = StObject.set(x, "func", js.Any.fromFunction1((t0: /* call */ ServerDuplexStream[RequestType, ResponseType]) => value(t0).runNow()))
  ...
  object ClientStreamingHandler {
    ...
    inline def apply[RequestType, ResponseType](
      deserialize: /* bytes */ Buffer => RequestType,
      func: (/* call */ ServerReadableStream[RequestType, ResponseType], /* callback */ sendUnaryData[ResponseType]) => Callback,
      path: String,
      serialize: ResponseType => Buffer,
      `type`: HandlerType
    ): ClientStreamingHandler[RequestType, ResponseType] = {
      val __obj = js.Dynamic.literal(deserialize = js.Any.fromFunction1(deserialize), func = js.Any.fromFunction2((t0: /* call */ ServerReadableStream[RequestType, ResponseType], t1: /* callback */ sendUnaryData[ResponseType]) => (func(t0, t1)).runNow()), path = path.asInstanceOf[js.Any], serialize = js.Any.fromFunction1(serialize))
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    ...
    extension [Self <: ClientStreamingHandler[?, ?], RequestType, ResponseType](x: Self & (ClientStreamingHandler[RequestType, ResponseType])) {
      ...
      inline def setFunc(
        value: (/* call */ ServerReadableStream[RequestType, ResponseType], /* callback */ sendUnaryData[ResponseType]) => Callback
      ): Self = StObject.set(x, "func", js.Any.fromFunction2((t0: /* call */ ServerReadableStream[RequestType, ResponseType], t1: /* callback */ sendUnaryData[ResponseType]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.UnaryHandler[RequestType, ResponseType]
    - typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.ClientStreamingHandler[RequestType, ResponseType]
    - typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.ServerStreamingHandler[RequestType, ResponseType]
    - typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.BidiStreamingHandler[RequestType, ResponseType]
  */
  ...
  object Handler {
    ...
    inline def BidiStreamingHandler[RequestType, ResponseType](
      ...
      val __obj = js.Dynamic.literal(deserialize = js.Any.fromFunction1(deserialize), func = js.Any.fromFunction1((t0: /* call */ ServerDuplexStream[RequestType, ResponseType]) => func(t0).runNow()), path = path.asInstanceOf[js.Any], serialize = js.Any.fromFunction1(serialize))
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.BidiStreamingHandler[RequestType, ResponseType]]
    }
    ...
    inline def ClientStreamingHandler[RequestType, ResponseType](
      ...
      val __obj = js.Dynamic.literal(deserialize = js.Any.fromFunction1(deserialize), func = js.Any.fromFunction2((t0: /* call */ ServerReadableStream[RequestType, ResponseType], t1: /* callback */ sendUnaryData[ResponseType]) => (func(t0, t1)).runNow()), path = path.asInstanceOf[js.Any], serialize = js.Any.fromFunction1(serialize))
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.ClientStreamingHandler[RequestType, ResponseType]]
    }
    
    inline def ServerStreamingHandler[RequestType, ResponseType](
      deserialize: /* bytes */ Buffer => RequestType,
      func: /* call */ ServerWritableStream[RequestType, ResponseType] => Callback,
      path: String,
      serialize: ResponseType => Buffer,
      `type`: HandlerType
    ): typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.ServerStreamingHandler[RequestType, ResponseType] = {
      val __obj = js.Dynamic.literal(deserialize = js.Any.fromFunction1(deserialize), func = js.Any.fromFunction1((t0: /* call */ ServerWritableStream[RequestType, ResponseType]) => func(t0).runNow()), path = path.asInstanceOf[js.Any], serialize = js.Any.fromFunction1(serialize))
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.ServerStreamingHandler[RequestType, ResponseType]]
    }
    
    inline def UnaryHandler[RequestType, ResponseType](
      deserialize: /* bytes */ Buffer => RequestType,
      func: (/* call */ ServerUnaryCall[RequestType, ResponseType], /* callback */ sendUnaryData[ResponseType]) => Callback,
      path: String,
      serialize: ResponseType => Buffer,
      `type`: HandlerType
    ): typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.UnaryHandler[RequestType, ResponseType] = {
      val __obj = js.Dynamic.literal(deserialize = js.Any.fromFunction1(deserialize), func = js.Any.fromFunction2((t0: /* call */ ServerUnaryCall[RequestType, ResponseType], t1: /* callback */ sendUnaryData[ResponseType]) => (func(t0, t1)).runNow()), path = path.asInstanceOf[js.Any], serialize = js.Any.fromFunction1(serialize))
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcServerCallMod.UnaryHandler[RequestType, ResponseType]]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.bidi
    - typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.clientStream
    - typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.serverStream
    - typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.unary
  */
  trait HandlerType extends StObject
  object HandlerType {
    
    inline def bidi: typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.bidi = "bidi".asInstanceOf[typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.bidi]
    
    inline def clientStream: typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.clientStream = "clientStream".asInstanceOf[typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.clientStream]
    
    inline def serverStream: typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.serverStream = "serverStream".asInstanceOf[typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.serverStream]
    
    inline def unary: typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.unary = "unary".asInstanceOf[typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.unary]
  }
  ...
  object ServerStreamingHandler {
    ...
    extension [Self <: ServerStreamingHandler[?, ?], RequestType, ResponseType](x: Self & (ServerStreamingHandler[RequestType, ResponseType])) {
      ...
      inline def setFunc(value: /* call */ ServerWritableStream[RequestType, ResponseType] => Callback): Self = StObject.set(x, "func", js.Any.fromFunction1((t0: /* call */ ServerWritableStream[RequestType, ResponseType]) => value(t0).runNow()))
  ...
  object UnaryHandler {
    ...
    extension [Self <: UnaryHandler[?, ?], RequestType, ResponseType](x: Self & (UnaryHandler[RequestType, ResponseType])) {
      ...
      inline def setFunc(
        value: (/* call */ ServerUnaryCall[RequestType, ResponseType], /* callback */ sendUnaryData[ResponseType]) => Callback
      ): Self = StObject.set(x, "func", js.Any.fromFunction2((t0: /* call */ ServerUnaryCall[RequestType, ResponseType], t1: /* callback */ sendUnaryData[ResponseType]) => (value(t0, t1)).runNow()))
