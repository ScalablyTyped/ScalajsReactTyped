...
import typingsJapgolly.grpcGrpcJs.anon.PartialInterceptingListen
import typingsJapgolly.grpcGrpcJs.buildSrcCallCredentialsMod.CallCredentials
import typingsJapgolly.grpcGrpcJs.buildSrcCallStreamMod.InterceptingListener
import typingsJapgolly.grpcGrpcJs.buildSrcCallStreamMod.Listener
import typingsJapgolly.grpcGrpcJs.buildSrcCallStreamMod.MessageContext
import typingsJapgolly.grpcGrpcJs.buildSrcCallStreamMod.MessageListener
import typingsJapgolly.grpcGrpcJs.buildSrcCallStreamMod.MetadataListener
import typingsJapgolly.grpcGrpcJs.buildSrcCallStreamMod.StatusListener
import typingsJapgolly.grpcGrpcJs.buildSrcChannelMod.Channel
import typingsJapgolly.grpcGrpcJs.buildSrcClientMod.CallOptions
...
object buildSrcClientInterceptorsMod {
  ...
  object FullRequester {
    ...
    inline def apply(
      cancel: /* next */ js.Function0[Unit] => Callback,
      halfClose: /* next */ js.Function0[Unit] => Callback,
      sendMessage: (/* message */ Any, /* next */ js.Function1[/* message */ Any, Unit]) => Callback,
      start: (/* metadata */ Metadata, /* listener */ InterceptingListener, /* next */ js.Function2[/* metadata */ Metadata, /* listener */ InterceptingListener | Listener, Unit]) => Callback
    ): FullRequester = {
      val __obj = js.Dynamic.literal(cancel = js.Any.fromFunction1((t0: /* next */ js.Function0[Unit]) => cancel(t0).runNow()), halfClose = js.Any.fromFunction1((t0: /* next */ js.Function0[Unit]) => halfClose(t0).runNow()), sendMessage = js.Any.fromFunction2((t0: /* message */ Any, t1: /* next */ js.Function1[/* message */ Any, Unit]) => (sendMessage(t0, t1)).runNow()), start = js.Any.fromFunction3((t0: /* metadata */ Metadata, t1: /* listener */ InterceptingListener, t2: /* next */ js.Function2[/* metadata */ Metadata, /* listener */ InterceptingListener | Listener, Unit]) => (start(t0, t1, t2)).runNow()))
      __obj.asInstanceOf[FullRequester]
    }
    
    extension [Self <: FullRequester](x: Self) {
      
      inline def setCancel(value: /* next */ js.Function0[Unit] => Callback): Self = StObject.set(x, "cancel", js.Any.fromFunction1((t0: /* next */ js.Function0[Unit]) => value(t0).runNow()))
      
      inline def setHalfClose(value: /* next */ js.Function0[Unit] => Callback): Self = StObject.set(x, "halfClose", js.Any.fromFunction1((t0: /* next */ js.Function0[Unit]) => value(t0).runNow()))
      
      inline def setSendMessage(value: (/* message */ Any, /* next */ js.Function1[/* message */ Any, Unit]) => Callback): Self = StObject.set(x, "sendMessage", js.Any.fromFunction2((t0: /* message */ Any, t1: /* next */ js.Function1[/* message */ Any, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setStart(
        value: (/* metadata */ Metadata, /* listener */ InterceptingListener, /* next */ js.Function2[/* metadata */ Metadata, /* listener */ InterceptingListener | Listener, Unit]) => Callback
      ): Self = StObject.set(x, "start", js.Any.fromFunction3((t0: /* metadata */ Metadata, t1: /* listener */ InterceptingListener, t2: /* next */ js.Function2[/* metadata */ Metadata, /* listener */ InterceptingListener | Listener, Unit]) => (value(t0, t1, t2)).runNow()))
    }
  }
