...
import typingsJapgolly.grpcGrpcJs.anon.PartialChannelOptions
...
object buildSrcMakeClientMod {
  ...
  - typingsJapgolly.grpcGrpcJs.buildSrcMakeClientMod.ServerMethodDefinition because var conflicts: originalName, path, requestStream, responseStream. Inlined responseSerialize, responseSerialize_Original, requestDeserialize, requestDeserialize_Original */ trait MethodDefinition[RequestType, ResponseType]
    extends StObject
