...
import typingsJapgolly.grpcGrpcJs.anon.Deserialize
import typingsJapgolly.grpcGrpcJs.anon.Serialize
...
import typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.WriteCallback
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.metadata
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.status
...
object buildSrcCallMod {
  ...
  - typingsJapgolly.grpcGrpcJs.buildSrcEventsMod.EmitterAugmentation1 because Already inherited
  ...
  - typingsJapgolly.grpcGrpcJs.buildSrcCallMod.SurfaceCall because Inheritance from two classes. Inlined call, cancel, getPeer */ @JSImport("@grpc/grpc-js/build/src/call", "ClientDuplexStreamImpl")
  @js.native
  ...
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.IntermediateObjectReadable because Inheritance from two classes. Inlined 
  - typingsJapgolly.grpcGrpcJs.buildSrcEventsMod.EmitterAugmentation1 because Already inherited
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.ObjectReadable because Inheritance from two classes. Inlined read, read */ @JSImport("@grpc/grpc-js/build/src/call", "ClientReadableStreamImpl")
  @js.native
  ...
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.IntermediateObjectWritable because Inheritance from two classes. Inlined 
  - typingsJapgolly.grpcGrpcJs.buildSrcObjectStreamMod.ObjectWritable because Inheritance from two classes. Inlined _write, write, write, write, write, write, setDefaultEncoding, end, end, end, end, end, end */ @JSImport("@grpc/grpc-js/build/src/call", "ClientWritableStreamImpl")
  @js.native
