...
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.channel
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.server
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.socket
import typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.subchannel
...
object buildSrcChannelzMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_UNKNOWN
    - typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_INFO
    - typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_WARNING
    - typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_ERROR
  */
  trait TraceSeverity extends StObject
  object TraceSeverity {
    
    inline def CT_ERROR: typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_ERROR = "CT_ERROR".asInstanceOf[typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_ERROR]
    
    inline def CT_INFO: typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_INFO = "CT_INFO".asInstanceOf[typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_INFO]
    
    inline def CT_UNKNOWN: typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_UNKNOWN = "CT_UNKNOWN".asInstanceOf[typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_UNKNOWN]
    
    inline def CT_WARNING: typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_WARNING = "CT_WARNING".asInstanceOf[typingsJapgolly.grpcGrpcJs.grpcGrpcJsStrings.CT_WARNING]
  }
}
