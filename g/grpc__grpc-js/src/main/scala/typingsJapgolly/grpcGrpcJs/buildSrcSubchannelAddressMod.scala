...
object buildSrcSubchannelAddressMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grpcGrpcJs.buildSrcSubchannelAddressMod.TcpSubchannelAddress
    - typingsJapgolly.grpcGrpcJs.buildSrcSubchannelAddressMod.IpcSubchannelAddress
  */
  trait SubchannelAddress extends StObject
  object SubchannelAddress {
    
    inline def IpcSubchannelAddress(path: String): typingsJapgolly.grpcGrpcJs.buildSrcSubchannelAddressMod.IpcSubchannelAddress = {
      val __obj = js.Dynamic.literal(path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcSubchannelAddressMod.IpcSubchannelAddress]
    }
    
    inline def TcpSubchannelAddress(host: String, port: Double): typingsJapgolly.grpcGrpcJs.buildSrcSubchannelAddressMod.TcpSubchannelAddress = {
      val __obj = js.Dynamic.literal(host = host.asInstanceOf[js.Any], port = port.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.grpcGrpcJs.buildSrcSubchannelAddressMod.TcpSubchannelAddress]
    }
  }
