...
object StrokePosition extends js.Object {
  ...
  /* 0 */ val CENTER: typingsJapgolly.googlemaps.google.maps.StrokePosition.CENTER with Double = js.native
  /* 1 */ val INSIDE: typingsJapgolly.googlemaps.google.maps.StrokePosition.INSIDE with Double = js.native
  /* 2 */ val OUTSIDE: typingsJapgolly.googlemaps.google.maps.StrokePosition.OUTSIDE with Double = js.native
  @JSBracketAccess
