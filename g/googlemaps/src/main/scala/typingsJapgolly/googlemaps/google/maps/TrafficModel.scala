...
object TrafficModel extends js.Object {
  ...
  /* "bestguess" */ val BEST_GUESS: typingsJapgolly.googlemaps.google.maps.TrafficModel.BEST_GUESS with String = js.native
  /* "optimistic" */ val OPTIMISTIC: typingsJapgolly.googlemaps.google.maps.TrafficModel.OPTIMISTIC with String = js.native
  /* "pessimistic" */ val PESSIMISTIC: typingsJapgolly.googlemaps.google.maps.TrafficModel.PESSIMISTIC with String = js.native
  @JSBracketAccess
