...
object ZoomControlStyle extends js.Object {
  ...
  /* 0 */ val DEFAULT: typingsJapgolly.googlemaps.google.maps.ZoomControlStyle.DEFAULT with Double = js.native
  /* 2 */ val LARGE: typingsJapgolly.googlemaps.google.maps.ZoomControlStyle.LARGE with Double = js.native
  /* 1 */ val SMALL: typingsJapgolly.googlemaps.google.maps.ZoomControlStyle.SMALL with Double = js.native
  @JSBracketAccess
