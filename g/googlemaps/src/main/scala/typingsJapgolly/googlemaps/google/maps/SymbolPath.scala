...
object SymbolPath extends js.Object {
  ...
  /* 3 */ val BACKWARD_CLOSED_ARROW: typingsJapgolly.googlemaps.google.maps.SymbolPath.BACKWARD_CLOSED_ARROW with Double = js.native
  /* 4 */ val BACKWARD_OPEN_ARROW: typingsJapgolly.googlemaps.google.maps.SymbolPath.BACKWARD_OPEN_ARROW with Double = js.native
  /* 0 */ val CIRCLE: typingsJapgolly.googlemaps.google.maps.SymbolPath.CIRCLE with Double = js.native
  /* 1 */ val FORWARD_CLOSED_ARROW: typingsJapgolly.googlemaps.google.maps.SymbolPath.FORWARD_CLOSED_ARROW with Double = js.native
  /* 2 */ val FORWARD_OPEN_ARROW: typingsJapgolly.googlemaps.google.maps.SymbolPath.FORWARD_OPEN_ARROW with Double = js.native
  @JSBracketAccess
