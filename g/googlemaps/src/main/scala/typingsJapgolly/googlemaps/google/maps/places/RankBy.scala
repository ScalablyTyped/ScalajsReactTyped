...
object RankBy extends js.Object {
  ...
  /* 1 */ val DISTANCE: typingsJapgolly.googlemaps.google.maps.places.RankBy.DISTANCE with Double = js.native
  /* 0 */ val PROMINENCE: typingsJapgolly.googlemaps.google.maps.places.RankBy.PROMINENCE with Double = js.native
  @JSBracketAccess
