...
object StreetViewPreference extends js.Object {
  ...
  /* "best" */ val BEST: typingsJapgolly.googlemaps.google.maps.StreetViewPreference.BEST with String = js.native
  /* "nearest" */ val NEAREST: typingsJapgolly.googlemaps.google.maps.StreetViewPreference.NEAREST with String = js.native
  @JSBracketAccess
