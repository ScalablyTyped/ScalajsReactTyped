...
object MapsEngineStatus extends js.Object {
  ...
  /* "INVALID_LAYER" */ val INVALID_LAYER: typingsJapgolly.googlemaps.google.maps.visualization.MapsEngineStatus.INVALID_LAYER with String = js.native
  /* "OK" */ val OK: typingsJapgolly.googlemaps.google.maps.visualization.MapsEngineStatus.OK with String = js.native
  /* "UNKNOWN_ERROR" */ val UNKNOWN_ERROR: typingsJapgolly.googlemaps.google.maps.visualization.MapsEngineStatus.UNKNOWN_ERROR with String = js.native
  @JSBracketAccess
