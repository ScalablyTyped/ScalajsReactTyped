...
object TransitRoutePreference extends js.Object {
  ...
  /* "FEWER_TRANSFERS" */ val FEWER_TRANSFERS: typingsJapgolly.googlemaps.google.maps.TransitRoutePreference.FEWER_TRANSFERS with String = js.native
  /* "LESS_WALKING" */ val LESS_WALKING: typingsJapgolly.googlemaps.google.maps.TransitRoutePreference.LESS_WALKING with String = js.native
  @JSBracketAccess
