...
object UnitSystem extends js.Object {
  ...
  /* 1 */ val IMPERIAL: typingsJapgolly.googlemaps.google.maps.UnitSystem.IMPERIAL with Double = js.native
  /* 0 */ val METRIC: typingsJapgolly.googlemaps.google.maps.UnitSystem.METRIC with Double = js.native
  @JSBracketAccess
