...
object StreetViewSource extends js.Object {
  ...
  /* "default" */ val DEFAULT: typingsJapgolly.googlemaps.google.maps.StreetViewSource.DEFAULT with String = js.native
  /* "outdoor" */ val OUTDOOR: typingsJapgolly.googlemaps.google.maps.StreetViewSource.OUTDOOR with String = js.native
  @JSBracketAccess
