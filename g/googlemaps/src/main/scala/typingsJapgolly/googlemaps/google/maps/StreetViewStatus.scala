...
object StreetViewStatus extends js.Object {
  ...
  /* "OK" */ val OK: typingsJapgolly.googlemaps.google.maps.StreetViewStatus.OK with String = js.native
  /* "UNKNOWN_ERROR" */ val UNKNOWN_ERROR: typingsJapgolly.googlemaps.google.maps.StreetViewStatus.UNKNOWN_ERROR with String = js.native
  /* "ZERO_RESULTS" */ val ZERO_RESULTS: typingsJapgolly.googlemaps.google.maps.StreetViewStatus.ZERO_RESULTS with String = js.native
  @JSBracketAccess
