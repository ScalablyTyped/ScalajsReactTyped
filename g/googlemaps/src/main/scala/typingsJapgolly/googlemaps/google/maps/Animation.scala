...
object Animation extends js.Object {
  ...
  /* 1 */ val BOUNCE: typingsJapgolly.googlemaps.google.maps.Animation.BOUNCE with Double = js.native
  /* 2 */ val DROP: typingsJapgolly.googlemaps.google.maps.Animation.DROP with Double = js.native
  @JSBracketAccess
