package typingsJapgolly.gensync
...
object mod {
  ...
  object ErrbackOptions {
    ...
    inline def apply[A /* <: js.Array[Any] */, R, E](
      async: Unit,
      errback: /* import warning: importer.ImportType#apply c repeated non-array type: A */ js.Array[A] => japgolly.scalajs.react.Callback,
      sync: /* args */ A => R
    ): ErrbackOptions[A, R, E] = {
      val __obj = js.Dynamic.literal(async = async.asInstanceOf[js.Any], errback = js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply c repeated non-array type: A */ js.Array[A]) => errback(t0).runNow()), sync = js.Any.fromFunction1(sync))
    ...
    extension [Self <: ErrbackOptions[?, ?, ?], A /* <: js.Array[Any] */, R, E](x: Self & (ErrbackOptions[A, R, E])) {
      ...
      inline def setErrback(
        value: /* import warning: importer.ImportType#apply c repeated non-array type: A */ js.Array[A] => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "errback", js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply c repeated non-array type: A */ js.Array[A]) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gensync.mod.SyncOptions[A, R]
    - typingsJapgolly.gensync.mod.AsyncOptions[A, R]
    - typingsJapgolly.gensync.mod.ErrbackOptions[A, R, E]
  */
  trait Options[A /* <: js.Array[Any] */, R, E] extends StObject
  object Options {
    
    inline def AsyncOptions[A /* <: js.Array[Any] */, R](async: A => js.Promise[R], errback: Unit, sync: A => R): typingsJapgolly.gensync.mod.AsyncOptions[A, R] = {
      val __obj = js.Dynamic.literal(async = js.Any.fromFunction1(async), errback = errback.asInstanceOf[js.Any], sync = js.Any.fromFunction1(sync))
      __obj.asInstanceOf[typingsJapgolly.gensync.mod.AsyncOptions[A, R]]
    }
    ...
    inline def ErrbackOptions[A /* <: js.Array[Any] */, R, E](
      ...
      val __obj = js.Dynamic.literal(async = async.asInstanceOf[js.Any], errback = js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply c repeated non-array type: A */ js.Array[A]) => errback(t0).runNow()), sync = js.Any.fromFunction1(sync))
      __obj.asInstanceOf[typingsJapgolly.gensync.mod.ErrbackOptions[A, R, E]]
    }
    
    inline def SyncOptions[A /* <: js.Array[Any] */, R](async: Unit, errback: Unit, sync: A => R): typingsJapgolly.gensync.mod.SyncOptions[A, R] = {
      ...
      __obj.asInstanceOf[typingsJapgolly.gensync.mod.SyncOptions[A, R]]
    }
  }
