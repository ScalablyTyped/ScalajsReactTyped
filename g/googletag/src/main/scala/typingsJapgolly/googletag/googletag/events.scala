...
object events {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.googletag.googletagStrings.impressionViewable
    - typingsJapgolly.googletag.googletagStrings.rewardedSlotClosed
    - typingsJapgolly.googletag.googletagStrings.rewardedSlotGranted
    - typingsJapgolly.googletag.googletagStrings.rewardedSlotReady
    - typingsJapgolly.googletag.googletagStrings.slotOnload
    - typingsJapgolly.googletag.googletagStrings.slotRenderEnded
    - typingsJapgolly.googletag.googletagStrings.slotRequested
    - typingsJapgolly.googletag.googletagStrings.slotResponseReceived
    - typingsJapgolly.googletag.googletagStrings.slotVisibilityChanged
  */
  ...
  object RewardedSlotReadyEvent {
    ...
    inline def apply(makeRewardedVisible: Callback, serviceName: String, slot: Slot): RewardedSlotReadyEvent = {
      val __obj = js.Dynamic.literal(makeRewardedVisible = makeRewardedVisible.toJsFn, serviceName = serviceName.asInstanceOf[js.Any], slot = slot.asInstanceOf[js.Any])
      __obj.asInstanceOf[RewardedSlotReadyEvent]
    }
    
    extension [Self <: RewardedSlotReadyEvent](x: Self) {
      
      inline def setMakeRewardedVisible(value: Callback): Self = StObject.set(x, "makeRewardedVisible", value.toJsFn)
    }
  }
