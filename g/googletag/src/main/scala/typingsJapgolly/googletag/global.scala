...
import typingsJapgolly.googletag.googletag.CommandArray
import typingsJapgolly.googletag.googletag.CompanionAdsService
import typingsJapgolly.googletag.googletag.GeneralSize
import typingsJapgolly.googletag.googletag.PubAdsService
import typingsJapgolly.googletag.googletag.SizeMappingBuilder
import typingsJapgolly.googletag.googletag.Slot
import typingsJapgolly.googletag.googletag.enums.OutOfPageFormat
  ...
  object googletag {
    ...
    object enums {
      ...
      object OutOfPageFormat extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.googletag.googletag.enums.OutOfPageFormat & Double] = js.native
        
        /* 0 */ val BOTTOM_ANCHOR: typingsJapgolly.googletag.googletag.enums.OutOfPageFormat.BOTTOM_ANCHOR & Double = js.native
        
        /* 1 */ val INTERSTITIAL: typingsJapgolly.googletag.googletag.enums.OutOfPageFormat.INTERSTITIAL & Double = js.native
        
        /* 2 */ val REWARDED: typingsJapgolly.googletag.googletag.enums.OutOfPageFormat.REWARDED & Double = js.native
        
        /* 3 */ val TOP_ANCHOR: typingsJapgolly.googletag.googletag.enums.OutOfPageFormat.TOP_ANCHOR & Double = js.native
      }
      ...
      object TrafficSource extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.googletag.googletag.enums.TrafficSource & Double] = js.native
        
        /* 0 */ val ORGANIC: typingsJapgolly.googletag.googletag.enums.TrafficSource.ORGANIC & Double = js.native
        
        /* 1 */ val PURCHASED: typingsJapgolly.googletag.googletag.enums.TrafficSource.PURCHASED & Double = js.native
      }
    }
