package typingsJapgolly.googletag
...
object anon {
  ...
  trait AuctionSignals extends StObject {
    ...
    var decisionLogicUrl: js.UndefOr[String] = js.undefined
  ...
  object AuctionSignals {
    ...
    inline def apply(): AuctionSignals = {
    ...
    extension [Self <: AuctionSignals](x: Self) {
      ...
      inline def setDecisionLogicUrlUndefined: Self = StObject.set(x, "decisionLogicUrl", js.undefined)
  ...
  /* Inlined std.Record<'vid' | 'cmsid', string> */
  trait Recordvidcmsidstring extends StObject {
    
    var cmsid: String
    
    var vid: String
  }
  object Recordvidcmsidstring {
    
    inline def apply(cmsid: String, vid: String): Recordvidcmsidstring = {
      val __obj = js.Dynamic.literal(cmsid = cmsid.asInstanceOf[js.Any], vid = vid.asInstanceOf[js.Any])
      __obj.asInstanceOf[Recordvidcmsidstring]
    }
    
    extension [Self <: Recordvidcmsidstring](x: Self) {
      
      inline def setCmsid(value: String): Self = StObject.set(x, "cmsid", value.asInstanceOf[js.Any])
