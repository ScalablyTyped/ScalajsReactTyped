...
import typingsJapgolly.graphqlPlaygroundHtml.distRenderPlaygroundPageMod.CursorShape
import typingsJapgolly.graphqlPlaygroundHtml.distRenderPlaygroundPageMod.Theme
