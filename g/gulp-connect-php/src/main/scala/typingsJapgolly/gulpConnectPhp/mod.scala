package typingsJapgolly.gulpConnectPhp

import typingsJapgolly.gulpConnectPhp.gulpConnectPhpStrings.php_args
import typingsJapgolly.gulpConnectPhp.gulpConnectPhpStrings.spawn
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gulpConnectPhp.gulpConnectPhpStrings.spawn
    - typingsJapgolly.gulpConnectPhp.gulpConnectPhpStrings.php_args
  */
  trait ConfigCallbackType extends StObject
  object ConfigCallbackType {
    
    inline def php_args: typingsJapgolly.gulpConnectPhp.gulpConnectPhpStrings.php_args = "php_args".asInstanceOf[typingsJapgolly.gulpConnectPhp.gulpConnectPhpStrings.php_args]
    
    inline def spawn: typingsJapgolly.gulpConnectPhp.gulpConnectPhpStrings.spawn = "spawn".asInstanceOf[typingsJapgolly.gulpConnectPhp.gulpConnectPhpStrings.spawn]
  }
