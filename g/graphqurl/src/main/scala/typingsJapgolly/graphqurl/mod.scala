...
import typingsJapgolly.graphqurl.anon.Endpoint
...
object mod {
  ...
  object SubscriptionOptions {
    ...
    extension [Self <: SubscriptionOptions](x: Self) {
      ...
      inline def setOnGraphQLComplete(value: Callback): Self = StObject.set(x, "onGraphQLComplete", value.toJsFn)
      
      inline def setOnGraphQLCompleteUndefined: Self = StObject.set(x, "onGraphQLComplete", js.undefined)
      
      inline def setOnGraphQLData(value: /* response */ Response => Callback): Self = StObject.set(x, "onGraphQLData", js.Any.fromFunction1((t0: /* response */ Response) => value(t0).runNow()))
      
      inline def setOnGraphQLDataUndefined: Self = StObject.set(x, "onGraphQLData", js.undefined)
      
      inline def setOnGraphQLError(value: /* error */ Any => Callback): Self = StObject.set(x, "onGraphQLError", js.Any.fromFunction1((t0: /* error */ Any) => value(t0).runNow()))
