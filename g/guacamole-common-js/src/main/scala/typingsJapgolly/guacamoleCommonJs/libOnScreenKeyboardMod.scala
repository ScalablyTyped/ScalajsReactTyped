...
object libOnScreenKeyboardMod {
  ...
  object OnScreenKeyboard {
    ...
    type Key = Instantiable2[
        /* template */ typingsJapgolly.guacamoleCommonJs.libOnScreenKeyboardMod.Key, 
        /* name */ js.UndefOr[String], 
        typingsJapgolly.guacamoleCommonJs.libOnScreenKeyboardMod.Key
      ]
    
    type Layout = Instantiable1[
        /* template */ typingsJapgolly.guacamoleCommonJs.libOnScreenKeyboardMod.Layout, 
        typingsJapgolly.guacamoleCommonJs.libOnScreenKeyboardMod.Layout
      ]
  }
