...
open class AudioPlayer ()
  extends typingsJapgolly.guacamoleCommonJs.libAudioPlayerMod.AudioPlayer
/* static members */
object AudioPlayer {
  ...
  /**
    ...
    */
  inline def getInstance(stream: typingsJapgolly.guacamoleCommonJs.libInputStreamMod.InputStream, mimetype: Mimetype): typingsJapgolly.guacamoleCommonJs.libAudioPlayerMod.AudioPlayer | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")(stream.asInstanceOf[js.Any], mimetype.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.guacamoleCommonJs.libAudioPlayerMod.AudioPlayer | Null]
