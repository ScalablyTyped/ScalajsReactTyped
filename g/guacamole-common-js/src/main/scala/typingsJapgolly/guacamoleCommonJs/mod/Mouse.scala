...
open class Mouse protected ()
  extends typingsJapgolly.guacamoleCommonJs.libMouseMod.Mouse {
  /**
...
object Mouse {
  ...
  open class GuacTouchDevice protected ()
    extends typingsJapgolly.guacamoleCommonJs.libMouseMod.Mouse.GuacTouchDevice {
    /**
  ...
  open class State protected ()
    extends typingsJapgolly.guacamoleCommonJs.libMouseMod.Mouse.State {
    /**
  ...
  open class Touchpad protected ()
    extends typingsJapgolly.guacamoleCommonJs.libMouseMod.Mouse.Touchpad {
    /**
      * @param element The Element to use to provide touch events.
      */
    def this(element: HTMLElement) = this()
  ...
  open class Touchscreen protected ()
    extends typingsJapgolly.guacamoleCommonJs.libMouseMod.Mouse.Touchscreen {
    /**
      * @param element The Element to use to provide touch events.
      */
    def this(element: HTMLElement) = this()
