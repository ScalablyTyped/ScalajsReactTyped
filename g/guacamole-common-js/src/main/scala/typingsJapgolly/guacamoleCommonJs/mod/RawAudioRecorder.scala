...
open class RawAudioRecorder protected ()
  extends typingsJapgolly.guacamoleCommonJs.libRawAudioRecorderMod.RawAudioRecorder {
  /**
    ...
    */
  def this(stream: typingsJapgolly.guacamoleCommonJs.libOutputStreamMod.OutputStream, mimetype: Mimetype) = this()
}
/* static members */
object RawAudioRecorder {
  ...
  @JSImport("guacamole-common-js", "RawAudioRecorder.isSupportedType")
  @js.native
