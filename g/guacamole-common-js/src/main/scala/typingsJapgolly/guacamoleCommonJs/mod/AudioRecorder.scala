...
open class AudioRecorder ()
  extends typingsJapgolly.guacamoleCommonJs.libAudioRecorderMod.AudioRecorder
/* static members */
object AudioRecorder {
  ...
  /**
    ...
    */
  inline def getInstance(stream: typingsJapgolly.guacamoleCommonJs.libOutputStreamMod.OutputStream, mimetype: Mimetype): typingsJapgolly.guacamoleCommonJs.libAudioRecorderMod.AudioRecorder | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")(stream.asInstanceOf[js.Any], mimetype.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.guacamoleCommonJs.libAudioRecorderMod.AudioRecorder | Null]
