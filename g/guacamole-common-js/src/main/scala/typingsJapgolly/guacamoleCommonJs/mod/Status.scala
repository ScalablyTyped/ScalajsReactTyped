...
open class Status protected ()
  extends typingsJapgolly.guacamoleCommonJs.libStatusMod.Status {
  /**
...
object Status {
  ...
  object Code {
    ...
    inline def fromHTTPCode(status: Double): typingsJapgolly.guacamoleCommonJs.libStatusMod.Status.Code = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHTTPCode")(status.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.guacamoleCommonJs.libStatusMod.Status.Code]
    
    inline def fromWebSocketCode(code: Double): typingsJapgolly.guacamoleCommonJs.libStatusMod.Status.Code = ^.asInstanceOf[js.Dynamic].applyDynamic("fromWebSocketCode")(code.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.guacamoleCommonJs.libStatusMod.Status.Code]
  }
}
