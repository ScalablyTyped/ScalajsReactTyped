...
open class RawAudioPlayer protected ()
  extends typingsJapgolly.guacamoleCommonJs.libRawAudioPlayerMod.RawAudioPlayer {
  /**
    ...
    */
  def this(stream: typingsJapgolly.guacamoleCommonJs.libInputStreamMod.InputStream, mimetype: Mimetype) = this()
}
/* static members */
