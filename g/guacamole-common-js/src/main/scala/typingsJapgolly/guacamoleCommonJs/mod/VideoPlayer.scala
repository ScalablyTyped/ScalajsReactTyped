...
open class VideoPlayer ()
  extends typingsJapgolly.guacamoleCommonJs.libVideoPlayerMod.VideoPlayer
/* static members */
object VideoPlayer {
  ...
  inline def getInstance(
    stream: typingsJapgolly.guacamoleCommonJs.libInputStreamMod.InputStream,
    layer: typingsJapgolly.guacamoleCommonJs.libVisibleLayerMod.VisibleLayer,
    mimetype: MimeType
  ): typingsJapgolly.guacamoleCommonJs.libVideoPlayerMod.VideoPlayer | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")(stream.asInstanceOf[js.Any], layer.asInstanceOf[js.Any], mimetype.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.guacamoleCommonJs.libVideoPlayerMod.VideoPlayer | Null]
