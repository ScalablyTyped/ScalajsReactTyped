...
import typingsJapgolly.guacamoleCommonJs.libAudioRecorderMod.AudioRecorder
...
object libRawAudioRecorderMod {
  
  @JSImport("guacamole-common-js/lib/RawAudioRecorder", "RawAudioRecorder")
  @js.native
  ...
  object RawAudioRecorder {
    ...
    @JSImport("guacamole-common-js/lib/RawAudioRecorder", "RawAudioRecorder.isSupportedType")
    @js.native
