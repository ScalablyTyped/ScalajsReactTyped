...
import typingsJapgolly.guacamoleCommonJs.libGuacCommonMod.TypedArray
...
object libArrayBufferWriterMod {
  ...
  @JSImport("guacamole-common-js/lib/ArrayBufferWriter", "ArrayBufferWriter")
  @js.native
  ...
  object ArrayBufferWriter {
    ...
    /**
      ...
      * instances.
      */
    @JSImport("guacamole-common-js/lib/ArrayBufferWriter", "ArrayBufferWriter.DEFAULT_BLOB_LENGTH")
    @js.native
