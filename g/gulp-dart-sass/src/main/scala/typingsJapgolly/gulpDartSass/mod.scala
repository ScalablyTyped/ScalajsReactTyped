package typingsJapgolly.gulpDartSass

import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.gulpDartSass.anon.Duration
import typingsJapgolly.gulpDartSass.gulpDartSassStrings.async
import typingsJapgolly.gulpDartSass.gulpDartSassStrings.sync
