...
object PlacePhotoRequest {
  ...
  inline def apply(photoreference: String): PlacePhotoRequest = {
  ...
  extension [Self <: PlacePhotoRequest](x: Self) {
    ...
    inline def setPhotoreference(value: String): Self = StObject.set(x, "photoreference", value.asInstanceOf[js.Any])
  }
}
