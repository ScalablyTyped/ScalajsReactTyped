package typingsJapgolly.graygelf

import org.scalablytyped.runtime.StringDictionary
import org.scalajs.dom.Event
import typingsJapgolly.graygelf.anon.A
import typingsJapgolly.graygelf.anon.AlwaysCompress
import typingsJapgolly.graygelf.anon.Dictkey
import typingsJapgolly.graygelf.anon.Facility
import typingsJapgolly.graygelf.graygelfInts.`0`
import typingsJapgolly.graygelf.graygelfInts.`1240`
import typingsJapgolly.graygelf.graygelfInts.`1`
import typingsJapgolly.graygelf.graygelfInts.`2`
import typingsJapgolly.graygelf.graygelfInts.`3`
import typingsJapgolly.graygelf.graygelfInts.`4`
import typingsJapgolly.graygelf.graygelfInts.`5`
import typingsJapgolly.graygelf.graygelfInts.`6`
import typingsJapgolly.graygelf.graygelfInts.`7`
import typingsJapgolly.graygelf.graygelfInts.`8154`
import typingsJapgolly.graygelf.graygelfStrings.deflate
import typingsJapgolly.graygelf.graygelfStrings.error
import typingsJapgolly.graygelf.graygelfStrings.gzip
import typingsJapgolly.graygelf.graygelfStrings.message
...
object mod {
  ...
  open class ^ ()
    extends StObject
       with typingsJapgolly.graygelf.mod.graygelf {
    def this(setup: typingsJapgolly.graygelf.mod.setup) = this()
  }
  @JSImport("graygelf", JSImport.Namespace)
  @js.native
  ...
  /* key */ StringDictionary[js.UndefOr[String | Double]] {
    ...
    var level: js.UndefOr[
        `0` | `1` | `2` | `3` | `4` | `5` | `6` | `7` | typingsJapgolly.graygelf.graygelfStrings.`0` | typingsJapgolly.graygelf.graygelfStrings.`1` | typingsJapgolly.graygelf.graygelfStrings.`2` | typingsJapgolly.graygelf.graygelfStrings.`3` | typingsJapgolly.graygelf.graygelfStrings.`4` | typingsJapgolly.graygelf.graygelfStrings.`5` | typingsJapgolly.graygelf.graygelfStrings.`6` | typingsJapgolly.graygelf.graygelfStrings.`7`
      ] = js.undefined
  ...
  object GelfMessage {
    ...
    extension [Self <: GelfMessage](x: Self) {
      ...
      inline def setLevel(
        value: `0` | `1` | `2` | `3` | `4` | `5` | `6` | `7` | typingsJapgolly.graygelf.graygelfStrings.`0` | typingsJapgolly.graygelf.graygelfStrings.`1` | typingsJapgolly.graygelf.graygelfStrings.`2` | typingsJapgolly.graygelf.graygelfStrings.`3` | typingsJapgolly.graygelf.graygelfStrings.`4` | typingsJapgolly.graygelf.graygelfStrings.`5` | typingsJapgolly.graygelf.graygelfStrings.`6` | typingsJapgolly.graygelf.graygelfStrings.`7`
  ...
  trait Instance extends StObject {
    ...
    @JSName("on")
    var on_Original: typingsJapgolly.std.EventListener = js.native
    
    def once(evt: Event): Unit = js.native
    @JSName("once")
    var once_Original: typingsJapgolly.std.EventListener = js.native
