...
object people {
  ...
  object connections {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.gapiPeople.gapiPeopleStrings.LAST_MODIFIED_ASCENDING
      - typingsJapgolly.gapiPeople.gapiPeopleStrings.FIRST_NAME_ASCENDING
      - typingsJapgolly.gapiPeople.gapiPeopleStrings.LAST_NAME_ASCENDING
    */
    trait SortOrder extends StObject
    object SortOrder {
      
      inline def FIRST_NAME_ASCENDING: typingsJapgolly.gapiPeople.gapiPeopleStrings.FIRST_NAME_ASCENDING = "FIRST_NAME_ASCENDING".asInstanceOf[typingsJapgolly.gapiPeople.gapiPeopleStrings.FIRST_NAME_ASCENDING]
      
      inline def LAST_MODIFIED_ASCENDING: typingsJapgolly.gapiPeople.gapiPeopleStrings.LAST_MODIFIED_ASCENDING = "LAST_MODIFIED_ASCENDING".asInstanceOf[typingsJapgolly.gapiPeople.gapiPeopleStrings.LAST_MODIFIED_ASCENDING]
      
      inline def LAST_NAME_ASCENDING: typingsJapgolly.gapiPeople.gapiPeopleStrings.LAST_NAME_ASCENDING = "LAST_NAME_ASCENDING".asInstanceOf[typingsJapgolly.gapiPeople.gapiPeopleStrings.LAST_NAME_ASCENDING]
    }
  }
}
