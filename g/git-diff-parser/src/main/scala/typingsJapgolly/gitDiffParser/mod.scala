...
import typingsJapgolly.gitDiffParser.gitDiffParserBooleans.`false`
import typingsJapgolly.gitDiffParser.gitDiffParserBooleans.`true`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gitDiffParser.gitDiffParserStrings.deleted
    - typingsJapgolly.gitDiffParser.gitDiffParserStrings.added
    - typingsJapgolly.gitDiffParser.gitDiffParserStrings.normal
  */
  trait LineType extends StObject
  object LineType {
    
    inline def added: typingsJapgolly.gitDiffParser.gitDiffParserStrings.added = "added".asInstanceOf[typingsJapgolly.gitDiffParser.gitDiffParserStrings.added]
    
    inline def deleted: typingsJapgolly.gitDiffParser.gitDiffParserStrings.deleted = "deleted".asInstanceOf[typingsJapgolly.gitDiffParser.gitDiffParserStrings.deleted]
    
    inline def normal: typingsJapgolly.gitDiffParser.gitDiffParserStrings.normal = "normal".asInstanceOf[typingsJapgolly.gitDiffParser.gitDiffParserStrings.normal]
  }
