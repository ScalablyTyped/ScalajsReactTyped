package typingsJapgolly.googlePublisherTag

import org.scalajs.dom.Element
import typingsJapgolly.googlePublisherTag.googletag.CommandArray
import typingsJapgolly.googlePublisherTag.googletag.CompanionAdsService
import typingsJapgolly.googlePublisherTag.googletag.GeneralSize
import typingsJapgolly.googlePublisherTag.googletag.PubAdsService
import typingsJapgolly.googlePublisherTag.googletag.SizeMappingBuilder
import typingsJapgolly.googlePublisherTag.googletag.Slot
import typingsJapgolly.googlePublisherTag.googletag.enums.OutOfPageFormat
  ...
  object googletag {
    ...
    object enums {
      ...
      object OutOfPageFormat extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.googlePublisherTag.googletag.enums.OutOfPageFormat & Double] = js.native
        
        /* 1 */ val BOTTOM_ANCHOR: typingsJapgolly.googlePublisherTag.googletag.enums.OutOfPageFormat.BOTTOM_ANCHOR & Double = js.native
        
        /* 2 */ val INTERSTITIAL: typingsJapgolly.googlePublisherTag.googletag.enums.OutOfPageFormat.INTERSTITIAL & Double = js.native
        
        /* 3 */ val REWARDED: typingsJapgolly.googlePublisherTag.googletag.enums.OutOfPageFormat.REWARDED & Double = js.native
        
        /* 0 */ val TOP_ANCHOR: typingsJapgolly.googlePublisherTag.googletag.enums.OutOfPageFormat.TOP_ANCHOR & Double = js.native
      }
      ...
      object TrafficSource extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.googlePublisherTag.googletag.enums.TrafficSource & Double] = js.native
        
        /* 1 */ val ORGANIC: typingsJapgolly.googlePublisherTag.googletag.enums.TrafficSource.ORGANIC & Double = js.native
        
        /* 0 */ val PURCHASED: typingsJapgolly.googlePublisherTag.googletag.enums.TrafficSource.PURCHASED & Double = js.native
      }
    }
