...
open class List[T] () extends Iterable[T] {
  ...
  def addAll(coll: js.Array[T]): typingsJapgolly.go.mod.List[T] = js.native
  /**
    ...
    */
  def addAll(coll: Iterable[T]): typingsJapgolly.go.mod.List[T] = js.native
  ...
  /**
    ...
    */
  def concat[S](it: Iterable[S]): typingsJapgolly.go.mod.List[S | T] = js.native
  ...
  /**
    ...
    */
  def copy(): typingsJapgolly.go.mod.List[T] = js.native
  ...
  /**
    ...
    */
  def filter(pred: js.Function1[/* x */ T, Boolean]): typingsJapgolly.go.mod.List[T] = js.native
  ...
  /**
    ...
    */
  def map[S](func: js.Function1[/* x */ T, S]): typingsJapgolly.go.mod.List[S] = js.native
  ...
  /**
    ...
    */
  def reverse(): typingsJapgolly.go.mod.List[T] = js.native
  ...
  /**
    ...
    */
  def sort(sortfunc: js.Function2[/* a */ T, /* b */ T, Double]): typingsJapgolly.go.mod.List[T] = js.native
