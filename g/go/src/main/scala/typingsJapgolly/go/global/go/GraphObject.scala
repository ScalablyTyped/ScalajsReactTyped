...
import typingsJapgolly.go.mod.Constructor
...
open class GraphObject ()
  extends typingsJapgolly.go.mod.GraphObject
object GraphObject {
  ...
  @js.native
  def Fill: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Fill_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Fill")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Horizontal: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Horizontal_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Horizontal")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Uniform: typingsJapgolly.go.mod.EnumValue = js.native
  ...
  @js.native
  def UniformToFill: typingsJapgolly.go.mod.EnumValue = js.native
  inline def UniformToFill_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UniformToFill")(x.asInstanceOf[js.Any])
  
  inline def Uniform_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Uniform")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Vertical: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Vertical_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Vertical")(x.asInstanceOf[js.Any])
  ...
  // undocumented
  /* static member */
  inline def getBuilders(): typingsJapgolly.go.mod.Map[String, js.Function1[/* args */ js.Array[Any], js.Object]] = ^.asInstanceOf[js.Dynamic].applyDynamic("getBuilders")().asInstanceOf[typingsJapgolly.go.mod.Map[String, js.Function1[/* args */ js.Array[Any], js.Object]]]
