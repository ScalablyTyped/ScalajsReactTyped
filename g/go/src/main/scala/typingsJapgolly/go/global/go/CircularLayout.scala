...
open class CircularLayout ()
  extends typingsJapgolly.go.mod.CircularLayout
object CircularLayout {
  ...
  @js.native
  def BidirectionalLeft: typingsJapgolly.go.mod.EnumValue = js.native
  inline def BidirectionalLeft_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BidirectionalLeft")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def BidirectionalRight: typingsJapgolly.go.mod.EnumValue = js.native
  inline def BidirectionalRight_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("BidirectionalRight")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Circular: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Circular_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Circular")(x.asInstanceOf[js.Any])
  
  /**Rings are filled clockwise; This value is used for CircularLayout.direction.*/
  /* static member */
  @JSGlobal("go.CircularLayout.Clockwise")
  @js.native
  def Clockwise: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Clockwise_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Clockwise")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def ConstantAngle: typingsJapgolly.go.mod.EnumValue = js.native
  inline def ConstantAngle_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ConstantAngle")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def ConstantDistance: typingsJapgolly.go.mod.EnumValue = js.native
  inline def ConstantDistance_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ConstantDistance")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def ConstantSpacing: typingsJapgolly.go.mod.EnumValue = js.native
  inline def ConstantSpacing_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ConstantSpacing")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Counterclockwise: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Counterclockwise_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Counterclockwise")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Forwards: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Forwards_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Forwards")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Optimized: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Optimized_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Optimized")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Packed: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Packed_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Packed")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Pythagorean: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Pythagorean_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Pythagorean")(x.asInstanceOf[js.Any])
