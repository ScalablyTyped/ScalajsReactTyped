...
/**
  ...
  */
open class Diagram ()
  extends typingsJapgolly.go.mod.Diagram {
...
object Diagram {
  ...
  @js.native
  def AllParentsCollapsed: typingsJapgolly.go.mod.EnumValue = js.native
  inline def AllParentsCollapsed_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("AllParentsCollapsed")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def CycleAll: typingsJapgolly.go.mod.EnumValue = js.native
  inline def CycleAll_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CycleAll")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def CycleDestinationTree: typingsJapgolly.go.mod.EnumValue = js.native
  inline def CycleDestinationTree_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CycleDestinationTree")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def CycleNotDirected: typingsJapgolly.go.mod.EnumValue = js.native
  inline def CycleNotDirected_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CycleNotDirected")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def CycleNotUndirected: typingsJapgolly.go.mod.EnumValue = js.native
  inline def CycleNotUndirected_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CycleNotUndirected")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def CycleSourceTree: typingsJapgolly.go.mod.EnumValue = js.native
  inline def CycleSourceTree_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CycleSourceTree")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def DocumentScroll: typingsJapgolly.go.mod.EnumValue = js.native
  inline def DocumentScroll_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DocumentScroll")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def InfiniteScroll: typingsJapgolly.go.mod.EnumValue = js.native
  inline def InfiniteScroll_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("InfiniteScroll")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def TreeParentCollapsed: typingsJapgolly.go.mod.EnumValue = js.native
  inline def TreeParentCollapsed_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TreeParentCollapsed")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  /* static member */
  inline def fromDiv(div: HTMLDivElement): typingsJapgolly.go.mod.Diagram = ^.asInstanceOf[js.Dynamic].applyDynamic("fromDiv")(div.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.go.mod.Diagram]
