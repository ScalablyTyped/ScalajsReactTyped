...
open class TextBlock ()
  extends typingsJapgolly.go.mod.TextBlock
object TextBlock {
  ...
  @js.native
  def OverflowClip: typingsJapgolly.go.mod.EnumValue = js.native
  inline def OverflowClip_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OverflowClip")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def OverflowEllipsis: typingsJapgolly.go.mod.EnumValue = js.native
  inline def OverflowEllipsis_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OverflowEllipsis")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def WrapDesiredSize: typingsJapgolly.go.mod.EnumValue = js.native
  inline def WrapDesiredSize_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WrapDesiredSize")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def WrapFit: typingsJapgolly.go.mod.EnumValue = js.native
  inline def WrapFit_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WrapFit")(x.asInstanceOf[js.Any])
