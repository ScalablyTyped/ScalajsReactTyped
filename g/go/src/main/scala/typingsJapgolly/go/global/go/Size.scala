...
/**
  ...
  */
open class Size ()
  extends typingsJapgolly.go.mod.Size {
  /**
...
object Size {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(str: String): typingsJapgolly.go.mod.Size = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.go.mod.Size]
  ...
  /**
    ...
    */
  /* static member */
  inline def stringify(`val`: typingsJapgolly.go.mod.Size): String = ^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
}
