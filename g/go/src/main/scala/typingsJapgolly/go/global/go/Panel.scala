...
/**
  ...
  */
open class Panel ()
  extends typingsJapgolly.go.mod.Panel {
...
object Panel {
  ...
  @js.native
  def Auto: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Auto_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Auto")(x.asInstanceOf[js.Any])
  
  /**This value for .type is used to draw regular patterns of lines.*/
  /* static member */
  @JSGlobal("go.Panel.Grid")
  @js.native
  def Grid: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Grid_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Grid")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Link: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Link_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Link")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Spot: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Spot_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Spot")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Table: typingsJapgolly.go.mod.EnumValue = js.native
  
  /**Organizational Panel type that is only valid inside of a Table panel.*/
  /* static member */
  @JSGlobal("go.Panel.TableColumn")
  @js.native
  def TableColumn: typingsJapgolly.go.mod.EnumValue = js.native
  inline def TableColumn_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TableColumn")(x.asInstanceOf[js.Any])
  
  /**Organizational Panel type that is only valid inside of a Table panel.*/
  /* static member */
  @JSGlobal("go.Panel.TableRow")
  @js.native
  def TableRow: typingsJapgolly.go.mod.EnumValue = js.native
  inline def TableRow_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TableRow")(x.asInstanceOf[js.Any])
  
  inline def Table_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Table")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Viewbox: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Viewbox_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Viewbox")(x.asInstanceOf[js.Any])
}
