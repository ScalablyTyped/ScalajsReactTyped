...
/**
  ...
  */
open class Model ()
  extends typingsJapgolly.go.mod.Model {
...
object Model {
  ...
  /**
    ...
    */
  /* static member */
  inline def fromJson(s: String): typingsJapgolly.go.mod.Model = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJson")(s.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.go.mod.Model]
  inline def fromJson(s: String, model: typingsJapgolly.go.mod.Model): typingsJapgolly.go.mod.Model = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJson")(s.asInstanceOf[js.Any], model.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.go.mod.Model]
  inline def fromJson(s: js.Object): typingsJapgolly.go.mod.Model = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJson")(s.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.go.mod.Model]
  inline def fromJson(s: js.Object, model: typingsJapgolly.go.mod.Model): typingsJapgolly.go.mod.Model = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJson")(s.asInstanceOf[js.Any], model.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.go.mod.Model]
}
