...
/**
  ...
  */
open class Point ()
  extends typingsJapgolly.go.mod.Point {
  /**
...
object Point {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(str: String): typingsJapgolly.go.mod.Point = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.go.mod.Point]
  ...
  /**
    ...
    */
  /* static member */
  inline def stringify(`val`: typingsJapgolly.go.mod.Point): String = ^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
}
