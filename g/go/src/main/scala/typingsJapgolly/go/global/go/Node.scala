...
/**
  ...
  */
open class Node ()
  extends typingsJapgolly.go.mod.Node {
  def this(`type`: typingsJapgolly.go.mod.EnumValue) = this()
}
object Node {
  ...
  @js.native
  def DirectionAbsolute: typingsJapgolly.go.mod.EnumValue = js.native
  inline def DirectionAbsolute_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DirectionAbsolute")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def DirectionDefault: typingsJapgolly.go.mod.EnumValue = js.native
  inline def DirectionDefault_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DirectionDefault")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def DirectionRotatedNode: typingsJapgolly.go.mod.EnumValue = js.native
  ...
  @js.native
  def DirectionRotatedNodeOrthogonal: typingsJapgolly.go.mod.EnumValue = js.native
  inline def DirectionRotatedNodeOrthogonal_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DirectionRotatedNodeOrthogonal")(x.asInstanceOf[js.Any])
  
  inline def DirectionRotatedNode_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DirectionRotatedNode")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SpreadingEvenly: typingsJapgolly.go.mod.EnumValue = js.native
  inline def SpreadingEvenly_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SpreadingEvenly")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SpreadingNone: typingsJapgolly.go.mod.EnumValue = js.native
  inline def SpreadingNone_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SpreadingNone")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def SpreadingPacked: typingsJapgolly.go.mod.EnumValue = js.native
  inline def SpreadingPacked_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SpreadingPacked")(x.asInstanceOf[js.Any])
}
