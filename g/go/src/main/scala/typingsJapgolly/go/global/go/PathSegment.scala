...
open class PathSegment protected ()
  extends typingsJapgolly.go.mod.PathSegment {
  /**
    ...
    */
  def this(
    `type`: typingsJapgolly.go.mod.EnumValue,
...
object PathSegment {
  ...
  @js.native
  def Arc: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Arc_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Arc")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Line: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Line_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Line")(x.asInstanceOf[js.Any])
  
  /**For beginning a new subpath, a value for PathSegment.type.*/
  /* static member */
  @JSGlobal("go.PathSegment.Move")
  @js.native
  def Move: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Move_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Move")(x.asInstanceOf[js.Any])
  
  /**For drawing a quadratic bezier segment, a value for PathSegment.type.*/
  /* static member */
  @JSGlobal("go.PathSegment.QuadraticBezier")
  @js.native
  def QuadraticBezier: typingsJapgolly.go.mod.EnumValue = js.native
  inline def QuadraticBezier_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("QuadraticBezier")(x.asInstanceOf[js.Any])
  
  /**For drawing an SVG arc segment, a value for PathSegment.type.*/
  /* static member */
  @JSGlobal("go.PathSegment.SvgArc")
  @js.native
  def SvgArc: typingsJapgolly.go.mod.EnumValue = js.native
  inline def SvgArc_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SvgArc")(x.asInstanceOf[js.Any])
}
