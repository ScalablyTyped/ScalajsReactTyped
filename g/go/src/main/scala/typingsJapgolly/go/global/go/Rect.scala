...
/**
  ...
  */
open class Rect ()
  extends typingsJapgolly.go.mod.Rect {
  /**
    ...
    */
  def this(tl: typingsJapgolly.go.mod.Point, br: typingsJapgolly.go.mod.Point) = this()
  /**
    * The constructor taking a Point and a Size produces a Rect at that point with that size.
    * @param {Point} tl Top-left Point
    * @param {Point} sz Size
    */
  def this(tl: typingsJapgolly.go.mod.Point, sz: typingsJapgolly.go.mod.Size) = this()
  /**
...
object Rect {
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(str: String): typingsJapgolly.go.mod.Rect = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.go.mod.Rect]
  ...
  /**
    ...
    */
  /* static member */
  inline def stringify(`val`: typingsJapgolly.go.mod.Rect): String = ^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
}
