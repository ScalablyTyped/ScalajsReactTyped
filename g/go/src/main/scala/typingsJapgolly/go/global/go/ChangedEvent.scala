...
open class ChangedEvent ()
  extends typingsJapgolly.go.mod.ChangedEvent
object ChangedEvent {
  ...
  @js.native
  def Insert: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Insert_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Insert")(x.asInstanceOf[js.Any])
  
  /**For simple property changes, and used as the value for ChangedEvent.change.*/
  /* static member */
  @JSGlobal("go.ChangedEvent.Property")
  @js.native
  def Property: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Property_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Property")(x.asInstanceOf[js.Any])
  
  /**For removing from collections, and used as the value for ChangedEvent.change.*/
  /* static member */
  @JSGlobal("go.ChangedEvent.Remove")
  @js.native
  def Remove: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Remove_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Remove")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Transaction: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Transaction_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Transaction")(x.asInstanceOf[js.Any])
}
