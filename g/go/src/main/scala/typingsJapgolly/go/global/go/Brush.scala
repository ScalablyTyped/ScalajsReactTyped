...
/**
  ...
  */
open class Brush ()
  extends typingsJapgolly.go.mod.Brush {
...
object Brush {
  ...
  @js.native
  def Linear: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Linear_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Linear")(x.asInstanceOf[js.Any])
  
  /**For pattern brushes, used as the value for Brush.type.*/
  /* static member */
  @JSGlobal("go.Brush.Pattern")
  @js.native
  def Pattern: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Pattern_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Pattern")(x.asInstanceOf[js.Any])
  
  /**For radial gradient brushes, used as the value for Brush.type.*/
  /* static member */
  @JSGlobal("go.Brush.Radial")
  @js.native
  def Radial: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Radial_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Radial")(x.asInstanceOf[js.Any])
  
  /**For simple, solid color brushes, used as the value for Brush.type.*/
  /* static member */
  @JSGlobal("go.Brush.Solid")
  @js.native
  def Solid: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Solid_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Solid")(x.asInstanceOf[js.Any])
