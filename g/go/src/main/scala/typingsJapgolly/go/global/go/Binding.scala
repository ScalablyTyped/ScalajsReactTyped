...
/**
  ...
  */
open class Binding ()
  extends typingsJapgolly.go.mod.Binding {
...
object Binding {
  ...
  @js.native
  def OneWay: typingsJapgolly.go.mod.EnumValue = js.native
  inline def OneWay_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("OneWay")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def TwoWay: typingsJapgolly.go.mod.EnumValue = js.native
  inline def TwoWay_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TwoWay")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  /* static member */
  inline def parseEnum(ctor: Constructor, defval: typingsJapgolly.go.mod.EnumValue): js.Function1[/* a */ String, typingsJapgolly.go.mod.EnumValue] = (^.asInstanceOf[js.Dynamic].applyDynamic("parseEnum")(ctor.asInstanceOf[js.Any], defval.asInstanceOf[js.Any])).asInstanceOf[js.Function1[/* a */ String, typingsJapgolly.go.mod.EnumValue]]
