...
open class LinkReshapingTool ()
  extends typingsJapgolly.go.mod.LinkReshapingTool
object LinkReshapingTool {
  ...
  @js.native
  def All: typingsJapgolly.go.mod.EnumValue = js.native
  inline def All_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("All")(x.asInstanceOf[js.Any])
