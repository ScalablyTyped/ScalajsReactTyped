...
open class ToolManager ()
  extends typingsJapgolly.go.mod.ToolManager
object ToolManager {
  ...
  @js.native
  def GestureCancel: typingsJapgolly.go.mod.EnumValue = js.native
  inline def GestureCancel_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GestureCancel")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def GestureNone: typingsJapgolly.go.mod.EnumValue = js.native
  inline def GestureNone_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GestureNone")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def GestureZoom: typingsJapgolly.go.mod.EnumValue = js.native
  inline def GestureZoom_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GestureZoom")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def WheelNone: typingsJapgolly.go.mod.EnumValue = js.native
  inline def WheelNone_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WheelNone")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def WheelScroll: typingsJapgolly.go.mod.EnumValue = js.native
  inline def WheelScroll_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WheelScroll")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def WheelZoom: typingsJapgolly.go.mod.EnumValue = js.native
  inline def WheelZoom_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("WheelZoom")(x.asInstanceOf[js.Any])
}
