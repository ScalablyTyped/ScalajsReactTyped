...
/**
  ...
  */
open class Geometry ()
  extends typingsJapgolly.go.mod.Geometry {
...
object Geometry {
  ...
  @js.native
  def Ellipse: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Ellipse_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Ellipse")(x.asInstanceOf[js.Any])
  ...
  @js.native
  def Path: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Path_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Path")(x.asInstanceOf[js.Any])
  
  /**For drawing a rectangle; a value for Geometry.type.*/
  /* static member */
  @JSGlobal("go.Geometry.Rectangle")
  @js.native
  def Rectangle: typingsJapgolly.go.mod.EnumValue = js.native
  inline def Rectangle_=(x: typingsJapgolly.go.mod.EnumValue): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Rectangle")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  /* static member */
  inline def parse(str: String): typingsJapgolly.go.mod.Geometry = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.go.mod.Geometry]
  inline def parse(str: String, filled: Boolean): typingsJapgolly.go.mod.Geometry = (^.asInstanceOf[js.Dynamic].applyDynamic("parse")(str.asInstanceOf[js.Any], filled.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.go.mod.Geometry]
  ...
  /**
    ...
    */
  /* static member */
  inline def stringify(`val`: typingsJapgolly.go.mod.Geometry): String = ^.asInstanceOf[js.Dynamic].applyDynamic("stringify")(`val`.asInstanceOf[js.Any]).asInstanceOf[String]
}
