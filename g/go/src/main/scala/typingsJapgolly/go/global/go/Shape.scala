...
/**
  ...
  */
open class Shape ()
  extends typingsJapgolly.go.mod.Shape
object Shape {
  ...
  /**
    ...
    */
  /* static member */
  inline def defineArrowheadGeometry(name: String, geo: typingsJapgolly.go.mod.Geometry): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("defineArrowheadGeometry")(name.asInstanceOf[js.Any], geo.asInstanceOf[js.Any])).asInstanceOf[Unit]
  /**
    * This static function defines a named arrowhead geometry.
    * @param {string} name the new arrowhead name must start with an uppercase letter, and must not be "None"
  ...
  inline def defineFigureGenerator(
    name: String,
    func: js.Function3[
      /* shape */ typingsJapgolly.go.mod.Shape, 
      /* width */ Double, 
      /* height */ Double, 
      typingsJapgolly.go.mod.Geometry
    ]
  ...
  /**
    ...
    */
  /* static member */
  inline def getArrowheadGeometries(): typingsJapgolly.go.mod.Map[String, typingsJapgolly.go.mod.Geometry] = ^.asInstanceOf[js.Dynamic].applyDynamic("getArrowheadGeometries")().asInstanceOf[typingsJapgolly.go.mod.Map[String, typingsJapgolly.go.mod.Geometry]]
  ...
  /**
    ...
    */
  /* static member */
  inline def getFigureGenerators(): typingsJapgolly.go.mod.Map[
    String, 
    js.Function3[
      /* shape */ typingsJapgolly.go.mod.Shape, 
      /* width */ Double, 
  ...
  ] = ^.asInstanceOf[js.Dynamic].applyDynamic("getFigureGenerators")().asInstanceOf[typingsJapgolly.go.mod.Map[
    String, 
    js.Function3[
      /* shape */ typingsJapgolly.go.mod.Shape, 
      /* width */ Double, 
