...
object mod {
  ...
  inline def apply(callback: js.Function1[/* file */ File, typingsJapgolly.gulpPostcss.anon.Options]): ReadWriteStream = ^.asInstanceOf[js.Dynamic].apply(callback.asInstanceOf[js.Any]).asInstanceOf[ReadWriteStream]
