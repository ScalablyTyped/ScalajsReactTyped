...
object ReportRow {
  ...
  inline def apply(formatForUpload: CallbackTo[Record[String, String | Double]]): ReportRow = {
  ...
  extension [Self <: ReportRow](x: Self) {
    ...
    inline def setFormatForUpload(value: CallbackTo[Record[String, String | Double]]): Self = StObject.set(x, "formatForUpload", value.toJsFn)
  }
}
