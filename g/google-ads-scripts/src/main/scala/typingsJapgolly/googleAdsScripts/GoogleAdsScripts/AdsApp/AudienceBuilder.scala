...
object AudienceBuilder {
  ...
  inline def apply(
    build: CallbackTo[AudienceOperation],
    exclude: CallbackTo[ExcludedAudienceOperation],
  ...
  extension [Self <: AudienceBuilder](x: Self) {
    ...
    inline def setExclude(value: CallbackTo[ExcludedAudienceOperation]): Self = StObject.set(x, "exclude", value.toJsFn)
