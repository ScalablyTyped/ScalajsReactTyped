...
object FrequencyCapBuilder {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(build = build.toJsFn, withEventType = js.Any.fromFunction1(withEventType), withLimit = js.Any.fromFunction1(withLimit), withTimeUnit = js.Any.fromFunction1(withTimeUnit))
