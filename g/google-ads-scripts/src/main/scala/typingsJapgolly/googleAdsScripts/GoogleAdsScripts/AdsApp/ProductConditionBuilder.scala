...
object ProductConditionBuilder {
  ...
  inline def apply(
    build: CallbackTo[ProductConditionOperation],
    ...
    val __obj = js.Dynamic.literal(build = build.toJsFn, withBid = js.Any.fromFunction1(withBid), withCondition = js.Any.fromFunction1(withCondition), withValue = js.Any.fromFunction1(withValue))
