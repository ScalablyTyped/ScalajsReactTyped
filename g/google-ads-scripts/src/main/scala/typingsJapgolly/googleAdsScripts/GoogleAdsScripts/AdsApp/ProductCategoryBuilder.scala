...
object ProductCategoryBuilder {
  ...
  inline def apply(
    build: CallbackTo[ProductCategoryOperation],
    ...
    val __obj = js.Dynamic.literal(build = build.toJsFn, withBid = js.Any.fromFunction1(withBid), withName = js.Any.fromFunction1(withName), withValue = js.Any.fromFunction1(withValue))
