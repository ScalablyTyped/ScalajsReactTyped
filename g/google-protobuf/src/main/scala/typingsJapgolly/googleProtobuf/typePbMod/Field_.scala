package typingsJapgolly.googleProtobuf.typePbMod

import typingsJapgolly.googleProtobuf.mod.Message
import typingsJapgolly.googleProtobuf.typePbMod.Field.Cardinality
import typingsJapgolly.googleProtobuf.typePbMod.Field.Kind
