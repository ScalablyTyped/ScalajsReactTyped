...
import typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.KindCase
...
object googleProtobufStructPbMod {
  ...
  object ListValue {
    ...
    trait AsObject extends StObject {
      ...
      var valuesList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.AsObject]
    }
    object AsObject {
      
      inline def apply(valuesList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.AsObject]): AsObject = {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setValuesList(value: js.Array[typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.AsObject]): Self = StObject.set(x, "valuesList", value.asInstanceOf[js.Any])
        
        inline def setValuesListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.AsObject*): Self = StObject.set(x, "valuesList", js.Array(value*))
      }
    }
  }
  ...
  object NullValue extends StObject {
    ...
    sealed trait NULL_VALUE
      extends StObject
         with NullValue
    /* 0 */ val NULL_VALUE: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.NullValue.NULL_VALUE & Double = js.native
  }
  ...
  object Struct {
    ...
    trait AsObject extends StObject {
      ...
      var fieldsMap: js.Array[
            js.Tuple2[String, typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.AsObject]
          ]
    }
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setFieldsMapVarargs(
          value: (js.Tuple2[String, typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.AsObject])*
        ): Self = StObject.set(x, "fieldsMap", js.Array(value*))
      }
    }
  }
  ...
  object Value {
    ...
    object KindCase extends StObject {
      ...
      sealed trait BOOL_VALUE
        extends StObject
           with KindCase
      /* 4 */ val BOOL_VALUE: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.BOOL_VALUE & Double = js.native
      
      @js.native
      sealed trait KIND_NOT_SET
        extends StObject
           with KindCase
      /* 0 */ val KIND_NOT_SET: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.KIND_NOT_SET & Double = js.native
      
      @js.native
      sealed trait LIST_VALUE
        extends StObject
           with KindCase
      /* 6 */ val LIST_VALUE: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.LIST_VALUE & Double = js.native
      
      @js.native
      sealed trait NULL_VALUE
        extends StObject
           with KindCase
      /* 1 */ val NULL_VALUE: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.NULL_VALUE & Double = js.native
      
      @js.native
      sealed trait NUMBER_VALUE
        extends StObject
           with KindCase
      /* 2 */ val NUMBER_VALUE: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.NUMBER_VALUE & Double = js.native
      
      @js.native
      sealed trait STRING_VALUE
        extends StObject
           with KindCase
      /* 3 */ val STRING_VALUE: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.STRING_VALUE & Double = js.native
      
      @js.native
      sealed trait STRUCT_VALUE
        extends StObject
           with KindCase
      /* 5 */ val STRUCT_VALUE: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Value.KindCase.STRUCT_VALUE & Double = js.native
    }
    ...
    trait AsObject extends StObject {
      ...
      var listValue: js.UndefOr[typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.ListValue.AsObject] = js.undefined
      ...
      var structValue: js.UndefOr[typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Struct.AsObject] = js.undefined
    }
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setListValue(value: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.ListValue.AsObject): Self = StObject.set(x, "listValue", value.asInstanceOf[js.Any])
        ...
        inline def setStructValue(value: typingsJapgolly.googleProtobuf.googleProtobufStructPbMod.Struct.AsObject): Self = StObject.set(x, "structValue", value.asInstanceOf[js.Any])
