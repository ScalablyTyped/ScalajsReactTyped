...
import typingsJapgolly.googleProtobuf.googleProtobufAnyPbMod.Any
...
object Option {
  ...
  trait AsObject extends StObject {
    ...
    var value: js.UndefOr[typingsJapgolly.googleProtobuf.googleProtobufAnyPbMod.Any.AsObject] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setValue(value: typingsJapgolly.googleProtobuf.googleProtobufAnyPbMod.Any.AsObject): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
