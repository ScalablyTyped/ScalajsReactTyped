...
object Enum {
  ...
  trait AsObject extends StObject {
    ...
    var enumvalueList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.EnumValue.AsObject]
  ...
  object AsObject {
    ...
    inline def apply(
      enumvalueList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.EnumValue.AsObject],
      name: String,
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setEnumvalueList(value: js.Array[typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.EnumValue.AsObject]): Self = StObject.set(x, "enumvalueList", value.asInstanceOf[js.Any])
      
      inline def setEnumvalueListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.EnumValue.AsObject*): Self = StObject.set(x, "enumvalueList", js.Array(value*))
