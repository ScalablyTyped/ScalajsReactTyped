...
object Type {
  ...
  trait AsObject extends StObject {
    ...
    var fieldsList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.Field.AsObject]
  ...
  object AsObject {
    ...
    inline def apply(
      fieldsList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.Field.AsObject],
      name: String,
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setFieldsList(value: js.Array[typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.Field.AsObject]): Self = StObject.set(x, "fieldsList", value.asInstanceOf[js.Any])
      
      inline def setFieldsListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.Field.AsObject*): Self = StObject.set(x, "fieldsList", js.Array(value*))
