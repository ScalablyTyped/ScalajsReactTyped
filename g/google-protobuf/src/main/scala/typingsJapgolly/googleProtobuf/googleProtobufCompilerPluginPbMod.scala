...
import typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.File
import typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.FileDescriptorProto
  ...
  object CodeGeneratorRequest {
    ...
    trait AsObject extends StObject {
      ...
      var compilerVersion: js.UndefOr[
            typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.Version.AsObject
          ] = js.undefined
    ...
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setCompilerVersion(value: typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.Version.AsObject): Self = StObject.set(x, "compilerVersion", value.asInstanceOf[js.Any])
        ...
        inline def setProtoFileListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.FileDescriptorProto.AsObject*): Self = StObject.set(x, "protoFileList", js.Array(value*))
      }
    }
  }
  ...
  object CodeGeneratorResponse {
    ...
    object Feature extends StObject {
      ...
      sealed trait FEATURE_NONE
        extends StObject
           with Feature
      /* 0 */ val FEATURE_NONE: typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.Feature.FEATURE_NONE & Double = js.native
      
      @js.native
      sealed trait FEATURE_PROTO3_OPTIONAL
        extends StObject
           with Feature
      /* 1 */ val FEATURE_PROTO3_OPTIONAL: typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.Feature.FEATURE_PROTO3_OPTIONAL & Double = js.native
    }
    ...
    object File {
      ...
      inline def toObject(includeInstance: Boolean, msg: File): typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.File.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.File.AsObject]
      ...
      object AsObject {
        ...
        inline def apply(): typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.File.AsObject = {
          val __obj = js.Dynamic.literal()
          __obj.asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.File.AsObject]
        }
        
        extension [Self <: typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.File.AsObject](x: Self) {
    ...
    object AsObject {
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setFileListVarargs(
          value: typingsJapgolly.googleProtobuf.googleProtobufCompilerPluginPbMod.CodeGeneratorResponse.File.AsObject*
