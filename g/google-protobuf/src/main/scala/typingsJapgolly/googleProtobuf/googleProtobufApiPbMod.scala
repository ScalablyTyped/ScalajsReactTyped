...
import typingsJapgolly.googleProtobuf.googleProtobufSourceContextPbMod.SourceContext
import typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.Option
import typingsJapgolly.googleProtobuf.googleProtobufTypePbMod.Syntax
...
object googleProtobufApiPbMod {
  ...
  object Api {
    ...
    trait AsObject extends StObject {
      ...
      var methodsList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufApiPbMod.Method.AsObject]
      
      var mixinsList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufApiPbMod.Mixin.AsObject]
      ...
      var sourceContext: js.UndefOr[
            typingsJapgolly.googleProtobuf.googleProtobufSourceContextPbMod.SourceContext.AsObject
          ] = js.undefined
    ...
    object AsObject {
      ...
      inline def apply(
        methodsList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufApiPbMod.Method.AsObject],
        mixinsList: js.Array[typingsJapgolly.googleProtobuf.googleProtobufApiPbMod.Mixin.AsObject],
        name: String,
      ...
      extension [Self <: AsObject](x: Self) {
        ...
        inline def setMethodsList(value: js.Array[typingsJapgolly.googleProtobuf.googleProtobufApiPbMod.Method.AsObject]): Self = StObject.set(x, "methodsList", value.asInstanceOf[js.Any])
        
        inline def setMethodsListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufApiPbMod.Method.AsObject*): Self = StObject.set(x, "methodsList", js.Array(value*))
        
        inline def setMixinsList(value: js.Array[typingsJapgolly.googleProtobuf.googleProtobufApiPbMod.Mixin.AsObject]): Self = StObject.set(x, "mixinsList", value.asInstanceOf[js.Any])
        
        inline def setMixinsListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufApiPbMod.Mixin.AsObject*): Self = StObject.set(x, "mixinsList", js.Array(value*))
        ...
        inline def setSourceContext(value: typingsJapgolly.googleProtobuf.googleProtobufSourceContextPbMod.SourceContext.AsObject): Self = StObject.set(x, "sourceContext", value.asInstanceOf[js.Any])
