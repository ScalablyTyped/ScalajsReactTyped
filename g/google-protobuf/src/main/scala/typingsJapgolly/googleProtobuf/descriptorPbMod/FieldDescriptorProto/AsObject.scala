...
trait AsObject extends js.Object {
  ...
  var options: js.UndefOr[typingsJapgolly.googleProtobuf.descriptorPbMod.FieldOptions.AsObject] = js.undefined
...
object AsObject {
  ...
  def apply(
    ...
    options: typingsJapgolly.googleProtobuf.descriptorPbMod.FieldOptions.AsObject = null,
    `type`: Type = null,
