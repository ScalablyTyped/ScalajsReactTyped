...
import typingsJapgolly.googleProtobuf.descriptorPbMod.DescriptorProto.ExtensionRange
import typingsJapgolly.googleProtobuf.descriptorPbMod.DescriptorProto.ReservedRange
