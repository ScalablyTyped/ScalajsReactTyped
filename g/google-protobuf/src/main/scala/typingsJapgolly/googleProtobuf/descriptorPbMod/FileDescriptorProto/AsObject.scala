package typingsJapgolly.googleProtobuf.descriptorPbMod.FileDescriptorProto
...
trait AsObject extends js.Object {
  ...
  var messageTypeList: js.Array[typingsJapgolly.googleProtobuf.descriptorPbMod.DescriptorProto.AsObject]
  var name: js.UndefOr[String] = js.undefined
  var options: js.UndefOr[typingsJapgolly.googleProtobuf.descriptorPbMod.FileOptions.AsObject] = js.undefined
  var pb_package: js.UndefOr[String] = js.undefined
  var publicDependencyList: js.Array[Double]
  var serviceList: js.Array[typingsJapgolly.googleProtobuf.descriptorPbMod.ServiceDescriptorProto.AsObject]
  var sourceCodeInfo: js.UndefOr[typingsJapgolly.googleProtobuf.descriptorPbMod.SourceCodeInfo.AsObject] = js.undefined
...
object AsObject {
  ...
  def apply(
    ...
    messageTypeList: js.Array[typingsJapgolly.googleProtobuf.descriptorPbMod.DescriptorProto.AsObject],
    publicDependencyList: js.Array[Double],
    serviceList: js.Array[typingsJapgolly.googleProtobuf.descriptorPbMod.ServiceDescriptorProto.AsObject],
    weakDependencyList: js.Array[Double],
    name: String = null,
    options: typingsJapgolly.googleProtobuf.descriptorPbMod.FileOptions.AsObject = null,
    pb_package: String = null,
    sourceCodeInfo: typingsJapgolly.googleProtobuf.descriptorPbMod.SourceCodeInfo.AsObject = null,
    syntax: String = null
  ): AsObject = {
