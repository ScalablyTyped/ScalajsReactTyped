...
import typingsJapgolly.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Label
import typingsJapgolly.googleProtobuf.descriptorPbMod.FieldDescriptorProto.Type
