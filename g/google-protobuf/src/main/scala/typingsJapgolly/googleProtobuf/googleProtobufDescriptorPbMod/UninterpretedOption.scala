...
import typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.UninterpretedOption.NamePart
...
object UninterpretedOption {
  ...
  object NamePart {
    ...
    inline def toObject(includeInstance: Boolean, msg: NamePart): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.UninterpretedOption.NamePart.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.UninterpretedOption.NamePart.AsObject]
    ...
    object AsObject {
      ...
      inline def apply(): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.UninterpretedOption.NamePart.AsObject = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.UninterpretedOption.NamePart.AsObject]
      }
      
      extension [Self <: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.UninterpretedOption.NamePart.AsObject](x: Self) {
  ...
  trait AsObject extends StObject {
    ...
    var nameList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.UninterpretedOption.NamePart.AsObject
      ]
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setNameListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.UninterpretedOption.NamePart.AsObject*
      ): Self = StObject.set(x, "nameList", js.Array(value*))
