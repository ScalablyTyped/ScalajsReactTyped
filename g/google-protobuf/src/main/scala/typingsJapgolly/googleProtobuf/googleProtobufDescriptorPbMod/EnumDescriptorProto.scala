...
import typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange
...
object EnumDescriptorProto {
  ...
  object EnumReservedRange {
    ...
    inline def toObject(includeInstance: Boolean, msg: EnumReservedRange): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject]
    ...
    object AsObject {
      ...
      inline def apply(): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject]
      }
      
      extension [Self <: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject](x: Self) {
  ...
  trait AsObject extends StObject {
    ...
    var options: js.UndefOr[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumOptions.AsObject
      ] = js.undefined
    
    var reservedNameList: js.Array[String]
    
    var reservedRangeList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject
      ]
    
    var valueList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumValueDescriptorProto.AsObject
      ]
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setOptions(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      ...
      inline def setReservedRangeListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.EnumReservedRange.AsObject*
      ...
      inline def setValueListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumValueDescriptorProto.AsObject*
      ): Self = StObject.set(x, "valueList", js.Array(value*))
    }
  }
}
