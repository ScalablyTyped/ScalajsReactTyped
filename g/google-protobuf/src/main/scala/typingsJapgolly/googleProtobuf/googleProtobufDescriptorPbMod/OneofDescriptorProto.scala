...
object OneofDescriptorProto {
  ...
  trait AsObject extends StObject {
    ...
    var options: js.UndefOr[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.OneofOptions.AsObject
      ] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setOptions(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.OneofOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
