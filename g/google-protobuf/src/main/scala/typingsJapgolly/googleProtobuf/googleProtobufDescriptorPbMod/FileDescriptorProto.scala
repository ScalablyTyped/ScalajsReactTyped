...
object FileDescriptorProto {
  ...
  trait AsObject extends StObject {
    ...
    var messageTypeList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.AsObject
      ]
    
    var name: js.UndefOr[String] = js.undefined
    
    var options: js.UndefOr[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.FileOptions.AsObject
      ] = js.undefined
    ...
    var serviceList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.ServiceDescriptorProto.AsObject
      ]
    
    var sourceCodeInfo: js.UndefOr[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.AsObject
      ] = js.undefined
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setMessageTypeList(
        value: js.Array[
              typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.AsObject
            ]
      ): Self = StObject.set(x, "messageTypeList", value.asInstanceOf[js.Any])
      
      inline def setMessageTypeListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.AsObject*): Self = StObject.set(x, "messageTypeList", js.Array(value*))
      
      inline def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
      
      inline def setNameUndefined: Self = StObject.set(x, "name", js.undefined)
      
      inline def setOptions(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.FileOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      ...
      inline def setServiceListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.ServiceDescriptorProto.AsObject*
      ): Self = StObject.set(x, "serviceList", js.Array(value*))
      
      inline def setSourceCodeInfo(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.AsObject): Self = StObject.set(x, "sourceCodeInfo", value.asInstanceOf[js.Any])
