...
object ServiceDescriptorProto {
  ...
  trait AsObject extends StObject {
    ...
    var methodList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MethodDescriptorProto.AsObject
      ]
    
    var name: js.UndefOr[String] = js.undefined
    
    var options: js.UndefOr[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.ServiceOptions.AsObject
      ] = js.undefined
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setMethodListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MethodDescriptorProto.AsObject*
      ): Self = StObject.set(x, "methodList", js.Array(value*))
      
      inline def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
      
      inline def setNameUndefined: Self = StObject.set(x, "name", js.undefined)
      
      inline def setOptions(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.ServiceOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
