...
object MethodDescriptorProto {
  ...
  trait AsObject extends StObject {
    ...
    var options: js.UndefOr[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.AsObject
      ] = js.undefined
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setOptions(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
