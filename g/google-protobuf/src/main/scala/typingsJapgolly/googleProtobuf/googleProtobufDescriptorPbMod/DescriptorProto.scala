...
import typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange
import typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange
...
object DescriptorProto {
  ...
  object ExtensionRange {
    ...
    inline def toObject(includeInstance: Boolean, msg: ExtensionRange): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject]
    ...
    trait AsObject extends StObject {
      ...
      var options: js.UndefOr[
            typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.ExtensionRangeOptions.AsObject
          ] = js.undefined
    ...
    object AsObject {
      ...
      inline def apply(): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject]
      }
      
      extension [Self <: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject](x: Self) {
        
        inline def setEnd(value: Double): Self = StObject.set(x, "end", value.asInstanceOf[js.Any])
        
        inline def setEndUndefined: Self = StObject.set(x, "end", js.undefined)
        
        inline def setOptions(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.ExtensionRangeOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
  ...
  object ReservedRange {
    ...
    inline def toObject(includeInstance: Boolean, msg: ReservedRange): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject]
    ...
    object AsObject {
      ...
      inline def apply(): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject]
      }
      
      extension [Self <: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject](x: Self) {
  ...
  trait AsObject extends StObject {
    ...
    var enumTypeList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.AsObject
      ]
    
    var extensionList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.FieldDescriptorProto.AsObject
      ]
    
    var extensionRangeList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject
      ]
    ...
    var oneofDeclList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.OneofDescriptorProto.AsObject
      ]
    
    var options: js.UndefOr[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MessageOptions.AsObject
      ] = js.undefined
    
    var reservedNameList: js.Array[String]
    
    var reservedRangeList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject
      ]
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setEnumTypeListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.EnumDescriptorProto.AsObject*): Self = StObject.set(x, "enumTypeList", js.Array(value*))
      ...
      inline def setExtensionListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.FieldDescriptorProto.AsObject*): Self = StObject.set(x, "extensionList", js.Array(value*))
      ...
      inline def setExtensionRangeListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ExtensionRange.AsObject*
      ...
      inline def setFieldListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.FieldDescriptorProto.AsObject*): Self = StObject.set(x, "fieldList", js.Array(value*))
      ...
      inline def setOneofDeclListVarargs(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.OneofDescriptorProto.AsObject*): Self = StObject.set(x, "oneofDeclList", js.Array(value*))
      
      inline def setOptions(value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MessageOptions.AsObject): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      ...
      inline def setReservedRangeListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.DescriptorProto.ReservedRange.AsObject*
