...
import typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.IdempotencyLevel
...
object MethodOptions {
  ...
  object IdempotencyLevel extends StObject {
    ...
    /* 0 */ val IDEMPOTENCY_UNKNOWN: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.IdempotencyLevel.IDEMPOTENCY_UNKNOWN & Double = js.native
    
    @js.native
    sealed trait IDEMPOTENT
      extends StObject
         with IdempotencyLevel
    /* 2 */ val IDEMPOTENT: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.IdempotencyLevel.IDEMPOTENT & Double = js.native
    
    @js.native
    sealed trait NO_SIDE_EFFECTS
      extends StObject
         with IdempotencyLevel
    /* 1 */ val NO_SIDE_EFFECTS: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.MethodOptions.IdempotencyLevel.NO_SIDE_EFFECTS & Double = js.native
  }
