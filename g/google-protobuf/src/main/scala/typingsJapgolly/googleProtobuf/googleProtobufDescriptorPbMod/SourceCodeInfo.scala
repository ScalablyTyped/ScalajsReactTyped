...
import typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.Location
...
object SourceCodeInfo {
  ...
  object Location {
    ...
    inline def toObject(includeInstance: Boolean, msg: Location): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.Location.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.Location.AsObject]
    ...
    object AsObject {
      ...
      inline def apply(
      ...
      ): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.Location.AsObject = {
        ...
        __obj.asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.Location.AsObject]
      }
      
      extension [Self <: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.Location.AsObject](x: Self) {
  ...
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setLocationListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.SourceCodeInfo.Location.AsObject*
      ): Self = StObject.set(x, "locationList", js.Array(value*))
    }
  }
}
