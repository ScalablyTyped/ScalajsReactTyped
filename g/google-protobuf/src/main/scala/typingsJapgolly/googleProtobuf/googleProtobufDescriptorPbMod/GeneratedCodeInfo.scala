...
import typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation
...
object GeneratedCodeInfo {
  ...
  object Annotation {
    ...
    inline def toObject(includeInstance: Boolean, msg: Annotation): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(includeInstance.asInstanceOf[js.Any], msg.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject]
    ...
    object AsObject {
      ...
      inline def apply(pathList: js.Array[Double]): typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject = {
        val __obj = js.Dynamic.literal(pathList = pathList.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject]
      }
      
      extension [Self <: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject](x: Self) {
  ...
  trait AsObject extends StObject {
    ...
    var annotationList: js.Array[
        typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject
      ]
  }
  object AsObject {
    ...
    extension [Self <: AsObject](x: Self) {
      ...
      inline def setAnnotationListVarargs(
        value: typingsJapgolly.googleProtobuf.googleProtobufDescriptorPbMod.GeneratedCodeInfo.Annotation.AsObject*
      ): Self = StObject.set(x, "annotationList", js.Array(value*))
    }
  }
}
