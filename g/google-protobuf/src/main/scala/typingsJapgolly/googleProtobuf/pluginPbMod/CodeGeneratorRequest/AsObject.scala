...
trait AsObject extends js.Object {
  var compilerVersion: js.UndefOr[typingsJapgolly.googleProtobuf.pluginPbMod.Version.AsObject] = js.undefined
  var fileToGenerateList: js.Array[String]
  var parameter: js.UndefOr[String] = js.undefined
  var protoFileList: js.Array[typingsJapgolly.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject]
}
...
object AsObject {
  ...
  def apply(
    ...
    protoFileList: js.Array[typingsJapgolly.googleProtobuf.descriptorPbMod.FileDescriptorProto.AsObject],
    compilerVersion: typingsJapgolly.googleProtobuf.pluginPbMod.Version.AsObject = null,
