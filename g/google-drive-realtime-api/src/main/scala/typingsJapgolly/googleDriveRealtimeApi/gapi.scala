  ...
  object drive {
    ...
    object realtime {
      ...
      /* Rewritten from type alias, can be one of: 
        - typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.EditableString
        - typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.Map
        - typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.List
      */
      trait CollaborativeObjectType extends StObject
      object CollaborativeObjectType {
        
        inline def EditableString: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.EditableString = "EditableString".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.EditableString]
        
        inline def List: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.List = "List".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.List]
        
        inline def Map: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.Map = "Map".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.Map]
      }
      ...
      */
      ...
      object ErrorType {
        ...
        inline def client_error: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.client_error = "client_error".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.client_error]
        
        inline def concurrent_creation: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.concurrent_creation = "concurrent_creation".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.concurrent_creation]
        
        inline def fatal_network_error: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.fatal_network_error = "fatal_network_error".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.fatal_network_error]
        
        inline def forbidden: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.forbidden = "forbidden".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.forbidden]
        
        inline def invalid_compound_operation: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.invalid_compound_operation = "invalid_compound_operation".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.invalid_compound_operation]
        
        inline def invalid_element_type: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.invalid_element_type = "invalid_element_type".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.invalid_element_type]
        
        inline def invalid_json_syntax: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.invalid_json_syntax = "invalid_json_syntax".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.invalid_json_syntax]
        
        inline def missing_property: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.missing_property = "missing_property".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.missing_property]
        
        inline def no_write_permission: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.no_write_permission = "no_write_permission".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.no_write_permission]
        
        inline def not_found: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.not_found = "not_found".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.not_found]
        
        inline def server_error: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.server_error = "server_error".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.server_error]
        
        inline def token_refresh_required: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.token_refresh_required = "token_refresh_required".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.token_refresh_required]
        
        inline def unexpected_element: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.unexpected_element = "unexpected_element".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.unexpected_element]
      }
      ...
      */
      ...
      object EventType {
        ...
        inline def attribute_changed: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.attribute_changed = "attribute_changed".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.attribute_changed]
        
        inline def collaborator_joined: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.collaborator_joined = "collaborator_joined".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.collaborator_joined]
        
        inline def collaborator_left: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.collaborator_left = "collaborator_left".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.collaborator_left]
        
        inline def document_save_state_changed: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.document_save_state_changed = "document_save_state_changed".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.document_save_state_changed]
        
        inline def object_changed: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.object_changed = "object_changed".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.object_changed]
        
        inline def reference_shifted: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.reference_shifted = "reference_shifted".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.reference_shifted]
        
        inline def text_deleted: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.text_deleted = "text_deleted".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.text_deleted]
        
        inline def text_inserted: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.text_inserted = "text_inserted".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.text_inserted]
        
        inline def undo_redo_state_changed: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.undo_redo_state_changed = "undo_redo_state_changed".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.undo_redo_state_changed]
        
        inline def value_changed: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.value_changed = "value_changed".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.value_changed]
        
        inline def values_added: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.values_added = "values_added".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.values_added]
        
        inline def values_removed: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.values_removed = "values_removed".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.values_removed]
        
        inline def values_set: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.values_set = "values_set".asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.values_set]
      }
      ...
      object databinding {
        ...
        object Binding {
          ...
          inline def apply(collaborativeObject: CollaborativeObject, domElement: Element, unbind: Callback): Binding = {
            val __obj = js.Dynamic.literal(collaborativeObject = collaborativeObject.asInstanceOf[js.Any], domElement = domElement.asInstanceOf[js.Any], unbind = unbind.toJsFn)
