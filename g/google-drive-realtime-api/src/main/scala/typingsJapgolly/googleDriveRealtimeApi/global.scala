...
import typingsJapgolly.googleDriveRealtimeApi.anon.SHIFTAFTERDELETE
...
import typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.databinding.Binding
import typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.EditableString
import typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.Map
...
import typingsJapgolly.googleDriveRealtimeApi.rtclient.DriveAPIFileResource
import typingsJapgolly.googleDriveRealtimeApi.rtclient.LoaderOptions
import typingsJapgolly.googleDriveRealtimeApi.rtclient.RealtimeLoader
import typingsJapgolly.googleDriveRealtimeApi.rtclient.RealtimeLoaderFactory
    ...
    object drive {
      ...
      object realtime {
        ...
        open class CollaborativeList[V] ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.CollaborativeList[V]
        /* static members */
        object CollaborativeList {
          
          @JSGlobal("gapi.drive.realtime.CollaborativeList.type")
          @js.native
          val `type`: typingsJapgolly.googleDriveRealtimeApi.googleDriveRealtimeApiStrings.List = js.native
        }
        ...
        open class CollaborativeMap[V] ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.CollaborativeMap[V]
        /* static members */
        ...
        open class CollaborativeObject ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.CollaborativeObject
        
        @JSGlobal("gapi.drive.realtime.CollaborativeString")
        @js.native
        open class CollaborativeString ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.CollaborativeString
        /* static members */
        ...
        open class Collaborator protected ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Collaborator {
          def this(
            sessionId: String,
            userId: String,
            displayName: String,
        ...
        open class Document ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document
        
        @JSGlobal("gapi.drive.realtime.Error")
        @js.native
        open class Error protected ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Error {
        ...
        object ErrorType {
          ...
          @js.native
          def CLIENT_ERROR: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def CLIENT_ERROR_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CLIENT_ERROR")(x.asInstanceOf[js.Any])
          ...
          @js.native
          def CONCURRENT_CREATION: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def CONCURRENT_CREATION_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("CONCURRENT_CREATION")(x.asInstanceOf[js.Any])
          ...
          @js.native
          def FATAL_NETWORK_ERROR: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def FATAL_NETWORK_ERROR_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FATAL_NETWORK_ERROR")(x.asInstanceOf[js.Any])
          ...
          @js.native
          def FORBIDDEN: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def FORBIDDEN_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("FORBIDDEN")(x.asInstanceOf[js.Any])
          ...
          @js.native
          def INVALID_COMPOUND_OPERATION: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def INVALID_COMPOUND_OPERATION_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("INVALID_COMPOUND_OPERATION")(x.asInstanceOf[js.Any])
          
          // The provided JSON element does not have the
          // expected type.
          @JSGlobal("gapi.drive.realtime.ErrorType.INVALID_ELEMENT_TYPE")
          @js.native
          def INVALID_ELEMENT_TYPE: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def INVALID_ELEMENT_TYPE_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("INVALID_ELEMENT_TYPE")(x.asInstanceOf[js.Any])
          ...
          @js.native
          def INVALID_JSON_SYNTAX: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def INVALID_JSON_SYNTAX_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("INVALID_JSON_SYNTAX")(x.asInstanceOf[js.Any])
          ...
          @js.native
          def MISSING_PROPERTY: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def MISSING_PROPERTY_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("MISSING_PROPERTY")(x.asInstanceOf[js.Any])
          
          // The provided document ID could not be found.
          @JSGlobal("gapi.drive.realtime.ErrorType.NOT_FOUND")
          @js.native
          def NOT_FOUND: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def NOT_FOUND_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NOT_FOUND")(x.asInstanceOf[js.Any])
          
          // The user does not have permission to edit the
          // document.
          @JSGlobal("gapi.drive.realtime.ErrorType.NO_WRITE_PERMISSION")
          @js.native
          def NO_WRITE_PERMISSION: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def NO_WRITE_PERMISSION_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("NO_WRITE_PERMISSION")(x.asInstanceOf[js.Any])
          
          // An internal error occurred in the Drive Realtime
          // API server.
          @JSGlobal("gapi.drive.realtime.ErrorType.SERVER_ERROR")
          @js.native
          def SERVER_ERROR: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def SERVER_ERROR_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SERVER_ERROR")(x.asInstanceOf[js.Any])
          
          // The provided OAuth token is no longer valid and
          // must be refreshed.
          @JSGlobal("gapi.drive.realtime.ErrorType.TOKEN_REFRESH_REQUIRED")
          @js.native
          def TOKEN_REFRESH_REQUIRED: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def TOKEN_REFRESH_REQUIRED_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("TOKEN_REFRESH_REQUIRED")(x.asInstanceOf[js.Any])
          ...
          @js.native
          def UNEXPECTED_ELEMENT: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType = js.native
          inline def UNEXPECTED_ELEMENT_=(x: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.ErrorType): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("UNEXPECTED_ELEMENT")(x.asInstanceOf[js.Any])
        }
        ...
        open class IndexReference[V] ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.IndexReference[V]
        /* static members */
        ...
        open class Model ()
          extends StObject
             with typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Model
        ...
        object databinding {
          ...
          inline def bindString(
            s: typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.CollaborativeString,
        ...
        inline def load(
          fileId: String,
          onLoaded: js.Function1[/* d */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit]
        ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("load")(fileId.asInstanceOf[js.Any], onLoaded.asInstanceOf[js.Any])).asInstanceOf[Unit]
        inline def load(
          fileId: String,
          onLoaded: js.Function1[/* d */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit],
          opt_initializerFn: js.Function1[/* m */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Model, Unit]
        ...
        inline def load(
          ...
          onLoaded: js.Function1[/* d */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit],
          opt_initializerFn: js.Function1[/* m */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Model, Unit],
          opt_errorFn: js.Function1[/* e */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Error, Unit]
        ...
        inline def loadAppDataDocument(
          onLoaded: js.Function1[/* x */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit]
        ): Unit = ^.asInstanceOf[js.Dynamic].applyDynamic("loadAppDataDocument")(onLoaded.asInstanceOf[js.Any]).asInstanceOf[Unit]
        inline def loadAppDataDocument(
          onLoaded: js.Function1[/* x */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit],
          opt_initializerFn: js.Function1[/* x */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Model, Unit]
        ...
        inline def loadFromJson(json: String): typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document = ^.asInstanceOf[js.Dynamic].applyDynamic("loadFromJson")(json.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document]
        inline def loadFromJson(
          json: String,
          opt_errorFn: js.Function1[/* e */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Error, Unit]
        ): typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document = (^.asInstanceOf[js.Dynamic].applyDynamic("loadFromJson")(json.asInstanceOf[js.Any], opt_errorFn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document]
        
        inline def newInMemoryDocument(): typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document = ^.asInstanceOf[js.Dynamic].applyDynamic("newInMemoryDocument")().asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document]
        inline def newInMemoryDocument(
          opt_onLoaded: js.Function1[/* d */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit]
        ): typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document = ^.asInstanceOf[js.Dynamic].applyDynamic("newInMemoryDocument")(opt_onLoaded.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document]
        inline def newInMemoryDocument(
          opt_onLoaded: js.Function1[/* d */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit],
          opt_initializerFn: js.Function1[/* m */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Model, Unit]
        ): typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document = (^.asInstanceOf[js.Dynamic].applyDynamic("newInMemoryDocument")(opt_onLoaded.asInstanceOf[js.Any], opt_initializerFn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document]
        inline def newInMemoryDocument(
          opt_onLoaded: js.Function1[/* d */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit],
          opt_initializerFn: js.Function1[/* m */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Model, Unit],
          opt_errorFn: js.Function1[/* e */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Error, Unit]
        ): typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document = (^.asInstanceOf[js.Dynamic].applyDynamic("newInMemoryDocument")(opt_onLoaded.asInstanceOf[js.Any], opt_initializerFn.asInstanceOf[js.Any], opt_errorFn.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document]
        inline def newInMemoryDocument(
          opt_onLoaded: js.Function1[/* d */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Document, Unit],
          opt_initializerFn: Unit,
          opt_errorFn: js.Function1[/* e */ typingsJapgolly.googleDriveRealtimeApi.gapi.drive.realtime.Error, Unit]
