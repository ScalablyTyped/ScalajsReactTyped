...
import typingsJapgolly.googleAnalytics.UniversalAnalytics.ga
...
object global {
  ...
  open class Tracker ()
    extends StObject
       with typingsJapgolly.googleAnalytics.Tracker
  
  @JSGlobal("ga")
  @js.native
  def ga: typingsJapgolly.googleAnalytics.UniversalAnalytics.ga = js.native
