...
import typingsJapgolly.googleAnalytics.anon.EventAction
import typingsJapgolly.googleAnalytics.anon.EventCategory
import typingsJapgolly.googleAnalytics.anon.SocialAction
import typingsJapgolly.googleAnalytics.anon.TimingCategory
...
object UniversalAnalytics {
  ...
  object FieldsObject {
    ...
    extension [Self <: FieldsObject](x: Self) {
      ...
      inline def setHitCallback(value: Callback): Self = StObject.set(x, "hitCallback", value.toJsFn)
  ...
  */
  ...
  object HitType {
    ...
    inline def event: typingsJapgolly.googleAnalytics.googleAnalyticsStrings.event = "event".asInstanceOf[typingsJapgolly.googleAnalytics.googleAnalyticsStrings.event]
    
    inline def exception: typingsJapgolly.googleAnalytics.googleAnalyticsStrings.exception = "exception".asInstanceOf[typingsJapgolly.googleAnalytics.googleAnalyticsStrings.exception]
    
    inline def item: typingsJapgolly.googleAnalytics.googleAnalyticsStrings.item = "item".asInstanceOf[typingsJapgolly.googleAnalytics.googleAnalyticsStrings.item]
    
    inline def pageview: typingsJapgolly.googleAnalytics.googleAnalyticsStrings.pageview = "pageview".asInstanceOf[typingsJapgolly.googleAnalytics.googleAnalyticsStrings.pageview]
    
    inline def screenview: typingsJapgolly.googleAnalytics.googleAnalyticsStrings.screenview = "screenview".asInstanceOf[typingsJapgolly.googleAnalytics.googleAnalyticsStrings.screenview]
    
    inline def social: typingsJapgolly.googleAnalytics.googleAnalyticsStrings.social = "social".asInstanceOf[typingsJapgolly.googleAnalytics.googleAnalyticsStrings.social]
    
    inline def timing: typingsJapgolly.googleAnalytics.googleAnalyticsStrings.timing = "timing".asInstanceOf[typingsJapgolly.googleAnalytics.googleAnalyticsStrings.timing]
    
    inline def transaction: typingsJapgolly.googleAnalytics.googleAnalyticsStrings.transaction = "transaction".asInstanceOf[typingsJapgolly.googleAnalytics.googleAnalyticsStrings.transaction]
  }
  ...
  trait ga extends StObject {
    ...
    def apply(
      ...
      pluginConstructor: js.Function2[
          /* tracker */ typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker, 
    ...
    def apply(
      readyCallback: js.Function1[
          /* defaultTracker */ js.UndefOr[typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker], 
          Unit
        ]
    ): Unit = js.native
    
    def create(trackingId: String): typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker = js.native
    def create(trackingId: String, cookieDomain: String): typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker = js.native
    def create(trackingId: String, cookieDomain: String, fieldsObject: FieldsObject): typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker = js.native
    def create(trackingId: String, cookieDomain: String, name: String): typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker = js.native
    def create(trackingId: String, cookieDomain: String, name: String, fieldsObject: FieldsObject): typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker = js.native
    def create(trackingId: String, fieldsObject: FieldsObject): typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker = js.native
    
    def getAll(): js.Array[typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker] = js.native
    
    def getByName(name: String): typingsJapgolly.googleAnalytics.UniversalAnalytics.Tracker = js.native
