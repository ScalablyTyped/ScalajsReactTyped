...
import typingsJapgolly.gapiClientAdmin.AnonApplicationName
import typingsJapgolly.gapiClientAdmin.AnonCallerType
import typingsJapgolly.gapiClientAdmin.AnonName
