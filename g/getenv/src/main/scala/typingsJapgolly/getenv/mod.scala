...
import typingsJapgolly.getenv.getenvStrings.bool
import typingsJapgolly.getenv.getenvStrings.boolish
import typingsJapgolly.getenv.getenvStrings.float
import typingsJapgolly.getenv.getenvStrings.int
import typingsJapgolly.getenv.getenvStrings.string
import typingsJapgolly.getenv.getenvStrings.url
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.getenv.getenvStrings.string
    - typingsJapgolly.getenv.getenvStrings.int
    - typingsJapgolly.getenv.getenvStrings.float
    - typingsJapgolly.getenv.getenvStrings.bool
    - typingsJapgolly.getenv.getenvStrings.boolish
    - typingsJapgolly.getenv.getenvStrings.url
  */
