...
import typingsJapgolly.gapiClientCloudtasks.AnonBearertoken
import typingsJapgolly.gapiClientCloudtasks.AnonCallback
...
object TasksResource {
  @scala.inline
  def apply(
    acknowledge: AnonAccesstoken => CallbackTo[Request_[js.Object]],
    cancelLease: AnonAccesstoken => CallbackTo[Request_[Task]],
    create: AnonAlt => CallbackTo[Request_[Task]],
    delete: AnonAccesstoken => CallbackTo[Request_[js.Object]],
    get: AnonBearertoken => CallbackTo[Request_[Task]],
    list: AnonCallback => CallbackTo[Request_[ListTasksResponse]],
    pull: AnonAccesstoken => CallbackTo[Request_[PullTasksResponse]],
    renewLease: AnonAccesstoken => CallbackTo[Request_[Task]],
    run: AnonAccesstoken => CallbackTo[Request_[Task]]
  ): TasksResource = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("acknowledge")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientCloudtasks.AnonAccesstoken) => acknowledge(t0).runNow()))
    __obj.updateDynamic("cancelLease")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientCloudtasks.AnonAccesstoken) => cancelLease(t0).runNow()))
    ...
    __obj.updateDynamic("get")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientCloudtasks.AnonBearertoken) => get(t0).runNow()))
    __obj.updateDynamic("list")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientCloudtasks.AnonCallback) => list(t0).runNow()))
    __obj.updateDynamic("pull")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientCloudtasks.AnonAccesstoken) => pull(t0).runNow()))
    __obj.updateDynamic("renewLease")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientCloudtasks.AnonAccesstoken) => renewLease(t0).runNow()))
    __obj.updateDynamic("run")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientCloudtasks.AnonAccesstoken) => run(t0).runNow()))
