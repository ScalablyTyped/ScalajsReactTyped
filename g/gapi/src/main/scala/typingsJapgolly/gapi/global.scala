...
import typingsJapgolly.gapi.anon.ApiKey
import typingsJapgolly.gapi.anon.Apppackagename
import typingsJapgolly.gapi.anon.Clientid
import typingsJapgolly.gapi.gapi.CallbackOrConfig
import typingsJapgolly.gapi.gapi.client.RequestOptions
import typingsJapgolly.gapi.gapi.client.RpcRequest
import typingsJapgolly.gapi.gapi.client.TokenObject
  ...
  object gapi {
    ...
    object client {
      ...
      open class HttpBatch ()
        extends StObject
           with typingsJapgolly.gapi.gapi.client.HttpBatch
      
      @JSGlobal("gapi.client.HttpRequest")
      @js.native
      open class HttpRequest[T] ()
        extends StObject
           with typingsJapgolly.gapi.gapi.client.HttpRequest[T]
      ...
      open class HttpRequestPromise[T] ()
        extends StObject
           with typingsJapgolly.gapi.gapi.client.HttpRequestPromise[T]
      ...
      inline def request(args: RequestOptions): typingsJapgolly.gapi.gapi.client.HttpRequest[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("request")(args.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.gapi.gapi.client.HttpRequest[Any]]
