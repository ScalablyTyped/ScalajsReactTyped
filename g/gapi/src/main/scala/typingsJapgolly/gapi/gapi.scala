...
import typingsJapgolly.gapi.anon.Body
import typingsJapgolly.gapi.anon.Callback
...
object gapi {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gapi.gapi.LoadConfig
    - typingsJapgolly.gapi.gapi.LoadCallback
  */
  ...
  object client {
    ...
    object RpcRequest {
      ...
      inline def apply(
        callback: js.Function2[/* jsonResp */ Any, /* rawResp */ String, Unit] => japgolly.scalajs.react.Callback
      ): RpcRequest = {
        val __obj = js.Dynamic.literal(callback = js.Any.fromFunction1((t0: js.Function2[/* jsonResp */ Any, /* rawResp */ String, Unit]) => callback(t0).runNow()))
      ...
      extension [Self <: RpcRequest](x: Self) {
        ...
        inline def setCallback(
          value: js.Function2[/* jsonResp */ Any, /* rawResp */ String, Unit] => japgolly.scalajs.react.Callback
        ): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: js.Function2[/* jsonResp */ Any, /* rawResp */ String, Unit]) => value(t0).runNow()))
      }
    }
