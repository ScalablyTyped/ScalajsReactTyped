...
import typingsJapgolly.got.gotStrings.downloadProgress
import typingsJapgolly.got.gotStrings.error
import typingsJapgolly.got.gotStrings.redirect
import typingsJapgolly.got.gotStrings.request
import typingsJapgolly.got.gotStrings.response
import typingsJapgolly.got.gotStrings.uploadProgress
