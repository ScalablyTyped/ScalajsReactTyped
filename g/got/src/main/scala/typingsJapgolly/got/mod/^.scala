...
import typingsJapgolly.got.GotInstanceGotBodyFnnull
import typingsJapgolly.got.GotInstanceGotBodyFnstrin
import typingsJapgolly.got.GotInstanceGotFormFnnull
import typingsJapgolly.got.GotInstanceGotFormFnstrin
import typingsJapgolly.got.GotInstanceGotJSONFn
import typingsJapgolly.got.Recordgetpostputpatchhead
