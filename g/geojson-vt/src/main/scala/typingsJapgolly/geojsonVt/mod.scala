package typingsJapgolly.geojsonVt

import typingsJapgolly.geojson.mod.GeoJSON
import typingsJapgolly.geojson.mod.GeoJsonGeometryTypes
import typingsJapgolly.geojsonVt.geojsonVtBooleans.`false`
import typingsJapgolly.geojsonVt.geojsonVtInts.`0`
import typingsJapgolly.geojsonVt.geojsonVtInts.`1`
import typingsJapgolly.geojsonVt.geojsonVtInts.`2`
import typingsJapgolly.geojsonVt.geojsonVtStrings.GeometryCollection
...
object mod {
  ...
  object FeatureTypes extends StObject {
    ...
    sealed trait Linestring
      extends StObject
         with FeatureTypes
    /* 1 */ val Linestring: typingsJapgolly.geojsonVt.mod.FeatureTypes.Linestring & Double = js.native
    
    @js.native
    sealed trait Point
      extends StObject
         with FeatureTypes
    /* 0 */ val Point: typingsJapgolly.geojsonVt.mod.FeatureTypes.Point & Double = js.native
    
    @js.native
    sealed trait Polygon
      extends StObject
         with FeatureTypes
    /* 2 */ val Polygon: typingsJapgolly.geojsonVt.mod.FeatureTypes.Polygon & Double = js.native
    
    @js.native
    sealed trait Unknown
      extends StObject
         with FeatureTypes
    /* 0 */ val Unknown: typingsJapgolly.geojsonVt.mod.FeatureTypes.Unknown & Double = js.native
  }
