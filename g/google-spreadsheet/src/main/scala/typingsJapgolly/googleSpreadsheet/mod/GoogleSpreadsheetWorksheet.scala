...
import typingsJapgolly.googleSpreadsheet.anon.Data
import typingsJapgolly.googleSpreadsheet.anon.End
import typingsJapgolly.googleSpreadsheet.anon.Insert
