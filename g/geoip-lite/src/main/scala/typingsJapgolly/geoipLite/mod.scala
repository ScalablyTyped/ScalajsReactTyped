...
import typingsJapgolly.geoipLite.geoipLiteStrings.`0`
import typingsJapgolly.geoipLite.geoipLiteStrings.`1`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.geoipLite.geoipLiteInts.`1`
    - typingsJapgolly.geoipLite.geoipLiteInts.`-1`
    - typingsJapgolly.geoipLite.geoipLiteInts.`0`
    - scala.Null
  */
