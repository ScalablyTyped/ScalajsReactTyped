...
import typingsJapgolly.gsi.gsiStrings.popup
import typingsJapgolly.gsi.gsiStrings.redirect
import typingsJapgolly.gsi.gsiStrings.signin
import typingsJapgolly.gsi.gsiStrings.signup
import typingsJapgolly.gsi.gsiStrings.use
...
object IdConfiguration {
  ...
  extension [Self <: IdConfiguration](x: Self) {
    ...
    inline def setCallback(value: /* token */ CredentialResponse => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* token */ CredentialResponse) => value(t0).runNow()))
    ...
    inline def setNative_callback(value: /* credential */ GsiCredential => Callback): Self = StObject.set(x, "native_callback", js.Any.fromFunction1((t0: /* credential */ GsiCredential) => value(t0).runNow()))
