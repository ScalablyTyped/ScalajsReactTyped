...
object Router {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.gatsbyjsReachRouter.mod.Router] {
    ...
    inline def component(value: ComponentType[js.Object] | String): this.type = set("component", value.asInstanceOf[js.Any])
  ...
  def withProps(p: RouterProps & HTMLProps[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
