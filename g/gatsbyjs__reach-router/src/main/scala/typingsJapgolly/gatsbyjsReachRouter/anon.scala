...
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.`additions removals`
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.`additions text`
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.`inline`
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.`removals additions`
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.`removals text`
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.`text additions`
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.`text removals`
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.additions
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.all
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.ascending
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.assertive
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.both
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.copy
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.date
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.decimal
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.descending
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.dialog
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.email
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.environment
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.execute
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.grammar
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.grid
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.horizontal
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.inherit
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.link
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.list
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.listbox
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.location
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.menu
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.mixed
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.move
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.no
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.none
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.numeric
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.off
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.on
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.other
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.page
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.polite
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.popup
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.removals
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.search
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.spelling
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.step
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.tel
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.text
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.time
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.tree
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.url
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.user
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.vertical
import typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.yes
...
object anon {
  ...
  trait ReadonlyLocationProps extends StObject {
    ...
    def children(context: LocationContext): Node
  }
  object ReadonlyLocationProps {
    
    inline def apply(children: LocationContext => Node): ReadonlyLocationProps = {
    ...
    extension [Self <: ReadonlyLocationProps](x: Self) {
      ...
      inline def setChildren(value: LocationContext => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
    }
  }
  ...
  trait ReadonlyLocationProviderP extends StObject {
    ...
    val children: js.UndefOr[Node | LocationProviderRenderFn] = js.undefined
  ...
  trait ReadonlyRouterPropsHTMLPr extends StObject {
    ...
    val `aria-autocomplete`: js.UndefOr[
        none | `inline` | typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.list | both
      ] = js.undefined
    ...
    val `aria-current`: js.UndefOr[
        Boolean | page | typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.step | typingsJapgolly.gatsbyjsReachRouter.gatsbyjsReachRouterStrings.location | date | time
      ] = js.undefined
