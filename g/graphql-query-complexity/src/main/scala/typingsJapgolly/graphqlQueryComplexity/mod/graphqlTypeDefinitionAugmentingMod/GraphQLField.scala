package typingsJapgolly.graphqlQueryComplexity.mod.graphqlTypeDefinitionAugmentingMod

import typingsJapgolly.graphqlQueryComplexity.queryComplexityMod.Complexity
