...
object event {
  ...
  object EventModule {
    ...
    extension [Self <: EventModule](x: Self) {
      ...
      inline def setListenersAny(value: CallbackTo[js.Array[js.Function]]): Self = StObject.set(x, "listenersAny", value.toJsFn)
      ...
      inline def setSetMaxListener(value: Double => Callback): Self = StObject.set(x, "setMaxListener", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    }
  }
}
