...
import typingsJapgolly.gherkin.anon.Column
...
object distSrcGherkinLineMod {
  ...
  object GherkinLine {
    ...
    inline def apply(
      ...
      getTableCells: CallbackTo[js.Array[Column]],
      getTags: CallbackTo[js.Array[Column]],
      indent: Double,
      isEmpty: Boolean,
      lineNumber: Any,
      lineText: Any,
    ...
    extension [Self <: GherkinLine](x: Self) {
      ...
      inline def setGetTableCells(value: CallbackTo[js.Array[Column]]): Self = StObject.set(x, "getTableCells", value.toJsFn)
      
      inline def setGetTags(value: CallbackTo[js.Array[Column]]): Self = StObject.set(x, "getTags", value.toJsFn)
