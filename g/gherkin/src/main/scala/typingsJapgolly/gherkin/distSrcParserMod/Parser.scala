...
trait Parser extends StObject {
  ...
  def parse(tokenScanner: String, tokenMatcher: typingsJapgolly.gherkin.distSrcTokenMatcherMod.default): Any = js.native
  def parse(tokenScanner: typingsJapgolly.gherkin.distSrcTokenScannerMod.default): Any = js.native
  def parse(
    tokenScanner: typingsJapgolly.gherkin.distSrcTokenScannerMod.default,
    tokenMatcher: typingsJapgolly.gherkin.distSrcTokenMatcherMod.default
  ): Any = js.native
