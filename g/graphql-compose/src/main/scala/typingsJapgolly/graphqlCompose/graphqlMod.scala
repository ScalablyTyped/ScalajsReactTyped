...
import typingsJapgolly.graphqlCompose.enumTypeComposerMod._EnumTypeComposeDefinition
import typingsJapgolly.graphqlCompose.graphqlComposeStrings.`No longer supported`
import typingsJapgolly.graphqlCompose.inputTypeComposerMod._InputTypeComposeDefinition
import typingsJapgolly.graphqlCompose.scalarTypeComposerMod._ScalarTypeComposeDefinition
...
object graphqlMod extends js.Object {
  ...
  class GraphQLDirective protected ()
    extends typingsJapgolly.graphql.mod.GraphQLDirective {
    def this(config: GraphQLDirectiveConfig) = this()
  }
  
  @js.native
  class GraphQLEnumType protected ()
    extends typingsJapgolly.graphql.mod.GraphQLEnumType
  ...
  class GraphQLError protected ()
    extends typingsJapgolly.graphql.mod.GraphQLError {
    def this(
      message: String,
  ...
  class GraphQLInputObjectType protected ()
    extends typingsJapgolly.graphql.mod.GraphQLInputObjectType
  ...
  class GraphQLSchema protected ()
    extends typingsJapgolly.graphql.mod.GraphQLSchema {
    def this(config: GraphQLSchemaConfig) = this()
  }
  
  @js.native
  class GraphQLUnionType protected ()
    extends typingsJapgolly.graphql.mod.GraphQLUnionType {
    def this(config: GraphQLUnionTypeConfig[_, _]) = this()
  }
  
  @js.native
  class Source protected ()
    extends typingsJapgolly.graphql.mod.Source {
  ...
  class TypeInfo protected ()
    extends typingsJapgolly.graphql.mod.TypeInfo {
  ...
  class ValidationContext protected ()
    extends typingsJapgolly.graphql.mod.ValidationContext {
    def this(
      schema: typingsJapgolly.graphql.schemaMod.GraphQLSchema,
      ast: DocumentNode,
