...
import typingsJapgolly.graphqlCompose.AnonParams
import typingsJapgolly.graphqlCompose.AnonProjection
import typingsJapgolly.graphqlCompose.PartialComposeArgumentCon
...
import typingsJapgolly.graphqlCompose.objectTypeComposerMod.ComposeArgumentConfigAsObject
