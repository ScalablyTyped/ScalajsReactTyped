...
import typingsJapgolly.graphqlCompose.objectTypeComposerMod.ComposeOutputType
...
object ResolverOpts {
  ...
  def apply[TSource, TContext, TArgs, TReturn](
    ...
    resolve: /* resolveParams */ ResolveParams[TSource, TContext, TArgs] => CallbackTo[js.Promise[js.Any] | js.Any] = null,
    ...
    if (resolve != null) __obj.updateDynamic("resolve")(js.Any.fromFunction1((t0: /* resolveParams */ typingsJapgolly.graphqlCompose.resolverMod.ResolveParams[TSource, TContext, TArgs]) => resolve(t0).runNow()))
