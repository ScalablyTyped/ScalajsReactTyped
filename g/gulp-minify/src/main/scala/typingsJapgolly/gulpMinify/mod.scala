...
import typingsJapgolly.gulpMinify.anon.Asciionly
import typingsJapgolly.gulpMinify.anon.Booleans
import typingsJapgolly.gulpMinify.anon.Min
import typingsJapgolly.gulpMinify.gulpMinifyStrings.all
import typingsJapgolly.gulpMinify.gulpMinifyStrings.some
