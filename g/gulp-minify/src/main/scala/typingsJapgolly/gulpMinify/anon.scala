package typingsJapgolly.gulpMinify

import typingsJapgolly.gulpMinify.gulpMinifyBooleans.`false`
import typingsJapgolly.gulpMinify.gulpMinifyInts.`32000`
import typingsJapgolly.gulpMinify.gulpMinifyInts.`80`
