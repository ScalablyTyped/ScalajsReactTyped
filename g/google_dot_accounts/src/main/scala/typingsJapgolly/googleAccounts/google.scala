...
import typingsJapgolly.googleAccounts.googleAccountsStrings._empty
import typingsJapgolly.googleAccounts.googleAccountsStrings.auto_cancel
import typingsJapgolly.googleAccounts.googleAccountsStrings.browser_not_supported
import typingsJapgolly.googleAccounts.googleAccountsStrings.cancel_called
import typingsJapgolly.googleAccounts.googleAccountsStrings.center
import typingsJapgolly.googleAccounts.googleAccountsStrings.circle
import typingsJapgolly.googleAccounts.googleAccountsStrings.consent
import typingsJapgolly.googleAccounts.googleAccountsStrings.continue_with
import typingsJapgolly.googleAccounts.googleAccountsStrings.credential_returned
import typingsJapgolly.googleAccounts.googleAccountsStrings.dismissed
import typingsJapgolly.googleAccounts.googleAccountsStrings.display
import typingsJapgolly.googleAccounts.googleAccountsStrings.filled_black
import typingsJapgolly.googleAccounts.googleAccountsStrings.filled_blue
import typingsJapgolly.googleAccounts.googleAccountsStrings.flow_restarted
import typingsJapgolly.googleAccounts.googleAccountsStrings.icon
import typingsJapgolly.googleAccounts.googleAccountsStrings.invalid_client
import typingsJapgolly.googleAccounts.googleAccountsStrings.issuing_failed
import typingsJapgolly.googleAccounts.googleAccountsStrings.large
import typingsJapgolly.googleAccounts.googleAccountsStrings.left
import typingsJapgolly.googleAccounts.googleAccountsStrings.medium
import typingsJapgolly.googleAccounts.googleAccountsStrings.missing_client_id
import typingsJapgolly.googleAccounts.googleAccountsStrings.none
import typingsJapgolly.googleAccounts.googleAccountsStrings.opt_out_or_no_session
import typingsJapgolly.googleAccounts.googleAccountsStrings.outline
import typingsJapgolly.googleAccounts.googleAccountsStrings.pill
import typingsJapgolly.googleAccounts.googleAccountsStrings.popup
import typingsJapgolly.googleAccounts.googleAccountsStrings.rectangular
import typingsJapgolly.googleAccounts.googleAccountsStrings.redirect
import typingsJapgolly.googleAccounts.googleAccountsStrings.secure_http_required
import typingsJapgolly.googleAccounts.googleAccountsStrings.select_account
import typingsJapgolly.googleAccounts.googleAccountsStrings.signin
import typingsJapgolly.googleAccounts.googleAccountsStrings.signin_with
import typingsJapgolly.googleAccounts.googleAccountsStrings.signup
import typingsJapgolly.googleAccounts.googleAccountsStrings.signup_with
import typingsJapgolly.googleAccounts.googleAccountsStrings.skipped
import typingsJapgolly.googleAccounts.googleAccountsStrings.small
import typingsJapgolly.googleAccounts.googleAccountsStrings.square
import typingsJapgolly.googleAccounts.googleAccountsStrings.standard
import typingsJapgolly.googleAccounts.googleAccountsStrings.suppressed_by_user
import typingsJapgolly.googleAccounts.googleAccountsStrings.tap_outside
import typingsJapgolly.googleAccounts.googleAccountsStrings.unknown_reason
import typingsJapgolly.googleAccounts.googleAccountsStrings.unregistered_origin
import typingsJapgolly.googleAccounts.googleAccountsStrings.use
import typingsJapgolly.googleAccounts.googleAccountsStrings.user_cancel
  ...
  object accounts {
    ...
    object id {
      ...
      object IdConfiguration {
        ...
        extension [Self <: IdConfiguration](x: Self) {
          ...
          inline def setCallback(value: /* response */ CredentialResponse => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* response */ CredentialResponse) => value(t0).runNow()))
          ...
          inline def setNative_callback(value: /* response */ CredentialResponse => Callback): Self = StObject.set(x, "native_callback", js.Any.fromFunction1((t0: /* response */ CredentialResponse) => value(t0).runNow()))
    ...
    object oauth2 {
      ...
      object CodeClient {
        ...
        inline def apply(requestCode: Callback): CodeClient = {
          val __obj = js.Dynamic.literal(requestCode = requestCode.toJsFn)
          __obj.asInstanceOf[CodeClient]
        }
        
        extension [Self <: CodeClient](x: Self) {
          
          inline def setRequestCode(value: Callback): Self = StObject.set(x, "requestCode", value.toJsFn)
        }
      }
      ...
      object CodeClientConfig {
        ...
        extension [Self <: CodeClientConfig](x: Self) {
          ...
          inline def setCallback(value: /* response */ Any => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* response */ Any) => value(t0).runNow()))
      ...
      object TokenClientConfig {
        ...
        inline def apply(callback: TokenResponse => Callback, client_id: String): TokenClientConfig = {
          val __obj = js.Dynamic.literal(callback = js.Any.fromFunction1((t0: TokenResponse) => callback(t0).runNow()), client_id = client_id.asInstanceOf[js.Any])
          __obj.asInstanceOf[TokenClientConfig]
        }
        
        extension [Self <: TokenClientConfig](x: Self) {
          
          inline def setCallback(value: TokenResponse => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: TokenResponse) => value(t0).runNow()))
