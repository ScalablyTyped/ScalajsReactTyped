...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gtin.gtinStrings.`GTIN-8`
    - typingsJapgolly.gtin.gtinStrings.`GTIN-12`
    - typingsJapgolly.gtin.gtinStrings.`GTIN-13`
    - typingsJapgolly.gtin.gtinStrings.`GTIN-14`
  */
  trait GtinFormat extends StObject
  object GtinFormat {
    
    inline def `GTIN-12`: typingsJapgolly.gtin.gtinStrings.`GTIN-12` = "GTIN-12".asInstanceOf[typingsJapgolly.gtin.gtinStrings.`GTIN-12`]
    
    inline def `GTIN-13`: typingsJapgolly.gtin.gtinStrings.`GTIN-13` = "GTIN-13".asInstanceOf[typingsJapgolly.gtin.gtinStrings.`GTIN-13`]
    
    inline def `GTIN-14`: typingsJapgolly.gtin.gtinStrings.`GTIN-14` = "GTIN-14".asInstanceOf[typingsJapgolly.gtin.gtinStrings.`GTIN-14`]
    
    inline def `GTIN-8`: typingsJapgolly.gtin.gtinStrings.`GTIN-8` = "GTIN-8".asInstanceOf[typingsJapgolly.gtin.gtinStrings.`GTIN-8`]
  }
}
