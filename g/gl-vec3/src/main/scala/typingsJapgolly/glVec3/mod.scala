...
object mod {
  ...
  inline def angle(a: js.Array[Double], b: js.Array[Double]): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("angle")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  inline def fromValues(x: Double, y: Double, z: Double): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("fromValues")(x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
  ...
  inline def rotateX(out: js.Array[Double], a: js.Array[Double], b: js.Array[Double], c: Double): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("rotateX")(out.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
  
  inline def rotateY(out: js.Array[Double], a: js.Array[Double], b: js.Array[Double], c: Double): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("rotateY")(out.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
  
  inline def rotateZ(out: js.Array[Double], a: js.Array[Double], b: js.Array[Double], c: Double): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("rotateZ")(out.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
  ...
  inline def set(out: js.Array[Double], x: Double, y: Double, z: Double): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("set")(out.asInstanceOf[js.Any], x.asInstanceOf[js.Any], y.asInstanceOf[js.Any], z.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
