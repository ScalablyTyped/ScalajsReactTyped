...
object buildSrcCommonMod {
  ...
  object FetchResponse {
    ...
    inline def apply(
      arrayBuffer: CallbackTo[js.Promise[Any]],
      ...
      val __obj = js.Dynamic.literal(arrayBuffer = arrayBuffer.toJsFn, blob = blob.toJsFn, headers = headers.asInstanceOf[js.Any], json = json.toJsFn, status = status.asInstanceOf[js.Any], statusText = statusText.asInstanceOf[js.Any], text = text.toJsFn, url = url.asInstanceOf[js.Any], body = null)
      __obj.asInstanceOf[FetchResponse]
    }
    
    extension [Self <: FetchResponse](x: Self) {
      
      inline def setArrayBuffer(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "arrayBuffer", value.toJsFn)
