...
object mod {
  ...
  /**
    ...
    */
  open class Gaxios ()
    extends typingsJapgolly.gaxios.buildSrcGaxiosMod.Gaxios {
  ...
  open class GaxiosError[T] protected ()
    extends typingsJapgolly.gaxios.buildSrcCommonMod.GaxiosError[T] {
    def this(message: String, options: GaxiosOptions, response: GaxiosResponse[T]) = this()
  }
  
  @JSImport("gaxios", "instance")
  @js.native
  val instance: typingsJapgolly.gaxios.buildSrcGaxiosMod.Gaxios = js.native
