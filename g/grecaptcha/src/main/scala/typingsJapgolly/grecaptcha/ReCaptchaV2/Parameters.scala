...
object Parameters {
  ...
  def apply(
    badge: Badge = null,
    callback: /* response */ String => Callback = null,
    `error-callback`: js.UndefOr[Callback] = js.undefined,
    `expired-callback`: js.UndefOr[Callback] = js.undefined,
    ...
    if (callback != null) __obj.updateDynamic("callback")(js.Any.fromFunction1((t0: /* response */ java.lang.String) => callback(t0).runNow()))
    `error-callback`.foreach(p => __obj.updateDynamic("error-callback")(p.toJsFn))
    `expired-callback`.foreach(p => __obj.updateDynamic("expired-callback")(p.toJsFn))
