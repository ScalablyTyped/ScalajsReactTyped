...
import typingsJapgolly.gapiPagespeedonline.anon.CssResponsebytes
import typingsJapgolly.gapiPagespeedonline.anon.Locale
import typingsJapgolly.gapiPagespeedonline.anon.Major
