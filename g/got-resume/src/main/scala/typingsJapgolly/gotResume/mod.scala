...
import typingsJapgolly.gotResume.anon.ToFileOptionsPartialWithU
import typingsJapgolly.gotResume.gotResumeStrings.GotResumeCancelError
import typingsJapgolly.gotResume.gotResumeStrings.GotResumeError
import typingsJapgolly.gotResume.gotResumeStrings.GotResumeOptionsError
import typingsJapgolly.gotResume.gotResumeStrings.GotResumePreError
import typingsJapgolly.gotResume.gotResumeStrings.GotResumeTransferError
import typingsJapgolly.gotResume.gotResumeStrings.end
import typingsJapgolly.gotResume.gotResumeStrings.error
import typingsJapgolly.gotResume.gotResumeStrings.progress
import typingsJapgolly.gotResume.gotResumeStrings.response
...
object mod {
  ...
  open class Transfer protected () extends StObject {
    ...
    var prePromise: js.UndefOr[typingsJapgolly.bluebird.mod.^[Unit]] = js.native
  ...
  inline def toFile(path: String, options: ToFileOptionsWithUrl): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("toFile")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  /**
    ...
    */
  inline def toFile(path: String, url: String): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("toFile")(path.asInstanceOf[js.Any], url.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
  inline def toFile(path: String, url: String, options: ToFileOptions): typingsJapgolly.bluebird.mod.^[Unit] = (^.asInstanceOf[js.Dynamic].applyDynamic("toFile")(path.asInstanceOf[js.Any], url.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[Unit]]
