package typingsJapgolly.gotResume

import japgolly.scalajs.react.Callback
import typingsJapgolly.gotResume.mod.Progress
import typingsJapgolly.gotResume.mod.TimeoutSpec
...
object anon {
  ...
  object ToFileOptionsPartialWithU {
    ...
    extension [Self <: ToFileOptionsPartialWithU](x: Self) {
      ...
      inline def setOnProgress(value: /* progress */ Progress => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction1((t0: /* progress */ Progress) => value(t0).runNow()))
      
      inline def setOnProgressUndefined: Self = StObject.set(x, "onProgress", js.undefined)
      
      inline def setOnResponse(value: /* res */ IncomingMessage => Callback): Self = StObject.set(x, "onResponse", js.Any.fromFunction1((t0: /* res */ IncomingMessage) => value(t0).runNow()))
