...
trait Shared extends js.Object {
  ...
  def currencyFormatter(
    currency: String,
    options: typingsJapgolly.globalize.currencyMod.globalizeDistGlobalizeAugmentingMod.CurrencyFormatterOptions
  ...
  def dateFormatter(
    options: typingsJapgolly.globalize.dateMod.globalizeDistGlobalizeAugmentingMod.DateFormatterOptions
  ...
  def formatNumber(
    value: Double,
    options: typingsJapgolly.globalize.numberMod.globalizeDistGlobalizeAugmentingMod.NumberFormatterOptions
  ): String = js.native
  /**
  ...
  def formatRelativeTime(
    value: Double,
    unit: String,
    options: typingsJapgolly.globalize.relativeTimeMod.globalizeDistGlobalizeAugmentingMod.RelativeTimeFormatterOptions
  ): String = js.native
  /**
  ...
  def formatUnit(
    value: Double,
    unit: String,
    options: typingsJapgolly.globalize.unitMod.globalizeDistGlobalizeAugmentingMod.UnitFormatterOptions
  ): String = js.native
  /**
  ...
  def numberParser(
    options: typingsJapgolly.globalize.numberMod.globalizeDistGlobalizeAugmentingMod.NumberParserOptions
  ...
  def plural(
    value: Double,
    options: typingsJapgolly.globalize.pluralMod.globalizeDistGlobalizeAugmentingMod.PluralGeneratorOptions
  ): String = js.native
  /**
