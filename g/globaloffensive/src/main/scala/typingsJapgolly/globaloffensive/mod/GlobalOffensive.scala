...
import typingsJapgolly.globaloffensive.anon.MatchId
import typingsJapgolly.globaloffensive.globaloffensiveStrings.connectedToGC
import typingsJapgolly.globaloffensive.globaloffensiveStrings.connectionStatus
import typingsJapgolly.globaloffensive.globaloffensiveStrings.disconnectedFromGC
import typingsJapgolly.globaloffensive.globaloffensiveStrings.inspectItemInfo
import typingsJapgolly.globaloffensive.globaloffensiveStrings.inspectItemTimedOut
import typingsJapgolly.globaloffensive.globaloffensiveStrings.itemAcquired
import typingsJapgolly.globaloffensive.globaloffensiveStrings.itemChanged
import typingsJapgolly.globaloffensive.globaloffensiveStrings.itemCustomizationNotification
import typingsJapgolly.globaloffensive.globaloffensiveStrings.itemRemoved
import typingsJapgolly.globaloffensive.globaloffensiveStrings.matchList
import typingsJapgolly.globaloffensive.globaloffensiveStrings.playersProfile
...
trait GlobalOffensive extends EventEmitter {
  ...
  /**
    ...
    * @since v1.1
    */
  def inspectItem(owner: typingsJapgolly.steamid.mod.^): Unit = js.native
  def inspectItem(owner: typingsJapgolly.steamid.mod.^, assetid: String): Unit = js.native
  def inspectItem(owner: typingsJapgolly.steamid.mod.^, assetid: String, d: String): Unit = js.native
  def inspectItem(
    owner: typingsJapgolly.steamid.mod.^,
    assetid: String,
    d: String,
  ...
  def inspectItem(owner: typingsJapgolly.steamid.mod.^, assetid: Unit, d: String): Unit = js.native
  def inspectItem(
    owner: typingsJapgolly.steamid.mod.^,
    assetid: Unit,
    d: String,
  ...
  @JSName("off")
  def off_accountData(
    event: typingsJapgolly.globaloffensive.globaloffensiveStrings.accountData,
  ...
  def removeAllListeners(
    event: connectedToGC | disconnectedFromGC | typingsJapgolly.globaloffensive.globaloffensiveStrings.accountData | connectionStatus | matchList | inspectItemInfo | inspectItemTimedOut | itemAcquired | itemChanged | itemRemoved | itemCustomizationNotification | playersProfile
  ): this.type = js.native
  ...
  /**
    ...
    */
  def requestLiveGameForUser(steamid: typingsJapgolly.steamid.mod.^): Unit = js.native
  ...
  /**
    ...
    * @since v1.2
    */
  def requestPlayersProfile(steamid: typingsJapgolly.steamid.mod.^): Unit = js.native
  def requestPlayersProfile(steamid: typingsJapgolly.steamid.mod.^, callback: js.Function1[/* profile */ Profile, Unit]): Unit = js.native
  ...
  /**
    ...
    * @param steamid the users steamid
    */
  def requestRecentGames(steamid: typingsJapgolly.steamid.mod.^): Unit = js.native
}
