package typingsJapgolly.googleCloudPaginator.mod
...
class Paginator_ () extends js.Object {
  ...
  /**
    ...
    */
  def runAsStream_[T](parsedArguments: ParsedArguments, originalMethod: js.Function): typingsJapgolly.googleCloudPaginator.resourceStreamMod.ResourceStream[T] = js.native
  /**
  ...
  def streamify[T](methodName: String): js.ThisFunction1[
    ...
    /* repeated */ js.Any, 
    typingsJapgolly.googleCloudPaginator.resourceStreamMod.ResourceStream[T]
  ] = js.native
}
