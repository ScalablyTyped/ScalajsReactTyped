...
object mod {
  ...
  open class Paginator_ () extends StObject {
    ...
    /**
      ...
      */
    def runAsStream_[T](parsedArguments: ParsedArguments, originalMethod: js.Function): typingsJapgolly.googleCloudPaginator.buildSrcResourceStreamMod.ResourceStream[T] = js.native
    ...
    def streamify[T](methodName: String): js.ThisFunction1[
        ...
        /* repeated */ Any, 
        typingsJapgolly.googleCloudPaginator.buildSrcResourceStreamMod.ResourceStream[T]
      ] = js.native
  }
  ...
  open class ResourceStream[T] protected ()
    extends typingsJapgolly.googleCloudPaginator.buildSrcResourceStreamMod.ResourceStream[T] {
