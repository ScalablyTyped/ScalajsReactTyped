...
import typingsJapgolly.gapiClientAndroidmanagement.AnonBearertoken
...
object OperationsResource {
  ...
  def apply(
    ...
    __obj.updateDynamic("cancel")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientAndroidmanagement.AnonAlt) => cancel(t0).runNow()))
    ...
    __obj.updateDynamic("list")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientAndroidmanagement.AnonBearertoken) => list(t0).runNow()))
