...
import typingsJapgolly.gradientParser.gradientParserStrings.circle
import typingsJapgolly.gradientParser.gradientParserStrings.ellipse
import typingsJapgolly.gradientParser.gradientParserStrings.shape
