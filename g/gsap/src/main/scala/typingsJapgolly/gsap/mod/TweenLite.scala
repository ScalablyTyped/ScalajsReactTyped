...
class TweenLite protected ()
  extends typingsJapgolly.gsap.gsap.TweenLite {
...
object TweenLite extends js.Object {
  ...
  var defaultEase: typingsJapgolly.gsap.gsap.Ease = js.native
  ...
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit]): typingsJapgolly.gsap.gsap.TweenLite = js.native
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit], params: js.Array[_]): typingsJapgolly.gsap.gsap.TweenLite = js.native
  def delayedCall(
    delay: Double,
    callback: js.Function1[/* repeated */ js.Any, Unit],
    params: js.Array[_],
    scope: js.Any
  ): typingsJapgolly.gsap.gsap.TweenLite = js.native
  def delayedCall(
    delay: Double,
    callback: js.Function1[/* repeated */ js.Any, Unit],
    params: js.Array[_],
  ...
  /**
    ...
    */
  def from(target: js.Any, duration: Double, vars: js.Any): typingsJapgolly.gsap.gsap.TweenLite = js.native
  /**
    ...
    */
  def fromTo(target: js.Any, duration: Double, fromVars: js.Any, toVars: js.Any): typingsJapgolly.gsap.gsap.TweenLite = js.native
  /**
    ...
    */
  def getTweensOf(target: js.Any): js.Array[typingsJapgolly.gsap.gsap.TweenLite] = js.native
  def getTweensOf(target: js.Any, onlyActive: Boolean): js.Array[typingsJapgolly.gsap.gsap.TweenLite] = js.native
  ...
  def set(target: js.Any, vars: js.Any): typingsJapgolly.gsap.gsap.TweenLite = js.native
  ...
  def to(target: js.Any, duration: Double, vars: js.Any): typingsJapgolly.gsap.gsap.TweenLite = js.native
}
