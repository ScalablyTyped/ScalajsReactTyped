...
import typingsJapgolly.gsap.gsap.Tween
import typingsJapgolly.gsap.gsap.TweenConfig
...
class TweenMax protected ()
  extends typingsJapgolly.gsap.gsap.TweenMax {
...
object TweenMax extends js.Object {
  ...
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit]): typingsJapgolly.gsap.gsap.TweenMax = js.native
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit], params: js.Array[_]): typingsJapgolly.gsap.gsap.TweenMax = js.native
  def delayedCall(
    delay: Double,
    callback: js.Function1[/* repeated */ js.Any, Unit],
    params: js.Array[_],
    scope: js.Object
  ): typingsJapgolly.gsap.gsap.TweenMax = js.native
  def delayedCall(
    delay: Double,
    callback: js.Function1[/* repeated */ js.Any, Unit],
    params: js.Array[_],
  ...
  /**
    ...
    */
  def from(target: js.Object, duration: Double, vars: js.Object): typingsJapgolly.gsap.gsap.TweenMax = js.native
  /**
    ...
    */
  def fromTo(target: js.Object, duration: Double, fromVars: js.Object, toVars: js.Object): typingsJapgolly.gsap.gsap.TweenMax = js.native
  ...
  def set(target: js.Object, vars: js.Object): typingsJapgolly.gsap.gsap.TweenMax = js.native
  /**
  ...
  def to(target: js.Object, duration: Double, vars: TweenConfig): typingsJapgolly.gsap.gsap.TweenMax = js.native
}
