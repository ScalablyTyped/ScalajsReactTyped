...
- typingsJapgolly.gsap.gsap.Tween because Already inherited */ @JSGlobal("gsap.TweenMax")
@js.native
...
object TweenMax extends js.Object {
  ...
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit]): TweenMax = js.native
  def delayedCall(delay: Double, callback: js.Function1[/* repeated */ js.Any, Unit], params: js.Array[_]): TweenMax = js.native
  def delayedCall(
    delay: Double,
  ...
  /**
    ...
    */
  def from(target: js.Object, duration: Double, vars: js.Object): TweenMax = js.native
  /**
    ...
    */
  def fromTo(target: js.Object, duration: Double, fromVars: js.Object, toVars: js.Object): TweenMax = js.native
  ...
  def set(target: js.Object, vars: js.Object): TweenMax = js.native
  /**
  ...
  def to(target: js.Object, duration: Double, vars: TweenConfig): TweenMax = js.native
}
