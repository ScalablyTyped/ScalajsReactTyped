...
object TweenConfig {
  ...
  /* p */ StringDictionary[js.Any] = null,
    ...
    onComplete: /* repeated */ js.Any => Callback = null,
    onCompleteParams: js.Array[_] = null,
    onCompleteScope: js.Object = null,
    onOverwrite: /* repeated */ js.Any => Callback = null,
    onRepeat: /* repeated */ js.Any => Callback = null,
    onRepeatScope: js.Object = null,
    onReverseComplete: /* repeated */ js.Any => Callback = null,
    onReverseCompleteParams: js.Array[_] = null,
    onReverseCompleteScope: js.Object = null,
    onStart: /* repeated */ js.Any => Callback = null,
    ...
    if (onComplete != null) __obj.updateDynamic("onComplete")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onComplete(t0).runNow()))
    ...
    if (onOverwrite != null) __obj.updateDynamic("onOverwrite")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onOverwrite(t0).runNow()))
    if (onRepeat != null) __obj.updateDynamic("onRepeat")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onRepeat(t0).runNow()))
    if (onRepeatScope != null) __obj.updateDynamic("onRepeatScope")(onRepeatScope.asInstanceOf[js.Any])
    if (onReverseComplete != null) __obj.updateDynamic("onReverseComplete")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onReverseComplete(t0).runNow()))
    ...
    if (onStart != null) __obj.updateDynamic("onStart")(js.Any.fromFunction1((t0: /* repeated */ js.Any) => onStart(t0).runNow()))
