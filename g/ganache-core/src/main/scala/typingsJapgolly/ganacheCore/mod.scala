...
import typingsJapgolly.ganacheCore.anon.Log
...
import typingsJapgolly.ganacheCore.mod.Ganache.Server
...
object mod {
  ...
  object Ganache {
    ...
    object Provider {
      ...
      inline def apply(
        close: js.Function => Callback,
        on: (String, js.Function0[Unit]) => Callback,
        once: (String, js.Function0[Unit]) => Callback,
        removeAllListeners: String => Callback,
        removeListener: (String, js.Function0[Unit]) => Callback,
        send: (JsonRpcPayload, js.Function2[/* error */ js.Error | Null, /* result */ js.UndefOr[JsonRpcResponse], Unit]) => Callback
      ): Provider = {
        val __obj = js.Dynamic.literal(close = js.Any.fromFunction1((t0: js.Function) => close(t0).runNow()), on = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (on(t0, t1)).runNow()), once = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (once(t0, t1)).runNow()), removeAllListeners = js.Any.fromFunction1((t0: String) => removeAllListeners(t0).runNow()), removeListener = js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (removeListener(t0, t1)).runNow()), send = js.Any.fromFunction2((t0: JsonRpcPayload, t1: js.Function2[/* error */ js.Error | Null, /* result */ js.UndefOr[JsonRpcResponse], Unit]) => (send(t0, t1)).runNow()))
        __obj.asInstanceOf[Provider]
      }
      
      extension [Self <: Provider](x: Self) {
        
        inline def setClose(value: js.Function => Callback): Self = StObject.set(x, "close", js.Any.fromFunction1((t0: js.Function) => value(t0).runNow()))
        ...
        inline def setOnce(value: (String, js.Function0[Unit]) => Callback): Self = StObject.set(x, "once", js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
        
        inline def setRemoveAllListeners(value: String => Callback): Self = StObject.set(x, "removeAllListeners", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
        
        inline def setRemoveListener(value: (String, js.Function0[Unit]) => Callback): Self = StObject.set(x, "removeListener", js.Any.fromFunction2((t0: String, t1: js.Function0[Unit]) => (value(t0, t1)).runNow()))
        
        inline def setSend(
          value: (JsonRpcPayload, js.Function2[/* error */ js.Error | Null, /* result */ js.UndefOr[JsonRpcResponse], Unit]) => Callback
        ): Self = StObject.set(x, "send", js.Any.fromFunction2((t0: JsonRpcPayload, t1: js.Function2[/* error */ js.Error | Null, /* result */ js.UndefOr[JsonRpcResponse], Unit]) => (value(t0, t1)).runNow()))
      }
    }
