...
object utmMod {
  ...
  @js.native
  open class Dms ()
    extends typingsJapgolly.geodesy.latlonEllipsoidalDatumMod.Dms
  object Dms {
  ...
  */
  ...
  object Hemisphere {
    ...
    inline def N: typingsJapgolly.geodesy.geodesyStrings.N = "N".asInstanceOf[typingsJapgolly.geodesy.geodesyStrings.N]
    
    inline def S: typingsJapgolly.geodesy.geodesyStrings.S = "S".asInstanceOf[typingsJapgolly.geodesy.geodesyStrings.S]
  }
