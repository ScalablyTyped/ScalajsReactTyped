...
import typingsJapgolly.geodesy.mod.GeoJSON
import typingsJapgolly.geodesy.mod.Polygon
...
object latlonNvectorSphericalMod extends js.Object {
  ...
  @js.native
  class Dms ()
    extends typingsJapgolly.geodesy.dmsMod.default
  ...
  trait LatLonNvectorSpherical extends js.Object {
    ...
    def greatCircle(bearing: Double): typingsJapgolly.geodesy.vector3dMod.default = js.native
  ...
  trait NvectorSpherical
    extends typingsJapgolly.geodesy.vector3dMod.default {
    def greatCircle(bearing: Double): typingsJapgolly.geodesy.vector3dMod.default = js.native
