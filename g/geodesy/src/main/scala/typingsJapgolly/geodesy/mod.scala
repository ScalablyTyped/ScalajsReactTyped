...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.geodesy.geodesyStrings.d
    - typingsJapgolly.geodesy.geodesyStrings.dm
    - typingsJapgolly.geodesy.geodesyStrings.dms
  */
  trait Format extends StObject
  object Format {
    
    inline def d: typingsJapgolly.geodesy.geodesyStrings.d = "d".asInstanceOf[typingsJapgolly.geodesy.geodesyStrings.d]
    
    inline def dm: typingsJapgolly.geodesy.geodesyStrings.dm = "dm".asInstanceOf[typingsJapgolly.geodesy.geodesyStrings.dm]
    
    inline def dms: typingsJapgolly.geodesy.geodesyStrings.dms = "dms".asInstanceOf[typingsJapgolly.geodesy.geodesyStrings.dms]
  }
