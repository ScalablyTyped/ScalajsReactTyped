...
import typingsJapgolly.gapiClientToolresults.AnonAltFields
...
object ProjectsResource {
  @scala.inline
  def apply(
    getSettings: AnonAltFields => CallbackTo[Request_[ProjectSettings]],
    histories: HistoriesResource,
    initializeSettings: AnonAltFields => CallbackTo[Request_[ProjectSettings]]
  ): ProjectsResource = {
    val __obj = js.Dynamic.literal(histories = histories.asInstanceOf[js.Any])
    __obj.updateDynamic("getSettings")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientToolresults.AnonAltFields) => getSettings(t0).runNow()))
    __obj.updateDynamic("initializeSettings")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientToolresults.AnonAltFields) => initializeSettings(t0).runNow()))
