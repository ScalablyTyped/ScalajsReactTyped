package typingsJapgolly.gitlab.baseServiceMod

import typingsJapgolly.gitlab.gitlabNumbers.`3`
import typingsJapgolly.gitlab.gitlabNumbers.`4`
import typingsJapgolly.gitlab.gitlabStrings.execution
import typingsJapgolly.gitlab.gitlabStrings.memory
