...
import typingsJapgolly.gitlab.jobsMod.JobScope
import typingsJapgolly.gitlab.notificationSettingsMod.NotificationSettingLevel
import typingsJapgolly.gitlab.servicesServicesMod.SupportedService
import typingsJapgolly.gitlab.snippetsMod.SnippetVisibility
import typingsJapgolly.gitlab.userImpersonationTokensMod.ImpersonationTokenScope
