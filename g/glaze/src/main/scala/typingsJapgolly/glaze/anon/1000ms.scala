...
import typingsJapgolly.glaze.glazeStrings.Dot15s
import typingsJapgolly.glaze.glazeStrings.Dot1s
import typingsJapgolly.glaze.glazeStrings.Dot2s
import typingsJapgolly.glaze.glazeStrings.Dot3s
import typingsJapgolly.glaze.glazeStrings.Dot5s
import typingsJapgolly.glaze.glazeStrings.Dot7s
import typingsJapgolly.glaze.glazeStrings.`1s`
import typingsJapgolly.glaze.glazeStrings.`75ms`
...
trait `1000ms` extends StObject {
  ...
  val `75ms`: typingsJapgolly.glaze.glazeStrings.`75ms`
}
object `1000ms` {
