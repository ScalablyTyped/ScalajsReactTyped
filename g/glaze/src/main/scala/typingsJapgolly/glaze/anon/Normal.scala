...
import typingsJapgolly.glaze.glazeStrings.Dot025em
import typingsJapgolly.glaze.glazeStrings.Dot05em
import typingsJapgolly.glaze.glazeStrings.Dot1em
import typingsJapgolly.glaze.glazeStrings.`-0Dot025em`
import typingsJapgolly.glaze.glazeStrings.`-0Dot05em`
...
trait Normal extends StObject {
  ...
  val normal: typingsJapgolly.glaze.glazeInts.`0`
...
object Normal {
  ...
  extension [Self <: Normal](x: Self) {
    ...
    inline def setNormal(value: typingsJapgolly.glaze.glazeInts.`0`): Self = StObject.set(x, "normal", value.asInstanceOf[js.Any])
