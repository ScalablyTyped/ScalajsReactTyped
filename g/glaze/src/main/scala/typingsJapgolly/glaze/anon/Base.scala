...
import typingsJapgolly.glaze.glazeDoubles.`1.25`
import typingsJapgolly.glaze.glazeDoubles.`1.375`
import typingsJapgolly.glaze.glazeDoubles.`1.5`
import typingsJapgolly.glaze.glazeDoubles.`1.625`
...
trait Base extends StObject {
  ...
  val loose: typingsJapgolly.glaze.glazeInts.`2`
...
object Base {
  ...
  extension [Self <: Base](x: Self) {
    ...
    inline def setLoose(value: typingsJapgolly.glaze.glazeInts.`2`): Self = StObject.set(x, "loose", value.asInstanceOf[js.Any])
