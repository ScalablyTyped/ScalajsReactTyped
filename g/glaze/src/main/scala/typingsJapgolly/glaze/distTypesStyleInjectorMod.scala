...
import typingsJapgolly.glaze.distTypesRuleManagerMod.RuleManager
...
object distTypesStyleInjectorMod {
  ...
  object StyleInjector {
    ...
    inline def apply(addRule: String => Double, nullifyRule: Double => Callback, ruleManager: RuleManager): StyleInjector = {
      val __obj = js.Dynamic.literal(addRule = js.Any.fromFunction1(addRule), nullifyRule = js.Any.fromFunction1((t0: Double) => nullifyRule(t0).runNow()), ruleManager = ruleManager.asInstanceOf[js.Any])
    ...
    extension [Self <: StyleInjector](x: Self) {
      ...
      inline def setNullifyRule(value: Double => Callback): Self = StObject.set(x, "nullifyRule", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
