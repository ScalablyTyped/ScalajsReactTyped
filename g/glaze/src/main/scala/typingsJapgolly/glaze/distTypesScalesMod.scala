...
object distTypesScalesMod {
  ...
  inline def symmetricScale[T /* <: String | Double */](
    nonNegativeTokens: /* import warning: importer.ImportType#apply Failed type conversion: {[ key in T ]: string | number} */ js.Any
  ): /* import warning: importer.ImportType#apply Failed type conversion: {readonly [ key in T | glaze.glaze/dist-types/scales.Negate<std.Extract<T, number>> | T extends '1px'? '-1px' : never ]: string | number} */ js.Any = ^.asInstanceOf[js.Dynamic].applyDynamic("symmetricScale")(nonNegativeTokens.asInstanceOf[js.Any]).asInstanceOf[/* import warning: importer.ImportType#apply Failed type conversion: {readonly [ key in T | glaze.glaze/dist-types/scales.Negate<std.Extract<T, number>> | T extends '1px'? '-1px' : never ]: string | number} */ js.Any]
