...
object mod {
  ...
  object ConnectAppOptions {
    ...
    extension [Self <: ConnectAppOptions](x: Self) {
      ...
      inline def setMiddleware(
        value: (/* connect */ js.Function0[typingsJapgolly.connect.mod.Server], /* options */ ConnectAppOptions) => js.Array[HandleFunction | ConnectRouteHandler]
      ...
      ): Self = StObject.set(x, "serverInit", js.Any.fromFunction1((t0: /* server */ (Server[
              Instantiable1[/* socket */ Socket, typingsJapgolly.node.httpMod.IncomingMessage], 
              Instantiable1[
                /* import warning: RewrittenClass.unapply cls was tparam Request */ /* req */ Any, 
                typingsJapgolly.node.httpMod.ServerResponse[typingsJapgolly.node.httpMod.IncomingMessage]
  ...
  type MiddlewareFactory = js.Function2[
    /* connect */ js.Function0[typingsJapgolly.connect.mod.Server], 
