...
open class KmlLayerRoot ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlLayerRoot {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLayerById(id: String): typingsJapgolly.googleEarth.google.earth.KmlLayer = js.native
