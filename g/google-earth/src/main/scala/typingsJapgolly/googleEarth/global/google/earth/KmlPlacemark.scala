...
open class KmlPlacemark ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlPlacemark {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getGeometry(): typingsJapgolly.googleEarth.google.earth.KmlGeometry = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setGeometry(geometry: typingsJapgolly.googleEarth.google.earth.KmlGeometry): Unit = js.native
