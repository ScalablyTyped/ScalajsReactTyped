...
open class KmlDocument ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlDocument {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getElementsByStyleUrl(styleUrl: String): typingsJapgolly.googleEarth.google.earth.KmlObjectList[typingsJapgolly.googleEarth.google.earth.KmlObject] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getStyleSelectors(): typingsJapgolly.googleEarth.google.earth.GEStyleSelectorContainer = js.native
