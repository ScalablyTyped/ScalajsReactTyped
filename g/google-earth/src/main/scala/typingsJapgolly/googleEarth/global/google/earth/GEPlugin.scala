...
import typingsJapgolly.googleEarth.google.earth.GEHitTestModeEnum
import typingsJapgolly.googleEarth.google.earth.GEMapTypeEnum
import typingsJapgolly.googleEarth.google.earth.GENavigationControlEnum
...
open class GEPlugin ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.GEPlugin {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createCamera(id: String): typingsJapgolly.googleEarth.google.earth.KmlCamera = js.native
  
  /**
    * Creates a Document. A Document is a container for features and styles.
    */
  /* CompleteClass */
  override def createDocument(id: String): typingsJapgolly.googleEarth.google.earth.KmlDocument = js.native
  
  /**
    * Creates a Feature balloon.
    */
  /* CompleteClass */
  override def createFeatureBalloon(id: String): typingsJapgolly.googleEarth.google.earth.GEFeatureBalloon = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createFolder(id: String): typingsJapgolly.googleEarth.google.earth.KmlFolder = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createGroundOverlay(id: String): typingsJapgolly.googleEarth.google.earth.KmlGroundOverlay = js.native
  
  /**
    * Creates an Html Div Balloon.
    */
  /* CompleteClass */
  override def createHtmlDivBalloon(id: String): typingsJapgolly.googleEarth.google.earth.GEHtmlDivBalloon = js.native
  
  /**
    * Creates an HTML string balloon.
    */
  /* CompleteClass */
  override def createHtmlStringBalloon(id: String): typingsJapgolly.googleEarth.google.earth.GEHtmlStringBalloon = js.native
  
  /**
    * Creates an Icon. An icon defines an image associated with an Icon style or overlay.
    */
  /* CompleteClass */
  override def createIcon(id: String): typingsJapgolly.googleEarth.google.earth.KmlIcon = js.native
  
  /**
    * Creates a LatLonAltBox, a bounding box that describes an area of interest defined by geographic coordinates and altitudes.
    */
  /* CompleteClass */
  override def createLatLonAltBox(id: String): typingsJapgolly.googleEarth.google.earth.KmlLatLonAltBox = js.native
  
  /**
    * Creates a LatLonBox, a bounding box that describes an area of interest defined by geographic coordinates and altitudes.
    */
  /* CompleteClass */
  override def createLatLonBox(id: String): typingsJapgolly.googleEarth.google.earth.KmlLatLonBox = js.native
  
  /**
    * Creates a line string on Google Earth.
    */
  /* CompleteClass */
  override def createLineString(id: String): typingsJapgolly.googleEarth.google.earth.KmlLineString = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createLinearRing(id: String): typingsJapgolly.googleEarth.google.earth.KmlLinearRing = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createLink(id: String): typingsJapgolly.googleEarth.google.earth.KmlLink = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createLocation(id: String): typingsJapgolly.googleEarth.google.earth.KmlLocation = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createLod(id: String): typingsJapgolly.googleEarth.google.earth.KmlLod = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createLookAt(id: String): typingsJapgolly.googleEarth.google.earth.KmlLookAt = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createModel(id: String): typingsJapgolly.googleEarth.google.earth.KmlModel = js.native
  
  /**
    * Creates a container for one or more geometry primitives associated with the same feature.
    */
  /* CompleteClass */
  override def createMultiGeometry(id: String): typingsJapgolly.googleEarth.google.earth.KmlMultiGeometry = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createNetworkLink(id: String): typingsJapgolly.googleEarth.google.earth.KmlNetworkLink = js.native
  
  /**
    * Sets the rotation of a 3D model's coordinate system to position the object in Google Earth.
    */
  /* CompleteClass */
  override def createOrientation(id: String): typingsJapgolly.googleEarth.google.earth.KmlOrientation = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createPlacemark(id: String): typingsJapgolly.googleEarth.google.earth.KmlPlacemark = js.native
  
  /**
    * Creates a point on the globe. Specifies the geographic location defined by longitude, latitude, and (optional) altitude.
    */
  /* CompleteClass */
  override def createPoint(id: String): typingsJapgolly.googleEarth.google.earth.KmlPoint = js.native
  
  /**
    * Creates a Polygon. A Polygon is defined by an outer boundary and 0 or more inner boundaries.
    */
  /* CompleteClass */
  override def createPolygon(id: String): typingsJapgolly.googleEarth.google.earth.KmlPolygon = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createRegion(id: String): typingsJapgolly.googleEarth.google.earth.KmlRegion = js.native
  
  /**
    * Sets the scale of a model along the x, y, and z axes in the model's coordinate space.
    */
  /* CompleteClass */
  override def createScale(id: String): typingsJapgolly.googleEarth.google.earth.KmlScale = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createScreenOverlay(id: String): typingsJapgolly.googleEarth.google.earth.KmlScreenOverlay = js.native
  
  /**
    * A Style defines an addressable style group that can be referenced by StyleMaps and features.
    */
  /* CompleteClass */
  override def createStyle(id: String): typingsJapgolly.googleEarth.google.earth.KmlStyle = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createStyleMap(id: String): typingsJapgolly.googleEarth.google.earth.KmlStyleMap = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createTimeSpan(id: String): typingsJapgolly.googleEarth.google.earth.KmlTimeSpan = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def createTimeStamp(id: String): typingsJapgolly.googleEarth.google.earth.KmlTimeStamp = js.native
  
  /**
    * Creates a new viewer options object.
    */
  /* CompleteClass */
  override def createViewerOptions(id: String): typingsJapgolly.googleEarth.google.earth.KmlViewerOptions = js.native
  
  /**
    * Returns the currently active balloon, or null.
    */
  /* CompleteClass */
  override def getBalloon(): typingsJapgolly.googleEarth.google.earth.GEAbstractBalloon = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getElementsByType(): typingsJapgolly.googleEarth.google.earth.KmlObjectList[typingsJapgolly.googleEarth.google.earth.KmlObject] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getGlobe(): typingsJapgolly.googleEarth.google.earth.GEGlobe = js.native
  
  /**
    * Controls built-in layer behavior.
    */
  /* CompleteClass */
  override def getLayerRoot(): typingsJapgolly.googleEarth.google.earth.KmlLayerRoot = js.native
  
  /**
    * Controls the navigation controls on the globe.
    */
  /* CompleteClass */
  override def getNavigationControl(): typingsJapgolly.googleEarth.google.earth.GENavigationControl = js.native
  
  /**
    * The options used to manipulate the behavior of the Google Earth plugin.
    */
  /* CompleteClass */
  override def getOptions(): typingsJapgolly.googleEarth.google.earth.GEOptions = js.native
  
  /**
    * Exposes functionality for interacting with photo overlays.
    */
  /* CompleteClass */
  override def getPhotoOverlayViewer(): typingsJapgolly.googleEarth.google.earth.GEPhotoOverlayViewer = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getSun(): typingsJapgolly.googleEarth.google.earth.GESun = js.native
  
  /**
    * The time class used to manipulate the behavior of the Google Earth plugin time.
    */
  /* CompleteClass */
  override def getTime(): typingsJapgolly.googleEarth.google.earth.GETime = js.native
  
  /**
    * Exposes functionality for interacting with KML tours.
    */
  /* CompleteClass */
  override def getTourPlayer(): typingsJapgolly.googleEarth.google.earth.GETourPlayer = js.native
  
  /**
    * Controls the plugin viewport.
    */
  /* CompleteClass */
  override def getView(): typingsJapgolly.googleEarth.google.earth.GEView = js.native
  
  /**
    * Controls the window options.
    */
  /* CompleteClass */
  override def getWindow(): typingsJapgolly.googleEarth.google.earth.GEWindow = js.native
  
  /**
    * Parse a string of KML and return a handle to the root of the KML object structure that was created.
    */
  /* CompleteClass */
  override def parseKml(kml: String): typingsJapgolly.googleEarth.google.earth.KmlObject = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setBalloon(newActiveBalloon: typingsJapgolly.googleEarth.google.earth.GEAbstractBalloon): Unit = js.native
}
