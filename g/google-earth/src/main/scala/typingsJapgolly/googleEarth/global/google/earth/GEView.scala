...
open class GEView ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.GEView {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copyAsCamera(altitudeMode: KmlAltitudeModeEnum): typingsJapgolly.googleEarth.google.earth.KmlCamera = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copyAsLookAt(altitudeMode: KmlAltitudeModeEnum): typingsJapgolly.googleEarth.google.earth.KmlLookAt = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getViewportGlobeBounds(): typingsJapgolly.googleEarth.google.earth.KmlLatLonBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def hitTest(x: Double, xUnits: KmlUnitsEnum, y: Double, yUnits: KmlUnitsEnum, mode: GEHitTestModeEnum): typingsJapgolly.googleEarth.google.earth.GEHitTestResult = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def project(lat: Double, lng: Double, alt: Double, altitudeMode: KmlAltitudeModeEnum): typingsJapgolly.googleEarth.google.earth.KmlVec2 = js.native
  
  /**
    * Sets the camera that views the scene in Google Earth.
    */
  /* CompleteClass */
  override def setAbstractView(view: typingsJapgolly.googleEarth.google.earth.KmlAbstractView): Unit = js.native
}
