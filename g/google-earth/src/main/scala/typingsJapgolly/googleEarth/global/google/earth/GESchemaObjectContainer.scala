...
@js.native
open class GESchemaObjectContainer[T /* <: typingsJapgolly.googleEarth.google.earth.KmlObject */] ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.GESchemaObjectContainer[T] {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getChildNodes(): typingsJapgolly.googleEarth.google.earth.KmlObjectList[T] = js.native
