...
open class KmlCoordArray ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlCoordArray {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def get(index: Double): typingsJapgolly.googleEarth.google.earth.KmlCoord = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def pop(): typingsJapgolly.googleEarth.google.earth.KmlCoord = js.native
  
  /**
    * Appends one or more new elements to the end of an array and returns the new length of the array.
    */
  /* CompleteClass */
  override def push(coordOrList: typingsJapgolly.googleEarth.google.earth.KmlCoord): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def set(index: Double, coord: typingsJapgolly.googleEarth.google.earth.KmlCoord): Unit = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def shift(): typingsJapgolly.googleEarth.google.earth.KmlCoord = js.native
  
  /**
    * Adds an element or elements to the beginning of an array.
    */
  /* CompleteClass */
  override def unshift(coordOrList: typingsJapgolly.googleEarth.google.earth.KmlCoord): Double = js.native
