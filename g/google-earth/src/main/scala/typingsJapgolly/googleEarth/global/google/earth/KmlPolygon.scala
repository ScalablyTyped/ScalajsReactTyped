...
open class KmlPolygon ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlPolygon {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getInnerBoundaries(): typingsJapgolly.googleEarth.google.earth.GELinearRingContainer = js.native
  
  /**
    * Contains a LinearRing element.
    */
  /* CompleteClass */
  override def getOuterBoundary(): typingsJapgolly.googleEarth.google.earth.KmlLinearRing = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setOuterBoundary(outerBoundary: typingsJapgolly.googleEarth.google.earth.KmlLinearRing): Unit = js.native
