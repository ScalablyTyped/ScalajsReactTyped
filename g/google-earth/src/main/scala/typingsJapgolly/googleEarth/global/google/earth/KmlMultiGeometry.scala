...
@js.native
open class KmlMultiGeometry ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlMultiGeometry {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getGeometries(): typingsJapgolly.googleEarth.google.earth.GEGeometryContainer = js.native
