...
import typingsJapgolly.googleEarth.google.earth.KmlListItemTypeEnum
...
@js.native
open class KmlListStyle ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlListStyle {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBgColor(): typingsJapgolly.googleEarth.google.earth.KmlColor = js.native
