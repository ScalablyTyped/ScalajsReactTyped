...
open class KmlTimeSpan ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlTimeSpan {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getBegin(): typingsJapgolly.googleEarth.google.earth.KmlDateTime = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getEnd(): typingsJapgolly.googleEarth.google.earth.KmlDateTime = js.native
