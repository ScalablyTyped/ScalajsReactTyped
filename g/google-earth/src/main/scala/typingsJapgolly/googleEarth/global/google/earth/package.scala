...
import typingsJapgolly.googleEarth.global.google.earth.^
...
inline def addEventListener(
  targetObject: Any,
  eventID: String,
  listenerCallback: js.Function1[/* event */ typingsJapgolly.googleEarth.google.earth.KmlEvent, Unit]
...
inline def createInstance(
  domNode: String,
  initCallback: js.Function1[/* plugin */ typingsJapgolly.googleEarth.google.earth.GEPlugin, Unit],
...
inline def executeBatch(pluginInstance: typingsJapgolly.googleEarth.google.earth.GEPlugin, batchFunction: js.Function): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("executeBatch")(pluginInstance.asInstanceOf[js.Any], batchFunction.asInstanceOf[js.Any])).asInstanceOf[Unit]

inline def fetchKml(
  pluginInstance: typingsJapgolly.googleEarth.google.earth.GEPlugin,
  url: String,
  completionCallback: js.Function1[/* feature */ typingsJapgolly.googleEarth.google.earth.KmlFeature, Unit]
