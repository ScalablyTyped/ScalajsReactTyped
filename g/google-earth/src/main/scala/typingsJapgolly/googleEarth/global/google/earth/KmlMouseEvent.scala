...
import typingsJapgolly.googleEarth.google.earth.GEEventPhaseEnum
...
@js.native
open class KmlMouseEvent ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlMouseEvent {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var getCurrentTarget: typingsJapgolly.googleEarth.google.earth.GEEventEmitter = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getRelatedTarget(): typingsJapgolly.googleEarth.google.earth.GEEventEmitter = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getTarget(): typingsJapgolly.googleEarth.google.earth.GEEventEmitter = js.native
