...
open class KmlLookAt ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlLookAt {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copyAsCamera(): typingsJapgolly.googleEarth.google.earth.KmlCamera = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def copyAsLookAt(): typingsJapgolly.googleEarth.google.earth.KmlLookAt = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getViewerOptions(): typingsJapgolly.googleEarth.google.earth.KmlViewerOptions = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setViewerOptions(viewerOptions: typingsJapgolly.googleEarth.google.earth.KmlViewerOptions): Unit = js.native
}
