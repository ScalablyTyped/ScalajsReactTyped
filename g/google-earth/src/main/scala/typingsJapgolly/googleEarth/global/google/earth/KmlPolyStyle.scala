...
@js.native
open class KmlPolyStyle ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlPolyStyle {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getFill(): Boolean = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getOutline(): Boolean = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setFill(fill: Boolean): Unit = js.native
  
  /**
    * Specifies whether to outline the polygon. Polygon outlines use the current KmlLineStyle.
    */
  /* CompleteClass */
  override def setOutline(outline: Boolean): Unit = js.native
}
