...
open class KmlLinearRing ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlLineString {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getCoordinates(): typingsJapgolly.googleEarth.google.earth.KmlCoordArray = js.native
