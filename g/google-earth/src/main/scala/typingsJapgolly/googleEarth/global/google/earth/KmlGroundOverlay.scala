...
open class KmlGroundOverlay ()
  extends StObject
     with typingsJapgolly.googleEarth.google.earth.KmlGroundOverlay {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getLatLonBox(): typingsJapgolly.googleEarth.google.earth.KmlLatLonBox = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def setLatLonBox(latLonBox: typingsJapgolly.googleEarth.google.earth.KmlLatLonBox): Unit = js.native
