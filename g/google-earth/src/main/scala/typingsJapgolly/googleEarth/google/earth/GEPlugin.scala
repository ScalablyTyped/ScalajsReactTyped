...
object GEPlugin {
  ...
  extension [Self <: GEPlugin](x: Self) {
    ...
    inline def setGetBalloon(value: CallbackTo[GEAbstractBalloon]): Self = StObject.set(x, "getBalloon", value.toJsFn)
    
    inline def setGetEarthVersion(value: CallbackTo[String]): Self = StObject.set(x, "getEarthVersion", value.toJsFn)
    ...
    inline def setGetElementsByType(value: CallbackTo[KmlObjectList[KmlObject]]): Self = StObject.set(x, "getElementsByType", value.toJsFn)
    
    inline def setGetFeatures(value: CallbackTo[GEFeatureContainer]): Self = StObject.set(x, "getFeatures", value.toJsFn)
    
    inline def setGetGlobe(value: CallbackTo[GEGlobe]): Self = StObject.set(x, "getGlobe", value.toJsFn)
    
    inline def setGetLayerRoot(value: CallbackTo[KmlLayerRoot]): Self = StObject.set(x, "getLayerRoot", value.toJsFn)
    
    inline def setGetNavigationControl(value: CallbackTo[GENavigationControl]): Self = StObject.set(x, "getNavigationControl", value.toJsFn)
    
    inline def setGetOptions(value: CallbackTo[GEOptions]): Self = StObject.set(x, "getOptions", value.toJsFn)
    
    inline def setGetPhotoOverlayViewer(value: CallbackTo[GEPhotoOverlayViewer]): Self = StObject.set(x, "getPhotoOverlayViewer", value.toJsFn)
    
    inline def setGetPluginVersion(value: CallbackTo[String]): Self = StObject.set(x, "getPluginVersion", value.toJsFn)
    
    inline def setGetStreamingPercent(value: CallbackTo[Double]): Self = StObject.set(x, "getStreamingPercent", value.toJsFn)
    
    inline def setGetSun(value: CallbackTo[GESun]): Self = StObject.set(x, "getSun", value.toJsFn)
    
    inline def setGetTime(value: CallbackTo[GETime]): Self = StObject.set(x, "getTime", value.toJsFn)
    
    inline def setGetTourPlayer(value: CallbackTo[GETourPlayer]): Self = StObject.set(x, "getTourPlayer", value.toJsFn)
    
    inline def setGetView(value: CallbackTo[GEView]): Self = StObject.set(x, "getView", value.toJsFn)
    
    inline def setGetWindow(value: CallbackTo[GEWindow]): Self = StObject.set(x, "getWindow", value.toJsFn)
    ...
    inline def setSetBalloon(value: GEAbstractBalloon => Callback): Self = StObject.set(x, "setBalloon", js.Any.fromFunction1((t0: GEAbstractBalloon) => value(t0).runNow()))
