...
@js.native
trait ParamsResourceServiceaccountkeysInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaServiceAccountKey] = js.native
}
...
object ParamsResourceServiceaccountkeysInsert {
  ...
  def apply(
    ...
    requestBody: SchemaServiceAccountKey = null,
    userIp: String = null
  ): ParamsResourceServiceaccountkeysInsert = {
