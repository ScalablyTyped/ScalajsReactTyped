...
@js.native
trait ParamsResourceStorelayoutclustersUpdate extends StandardParameters {
  /**
...
object ParamsResourceStorelayoutclustersUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceStorelayoutclustersUpdate = {
    ...
    __obj.asInstanceOf[ParamsResourceStorelayoutclustersUpdate]
  }
}
