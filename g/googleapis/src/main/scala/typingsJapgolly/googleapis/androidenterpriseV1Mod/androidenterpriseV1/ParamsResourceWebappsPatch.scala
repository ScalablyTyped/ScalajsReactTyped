...
@js.native
trait ParamsResourceWebappsPatch extends StandardParameters {
  /**
...
object ParamsResourceWebappsPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourceWebappsPatch]
  }
}
