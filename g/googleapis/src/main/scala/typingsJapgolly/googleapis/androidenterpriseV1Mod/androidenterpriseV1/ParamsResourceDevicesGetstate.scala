...
@js.native
trait ParamsResourceDevicesGetstate extends StandardParameters {
  /**
...
object ParamsResourceDevicesGetstate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourceDevicesGetstate]
  }
}
