...
@js.native
trait ParamsResourceInstallsList extends StandardParameters {
  /**
...
object ParamsResourceInstallsList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourceInstallsList]
  }
}
