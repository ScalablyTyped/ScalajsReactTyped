...
@js.native
trait ParamsResourceStorelayoutclustersGet extends StandardParameters {
  /**
...
object ParamsResourceStorelayoutclustersGet {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceStorelayoutclustersGet = {
    ...
    __obj.asInstanceOf[ParamsResourceStorelayoutclustersGet]
  }
}
