...
import typingsJapgolly.googleapis.bigqueryV2Mod.bigqueryV2.SchemaClustering
import typingsJapgolly.googleapis.bigqueryV2Mod.bigqueryV2.SchemaTableReference
import typingsJapgolly.googleapis.bigqueryV2Mod.bigqueryV2.SchemaTimePartitioning
