...
@js.native
class ResourceProjectsCatalogs protected () extends js.Object {
  ...
  def search(params: ParamsResourceProjectsCatalogsSearch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPrivatecatalogV1beta1SearchCatalogsResponse] = js.native
  def search(
    params: ParamsResourceProjectsCatalogsSearch,
