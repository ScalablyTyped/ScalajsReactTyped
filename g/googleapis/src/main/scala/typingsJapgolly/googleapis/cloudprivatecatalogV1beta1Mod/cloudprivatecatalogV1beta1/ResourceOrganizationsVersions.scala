...
@js.native
class ResourceOrganizationsVersions protected () extends js.Object {
  ...
  def search(params: ParamsResourceOrganizationsVersionsSearch): GaxiosPromise[SchemaGoogleCloudPrivatecatalogV1beta1SearchVersionsResponse] = js.native
  def search(
    params: ParamsResourceOrganizationsVersionsSearch,
  ...
  def search(params: ParamsResourceOrganizationsVersionsSearch, options: MethodOptions): GaxiosPromise[SchemaGoogleCloudPrivatecatalogV1beta1SearchVersionsResponse] = js.native
  def search(
    params: ParamsResourceOrganizationsVersionsSearch,
