...
object ParamsResourceAccountactiveadsummariesGet {
  ...
  def apply(
    ...
    summaryAccountId: String = null,
    userIp: String = null
  ): ParamsResourceAccountactiveadsummariesGet = {
    ...
    if (summaryAccountId != null) __obj.updateDynamic("summaryAccountId")(summaryAccountId.asInstanceOf[js.Any])
