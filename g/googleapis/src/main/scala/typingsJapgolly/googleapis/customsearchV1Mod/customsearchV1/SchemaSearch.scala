...
import typingsJapgolly.googleapis.AnonCorrectedQuery
import typingsJapgolly.googleapis.AnonFormattedSearchTime
import typingsJapgolly.googleapis.AnonTemplate
