package typingsJapgolly.googleapis.mod.deploymentmanagerAlpha
...
class Deploymentmanager protected ()
  extends typingsJapgolly.googleapis.deploymentmanagerAlphaMod.deploymentmanagerAlpha.Deploymentmanager {
