package typingsJapgolly.googleapis.mod.binaryauthorizationV1beta1
...
class Binaryauthorization protected ()
  extends typingsJapgolly.googleapis.binaryauthorizationV1beta1Mod.binaryauthorizationV1beta1.Binaryauthorization {
