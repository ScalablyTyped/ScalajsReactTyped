package typingsJapgolly.googleapis.mod.firebasedynamiclinksV1
...
class Firebasedynamiclinks protected ()
  extends typingsJapgolly.googleapis.firebasedynamiclinksV1Mod.firebasedynamiclinksV1.Firebasedynamiclinks {
