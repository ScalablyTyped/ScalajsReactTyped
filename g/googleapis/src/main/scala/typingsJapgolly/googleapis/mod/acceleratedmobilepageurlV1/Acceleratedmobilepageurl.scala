package typingsJapgolly.googleapis.mod.acceleratedmobilepageurlV1
...
class Acceleratedmobilepageurl protected ()
  extends typingsJapgolly.googleapis.acceleratedmobilepageurlV1Mod.acceleratedmobilepageurlV1.Acceleratedmobilepageurl {
