package typingsJapgolly.googleapis.mod.androiddeviceprovisioningV1
...
class Androiddeviceprovisioning protected ()
  extends typingsJapgolly.googleapis.androiddeviceprovisioningV1Mod.androiddeviceprovisioningV1.Androiddeviceprovisioning {
