package typingsJapgolly.googleapis.mod.doubleclicksearchV2
...
class Doubleclicksearch protected ()
  extends typingsJapgolly.googleapis.doubleclicksearchV2Mod.doubleclicksearchV2.Doubleclicksearch {
