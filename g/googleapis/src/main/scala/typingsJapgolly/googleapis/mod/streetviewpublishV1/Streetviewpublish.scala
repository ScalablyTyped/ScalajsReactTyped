package typingsJapgolly.googleapis.mod.streetviewpublishV1
...
class Streetviewpublish protected ()
  extends typingsJapgolly.googleapis.streetviewpublishV1Mod.streetviewpublishV1.Streetviewpublish {
