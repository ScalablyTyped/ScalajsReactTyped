package typingsJapgolly.googleapis.mod.servicenetworkingV1
...
class Servicenetworking protected ()
  extends typingsJapgolly.googleapis.servicenetworkingV1Mod.servicenetworkingV1.Servicenetworking {
