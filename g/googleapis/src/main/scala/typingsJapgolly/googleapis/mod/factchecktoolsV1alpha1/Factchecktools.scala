package typingsJapgolly.googleapis.mod.factchecktoolsV1alpha1
...
class Factchecktools protected ()
  extends typingsJapgolly.googleapis.factchecktoolsV1alpha1Mod.factchecktoolsV1alpha1.Factchecktools {
