package typingsJapgolly.googleapis.mod.adexperiencereportV1
...
class Adexperiencereport protected ()
  extends typingsJapgolly.googleapis.adexperiencereportV1Mod.adexperiencereportV1.Adexperiencereport {
