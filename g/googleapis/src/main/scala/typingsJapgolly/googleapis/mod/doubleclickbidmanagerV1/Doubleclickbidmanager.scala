package typingsJapgolly.googleapis.mod.doubleclickbidmanagerV1
...
class Doubleclickbidmanager protected ()
  extends typingsJapgolly.googleapis.doubleclickbidmanagerV1Mod.doubleclickbidmanagerV1.Doubleclickbidmanager {
