package typingsJapgolly.googleapis.mod.serviceconsumermanagementV1
...
class Serviceconsumermanagement protected ()
  extends typingsJapgolly.googleapis.serviceconsumermanagementV1Mod.serviceconsumermanagementV1.Serviceconsumermanagement {
