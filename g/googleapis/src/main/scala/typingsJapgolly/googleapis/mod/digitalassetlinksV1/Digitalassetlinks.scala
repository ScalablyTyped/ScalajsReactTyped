package typingsJapgolly.googleapis.mod.digitalassetlinksV1
...
class Digitalassetlinks protected ()
  extends typingsJapgolly.googleapis.digitalassetlinksV1Mod.digitalassetlinksV1.Digitalassetlinks {
