package typingsJapgolly.googleapis.mod.abusiveexperiencereportV1
...
class Abusiveexperiencereport protected ()
  extends typingsJapgolly.googleapis.v1Mod.abusiveexperiencereportV1.Abusiveexperiencereport {
