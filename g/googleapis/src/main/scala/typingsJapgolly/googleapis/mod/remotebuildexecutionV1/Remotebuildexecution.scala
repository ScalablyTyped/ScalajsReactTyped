package typingsJapgolly.googleapis.mod.remotebuildexecutionV1
...
class Remotebuildexecution protected ()
  extends typingsJapgolly.googleapis.remotebuildexecutionV1Mod.remotebuildexecutionV1.Remotebuildexecution {
