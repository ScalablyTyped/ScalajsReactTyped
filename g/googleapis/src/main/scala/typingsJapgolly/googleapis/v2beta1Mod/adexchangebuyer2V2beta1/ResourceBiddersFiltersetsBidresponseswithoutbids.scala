...
@js.native
class ResourceBiddersFiltersetsBidresponseswithoutbids protected () extends js.Object {
  ...
  def list(params: ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList, options: MethodOptions): GaxiosPromise[SchemaListBidResponsesWithoutBidsResponse] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsBidresponseswithoutbidsList,
