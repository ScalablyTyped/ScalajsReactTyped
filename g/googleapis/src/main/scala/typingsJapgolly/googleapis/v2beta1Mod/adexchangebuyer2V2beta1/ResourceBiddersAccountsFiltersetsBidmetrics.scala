...
@JSImport("googleapis/build/src/apis/adexchangebuyer2/v2beta1", "adexchangebuyer2_v2beta1.Resource$Bidders$Accounts$Filtersets$Bidmetrics")
@js.native
class ResourceBiddersAccountsFiltersetsBidmetrics protected () extends js.Object {
  ...
  def list(params: ParamsResourceBiddersAccountsFiltersetsBidmetricsList, options: MethodOptions): GaxiosPromise[SchemaListBidMetricsResponse] = js.native
  def list(
    params: ParamsResourceBiddersAccountsFiltersetsBidmetricsList,
