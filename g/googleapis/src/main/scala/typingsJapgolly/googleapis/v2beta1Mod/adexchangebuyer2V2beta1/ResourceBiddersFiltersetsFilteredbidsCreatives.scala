...
@js.native
class ResourceBiddersFiltersetsFilteredbidsCreatives protected () extends js.Object {
  ...
  def list(params: ParamsResourceBiddersFiltersetsFilteredbidsCreativesList): GaxiosPromise[SchemaListCreativeStatusBreakdownByCreativeResponse] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsFilteredbidsCreativesList,
  ...
  def list(params: ParamsResourceBiddersFiltersetsFilteredbidsCreativesList, options: MethodOptions): GaxiosPromise[SchemaListCreativeStatusBreakdownByCreativeResponse] = js.native
  def list(
    params: ParamsResourceBiddersFiltersetsFilteredbidsCreativesList,
