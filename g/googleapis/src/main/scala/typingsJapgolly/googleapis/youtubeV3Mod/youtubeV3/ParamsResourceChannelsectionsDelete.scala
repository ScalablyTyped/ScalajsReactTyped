...
@js.native
trait ParamsResourceChannelsectionsDelete extends StandardParameters {
  /**
...
object ParamsResourceChannelsectionsDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceChannelsectionsDelete = {
    ...
    __obj.asInstanceOf[ParamsResourceChannelsectionsDelete]
  }
}
