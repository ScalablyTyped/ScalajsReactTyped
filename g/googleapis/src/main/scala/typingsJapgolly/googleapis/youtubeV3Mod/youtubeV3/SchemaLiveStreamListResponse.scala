...
@js.native
trait SchemaLiveStreamListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaLiveStream]] = js.native
  /**
...
object SchemaLiveStreamListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[SchemaLiveStream] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[SchemaLiveStreamListResponse]
  }
}
