...
@js.native
trait SchemaPlaylistItemListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaPlaylistItem]] = js.native
  /**
...
object SchemaPlaylistItemListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[SchemaPlaylistItem] = null,
    kind: String = null,
  ...
  ): SchemaPlaylistItemListResponse = {
    ...
    __obj.asInstanceOf[SchemaPlaylistItemListResponse]
  }
}
