...
@js.native
trait ParamsResourcePlaylistsDelete extends StandardParameters {
  /**
...
object ParamsResourcePlaylistsDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourcePlaylistsDelete]
  }
}
