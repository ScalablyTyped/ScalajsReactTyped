...
@js.native
trait SchemaLiveBroadcastListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaLiveBroadcast]] = js.native
  /**
...
object SchemaLiveBroadcastListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[SchemaLiveBroadcast] = null,
    kind: String = null,
  ...
  ): SchemaLiveBroadcastListResponse = {
    ...
    __obj.asInstanceOf[SchemaLiveBroadcastListResponse]
  }
}
