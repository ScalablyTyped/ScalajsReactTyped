...
@js.native
trait ParamsResourceVideosReportabuse extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaVideoAbuseReport] = js.native
}
...
object ParamsResourceVideosReportabuse {
  ...
  def apply(
    ...
    requestBody: SchemaVideoAbuseReport = null,
    userIp: String = null
  ): ParamsResourceVideosReportabuse = {
