...
@js.native
trait SchemaLiveChatModeratorListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaLiveChatModerator]] = js.native
  /**
...
object SchemaLiveChatModeratorListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[SchemaLiveChatModerator] = null,
    kind: String = null,
  ...
  ): SchemaLiveChatModeratorListResponse = {
    ...
    __obj.asInstanceOf[SchemaLiveChatModeratorListResponse]
  }
}
