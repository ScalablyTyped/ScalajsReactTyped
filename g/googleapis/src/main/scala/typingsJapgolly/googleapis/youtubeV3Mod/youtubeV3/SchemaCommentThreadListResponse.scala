...
@js.native
trait SchemaCommentThreadListResponse extends js.Object {
  /**
  ...
  /**
    ...
    */
  var items: js.UndefOr[js.Array[SchemaCommentThread]] = js.native
  /**
...
object SchemaCommentThreadListResponse {
  @scala.inline
  def apply(
    etag: String = null,
    eventId: String = null,
    items: js.Array[SchemaCommentThread] = null,
    kind: String = null,
    nextPageToken: String = null,
    pageInfo: SchemaPageInfo = null,
    tokenPagination: SchemaTokenPagination = null,
    visitorId: String = null
  ): SchemaCommentThreadListResponse = {
    ...
    __obj.asInstanceOf[SchemaCommentThreadListResponse]
  }
}
