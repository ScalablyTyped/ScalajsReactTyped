...
@js.native
trait ParamsResourceInstancegroupmanagersUpdateperinstanceconfigs extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaInstanceGroupManagersUpdatePerInstanceConfigsReq] = js.native
  /**
...
object ParamsResourceInstancegroupmanagersUpdateperinstanceconfigs {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    requestBody: SchemaInstanceGroupManagersUpdatePerInstanceConfigsReq = null,
    requestId: String = null,
    userIp: String = null,
    zone: String = null
  ): ParamsResourceInstancegroupmanagersUpdateperinstanceconfigs = {
    ...
    __obj.asInstanceOf[ParamsResourceInstancegroupmanagersUpdateperinstanceconfigs]
  }
}
