...
object ParamsResourceOrganizationsecuritypoliciesAddassociation {
  ...
  def apply(
    ...
    replaceExistingAssociation: js.UndefOr[Boolean] = js.undefined,
    requestBody: SchemaSecurityPolicyAssociation = null,
    requestId: String = null,
    securityPolicy: String = null,
    userIp: String = null
  ): ParamsResourceOrganizationsecuritypoliciesAddassociation = {
    ...
    if (!js.isUndefined(replaceExistingAssociation)) __obj.updateDynamic("replaceExistingAssociation")(replaceExistingAssociation.asInstanceOf[js.Any])
