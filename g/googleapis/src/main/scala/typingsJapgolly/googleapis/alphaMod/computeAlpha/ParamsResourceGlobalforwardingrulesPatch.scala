...
@js.native
trait ParamsResourceGlobalforwardingrulesPatch extends StandardParameters {
  /**
...
object ParamsResourceGlobalforwardingrulesPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceGlobalforwardingrulesPatch = {
    ...
    __obj.asInstanceOf[ParamsResourceGlobalforwardingrulesPatch]
  }
}
