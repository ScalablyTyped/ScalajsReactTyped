...
@js.native
trait ParamsResourceInstancegroupmanagersPatch extends StandardParameters {
  /**
...
object ParamsResourceInstancegroupmanagersPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsResourceInstancegroupmanagersPatch = {
    ...
    __obj.asInstanceOf[ParamsResourceInstancegroupmanagersPatch]
  }
}
