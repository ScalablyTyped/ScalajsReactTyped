...
@js.native
trait ParamsResourceOrganizationsecuritypoliciesCopyrules extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var sourceSecurityPolicy: js.UndefOr[String] = js.native
}
...
object ParamsResourceOrganizationsecuritypoliciesCopyrules {
  ...
  def apply(
    ...
    userIp: String = null
  ): ParamsResourceOrganizationsecuritypoliciesCopyrules = {
    ...
    if (sourceSecurityPolicy != null) __obj.updateDynamic("sourceSecurityPolicy")(sourceSecurityPolicy.asInstanceOf[js.Any])
