...
@js.native
trait ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs extends StandardParameters {
  /**
...
object ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    region: String = null,
    userIp: String = null
  ): ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs = {
    ...
    __obj.asInstanceOf[ParamsResourceRegioninstancegroupmanagersListperinstanceconfigs]
  }
}
