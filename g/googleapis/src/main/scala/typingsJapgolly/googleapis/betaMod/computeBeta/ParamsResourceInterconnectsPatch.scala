...
@js.native
trait ParamsResourceInterconnectsPatch extends StandardParameters {
  /**
...
object ParamsResourceInterconnectsPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceInterconnectsPatch = {
    ...
    __obj.asInstanceOf[ParamsResourceInterconnectsPatch]
  }
}
