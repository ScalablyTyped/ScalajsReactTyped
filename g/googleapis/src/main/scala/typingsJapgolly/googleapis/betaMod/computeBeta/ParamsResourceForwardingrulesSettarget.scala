...
@js.native
trait ParamsResourceForwardingrulesSettarget extends StandardParameters {
  /**
...
object ParamsResourceForwardingrulesSettarget {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceForwardingrulesSettarget = {
    ...
    __obj.asInstanceOf[ParamsResourceForwardingrulesSettarget]
  }
}
