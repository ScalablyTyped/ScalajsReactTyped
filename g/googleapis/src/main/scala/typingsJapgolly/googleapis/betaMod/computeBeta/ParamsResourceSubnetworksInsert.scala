...
@js.native
trait ParamsResourceSubnetworksInsert extends StandardParameters {
  /**
...
object ParamsResourceSubnetworksInsert {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceSubnetworksInsert = {
    ...
    __obj.asInstanceOf[ParamsResourceSubnetworksInsert]
  }
}
