...
@js.native
trait ParamsResourceNodegroupsListnodes extends StandardParameters {
  /**
...
object ParamsResourceNodegroupsListnodes {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null,
    zone: String = null
  ): ParamsResourceNodegroupsListnodes = {
    ...
    __obj.asInstanceOf[ParamsResourceNodegroupsListnodes]
  }
}
