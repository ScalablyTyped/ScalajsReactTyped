...
@js.native
trait ParamsResourceNetworksDelete extends StandardParameters {
  /**
...
object ParamsResourceNetworksDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourceNetworksDelete]
  }
}
