...
@js.native
trait ParamsResourceInterconnectattachmentsPatch extends StandardParameters {
  /**
...
object ParamsResourceInterconnectattachmentsPatch {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceInterconnectattachmentsPatch = {
    ...
    __obj.asInstanceOf[ParamsResourceInterconnectattachmentsPatch]
  }
}
