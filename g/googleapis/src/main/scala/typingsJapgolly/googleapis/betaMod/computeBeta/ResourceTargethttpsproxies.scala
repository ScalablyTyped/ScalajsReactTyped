...
@JSImport("googleapis/build/src/apis/compute/beta", "compute_beta.Resource$Targethttpsproxies")
@js.native
class ResourceTargethttpsproxies protected () extends js.Object {
  ...
  /**
    ...
    *   };
    *
    *   compute.targetHttpsProxies.testIamPermissions(request, function(err,
    * response) { if (err) { console.error(err); return;
    *     }
    *
    *     // TODO: Change code below to process the `response` object:
