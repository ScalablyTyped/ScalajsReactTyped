...
@js.native
trait ParamsResourceEditsBundlesList extends StandardParameters {
  /**
...
object ParamsResourceEditsBundlesList {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceEditsBundlesList = {
    ...
    __obj.asInstanceOf[ParamsResourceEditsBundlesList]
  }
}
