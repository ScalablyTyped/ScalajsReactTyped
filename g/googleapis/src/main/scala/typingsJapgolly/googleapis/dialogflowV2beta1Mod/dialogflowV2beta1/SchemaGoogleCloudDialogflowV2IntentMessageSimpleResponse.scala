...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponse extends js.Object {
  /**
...
object SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponse {
  @scala.inline
  def apply(displayText: String = null, ssml: String = null, textToSpeech: String = null): SchemaGoogleCloudDialogflowV2IntentMessageSimpleResponse = {
