...
@js.native
trait ParamsResourceNotificationsUpdate extends StandardParameters {
  /**
...
object ParamsResourceNotificationsUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceNotificationsUpdate = {
    ...
    __obj.asInstanceOf[ParamsResourceNotificationsUpdate]
  }
}
