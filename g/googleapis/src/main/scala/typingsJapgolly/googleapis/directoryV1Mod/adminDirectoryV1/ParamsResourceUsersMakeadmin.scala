...
@js.native
trait ParamsResourceUsersMakeadmin extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaUserMakeAdmin] = js.native
  /**
...
object ParamsResourceUsersMakeadmin {
  ...
  def apply(
    ...
    requestBody: SchemaUserMakeAdmin = null,
    userIp: String = null,
    userKey: String = null
  ): ParamsResourceUsersMakeadmin = {
