...
import typingsJapgolly.googleapis.tpuV1Mod.tpuV1.Options
...
object tpuMod extends js.Object {
  ...
  object VERSIONS extends js.Object {
    ...
    class v1alpha1 protected ()
      extends typingsJapgolly.googleapis.tpuV1alpha1Mod.tpuV1alpha1.Tpu {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v1alpha1
      extends TopLevel[
              Instantiable2[
                ...
                typingsJapgolly.googleapis.tpuV1alpha1Mod.tpuV1alpha1.Tpu
              ]
            ]
