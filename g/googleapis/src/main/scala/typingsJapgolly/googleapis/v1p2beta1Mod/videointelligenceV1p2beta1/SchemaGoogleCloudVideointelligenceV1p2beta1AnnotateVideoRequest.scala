...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest extends js.Object {
  /**
  ...
  /**
    ...
    */
  var videoContext: js.UndefOr[SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext] = js.native
}

object SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest {
  @scala.inline
  def apply(
    ...
    videoContext: SchemaGoogleCloudVideointelligenceV1p2beta1VideoContext = null
  ): SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest = {
    ...
    __obj.asInstanceOf[SchemaGoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest]
  }
}
