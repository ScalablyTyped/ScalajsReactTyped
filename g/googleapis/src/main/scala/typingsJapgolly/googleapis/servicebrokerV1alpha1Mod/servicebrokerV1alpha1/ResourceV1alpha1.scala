...
class ResourceV1alpha1 protected () extends js.Object {
  ...
  def getIamPolicy(params: ParamsResourceV1alpha1Getiampolicy): GaxiosPromise[SchemaGoogleIamV1Policy] = js.native
  def getIamPolicy(
    params: ParamsResourceV1alpha1Getiampolicy,
  ...
  def getIamPolicy(params: ParamsResourceV1alpha1Getiampolicy, options: MethodOptions): GaxiosPromise[SchemaGoogleIamV1Policy] = js.native
  def getIamPolicy(
    params: ParamsResourceV1alpha1Getiampolicy,
  ...
  def setIamPolicy(params: ParamsResourceV1alpha1Setiampolicy): GaxiosPromise[SchemaGoogleIamV1Policy] = js.native
  def setIamPolicy(
    params: ParamsResourceV1alpha1Setiampolicy,
    callback: BodyResponseCallback[SchemaGoogleIamV1Policy]
  ): Unit = js.native
  def setIamPolicy(
    params: ParamsResourceV1alpha1Setiampolicy,
  ...
  def setIamPolicy(params: ParamsResourceV1alpha1Setiampolicy, options: MethodOptions): GaxiosPromise[SchemaGoogleIamV1Policy] = js.native
  def setIamPolicy(
    params: ParamsResourceV1alpha1Setiampolicy,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleIamV1Policy]
  ...
  def testIamPermissions(params: ParamsResourceV1alpha1Testiampermissions): GaxiosPromise[SchemaGoogleIamV1TestIamPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsResourceV1alpha1Testiampermissions,
  ...
  def testIamPermissions(params: ParamsResourceV1alpha1Testiampermissions, options: MethodOptions): GaxiosPromise[SchemaGoogleIamV1TestIamPermissionsResponse] = js.native
  def testIamPermissions(
    params: ParamsResourceV1alpha1Testiampermissions,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaGoogleIamV1TestIamPermissionsResponse]
