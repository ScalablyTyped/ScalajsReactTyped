...
@js.native
trait ParamsResourceManagementProfilefilterlinksPatch extends StandardParameters {
  /**
...
object ParamsResourceManagementProfilefilterlinksPatch {
  ...
  def apply(
    ...
    requestBody: SchemaProfileFilterLink = null,
    userIp: String = null,
    webPropertyId: String = null
  ): ParamsResourceManagementProfilefilterlinksPatch = {
