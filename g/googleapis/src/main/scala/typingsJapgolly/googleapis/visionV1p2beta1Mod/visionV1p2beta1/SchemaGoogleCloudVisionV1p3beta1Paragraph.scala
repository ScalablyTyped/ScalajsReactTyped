...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p3beta1Paragraph extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p3beta1Paragraph {
  ...
  def apply(
    ...
    words: js.Array[SchemaGoogleCloudVisionV1p3beta1Word] = null
  ): SchemaGoogleCloudVisionV1p3beta1Paragraph = {
