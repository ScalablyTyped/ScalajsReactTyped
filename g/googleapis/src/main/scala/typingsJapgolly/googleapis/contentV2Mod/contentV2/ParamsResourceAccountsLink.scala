...
@js.native
trait ParamsResourceAccountsLink extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaAccountsLinkRequest] = js.native
}
...
object ParamsResourceAccountsLink {
  ...
  def apply(
    ...
    requestBody: SchemaAccountsLinkRequest = null,
    userIp: String = null
  ): ParamsResourceAccountsLink = {
