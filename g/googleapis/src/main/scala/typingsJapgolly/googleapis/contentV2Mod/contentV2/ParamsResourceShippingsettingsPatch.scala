...
@js.native
trait ParamsResourceShippingsettingsPatch extends StandardParameters {
  /**
...
object ParamsResourceShippingsettingsPatch {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsResourceShippingsettingsPatch = {
    ...
    __obj.asInstanceOf[ParamsResourceShippingsettingsPatch]
  }
}
