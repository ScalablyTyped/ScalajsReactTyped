...
@js.native
trait ParamsResourceFilesUntrash extends StandardParameters {
  /**
...
object ParamsResourceFilesUntrash {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourceFilesUntrash]
  }
}
