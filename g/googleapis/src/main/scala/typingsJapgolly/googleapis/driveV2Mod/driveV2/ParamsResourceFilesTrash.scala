...
@js.native
trait ParamsResourceFilesTrash extends StandardParameters {
  /**
...
object ParamsResourceFilesTrash {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourceFilesTrash]
  }
}
