...
@js.native
trait SchemaPlusDomainsAclentryResource extends js.Object {
  /**
...
object SchemaPlusDomainsAclentryResource {
  @scala.inline
  def apply(displayName: String = null, id: String = null, `type`: String = null): SchemaPlusDomainsAclentryResource = {
