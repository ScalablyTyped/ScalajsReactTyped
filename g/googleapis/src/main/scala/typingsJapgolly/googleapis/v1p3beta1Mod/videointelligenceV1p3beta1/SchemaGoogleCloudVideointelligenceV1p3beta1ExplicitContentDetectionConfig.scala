...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig extends js.Object {
  /**
...
object SchemaGoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig {
  @scala.inline
  def apply(model: String = null): SchemaGoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig = {
