...
@js.native
trait ParamsResourceGroupitemsInsert extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaGroupItem] = js.native
}
...
object ParamsResourceGroupitemsInsert {
  ...
  def apply(
    ...
    requestBody: SchemaGroupItem = null,
    userIp: String = null
  ): ParamsResourceGroupitemsInsert = {
