...
@js.native
trait ParamsResourceAccountsCustomchannelsList extends StandardParameters {
  /**
...
object ParamsResourceAccountsCustomchannelsList {
  @scala.inline
  def apply(
    ...
    userIp: String = null
  ): ParamsResourceAccountsCustomchannelsList = {
    ...
    __obj.asInstanceOf[ParamsResourceAccountsCustomchannelsList]
  }
}
