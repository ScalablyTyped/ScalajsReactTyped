...
@js.native
trait ParamsResourceEditsApksAddexternallyhosted extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaApksAddExternallyHostedRequest] = js.native
}
...
object ParamsResourceEditsApksAddexternallyhosted {
  ...
  def apply(
    ...
    requestBody: SchemaApksAddExternallyHostedRequest = null,
    userIp: String = null
  ): ParamsResourceEditsApksAddexternallyhosted = {
