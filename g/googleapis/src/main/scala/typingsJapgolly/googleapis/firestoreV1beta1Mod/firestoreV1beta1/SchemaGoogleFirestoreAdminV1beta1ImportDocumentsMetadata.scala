...
object SchemaGoogleFirestoreAdminV1beta1ImportDocumentsMetadata {
  ...
  def apply(
    ...
    progressBytes: SchemaGoogleFirestoreAdminV1beta1Progress = null,
    progressDocuments: SchemaGoogleFirestoreAdminV1beta1Progress = null,
    startTime: String = null
  ): SchemaGoogleFirestoreAdminV1beta1ImportDocumentsMetadata = {
