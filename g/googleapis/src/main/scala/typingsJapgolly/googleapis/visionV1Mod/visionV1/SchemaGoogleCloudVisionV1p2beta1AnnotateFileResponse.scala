...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse extends js.Object {
  /**
...
object SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse {
  ...
  def apply(
    ...
    responses: js.Array[SchemaGoogleCloudVisionV1p2beta1AnnotateImageResponse] = null
  ): SchemaGoogleCloudVisionV1p2beta1AnnotateFileResponse = {
