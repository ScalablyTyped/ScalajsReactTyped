...
/**
  ...
  */
@js.native
trait SchemaGoogleCloudVisionV1p2beta1WebDetection extends js.Object {
  /**
    * The service&#39;s best guess as to the topic of the request image.
    * Inferred from similar images on the open web.
    */
  var bestGuessLabels: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebLabel]] = js.native
  /**
  ...
  /**
    ...
    */
  var pagesWithMatchingImages: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebPage]] = js.native
  /**
  ...
  /**
    ...
    */
  var visuallySimilarImages: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebImage]] = js.native
  /**
    * Deduced entities from similar images on the Internet.
    */
  var webEntities: js.UndefOr[js.Array[SchemaGoogleCloudVisionV1p2beta1WebDetectionWebEntity]] = js.native
}
