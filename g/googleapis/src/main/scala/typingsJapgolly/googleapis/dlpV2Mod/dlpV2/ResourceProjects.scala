...
class ResourceProjects protected () extends js.Object {
  ...
  var deidentifyTemplates: ResourceProjectsDeidentifytemplates = js.native
  var dlpJobs: ResourceProjectsDlpjobs = js.native
  var image: ResourceProjectsImage = js.native
