...
import typingsJapgolly.googleapis.oauth2V1Mod.oauth2V1.Options
...
object oauth2Mod extends js.Object {
  ...
  object VERSIONS extends js.Object {
    ...
    @js.native
    class v2 protected ()
      extends typingsJapgolly.googleapis.oauth2V2Mod.oauth2V2.Oauth2 {
      def this(options: GlobalOptions) = this()
      def this(options: GlobalOptions, google: GoogleConfigurable) = this()
    }
    ...
    object v2
      extends TopLevel[
              Instantiable2[
                ...
                typingsJapgolly.googleapis.oauth2V2Mod.oauth2V2.Oauth2
              ]
            ]
