package typingsJapgolly.googleapis.dnsV2beta1Mod.dnsV2beta1
...
@js.native
trait ParamsResourceManagedzonesUpdate extends StandardParameters {
  /**
...
object ParamsResourceManagedzonesUpdate {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceManagedzonesUpdate = {
    ...
    __obj.asInstanceOf[ParamsResourceManagedzonesUpdate]
  }
}
