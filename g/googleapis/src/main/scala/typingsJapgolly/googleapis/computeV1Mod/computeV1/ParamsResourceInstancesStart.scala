...
@js.native
trait ParamsResourceInstancesStart extends StandardParameters {
  /**
...
object ParamsResourceInstancesStart {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourceInstancesStart]
  }
}
