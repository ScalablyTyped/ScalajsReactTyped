...
@js.native
trait ParamsResourceRoutersDelete extends StandardParameters {
  /**
...
object ParamsResourceRoutersDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    __obj.asInstanceOf[ParamsResourceRoutersDelete]
  }
}
