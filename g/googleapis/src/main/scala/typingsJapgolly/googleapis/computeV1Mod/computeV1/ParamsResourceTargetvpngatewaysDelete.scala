...
@js.native
trait ParamsResourceTargetvpngatewaysDelete extends StandardParameters {
  /**
...
object ParamsResourceTargetvpngatewaysDelete {
  @scala.inline
  def apply(
    alt: String = null,
    ...
    userIp: String = null
  ): ParamsResourceTargetvpngatewaysDelete = {
    ...
    __obj.asInstanceOf[ParamsResourceTargetvpngatewaysDelete]
  }
}
