...
@js.native
trait ParamsResourceVpntunnelsDelete extends StandardParameters {
  /**
...
object ParamsResourceVpntunnelsDelete {
  @scala.inline
  def apply(
    alt: String = null,
  ...
  ): ParamsResourceVpntunnelsDelete = {
    ...
    __obj.asInstanceOf[ParamsResourceVpntunnelsDelete]
  }
}
