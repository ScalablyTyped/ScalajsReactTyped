...
class ResourceProjects protected () extends js.Object {
  ...
  def batchGetAssetsHistory(params: ParamsResourceProjectsBatchgetassetshistory, options: MethodOptions): GaxiosPromise[SchemaBatchGetAssetsHistoryResponse] = js.native
  def batchGetAssetsHistory(
    params: ParamsResourceProjectsBatchgetassetshistory,
  ...
  def exportAssets(
    params: ParamsResourceProjectsExportassets,
    options: BodyResponseCallback[SchemaOperation],
    callback: BodyResponseCallback[SchemaOperation]
  ): Unit = js.native
  def exportAssets(params: ParamsResourceProjectsExportassets, options: MethodOptions): GaxiosPromise[SchemaOperation] = js.native
  def exportAssets(
    params: ParamsResourceProjectsExportassets,
    options: MethodOptions,
    callback: BodyResponseCallback[SchemaOperation]
