...
@js.native
trait ParamsResourceBlobsBatchread extends StandardParameters {
  /**
  ...
  /**
    ...
    */
  var requestBody: js.UndefOr[SchemaBuildBazelRemoteExecutionV2BatchReadBlobsRequest] = js.native
}
