...
object TableContainer {
  ...
  @JSImport("griddle-react", "components.TableContainer")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TableContainer.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
