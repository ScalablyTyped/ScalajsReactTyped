...
object utils {
  ...
  object SortProperties {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(columnId = columnId.asInstanceOf[js.Any], setSortColumn = js.Any.fromFunction1((t0: js.Function1[/* key */ GriddleSortKey, Unit]) => setSortColumn(t0).runNow()), sortProperty = sortProperty.asInstanceOf[js.Any])
    ...
    extension [Self <: SortProperties](x: Self) {
      ...
      inline def setSetSortColumn(value: js.Function1[/* key */ GriddleSortKey, Unit] => Callback): Self = StObject.set(x, "setSortColumn", js.Any.fromFunction1((t0: js.Function1[/* key */ GriddleSortKey, Unit]) => value(t0).runNow()))
