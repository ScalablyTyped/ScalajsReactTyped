package typingsJapgolly.googleDdns

import typingsJapgolly.googleDdns.googleDdnsBooleans.`false`
import typingsJapgolly.googleDdns.googleDdnsBooleans.`true`
...
import typingsJapgolly.googleDdns.googleDdnsStrings.success
