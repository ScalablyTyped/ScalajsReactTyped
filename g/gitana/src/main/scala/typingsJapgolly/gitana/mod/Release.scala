...
@js.native
open class Release protected () extends AbstractRepositoryObject {
  def this(repository: Any, `object`: Any) = this()
  
  def archive(callback: Any): Any = js.native
  
  def finalize(`object`: Any, callback: Any): Any = js.native
  
  def loadInfo(callback: Any): Any = js.native
  
  def releaseImmediately(callback: Any): Any = js.native
  
  def startFinalize(`object`: Any, callback: Any): Any = js.native
  
  def unarchive(callback: Any): Any = js.native
  
  def unfinalize(callback: Any): Any = js.native
}
object Release {
