...
open class Identity protected () extends StObject {
  ...
  def changePassword(password: Any, verifyPassword: Any): Any = js.native
  
  def findPolicyTenants(registrarId: Any): Any = js.native
  
  def findPolicyUserForTenant(tenantId: Any): Any = js.native
  
  def findPolicyUsers(tenantId: Any): Any = js.native
  
  def findPolicyUsersForTenant(tenantId: Any): Any = js.native
