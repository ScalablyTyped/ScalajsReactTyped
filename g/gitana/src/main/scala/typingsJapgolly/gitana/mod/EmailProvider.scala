...
@js.native
open class EmailProvider protected () extends AbstractApplicationObject {
  def this(application: Any, `object`: Any) = this()
  
  def send(email: Any, model: Any): Any = js.native
  
  def sendForExport(exportId: Any, emailConfig: Any, callback: Any): Any = js.native
  
  def test(from: Any, to: Any): Any = js.native
}
