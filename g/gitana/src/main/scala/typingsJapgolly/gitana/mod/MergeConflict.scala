...
@js.native
open class MergeConflict protected () extends AbstractRepositoryObject {
  def this(repository: Any, `object`: Any) = this()
  
  def commit(branchId: Any): Any = js.native
  
  def resolve(resolutionsArrayOrString: Any, callback: Any): Any = js.native
}
