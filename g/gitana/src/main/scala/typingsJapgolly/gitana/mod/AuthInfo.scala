...
@js.native
open class AuthInfo protected () extends StObject {
  ...
  def getTenantDescription(): Any = js.native
  
  def getTenantId(): Any = js.native
  
  def getTenantTitle(): Any = js.native
  
  def getTicket(): Any = js.native
}
object AuthInfo {
