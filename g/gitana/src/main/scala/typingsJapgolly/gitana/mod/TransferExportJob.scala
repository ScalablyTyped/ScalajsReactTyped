...
@JSImport("gitana", "TransferExportJob")
@js.native
open class TransferExportJob protected () extends StObject {
  def this(cluster: Any, `object`: Any) = this()
  
  def base(): Unit = js.native
  
  def getImports(): Any = js.native
  
  def getSingleImportTargetId(): Any = js.native
}
object TransferExportJob {
