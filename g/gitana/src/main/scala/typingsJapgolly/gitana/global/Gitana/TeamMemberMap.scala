...
@JSGlobal("Gitana.TeamMemberMap")
@js.native
open class TeamMemberMap protected ()
  extends typingsJapgolly.gitana.mod.TeamMemberMap {
  def this(team: Any, `object`: Any) = this()
}
object TeamMemberMap {
