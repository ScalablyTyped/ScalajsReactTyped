...
@JSGlobal("Gitana.AutoClientMappingMap")
@js.native
open class AutoClientMappingMap protected ()
  extends typingsJapgolly.gitana.mod.AutoClientMappingMap {
  def this(webhost: Any, `object`: Any) = this()
}
object AutoClientMappingMap {
