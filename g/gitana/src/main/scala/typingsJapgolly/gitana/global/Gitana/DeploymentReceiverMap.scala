...
@JSGlobal("Gitana.DeploymentReceiverMap")
@js.native
open class DeploymentReceiverMap protected ()
  extends typingsJapgolly.gitana.mod.DeploymentReceiverMap {
  def this(platform: Any, `object`: Any) = this()
}
object DeploymentReceiverMap {
