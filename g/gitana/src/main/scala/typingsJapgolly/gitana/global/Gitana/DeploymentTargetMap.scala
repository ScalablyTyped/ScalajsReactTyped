...
@JSGlobal("Gitana.DeploymentTargetMap")
@js.native
open class DeploymentTargetMap protected ()
  extends typingsJapgolly.gitana.mod.DeploymentTargetMap {
  def this(platform: Any, `object`: Any) = this()
}
object DeploymentTargetMap {
