...
@JSGlobal("Gitana.BillingProviderConfigurationMap")
@js.native
open class BillingProviderConfigurationMap protected ()
  extends typingsJapgolly.gitana.mod.BillingProviderConfigurationMap {
