...
@JSGlobal("Gitana.DeployedApplicationMap")
@js.native
open class DeployedApplicationMap protected ()
  extends typingsJapgolly.gitana.mod.DeployedApplicationMap {
  def this(webhost: Any, `object`: Any) = this()
}
object DeployedApplicationMap {
