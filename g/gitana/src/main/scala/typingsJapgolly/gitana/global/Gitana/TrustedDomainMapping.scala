...
@JSGlobal("Gitana.TrustedDomainMapping")
@js.native
open class TrustedDomainMapping protected ()
  extends typingsJapgolly.gitana.mod.TrustedDomainMapping {
  def this(webhost: Any, `object`: Any) = this()
}
object TrustedDomainMapping {
