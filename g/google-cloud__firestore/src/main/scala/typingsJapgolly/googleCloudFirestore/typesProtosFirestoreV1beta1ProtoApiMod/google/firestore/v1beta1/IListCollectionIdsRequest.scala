...
trait IListCollectionIdsRequest extends StObject {
...
object IListCollectionIdsRequest {
  
  inline def apply(): IListCollectionIdsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[IListCollectionIdsRequest]
  }
  
  extension [Self <: IListCollectionIdsRequest](x: Self) {
