...
object FileOptions {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.SPEED
    - typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.CODE_SIZE
    - typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.LITE_RUNTIME
  */
  trait OptimizeMode extends StObject
  object OptimizeMode {
    
    inline def CODE_SIZE: typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.CODE_SIZE = "CODE_SIZE".asInstanceOf[typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.CODE_SIZE]
    
    inline def LITE_RUNTIME: typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.LITE_RUNTIME = "LITE_RUNTIME".asInstanceOf[typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.LITE_RUNTIME]
    
    inline def SPEED: typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.SPEED = "SPEED".asInstanceOf[typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.SPEED]
  }
}
