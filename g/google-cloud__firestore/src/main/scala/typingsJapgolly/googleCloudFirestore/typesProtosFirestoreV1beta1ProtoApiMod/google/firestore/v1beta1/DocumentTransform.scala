...
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.appendMissingElements
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.increment
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.maximum
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.minimum
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.removeAllFromArray
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.setToServerValue
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.DocumentTransform.FieldTransform.ServerValue
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1beta1ProtoApiMod.google.firestore.v1beta1.DocumentTransform.IFieldTransform
...
object DocumentTransform {
  ...
  object FieldTransform {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.SERVER_VALUE_UNSPECIFIED
      - typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.REQUEST_TIME
    */
    trait ServerValue extends StObject
    object ServerValue {
      
      inline def REQUEST_TIME: typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.REQUEST_TIME = "REQUEST_TIME".asInstanceOf[typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.REQUEST_TIME]
      
      inline def SERVER_VALUE_UNSPECIFIED: typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.SERVER_VALUE_UNSPECIFIED = "SERVER_VALUE_UNSPECIFIED".asInstanceOf[typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.SERVER_VALUE_UNSPECIFIED]
    }
  }
