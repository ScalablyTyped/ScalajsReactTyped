...
object AggregateQuerySnapshot {
  ...
  inline def apply[T /* <: AggregateSpec */](
    data: CallbackTo[AggregateSpecData[T]],
    isEqual: AggregateQuerySnapshot[T] => Boolean,
    query: AggregateQuery[T],
    readTime: Timestamp
  ): AggregateQuerySnapshot[T] = {
    val __obj = js.Dynamic.literal(data = data.toJsFn, isEqual = js.Any.fromFunction1(isEqual), query = query.asInstanceOf[js.Any], readTime = readTime.asInstanceOf[js.Any])
  ...
  extension [Self <: AggregateQuerySnapshot[?], T /* <: AggregateSpec */](x: Self & AggregateQuerySnapshot[T]) {
    ...
    inline def setData(value: CallbackTo[AggregateSpecData[T]]): Self = StObject.set(x, "data", value.toJsFn)
