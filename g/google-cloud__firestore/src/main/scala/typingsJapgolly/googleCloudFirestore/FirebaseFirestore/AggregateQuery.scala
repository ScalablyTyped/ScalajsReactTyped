...
object AggregateQuery {
  ...
  inline def apply[T /* <: AggregateSpec */](
    get: CallbackTo[js.Promise[AggregateQuerySnapshot[T]]],
    isEqual: AggregateQuery[T] => Boolean,
    query: Query[Any]
  ): AggregateQuery[T] = {
    val __obj = js.Dynamic.literal(get = get.toJsFn, isEqual = js.Any.fromFunction1(isEqual), query = query.asInstanceOf[js.Any])
    __obj.asInstanceOf[AggregateQuery[T]]
  }
  
  extension [Self <: AggregateQuery[?], T /* <: AggregateSpec */](x: Self & AggregateQuery[T]) {
    
    inline def setGet(value: CallbackTo[js.Promise[AggregateQuerySnapshot[T]]]): Self = StObject.set(x, "get", value.toJsFn)
