...
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreAdminV1ProtoApiMod.google.firestore.admin.v1.FieldOperationMetadata.IIndexConfigDelta
...
object FieldOperationMetadata {
  ...
  object IndexConfigDelta {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.CHANGE_TYPE_UNSPECIFIED
    ...
    */
    ...
    object ChangeType {
      ...
      inline def CHANGE_TYPE_UNSPECIFIED: typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.CHANGE_TYPE_UNSPECIFIED = "CHANGE_TYPE_UNSPECIFIED".asInstanceOf[typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.CHANGE_TYPE_UNSPECIFIED]
