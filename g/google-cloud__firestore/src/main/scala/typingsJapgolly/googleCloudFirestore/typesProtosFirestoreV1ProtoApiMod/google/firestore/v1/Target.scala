...
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.documents
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.query
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.readTime
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.resumeToken
...
/** Represents a Target. */
@JSImport("@google-cloud/firestore/types/protos/firestore_v1_proto_api", "google.firestore.v1.Target")
@js.native
/**
...
object Target {
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1_proto_api", "google.firestore.v1.Target.DocumentsTarget")
  @js.native
  /**
  ...
  @JSImport("@google-cloud/firestore/types/protos/firestore_v1_proto_api", "google.firestore.v1.Target.QueryTarget")
  @js.native
  /**
