...
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.api.IHttpRule
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.longrunning.IOperationInfo
