...
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.api.FieldBehavior
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.api.IResourceReference
