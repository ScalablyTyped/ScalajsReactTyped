package typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.document
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.documentMetadata
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.metadata
import typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.namedQuery
...
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.IDocument
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.IStructuredQuery
...
object firestore {
  ...
  object BundledQuery {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.FIRST
      - typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.LAST
    */
    trait LimitType extends StObject
    object LimitType {
      
      inline def FIRST: typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.FIRST = "FIRST".asInstanceOf[typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.FIRST]
      
      inline def LAST: typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.LAST = "LAST".asInstanceOf[typingsJapgolly.googleCloudFirestore.googleCloudFirestoreStrings.LAST]
    }
  }
