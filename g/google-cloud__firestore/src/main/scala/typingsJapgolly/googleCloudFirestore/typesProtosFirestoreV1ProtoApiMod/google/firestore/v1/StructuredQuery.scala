...
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.CompositeFilter.Operator
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.ICollectionSelector
import typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.IOrder
...
object StructuredQuery {
  ...
  open class FieldFilter ()
    ...
    /** FieldFilter op. */
    @JSName("op")
    var op_FieldFilter: typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.FieldFilter.Operator = js.native
  ...
  open class UnaryFilter ()
    ...
    /** UnaryFilter op. */
    @JSName("op")
    var op_UnaryFilter: typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.UnaryFilter.Operator = js.native
  ...
  */
  ...
  trait IFieldFilter extends StObject {
    ...
    /** FieldFilter op */
    var op: js.UndefOr[
        typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.FieldFilter.Operator | Null
      ] = js.undefined
  ...
  object IFieldFilter {
    ...
    extension [Self <: IFieldFilter](x: Self) {
      ...
      inline def setOp(
        value: typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.FieldFilter.Operator
  ...
  trait IUnaryFilter extends StObject {
    ...
    /** UnaryFilter op */
    var op: js.UndefOr[
        typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.UnaryFilter.Operator | Null
      ] = js.undefined
  }
  object IUnaryFilter {
    ...
    extension [Self <: IUnaryFilter](x: Self) {
      ...
      inline def setOp(
        value: typingsJapgolly.googleCloudFirestore.typesProtosFirestoreV1ProtoApiMod.google.firestore.v1.StructuredQuery.UnaryFilter.Operator
      ): Self = StObject.set(x, "op", value.asInstanceOf[js.Any])
