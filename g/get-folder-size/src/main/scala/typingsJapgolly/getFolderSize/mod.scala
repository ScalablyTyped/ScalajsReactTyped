...
import typingsJapgolly.getFolderSize.mod.getFolderSize.FolderSizeInfo
import typingsJapgolly.getFolderSize.mod.getFolderSize.Options
...
object mod {
  ...
  object getFolderSize {
    ...
    object FStatsLike {
      ...
      inline def apply(ino: Double, isDirectory: CallbackTo[Boolean], size: Double): FStatsLike = {
        val __obj = js.Dynamic.literal(ino = ino.asInstanceOf[js.Any], isDirectory = isDirectory.toJsFn, size = size.asInstanceOf[js.Any])
