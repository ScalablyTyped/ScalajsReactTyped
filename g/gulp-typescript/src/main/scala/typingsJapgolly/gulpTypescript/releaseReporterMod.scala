...
import typingsJapgolly.gulpTypescript.anon.Character
...
object releaseReporterMod {
  ...
  object Reporter {
    ...
    extension [Self <: Reporter](x: Self) {
      ...
      inline def setError(value: (/* error */ TypeScriptError, /* typescript */ Typeofts) => Callback): Self = StObject.set(x, "error", js.Any.fromFunction2((t0: /* error */ TypeScriptError, t1: /* typescript */ Typeofts) => (value(t0, t1)).runNow()))
      
      inline def setErrorUndefined: Self = StObject.set(x, "error", js.undefined)
      
      inline def setFinish(value: /* results */ CompilationResult => Callback): Self = StObject.set(x, "finish", js.Any.fromFunction1((t0: /* results */ CompilationResult) => value(t0).runNow()))
