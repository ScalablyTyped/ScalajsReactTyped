...
import typingsJapgolly.gulpTypescript.releaseProjectMod.ICompileStream
import typingsJapgolly.gulpTypescript.releaseReporterMod.CompilationResult
import typingsJapgolly.gulpTypescript.releaseReporterMod.Reporter
import typingsJapgolly.gulpTypescript.releaseTypesMod.GetCustomTransformers
...
object mod {
  ...
  inline def apply(proj: typingsJapgolly.gulpTypescript.releaseProjectMod.Project): CompileStream = ^.asInstanceOf[js.Dynamic].apply(proj.asInstanceOf[js.Any]).asInstanceOf[CompileStream]
  inline def apply(proj: typingsJapgolly.gulpTypescript.releaseProjectMod.Project, theReporter: Reporter): CompileStream = (^.asInstanceOf[js.Dynamic].apply(proj.asInstanceOf[js.Any], theReporter.asInstanceOf[js.Any])).asInstanceOf[CompileStream]
  ...
  type Project = typingsJapgolly.gulpTypescript.releaseProjectMod.Project
