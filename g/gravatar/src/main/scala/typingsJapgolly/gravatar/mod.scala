package typingsJapgolly.gravatar
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gravatar.gravatarBooleans.`false`
    - typingsJapgolly.gravatar.gravatarBooleans.`true`
    - typingsJapgolly.gravatar.gravatarStrings.http
    - typingsJapgolly.gravatar.gravatarStrings.https
  */
  trait Protocol extends StObject
  object Protocol {
    
    inline def `false`: typingsJapgolly.gravatar.gravatarBooleans.`false` = false.asInstanceOf[typingsJapgolly.gravatar.gravatarBooleans.`false`]
    
    inline def http: typingsJapgolly.gravatar.gravatarStrings.http = "http".asInstanceOf[typingsJapgolly.gravatar.gravatarStrings.http]
    
    inline def https: typingsJapgolly.gravatar.gravatarStrings.https = "https".asInstanceOf[typingsJapgolly.gravatar.gravatarStrings.https]
    
    inline def `true`: typingsJapgolly.gravatar.gravatarBooleans.`true` = true.asInstanceOf[typingsJapgolly.gravatar.gravatarBooleans.`true`]
  }
}
