...
import typingsJapgolly.gapiClientSpanner.AnonBearertoken
...
object OperationsResource {
  ...
  def apply(
    ...
    __obj.updateDynamic("cancel")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientSpanner.AnonAccesstoken) => cancel(t0).runNow()))
    ...
    __obj.updateDynamic("list")(js.Any.fromFunction1((t0: typingsJapgolly.gapiClientSpanner.AnonBearertoken) => list(t0).runNow()))
