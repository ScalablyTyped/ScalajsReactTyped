...
import typingsJapgolly.googleCloudStorage.buildSrcResumableUploadMod.PredefinedAcl
...
object googleCloudStorageStrings {
  ...
  sealed trait authenticatedRead
    extends StObject
       with PredefinedAcl
       with typingsJapgolly.googleCloudStorage.buildSrcFileMod.PredefinedAcl
