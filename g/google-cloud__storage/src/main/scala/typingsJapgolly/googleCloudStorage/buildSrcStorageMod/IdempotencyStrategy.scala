...
object IdempotencyStrategy extends StObject {
  ...
  /* 0 */ val RetryAlways: typingsJapgolly.googleCloudStorage.buildSrcStorageMod.IdempotencyStrategy.RetryAlways & Double = js.native
  
  @js.native
  sealed trait RetryConditional
    extends StObject
       with IdempotencyStrategy
  /* 1 */ val RetryConditional: typingsJapgolly.googleCloudStorage.buildSrcStorageMod.IdempotencyStrategy.RetryConditional & Double = js.native
  
  @js.native
  sealed trait RetryNever
    extends StObject
       with IdempotencyStrategy
  /* 2 */ val RetryNever: typingsJapgolly.googleCloudStorage.buildSrcStorageMod.IdempotencyStrategy.RetryNever & Double = js.native
}
