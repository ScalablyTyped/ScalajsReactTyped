...
import typingsJapgolly.googleCloudStorage.anon.OWNERROLE
import typingsJapgolly.googleCloudStorage.buildSrcBucketMod.Bucket
import typingsJapgolly.googleCloudStorage.buildSrcChannelMod.Channel
...
import typingsJapgolly.googleCloudStorage.buildSrcHmacKeyMod.HmacKey
import typingsJapgolly.googleCloudStorage.buildSrcHmacKeyMod.HmacKeyOptions
import typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonMod.Service
...
object Storage {
  ...
  def Bucket: Instantiable3[
    ...
    typingsJapgolly.googleCloudStorage.buildSrcBucketMod.Bucket
  ] = js.native
  inline def Bucket_=(
    x: Instantiable3[
      /* storage */ Storage, 
  ...
  def Channel: Instantiable3[
    ...
    /* id */ String, 
    /* resourceId */ String, 
    typingsJapgolly.googleCloudStorage.buildSrcChannelMod.Channel
  ] = js.native
  ...
  def File: Instantiable3[
    ...
    typingsJapgolly.googleCloudStorage.buildSrcFileMod.File
  ] = js.native
  inline def File_=(
  ...
  def HmacKey: Instantiable3[
    ...
    typingsJapgolly.googleCloudStorage.buildSrcHmacKeyMod.HmacKey
  ] = js.native
  inline def HmacKey_=(
    x: Instantiable3[
      /* storage */ Storage, 
