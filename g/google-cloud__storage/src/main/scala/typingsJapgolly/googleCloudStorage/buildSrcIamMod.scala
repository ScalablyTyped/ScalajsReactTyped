...
object buildSrcIamMod {
  ...
  object IAMExceptionMessages extends StObject {
    ...
    /* "Permissions are required." */ val PERMISSIONS_REQUIRED: typingsJapgolly.googleCloudStorage.buildSrcIamMod.IAMExceptionMessages.PERMISSIONS_REQUIRED & String = js.native
    
    @js.native
    sealed trait POLICY_OBJECT_REQUIRED
      extends StObject
         with IAMExceptionMessages
    /* "A policy object is required." */ val POLICY_OBJECT_REQUIRED: typingsJapgolly.googleCloudStorage.buildSrcIamMod.IAMExceptionMessages.POLICY_OBJECT_REQUIRED & String = js.native
  }
