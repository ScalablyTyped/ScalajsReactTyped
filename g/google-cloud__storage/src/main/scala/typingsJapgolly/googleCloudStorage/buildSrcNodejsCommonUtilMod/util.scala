...
object util extends Shortcut {
  ...
  @JSImport("@google-cloud/storage/build/src/nodejs-common/util", "util")
  @js.native
  val ^ : Util_ = js.native
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@google-cloud/storage/build/src/nodejs-common/util", "util.ApiError")
  @js.native
  ...
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("@google-cloud/storage/build/src/nodejs-common/util", "util.PartialFailureError")
  @js.native
