...
import typingsJapgolly.googleCloudStorage.anon.TypeofApiError
import typingsJapgolly.googleCloudStorage.anon.UserAgent
...
open class Util_ () extends StObject {
  ...
  var PartialFailureError: Instantiable1[
    /* b */ GoogleErrorBody, 
    typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonUtilMod.PartialFailureError
  ] = js.native
