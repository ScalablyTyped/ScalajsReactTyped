...
import typingsJapgolly.googleCloudStorage.bucketMod.BucketOptions
import typingsJapgolly.googleCloudStorage.fileMod.FileOptions
import typingsJapgolly.googleCloudStorage.hmacKeyMod.HmacKeyOptions
import typingsJapgolly.googleCloudStorage.storageMod.StorageOptions
...
object mod extends js.Object {
  ...
  class Bucket protected ()
    extends typingsJapgolly.googleCloudStorage.bucketMod.Bucket {
    def this(storage: typingsJapgolly.googleCloudStorage.storageMod.Storage, name: String) = this()
    def this(
      storage: typingsJapgolly.googleCloudStorage.storageMod.Storage,
      name: String,
  ...
  class Channel protected ()
    extends typingsJapgolly.googleCloudStorage.channelMod.Channel {
    def this(storage: typingsJapgolly.googleCloudStorage.storageMod.Storage, id: String, resourceId: String) = this()
  }
  ...
  class File protected ()
    extends typingsJapgolly.googleCloudStorage.fileMod.File {
    /**
    ...
    /**
      ...
      */
    def this(bucket: typingsJapgolly.googleCloudStorage.bucketMod.Bucket, name: String) = this()
    def this(bucket: typingsJapgolly.googleCloudStorage.bucketMod.Bucket, name: String, options: FileOptions) = this()
  }
  
  @js.native
  class HmacKey protected ()
    extends typingsJapgolly.googleCloudStorage.hmacKeyMod.HmacKey {
    /**
    ...
    /**
      ...
      */
    def this(storage: typingsJapgolly.googleCloudStorage.storageMod.Storage, accessId: String) = this()
    def this(
      storage: typingsJapgolly.googleCloudStorage.storageMod.Storage,
      accessId: String,
  ...
  @js.native
  class Iam protected ()
    extends typingsJapgolly.googleCloudStorage.iamMod.Iam {
    def this(bucket: typingsJapgolly.googleCloudStorage.bucketMod.Bucket) = this()
  }
  ...
  class Notification protected ()
    extends typingsJapgolly.googleCloudStorage.notificationMod.Notification {
    def this(bucket: typingsJapgolly.googleCloudStorage.bucketMod.Bucket, id: String) = this()
  }
  ...
  /**
    ...
    */
  class Storage ()
    extends typingsJapgolly.googleCloudStorage.storageMod.Storage {
  ...
  object Storage extends js.Object {
    ...
    var File: Instantiable3[
        /* bucket */ typingsJapgolly.googleCloudStorage.bucketMod.Bucket, 
        /* name */ String, 
