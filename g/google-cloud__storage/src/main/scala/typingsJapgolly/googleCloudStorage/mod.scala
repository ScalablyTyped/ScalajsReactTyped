...
import typingsJapgolly.googleCloudStorage.buildSrcStorageMod.StorageOptions
...
object mod {
  ...
  open class Bucket protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcBucketMod.Bucket {
    def this(storage: typingsJapgolly.googleCloudStorage.buildSrcStorageMod.Storage, name: String) = this()
    def this(
      storage: typingsJapgolly.googleCloudStorage.buildSrcStorageMod.Storage,
      name: String,
  ...
  open class Channel protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcChannelMod.Channel {
    def this(
      storage: typingsJapgolly.googleCloudStorage.buildSrcStorageMod.Storage,
      id: String,
      resourceId: String
  ...
  open class File protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcFileMod.File {
    /**
      * Cloud Storage uses access control lists (ACLs) to manage object and
      * bucket access. ACLs are the mechanism you use to share objects with other
      * users and allow other users to access your buckets and objects.
    ...
    /**
      ...
      * ```
      */
    def this(bucket: typingsJapgolly.googleCloudStorage.buildSrcBucketMod.Bucket, name: String) = this()
    def this(
      bucket: typingsJapgolly.googleCloudStorage.buildSrcBucketMod.Bucket,
      name: String,
      options: FileOptions
    ) = this()
  }
  ...
  open class HashStreamValidator ()
    extends typingsJapgolly.googleCloudStorage.buildSrcHashStreamValidatorMod.HashStreamValidator {
  ...
  open class HmacKey protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcHmacKeyMod.HmacKey {
    /**
    ...
    /**
      ...
      * ```
      */
    def this(storage: typingsJapgolly.googleCloudStorage.buildSrcStorageMod.Storage, accessId: String) = this()
    def this(
      storage: typingsJapgolly.googleCloudStorage.buildSrcStorageMod.Storage,
      accessId: String,
  ...
  open class Iam protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcIamMod.Iam {
    def this(bucket: typingsJapgolly.googleCloudStorage.buildSrcBucketMod.Bucket) = this()
  }
  ...
  object IdempotencyStrategy extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.googleCloudStorage.buildSrcStorageMod.IdempotencyStrategy & Double
      ] = js.native
  ...
  open class Notification protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcNotificationMod.Notification {
    def this(bucket: typingsJapgolly.googleCloudStorage.buildSrcBucketMod.Bucket, id: String) = this()
  }
  ...
  /**
    ...
    */
  open class Storage ()
    extends typingsJapgolly.googleCloudStorage.buildSrcStorageMod.Storage {
