...
import typingsJapgolly.googleCloudStorage.buildSrcBucketMod.AvailableServiceObjectMethods
...
import typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonUtilMod.Duplexify
