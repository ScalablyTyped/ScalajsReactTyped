...
import typingsJapgolly.googleCloudStorage.anon.ReqOpts
...
object buildSrcNodejsCommonServiceObjectMod {
  ...
  object ServiceObjectParent {
    ...
    inline def apply(
      getRequestInterceptors: CallbackTo[js.Array[js.Function]],
      ...
      val __obj = js.Dynamic.literal(getRequestInterceptors = getRequestInterceptors.toJsFn, interceptors = interceptors.asInstanceOf[js.Any], request = js.Any.fromFunction2((t0: DecorateRequestOptions, t1: BodyResponseCallback) => (request(t0, t1)).runNow()), requestStream = js.Any.fromFunction1(requestStream))
      __obj.asInstanceOf[ServiceObjectParent]
    }
    
    extension [Self <: ServiceObjectParent](x: Self) {
      
      inline def setGetRequestInterceptors(value: CallbackTo[js.Array[js.Function]]): Self = StObject.set(x, "getRequestInterceptors", value.toJsFn)
