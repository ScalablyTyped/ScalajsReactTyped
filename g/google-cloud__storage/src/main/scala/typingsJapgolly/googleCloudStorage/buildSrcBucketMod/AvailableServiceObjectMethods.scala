...
object AvailableServiceObjectMethods extends StObject {
  ...
  /* 1 */ val delete: typingsJapgolly.googleCloudStorage.buildSrcBucketMod.AvailableServiceObjectMethods.delete & Double = js.native
  
  @js.native
  sealed trait setMetadata
    extends StObject
       with AvailableServiceObjectMethods
  /* 0 */ val setMetadata: typingsJapgolly.googleCloudStorage.buildSrcBucketMod.AvailableServiceObjectMethods.setMetadata & Double = js.native
}
