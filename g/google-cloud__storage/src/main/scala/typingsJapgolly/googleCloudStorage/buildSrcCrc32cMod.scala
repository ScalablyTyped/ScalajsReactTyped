...
object buildSrcCrc32cMod {
  ...
  object CRC32CValidator {
    ...
    inline def apply(update: Buffer => Callback, validate: String => Boolean): CRC32CValidator = {
      val __obj = js.Dynamic.literal(update = js.Any.fromFunction1((t0: Buffer) => update(t0).runNow()), validate = js.Any.fromFunction1(validate))
