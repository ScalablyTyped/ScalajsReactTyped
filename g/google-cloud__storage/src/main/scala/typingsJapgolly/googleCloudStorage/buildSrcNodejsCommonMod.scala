...
import typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonServiceMod.ServiceConfig
import typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonServiceMod.ServiceOptions
import typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonServiceObjectMod.ServiceObjectConfig
...
import typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonUtilMod.Util_
...
object buildSrcNodejsCommonMod {
  ...
  open class ApiError protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonUtilMod.ApiError {
  ...
  open class Service protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonServiceMod.Service {
    /**
  ...
  open class ServiceObject[T] protected ()
    extends typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonServiceObjectMod.ServiceObject[T] {
  ...
  object util extends Shortcut {
    ...
    open class PartialFailureError protected ()
      extends typingsJapgolly.googleCloudStorage.buildSrcNodejsCommonUtilMod.PartialFailureError {
