...
import typingsJapgolly.googleImages.mod.SearchColorType
import typingsJapgolly.googleImages.mod.SearchDominantColor
import typingsJapgolly.googleImages.mod.SearchImageSize
import typingsJapgolly.googleImages.mod.SearchImageType
import typingsJapgolly.googleImages.mod.SearchSafe
...
object googleImagesStrings {
  ...
  sealed trait clipart
    extends StObject
       with SearchImageType
  inline def clipart: clipart = "clipart".asInstanceOf[clipart]
  
  @js.native
  sealed trait color
    extends StObject
       with SearchColorType
  ...
  sealed trait lineart
    extends StObject
       with SearchImageType
  inline def lineart: lineart = "lineart".asInstanceOf[lineart]
