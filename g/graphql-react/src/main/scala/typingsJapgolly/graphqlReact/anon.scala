...
import typingsJapgolly.graphqlReact.mod.GraphQLCache
...
object anon {
  ...
  object FetchOptionsOverride {
    ...
    extension [Self <: FetchOptionsOverride[?], V](x: Self & FetchOptionsOverride[V]) {
      ...
      inline def setFetchOptionsOverride(value: /* options */ GraphQLFetchOptions => Callback): Self = StObject.set(x, "fetchOptionsOverride", js.Any.fromFunction1((t0: /* options */ GraphQLFetchOptions) => value(t0).runNow()))
