...
import typingsJapgolly.gm.mod.ChannelOperator
import typingsJapgolly.gm.mod.ChannelType
import typingsJapgolly.gm.mod.ColorSpace
import typingsJapgolly.gm.mod.ComposeOperator
import typingsJapgolly.gm.mod.CompressionType
import typingsJapgolly.gm.mod.DisposeMethod
import typingsJapgolly.gm.mod.Encoding
import typingsJapgolly.gm.mod.EndianType
import typingsJapgolly.gm.mod.FilterType
import typingsJapgolly.gm.mod.GravityDirection
import typingsJapgolly.gm.mod.HighlightStyle
import typingsJapgolly.gm.mod.ImageType
import typingsJapgolly.gm.mod.IntentType
import typingsJapgolly.gm.mod.InterlaceType
import typingsJapgolly.gm.mod.LimitType
import typingsJapgolly.gm.mod.ListType
import typingsJapgolly.gm.mod.NamedColor
import typingsJapgolly.gm.mod.NoiseType
import typingsJapgolly.gm.mod.OperationMode
import typingsJapgolly.gm.mod.PreviewType
import typingsJapgolly.gm.mod.ResizeOption
import typingsJapgolly.gm.mod.SetDrawMethod
import typingsJapgolly.gm.mod.SetDrawProperty
import typingsJapgolly.gm.mod.UnitType
import typingsJapgolly.gm.mod.VirtualPixelMethod
import typingsJapgolly.gm.mod.VisualType
