package typingsJapgolly.getSassVars

import typingsJapgolly.getSassVars.getSassVarsStrings.async
import typingsJapgolly.getSassVars.getSassVarsStrings.sync
