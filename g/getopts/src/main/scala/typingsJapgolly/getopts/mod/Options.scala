...
object Options {
  ...
  def apply(
    ...
    unknown: /* optionName */ String => CallbackTo[Boolean] = null
  ): Options = {
    ...
    if (unknown != null) __obj.updateDynamic("unknown")(js.Any.fromFunction1((t0: /* optionName */ java.lang.String) => unknown(t0).runNow()))
