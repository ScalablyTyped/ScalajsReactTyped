...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.About
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.CommentList
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.FileList
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.GeneratedIds
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.PropertyList
...
import typingsJapgolly.googleAppsScript.googleAppsScriptStrings.fileOrganizer
import typingsJapgolly.googleAppsScript.googleAppsScriptStrings.organizer
import typingsJapgolly.googleAppsScript.googleAppsScriptStrings.owner
import typingsJapgolly.googleAppsScript.googleAppsScriptStrings.reader
import typingsJapgolly.googleAppsScript.googleAppsScriptStrings.writer
...
object Drive {
  ...
  inline def apply(
    ...
    newFile: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File],
    ...
    newPermission: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission],
    ...
    newUser: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User],
    newUserPicture: CallbackTo[UserPicture]
  ): Drive = {
    val __obj = js.Dynamic.literal(newChannel = newChannel.toJsFn, newChildReference = newChildReference.toJsFn, newComment = newComment.toJsFn, newCommentContext = newCommentContext.toJsFn, newCommentReply = newCommentReply.toJsFn, newDrive = newDrive.toJsFn, newDriveBackgroundImageFile = newDriveBackgroundImageFile.toJsFn, newDriveCapabilities = newDriveCapabilities.toJsFn, newDriveRestrictions = newDriveRestrictions.toJsFn, newFile = newFile.toJsFn, newFileCapabilities = newFileCapabilities.toJsFn, newFileImageMediaMetadata = newFileImageMediaMetadata.toJsFn, newFileImageMediaMetadataLocation = newFileImageMediaMetadataLocation.toJsFn, newFileIndexableText = newFileIndexableText.toJsFn, newFileLabels = newFileLabels.toJsFn, newFileThumbnail = newFileThumbnail.toJsFn, newFileVideoMediaMetadata = newFileVideoMediaMetadata.toJsFn, newParentReference = newParentReference.toJsFn, newPermission = newPermission.toJsFn, newPermissionPermissionDetails = newPermissionPermissionDetails.toJsFn, newPermissionTeamDrivePermissionDetails = newPermissionTeamDrivePermissionDetails.toJsFn, newProperty = newProperty.toJsFn, newRevision = newRevision.toJsFn, newTeamDrive = newTeamDrive.toJsFn, newTeamDriveBackgroundImageFile = newTeamDriveBackgroundImageFile.toJsFn, newTeamDriveCapabilities = newTeamDriveCapabilities.toJsFn, newTeamDriveRestrictions = newTeamDriveRestrictions.toJsFn, newUser = newUser.toJsFn, newUserPicture = newUserPicture.toJsFn)
  ...
  object Permission extends StObject {
    ...
    sealed trait COMMENT
      extends StObject
         with typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Permission
  ...
  object Collection {
    ...
    trait DrivesCollection extends StObject {
      ...
      def get(driveId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive = js.native
      // Gets a shared drive's metadata by ID.
      def get(driveId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive = js.native
      
      // Hides a shared drive from the default view.
      def hide(driveId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive = js.native
      
      // Creates a new shared drive.
      def insert(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive, requestId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive = js.native
      ...
      def unhide(driveId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive = js.native
      
      // Updates the metadata for a shared drive.
      def update(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive, driveId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive = js.native
      // Updates the metadata for a shared drive.
      def update(
        resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive,
        driveId: String,
        optionalArgs: js.Object
      ): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive = js.native
    }
    ...
    trait FilesCollection extends StObject {
      ...
      def copy(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File, fileId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Creates a copy of the specified file.
      def copy(
        resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File,
        fileId: String,
        optionalArgs: js.Object
      ): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      ...
      def get(fileId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Gets a file's metadata by ID.
      def get(fileId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      
      // Insert a new file.
      def insert(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Insert a new file.
      def insert(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File, mediaData: Any): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Insert a new file.
      def insert(
        resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File,
        mediaData: Any,
      ...
      def patch(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File, fileId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Updates file metadata and/or content. This method supports patch semantics.
      def patch(
        resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File,
        fileId: String,
      ...
      def touch(fileId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Set the file's updated time to the current server time.
      def touch(fileId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      ...
      def trash(fileId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Moves a file to the trash. The currently authenticated user must own the file or be at least a fileOrganizer on the parent for Team Drive files.
      def trash(fileId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      
      // Restores a file from the trash.
      def untrash(fileId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Restores a file from the trash.
      def untrash(fileId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      
      // Updates file metadata and/or content.
      def update(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File, fileId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = js.native
      // Updates file metadata and/or content.
      def update(
        resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File,
        fileId: String,
    ...
    trait PermissionsCollection extends StObject {
      ...
      def get(fileId: String, permissionId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission = js.native
      // Gets a permission by ID.
      def get(fileId: String, permissionId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission = js.native
      ...
      def insert(
        resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission,
        fileId: String
      ): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission = js.native
      // Inserts a permission for a file or Team Drive.
      def insert(
        resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission,
        fileId: String,
  ...
  trait DriveApp extends StObject {
    ...
    /**
      ...
      */
    def addFile(child: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File): Folder = js.native
    ...
    def createFile(blob: BlobSource): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    /**
      ...
      */
    def createFile(name: String, content: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    /**
      ...
      */
    def createFile(name: String, content: String, mimeType: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    ...
    def createShortcut(targetId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    ...
    /**
      ...
      * link.
      */
    def createShortcutForTargetIdAndResourceKey(targetId: String, targetResourceKey: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    ...
    /**
      ...
      */
    def getFileById(id: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    ...
    /**
      ...
      */
    def getFileByIdAndResourceKey(id: String, resourceKey: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    ...
    /**
      ...
      */
    def removeFile(child: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File): Folder = js.native
  ...
  extension [Self <: Drive](x: Self) {
    ...
    inline def setNewChildReference(value: CallbackTo[ChildReference]): Self = StObject.set(x, "newChildReference", value.toJsFn)
    
    inline def setNewComment(value: CallbackTo[Comment]): Self = StObject.set(x, "newComment", value.toJsFn)
    
    inline def setNewCommentContext(value: CallbackTo[CommentContext]): Self = StObject.set(x, "newCommentContext", value.toJsFn)
    
    inline def setNewCommentReply(value: CallbackTo[CommentReply]): Self = StObject.set(x, "newCommentReply", value.toJsFn)
    
    inline def setNewDrive(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive]): Self = StObject.set(x, "newDrive", value.toJsFn)
    
    inline def setNewDriveBackgroundImageFile(value: CallbackTo[DriveBackgroundImageFile]): Self = StObject.set(x, "newDriveBackgroundImageFile", value.toJsFn)
    
    inline def setNewDriveCapabilities(value: CallbackTo[DriveCapabilities]): Self = StObject.set(x, "newDriveCapabilities", value.toJsFn)
    
    inline def setNewDriveRestrictions(value: CallbackTo[DriveRestrictions]): Self = StObject.set(x, "newDriveRestrictions", value.toJsFn)
    
    inline def setNewFile(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File]): Self = StObject.set(x, "newFile", value.toJsFn)
    
    inline def setNewFileCapabilities(value: CallbackTo[FileCapabilities]): Self = StObject.set(x, "newFileCapabilities", value.toJsFn)
    
    inline def setNewFileImageMediaMetadata(value: CallbackTo[FileImageMediaMetadata]): Self = StObject.set(x, "newFileImageMediaMetadata", value.toJsFn)
    
    inline def setNewFileImageMediaMetadataLocation(value: CallbackTo[FileImageMediaMetadataLocation]): Self = StObject.set(x, "newFileImageMediaMetadataLocation", value.toJsFn)
    
    inline def setNewFileIndexableText(value: CallbackTo[FileIndexableText]): Self = StObject.set(x, "newFileIndexableText", value.toJsFn)
    
    inline def setNewFileLabels(value: CallbackTo[FileLabels]): Self = StObject.set(x, "newFileLabels", value.toJsFn)
    
    inline def setNewFileThumbnail(value: CallbackTo[FileThumbnail]): Self = StObject.set(x, "newFileThumbnail", value.toJsFn)
    
    inline def setNewFileVideoMediaMetadata(value: CallbackTo[FileVideoMediaMetadata]): Self = StObject.set(x, "newFileVideoMediaMetadata", value.toJsFn)
    
    inline def setNewParentReference(value: CallbackTo[ParentReference]): Self = StObject.set(x, "newParentReference", value.toJsFn)
    
    inline def setNewPermission(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission]): Self = StObject.set(x, "newPermission", value.toJsFn)
    
    inline def setNewPermissionPermissionDetails(value: CallbackTo[PermissionPermissionDetails]): Self = StObject.set(x, "newPermissionPermissionDetails", value.toJsFn)
    
    inline def setNewPermissionTeamDrivePermissionDetails(value: CallbackTo[PermissionTeamDrivePermissionDetails]): Self = StObject.set(x, "newPermissionTeamDrivePermissionDetails", value.toJsFn)
    
    inline def setNewProperty(value: CallbackTo[Property]): Self = StObject.set(x, "newProperty", value.toJsFn)
    
    inline def setNewRevision(value: CallbackTo[Revision]): Self = StObject.set(x, "newRevision", value.toJsFn)
    
    inline def setNewTeamDrive(value: CallbackTo[TeamDrive]): Self = StObject.set(x, "newTeamDrive", value.toJsFn)
    
    inline def setNewTeamDriveBackgroundImageFile(value: CallbackTo[TeamDriveBackgroundImageFile]): Self = StObject.set(x, "newTeamDriveBackgroundImageFile", value.toJsFn)
    
    inline def setNewTeamDriveCapabilities(value: CallbackTo[TeamDriveCapabilities]): Self = StObject.set(x, "newTeamDriveCapabilities", value.toJsFn)
    
    inline def setNewTeamDriveRestrictions(value: CallbackTo[TeamDriveRestrictions]): Self = StObject.set(x, "newTeamDriveRestrictions", value.toJsFn)
    
    inline def setNewUser(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User]): Self = StObject.set(x, "newUser", value.toJsFn)
    
    inline def setNewUserPicture(value: CallbackTo[UserPicture]): Self = StObject.set(x, "newUserPicture", value.toJsFn)
  ...
  trait File extends StObject {
    ...
    def addCommenter(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def addCommenter(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def addCommenters(emailAddresses: js.Array[String]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def addEditor(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def addEditor(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def addEditors(emailAddresses: js.Array[String]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def addViewer(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def addViewer(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def addViewers(emailAddresses: js.Array[String]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def getAccess(email: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Permission = js.native
    def getAccess(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Permission = js.native
    ...
    def getEditors(): js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.User] = js.native
    ...
    def getOwner(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.User = js.native
    ...
    def getSharingPermission(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Permission = js.native
    ...
    def getViewers(): js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.User] = js.native
    ...
    def makeCopy(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def makeCopy(destination: Folder): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def makeCopy(name: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def makeCopy(name: String, destination: Folder): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def moveTo(destination: Folder): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def removeCommenter(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def removeCommenter(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def removeEditor(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def removeEditor(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def removeViewer(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def removeViewer(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def revokePermissions(user: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def revokePermissions(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setContent(content: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setDescription(description: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setName(name: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setOwner(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    def setOwner(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setSecurityUpdateEnabled(enabled: Boolean): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setShareableByEditors(shareable: Boolean): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setSharing(
      accessType: Access,
      permissionType: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Permission
    ): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setStarred(starred: Boolean): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
    
    def setTrashed(trashed: Boolean): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File = js.native
  }
  ...
  trait FileIterator extends StObject {
    ...
    /**
      ...
      */
    def next(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File
  }
  object FileIterator {
    
    inline def apply(
      getContinuationToken: CallbackTo[String],
      hasNext: CallbackTo[Boolean],
      next: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File]
    ): FileIterator = {
      val __obj = js.Dynamic.literal(getContinuationToken = getContinuationToken.toJsFn, hasNext = hasNext.toJsFn, next = next.toJsFn)
      __obj.asInstanceOf[FileIterator]
    }
    
    extension [Self <: FileIterator](x: Self) {
      
      inline def setGetContinuationToken(value: CallbackTo[String]): Self = StObject.set(x, "getContinuationToken", value.toJsFn)
      
      inline def setHasNext(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasNext", value.toJsFn)
      
      inline def setNext(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.File]): Self = StObject.set(x, "next", value.toJsFn)
    }
  }
  ...
  trait Folder extends StObject {
    ...
    def addEditor(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): Folder = js.native
    ...
    def addViewer(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): Folder = js.native
    ...
    def removeEditor(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): Folder = js.native
    ...
    def removeViewer(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): Folder = js.native
    
    def revokePermissions(user: String): Folder = js.native
    def revokePermissions(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): Folder = js.native
    ...
    def setOwner(user: typingsJapgolly.googleAppsScript.GoogleAppsScript.Base.User): Folder = js.native
  ...
  object FolderIterator {
    ...
    inline def apply(getContinuationToken: CallbackTo[String], hasNext: CallbackTo[Boolean], next: CallbackTo[Folder]): FolderIterator = {
      val __obj = js.Dynamic.literal(getContinuationToken = getContinuationToken.toJsFn, hasNext = hasNext.toJsFn, next = next.toJsFn)
    ...
    extension [Self <: FolderIterator](x: Self) {
      ...
      inline def setNext(value: CallbackTo[Folder]): Self = StObject.set(x, "next", value.toJsFn)
    }
  }
  ...
  object Schema {
    ...
    trait About extends StObject {
      ...
      var user: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User] = js.undefined
    }
    object About {
      ...
      extension [Self <: About](x: Self) {
        ...
        inline def setUser(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User): Self = StObject.set(x, "user", value.asInstanceOf[js.Any])
    ...
    trait Change extends StObject {
      ...
      var drive: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive] = js.undefined
      
      var driveId: js.UndefOr[String] = js.undefined
      
      var file: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File] = js.undefined
    ...
    object Change {
      ...
      extension [Self <: Change](x: Self) {
        ...
        inline def setDrive(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive): Self = StObject.set(x, "drive", value.asInstanceOf[js.Any])
        ...
        inline def setFile(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File): Self = StObject.set(x, "file", value.asInstanceOf[js.Any])
    ...
    trait Comment extends StObject {
      ...
      var author: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User] = js.undefined
    ...
    object Comment {
      ...
      extension [Self <: Comment](x: Self) {
        ...
        inline def setAuthor(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User): Self = StObject.set(x, "author", value.asInstanceOf[js.Any])
    ...
    object Drive {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive](x: Self) {
    ...
    trait DriveList extends StObject {
      ...
      var items: js.UndefOr[js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive]] = js.undefined
    ...
    object DriveList {
      ...
      extension [Self <: DriveList](x: Self) {
        ...
        inline def setItems(value: js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
        
        inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
        
        inline def setItemsVarargs(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Drive*): Self = StObject.set(x, "items", js.Array(value*))
    ...
    trait File extends StObject {
      ...
      var lastModifyingUser: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User] = js.undefined
      ...
      var owners: js.UndefOr[js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User]] = js.undefined
      ...
      var permissions: js.UndefOr[
            js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission]
          ] = js.undefined
      ...
      var sharingUser: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User] = js.undefined
      ...
      var trashingUser: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User] = js.undefined
      
      var userPermission: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission] = js.undefined
    ...
    object File {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File](x: Self) {
        ...
        inline def setLastModifyingUser(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User): Self = StObject.set(x, "lastModifyingUser", value.asInstanceOf[js.Any])
        ...
        inline def setOwners(value: js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User]): Self = StObject.set(x, "owners", value.asInstanceOf[js.Any])
        
        inline def setOwnersUndefined: Self = StObject.set(x, "owners", js.undefined)
        
        inline def setOwnersVarargs(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User*): Self = StObject.set(x, "owners", js.Array(value*))
        ...
        inline def setPermissions(value: js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission]): Self = StObject.set(x, "permissions", value.asInstanceOf[js.Any])
        
        inline def setPermissionsUndefined: Self = StObject.set(x, "permissions", js.undefined)
        
        inline def setPermissionsVarargs(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission*): Self = StObject.set(x, "permissions", js.Array(value*))
        ...
        inline def setSharingUser(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User): Self = StObject.set(x, "sharingUser", value.asInstanceOf[js.Any])
        ...
        inline def setTrashingUser(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User): Self = StObject.set(x, "trashingUser", value.asInstanceOf[js.Any])
        
        inline def setTrashingUserUndefined: Self = StObject.set(x, "trashingUser", js.undefined)
        
        inline def setUserPermission(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission): Self = StObject.set(x, "userPermission", value.asInstanceOf[js.Any])
    ...
    trait FileList extends StObject {
      ...
      var items: js.UndefOr[js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File]] = js.undefined
    ...
    object FileList {
      ...
      extension [Self <: FileList](x: Self) {
        ...
        inline def setItems(value: js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
        
        inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
        
        inline def setItemsVarargs(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.File*): Self = StObject.set(x, "items", js.Array(value*))
    ...
    object Permission {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission](x: Self) {
    ...
    object PermissionList {
      ...
      extension [Self <: PermissionList](x: Self) {
        ...
        inline def setItems(value: js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
        
        inline def setItemsUndefined: Self = StObject.set(x, "items", js.undefined)
        
        inline def setItemsVarargs(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.Permission*): Self = StObject.set(x, "items", js.Array(value*))
    ...
    object User {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.Schema.User](x: Self) {
  ...
  object User {
    ...
    ): typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.User = {
      val __obj = js.Dynamic.literal(getDomain = getDomain.toJsFn, getEmail = getEmail.toJsFn, getName = getName.toJsFn, getPhotoUrl = getPhotoUrl.toJsFn, getUserLoginId = getUserLoginId.toJsFn)
      __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.User]
    }
    
    extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Drive.User](x: Self) {
      ...
      inline def setGetPhotoUrl(value: CallbackTo[String]): Self = StObject.set(x, "getPhotoUrl", value.toJsFn)
