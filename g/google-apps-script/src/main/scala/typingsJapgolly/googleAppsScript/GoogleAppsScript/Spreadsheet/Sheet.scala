...
import typingsJapgolly.googleAppsScript.anon.ContentsOnly
...
trait Sheet extends StObject {
  ...
  def copyTo(spreadsheet: typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet): Sheet = js.native
  ...
  def getParent(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
