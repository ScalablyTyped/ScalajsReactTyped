...
object EmbeddedColumnChartBuilder {
  ...
  def apply(
    ...
    setBackgroundColor: String => CallbackTo[EmbeddedColumnChartBuilder],
    setChartType: ChartType => CallbackTo[EmbeddedChartBuilder],
    setColors: js.Array[String] => CallbackTo[EmbeddedColumnChartBuilder],
    setHiddenDimensionStrategy: ChartHiddenDimensionStrategy => CallbackTo[EmbeddedChartBuilder],
    setLegendPosition: Position => CallbackTo[EmbeddedColumnChartBuilder],
    setLegendTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => CallbackTo[EmbeddedColumnChartBuilder],
    ...
    setRange: (Double, Double) => CallbackTo[EmbeddedColumnChartBuilder],
    setStacked: CallbackTo[EmbeddedColumnChartBuilder],
    setTitle: String => CallbackTo[EmbeddedColumnChartBuilder],
    setTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => CallbackTo[EmbeddedColumnChartBuilder],
    setTransposeRowsAndColumns: Boolean => CallbackTo[EmbeddedChartBuilder],
    setXAxisTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => CallbackTo[EmbeddedColumnChartBuilder],
    setXAxisTitle: String => CallbackTo[EmbeddedColumnChartBuilder],
    setXAxisTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => CallbackTo[EmbeddedColumnChartBuilder],
    setYAxisTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => CallbackTo[EmbeddedColumnChartBuilder],
    setYAxisTitle: String => CallbackTo[EmbeddedColumnChartBuilder],
    setYAxisTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => CallbackTo[EmbeddedColumnChartBuilder],
