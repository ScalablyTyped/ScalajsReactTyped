...
object EmbeddedBarChartBuilder {
  ...
  inline def apply(
    ...
    setLegendTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder,
  ...
  extension [Self <: EmbeddedBarChartBuilder](x: Self) {
    ...
    inline def setReverseCategories(value: CallbackTo[EmbeddedBarChartBuilder]): Self = StObject.set(x, "reverseCategories", value.toJsFn)
    
    inline def setReverseDirection(value: CallbackTo[EmbeddedBarChartBuilder]): Self = StObject.set(x, "reverseDirection", value.toJsFn)
    ...
    inline def setSetLegendTextStyle(
      value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedBarChartBuilder
    ...
    inline def setSetStacked(value: CallbackTo[EmbeddedBarChartBuilder]): Self = StObject.set(x, "setStacked", value.toJsFn)
    ...
    inline def setUseLogScale(value: CallbackTo[EmbeddedBarChartBuilder]): Self = StObject.set(x, "useLogScale", value.toJsFn)
  }
}
