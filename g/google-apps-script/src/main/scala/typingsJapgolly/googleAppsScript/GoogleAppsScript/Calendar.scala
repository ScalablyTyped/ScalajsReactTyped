...
trait Calendar extends StObject {
  ...
  def newConferenceData(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData
...
object Calendar {
  ...
  inline def apply(
    ...
    newConferenceData: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData],
  ...
  ): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar = {
    val __obj = js.Dynamic.literal(newAclRule = newAclRule.toJsFn, newAclRuleScope = newAclRuleScope.toJsFn, newCalendar = newCalendar.toJsFn, newCalendarListEntry = newCalendarListEntry.toJsFn, newCalendarListEntryNotificationSettings = newCalendarListEntryNotificationSettings.toJsFn, newCalendarNotification = newCalendarNotification.toJsFn, newChannel = newChannel.toJsFn, newConferenceData = newConferenceData.toJsFn, newConferenceParameters = newConferenceParameters.toJsFn, newConferenceParametersAddOnParameters = newConferenceParametersAddOnParameters.toJsFn, newConferenceProperties = newConferenceProperties.toJsFn, newConferenceRequestStatus = newConferenceRequestStatus.toJsFn, newConferenceSolution = newConferenceSolution.toJsFn, newConferenceSolutionKey = newConferenceSolutionKey.toJsFn, newCreateConferenceRequest = newCreateConferenceRequest.toJsFn, newEntryPoint = newEntryPoint.toJsFn, newEvent = newEvent.toJsFn, newEventAttachment = newEventAttachment.toJsFn, newEventAttendee = newEventAttendee.toJsFn, newEventCreator = newEventCreator.toJsFn, newEventDateTime = newEventDateTime.toJsFn, newEventExtendedProperties = newEventExtendedProperties.toJsFn, newEventGadget = newEventGadget.toJsFn, newEventOrganizer = newEventOrganizer.toJsFn, newEventReminder = newEventReminder.toJsFn, newEventReminders = newEventReminders.toJsFn, newEventSource = newEventSource.toJsFn, newFreeBusyRequest = newFreeBusyRequest.toJsFn, newFreeBusyRequestItem = newFreeBusyRequestItem.toJsFn)
    __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar]
  }
  ...
  trait CalendarApp extends StObject {
    ...
    def createCalendar(name: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
    def createCalendar(name: String, options: StringDictionary[Any]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
    ...
    def getAllCalendars(): js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar] = js.native
    
    def getAllOwnedCalendars(): js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar] = js.native
    
    def getCalendarById(id: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
    
    def getCalendarsByName(name: String): js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar] = js.native
    
    def getColor(): String = js.native
    
    def getDefaultCalendar(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
    ...
    def getOwnedCalendarById(id: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
    
    def getOwnedCalendarsByName(name: String): js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar] = js.native
    ...
    def subscribeToCalendar(id: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
    def subscribeToCalendar(id: String, options: StringDictionary[Any]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
  }
  ...
  extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar](x: Self) {
    ...
    inline def setNewAclRule(value: CallbackTo[AclRule]): Self = StObject.set(x, "newAclRule", value.toJsFn)
    
    inline def setNewAclRuleScope(value: CallbackTo[AclRuleScope]): Self = StObject.set(x, "newAclRuleScope", value.toJsFn)
    
    inline def setNewCalendar(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar]): Self = StObject.set(x, "newCalendar", value.toJsFn)
    
    inline def setNewCalendarListEntry(value: CallbackTo[CalendarListEntry]): Self = StObject.set(x, "newCalendarListEntry", value.toJsFn)
    
    inline def setNewCalendarListEntryNotificationSettings(value: CallbackTo[CalendarListEntryNotificationSettings]): Self = StObject.set(x, "newCalendarListEntryNotificationSettings", value.toJsFn)
    
    inline def setNewCalendarNotification(value: CallbackTo[CalendarNotification]): Self = StObject.set(x, "newCalendarNotification", value.toJsFn)
    
    inline def setNewChannel(value: CallbackTo[Channel]): Self = StObject.set(x, "newChannel", value.toJsFn)
    
    inline def setNewConferenceData(
      value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData]
    ): Self = StObject.set(x, "newConferenceData", value.toJsFn)
    
    inline def setNewConferenceParameters(value: CallbackTo[ConferenceParameters]): Self = StObject.set(x, "newConferenceParameters", value.toJsFn)
    
    inline def setNewConferenceParametersAddOnParameters(value: CallbackTo[ConferenceParametersAddOnParameters]): Self = StObject.set(x, "newConferenceParametersAddOnParameters", value.toJsFn)
    
    inline def setNewConferenceProperties(value: CallbackTo[ConferenceProperties]): Self = StObject.set(x, "newConferenceProperties", value.toJsFn)
    
    inline def setNewConferenceRequestStatus(value: CallbackTo[ConferenceRequestStatus]): Self = StObject.set(x, "newConferenceRequestStatus", value.toJsFn)
    
    inline def setNewConferenceSolution(value: CallbackTo[ConferenceSolution]): Self = StObject.set(x, "newConferenceSolution", value.toJsFn)
    
    inline def setNewConferenceSolutionKey(value: CallbackTo[ConferenceSolutionKey]): Self = StObject.set(x, "newConferenceSolutionKey", value.toJsFn)
    
    inline def setNewCreateConferenceRequest(value: CallbackTo[CreateConferenceRequest]): Self = StObject.set(x, "newCreateConferenceRequest", value.toJsFn)
    ...
    inline def setNewEventAttachment(value: CallbackTo[EventAttachment]): Self = StObject.set(x, "newEventAttachment", value.toJsFn)
    
    inline def setNewEventAttendee(value: CallbackTo[EventAttendee]): Self = StObject.set(x, "newEventAttendee", value.toJsFn)
    
    inline def setNewEventCreator(value: CallbackTo[EventCreator]): Self = StObject.set(x, "newEventCreator", value.toJsFn)
    
    inline def setNewEventDateTime(value: CallbackTo[EventDateTime]): Self = StObject.set(x, "newEventDateTime", value.toJsFn)
    
    inline def setNewEventExtendedProperties(value: CallbackTo[EventExtendedProperties]): Self = StObject.set(x, "newEventExtendedProperties", value.toJsFn)
    
    inline def setNewEventGadget(value: CallbackTo[EventGadget]): Self = StObject.set(x, "newEventGadget", value.toJsFn)
    
    inline def setNewEventOrganizer(value: CallbackTo[EventOrganizer]): Self = StObject.set(x, "newEventOrganizer", value.toJsFn)
    
    inline def setNewEventReminder(value: CallbackTo[EventReminder]): Self = StObject.set(x, "newEventReminder", value.toJsFn)
    
    inline def setNewEventReminders(value: CallbackTo[EventReminders]): Self = StObject.set(x, "newEventReminders", value.toJsFn)
    
    inline def setNewEventSource(value: CallbackTo[EventSource]): Self = StObject.set(x, "newEventSource", value.toJsFn)
    
    inline def setNewFreeBusyRequest(value: CallbackTo[FreeBusyRequest]): Self = StObject.set(x, "newFreeBusyRequest", value.toJsFn)
    
    inline def setNewFreeBusyRequestItem(value: CallbackTo[FreeBusyRequestItem]): Self = StObject.set(x, "newFreeBusyRequestItem", value.toJsFn)
  ...
  object Collection {
    ...
    trait EventsCollection extends StObject {
      ...
      def instances(calendarId: String, eventId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events = js.native
      // Returns instances of the specified recurring event.
      def instances(calendarId: String, eventId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events = js.native
      // Returns instances of the specified recurring event.
      def instances(calendarId: String, eventId: String, optionalArgs: js.Object, headers: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events = js.native
      
      // Returns events on the specified calendar.
      def list(calendarId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events = js.native
      // Returns events on the specified calendar.
      def list(calendarId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events = js.native
      // Returns events on the specified calendar.
      def list(calendarId: String, optionalArgs: js.Object, headers: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events = js.native
  ...
  object EventGuest {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getAdditionalGuests = getAdditionalGuests.toJsFn, getEmail = getEmail.toJsFn, getGuestStatus = getGuestStatus.toJsFn, getName = getName.toJsFn, getStatus = getStatus.toJsFn)
      __obj.asInstanceOf[EventGuest]
    }
    
    extension [Self <: EventGuest](x: Self) {
      
      inline def setGetAdditionalGuests(value: CallbackTo[Integer]): Self = StObject.set(x, "getAdditionalGuests", value.toJsFn)
      
      inline def setGetEmail(value: CallbackTo[String]): Self = StObject.set(x, "getEmail", value.toJsFn)
      
      inline def setGetGuestStatus(value: CallbackTo[GuestStatus]): Self = StObject.set(x, "getGuestStatus", value.toJsFn)
  ...
  object EventRecurrence {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addDailyExclusion = addDailyExclusion.toJsFn, addDailyRule = addDailyRule.toJsFn, addDate = js.Any.fromFunction1(addDate), addDateExclusion = js.Any.fromFunction1(addDateExclusion), addMonthlyExclusion = addMonthlyExclusion.toJsFn, addMonthlyRule = addMonthlyRule.toJsFn, addWeeklyExclusion = addWeeklyExclusion.toJsFn, addWeeklyRule = addWeeklyRule.toJsFn, addYearlyExclusion = addYearlyExclusion.toJsFn, addYearlyRule = addYearlyRule.toJsFn, setTimeZone = js.Any.fromFunction1(setTimeZone))
      __obj.asInstanceOf[EventRecurrence]
    }
    
    extension [Self <: EventRecurrence](x: Self) {
      
      inline def setAddDailyExclusion(value: CallbackTo[RecurrenceRule]): Self = StObject.set(x, "addDailyExclusion", value.toJsFn)
      
      inline def setAddDailyRule(value: CallbackTo[RecurrenceRule]): Self = StObject.set(x, "addDailyRule", value.toJsFn)
      ...
      inline def setAddMonthlyExclusion(value: CallbackTo[RecurrenceRule]): Self = StObject.set(x, "addMonthlyExclusion", value.toJsFn)
      
      inline def setAddMonthlyRule(value: CallbackTo[RecurrenceRule]): Self = StObject.set(x, "addMonthlyRule", value.toJsFn)
      
      inline def setAddWeeklyExclusion(value: CallbackTo[RecurrenceRule]): Self = StObject.set(x, "addWeeklyExclusion", value.toJsFn)
      
      inline def setAddWeeklyRule(value: CallbackTo[RecurrenceRule]): Self = StObject.set(x, "addWeeklyRule", value.toJsFn)
      
      inline def setAddYearlyExclusion(value: CallbackTo[RecurrenceRule]): Self = StObject.set(x, "addYearlyExclusion", value.toJsFn)
      
      inline def setAddYearlyRule(value: CallbackTo[RecurrenceRule]): Self = StObject.set(x, "addYearlyRule", value.toJsFn)
  ...
  object Schema {
    ...
    object Calendar {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar](x: Self) {
    ...
    object ConferenceData {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData](x: Self) {
    ...
    trait Event extends StObject {
      ...
      var conferenceData: js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData] = js.undefined
    ...
    object Event {
      ...
      extension [Self <: Event](x: Self) {
        ...
        inline def setConferenceData(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.ConferenceData): Self = StObject.set(x, "conferenceData", value.asInstanceOf[js.Any])
    ...
    object Events {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events](x: Self) {
