...
object EmbeddedComboChartBuilder {
  ...
  inline def apply(
    ...
    setLegendTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    ...
    setTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setXAxisTitle: String => EmbeddedComboChartBuilder,
    setXAxisTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setYAxisTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
    setYAxisTitle: String => EmbeddedComboChartBuilder,
    setYAxisTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder,
  ...
  extension [Self <: EmbeddedComboChartBuilder](x: Self) {
    ...
    inline def setReverseCategories(value: CallbackTo[EmbeddedComboChartBuilder]): Self = StObject.set(x, "reverseCategories", value.toJsFn)
    ...
    inline def setSetLegendTextStyle(
      value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedComboChartBuilder
    ...
    inline def setSetStacked(value: CallbackTo[EmbeddedComboChartBuilder]): Self = StObject.set(x, "setStacked", value.toJsFn)
    ...
    inline def setUseLogScale(value: CallbackTo[EmbeddedComboChartBuilder]): Self = StObject.set(x, "useLogScale", value.toJsFn)
  }
}
