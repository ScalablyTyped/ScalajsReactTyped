...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.BatchUpdateDocumentResponse
...
object Docs {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newAutoText = newAutoText.toJsFn, newBackground = newBackground.toJsFn, newBatchUpdateDocumentRequest = newBatchUpdateDocumentRequest.toJsFn, newBody = newBody.toJsFn, newBullet = newBullet.toJsFn, newColor = newColor.toJsFn, newColumnBreak = newColumnBreak.toJsFn, newCreateNamedRangeRequest = newCreateNamedRangeRequest.toJsFn, newCreateParagraphBulletsRequest = newCreateParagraphBulletsRequest.toJsFn, newDeleteContentRangeRequest = newDeleteContentRangeRequest.toJsFn, newDeleteNamedRangeRequest = newDeleteNamedRangeRequest.toJsFn, newDeleteParagraphBulletsRequest = newDeleteParagraphBulletsRequest.toJsFn, newDeletePositionedObjectRequest = newDeletePositionedObjectRequest.toJsFn, newDeleteTableColumnRequest = newDeleteTableColumnRequest.toJsFn, newDeleteTableRowRequest = newDeleteTableRowRequest.toJsFn, newDimension = newDimension.toJsFn, newDocument = newDocument.toJsFn, newDocumentStyle = newDocumentStyle.toJsFn, newEndOfSegmentLocation = newEndOfSegmentLocation.toJsFn, newEquation = newEquation.toJsFn, newFootnoteReference = newFootnoteReference.toJsFn, newHorizontalRule = newHorizontalRule.toJsFn, newInlineObjectElement = newInlineObjectElement.toJsFn, newInsertInlineImageRequest = newInsertInlineImageRequest.toJsFn, newInsertPageBreakRequest = newInsertPageBreakRequest.toJsFn, newInsertTableRequest = newInsertTableRequest.toJsFn, newInsertTableRowRequest = newInsertTableRowRequest.toJsFn, newInsertTextRequest = newInsertTextRequest.toJsFn, newLink = newLink.toJsFn, newLocation = newLocation.toJsFn, newNamedStyle = newNamedStyle.toJsFn, newNamedStyles = newNamedStyles.toJsFn, newOptionalColor = newOptionalColor.toJsFn, newPageBreak = newPageBreak.toJsFn, newParagraph = newParagraph.toJsFn, newParagraphBorder = newParagraphBorder.toJsFn, newParagraphElement = newParagraphElement.toJsFn, newParagraphStyle = newParagraphStyle.toJsFn, newRange = newRange.toJsFn, newReplaceAllTextRequest = newReplaceAllTextRequest.toJsFn, newRequest = newRequest.toJsFn, newRgbColor = newRgbColor.toJsFn, newSectionBreak = newSectionBreak.toJsFn, newSectionColumnProperties = newSectionColumnProperties.toJsFn, newSectionStyle = newSectionStyle.toJsFn, newShading = newShading.toJsFn, newSize = newSize.toJsFn, newStructuralElement = newStructuralElement.toJsFn, newSubstringMatchCriteria = newSubstringMatchCriteria.toJsFn, newTabStop = newTabStop.toJsFn, newTable = newTable.toJsFn, newTableCell = newTableCell.toJsFn, newTableCellBorder = newTableCellBorder.toJsFn, newTableCellLocation = newTableCellLocation.toJsFn, newTableCellStyle = newTableCellStyle.toJsFn, newTableColumnProperties = newTableColumnProperties.toJsFn, newTableOfContents = newTableOfContents.toJsFn, newTableRow = newTableRow.toJsFn, newTableRowStyle = newTableRowStyle.toJsFn, newTableStyle = newTableStyle.toJsFn, newTextRun = newTextRun.toJsFn, newTextStyle = newTextStyle.toJsFn, newUpdateParagraphStyleRequest = newUpdateParagraphStyleRequest.toJsFn, newUpdateTextStyleRequest = newUpdateTextStyleRequest.toJsFn, newWeightedFontFamily = newWeightedFontFamily.toJsFn, newWriteControl = newWriteControl.toJsFn)
  ...
  object Collection {
    ...
    trait DocumentsCollection extends StObject {
      ...
      def create(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.Document): typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.Document = js.native
      
      // Gets the latest version of the specified document.
      def get(documentId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.Document = js.native
      // Gets the latest version of the specified document.
      def get(documentId: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.Document = js.native
    }
  }
  ...
  extension [Self <: Docs](x: Self) {
    ...
    inline def setNewAutoText(value: CallbackTo[AutoText]): Self = StObject.set(x, "newAutoText", value.toJsFn)
    
    inline def setNewBackground(value: CallbackTo[Background]): Self = StObject.set(x, "newBackground", value.toJsFn)
    
    inline def setNewBatchUpdateDocumentRequest(value: CallbackTo[BatchUpdateDocumentRequest]): Self = StObject.set(x, "newBatchUpdateDocumentRequest", value.toJsFn)
    
    inline def setNewBody(value: CallbackTo[Body]): Self = StObject.set(x, "newBody", value.toJsFn)
    ...
    inline def setNewColumnBreak(value: CallbackTo[ColumnBreak]): Self = StObject.set(x, "newColumnBreak", value.toJsFn)
    
    inline def setNewCreateNamedRangeRequest(value: CallbackTo[CreateNamedRangeRequest]): Self = StObject.set(x, "newCreateNamedRangeRequest", value.toJsFn)
    ...
    inline def setNewDeleteContentRangeRequest(value: CallbackTo[DeleteContentRangeRequest]): Self = StObject.set(x, "newDeleteContentRangeRequest", value.toJsFn)
    ...
    inline def setNewDeletePositionedObjectRequest(value: CallbackTo[DeletePositionedObjectRequest]): Self = StObject.set(x, "newDeletePositionedObjectRequest", value.toJsFn)
    ...
    inline def setNewDocument(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.Document]): Self = StObject.set(x, "newDocument", value.toJsFn)
    
    inline def setNewDocumentStyle(value: CallbackTo[DocumentStyle]): Self = StObject.set(x, "newDocumentStyle", value.toJsFn)
    
    inline def setNewEndOfSegmentLocation(value: CallbackTo[EndOfSegmentLocation]): Self = StObject.set(x, "newEndOfSegmentLocation", value.toJsFn)
    
    inline def setNewEquation(value: CallbackTo[Equation]): Self = StObject.set(x, "newEquation", value.toJsFn)
    
    inline def setNewFootnoteReference(value: CallbackTo[FootnoteReference]): Self = StObject.set(x, "newFootnoteReference", value.toJsFn)
    
    inline def setNewHorizontalRule(value: CallbackTo[HorizontalRule]): Self = StObject.set(x, "newHorizontalRule", value.toJsFn)
    
    inline def setNewInlineObjectElement(value: CallbackTo[InlineObjectElement]): Self = StObject.set(x, "newInlineObjectElement", value.toJsFn)
    
    inline def setNewInsertInlineImageRequest(value: CallbackTo[InsertInlineImageRequest]): Self = StObject.set(x, "newInsertInlineImageRequest", value.toJsFn)
    
    inline def setNewInsertPageBreakRequest(value: CallbackTo[InsertPageBreakRequest]): Self = StObject.set(x, "newInsertPageBreakRequest", value.toJsFn)
    
    inline def setNewInsertTableRequest(value: CallbackTo[InsertTableRequest]): Self = StObject.set(x, "newInsertTableRequest", value.toJsFn)
    
    inline def setNewInsertTableRowRequest(value: CallbackTo[InsertTableRowRequest]): Self = StObject.set(x, "newInsertTableRowRequest", value.toJsFn)
    ...
    inline def setNewLocation(value: CallbackTo[Location]): Self = StObject.set(x, "newLocation", value.toJsFn)
    
    inline def setNewNamedStyle(value: CallbackTo[NamedStyle]): Self = StObject.set(x, "newNamedStyle", value.toJsFn)
    
    inline def setNewNamedStyles(value: CallbackTo[NamedStyles]): Self = StObject.set(x, "newNamedStyles", value.toJsFn)
    
    inline def setNewOptionalColor(value: CallbackTo[OptionalColor]): Self = StObject.set(x, "newOptionalColor", value.toJsFn)
    
    inline def setNewPageBreak(value: CallbackTo[PageBreak]): Self = StObject.set(x, "newPageBreak", value.toJsFn)
    
    inline def setNewParagraph(value: CallbackTo[Paragraph]): Self = StObject.set(x, "newParagraph", value.toJsFn)
    
    inline def setNewParagraphBorder(value: CallbackTo[ParagraphBorder]): Self = StObject.set(x, "newParagraphBorder", value.toJsFn)
    
    inline def setNewParagraphElement(value: CallbackTo[ParagraphElement]): Self = StObject.set(x, "newParagraphElement", value.toJsFn)
    
    inline def setNewParagraphStyle(value: CallbackTo[ParagraphStyle]): Self = StObject.set(x, "newParagraphStyle", value.toJsFn)
    ...
    inline def setNewSectionBreak(value: CallbackTo[SectionBreak]): Self = StObject.set(x, "newSectionBreak", value.toJsFn)
    
    inline def setNewSectionColumnProperties(value: CallbackTo[SectionColumnProperties]): Self = StObject.set(x, "newSectionColumnProperties", value.toJsFn)
    
    inline def setNewSectionStyle(value: CallbackTo[SectionStyle]): Self = StObject.set(x, "newSectionStyle", value.toJsFn)
    
    inline def setNewShading(value: CallbackTo[Shading]): Self = StObject.set(x, "newShading", value.toJsFn)
    
    inline def setNewSize(value: CallbackTo[Size]): Self = StObject.set(x, "newSize", value.toJsFn)
    
    inline def setNewStructuralElement(value: CallbackTo[StructuralElement]): Self = StObject.set(x, "newStructuralElement", value.toJsFn)
    ...
    inline def setNewTabStop(value: CallbackTo[TabStop]): Self = StObject.set(x, "newTabStop", value.toJsFn)
    
    inline def setNewTable(value: CallbackTo[Table]): Self = StObject.set(x, "newTable", value.toJsFn)
    
    inline def setNewTableCell(value: CallbackTo[TableCell]): Self = StObject.set(x, "newTableCell", value.toJsFn)
    
    inline def setNewTableCellBorder(value: CallbackTo[TableCellBorder]): Self = StObject.set(x, "newTableCellBorder", value.toJsFn)
    ...
    inline def setNewTableCellStyle(value: CallbackTo[TableCellStyle]): Self = StObject.set(x, "newTableCellStyle", value.toJsFn)
    ...
    inline def setNewTableOfContents(value: CallbackTo[TableOfContents]): Self = StObject.set(x, "newTableOfContents", value.toJsFn)
    
    inline def setNewTableRow(value: CallbackTo[TableRow]): Self = StObject.set(x, "newTableRow", value.toJsFn)
    
    inline def setNewTableRowStyle(value: CallbackTo[TableRowStyle]): Self = StObject.set(x, "newTableRowStyle", value.toJsFn)
    
    inline def setNewTableStyle(value: CallbackTo[TableStyle]): Self = StObject.set(x, "newTableStyle", value.toJsFn)
    
    inline def setNewTextRun(value: CallbackTo[TextRun]): Self = StObject.set(x, "newTextRun", value.toJsFn)
    
    inline def setNewTextStyle(value: CallbackTo[TextStyle]): Self = StObject.set(x, "newTextStyle", value.toJsFn)
  ...
  object Schema {
    ...
    object Document {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.Document = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.Document]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.Document](x: Self) {
    ...
    object List {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.List = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.List]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Docs.Schema.List](x: Self) {
