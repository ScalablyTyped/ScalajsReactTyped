...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.Reports.SavedCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Schema.AdsenseReportsGenerateResponse
