...
object DriveActivity {
  ...
  inline def apply(
    ...
    newLegacy: CallbackTo[Any],
    newNoConsolidation: CallbackTo[Any],
    newQueryDriveActivityRequest: CallbackTo[QueryDriveActivityRequest]
  ): DriveActivity = {
    val __obj = js.Dynamic.literal(newConsolidationStrategy = newConsolidationStrategy.toJsFn, newLegacy = newLegacy.toJsFn, newNoConsolidation = newNoConsolidation.toJsFn, newQueryDriveActivityRequest = newQueryDriveActivityRequest.toJsFn)
  ...
  extension [Self <: DriveActivity](x: Self) {
    ...
    inline def setNewConsolidationStrategy(value: CallbackTo[ConsolidationStrategy]): Self = StObject.set(x, "newConsolidationStrategy", value.toJsFn)
    
    inline def setNewLegacy(value: CallbackTo[Any]): Self = StObject.set(x, "newLegacy", value.toJsFn)
    
    inline def setNewNoConsolidation(value: CallbackTo[Any]): Self = StObject.set(x, "newNoConsolidation", value.toJsFn)
    
    inline def setNewQueryDriveActivityRequest(value: CallbackTo[QueryDriveActivityRequest]): Self = StObject.set(x, "newQueryDriveActivityRequest", value.toJsFn)
  }
  ...
  object Schema {
    ...
    object DriveActivity {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity](x: Self) {
    ...
    trait QueryDriveActivityResponse extends StObject {
      ...
      var activities: js.UndefOr[
            js.Array[
              typingsJapgolly.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity
            ]
          ] = js.undefined
    ...
    object QueryDriveActivityResponse {
      ...
      extension [Self <: QueryDriveActivityResponse](x: Self) {
        ...
        inline def setActivitiesVarargs(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.DriveActivity.Schema.DriveActivity*): Self = StObject.set(x, "activities", js.Array(value*))
