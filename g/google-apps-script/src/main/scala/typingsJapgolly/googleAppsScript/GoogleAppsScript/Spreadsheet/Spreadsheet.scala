...
import typingsJapgolly.googleAppsScript.anon.FunctionName
import typingsJapgolly.googleAppsScript.anon.Template
...
trait Spreadsheet extends StObject {
  ...
  def addDeveloperMetadata(key: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, value: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, value: String, visibility: DeveloperMetadataVisibility): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addDeveloperMetadata(key: String, visibility: DeveloperMetadataVisibility): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def addEditor(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addEditor(user: User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def addEditors(emailAddresses: js.Array[String]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def addMenu(name: String, subMenus: js.Array[FunctionName | Null]): Unit = js.native
  
  def addViewer(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def addViewer(user: User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def addViewers(emailAddresses: js.Array[String]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def appendRow(rowContents: js.Array[Any]): Sheet = js.native
  
  def autoResizeColumn(columnPosition: Integer): Sheet = js.native
  
  def copy(name: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def removeEditor(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeEditor(user: User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def removeMenu(name: String): Unit = js.native
  
  def removeNamedRange(name: String): Unit = js.native
  
  def removeViewer(emailAddress: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  def removeViewer(user: User): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  ...
  def setIterativeCalculationConvergenceThreshold(minThreshold: Double): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def setIterativeCalculationEnabled(isEnabled: Boolean): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def setMaxIterativeCalculationCycles(maxIterations: Integer): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
  
  def setNamedRange(name: String, range: Range): Unit = js.native
  
  def setRecalculationInterval(recalculationInterval: RecalculationInterval): typingsJapgolly.googleAppsScript.GoogleAppsScript.Spreadsheet.Spreadsheet = js.native
