package typingsJapgolly.googleAppsScript.GoogleAppsScript.UrlShortener

import typingsJapgolly.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.Url
import typingsJapgolly.googleAppsScript.GoogleAppsScript.UrlShortener.Schema.UrlHistory
