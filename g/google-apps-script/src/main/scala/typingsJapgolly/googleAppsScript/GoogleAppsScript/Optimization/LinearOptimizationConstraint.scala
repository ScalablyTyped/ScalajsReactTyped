...
object LinearOptimizationConstraint {
  @scala.inline
  def apply(setCoefficient: (String, Double) => CallbackTo[LinearOptimizationConstraint]): LinearOptimizationConstraint = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("setCoefficient")(js.Any.fromFunction2((t0: java.lang.String, t1: scala.Double) => setCoefficient(t0, t1).runNow()))
