...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.People.Collection.ContactGroups.MembersCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.People.Collection.ContactGroupsCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.People.Collection.People.ConnectionsCollection
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.People.Schema.BatchGetContactGroupsResponse
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.People.Schema.GetPeopleResponse
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.People.Schema.ListConnectionsResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.People.Schema.ListContactGroupsResponse
...
object People {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newAddress = newAddress.toJsFn, newAgeRangeType = newAgeRangeType.toJsFn, newBiography = newBiography.toJsFn, newBirthday = newBirthday.toJsFn, newBraggingRights = newBraggingRights.toJsFn, newContactGroup = newContactGroup.toJsFn, newContactGroupMembership = newContactGroupMembership.toJsFn, newContactGroupMetadata = newContactGroupMetadata.toJsFn, newCoverPhoto = newCoverPhoto.toJsFn, newCreateContactGroupRequest = newCreateContactGroupRequest.toJsFn, newDate = newDate.toJsFn, newDomainMembership = newDomainMembership.toJsFn, newEmailAddress = newEmailAddress.toJsFn, newEvent = newEvent.toJsFn, newFieldMetadata = newFieldMetadata.toJsFn, newGender = newGender.toJsFn, newImClient = newImClient.toJsFn, newInterest = newInterest.toJsFn, newLocale = newLocale.toJsFn, newMembership = newMembership.toJsFn, newModifyContactGroupMembersRequest = newModifyContactGroupMembersRequest.toJsFn, newName = newName.toJsFn, newNickname = newNickname.toJsFn, newOccupation = newOccupation.toJsFn, newOrganization = newOrganization.toJsFn, newPerson = newPerson.toJsFn, newPersonMetadata = newPersonMetadata.toJsFn, newPhoneNumber = newPhoneNumber.toJsFn, newPhoto = newPhoto.toJsFn, newProfileMetadata = newProfileMetadata.toJsFn, newRelation = newRelation.toJsFn, newRelationshipInterest = newRelationshipInterest.toJsFn, newRelationshipStatus = newRelationshipStatus.toJsFn, newResidence = newResidence.toJsFn, newSipAddress = newSipAddress.toJsFn, newSkill = newSkill.toJsFn, newSource = newSource.toJsFn, newTagline = newTagline.toJsFn, newUpdateContactGroupRequest = newUpdateContactGroupRequest.toJsFn, newUrl = newUrl.toJsFn, newUserDefined = newUserDefined.toJsFn)
  ...
  extension [Self <: People](x: Self) {
    ...
    inline def setNewAgeRangeType(value: CallbackTo[AgeRangeType]): Self = StObject.set(x, "newAgeRangeType", value.toJsFn)
    
    inline def setNewBiography(value: CallbackTo[Biography]): Self = StObject.set(x, "newBiography", value.toJsFn)
    
    inline def setNewBirthday(value: CallbackTo[Birthday]): Self = StObject.set(x, "newBirthday", value.toJsFn)
    
    inline def setNewBraggingRights(value: CallbackTo[BraggingRights]): Self = StObject.set(x, "newBraggingRights", value.toJsFn)
    
    inline def setNewContactGroup(value: CallbackTo[ContactGroup]): Self = StObject.set(x, "newContactGroup", value.toJsFn)
    
    inline def setNewContactGroupMembership(value: CallbackTo[ContactGroupMembership]): Self = StObject.set(x, "newContactGroupMembership", value.toJsFn)
    
    inline def setNewContactGroupMetadata(value: CallbackTo[ContactGroupMetadata]): Self = StObject.set(x, "newContactGroupMetadata", value.toJsFn)
    
    inline def setNewCoverPhoto(value: CallbackTo[CoverPhoto]): Self = StObject.set(x, "newCoverPhoto", value.toJsFn)
    
    inline def setNewCreateContactGroupRequest(value: CallbackTo[CreateContactGroupRequest]): Self = StObject.set(x, "newCreateContactGroupRequest", value.toJsFn)
    
    inline def setNewDate(value: CallbackTo[Date]): Self = StObject.set(x, "newDate", value.toJsFn)
    
    inline def setNewDomainMembership(value: CallbackTo[DomainMembership]): Self = StObject.set(x, "newDomainMembership", value.toJsFn)
    
    inline def setNewEmailAddress(value: CallbackTo[EmailAddress]): Self = StObject.set(x, "newEmailAddress", value.toJsFn)
    
    inline def setNewEvent(value: CallbackTo[Event]): Self = StObject.set(x, "newEvent", value.toJsFn)
    
    inline def setNewFieldMetadata(value: CallbackTo[FieldMetadata]): Self = StObject.set(x, "newFieldMetadata", value.toJsFn)
    
    inline def setNewGender(value: CallbackTo[Gender]): Self = StObject.set(x, "newGender", value.toJsFn)
    
    inline def setNewImClient(value: CallbackTo[ImClient]): Self = StObject.set(x, "newImClient", value.toJsFn)
    
    inline def setNewInterest(value: CallbackTo[Interest]): Self = StObject.set(x, "newInterest", value.toJsFn)
    
    inline def setNewLocale(value: CallbackTo[Locale]): Self = StObject.set(x, "newLocale", value.toJsFn)
    
    inline def setNewMembership(value: CallbackTo[Membership]): Self = StObject.set(x, "newMembership", value.toJsFn)
    
    inline def setNewModifyContactGroupMembersRequest(value: CallbackTo[ModifyContactGroupMembersRequest]): Self = StObject.set(x, "newModifyContactGroupMembersRequest", value.toJsFn)
    
    inline def setNewName(value: CallbackTo[Name]): Self = StObject.set(x, "newName", value.toJsFn)
    
    inline def setNewNickname(value: CallbackTo[Nickname]): Self = StObject.set(x, "newNickname", value.toJsFn)
    
    inline def setNewOccupation(value: CallbackTo[Occupation]): Self = StObject.set(x, "newOccupation", value.toJsFn)
    
    inline def setNewOrganization(value: CallbackTo[Organization]): Self = StObject.set(x, "newOrganization", value.toJsFn)
    
    inline def setNewPerson(value: CallbackTo[Person]): Self = StObject.set(x, "newPerson", value.toJsFn)
    
    inline def setNewPersonMetadata(value: CallbackTo[PersonMetadata]): Self = StObject.set(x, "newPersonMetadata", value.toJsFn)
    
    inline def setNewPhoneNumber(value: CallbackTo[PhoneNumber]): Self = StObject.set(x, "newPhoneNumber", value.toJsFn)
    
    inline def setNewPhoto(value: CallbackTo[Photo]): Self = StObject.set(x, "newPhoto", value.toJsFn)
    
    inline def setNewProfileMetadata(value: CallbackTo[ProfileMetadata]): Self = StObject.set(x, "newProfileMetadata", value.toJsFn)
    
    inline def setNewRelation(value: CallbackTo[Relation]): Self = StObject.set(x, "newRelation", value.toJsFn)
    
    inline def setNewRelationshipInterest(value: CallbackTo[RelationshipInterest]): Self = StObject.set(x, "newRelationshipInterest", value.toJsFn)
    
    inline def setNewRelationshipStatus(value: CallbackTo[RelationshipStatus]): Self = StObject.set(x, "newRelationshipStatus", value.toJsFn)
    
    inline def setNewResidence(value: CallbackTo[Residence]): Self = StObject.set(x, "newResidence", value.toJsFn)
    
    inline def setNewSipAddress(value: CallbackTo[SipAddress]): Self = StObject.set(x, "newSipAddress", value.toJsFn)
    
    inline def setNewSkill(value: CallbackTo[Skill]): Self = StObject.set(x, "newSkill", value.toJsFn)
    
    inline def setNewSource(value: CallbackTo[Source]): Self = StObject.set(x, "newSource", value.toJsFn)
    
    inline def setNewTagline(value: CallbackTo[Tagline]): Self = StObject.set(x, "newTagline", value.toJsFn)
    
    inline def setNewUpdateContactGroupRequest(value: CallbackTo[UpdateContactGroupRequest]): Self = StObject.set(x, "newUpdateContactGroupRequest", value.toJsFn)
    
    inline def setNewUrl(value: CallbackTo[Url]): Self = StObject.set(x, "newUrl", value.toJsFn)
    
    inline def setNewUserDefined(value: CallbackTo[UserDefined]): Self = StObject.set(x, "newUserDefined", value.toJsFn)
