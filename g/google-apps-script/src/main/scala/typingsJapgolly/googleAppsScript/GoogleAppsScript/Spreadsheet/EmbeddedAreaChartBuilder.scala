...
object EmbeddedAreaChartBuilder {
  ...
  inline def apply(
    ...
    setLegendTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder,
  ...
  extension [Self <: EmbeddedAreaChartBuilder](x: Self) {
    ...
    inline def setReverseCategories(value: CallbackTo[EmbeddedAreaChartBuilder]): Self = StObject.set(x, "reverseCategories", value.toJsFn)
    ...
    inline def setSetLegendTextStyle(
      value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedAreaChartBuilder
    ...
    inline def setSetStacked(value: CallbackTo[EmbeddedAreaChartBuilder]): Self = StObject.set(x, "setStacked", value.toJsFn)
    ...
    inline def setUseLogScale(value: CallbackTo[EmbeddedAreaChartBuilder]): Self = StObject.set(x, "useLogScale", value.toJsFn)
  }
}
