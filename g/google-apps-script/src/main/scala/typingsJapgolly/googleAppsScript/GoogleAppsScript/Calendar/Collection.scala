...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Acl
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.AclRule
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.CalendarList
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Colors
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Event
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Events
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.FreeBusyRequest
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.FreeBusyResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Setting
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Settings
...
object Collection extends js.Object {
  ...
  trait CalendarsCollection extends js.Object {
    ...
    def get(calendarId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    // Returns metadata for a calendar.
    def get(calendarId: String, optionalArgs: js.Object, headers: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    // Creates a secondary calendar.
    def insert(resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
    // Creates a secondary calendar.
    def insert(
      resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar,
      optionalArgs: js.Object,
      headers: js.Object
    ): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Schema.Calendar = js.native
