package typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager

import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.EnvironmentsCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.VersionHeadersCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.VersionsCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.BuiltInVariablesCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.FoldersCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.TagsCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.TriggersCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.VariablesCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.Workspaces.ZonesCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.Containers.WorkspacesCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.ContainersCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Collection.Accounts.UserPermissionsCollection
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ContainerVersionHeader
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.CreateBuiltInVariableResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.CreateContainerVersionRequestVersionOptions
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.CreateContainerVersionResponse
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.FolderEntities
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.GetWorkspaceStatusResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListAccountsResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListContainerVersionsResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListContainersResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListEnabledBuiltInVariablesResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListEnvironmentsResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListFoldersResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListTagsResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListTriggersResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListUserPermissionsResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListVariablesResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListWorkspacesResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.ListZonesResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.PublishContainerVersionResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.QuickPreviewResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertBuiltInVariableResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertFolderResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertTagResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertTriggerResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertVariableResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.RevertZoneResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.TagManager.Schema.SyncWorkspaceResponse
