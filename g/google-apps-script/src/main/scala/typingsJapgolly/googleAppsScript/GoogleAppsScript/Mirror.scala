...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Mirror.Schema.AttachmentsListResponse
...
object Mirror {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newAccount = newAccount.toJsFn, newAttachment = newAttachment.toJsFn, newAuthToken = newAuthToken.toJsFn, newCommand = newCommand.toJsFn, newContact = newContact.toJsFn, newLocation = newLocation.toJsFn, newMenuItem = newMenuItem.toJsFn, newMenuValue = newMenuValue.toJsFn, newNotification = newNotification.toJsFn, newNotificationConfig = newNotificationConfig.toJsFn, newSubscription = newSubscription.toJsFn, newTimelineItem = newTimelineItem.toJsFn, newUserAction = newUserAction.toJsFn, newUserData = newUserData.toJsFn)
  ...
  object Collection {
    ...
    object ContactsCollection {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get), insert = js.Any.fromFunction1(insert), list = list.toJsFn, patch = js.Any.fromFunction2(patch), remove = js.Any.fromFunction1((t0: String) => remove(t0).runNow()), update = js.Any.fromFunction2(update))
      ...
      extension [Self <: ContactsCollection](x: Self) {
        ...
        inline def setList(value: CallbackTo[ContactsListResponse]): Self = StObject.set(x, "list", value.toJsFn)
    ...
    object LocationsCollection {
      ...
      inline def apply(get: String => Location, list: CallbackTo[LocationsListResponse]): LocationsCollection = {
      ...
      extension [Self <: LocationsCollection](x: Self) {
        ...
        inline def setList(value: CallbackTo[LocationsListResponse]): Self = StObject.set(x, "list", value.toJsFn)
      }
    }
    ...
    object SubscriptionsCollection {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(insert = js.Any.fromFunction1(insert), list = list.toJsFn, remove = js.Any.fromFunction1((t0: String) => remove(t0).runNow()), update = js.Any.fromFunction2(update))
      ...
      extension [Self <: SubscriptionsCollection](x: Self) {
        ...
        inline def setList(value: CallbackTo[SubscriptionsListResponse]): Self = StObject.set(x, "list", value.toJsFn)
  ...
  extension [Self <: Mirror](x: Self) {
    ...
    inline def setNewAuthToken(value: CallbackTo[AuthToken]): Self = StObject.set(x, "newAuthToken", value.toJsFn)
    
    inline def setNewCommand(value: CallbackTo[Command]): Self = StObject.set(x, "newCommand", value.toJsFn)
    
    inline def setNewContact(value: CallbackTo[Contact]): Self = StObject.set(x, "newContact", value.toJsFn)
    
    inline def setNewLocation(value: CallbackTo[Location]): Self = StObject.set(x, "newLocation", value.toJsFn)
    
    inline def setNewMenuItem(value: CallbackTo[MenuItem]): Self = StObject.set(x, "newMenuItem", value.toJsFn)
    
    inline def setNewMenuValue(value: CallbackTo[MenuValue]): Self = StObject.set(x, "newMenuValue", value.toJsFn)
    
    inline def setNewNotification(value: CallbackTo[Notification]): Self = StObject.set(x, "newNotification", value.toJsFn)
    
    inline def setNewNotificationConfig(value: CallbackTo[NotificationConfig]): Self = StObject.set(x, "newNotificationConfig", value.toJsFn)
    
    inline def setNewSubscription(value: CallbackTo[Subscription]): Self = StObject.set(x, "newSubscription", value.toJsFn)
    
    inline def setNewTimelineItem(value: CallbackTo[TimelineItem]): Self = StObject.set(x, "newTimelineItem", value.toJsFn)
    
    inline def setNewUserAction(value: CallbackTo[UserAction]): Self = StObject.set(x, "newUserAction", value.toJsFn)
    
    inline def setNewUserData(value: CallbackTo[UserData]): Self = StObject.set(x, "newUserData", value.toJsFn)
