...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Schema.Accounts
  ...
  object Collection {
    ...
    object Accounts {
      ...
      trait CustomchannelsCollection extends StObject {
        ...
        var Adunits: js.UndefOr[
                typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.Customchannels.AdunitsCollection
              ] = js.native
      ...
      object PaymentsCollection {
        ...
        inline def apply(list: String => Payments): typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.PaymentsCollection = {
          val __obj = js.Dynamic.literal(list = js.Any.fromFunction1(list))
          __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.PaymentsCollection]
        }
        
        extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Collection.Accounts.PaymentsCollection](x: Self) {
    ...
    object Metadata {
      ...
      object DimensionsCollection {
        ...
        inline def apply(list: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Schema.Metadata]): DimensionsCollection = {
          val __obj = js.Dynamic.literal(list = list.toJsFn)
          __obj.asInstanceOf[DimensionsCollection]
        }
        
        extension [Self <: DimensionsCollection](x: Self) {
          
          inline def setList(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Schema.Metadata]): Self = StObject.set(x, "list", value.toJsFn)
        }
      }
      ...
      object MetricsCollection {
        ...
        inline def apply(list: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Schema.Metadata]): MetricsCollection = {
          val __obj = js.Dynamic.literal(list = list.toJsFn)
    ...
    object PaymentsCollection {
      ...
      inline def apply(list: CallbackTo[Payments]): PaymentsCollection = {
        val __obj = js.Dynamic.literal(list = list.toJsFn)
      ...
      extension [Self <: PaymentsCollection](x: Self) {
        ...
        inline def setList(value: CallbackTo[Payments]): Self = StObject.set(x, "list", value.toJsFn)
      }
    }
    ...
    trait ReportsCollection extends StObject {
      ...
      var Saved: js.UndefOr[
            typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Collection.Reports.SavedCollection
          ] = js.native
