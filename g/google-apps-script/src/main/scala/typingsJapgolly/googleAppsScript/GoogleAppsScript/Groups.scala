...
object Groups {
  ...
  object GroupsApp {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(Role = Role.asInstanceOf[js.Any], getGroupByEmail = js.Any.fromFunction1(getGroupByEmail), getGroups = getGroups.toJsFn)
    ...
    extension [Self <: GroupsApp](x: Self) {
      ...
      inline def setGetGroups(value: CallbackTo[js.Array[Group]]): Self = StObject.set(x, "getGroups", value.toJsFn)
