...
object Analyticsreporting {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newCohort = newCohort.toJsFn, newCohortGroup = newCohortGroup.toJsFn, newDateRange = newDateRange.toJsFn, newDimension = newDimension.toJsFn, newDimensionFilter = newDimensionFilter.toJsFn, newDimensionFilterClause = newDimensionFilterClause.toJsFn, newDynamicSegment = newDynamicSegment.toJsFn, newGetReportsRequest = newGetReportsRequest.toJsFn, newMetric = newMetric.toJsFn, newMetricFilter = newMetricFilter.toJsFn, newMetricFilterClause = newMetricFilterClause.toJsFn, newOrFiltersForSegment = newOrFiltersForSegment.toJsFn, newOrderBy = newOrderBy.toJsFn, newPivot = newPivot.toJsFn, newReportRequest = newReportRequest.toJsFn, newSearchUserActivityRequest = newSearchUserActivityRequest.toJsFn, newSegment = newSegment.toJsFn, newSegmentDefinition = newSegmentDefinition.toJsFn, newSegmentDimensionFilter = newSegmentDimensionFilter.toJsFn, newSegmentFilter = newSegmentFilter.toJsFn, newSegmentFilterClause = newSegmentFilterClause.toJsFn, newSegmentMetricFilter = newSegmentMetricFilter.toJsFn, newSegmentSequenceStep = newSegmentSequenceStep.toJsFn, newSequenceSegment = newSequenceSegment.toJsFn, newSimpleSegment = newSimpleSegment.toJsFn, newUser = newUser.toJsFn)
    __obj.asInstanceOf[Analyticsreporting]
  }
  
  extension [Self <: Analyticsreporting](x: Self) {
    
    inline def setNewCohort(value: CallbackTo[Cohort]): Self = StObject.set(x, "newCohort", value.toJsFn)
    
    inline def setNewCohortGroup(value: CallbackTo[CohortGroup]): Self = StObject.set(x, "newCohortGroup", value.toJsFn)
    ...
    inline def setNewDimensionFilterClause(value: CallbackTo[DimensionFilterClause]): Self = StObject.set(x, "newDimensionFilterClause", value.toJsFn)
    
    inline def setNewDynamicSegment(value: CallbackTo[DynamicSegment]): Self = StObject.set(x, "newDynamicSegment", value.toJsFn)
    
    inline def setNewGetReportsRequest(value: CallbackTo[GetReportsRequest]): Self = StObject.set(x, "newGetReportsRequest", value.toJsFn)
    
    inline def setNewMetric(value: CallbackTo[Metric]): Self = StObject.set(x, "newMetric", value.toJsFn)
    
    inline def setNewMetricFilter(value: CallbackTo[MetricFilter]): Self = StObject.set(x, "newMetricFilter", value.toJsFn)
    
    inline def setNewMetricFilterClause(value: CallbackTo[MetricFilterClause]): Self = StObject.set(x, "newMetricFilterClause", value.toJsFn)
    
    inline def setNewOrFiltersForSegment(value: CallbackTo[OrFiltersForSegment]): Self = StObject.set(x, "newOrFiltersForSegment", value.toJsFn)
    
    inline def setNewOrderBy(value: CallbackTo[OrderBy]): Self = StObject.set(x, "newOrderBy", value.toJsFn)
    
    inline def setNewPivot(value: CallbackTo[Pivot]): Self = StObject.set(x, "newPivot", value.toJsFn)
    
    inline def setNewReportRequest(value: CallbackTo[ReportRequest]): Self = StObject.set(x, "newReportRequest", value.toJsFn)
    
    inline def setNewSearchUserActivityRequest(value: CallbackTo[SearchUserActivityRequest]): Self = StObject.set(x, "newSearchUserActivityRequest", value.toJsFn)
    
    inline def setNewSegment(value: CallbackTo[Segment]): Self = StObject.set(x, "newSegment", value.toJsFn)
    
    inline def setNewSegmentDefinition(value: CallbackTo[SegmentDefinition]): Self = StObject.set(x, "newSegmentDefinition", value.toJsFn)
    
    inline def setNewSegmentDimensionFilter(value: CallbackTo[SegmentDimensionFilter]): Self = StObject.set(x, "newSegmentDimensionFilter", value.toJsFn)
    
    inline def setNewSegmentFilter(value: CallbackTo[SegmentFilter]): Self = StObject.set(x, "newSegmentFilter", value.toJsFn)
    
    inline def setNewSegmentFilterClause(value: CallbackTo[SegmentFilterClause]): Self = StObject.set(x, "newSegmentFilterClause", value.toJsFn)
    
    inline def setNewSegmentMetricFilter(value: CallbackTo[SegmentMetricFilter]): Self = StObject.set(x, "newSegmentMetricFilter", value.toJsFn)
    
    inline def setNewSegmentSequenceStep(value: CallbackTo[SegmentSequenceStep]): Self = StObject.set(x, "newSegmentSequenceStep", value.toJsFn)
    
    inline def setNewSequenceSegment(value: CallbackTo[SequenceSegment]): Self = StObject.set(x, "newSequenceSegment", value.toJsFn)
    
    inline def setNewSimpleSegment(value: CallbackTo[SimpleSegment]): Self = StObject.set(x, "newSimpleSegment", value.toJsFn)
