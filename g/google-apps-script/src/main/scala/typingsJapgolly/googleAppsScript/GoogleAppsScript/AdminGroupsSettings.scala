...
object AdminGroupsSettings {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newGroups = newGroups.toJsFn)
  ...
  extension [Self <: AdminGroupsSettings](x: Self) {
    ...
    inline def setNewGroups(
      value: CallbackTo[
          typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups
        ]
    ): Self = StObject.set(x, "newGroups", value.toJsFn)
  }
  ...
  object Collection {
    ...
    trait GroupsCollection extends StObject {
      ...
      def get(groupUniqueId: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups
      
      // Updates an existing resource. This method supports patch semantics.
      def patch(
        resource: typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups,
    ...
    object GroupsCollection {
      ...
      inline def apply(
        get: String => typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups,
        patch: (typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups, String) => typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups,
        update: (typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups, String) => typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups
      ): GroupsCollection = {
      ...
      extension [Self <: GroupsCollection](x: Self) {
        ...
        inline def setGet(
          value: String => typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups
        ): Self = StObject.set(x, "get", js.Any.fromFunction1(value))
        
        inline def setPatch(
          value: (typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups, String) => typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups
  ...
  object Schema {
    ...
    object Groups {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminGroupsSettings.Schema.Groups](x: Self) {
