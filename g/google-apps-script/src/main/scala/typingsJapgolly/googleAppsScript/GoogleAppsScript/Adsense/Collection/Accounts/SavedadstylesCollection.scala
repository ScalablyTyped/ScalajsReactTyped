...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Schema.SavedAdStyle
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Schema.SavedAdStyles
