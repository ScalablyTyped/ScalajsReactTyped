...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.DatasetList
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.GetQueryResultsResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.GetServiceAccountResponse
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.JobCancelResponse
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.JobList
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.ProjectList
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.QueryResponse
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.TableDataInsertAllResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.TableDataList
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.BigQuery.Schema.TableList
...
object BigQuery {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newBigQueryModelTraining = newBigQueryModelTraining.toJsFn, newBigtableColumn = newBigtableColumn.toJsFn, newBigtableColumnFamily = newBigtableColumnFamily.toJsFn, newBigtableOptions = newBigtableOptions.toJsFn, newBqmlIterationResult = newBqmlIterationResult.toJsFn, newBqmlTrainingRun = newBqmlTrainingRun.toJsFn, newBqmlTrainingRunTrainingOptions = newBqmlTrainingRunTrainingOptions.toJsFn, newClustering = newClustering.toJsFn, newCsvOptions = newCsvOptions.toJsFn, newDataset = newDataset.toJsFn, newDatasetAccess = newDatasetAccess.toJsFn, newDatasetReference = newDatasetReference.toJsFn, newDestinationTableProperties = newDestinationTableProperties.toJsFn, newEncryptionConfiguration = newEncryptionConfiguration.toJsFn, newErrorProto = newErrorProto.toJsFn, newExplainQueryStage = newExplainQueryStage.toJsFn, newExplainQueryStep = newExplainQueryStep.toJsFn, newExternalDataConfiguration = newExternalDataConfiguration.toJsFn, newGoogleSheetsOptions = newGoogleSheetsOptions.toJsFn, newJob = newJob.toJsFn, newJobConfiguration = newJobConfiguration.toJsFn, newJobConfigurationExtract = newJobConfigurationExtract.toJsFn, newJobConfigurationLoad = newJobConfigurationLoad.toJsFn, newJobConfigurationQuery = newJobConfigurationQuery.toJsFn, newJobConfigurationTableCopy = newJobConfigurationTableCopy.toJsFn, newJobReference = newJobReference.toJsFn, newJobStatistics = newJobStatistics.toJsFn, newJobStatistics2 = newJobStatistics2.toJsFn, newJobStatistics2ReservationUsage = newJobStatistics2ReservationUsage.toJsFn, newJobStatistics3 = newJobStatistics3.toJsFn, newJobStatistics4 = newJobStatistics4.toJsFn, newJobStatisticsReservationUsage = newJobStatisticsReservationUsage.toJsFn, newJobStatus = newJobStatus.toJsFn, newMaterializedViewDefinition = newMaterializedViewDefinition.toJsFn, newModelDefinition = newModelDefinition.toJsFn, newModelDefinitionModelOptions = newModelDefinitionModelOptions.toJsFn, newQueryParameter = newQueryParameter.toJsFn, newQueryParameterType = newQueryParameterType.toJsFn, newQueryParameterTypeStructTypes = newQueryParameterTypeStructTypes.toJsFn, newQueryParameterValue = newQueryParameterValue.toJsFn, newQueryRequest = newQueryRequest.toJsFn, newQueryTimelineSample = newQueryTimelineSample.toJsFn, newRangePartitioning = newRangePartitioning.toJsFn, newRangePartitioningRange = newRangePartitioningRange.toJsFn, newRoutineReference = newRoutineReference.toJsFn, newStreamingbuffer = newStreamingbuffer.toJsFn, newTable = newTable.toJsFn, newTableDataInsertAllRequest = newTableDataInsertAllRequest.toJsFn, newTableDataInsertAllRequestRows = newTableDataInsertAllRequestRows.toJsFn, newTableFieldSchema = newTableFieldSchema.toJsFn, newTableFieldSchemaCategories = newTableFieldSchemaCategories.toJsFn, newTableReference = newTableReference.toJsFn, newTableSchema = newTableSchema.toJsFn, newTimePartitioning = newTimePartitioning.toJsFn, newUserDefinedFunctionResource = newUserDefinedFunctionResource.toJsFn, newViewDefinition = newViewDefinition.toJsFn)
  ...
  extension [Self <: BigQuery](x: Self) {
    ...
    inline def setNewBigQueryModelTraining(value: CallbackTo[BigQueryModelTraining]): Self = StObject.set(x, "newBigQueryModelTraining", value.toJsFn)
    
    inline def setNewBigtableColumn(value: CallbackTo[BigtableColumn]): Self = StObject.set(x, "newBigtableColumn", value.toJsFn)
    
    inline def setNewBigtableColumnFamily(value: CallbackTo[BigtableColumnFamily]): Self = StObject.set(x, "newBigtableColumnFamily", value.toJsFn)
    
    inline def setNewBigtableOptions(value: CallbackTo[BigtableOptions]): Self = StObject.set(x, "newBigtableOptions", value.toJsFn)
    
    inline def setNewBqmlIterationResult(value: CallbackTo[BqmlIterationResult]): Self = StObject.set(x, "newBqmlIterationResult", value.toJsFn)
    
    inline def setNewBqmlTrainingRun(value: CallbackTo[BqmlTrainingRun]): Self = StObject.set(x, "newBqmlTrainingRun", value.toJsFn)
    
    inline def setNewBqmlTrainingRunTrainingOptions(value: CallbackTo[BqmlTrainingRunTrainingOptions]): Self = StObject.set(x, "newBqmlTrainingRunTrainingOptions", value.toJsFn)
    
    inline def setNewClustering(value: CallbackTo[Clustering]): Self = StObject.set(x, "newClustering", value.toJsFn)
    
    inline def setNewCsvOptions(value: CallbackTo[CsvOptions]): Self = StObject.set(x, "newCsvOptions", value.toJsFn)
    
    inline def setNewDataset(value: CallbackTo[Dataset]): Self = StObject.set(x, "newDataset", value.toJsFn)
    
    inline def setNewDatasetAccess(value: CallbackTo[DatasetAccess]): Self = StObject.set(x, "newDatasetAccess", value.toJsFn)
    
    inline def setNewDatasetReference(value: CallbackTo[DatasetReference]): Self = StObject.set(x, "newDatasetReference", value.toJsFn)
    
    inline def setNewDestinationTableProperties(value: CallbackTo[DestinationTableProperties]): Self = StObject.set(x, "newDestinationTableProperties", value.toJsFn)
    
    inline def setNewEncryptionConfiguration(value: CallbackTo[EncryptionConfiguration]): Self = StObject.set(x, "newEncryptionConfiguration", value.toJsFn)
    
    inline def setNewErrorProto(value: CallbackTo[ErrorProto]): Self = StObject.set(x, "newErrorProto", value.toJsFn)
    
    inline def setNewExplainQueryStage(value: CallbackTo[ExplainQueryStage]): Self = StObject.set(x, "newExplainQueryStage", value.toJsFn)
    
    inline def setNewExplainQueryStep(value: CallbackTo[ExplainQueryStep]): Self = StObject.set(x, "newExplainQueryStep", value.toJsFn)
    
    inline def setNewExternalDataConfiguration(value: CallbackTo[ExternalDataConfiguration]): Self = StObject.set(x, "newExternalDataConfiguration", value.toJsFn)
    
    inline def setNewGoogleSheetsOptions(value: CallbackTo[GoogleSheetsOptions]): Self = StObject.set(x, "newGoogleSheetsOptions", value.toJsFn)
    
    inline def setNewJob(value: CallbackTo[Job]): Self = StObject.set(x, "newJob", value.toJsFn)
    
    inline def setNewJobConfiguration(value: CallbackTo[JobConfiguration]): Self = StObject.set(x, "newJobConfiguration", value.toJsFn)
    
    inline def setNewJobConfigurationExtract(value: CallbackTo[JobConfigurationExtract]): Self = StObject.set(x, "newJobConfigurationExtract", value.toJsFn)
    
    inline def setNewJobConfigurationLoad(value: CallbackTo[JobConfigurationLoad]): Self = StObject.set(x, "newJobConfigurationLoad", value.toJsFn)
    
    inline def setNewJobConfigurationQuery(value: CallbackTo[JobConfigurationQuery]): Self = StObject.set(x, "newJobConfigurationQuery", value.toJsFn)
    
    inline def setNewJobConfigurationTableCopy(value: CallbackTo[JobConfigurationTableCopy]): Self = StObject.set(x, "newJobConfigurationTableCopy", value.toJsFn)
    
    inline def setNewJobReference(value: CallbackTo[JobReference]): Self = StObject.set(x, "newJobReference", value.toJsFn)
    
    inline def setNewJobStatistics(value: CallbackTo[JobStatistics]): Self = StObject.set(x, "newJobStatistics", value.toJsFn)
    
    inline def setNewJobStatistics2(value: CallbackTo[JobStatistics2]): Self = StObject.set(x, "newJobStatistics2", value.toJsFn)
    
    inline def setNewJobStatistics2ReservationUsage(value: CallbackTo[JobStatistics2ReservationUsage]): Self = StObject.set(x, "newJobStatistics2ReservationUsage", value.toJsFn)
    
    inline def setNewJobStatistics3(value: CallbackTo[JobStatistics3]): Self = StObject.set(x, "newJobStatistics3", value.toJsFn)
    
    inline def setNewJobStatistics4(value: CallbackTo[JobStatistics4]): Self = StObject.set(x, "newJobStatistics4", value.toJsFn)
    
    inline def setNewJobStatisticsReservationUsage(value: CallbackTo[JobStatisticsReservationUsage]): Self = StObject.set(x, "newJobStatisticsReservationUsage", value.toJsFn)
    
    inline def setNewJobStatus(value: CallbackTo[JobStatus]): Self = StObject.set(x, "newJobStatus", value.toJsFn)
    
    inline def setNewMaterializedViewDefinition(value: CallbackTo[MaterializedViewDefinition]): Self = StObject.set(x, "newMaterializedViewDefinition", value.toJsFn)
    
    inline def setNewModelDefinition(value: CallbackTo[ModelDefinition]): Self = StObject.set(x, "newModelDefinition", value.toJsFn)
    
    inline def setNewModelDefinitionModelOptions(value: CallbackTo[ModelDefinitionModelOptions]): Self = StObject.set(x, "newModelDefinitionModelOptions", value.toJsFn)
    
    inline def setNewQueryParameter(value: CallbackTo[QueryParameter]): Self = StObject.set(x, "newQueryParameter", value.toJsFn)
    
    inline def setNewQueryParameterType(value: CallbackTo[QueryParameterType]): Self = StObject.set(x, "newQueryParameterType", value.toJsFn)
    
    inline def setNewQueryParameterTypeStructTypes(value: CallbackTo[QueryParameterTypeStructTypes]): Self = StObject.set(x, "newQueryParameterTypeStructTypes", value.toJsFn)
    
    inline def setNewQueryParameterValue(value: CallbackTo[QueryParameterValue]): Self = StObject.set(x, "newQueryParameterValue", value.toJsFn)
    
    inline def setNewQueryRequest(value: CallbackTo[QueryRequest]): Self = StObject.set(x, "newQueryRequest", value.toJsFn)
    
    inline def setNewQueryTimelineSample(value: CallbackTo[QueryTimelineSample]): Self = StObject.set(x, "newQueryTimelineSample", value.toJsFn)
    
    inline def setNewRangePartitioning(value: CallbackTo[RangePartitioning]): Self = StObject.set(x, "newRangePartitioning", value.toJsFn)
    
    inline def setNewRangePartitioningRange(value: CallbackTo[RangePartitioningRange]): Self = StObject.set(x, "newRangePartitioningRange", value.toJsFn)
    
    inline def setNewRoutineReference(value: CallbackTo[RoutineReference]): Self = StObject.set(x, "newRoutineReference", value.toJsFn)
    
    inline def setNewStreamingbuffer(value: CallbackTo[Streamingbuffer]): Self = StObject.set(x, "newStreamingbuffer", value.toJsFn)
    
    inline def setNewTable(value: CallbackTo[Table]): Self = StObject.set(x, "newTable", value.toJsFn)
    
    inline def setNewTableDataInsertAllRequest(value: CallbackTo[TableDataInsertAllRequest]): Self = StObject.set(x, "newTableDataInsertAllRequest", value.toJsFn)
    
    inline def setNewTableDataInsertAllRequestRows(value: CallbackTo[TableDataInsertAllRequestRows]): Self = StObject.set(x, "newTableDataInsertAllRequestRows", value.toJsFn)
    
    inline def setNewTableFieldSchema(value: CallbackTo[TableFieldSchema]): Self = StObject.set(x, "newTableFieldSchema", value.toJsFn)
    
    inline def setNewTableFieldSchemaCategories(value: CallbackTo[TableFieldSchemaCategories]): Self = StObject.set(x, "newTableFieldSchemaCategories", value.toJsFn)
    
    inline def setNewTableReference(value: CallbackTo[TableReference]): Self = StObject.set(x, "newTableReference", value.toJsFn)
    
    inline def setNewTableSchema(value: CallbackTo[TableSchema]): Self = StObject.set(x, "newTableSchema", value.toJsFn)
    
    inline def setNewTimePartitioning(value: CallbackTo[TimePartitioning]): Self = StObject.set(x, "newTimePartitioning", value.toJsFn)
    
    inline def setNewUserDefinedFunctionResource(value: CallbackTo[UserDefinedFunctionResource]): Self = StObject.set(x, "newUserDefinedFunctionResource", value.toJsFn)
    
    inline def setNewViewDefinition(value: CallbackTo[ViewDefinition]): Self = StObject.set(x, "newViewDefinition", value.toJsFn)
