...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminLicenseManager.Schema.LicenseAssignmentList
...
object AdminLicenseManager {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newLicenseAssignment = newLicenseAssignment.toJsFn, newLicenseAssignmentInsert = newLicenseAssignmentInsert.toJsFn)
  ...
  extension [Self <: AdminLicenseManager](x: Self) {
    ...
    inline def setNewLicenseAssignment(value: CallbackTo[LicenseAssignment]): Self = StObject.set(x, "newLicenseAssignment", value.toJsFn)
    
    inline def setNewLicenseAssignmentInsert(value: CallbackTo[LicenseAssignmentInsert]): Self = StObject.set(x, "newLicenseAssignmentInsert", value.toJsFn)
  }
