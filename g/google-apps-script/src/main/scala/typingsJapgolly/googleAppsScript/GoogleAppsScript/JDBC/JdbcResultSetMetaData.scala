...
object JdbcResultSetMetaData {
  ...
  extension [Self <: JdbcResultSetMetaData](x: Self) {
    ...
    inline def setGetColumnCount(value: CallbackTo[Integer]): Self = StObject.set(x, "getColumnCount", value.toJsFn)
