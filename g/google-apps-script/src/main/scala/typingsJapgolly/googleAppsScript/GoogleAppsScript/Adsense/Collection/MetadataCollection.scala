...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Collection.Metadata.DimensionsCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Adsense.Collection.Metadata.MetricsCollection
