package typingsJapgolly.googleAppsScript.GoogleAppsScript.Sheets.Collection
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Sheets.Schema.Spreadsheet
