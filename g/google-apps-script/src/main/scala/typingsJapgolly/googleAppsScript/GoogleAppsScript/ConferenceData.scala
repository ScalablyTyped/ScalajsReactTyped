...
object ConferenceData {
  ...
  object ConferenceData {
    ...
    inline def apply(printJson: CallbackTo[String]): typingsJapgolly.googleAppsScript.GoogleAppsScript.ConferenceData.ConferenceData = {
      val __obj = js.Dynamic.literal(printJson = printJson.toJsFn)
      __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.ConferenceData.ConferenceData]
    }
    
    extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.ConferenceData.ConferenceData](x: Self) {
  ...
  trait ConferenceDataBuilder extends StObject {
    ...
    /**
      ...
      */
    def build(): typingsJapgolly.googleAppsScript.GoogleAppsScript.ConferenceData.ConferenceData
  ...
  object ConferenceDataBuilder {
    ...
    inline def apply(
      ...
      build: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.ConferenceData.ConferenceData],
    ...
    extension [Self <: ConferenceDataBuilder](x: Self) {
      ...
      inline def setBuild(value: CallbackTo[typingsJapgolly.googleAppsScript.GoogleAppsScript.ConferenceData.ConferenceData]): Self = StObject.set(x, "build", value.toJsFn)
  ...
  object ConferenceDataService {
    ...
    inline def apply(
      ...
      newConferenceDataBuilder: CallbackTo[ConferenceDataBuilder],
      newConferenceError: CallbackTo[ConferenceError],
      newConferenceParameter: CallbackTo[ConferenceParameter],
      newEntryPoint: CallbackTo[EntryPoint]
    ): ConferenceDataService = {
      val __obj = js.Dynamic.literal(ConferenceErrorType = ConferenceErrorType.asInstanceOf[js.Any], EntryPointFeature = EntryPointFeature.asInstanceOf[js.Any], EntryPointType = EntryPointType.asInstanceOf[js.Any], newConferenceDataBuilder = newConferenceDataBuilder.toJsFn, newConferenceError = newConferenceError.toJsFn, newConferenceParameter = newConferenceParameter.toJsFn, newEntryPoint = newEntryPoint.toJsFn)
    ...
    extension [Self <: ConferenceDataService](x: Self) {
      ...
      inline def setNewConferenceDataBuilder(value: CallbackTo[ConferenceDataBuilder]): Self = StObject.set(x, "newConferenceDataBuilder", value.toJsFn)
      
      inline def setNewConferenceError(value: CallbackTo[ConferenceError]): Self = StObject.set(x, "newConferenceError", value.toJsFn)
      
      inline def setNewConferenceParameter(value: CallbackTo[ConferenceParameter]): Self = StObject.set(x, "newConferenceParameter", value.toJsFn)
      
      inline def setNewEntryPoint(value: CallbackTo[EntryPoint]): Self = StObject.set(x, "newEntryPoint", value.toJsFn)
    }
  }
