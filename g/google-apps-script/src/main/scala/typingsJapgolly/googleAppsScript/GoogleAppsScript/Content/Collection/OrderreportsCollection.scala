...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Content.Schema.OrderreportsListDisbursementsResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Content.Schema.OrderreportsListTransactionsResponse
