...
object LinearOptimizationService {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(Status = Status.asInstanceOf[js.Any], VariableType = VariableType.asInstanceOf[js.Any])
    __obj.updateDynamic("createEngine")(createEngine.toJsFn)
