...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Appsactivity.Collection.ActivitiesCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Appsactivity.Schema.ListActivitiesResponse
