...
object JdbcParameterMetaData {
  ...
  extension [Self <: JdbcParameterMetaData](x: Self) {
    ...
    inline def setGetParameterCount(value: CallbackTo[Integer]): Self = StObject.set(x, "getParameterCount", value.toJsFn)
