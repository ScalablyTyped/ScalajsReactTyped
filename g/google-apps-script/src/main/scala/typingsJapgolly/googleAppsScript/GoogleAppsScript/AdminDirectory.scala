...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Collection.Resources.BuildingsCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Collection.Resources.CalendarsCollection
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Collection.Resources.FeaturesCollection
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Collection.Users.PhotosCollection
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Buildings
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.CalendarResource
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.CalendarResources
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.ChromeOsDevices
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.DomainAliases
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Features
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Members
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.MembersHasMember
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.MobileDevice
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.MobileDeviceAction
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.MobileDevices
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Notification
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Notifications
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.OrgUnit
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.OrgUnits
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Roles
...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Users
...
object AdminDirectory {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newAlias = newAlias.toJsFn, newBuilding = newBuilding.toJsFn, newBuildingAddress = newBuildingAddress.toJsFn, newBuildingCoordinates = newBuildingCoordinates.toJsFn, newCalendarResource = newCalendarResource.toJsFn, newChannel = newChannel.toJsFn, newChromeOsDevice = newChromeOsDevice.toJsFn, newChromeOsDeviceAction = newChromeOsDeviceAction.toJsFn, newChromeOsDeviceActiveTimeRanges = newChromeOsDeviceActiveTimeRanges.toJsFn, newChromeOsDeviceCpuStatusReports = newChromeOsDeviceCpuStatusReports.toJsFn, newChromeOsDeviceCpuStatusReportsCpuTemperatureInfo = newChromeOsDeviceCpuStatusReportsCpuTemperatureInfo.toJsFn, newChromeOsDeviceDeviceFiles = newChromeOsDeviceDeviceFiles.toJsFn, newChromeOsDeviceDiskVolumeReports = newChromeOsDeviceDiskVolumeReports.toJsFn, newChromeOsDeviceDiskVolumeReportsVolumeInfo = newChromeOsDeviceDiskVolumeReportsVolumeInfo.toJsFn, newChromeOsDeviceRecentUsers = newChromeOsDeviceRecentUsers.toJsFn, newChromeOsDeviceSystemRamFreeReports = newChromeOsDeviceSystemRamFreeReports.toJsFn, newChromeOsDeviceTpmVersionInfo = newChromeOsDeviceTpmVersionInfo.toJsFn, newChromeOsMoveDevicesToOu = newChromeOsMoveDevicesToOu.toJsFn, newCustomer = newCustomer.toJsFn, newCustomerPostalAddress = newCustomerPostalAddress.toJsFn, newDomainAlias = newDomainAlias.toJsFn, newDomains = newDomains.toJsFn, newFeature = newFeature.toJsFn, newFeatureRename = newFeatureRename.toJsFn, newGroup = newGroup.toJsFn, newMember = newMember.toJsFn, newMobileDeviceAction = newMobileDeviceAction.toJsFn, newNotification = newNotification.toJsFn, newOrgUnit = newOrgUnit.toJsFn, newRole = newRole.toJsFn, newRoleAssignment = newRoleAssignment.toJsFn, newRoleRolePrivileges = newRoleRolePrivileges.toJsFn, newSchema = newSchema.toJsFn, newSchemaFieldSpec = newSchemaFieldSpec.toJsFn, newSchemaFieldSpecNumericIndexingSpec = newSchemaFieldSpecNumericIndexingSpec.toJsFn, newUser = newUser.toJsFn, newUserMakeAdmin = newUserMakeAdmin.toJsFn, newUserName = newUserName.toJsFn, newUserPhoto = newUserPhoto.toJsFn, newUserUndelete = newUserUndelete.toJsFn)
  ...
  extension [Self <: AdminDirectory](x: Self) {
    ...
    inline def setNewAlias(value: CallbackTo[Alias]): Self = StObject.set(x, "newAlias", value.toJsFn)
    
    inline def setNewBuilding(value: CallbackTo[Building]): Self = StObject.set(x, "newBuilding", value.toJsFn)
    
    inline def setNewBuildingAddress(value: CallbackTo[BuildingAddress]): Self = StObject.set(x, "newBuildingAddress", value.toJsFn)
    
    inline def setNewBuildingCoordinates(value: CallbackTo[BuildingCoordinates]): Self = StObject.set(x, "newBuildingCoordinates", value.toJsFn)
    
    inline def setNewCalendarResource(value: CallbackTo[CalendarResource]): Self = StObject.set(x, "newCalendarResource", value.toJsFn)
    
    inline def setNewChannel(value: CallbackTo[Channel]): Self = StObject.set(x, "newChannel", value.toJsFn)
    
    inline def setNewChromeOsDevice(value: CallbackTo[ChromeOsDevice]): Self = StObject.set(x, "newChromeOsDevice", value.toJsFn)
    
    inline def setNewChromeOsDeviceAction(value: CallbackTo[ChromeOsDeviceAction]): Self = StObject.set(x, "newChromeOsDeviceAction", value.toJsFn)
    
    inline def setNewChromeOsDeviceActiveTimeRanges(value: CallbackTo[ChromeOsDeviceActiveTimeRanges]): Self = StObject.set(x, "newChromeOsDeviceActiveTimeRanges", value.toJsFn)
    
    inline def setNewChromeOsDeviceCpuStatusReports(value: CallbackTo[ChromeOsDeviceCpuStatusReports]): Self = StObject.set(x, "newChromeOsDeviceCpuStatusReports", value.toJsFn)
    
    inline def setNewChromeOsDeviceCpuStatusReportsCpuTemperatureInfo(value: CallbackTo[ChromeOsDeviceCpuStatusReportsCpuTemperatureInfo]): Self = StObject.set(x, "newChromeOsDeviceCpuStatusReportsCpuTemperatureInfo", value.toJsFn)
    
    inline def setNewChromeOsDeviceDeviceFiles(value: CallbackTo[ChromeOsDeviceDeviceFiles]): Self = StObject.set(x, "newChromeOsDeviceDeviceFiles", value.toJsFn)
    
    inline def setNewChromeOsDeviceDiskVolumeReports(value: CallbackTo[ChromeOsDeviceDiskVolumeReports]): Self = StObject.set(x, "newChromeOsDeviceDiskVolumeReports", value.toJsFn)
    
    inline def setNewChromeOsDeviceDiskVolumeReportsVolumeInfo(value: CallbackTo[ChromeOsDeviceDiskVolumeReportsVolumeInfo]): Self = StObject.set(x, "newChromeOsDeviceDiskVolumeReportsVolumeInfo", value.toJsFn)
    
    inline def setNewChromeOsDeviceRecentUsers(value: CallbackTo[ChromeOsDeviceRecentUsers]): Self = StObject.set(x, "newChromeOsDeviceRecentUsers", value.toJsFn)
    
    inline def setNewChromeOsDeviceSystemRamFreeReports(value: CallbackTo[ChromeOsDeviceSystemRamFreeReports]): Self = StObject.set(x, "newChromeOsDeviceSystemRamFreeReports", value.toJsFn)
    
    inline def setNewChromeOsDeviceTpmVersionInfo(value: CallbackTo[ChromeOsDeviceTpmVersionInfo]): Self = StObject.set(x, "newChromeOsDeviceTpmVersionInfo", value.toJsFn)
    
    inline def setNewChromeOsMoveDevicesToOu(value: CallbackTo[ChromeOsMoveDevicesToOu]): Self = StObject.set(x, "newChromeOsMoveDevicesToOu", value.toJsFn)
    
    inline def setNewCustomer(value: CallbackTo[Customer]): Self = StObject.set(x, "newCustomer", value.toJsFn)
    
    inline def setNewCustomerPostalAddress(value: CallbackTo[CustomerPostalAddress]): Self = StObject.set(x, "newCustomerPostalAddress", value.toJsFn)
    
    inline def setNewDomainAlias(value: CallbackTo[DomainAlias]): Self = StObject.set(x, "newDomainAlias", value.toJsFn)
    
    inline def setNewDomains(value: CallbackTo[Domains]): Self = StObject.set(x, "newDomains", value.toJsFn)
    
    inline def setNewFeature(value: CallbackTo[Feature]): Self = StObject.set(x, "newFeature", value.toJsFn)
    
    inline def setNewFeatureRename(value: CallbackTo[FeatureRename]): Self = StObject.set(x, "newFeatureRename", value.toJsFn)
    
    inline def setNewGroup(value: CallbackTo[Group]): Self = StObject.set(x, "newGroup", value.toJsFn)
    
    inline def setNewMember(value: CallbackTo[Member]): Self = StObject.set(x, "newMember", value.toJsFn)
    
    inline def setNewMobileDeviceAction(value: CallbackTo[MobileDeviceAction]): Self = StObject.set(x, "newMobileDeviceAction", value.toJsFn)
    
    inline def setNewNotification(value: CallbackTo[Notification]): Self = StObject.set(x, "newNotification", value.toJsFn)
    
    inline def setNewOrgUnit(value: CallbackTo[OrgUnit]): Self = StObject.set(x, "newOrgUnit", value.toJsFn)
    
    inline def setNewRole(value: CallbackTo[Role]): Self = StObject.set(x, "newRole", value.toJsFn)
    
    inline def setNewRoleAssignment(value: CallbackTo[RoleAssignment]): Self = StObject.set(x, "newRoleAssignment", value.toJsFn)
    
    inline def setNewRoleRolePrivileges(value: CallbackTo[RoleRolePrivileges]): Self = StObject.set(x, "newRoleRolePrivileges", value.toJsFn)
    
    inline def setNewSchema(value: CallbackTo[Schema]): Self = StObject.set(x, "newSchema", value.toJsFn)
    
    inline def setNewSchemaFieldSpec(value: CallbackTo[SchemaFieldSpec]): Self = StObject.set(x, "newSchemaFieldSpec", value.toJsFn)
    
    inline def setNewSchemaFieldSpecNumericIndexingSpec(value: CallbackTo[SchemaFieldSpecNumericIndexingSpec]): Self = StObject.set(x, "newSchemaFieldSpecNumericIndexingSpec", value.toJsFn)
    
    inline def setNewUser(value: CallbackTo[User]): Self = StObject.set(x, "newUser", value.toJsFn)
    
    inline def setNewUserMakeAdmin(value: CallbackTo[UserMakeAdmin]): Self = StObject.set(x, "newUserMakeAdmin", value.toJsFn)
    
    inline def setNewUserName(value: CallbackTo[UserName]): Self = StObject.set(x, "newUserName", value.toJsFn)
    
    inline def setNewUserPhoto(value: CallbackTo[UserPhoto]): Self = StObject.set(x, "newUserPhoto", value.toJsFn)
    
    inline def setNewUserUndelete(value: CallbackTo[UserUndelete]): Self = StObject.set(x, "newUserUndelete", value.toJsFn)
  ...
  object Collection {
    ...
    object AspsCollection {
      ...
      inline def apply(get: (String, Double) => Asp, list: String => Asps, remove: (String, Double) => Callback): AspsCollection = {
        val __obj = js.Dynamic.literal(get = js.Any.fromFunction2(get), list = js.Any.fromFunction1(list), remove = js.Any.fromFunction2((t0: String, t1: Double) => (remove(t0, t1)).runNow()))
      ...
      extension [Self <: AspsCollection](x: Self) {
        ...
        inline def setList(value: String => Asps): Self = StObject.set(x, "list", js.Any.fromFunction1(value))
    ...
    object ChannelsCollection {
      ...
      inline def apply(stop: Channel => Callback): ChannelsCollection = {
        val __obj = js.Dynamic.literal(stop = js.Any.fromFunction1((t0: Channel) => stop(t0).runNow()))
        __obj.asInstanceOf[ChannelsCollection]
      }
      
      extension [Self <: ChannelsCollection](x: Self) {
        
        inline def setStop(value: Channel => Callback): Self = StObject.set(x, "stop", js.Any.fromFunction1((t0: Channel) => value(t0).runNow()))
      }
    }
    
    @js.native
    trait ChromeosdevicesCollection extends StObject {
    ...
    object CustomersCollection {
      ...
      extension [Self <: CustomersCollection](x: Self) {
        ...
        inline def setPatch(value: (Customer, String) => Customer): Self = StObject.set(x, "patch", js.Any.fromFunction2(value))
        
        inline def setUpdate(value: (Customer, String) => Customer): Self = StObject.set(x, "update", js.Any.fromFunction2(value))
      }
    }
    
    @js.native
    trait DomainAliasesCollection extends StObject {
    ...
    object DomainsCollection {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(get = js.Any.fromFunction2(get), insert = js.Any.fromFunction2(insert), list = js.Any.fromFunction1(list), remove = js.Any.fromFunction2((t0: String, t1: String) => (remove(t0, t1)).runNow()))
      ...
      extension [Self <: DomainsCollection](x: Self) {
        ...
        inline def setInsert(value: (Domains, String) => Domains): Self = StObject.set(x, "insert", js.Any.fromFunction2(value))
        
        inline def setList(value: String => Domains2): Self = StObject.set(x, "list", js.Any.fromFunction1(value))
    ...
    object Groups {
      ...
      object AliasesCollection {
        ...
        inline def apply(insert: (Alias, String) => Alias, list: String => Aliases, remove: (String, String) => Callback): AliasesCollection = {
          val __obj = js.Dynamic.literal(insert = js.Any.fromFunction2(insert), list = js.Any.fromFunction1(list), remove = js.Any.fromFunction2((t0: String, t1: String) => (remove(t0, t1)).runNow()))
        ...
        extension [Self <: AliasesCollection](x: Self) {
          ...
          inline def setList(value: String => Aliases): Self = StObject.set(x, "list", js.Any.fromFunction1(value))
    ...
    @js.native
    trait MobiledevicesCollection extends StObject {
    ...
    @js.native
    trait NotificationsCollection extends StObject {
    ...
    @js.native
    trait OrgunitsCollection extends StObject {
    ...
    object PrivilegesCollection {
      ...
      inline def apply(list: String => Privileges): PrivilegesCollection = {
    ...
    object ResolvedAppAccessSettingsCollection {
      ...
      inline def apply(GetSettings: CallbackTo[AppAccessCollections], ListTrustedApps: CallbackTo[TrustedApps]): ResolvedAppAccessSettingsCollection = {
        val __obj = js.Dynamic.literal(GetSettings = GetSettings.toJsFn, ListTrustedApps = ListTrustedApps.toJsFn)
        __obj.asInstanceOf[ResolvedAppAccessSettingsCollection]
      }
      
      extension [Self <: ResolvedAppAccessSettingsCollection](x: Self) {
        
        inline def setGetSettings(value: CallbackTo[AppAccessCollections]): Self = StObject.set(x, "GetSettings", value.toJsFn)
        
        inline def setListTrustedApps(value: CallbackTo[TrustedApps]): Self = StObject.set(x, "ListTrustedApps", value.toJsFn)
      }
    }
    ...
    object Resources {
      ...
      @js.native
      trait BuildingsCollection extends StObject {
      ...
      @js.native
      trait FeaturesCollection extends StObject {
    ...
    object ResourcesCollection {
      ...
      inline def apply(): ResourcesCollection = {
      ...
      extension [Self <: ResourcesCollection](x: Self) {
        ...
        inline def setFeatures(value: FeaturesCollection): Self = StObject.set(x, "Features", value.asInstanceOf[js.Any])
    ...
    @js.native
    trait RoleAssignmentsCollection extends StObject {
    ...
    @js.native
    trait RolesCollection extends StObject {
    ...
    object SchemasCollection {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(get = js.Any.fromFunction2(get), insert = js.Any.fromFunction2(insert), list = js.Any.fromFunction1(list), patch = js.Any.fromFunction3(patch), remove = js.Any.fromFunction2((t0: String, t1: String) => (remove(t0, t1)).runNow()), update = js.Any.fromFunction3(update))
      ...
      extension [Self <: SchemasCollection](x: Self) {
        ...
        inline def setInsert(value: (Schema, String) => Schema): Self = StObject.set(x, "insert", js.Any.fromFunction2(value))
        
        inline def setList(value: String => Schemas): Self = StObject.set(x, "list", js.Any.fromFunction1(value))
        
        inline def setPatch(value: (Schema, String, String) => Schema): Self = StObject.set(x, "patch", js.Any.fromFunction3(value))
        
        inline def setRemove(value: (String, String) => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
        
        inline def setUpdate(value: (Schema, String, String) => Schema): Self = StObject.set(x, "update", js.Any.fromFunction3(value))
      }
    }
    ...
    object TokensCollection {
      ...
      inline def apply(get: (String, String) => Token, list: String => Tokens, remove: (String, String) => Callback): TokensCollection = {
        val __obj = js.Dynamic.literal(get = js.Any.fromFunction2(get), list = js.Any.fromFunction1(list), remove = js.Any.fromFunction2((t0: String, t1: String) => (remove(t0, t1)).runNow()))
      ...
      extension [Self <: TokensCollection](x: Self) {
        ...
        inline def setList(value: String => Tokens): Self = StObject.set(x, "list", js.Any.fromFunction1(value))
    ...
    object Users {
      ...
      object PhotosCollection {
        ...
        inline def apply(
          ...
          val __obj = js.Dynamic.literal(get = js.Any.fromFunction1(get), patch = js.Any.fromFunction2(patch), remove = js.Any.fromFunction1((t0: String) => remove(t0).runNow()), update = js.Any.fromFunction2(update))
        ...
        extension [Self <: PhotosCollection](x: Self) {
          ...
          inline def setPatch(value: (UserPhoto, String) => UserPhoto): Self = StObject.set(x, "patch", js.Any.fromFunction2(value))
          
          inline def setRemove(value: String => Callback): Self = StObject.set(x, "remove", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
          
          inline def setUpdate(value: (UserPhoto, String) => UserPhoto): Self = StObject.set(x, "update", js.Any.fromFunction2(value))
        }
      }
    }
    ...
    trait UsersCollection extends StObject {
      ...
      var Aliases: js.UndefOr[
            typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Collection.Users.AliasesCollection
          ] = js.native
    ...
    object VerificationCodesCollection {
      ...
      inline def apply(generate: String => Callback, invalidate: String => Callback, list: String => VerificationCodes): VerificationCodesCollection = {
        val __obj = js.Dynamic.literal(generate = js.Any.fromFunction1((t0: String) => generate(t0).runNow()), invalidate = js.Any.fromFunction1((t0: String) => invalidate(t0).runNow()), list = js.Any.fromFunction1(list))
        __obj.asInstanceOf[VerificationCodesCollection]
      }
      
      extension [Self <: VerificationCodesCollection](x: Self) {
        
        inline def setGenerate(value: String => Callback): Self = StObject.set(x, "generate", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
        
        inline def setInvalidate(value: String => Callback): Self = StObject.set(x, "invalidate", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  ...
  object Schema {
    ...
    object AppAccessCollections {
      ...
      inline def apply(): AppAccessCollections = {
        val __obj = js.Dynamic.literal()
    ...
    object Asps {
      ...
      extension [Self <: Asps](x: Self) {
        ...
        inline def setItems(value: js.Array[Asp]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    object Building {
      ...
      extension [Self <: Building](x: Self) {
        ...
        inline def setCoordinates(value: BuildingCoordinates): Self = StObject.set(x, "coordinates", value.asInstanceOf[js.Any])
    ...
    object BuildingAddress {
      ...
      inline def apply(): BuildingAddress = {
        val __obj = js.Dynamic.literal()
    ...
    object BuildingCoordinates {
      ...
      inline def apply(): BuildingCoordinates = {
        val __obj = js.Dynamic.literal()
    ...
    object CalendarResource {
      ...
      inline def apply(): CalendarResource = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: CalendarResource](x: Self) {
        ...
        inline def setFeatureInstances(value: js.Object): Self = StObject.set(x, "featureInstances", value.asInstanceOf[js.Any])
    ...
    object CalendarResources {
      ...
      inline def apply(): CalendarResources = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: CalendarResources](x: Self) {
        ...
        inline def setItems(value: js.Array[CalendarResource]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    object ChromeOsDevice {
      ...
      inline def apply(): ChromeOsDevice = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: ChromeOsDevice](x: Self) {
        ...
        inline def setCpuStatusReports(value: js.Array[ChromeOsDeviceCpuStatusReports]): Self = StObject.set(x, "cpuStatusReports", value.asInstanceOf[js.Any])
        ...
        inline def setDiskVolumeReports(value: js.Array[ChromeOsDeviceDiskVolumeReports]): Self = StObject.set(x, "diskVolumeReports", value.asInstanceOf[js.Any])
        ...
        inline def setRecentUsers(value: js.Array[ChromeOsDeviceRecentUsers]): Self = StObject.set(x, "recentUsers", value.asInstanceOf[js.Any])
        ...
        inline def setSystemRamFreeReports(value: js.Array[ChromeOsDeviceSystemRamFreeReports]): Self = StObject.set(x, "systemRamFreeReports", value.asInstanceOf[js.Any])
        ...
        inline def setTpmVersionInfo(value: ChromeOsDeviceTpmVersionInfo): Self = StObject.set(x, "tpmVersionInfo", value.asInstanceOf[js.Any])
    ...
    object ChromeOsDeviceAction {
      ...
      inline def apply(): ChromeOsDeviceAction = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceActiveTimeRanges {
      ...
      inline def apply(): ChromeOsDeviceActiveTimeRanges = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceCpuStatusReports {
      ...
      inline def apply(): ChromeOsDeviceCpuStatusReports = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceCpuStatusReportsCpuTemperatureInfo {
      ...
      inline def apply(): ChromeOsDeviceCpuStatusReportsCpuTemperatureInfo = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceDeviceFiles {
      ...
      inline def apply(): ChromeOsDeviceDeviceFiles = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceDiskVolumeReports {
      ...
      inline def apply(): ChromeOsDeviceDiskVolumeReports = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceDiskVolumeReportsVolumeInfo {
      ...
      inline def apply(): ChromeOsDeviceDiskVolumeReportsVolumeInfo = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceRecentUsers {
      ...
      inline def apply(): ChromeOsDeviceRecentUsers = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceSystemRamFreeReports {
      ...
      inline def apply(): ChromeOsDeviceSystemRamFreeReports = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDeviceTpmVersionInfo {
      ...
      inline def apply(): ChromeOsDeviceTpmVersionInfo = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsDevices {
      ...
      inline def apply(): ChromeOsDevices = {
        val __obj = js.Dynamic.literal()
    ...
    object ChromeOsMoveDevicesToOu {
      ...
      inline def apply(): ChromeOsMoveDevicesToOu = {
        val __obj = js.Dynamic.literal()
    ...
    object Customer {
      ...
      extension [Self <: Customer](x: Self) {
        ...
        inline def setPostalAddress(value: CustomerPostalAddress): Self = StObject.set(x, "postalAddress", value.asInstanceOf[js.Any])
    ...
    object CustomerPostalAddress {
      ...
      inline def apply(): CustomerPostalAddress = {
        val __obj = js.Dynamic.literal()
    ...
    object DomainAliases {
      ...
      inline def apply(): DomainAliases = {
        val __obj = js.Dynamic.literal()
    ...
    object FeatureInstance {
      ...
      inline def apply(): FeatureInstance = {
        val __obj = js.Dynamic.literal()
    ...
    object FeatureRename {
      ...
      inline def apply(): FeatureRename = {
        val __obj = js.Dynamic.literal()
    ...
    object Groups {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Groups = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Groups]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Groups](x: Self) {
    ...
    object MembersHasMember {
      ...
      inline def apply(): MembersHasMember = {
        val __obj = js.Dynamic.literal()
    ...
    object MobileDevice {
      ...
      extension [Self <: MobileDevice](x: Self) {
        ...
        inline def setApplications(value: js.Array[MobileDeviceApplications]): Self = StObject.set(x, "applications", value.asInstanceOf[js.Any])
    ...
    object MobileDeviceAction {
      ...
      inline def apply(): MobileDeviceAction = {
        val __obj = js.Dynamic.literal()
    ...
    object MobileDeviceApplications {
      ...
      inline def apply(): MobileDeviceApplications = {
        val __obj = js.Dynamic.literal()
    ...
    object MobileDevices {
      ...
      inline def apply(): MobileDevices = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: MobileDevices](x: Self) {
        ...
        inline def setMobiledevices(value: js.Array[MobileDevice]): Self = StObject.set(x, "mobiledevices", value.asInstanceOf[js.Any])
    ...
    object OrgUnits {
      ...
      extension [Self <: OrgUnits](x: Self) {
        ...
        inline def setOrganizationUnits(value: js.Array[OrgUnit]): Self = StObject.set(x, "organizationUnits", value.asInstanceOf[js.Any])
    ...
    object Privileges {
      ...
      extension [Self <: Privileges](x: Self) {
        ...
        inline def setItems(value: js.Array[Privilege]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    object Role {
      ...
      extension [Self <: Role](x: Self) {
        ...
        inline def setRolePrivileges(value: js.Array[RoleRolePrivileges]): Self = StObject.set(x, "rolePrivileges", value.asInstanceOf[js.Any])
    ...
    object RoleAssignments {
      ...
      inline def apply(): RoleAssignments = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: RoleAssignments](x: Self) {
        ...
        inline def setItems(value: js.Array[RoleAssignment]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    object RoleRolePrivileges {
      ...
      inline def apply(): RoleRolePrivileges = {
        val __obj = js.Dynamic.literal()
    ...
    object Roles {
      ...
      extension [Self <: Roles](x: Self) {
        ...
        inline def setItems(value: js.Array[Role]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    object Schema {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Schema = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Schema]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Schema](x: Self) {
        ...
        inline def setFields(value: js.Array[SchemaFieldSpec]): Self = StObject.set(x, "fields", value.asInstanceOf[js.Any])
    ...
    object SchemaFieldSpec {
      ...
      inline def apply(): SchemaFieldSpec = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: SchemaFieldSpec](x: Self) {
        ...
        inline def setNumericIndexingSpec(value: SchemaFieldSpecNumericIndexingSpec): Self = StObject.set(x, "numericIndexingSpec", value.asInstanceOf[js.Any])
    ...
    object SchemaFieldSpecNumericIndexingSpec {
      ...
      inline def apply(): SchemaFieldSpecNumericIndexingSpec = {
        val __obj = js.Dynamic.literal()
    ...
    trait Schemas extends StObject {
      ...
      var schemas: js.UndefOr[
            js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Schema]
          ] = js.undefined
    }
    object Schemas {
      
      inline def apply(): Schemas = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: Schemas](x: Self) {
        ...
        inline def setSchemas(value: js.Array[typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Schema]): Self = StObject.set(x, "schemas", value.asInstanceOf[js.Any])
        
        inline def setSchemasUndefined: Self = StObject.set(x, "schemas", js.undefined)
        
        inline def setSchemasVarargs(value: typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Schema*): Self = StObject.set(x, "schemas", js.Array(value*))
      }
    }
    ...
    object Tokens {
      ...
      extension [Self <: Tokens](x: Self) {
        ...
        inline def setItems(value: js.Array[Token]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
    ...
    object TrustedApps {
      ...
      extension [Self <: TrustedApps](x: Self) {
        ...
        inline def setTrustedApps(value: js.Array[TrustedAppId]): Self = StObject.set(x, "trustedApps", value.asInstanceOf[js.Any])
    ...
    object User {
      ...
      extension [Self <: User](x: Self) {
        ...
        inline def setCustomSchemas(value: js.Object): Self = StObject.set(x, "customSchemas", value.asInstanceOf[js.Any])
    ...
    object UserExternalId {
      ...
      inline def apply(): UserExternalId = {
        val __obj = js.Dynamic.literal()
    ...
    object UserMakeAdmin {
      ...
      inline def apply(): UserMakeAdmin = {
        val __obj = js.Dynamic.literal()
    ...
    object UserOrganization {
      ...
      inline def apply(): UserOrganization = {
        val __obj = js.Dynamic.literal()
    ...
    object UserPosixAccount {
      ...
      inline def apply(): UserPosixAccount = {
        val __obj = js.Dynamic.literal()
    ...
    object UserSshPublicKey {
      ...
      inline def apply(): UserSshPublicKey = {
        val __obj = js.Dynamic.literal()
    ...
    object VerificationCode {
      ...
      inline def apply(): VerificationCode = {
        val __obj = js.Dynamic.literal()
    ...
    object VerificationCodes {
      ...
      inline def apply(): VerificationCodes = {
        val __obj = js.Dynamic.literal()
      ...
      extension [Self <: VerificationCodes](x: Self) {
        ...
        inline def setItems(value: js.Array[VerificationCode]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
