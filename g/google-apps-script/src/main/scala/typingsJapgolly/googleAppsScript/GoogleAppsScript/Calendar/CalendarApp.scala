...
trait CalendarApp extends js.Object {
  ...
  def createCalendar(name: String, options: StringDictionary[js.Any]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
  ...
  def subscribeToCalendar(id: String, options: StringDictionary[js.Any]): typingsJapgolly.googleAppsScript.GoogleAppsScript.Calendar.Calendar = js.native
}
