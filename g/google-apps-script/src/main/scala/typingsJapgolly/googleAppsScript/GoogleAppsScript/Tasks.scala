...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Tasks.Schema.TaskLists
...
object Tasks {
  ...
  inline def apply(newTask: CallbackTo[Task], newTaskLinks: CallbackTo[TaskLinks], newTaskList: CallbackTo[TaskList]): Tasks = {
    val __obj = js.Dynamic.literal(newTask = newTask.toJsFn, newTaskLinks = newTaskLinks.toJsFn, newTaskList = newTaskList.toJsFn)
  ...
  object Collection {
    ...
    trait TasksCollection extends StObject {
      ...
      def list(tasklist: String): typingsJapgolly.googleAppsScript.GoogleAppsScript.Tasks.Schema.Tasks = js.native
      // Returns all tasks in the specified task list.
      def list(tasklist: String, optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.Tasks.Schema.Tasks = js.native
  ...
  object Schema {
    ...
    object Tasks {
      ...
      inline def apply(): typingsJapgolly.googleAppsScript.GoogleAppsScript.Tasks.Schema.Tasks = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.googleAppsScript.GoogleAppsScript.Tasks.Schema.Tasks]
      }
      
      extension [Self <: typingsJapgolly.googleAppsScript.GoogleAppsScript.Tasks.Schema.Tasks](x: Self) {
  ...
  extension [Self <: Tasks](x: Self) {
    ...
    inline def setNewTask(value: CallbackTo[Task]): Self = StObject.set(x, "newTask", value.toJsFn)
    
    inline def setNewTaskLinks(value: CallbackTo[TaskLinks]): Self = StObject.set(x, "newTaskLinks", value.toJsFn)
    
    inline def setNewTaskList(value: CallbackTo[TaskList]): Self = StObject.set(x, "newTaskList", value.toJsFn)
