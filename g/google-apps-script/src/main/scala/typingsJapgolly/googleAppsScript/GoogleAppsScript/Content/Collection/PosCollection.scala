...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Content.Schema.PosCustomBatchResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Content.Schema.PosInventoryRequest
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Content.Schema.PosInventoryResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Content.Schema.PosListResponse
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Content.Schema.PosSaleRequest
import typingsJapgolly.googleAppsScript.GoogleAppsScript.Content.Schema.PosSaleResponse
