...
object EmbeddedHistogramChartBuilder {
  ...
  inline def apply(
    ...
    setLegendTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder,
    ...
    setTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder,
    setTransposeRowsAndColumns: Boolean => EmbeddedChartBuilder,
    setXAxisTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder,
    setXAxisTitle: String => EmbeddedHistogramChartBuilder,
    setXAxisTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder,
    setYAxisTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder,
    setYAxisTitle: String => EmbeddedHistogramChartBuilder,
    setYAxisTitleTextStyle: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder,
  ...
  extension [Self <: EmbeddedHistogramChartBuilder](x: Self) {
    ...
    inline def setReverseCategories(value: CallbackTo[EmbeddedHistogramChartBuilder]): Self = StObject.set(x, "reverseCategories", value.toJsFn)
    ...
    inline def setSetLegendTextStyle(
      value: typingsJapgolly.googleAppsScript.GoogleAppsScript.Charts.TextStyle => EmbeddedHistogramChartBuilder
    ...
    inline def setSetStacked(value: CallbackTo[EmbeddedHistogramChartBuilder]): Self = StObject.set(x, "setStacked", value.toJsFn)
    ...
    inline def setUseLogScale(value: CallbackTo[EmbeddedHistogramChartBuilder]): Self = StObject.set(x, "useLogScale", value.toJsFn)
  }
}
