...
object TagManager {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(newAccount = newAccount.toJsFn, newAccountAccess = newAccountAccess.toJsFn, newBuiltInVariable = newBuiltInVariable.toJsFn, newCondition = newCondition.toJsFn, newContainer = newContainer.toJsFn, newContainerAccess = newContainerAccess.toJsFn, newContainerVersion = newContainerVersion.toJsFn, newCreateContainerVersionRequestVersionOptions = newCreateContainerVersionRequestVersionOptions.toJsFn, newCustomTemplate = newCustomTemplate.toJsFn, newEntity = newEntity.toJsFn, newEnvironment = newEnvironment.toJsFn, newFolder = newFolder.toJsFn, newParameter = newParameter.toJsFn, newSetupTag = newSetupTag.toJsFn, newTag = newTag.toJsFn, newTeardownTag = newTeardownTag.toJsFn, newTimestamp = newTimestamp.toJsFn, newTrigger = newTrigger.toJsFn, newUserPermission = newUserPermission.toJsFn, newVariable = newVariable.toJsFn, newVariableFormatValue = newVariableFormatValue.toJsFn, newWorkspace = newWorkspace.toJsFn, newZone = newZone.toJsFn, newZoneBoundary = newZoneBoundary.toJsFn, newZoneChildContainer = newZoneChildContainer.toJsFn, newZoneTypeRestriction = newZoneTypeRestriction.toJsFn)
  ...
  extension [Self <: TagManager](x: Self) {
    ...
    inline def setNewAccountAccess(value: CallbackTo[AccountAccess]): Self = StObject.set(x, "newAccountAccess", value.toJsFn)
    
    inline def setNewBuiltInVariable(value: CallbackTo[BuiltInVariable]): Self = StObject.set(x, "newBuiltInVariable", value.toJsFn)
    
    inline def setNewCondition(value: CallbackTo[Condition]): Self = StObject.set(x, "newCondition", value.toJsFn)
    
    inline def setNewContainer(value: CallbackTo[Container]): Self = StObject.set(x, "newContainer", value.toJsFn)
    
    inline def setNewContainerAccess(value: CallbackTo[ContainerAccess]): Self = StObject.set(x, "newContainerAccess", value.toJsFn)
    
    inline def setNewContainerVersion(value: CallbackTo[ContainerVersion]): Self = StObject.set(x, "newContainerVersion", value.toJsFn)
    
    inline def setNewCreateContainerVersionRequestVersionOptions(value: CallbackTo[CreateContainerVersionRequestVersionOptions]): Self = StObject.set(x, "newCreateContainerVersionRequestVersionOptions", value.toJsFn)
    
    inline def setNewCustomTemplate(value: CallbackTo[CustomTemplate]): Self = StObject.set(x, "newCustomTemplate", value.toJsFn)
    
    inline def setNewEntity(value: CallbackTo[Entity]): Self = StObject.set(x, "newEntity", value.toJsFn)
    
    inline def setNewEnvironment(value: CallbackTo[Environment]): Self = StObject.set(x, "newEnvironment", value.toJsFn)
    
    inline def setNewFolder(value: CallbackTo[Folder]): Self = StObject.set(x, "newFolder", value.toJsFn)
    
    inline def setNewParameter(value: CallbackTo[Parameter]): Self = StObject.set(x, "newParameter", value.toJsFn)
    
    inline def setNewSetupTag(value: CallbackTo[SetupTag]): Self = StObject.set(x, "newSetupTag", value.toJsFn)
    
    inline def setNewTag(value: CallbackTo[Tag]): Self = StObject.set(x, "newTag", value.toJsFn)
    
    inline def setNewTeardownTag(value: CallbackTo[TeardownTag]): Self = StObject.set(x, "newTeardownTag", value.toJsFn)
    
    inline def setNewTimestamp(value: CallbackTo[Timestamp]): Self = StObject.set(x, "newTimestamp", value.toJsFn)
    
    inline def setNewTrigger(value: CallbackTo[Trigger]): Self = StObject.set(x, "newTrigger", value.toJsFn)
    
    inline def setNewUserPermission(value: CallbackTo[UserPermission]): Self = StObject.set(x, "newUserPermission", value.toJsFn)
    
    inline def setNewVariable(value: CallbackTo[Variable]): Self = StObject.set(x, "newVariable", value.toJsFn)
    
    inline def setNewVariableFormatValue(value: CallbackTo[VariableFormatValue]): Self = StObject.set(x, "newVariableFormatValue", value.toJsFn)
    
    inline def setNewWorkspace(value: CallbackTo[Workspace]): Self = StObject.set(x, "newWorkspace", value.toJsFn)
    
    inline def setNewZone(value: CallbackTo[Zone]): Self = StObject.set(x, "newZone", value.toJsFn)
    
    inline def setNewZoneBoundary(value: CallbackTo[ZoneBoundary]): Self = StObject.set(x, "newZoneBoundary", value.toJsFn)
    
    inline def setNewZoneChildContainer(value: CallbackTo[ZoneChildContainer]): Self = StObject.set(x, "newZoneChildContainer", value.toJsFn)
    
    inline def setNewZoneTypeRestriction(value: CallbackTo[ZoneTypeRestriction]): Self = StObject.set(x, "newZoneTypeRestriction", value.toJsFn)
  }
}
