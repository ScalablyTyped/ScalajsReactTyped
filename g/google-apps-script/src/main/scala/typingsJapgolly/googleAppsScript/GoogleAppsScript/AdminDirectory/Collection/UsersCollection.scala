...
import typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Collection.Users.AliasesCollection
...
trait UsersCollection extends js.Object {
  ...
  def list(): typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Users = js.native
  // Retrieve either deleted users or all users in a domain (paginated)
  def list(optionalArgs: js.Object): typingsJapgolly.googleAppsScript.GoogleAppsScript.AdminDirectory.Schema.Users = js.native
