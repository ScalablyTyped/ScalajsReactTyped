...
object HTML {
  ...
  object SandboxMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.googleAppsScript.GoogleAppsScript.HTML.SandboxMode & Double] = js.native
    
    /* 0 */ val EMULATED: typingsJapgolly.googleAppsScript.GoogleAppsScript.HTML.SandboxMode.EMULATED & Double = js.native
    
    /* 1 */ val IFRAME: typingsJapgolly.googleAppsScript.GoogleAppsScript.HTML.SandboxMode.IFRAME & Double = js.native
    
    /* 2 */ val NATIVE: typingsJapgolly.googleAppsScript.GoogleAppsScript.HTML.SandboxMode.NATIVE & Double = js.native
  }
  ...
  object XFrameOptionsMode extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.googleAppsScript.GoogleAppsScript.HTML.XFrameOptionsMode & Double
      ] = js.native
    
    /* 0 */ val ALLOWALL: typingsJapgolly.googleAppsScript.GoogleAppsScript.HTML.XFrameOptionsMode.ALLOWALL & Double = js.native
    
    /* 1 */ val DEFAULT: typingsJapgolly.googleAppsScript.GoogleAppsScript.HTML.XFrameOptionsMode.DEFAULT & Double = js.native
  }
}
