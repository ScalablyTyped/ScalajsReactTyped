...
import typingsJapgolly.guacamoleClient.anon.FnCall
import typingsJapgolly.guacamoleClient.anon.FnCallPathFillRule
...
import typingsJapgolly.guacamoleClient.libLayerMod.Layer.LineCap
import typingsJapgolly.guacamoleClient.libLayerMod.Layer.LineJoin
import typingsJapgolly.guacamoleClient.libLayerMod.Layer.Pixel
...
object libLayerMod {
  ...
  object Layer {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.guacamoleClient.guacamoleClientStrings.round
      - typingsJapgolly.guacamoleClient.guacamoleClientStrings.square
      - typingsJapgolly.guacamoleClient.guacamoleClientStrings.butt
    */
    trait LineCap extends StObject
    object LineCap {
      
      inline def butt: typingsJapgolly.guacamoleClient.guacamoleClientStrings.butt = "butt".asInstanceOf[typingsJapgolly.guacamoleClient.guacamoleClientStrings.butt]
      
      inline def round: typingsJapgolly.guacamoleClient.guacamoleClientStrings.round = "round".asInstanceOf[typingsJapgolly.guacamoleClient.guacamoleClientStrings.round]
      
      inline def square: typingsJapgolly.guacamoleClient.guacamoleClientStrings.square = "square".asInstanceOf[typingsJapgolly.guacamoleClient.guacamoleClientStrings.square]
    }
    
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.guacamoleClient.guacamoleClientStrings.round
      - typingsJapgolly.guacamoleClient.guacamoleClientStrings.bevel
      - typingsJapgolly.guacamoleClient.guacamoleClientStrings.mitter
    */
    trait LineJoin extends StObject
    object LineJoin {
      
      inline def bevel: typingsJapgolly.guacamoleClient.guacamoleClientStrings.bevel = "bevel".asInstanceOf[typingsJapgolly.guacamoleClient.guacamoleClientStrings.bevel]
      
      inline def mitter: typingsJapgolly.guacamoleClient.guacamoleClientStrings.mitter = "mitter".asInstanceOf[typingsJapgolly.guacamoleClient.guacamoleClientStrings.mitter]
