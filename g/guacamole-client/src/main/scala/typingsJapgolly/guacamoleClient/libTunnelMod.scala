...
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`2`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`3`
...
import typingsJapgolly.guacamoleClient.libTunnelMod.Tunnel.State
...
object libTunnelMod {
  ...
  /* note: abstract class */ @JSImport("guacamole-client/lib/Tunnel", "Tunnel")
  @js.native
