...
object libOnScreenKeyboardMod {
  ...
  object OnScreenKeyboard {
    ...
    type Key = Instantiable2[
        /* template */ typingsJapgolly.guacamoleClient.libOnScreenKeyboardMod.Key, 
        /* name */ js.UndefOr[String], 
        typingsJapgolly.guacamoleClient.libOnScreenKeyboardMod.Key
      ]
    
    type Layout = Instantiable1[
        /* template */ typingsJapgolly.guacamoleClient.libOnScreenKeyboardMod.Layout, 
        typingsJapgolly.guacamoleClient.libOnScreenKeyboardMod.Layout
      ]
  }
