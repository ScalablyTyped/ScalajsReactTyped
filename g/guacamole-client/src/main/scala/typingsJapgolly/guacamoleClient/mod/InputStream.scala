...
open class InputStream protected ()
  extends typingsJapgolly.guacamoleClient.libInputStreamMod.InputStream {
  /**
    * @param client The client owning this stream.
    * @param index The index of this stream.
    */
  def this(client: typingsJapgolly.guacamoleClient.libClientMod.Client, index: Double) = this()
}
