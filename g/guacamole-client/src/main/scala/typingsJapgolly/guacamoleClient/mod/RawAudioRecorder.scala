...
open class RawAudioRecorder protected ()
  extends typingsJapgolly.guacamoleClient.libRawAudioRecorderMod.RawAudioRecorder {
  /**
    ...
    */
  def this(stream: typingsJapgolly.guacamoleClient.libOutputStreamMod.OutputStream, mimetype: Mimetype) = this()
}
/* static members */
