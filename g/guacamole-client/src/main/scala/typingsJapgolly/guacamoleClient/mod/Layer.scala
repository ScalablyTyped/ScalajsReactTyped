...
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0x1`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0x2`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0x4`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0x6`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0x8`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0x9`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0xa`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0xb`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0xc`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0xe`
import typingsJapgolly.guacamoleClient.guacamoleClientInts.`0xf`
...
open class Layer protected ()
  extends typingsJapgolly.guacamoleClient.libLayerMod.Layer {
  /**
...
object Layer {
  ...
  open class Pixel protected ()
    extends typingsJapgolly.guacamoleClient.libLayerMod.Layer.Pixel {
    /**
