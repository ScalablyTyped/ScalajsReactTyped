...
open class AudioPlayer ()
  extends typingsJapgolly.guacamoleClient.libAudioPlayerMod.AudioPlayer
/* static members */
object AudioPlayer {
  ...
  /**
    ...
    */
  inline def getInstance(stream: typingsJapgolly.guacamoleClient.libInputStreamMod.InputStream, mimetype: Mimetype): typingsJapgolly.guacamoleClient.libAudioPlayerMod.AudioPlayer | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")(stream.asInstanceOf[js.Any], mimetype.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.guacamoleClient.libAudioPlayerMod.AudioPlayer | Null]
