...
open class AudioRecorder ()
  extends typingsJapgolly.guacamoleClient.libAudioRecorderMod.AudioRecorder
/* static members */
object AudioRecorder {
  ...
  /**
    ...
    */
  inline def getInstance(stream: typingsJapgolly.guacamoleClient.libOutputStreamMod.OutputStream, mimetype: Mimetype): typingsJapgolly.guacamoleClient.libAudioRecorderMod.AudioRecorder | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")(stream.asInstanceOf[js.Any], mimetype.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.guacamoleClient.libAudioRecorderMod.AudioRecorder | Null]
