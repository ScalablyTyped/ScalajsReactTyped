...
open class VideoPlayer ()
  extends typingsJapgolly.guacamoleClient.libVideoPlayerMod.VideoPlayer
/* static members */
object VideoPlayer {
  ...
  inline def getInstance(
    stream: typingsJapgolly.guacamoleClient.libInputStreamMod.InputStream,
    layer: typingsJapgolly.guacamoleClient.libVisibleLayerMod.VisibleLayer,
    mimetype: MimeType
  ): typingsJapgolly.guacamoleClient.libVideoPlayerMod.VideoPlayer | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("getInstance")(stream.asInstanceOf[js.Any], layer.asInstanceOf[js.Any], mimetype.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.guacamoleClient.libVideoPlayerMod.VideoPlayer | Null]
