...
import typingsJapgolly.gestaltDatepicker.anon.Date
import typingsJapgolly.gestaltDatepicker.anon.Day
import typingsJapgolly.gestaltDatepicker.anon.Event
import typingsJapgolly.gestaltDatepicker.anon.FirstWeekContainsDate
...
object mod extends Shortcut {
  ...
  object DatePickerProps {
    ...
    inline def apply(id: String, onChange: Event => Callback): DatePickerProps = {
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], onChange = js.Any.fromFunction1((t0: Event) => onChange(t0).runNow()))
    ...
    extension [Self <: DatePickerProps](x: Self) {
      ...
      inline def setNextRefFunction1(value: Any | Null => Callback): Self = StObject.set(x, "nextRef", js.Any.fromFunction1((t0: Any | Null) => value(t0).runNow()))
      ...
      inline def setOnChange(value: Event => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: Event) => value(t0).runNow()))
