...
object anon {
  ...
  object Info {
    ...
    extension [Self <: Info](x: Self) {
      ...
      inline def setInfo(value: /* str */ String => Callback): Self = StObject.set(x, "info", js.Any.fromFunction1((t0: /* str */ String) => value(t0).runNow()))
      
      inline def setInfoUndefined: Self = StObject.set(x, "info", js.undefined)
      
      inline def setWarn(value: /* str */ String => Callback): Self = StObject.set(x, "warn", js.Any.fromFunction1((t0: /* str */ String) => value(t0).runNow()))
