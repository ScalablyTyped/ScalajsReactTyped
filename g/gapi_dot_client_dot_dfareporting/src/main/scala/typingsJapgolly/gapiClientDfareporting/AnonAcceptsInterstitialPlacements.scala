...
trait AnonAcceptsInterstitialPlacements extends js.Object {
...
object AnonAcceptsInterstitialPlacements {
  @scala.inline
  def apply(
    profileId: String,
    ...
    userIp: String = null
  ): AnonAcceptsInterstitialPlacements = {
    ...
    __obj.asInstanceOf[AnonAcceptsInterstitialPlacements]
  }
}
