...
object CertificateFormat extends StObject {
  ...
  /* "JWK" */ val JWK: typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.CertificateFormat.JWK & String = js.native
  
  @js.native
  sealed trait PEM
    extends StObject
       with CertificateFormat
  /* "PEM" */ val PEM: typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.CertificateFormat.PEM & String = js.native
}
