...
object buildSrcMessagesMod {
  ...
  object WarningTypes extends StObject {
    ...
    sealed trait DEPRECATION
      extends StObject
         with WarningTypes
    /* "DeprecationWarning" */ val DEPRECATION: typingsJapgolly.googleAuthLibrary.buildSrcMessagesMod.WarningTypes.DEPRECATION & String = js.native
    
    @js.native
    sealed trait WARNING
      extends StObject
         with WarningTypes
    /* "Warning" */ val WARNING: typingsJapgolly.googleAuthLibrary.buildSrcMessagesMod.WarningTypes.WARNING & String = js.native
  }
