...
import typingsJapgolly.googleAuthLibrary.buildSrcAuthDownscopedclientMod.AccessBoundaryRule
import typingsJapgolly.googleAuthLibrary.buildSrcAuthIdentitypoolclientMod.SubjectTokenFormatType
import typingsJapgolly.googleAuthLibrary.buildSrcAuthLoginticketMod.TokenPayload
import typingsJapgolly.googleAuthLibrary.buildSrcTransportersMod.DefaultTransporter
...
object anon {
  ...
  trait Headers extends StObject {
    ...
    var headers: js.UndefOr[typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.Headers] = js.undefined
  ...
  object Headers {
    ...
    extension [Self <: Headers](x: Self) {
      ...
      inline def setHeaders(value: typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.Headers): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
