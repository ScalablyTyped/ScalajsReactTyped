...
object buildSrcAuthOauth2commonMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.basic
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.`request-body`
  */
  trait ConfidentialClientType extends StObject
  object ConfidentialClientType {
    
    inline def basic: typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.basic = "basic".asInstanceOf[typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.basic]
    
    inline def `request-body`: typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.`request-body` = "request-body".asInstanceOf[typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.`request-body`]
  }
  ...
  /**
    ...
    */
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.invalid_request
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.invalid_client
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.invalid_grant
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.unauthorized_client
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.unsupported_grant_type
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.invalid_scope
    - java.lang.String
  */
