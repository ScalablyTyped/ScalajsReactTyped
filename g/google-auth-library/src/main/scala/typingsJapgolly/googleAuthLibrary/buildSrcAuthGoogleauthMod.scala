...
import typingsJapgolly.googleAuthLibrary.anon.Headers
...
import typingsJapgolly.googleAuthLibrary.buildSrcAuthComputeclientMod.Compute
import typingsJapgolly.googleAuthLibrary.buildSrcAuthCredentialsMod.CredentialBody
import typingsJapgolly.googleAuthLibrary.buildSrcAuthCredentialsMod.ImpersonatedJWTInput
import typingsJapgolly.googleAuthLibrary.buildSrcAuthCredentialsMod.JWTInput
import typingsJapgolly.googleAuthLibrary.buildSrcAuthEnvDetectMod.GCPEnv
import typingsJapgolly.googleAuthLibrary.buildSrcAuthExternalclientMod.ExternalAccountClientOptions
import typingsJapgolly.googleAuthLibrary.buildSrcAuthIdtokenclientMod.IdTokenClient
import typingsJapgolly.googleAuthLibrary.buildSrcAuthImpersonatedMod.Impersonated
import typingsJapgolly.googleAuthLibrary.buildSrcAuthImpersonatedMod.ImpersonatedOptions
import typingsJapgolly.googleAuthLibrary.buildSrcAuthJwtclientMod.JWT
...
import typingsJapgolly.googleAuthLibrary.buildSrcTransportersMod.Transporter
...
object buildSrcAuthGoogleauthMod {
  ...
  open class GoogleAuth[T /* <: AuthClient */] () extends StObject {
    ...
    /**
      ...
      * request.
      */
    def getRequestHeaders(): js.Promise[typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.Headers] = js.native
    def getRequestHeaders(url: String): js.Promise[typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.Headers] = js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.googleAuthLibrary.buildSrcAuthJwtclientMod.JWT
    - typingsJapgolly.googleAuthLibrary.buildSrcAuthRefreshclientMod.UserRefreshClient
    - typingsJapgolly.googleAuthLibrary.buildSrcAuthBaseexternalclientMod.BaseExternalAccountClient
    - typingsJapgolly.googleAuthLibrary.buildSrcAuthImpersonatedMod.Impersonated
  */
