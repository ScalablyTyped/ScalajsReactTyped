...
import typingsJapgolly.googleAuthLibrary.anon.Res
import typingsJapgolly.googleAuthLibrary.buildSrcAuthCredentialsMod.Credentials
import typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.Headers
...
object buildSrcAuthAuthclientMod {
  
  /* note: abstract class */ @JSImport("google-auth-library/build/src/auth/authclient", "AuthClient")
  @js.native
