...
object buildSrcCryptoCryptoMod {
  ...
  object CryptoSigner {
    ...
    inline def apply(sign: (String, String) => String, update: String => Callback): CryptoSigner = {
      val __obj = js.Dynamic.literal(sign = js.Any.fromFunction2(sign), update = js.Any.fromFunction1((t0: String) => update(t0).runNow()))
