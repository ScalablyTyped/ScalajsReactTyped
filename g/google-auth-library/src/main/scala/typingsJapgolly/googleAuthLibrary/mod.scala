...
import typingsJapgolly.googleAuthLibrary.buildSrcAuthBaseexternalclientMod.BaseExternalAccountClientOptions
import typingsJapgolly.googleAuthLibrary.buildSrcAuthComputeclientMod.ComputeOptions
import typingsJapgolly.googleAuthLibrary.buildSrcAuthDownscopedclientMod.CredentialAccessBoundary
...
import typingsJapgolly.googleAuthLibrary.buildSrcAuthIdtokenclientMod.IdTokenOptions
...
import typingsJapgolly.googleAuthLibrary.buildSrcAuthPluggableAuthClientMod.PluggableAuthClientOptions
...
object mod {
  ...
  open class AuthClient ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthAuthclientMod.AuthClient {
  ...
  open class AwsClient protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthAwsclientMod.AwsClient {
    /**
  ...
  open class BaseExternalAccountClient protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthBaseexternalclientMod.BaseExternalAccountClient {
    /**
  ...
  object CodeChallengeMethod extends StObject {
    ...
    def apply(value: String): js.UndefOr[
        typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.CodeChallengeMethod & String
      ] = js.native
  ...
  /**
    ...
    */
  open class Compute ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthComputeclientMod.Compute {
  ...
  open class DefaultTransporter ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcTransportersMod.DefaultTransporter
  /* static members */
  ...
  open class DownscopedClient protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthDownscopedclientMod.DownscopedClient {
    /**
      ...
      */
    def this(
      authClient: typingsJapgolly.googleAuthLibrary.buildSrcAuthAuthclientMod.AuthClient,
  ...
  open class ExternalAccountClient ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthExternalclientMod.ExternalAccountClient
  /* static members */
  object ExternalAccountClient {
    ...
    /**
      ...
      */
    inline def fromJSON(options: ExternalAccountClientOptions): typingsJapgolly.googleAuthLibrary.buildSrcAuthBaseexternalclientMod.BaseExternalAccountClient | Null = ^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(options.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.googleAuthLibrary.buildSrcAuthBaseexternalclientMod.BaseExternalAccountClient | Null]
    inline def fromJSON(options: ExternalAccountClientOptions, additionalOptions: RefreshOptions): typingsJapgolly.googleAuthLibrary.buildSrcAuthBaseexternalclientMod.BaseExternalAccountClient | Null = (^.asInstanceOf[js.Dynamic].applyDynamic("fromJSON")(options.asInstanceOf[js.Any], additionalOptions.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.googleAuthLibrary.buildSrcAuthBaseexternalclientMod.BaseExternalAccountClient | Null]
  }
  ...
  object GCPEnv extends StObject {
    ...
    @JSBracketAccess
    def apply(value: String): js.UndefOr[typingsJapgolly.googleAuthLibrary.buildSrcAuthEnvDetectMod.GCPEnv & String] = js.native
    
    /* "APP_ENGINE" */ val APP_ENGINE: typingsJapgolly.googleAuthLibrary.buildSrcAuthEnvDetectMod.GCPEnv.APP_ENGINE & String = js.native
    
    /* "CLOUD_FUNCTIONS" */ val CLOUD_FUNCTIONS: typingsJapgolly.googleAuthLibrary.buildSrcAuthEnvDetectMod.GCPEnv.CLOUD_FUNCTIONS & String = js.native
    
    /* "CLOUD_RUN" */ val CLOUD_RUN: typingsJapgolly.googleAuthLibrary.buildSrcAuthEnvDetectMod.GCPEnv.CLOUD_RUN & String = js.native
    
    /* "COMPUTE_ENGINE" */ val COMPUTE_ENGINE: typingsJapgolly.googleAuthLibrary.buildSrcAuthEnvDetectMod.GCPEnv.COMPUTE_ENGINE & String = js.native
    
    /* "KUBERNETES_ENGINE" */ val KUBERNETES_ENGINE: typingsJapgolly.googleAuthLibrary.buildSrcAuthEnvDetectMod.GCPEnv.KUBERNETES_ENGINE & String = js.native
    
    /* "NONE" */ val NONE: typingsJapgolly.googleAuthLibrary.buildSrcAuthEnvDetectMod.GCPEnv.NONE & String = js.native
  }
  
  @JSImport("google-auth-library", "GoogleAuth")
  @js.native
  open class GoogleAuth[T /* <: typingsJapgolly.googleAuthLibrary.buildSrcAuthAuthclientMod.AuthClient */] ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthGoogleauthMod.GoogleAuth[T] {
  ...
  open class IAMAuth protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthIamMod.IAMAuth {
    /**
      * IAM credentials.
      *
  ...
  open class IdTokenClient protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthIdtokenclientMod.IdTokenClient {
    /**
  ...
  open class IdentityPoolClient protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthIdentitypoolclientMod.IdentityPoolClient {
    /**
  ...
  open class Impersonated ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthImpersonatedMod.Impersonated {
  ...
  open class JWT protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthJwtclientMod.JWT {
    /**
  ...
  open class JWTAccess protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthJwtaccessMod.JWTAccess {
    /**
  ...
  open class LoginTicket ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthLoginticketMod.LoginTicket {
  ...
  open class OAuth2Client ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthOauth2clientMod.OAuth2Client {
  ...
  open class PluggableAuthClient protected ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthPluggableAuthClientMod.PluggableAuthClient {
    /**
  ...
  open class UserRefreshClient ()
    extends typingsJapgolly.googleAuthLibrary.buildSrcAuthRefreshclientMod.UserRefreshClient {
    def this(clientId: String) = this()
  ...
  object auth extends Shortcut {
    ...
    @js.native
    val ^ : typingsJapgolly.googleAuthLibrary.buildSrcAuthGoogleauthMod.GoogleAuth[JSONClient] = js.native
    ...
    type _To = typingsJapgolly.googleAuthLibrary.buildSrcAuthGoogleauthMod.GoogleAuth[JSONClient]
    
    /* This means you don't have to write `^`, but can instead just say `auth.foo` */
    override def _to: typingsJapgolly.googleAuthLibrary.buildSrcAuthGoogleauthMod.GoogleAuth[JSONClient] = ^
  }
}
