...
object buildSrcAuthIdentitypoolclientMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.json
    - typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.text
  */
  trait SubjectTokenFormatType extends StObject
  object SubjectTokenFormatType {
    
    inline def json: typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.json = "json".asInstanceOf[typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.json]
    
    inline def text: typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.text = "text".asInstanceOf[typingsJapgolly.googleAuthLibrary.googleAuthLibraryStrings.text]
  }
}
