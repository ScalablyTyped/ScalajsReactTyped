...
import typingsJapgolly.googleGax.mod.fallback.protobuf.rpc.Service
...
trait Typeofrpc extends StObject {
  ...
  var Service: Instantiable1[/* rpcImpl */ RPCImpl, typingsJapgolly.googleGax.mod.fallback.protobuf.rpc.Service]
}
object Typeofrpc {
