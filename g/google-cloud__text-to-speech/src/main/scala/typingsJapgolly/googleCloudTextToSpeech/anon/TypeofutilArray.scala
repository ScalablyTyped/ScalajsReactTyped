...
@js.native
trait TypeofutilArray extends StObject {
  ...
  var EventEmitter: Instantiable0[typingsJapgolly.googleGax.mod.fallback.protobufMinimal.util.EventEmitter] = js.native
  ...
  var LongBits: (Instantiable2[
    /* lo */ Double, 
    /* hi */ Double, 
    typingsJapgolly.googleGax.mod.fallback.protobufMinimal.util.LongBits
  ]) & TypeofLongBits = js.native
  
  /** Error subclass indicating a protocol specifc error. */
  var ProtocolError: Instantiable1[
    /* message */ String, 
    typingsJapgolly.googleGax.mod.fallback.protobufMinimal.util.ProtocolError[Message[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]]
  ] = js.native
