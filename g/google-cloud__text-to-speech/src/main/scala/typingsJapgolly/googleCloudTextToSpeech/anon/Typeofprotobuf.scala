...
trait Typeofprotobuf extends StObject {
  ...
  var BufferReader: Instantiable1[/* buffer */ Buffer, typingsJapgolly.googleGax.mod.fallback.protobuf.BufferReader] = js.native
  ...
  var FieldBase: Instantiable3[
    ...
    /* id */ Double, 
    /* type */ String, 
    typingsJapgolly.googleGax.mod.fallback.protobuf.FieldBase
  ] = js.native
  ...
  var NamespaceBase: Instantiable0[typingsJapgolly.googleGax.mod.fallback.protobuf.NamespaceBase] = js.native
  
  var OneOf: TypeofOneOf = js.native
  
  var Reader: TypeofReader = js.native
  
  var ReflectionObject: Instantiable0[typingsJapgolly.googleGax.mod.fallback.protobuf.ReflectionObject] = js.native
