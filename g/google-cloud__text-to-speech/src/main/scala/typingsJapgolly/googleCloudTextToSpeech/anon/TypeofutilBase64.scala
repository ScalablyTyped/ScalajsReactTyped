...
trait TypeofutilBase64 extends StObject {
  ...
  var EventEmitter: Instantiable0[typingsJapgolly.googleGax.mod.protobufMinimal.util.EventEmitter] = js.native
  ...
  var LongBits: (Instantiable2[
    /* lo */ Double, 
    /* hi */ Double, 
    typingsJapgolly.googleGax.mod.protobufMinimal.util.LongBits
  ]) & TypeofLongBits = js.native
  
  /** Error subclass indicating a protocol specifc error. */
  var ProtocolError: Instantiable1[
    /* message */ String, 
    typingsJapgolly.googleGax.mod.protobufMinimal.util.ProtocolError[Message[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]]
  ] = js.native
