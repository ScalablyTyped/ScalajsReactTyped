...
trait Typeofutil extends StObject {
  ...
  var Buffer: Constructor[typingsJapgolly.protobufjs.mod.Buffer] = js.native
  
  /** A minimal event emitter. */
  var EventEmitter: Instantiable0[typingsJapgolly.googleGax.mod.fallback.protobuf.util.EventEmitter] = js.native
  
  /** Long.js's Long class if available. */
  var Long: Constructor[typingsJapgolly.protobufjs.mod.Long] = js.native
  
  /** Helper class for working with the low and high bits of a 64 bit value. */
  var LongBits: (Instantiable2[
    /* lo */ Double, 
    /* hi */ Double, 
    typingsJapgolly.googleGax.mod.fallback.protobuf.util.LongBits
  ]) & TypeofLongBits = js.native
  
  /** Error subclass indicating a protocol specifc error. */
  var ProtocolError: Instantiable1[
    /* message */ String, 
    typingsJapgolly.googleGax.mod.fallback.protobuf.util.ProtocolError[Message[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]]
  ] = js.native
