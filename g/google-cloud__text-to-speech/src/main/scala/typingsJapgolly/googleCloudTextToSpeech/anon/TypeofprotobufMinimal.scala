...
trait TypeofprotobufMinimal extends StObject {
  ...
  var BufferReader: Instantiable1[
    /* buffer */ Buffer, 
    typingsJapgolly.googleGax.mod.fallback.protobufMinimal.BufferReader
  ] = js.native
  ...
  var FieldBase: Instantiable3[
    ...
    /* id */ Double, 
    /* type */ String, 
    typingsJapgolly.googleGax.mod.fallback.protobufMinimal.FieldBase
  ] = js.native
  ...
  var NamespaceBase: Instantiable0[typingsJapgolly.googleGax.mod.fallback.protobufMinimal.NamespaceBase] = js.native
  
  var OneOf: TypeofOneOfInstantiable = js.native
  
  var Reader: TypeofReaderInstantiable = js.native
  
  var ReflectionObject: Instantiable0[typingsJapgolly.googleGax.mod.fallback.protobufMinimal.ReflectionObject] = js.native
