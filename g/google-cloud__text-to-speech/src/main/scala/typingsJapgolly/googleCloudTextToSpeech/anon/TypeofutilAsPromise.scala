...
trait TypeofutilAsPromise extends StObject {
  ...
  var EventEmitter: Instantiable0[typingsJapgolly.googleGax.mod.protobuf.util.EventEmitter] = js.native
  ...
  var LongBits: (Instantiable2[
    /* lo */ Double, 
    /* hi */ Double, 
    typingsJapgolly.googleGax.mod.protobuf.util.LongBits
  ]) & TypeofLongBits = js.native
  
  /** Error subclass indicating a protocol specifc error. */
  var ProtocolError: Instantiable1[
    /* message */ String, 
    typingsJapgolly.googleGax.mod.protobuf.util.ProtocolError[Message[/* import warning: RewrittenClass.unapply cls was tparam T */ Any]]
  ] = js.native
