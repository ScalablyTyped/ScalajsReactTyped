...
import typingsJapgolly.googleGax.mod.fallback.protobufMinimal.Namespace
...
@js.native
trait TypeofNamespaceInstantiable
  extends StObject
  ...
  /**
    ...
    */
  def fromJSON(name: String, json: StringDictionary[Any]): typingsJapgolly.protobufjs.mod.Namespace = js.native
