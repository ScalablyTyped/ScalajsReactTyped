package typingsJapgolly.googleCloudTextToSpeech.buildSrcMod
...
object v1beta1 {
  ...
  @JSImport("@google-cloud/text-to-speech/build/src", "v1beta1.TextToSpeechClient")
  @js.native
  /**
  ...
  open class TextToSpeechClient ()
    extends typingsJapgolly.googleCloudTextToSpeech.buildSrcV1beta1Mod.TextToSpeechClient {
