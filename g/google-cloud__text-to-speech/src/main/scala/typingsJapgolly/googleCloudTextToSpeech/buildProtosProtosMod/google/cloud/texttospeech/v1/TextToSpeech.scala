...
import typingsJapgolly.googleCloudTextToSpeech.buildProtosProtosMod.google.cloud.texttospeech.v1.TextToSpeech.ListVoicesCallback
import typingsJapgolly.googleCloudTextToSpeech.buildProtosProtosMod.google.cloud.texttospeech.v1.TextToSpeech.SynthesizeSpeechCallback
