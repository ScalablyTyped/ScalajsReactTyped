package typingsJapgolly.googleCloudTextToSpeech.buildProtosProtosMod.google.api

import org.scalajs.dom.History
import typingsJapgolly.googleCloudTextToSpeech.buildProtosProtosMod.google.api.ResourceDescriptor.Style
