...
import typingsJapgolly.googleCloudTextToSpeech.googleCloudTextToSpeechStrings.ssml
import typingsJapgolly.googleCloudTextToSpeech.googleCloudTextToSpeechStrings.text
