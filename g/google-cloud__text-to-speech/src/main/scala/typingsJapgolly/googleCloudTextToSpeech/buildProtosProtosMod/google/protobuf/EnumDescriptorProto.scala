...
@JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.protobuf.EnumDescriptorProto")
@js.native
/**
...
object EnumDescriptorProto {
  ...
  @JSImport("@google-cloud/text-to-speech/build/protos/protos", "google.protobuf.EnumDescriptorProto.EnumReservedRange")
  @js.native
  /**
