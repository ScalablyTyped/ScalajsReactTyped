...
import typingsJapgolly.googleCloudTextToSpeech.anon.Typeoffallback
import typingsJapgolly.googleCloudTextToSpeech.anon.Typeofgax
...
import typingsJapgolly.googleGax.mod.PathTemplate
