...
object GridColumn {
  ...
  extension [Self <: GridColumn](x: Self) {
    ...
    inline def setDecimalDigitsUndefined: Self = StObject.set(x, "decimalDigits", js.undefined)
    
    inline def setEditField(value: String): Self = StObject.set(x, "editField", value.asInstanceOf[js.Any])
    ...
    inline def setTmpl(value: String): Self = StObject.set(x, "tmpl", value.asInstanceOf[js.Any])
    
    inline def setTmplUndefined: Self = StObject.set(x, "tmpl", js.undefined)
