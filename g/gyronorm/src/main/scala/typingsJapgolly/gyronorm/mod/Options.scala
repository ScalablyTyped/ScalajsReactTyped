...
object Options {
  ...
  def apply(
    ...
    logger: /* data */ LoggerData => Callback = null,
    ...
    if (logger != null) __obj.updateDynamic("logger")(js.Any.fromFunction1((t0: /* data */ typingsJapgolly.gyronorm.mod.LoggerData) => logger(t0).runNow()))
