...
import typingsJapgolly.googleapisCommon.anon.Fragment
import typingsJapgolly.googleapisCommon.anon.Oauth2
import typingsJapgolly.googleapisCommon.anon.Protocols
import typingsJapgolly.googleapisCommon.anon.Ref
import typingsJapgolly.googleapisCommon.anon.X16
import typingsJapgolly.googleapisCommon.googleapisCommonStrings.int32
...
object buildSrcSchemaMod {
  ...
  */
  ...
  object HttpMethod {
    ...
    inline def GET: typingsJapgolly.googleapisCommon.googleapisCommonStrings.GET = "GET".asInstanceOf[typingsJapgolly.googleapisCommon.googleapisCommonStrings.GET]
    
    inline def PATCH: typingsJapgolly.googleapisCommon.googleapisCommonStrings.PATCH = "PATCH".asInstanceOf[typingsJapgolly.googleapisCommon.googleapisCommonStrings.PATCH]
    
    inline def PUT: typingsJapgolly.googleapisCommon.googleapisCommonStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.googleapisCommon.googleapisCommonStrings.PUT]
  }
  ...
  */
  ...
  object SchemaType {
    ...
    inline def array: typingsJapgolly.googleapisCommon.googleapisCommonStrings.array = "array".asInstanceOf[typingsJapgolly.googleapisCommon.googleapisCommonStrings.array]
    
    inline def boolean: typingsJapgolly.googleapisCommon.googleapisCommonStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.googleapisCommon.googleapisCommonStrings.boolean]
    
    inline def integer: typingsJapgolly.googleapisCommon.googleapisCommonStrings.integer = "integer".asInstanceOf[typingsJapgolly.googleapisCommon.googleapisCommonStrings.integer]
    
    inline def `object`: typingsJapgolly.googleapisCommon.googleapisCommonStrings.`object` = "object".asInstanceOf[typingsJapgolly.googleapisCommon.googleapisCommonStrings.`object`]
    
    inline def string: typingsJapgolly.googleapisCommon.googleapisCommonStrings.string = "string".asInstanceOf[typingsJapgolly.googleapisCommon.googleapisCommonStrings.string]
  }
