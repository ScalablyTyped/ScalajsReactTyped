...
object mod {
  ...
  @js.native
  val gifsicle: PluginFactory[typingsJapgolly.imageminGifsicle.mod.Options] = js.native
  
  @JSImport("gulp-imagemin", "mozjpeg")
  @js.native
  val mozjpeg: PluginFactory[typingsJapgolly.imageminMozjpeg.mod.Options] = js.native
  
  @JSImport("gulp-imagemin", "optipng")
  @js.native
  val optipng: PluginFactory[typingsJapgolly.imageminOptipng.mod.Options] = js.native
  
  @JSImport("gulp-imagemin", "svgo")
  @js.native
  val svgo: PluginFactory[typingsJapgolly.imageminSvgo.mod.Options] = js.native
