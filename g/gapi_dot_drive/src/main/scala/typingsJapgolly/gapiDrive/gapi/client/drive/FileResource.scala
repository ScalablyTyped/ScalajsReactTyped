...
import typingsJapgolly.gapiDrive.AnonAperture
import typingsJapgolly.gapiDrive.AnonCanAddChildren
import typingsJapgolly.gapiDrive.AnonDisplayName
import typingsJapgolly.gapiDrive.AnonDurationMillis
import typingsJapgolly.gapiDrive.AnonHidden
import typingsJapgolly.gapiDrive.AnonImage
import typingsJapgolly.gapiDrive.AnonText
