...
import typingsJapgolly.gapiDrive.anon.Aperture
import typingsJapgolly.gapiDrive.anon.CanAddChildren
import typingsJapgolly.gapiDrive.anon.DisplayName
import typingsJapgolly.gapiDrive.anon.DurationMillis
import typingsJapgolly.gapiDrive.anon.Hidden
import typingsJapgolly.gapiDrive.anon.Image
import typingsJapgolly.gapiDrive.anon.Text
import typingsJapgolly.gapiDrive.gapiDriveStrings.driveNumbersignfile
