...
object buildSrcMessageStreamMod {
  ...
  open class ChannelError protected ()
    ...
    @JSName("metadata")
    var metadata_ChannelError: typingsJapgolly.googleGax.mod.grpc.Metadata = js.native
  ...
  open class StatusError protected ()
    ...
    var metadata: Metadata = js.native
    @JSName("metadata")
    var metadata_StatusError: typingsJapgolly.googleGax.mod.grpc.Metadata = js.native
