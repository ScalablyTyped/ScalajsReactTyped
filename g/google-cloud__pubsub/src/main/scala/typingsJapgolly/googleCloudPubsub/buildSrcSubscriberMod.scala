...
import typingsJapgolly.googleCloudPubsub.buildSrcMessageQueuesMod.BatchOptions
import typingsJapgolly.googleCloudPubsub.buildSrcMessageStreamMod.MessageStreamOptions
...
object buildSrcSubscriberMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.SUCCESS
    - typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.INVALID
    - typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.FAILED_PRECONDITION
    - typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.PERMISSION_DENIED
    - typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.OTHER
  */
  trait AckResponse extends StObject
  object AckResponse {
    
    inline def FAILED_PRECONDITION: typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.FAILED_PRECONDITION = "FAILED_PRECONDITION".asInstanceOf[typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.FAILED_PRECONDITION]
    
    inline def INVALID: typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.INVALID = "INVALID".asInstanceOf[typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.INVALID]
    
    inline def OTHER: typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.OTHER = "OTHER".asInstanceOf[typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.OTHER]
    
    inline def PERMISSION_DENIED: typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.PERMISSION_DENIED = "PERMISSION_DENIED".asInstanceOf[typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.PERMISSION_DENIED]
    
    inline def SUCCESS: typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.SUCCESS = "SUCCESS".asInstanceOf[typingsJapgolly.googleCloudPubsub.googleCloudPubsubStrings.SUCCESS]
  }
