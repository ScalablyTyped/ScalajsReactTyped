...
import typingsJapgolly.googleCloudPubsub.buildSrcPublisherFlowPublisherMod.FlowControlledPublisher
...
import typingsJapgolly.googleCloudPubsub.buildSrcPubsubMod.ObjectStream
import typingsJapgolly.googleCloudPubsub.buildSrcPubsubMod.PageOptions
import typingsJapgolly.googleCloudPubsub.buildSrcPubsubMod.PagedResponse
...
object buildSrcTopicMod {
  ...
  type GetTopicSubscriptionsCallback = RequestCallback[
    Subscription, 
    /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify google.pubsub.v1.IListTopicSubscriptionsResponse */ Any
  ]
  ...
  type TopicMetadata = /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify google.pubsub.v1.ITopic */ Any
