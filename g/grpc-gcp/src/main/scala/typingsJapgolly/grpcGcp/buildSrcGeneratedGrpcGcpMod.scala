...
import typingsJapgolly.grpcGcp.buildSrcGeneratedGrpcGcpMod.grpc.gcp.AffinityConfig.Command
      ...
      object AffinityConfig {
        ...
        object Command extends StObject {
          ...
          sealed trait BIND
            extends StObject
               with Command
          /* 1 */ val BIND: typingsJapgolly.grpcGcp.buildSrcGeneratedGrpcGcpMod.grpc.gcp.AffinityConfig.Command.BIND & Double = js.native
          
          @js.native
          sealed trait BOUND
            extends StObject
               with Command
          /* 0 */ val BOUND: typingsJapgolly.grpcGcp.buildSrcGeneratedGrpcGcpMod.grpc.gcp.AffinityConfig.Command.BOUND & Double = js.native
          
          @js.native
          sealed trait UNBIND
            extends StObject
               with Command
          /* 2 */ val UNBIND: typingsJapgolly.grpcGcp.buildSrcGeneratedGrpcGcpMod.grpc.gcp.AffinityConfig.Command.UNBIND & Double = js.native
        }
