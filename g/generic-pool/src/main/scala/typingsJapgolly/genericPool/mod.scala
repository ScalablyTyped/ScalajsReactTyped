package typingsJapgolly.genericPool
...
object mod {
  ...
  object Factory {
    ...
    inline def apply[T](create: CallbackTo[js.Promise[T]], destroy: T => js.Promise[Unit]): Factory[T] = {
    ...
    extension [Self <: Factory[?], T](x: Self & Factory[T]) {
      ...
      inline def setCreate(value: CallbackTo[js.Promise[T]]): Self = StObject.set(x, "create", value.toJsFn)
