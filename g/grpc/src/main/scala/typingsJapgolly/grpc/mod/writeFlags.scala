...
object writeFlags extends StObject {
  ...
  sealed trait BUFFER_HINT
    extends StObject
       with writeFlags
  /* 1 */ val BUFFER_HINT: typingsJapgolly.grpc.mod.writeFlags.BUFFER_HINT & Double = js.native
  ...
  sealed trait NO_COMPRESS
    extends StObject
       with writeFlags
  /* 0 */ val NO_COMPRESS: typingsJapgolly.grpc.mod.writeFlags.NO_COMPRESS & Double = js.native
}
