...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.graphql.astMod.ExecutableDefinitionNode
  - typingsJapgolly.graphql.astMod.TypeSystemDefinitionNode
  - typingsJapgolly.graphql.astMod.TypeSystemExtensionNode
*/
