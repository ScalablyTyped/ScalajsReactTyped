...
trait AnonDate extends js.Object {
  ...
  var date: js.UndefOr[typingsJapgolly.gapiCalendar.gapi.client.calendar.date] = js.undefined
...
object AnonDate {
  @scala.inline
  def apply(date: date = null, dateTime: datetime = null, timeZone: String = null): AnonDate = {
