...
import typingsJapgolly.gapiClientBigquery.gapi.client.bigquery.TableReference
import typingsJapgolly.gapiClientBigquery.gapi.client.bigquery.TimePartitioning
