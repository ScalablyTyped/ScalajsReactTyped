...
package object entityMod {
  /**
    ...
    */
  type DatastoreKeyPath = js.Array[typingsJapgolly.googleCloudDatastore.entityMod.PathElement]
  ...
  /**
    ...
    */
  type ObjOrPayload[T] = T | typingsJapgolly.googleCloudDatastore.entityMod.DatastorePayload[T]
  type OneOrMany[T] = typingsJapgolly.googleCloudDatastore.entityMod.ObjOrPayload[T] | js.Array[typingsJapgolly.googleCloudDatastore.entityMod.ObjOrPayload[T]]
  type PathElement = java.lang.String | scala.Double | typingsJapgolly.googleCloudDatastore.entityMod.DatastoreInt
}
