package typingsJapgolly.googleCloudDatastore.requestMod

import typingsJapgolly.googleCloudDatastore.entityMod.DatastoreKey
import typingsJapgolly.googleCloudDatastore.entityMod.OneOrMany
import typingsJapgolly.googleCloudDatastore.queryMod.Query
import typingsJapgolly.googleCloudDatastore.queryMod.QueryCallback
import typingsJapgolly.googleCloudDatastore.queryMod.QueryOptions
import typingsJapgolly.googleCloudDatastore.queryMod.QueryResult
