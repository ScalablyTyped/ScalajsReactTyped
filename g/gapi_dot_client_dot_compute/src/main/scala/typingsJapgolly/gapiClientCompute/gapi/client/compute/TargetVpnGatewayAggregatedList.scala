...
trait TargetVpnGatewayAggregatedList extends js.Object {
  /** [Output Only] Unique identifier for the resource; defined by the server. */
  var id: js.UndefOr[String] = js.undefined
  /** A list of TargetVpnGateway resources. */
  var items: js.UndefOr[Record[String, TargetVpnGatewaysScopedList]] = js.undefined
...
object TargetVpnGatewayAggregatedList {
  @scala.inline
  def apply(
    id: String = null,
    items: Record[String, TargetVpnGatewaysScopedList] = null,
    kind: String = null,
    ...
    __obj.asInstanceOf[TargetVpnGatewayAggregatedList]
  }
}
