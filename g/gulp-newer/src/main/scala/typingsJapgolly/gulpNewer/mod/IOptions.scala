package typingsJapgolly.gulpNewer.mod
...
object IOptions {
  @scala.inline
  def apply(dest: String, ext: String = null, map: /* relativePath */ String => CallbackTo[String] = null): IOptions = {
    val __obj = js.Dynamic.literal(dest = dest.asInstanceOf[js.Any])
    if (ext != null) __obj.updateDynamic("ext")(ext.asInstanceOf[js.Any])
    if (map != null) __obj.updateDynamic("map")(js.Any.fromFunction1((t0: /* relativePath */ java.lang.String) => map(t0).runNow()))
