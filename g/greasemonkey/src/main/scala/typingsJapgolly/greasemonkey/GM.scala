...
import typingsJapgolly.greasemonkey.anon.Mimetype
import typingsJapgolly.greasemonkey.anon.Onabort
import typingsJapgolly.greasemonkey.greasemonkeyBooleans.`false`
import typingsJapgolly.greasemonkey.greasemonkeyInts.`1`
import typingsJapgolly.greasemonkey.greasemonkeyInts.`2`
import typingsJapgolly.greasemonkey.greasemonkeyInts.`3`
import typingsJapgolly.greasemonkey.greasemonkeyInts.`4`
...
object GM {
  ...
  object Request {
    ...
    extension [Self <: Request[?], TContext](x: Self & Request[TContext]) {
      ...
      inline def setOnreadystatechange(value: /* response */ Response[TContext] => Callback): Self = StObject.set(x, "onreadystatechange", js.Any.fromFunction1((t0: /* response */ Response[TContext]) => value(t0).runNow()))
      
      inline def setOnreadystatechangeUndefined: Self = StObject.set(x, "onreadystatechange", js.undefined)
      
      inline def setOntimeout(value: /* response */ Response[TContext] => Callback): Self = StObject.set(x, "ontimeout", js.Any.fromFunction1((t0: /* response */ Response[TContext]) => value(t0).runNow()))
