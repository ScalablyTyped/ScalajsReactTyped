...
import typingsJapgolly.greasemonkey.AnonMimetype
import typingsJapgolly.greasemonkey.greasemonkeyStrings.end
import typingsJapgolly.greasemonkey.greasemonkeyStrings.idle
import typingsJapgolly.greasemonkey.greasemonkeyStrings.start
