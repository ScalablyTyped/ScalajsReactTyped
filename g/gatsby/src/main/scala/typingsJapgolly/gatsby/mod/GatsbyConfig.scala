...
import typingsJapgolly.gatsby.AnonOptions
import typingsJapgolly.gatsby.AnonPrefix
...
object GatsbyConfig {
  @scala.inline
  def apply(
    developMiddleware: /* app */ js.Any => Callback = null,
    ...
    if (developMiddleware != null) __obj.updateDynamic("developMiddleware")(js.Any.fromFunction1((t0: /* app */ js.Any) => developMiddleware(t0).runNow()))
