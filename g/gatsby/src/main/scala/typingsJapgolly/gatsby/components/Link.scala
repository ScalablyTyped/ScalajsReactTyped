...
import typingsJapgolly.gatsbyLink.mod.GatsbyLinkProps
import typingsJapgolly.reachRouter.mod.LinkGetProps
import typingsJapgolly.reachRouter.reachRouterStrings.`additions text`
import typingsJapgolly.reachRouter.reachRouterStrings.`inline`
import typingsJapgolly.reachRouter.reachRouterStrings.additions
import typingsJapgolly.reachRouter.reachRouterStrings.all
import typingsJapgolly.reachRouter.reachRouterStrings.ascending
import typingsJapgolly.reachRouter.reachRouterStrings.assertive
import typingsJapgolly.reachRouter.reachRouterStrings.both
import typingsJapgolly.reachRouter.reachRouterStrings.copy
import typingsJapgolly.reachRouter.reachRouterStrings.date
import typingsJapgolly.reachRouter.reachRouterStrings.decimal
import typingsJapgolly.reachRouter.reachRouterStrings.descending
import typingsJapgolly.reachRouter.reachRouterStrings.dialog
import typingsJapgolly.reachRouter.reachRouterStrings.email
import typingsJapgolly.reachRouter.reachRouterStrings.execute
import typingsJapgolly.reachRouter.reachRouterStrings.grammar
import typingsJapgolly.reachRouter.reachRouterStrings.grid
import typingsJapgolly.reachRouter.reachRouterStrings.horizontal
import typingsJapgolly.reachRouter.reachRouterStrings.inherit
import typingsJapgolly.reachRouter.reachRouterStrings.link
import typingsJapgolly.reachRouter.reachRouterStrings.list
import typingsJapgolly.reachRouter.reachRouterStrings.listbox
import typingsJapgolly.reachRouter.reachRouterStrings.location
import typingsJapgolly.reachRouter.reachRouterStrings.menu
import typingsJapgolly.reachRouter.reachRouterStrings.mixed
import typingsJapgolly.reachRouter.reachRouterStrings.move
import typingsJapgolly.reachRouter.reachRouterStrings.no
import typingsJapgolly.reachRouter.reachRouterStrings.none
import typingsJapgolly.reachRouter.reachRouterStrings.numeric
import typingsJapgolly.reachRouter.reachRouterStrings.off
import typingsJapgolly.reachRouter.reachRouterStrings.on
import typingsJapgolly.reachRouter.reachRouterStrings.other
import typingsJapgolly.reachRouter.reachRouterStrings.page
import typingsJapgolly.reachRouter.reachRouterStrings.polite
import typingsJapgolly.reachRouter.reachRouterStrings.popup
import typingsJapgolly.reachRouter.reachRouterStrings.removals
import typingsJapgolly.reachRouter.reachRouterStrings.search
import typingsJapgolly.reachRouter.reachRouterStrings.spelling
import typingsJapgolly.reachRouter.reachRouterStrings.step
import typingsJapgolly.reachRouter.reachRouterStrings.tel
import typingsJapgolly.reachRouter.reachRouterStrings.text
import typingsJapgolly.reachRouter.reachRouterStrings.time
import typingsJapgolly.reachRouter.reachRouterStrings.tree
import typingsJapgolly.reachRouter.reachRouterStrings.url
import typingsJapgolly.reachRouter.reachRouterStrings.vertical
import typingsJapgolly.reachRouter.reachRouterStrings.yes
...
object Link {
  def apply[TState](
    ...
    onClick: /* event */ ReactMouseEventFrom[HTMLAnchorElement] => Callback = null,
    ...
    typingsJapgolly.gatsby.mod.Link[TState], 
    Unit, 
    GatsbyLinkProps[TState]
  ] = {
    ...
    if (getProps != null) __obj.updateDynamic("getProps")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.reachRouter.mod.LinkGetProps) => getProps(t0).runNow()))
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: /* event */ japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLAnchorElement]) => onClick(t0).runNow()))
  ...
  typingsJapgolly.gatsbyLink.mod.GatsbyLinkProps[TState], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.gatsby.mod.Link[TState]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.gatsbyLink.mod.GatsbyLinkProps[TState]])(children: _*)
  }
