...
trait FlexProps extends StObject {
  ...
  var gap: js.UndefOr[UnsignedUpTo12 | typingsJapgolly.gestalt.anon.Column] = js.undefined
...
object FlexProps {
  ...
  extension [Self <: FlexProps](x: Self) {
    ...
    inline def setGap(value: UnsignedUpTo12 | typingsJapgolly.gestalt.anon.Column): Self = StObject.set(x, "gap", value.asInstanceOf[js.Any])
