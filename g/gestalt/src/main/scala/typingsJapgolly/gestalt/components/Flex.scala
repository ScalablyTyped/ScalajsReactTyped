...
import typingsJapgolly.gestalt.mod.FlexProps
...
object Flex {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def gap(value: UnsignedUpTo12 | typingsJapgolly.gestalt.anon.Column): this.type = set("gap", value.asInstanceOf[js.Any])
