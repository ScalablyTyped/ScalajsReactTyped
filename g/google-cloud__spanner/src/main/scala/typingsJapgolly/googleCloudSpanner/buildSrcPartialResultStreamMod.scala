...
import typingsJapgolly.googleCloudSpanner.googleCloudSpannerStrings.data
import typingsJapgolly.googleCloudSpanner.googleCloudSpannerStrings.response
import typingsJapgolly.googleCloudSpanner.googleCloudSpannerStrings.stats
