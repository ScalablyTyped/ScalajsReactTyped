...
import typingsJapgolly.googleCloudSpanner.anon.FnCall
import typingsJapgolly.googleCloudSpanner.anon.TypeofStruct
import typingsJapgolly.protobufjs.mod.common.IListValue
import typingsJapgolly.protobufjs.mod.common.ITimestamp
import typingsJapgolly.protobufjs.mod.common.IValue
...
object buildSrcCodecMod {
  ...
  object codec {
    ...
    @js.native
    def Float: Instantiable1[/* value */ Double, typingsJapgolly.googleCloudSpanner.buildSrcCodecMod.Float] = js.native
    ...
    @js.native
    def Int: Instantiable1[/* value */ String, typingsJapgolly.googleCloudSpanner.buildSrcCodecMod.Int] = js.native
    ...
    @js.native
    def Numeric: Instantiable1[/* value */ String, typingsJapgolly.googleCloudSpanner.buildSrcCodecMod.Numeric] = js.native
    ...
    def PGNumeric: Instantiable1[
        ...
        typingsJapgolly.googleCloudSpanner.buildSrcCodecMod.PGNumeric
      ] = js.native
    ...
    def SpannerDate: Instantiable1[
        ...
        typingsJapgolly.googleCloudSpanner.buildSrcCodecMod.SpannerDate
      ] = js.native
