...
import typingsJapgolly.googleCloudSpanner.anon.TypeofSpanner
import typingsJapgolly.googleCloudSpanner.buildSrcCommonGrpcServiceMod.GrpcService
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.NormalCallback
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.PagedCallback
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.PagedOptions
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.PagedOptionsWithFilter
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.PagedResponse
import typingsJapgolly.googleCloudSpanner.buildSrcDatabaseMod.Database
import typingsJapgolly.googleCloudSpanner.buildSrcInstanceMod.CreateInstanceCallback
import typingsJapgolly.googleCloudSpanner.buildSrcInstanceMod.CreateInstanceResponse
import typingsJapgolly.googleCloudSpanner.buildSrcInstanceMod.Instance
import typingsJapgolly.googleCloudSpanner.buildSrcSessionPoolMod.SessionPoolOptions
import typingsJapgolly.googleCloudSpanner.buildSrcTransactionMod.ExecuteSqlRequest
import typingsJapgolly.googleCloudSpanner.buildSrcTransactionMod.ReadRequest
...
import typingsJapgolly.googleGax.mod.grpc.ChannelCredentials
import typingsJapgolly.node.NodeJS.ReadableStream
import typingsJapgolly.stackTrace.mod.StackFrame
...
object mod {
  ...
  object default {
    ...
    @js.native
    def Spanner: TypeofSpanner & (Instantiable1[
        /* options */ js.UndefOr[SpannerOptions], 
        typingsJapgolly.googleCloudSpanner.mod.Spanner
      ]) = js.native
  ...
  open class PartitionedDml protected ()
    extends typingsJapgolly.googleCloudSpanner.buildSrcTransactionMod.PartitionedDml {
    def this(session: typingsJapgolly.googleCloudSpanner.buildSrcSessionMod.Session) = this()
    def this(
      session: typingsJapgolly.googleCloudSpanner.buildSrcSessionMod.Session,
  ...
  open class Session protected ()
    extends typingsJapgolly.googleCloudSpanner.buildSrcSessionMod.Session {
  ...
  open class SessionPool protected ()
    extends typingsJapgolly.googleCloudSpanner.buildSrcSessionPoolMod.SessionPool {
    /**
      * @constructor
  ...
  open class Snapshot protected ()
    extends typingsJapgolly.googleCloudSpanner.buildSrcTransactionMod.Snapshot {
    /**
      * The transaction ID.
      *
      * @name Snapshot#id
    ...
    /**
      ...
      */
    def this(session: typingsJapgolly.googleCloudSpanner.buildSrcSessionMod.Session) = this()
    def this(session: typingsJapgolly.googleCloudSpanner.buildSrcSessionMod.Session, options: TimestampBounds) = this()
    def this(
      session: typingsJapgolly.googleCloudSpanner.buildSrcSessionMod.Session,
      options: Unit,
  ...
  open class Table protected ()
    extends typingsJapgolly.googleCloudSpanner.buildSrcTableMod.Table {
    def this(database: Database, name: String) = this()
  }
  ...
  open class Transaction protected ()
    extends typingsJapgolly.googleCloudSpanner.buildSrcTransactionMod.Transaction {
    /**
