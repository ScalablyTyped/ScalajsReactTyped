...
import typingsJapgolly.googleCloudCommon.buildSrcServiceObjectMod.GetConfig
import typingsJapgolly.googleCloudSpanner.buildSrcBackupMod.Backup
import typingsJapgolly.googleCloudSpanner.buildSrcBackupMod.CopyBackupCallback
import typingsJapgolly.googleCloudSpanner.buildSrcBackupMod.CopyBackupOptions
import typingsJapgolly.googleCloudSpanner.buildSrcBackupMod.CopyBackupResponse
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.LongRunningCallback
...
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.RequestCallback
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.ResourceCallback
import typingsJapgolly.googleCloudSpanner.buildSrcDatabaseMod.Database
import typingsJapgolly.googleCloudSpanner.buildSrcDatabaseMod.SessionPoolConstructor
import typingsJapgolly.googleCloudSpanner.buildSrcSessionPoolMod.SessionPool
import typingsJapgolly.googleCloudSpanner.buildSrcSessionPoolMod.SessionPoolOptions
import typingsJapgolly.googleCloudSpanner.mod.CreateInstanceRequest
import typingsJapgolly.googleCloudSpanner.mod.RequestConfig
...
object buildSrcInstanceMod {
  ...
  - typingsJapgolly.googleCloudSpanner.buildSrcInstanceMod.GetInstanceMetadataOptions because var conflicts: gaxOptions. Inlined fieldNames */ trait GetInstanceConfig
    extends StObject
       with GetConfig
