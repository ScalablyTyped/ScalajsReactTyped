...
import typingsJapgolly.googleCloudSpanner.buildSrcCommonMod.IOperation
...
import typingsJapgolly.googleCloudSpanner.googleCloudSpannerStrings.state
import typingsJapgolly.googleCloudSpanner.mod.EnumKey
import typingsJapgolly.googleCloudSpanner.mod.RequestConfig
import typingsJapgolly.googleCloudSpanner.mod.TranslateEnumKeys
import typingsJapgolly.googleGax.buildSrcGaxMod.CallOptions
import typingsJapgolly.googleGax.buildSrcGrpcMod.Metadata
import typingsJapgolly.googleGax.mod.Operation_
import typingsJapgolly.protobufjs.mod.common.ITimestamp
