...
object buildSrcBatchTransactionMod {
  ...
  trait TransactionIdentifier extends StObject {
    ...
    var session: String | typingsJapgolly.googleCloudSpanner.mod.Session
  ...
  object TransactionIdentifier {
    ...
    inline def apply(session: String | typingsJapgolly.googleCloudSpanner.mod.Session): TransactionIdentifier = {
    ...
    extension [Self <: TransactionIdentifier](x: Self) {
      ...
      inline def setSession(value: String | typingsJapgolly.googleCloudSpanner.mod.Session): Self = StObject.set(x, "session", value.asInstanceOf[js.Any])
