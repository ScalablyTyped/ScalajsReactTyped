...
object buildSrcSessionPoolMod {
  ...
  open class SessionPool protected () extends SessionPoolInterface {
    ...
    var _acquires: typingsJapgolly.pQueue.mod.default[default, QueueAddOptions] = js.native
    ...
    var _requests: typingsJapgolly.pQueue.mod.default[default, QueueAddOptions] = js.native
