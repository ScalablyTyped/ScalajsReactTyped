...
object process {
  ...
  object GraphTraversalSource {
    ...
    inline def apply[T /* <: GraphTraversal */](
      ...
      tx: CallbackTo[Transaction[GraphTraversalSource[T]]],
    ...
    extension [Self <: GraphTraversalSource[?], T /* <: GraphTraversal */](x: Self & GraphTraversalSource[T]) {
      ...
      inline def setTx(value: CallbackTo[Transaction[GraphTraversalSource[T]]]): Self = StObject.set(x, "tx", value.toJsFn)
  ...
  object Transaction {
    ...
    inline def apply[S /* <: GraphTraversalSource[GraphTraversal] */](
      ...
      commit: CallbackTo[js.Promise[Any]],
      isOpen: Boolean,
      rollback: CallbackTo[js.Promise[Unit]]
    ): Transaction[S] = {
      val __obj = js.Dynamic.literal(begin = begin.toJsFn, close = close.toJsFn, commit = commit.toJsFn, isOpen = isOpen.asInstanceOf[js.Any], rollback = rollback.toJsFn)
      __obj.asInstanceOf[Transaction[S]]
    }
    
    extension [Self <: Transaction[?], S /* <: GraphTraversalSource[GraphTraversal] */](x: Self & Transaction[S]) {
      
      inline def setBegin(value: CallbackTo[S]): Self = StObject.set(x, "begin", value.toJsFn)
      
      inline def setClose(value: CallbackTo[js.Promise[Unit]]): Self = StObject.set(x, "close", value.toJsFn)
      
      inline def setCommit(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "commit", value.toJsFn)
  ...
  object TraversalStrategies {
    ...
    inline def apply(
      addStrategy: TraversalStrategy => Callback,
      applyStrategies: Traversal => js.Promise[Traversal],
      removeStrategy: TraversalStrategy => Any
    ): TraversalStrategies = {
      val __obj = js.Dynamic.literal(addStrategy = js.Any.fromFunction1((t0: TraversalStrategy) => addStrategy(t0).runNow()), applyStrategies = js.Any.fromFunction1(applyStrategies), removeStrategy = js.Any.fromFunction1(removeStrategy))
      __obj.asInstanceOf[TraversalStrategies]
    }
    
    extension [Self <: TraversalStrategies](x: Self) {
      
      inline def setAddStrategy(value: TraversalStrategy => Callback): Self = StObject.set(x, "addStrategy", js.Any.fromFunction1((t0: TraversalStrategy) => value(t0).runNow()))
