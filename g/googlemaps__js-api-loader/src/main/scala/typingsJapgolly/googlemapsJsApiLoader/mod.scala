package typingsJapgolly.googlemapsJsApiLoader

import japgolly.scalajs.react.Callback
import org.scalajs.dom.ErrorEvent
import org.scalajs.dom.Event
import typingsJapgolly.googlemapsJsApiLoader.anon.Typeofgoogle
import typingsJapgolly.googlemapsJsApiLoader.googlemapsJsApiLoaderStrings.drawing
import typingsJapgolly.googlemapsJsApiLoader.googlemapsJsApiLoaderStrings.geometry
import typingsJapgolly.googlemapsJsApiLoader.googlemapsJsApiLoaderStrings.localContext
import typingsJapgolly.googlemapsJsApiLoader.googlemapsJsApiLoaderStrings.origin
import typingsJapgolly.googlemapsJsApiLoader.googlemapsJsApiLoaderStrings.places
import typingsJapgolly.googlemapsJsApiLoader.googlemapsJsApiLoaderStrings.visualization
...
object mod {
  ...
  object LoaderStatus extends StObject {
    ...
    sealed trait FAILURE
      extends StObject
         with LoaderStatus
    /* 3 */ val FAILURE: typingsJapgolly.googlemapsJsApiLoader.mod.LoaderStatus.FAILURE & Double = js.native
    
    @js.native
    sealed trait INITIALIZED
      extends StObject
         with LoaderStatus
    /* 0 */ val INITIALIZED: typingsJapgolly.googlemapsJsApiLoader.mod.LoaderStatus.INITIALIZED & Double = js.native
    
    @js.native
    sealed trait LOADING
      extends StObject
         with LoaderStatus
    /* 1 */ val LOADING: typingsJapgolly.googlemapsJsApiLoader.mod.LoaderStatus.LOADING & Double = js.native
    
    @js.native
    sealed trait SUCCESS
      extends StObject
         with LoaderStatus
    /* 2 */ val SUCCESS: typingsJapgolly.googlemapsJsApiLoader.mod.LoaderStatus.SUCCESS & Double = js.native
  }
  ...
  object global {
    ...
    object Window {
      ...
      inline def apply(__googleMapsCallback: Event => Callback): Window = {
        val __obj = js.Dynamic.literal(__googleMapsCallback = js.Any.fromFunction1((t0: Event) => __googleMapsCallback(t0).runNow()))
        __obj.asInstanceOf[Window]
      }
      
      extension [Self <: Window](x: Self) {
        
        inline def set__googleMapsCallback(value: Event => Callback): Self = StObject.set(x, "__googleMapsCallback", js.Any.fromFunction1((t0: Event) => value(t0).runNow()))
      }
    }
  }
}
