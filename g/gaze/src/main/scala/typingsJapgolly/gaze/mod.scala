...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gaze.gazeStrings.auto
    - typingsJapgolly.gaze.gazeStrings.watch
    - typingsJapgolly.gaze.gazeStrings.poll
  */
  trait Mode extends StObject
  object Mode {
    
    inline def auto: typingsJapgolly.gaze.gazeStrings.auto = "auto".asInstanceOf[typingsJapgolly.gaze.gazeStrings.auto]
    
    inline def poll: typingsJapgolly.gaze.gazeStrings.poll = "poll".asInstanceOf[typingsJapgolly.gaze.gazeStrings.poll]
    
    inline def watch: typingsJapgolly.gaze.gazeStrings.watch = "watch".asInstanceOf[typingsJapgolly.gaze.gazeStrings.watch]
  }
