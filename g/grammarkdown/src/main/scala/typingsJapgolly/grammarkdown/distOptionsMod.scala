...
import typingsJapgolly.grammarkdown.anon.PartialKnownOption
...
object distOptionsMod {
  ...
  object EmitFormat extends StObject {
    ...
    sealed trait ecmarkup
      extends StObject
         with EmitFormat
    /* 2 */ val ecmarkup: typingsJapgolly.grammarkdown.distOptionsMod.EmitFormat.ecmarkup & Double = js.native
    ...
    sealed trait html
      extends StObject
         with EmitFormat
    /* 1 */ val html: typingsJapgolly.grammarkdown.distOptionsMod.EmitFormat.html & Double = js.native
    ...
    sealed trait markdown
      extends StObject
         with EmitFormat
    /* 0 */ val markdown: typingsJapgolly.grammarkdown.distOptionsMod.EmitFormat.markdown & Double = js.native
  }
  ...
  object NewLineKind extends StObject {
    ...
    sealed trait CarriageReturnLineFeed
      extends StObject
         with NewLineKind
    /* 1 */ val CarriageReturnLineFeed: typingsJapgolly.grammarkdown.distOptionsMod.NewLineKind.CarriageReturnLineFeed & Double = js.native
    ...
    sealed trait LineFeed
      extends StObject
         with NewLineKind
    /* 0 */ val LineFeed: typingsJapgolly.grammarkdown.distOptionsMod.NewLineKind.LineFeed & Double = js.native
  }
