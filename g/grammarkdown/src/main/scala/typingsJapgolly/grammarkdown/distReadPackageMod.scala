...
object distReadPackageMod {
  
  @JSImport("grammarkdown/dist/read-package", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def readPackage(packagePath: String, done: js.Function2[/* err */ Any, /* pkg */ js.UndefOr[Package], Unit]): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("readPackage")(packagePath.asInstanceOf[js.Any], done.asInstanceOf[js.Any])).asInstanceOf[Unit]
