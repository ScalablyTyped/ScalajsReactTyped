...
import typingsJapgolly.grammarkdown.anon.Detailed
import typingsJapgolly.grammarkdown.anon.DetailedMessage
import typingsJapgolly.grammarkdown.distLineOffsetMapMod.LineOffsetMap
...
import typingsJapgolly.grammarkdown.distTypesMod.Position
import typingsJapgolly.grammarkdown.distTypesMod.Range
...
object distDiagnosticsMod {
  ...
  @js.native
  open class DiagnosticMessages () extends StObject {
    def this(lineOffsetMap: LineOffsetMap) = this()
    
    /* private */ var compareDiagnostics: Any = js.native
    
    def copyFrom(other: DiagnosticMessages): Unit = js.native
    
    def count(): Double = js.native
    
    /* private */ var deduplicateDiagnostics: Any = js.native
    
    /* private */ var detailedDiagnosticMessages: Any = js.native
    
    /* private */ var diagnostics: Any = js.native
    
    /* private */ var diagnosticsArguments: Any = js.native
    
    /* private */ var diagnosticsLength: Any = js.native
    
    /* private */ var diagnosticsNode: Any = js.native
    
    /* private */ var diagnosticsPos: Any = js.native
    ...
    def getDiagnosticArguments(diagnosticIndex: Double): js.UndefOr[js.Array[Any]] = js.native
    
    /* private */ var getDiagnosticCode: Any = js.native
    
    /* private */ var getDiagnosticErrorLevel: Any = js.native
    ...
    /* private */ var getDiagnosticLength: Any = js.native
    
    def getDiagnosticNode(diagnosticIndex: Double): js.UndefOr[Node[SyntaxKind]] = js.native
    
    /* private */ var getDiagnosticPos: Any = js.native
    ...
    /* private */ var getSortedAndDeduplicatedDiagnosticIndices: Any = js.native
    
    @JSName(js.Symbol.iterator)
    var iterator: js.Function0[Generator[js.UndefOr[DiagnosticInfo], Unit, Any]] = js.native
    
    /* private */ var lineOffsetMap: Any = js.native
    
    def report(pos: Double, message: Diagnostic, args: Any*): Unit = js.native
    
    /* private */ var reportDiagnostic: Any = js.native
    
    def reportNode(sourceFile: Unit, node: Node[SyntaxKind], message: Diagnostic, args: Any*): Unit = js.native
    def reportNode(sourceFile: SourceFile, node: Node[SyntaxKind], message: Diagnostic, args: Any*): Unit = js.native
    
    def setSourceFile(sourceFile: SourceFile): Unit = js.native
    
    /* private */ var simpleDiagnosticMessages: Any = js.native
    
    def size: Double = js.native
    
    /* private */ var sortDiagnostics: Any = js.native
    
    /* private */ var sortedAndDeduplicatedDiagnosticIndices: Any = js.native
    
    /* private */ var sourceFiles: Any = js.native
    
    /* private */ var sourceFilesDiagnosticOffset: Any = js.native
    
    def values(): Generator[js.UndefOr[DiagnosticInfo], Unit, Any] = js.native
  }
  ...
  @js.native
  open class LineMap protected () extends StObject {
    def this(text: String) = this()
    
    /* private */ var computeLineStarts: Any = js.native
  ...
  @js.native
  open class NullDiagnosticMessages () extends DiagnosticMessages {
    def this(lineOffsetMap: LineOffsetMap) = this()
  }
  /* static members */
  ...
  inline def formatString(format: String, args: js.Array[Any]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("formatString")(format.asInstanceOf[js.Any], args.asInstanceOf[js.Any])).asInstanceOf[String]
  ...
  trait DiagnosticInfo extends StObject {
    ...
    var messageArguments: js.UndefOr[js.Array[Any]] = js.undefined
  ...
  object DiagnosticInfo {
    ...
    extension [Self <: DiagnosticInfo](x: Self) {
      ...
      inline def setMessageArguments(value: js.Array[Any]): Self = StObject.set(x, "messageArguments", value.asInstanceOf[js.Any])
      
      inline def setMessageArgumentsUndefined: Self = StObject.set(x, "messageArguments", js.undefined)
      
      inline def setMessageArgumentsVarargs(value: Any*): Self = StObject.set(x, "messageArguments", js.Array(value*))
