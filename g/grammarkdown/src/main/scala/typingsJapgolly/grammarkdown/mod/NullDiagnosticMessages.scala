...
open class NullDiagnosticMessages ()
  extends typingsJapgolly.grammarkdown.distDiagnosticsMod.NullDiagnosticMessages {
  def this(lineOffsetMap: typingsJapgolly.grammarkdown.distLineOffsetMapMod.LineOffsetMap) = this()
}
/* static members */
