...
import typingsJapgolly.grammarkdown.distOptionsMod.EmitFormat
import typingsJapgolly.grammarkdown.distOptionsMod.NewLineKind
import typingsJapgolly.grammarkdown.distOptionsMod.RawArguments
...
object anon {
  ...
  trait Range extends StObject {
    ...
    var range: typingsJapgolly.grammarkdown.distTypesMod.Range
    
    var text: String
  }
  object Range {
    
    inline def apply(range: typingsJapgolly.grammarkdown.distTypesMod.Range, text: String): Range = {
    ...
    extension [Self <: Range](x: Self) {
      ...
      inline def setRange(value: typingsJapgolly.grammarkdown.distTypesMod.Range): Self = StObject.set(x, "range", value.asInstanceOf[js.Any])
