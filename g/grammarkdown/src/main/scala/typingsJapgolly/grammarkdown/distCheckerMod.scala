...
import typingsJapgolly.grammarkdown.distBinderMod.BindingTable
...
import typingsJapgolly.grammarkdown.distNavigatorMod.NodeNavigator
import typingsJapgolly.grammarkdown.distNodesMod.Declaration
...
import typingsJapgolly.grammarkdown.distSymbolsMod.SymbolKind.Parameter
import typingsJapgolly.grammarkdown.distSymbolsMod.SymbolKind.Production
...
object distCheckerMod {
  ...
  open class Resolver protected () extends StObject {
    ...
    /**
      ...
      */
    def getDeclarations(name: String, meaning: Parameter, location: Node[SyntaxKind]): js.Array[typingsJapgolly.grammarkdown.distNodesMod.Parameter] = js.native
    /**
      * Gets the declarations for `name` at the provided `location` that have the given `meaning`.
      */
    def getDeclarations(name: String, meaning: Production, location: Node[SyntaxKind]): js.Array[typingsJapgolly.grammarkdown.distNodesMod.Production] = js.native
    /**
      * Gets the declarations for `name` at the provided `location` that have the given `meaning`.
      */
    def getDeclarations(
      name: String,
      meaning: typingsJapgolly.grammarkdown.distSymbolsMod.SymbolKind.SourceFile,
