...
object distParserMod {
  ...
  object TextChange {
    ...
    inline def clone_(change: TextChange): typingsJapgolly.grammarkdown.anon.Range = ^.asInstanceOf[js.Dynamic].applyDynamic("clone")(change.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.grammarkdown.anon.Range]
    
    inline def create(text: String, range: Range): typingsJapgolly.grammarkdown.anon.Range = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(text.asInstanceOf[js.Any], range.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.grammarkdown.anon.Range]
