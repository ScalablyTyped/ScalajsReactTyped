package typingsJapgolly.gulpUtil

import org.scalablytyped.runtime.Shortcut
import typingsJapgolly.chalk.mod.ChalkInstance
import typingsJapgolly.gulpUtil.anon.File
...
import typingsJapgolly.vinyl.anon.ConstructorOptionscontent
import typingsJapgolly.vinyl.mod.FileConstructor
import typingsJapgolly.vinyl.mod.NullFile
...
object mod {
  ...
  - typingsJapgolly.gulpUtil.mod.PluginErrorOptions because var conflicts: message, name, stack. Inlined fileName, lineNumber, showStack, showProperties, plugin, error */ @JSImport("gulp-util", "PluginError")
  @js.native
