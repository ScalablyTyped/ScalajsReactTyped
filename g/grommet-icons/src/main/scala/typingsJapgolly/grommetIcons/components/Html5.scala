...
object Html5 {
  ...
  @JSImport("grommet-icons/es6", "Html5")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Html5.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
