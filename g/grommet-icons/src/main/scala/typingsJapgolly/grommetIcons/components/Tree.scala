...
object Tree {
  ...
  @JSImport("grommet-icons/es6", "Tree")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Tree.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
