...
object Attraction {
  ...
  @JSImport("grommet-icons/es6", "Attraction")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Attraction.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
