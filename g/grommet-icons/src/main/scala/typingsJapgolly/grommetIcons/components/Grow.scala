...
object Grow {
  ...
  @JSImport("grommet-icons/es6", "Grow")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Grow.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
