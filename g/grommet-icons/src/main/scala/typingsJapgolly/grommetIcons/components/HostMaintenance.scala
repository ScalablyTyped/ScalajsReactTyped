...
object HostMaintenance {
  ...
  @JSImport("grommet-icons/es6", "HostMaintenance")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: HostMaintenance.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
