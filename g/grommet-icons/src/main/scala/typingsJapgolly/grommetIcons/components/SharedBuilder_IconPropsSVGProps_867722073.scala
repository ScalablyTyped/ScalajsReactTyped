...
@scala.inline
open class SharedBuilder_IconPropsSVGProps_867722073[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
     with StBuildingComponent[R] {
  
  inline def a11yTitle(value: String): this.type = set("a11yTitle", value.asInstanceOf[js.Any])
