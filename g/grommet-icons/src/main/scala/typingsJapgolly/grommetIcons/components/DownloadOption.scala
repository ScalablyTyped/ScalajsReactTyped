...
object DownloadOption {
  ...
  @JSImport("grommet-icons/es6", "DownloadOption")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DownloadOption.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
