...
object TextAlignCenter {
  ...
  @JSImport("grommet-icons/es6", "TextAlignCenter")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: TextAlignCenter.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
