...
object Hide {
  ...
  @JSImport("grommet-icons/es6", "Hide")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Hide.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
