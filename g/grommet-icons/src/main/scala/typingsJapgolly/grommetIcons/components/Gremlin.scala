...
object Gremlin {
  ...
  @JSImport("grommet-icons/es6", "Gremlin")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Gremlin.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
