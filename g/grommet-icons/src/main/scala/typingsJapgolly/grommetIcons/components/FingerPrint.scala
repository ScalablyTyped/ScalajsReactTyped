...
object FingerPrint {
  ...
  @JSImport("grommet-icons/es6", "FingerPrint")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: FingerPrint.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
