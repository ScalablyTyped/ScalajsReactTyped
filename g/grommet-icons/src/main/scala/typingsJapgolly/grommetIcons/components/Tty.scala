...
object Tty {
  ...
  @JSImport("grommet-icons/es6", "Tty")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: Tty.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
