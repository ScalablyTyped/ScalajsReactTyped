...
object DocumentPerformance {
  ...
  @JSImport("grommet-icons/es6", "DocumentPerformance")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: DocumentPerformance.type): SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement] = new SharedBuilder_IconPropsSVGProps_867722073[SVGSVGElement](js.Array(this.component, js.Dictionary.empty))()
