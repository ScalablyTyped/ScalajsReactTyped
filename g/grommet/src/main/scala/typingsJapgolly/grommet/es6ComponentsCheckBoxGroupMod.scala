...
import typingsJapgolly.grommet.es6ComponentsCheckBoxMod.CheckBoxProps
import typingsJapgolly.react.mod.FC
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object es6ComponentsCheckBoxGroupMod {
  ...
  object CheckBoxGroupProps {
    ...
    extension [Self <: CheckBoxGroupProps](x: Self) {
      ...
      inline def setOnChange(value: /* event */ js.UndefOr[OnChangeEvent] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* event */ js.UndefOr[OnChangeEvent]) => value(t0).runNow()))
  ...
  /* import warning: RemoveDifficultInheritance.summarizeChanges 
  - Dropped {[ P in std.Exclude<keyof grommet.grommet/es6/components/CheckBox.CheckBoxProps & react.react.DetailedHTMLProps<react.react.InputHTMLAttributes<std.HTMLInputElement>, std.HTMLInputElement>, 'checked'> ]: grommet.grommet/es6/components/CheckBox.CheckBoxProps & react.react.DetailedHTMLProps<react.react.InputHTMLAttributes<std.HTMLInputElement>, std.HTMLInputElement>[P]} */ trait CheckBoxType
    extends StObject
