...
import typingsJapgolly.grommet.es6ComponentsDataTableMod.ColumnSizeType
...
import typingsJapgolly.grommet.es6ComponentsDiagramMod._DiagramAnimationType
import typingsJapgolly.grommet.es6ComponentsGridMod._GridSizeType
...
import typingsJapgolly.grommet.es6ComponentsListMod._SizeType
...
import typingsJapgolly.grommet.es6ContextsAnnounceContextMod.AnnounceMode
import typingsJapgolly.grommet.es6ThemesBaseMod._DigitalTexts
...
import typingsJapgolly.grommet.es6UtilsMod._AlignContentType
import typingsJapgolly.grommet.es6UtilsMod._AlignType
import typingsJapgolly.grommet.es6UtilsMod._BasisType
import typingsJapgolly.grommet.es6UtilsMod._BoxSizeType
import typingsJapgolly.grommet.es6UtilsMod._EdgeType
import typingsJapgolly.grommet.es6UtilsMod._ElevationType
import typingsJapgolly.grommet.es6UtilsMod._FillType
import typingsJapgolly.grommet.es6UtilsMod._GapType
import typingsJapgolly.grommet.es6UtilsMod._HeightType
import typingsJapgolly.grommet.es6UtilsMod._HoverIndicatorType
import typingsJapgolly.grommet.es6UtilsMod._OpacityType
import typingsJapgolly.grommet.es6UtilsMod._PolymorphicType
import typingsJapgolly.grommet.es6UtilsMod._RoundType
import typingsJapgolly.grommet.es6UtilsMod._TShirtSizeType
import typingsJapgolly.grommet.es6UtilsMod._ThicknessType
...
object grommetStrings {
  ...
  inline def Africa: Africa = "Africa".asInstanceOf[Africa]
  
  @js.native
  sealed trait Asia extends StObject
  inline def Asia: Asia = "Asia".asInstanceOf[Asia]
  ...
  inline def `North America`: `North America` = ("North America").asInstanceOf[`North America`]
  ...
  inline def analog: analog = "analog".asInstanceOf[analog]
  ...
  sealed trait rectilinear
    extends StObject
       with DiagramConnectionType
  inline def rectilinear: rectilinear = "rectilinear".asInstanceOf[rectilinear]
  ...
  inline def rotateLeft: rotateLeft = "rotateLeft".asInstanceOf[rotateLeft]
