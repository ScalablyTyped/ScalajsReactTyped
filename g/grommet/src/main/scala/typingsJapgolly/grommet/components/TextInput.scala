...
object TextInput {
  def apply(
    ...
    typingsJapgolly.grommet.mod.TextInput, 
    Unit, 
    TextInputProps with (Omit[
      DetailedHTMLProps[InputHTMLAttributes[HTMLInputElement], HTMLInputElement], 
      onSelect | size | placeholder
  ...
  typingsJapgolly.grommet.textInputMod.TextInputProps with (typingsJapgolly.grommet.utilsMod.Omit[
    ...
    typingsJapgolly.grommet.grommetStrings.onSelect | typingsJapgolly.grommet.grommetStrings.size | typingsJapgolly.grommet.grommetStrings.placeholder
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.TextInput](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.textInputMod.TextInputProps with (typingsJapgolly.grommet.utilsMod.Omit[
  typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement], 
    org.scalajs.dom.raw.HTMLInputElement
  ], 
  typingsJapgolly.grommet.grommetStrings.onSelect | typingsJapgolly.grommet.grommetStrings.size | typingsJapgolly.grommet.grommetStrings.placeholder])])(children: _*)
  }
