...
import typingsJapgolly.grommet.checkBoxMod.CheckBoxProps
...
object CheckBox {
  ...
  typingsJapgolly.grommet.checkBoxMod.CheckBoxProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  ...
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLInputElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.checkBoxMod.CheckBoxProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement], 
