...
object MaskedInput {
  def apply(
    ...
    typingsJapgolly.grommet.mod.MaskedInput, 
    Unit, 
    MaskedInputProps with (Omit[
      DetailedHTMLProps[InputHTMLAttributes[HTMLInputElement], HTMLInputElement], 
      id | mask | name | plain | size | value
  ...
  typingsJapgolly.grommet.maskedInputMod.MaskedInputProps with (typingsJapgolly.std.Omit[
    ...
    typingsJapgolly.grommet.grommetStrings.id | typingsJapgolly.grommet.grommetStrings.mask | typingsJapgolly.grommet.grommetStrings.name | typingsJapgolly.grommet.grommetStrings.plain | typingsJapgolly.grommet.grommetStrings.size | typingsJapgolly.grommet.grommetStrings.value
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.MaskedInput](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.maskedInputMod.MaskedInputProps with (typingsJapgolly.std.Omit[
  typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement], 
    org.scalajs.dom.raw.HTMLInputElement
  ], 
  typingsJapgolly.grommet.grommetStrings.id | typingsJapgolly.grommet.grommetStrings.mask | typingsJapgolly.grommet.grommetStrings.name | typingsJapgolly.grommet.grommetStrings.plain | typingsJapgolly.grommet.grommetStrings.size | typingsJapgolly.grommet.grommetStrings.value])])(children: _*)
  }
