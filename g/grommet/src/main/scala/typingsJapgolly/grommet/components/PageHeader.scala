...
object PageHeader {
  ...
  @JSImport("grommet/es6", "PageHeader")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def gridProps(value: GridProps): this.type = set("gridProps", value.asInstanceOf[js.Any])
    ...
    inline def parent(value: VdomElement): this.type = set("parent", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def subtitle(value: String | Element): this.type = set("subtitle", value.asInstanceOf[js.Any])
  ...
  def withProps(p: PageHeaderExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
