...
object Stack {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def guidingChild(value: Double | first | last): this.type = set("guidingChild", value.asInstanceOf[js.Any])
    ...
    inline def interactiveChild(value: Double | first | last): this.type = set("interactiveChild", value.asInstanceOf[js.Any])
  ...
  def withProps(p: StackExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
