...
import typingsJapgolly.grommet.rangeInputMod.RangeInputProps
...
object RangeInput {
  ...
  typingsJapgolly.grommet.rangeInputMod.RangeInputProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  ...
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLInputElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.rangeInputMod.RangeInputProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement], 
  org.scalajs.dom.raw.HTMLInputElement])])(children: _*)
  }
