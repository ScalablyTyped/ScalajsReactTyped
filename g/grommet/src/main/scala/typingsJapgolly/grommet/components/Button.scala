...
object Button {
  ...
  typingsJapgolly.grommet.buttonMod.ButtonProps with (typingsJapgolly.grommet.utilsMod.Omit[
  ...
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLButtonElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.buttonMod.ButtonProps with (typingsJapgolly.grommet.utilsMod.Omit[
  typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.ButtonHTMLAttributes[org.scalajs.dom.raw.HTMLButtonElement], 
    org.scalajs.dom.raw.HTMLButtonElement
  ], 
