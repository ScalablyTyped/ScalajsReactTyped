...
import typingsJapgolly.grommet.collapsibleMod.CollapsibleProps
...
object Collapsible {
  def apply(
    ...
    dir: String = null,
    direction: typingsJapgolly.grommet.grommetStrings.horizontal | typingsJapgolly.grommet.grommetStrings.vertical = null,
    ...
    typingsJapgolly.grommet.mod.Collapsible, 
    Unit, 
    CollapsibleProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
  ] = {
  ...
  typingsJapgolly.grommet.collapsibleMod.CollapsibleProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
    org.scalajs.dom.raw.HTMLDivElement
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.Collapsible](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.collapsibleMod.CollapsibleProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
