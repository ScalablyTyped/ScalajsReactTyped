...
import typingsJapgolly.grommet.es6ComponentsPageMod.PageExtendedProps
...
object Page {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def kind(value: wide | narrow | full | String): this.type = set("kind", value.asInstanceOf[js.Any])
  ...
  def withProps(p: PageExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
