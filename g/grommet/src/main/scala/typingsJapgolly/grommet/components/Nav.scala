...
object Nav {
  ...
  implicit def make(companion: Nav.type): SharedBuilder_BoxExtendedProps1736190285 = new SharedBuilder_BoxExtendedProps1736190285(js.Array(this.component, js.Dictionary.empty))()
