...
object DropButton {
  def apply(
    ...
    typingsJapgolly.grommet.mod.DropButton, 
    Unit, 
    DropButtonProps with ButtonProps with (Omit[
      DetailedHTMLProps[ButtonHTMLAttributes[HTMLButtonElement], HTMLButtonElement], 
      color
  ...
  typingsJapgolly.grommet.dropButtonMod.DropButtonProps with typingsJapgolly.grommet.buttonMod.ButtonProps with (typingsJapgolly.grommet.utilsMod.Omit[
  ...
  typingsJapgolly.grommet.mod.DropButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.dropButtonMod.DropButtonProps with typingsJapgolly.grommet.buttonMod.ButtonProps with (typingsJapgolly.grommet.utilsMod.Omit[
  typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.ButtonHTMLAttributes[org.scalajs.dom.raw.HTMLButtonElement], 
    org.scalajs.dom.raw.HTMLButtonElement
  ], 
