...
object Spinner {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def message(value: String | Start): this.type = set("message", value.asInstanceOf[js.Any])
  ...
  def withProps(p: SpinnerExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
