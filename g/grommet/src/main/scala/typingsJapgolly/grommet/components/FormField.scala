...
object FormField {
  def apply(
    ...
    typingsJapgolly.grommet.mod.FormField, 
    Unit, 
    FormFieldProps with (Omit[
      DetailedHTMLProps[InputHTMLAttributes[HTMLInputElement], HTMLInputElement], 
      placeholder
  ...
  typingsJapgolly.grommet.formFieldMod.FormFieldProps with (typingsJapgolly.grommet.utilsMod.Omit[
    ...
    typingsJapgolly.grommet.grommetStrings.placeholder
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.FormField](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.formFieldMod.FormFieldProps with (typingsJapgolly.grommet.utilsMod.Omit[
  typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement], 
    org.scalajs.dom.raw.HTMLInputElement
  ], 
  typingsJapgolly.grommet.grommetStrings.placeholder])])(children: _*)
  }
