...
object Anchor {
  ...
  typingsJapgolly.grommet.anchorMod.AnchorProps with (typingsJapgolly.grommet.utilsMod.Omit[
    typingsJapgolly.react.mod.DetailedHTMLProps[
      typingsJapgolly.react.mod.AnchorHTMLAttributes[org.scalajs.dom.raw.HTMLAnchorElement], 
      org.scalajs.dom.raw.HTMLAnchorElement
    ], 
    typingsJapgolly.grommet.grommetStrings.color
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLAnchorElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.anchorMod.AnchorProps with (typingsJapgolly.grommet.utilsMod.Omit[
  typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.AnchorHTMLAttributes[org.scalajs.dom.raw.HTMLAnchorElement], 
    org.scalajs.dom.raw.HTMLAnchorElement
  ], 
