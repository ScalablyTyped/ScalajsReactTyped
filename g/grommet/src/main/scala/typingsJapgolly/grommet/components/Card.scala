...
object Card {
  ...
  implicit def make(companion: Card.type): SharedBuilder_BoxTypes_1312507900[HTMLDivElement] = new SharedBuilder_BoxTypes_1312507900[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
