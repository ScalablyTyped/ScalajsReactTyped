...
import typingsJapgolly.grommet.es6ComponentsFormMod.FormExtendedEvent
...
object Form {
  ...
  inline def apply[T](): Builder[T] = {
    ...
    new Builder[T](js.Array(this.component, __props.asInstanceOf[TypedFormProps[T]]))
  }
  ...
  open class Builder[T] (val args: js.Array[Any])
    ...
    inline def errors(value: js.Object): this.type = set("errors", value.asInstanceOf[js.Any])
    
    inline def hidden(value: Boolean): this.type = set("hidden", value.asInstanceOf[js.Any])
    
    inline def id(value: String): this.type = set("id", value.asInstanceOf[js.Any])
    
    inline def infos(value: js.Object): this.type = set("infos", value.asInstanceOf[js.Any])
    ...
    inline def messages(value: Invalid): this.type = set("messages", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: (T, /* options */ Touched) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: T, t1: /* options */ Touched) => (value(t0, t1)).runNow()))
    ...
    inline def onReset(value: /* event */ ReactEventFrom[Element] => Any): this.type = set("onReset", js.Any.fromFunction1(value))
    ...
    inline def onSubmit(value: /* event */ FormExtendedEvent[T, Element] => Callback): this.type = set("onSubmit", js.Any.fromFunction1((t0: /* event */ FormExtendedEvent[T, Element]) => value(t0).runNow()))
    ...
    inline def onValidate(value: /* validationResults */ Errors => Callback): this.type = set("onValidate", js.Any.fromFunction1((t0: /* validationResults */ Errors) => value(t0).runNow()))
    ...
    inline def validate(value: blur | submit | change): this.type = set("validate", value.asInstanceOf[js.Any])
  ...
  def withProps[T](p: TypedFormProps[T]): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
