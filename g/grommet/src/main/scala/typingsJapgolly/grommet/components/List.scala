...
object List {
  def apply(
    ...
    typingsJapgolly.grommet.mod.List, 
    Unit, 
    ListProps with (DetailedHTMLProps[HTMLAttributes[HTMLUListElement], HTMLUListElement])
  ] = {
  ...
  typingsJapgolly.grommet.listMod.ListProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLUListElement], 
    org.scalajs.dom.raw.HTMLUListElement
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.List](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.listMod.ListProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLUListElement], 
  org.scalajs.dom.raw.HTMLUListElement])])(children: _*)
  }
