...
import typingsJapgolly.grommet.es6ComponentsCheckBoxGroupMod.CheckBoxType
import typingsJapgolly.grommet.es6ComponentsCheckBoxGroupMod.OnChangeEvent
...
object CheckBoxGroup {
  ...
  inline def apply(options: js.Array[CheckBoxType | String]): Builder = {
    val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[CheckBoxGroupExtendedProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def defaultValue(value: js.Array[Double | String]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    
    inline def defaultValueVarargs(value: (Double | String)*): this.type = set("defaultValue", js.Array(value*))
    ...
    inline def onChange(value: /* event */ js.UndefOr[OnChangeEvent] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* event */ js.UndefOr[OnChangeEvent]) => value(t0).runNow()))
  ...
  def withProps(p: CheckBoxGroupExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
