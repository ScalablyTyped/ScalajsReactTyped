...
import typingsJapgolly.grommet.calendarMod.CalendarProps
...
object Calendar {
  def apply(
    ...
    typingsJapgolly.grommet.mod.Calendar, 
    Unit, 
    CalendarProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
  ] = {
  ...
  typingsJapgolly.grommet.calendarMod.CalendarProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
    org.scalajs.dom.raw.HTMLDivElement
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.Calendar](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.calendarMod.CalendarProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
