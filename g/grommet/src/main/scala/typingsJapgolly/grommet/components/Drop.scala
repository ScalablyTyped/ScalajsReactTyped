...
object Drop {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def align(value: Bottom): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def onClickOutside(value: ReactMouseEventFrom[HTMLDocument & Element] => Callback): this.type = set("onClickOutside", js.Any.fromFunction1((t0: ReactMouseEventFrom[HTMLDocument & Element]) => value(t0).runNow()))
    ...
    inline def restrictFocus(value: Boolean): this.type = set("restrictFocus", value.asInstanceOf[js.Any])
    ...
    inline def stretch(value: Boolean | align): this.type = set("stretch", value.asInstanceOf[js.Any])
  ...
  def withProps(p: DropExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
