...
object Drop {
  def apply(
    ...
    typingsJapgolly.grommet.mod.Drop, 
    Unit, 
    DropProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
  ] = {
  ...
  typingsJapgolly.grommet.dropMod.DropProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
    org.scalajs.dom.raw.HTMLDivElement
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.Drop](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.dropMod.DropProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
