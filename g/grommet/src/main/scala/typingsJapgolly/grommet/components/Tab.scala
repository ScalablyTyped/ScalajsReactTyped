...
object Tab {
  def apply(
    ...
    typingsJapgolly.grommet.mod.Tab, 
    Unit, 
    TabProps with (Omit[
      DetailedHTMLProps[ButtonHTMLAttributes[HTMLButtonElement], HTMLButtonElement], 
      title
  ...
  typingsJapgolly.grommet.tabMod.TabProps with (typingsJapgolly.grommet.utilsMod.Omit[
  ...
  typingsJapgolly.grommet.mod.Tab](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.tabMod.TabProps with (typingsJapgolly.grommet.utilsMod.Omit[
  typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.ButtonHTMLAttributes[org.scalajs.dom.raw.HTMLButtonElement], 
    org.scalajs.dom.raw.HTMLButtonElement
  ], 
  typingsJapgolly.grommet.grommetStrings.title])])(children: _*)
  }
