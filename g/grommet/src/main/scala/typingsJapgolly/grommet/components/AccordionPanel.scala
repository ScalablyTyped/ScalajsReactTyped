...
object AccordionPanel {
  def apply(
    ...
    typingsJapgolly.grommet.mod.AccordionPanel, 
    Unit, 
    AccordionPanelProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
  ] = {
  ...
  typingsJapgolly.grommet.accordionPanelMod.AccordionPanelProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
    org.scalajs.dom.raw.HTMLDivElement
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.AccordionPanel](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.accordionPanelMod.AccordionPanelProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
