...
object RadioButton {
  def apply(
    ...
    typingsJapgolly.grommet.mod.RadioButton, 
    Unit, 
    RadioButtonProps with (DetailedHTMLProps[InputHTMLAttributes[HTMLInputElement], HTMLInputElement])
  ] = {
  ...
  typingsJapgolly.grommet.radioButtonMod.RadioButtonProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  ...
  typingsJapgolly.grommet.mod.RadioButton](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.radioButtonMod.RadioButtonProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.InputHTMLAttributes[org.scalajs.dom.raw.HTMLInputElement], 
