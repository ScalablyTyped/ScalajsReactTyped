...
import typingsJapgolly.grommet.distributionMod.DistributionProps
...
object Distribution {
  def apply(
    ...
    typingsJapgolly.grommet.mod.Distribution, 
    Unit, 
    DistributionProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
  ] = {
  ...
  typingsJapgolly.grommet.distributionMod.DistributionProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
    org.scalajs.dom.raw.HTMLDivElement
  ]), 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.grommet.mod.Distribution](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.distributionMod.DistributionProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
  org.scalajs.dom.raw.HTMLDivElement])])
  }
