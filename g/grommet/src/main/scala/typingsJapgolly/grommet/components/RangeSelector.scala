...
object RangeSelector {
  ...
  inline def apply(values: js.Array[Double]): Builder = {
    val __props = js.Dynamic.literal(values = values.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[RangeSelectorProps & (Omit[DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement], color])]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def direction(
      value: typingsJapgolly.grommet.grommetStrings.horizontal | typingsJapgolly.grommet.grommetStrings.vertical
    ...
    inline def messages(value: Lower): this.type = set("messages", value.asInstanceOf[js.Any])
    ...
    inline def opacity(value: weak | medium | strong | String | Boolean): this.type = set("opacity", value.asInstanceOf[js.Any])
    ...
    inline def round(value: xsmall | small | medium | large | full | String): this.type = set("round", value.asInstanceOf[js.Any])
    
    inline def security(value: String): this.type = set("security", value.asInstanceOf[js.Any])
    
    inline def size(value: xxsmall | xsmall | small | medium | large | xlarge | full | String): this.type = set("size", value.asInstanceOf[js.Any])
  ...
  def withProps(
    p: RangeSelectorProps & (Omit[DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement], color])
