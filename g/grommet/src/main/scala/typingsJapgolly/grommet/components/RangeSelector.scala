...
object RangeSelector {
  def apply(
    ...
    typingsJapgolly.grommet.mod.RangeSelector, 
    Unit, 
    RangeSelectorProps with (Omit[DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement], color])
  ] = {
  ...
  typingsJapgolly.grommet.rangeSelectorMod.RangeSelectorProps with (typingsJapgolly.grommet.utilsMod.Omit[
  ...
  typingsJapgolly.grommet.mod.RangeSelector](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.rangeSelectorMod.RangeSelectorProps with (typingsJapgolly.grommet.utilsMod.Omit[
  typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
    org.scalajs.dom.raw.HTMLDivElement
  ], 
