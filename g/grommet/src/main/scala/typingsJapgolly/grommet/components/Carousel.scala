...
object Carousel {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def activeChild(value: Double): this.type = set("activeChild", value.asInstanceOf[js.Any])
    ...
    inline def controls(value: Boolean | arrows | selectors): this.type = set("controls", value.asInstanceOf[js.Any])
    ...
    inline def initialChild(value: Double): this.type = set("initialChild", value.asInstanceOf[js.Any])
    ...
    inline def onChild(value: /* repeated */ Any => Callback): this.type = set("onChild", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
    ...
    inline def play(value: Double): this.type = set("play", value.asInstanceOf[js.Any])
  ...
  def withProps(p: CarouselExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
