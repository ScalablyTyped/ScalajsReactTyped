...
import typingsJapgolly.grommet.tableFooterMod.TableFooterProps
...
object TableFooter {
  ...
  typingsJapgolly.grommet.tableFooterMod.TableFooterProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  ...
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLTableSectionElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.tableFooterMod.TableFooterProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLTableSectionElement], 
