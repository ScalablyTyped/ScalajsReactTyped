...
object Accordion {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onActive(value: /* activeIndexes */ js.Array[Double] => Callback): this.type = set("onActive", js.Any.fromFunction1((t0: /* activeIndexes */ js.Array[Double]) => value(t0).runNow()))
  ...
  def withProps(p: AccordionExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
