...
import typingsJapgolly.grommet.accordionMod.AccordionProps
...
object Accordion {
  ...
  typingsJapgolly.grommet.accordionMod.AccordionProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  ...
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.accordionMod.AccordionProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
