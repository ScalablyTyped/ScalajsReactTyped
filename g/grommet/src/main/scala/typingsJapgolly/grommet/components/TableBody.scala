...
import typingsJapgolly.grommet.tableBodyMod.TableBodyProps
...
object TableBody {
  ...
  typingsJapgolly.grommet.tableBodyMod.TableBodyProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  ...
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLTableSectionElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.tableBodyMod.TableBodyProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLTableSectionElement], 
