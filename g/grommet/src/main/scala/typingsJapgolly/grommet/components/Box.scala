...
object Box {
  ...
  typingsJapgolly.grommet.boxMod.BoxProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  ...
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLDivElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.boxMod.BoxProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
