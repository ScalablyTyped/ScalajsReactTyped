...
object Layer {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def animation(value: none | slide | fadeIn | Boolean): this.type = set("animation", value.asInstanceOf[js.Any])
    
    inline def `aria-activedescendant`(value: String): this.type = set("aria-activedescendant", value.asInstanceOf[js.Any])
    
    inline def `aria-atomic`(value: Booleanish): this.type = set("aria-atomic", value.asInstanceOf[js.Any])
    
    inline def `aria-autocomplete`(value: typingsJapgolly.react.reactStrings.none | `inline` | list | both): this.type = set("aria-autocomplete", value.asInstanceOf[js.Any])
    ...
    inline def `aria-dropeffect`(value: typingsJapgolly.react.reactStrings.none | copy | execute | link | move | popup): this.type = set("aria-dropeffect", value.asInstanceOf[js.Any])
    ...
    inline def `aria-sort`(value: typingsJapgolly.react.reactStrings.none | ascending | descending | other): this.type = set("aria-sort", value.asInstanceOf[js.Any])
    ...
    inline def full(
      value: Boolean | typingsJapgolly.grommet.grommetStrings.vertical | typingsJapgolly.grommet.grommetStrings.horizontal
    ...
    inline def inputMode(
      value: typingsJapgolly.react.reactStrings.none | text | tel | url | email | numeric | decimal | search
    ...
    inline def position(value: LayerPositionType): this.type = set("position", value.asInstanceOf[js.Any])
    ...
    inline def target(value: js.Object): this.type = set("target", value.asInstanceOf[js.Any])
  ...
  def withProps(p: LayerExtendedProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
