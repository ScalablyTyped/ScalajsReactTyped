...
object Layer {
  def apply(
    ...
    full: Boolean | typingsJapgolly.grommet.grommetStrings.vertical | typingsJapgolly.grommet.grommetStrings.horizontal = null,
    ...
    typingsJapgolly.grommet.mod.Layer, 
    Unit, 
    LayerProps with (DetailedHTMLProps[HTMLAttributes[HTMLDivElement], HTMLDivElement])
  ] = {
  ...
  typingsJapgolly.grommet.layerMod.LayerProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
    org.scalajs.dom.raw.HTMLDivElement
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.grommet.mod.Layer](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.layerMod.LayerProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
  org.scalajs.dom.raw.HTMLDivElement])])(children: _*)
  }
