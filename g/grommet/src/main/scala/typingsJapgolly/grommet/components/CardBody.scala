...
object CardBody {
  ...
  @JSImport("grommet/es6", "CardBody")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CardBody.type): SharedBuilder_BoxTypes_1312507900[HTMLDivElement] = new SharedBuilder_BoxTypes_1312507900[HTMLDivElement](js.Array(this.component, js.Dictionary.empty))()
