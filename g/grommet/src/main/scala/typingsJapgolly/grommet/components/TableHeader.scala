...
import typingsJapgolly.grommet.tableHeaderMod.TableHeaderProps
...
object TableHeader {
  ...
  typingsJapgolly.grommet.tableHeaderMod.TableHeaderProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLTableSectionElement], 
    org.scalajs.dom.raw.HTMLTableSectionElement
  ]), 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLTableSectionElement]](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.grommet.tableHeaderMod.TableHeaderProps with (typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLTableSectionElement], 
  org.scalajs.dom.raw.HTMLTableSectionElement])])(children: _*)
  }
