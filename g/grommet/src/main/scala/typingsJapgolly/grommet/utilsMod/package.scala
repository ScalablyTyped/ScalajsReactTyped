...
package object utilsMod {
  ...
  type BackgroundType = java.lang.String | typingsJapgolly.grommet.AnonImage
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type BasisType = typingsJapgolly.grommet.utilsMod._BasisType | java.lang.String
  /* Rewritten from type alias, can be one of: 
    - scala.Boolean
    - typingsJapgolly.grommet.utilsMod.BoxSideType
    - typingsJapgolly.grommet.AnonStyle
    - js.Array[typingsJapgolly.grommet.AnonSizeStyle]
  */
  type BorderType = typingsJapgolly.grommet.utilsMod._BorderType | js.Array[typingsJapgolly.grommet.AnonSizeStyle] | scala.Boolean
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grommet.grommetStrings.xsmall
    - typingsJapgolly.grommet.grommetStrings.small
    - typingsJapgolly.grommet.grommetStrings.medium
    ...
    - java.lang.String
  */
  type BoxSizeType = typingsJapgolly.grommet.utilsMod._BoxSizeType | java.lang.String
  type ColorType = js.UndefOr[java.lang.String | typingsJapgolly.grommet.AnonLight]
  type DeepFreeze_ = js.Function1[/* obj */ js.Object, typingsJapgolly.grommet.utilsMod.DeepReadonly[js.Object]]
  ...
  {readonly [ K in keyof T ]: T[K] extends object? / * import warning: SimplifyRecursiveTypeAlias.enterTsTypeRef rewrittenOpt applyOrElse Simplified recursive type alias grommet.grommet/utils.DeepReadonly<T[K]> * / object : T[K]}
    */ typingsJapgolly.grommet.grommetStrings.DeepReadonly with js.Any
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ElevationType = typingsJapgolly.grommet.utilsMod._ElevationType | java.lang.String
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grommet.grommetStrings.horizontal
    - typingsJapgolly.grommet.grommetStrings.vertical
    - scala.Boolean
  */
  type FillType = typingsJapgolly.grommet.utilsMod._FillType | scala.Boolean
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grommet.grommetStrings.none
    - typingsJapgolly.grommet.grommetStrings.xxsmall
    - typingsJapgolly.grommet.grommetStrings.xsmall
    ...
    - java.lang.String
  */
  type GapType = typingsJapgolly.grommet.utilsMod._GapType | java.lang.String
  type GraphColorsType = js.Array[java.lang.String] | typingsJapgolly.grommet.AnonDarkArray
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.grommet.grommetStrings.large
    - typingsJapgolly.grommet.grommetStrings.xlarge
    - typingsJapgolly.grommet.AnonBottom
    - java.lang.String
  */
  type MarginType = typingsJapgolly.grommet.utilsMod._MarginType | java.lang.String
  ...
  {[ K in keyof T ]:? grommet.grommet/utils.NonUndefined<T[K]>}
    */ typingsJapgolly.grommet.grommetStrings.NonUndefinedProps with T
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - scala.Double
  */
  type OpacityType = typingsJapgolly.grommet.utilsMod._OpacityType | java.lang.String | scala.Double
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.grommet.grommetStrings.none
    - typingsJapgolly.grommet.grommetStrings.xxsmall
    - typingsJapgolly.grommet.grommetStrings.xsmall
    ...
    - java.lang.String
  */
  type PadType = typingsJapgolly.grommet.utilsMod._PadType | java.lang.String
  type PlaceHolderType = java.lang.String | japgolly.scalajs.react.raw.React.Element | japgolly.scalajs.react.raw.React.Node
  /* Rewritten from type alias, can be one of: 
  ...
  */
  type PolymorphicType = typingsJapgolly.grommet.utilsMod._PolymorphicType | typingsJapgolly.react.mod.ComponentType[js.Any]
}
