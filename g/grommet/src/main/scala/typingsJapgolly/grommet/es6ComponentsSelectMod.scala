...
object es6ComponentsSelectMod {
  ...
  trait BasicSelectProps extends StObject {
    ...
    var emptySearchMessage: js.UndefOr[String | Node] = js.undefined
    
    var focusIndicator: js.UndefOr[Boolean] = js.undefined
    
    var gridArea: js.UndefOr[GridAreaType] = js.undefined
    
    var icon: js.UndefOr[Boolean | (js.Function1[/* repeated */ Any, Any]) | Node | FC[js.Object]] = js.undefined
    
    var id: js.UndefOr[String] = js.undefined
    
    var labelKey: js.UndefOr[String | (js.Function1[/* repeated */ Any, String | Node])] = js.undefined
    ...
    var valueLabel: js.UndefOr[Node | (js.Function1[/* repeated */ Any, String | Node])] = js.undefined
  }
  object BasicSelectProps {
    ...
    extension [Self <: BasicSelectProps](x: Self) {
      ...
      inline def setEmptySearchMessage(value: String | Node): Self = StObject.set(x, "emptySearchMessage", value.asInstanceOf[js.Any])
      
      inline def setEmptySearchMessageNull: Self = StObject.set(x, "emptySearchMessage", null)
      
      inline def setEmptySearchMessageUndefined: Self = StObject.set(x, "emptySearchMessage", js.undefined)
      
      inline def setEmptySearchMessageVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "emptySearchMessage", js.Array(value*))
      
      inline def setEmptySearchMessageVdomElement(value: VdomElement): Self = StObject.set(x, "emptySearchMessage", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setIcon(value: Boolean | (js.Function1[/* repeated */ Any, Any]) | Node | FC[js.Object]): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      ...
      inline def setLabelKey(value: String | (js.Function1[/* repeated */ Any, String | Node])): Self = StObject.set(x, "labelKey", value.asInstanceOf[js.Any])
      
      inline def setLabelKeyFunction1(value: /* repeated */ Any => String | Node): Self = StObject.set(x, "labelKey", js.Any.fromFunction1(value))
      ...
      inline def setValueLabel(value: Node | (js.Function1[/* repeated */ Any, String | Node])): Self = StObject.set(x, "valueLabel", value.asInstanceOf[js.Any])
      
      inline def setValueLabelFunction1(value: /* repeated */ Any => String | Node): Self = StObject.set(x, "valueLabel", js.Any.fromFunction1(value))
      ...
      inline def setValueLabelVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "valueLabel", js.Array(value*))
      
      inline def setValueLabelVdomElement(value: VdomElement): Self = StObject.set(x, "valueLabel", value.rawElement.asInstanceOf[js.Any])
    }
  }
