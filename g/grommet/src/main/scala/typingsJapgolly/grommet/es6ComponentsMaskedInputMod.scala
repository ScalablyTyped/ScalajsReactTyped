...
object es6ComponentsMaskedInputMod {
  ...
  trait MaskedInputProps extends StObject {
    ...
    var onBlur: js.UndefOr[js.Function1[/* event */ ReactFocusEventFrom[org.scalajs.dom.Element], Any]] = js.undefined
  ...
  object MaskedInputProps {
    ...
    extension [Self <: MaskedInputProps](x: Self) {
      ...
      inline def setOnBlur(value: /* event */ ReactFocusEventFrom[org.scalajs.dom.Element] => Any): Self = StObject.set(x, "onBlur", js.Any.fromFunction1(value))
