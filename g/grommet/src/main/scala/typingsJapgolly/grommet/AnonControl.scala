...
trait AnonControl extends js.Object {
  ...
  var searchInput: js.UndefOr[Element] = js.undefined
...
object AnonControl {
  ...
  def apply(
    ...
    if (searchInput != null) __obj.updateDynamic("searchInput")(searchInput.rawElement.asInstanceOf[js.Any])
