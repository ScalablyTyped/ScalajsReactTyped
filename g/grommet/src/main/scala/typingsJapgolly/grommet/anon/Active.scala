...
trait Active extends StObject {
  ...
  var colors: js.UndefOr[typingsJapgolly.grommet.es6ThemesBaseMod.Colors] = js.undefined
...
object Active {
  ...
  extension [Self <: Active](x: Self) {
    ...
    inline def setColors(value: typingsJapgolly.grommet.es6ThemesBaseMod.Colors): Self = StObject.set(x, "colors", value.asInstanceOf[js.Any])
