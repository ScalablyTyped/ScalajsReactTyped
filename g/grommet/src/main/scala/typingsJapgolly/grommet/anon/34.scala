...
object `34` {
  ...
  extension [Self <: `34`](x: Self) {
    ...
    inline def set1(value: FontLarge): Self = StObject.set(x, "1", value.asInstanceOf[js.Any])
    
    inline def set1Undefined: Self = StObject.set(x, "1", js.undefined)
    
    inline def set2(value: FontLarge): Self = StObject.set(x, "2", value.asInstanceOf[js.Any])
    
    inline def set2Undefined: Self = StObject.set(x, "2", js.undefined)
    
    inline def set3(value: FontLarge): Self = StObject.set(x, "3", value.asInstanceOf[js.Any])
    
    inline def set3Undefined: Self = StObject.set(x, "3", js.undefined)
    
    inline def set4(value: FontLarge): Self = StObject.set(x, "4", value.asInstanceOf[js.Any])
    
    inline def set4Undefined: Self = StObject.set(x, "4", js.undefined)
    
    inline def set5(value: FontLarge): Self = StObject.set(x, "5", value.asInstanceOf[js.Any])
    
    inline def set5Undefined: Self = StObject.set(x, "5", js.undefined)
    
    inline def set6(value: FontLarge): Self = StObject.set(x, "6", value.asInstanceOf[js.Any])
