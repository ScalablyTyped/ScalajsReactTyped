...
object global {
  ...
  open class DOMMatrix ()
    extends StObject
       with typingsJapgolly.geometryDom.GeometryDom.DOMMatrix {
  ...
  open class DOMMatrixReadOnly protected ()
    extends StObject
       with typingsJapgolly.geometryDom.GeometryDom.DOMMatrixReadOnly {
  ...
  open class DOMPoint ()
    extends StObject
       with typingsJapgolly.geometryDom.GeometryDom.DOMPoint {
  ...
  open class DOMPointReadOnly protected ()
    extends StObject
       with typingsJapgolly.geometryDom.GeometryDom.DOMPointReadOnly {
    def this(x: Double, y: Double, z: Double, w: Double) = this()
  ...
  open class DOMQuad ()
    extends StObject
       with typingsJapgolly.geometryDom.GeometryDom.DOMQuad {
    ...
    /**
      ...
      */
    /* CompleteClass */
    var bounds: typingsJapgolly.geometryDom.GeometryDom.DOMRectReadOnly = js.native
    
    /**
      * a DOMPoint that represents p1 of the quadrilateral
      */
    /* CompleteClass */
    var p1: typingsJapgolly.geometryDom.GeometryDom.DOMPoint = js.native
    
    /**
      * a DOMPoint that represents p2 of the quadrilateral
      */
    /* CompleteClass */
    var p2: typingsJapgolly.geometryDom.GeometryDom.DOMPoint = js.native
    
    /**
      * a DOMPoint that represents p3 of the quadrilateral
      */
    /* CompleteClass */
    var p3: typingsJapgolly.geometryDom.GeometryDom.DOMPoint = js.native
    
    /**
      * a DOMPoint that represents p4 of the quadrilateral
      */
    /* CompleteClass */
    var p4: typingsJapgolly.geometryDom.GeometryDom.DOMPoint = js.native
  }
  ...
  open class DOMRect protected ()
    extends StObject
       with typingsJapgolly.geometryDom.GeometryDom.DOMRect {
  ...
  open class DOMRectReadOnly protected ()
    extends StObject
       with typingsJapgolly.geometryDom.GeometryDom.DOMRectReadOnly {
    def this(x: Double, y: Double, width: Double, height: Double) = this()
