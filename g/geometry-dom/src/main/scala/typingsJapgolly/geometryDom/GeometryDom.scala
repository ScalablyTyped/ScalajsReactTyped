...
object GeometryDom {
  ...
  object DOMRectList {
    ...
    inline def apply(item: Double => DOMRect, length: Double): typingsJapgolly.geometryDom.GeometryDom.DOMRectList = {
      val __obj = js.Dynamic.literal(item = js.Any.fromFunction1(item), length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.geometryDom.GeometryDom.DOMRectList]
    }
    
    extension [Self <: typingsJapgolly.geometryDom.GeometryDom.DOMRectList](x: Self) {
