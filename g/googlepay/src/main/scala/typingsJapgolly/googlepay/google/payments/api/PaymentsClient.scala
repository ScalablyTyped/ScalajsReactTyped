...
object PaymentsClient {
  ...
  inline def apply(
    ...
    prefetchPaymentData: PaymentDataRequest => Callback
  ): PaymentsClient = {
    val __obj = js.Dynamic.literal(createButton = js.Any.fromFunction1(createButton), isReadyToPay = js.Any.fromFunction1(isReadyToPay), loadPaymentData = js.Any.fromFunction1(loadPaymentData), prefetchPaymentData = js.Any.fromFunction1((t0: PaymentDataRequest) => prefetchPaymentData(t0).runNow()))
  ...
  extension [Self <: PaymentsClient](x: Self) {
    ...
    inline def setPrefetchPaymentData(value: PaymentDataRequest => Callback): Self = StObject.set(x, "prefetchPaymentData", js.Any.fromFunction1((t0: PaymentDataRequest) => value(t0).runNow()))
  }
}
