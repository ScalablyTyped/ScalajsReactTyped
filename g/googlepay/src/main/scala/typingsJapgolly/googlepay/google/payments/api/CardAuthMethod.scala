...
object CardAuthMethod {
  ...
  inline def CRYPTOGRAM_3DS: typingsJapgolly.googlepay.googlepayStrings.CRYPTOGRAM_3DS = "CRYPTOGRAM_3DS".asInstanceOf[typingsJapgolly.googlepay.googlepayStrings.CRYPTOGRAM_3DS]
  
  inline def PAN_ONLY: typingsJapgolly.googlepay.googlepayStrings.PAN_ONLY = "PAN_ONLY".asInstanceOf[typingsJapgolly.googlepay.googlepayStrings.PAN_ONLY]
}
