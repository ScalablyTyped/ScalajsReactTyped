...
object ZoneRecord {
  ...
  inline def apply(rrset_name: String, rrset_ttl: Double, rrset_type: String, rrset_values: js.Array[String]): ZoneRecord = {
  ...
  extension [Self <: ZoneRecord](x: Self) {
    ...
    inline def setRrset_ttl(value: Double): Self = StObject.set(x, "rrset_ttl", value.asInstanceOf[js.Any])
    
    inline def setRrset_type(value: String): Self = StObject.set(x, "rrset_type", value.asInstanceOf[js.Any])
