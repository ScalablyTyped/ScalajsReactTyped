...
trait AnonBackgroundImageUrl extends js.Object {
  /**
    ...
    */
  var backgroundImageUrl: AnonDefault
  /**
  ...
  /**
    ...
    */
  var largeBrandedBannerImageImapScript: AnonDefault
  /**
    * The URL for the 854px by 70px image that appears below the video player in the expanded video view of the video watch page.
    */
  var largeBrandedBannerImageUrl: AnonDefault
  /**
    ...
    */
  var smallBrandedBannerImageImapScript: AnonDefault
  /**
    * The URL for the 640px by 70px banner image that appears below the video player in the default view of the video watch page.
    */
  var smallBrandedBannerImageUrl: AnonDefault
  /**
...
object AnonBackgroundImageUrl {
  @scala.inline
  def apply(
    backgroundImageUrl: AnonDefault,
    ...
    largeBrandedBannerImageImapScript: AnonDefault,
    largeBrandedBannerImageUrl: AnonDefault,
    smallBrandedBannerImageImapScript: AnonDefault,
    smallBrandedBannerImageUrl: AnonDefault,
    trackingImageUrl: String,
    watchIconImageUrl: String
  ): AnonBackgroundImageUrl = {
    ...
    __obj.asInstanceOf[AnonBackgroundImageUrl]
  }
}
