...
import typingsJapgolly.gliderJs.anon.Next
import typingsJapgolly.gliderJs.anon.Prev
import typingsJapgolly.gliderJs.anon.Scroll
import typingsJapgolly.gliderJs.anon.Slide
import typingsJapgolly.gliderJs.anon.Type
import typingsJapgolly.gliderJs.gliderJsBooleans.`false`
import typingsJapgolly.gliderJs.gliderJsStrings.`glider-add`
import typingsJapgolly.gliderJs.gliderJsStrings.`glider-animated`
import typingsJapgolly.gliderJs.gliderJsStrings.`glider-destroy`
import typingsJapgolly.gliderJs.gliderJsStrings.`glider-loaded`
import typingsJapgolly.gliderJs.gliderJsStrings.`glider-refresh`
import typingsJapgolly.gliderJs.gliderJsStrings.`glider-remove`
import typingsJapgolly.gliderJs.gliderJsStrings.`glider-slide-hidden`
import typingsJapgolly.gliderJs.gliderJsStrings.`glider-slide-visible`
import typingsJapgolly.gliderJs.gliderJsStrings.auto
import typingsJapgolly.gliderJs.gliderJsStrings.next
import typingsJapgolly.gliderJs.gliderJsStrings.prev
import typingsJapgolly.gliderJs.mod.global.HTMLDivElement
...
object mod {
  ...
  trait Glider[T /* <: HTMLElement */] extends StObject {
    ...
    var slides: HTMLCollection[Any] = js.native
