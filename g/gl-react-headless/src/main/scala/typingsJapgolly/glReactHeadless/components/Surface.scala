...
object Surface {
  ...
  ): UnmountedWithRoot[SurfaceProps, typingsJapgolly.glReactHeadless.mod.Surface, Unit, SurfaceProps] = {
  ...
  typingsJapgolly.glReactHeadless.mod.Surface](this.componentImport)
