...
import typingsJapgolly.grasp.anon.Args
...
object mod {
  ...
  */
  ...
  object QueryEngineType {
    ...
    inline def equery: typingsJapgolly.grasp.graspStrings.equery = "equery".asInstanceOf[typingsJapgolly.grasp.graspStrings.equery]
    
    inline def squery: typingsJapgolly.grasp.graspStrings.squery = "squery".asInstanceOf[typingsJapgolly.grasp.graspStrings.squery]
  }
