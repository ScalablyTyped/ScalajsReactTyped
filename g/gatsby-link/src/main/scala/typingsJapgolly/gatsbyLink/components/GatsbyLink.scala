package typingsJapgolly.gatsbyLink.components
...
import typingsJapgolly.gatsbyLink.mod.default
...
object GatsbyLink {
  def apply[TState](
    ...
    children: ChildArg*
  ): UnmountedWithRoot[GatsbyLinkProps[TState], default[TState], Unit, GatsbyLinkProps[TState]] = {
  ...
  typingsJapgolly.gatsbyLink.mod.default[TState]](this.componentImport)
