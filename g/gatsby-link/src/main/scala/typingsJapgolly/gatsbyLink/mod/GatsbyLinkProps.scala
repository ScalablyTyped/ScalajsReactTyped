package typingsJapgolly.gatsbyLink.mod
...
trait GatsbyLinkProps[TState] extends LinkProps[TState] {
  ...
  @JSName("onClick")
  var onClick_GatsbyLinkProps: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLAnchorElement], Unit]] = js.undefined
