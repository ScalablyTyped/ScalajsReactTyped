...
import typingsJapgolly.gatsbyTransformerRemark.anon.Absolute
import typingsJapgolly.gatsbyTransformerRemark.gatsbyTransformerRemarkStrings.`gatsby-transformer-remark`
