package typingsJapgolly.geolib.typesMod
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.geolib.AnonAlt
  - typingsJapgolly.geolib.AnonAltitudeGeolibAltitudeInputValue
  - typingsJapgolly.geolib.AnonElevation
  - typingsJapgolly.geolib.AnonElev
*/
