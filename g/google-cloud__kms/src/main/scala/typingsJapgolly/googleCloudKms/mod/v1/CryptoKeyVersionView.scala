...
object CryptoKeyVersionView extends StObject {
  ...
  /* 0 */ val CRYPTO_KEY_VERSION_VIEW_UNSPECIFIED: typingsJapgolly.googleCloudKms.mod.v1.CryptoKeyVersionView.CRYPTO_KEY_VERSION_VIEW_UNSPECIFIED & Double = js.native
  ...
  sealed trait FULL
    extends StObject
       with CryptoKeyVersionView
  /* 1 */ val FULL: typingsJapgolly.googleCloudKms.mod.v1.CryptoKeyVersionView.FULL & Double = js.native
}
