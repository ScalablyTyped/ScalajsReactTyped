...
object CryptoKeyVersionState extends StObject {
  ...
  /* 0 */ val CRYPTO_KEY_VERSION_STATE_UNSPECIFIED: typingsJapgolly.googleCloudKms.mod.v1.CryptoKeyVersionState.CRYPTO_KEY_VERSION_STATE_UNSPECIFIED & Double = js.native
  ...
  sealed trait DESTROYED
    extends StObject
       with CryptoKeyVersionState
  /* 3 */ val DESTROYED: typingsJapgolly.googleCloudKms.mod.v1.CryptoKeyVersionState.DESTROYED & Double = js.native
  ...
  sealed trait DESTROY_SCHEDULED
    extends StObject
       with CryptoKeyVersionState
  /* 4 */ val DESTROY_SCHEDULED: typingsJapgolly.googleCloudKms.mod.v1.CryptoKeyVersionState.DESTROY_SCHEDULED & Double = js.native
  ...
  sealed trait DISABLED
    extends StObject
       with CryptoKeyVersionState
  /* 2 */ val DISABLED: typingsJapgolly.googleCloudKms.mod.v1.CryptoKeyVersionState.DISABLED & Double = js.native
  ...
  sealed trait ENABLED
    extends StObject
       with CryptoKeyVersionState
  /* 1 */ val ENABLED: typingsJapgolly.googleCloudKms.mod.v1.CryptoKeyVersionState.ENABLED & Double = js.native
  ...
  sealed trait PENDING_GENERATION
    extends StObject
       with CryptoKeyVersionState
  /* 5 */ val PENDING_GENERATION: typingsJapgolly.googleCloudKms.mod.v1.CryptoKeyVersionState.PENDING_GENERATION & Double = js.native
}
