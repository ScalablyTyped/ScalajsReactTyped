package typingsJapgolly.generateChangelog.mod
...
object Options {
  ...
  def apply(
    ...
    if (!js.isUndefined(major)) __obj.updateDynamic("major")(major.asInstanceOf[js.Any])
    if (!js.isUndefined(minor)) __obj.updateDynamic("minor")(minor.asInstanceOf[js.Any])
