...
import typingsJapgolly.gapiAuth2.anon.Apppackagename
import typingsJapgolly.gapiAuth2.gapi.auth2.AuthorizeConfig
import typingsJapgolly.gapiAuth2.gapi.auth2.AuthorizeResponse
import typingsJapgolly.gapiAuth2.gapi.auth2.ClientConfig
  ...
  object gapi {
    ...
    object auth2 {
      ...
      open class GoogleAuth ()
        extends StObject
           with typingsJapgolly.gapiAuth2.gapi.auth2.GoogleAuth
      
      @JSGlobal("gapi.auth2.GoogleAuthBase")
      @js.native
      open class GoogleAuthBase ()
        extends StObject
           with typingsJapgolly.gapiAuth2.gapi.auth2.GoogleAuthBase
      
      @JSGlobal("gapi.auth2.SigninOptionsBuilder")
      @js.native
      open class SigninOptionsBuilder ()
        extends StObject
           with typingsJapgolly.gapiAuth2.gapi.auth2.SigninOptionsBuilder {
      ...
      /**
        ...
        */
      inline def getAuthInstance(): typingsJapgolly.gapiAuth2.gapi.auth2.GoogleAuth = ^.asInstanceOf[js.Dynamic].applyDynamic("getAuthInstance")().asInstanceOf[typingsJapgolly.gapiAuth2.gapi.auth2.GoogleAuth]
      ...
      /**
        ...
        */
      inline def init(params: ClientConfig): typingsJapgolly.gapiAuth2.gapi.auth2.GoogleAuth = ^.asInstanceOf[js.Dynamic].applyDynamic("init")(params.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.gapiAuth2.gapi.auth2.GoogleAuth]
    }
