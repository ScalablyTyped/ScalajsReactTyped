...
object anon {
  ...
  object Apppackagename {
    ...
    extension [Self <: Apppackagename](x: Self) {
      ...
      inline def setOnfailure(value: /* reason */ Error => Callback): Self = StObject.set(x, "onfailure", js.Any.fromFunction1((t0: /* reason */ Error) => value(t0).runNow()))
      
      inline def setOnfailureUndefined: Self = StObject.set(x, "onfailure", js.undefined)
      
      inline def setOnsuccess(value: /* user */ GoogleUser => Callback): Self = StObject.set(x, "onsuccess", js.Any.fromFunction1((t0: /* user */ GoogleUser) => value(t0).runNow()))
