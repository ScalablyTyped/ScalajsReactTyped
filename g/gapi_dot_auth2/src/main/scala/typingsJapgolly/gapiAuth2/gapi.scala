package typingsJapgolly.gapiAuth2

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.gapiAuth2.anon.Code
import typingsJapgolly.gapiAuth2.anon.Details
import typingsJapgolly.gapiAuth2.gapiAuth2Strings.consent
import typingsJapgolly.gapiAuth2.gapiAuth2Strings.popup
import typingsJapgolly.gapiAuth2.gapiAuth2Strings.redirect
import typingsJapgolly.gapiAuth2.gapiAuth2Strings.select_account
  ...
  object auth2 {
    ...
    object BasicProfile {
      ...
      inline def apply(
        ...
        val __obj = js.Dynamic.literal(getEmail = getEmail.toJsFn, getFamilyName = getFamilyName.toJsFn, getGivenName = getGivenName.toJsFn, getId = getId.toJsFn, getImageUrl = getImageUrl.toJsFn, getName = getName.toJsFn)
      ...
      extension [Self <: BasicProfile](x: Self) {
        ...
        inline def setGetFamilyName(value: CallbackTo[String]): Self = StObject.set(x, "getFamilyName", value.toJsFn)
        
        inline def setGetGivenName(value: CallbackTo[String]): Self = StObject.set(x, "getGivenName", value.toJsFn)
    ...
    object CurrentUser {
      ...
      inline def apply(get: CallbackTo[GoogleUser], listen: js.Function1[/* user */ GoogleUser, Any] => Callback): CurrentUser = {
        val __obj = js.Dynamic.literal(get = get.toJsFn, listen = js.Any.fromFunction1((t0: js.Function1[/* user */ GoogleUser, Any]) => listen(t0).runNow()))
        __obj.asInstanceOf[CurrentUser]
      }
      
      extension [Self <: CurrentUser](x: Self) {
        
        inline def setGet(value: CallbackTo[GoogleUser]): Self = StObject.set(x, "get", value.toJsFn)
        
        inline def setListen(value: js.Function1[/* user */ GoogleUser, Any] => Callback): Self = StObject.set(x, "listen", js.Any.fromFunction1((t0: js.Function1[/* user */ GoogleUser, Any]) => value(t0).runNow()))
      }
    }
    ...
    object IsSignedIn {
      ...
      inline def apply(get: CallbackTo[Boolean], listen: js.Function1[/* signedIn */ Boolean, Any] => Callback): IsSignedIn = {
        val __obj = js.Dynamic.literal(get = get.toJsFn, listen = js.Any.fromFunction1((t0: js.Function1[/* signedIn */ Boolean, Any]) => listen(t0).runNow()))
        __obj.asInstanceOf[IsSignedIn]
      }
      
      extension [Self <: IsSignedIn](x: Self) {
        
        inline def setGet(value: CallbackTo[Boolean]): Self = StObject.set(x, "get", value.toJsFn)
        
        inline def setListen(value: js.Function1[/* signedIn */ Boolean, Any] => Callback): Self = StObject.set(x, "listen", js.Any.fromFunction1((t0: js.Function1[/* signedIn */ Boolean, Any]) => value(t0).runNow()))
      }
    }
