...
import typingsJapgolly.gapiAuth2.gapi.auth2.GoogleUser
...
object AnonApppackagename {
  ...
  def apply(
    ...
    onfailure: /* reason */ AnonError => Callback = null,
    onsuccess: /* user */ GoogleUser => Callback = null,
    scope: String = null,
    theme: String = null,
    ...
    if (onfailure != null) __obj.updateDynamic("onfailure")(js.Any.fromFunction1((t0: /* reason */ typingsJapgolly.gapiAuth2.AnonError) => onfailure(t0).runNow()))
    if (onsuccess != null) __obj.updateDynamic("onsuccess")(js.Any.fromFunction1((t0: /* user */ typingsJapgolly.gapiAuth2.gapi.auth2.GoogleUser) => onsuccess(t0).runNow()))
