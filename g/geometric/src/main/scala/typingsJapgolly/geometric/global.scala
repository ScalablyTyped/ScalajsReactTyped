package typingsJapgolly.geometric

import typingsJapgolly.geometric.mod.Line
import typingsJapgolly.geometric.mod.LineInterpolator
import typingsJapgolly.geometric.mod.Point
import typingsJapgolly.geometric.mod.Polygon
