...
import typingsJapgolly.googleVisualization.google.visualization.ChartStrokeOpacity
import typingsJapgolly.googleVisualization.google.visualization.ChartTextStyle
