package typingsJapgolly.googleVisualization.global.google

import typingsJapgolly.googleVisualization.global.google.^
import typingsJapgolly.googleVisualization.google.LoadOptions
...
inline def load_visualization(
  visualization: typingsJapgolly.googleVisualization.googleVisualizationStrings.visualization,
  version: String,
  options: LoadOptions
