...
import typingsJapgolly.googleVisualization.google.visualization.NumberFormatOptions
...
open class NumberFormat ()
  extends StObject
     with typingsJapgolly.googleVisualization.google.visualization.NumberFormat {
