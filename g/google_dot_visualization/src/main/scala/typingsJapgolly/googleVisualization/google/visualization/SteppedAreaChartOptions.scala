...
object SteppedAreaChartOptions {
  ...
  inline def apply(): SteppedAreaChartOptions = {
  ...
  extension [Self <: SteppedAreaChartOptions](x: Self) {
    ...
    inline def setConnectSteps(value: Boolean): Self = StObject.set(x, "connectSteps", value.asInstanceOf[js.Any])
    
    inline def setConnectStepsUndefined: Self = StObject.set(x, "connectSteps", js.undefined)
