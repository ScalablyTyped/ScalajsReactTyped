...
object GulpSassOptions {
  ...
  def apply(
    ...
    onSuccess: /* css */ String => CallbackTo[js.Any] = null,
    outFile: String = null,
    ...
    if (onSuccess != null) __obj.updateDynamic("onSuccess")(js.Any.fromFunction1((t0: /* css */ java.lang.String) => onSuccess(t0).runNow()))
