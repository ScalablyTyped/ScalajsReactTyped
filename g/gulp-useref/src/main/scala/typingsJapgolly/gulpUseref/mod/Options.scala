package typingsJapgolly.gulpUseref.mod
...
object Options {
  ...
  def apply(
    ...
    transformPath: /* filePath */ String => Callback = null
  ): Options = {
    ...
    if (transformPath != null) __obj.updateDynamic("transformPath")(js.Any.fromFunction1((t0: /* filePath */ java.lang.String) => transformPath(t0).runNow()))
