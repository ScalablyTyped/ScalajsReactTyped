...
import typingsJapgolly.googleGax.buildSrcFallbackMod.GrpcClient
...
object buildSrcLocationServiceMod {
  ...
  open class LocationsClient protected () extends StObject {
    ...
    /**
      ...
      */
    def this(gaxGrpc: typingsJapgolly.googleGax.buildSrcGrpcMod.GrpcClient, opts: ClientOptions) = this()
    ...
    var gaxGrpc: typingsJapgolly.googleGax.buildSrcGrpcMod.GrpcClient | GrpcClient = js.native
