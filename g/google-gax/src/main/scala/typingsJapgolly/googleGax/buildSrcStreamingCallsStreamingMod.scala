...
import typingsJapgolly.googleGax.buildSrcGaxMod.RetryRequestOptions
import typingsJapgolly.googleGax.googleGaxBooleans.`false`
...
object buildSrcStreamingCallsStreamingMod {
  ...
  object StreamType extends StObject {
    ...
    sealed trait BIDI_STREAMING
      extends StObject
         with StreamType
    /* 3 */ val BIDI_STREAMING: typingsJapgolly.googleGax.buildSrcStreamingCallsStreamingMod.StreamType.BIDI_STREAMING & Double = js.native
    ...
    sealed trait CLIENT_STREAMING
      extends StObject
         with StreamType
    /* 2 */ val CLIENT_STREAMING: typingsJapgolly.googleGax.buildSrcStreamingCallsStreamingMod.StreamType.CLIENT_STREAMING & Double = js.native
    ...
    sealed trait SERVER_STREAMING
      extends StObject
         with StreamType
    /* 1 */ val SERVER_STREAMING: typingsJapgolly.googleGax.buildSrcStreamingCallsStreamingMod.StreamType.SERVER_STREAMING & Double = js.native
  }
