...
import typingsJapgolly.googleGax.anon.TypeofCallCredentials
import typingsJapgolly.googleGax.anon.TypeofChannelCredentials
import typingsJapgolly.googleGax.anon.TypeofMessage
import typingsJapgolly.googleGax.anon.TypeofMetadata
import typingsJapgolly.googleGax.anon.TypeofServerCredentials
import typingsJapgolly.googleGax.anon.Typeofcredentials
import typingsJapgolly.googleGax.anon.Typeofexperimental
...
import typingsJapgolly.grpcProtoLoader.buildSrcUtilMod.Options
...
object buildSrcGrpcMod {
  ...
  open class GrpcClient () extends StObject {
    ...
    /**
      ...
      */
    def _getCredentials(opts: ClientStubOptions): js.Promise[typingsJapgolly.grpcGrpcJs.mod.ChannelCredentials] = js.native
    ...
    def metadataBuilder(headers: OutgoingHttpHeaders): js.Function2[
        ...
        typingsJapgolly.grpcGrpcJs.mod.Metadata
      ] = js.native
  }
  /* static members */
  object GrpcClient {
  ...
  trait ClientStubOptions
    ...
    var sslCreds: js.UndefOr[typingsJapgolly.grpcGrpcJs.mod.ChannelCredentials] = js.undefined
  }
  object ClientStubOptions {
    ...
    extension [Self <: ClientStubOptions](x: Self) {
      ...
      inline def setSslCreds(value: typingsJapgolly.grpcGrpcJs.mod.ChannelCredentials): Self = StObject.set(x, "sslCreds", value.asInstanceOf[js.Any])
  ...
  trait GrpcModule extends StObject {
    ...
    def closeClient(client: typingsJapgolly.grpcGrpcJs.buildSrcClientMod.Client): Unit = js.native
    ...
    def getClientChannel(client: typingsJapgolly.grpcGrpcJs.buildSrcClientMod.Client): Channel = js.native
