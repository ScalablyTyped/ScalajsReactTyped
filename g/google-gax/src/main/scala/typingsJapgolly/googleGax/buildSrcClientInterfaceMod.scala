...
import typingsJapgolly.googleGax.buildSrcDescriptorMod.BundleDescriptor
import typingsJapgolly.googleGax.buildSrcDescriptorMod.LongrunningDescriptor
import typingsJapgolly.googleGax.buildSrcDescriptorMod.PageDescriptor
import typingsJapgolly.googleGax.buildSrcDescriptorMod.StreamDescriptor
...
object buildSrcClientInterfaceMod {
  ...
  - typingsJapgolly.googleGax.buildSrcGrpcMod.ClientStubOptions because Inheritance from two classes. Inlined protocol, servicePath, port, sslCreds, cert, key */ trait ClientOptions
    extends StObject
