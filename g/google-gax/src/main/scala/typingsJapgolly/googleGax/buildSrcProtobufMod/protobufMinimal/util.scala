...
import typingsJapgolly.protobufjs.mod.FetchCallback
import typingsJapgolly.protobufjs.mod.IConversionOptions
import typingsJapgolly.protobufjs.mod.IFetchOptions
import typingsJapgolly.protobufjs.mod.OneOfGetter
import typingsJapgolly.protobufjs.mod.OneOfSetter
import typingsJapgolly.protobufjs.mod.PoolAllocator
import typingsJapgolly.protobufjs.mod.PoolSlicer
import typingsJapgolly.protobufjs.mod.asPromiseCallback
...
object util {
  ...
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util")
  @js.native
  val ^ : js.Any = js.native
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.Array")
  @js.native
  ...
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.Buffer")
  @js.native
  ...
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.Buffer")
  @js.native
  def Buffer: Constructor[typingsJapgolly.protobufjs.mod.Buffer] = js.native
  inline def Buffer_=(x: Constructor[typingsJapgolly.protobufjs.mod.Buffer]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Buffer")(x.asInstanceOf[js.Any])
  
  /** A minimal event emitter. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.EventEmitter")
  @js.native
  /** Constructs a new event emitter instance. */
  open class EventEmitter ()
    extends typingsJapgolly.protobufjs.minimalMod.util.EventEmitter
  
  /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.Long")
  @js.native
  open class Long protected ()
    extends StObject
       with typingsJapgolly.protobufjs.mod.Long {
    def this(params: Any*) = this()
  ...
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.Long")
  @js.native
  def Long: Constructor[typingsJapgolly.protobufjs.mod.Long] = js.native
  
  /** Helper class for working with the low and high bits of a 64 bit value. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.LongBits")
  @js.native
  open class LongBits protected ()
    extends typingsJapgolly.protobufjs.minimalMod.util.LongBits {
    /**
  ...
  object LongBits {
    ...
    inline def from(value: String): typingsJapgolly.protobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.protobufjs.mod.util.LongBits]
    inline def from(value: Double): typingsJapgolly.protobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.protobufjs.mod.util.LongBits]
    /**
      ...
      */
    /* static member */
    inline def from(value: typingsJapgolly.protobufjs.mod.Long): typingsJapgolly.protobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.protobufjs.mod.util.LongBits]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromHash(hash: String): typingsJapgolly.protobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("fromHash")(hash.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.protobufjs.mod.util.LongBits]
    ...
    /**
      ...
      */
    /* static member */
    inline def fromNumber(value: Double): typingsJapgolly.protobufjs.mod.util.LongBits = ^.asInstanceOf[js.Dynamic].applyDynamic("fromNumber")(value.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.protobufjs.mod.util.LongBits]
    
    /** Zero bits. */
    /* static member */
    @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.LongBits.zero")
    @js.native
    def zero: typingsJapgolly.protobufjs.mod.util.LongBits = js.native
    
    /** Zero hash. */
    /* static member */
    @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.LongBits.zeroHash")
    @js.native
    ...
    inline def zero_=(x: typingsJapgolly.protobufjs.mod.util.LongBits): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("zero")(x.asInstanceOf[js.Any])
  }
  
  inline def Long_=(x: Constructor[typingsJapgolly.protobufjs.mod.Long]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("Long")(x.asInstanceOf[js.Any])
  
  /** Error subclass indicating a protocol specifc error. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.ProtocolError")
  @js.native
  open class ProtocolError[T /* <: typingsJapgolly.protobufjs.mod.Message[T] */] protected ()
    extends typingsJapgolly.protobufjs.minimalMod.util.ProtocolError[T] {
    /**
  ...
  object base64 {
    ...
    @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.base64")
    @js.native
    val ^ : js.Any = js.native
  ...
  object codegen {
    ...
    @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.codegen")
    @js.native
    val ^ : js.Any = js.native
    
    /** When set to `true`, codegen will log generated code to console. Useful for debugging. */
    @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.codegen.verbose")
    @js.native
  ...
  /**
    ...
    */
  inline def compareFieldsById(a: typingsJapgolly.protobufjs.mod.Field, b: typingsJapgolly.protobufjs.mod.Field): Double = (^.asInstanceOf[js.Dynamic].applyDynamic("compareFieldsById")(a.asInstanceOf[js.Any], b.asInstanceOf[js.Any])).asInstanceOf[Double]
  ...
  /**
    ...
    */
  inline def decorateEnum(`object`: js.Object): typingsJapgolly.protobufjs.mod.Enum = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateEnum")(`object`.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.protobufjs.mod.Enum]
  
  /** Decorator root (TypeScript). */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.decorateRoot")
  @js.native
  def decorateRoot: typingsJapgolly.protobufjs.mod.Root = js.native
  inline def decorateRoot_=(x: typingsJapgolly.protobufjs.mod.Root): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("decorateRoot")(x.asInstanceOf[js.Any])
  ...
  /**
    ...
    */
  inline def decorateType[T /* <: typingsJapgolly.protobufjs.mod.Message[T] */](ctor: Constructor[T]): typingsJapgolly.protobufjs.mod.Type = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateType")(ctor.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.protobufjs.mod.Type]
  inline def decorateType[T /* <: typingsJapgolly.protobufjs.mod.Message[T] */](ctor: Constructor[T], typeName: String): typingsJapgolly.protobufjs.mod.Type = (^.asInstanceOf[js.Dynamic].applyDynamic("decorateType")(ctor.asInstanceOf[js.Any], typeName.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.protobufjs.mod.Type]
  
  /** An immuable empty array. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.emptyArray")
  @js.native
  val emptyArray: js.Array[Any] = js.native
  
  /** An immutable empty object. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.emptyObject")
  @js.native
  ...
  object float {
    ...
    @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.float")
    @js.native
    val ^ : js.Any = js.native
  ...
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.global")
  @js.native
  ...
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.isNode")
  @js.native
  ...
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.key2Re")
  @js.native
  val key2Re: js.RegExp = js.native
  
  /** Regular expression used to verify 32 bit (`int32` etc.) map keys. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.key32Re")
  @js.native
  val key32Re: js.RegExp = js.native
  
  /** Regular expression used to verify 64 bit (`int64` etc.) map keys. */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.key64Re")
  @js.native
  ...
  /**
    ...
    */
  inline def longFromHash(hash: String): typingsJapgolly.protobufjs.mod.Long | Double = ^.asInstanceOf[js.Dynamic].applyDynamic("longFromHash")(hash.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.protobufjs.mod.Long | Double]
  inline def longFromHash(hash: String, unsigned: Boolean): typingsJapgolly.protobufjs.mod.Long | Double = (^.asInstanceOf[js.Dynamic].applyDynamic("longFromHash")(hash.asInstanceOf[js.Any], unsigned.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.protobufjs.mod.Long | Double]
  ...
  /**
    ...
    * @returns Hash
    */
  inline def longToHash(value: typingsJapgolly.protobufjs.mod.Long): String = ^.asInstanceOf[js.Dynamic].applyDynamic("longToHash")(value.asInstanceOf[js.Any]).asInstanceOf[String]
  ...
  /**
    ...
    * @returns Buffer
    */
  inline def newBuffer(): js.typedarray.Uint8Array | typingsJapgolly.protobufjs.mod.Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("newBuffer")().asInstanceOf[js.typedarray.Uint8Array | typingsJapgolly.protobufjs.mod.Buffer]
  inline def newBuffer(sizeOrArray: js.Array[Double]): js.typedarray.Uint8Array | typingsJapgolly.protobufjs.mod.Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("newBuffer")(sizeOrArray.asInstanceOf[js.Any]).asInstanceOf[js.typedarray.Uint8Array | typingsJapgolly.protobufjs.mod.Buffer]
  inline def newBuffer(sizeOrArray: Double): js.typedarray.Uint8Array | typingsJapgolly.protobufjs.mod.Buffer = ^.asInstanceOf[js.Dynamic].applyDynamic("newBuffer")(sizeOrArray.asInstanceOf[js.Any]).asInstanceOf[js.typedarray.Uint8Array | typingsJapgolly.protobufjs.mod.Buffer]
  ...
  object path {
    ...
    @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.path")
    @js.native
    val ^ : js.Any = js.native
  ...
  /**
    ...
    */
  @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.toJSONOptions")
  @js.native
  ...
  object utf8 {
    ...
    @JSImport("google-gax/build/src/protobuf", "protobufMinimal.util.utf8")
    @js.native
    val ^ : js.Any = js.native
