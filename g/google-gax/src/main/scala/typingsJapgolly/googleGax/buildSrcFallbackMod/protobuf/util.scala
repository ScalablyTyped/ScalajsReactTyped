package typingsJapgolly.googleGax.buildSrcFallbackMod.protobuf
...
object util {
  ...
  open class EventEmitter ()
    extends typingsJapgolly.protobufjs.mod.util.EventEmitter
  ...
  open class LongBits protected ()
    extends typingsJapgolly.protobufjs.mod.util.LongBits {
    /**
  ...
  open class ProtocolError[T /* <: typingsJapgolly.protobufjs.mod.Message[T] */] protected ()
    extends typingsJapgolly.protobufjs.mod.util.ProtocolError[T] {
    /**
