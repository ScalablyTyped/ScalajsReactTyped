...
import typingsJapgolly.googleGax.anon.PartialRetryOptions
...
object buildSrcGaxMod {
  ...
  object RetryRequestOptions {
    ...
    extension [Self <: RetryRequestOptions](x: Self) {
      ...
      inline def setShouldRetryFn(value: CallbackTo[Boolean]): Self = StObject.set(x, "shouldRetryFn", value.toJsFn)
