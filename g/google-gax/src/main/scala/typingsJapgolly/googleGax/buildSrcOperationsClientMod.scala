...
import typingsJapgolly.googleAuthLibrary.buildSrcAuthGoogleauthMod.ProjectIdCallback
...
object buildSrcOperationsClientMod {
  ...
  open class OperationsClientBuilder protected () extends StObject {
    ...
    /**
      ...
      */
    def this(gaxGrpc: typingsJapgolly.googleGax.buildSrcGrpcMod.GrpcClient) = this()
    def this(gaxGrpc: GrpcClient, protoJson: Root) = this()
    def this(gaxGrpc: typingsJapgolly.googleGax.buildSrcGrpcMod.GrpcClient, protoJson: Root) = this()
