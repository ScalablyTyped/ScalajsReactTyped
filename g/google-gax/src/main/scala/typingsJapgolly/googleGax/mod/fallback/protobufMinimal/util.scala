...
object util {
  ...
  open class EventEmitter ()
    extends typingsJapgolly.googleGax.buildSrcFallbackMod.protobufMinimal.util.EventEmitter
  ...
  open class LongBits protected ()
    extends typingsJapgolly.googleGax.buildSrcFallbackMod.protobufMinimal.util.LongBits {
    /**
  ...
  open class ProtocolError[T /* <: typingsJapgolly.protobufjs.mod.Message[T] */] protected ()
    extends typingsJapgolly.googleGax.buildSrcFallbackMod.protobufMinimal.util.ProtocolError[T] {
    /**
