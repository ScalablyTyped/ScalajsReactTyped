...
object util {
  ...
  open class EventEmitter ()
    extends typingsJapgolly.googleGax.buildSrcFallbackMod.protobuf.util.EventEmitter
  ...
  open class LongBits protected ()
    extends typingsJapgolly.googleGax.buildSrcFallbackMod.protobuf.util.LongBits {
    /**
  ...
  open class ProtocolError[T /* <: typingsJapgolly.protobufjs.mod.Message[T] */] protected ()
    extends typingsJapgolly.googleGax.buildSrcFallbackMod.protobuf.util.ProtocolError[T] {
    /**
  ...
  object path {
    ...
    @JSImport("google-gax", "fallback.protobuf.util.path")
    @js.native
    val ^ : js.Any = js.native
  ...
  object utf8 {
    ...
    @JSImport("google-gax", "fallback.protobuf.util.utf8")
    @js.native
    val ^ : js.Any = js.native
