...
object grpc {
  ...
  open class CallCredentials ()
    extends typingsJapgolly.grpcGrpcJs.mod.CallCredentials
  /* static members */
  ...
  open class Channel protected ()
    extends typingsJapgolly.grpcGrpcJs.mod.Channel {
    def this(
      target: String,
  ...
  open class Client protected ()
    extends typingsJapgolly.grpcGrpcJs.mod.Client {
    def this(
      address: String,
      credentials: typingsJapgolly.grpcGrpcJs.buildSrcChannelCredentialsMod.ChannelCredentials
    ) = this()
  ...
  open class InterceptingCall protected ()
    extends typingsJapgolly.grpcGrpcJs.mod.InterceptingCall {
  ...
  open class InterceptorConfigurationError protected ()
    extends typingsJapgolly.grpcGrpcJs.mod.InterceptorConfigurationError {
  ...
  open class ListenerBuilder ()
    extends typingsJapgolly.grpcGrpcJs.mod.ListenerBuilder
  
  @JSImport("google-gax", "grpc.Metadata")
  @js.native
  open class Metadata ()
    extends typingsJapgolly.grpcGrpcJs.mod.Metadata {
  ...
  open class RequesterBuilder ()
    extends typingsJapgolly.grpcGrpcJs.mod.RequesterBuilder
  
  @JSImport("google-gax", "grpc.Server")
  @js.native
  open class Server ()
    extends typingsJapgolly.grpcGrpcJs.mod.Server {
  ...
  open class ServerCredentials ()
    extends typingsJapgolly.grpcGrpcJs.mod.ServerCredentials
  /* static members */
  ...
  open class StatusBuilder ()
    extends typingsJapgolly.grpcGrpcJs.mod.StatusBuilder
  ...
  object credentials {
    ...
    @JSImport("google-gax", "grpc.credentials.createFromSecureContext")
    @js.native
  ...
  object experimental {
    ...
    @JSImport("google-gax", "grpc.experimental")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("google-gax", "grpc.experimental.BackoffTimeout")
    @js.native
    open class BackoffTimeout protected ()
      extends typingsJapgolly.grpcGrpcJs.mod.experimental.BackoffTimeout {
    ...
    open class BaseFilter ()
      extends typingsJapgolly.grpcGrpcJs.mod.experimental.BaseFilter
    ...
    open class BaseSubchannelWrapper protected ()
      extends typingsJapgolly.grpcGrpcJs.mod.experimental.BaseSubchannelWrapper {
      def this(child: SubchannelInterface) = this()
    }
    
    @JSImport("google-gax", "grpc.experimental.ChildLoadBalancerHandler")
    @js.native
    open class ChildLoadBalancerHandler protected ()
      extends typingsJapgolly.grpcGrpcJs.mod.experimental.ChildLoadBalancerHandler {
      def this(channelControlHelper: ChannelControlHelper) = this()
    }
    
    @JSImport("google-gax", "grpc.experimental.FilterStackFactory")
    @js.native
    open class FilterStackFactory protected ()
      extends typingsJapgolly.grpcGrpcJs.mod.experimental.FilterStackFactory {
      def this(factories: js.Array[FilterFactory[Filter]]) = this()
    }
    
    @JSImport("google-gax", "grpc.experimental.OutlierDetectionLoadBalancingConfig")
    @js.native
    open class OutlierDetectionLoadBalancingConfig protected ()
      extends typingsJapgolly.grpcGrpcJs.mod.experimental.OutlierDetectionLoadBalancingConfig {
      def this(
    ...
    open class QueuePicker protected ()
      extends typingsJapgolly.grpcGrpcJs.mod.experimental.QueuePicker {
      def this(loadBalancer: LoadBalancer) = this()
    }
    
    @JSImport("google-gax", "grpc.experimental.UnavailablePicker")
    @js.native
    open class UnavailablePicker ()
      extends typingsJapgolly.grpcGrpcJs.mod.experimental.UnavailablePicker {
  ...
  object status extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.grpcGrpcJs.buildSrcConstantsMod.Status & Double] = js.native
