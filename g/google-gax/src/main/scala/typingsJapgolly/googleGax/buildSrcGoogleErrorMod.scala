...
import typingsJapgolly.googleGax.buildSrcStatusMod.Status
...
object buildSrcGoogleErrorMod {
  ...
  trait ErrorInfo extends StObject {
    ...
    var metadata: typingsJapgolly.googleGax.anon.String
    
    var reason: String
  }
  object ErrorInfo {
    
    inline def apply(domain: String, metadata: typingsJapgolly.googleGax.anon.String, reason: String): ErrorInfo = {
    ...
    extension [Self <: ErrorInfo](x: Self) {
      ...
      inline def setMetadata(value: typingsJapgolly.googleGax.anon.String): Self = StObject.set(x, "metadata", value.asInstanceOf[js.Any])
  ...
  - typingsJapgolly.std.Error because var conflicts: message. Inlined name, stack, cause */ trait FallbackServiceError
    extends StObject
  ...
  trait FallbackStatusObject extends StObject {
    ...
    var errorInfoMetadata: js.UndefOr[typingsJapgolly.googleGax.anon.String] = js.undefined
  ...
  object FallbackStatusObject {
    ...
    extension [Self <: FallbackStatusObject](x: Self) {
      ...
      inline def setErrorInfoMetadata(value: typingsJapgolly.googleGax.anon.String): Self = StObject.set(x, "errorInfoMetadata", value.asInstanceOf[js.Any])
