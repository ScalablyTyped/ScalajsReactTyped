...
import typingsJapgolly.gridstack.distEs5GridstackEngineMod.GridStackEngine
import typingsJapgolly.gridstack.distEs5GridstackEngineMod.GridStackEngineOptions
import typingsJapgolly.gridstack.distEs5GridstackMod.GridStack
import typingsJapgolly.gridstack.gridstackBooleans.`false`
import typingsJapgolly.gridstack.gridstackBooleans.`true`
import typingsJapgolly.gridstack.gridstackStrings.auto
import typingsJapgolly.gridstack.gridstackStrings.mobile
...
object distEs5TypesMod {
  ...
  @JSImport("gridstack/dist/es5/types", "dragInDefaultOptions")
  @js.native
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gridstack.gridstackStrings.moveScale
    - typingsJapgolly.gridstack.gridstackStrings.move
    - typingsJapgolly.gridstack.gridstackStrings.scale
    - typingsJapgolly.gridstack.gridstackStrings.none
    - js.Function4[
  / * column * / scala.Double, 
  / * oldColumn * / scala.Double, 
  / * nodes * / js.Array[typingsJapgolly.gridstack.distEs5TypesMod.GridStackNode], 
  / * oldNodes * / js.Array[typingsJapgolly.gridstack.distEs5TypesMod.GridStackNode], 
  scala.Unit]
  */
