...
import typingsJapgolly.gridstack.distGridstackEngineMod.GridStackEngine
import typingsJapgolly.gridstack.distGridstackEngineMod.GridStackEngineOptions
...
import typingsJapgolly.gridstack.mod.GridStack
...
object distTypesMod {
  ...
  / * oldNodes * / js.Array[typingsJapgolly.gridstack.distTypesMod.GridStackNode], 
  scala.Unit]
  */
