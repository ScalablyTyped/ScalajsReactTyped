...
import typingsJapgolly.gridstack.distDdDraggableMod.DDDragEvent
import typingsJapgolly.gridstack.distDdGridstackMod.DDKey
import typingsJapgolly.gridstack.distDdGridstackMod._DDOpts
import typingsJapgolly.gridstack.distTypesMod._ColumnOptions
import typingsJapgolly.gridstack.mod._GridStackEvent
...
object gridstackStrings {
  ...
  sealed trait added
    extends StObject
       ...
       with typingsJapgolly.gridstack.distEs5GridstackMod._GridStackEvent
  ...
  sealed trait destroy
    extends StObject
       with _DDOpts
       with typingsJapgolly.gridstack.distEs5DdGridstackMod._DDOpts
  ...
  sealed trait drag
    extends StObject
       with DDDragEvent
       with typingsJapgolly.gridstack.distEs5DdDraggableMod.DDDragEvent
       with _GridStackEvent
       with typingsJapgolly.gridstack.distEs5GridstackMod._GridStackEvent
  ...
  sealed trait maxHeight
    extends StObject
       with DDKey
       with typingsJapgolly.gridstack.distEs5DdGridstackMod.DDKey
  ...
  sealed trait move
    extends StObject
       with _ColumnOptions
       with typingsJapgolly.gridstack.distEs5TypesMod._ColumnOptions
