...
object distDdManagerMod {
  
  @JSImport("gridstack/dist/dd-manager", "DDManager")
  @js.native
  ...
  object DDManager {
    ...
    /** item being dragged */
    @JSImport("gridstack/dist/dd-manager", "DDManager.dragElement")
    @js.native
    ...
    @JSImport("gridstack/dist/dd-manager", "DDManager.dropElement")
    @js.native
    ...
    @JSImport("gridstack/dist/dd-manager", "DDManager.mouseHandled")
    @js.native
    ...
    @JSImport("gridstack/dist/dd-manager", "DDManager.overResizeElement")
    @js.native
    ...
    @JSImport("gridstack/dist/dd-manager", "DDManager.pauseDrag")
    @js.native
