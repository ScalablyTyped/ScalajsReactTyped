...
import typingsJapgolly.gridstack.anon.TypeofUtilsInstantiable
import typingsJapgolly.gridstack.distGridstackEngineMod.GridStackEngineOptions
import typingsJapgolly.gridstack.distTypesMod.ColumnOptions
...
import typingsJapgolly.gridstack.distTypesMod.GridStackEventHandlerCallback
...
import typingsJapgolly.gridstack.distUtilsMod.HeightData
...
object mod {
  ...
  open class DDGridStack ()
    extends typingsJapgolly.gridstack.distDdGridstackMod.DDGridStack
  /* static members */
  object DDGridStack {
    ...
    inline def get(): typingsJapgolly.gridstack.distDdGridstackMod.DDGridStack = ^.asInstanceOf[js.Dynamic].applyDynamic("get")().asInstanceOf[typingsJapgolly.gridstack.distDdGridstackMod.DDGridStack]
  }
  ...
  open class GridStack protected () extends StObject {
    ...
    var engine: typingsJapgolly.gridstack.distGridstackEngineMod.GridStackEngine = js.native
  ...
  object GridStack {
    ...
    def Engine: Instantiable1[
        ...
        typingsJapgolly.gridstack.distGridstackEngineMod.GridStackEngine
      ] = js.native
    inline def Engine_=(
      x: Instantiable1[
          /* opts */ js.UndefOr[GridStackEngineOptions], 
  ...
  open class GridStackEngine ()
    extends typingsJapgolly.gridstack.distGridstackEngineMod.GridStackEngine {
  ...
  @js.native
  open class Utils ()
    extends typingsJapgolly.gridstack.distUtilsMod.Utils
  /* static members */
  object Utils {
