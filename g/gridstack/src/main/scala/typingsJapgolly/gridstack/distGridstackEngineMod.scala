...
import typingsJapgolly.gridstack.distTypesMod.GridStackMoveOpts
import typingsJapgolly.gridstack.distTypesMod.GridStackNode
import typingsJapgolly.gridstack.distTypesMod.GridStackPosition
...
object distGridstackEngineMod {
  ...
  object GridStackEngineOptions {
    ...
    extension [Self <: GridStackEngineOptions](x: Self) {
      ...
      inline def setOnChange(value: /* nodes */ js.Array[GridStackNode] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* nodes */ js.Array[GridStackNode]) => value(t0).runNow()))
