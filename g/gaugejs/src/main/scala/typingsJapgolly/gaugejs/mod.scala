...
import typingsJapgolly.gaugejs.anon.Color
import typingsJapgolly.gaugejs.anon.DivColor
import typingsJapgolly.gaugejs.anon.FontSize
import typingsJapgolly.gaugejs.anon.PointerOptionsiconPathstr
import typingsJapgolly.gaugejs.anon.StaticZoneOptionsheightnu
