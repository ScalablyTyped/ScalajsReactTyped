...
object MarkerClustererOptions {
  ...
  def apply(
    ...
    calculator: (/* markers */ js.Array[Marker], /* clusterIconStylesCount */ Double) => CallbackTo[ClusterIconInfo] = null,
    ...
    if (calculator != null) __obj.updateDynamic("calculator")(js.Any.fromFunction2((t0: /* markers */ js.Array[typingsJapgolly.googlemaps.google.maps.Marker], t1: /* clusterIconStylesCount */ scala.Double) => calculator(t0, t1).runNow()))
