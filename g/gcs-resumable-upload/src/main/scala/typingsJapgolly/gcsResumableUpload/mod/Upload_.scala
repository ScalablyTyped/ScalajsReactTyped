...
import typingsJapgolly.gcsResumableUpload.AnonScopes
import typingsJapgolly.gcsResumableUpload.gcsResumableUploadStrings.Asterisk
import typingsJapgolly.googleAuthLibrary.mod.GoogleAuth
import typingsJapgolly.node.Buffer
import typingsJapgolly.pumpify.mod.^
...
class Upload_ protected () extends ^ {
  ...
  var configStore: typingsJapgolly.configstore.mod.^ = js.native
