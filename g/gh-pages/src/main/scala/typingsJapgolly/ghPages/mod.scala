...
import typingsJapgolly.ghPages.anon.Email
import typingsJapgolly.ghPages.ghPagesBooleans.`false`
import typingsJapgolly.ghPages.ghPagesBooleans.`true`
import typingsJapgolly.ghPages.ghPagesInts.`1`
import typingsJapgolly.ghPages.ghPagesStrings.AsteriskAsteriskSlashAsterisk
import typingsJapgolly.ghPages.ghPagesStrings.Dot
import typingsJapgolly.ghPages.ghPagesStrings.Updates
import typingsJapgolly.ghPages.ghPagesStrings.`gh-pages`
import typingsJapgolly.ghPages.ghPagesStrings.git
...
object mod {
  ...
  object defaults {
    ...
    @js.native
    val git: typingsJapgolly.ghPages.ghPagesStrings.git = js.native
  ...
  trait Defaults_ extends StObject {
    ...
    var git: typingsJapgolly.ghPages.ghPagesStrings.git
