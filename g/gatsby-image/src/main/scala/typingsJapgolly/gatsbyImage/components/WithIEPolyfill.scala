...
object WithIEPolyfill {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[GatsbyImageWithIEPolyfillProps, default, Unit, GatsbyImageWithIEPolyfillProps] = {
  ...
  typingsJapgolly.gatsbyImage.withIEPolyfillMod.GatsbyImageWithIEPolyfillProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.gatsbyImage.withIEPolyfillMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.gatsbyImage.withIEPolyfillMod.GatsbyImageWithIEPolyfillProps])(children: _*)
  }
