package typingsJapgolly.gatsbyImage
...
object mod {
  ...
  type GatsbyImage = japgolly.scalajs.react.facade.React.Component[GatsbyImageProps & js.Object, js.Object]
  ...
  object GatsbyImageOptionalProps {
    ...
    extension [Self <: GatsbyImageOptionalProps](x: Self) {
      ...
      inline def setOnStartLoad(value: /* param */ WasCached => Callback): Self = StObject.set(x, "onStartLoad", js.Any.fromFunction1((t0: /* param */ WasCached) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.gatsbyImage.mod.GatsbyImageFluidProps
    - typingsJapgolly.gatsbyImage.mod.GatsbyImageFixedProps
  */
  trait GatsbyImageProps extends StObject
  object GatsbyImageProps {
    
    inline def GatsbyImageFixedProps(fixed: FixedObject | js.Array[FixedObject]): typingsJapgolly.gatsbyImage.mod.GatsbyImageFixedProps = {
      val __obj = js.Dynamic.literal(fixed = fixed.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.gatsbyImage.mod.GatsbyImageFixedProps]
    }
    
    inline def GatsbyImageFluidProps(fluid: FluidObject | js.Array[FluidObject]): typingsJapgolly.gatsbyImage.mod.GatsbyImageFluidProps = {
      val __obj = js.Dynamic.literal(fluid = fluid.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.gatsbyImage.mod.GatsbyImageFluidProps]
    }
  }
}
