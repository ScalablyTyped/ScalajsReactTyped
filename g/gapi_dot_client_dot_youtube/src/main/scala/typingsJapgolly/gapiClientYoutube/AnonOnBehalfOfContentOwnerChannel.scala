...
trait AnonOnBehalfOfContentOwnerChannel extends js.Object {
...
object AnonOnBehalfOfContentOwnerChannel {
  @scala.inline
  def apply(
    part: String,
    alt: String = null,
    ...
    userIp: String = null
  ): AnonOnBehalfOfContentOwnerChannel = {
    ...
    __obj.asInstanceOf[AnonOnBehalfOfContentOwnerChannel]
  }
}
