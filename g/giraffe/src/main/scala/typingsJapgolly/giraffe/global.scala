...
import typingsJapgolly.backbone.mod.Events
import typingsJapgolly.giraffe.Giraffe.App
import typingsJapgolly.giraffe.Giraffe.AppMap
import typingsJapgolly.giraffe.Giraffe.DefaultOptions
import typingsJapgolly.giraffe.Giraffe.GiraffeObject
import typingsJapgolly.giraffe.Giraffe.ViewMap
...
object global {
  ...
  object Giraffe {
    ...
    @js.native
    open class Collection[TModel /* <: typingsJapgolly.giraffe.Giraffe.Model */] ()
      extends typingsJapgolly.giraffe.Giraffe.Collection[TModel]
    
    object Contrib {
      
      @JSGlobal("Giraffe.Contrib.CollectionView")
      @js.native
      open class CollectionView[TModel /* <: typingsJapgolly.giraffe.Giraffe.Model */] ()
        extends typingsJapgolly.giraffe.Giraffe.Contrib.CollectionView[TModel]
      ...
      open class Controller ()
        extends typingsJapgolly.giraffe.Giraffe.Contrib.Controller {
      ...
      @js.native
      open class FastCollectionView[TModel /* <: typingsJapgolly.giraffe.Giraffe.Model */] ()
        extends typingsJapgolly.giraffe.Giraffe.Contrib.FastCollectionView[TModel]
    ...
    @js.native
    open class Model ()
      extends typingsJapgolly.giraffe.Giraffe.Model
    
    @JSGlobal("Giraffe.Router")
    @js.native
    open class Router ()
      extends typingsJapgolly.giraffe.Giraffe.Router
    
    @JSGlobal("Giraffe.View")
    @js.native
    open class View[TModel /* <: typingsJapgolly.giraffe.Giraffe.Model */] ()
      extends typingsJapgolly.giraffe.Giraffe.View[TModel]
    object View {
      ...
      /* static member */
      inline def detachByElement(el: Any): typingsJapgolly.giraffe.Giraffe.View[typingsJapgolly.giraffe.Giraffe.Model] = ^.asInstanceOf[js.Dynamic].applyDynamic("detachByElement")(el.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.giraffe.Giraffe.View[typingsJapgolly.giraffe.Giraffe.Model]]
      inline def detachByElement(el: Any, preserve: Boolean): typingsJapgolly.giraffe.Giraffe.View[typingsJapgolly.giraffe.Giraffe.Model] = (^.asInstanceOf[js.Dynamic].applyDynamic("detachByElement")(el.asInstanceOf[js.Any], preserve.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.giraffe.Giraffe.View[typingsJapgolly.giraffe.Giraffe.Model]]
      
      /* static member */
      inline def getByCid(cid: String): typingsJapgolly.giraffe.Giraffe.View[typingsJapgolly.giraffe.Giraffe.Model] = ^.asInstanceOf[js.Dynamic].applyDynamic("getByCid")(cid.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.giraffe.Giraffe.View[typingsJapgolly.giraffe.Giraffe.Model]]
      
      /* static member */
      inline def getClosestView[TModel](el: Any): typingsJapgolly.giraffe.Giraffe.View[typingsJapgolly.giraffe.Giraffe.Model] = ^.asInstanceOf[js.Dynamic].applyDynamic("getClosestView")(el.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.giraffe.Giraffe.View[typingsJapgolly.giraffe.Giraffe.Model]]
    ...
    @js.native
    def views: ViewMap[typingsJapgolly.giraffe.Giraffe.Model] = js.native
    inline def views_=(x: ViewMap[typingsJapgolly.giraffe.Giraffe.Model]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("views")(x.asInstanceOf[js.Any])
