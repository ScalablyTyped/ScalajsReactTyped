...
object mod {
  ...
  object ZXCVBNFeedbackWarning {
    ...
    inline def `A word by itself is easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`A word by itself is easy to guess` = ("A word by itself is easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`A word by itself is easy to guess`]
    
    inline def `Common names and surnames are easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Common names and surnames are easy to guess` = ("Common names and surnames are easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Common names and surnames are easy to guess`]
    
    inline def `Dates are often easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Dates are often easy to guess` = ("Dates are often easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Dates are often easy to guess`]
    
    inline def `Names and surnames by themselves are easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Names and surnames by themselves are easy to guess` = ("Names and surnames by themselves are easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Names and surnames by themselves are easy to guess`]
    
    inline def `Recent years are easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Recent years are easy to guess` = ("Recent years are easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Recent years are easy to guess`]
    
    inline def `Repeats like QuotationmarkaaaQuotationmark are easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Repeats like QuotationmarkaaaQuotationmark are easy to guess` = ("Repeats like \"aaa\" are easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Repeats like QuotationmarkaaaQuotationmark are easy to guess`]
    ...
    inline def `Sequences like abc or 6543 are easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Sequences like abc or 6543 are easy to guess` = ("Sequences like abc or 6543 are easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Sequences like abc or 6543 are easy to guess`]
    
    inline def `Short keyboard patterns are easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Short keyboard patterns are easy to guess` = ("Short keyboard patterns are easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Short keyboard patterns are easy to guess`]
    
    inline def `Straight rows of keys are easy to guess`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Straight rows of keys are easy to guess` = ("Straight rows of keys are easy to guess").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Straight rows of keys are easy to guess`]
    
    inline def `This is a top-10 common password`: typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a top-10 common password` = ("This is a top-10 common password").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a top-10 common password`]
    
    inline def `This is a top-100 common password`: typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a top-100 common password` = ("This is a top-100 common password").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a top-100 common password`]
    
    inline def `This is a very common password`: typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a very common password` = ("This is a very common password").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a very common password`]
    
    inline def `This is similar to a commonly used password`: typingsJapgolly.zxcvbn.zxcvbnStrings.`This is similar to a commonly used password` = ("This is similar to a commonly used password").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`This is similar to a commonly used password`]
    
    inline def `Use a longer keyboard pattern with more turns`: typingsJapgolly.zxcvbn.zxcvbnStrings.`Use a longer keyboard pattern with more turns` = ("Use a longer keyboard pattern with more turns").asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings.`Use a longer keyboard pattern with more turns`]
    
    inline def _empty: typingsJapgolly.zxcvbn.zxcvbnStrings._empty = "".asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnStrings._empty]
  }
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Straight rows of keys are easy to guess`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Short keyboard patterns are easy to guess`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Use a longer keyboard pattern with more turns`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Repeats like QuotationmarkaaaQuotationmark are easy to guess`
    - / * Repeats like "abcabcabc" are only slightly harder to guess than "abc" * / java.lang.String
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Sequences like abc or 6543 are easy to guess`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Recent years are easy to guess`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Dates are often easy to guess`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a top-10 common password`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a top-100 common password`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`This is a very common password`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`This is similar to a commonly used password`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`A word by itself is easy to guess`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Names and surnames by themselves are easy to guess`
    - typingsJapgolly.zxcvbn.zxcvbnStrings.`Common names and surnames are easy to guess`
    - typingsJapgolly.zxcvbn.zxcvbnStrings._empty
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.zxcvbn.zxcvbnInts.`0`
    - typingsJapgolly.zxcvbn.zxcvbnInts.`1`
    - typingsJapgolly.zxcvbn.zxcvbnInts.`2`
    - typingsJapgolly.zxcvbn.zxcvbnInts.`3`
    - typingsJapgolly.zxcvbn.zxcvbnInts.`4`
  */
  trait ZXCVBNScore extends StObject
  object ZXCVBNScore {
    
    inline def `0`: typingsJapgolly.zxcvbn.zxcvbnInts.`0` = 0.asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnInts.`0`]
    
    inline def `1`: typingsJapgolly.zxcvbn.zxcvbnInts.`1` = 1.asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnInts.`1`]
    
    inline def `2`: typingsJapgolly.zxcvbn.zxcvbnInts.`2` = 2.asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnInts.`2`]
    
    inline def `3`: typingsJapgolly.zxcvbn.zxcvbnInts.`3` = 3.asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnInts.`3`]
    
    inline def `4`: typingsJapgolly.zxcvbn.zxcvbnInts.`4` = 4.asInstanceOf[typingsJapgolly.zxcvbn.zxcvbnInts.`4`]
  }
