...
import typingsJapgolly.zenObservableTs.typesMod.ZenObservable.Subscription
...
trait Observable[T] extends js.Object {
  ...
  def flatMap[R](
    fn: js.Function1[
      /* value */ T, 
      typingsJapgolly.zenObservableTs.typesMod.ZenObservable.ObservableLike[R]
    ]
  ...
  def from[R](observable: typingsJapgolly.zenObservableTs.typesMod.ZenObservable.ObservableLike[R]): Observable[R] = js.native
  ...
  def subscribe(observerOrNext: typingsJapgolly.zenObservableTs.typesMod.ZenObservable.Observer[T]): Subscription = js.native
  def subscribe(
    observerOrNext: typingsJapgolly.zenObservableTs.typesMod.ZenObservable.Observer[T],
    error: js.Function1[/* error */ js.Any, Unit]
  ): Subscription = js.native
  def subscribe(
    observerOrNext: typingsJapgolly.zenObservableTs.typesMod.ZenObservable.Observer[T],
