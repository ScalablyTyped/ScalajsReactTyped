...
object Observer {
  ...
  def apply[T](
    ...
    if (start != null) __obj.updateDynamic("start")(js.Any.fromFunction1((t0: /* subscription */ typingsJapgolly.zenObservableTs.typesMod.ZenObservable.Subscription) => start(t0).runNow()))
