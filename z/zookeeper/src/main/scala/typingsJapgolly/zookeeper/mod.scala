...
object mod {
  ...
  trait ZooKeeperPromise
    extends typingsJapgolly.zookeeper.zookeeperWithCallbacksMod.^ {
    ...
    /**
      ...
      * returns {ZkPromise}
      */
    def on_connected(): typingsJapgolly.zookeeper.zookeeperDeprecatedPromiseMod.^ = js.native
  ...
  type ZooKeeperPromiseBase = typingsJapgolly.zookeeper.zookeeperWithCallbacksMod.^
}
