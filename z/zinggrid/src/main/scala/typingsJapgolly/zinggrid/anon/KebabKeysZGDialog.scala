...
/* Inlined zinggrid.KebabKeys<zinggrid.ZSoft.ZingGridAttributes.ZGDialog> */
trait KebabKeysZGDialog extends StObject {
...
object KebabKeysZGDialog {
  
  inline def apply(): KebabKeysZGDialog = {
