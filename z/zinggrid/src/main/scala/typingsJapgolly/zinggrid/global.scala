...
import typingsJapgolly.zinggrid.ZSoft.ZingGridConfig
...
object global {
  ...
  object ZSoft {
    ...
    open class ZingGrid protected ()
      extends StObject
         with typingsJapgolly.zinggrid.ZSoft.ZingGrid {
  ...
  object ZingGrid {
    ...
    /**
      ...
      * </ul>
      */
    inline def customizeDialog(`type`: String, config: Any): typingsJapgolly.zinggrid.ZingGrid = (^.asInstanceOf[js.Dynamic].applyDynamic("customizeDialog")(`type`.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.zinggrid.ZingGrid]
