...
object EventTarget {
  ...
  extension [Self <: EventTarget](x: Self) {
    ...
    inline def setRemoveAllListeners(value: /* eventName */ js.UndefOr[String] => Callback): Self = StObject.set(x, "removeAllListeners", js.Any.fromFunction1((t0: /* eventName */ js.UndefOr[String]) => value(t0).runNow()))
