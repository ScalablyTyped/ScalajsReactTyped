...
object ZoneType {
  @scala.inline
  def apply(
    __load_patch: (String, _PatchFn) => Callback,
    ...
    __obj.updateDynamic("__load_patch")(js.Any.fromFunction2((t0: java.lang.String, t1: typingsJapgolly.zoneDotJs._PatchFn) => __load_patch(t0, t1).runNow()))
