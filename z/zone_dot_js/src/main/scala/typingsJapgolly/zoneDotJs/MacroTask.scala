...
import typingsJapgolly.zoneDotJs.zoneDotJsStrings.macroTask
...
object MacroTask {
  ...
  def apply(
    ...
    if (cancelFn != null) __obj.updateDynamic("cancelFn")(js.Any.fromFunction1((t0: /* task */ typingsJapgolly.zoneDotJs.Task) => cancelFn(t0).runNow()))
    if (data != null) __obj.updateDynamic("data")(data.asInstanceOf[js.Any])
    if (scheduleFn != null) __obj.updateDynamic("scheduleFn")(js.Any.fromFunction1((t0: /* task */ typingsJapgolly.zoneDotJs.Task) => scheduleFn(t0).runNow()))
