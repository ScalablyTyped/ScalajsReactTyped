...
/**
  ...
  */
@js.native
trait _ZonePrivate extends js.Object {
  ...
  def currentZoneFrame(): _ZoneFrame = js.native
  def filterProperties(target: js.Any, onProperties: js.Array[String], ignoreProperties: js.Array[_]): js.Array[String] = js.native
  def getGlobalObjects(): js.UndefOr[Anon_ADDEVENTLISTENERSTR] = js.native
  def isIEOrEdge(): Boolean = js.native
  def microtaskDrainDone(): Unit = js.native
  def onUnhandledError(error: js.Error): Unit = js.native
  def patchCallbacks(api: _ZonePrivate, target: js.Any, targetName: String, method: String, callbacks: js.Array[String]): Unit = js.native
  def patchClass(className: String): Unit = js.native
  def patchEventPrototype(_global: js.Any, api: _ZonePrivate): Unit = js.native
