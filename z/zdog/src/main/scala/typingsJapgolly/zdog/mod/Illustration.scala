...
- typingsJapgolly.zdog.mod.Dragger because Inheritance from two classes. Inlined onDragStart, onDragStart_Original, onDragMove, onDragMove_Original, onDragEnd, onDragEnd_Original */ @JSImport("zdog", "Illustration")
@js.native
class Illustration protected () extends Anchor {
  ...
  def onPrerender(context: typingsJapgolly.std.SVGSVGElement): Unit = js.native
  /** @see {@link IllustrationOptions#onResize} */
