...
trait AnonExact extends js.Object {
  ...
  var marker: js.UndefOr[AnonBackgroundcolor] = js.undefined
  var `plot-label`: js.UndefOr[AnonBackgroundcolor1] = js.undefined
  /**
  ...
  var `scale-label`: js.UndefOr[AnonBackgroundcolor2] = js.undefined
  /**
...
object AnonExact {
  ...
  def apply(
    ...
    marker: AnonBackgroundcolor = null,
    `plot-label`: AnonBackgroundcolor1 = null,
    `reverse-series`: js.UndefOr[Boolean] = js.undefined,
    `scale-label`: AnonBackgroundcolor2 = null,
