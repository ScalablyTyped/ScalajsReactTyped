...
trait AnonAnimation extends js.Object {
  ...
  var animation: js.UndefOr[Anon1] = js.undefined
  /**
  ...
  var goal: js.UndefOr[AnonHeight] = js.undefined
  /**
  ...
  var `highlight-marker`: js.UndefOr[AnonLinewidth] = js.undefined
  ...
  var trend: js.UndefOr[AnonAlphaBackgroundcolor] = js.undefined
  /**
    * Sets the URL for the link associated with the object. "http://www.domain.com/link.php" | "link.asp" | ...
    */
  var url: js.UndefOr[String] = js.undefined
  var `value-box`: js.UndefOr[AnonCallout] = js.undefined
  /**
...
object AnonAnimation {
  ...
  def apply(
    ...
    `highlight-marker`: AnonLinewidth = null,
    ...
    trend: AnonAlphaBackgroundcolor = null,
    url: String = null,
    `value-box`: AnonCallout = null,
    ...
    if (`bar-max-width` != null) __obj.updateDynamic("bar-max-width")(`bar-max-width`.asInstanceOf[js.Any])
    ...
    if (exponentDecimals != null) __obj.updateDynamic("exponentDecimals")(exponentDecimals.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(`smart-sampling`)) __obj.updateDynamic("smart-sampling")(`smart-sampling`.asInstanceOf[js.Any])
