...
trait AnonBorderleft extends js.Object {
  /**
...
object AnonBorderleft {
  ...
  def apply(
    ...
    `show-marker`: js.UndefOr[Boolean] = js.undefined,
    ...
    if (!js.isUndefined(`show-marker`)) __obj.updateDynamic("show-marker")(`show-marker`.asInstanceOf[js.Any])
    ...
    __obj.asInstanceOf[AnonBorderleft]
  }
}
