...
import typingsJapgolly.zustand.anon.GetOptions
import typingsJapgolly.zustand.vanillaMod.StateCreator
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object middlewarePersistMod {
  
  @JSImport("zustand/middleware/persist", "persist")
  @js.native
  ...
  object PersistOptions {
    ...
    extension [Self <: PersistOptions[?, ?], S, PersistedState](x: Self & (PersistOptions[S, PersistedState])) {
      ...
      inline def setGetStorage(value: CallbackTo[StateStorage]): Self = StObject.set(x, "getStorage", value.toJsFn)
  ...
  trait StorePersist[S, Ps] extends StObject {
    ...
    var persist: GetOptions[S, Ps]
  }
  object StorePersist {
    
    inline def apply[S, Ps](persist: GetOptions[S, Ps]): StorePersist[S, Ps] = {
