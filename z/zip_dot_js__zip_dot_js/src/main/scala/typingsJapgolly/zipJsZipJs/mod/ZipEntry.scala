...
object ZipEntry {
  ...
  extension [Self <: ZipEntry](x: Self) {
    ...
    inline def setGetFullname(value: CallbackTo[String]): Self = StObject.set(x, "getFullname", value.toJsFn)
