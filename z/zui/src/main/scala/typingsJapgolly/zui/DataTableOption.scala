...
object DataTableOption {
  ...
  extension [Self <: DataTableOption](x: Self) {
    ...
    inline def setAfterLoad(value: /* event */ AfterLoadEvent => Callback): Self = StObject.set(x, "afterLoad", js.Any.fromFunction1((t0: /* event */ AfterLoadEvent) => value(t0).runNow()))
    ...
    inline def setChecksChanged(value: /* event */ ChecksChangeEvent => Callback): Self = StObject.set(x, "checksChanged", js.Any.fromFunction1((t0: /* event */ ChecksChangeEvent) => value(t0).runNow()))
    ...
    inline def setSizeChanged(value: /* event */ SizeChangeEvent => Callback): Self = StObject.set(x, "sizeChanged", js.Any.fromFunction1((t0: /* event */ SizeChangeEvent) => value(t0).runNow()))
    
    inline def setSizeChangedUndefined: Self = StObject.set(x, "sizeChanged", js.undefined)
    
    inline def setSort(value: /* event */ SortEvent => Callback): Self = StObject.set(x, "sort", js.Any.fromFunction1((t0: /* event */ SortEvent) => value(t0).runNow()))
