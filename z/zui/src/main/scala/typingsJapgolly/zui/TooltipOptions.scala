...
object TooltipOptions {
  ...
  extension [Self <: TooltipOptions](x: Self) {
    ...
    inline def setPlacementCallback(value: Callback): Self = StObject.set(x, "placement", value.toJsFn)
    ...
    inline def setTitleCallback(value: Callback): Self = StObject.set(x, "title", value.toJsFn)
    ...
    inline def setViewportCallback(value: Callback): Self = StObject.set(x, "viewport", value.toJsFn)
