...
object DroppableOption {
  ...
  extension [Self <: DroppableOption](x: Self) {
    ...
    inline def setAlways(value: /* e */ DroppableEvent => Callback): Self = StObject.set(x, "always", js.Any.fromFunction1((t0: /* e */ DroppableEvent) => value(t0).runNow()))
    ...
    inline def setDrag(value: /* e */ DroppableEvent => Callback): Self = StObject.set(x, "drag", js.Any.fromFunction1((t0: /* e */ DroppableEvent) => value(t0).runNow()))
    
    inline def setDragUndefined: Self = StObject.set(x, "drag", js.undefined)
    
    inline def setDrop(value: /* e */ DroppableEvent => Callback): Self = StObject.set(x, "drop", js.Any.fromFunction1((t0: /* e */ DroppableEvent) => value(t0).runNow()))
    
    inline def setDropUndefined: Self = StObject.set(x, "drop", js.undefined)
    
    inline def setFinish(value: /* e */ DroppableEvent => Callback): Self = StObject.set(x, "finish", js.Any.fromFunction1((t0: /* e */ DroppableEvent) => value(t0).runNow()))
    ...
    inline def setStart(value: /* e */ js.UndefOr[DroppableEvent] => Callback): Self = StObject.set(x, "start", js.Any.fromFunction1((t0: /* e */ js.UndefOr[DroppableEvent]) => value(t0).runNow()))
