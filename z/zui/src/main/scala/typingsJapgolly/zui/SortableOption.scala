...
object SortableOption {
  ...
  extension [Self <: SortableOption](x: Self) {
    ...
    inline def setFinish(value: /* e */ js.UndefOr[SortEvent] => Callback): Self = StObject.set(x, "finish", js.Any.fromFunction1((t0: /* e */ js.UndefOr[SortEvent]) => value(t0).runNow()))
    ...
    inline def setOrder(value: /* e */ js.UndefOr[SortEvent] => Callback): Self = StObject.set(x, "order", js.Any.fromFunction1((t0: /* e */ js.UndefOr[SortEvent]) => value(t0).runNow()))
    ...
    inline def setStart(value: /* e */ js.UndefOr[SortEvent] => Callback): Self = StObject.set(x, "start", js.Any.fromFunction1((t0: /* e */ js.UndefOr[SortEvent]) => value(t0).runNow()))
