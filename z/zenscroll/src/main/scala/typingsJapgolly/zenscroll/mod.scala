...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsJapgolly.zenscroll.mod.ZenScroll.zenscroll = js.native
  ...
  object ZenScroll {
    ...
    trait zenscroll extends StObject {
      ...
      def createScroller(scrollContainer: HTMLElement): typingsJapgolly.zenscroll.mod.ZenScroll.zenscroll = js.native
      def createScroller(scrollContainer: HTMLElement, defaultDuration: Double): typingsJapgolly.zenscroll.mod.ZenScroll.zenscroll = js.native
      def createScroller(scrollContainer: HTMLElement, defaultDuration: Double, edgeOffset: Double): typingsJapgolly.zenscroll.mod.ZenScroll.zenscroll = js.native
      def createScroller(scrollContainer: HTMLElement, defaultDuration: Unit, edgeOffset: Double): typingsJapgolly.zenscroll.mod.ZenScroll.zenscroll = js.native
  ...
  type _To = typingsJapgolly.zenscroll.mod.ZenScroll.zenscroll
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsJapgolly.zenscroll.mod.ZenScroll.zenscroll = ^
