...
object anon {
  ...
  object Aftercopy {
    ...
    extension [Self <: Aftercopy](x: Self) {
      ...
      inline def setAftercopyFunction1(value: ZeroClipboardAfterCopyEvent => Callback): Self = StObject.set(x, "aftercopy", js.Any.fromFunction1((t0: ZeroClipboardAfterCopyEvent) => value(t0).runNow()))
      ...
      inline def setBeforecopyFunction1(value: ZeroClipboardBeforeCopyEvent => Callback): Self = StObject.set(x, "beforecopy", js.Any.fromFunction1((t0: ZeroClipboardBeforeCopyEvent) => value(t0).runNow()))
      ...
      inline def setCopyFunction1(value: ZeroClipboardCopyEvent => Callback): Self = StObject.set(x, "copy", js.Any.fromFunction1((t0: ZeroClipboardCopyEvent) => value(t0).runNow()))
      ...
      inline def setDestroyFunction1(value: ZeroClipboardDestroyEvent => Callback): Self = StObject.set(x, "destroy", js.Any.fromFunction1((t0: ZeroClipboardDestroyEvent) => value(t0).runNow()))
      ...
      inline def setErrorFunction1(value: ZeroClipboardErrorEvent => Callback): Self = StObject.set(x, "error", js.Any.fromFunction1((t0: ZeroClipboardErrorEvent) => value(t0).runNow()))
      ...
      inline def setReadyFunction1(value: ZeroClipboardReadyEvent => Callback): Self = StObject.set(x, "ready", js.Any.fromFunction1((t0: ZeroClipboardReadyEvent) => value(t0).runNow()))
