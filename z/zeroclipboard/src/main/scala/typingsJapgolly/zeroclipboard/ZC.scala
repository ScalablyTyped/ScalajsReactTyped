...
import typingsJapgolly.zeroclipboard.anon.Aftercopy
import typingsJapgolly.zeroclipboard.anon.Beforecopy
import typingsJapgolly.zeroclipboard.anon.ClearData
import typingsJapgolly.zeroclipboard.anon.Name
import typingsJapgolly.zeroclipboard.zeroclipboardStrings.activeClass
import typingsJapgolly.zeroclipboard.zeroclipboardStrings.aftercopy
import typingsJapgolly.zeroclipboard.zeroclipboardStrings.autoActivate
import typingsJapgolly.zeroclipboard.zeroclipboardStrings.beforecopy
...
import typingsJapgolly.zeroclipboard.zeroclipboardStrings.copy
import typingsJapgolly.zeroclipboard.zeroclipboardStrings.destroy
import typingsJapgolly.zeroclipboard.zeroclipboardStrings.error
...
import typingsJapgolly.zeroclipboard.zeroclipboardStrings.ready
...
object ZC {
  ...
  object EventListenerObject {
    ...
    inline def apply[T /* <: ZeroClipboardEvent */](handleEvent: T => Callback): EventListenerObject[T] = {
      val __obj = js.Dynamic.literal(handleEvent = js.Any.fromFunction1((t0: T) => handleEvent(t0).runNow()))
    ...
    extension [Self <: EventListenerObject[?], T /* <: ZeroClipboardEvent */](x: Self & EventListenerObject[T]) {
      ...
      inline def setHandleEvent(value: T => Callback): Self = StObject.set(x, "handleEvent", js.Any.fromFunction1((t0: T) => value(t0).runNow()))
    }
  }
  ...
  object List {
    ...
    inline def apply[T](length: Double): typingsJapgolly.zeroclipboard.ZC.List[T] = {
      val __obj = js.Dynamic.literal(length = length.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.zeroclipboard.ZC.List[T]]
    }
    
    extension [Self <: typingsJapgolly.zeroclipboard.ZC.List[?], T](x: Self & typingsJapgolly.zeroclipboard.ZC.List[T]) {
  ...
  trait ZeroClipboardClient
    ...
    /**
      ...
      * @return {ZeroClipboardClient}
      */
    def clip(elements: typingsJapgolly.zeroclipboard.ZC.List[Element]): ZeroClipboardClient = js.native
    ...
    /**
      ...
      * @return {ZeroClipboardClient}
      */
    def unclip(elements: typingsJapgolly.zeroclipboard.ZC.List[Element]): ZeroClipboardClient = js.native
  }
  ...
  trait ZeroClipboardStatic
    extends StObject
       ...
       with Instantiable1[
          (/* elements */ Element) | (/* elements */ typingsJapgolly.zeroclipboard.ZC.List[Element]), 
          ZeroClipboardClient
        ] {
