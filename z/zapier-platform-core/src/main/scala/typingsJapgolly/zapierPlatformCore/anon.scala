...
object anon {
  ...
  object Get {
    ...
    inline def apply(get: CallbackTo[js.Promise[String]], set: String => js.Promise[Null]): Get = {
    ...
    extension [Self <: Get](x: Self) {
      ...
      inline def setGet(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "get", value.toJsFn)
