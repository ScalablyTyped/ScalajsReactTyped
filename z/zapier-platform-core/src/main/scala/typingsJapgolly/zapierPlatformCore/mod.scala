...
import typingsJapgolly.zapierPlatformCore.anon.Body
import typingsJapgolly.zapierPlatformCore.anon.CustomStoreKey
import typingsJapgolly.zapierPlatformCore.anon.Error
import typingsJapgolly.zapierPlatformCore.anon.Get
import typingsJapgolly.zapierPlatformCore.anon.HttpRequestOptionsrawtrue
import typingsJapgolly.zapierPlatformCore.anon.HttpRequestOptionsrawtrueAgent
import typingsJapgolly.zapierPlatformCore.anon.HttpRequestOptionsurlstri
import typingsJapgolly.zapierPlatformCore.anon.Id
import typingsJapgolly.zapierPlatformCore.anon.Inject
import typingsJapgolly.zapierPlatformCore.anon.IsBulkRead
import typingsJapgolly.zapierPlatformCore.anon.Parse
import typingsJapgolly.zapierPlatformCore.anon.PartialmethodHttpMethodqu
import typingsJapgolly.zapierPlatformCore.anon.PartialmethodHttpMethodquContent
...
object mod {
  ...
  object BaseHttpResponse {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getHeader = js.Any.fromFunction1(getHeader), headers = headers.asInstanceOf[js.Any], request = request.asInstanceOf[js.Any], skipThrowForStatus = skipThrowForStatus.asInstanceOf[js.Any], status = status.asInstanceOf[js.Any], throwForStatus = throwForStatus.toJsFn)
    ...
    extension [Self <: BaseHttpResponse](x: Self) {
      ...
      inline def setThrowForStatus(value: Callback): Self = StObject.set(x, "throwForStatus", value.toJsFn)
    }
  }
  ...
  */
  ...
  object HttpMethod {
    ...
    inline def DELETE: typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.DELETE = "DELETE".asInstanceOf[typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.DELETE]
    
    inline def GET: typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.GET = "GET".asInstanceOf[typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.GET]
    
    inline def HEAD: typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.HEAD = "HEAD".asInstanceOf[typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.HEAD]
    
    inline def OPTIONS: typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.OPTIONS = "OPTIONS".asInstanceOf[typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.OPTIONS]
    
    inline def PATCH: typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.PATCH = "PATCH".asInstanceOf[typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.PATCH]
    
    inline def POST: typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.POST = "POST".asInstanceOf[typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.POST]
    
    inline def PUT: typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.zapierPlatformCore.zapierPlatformCoreStrings.PUT]
  }
