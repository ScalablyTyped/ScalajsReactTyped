...
object anon {
  ...
  trait Agent extends StObject {
    ...
    var agent: js.UndefOr[
        typingsJapgolly.zipkinTransportHttp.mod.Agent | (js.Function1[/* url */ URL_, typingsJapgolly.zipkinTransportHttp.mod.Agent])
      ] = js.undefined
  ...
  object Agent {
    ...
    extension [Self <: Agent](x: Self) {
      ...
      inline def setAgent(
        value: typingsJapgolly.zipkinTransportHttp.mod.Agent | (js.Function1[/* url */ URL_, typingsJapgolly.zipkinTransportHttp.mod.Agent])
      ): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
      
      inline def setAgentFunction1(value: /* url */ URL_ => typingsJapgolly.zipkinTransportHttp.mod.Agent): Self = StObject.set(x, "agent", js.Any.fromFunction1(value))
