package typingsJapgolly.zipkinJavascriptOpentracing
...
object mod {
  ...
  open class ^ protected ()
    extends StObject
       with typingsJapgolly.zipkinJavascriptOpentracing.mod.zipkinJavascriptOpentracing {
  ...
  object zipkinJavascriptOpentracing {
    ...
    inline def apply(
      extract: (Any, Any) => Any,
      inject: (Any, Any, Any) => Callback,
      startSpan: (Any, /* repeated */ Any) => Any
    ): typingsJapgolly.zipkinJavascriptOpentracing.mod.zipkinJavascriptOpentracing = {
      val __obj = js.Dynamic.literal(extract = js.Any.fromFunction2(extract), inject = js.Any.fromFunction3((t0: Any, t1: Any, t2: Any) => (inject(t0, t1, t2)).runNow()), startSpan = js.Any.fromFunction2(startSpan))
      __obj.asInstanceOf[typingsJapgolly.zipkinJavascriptOpentracing.mod.zipkinJavascriptOpentracing]
    }
    
    extension [Self <: typingsJapgolly.zipkinJavascriptOpentracing.mod.zipkinJavascriptOpentracing](x: Self) {
      
      inline def setExtract(value: (Any, Any) => Any): Self = StObject.set(x, "extract", js.Any.fromFunction2(value))
      
      inline def setInject(value: (Any, Any, Any) => Callback): Self = StObject.set(x, "inject", js.Any.fromFunction3((t0: Any, t1: Any, t2: Any) => (value(t0, t1, t2)).runNow()))
