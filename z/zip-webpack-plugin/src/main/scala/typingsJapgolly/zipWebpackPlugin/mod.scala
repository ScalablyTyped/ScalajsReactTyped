package typingsJapgolly.zipWebpackPlugin
...
object mod {
  ...
  trait Options extends StObject {
    ...
    /**
      ...
      */
    var fileOptions: js.UndefOr[typingsJapgolly.zipWebpackPlugin.mod.fileOptions] = js.undefined
    ...
    /**
      ...
      */
    var zipOptions: js.UndefOr[typingsJapgolly.zipWebpackPlugin.mod.zipOptions] = js.undefined
  }
  object Options {
  ...
  object ZipPlugin {
    ...
    inline def apply(apply: Compiler => Callback): ZipPlugin = {
