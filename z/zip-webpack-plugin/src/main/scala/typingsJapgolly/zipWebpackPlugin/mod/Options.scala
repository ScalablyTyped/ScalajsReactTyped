...
object Options {
  ...
  def apply(
    ...
    path: String = null,
    pathMapper: /* assetPath */ String => CallbackTo[String] = null,
    ...
    if (pathMapper != null) __obj.updateDynamic("pathMapper")(js.Any.fromFunction1((t0: /* assetPath */ java.lang.String) => pathMapper(t0).runNow()))
