...
import typingsJapgolly.zwjsbridge.zwjsbridgeStrings.number
import typingsJapgolly.zwjsbridge.zwjsbridgeStrings.password
import typingsJapgolly.zwjsbridge.zwjsbridgeStrings.text
