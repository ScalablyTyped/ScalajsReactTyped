...
import typingsJapgolly.zchatBrowser.mod.Schedule
import typingsJapgolly.zchatBrowser.zchatBrowserStrings.account
import typingsJapgolly.zchatBrowser.zchatBrowserStrings.department
...
object anon {
  ...
  object Jwtfn {
    ...
    extension [Self <: Jwtfn](x: Self) {
      ...
      inline def setJwt_fn(value: /* callback */ js.Function1[/* jwt */ String, Unit] => Callback): Self = StObject.set(x, "jwt_fn", js.Any.fromFunction1((t0: /* callback */ js.Function1[/* jwt */ String, Unit]) => value(t0).runNow()))
