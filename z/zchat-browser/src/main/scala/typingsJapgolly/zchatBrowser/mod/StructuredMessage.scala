...
import typingsJapgolly.zchatBrowser.zchatBrowserStrings.BUTTON_TEMPLATE
...
object StructuredMessage {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.zchatBrowser.mod.StructuredMessage.QuickReplies
    - typingsJapgolly.zchatBrowser.mod.StructuredMessage.ButtonTemplate
    - typingsJapgolly.zchatBrowser.mod.StructuredMessage.PanelTemplate
    - typingsJapgolly.zchatBrowser.mod.StructuredMessage.PanelTemplateCarousel
    - typingsJapgolly.zchatBrowser.mod.StructuredMessage.ListTemplate
  */
  trait Message extends StObject
  object Message {
    
    inline def ButtonTemplate(buttons: js.Array[Button[QUICK_REPLY_ACTION | LINK_ACTION]], msg: String): typingsJapgolly.zchatBrowser.mod.StructuredMessage.ButtonTemplate = {
      val __obj = js.Dynamic.literal(buttons = buttons.asInstanceOf[js.Any], msg = msg.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("BUTTON_TEMPLATE")
      __obj.asInstanceOf[typingsJapgolly.zchatBrowser.mod.StructuredMessage.ButtonTemplate]
    }
    
    inline def ListTemplate(items: js.Array[ListItem]): typingsJapgolly.zchatBrowser.mod.StructuredMessage.ListTemplate = {
      val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("LIST_TEMPLATE")
      __obj.asInstanceOf[typingsJapgolly.zchatBrowser.mod.StructuredMessage.ListTemplate]
    }
    
    inline def PanelTemplate(panel: Panel): typingsJapgolly.zchatBrowser.mod.StructuredMessage.PanelTemplate = {
      val __obj = js.Dynamic.literal(panel = panel.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("PANEL_TEMPLATE")
      __obj.asInstanceOf[typingsJapgolly.zchatBrowser.mod.StructuredMessage.PanelTemplate]
    }
    
    inline def PanelTemplateCarousel(items: js.Array[PanelTemplate]): typingsJapgolly.zchatBrowser.mod.StructuredMessage.PanelTemplateCarousel = {
      val __obj = js.Dynamic.literal(items = items.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("PANEL_TEMPLATE_CAROUSEL")
      __obj.asInstanceOf[typingsJapgolly.zchatBrowser.mod.StructuredMessage.PanelTemplateCarousel]
    }
    
    inline def QuickReplies(msg: String, quick_replies: js.Array[Button[QUICK_REPLY_ACTION]]): typingsJapgolly.zchatBrowser.mod.StructuredMessage.QuickReplies = {
      ...
      __obj.asInstanceOf[typingsJapgolly.zchatBrowser.mod.StructuredMessage.QuickReplies]
    }
  }
