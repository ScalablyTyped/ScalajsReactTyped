package typingsJapgolly.zSchema
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setCustomValidator(value: (/* report */ Report, /* schema */ Any, /* json */ Any) => Callback): Self = StObject.set(x, "customValidator", js.Any.fromFunction3((t0: /* report */ Report, t1: /* schema */ Any, t2: /* json */ Any) => (value(t0, t1, t2)).runNow()))
  ...
  object Report {
    ...
    inline def apply(
      addCustomError: (String, String, js.Array[String], String, String) => Callback,
      errors: js.Array[SchemaErrorDetail],
      isValid: CallbackTo[Boolean]
    ): Report = {
      val __obj = js.Dynamic.literal(addCustomError = js.Any.fromFunction5((t0: String, t1: String, t2: js.Array[String], t3: String, t4: String) => (addCustomError(t0, t1, t2, t3, t4)).runNow()), errors = errors.asInstanceOf[js.Any], isValid = isValid.toJsFn)
      __obj.asInstanceOf[Report]
    }
    
    extension [Self <: Report](x: Self) {
      
      inline def setAddCustomError(value: (String, String, js.Array[String], String, String) => Callback): Self = StObject.set(x, "addCustomError", js.Any.fromFunction5((t0: String, t1: String, t2: js.Array[String], t3: String, t4: String) => (value(t0, t1, t2, t3, t4)).runNow()))
