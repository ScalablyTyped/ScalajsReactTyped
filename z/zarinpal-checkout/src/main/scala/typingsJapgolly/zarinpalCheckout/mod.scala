package typingsJapgolly.zarinpalCheckout
...
object mod {
  ...
  object ZarinPalInstance {
    ...
    inline def apply(
      ...
      UnverifiedTransactions: CallbackTo[js.Promise[UnverifiedTransactionsOutput]]
    ): ZarinPalInstance = {
      val __obj = js.Dynamic.literal(PaymentRequest = js.Any.fromFunction1(PaymentRequest), PaymentVerification = js.Any.fromFunction1(PaymentVerification), RefreshAuthority = js.Any.fromFunction1(RefreshAuthority), UnverifiedTransactions = UnverifiedTransactions.toJsFn)
    ...
    extension [Self <: ZarinPalInstance](x: Self) {
      ...
      inline def setUnverifiedTransactions(value: CallbackTo[js.Promise[UnverifiedTransactionsOutput]]): Self = StObject.set(x, "UnverifiedTransactions", value.toJsFn)
    }
  }
}
