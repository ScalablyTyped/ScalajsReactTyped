...
import typingsJapgolly.zipkin.anon.Ipv4
...
object model {
  ...
  open class Span protected () extends StObject {
    ...
    val annotations: js.Array[typingsJapgolly.zipkin.mod.model.Annotation] = js.native
  ...
  object Annotation {
    ...
    inline def apply(timestamp: Double, value: String): typingsJapgolly.zipkin.mod.model.Annotation = {
      val __obj = js.Dynamic.literal(timestamp = timestamp.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.zipkin.mod.model.Annotation]
    }
    
    extension [Self <: typingsJapgolly.zipkin.mod.model.Annotation](x: Self) {
