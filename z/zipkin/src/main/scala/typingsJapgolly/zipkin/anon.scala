...
import typingsJapgolly.zipkin.mod.Recorder
import typingsJapgolly.zipkin.mod.TraceId
import typingsJapgolly.zipkin.mod.Tracer
import typingsJapgolly.zipkin.mod.model.Endpoint
import typingsJapgolly.zipkin.mod.option.IOption
import typingsJapgolly.zipkin.mod.sampler.Sampler
import typingsJapgolly.zipkin.zipkinStrings.`1`
...
object anon {
  ...
  trait Logger extends StObject {
    ...
    var logger: typingsJapgolly.zipkin.mod.Logger
    
    var timeout: js.UndefOr[Double] = js.undefined
  }
  object Logger {
    
    inline def apply(logger: typingsJapgolly.zipkin.mod.Logger): Logger = {
    ...
    extension [Self <: Logger](x: Self) {
      ...
      inline def setLogger(value: typingsJapgolly.zipkin.mod.Logger): Self = StObject.set(x, "logger", value.asInstanceOf[js.Any])
  ...
  trait XB3Flags extends StObject {
    ...
    var `X-B3-Flags`: js.UndefOr[`1` | typingsJapgolly.zipkin.zipkinStrings.`0`] = js.undefined
    
    var `X-B3-ParentSpanId`: js.UndefOr[String] = js.undefined
    
    var `X-B3-Sampled`: js.UndefOr[`1` | typingsJapgolly.zipkin.zipkinStrings.`0`] = js.undefined
  ...
  object XB3Flags {
    ...
    extension [Self <: XB3Flags](x: Self) {
      ...
      inline def `setX-B3-Flags`(value: `1` | typingsJapgolly.zipkin.zipkinStrings.`0`): Self = StObject.set(x, "X-B3-Flags", value.asInstanceOf[js.Any])
      ...
      inline def `setX-B3-Sampled`(value: `1` | typingsJapgolly.zipkin.zipkinStrings.`0`): Self = StObject.set(x, "X-B3-Sampled", value.asInstanceOf[js.Any])
