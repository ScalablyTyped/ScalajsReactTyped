...
import typingsJapgolly.angularDevkitSchematics.anon.ReadonlyFileEntry
...
object srcTreeInterfaceMod {
  ...
  object MergeStrategy extends StObject {
    ...
    sealed trait AllowCreationConflict
      extends StObject
         with MergeStrategy
    /* 4 */ val AllowCreationConflict: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy.AllowCreationConflict & Double = js.native
    
    @js.native
    sealed trait AllowDeleteConflict
      extends StObject
         with MergeStrategy
    /* 8 */ val AllowDeleteConflict: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy.AllowDeleteConflict & Double = js.native
    
    @js.native
    sealed trait AllowOverwriteConflict
      extends StObject
         with MergeStrategy
    /* 2 */ val AllowOverwriteConflict: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy.AllowOverwriteConflict & Double = js.native
    
    @js.native
    sealed trait ContentOnly
      extends StObject
         with MergeStrategy
    /* 2 */ val ContentOnly: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy.ContentOnly & Double = js.native
    
    @js.native
    sealed trait Default
      extends StObject
         with MergeStrategy
    /* 0 */ val Default: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy.Default & Double = js.native
    
    @js.native
    sealed trait Error
      extends StObject
         with MergeStrategy
    /* 1 */ val Error: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy.Error & Double = js.native
    
    @js.native
    sealed trait Overwrite
      extends StObject
         with MergeStrategy
    /* 14 */ val Overwrite: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy.Overwrite & Double = js.native
  }
  ...
  object DirEntry {
    ...
    inline def apply(
      ...
      visit: FileVisitor => Callback
    ): DirEntry = {
      val __obj = js.Dynamic.literal(dir = js.Any.fromFunction1(dir), file = js.Any.fromFunction1(file), path = path.asInstanceOf[js.Any], subdirs = subdirs.asInstanceOf[js.Any], subfiles = subfiles.asInstanceOf[js.Any], visit = js.Any.fromFunction1((t0: FileVisitor) => visit(t0).runNow()), parent = null)
    ...
    extension [Self <: DirEntry](x: Self) {
      ...
      inline def setVisit(value: FileVisitor => Callback): Self = StObject.set(x, "visit", js.Any.fromFunction1((t0: FileVisitor) => value(t0).runNow()))
    }
  }
