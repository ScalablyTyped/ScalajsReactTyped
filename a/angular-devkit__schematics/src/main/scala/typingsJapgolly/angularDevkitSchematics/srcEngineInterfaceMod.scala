...
import typingsJapgolly.angularDevkitSchematics.anon.Extends
...
object srcEngineInterfaceMod {
  ...
  type SchematicDescription[CollectionMetadataT /* <: js.Object */, SchematicMetadataT /* <: js.Object */] = SchematicMetadataT & typingsJapgolly.angularDevkitSchematics.anon.Collection[CollectionMetadataT]
  ...
  object TaskConfigurationGenerator {
    ...
    inline def apply[T](toConfiguration: CallbackTo[TaskConfiguration[T]]): TaskConfigurationGenerator[T] = {
      val __obj = js.Dynamic.literal(toConfiguration = toConfiguration.toJsFn)
    ...
    extension [Self <: TaskConfigurationGenerator[?], T](x: Self & TaskConfigurationGenerator[T]) {
      ...
      inline def setToConfiguration(value: CallbackTo[TaskConfiguration[T]]): Self = StObject.set(x, "toConfiguration", value.toJsFn)
    }
  }
