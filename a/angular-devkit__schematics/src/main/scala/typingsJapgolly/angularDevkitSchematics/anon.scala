...
object anon {
  ...
  trait Collection[CollectionMetadataT /* <: js.Object */] extends StObject {
    ...
    val collection: typingsJapgolly.angularDevkitSchematics.srcEngineInterfaceMod.CollectionDescription[CollectionMetadataT]
  ...
  object Collection {
    ...
    inline def apply[CollectionMetadataT /* <: js.Object */](
      collection: typingsJapgolly.angularDevkitSchematics.srcEngineInterfaceMod.CollectionDescription[CollectionMetadataT],
      name: String
    ...
    extension [Self <: Collection[?], CollectionMetadataT /* <: js.Object */](x: Self & Collection[CollectionMetadataT]) {
      ...
      inline def setCollection(
        value: typingsJapgolly.angularDevkitSchematics.srcEngineInterfaceMod.CollectionDescription[CollectionMetadataT]
