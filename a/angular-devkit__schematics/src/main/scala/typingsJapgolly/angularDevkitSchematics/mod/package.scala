...
import typingsJapgolly.angularDevkitSchematics.anon.PartialExecutionOptions
import typingsJapgolly.angularDevkitSchematics.mod.^
import typingsJapgolly.angularDevkitSchematics.srcEngineInterfaceMod.FileOperator
...
import typingsJapgolly.angularDevkitSchematics.srcRulesRandomMod.RandomOptions
import typingsJapgolly.angularDevkitSchematics.srcRulesTemplateMod.PathTemplateData
import typingsJapgolly.angularDevkitSchematics.srcRulesTemplateMod.PathTemplateOptions
...
type Tree = typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree
...
inline def branchAndMerge(rule: Rule, strategy: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy): Rule = (^.asInstanceOf[js.Dynamic].applyDynamic("branchAndMerge")(rule.asInstanceOf[js.Any], strategy.asInstanceOf[js.Any])).asInstanceOf[Rule]

inline def callRule(
  rule: Rule,
  input: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree,
  context: SchematicContext
): Observable_[typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree] = (^.asInstanceOf[js.Dynamic].applyDynamic("callRule")(rule.asInstanceOf[js.Any], input.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Observable_[typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree]]
inline def callRule(
  rule: Rule,
  input: Observable_[typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree],
  context: SchematicContext
): Observable_[typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree] = (^.asInstanceOf[js.Dynamic].applyDynamic("callRule")(rule.asInstanceOf[js.Any], input.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Observable_[typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree]]

inline def callSource(source: Source, context: SchematicContext): Observable_[typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree] = (^.asInstanceOf[js.Dynamic].applyDynamic("callSource")(source.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[Observable_[typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree]]
...
inline def mergeWith(
  source: Source,
  strategy: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.MergeStrategy
): Rule = (^.asInstanceOf[js.Dynamic].applyDynamic("mergeWith")(source.asInstanceOf[js.Any], strategy.asInstanceOf[js.Any])).asInstanceOf[Rule]
...
inline def source(tree: typingsJapgolly.angularDevkitSchematics.srcTreeInterfaceMod.Tree): Source = ^.asInstanceOf[js.Dynamic].applyDynamic("source")(tree.asInstanceOf[js.Any]).asInstanceOf[Source]
