...
import typingsJapgolly.awsSdkMiddlewareBucketEndpoint.anon.AccelerateEndpoint
import typingsJapgolly.awsSdkMiddlewareBucketEndpoint.anon.AccesspointName
import typingsJapgolly.awsSdkMiddlewareBucketEndpoint.anon.AllowFipsRegion
import typingsJapgolly.awsSdkMiddlewareBucketEndpoint.anon.ClientPartition
import typingsJapgolly.awsSdkMiddlewareBucketEndpoint.anon.DualstackEndpoint
import typingsJapgolly.awsSdkMiddlewareBucketEndpoint.anon.TlsCompatible
import typingsJapgolly.awsSdkUtilArnParser.mod.ARN
...
object distTypesBucketHostnameUtilsMod {
  ...
  object ArnHostnameParams {
    ...
    inline def apply(baseHostname: String, bucketName: ARN, clientRegion: String, isCustomEndpoint: Boolean): ArnHostnameParams = {
      val __obj = js.Dynamic.literal(baseHostname = baseHostname.asInstanceOf[js.Any], bucketName = bucketName.asInstanceOf[js.Any], clientRegion = clientRegion.asInstanceOf[js.Any], isCustomEndpoint = isCustomEndpoint.asInstanceOf[js.Any])
  ...
  object BucketHostnameParams {
    ...
    inline def apply(baseHostname: String, bucketName: String, clientRegion: String, isCustomEndpoint: Boolean): BucketHostnameParams = {
      val __obj = js.Dynamic.literal(baseHostname = baseHostname.asInstanceOf[js.Any], bucketName = bucketName.asInstanceOf[js.Any], clientRegion = clientRegion.asInstanceOf[js.Any], isCustomEndpoint = isCustomEndpoint.asInstanceOf[js.Any])
