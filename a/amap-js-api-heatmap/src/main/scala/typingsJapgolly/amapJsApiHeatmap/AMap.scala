...
import typingsJapgolly.amapJsApiHeatmap.anon.Data
import typingsJapgolly.amapJsApiHeatmap.anon.DrawGridLine
...
object AMap {
  ...
  object Heatmap {
    ...
    object Data {
      ...
      inline def apply(count: Double, lat: Double, lng: Double): typingsJapgolly.amapJsApiHeatmap.AMap.Heatmap.Data = {
        val __obj = js.Dynamic.literal(count = count.asInstanceOf[js.Any], lat = lat.asInstanceOf[js.Any], lng = lng.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.amapJsApiHeatmap.AMap.Heatmap.Data]
      }
      
      extension [Self <: typingsJapgolly.amapJsApiHeatmap.AMap.Heatmap.Data](x: Self) {
    ...
    trait DataSet extends StObject {
      ...
      /**
        * 坐标数据集
        */
      var data: js.Array[typingsJapgolly.amapJsApiHeatmap.AMap.Heatmap.Data]
    ...
    object DataSet {
      ...
      inline def apply(data: js.Array[typingsJapgolly.amapJsApiHeatmap.AMap.Heatmap.Data]): DataSet = {
      ...
      extension [Self <: DataSet](x: Self) {
        ...
        inline def setData(value: js.Array[typingsJapgolly.amapJsApiHeatmap.AMap.Heatmap.Data]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
        
        inline def setDataVarargs(value: typingsJapgolly.amapJsApiHeatmap.AMap.Heatmap.Data*): Self = StObject.set(x, "data", js.Array(value*))
