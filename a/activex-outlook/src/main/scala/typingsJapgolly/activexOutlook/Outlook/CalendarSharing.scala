...
object CalendarSharing {
  ...
  extension [Self <: CalendarSharing](x: Self) {
    ...
    inline def setSaveAsICal(value: String => Callback): Self = StObject.set(x, "SaveAsICal", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
