...
object OlRecipientSelectors {
  ...
  inline def olShowNone: `0` = 0.asInstanceOf[`0`]
  
  inline def olShowTo: `1` = 1.asInstanceOf[`1`]
  
  inline def olShowToCc: `2` = 2.asInstanceOf[`2`]
  
  inline def olShowToCcBcc: `3` = 3.asInstanceOf[`3`]
}
