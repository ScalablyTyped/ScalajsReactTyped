...
object SolutionsModule {
  ...
  inline def apply(
    AddSolution: (Folder, OlSolutionScope) => Callback,
  ...
  extension [Self <: SolutionsModule](x: Self) {
    ...
    inline def setAddSolution(value: (Folder, OlSolutionScope) => Callback): Self = StObject.set(x, "AddSolution", js.Any.fromFunction2((t0: Folder, t1: OlSolutionScope) => (value(t0, t1)).runNow()))
