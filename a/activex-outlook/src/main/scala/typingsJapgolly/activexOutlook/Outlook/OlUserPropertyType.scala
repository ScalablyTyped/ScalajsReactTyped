...
object OlUserPropertyType {
  ...
  inline def olCombination: `19` = 19.asInstanceOf[`19`]
  
  inline def olCurrency: `14` = 14.asInstanceOf[`14`]
  
  inline def olDateTime: `5` = 5.asInstanceOf[`5`]
  
  inline def olDuration: `7` = 7.asInstanceOf[`7`]
  
  inline def olEnumeration: `21` = 21.asInstanceOf[`21`]
  
  inline def olFormula: `18` = 18.asInstanceOf[`18`]
  
  inline def olInteger: `20` = 20.asInstanceOf[`20`]
  
  inline def olKeywords: `11` = 11.asInstanceOf[`11`]
  
  inline def olNumber: `3` = 3.asInstanceOf[`3`]
  
  inline def olOutlookInternal: `0` = 0.asInstanceOf[`0`]
  
  inline def olPercent: `12` = 12.asInstanceOf[`12`]
  
  inline def olSmartFrom: `22` = 22.asInstanceOf[`22`]
  
  inline def olText: `1` = 1.asInstanceOf[`1`]
  
  inline def olYesNo: `6` = 6.asInstanceOf[`6`]
}
