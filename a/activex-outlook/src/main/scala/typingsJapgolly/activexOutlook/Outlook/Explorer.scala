...
class Explorer protected () extends js.Object {
  val AccountSelector: typingsJapgolly.activexOutlook.Outlook.AccountSelector = js.native
  ...
  val NavigationPane: typingsJapgolly.activexOutlook.Outlook.NavigationPane = js.native
  @JSName("Outlook.Explorer_typekey")
  var OutlookDotExplorer_typekey: Explorer = js.native
  val Panes: typingsJapgolly.activexOutlook.Outlook.Panes = js.native
  val Parent: js.Any = js.native
  val Selection: typingsJapgolly.activexOutlook.Outlook.Selection = js.native
