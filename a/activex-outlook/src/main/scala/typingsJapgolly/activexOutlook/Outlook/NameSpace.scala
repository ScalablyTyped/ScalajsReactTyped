...
trait NameSpace extends StObject {
  ...
  val Accounts: typingsJapgolly.activexOutlook.Outlook.Accounts = js.native
  
  def AddStore(Store: Any): Unit = js.native
  
  def AddStoreEx(Store: Any, Type: OlStoreType): Unit = js.native
  
  val AddressLists: typingsJapgolly.activexOutlook.Outlook.AddressLists = js.native
  ...
  val Stores: typingsJapgolly.activexOutlook.Outlook.Stores = js.native
  
  val SyncObjects: typingsJapgolly.activexOutlook.Outlook.SyncObjects = js.native
