...
object OlMeetingRecipientType {
  ...
  inline def olOptional: `2` = 2.asInstanceOf[`2`]
  
  inline def olOrganizer: `0` = 0.asInstanceOf[`0`]
  
  inline def olRequired: `1` = 1.asInstanceOf[`1`]
  
  inline def olResource: `3` = 3.asInstanceOf[`3`]
}
