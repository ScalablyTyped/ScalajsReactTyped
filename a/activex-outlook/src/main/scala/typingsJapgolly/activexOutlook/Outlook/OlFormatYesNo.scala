...
*/
trait OlFormatYesNo extends StObject
object OlFormatYesNo {
  
  inline def olFormatYesNoIcon: `4` = 4.asInstanceOf[`4`]
  
  inline def olFormatYesNoOnOff: `2` = 2.asInstanceOf[`2`]
  
  inline def olFormatYesNoTrueFalse: `3` = 3.asInstanceOf[`3`]
  
  inline def olFormatYesNoYesNo: `1` = 1.asInstanceOf[`1`]
}
