...
*/
trait OlFormatNumber extends StObject
object OlFormatNumber {
  
  inline def olFormatNumber1Decimal: `3` = 3.asInstanceOf[`3`]
  
  inline def olFormatNumber2Decimal: `4` = 4.asInstanceOf[`4`]
  
  inline def olFormatNumberAllDigits: `1` = 1.asInstanceOf[`1`]
  
  inline def olFormatNumberComputer1: `6` = 6.asInstanceOf[`6`]
  
  inline def olFormatNumberComputer2: `7` = 7.asInstanceOf[`7`]
  
  inline def olFormatNumberComputer3: `8` = 8.asInstanceOf[`8`]
  
  inline def olFormatNumberRaw: `9` = 9.asInstanceOf[`9`]
  
  inline def olFormatNumberScientific: `5` = 5.asInstanceOf[`5`]
  
  inline def olFormatNumberTruncated: `2` = 2.asInstanceOf[`2`]
}
