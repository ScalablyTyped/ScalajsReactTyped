...
*/
trait OlSensitivity extends StObject
object OlSensitivity {
  
  inline def olConfidential: `3` = 3.asInstanceOf[`3`]
  
  inline def olNormal: `0` = 0.asInstanceOf[`0`]
  
  inline def olPersonal: `1` = 1.asInstanceOf[`1`]
  
  inline def olPrivate: `2` = 2.asInstanceOf[`2`]
}
