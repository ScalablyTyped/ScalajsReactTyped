...
class TableView protected () extends js.Object {
  ...
  val AutoFormatRules: typingsJapgolly.activexOutlook.Outlook.AutoFormatRules = js.native
  ...
  val ViewFields: typingsJapgolly.activexOutlook.Outlook.ViewFields = js.native
