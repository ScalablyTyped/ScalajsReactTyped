...
*/
trait OlDisplayType extends StObject
object OlDisplayType {
  
  inline def olAgent: `3` = 3.asInstanceOf[`3`]
  
  inline def olDistList: `1` = 1.asInstanceOf[`1`]
  
  inline def olForum: `2` = 2.asInstanceOf[`2`]
  
  inline def olOrganization: `4` = 4.asInstanceOf[`4`]
  
  inline def olPrivateDistList: `5` = 5.asInstanceOf[`5`]
  
  inline def olRemoteUser: `6` = 6.asInstanceOf[`6`]
  
  inline def olUser: `0` = 0.asInstanceOf[`0`]
}
