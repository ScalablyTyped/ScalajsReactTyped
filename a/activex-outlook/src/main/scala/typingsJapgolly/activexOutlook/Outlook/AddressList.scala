...
trait AddressList extends StObject {
  ...
  val AddressEntries: typingsJapgolly.activexOutlook.Outlook.AddressEntries
...
object AddressList {
  ...
  inline def apply(
    ...
    Class: OlObjectClass,
    GetContactsFolder: CallbackTo[Folder],
    ID: String,
    Index: Double,
  ...
  extension [Self <: AddressList](x: Self) {
    ...
    inline def setGetContactsFolder(value: CallbackTo[Folder]): Self = StObject.set(x, "GetContactsFolder", value.toJsFn)
