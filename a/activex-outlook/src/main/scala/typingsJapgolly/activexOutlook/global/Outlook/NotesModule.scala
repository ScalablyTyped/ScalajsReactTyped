...
@js.native
/* private */ open class NotesModule ()
  extends StObject
     with typingsJapgolly.activexOutlook.Outlook.NotesModule {
  ...
  /* CompleteClass */
  override val NavigationGroups: typingsJapgolly.activexOutlook.Outlook.NavigationGroups = js.native
  ...
  var OutlookDotNotesModule_typekey: typingsJapgolly.activexOutlook.Outlook.NotesModule = js.native
