...
/* private */ open class Stores ()
  extends StObject
     with typingsJapgolly.activexOutlook.Outlook.Stores {
  ...
  /* CompleteClass */
  override def Item(Index: Any): typingsJapgolly.activexOutlook.Outlook.Store = js.native
  
  /* private */ /* CompleteClass */
  @JSName("Outlook.Stores_typekey")
  var OutlookDotStores_typekey: typingsJapgolly.activexOutlook.Outlook.Stores = js.native
