...
@js.native
/* private */ open class MailModule ()
  extends StObject
     with typingsJapgolly.activexOutlook.Outlook.MailModule {
  ...
  var OutlookDotMailModule_typekey: typingsJapgolly.activexOutlook.Outlook.MailModule = js.native
