...
/* private */ open class AccountRuleCondition ()
  extends StObject
     with typingsJapgolly.activexOutlook.Outlook.AccountRuleCondition {
  
  /* CompleteClass */
  var Account: typingsJapgolly.activexOutlook.Outlook.Account = js.native
  ...
  var OutlookDotAccountRuleCondition_typekey: typingsJapgolly.activexOutlook.Outlook.AccountRuleCondition = js.native
