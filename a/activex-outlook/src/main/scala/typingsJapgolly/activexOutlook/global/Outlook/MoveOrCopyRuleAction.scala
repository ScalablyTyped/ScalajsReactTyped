...
/* private */ open class MoveOrCopyRuleAction ()
  extends StObject
     with typingsJapgolly.activexOutlook.Outlook.MoveOrCopyRuleAction {
  ...
  var OutlookDotMoveOrCopyRuleAction_typekey: typingsJapgolly.activexOutlook.Outlook.MoveOrCopyRuleAction = js.native
