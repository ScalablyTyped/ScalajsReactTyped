...
object global {
  ...
  object Shell32 {
    ...
    /* private */ open class FileSearchBand ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.FileSearchBand
    ...
    /* private */ open class Folder3 ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.Folder3
    ...
    /* private */ open class FolderItemVerb ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.FolderItemVerb {
      ...
      var Shell32DotFolderItemVerb_typekey: typingsJapgolly.activexShell.Shell32.FolderItemVerb = js.native
    }
    ...
    /* private */ open class FolderItemVerbs ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.FolderItemVerbs
    ...
    /* private */ open class FolderItems3 ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.FolderItems3
    ...
    /* private */ open class Shell ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.Shell
    ...
    /* private */ open class ShellDispatchInproc ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.ShellDispatchInproc {
      
      /* private */ /* CompleteClass */
      @JSName("Shell32.ShellDispatchInproc_typekey")
      var Shell32DotShellDispatchInproc_typekey: typingsJapgolly.activexShell.Shell32.ShellDispatchInproc = js.native
    }
    ...
    /* private */ open class ShellFolderItem ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.ShellFolderItem
    ...
    /* private */ open class ShellFolderView ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.ShellFolderView
    ...
    /* private */ open class ShellFolderViewOC ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.ShellFolderViewOC {
      
      /** Set the ShellFolderView object to monitor events of. */
      /* CompleteClass */
      override def SetFolderView(pdisp: typingsJapgolly.activexShell.Shell32.ShellFolderView): Unit = js.native
      
      /* private */ /* CompleteClass */
      @JSName("Shell32.ShellFolderViewOC_typekey")
      var Shell32DotShellFolderViewOC_typekey: typingsJapgolly.activexShell.Shell32.ShellFolderViewOC = js.native
    }
    ...
    /* private */ open class ShellLinkObject ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.ShellLinkObject
    
    @JSGlobal("Shell32.ShellWindows")
    @js.native
    /* private */ open class ShellWindows ()
      extends StObject
         with typingsJapgolly.activexShell.Shell32.ShellWindows
  }
}
