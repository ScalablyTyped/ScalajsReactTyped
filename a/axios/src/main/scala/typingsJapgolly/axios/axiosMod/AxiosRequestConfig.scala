...
import typingsJapgolly.axios.axiosNumbers.`false`
...
object AxiosRequestConfig {
  ...
  def apply(
    ...
    if (adapter != null) __obj.updateDynamic("adapter")(js.Any.fromFunction1((t0: /* config */ typingsJapgolly.axios.axiosMod.AxiosRequestConfig) => adapter(t0).runNow()))
