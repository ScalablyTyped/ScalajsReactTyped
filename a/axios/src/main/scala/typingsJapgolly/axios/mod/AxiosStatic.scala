...
import typingsJapgolly.axios.anon.TypeofAxiosError
...
trait AxiosStatic extends AxiosInstance {
  ...
  var Axios: Instantiable1[/* config */ js.UndefOr[AxiosRequestConfig[Any]], typingsJapgolly.axios.mod.Axios] = js.native
