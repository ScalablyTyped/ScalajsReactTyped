...
import typingsJapgolly.axios.anon.FormData
import typingsJapgolly.axios.anon.Headers
import typingsJapgolly.axios.anon.PartialHeadersDefaults
...
trait CreateAxiosDefaults[D] extends StObject {
  ...
  var responseEncoding: js.UndefOr[typingsJapgolly.axios.mod.responseEncoding | String] = js.undefined
...
object CreateAxiosDefaults {
  ...
  extension [Self <: CreateAxiosDefaults[?], D](x: Self & CreateAxiosDefaults[D]) {
    ...
    inline def setBeforeRedirect(value: (/* options */ Record[String, Any], /* responseDetails */ Headers) => Callback): Self = StObject.set(x, "beforeRedirect", js.Any.fromFunction2((t0: /* options */ Record[String, Any], t1: /* responseDetails */ Headers) => (value(t0, t1)).runNow()))
    ...
    inline def setOnDownloadProgress(value: /* progressEvent */ AxiosProgressEvent => Callback): Self = StObject.set(x, "onDownloadProgress", js.Any.fromFunction1((t0: /* progressEvent */ AxiosProgressEvent) => value(t0).runNow()))
    
    inline def setOnDownloadProgressUndefined: Self = StObject.set(x, "onDownloadProgress", js.undefined)
    
    inline def setOnUploadProgress(value: /* progressEvent */ AxiosProgressEvent => Callback): Self = StObject.set(x, "onUploadProgress", js.Any.fromFunction1((t0: /* progressEvent */ AxiosProgressEvent) => value(t0).runNow()))
