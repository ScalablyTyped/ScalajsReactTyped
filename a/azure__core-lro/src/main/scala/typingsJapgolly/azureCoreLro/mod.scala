...
import typingsJapgolly.azureCoreLro.anon.AbortSignal
import typingsJapgolly.azureCoreLro.anon.FireProgress
...
object mod {
  ...
  object CreateHttpPollerOptions {
    ...
    extension [Self <: CreateHttpPollerOptions[?, ?], TResult, TState](x: Self & (CreateHttpPollerOptions[TResult, TState])) {
      ...
      inline def setUpdateState(value: (/* state */ TState, /* response */ LroResponse[Any]) => Callback): Self = StObject.set(x, "updateState", js.Any.fromFunction2((t0: /* state */ TState, t1: /* response */ LroResponse[Any]) => (value(t0, t1)).runNow()))
      
      inline def setUpdateStateUndefined: Self = StObject.set(x, "updateState", js.undefined)
      
      inline def setWithOperationLocation(value: /* operationLocation */ String => Callback): Self = StObject.set(x, "withOperationLocation", js.Any.fromFunction1((t0: /* operationLocation */ String) => value(t0).runNow()))
  ...
  object LroEngineOptions {
    ...
    extension [Self <: LroEngineOptions[?, ?], TResult, TState](x: Self & (LroEngineOptions[TResult, TState])) {
      ...
      inline def setUpdateState(value: (/* state */ TState, /* lastResponse */ RawResponse) => Callback): Self = StObject.set(x, "updateState", js.Any.fromFunction2((t0: /* state */ TState, t1: /* lastResponse */ RawResponse) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azureCoreLro.azureCoreLroStrings.`azure-async-operation`
    - typingsJapgolly.azureCoreLro.azureCoreLroStrings.location
    - typingsJapgolly.azureCoreLro.azureCoreLroStrings.`original-uri`
  */
  trait LroResourceLocationConfig extends StObject
  object LroResourceLocationConfig {
    
    inline def `azure-async-operation`: typingsJapgolly.azureCoreLro.azureCoreLroStrings.`azure-async-operation` = "azure-async-operation".asInstanceOf[typingsJapgolly.azureCoreLro.azureCoreLroStrings.`azure-async-operation`]
    
    inline def location: typingsJapgolly.azureCoreLro.azureCoreLroStrings.location = "location".asInstanceOf[typingsJapgolly.azureCoreLro.azureCoreLroStrings.location]
    
    inline def `original-uri`: typingsJapgolly.azureCoreLro.azureCoreLroStrings.`original-uri` = "original-uri".asInstanceOf[typingsJapgolly.azureCoreLro.azureCoreLroStrings.`original-uri`]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azureCoreLro.azureCoreLroStrings.notStarted
    - typingsJapgolly.azureCoreLro.azureCoreLroStrings.running
    - typingsJapgolly.azureCoreLro.azureCoreLroStrings.succeeded
    - typingsJapgolly.azureCoreLro.azureCoreLroStrings.canceled
    - typingsJapgolly.azureCoreLro.azureCoreLroStrings.failed
  */
  trait OperationStatus extends StObject
  object OperationStatus {
    
    inline def canceled: typingsJapgolly.azureCoreLro.azureCoreLroStrings.canceled = "canceled".asInstanceOf[typingsJapgolly.azureCoreLro.azureCoreLroStrings.canceled]
    
    inline def failed: typingsJapgolly.azureCoreLro.azureCoreLroStrings.failed = "failed".asInstanceOf[typingsJapgolly.azureCoreLro.azureCoreLroStrings.failed]
    
    inline def notStarted: typingsJapgolly.azureCoreLro.azureCoreLroStrings.notStarted = "notStarted".asInstanceOf[typingsJapgolly.azureCoreLro.azureCoreLroStrings.notStarted]
    
    inline def running: typingsJapgolly.azureCoreLro.azureCoreLroStrings.running = "running".asInstanceOf[typingsJapgolly.azureCoreLro.azureCoreLroStrings.running]
    
    inline def succeeded: typingsJapgolly.azureCoreLro.azureCoreLroStrings.succeeded = "succeeded".asInstanceOf[typingsJapgolly.azureCoreLro.azureCoreLroStrings.succeeded]
  }
