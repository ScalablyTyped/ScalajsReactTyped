package typingsJapgolly.azureCoreLro
...
object anon {
  ...
  object FireProgress {
    ...
    extension [Self <: FireProgress[?], TState](x: Self & FireProgress[TState]) {
      ...
      inline def setFireProgress(value: /* state */ TState => Callback): Self = StObject.set(x, "fireProgress", js.Any.fromFunction1((t0: /* state */ TState) => value(t0).runNow()))
