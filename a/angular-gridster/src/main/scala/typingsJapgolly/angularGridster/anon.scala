...
object anon {
  ...
  object Drag {
    ...
    extension [Self <: Drag](x: Self) {
      ...
      inline def setDrag(value: (/* event */ IAngularEvent, /* $element */ IAugmentedJQuery, /* options */ Any) => Callback): Self = StObject.set(x, "drag", js.Any.fromFunction3((t0: /* event */ IAngularEvent, t1: /* $element */ IAugmentedJQuery, t2: /* options */ Any) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setStart(value: (/* event */ IAngularEvent, /* $element */ IAugmentedJQuery, /* options */ Any) => Callback): Self = StObject.set(x, "start", js.Any.fromFunction3((t0: /* event */ IAngularEvent, t1: /* $element */ IAugmentedJQuery, t2: /* options */ Any) => (value(t0, t1, t2)).runNow()))
      
      inline def setStartUndefined: Self = StObject.set(x, "start", js.undefined)
      
      inline def setStop(value: (/* event */ IAngularEvent, /* $element */ IAugmentedJQuery, /* options */ Any) => Callback): Self = StObject.set(x, "stop", js.Any.fromFunction3((t0: /* event */ IAngularEvent, t1: /* $element */ IAugmentedJQuery, t2: /* options */ Any) => (value(t0, t1, t2)).runNow()))
  ...
  object Enabled {
    ...
    extension [Self <: Enabled](x: Self) {
      ...
      inline def setResize(value: (/* event */ IAngularEvent, /* $element */ IAugmentedJQuery, /* options */ Any) => Callback): Self = StObject.set(x, "resize", js.Any.fromFunction3((t0: /* event */ IAngularEvent, t1: /* $element */ IAugmentedJQuery, t2: /* options */ Any) => (value(t0, t1, t2)).runNow()))
