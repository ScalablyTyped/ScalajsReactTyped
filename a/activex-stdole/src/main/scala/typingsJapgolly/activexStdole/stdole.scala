...
import typingsJapgolly.activexStdole.activexStdoleInts.`0`
import typingsJapgolly.activexStdole.activexStdoleInts.`1`
import typingsJapgolly.activexStdole.activexStdoleInts.`2`
import typingsJapgolly.activexStdole.activexStdoleInts.`4`
...
object stdole {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.activexStdole.activexStdoleInts.`4`
    - typingsJapgolly.activexStdole.activexStdoleInts.`0`
    - typingsJapgolly.activexStdole.activexStdoleInts.`1`
    - typingsJapgolly.activexStdole.activexStdoleInts.`2`
  */
  ...
  */
  ...
  object StdPicture {
    ...
    inline def apply(
      Handle: Double,
      Height: Double,
      Render: (Double, Double, Double, Double, Double, Double, Double, Double, Double, Unit) => Callback,
      Type: Double,
      Width: Double,
      hPal: Double,
      stdoleDotStdPicture_typekey: StdPicture
    ): StdPicture = {
      val __obj = js.Dynamic.literal(Handle = Handle.asInstanceOf[js.Any], Height = Height.asInstanceOf[js.Any], Render = js.Any.fromFunction10((t0: Double, t1: Double, t2: Double, t3: Double, t4: Double, t5: Double, t6: Double, t7: Double, t8: Double, t9: Unit) => (Render(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9)).runNow()), Type = Type.asInstanceOf[js.Any], Width = Width.asInstanceOf[js.Any], hPal = hPal.asInstanceOf[js.Any])
    ...
    extension [Self <: StdPicture](x: Self) {
      ...
      inline def setRender(value: (Double, Double, Double, Double, Double, Double, Double, Double, Double, Unit) => Callback): Self = StObject.set(x, "Render", js.Any.fromFunction10((t0: Double, t1: Double, t2: Double, t3: Double, t4: Double, t5: Double, t6: Double, t7: Double, t8: Double, t9: Unit) => (value(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9)).runNow()))
