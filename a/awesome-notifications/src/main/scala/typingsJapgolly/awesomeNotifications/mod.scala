package typingsJapgolly.awesomeNotifications

import org.scalajs.dom.HTMLElement
import typingsJapgolly.awesomeNotifications.anon.Async
import typingsJapgolly.awesomeNotifications.anon.Asyncblock
import typingsJapgolly.awesomeNotifications.awesomeNotificationsBooleans.`false`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`bottom-right`
    - typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`bottom-left`
    - typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`top-left`
    - typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`top-right`
  */
  trait AwnPosition extends StObject
  object AwnPosition {
    
    inline def `bottom-left`: typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`bottom-left` = "bottom-left".asInstanceOf[typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`bottom-left`]
    
    inline def `bottom-right`: typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`bottom-right` = "bottom-right".asInstanceOf[typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`bottom-right`]
    
    inline def `top-left`: typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`top-left` = "top-left".asInstanceOf[typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`top-left`]
    
    inline def `top-right`: typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`top-right` = "top-right".asInstanceOf[typingsJapgolly.awesomeNotifications.awesomeNotificationsStrings.`top-right`]
  }
}
