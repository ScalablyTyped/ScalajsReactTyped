...
object IDialogOptions {
  ...
  extension [Self <: IDialogOptions](x: Self) {
    ...
    inline def setOnComplete(value: (/* scope */ IScope, /* element */ JQuery) => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction2((t0: /* scope */ IScope, t1: /* element */ JQuery) => (value(t0, t1)).runNow()))
    
    inline def setOnCompleteUndefined: Self = StObject.set(x, "onComplete", js.undefined)
    
    inline def setOnRemoving(value: (/* element */ JQuery, /* removePromise */ IPromise[Any]) => Callback): Self = StObject.set(x, "onRemoving", js.Any.fromFunction2((t0: /* element */ JQuery, t1: /* removePromise */ IPromise[Any]) => (value(t0, t1)).runNow()))
    
    inline def setOnRemovingUndefined: Self = StObject.set(x, "onRemoving", js.undefined)
    
    inline def setOnShowing(value: (/* scope */ IScope, /* element */ JQuery) => Callback): Self = StObject.set(x, "onShowing", js.Any.fromFunction2((t0: /* scope */ IScope, t1: /* element */ JQuery) => (value(t0, t1)).runNow()))
