...
import typingsJapgolly.angularRouter.angularRouterStrings.full
import typingsJapgolly.angularRouter.angularRouterStrings.prefix
...
object Route {
  ...
  extension [Self <: Route](x: Self) {
    ...
    ): Self = StObject.set(x, "loadChildren", value.toJsFn)
    
    inline def setLoadChildrenUndefined: Self = StObject.set(x, "loadChildren", js.undefined)
    
    inline def setLoadComponent(value: CallbackTo[Type[Any] | Observable_[Type[Any]] | js.Promise[Type[Any]]]): Self = StObject.set(x, "loadComponent", value.toJsFn)
