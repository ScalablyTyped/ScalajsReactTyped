...
object Route {
  ...
  def apply(
    ...
    matcher: (/* segments */ js.Array[UrlSegment], /* group */ UrlSegmentGroup, /* route */ Route) => CallbackTo[UrlMatchResult] = null,
    outlet: String = null,
    path: String = null,
    ...
    if (matcher != null) __obj.updateDynamic("matcher")(js.Any.fromFunction3((t0: /* segments */ js.Array[typingsJapgolly.angularRouter.mod.UrlSegment], t1: /* group */ typingsJapgolly.angularRouter.mod.UrlSegmentGroup, t2: /* route */ typingsJapgolly.angularRouter.mod.Route) => matcher(t0, t1, t2).runNow()))
