...
object Route {
  ...
  def apply(
    ...
    if (matcher != null) __obj.updateDynamic("matcher")(js.Any.fromFunction3((t0: /* segments */ js.Array[typingsJapgolly.atAngularRouter.atAngularRouterMod.UrlSegment], t1: /* group */ typingsJapgolly.atAngularRouter.atAngularRouterMod.UrlSegmentGroup, t2: /* route */ typingsJapgolly.atAngularRouter.atAngularRouterMod.Route) => matcher(t0, t1, t2).runNow()))
