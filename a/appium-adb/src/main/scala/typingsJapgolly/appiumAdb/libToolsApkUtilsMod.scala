...
import typingsJapgolly.appiumAdb.appiumAdbStrings.newerVersionInstalled
import typingsJapgolly.appiumAdb.appiumAdbStrings.notInstalled
import typingsJapgolly.appiumAdb.appiumAdbStrings.olderVersionInstalled
import typingsJapgolly.appiumAdb.appiumAdbStrings.sameVersionInstalled
import typingsJapgolly.appiumAdb.appiumAdbStrings.unknown
...
object libToolsApkUtilsMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.appiumAdb.appiumAdbStrings.sameVersionInstalled
    - typingsJapgolly.appiumAdb.appiumAdbStrings.olderVersionInstalled
    - typingsJapgolly.appiumAdb.appiumAdbStrings.newerVersionInstalled
    - typingsJapgolly.appiumAdb.appiumAdbStrings.unknown
    - typingsJapgolly.appiumAdb.appiumAdbStrings.notInstalled
  */
