...
import typingsJapgolly.semver.mod.SemVer
...
object libToolsSystemCallsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.appiumAdb.appiumAdbStrings.aapt
    - typingsJapgolly.appiumAdb.appiumAdbStrings.aapt2
    - typingsJapgolly.appiumAdb.appiumAdbStrings.adb
    - typingsJapgolly.appiumAdb.appiumAdbStrings.apkanalyzer
    - typingsJapgolly.appiumAdb.appiumAdbStrings.apksignerDotjar
    - typingsJapgolly.appiumAdb.appiumAdbStrings.bundletool
    - typingsJapgolly.appiumAdb.appiumAdbStrings.zipalign
  */
  trait BinaryName extends StObject
  object BinaryName {
    
    inline def aapt: typingsJapgolly.appiumAdb.appiumAdbStrings.aapt = "aapt".asInstanceOf[typingsJapgolly.appiumAdb.appiumAdbStrings.aapt]
    
    inline def aapt2: typingsJapgolly.appiumAdb.appiumAdbStrings.aapt2 = "aapt2".asInstanceOf[typingsJapgolly.appiumAdb.appiumAdbStrings.aapt2]
    
    inline def adb: typingsJapgolly.appiumAdb.appiumAdbStrings.adb = "adb".asInstanceOf[typingsJapgolly.appiumAdb.appiumAdbStrings.adb]
    
    inline def apkanalyzer: typingsJapgolly.appiumAdb.appiumAdbStrings.apkanalyzer = "apkanalyzer".asInstanceOf[typingsJapgolly.appiumAdb.appiumAdbStrings.apkanalyzer]
    
    inline def apksignerDotjar: typingsJapgolly.appiumAdb.appiumAdbStrings.apksignerDotjar = "apksigner.jar".asInstanceOf[typingsJapgolly.appiumAdb.appiumAdbStrings.apksignerDotjar]
    
    inline def bundletool: typingsJapgolly.appiumAdb.appiumAdbStrings.bundletool = "bundletool".asInstanceOf[typingsJapgolly.appiumAdb.appiumAdbStrings.bundletool]
    
    inline def zipalign: typingsJapgolly.appiumAdb.appiumAdbStrings.zipalign = "zipalign".asInstanceOf[typingsJapgolly.appiumAdb.appiumAdbStrings.zipalign]
  }
