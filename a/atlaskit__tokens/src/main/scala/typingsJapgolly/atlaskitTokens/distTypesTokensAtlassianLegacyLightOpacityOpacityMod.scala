...
import typingsJapgolly.atlaskitTokens.anon.Loading
...
object distTypesTokensAtlassianLegacyLightOpacityOpacityMod {
  ...
  object default {
    ...
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-legacy-light/opacity/opacity", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@atlaskit/tokens/dist/types/tokens/atlassian-legacy-light/opacity/opacity", "default.opacity")
    @js.native
