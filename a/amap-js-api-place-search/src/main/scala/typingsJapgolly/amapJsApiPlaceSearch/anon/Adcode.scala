...
import typingsJapgolly.amapJsApiPlaceSearch.AMap.PlaceSearch.Discount
import typingsJapgolly.amapJsApiPlaceSearch.AMap.PlaceSearch.Groupbuy
import typingsJapgolly.amapJsApiPlaceSearch.AMap.PlaceSearch.PoiPhoto
