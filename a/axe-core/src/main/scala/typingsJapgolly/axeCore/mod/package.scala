...
import typingsJapgolly.axeCore.anon.Description
import typingsJapgolly.axeCore.anon.Enabled
import typingsJapgolly.axeCore.anon.Fail
import typingsJapgolly.axeCore.mod.^
...
type ElementContext = Node | NodeList[Node] | String | ContextObject
