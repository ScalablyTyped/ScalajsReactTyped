...
object anon {
  ...
  object Callback {
    ...
    inline def apply(callback: /* repeated */ Any => japgolly.scalajs.react.Callback, id: String): Callback = {
      val __obj = js.Dynamic.literal(callback = js.Any.fromFunction1((t0: /* repeated */ Any) => callback(t0).runNow()), id = id.asInstanceOf[js.Any])
