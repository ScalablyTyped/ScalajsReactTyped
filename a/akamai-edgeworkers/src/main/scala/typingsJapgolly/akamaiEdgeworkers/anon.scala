...
import typingsJapgolly.akamaiEdgeworkers.akamaiEdgeworkersStrings.byob
import typingsJapgolly.akamaiEdgeworkers.httpRequestMod.RequestBody
...
object anon {
  ...
  trait Body extends StObject {
    ...
    var headers: js.UndefOr[typingsJapgolly.akamaiEdgeworkers.createResponseMod.Headers] = js.undefined
  ...
  object Body {
    ...
    extension [Self <: Body](x: Self) {
      ...
      inline def setHeaders(value: typingsJapgolly.akamaiEdgeworkers.createResponseMod.Headers): Self = StObject.set(x, "headers", value.asInstanceOf[js.Any])
  ...
  object ToUTCString {
    ...
    inline def apply(toUTCString: CallbackTo[String]): ToUTCString = {
      val __obj = js.Dynamic.literal(toUTCString = toUTCString.toJsFn)
