...
import typingsJapgolly.awsSdkNodeConfigProvider.awsSdkNodeConfigProviderStrings.config
import typingsJapgolly.awsSdkNodeConfigProvider.awsSdkNodeConfigProviderStrings.credentials
