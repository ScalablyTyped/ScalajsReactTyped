...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "azure__core-http-compat" % "1.3.0-8330de",
  "org.scalablytyped.japgolly" %%% "azure__core-lro" % "2.3.1-f022e7",
  "org.scalablytyped.japgolly" %%% "azure__core-paging" % "1.3.0-df0e03",
