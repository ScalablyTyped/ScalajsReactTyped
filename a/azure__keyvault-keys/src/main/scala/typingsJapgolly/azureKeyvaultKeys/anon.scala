package typingsJapgolly.azureKeyvaultKeys

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.azureKeyvaultKeys.mod.DeletionRecoveryLevel
import typingsJapgolly.azureKeyvaultKeys.mod.KeyReleasePolicy
...
object anon {
  ...
  /* Inlined @azure/keyvault-keys.@azure/keyvault-keys.KeyProperties & { readonly recoveryId :string | undefined,  readonly scheduledPurgeDate :std.Date | undefined,   deletedOn :std.Date | undefined} */
  trait KeyPropertiesreadonlyreco extends StObject {
    ...
    /**
      ...
      * the server.**
      */
    var deletedOn: js.UndefOr[js.Date] = js.undefined
    ...
    /**
      ...
      */
    val recoveryId: js.UndefOr[String] = js.undefined
    ...
    /**
      ...
      * the server.**
      */
    val scheduledPurgeDate: js.UndefOr[js.Date] = js.undefined
  ...
  object KeyPropertiesreadonlyreco {
    
    inline def apply(name: String, vaultUrl: String): KeyPropertiesreadonlyreco = {
    ...
    extension [Self <: KeyPropertiesreadonlyreco](x: Self) {
      ...
      inline def setDeletedOn(value: js.Date): Self = StObject.set(x, "deletedOn", value.asInstanceOf[js.Any])
      
      inline def setDeletedOnUndefined: Self = StObject.set(x, "deletedOn", js.undefined)
      ...
      inline def setRecoveryId(value: String): Self = StObject.set(x, "recoveryId", value.asInstanceOf[js.Any])
      
      inline def setRecoveryIdUndefined: Self = StObject.set(x, "recoveryId", js.undefined)
      ...
      inline def setScheduledPurgeDate(value: js.Date): Self = StObject.set(x, "scheduledPurgeDate", value.asInstanceOf[js.Any])
      
      inline def setScheduledPurgeDateUndefined: Self = StObject.set(x, "scheduledPurgeDate", js.undefined)
