...
object KnownKeyExportEncryptionAlgorithm extends StObject {
  ...
  /* "CKM_RSA_AES_KEY_WRAP" */ val CkmRsaAesKeyWrap: typingsJapgolly.azureKeyvaultKeys.mod.KnownKeyExportEncryptionAlgorithm.CkmRsaAesKeyWrap & String = js.native
  ...
  sealed trait RsaAesKeyWrap256
    extends StObject
       with KnownKeyExportEncryptionAlgorithm
  /* "RSA_AES_KEY_WRAP_256" */ val RsaAesKeyWrap256: typingsJapgolly.azureKeyvaultKeys.mod.KnownKeyExportEncryptionAlgorithm.RsaAesKeyWrap256 & String = js.native
  ...
  sealed trait RsaAesKeyWrap384
    extends StObject
       with KnownKeyExportEncryptionAlgorithm
  /* "RSA_AES_KEY_WRAP_384" */ val RsaAesKeyWrap384: typingsJapgolly.azureKeyvaultKeys.mod.KnownKeyExportEncryptionAlgorithm.RsaAesKeyWrap384 & String = js.native
}
