...
object DOMDocument60 {
  ...
  inline def apply(
    ...
    createDocumentFragment: CallbackTo[IXMLDOMDocumentFragment],
  ...
  extension [Self <: DOMDocument60](x: Self) {
    ...
    inline def setCreateDocumentFragment(value: CallbackTo[IXMLDOMDocumentFragment]): Self = StObject.set(x, "createDocumentFragment", value.toJsFn)
    ...
    inline def setValidate(value: CallbackTo[IXMLDOMParseError]): Self = StObject.set(x, "validate", value.toJsFn)
