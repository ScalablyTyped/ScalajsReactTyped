...
trait IXMLDOMNode extends StObject {
  ...
  /* private */ @JSName("MSXML2.IXMLDOMNode_typekey")
  var MSXML2DotIXMLDOMNode_typekey: IXMLDOMNode
...
object IXMLDOMNode {
  ...
  inline def apply(
    MSXML2DotIXMLDOMNode_typekey: IXMLDOMNode,
    ...
    __obj.updateDynamic("MSXML2.IXMLDOMNode_typekey")(MSXML2DotIXMLDOMNode_typekey.asInstanceOf[js.Any])
    __obj.asInstanceOf[IXMLDOMNode]
  }
  
  extension [Self <: IXMLDOMNode](x: Self) {
    ...
    inline def setMSXML2DotIXMLDOMNode_typekey(value: IXMLDOMNode): Self = StObject.set(x, "MSXML2.IXMLDOMNode_typekey", value.asInstanceOf[js.Any])
