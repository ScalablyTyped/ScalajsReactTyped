...
trait IXMLDOMDocumentType extends StObject {
  
  /* private */ @JSName("MSXML2.IXMLDOMDocumentType_typekey")
  var MSXML2DotIXMLDOMDocumentType_typekey: IXMLDOMDocumentType
  ...
  def entities(index: Double): IXMLDOMNode
  /** a list of entities in the document */
  @JSName("entities")
  val entities_Original: IXMLDOMNamedNodeMap
  ...
  def notations(index: Double): IXMLDOMNode
  /** a list of notations in the document */
  @JSName("notations")
  val notations_Original: IXMLDOMNamedNodeMap
...
object IXMLDOMDocumentType {
  
  inline def apply(
    MSXML2DotIXMLDOMDocumentType_typekey: IXMLDOMDocumentType,
    ...
    val __obj = js.Dynamic.literal(appendChild = js.Any.fromFunction1(appendChild), attributes = attributes.asInstanceOf[js.Any], baseName = baseName.asInstanceOf[js.Any], childNodes = childNodes.asInstanceOf[js.Any], cloneNode = js.Any.fromFunction1(cloneNode), dataType = dataType.asInstanceOf[js.Any], definition = definition.asInstanceOf[js.Any], entities = entities.asInstanceOf[js.Any], firstChild = firstChild.asInstanceOf[js.Any], hasChildNodes = hasChildNodes.toJsFn, insertBefore = js.Any.fromFunction2(insertBefore), lastChild = lastChild.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], namespaceURI = namespaceURI.asInstanceOf[js.Any], nextSibling = nextSibling.asInstanceOf[js.Any], nodeName = nodeName.asInstanceOf[js.Any], nodeType = nodeType.asInstanceOf[js.Any], nodeTypeString = nodeTypeString.asInstanceOf[js.Any], nodeTypedValue = nodeTypedValue.asInstanceOf[js.Any], nodeValue = nodeValue.asInstanceOf[js.Any], notations = notations.asInstanceOf[js.Any], ownerDocument = ownerDocument.asInstanceOf[js.Any], parentNode = parentNode.asInstanceOf[js.Any], parsed = parsed.asInstanceOf[js.Any], prefix = prefix.asInstanceOf[js.Any], previousSibling = previousSibling.asInstanceOf[js.Any], removeChild = js.Any.fromFunction1(removeChild), replaceChild = js.Any.fromFunction2(replaceChild), selectNodes = js.Any.fromFunction1(selectNodes), selectSingleNode = js.Any.fromFunction1(selectSingleNode), specified = specified.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any], transformNode = js.Any.fromFunction1(transformNode), transformNodeToObject = js.Any.fromFunction2((t0: IXMLDOMNode, t1: Any) => (transformNodeToObject(t0, t1)).runNow()), xml = xml.asInstanceOf[js.Any])
    __obj.updateDynamic("MSXML2.IXMLDOMDocumentType_typekey")(MSXML2DotIXMLDOMDocumentType_typekey.asInstanceOf[js.Any])
    __obj.asInstanceOf[IXMLDOMDocumentType]
  }
  
  extension [Self <: IXMLDOMDocumentType](x: Self) {
    ...
    inline def setEntities(value: IXMLDOMNamedNodeMap): Self = StObject.set(x, "entities", value.asInstanceOf[js.Any])
    ...
    inline def setMSXML2DotIXMLDOMDocumentType_typekey(value: IXMLDOMDocumentType): Self = StObject.set(x, "MSXML2.IXMLDOMDocumentType_typekey", value.asInstanceOf[js.Any])
    ...
    inline def setNotations(value: IXMLDOMNamedNodeMap): Self = StObject.set(x, "notations", value.asInstanceOf[js.Any])
