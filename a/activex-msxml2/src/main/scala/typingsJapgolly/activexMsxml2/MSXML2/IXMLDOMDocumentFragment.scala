...
trait IXMLDOMDocumentFragment extends StObject {
  ...
  /* private */ @JSName("MSXML2.IXMLDOMDocumentFragment_typekey")
  var MSXML2DotIXMLDOMDocumentFragment_typekey: IXMLDOMDocumentFragment
...
object IXMLDOMDocumentFragment {
  
  inline def apply(
    MSXML2DotIXMLDOMDocumentFragment_typekey: IXMLDOMDocumentFragment,
  ...
  extension [Self <: IXMLDOMDocumentFragment](x: Self) {
    ...
    inline def setMSXML2DotIXMLDOMDocumentFragment_typekey(value: IXMLDOMDocumentFragment): Self = StObject.set(x, "MSXML2.IXMLDOMDocumentFragment_typekey", value.asInstanceOf[js.Any])
