...
object XEnhancedCustomShapeDefaulter {
  ...
  inline def apply(
    acquire: Callback,
    createCustomShapeDefaults: String => Callback,
    queryInterface: `type` => Any,
    release: Callback
  ): XEnhancedCustomShapeDefaulter = {
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, createCustomShapeDefaults = js.Any.fromFunction1((t0: String) => createCustomShapeDefaults(t0).runNow()), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
    __obj.asInstanceOf[XEnhancedCustomShapeDefaulter]
  }
  
  extension [Self <: XEnhancedCustomShapeDefaulter](x: Self) {
    
    inline def setCreateCustomShapeDefaults(value: String => Callback): Self = StObject.set(x, "createCustomShapeDefaults", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  }
}
