...
import typingsJapgolly.activexLibreoffice.com_.sun.star.tiledrendering.XTiledRenderable
...
- typingsJapgolly.activexLibreoffice.com_.sun.star.frame.XModel because Already inherited
- typingsJapgolly.activexLibreoffice.com_.sun.star.text.XTextDocument because var conflicts: CurrentController. Inlined getText, reformat, Text */ @js.native
