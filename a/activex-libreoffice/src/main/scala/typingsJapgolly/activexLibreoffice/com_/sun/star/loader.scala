...
object loader {
  ...
  object XImplementationLoader {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, activate = js.Any.fromFunction4(activate), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, writeRegistryInfo = js.Any.fromFunction3(writeRegistryInfo))
