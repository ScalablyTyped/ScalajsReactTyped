...
object XBufferController {
  ...
  inline def apply(
    ...
    destroyBuffers: Callback,
    queryInterface: `type` => Any,
    release: Callback,
    showBuffer: Boolean => Boolean,
    switchBuffer: Boolean => Boolean
  ): XBufferController = {
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, createBuffers = js.Any.fromFunction1(createBuffers), destroyBuffers = destroyBuffers.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, showBuffer = js.Any.fromFunction1(showBuffer), switchBuffer = js.Any.fromFunction1(switchBuffer))
  ...
  extension [Self <: XBufferController](x: Self) {
    ...
    inline def setDestroyBuffers(value: Callback): Self = StObject.set(x, "destroyBuffers", value.toJsFn)
