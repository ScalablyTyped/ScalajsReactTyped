...
object PropertyControlType {
  ...
  */
  ...
  object Constants {
    ...
    inline def CharacterField: `5` = 5.asInstanceOf[`5`]
    
    inline def ColorListBox: `7` = 7.asInstanceOf[`7`]
    
    inline def ComboBox: `2` = 2.asInstanceOf[`2`]
    
    inline def DateField: `9` = 9.asInstanceOf[`9`]
    
    inline def DateTimeField: `11` = 11.asInstanceOf[`11`]
    
    inline def HyperlinkField: `12` = 12.asInstanceOf[`12`]
    
    inline def ListBox: `1` = 1.asInstanceOf[`1`]
    
    inline def MultiLineTextField: `4` = 4.asInstanceOf[`4`]
    
    inline def NumericField: `8` = 8.asInstanceOf[`8`]
    
    inline def StringListField: `6` = 6.asInstanceOf[`6`]
    
    inline def TextField: `3` = 3.asInstanceOf[`3`]
    
    inline def TimeField: `10` = 10.asInstanceOf[`10`]
    
    inline def Unknown: `13` = 13.asInstanceOf[`13`]
  }
}
