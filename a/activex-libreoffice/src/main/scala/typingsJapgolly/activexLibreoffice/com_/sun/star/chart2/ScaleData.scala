...
import typingsJapgolly.activexLibreoffice.com_.sun.star.chart.TimeIncrement
...
trait ScaleData extends StObject {
  ...
  var IncrementData: typingsJapgolly.activexLibreoffice.com_.sun.star.chart2.IncrementData
