...
import typingsJapgolly.activexLibreoffice.com_.sun.star.frame.FrameLoader
...
import typingsJapgolly.activexLibreoffice.com_.sun.star.task.XInteractionHandler2
