...
import typingsJapgolly.activexLibreoffice.com_.sun.star.uno.DeploymentException
...
object java_ {
  ...
  object XJavaThreadRegister11 {
    ...
    inline def apply(
      acquire: Callback,
      isThreadAttached: CallbackTo[Boolean],
      queryInterface: `type` => Any,
      registerThread: Callback,
      release: Callback,
      revokeThread: Callback
    ): XJavaThreadRegister11 = {
      val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, isThreadAttached = isThreadAttached.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), registerThread = registerThread.toJsFn, release = release.toJsFn, revokeThread = revokeThread.toJsFn)
      __obj.asInstanceOf[XJavaThreadRegister11]
    }
    
    extension [Self <: XJavaThreadRegister11](x: Self) {
      
      inline def setIsThreadAttached(value: CallbackTo[Boolean]): Self = StObject.set(x, "isThreadAttached", value.toJsFn)
      
      inline def setRegisterThread(value: Callback): Self = StObject.set(x, "registerThread", value.toJsFn)
      
      inline def setRevokeThread(value: Callback): Self = StObject.set(x, "revokeThread", value.toJsFn)
    }
  }
  ...
  object XJavaVM {
    ...
    inline def apply(
      ...
      isVMEnabled: CallbackTo[Boolean],
      isVMStarted: CallbackTo[Boolean],
      queryInterface: `type` => Any,
      release: Callback
    ): XJavaVM = {
      val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, getJavaVM = js.Any.fromFunction1(getJavaVM), isVMEnabled = isVMEnabled.toJsFn, isVMStarted = isVMStarted.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
    ...
    extension [Self <: XJavaVM](x: Self) {
      ...
      inline def setIsVMEnabled(value: CallbackTo[Boolean]): Self = StObject.set(x, "isVMEnabled", value.toJsFn)
      
      inline def setIsVMStarted(value: CallbackTo[Boolean]): Self = StObject.set(x, "isVMStarted", value.toJsFn)
    }
  }
}
