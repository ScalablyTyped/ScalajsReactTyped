...
object XCertificate {
  ...
  extension [Self <: XCertificate](x: Self) {
    ...
    inline def setGetCertificateUsage(value: CallbackTo[Double]): Self = StObject.set(x, "getCertificateUsage", value.toJsFn)
