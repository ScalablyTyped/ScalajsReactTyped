...
object XCanvas {
  ...
  extension [Self <: XCanvas](x: Self) {
    ...
    inline def setDrawBezier(value: (RealBezierSegment2D, RealPoint2D, ViewState, RenderState) => Callback): Self = StObject.set(x, "drawBezier", js.Any.fromFunction4((t0: RealBezierSegment2D, t1: RealPoint2D, t2: ViewState, t3: RenderState) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setDrawLine(value: (RealPoint2D, RealPoint2D, ViewState, RenderState) => Callback): Self = StObject.set(x, "drawLine", js.Any.fromFunction4((t0: RealPoint2D, t1: RealPoint2D, t2: ViewState, t3: RenderState) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setDrawPoint(value: (RealPoint2D, ViewState, RenderState) => Callback): Self = StObject.set(x, "drawPoint", js.Any.fromFunction3((t0: RealPoint2D, t1: ViewState, t2: RenderState) => (value(t0, t1, t2)).runNow()))
