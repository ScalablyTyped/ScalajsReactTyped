...
object XColumnLocate {
  ...
  inline def apply(acquire: Callback, findColumn: String => Double, queryInterface: `type` => Any, release: Callback): XColumnLocate = {
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, findColumn = js.Any.fromFunction1(findColumn), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
