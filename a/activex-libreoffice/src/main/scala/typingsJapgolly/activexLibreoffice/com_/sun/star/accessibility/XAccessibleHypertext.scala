...
object XAccessibleHypertext {
  ...
  inline def apply(
    ...
    getHyperLinkCount: CallbackTo[Double],
  ...
  extension [Self <: XAccessibleHypertext](x: Self) {
    ...
    inline def setGetHyperLinkCount(value: CallbackTo[Double]): Self = StObject.set(x, "getHyperLinkCount", value.toJsFn)
