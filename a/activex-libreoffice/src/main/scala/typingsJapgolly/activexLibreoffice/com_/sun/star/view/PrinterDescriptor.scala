...
trait PrinterDescriptor extends StObject {
  ...
  /**
    ...
    */
  var PaperFormat: typingsJapgolly.activexLibreoffice.com_.sun.star.view.PaperFormat
  
  /** specifies the orientation of the paper. */
  var PaperOrientation: typingsJapgolly.activexLibreoffice.com_.sun.star.view.PaperOrientation
