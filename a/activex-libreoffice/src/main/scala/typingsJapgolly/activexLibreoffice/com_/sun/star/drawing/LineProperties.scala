...
trait LineProperties extends StObject {
  ...
  var LineCap: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.LineCap
  ...
  var LineJoint: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.LineJoint
