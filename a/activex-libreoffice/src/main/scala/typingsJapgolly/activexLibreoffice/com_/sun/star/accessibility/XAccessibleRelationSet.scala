...
object XAccessibleRelationSet {
  ...
  inline def apply(
    ...
    getRelationCount: CallbackTo[Double],
    queryInterface: `type` => Any,
    release: Callback
  ): XAccessibleRelationSet = {
    val __obj = js.Dynamic.literal(RelationCount = RelationCount.asInstanceOf[js.Any], acquire = acquire.toJsFn, containsRelation = js.Any.fromFunction1(containsRelation), getRelation = js.Any.fromFunction1(getRelation), getRelationByType = js.Any.fromFunction1(getRelationByType), getRelationCount = getRelationCount.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
  ...
  extension [Self <: XAccessibleRelationSet](x: Self) {
    ...
    inline def setGetRelationCount(value: CallbackTo[Double]): Self = StObject.set(x, "getRelationCount", value.toJsFn)
