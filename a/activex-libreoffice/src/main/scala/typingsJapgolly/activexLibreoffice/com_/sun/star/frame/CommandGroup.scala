...
object CommandGroup {
  ...
  */
  ...
  object Constants {
    ...
    inline def APPLICATION: `1` = 1.asInstanceOf[`1`]
    
    inline def CHART: `20` = 20.asInstanceOf[`20`]
    
    inline def CONNECTOR: `22` = 22.asInstanceOf[`22`]
    
    inline def CONTROLS: `25` = 25.asInstanceOf[`25`]
    
    inline def DATA: `17` = 17.asInstanceOf[`17`]
    
    inline def DOCUMENT: `3` = 3.asInstanceOf[`3`]
    
    inline def DRAWING: `24` = 24.asInstanceOf[`24`]
    
    inline def EDIT: `4` = 4.asInstanceOf[`4`]
    
    inline def ENUMERATION: `16` = 16.asInstanceOf[`16`]
    
    inline def EXPLORER: `21` = 21.asInstanceOf[`21`]
    
    inline def FORMAT: `10` = 10.asInstanceOf[`10`]
    
    inline def FRAME: `13` = 13.asInstanceOf[`13`]
    
    inline def GRAPHIC: `14` = 14.asInstanceOf[`14`]
    
    inline def IMAGE: `19` = 19.asInstanceOf[`19`]
    
    inline def INSERT: `9` = 9.asInstanceOf[`9`]
    
    inline def INTERNAL: `0` = 0.asInstanceOf[`0`]
    
    inline def MACRO: `5` = 5.asInstanceOf[`5`]
    
    inline def MATH: `7` = 7.asInstanceOf[`7`]
    
    inline def MODIFY: `23` = 23.asInstanceOf[`23`]
    
    inline def NAVIGATOR: `8` = 8.asInstanceOf[`8`]
    
    inline def OPTIONS: `6` = 6.asInstanceOf[`6`]
    
    inline def SPECIAL: `18` = 18.asInstanceOf[`18`]
    
    inline def TABLE: `15` = 15.asInstanceOf[`15`]
    
    inline def TEMPLATE: `11` = 11.asInstanceOf[`11`]
    
    inline def TEXT: `12` = 12.asInstanceOf[`12`]
