...
object XLanguageGuessing {
  ...
  inline def apply(
    ...
    disableLanguages: SeqEquiv[Locale] => Callback,
    enableLanguages: SeqEquiv[Locale] => Callback,
    getAvailableLanguages: CallbackTo[SafeArray[Locale]],
    getDisabledLanguages: CallbackTo[SafeArray[Locale]],
    getEnabledLanguages: CallbackTo[SafeArray[Locale]],
    guessPrimaryLanguage: (String, Double, Double) => Locale
  ): XLanguageGuessing = {
    val __obj = js.Dynamic.literal(AvailableLanguages = AvailableLanguages.asInstanceOf[js.Any], DisabledLanguages = DisabledLanguages.asInstanceOf[js.Any], EnabledLanguages = EnabledLanguages.asInstanceOf[js.Any], disableLanguages = js.Any.fromFunction1((t0: SeqEquiv[Locale]) => disableLanguages(t0).runNow()), enableLanguages = js.Any.fromFunction1((t0: SeqEquiv[Locale]) => enableLanguages(t0).runNow()), getAvailableLanguages = getAvailableLanguages.toJsFn, getDisabledLanguages = getDisabledLanguages.toJsFn, getEnabledLanguages = getEnabledLanguages.toJsFn, guessPrimaryLanguage = js.Any.fromFunction3(guessPrimaryLanguage))
  ...
  extension [Self <: XLanguageGuessing](x: Self) {
    ...
    inline def setDisableLanguages(value: SeqEquiv[Locale] => Callback): Self = StObject.set(x, "disableLanguages", js.Any.fromFunction1((t0: SeqEquiv[Locale]) => value(t0).runNow()))
    
    inline def setDisabledLanguages(value: SafeArray[Locale]): Self = StObject.set(x, "DisabledLanguages", value.asInstanceOf[js.Any])
    
    inline def setEnableLanguages(value: SeqEquiv[Locale] => Callback): Self = StObject.set(x, "enableLanguages", js.Any.fromFunction1((t0: SeqEquiv[Locale]) => value(t0).runNow()))
    
    inline def setEnabledLanguages(value: SafeArray[Locale]): Self = StObject.set(x, "EnabledLanguages", value.asInstanceOf[js.Any])
    
    inline def setGetAvailableLanguages(value: CallbackTo[SafeArray[Locale]]): Self = StObject.set(x, "getAvailableLanguages", value.toJsFn)
    
    inline def setGetDisabledLanguages(value: CallbackTo[SafeArray[Locale]]): Self = StObject.set(x, "getDisabledLanguages", value.toJsFn)
    
    inline def setGetEnabledLanguages(value: CallbackTo[SafeArray[Locale]]): Self = StObject.set(x, "getEnabledLanguages", value.toJsFn)
