...
object XExtendedFilterDetection {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, detect = js.Any.fromFunction1(detect), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
