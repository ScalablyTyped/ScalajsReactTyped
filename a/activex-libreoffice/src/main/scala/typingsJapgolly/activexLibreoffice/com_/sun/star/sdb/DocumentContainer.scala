...
import typingsJapgolly.activexLibreoffice.com_.sun.star.container.XHierarchicalNameContainer
import typingsJapgolly.activexLibreoffice.com_.sun.star.frame.XComponentLoader
