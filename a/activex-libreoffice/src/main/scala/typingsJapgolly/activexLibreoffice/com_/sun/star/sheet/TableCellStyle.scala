...
- typingsJapgolly.activexLibreoffice.com_.sun.star.xml.UserDefinedAttributesSupplier because var conflicts: UserDefinedAttributes. Inlined 
...
- typingsJapgolly.activexLibreoffice.com_.sun.star.style.Style because var conflicts: UserDefinedAttributes. Inlined DisplayName, FollowStyle, Hidden, IsAutoUpdate, IsPhysical, ParaStyleConditions, StyleInteropGrabBag */ trait TableCellStyle
  extends StObject
     with CellProperties
