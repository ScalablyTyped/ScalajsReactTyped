...
trait DataPointProperties
  ...
  var Gradient: typingsJapgolly.activexLibreoffice.com_.sun.star.awt.Gradient = js.native
  
  var GradientName: String = js.native
  
  var Hatch: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.Hatch = js.native
  ...
  /**
    ...
    * @see com.sun.star.drawing.LineProperties
    */
  var LineDash: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.LineDash = js.native
  ...
  var LineStyle: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.LineStyle = js.native
  ...
  var Symbol: typingsJapgolly.activexLibreoffice.com_.sun.star.chart2.Symbol = js.native
