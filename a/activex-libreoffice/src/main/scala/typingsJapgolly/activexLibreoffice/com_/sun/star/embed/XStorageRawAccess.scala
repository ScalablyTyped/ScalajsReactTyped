...
object XStorageRawAccess {
  ...
  inline def apply(
    ...
    insertRawEncrStreamElement: (String, XInputStream) => Callback
  ): XStorageRawAccess = {
    val __obj = js.Dynamic.literal(getPlainRawStreamElement = js.Any.fromFunction1(getPlainRawStreamElement), getRawEncrStreamElement = js.Any.fromFunction1(getRawEncrStreamElement), insertRawEncrStreamElement = js.Any.fromFunction2((t0: String, t1: XInputStream) => (insertRawEncrStreamElement(t0, t1)).runNow()))
  ...
  extension [Self <: XStorageRawAccess](x: Self) {
    ...
    inline def setInsertRawEncrStreamElement(value: (String, XInputStream) => Callback): Self = StObject.set(x, "insertRawEncrStreamElement", js.Any.fromFunction2((t0: String, t1: XInputStream) => (value(t0, t1)).runNow()))
  }
}
