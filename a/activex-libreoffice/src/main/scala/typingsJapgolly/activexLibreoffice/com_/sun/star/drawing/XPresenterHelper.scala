...
object XPresenterHelper {
  ...
  inline def apply(
    ...
    releaseMouse: XWindow => Callback,
    toTop: XWindow => Callback
  ): XPresenterHelper = {
    val __obj = js.Dynamic.literal(captureMouse = js.Any.fromFunction1((t0: XWindow) => captureMouse(t0).runNow()), createCanvas = js.Any.fromFunction3(createCanvas), createSharedCanvas = js.Any.fromFunction5(createSharedCanvas), createWindow = js.Any.fromFunction5(createWindow), getWindowExtentsRelative = js.Any.fromFunction2(getWindowExtentsRelative), loadBitmap = js.Any.fromFunction2(loadBitmap), releaseMouse = js.Any.fromFunction1((t0: XWindow) => releaseMouse(t0).runNow()), toTop = js.Any.fromFunction1((t0: XWindow) => toTop(t0).runNow()))
    __obj.asInstanceOf[XPresenterHelper]
  }
  
  extension [Self <: XPresenterHelper](x: Self) {
    
    inline def setCaptureMouse(value: XWindow => Callback): Self = StObject.set(x, "captureMouse", js.Any.fromFunction1((t0: XWindow) => value(t0).runNow()))
    ...
    inline def setReleaseMouse(value: XWindow => Callback): Self = StObject.set(x, "releaseMouse", js.Any.fromFunction1((t0: XWindow) => value(t0).runNow()))
    
    inline def setToTop(value: XWindow => Callback): Self = StObject.set(x, "toTop", js.Any.fromFunction1((t0: XWindow) => value(t0).runNow()))
  }
}
