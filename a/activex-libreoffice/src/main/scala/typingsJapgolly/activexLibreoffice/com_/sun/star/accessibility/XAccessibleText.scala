...
object XAccessibleText {
  ...
  extension [Self <: XAccessibleText](x: Self) {
    ...
    inline def setGetCharacterCount(value: CallbackTo[Double]): Self = StObject.set(x, "getCharacterCount", value.toJsFn)
    ...
    inline def setGetSelectionEnd(value: CallbackTo[Double]): Self = StObject.set(x, "getSelectionEnd", value.toJsFn)
    
    inline def setGetSelectionStart(value: CallbackTo[Double]): Self = StObject.set(x, "getSelectionStart", value.toJsFn)
