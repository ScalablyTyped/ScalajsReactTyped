...
object XSidebarPanel {
  ...
  inline def apply(MinimalWidth: Double, getHeightForWidth: Double => LayoutSize, getMinimalWidth: CallbackTo[Double]): XSidebarPanel = {
    val __obj = js.Dynamic.literal(MinimalWidth = MinimalWidth.asInstanceOf[js.Any], getHeightForWidth = js.Any.fromFunction1(getHeightForWidth), getMinimalWidth = getMinimalWidth.toJsFn)
  ...
  extension [Self <: XSidebarPanel](x: Self) {
    ...
    inline def setGetMinimalWidth(value: CallbackTo[Double]): Self = StObject.set(x, "getMinimalWidth", value.toJsFn)
