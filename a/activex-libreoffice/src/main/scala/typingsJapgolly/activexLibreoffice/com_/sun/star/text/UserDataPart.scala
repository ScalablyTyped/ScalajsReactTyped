...
object UserDataPart {
  ...
  */
  ...
  object Constants {
    ...
    inline def CITY: `7` = 7.asInstanceOf[`7`]
    
    inline def COMPANY: `0` = 0.asInstanceOf[`0`]
    
    inline def COUNTRY: `5` = 5.asInstanceOf[`5`]
    
    inline def EMAIL: `13` = 13.asInstanceOf[`13`]
    
    inline def FAX: `12` = 12.asInstanceOf[`12`]
    
    inline def FIRSTNAME: `1` = 1.asInstanceOf[`1`]
    
    inline def NAME: `2` = 2.asInstanceOf[`2`]
    
    inline def PHONE_COMPANY: `11` = 11.asInstanceOf[`11`]
    
    inline def PHONE_PRIVATE: `10` = 10.asInstanceOf[`10`]
    
    inline def POSITION: `9` = 9.asInstanceOf[`9`]
    
    inline def SHORTCUT: `3` = 3.asInstanceOf[`3`]
    
    inline def STATE: `14` = 14.asInstanceOf[`14`]
    
    inline def STREET: `4` = 4.asInstanceOf[`4`]
    
    inline def TITLE: `8` = 8.asInstanceOf[`8`]
    
    inline def ZIP: `6` = 6.asInstanceOf[`6`]
  }
}
