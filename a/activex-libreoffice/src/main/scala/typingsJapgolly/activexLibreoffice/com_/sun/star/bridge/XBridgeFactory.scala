...
object XBridgeFactory {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(ExistingBridges = ExistingBridges.asInstanceOf[js.Any], acquire = acquire.toJsFn, createBridge = js.Any.fromFunction4(createBridge), getBridge = js.Any.fromFunction1(getBridge), getExistingBridges = getExistingBridges.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
  ...
  extension [Self <: XBridgeFactory](x: Self) {
    ...
    inline def setGetExistingBridges(value: CallbackTo[SafeArray[XBridge]]): Self = StObject.set(x, "getExistingBridges", value.toJsFn)
  }
}
