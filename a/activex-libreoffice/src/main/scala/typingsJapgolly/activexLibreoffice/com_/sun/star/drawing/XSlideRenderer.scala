...
trait XSlideRenderer extends StObject {
  ...
  /**
    ...
    * @see createPreview
    */
  def createPreviewForCanvas(xSlide: XDrawPage, aMaximumPreviewPixelSize: Size, nSuperSampleFactor: Double, xCanvas: XCanvas): typingsJapgolly.activexLibreoffice.com_.sun.star.rendering.XBitmap
}
object XSlideRenderer {
  ...
  extension [Self <: XSlideRenderer](x: Self) {
    ...
    inline def setCreatePreviewForCanvas(
      value: (XDrawPage, Size, Double, XCanvas) => typingsJapgolly.activexLibreoffice.com_.sun.star.rendering.XBitmap
