...
trait UnoControlTimeFieldModel
  extends StObject
...
object UnoControlTimeFieldModel {
  ...
  extension [Self <: UnoControlTimeFieldModel](x: Self) {
    ...
    inline def setTimeFormat(value: Double): Self = StObject.set(x, "TimeFormat", value.asInstanceOf[js.Any])
    
    inline def setTimeMax(value: Time): Self = StObject.set(x, "TimeMax", value.asInstanceOf[js.Any])
    
    inline def setTimeMin(value: Time): Self = StObject.set(x, "TimeMin", value.asInstanceOf[js.Any])
