...
object XConfiguration {
  ...
  extension [Self <: XConfiguration](x: Self) {
    ...
    inline def setRemoveResource(value: XResourceId => Callback): Self = StObject.set(x, "removeResource", js.Any.fromFunction1((t0: XResourceId) => value(t0).runNow()))
  }
}
