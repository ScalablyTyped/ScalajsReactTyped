...
import typingsJapgolly.activexLibreoffice.com_.sun.star.security.EncryptionException
import typingsJapgolly.activexLibreoffice.com_.sun.star.security.SignatureException
