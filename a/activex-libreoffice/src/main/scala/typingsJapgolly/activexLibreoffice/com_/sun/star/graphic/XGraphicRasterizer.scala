...
object XGraphicRasterizer {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, initializeData = js.Any.fromFunction4(initializeData), queryInterface = js.Any.fromFunction1(queryInterface), rasterize = js.Any.fromFunction6(rasterize), release = release.toJsFn)
