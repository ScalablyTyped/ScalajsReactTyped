...
trait XFixedLine
  ...
  var LineDash: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.LineDash
  
  /** This property contains the type of the line. */
  var LineStyle: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.LineStyle
