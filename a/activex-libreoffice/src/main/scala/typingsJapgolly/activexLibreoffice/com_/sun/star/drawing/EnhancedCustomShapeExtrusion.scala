...
trait EnhancedCustomShapeExtrusion extends StObject {
  ...
  var ProjectionMode: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.ProjectionMode
  ...
  var ShadeMode: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.ShadeMode
