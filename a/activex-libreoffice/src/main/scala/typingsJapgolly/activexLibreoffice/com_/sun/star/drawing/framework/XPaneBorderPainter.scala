...
object XPaneBorderPainter {
  ...
  inline def apply(
    ...
    paintBorder: (String, XCanvas, Rectangle, Rectangle, String) => Callback,
    paintBorderWithCallout: (String, XCanvas, Rectangle, Rectangle, String, Point) => Callback,
    removeBorder: (String, Rectangle, BorderType) => Rectangle
  ): XPaneBorderPainter = {
    val __obj = js.Dynamic.literal(addBorder = js.Any.fromFunction3(addBorder), getCalloutOffset = js.Any.fromFunction1(getCalloutOffset), paintBorder = js.Any.fromFunction5((t0: String, t1: XCanvas, t2: Rectangle, t3: Rectangle, t4: String) => (paintBorder(t0, t1, t2, t3, t4)).runNow()), paintBorderWithCallout = js.Any.fromFunction6((t0: String, t1: XCanvas, t2: Rectangle, t3: Rectangle, t4: String, t5: Point) => (paintBorderWithCallout(t0, t1, t2, t3, t4, t5)).runNow()), removeBorder = js.Any.fromFunction3(removeBorder))
  ...
  extension [Self <: XPaneBorderPainter](x: Self) {
    ...
    inline def setPaintBorder(value: (String, XCanvas, Rectangle, Rectangle, String) => Callback): Self = StObject.set(x, "paintBorder", js.Any.fromFunction5((t0: String, t1: XCanvas, t2: Rectangle, t3: Rectangle, t4: String) => (value(t0, t1, t2, t3, t4)).runNow()))
    
    inline def setPaintBorderWithCallout(value: (String, XCanvas, Rectangle, Rectangle, String, Point) => Callback): Self = StObject.set(x, "paintBorderWithCallout", js.Any.fromFunction6((t0: String, t1: XCanvas, t2: Rectangle, t3: Rectangle, t4: String, t5: Point) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
