...
object XTolerantMultiPropertySet {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, getDirectPropertyValuesTolerant = js.Any.fromFunction1(getDirectPropertyValuesTolerant), getPropertyValuesTolerant = js.Any.fromFunction1(getPropertyValuesTolerant), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, setPropertyValuesTolerant = js.Any.fromFunction2(setPropertyValuesTolerant))
