...
import typingsJapgolly.activexLibreoffice.com_.sun.star.text.WritingMode
...
trait TextProperties
  ...
  var TextAnimationDirection: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.TextAnimationDirection
  
  /** This value defines the type of animation. */
  var TextAnimationKind: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.TextAnimationKind
  ...
  var TextHorizontalAdjust: typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.TextHorizontalAdjust
