...
object XTextConvert {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, convertToTable = js.Any.fromFunction4(convertToTable), convertToTextFrame = js.Any.fromFunction3(convertToTextFrame), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
