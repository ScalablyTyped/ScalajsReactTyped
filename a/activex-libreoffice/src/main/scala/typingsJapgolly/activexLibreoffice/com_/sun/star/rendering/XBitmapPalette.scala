...
object XBitmapPalette {
  ...
  inline def apply(
    ...
    getNumberOfEntries: CallbackTo[Double],
    queryInterface: `type` => Any,
    release: Callback,
    setIndex: (SeqEquiv[ColorComponent], Boolean, Double) => Boolean
  ): XBitmapPalette = {
    val __obj = js.Dynamic.literal(ColorSpace = ColorSpace.asInstanceOf[js.Any], NumberOfEntries = NumberOfEntries.asInstanceOf[js.Any], acquire = acquire.toJsFn, getColorSpace = getColorSpace.toJsFn, getIndex = js.Any.fromFunction2(getIndex), getNumberOfEntries = getNumberOfEntries.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, setIndex = js.Any.fromFunction3(setIndex))
  ...
  extension [Self <: XBitmapPalette](x: Self) {
    ...
    inline def setGetNumberOfEntries(value: CallbackTo[Double]): Self = StObject.set(x, "getNumberOfEntries", value.toJsFn)
