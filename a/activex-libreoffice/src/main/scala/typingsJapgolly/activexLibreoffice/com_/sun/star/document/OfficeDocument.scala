...
import typingsJapgolly.activexLibreoffice.com_.sun.star.view.XPrintJobBroadcaster
import typingsJapgolly.activexLibreoffice.com_.sun.star.view.XPrintable
