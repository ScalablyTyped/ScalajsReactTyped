...
object XHierarchicalStorageAccess {
  ...
  extension [Self <: XHierarchicalStorageAccess](x: Self) {
    ...
    inline def setRemoveStreamElementByHierarchicalName(value: String => Callback): Self = StObject.set(x, "removeStreamElementByHierarchicalName", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  }
}
