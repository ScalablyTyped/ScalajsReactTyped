...
object XXMLSignature {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, generate = js.Any.fromFunction2(generate), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, validate = js.Any.fromFunction2(validate))
