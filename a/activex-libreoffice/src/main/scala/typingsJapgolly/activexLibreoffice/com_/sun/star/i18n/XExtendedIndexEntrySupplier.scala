...
object XExtendedIndexEntrySupplier {
  ...
  inline def apply(
    ...
    getLocaleList: CallbackTo[SafeArray[Locale]],
    ...
    val __obj = js.Dynamic.literal(LocaleList = LocaleList.asInstanceOf[js.Any], acquire = acquire.toJsFn, compareIndexEntry = js.Any.fromFunction6(compareIndexEntry), getAlgorithmList = js.Any.fromFunction1(getAlgorithmList), getIndexCharacter = js.Any.fromFunction3(getIndexCharacter), getIndexFollowPageWord = js.Any.fromFunction2(getIndexFollowPageWord), getIndexKey = js.Any.fromFunction3(getIndexKey), getLocaleList = getLocaleList.toJsFn, getPhoneticCandidate = js.Any.fromFunction2(getPhoneticCandidate), loadAlgorithm = js.Any.fromFunction3(loadAlgorithm), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, usePhoneticEntry = js.Any.fromFunction1(usePhoneticEntry))
  ...
  extension [Self <: XExtendedIndexEntrySupplier](x: Self) {
    ...
    inline def setGetLocaleList(value: CallbackTo[SafeArray[Locale]]): Self = StObject.set(x, "getLocaleList", value.toJsFn)
