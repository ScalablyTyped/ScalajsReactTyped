...
object XSecurityEnvironment {
  ...
  extension [Self <: XSecurityEnvironment](x: Self) {
    ...
    inline def setGetPersonalCertificates(value: CallbackTo[SafeArray[XCertificate]]): Self = StObject.set(x, "getPersonalCertificates", value.toJsFn)
    
    inline def setGetSecurityEnvironmentInformation(value: CallbackTo[String]): Self = StObject.set(x, "getSecurityEnvironmentInformation", value.toJsFn)
