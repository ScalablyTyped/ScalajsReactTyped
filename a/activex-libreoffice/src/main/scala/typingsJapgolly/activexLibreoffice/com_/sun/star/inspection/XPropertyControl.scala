...
object XPropertyControl {
  ...
  extension [Self <: XPropertyControl](x: Self) {
    ...
    inline def setNotifyModifiedValue(value: Callback): Self = StObject.set(x, "notifyModifiedValue", value.toJsFn)
