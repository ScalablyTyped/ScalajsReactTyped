...
object XAccessibleTable {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AccessibleCaption = AccessibleCaption.asInstanceOf[js.Any], AccessibleColumnCount = AccessibleColumnCount.asInstanceOf[js.Any], AccessibleColumnHeaders = AccessibleColumnHeaders.asInstanceOf[js.Any], AccessibleRowCount = AccessibleRowCount.asInstanceOf[js.Any], AccessibleRowHeaders = AccessibleRowHeaders.asInstanceOf[js.Any], AccessibleSummary = AccessibleSummary.asInstanceOf[js.Any], SelectedAccessibleColumns = SelectedAccessibleColumns.asInstanceOf[js.Any], SelectedAccessibleRows = SelectedAccessibleRows.asInstanceOf[js.Any], acquire = acquire.toJsFn, getAccessibleCaption = getAccessibleCaption.toJsFn, getAccessibleCellAt = js.Any.fromFunction2(getAccessibleCellAt), getAccessibleColumn = js.Any.fromFunction1(getAccessibleColumn), getAccessibleColumnCount = getAccessibleColumnCount.toJsFn, getAccessibleColumnDescription = js.Any.fromFunction1(getAccessibleColumnDescription), getAccessibleColumnExtentAt = js.Any.fromFunction2(getAccessibleColumnExtentAt), getAccessibleColumnHeaders = getAccessibleColumnHeaders.toJsFn, getAccessibleIndex = js.Any.fromFunction2(getAccessibleIndex), getAccessibleRow = js.Any.fromFunction1(getAccessibleRow), getAccessibleRowCount = getAccessibleRowCount.toJsFn, getAccessibleRowDescription = js.Any.fromFunction1(getAccessibleRowDescription), getAccessibleRowExtentAt = js.Any.fromFunction2(getAccessibleRowExtentAt), getAccessibleRowHeaders = getAccessibleRowHeaders.toJsFn, getAccessibleSummary = getAccessibleSummary.toJsFn, getSelectedAccessibleColumns = getSelectedAccessibleColumns.toJsFn, getSelectedAccessibleRows = getSelectedAccessibleRows.toJsFn, isAccessibleColumnSelected = js.Any.fromFunction1(isAccessibleColumnSelected), isAccessibleRowSelected = js.Any.fromFunction1(isAccessibleRowSelected), isAccessibleSelected = js.Any.fromFunction2(isAccessibleSelected), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
  ...
  extension [Self <: XAccessibleTable](x: Self) {
    ...
    inline def setGetAccessibleCaption(value: CallbackTo[XAccessible]): Self = StObject.set(x, "getAccessibleCaption", value.toJsFn)
    ...
    inline def setGetAccessibleColumnCount(value: CallbackTo[Double]): Self = StObject.set(x, "getAccessibleColumnCount", value.toJsFn)
    ...
    inline def setGetAccessibleColumnHeaders(value: CallbackTo[XAccessibleTable]): Self = StObject.set(x, "getAccessibleColumnHeaders", value.toJsFn)
    ...
    inline def setGetAccessibleRowCount(value: CallbackTo[Double]): Self = StObject.set(x, "getAccessibleRowCount", value.toJsFn)
    ...
    inline def setGetAccessibleRowHeaders(value: CallbackTo[XAccessibleTable]): Self = StObject.set(x, "getAccessibleRowHeaders", value.toJsFn)
    
    inline def setGetAccessibleSummary(value: CallbackTo[XAccessible]): Self = StObject.set(x, "getAccessibleSummary", value.toJsFn)
    
    inline def setGetSelectedAccessibleColumns(value: CallbackTo[SafeArray[Double]]): Self = StObject.set(x, "getSelectedAccessibleColumns", value.toJsFn)
    
    inline def setGetSelectedAccessibleRows(value: CallbackTo[SafeArray[Double]]): Self = StObject.set(x, "getSelectedAccessibleRows", value.toJsFn)
