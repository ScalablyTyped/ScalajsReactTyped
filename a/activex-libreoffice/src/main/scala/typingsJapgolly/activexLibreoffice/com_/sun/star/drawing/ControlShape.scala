...
- typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.XShapeDescriptor because Already inherited
- typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.XShape because Already inherited
- typingsJapgolly.activexLibreoffice.com_.sun.star.drawing.XControlShape because var conflicts: Position, Size. Inlined Control, getControl, setControl */ trait ControlShape
  extends StObject
     with Shape {
