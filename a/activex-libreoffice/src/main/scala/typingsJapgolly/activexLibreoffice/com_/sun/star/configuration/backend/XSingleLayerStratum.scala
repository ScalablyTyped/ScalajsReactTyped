...
object XSingleLayerStratum {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, getLayer = js.Any.fromFunction2(getLayer), getUpdatableLayer = js.Any.fromFunction1(getUpdatableLayer), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
