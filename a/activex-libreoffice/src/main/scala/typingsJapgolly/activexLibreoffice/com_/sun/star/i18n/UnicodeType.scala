...
object UnicodeType {
  ...
  */
  ...
  object Constants {
    ...
    inline def COMBINING_SPACING_MARK: `8` = 8.asInstanceOf[`8`]
    
    inline def CONNECTOR_PUNCTUATION: `22` = 22.asInstanceOf[`22`]
    
    inline def CONTROL: `15` = 15.asInstanceOf[`15`]
    
    inline def CURRENCY_SYMBOL: `25` = 25.asInstanceOf[`25`]
    
    inline def DASH_PUNCTUATION: `19` = 19.asInstanceOf[`19`]
    
    inline def DECIMAL_DIGIT_NUMBER: `9` = 9.asInstanceOf[`9`]
    
    inline def ENCLOSING_MARK: `7` = 7.asInstanceOf[`7`]
    
    inline def END_PUNCTUATION: `29` = 29.asInstanceOf[`29`]
    
    inline def FINAL_PUNCTUATION: `21` = 21.asInstanceOf[`21`]
    
    inline def FORMAT: `16` = 16.asInstanceOf[`16`]
    
    inline def GENERAL_TYPES_COUNT: `30` = 30.asInstanceOf[`30`]
    
    inline def INITIAL_PUNCTUATION: `20` = 20.asInstanceOf[`20`]
    
    inline def LETTER_NUMBER: `10` = 10.asInstanceOf[`10`]
    
    inline def LINE_SEPARATOR: `13` = 13.asInstanceOf[`13`]
    
    inline def LOWERCASE_LETTER: `2` = 2.asInstanceOf[`2`]
    
    inline def MATH_SYMBOL: `24` = 24.asInstanceOf[`24`]
    
    inline def MODIFIER_LETTER: `4` = 4.asInstanceOf[`4`]
    
    inline def MODIFIER_SYMBOL: `26` = 26.asInstanceOf[`26`]
    
    inline def NON_SPACING_MARK: `6` = 6.asInstanceOf[`6`]
    
    inline def OTHER_LETTER: `5` = 5.asInstanceOf[`5`]
    
    inline def OTHER_NUMBER: `11` = 11.asInstanceOf[`11`]
    
    inline def OTHER_PUNCTUATION: `23` = 23.asInstanceOf[`23`]
    
    inline def OTHER_SYMBOL: `27` = 27.asInstanceOf[`27`]
    
    inline def PARAGRAPH_SEPARATOR: `14` = 14.asInstanceOf[`14`]
    
    inline def PRIVATE_USE: `17` = 17.asInstanceOf[`17`]
    
    inline def SPACE_SEPARATOR: `12` = 12.asInstanceOf[`12`]
    
    inline def START_PUNCTUATION: `28` = 28.asInstanceOf[`28`]
    
    inline def SURROGATE: `18` = 18.asInstanceOf[`18`]
    
    inline def TITLECASE_LETTER: `3` = 3.asInstanceOf[`3`]
    
    inline def UNASSIGNED: `0` = 0.asInstanceOf[`0`]
    
    inline def UPPERCASE_LETTER: `1` = 1.asInstanceOf[`1`]
  }
}
