...
object XDOMImplementation {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, createDocument = js.Any.fromFunction3(createDocument), createDocumentType = js.Any.fromFunction3(createDocumentType), hasFeature = js.Any.fromFunction2(hasFeature), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
