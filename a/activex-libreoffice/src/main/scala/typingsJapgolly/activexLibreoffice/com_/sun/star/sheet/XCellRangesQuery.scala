...
object XCellRangesQuery {
  ...
  extension [Self <: XCellRangesQuery](x: Self) {
    ...
    inline def setQueryEmptyCells(value: CallbackTo[XSheetCellRanges]): Self = StObject.set(x, "queryEmptyCells", value.toJsFn)
    ...
    inline def setQueryVisibleCells(value: CallbackTo[XSheetCellRanges]): Self = StObject.set(x, "queryVisibleCells", value.toJsFn)
  }
}
