...
object XStringSubstitution {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, getSubstituteVariableValue = js.Any.fromFunction1(getSubstituteVariableValue), queryInterface = js.Any.fromFunction1(queryInterface), reSubstituteVariables = js.Any.fromFunction1(reSubstituteVariables), release = release.toJsFn, substituteVariables = js.Any.fromFunction2(substituteVariables))
