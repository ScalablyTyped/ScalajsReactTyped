...
object XStringKeyMap {
  ...
  inline def apply(
    ...
    insertValue: (String, Any) => Callback
  ): XStringKeyMap = {
    val __obj = js.Dynamic.literal(Count = Count.asInstanceOf[js.Any], getKeyByIndex = js.Any.fromFunction1(getKeyByIndex), getValue = js.Any.fromFunction1(getValue), getValueByIndex = js.Any.fromFunction1(getValueByIndex), hasValue = js.Any.fromFunction1(hasValue), insertValue = js.Any.fromFunction2((t0: String, t1: Any) => (insertValue(t0, t1)).runNow()))
  ...
  extension [Self <: XStringKeyMap](x: Self) {
    ...
    inline def setInsertValue(value: (String, Any) => Callback): Self = StObject.set(x, "insertValue", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
  }
}
