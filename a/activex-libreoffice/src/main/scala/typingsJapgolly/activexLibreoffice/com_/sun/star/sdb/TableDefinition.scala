...
object TableDefinition {
  ...
  inline def apply(
    ...
    createWithName: String => Callback,
  ...
  extension [Self <: TableDefinition](x: Self) {
    ...
    inline def setCreateWithName(value: String => Callback): Self = StObject.set(x, "createWithName", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  }
}
