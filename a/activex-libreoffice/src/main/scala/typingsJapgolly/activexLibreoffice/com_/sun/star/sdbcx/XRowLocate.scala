...
object XRowLocate {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(Bookmark = Bookmark.asInstanceOf[js.Any], acquire = acquire.toJsFn, compareBookmarks = js.Any.fromFunction2(compareBookmarks), getBookmark = getBookmark.toJsFn, hasOrderedBookmarks = hasOrderedBookmarks.toJsFn, hashBookmark = js.Any.fromFunction1(hashBookmark), moveRelativeToBookmark = js.Any.fromFunction2(moveRelativeToBookmark), moveToBookmark = js.Any.fromFunction1(moveToBookmark), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
  ...
  extension [Self <: XRowLocate](x: Self) {
    ...
    inline def setGetBookmark(value: CallbackTo[Any]): Self = StObject.set(x, "getBookmark", value.toJsFn)
    
    inline def setHasOrderedBookmarks(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasOrderedBookmarks", value.toJsFn)
