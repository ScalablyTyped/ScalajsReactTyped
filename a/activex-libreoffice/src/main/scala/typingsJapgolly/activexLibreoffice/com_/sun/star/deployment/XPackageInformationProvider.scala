...
object XPackageInformationProvider {
  ...
  inline def apply(
    ...
    getExtensionList: CallbackTo[SafeArray[SafeArray[String]]],
    getPackageLocation: String => String,
    isUpdateAvailable: String => SafeArray[SafeArray[String]]
  ): XPackageInformationProvider = {
    val __obj = js.Dynamic.literal(ExtensionList = ExtensionList.asInstanceOf[js.Any], getExtensionList = getExtensionList.toJsFn, getPackageLocation = js.Any.fromFunction1(getPackageLocation), isUpdateAvailable = js.Any.fromFunction1(isUpdateAvailable))
  ...
  extension [Self <: XPackageInformationProvider](x: Self) {
    ...
    inline def setGetExtensionList(value: CallbackTo[SafeArray[SafeArray[String]]]): Self = StObject.set(x, "getExtensionList", value.toJsFn)
