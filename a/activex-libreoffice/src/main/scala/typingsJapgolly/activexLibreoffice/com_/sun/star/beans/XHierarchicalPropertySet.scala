...
object XHierarchicalPropertySet {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(HierarchicalPropertySetInfo = HierarchicalPropertySetInfo.asInstanceOf[js.Any], acquire = acquire.toJsFn, getHierarchicalPropertySetInfo = getHierarchicalPropertySetInfo.toJsFn, getHierarchicalPropertyValue = js.Any.fromFunction1(getHierarchicalPropertyValue), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, setHierarchicalPropertyValue = js.Any.fromFunction2((t0: String, t1: Any) => (setHierarchicalPropertyValue(t0, t1)).runNow()))
  ...
  extension [Self <: XHierarchicalPropertySet](x: Self) {
    ...
    inline def setSetHierarchicalPropertyValue(value: (String, Any) => Callback): Self = StObject.set(x, "setHierarchicalPropertyValue", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
  }
}
