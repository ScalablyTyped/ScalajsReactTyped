...
import typingsJapgolly.activexLibreoffice.com_.sun.star.util.XMacroExpander
  ...
  */
  ...
  object XUriReference {
    ...
    inline def apply(
      ...
      UriReference: String,
      acquire: Callback,
      clearFragment: Callback,
      getAuthority: CallbackTo[String],
      getFragment: CallbackTo[String],
      getPath: CallbackTo[String],
      getPathSegment: Double => String,
      getPathSegmentCount: CallbackTo[Double],
      getQuery: CallbackTo[String],
      getScheme: CallbackTo[String],
      getSchemeSpecificPart: CallbackTo[String],
      getUriReference: CallbackTo[String],
      hasAuthority: CallbackTo[Boolean],
      hasFragment: CallbackTo[Boolean],
      hasQuery: CallbackTo[Boolean],
      hasRelativePath: CallbackTo[Boolean],
      isAbsolute: CallbackTo[Boolean],
      isHierarchical: CallbackTo[Boolean],
      queryInterface: `type` => Any,
      release: Callback,
      setFragment: String => Callback
    ): XUriReference = {
      val __obj = js.Dynamic.literal(Authority = Authority.asInstanceOf[js.Any], Fragment = Fragment.asInstanceOf[js.Any], Path = Path.asInstanceOf[js.Any], PathSegmentCount = PathSegmentCount.asInstanceOf[js.Any], Query = Query.asInstanceOf[js.Any], Scheme = Scheme.asInstanceOf[js.Any], SchemeSpecificPart = SchemeSpecificPart.asInstanceOf[js.Any], UriReference = UriReference.asInstanceOf[js.Any], acquire = acquire.toJsFn, clearFragment = clearFragment.toJsFn, getAuthority = getAuthority.toJsFn, getFragment = getFragment.toJsFn, getPath = getPath.toJsFn, getPathSegment = js.Any.fromFunction1(getPathSegment), getPathSegmentCount = getPathSegmentCount.toJsFn, getQuery = getQuery.toJsFn, getScheme = getScheme.toJsFn, getSchemeSpecificPart = getSchemeSpecificPart.toJsFn, getUriReference = getUriReference.toJsFn, hasAuthority = hasAuthority.toJsFn, hasFragment = hasFragment.toJsFn, hasQuery = hasQuery.toJsFn, hasRelativePath = hasRelativePath.toJsFn, isAbsolute = isAbsolute.toJsFn, isHierarchical = isHierarchical.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, setFragment = js.Any.fromFunction1((t0: String) => setFragment(t0).runNow()))
    ...
    extension [Self <: XUriReference](x: Self) {
      ...
      inline def setClearFragment(value: Callback): Self = StObject.set(x, "clearFragment", value.toJsFn)
      
      inline def setFragment(value: String): Self = StObject.set(x, "Fragment", value.asInstanceOf[js.Any])
      
      inline def setGetAuthority(value: CallbackTo[String]): Self = StObject.set(x, "getAuthority", value.toJsFn)
      
      inline def setGetFragment(value: CallbackTo[String]): Self = StObject.set(x, "getFragment", value.toJsFn)
      ...
      inline def setGetPathSegmentCount(value: CallbackTo[Double]): Self = StObject.set(x, "getPathSegmentCount", value.toJsFn)
      
      inline def setGetQuery(value: CallbackTo[String]): Self = StObject.set(x, "getQuery", value.toJsFn)
      
      inline def setGetScheme(value: CallbackTo[String]): Self = StObject.set(x, "getScheme", value.toJsFn)
      
      inline def setGetSchemeSpecificPart(value: CallbackTo[String]): Self = StObject.set(x, "getSchemeSpecificPart", value.toJsFn)
      
      inline def setGetUriReference(value: CallbackTo[String]): Self = StObject.set(x, "getUriReference", value.toJsFn)
      
      inline def setHasAuthority(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasAuthority", value.toJsFn)
      
      inline def setHasFragment(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasFragment", value.toJsFn)
      
      inline def setHasQuery(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasQuery", value.toJsFn)
      
      inline def setHasRelativePath(value: CallbackTo[Boolean]): Self = StObject.set(x, "hasRelativePath", value.toJsFn)
      
      inline def setIsAbsolute(value: CallbackTo[Boolean]): Self = StObject.set(x, "isAbsolute", value.toJsFn)
      
      inline def setIsHierarchical(value: CallbackTo[Boolean]): Self = StObject.set(x, "isHierarchical", value.toJsFn)
      ...
      inline def setSetFragment(value: String => Callback): Self = StObject.set(x, "setFragment", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
  ...
  object XUriReferenceFactory {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, makeAbsolute = js.Any.fromFunction4(makeAbsolute), makeRelative = js.Any.fromFunction5(makeRelative), parse = js.Any.fromFunction1(parse), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
  ...
  object XUriSchemeParser {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(acquire = acquire.toJsFn, parse = js.Any.fromFunction2(parse), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn)
  ...
  object XVndSunStarExpandUrlReference {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(Authority = Authority.asInstanceOf[js.Any], Fragment = Fragment.asInstanceOf[js.Any], Path = Path.asInstanceOf[js.Any], PathSegmentCount = PathSegmentCount.asInstanceOf[js.Any], Query = Query.asInstanceOf[js.Any], Scheme = Scheme.asInstanceOf[js.Any], SchemeSpecificPart = SchemeSpecificPart.asInstanceOf[js.Any], UriReference = UriReference.asInstanceOf[js.Any], acquire = acquire.toJsFn, clearFragment = clearFragment.toJsFn, expand = js.Any.fromFunction1(expand), getAuthority = getAuthority.toJsFn, getFragment = getFragment.toJsFn, getPath = getPath.toJsFn, getPathSegment = js.Any.fromFunction1(getPathSegment), getPathSegmentCount = getPathSegmentCount.toJsFn, getQuery = getQuery.toJsFn, getScheme = getScheme.toJsFn, getSchemeSpecificPart = getSchemeSpecificPart.toJsFn, getUriReference = getUriReference.toJsFn, hasAuthority = hasAuthority.toJsFn, hasFragment = hasFragment.toJsFn, hasQuery = hasQuery.toJsFn, hasRelativePath = hasRelativePath.toJsFn, isAbsolute = isAbsolute.toJsFn, isHierarchical = isHierarchical.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, setFragment = js.Any.fromFunction1((t0: String) => setFragment(t0).runNow()))
  ...
  object XVndSunStarScriptUrl {
    ...
    inline def apply(
      ...
      setParameter: (String, String) => Callback
    ): XVndSunStarScriptUrl = {
      val __obj = js.Dynamic.literal(Name = Name.asInstanceOf[js.Any], acquire = acquire.toJsFn, getName = getName.toJsFn, getParameter = js.Any.fromFunction1(getParameter), hasParameter = js.Any.fromFunction1(hasParameter), queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, setName = js.Any.fromFunction1((t0: String) => setName(t0).runNow()), setParameter = js.Any.fromFunction2((t0: String, t1: String) => (setParameter(t0, t1)).runNow()))
    ...
    extension [Self <: XVndSunStarScriptUrl](x: Self) {
      ...
      inline def setSetParameter(value: (String, String) => Callback): Self = StObject.set(x, "setParameter", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object XVndSunStarScriptUrlReference {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(Authority = Authority.asInstanceOf[js.Any], Fragment = Fragment.asInstanceOf[js.Any], Name = Name.asInstanceOf[js.Any], Path = Path.asInstanceOf[js.Any], PathSegmentCount = PathSegmentCount.asInstanceOf[js.Any], Query = Query.asInstanceOf[js.Any], Scheme = Scheme.asInstanceOf[js.Any], SchemeSpecificPart = SchemeSpecificPart.asInstanceOf[js.Any], UriReference = UriReference.asInstanceOf[js.Any], acquire = acquire.toJsFn, clearFragment = clearFragment.toJsFn, getAuthority = getAuthority.toJsFn, getFragment = getFragment.toJsFn, getName = getName.toJsFn, getParameter = js.Any.fromFunction1(getParameter), getPath = getPath.toJsFn, getPathSegment = js.Any.fromFunction1(getPathSegment), getPathSegmentCount = getPathSegmentCount.toJsFn, getQuery = getQuery.toJsFn, getScheme = getScheme.toJsFn, getSchemeSpecificPart = getSchemeSpecificPart.toJsFn, getUriReference = getUriReference.toJsFn, hasAuthority = hasAuthority.toJsFn, hasFragment = hasFragment.toJsFn, hasParameter = js.Any.fromFunction1(hasParameter), hasQuery = hasQuery.toJsFn, hasRelativePath = hasRelativePath.toJsFn, isAbsolute = isAbsolute.toJsFn, isHierarchical = isHierarchical.toJsFn, queryInterface = js.Any.fromFunction1(queryInterface), release = release.toJsFn, setFragment = js.Any.fromFunction1((t0: String) => setFragment(t0).runNow()), setName = js.Any.fromFunction1((t0: String) => setName(t0).runNow()), setParameter = js.Any.fromFunction2((t0: String, t1: String) => (setParameter(t0, t1)).runNow()))
