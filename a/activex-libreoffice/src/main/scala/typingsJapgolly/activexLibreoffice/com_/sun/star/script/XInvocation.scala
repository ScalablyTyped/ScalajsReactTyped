...
object XInvocation {
  ...
  extension [Self <: XInvocation](x: Self) {
    ...
    inline def setGetIntrospection(value: CallbackTo[XIntrospectionAccess]): Self = StObject.set(x, "getIntrospection", value.toJsFn)
    ...
    inline def setSetValue(value: (String, Any) => Callback): Self = StObject.set(x, "setValue", js.Any.fromFunction2((t0: String, t1: Any) => (value(t0, t1)).runNow()))
  }
}
