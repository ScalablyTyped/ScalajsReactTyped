...
import typingsJapgolly.azureCoreClient.azureCoreClientStrings.binary
import typingsJapgolly.azureCoreClient.azureCoreClientStrings.form
import typingsJapgolly.azureCoreClient.azureCoreClientStrings.json
import typingsJapgolly.azureCoreClient.azureCoreClientStrings.multipart
import typingsJapgolly.azureCoreClient.azureCoreClientStrings.text
import typingsJapgolly.azureCoreClient.azureCoreClientStrings.unknown
import typingsJapgolly.azureCoreClient.azureCoreClientStrings.xml
...
trait OperationSpec extends StObject {
  ...
  /**
    ...
    * returned.
    */
  val responses: StringDictionary[OperationResponseMap]
...
object OperationSpec {
  ...
  inline def apply(httpMethod: HttpMethods, responses: StringDictionary[OperationResponseMap], serializer: Serializer): OperationSpec = {
  ...
  extension [Self <: OperationSpec](x: Self) {
    ...
    inline def setResponses(value: StringDictionary[OperationResponseMap]): Self = StObject.set(x, "responses", value.asInstanceOf[js.Any])
