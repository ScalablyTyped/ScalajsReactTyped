...
import typingsJapgolly.azureCoreClient.mod.^
import typingsJapgolly.azureCoreRestPipeline.typesLatestCoreRestPipelineMod.AuthorizeRequestOnChallengeOptions
