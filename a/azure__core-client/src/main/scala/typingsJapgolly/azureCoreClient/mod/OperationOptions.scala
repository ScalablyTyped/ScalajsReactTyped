...
object OperationOptions {
  ...
  extension [Self <: OperationOptions](x: Self) {
    ...
    inline def setOnResponse(
      value: (/* rawResponse */ FullOperationResponse, /* flatResponse */ Any, /* error */ js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "onResponse", js.Any.fromFunction3((t0: /* rawResponse */ FullOperationResponse, t1: /* flatResponse */ Any, t2: /* error */ js.UndefOr[Any]) => (value(t0, t1, t2)).runNow()))
