...
import typingsJapgolly.antvAttr.libInterfaceMod.CallbackType
...
object libAttributesBaseMod {
  ...
  object Attribute {
    ...
    inline def apply(
      ...
      defaultCallback: Any,
      getFields: CallbackTo[js.Array[String]],
      getLinearValue: Double => Double | String,
      getNames: CallbackTo[js.Array[Any]],
      getScale: String => Any,
      linear: Boolean,
    ...
    extension [Self <: Attribute](x: Self) {
      ...
      inline def setGetFields(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "getFields", value.toJsFn)
      
      inline def setGetLinearValue(value: Double => Double | String): Self = StObject.set(x, "getLinearValue", js.Any.fromFunction1(value))
      
      inline def setGetNames(value: CallbackTo[js.Array[Any]]): Self = StObject.set(x, "getNames", value.toJsFn)
