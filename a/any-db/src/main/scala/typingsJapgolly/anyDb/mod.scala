  ...
  object PoolConfig {
    ...
    extension [Self <: PoolConfig](x: Self) {
      ...
      inline def setOnConnect(
        value: (/* connection */ Connection, /* ready */ js.Function2[/* error */ js.Error, /* result */ Connection, Unit]) => Callback
      ): Self = StObject.set(x, "onConnect", js.Any.fromFunction2((t0: /* connection */ Connection, t1: /* ready */ js.Function2[/* error */ js.Error, /* result */ Connection, Unit]) => (value(t0, t1)).runNow()))
      ...
      inline def setReset(
        value: (/* connection */ Connection, /* done */ js.Function1[/* error */ js.Error, Unit]) => Callback
      ): Self = StObject.set(x, "reset", js.Any.fromFunction2((t0: /* connection */ Connection, t1: /* done */ js.Function1[/* error */ js.Error, Unit]) => (value(t0, t1)).runNow()))
