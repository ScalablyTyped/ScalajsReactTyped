...
import typingsJapgolly.airbnbPropTypes.anon.Gt
import typingsJapgolly.airbnbPropTypes.anon.StripHOCs
...
object mod {
  ...
  object ReactComponentLike {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], forceUpdate = js.Any.fromFunction1(forceUpdate), props = props.asInstanceOf[js.Any], refs = refs.asInstanceOf[js.Any], render = render.toJsFn, setState = js.Any.fromFunction1(setState), state = state.asInstanceOf[js.Any])
    ...
    extension [Self <: ReactComponentLike](x: Self) {
      ...
      inline def setRender(value: CallbackTo[ReactNodeLike]): Self = StObject.set(x, "render", value.toJsFn)
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.airbnbPropTypes.mod.ReactClassComponentLike
    - typingsJapgolly.airbnbPropTypes.mod.ReactFunctionComponentLike
  */
