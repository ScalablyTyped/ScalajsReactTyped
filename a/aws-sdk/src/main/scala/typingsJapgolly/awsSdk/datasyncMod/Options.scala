...
trait Options extends js.Object {
  /**
    ...
    */
  var Atime: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.Atime] = js.native
  /**
    * A value that limits the bandwidth used by AWS DataSync. For example, if you want AWS DataSync to use a maximum of 1 MB, set this value to 1048576 (=1024*1024).
    */
  var BytesPerSecond: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.BytesPerSecond] = js.native
  /**
    ...
    */
  var Gid: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.Gid] = js.native
  /**
    ...
    */
  var LogLevel: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.LogLevel] = js.native
  /**
    ...
    */
  var Mtime: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.Mtime] = js.native
  /**
    ...
    */
  var OverwriteMode: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.OverwriteMode] = js.native
  /**
    ...
    */
  var PosixPermissions: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.PosixPermissions] = js.native
  /**
    ...
    */
  var PreserveDeletedFiles: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.PreserveDeletedFiles] = js.native
  /**
    ...
    */
  var PreserveDevices: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.PreserveDevices] = js.native
  /**
    ...
    */
  var TaskQueueing: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.TaskQueueing] = js.native
  /**
    ...
    */
  var Uid: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.Uid] = js.native
  /**
    ...
    */
  var VerifyMode: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.VerifyMode] = js.native
}
