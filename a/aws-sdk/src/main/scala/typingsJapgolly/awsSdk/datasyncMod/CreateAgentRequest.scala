...
trait CreateAgentRequest extends js.Object {
  /**
    ...
    */
  var ActivationKey: typingsJapgolly.awsSdk.datasyncMod.ActivationKey = js.native
  /**
  ...
  /**
    ...
    */
  var VpcEndpointId: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.VpcEndpointId] = js.native
}
