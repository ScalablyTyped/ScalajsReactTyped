...
trait DescribeLocationS3Response extends js.Object {
  ...
  var S3Config: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.S3Config] = js.native
  /**
    ...
    */
  var S3StorageClass: js.UndefOr[typingsJapgolly.awsSdk.datasyncMod.S3StorageClass] = js.native
}
