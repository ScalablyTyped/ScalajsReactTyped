...
trait HistoricalMetric extends js.Object {
  ...
  /**
    ...
    */
  var Statistic: js.UndefOr[typingsJapgolly.awsSdk.connectMod.Statistic] = js.native
  /**
    * The threshold for the metric, used with service level metrics.
    */
  var Threshold: js.UndefOr[typingsJapgolly.awsSdk.connectMod.Threshold] = js.native
  /**
    * The unit for the metric.
    */
  var Unit: js.UndefOr[typingsJapgolly.awsSdk.connectMod.Unit] = js.native
}
