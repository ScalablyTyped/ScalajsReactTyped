...
trait User extends js.Object {
  ...
  /**
    ...
    */
  var DirectoryUserId: js.UndefOr[typingsJapgolly.awsSdk.connectMod.DirectoryUserId] = js.native
  /**
  ...
  /**
    ...
    */
  var RoutingProfileId: js.UndefOr[typingsJapgolly.awsSdk.connectMod.RoutingProfileId] = js.native
  /**
    * The identifiers of the security profiles for the user.
    */
  var SecurityProfileIds: js.UndefOr[typingsJapgolly.awsSdk.connectMod.SecurityProfileIds] = js.native
  /**
    * The tags.
    */
