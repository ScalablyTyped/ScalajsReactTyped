...
trait GetMetricDataRequest extends js.Object {
  ...
  /**
    ...
    */
  var Filters: typingsJapgolly.awsSdk.connectMod.Filters = js.native
  /**
    ...
    */
  var Groupings: js.UndefOr[typingsJapgolly.awsSdk.connectMod.Groupings] = js.native
  /**
    ...
    */
  var HistoricalMetrics: typingsJapgolly.awsSdk.connectMod.HistoricalMetrics = js.native
  /**
