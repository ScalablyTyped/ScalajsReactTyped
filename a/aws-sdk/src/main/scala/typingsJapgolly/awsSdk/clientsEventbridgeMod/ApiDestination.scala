...
trait ApiDestination extends StObject {
  ...
  /**
    ...
    */
  var ApiDestinationArn: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.ApiDestinationArn] = js.undefined
  
  /**
    * The state of the API destination.
    */
  var ApiDestinationState: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.ApiDestinationState] = js.undefined
  
  /**
    * The ARN of the connection specified for the API destination.
    */
  var ConnectionArn: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.ConnectionArn] = js.undefined
