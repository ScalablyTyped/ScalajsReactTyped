...
trait EcsParameters extends StObject {
  ...
  /**
    ...
    */
  var CapacityProviderStrategy: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.CapacityProviderStrategy] = js.undefined
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.LaunchType] = js.undefined
  ...
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.NetworkConfiguration] = js.undefined
  
  /**
    * An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime).
    */
  var PlacementConstraints: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.PlacementConstraints] = js.undefined
  ...
  /**
    ...
    */
  var PropagateTags: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.PropagateTags] = js.undefined
  
  /**
    * The reference ID to use for the task.
    */
  var ReferenceId: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.ReferenceId] = js.undefined
