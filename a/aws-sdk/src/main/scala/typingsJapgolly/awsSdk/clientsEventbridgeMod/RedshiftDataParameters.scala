...
trait RedshiftDataParameters extends StObject {
  ...
  /**
    ...
    */
  var Database: typingsJapgolly.awsSdk.clientsEventbridgeMod.Database
  
  /**
    * The database user name. Required when authenticating using temporary credentials.
    */
  var DbUser: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.DbUser] = js.undefined
  ...
  /**
    ...
    */
  var Sql: typingsJapgolly.awsSdk.clientsEventbridgeMod.Sql
  
  /**
    * The name of the SQL statement. You can name the SQL statement when you create it to identify the query.
    */
  var StatementName: js.UndefOr[typingsJapgolly.awsSdk.clientsEventbridgeMod.StatementName] = js.undefined
