...
trait HIT extends js.Object {
  ...
  /**
    ...
    */
  var HITReviewStatus: js.UndefOr[typingsJapgolly.awsSdk.mturkMod.HITReviewStatus] = js.native
  /**
    * The status of the HIT and its assignments. Valid Values are Assignable | Unassignable | Reviewable | Reviewing | Disposed. 
    */
  var HITStatus: js.UndefOr[typingsJapgolly.awsSdk.mturkMod.HITStatus] = js.native
  /**
