...
trait ScheduleAction extends js.Object {
  ...
  /**
    ...
    */
  var ScheduleActionSettings: typingsJapgolly.awsSdk.medialiveMod.ScheduleActionSettings = js.native
  /**
    * The time for the action to start in the channel.
    */
  var ScheduleActionStartSettings: typingsJapgolly.awsSdk.medialiveMod.ScheduleActionStartSettings = js.native
}
