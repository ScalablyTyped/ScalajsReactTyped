...
trait OutputSettings extends js.Object {
  var ArchiveOutputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.ArchiveOutputSettings] = js.native
  var FrameCaptureOutputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.FrameCaptureOutputSettings] = js.native
  var HlsOutputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.HlsOutputSettings] = js.native
  var MediaPackageOutputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.MediaPackageOutputSettings] = js.native
  var MsSmoothOutputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.MsSmoothOutputSettings] = js.native
  var MultiplexOutputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.MultiplexOutputSettings] = js.native
  var RtmpOutputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.RtmpOutputSettings] = js.native
  var UdpOutputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.UdpOutputSettings] = js.native
}
