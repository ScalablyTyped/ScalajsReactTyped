...
trait InputSettings extends js.Object {
  ...
  3) forced - filtering will be applied regardless of input type
    */
  var InputFilter: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.InputFilter] = js.native
  /**
    * Input settings.
    */
  var NetworkInputSettings: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.NetworkInputSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var VideoSelector: js.UndefOr[typingsJapgolly.awsSdk.medialiveMod.VideoSelector] = js.native
}
