...
trait ListWebhooksInput extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsCodepipelineMod.MaxResults] = js.undefined
  
  /**
    * The token that was returned from the previous ListWebhooks call, which can be used to return the next set of webhooks in the list.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsCodepipelineMod.NextToken] = js.undefined
}
