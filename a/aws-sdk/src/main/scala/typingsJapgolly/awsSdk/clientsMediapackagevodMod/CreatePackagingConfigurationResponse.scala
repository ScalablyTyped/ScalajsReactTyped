...
trait CreatePackagingConfigurationResponse extends StObject {
  ...
  var CmafPackage: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackagevodMod.CmafPackage] = js.undefined
  
  var DashPackage: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackagevodMod.DashPackage] = js.undefined
  
  var HlsPackage: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackagevodMod.HlsPackage] = js.undefined
  ...
  var MssPackage: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackagevodMod.MssPackage] = js.undefined
...
object CreatePackagingConfigurationResponse {
  ...
  inline def apply(): CreatePackagingConfigurationResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreatePackagingConfigurationResponse]
  }
  
  extension [Self <: CreatePackagingConfigurationResponse](x: Self) {
