...
trait EncryptionContractConfiguration extends StObject {
  ...
  /**
    ...
    */
  var PresetSpeke20Audio: typingsJapgolly.awsSdk.clientsMediapackagevodMod.PresetSpeke20Audio
  
  /**
    * A collection of video encryption presets.
    */
  var PresetSpeke20Video: typingsJapgolly.awsSdk.clientsMediapackagevodMod.PresetSpeke20Video
}
