...
trait ListConnectionsInput extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.codestarconnectionsMod.MaxResults] = js.native
  /**
    * The token that was returned from the previous ListConnections call, which can be used to return the next set of connections in the list.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.codestarconnectionsMod.NextToken] = js.native
  /**
