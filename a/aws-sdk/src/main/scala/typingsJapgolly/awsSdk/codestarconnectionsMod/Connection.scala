...
trait Connection extends js.Object {
  /**
    ...
    */
  var ConnectionArn: js.UndefOr[typingsJapgolly.awsSdk.codestarconnectionsMod.ConnectionArn] = js.native
  /**
    * The name of the connection. Connection names must be unique in an AWS user account.
    */
  var ConnectionName: js.UndefOr[typingsJapgolly.awsSdk.codestarconnectionsMod.ConnectionName] = js.native
  /**
    * The current status of the connection. 
    */
  var ConnectionStatus: js.UndefOr[typingsJapgolly.awsSdk.codestarconnectionsMod.ConnectionStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var ProviderType: js.UndefOr[typingsJapgolly.awsSdk.codestarconnectionsMod.ProviderType] = js.native
}
