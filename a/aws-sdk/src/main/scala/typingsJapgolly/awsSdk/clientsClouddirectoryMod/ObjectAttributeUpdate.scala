...
trait ObjectAttributeUpdate extends StObject {
  ...
  /**
    ...
    */
  var ObjectAttributeAction: js.UndefOr[typingsJapgolly.awsSdk.clientsClouddirectoryMod.ObjectAttributeAction] = js.undefined
...
object ObjectAttributeUpdate {
  ...
  extension [Self <: ObjectAttributeUpdate](x: Self) {
