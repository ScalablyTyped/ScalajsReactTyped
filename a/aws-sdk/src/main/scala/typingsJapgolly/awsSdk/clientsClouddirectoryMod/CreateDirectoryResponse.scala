...
trait CreateDirectoryResponse extends StObject {
  ...
  /**
    ...
    */
  var DirectoryArn: typingsJapgolly.awsSdk.clientsClouddirectoryMod.DirectoryArn
  ...
  /**
    ...
    */
  var ObjectIdentifier: typingsJapgolly.awsSdk.clientsClouddirectoryMod.ObjectIdentifier
}
