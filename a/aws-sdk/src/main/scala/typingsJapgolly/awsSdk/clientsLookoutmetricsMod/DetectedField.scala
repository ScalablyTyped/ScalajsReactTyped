...
trait DetectedField extends StObject {
  ...
  /**
    ...
    */
  var Confidence: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.Confidence] = js.undefined
  
  /**
    * The field's message.
    */
  var Message: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.Message] = js.undefined
