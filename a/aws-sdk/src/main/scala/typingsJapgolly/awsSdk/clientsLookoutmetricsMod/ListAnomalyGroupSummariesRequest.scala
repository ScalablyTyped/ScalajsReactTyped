...
trait ListAnomalyGroupSummariesRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MaxResults] = js.undefined
  ...
  /**
    ...
    */
  var SensitivityThreshold: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.SensitivityThreshold
}
