...
trait CreateAnomalyDetectorRequest extends StObject {
  ...
  /**
    ...
    */
  var AnomalyDetectorConfig: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AnomalyDetectorConfig
  
  /**
    * A description of the detector.
    */
  var AnomalyDetectorDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AnomalyDetectorDescription] = js.undefined
  
  /**
    * The name of the detector.
    */
  var AnomalyDetectorName: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AnomalyDetectorName
  
  /**
    * The ARN of the KMS key to use to encrypt your data.
    */
  var KmsKeyArn: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.KmsKeyArn] = js.undefined
