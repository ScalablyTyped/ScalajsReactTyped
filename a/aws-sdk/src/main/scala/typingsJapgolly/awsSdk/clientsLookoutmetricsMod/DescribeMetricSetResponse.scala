...
trait DescribeMetricSetResponse extends StObject {
  ...
  /**
    ...
    */
  var DimensionList: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.DimensionList] = js.undefined
  ...
  /**
    ...
    */
  var MetricList: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MetricList] = js.undefined
  ...
  /**
    ...
    */
  var MetricSetDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MetricSetDescription] = js.undefined
  ...
  /**
    ...
    */
  var MetricSetName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MetricSetName] = js.undefined
  
  /**
    * Contains information about the dataset's source data.
    */
  var MetricSource: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MetricSource] = js.undefined
  
  /**
    * After an interval ends, the amount of seconds that the detector waits before importing data. Offset is only supported for S3, Redshift, Athena and datasources.
    */
  var Offset: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.Offset] = js.undefined
  
  /**
    * Contains information about the column used for tracking time in your source data.
    */
  var TimestampColumn: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.TimestampColumn] = js.undefined
  
  /**
    * The time zone in which the dataset's data was recorded.
    */
  var Timezone: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.Timezone] = js.undefined
}
