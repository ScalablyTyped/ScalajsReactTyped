...
trait MetricSource extends StObject {
  ...
  /**
    ...
    */
  var AppFlowConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AppFlowConfig] = js.undefined
  
  /**
    * Details about an Amazon Athena datasource.
    */
  var AthenaSourceConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AthenaSourceConfig] = js.undefined
  
  /**
    * Details about an Amazon CloudWatch monitoring datasource.
    */
  var CloudWatchConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.CloudWatchConfig] = js.undefined
  
  /**
    * Details about an Amazon Relational Database Service (RDS) datasource.
    */
  var RDSSourceConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.RDSSourceConfig] = js.undefined
  
  /**
    * Details about an Amazon Redshift database datasource.
    */
  var RedshiftSourceConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.RedshiftSourceConfig] = js.undefined
  
  var S3SourceConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.S3SourceConfig] = js.undefined
}
object MetricSource {
