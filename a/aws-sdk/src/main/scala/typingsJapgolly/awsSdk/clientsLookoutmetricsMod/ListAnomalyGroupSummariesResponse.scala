...
trait ListAnomalyGroupSummariesResponse extends StObject {
  ...
  /**
    ...
    */
  var AnomalyGroupStatistics: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AnomalyGroupStatistics] = js.undefined
  
  /**
    * A list of anomaly group summaries.
    */
  var AnomalyGroupSummaryList: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AnomalyGroupSummaryList] = js.undefined
