...
trait Action extends StObject {
  ...
  /**
    ...
    */
  var LambdaConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.LambdaConfiguration] = js.undefined
  
  /**
    * A configuration for an Amazon SNS channel.
    */
  var SNSConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.SNSConfiguration] = js.undefined
}
object Action {
