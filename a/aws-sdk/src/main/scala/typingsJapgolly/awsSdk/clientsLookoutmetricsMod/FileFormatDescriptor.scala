...
trait FileFormatDescriptor extends StObject {
  ...
  /**
    ...
    */
  var CsvFormatDescriptor: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.CsvFormatDescriptor] = js.undefined
  
  /**
    * Contains information about how a source JSON data file should be analyzed.
    */
  var JsonFormatDescriptor: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.JsonFormatDescriptor] = js.undefined
}
