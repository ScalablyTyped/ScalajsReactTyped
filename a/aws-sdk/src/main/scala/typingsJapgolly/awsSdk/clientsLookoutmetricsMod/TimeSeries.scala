...
trait TimeSeries extends StObject {
  ...
  /**
    ...
    */
  var MetricValueList: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MetricValueList
  
  /**
    * The ID of the metric.
    */
  var TimeSeriesId: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.TimeSeriesId
}
object TimeSeries {
