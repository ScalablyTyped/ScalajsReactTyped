...
trait Alert extends StObject {
  ...
  /**
    ...
    */
  var Action: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.Action] = js.undefined
  ...
  /**
    ...
    */
  var AlertDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AlertDescription] = js.undefined
  
  /**
    * The configuration of the alert filters, containing MetricList and DimensionFilter.
    */
  var AlertFilters: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AlertFilters] = js.undefined
  
  /**
    * The name of the alert.
    */
  var AlertName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AlertName] = js.undefined
  ...
  /**
    ...
    */
  var AlertStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AlertStatus] = js.undefined
  
  /**
    * The type of the alert.
    */
  var AlertType: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutmetricsMod.AlertType] = js.undefined
