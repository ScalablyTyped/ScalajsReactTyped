...
trait CreateMetricSetRequest extends StObject {
  ...
  /**
    ...
    */
  var MetricList: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MetricList
  ...
  /**
    ...
    */
  var MetricSetName: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MetricSetName
  
  /**
    * Contains information about how the source data should be interpreted.
    */
  var MetricSource: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.MetricSource
