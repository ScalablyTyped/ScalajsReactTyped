...
trait VpcConfiguration extends StObject {
  ...
  /**
    ...
    */
  var SecurityGroupIdList: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.SecurityGroupIdList
  
  /**
    * An array of strings containing the Amazon VPC subnet IDs (e.g., subnet-0bb1c79de3EXAMPLE.
    */
  var SubnetIdList: typingsJapgolly.awsSdk.clientsLookoutmetricsMod.SubnetIdList
}
