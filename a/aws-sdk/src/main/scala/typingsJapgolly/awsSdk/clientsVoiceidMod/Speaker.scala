...
trait Speaker extends StObject {
  ...
  /**
    ...
    */
  var CustomerSpeakerId: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.CustomerSpeakerId] = js.undefined
  ...
  /**
    ...
    */
  var GeneratedSpeakerId: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.GeneratedSpeakerId] = js.undefined
...
object Speaker {
  ...
  inline def apply(): Speaker = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[Speaker]
  }
  
  extension [Self <: Speaker](x: Self) {
