...
trait SpeakerEnrollmentJob extends StObject {
  ...
  /**
    ...
    */
  var EnrollmentConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.EnrollmentConfig] = js.undefined
  
  /**
    * Contains details that are populated when an entire batch job fails. In cases of individual registration job failures, the batch job as a whole doesn't fail; it is completed with a JobStatus of COMPLETED_WITH_ERRORS. You can use the job output file to identify the individual registration requests that failed.
    */
  var FailureDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.FailureDetails] = js.undefined
  ...
  /**
    ...
    */
  var InputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.InputDataConfig] = js.undefined
  
  /**
    * The service-generated identifier for the speaker enrollment job.
    */
  var JobId: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.JobId] = js.undefined
  
  /**
    * The client-provided name for the speaker enrollment job.
    */
  var JobName: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.JobName] = js.undefined
  ...
  /**
    ...
    */
  var JobProgress: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.JobProgress] = js.undefined
  ...
  /**
    ...
    */
  var OutputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.OutputDataConfig] = js.undefined
}
object SpeakerEnrollmentJob {
  ...
  extension [Self <: SpeakerEnrollmentJob](x: Self) {
