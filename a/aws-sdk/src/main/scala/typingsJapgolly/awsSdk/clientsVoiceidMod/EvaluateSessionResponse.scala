...
trait EvaluateSessionResponse extends StObject {
  ...
  /**
    ...
    */
  var AuthenticationResult: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.AuthenticationResult] = js.undefined
  ...
  /**
    ...
    */
  var FraudDetectionResult: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.FraudDetectionResult] = js.undefined
  
  /**
    * The service-generated identifier of the session.
    */
  var SessionId: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.SessionId] = js.undefined
  
  /**
    * The client-provided name of the session.
    */
  var SessionName: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.SessionName] = js.undefined
  ...
  /**
    ...
    */
  var StreamingStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsVoiceidMod.StreamingStatus] = js.undefined
}
