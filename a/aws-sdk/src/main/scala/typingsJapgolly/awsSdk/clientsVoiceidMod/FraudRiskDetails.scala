...
trait FraudRiskDetails extends StObject {
  ...
  /**
    ...
    */
  var KnownFraudsterRisk: typingsJapgolly.awsSdk.clientsVoiceidMod.KnownFraudsterRisk
  
  /**
    * The details resulting from 'Voice Spoofing Risk' analysis of the speaker.
    */
  var VoiceSpoofingRisk: typingsJapgolly.awsSdk.clientsVoiceidMod.VoiceSpoofingRisk
}
