...
trait CreateDeliverabilityTestReportResponse extends StObject {
  ...
  /**
    ...
    */
  var DeliverabilityTestStatus: typingsJapgolly.awsSdk.clientsPinpointemailMod.DeliverabilityTestStatus
  
  /**
    * A unique string that identifies the predictive inbox placement test.
    */
  var ReportId: typingsJapgolly.awsSdk.clientsPinpointemailMod.ReportId
}
