...
trait DomainDeliverabilityTrackingOption extends StObject {
  ...
  /**
    ...
    */
  var Domain: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.Domain] = js.undefined
  
  /**
    * An object that contains information about the inbox placement data settings for the domain.
    */
  var InboxPlacementTrackingOption: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.InboxPlacementTrackingOption] = js.undefined
