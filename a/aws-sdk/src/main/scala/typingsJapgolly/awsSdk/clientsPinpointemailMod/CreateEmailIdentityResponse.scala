...
trait CreateEmailIdentityResponse extends StObject {
  ...
  /**
    ...
    */
  var DkimAttributes: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.DkimAttributes] = js.undefined
  
  /**
    * The email identity type.
    */
  var IdentityType: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.IdentityType] = js.undefined
