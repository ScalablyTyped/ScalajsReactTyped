...
trait GetConfigurationSetResponse extends StObject {
  ...
  /**
    ...
    */
  var ConfigurationSetName: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.ConfigurationSetName] = js.undefined
  
  /**
    * An object that defines the dedicated IP pool that is used to send emails that you send using the configuration set.
    */
  var DeliveryOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.DeliveryOptions] = js.undefined
  
  /**
    * An object that defines whether or not Amazon Pinpoint collects reputation metrics for the emails that you send that use the configuration set.
    */
  var ReputationOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.ReputationOptions] = js.undefined
  
  /**
    * An object that defines whether or not Amazon Pinpoint can send email that you send using the configuration set.
    */
  var SendingOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.SendingOptions] = js.undefined
  ...
  /**
    ...
    */
  var TrackingOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.TrackingOptions] = js.undefined
}
