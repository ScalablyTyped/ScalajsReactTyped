...
trait DeliverabilityTestReport extends StObject {
  ...
  /**
    ...
    */
  var DeliverabilityTestStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.DeliverabilityTestStatus] = js.undefined
  ...
  /**
    ...
    */
  var ReportId: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.ReportId] = js.undefined
  
  /**
    * A name that helps you identify a predictive inbox placement test report.
    */
  var ReportName: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.ReportName] = js.undefined
