...
trait OverallVolume extends StObject {
  ...
  /**
    ...
    */
  var DomainIspPlacements: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.DomainIspPlacements] = js.undefined
  ...
  /**
    ...
    */
  var VolumeStatistics: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.VolumeStatistics] = js.undefined
}
