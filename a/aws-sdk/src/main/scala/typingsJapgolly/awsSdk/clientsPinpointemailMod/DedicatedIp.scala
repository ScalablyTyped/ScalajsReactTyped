...
trait DedicatedIp extends StObject {
  ...
  /**
    ...
    */
  var Ip: typingsJapgolly.awsSdk.clientsPinpointemailMod.Ip
  
  /**
    * The name of the dedicated IP pool that the IP address is associated with.
    */
  var PoolName: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointemailMod.PoolName] = js.undefined
  ...
  /**
    ...
    */
  var WarmupStatus: typingsJapgolly.awsSdk.clientsPinpointemailMod.WarmupStatus
}
object DedicatedIp {
