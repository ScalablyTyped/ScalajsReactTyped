...
trait GetDeliverabilityTestReportResponse extends StObject {
  ...
  /**
    ...
    */
  var DeliverabilityTestReport: typingsJapgolly.awsSdk.clientsPinpointemailMod.DeliverabilityTestReport
  
  /**
    * An object that describes how the test email was handled by several email providers, including Gmail, Hotmail, Yahoo, AOL, and others.
    */
  var IspPlacements: typingsJapgolly.awsSdk.clientsPinpointemailMod.IspPlacements
