...
trait DescribeCompanyNetworkConfigurationResponse extends StObject {
  ...
  /**
    ...
    */
  var SecurityGroupIds: js.UndefOr[typingsJapgolly.awsSdk.clientsWorklinkMod.SecurityGroupIds] = js.undefined
  
  /**
    * The subnets used for X-ENI connections from Amazon WorkLink rendering containers.
    */
  var SubnetIds: js.UndefOr[typingsJapgolly.awsSdk.clientsWorklinkMod.SubnetIds] = js.undefined
  
  /**
    * The VPC with connectivity to associated websites.
    */
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.clientsWorklinkMod.VpcId] = js.undefined
}
