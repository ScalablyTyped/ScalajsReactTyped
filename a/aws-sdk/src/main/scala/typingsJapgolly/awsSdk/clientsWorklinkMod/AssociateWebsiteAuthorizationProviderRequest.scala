...
trait AssociateWebsiteAuthorizationProviderRequest extends StObject {
  ...
  /**
    ...
    */
  var AuthorizationProviderType: typingsJapgolly.awsSdk.clientsWorklinkMod.AuthorizationProviderType
  
  /**
    * The domain name of the authorization provider. This applies only to SAML-based authorization providers.
    */
  var DomainName: js.UndefOr[typingsJapgolly.awsSdk.clientsWorklinkMod.DomainName] = js.undefined
