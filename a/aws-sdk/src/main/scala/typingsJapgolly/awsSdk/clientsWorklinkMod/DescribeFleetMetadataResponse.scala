...
trait DescribeFleetMetadataResponse extends StObject {
  ...
  /**
    ...
    */
  var CompanyCode: js.UndefOr[typingsJapgolly.awsSdk.clientsWorklinkMod.CompanyCode] = js.undefined
  ...
  /**
    ...
    */
  var FleetName: js.UndefOr[typingsJapgolly.awsSdk.clientsWorklinkMod.FleetName] = js.undefined
  
  /**
    * The current state of the fleet.
    */
  var FleetStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsWorklinkMod.FleetStatus] = js.undefined
