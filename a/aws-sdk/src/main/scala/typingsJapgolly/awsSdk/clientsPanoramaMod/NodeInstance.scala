...
trait NodeInstance extends StObject {
  ...
  /**
    * The node's ID.
    */
  var NodeId: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.NodeId] = js.undefined
  ...
  /**
    * The instance's name.
    */
  var NodeName: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.NodeName] = js.undefined
