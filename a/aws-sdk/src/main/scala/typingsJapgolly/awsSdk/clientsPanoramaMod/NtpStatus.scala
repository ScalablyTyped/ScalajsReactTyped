...
trait NtpStatus extends StObject {
  ...
  /**
    ...
    */
  var IpAddress: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.IpAddress] = js.undefined
  
  /**
    * The domain name of the server.
    */
  var NtpServerName: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.NtpServerName] = js.undefined
}
object NtpStatus {
