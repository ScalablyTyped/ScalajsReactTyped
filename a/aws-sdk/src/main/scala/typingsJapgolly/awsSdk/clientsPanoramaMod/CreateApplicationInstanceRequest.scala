...
trait CreateApplicationInstanceRequest extends StObject {
  ...
  /**
    * A device's ID.
    */
  var DefaultRuntimeContextDevice: typingsJapgolly.awsSdk.clientsPanoramaMod.DefaultRuntimeContextDevice
  ...
  /**
    ...
    */
  var ManifestPayload: typingsJapgolly.awsSdk.clientsPanoramaMod.ManifestPayload
  ...
  /**
    ...
    */
  var RuntimeRoleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.RuntimeRoleArn] = js.undefined
