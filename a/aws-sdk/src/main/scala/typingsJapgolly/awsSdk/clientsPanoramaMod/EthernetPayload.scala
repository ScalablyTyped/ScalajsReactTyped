...
trait EthernetPayload extends StObject {
  ...
  /**
    ...
    */
  var ConnectionType: typingsJapgolly.awsSdk.clientsPanoramaMod.ConnectionType
  
  /**
    * Network configuration for a static IP connection.
    */
  var StaticIpConnectionInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.StaticIpConnectionInfo] = js.undefined
}
