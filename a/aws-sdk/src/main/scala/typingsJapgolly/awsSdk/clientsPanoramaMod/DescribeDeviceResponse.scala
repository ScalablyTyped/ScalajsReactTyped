...
trait DescribeDeviceResponse extends StObject {
  ...
  /**
    ...
    */
  var AlternateSoftwares: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.AlternateSoftwares] = js.undefined
  ...
  /**
    ...
    */
  var CurrentSoftware: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.CurrentSoftware] = js.undefined
  
  /**
    * The device's description.
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.Description] = js.undefined
  
  /**
    * A device's aggregated status. Including the device's connection status, provisioning status, and lease status.
    */
  var DeviceAggregatedStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.DeviceAggregatedStatus] = js.undefined
  
  /**
    * The device's connection status.
    */
  var DeviceConnectionStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.DeviceConnectionStatus] = js.undefined
  ...
  /**
    ...
    */
  var LatestAlternateSoftware: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.LatestAlternateSoftware] = js.undefined
  
  /**
    * A device's latest job. Includes the target image version, and the job status.
    */
  var LatestDeviceJob: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.LatestDeviceJob] = js.undefined
  
  /**
    * The latest software version available for the device.
    */
  var LatestSoftware: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.LatestSoftware] = js.undefined
