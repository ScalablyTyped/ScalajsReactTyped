...
trait S3Location extends StObject {
  ...
  /**
    * A bucket name.
    */
  var BucketName: typingsJapgolly.awsSdk.clientsPanoramaMod.BucketName
  
  /**
    * An object key.
    */
  var ObjectKey: typingsJapgolly.awsSdk.clientsPanoramaMod.ObjectKey
  
  /**
    * The bucket's Region.
    */
  var Region: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.Region] = js.undefined
}
object S3Location {
