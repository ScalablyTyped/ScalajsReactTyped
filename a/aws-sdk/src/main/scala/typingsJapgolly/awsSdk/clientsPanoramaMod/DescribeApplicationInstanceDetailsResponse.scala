...
trait DescribeApplicationInstanceDetailsResponse extends StObject {
  ...
  /**
    ...
    */
  var ApplicationInstanceId: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.ApplicationInstanceId] = js.undefined
  ...
  /**
    ...
    */
  var DefaultRuntimeContextDevice: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.DefaultRuntimeContextDevice] = js.undefined
  ...
  /**
    ...
    */
  var ManifestOverridesPayload: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.ManifestOverridesPayload] = js.undefined
  
  /**
    * The application instance's configuration manifest.
    */
  var ManifestPayload: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.ManifestPayload] = js.undefined
...
object DescribeApplicationInstanceDetailsResponse {
  ...
  extension [Self <: DescribeApplicationInstanceDetailsResponse](x: Self) {
