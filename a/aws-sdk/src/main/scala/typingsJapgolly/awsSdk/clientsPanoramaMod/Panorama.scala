...
trait Panorama extends Service {
  ...
  /**
    ...
    */
  def signalApplicationInstanceNodeInstances(): Request[SignalApplicationInstanceNodeInstancesResponse, AWSError] = js.native
  def signalApplicationInstanceNodeInstances(
    callback: js.Function2[/* err */ AWSError, /* data */ SignalApplicationInstanceNodeInstancesResponse, Unit]
  ): Request[SignalApplicationInstanceNodeInstancesResponse, AWSError] = js.native
  /**
    * Signal camera nodes to stop or resume.
    */
  def signalApplicationInstanceNodeInstances(params: SignalApplicationInstanceNodeInstancesRequest): Request[SignalApplicationInstanceNodeInstancesResponse, AWSError] = js.native
  def signalApplicationInstanceNodeInstances(
    params: SignalApplicationInstanceNodeInstancesRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ SignalApplicationInstanceNodeInstancesResponse, Unit]
  ): Request[SignalApplicationInstanceNodeInstancesResponse, AWSError] = js.native
