...
trait DeviceJob extends StObject {
  ...
  /**
    ...
    */
  var DeviceName: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.DeviceName] = js.undefined
  
  /**
    * The job's ID.
    */
  var JobId: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.JobId] = js.undefined
  
  /**
    * The job's type.
    */
  var JobType: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.JobType] = js.undefined
}
object DeviceJob {
