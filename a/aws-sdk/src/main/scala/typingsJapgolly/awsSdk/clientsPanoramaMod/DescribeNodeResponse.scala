...
trait DescribeNodeResponse extends StObject {
  ...
  /**
    ...
    */
  var Description: typingsJapgolly.awsSdk.clientsPanoramaMod.Description
  ...
  /**
    * The node's ID.
    */
  var NodeId: typingsJapgolly.awsSdk.clientsPanoramaMod.NodeId
  
  /**
    * The node's interface.
    */
  var NodeInterface: typingsJapgolly.awsSdk.clientsPanoramaMod.NodeInterface
