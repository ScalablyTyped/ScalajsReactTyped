...
trait DescribeDeviceJobResponse extends StObject {
  ...
  /**
    * The device's ARN.
    */
  var DeviceArn: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.DeviceArn] = js.undefined
  ...
  /**
    * The device's type.
    */
  var DeviceType: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.DeviceType] = js.undefined
