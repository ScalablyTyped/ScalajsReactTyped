...
trait CreateJobForDevicesRequest extends StObject {
  ...
  /**
    ...
    */
  var DeviceJobConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsPanoramaMod.DeviceJobConfig] = js.undefined
  
  /**
    * The type of job to run.
    */
  var JobType: typingsJapgolly.awsSdk.clientsPanoramaMod.JobType
}
