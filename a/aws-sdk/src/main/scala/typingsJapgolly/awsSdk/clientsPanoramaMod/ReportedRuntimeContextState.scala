...
trait ReportedRuntimeContextState extends StObject {
  ...
  /**
    ...
    */
  var DesiredState: typingsJapgolly.awsSdk.clientsPanoramaMod.DesiredState
  
  /**
    * The application's reported status.
    */
  var DeviceReportedStatus: typingsJapgolly.awsSdk.clientsPanoramaMod.DeviceReportedStatus
  ...
  /**
    * The device's name.
    */
  var RuntimeContextName: typingsJapgolly.awsSdk.clientsPanoramaMod.RuntimeContextName
}
