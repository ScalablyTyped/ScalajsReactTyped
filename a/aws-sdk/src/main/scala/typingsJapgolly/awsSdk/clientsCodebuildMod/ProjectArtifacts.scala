...
object ProjectArtifacts {
  ...
  inline def apply(`type`: ArtifactsType): ProjectArtifacts = {
  ...
  extension [Self <: ProjectArtifacts](x: Self) {
    ...
    inline def setNamespaceType(value: ArtifactNamespace): Self = StObject.set(x, "namespaceType", value.asInstanceOf[js.Any])
    ...
    inline def setPackaging(value: ArtifactPackaging): Self = StObject.set(x, "packaging", value.asInstanceOf[js.Any])
