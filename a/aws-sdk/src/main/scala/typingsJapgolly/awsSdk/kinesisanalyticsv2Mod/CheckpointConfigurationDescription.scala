...
trait CheckpointConfigurationDescription extends js.Object {
  /**
    ...
    */
  var CheckpointInterval: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.CheckpointInterval] = js.native
  /**
  ...
  /**
    ...
    */
  var ConfigurationType: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ConfigurationType] = js.native
  /**
    ...
    */
  var MinPauseBetweenCheckpoints: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.MinPauseBetweenCheckpoints] = js.native
}
