...
trait Output extends js.Object {
  /**
    ...
    */
  var DestinationSchema: typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.DestinationSchema = js.native
  /**
    * Identifies an Amazon Kinesis Data Firehose delivery stream as the destination.
    */
  var KinesisFirehoseOutput: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.KinesisFirehoseOutput] = js.native
  /**
    * Identifies an Amazon Kinesis data stream as the destination.
    */
  var KinesisStreamsOutput: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.KinesisStreamsOutput] = js.native
  /**
    * Identifies an AWS Lambda function as the destination.
    */
  var LambdaOutput: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.LambdaOutput] = js.native
  /**
