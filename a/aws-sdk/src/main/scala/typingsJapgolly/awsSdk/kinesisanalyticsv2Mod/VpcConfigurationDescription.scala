...
trait VpcConfigurationDescription extends js.Object {
  /**
    ...
    */
  var SecurityGroupIds: typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.SecurityGroupIds = js.native
  /**
    * The array of Subnet IDs used by the VPC configuration.
    */
  var SubnetIds: typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.SubnetIds = js.native
  /**
  ...
  /**
    ...
    */
  var VpcId: typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.VpcId = js.native
}
