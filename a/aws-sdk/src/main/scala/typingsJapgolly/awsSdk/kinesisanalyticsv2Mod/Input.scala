...
trait Input extends js.Object {
  /**
    ...
    */
  var InputParallelism: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.InputParallelism] = js.native
  /**
    * The InputProcessingConfiguration for the input. An input processor transforms records as they are received from the stream, before the application's SQL code executes. Currently, the only input processing configuration available is InputLambdaProcessor. 
    */
  var InputProcessingConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.InputProcessingConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var KinesisFirehoseInput: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.KinesisFirehoseInput] = js.native
  /**
    * If the streaming source is an Amazon Kinesis data stream, identifies the stream's Amazon Resource Name (ARN). 
    */
  var KinesisStreamsInput: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.KinesisStreamsInput] = js.native
  /**
