...
trait InputDescription extends js.Object {
  /**
    ...
    */
  var InAppStreamNames: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.InAppStreamNames] = js.native
  /**
  ...
  /**
    ...
    */
  var InputStartingPositionConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.InputStartingPositionConfiguration] = js.native
  /**
    * If a Kinesis Data Firehose delivery stream is configured as a streaming source, provides the delivery stream's ARN. 
    */
  var KinesisFirehoseInputDescription: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.KinesisFirehoseInputDescription] = js.native
  /**
    * If a Kinesis data stream is configured as a streaming source, provides the Kinesis data stream's Amazon Resource Name (ARN). 
    */
  var KinesisStreamsInputDescription: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.KinesisStreamsInputDescription] = js.native
  /**
