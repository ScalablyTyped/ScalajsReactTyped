...
trait RunConfiguration extends js.Object {
  /**
    ...
    */
  var ApplicationRestoreConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ApplicationRestoreConfiguration] = js.native
  /**
    * Describes the starting parameters for an Apache Flink-based Kinesis Data Analytics application.
    */
  var FlinkRunConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.FlinkRunConfiguration] = js.native
  /**
    * Describes the starting parameters for an SQL-based Kinesis Data Analytics application.
    */
  var SqlRunConfigurations: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.SqlRunConfigurations] = js.native
}
