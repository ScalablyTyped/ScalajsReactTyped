...
trait FlinkApplicationConfiguration extends js.Object {
  /**
    ...
    */
  var CheckpointConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.CheckpointConfiguration] = js.native
  /**
    * Describes configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.MonitoringConfiguration] = js.native
  /**
    * Describes parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ParallelismConfiguration] = js.native
}
