...
trait ApplicationRestoreConfiguration extends js.Object {
  /**
    ...
    */
  var ApplicationRestoreType: typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ApplicationRestoreType = js.native
  /**
    * The identifier of an existing snapshot of application state to use to restart an application. The application uses this value if RESTORE_FROM_CUSTOM_SNAPSHOT is specified for the ApplicationRestoreType.
    */
  var SnapshotName: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.SnapshotName] = js.native
}
