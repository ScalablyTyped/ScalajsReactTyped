...
trait ApplicationConfigurationDescription extends js.Object {
  ...
  var ApplicationCodeConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ApplicationCodeConfigurationDescription
  ] = js.native
  /**
    * Describes whether snapshots are enabled for a Java-based Kinesis Data Analytics application.
    */
  var ApplicationSnapshotConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ApplicationSnapshotConfigurationDescription
  ] = js.native
  /**
    * Describes execution properties for a Java-based Kinesis Data Analytics application.
    */
  var EnvironmentPropertyDescriptions: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.EnvironmentPropertyDescriptions] = js.native
  /**
    * The details about a Java-based Kinesis Data Analytics application.
    */
  var FlinkApplicationConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.FlinkApplicationConfigurationDescription
  ] = js.native
  /**
    * The details about the starting properties for a Kinesis Data Analytics application.
    */
  var RunConfigurationDescription: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.RunConfigurationDescription] = js.native
  /**
  ...
  var SqlApplicationConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.SqlApplicationConfigurationDescription
  ] = js.native
  /**
    * The array of descriptions of VPC configurations available to the application.
    */
  var VpcConfigurationDescriptions: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.VpcConfigurationDescriptions] = js.native
}
