...
trait SqlApplicationConfigurationUpdate extends js.Object {
  /**
    ...
    */
  var InputUpdates: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.InputUpdates] = js.native
  /**
    * The array of OutputUpdate objects describing the new destination streams used by the application.
    */
  var OutputUpdates: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.OutputUpdates] = js.native
  /**
    * The array of ReferenceDataSourceUpdate objects describing the new reference data sources used by the application.
    */
  var ReferenceDataSourceUpdates: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ReferenceDataSourceUpdates] = js.native
}
