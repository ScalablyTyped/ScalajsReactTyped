...
trait ListApplicationSnapshotsResponse extends js.Object {
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.NextToken] = js.native
  /**
    * A collection of objects containing information about the application snapshots.
    */
  var SnapshotSummaries: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.SnapshotSummaries] = js.native
}
