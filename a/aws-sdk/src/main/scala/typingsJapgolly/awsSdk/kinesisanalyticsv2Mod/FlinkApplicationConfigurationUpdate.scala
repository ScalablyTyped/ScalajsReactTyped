...
trait FlinkApplicationConfigurationUpdate extends js.Object {
  /**
    ...
    */
  var CheckpointConfigurationUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.CheckpointConfigurationUpdate] = js.native
  /**
    * Describes updates to the configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfigurationUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.MonitoringConfigurationUpdate] = js.native
  /**
    * Describes updates to the parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfigurationUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ParallelismConfigurationUpdate] = js.native
}
