...
trait S3ReferenceDataSource extends js.Object {
  /**
    ...
    */
  var BucketARN: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.BucketARN] = js.native
  /**
    * The object key name containing the reference data.
    */
  var FileKey: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.FileKey] = js.native
}
