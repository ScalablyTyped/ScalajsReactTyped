...
trait SqlApplicationConfiguration extends js.Object {
  /**
    ...
    */
  var Inputs: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.Inputs] = js.native
  /**
    * The array of Output objects describing the destination streams used by the application.
    */
  var Outputs: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.Outputs] = js.native
  /**
    * The array of ReferenceDataSource objects describing the reference data sources used by the application.
    */
  var ReferenceDataSources: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ReferenceDataSources] = js.native
}
