...
trait ApplicationConfigurationUpdate extends js.Object {
  /**
    ...
    */
  var ApplicationCodeConfigurationUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ApplicationCodeConfigurationUpdate] = js.native
  /**
    * Describes whether snapshots are enabled for a Java-based Kinesis Data Analytics application.
    */
  var ApplicationSnapshotConfigurationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ApplicationSnapshotConfigurationUpdate
  ] = js.native
  /**
    * Describes updates to the environment properties for a Java-based Kinesis Data Analytics application.
    */
  var EnvironmentPropertyUpdates: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.EnvironmentPropertyUpdates] = js.native
  /**
    * Describes updates to a Java-based Kinesis Data Analytics application's configuration.
    */
  var FlinkApplicationConfigurationUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.FlinkApplicationConfigurationUpdate] = js.native
  /**
    * Describes updates to an SQL-based Kinesis Data Analytics application's configuration.
    */
  var SqlApplicationConfigurationUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.SqlApplicationConfigurationUpdate] = js.native
  /**
    * Updates to the array of descriptions of VPC configurations available to the application.
    */
  var VpcConfigurationUpdates: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.VpcConfigurationUpdates] = js.native
}
