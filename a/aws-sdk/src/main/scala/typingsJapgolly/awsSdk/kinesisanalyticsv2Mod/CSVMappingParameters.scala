...
trait CSVMappingParameters extends js.Object {
  /**
    ...
    */
  var RecordColumnDelimiter: typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.RecordColumnDelimiter = js.native
  /**
    * The row delimiter. For example, in a CSV format, '\n' is the typical row delimiter.
    */
  var RecordRowDelimiter: typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.RecordRowDelimiter = js.native
}
