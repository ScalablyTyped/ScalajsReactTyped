...
trait DiscoverInputSchemaResponse extends js.Object {
  ...
  /**
    ...
    */
  var ParsedInputRecords: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ParsedInputRecords] = js.native
  /**
    * The stream data that was modified by the processor specified in the InputProcessingConfiguration parameter.
    */
  var ProcessedInputRecords: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.ProcessedInputRecords] = js.native
  /**
    * The raw stream data that was sampled to infer the schema.
    */
  var RawInputRecords: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.RawInputRecords] = js.native
}
