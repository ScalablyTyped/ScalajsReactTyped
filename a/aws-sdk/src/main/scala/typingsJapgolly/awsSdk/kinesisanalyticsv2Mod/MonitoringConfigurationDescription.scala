...
trait MonitoringConfigurationDescription extends js.Object {
  ...
  /**
    ...
    */
  var LogLevel: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.LogLevel] = js.native
  /**
    * Describes the granularity of the CloudWatch Logs for an application.
    */
  var MetricsLevel: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsv2Mod.MetricsLevel] = js.native
}
