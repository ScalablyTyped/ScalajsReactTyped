...
trait AffectedEntity extends StObject {
  ...
  /**
    ...
    */
  var entityArn: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.entityArn] = js.undefined
  
  /**
    * The URL of the affected entity.
    */
  var entityUrl: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.entityUrl] = js.undefined
  
  /**
    * The ID of the affected entity.
    */
  var entityValue: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.entityValue] = js.undefined
