...
trait OrganizationEvent extends StObject {
  ...
  /**
    ...
    */
  var eventScopeCode: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.eventScopeCode] = js.undefined
  
  /**
    * A list of event type category codes. Possible values are issue, accountNotification, or scheduledChange. Currently, the investigation value isn't supported at this time.
    */
  var eventTypeCategory: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.eventTypeCategory] = js.undefined
  
  /**
    * The unique identifier for the event type. The format is AWS_SERVICE_DESCRIPTION. For example, AWS_EC2_SYSTEM_MAINTENANCE_EVENT.
    */
  var eventTypeCode: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.eventTypeCode] = js.undefined
  ...
  /**
    ...
    */
  var region: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.region] = js.undefined
  
  /**
    * The Amazon Web Services service that is affected by the event, such as EC2 and RDS.
    */
  var service: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.service] = js.undefined
...
object OrganizationEvent {
  ...
  inline def apply(): OrganizationEvent = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OrganizationEvent]
  }
  
  extension [Self <: OrganizationEvent](x: Self) {
