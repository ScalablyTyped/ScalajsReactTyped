...
trait EventAggregate extends StObject {
  ...
  /**
    ...
    */
  var aggregateValue: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.aggregateValue] = js.undefined
  
  /**
    * The number of events of the associated issue type.
    */
  var count: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthMod.count] = js.undefined
}
