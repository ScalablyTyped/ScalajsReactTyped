...
trait CreateAccountStatus extends js.Object {
  /**
    ...
    */
  var AccountId: js.UndefOr[typingsJapgolly.awsSdk.organizationsMod.AccountId] = js.native
  /**
    * The account name given to the account when it was created.
    */
  var AccountName: js.UndefOr[typingsJapgolly.awsSdk.organizationsMod.AccountName] = js.native
  /**
