...
trait PillarDifference extends StObject {
  ...
  /**
    ...
    */
  var DifferenceStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsWellarchitectedMod.DifferenceStatus] = js.undefined
  ...
  /**
    ...
    */
  var QuestionDifferences: js.UndefOr[typingsJapgolly.awsSdk.clientsWellarchitectedMod.QuestionDifferences] = js.undefined
}
