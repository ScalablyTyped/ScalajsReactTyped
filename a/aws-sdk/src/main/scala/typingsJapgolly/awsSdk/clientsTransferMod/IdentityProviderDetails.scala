...
trait IdentityProviderDetails extends StObject {
  ...
  /**
    ...
    */
  var DirectoryId: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.DirectoryId] = js.undefined
  
  /**
    * The ARN for a lambda function to use for the Identity provider.
    */
  var Function: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.Function] = js.undefined
  ...
  /**
    ...
    */
  var Url: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.Url] = js.undefined
}
