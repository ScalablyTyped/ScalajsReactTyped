...
trait DescribedSecurityPolicy extends StObject {
  ...
  /**
    ...
    */
  var Fips: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.Fips] = js.undefined
  
  /**
    * Specifies the name of the security policy that is attached to the server.
    */
  var SecurityPolicyName: typingsJapgolly.awsSdk.clientsTransferMod.SecurityPolicyName
