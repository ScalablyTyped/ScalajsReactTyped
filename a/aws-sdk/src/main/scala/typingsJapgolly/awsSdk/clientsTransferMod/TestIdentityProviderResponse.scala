...
trait TestIdentityProviderResponse extends StObject {
  ...
  /**
    ...
    */
  var Message: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.Message] = js.undefined
  
  /**
    * The response that is returned from your API Gateway.
    */
  var Response: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.Response] = js.undefined
  
  /**
    * The HTTP status code that is the response from your API Gateway.
    */
  var StatusCode: typingsJapgolly.awsSdk.clientsTransferMod.StatusCode
  
  /**
    * The endpoint of the service used to authenticate a user.
    */
  var Url: typingsJapgolly.awsSdk.clientsTransferMod.Url
}
