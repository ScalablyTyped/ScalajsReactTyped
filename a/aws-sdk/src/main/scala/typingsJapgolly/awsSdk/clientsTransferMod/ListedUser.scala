...
trait ListedUser extends StObject {
  ...
  /**
    ...
    */
  var SshPublicKeyCount: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.SshPublicKeyCount] = js.undefined
  
  /**
    * Specifies the name of the user whose ARN was specified. User names are used for authentication purposes.
    */
  var UserName: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.UserName] = js.undefined
}
object ListedUser {
