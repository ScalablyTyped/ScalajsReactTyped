...
trait UpdateAccessRequest extends StObject {
  ...
  /**
    ...
    */
  var Role: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.Role] = js.undefined
...
object UpdateAccessRequest {
  ...
  inline def apply(ExternalId: ExternalId, ServerId: ServerId): UpdateAccessRequest = {
