...
trait DescribeAccessRequest extends StObject {
...
object DescribeAccessRequest {
  ...
  inline def apply(ExternalId: ExternalId, ServerId: ServerId): DescribeAccessRequest = {
  ...
  extension [Self <: DescribeAccessRequest](x: Self) {
