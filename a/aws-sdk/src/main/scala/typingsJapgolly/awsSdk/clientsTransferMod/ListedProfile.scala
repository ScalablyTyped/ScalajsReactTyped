...
trait ListedProfile extends StObject {
  ...
  /**
    ...
    */
  var As2Id: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.As2Id] = js.undefined
  
  /**
    * A unique identifier for the local or partner AS2 profile.
    */
  var ProfileId: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.ProfileId] = js.undefined
