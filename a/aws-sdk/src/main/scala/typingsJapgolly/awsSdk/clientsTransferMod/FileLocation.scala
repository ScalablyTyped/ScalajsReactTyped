...
trait FileLocation extends StObject {
  ...
  /**
    ...
    */
  var EfsFileLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.EfsFileLocation] = js.undefined
  
  /**
    * Specifies the S3 details for the file being used, such as bucket, ETag, and so forth.
    */
  var S3FileLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.S3FileLocation] = js.undefined
}
object FileLocation {
