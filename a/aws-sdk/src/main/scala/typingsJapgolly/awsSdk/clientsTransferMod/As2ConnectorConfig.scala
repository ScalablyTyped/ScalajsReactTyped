...
trait As2ConnectorConfig extends StObject {
  ...
  /**
    ...
    */
  var MdnResponse: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.MdnResponse] = js.undefined
  ...
  /**
    ...
    */
  var MessageSubject: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.MessageSubject] = js.undefined
