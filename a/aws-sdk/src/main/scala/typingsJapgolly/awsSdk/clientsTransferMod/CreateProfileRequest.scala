...
trait CreateProfileRequest extends StObject {
  ...
  /**
    ...
    */
  var As2Id: typingsJapgolly.awsSdk.clientsTransferMod.As2Id
  
  /**
    * An array of identifiers for the imported certificates. You use this identifier for working with profiles and partner profiles.
    */
  var CertificateIds: js.UndefOr[typingsJapgolly.awsSdk.clientsTransferMod.CertificateIds] = js.undefined
  ...
  /**
    ...
    */
  var ProfileType: typingsJapgolly.awsSdk.clientsTransferMod.ProfileType
