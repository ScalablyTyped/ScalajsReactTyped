...
trait CollectionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CollectionName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.CollectionName] = js.undefined
  
  /**
    * Parameter values for the tensor collection. The allowed parameters are "name", "include_regex", "reduction_config", "save_config", "tensor_names", and "save_histogram".
    */
  var CollectionParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.CollectionParameters] = js.undefined
}
