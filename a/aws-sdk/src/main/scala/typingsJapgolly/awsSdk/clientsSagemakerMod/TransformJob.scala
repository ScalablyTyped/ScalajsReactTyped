...
trait TransformJob extends StObject {
  ...
  /**
    ...
    */
  var ModelName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelName] = js.undefined
  ...
  var TransformInput: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TransformInput] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the transform job.
    */
  var TransformJobArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TransformJobArn] = js.undefined
  
  /**
    * The name of the transform job.
    */
  var TransformJobName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TransformJobName] = js.undefined
  ...
  /**
    ...
    */
  var TransformJobStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TransformJobStatus] = js.undefined
  
  var TransformOutput: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TransformOutput] = js.undefined
  
  var TransformResources: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TransformResources] = js.undefined
