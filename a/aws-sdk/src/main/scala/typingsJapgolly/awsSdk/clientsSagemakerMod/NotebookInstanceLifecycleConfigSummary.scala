...
trait NotebookInstanceLifecycleConfigSummary extends StObject {
  ...
  /**
    ...
    */
  var NotebookInstanceLifecycleConfigArn: typingsJapgolly.awsSdk.clientsSagemakerMod.NotebookInstanceLifecycleConfigArn
  
  /**
    * The name of the lifecycle configuration.
    */
  var NotebookInstanceLifecycleConfigName: typingsJapgolly.awsSdk.clientsSagemakerMod.NotebookInstanceLifecycleConfigName
}
