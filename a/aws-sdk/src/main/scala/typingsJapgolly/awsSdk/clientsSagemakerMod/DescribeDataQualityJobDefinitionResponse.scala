...
trait DescribeDataQualityJobDefinitionResponse extends StObject {
  ...
  /**
    ...
    */
  var DataQualityAppSpecification: typingsJapgolly.awsSdk.clientsSagemakerMod.DataQualityAppSpecification
  
  /**
    * The constraints and baselines for the data quality monitoring job definition.
    */
  var DataQualityBaselineConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DataQualityBaselineConfig] = js.undefined
  
  /**
    * The list of inputs for the data quality monitoring job. Currently endpoints are supported.
    */
  var DataQualityJobInput: typingsJapgolly.awsSdk.clientsSagemakerMod.DataQualityJobInput
