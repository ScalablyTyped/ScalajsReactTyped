...
trait DataCaptureConfigSummary extends StObject {
  ...
  /**
    ...
    */
  var CaptureStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.CaptureStatus
  ...
  /**
    ...
    */
  var EnableCapture: typingsJapgolly.awsSdk.clientsSagemakerMod.EnableCapture
  
  /**
    * The KMS key being used to encrypt the data in Amazon S3.
    */
  var KmsKeyId: typingsJapgolly.awsSdk.clientsSagemakerMod.KmsKeyId
}
