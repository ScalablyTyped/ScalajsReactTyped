...
trait CreateModelExplainabilityJobDefinitionRequest extends StObject {
  ...
  /**
    ...
    */
  var ModelExplainabilityAppSpecification: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelExplainabilityAppSpecification
  
  /**
    * The baseline configuration for a model explainability job.
    */
  var ModelExplainabilityBaselineConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelExplainabilityBaselineConfig] = js.undefined
  
  /**
    * Inputs for the model explainability job.
    */
  var ModelExplainabilityJobInput: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelExplainabilityJobInput
