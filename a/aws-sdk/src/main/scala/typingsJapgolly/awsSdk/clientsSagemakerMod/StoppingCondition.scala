...
trait StoppingCondition extends StObject {
  ...
  /**
    ...
    */
  var MaxRuntimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MaxRuntimeInSeconds] = js.undefined
  ...
  /**
    ...
    */
  var MaxWaitTimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MaxWaitTimeInSeconds] = js.undefined
}
