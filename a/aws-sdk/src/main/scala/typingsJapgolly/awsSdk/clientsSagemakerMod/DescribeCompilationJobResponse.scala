...
trait DescribeCompilationJobResponse extends StObject {
  ...
  /**
    ...
    */
  var CompilationJobStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.CompilationJobStatus
  ...
  /**
    ...
    */
  var FailureReason: typingsJapgolly.awsSdk.clientsSagemakerMod.FailureReason
  
  /**
    * The inference image to use when compiling a model. Specify an image only if the target device is a cloud instance.
    */
  var InferenceImage: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.InferenceImage] = js.undefined
  
  /**
    * Information about the location in Amazon S3 of the input model artifacts, the name and shape of the expected data inputs, and the framework in which the model was trained.
    */
  var InputConfig: typingsJapgolly.awsSdk.clientsSagemakerMod.InputConfig
  ...
  /**
    ...
    */
  var ModelArtifacts: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelArtifacts
  
  /**
    * Provides a BLAKE2 hash value that identifies the compiled model artifacts in Amazon S3.
    */
  var ModelDigests: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelDigests] = js.undefined
  ...
  /**
    ...
    */
  var OutputConfig: typingsJapgolly.awsSdk.clientsSagemakerMod.OutputConfig
  ...
  /**
    ...
    */
  var StoppingCondition: typingsJapgolly.awsSdk.clientsSagemakerMod.StoppingCondition
