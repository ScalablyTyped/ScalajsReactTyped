...
trait ProfilerConfigForUpdate extends StObject {
  ...
  /**
    ...
    */
  var DisableProfiler: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DisableProfiler] = js.undefined
  
  /**
    * A time interval for capturing system metrics in milliseconds. Available values are 100, 200, 500, 1000 (1 second), 5000 (5 seconds), and 60000 (1 minute) milliseconds. The default value is 500 milliseconds.
    */
  var ProfilingIntervalInMilliseconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProfilingIntervalInMilliseconds] = js.undefined
  
  /**
    * Configuration information for capturing framework metrics. Available key strings for different profiling options are DetailedProfilingConfig, PythonProfilingConfig, and DataLoaderProfilingConfig. The following codes are configuration structures for the ProfilingParameters parameter. To learn more about how to configure the ProfilingParameters parameter, see Use the SageMaker and Debugger Configuration API Operations to Create, Update, and Debug Your Training Job. 
    */
  var ProfilingParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProfilingParameters] = js.undefined
