...
trait CreatePipelineRequest extends StObject {
  ...
  /**
    ...
    */
  var PipelineDefinition: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.PipelineDefinition] = js.undefined
  
  /**
    * The location of the pipeline definition stored in Amazon S3. If specified, SageMaker will retrieve the pipeline definition from this location.
    */
  var PipelineDefinitionS3Location: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.PipelineDefinitionS3Location] = js.undefined
  
  /**
    * A description of the pipeline.
    */
  var PipelineDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.PipelineDescription] = js.undefined
  ...
  /**
    ...
    */
  var PipelineName: typingsJapgolly.awsSdk.clientsSagemakerMod.PipelineName
