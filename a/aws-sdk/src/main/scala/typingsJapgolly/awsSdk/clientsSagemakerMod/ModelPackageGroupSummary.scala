...
trait ModelPackageGroupSummary extends StObject {
  ...
  /**
    ...
    */
  var ModelPackageGroupArn: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageGroupArn
  ...
  /**
    ...
    */
  var ModelPackageGroupStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageGroupStatus
}
object ModelPackageGroupSummary {
  ...
  extension [Self <: ModelPackageGroupSummary](x: Self) {
