...
trait ProcessingJob extends StObject {
  ...
  var AppSpecification: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AppSpecification] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the AutoML job associated with this processing job.
    */
  var AutoMLJobArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AutoMLJobArn] = js.undefined
  ...
  /**
    ...
    */
  var ExitMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ExitMessage] = js.undefined
  
  var ExperimentConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ExperimentConfig] = js.undefined
  ...
  /**
    ...
    */
  var MonitoringScheduleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MonitoringScheduleArn] = js.undefined
  
  var NetworkConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.NetworkConfig] = js.undefined
  ...
  /**
    ...
    */
  var ProcessingInputs: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingInputs] = js.undefined
  
  /**
    * The ARN of the processing job.
    */
  var ProcessingJobArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingJobArn] = js.undefined
  
  /**
    * The name of the processing job.
    */
  var ProcessingJobName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingJobName] = js.undefined
  
  /**
    * The status of the processing job.
    */
  var ProcessingJobStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingJobStatus] = js.undefined
  
  var ProcessingOutputConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingOutputConfig] = js.undefined
  
  var ProcessingResources: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingResources] = js.undefined
  ...
  /**
    ...
    */
  var TrainingJobArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TrainingJobArn] = js.undefined
}
