...
trait FileSystemConfig extends StObject {
  ...
  /**
    ...
    */
  var DefaultGid: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DefaultGid] = js.undefined
  
  /**
    * The default POSIX user ID (UID). If not specified, defaults to 1000.
    */
  var DefaultUid: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DefaultUid] = js.undefined
  
  /**
    * The path within the image to mount the user's EFS home directory. The directory should be empty. If not specified, defaults to /home/sagemaker-user.
    */
  var MountPath: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MountPath] = js.undefined
}
