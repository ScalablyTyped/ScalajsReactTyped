...
trait BatchDescribeModelPackageOutput extends StObject {
  ...
  /**
    ...
    */
  var BatchDescribeModelPackageErrorMap: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.BatchDescribeModelPackageErrorMap] = js.undefined
  
  /**
    * The summaries for the model package versions
    */
  var ModelPackageSummaries: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageSummaries] = js.undefined
}
