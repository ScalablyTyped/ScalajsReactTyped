...
trait ListModelPackagesInput extends StObject {
  ...
  /**
    ...
    */
  var ModelPackageType: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageType] = js.undefined
  
  /**
    * A string in the model package name. This filter returns only model packages whose name contains the specified string.
    */
  var NameContains: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.NameContains] = js.undefined
  ...
  /**
    ...
    */
  var SortOrder: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SortOrder] = js.undefined
}
