...
trait DescribeInferenceRecommendationsJobResponse extends StObject {
  ...
  /**
    ...
    */
  var InferenceRecommendations: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.InferenceRecommendations] = js.undefined
...
object DescribeInferenceRecommendationsJobResponse {
  ...
  extension [Self <: DescribeInferenceRecommendationsJobResponse](x: Self) {
