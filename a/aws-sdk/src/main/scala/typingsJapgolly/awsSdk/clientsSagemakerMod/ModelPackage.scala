...
trait ModelPackage extends StObject {
  ...
  /**
    ...
    */
  var ModelPackageArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageArn] = js.undefined
  ...
  /**
    ...
    */
  var ModelPackageStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageStatus] = js.undefined
  
  /**
    * Specifies the validation and image scan statuses of the model package.
    */
  var ModelPackageStatusDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageStatusDetails] = js.undefined
