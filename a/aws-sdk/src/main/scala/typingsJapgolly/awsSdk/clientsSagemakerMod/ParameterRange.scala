...
trait ParameterRange extends StObject {
  ...
  var CategoricalParameterRangeSpecification: js.UndefOr[
    typingsJapgolly.awsSdk.clientsSagemakerMod.CategoricalParameterRangeSpecification
  ] = js.undefined
  
  /**
    * A ContinuousParameterRangeSpecification object that defines the possible values for a continuous hyperparameter.
    */
  var ContinuousParameterRangeSpecification: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ContinuousParameterRangeSpecification] = js.undefined
  
  /**
    * A IntegerParameterRangeSpecification object that defines the possible values for an integer hyperparameter.
    */
  var IntegerParameterRangeSpecification: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.IntegerParameterRangeSpecification] = js.undefined
}
