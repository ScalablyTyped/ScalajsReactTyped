...
trait DescribeModelPackageOutput extends StObject {
  ...
  /**
    ...
    */
  var AdditionalInferenceSpecifications: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AdditionalInferenceSpecifications] = js.undefined
  
  /**
    * A description provided for the model approval.
    */
  var ApprovalDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ApprovalDescription] = js.undefined
  ...
  /**
    ...
    */
  var DriftCheckBaselines: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DriftCheckBaselines] = js.undefined
  ...
  var MetadataProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MetadataProperties] = js.undefined
  
  /**
    * The approval status of the model package.
    */
  var ModelApprovalStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelApprovalStatus] = js.undefined
  
  /**
    * Metrics for the model.
    */
  var ModelMetrics: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelMetrics] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the model package.
    */
  var ModelPackageArn: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageArn
  ...
  /**
    ...
    */
  var ModelPackageStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageStatus
  
  /**
    * Details about the current status of the model package.
    */
  var ModelPackageStatusDetails: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageStatusDetails
  
  /**
    * The version of the model package.
    */
  var ModelPackageVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageVersion] = js.undefined
  ...
  /**
    ...
    */
  var SourceAlgorithmSpecification: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SourceAlgorithmSpecification] = js.undefined
