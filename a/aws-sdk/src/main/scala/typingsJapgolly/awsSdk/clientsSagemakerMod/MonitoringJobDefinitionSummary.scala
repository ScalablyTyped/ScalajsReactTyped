...
trait MonitoringJobDefinitionSummary extends StObject {
  ...
  /**
    ...
    */
  var MonitoringJobDefinitionArn: typingsJapgolly.awsSdk.clientsSagemakerMod.MonitoringJobDefinitionArn
  
  /**
    * The name of the monitoring job.
    */
  var MonitoringJobDefinitionName: typingsJapgolly.awsSdk.clientsSagemakerMod.MonitoringJobDefinitionName
}
