...
trait TrialComponentSourceDetail extends StObject {
  ...
  /**
    ...
    */
  var ProcessingJob: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingJob] = js.undefined
  ...
  /**
    ...
    */
  var TransformJob: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TransformJob] = js.undefined
}
