...
trait Phase extends StObject {
  ...
  /**
    ...
    */
  var InitialNumberOfUsers: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.InitialNumberOfUsers] = js.undefined
  
  /**
    * Specified how many new users to spawn in a minute.
    */
  var SpawnRate: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SpawnRate] = js.undefined
}
object Phase {
