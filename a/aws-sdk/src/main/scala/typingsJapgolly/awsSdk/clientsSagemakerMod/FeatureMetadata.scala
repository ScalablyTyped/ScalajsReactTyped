...
trait FeatureMetadata extends StObject {
  ...
  /**
    * The name of feature.
    */
  var FeatureName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FeatureName] = js.undefined
  
  /**
    * The data type of the feature.
    */
  var FeatureType: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FeatureType] = js.undefined
