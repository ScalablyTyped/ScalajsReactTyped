...
trait USD extends StObject {
  ...
  /**
    ...
    */
  var Cents: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Cents] = js.undefined
  
  /**
    * The whole number of dollars in the amount.
    */
  var Dollars: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Dollars] = js.undefined
  
  /**
    * Fractions of a cent, in tenths.
    */
  var TenthFractionsOfACent: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TenthFractionsOfACent] = js.undefined
}
object USD {
