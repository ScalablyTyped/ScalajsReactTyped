...
trait CreateModelBiasJobDefinitionRequest extends StObject {
  ...
  /**
    ...
    */
  var ModelBiasAppSpecification: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelBiasAppSpecification
  
  /**
    * The baseline configuration for a model bias job.
    */
  var ModelBiasBaselineConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelBiasBaselineConfig] = js.undefined
  
  /**
    * Inputs for the model bias job.
    */
  var ModelBiasJobInput: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelBiasJobInput
