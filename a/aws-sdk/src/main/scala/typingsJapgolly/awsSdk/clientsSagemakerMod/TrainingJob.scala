...
trait TrainingJob extends StObject {
  ...
  /**
    ...
    */
  var AlgorithmSpecification: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AlgorithmSpecification] = js.undefined
  ...
  /**
    ...
    */
  var BillableTimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.BillableTimeInSeconds] = js.undefined
  
  var CheckpointConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.CheckpointConfig] = js.undefined
  ...
  var DebugHookConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DebugHookConfig] = js.undefined
  
  /**
    * Information about the debug rule configuration.
    */
  var DebugRuleConfigurations: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DebugRuleConfigurations] = js.undefined
  
  /**
    * Information about the evaluation status of the rules for the training job.
    */
  var DebugRuleEvaluationStatuses: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DebugRuleEvaluationStatuses] = js.undefined
  ...
  /**
    ...
    */
  var FinalMetricDataList: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FinalMetricDataList] = js.undefined
  ...
  /**
    ...
    */
  var InputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.InputDataConfig] = js.undefined
  ...
  /**
    ...
    */
  var ModelArtifacts: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelArtifacts] = js.undefined
  
  /**
    * The S3 path where model artifacts that you configured when creating the job are stored. SageMaker creates subfolders for model artifacts.
    */
  var OutputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.OutputDataConfig] = js.undefined
  
  /**
    * Resources, including ML compute instances and ML storage volumes, that are configured for model training.
    */
  var ResourceConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ResourceConfig] = js.undefined
  
  /**
    * The number of times to retry the job when the job fails due to an InternalServerError.
    */
  var RetryStrategy: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.RetryStrategy] = js.undefined
  ...
  /**
    ...
    */
  var SecondaryStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SecondaryStatus] = js.undefined
  
  /**
    * A history of all of the secondary statuses that the training job has transitioned through.
    */
  var SecondaryStatusTransitions: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SecondaryStatusTransitions] = js.undefined
  ...
  /**
    ...
    */
  var StoppingCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.StoppingCondition] = js.undefined
  ...
  var TensorBoardOutputConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TensorBoardOutputConfig] = js.undefined
  ...
  /**
    ...
    */
  var TrainingJobName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TrainingJobName] = js.undefined
  ...
  /**
    ...
    */
  var TrainingJobStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TrainingJobStatus] = js.undefined
  ...
  /**
    ...
    */
  var TrainingTimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TrainingTimeInSeconds] = js.undefined
