...
trait CreateStudioLifecycleConfigRequest extends StObject {
  ...
  /**
    ...
    */
  var StudioLifecycleConfigAppType: typingsJapgolly.awsSdk.clientsSagemakerMod.StudioLifecycleConfigAppType
  
  /**
    * The content of your Studio Lifecycle Configuration script. This content must be base64 encoded.
    */
  var StudioLifecycleConfigContent: typingsJapgolly.awsSdk.clientsSagemakerMod.StudioLifecycleConfigContent
