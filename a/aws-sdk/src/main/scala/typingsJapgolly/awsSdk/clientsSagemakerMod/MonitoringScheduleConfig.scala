...
trait MonitoringScheduleConfig extends StObject {
  ...
  /**
    ...
    */
  var MonitoringJobDefinition: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MonitoringJobDefinition] = js.undefined
  
  /**
    * The name of the monitoring job definition to schedule.
    */
  var MonitoringJobDefinitionName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MonitoringJobDefinitionName] = js.undefined
  
  /**
    * The type of the monitoring job definition to schedule.
    */
  var MonitoringType: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MonitoringType] = js.undefined
  
  /**
    * Configures the monitoring schedule.
    */
  var ScheduleConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ScheduleConfig] = js.undefined
}
