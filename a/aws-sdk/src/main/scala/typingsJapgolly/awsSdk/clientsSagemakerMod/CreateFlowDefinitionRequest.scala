...
trait CreateFlowDefinitionRequest extends StObject {
  ...
  /**
    ...
    */
  var HumanLoopActivationConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.HumanLoopActivationConfig] = js.undefined
  
  /**
    * An object containing information about the tasks the human reviewers will perform.
    */
  var HumanLoopConfig: typingsJapgolly.awsSdk.clientsSagemakerMod.HumanLoopConfig
  
  /**
    * Container for configuring the source of human task requests. Use to specify if Amazon Rekognition or Amazon Textract is used as an integration source.
    */
  var HumanLoopRequestSource: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.HumanLoopRequestSource] = js.undefined
