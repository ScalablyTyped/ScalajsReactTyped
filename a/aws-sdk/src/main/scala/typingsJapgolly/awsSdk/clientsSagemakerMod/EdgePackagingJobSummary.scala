...
trait EdgePackagingJobSummary extends StObject {
  ...
  /**
    ...
    */
  var EdgePackagingJobArn: typingsJapgolly.awsSdk.clientsSagemakerMod.EdgePackagingJobArn
  ...
  /**
    ...
    */
  var EdgePackagingJobStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.EdgePackagingJobStatus
