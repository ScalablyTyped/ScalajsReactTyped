...
trait HyperParameterTuningJobSummary extends StObject {
  ...
  /**
    ...
    */
  var HyperParameterTuningJobArn: typingsJapgolly.awsSdk.clientsSagemakerMod.HyperParameterTuningJobArn
  ...
  /**
    ...
    */
  var HyperParameterTuningJobStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.HyperParameterTuningJobStatus
  ...
  /**
    ...
    */
  var ObjectiveStatusCounters: typingsJapgolly.awsSdk.clientsSagemakerMod.ObjectiveStatusCounters
  
  /**
    * The ResourceLimits object that specifies the maximum number of training jobs and parallel training jobs allowed for this tuning job.
    */
  var ResourceLimits: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ResourceLimits] = js.undefined
  ...
  /**
    ...
    */
  var TrainingJobStatusCounters: typingsJapgolly.awsSdk.clientsSagemakerMod.TrainingJobStatusCounters
}
