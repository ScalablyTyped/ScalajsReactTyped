...
trait RecommendationJobInputConfig extends StObject {
  ...
  /**
    ...
    */
  var JobDurationInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.JobDurationInSeconds] = js.undefined
  ...
  /**
    ...
    */
  var TrafficPattern: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TrafficPattern] = js.undefined
