...
trait DebugHookConfig extends StObject {
  ...
  /**
    ...
    */
  var CollectionConfigurations: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.CollectionConfigurations] = js.undefined
  
  /**
    * Configuration information for the Debugger hook parameters.
    */
  var HookParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.HookParameters] = js.undefined
