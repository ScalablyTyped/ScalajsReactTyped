...
trait UserSettings extends StObject {
  ...
  /**
    ...
    */
  var CanvasAppSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.CanvasAppSettings] = js.undefined
  ...
  /**
    ...
    */
  var JupyterServerAppSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.JupyterServerAppSettings] = js.undefined
  
  /**
    * The kernel gateway app settings.
    */
  var KernelGatewayAppSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.KernelGatewayAppSettings] = js.undefined
  
  /**
    * A collection of settings that configure the RSessionGateway app.
    */
  var RSessionAppSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.RSessionAppSettings] = js.undefined
  
  /**
    * A collection of settings that configure user interaction with the RStudioServerPro app.
    */
  var RStudioServerProAppSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.RStudioServerProAppSettings] = js.undefined
  ...
  /**
    ...
    */
  var SharingSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SharingSettings] = js.undefined
  
  /**
    * The TensorBoard app settings.
    */
  var TensorBoardAppSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TensorBoardAppSettings] = js.undefined
}
object UserSettings {
