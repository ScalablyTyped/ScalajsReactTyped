...
trait ProcessingInput extends StObject {
  ...
  /**
    ...
    */
  var AppManaged: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AppManaged] = js.undefined
  
  /**
    * Configuration for a Dataset Definition input. 
    */
  var DatasetDefinition: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DatasetDefinition] = js.undefined
