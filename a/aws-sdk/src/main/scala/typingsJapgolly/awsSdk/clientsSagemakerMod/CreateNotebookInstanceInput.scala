...
trait CreateNotebookInstanceInput extends StObject {
  ...
  /**
    ...
    */
  var InstanceType: typingsJapgolly.awsSdk.clientsSagemakerMod.InstanceType
  ...
  /**
    ...
    */
  var SecurityGroupIds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SecurityGroupIds] = js.undefined
