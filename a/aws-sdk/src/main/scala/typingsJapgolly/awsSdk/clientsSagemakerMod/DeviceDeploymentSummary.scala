...
trait DeviceDeploymentSummary extends StObject {
  ...
  /**
    ...
    */
  var DeviceArn: typingsJapgolly.awsSdk.clientsSagemakerMod.DeviceArn
  
  /**
    * The deployment status of the device.
    */
  var DeviceDeploymentStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DeviceDeploymentStatus] = js.undefined
  ...
  /**
    ...
    */
  var DeviceName: typingsJapgolly.awsSdk.clientsSagemakerMod.DeviceName
