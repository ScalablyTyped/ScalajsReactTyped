...
trait DescribePipelineResponse extends StObject {
  ...
  /**
    ...
    */
  var PipelineName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.PipelineName] = js.undefined
  
  /**
    * The status of the pipeline execution.
    */
  var PipelineStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.PipelineStatus] = js.undefined
