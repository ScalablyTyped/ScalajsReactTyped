...
trait FeatureGroup extends StObject {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Description] = js.undefined
  ...
  /**
    ...
    */
  var FeatureDefinitions: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FeatureDefinitions] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of a FeatureGroup.
    */
  var FeatureGroupArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FeatureGroupArn] = js.undefined
  
  /**
    * The name of the FeatureGroup.
    */
  var FeatureGroupName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FeatureGroupName] = js.undefined
  
  /**
    * A FeatureGroup status.
    */
  var FeatureGroupStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FeatureGroupStatus] = js.undefined
  ...
  /**
    ...
    */
  var LastUpdateStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.LastUpdateStatus] = js.undefined
  
  var OfflineStoreConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.OfflineStoreConfig] = js.undefined
  
  var OfflineStoreStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.OfflineStoreStatus] = js.undefined
  
  var OnlineStoreConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.OnlineStoreConfig] = js.undefined
