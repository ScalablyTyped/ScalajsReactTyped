...
trait AutoMLCandidate extends StObject {
  ...
  /**
    ...
    */
  var CandidateName: typingsJapgolly.awsSdk.clientsSagemakerMod.CandidateName
  
  /**
    * The properties of an AutoML candidate job.
    */
  var CandidateProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.CandidateProperties] = js.undefined
  
  /**
    * The candidate's status.
    */
  var CandidateStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.CandidateStatus
  
  /**
    * Information about the candidate's steps.
    */
  var CandidateSteps: typingsJapgolly.awsSdk.clientsSagemakerMod.CandidateSteps
  ...
  var FinalAutoMLJobObjectiveMetric: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FinalAutoMLJobObjectiveMetric] = js.undefined
  ...
  /**
    ...
    */
  var ObjectiveStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.ObjectiveStatus
}
