...
trait DescribeAutoMLJobResponse extends StObject {
  ...
  /**
    ...
    */
  var AutoMLJobArtifacts: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AutoMLJobArtifacts] = js.undefined
  
  /**
    * Returns the configuration for the AutoML job.
    */
  var AutoMLJobConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AutoMLJobConfig] = js.undefined
  ...
  /**
    ...
    */
  var AutoMLJobObjective: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AutoMLJobObjective] = js.undefined
  
  /**
    * Returns the secondary status of the AutoML job.
    */
  var AutoMLJobSecondaryStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.AutoMLJobSecondaryStatus
  
  /**
    * Returns the status of the AutoML job.
    */
  var AutoMLJobStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.AutoMLJobStatus
  ...
  /**
    ...
    */
  var GenerateCandidateDefinitionsOnly: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.GenerateCandidateDefinitionsOnly] = js.undefined
  ...
  /**
    ...
    */
  var ModelDeployConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelDeployConfig] = js.undefined
  
  /**
    * Provides information about endpoint for the model deployment.
    */
  var ModelDeployResult: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelDeployResult] = js.undefined
  ...
  /**
    ...
    */
  var ProblemType: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ProblemType] = js.undefined
  ...
  /**
    ...
    */
  var ResolvedAttributes: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ResolvedAttributes] = js.undefined
