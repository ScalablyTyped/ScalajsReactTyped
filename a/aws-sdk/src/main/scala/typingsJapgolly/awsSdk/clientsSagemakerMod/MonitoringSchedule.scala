...
trait MonitoringSchedule extends StObject {
  ...
  var MonitoringScheduleConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MonitoringScheduleConfig] = js.undefined
  
  /**
    * The name of the monitoring schedule.
    */
  var MonitoringScheduleName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MonitoringScheduleName] = js.undefined
