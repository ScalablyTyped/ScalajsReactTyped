...
trait AppDetails extends StObject {
  ...
  /**
    * The name of the app.
    */
  var AppName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AppName] = js.undefined
  
  /**
    * The type of app.
    */
  var AppType: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AppType] = js.undefined
  ...
  /**
    ...
    */
  var UserProfileName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.UserProfileName] = js.undefined
}
object AppDetails {
