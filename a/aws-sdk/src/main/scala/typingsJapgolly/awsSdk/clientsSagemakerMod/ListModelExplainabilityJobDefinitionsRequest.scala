...
trait ListModelExplainabilityJobDefinitionsRequest extends StObject {
...
object ListModelExplainabilityJobDefinitionsRequest {
  ...
  inline def apply(): ListModelExplainabilityJobDefinitionsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListModelExplainabilityJobDefinitionsRequest]
  }
  
  extension [Self <: ListModelExplainabilityJobDefinitionsRequest](x: Self) {
