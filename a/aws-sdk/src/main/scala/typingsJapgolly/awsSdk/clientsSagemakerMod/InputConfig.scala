...
trait InputConfig extends StObject {
  ...
  /**
    ...
    */
  var DataInputConfig: typingsJapgolly.awsSdk.clientsSagemakerMod.DataInputConfig
  
  /**
    * Identifies the framework in which the model was trained. For example: TENSORFLOW.
    */
  var Framework: typingsJapgolly.awsSdk.clientsSagemakerMod.Framework
  ...
  /**
    ...
    */
  var FrameworkVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FrameworkVersion] = js.undefined
