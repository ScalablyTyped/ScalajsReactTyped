...
trait DescribeAlgorithmOutput extends StObject {
  ...
  /**
    ...
    */
  var AlgorithmStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.AlgorithmStatus
  
  /**
    * Details about the current status of the algorithm.
    */
  var AlgorithmStatusDetails: typingsJapgolly.awsSdk.clientsSagemakerMod.AlgorithmStatusDetails
