...
trait LabelingJobForWorkteamSummary extends StObject {
  ...
  /**
    ...
    */
  var LabelingJobName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.LabelingJobName] = js.undefined
  
  /**
    * The configured number of workers per data object.
    */
  var NumberOfHumanWorkersPerDataObject: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.NumberOfHumanWorkersPerDataObject] = js.undefined
