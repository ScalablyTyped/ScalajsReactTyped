...
trait TrainingJobDefinition extends StObject {
  ...
  /**
    ...
    */
  var HyperParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.HyperParameters] = js.undefined
  
  /**
    * An array of Channel objects, each of which specifies an input source.
    */
  var InputDataConfig: typingsJapgolly.awsSdk.clientsSagemakerMod.InputDataConfig
  
  /**
    * the path to the S3 bucket where you want to store model artifacts. SageMaker creates subfolders for the artifacts.
    */
  var OutputDataConfig: typingsJapgolly.awsSdk.clientsSagemakerMod.OutputDataConfig
  
  /**
    * The resources, including the ML compute instances and ML storage volumes, to use for model training.
    */
  var ResourceConfig: typingsJapgolly.awsSdk.clientsSagemakerMod.ResourceConfig
  ...
  var TrainingInputMode: typingsJapgolly.awsSdk.clientsSagemakerMod.TrainingInputMode
}
