...
trait CreatePresignedDomainUrlRequest extends StObject {
  ...
  /**
    ...
    */
  var ExpiresInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ExpiresInSeconds] = js.undefined
  
  /**
    * The session expiration duration in seconds. This value defaults to 43200.
    */
  var SessionExpirationDurationInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SessionExpirationDurationInSeconds] = js.undefined
