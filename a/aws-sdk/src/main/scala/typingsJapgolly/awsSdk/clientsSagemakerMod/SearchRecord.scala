...
trait SearchRecord extends StObject {
  ...
  var Endpoint: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Endpoint] = js.undefined
  
  /**
    * The properties of an experiment.
    */
  var Experiment: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Experiment] = js.undefined
  
  var FeatureGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FeatureGroup] = js.undefined
  
  /**
    * The feature metadata used to search through the features.
    */
  var FeatureMetadata: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.FeatureMetadata] = js.undefined
  ...
  var ModelPackage: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackage] = js.undefined
  
  var ModelPackageGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelPackageGroup] = js.undefined
  
  var Pipeline: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Pipeline] = js.undefined
  
  var PipelineExecution: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.PipelineExecution] = js.undefined
  
  /**
    * The properties of a project.
    */
  var Project: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Project] = js.undefined
  
  /**
    * The properties of a training job.
    */
  var TrainingJob: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TrainingJob] = js.undefined
  
  /**
    * The properties of a trial.
    */
  var Trial: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Trial] = js.undefined
  
  /**
    * The properties of a trial component.
    */
  var TrialComponent: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TrialComponent] = js.undefined
}
object SearchRecord {
