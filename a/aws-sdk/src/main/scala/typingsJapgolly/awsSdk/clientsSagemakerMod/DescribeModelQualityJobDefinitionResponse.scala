...
trait DescribeModelQualityJobDefinitionResponse extends StObject {
  ...
  /**
    ...
    */
  var ModelQualityAppSpecification: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelQualityAppSpecification
  
  /**
    * The baseline configuration for a model quality job.
    */
  var ModelQualityBaselineConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelQualityBaselineConfig] = js.undefined
  
  /**
    * Inputs for the model quality job.
    */
  var ModelQualityJobInput: typingsJapgolly.awsSdk.clientsSagemakerMod.ModelQualityJobInput
