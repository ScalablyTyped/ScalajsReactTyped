...
trait DescribeTransformJobResponse extends StObject {
  ...
  /**
    ...
    */
  var BatchStrategy: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.BatchStrategy] = js.undefined
  ...
  var DataProcessing: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DataProcessing] = js.undefined
  ...
  /**
    ...
    */
  var LabelingJobArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.LabelingJobArn] = js.undefined
  
  /**
    * The maximum number of parallel requests on each instance node that can be launched in a transform job. The default value is 1.
    */
  var MaxConcurrentTransforms: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MaxConcurrentTransforms] = js.undefined
  
  /**
    * The maximum payload size, in MB, used in the transform job.
    */
  var MaxPayloadInMB: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MaxPayloadInMB] = js.undefined
  
  /**
    * The timeout and maximum number of retries for processing a transform job invocation.
    */
  var ModelClientConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ModelClientConfig] = js.undefined
  ...
  /**
    ...
    */
  var TransformInput: typingsJapgolly.awsSdk.clientsSagemakerMod.TransformInput
  
  /**
    * The Amazon Resource Name (ARN) of the transform job.
    */
  var TransformJobArn: typingsJapgolly.awsSdk.clientsSagemakerMod.TransformJobArn
  ...
  /**
    ...
    */
  var TransformJobStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.TransformJobStatus
  
  /**
    * Identifies the Amazon S3 location where you want Amazon SageMaker to save the results from the transform job.
    */
  var TransformOutput: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TransformOutput] = js.undefined
  
  /**
    * Describes the resources, including ML instance types and ML instance count, to use for the transform job.
    */
  var TransformResources: typingsJapgolly.awsSdk.clientsSagemakerMod.TransformResources
...
object DescribeTransformJobResponse {
  ...
  extension [Self <: DescribeTransformJobResponse](x: Self) {
