...
trait ProfilerRuleEvaluationStatus extends StObject {
  ...
  /**
    ...
    */
  var RuleConfigurationName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.RuleConfigurationName] = js.undefined
  ...
  /**
    ...
    */
  var RuleEvaluationStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.RuleEvaluationStatus] = js.undefined
  
  /**
    * Details from the rule evaluation.
    */
  var StatusDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.StatusDetails] = js.undefined
}
object ProfilerRuleEvaluationStatus {
  
  inline def apply(): ProfilerRuleEvaluationStatus = {
