...
trait CaptureContentTypeHeader extends StObject {
  ...
  /**
    ...
    */
  var CsvContentTypes: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.CsvContentTypes] = js.undefined
  
  /**
    * The list of all content type headers that SageMaker will treat as JSON and capture accordingly.
    */
  var JsonContentTypes: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.JsonContentTypes] = js.undefined
}
