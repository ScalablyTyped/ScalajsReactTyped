...
trait AutoMLJobCompletionCriteria extends StObject {
  ...
  /**
    ...
    */
  var MaxAutoMLJobRuntimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MaxAutoMLJobRuntimeInSeconds] = js.undefined
  
  /**
    * The maximum number of times a training job is allowed to run.
    */
  var MaxCandidates: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MaxCandidates] = js.undefined
  ...
  /**
    ...
    */
  var MaxRuntimePerTrainingJobInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.MaxRuntimePerTrainingJobInSeconds] = js.undefined
}
