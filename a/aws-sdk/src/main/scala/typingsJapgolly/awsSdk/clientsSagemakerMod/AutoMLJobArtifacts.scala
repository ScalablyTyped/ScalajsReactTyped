...
trait AutoMLJobArtifacts extends StObject {
  ...
  /**
    ...
    */
  var CandidateDefinitionNotebookLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.CandidateDefinitionNotebookLocation] = js.undefined
  
  /**
    * The URL of the notebook location.
    */
  var DataExplorationNotebookLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.DataExplorationNotebookLocation] = js.undefined
}
