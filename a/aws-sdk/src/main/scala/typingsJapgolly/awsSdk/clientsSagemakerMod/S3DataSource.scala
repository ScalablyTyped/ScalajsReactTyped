...
trait S3DataSource extends StObject {
  ...
  /**
    ...
    */
  var AttributeNames: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.AttributeNames] = js.undefined
  
  /**
    * A list of names of instance groups that get data from the S3 data source.
    */
  var InstanceGroupNames: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.InstanceGroupNames] = js.undefined
  ...
  /**
    ...
    */
  var S3DataType: typingsJapgolly.awsSdk.clientsSagemakerMod.S3DataType
...
object S3DataSource {
  ...
  extension [Self <: S3DataSource](x: Self) {
    ...
    inline def setInstanceGroupNames(value: InstanceGroupNames): Self = StObject.set(x, "InstanceGroupNames", value.asInstanceOf[js.Any])
    
    inline def setInstanceGroupNamesUndefined: Self = StObject.set(x, "InstanceGroupNames", js.undefined)
    
    inline def setInstanceGroupNamesVarargs(value: InstanceGroupName*): Self = StObject.set(x, "InstanceGroupNames", js.Array(value*))
