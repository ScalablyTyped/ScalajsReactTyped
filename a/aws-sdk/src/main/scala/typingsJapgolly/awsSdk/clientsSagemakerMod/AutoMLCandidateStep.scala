...
trait AutoMLCandidateStep extends StObject {
  ...
  /**
    ...
    */
  var CandidateStepArn: typingsJapgolly.awsSdk.clientsSagemakerMod.CandidateStepArn
  
  /**
    * The name for the candidate's step.
    */
  var CandidateStepName: typingsJapgolly.awsSdk.clientsSagemakerMod.CandidateStepName
  
  /**
    * Whether the candidate is at the transform, training, or processing step.
    */
  var CandidateStepType: typingsJapgolly.awsSdk.clientsSagemakerMod.CandidateStepType
}
