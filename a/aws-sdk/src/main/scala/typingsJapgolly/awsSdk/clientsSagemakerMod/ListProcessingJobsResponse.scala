...
trait ListProcessingJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var ProcessingJobSummaries: typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingJobSummaries
}
object ListProcessingJobsResponse {
  ...
  extension [Self <: ListProcessingJobsResponse](x: Self) {
    ...
    inline def setProcessingJobSummariesVarargs(value: ProcessingJobSummary*): Self = StObject.set(x, "ProcessingJobSummaries", js.Array(value*))
  }
}
