...
trait GitConfig extends StObject {
  ...
  /**
    ...
    */
  var Branch: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.Branch] = js.undefined
  ...
  /**
    ...
    */
  var SecretArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.SecretArn] = js.undefined
}
object GitConfig {
