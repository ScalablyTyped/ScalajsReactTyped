...
trait CreateWorkteamRequest extends StObject {
  ...
  /**
    ...
    */
  var MemberDefinitions: typingsJapgolly.awsSdk.clientsSagemakerMod.MemberDefinitions
  
  /**
    * Configures notification of workers regarding available or expiring work items.
    */
  var NotificationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.NotificationConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var WorkforceName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.WorkforceName] = js.undefined
