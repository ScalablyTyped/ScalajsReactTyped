...
trait DomainSettingsForUpdate extends StObject {
  ...
  /**
    ...
    */
  var ExecutionRoleIdentityConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ExecutionRoleIdentityConfig] = js.undefined
  
  /**
    * A collection of RStudioServerPro Domain-level app settings to update.
    */
  var RStudioServerProDomainSettingsForUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsSagemakerMod.RStudioServerProDomainSettingsForUpdate
  ] = js.undefined
}
