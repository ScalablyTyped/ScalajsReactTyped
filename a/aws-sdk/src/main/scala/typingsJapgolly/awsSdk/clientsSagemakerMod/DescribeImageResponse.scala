...
trait DescribeImageResponse extends StObject {
  ...
  /**
    ...
    */
  var ImageName: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ImageName] = js.undefined
  
  /**
    * The status of the image.
    */
  var ImageStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ImageStatus] = js.undefined
