...
trait ImageVersion extends StObject {
  ...
  /**
    ...
    */
  var ImageArn: typingsJapgolly.awsSdk.clientsSagemakerMod.ImageArn
  
  /**
    * The ARN of the version.
    */
  var ImageVersionArn: typingsJapgolly.awsSdk.clientsSagemakerMod.ImageVersionArn
  
  /**
    * The status of the version.
    */
  var ImageVersionStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.ImageVersionStatus
