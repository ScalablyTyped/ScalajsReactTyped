...
trait DescribeProcessingJobResponse extends StObject {
  ...
  /**
    ...
    */
  var AppSpecification: typingsJapgolly.awsSdk.clientsSagemakerMod.AppSpecification
  ...
  /**
    ...
    */
  var ProcessingJobArn: typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingJobArn
  
  /**
    * The name of the processing job. The name must be unique within an Amazon Web Services Region in the Amazon Web Services account.
    */
  var ProcessingJobName: typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingJobName
  
  /**
    * Provides the status of a processing job.
    */
  var ProcessingJobStatus: typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingJobStatus
  ...
  /**
    ...
    */
  var ProcessingResources: typingsJapgolly.awsSdk.clientsSagemakerMod.ProcessingResources
