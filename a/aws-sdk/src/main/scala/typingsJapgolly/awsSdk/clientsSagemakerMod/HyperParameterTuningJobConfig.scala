...
trait HyperParameterTuningJobConfig extends StObject {
  ...
  /**
    ...
    */
  var HyperParameterTuningJobObjective: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.HyperParameterTuningJobObjective] = js.undefined
  
  /**
    * The ParameterRanges object that specifies the ranges of hyperparameters that this tuning job searches.
    */
  var ParameterRanges: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.ParameterRanges] = js.undefined
  
  /**
    * The ResourceLimits object that specifies the maximum number of training jobs and parallel training jobs for this tuning job.
    */
  var ResourceLimits: typingsJapgolly.awsSdk.clientsSagemakerMod.ResourceLimits
  ...
  /**
    ...
    */
  var TrainingJobEarlyStoppingType: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TrainingJobEarlyStoppingType] = js.undefined
  
  /**
    * The tuning job's completion criteria.
    */
  var TuningJobCompletionCriteria: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerMod.TuningJobCompletionCriteria] = js.undefined
}
