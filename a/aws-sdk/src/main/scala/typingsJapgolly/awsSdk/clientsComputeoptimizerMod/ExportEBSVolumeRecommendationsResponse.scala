...
trait ExportEBSVolumeRecommendationsResponse extends StObject {
...
object ExportEBSVolumeRecommendationsResponse {
  ...
  inline def apply(): ExportEBSVolumeRecommendationsResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ExportEBSVolumeRecommendationsResponse]
  }
  
  extension [Self <: ExportEBSVolumeRecommendationsResponse](x: Self) {
