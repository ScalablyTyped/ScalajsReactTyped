...
trait CreateFirewallRuleRequest extends StObject {
  ...
  /**
    ...
    */
  var Action: typingsJapgolly.awsSdk.clientsRoute53resolverMod.Action
  ...
  /**
    ...
    */
  var BlockOverrideDnsType: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53resolverMod.BlockOverrideDnsType] = js.undefined
  ...
  /**
    ...
    */
  var BlockOverrideDomain: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53resolverMod.BlockOverrideDomain] = js.undefined
  ...
  /**
    ...
    */
  var BlockOverrideTtl: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53resolverMod.BlockOverrideTtl] = js.undefined
  ...
  /**
    ...
    */
  var BlockResponse: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53resolverMod.BlockResponse] = js.undefined
  
  /**
    * A unique string that identifies the request and that allows you to retry failed requests without the risk of running the operation twice. CreatorRequestId can be any unique string, for example, a date/time stamp. 
    */
  var CreatorRequestId: typingsJapgolly.awsSdk.clientsRoute53resolverMod.CreatorRequestId
  ...
  /**
    ...
    */
  var Name: typingsJapgolly.awsSdk.clientsRoute53resolverMod.Name
  ...
  /**
    ...
    */
  var Priority: typingsJapgolly.awsSdk.clientsRoute53resolverMod.Priority
}
