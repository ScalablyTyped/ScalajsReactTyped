...
trait QueryResponse extends StObject {
  ...
  /**
    ...
    */
  var QueryId: typingsJapgolly.awsSdk.clientsTimestreamqueryMod.QueryId
  
  /**
    * Information about the status of the query, including progress and bytes scanned.
    */
  var QueryStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsTimestreamqueryMod.QueryStatus] = js.undefined
