...
trait CreateScheduledQueryRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.clientsTimestreamqueryMod.ClientToken] = js.undefined
  
  /**
    * Configuration for error reporting. Error reports will be generated when a problem is encountered when writing the query results. 
    */
  var ErrorReportConfiguration: typingsJapgolly.awsSdk.clientsTimestreamqueryMod.ErrorReportConfiguration
  ...
  /**
    ...
    */
  var NotificationConfiguration: typingsJapgolly.awsSdk.clientsTimestreamqueryMod.NotificationConfiguration
  ...
  /**
    ...
    */
  var QueryString: typingsJapgolly.awsSdk.clientsTimestreamqueryMod.QueryString
  
  /**
    * The schedule configuration for the query.
    */
  var ScheduleConfiguration: typingsJapgolly.awsSdk.clientsTimestreamqueryMod.ScheduleConfiguration
  ...
  /**
    ...
    */
  var TargetConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsTimestreamqueryMod.TargetConfiguration] = js.undefined
}
