...
trait ScheduledQueryRunSummary extends StObject {
  ...
  /**
    ...
    */
  var ErrorReportLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsTimestreamqueryMod.ErrorReportLocation] = js.undefined
  
  /**
    * Runtime statistics for a scheduled run.
    */
  var ExecutionStats: js.UndefOr[typingsJapgolly.awsSdk.clientsTimestreamqueryMod.ExecutionStats] = js.undefined
