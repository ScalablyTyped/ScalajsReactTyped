...
trait MemberDetail extends js.Object {
  /**
    ...
    */
  var AccountId: js.UndefOr[typingsJapgolly.awsSdk.detectiveMod.AccountId] = js.native
  /**
    * The AWS account root user email address for the member account.
    */
  var EmailAddress: js.UndefOr[typingsJapgolly.awsSdk.detectiveMod.EmailAddress] = js.native
  /**
