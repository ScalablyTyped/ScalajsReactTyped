...
trait FragmentSelector extends js.Object {
  /**
    ...
    */
  var FragmentSelectorType: typingsJapgolly.awsSdk.kinesisvideoarchivedmediaMod.FragmentSelectorType = js.native
  /**
    * The range of timestamps to return.
    */
  var TimestampRange: typingsJapgolly.awsSdk.kinesisvideoarchivedmediaMod.TimestampRange = js.native
}
