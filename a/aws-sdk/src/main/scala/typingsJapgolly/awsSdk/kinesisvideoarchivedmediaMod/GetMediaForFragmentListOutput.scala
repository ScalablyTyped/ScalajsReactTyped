...
trait GetMediaForFragmentListOutput extends js.Object {
  /**
    ...
    */
  var ContentType: js.UndefOr[typingsJapgolly.awsSdk.kinesisvideoarchivedmediaMod.ContentType] = js.native
  /**
    ...
    */
  var Payload: js.UndefOr[typingsJapgolly.awsSdk.kinesisvideoarchivedmediaMod.Payload] = js.native
}
