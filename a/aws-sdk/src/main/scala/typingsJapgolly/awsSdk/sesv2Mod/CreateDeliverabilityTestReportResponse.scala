...
trait CreateDeliverabilityTestReportResponse extends js.Object {
  /**
    ...
    */
  var DeliverabilityTestStatus: typingsJapgolly.awsSdk.sesv2Mod.DeliverabilityTestStatus = js.native
  /**
    * A unique string that identifies the predictive inbox placement test.
    */
  var ReportId: typingsJapgolly.awsSdk.sesv2Mod.ReportId = js.native
}
