...
trait OverallVolume extends js.Object {
  /**
    ...
    */
  var DomainIspPlacements: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.DomainIspPlacements] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatistics: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.VolumeStatistics] = js.native
}
