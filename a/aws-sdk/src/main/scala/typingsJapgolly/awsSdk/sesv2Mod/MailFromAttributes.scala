...
trait MailFromAttributes extends js.Object {
  /**
    ...
    */
  var BehaviorOnMxFailure: typingsJapgolly.awsSdk.sesv2Mod.BehaviorOnMxFailure = js.native
  /**
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typingsJapgolly.awsSdk.sesv2Mod.MailFromDomainStatus = js.native
}
