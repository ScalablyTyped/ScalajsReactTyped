...
trait DomainDeliverabilityTrackingOption extends js.Object {
  /**
    ...
    */
  var Domain: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.Domain] = js.native
  /**
    * An object that contains information about the inbox placement data settings for the domain.
    */
  var InboxPlacementTrackingOption: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.InboxPlacementTrackingOption] = js.native
  /**
