...
trait EventDestination extends js.Object {
  /**
    ...
    */
  var CloudWatchDestination: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.CloudWatchDestination] = js.native
  /**
    ...
    */
  var Enabled: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.Enabled] = js.native
  /**
    * An object that defines an Amazon Kinesis Data Firehose destination for email events. You can use Amazon Kinesis Data Firehose to stream data to other services, such as Amazon S3 and Amazon Redshift.
    */
  var KinesisFirehoseDestination: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.KinesisFirehoseDestination] = js.native
  /**
  ...
  /**
    ...
    */
  var PinpointDestination: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.PinpointDestination] = js.native
  /**
    * An object that defines an Amazon SNS destination for email events. You can use Amazon SNS to send notification when certain email events occur.
    */
  var SnsDestination: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.SnsDestination] = js.native
}
