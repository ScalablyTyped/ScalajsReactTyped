...
trait IspPlacement extends js.Object {
  /**
    ...
    */
  var IspName: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.IspName] = js.native
  /**
    * An object that contains inbox placement metrics for a specific email provider.
    */
  var PlacementStatistics: js.UndefOr[typingsJapgolly.awsSdk.sesv2Mod.PlacementStatistics] = js.native
}
