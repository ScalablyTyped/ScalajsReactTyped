...
trait LoggingInfo extends StObject {
  ...
  /**
    ...
    */
  var S3BucketName: typingsJapgolly.awsSdk.clientsSsmMod.S3BucketName
  
  /**
    * (Optional) The S3 bucket subfolder. 
    */
  var S3KeyPrefix: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.S3KeyPrefix] = js.undefined
  
  /**
    * The Amazon Web Services Region where the S3 bucket is located.
    */
  var S3Region: typingsJapgolly.awsSdk.clientsSsmMod.S3Region
}
object LoggingInfo {
