...
trait CloudWatchOutputConfig extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchLogGroupName: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.CloudWatchLogGroupName] = js.undefined
  
  /**
    * Enables Systems Manager to send command output to CloudWatch Logs.
    */
  var CloudWatchOutputEnabled: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.CloudWatchOutputEnabled] = js.undefined
}
