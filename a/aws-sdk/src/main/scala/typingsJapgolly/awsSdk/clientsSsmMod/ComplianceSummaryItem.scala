...
trait ComplianceSummaryItem extends StObject {
  ...
  /**
    ...
    */
  var CompliantSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.CompliantSummary] = js.undefined
  
  /**
    * A list of NON_COMPLIANT items for the specified compliance type.
    */
  var NonCompliantSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.NonCompliantSummary] = js.undefined
}
