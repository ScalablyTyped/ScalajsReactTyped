...
trait Command extends StObject {
  ...
  /**
    ...
    */
  var CompletedCount: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.CompletedCount] = js.undefined
  
  /**
    * The number of targets for which the status is Delivery Timed Out.
    */
  var DeliveryTimedOutCount: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.DeliveryTimedOutCount] = js.undefined
  ...
  /**
    ...
    */
  var ErrorCount: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.ErrorCount] = js.undefined
  ...
  /**
    ...
    */
  var TargetCount: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.TargetCount] = js.undefined
