...
trait DocumentReviewerResponseSource extends StObject {
  ...
  /**
    ...
    */
  var ReviewStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.ReviewStatus] = js.undefined
  
  /**
    * The user in your organization assigned to review a document request.
    */
  var Reviewer: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.Reviewer] = js.undefined
