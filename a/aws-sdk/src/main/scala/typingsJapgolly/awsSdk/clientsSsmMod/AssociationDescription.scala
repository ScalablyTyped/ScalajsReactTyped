...
trait AssociationDescription extends StObject {
  ...
  var AlarmConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.AlarmConfiguration] = js.undefined
  
  /**
    * By default, when you create a new associations, the system runs it immediately after it is created and then according to the schedule you specified. Specify this option if you don't want an association to run immediately after you create it. This parameter isn't supported for rate expressions.
    */
  var ApplyOnlyAtCronInterval: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.ApplyOnlyAtCronInterval] = js.undefined
  ...
  /**
    ...
    */
  var AssociationName: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.AssociationName] = js.undefined
  ...
  /**
    ...
    */
  var AutomationTargetParameterName: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.AutomationTargetParameterName] = js.undefined
  ...
  /**
    ...
    */
  var MaxConcurrency: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.MaxConcurrency] = js.undefined
  ...
  /**
    ...
    */
  var MaxErrors: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.MaxErrors] = js.undefined
  ...
  /**
    ...
    */
  var ScheduleExpression: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.ScheduleExpression] = js.undefined
  
  /**
    * Number of days to wait after the scheduled day to run an association.
    */
  var ScheduleOffset: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.ScheduleOffset] = js.undefined
  ...
  /**
    ...
    */
  var TargetLocations: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.TargetLocations] = js.undefined
  
  /**
    * A key-value mapping of document parameters to target resources. Both Targets and TargetMaps can't be specified together.
    */
  var TargetMaps: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.TargetMaps] = js.undefined
