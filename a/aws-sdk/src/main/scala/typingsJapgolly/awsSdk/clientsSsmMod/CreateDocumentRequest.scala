...
trait CreateDocumentRequest extends StObject {
  ...
  /**
    ...
    */
  var DocumentType: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.DocumentType] = js.undefined
  ...
  /**
    ...
    */
  var TargetType: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.TargetType] = js.undefined
...
object CreateDocumentRequest {
  ...
  extension [Self <: CreateDocumentRequest](x: Self) {
