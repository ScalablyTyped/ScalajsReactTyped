...
trait GetDeployablePatchSnapshotForInstanceRequest extends StObject {
  ...
  /**
    ...
    */
  var BaselineOverride: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.BaselineOverride] = js.undefined
  ...
  /**
    ...
    */
  var SnapshotId: typingsJapgolly.awsSdk.clientsSsmMod.SnapshotId
}
