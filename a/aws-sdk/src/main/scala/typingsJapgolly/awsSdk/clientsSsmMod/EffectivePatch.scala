...
trait EffectivePatch extends StObject {
  ...
  /**
    ...
    */
  var Patch: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.Patch] = js.undefined
  
  /**
    * The status of the patch in a patch baseline. This includes information about whether the patch is currently approved, due to be approved by a rule, explicitly approved, or explicitly rejected and the date the patch was or will be approved.
    */
  var PatchStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.PatchStatus] = js.undefined
}
