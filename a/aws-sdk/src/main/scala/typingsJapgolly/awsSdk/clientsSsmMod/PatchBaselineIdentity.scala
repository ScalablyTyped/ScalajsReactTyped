...
trait PatchBaselineIdentity extends StObject {
  ...
  /**
    ...
    */
  var BaselineDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.BaselineDescription] = js.undefined
  ...
  /**
    ...
    */
  var BaselineName: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.BaselineName] = js.undefined
  ...
  /**
    ...
    */
  var DefaultBaseline: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.DefaultBaseline] = js.undefined
  
  /**
    * Defines the operating system the patch baseline applies to. The default value is WINDOWS. 
    */
  var OperatingSystem: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.OperatingSystem] = js.undefined
}
