...
trait PatchRule extends StObject {
  ...
  /**
    ...
    */
  var ApproveAfterDays: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.ApproveAfterDays] = js.undefined
  ...
  /**
    ...
    */
  var PatchFilterGroup: typingsJapgolly.awsSdk.clientsSsmMod.PatchFilterGroup
}
object PatchRule {
