...
trait InventoryDeletionSummary extends StObject {
  ...
  /**
    ...
    */
  var RemainingCount: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.RemainingCount] = js.undefined
  ...
  /**
    ...
    */
  var TotalCount: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmMod.TotalCount] = js.undefined
}
