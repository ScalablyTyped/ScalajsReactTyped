...
trait OutputDataConfig extends StObject {
  ...
  /**
    ...
    */
  var S3Bucket: typingsJapgolly.awsSdk.clientsComprehendmedicalMod.S3Bucket
  ...
  /**
    ...
    */
  var S3Key: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendmedicalMod.S3Key] = js.undefined
}
