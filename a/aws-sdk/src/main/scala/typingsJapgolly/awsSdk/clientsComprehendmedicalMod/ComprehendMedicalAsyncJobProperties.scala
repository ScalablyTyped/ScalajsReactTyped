...
trait ComprehendMedicalAsyncJobProperties extends StObject {
  ...
  /**
    ...
    */
  var InputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendmedicalMod.InputDataConfig] = js.undefined
  ...
  /**
    ...
    */
  var LanguageCode: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendmedicalMod.LanguageCode] = js.undefined
  
  /**
    * The path to the file that describes the results of a batch job.
    */
  var ManifestFilePath: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendmedicalMod.ManifestFilePath] = js.undefined
  ...
  /**
    ...
    */
  var ModelVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendmedicalMod.ModelVersion] = js.undefined
  
  /**
    * The output data configuration that you supplied when you created the detection job.
    */
  var OutputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendmedicalMod.OutputDataConfig] = js.undefined
