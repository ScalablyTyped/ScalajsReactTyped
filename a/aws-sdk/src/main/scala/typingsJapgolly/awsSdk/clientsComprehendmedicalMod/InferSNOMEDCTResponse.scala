...
trait InferSNOMEDCTResponse extends StObject {
  ...
  /**
    ...
    */
  var Characters: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendmedicalMod.Characters] = js.undefined
  ...
  /**
    ...
    */
  var SNOMEDCTDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendmedicalMod.SNOMEDCTDetails] = js.undefined
}
