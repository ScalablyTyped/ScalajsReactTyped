...
trait CreateConferenceProviderRequest extends js.Object {
  ...
  /**
    ...
    */
  var ConferenceProviderName: typingsJapgolly.awsSdk.alexaforbusinessMod.ConferenceProviderName = js.native
  /**
    * Represents a type within a list of predefined types.
    */
  var ConferenceProviderType: typingsJapgolly.awsSdk.alexaforbusinessMod.ConferenceProviderType = js.native
  /**
    * The IP endpoint and protocol for calling.
    */
  var IPDialIn: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.IPDialIn] = js.native
  /**
    * The meeting settings for the conference provider.
    */
  var MeetingSetting: typingsJapgolly.awsSdk.alexaforbusinessMod.MeetingSetting = js.native
  /**
    * The information for PSTN conferencing.
    */
  var PSTNDialIn: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.PSTNDialIn] = js.native
}
