...
trait CreateProfileRequest extends js.Object {
  /**
    ...
    */
  var Address: typingsJapgolly.awsSdk.alexaforbusinessMod.Address = js.native
  /**
  ...
  /**
    ...
    */
  var DistanceUnit: typingsJapgolly.awsSdk.alexaforbusinessMod.DistanceUnit = js.native
  /**
  ...
  /**
    ...
    */
  var ProfileName: typingsJapgolly.awsSdk.alexaforbusinessMod.ProfileName = js.native
  /**
  ...
  /**
    ...
    */
  var TemperatureUnit: typingsJapgolly.awsSdk.alexaforbusinessMod.TemperatureUnit = js.native
  /**
    * The time zone used by a room profile.
    */
  var Timezone: typingsJapgolly.awsSdk.alexaforbusinessMod.Timezone = js.native
  /**
    * A wake word for Alexa, Echo, Amazon, or a computer.
    */
  var WakeWord: typingsJapgolly.awsSdk.alexaforbusinessMod.WakeWord = js.native
}
