...
trait SendAnnouncementRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: typingsJapgolly.awsSdk.alexaforbusinessMod.ClientRequestToken = js.native
  /**
    * The announcement content. This can contain only one of the three possible announcement types (text, SSML or audio).
    */
  var Content: typingsJapgolly.awsSdk.alexaforbusinessMod.Content = js.native
  /**
  ...
  /**
    ...
    */
  var TimeToLiveInSeconds: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.TimeToLiveInSeconds] = js.native
}
