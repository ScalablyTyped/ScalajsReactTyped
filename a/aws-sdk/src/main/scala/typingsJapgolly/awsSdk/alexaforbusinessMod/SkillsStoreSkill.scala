...
trait SkillsStoreSkill extends js.Object {
  /**
    ...
    */
  var IconUrl: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.IconUrl] = js.native
  /**
    * Sample utterances that interact with the skill.
    */
  var SampleUtterances: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.SampleUtterances] = js.native
  /**
    * Short description about the skill.
    */
  var ShortDescription: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.ShortDescription] = js.native
  /**
    * Information about the skill.
    */
  var SkillDetails: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.SkillDetails] = js.native
  /**
