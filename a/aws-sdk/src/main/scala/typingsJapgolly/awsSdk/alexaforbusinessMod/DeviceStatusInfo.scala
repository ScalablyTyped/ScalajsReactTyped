...
trait DeviceStatusInfo extends js.Object {
  /**
    ...
    */
  var ConnectionStatus: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.ConnectionStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var DeviceStatusDetails: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.DeviceStatusDetails] = js.native
}
