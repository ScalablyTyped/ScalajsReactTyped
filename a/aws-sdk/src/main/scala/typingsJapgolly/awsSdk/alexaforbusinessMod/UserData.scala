...
trait UserData extends js.Object {
  ...
  /**
    ...
    */
  var EnrollmentId: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.EnrollmentId] = js.native
  /**
    * The enrollment status of a user.
    */
  var EnrollmentStatus: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.EnrollmentStatus] = js.native
  /**
