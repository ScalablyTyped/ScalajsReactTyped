...
trait PutRoomSkillParameterRequest extends js.Object {
  ...
  /**
    ...
    */
  var RoomSkillParameter: typingsJapgolly.awsSdk.alexaforbusinessMod.RoomSkillParameter = js.native
  /**
    * The ARN of the skill associated with the room skill parameter. Required.
    */
  var SkillId: typingsJapgolly.awsSdk.alexaforbusinessMod.SkillId = js.native
}
