...
trait Profile extends js.Object {
  /**
    ...
    */
  var Address: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.Address] = js.native
  /**
  ...
  /**
    ...
    */
  var DistanceUnit: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.DistanceUnit] = js.native
  /**
  ...
  /**
    ...
    */
  var MaxVolumeLimit: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.MaxVolumeLimit] = js.native
  /**
    * Meeting room settings of a room profile.
    */
  var MeetingRoomConfiguration: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.MeetingRoomConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var ProfileName: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.ProfileName] = js.native
  /**
  ...
  /**
    ...
    */
  var TemperatureUnit: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.TemperatureUnit] = js.native
  /**
    * The time zone of a room profile.
    */
  var Timezone: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.Timezone] = js.native
  /**
    * The wake word of a room profile.
    */
  var WakeWord: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.WakeWord] = js.native
}
