...
trait SkillSummary extends js.Object {
  /**
    ...
    */
  var EnablementType: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.EnablementType] = js.native
  /**
    * The ARN of the skill summary.
    */
  var SkillId: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.SkillId] = js.native
  /**
    * The name of the skill.
    */
  var SkillName: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.SkillName] = js.native
  /**
    * Whether the skill is publicly available or is a private skill.
    */
  var SkillType: js.UndefOr[typingsJapgolly.awsSdk.alexaforbusinessMod.SkillType] = js.native
  /**
