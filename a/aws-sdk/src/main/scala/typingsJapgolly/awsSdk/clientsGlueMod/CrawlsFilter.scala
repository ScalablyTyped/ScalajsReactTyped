...
trait CrawlsFilter extends StObject {
  ...
  /**
    ...
    */
  var FieldName: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.FieldName] = js.undefined
  ...
  /**
    ...
    */
  var FilterOperator: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.FilterOperator] = js.undefined
}
object CrawlsFilter {
