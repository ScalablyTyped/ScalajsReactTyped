...
trait LastCrawlInfo extends StObject {
  ...
  /**
    ...
    */
  var LogGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.LogGroup] = js.undefined
  
  /**
    * The log stream for the last crawl.
    */
  var LogStream: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.LogStream] = js.undefined
  
  /**
    * The prefix for a message about this crawl.
    */
  var MessagePrefix: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.MessagePrefix] = js.undefined
