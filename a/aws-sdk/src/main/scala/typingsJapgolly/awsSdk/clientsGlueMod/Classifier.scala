...
trait Classifier extends StObject {
  ...
  /**
    ...
    */
  var CsvClassifier: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.CsvClassifier] = js.undefined
  
  /**
    * A classifier that uses grok.
    */
  var GrokClassifier: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.GrokClassifier] = js.undefined
  
  /**
    * A classifier for JSON content.
    */
  var JsonClassifier: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.JsonClassifier] = js.undefined
  
  /**
    * A classifier for XML content.
    */
  var XMLClassifier: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.XMLClassifier] = js.undefined
}
object Classifier {
