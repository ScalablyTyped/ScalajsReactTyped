...
trait TaskRunProperties extends StObject {
  ...
  /**
    ...
    */
  var ExportLabelsTaskRunProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.ExportLabelsTaskRunProperties] = js.undefined
  
  /**
    * The configuration properties for a find matches task run.
    */
  var FindMatchesTaskRunProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.FindMatchesTaskRunProperties] = js.undefined
  
  /**
    * The configuration properties for an importing labels task run.
    */
  var ImportLabelsTaskRunProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.ImportLabelsTaskRunProperties] = js.undefined
  
  /**
    * The configuration properties for a labeling set generation task run.
    */
  var LabelingSetGenerationTaskRunProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.LabelingSetGenerationTaskRunProperties] = js.undefined
  
  /**
    * The type of task run.
    */
  var TaskType: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.TaskType] = js.undefined
}
