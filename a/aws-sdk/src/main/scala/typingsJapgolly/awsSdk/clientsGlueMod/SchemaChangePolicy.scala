...
trait SchemaChangePolicy extends StObject {
  ...
  /**
    ...
    */
  var DeleteBehavior: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.DeleteBehavior] = js.undefined
  
  /**
    * The update behavior when the crawler finds a changed schema.
    */
  var UpdateBehavior: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.UpdateBehavior] = js.undefined
}
