...
trait WorkflowRun extends StObject {
  ...
  /**
    ...
    */
  var StartingEventBatchCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.StartingEventBatchCondition] = js.undefined
  ...
  /**
    ...
    */
  var WorkflowRunProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.WorkflowRunProperties] = js.undefined
}
object WorkflowRun {
