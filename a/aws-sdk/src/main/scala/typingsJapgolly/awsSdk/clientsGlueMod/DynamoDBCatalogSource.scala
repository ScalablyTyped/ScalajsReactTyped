...
trait DynamoDBCatalogSource extends StObject {
...
object DynamoDBCatalogSource {
  ...
  inline def apply(Database: EnclosedInStringProperty, Name: NodeName, Table: EnclosedInStringProperty): DynamoDBCatalogSource = {
  ...
  extension [Self <: DynamoDBCatalogSource](x: Self) {
