...
trait UpdateJobFromSourceControlRequest extends StObject {
...
object UpdateJobFromSourceControlRequest {
  ...
  inline def apply(): UpdateJobFromSourceControlRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateJobFromSourceControlRequest]
  }
  
  extension [Self <: UpdateJobFromSourceControlRequest](x: Self) {
