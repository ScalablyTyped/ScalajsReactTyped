...
trait UpdateCrawlerRequest extends StObject {
  ...
  /**
    ...
    */
  var CrawlerSecurityConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.CrawlerSecurityConfiguration] = js.undefined
  
  /**
    * The Glue database where results are stored, such as: arn:aws:daylight:us-east-1::database/sometable/ *.
    */
  var DatabaseName: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.DatabaseName] = js.undefined
  ...
  /**
    ...
    */
  var LakeFormationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.LakeFormationConfiguration] = js.undefined
  
  /**
    * Specifies data lineage configuration settings for the crawler.
    */
  var LineageConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.LineageConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var RecrawlPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.RecrawlPolicy] = js.undefined
  
  /**
    * The IAM role or Amazon Resource Name (ARN) of an IAM role that is used by the new crawler to access customer resources.
    */
  var Role: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Role] = js.undefined
  ...
  /**
    ...
    */
  var SchemaChangePolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.SchemaChangePolicy] = js.undefined
  
  /**
    * The table prefix used for catalog tables that are created.
    */
  var TablePrefix: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.TablePrefix] = js.undefined
