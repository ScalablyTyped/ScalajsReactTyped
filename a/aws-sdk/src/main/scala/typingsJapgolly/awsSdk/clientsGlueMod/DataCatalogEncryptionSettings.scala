...
trait DataCatalogEncryptionSettings extends StObject {
  ...
  /**
    ...
    */
  var ConnectionPasswordEncryption: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.ConnectionPasswordEncryption] = js.undefined
  
  /**
    * Specifies the encryption-at-rest configuration for the Data Catalog.
    */
  var EncryptionAtRest: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.EncryptionAtRest] = js.undefined
}
