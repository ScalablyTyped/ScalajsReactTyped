...
trait Glue extends Service {
  ...
  /**
    ...
    */
  def updateJobFromSourceControl(): Request[UpdateJobFromSourceControlResponse, AWSError] = js.native
  def updateJobFromSourceControl(callback: js.Function2[/* err */ AWSError, /* data */ UpdateJobFromSourceControlResponse, Unit]): Request[UpdateJobFromSourceControlResponse, AWSError] = js.native
  /**
    * Synchronizes a job from the source control repository. This operation takes the job artifacts that are located in the remote repository and updates the Glue internal stores with these artifacts. This API supports optional parameters which take in the repository information.
    */
  def updateJobFromSourceControl(params: UpdateJobFromSourceControlRequest): Request[UpdateJobFromSourceControlResponse, AWSError] = js.native
  def updateJobFromSourceControl(
    params: UpdateJobFromSourceControlRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ UpdateJobFromSourceControlResponse, Unit]
  ): Request[UpdateJobFromSourceControlResponse, AWSError] = js.native
  ...
  /**
    ...
    */
  def updateSourceControlFromJob(): Request[UpdateSourceControlFromJobResponse, AWSError] = js.native
  def updateSourceControlFromJob(callback: js.Function2[/* err */ AWSError, /* data */ UpdateSourceControlFromJobResponse, Unit]): Request[UpdateSourceControlFromJobResponse, AWSError] = js.native
  /**
    * Synchronizes a job to the source control repository. This operation takes the job artifacts from the Glue internal stores and makes a commit to the remote repository that is configured on the job. This API supports optional parameters which take in the repository information.
    */
  def updateSourceControlFromJob(params: UpdateSourceControlFromJobRequest): Request[UpdateSourceControlFromJobResponse, AWSError] = js.native
  def updateSourceControlFromJob(
    params: UpdateSourceControlFromJobRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ UpdateSourceControlFromJobResponse, Unit]
  ): Request[UpdateSourceControlFromJobResponse, AWSError] = js.native
