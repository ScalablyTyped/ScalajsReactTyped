...
trait CreateScriptResponse extends StObject {
  ...
  /**
    ...
    */
  var PythonScript: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.PythonScript] = js.undefined
  
  /**
    * The Scala code generated from the DAG.
    */
  var ScalaCode: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.ScalaCode] = js.undefined
}
