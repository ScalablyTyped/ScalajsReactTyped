...
trait EncryptionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchEncryption: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.CloudWatchEncryption] = js.undefined
  
  /**
    * The encryption configuration for job bookmarks.
    */
  var JobBookmarksEncryption: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.JobBookmarksEncryption] = js.undefined
