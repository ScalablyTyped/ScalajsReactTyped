...
trait Spigot extends StObject {
  ...
  /**
    ...
    */
  var Prob: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Prob] = js.undefined
  
  /**
    * Specifies a number of records to write starting from the beginning of the dataset.
    */
  var Topk: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Topk] = js.undefined
}
object Spigot {
