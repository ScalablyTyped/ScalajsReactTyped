...
trait CodeGenConfigurationNode extends StObject {
  ...
  /**
    ...
    */
  var Aggregate: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Aggregate] = js.undefined
  
  /**
    * Specifies a transform that maps data property keys in the data source to data property keys in the data target. You can rename keys, modify the data types for keys, and choose which keys to drop from the dataset.
    */
  var ApplyMapping: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.ApplyMapping] = js.undefined
  
  /**
    * Specifies a connector to an Amazon Athena data source.
    */
  var AthenaConnectorSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.AthenaConnectorSource] = js.undefined
  
  /**
    * Specifies an Apache Kafka data store in the Data Catalog.
    */
  var CatalogKafkaSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.CatalogKafkaSource] = js.undefined
  
  /**
    * Specifies a Kinesis data source in the Glue Data Catalog.
    */
  var CatalogKinesisSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.CatalogKinesisSource] = js.undefined
  
  /**
    * Specifies a data store in the Glue Data Catalog.
    */
  var CatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.CatalogSource] = js.undefined
  ...
  /**
    ...
    */
  var CustomCode: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.CustomCode] = js.undefined
  
  /**
    * Specifies an Apache Kafka data store.
    */
  var DirectKafkaSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.DirectKafkaSource] = js.undefined
  
  /**
    * Specifies a direct Amazon Kinesis data source.
    */
  var DirectKinesisSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.DirectKinesisSource] = js.undefined
  
  /**
    * Specifies a transform that removes rows of repeating data from a data set.
    */
  var DropDuplicates: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.DropDuplicates] = js.undefined
  
  /**
    * Specifies a transform that chooses the data property keys that you want to drop.
    */
  var DropFields: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.DropFields] = js.undefined
  
  /**
    * Specifies a transform that removes columns from the dataset if all values in the column are 'null'. By default, Glue Studio will recognize null objects, but some values such as empty strings, strings that are "null", -1 integers or other placeholders such as zeros, are not automatically recognized as nulls.
    */
  var DropNullFields: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.DropNullFields] = js.undefined
  
  var DynamoDBCatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.DynamoDBCatalogSource] = js.undefined
  
  /**
    * Specifies a transform that locates records in the dataset that have missing values and adds a new field with a value determined by imputation. The input data set is used to train the machine learning model that determines what the missing value should be.
    */
  var FillMissingValues: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.FillMissingValues] = js.undefined
  
  /**
    * Specifies a transform that splits a dataset into two, based on a filter condition.
    */
  var Filter: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Filter] = js.undefined
  
  /**
    * Specifies a data source in a goverened Data Catalog.
    */
  var GovernedCatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.GovernedCatalogSource] = js.undefined
  
  /**
    * Specifies a data target that writes to a goverened catalog.
    */
  var GovernedCatalogTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.GovernedCatalogTarget] = js.undefined
  
  /**
    * Specifies a connector to a JDBC data source.
    */
  var JDBCConnectorSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.JDBCConnectorSource] = js.undefined
  
  /**
    * Specifies a data target that writes to Amazon S3 in Apache Parquet columnar storage.
    */
  var JDBCConnectorTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.JDBCConnectorTarget] = js.undefined
  
  /**
    * Specifies a transform that joins two datasets into one dataset using a comparison phrase on the specified data property keys. You can use inner, outer, left, right, left semi, and left anti joins.
    */
  var Join: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Join] = js.undefined
  
  /**
    * Specifies a transform that merges a DynamicFrame with a staging DynamicFrame based on the specified primary keys to identify records. Duplicate records (records with the same primary keys) are not de-duplicated. 
    */
  var Merge: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Merge] = js.undefined
  
  /**
    * Specifies a Microsoft SQL server data source in the Glue Data Catalog.
    */
  var MicrosoftSQLServerCatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.MicrosoftSQLServerCatalogSource] = js.undefined
  
  /**
    * Specifies a target that uses Microsoft SQL.
    */
  var MicrosoftSQLServerCatalogTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.MicrosoftSQLServerCatalogTarget] = js.undefined
  
  /**
    * Specifies a MySQL data source in the Glue Data Catalog.
    */
  var MySQLCatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.MySQLCatalogSource] = js.undefined
  
  /**
    * Specifies a target that uses MySQL.
    */
  var MySQLCatalogTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.MySQLCatalogTarget] = js.undefined
  
  /**
    * Specifies an Oracle data source in the Glue Data Catalog.
    */
  var OracleSQLCatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.OracleSQLCatalogSource] = js.undefined
  
  /**
    * Specifies a target that uses Oracle SQL.
    */
  var OracleSQLCatalogTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.OracleSQLCatalogTarget] = js.undefined
  
  /**
    * Specifies a transform that identifies, removes or masks PII data.
    */
  var PIIDetection: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.PIIDetection] = js.undefined
  
  /**
    * Specifies a PostgresSQL data source in the Glue Data Catalog.
    */
  var PostgreSQLCatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.PostgreSQLCatalogSource] = js.undefined
  
  /**
    * Specifies a target that uses Postgres SQL.
    */
  var PostgreSQLCatalogTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.PostgreSQLCatalogTarget] = js.undefined
  
  /**
    * Specifies an Amazon Redshift data store.
    */
  var RedshiftSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.RedshiftSource] = js.undefined
  
  /**
    * Specifies a target that uses Amazon Redshift.
    */
  var RedshiftTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.RedshiftTarget] = js.undefined
  
  var RelationalCatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.RelationalCatalogSource] = js.undefined
  
  /**
    * Specifies a transform that renames a single data property key.
    */
  var RenameField: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.RenameField] = js.undefined
  
  /**
    * Specifies an Amazon S3 data store in the Glue Data Catalog.
    */
  var S3CatalogSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.S3CatalogSource] = js.undefined
  
  /**
    * Specifies a data target that writes to Amazon S3 using the Glue Data Catalog.
    */
  var S3CatalogTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.S3CatalogTarget] = js.undefined
  
  /**
    * Specifies a command-separated value (CSV) data store stored in Amazon S3.
    */
  var S3CsvSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.S3CsvSource] = js.undefined
  
  /**
    * Specifies a data target that writes to Amazon S3.
    */
  var S3DirectTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.S3DirectTarget] = js.undefined
  
  /**
    * Specifies a data target that writes to Amazon S3 in Apache Parquet columnar storage.
    */
  var S3GlueParquetTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.S3GlueParquetTarget] = js.undefined
  
  /**
    * Specifies a JSON data store stored in Amazon S3.
    */
  var S3JsonSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.S3JsonSource] = js.undefined
  
  /**
    * Specifies an Apache Parquet data store stored in Amazon S3.
    */
  var S3ParquetSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.S3ParquetSource] = js.undefined
  
  /**
    * Specifies a transform that chooses the data property keys that you want to keep.
    */
  var SelectFields: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.SelectFields] = js.undefined
  
  /**
    * Specifies a transform that chooses one DynamicFrame from a collection of DynamicFrames. The output is the selected DynamicFrame 
    */
  var SelectFromCollection: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.SelectFromCollection] = js.undefined
  
  /**
    * Specifies a connector to an Apache Spark data source.
    */
  var SparkConnectorSource: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.SparkConnectorSource] = js.undefined
  
  /**
    * Specifies a target that uses an Apache Spark connector.
    */
  var SparkConnectorTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.SparkConnectorTarget] = js.undefined
  
  /**
    * Specifies a transform where you enter a SQL query using Spark SQL syntax to transform the data. The output is a single DynamicFrame.
    */
  var SparkSQL: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.SparkSQL] = js.undefined
  
  /**
    * Specifies a transform that writes samples of the data to an Amazon S3 bucket.
    */
  var Spigot: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Spigot] = js.undefined
  
  /**
    * Specifies a transform that splits data property keys into two DynamicFrames. The output is a collection of DynamicFrames: one with selected data property keys, and one with the remaining data property keys.
    */
  var SplitFields: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.SplitFields] = js.undefined
  
  /**
    * Specifies a transform that combines the rows from two or more datasets into a single result.
    */
  var Union: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Union] = js.undefined
}
