...
trait S3Encryption extends StObject {
  ...
  /**
    ...
    */
  var KmsKeyArn: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.KmsKeyArn] = js.undefined
  
  /**
    * The encryption mode to use for Amazon S3 data.
    */
  var S3EncryptionMode: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.S3EncryptionMode] = js.undefined
}
object S3Encryption {
