...
trait CreateTriggerRequest extends StObject {
  ...
  /**
    ...
    */
  var EventBatchingCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.EventBatchingCondition] = js.undefined
  ...
  /**
    ...
    */
  var Predicate: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.Predicate] = js.undefined
