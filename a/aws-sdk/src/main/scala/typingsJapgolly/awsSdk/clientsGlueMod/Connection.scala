...
trait Connection extends StObject {
  ...
  /**
    ...
    */
  var ConnectionProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.ConnectionProperties] = js.undefined
  
  /**
    * The type of the connection. Currently, SFTP is not supported.
    */
  var ConnectionType: js.UndefOr[typingsJapgolly.awsSdk.clientsGlueMod.ConnectionType] = js.undefined
