...
trait BudgetPerformanceHistory extends js.Object {
  var BudgetName: js.UndefOr[typingsJapgolly.awsSdk.budgetsMod.BudgetName] = js.native
  var BudgetType: js.UndefOr[typingsJapgolly.awsSdk.budgetsMod.BudgetType] = js.native
  /**
    * A list of amounts of cost or usage that you created budgets for, compared to your actual costs or usage.
    */
  var BudgetedAndActualAmountsList: js.UndefOr[typingsJapgolly.awsSdk.budgetsMod.BudgetedAndActualAmountsList] = js.native
  /**
  ...
  var TimeUnit: js.UndefOr[typingsJapgolly.awsSdk.budgetsMod.TimeUnit] = js.native
}
