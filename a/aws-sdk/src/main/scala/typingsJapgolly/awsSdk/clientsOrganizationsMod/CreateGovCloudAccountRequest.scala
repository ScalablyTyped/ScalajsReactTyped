...
trait CreateGovCloudAccountRequest extends StObject {
  ...
  /**
    ...
    */
  var Email: typingsJapgolly.awsSdk.clientsOrganizationsMod.Email
  ...
  /**
    ...
    */
  var RoleName: js.UndefOr[typingsJapgolly.awsSdk.clientsOrganizationsMod.RoleName] = js.undefined
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.clientsOrganizationsMod.Tags] = js.undefined
}
object CreateGovCloudAccountRequest {
  
  inline def apply(AccountName: CreateAccountName, Email: Email): CreateGovCloudAccountRequest = {
