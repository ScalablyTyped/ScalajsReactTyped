...
trait ListCreateAccountStatusResponse extends StObject {
  ...
  /**
    ...
    */
  var CreateAccountStatuses: js.UndefOr[typingsJapgolly.awsSdk.clientsOrganizationsMod.CreateAccountStatuses] = js.undefined
...
object ListCreateAccountStatusResponse {
  ...
  extension [Self <: ListCreateAccountStatusResponse](x: Self) {
