...
trait MetricPolicyRule extends StObject {
  ...
  /**
    ...
    */
  var ObjectGroup: typingsJapgolly.awsSdk.clientsMediastoreMod.ObjectGroup
  
  /**
    * A name that allows you to refer to the object group.
    */
  var ObjectGroupName: typingsJapgolly.awsSdk.clientsMediastoreMod.ObjectGroupName
}
