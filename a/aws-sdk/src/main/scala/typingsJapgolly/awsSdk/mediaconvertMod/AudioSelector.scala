...
trait AudioSelector extends js.Object {
  ...
  /**
    ...
    */
  var LanguageCode: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.LanguageCode] = js.native
  /**
  ...
  /**
    ...
    */
  var RemixSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.RemixSettings] = js.native
  /**
