...
trait AudioCodecSettings extends js.Object {
  /**
    ...
    */
  var AacSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.AacSettings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value AC3.
    */
  var Ac3Settings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.Ac3Settings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value AIFF.
    */
  var AiffSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.AiffSettings] = js.native
  /**
    * Type of Audio codec.
    */
  ...
  /**
    ...
    */
  var Eac3AtmosSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.Eac3AtmosSettings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value EAC3.
    */
  var Eac3Settings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.Eac3Settings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value MP2.
    */
  var Mp2Settings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.Mp2Settings] = js.native
  /**
    * Required when you set Codec, under AudioDescriptions>CodecSettings, to the value MP3.
    */
  var Mp3Settings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.Mp3Settings] = js.native
  /**
    * Required when you set (Codec) under (AudioDescriptions)>(CodecSettings) to the value WAV.
    */
  var WavSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.WavSettings] = js.native
}
