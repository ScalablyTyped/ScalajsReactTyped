...
trait ContainerSettings extends js.Object {
  /**
    ...
    */
  var CmfcSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.CmfcSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var F4vSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.F4vSettings] = js.native
  /**
    ...
    */
  var M2tsSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.M2tsSettings] = js.native
  /**
    * Settings for TS segments in HLS
    */
  var M3u8Settings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.M3u8Settings] = js.native
  /**
    * Settings for MOV Container.
    */
  var MovSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.MovSettings] = js.native
  /**
    * Settings for MP4 container. You can create audio-only AAC outputs with this container.
    */
  var Mp4Settings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.Mp4Settings] = js.native
  /**
    * Settings for MP4 segments in DASH
    */
  var MpdSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.MpdSettings] = js.native
}
