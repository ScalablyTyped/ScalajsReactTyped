...
trait OutputGroupSettings extends js.Object {
  /**
    ...
    */
  var CmafGroupSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.CmafGroupSettings] = js.native
  /**
    * Required when you set (Type) under (OutputGroups)>(OutputGroupSettings) to DASH_ISO_GROUP_SETTINGS.
    */
  var DashIsoGroupSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.DashIsoGroupSettings] = js.native
  /**
    * Required when you set (Type) under (OutputGroups)>(OutputGroupSettings) to FILE_GROUP_SETTINGS.
    */
  var FileGroupSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.FileGroupSettings] = js.native
  /**
    * Required when you set (Type) under (OutputGroups)>(OutputGroupSettings) to HLS_GROUP_SETTINGS.
    */
  var HlsGroupSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.HlsGroupSettings] = js.native
  /**
    * Required when you set (Type) under (OutputGroups)>(OutputGroupSettings) to MS_SMOOTH_GROUP_SETTINGS.
    */
  var MsSmoothGroupSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.MsSmoothGroupSettings] = js.native
  /**
