...
trait CaptionSourceSettings extends js.Object {
  /**
    ...
    */
  var AncillarySourceSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.AncillarySourceSettings] = js.native
  /**
    * DVB Sub Source Settings
    */
  var DvbSubSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.DvbSubSourceSettings] = js.native
  /**
    * Settings for embedded captions Source
    */
  var EmbeddedSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.EmbeddedSourceSettings] = js.native
  /**
    ...
    */
  var FileSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.FileSourceSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var TeletextSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.TeletextSourceSettings] = js.native
  /**
    * Settings specific to caption sources that are specified by track number. Currently, this is only IMSC captions in an IMF package. If your caption source is IMSC 1.1 in a separate xml file, use FileSourceSettings instead of TrackSourceSettings.
    */
  var TrackSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.TrackSourceSettings] = js.native
}
