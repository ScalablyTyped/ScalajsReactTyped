...
trait M2tsSettings extends js.Object {
  ...
  /**
    ...
    */
  var DvbNitSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.DvbNitSettings] = js.native
  /**
    * Inserts DVB Service Description Table (NIT) at the specified table repetition interval.
    */
  var DvbSdtSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.DvbSdtSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var DvbTdtSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.DvbTdtSettings] = js.native
  /**
