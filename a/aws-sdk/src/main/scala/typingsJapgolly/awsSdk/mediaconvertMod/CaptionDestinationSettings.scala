...
trait CaptionDestinationSettings extends js.Object {
  /**
    ...
    */
  var BurninDestinationSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.BurninDestinationSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var DvbSubDestinationSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.DvbSubDestinationSettings] = js.native
  /**
    * Settings specific to embedded/ancillary caption outputs, including 608/708 Channel destination number.
    */
  var EmbeddedDestinationSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.EmbeddedDestinationSettings] = js.native
  /**
    * Settings specific to IMSC caption outputs.
    */
  var ImscDestinationSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.ImscDestinationSettings] = js.native
  /**
    * Settings for SCC caption output.
    */
  var SccDestinationSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.SccDestinationSettings] = js.native
  /**
    * Settings for Teletext caption output
    */
  var TeletextDestinationSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.TeletextDestinationSettings] = js.native
  /**
    * Settings specific to TTML caption outputs, including Pass style information (TtmlStylePassthrough).
    */
  var TtmlDestinationSettings: js.UndefOr[typingsJapgolly.awsSdk.mediaconvertMod.TtmlDestinationSettings] = js.native
}
