...
trait StartSelector extends js.Object {
  ...
  /**
    ...
    */
  var ContinuationToken: js.UndefOr[typingsJapgolly.awsSdk.kinesisvideomediaMod.ContinuationToken] = js.native
  /**
    ...
    */
  var StartSelectorType: typingsJapgolly.awsSdk.kinesisvideomediaMod.StartSelectorType = js.native
  /**
