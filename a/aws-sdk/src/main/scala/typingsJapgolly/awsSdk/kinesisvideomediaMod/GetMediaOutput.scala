...
trait GetMediaOutput extends js.Object {
  /**
    ...
    */
  var ContentType: js.UndefOr[typingsJapgolly.awsSdk.kinesisvideomediaMod.ContentType] = js.native
  /**
    ...
    */
  var Payload: js.UndefOr[typingsJapgolly.awsSdk.kinesisvideomediaMod.Payload] = js.native
}
