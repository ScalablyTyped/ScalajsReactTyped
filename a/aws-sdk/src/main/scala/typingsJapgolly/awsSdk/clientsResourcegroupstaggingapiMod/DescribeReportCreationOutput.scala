...
trait DescribeReportCreationOutput extends StObject {
  ...
  /**
    ...
    */
  var S3Location: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupstaggingapiMod.S3Location] = js.undefined
  ...
  /**
    ...
    */
  var Status: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupstaggingapiMod.Status] = js.undefined
}
