...
trait ResourceTagMapping extends StObject {
  ...
  /**
    ...
    */
  var ComplianceDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupstaggingapiMod.ComplianceDetails] = js.undefined
  
  /**
    * The ARN of the resource.
    */
  var ResourceARN: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupstaggingapiMod.ResourceARN] = js.undefined
