...
trait FailureInfo extends StObject {
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupstaggingapiMod.ErrorCode] = js.undefined
  
  /**
    * The message of the common error.
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupstaggingapiMod.ErrorMessage] = js.undefined
  
  /**
    * The HTTP status code of the common error.
    */
  var StatusCode: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupstaggingapiMod.StatusCode] = js.undefined
}
object FailureInfo {
