...
trait MaintenanceStartTime extends StObject {
  ...
  /**
    ...
    */
  var DayOfMonth: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupgatewayMod.DayOfMonth] = js.undefined
  
  /**
    * An ordinal number between 0 and 6 that represents the day of the week, where 0 represents Sunday and 6 represents Saturday. The day of week is in the time zone of the gateway.
    */
  var DayOfWeek: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupgatewayMod.DayOfWeek] = js.undefined
  
  /**
    * The hour component of the maintenance start time represented as hh, where hh is the hour (0 to 23). The hour of the day is in the time zone of the gateway.
    */
  var HourOfDay: typingsJapgolly.awsSdk.clientsBackupgatewayMod.HourOfDay
  
  /**
    * The minute component of the maintenance start time represented as mm, where mm is the minute (0 to 59). The minute of the hour is in the time zone of the gateway.
    */
  var MinuteOfHour: typingsJapgolly.awsSdk.clientsBackupgatewayMod.MinuteOfHour
}
