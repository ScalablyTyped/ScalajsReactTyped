...
trait CreateGatewayInput extends StObject {
  ...
  /**
    ...
    */
  var ActivationKey: typingsJapgolly.awsSdk.clientsBackupgatewayMod.ActivationKey
  ...
  /**
    ...
    */
  var GatewayType: typingsJapgolly.awsSdk.clientsBackupgatewayMod.GatewayType
