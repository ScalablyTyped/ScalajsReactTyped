...
trait UpdateHypervisorInput extends StObject {
  ...
  /**
    ...
    */
  var Host: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupgatewayMod.Host] = js.undefined
  ...
  /**
    ...
    */
  var Name: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupgatewayMod.Name] = js.undefined
  
  /**
    * The updated password for the hypervisor.
    */
  var Password: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupgatewayMod.Password] = js.undefined
  
  /**
    * The updated username for the hypervisor.
    */
  var Username: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupgatewayMod.Username] = js.undefined
}
object UpdateHypervisorInput {
  ...
  extension [Self <: UpdateHypervisorInput](x: Self) {
