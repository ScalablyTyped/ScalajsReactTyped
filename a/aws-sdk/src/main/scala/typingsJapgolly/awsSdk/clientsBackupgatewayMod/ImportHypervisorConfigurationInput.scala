...
trait ImportHypervisorConfigurationInput extends StObject {
  ...
  /**
    ...
    */
  var KmsKeyArn: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupgatewayMod.KmsKeyArn] = js.undefined
  
  /**
    * The name of the hypervisor.
    */
  var Name: typingsJapgolly.awsSdk.clientsBackupgatewayMod.Name
