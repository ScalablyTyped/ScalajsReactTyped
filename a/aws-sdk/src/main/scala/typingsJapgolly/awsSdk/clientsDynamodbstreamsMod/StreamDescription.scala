...
trait StreamDescription extends StObject {
  ...
  /**
    ...
    */
  var KeySchema: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbstreamsMod.KeySchema] = js.undefined
  ...
  /**
    ...
    */
  var StreamStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbstreamsMod.StreamStatus] = js.undefined
