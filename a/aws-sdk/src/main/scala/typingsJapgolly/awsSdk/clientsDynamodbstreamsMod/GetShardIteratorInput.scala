...
trait GetShardIteratorInput extends StObject {
  ...
  /**
    ...
    */
  var ShardId: typingsJapgolly.awsSdk.clientsDynamodbstreamsMod.ShardId
  ...
  /**
    ...
    */
  var ShardIteratorType: typingsJapgolly.awsSdk.clientsDynamodbstreamsMod.ShardIteratorType
  
  /**
    * The Amazon Resource Name (ARN) for the stream.
    */
  var StreamArn: typingsJapgolly.awsSdk.clientsDynamodbstreamsMod.StreamArn
}
