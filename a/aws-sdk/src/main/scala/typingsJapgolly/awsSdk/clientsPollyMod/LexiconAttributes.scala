...
trait LexiconAttributes extends StObject {
  ...
  /**
    ...
    */
  var Alphabet: js.UndefOr[typingsJapgolly.awsSdk.clientsPollyMod.Alphabet] = js.undefined
  ...
  /**
    ...
    */
  var LexemesCount: js.UndefOr[typingsJapgolly.awsSdk.clientsPollyMod.LexemesCount] = js.undefined
  
  /**
    * Amazon Resource Name (ARN) of the lexicon.
    */
  var LexiconArn: js.UndefOr[typingsJapgolly.awsSdk.clientsPollyMod.LexiconArn] = js.undefined
  
  /**
    * Total size of the lexicon, in characters.
    */
  var Size: js.UndefOr[typingsJapgolly.awsSdk.clientsPollyMod.Size] = js.undefined
}
