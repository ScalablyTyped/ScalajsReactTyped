...
trait Voice extends StObject {
  ...
  /**
    * Gender of the voice.
    */
  var Gender: js.UndefOr[typingsJapgolly.awsSdk.clientsPollyMod.Gender] = js.undefined
  ...
  /**
    ...
    */
  var LanguageName: js.UndefOr[typingsJapgolly.awsSdk.clientsPollyMod.LanguageName] = js.undefined
