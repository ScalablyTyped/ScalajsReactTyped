...
trait SynthesizeSpeechOutput extends StObject {
  ...
  /**
    ...
    */
  var AudioStream: js.UndefOr[typingsJapgolly.awsSdk.clientsPollyMod.AudioStream] = js.undefined
  ...
  /**
    ...
    */
  var ContentType: js.UndefOr[typingsJapgolly.awsSdk.clientsPollyMod.ContentType] = js.undefined
