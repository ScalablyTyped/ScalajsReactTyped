...
trait ChannelMessageSummary extends StObject {
  ...
  /**
    ...
    */
  var Content: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.Content] = js.undefined
  ...
  /**
    ...
    */
  var Metadata: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.Metadata] = js.undefined
...
object ChannelMessageSummary {
  ...
  extension [Self <: ChannelMessageSummary](x: Self) {
