...
trait ListChannelMessagesRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.MaxResults] = js.undefined
  
  /**
    * The token passed by previous API calls until all requested messages are returned.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.NextToken] = js.undefined
  ...
  /**
    ...
    */
  var SortOrder: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.SortOrder] = js.undefined
