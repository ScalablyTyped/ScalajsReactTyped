...
trait PushNotificationPreferences extends StObject {
  ...
  /**
    ...
    */
  var AllowNotifications: typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.AllowNotifications
  
  /**
    * The simple JSON object used to send a subset of a push notification to the requested member.
    */
  var FilterRule: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.FilterRule] = js.undefined
}
