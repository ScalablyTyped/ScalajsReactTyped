...
trait ElasticChannelConfiguration extends StObject {
  ...
  /**
    ...
    */
  var MaximumSubChannels: typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.MaximumSubChannels
  
  /**
    * The minimum allowed percentage of TargetMembershipsPerSubChannel users. Ceil of the calculated value is used in balancing members among SubChannels of the elastic channel.
    */
  var MinimumMembershipPercentage: typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.MinimumMembershipPercentage
  
  /**
    * The maximum number of members allowed in a SubChannel.
    */
  var TargetMembershipsPerSubChannel: typingsJapgolly.awsSdk.clientsChimesdkmessagingMod.TargetMembershipsPerSubChannel
}
