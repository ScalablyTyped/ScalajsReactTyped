...
trait StorageType extends js.Object {
  var StorageSubTypeName: js.UndefOr[typingsJapgolly.awsSdk.esMod.StorageSubTypeName] = js.native
  /**
    * List of limits that are applicable for given storage type. 
    */
  var StorageTypeLimits: js.UndefOr[StorageTypeLimitList] = js.native
  var StorageTypeName: js.UndefOr[typingsJapgolly.awsSdk.esMod.StorageTypeName] = js.native
}
