...
trait ElasticsearchDomainStatus extends js.Object {
  /**
    ...
    */
  var ARN: typingsJapgolly.awsSdk.esMod.ARN = js.native
  /**
  ...
  /**
    ...
    */
  var AdvancedSecurityOptions: js.UndefOr[typingsJapgolly.awsSdk.esMod.AdvancedSecurityOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var DomainId: typingsJapgolly.awsSdk.esMod.DomainId = js.native
  /**
  ...
  /**
    ...
    */
  var ElasticsearchClusterConfig: typingsJapgolly.awsSdk.esMod.ElasticsearchClusterConfig = js.native
  ...
  /**
    ...
    */
  var ServiceSoftwareOptions: js.UndefOr[typingsJapgolly.awsSdk.esMod.ServiceSoftwareOptions] = js.native
  /**
