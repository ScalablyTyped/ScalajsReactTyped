...
trait CognitoOptions extends js.Object {
  ...
  /**
    ...
    */
  var IdentityPoolId: js.UndefOr[typingsJapgolly.awsSdk.esMod.IdentityPoolId] = js.native
  /**
    * Specifies the role ARN that provides Elasticsearch permissions for accessing Cognito resources.
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.esMod.RoleArn] = js.native
  /**
    * Specifies the Cognito user pool ID for Kibana authentication.
    */
  var UserPoolId: js.UndefOr[typingsJapgolly.awsSdk.esMod.UserPoolId] = js.native
}
