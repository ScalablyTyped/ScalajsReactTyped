...
trait DomainNameConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var DomainNameStatus: js.UndefOr[typingsJapgolly.awsSdk.apigatewayv2Mod.DomainNameStatus] = js.native
  /**
  ...
  /**
    * The endpoint type.
    */
  var EndpointType: js.UndefOr[typingsJapgolly.awsSdk.apigatewayv2Mod.EndpointType] = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityPolicy: js.UndefOr[typingsJapgolly.awsSdk.apigatewayv2Mod.SecurityPolicy] = js.native
}
