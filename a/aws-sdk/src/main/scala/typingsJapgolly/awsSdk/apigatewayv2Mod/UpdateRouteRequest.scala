...
trait UpdateRouteRequest extends js.Object {
  ...
  /**
    ...
    */
  var AuthorizationScopes: js.UndefOr[typingsJapgolly.awsSdk.apigatewayv2Mod.AuthorizationScopes] = js.native
  /**
    ...
    */
  var AuthorizationType: js.UndefOr[typingsJapgolly.awsSdk.apigatewayv2Mod.AuthorizationType] = js.native
  /**
