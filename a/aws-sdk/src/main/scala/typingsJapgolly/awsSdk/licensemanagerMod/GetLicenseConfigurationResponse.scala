...
trait GetLicenseConfigurationResponse extends js.Object {
  /**
    ...
    */
  var AutomatedDiscoveryInformation: js.UndefOr[typingsJapgolly.awsSdk.licensemanagerMod.AutomatedDiscoveryInformation] = js.native
  /**
    * Summaries of the licenses consumed by resources.
    */
  var ConsumedLicenseSummaryList: js.UndefOr[typingsJapgolly.awsSdk.licensemanagerMod.ConsumedLicenseSummaryList] = js.native
  /**
  ...
  /**
    ...
    */
  var LicenseCountingType: js.UndefOr[typingsJapgolly.awsSdk.licensemanagerMod.LicenseCountingType] = js.native
  /**
    * License rules.
    */
  ...
  /**
    ...
    */
  var ManagedResourceSummaryList: js.UndefOr[typingsJapgolly.awsSdk.licensemanagerMod.ManagedResourceSummaryList] = js.native
  /**
  ...
  /**
    * Product information.
    */
  var ProductInformationList: js.UndefOr[typingsJapgolly.awsSdk.licensemanagerMod.ProductInformationList] = js.native
  /**
