...
trait CreateAgentRequest extends StObject {
  ...
  /**
    ...
    */
  var ActivationKey: typingsJapgolly.awsSdk.clientsDatasyncMod.ActivationKey
  ...
  /**
    ...
    */
  var VpcEndpointId: js.UndefOr[typingsJapgolly.awsSdk.clientsDatasyncMod.VpcEndpointId] = js.undefined
}
