...
trait CreateLocationHdfsRequest extends StObject {
  ...
  /**
    ...
    */
  var KerberosPrincipal: js.UndefOr[typingsJapgolly.awsSdk.clientsDatasyncMod.KerberosPrincipal] = js.undefined
  
  /**
    * The URI of the HDFS cluster's Key Management Server (KMS). 
    */
  var KmsKeyProviderUri: js.UndefOr[typingsJapgolly.awsSdk.clientsDatasyncMod.KmsKeyProviderUri] = js.undefined
  ...
  /**
    ...
    */
  var QopConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsDatasyncMod.QopConfiguration] = js.undefined
...
object CreateLocationHdfsRequest {
  ...
  extension [Self <: CreateLocationHdfsRequest](x: Self) {
