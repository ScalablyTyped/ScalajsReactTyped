...
trait EventTypeSummary extends StObject {
  ...
  /**
    ...
    */
  var EventTypeId: js.UndefOr[typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.EventTypeId] = js.undefined
  
  /**
    * The name of the event.
    */
  var EventTypeName: js.UndefOr[typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.EventTypeName] = js.undefined
  
  /**
    * The resource type of the event.
    */
  var ResourceType: js.UndefOr[typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.ResourceType] = js.undefined
  
  /**
    * The name of the service for which the event applies.
    */
  var ServiceName: js.UndefOr[typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.ServiceName] = js.undefined
}
