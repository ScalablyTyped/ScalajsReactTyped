...
trait CreateNotificationRuleRequest extends StObject {
  ...
  /**
    ...
    */
  var DetailType: typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.DetailType
  
  /**
    * A list of event types associated with this notification rule. For a list of allowed events, see EventTypeSummary.
    */
  var EventTypeIds: typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.EventTypeIds
  ...
  /**
    ...
    */
  var Targets: typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.Targets
}
