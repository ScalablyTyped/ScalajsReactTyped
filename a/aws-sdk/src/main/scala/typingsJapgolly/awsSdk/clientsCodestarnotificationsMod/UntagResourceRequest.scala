...
trait UntagResourceRequest extends StObject {
  ...
  /**
    ...
    */
  var TagKeys: typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.TagKeys
}
object UntagResourceRequest {
  
  inline def apply(Arn: NotificationRuleArn, TagKeys: TagKeys): UntagResourceRequest = {
