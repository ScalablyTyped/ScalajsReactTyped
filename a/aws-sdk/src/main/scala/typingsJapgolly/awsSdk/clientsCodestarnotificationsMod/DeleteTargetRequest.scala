...
trait DeleteTargetRequest extends StObject {
  ...
  /**
    ...
    */
  var ForceUnsubscribeAll: js.UndefOr[typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.ForceUnsubscribeAll] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the Chatbot topic or Chatbot client to delete.
    */
  var TargetAddress: typingsJapgolly.awsSdk.clientsCodestarnotificationsMod.TargetAddress
}
