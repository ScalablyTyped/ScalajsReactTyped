...
trait ListAppComponentRecommendationsRequest extends StObject {
...
object ListAppComponentRecommendationsRequest {
  ...
  inline def apply(assessmentArn: Arn): ListAppComponentRecommendationsRequest = {
  ...
  extension [Self <: ListAppComponentRecommendationsRequest](x: Self) {
