...
trait MembershipDatasources extends StObject {
  ...
  /**
    ...
    */
  var DatasourcePackageIngestHistory: js.UndefOr[typingsJapgolly.awsSdk.clientsDetectiveMod.DatasourcePackageIngestHistory] = js.undefined
...
object MembershipDatasources {
  ...
  extension [Self <: MembershipDatasources](x: Self) {
