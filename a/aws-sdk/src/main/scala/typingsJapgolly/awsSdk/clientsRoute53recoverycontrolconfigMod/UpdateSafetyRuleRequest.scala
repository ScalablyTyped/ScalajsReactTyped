...
trait UpdateSafetyRuleRequest extends StObject {
  ...
  /**
    ...
    */
  var AssertionRuleUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsRoute53recoverycontrolconfigMod.AssertionRuleUpdate
  ] = js.undefined
  
  /**
    * The gating rule to update.
    */
  var GatingRuleUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53recoverycontrolconfigMod.GatingRuleUpdate] = js.undefined
}
