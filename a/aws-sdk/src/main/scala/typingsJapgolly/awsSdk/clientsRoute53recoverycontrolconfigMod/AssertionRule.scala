...
trait AssertionRule extends StObject {
  ...
  /**
    ...
    */
  var RuleConfig: typingsJapgolly.awsSdk.clientsRoute53recoverycontrolconfigMod.RuleConfig
  ...
  /**
    ...
    */
  var Status: typingsJapgolly.awsSdk.clientsRoute53recoverycontrolconfigMod.Status
...
object AssertionRule {
  ...
  extension [Self <: AssertionRule](x: Self) {
