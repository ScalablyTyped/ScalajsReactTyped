...
trait ReportDefinition extends js.Object {
  ...
  /**
    ...
    */
  var RefreshClosedReports: js.UndefOr[typingsJapgolly.awsSdk.curMod.RefreshClosedReports] = js.native
  var ReportName: typingsJapgolly.awsSdk.curMod.ReportName = js.native
  /**
    * Whether you want Amazon Web Services to overwrite the previous version of each report or to deliver the report in addition to the previous versions.
    */
  var ReportVersioning: js.UndefOr[typingsJapgolly.awsSdk.curMod.ReportVersioning] = js.native
  var S3Bucket: typingsJapgolly.awsSdk.curMod.S3Bucket = js.native
  var S3Prefix: typingsJapgolly.awsSdk.curMod.S3Prefix = js.native
  var S3Region: AWSRegion = js.native
  var TimeUnit: typingsJapgolly.awsSdk.curMod.TimeUnit = js.native
}
