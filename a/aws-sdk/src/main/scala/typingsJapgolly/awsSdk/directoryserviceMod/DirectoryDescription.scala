...
trait DirectoryDescription extends js.Object {
  /**
    ...
    */
  var AccessUrl: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.AccessUrl] = js.native
  /**
  ...
  /**
    ...
    */
  var DesiredNumberOfDomainControllers: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.DesiredNumberOfDomainControllers] = js.native
  /**
  ...
  /**
    ...
    */
  var DnsIpAddrs: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.DnsIpAddrs] = js.native
  /**
  ...
  /**
    ...
    */
  var OwnerDirectoryDescription: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.OwnerDirectoryDescription] = js.native
  /**
    * A RadiusSettings object that contains information about the RADIUS server configured for this directory.
    */
  var RadiusSettings: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.RadiusSettings] = js.native
  /**
    * The status of the RADIUS MFA server connection.
    */
  var RadiusStatus: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.RadiusStatus] = js.native
  /**
    * The method used when sharing a directory to determine whether the directory should be shared within your AWS organization (ORGANIZATIONS) or with any AWS account by sending a shared directory request (HANDSHAKE).
    */
  var ShareMethod: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.ShareMethod] = js.native
  /**
  ...
  /**
    ...
    */
  var ShareStatus: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.ShareStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var SsoEnabled: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.SsoEnabled] = js.native
  /**
  ...
  /**
    ...
    */
  var StageReason: js.UndefOr[typingsJapgolly.awsSdk.directoryserviceMod.StageReason] = js.native
  /**
    * The directory size.
    */
