...
trait StartSchemaExtensionRequest extends js.Object {
  /**
    ...
    */
  var CreateSnapshotBeforeSchemaExtension: typingsJapgolly.awsSdk.directoryserviceMod.CreateSnapshotBeforeSchemaExtension = js.native
  /**
    * A description of the schema extension.
    */
  var Description: typingsJapgolly.awsSdk.directoryserviceMod.Description = js.native
  /**
  ...
  /**
    ...
    */
  var LdifContent: typingsJapgolly.awsSdk.directoryserviceMod.LdifContent = js.native
}
