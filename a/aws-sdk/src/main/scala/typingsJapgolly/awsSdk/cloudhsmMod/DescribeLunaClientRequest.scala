...
trait DescribeLunaClientRequest extends js.Object {
  /**
    ...
    */
  var CertificateFingerprint: js.UndefOr[typingsJapgolly.awsSdk.cloudhsmMod.CertificateFingerprint] = js.native
  /**
    * The ARN of the client.
    */
  var ClientArn: js.UndefOr[typingsJapgolly.awsSdk.cloudhsmMod.ClientArn] = js.native
}
