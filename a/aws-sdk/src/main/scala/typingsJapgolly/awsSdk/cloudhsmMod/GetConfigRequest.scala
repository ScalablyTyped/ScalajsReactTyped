...
trait GetConfigRequest extends js.Object {
  /**
    ...
    */
  var ClientArn: typingsJapgolly.awsSdk.cloudhsmMod.ClientArn = js.native
  /**
    * The client version.
    */
  var ClientVersion: typingsJapgolly.awsSdk.cloudhsmMod.ClientVersion = js.native
  /**
    * A list of ARNs that identify the high-availability partition groups that are associated with the client.
    */
  var HapgList: typingsJapgolly.awsSdk.cloudhsmMod.HapgList = js.native
}
