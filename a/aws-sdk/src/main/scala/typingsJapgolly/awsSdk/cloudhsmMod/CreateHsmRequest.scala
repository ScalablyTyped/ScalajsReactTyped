...
trait CreateHsmRequest extends js.Object {
  /**
    ...
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.cloudhsmMod.ClientToken] = js.native
  /**
  ...
  /**
    ...
    */
  var ExternalId: js.UndefOr[typingsJapgolly.awsSdk.cloudhsmMod.ExternalId] = js.native
  /**
    * The ARN of an IAM role to enable the AWS CloudHSM service to allocate an ENI on your behalf.
    */
  var IamRoleArn: typingsJapgolly.awsSdk.cloudhsmMod.IamRoleArn = js.native
  /**
    * The SSH public key to install on the HSM.
    */
  var SshKey: typingsJapgolly.awsSdk.cloudhsmMod.SshKey = js.native
  /**
    * The identifier of the subnet in your VPC in which to place the HSM.
    */
  var SubnetId: typingsJapgolly.awsSdk.cloudhsmMod.SubnetId = js.native
  var SubscriptionType: typingsJapgolly.awsSdk.cloudhsmMod.SubscriptionType = js.native
  /**
