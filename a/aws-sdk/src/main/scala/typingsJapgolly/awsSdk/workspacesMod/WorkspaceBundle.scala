...
trait WorkspaceBundle extends js.Object {
  /**
    ...
    */
  var BundleId: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.BundleId] = js.native
  /**
    * The compute type. For more information, see Amazon WorkSpaces Bundles.
    */
  var ComputeType: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.ComputeType] = js.native
  /**
    * A description.
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.Description] = js.native
  /**
  ...
  /**
    ...
    */
  var RootStorage: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.RootStorage] = js.native
  /**
    * The size of the user storage.
    */
  var UserStorage: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.UserStorage] = js.native
}
