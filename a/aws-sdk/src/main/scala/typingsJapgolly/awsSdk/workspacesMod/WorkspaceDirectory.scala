...
trait WorkspaceDirectory extends js.Object {
  /**
    * The directory alias.
    */
  var Alias: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.Alias] = js.native
  /**
  ...
  /**
    ...
    */
  var DirectoryId: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.DirectoryId] = js.native
  /**
    * The name of the directory.
    */
  var DirectoryName: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.DirectoryName] = js.native
  /**
    * The directory type.
    */
  ...
  /**
    ...
    */
  var DnsIpAddresses: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.DnsIpAddresses] = js.native
  /**
  ...
  /**
    ...
    */
  var RegistrationCode: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.RegistrationCode] = js.native
  /**
    * The default self-service permissions for WorkSpaces in the directory.
    */
  var SelfservicePermissions: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.SelfservicePermissions] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetIds: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.SubnetIds] = js.native
  /**
    ...
    */
  var Tenancy: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.Tenancy] = js.native
  /**
    * The devices and operating systems that users can use to access WorkSpaces.
    */
  var WorkspaceAccessProperties: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.WorkspaceAccessProperties] = js.native
  /**
