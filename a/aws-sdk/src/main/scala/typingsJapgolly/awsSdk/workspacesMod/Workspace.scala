...
trait Workspace extends js.Object {
  ...
  /**
    ...
    */
  var ComputerName: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.ComputerName] = js.native
  /**
  ...
  /**
    ...
    */
  var IpAddress: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.IpAddress] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetId: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.SubnetId] = js.native
  /**
    * The user for the WorkSpace.
    */
  var UserName: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.UserName] = js.native
  /**
