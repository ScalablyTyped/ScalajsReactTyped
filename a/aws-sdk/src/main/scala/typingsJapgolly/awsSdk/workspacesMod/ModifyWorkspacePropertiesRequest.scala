...
trait ModifyWorkspacePropertiesRequest extends js.Object {
  /**
    ...
    */
  var WorkspaceId: typingsJapgolly.awsSdk.workspacesMod.WorkspaceId = js.native
  /**
    * The properties of the WorkSpace.
    */
  var WorkspaceProperties: typingsJapgolly.awsSdk.workspacesMod.WorkspaceProperties = js.native
}
