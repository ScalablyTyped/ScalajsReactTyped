...
trait WorkspaceRequest extends js.Object {
  /**
    ...
    */
  var BundleId: typingsJapgolly.awsSdk.workspacesMod.BundleId = js.native
  /**
    * The identifier of the AWS Directory Service directory for the WorkSpace. You can use DescribeWorkspaceDirectories to list the available directories.
    */
  var DirectoryId: typingsJapgolly.awsSdk.workspacesMod.DirectoryId = js.native
  /**
  ...
  /**
    ...
    */
  var UserName: typingsJapgolly.awsSdk.workspacesMod.UserName = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeEncryptionKey: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.VolumeEncryptionKey] = js.native
  /**
    * The WorkSpace properties.
    */
  var WorkspaceProperties: js.UndefOr[typingsJapgolly.awsSdk.workspacesMod.WorkspaceProperties] = js.native
}
