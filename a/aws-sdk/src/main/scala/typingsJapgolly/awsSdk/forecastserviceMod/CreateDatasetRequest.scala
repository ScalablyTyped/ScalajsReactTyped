...
trait CreateDatasetRequest extends js.Object {
  ...
  /**
    ...
    */
  var DatasetType: typingsJapgolly.awsSdk.forecastserviceMod.DatasetType = js.native
  /**
    ...
    */
  var Domain: typingsJapgolly.awsSdk.forecastserviceMod.Domain = js.native
  /**
  ...
  /**
    ...
    */
  var Schema: typingsJapgolly.awsSdk.forecastserviceMod.Schema = js.native
}
