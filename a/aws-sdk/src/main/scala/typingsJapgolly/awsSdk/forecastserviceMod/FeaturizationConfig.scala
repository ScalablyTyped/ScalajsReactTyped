...
trait FeaturizationConfig extends js.Object {
  /**
    ...
    */
  var Featurizations: js.UndefOr[typingsJapgolly.awsSdk.forecastserviceMod.Featurizations] = js.native
  /**
    ...
    */
  var ForecastDimensions: js.UndefOr[typingsJapgolly.awsSdk.forecastserviceMod.ForecastDimensions] = js.native
  /**
