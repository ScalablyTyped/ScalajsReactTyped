...
trait FeaturizationMethod extends js.Object {
  /**
    ...
    */
  var FeaturizationMethodName: typingsJapgolly.awsSdk.forecastserviceMod.FeaturizationMethodName = js.native
  /**
    ...
    */
  var FeaturizationMethodParameters: js.UndefOr[typingsJapgolly.awsSdk.forecastserviceMod.FeaturizationMethodParameters] = js.native
}
