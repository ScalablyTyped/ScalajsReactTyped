...
trait DatasetSummary extends js.Object {
  ...
  /**
    * The dataset type.
    */
  var DatasetType: js.UndefOr[typingsJapgolly.awsSdk.forecastserviceMod.DatasetType] = js.native
  /**
    * The domain associated with the dataset.
    */
  var Domain: js.UndefOr[typingsJapgolly.awsSdk.forecastserviceMod.Domain] = js.native
  /**
