...
trait WindowSummary extends js.Object {
  /**
    ...
    */
  var EvaluationType: js.UndefOr[typingsJapgolly.awsSdk.forecastserviceMod.EvaluationType] = js.native
  /**
  ...
  /**
    ...
    */
  var Metrics: js.UndefOr[typingsJapgolly.awsSdk.forecastserviceMod.Metrics] = js.native
  /**
