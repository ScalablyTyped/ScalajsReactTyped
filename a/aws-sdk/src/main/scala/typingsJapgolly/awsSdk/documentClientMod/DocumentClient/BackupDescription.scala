...
trait BackupDescription extends js.Object {
  /**
    ...
    */
  var BackupDetails: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.BackupDetails] = js.native
  /**
    * Contains the details of the table when the backup was created. 
    */
  var SourceTableDetails: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.SourceTableDetails] = js.native
  /**
    * Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.
    */
  var SourceTableFeatureDetails: js.UndefOr[
    typingsJapgolly.awsSdk.documentClientMod.DocumentClient.SourceTableFeatureDetails
  ] = js.native
}
