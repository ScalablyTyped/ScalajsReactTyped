...
trait SourceTableFeatureDetails extends js.Object {
  /**
    ...
    */
  var GlobalSecondaryIndexes: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.GlobalSecondaryIndexes] = js.native
  /**
    * Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. 
    */
  var LocalSecondaryIndexes: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.LocalSecondaryIndexes] = js.native
  /**
    * The description of the server-side encryption status on the table when the backup was created.
    */
  var SSEDescription: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.SSEDescription] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeToLiveDescription: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.TimeToLiveDescription] = js.native
}
