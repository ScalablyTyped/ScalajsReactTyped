...
trait BackupDetails extends js.Object {
  ...
  /**
    ...
    */
  var BackupSizeBytes: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.BackupSizeBytes] = js.native
  /**
    * Backup can be in one of the following states: CREATING, ACTIVE, DELETED. 
    */
  var BackupStatus: typingsJapgolly.awsSdk.documentClientMod.DocumentClient.BackupStatus = js.native
  /**
    ...
    */
  var BackupType: typingsJapgolly.awsSdk.documentClientMod.DocumentClient.BackupType = js.native
}
