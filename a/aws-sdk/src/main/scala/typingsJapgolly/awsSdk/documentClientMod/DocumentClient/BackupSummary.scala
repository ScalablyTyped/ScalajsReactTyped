...
trait BackupSummary extends js.Object {
  /**
    ...
    */
  var BackupArn: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.BackupArn] = js.native
  /**
  ...
  /**
    ...
    */
  var BackupName: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.BackupName] = js.native
  /**
  ...
  /**
    ...
    */
  var BackupStatus: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.BackupStatus] = js.native
  /**
    ...
    */
  var BackupType: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.BackupType] = js.native
  /**
  ...
  /**
    ...
    */
  var TableId: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.TableId] = js.native
  /**
    * Name of the table.
    */
