...
trait UpdateItemInput extends js.Object {
  /**
    ...
    */
  var AttributeUpdates: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.AttributeUpdates] = js.native
  /**
  ...
  /**
    ...
    */
  var UpdateExpression: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.UpdateExpression] = js.native
}
