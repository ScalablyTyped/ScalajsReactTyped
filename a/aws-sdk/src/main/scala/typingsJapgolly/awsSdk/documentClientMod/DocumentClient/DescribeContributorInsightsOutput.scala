...
trait DescribeContributorInsightsOutput extends js.Object {
  ...
  var ContributorInsightsRuleList: js.UndefOr[
    typingsJapgolly.awsSdk.documentClientMod.DocumentClient.ContributorInsightsRuleList
  ] = js.native
  /**
    * Current Status contributor insights.
    */
  var ContributorInsightsStatus: js.UndefOr[
    typingsJapgolly.awsSdk.documentClientMod.DocumentClient.ContributorInsightsStatus
  ] = js.native
  /**
    ...
    */
  var FailureException: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.FailureException] = js.native
  /**
