...
trait SSEDescription extends js.Object {
  ...
  /**
    ...
    */
  var KMSMasterKeyArn: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.KMSMasterKeyArn] = js.native
  /**
    ...
    */
  var SSEType: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.SSEType] = js.native
  /**
