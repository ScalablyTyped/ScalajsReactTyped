...
trait GlobalSecondaryIndexInfo extends js.Object {
  ...
  /**
    ...
    */
  var KeySchema: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.KeySchema] = js.native
  /**
    * Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected. 
    */
  var Projection: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.Projection] = js.native
  /**
