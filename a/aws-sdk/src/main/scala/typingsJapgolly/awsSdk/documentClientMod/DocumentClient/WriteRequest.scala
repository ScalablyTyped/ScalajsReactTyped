...
trait WriteRequest extends js.Object {
  /**
    ...
    */
  var DeleteRequest: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.DeleteRequest] = js.native
  /**
    * A request to perform a PutItem operation.
    */
  var PutRequest: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.PutRequest] = js.native
}
