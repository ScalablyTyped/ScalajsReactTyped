...
trait UpdateTableInput extends js.Object {
  /**
    ...
    */
  var AttributeDefinitions: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.AttributeDefinitions] = js.native
  /**
  ...
  /**
    ...
    */
  var ProvisionedThroughput: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.ProvisionedThroughput] = js.native
  /**
  ...
  /**
    ...
    */
  var SSESpecification: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.SSESpecification] = js.native
  /**
    ...
    */
  var StreamSpecification: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.StreamSpecification] = js.native
  /**
