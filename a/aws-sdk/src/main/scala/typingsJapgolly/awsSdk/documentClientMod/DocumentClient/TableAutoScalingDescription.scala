...
trait TableAutoScalingDescription extends js.Object {
  ...
  /**
    ...
    */
  var TableName: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.TableName] = js.native
  /**
    ...
    */
  var TableStatus: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.TableStatus] = js.native
}
