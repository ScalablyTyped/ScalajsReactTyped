...
trait ReplicaDescription extends js.Object {
  ...
  /**
    ...
    */
  var ReplicaStatusDescription: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.ReplicaStatusDescription] = js.native
  /**
    * Specifies the progress of a Create, Update, or Delete action on the replica as a percentage.
    */
  var ReplicaStatusPercentProgress: js.UndefOr[
    typingsJapgolly.awsSdk.documentClientMod.DocumentClient.ReplicaStatusPercentProgress
  ] = js.native
}
