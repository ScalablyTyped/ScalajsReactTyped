...
trait ReplicaAutoScalingDescription extends js.Object {
  ...
  /**
    ...
    */
  var RegionName: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.RegionName] = js.native
  ...
  /**
    ...
    */
  var ReplicaStatus: js.UndefOr[typingsJapgolly.awsSdk.documentClientMod.DocumentClient.ReplicaStatus] = js.native
}
