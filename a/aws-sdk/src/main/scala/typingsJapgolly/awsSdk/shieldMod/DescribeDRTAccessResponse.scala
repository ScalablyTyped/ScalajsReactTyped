...
trait DescribeDRTAccessResponse extends js.Object {
  /**
    ...
    */
  var LogBucketList: js.UndefOr[typingsJapgolly.awsSdk.shieldMod.LogBucketList] = js.native
  /**
    * The Amazon Resource Name (ARN) of the role the DRT used to access your AWS account.
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.shieldMod.RoleArn] = js.native
}
