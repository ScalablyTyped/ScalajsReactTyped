...
trait GameSession extends js.Object {
  ...
  /**
    ...
    */
  var DnsName: js.UndefOr[typingsJapgolly.awsSdk.gameliftMod.DnsName] = js.native
  /**
  ...
  /**
    ...
    */
  var FleetId: js.UndefOr[typingsJapgolly.awsSdk.gameliftMod.FleetId] = js.native
  /**
  ...
  /**
    ...
    */
  var GameSessionData: js.UndefOr[typingsJapgolly.awsSdk.gameliftMod.GameSessionData] = js.native
  /**
  ...
  /**
    ...
    */
  var IpAddress: js.UndefOr[typingsJapgolly.awsSdk.gameliftMod.IpAddress] = js.native
  /**
    * Information about the matchmaking process that was used to create the game session. It is in JSON syntax, formatted as a string. In addition the matchmaking configuration used, it contains data on all players assigned to the match, including player attributes and team assignments. For more details on matchmaker data, see Match Data. Matchmaker data is useful when requesting match backfills, and is updated whenever new players are added during a successful backfill (see StartMatchBackfill). 
    */
  var MatchmakerData: js.UndefOr[typingsJapgolly.awsSdk.gameliftMod.MatchmakerData] = js.native
  /**
  ...
  /**
    ...
    */
  var PlayerSessionCreationPolicy: js.UndefOr[typingsJapgolly.awsSdk.gameliftMod.PlayerSessionCreationPolicy] = js.native
  /**
