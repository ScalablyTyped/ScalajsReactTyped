...
trait TimeSeriesTransformation extends StObject {
  ...
  /**
    ...
    */
  var Action: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.Action] = js.undefined
  
  /**
    * An array of conditions that define which members of the related time series are transformed.
    */
  var TimeSeriesConditions: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.TimeSeriesConditions] = js.undefined
}
