...
trait TimeSeriesCondition extends StObject {
  ...
  /**
    ...
    */
  var AttributeValue: typingsJapgolly.awsSdk.clientsForecastserviceMod.AttributeValue
  
  /**
    * The condition to apply. Valid values are EQUALS, NOT_EQUALS, LESS_THAN and GREATER_THAN.
    */
  var Condition: typingsJapgolly.awsSdk.clientsForecastserviceMod.Condition
}
