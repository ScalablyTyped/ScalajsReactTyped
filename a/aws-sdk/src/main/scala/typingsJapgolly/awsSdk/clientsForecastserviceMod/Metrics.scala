...
trait Metrics extends StObject {
  ...
  /**
    ...
    */
  var ErrorMetrics: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.ErrorMetrics] = js.undefined
  ...
  /**
    ...
    */
  var WeightedQuantileLosses: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.WeightedQuantileLosses] = js.undefined
}
object Metrics {
