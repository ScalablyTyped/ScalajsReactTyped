...
trait ExplainabilityConfig extends StObject {
  ...
  /**
    ...
    */
  var TimePointGranularity: typingsJapgolly.awsSdk.clientsForecastserviceMod.TimePointGranularity
  ...
  /**
    ...
    */
  var TimeSeriesGranularity: typingsJapgolly.awsSdk.clientsForecastserviceMod.TimeSeriesGranularity
}
