...
trait DescribeExplainabilityResponse extends StObject {
  ...
  /**
    ...
    */
  var ExplainabilityConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.ExplainabilityConfig] = js.undefined
  ...
  var Schema: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.Schema] = js.undefined
