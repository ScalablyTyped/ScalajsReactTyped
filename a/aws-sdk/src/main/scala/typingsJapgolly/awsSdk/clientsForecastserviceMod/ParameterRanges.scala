...
trait ParameterRanges extends StObject {
  ...
  /**
    ...
    */
  var CategoricalParameterRanges: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.CategoricalParameterRanges] = js.undefined
  
  /**
    * Specifies the tunable range for each continuous hyperparameter.
    */
  var ContinuousParameterRanges: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.ContinuousParameterRanges] = js.undefined
  
  /**
    * Specifies the tunable range for each integer hyperparameter.
    */
  var IntegerParameterRanges: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.IntegerParameterRanges] = js.undefined
}
