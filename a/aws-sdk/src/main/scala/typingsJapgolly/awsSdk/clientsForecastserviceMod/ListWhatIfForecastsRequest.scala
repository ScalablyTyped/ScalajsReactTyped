...
trait ListWhatIfForecastsRequest extends StObject {
  ...
  /**
    ...
    */
  var Filters: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.Filters] = js.undefined
  
  /**
    * The number of items to return in the response.
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.MaxResults] = js.undefined
...
object ListWhatIfForecastsRequest {
  ...
  inline def apply(): ListWhatIfForecastsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListWhatIfForecastsRequest]
  }
  
  extension [Self <: ListWhatIfForecastsRequest](x: Self) {
