...
trait DataConfig extends StObject {
  ...
  /**
    ...
    */
  var AdditionalDatasets: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.AdditionalDatasets] = js.undefined
  
  /**
    * Aggregation and filling options for attributes in your dataset group.
    */
  var AttributeConfigs: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.AttributeConfigs] = js.undefined
