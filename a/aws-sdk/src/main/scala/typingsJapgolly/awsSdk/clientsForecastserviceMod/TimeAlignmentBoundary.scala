...
trait TimeAlignmentBoundary extends StObject {
  ...
  /**
    ...
    */
  var DayOfMonth: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.DayOfMonth] = js.undefined
  
  /**
    * The day of week to use for time alignment during aggregation. The day must be in uppercase.
    */
  var DayOfWeek: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.DayOfWeek] = js.undefined
  
  /**
    * The hour of day to use for time alignment during aggregation.
    */
  var Hour: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.Hour] = js.undefined
  
  /**
    * The month to use for time alignment during aggregation. The month must be in uppercase.
    */
  var Month: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.Month] = js.undefined
}
