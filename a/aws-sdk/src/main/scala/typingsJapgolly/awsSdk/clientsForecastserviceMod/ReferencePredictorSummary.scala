...
trait ReferencePredictorSummary extends StObject {
  ...
  /**
    ...
    */
  var Arn: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.Arn] = js.undefined
  
  /**
    * Whether the reference predictor is Active or Deleted.
    */
  var State: js.UndefOr[typingsJapgolly.awsSdk.clientsForecastserviceMod.State] = js.undefined
}
