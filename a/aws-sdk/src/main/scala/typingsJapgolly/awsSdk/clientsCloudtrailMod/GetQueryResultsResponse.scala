...
trait GetQueryResultsResponse extends StObject {
  ...
  /**
    ...
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.ErrorMessage] = js.undefined
  ...
  /**
    ...
    */
  var QueryResultRows: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.QueryResultRows] = js.undefined
  
  /**
    * Shows the count of query results.
    */
  var QueryStatistics: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.QueryStatistics] = js.undefined
  
  /**
    * The status of the query. Values include QUEUED, RUNNING, FINISHED, FAILED, TIMED_OUT, or CANCELLED.
    */
  var QueryStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.QueryStatus] = js.undefined
}
