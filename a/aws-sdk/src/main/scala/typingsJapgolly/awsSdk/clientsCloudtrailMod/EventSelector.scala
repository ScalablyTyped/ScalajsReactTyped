...
trait EventSelector extends StObject {
  ...
  /**
    ...
    */
  var DataResources: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.DataResources] = js.undefined
  ...
  /**
    ...
    */
  var ExcludeManagementEventSources: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.ExcludeManagementEventSources] = js.undefined
  ...
  /**
    ...
    */
  var ReadWriteType: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.ReadWriteType] = js.undefined
}
