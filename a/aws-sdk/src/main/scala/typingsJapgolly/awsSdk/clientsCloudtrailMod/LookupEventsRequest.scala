...
trait LookupEventsRequest extends StObject {
  ...
  /**
    ...
    */
  var EventCategory: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.EventCategory] = js.undefined
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.MaxResults] = js.undefined
  
  /**
    * The token to use to get the next page of results after a previous API call. This token must be passed in with the same parameters that were specified in the original call. For example, if the original call specified an AttributeKey of 'Username' with a value of 'root', the call with NextToken should include those same parameters.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudtrailMod.NextToken] = js.undefined
