...
trait OriginEndpoint extends js.Object {
  ...
  var Authorization: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.Authorization] = js.native
  /**
    * The ID of the Channel the OriginEndpoint is associated with.
    */
  var ChannelId: js.UndefOr[string] = js.native
  var CmafPackage: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.CmafPackage] = js.native
  var DashPackage: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.DashPackage] = js.native
  /**
    * A short text description of the OriginEndpoint.
    */
  var Description: js.UndefOr[string] = js.native
  var HlsPackage: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.HlsPackage] = js.native
  /**
  ...
  var MssPackage: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.MssPackage] = js.native
  /**
    * Control whether origination of video is allowed for this OriginEndpoint. If set to ALLOW, the OriginEndpoint
  may by requested, pursuant to any other form of access control. If set to DENY, the OriginEndpoint may not be
  requested. This can be helpful for Live to VOD harvesting, or for temporarily disabling origination
    */
  var Origination: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.Origination] = js.native
  /**
    * Maximum duration (seconds) of content to retain for startover playback.
  If not specified, startover playback will be disabled for the OriginEndpoint.
    */
  var StartoverWindowSeconds: js.UndefOr[integer] = js.native
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.Tags] = js.native
  /**
