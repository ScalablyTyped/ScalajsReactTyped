...
trait HlsPackage extends js.Object {
  ...
  messages in the input source.
    */
  var AdMarkers: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.AdMarkers] = js.native
  var AdTriggers: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.AdTriggers] = js.native
  var AdsOnDeliveryRestrictions: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.AdsOnDeliveryRestrictions] = js.native
  ...
  entry will be included in the media playlist.
    */
  var PlaylistType: js.UndefOr[typingsJapgolly.awsSdk.mediapackageMod.PlaylistType] = js.native
  /**
