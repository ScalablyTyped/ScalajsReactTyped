...
package object importexportMod {
  ...
  type ArtifactList = js.Array[typingsJapgolly.awsSdk.importexportMod.Artifact]
  type Carrier = java.lang.String
  type ClientConfiguration = typingsJapgolly.awsSdk.serviceMod.ServiceConfigurationOptions with typingsJapgolly.awsSdk.importexportMod.ClientApiVersions
  ...
  type JobIdList = js.Array[typingsJapgolly.awsSdk.importexportMod.GenericString]
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdk.awsSdkStrings.Import_
    - typingsJapgolly.awsSdk.awsSdkStrings.Export_
    - java.lang.String
  */
  type JobType = typingsJapgolly.awsSdk.importexportMod._JobType | java.lang.String
  type JobsList = js.Array[typingsJapgolly.awsSdk.importexportMod.Job]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type apiVersion = typingsJapgolly.awsSdk.importexportMod._apiVersion | java.lang.String
