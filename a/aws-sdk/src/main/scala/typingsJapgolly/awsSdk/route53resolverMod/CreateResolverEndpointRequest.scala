...
trait CreateResolverEndpointRequest extends js.Object {
  /**
    ...
    */
  var CreatorRequestId: typingsJapgolly.awsSdk.route53resolverMod.CreatorRequestId = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityGroupIds: typingsJapgolly.awsSdk.route53resolverMod.SecurityGroupIds = js.native
  /**
