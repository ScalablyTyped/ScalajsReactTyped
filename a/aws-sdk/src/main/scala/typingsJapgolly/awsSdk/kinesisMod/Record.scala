...
trait Record extends js.Object {
  ...
  /**
    ...
    */
  var Data: typingsJapgolly.awsSdk.kinesisMod.Data = js.native
  /**
    ...
    */
  var EncryptionType: js.UndefOr[typingsJapgolly.awsSdk.kinesisMod.EncryptionType] = js.native
  /**
    * Identifies which shard in the stream the data record is assigned to.
    */
  var PartitionKey: typingsJapgolly.awsSdk.kinesisMod.PartitionKey = js.native
  /**
    * The unique identifier of the record within its shard.
    */
  var SequenceNumber: typingsJapgolly.awsSdk.kinesisMod.SequenceNumber = js.native
}
