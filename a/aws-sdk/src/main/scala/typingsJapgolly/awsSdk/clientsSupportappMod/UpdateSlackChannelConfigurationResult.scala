...
trait UpdateSlackChannelConfigurationResult extends StObject {
  ...
  /**
    ...
    */
  var channelId: js.UndefOr[typingsJapgolly.awsSdk.clientsSupportappMod.channelId] = js.undefined
  ...
  /**
    ...
    */
  var teamId: js.UndefOr[typingsJapgolly.awsSdk.clientsSupportappMod.teamId] = js.undefined
}
