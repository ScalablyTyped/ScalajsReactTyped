...
trait ExportSummary extends StObject {
  ...
  /**
    ...
    */
  var ExportArn: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ExportArn] = js.undefined
  
  /**
    * Export can be in one of the following states: IN_PROGRESS, COMPLETED, or FAILED.
    */
  var ExportStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ExportStatus] = js.undefined
}
