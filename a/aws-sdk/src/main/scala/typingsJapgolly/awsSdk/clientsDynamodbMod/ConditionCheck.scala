...
trait ConditionCheck extends StObject {
  ...
  /**
    ...
    */
  var ConditionExpression: typingsJapgolly.awsSdk.clientsDynamodbMod.ConditionExpression
  ...
  /**
    ...
    */
  var Key: typingsJapgolly.awsSdk.clientsDynamodbMod.Key
  
  /**
    * Use ReturnValuesOnConditionCheckFailure to get the item attributes if the ConditionCheck condition fails. For ReturnValuesOnConditionCheckFailure, the valid values are: NONE and ALL_OLD.
    */
  var ReturnValuesOnConditionCheckFailure: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ReturnValuesOnConditionCheckFailure] = js.undefined
