...
trait SSESpecification extends StObject {
  ...
  /**
    ...
    */
  var KMSMasterKeyId: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.KMSMasterKeyId] = js.undefined
  ...
  /**
    ...
    */
  var SSEType: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.SSEType] = js.undefined
}
