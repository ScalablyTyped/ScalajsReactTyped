...
trait TableDescription extends StObject {
  ...
  /**
    ...
    */
  var ArchivalSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ArchivalSummary] = js.undefined
  ...
  /**
    ...
    */
  var AttributeDefinitions: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.AttributeDefinitions] = js.undefined
  
  /**
    * Contains the details for the read/write capacity mode.
    */
  var BillingModeSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.BillingModeSummary] = js.undefined
  ...
  /**
    ...
    */
  var RestoreSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.RestoreSummary] = js.undefined
  
  /**
    * The description of the server-side encryption status on the specified table.
    */
  var SSEDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.SSEDescription] = js.undefined
  ...
  /**
    ...
    */
  var TableClassSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.TableClassSummary] = js.undefined
