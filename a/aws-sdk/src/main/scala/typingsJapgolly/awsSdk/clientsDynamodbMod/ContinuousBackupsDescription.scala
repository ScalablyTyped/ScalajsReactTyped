...
trait ContinuousBackupsDescription extends StObject {
  ...
  /**
    ...
    */
  var ContinuousBackupsStatus: typingsJapgolly.awsSdk.clientsDynamodbMod.ContinuousBackupsStatus
  
  /**
    * The description of the point in time recovery settings applied to the table.
    */
  var PointInTimeRecoveryDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.PointInTimeRecoveryDescription] = js.undefined
}
