...
trait DescribeContributorInsightsOutput extends StObject {
  ...
  /**
    ...
    */
  var ContributorInsightsRuleList: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ContributorInsightsRuleList] = js.undefined
  ...
  /**
    ...
    */
  var FailureException: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.FailureException] = js.undefined
