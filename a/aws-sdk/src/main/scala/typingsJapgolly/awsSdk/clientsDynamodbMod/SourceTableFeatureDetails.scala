...
trait SourceTableFeatureDetails extends StObject {
  ...
  /**
    ...
    */
  var GlobalSecondaryIndexes: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.GlobalSecondaryIndexes] = js.undefined
  
  /**
    * Represents the LSI properties for the table when the backup was created. It includes the IndexName, KeySchema and Projection for the LSIs on the table at the time of backup. 
    */
  var LocalSecondaryIndexes: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.LocalSecondaryIndexes] = js.undefined
