...
trait WriteRequest extends StObject {
  ...
  /**
    ...
    */
  var DeleteRequest: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.DeleteRequest] = js.undefined
  
  /**
    * A request to perform a PutItem operation.
    */
  var PutRequest: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.PutRequest] = js.undefined
}
object WriteRequest {
