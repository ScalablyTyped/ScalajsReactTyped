...
trait ExportTableToPointInTimeInput extends StObject {
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ClientToken] = js.undefined
  
  /**
    * The format for the exported data. Valid values for ExportFormat are DYNAMODB_JSON or ION.
    */
  var ExportFormat: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ExportFormat] = js.undefined
  ...
  /**
    ...
    */
  var S3Bucket: typingsJapgolly.awsSdk.clientsDynamodbMod.S3Bucket
  
  /**
    * The ID of the Amazon Web Services account that owns the bucket the export will be stored in.
    */
  var S3BucketOwner: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.S3BucketOwner] = js.undefined
  
  /**
    * The Amazon S3 bucket prefix to use as the file name and path of the exported snapshot.
    */
  var S3Prefix: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.S3Prefix] = js.undefined
  ...
  /**
    ...
    */
  var S3SseAlgorithm: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.S3SseAlgorithm] = js.undefined
  
  /**
    * The ID of the KMS managed key used to encrypt the S3 bucket where export data will be stored (if applicable).
    */
  var S3SseKmsKeyId: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.S3SseKmsKeyId] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) associated with the table to export.
    */
  var TableArn: typingsJapgolly.awsSdk.clientsDynamodbMod.TableArn
}
