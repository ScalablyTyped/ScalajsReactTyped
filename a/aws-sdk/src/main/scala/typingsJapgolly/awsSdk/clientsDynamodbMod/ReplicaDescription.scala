...
trait ReplicaDescription extends StObject {
  ...
  /**
    ...
    */
  var RegionName: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.RegionName] = js.undefined
  ...
  /**
    ...
    */
  var ReplicaStatusDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ReplicaStatusDescription] = js.undefined
  
  /**
    * Specifies the progress of a Create, Update, or Delete action on the replica as a percentage.
    */
  var ReplicaStatusPercentProgress: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ReplicaStatusPercentProgress] = js.undefined
