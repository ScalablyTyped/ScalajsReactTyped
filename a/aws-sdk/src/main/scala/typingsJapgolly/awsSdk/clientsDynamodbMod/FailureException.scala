...
trait FailureException extends StObject {
  ...
  /**
    ...
    */
  var ExceptionDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ExceptionDescription] = js.undefined
  
  /**
    * Exception name.
    */
  var ExceptionName: js.UndefOr[typingsJapgolly.awsSdk.clientsDynamodbMod.ExceptionName] = js.undefined
}
