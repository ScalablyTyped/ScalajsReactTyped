...
trait ImportTableInput extends StObject {
  ...
  /**
    ...
    */
  var InputFormat: typingsJapgolly.awsSdk.clientsDynamodbMod.InputFormat
  ...
  /**
    ...
    */
  var S3BucketSource: typingsJapgolly.awsSdk.clientsDynamodbMod.S3BucketSource
  
  /**
    * Parameters for the table to import the data into. 
    */
  var TableCreationParameters: typingsJapgolly.awsSdk.clientsDynamodbMod.TableCreationParameters
}
