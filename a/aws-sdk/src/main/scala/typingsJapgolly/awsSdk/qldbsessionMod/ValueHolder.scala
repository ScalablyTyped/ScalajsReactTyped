...
trait ValueHolder extends js.Object {
  /**
    ...
    */
  var IonBinary: js.UndefOr[typingsJapgolly.awsSdk.qldbsessionMod.IonBinary] = js.native
  /**
    * An Amazon Ion plaintext value contained in a ValueHolder structure. 
    */
  var IonText: js.UndefOr[typingsJapgolly.awsSdk.qldbsessionMod.IonText] = js.native
}
