...
trait CommitTransactionRequest extends js.Object {
  /**
    ...
    */
  var CommitDigest: typingsJapgolly.awsSdk.qldbsessionMod.CommitDigest = js.native
  /**
    * Specifies the transaction id of the transaction to commit.
    */
  var TransactionId: typingsJapgolly.awsSdk.qldbsessionMod.TransactionId = js.native
}
