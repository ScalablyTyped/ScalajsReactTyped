...
trait CreateHomeRegionControlRequest extends js.Object {
  /**
    ...
    */
  var DryRun: js.UndefOr[typingsJapgolly.awsSdk.migrationhubconfigMod.DryRun] = js.native
  /**
    * The name of the home region of the calling account.
    */
  var HomeRegion: typingsJapgolly.awsSdk.migrationhubconfigMod.HomeRegion = js.native
  /**
    * The account for which this command sets up a home region control. The Target is always of type ACCOUNT.
    */
  var Target: typingsJapgolly.awsSdk.migrationhubconfigMod.Target = js.native
}
