...
trait RegisterAppInstanceUserEndpointRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientRequestToken: typingsJapgolly.awsSdk.clientsChimesdkidentityMod.ClientRequestToken
  
  /**
    * The attributes of an Endpoint.
    */
  var EndpointAttributes: typingsJapgolly.awsSdk.clientsChimesdkidentityMod.EndpointAttributes
