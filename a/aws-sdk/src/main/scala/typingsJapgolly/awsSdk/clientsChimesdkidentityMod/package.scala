...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.INVALID_DEVICE_TOKEN
  - typingsJapgolly.awsSdk.awsSdkStrings.INVALID_PINPOINT_ARN
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.`2021-04-20`
