...
trait UpdateAppInstanceUserEndpointResponse extends StObject {
...
object UpdateAppInstanceUserEndpointResponse {
  ...
  inline def apply(): UpdateAppInstanceUserEndpointResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateAppInstanceUserEndpointResponse]
  }
  
  extension [Self <: UpdateAppInstanceUserEndpointResponse](x: Self) {
