...
trait Activity extends js.Object {
  /**
    ...
    */
  var CommentMetadata: js.UndefOr[typingsJapgolly.awsSdk.workdocsMod.CommentMetadata] = js.native
  /**
  ...
  /**
    ...
    */
  var Participants: js.UndefOr[typingsJapgolly.awsSdk.workdocsMod.Participants] = js.native
  /**
    * The metadata of the resource involved in the user action.
    */
  var ResourceMetadata: js.UndefOr[typingsJapgolly.awsSdk.workdocsMod.ResourceMetadata] = js.native
  /**
