...
trait Invite extends js.Object {
  /**
    ...
    */
  var EmailAddress: js.UndefOr[typingsJapgolly.awsSdk.chimeMod.EmailAddress] = js.native
  /**
    * The status of the invite email.
    */
  var EmailStatus: js.UndefOr[typingsJapgolly.awsSdk.chimeMod.EmailStatus] = js.native
  /**
    * The invite ID.
    */
