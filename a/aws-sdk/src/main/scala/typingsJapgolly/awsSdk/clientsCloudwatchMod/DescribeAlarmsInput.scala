...
trait DescribeAlarmsInput extends StObject {
  ...
  /**
    ...
    */
  var ActionPrefix: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.ActionPrefix] = js.undefined
  ...
  /**
    ...
    */
  var AlarmNamePrefix: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.AlarmNamePrefix] = js.undefined
  
  /**
    * The names of the alarms to retrieve information about.
    */
  var AlarmNames: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.AlarmNames] = js.undefined
  
  /**
    * Use this parameter to specify whether you want the operation to return metric alarms or composite alarms. If you omit this parameter, only metric alarms are returned.
    */
  var AlarmTypes: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.AlarmTypes] = js.undefined
  ...
  /**
    ...
    */
  var MaxRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.MaxRecords] = js.undefined
