...
trait GetMetricStatisticsInput extends StObject {
  ...
  /**
    ...
    */
  var ExtendedStatistics: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.ExtendedStatistics] = js.undefined
  
  /**
    * The name of the metric, with or without spaces.
    */
  var MetricName: typingsJapgolly.awsSdk.clientsCloudwatchMod.MetricName
  ...
  /**
    ...
    */
  var Period: typingsJapgolly.awsSdk.clientsCloudwatchMod.Period
  ...
  /**
    ...
    */
  var Statistics: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.Statistics] = js.undefined
