...
trait DashboardValidationMessage extends StObject {
  ...
  /**
    ...
    */
  var DataPath: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.DataPath] = js.undefined
  
  /**
    * A message describing the error or warning.
    */
  var Message: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.Message] = js.undefined
}
