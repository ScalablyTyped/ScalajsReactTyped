...
trait GetDashboardOutput extends StObject {
  ...
  /**
    ...
    */
  var DashboardArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.DashboardArn] = js.undefined
  ...
  /**
    ...
    */
  var DashboardBody: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.DashboardBody] = js.undefined
  
  /**
    * The name of the dashboard.
    */
  var DashboardName: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.DashboardName] = js.undefined
}
