...
trait MetricAlarm extends StObject {
  ...
  /**
    ...
    */
  var ActionsEnabled: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.ActionsEnabled] = js.undefined
  ...
  /**
    ...
    */
  var AlarmArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.AlarmArn] = js.undefined
  ...
  /**
    ...
    */
  var AlarmDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.AlarmDescription] = js.undefined
  
  /**
    * The name of the alarm.
    */
  var AlarmName: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.AlarmName] = js.undefined
  
  /**
    * The arithmetic operation to use when comparing the specified statistic and threshold. The specified statistic value is used as the first operand.
    */
  var ComparisonOperator: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.ComparisonOperator] = js.undefined
  
  /**
    * The number of data points that must be breaching to trigger the alarm.
    */
  var DatapointsToAlarm: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.DatapointsToAlarm] = js.undefined
  
  /**
    * The dimensions for the metric associated with the alarm.
    */
  var Dimensions: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.Dimensions] = js.undefined
  
  /**
    * Used only for alarms based on percentiles. If ignore, the alarm state does not change during periods with too few data points to be statistically significant. If evaluate or this parameter is not used, the alarm is always evaluated and possibly changes state no matter how many data points are available.
    */
  var EvaluateLowSampleCountPercentile: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.EvaluateLowSampleCountPercentile] = js.undefined
  
  /**
    * The number of periods over which data is compared to the specified threshold.
    */
  var EvaluationPeriods: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.EvaluationPeriods] = js.undefined
  
  /**
    * The percentile statistic for the metric associated with the alarm. Specify a value between p0.0 and p100.
    */
  var ExtendedStatistic: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.ExtendedStatistic] = js.undefined
  ...
  /**
    ...
    */
  var MetricName: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.MetricName] = js.undefined
  ...
  /**
    ...
    */
  var Namespace: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.Namespace] = js.undefined
  ...
  /**
    ...
    */
  var Period: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.Period] = js.undefined
  
  /**
    * An explanation for the alarm state, in text format.
    */
  var StateReason: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.StateReason] = js.undefined
  
  /**
    * An explanation for the alarm state, in JSON format.
    */
  var StateReasonData: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.StateReasonData] = js.undefined
  ...
  /**
    ...
    */
  var StateValue: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.StateValue] = js.undefined
  
  /**
    * The statistic for the metric associated with the alarm, other than percentile. For percentile statistics, use ExtendedStatistic.
    */
  var Statistic: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.Statistic] = js.undefined
  
  /**
    * The value to compare with the specified statistic.
    */
  var Threshold: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.Threshold] = js.undefined
  ...
  /**
    ...
    */
  var TreatMissingData: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.TreatMissingData] = js.undefined
