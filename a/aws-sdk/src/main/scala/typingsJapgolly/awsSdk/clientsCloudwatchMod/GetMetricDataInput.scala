...
trait GetMetricDataInput extends StObject {
  ...
  /**
    ...
    */
  var LabelOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.LabelOptions] = js.undefined
  ...
  /**
    ...
    */
  var MetricDataQueries: typingsJapgolly.awsSdk.clientsCloudwatchMod.MetricDataQueries
