...
trait PartialFailure extends StObject {
  ...
  /**
    * The type of error.
    */
  var ExceptionType: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.ExceptionType] = js.undefined
  
  /**
    * The code of the error.
    */
  var FailureCode: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.FailureCode] = js.undefined
  
  /**
    * A description of the error.
    */
  var FailureDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.FailureDescription] = js.undefined
  
  /**
    * The specified rule that could not be deleted.
    */
  var FailureResource: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.FailureResource] = js.undefined
}
