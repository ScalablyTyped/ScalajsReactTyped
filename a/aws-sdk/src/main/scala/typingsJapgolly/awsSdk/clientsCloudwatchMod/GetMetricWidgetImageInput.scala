...
trait GetMetricWidgetImageInput extends StObject {
  ...
  /**
    ...
    */
  var MetricWidget: typingsJapgolly.awsSdk.clientsCloudwatchMod.MetricWidget
  ...
  /**
    ...
    */
  var OutputFormat: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatchMod.OutputFormat] = js.undefined
}
