...
trait ParameterRange extends js.Object {
  /**
    ...
    */
  var CategoricalParameterRangeSpecification: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.CategoricalParameterRangeSpecification] = js.native
  /**
    * A ContinuousParameterRangeSpecification object that defines the possible values for a continuous hyperparameter.
    */
  var ContinuousParameterRangeSpecification: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.ContinuousParameterRangeSpecification] = js.native
  /**
    * A IntegerParameterRangeSpecification object that defines the possible values for an integer hyperparameter.
    */
  var IntegerParameterRangeSpecification: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.IntegerParameterRangeSpecification] = js.native
}
