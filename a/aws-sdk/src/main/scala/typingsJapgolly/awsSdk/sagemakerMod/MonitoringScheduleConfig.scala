...
trait MonitoringScheduleConfig extends js.Object {
  /**
    ...
    */
  var MonitoringJobDefinition: typingsJapgolly.awsSdk.sagemakerMod.MonitoringJobDefinition = js.native
  /**
    * Configures the monitoring schedule.
    */
  var ScheduleConfig: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.ScheduleConfig] = js.native
}
