...
trait AutoMLJobCompletionCriteria extends js.Object {
  /**
    ...
    */
  var MaxAutoMLJobRuntimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxAutoMLJobRuntimeInSeconds] = js.native
  /**
    * The maximum number of times a training job is allowed to run.
    */
  var MaxCandidates: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxCandidates] = js.native
  /**
    * The maximum time, in seconds, a job is allowed to run.
    */
  var MaxRuntimePerTrainingJobInSeconds: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxRuntimePerTrainingJobInSeconds] = js.native
}
