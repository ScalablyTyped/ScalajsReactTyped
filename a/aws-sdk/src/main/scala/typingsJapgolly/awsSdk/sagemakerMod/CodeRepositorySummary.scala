...
trait CodeRepositorySummary extends js.Object {
  /**
    ...
    */
  var CodeRepositoryArn: typingsJapgolly.awsSdk.sagemakerMod.CodeRepositoryArn = js.native
  /**
  ...
  /**
    ...
    */
  var GitConfig: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.GitConfig] = js.native
  /**
