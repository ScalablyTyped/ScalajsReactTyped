...
trait DescribeNotebookInstanceOutput extends js.Object {
  ...
  /**
    ...
    */
  var DirectInternetAccess: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.DirectInternetAccess] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceType: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.InstanceType] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkInterfaceId: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.NetworkInterfaceId] = js.native
  /**
    * The Amazon Resource Name (ARN) of the notebook instance.
    */
  var NotebookInstanceArn: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.NotebookInstanceArn] = js.native
  /**
  ...
  /**
    ...
    */
  var NotebookInstanceName: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.NotebookInstanceName] = js.native
  /**
    * The status of the notebook instance.
    */
  var NotebookInstanceStatus: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.NotebookInstanceStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var RootAccess: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.RootAccess] = js.native
  /**
  ...
  /**
    ...
    */
  var SubnetId: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.SubnetId] = js.native
  /**
