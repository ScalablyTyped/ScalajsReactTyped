...
trait GitConfig extends js.Object {
  /**
    ...
    */
  var Branch: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.Branch] = js.native
  /**
  ...
  /**
    ...
    */
  var SecretArn: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.SecretArn] = js.native
}
