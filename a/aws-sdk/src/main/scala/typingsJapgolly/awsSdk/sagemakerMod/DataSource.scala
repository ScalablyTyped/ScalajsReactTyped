...
trait DataSource extends js.Object {
  /**
    ...
    */
  var FileSystemDataSource: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.FileSystemDataSource] = js.native
  /**
    * The S3 location of the data source that is associated with a channel.
    */
  var S3DataSource: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.S3DataSource] = js.native
}
