...
trait StoppingCondition extends js.Object {
  /**
    ...
    */
  var MaxRuntimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxRuntimeInSeconds] = js.native
  /**
    ...
    */
  var MaxWaitTimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxWaitTimeInSeconds] = js.native
}
