...
trait DescribeTransformJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var BatchStrategy: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.BatchStrategy] = js.native
  /**
    * A timestamp that shows when the transform Job was created.
    */
  var CreationTime: js.Date = js.native
  var DataProcessing: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.DataProcessing] = js.native
  /**
  ...
  /**
    ...
    */
  var MaxConcurrentTransforms: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxConcurrentTransforms] = js.native
  /**
    * The maximum payload size, in MB, used in the transform job.
    */
  var MaxPayloadInMB: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxPayloadInMB] = js.native
  /**
  ...
  /**
    ...
    */
  var TransformInput: typingsJapgolly.awsSdk.sagemakerMod.TransformInput = js.native
  /**
  ...
  /**
    ...
    */
  var TransformOutput: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.TransformOutput] = js.native
  /**
    * Describes the resources, including ML instance types and ML instance count, to use for the transform job.
    */
  var TransformResources: typingsJapgolly.awsSdk.sagemakerMod.TransformResources = js.native
  /**
