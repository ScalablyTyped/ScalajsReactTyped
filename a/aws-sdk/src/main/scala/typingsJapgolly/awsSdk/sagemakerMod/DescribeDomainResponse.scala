...
trait DescribeDomainResponse extends js.Object {
  /**
    ...
    */
  var AuthMode: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.AuthMode] = js.native
  /**
    * The creation time.
    */
  ...
  /**
    ...
    */
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.VpcId] = js.native
}
