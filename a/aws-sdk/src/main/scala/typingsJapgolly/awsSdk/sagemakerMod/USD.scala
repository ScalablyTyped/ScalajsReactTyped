...
trait USD extends js.Object {
  /**
    ...
    */
  var Cents: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.Cents] = js.native
  /**
    * The whole number of dollars in the amount.
    */
  var Dollars: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.Dollars] = js.native
  /**
    * Fractions of a cent, in tenths.
    */
  var TenthFractionsOfACent: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.TenthFractionsOfACent] = js.native
}
