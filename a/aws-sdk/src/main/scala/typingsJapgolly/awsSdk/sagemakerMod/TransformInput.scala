...
trait TransformInput extends js.Object {
  /**
    ...
    */
  var CompressionType: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.CompressionType] = js.native
  /**
    * The multipurpose internet mail extension (MIME) type of the data. Amazon SageMaker uses the MIME type with each http call to transfer data to the transform job.
    */
  var ContentType: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.ContentType] = js.native
  /**
  ...
  /**
    ...
    */
  var SplitType: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.SplitType] = js.native
}
