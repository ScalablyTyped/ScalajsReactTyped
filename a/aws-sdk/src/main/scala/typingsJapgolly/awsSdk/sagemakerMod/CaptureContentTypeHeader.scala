...
trait CaptureContentTypeHeader extends js.Object {
  /**
    * 
    */
  var CsvContentTypes: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.CsvContentTypes] = js.native
  /**
    * 
    */
  var JsonContentTypes: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.JsonContentTypes] = js.native
}
