...
trait UpdateWorkteamRequest extends js.Object {
  ...
  /**
    ...
    */
  var MemberDefinitions: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MemberDefinitions] = js.native
  /**
    * Configures SNS topic notifications for available or expiring work items
    */
  var NotificationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.NotificationConfiguration] = js.native
  /**
