...
trait LabelingJobStoppingConditions extends js.Object {
  /**
    ...
    */
  var MaxHumanLabeledObjectCount: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxHumanLabeledObjectCount] = js.native
  /**
    * The maximum number of input data objects that should be labeled.
    */
  var MaxPercentageOfInputDatasetLabeled: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxPercentageOfInputDatasetLabeled] = js.native
}
