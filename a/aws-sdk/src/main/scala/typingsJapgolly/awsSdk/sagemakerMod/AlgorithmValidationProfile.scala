...
trait AlgorithmValidationProfile extends js.Object {
  ...
  /**
    ...
    */
  var TrainingJobDefinition: typingsJapgolly.awsSdk.sagemakerMod.TrainingJobDefinition = js.native
  /**
    * The TransformJobDefinition object that describes the transform job that Amazon SageMaker runs to validate your algorithm.
    */
  var TransformJobDefinition: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.TransformJobDefinition] = js.native
}
