...
trait InputConfig extends js.Object {
  /**
    ...
    */
  var DataInputConfig: typingsJapgolly.awsSdk.sagemakerMod.DataInputConfig = js.native
  /**
    * Identifies the framework in which the model was trained. For example: TENSORFLOW.
    */
  var Framework: typingsJapgolly.awsSdk.sagemakerMod.Framework = js.native
  /**
    * The S3 path where the model artifacts, which result from model training, are stored. This path must point to a single gzip compressed tar archive (.tar.gz suffix).
    */
  var S3Uri: typingsJapgolly.awsSdk.sagemakerMod.S3Uri = js.native
}
