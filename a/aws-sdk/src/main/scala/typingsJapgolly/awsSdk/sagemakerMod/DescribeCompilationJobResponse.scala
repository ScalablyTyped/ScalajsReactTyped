...
trait DescribeCompilationJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var FailureReason: typingsJapgolly.awsSdk.sagemakerMod.FailureReason = js.native
  /**
    * Information about the location in Amazon S3 of the input model artifacts, the name and shape of the expected data inputs, and the framework in which the model was trained.
    */
  var InputConfig: typingsJapgolly.awsSdk.sagemakerMod.InputConfig = js.native
  /**
  ...
  /**
    ...
    */
  var ModelArtifacts: typingsJapgolly.awsSdk.sagemakerMod.ModelArtifacts = js.native
  /**
    * Information about the output location for the compiled model and the target device that the model runs on.
    */
  var OutputConfig: typingsJapgolly.awsSdk.sagemakerMod.OutputConfig = js.native
  /**
