...
trait AutoMLJobArtifacts extends js.Object {
  /**
    ...
    */
  var CandidateDefinitionNotebookLocation: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.CandidateDefinitionNotebookLocation] = js.native
  /**
    * The URL to the notebook location.
    */
  var DataExplorationNotebookLocation: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.DataExplorationNotebookLocation] = js.native
}
