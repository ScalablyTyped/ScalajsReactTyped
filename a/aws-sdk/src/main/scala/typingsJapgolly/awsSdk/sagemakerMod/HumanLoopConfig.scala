...
trait HumanLoopConfig extends js.Object {
  /**
    ...
    */
  var HumanTaskUiArn: typingsJapgolly.awsSdk.sagemakerMod.HumanTaskUiArn = js.native
  var PublicWorkforceTaskPrice: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.PublicWorkforceTaskPrice] = js.native
  /**
  ...
  /**
    ...
    */
  var WorkteamArn: typingsJapgolly.awsSdk.sagemakerMod.WorkteamArn = js.native
}
