...
trait DebugHookConfig extends js.Object {
  /**
    ...
    */
  var CollectionConfigurations: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.CollectionConfigurations] = js.native
  /**
    * Configuration information for the debug hook parameters.
    */
  var HookParameters: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.HookParameters] = js.native
  /**
