...
trait ResourceLimits extends js.Object {
  /**
    ...
    */
  var MaxNumberOfTrainingJobs: typingsJapgolly.awsSdk.sagemakerMod.MaxNumberOfTrainingJobs = js.native
  /**
    * The maximum number of concurrent training jobs that a hyperparameter tuning job can launch.
    */
  var MaxParallelTrainingJobs: typingsJapgolly.awsSdk.sagemakerMod.MaxParallelTrainingJobs = js.native
}
