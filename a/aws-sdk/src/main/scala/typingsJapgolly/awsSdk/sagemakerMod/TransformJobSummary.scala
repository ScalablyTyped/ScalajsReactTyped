...
trait TransformJobSummary extends js.Object {
  ...
  /**
    ...
    */
  var TransformJobArn: typingsJapgolly.awsSdk.sagemakerMod.TransformJobArn = js.native
  /**
  ...
  /**
    ...
    */
  var TransformJobStatus: typingsJapgolly.awsSdk.sagemakerMod.TransformJobStatus = js.native
}
