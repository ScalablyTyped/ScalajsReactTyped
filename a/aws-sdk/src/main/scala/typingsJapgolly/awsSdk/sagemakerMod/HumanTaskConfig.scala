...
trait HumanTaskConfig extends js.Object {
  /**
    ...
    */
  var AnnotationConsolidationConfig: typingsJapgolly.awsSdk.sagemakerMod.AnnotationConsolidationConfig = js.native
  /**
    ...
    */
  var MaxConcurrentTaskCount: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.MaxConcurrentTaskCount] = js.native
  /**
    * The number of human workers that will label an object. 
    */
  var NumberOfHumanWorkersPerDataObject: typingsJapgolly.awsSdk.sagemakerMod.NumberOfHumanWorkersPerDataObject = js.native
  /**
  ...
  /**
    ...
    */
  var TaskAvailabilityLifetimeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.TaskAvailabilityLifetimeInSeconds] = js.native
  /**
    * A description of the task for your human workers.
    */
  var TaskDescription: typingsJapgolly.awsSdk.sagemakerMod.TaskDescription = js.native
  /**
    * Keywords used to describe the task so that workers on Amazon Mechanical Turk can discover the task.
    */
  var TaskKeywords: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.TaskKeywords] = js.native
  /**
    * The amount of time that a worker has to complete a task.
    */
  var TaskTimeLimitInSeconds: typingsJapgolly.awsSdk.sagemakerMod.TaskTimeLimitInSeconds = js.native
  /**
    * A title for the task for your human workers.
    */
  var TaskTitle: typingsJapgolly.awsSdk.sagemakerMod.TaskTitle = js.native
  /**
    * Information about the user interface that workers use to complete the labeling task.
    */
  var UiConfig: typingsJapgolly.awsSdk.sagemakerMod.UiConfig = js.native
  /**
