...
trait DescribeLabelingJobResponse extends js.Object {
  ...
  /**
    ...
    */
  var LabelAttributeName: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.LabelAttributeName] = js.native
  /**
  ...
  /**
    ...
    */
  var LabelCounters: typingsJapgolly.awsSdk.sagemakerMod.LabelCounters = js.native
  /**
  ...
  /**
    ...
    */
  var LabelingJobArn: typingsJapgolly.awsSdk.sagemakerMod.LabelingJobArn = js.native
  /**
  ...
  /**
    ...
    */
  var LabelingJobOutput: js.UndefOr[typingsJapgolly.awsSdk.sagemakerMod.LabelingJobOutput] = js.native
  /**
    * The processing status of the labeling job. 
    */
  var LabelingJobStatus: typingsJapgolly.awsSdk.sagemakerMod.LabelingJobStatus = js.native
  /**
