...
trait AutoMLCandidateStep extends js.Object {
  /**
    ...
    */
  var CandidateStepArn: typingsJapgolly.awsSdk.sagemakerMod.CandidateStepArn = js.native
  /**
    * The name for the Candidate's step.
    */
  var CandidateStepName: typingsJapgolly.awsSdk.sagemakerMod.CandidateStepName = js.native
  /**
    * Whether the Candidate is at the transform, training, or processing step.
    */
  var CandidateStepType: typingsJapgolly.awsSdk.sagemakerMod.CandidateStepType = js.native
}
