...
trait HumanLoopActivationConfig extends js.Object {
  /**
    ...
    */
  var HumanLoopActivationConditionsConfig: typingsJapgolly.awsSdk.sagemakerMod.HumanLoopActivationConditionsConfig = js.native
  /**
    * Container for configuring the source of human task requests.
    */
  var HumanLoopRequestSource: typingsJapgolly.awsSdk.sagemakerMod.HumanLoopRequestSource = js.native
}
