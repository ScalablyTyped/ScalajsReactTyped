...
trait DescribeLunaClientResponse extends StObject {
  ...
  /**
    ...
    */
  var Certificate: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmMod.Certificate] = js.undefined
  
  /**
    * The certificate fingerprint.
    */
  var CertificateFingerprint: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmMod.CertificateFingerprint] = js.undefined
  
  /**
    * The ARN of the client.
    */
  var ClientArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmMod.ClientArn] = js.undefined
  
  /**
    * The label of the client.
    */
  var Label: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmMod.Label] = js.undefined
