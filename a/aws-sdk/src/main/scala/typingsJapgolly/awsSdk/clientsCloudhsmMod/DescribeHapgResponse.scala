...
trait DescribeHapgResponse extends StObject {
  ...
  /**
    ...
    */
  var HapgArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmMod.HapgArn] = js.undefined
  ...
  /**
    ...
    */
  var PartitionSerialList: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmMod.PartitionSerialList] = js.undefined
