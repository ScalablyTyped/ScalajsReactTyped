...
trait LoadBalancer extends js.Object {
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.AvailabilityZones] = js.native
  /**
    * The ID of the Amazon Route 53 hosted zone associated with the load balancer.
    */
  var CanonicalHostedZoneId: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.CanonicalHostedZoneId] = js.native
  /**
  ...
  /**
    ...
    */
  var DNSName: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.DNSName] = js.native
  /**
    * The type of IP addresses used by the subnets for your load balancer. The possible values are ipv4 (for IPv4 addresses) and dualstack (for IPv4 and IPv6 addresses).
    */
  var IpAddressType: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.IpAddressType] = js.native
  /**
  ...
  /**
    ...
    */
  var LoadBalancerName: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.LoadBalancerName] = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityGroups: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.SecurityGroups] = js.native
  /**
