...
trait AvailabilityZone extends js.Object {
  /**
    ...
    */
  var LoadBalancerAddresses: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.LoadBalancerAddresses] = js.native
  /**
    * The ID of the subnet. You can specify one subnet per Availability Zone.
    */
  var SubnetId: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.SubnetId] = js.native
  /**
    * The name of the Availability Zone.
    */
  var ZoneName: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.ZoneName] = js.native
}
