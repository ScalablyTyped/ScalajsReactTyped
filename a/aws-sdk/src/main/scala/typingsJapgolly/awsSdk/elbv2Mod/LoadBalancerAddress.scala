...
trait LoadBalancerAddress extends js.Object {
  /**
    ...
    */
  var AllocationId: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.AllocationId] = js.native
  /**
    * The static IP address.
    */
  var IpAddress: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.IpAddress] = js.native
  /**
    * [Network Load Balancers] The private IPv4 address for an internal load balancer.
    */
  var PrivateIPv4Address: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.PrivateIPv4Address] = js.native
}
