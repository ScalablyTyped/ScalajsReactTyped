...
trait SslPolicy extends js.Object {
  /**
    * The ciphers.
    */
  var Ciphers: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.Ciphers] = js.native
  /**
  ...
  /**
    * The protocols.
    */
  var SslProtocols: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.SslProtocols] = js.native
}
