...
trait DescribeRulesInput extends js.Object {
  /**
    ...
    */
  var ListenerArn: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.ListenerArn] = js.native
  /**
  ...
  /**
    ...
    */
  var RuleArns: js.UndefOr[typingsJapgolly.awsSdk.elbv2Mod.RuleArns] = js.native
}
