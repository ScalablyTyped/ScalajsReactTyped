...
import typingsJapgolly.awsSdk.anon.ConfigurationOptionskeyst
import typingsJapgolly.awsSdk.awsSdkBooleans.`false`
...
object libConfigBaseMod {
  ...
  trait HTTPOptions extends StObject {
    ...
    /**
      ...
      */
    var agent: js.UndefOr[Agent | typingsJapgolly.node.httpsMod.Agent] = js.undefined
  ...
  object Logger {
    ...
    extension [Self <: Logger](x: Self) {
      ...
      inline def setWrite(
        value: (/* chunk */ Any, /* encoding */ js.UndefOr[String], /* callback */ js.UndefOr[js.Function0[Unit]]) => Callback
      ): Self = StObject.set(x, "write", js.Any.fromFunction3((t0: /* chunk */ Any, t1: /* encoding */ js.UndefOr[String], t2: /* callback */ js.UndefOr[js.Function0[Unit]]) => (value(t0, t1, t2)).runNow()))
