...
trait JobDescriptor extends js.Object {
  /**
    ...
    */
  var ConfirmationRequired: js.UndefOr[typingsJapgolly.awsSdk.s3controlMod.ConfirmationRequired] = js.native
  /**
  ...
  /**
    ...
    */
  var JobArn: js.UndefOr[typingsJapgolly.awsSdk.s3controlMod.JobArn] = js.native
  /**
    * The ID for the specified job.
    */
  var JobId: js.UndefOr[typingsJapgolly.awsSdk.s3controlMod.JobId] = js.native
  /**
  ...
  /**
    ...
    */
  var SuspendedCause: js.UndefOr[typingsJapgolly.awsSdk.s3controlMod.SuspendedCause] = js.native
  /**
