...
trait GetAccessPointResult extends js.Object {
  ...
  /**
    ...
    */
  var NetworkOrigin: js.UndefOr[typingsJapgolly.awsSdk.s3controlMod.NetworkOrigin] = js.native
  var PublicAccessBlockConfiguration: js.UndefOr[typingsJapgolly.awsSdk.s3controlMod.PublicAccessBlockConfiguration] = js.native
  /**
    * Contains the Virtual Private Cloud (VPC) configuration for the specified access point.
    */
  var VpcConfiguration: js.UndefOr[typingsJapgolly.awsSdk.s3controlMod.VpcConfiguration] = js.native
}
