...
package object wafregionalMod {
  ...
  type ActivatedRules = js.Array[typingsJapgolly.awsSdk.wafregionalMod.ActivatedRule]
  type ByteMatchSetSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.ByteMatchSetSummary]
  type ByteMatchSetUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.ByteMatchSetUpdate]
  type ByteMatchTargetString = typingsJapgolly.node.Buffer | scala.scalajs.js.typedarray.Uint8Array | typingsJapgolly.awsSdk.wafregionalMod.Blob | java.lang.String
  type ByteMatchTuples = js.Array[typingsJapgolly.awsSdk.wafregionalMod.ByteMatchTuple]
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdk.awsSdkStrings.INSERT
    - typingsJapgolly.awsSdk.awsSdkStrings.DELETE
    - java.lang.String
  */
  type ChangeAction = typingsJapgolly.awsSdk.wafregionalMod._ChangeAction | java.lang.String
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ChangeTokenStatus = typingsJapgolly.awsSdk.wafregionalMod._ChangeTokenStatus | java.lang.String
  type ClientConfiguration = typingsJapgolly.awsSdk.serviceMod.ServiceConfigurationOptions with typingsJapgolly.awsSdk.wafregionalMod.ClientApiVersions
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ComparisonOperator = typingsJapgolly.awsSdk.wafregionalMod._ComparisonOperator | java.lang.String
  type Country = java.lang.String
  type ExcludedRules = js.Array[typingsJapgolly.awsSdk.wafregionalMod.ExcludedRule]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type GeoMatchConstraintValue = typingsJapgolly.awsSdk.wafregionalMod._GeoMatchConstraintValue | java.lang.String
  type GeoMatchConstraints = js.Array[typingsJapgolly.awsSdk.wafregionalMod.GeoMatchConstraint]
  type GeoMatchSetSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.GeoMatchSetSummary]
  type GeoMatchSetUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.GeoMatchSetUpdate]
  type GetSampledRequestsMaxItems = scala.Double
  type HTTPHeaders = js.Array[typingsJapgolly.awsSdk.wafregionalMod.HTTPHeader]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type IPSetDescriptorType = typingsJapgolly.awsSdk.wafregionalMod._IPSetDescriptorType | java.lang.String
  type IPSetDescriptorValue = java.lang.String
  type IPSetDescriptors = js.Array[typingsJapgolly.awsSdk.wafregionalMod.IPSetDescriptor]
  type IPSetSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.IPSetSummary]
  type IPSetUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.IPSetUpdate]
  type IPString = java.lang.String
  type LogDestinationConfigs = js.Array[typingsJapgolly.awsSdk.wafregionalMod.ResourceArn]
  type LoggingConfigurations = js.Array[typingsJapgolly.awsSdk.wafregionalMod.LoggingConfiguration]
  type ManagedKey = java.lang.String
  type ManagedKeys = js.Array[typingsJapgolly.awsSdk.wafregionalMod.ManagedKey]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type MatchFieldType = typingsJapgolly.awsSdk.wafregionalMod._MatchFieldType | java.lang.String
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type PositionalConstraint = typingsJapgolly.awsSdk.wafregionalMod._PositionalConstraint | java.lang.String
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type PredicateType = typingsJapgolly.awsSdk.wafregionalMod._PredicateType | java.lang.String
  type Predicates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.Predicate]
  type RateKey = typingsJapgolly.awsSdk.awsSdkStrings.IP | java.lang.String
  type RateLimit = scala.Double
  type RedactedFields = js.Array[typingsJapgolly.awsSdk.wafregionalMod.FieldToMatch]
  type RegexMatchSetSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RegexMatchSetSummary]
  type RegexMatchSetUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RegexMatchSetUpdate]
  type RegexMatchTuples = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RegexMatchTuple]
  type RegexPatternSetSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RegexPatternSetSummary]
  type RegexPatternSetUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RegexPatternSetUpdate]
  type RegexPatternString = java.lang.String
  type RegexPatternStrings = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RegexPatternString]
  type ResourceArn = java.lang.String
  type ResourceArns = js.Array[typingsJapgolly.awsSdk.wafregionalMod.ResourceArn]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type ResourceType = typingsJapgolly.awsSdk.wafregionalMod._ResourceType | java.lang.String
  type RuleGroupSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RuleGroupSummary]
  type RuleGroupUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RuleGroupUpdate]
  type RulePriority = scala.Double
  type RuleSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RuleSummary]
  type RuleUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.RuleUpdate]
  type SampleWeight = scala.Double
  type SampledHTTPRequests = js.Array[typingsJapgolly.awsSdk.wafregionalMod.SampledHTTPRequest]
  type Size = scala.Double
  type SizeConstraintSetSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.SizeConstraintSetSummary]
  type SizeConstraintSetUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.SizeConstraintSetUpdate]
  type SizeConstraints = js.Array[typingsJapgolly.awsSdk.wafregionalMod.SizeConstraint]
  type SqlInjectionMatchSetSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.SqlInjectionMatchSetSummary]
  type SqlInjectionMatchSetUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.SqlInjectionMatchSetUpdate]
  type SqlInjectionMatchTuples = js.Array[typingsJapgolly.awsSdk.wafregionalMod.SqlInjectionMatchTuple]
  type SubscribedRuleGroupSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.SubscribedRuleGroupSummary]
  type TagKey = java.lang.String
  type TagKeyList = js.Array[typingsJapgolly.awsSdk.wafregionalMod.TagKey]
  type TagList = js.Array[typingsJapgolly.awsSdk.wafregionalMod.Tag]
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type TextTransformation = typingsJapgolly.awsSdk.wafregionalMod._TextTransformation | java.lang.String
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type WafActionType = typingsJapgolly.awsSdk.wafregionalMod._WafActionType | java.lang.String
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdk.awsSdkStrings.NONE
    - typingsJapgolly.awsSdk.awsSdkStrings.COUNT
    - java.lang.String
  */
  type WafOverrideActionType = typingsJapgolly.awsSdk.wafregionalMod._WafOverrideActionType | java.lang.String
  /* Rewritten from type alias, can be one of: 
    ...
    - java.lang.String
  */
  type WafRuleType = typingsJapgolly.awsSdk.wafregionalMod._WafRuleType | java.lang.String
  type WebACLSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.WebACLSummary]
  type WebACLUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.WebACLUpdate]
  type XssMatchSetSummaries = js.Array[typingsJapgolly.awsSdk.wafregionalMod.XssMatchSetSummary]
  type XssMatchSetUpdates = js.Array[typingsJapgolly.awsSdk.wafregionalMod.XssMatchSetUpdate]
  type XssMatchTuples = js.Array[typingsJapgolly.awsSdk.wafregionalMod.XssMatchTuple]
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdk.awsSdkStrings.`2016-11-28`
    - typingsJapgolly.awsSdk.awsSdkStrings.latest_
    - java.lang.String
  */
  type apiVersion = typingsJapgolly.awsSdk.wafregionalMod._apiVersion | java.lang.String
}
