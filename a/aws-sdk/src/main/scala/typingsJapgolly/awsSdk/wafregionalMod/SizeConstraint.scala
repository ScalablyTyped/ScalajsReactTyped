...
trait SizeConstraint extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: typingsJapgolly.awsSdk.wafregionalMod.ComparisonOperator = js.native
  /**
    * Specifies where in a web request to look for the size constraint.
    */
  var FieldToMatch: typingsJapgolly.awsSdk.wafregionalMod.FieldToMatch = js.native
  /**
    ...
    */
  var Size: typingsJapgolly.awsSdk.wafregionalMod.Size = js.native
  /**
    ...
    */
  var TextTransformation: typingsJapgolly.awsSdk.wafregionalMod.TextTransformation = js.native
}
