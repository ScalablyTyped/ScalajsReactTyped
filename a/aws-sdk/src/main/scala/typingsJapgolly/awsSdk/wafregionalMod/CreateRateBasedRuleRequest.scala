...
trait CreateRateBasedRuleRequest extends js.Object {
  /**
    ...
    */
  var ChangeToken: typingsJapgolly.awsSdk.wafregionalMod.ChangeToken = js.native
  /**
    ...
    */
  var MetricName: typingsJapgolly.awsSdk.wafregionalMod.MetricName = js.native
  /**
  ...
  /**
    ...
    */
  var RateKey: typingsJapgolly.awsSdk.wafregionalMod.RateKey = js.native
  /**
    * The maximum number of requests, which have an identical value in the field that is specified by RateKey, allowed in a five-minute period. If the number of requests exceeds the RateLimit and the other predicates specified in the rule are also met, AWS WAF triggers the action that is specified for this rule.
    */
  var RateLimit: typingsJapgolly.awsSdk.wafregionalMod.RateLimit = js.native
