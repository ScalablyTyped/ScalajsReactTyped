...
trait UpdateRecordsRequest extends js.Object {
  /**
    ...
    */
  var ClientContext: js.UndefOr[typingsJapgolly.awsSdk.cognitosyncMod.ClientContext] = js.native
  /**
  ...
  /**
    ...
    */
  var SyncSessionToken: typingsJapgolly.awsSdk.cognitosyncMod.SyncSessionToken = js.native
}
