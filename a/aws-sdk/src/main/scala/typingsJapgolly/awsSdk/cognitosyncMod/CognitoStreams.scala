...
trait CognitoStreams extends js.Object {
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typingsJapgolly.awsSdk.cognitosyncMod.StreamName] = js.native
  /**
    ...
    */
  var StreamingStatus: js.UndefOr[typingsJapgolly.awsSdk.cognitosyncMod.StreamingStatus] = js.native
}
