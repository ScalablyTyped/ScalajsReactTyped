...
trait DomainJoinInfo extends StObject {
  ...
  /**
    ...
    */
  var DirectoryName: js.UndefOr[typingsJapgolly.awsSdk.clientsAppstreamMod.DirectoryName] = js.undefined
  
  /**
    * The distinguished name of the organizational unit for computer accounts.
    */
  var OrganizationalUnitDistinguishedName: js.UndefOr[typingsJapgolly.awsSdk.clientsAppstreamMod.OrganizationalUnitDistinguishedName] = js.undefined
}
