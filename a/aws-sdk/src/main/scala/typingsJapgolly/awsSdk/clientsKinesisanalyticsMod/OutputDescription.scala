...
trait OutputDescription extends StObject {
  ...
  /**
    ...
    */
  var DestinationSchema: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.DestinationSchema] = js.undefined
  
  /**
    * Describes the Amazon Kinesis Firehose delivery stream configured as the destination where output is written.
    */
  var KinesisFirehoseOutputDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.KinesisFirehoseOutputDescription
  ] = js.undefined
  ...
  var KinesisStreamsOutputDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.KinesisStreamsOutputDescription
  ] = js.undefined
  
  /**
    * Describes the AWS Lambda function configured as the destination where output is written.
    */
  var LambdaOutputDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.LambdaOutputDescription] = js.undefined
