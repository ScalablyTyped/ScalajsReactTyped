...
trait ApplicationDetail extends StObject {
  ...
  /**
    ...
    */
  var ApplicationCode: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.ApplicationCode] = js.undefined
  
  /**
    * Description of the application.
    */
  var ApplicationDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.ApplicationDescription] = js.undefined
  ...
  /**
    ...
    */
  var ApplicationVersionId: typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.ApplicationVersionId
  
  /**
    * Describes the CloudWatch log streams that are configured to receive application messages. For more information about using CloudWatch log streams with Amazon Kinesis Analytics applications, see Working with Amazon CloudWatch Logs. 
    */
  var CloudWatchLoggingOptionDescriptions: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.CloudWatchLoggingOptionDescriptions
  ] = js.undefined
  ...
  /**
    ...
    */
  var InputDescriptions: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.InputDescriptions] = js.undefined
  ...
  /**
    ...
    */
  var OutputDescriptions: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.OutputDescriptions] = js.undefined
  
  /**
    * Describes reference data sources configured for the application. For more information, see Configuring Application Input. 
    */
  var ReferenceDataSourceDescriptions: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.ReferenceDataSourceDescriptions
  ] = js.undefined
}
