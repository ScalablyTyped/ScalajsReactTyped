...
trait MappingParameters extends StObject {
  ...
  /**
    ...
    */
  var CSVMappingParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.CSVMappingParameters] = js.undefined
  
  /**
    * Provides additional mapping information when JSON is the record format on the streaming source.
    */
  var JSONMappingParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.JSONMappingParameters] = js.undefined
}
