...
trait ApplicationUpdate extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchLoggingOptionUpdates: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.CloudWatchLoggingOptionUpdates] = js.undefined
  
  /**
    * Describes application input configuration updates.
    */
  var InputUpdates: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.InputUpdates] = js.undefined
  
  /**
    * Describes application output configuration updates.
    */
  var OutputUpdates: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.OutputUpdates] = js.undefined
  
  /**
    * Describes application reference data source updates.
    */
  var ReferenceDataSourceUpdates: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.ReferenceDataSourceUpdates] = js.undefined
}
