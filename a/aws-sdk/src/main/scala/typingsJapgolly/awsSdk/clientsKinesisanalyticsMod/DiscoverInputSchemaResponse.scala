...
trait DiscoverInputSchemaResponse extends StObject {
  ...
  /**
    ...
    */
  var ParsedInputRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.ParsedInputRecords] = js.undefined
  
  /**
    * Stream data that was modified by the processor specified in the InputProcessingConfiguration parameter.
    */
  var ProcessedInputRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.ProcessedInputRecords] = js.undefined
  
  /**
    * Raw stream data that was sampled to infer the schema.
    */
  var RawInputRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.RawInputRecords] = js.undefined
}
