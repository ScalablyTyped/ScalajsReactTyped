...
trait OutputUpdate extends StObject {
  ...
  /**
    ...
    */
  var KinesisFirehoseOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.KinesisFirehoseOutputUpdate] = js.undefined
  
  /**
    * Describes an Amazon Kinesis stream as the destination for the output.
    */
  var KinesisStreamsOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.KinesisStreamsOutputUpdate] = js.undefined
  
  /**
    * Describes an AWS Lambda function as the destination for the output.
    */
  var LambdaOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsMod.LambdaOutputUpdate] = js.undefined
