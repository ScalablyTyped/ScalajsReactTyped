...
trait LambdaFunctionStartFailedEventDetails extends StObject {
...
object LambdaFunctionStartFailedEventDetails {
  ...
  inline def apply(): LambdaFunctionStartFailedEventDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[LambdaFunctionStartFailedEventDetails]
  }
  
  extension [Self <: LambdaFunctionStartFailedEventDetails](x: Self) {
