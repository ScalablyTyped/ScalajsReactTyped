...
trait ComplianceViolator extends js.Object {
  /**
    * The resource ID.
    */
  var ResourceId: js.UndefOr[typingsJapgolly.awsSdk.fmsMod.ResourceId] = js.native
  /**
    ...
    */
  var ResourceType: js.UndefOr[typingsJapgolly.awsSdk.fmsMod.ResourceType] = js.native
  /**
    * The reason that the resource is not protected by the policy.
    */
  var ViolationReason: js.UndefOr[typingsJapgolly.awsSdk.fmsMod.ViolationReason] = js.native
}
