...
trait Policy extends js.Object {
  ...
  /**
    ...
    */
  var PolicyId: js.UndefOr[typingsJapgolly.awsSdk.fmsMod.PolicyId] = js.native
  /**
  ...
  /**
    ...
    */
  var PolicyUpdateToken: js.UndefOr[typingsJapgolly.awsSdk.fmsMod.PolicyUpdateToken] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceTags: js.UndefOr[typingsJapgolly.awsSdk.fmsMod.ResourceTags] = js.native
  /**
    ...
    */
  var ResourceType: typingsJapgolly.awsSdk.fmsMod.ResourceType = js.native
  /**
    * An array of ResourceType.
    */
  var ResourceTypeList: js.UndefOr[typingsJapgolly.awsSdk.fmsMod.ResourceTypeList] = js.native
  /**
    * Details about the security service that is being used to protect the resources.
    */
  var SecurityServicePolicyData: typingsJapgolly.awsSdk.fmsMod.SecurityServicePolicyData = js.native
}
