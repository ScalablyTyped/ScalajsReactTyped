...
trait EcsParameters extends StObject {
  ...
  /**
    ...
    */
  var CapacityProviderStrategy: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.CapacityProviderStrategy] = js.undefined
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.LaunchType] = js.undefined
  ...
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.NetworkConfiguration] = js.undefined
  
  /**
    * An array of placement constraint objects to use for the task. You can specify up to 10 constraints per task (including constraints in the task definition and those specified at runtime).
    */
  var PlacementConstraints: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.PlacementConstraints] = js.undefined
  ...
  /**
    ...
    */
  var PropagateTags: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.PropagateTags] = js.undefined
  
  /**
    * The reference ID to use for the task.
    */
  var ReferenceId: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.ReferenceId] = js.undefined
