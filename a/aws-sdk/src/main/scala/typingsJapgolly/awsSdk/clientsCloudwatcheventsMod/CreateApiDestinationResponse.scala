...
trait CreateApiDestinationResponse extends StObject {
  ...
  /**
    ...
    */
  var ApiDestinationArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.ApiDestinationArn] = js.undefined
  
  /**
    * The state of the API destination that was created by the request.
    */
  var ApiDestinationState: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.ApiDestinationState] = js.undefined
...
object CreateApiDestinationResponse {
  ...
  extension [Self <: CreateApiDestinationResponse](x: Self) {
