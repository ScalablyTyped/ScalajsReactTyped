...
trait RedshiftDataParameters extends StObject {
  ...
  /**
    ...
    */
  var Database: typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.Database
  
  /**
    * The database user name. Required when authenticating using temporary credentials.
    */
  var DbUser: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.DbUser] = js.undefined
  ...
  /**
    ...
    */
  var Sql: typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.Sql
  
  /**
    * The name of the SQL statement. You can name the SQL statement when you create it to identify the query.
    */
  var StatementName: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.StatementName] = js.undefined
