...
trait Target extends StObject {
  ...
  /**
    ...
    */
  var BatchParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.BatchParameters] = js.undefined
  
  /**
    * The DeadLetterConfig that defines the target queue to send dead-letter queue events to.
    */
  var DeadLetterConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.DeadLetterConfig] = js.undefined
  
  /**
    * Contains the Amazon ECS task definition and task count to be used, if the event target is an Amazon ECS task. For more information about Amazon ECS tasks, see Task Definitions  in the Amazon EC2 Container Service Developer Guide.
    */
  var EcsParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.EcsParameters] = js.undefined
  
  /**
    * Contains the HTTP parameters to use when the target is a API Gateway REST endpoint or EventBridge ApiDestination. If you specify an API Gateway REST API or EventBridge ApiDestination as a target, you can use this parameter to specify headers, path parameters, and query string keys/values as part of your target invoking request. If you're using ApiDestinations, the corresponding Connection can also have these values configured. In case of any conflicting keys, values from the Connection take precedence.
    */
  var HttpParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.HttpParameters] = js.undefined
  ...
  /**
    ...
    */
  var InputTransformer: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.InputTransformer] = js.undefined
  
  /**
    * The custom parameter you can use to control the shard assignment, when the target is a Kinesis data stream. If you do not include this parameter, the default is to use the eventId as the partition key.
    */
  var KinesisParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.KinesisParameters] = js.undefined
  ...
  /**
    ...
    */
  var RedshiftDataParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.RedshiftDataParameters] = js.undefined
  
  /**
    * The RetryPolicy object that contains the retry policy configuration to use for the dead-letter queue.
    */
  var RetryPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.RetryPolicy] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the IAM role to be used for this target when the rule is triggered. If one rule triggers multiple targets, you can use a different IAM role for each target.
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.RoleArn] = js.undefined
  
  /**
    * Parameters used when you are using the rule to invoke Amazon EC2 Run Command.
    */
  var RunCommandParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.RunCommandParameters] = js.undefined
  ...
  /**
    ...
    */
  var SageMakerPipelineParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.SageMakerPipelineParameters] = js.undefined
  
  /**
    * Contains the message group ID to use when the target is a FIFO queue. If you specify an SQS FIFO queue as a target, the queue must have content-based deduplication enabled.
    */
  var SqsParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.SqsParameters] = js.undefined
}
object Target {
