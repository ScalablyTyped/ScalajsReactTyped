...
trait PutPermissionRequest extends StObject {
  ...
  /**
    ...
    */
  var Action: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.Action] = js.undefined
  ...
  /**
    ...
    */
  var Condition: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.Condition] = js.undefined
  ...
  /**
    ...
    */
  var Principal: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.Principal] = js.undefined
  
  /**
    * An identifier string for the external account that you are granting permissions to. If you later want to revoke the permission for this external account, specify this StatementId when you run RemovePermission.
    */
  var StatementId: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudwatcheventsMod.StatementId] = js.undefined
}
