...
trait PackageDetails extends StObject {
  ...
  /**
    ...
    */
  var ErrorDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.ErrorDetails] = js.undefined
  ...
  /**
    ...
    */
  var PackageID: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.PackageID] = js.undefined
  
  /**
    * User specified name of the package.
    */
  var PackageName: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.PackageName] = js.undefined
  
  /**
    * Current state of the package. Values are COPYING/COPY_FAILED/AVAILABLE/DELETING/DELETE_FAILED
    */
  var PackageStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.PackageStatus] = js.undefined
  
  /**
    * Currently supports only TXT-DICTIONARY.
    */
  var PackageType: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.PackageType] = js.undefined
}
