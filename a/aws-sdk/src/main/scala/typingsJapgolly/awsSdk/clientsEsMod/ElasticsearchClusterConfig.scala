...
trait ElasticsearchClusterConfig extends StObject {
  ...
  /**
    ...
    */
  var ColdStorageOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.ColdStorageOptions] = js.undefined
  ...
  /**
    ...
    */
  var ZoneAwarenessConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.ZoneAwarenessConfig] = js.undefined
