...
trait InstanceCountLimits extends StObject {
  ...
  var MaximumInstanceCount: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.MaximumInstanceCount] = js.undefined
  
  var MinimumInstanceCount: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.MinimumInstanceCount] = js.undefined
}
