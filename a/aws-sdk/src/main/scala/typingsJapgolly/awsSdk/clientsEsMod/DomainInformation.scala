...
trait DomainInformation extends StObject {
  ...
  var OwnerId: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.OwnerId] = js.undefined
  
  var Region: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.Region] = js.undefined
}
