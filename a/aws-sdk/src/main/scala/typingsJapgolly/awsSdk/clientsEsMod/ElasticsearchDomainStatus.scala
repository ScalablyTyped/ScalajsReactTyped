...
trait ElasticsearchDomainStatus extends StObject {
  ...
  /**
    ...
    */
  var AdvancedOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.AdvancedOptions] = js.undefined
  
  /**
    * The current status of the Elasticsearch domain's advanced security options.
    */
  var AdvancedSecurityOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.AdvancedSecurityOptions] = js.undefined
  ...
  /**
    ...
    */
  var ChangeProgressDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.ChangeProgressDetails] = js.undefined
  
  /**
    * The CognitoOptions for the specified domain. For more information, see Amazon Cognito Authentication for Kibana.
    */
  var CognitoOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.CognitoOptions] = js.undefined
  ...
  /**
    ...
    */
  var DomainEndpointOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.DomainEndpointOptions] = js.undefined
  
  /**
    * The unique identifier for the specified Elasticsearch domain.
    */
  var DomainId: typingsJapgolly.awsSdk.clientsEsMod.DomainId
  ...
  /**
    ...
    */
  var EBSOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.EBSOptions] = js.undefined
  
  /**
    * The type and number of instances in the domain cluster.
    */
  var ElasticsearchClusterConfig: typingsJapgolly.awsSdk.clientsEsMod.ElasticsearchClusterConfig
  ...
  /**
    ...
    */
  var EncryptionAtRestOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.EncryptionAtRestOptions] = js.undefined
  ...
  /**
    ...
    */
  var LogPublishingOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.LogPublishingOptions] = js.undefined
  
  /**
    * Specifies the status of the NodeToNodeEncryptionOptions.
    */
  var NodeToNodeEncryptionOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.NodeToNodeEncryptionOptions] = js.undefined
  ...
  /**
    ...
    */
  var ServiceSoftwareOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.ServiceSoftwareOptions] = js.undefined
  
  /**
    * Specifies the status of the SnapshotOptions
    */
  var SnapshotOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEsMod.SnapshotOptions] = js.undefined
