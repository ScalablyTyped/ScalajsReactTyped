...
trait DeleteBackendAuthRequest extends StObject {
...
object DeleteBackendAuthRequest {
  ...
  inline def apply(AppId: string, BackendEnvironmentName: string, ResourceName: string): DeleteBackendAuthRequest = {
  ...
  extension [Self <: DeleteBackendAuthRequest](x: Self) {
