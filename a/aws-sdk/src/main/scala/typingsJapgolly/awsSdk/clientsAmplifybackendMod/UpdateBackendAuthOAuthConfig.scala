...
trait UpdateBackendAuthOAuthConfig extends StObject {
  ...
  /**
    ...
    */
  var OAuthGrantType: js.UndefOr[typingsJapgolly.awsSdk.clientsAmplifybackendMod.OAuthGrantType] = js.undefined
  ...
  /**
    ...
    */
  var SocialProviderSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsAmplifybackendMod.SocialProviderSettings] = js.undefined
}
object UpdateBackendAuthOAuthConfig {
  ...
  extension [Self <: UpdateBackendAuthOAuthConfig](x: Self) {
