...
trait UnprocessedNamedQueryId extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.athenaMod.ErrorCode] = js.native
  /**
    * The error message returned when the processing request for the named query failed, if applicable.
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.athenaMod.ErrorMessage] = js.native
  /**
    * The unique identifier of the named query.
    */
  var NamedQueryId: js.UndefOr[typingsJapgolly.awsSdk.athenaMod.NamedQueryId] = js.native
}
