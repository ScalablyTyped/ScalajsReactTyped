...
trait GetEmailIdentityResponse extends js.Object {
  /**
    ...
    */
  var DkimAttributes: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.DkimAttributes] = js.native
  /**
  ...
  /**
    ...
    */
  var IdentityType: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.IdentityType] = js.native
  /**
    * An object that contains information about the Mail-From attributes for the email identity.
    */
  var MailFromAttributes: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.MailFromAttributes] = js.native
  /**
