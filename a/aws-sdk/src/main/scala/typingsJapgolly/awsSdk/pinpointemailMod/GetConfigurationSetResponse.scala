...
trait GetConfigurationSetResponse extends js.Object {
  /**
    ...
    */
  var ConfigurationSetName: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.ConfigurationSetName] = js.native
  /**
    * An object that defines the dedicated IP pool that is used to send emails that you send using the configuration set.
    */
  var DeliveryOptions: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.DeliveryOptions] = js.native
  /**
    * An object that defines whether or not Amazon Pinpoint collects reputation metrics for the emails that you send that use the configuration set.
    */
  var ReputationOptions: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.ReputationOptions] = js.native
  /**
    * An object that defines whether or not Amazon Pinpoint can send email that you send using the configuration set.
    */
  var SendingOptions: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.SendingOptions] = js.native
  /**
  ...
  /**
    ...
    */
  var TrackingOptions: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.TrackingOptions] = js.native
}
