...
trait DeliverabilityTestReport extends js.Object {
  ...
  /**
    ...
    */
  var DeliverabilityTestStatus: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.DeliverabilityTestStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var ReportId: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.ReportId] = js.native
  /**
    * A name that helps you identify a predictive inbox placement test report.
    */
  var ReportName: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.ReportName] = js.native
  /**
