...
trait CreateDeliverabilityTestReportResponse extends js.Object {
  /**
    ...
    */
  var DeliverabilityTestStatus: typingsJapgolly.awsSdk.pinpointemailMod.DeliverabilityTestStatus = js.native
  /**
    * A unique string that identifies the predictive inbox placement test.
    */
  var ReportId: typingsJapgolly.awsSdk.pinpointemailMod.ReportId = js.native
}
