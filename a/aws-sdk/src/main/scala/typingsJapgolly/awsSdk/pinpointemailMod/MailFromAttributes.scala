...
trait MailFromAttributes extends js.Object {
  /**
    ...
    */
  var BehaviorOnMxFailure: typingsJapgolly.awsSdk.pinpointemailMod.BehaviorOnMxFailure = js.native
  /**
  ...
  /**
    ...
    */
  var MailFromDomainStatus: typingsJapgolly.awsSdk.pinpointemailMod.MailFromDomainStatus = js.native
}
