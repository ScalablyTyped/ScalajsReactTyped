...
trait DailyVolume extends js.Object {
  /**
    ...
    */
  var DomainIspPlacements: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.DomainIspPlacements] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatistics: js.UndefOr[typingsJapgolly.awsSdk.pinpointemailMod.VolumeStatistics] = js.native
}
