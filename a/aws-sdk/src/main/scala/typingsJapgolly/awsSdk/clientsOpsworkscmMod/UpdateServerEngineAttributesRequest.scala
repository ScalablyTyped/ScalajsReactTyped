...
trait UpdateServerEngineAttributesRequest extends StObject {
  ...
  /**
    ...
    */
  var AttributeName: typingsJapgolly.awsSdk.clientsOpsworkscmMod.AttributeName
  
  /**
    * The value to set for the attribute. 
    */
  var AttributeValue: js.UndefOr[typingsJapgolly.awsSdk.clientsOpsworkscmMod.AttributeValue] = js.undefined
