...
trait UpdateCrawlerRequest extends js.Object {
  ...
  /**
    ...
    */
  var CrawlerSecurityConfiguration: js.UndefOr[typingsJapgolly.awsSdk.glueMod.CrawlerSecurityConfiguration] = js.native
  /**
    * The AWS Glue database where results are stored, such as: arn:aws:daylight:us-east-1::database/sometable/ *.
    */
  var DatabaseName: js.UndefOr[typingsJapgolly.awsSdk.glueMod.DatabaseName] = js.native
  /**
  ...
  /**
    ...
    */
  var Role: js.UndefOr[typingsJapgolly.awsSdk.glueMod.Role] = js.native
  /**
  ...
  /**
    ...
    */
  var SchemaChangePolicy: js.UndefOr[typingsJapgolly.awsSdk.glueMod.SchemaChangePolicy] = js.native
  /**
    * The table prefix used for catalog tables that are created.
    */
  var TablePrefix: js.UndefOr[typingsJapgolly.awsSdk.glueMod.TablePrefix] = js.native
  /**
