...
trait ConnectionInput extends js.Object {
  /**
    ...
    */
  var ConnectionProperties: typingsJapgolly.awsSdk.glueMod.ConnectionProperties = js.native
  /**
    * The type of the connection. Currently, only JDBC is supported; SFTP is not supported.
    */
  var ConnectionType: typingsJapgolly.awsSdk.glueMod.ConnectionType = js.native
  /**
