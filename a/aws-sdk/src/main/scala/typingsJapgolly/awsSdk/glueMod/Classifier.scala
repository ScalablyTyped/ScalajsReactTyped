...
trait Classifier extends js.Object {
  /**
    ...
    */
  var CsvClassifier: js.UndefOr[typingsJapgolly.awsSdk.glueMod.CsvClassifier] = js.native
  /**
    * A classifier that uses grok.
    */
  var GrokClassifier: js.UndefOr[typingsJapgolly.awsSdk.glueMod.GrokClassifier] = js.native
  /**
    * A classifier for JSON content.
    */
  var JsonClassifier: js.UndefOr[typingsJapgolly.awsSdk.glueMod.JsonClassifier] = js.native
  /**
    * A classifier for XML content.
    */
  var XMLClassifier: js.UndefOr[typingsJapgolly.awsSdk.glueMod.XMLClassifier] = js.native
}
