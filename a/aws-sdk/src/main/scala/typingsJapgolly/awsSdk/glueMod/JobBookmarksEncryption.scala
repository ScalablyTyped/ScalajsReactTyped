...
trait JobBookmarksEncryption extends js.Object {
  /**
    ...
    */
  var JobBookmarksEncryptionMode: js.UndefOr[typingsJapgolly.awsSdk.glueMod.JobBookmarksEncryptionMode] = js.native
  /**
    * The Amazon Resource Name (ARN) of the KMS key to be used to encrypt the data.
    */
  var KmsKeyArn: js.UndefOr[typingsJapgolly.awsSdk.glueMod.KmsKeyArn] = js.native
}
