...
trait EncryptionConfiguration extends js.Object {
  /**
    ...
    */
  var CloudWatchEncryption: js.UndefOr[typingsJapgolly.awsSdk.glueMod.CloudWatchEncryption] = js.native
  /**
    * The encryption configuration for job bookmarks.
    */
  var JobBookmarksEncryption: js.UndefOr[typingsJapgolly.awsSdk.glueMod.JobBookmarksEncryption] = js.native
  /**
