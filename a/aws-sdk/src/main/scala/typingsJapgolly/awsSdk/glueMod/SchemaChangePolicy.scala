...
trait SchemaChangePolicy extends js.Object {
  /**
    ...
    */
  var DeleteBehavior: js.UndefOr[typingsJapgolly.awsSdk.glueMod.DeleteBehavior] = js.native
  /**
    * The update behavior when the crawler finds a changed schema.
    */
  var UpdateBehavior: js.UndefOr[typingsJapgolly.awsSdk.glueMod.UpdateBehavior] = js.native
}
