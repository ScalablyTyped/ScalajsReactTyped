...
trait UpdateGrokClassifierRequest extends js.Object {
  /**
    ...
    */
  var Classification: js.UndefOr[typingsJapgolly.awsSdk.glueMod.Classification] = js.native
  /**
  ...
  /**
    ...
    */
  var GrokPattern: js.UndefOr[typingsJapgolly.awsSdk.glueMod.GrokPattern] = js.native
  /**
