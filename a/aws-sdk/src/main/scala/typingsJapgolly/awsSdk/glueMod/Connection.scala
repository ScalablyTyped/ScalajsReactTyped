...
trait Connection extends js.Object {
  /**
    ...
    */
  var ConnectionProperties: js.UndefOr[typingsJapgolly.awsSdk.glueMod.ConnectionProperties] = js.native
  /**
    * The type of the connection. Currently, only JDBC is supported; SFTP is not supported.
    */
  var ConnectionType: js.UndefOr[typingsJapgolly.awsSdk.glueMod.ConnectionType] = js.native
  /**
  ...
  /**
    ...
    */
  var MatchCriteria: js.UndefOr[typingsJapgolly.awsSdk.glueMod.MatchCriteria] = js.native
  /**
  ...
  /**
    ...
    */
  var PhysicalConnectionRequirements: js.UndefOr[typingsJapgolly.awsSdk.glueMod.PhysicalConnectionRequirements] = js.native
}
