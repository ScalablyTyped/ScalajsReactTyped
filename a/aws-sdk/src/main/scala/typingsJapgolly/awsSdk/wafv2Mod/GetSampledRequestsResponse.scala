...
trait GetSampledRequestsResponse extends js.Object {
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typingsJapgolly.awsSdk.wafv2Mod.PopulationSize] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typingsJapgolly.awsSdk.wafv2Mod.TimeWindow] = js.native
}
