...
trait SizeConstraintStatement extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: typingsJapgolly.awsSdk.wafv2Mod.ComparisonOperator = js.native
  /**
    * The part of a web request that you want AWS WAF to inspect. For more information, see FieldToMatch. 
    */
  var FieldToMatch: typingsJapgolly.awsSdk.wafv2Mod.FieldToMatch = js.native
  /**
    * The size, in byte, to compare to the request part, after any transformations.
    */
  var Size: typingsJapgolly.awsSdk.wafv2Mod.Size = js.native
  /**
    ...
    */
  var TextTransformations: typingsJapgolly.awsSdk.wafv2Mod.TextTransformations = js.native
}
