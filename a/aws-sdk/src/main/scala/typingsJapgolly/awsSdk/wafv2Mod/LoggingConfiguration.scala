...
trait LoggingConfiguration extends js.Object {
  /**
    ...
    */
  var LogDestinationConfigs: typingsJapgolly.awsSdk.wafv2Mod.LogDestinationConfigs = js.native
  /**
    ...
    */
  var RedactedFields: js.UndefOr[typingsJapgolly.awsSdk.wafv2Mod.RedactedFields] = js.native
  /**
