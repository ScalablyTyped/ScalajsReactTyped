...
trait HTTPRequest extends js.Object {
  ...
  /**
    ...
    */
  var Country: js.UndefOr[typingsJapgolly.awsSdk.wafv2Mod.Country] = js.native
  /**
    * The HTTP version specified in the sampled web request, for example, HTTP/1.1.
    */
  var HTTPVersion: js.UndefOr[typingsJapgolly.awsSdk.wafv2Mod.HTTPVersion] = js.native
  /**
