...
trait GetRuleGroupResponse extends js.Object {
  /**
    ...
    */
  var LockToken: js.UndefOr[typingsJapgolly.awsSdk.wafv2Mod.LockToken] = js.native
  /**
    * 
    */
  var RuleGroup: js.UndefOr[typingsJapgolly.awsSdk.wafv2Mod.RuleGroup] = js.native
}
