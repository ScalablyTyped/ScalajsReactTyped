...
trait DescribeBackupsRequest extends StObject {
  ...
  /**
    ...
    */
  var BackupIds: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.BackupIds] = js.undefined
  
  /**
    * The filters structure. The supported names are file-system-id, backup-type, file-system-type, and volume-id.
    */
  var Filters: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.Filters] = js.undefined
