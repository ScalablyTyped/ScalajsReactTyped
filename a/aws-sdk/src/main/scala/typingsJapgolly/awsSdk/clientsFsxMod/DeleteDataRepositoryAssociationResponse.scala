...
trait DeleteDataRepositoryAssociationResponse extends StObject {
  ...
  /**
    ...
    */
  var DeleteDataInFileSystem: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.DeleteDataInFileSystem] = js.undefined
...
object DeleteDataRepositoryAssociationResponse {
  ...
  extension [Self <: DeleteDataRepositoryAssociationResponse](x: Self) {
