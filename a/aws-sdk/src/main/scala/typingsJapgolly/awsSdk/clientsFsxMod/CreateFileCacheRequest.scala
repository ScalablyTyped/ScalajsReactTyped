...
trait CreateFileCacheRequest extends StObject {
  ...
  /**
    ...
    */
  var CopyTagsToDataRepositoryAssociations: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.CopyTagsToDataRepositoryAssociations] = js.undefined
  ...
  /**
    ...
    */
  var FileCacheType: typingsJapgolly.awsSdk.clientsFsxMod.FileCacheType
