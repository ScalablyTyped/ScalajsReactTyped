...
trait FileCache extends StObject {
  ...
  /**
    ...
    */
  var DNSName: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.DNSName] = js.undefined
  
  /**
    * A list of IDs of data repository associations that are associated with this cache.
    */
  var DataRepositoryAssociationIds: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.DataRepositoryAssociationIds] = js.undefined
  ...
  /**
    ...
    */
  var FileCacheId: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.FileCacheId] = js.undefined
  
  /**
    * The type of cache, which must be LUSTRE.
    */
  var FileCacheType: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.FileCacheType] = js.undefined
  ...
  /**
    ...
    */
  var KmsKeyId: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.KmsKeyId] = js.undefined
  ...
  var NetworkInterfaceIds: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.NetworkInterfaceIds] = js.undefined
  
  var OwnerId: js.UndefOr[AWSAccountId] = js.undefined
  
  var ResourceARN: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.ResourceARN] = js.undefined
  
  /**
    * The storage capacity of the cache in gibibytes (GiB).
    */
  var StorageCapacity: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.StorageCapacity] = js.undefined
  
  var SubnetIds: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.SubnetIds] = js.undefined
  
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.VpcId] = js.undefined
}
object FileCache {
  
  inline def apply(): FileCache = {
