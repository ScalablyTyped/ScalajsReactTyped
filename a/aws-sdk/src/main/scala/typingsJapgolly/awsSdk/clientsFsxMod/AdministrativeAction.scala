...
trait AdministrativeAction extends StObject {
  ...
  var AdministrativeActionType: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.AdministrativeActionType] = js.undefined
  ...
  /**
    ...
    */
  var Status: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.Status] = js.undefined
