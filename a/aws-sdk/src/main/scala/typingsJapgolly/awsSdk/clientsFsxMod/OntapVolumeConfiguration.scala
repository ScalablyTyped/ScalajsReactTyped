...
trait OntapVolumeConfiguration extends StObject {
  ...
  /**
    ...
    */
  var FlexCacheEndpointType: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.FlexCacheEndpointType] = js.undefined
  ...
  /**
    ...
    */
  var JunctionPath: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.JunctionPath] = js.undefined
  ...
  /**
    ...
    */
  var OntapVolumeType: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.OntapVolumeType] = js.undefined
  
  /**
    * The security style for the volume, which can be UNIX, NTFS, or MIXED.
    */
  var SecurityStyle: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.SecurityStyle] = js.undefined
  ...
  /**
    ...
    */
  var StorageVirtualMachineId: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.StorageVirtualMachineId] = js.undefined
  ...
  /**
    ...
    */
  var TieringPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.TieringPolicy] = js.undefined
  
  /**
    * The volume's universally unique identifier (UUID).
    */
  var UUID: js.UndefOr[typingsJapgolly.awsSdk.clientsFsxMod.UUID] = js.undefined
}
