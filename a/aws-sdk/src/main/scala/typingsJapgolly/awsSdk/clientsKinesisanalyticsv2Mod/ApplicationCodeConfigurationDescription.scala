...
trait ApplicationCodeConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var CodeContentDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.CodeContentDescription] = js.undefined
  
  /**
    * Specifies whether the code content is in text or zip format.
    */
  var CodeContentType: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.CodeContentType
}
