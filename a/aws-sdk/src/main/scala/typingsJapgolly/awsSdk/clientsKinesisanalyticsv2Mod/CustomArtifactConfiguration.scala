...
trait CustomArtifactConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ArtifactType: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ArtifactType
  
  /**
    * The parameters required to fully specify a Maven reference.
    */
  var MavenReference: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.MavenReference] = js.undefined
  
  var S3ContentLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.S3ContentLocation] = js.undefined
}
