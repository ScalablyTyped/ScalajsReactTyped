...
trait CSVMappingParameters extends StObject {
  ...
  /**
    ...
    */
  var RecordColumnDelimiter: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.RecordColumnDelimiter
  
  /**
    * The row delimiter. For example, in a CSV format, '\n' is the typical row delimiter.
    */
  var RecordRowDelimiter: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.RecordRowDelimiter
}
