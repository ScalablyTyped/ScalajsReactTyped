...
trait RecordFormat extends StObject {
  ...
  /**
    ...
    */
  var MappingParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.MappingParameters] = js.undefined
  
  /**
    * The type of record format.
    */
  var RecordFormatType: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.RecordFormatType
}
object RecordFormat {
