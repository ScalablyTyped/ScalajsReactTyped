...
trait FlinkApplicationConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CheckpointConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.CheckpointConfiguration] = js.undefined
  
  /**
    * Describes configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.MonitoringConfiguration] = js.undefined
  
  /**
    * Describes parameters for how an application executes multiple tasks simultaneously.
    */
  var ParallelismConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ParallelismConfiguration] = js.undefined
}
