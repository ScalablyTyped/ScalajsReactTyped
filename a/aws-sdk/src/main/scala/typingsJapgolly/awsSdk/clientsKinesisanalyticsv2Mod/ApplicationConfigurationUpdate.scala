...
trait ApplicationConfigurationUpdate extends StObject {
  ...
  var ApplicationCodeConfigurationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationCodeConfigurationUpdate
  ] = js.undefined
  ...
  var ApplicationSnapshotConfigurationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationSnapshotConfigurationUpdate
  ] = js.undefined
  
  /**
    * Describes updates to the environment properties for a Flink-based Kinesis Data Analytics application.
    */
  var EnvironmentPropertyUpdates: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.EnvironmentPropertyUpdates] = js.undefined
  ...
  var FlinkApplicationConfigurationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.FlinkApplicationConfigurationUpdate
  ] = js.undefined
  ...
  var SqlApplicationConfigurationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.SqlApplicationConfigurationUpdate
  ] = js.undefined
  
  /**
    * Updates to the array of descriptions of VPC configurations available to the application.
    */
  var VpcConfigurationUpdates: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.VpcConfigurationUpdates] = js.undefined
  ...
  var ZeppelinApplicationConfigurationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ZeppelinApplicationConfigurationUpdate
  ] = js.undefined
}
