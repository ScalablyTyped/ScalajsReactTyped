...
trait DiscoverInputSchemaResponse extends StObject {
  ...
  /**
    ...
    */
  var ParsedInputRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ParsedInputRecords] = js.undefined
  
  /**
    * The stream data that was modified by the processor specified in the InputProcessingConfiguration parameter.
    */
  var ProcessedInputRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ProcessedInputRecords] = js.undefined
  
  /**
    * The raw stream data that was sampled to infer the schema.
    */
  var RawInputRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.RawInputRecords] = js.undefined
}
