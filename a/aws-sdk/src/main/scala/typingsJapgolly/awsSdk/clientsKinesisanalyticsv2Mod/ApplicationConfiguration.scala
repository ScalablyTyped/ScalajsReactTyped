...
trait ApplicationConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ApplicationCodeConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationCodeConfiguration] = js.undefined
  
  /**
    * Describes whether snapshots are enabled for a Flink-based Kinesis Data Analytics application.
    */
  var ApplicationSnapshotConfiguration: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationSnapshotConfiguration
  ] = js.undefined
  
  /**
    * Describes execution properties for a Flink-based Kinesis Data Analytics application.
    */
  var EnvironmentProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.EnvironmentProperties] = js.undefined
  
  /**
    * The creation and update parameters for a Flink-based Kinesis Data Analytics application.
    */
  var FlinkApplicationConfiguration: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.FlinkApplicationConfiguration
  ] = js.undefined
  
  /**
    * The creation and update parameters for a SQL-based Kinesis Data Analytics application.
    */
  var SqlApplicationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.SqlApplicationConfiguration] = js.undefined
  
  /**
    * The array of descriptions of VPC configurations available to the application.
    */
  var VpcConfigurations: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.VpcConfigurations] = js.undefined
  
  /**
    * The configuration parameters for a Kinesis Data Analytics Studio notebook.
    */
  var ZeppelinApplicationConfiguration: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ZeppelinApplicationConfiguration
  ] = js.undefined
}
