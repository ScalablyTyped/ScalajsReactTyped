...
trait OutputDescription extends StObject {
  ...
  /**
    ...
    */
  var DestinationSchema: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.DestinationSchema] = js.undefined
  
  /**
    * Describes the Kinesis Data Firehose delivery stream that is configured as the destination where output is written.
    */
  var KinesisFirehoseOutputDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseOutputDescription
  ] = js.undefined
  ...
  var KinesisStreamsOutputDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsOutputDescription
  ] = js.undefined
  
  /**
    * Describes the Lambda function that is configured as the destination where output is written.
    */
  var LambdaOutputDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.LambdaOutputDescription] = js.undefined
