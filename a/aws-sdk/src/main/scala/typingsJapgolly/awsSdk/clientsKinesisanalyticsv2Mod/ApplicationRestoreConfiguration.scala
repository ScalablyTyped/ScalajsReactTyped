...
trait ApplicationRestoreConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ApplicationRestoreType: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationRestoreType
  
  /**
    * The identifier of an existing snapshot of application state to use to restart an application. The application uses this value if RESTORE_FROM_CUSTOM_SNAPSHOT is specified for the ApplicationRestoreType.
    */
  var SnapshotName: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.SnapshotName] = js.undefined
}
