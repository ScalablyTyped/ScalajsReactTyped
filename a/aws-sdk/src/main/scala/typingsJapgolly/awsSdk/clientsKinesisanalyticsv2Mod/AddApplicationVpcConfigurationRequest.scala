...
trait AddApplicationVpcConfigurationRequest extends StObject {
  ...
  /**
    ...
    */
  var ConditionalToken: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ConditionalToken] = js.undefined
  ...
  /**
    ...
    */
  var VpcConfiguration: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.VpcConfiguration
}
