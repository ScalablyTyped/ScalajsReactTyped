...
trait ApplicationMaintenanceConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var ApplicationMaintenanceWindowEndTime: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationMaintenanceWindowEndTime
  
  /**
    * The start time for the maintenance window.
    */
  var ApplicationMaintenanceWindowStartTime: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationMaintenanceWindowStartTime
}
