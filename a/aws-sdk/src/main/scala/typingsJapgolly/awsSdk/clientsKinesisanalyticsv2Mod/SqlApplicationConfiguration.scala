...
trait SqlApplicationConfiguration extends StObject {
  ...
  /**
    ...
    */
  var Inputs: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.Inputs] = js.undefined
  
  /**
    * The array of Output objects describing the destination streams used by the application.
    */
  var Outputs: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.Outputs] = js.undefined
  
  /**
    * The array of ReferenceDataSource objects describing the reference data sources used by the application.
    */
  var ReferenceDataSources: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ReferenceDataSources] = js.undefined
}
