...
trait ApplicationSummary extends StObject {
  ...
  /**
    ...
    */
  var ApplicationMode: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationMode] = js.undefined
  ...
  /**
    ...
    */
  var ApplicationStatus: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationStatus
  
  /**
    * Provides the current application version.
    */
  var ApplicationVersionId: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationVersionId
  
  /**
    * The runtime environment for the application.
    */
  var RuntimeEnvironment: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.RuntimeEnvironment
}
