...
trait VpcConfiguration extends StObject {
  ...
  /**
    ...
    */
  var SecurityGroupIds: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.SecurityGroupIds
  
  /**
    * The array of Subnet IDs used by the VPC configuration.
    */
  var SubnetIds: typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.SubnetIds
}
