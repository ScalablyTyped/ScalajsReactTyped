...
trait ParallelismConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var ConfigurationType: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ConfigurationType] = js.undefined
  ...
  /**
    ...
    */
  var Parallelism: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.Parallelism] = js.undefined
  
  /**
    * Describes the number of parallel tasks that a Flink-based Kinesis Data Analytics application can perform per Kinesis Processing Unit (KPU) used by the application.
    */
  var ParallelismPerKPU: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ParallelismPerKPU] = js.undefined
}
