...
trait S3ReferenceDataSource extends StObject {
  ...
  /**
    ...
    */
  var BucketARN: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.BucketARN] = js.undefined
  
  /**
    * The object key name containing the reference data.
    */
  var FileKey: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.FileKey] = js.undefined
}
