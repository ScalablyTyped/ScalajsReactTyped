...
trait MonitoringConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var LogLevel: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.LogLevel] = js.undefined
  
  /**
    * Describes the granularity of the CloudWatch Logs for an application.
    */
  var MetricsLevel: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.MetricsLevel] = js.undefined
}
