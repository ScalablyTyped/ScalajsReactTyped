...
trait UpdateApplicationRequest extends StObject {
  ...
  var ApplicationConfigurationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationConfigurationUpdate
  ] = js.undefined
  ...
  var CloudWatchLoggingOptionUpdates: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.CloudWatchLoggingOptionUpdates
  ] = js.undefined
  ...
  /**
    ...
    */
  var RunConfigurationUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.RunConfigurationUpdate] = js.undefined
