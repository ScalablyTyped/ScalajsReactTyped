...
trait FlinkApplicationConfigurationDescription extends StObject {
  ...
  var CheckpointConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.CheckpointConfigurationDescription
  ] = js.undefined
  ...
  /**
    ...
    */
  var JobPlanDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.JobPlanDescription] = js.undefined
  
  /**
    * Describes configuration parameters for Amazon CloudWatch logging for an application.
    */
  var MonitoringConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.MonitoringConfigurationDescription
  ] = js.undefined
  ...
  var ParallelismConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ParallelismConfigurationDescription
  ] = js.undefined
}
