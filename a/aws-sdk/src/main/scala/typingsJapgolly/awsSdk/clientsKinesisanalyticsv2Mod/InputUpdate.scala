...
trait InputUpdate extends StObject {
  ...
  /**
    ...
    */
  var InputParallelismUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.InputParallelismUpdate] = js.undefined
  
  /**
    * Describes updates to an InputProcessingConfiguration.
    */
  var InputProcessingConfigurationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.InputProcessingConfigurationUpdate
  ] = js.undefined
  
  /**
    * Describes the data format on the streaming source, and how record elements on the streaming source map to columns of the in-application stream that is created.
    */
  var InputSchemaUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.InputSchemaUpdate] = js.undefined
  
  /**
    * If a Kinesis Data Firehose delivery stream is the streaming source to be updated, provides an updated stream ARN.
    */
  var KinesisFirehoseInputUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseInputUpdate] = js.undefined
  
  /**
    * If a Kinesis data stream is the streaming source to be updated, provides an updated stream Amazon Resource Name (ARN).
    */
  var KinesisStreamsInputUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsInputUpdate] = js.undefined
