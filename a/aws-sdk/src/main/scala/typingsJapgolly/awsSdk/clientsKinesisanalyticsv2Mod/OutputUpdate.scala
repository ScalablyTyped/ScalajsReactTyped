...
trait OutputUpdate extends StObject {
  ...
  /**
    ...
    */
  var KinesisFirehoseOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.KinesisFirehoseOutputUpdate] = js.undefined
  
  /**
    * Describes a Kinesis data stream as the destination for the output.
    */
  var KinesisStreamsOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.KinesisStreamsOutputUpdate] = js.undefined
  
  /**
    * Describes an Amazon Lambda function as the destination for the output.
    */
  var LambdaOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.LambdaOutputUpdate] = js.undefined
