...
trait DiscoverInputSchemaRequest extends StObject {
  ...
  /**
    ...
    */
  var ResourceARN: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ResourceARN] = js.undefined
  
  /**
    * Specify this parameter to discover a schema from data in an Amazon S3 object.
    */
  var S3Configuration: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.S3Configuration] = js.undefined
