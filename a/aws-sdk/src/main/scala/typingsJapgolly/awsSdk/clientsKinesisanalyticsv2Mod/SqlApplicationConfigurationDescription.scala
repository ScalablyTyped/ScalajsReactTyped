...
trait SqlApplicationConfigurationDescription extends StObject {
  ...
  /**
    ...
    */
  var OutputDescriptions: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.OutputDescriptions] = js.undefined
  
  /**
    * The array of ReferenceDataSourceDescription objects describing the reference data sources used by the application.
    */
  var ReferenceDataSourceDescriptions: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ReferenceDataSourceDescriptions
  ] = js.undefined
}
