...
trait ApplicationConfigurationDescription extends StObject {
  ...
  var ApplicationCodeConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationCodeConfigurationDescription
  ] = js.undefined
  ...
  var ApplicationSnapshotConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ApplicationSnapshotConfigurationDescription
  ] = js.undefined
  
  /**
    * Describes execution properties for a Flink-based Kinesis Data Analytics application.
    */
  var EnvironmentPropertyDescriptions: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.EnvironmentPropertyDescriptions
  ] = js.undefined
  ...
  var FlinkApplicationConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.FlinkApplicationConfigurationDescription
  ] = js.undefined
  
  /**
    * The details about the starting properties for a Kinesis Data Analytics application.
    */
  var RunConfigurationDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.RunConfigurationDescription] = js.undefined
  ...
  var SqlApplicationConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.SqlApplicationConfigurationDescription
  ] = js.undefined
  
  /**
    * The array of descriptions of VPC configurations available to the application.
    */
  var VpcConfigurationDescriptions: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.VpcConfigurationDescriptions] = js.undefined
  
  /**
    * The configuration parameters for a Kinesis Data Analytics Studio notebook.
    */
  var ZeppelinApplicationConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.clientsKinesisanalyticsv2Mod.ZeppelinApplicationConfigurationDescription
  ] = js.undefined
}
