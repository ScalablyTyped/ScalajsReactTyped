...
trait HumanLoopSummary extends StObject {
  ...
  /**
    ...
    */
  var FailureReason: js.UndefOr[typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.FailureReason] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the flow definition used to configure the human loop.
    */
  var FlowDefinitionArn: js.UndefOr[typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.FlowDefinitionArn] = js.undefined
  
  /**
    * The name of the human loop.
    */
  var HumanLoopName: js.UndefOr[typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.HumanLoopName] = js.undefined
  
  /**
    * The status of the human loop. 
    */
  var HumanLoopStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.HumanLoopStatus] = js.undefined
}
