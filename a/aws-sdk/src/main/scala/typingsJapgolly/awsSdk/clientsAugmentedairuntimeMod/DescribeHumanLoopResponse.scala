...
trait DescribeHumanLoopResponse extends StObject {
  ...
  /**
    ...
    */
  var HumanLoopArn: typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.HumanLoopArn
  ...
  /**
    ...
    */
  var HumanLoopOutput: js.UndefOr[typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.HumanLoopOutput] = js.undefined
  
  /**
    * The status of the human loop. 
    */
  var HumanLoopStatus: typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.HumanLoopStatus
}
