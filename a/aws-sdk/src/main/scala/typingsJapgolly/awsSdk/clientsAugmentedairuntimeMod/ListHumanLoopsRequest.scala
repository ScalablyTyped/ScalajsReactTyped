...
trait ListHumanLoopsRequest extends StObject {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.FlowDefinitionArn
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.MaxResults] = js.undefined
  
  /**
    * A token to display the next page of results.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.NextToken] = js.undefined
  
  /**
    * Optional. The order for displaying results. Valid values: Ascending and Descending.
    */
  var SortOrder: js.UndefOr[typingsJapgolly.awsSdk.clientsAugmentedairuntimeMod.SortOrder] = js.undefined
}
