...
trait Playlist extends js.Object {
  ...
  /**
    ...
    */
  var HlsContentProtection: js.UndefOr[typingsJapgolly.awsSdk.elastictranscoderMod.HlsContentProtection] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputKeys: js.UndefOr[typingsJapgolly.awsSdk.elastictranscoderMod.OutputKeys] = js.native
  /**
    * The DRM settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.
    */
  var PlayReadyDrm: js.UndefOr[typingsJapgolly.awsSdk.elastictranscoderMod.PlayReadyDrm] = js.native
  /**
