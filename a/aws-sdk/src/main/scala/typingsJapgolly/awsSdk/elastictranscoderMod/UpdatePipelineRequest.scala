...
trait UpdatePipelineRequest extends js.Object {
  ...
  /**
    ...
    */
  var Name: js.UndefOr[typingsJapgolly.awsSdk.elastictranscoderMod.Name] = js.native
  /**
    ...
    */
  var Notifications: js.UndefOr[typingsJapgolly.awsSdk.elastictranscoderMod.Notifications] = js.native
  /**
    * The IAM Amazon Resource Name (ARN) for the role that you want Elastic Transcoder to use to transcode jobs for this pipeline.
    */
  var Role: js.UndefOr[typingsJapgolly.awsSdk.elastictranscoderMod.Role] = js.native
  /**
