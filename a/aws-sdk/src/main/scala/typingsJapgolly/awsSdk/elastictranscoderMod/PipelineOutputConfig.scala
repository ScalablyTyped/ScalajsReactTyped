...
trait PipelineOutputConfig extends js.Object {
  ...
  /**
    ...
    */
  var Permissions: js.UndefOr[typingsJapgolly.awsSdk.elastictranscoderMod.Permissions] = js.native
  /**
    ...
    */
  var StorageClass: js.UndefOr[typingsJapgolly.awsSdk.elastictranscoderMod.StorageClass] = js.native
}
