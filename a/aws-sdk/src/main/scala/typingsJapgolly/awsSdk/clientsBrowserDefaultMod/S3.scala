package typingsJapgolly.awsSdk.clientsBrowserDefaultMod

import typingsJapgolly.awsSdk.clientsS3Mod.ClientConfiguration
import typingsJapgolly.awsSdk.clientsS3Mod.^
...
object S3 {
  ...
  open class ManagedUpload protected ()
    extends typingsJapgolly.awsSdk.clientsS3Mod.ManagedUpload {
    /**
  ...
  open class PresignedPost ()
    extends typingsJapgolly.awsSdk.clientsS3Mod.PresignedPost
}
