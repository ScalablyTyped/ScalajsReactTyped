...
trait CompleteSnapshotRequest extends StObject {
  ...
  /**
    ...
    */
  var ChangedBlocksCount: typingsJapgolly.awsSdk.clientsEbsMod.ChangedBlocksCount
  ...
  /**
    ...
    */
  var ChecksumAggregationMethod: js.UndefOr[typingsJapgolly.awsSdk.clientsEbsMod.ChecksumAggregationMethod] = js.undefined
