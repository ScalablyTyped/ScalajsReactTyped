...
trait StartSnapshotRequest extends StObject {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsEbsMod.Description] = js.undefined
  ...
  /**
    ...
    */
  var KmsKeyArn: js.UndefOr[typingsJapgolly.awsSdk.clientsEbsMod.KmsKeyArn] = js.undefined
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.clientsEbsMod.Tags] = js.undefined
  ...
  /**
    ...
    */
  var Timeout: js.UndefOr[typingsJapgolly.awsSdk.clientsEbsMod.Timeout] = js.undefined
  
  /**
    * The size of the volume, in GiB. The maximum size is 65536 GiB (64 TiB).
    */
  var VolumeSize: typingsJapgolly.awsSdk.clientsEbsMod.VolumeSize
}
