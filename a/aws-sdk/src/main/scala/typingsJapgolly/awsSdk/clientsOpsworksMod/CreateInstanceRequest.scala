...
trait CreateInstanceRequest extends StObject {
  ...
  /**
    ...
    */
  var Architecture: js.UndefOr[typingsJapgolly.awsSdk.clientsOpsworksMod.Architecture] = js.undefined
  
  /**
    * For load-based or time-based instances, the type. Windows stacks can use only time-based instances.
    */
  var AutoScalingType: js.UndefOr[typingsJapgolly.awsSdk.clientsOpsworksMod.AutoScalingType] = js.undefined
  ...
  /**
    ...
    */
  var BlockDeviceMappings: js.UndefOr[typingsJapgolly.awsSdk.clientsOpsworksMod.BlockDeviceMappings] = js.undefined
  ...
  /**
    ...
    */
  var RootDeviceType: js.UndefOr[typingsJapgolly.awsSdk.clientsOpsworksMod.RootDeviceType] = js.undefined
...
object CreateInstanceRequest {
  ...
  inline def apply(InstanceType: String, LayerIds: Strings, StackId: String): CreateInstanceRequest = {
