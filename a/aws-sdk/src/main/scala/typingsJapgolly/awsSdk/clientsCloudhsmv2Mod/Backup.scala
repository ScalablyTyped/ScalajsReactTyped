...
trait Backup extends StObject {
  ...
  /**
    ...
    */
  var BackupId: typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.BackupId
  
  /**
    * The state of the backup.
    */
  var BackupState: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.BackupState] = js.undefined
