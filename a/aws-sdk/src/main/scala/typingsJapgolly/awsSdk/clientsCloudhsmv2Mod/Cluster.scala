...
trait Cluster extends StObject {
  ...
  /**
    ...
    */
  var BackupPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.BackupPolicy] = js.undefined
  
  /**
    * A policy that defines how the service retains backups.
    */
  var BackupRetentionPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.BackupRetentionPolicy] = js.undefined
  
  /**
    * Contains one or more certificates or a certificate signing request (CSR).
    */
  var Certificates: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.Certificates] = js.undefined
  
  /**
    * The cluster's identifier (ID).
    */
  var ClusterId: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.ClusterId] = js.undefined
  ...
  /**
    ...
    */
  var HsmType: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.HsmType] = js.undefined
  
  /**
    * Contains information about the HSMs in the cluster.
    */
  var Hsms: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.Hsms] = js.undefined
  
  /**
    * The default password for the cluster's Pre-Crypto Officer (PRECO) user.
    */
  var PreCoPassword: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.PreCoPassword] = js.undefined
  
  /**
    * The identifier (ID) of the cluster's security group.
    */
  var SecurityGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.SecurityGroup] = js.undefined
  ...
  /**
    ...
    */
  var StateMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.StateMessage] = js.undefined
  ...
  /**
    ...
    */
  var TagList: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.TagList] = js.undefined
  
  /**
    * The identifier (ID) of the virtual private cloud (VPC) that contains the cluster.
    */
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudhsmv2Mod.VpcId] = js.undefined
}
object Cluster {
