...
trait ReplicationConfigurationTemplate extends StObject {
...
object ReplicationConfigurationTemplate {
  ...
  inline def apply(replicationConfigurationTemplateID: ReplicationConfigurationTemplateID): ReplicationConfigurationTemplate = {
  ...
  extension [Self <: ReplicationConfigurationTemplate](x: Self) {
