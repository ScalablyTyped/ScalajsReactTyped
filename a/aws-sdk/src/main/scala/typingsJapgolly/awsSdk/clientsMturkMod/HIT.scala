...
trait HIT extends StObject {
  ...
  /**
    ...
    */
  var HITReviewStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsMturkMod.HITReviewStatus] = js.undefined
  
  /**
    * The status of the HIT and its assignments. Valid Values are Assignable | Unassignable | Reviewable | Reviewing | Disposed. 
    */
  var HITStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsMturkMod.HITStatus] = js.undefined
