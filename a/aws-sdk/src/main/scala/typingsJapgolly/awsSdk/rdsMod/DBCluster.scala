...
trait DBCluster extends js.Object {
  ...
  /**
    ...
    */
  var ActivityStreamMode: js.UndefOr[typingsJapgolly.awsSdk.rdsMod.ActivityStreamMode] = js.native
  /**
    * The status of the database activity stream.
    */
  var ActivityStreamStatus: js.UndefOr[typingsJapgolly.awsSdk.rdsMod.ActivityStreamStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsJapgolly.awsSdk.rdsMod.AvailabilityZones] = js.native
  /**
  ...
  /**
    ...
    */
  var DBClusterOptionGroupMemberships: js.UndefOr[typingsJapgolly.awsSdk.rdsMod.DBClusterOptionGroupMemberships] = js.native
  /**
  ...
  var ScalingConfigurationInfo: js.UndefOr[typingsJapgolly.awsSdk.rdsMod.ScalingConfigurationInfo] = js.native
  /**
