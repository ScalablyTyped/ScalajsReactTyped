...
trait OptionGroupOption extends js.Object {
  ...
  /**
    ...
    */
  var OptionsConflictsWith: js.UndefOr[typingsJapgolly.awsSdk.rdsMod.OptionsConflictsWith] = js.native
  /**
    * The options that are prerequisites for this option.
    */
  var OptionsDependedOn: js.UndefOr[typingsJapgolly.awsSdk.rdsMod.OptionsDependedOn] = js.native
  /**
