...
package object stsMod {
  ...
  type ClientConfiguration = typingsJapgolly.awsSdk.serviceMod.ServiceConfigurationOptions with typingsJapgolly.awsSdk.stsMod.ClientApiVersions
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdk.awsSdkStrings.`2011-06-15`
    - typingsJapgolly.awsSdk.awsSdkStrings.latest_
    - java.lang.String
  */
  type apiVersion = typingsJapgolly.awsSdk.stsMod._apiVersion | java.lang.String
  ...
  type policyDescriptorListType = js.Array[typingsJapgolly.awsSdk.stsMod.PolicyDescriptorType]
  ...
  type tagKeyListType = js.Array[typingsJapgolly.awsSdk.stsMod.tagKeyType]
  type tagKeyType = java.lang.String
  type tagListType = js.Array[typingsJapgolly.awsSdk.stsMod.Tag]
