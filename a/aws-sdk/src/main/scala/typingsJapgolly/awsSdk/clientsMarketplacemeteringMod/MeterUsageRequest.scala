...
trait MeterUsageRequest extends StObject {
  ...
  /**
    ...
    */
  var ProductCode: typingsJapgolly.awsSdk.clientsMarketplacemeteringMod.ProductCode
  ...
  /**
    ...
    */
  var UsageAllocations: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacemeteringMod.UsageAllocations] = js.undefined
  
  /**
    * It will be one of the fcp dimension name provided during the publishing of the product.
    */
  var UsageDimension: typingsJapgolly.awsSdk.clientsMarketplacemeteringMod.UsageDimension
  
  /**
    * Consumption value for the hour. Defaults to 0 if not specified.
    */
  var UsageQuantity: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacemeteringMod.UsageQuantity] = js.undefined
}
object MeterUsageRequest {
  ...
  extension [Self <: MeterUsageRequest](x: Self) {
