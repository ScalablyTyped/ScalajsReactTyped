...
trait AffectedEntity extends js.Object {
  ...
  /**
    ...
    */
  var entityArn: js.UndefOr[typingsJapgolly.awsSdk.healthMod.entityArn] = js.native
  /**
    * The URL of the affected entity.
    */
  var entityUrl: js.UndefOr[typingsJapgolly.awsSdk.healthMod.entityUrl] = js.native
  /**
    * The ID of the affected entity.
    */
  var entityValue: js.UndefOr[typingsJapgolly.awsSdk.healthMod.entityValue] = js.native
  /**
