...
trait OrganizationEvent extends js.Object {
  ...
  /**
    ...
    */
  var eventTypeCategory: js.UndefOr[typingsJapgolly.awsSdk.healthMod.eventTypeCategory] = js.native
  /**
    * The unique identifier for the event type. The format is AWS_SERVICE_DESCRIPTION. For example, AWS_EC2_SYSTEM_MAINTENANCE_EVENT.
    */
  var eventTypeCode: js.UndefOr[typingsJapgolly.awsSdk.healthMod.eventTypeCode] = js.native
  /**
  ...
  /**
    ...
    */
  var region: js.UndefOr[typingsJapgolly.awsSdk.healthMod.region] = js.native
  /**
    * The AWS service that is affected by the event. For example, EC2, RDS.
    */
  var service: js.UndefOr[typingsJapgolly.awsSdk.healthMod.service] = js.native
  /**
