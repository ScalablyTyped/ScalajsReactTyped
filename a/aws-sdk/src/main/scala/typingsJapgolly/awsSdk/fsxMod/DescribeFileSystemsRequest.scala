...
trait DescribeFileSystemsRequest extends js.Object {
  /**
    ...
    */
  var FileSystemIds: js.UndefOr[typingsJapgolly.awsSdk.fsxMod.FileSystemIds] = js.native
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.fsxMod.MaxResults] = js.native
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.fsxMod.NextToken] = js.native
}
