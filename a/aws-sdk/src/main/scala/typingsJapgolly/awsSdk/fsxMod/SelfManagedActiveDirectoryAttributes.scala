...
trait SelfManagedActiveDirectoryAttributes extends js.Object {
  /**
    ...
    */
  var DnsIps: js.UndefOr[typingsJapgolly.awsSdk.fsxMod.DnsIps] = js.native
  /**
  ...
  /**
    ...
    */
  var OrganizationalUnitDistinguishedName: js.UndefOr[typingsJapgolly.awsSdk.fsxMod.OrganizationalUnitDistinguishedName] = js.native
  /**
