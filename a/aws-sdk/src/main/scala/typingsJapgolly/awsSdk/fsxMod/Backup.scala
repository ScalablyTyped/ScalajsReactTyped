...
trait Backup extends js.Object {
  ...
  /**
    ...
    */
  var FileSystem: typingsJapgolly.awsSdk.fsxMod.FileSystem = js.native
  /**
  ...
  var ProgressPercent: js.UndefOr[typingsJapgolly.awsSdk.fsxMod.ProgressPercent] = js.native
  /**
