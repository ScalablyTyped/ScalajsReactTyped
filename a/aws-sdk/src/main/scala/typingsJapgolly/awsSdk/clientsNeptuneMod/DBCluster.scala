...
trait DBCluster extends StObject {
  ...
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsJapgolly.awsSdk.clientsNeptuneMod.AvailabilityZones] = js.undefined
  ...
  /**
    * Not supported by Neptune.
    */
  var DBClusterOptionGroupMemberships: js.UndefOr[typingsJapgolly.awsSdk.clientsNeptuneMod.DBClusterOptionGroupMemberships] = js.undefined
...
object DBCluster {
  ...
  extension [Self <: DBCluster](x: Self) {
