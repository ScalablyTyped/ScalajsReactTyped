...
trait EventSubscription extends StObject {
  ...
  /**
    ...
    */
  var EventCategoriesList: js.UndefOr[typingsJapgolly.awsSdk.clientsNeptuneMod.EventCategoriesList] = js.undefined
  ...
  /**
    ...
    */
  var SourceIdsList: js.UndefOr[typingsJapgolly.awsSdk.clientsNeptuneMod.SourceIdsList] = js.undefined
