...
trait SendBounceRequest extends StObject {
  ...
  /**
    ...
    */
  var BouncedRecipientInfoList: typingsJapgolly.awsSdk.clientsSesMod.BouncedRecipientInfoList
  
  /**
    * Human-readable text for the bounce message to explain the failure. If not specified, the text will be auto-generated based on the bounced recipient information.
    */
  var Explanation: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.Explanation] = js.undefined
  
  /**
    * Message-related DSN fields. If not specified, Amazon SES will choose the values.
    */
  var MessageDsn: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.MessageDsn] = js.undefined
