...
trait GetCustomVerificationEmailTemplateResponse extends StObject {
  ...
  /**
    ...
    */
  var FailureRedirectionURL: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.FailureRedirectionURL] = js.undefined
  ...
  /**
    ...
    */
  var SuccessRedirectionURL: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.SuccessRedirectionURL] = js.undefined
  
  /**
    * The content of the custom verification email.
    */
  var TemplateContent: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.TemplateContent] = js.undefined
  
  /**
    * The name of the custom verification email template.
    */
  var TemplateName: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.TemplateName] = js.undefined
