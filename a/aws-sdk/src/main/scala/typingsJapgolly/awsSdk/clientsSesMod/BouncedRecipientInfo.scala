...
trait BouncedRecipientInfo extends StObject {
  ...
  /**
    ...
    */
  var BounceType: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.BounceType] = js.undefined
  ...
  /**
    ...
    */
  var RecipientDsnFields: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.RecipientDsnFields] = js.undefined
}
