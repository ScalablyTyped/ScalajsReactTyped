...
trait ListCustomVerificationEmailTemplatesResponse extends StObject {
  ...
  /**
    ...
    */
  var CustomVerificationEmailTemplates: js.UndefOr[typingsJapgolly.awsSdk.clientsSesMod.CustomVerificationEmailTemplates] = js.undefined
...
object ListCustomVerificationEmailTemplatesResponse {
  ...
  extension [Self <: ListCustomVerificationEmailTemplatesResponse](x: Self) {
    ...
    inline def setCustomVerificationEmailTemplatesVarargs(value: CustomVerificationEmailTemplate*): Self = StObject.set(x, "CustomVerificationEmailTemplates", js.Array(value*))
