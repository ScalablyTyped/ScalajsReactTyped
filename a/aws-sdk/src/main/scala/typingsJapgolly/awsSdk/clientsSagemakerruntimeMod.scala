...
object clientsSagemakerruntimeMod {
  ...
  trait ClientApiVersions extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerruntimeMod.apiVersion] = js.undefined
  }
  ...
  trait InvokeEndpointAsyncInput extends StObject {
    ...
    /**
      ...
      */
    var EndpointName: typingsJapgolly.awsSdk.clientsSagemakerruntimeMod.EndpointName
    
    /**
      * The identifier for the inference request. Amazon SageMaker will generate an identifier for you if none is specified. 
      */
    var InferenceId: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakerruntimeMod.InferenceId] = js.undefined
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdk.awsSdkStrings.`2017-05-13`
