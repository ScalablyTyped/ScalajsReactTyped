...
trait CertificateAuthorityConfiguration extends js.Object {
  /**
    ...
    */
  var KeyAlgorithm: typingsJapgolly.awsSdk.acmpcaMod.KeyAlgorithm = js.native
  /**
    * Name of the algorithm your private CA uses to sign certificate requests.
    */
  var SigningAlgorithm: typingsJapgolly.awsSdk.acmpcaMod.SigningAlgorithm = js.native
  /**
