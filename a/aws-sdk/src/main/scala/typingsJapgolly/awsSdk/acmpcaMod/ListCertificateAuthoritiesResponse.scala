...
trait ListCertificateAuthoritiesResponse extends js.Object {
  /**
    ...
    */
  var CertificateAuthorities: js.UndefOr[typingsJapgolly.awsSdk.acmpcaMod.CertificateAuthorities] = js.native
  /**
    * When the list is truncated, this value is present and should be used for the NextToken parameter in a subsequent pagination request.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.acmpcaMod.NextToken] = js.native
}
