...
trait Policies extends js.Object {
  /**
    ...
    */
  var AppCookieStickinessPolicies: js.UndefOr[typingsJapgolly.awsSdk.elbMod.AppCookieStickinessPolicies] = js.native
  /**
    * The stickiness policies created using CreateLBCookieStickinessPolicy.
    */
  var LBCookieStickinessPolicies: js.UndefOr[typingsJapgolly.awsSdk.elbMod.LBCookieStickinessPolicies] = js.native
  /**
