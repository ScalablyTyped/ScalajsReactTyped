...
trait LoadBalancerDescription extends js.Object {
  ...
  /**
    ...
    */
  var BackendServerDescriptions: js.UndefOr[typingsJapgolly.awsSdk.elbMod.BackendServerDescriptions] = js.native
  /**
  ...
  /**
    ...
    */
  var DNSName: js.UndefOr[typingsJapgolly.awsSdk.elbMod.DNSName] = js.native
  /**
  ...
  /**
    ...
    */
  var ListenerDescriptions: js.UndefOr[typingsJapgolly.awsSdk.elbMod.ListenerDescriptions] = js.native
  /**
  ...
  /**
    ...
    */
  var Policies: js.UndefOr[typingsJapgolly.awsSdk.elbMod.Policies] = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityGroups: js.UndefOr[typingsJapgolly.awsSdk.elbMod.SecurityGroups] = js.native
  /**
    * The security group for the load balancer, which you can use as part of your inbound rules for your registered instances. To only allow traffic from load balancers, add a security group rule that specifies this source security group as the inbound source.
    */
  var SourceSecurityGroup: js.UndefOr[typingsJapgolly.awsSdk.elbMod.SourceSecurityGroup] = js.native
  /**
  ...
  /**
    ...
    */
  var VPCId: js.UndefOr[typingsJapgolly.awsSdk.elbMod.VPCId] = js.native
}
