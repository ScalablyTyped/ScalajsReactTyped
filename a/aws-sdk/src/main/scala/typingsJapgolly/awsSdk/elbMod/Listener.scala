...
trait Listener extends js.Object {
  /**
    ...
    */
  var InstancePort: typingsJapgolly.awsSdk.elbMod.InstancePort = js.native
  /**
  ...
  /**
    ...
    */
  var Protocol: typingsJapgolly.awsSdk.elbMod.Protocol = js.native
  /**
    * The Amazon Resource Name (ARN) of the server certificate.
    */
  var SSLCertificateId: js.UndefOr[typingsJapgolly.awsSdk.elbMod.SSLCertificateId] = js.native
}
