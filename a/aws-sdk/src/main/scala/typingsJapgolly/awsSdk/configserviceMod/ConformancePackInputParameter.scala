...
trait ConformancePackInputParameter extends js.Object {
  /**
    ...
    */
  var ParameterName: typingsJapgolly.awsSdk.configserviceMod.ParameterName = js.native
  /**
    * Another part of the key-value pair. 
    */
  var ParameterValue: typingsJapgolly.awsSdk.configserviceMod.ParameterValue = js.native
}
