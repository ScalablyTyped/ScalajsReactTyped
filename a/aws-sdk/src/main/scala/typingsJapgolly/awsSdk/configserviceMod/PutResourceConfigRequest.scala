...
trait PutResourceConfigRequest extends js.Object {
  /**
    ...
    */
  var Configuration: typingsJapgolly.awsSdk.configserviceMod.Configuration = js.native
  /**
  ...
  /**
    ...
    */
  var SchemaVersionId: typingsJapgolly.awsSdk.configserviceMod.SchemaVersionId = js.native
  /**
    * Tags associated with the resource.
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.configserviceMod.Tags] = js.native
}
