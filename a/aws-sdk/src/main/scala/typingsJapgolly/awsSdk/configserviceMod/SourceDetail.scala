...
trait SourceDetail extends js.Object {
  /**
    ...
    */
  var EventSource: js.UndefOr[typingsJapgolly.awsSdk.configserviceMod.EventSource] = js.native
  /**
  ...
  /**
    ...
    */
  var MessageType: js.UndefOr[typingsJapgolly.awsSdk.configserviceMod.MessageType] = js.native
}
