...
trait Compliance extends js.Object {
  /**
    ...
    */
  var ComplianceContributorCount: js.UndefOr[typingsJapgolly.awsSdk.configserviceMod.ComplianceContributorCount] = js.native
  /**
...
object Compliance {
  ...
  def apply(
    ...
    if (ComplianceContributorCount != null) __obj.updateDynamic("ComplianceContributorCount")(ComplianceContributorCount.asInstanceOf[js.Any])
