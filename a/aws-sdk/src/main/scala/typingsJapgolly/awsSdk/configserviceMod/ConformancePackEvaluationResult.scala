...
trait ConformancePackEvaluationResult extends js.Object {
  /**
    ...
    */
  var Annotation: js.UndefOr[typingsJapgolly.awsSdk.configserviceMod.Annotation] = js.native
  /**
  ...
  var EvaluationResultIdentifier: typingsJapgolly.awsSdk.configserviceMod.EvaluationResultIdentifier = js.native
  /**
