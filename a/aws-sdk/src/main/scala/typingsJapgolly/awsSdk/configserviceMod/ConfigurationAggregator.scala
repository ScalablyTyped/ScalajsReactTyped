...
trait ConfigurationAggregator extends js.Object {
  ...
  /**
    ...
    */
  var ConfigurationAggregatorArn: js.UndefOr[typingsJapgolly.awsSdk.configserviceMod.ConfigurationAggregatorArn] = js.native
  /**
    * The name of the aggregator.
    */
  var ConfigurationAggregatorName: js.UndefOr[typingsJapgolly.awsSdk.configserviceMod.ConfigurationAggregatorName] = js.native
  /**
