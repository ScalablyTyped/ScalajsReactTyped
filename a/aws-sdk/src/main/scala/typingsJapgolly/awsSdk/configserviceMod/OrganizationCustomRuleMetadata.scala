...
trait OrganizationCustomRuleMetadata extends js.Object {
  ...
  /**
    ...
    */
  var OrganizationConfigRuleTriggerTypes: typingsJapgolly.awsSdk.configserviceMod.OrganizationConfigRuleTriggerTypes = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceTypesScope: js.UndefOr[typingsJapgolly.awsSdk.configserviceMod.ResourceTypesScope] = js.native
  /**
