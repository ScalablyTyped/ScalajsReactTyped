...
trait SensorStatisticsSummary extends StObject {
  ...
  /**
    ...
    */
  var CategoricalValues: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.CategoricalValues] = js.undefined
  
  /**
    *  Name of the component to which the particular sensor belongs for which the statistics belong to. 
    */
  var ComponentName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.ComponentName] = js.undefined
  ...
  /**
    ...
    */
  var LargeTimestampGaps: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.LargeTimestampGaps] = js.undefined
  ...
  /**
    ...
    */
  var MonotonicValues: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.MonotonicValues] = js.undefined
  
  /**
    *  Parameter that describes potential risk about whether data associated with the sensor has more than one operating mode. 
    */
  var MultipleOperatingModes: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.MultipleOperatingModes] = js.undefined
  
  /**
    *  Name of the sensor that the statistics belong to. 
    */
  var SensorName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.SensorName] = js.undefined
}
