...
trait ListSensorStatisticsRequest extends StObject {
  ...
  /**
    ...
    */
  var DatasetName: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DatasetName
  
  /**
    *  The ingestion job id associated with the list of Sensor Statistics. To get sensor statistics for a particular ingestion job id, both dataset name and ingestion job id must be submitted as inputs. 
    */
  var IngestionJobId: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.IngestionJobId] = js.undefined
