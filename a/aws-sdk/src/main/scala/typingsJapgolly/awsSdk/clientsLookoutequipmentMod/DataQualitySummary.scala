...
trait DataQualitySummary extends StObject {
  ...
  /**
    ...
    */
  var DuplicateTimestamps: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DuplicateTimestamps
  ...
  /**
    ...
    */
  var InsufficientSensorData: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.InsufficientSensorData
  
  /**
    *  Parameter that gives information about data that is invalid over all the sensors in the input data. 
    */
  var InvalidSensorData: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.InvalidSensorData
  
  /**
    *  Parameter that gives information about data that is missing over all the sensors in the input data. 
    */
  var MissingSensorData: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.MissingSensorData
  
  /**
    *  Parameter that gives information about unsupported timestamps in the input data. 
    */
  var UnsupportedTimestamps: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.UnsupportedTimestamps
}
