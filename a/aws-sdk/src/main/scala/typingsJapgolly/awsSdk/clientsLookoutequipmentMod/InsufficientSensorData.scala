...
trait InsufficientSensorData extends StObject {
  ...
  /**
    ...
    */
  var MissingCompleteSensorData: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.MissingCompleteSensorData
  
  /**
    *  Parameter that describes the total number of sensors that have a short date range of less than 90 days of data overall. 
    */
  var SensorsWithShortDateRange: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.SensorsWithShortDateRange
}
