...
trait DescribeInferenceSchedulerResponse extends StObject {
  ...
  /**
    ...
    */
  var DataDelayOffsetInMinutes: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DataDelayOffsetInMinutes] = js.undefined
  ...
  /**
    ...
    */
  var DataUploadFrequency: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DataUploadFrequency] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the inference scheduler being described. 
    */
  var InferenceSchedulerArn: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.InferenceSchedulerArn] = js.undefined
  
  /**
    * The name of the inference scheduler being described. 
    */
  var InferenceSchedulerName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.InferenceSchedulerName] = js.undefined
  ...
  /**
    ...
    */
  var LatestInferenceResult: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.LatestInferenceResult] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the ML model of the inference scheduler being described. 
    */
  var ModelArn: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.ModelArn] = js.undefined
  
  /**
    * The name of the ML model of the inference scheduler being described. 
    */
  var ModelName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.ModelName] = js.undefined
