...
trait CreateModelRequest extends StObject {
  ...
  /**
    ...
    */
  var DataPreProcessingConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DataPreProcessingConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var DatasetSchema: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DatasetSchema] = js.undefined
  ...
  /**
    ...
    */
  var LabelsInputConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.LabelsInputConfiguration] = js.undefined
  
  /**
    * The name for the ML model to be created.
    */
  var ModelName: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.ModelName
  
  /**
    * Indicates that the asset associated with this sensor has been shut off. As long as this condition is met, Lookout for Equipment will not use data from this asset for training, evaluation, or inference.
    */
  var OffCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.OffCondition] = js.undefined
