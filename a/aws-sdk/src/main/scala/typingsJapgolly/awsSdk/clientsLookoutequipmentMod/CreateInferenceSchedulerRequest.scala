...
trait CreateInferenceSchedulerRequest extends StObject {
  ...
  /**
    ...
    */
  var DataUploadFrequency: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DataUploadFrequency
  
  /**
    * The name of the inference scheduler being created. 
    */
  var InferenceSchedulerName: typingsJapgolly.awsSdk.clientsLookoutequipmentMod.InferenceSchedulerName
