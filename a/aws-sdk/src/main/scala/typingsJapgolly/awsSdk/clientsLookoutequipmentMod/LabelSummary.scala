...
trait LabelSummary extends StObject {
  ...
  /**
    ...
    */
  var Equipment: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.Equipment] = js.undefined
  ...
  /**
    ...
    */
  var FaultCode: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.FaultCode] = js.undefined
  
  /**
    *  The ARN of the label group. 
    */
  var LabelGroupArn: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.LabelGroupArn] = js.undefined
  
  /**
    *  The name of the label group. 
    */
  var LabelGroupName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.LabelGroupName] = js.undefined
