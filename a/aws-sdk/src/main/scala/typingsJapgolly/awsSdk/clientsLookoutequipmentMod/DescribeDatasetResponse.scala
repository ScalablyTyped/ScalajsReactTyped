...
trait DescribeDatasetResponse extends StObject {
  ...
  /**
    ...
    */
  var DataQualitySummary: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DataQualitySummary] = js.undefined
  ...
  /**
    ...
    */
  var DatasetArn: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DatasetArn] = js.undefined
  
  /**
    * The name of the dataset being described. 
    */
  var DatasetName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.DatasetName] = js.undefined
  
  /**
    *  IngestedFilesSummary associated with the given dataset for the latest successful associated ingestion job id. 
    */
  var IngestedFilesSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.IngestedFilesSummary] = js.undefined
  
  /**
    * Specifies the S3 location configuration for the data input for the data ingestion job. 
    */
  var IngestionInputConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutequipmentMod.IngestionInputConfiguration] = js.undefined
