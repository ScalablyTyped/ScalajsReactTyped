...
trait ModelPackagingDescription extends StObject {
  ...
  /**
    ...
    */
  var ModelPackagingConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ModelPackagingConfiguration] = js.undefined
  
  /**
    * The description for the model packaging job. 
    */
  var ModelPackagingJobDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ModelPackagingJobDescription] = js.undefined
  
  /**
    * The AWS service used to package the job. Currently Lookout for Vision can package jobs with AWS IoT Greengrass. 
    */
  var ModelPackagingMethod: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ModelPackagingMethod] = js.undefined
  
  /**
    * Information about the output of the model packaging job. For more information, see DescribeModelPackagingJob. 
    */
  var ModelPackagingOutputDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ModelPackagingOutputDetails] = js.undefined
  
  /**
    * The version of the model used in the model packaging job. 
    */
  var ModelVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ModelVersion] = js.undefined
  
  /**
    * The name of the project that's associated with a model that's in the model package. 
    */
  var ProjectName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ProjectName] = js.undefined
