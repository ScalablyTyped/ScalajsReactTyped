...
trait GreengrassOutputDetails extends StObject {
  ...
  /**
    ...
    */
  var ComponentName: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ComponentName] = js.undefined
  ...
  /**
    ...
    */
  var ComponentVersionArn: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ComponentVersionArn] = js.undefined
}
