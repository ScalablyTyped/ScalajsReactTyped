...
trait GreengrassConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CompilerOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.CompilerOptions] = js.undefined
  
  /**
    *  A description for the AWS IoT Greengrass component. 
    */
  var ComponentDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ComponentDescription] = js.undefined
  
  /**
    *  A name for the AWS IoT Greengrass component. 
    */
  var ComponentName: typingsJapgolly.awsSdk.clientsLookoutvisionMod.ComponentName
  
  /**
    * A Version for the AWS IoT Greengrass component. If you don't provide a value, a default value of  Model Version.0.0 is used. 
    */
  var ComponentVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.ComponentVersion] = js.undefined
  ...
  /**
    ...
    */
  var TargetDevice: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.TargetDevice] = js.undefined
  
  /**
    * The target platform for the model. If you specify TargetPlatform, you can't specify TargetDevice. 
    */
  var TargetPlatform: js.UndefOr[typingsJapgolly.awsSdk.clientsLookoutvisionMod.TargetPlatform] = js.undefined
}
