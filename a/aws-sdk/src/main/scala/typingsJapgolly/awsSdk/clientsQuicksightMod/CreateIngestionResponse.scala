...
trait CreateIngestionResponse extends StObject {
  ...
  /**
    ...
    */
  var IngestionId: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.IngestionId] = js.undefined
  
  /**
    * The ingestion status.
    */
  var IngestionStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.IngestionStatus] = js.undefined
