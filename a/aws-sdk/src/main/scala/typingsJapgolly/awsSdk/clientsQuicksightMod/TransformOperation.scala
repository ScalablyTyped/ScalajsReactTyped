...
trait TransformOperation extends StObject {
  ...
  /**
    ...
    */
  var CastColumnTypeOperation: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.CastColumnTypeOperation] = js.undefined
  
  /**
    * An operation that creates calculated columns. Columns created in one such operation form a lexical closure.
    */
  var CreateColumnsOperation: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.CreateColumnsOperation] = js.undefined
  
  /**
    * An operation that filters rows based on some condition.
    */
  var FilterOperation: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.FilterOperation] = js.undefined
  
  /**
    * An operation that projects columns. Operations that come after a projection can only refer to projected columns.
    */
  var ProjectOperation: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.ProjectOperation] = js.undefined
  
  /**
    * An operation that renames a column.
    */
  var RenameColumnOperation: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.RenameColumnOperation] = js.undefined
  
  /**
    * An operation that tags a column with additional information.
    */
  var TagColumnOperation: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.TagColumnOperation] = js.undefined
  
  var UntagColumnOperation: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.UntagColumnOperation] = js.undefined
}
