...
trait PhysicalTable extends StObject {
  ...
  /**
    ...
    */
  var CustomSql: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.CustomSql] = js.undefined
  
  /**
    * A physical table type for relational data sources.
    */
  var RelationalTable: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.RelationalTable] = js.undefined
  
  /**
    * A physical table type for as S3 data source.
    */
  var S3Source: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.S3Source] = js.undefined
}
