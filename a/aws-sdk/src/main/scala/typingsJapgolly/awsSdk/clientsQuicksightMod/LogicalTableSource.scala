...
trait LogicalTableSource extends StObject {
  ...
  /**
    ...
    */
  var JoinInstruction: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.JoinInstruction] = js.undefined
  
  /**
    * Physical table ID.
    */
  var PhysicalTableId: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.PhysicalTableId] = js.undefined
}
