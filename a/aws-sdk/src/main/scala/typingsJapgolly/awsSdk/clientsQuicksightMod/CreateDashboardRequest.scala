...
trait CreateDashboardRequest extends StObject {
  ...
  /**
    ...
    */
  var DashboardPublishOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.DashboardPublishOptions] = js.undefined
  ...
  /**
    ...
    */
  var Parameters: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.Parameters] = js.undefined
