...
trait UploadSettings extends StObject {
  ...
  /**
    ...
    */
  var Delimiter: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.Delimiter] = js.undefined
  ...
  /**
    * Text qualifier.
    */
  var TextQualifier: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.TextQualifier] = js.undefined
}
