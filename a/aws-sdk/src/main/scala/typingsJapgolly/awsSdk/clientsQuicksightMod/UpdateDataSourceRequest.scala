...
trait UpdateDataSourceRequest extends StObject {
  ...
  /**
    ...
    */
  var DataSourceParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.DataSourceParameters] = js.undefined
  ...
  /**
    ...
    */
  var SslProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.SslProperties] = js.undefined
  
  /**
    * Use this parameter only when you want Amazon QuickSight to use a VPC connection when connecting to your underlying source.
    */
  var VpcConnectionProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.VpcConnectionProperties] = js.undefined
}
