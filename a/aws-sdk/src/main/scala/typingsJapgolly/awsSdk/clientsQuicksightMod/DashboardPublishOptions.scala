...
trait DashboardPublishOptions extends StObject {
  ...
  /**
    ...
    */
  var AdHocFilteringOption: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.AdHocFilteringOption] = js.undefined
  
  /**
    * Export to .csv option.
    */
  var ExportToCSVOption: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.ExportToCSVOption] = js.undefined
  
  /**
    * Sheet controls option.
    */
  var SheetControlsOption: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.SheetControlsOption] = js.undefined
}
