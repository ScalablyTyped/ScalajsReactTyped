...
trait DataSetConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ColumnGroupSchemaList: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.ColumnGroupSchemaList] = js.undefined
  
  /**
    * Dataset schema.
    */
  var DataSetSchema: js.UndefOr[typingsJapgolly.awsSdk.clientsQuicksightMod.DataSetSchema] = js.undefined
