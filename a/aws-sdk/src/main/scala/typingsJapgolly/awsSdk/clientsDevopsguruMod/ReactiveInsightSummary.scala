...
trait ReactiveInsightSummary extends StObject {
  
  /**
    * The Amazon Resource Names (ARNs) of the Amazon Web Services resources that generated this insight.
    */
  var AssociatedResourceArns: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.AssociatedResourceArns] = js.undefined
...
object ReactiveInsightSummary {
  ...
  inline def apply(): ReactiveInsightSummary = {
