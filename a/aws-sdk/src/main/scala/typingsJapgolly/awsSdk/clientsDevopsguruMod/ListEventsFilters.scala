...
trait ListEventsFilters extends StObject {
  ...
  /**
    ...
    */
  var EventTimeRange: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.EventTimeRange] = js.undefined
  
  /**
    *  An ID of an insight that is related to the events you want to filter for. 
    */
  var InsightId: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.InsightId] = js.undefined
