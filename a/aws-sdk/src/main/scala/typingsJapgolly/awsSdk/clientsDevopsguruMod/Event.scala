...
trait Event extends StObject {
  ...
  /**
    ...
    */
  var EventClass: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.EventClass] = js.undefined
  
  /**
    *  The Amazon Web Services source that emitted the event. 
    */
  var EventSource: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.EventSource] = js.undefined
