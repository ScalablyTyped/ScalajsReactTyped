...
trait ReactiveAnomaly extends StObject {
  
  /**
    *  An AnomalyReportedTimeRange object that specifies the time range between when the anomaly is opened and the time when it is closed. 
    */
  var AnomalyReportedTimeRange: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.AnomalyReportedTimeRange] = js.undefined
  
  /**
    * The Amazon Web Services resources in which anomalous behavior was detected by DevOps Guru.
    */
  var AnomalyResources: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.AnomalyResources] = js.undefined
  
  var AnomalyTimeRange: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.AnomalyTimeRange] = js.undefined
...
object ReactiveAnomaly {
  ...
  inline def apply(): ReactiveAnomaly = {
