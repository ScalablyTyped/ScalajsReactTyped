...
trait AnomalousLogGroup extends StObject {
  ...
  /**
    ...
    */
  var LogAnomalyShowcases: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.LogAnomalyShowcases] = js.undefined
  
  /**
    *  The name of the CloudWatch log group. 
    */
  var LogGroupName: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.LogGroupName] = js.undefined
  
  /**
    *  The number of log lines that were scanned for anomalous log events. 
    */
  var NumberOfLogLinesScanned: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.NumberOfLogLinesScanned] = js.undefined
}
