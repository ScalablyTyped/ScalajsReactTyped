...
trait ListAnomaliesForInsightResponse extends StObject {
  ...
  /**
    ...
    */
  var ProactiveAnomalies: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.ProactiveAnomalies] = js.undefined
  
  /**
    *  An array of ReactiveAnomalySummary objects that represent the requested anomalies 
    */
  var ReactiveAnomalies: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.ReactiveAnomalies] = js.undefined
}
