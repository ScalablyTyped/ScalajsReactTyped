...
trait ListAnomalousLogGroupsResponse extends StObject {
  ...
  /**
    ...
    */
  var AnomalousLogGroups: typingsJapgolly.awsSdk.clientsDevopsguruMod.AnomalousLogGroups
  
  /**
    *  The ID of the insight containing the log groups. 
    */
  var InsightId: typingsJapgolly.awsSdk.clientsDevopsguruMod.InsightId
