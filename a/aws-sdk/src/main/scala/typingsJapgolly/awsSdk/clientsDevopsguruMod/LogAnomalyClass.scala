...
trait LogAnomalyClass extends StObject {
  ...
  /**
    ...
    */
  var Explanation: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.Explanation] = js.undefined
  
  /**
    *  The token where the anomaly was detected. This may refer to an exception or another location, or it may be blank for log anomalies such as format anomalies. 
    */
  var LogAnomalyToken: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.LogAnomalyToken] = js.undefined
  
  /**
    *  The type of log anomaly that has been detected. 
    */
  var LogAnomalyType: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.LogAnomalyType] = js.undefined
  
  /**
    *  The ID of the log event. 
    */
  var LogEventId: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.LogEventId] = js.undefined
  ...
  /**
    ...
    */
  var LogStreamName: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.LogStreamName] = js.undefined
  
  /**
    *  The number of log lines where this anomalous log event occurs. 
    */
  var NumberOfLogLinesOccurrences: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.NumberOfLogLinesOccurrences] = js.undefined
}
object LogAnomalyClass {
  ...
  extension [Self <: LogAnomalyClass](x: Self) {
