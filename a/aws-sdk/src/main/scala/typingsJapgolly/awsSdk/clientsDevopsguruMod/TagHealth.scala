...
trait TagHealth extends StObject {
  ...
  /**
    ...
    */
  var AppBoundaryKey: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.AppBoundaryKey] = js.undefined
  ...
  /**
    ...
    */
  var TagValue: js.UndefOr[typingsJapgolly.awsSdk.clientsDevopsguruMod.TagValue] = js.undefined
}
object TagHealth {
