...
trait ListMonitoredResourcesFilters extends StObject {
  ...
  /**
    ...
    */
  var ResourcePermission: typingsJapgolly.awsSdk.clientsDevopsguruMod.ResourcePermission
  
  /**
    *  The type of resource that you wish to retrieve, such as log groups. 
    */
  var ResourceTypeFilters: typingsJapgolly.awsSdk.clientsDevopsguruMod.ResourceTypeFilters
}
