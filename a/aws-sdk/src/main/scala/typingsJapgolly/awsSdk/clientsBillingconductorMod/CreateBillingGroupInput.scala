...
trait CreateBillingGroupInput extends StObject {
  ...
  /**
    ...
    */
  var AccountGrouping: typingsJapgolly.awsSdk.clientsBillingconductorMod.AccountGrouping
  
  /**
    *  The token that is needed to support idempotency. Idempotency isn't currently supported, but will be implemented in a future update. 
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.ClientToken] = js.undefined
  
  /**
    *  The preferences and settings that will be used to compute the Amazon Web Services charges for a billing group. 
    */
  var ComputationPreference: typingsJapgolly.awsSdk.clientsBillingconductorMod.ComputationPreference
