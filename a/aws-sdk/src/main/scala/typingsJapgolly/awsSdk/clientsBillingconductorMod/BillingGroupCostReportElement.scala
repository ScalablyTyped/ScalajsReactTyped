...
trait BillingGroupCostReportElement extends StObject {
  ...
  /**
    ...
    */
  var AWSCost: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.AWSCost] = js.undefined
  ...
  /**
    ...
    */
  var Currency: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.Currency] = js.undefined
  
  /**
    *  The billing group margin. 
    */
  var Margin: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.Margin] = js.undefined
  
  /**
    *  The percentage of billing group margin. 
    */
  var MarginPercentage: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.MarginPercentage] = js.undefined
  
  /**
    * The hypothetical Amazon Web Services charges based on the associated pricing plan of a billing group. 
    */
  var ProformaCost: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.ProformaCost] = js.undefined
}
