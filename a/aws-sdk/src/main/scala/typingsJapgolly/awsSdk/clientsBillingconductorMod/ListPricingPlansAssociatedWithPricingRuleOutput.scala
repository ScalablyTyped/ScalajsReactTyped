...
trait ListPricingPlansAssociatedWithPricingRuleOutput extends StObject {
  ...
  /**
    ...
    */
  var PricingPlanArns: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.PricingPlanArns] = js.undefined
  
  /**
    *  The pricing rule Amazon Resource Name (ARN) for which associations will be listed. 
    */
  var PricingRuleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.PricingRuleArn] = js.undefined
}
