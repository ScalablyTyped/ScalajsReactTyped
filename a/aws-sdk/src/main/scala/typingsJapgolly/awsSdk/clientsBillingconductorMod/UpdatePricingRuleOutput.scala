...
trait UpdatePricingRuleOutput extends StObject {
  ...
  /**
    ...
    */
  var ModifierPercentage: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.ModifierPercentage] = js.undefined
  ...
  /**
    ...
    */
  var Service: js.UndefOr[typingsJapgolly.awsSdk.clientsBillingconductorMod.Service] = js.undefined
