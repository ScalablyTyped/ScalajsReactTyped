...
trait GetTerminologyResponse extends js.Object {
  /**
    ...
    */
  var TerminologyDataLocation: js.UndefOr[typingsJapgolly.awsSdk.translateMod.TerminologyDataLocation] = js.native
  /**
    * The properties of the custom terminology being retrieved.
    */
  var TerminologyProperties: js.UndefOr[typingsJapgolly.awsSdk.translateMod.TerminologyProperties] = js.native
}
