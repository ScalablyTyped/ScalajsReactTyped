...
trait TextTranslationJobProperties extends js.Object {
  ...
  /**
    ...
    */
  var InputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.translateMod.InputDataConfig] = js.native
  /**
    * The number of documents successfully and unsuccessfully processed during the translation job.
    */
  var JobDetails: js.UndefOr[typingsJapgolly.awsSdk.translateMod.JobDetails] = js.native
  /**
    * The ID of the translation job.
    */
  var JobId: js.UndefOr[typingsJapgolly.awsSdk.translateMod.JobId] = js.native
  /**
    * The user-defined name of the translation job.
    */
  var JobName: js.UndefOr[typingsJapgolly.awsSdk.translateMod.JobName] = js.native
  /**
    * The status of the translation job.
    */
  var JobStatus: js.UndefOr[typingsJapgolly.awsSdk.translateMod.JobStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.translateMod.OutputDataConfig] = js.native
  /**
