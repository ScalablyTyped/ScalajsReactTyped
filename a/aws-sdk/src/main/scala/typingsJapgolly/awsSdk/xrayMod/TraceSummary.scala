...
trait TraceSummary extends js.Object {
  /**
    ...
    */
  var Annotations: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.Annotations] = js.native
  /**
  ...
  /**
    ...
    */
  var ErrorRootCauses: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.ErrorRootCauses] = js.native
  /**
    * A collection of FaultRootCause structures corresponding to the the trace segments.
    */
  var FaultRootCauses: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.FaultRootCauses] = js.native
  /**
  ...
  /**
    ...
    */
  var Http: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.Http] = js.native
  /**
  ...
  /**
    ...
    */
  var ResponseTimeRootCauses: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.ResponseTimeRootCauses] = js.native
  /**
