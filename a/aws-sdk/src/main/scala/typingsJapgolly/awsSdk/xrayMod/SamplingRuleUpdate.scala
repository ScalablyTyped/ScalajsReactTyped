...
trait SamplingRuleUpdate extends js.Object {
  ...
  /**
    ...
    */
  var HTTPMethod: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.HTTPMethod] = js.native
  /**
    * Matches the hostname from a request URL.
    */
  var Host: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.Host] = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceName: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.ServiceName] = js.native
  /**
    * Matches the origin that the service uses to identify its type in segments.
    */
  var ServiceType: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.ServiceType] = js.native
  /**
    * Matches the path from a request URL.
    */
  var URLPath: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.URLPath] = js.native
}
