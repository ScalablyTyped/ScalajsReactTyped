...
trait GetTraceSummariesRequest extends js.Object {
  ...
  /**
    ...
    */
  var SamplingStrategy: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.SamplingStrategy] = js.native
  /**
  ...
  /**
    ...
    */
  var TimeRangeType: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.TimeRangeType] = js.native
}
