...
trait ValueWithServiceIds extends js.Object {
  /**
    ...
    */
  var AnnotationValue: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.AnnotationValue] = js.native
  /**
    * Services to which the annotation applies.
    */
  var ServiceIds: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.ServiceIds] = js.native
}
