...
trait ServiceStatistics extends js.Object {
  /**
    ...
    */
  var ErrorStatistics: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.ErrorStatistics] = js.native
  /**
    * Information about requests that failed with a 5xx Server Error status code.
    */
  var FaultStatistics: js.UndefOr[typingsJapgolly.awsSdk.xrayMod.FaultStatistics] = js.native
  /**
