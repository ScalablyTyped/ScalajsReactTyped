...
trait DescribeFlowResponse extends js.Object {
  var Flow: js.UndefOr[typingsJapgolly.awsSdk.mediaconnectMod.Flow] = js.native
  var Messages: js.UndefOr[typingsJapgolly.awsSdk.mediaconnectMod.Messages] = js.native
}
