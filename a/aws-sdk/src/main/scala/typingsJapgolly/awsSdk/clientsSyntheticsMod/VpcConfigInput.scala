...
trait VpcConfigInput extends StObject {
  ...
  /**
    ...
    */
  var SecurityGroupIds: js.UndefOr[typingsJapgolly.awsSdk.clientsSyntheticsMod.SecurityGroupIds] = js.undefined
  
  /**
    * The IDs of the subnets where this canary is to run.
    */
  var SubnetIds: js.UndefOr[typingsJapgolly.awsSdk.clientsSyntheticsMod.SubnetIds] = js.undefined
}
