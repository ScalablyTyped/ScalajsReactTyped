...
trait BulkEmailEntry extends StObject {
  ...
  /**
    ...
    */
  var Destination: typingsJapgolly.awsSdk.clientsSesv2Mod.Destination
  
  /**
    * The ReplacementEmailContent associated with a BulkEmailEntry.
    */
  var ReplacementEmailContent: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ReplacementEmailContent] = js.undefined
