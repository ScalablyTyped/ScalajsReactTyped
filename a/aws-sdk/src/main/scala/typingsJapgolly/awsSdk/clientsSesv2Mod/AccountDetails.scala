...
trait AccountDetails extends StObject {
  ...
  /**
    ...
    */
  var AdditionalContactEmailAddresses: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.AdditionalContactEmailAddresses] = js.undefined
  
  /**
    * The language you would prefer for the case. The contact language can be one of ENGLISH or JAPANESE.
    */
  var ContactLanguage: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ContactLanguage] = js.undefined
  ...
  /**
    ...
    */
  var MailType: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.MailType] = js.undefined
  
  /**
    * Information about the review of the latest details you submitted.
    */
  var ReviewDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ReviewDetails] = js.undefined
  
  /**
    * A description of the types of email that you plan to send.
    */
  var UseCaseDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.UseCaseDescription] = js.undefined
  
  /**
    * The URL of your website. This information helps us better understand the type of content that you plan to send.
    */
  var WebsiteURL: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.WebsiteURL] = js.undefined
}
