...
trait CustomVerificationEmailTemplateMetadata extends StObject {
  ...
  /**
    ...
    */
  var FailureRedirectionURL: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.FailureRedirectionURL] = js.undefined
  ...
  /**
    ...
    */
  var SuccessRedirectionURL: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.SuccessRedirectionURL] = js.undefined
...
object CustomVerificationEmailTemplateMetadata {
  ...
  extension [Self <: CustomVerificationEmailTemplateMetadata](x: Self) {
