...
trait GetImportJobResponse extends StObject {
  ...
  /**
    ...
    */
  var FailedRecordsCount: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.FailedRecordsCount] = js.undefined
  
  /**
    * The failure details about an import job.
    */
  var FailureInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.FailureInfo] = js.undefined
  
  /**
    * The data source of the import job.
    */
  var ImportDataSource: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ImportDataSource] = js.undefined
  
  /**
    * The destination of the import job.
    */
  var ImportDestination: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ImportDestination] = js.undefined
  ...
  /**
    ...
    */
  var JobStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.JobStatus] = js.undefined
  
  /**
    * The current number of records processed.
    */
  var ProcessedRecordsCount: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ProcessedRecordsCount] = js.undefined
}
