...
trait ImportDestination extends StObject {
  ...
  /**
    ...
    */
  var ContactListDestination: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ContactListDestination] = js.undefined
  
  /**
    * An object that contains the action of the import job towards suppression list.
    */
  var SuppressionListDestination: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.SuppressionListDestination] = js.undefined
}
