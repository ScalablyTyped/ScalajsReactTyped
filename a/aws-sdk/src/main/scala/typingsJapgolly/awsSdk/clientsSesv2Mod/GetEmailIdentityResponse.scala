...
trait GetEmailIdentityResponse extends StObject {
  ...
  /**
    ...
    */
  var ConfigurationSetName: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ConfigurationSetName] = js.undefined
  
  /**
    * An object that contains information about the DKIM attributes for the identity.
    */
  var DkimAttributes: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.DkimAttributes] = js.undefined
  ...
  /**
    ...
    */
  var IdentityType: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.IdentityType] = js.undefined
  
  /**
    * An object that contains information about the Mail-From attributes for the email identity.
    */
  var MailFromAttributes: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.MailFromAttributes] = js.undefined
