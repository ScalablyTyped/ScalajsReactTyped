...
trait CreateConfigurationSetRequest extends StObject {
  ...
  /**
    ...
    */
  var DeliveryOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.DeliveryOptions] = js.undefined
  
  /**
    * An object that defines whether or not Amazon SES collects reputation metrics for the emails that you send that use the configuration set.
    */
  var ReputationOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.ReputationOptions] = js.undefined
  
  /**
    * An object that defines whether or not Amazon SES can send email that you send using the configuration set.
    */
  var SendingOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.SendingOptions] = js.undefined
  
  var SuppressionOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.SuppressionOptions] = js.undefined
  ...
  /**
    ...
    */
  var TrackingOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.TrackingOptions] = js.undefined
}
