...
trait CreateImportJobRequest extends StObject {
  ...
  /**
    ...
    */
  var ImportDataSource: typingsJapgolly.awsSdk.clientsSesv2Mod.ImportDataSource
  
  /**
    * The destination for the import job.
    */
  var ImportDestination: typingsJapgolly.awsSdk.clientsSesv2Mod.ImportDestination
}
