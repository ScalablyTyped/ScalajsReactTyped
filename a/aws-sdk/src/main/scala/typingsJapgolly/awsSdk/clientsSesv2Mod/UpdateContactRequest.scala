...
trait UpdateContactRequest extends StObject {
  ...
  /**
    ...
    */
  var AttributesData: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.AttributesData] = js.undefined
  ...
  /**
    ...
    */
  var UnsubscribeAll: js.UndefOr[typingsJapgolly.awsSdk.clientsSesv2Mod.UnsubscribeAll] = js.undefined
}
object UpdateContactRequest {
  
  inline def apply(ContactListName: ContactListName, EmailAddress: EmailAddress): UpdateContactRequest = {
