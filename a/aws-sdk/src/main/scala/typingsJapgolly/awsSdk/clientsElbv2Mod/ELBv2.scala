...
import typingsJapgolly.awsSdk.anon.DescribeLoadBalancersInpu
import typingsJapgolly.awsSdk.awsSdkStrings.loadBalancerAvailable
import typingsJapgolly.awsSdk.awsSdkStrings.loadBalancerExists
import typingsJapgolly.awsSdk.awsSdkStrings.loadBalancersDeleted
import typingsJapgolly.awsSdk.awsSdkStrings.targetDeregistered
import typingsJapgolly.awsSdk.awsSdkStrings.targetInService
...
trait ELBv2 extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_targetDeregistered(state: targetDeregistered, params: typingsJapgolly.awsSdk.anon.DescribeTargetHealthInput): Request[DescribeTargetHealthOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_targetDeregistered(
    state: targetDeregistered,
    params: typingsJapgolly.awsSdk.anon.DescribeTargetHealthInput,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeTargetHealthOutput, Unit]
  ): Request[DescribeTargetHealthOutput, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_targetInService(state: targetInService, params: typingsJapgolly.awsSdk.anon.DescribeTargetHealthInput): Request[DescribeTargetHealthOutput, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_targetInService(
    state: targetInService,
    params: typingsJapgolly.awsSdk.anon.DescribeTargetHealthInput,
