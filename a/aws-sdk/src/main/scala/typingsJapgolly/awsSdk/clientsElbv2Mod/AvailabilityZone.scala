...
trait AvailabilityZone extends StObject {
  ...
  /**
    ...
    */
  var LoadBalancerAddresses: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.LoadBalancerAddresses] = js.undefined
  
  /**
    * [Application Load Balancers on Outposts] The ID of the Outpost.
    */
  var OutpostId: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.OutpostId] = js.undefined
  
  /**
    * The ID of the subnet. You can specify one subnet per Availability Zone.
    */
  var SubnetId: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.SubnetId] = js.undefined
  
  /**
    * The name of the Availability Zone.
    */
  var ZoneName: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.ZoneName] = js.undefined
}
