...
trait LoadBalancerAddress extends StObject {
  ...
  /**
    ...
    */
  var AllocationId: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.AllocationId] = js.undefined
  
  /**
    * [Network Load Balancers] The IPv6 address.
    */
  var IPv6Address: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.IPv6Address] = js.undefined
  
  /**
    * The static IP address.
    */
  var IpAddress: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.IpAddress] = js.undefined
  
  /**
    * [Network Load Balancers] The private IPv4 address for an internal load balancer.
    */
  var PrivateIPv4Address: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.PrivateIPv4Address] = js.undefined
}
