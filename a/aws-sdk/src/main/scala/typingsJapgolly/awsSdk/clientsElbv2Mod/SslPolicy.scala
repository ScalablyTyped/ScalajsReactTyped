...
trait SslPolicy extends StObject {
  ...
  /**
    * The ciphers.
    */
  var Ciphers: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.Ciphers] = js.undefined
  ...
  /**
    * The protocols.
    */
  var SslProtocols: js.UndefOr[typingsJapgolly.awsSdk.clientsElbv2Mod.SslProtocols] = js.undefined
