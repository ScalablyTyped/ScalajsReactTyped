...
trait ListSignalCatalogNodesRequest extends StObject {
...
object ListSignalCatalogNodesRequest {
  ...
  inline def apply(name: resourceName): ListSignalCatalogNodesRequest = {
    val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any])
    __obj.asInstanceOf[ListSignalCatalogNodesRequest]
  }
  
  extension [Self <: ListSignalCatalogNodesRequest](x: Self) {
