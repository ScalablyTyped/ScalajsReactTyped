...
import typingsJapgolly.awsSdk.clientsDynamodbMod.^
...
object DynamoDB {
  ...
  open class Converter ()
    extends typingsJapgolly.awsSdk.clientsDynamodbMod.Converter
  /* static members */
  object Converter {
  ...
  open class DocumentClient ()
    extends typingsJapgolly.awsSdk.clientsDynamodbMod.DocumentClient {
