...
trait CreateEnvironmentInput extends StObject {
  ...
  /**
    ...
    */
  var AirflowConfigurationOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.AirflowConfigurationOptions] = js.undefined
  ...
  /**
    ...
    */
  var AirflowVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.AirflowVersion] = js.undefined
  ...
  /**
    ...
    */
  var EnvironmentClass: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.EnvironmentClass] = js.undefined
  ...
  /**
    ...
    */
  var KmsKey: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.KmsKey] = js.undefined
  ...
  /**
    ...
    */
  var MaxWorkers: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.MaxWorkers] = js.undefined
  
  /**
    * The minimum number of workers that you want to run in your environment. MWAA scales the number of Apache Airflow workers up to the number you specify in the MaxWorkers field. When there are no more tasks running, and no more in the queue, MWAA disposes of the extra workers leaving the worker count you specify in the MinWorkers field. For example, 2.
    */
  var MinWorkers: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.MinWorkers] = js.undefined
  ...
  /**
    ...
    */
  var NetworkConfiguration: typingsJapgolly.awsSdk.clientsMwaaMod.NetworkConfiguration
  ...
  /**
    ...
    */
  var Schedulers: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.Schedulers] = js.undefined
  ...
  /**
    ...
    */
  var WebserverAccessMode: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.WebserverAccessMode] = js.undefined
  
  /**
    * The day and time of the week in Coordinated Universal Time (UTC) 24-hour standard time to start weekly maintenance updates of your environment in the following format: DAY:HH:MM. For example: TUE:03:30. You can specify a start time in 30 minute increments only.
    */
  var WeeklyMaintenanceWindowStart: js.UndefOr[typingsJapgolly.awsSdk.clientsMwaaMod.WeeklyMaintenanceWindowStart] = js.undefined
}
