...
import typingsJapgolly.awsSdk.anon.DescribeAssetRequestwaite
import typingsJapgolly.awsSdk.anon.DescribePortalRequestwait
import typingsJapgolly.awsSdk.awsSdkStrings.assetActive
import typingsJapgolly.awsSdk.awsSdkStrings.assetModelActive
import typingsJapgolly.awsSdk.awsSdkStrings.assetModelNotExists
import typingsJapgolly.awsSdk.awsSdkStrings.assetNotExists
import typingsJapgolly.awsSdk.awsSdkStrings.portalActive
import typingsJapgolly.awsSdk.awsSdkStrings.portalNotExists
...
trait IoTSiteWise extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_assetModelActive(state: assetModelActive, params: typingsJapgolly.awsSdk.anon.DescribeAssetModelRequest): Request[DescribeAssetModelResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_assetModelActive(
    state: assetModelActive,
    params: typingsJapgolly.awsSdk.anon.DescribeAssetModelRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeAssetModelResponse, Unit]
  ): Request[DescribeAssetModelResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_assetModelNotExists(state: assetModelNotExists, params: typingsJapgolly.awsSdk.anon.DescribeAssetModelRequest): Request[DescribeAssetModelResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_assetModelNotExists(
    state: assetModelNotExists,
    params: typingsJapgolly.awsSdk.anon.DescribeAssetModelRequest,
