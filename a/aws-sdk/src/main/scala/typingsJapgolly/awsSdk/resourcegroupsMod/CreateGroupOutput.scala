...
trait CreateGroupOutput extends js.Object {
  /**
    ...
    */
  var Group: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupsMod.Group] = js.native
  /**
    * The resource query associated with the group.
    */
  var ResourceQuery: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupsMod.ResourceQuery] = js.native
  /**
    * The tags associated with the group.
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupsMod.Tags] = js.native
}
