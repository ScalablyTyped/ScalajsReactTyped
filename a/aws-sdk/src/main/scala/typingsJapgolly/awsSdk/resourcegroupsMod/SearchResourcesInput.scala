...
trait SearchResourcesInput extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupsMod.MaxResults] = js.native
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupsMod.NextToken] = js.native
  /**
    * The search query, using the same formats that are supported for resource group definition.
    */
  var ResourceQuery: typingsJapgolly.awsSdk.resourcegroupsMod.ResourceQuery = js.native
}
