...
trait PutFileSystemPolicyRequest extends js.Object {
  /**
    ...
    */
  var BypassPolicyLockoutSafetyCheck: js.UndefOr[typingsJapgolly.awsSdk.efsMod.BypassPolicyLockoutSafetyCheck] = js.native
  /**
  ...
  /**
    ...
    */
  var Policy: typingsJapgolly.awsSdk.efsMod.Policy = js.native
}
