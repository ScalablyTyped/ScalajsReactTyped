...
trait AccessPointDescription extends js.Object {
  /**
    ...
    */
  var AccessPointArn: js.UndefOr[typingsJapgolly.awsSdk.efsMod.AccessPointArn] = js.native
  /**
    * The ID of the access point, assigned by Amazon EFS.
    */
  var AccessPointId: js.UndefOr[typingsJapgolly.awsSdk.efsMod.AccessPointId] = js.native
  /**
    * The opaque string specified in the request to ensure idempotent creation.
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.efsMod.ClientToken] = js.native
  /**
    * The ID of the EFS file system that the access point applies to.
    */
  var FileSystemId: js.UndefOr[typingsJapgolly.awsSdk.efsMod.FileSystemId] = js.native
  /**
    * Identifies the lifecycle phase of the access point.
    */
  var LifeCycleState: js.UndefOr[typingsJapgolly.awsSdk.efsMod.LifeCycleState] = js.native
  /**
    * The name of the access point. This is the value of the Name tag.
    */
  var Name: js.UndefOr[typingsJapgolly.awsSdk.efsMod.Name] = js.native
  /**
  ...
  /**
    ...
    */
  var PosixUser: js.UndefOr[typingsJapgolly.awsSdk.efsMod.PosixUser] = js.native
  /**
    * The directory on the Amazon EFS file system that the access point exposes as the root directory to NFS clients using the access point.
    */
  var RootDirectory: js.UndefOr[typingsJapgolly.awsSdk.efsMod.RootDirectory] = js.native
  /**
    * The tags associated with the access point, presented as an array of Tag objects.
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.efsMod.Tags] = js.native
}
