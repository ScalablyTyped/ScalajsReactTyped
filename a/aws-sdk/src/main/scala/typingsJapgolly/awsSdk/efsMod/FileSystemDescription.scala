...
trait FileSystemDescription extends js.Object {
  ...
  /**
    ...
    */
  var CreationToken: typingsJapgolly.awsSdk.efsMod.CreationToken = js.native
  /**
    * A Boolean value that, if true, indicates that the file system is encrypted.
    */
  var Encrypted: js.UndefOr[typingsJapgolly.awsSdk.efsMod.Encrypted] = js.native
  /**
  ...
  /**
    ...
    */
  var KmsKeyId: js.UndefOr[typingsJapgolly.awsSdk.efsMod.KmsKeyId] = js.native
  /**
    * The lifecycle phase of the file system.
    */
  var LifeCycleState: typingsJapgolly.awsSdk.efsMod.LifeCycleState = js.native
  /**
  ...
  /**
    ...
    */
  var PerformanceMode: typingsJapgolly.awsSdk.efsMod.PerformanceMode = js.native
  /**
    ...
    */
  var ProvisionedThroughputInMibps: js.UndefOr[typingsJapgolly.awsSdk.efsMod.ProvisionedThroughputInMibps] = js.native
  /**
  ...
  /**
    ...
    */
  var ThroughputMode: js.UndefOr[typingsJapgolly.awsSdk.efsMod.ThroughputMode] = js.native
}
