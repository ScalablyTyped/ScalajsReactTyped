...
trait PosixUser extends js.Object {
  /**
    ...
    */
  var Gid: typingsJapgolly.awsSdk.efsMod.Gid = js.native
  /**
    * Secondary POSIX group IDs used for all file system operations using this access point.
    */
  var SecondaryGids: js.UndefOr[typingsJapgolly.awsSdk.efsMod.SecondaryGids] = js.native
  /**
    * The POSIX user ID used for all file system operations using this access point.
    */
  var Uid: typingsJapgolly.awsSdk.efsMod.Uid = js.native
}
