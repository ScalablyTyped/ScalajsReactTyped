...
trait ScalingPolicy extends js.Object {
  /**
    ...
    */
  var PolicyName: typingsJapgolly.awsSdk.autoscalingplansMod.PolicyName = js.native
  /**
    * The type of scaling policy.
    */
  var PolicyType: typingsJapgolly.awsSdk.autoscalingplansMod.PolicyType = js.native
  /**
    * The target tracking scaling policy. Includes support for predefined or customized metrics.
    */
  var TargetTrackingConfiguration: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.TargetTrackingConfiguration] = js.native
}
