...
trait ScalingPlanResource extends js.Object {
  ...
  /**
    ...
    */
  var ScalingPolicies: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.ScalingPolicies] = js.native
  /**
    ...
    */
  var ScalingStatusCode: typingsJapgolly.awsSdk.autoscalingplansMod.ScalingStatusCode = js.native
  /**
