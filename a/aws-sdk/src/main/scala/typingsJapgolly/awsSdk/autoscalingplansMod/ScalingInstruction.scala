...
trait ScalingInstruction extends js.Object {
  /**
    ...
    */
  var CustomizedLoadMetricSpecification: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.CustomizedLoadMetricSpecification] = js.native
  /**
    ...
    */
  var DisableDynamicScaling: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.DisableDynamicScaling] = js.native
  /**
  ...
  /**
    ...
    */
  var PredefinedLoadMetricSpecification: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.PredefinedLoadMetricSpecification] = js.native
  /**
    ...
    */
  var PredictiveScalingMaxCapacityBehavior: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.PredictiveScalingMaxCapacityBehavior] = js.native
  /**
  ...
  /**
    ...
    */
  var PredictiveScalingMode: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.PredictiveScalingMode] = js.native
  /**
  ...
  /**
    ...
    */
  var ScalableDimension: typingsJapgolly.awsSdk.autoscalingplansMod.ScalableDimension = js.native
  /**
    ...
    */
  var ScalingPolicyUpdateBehavior: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.ScalingPolicyUpdateBehavior] = js.native
  /**
    ...
    */
  var ScheduledActionBufferTime: js.UndefOr[typingsJapgolly.awsSdk.autoscalingplansMod.ScheduledActionBufferTime] = js.native
  /**
    * The namespace of the AWS service.
    */
  var ServiceNamespace: typingsJapgolly.awsSdk.autoscalingplansMod.ServiceNamespace = js.native
  /**
    ...
    */
  var TargetTrackingConfigurations: typingsJapgolly.awsSdk.autoscalingplansMod.TargetTrackingConfigurations = js.native
}
...
object ScalingInstruction {
  ...
  def apply(
    ...
    if (!js.isUndefined(DisableDynamicScaling)) __obj.updateDynamic("DisableDynamicScaling")(DisableDynamicScaling.asInstanceOf[js.Any])
