...
trait UpdateAction extends js.Object {
  ...
  /**
    ...
    */
  var ServiceUpdateSeverity: js.UndefOr[typingsJapgolly.awsSdk.elasticacheMod.ServiceUpdateSeverity] = js.native
  /**
    * The status of the service update
    */
  var ServiceUpdateStatus: js.UndefOr[typingsJapgolly.awsSdk.elasticacheMod.ServiceUpdateStatus] = js.native
  /**
    * Reflects the nature of the service update 
    */
  var ServiceUpdateType: js.UndefOr[typingsJapgolly.awsSdk.elasticacheMod.ServiceUpdateType] = js.native
  /**
    * If yes, all nodes in the replication group have been updated by the recommended apply-by date. If no, at least one node in the replication group have not been updated by the recommended apply-by date. If N/A, the replication group was created after the recommended apply-by date.
    */
  var SlaMet: js.UndefOr[typingsJapgolly.awsSdk.elasticacheMod.SlaMet] = js.native
  /**
  ...
  /**
    ...
    */
  var UpdateActionStatus: js.UndefOr[typingsJapgolly.awsSdk.elasticacheMod.UpdateActionStatus] = js.native
  /**
