...
trait SendBounceRequest extends js.Object {
  ...
  /**
    ...
    */
  var BouncedRecipientInfoList: typingsJapgolly.awsSdk.sesMod.BouncedRecipientInfoList = js.native
  /**
    * Human-readable text for the bounce message to explain the failure. If not specified, the text will be auto-generated based on the bounced recipient information.
    */
  var Explanation: js.UndefOr[typingsJapgolly.awsSdk.sesMod.Explanation] = js.native
  /**
    * Message-related DSN fields. If not specified, Amazon SES will choose the values.
    */
  var MessageDsn: js.UndefOr[typingsJapgolly.awsSdk.sesMod.MessageDsn] = js.native
  /**
