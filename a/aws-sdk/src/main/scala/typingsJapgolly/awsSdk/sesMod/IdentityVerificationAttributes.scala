...
trait IdentityVerificationAttributes extends js.Object {
  /**
    ...
    */
  var VerificationStatus: typingsJapgolly.awsSdk.sesMod.VerificationStatus = js.native
  /**
    * The verification token for a domain identity. Null for email address identities.
    */
  var VerificationToken: js.UndefOr[typingsJapgolly.awsSdk.sesMod.VerificationToken] = js.native
}
