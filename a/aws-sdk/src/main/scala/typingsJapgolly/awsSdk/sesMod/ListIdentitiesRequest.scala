...
trait ListIdentitiesRequest extends js.Object {
  /**
    ...
    */
  var IdentityType: js.UndefOr[typingsJapgolly.awsSdk.sesMod.IdentityType] = js.native
  /**
    * The maximum number of identities per page. Possible values are 1-1000 inclusive.
    */
  var MaxItems: js.UndefOr[typingsJapgolly.awsSdk.sesMod.MaxItems] = js.native
  /**
