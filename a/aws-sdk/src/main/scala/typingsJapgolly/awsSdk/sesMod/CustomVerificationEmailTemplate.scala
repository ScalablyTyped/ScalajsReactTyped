...
trait CustomVerificationEmailTemplate extends js.Object {
  /**
    ...
    */
  var FailureRedirectionURL: js.UndefOr[typingsJapgolly.awsSdk.sesMod.FailureRedirectionURL] = js.native
  /**
  ...
  /**
    ...
    */
  var SuccessRedirectionURL: js.UndefOr[typingsJapgolly.awsSdk.sesMod.SuccessRedirectionURL] = js.native
  /**
    * The name of the custom verification email template.
    */
  var TemplateName: js.UndefOr[typingsJapgolly.awsSdk.sesMod.TemplateName] = js.native
  /**
