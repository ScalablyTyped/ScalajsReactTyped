...
trait BouncedRecipientInfo extends js.Object {
  /**
    ...
    */
  var BounceType: js.UndefOr[typingsJapgolly.awsSdk.sesMod.BounceType] = js.native
  /**
  ...
  /**
    ...
    */
  var RecipientDsnFields: js.UndefOr[typingsJapgolly.awsSdk.sesMod.RecipientDsnFields] = js.native
}
