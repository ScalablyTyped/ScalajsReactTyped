...
trait ReservationAggregates extends js.Object {
  /**
    ...
    */
  var AmortizedRecurringFee: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.AmortizedRecurringFee] = js.native
  /**
    * The upfront cost of your reservation, amortized over the reservation period.
    */
  var AmortizedUpfrontFee: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.AmortizedUpfrontFee] = js.native
  /**
    ...
    */
  var NetRISavings: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.NetRISavings] = js.native
  /**
    * How much your reservation would cost if charged On-Demand rates.
    */
  var OnDemandCostOfRIHoursUsed: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.OnDemandCostOfRIHoursUsed] = js.native
  /**
    * How many reservation hours that you purchased.
    */
  var PurchasedHours: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.PurchasedHours] = js.native
  /**
    ...
    */
  var PurchasedUnits: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.PurchasedUnits] = js.native
  /**
    * The total number of reservation hours that you used.
    */
  var TotalActualHours: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.TotalActualHours] = js.native
  /**
    ...
    */
  var TotalActualUnits: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.TotalActualUnits] = js.native
  /**
    * The total cost of your reservation, amortized over the reservation period.
    */
  var TotalAmortizedFee: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.TotalAmortizedFee] = js.native
  /**
    * How much you could save if you use your entire reservation.
    */
  var TotalPotentialRISavings: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.TotalPotentialRISavings] = js.native
  /**
    * The number of reservation hours that you didn't use.
    */
  var UnusedHours: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.UnusedHours] = js.native
  /**
    ...
    */
  var UnusedUnits: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.UnusedUnits] = js.native
  /**
    * The percentage of reservation time that you used.
    */
  var UtilizationPercentage: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.UtilizationPercentage] = js.native
  /**
    ...
    */
  var UtilizationPercentageInUnits: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.UtilizationPercentageInUnits] = js.native
}
