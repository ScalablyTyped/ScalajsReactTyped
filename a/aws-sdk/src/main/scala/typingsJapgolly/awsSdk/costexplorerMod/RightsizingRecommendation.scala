...
trait RightsizingRecommendation extends js.Object {
  ...
  /**
    ...
    */
  var CurrentInstance: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.CurrentInstance] = js.native
  /**
    *  Details for modification recommendations. 
    */
  var ModifyRecommendationDetail: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.ModifyRecommendationDetail] = js.native
  /**
    * Recommendation to either terminate or modify the resource.
    */
  var RightsizingType: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.RightsizingType] = js.native
  /**
    * Details for termination recommendations.
    */
  var TerminateRecommendationDetail: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.TerminateRecommendationDetail] = js.native
}
