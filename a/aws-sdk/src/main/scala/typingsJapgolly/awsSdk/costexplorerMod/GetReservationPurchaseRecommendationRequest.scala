...
trait GetReservationPurchaseRecommendationRequest extends js.Object {
  ...
  /**
    ...
    */
  var AccountScope: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.AccountScope] = js.native
  /**
    * The number of previous days that you want AWS to consider when it calculates your recommendations.
    */
  var LookbackPeriodInDays: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.LookbackPeriodInDays] = js.native
  /**
  ...
  /**
    ...
    */
  var PaymentOption: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.PaymentOption] = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceSpecification: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.ServiceSpecification] = js.native
  /**
    * The reservation term that you want recommendations for.
    */
  var TermInYears: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.TermInYears] = js.native
}
