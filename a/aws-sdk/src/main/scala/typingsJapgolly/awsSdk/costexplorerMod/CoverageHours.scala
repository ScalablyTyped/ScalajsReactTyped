...
trait CoverageHours extends js.Object {
  /**
    ...
    */
  var CoverageHoursPercentage: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.CoverageHoursPercentage] = js.native
  /**
    * The number of instance running hours that On-Demand Instances covered.
    */
  var OnDemandHours: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.OnDemandHours] = js.native
  /**
    * The number of instance running hours that reservations covered.
    */
  var ReservedHours: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.ReservedHours] = js.native
  /**
    * The total instance usage, in hours.
    */
  var TotalRunningHours: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.TotalRunningHours] = js.native
}
