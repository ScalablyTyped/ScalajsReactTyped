...
trait GetSavingsPlansPurchaseRecommendationRequest extends js.Object {
  /**
    ...
    */
  var LookbackPeriodInDays: typingsJapgolly.awsSdk.costexplorerMod.LookbackPeriodInDays = js.native
  /**
  ...
  /**
    ...
    */
  var PaymentOption: typingsJapgolly.awsSdk.costexplorerMod.PaymentOption = js.native
  /**
  ...
  /**
    ...
    */
  var TermInYears: typingsJapgolly.awsSdk.costexplorerMod.TermInYears = js.native
}
