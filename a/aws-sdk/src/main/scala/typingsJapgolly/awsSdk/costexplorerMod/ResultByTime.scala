...
trait ResultByTime extends js.Object {
  /**
    ...
    */
  var Estimated: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.Estimated] = js.native
  /**
    * The groups that this time period includes.
    */
  var Groups: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.Groups] = js.native
  /**
