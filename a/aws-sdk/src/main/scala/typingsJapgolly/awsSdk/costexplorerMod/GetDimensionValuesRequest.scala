...
trait GetDimensionValuesRequest extends js.Object {
  /**
    ...
    */
  var Context: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.Context] = js.native
  /**
    * The name of the dimension. Each Dimension is available for a different Context. For more information, see Context. 
    */
  var Dimension: typingsJapgolly.awsSdk.costexplorerMod.Dimension = js.native
  /**
  ...
  /**
    ...
    */
  var SearchString: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.SearchString] = js.native
  /**
