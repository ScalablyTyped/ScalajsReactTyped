...
trait Coverage extends js.Object {
  /**
    ...
    */
  var CoverageCost: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.CoverageCost] = js.native
  /**
    * The amount of instance usage that the reservation covered, in hours.
    */
  var CoverageHours: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.CoverageHours] = js.native
  /**
    * The amount of instance usage that the reservation covered, in normalized units.
    */
  var CoverageNormalizedUnits: js.UndefOr[typingsJapgolly.awsSdk.costexplorerMod.CoverageNormalizedUnits] = js.native
}
