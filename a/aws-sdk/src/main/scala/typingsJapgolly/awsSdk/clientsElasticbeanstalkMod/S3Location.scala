...
trait S3Location extends StObject {
  ...
  /**
    ...
    */
  var S3Bucket: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.S3Bucket] = js.undefined
  
  /**
    * The Amazon S3 key where the data is located.
    */
  var S3Key: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.S3Key] = js.undefined
}
object S3Location {
