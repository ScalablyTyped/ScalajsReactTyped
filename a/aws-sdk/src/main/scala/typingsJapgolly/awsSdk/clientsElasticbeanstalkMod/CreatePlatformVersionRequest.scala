...
trait CreatePlatformVersionRequest extends StObject {
  ...
  /**
    ...
    */
  var PlatformName: typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformName
  
  /**
    * The number, such as 1.0.2, for the new platform version.
    */
  var PlatformVersion: typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformVersion
