...
trait AssociateEnvironmentOperationsRoleMessage extends StObject {
  ...
  /**
    ...
    */
  var EnvironmentName: typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.EnvironmentName
  
  /**
    * The Amazon Resource Name (ARN) of an existing IAM role to be used as the environment's operations role.
    */
  var OperationsRole: typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.OperationsRole
}
