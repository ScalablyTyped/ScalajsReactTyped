...
trait CustomAmi extends StObject {
  ...
  /**
    ...
    */
  var ImageId: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.ImageId] = js.undefined
  
  /**
    * The type of virtualization used to create the custom AMI.
    */
  var VirtualizationType: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.VirtualizationType] = js.undefined
}
object CustomAmi {
