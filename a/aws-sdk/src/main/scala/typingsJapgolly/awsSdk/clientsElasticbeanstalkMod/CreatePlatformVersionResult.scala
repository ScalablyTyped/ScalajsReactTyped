...
trait CreatePlatformVersionResult extends StObject {
  ...
  /**
    ...
    */
  var Builder: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.Builder] = js.undefined
  
  /**
    * Detailed information about the new version of the custom platform.
    */
  var PlatformSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformSummary] = js.undefined
}
