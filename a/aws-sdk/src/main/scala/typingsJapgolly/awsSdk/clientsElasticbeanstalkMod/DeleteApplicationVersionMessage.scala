...
trait DeleteApplicationVersionMessage extends StObject {
  ...
  /**
    ...
    */
  var DeleteSourceBundle: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.DeleteSourceBundle] = js.undefined
  
  /**
    * The label of the version to delete.
    */
  var VersionLabel: typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.VersionLabel
}
