...
trait PlatformSummary extends StObject {
  ...
  /**
    ...
    */
  var OperatingSystemName: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.OperatingSystemName] = js.undefined
  
  /**
    * The version of the operating system used by the platform version.
    */
  var OperatingSystemVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.OperatingSystemVersion] = js.undefined
  ...
  /**
    ...
    */
  var PlatformBranchLifecycleState: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformBranchLifecycleState] = js.undefined
  ...
  /**
    ...
    */
  var PlatformCategory: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformCategory] = js.undefined
  ...
  /**
    ...
    */
  var PlatformLifecycleState: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformLifecycleState] = js.undefined
  
  /**
    * The AWS account ID of the person who created the platform version.
    */
  var PlatformOwner: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformOwner] = js.undefined
  
  /**
    * The status of the platform version. You can create an environment from the platform version once it is ready.
    */
  var PlatformStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformStatus] = js.undefined
  
  /**
    * The version string of the platform version.
    */
  var PlatformVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.PlatformVersion] = js.undefined
  
  /**
    * The additions associated with the platform version.
    */
  var SupportedAddonList: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.SupportedAddonList] = js.undefined
