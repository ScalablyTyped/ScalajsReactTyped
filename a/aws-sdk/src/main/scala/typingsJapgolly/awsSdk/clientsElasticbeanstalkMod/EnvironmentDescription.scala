...
trait EnvironmentDescription extends StObject {
  ...
  /**
    ...
    */
  var AbortableOperationInProgress: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.AbortableOperationInProgress] = js.undefined
  ...
  /**
    ...
    */
  var EndpointURL: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.EndpointURL] = js.undefined
  
  /**
    * The environment's Amazon Resource Name (ARN), which can be used in other API requests that require an ARN.
    */
  var EnvironmentArn: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.EnvironmentArn] = js.undefined
  ...
  /**
    ...
    */
  var EnvironmentLinks: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.EnvironmentLinks] = js.undefined
