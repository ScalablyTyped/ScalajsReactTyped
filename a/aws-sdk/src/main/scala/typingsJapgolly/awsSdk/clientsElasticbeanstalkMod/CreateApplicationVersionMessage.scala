...
trait CreateApplicationVersionMessage extends StObject {
  ...
  /**
    ...
    */
  var AutoCreateApplication: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.AutoCreateApplication] = js.undefined
  
  /**
    * Settings for an AWS CodeBuild build.
    */
  var BuildConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticbeanstalkMod.BuildConfiguration] = js.undefined
