...
trait StandardsControl extends js.Object {
  ...
  /**
    ...
    */
  var ControlStatus: js.UndefOr[typingsJapgolly.awsSdk.securityhubMod.ControlStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var SeverityRating: js.UndefOr[typingsJapgolly.awsSdk.securityhubMod.SeverityRating] = js.native
  /**
...
object StandardsControl {
  ...
  def apply(
    ...
    ControlStatusUpdatedAt: js.Date = null,
