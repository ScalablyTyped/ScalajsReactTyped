...
trait Statement extends StObject {
  ...
  /**
    ...
    */
  var AndStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.AndStatement] = js.undefined
  
  /**
    * A rule statement that defines a string match search for WAF to apply to web requests. The byte match statement provides the bytes to search for, the location in requests that you want WAF to search, and other settings. The bytes to search for are typically a string that corresponds with ASCII characters. In the WAF console and the developer guide, this is called a string match statement.
    */
  var ByteMatchStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.ByteMatchStatement] = js.undefined
  
  /**
    * A rule statement used to identify web requests based on country of origin. 
    */
  var GeoMatchStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.GeoMatchStatement] = js.undefined
  ...
  /**
    ...
    */
  var IPSetReferenceStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.IPSetReferenceStatement] = js.undefined
  ...
  /**
    ...
    */
  var LabelMatchStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.LabelMatchStatement] = js.undefined
  ...
  /**
    ...
    */
  var ManagedRuleGroupStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.ManagedRuleGroupStatement] = js.undefined
  
  /**
    * A logical rule statement used to negate the results of another rule statement. You provide one Statement within the NotStatement.
    */
  var NotStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.NotStatement] = js.undefined
  
  /**
    * A logical rule statement used to combine other rule statements with OR logic. You provide more than one Statement within the OrStatement. 
    */
  var OrStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.OrStatement] = js.undefined
  ...
  /**
    ...
    */
  var RateBasedStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.RateBasedStatement] = js.undefined
  
  /**
    * A rule statement used to search web request components for a match against a single regular expression. 
    */
  var RegexMatchStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.RegexMatchStatement] = js.undefined
  ...
  /**
    ...
    */
  var RegexPatternSetReferenceStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.RegexPatternSetReferenceStatement] = js.undefined
  ...
  /**
    ...
    */
  var RuleGroupReferenceStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.RuleGroupReferenceStatement] = js.undefined
  ...
  /**
    ...
    */
  var SizeConstraintStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.SizeConstraintStatement] = js.undefined
  
  /**
    * A rule statement that inspects for malicious SQL code. Attackers insert malicious SQL code into web requests to do things like modify your database or extract data from it. 
    */
  var SqliMatchStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.SqliMatchStatement] = js.undefined
  
  /**
    * A rule statement that inspects for cross-site scripting (XSS) attacks. In XSS attacks, the attacker uses vulnerabilities in a benign website as a vehicle to inject malicious client-site scripts into other legitimate web browsers. 
    */
  var XssMatchStatement: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.XssMatchStatement] = js.undefined
}
object Statement {
