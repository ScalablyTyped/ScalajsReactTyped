...
trait FirewallManagerRuleGroup extends StObject {
  ...
  /**
    ...
    */
  var FirewallManagerStatement: typingsJapgolly.awsSdk.clientsWafv2Mod.FirewallManagerStatement
  ...
  /**
    ...
    */
  var OverrideAction: typingsJapgolly.awsSdk.clientsWafv2Mod.OverrideAction
