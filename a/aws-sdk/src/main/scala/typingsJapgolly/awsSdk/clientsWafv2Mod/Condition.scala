...
trait Condition extends StObject {
  ...
  /**
    ...
    */
  var ActionCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.ActionCondition] = js.undefined
  
  /**
    * A single label name condition. This is the fully qualified label name that a log record must contain in order to meet the condition. Fully qualified labels have a prefix, optional namespaces, and label name. The prefix identifies the rule group or web ACL context of the rule that added the label. 
    */
  var LabelNameCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.LabelNameCondition] = js.undefined
}
object Condition {
