...
trait ManagedRuleGroupConfig extends StObject {
  ...
  /**
    ...
    */
  var PasswordField: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.PasswordField] = js.undefined
  
  /**
    * The payload type for your login endpoint, either JSON or form encoded.
    */
  var PayloadType: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.PayloadType] = js.undefined
  
  /**
    * Details about your login page username field. 
    */
  var UsernameField: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.UsernameField] = js.undefined
}
