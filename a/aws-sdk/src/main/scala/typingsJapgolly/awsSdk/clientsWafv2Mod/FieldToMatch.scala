...
trait FieldToMatch extends StObject {
  ...
  /**
    ...
    */
  var AllQueryArguments: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.AllQueryArguments] = js.undefined
  ...
  /**
    ...
    */
  var Body: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.Body] = js.undefined
  ...
  /**
    ...
    */
  var Cookies: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.Cookies] = js.undefined
  ...
  /**
    ...
    */
  var Headers: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.Headers] = js.undefined
  ...
  /**
    ...
    */
  var JsonBody: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.JsonBody] = js.undefined
  
  /**
    * Inspect the HTTP method. The method indicates the type of operation that the request is asking the origin to perform. 
    */
  var Method: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.Method] = js.undefined
  
  /**
    * Inspect the query string. This is the part of a URL that appears after a ? character, if any.
    */
  var QueryString: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.QueryString] = js.undefined
  ...
  /**
    ...
    */
  var SingleHeader: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.SingleHeader] = js.undefined
  ...
  /**
    ...
    */
  var SingleQueryArgument: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.SingleQueryArgument] = js.undefined
  
  /**
    * Inspect the request URI path. This is the part of the web request that identifies a resource, for example, /images/daily-ad.jpg.
    */
  var UriPath: js.UndefOr[typingsJapgolly.awsSdk.clientsWafv2Mod.UriPath] = js.undefined
}
object FieldToMatch {
