...
trait GetQueryStatisticsResponse extends StObject {
  ...
  /**
    ...
    */
  var ExecutionStatistics: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.ExecutionStatistics] = js.undefined
  
  /**
    * A PlanningStatistics structure containing query planning statistics.
    */
  var PlanningStatistics: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.PlanningStatistics] = js.undefined
