...
trait DataLakeSettings extends StObject {
  ...
  /**
    ...
    */
  var AuthorizedSessionTagValueList: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.AuthorizedSessionTagValueList] = js.undefined
  ...
  /**
    ...
    */
  var TrustedResourceOwners: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.TrustedResourceOwners] = js.undefined
}
