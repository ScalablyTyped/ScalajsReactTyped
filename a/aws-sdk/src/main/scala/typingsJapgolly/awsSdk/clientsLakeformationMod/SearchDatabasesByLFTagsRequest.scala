...
trait SearchDatabasesByLFTagsRequest extends StObject {
  ...
  /**
    ...
    */
  var Expression: typingsJapgolly.awsSdk.clientsLakeformationMod.Expression
...
object SearchDatabasesByLFTagsRequest {
  ...
  inline def apply(Expression: Expression): SearchDatabasesByLFTagsRequest = {
