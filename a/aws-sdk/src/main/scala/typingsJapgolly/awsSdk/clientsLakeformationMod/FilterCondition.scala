...
trait FilterCondition extends StObject {
  ...
  /**
    ...
    */
  var ComparisonOperator: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.ComparisonOperator] = js.undefined
  ...
  /**
    ...
    */
  var StringValueList: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.StringValueList] = js.undefined
}
