...
trait DataCellsFilter extends StObject {
  ...
  /**
    ...
    */
  var ColumnNames: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.ColumnNames] = js.undefined
  
  /**
    * A wildcard with exclusions. You must specify either a ColumnNames list or the ColumnWildCard. 
    */
  var ColumnWildcard: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.ColumnWildcard] = js.undefined
  ...
  /**
    * A PartiQL predicate.
    */
  var RowFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsLakeformationMod.RowFilter] = js.undefined
