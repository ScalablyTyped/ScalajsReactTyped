...
trait ApiGatewayProxyConfig extends StObject {
  
  /**
    * The resource ID of the API Gateway for the proxy. 
    */
  var ApiGatewayId: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.ApiGatewayId] = js.undefined
  ...
  /**
    ...
    */
  var NlbArn: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.NlbArn] = js.undefined
  
  /**
    * The name of the Network Load Balancer that is configured by the API Gateway proxy. 
    */
  var NlbName: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.NlbName] = js.undefined
  ...
  /**
    ...
    */
  var StageName: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.StageName] = js.undefined
  
  /**
    * The VpcLink ID of the API Gateway proxy. 
    */
  var VpcLinkId: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.VpcLinkId] = js.undefined
}
object ApiGatewayProxyConfig {
  
  inline def apply(): ApiGatewayProxyConfig = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ApiGatewayProxyConfig]
  }
  
  extension [Self <: ApiGatewayProxyConfig](x: Self) {
