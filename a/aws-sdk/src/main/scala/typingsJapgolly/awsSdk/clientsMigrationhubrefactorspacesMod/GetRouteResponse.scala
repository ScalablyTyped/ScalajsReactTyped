...
trait GetRouteResponse extends StObject {
  ...
  /**
    ...
    */
  var PathResourceToId: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.PathResourceToId] = js.undefined
  ...
  /**
    ...
    */
  var RouteId: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.RouteId] = js.undefined
  
  /**
    * The type of route.
    */
  var RouteType: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.RouteType] = js.undefined
...
object GetRouteResponse {
  ...
  inline def apply(): GetRouteResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetRouteResponse]
  }
  
  extension [Self <: GetRouteResponse](x: Self) {
