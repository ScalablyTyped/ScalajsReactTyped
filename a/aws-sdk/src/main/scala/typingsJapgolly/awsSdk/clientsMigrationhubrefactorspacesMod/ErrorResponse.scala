...
trait ErrorResponse extends StObject {
  ...
  /**
    ...
    */
  var AccountId: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.AccountId] = js.undefined
  
  /**
    * Additional details about the error. 
    */
  var AdditionalDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.AdditionalDetails] = js.undefined
  ...
  /**
    ...
    */
  var ResourceIdentifier: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubrefactorspacesMod.ResourceIdentifier] = js.undefined
