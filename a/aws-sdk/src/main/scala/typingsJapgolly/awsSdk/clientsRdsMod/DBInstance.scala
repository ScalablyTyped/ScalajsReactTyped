...
trait DBInstance extends StObject {
  ...
  /**
    ...
    */
  var ActivityStreamMode: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.ActivityStreamMode] = js.undefined
  
  /**
    * The status of the policy state of the activity stream.
    */
  var ActivityStreamPolicyStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.ActivityStreamPolicyStatus] = js.undefined
  
  /**
    * The status of the database activity stream.
    */
  var ActivityStreamStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.ActivityStreamStatus] = js.undefined
  ...
  /**
    ...
    */
  var DBSubnetGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.DBSubnetGroup] = js.undefined
  ...
  /**
    ...
    */
  var Endpoint: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.Endpoint] = js.undefined
  ...
  /**
    ...
    */
  var PendingModifiedValues: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.PendingModifiedValues] = js.undefined
