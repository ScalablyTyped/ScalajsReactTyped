...
import typingsJapgolly.awsSdk.anon.DescribeDBClusterSnapshot
import typingsJapgolly.awsSdk.anon.DescribeDBInstancesMessagFilters
import typingsJapgolly.awsSdk.anon.DescribeDBSnapshotsMessag
import typingsJapgolly.awsSdk.awsSdkStrings.dBClusterAvailable
import typingsJapgolly.awsSdk.awsSdkStrings.dBClusterDeleted
...
trait RDS extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_dBClusterAvailable(state: dBClusterAvailable, params: typingsJapgolly.awsSdk.anon.DescribeDBClustersMessage): Request[DBClusterMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_dBClusterAvailable(
    state: dBClusterAvailable,
    params: typingsJapgolly.awsSdk.anon.DescribeDBClustersMessage,
    callback: js.Function2[/* err */ AWSError, /* data */ DBClusterMessage, Unit]
  ): Request[DBClusterMessage, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_dBClusterDeleted(state: dBClusterDeleted, params: typingsJapgolly.awsSdk.anon.DescribeDBClustersMessage): Request[DBClusterMessage, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_dBClusterDeleted(
    state: dBClusterDeleted,
    params: typingsJapgolly.awsSdk.anon.DescribeDBClustersMessage,
