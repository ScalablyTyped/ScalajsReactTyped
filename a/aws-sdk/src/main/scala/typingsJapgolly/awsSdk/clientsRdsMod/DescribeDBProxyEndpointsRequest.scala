...
trait DescribeDBProxyEndpointsRequest extends StObject {
  ...
  /**
    ...
    */
  var DBProxyEndpointName: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.DBProxyEndpointName] = js.undefined
  ...
  /**
    ...
    */
  var DBProxyName: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.DBProxyName] = js.undefined
  ...
  /**
    ...
    */
  var MaxRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.MaxRecords] = js.undefined
}
object DescribeDBProxyEndpointsRequest {
  ...
  extension [Self <: DescribeDBProxyEndpointsRequest](x: Self) {
