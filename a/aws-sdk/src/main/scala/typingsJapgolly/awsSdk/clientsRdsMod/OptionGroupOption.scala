...
trait OptionGroupOption extends StObject {
  ...
  /**
    ...
    */
  var OptionsConflictsWith: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.OptionsConflictsWith] = js.undefined
  
  /**
    * The options that are prerequisites for this option.
    */
  var OptionsDependedOn: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.OptionsDependedOn] = js.undefined
