...
trait OptionGroups extends StObject {
  ...
  /**
    ...
    */
  var OptionGroupsList: js.UndefOr[typingsJapgolly.awsSdk.clientsRdsMod.OptionGroupsList] = js.undefined
}
object OptionGroups {
  ...
  extension [Self <: OptionGroups](x: Self) {
    ...
    inline def setOptionGroupsListVarargs(value: OptionGroup*): Self = StObject.set(x, "OptionGroupsList", js.Array(value*))
  }
}
