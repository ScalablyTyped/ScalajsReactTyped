...
trait CreateDBProxyEndpointRequest extends StObject {
  ...
  /**
    ...
    */
  var DBProxyEndpointName: typingsJapgolly.awsSdk.clientsRdsMod.DBProxyEndpointName
  
  /**
    * The name of the DB proxy associated with the DB proxy endpoint that you create.
    */
  var DBProxyName: typingsJapgolly.awsSdk.clientsRdsMod.DBProxyName
...
object CreateDBProxyEndpointRequest {
  ...
  extension [Self <: CreateDBProxyEndpointRequest](x: Self) {
