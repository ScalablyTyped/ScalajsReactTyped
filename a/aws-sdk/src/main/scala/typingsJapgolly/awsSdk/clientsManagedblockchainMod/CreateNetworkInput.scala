...
trait CreateNetworkInput extends StObject {
  ...
  /**
    ...
    */
  var Framework: typingsJapgolly.awsSdk.clientsManagedblockchainMod.Framework
  ...
  /**
    ...
    */
  var VotingPolicy: typingsJapgolly.awsSdk.clientsManagedblockchainMod.VotingPolicy
}
