...
trait Network extends StObject {
  ...
  /**
    ...
    */
  var Framework: js.UndefOr[typingsJapgolly.awsSdk.clientsManagedblockchainMod.Framework] = js.undefined
  ...
  /**
    ...
    */
  var VotingPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsManagedblockchainMod.VotingPolicy] = js.undefined
