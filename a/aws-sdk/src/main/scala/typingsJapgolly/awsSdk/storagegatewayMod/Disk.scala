...
trait Disk extends js.Object {
  ...
  var DiskAllocationType: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.DiskAllocationType] = js.native
  var DiskAttributeList: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.DiskAttributeList] = js.native
  /**
    * The unique device ID or other distinguishing data that identifies a local disk.
    */
  var DiskId: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.DiskId] = js.native
  /**
