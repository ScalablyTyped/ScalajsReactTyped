...
trait DescribeSMBSettingsOutput extends js.Object {
  /**
    ...
    */
  var ActiveDirectoryStatus: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.ActiveDirectoryStatus] = js.native
  /**
    * The name of the domain that the gateway is joined to.
    */
  var DomainName: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.DomainName] = js.native
  ...
  /**
    ...
    */
  var SMBSecurityStrategy: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.SMBSecurityStrategy] = js.native
}
