...
trait UpdateVTLDeviceTypeInput extends js.Object {
  /**
    ...
    */
  var DeviceType: typingsJapgolly.awsSdk.storagegatewayMod.DeviceType = js.native
  /**
    * The Amazon Resource Name (ARN) of the medium changer you want to select.
    */
  var VTLDeviceARN: typingsJapgolly.awsSdk.storagegatewayMod.VTLDeviceARN = js.native
}
