...
trait StorediSCSIVolume extends js.Object {
  ...
  /**
    ...
    */
  var TargetName: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.TargetName] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeStatus: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.VolumeStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeUsedInBytes: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.VolumeUsedInBytes] = js.native
  /**
    * An VolumeiSCSIAttributes object that represents a collection of iSCSI attributes for one stored volume.
    */
  var VolumeiSCSIAttributes: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.VolumeiSCSIAttributes] = js.native
}
