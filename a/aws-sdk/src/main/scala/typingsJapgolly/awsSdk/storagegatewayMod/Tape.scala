...
trait Tape extends js.Object {
  ...
  /**
    ...
    */
  var PoolId: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.PoolId] = js.native
  /**
  ...
  /**
    ...
    */
  var TapeARN: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.TapeARN] = js.native
  /**
    * The barcode that identifies a specific virtual tape.
    */
  var TapeBarcode: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.TapeBarcode] = js.native
  /**
  ...
  /**
    ...
    */
  var TapeStatus: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.TapeStatus] = js.native
  /**
