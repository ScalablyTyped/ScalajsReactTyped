...
trait ActivateGatewayInput extends js.Object {
  /**
    ...
    */
  var ActivationKey: typingsJapgolly.awsSdk.storagegatewayMod.ActivationKey = js.native
  /**
    * The name you configured for your gateway.
    */
  var GatewayName: typingsJapgolly.awsSdk.storagegatewayMod.GatewayName = js.native
  /**
  ...
  /**
    ...
    */
  var GatewayTimezone: typingsJapgolly.awsSdk.storagegatewayMod.GatewayTimezone = js.native
  /**
  ...
  /**
    ...
    */
  var MediumChangerType: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.MediumChangerType] = js.native
  /**
  ...
  /**
    ...
    */
  var TapeDriveType: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.TapeDriveType] = js.native
}
