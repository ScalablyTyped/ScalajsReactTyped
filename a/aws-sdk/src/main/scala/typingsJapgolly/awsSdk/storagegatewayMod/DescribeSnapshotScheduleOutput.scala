...
trait DescribeSnapshotScheduleOutput extends js.Object {
  /**
    ...
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.Description] = js.native
  /**
    * The number of hours between snapshots.
    */
  var RecurrenceInHours: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.RecurrenceInHours] = js.native
  /**
