...
trait VTLDevice extends js.Object {
  /**
    ...
    */
  var DeviceiSCSIAttributes: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.DeviceiSCSIAttributes] = js.native
  /**
    * Specifies the unique Amazon Resource Name (ARN) of the device (tape drive or media changer).
    */
  var VTLDeviceARN: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.VTLDeviceARN] = js.native
  /**
    * Specifies the model number of device that the VTL device emulates.
    */
  var VTLDeviceProductIdentifier: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.VTLDeviceProductIdentifier] = js.native
  /**
    * Specifies the type of device that the VTL device emulates.
    */
  var VTLDeviceType: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.VTLDeviceType] = js.native
  /**
    * Specifies the vendor of the device that the VTL device object emulates.
    */
  var VTLDeviceVendor: js.UndefOr[typingsJapgolly.awsSdk.storagegatewayMod.VTLDeviceVendor] = js.native
}
