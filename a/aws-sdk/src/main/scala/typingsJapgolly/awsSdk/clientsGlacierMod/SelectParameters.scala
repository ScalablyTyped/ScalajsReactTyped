...
trait SelectParameters extends StObject {
  ...
  /**
    ...
    */
  var ExpressionType: js.UndefOr[typingsJapgolly.awsSdk.clientsGlacierMod.ExpressionType] = js.undefined
  
  /**
    * Describes the serialization format of the object.
    */
  var InputSerialization: js.UndefOr[typingsJapgolly.awsSdk.clientsGlacierMod.InputSerialization] = js.undefined
  
  /**
    * Describes how the results of the select job are serialized.
    */
  var OutputSerialization: js.UndefOr[typingsJapgolly.awsSdk.clientsGlacierMod.OutputSerialization] = js.undefined
}
