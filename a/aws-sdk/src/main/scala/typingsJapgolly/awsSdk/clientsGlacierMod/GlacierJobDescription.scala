...
trait GlacierJobDescription extends StObject {
  ...
  /**
    ...
    */
  var OutputLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsGlacierMod.OutputLocation] = js.undefined
  ...
  /**
    ...
    */
  var SelectParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsGlacierMod.SelectParameters] = js.undefined
  
  /**
    * The status code can be InProgress, Succeeded, or Failed, and indicates the status of the job.
    */
  var StatusCode: js.UndefOr[typingsJapgolly.awsSdk.clientsGlacierMod.StatusCode] = js.undefined
