...
trait AccountSharingInfo extends js.Object {
  /**
    ...
    */
  var AccountId: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.AccountId] = js.native
  /**
    * The version of the current document shared with the account.
    */
  var SharedDocumentVersion: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.SharedDocumentVersion] = js.native
}
