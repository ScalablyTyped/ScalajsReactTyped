...
trait InstancePatchState extends js.Object {
  /**
    ...
    */
  var BaselineId: typingsJapgolly.awsSdk.ssmMod.BaselineId = js.native
  /**
  ...
  /**
    ...
    */
  var InstallOverrideList: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.InstallOverrideList] = js.native
  /**
  ...
  /**
    ...
    */
  var OwnerInformation: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.OwnerInformation] = js.native
  /**
  ...
  /**
    ...
    */
  var RebootOption: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.RebootOption] = js.native
  /**
