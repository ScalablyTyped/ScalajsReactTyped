...
trait AutomationExecution extends js.Object {
  /**
    * The execution ID.
    */
  var AutomationExecutionId: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.AutomationExecutionId] = js.native
  /**
    * The execution status of the Automation.
    */
  var AutomationExecutionStatus: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.AutomationExecutionStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var DocumentName: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.DocumentName] = js.native
  /**
  ...
  /**
    ...
    */
  var ProgressCounters: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.ProgressCounters] = js.native
  /**
    * A list of resolved targets in the rate control execution.
    */
  var ResolvedTargets: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.ResolvedTargets] = js.native
  /**
  ...
  /**
    ...
    */
  var TargetLocations: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.TargetLocations] = js.native
  /**
    * The specified key-value mapping of document parameters to target resources.
    */
  var TargetMaps: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.TargetMaps] = js.native
  /**
    * The parameter name.
    */
