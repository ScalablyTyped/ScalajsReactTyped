...
trait ComplianceSummaryItem extends js.Object {
  ...
  /**
    ...
    */
  var CompliantSummary: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.CompliantSummary] = js.native
  /**
    * A list of NON_COMPLIANT items for the specified compliance type.
    */
  var NonCompliantSummary: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.NonCompliantSummary] = js.native
}
