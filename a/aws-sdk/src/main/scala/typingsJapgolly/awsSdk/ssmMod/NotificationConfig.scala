...
trait NotificationConfig extends js.Object {
  /**
    ...
    */
  var NotificationArn: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.NotificationArn] = js.native
  /**
  ...
  /**
    ...
    */
  var NotificationType: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.NotificationType] = js.native
}
