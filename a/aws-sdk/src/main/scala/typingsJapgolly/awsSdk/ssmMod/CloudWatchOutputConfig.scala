...
trait CloudWatchOutputConfig extends js.Object {
  /**
    ...
    */
  var CloudWatchLogGroupName: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.CloudWatchLogGroupName] = js.native
  /**
    * Enables Systems Manager to send command output to CloudWatch Logs.
    */
  var CloudWatchOutputEnabled: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.CloudWatchOutputEnabled] = js.native
}
