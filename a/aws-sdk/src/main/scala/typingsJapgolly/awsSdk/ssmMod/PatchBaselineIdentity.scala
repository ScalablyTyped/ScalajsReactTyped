...
trait PatchBaselineIdentity extends js.Object {
  /**
    ...
    */
  var BaselineDescription: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.BaselineDescription] = js.native
  /**
  ...
  /**
    ...
    */
  var BaselineName: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.BaselineName] = js.native
  /**
    * Whether this is the default baseline. Note that Systems Manager supports creating multiple default patch baselines. For example, you can create a default patch baseline for each operating system.
    */
  var DefaultBaseline: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.DefaultBaseline] = js.native
  /**
