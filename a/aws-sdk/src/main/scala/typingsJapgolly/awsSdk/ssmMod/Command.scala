...
trait Command extends js.Object {
  ...
  /**
    ...
    */
  var CompletedCount: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.CompletedCount] = js.native
  /**
    * The number of targets for which the status is Delivery Timed Out.
    */
  var DeliveryTimedOutCount: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.DeliveryTimedOutCount] = js.native
  /**
  ...
  /**
    ...
    */
  var ErrorCount: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.ErrorCount] = js.native
  /**
  ...
  /**
    ...
    */
  var TargetCount: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.TargetCount] = js.native
  /**
