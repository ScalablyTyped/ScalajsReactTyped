...
trait TargetLocation extends js.Object {
  /**
    ...
    */
  var Accounts: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.Accounts] = js.native
  /**
    * The Automation execution role used by the currently running Automation.
    */
  var ExecutionRoleName: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.ExecutionRoleName] = js.native
  /**
    * The AWS Regions targeted by the current Automation execution.
    */
  var Regions: js.UndefOr[typingsJapgolly.awsSdk.ssmMod.Regions] = js.native
  /**
