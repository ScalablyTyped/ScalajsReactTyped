...
trait OutputUpdate extends js.Object {
  ...
  /**
    ...
    */
  var KinesisFirehoseOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.KinesisFirehoseOutputUpdate] = js.native
  /**
    * Describes an Amazon Kinesis stream as the destination for the output.
    */
  var KinesisStreamsOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.KinesisStreamsOutputUpdate] = js.native
  /**
    * Describes an AWS Lambda function as the destination for the output.
    */
  var LambdaOutputUpdate: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.LambdaOutputUpdate] = js.native
  /**
