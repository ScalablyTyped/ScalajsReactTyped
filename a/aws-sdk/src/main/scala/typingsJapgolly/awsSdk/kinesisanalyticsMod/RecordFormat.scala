...
trait RecordFormat extends js.Object {
  /**
    ...
    */
  var MappingParameters: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.MappingParameters] = js.native
  /**
    * The type of record format.
    */
  var RecordFormatType: typingsJapgolly.awsSdk.kinesisanalyticsMod.RecordFormatType = js.native
}
