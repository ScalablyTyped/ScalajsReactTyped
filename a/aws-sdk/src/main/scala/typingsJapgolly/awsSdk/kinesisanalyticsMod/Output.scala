...
trait Output extends js.Object {
  /**
    ...
    */
  var DestinationSchema: typingsJapgolly.awsSdk.kinesisanalyticsMod.DestinationSchema = js.native
  /**
    * Identifies an Amazon Kinesis Firehose delivery stream as the destination.
    */
  var KinesisFirehoseOutput: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.KinesisFirehoseOutput] = js.native
  /**
    * Identifies an Amazon Kinesis stream as the destination.
    */
  var KinesisStreamsOutput: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.KinesisStreamsOutput] = js.native
  /**
    * Identifies an AWS Lambda function as the destination.
    */
  var LambdaOutput: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.LambdaOutput] = js.native
  /**
