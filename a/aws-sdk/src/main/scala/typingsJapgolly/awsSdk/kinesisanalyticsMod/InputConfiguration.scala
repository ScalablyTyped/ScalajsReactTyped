...
trait InputConfiguration extends js.Object {
  /**
    ...
    */
  var Id: typingsJapgolly.awsSdk.kinesisanalyticsMod.Id = js.native
  /**
    * Point at which you want the application to start processing records from the streaming source.
    */
  var InputStartingPositionConfiguration: typingsJapgolly.awsSdk.kinesisanalyticsMod.InputStartingPositionConfiguration = js.native
}
