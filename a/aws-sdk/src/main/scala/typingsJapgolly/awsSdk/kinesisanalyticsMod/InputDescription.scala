...
trait InputDescription extends js.Object {
  /**
    ...
    */
  var InAppStreamNames: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.InAppStreamNames] = js.native
  /**
  ...
  /**
    ...
    */
  var InputParallelism: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.InputParallelism] = js.native
  /**
    * The description of the preprocessor that executes on records in this input before the application's code is run.
    */
  var InputProcessingConfigurationDescription: js.UndefOr[
    typingsJapgolly.awsSdk.kinesisanalyticsMod.InputProcessingConfigurationDescription
  ] = js.native
  /**
  ...
  /**
    ...
    */
  var InputStartingPositionConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.InputStartingPositionConfiguration] = js.native
  /**
    * If an Amazon Kinesis Firehose delivery stream is configured as a streaming source, provides the delivery stream's ARN and an IAM role that enables Amazon Kinesis Analytics to access the stream on your behalf.
    */
  var KinesisFirehoseInputDescription: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.KinesisFirehoseInputDescription] = js.native
  /**
    * If an Amazon Kinesis stream is configured as streaming source, provides Amazon Kinesis stream's Amazon Resource Name (ARN) and an IAM role that enables Amazon Kinesis Analytics to access the stream on your behalf.
    */
  var KinesisStreamsInputDescription: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.KinesisStreamsInputDescription] = js.native
  /**
