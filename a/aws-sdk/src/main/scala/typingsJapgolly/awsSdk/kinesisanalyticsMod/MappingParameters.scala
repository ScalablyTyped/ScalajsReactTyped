...
trait MappingParameters extends js.Object {
  /**
    ...
    */
  var CSVMappingParameters: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.CSVMappingParameters] = js.native
  /**
    * Provides additional mapping information when JSON is the record format on the streaming source.
    */
  var JSONMappingParameters: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.JSONMappingParameters] = js.native
}
