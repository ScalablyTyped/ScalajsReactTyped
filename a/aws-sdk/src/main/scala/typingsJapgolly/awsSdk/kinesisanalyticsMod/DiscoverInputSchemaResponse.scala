...
trait DiscoverInputSchemaResponse extends js.Object {
  ...
  /**
    ...
    */
  var ParsedInputRecords: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.ParsedInputRecords] = js.native
  /**
    * Stream data that was modified by the processor specified in the InputProcessingConfiguration parameter.
    */
  var ProcessedInputRecords: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.ProcessedInputRecords] = js.native
  /**
    * Raw stream data that was sampled to infer the schema.
    */
  var RawInputRecords: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.RawInputRecords] = js.native
}
