...
trait CloudWatchLoggingOption extends js.Object {
  /**
    ...
    */
  var LogStreamARN: typingsJapgolly.awsSdk.kinesisanalyticsMod.LogStreamARN = js.native
  /**
    * IAM ARN of the role to use to send application messages. Note: To write application messages to CloudWatch, the IAM role that is used must have the PutLogEvents policy action enabled.
    */
  var RoleARN: typingsJapgolly.awsSdk.kinesisanalyticsMod.RoleARN = js.native
}
