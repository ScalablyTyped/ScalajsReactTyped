...
trait LambdaOutputDescription extends js.Object {
  /**
    ...
    */
  var ResourceARN: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.ResourceARN] = js.native
  /**
    * ARN of the IAM role that Amazon Kinesis Analytics can assume to write to the destination function.
    */
  var RoleARN: js.UndefOr[typingsJapgolly.awsSdk.kinesisanalyticsMod.RoleARN] = js.native
}
