...
trait MountTargetDescription extends StObject {
  ...
  /**
    ...
    */
  var AvailabilityZoneId: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.AvailabilityZoneId] = js.undefined
  ...
  /**
    ...
    */
  var AvailabilityZoneName: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.AvailabilityZoneName] = js.undefined
  ...
  /**
    ...
    */
  var IpAddress: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.IpAddress] = js.undefined
  
  /**
    * Lifecycle state of the mount target.
    */
  var LifeCycleState: typingsJapgolly.awsSdk.clientsEfsMod.LifeCycleState
  ...
  /**
    ...
    */
  var NetworkInterfaceId: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.NetworkInterfaceId] = js.undefined
  ...
  /**
    ...
    */
  var SubnetId: typingsJapgolly.awsSdk.clientsEfsMod.SubnetId
  
  /**
    * The virtual private cloud (VPC) ID that the mount target is configured in.
    */
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.VpcId] = js.undefined
}
