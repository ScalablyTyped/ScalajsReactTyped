...
trait UpdateFileSystemRequest extends StObject {
  ...
  /**
    ...
    */
  var ProvisionedThroughputInMibps: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.ProvisionedThroughputInMibps] = js.undefined
  ...
  /**
    ...
    */
  var ThroughputMode: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.ThroughputMode] = js.undefined
}
