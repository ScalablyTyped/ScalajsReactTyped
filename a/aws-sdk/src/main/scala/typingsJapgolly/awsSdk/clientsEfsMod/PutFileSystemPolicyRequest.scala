...
trait PutFileSystemPolicyRequest extends StObject {
  ...
  /**
    ...
    */
  var BypassPolicyLockoutSafetyCheck: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.BypassPolicyLockoutSafetyCheck] = js.undefined
  ...
  /**
    ...
    */
  var Policy: typingsJapgolly.awsSdk.clientsEfsMod.Policy
}
