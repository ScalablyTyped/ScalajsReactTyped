...
trait AccessPointDescription extends StObject {
  ...
  /**
    ...
    */
  var AccessPointArn: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.AccessPointArn] = js.undefined
  
  /**
    * The ID of the access point, assigned by Amazon EFS.
    */
  var AccessPointId: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.AccessPointId] = js.undefined
  
  /**
    * The opaque string specified in the request to ensure idempotent creation.
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.ClientToken] = js.undefined
  
  /**
    * The ID of the EFS file system that the access point applies to.
    */
  var FileSystemId: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.FileSystemId] = js.undefined
  
  /**
    * Identifies the lifecycle phase of the access point.
    */
  var LifeCycleState: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.LifeCycleState] = js.undefined
  
  /**
    * The name of the access point. This is the value of the Name tag.
    */
  var Name: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.Name] = js.undefined
  ...
  /**
    ...
    */
  var PosixUser: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.PosixUser] = js.undefined
  
  /**
    * The directory on the Amazon EFS file system that the access point exposes as the root directory to NFS clients using the access point.
    */
  var RootDirectory: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.RootDirectory] = js.undefined
  
  /**
    * The tags associated with the access point, presented as an array of Tag objects.
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.Tags] = js.undefined
}
