...
trait DescribeFileSystemsRequest extends StObject {
  ...
  /**
    ...
    */
  var CreationToken: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.CreationToken] = js.undefined
  ...
  /**
    ...
    */
  var Marker: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.Marker] = js.undefined
  
  /**
    * (Optional) Specifies the maximum number of file systems to return in the response (integer). This number is automatically set to 100. The response is paginated at 100 per page if you have more than 100 file systems. 
    */
  var MaxItems: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.MaxItems] = js.undefined
}
