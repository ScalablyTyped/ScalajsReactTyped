...
trait ResourceIdPreference extends StObject {
  ...
  /**
    ...
    */
  var ResourceIdType: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.ResourceIdType] = js.undefined
  
  /**
    * Identifies the Amazon EFS resources to which the ID preference setting applies, FILE_SYSTEM and MOUNT_TARGET.
    */
  var Resources: js.UndefOr[typingsJapgolly.awsSdk.clientsEfsMod.Resources] = js.undefined
}
