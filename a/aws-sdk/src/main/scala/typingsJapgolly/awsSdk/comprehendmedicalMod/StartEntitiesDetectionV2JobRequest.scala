...
trait StartEntitiesDetectionV2JobRequest extends js.Object {
  ...
  /**
    ...
    */
  var InputDataConfig: typingsJapgolly.awsSdk.comprehendmedicalMod.InputDataConfig = js.native
  /**
  ...
  /**
    ...
    */
  var LanguageCode: typingsJapgolly.awsSdk.comprehendmedicalMod.LanguageCode = js.native
  /**
    * Specifies where to send the output files.
    */
  var OutputDataConfig: typingsJapgolly.awsSdk.comprehendmedicalMod.OutputDataConfig = js.native
}
