...
trait ComprehendMedicalAsyncJobProperties extends js.Object {
  ...
  /**
    ...
    */
  var InputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.comprehendmedicalMod.InputDataConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var JobName: js.UndefOr[typingsJapgolly.awsSdk.comprehendmedicalMod.JobName] = js.native
  /**
    * The current status of the detection job. If the status is FAILED, the Message field shows the reason for the failure.
    */
  var JobStatus: js.UndefOr[typingsJapgolly.awsSdk.comprehendmedicalMod.JobStatus] = js.native
  /**
    * The AWS Key Management Service key, if any, used to encrypt the output files. 
    */
  var KMSKey: js.UndefOr[typingsJapgolly.awsSdk.comprehendmedicalMod.KMSKey] = js.native
  /**
    * The language code of the input documents.
    */
  var LanguageCode: js.UndefOr[typingsJapgolly.awsSdk.comprehendmedicalMod.LanguageCode] = js.native
  /**
    * The path to the file that describes the results of a batch job.
    */
  var ManifestFilePath: js.UndefOr[typingsJapgolly.awsSdk.comprehendmedicalMod.ManifestFilePath] = js.native
  /**
  ...
  /**
    ...
    */
  var ModelVersion: js.UndefOr[typingsJapgolly.awsSdk.comprehendmedicalMod.ModelVersion] = js.native
  /**
    * The output data configuration that you supplied when you created the detection job.
    */
  var OutputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.comprehendmedicalMod.OutputDataConfig] = js.native
  /**
