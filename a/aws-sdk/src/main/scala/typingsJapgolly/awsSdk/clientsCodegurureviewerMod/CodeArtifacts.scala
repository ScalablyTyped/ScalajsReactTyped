...
trait CodeArtifacts extends StObject {
  ...
  /**
    ...
    */
  var BuildArtifactsObjectKey: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.BuildArtifactsObjectKey] = js.undefined
  
  /**
    * The S3 object key for a source code .zip file. This is required for all code reviews.
    */
  var SourceCodeArtifactsObjectKey: typingsJapgolly.awsSdk.clientsCodegurureviewerMod.SourceCodeArtifactsObjectKey
}
