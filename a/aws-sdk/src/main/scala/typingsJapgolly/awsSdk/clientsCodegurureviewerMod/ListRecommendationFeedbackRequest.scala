...
trait ListRecommendationFeedbackRequest extends StObject {
  ...
  /**
    ...
    */
  var RecommendationIds: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.RecommendationIds] = js.undefined
  ...
  /**
    ...
    */
  var UserIds: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.UserIds] = js.undefined
}
