...
trait RuleMetadata extends StObject {
  ...
  /**
    ...
    */
  var LongDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.LongDescription] = js.undefined
  
  /**
    * The ID of the rule.
    */
  var RuleId: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.RuleId] = js.undefined
  
  /**
    * The name of the rule.
    */
  var RuleName: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.RuleName] = js.undefined
  
  /**
    * Tags that are associated with the rule.
    */
  var RuleTags: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.RuleTags] = js.undefined
  
  /**
    * A short description of the rule.
    */
  var ShortDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.ShortDescription] = js.undefined
}
object RuleMetadata {
