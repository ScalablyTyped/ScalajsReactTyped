...
trait RequestMetadata extends StObject {
  ...
  /**
    ...
    */
  var EventInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.EventInfo] = js.undefined
  
  /**
    * The ID of the request. This is required for a pull request code review.
    */
  var RequestId: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.RequestId] = js.undefined
  ...
  /**
    ...
    */
  var Requester: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.Requester] = js.undefined
  ...
  /**
    ...
    */
  var VendorName: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.VendorName] = js.undefined
}
