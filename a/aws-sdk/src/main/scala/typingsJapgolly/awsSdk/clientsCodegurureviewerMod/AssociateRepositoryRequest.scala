...
trait AssociateRepositoryRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.ClientRequestToken] = js.undefined
  ...
  /**
    ...
    */
  var KMSKeyDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.KMSKeyDetails] = js.undefined
  
  /**
    * The repository to associate.
    */
  var Repository: typingsJapgolly.awsSdk.clientsCodegurureviewerMod.Repository
