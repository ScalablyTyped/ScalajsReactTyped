...
trait KMSKeyDetails extends StObject {
  ...
  /**
    ...
    */
  var EncryptionOption: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.EncryptionOption] = js.undefined
  
  /**
    * The ID of the Amazon Web Services KMS key that is associated with a repository association.
    */
  var KMSKeyId: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.KMSKeyId] = js.undefined
}
