...
trait PutRecommendationFeedbackRequest extends StObject {
  ...
  /**
    ...
    */
  var Reactions: typingsJapgolly.awsSdk.clientsCodegurureviewerMod.Reactions
  
  /**
    * The recommendation ID that can be used to track the provided recommendations and then to collect the feedback.
    */
  var RecommendationId: typingsJapgolly.awsSdk.clientsCodegurureviewerMod.RecommendationId
}
