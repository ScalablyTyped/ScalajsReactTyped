...
trait CodeReview extends StObject {
  ...
  /**
    ...
    */
  var AnalysisTypes: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.AnalysisTypes] = js.undefined
  ...
  /**
    ...
    */
  var AssociationArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.AssociationArn] = js.undefined
  ...
  /**
    ...
    */
  var ConfigFileState: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.ConfigFileState] = js.undefined
  ...
  /**
    ...
    */
  var Metrics: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.Metrics] = js.undefined
  
  /**
    * The name of the code review.
    */
  var Name: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.Name] = js.undefined
  
  /**
    * The owner of the repository. For an Amazon Web Services CodeCommit repository, this is the Amazon Web Services account ID of the account that owns the repository. For a GitHub, GitHub Enterprise Server, or Bitbucket repository, this is the username for the account that owns the repository. For an S3 repository, it can be the username or Amazon Web Services account ID.
    */
  var Owner: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.Owner] = js.undefined
  
  /**
    * The type of repository that contains the reviewed code (for example, GitHub or Bitbucket).
    */
  var ProviderType: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.ProviderType] = js.undefined
  
  /**
    * The pull request ID for the code review.
    */
  var PullRequestId: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.PullRequestId] = js.undefined
  ...
  /**
    ...
    */
  var SourceCodeType: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.SourceCodeType] = js.undefined
  ...
  /**
    ...
    */
  var StateReason: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.StateReason] = js.undefined
  
  /**
    * The type of code review.
    */
  var Type: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.Type] = js.undefined
}
object CodeReview {
