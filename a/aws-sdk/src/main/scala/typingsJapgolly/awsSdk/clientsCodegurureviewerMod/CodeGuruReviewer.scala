...
import typingsJapgolly.awsSdk.anon.DescribeRepositoryAssocia
import typingsJapgolly.awsSdk.awsSdkStrings.codeReviewCompleted
import typingsJapgolly.awsSdk.awsSdkStrings.repositoryAssociationSucceeded
...
trait CodeGuruReviewer extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_codeReviewCompleted(state: codeReviewCompleted, params: typingsJapgolly.awsSdk.anon.DescribeCodeReviewRequest): Request[DescribeCodeReviewResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_codeReviewCompleted(
    state: codeReviewCompleted,
    params: typingsJapgolly.awsSdk.anon.DescribeCodeReviewRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeCodeReviewResponse, Unit]
  ): Request[DescribeCodeReviewResponse, AWSError] = js.native
  /**
