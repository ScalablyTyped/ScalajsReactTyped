...
trait ListCodeReviewsRequest extends StObject {
  ...
  /**
    ...
    */
  var RepositoryNames: js.UndefOr[typingsJapgolly.awsSdk.clientsCodegurureviewerMod.RepositoryNames] = js.undefined
  ...
  /**
    ...
    */
  var Type: typingsJapgolly.awsSdk.clientsCodegurureviewerMod.Type
}
