...
trait GetDataSourceOutput extends StObject {
  ...
  var RDSMetadata: js.UndefOr[typingsJapgolly.awsSdk.clientsMachinelearningMod.RDSMetadata] = js.undefined
  
  var RedshiftMetadata: js.UndefOr[typingsJapgolly.awsSdk.clientsMachinelearningMod.RedshiftMetadata] = js.undefined
  
  var RoleARN: js.UndefOr[typingsJapgolly.awsSdk.clientsMachinelearningMod.RoleARN] = js.undefined
