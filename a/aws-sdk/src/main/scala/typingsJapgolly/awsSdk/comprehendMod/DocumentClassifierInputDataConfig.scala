...
trait DocumentClassifierInputDataConfig extends js.Object {
  /**
    ...
    */
  var LabelDelimiter: js.UndefOr[typingsJapgolly.awsSdk.comprehendMod.LabelDelimiter] = js.native
  /**
    ...
    */
  var S3Uri: typingsJapgolly.awsSdk.comprehendMod.S3Uri = js.native
}
