...
import typingsJapgolly.awsSdk.GetPolicyRequestwaiterWai
import typingsJapgolly.awsSdk.GetRoleRequestwaiterWaite
import typingsJapgolly.awsSdk.GetUserRequestwaiterWaite
...
trait IAM extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_instanceProfileExists(state: instanceProfileExists, params: typingsJapgolly.awsSdk.GetInstanceProfileRequest): Request[GetInstanceProfileResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_instanceProfileExists(
    state: instanceProfileExists,
    params: typingsJapgolly.awsSdk.GetInstanceProfileRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ GetInstanceProfileResponse, Unit]
  ): Request[GetInstanceProfileResponse, AWSError] = js.native
  /**
