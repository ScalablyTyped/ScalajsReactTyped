...
trait DeploymentEvent extends StObject {
  ...
  /**
    ...
    */
  var ActionInvocations: js.UndefOr[typingsJapgolly.awsSdk.clientsAppconfigMod.ActionInvocations] = js.undefined
  ...
  /**
    ...
    */
  var TriggeredBy: js.UndefOr[typingsJapgolly.awsSdk.clientsAppconfigMod.TriggeredBy] = js.undefined
}
