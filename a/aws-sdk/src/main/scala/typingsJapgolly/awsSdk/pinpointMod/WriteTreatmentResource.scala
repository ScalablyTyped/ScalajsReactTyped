...
trait WriteTreatmentResource extends js.Object {
  /**
    ...
    */
  var MessageConfiguration: js.UndefOr[typingsJapgolly.awsSdk.pinpointMod.MessageConfiguration] = js.native
  /**
    * The schedule settings for the treatment.
    */
  var Schedule: js.UndefOr[typingsJapgolly.awsSdk.pinpointMod.Schedule] = js.native
  /**
  ...
  /**
    ...
    */
  var TemplateConfiguration: js.UndefOr[typingsJapgolly.awsSdk.pinpointMod.TemplateConfiguration] = js.native
  /**
