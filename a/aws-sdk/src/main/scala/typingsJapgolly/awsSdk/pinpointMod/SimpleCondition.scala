...
trait SimpleCondition extends js.Object {
  /**
    ...
    */
  var EventCondition: js.UndefOr[typingsJapgolly.awsSdk.pinpointMod.EventCondition] = js.native
  /**
    * The segment that's associated with the activity.
    */
  var SegmentCondition: js.UndefOr[typingsJapgolly.awsSdk.pinpointMod.SegmentCondition] = js.native
  /**
    * The dimension settings for the segment that's associated with the activity.
    */
  var SegmentDimensions: js.UndefOr[typingsJapgolly.awsSdk.pinpointMod.SegmentDimensions] = js.native
}
