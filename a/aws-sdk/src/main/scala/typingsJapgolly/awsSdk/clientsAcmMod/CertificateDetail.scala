...
trait CertificateDetail extends StObject {
  ...
  /**
    ...
    */
  var FailureReason: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.FailureReason] = js.undefined
  ...
  /**
    ...
    */
  var KeyAlgorithm: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.KeyAlgorithm] = js.undefined
  ...
  /**
    ...
    */
  var RenewalEligibility: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.RenewalEligibility] = js.undefined
  
  /**
    * Contains information about the status of ACM's managed renewal for the certificate. This field exists only when the certificate type is AMAZON_ISSUED.
    */
  var RenewalSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.RenewalSummary] = js.undefined
  
  /**
    * The reason the certificate was revoked. This value exists only when the certificate status is REVOKED. 
    */
  var RevocationReason: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.RevocationReason] = js.undefined
