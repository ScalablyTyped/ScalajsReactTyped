...
trait RequestCertificateRequest extends StObject {
  ...
  /**
    ...
    */
  var IdempotencyToken: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.IdempotencyToken] = js.undefined
  ...
  /**
    ...
    */
  var ValidationMethod: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.ValidationMethod] = js.undefined
}
