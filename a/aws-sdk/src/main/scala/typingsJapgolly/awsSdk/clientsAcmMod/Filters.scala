...
object Filters {
  ...
  extension [Self <: Filters](x: Self) {
    ...
    inline def setExtendedKeyUsageVarargs(value: ExtendedKeyUsageName*): Self = StObject.set(x, "extendedKeyUsage", js.Array(value*))
    ...
    inline def setKeyTypesVarargs(value: KeyAlgorithm*): Self = StObject.set(x, "keyTypes", js.Array(value*))
    ...
    inline def setKeyUsageVarargs(value: KeyUsageName*): Self = StObject.set(x, "keyUsage", js.Array(value*))
  }
}
