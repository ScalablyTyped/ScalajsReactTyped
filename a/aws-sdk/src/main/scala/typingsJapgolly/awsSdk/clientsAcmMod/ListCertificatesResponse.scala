...
trait ListCertificatesResponse extends StObject {
  ...
  /**
    ...
    */
  var CertificateSummaryList: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.CertificateSummaryList] = js.undefined
  
  /**
    * When the list is truncated, this value is present and contains the value to use for the NextToken parameter in a subsequent pagination request.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.NextToken] = js.undefined
}
