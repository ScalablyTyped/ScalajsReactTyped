...
trait ListCertificatesRequest extends StObject {
  ...
  /**
    ...
    */
  var CertificateStatuses: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.CertificateStatuses] = js.undefined
  ...
  /**
    ...
    */
  var MaxItems: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.MaxItems] = js.undefined
  ...
  /**
    ...
    */
  var SortBy: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.SortBy] = js.undefined
  
  /**
    * Specifies the order of sorted results. If you specify SortOrder, you must also specify SortBy.
    */
  var SortOrder: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.SortOrder] = js.undefined
}
