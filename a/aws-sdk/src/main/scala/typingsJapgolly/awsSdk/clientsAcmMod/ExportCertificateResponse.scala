...
trait ExportCertificateResponse extends StObject {
  ...
  /**
    ...
    */
  var CertificateChain: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.CertificateChain] = js.undefined
  
  /**
    * The encrypted private key associated with the public key in the certificate. The key is output in PKCS #8 format and is base64 PEM-encoded. 
    */
  var PrivateKey: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmMod.PrivateKey] = js.undefined
}
