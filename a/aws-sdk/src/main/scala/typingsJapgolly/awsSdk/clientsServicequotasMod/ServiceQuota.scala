...
trait ServiceQuota extends StObject {
  ...
  /**
    ...
    */
  var ErrorReason: js.UndefOr[typingsJapgolly.awsSdk.clientsServicequotasMod.ErrorReason] = js.undefined
  
  /**
    * Indicates whether the quota is global.
    */
  var GlobalQuota: js.UndefOr[typingsJapgolly.awsSdk.clientsServicequotasMod.GlobalQuota] = js.undefined
  ...
  /**
    ...
    */
  var QuotaArn: js.UndefOr[typingsJapgolly.awsSdk.clientsServicequotasMod.QuotaArn] = js.undefined
  
  /**
    * The quota identifier.
    */
  var QuotaCode: js.UndefOr[typingsJapgolly.awsSdk.clientsServicequotasMod.QuotaCode] = js.undefined
  
  /**
    * The quota name.
    */
  var QuotaName: js.UndefOr[typingsJapgolly.awsSdk.clientsServicequotasMod.QuotaName] = js.undefined
  ...
  /**
    * The service name.
    */
  var ServiceName: js.UndefOr[typingsJapgolly.awsSdk.clientsServicequotasMod.ServiceName] = js.undefined
