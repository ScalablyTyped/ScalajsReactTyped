...
trait ErrorReason extends StObject {
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.clientsServicequotasMod.ErrorCode] = js.undefined
  
  /**
    * The error message.
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsServicequotasMod.ErrorMessage] = js.undefined
}
object ErrorReason {
