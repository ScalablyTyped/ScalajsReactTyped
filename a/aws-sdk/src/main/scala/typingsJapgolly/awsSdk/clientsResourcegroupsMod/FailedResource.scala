...
trait FailedResource extends StObject {
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupsMod.ErrorCode] = js.undefined
  
  /**
    * The error message text associated with the failure.
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsResourcegroupsMod.ErrorMessage] = js.undefined
