...
trait Summary extends js.Object {
  /**
    ...
    */
  var LastUpdated: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.LastUpdated] = js.native
  /**
    * The count of noncompliant resources.
    */
  var NonCompliantResources: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.NonCompliantResources] = js.native
  /**
    * The AWS Region that the summary applies to.
    */
  var Region: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.Region] = js.native
  /**
  ...
  /**
    ...
    */
  var TargetId: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.TargetId] = js.native
  /**
    * Whether the target is an account, an OU, or the organization root.
    */
  var TargetIdType: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.TargetIdType] = js.native
}
