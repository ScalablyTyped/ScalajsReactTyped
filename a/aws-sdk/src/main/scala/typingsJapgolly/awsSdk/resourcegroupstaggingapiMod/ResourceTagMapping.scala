...
trait ResourceTagMapping extends js.Object {
  /**
    ...
    */
  var ComplianceDetails: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.ComplianceDetails] = js.native
  /**
    * The ARN of the resource.
    */
  var ResourceARN: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.ResourceARN] = js.native
  /**
