...
trait FailureInfo extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.ErrorCode] = js.native
  /**
  ...
  /**
    ...
    */
  var StatusCode: js.UndefOr[typingsJapgolly.awsSdk.resourcegroupstaggingapiMod.StatusCode] = js.native
}
