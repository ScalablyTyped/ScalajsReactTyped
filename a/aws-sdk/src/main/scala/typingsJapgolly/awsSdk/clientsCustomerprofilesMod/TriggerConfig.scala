...
trait TriggerConfig extends StObject {
  ...
  /**
    ...
    */
  var TriggerProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.TriggerProperties] = js.undefined
  
  /**
    * Specifies the type of flow trigger. It can be OnDemand, Scheduled, or Event.
    */
  var TriggerType: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.TriggerType
}
