...
trait ListWorkflowsRequest extends StObject {
  ...
  /**
    ...
    */
  var Status: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.Status] = js.undefined
  
  /**
    * The type of workflow. The only supported value is APPFLOW_INTEGRATION.
    */
  var WorkflowType: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.WorkflowType] = js.undefined
}
