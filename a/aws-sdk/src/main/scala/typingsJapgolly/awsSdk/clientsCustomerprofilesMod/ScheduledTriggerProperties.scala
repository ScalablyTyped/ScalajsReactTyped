...
trait ScheduledTriggerProperties extends StObject {
  ...
  /**
    ...
    */
  var DataPullMode: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.DataPullMode] = js.undefined
  ...
  /**
    ...
    */
  var ScheduleExpression: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.ScheduleExpression
  
  /**
    * Specifies the optional offset that is added to the time interval for a schedule-triggered flow.
    */
  var ScheduleOffset: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.ScheduleOffset] = js.undefined
  ...
  /**
    ...
    */
  var Timezone: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.Timezone] = js.undefined
}
