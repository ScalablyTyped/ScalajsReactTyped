...
trait SourceFlowConfig extends StObject {
  ...
  /**
    ...
    */
  var ConnectorProfileName: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.ConnectorProfileName] = js.undefined
  ...
  /**
    ...
    */
  var IncrementalPullConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.IncrementalPullConfig] = js.undefined
  
  /**
    * Specifies the information that is required to query a particular source connector.
    */
  var SourceConnectorProperties: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.SourceConnectorProperties
}
