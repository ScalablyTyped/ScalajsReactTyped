...
trait IdentityResolutionJob extends StObject {
  ...
  /**
    ...
    */
  var ExportingLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.ExportingLocation] = js.undefined
  ...
  /**
    ...
    */
  var JobStats: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.JobStats] = js.undefined
...
object IdentityResolutionJob {
  ...
  extension [Self <: IdentityResolutionJob](x: Self) {
