...
trait AppflowIntegration extends StObject {
  ...
  /**
    ...
    */
  var Batches: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.Batches] = js.undefined
  
  var FlowDefinition: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.FlowDefinition
}
