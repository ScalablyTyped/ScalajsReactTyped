...
trait MatchingResponse extends StObject {
  ...
  /**
    ...
    */
  var AutoMerging: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.AutoMerging] = js.undefined
  ...
  /**
    ...
    */
  var ExportingConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.ExportingConfig] = js.undefined
  
  /**
    * The day and time when do you want to start the Identity Resolution Job every week.
    */
  var JobSchedule: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.JobSchedule] = js.undefined
}
