...
trait GetProfileObjectTypeResponse extends StObject {
...
object GetProfileObjectTypeResponse {
  ...
  inline def apply(Description: text, ObjectTypeName: typeName): GetProfileObjectTypeResponse = {
  ...
  extension [Self <: GetProfileObjectTypeResponse](x: Self) {
