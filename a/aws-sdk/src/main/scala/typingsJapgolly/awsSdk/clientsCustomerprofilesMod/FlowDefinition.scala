...
trait FlowDefinition extends StObject {
  ...
  /**
    ...
    */
  var FlowName: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.FlowName
  
  /**
    * The Amazon Resource Name of the AWS Key Management Service (KMS) key you provide for encryption.
    */
  var KmsArn: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.KmsArn
  
  /**
    * The configuration that controls how Customer Profiles retrieves data from the source.
    */
  var SourceFlowConfig: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.SourceFlowConfig
  
  /**
    * A list of tasks that Customer Profiles performs while transferring the data in the flow run.
    */
  var Tasks: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.Tasks
  
  /**
    * The trigger settings that determine how and when the flow runs.
    */
  var TriggerConfig: typingsJapgolly.awsSdk.clientsCustomerprofilesMod.TriggerConfig
}
