...
trait AutoMerging extends StObject {
  ...
  /**
    ...
    */
  var ConflictResolution: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.ConflictResolution] = js.undefined
  
  /**
    * A list of matching attributes that represent matching criteria. If two profiles meet at least one of the requirements in the matching attributes list, they will be merged.
    */
  var Consolidation: js.UndefOr[typingsJapgolly.awsSdk.clientsCustomerprofilesMod.Consolidation] = js.undefined
