...
trait BatchDeleteDocumentRequest extends StObject {
  ...
  var DataSourceSyncJobMetricTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.DataSourceSyncJobMetricTarget] = js.undefined
  
  /**
    * One or more identifiers for documents to delete from the index.
    */
  var DocumentIdList: typingsJapgolly.awsSdk.clientsKendraMod.DocumentIdList
