...
trait JiraConfiguration extends StObject {
  ...
  /**
    ...
    */
  var IssueSubEntityFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.IssueSubEntityFilter] = js.undefined
  
  /**
    * Specify which issue types to crawl in your Jira data source. You can specify one or more of these options to crawl.
    */
  var IssueType: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.IssueType] = js.undefined
  ...
  /**
    ...
    */
  var JiraAccountUrl: typingsJapgolly.awsSdk.clientsKendraMod.JiraAccountUrl
  
  /**
    * Specify which projects to crawl in your Jira data source. You can specify one or more Jira project IDs.
    */
  var Project: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.Project] = js.undefined
