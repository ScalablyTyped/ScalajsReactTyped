...
trait DescribeDataSourceResponse extends StObject {
  ...
  /**
    ...
    */
  var CustomDocumentEnrichmentConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.CustomDocumentEnrichmentConfiguration] = js.undefined
  
  /**
    * The description for the data source connector.
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.Description] = js.undefined
  ...
  /**
    ...
    */
  var IndexId: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.IndexId] = js.undefined
  
  /**
    * The code for a language. This shows a supported language for all documents in the data source. English is supported by default. For more information on supported languages, including their codes, see Adding documents in languages other than English.
    */
  var LanguageCode: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.LanguageCode] = js.undefined
  ...
  /**
    ...
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.RoleArn] = js.undefined
