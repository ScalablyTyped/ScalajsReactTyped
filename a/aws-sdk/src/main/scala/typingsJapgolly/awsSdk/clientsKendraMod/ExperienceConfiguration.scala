...
trait ExperienceConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ContentSourceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.ContentSourceConfiguration] = js.undefined
  
  /**
    * The IAM Identity Center field name that contains the identifiers of your users, such as their emails.
    */
  var UserIdentityConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.UserIdentityConfiguration] = js.undefined
}
