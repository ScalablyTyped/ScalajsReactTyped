...
trait DatabaseConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AclConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.AclConfiguration] = js.undefined
  
  /**
    * Information about where the index should get the document information from the database.
    */
  var ColumnConfiguration: typingsJapgolly.awsSdk.clientsKendraMod.ColumnConfiguration
  
  /**
    * Configuration information that's required to connect to a database.
    */
  var ConnectionConfiguration: typingsJapgolly.awsSdk.clientsKendraMod.ConnectionConfiguration
  
  /**
    * The type of database engine that runs the database.
    */
  var DatabaseEngineType: typingsJapgolly.awsSdk.clientsKendraMod.DatabaseEngineType
  
  /**
    * Provides information about how Amazon Kendra uses quote marks around SQL identifiers when querying a database data source.
    */
  var SqlConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.SqlConfiguration] = js.undefined
