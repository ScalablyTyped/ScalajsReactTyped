...
trait IndexStatistics extends StObject {
  ...
  /**
    ...
    */
  var FaqStatistics: typingsJapgolly.awsSdk.clientsKendraMod.FaqStatistics
  
  /**
    * The number of text documents indexed.
    */
  var TextDocumentStatistics: typingsJapgolly.awsSdk.clientsKendraMod.TextDocumentStatistics
}
