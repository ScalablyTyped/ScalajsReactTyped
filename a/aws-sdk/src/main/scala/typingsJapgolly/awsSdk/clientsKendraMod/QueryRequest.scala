...
trait QueryRequest extends StObject {
  ...
  /**
    ...
    */
  var AttributeFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.AttributeFilter] = js.undefined
  ...
  /**
    ...
    */
  var QueryText: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.QueryText] = js.undefined
  ...
  /**
    ...
    */
  var SortingConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.SortingConfiguration] = js.undefined
  
  /**
    * Enables suggested spell corrections for queries.
    */
  var SpellCorrectionConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.SpellCorrectionConfiguration] = js.undefined
  
  /**
    * The user context token or user and group information.
    */
  var UserContext: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.UserContext] = js.undefined
  
  /**
    * Provides an identifier for a specific user. The VisitorId should be a unique identifier, such as a GUID. Don't use personally identifiable information, such as the user's email address, as the VisitorId.
    */
  var VisitorId: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.VisitorId] = js.undefined
}
object QueryRequest {
