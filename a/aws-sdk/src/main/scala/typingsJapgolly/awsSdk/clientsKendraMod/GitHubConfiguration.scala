...
trait GitHubConfiguration extends StObject {
  ...
  /**
    ...
    */
  var GitHubDocumentCrawlProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.GitHubDocumentCrawlProperties] = js.undefined
  ...
  /**
    ...
    */
  var OnPremiseConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.OnPremiseConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var SaaSConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.SaaSConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var Type: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.Type] = js.undefined
