...
trait UserContext extends StObject {
  ...
  /**
    ...
    */
  var DataSourceGroups: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.DataSourceGroups] = js.undefined
  
  /**
    * The list of groups you want to filter search results based on the groups' access to documents.
    */
  var Groups: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.Groups] = js.undefined
  
  /**
    * The user context token for filtering search results for a user. It must be a JWT or a JSON token.
    */
  var Token: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.Token] = js.undefined
