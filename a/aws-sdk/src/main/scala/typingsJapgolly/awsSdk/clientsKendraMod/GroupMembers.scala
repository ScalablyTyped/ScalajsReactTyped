...
trait GroupMembers extends StObject {
  ...
  /**
    ...
    */
  var MemberGroups: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.MemberGroups] = js.undefined
  
  /**
    * A list of users that belong to a group. For example, a list of interns all belong to the "Interns" group.
    */
  var MemberUsers: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.MemberUsers] = js.undefined
