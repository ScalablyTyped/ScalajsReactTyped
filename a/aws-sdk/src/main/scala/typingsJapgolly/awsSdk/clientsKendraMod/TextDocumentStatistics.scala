...
trait TextDocumentStatistics extends StObject {
  ...
  /**
    ...
    */
  var IndexedTextBytes: typingsJapgolly.awsSdk.clientsKendraMod.IndexedTextBytes
  
  /**
    * The number of text documents indexed.
    */
  var IndexedTextDocumentsCount: typingsJapgolly.awsSdk.clientsKendraMod.IndexedTextDocumentsCount
}
