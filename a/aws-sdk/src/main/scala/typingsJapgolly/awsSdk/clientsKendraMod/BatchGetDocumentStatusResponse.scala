...
trait BatchGetDocumentStatusResponse extends StObject {
  ...
  /**
    ...
    */
  var DocumentStatusList: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.DocumentStatusList] = js.undefined
...
object BatchGetDocumentStatusResponse {
  ...
  extension [Self <: BatchGetDocumentStatusResponse](x: Self) {
