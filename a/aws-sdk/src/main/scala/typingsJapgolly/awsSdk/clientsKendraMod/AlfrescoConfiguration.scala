...
trait AlfrescoConfiguration extends StObject {
  ...
  /**
    ...
    */
  var EntityFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.EntityFilter] = js.undefined
  ...
  /**
    ...
    */
  var SiteId: typingsJapgolly.awsSdk.clientsKendraMod.SiteId
  
  /**
    * The URL of the Alfresco site. For example, https://hostname:8080.
    */
  var SiteUrl: typingsJapgolly.awsSdk.clientsKendraMod.SiteUrl
