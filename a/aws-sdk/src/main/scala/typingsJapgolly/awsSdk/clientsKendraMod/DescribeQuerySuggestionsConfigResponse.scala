...
trait DescribeQuerySuggestionsConfigResponse extends StObject {
  ...
  /**
    ...
    */
  var MinimumNumberOfQueryingUsers: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.MinimumNumberOfQueryingUsers] = js.undefined
  
  /**
    * The minimum number of times a query must be searched in order for the query to be eligible to suggest to your users.
    */
  var MinimumQueryCount: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.MinimumQueryCount] = js.undefined
  ...
  /**
    ...
    */
  var Mode: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.Mode] = js.undefined
