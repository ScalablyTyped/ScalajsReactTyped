...
trait DataSourceSyncJobMetricTarget extends StObject {
  ...
  /**
    ...
    */
  var DataSourceId: typingsJapgolly.awsSdk.clientsKendraMod.DataSourceId
  ...
  /**
    ...
    */
  var DataSourceSyncJobId: js.UndefOr[typingsJapgolly.awsSdk.clientsKendraMod.DataSourceSyncJobId] = js.undefined
}
