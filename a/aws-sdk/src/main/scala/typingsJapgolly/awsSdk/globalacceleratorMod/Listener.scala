...
trait Listener extends js.Object {
  ...
  /**
    ...
    */
  var ListenerArn: js.UndefOr[GenericString] = js.native
  /**
    * The list of port ranges for the connections from clients to the accelerator.
    */
  var PortRanges: js.UndefOr[typingsJapgolly.awsSdk.globalacceleratorMod.PortRanges] = js.native
  /**
    * The protocol for the connections from clients to the accelerator.
    */
  var Protocol: js.UndefOr[typingsJapgolly.awsSdk.globalacceleratorMod.Protocol] = js.native
}
