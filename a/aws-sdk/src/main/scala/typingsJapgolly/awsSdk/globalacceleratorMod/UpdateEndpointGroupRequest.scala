...
trait UpdateEndpointGroupRequest extends js.Object {
  /**
    ...
    */
  var EndpointConfigurations: js.UndefOr[typingsJapgolly.awsSdk.globalacceleratorMod.EndpointConfigurations] = js.native
  /**
  ...
  /**
    ...
    */
  var HealthCheckIntervalSeconds: js.UndefOr[typingsJapgolly.awsSdk.globalacceleratorMod.HealthCheckIntervalSeconds] = js.native
  /**
  ...
  /**
    ...
    */
  var HealthCheckPort: js.UndefOr[typingsJapgolly.awsSdk.globalacceleratorMod.HealthCheckPort] = js.native
  /**
    * The protocol that AWS Global Accelerator uses to check the health of endpoints that are part of this endpoint group. The default value is TCP.
    */
  var HealthCheckProtocol: js.UndefOr[typingsJapgolly.awsSdk.globalacceleratorMod.HealthCheckProtocol] = js.native
  /**
    * The number of consecutive health checks required to set the state of a healthy endpoint to unhealthy, or to set an unhealthy endpoint to healthy. The default value is 3.
    */
  var ThresholdCount: js.UndefOr[typingsJapgolly.awsSdk.globalacceleratorMod.ThresholdCount] = js.native
  /**
    ...
    */
  var TrafficDialPercentage: js.UndefOr[typingsJapgolly.awsSdk.globalacceleratorMod.TrafficDialPercentage] = js.native
}
