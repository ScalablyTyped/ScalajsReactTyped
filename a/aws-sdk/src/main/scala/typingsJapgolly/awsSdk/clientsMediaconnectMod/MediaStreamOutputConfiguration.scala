...
trait MediaStreamOutputConfiguration extends StObject {
  ...
  /**
    ...
    */
  var EncodingName: typingsJapgolly.awsSdk.clientsMediaconnectMod.EncodingName
  
  /**
    * Encoding parameters
    */
  var EncodingParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconnectMod.EncodingParameters] = js.undefined
