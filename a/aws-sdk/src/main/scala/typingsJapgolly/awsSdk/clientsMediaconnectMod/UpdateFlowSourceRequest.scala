...
trait UpdateFlowSourceRequest extends StObject {
  ...
  /**
    ...
    */
  var Protocol: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconnectMod.Protocol] = js.undefined
...
object UpdateFlowSourceRequest {
  ...
  inline def apply(FlowArn: string, SourceArn: string): UpdateFlowSourceRequest = {
  ...
  extension [Self <: UpdateFlowSourceRequest](x: Self) {
    
    inline def setDecryption(value: UpdateEncryption): Self = StObject.set(x, "Decryption", value.asInstanceOf[js.Any])
