...
trait ListedFlow extends StObject {
  ...
  var Maintenance: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconnectMod.Maintenance] = js.undefined
  ...
  /**
    ...
    */
  var SourceType: typingsJapgolly.awsSdk.clientsMediaconnectMod.SourceType
  
  /**
    * The current status of the flow.
    */
  var Status: typingsJapgolly.awsSdk.clientsMediaconnectMod.Status
}
object ListedFlow {
