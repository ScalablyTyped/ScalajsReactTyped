...
trait FmtpRequest extends StObject {
  ...
  /**
    ...
    */
  var Colorimetry: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconnectMod.Colorimetry] = js.undefined
  ...
  /**
    ...
    */
  var Range: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconnectMod.Range] = js.undefined
  
  /**
    * The type of compression that was used to smooth the video’s appearance.
    */
  var ScanMode: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconnectMod.ScanMode] = js.undefined
  
  /**
    * The transfer characteristic system (TCS) that is used in the video.
    */
  var Tcs: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconnectMod.Tcs] = js.undefined
}
object FmtpRequest {
