...
trait Reservation extends StObject {
  ...
  /**
    ...
    */
  var DurationUnits: typingsJapgolly.awsSdk.clientsMediaconnectMod.DurationUnits
  ...
  /**
    ...
    */
  var PriceUnits: typingsJapgolly.awsSdk.clientsMediaconnectMod.PriceUnits
  ...
  /**
    ...
    */
  var ReservationState: typingsJapgolly.awsSdk.clientsMediaconnectMod.ReservationState
  
  /**
    * A definition of the amount of outbound bandwidth that you would be reserving if you purchase the offering. MediaConnect defines the values that make up the resourceSpecification in the offering.
    */
  var ResourceSpecification: typingsJapgolly.awsSdk.clientsMediaconnectMod.ResourceSpecification
