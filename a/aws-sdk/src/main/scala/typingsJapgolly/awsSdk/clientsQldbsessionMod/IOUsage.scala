...
trait IOUsage extends StObject {
  ...
  /**
    ...
    */
  var ReadIOs: js.UndefOr[typingsJapgolly.awsSdk.clientsQldbsessionMod.ReadIOs] = js.undefined
  
  /**
    * The number of write I/O requests that the command made.
    */
  var WriteIOs: js.UndefOr[typingsJapgolly.awsSdk.clientsQldbsessionMod.WriteIOs] = js.undefined
}
object IOUsage {
