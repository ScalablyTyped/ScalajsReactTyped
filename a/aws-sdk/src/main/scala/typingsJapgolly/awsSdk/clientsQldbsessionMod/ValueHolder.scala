...
trait ValueHolder extends StObject {
  ...
  /**
    ...
    */
  var IonBinary: js.UndefOr[typingsJapgolly.awsSdk.clientsQldbsessionMod.IonBinary] = js.undefined
  
  /**
    * An Amazon Ion plaintext value contained in a ValueHolder structure.
    */
  var IonText: js.UndefOr[typingsJapgolly.awsSdk.clientsQldbsessionMod.IonText] = js.undefined
}
object ValueHolder {
