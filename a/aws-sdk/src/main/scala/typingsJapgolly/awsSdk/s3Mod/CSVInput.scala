...
trait CSVInput extends js.Object {
  /**
    ...
    */
  var AllowQuotedRecordDelimiter: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.AllowQuotedRecordDelimiter] = js.native
  /**
    * A single character used to indicate that a row should be ignored when the character is present at the start of that row. You can specify any character to indicate a comment line.
    */
  var Comments: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.Comments] = js.native
  /**
    * A single character used to separate individual fields in a record. You can specify an arbitrary delimiter.
    */
  var FieldDelimiter: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.FieldDelimiter] = js.native
  /**
    ...
    */
  var FileHeaderInfo: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.FileHeaderInfo] = js.native
  /**
    ...
    */
  var QuoteCharacter: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.QuoteCharacter] = js.native
  /**
    * A single character used for escaping the quotation mark character inside an already escaped value. For example, the value """ a , b """ is parsed as " a , b ".
    */
  var QuoteEscapeCharacter: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.QuoteEscapeCharacter] = js.native
  /**
    * A single character used to separate individual records in the input. Instead of the default value, you can specify an arbitrary delimiter.
    */
  var RecordDelimiter: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.RecordDelimiter] = js.native
}
