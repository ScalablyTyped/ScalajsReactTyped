...
trait ListPartsRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxParts: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.MaxParts] = js.native
  /**
    * Specifies the part after which listing should begin. Only parts with higher part numbers will be listed.
    */
  var PartNumberMarker: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.PartNumberMarker] = js.native
