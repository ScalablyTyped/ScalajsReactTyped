...
trait PutBucketPolicyRequest extends js.Object {
  ...
  /**
    ...
    */
  var ConfirmRemoveSelfBucketAccess: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.ConfirmRemoveSelfBucketAccess] = js.native
  /**
  ...
  /**
    ...
    */
  var Policy: typingsJapgolly.awsSdk.s3Mod.Policy = js.native
}
