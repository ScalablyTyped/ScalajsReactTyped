...
trait SelectObjectContentRequest extends js.Object {
  ...
  /**
    ...
    */
  var RequestProgress: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.RequestProgress] = js.native
  /**
  ...
  /**
    ...
    */
  var ScanRange: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.ScanRange] = js.native
}
