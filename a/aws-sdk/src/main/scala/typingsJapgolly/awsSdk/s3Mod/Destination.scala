...
trait Destination extends js.Object {
  /**
    ...
    */
  var AccessControlTranslation: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.AccessControlTranslation] = js.native
  /**
  ...
  /**
    ...
    */
  var EncryptionConfiguration: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.EncryptionConfiguration] = js.native
  /**
    ...
    */
  var Metrics: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.Metrics] = js.native
  /**
    *  A container specifying S3 Replication Time Control (S3 RTC), including whether S3 RTC is enabled and the time when all objects and operations on objects must be replicated. Must be specified together with a Metrics block. 
    */
  var ReplicationTime: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.ReplicationTime] = js.native
  /**
