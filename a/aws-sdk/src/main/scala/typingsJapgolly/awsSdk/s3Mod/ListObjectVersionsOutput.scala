...
trait ListObjectVersionsOutput extends js.Object {
  ...
  /**
    ...
    */
  var DeleteMarkers: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.DeleteMarkers] = js.native
  /**
  ...
  /**
    ...
    */
  var IsTruncated: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.IsTruncated] = js.native
  /**
    * Marks the last key returned in a truncated response.
    */
  var KeyMarker: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.KeyMarker] = js.native
  /**
  ...
  /**
    ...
    */
  var NextKeyMarker: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.NextKeyMarker] = js.native
  /**
    * When the number of responses exceeds the value of MaxKeys, NextVersionIdMarker specifies the first object version not returned that satisfies the search criteria. Use this value for the version-id-marker request parameter in a subsequent request.
    */
  var NextVersionIdMarker: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.NextVersionIdMarker] = js.native
  /**
  ...
  /**
    ...
    */
  var VersionIdMarker: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.VersionIdMarker] = js.native
  /**
