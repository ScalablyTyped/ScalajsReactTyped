...
trait Rule extends js.Object {
  var AbortIncompleteMultipartUpload: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.AbortIncompleteMultipartUpload] = js.native
  /**
  ...
  /**
    ...
    */
  var ID: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.ID] = js.native
  var NoncurrentVersionExpiration: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.NoncurrentVersionExpiration] = js.native
  var NoncurrentVersionTransition: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.NoncurrentVersionTransition] = js.native
  /**
    * Object key prefix that identifies one or more objects to which this rule applies.
    */
  var Prefix: typingsJapgolly.awsSdk.s3Mod.Prefix = js.native
  /**
  ...
  /**
    ...
    */
  var Transition: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.Transition] = js.native
}
