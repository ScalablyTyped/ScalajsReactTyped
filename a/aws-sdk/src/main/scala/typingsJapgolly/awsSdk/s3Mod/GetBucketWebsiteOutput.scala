...
trait GetBucketWebsiteOutput extends js.Object {
  /**
    ...
    */
  var ErrorDocument: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.ErrorDocument] = js.native
  /**
    * The name of the index document for the website.
    */
  var IndexDocument: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.IndexDocument] = js.native
  /**
    * Specifies the redirect behavior of all requests to a website endpoint of an Amazon S3 bucket.
    */
  var RedirectAllRequestsTo: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.RedirectAllRequestsTo] = js.native
  /**
    * Rules that define when a redirect is applied and the redirect behavior.
    */
  var RoutingRules: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.RoutingRules] = js.native
}
