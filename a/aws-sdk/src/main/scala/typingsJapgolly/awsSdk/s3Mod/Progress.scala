...
trait Progress extends js.Object {
  /**
    ...
    */
  var BytesProcessed: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.BytesProcessed] = js.native
  /**
    * The current number of bytes of records payload data returned.
    */
  var BytesReturned: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.BytesReturned] = js.native
  /**
    * The current number of object bytes scanned.
    */
  var BytesScanned: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.BytesScanned] = js.native
}
