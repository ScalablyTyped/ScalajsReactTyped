...
trait GetObjectOutput extends js.Object {
  /**
    ...
    */
  var AcceptRanges: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.AcceptRanges] = js.native
  /**
    * Object data.
    */
  var Body: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.Body] = js.native
  /**
  ...
  /**
    ...
    */
  var ContentLength: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.ContentLength] = js.native
  /**
    * The portion of the object returned in the response.
    */
  var ContentRange: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.ContentRange] = js.native
  /**
  ...
  /**
    ...
    */
  var DeleteMarker: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.DeleteMarker] = js.native
  /**
  ...
  /**
    ...
    */
  var Expiration: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.Expiration] = js.native
  /**
  ...
  /**
    ...
    */
  var MissingMeta: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.MissingMeta] = js.native
  /**
  ...
  /**
    ...
    */
  var PartsCount: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.PartsCount] = js.native
  /**
    * Amazon S3 can return this if your request involves a bucket that is either a source or destination in a replication rule.
    */
  var ReplicationStatus: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.ReplicationStatus] = js.native
  var RequestCharged: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.RequestCharged] = js.native
  /**
    * Provides information about object restoration operation and expiration time of the restored object copy.
    */
  var Restore: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.Restore] = js.native
  /**
  ...
  /**
    ...
    */
  var TagCount: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.TagCount] = js.native
  /**
