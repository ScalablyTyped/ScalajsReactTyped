...
trait CreateIdentityPoolInput extends js.Object {
  ...
  /**
    ...
    */
  var DeveloperProviderName: js.UndefOr[typingsJapgolly.awsSdk.cognitoidentityMod.DeveloperProviderName] = js.native
  /**
    * A string that you provide.
    */
  var IdentityPoolName: typingsJapgolly.awsSdk.cognitoidentityMod.IdentityPoolName = js.native
  /**
