...
trait Table extends StObject {
  ...
  /**
    ...
    */
  var MagneticStoreWriteProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsTimestreamwriteMod.MagneticStoreWriteProperties] = js.undefined
  
  /**
    * The retention duration for the memory store and magnetic store.
    */
  var RetentionProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsTimestreamwriteMod.RetentionProperties] = js.undefined
  ...
  /**
    ...
    */
  var TableStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsTimestreamwriteMod.TableStatus] = js.undefined
}
object Table {
