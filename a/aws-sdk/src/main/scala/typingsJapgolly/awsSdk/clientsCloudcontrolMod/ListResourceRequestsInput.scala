...
trait ListResourceRequestsInput extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudcontrolMod.MaxResults] = js.undefined
  
  /**
    * If the previous paginated request didn't return all of the remaining results, the response object's NextToken parameter value is set to a token. To retrieve the next set of results, call this action again and assign that token to the request object's NextToken parameter. If there are no remaining results, the previous response object's NextToken parameter is set to null.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudcontrolMod.NextToken] = js.undefined
  
  /**
    * The filter criteria to apply to the requests returned.
    */
  var ResourceRequestStatusFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudcontrolMod.ResourceRequestStatusFilter] = js.undefined
}
object ListResourceRequestsInput {
  ...
  extension [Self <: ListResourceRequestsInput](x: Self) {
