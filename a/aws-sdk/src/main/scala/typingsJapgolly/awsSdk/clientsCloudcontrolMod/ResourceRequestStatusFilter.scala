...
trait ResourceRequestStatusFilter extends StObject {
  ...
  /**
    ...
    */
  var OperationStatuses: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudcontrolMod.OperationStatuses] = js.undefined
  
  /**
    * The operation types to include in the filter.
    */
  var Operations: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudcontrolMod.Operations] = js.undefined
}
