...
trait UpdateResourceInput extends StObject {
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudcontrolMod.ClientToken] = js.undefined
  ...
  /**
    ...
    */
  var Identifier: typingsJapgolly.awsSdk.clientsCloudcontrolMod.Identifier
  ...
  /**
    ...
    */
  var PatchDocument: typingsJapgolly.awsSdk.clientsCloudcontrolMod.PatchDocument
  ...
  /**
    ...
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudcontrolMod.RoleArn] = js.undefined
  
  /**
    * The name of the resource type.
    */
  var TypeName: typingsJapgolly.awsSdk.clientsCloudcontrolMod.TypeName
  
  /**
    * For private resource types, the type version to use in this resource operation. If you do not specify a resource version, CloudFormation uses the default version.
    */
  var TypeVersionId: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudcontrolMod.TypeVersionId] = js.undefined
}
