...
trait Shard extends StObject {
  ...
  /**
    ...
    */
  var HashKeyRange: typingsJapgolly.awsSdk.clientsKinesisMod.HashKeyRange
  ...
  /**
    ...
    */
  var SequenceNumberRange: typingsJapgolly.awsSdk.clientsKinesisMod.SequenceNumberRange
