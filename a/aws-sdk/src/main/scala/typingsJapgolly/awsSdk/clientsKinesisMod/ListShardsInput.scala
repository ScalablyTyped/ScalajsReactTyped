...
trait ListShardsInput extends StObject {
  ...
  /**
    ...
    */
  var ShardFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisMod.ShardFilter] = js.undefined
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisMod.StreamName] = js.undefined
}
