...
trait DescribeStreamConsumerInput extends StObject {
  ...
  /**
    ...
    */
  var ConsumerARN: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisMod.ConsumerARN] = js.undefined
  
  /**
    * The name that you gave to the consumer.
    */
  var ConsumerName: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisMod.ConsumerName] = js.undefined
  ...
  /**
    ...
    */
  var StreamARN: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisMod.StreamARN] = js.undefined
}
