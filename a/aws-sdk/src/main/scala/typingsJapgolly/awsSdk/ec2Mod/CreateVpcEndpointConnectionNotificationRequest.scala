...
trait CreateVpcEndpointConnectionNotificationRequest extends js.Object {
  ...
  /**
    ...
    */
  var ServiceId: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.ServiceId] = js.native
  /**
    * The ID of the endpoint.
    */
  var VpcEndpointId: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.VpcEndpointId] = js.native
}
