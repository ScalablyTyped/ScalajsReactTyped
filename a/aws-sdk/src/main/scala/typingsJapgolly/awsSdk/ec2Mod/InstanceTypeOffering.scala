...
trait InstanceTypeOffering extends js.Object {
  ...
  /**
    ...
    */
  var Location: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.Location] = js.native
  /**
    * The location type.
    */
  var LocationType: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.LocationType] = js.native
}
