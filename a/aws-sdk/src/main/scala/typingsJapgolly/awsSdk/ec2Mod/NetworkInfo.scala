...
trait NetworkInfo extends js.Object {
  /**
    ...
    */
  var EnaSupport: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.EnaSupport] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkPerformance: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.NetworkPerformance] = js.native
}
