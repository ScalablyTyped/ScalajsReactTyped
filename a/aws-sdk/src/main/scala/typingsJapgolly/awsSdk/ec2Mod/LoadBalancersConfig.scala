...
trait LoadBalancersConfig extends js.Object {
  /**
    ...
    */
  var ClassicLoadBalancersConfig: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.ClassicLoadBalancersConfig] = js.native
  /**
    * The target groups.
    */
  var TargetGroupsConfig: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.TargetGroupsConfig] = js.native
}
