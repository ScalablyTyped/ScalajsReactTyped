...
trait ExportTask extends js.Object {
  ...
  /**
    ...
    */
  var ExportToS3Task: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.ExportToS3Task] = js.native
  /**
    * Information about the instance to export.
    */
  var InstanceExportDetails: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.InstanceExportDetails] = js.native
  /**
