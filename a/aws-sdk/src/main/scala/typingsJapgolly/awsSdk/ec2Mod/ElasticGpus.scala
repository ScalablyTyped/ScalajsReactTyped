...
trait ElasticGpus extends js.Object {
  ...
  /**
    ...
    */
  var ElasticGpuHealth: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.ElasticGpuHealth] = js.native
  /**
  ...
  /**
    ...
    */
  var ElasticGpuState: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.ElasticGpuState] = js.native
  /**
