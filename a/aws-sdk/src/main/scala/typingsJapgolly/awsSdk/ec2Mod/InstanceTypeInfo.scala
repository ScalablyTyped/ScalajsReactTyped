...
trait InstanceTypeInfo extends js.Object {
  ...
  /**
    ...
    */
  var EbsInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.EbsInfo] = js.native
  /**
    * Describes the FPGA accelerator settings for the instance type.
    */
  var FpgaInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.FpgaInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var GpuInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.GpuInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var InferenceAcceleratorInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.InferenceAcceleratorInfo] = js.native
  /**
    * Describes the disks for the instance type.
    */
  var InstanceStorageInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.InstanceStorageInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var MemoryInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.MemoryInfo] = js.native
  /**
    * Describes the network settings for the instance type.
    */
  var NetworkInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.NetworkInfo] = js.native
  /**
    * Describes the placement group settings for the instance type.
    */
  var PlacementGroupInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.PlacementGroupInfo] = js.native
  /**
    * Describes the processor.
    */
  var ProcessorInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.ProcessorInfo] = js.native
  /**
  ...
  /**
    ...
    */
  var VCpuInfo: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.VCpuInfo] = js.native
}
