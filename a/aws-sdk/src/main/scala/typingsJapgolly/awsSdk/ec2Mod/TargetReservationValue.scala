...
trait TargetReservationValue extends js.Object {
  /**
    ...
    */
  var ReservationValue: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.ReservationValue] = js.native
  /**
    * The configuration of the Convertible Reserved Instances that make up the exchange.
    */
  var TargetConfiguration: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.TargetConfiguration] = js.native
}
