...
trait ModifyVpnConnectionRequest extends js.Object {
  /**
    ...
    */
  var CustomerGatewayId: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.CustomerGatewayId] = js.native
  /**
  ...
  /**
    ...
    */
  var VpnGatewayId: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.VpnGatewayId] = js.native
}
