...
trait CreateLaunchTemplateVersionRequest extends js.Object {
  ...
  /**
    ...
    */
  var LaunchTemplateId: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.LaunchTemplateId] = js.native
  /**
    * The name of the launch template. You must specify either the launch template ID or launch template name in the request.
    */
  var LaunchTemplateName: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.LaunchTemplateName] = js.native
  /**
  ...
  /**
    ...
    */
  var VersionDescription: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.VersionDescription] = js.native
}
