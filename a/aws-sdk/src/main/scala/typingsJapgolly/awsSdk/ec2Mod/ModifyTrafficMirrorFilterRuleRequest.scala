...
trait ModifyTrafficMirrorFilterRuleRequest extends js.Object {
  ...
  /**
    ...
    */
  var TrafficDirection: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.TrafficDirection] = js.native
  /**
    * The ID of the Traffic Mirror rule.
    */
  var TrafficMirrorFilterRuleId: typingsJapgolly.awsSdk.ec2Mod.TrafficMirrorFilterRuleId = js.native
}
