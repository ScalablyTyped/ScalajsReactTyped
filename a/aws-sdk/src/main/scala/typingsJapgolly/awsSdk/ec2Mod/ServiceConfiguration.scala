...
trait ServiceConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var PrivateDnsNameConfiguration: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.PrivateDnsNameConfiguration] = js.native
  /**
  ...
  /**
    * The service state.
    */
  var ServiceState: js.UndefOr[typingsJapgolly.awsSdk.ec2Mod.ServiceState] = js.native
  /**
    * The type of service.
    */
