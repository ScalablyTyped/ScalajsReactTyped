...
trait ListApplicationStatesRequest extends StObject {
  ...
  /**
    ...
    */
  var ApplicationIds: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubMod.ApplicationIds] = js.undefined
  
  /**
    * Maximum number of results to be returned per page.
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubMod.MaxResults] = js.undefined
