...
trait MigrationTaskSummary extends StObject {
  ...
  /**
    ...
    */
  var MigrationTaskName: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubMod.MigrationTaskName] = js.undefined
  ...
  /**
    ...
    */
  var ProgressUpdateStream: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubMod.ProgressUpdateStream] = js.undefined
  
  /**
    * Status of the task.
    */
  var Status: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubMod.Status] = js.undefined
