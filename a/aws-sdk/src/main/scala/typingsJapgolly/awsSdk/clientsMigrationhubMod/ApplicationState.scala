...
trait ApplicationState extends StObject {
  ...
  /**
    ...
    */
  var ApplicationId: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubMod.ApplicationId] = js.undefined
  
  /**
    * The current status of an application.
    */
  var ApplicationStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsMigrationhubMod.ApplicationStatus] = js.undefined
