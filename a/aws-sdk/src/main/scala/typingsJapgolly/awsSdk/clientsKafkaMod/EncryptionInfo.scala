...
trait EncryptionInfo extends StObject {
  ...
  /**
    ...
    */
  var EncryptionAtRest: js.UndefOr[typingsJapgolly.awsSdk.clientsKafkaMod.EncryptionAtRest] = js.undefined
  ...
  /**
    ...
    */
  var EncryptionInTransit: js.UndefOr[typingsJapgolly.awsSdk.clientsKafkaMod.EncryptionInTransit] = js.undefined
}
