...
trait Prometheus extends StObject {
  ...
  /**
    ...
    */
  var JmxExporter: js.UndefOr[typingsJapgolly.awsSdk.clientsKafkaMod.JmxExporter] = js.undefined
  ...
  /**
    ...
    */
  var NodeExporter: js.UndefOr[typingsJapgolly.awsSdk.clientsKafkaMod.NodeExporter] = js.undefined
}
object Prometheus {
