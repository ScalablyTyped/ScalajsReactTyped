...
trait AnalysisScheme extends js.Object {
  var AnalysisOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.AnalysisOptions] = js.native
  var AnalysisSchemeLanguage: typingsJapgolly.awsSdk.cloudsearchMod.AnalysisSchemeLanguage = js.native
