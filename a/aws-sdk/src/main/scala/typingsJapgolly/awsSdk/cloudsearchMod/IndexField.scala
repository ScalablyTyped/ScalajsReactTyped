...
trait IndexField extends js.Object {
  var DateArrayOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.DateArrayOptions] = js.native
  var DateOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.DateOptions] = js.native
  var DoubleArrayOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.DoubleArrayOptions] = js.native
  var DoubleOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.DoubleOptions] = js.native
  /**
  ...
  var IndexFieldType: typingsJapgolly.awsSdk.cloudsearchMod.IndexFieldType = js.native
  var IntArrayOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.IntArrayOptions] = js.native
  var IntOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.IntOptions] = js.native
  var LatLonOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.LatLonOptions] = js.native
  var LiteralArrayOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.LiteralArrayOptions] = js.native
  var LiteralOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.LiteralOptions] = js.native
  var TextArrayOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.TextArrayOptions] = js.native
  var TextOptions: js.UndefOr[typingsJapgolly.awsSdk.cloudsearchMod.TextOptions] = js.native
}
