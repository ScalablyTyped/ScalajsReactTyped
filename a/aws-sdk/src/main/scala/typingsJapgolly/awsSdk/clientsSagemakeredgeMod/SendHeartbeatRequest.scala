...
trait SendHeartbeatRequest extends StObject {
  ...
  /**
    ...
    */
  var DeploymentResult: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakeredgeMod.DeploymentResult] = js.undefined
  ...
  /**
    ...
    */
  var Models: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakeredgeMod.Models] = js.undefined
}
