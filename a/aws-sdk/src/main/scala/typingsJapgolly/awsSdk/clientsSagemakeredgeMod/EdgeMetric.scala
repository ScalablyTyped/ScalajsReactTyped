...
trait EdgeMetric extends StObject {
  ...
  /**
    ...
    */
  var Dimension: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakeredgeMod.Dimension] = js.undefined
  ...
  /**
    ...
    */
  var Value: js.UndefOr[typingsJapgolly.awsSdk.clientsSagemakeredgeMod.Value] = js.undefined
}
object EdgeMetric {
