...
trait GetOrganizationsAccessReportResponse extends StObject {
  ...
  /**
    ...
    */
  var AccessDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsIamMod.AccessDetails] = js.undefined
  
  var ErrorDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsIamMod.ErrorDetails] = js.undefined
