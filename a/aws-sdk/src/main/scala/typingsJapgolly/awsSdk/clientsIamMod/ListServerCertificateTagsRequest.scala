...
trait ListServerCertificateTagsRequest extends StObject {
...
object ListServerCertificateTagsRequest {
  ...
  inline def apply(ServerCertificateName: serverCertificateNameType): ListServerCertificateTagsRequest = {
  ...
  extension [Self <: ListServerCertificateTagsRequest](x: Self) {
