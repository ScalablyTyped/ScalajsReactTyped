...
trait CorsRule extends js.Object {
  /**
    ...
    */
  var AllowedHeaders: typingsJapgolly.awsSdk.mediastoreMod.AllowedHeaders = js.native
  /**
    ...
    */
  var AllowedMethods: js.UndefOr[typingsJapgolly.awsSdk.mediastoreMod.AllowedMethods] = js.native
  /**
    ...
    */
  var AllowedOrigins: typingsJapgolly.awsSdk.mediastoreMod.AllowedOrigins = js.native
  /**
    ...
    */
  var ExposeHeaders: js.UndefOr[typingsJapgolly.awsSdk.mediastoreMod.ExposeHeaders] = js.native
  /**
    ...
    */
  var MaxAgeSeconds: js.UndefOr[typingsJapgolly.awsSdk.mediastoreMod.MaxAgeSeconds] = js.native
}
