...
trait HumanLoopActivationOutput extends js.Object {
  ...
  var HumanLoopActivationConditionsEvaluationResults: js.UndefOr[
    typingsJapgolly.awsSdk.textractMod.HumanLoopActivationConditionsEvaluationResults
  ] = js.native
  /**
    * Shows if and why human review was needed.
    */
  var HumanLoopActivationReasons: js.UndefOr[typingsJapgolly.awsSdk.textractMod.HumanLoopActivationReasons] = js.native
  /**
    * The Amazon Resource Name (ARN) of the HumanLoop created.
    */
  var HumanLoopArn: js.UndefOr[typingsJapgolly.awsSdk.textractMod.HumanLoopArn] = js.native
}
