...
trait GetDocumentTextDetectionResponse extends js.Object {
  ...
  /**
    ...
    */
  var DocumentMetadata: js.UndefOr[typingsJapgolly.awsSdk.textractMod.DocumentMetadata] = js.native
  /**
    * The current status of the text detection job.
    */
  var JobStatus: js.UndefOr[typingsJapgolly.awsSdk.textractMod.JobStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.textractMod.StatusMessage] = js.native
  /**
    * A list of warnings that occurred during the text-detection operation for the document.
    */
  var Warnings: js.UndefOr[typingsJapgolly.awsSdk.textractMod.Warnings] = js.native
}
