...
trait HumanLoopConfig extends js.Object {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsJapgolly.awsSdk.textractMod.FlowDefinitionArn = js.native
  /**
    * The name of the human workflow used for this image. This should be kept unique within a region.
    */
  var HumanLoopName: typingsJapgolly.awsSdk.textractMod.HumanLoopName = js.native
}
