...
trait DisassociateUserFromPermissionGroupRequest extends StObject {
...
object DisassociateUserFromPermissionGroupRequest {
  ...
  inline def apply(permissionGroupId: PermissionGroupId, userId: UserId): DisassociateUserFromPermissionGroupRequest = {
  ...
  extension [Self <: DisassociateUserFromPermissionGroupRequest](x: Self) {
