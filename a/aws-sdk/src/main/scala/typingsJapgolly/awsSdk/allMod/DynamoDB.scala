...
import typingsJapgolly.awsSdk.dynamodbMod.^
...
object DynamoDB extends js.Object {
  @js.native
  class Converter ()
    extends typingsJapgolly.awsSdk.dynamodbMod.Converter
  ...
  class DocumentClient ()
    extends typingsJapgolly.awsSdk.dynamodbMod.DocumentClient {
