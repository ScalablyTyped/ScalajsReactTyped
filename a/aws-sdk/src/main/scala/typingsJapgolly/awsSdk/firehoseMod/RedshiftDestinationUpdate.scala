...
trait RedshiftDestinationUpdate extends js.Object {
  ...
  /**
    ...
    */
  var ClusterJDBCURL: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.ClusterJDBCURL] = js.native
  /**
    * The COPY command.
    */
  var CopyCommand: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.CopyCommand] = js.native
  /**
    * The user password.
    */
  var Password: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.Password] = js.native
  /**
  ...
  /**
    ...
    */
  var Username: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.Username] = js.native
}
