...
trait CopyCommand extends js.Object {
  /**
    ...
    */
  var CopyOptions: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.CopyOptions] = js.native
  /**
    * A comma-separated list of column names.
    */
  var DataTableColumns: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.DataTableColumns] = js.native
  /**
    * The name of the target table. The table must already exist in the database.
    */
  var DataTableName: typingsJapgolly.awsSdk.firehoseMod.DataTableName = js.native
}
