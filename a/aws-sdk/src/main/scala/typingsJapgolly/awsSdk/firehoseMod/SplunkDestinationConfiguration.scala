...
trait SplunkDestinationConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var HECEndpoint: typingsJapgolly.awsSdk.firehoseMod.HECEndpoint = js.native
  /**
    * This type can be either "Raw" or "Event."
    */
  var HECEndpointType: typingsJapgolly.awsSdk.firehoseMod.HECEndpointType = js.native
  /**
    * This is a GUID that you obtain from your Splunk cluster when you create a new HEC endpoint.
    */
  var HECToken: typingsJapgolly.awsSdk.firehoseMod.HECToken = js.native
  /**
