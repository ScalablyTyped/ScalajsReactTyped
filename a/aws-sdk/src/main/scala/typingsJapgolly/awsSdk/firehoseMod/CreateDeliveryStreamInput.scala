...
trait CreateDeliveryStreamInput extends js.Object {
  /**
    ...
    */
  var DeliveryStreamEncryptionConfigurationInput: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.DeliveryStreamEncryptionConfigurationInput] = js.native
  /**
  ...
  /**
    ...
    */
  var ElasticsearchDestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.ElasticsearchDestinationConfiguration] = js.native
  /**
    * The destination in Amazon S3. You can specify only one destination.
    */
  var ExtendedS3DestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.ExtendedS3DestinationConfiguration] = js.native
  /**
    * When a Kinesis data stream is used as the source for the delivery stream, a KinesisStreamSourceConfiguration containing the Kinesis data stream Amazon Resource Name (ARN) and the role ARN for the source stream.
    */
  var KinesisStreamSourceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.KinesisStreamSourceConfiguration] = js.native
  /**
    * The destination in Amazon Redshift. You can specify only one destination.
    */
  var RedshiftDestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.RedshiftDestinationConfiguration] = js.native
  /**
    * [Deprecated] The destination in Amazon S3. You can specify only one destination.
    */
  var S3DestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.S3DestinationConfiguration] = js.native
  /**
    * The destination in Splunk. You can specify only one destination.
    */
  var SplunkDestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.SplunkDestinationConfiguration] = js.native
  /**
