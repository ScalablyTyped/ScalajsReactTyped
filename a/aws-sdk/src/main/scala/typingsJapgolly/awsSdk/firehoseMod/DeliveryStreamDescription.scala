...
trait DeliveryStreamDescription extends js.Object {
  ...
  /**
    ...
    */
  var DeliveryStreamARN: typingsJapgolly.awsSdk.firehoseMod.DeliveryStreamARN = js.native
  /**
    * Indicates the server-side encryption (SSE) status for the delivery stream.
    */
  var DeliveryStreamEncryptionConfiguration: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.DeliveryStreamEncryptionConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var DeliveryStreamStatus: typingsJapgolly.awsSdk.firehoseMod.DeliveryStreamStatus = js.native
  /**
    ...
    */
  var DeliveryStreamType: typingsJapgolly.awsSdk.firehoseMod.DeliveryStreamType = js.native
  /**
    * The destinations.
    */
  ...
  /**
    ...
    */
  var FailureDescription: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.FailureDescription] = js.native
  /**
