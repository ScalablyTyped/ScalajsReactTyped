...
trait RedshiftDestinationDescription extends js.Object {
  ...
  /**
    ...
    */
  var ClusterJDBCURL: typingsJapgolly.awsSdk.firehoseMod.ClusterJDBCURL = js.native
  /**
    * The COPY command.
    */
  var CopyCommand: typingsJapgolly.awsSdk.firehoseMod.CopyCommand = js.native
  /**
  ...
  /**
    ...
    */
  var S3DestinationDescription: typingsJapgolly.awsSdk.firehoseMod.S3DestinationDescription = js.native
  /**
    * The name of the user.
    */
  var Username: typingsJapgolly.awsSdk.firehoseMod.Username = js.native
}
