...
trait CloudWatchLoggingOptions extends js.Object {
  ...
  /**
    ...
    */
  var LogGroupName: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.LogGroupName] = js.native
  /**
    * The CloudWatch log stream name for logging. This value is required if CloudWatch logging is enabled.
    */
  var LogStreamName: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.LogStreamName] = js.native
}
