...
trait PutRecordBatchResponseEntry extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.ErrorCode] = js.native
  /**
    * The error message for an individual record result.
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.firehoseMod.ErrorMessage] = js.native
  /**
