...
trait DBInstance extends js.Object {
  ...
  /**
    ...
    */
  var Endpoint: js.UndefOr[typingsJapgolly.awsSdk.neptuneMod.Endpoint] = js.native
  /**
  ...
  /**
    ...
    */
  var PendingModifiedValues: js.UndefOr[typingsJapgolly.awsSdk.neptuneMod.PendingModifiedValues] = js.native
  /**
    *  (Not supported by Neptune) 
    */
