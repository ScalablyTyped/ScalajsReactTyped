...
trait DBCluster extends js.Object {
  ...
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsJapgolly.awsSdk.neptuneMod.AvailabilityZones] = js.native
  /**
  ...
  /**
    *  (Not supported by Neptune) 
    */
  var DBClusterOptionGroupMemberships: js.UndefOr[typingsJapgolly.awsSdk.neptuneMod.DBClusterOptionGroupMemberships] = js.native
  /**
