...
trait DescribeAccountLimitsAnswer extends StObject {
  ...
  /**
    ...
    */
  var MaxNumberOfAutoScalingGroups: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.MaxNumberOfAutoScalingGroups] = js.undefined
  
  /**
    * The maximum number of launch configurations allowed for your account. The default is 200 launch configurations per Region.
    */
  var MaxNumberOfLaunchConfigurations: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.MaxNumberOfLaunchConfigurations] = js.undefined
  
  /**
    * The current number of groups for your account.
    */
  var NumberOfAutoScalingGroups: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.NumberOfAutoScalingGroups] = js.undefined
  
  /**
    * The current number of launch configurations for your account.
    */
  var NumberOfLaunchConfigurations: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.NumberOfLaunchConfigurations] = js.undefined
}
