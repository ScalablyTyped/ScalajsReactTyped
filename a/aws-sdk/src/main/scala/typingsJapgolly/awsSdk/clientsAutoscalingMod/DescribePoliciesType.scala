...
trait DescribePoliciesType extends StObject {
  ...
  /**
    ...
    */
  var PolicyNames: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.PolicyNames] = js.undefined
  
  /**
    * One or more policy types. The valid values are SimpleScaling, StepScaling, TargetTrackingScaling, and PredictiveScaling.
    */
  var PolicyTypes: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.PolicyTypes] = js.undefined
}
