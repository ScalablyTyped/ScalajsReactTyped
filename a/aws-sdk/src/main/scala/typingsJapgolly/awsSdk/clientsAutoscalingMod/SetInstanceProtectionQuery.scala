...
trait SetInstanceProtectionQuery extends StObject {
  ...
  /**
    ...
    */
  var InstanceIds: typingsJapgolly.awsSdk.clientsAutoscalingMod.InstanceIds
  
  /**
    * Indicates whether the instance is protected from termination by Amazon EC2 Auto Scaling when scaling in.
    */
  var ProtectedFromScaleIn: typingsJapgolly.awsSdk.clientsAutoscalingMod.ProtectedFromScaleIn
}
