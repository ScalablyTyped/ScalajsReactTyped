...
trait DescribeScalingActivitiesType extends StObject {
  ...
  /**
    ...
    */
  var ActivityIds: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.ActivityIds] = js.undefined
  ...
  /**
    ...
    */
  var IncludeDeletedGroups: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.IncludeDeletedGroups] = js.undefined
  
  /**
    * The maximum number of items to return with this call. The default value is 100 and the maximum value is 100.
    */
  var MaxRecords: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.MaxRecords] = js.undefined
