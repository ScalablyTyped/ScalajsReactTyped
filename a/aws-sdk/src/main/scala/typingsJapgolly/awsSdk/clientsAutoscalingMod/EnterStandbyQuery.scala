...
trait EnterStandbyQuery extends StObject {
  ...
  /**
    ...
    */
  var InstanceIds: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.InstanceIds] = js.undefined
  
  /**
    * Indicates whether to decrement the desired capacity of the Auto Scaling group by the number of instances moved to Standby mode.
    */
  var ShouldDecrementDesiredCapacity: typingsJapgolly.awsSdk.clientsAutoscalingMod.ShouldDecrementDesiredCapacity
}
