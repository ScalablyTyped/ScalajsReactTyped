...
trait PutLifecycleHookType extends StObject {
  ...
  /**
    ...
    */
  var HeartbeatTimeout: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.HeartbeatTimeout] = js.undefined
  ...
  /**
    ...
    */
  var LifecycleTransition: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.LifecycleTransition] = js.undefined
