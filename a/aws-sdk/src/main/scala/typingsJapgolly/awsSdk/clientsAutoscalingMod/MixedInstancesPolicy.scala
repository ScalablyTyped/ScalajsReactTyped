...
trait MixedInstancesPolicy extends StObject {
  ...
  /**
    ...
    */
  var InstancesDistribution: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.InstancesDistribution] = js.undefined
  
  /**
    * One or more launch templates and the instance types (overrides) that are used to launch EC2 instances to fulfill On-Demand and Spot capacities.
    */
  var LaunchTemplate: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.LaunchTemplate] = js.undefined
}
