...
trait AutoScalingGroupNamesType extends StObject {
  ...
  /**
    ...
    */
  var AutoScalingGroupNames: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.AutoScalingGroupNames] = js.undefined
  
  /**
    * One or more filters to limit the results based on specific tags. 
    */
  var Filters: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.Filters] = js.undefined
