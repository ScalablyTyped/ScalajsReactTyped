...
trait AutoScalingGroup extends StObject {
  ...
  /**
    ...
    */
  var AvailabilityZones: typingsJapgolly.awsSdk.clientsAutoscalingMod.AvailabilityZones
  ...
  /**
    * Reserved.
    */
  var Context: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.Context] = js.undefined
  ...
  /**
    ...
    */
  var DefaultInstanceWarmup: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.DefaultInstanceWarmup] = js.undefined
  ...
  /**
    ...
    */
  var EnabledMetrics: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.EnabledMetrics] = js.undefined
  
  /**
    * The duration of the health check grace period, in seconds.
    */
  var HealthCheckGracePeriod: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.HealthCheckGracePeriod] = js.undefined
  ...
  /**
    ...
    */
  var Instances: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.Instances] = js.undefined
  ...
  /**
    ...
    */
  var LoadBalancerNames: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.LoadBalancerNames] = js.undefined
  
  /**
    * The maximum amount of time, in seconds, that an instance can be in service. Valid Range: Minimum value of 0.
    */
  var MaxInstanceLifetime: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.MaxInstanceLifetime] = js.undefined
  ...
  /**
    ...
    */
  var SuspendedProcesses: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.SuspendedProcesses] = js.undefined
  ...
  /**
    ...
    */
  var TargetGroupARNs: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.TargetGroupARNs] = js.undefined
  
  /**
    * The termination policies for the group.
    */
  var TerminationPolicies: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.TerminationPolicies] = js.undefined
  ...
  /**
    ...
    */
  var WarmPoolConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.WarmPoolConfiguration] = js.undefined
  
  /**
    * The current size of the warm pool.
    */
  var WarmPoolSize: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.WarmPoolSize] = js.undefined
}
