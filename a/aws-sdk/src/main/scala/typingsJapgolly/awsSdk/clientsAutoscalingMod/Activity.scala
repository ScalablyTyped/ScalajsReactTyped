...
trait Activity extends StObject {
  ...
  /**
    ...
    */
  var AutoScalingGroupState: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.AutoScalingGroupState] = js.undefined
  ...
  /**
    ...
    */
  var Progress: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingMod.Progress] = js.undefined
