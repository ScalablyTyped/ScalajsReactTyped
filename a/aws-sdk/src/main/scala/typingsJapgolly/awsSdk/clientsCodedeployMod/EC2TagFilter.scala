...
trait EC2TagFilter extends StObject {
  ...
  /**
    * The tag filter key.
    */
  var Key: js.UndefOr[typingsJapgolly.awsSdk.clientsCodedeployMod.Key] = js.undefined
  ...
  /**
    ...
    */
  var Value: js.UndefOr[typingsJapgolly.awsSdk.clientsCodedeployMod.Value] = js.undefined
}
object EC2TagFilter {
