...
trait AssociateRepositoryRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typingsJapgolly.awsSdk.codegurureviewerMod.ClientRequestToken] = js.native
  /**
    * The repository to associate.
    */
  var Repository: typingsJapgolly.awsSdk.codegurureviewerMod.Repository = js.native
}
