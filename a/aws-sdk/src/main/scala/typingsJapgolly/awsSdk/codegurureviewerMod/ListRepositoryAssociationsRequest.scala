...
trait ListRepositoryAssociationsRequest extends js.Object {
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.codegurureviewerMod.MaxResults] = js.native
  /**
    * List of names to use as a filter.
    */
  var Names: js.UndefOr[typingsJapgolly.awsSdk.codegurureviewerMod.Names] = js.native
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.codegurureviewerMod.NextToken] = js.native
  /**
    ...
    */
  var Owners: js.UndefOr[typingsJapgolly.awsSdk.codegurureviewerMod.Owners] = js.native
  /**
    * List of provider types to use as a filter.
    */
  var ProviderTypes: js.UndefOr[typingsJapgolly.awsSdk.codegurureviewerMod.ProviderTypes] = js.native
  /**
