...
trait Protection extends StObject {
  ...
  /**
    ...
    */
  var ApplicationLayerAutomaticResponseConfiguration: js.UndefOr[
    typingsJapgolly.awsSdk.clientsShieldMod.ApplicationLayerAutomaticResponseConfiguration
  ] = js.undefined
  
  /**
    * The unique identifier (ID) for the Route 53 health check that's associated with the protection. 
    */
  var HealthCheckIds: js.UndefOr[typingsJapgolly.awsSdk.clientsShieldMod.HealthCheckIds] = js.undefined
