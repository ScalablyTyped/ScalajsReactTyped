...
trait SubscriptionLimits extends StObject {
  ...
  /**
    ...
    */
  var ProtectionGroupLimits: typingsJapgolly.awsSdk.clientsShieldMod.ProtectionGroupLimits
  
  /**
    * Limits settings on protections for your subscription. 
    */
  var ProtectionLimits: typingsJapgolly.awsSdk.clientsShieldMod.ProtectionLimits
}
