...
trait LDAPSSettingInfo extends StObject {
  ...
  /**
    ...
    */
  var LDAPSStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.LDAPSStatus] = js.undefined
  
  /**
    * Describes a state change for LDAPS.
    */
  var LDAPSStatusReason: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.LDAPSStatusReason] = js.undefined
