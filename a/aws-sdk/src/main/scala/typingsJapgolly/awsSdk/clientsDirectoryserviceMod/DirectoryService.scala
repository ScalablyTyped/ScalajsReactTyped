...
trait DirectoryService extends Service {
  ...
  /**
    ...
    */
  def describeUpdateDirectory(): Request[DescribeUpdateDirectoryResult, AWSError] = js.native
  def describeUpdateDirectory(callback: js.Function2[/* err */ AWSError, /* data */ DescribeUpdateDirectoryResult, Unit]): Request[DescribeUpdateDirectoryResult, AWSError] = js.native
  /**
    *  Describes the updates of a directory for a particular update type. 
    */
  def describeUpdateDirectory(params: DescribeUpdateDirectoryRequest): Request[DescribeUpdateDirectoryResult, AWSError] = js.native
  def describeUpdateDirectory(
    params: DescribeUpdateDirectoryRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ DescribeUpdateDirectoryResult, Unit]
  ): Request[DescribeUpdateDirectoryResult, AWSError] = js.native
  ...
  /**
    ...
    */
  def updateDirectorySetup(): Request[UpdateDirectorySetupResult, AWSError] = js.native
  def updateDirectorySetup(callback: js.Function2[/* err */ AWSError, /* data */ UpdateDirectorySetupResult, Unit]): Request[UpdateDirectorySetupResult, AWSError] = js.native
  /**
    *  Updates the directory for a particular update type. 
    */
  def updateDirectorySetup(params: UpdateDirectorySetupRequest): Request[UpdateDirectorySetupResult, AWSError] = js.native
  def updateDirectorySetup(
    params: UpdateDirectorySetupRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ UpdateDirectorySetupResult, Unit]
  ): Request[UpdateDirectorySetupResult, AWSError] = js.native
