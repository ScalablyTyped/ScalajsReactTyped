...
trait DirectoryLimits extends StObject {
  ...
  var CloudOnlyDirectoriesLimitReached: js.UndefOr[
    typingsJapgolly.awsSdk.clientsDirectoryserviceMod.CloudOnlyDirectoriesLimitReached
  ] = js.undefined
  ...
  var ConnectedDirectoriesLimitReached: js.UndefOr[
    typingsJapgolly.awsSdk.clientsDirectoryserviceMod.ConnectedDirectoriesLimitReached
  ] = js.undefined
}
