...
trait EventTopic extends StObject {
  ...
  /**
    ...
    */
  var TopicArn: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TopicArn] = js.undefined
  
  /**
    * The name of an Amazon SNS topic the receives status messages from the directory.
    */
  var TopicName: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TopicName] = js.undefined
}
object EventTopic {
