...
trait ShareDirectoryRequest extends StObject {
  ...
  /**
    ...
    */
  var ShareMethod: typingsJapgolly.awsSdk.clientsDirectoryserviceMod.ShareMethod
  ...
  /**
    ...
    */
  var ShareTarget: typingsJapgolly.awsSdk.clientsDirectoryserviceMod.ShareTarget
}
