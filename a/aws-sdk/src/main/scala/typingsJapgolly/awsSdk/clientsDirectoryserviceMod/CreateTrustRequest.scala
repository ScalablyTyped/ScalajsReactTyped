...
trait CreateTrustRequest extends StObject {
  ...
  /**
    ...
    */
  var TrustDirection: typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TrustDirection
  
  /**
    * The trust password. The must be the same password that was used when creating the trust relationship on the external domain.
    */
  var TrustPassword: typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TrustPassword
