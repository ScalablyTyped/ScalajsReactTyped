...
trait UpdateDirectorySetupRequest extends StObject {
  ...
  /**
    ...
    */
  var CreateSnapshotBeforeUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.CreateSnapshotBeforeUpdate] = js.undefined
  ...
  /**
    ...
    */
  var OSUpdateSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.OSUpdateSettings] = js.undefined
  
  /**
    *  The type of update that needs to be performed on the directory. For example, OS. 
    */
  var UpdateType: typingsJapgolly.awsSdk.clientsDirectoryserviceMod.UpdateType
}
