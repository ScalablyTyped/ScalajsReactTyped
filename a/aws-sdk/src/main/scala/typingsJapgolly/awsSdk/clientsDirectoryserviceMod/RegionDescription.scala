...
trait RegionDescription extends StObject {
  ...
  /**
    ...
    */
  var RegionName: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.RegionName] = js.undefined
  
  /**
    * Specifies whether the Region is the primary Region or an additional Region.
    */
  var RegionType: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.RegionType] = js.undefined
