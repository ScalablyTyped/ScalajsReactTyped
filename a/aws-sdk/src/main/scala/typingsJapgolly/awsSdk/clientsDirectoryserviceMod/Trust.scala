...
trait Trust extends StObject {
  ...
  /**
    ...
    */
  var RemoteDomainName: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.RemoteDomainName] = js.undefined
  
  /**
    * Current state of selective authentication for the trust.
    */
  var SelectiveAuth: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.SelectiveAuth] = js.undefined
  ...
  /**
    ...
    */
  var TrustDirection: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TrustDirection] = js.undefined
  
  /**
    * The unique ID of the trust relationship.
    */
  var TrustId: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TrustId] = js.undefined
  
  /**
    * The trust relationship state.
    */
  var TrustState: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TrustState] = js.undefined
  
  /**
    * The reason for the TrustState.
    */
  var TrustStateReason: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TrustStateReason] = js.undefined
  
  /**
    * The trust relationship type. Forest is the default.
    */
  var TrustType: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.TrustType] = js.undefined
}
object Trust {
