...
trait DirectoryDescription extends StObject {
  ...
  /**
    ...
    */
  var AccessUrl: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.AccessUrl] = js.undefined
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.Description] = js.undefined
  
  /**
    * The desired number of domain controllers in the directory if the directory is Microsoft AD.
    */
  var DesiredNumberOfDomainControllers: js.UndefOr[
    typingsJapgolly.awsSdk.clientsDirectoryserviceMod.DesiredNumberOfDomainControllers
  ] = js.undefined
  ...
  /**
    ...
    */
  var DnsIpAddrs: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.DnsIpAddrs] = js.undefined
  ...
  /**
    ...
    */
  var OwnerDirectoryDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.OwnerDirectoryDescription] = js.undefined
  
  /**
    * A RadiusSettings object that contains information about the RADIUS server configured for this directory.
    */
  var RadiusSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.RadiusSettings] = js.undefined
  
  /**
    * The status of the RADIUS MFA server connection.
    */
  var RadiusStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.RadiusStatus] = js.undefined
  
  /**
    * Lists the Regions where the directory has replicated.
    */
  var RegionsInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.RegionsInfo] = js.undefined
  ...
  /**
    ...
    */
  var ShareMethod: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.ShareMethod] = js.undefined
  ...
  /**
    ...
    */
  var ShareStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.ShareStatus] = js.undefined
  ...
  /**
    ...
    */
  var SsoEnabled: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.SsoEnabled] = js.undefined
  ...
  /**
    ...
    */
  var StageReason: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.StageReason] = js.undefined
