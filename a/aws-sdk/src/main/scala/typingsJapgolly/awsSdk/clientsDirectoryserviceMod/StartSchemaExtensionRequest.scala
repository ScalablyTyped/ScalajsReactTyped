...
trait StartSchemaExtensionRequest extends StObject {
  ...
  /**
    ...
    */
  var CreateSnapshotBeforeSchemaExtension: typingsJapgolly.awsSdk.clientsDirectoryserviceMod.CreateSnapshotBeforeSchemaExtension
  
  /**
    * A description of the schema extension.
    */
  var Description: typingsJapgolly.awsSdk.clientsDirectoryserviceMod.Description
  ...
  /**
    ...
    */
  var LdifContent: typingsJapgolly.awsSdk.clientsDirectoryserviceMod.LdifContent
}
