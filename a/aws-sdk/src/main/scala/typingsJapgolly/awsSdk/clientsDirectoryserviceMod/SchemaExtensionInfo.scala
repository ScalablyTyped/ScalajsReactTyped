...
trait SchemaExtensionInfo extends StObject {
  ...
  /**
    ...
    */
  var SchemaExtensionStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.SchemaExtensionStatus] = js.undefined
  
  /**
    * The reason for the SchemaExtensionStatus.
    */
  var SchemaExtensionStatusReason: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.SchemaExtensionStatusReason] = js.undefined
