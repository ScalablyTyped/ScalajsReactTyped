...
trait IpRouteInfo extends StObject {
  ...
  /**
    ...
    */
  var CidrIp: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.CidrIp] = js.undefined
  ...
  /**
    ...
    */
  var IpRouteStatusMsg: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.IpRouteStatusMsg] = js.undefined
  
  /**
    * The reason for the IpRouteStatusMsg.
    */
  var IpRouteStatusReason: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.IpRouteStatusReason] = js.undefined
}
object IpRouteInfo {
