...
trait DirectoryVpcSettingsDescription extends StObject {
  ...
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.AvailabilityZones] = js.undefined
  
  /**
    * The domain controller security group identifier for the directory.
    */
  var SecurityGroupId: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.SecurityGroupId] = js.undefined
  
  /**
    * The identifiers of the subnets for the directory servers.
    */
  var SubnetIds: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.SubnetIds] = js.undefined
  
  /**
    * The identifier of the VPC that the directory is in.
    */
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.clientsDirectoryserviceMod.VpcId] = js.undefined
}
