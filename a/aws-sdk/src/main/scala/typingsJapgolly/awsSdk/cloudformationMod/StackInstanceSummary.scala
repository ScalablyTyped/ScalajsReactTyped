...
trait StackInstanceSummary extends js.Object {
  /**
    ...
    */
  var Account: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.Account] = js.native
  /**
  ...
  /**
    ...
    */
  var OrganizationalUnitId: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.OrganizationalUnitId] = js.native
  /**
    * The name of the AWS region that the stack instance is associated with.
    */
  var Region: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.Region] = js.native
  /**
