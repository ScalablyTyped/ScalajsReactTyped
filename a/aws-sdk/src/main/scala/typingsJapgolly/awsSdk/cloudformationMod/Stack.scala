...
trait Stack extends js.Object {
  /**
    ...
    */
  var Capabilities: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.Capabilities] = js.native
  /**
    * The unique ID of the change set.
    */
  var ChangeSetId: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.ChangeSetId] = js.native
  /**
  ...
  /**
    ...
    */
  var DisableRollback: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.DisableRollback] = js.native
  /**
  ...
  /**
    ...
    */
  var EnableTerminationProtection: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.EnableTerminationProtection] = js.native
  /**
  ...
  /**
    ...
    */
  var NotificationARNs: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.NotificationARNs] = js.native
  /**
    * A list of output structures.
    */
  var Outputs: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.Outputs] = js.native
  /**
    * A list of Parameter structures.
    */
  var Parameters: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.Parameters] = js.native
  /**
  ...
  /**
    ...
    */
  var RollbackConfiguration: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.RollbackConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.Tags] = js.native
  /**
