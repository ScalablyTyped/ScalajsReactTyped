...
trait RollbackConfiguration extends js.Object {
  /**
    ...
    */
  var MonitoringTimeInMinutes: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.MonitoringTimeInMinutes] = js.native
  /**
    ...
    */
  var RollbackTriggers: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.RollbackTriggers] = js.native
}
