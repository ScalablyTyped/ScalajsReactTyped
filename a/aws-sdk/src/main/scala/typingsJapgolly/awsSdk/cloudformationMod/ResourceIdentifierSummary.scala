...
trait ResourceIdentifierSummary extends js.Object {
  /**
    ...
    */
  var LogicalResourceIds: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.LogicalResourceIds] = js.native
  /**
    ...
    */
  var ResourceIdentifiers: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.ResourceIdentifiers] = js.native
  /**
