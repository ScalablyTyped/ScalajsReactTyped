...
trait ResourceChangeDetail extends js.Object {
  /**
    ...
    */
  var CausingEntity: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.CausingEntity] = js.native
  /**
    ...
    */
  var ChangeSource: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.ChangeSource] = js.native
  /**
