...
trait RegisterTypeInput extends js.Object {
  ...
  /**
    ...
    */
  var LoggingConfig: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.LoggingConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var TypeName: typingsJapgolly.awsSdk.cloudformationMod.TypeName = js.native
}
