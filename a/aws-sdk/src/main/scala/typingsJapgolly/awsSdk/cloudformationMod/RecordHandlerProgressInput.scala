...
trait RecordHandlerProgressInput extends js.Object {
  ...
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var OperationStatus: typingsJapgolly.awsSdk.cloudformationMod.OperationStatus = js.native
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var ResourceModel: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.ResourceModel] = js.native
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.StatusMessage] = js.native
}
