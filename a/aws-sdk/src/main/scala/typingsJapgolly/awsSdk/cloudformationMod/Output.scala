...
trait Output extends js.Object {
  ...
  /**
    ...
    */
  var ExportName: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.ExportName] = js.native
  /**
    * The key associated with the output.
    */
  var OutputKey: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.OutputKey] = js.native
  /**
    * The value associated with the output.
    */
  var OutputValue: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.OutputValue] = js.native
}
