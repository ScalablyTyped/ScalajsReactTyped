...
trait PropertyDifference extends js.Object {
  ...
  /**
    ...
    */
  var DifferenceType: typingsJapgolly.awsSdk.cloudformationMod.DifferenceType = js.native
  /**
  ...
  /**
    ...
    */
  var PropertyPath: typingsJapgolly.awsSdk.cloudformationMod.PropertyPath = js.native
}
