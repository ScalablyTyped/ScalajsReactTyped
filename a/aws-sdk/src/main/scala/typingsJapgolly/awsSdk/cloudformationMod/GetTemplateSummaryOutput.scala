...
trait GetTemplateSummaryOutput extends js.Object {
  ...
  /**
    ...
    */
  var CapabilitiesReason: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.CapabilitiesReason] = js.native
  /**
  ...
  /**
    ...
    */
  var Metadata: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.Metadata] = js.native
  /**
  ...
  /**
    ...
    */
  var ResourceIdentifierSummaries: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.ResourceIdentifierSummaries] = js.native
  /**
    * A list of all the template resource types that are defined in the template, such as AWS::EC2::Instance, AWS::Dynamo::Table, and Custom::MyCustomInstance.
    */
  var ResourceTypes: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.ResourceTypes] = js.native
  /**
    * The AWS template format version, which identifies the capabilities of the template.
    */
  var Version: js.UndefOr[typingsJapgolly.awsSdk.cloudformationMod.Version] = js.native
}
