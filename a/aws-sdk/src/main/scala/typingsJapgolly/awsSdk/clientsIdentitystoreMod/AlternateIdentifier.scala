...
trait AlternateIdentifier extends StObject {
  ...
  /**
    ...
    */
  var ExternalId: js.UndefOr[typingsJapgolly.awsSdk.clientsIdentitystoreMod.ExternalId] = js.undefined
  
  /**
    * An entity attribute that's unique to a specific entity.
    */
  var UniqueAttribute: js.UndefOr[typingsJapgolly.awsSdk.clientsIdentitystoreMod.UniqueAttribute] = js.undefined
}
