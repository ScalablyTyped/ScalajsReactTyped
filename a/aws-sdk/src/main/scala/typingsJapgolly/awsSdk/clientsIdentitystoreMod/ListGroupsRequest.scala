...
trait ListGroupsRequest extends StObject {
  ...
  /**
    ...
    */
  var Filters: js.UndefOr[typingsJapgolly.awsSdk.clientsIdentitystoreMod.Filters] = js.undefined
...
object ListGroupsRequest {
  ...
  inline def apply(IdentityStoreId: IdentityStoreId): ListGroupsRequest = {
