...
trait DescribeGroupResponse extends StObject {
  ...
  /**
    ...
    */
  var ExternalIds: js.UndefOr[typingsJapgolly.awsSdk.clientsIdentitystoreMod.ExternalIds] = js.undefined
...
object DescribeGroupResponse {
  ...
  inline def apply(GroupId: ResourceId, IdentityStoreId: IdentityStoreId): DescribeGroupResponse = {
