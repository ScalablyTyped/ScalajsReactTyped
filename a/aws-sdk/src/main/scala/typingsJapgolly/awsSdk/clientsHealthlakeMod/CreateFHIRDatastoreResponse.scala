...
trait CreateFHIRDatastoreResponse extends StObject {
  ...
  /**
    ...
    */
  var DatastoreArn: typingsJapgolly.awsSdk.clientsHealthlakeMod.DatastoreArn
  ...
  /**
    ...
    */
  var DatastoreStatus: typingsJapgolly.awsSdk.clientsHealthlakeMod.DatastoreStatus
}
