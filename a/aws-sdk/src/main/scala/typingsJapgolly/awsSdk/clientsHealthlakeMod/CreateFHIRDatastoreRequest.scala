...
trait CreateFHIRDatastoreRequest extends StObject {
  ...
  /**
    ...
    */
  var DatastoreName: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthlakeMod.DatastoreName] = js.undefined
  ...
  /**
    ...
    */
  var PreloadDataConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthlakeMod.PreloadDataConfig] = js.undefined
  
  /**
    *  The server-side encryption key configuration for a customer provided encryption key specified for creating a Data Store. 
    */
  var SseConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthlakeMod.SseConfiguration] = js.undefined
