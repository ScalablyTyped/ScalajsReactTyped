...
trait ImportJobProperties extends StObject {
  ...
  /**
    ...
    */
  var InputDataConfig: typingsJapgolly.awsSdk.clientsHealthlakeMod.InputDataConfig
  ...
  /**
    ...
    */
  var JobStatus: typingsJapgolly.awsSdk.clientsHealthlakeMod.JobStatus
  
  /**
    * An explanation of any errors that may have occurred during the FHIR import job. 
    */
  var Message: js.UndefOr[typingsJapgolly.awsSdk.clientsHealthlakeMod.Message] = js.undefined
