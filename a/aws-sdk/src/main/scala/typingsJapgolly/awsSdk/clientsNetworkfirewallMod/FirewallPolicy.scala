...
trait FirewallPolicy extends StObject {
  ...
  /**
    ...
    */
  var StatefulEngineOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.StatefulEngineOptions] = js.undefined
  
  /**
    * References to the stateful rule groups that are used in the policy. These define the inspection criteria in stateful rules. 
    */
  var StatefulRuleGroupReferences: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.StatefulRuleGroupReferences] = js.undefined
  ...
  /**
    ...
    */
  var StatelessRuleGroupReferences: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.StatelessRuleGroupReferences] = js.undefined
}
