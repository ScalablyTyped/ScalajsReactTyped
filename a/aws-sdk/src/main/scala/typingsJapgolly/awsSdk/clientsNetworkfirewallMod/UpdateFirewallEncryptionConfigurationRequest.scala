...
trait UpdateFirewallEncryptionConfigurationRequest extends StObject {
...
object UpdateFirewallEncryptionConfigurationRequest {
  ...
  inline def apply(): UpdateFirewallEncryptionConfigurationRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateFirewallEncryptionConfigurationRequest]
  }
  
  extension [Self <: UpdateFirewallEncryptionConfigurationRequest](x: Self) {
