...
trait CustomAction extends StObject {
  ...
  /**
    ...
    */
  var ActionDefinition: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.ActionDefinition
  
  /**
    * The descriptive name of the custom action. You can't change the name of a custom action after you create it.
    */
  var ActionName: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.ActionName
}
object CustomAction {
