...
trait CreateFirewallResponse extends StObject {
  ...
  /**
    ...
    */
  var Firewall: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.Firewall] = js.undefined
  
  /**
    * Detailed information about the current status of a Firewall. You can retrieve this for a firewall by calling DescribeFirewall and providing the firewall name and ARN.
    */
  var FirewallStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.FirewallStatus] = js.undefined
}
