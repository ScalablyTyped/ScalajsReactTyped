...
trait StatelessRulesAndCustomActions extends StObject {
  ...
  /**
    ...
    */
  var CustomActions: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.CustomActions] = js.undefined
  
  /**
    * Defines the set of stateless rules for use in a stateless rule group. 
    */
  var StatelessRules: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.StatelessRules
}
