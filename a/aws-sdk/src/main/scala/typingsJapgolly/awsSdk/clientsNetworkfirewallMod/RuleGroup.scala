...
trait RuleGroup extends StObject {
  ...
  /**
    ...
    */
  var ReferenceSets: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.ReferenceSets] = js.undefined
  
  /**
    * Settings that are available for use in the rules in the rule group. You can only use these for stateful rule groups. 
    */
  var RuleVariables: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.RuleVariables] = js.undefined
  
  /**
    * The stateful rules or stateless rules for the rule group. 
    */
  var RulesSource: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.RulesSource
  ...
  /**
    ...
    */
  var StatefulRuleOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.StatefulRuleOptions] = js.undefined
}
object RuleGroup {
