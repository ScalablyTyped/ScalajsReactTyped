...
trait RuleOption extends StObject {
  ...
  /**
    * 
    */
  var Keyword: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.Keyword
  
  /**
    * 
    */
  var Settings: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.Settings] = js.undefined
}
object RuleOption {
