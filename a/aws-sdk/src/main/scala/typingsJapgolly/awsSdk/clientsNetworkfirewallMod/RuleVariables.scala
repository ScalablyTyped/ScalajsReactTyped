...
trait RuleVariables extends StObject {
  ...
  /**
    ...
    */
  var IPSets: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.IPSets] = js.undefined
  
  /**
    * A list of port ranges. 
    */
  var PortSets: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.PortSets] = js.undefined
}
