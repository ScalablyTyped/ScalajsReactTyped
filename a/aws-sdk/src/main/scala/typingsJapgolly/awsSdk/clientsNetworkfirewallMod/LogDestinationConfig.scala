...
trait LogDestinationConfig extends StObject {
  ...
  /**
    ...
    */
  var LogDestinationType: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.LogDestinationType
  ...
  /**
    ...
    */
  var LogType: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.LogType
}
