...
trait StatefulEngineOptions extends StObject {
  ...
  /**
    ...
    */
  var RuleOrder: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.RuleOrder] = js.undefined
  ...
  /**
    ...
    */
  var StreamExceptionPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkfirewallMod.StreamExceptionPolicy] = js.undefined
}
