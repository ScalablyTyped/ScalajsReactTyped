...
trait RulesSourceList extends StObject {
  ...
  /**
    ...
    */
  var GeneratedRulesType: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.GeneratedRulesType
  
  /**
    * The protocols you want to inspect. Specify TLS_SNI for HTTPS. Specify HTTP_HOST for HTTP. You can specify either or both. 
    */
  var TargetTypes: typingsJapgolly.awsSdk.clientsNetworkfirewallMod.TargetTypes
