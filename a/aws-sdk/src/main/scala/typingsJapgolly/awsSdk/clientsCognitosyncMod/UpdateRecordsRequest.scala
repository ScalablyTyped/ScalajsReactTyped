...
trait UpdateRecordsRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientContext: js.UndefOr[typingsJapgolly.awsSdk.clientsCognitosyncMod.ClientContext] = js.undefined
  ...
  /**
    ...
    */
  var DeviceId: js.UndefOr[typingsJapgolly.awsSdk.clientsCognitosyncMod.DeviceId] = js.undefined
  ...
  /**
    ...
    */
  var SyncSessionToken: typingsJapgolly.awsSdk.clientsCognitosyncMod.SyncSessionToken
}
