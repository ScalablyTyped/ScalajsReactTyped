...
trait Connection extends StObject {
  ...
  /**
    ...
    */
  var ConnectionArn: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.ConnectionArn] = js.undefined
  
  /**
    * The ID of the connection.
    */
  var ConnectionId: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.ConnectionId] = js.undefined
