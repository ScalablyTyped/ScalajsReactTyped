...
trait OrganizationStatus extends StObject {
  ...
  /**
    ...
    */
  var AccountStatusList: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.AccountStatusList] = js.undefined
  
  /**
    * The status of the organization's AWS service access. This will be ENABLED or DISABLED.
    */
  var OrganizationAwsServiceAccessStatus: js.UndefOr[
    typingsJapgolly.awsSdk.clientsNetworkmanagerMod.OrganizationAwsServiceAccessStatus
  ] = js.undefined
  
  /**
    * The ID of an Amazon Web Services Organization.
    */
  var OrganizationId: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.OrganizationId] = js.undefined
  
  /**
    * The status of the SLR deployment for the account. This will be either SUCCEEDED or IN_PROGRESS.
    */
  var SLRDeploymentStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.SLRDeploymentStatus] = js.undefined
}
