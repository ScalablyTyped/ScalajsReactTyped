...
trait CreateTransitGatewayPeeringRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.ClientToken] = js.undefined
  ...
  /**
    ...
    */
  var TransitGatewayArn: typingsJapgolly.awsSdk.clientsNetworkmanagerMod.TransitGatewayArn
}
object CreateTransitGatewayPeeringRequest {
  ...
  extension [Self <: CreateTransitGatewayPeeringRequest](x: Self) {
