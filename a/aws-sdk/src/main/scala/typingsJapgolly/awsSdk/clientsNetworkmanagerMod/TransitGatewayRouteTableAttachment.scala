...
trait TransitGatewayRouteTableAttachment extends StObject {
  ...
  /**
    ...
    */
  var PeeringId: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.PeeringId] = js.undefined
  
  /**
    * The ARN of the transit gateway attachment route table.
    */
  var TransitGatewayRouteTableArn: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.TransitGatewayRouteTableArn] = js.undefined
}
