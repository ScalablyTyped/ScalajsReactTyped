...
trait TransitGatewayPeering extends StObject {
  ...
  /**
    ...
    */
  var Peering: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.Peering] = js.undefined
  
  /**
    * The ARN of the transit gateway.
    */
  var TransitGatewayArn: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.TransitGatewayArn] = js.undefined
  
  /**
    * The ID of the transit gateway peering attachment.
    */
  var TransitGatewayPeeringAttachmentId: js.UndefOr[
    typingsJapgolly.awsSdk.clientsNetworkmanagerMod.TransitGatewayPeeringAttachmentId
  ] = js.undefined
}
object TransitGatewayPeering {
  ...
  extension [Self <: TransitGatewayPeering](x: Self) {
