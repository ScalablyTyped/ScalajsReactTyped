...
trait GetCoreNetworkChangeSetRequest extends StObject {
...
object GetCoreNetworkChangeSetRequest {
  ...
  inline def apply(CoreNetworkId: CoreNetworkId, PolicyVersionId: Integer): GetCoreNetworkChangeSetRequest = {
  ...
  extension [Self <: GetCoreNetworkChangeSetRequest](x: Self) {
