...
trait ConnectPeerSummary extends StObject {
  ...
  /**
    ...
    */
  var ConnectPeerId: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.ConnectPeerId] = js.undefined
  
  /**
    * The state of a Connect peer.
    */
  var ConnectPeerState: js.UndefOr[typingsJapgolly.awsSdk.clientsNetworkmanagerMod.ConnectPeerState] = js.undefined
