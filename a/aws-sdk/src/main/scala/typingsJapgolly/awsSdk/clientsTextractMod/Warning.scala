...
trait Warning extends StObject {
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.ErrorCode] = js.undefined
  
  /**
    * A list of the pages that the warning applies to.
    */
  var Pages: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.Pages] = js.undefined
}
object Warning {
