...
trait HumanLoopConfig extends StObject {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsJapgolly.awsSdk.clientsTextractMod.FlowDefinitionArn
  
  /**
    * The name of the human workflow used for this image. This should be kept unique within a region.
    */
  var HumanLoopName: typingsJapgolly.awsSdk.clientsTextractMod.HumanLoopName
}
