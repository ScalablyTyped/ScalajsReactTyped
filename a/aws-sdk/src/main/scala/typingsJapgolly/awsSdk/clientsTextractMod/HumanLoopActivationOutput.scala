...
trait HumanLoopActivationOutput extends StObject {
  ...
  var HumanLoopActivationConditionsEvaluationResults: js.UndefOr[
    typingsJapgolly.awsSdk.clientsTextractMod.HumanLoopActivationConditionsEvaluationResults
  ] = js.undefined
  
  /**
    * Shows if and why human review was needed.
    */
  var HumanLoopActivationReasons: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.HumanLoopActivationReasons] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the HumanLoop created.
    */
  var HumanLoopArn: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.HumanLoopArn] = js.undefined
}
