...
trait Geometry extends StObject {
  ...
  /**
    ...
    */
  var BoundingBox: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.BoundingBox] = js.undefined
  
  /**
    * Within the bounding box, a fine-grained polygon around the recognized item.
    */
  var Polygon: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.Polygon] = js.undefined
}
object Geometry {
