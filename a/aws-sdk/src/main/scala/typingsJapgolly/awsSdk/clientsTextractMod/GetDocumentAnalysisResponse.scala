...
trait GetDocumentAnalysisResponse extends StObject {
  ...
  /**
    ...
    */
  var DocumentMetadata: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.DocumentMetadata] = js.undefined
  
  /**
    * The current status of the text detection job.
    */
  var JobStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.JobStatus] = js.undefined
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.StatusMessage] = js.undefined
  
  /**
    * A list of warnings that occurred during the document-analysis operation.
    */
  var Warnings: js.UndefOr[typingsJapgolly.awsSdk.clientsTextractMod.Warnings] = js.undefined
}
