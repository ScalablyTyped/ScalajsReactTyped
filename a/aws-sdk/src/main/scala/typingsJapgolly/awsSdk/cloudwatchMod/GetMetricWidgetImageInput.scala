...
trait GetMetricWidgetImageInput extends js.Object {
  /**
    ...
    */
  var MetricWidget: typingsJapgolly.awsSdk.cloudwatchMod.MetricWidget = js.native
  /**
    ...
    */
  var OutputFormat: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.OutputFormat] = js.native
}
