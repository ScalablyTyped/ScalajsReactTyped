...
trait AlarmHistoryItem extends js.Object {
  ...
  /**
    ...
    */
  var HistoryData: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.HistoryData] = js.native
  /**
  ...
  /**
    ...
    */
  var HistorySummary: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.HistorySummary] = js.native
  /**
