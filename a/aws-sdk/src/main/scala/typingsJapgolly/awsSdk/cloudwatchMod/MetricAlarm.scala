...
trait MetricAlarm extends js.Object {
  ...
  /**
    ...
    */
  var AlarmArn: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.AlarmArn] = js.native
  /**
  ...
  /**
    ...
    */
  var ComparisonOperator: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.ComparisonOperator] = js.native
  /**
  ...
  /**
    ...
    */
  var EvaluationPeriods: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.EvaluationPeriods] = js.native
  /**
  ...
  /**
    ...
    */
  var StateReason: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.StateReason] = js.native
  /**
    * An explanation for the alarm state, in JSON format.
    */
  var StateReasonData: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.StateReasonData] = js.native
  /**
  ...
  /**
    ...
    */
  var StateValue: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.StateValue] = js.native
  /**
