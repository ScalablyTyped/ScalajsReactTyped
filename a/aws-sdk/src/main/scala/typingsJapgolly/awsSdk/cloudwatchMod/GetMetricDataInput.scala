...
trait GetMetricDataInput extends js.Object {
  ...
  /**
    ...
    */
  var MetricDataQueries: typingsJapgolly.awsSdk.cloudwatchMod.MetricDataQueries = js.native
  /**
  ...
  /**
    ...
    */
  var ScanBy: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.ScanBy] = js.native
  /**
