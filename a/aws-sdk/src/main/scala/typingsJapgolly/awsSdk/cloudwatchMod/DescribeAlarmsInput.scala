...
trait DescribeAlarmsInput extends js.Object {
  /**
    ...
    */
  var ActionPrefix: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.ActionPrefix] = js.native
  /**
    * The alarm name prefix. If this parameter is specified, you cannot specify AlarmNames.
    */
  var AlarmNamePrefix: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.AlarmNamePrefix] = js.native
  /**
    * The names of the alarms.
    */
  var AlarmNames: js.UndefOr[typingsJapgolly.awsSdk.cloudwatchMod.AlarmNames] = js.native
  /**
