...
trait SidewalkListDevice extends StObject {
  ...
  /**
    ...
    */
  var SidewalkId: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.SidewalkId] = js.undefined
  
  /**
    * The Sidewalk manufacturing series number.
    */
  var SidewalkManufacturingSn: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.SidewalkManufacturingSn] = js.undefined
}
