...
trait UpdateLogLevelsByResourceTypesRequest extends StObject {
...
object UpdateLogLevelsByResourceTypesRequest {
  ...
  inline def apply(): UpdateLogLevelsByResourceTypesRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateLogLevelsByResourceTypesRequest]
  }
  
  extension [Self <: UpdateLogLevelsByResourceTypesRequest](x: Self) {
