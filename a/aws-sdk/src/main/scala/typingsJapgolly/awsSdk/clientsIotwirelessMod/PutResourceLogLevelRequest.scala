...
trait PutResourceLogLevelRequest extends StObject {
  ...
  var ResourceIdentifier: typingsJapgolly.awsSdk.clientsIotwirelessMod.ResourceIdentifier
  
  /**
    * The type of the resource, which can be WirelessDevice or WirelessGateway.
    */
  var ResourceType: typingsJapgolly.awsSdk.clientsIotwirelessMod.ResourceType
}
