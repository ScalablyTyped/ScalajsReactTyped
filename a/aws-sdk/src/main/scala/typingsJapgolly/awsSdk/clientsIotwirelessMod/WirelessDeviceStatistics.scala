...
trait WirelessDeviceStatistics extends StObject {
  ...
  /**
    ...
    */
  var DestinationName: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DestinationName] = js.undefined
  
  var FuotaDeviceStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.FuotaDeviceStatus] = js.undefined
  ...
  var McGroupId: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.McGroupId] = js.undefined
  
  /**
    * The status of the wireless device in the multicast group.
    */
  var MulticastDeviceStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.MulticastDeviceStatus] = js.undefined
