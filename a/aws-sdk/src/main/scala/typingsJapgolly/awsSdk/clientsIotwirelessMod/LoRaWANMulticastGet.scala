...
trait LoRaWANMulticastGet extends StObject {
  ...
  var DlClass: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DlClass] = js.undefined
  
  var NumberOfDevicesInGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.NumberOfDevicesInGroup] = js.undefined
  
  var NumberOfDevicesRequested: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.NumberOfDevicesRequested] = js.undefined
