...
trait LoRaWANGetServiceProfileInfo extends StObject {
  ...
  /**
    ...
    */
  var ChannelMask: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.ChannelMask] = js.undefined
  
  /**
    * The DevStatusReqFreq value.
    */
  var DevStatusReqFreq: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DevStatusReqFreq] = js.undefined
  
  /**
    * The DLBucketSize value.
    */
  var DlBucketSize: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DlBucketSize] = js.undefined
  
  /**
    * The DLRate value.
    */
  var DlRate: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DlRate] = js.undefined
  
  /**
    * The DLRatePolicy value.
    */
  var DlRatePolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DlRatePolicy] = js.undefined
  
  /**
    * The DRMax value.
    */
  var DrMax: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DrMax] = js.undefined
  
  /**
    * The DRMin value.
    */
  var DrMin: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DrMin] = js.undefined
  
  /**
    * The HRAllowed value that describes whether handover roaming is allowed.
    */
  var HrAllowed: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.HrAllowed] = js.undefined
  
  /**
    * The MinGwDiversity value.
    */
  var MinGwDiversity: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.MinGwDiversity] = js.undefined
  
  /**
    * The NwkGeoLoc value.
    */
  var NwkGeoLoc: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.NwkGeoLoc] = js.undefined
  
  /**
    * The PRAllowed value that describes whether passive roaming is allowed.
    */
  var PrAllowed: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.PrAllowed] = js.undefined
  
  /**
    * The RAAllowed value that describes whether roaming activation is allowed.
    */
  var RaAllowed: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.RaAllowed] = js.undefined
  
  /**
    * The ReportDevStatusBattery value.
    */
  var ReportDevStatusBattery: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.ReportDevStatusBattery] = js.undefined
  
  /**
    * The ReportDevStatusMargin value.
    */
  var ReportDevStatusMargin: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.ReportDevStatusMargin] = js.undefined
  
  /**
    * The TargetPER value.
    */
  var TargetPer: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.TargetPer] = js.undefined
  
  /**
    * The ULBucketSize value.
    */
  var UlBucketSize: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.UlBucketSize] = js.undefined
  
  /**
    * The ULRate value.
    */
  var UlRate: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.UlRate] = js.undefined
  
  /**
    * The ULRatePolicy value.
    */
  var UlRatePolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.UlRatePolicy] = js.undefined
}
