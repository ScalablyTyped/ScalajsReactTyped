...
trait Accuracy extends StObject {
  ...
  /**
    ...
    */
  var HorizontalAccuracy: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.HorizontalAccuracy] = js.undefined
  
  /**
    * The vertical accuracy of the estimated position in meters.
    */
  var VerticalAccuracy: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.VerticalAccuracy] = js.undefined
}
object Accuracy {
