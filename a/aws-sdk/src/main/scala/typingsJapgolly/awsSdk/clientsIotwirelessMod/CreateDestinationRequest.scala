...
trait CreateDestinationRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.ClientRequestToken] = js.undefined
  
  /**
    * The description of the new resource.
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.Description] = js.undefined
  
  /**
    * The rule name or topic rule to send messages to.
    */
  var Expression: typingsJapgolly.awsSdk.clientsIotwirelessMod.Expression
  
  /**
    * The type of value in Expression.
    */
  var ExpressionType: typingsJapgolly.awsSdk.clientsIotwirelessMod.ExpressionType
  ...
  /**
    ...
    */
  var RoleArn: typingsJapgolly.awsSdk.clientsIotwirelessMod.RoleArn
