...
trait ListNetworkAnalyzerConfigurationsRequest extends StObject {
...
object ListNetworkAnalyzerConfigurationsRequest {
  ...
  inline def apply(): ListNetworkAnalyzerConfigurationsRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[ListNetworkAnalyzerConfigurationsRequest]
  }
  
  extension [Self <: ListNetworkAnalyzerConfigurationsRequest](x: Self) {
