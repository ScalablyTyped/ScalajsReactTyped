...
trait OtaaV11 extends StObject {
  ...
  /**
    * The JoinEUI value.
    */
  var JoinEui: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.JoinEui] = js.undefined
  
  /**
    * The NwkKey value.
    */
  var NwkKey: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.NwkKey] = js.undefined
}
object OtaaV11 {
