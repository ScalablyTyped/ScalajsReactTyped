...
trait UpdateFuotaTaskRequest extends StObject {
  ...
  var FirmwareUpdateImage: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.FirmwareUpdateImage] = js.undefined
  
  var FirmwareUpdateRole: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.FirmwareUpdateRole] = js.undefined
...
object UpdateFuotaTaskRequest {
  ...
  extension [Self <: UpdateFuotaTaskRequest](x: Self) {
