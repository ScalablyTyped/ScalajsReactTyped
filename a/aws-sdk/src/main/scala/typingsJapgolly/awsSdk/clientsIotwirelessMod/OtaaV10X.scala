...
trait OtaaV10X extends StObject {
  ...
  /**
    * The AppEUI value.
    */
  var AppEui: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.AppEui] = js.undefined
  
  /**
    * The AppKey value.
    */
  var AppKey: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.AppKey] = js.undefined
  
  /**
    * The GenAppKey value.
    */
  var GenAppKey: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.GenAppKey] = js.undefined
}
object OtaaV10X {
