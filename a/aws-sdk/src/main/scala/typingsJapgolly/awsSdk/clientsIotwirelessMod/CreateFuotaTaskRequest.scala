...
trait CreateFuotaTaskRequest extends StObject {
  ...
  var FirmwareUpdateImage: typingsJapgolly.awsSdk.clientsIotwirelessMod.FirmwareUpdateImage
  
  var FirmwareUpdateRole: typingsJapgolly.awsSdk.clientsIotwirelessMod.FirmwareUpdateRole
