...
trait ParticipatingGateways extends StObject {
  ...
  /**
    ...
    */
  var DownlinkMode: typingsJapgolly.awsSdk.clientsIotwirelessMod.DownlinkMode
  
  /**
    * The list of gateways that you want to use for sending the downlink data traffic.
    */
  var GatewayList: typingsJapgolly.awsSdk.clientsIotwirelessMod.GatewayList
  
  /**
    * The duration of time for which AWS IoT Core for LoRaWAN will wait before transmitting the payload to the next gateway.
    */
  var TransmissionInterval: typingsJapgolly.awsSdk.clientsIotwirelessMod.TransmissionInterval
}
