...
trait LoRaWANUpdateDevice extends StObject {
  ...
  /**
    ...
    */
  var DeviceProfileId: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DeviceProfileId] = js.undefined
  ...
  /**
    ...
    */
  var ServiceProfileId: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.ServiceProfileId] = js.undefined
}
