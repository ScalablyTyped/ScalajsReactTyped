...
trait EventConfigurationItem extends StObject {
  ...
  /**
    ...
    */
  var Identifier: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.Identifier] = js.undefined
  
  /**
    * Identifier type of the particular resource identifier for event configuration.
    */
  var IdentifierType: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.IdentifierType] = js.undefined
