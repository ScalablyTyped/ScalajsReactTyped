...
trait SidewalkDeviceMetadata extends StObject {
  ...
  /**
    ...
    */
  var BatteryLevel: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.BatteryLevel] = js.undefined
  
  /**
    * Device state defines the device status of sidewalk device.
    */
  var DeviceState: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.DeviceState] = js.undefined
  
  /**
    * Sidewalk device status notification.
    */
  var Event: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.Event] = js.undefined
