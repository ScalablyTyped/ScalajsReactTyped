...
trait GetWirelessDeviceResponse extends StObject {
  ...
  /**
    ...
    */
  var ThingArn: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.ThingArn] = js.undefined
  
  /**
    * The name of the thing associated with the wireless device. The value is empty if a thing isn't associated with the device.
    */
  var ThingName: js.UndefOr[typingsJapgolly.awsSdk.clientsIotwirelessMod.ThingName] = js.undefined
