...
trait ChallengeResponseType extends js.Object {
  /**
    * The challenge name
    */
  var ChallengeName: js.UndefOr[typingsJapgolly.awsSdk.cognitoidentityserviceproviderMod.ChallengeName] = js.native
  /**
    * The challenge response.
    */
  var ChallengeResponse: js.UndefOr[typingsJapgolly.awsSdk.cognitoidentityserviceproviderMod.ChallengeResponse] = js.native
}
