...
import typingsJapgolly.awsSdk.anon.DescribeCacheClustersMess
import typingsJapgolly.awsSdk.anon.DescribeReplicationGroups
import typingsJapgolly.awsSdk.awsSdkStrings.cacheClusterAvailable
import typingsJapgolly.awsSdk.awsSdkStrings.cacheClusterDeleted
import typingsJapgolly.awsSdk.awsSdkStrings.replicationGroupAvailable
import typingsJapgolly.awsSdk.awsSdkStrings.replicationGroupDeleted
...
trait ElastiCache extends Service {
  ...
  @JSName("config")
  var config_ElastiCache: ConfigBase & ClientConfiguration = js.native
