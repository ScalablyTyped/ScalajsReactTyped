...
trait PendingLogDeliveryConfiguration extends StObject {
  ...
  /**
    ...
    */
  var DestinationDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticacheMod.DestinationDetails] = js.undefined
  
  /**
    * Returns the destination type, either CloudWatch Logs or Kinesis Data Firehose.
    */
  var DestinationType: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticacheMod.DestinationType] = js.undefined
  
  /**
    * Returns the log format, either JSON or TEXT
    */
  var LogFormat: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticacheMod.LogFormat] = js.undefined
  
  /**
    * Refers to slow-log or engine-log..
    */
  var LogType: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticacheMod.LogType] = js.undefined
}
