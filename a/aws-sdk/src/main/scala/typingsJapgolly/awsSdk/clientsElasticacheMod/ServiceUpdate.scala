...
trait ServiceUpdate extends StObject {
  ...
  /**
    ...
    */
  var ServiceUpdateSeverity: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticacheMod.ServiceUpdateSeverity] = js.undefined
  
  /**
    * The status of the service update
    */
  var ServiceUpdateStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticacheMod.ServiceUpdateStatus] = js.undefined
  
  /**
    * Reflects the nature of the service update
    */
  var ServiceUpdateType: js.UndefOr[typingsJapgolly.awsSdk.clientsElasticacheMod.ServiceUpdateType] = js.undefined
}
