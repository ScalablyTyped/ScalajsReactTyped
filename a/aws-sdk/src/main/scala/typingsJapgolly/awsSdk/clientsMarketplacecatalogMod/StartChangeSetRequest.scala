...
trait StartChangeSetRequest extends StObject {
  ...
  /**
    ...
    */
  var ChangeSetName: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacecatalogMod.ChangeSetName] = js.undefined
  
  /**
    * A unique token to identify the request to ensure idempotency.
    */
  var ClientRequestToken: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacecatalogMod.ClientRequestToken] = js.undefined
}
