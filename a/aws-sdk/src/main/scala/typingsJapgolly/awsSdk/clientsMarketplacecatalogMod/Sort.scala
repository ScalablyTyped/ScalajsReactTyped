...
trait Sort extends StObject {
  ...
  /**
    ...
    */
  var SortBy: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacecatalogMod.SortBy] = js.undefined
  
  /**
    * The sorting order. Can be ASCENDING or DESCENDING. The default value is DESCENDING.
    */
  var SortOrder: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacecatalogMod.SortOrder] = js.undefined
}
object Sort {
