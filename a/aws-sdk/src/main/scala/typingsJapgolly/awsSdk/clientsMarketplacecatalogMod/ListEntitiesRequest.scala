...
trait ListEntitiesRequest extends StObject {
  ...
  /**
    ...
    */
  var EntityType: typingsJapgolly.awsSdk.clientsMarketplacecatalogMod.EntityType
  
  /**
    * An array of filter objects. Each filter object contains two attributes, filterName and filterValues.
    */
  var FilterList: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacecatalogMod.FilterList] = js.undefined
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacecatalogMod.NextToken] = js.undefined
  
  /**
    * An object that contains two attributes, SortBy and SortOrder.
    */
  var Sort: js.UndefOr[typingsJapgolly.awsSdk.clientsMarketplacecatalogMod.Sort] = js.undefined
}
