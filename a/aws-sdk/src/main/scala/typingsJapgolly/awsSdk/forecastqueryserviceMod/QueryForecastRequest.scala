...
trait QueryForecastRequest extends js.Object {
  ...
  /**
    ...
    */
  var Filters: typingsJapgolly.awsSdk.forecastqueryserviceMod.Filters = js.native
  /**
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.forecastqueryserviceMod.NextToken] = js.native
  /**
