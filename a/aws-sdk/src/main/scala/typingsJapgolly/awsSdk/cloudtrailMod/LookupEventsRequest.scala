...
trait LookupEventsRequest extends js.Object {
  ...
  /**
    ...
    */
  var EventCategory: js.UndefOr[typingsJapgolly.awsSdk.cloudtrailMod.EventCategory] = js.native
  /**
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.cloudtrailMod.MaxResults] = js.native
  /**
