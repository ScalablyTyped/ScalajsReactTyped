...
trait ProtocolsListData extends StObject {
  ...
  /**
    ...
    */
  var PreviousProtocolsList: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.PreviousProtocolsList] = js.undefined
  
  /**
    * An array of protocols in the Firewall Manager protocols list.
    */
  var ProtocolsList: typingsJapgolly.awsSdk.clientsFmsMod.ProtocolsList
}
