...
trait ViolationDetail extends StObject {
  ...
  /**
    ...
    */
  var ResourceId: typingsJapgolly.awsSdk.clientsFmsMod.ResourceId
  ...
  /**
    ...
    */
  var ResourceType: typingsJapgolly.awsSdk.clientsFmsMod.ResourceType
  
  /**
    * List of violations for the requested resource.
    */
  var ResourceViolations: typingsJapgolly.awsSdk.clientsFmsMod.ResourceViolations
}
