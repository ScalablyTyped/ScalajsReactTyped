...
trait RemediationAction extends StObject {
  ...
  /**
    ...
    */
  var EC2AssociateRouteTableAction: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.EC2AssociateRouteTableAction] = js.undefined
  
  /**
    * Information about the CopyRouteTable action in the Amazon EC2 API.
    */
  var EC2CopyRouteTableAction: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.EC2CopyRouteTableAction] = js.undefined
  
  /**
    * Information about the CreateRoute action in the Amazon EC2 API.
    */
  var EC2CreateRouteAction: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.EC2CreateRouteAction] = js.undefined
  
  /**
    * Information about the CreateRouteTable action in the Amazon EC2 API.
    */
  var EC2CreateRouteTableAction: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.EC2CreateRouteTableAction] = js.undefined
  
  /**
    * Information about the DeleteRoute action in the Amazon EC2 API.
    */
  var EC2DeleteRouteAction: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.EC2DeleteRouteAction] = js.undefined
  
  /**
    * Information about the ReplaceRoute action in the Amazon EC2 API.
    */
  var EC2ReplaceRouteAction: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.EC2ReplaceRouteAction] = js.undefined
  
  /**
    * Information about the ReplaceRouteTableAssociation action in the Amazon EC2 API.
    */
  var EC2ReplaceRouteTableAssociationAction: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.EC2ReplaceRouteTableAssociationAction] = js.undefined
  
  /**
    * The remedial action to take when updating a firewall configuration.
    */
  var FMSPolicyUpdateFirewallCreationConfigAction: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.FMSPolicyUpdateFirewallCreationConfigAction] = js.undefined
}
