...
trait ThirdPartyFirewallFirewallPolicy extends StObject {
  ...
  /**
    ...
    */
  var FirewallPolicyId: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.FirewallPolicyId] = js.undefined
  
  /**
    * The name of the specified firewall policy.
    */
  var FirewallPolicyName: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.FirewallPolicyName] = js.undefined
}
