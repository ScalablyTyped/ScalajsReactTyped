...
trait ComplianceViolator extends StObject {
  ...
  /**
    ...
    */
  var ResourceType: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.ResourceType] = js.undefined
  
  /**
    * The reason that the resource is not protected by the policy.
    */
  var ViolationReason: js.UndefOr[typingsJapgolly.awsSdk.clientsFmsMod.ViolationReason] = js.undefined
}
