...
trait FilterCondition extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: js.UndefOr[typingsJapgolly.awsSdk.lakeformationMod.ComparisonOperator] = js.native
  /**
  ...
  /**
    ...
    */
  var StringValueList: js.UndefOr[typingsJapgolly.awsSdk.lakeformationMod.StringValueList] = js.native
}
