...
trait ListTrafficPolicyVersionsResponse extends js.Object {
  ...
  /**
    ...
    */
  var TrafficPolicies: typingsJapgolly.awsSdk.route53Mod.TrafficPolicies = js.native
  /**
    ...
    */
  var TrafficPolicyVersionMarker: typingsJapgolly.awsSdk.route53Mod.TrafficPolicyVersionMarker = js.native
}
