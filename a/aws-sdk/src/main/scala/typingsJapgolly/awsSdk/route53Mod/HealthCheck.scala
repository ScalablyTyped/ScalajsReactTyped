...
trait HealthCheck extends js.Object {
  ...
  /**
    ...
    */
  var CloudWatchAlarmConfiguration: js.UndefOr[typingsJapgolly.awsSdk.route53Mod.CloudWatchAlarmConfiguration] = js.native
  /**
    * A complex type that contains detailed information about one health check.
    */
  var HealthCheckConfig: typingsJapgolly.awsSdk.route53Mod.HealthCheckConfig = js.native
  /**
    * The version of the health check. You can optionally pass this value in a call to UpdateHealthCheck to prevent overwriting another change to the health check.
    */
  var HealthCheckVersion: typingsJapgolly.awsSdk.route53Mod.HealthCheckVersion = js.native
  /**
