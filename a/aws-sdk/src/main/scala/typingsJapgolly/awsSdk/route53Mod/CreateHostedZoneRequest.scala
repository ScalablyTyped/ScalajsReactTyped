...
trait CreateHostedZoneRequest extends js.Object {
  ...
  /**
    ...
    */
  var HostedZoneConfig: js.UndefOr[typingsJapgolly.awsSdk.route53Mod.HostedZoneConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var VPC: js.UndefOr[typingsJapgolly.awsSdk.route53Mod.VPC] = js.native
}
