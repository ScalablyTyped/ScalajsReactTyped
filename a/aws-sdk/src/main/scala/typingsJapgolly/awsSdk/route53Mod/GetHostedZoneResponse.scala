...
trait GetHostedZoneResponse extends js.Object {
  /**
    ...
    */
  var DelegationSet: js.UndefOr[typingsJapgolly.awsSdk.route53Mod.DelegationSet] = js.native
  /**
  ...
  /**
    ...
    */
  var VPCs: js.UndefOr[typingsJapgolly.awsSdk.route53Mod.VPCs] = js.native
}
