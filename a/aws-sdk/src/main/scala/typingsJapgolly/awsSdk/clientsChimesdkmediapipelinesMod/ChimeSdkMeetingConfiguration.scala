...
trait ChimeSdkMeetingConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ArtifactsConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmediapipelinesMod.ArtifactsConfiguration] = js.undefined
  
  /**
    * The source configuration for a specified media pipline.
    */
  var SourceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmediapipelinesMod.SourceConfiguration] = js.undefined
}
