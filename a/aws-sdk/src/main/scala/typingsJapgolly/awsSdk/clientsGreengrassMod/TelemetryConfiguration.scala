...
trait TelemetryConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ConfigurationSyncStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsGreengrassMod.ConfigurationSyncStatus] = js.undefined
  
  /**
    * Configure telemetry to be on or off.
    */
  var Telemetry: typingsJapgolly.awsSdk.clientsGreengrassMod.Telemetry
}
