...
trait GetBulkDeploymentStatusResponse extends StObject {
  ...
  /**
    ...
    */
  var BulkDeploymentMetrics: js.UndefOr[typingsJapgolly.awsSdk.clientsGreengrassMod.BulkDeploymentMetrics] = js.undefined
  
  /**
    * The status of the bulk deployment.
    */
  var BulkDeploymentStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsGreengrassMod.BulkDeploymentStatus] = js.undefined
