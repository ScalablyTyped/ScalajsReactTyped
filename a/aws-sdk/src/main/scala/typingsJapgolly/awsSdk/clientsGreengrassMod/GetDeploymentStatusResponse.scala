...
trait GetDeploymentStatusResponse extends StObject {
  ...
  /**
    ...
    */
  var DeploymentType: js.UndefOr[typingsJapgolly.awsSdk.clientsGreengrassMod.DeploymentType] = js.undefined
  
  /**
    * Error details
    */
  var ErrorDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsGreengrassMod.ErrorDetails] = js.undefined
