...
trait HttpInstanceSummary extends js.Object {
  /**
    ...
    */
  var Attributes: js.UndefOr[typingsJapgolly.awsSdk.servicediscoveryMod.Attributes] = js.native
  /**
    * If you configured health checking in the service, the current health status of the service instance.
    */
  var HealthStatus: js.UndefOr[typingsJapgolly.awsSdk.servicediscoveryMod.HealthStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var NamespaceName: js.UndefOr[typingsJapgolly.awsSdk.servicediscoveryMod.NamespaceName] = js.native
  /**
    * The name of the service that you specified when you registered the instance.
    */
  var ServiceName: js.UndefOr[typingsJapgolly.awsSdk.servicediscoveryMod.ServiceName] = js.native
}
