...
trait CodeConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CodeConfigurationValues: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.CodeConfigurationValues] = js.undefined
  ...
  /**
    ...
    */
  var ConfigurationSource: typingsJapgolly.awsSdk.clientsApprunnerMod.ConfigurationSource
}
