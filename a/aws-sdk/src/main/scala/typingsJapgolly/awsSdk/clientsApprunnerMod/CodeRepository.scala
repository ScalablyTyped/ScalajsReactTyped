...
trait CodeRepository extends StObject {
  ...
  /**
    ...
    */
  var CodeConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.CodeConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var SourceCodeVersion: typingsJapgolly.awsSdk.clientsApprunnerMod.SourceCodeVersion
}
