...
open class ^ ()
  ...
  /**
    ...
    */
  /* CompleteClass */
  var AutoScalingConfigurationSummary: typingsJapgolly.awsSdk.clientsApprunnerMod.AutoScalingConfigurationSummary = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var InstanceConfiguration: typingsJapgolly.awsSdk.clientsApprunnerMod.InstanceConfiguration = js.native
  
  /**
    * Configuration settings related to network traffic of the web application that this service runs.
    */
  /* CompleteClass */
  var NetworkConfiguration: typingsJapgolly.awsSdk.clientsApprunnerMod.NetworkConfiguration = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var ServiceId: typingsJapgolly.awsSdk.clientsApprunnerMod.ServiceId = js.native
  
  /**
    * The customer-provided service name.
    */
  /* CompleteClass */
  var ServiceName: typingsJapgolly.awsSdk.clientsApprunnerMod.ServiceName = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var SourceConfiguration: typingsJapgolly.awsSdk.clientsApprunnerMod.SourceConfiguration = js.native
