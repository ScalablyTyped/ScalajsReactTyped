...
trait Service extends StObject {
  ...
  /**
    ...
    */
  var AutoScalingConfigurationSummary: typingsJapgolly.awsSdk.clientsApprunnerMod.AutoScalingConfigurationSummary
  ...
  /**
    ...
    */
  var EncryptionConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.EncryptionConfiguration] = js.undefined
  
  /**
    * The settings for the health check that App Runner performs to monitor the health of this service.
    */
  var HealthCheckConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.HealthCheckConfiguration] = js.undefined
  
  /**
    * The runtime configuration of instances (scaling units) of this service.
    */
  var InstanceConfiguration: typingsJapgolly.awsSdk.clientsApprunnerMod.InstanceConfiguration
  
  /**
    * Configuration settings related to network traffic of the web application that this service runs.
    */
  var NetworkConfiguration: typingsJapgolly.awsSdk.clientsApprunnerMod.NetworkConfiguration
  ...
  /**
    ...
    */
  var ServiceId: typingsJapgolly.awsSdk.clientsApprunnerMod.ServiceId
  
  /**
    * The customer-provided service name.
    */
  var ServiceName: typingsJapgolly.awsSdk.clientsApprunnerMod.ServiceName
  ...
  /**
    ...
    */
  var SourceConfiguration: typingsJapgolly.awsSdk.clientsApprunnerMod.SourceConfiguration
