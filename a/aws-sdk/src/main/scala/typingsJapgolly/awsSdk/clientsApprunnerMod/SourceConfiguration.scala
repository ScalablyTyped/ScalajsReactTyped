...
trait SourceConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AuthenticationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.AuthenticationConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var CodeRepository: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.CodeRepository] = js.undefined
  
  /**
    * The description of a source image repository. You must provide either this member or CodeRepository (but not both).
    */
  var ImageRepository: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.ImageRepository] = js.undefined
}
