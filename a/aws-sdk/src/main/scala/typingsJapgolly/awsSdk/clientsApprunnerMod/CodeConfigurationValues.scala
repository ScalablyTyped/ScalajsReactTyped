...
trait CodeConfigurationValues extends StObject {
  ...
  /**
    ...
    */
  var BuildCommand: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.BuildCommand] = js.undefined
  ...
  /**
    ...
    */
  var Runtime: typingsJapgolly.awsSdk.clientsApprunnerMod.Runtime
  ...
  /**
    ...
    */
  var RuntimeEnvironmentVariables: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.RuntimeEnvironmentVariables] = js.undefined
  
  /**
    * The command App Runner runs to start your application.
    */
  var StartCommand: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.StartCommand] = js.undefined
}
