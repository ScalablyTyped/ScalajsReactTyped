...
trait UpdateServiceRequest extends StObject {
  ...
  /**
    ...
    */
  var InstanceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.InstanceConfiguration] = js.undefined
  
  /**
    * Configuration settings related to network traffic of the web application that the App Runner service runs.
    */
  var NetworkConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.NetworkConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var SourceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.SourceConfiguration] = js.undefined
}
