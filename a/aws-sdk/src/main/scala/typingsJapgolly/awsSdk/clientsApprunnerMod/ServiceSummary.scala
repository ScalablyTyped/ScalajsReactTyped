...
trait ServiceSummary extends StObject {
  ...
  /**
    ...
    */
  var ServiceId: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.ServiceId] = js.undefined
  
  /**
    * The customer-provided service name.
    */
  var ServiceName: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.ServiceName] = js.undefined
