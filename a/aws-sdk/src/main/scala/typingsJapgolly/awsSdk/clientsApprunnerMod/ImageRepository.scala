...
trait ImageRepository extends StObject {
  ...
  /**
    ...
    */
  var ImageConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.ImageConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var ImageIdentifier: typingsJapgolly.awsSdk.clientsApprunnerMod.ImageIdentifier
  
  /**
    * The type of the image repository. This reflects the repository provider and whether the repository is private or public.
    */
  var ImageRepositoryType: typingsJapgolly.awsSdk.clientsApprunnerMod.ImageRepositoryType
}
