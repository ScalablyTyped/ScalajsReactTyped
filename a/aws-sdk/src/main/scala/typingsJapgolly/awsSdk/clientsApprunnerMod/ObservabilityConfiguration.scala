...
trait ObservabilityConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ObservabilityConfigurationName: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.ObservabilityConfigurationName] = js.undefined
  ...
  /**
    ...
    */
  var TraceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.TraceConfiguration] = js.undefined
}
