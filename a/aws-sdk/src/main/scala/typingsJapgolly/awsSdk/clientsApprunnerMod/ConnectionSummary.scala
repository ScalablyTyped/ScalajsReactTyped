...
trait ConnectionSummary extends StObject {
  ...
  /**
    ...
    */
  var ConnectionName: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.ConnectionName] = js.undefined
  ...
  /**
    ...
    */
  var ProviderType: js.UndefOr[typingsJapgolly.awsSdk.clientsApprunnerMod.ProviderType] = js.undefined
...
object ConnectionSummary {
  ...
  inline def apply(): ConnectionSummary = {
