...
trait RemoteIpDetails extends StObject {
  ...
  /**
    ...
    */
  var City: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.City] = js.undefined
  
  /**
    * The country code of the remote IP address.
    */
  var Country: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.Country] = js.undefined
  
  /**
    * The location information of the remote IP address.
    */
  var GeoLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.GeoLocation] = js.undefined
  ...
  /**
    ...
    */
  var Organization: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.Organization] = js.undefined
}
