...
trait GetFindingsStatisticsRequest extends StObject {
  ...
  /**
    ...
    */
  var FindingCriteria: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.FindingCriteria] = js.undefined
  
  /**
    * The types of finding statistics to retrieve.
    */
  var FindingStatisticTypes: typingsJapgolly.awsSdk.clientsGuarddutyMod.FindingStatisticTypes
}
