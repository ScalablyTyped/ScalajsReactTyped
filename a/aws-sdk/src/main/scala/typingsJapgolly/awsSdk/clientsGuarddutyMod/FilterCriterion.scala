...
trait FilterCriterion extends StObject {
  ...
  /**
    ...
    */
  var CriterionKey: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.CriterionKey] = js.undefined
  
  /**
    * Contains information about the condition.
    */
  var FilterCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.FilterCondition] = js.undefined
}
