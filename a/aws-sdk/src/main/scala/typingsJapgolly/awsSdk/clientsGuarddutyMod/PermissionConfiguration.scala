...
trait PermissionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AccountLevelPermissions: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.AccountLevelPermissions] = js.undefined
  
  /**
    * Contains information about the bucket level permissions for the S3 bucket.
    */
  var BucketLevelPermissions: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.BucketLevelPermissions] = js.undefined
}
