...
trait S3BucketDetail extends StObject {
  ...
  /**
    ...
    */
  var DefaultServerSideEncryption: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.DefaultServerSideEncryption] = js.undefined
  ...
  /**
    ...
    */
  var Owner: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.Owner] = js.undefined
  
  /**
    * Describes the public access policies that apply to the S3 bucket.
    */
  var PublicAccess: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.PublicAccess] = js.undefined
