...
trait BucketLevelPermissions extends StObject {
  ...
  /**
    ...
    */
  var AccessControlList: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.AccessControlList] = js.undefined
  
  /**
    * Contains information on which account level S3 Block Public Access settings are applied to the S3 bucket.
    */
  var BlockPublicAccess: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.BlockPublicAccess] = js.undefined
  
  /**
    * Contains information on the bucket policies for the S3 bucket.
    */
  var BucketPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.BucketPolicy] = js.undefined
}
