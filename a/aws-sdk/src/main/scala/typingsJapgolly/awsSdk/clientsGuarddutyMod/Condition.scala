...
trait Condition extends StObject {
  ...
  /**
    ...
    */
  var Eq: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.Eq] = js.undefined
  
  /**
    * Represents an equal  condition to be applied to a single field when querying for findings.
    */
  var Equals: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.Equals] = js.undefined
  ...
  /**
    ...
    */
  var Neq: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.Neq] = js.undefined
  
  /**
    * Represents a not equal  condition to be applied to a single field when querying for findings.
    */
  var NotEquals: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.NotEquals] = js.undefined
}
object Condition {
