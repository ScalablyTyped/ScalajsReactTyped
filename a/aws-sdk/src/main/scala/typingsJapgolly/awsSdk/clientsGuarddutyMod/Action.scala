...
trait Action extends StObject {
  ...
  /**
    ...
    */
  var AwsApiCallAction: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.AwsApiCallAction] = js.undefined
  
  /**
    * Information about the DNS_REQUEST action described in this finding.
    */
  var DnsRequestAction: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.DnsRequestAction] = js.undefined
  
  /**
    * Information about the Kubernetes API call action described in this finding.
    */
  var KubernetesApiCallAction: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.KubernetesApiCallAction] = js.undefined
  
  /**
    * Information about the NETWORK_CONNECTION action described in this finding.
    */
  var NetworkConnectionAction: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.NetworkConnectionAction] = js.undefined
  
  /**
    * Information about the PORT_PROBE action described in this finding.
    */
  var PortProbeAction: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.PortProbeAction] = js.undefined
}
object Action {
