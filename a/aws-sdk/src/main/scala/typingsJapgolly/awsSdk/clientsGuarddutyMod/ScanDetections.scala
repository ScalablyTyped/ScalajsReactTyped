...
trait ScanDetections extends StObject {
  ...
  /**
    ...
    */
  var HighestSeverityThreatDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.HighestSeverityThreatDetails] = js.undefined
  
  /**
    * Total number of scanned files.
    */
  var ScannedItemCount: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.ScannedItemCount] = js.undefined
  
  /**
    * Contains details about identified threats organized by threat name.
    */
  var ThreatDetectedByName: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.ThreatDetectedByName] = js.undefined
  
  /**
    * Total number of infected files.
    */
  var ThreatsDetectedItemCount: js.UndefOr[typingsJapgolly.awsSdk.clientsGuarddutyMod.ThreatsDetectedItemCount] = js.undefined
}
