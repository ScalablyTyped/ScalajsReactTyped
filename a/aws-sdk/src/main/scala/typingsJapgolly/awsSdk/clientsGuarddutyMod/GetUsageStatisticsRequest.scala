...
trait GetUsageStatisticsRequest extends StObject {
  ...
  /**
    ...
    */
  var UsageCriteria: typingsJapgolly.awsSdk.clientsGuarddutyMod.UsageCriteria
  
  /**
    * The type of usage statistics to retrieve.
    */
  var UsageStatisticType: typingsJapgolly.awsSdk.clientsGuarddutyMod.UsageStatisticType
}
