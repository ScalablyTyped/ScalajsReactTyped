...
trait SetTaskStatusInput extends StObject {
  ...
  /**
    ...
    */
  var errorMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsDatapipelineMod.errorMessage] = js.undefined
  ...
  /**
    ...
    */
  var taskId: typingsJapgolly.awsSdk.clientsDatapipelineMod.taskId
