...
trait InstanceGroupModifyConfig extends StObject {
  ...
  /**
    ...
    */
  var ReconfigurationType: js.UndefOr[typingsJapgolly.awsSdk.clientsEmrMod.ReconfigurationType] = js.undefined
  
  /**
    * Policy for customizing shrink operations.
    */
  var ShrinkPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsEmrMod.ShrinkPolicy] = js.undefined
}
