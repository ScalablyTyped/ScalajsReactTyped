...
trait SessionMappingSummary extends StObject {
  ...
  /**
    ...
    */
  var IdentityType: js.UndefOr[typingsJapgolly.awsSdk.clientsEmrMod.IdentityType] = js.undefined
...
object SessionMappingSummary {
  ...
  inline def apply(): SessionMappingSummary = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SessionMappingSummary]
  }
  
  extension [Self <: SessionMappingSummary](x: Self) {
