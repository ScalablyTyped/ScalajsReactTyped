...
trait PutAutoScalingPolicyOutput extends StObject {
  ...
  /**
    ...
    */
  var ClusterId: js.UndefOr[typingsJapgolly.awsSdk.clientsEmrMod.ClusterId] = js.undefined
  
  /**
    * Specifies the ID of the instance group to which the scaling policy is applied.
    */
  var InstanceGroupId: js.UndefOr[typingsJapgolly.awsSdk.clientsEmrMod.InstanceGroupId] = js.undefined
}
