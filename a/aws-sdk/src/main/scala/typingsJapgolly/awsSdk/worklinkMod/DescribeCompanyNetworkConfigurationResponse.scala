...
trait DescribeCompanyNetworkConfigurationResponse extends js.Object {
  /**
    ...
    */
  var SecurityGroupIds: js.UndefOr[typingsJapgolly.awsSdk.worklinkMod.SecurityGroupIds] = js.native
  /**
    * The subnets used for X-ENI connections from Amazon WorkLink rendering containers.
    */
  var SubnetIds: js.UndefOr[typingsJapgolly.awsSdk.worklinkMod.SubnetIds] = js.native
  /**
    * The VPC with connectivity to associated websites.
    */
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.worklinkMod.VpcId] = js.native
}
