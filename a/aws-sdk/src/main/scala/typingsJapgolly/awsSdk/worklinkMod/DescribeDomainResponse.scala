...
trait DescribeDomainResponse extends js.Object {
  /**
    ...
    */
  var AcmCertificateArn: js.UndefOr[typingsJapgolly.awsSdk.worklinkMod.AcmCertificateArn] = js.native
  /**
  ...
  /**
    ...
    */
  var DomainStatus: js.UndefOr[typingsJapgolly.awsSdk.worklinkMod.DomainStatus] = js.native
}
