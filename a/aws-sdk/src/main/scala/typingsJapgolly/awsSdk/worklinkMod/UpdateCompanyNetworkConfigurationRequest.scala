...
trait UpdateCompanyNetworkConfigurationRequest extends js.Object {
  ...
  /**
    ...
    */
  var SecurityGroupIds: typingsJapgolly.awsSdk.worklinkMod.SecurityGroupIds = js.native
  /**
    * The subnets used for X-ENI connections from Amazon WorkLink rendering containers.
    */
  var SubnetIds: typingsJapgolly.awsSdk.worklinkMod.SubnetIds = js.native
  /**
    * The VPC with connectivity to associated websites.
    */
  var VpcId: typingsJapgolly.awsSdk.worklinkMod.VpcId = js.native
}
