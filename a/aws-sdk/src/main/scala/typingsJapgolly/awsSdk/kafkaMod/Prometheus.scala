...
trait Prometheus extends js.Object {
  /**
    ...
    */
  var JmxExporter: js.UndefOr[typingsJapgolly.awsSdk.kafkaMod.JmxExporter] = js.native
  /**
    * 
    Indicates whether you want to enable or disable the Node Exporter.
    
    */
  var NodeExporter: js.UndefOr[typingsJapgolly.awsSdk.kafkaMod.NodeExporter] = js.native
}
