...
trait ClusterInfo extends js.Object {
  ...
  /**
    ...
    */
  var BrokerNodeGroupInfo: js.UndefOr[typingsJapgolly.awsSdk.kafkaMod.BrokerNodeGroupInfo] = js.native
  /**
    * 
  ...
  var StateInfo: js.UndefOr[typingsJapgolly.awsSdk.kafkaMod.StateInfo] = js.native
  /**
    * 
