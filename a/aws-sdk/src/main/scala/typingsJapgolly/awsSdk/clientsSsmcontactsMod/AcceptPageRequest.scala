...
trait AcceptPageRequest extends StObject {
  ...
  /**
    ...
    */
  var AcceptCode: typingsJapgolly.awsSdk.clientsSsmcontactsMod.AcceptCode
  ...
  /**
    ...
    */
  var AcceptCodeValidation: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmcontactsMod.AcceptCodeValidation] = js.undefined
  
  /**
    * The type indicates if the page was DELIVERED or READ.
    */
  var AcceptType: typingsJapgolly.awsSdk.clientsSsmcontactsMod.AcceptType
