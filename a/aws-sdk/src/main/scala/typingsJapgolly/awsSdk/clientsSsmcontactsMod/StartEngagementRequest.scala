...
trait StartEngagementRequest extends StObject {
  ...
  /**
    ...
    */
  var Content: typingsJapgolly.awsSdk.clientsSsmcontactsMod.Content
  
  /**
    * A token ensuring that the operation is called only once with the specified details.
    */
  var IdempotencyToken: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmcontactsMod.IdempotencyToken] = js.undefined
  
  /**
    * The ARN of the incident that the engagement is part of.
    */
  var IncidentId: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmcontactsMod.IncidentId] = js.undefined
  
  /**
    * The insecure content of the message that was sent to the contact. Use this field for engagements to SMS.
    */
  var PublicContent: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmcontactsMod.PublicContent] = js.undefined
  
  /**
    * The insecure subject of the message that was sent to the contact. Use this field for engagements to SMS.
    */
  var PublicSubject: js.UndefOr[typingsJapgolly.awsSdk.clientsSsmcontactsMod.PublicSubject] = js.undefined
  
  /**
    * The user that started the engagement.
    */
  var Sender: typingsJapgolly.awsSdk.clientsSsmcontactsMod.Sender
  
  /**
    * The secure subject of the message that was sent to the contact. Use this field for engagements to VOICE or EMAIL.
    */
  var Subject: typingsJapgolly.awsSdk.clientsSsmcontactsMod.Subject
}
