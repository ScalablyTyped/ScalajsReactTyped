...
object CreateLoggingConfigurationRequest {
  ...
  inline def apply(logGroupArn: LogGroupArn, workspaceId: WorkspaceId): CreateLoggingConfigurationRequest = {
  ...
  extension [Self <: CreateLoggingConfigurationRequest](x: Self) {
