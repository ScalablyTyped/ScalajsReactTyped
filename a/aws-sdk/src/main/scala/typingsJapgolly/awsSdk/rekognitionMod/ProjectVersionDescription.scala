...
trait ProjectVersionDescription extends js.Object {
  ...
  /**
    ...
    */
  var EvaluationResult: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.EvaluationResult] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputConfig: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.OutputConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var TestingDataResult: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.TestingDataResult] = js.native
  /**
    * The manifest file that represents the training results.
    */
  var TrainingDataResult: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.TrainingDataResult] = js.native
  /**
