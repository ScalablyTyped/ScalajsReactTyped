...
trait StartCelebrityRecognitionRequest extends js.Object {
  /**
    ...
    */
  var ClientRequestToken: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.ClientRequestToken] = js.native
  /**
    * An identifier you specify that's returned in the completion notification that's published to your Amazon Simple Notification Service topic. For example, you can use JobTag to group related jobs and identify them in the completion notification.
    */
  var JobTag: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.JobTag] = js.native
  /**
    * The Amazon SNS topic ARN that you want Amazon Rekognition Video to publish the completion status of the celebrity recognition analysis to.
    */
  var NotificationChannel: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.NotificationChannel] = js.native
  /**
    * The video in which you want to recognize celebrities. The video must be stored in an Amazon S3 bucket.
    */
  var Video: typingsJapgolly.awsSdk.rekognitionMod.Video = js.native
}
