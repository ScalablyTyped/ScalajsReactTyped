...
trait CreateProjectVersionRequest extends js.Object {
  /**
    ...
    */
  var OutputConfig: typingsJapgolly.awsSdk.rekognitionMod.OutputConfig = js.native
  /**
  ...
  /**
    ...
    */
  var TestingData: typingsJapgolly.awsSdk.rekognitionMod.TestingData = js.native
  /**
    * The dataset to use for training. 
    */
  var TrainingData: typingsJapgolly.awsSdk.rekognitionMod.TrainingData = js.native
  /**
    * A name for the version of the model. This value must be unique.
    */
  var VersionName: typingsJapgolly.awsSdk.rekognitionMod.VersionName = js.native
}
