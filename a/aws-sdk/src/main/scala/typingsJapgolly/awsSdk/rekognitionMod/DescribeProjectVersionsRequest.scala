...
trait DescribeProjectVersionsRequest extends js.Object {
  ...
  /**
    ...
    */
  var ProjectArn: typingsJapgolly.awsSdk.rekognitionMod.ProjectArn = js.native
  /**
    ...
    */
  var VersionNames: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.VersionNames] = js.native
}
