...
trait FaceDetail extends js.Object {
  /**
    ...
    */
  var AgeRange: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.AgeRange] = js.native
  /**
    * Indicates whether or not the face has a beard, and the confidence level in the determination.
    */
  var Beard: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Beard] = js.native
  /**
  ...
  /**
    ...
    */
  var Emotions: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Emotions] = js.native
  /**
    * Indicates whether or not the face is wearing eye glasses, and the confidence level in the determination.
    */
  var Eyeglasses: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Eyeglasses] = js.native
  /**
  ...
  /**
    ...
    */
  var Gender: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Gender] = js.native
  /**
    * Indicates the location of landmarks on the face. Default attribute.
    */
  var Landmarks: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Landmarks] = js.native
  /**
    * Indicates whether or not the mouth on the face is open, and the confidence level in the determination.
    */
  var MouthOpen: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.MouthOpen] = js.native
  /**
    * Indicates whether or not the face has a mustache, and the confidence level in the determination.
    */
  var Mustache: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Mustache] = js.native
  /**
    * Indicates the pose of the face as determined by its pitch, roll, and yaw. Default attribute.
    */
  var Pose: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Pose] = js.native
  /**
  ...
  /**
    ...
    */
  var Smile: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Smile] = js.native
  /**
    * Indicates whether or not the face is wearing sunglasses, and the confidence level in the determination.
    */
  var Sunglasses: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Sunglasses] = js.native
}
