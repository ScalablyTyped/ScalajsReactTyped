...
trait DetectModerationLabelsResponse extends js.Object {
  /**
    ...
    */
  var HumanLoopActivationOutput: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.HumanLoopActivationOutput] = js.native
  /**
    * Array of detected Moderation labels and the time, in milliseconds from the start of the video, they were detected.
    */
  var ModerationLabels: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.ModerationLabels] = js.native
  /**
