...
trait HumanLoopConfig extends js.Object {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsJapgolly.awsSdk.rekognitionMod.FlowDefinitionArn = js.native
  /**
    * The name of the human review used for this image. This should be kept unique within a region.
    */
  var HumanLoopName: typingsJapgolly.awsSdk.rekognitionMod.HumanLoopName = js.native
}
