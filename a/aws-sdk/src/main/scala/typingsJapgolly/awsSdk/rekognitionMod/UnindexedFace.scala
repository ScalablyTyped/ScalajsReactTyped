...
trait UnindexedFace extends js.Object {
  /**
    ...
    */
  var FaceDetail: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.FaceDetail] = js.native
  /**
    ...
    */
  var Reasons: js.UndefOr[typingsJapgolly.awsSdk.rekognitionMod.Reasons] = js.native
}
