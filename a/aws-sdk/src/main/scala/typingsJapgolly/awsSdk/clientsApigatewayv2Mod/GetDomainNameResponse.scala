...
trait GetDomainNameResponse extends StObject {
  ...
  /**
    ...
    */
  var DomainNameConfigurations: js.UndefOr[typingsJapgolly.awsSdk.clientsApigatewayv2Mod.DomainNameConfigurations] = js.undefined
  
  /**
    * The mutual TLS authentication configuration for a custom domain name.
    */
  var MutualTlsAuthentication: js.UndefOr[typingsJapgolly.awsSdk.clientsApigatewayv2Mod.MutualTlsAuthentication] = js.undefined
  
  /**
    * The collection of tags associated with a domain name.
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.clientsApigatewayv2Mod.Tags] = js.undefined
}
