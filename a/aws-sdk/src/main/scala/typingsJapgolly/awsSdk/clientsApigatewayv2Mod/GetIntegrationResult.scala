...
trait GetIntegrationResult extends StObject {
  ...
  /**
    ...
    */
  var IntegrationType: js.UndefOr[typingsJapgolly.awsSdk.clientsApigatewayv2Mod.IntegrationType] = js.undefined
  ...
  /**
    ...
    */
  var TlsConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsApigatewayv2Mod.TlsConfig] = js.undefined
}
object GetIntegrationResult {
  
  inline def apply(): GetIntegrationResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[GetIntegrationResult]
  }
  
  extension [Self <: GetIntegrationResult](x: Self) {
