...
trait UpdateAuthorizerRequest extends StObject {
  ...
  /**
    ...
    */
  var AuthorizerType: js.UndefOr[typingsJapgolly.awsSdk.clientsApigatewayv2Mod.AuthorizerType] = js.undefined
...
object UpdateAuthorizerRequest {
  ...
  inline def apply(ApiId: string, AuthorizerId: string): UpdateAuthorizerRequest = {
