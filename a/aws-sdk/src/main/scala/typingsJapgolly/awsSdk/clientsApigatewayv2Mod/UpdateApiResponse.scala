...
trait UpdateApiResponse extends StObject {
  ...
  /**
    * The API protocol.
    */
  var ProtocolType: js.UndefOr[typingsJapgolly.awsSdk.clientsApigatewayv2Mod.ProtocolType] = js.undefined
...
object UpdateApiResponse {
  ...
  inline def apply(): UpdateApiResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateApiResponse]
  }
  
  extension [Self <: UpdateApiResponse](x: Self) {
