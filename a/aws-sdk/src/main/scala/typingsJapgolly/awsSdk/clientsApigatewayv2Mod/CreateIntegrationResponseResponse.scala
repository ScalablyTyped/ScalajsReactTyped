...
trait CreateIntegrationResponseResponse extends StObject {
...
object CreateIntegrationResponseResponse {
  ...
  inline def apply(): CreateIntegrationResponseResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateIntegrationResponseResponse]
  }
  
  extension [Self <: CreateIntegrationResponseResponse](x: Self) {
