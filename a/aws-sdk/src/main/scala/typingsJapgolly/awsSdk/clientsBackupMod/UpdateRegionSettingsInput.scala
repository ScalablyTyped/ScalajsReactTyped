...
trait UpdateRegionSettingsInput extends StObject {
  ...
  /**
    ...
    */
  var ResourceTypeManagementPreference: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupMod.ResourceTypeManagementPreference] = js.undefined
  
  /**
    * Updates the list of services along with the opt-in preferences for the Region.
    */
  var ResourceTypeOptInPreference: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupMod.ResourceTypeOptInPreference] = js.undefined
}
