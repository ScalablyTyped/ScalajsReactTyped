...
trait DescribeFrameworkOutput extends StObject {
  ...
  /**
    ...
    */
  var FrameworkControls: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupMod.FrameworkControls] = js.undefined
  
  /**
    * An optional description of the framework.
    */
  var FrameworkDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupMod.FrameworkDescription] = js.undefined
  
  /**
    * The unique name of a framework.
    */
  var FrameworkName: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupMod.FrameworkName] = js.undefined
