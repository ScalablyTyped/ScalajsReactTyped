...
trait CreateFrameworkInput extends StObject {
  ...
  /**
    ...
    */
  var FrameworkControls: typingsJapgolly.awsSdk.clientsBackupMod.FrameworkControls
  ...
  /**
    ...
    */
  var FrameworkName: typingsJapgolly.awsSdk.clientsBackupMod.FrameworkName
