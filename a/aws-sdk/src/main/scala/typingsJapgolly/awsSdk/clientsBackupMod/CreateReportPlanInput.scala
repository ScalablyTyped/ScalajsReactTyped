...
trait CreateReportPlanInput extends StObject {
  ...
  /**
    ...
    */
  var ReportDeliveryChannel: typingsJapgolly.awsSdk.clientsBackupMod.ReportDeliveryChannel
  
  /**
    * An optional description of the report plan with a maximum of 1,024 characters.
    */
  var ReportPlanDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsBackupMod.ReportPlanDescription] = js.undefined
  
  /**
    * The unique name of the report plan. The name must be between 1 and 256 characters, starting with a letter, and consisting of letters (a-z, A-Z), numbers (0-9), and underscores (_).
    */
  var ReportPlanName: typingsJapgolly.awsSdk.clientsBackupMod.ReportPlanName
  ...
  /**
    ...
    */
  var ReportSetting: typingsJapgolly.awsSdk.clientsBackupMod.ReportSetting
}
