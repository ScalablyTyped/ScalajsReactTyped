...
trait Condition extends StObject {
  ...
  /**
    ...
    */
  var ConditionKey: typingsJapgolly.awsSdk.clientsBackupMod.ConditionKey
  ...
  /**
    ...
    */
  var ConditionType: typingsJapgolly.awsSdk.clientsBackupMod.ConditionType
  
  /**
    * The value in a key-value pair. For example, in the tag Department: Accounting, Accounting is the value.
    */
  var ConditionValue: typingsJapgolly.awsSdk.clientsBackupMod.ConditionValue
}
object Condition {
