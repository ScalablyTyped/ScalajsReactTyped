...
trait Stack extends js.Object {
  ...
  /**
    ...
    */
  var Arn: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.Arn] = js.native
  /**
  ...
  /**
    ...
    */
  var EmbedHostDomains: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.EmbedHostDomains] = js.native
  /**
    * The URL that users are redirected to after they click the Send Feedback link. If no URL is specified, no Send Feedback link is displayed.
    */
  var FeedbackURL: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.FeedbackURL] = js.native
  /**
  ...
  /**
    ...
    */
  var RedirectURL: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.RedirectURL] = js.native
  /**
    * The errors for the stack.
    */
  var StackErrors: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.StackErrors] = js.native
  /**
