...
trait DirectoryConfig extends js.Object {
  ...
  /**
    ...
    */
  var DirectoryName: typingsJapgolly.awsSdk.appstreamMod.DirectoryName = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceAccountCredentials: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.ServiceAccountCredentials] = js.native
}
