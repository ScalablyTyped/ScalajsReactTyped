...
trait ServiceAccountCredentials extends js.Object {
  /**
    ...
    */
  var AccountName: typingsJapgolly.awsSdk.appstreamMod.AccountName = js.native
  /**
    * The password for the account.
    */
  var AccountPassword: typingsJapgolly.awsSdk.appstreamMod.AccountPassword = js.native
}
