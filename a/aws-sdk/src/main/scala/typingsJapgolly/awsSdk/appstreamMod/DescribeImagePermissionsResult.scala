...
trait DescribeImagePermissionsResult extends js.Object {
  /**
    ...
    */
  var Name: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.Name] = js.native
  /**
  ...
  /**
    ...
    */
  var SharedImagePermissionsList: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.SharedImagePermissionsList] = js.native
}
