...
trait Image extends js.Object {
  /**
    ...
    */
  var Applications: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.Applications] = js.native
  /**
    * The version of the AppStream 2.0 agent to use for instances that are launched from this image. 
    */
  var AppstreamAgentVersion: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.AppstreamAgentVersion] = js.native
  /**
  ...
  /**
    ...
    */
  var ImagePermissions: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.ImagePermissions] = js.native
  /**
