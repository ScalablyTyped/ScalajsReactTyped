...
trait Fleet extends js.Object {
  /**
    ...
    */
  var Arn: typingsJapgolly.awsSdk.appstreamMod.Arn = js.native
  /**
    * The capacity status for the fleet.
    */
  var ComputeCapacityStatus: typingsJapgolly.awsSdk.appstreamMod.ComputeCapacityStatus = js.native
  /**
  ...
  /**
    * The fleet errors.
    */
  var FleetErrors: js.UndefOr[typingsJapgolly.awsSdk.appstreamMod.FleetErrors] = js.native
  /**
