...
trait ScalingPolicy extends StObject {
  ...
  /**
    ...
    */
  var PolicyName: typingsJapgolly.awsSdk.clientsAutoscalingplansMod.PolicyName
  
  /**
    * The type of scaling policy.
    */
  var PolicyType: typingsJapgolly.awsSdk.clientsAutoscalingplansMod.PolicyType
  
  /**
    * The target tracking scaling policy. Includes support for predefined or customized metrics.
    */
  var TargetTrackingConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingplansMod.TargetTrackingConfiguration] = js.undefined
}
