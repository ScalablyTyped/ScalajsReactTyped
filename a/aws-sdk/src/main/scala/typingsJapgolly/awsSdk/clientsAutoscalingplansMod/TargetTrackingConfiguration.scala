...
trait TargetTrackingConfiguration extends StObject {
  ...
  var CustomizedScalingMetricSpecification: js.UndefOr[
    typingsJapgolly.awsSdk.clientsAutoscalingplansMod.CustomizedScalingMetricSpecification
  ] = js.undefined
  ...
  /**
    ...
    */
  var DisableScaleIn: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingplansMod.DisableScaleIn] = js.undefined
  ...
  var PredefinedScalingMetricSpecification: js.UndefOr[
    typingsJapgolly.awsSdk.clientsAutoscalingplansMod.PredefinedScalingMetricSpecification
  ] = js.undefined
