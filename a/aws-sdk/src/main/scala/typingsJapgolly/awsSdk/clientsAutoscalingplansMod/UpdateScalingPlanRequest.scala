...
trait UpdateScalingPlanRequest extends StObject {
  ...
  /**
    ...
    */
  var ApplicationSource: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingplansMod.ApplicationSource] = js.undefined
  
  /**
    * The scaling instructions. For more information, see ScalingInstruction in the AWS Auto Scaling API Reference.
    */
  var ScalingInstructions: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingplansMod.ScalingInstructions] = js.undefined
