...
trait DescribeScalingPlansResponse extends StObject {
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingplansMod.NextToken] = js.undefined
  
  /**
    * Information about the scaling plans.
    */
  var ScalingPlans: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingplansMod.ScalingPlans] = js.undefined
}
