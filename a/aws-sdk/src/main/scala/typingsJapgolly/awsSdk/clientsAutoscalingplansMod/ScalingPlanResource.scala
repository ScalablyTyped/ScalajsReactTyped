...
trait ScalingPlanResource extends StObject {
  ...
  /**
    ...
    */
  var ScalingPolicies: js.UndefOr[typingsJapgolly.awsSdk.clientsAutoscalingplansMod.ScalingPolicies] = js.undefined
  ...
  /**
    ...
    */
  var ScalingStatusCode: typingsJapgolly.awsSdk.clientsAutoscalingplansMod.ScalingStatusCode
