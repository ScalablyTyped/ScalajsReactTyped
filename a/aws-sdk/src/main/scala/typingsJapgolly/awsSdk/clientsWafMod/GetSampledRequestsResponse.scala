...
trait GetSampledRequestsResponse extends StObject {
  ...
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typingsJapgolly.awsSdk.clientsWafMod.PopulationSize] = js.undefined
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typingsJapgolly.awsSdk.clientsWafMod.TimeWindow] = js.undefined
}
