...
trait CreateWebACLMigrationStackRequest extends StObject {
  ...
  /**
    ...
    */
  var IgnoreUnsupportedType: typingsJapgolly.awsSdk.clientsWafMod.IgnoreUnsupportedType
  ...
  /**
    ...
    */
  var S3BucketName: typingsJapgolly.awsSdk.clientsWafMod.S3BucketName
