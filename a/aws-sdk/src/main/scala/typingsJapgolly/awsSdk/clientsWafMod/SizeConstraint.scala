...
trait SizeConstraint extends StObject {
  ...
  /**
    ...
    */
  var ComparisonOperator: typingsJapgolly.awsSdk.clientsWafMod.ComparisonOperator
  
  /**
    * Specifies where in a web request to look for the size constraint.
    */
  var FieldToMatch: typingsJapgolly.awsSdk.clientsWafMod.FieldToMatch
  ...
  /**
    ...
    */
  var Size: typingsJapgolly.awsSdk.clientsWafMod.Size
  ...
  /**
    ...
    */
  var TextTransformation: typingsJapgolly.awsSdk.clientsWafMod.TextTransformation
}
object SizeConstraint {
  ...
  extension [Self <: SizeConstraint](x: Self) {
