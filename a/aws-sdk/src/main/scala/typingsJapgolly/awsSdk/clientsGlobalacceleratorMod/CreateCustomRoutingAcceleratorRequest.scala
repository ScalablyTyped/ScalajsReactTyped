...
trait CreateCustomRoutingAcceleratorRequest extends StObject {
  ...
  /**
    ...
    */
  var IdempotencyToken: typingsJapgolly.awsSdk.clientsGlobalacceleratorMod.IdempotencyToken
  ...
  /**
    ...
    */
  var IpAddresses: js.UndefOr[typingsJapgolly.awsSdk.clientsGlobalacceleratorMod.IpAddresses] = js.undefined
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.clientsGlobalacceleratorMod.Tags] = js.undefined
}
object CreateCustomRoutingAcceleratorRequest {
  ...
  extension [Self <: CreateCustomRoutingAcceleratorRequest](x: Self) {
