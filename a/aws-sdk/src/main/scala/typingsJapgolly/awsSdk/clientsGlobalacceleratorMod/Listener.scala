...
trait Listener extends StObject {
  ...
  /**
    ...
    */
  var ClientAffinity: js.UndefOr[typingsJapgolly.awsSdk.clientsGlobalacceleratorMod.ClientAffinity] = js.undefined
  ...
  /**
    ...
    */
  var PortRanges: js.UndefOr[typingsJapgolly.awsSdk.clientsGlobalacceleratorMod.PortRanges] = js.undefined
  
  /**
    * The protocol for the connections from clients to the accelerator.
    */
  var Protocol: js.UndefOr[typingsJapgolly.awsSdk.clientsGlobalacceleratorMod.Protocol] = js.undefined
}
object Listener {
