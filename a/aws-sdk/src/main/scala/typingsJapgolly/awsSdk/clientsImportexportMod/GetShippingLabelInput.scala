...
trait GetShippingLabelInput extends StObject {
  ...
  var city: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.city] = js.undefined
  
  var company: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.company] = js.undefined
  
  var country: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.country] = js.undefined
  
  var jobIds: JobIdList
  
  var name: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.name] = js.undefined
  
  var phoneNumber: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.phoneNumber] = js.undefined
  
  var postalCode: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.postalCode] = js.undefined
  
  var stateOrProvince: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.stateOrProvince] = js.undefined
  
  var street1: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.street1] = js.undefined
  
  var street2: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.street2] = js.undefined
  
  var street3: js.UndefOr[typingsJapgolly.awsSdk.clientsImportexportMod.street3] = js.undefined
}
