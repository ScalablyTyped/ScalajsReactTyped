...
trait WorkspaceDirectory extends StObject {
  ...
  /**
    * The directory alias.
    */
  var Alias: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.Alias] = js.undefined
  ...
  /**
    ...
    */
  var DirectoryId: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.DirectoryId] = js.undefined
  
  /**
    * The name of the directory.
    */
  var DirectoryName: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.DirectoryName] = js.undefined
  ...
  /**
    ...
    */
  var DnsIpAddresses: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.DnsIpAddresses] = js.undefined
  ...
  /**
    ...
    */
  var RegistrationCode: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.RegistrationCode] = js.undefined
  
  /**
    * Describes the enablement status, user access URL, and relay state parameter name that are used for configuring federation with an SAML 2.0 identity provider.
    */
  var SamlProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.SamlProperties] = js.undefined
  
  /**
    * The default self-service permissions for WorkSpaces in the directory.
    */
  var SelfservicePermissions: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.SelfservicePermissions] = js.undefined
  ...
  /**
    ...
    */
  var SubnetIds: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.SubnetIds] = js.undefined
  ...
  /**
    ...
    */
  var Tenancy: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.Tenancy] = js.undefined
  
  /**
    * The devices and operating systems that users can use to access WorkSpaces.
    */
  var WorkspaceAccessProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.WorkspaceAccessProperties] = js.undefined
