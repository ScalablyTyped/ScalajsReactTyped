...
trait ConnectionAliasAssociation extends StObject {
  ...
  /**
    ...
    */
  var AssociationStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.AssociationStatus] = js.undefined
  
  /**
    * The identifier of the connection alias association. You use the connection identifier in the DNS TXT record when you're configuring your DNS routing policies.
    */
  var ConnectionIdentifier: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkspacesMod.ConnectionIdentifier] = js.undefined
