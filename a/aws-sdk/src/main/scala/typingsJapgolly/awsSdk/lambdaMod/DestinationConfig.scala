...
trait DestinationConfig extends js.Object {
  /**
    ...
    */
  var OnFailure: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.OnFailure] = js.native
  /**
    * The destination configuration for successful invocations.
    */
  var OnSuccess: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.OnSuccess] = js.native
}
