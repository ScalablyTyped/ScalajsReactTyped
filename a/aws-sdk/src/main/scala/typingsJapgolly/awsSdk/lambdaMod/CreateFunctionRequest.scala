...
trait CreateFunctionRequest extends js.Object {
  ...
  /**
    ...
    */
  var DeadLetterConfig: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.DeadLetterConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var Environment: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.Environment] = js.native
  /**
  ...
  /**
    ...
    */
  var Handler: typingsJapgolly.awsSdk.lambdaMod.Handler = js.native
  /**
    * The ARN of the AWS Key Management Service (AWS KMS) key that's used to encrypt your function's environment variables. If it's not provided, AWS Lambda uses a default service key.
    */
  var KMSKeyArn: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.KMSKeyArn] = js.native
  /**
  ...
  /**
    ...
    */
  var MemorySize: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.MemorySize] = js.native
  /**
  ...
  /**
    ...
    */
  var Runtime: typingsJapgolly.awsSdk.lambdaMod.Runtime = js.native
  /**
    * A list of tags to apply to the function.
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.Tags] = js.native
  /**
    * The amount of time that Lambda allows a function to run before stopping it. The default is 3 seconds. The maximum allowed value is 900 seconds.
    */
  var Timeout: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.Timeout] = js.native
  /**
    * Set Mode to Active to sample and trace a subset of incoming requests with AWS X-Ray.
    */
  var TracingConfig: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.TracingConfig] = js.native
  /**
    * For network connectivity to AWS resources in a VPC, specify a list of security groups and subnets in the VPC. When you connect a function to a VPC, it can only access resources and the internet through that VPC. For more information, see VPC Settings.
    */
  var VpcConfig: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.VpcConfig] = js.native
}
