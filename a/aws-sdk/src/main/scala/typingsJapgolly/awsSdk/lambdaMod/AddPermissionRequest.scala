...
trait AddPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typingsJapgolly.awsSdk.lambdaMod.Action = js.native
  /**
    * For Alexa Smart Home functions, a token that must be supplied by the invoker.
    */
  var EventSourceToken: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.EventSourceToken] = js.native
  /**
  ...
  /**
    ...
    */
  var Principal: typingsJapgolly.awsSdk.lambdaMod.Principal = js.native
  /**
  ...
  /**
    ...
    */
  var StatementId: typingsJapgolly.awsSdk.lambdaMod.StatementId = js.native
}
