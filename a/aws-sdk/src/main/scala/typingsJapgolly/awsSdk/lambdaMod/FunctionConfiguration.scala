...
trait FunctionConfiguration extends js.Object {
  ...
  /**
    ...
    */
  var LastUpdateStatus: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.LastUpdateStatus] = js.native
  /**
    * The reason for the last update that was performed on the function.
    */
  var LastUpdateStatusReason: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.LastUpdateStatusReason] = js.native
  /**
    * The reason code for the last update that was performed on the function.
    */
  var LastUpdateStatusReasonCode: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.LastUpdateStatusReasonCode] = js.native
  /**
  ...
  /**
    ...
    */
  var State: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.State] = js.native
  /**
    * The reason for the function's current state.
    */
  var StateReason: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.StateReason] = js.native
  /**
    * The reason code for the function's current state. When the code is Creating, you can't invoke or modify the function.
    */
  var StateReasonCode: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.StateReasonCode] = js.native
  /**
  ...
  /**
    ...
    */
  var Version: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.Version] = js.native
  /**
