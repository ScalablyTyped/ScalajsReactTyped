...
trait ListFunctionsRequest extends js.Object {
  /**
    ...
    */
  var FunctionVersion: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.FunctionVersion] = js.native
  /**
  ...
  /**
    ...
    */
  var MasterRegion: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.MasterRegion] = js.native
  /**
