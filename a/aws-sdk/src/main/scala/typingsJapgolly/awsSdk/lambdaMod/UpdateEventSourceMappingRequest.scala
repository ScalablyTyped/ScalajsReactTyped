...
trait UpdateEventSourceMappingRequest extends js.Object {
  /**
    ...
    */
  var BatchSize: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.BatchSize] = js.native
  /**
    * (Streams) If the function returns an error, split the batch in two and retry.
    */
  var BisectBatchOnFunctionError: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.BisectBatchOnFunctionError] = js.native
  /**
  ...
  /**
    ...
    */
  var Enabled: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.Enabled] = js.native
  /**
    * The name of the Lambda function.  Name formats     Function name - MyFunction.    Function ARN - arn:aws:lambda:us-west-2:123456789012:function:MyFunction.    Version or Alias ARN - arn:aws:lambda:us-west-2:123456789012:function:MyFunction:PROD.    Partial ARN - 123456789012:function:MyFunction.   The length constraint applies only to the full ARN. If you specify only the function name, it's limited to 64 characters in length.
    */
  var FunctionName: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.FunctionName] = js.native
  /**
    * The maximum amount of time to gather records before invoking the function, in seconds.
    */
  var MaximumBatchingWindowInSeconds: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.MaximumBatchingWindowInSeconds] = js.native
  /**
    * (Streams) The maximum age of a record that Lambda sends to a function for processing.
    */
  var MaximumRecordAgeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.MaximumRecordAgeInSeconds] = js.native
  /**
  ...
  /**
    ...
    */
  var ParallelizationFactor: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.ParallelizationFactor] = js.native
  /**
