...
trait InvocationRequest extends js.Object {
  ...
  /**
    ...
    */
  var InvocationType: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.InvocationType] = js.native
  /**
    * Set to Tail to include the execution log in the response.
    */
  var LogType: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.LogType] = js.native
  /**
