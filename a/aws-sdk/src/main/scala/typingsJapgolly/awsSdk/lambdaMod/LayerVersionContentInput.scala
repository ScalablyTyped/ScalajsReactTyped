...
trait LayerVersionContentInput extends js.Object {
  /**
    ...
    */
  var S3Bucket: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.S3Bucket] = js.native
  /**
    * The Amazon S3 key of the layer archive.
    */
  var S3Key: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.S3Key] = js.native
  /**
    * For versioned objects, the version of the layer archive object to use.
    */
  var S3ObjectVersion: js.UndefOr[typingsJapgolly.awsSdk.lambdaMod.S3ObjectVersion] = js.native
  /**
