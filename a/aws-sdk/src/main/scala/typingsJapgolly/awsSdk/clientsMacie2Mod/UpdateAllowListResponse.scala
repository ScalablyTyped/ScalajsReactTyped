...
trait UpdateAllowListResponse extends StObject {
...
object UpdateAllowListResponse {
  
  inline def apply(): UpdateAllowListResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateAllowListResponse]
  }
  
  extension [Self <: UpdateAllowListResponse](x: Self) {
