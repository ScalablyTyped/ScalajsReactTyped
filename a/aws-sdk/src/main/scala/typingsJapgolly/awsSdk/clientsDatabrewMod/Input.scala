...
trait Input extends StObject {
  ...
  /**
    ...
    */
  var DataCatalogInputDefinition: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.DataCatalogInputDefinition] = js.undefined
  
  /**
    * Connection information for dataset input files stored in a database.
    */
  var DatabaseInputDefinition: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.DatabaseInputDefinition] = js.undefined
  
  /**
    * Contains additional resource information needed for specific datasets.
    */
  var Metadata: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.Metadata] = js.undefined
