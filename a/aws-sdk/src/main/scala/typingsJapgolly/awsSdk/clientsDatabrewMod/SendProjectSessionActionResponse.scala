...
trait SendProjectSessionActionResponse extends StObject {
  ...
  /**
    ...
    */
  var ActionId: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.ActionId] = js.undefined
  ...
  /**
    ...
    */
  var Result: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.Result] = js.undefined
}
