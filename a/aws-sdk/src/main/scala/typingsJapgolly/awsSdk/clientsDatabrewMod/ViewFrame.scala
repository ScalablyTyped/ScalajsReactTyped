...
trait ViewFrame extends StObject {
  ...
  /**
    ...
    */
  var ColumnRange: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.ColumnRange] = js.undefined
  ...
  /**
    ...
    */
  var RowRange: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.RowRange] = js.undefined
  
  /**
    * The starting index for the range of columns to return in the view frame.
    */
  var StartColumnIndex: typingsJapgolly.awsSdk.clientsDatabrewMod.StartColumnIndex
  
  /**
    * The starting index for the range of rows to return in the view frame.
    */
  var StartRowIndex: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.StartRowIndex] = js.undefined
}
object ViewFrame {
