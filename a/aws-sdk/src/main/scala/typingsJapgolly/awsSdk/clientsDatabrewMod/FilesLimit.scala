...
trait FilesLimit extends StObject {
  ...
  /**
    ...
    */
  var MaxFiles: typingsJapgolly.awsSdk.clientsDatabrewMod.MaxFiles
  
  /**
    * A criteria to use for Amazon S3 files sorting before their selection. By default uses DESCENDING order, i.e. most recent files are selected first. Another possible value is ASCENDING.
    */
  var Order: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.Order] = js.undefined
  
  /**
    * A criteria to use for Amazon S3 files sorting before their selection. By default uses LAST_MODIFIED_DATE as a sorting criteria. Currently it's the only allowed value.
    */
  var OrderedBy: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.OrderedBy] = js.undefined
}
object FilesLimit {
