...
trait DatasetParameter extends StObject {
  ...
  /**
    ...
    */
  var CreateColumn: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.CreateColumn] = js.undefined
  
  /**
    * Additional parameter options such as a format and a timezone. Required for datetime parameters.
    */
  var DatetimeOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsDatabrewMod.DatetimeOptions] = js.undefined
