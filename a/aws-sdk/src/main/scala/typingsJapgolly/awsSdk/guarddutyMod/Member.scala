...
trait Member extends js.Object {
  /**
    * Member account ID.
    */
  var AccountId: typingsJapgolly.awsSdk.guarddutyMod.AccountId = js.native
  /**
    * Member account's detector ID.
    */
  var DetectorId: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.DetectorId] = js.native
  /**
    * Member account's email address.
    */
  var Email: typingsJapgolly.awsSdk.guarddutyMod.Email = js.native
  /**
