...
trait Resource extends js.Object {
  /**
    ...
    */
  var AccessKeyDetails: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.AccessKeyDetails] = js.native
  /**
    * The information about the EC2 instance associated with the activity that prompted GuardDuty to generate a finding.
    */
  var InstanceDetails: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.InstanceDetails] = js.native
  /**
