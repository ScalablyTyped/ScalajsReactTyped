...
trait InstanceDetails extends js.Object {
  ...
  /**
    ...
    */
  var IamInstanceProfile: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.IamInstanceProfile] = js.native
  /**
  ...
  /**
    ...
    */
  var NetworkInterfaces: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.NetworkInterfaces] = js.native
  /**
  ...
  /**
    ...
    */
  var ProductCodes: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.ProductCodes] = js.native
  /**
    * The tags of the EC2 instance.
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.Tags] = js.native
}
