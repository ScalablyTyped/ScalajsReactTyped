...
trait Action extends js.Object {
  ...
  /**
    ...
    */
  var AwsApiCallAction: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.AwsApiCallAction] = js.native
  /**
    * Information about the DNS_REQUEST action described in this finding.
    */
  var DnsRequestAction: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.DnsRequestAction] = js.native
  /**
    * Information about the NETWORK_CONNECTION action described in this finding.
    */
  var NetworkConnectionAction: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.NetworkConnectionAction] = js.native
  /**
    * Information about the PORT_PROBE action described in this finding.
    */
  var PortProbeAction: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.PortProbeAction] = js.native
}
