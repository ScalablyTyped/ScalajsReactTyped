...
trait RemoteIpDetails extends js.Object {
  /**
    ...
    */
  var City: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.City] = js.native
  /**
    * Country code of the remote IP address.
    */
  var Country: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.Country] = js.native
  /**
    * Location information of the remote IP address.
    */
  var GeoLocation: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.GeoLocation] = js.native
  /**
  ...
  /**
    ...
    */
  var Organization: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.Organization] = js.native
}
