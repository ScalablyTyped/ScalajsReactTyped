...
trait Condition extends js.Object {
  /**
    ...
    */
  var Eq: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.Eq] = js.native
  /**
    * Represents an equal condition to be applied to a single field when querying for findings.
    */
  var Equals: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.Equals] = js.native
  /**
  ...
  /**
    ...
    */
  var Neq: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.Neq] = js.native
  /**
    * Represents an not equal condition to be applied to a single field when querying for findings.
    */
  var NotEquals: js.UndefOr[typingsJapgolly.awsSdk.guarddutyMod.NotEquals] = js.native
}
