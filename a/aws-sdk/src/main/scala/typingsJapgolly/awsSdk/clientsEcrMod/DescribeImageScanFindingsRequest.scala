...
object DescribeImageScanFindingsRequest {
  ...
  inline def apply(imageId: ImageIdentifier, repositoryName: RepositoryName): DescribeImageScanFindingsRequest = {
  ...
  extension [Self <: DescribeImageScanFindingsRequest](x: Self) {
