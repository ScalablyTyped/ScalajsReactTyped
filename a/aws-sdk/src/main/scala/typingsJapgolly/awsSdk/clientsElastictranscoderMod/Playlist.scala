...
trait Playlist extends StObject {
  ...
  /**
    ...
    */
  var HlsContentProtection: js.UndefOr[typingsJapgolly.awsSdk.clientsElastictranscoderMod.HlsContentProtection] = js.undefined
  ...
  /**
    ...
    */
  var OutputKeys: js.UndefOr[typingsJapgolly.awsSdk.clientsElastictranscoderMod.OutputKeys] = js.undefined
  
  /**
    * The DRM settings, if any, that you want Elastic Transcoder to apply to the output files associated with this playlist.
    */
  var PlayReadyDrm: js.UndefOr[typingsJapgolly.awsSdk.clientsElastictranscoderMod.PlayReadyDrm] = js.undefined
