...
trait UpdatePipelineRequest extends StObject {
  ...
  /**
    ...
    */
  var Name: js.UndefOr[typingsJapgolly.awsSdk.clientsElastictranscoderMod.Name] = js.undefined
  ...
  /**
    ...
    */
  var Notifications: js.UndefOr[typingsJapgolly.awsSdk.clientsElastictranscoderMod.Notifications] = js.undefined
  
  /**
    * The IAM Amazon Resource Name (ARN) for the role that you want Elastic Transcoder to use to transcode jobs for this pipeline.
    */
  var Role: js.UndefOr[typingsJapgolly.awsSdk.clientsElastictranscoderMod.Role] = js.undefined
...
object UpdatePipelineRequest {
  ...
  inline def apply(Id: Id): UpdatePipelineRequest = {
  ...
  extension [Self <: UpdatePipelineRequest](x: Self) {
    ...
    inline def setInputBucketUndefined: Self = StObject.set(x, "InputBucket", js.undefined)
