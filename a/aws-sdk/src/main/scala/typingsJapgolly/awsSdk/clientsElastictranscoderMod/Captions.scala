...
trait Captions extends StObject {
  ...
  /**
    ...
    */
  var CaptionFormats: js.UndefOr[typingsJapgolly.awsSdk.clientsElastictranscoderMod.CaptionFormats] = js.undefined
  
  /**
    * Source files for the input sidecar captions used during the transcoding process. To omit all sidecar captions, leave CaptionSources blank.
    */
  var CaptionSources: js.UndefOr[typingsJapgolly.awsSdk.clientsElastictranscoderMod.CaptionSources] = js.undefined
