...
trait DescribeGameServerInstancesOutput extends StObject {
  ...
  /**
    ...
    */
  var GameServerInstances: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.GameServerInstances] = js.undefined
...
object DescribeGameServerInstancesOutput {
  ...
  extension [Self <: DescribeGameServerInstancesOutput](x: Self) {
