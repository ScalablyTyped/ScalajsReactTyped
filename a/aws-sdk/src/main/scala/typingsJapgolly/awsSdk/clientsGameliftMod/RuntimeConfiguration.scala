...
trait RuntimeConfiguration extends StObject {
  ...
  /**
    ...
    */
  var GameSessionActivationTimeoutSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.GameSessionActivationTimeoutSeconds] = js.undefined
  ...
  /**
    ...
    */
  var MaxConcurrentGameSessionActivations: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.MaxConcurrentGameSessionActivations] = js.undefined
