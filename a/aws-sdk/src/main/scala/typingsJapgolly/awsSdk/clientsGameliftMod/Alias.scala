...
trait Alias extends StObject {
  ...
  /**
    ...
    */
  var AliasArn: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.AliasArn] = js.undefined
  
  /**
    * A unique identifier for the alias. Alias IDs are unique within a Region.
    */
  var AliasId: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.AliasId] = js.undefined
