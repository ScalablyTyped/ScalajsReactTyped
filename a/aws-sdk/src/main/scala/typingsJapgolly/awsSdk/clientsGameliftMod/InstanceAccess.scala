...
trait InstanceAccess extends StObject {
  ...
  /**
    ...
    */
  var InstanceId: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.InstanceId] = js.undefined
  
  /**
    * IP address that is assigned to the instance.
    */
  var IpAddress: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.IpAddress] = js.undefined
