...
trait PutScalingPolicyInput extends StObject {
  ...
  /**
    ...
    */
  var MetricName: typingsJapgolly.awsSdk.clientsGameliftMod.MetricName
  ...
  /**
    ...
    */
  var PolicyType: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.PolicyType] = js.undefined
  ...
  /**
    ...
    */
  var ScalingAdjustmentType: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.ScalingAdjustmentType] = js.undefined
  
  /**
    * An object that contains settings for a target-based scaling policy.
    */
  var TargetConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.TargetConfiguration] = js.undefined
...
object PutScalingPolicyInput {
  ...
  inline def apply(FleetId: FleetIdOrArn, MetricName: MetricName, Name: NonZeroAndMaxString): PutScalingPolicyInput = {
