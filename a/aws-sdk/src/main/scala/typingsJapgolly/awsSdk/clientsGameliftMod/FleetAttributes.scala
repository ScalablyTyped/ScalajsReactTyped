...
trait FleetAttributes extends StObject {
  ...
  /**
    ...
    */
  var BuildArn: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.BuildArn] = js.undefined
  
  /**
    * A unique identifier for the build resource that is deployed on instances in this fleet.
    */
  var BuildId: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.BuildId] = js.undefined
  
  /**
    * Indicates whether a TLS/SSL certificate was generated for the fleet. 
    */
  var CertificateConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.CertificateConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var FleetType: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.FleetType] = js.undefined
  ...
  /**
    ...
    */
  var OperatingSystem: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.OperatingSystem] = js.undefined
  
  /**
    * The fleet policy that limits the number of game sessions an individual player can create over a span of time.
    */
  var ResourceCreationLimitPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.ResourceCreationLimitPolicy] = js.undefined
  
  /**
    *  The Amazon Resource Name (ARN) associated with the GameLift script resource that is deployed on instances in this fleet. In a GameLift script ARN, the resource ID matches the ScriptId value.
    */
  var ScriptArn: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.ScriptArn] = js.undefined
  
  /**
    * A unique identifier for the Realtime script resource that is deployed on instances in this fleet.
    */
  var ScriptId: js.UndefOr[typingsJapgolly.awsSdk.clientsGameliftMod.ScriptId] = js.undefined
