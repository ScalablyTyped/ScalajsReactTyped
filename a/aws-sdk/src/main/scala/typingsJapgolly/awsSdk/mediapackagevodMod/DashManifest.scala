...
trait DashManifest extends js.Object {
  /**
    ...
    */
  var ManifestLayout: js.UndefOr[typingsJapgolly.awsSdk.mediapackagevodMod.ManifestLayout] = js.native
  /**
  ...
  /**
    ...
    */
  var Profile: js.UndefOr[typingsJapgolly.awsSdk.mediapackagevodMod.Profile] = js.native
