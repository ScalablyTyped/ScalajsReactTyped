...
trait CreatePackagingConfigurationResponse extends js.Object {
  ...
  var CmafPackage: js.UndefOr[typingsJapgolly.awsSdk.mediapackagevodMod.CmafPackage] = js.native
  var DashPackage: js.UndefOr[typingsJapgolly.awsSdk.mediapackagevodMod.DashPackage] = js.native
  var HlsPackage: js.UndefOr[typingsJapgolly.awsSdk.mediapackagevodMod.HlsPackage] = js.native
  /**
    * The ID of the PackagingConfiguration.
    */
  var Id: js.UndefOr[string] = js.native
  var MssPackage: js.UndefOr[typingsJapgolly.awsSdk.mediapackagevodMod.MssPackage] = js.native
  /**
