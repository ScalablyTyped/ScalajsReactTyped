...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.SEND_MESSAGE
  - typingsJapgolly.awsSdk.awsSdkStrings.DISCONNECT_USER
  - typingsJapgolly.awsSdk.awsSdkStrings.DELETE_MESSAGE
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.`2020-07-14`
