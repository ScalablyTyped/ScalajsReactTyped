...
import typingsJapgolly.awsSdk.rdsMod.Boolean
...
/* Inlined aws-sdk.aws-sdk/clients/rds.DescribeDBClusterSnapshotsMessage & {  $waiter ? :aws-sdk.aws-sdk/lib/service.WaiterConfiguration} */
@js.native
