...
trait VideoSelectorSettings extends StObject {
  ...
  var VideoSelectorPid: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.VideoSelectorPid] = js.undefined
  
  var VideoSelectorProgramId: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.VideoSelectorProgramId] = js.undefined
}
