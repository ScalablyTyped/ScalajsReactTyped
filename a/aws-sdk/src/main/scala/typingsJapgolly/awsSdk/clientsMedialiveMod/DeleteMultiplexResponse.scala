...
trait DeleteMultiplexResponse extends StObject {
  ...
  /**
    ...
    */
  var MultiplexSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.MultiplexSettings] = js.undefined
...
object DeleteMultiplexResponse {
  ...
  inline def apply(): DeleteMultiplexResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DeleteMultiplexResponse]
  }
  
  extension [Self <: DeleteMultiplexResponse](x: Self) {
