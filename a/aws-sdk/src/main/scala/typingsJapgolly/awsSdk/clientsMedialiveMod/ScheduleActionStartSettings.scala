...
trait ScheduleActionStartSettings extends StObject {
  ...
  /**
    ...
    */
  var FixedModeScheduleActionStartSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.FixedModeScheduleActionStartSettings] = js.undefined
  
  /**
    * Option for specifying an action as relative to another action.
    */
  var FollowModeScheduleActionStartSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.FollowModeScheduleActionStartSettings] = js.undefined
  
  /**
    * Option for specifying an action that should be applied immediately.
    */
  var ImmediateModeScheduleActionStartSettings: js.UndefOr[
    typingsJapgolly.awsSdk.clientsMedialiveMod.ImmediateModeScheduleActionStartSettings
  ] = js.undefined
}
