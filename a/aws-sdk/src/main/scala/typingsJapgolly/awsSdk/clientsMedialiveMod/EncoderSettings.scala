...
trait EncoderSettings extends StObject {
  ...
  /**
    ...
    */
  var AvailBlanking: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.AvailBlanking] = js.undefined
  
  /**
    * Event-wide configuration settings for ad avail insertion.
    */
  var AvailConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.AvailConfiguration] = js.undefined
  
  /**
    * Settings for blackout slate.
    */
  var BlackoutSlate: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.BlackoutSlate] = js.undefined
  ...
  /**
    * Feature Activations
    */
  var FeatureActivations: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.FeatureActivations] = js.undefined
  
  /**
    * Configuration settings that apply to the event as a whole.
    */
  var GlobalConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.GlobalConfiguration] = js.undefined
  
  /**
    * Settings for motion graphics.
    */
  var MotionGraphicsConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.MotionGraphicsConfiguration] = js.undefined
  
  /**
    * Nielsen configuration settings.
    */
  var NielsenConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.NielsenConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var TimecodeConfig: typingsJapgolly.awsSdk.clientsMedialiveMod.TimecodeConfig
