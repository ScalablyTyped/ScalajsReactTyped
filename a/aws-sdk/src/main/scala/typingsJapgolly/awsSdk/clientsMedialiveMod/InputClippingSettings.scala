...
trait InputClippingSettings extends StObject {
  ...
  /**
    ...
    */
  var InputTimecodeSource: typingsJapgolly.awsSdk.clientsMedialiveMod.InputTimecodeSource
  
  /**
    * Settings to identify the start of the clip.
    */
  var StartTimecode: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.StartTimecode] = js.undefined
  
  /**
    * Settings to identify the end of the clip.
    */
  var StopTimecode: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.StopTimecode] = js.undefined
}
