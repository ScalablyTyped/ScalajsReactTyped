...
trait ScheduleAction extends StObject {
  ...
  /**
    ...
    */
  var ScheduleActionSettings: typingsJapgolly.awsSdk.clientsMedialiveMod.ScheduleActionSettings
  
  /**
    * The time for the action to start in the channel.
    */
  var ScheduleActionStartSettings: typingsJapgolly.awsSdk.clientsMedialiveMod.ScheduleActionStartSettings
}
