...
trait UpdateMultiplexProgramRequest extends StObject {
  ...
  /**
    ...
    */
  var MultiplexProgramSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMedialiveMod.MultiplexProgramSettings] = js.undefined
...
object UpdateMultiplexProgramRequest {
  ...
  extension [Self <: UpdateMultiplexProgramRequest](x: Self) {
