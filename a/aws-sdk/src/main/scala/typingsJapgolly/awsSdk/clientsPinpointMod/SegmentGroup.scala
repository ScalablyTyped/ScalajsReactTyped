...
trait SegmentGroup extends StObject {
  ...
  /**
    ...
    */
  var SourceType: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointMod.SourceType] = js.undefined
  
  /**
    * Specifies how to handle multiple dimensions for the segment. For example, if you specify three dimensions for the segment, whether the resulting segment includes endpoints that match all, any, or none of the dimensions.
    */
  var Type: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointMod.Type] = js.undefined
}
object SegmentGroup {
