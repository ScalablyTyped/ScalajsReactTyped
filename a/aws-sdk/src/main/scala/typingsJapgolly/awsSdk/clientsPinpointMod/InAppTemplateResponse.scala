...
trait InAppTemplateResponse extends StObject {
  ...
  /**
    ...
    */
  var Layout: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointMod.Layout] = js.undefined
  ...
  /**
    ...
    */
  var TemplateType: typingsJapgolly.awsSdk.clientsPinpointMod.TemplateType
