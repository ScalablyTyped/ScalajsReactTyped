...
trait CreateRecommenderConfiguration extends StObject {
...
object CreateRecommenderConfiguration {
  ...
  inline def apply(RecommendationProviderRoleArn: string, RecommendationProviderUri: string): CreateRecommenderConfiguration = {
