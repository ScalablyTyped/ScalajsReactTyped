...
trait SimpleCondition extends StObject {
  ...
  /**
    ...
    */
  var EventCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointMod.EventCondition] = js.undefined
  
  /**
    * The segment that's associated with the activity.
    */
  var SegmentCondition: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointMod.SegmentCondition] = js.undefined
  
  /**
    * The dimension settings for the segment that's associated with the activity.
    */
  var SegmentDimensions: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointMod.SegmentDimensions] = js.undefined
}
