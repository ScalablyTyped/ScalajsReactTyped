...
trait UpdateInAppTemplateRequest extends StObject {
  ...
  var InAppTemplateRequest: typingsJapgolly.awsSdk.clientsPinpointMod.InAppTemplateRequest
...
object UpdateInAppTemplateRequest {
  ...
  inline def apply(InAppTemplateRequest: InAppTemplateRequest, TemplateName: string): UpdateInAppTemplateRequest = {
  ...
  extension [Self <: UpdateInAppTemplateRequest](x: Self) {
