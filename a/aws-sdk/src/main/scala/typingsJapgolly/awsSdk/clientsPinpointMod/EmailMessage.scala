...
trait EmailMessage extends StObject {
  ...
  /**
    ...
    */
  var RawEmail: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointMod.RawEmail] = js.undefined
  ...
  /**
    ...
    */
  var SimpleEmail: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointMod.SimpleEmail] = js.undefined
