...
trait CSVOutput extends StObject {
  ...
  /**
    ...
    */
  var FieldDelimiter: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.FieldDelimiter] = js.undefined
  
  /**
    * A single character used for escaping when the field delimiter is part of the value. For example, if the value is a, b, Amazon S3 wraps this field value in quotation marks, as follows: " a , b ".
    */
  var QuoteCharacter: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.QuoteCharacter] = js.undefined
  
  /**
    * The single character used for escaping the quote character inside an already escaped value.
    */
  var QuoteEscapeCharacter: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.QuoteEscapeCharacter] = js.undefined
  ...
  /**
    ...
    */
  var QuoteFields: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.QuoteFields] = js.undefined
  
  /**
    * A single character used to separate individual records in the output. Instead of the default value, you can specify an arbitrary delimiter.
    */
  var RecordDelimiter: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.RecordDelimiter] = js.undefined
}
object CSVOutput {
