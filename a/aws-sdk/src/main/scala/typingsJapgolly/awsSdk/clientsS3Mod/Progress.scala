...
trait Progress extends StObject {
  ...
  /**
    ...
    */
  var BytesProcessed: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.BytesProcessed] = js.undefined
  
  /**
    * The current number of bytes of records payload data returned.
    */
  var BytesReturned: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.BytesReturned] = js.undefined
  
  /**
    * The current number of object bytes scanned.
    */
  var BytesScanned: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.BytesScanned] = js.undefined
}
object Progress {
