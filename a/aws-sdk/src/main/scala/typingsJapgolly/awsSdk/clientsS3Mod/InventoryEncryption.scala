...
trait InventoryEncryption extends StObject {
  ...
  /**
    ...
    */
  var SSEKMS: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.SSEKMS] = js.undefined
  
  /**
    * Specifies the use of SSE-S3 to encrypt delivered inventory reports.
    */
  var SSES3: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.SSES3] = js.undefined
}
