...
trait Redirect extends StObject {
  ...
  /**
    ...
    */
  var HostName: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.HostName] = js.undefined
  
  /**
    * The HTTP redirect code to use on the response. Not required if one of the siblings is present.
    */
  var HttpRedirectCode: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.HttpRedirectCode] = js.undefined
  
  /**
    * Protocol to use when redirecting requests. The default is the protocol that is used in the original request.
    */
  var Protocol: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.Protocol] = js.undefined
  ...
  /**
    ...
    */
  var ReplaceKeyPrefixWith: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.ReplaceKeyPrefixWith] = js.undefined
  ...
  /**
    ...
    */
  var ReplaceKeyWith: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.ReplaceKeyWith] = js.undefined
}
object Redirect {
