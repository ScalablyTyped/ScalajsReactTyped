...
trait CloudFunctionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CloudFunction: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.CloudFunction] = js.undefined
  
  var Event: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.Event] = js.undefined
