...
trait ListObjectVersionsOutput extends StObject {
  ...
  /**
    ...
    */
  var DeleteMarkers: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.DeleteMarkers] = js.undefined
  
  /**
    * The delimiter grouping the included keys. A delimiter is a character that you specify to group keys. All keys that contain the same string between the prefix and the first occurrence of the delimiter are grouped under a single result element in CommonPrefixes. These groups are counted as one result against the max-keys limitation. These keys are not returned elsewhere in the response.
    */
  var Delimiter: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.Delimiter] = js.undefined
  ...
  /**
    ...
    */
  var EncodingType: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.EncodingType] = js.undefined
  
  /**
    * A flag that indicates whether Amazon S3 returned all of the results that satisfied the search criteria. If your results were truncated, you can make a follow-up paginated request using the NextKeyMarker and NextVersionIdMarker response parameters as a starting place in another request to return the rest of the results.
    */
  var IsTruncated: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.IsTruncated] = js.undefined
  
  /**
    * Marks the last key returned in a truncated response.
    */
  var KeyMarker: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.KeyMarker] = js.undefined
  
  /**
    * Specifies the maximum number of objects to return.
    */
  var MaxKeys: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.MaxKeys] = js.undefined
  ...
  /**
    ...
    */
  var NextKeyMarker: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.NextKeyMarker] = js.undefined
  
  /**
    * When the number of responses exceeds the value of MaxKeys, NextVersionIdMarker specifies the first object version not returned that satisfies the search criteria. Use this value for the version-id-marker request parameter in a subsequent request.
    */
  var NextVersionIdMarker: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.NextVersionIdMarker] = js.undefined
  ...
  /**
    ...
    */
  var VersionIdMarker: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.VersionIdMarker] = js.undefined
