...
trait PutBucketPolicyRequest extends StObject {
  ...
  /**
    ...
    */
  var ConfirmRemoveSelfBucketAccess: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.ConfirmRemoveSelfBucketAccess] = js.undefined
  ...
  /**
    ...
    */
  var Policy: typingsJapgolly.awsSdk.clientsS3Mod.Policy
}
