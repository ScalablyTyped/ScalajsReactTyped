...
trait RestoreRequest extends StObject {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.Description] = js.undefined
  
  /**
    * S3 Glacier related parameters pertaining to this job. Do not use with restores that specify OutputLocation.
    */
  var GlacierJobParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.GlacierJobParameters] = js.undefined
  
  /**
    * Describes the location where the restore job's output is stored.
    */
  var OutputLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.OutputLocation] = js.undefined
  
  /**
    * Describes the parameters for Select job types.
    */
  var SelectParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.SelectParameters] = js.undefined
  
  /**
    * Retrieval tier at which the restore will be processed.
    */
  var Tier: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.Tier] = js.undefined
