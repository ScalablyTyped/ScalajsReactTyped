...
trait S3Location extends StObject {
  ...
  /**
    ...
    */
  var BucketName: typingsJapgolly.awsSdk.clientsS3Mod.BucketName
  ...
  var Encryption: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.Encryption] = js.undefined
  ...
  /**
    ...
    */
  var Tagging: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.Tagging] = js.undefined
  
  /**
    * A list of metadata to store with the restore results in S3.
    */
  var UserMetadata: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.UserMetadata] = js.undefined
}
object S3Location {
