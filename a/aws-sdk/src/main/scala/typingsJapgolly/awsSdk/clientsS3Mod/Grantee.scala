...
trait Grantee extends StObject {
  ...
  /**
    ...
    */
  var EmailAddress: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.EmailAddress] = js.undefined
  ...
  /**
    * Type of grantee
    */
  var Type: typingsJapgolly.awsSdk.clientsS3Mod.Type
  
  /**
    * URI of the grantee group.
    */
  var URI: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.URI] = js.undefined
}
object Grantee {
