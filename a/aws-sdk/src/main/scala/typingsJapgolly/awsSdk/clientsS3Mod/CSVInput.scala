...
trait CSVInput extends StObject {
  ...
  /**
    ...
    */
  var AllowQuotedRecordDelimiter: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.AllowQuotedRecordDelimiter] = js.undefined
  
  /**
    * A single character used to indicate that a row should be ignored when the character is present at the start of that row. You can specify any character to indicate a comment line.
    */
  var Comments: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.Comments] = js.undefined
  ...
  /**
    ...
    */
  var FileHeaderInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.FileHeaderInfo] = js.undefined
