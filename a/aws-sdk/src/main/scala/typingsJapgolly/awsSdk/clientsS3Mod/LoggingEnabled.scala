...
trait LoggingEnabled extends StObject {
  ...
  /**
    ...
    */
  var TargetBucket: typingsJapgolly.awsSdk.clientsS3Mod.TargetBucket
  ...
  /**
    ...
    */
  var TargetGrants: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.TargetGrants] = js.undefined
  
  /**
    * A prefix for all log object keys. If you store log files from multiple Amazon S3 buckets in a single bucket, you can use a prefix to distinguish which log files came from which bucket.
    */
  var TargetPrefix: typingsJapgolly.awsSdk.clientsS3Mod.TargetPrefix
}
