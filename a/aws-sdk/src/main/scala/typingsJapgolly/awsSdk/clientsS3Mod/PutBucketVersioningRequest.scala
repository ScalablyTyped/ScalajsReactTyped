...
trait PutBucketVersioningRequest extends StObject {
  ...
  /**
    ...
    */
  var MFA: js.UndefOr[typingsJapgolly.awsSdk.clientsS3Mod.MFA] = js.undefined
  
  /**
    * Container for setting the versioning state.
    */
  var VersioningConfiguration: typingsJapgolly.awsSdk.clientsS3Mod.VersioningConfiguration
}
