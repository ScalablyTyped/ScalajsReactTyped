...
trait SelectResourceConfigResponse extends StObject {
  ...
  /**
    ...
    */
  var QueryInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.QueryInfo] = js.undefined
  
  /**
    * Returns the results for the SQL query.
    */
  var Results: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.Results] = js.undefined
}
