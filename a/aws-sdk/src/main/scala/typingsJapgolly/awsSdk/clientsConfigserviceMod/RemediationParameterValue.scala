...
trait RemediationParameterValue extends StObject {
  ...
  /**
    ...
    */
  var ResourceValue: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.ResourceValue] = js.undefined
  
  /**
    * The value is static and does not change at run-time.
    */
  var StaticValue: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.StaticValue] = js.undefined
}
