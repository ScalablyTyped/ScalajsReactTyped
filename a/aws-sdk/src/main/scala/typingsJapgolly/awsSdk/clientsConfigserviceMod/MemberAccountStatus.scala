...
trait MemberAccountStatus extends StObject {
  ...
  /**
    ...
    */
  var AccountId: typingsJapgolly.awsSdk.clientsConfigserviceMod.AccountId
  ...
  /**
    ...
    */
  var MemberAccountRuleStatus: typingsJapgolly.awsSdk.clientsConfigserviceMod.MemberAccountRuleStatus
}
