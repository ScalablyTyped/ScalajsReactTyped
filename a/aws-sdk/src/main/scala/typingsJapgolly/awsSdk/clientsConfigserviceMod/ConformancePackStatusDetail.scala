...
trait ConformancePackStatusDetail extends StObject {
  ...
  /**
    ...
    */
  var ConformancePackState: typingsJapgolly.awsSdk.clientsConfigserviceMod.ConformancePackState
  
  /**
    * The reason of conformance pack creation failure.
    */
  var ConformancePackStatusReason: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.ConformancePackStatusReason] = js.undefined
  ...
  /**
    ...
    */
  var StackArn: typingsJapgolly.awsSdk.clientsConfigserviceMod.StackArn
}
