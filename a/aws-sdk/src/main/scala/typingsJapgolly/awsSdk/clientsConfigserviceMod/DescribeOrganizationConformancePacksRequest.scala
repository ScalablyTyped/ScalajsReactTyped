...
trait DescribeOrganizationConformancePacksRequest extends StObject {
  ...
  /**
    ...
    */
  var OrganizationConformancePackNames: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.OrganizationConformancePackNames] = js.undefined
}
object DescribeOrganizationConformancePacksRequest {
  ...
  extension [Self <: DescribeOrganizationConformancePacksRequest](x: Self) {
