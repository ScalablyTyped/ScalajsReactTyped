...
trait OrganizationCustomPolicyRuleMetadata extends StObject {
  ...
  /**
    ...
    */
  var DebugLogDeliveryAccounts: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.DebugLogDeliveryAccounts] = js.undefined
  ...
  /**
    ...
    */
  var PolicyRuntime: typingsJapgolly.awsSdk.clientsConfigserviceMod.PolicyRuntime
  
  /**
    * The policy definition containing the logic for your organization Config Custom Policy rule.
    */
  var PolicyText: typingsJapgolly.awsSdk.clientsConfigserviceMod.PolicyText
...
object OrganizationCustomPolicyRuleMetadata {
  ...
  extension [Self <: OrganizationCustomPolicyRuleMetadata](x: Self) {
