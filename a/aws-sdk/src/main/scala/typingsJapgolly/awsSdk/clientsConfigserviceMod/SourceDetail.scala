...
trait SourceDetail extends StObject {
  ...
  /**
    ...
    */
  var EventSource: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.EventSource] = js.undefined
  ...
  /**
    ...
    */
  var MessageType: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.MessageType] = js.undefined
}
object SourceDetail {
