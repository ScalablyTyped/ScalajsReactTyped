...
trait PutOrganizationConformancePackRequest extends StObject {
  ...
  /**
    ...
    */
  var ConformancePackInputParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.ConformancePackInputParameters] = js.undefined
  ...
  /**
    ...
    */
  var DeliveryS3Bucket: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.DeliveryS3Bucket] = js.undefined
  
  /**
    * The prefix for the Amazon S3 bucket.  This field is optional. 
    */
  var DeliveryS3KeyPrefix: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.DeliveryS3KeyPrefix] = js.undefined
  
  /**
    * A list of Amazon Web Services accounts to be excluded from an organization conformance pack while deploying a conformance pack.
    */
  var ExcludedAccounts: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.ExcludedAccounts] = js.undefined
  
  /**
    * Name of the organization conformance pack you want to create.
    */
  var OrganizationConformancePackName: typingsJapgolly.awsSdk.clientsConfigserviceMod.OrganizationConformancePackName
  
  /**
    * A string containing full conformance pack template body. Structure containing the template body with a minimum length of 1 byte and a maximum length of 51,200 bytes.
    */
  var TemplateBody: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.TemplateBody] = js.undefined
  ...
  /**
    ...
    */
  var TemplateS3Uri: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.TemplateS3Uri] = js.undefined
}
