...
trait ConformancePackInputParameter extends StObject {
  ...
  /**
    ...
    */
  var ParameterName: typingsJapgolly.awsSdk.clientsConfigserviceMod.ParameterName
  
  /**
    * Another part of the key-value pair. 
    */
  var ParameterValue: typingsJapgolly.awsSdk.clientsConfigserviceMod.ParameterValue
}
