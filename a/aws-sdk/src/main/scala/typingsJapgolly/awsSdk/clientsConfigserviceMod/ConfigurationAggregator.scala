...
trait ConfigurationAggregator extends StObject {
  ...
  /**
    ...
    */
  var ConfigurationAggregatorArn: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.ConfigurationAggregatorArn] = js.undefined
  
  /**
    * The name of the aggregator.
    */
  var ConfigurationAggregatorName: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.ConfigurationAggregatorName] = js.undefined
  ...
  /**
    ...
    */
  var OrganizationAggregationSource: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.OrganizationAggregationSource] = js.undefined
}
