...
trait ConformancePackDetail extends StObject {
  ...
  /**
    ...
    */
  var ConformancePackArn: typingsJapgolly.awsSdk.clientsConfigserviceMod.ConformancePackArn
  
  /**
    * ID of the conformance pack.
    */
  var ConformancePackId: typingsJapgolly.awsSdk.clientsConfigserviceMod.ConformancePackId
  ...
  /**
    ...
    */
  var TemplateSSMDocumentDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.TemplateSSMDocumentDetails] = js.undefined
}
