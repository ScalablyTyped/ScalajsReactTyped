...
trait ListConformancePackComplianceScoresRequest extends StObject {
  ...
  /**
    ...
    */
  var SortBy: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.SortBy] = js.undefined
  ...
  /**
    ...
    */
  var SortOrder: js.UndefOr[typingsJapgolly.awsSdk.clientsConfigserviceMod.SortOrder] = js.undefined
}
