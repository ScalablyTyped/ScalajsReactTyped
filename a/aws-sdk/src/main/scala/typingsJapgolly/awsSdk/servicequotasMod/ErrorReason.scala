...
trait ErrorReason extends js.Object {
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.servicequotasMod.ErrorCode] = js.native
  /**
    * The error message that provides more detail.
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.servicequotasMod.ErrorMessage] = js.native
}
