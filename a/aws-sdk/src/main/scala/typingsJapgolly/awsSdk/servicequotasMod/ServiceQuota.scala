...
trait ServiceQuota extends js.Object {
  ...
  /**
    ...
    */
  var ErrorReason: js.UndefOr[typingsJapgolly.awsSdk.servicequotasMod.ErrorReason] = js.native
  /**
    * Specifies if the quota is global.
    */
  var GlobalQuota: js.UndefOr[typingsJapgolly.awsSdk.servicequotasMod.GlobalQuota] = js.native
  /**
  ...
  /**
    ...
    */
  var QuotaArn: js.UndefOr[typingsJapgolly.awsSdk.servicequotasMod.QuotaArn] = js.native
  /**
    * The code identifier for the service quota specified.
    */
  var QuotaCode: js.UndefOr[typingsJapgolly.awsSdk.servicequotasMod.QuotaCode] = js.native
  /**
    * The name identifier of the service quota.
    */
  var QuotaName: js.UndefOr[typingsJapgolly.awsSdk.servicequotasMod.QuotaName] = js.native
  /**
  ...
  /**
    ...
    */
  var ServiceName: js.UndefOr[typingsJapgolly.awsSdk.servicequotasMod.ServiceName] = js.native
  /**
