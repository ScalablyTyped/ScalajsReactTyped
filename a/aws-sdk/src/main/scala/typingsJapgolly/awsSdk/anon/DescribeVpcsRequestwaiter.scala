...
import typingsJapgolly.awsSdk.clientsEc2Mod.DescribeVpcsMaxResults
...
import typingsJapgolly.awsSdk.clientsEc2Mod.VpcId
import typingsJapgolly.awsSdk.clientsEc2Mod.VpcIdStringList
...
trait DescribeVpcsRequestwaiter extends StObject {
...
object DescribeVpcsRequestwaiter {
  ...
  inline def apply(): DescribeVpcsRequestwaiter = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeVpcsRequestwaiter]
  }
  
  extension [Self <: DescribeVpcsRequestwaiter](x: Self) {
