...
import typingsJapgolly.awsSdk.clientsRdsMod.Boolean
import typingsJapgolly.awsSdk.clientsRdsMod.Filter
import typingsJapgolly.awsSdk.clientsRdsMod.FilterList
import typingsJapgolly.awsSdk.clientsRdsMod.IntegerOptional
import typingsJapgolly.awsSdk.clientsRdsMod.String
...
object DescribeDBClusterSnapshot {
  ...
  inline def apply(): DescribeDBClusterSnapshot = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeDBClusterSnapshot]
  }
  
  extension [Self <: DescribeDBClusterSnapshot](x: Self) {
