...
import typingsJapgolly.awsSdk.clientsEc2Mod.InstanceId
import typingsJapgolly.awsSdk.clientsEc2Mod.InstanceIdStringList
...
/* Inlined aws-sdk.aws-sdk/clients/ec2.DescribeInstancesRequest & {  $waiter :aws-sdk.aws-sdk/lib/service.WaiterConfiguration | undefined} */
trait DescribeInstancesRequestw extends StObject {
...
object DescribeInstancesRequestw {
  ...
  inline def apply(): DescribeInstancesRequestw = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeInstancesRequestw]
  }
  
  extension [Self <: DescribeInstancesRequestw](x: Self) {
