...
import typingsJapgolly.awsSdk.clientsCloudformationMod.ChangeSetNameOrId
import typingsJapgolly.awsSdk.clientsCloudformationMod.NextToken
import typingsJapgolly.awsSdk.clientsCloudformationMod.StackNameOrId
...
object DescribeChangeSetInputwai {
  ...
  extension [Self <: DescribeChangeSetInputwai](x: Self) {
