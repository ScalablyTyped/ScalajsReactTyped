...
import typingsJapgolly.awsSdk.clientsMachinelearningMod.ComparatorValue
import typingsJapgolly.awsSdk.clientsMachinelearningMod.EvaluationFilterVariable
import typingsJapgolly.awsSdk.clientsMachinelearningMod.PageLimit
import typingsJapgolly.awsSdk.clientsMachinelearningMod.SortOrder
import typingsJapgolly.awsSdk.clientsMachinelearningMod.StringType
...
trait DescribeEvaluationsInputw extends StObject {
  ...
  /**
    ...
    */
  var SortOrder: js.UndefOr[typingsJapgolly.awsSdk.clientsMachinelearningMod.SortOrder] = js.undefined
}
object DescribeEvaluationsInputw {
  ...
  extension [Self <: DescribeEvaluationsInputw](x: Self) {
