...
import typingsJapgolly.awsSdk.clientsSagemakerMod.NotebookInstanceName
...
trait DescribeNotebookInstanceI extends StObject {
  ...
  /**
    ...
    */
  var NotebookInstanceName: typingsJapgolly.awsSdk.clientsSagemakerMod.NotebookInstanceName
}
