...
object libCredentialsSharedIniFileCredentialsMod {
  ...
  object SharedIniFileCredentialsOptions {
    ...
    extension [Self <: SharedIniFileCredentialsOptions](x: Self) {
      ...
      inline def setCallback(value: /* err */ js.UndefOr[js.Error] => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* err */ js.UndefOr[js.Error]) => value(t0).runNow()))
      ...
      inline def setTokenCodeFn(
        value: (/* mfaSerial */ String, /* callback */ js.Function2[/* err */ js.UndefOr[js.Error], /* token */ js.UndefOr[String], Unit]) => Callback
      ): Self = StObject.set(x, "tokenCodeFn", js.Any.fromFunction2((t0: /* mfaSerial */ String, t1: /* callback */ js.Function2[/* err */ js.UndefOr[js.Error], /* token */ js.UndefOr[String], Unit]) => (value(t0, t1)).runNow()))
