...
trait InstanceGroup extends js.Object {
  ...
  /**
    ...
    */
  var InstanceGroupType: js.UndefOr[typingsJapgolly.awsSdk.emrMod.InstanceGroupType] = js.native
  /**
    * The EC2 instance type for all instances in the instance group.
    */
  var InstanceType: js.UndefOr[typingsJapgolly.awsSdk.emrMod.InstanceType] = js.native
  /**
