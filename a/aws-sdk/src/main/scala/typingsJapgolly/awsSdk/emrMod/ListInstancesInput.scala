...
trait ListInstancesInput extends js.Object {
  ...
  /**
    ...
    */
  var InstanceFleetId: js.UndefOr[typingsJapgolly.awsSdk.emrMod.InstanceFleetId] = js.native
  /**
    * The node type of the instance fleet. For example MASTER, CORE, or TASK.
    */
  var InstanceFleetType: js.UndefOr[typingsJapgolly.awsSdk.emrMod.InstanceFleetType] = js.native
  /**
    * The identifier of the instance group for which to list the instances.
    */
  var InstanceGroupId: js.UndefOr[typingsJapgolly.awsSdk.emrMod.InstanceGroupId] = js.native
  /**
