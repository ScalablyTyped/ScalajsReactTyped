...
trait StartHumanLoopResponse extends js.Object {
  /**
    ...
    */
  var HumanLoopActivationResults: js.UndefOr[typingsJapgolly.awsSdk.augmentedairuntimeMod.HumanLoopActivationResults] = js.native
  /**
    * The Amazon Resource Name (ARN) of the human loop.
    */
  var HumanLoopArn: js.UndefOr[typingsJapgolly.awsSdk.augmentedairuntimeMod.HumanLoopArn] = js.native
}
