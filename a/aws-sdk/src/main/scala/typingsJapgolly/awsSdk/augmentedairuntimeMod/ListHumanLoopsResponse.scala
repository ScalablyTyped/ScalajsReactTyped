...
trait ListHumanLoopsResponse extends js.Object {
  /**
    ...
    */
  var HumanLoopSummaries: typingsJapgolly.awsSdk.augmentedairuntimeMod.HumanLoopSummaries = js.native
  /**
    * A token to resume pagination.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.augmentedairuntimeMod.NextToken] = js.native
}
