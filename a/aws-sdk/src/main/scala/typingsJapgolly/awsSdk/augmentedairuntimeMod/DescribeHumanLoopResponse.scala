...
trait DescribeHumanLoopResponse extends js.Object {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsJapgolly.awsSdk.augmentedairuntimeMod.FlowDefinitionArn = js.native
  /**
    * The Amazon Resource Name (ARN) of the human loop.
    */
  var HumanLoopArn: typingsJapgolly.awsSdk.augmentedairuntimeMod.HumanLoopArn = js.native
  /**
  ...
  /**
    ...
    */
  var HumanLoopStatus: typingsJapgolly.awsSdk.augmentedairuntimeMod.HumanLoopStatus = js.native
}
