...
trait ListHumanLoopsRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.augmentedairuntimeMod.MaxResults] = js.native
  /**
  ...
  /**
    ...
    */
  var SortOrder: js.UndefOr[typingsJapgolly.awsSdk.augmentedairuntimeMod.SortOrder] = js.native
}
