package typingsJapgolly.awsSdk.managedUploadMod.ManagedUpload

import typingsJapgolly.awsSdk.s3Mod.PutObjectRequest
import typingsJapgolly.awsSdk.s3Mod.Tag
...
trait ManagedUploadOptions extends js.Object {
  ...
  /**
    ...
    */
  var service: js.UndefOr[typingsJapgolly.awsSdk.s3Mod.^] = js.native
  /**
...
object ManagedUploadOptions {
  ...
  def apply(
    ...
    service: typingsJapgolly.awsSdk.s3Mod.^ = null,
