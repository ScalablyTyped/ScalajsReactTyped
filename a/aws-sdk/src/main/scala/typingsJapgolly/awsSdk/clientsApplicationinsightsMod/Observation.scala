...
trait Observation extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchEventDetailType: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CloudWatchEventDetailType] = js.undefined
  
  /**
    *  The ID of the CloudWatch Event-based observation related to the detected problem. 
    */
  var CloudWatchEventId: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CloudWatchEventId] = js.undefined
  
  /**
    *  The source of the CloudWatch Event. 
    */
  var CloudWatchEventSource: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CloudWatchEventSource] = js.undefined
  
  /**
    *  The CodeDeploy application to which the deployment belongs. 
    */
  var CodeDeployApplication: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CodeDeployApplication] = js.undefined
  
  /**
    *  The deployment group to which the CodeDeploy deployment belongs. 
    */
  var CodeDeployDeploymentGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CodeDeployDeploymentGroup] = js.undefined
  
  /**
    *  The deployment ID of the CodeDeploy-based observation related to the detected problem. 
    */
  var CodeDeployDeploymentId: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CodeDeployDeploymentId] = js.undefined
  
  /**
    *  The instance group to which the CodeDeploy instance belongs. 
    */
  var CodeDeployInstanceGroupId: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CodeDeployInstanceGroupId] = js.undefined
  
  /**
    *  The status of the CodeDeploy deployment, for example SUCCESS or  FAILURE. 
    */
  var CodeDeployState: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CodeDeployState] = js.undefined
  
  /**
    *  The cause of an EBS CloudWatch event. 
    */
  var EbsCause: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.EbsCause] = js.undefined
  
  /**
    *  The type of EBS CloudWatch event, such as createVolume, deleteVolume or attachVolume. 
    */
  var EbsEvent: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.EbsEvent] = js.undefined
  
  /**
    *  The request ID of an EBS CloudWatch event. 
    */
  var EbsRequestId: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.EbsRequestId] = js.undefined
  
  /**
    *  The result of an EBS CloudWatch event, such as failed or succeeded. 
    */
  var EbsResult: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.EbsResult] = js.undefined
  
  /**
    *  The state of the instance, such as STOPPING or TERMINATING. 
    */
  var Ec2State: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.Ec2State] = js.undefined
  ...
  /**
    ...
    */
  var HealthEventArn: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.HealthEventArn] = js.undefined
  
  /**
    *  The description of the AWS Health event provided by the service, such as Amazon EC2. 
    */
  var HealthEventDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.HealthEventDescription] = js.undefined
  
  /**
    *  The category of the AWS Health event, such as issue. 
    */
  var HealthEventTypeCategory: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.HealthEventTypeCategory] = js.undefined
  
  /**
    *  The type of the AWS Health event, for example, AWS_EC2_POWER_CONNECTIVITY_ISSUE. 
    */
  var HealthEventTypeCode: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.HealthEventTypeCode] = js.undefined
  
  /**
    *  The service to which the AWS Health Event belongs, such as EC2. 
    */
  var HealthService: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.HealthService] = js.undefined
  ...
  /**
    ...
    */
  var LogFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.LogFilter] = js.undefined
  
  /**
    * The log group name.
    */
  var LogGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.LogGroup] = js.undefined
  
  /**
    * The log text of the observation.
    */
  var LogText: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.LogText] = js.undefined
  
  /**
    * The name of the observation metric.
    */
  var MetricName: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.MetricName] = js.undefined
  
  /**
    * The namespace of the observation metric.
    */
  var MetricNamespace: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.MetricNamespace] = js.undefined
  
  /**
    *  The category of an RDS event. 
    */
  var RdsEventCategories: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.RdsEventCategories] = js.undefined
  
  /**
    *  The message of an RDS event. 
    */
  var RdsEventMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.RdsEventMessage] = js.undefined
  
  /**
    *  The name of the S3 CloudWatch Event-based observation. 
    */
  var S3EventName: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.S3EventName] = js.undefined
  
  /**
    * The source resource ARN of the observation.
    */
  var SourceARN: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.SourceARN] = js.undefined
  
  /**
    * The source type of the observation.
    */
  var SourceType: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.SourceType] = js.undefined
  ...
  /**
    ...
    */
  var StatesArn: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.StatesArn] = js.undefined
  
  /**
    *  The Amazon Resource Name (ARN) of the step function execution-based observation. 
    */
  var StatesExecutionArn: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.StatesExecutionArn] = js.undefined
  
  /**
    *  The input to the step function-based observation. 
    */
  var StatesInput: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.StatesInput] = js.undefined
  
  /**
    *  The status of the step function-related observation. 
    */
  var StatesStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.StatesStatus] = js.undefined
  
  /**
    * The unit of the source observation metric.
    */
  var Unit: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.Unit] = js.undefined
  
  /**
    * The value of the source observation metric.
    */
  var Value: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.Value] = js.undefined
  
  /**
    *  The X-Ray request error percentage for this node. 
    */
  var XRayErrorPercent: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.XRayErrorPercent] = js.undefined
  
  /**
    *  The X-Ray request fault percentage for this node. 
    */
  var XRayFaultPercent: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.XRayFaultPercent] = js.undefined
  
  /**
    *  The name of the X-Ray node. 
    */
  var XRayNodeName: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.XRayNodeName] = js.undefined
  
  /**
    *  The type of the X-Ray node. 
    */
  var XRayNodeType: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.XRayNodeType] = js.undefined
  
  /**
    *  The X-Ray node request average latency for this node. 
    */
  var XRayRequestAverageLatency: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.XRayRequestAverageLatency] = js.undefined
  
  /**
    *  The X-Ray request count for this node. 
    */
  var XRayRequestCount: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.XRayRequestCount] = js.undefined
  
  /**
    *  The X-Ray request throttle percentage for this node. 
    */
  var XRayThrottlePercent: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.XRayThrottlePercent] = js.undefined
}
object Observation {
