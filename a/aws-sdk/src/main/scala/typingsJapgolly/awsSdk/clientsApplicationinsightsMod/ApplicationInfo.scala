...
trait ApplicationInfo extends StObject {
  ...
  /**
    ...
    */
  var AutoConfigEnabled: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.AutoConfigEnabled] = js.undefined
  
  /**
    *  Indicates whether Application Insights can listen to CloudWatch events for the application resources, such as instance terminated, failed deployment, and others. 
    */
  var CWEMonitorEnabled: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.CWEMonitorEnabled] = js.undefined
  
  /**
    *  The method used by Application Insights to onboard your resources. 
    */
  var DiscoveryType: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.DiscoveryType] = js.undefined
  
  /**
    * The lifecycle of the application. 
    */
  var LifeCycle: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.LifeCycle] = js.undefined
  
  /**
    *  Indicates whether Application Insights will create opsItems for any problem detected by Application Insights for an application. 
    */
  var OpsCenterEnabled: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.OpsCenterEnabled] = js.undefined
  
  /**
    *  The SNS topic provided to Application Insights that is associated to the created opsItems to receive SNS notifications for opsItem updates. 
    */
  var OpsItemSNSTopicArn: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.OpsItemSNSTopicArn] = js.undefined
  ...
  /**
    ...
    */
  var Remarks: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.Remarks] = js.undefined
