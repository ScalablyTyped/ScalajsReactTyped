...
trait DescribeComponentResponse extends StObject {
  ...
  var ApplicationComponent: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.ApplicationComponent] = js.undefined
  
  /**
    * The list of resource ARNs that belong to the component.
    */
  var ResourceList: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationinsightsMod.ResourceList] = js.undefined
}
