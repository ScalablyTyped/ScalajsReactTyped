...
trait CreateIdentityPoolInput extends StObject {
  ...
  /**
    ...
    */
  var DeveloperProviderName: js.UndefOr[typingsJapgolly.awsSdk.clientsCognitoidentityMod.DeveloperProviderName] = js.undefined
  
  /**
    * A string that you provide.
    */
  var IdentityPoolName: typingsJapgolly.awsSdk.clientsCognitoidentityMod.IdentityPoolName
