...
trait SetPrincipalTagAttributeMapResponse extends StObject {
  ...
  /**
    ...
    */
  var IdentityProviderName: js.UndefOr[typingsJapgolly.awsSdk.clientsCognitoidentityMod.IdentityProviderName] = js.undefined
  ...
  /**
    ...
    */
  var PrincipalTags: js.UndefOr[typingsJapgolly.awsSdk.clientsCognitoidentityMod.PrincipalTags] = js.undefined
  
  /**
    * You can use this operation to select default (username and clientID) attribute mappings.
    */
  var UseDefaults: js.UndefOr[typingsJapgolly.awsSdk.clientsCognitoidentityMod.UseDefaults] = js.undefined
}
