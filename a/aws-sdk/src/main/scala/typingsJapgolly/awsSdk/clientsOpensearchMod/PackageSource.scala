...
trait PackageSource extends StObject {
  ...
  /**
    ...
    */
  var S3BucketName: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.S3BucketName] = js.undefined
  
  /**
    * Key (file name) of the package.
    */
  var S3Key: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.S3Key] = js.undefined
}
