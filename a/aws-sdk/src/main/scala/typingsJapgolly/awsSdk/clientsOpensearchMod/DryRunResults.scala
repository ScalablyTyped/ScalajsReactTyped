...
trait DryRunResults extends StObject {
  ...
  /**
    ...
    */
  var DeploymentType: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.DeploymentType] = js.undefined
  
  /**
    * Contains an optional message associated with the DryRunResults.
    */
  var Message: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.Message] = js.undefined
}
