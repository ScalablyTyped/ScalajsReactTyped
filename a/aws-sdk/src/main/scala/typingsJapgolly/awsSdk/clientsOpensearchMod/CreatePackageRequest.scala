...
trait CreatePackageRequest extends StObject {
  ...
  /**
    ...
    */
  var PackageName: typingsJapgolly.awsSdk.clientsOpensearchMod.PackageName
  
  /**
    * The Amazon S3 location from which to import the package. 
    */
  var PackageSource: typingsJapgolly.awsSdk.clientsOpensearchMod.PackageSource
  
  /**
    * Type of package. Currently supports only TXT-DICTIONARY.
    */
  var PackageType: typingsJapgolly.awsSdk.clientsOpensearchMod.PackageType
}
