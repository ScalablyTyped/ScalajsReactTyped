...
trait CognitoOptions extends StObject {
  ...
  /**
    ...
    */
  var IdentityPoolId: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.IdentityPoolId] = js.undefined
  
  /**
    * The role ARN that provides OpenSearch permissions for accessing Cognito resources.
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.RoleArn] = js.undefined
  
  /**
    * The Cognito user pool ID for OpenSearch Dashboards authentication.
    */
  var UserPoolId: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.UserPoolId] = js.undefined
}
