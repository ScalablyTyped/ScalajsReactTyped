...
trait CreateDomainRequest extends StObject {
  ...
  /**
    ...
    */
  var ClusterConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.ClusterConfig] = js.undefined
  ...
  /**
    ...
    */
  var TagList: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.TagList] = js.undefined
  
  /**
    * Options to specify the subnets and security groups for a VPC endpoint. For more information, see Launching your Amazon OpenSearch Service domains using a VPC . 
    */
  var VPCOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.VPCOptions] = js.undefined
}
