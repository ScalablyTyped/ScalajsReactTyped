...
trait PackageDetails extends StObject {
  ...
  /**
    ...
    */
  var ErrorDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.ErrorDetails] = js.undefined
  ...
  /**
    ...
    */
  var PackageDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.PackageDescription] = js.undefined
  ...
  /**
    ...
    */
  var PackageName: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.PackageName] = js.undefined
  
  /**
    * Current state of the package. Values are COPYING, COPY_FAILED, AVAILABLE, DELETING, and DELETE_FAILED.
    */
  var PackageStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.PackageStatus] = js.undefined
  
  /**
    * Currently supports only TXT-DICTIONARY.
    */
  var PackageType: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.PackageType] = js.undefined
}
