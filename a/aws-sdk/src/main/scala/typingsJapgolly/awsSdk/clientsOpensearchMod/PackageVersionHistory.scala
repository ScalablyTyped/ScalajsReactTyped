...
trait PackageVersionHistory extends StObject {
  ...
  /**
    ...
    */
  var CommitMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.CommitMessage] = js.undefined
  ...
  /**
    * The package version.
    */
  var PackageVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.PackageVersion] = js.undefined
}
