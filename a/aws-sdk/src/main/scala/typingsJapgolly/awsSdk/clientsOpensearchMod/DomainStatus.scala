...
trait DomainStatus extends StObject {
  ...
  /**
    ...
    */
  var ARN: typingsJapgolly.awsSdk.clientsOpensearchMod.ARN
  ...
  /**
    ...
    */
  var AdvancedOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.AdvancedOptions] = js.undefined
  
  /**
    * The current status of the domain's advanced security options.
    */
  var AdvancedSecurityOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.AdvancedSecurityOptions] = js.undefined
  ...
  /**
    ...
    */
  var ChangeProgressDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.ChangeProgressDetails] = js.undefined
  
  /**
    * The type and number of instances in the domain.
    */
  var ClusterConfig: typingsJapgolly.awsSdk.clientsOpensearchMod.ClusterConfig
  ...
  /**
    ...
    */
  var CognitoOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.CognitoOptions] = js.undefined
  ...
  /**
    ...
    */
  var DomainEndpointOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.DomainEndpointOptions] = js.undefined
  
  /**
    * The unique identifier for the specified domain.
    */
  var DomainId: typingsJapgolly.awsSdk.clientsOpensearchMod.DomainId
  ...
  /**
    ...
    */
  var EBSOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.EBSOptions] = js.undefined
  
  /**
    * The status of the EncryptionAtRestOptions. 
    */
  var EncryptionAtRestOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.EncryptionAtRestOptions] = js.undefined
  ...
  /**
    ...
    */
  var LogPublishingOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.LogPublishingOptions] = js.undefined
  
  /**
    * The status of the NodeToNodeEncryptionOptions. 
    */
  var NodeToNodeEncryptionOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.NodeToNodeEncryptionOptions] = js.undefined
  ...
  /**
    ...
    */
  var ServiceSoftwareOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.ServiceSoftwareOptions] = js.undefined
  
  /**
    * The status of the SnapshotOptions. 
    */
  var SnapshotOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.SnapshotOptions] = js.undefined
