...
trait CreateOutboundConnectionResponse extends StObject {
  ...
  /**
    ...
    */
  var ConnectionAlias: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.ConnectionAlias] = js.undefined
  
  /**
    * The unique ID for the created outbound connection, which is used for subsequent operations on the connection.
    */
  var ConnectionId: js.UndefOr[typingsJapgolly.awsSdk.clientsOpensearchMod.ConnectionId] = js.undefined
