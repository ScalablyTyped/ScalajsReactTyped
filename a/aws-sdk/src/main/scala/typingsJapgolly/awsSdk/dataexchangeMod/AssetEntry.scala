...
trait AssetEntry extends js.Object {
  /**
    ...
    */
  var Arn: typingsJapgolly.awsSdk.dataexchangeMod.Arn = js.native
  /**
    * Information about the asset, including its size.
    */
  var AssetDetails: typingsJapgolly.awsSdk.dataexchangeMod.AssetDetails = js.native
  /**
    * The type of file your data is stored in. Currently, the supported asset type is S3_SNAPSHOT.
    */
  var AssetType: typingsJapgolly.awsSdk.dataexchangeMod.AssetType = js.native
  /**
  ...
  /**
    ...
    */
  var Id: typingsJapgolly.awsSdk.dataexchangeMod.Id = js.native
  /**
