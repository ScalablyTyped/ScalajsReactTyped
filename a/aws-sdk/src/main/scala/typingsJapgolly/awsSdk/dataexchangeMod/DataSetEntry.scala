...
trait DataSetEntry extends js.Object {
  ...
  /**
    ...
    */
  var Description: typingsJapgolly.awsSdk.dataexchangeMod.Description = js.native
  /**
  ...
  /**
    ...
    */
  var Name: typingsJapgolly.awsSdk.dataexchangeMod.Name = js.native
  /**
    * A property that defines the data set as OWNED by the account (for providers) or ENTITLED to the account (for subscribers).
    */
  var Origin: typingsJapgolly.awsSdk.dataexchangeMod.Origin = js.native
  /**
