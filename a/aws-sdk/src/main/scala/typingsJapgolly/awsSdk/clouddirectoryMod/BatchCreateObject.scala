...
trait BatchCreateObject extends js.Object {
  /**
    ...
    */
  var BatchReferenceName: js.UndefOr[typingsJapgolly.awsSdk.clouddirectoryMod.BatchReferenceName] = js.native
  /**
    * The name of the link.
    */
  var LinkName: js.UndefOr[typingsJapgolly.awsSdk.clouddirectoryMod.LinkName] = js.native
  /**
