...
trait AdBreak extends StObject {
  ...
  /**
    ...
    */
  var MessageType: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.MessageType] = js.undefined
  ...
  /**
    ...
    */
  var SpliceInsertMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.SpliceInsertMessage] = js.undefined
}
object AdBreak {
