...
trait ResponseOutputItem extends StObject {
  ...
  /**
    ...
    */
  var DashPlaylistSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.DashPlaylistSettings] = js.undefined
  
  /**
    * HLS manifest configuration settings.
    */
  var HlsPlaylistSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.HlsPlaylistSettings] = js.undefined
