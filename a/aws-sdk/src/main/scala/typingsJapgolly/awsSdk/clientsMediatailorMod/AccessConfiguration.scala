...
trait AccessConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AccessType: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.AccessType] = js.undefined
  
  /**
    * AWS Secrets Manager access token configuration parameters.
    */
  var SecretsManagerAccessTokenConfiguration: js.UndefOr[
    typingsJapgolly.awsSdk.clientsMediatailorMod.SecretsManagerAccessTokenConfiguration
  ] = js.undefined
}
