...
trait PlaybackConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AvailSuppression: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.AvailSuppression] = js.undefined
  
  /**
    * The configuration for bumpers. Bumpers are short audio or video clips that play at the start or before the end of an ad break. To learn more about bumpers, see Bumpers.
    */
  var Bumper: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.Bumper] = js.undefined
  
  /**
    * The configuration for using a content delivery network (CDN), like Amazon CloudFront, for content and ad segment management.
    */
  var CdnConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.CdnConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var DashConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.DashConfiguration] = js.undefined
  
  /**
    * The configuration for HLS content.
    */
  var HlsConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.HlsConfiguration] = js.undefined
  
  /**
    * The configuration for pre-roll ad insertion.
    */
  var LivePreRollConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.LivePreRollConfiguration] = js.undefined
  
  /**
    * The Amazon CloudWatch log settings for a playback configuration.
    */
  var LogConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.LogConfiguration] = js.undefined
  
  /**
    * The configuration for manifest processing rules. Manifest processing rules enable customization of the personalized manifests created by MediaTailor.
    */
  var ManifestProcessingRules: js.UndefOr[typingsJapgolly.awsSdk.clientsMediatailorMod.ManifestProcessingRules] = js.undefined
