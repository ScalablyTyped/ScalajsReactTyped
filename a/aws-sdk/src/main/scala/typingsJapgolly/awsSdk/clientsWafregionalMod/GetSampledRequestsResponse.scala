...
trait GetSampledRequestsResponse extends StObject {
  ...
  /**
    ...
    */
  var PopulationSize: js.UndefOr[typingsJapgolly.awsSdk.clientsWafregionalMod.PopulationSize] = js.undefined
  ...
  /**
    ...
    */
  var TimeWindow: js.UndefOr[typingsJapgolly.awsSdk.clientsWafregionalMod.TimeWindow] = js.undefined
}
