...
trait HTTPRequest extends StObject {
  ...
  /**
    ...
    */
  var Country: js.UndefOr[typingsJapgolly.awsSdk.clientsWafregionalMod.Country] = js.undefined
  
  /**
    * The HTTP version specified in the sampled web request, for example, HTTP/1.1.
    */
  var HTTPVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsWafregionalMod.HTTPVersion] = js.undefined
