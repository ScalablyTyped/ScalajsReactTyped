...
trait CreateWebACLMigrationStackRequest extends StObject {
  ...
  /**
    ...
    */
  var IgnoreUnsupportedType: typingsJapgolly.awsSdk.clientsWafregionalMod.IgnoreUnsupportedType
  ...
  /**
    ...
    */
  var S3BucketName: typingsJapgolly.awsSdk.clientsWafregionalMod.S3BucketName
