...
trait LoggingConfiguration extends StObject {
  ...
  /**
    ...
    */
  var LogDestinationConfigs: typingsJapgolly.awsSdk.clientsWafregionalMod.LogDestinationConfigs
  
  /**
    * The parts of the request that you want redacted from the logs. For example, if you redact the cookie field, the cookie field in the firehose will be xxx. 
    */
  var RedactedFields: js.UndefOr[typingsJapgolly.awsSdk.clientsWafregionalMod.RedactedFields] = js.undefined
