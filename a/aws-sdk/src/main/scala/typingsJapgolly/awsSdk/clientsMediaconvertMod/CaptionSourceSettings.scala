...
trait CaptionSourceSettings extends StObject {
  ...
  /**
    ...
    */
  var AncillarySourceSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.AncillarySourceSettings] = js.undefined
  
  /**
    * DVB Sub Source Settings
    */
  var DvbSubSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.DvbSubSourceSettings] = js.undefined
  
  /**
    * Settings for embedded captions Source
    */
  var EmbeddedSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.EmbeddedSourceSettings] = js.undefined
  
  /**
    * If your input captions are SCC, SMI, SRT, STL, TTML, WebVTT, or IMSC 1.1 in an xml file, specify the URI of the input caption source file. If your caption source is IMSC in an IMF package, use TrackSourceSettings instead of FileSoureSettings.
    */
  var FileSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.FileSourceSettings] = js.undefined
  ...
  /**
    ...
    */
  var TeletextSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.TeletextSourceSettings] = js.undefined
  
  /**
    * Settings specific to caption sources that are specified by track number. Currently, this is only IMSC captions in an IMF package. If your caption source is IMSC 1.1 in a separate xml file, use FileSourceSettings instead of TrackSourceSettings.
    */
  var TrackSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.TrackSourceSettings] = js.undefined
  
  /**
    * Settings specific to WebVTT sources in HLS alternative rendition group. Specify the properties (renditionGroupId, renditionName or renditionLanguageCode) to identify the unique subtitle track among the alternative rendition groups present in the HLS manifest. If no unique track is found, or multiple tracks match the specified properties, the job fails. If there is only one subtitle track in the rendition group, the settings can be left empty and the default subtitle track will be chosen. If your caption source is a sidecar file, use FileSourceSettings instead of WebvttHlsSourceSettings.
    */
  var WebvttHlsSourceSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.WebvttHlsSourceSettings] = js.undefined
}
