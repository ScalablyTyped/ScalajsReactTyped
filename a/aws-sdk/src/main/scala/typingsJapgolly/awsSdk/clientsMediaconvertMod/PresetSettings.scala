...
trait PresetSettings extends StObject {
  ...
  /**
    ...
    */
  var ContainerSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.ContainerSettings] = js.undefined
  
  /**
    * VideoDescription contains a group of video encoding settings. The specific video settings depend on the video codec that you choose for the property codec. Include one instance of VideoDescription per output.
    */
  var VideoDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.VideoDescription] = js.undefined
}
