...
trait EmbeddedSourceSettings extends StObject {
  ...
  /**
    ...
    */
  var Source608TrackNumber: js.UndefOr[integerMin1Max1] = js.undefined
...
object EmbeddedSourceSettings {
  ...
  extension [Self <: EmbeddedSourceSettings](x: Self) {
    ...
    inline def setSource608TrackNumber(value: integerMin1Max1): Self = StObject.set(x, "Source608TrackNumber", value.asInstanceOf[js.Any])
    
    inline def setSource608TrackNumberUndefined: Self = StObject.set(x, "Source608TrackNumber", js.undefined)
    
    inline def setTerminateCaptions(value: EmbeddedTerminateCaptions): Self = StObject.set(x, "TerminateCaptions", value.asInstanceOf[js.Any])
