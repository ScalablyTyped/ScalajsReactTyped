...
trait CreateJobRequest extends StObject {
  ...
  /**
    ...
    */
  var AccelerationSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.AccelerationSettings] = js.undefined
  
  /**
    * Optional. Choose a tag type that AWS Billing and Cost Management will use to sort your AWS Elemental MediaConvert costs on any billing report that you set up. Any transcoding outputs that don't have an associated tag will appear in your billing report unsorted. If you don't choose a valid value for this field, your job outputs will appear on the billing report unsorted.
    */
  var BillingTagsSource: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.BillingTagsSource] = js.undefined
  ...
  /**
    ...
    */
  var SimulateReservedQueue: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.SimulateReservedQueue] = js.undefined
  
  /**
    * Optional. Specify how often MediaConvert sends STATUS_UPDATE events to Amazon CloudWatch Events. Set the interval, in seconds, between status updates. MediaConvert sends an update at this interval from the time the service begins processing your job to the time it completes the transcode or encounters an error.
    */
  var StatusUpdateInterval: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.StatusUpdateInterval] = js.undefined
