...
trait JobSettings extends StObject {
  ...
  /**
    ...
    */
  var AvailBlanking: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.AvailBlanking] = js.undefined
  ...
  /**
    ...
    */
  var ExtendedDataServices: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.ExtendedDataServices] = js.undefined
  ...
  /**
    ...
    */
  var MotionImageInserter: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.MotionImageInserter] = js.undefined
  
  /**
    * Settings for your Nielsen configuration. If you don't do Nielsen measurement and analytics, ignore these settings. When you enable Nielsen configuration (nielsenConfiguration), MediaConvert enables PCM to ID3 tagging for all outputs in the job. To enable Nielsen configuration programmatically, include an instance of nielsenConfiguration in your JSON job specification. Even if you don't include any children of nielsenConfiguration, you still enable the setting.
    */
  var NielsenConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.NielsenConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var TimecodeConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.TimecodeConfig] = js.undefined
  ...
  /**
    ...
    */
  var TimedMetadataInsertion: js.UndefOr[typingsJapgolly.awsSdk.clientsMediaconvertMod.TimedMetadataInsertion] = js.undefined
}
object JobSettings {
