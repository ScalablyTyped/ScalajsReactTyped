...
trait TranscriptionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var EngineTranscribeMedicalSettings: js.UndefOr[
    typingsJapgolly.awsSdk.clientsChimesdkmeetingsMod.EngineTranscribeMedicalSettings
  ] = js.undefined
  
  /**
    * The transcription configuration settings passed to Amazon Transcribe.
    */
  var EngineTranscribeSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsChimesdkmeetingsMod.EngineTranscribeSettings] = js.undefined
}
