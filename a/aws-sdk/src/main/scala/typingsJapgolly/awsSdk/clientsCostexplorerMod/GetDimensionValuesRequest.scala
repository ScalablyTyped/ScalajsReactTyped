...
trait GetDimensionValuesRequest extends StObject {
  ...
  /**
    ...
    */
  var Context: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.Context] = js.undefined
  ...
  /**
    ...
    */
  var Dimension: typingsJapgolly.awsSdk.clientsCostexplorerMod.Dimension
