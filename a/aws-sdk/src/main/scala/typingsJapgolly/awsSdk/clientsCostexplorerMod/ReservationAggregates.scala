...
trait ReservationAggregates extends StObject {
  ...
  /**
    ...
    */
  var AmortizedRecurringFee: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.AmortizedRecurringFee] = js.undefined
  
  /**
    * The upfront cost of your reservation. It's amortized over the reservation period.
    */
  var AmortizedUpfrontFee: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.AmortizedUpfrontFee] = js.undefined
  ...
  /**
    ...
    */
  var NetRISavings: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.NetRISavings] = js.undefined
  
  /**
    * How much your reservation costs if charged On-Demand rates.
    */
  var OnDemandCostOfRIHoursUsed: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.OnDemandCostOfRIHoursUsed] = js.undefined
  
  /**
    * How many reservation hours that you purchased.
    */
  var PurchasedHours: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.PurchasedHours] = js.undefined
  ...
  /**
    ...
    */
  var PurchasedUnits: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.PurchasedUnits] = js.undefined
  
  /**
    * The cost of unused hours for your reservation.
    */
  var RICostForUnusedHours: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.RICostForUnusedHours] = js.undefined
  
  /**
    * The realized savings because of purchasing and using a reservation.
    */
  var RealizedSavings: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.RealizedSavings] = js.undefined
  
  /**
    * The total number of reservation hours that you used.
    */
  var TotalActualHours: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.TotalActualHours] = js.undefined
  ...
  /**
    ...
    */
  var TotalActualUnits: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.TotalActualUnits] = js.undefined
  
  /**
    * The total cost of your reservation. It's amortized over the reservation period.
    */
  var TotalAmortizedFee: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.TotalAmortizedFee] = js.undefined
  
  /**
    * How much you might save if you use your entire reservation.
    */
  var TotalPotentialRISavings: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.TotalPotentialRISavings] = js.undefined
  
  /**
    * The unrealized savings because of purchasing and using a reservation.
    */
  var UnrealizedSavings: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.UnrealizedSavings] = js.undefined
  
  /**
    * The number of reservation hours that you didn't use.
    */
  var UnusedHours: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.UnusedHours] = js.undefined
  ...
  /**
    ...
    */
  var UnusedUnits: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.UnusedUnits] = js.undefined
  
  /**
    * The percentage of reservation time that you used.
    */
  var UtilizationPercentage: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.UtilizationPercentage] = js.undefined
  ...
  /**
    ...
    */
  var UtilizationPercentageInUnits: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.UtilizationPercentageInUnits] = js.undefined
}
