...
trait GetCostAndUsageWithResourcesResponse extends StObject {
  ...
  /**
    ...
    */
  var GroupDefinitions: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.GroupDefinitions] = js.undefined
  ...
  /**
    ...
    */
  var ResultsByTime: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.ResultsByTime] = js.undefined
}
