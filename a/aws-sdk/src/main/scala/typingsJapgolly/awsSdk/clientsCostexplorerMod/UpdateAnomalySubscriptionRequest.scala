...
trait UpdateAnomalySubscriptionRequest extends StObject {
  ...
  /**
    ...
    */
  var MonitorArnList: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.MonitorArnList] = js.undefined
  
  /**
    * The update to the subscriber list. 
    */
  var Subscribers: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.Subscribers] = js.undefined
