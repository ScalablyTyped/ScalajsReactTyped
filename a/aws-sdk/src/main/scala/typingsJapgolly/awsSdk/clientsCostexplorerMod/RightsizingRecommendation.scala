...
trait RightsizingRecommendation extends StObject {
  ...
  /**
    ...
    */
  var CurrentInstance: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.CurrentInstance] = js.undefined
  
  /**
    * The list of possible reasons why the recommendation is generated, such as under- or over-utilization of specific metrics (for example, CPU, Memory, Network). 
    */
  var FindingReasonCodes: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.FindingReasonCodes] = js.undefined
  
  /**
    * The details for the modification recommendations. 
    */
  var ModifyRecommendationDetail: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.ModifyRecommendationDetail] = js.undefined
  
  /**
    * A recommendation to either terminate or modify the resource.
    */
  var RightsizingType: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.RightsizingType] = js.undefined
  
  /**
    * The details for termination recommendations.
    */
  var TerminateRecommendationDetail: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.TerminateRecommendationDetail] = js.undefined
}
