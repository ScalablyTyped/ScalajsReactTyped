...
trait CoverageHours extends StObject {
  ...
  /**
    ...
    */
  var CoverageHoursPercentage: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.CoverageHoursPercentage] = js.undefined
  
  /**
    * The number of instance running hours that On-Demand Instances covered.
    */
  var OnDemandHours: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.OnDemandHours] = js.undefined
  
  /**
    * The number of instance running hours that reservations covered.
    */
  var ReservedHours: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.ReservedHours] = js.undefined
  
  /**
    * The total instance usage, in hours.
    */
  var TotalRunningHours: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.TotalRunningHours] = js.undefined
}
