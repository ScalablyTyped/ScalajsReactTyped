...
trait EC2ResourceUtilization extends StObject {
  ...
  /**
    ...
    */
  var DiskResourceUtilization: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.DiskResourceUtilization] = js.undefined
  
  /**
    * The EBS field that contains a list of EBS metrics that are associated with the current instance. 
    */
  var EBSResourceUtilization: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.EBSResourceUtilization] = js.undefined
  ...
  /**
    ...
    */
  var NetworkResourceUtilization: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.NetworkResourceUtilization] = js.undefined
}
