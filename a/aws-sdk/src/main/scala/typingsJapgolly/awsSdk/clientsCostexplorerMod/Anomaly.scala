...
trait Anomaly extends StObject {
  ...
  /**
    ...
    */
  var AnomalyScore: typingsJapgolly.awsSdk.clientsCostexplorerMod.AnomalyScore
  ...
  /**
    ...
    */
  var Impact: typingsJapgolly.awsSdk.clientsCostexplorerMod.Impact
  ...
  /**
    ...
    */
  var RootCauses: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.RootCauses] = js.undefined
}
object Anomaly {
