...
trait CoverageNormalizedUnits extends StObject {
  ...
  /**
    ...
    */
  var CoverageNormalizedUnitsPercentage: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.CoverageNormalizedUnitsPercentage] = js.undefined
  
  /**
    * The number of normalized units that are covered by On-Demand Instances instead of a reservation.
    */
  var OnDemandNormalizedUnits: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.OnDemandNormalizedUnits] = js.undefined
  
  /**
    * The number of normalized units that a reservation covers.
    */
  var ReservedNormalizedUnits: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.ReservedNormalizedUnits] = js.undefined
  
  /**
    * The total number of normalized units that you used.
    */
  var TotalRunningNormalizedUnits: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.TotalRunningNormalizedUnits] = js.undefined
}
