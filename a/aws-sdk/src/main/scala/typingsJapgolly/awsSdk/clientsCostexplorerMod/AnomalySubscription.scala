...
trait AnomalySubscription extends StObject {
  ...
  /**
    ...
    */
  var MonitorArnList: typingsJapgolly.awsSdk.clientsCostexplorerMod.MonitorArnList
  
  /**
    * A list of subscribers to notify. 
    */
  var Subscribers: typingsJapgolly.awsSdk.clientsCostexplorerMod.Subscribers
