...
trait GetSavingsPlansPurchaseRecommendationRequest extends StObject {
  ...
  /**
    ...
    */
  var AccountScope: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.AccountScope] = js.undefined
  ...
  /**
    ...
    */
  var LookbackPeriodInDays: typingsJapgolly.awsSdk.clientsCostexplorerMod.LookbackPeriodInDays
  ...
  /**
    ...
    */
  var PaymentOption: typingsJapgolly.awsSdk.clientsCostexplorerMod.PaymentOption
  ...
  /**
    ...
    */
  var TermInYears: typingsJapgolly.awsSdk.clientsCostexplorerMod.TermInYears
}
