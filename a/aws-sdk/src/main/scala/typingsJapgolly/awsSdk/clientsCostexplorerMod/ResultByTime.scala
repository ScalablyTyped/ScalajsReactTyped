...
trait ResultByTime extends StObject {
  ...
  /**
    ...
    */
  var Estimated: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.Estimated] = js.undefined
  
  /**
    * The groups that this time period includes.
    */
  var Groups: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.Groups] = js.undefined
