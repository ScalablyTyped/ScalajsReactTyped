...
trait ReservationPurchaseRecommendation extends StObject {
  ...
  /**
    ...
    */
  var LookbackPeriodInDays: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.LookbackPeriodInDays] = js.undefined
  
  /**
    * The payment option for the reservation (for example, AllUpfront or NoUpfront).
    */
  var PaymentOption: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.PaymentOption] = js.undefined
  ...
  /**
    ...
    */
  var ServiceSpecification: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.ServiceSpecification] = js.undefined
  
  /**
    * The term of the reservation that you want recommendations for, in years.
    */
  var TermInYears: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.TermInYears] = js.undefined
}
