...
trait AnomalyMonitor extends StObject {
  ...
  /**
    ...
    */
  var MonitorDimension: js.UndefOr[typingsJapgolly.awsSdk.clientsCostexplorerMod.MonitorDimension] = js.undefined
  ...
  /**
    ...
    */
  var MonitorType: typingsJapgolly.awsSdk.clientsCostexplorerMod.MonitorType
}
