...
trait CreateCertificateAuthorityRequest extends StObject {
  ...
  /**
    ...
    */
  var CertificateAuthorityConfiguration: typingsJapgolly.awsSdk.clientsAcmpcaMod.CertificateAuthorityConfiguration
  
  /**
    * The type of the certificate authority.
    */
  var CertificateAuthorityType: typingsJapgolly.awsSdk.clientsAcmpcaMod.CertificateAuthorityType
  ...
  /**
    ...
    */
  var IdempotencyToken: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.IdempotencyToken] = js.undefined
  ...
  /**
    ...
    */
  var KeyStorageSecurityStandard: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.KeyStorageSecurityStandard] = js.undefined
