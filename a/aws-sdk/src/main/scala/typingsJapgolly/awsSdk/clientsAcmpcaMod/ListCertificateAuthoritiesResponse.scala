...
trait ListCertificateAuthoritiesResponse extends StObject {
  ...
  /**
    ...
    */
  var CertificateAuthorities: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.CertificateAuthorities] = js.undefined
  
  /**
    * When the list is truncated, this value is present and should be used for the NextToken parameter in a subsequent pagination request.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.NextToken] = js.undefined
}
