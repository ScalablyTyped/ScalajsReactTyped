...
trait IssueCertificateRequest extends StObject {
  ...
  /**
    ...
    */
  var ApiPassthrough: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.ApiPassthrough] = js.undefined
  ...
  /**
    ...
    */
  var Validity: typingsJapgolly.awsSdk.clientsAcmpcaMod.Validity
