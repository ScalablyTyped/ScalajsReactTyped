...
trait AccessMethod extends StObject {
  ...
  /**
    ...
    */
  var AccessMethodType: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.AccessMethodType] = js.undefined
  ...
  /**
    ...
    */
  var CustomObjectIdentifier: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.CustomObjectIdentifier] = js.undefined
}
object AccessMethod {
