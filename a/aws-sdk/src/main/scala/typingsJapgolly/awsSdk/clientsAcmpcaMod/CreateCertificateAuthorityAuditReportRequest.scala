...
trait CreateCertificateAuthorityAuditReportRequest extends StObject {
  ...
  /**
    ...
    */
  var AuditReportResponseFormat: typingsJapgolly.awsSdk.clientsAcmpcaMod.AuditReportResponseFormat
  ...
  /**
    ...
    */
  var S3BucketName: typingsJapgolly.awsSdk.clientsAcmpcaMod.S3BucketName
}
