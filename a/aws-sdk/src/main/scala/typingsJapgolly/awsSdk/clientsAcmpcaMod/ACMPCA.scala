...
import typingsJapgolly.awsSdk.anon.DescribeCertificateAuthor
import typingsJapgolly.awsSdk.anon.GetCertificateAuthorityCs
import typingsJapgolly.awsSdk.anon.GetCertificateRequestwait
import typingsJapgolly.awsSdk.awsSdkStrings.auditReportCreated
import typingsJapgolly.awsSdk.awsSdkStrings.certificateAuthorityCSRCreated
import typingsJapgolly.awsSdk.awsSdkStrings.certificateIssued
...
trait ACMPCA extends Service {
  ...
  @JSName("config")
  var config_ACMPCA: ConfigBase & ClientConfiguration = js.native
