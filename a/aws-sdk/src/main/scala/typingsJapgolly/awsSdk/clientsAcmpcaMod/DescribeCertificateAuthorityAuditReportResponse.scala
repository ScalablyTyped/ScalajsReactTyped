...
trait DescribeCertificateAuthorityAuditReportResponse extends StObject {
  ...
  /**
    ...
    */
  var AuditReportStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.AuditReportStatus] = js.undefined
  ...
  /**
    ...
    */
  var S3BucketName: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.S3BucketName] = js.undefined
  
  /**
    * S3 key that uniquely identifies the report file in your S3 bucket.
    */
  var S3Key: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.S3Key] = js.undefined
}
