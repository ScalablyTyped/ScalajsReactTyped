...
trait CertificateAuthorityConfiguration extends StObject {
  ...
  /**
    ...
    */
  var CsrExtensions: js.UndefOr[typingsJapgolly.awsSdk.clientsAcmpcaMod.CsrExtensions] = js.undefined
  
  /**
    * Type of the public key algorithm and size, in bits, of the key pair that your CA creates when it issues a certificate. When you create a subordinate CA, you must use a key algorithm supported by the parent CA.
    */
  var KeyAlgorithm: typingsJapgolly.awsSdk.clientsAcmpcaMod.KeyAlgorithm
  ...
  /**
    ...
    */
  var SigningAlgorithm: typingsJapgolly.awsSdk.clientsAcmpcaMod.SigningAlgorithm
