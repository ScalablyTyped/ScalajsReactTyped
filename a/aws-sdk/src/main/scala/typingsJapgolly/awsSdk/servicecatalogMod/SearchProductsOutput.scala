...
trait SearchProductsOutput extends js.Object {
  ...
  /**
    ...
    */
  var ProductViewAggregations: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProductViewAggregations] = js.native
  /**
    * Information about the product views.
    */
  var ProductViewSummaries: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProductViewSummaries] = js.native
}
