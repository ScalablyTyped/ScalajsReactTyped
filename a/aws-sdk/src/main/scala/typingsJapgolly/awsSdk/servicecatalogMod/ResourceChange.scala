...
trait ResourceChange extends js.Object {
  ...
  /**
    ...
    */
  var LogicalResourceId: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.LogicalResourceId] = js.native
  /**
    * The ID of the resource, if it was already created.
    */
  var PhysicalResourceId: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.PhysicalResourceId] = js.native
  /**
    * If the change type is Modify, indicates whether the existing resource is deleted and replaced with a new one.
    */
  var Replacement: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.Replacement] = js.native
  /**
  ...
  /**
    * The change scope.
    */
  var Scope: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.Scope] = js.native
}
