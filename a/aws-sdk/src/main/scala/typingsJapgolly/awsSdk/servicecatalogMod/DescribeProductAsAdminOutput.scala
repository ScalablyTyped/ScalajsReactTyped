...
trait DescribeProductAsAdminOutput extends js.Object {
  ...
  /**
    ...
    */
  var ProductViewDetail: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProductViewDetail] = js.native
  /**
    * Information about the provisioning artifacts (also known as versions) for the specified product.
    */
  var ProvisioningArtifactSummaries: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisioningArtifactSummaries] = js.native
  /**
