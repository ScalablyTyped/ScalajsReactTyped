...
trait Principal extends js.Object {
  /**
    ...
    */
  var PrincipalARN: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.PrincipalARN] = js.native
  /**
    * The principal type. The supported value is IAM.
    */
  var PrincipalType: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.PrincipalType] = js.native
}
