...
trait ProvisionedProductPlanDetails extends js.Object {
  ...
  /**
    ...
    */
  var NotificationArns: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.NotificationArns] = js.native
  /**
  ...
  /**
    * The status message.
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.StatusMessage] = js.native
  /**
    * One or more tags.
    */
