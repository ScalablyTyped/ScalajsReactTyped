...
trait DescribePortfolioShareStatusOutput extends js.Object {
  /**
    ...
    */
  var OrganizationNodeValue: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.OrganizationNodeValue] = js.native
  /**
  ...
  /**
    ...
    */
  var ShareDetails: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ShareDetails] = js.native
  /**
