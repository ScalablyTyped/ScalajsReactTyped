...
trait RecordDetail extends js.Object {
  ...
  /**
    ...
    */
  var ProvisionedProductName: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisionedProductName] = js.native
  /**
    * The type of provisioned product. The supported values are CFN_STACK and CFN_STACKSET.
    */
  var ProvisionedProductType: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisionedProductType] = js.native
  /**
  ...
  /**
    ...
    */
  var RecordErrors: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.RecordErrors] = js.native
  /**
  ...
  /**
    * One or more tags.
    */
  var RecordTags: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.RecordTags] = js.native
  /**
    * The record type.    PROVISION_PRODUCT     UPDATE_PROVISIONED_PRODUCT     TERMINATE_PROVISIONED_PRODUCT   
    */
  var RecordType: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.RecordType] = js.native
  /**
