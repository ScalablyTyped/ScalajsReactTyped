...
trait ProvisioningArtifactParameter extends js.Object {
  /**
    * The default value.
    */
  var DefaultValue: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.DefaultValue] = js.native
  /**
    * The description of the parameter.
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.Description] = js.native
  /**
  ...
  /**
    ...
    */
  var ParameterConstraints: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ParameterConstraints] = js.native
  /**
    * The parameter key.
    */
  var ParameterKey: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ParameterKey] = js.native
  /**
    * The parameter type.
    */
  var ParameterType: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ParameterType] = js.native
}
