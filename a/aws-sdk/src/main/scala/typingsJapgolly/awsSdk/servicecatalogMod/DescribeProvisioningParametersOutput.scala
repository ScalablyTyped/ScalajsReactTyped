...
trait DescribeProvisioningParametersOutput extends js.Object {
  ...
  /**
    ...
    */
  var ProvisioningArtifactParameters: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisioningArtifactParameters] = js.native
  /**
    * An object that contains information about preferences, such as regions and accounts, for the provisioning artifact.
    */
  var ProvisioningArtifactPreferences: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisioningArtifactPreferences] = js.native
  /**
  ...
  /**
    ...
    */
  var UsageInstructions: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.UsageInstructions] = js.native
}
