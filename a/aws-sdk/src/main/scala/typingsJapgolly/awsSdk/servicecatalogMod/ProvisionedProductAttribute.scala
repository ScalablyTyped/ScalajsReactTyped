...
trait ProvisionedProductAttribute extends js.Object {
  ...
  /**
    ...
    */
  var Id: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.Id] = js.native
  /**
    * A unique identifier that you provide to ensure idempotency. If multiple requests differ only by the idempotency token, the same response is returned for each repeated request.
    */
  var IdempotencyToken: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.IdempotencyToken] = js.native
  /**
  ...
  /**
    ...
    */
  var PhysicalId: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.PhysicalId] = js.native
  /**
  ...
  /**
    ...
    */
  var UserArn: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.UserArn] = js.native
  /**
    * The ARN of the IAM user in the session. This ARN might contain a session ID.
    */
  var UserArnSession: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.UserArnSession] = js.native
}
