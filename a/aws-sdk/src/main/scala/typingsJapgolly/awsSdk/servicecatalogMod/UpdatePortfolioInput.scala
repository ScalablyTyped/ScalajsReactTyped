...
trait UpdatePortfolioInput extends js.Object {
  ...
  /**
    * The tags to add.
    */
  var AddTags: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.AddTags] = js.native
  /**
  ...
  /**
    ...
    */
  var ProviderName: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProviderName] = js.native
  /**
    * The tags to remove.
    */
