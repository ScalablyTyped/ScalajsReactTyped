...
trait StackInstance extends js.Object {
  ...
  /**
    ...
    */
  var Region: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.Region] = js.native
  /**
    ...
    */
  var StackInstanceStatus: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.StackInstanceStatus] = js.native
}
