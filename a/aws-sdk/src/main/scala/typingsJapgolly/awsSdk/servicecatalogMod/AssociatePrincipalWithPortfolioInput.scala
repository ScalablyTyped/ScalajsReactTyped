...
trait AssociatePrincipalWithPortfolioInput extends js.Object {
  ...
  /**
    ...
    */
  var PrincipalARN: typingsJapgolly.awsSdk.servicecatalogMod.PrincipalARN = js.native
  /**
    * The principal type. The supported value is IAM.
    */
  var PrincipalType: typingsJapgolly.awsSdk.servicecatalogMod.PrincipalType = js.native
}
