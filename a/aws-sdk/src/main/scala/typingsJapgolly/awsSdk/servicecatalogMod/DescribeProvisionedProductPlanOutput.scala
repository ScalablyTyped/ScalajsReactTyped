...
trait DescribeProvisionedProductPlanOutput extends js.Object {
  ...
  /**
    ...
    */
  var ProvisionedProductPlanDetails: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisionedProductPlanDetails] = js.native
  /**
    * Information about the resource changes that will occur when the plan is executed.
    */
  var ResourceChanges: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ResourceChanges] = js.native
}
