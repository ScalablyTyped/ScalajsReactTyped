...
trait ProvisionProductInput extends js.Object {
  ...
  /**
    ...
    */
  var ProvisionedProductName: typingsJapgolly.awsSdk.servicecatalogMod.ProvisionedProductName = js.native
  /**
  ...
  /**
    ...
    */
  var ProvisioningParameters: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisioningParameters] = js.native
  /**
    * An object that contains information about the provisioning preferences for a stack set.
    */
  var ProvisioningPreferences: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisioningPreferences] = js.native
  /**
    * One or more tags.
    */
