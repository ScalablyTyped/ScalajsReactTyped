...
trait ShareDetails extends js.Object {
  /**
    * List of errors.
    */
  var ShareErrors: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ShareErrors] = js.native
  /**
    * List of accounts for whom the operation succeeded.
    */
  var SuccessfulShares: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.SuccessfulShares] = js.native
}
