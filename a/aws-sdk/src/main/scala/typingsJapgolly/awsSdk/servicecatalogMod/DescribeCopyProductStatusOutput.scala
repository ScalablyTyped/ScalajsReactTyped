...
trait DescribeCopyProductStatusOutput extends js.Object {
  /**
    ...
    */
  var CopyProductStatus: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.CopyProductStatus] = js.native
  /**
    * The status message.
    */
  var StatusDetail: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.StatusDetail] = js.native
  /**
