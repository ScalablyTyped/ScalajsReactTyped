...
trait RecordOutput extends js.Object {
  ...
  /**
    * The output key.
    */
  var OutputKey: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.OutputKey] = js.native
  /**
    * The output value.
    */
  var OutputValue: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.OutputValue] = js.native
}
