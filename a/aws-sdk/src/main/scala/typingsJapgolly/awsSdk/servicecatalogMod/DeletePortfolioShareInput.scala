...
trait DeletePortfolioShareInput extends js.Object {
  ...
  /**
    * The AWS account ID.
    */
  var AccountId: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.AccountId] = js.native
  /**
    * The organization node to whom you are going to stop sharing.
    */
  var OrganizationNode: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.OrganizationNode] = js.native
  /**
