...
trait DescribeProvisionedProductOutput extends js.Object {
  /**
    ...
    */
  var CloudWatchDashboards: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.CloudWatchDashboards] = js.native
  /**
    * Information about the provisioned product.
    */
  var ProvisionedProductDetail: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.ProvisionedProductDetail] = js.native
}
