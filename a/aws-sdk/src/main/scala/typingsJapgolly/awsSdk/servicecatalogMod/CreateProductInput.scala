...
trait CreateProductInput extends js.Object {
  ...
  /**
    * The type of product.
    */
  var ProductType: typingsJapgolly.awsSdk.servicecatalogMod.ProductType = js.native
  /**
  ...
  /**
    ...
    */
  var SupportDescription: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.SupportDescription] = js.native
  /**
    * The contact email for product support.
    */
  var SupportEmail: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.SupportEmail] = js.native
  /**
    * The contact URL for product support.
    */
  var SupportUrl: js.UndefOr[typingsJapgolly.awsSdk.servicecatalogMod.SupportUrl] = js.native
  /**
    * One or more tags.
    */
