...
trait BillingRecord extends StObject {
  ...
  /**
    ...
    */
  var DomainName: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53domainsMod.DomainName] = js.undefined
  
  /**
    * The ID of the invoice that is associated with the billing record.
    */
  var InvoiceId: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53domainsMod.InvoiceId] = js.undefined
  ...
  /**
    ...
    */
  var Price: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53domainsMod.Price] = js.undefined
}
