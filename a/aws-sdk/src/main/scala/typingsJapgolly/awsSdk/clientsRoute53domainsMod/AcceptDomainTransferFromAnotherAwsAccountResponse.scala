...
trait AcceptDomainTransferFromAnotherAwsAccountResponse extends StObject {
  ...
  /**
    ...
    */
  var OperationId: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53domainsMod.OperationId] = js.undefined
}
object AcceptDomainTransferFromAnotherAwsAccountResponse {
  ...
  extension [Self <: AcceptDomainTransferFromAnotherAwsAccountResponse](x: Self) {
