...
trait RetentionPeriod extends StObject {
  ...
  /**
    ...
    */
  var RetentionPeriodUnit: typingsJapgolly.awsSdk.clientsRbinMod.RetentionPeriodUnit
  
  /**
    * The period value for which the retention rule is to retain resources. The period is measured using the unit specified for RetentionPeriodUnit.
    */
  var RetentionPeriodValue: typingsJapgolly.awsSdk.clientsRbinMod.RetentionPeriodValue
}
