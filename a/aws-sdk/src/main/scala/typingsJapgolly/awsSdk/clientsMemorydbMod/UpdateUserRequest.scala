...
trait UpdateUserRequest extends StObject {
  ...
  /**
    ...
    */
  var AccessString: js.UndefOr[typingsJapgolly.awsSdk.clientsMemorydbMod.AccessString] = js.undefined
  
  /**
    * Denotes the user's authentication properties, such as whether it requires a password to authenticate.
    */
  var AuthenticationMode: js.UndefOr[typingsJapgolly.awsSdk.clientsMemorydbMod.AuthenticationMode] = js.undefined
