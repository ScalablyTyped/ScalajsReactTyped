...
trait CreateUserRequest extends StObject {
  ...
  /**
    ...
    */
  var AccessString: typingsJapgolly.awsSdk.clientsMemorydbMod.AccessString
  
  /**
    * Denotes the user's authentication properties, such as whether it requires a password to authenticate.
    */
  var AuthenticationMode: typingsJapgolly.awsSdk.clientsMemorydbMod.AuthenticationMode
