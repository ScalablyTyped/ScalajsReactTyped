...
trait CopySnapshotRequest extends StObject {
  ...
  /**
    ...
    */
  var KmsKeyId: js.UndefOr[typingsJapgolly.awsSdk.clientsMemorydbMod.KmsKeyId] = js.undefined
  ...
  /**
    ...
    */
  var TargetBucket: js.UndefOr[typingsJapgolly.awsSdk.clientsMemorydbMod.TargetBucket] = js.undefined
