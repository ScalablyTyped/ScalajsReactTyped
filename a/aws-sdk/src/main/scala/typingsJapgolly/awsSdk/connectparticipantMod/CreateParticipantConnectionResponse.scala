...
trait CreateParticipantConnectionResponse extends js.Object {
  /**
    ...
    */
  var ConnectionCredentials: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.ConnectionCredentials] = js.native
  /**
    * Creates the participant's websocket connection.
    */
  var Websocket: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.Websocket] = js.native
}
