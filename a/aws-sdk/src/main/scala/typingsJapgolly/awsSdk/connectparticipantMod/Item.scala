...
trait Item extends js.Object {
  ...
  /**
    ...
    */
  var DisplayName: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.DisplayName] = js.native
  /**
    * The ID of the item.
    */
  ...
  /**
    ...
    */
  var ParticipantId: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.ParticipantId] = js.native
  /**
    * The role of the sender. For example, is it a customer, agent, or system.
    */
  var ParticipantRole: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.ParticipantRole] = js.native
  /**
