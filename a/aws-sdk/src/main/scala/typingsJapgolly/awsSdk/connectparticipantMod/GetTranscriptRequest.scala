...
trait GetTranscriptRequest extends js.Object {
  ...
  /**
    ...
    */
  var ContactId: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.ContactId] = js.native
  /**
    * The maximum number of results to return in the page. Default: 10. 
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.MaxResults] = js.native
  /**
    * The pagination token. Use the value returned previously in the next subsequent request to retrieve the next set of results.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.NextToken] = js.native
  /**
    * The direction from StartPosition from which to retrieve message. Default: BACKWARD when no StartPosition is provided, FORWARD with StartPosition. 
    */
  var ScanDirection: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.ScanDirection] = js.native
  /**
  ...
  /**
    ...
    */
  var StartPosition: js.UndefOr[typingsJapgolly.awsSdk.connectparticipantMod.StartPosition] = js.native
}
