...
trait RotateChannelCredentialsResponse extends StObject {
  ...
  var EgressAccessLogs: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackageMod.EgressAccessLogs] = js.undefined
  
  var HlsIngest: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackageMod.HlsIngest] = js.undefined
  ...
  var IngressAccessLogs: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackageMod.IngressAccessLogs] = js.undefined
...
object RotateChannelCredentialsResponse {
  ...
  inline def apply(): RotateChannelCredentialsResponse = {
