...
trait EncryptionContractConfiguration extends StObject {
  ...
  /**
    ...
    */
  var PresetSpeke20Audio: typingsJapgolly.awsSdk.clientsMediapackageMod.PresetSpeke20Audio
  
  /**
    * A collection of video encryption presets.
    */
  var PresetSpeke20Video: typingsJapgolly.awsSdk.clientsMediapackageMod.PresetSpeke20Video
}
