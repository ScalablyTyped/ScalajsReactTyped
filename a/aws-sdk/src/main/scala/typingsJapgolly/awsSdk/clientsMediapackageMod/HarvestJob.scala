...
trait HarvestJob extends StObject {
  ...
  var S3Destination: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackageMod.S3Destination] = js.undefined
  ...
  include an explanation of why the HarvestJob failed.
    */
  var Status: js.UndefOr[typingsJapgolly.awsSdk.clientsMediapackageMod.Status] = js.undefined
}
object HarvestJob {
  
  inline def apply(): HarvestJob = {
