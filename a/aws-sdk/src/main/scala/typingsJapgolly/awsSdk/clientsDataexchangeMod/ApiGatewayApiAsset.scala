...
trait ApiGatewayApiAsset extends StObject {
  ...
  /**
    ...
    */
  var ApiDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsDataexchangeMod.ApiDescription] = js.undefined
  ...
  /**
    ...
    */
  var ProtocolType: js.UndefOr[typingsJapgolly.awsSdk.clientsDataexchangeMod.ProtocolType] = js.undefined
