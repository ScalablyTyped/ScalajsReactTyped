...
trait GetJobResponse extends StObject {
  ...
  /**
    ...
    */
  var State: js.UndefOr[typingsJapgolly.awsSdk.clientsDataexchangeMod.State] = js.undefined
  
  /**
    * The job type.
    */
  var Type: js.UndefOr[typingsJapgolly.awsSdk.clientsDataexchangeMod.Type] = js.undefined
