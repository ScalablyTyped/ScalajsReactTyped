...
trait AssetDetails extends StObject {
  ...
  /**
    ...
    */
  var ApiGatewayApiAsset: js.UndefOr[typingsJapgolly.awsSdk.clientsDataexchangeMod.ApiGatewayApiAsset] = js.undefined
  
  /**
    * The Amazon Redshift datashare that is the asset.
    */
  var RedshiftDataShareAsset: js.UndefOr[typingsJapgolly.awsSdk.clientsDataexchangeMod.RedshiftDataShareAsset] = js.undefined
  
  /**
    * The S3 object that is the asset.
    */
  var S3SnapshotAsset: js.UndefOr[typingsJapgolly.awsSdk.clientsDataexchangeMod.S3SnapshotAsset] = js.undefined
}
object AssetDetails {
