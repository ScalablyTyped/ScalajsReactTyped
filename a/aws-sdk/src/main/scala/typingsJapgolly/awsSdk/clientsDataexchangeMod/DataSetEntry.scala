...
trait DataSetEntry extends StObject {
  ...
  /**
    ...
    */
  var Description: typingsJapgolly.awsSdk.clientsDataexchangeMod.Description
  ...
  /**
    ...
    */
  var Name: typingsJapgolly.awsSdk.clientsDataexchangeMod.Name
  
  /**
    * A property that defines the data set as OWNED by the account (for providers) or ENTITLED to the account (for subscribers).
    */
  var Origin: typingsJapgolly.awsSdk.clientsDataexchangeMod.Origin
