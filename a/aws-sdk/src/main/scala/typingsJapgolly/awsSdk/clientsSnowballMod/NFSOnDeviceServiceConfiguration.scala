...
trait NFSOnDeviceServiceConfiguration extends StObject {
  ...
  /**
    ...
    */
  var StorageLimit: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.StorageLimit] = js.undefined
  
  /**
    * The scale unit of the NFS storage on the device. Valid values: TB.
    */
  var StorageUnit: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.StorageUnit] = js.undefined
}
