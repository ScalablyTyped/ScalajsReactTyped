...
trait JobMetadata extends StObject {
  ...
  /**
    ...
    */
  var AddressId: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.AddressId] = js.undefined
  ...
  var DeviceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.DeviceConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var JobState: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.JobState] = js.undefined
  
  /**
    * The type of job.
    */
  var JobType: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.JobType] = js.undefined
  ...
  /**
    ...
    */
  var KmsKeyARN: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.KmsKeyARN] = js.undefined
  
  /**
    * The ID of the long-term pricing type for the device.
    */
  var LongTermPricingId: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.LongTermPricingId] = js.undefined
  
  /**
    * The Amazon Simple Notification Service (Amazon SNS) notification settings associated with a specific job. The Notification object is returned as a part of the response syntax of the DescribeJob action in the JobMetadata data type.
    */
  var Notification: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.Notification] = js.undefined
  
  /**
    * Represents metadata and configuration settings for services on an Amazon Web Services Snow Family device.
    */
  var OnDeviceServiceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.OnDeviceServiceConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var RemoteManagement: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.RemoteManagement] = js.undefined
  ...
  /**
    ...
    */
  var RoleARN: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.RoleARN] = js.undefined
  
  /**
    * A job's shipping information, including inbound and outbound tracking numbers and shipping speed options.
    */
  var ShippingDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.ShippingDetails] = js.undefined
  ...
  /**
    ...
    */
  var SnowballType: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.SnowballType] = js.undefined
  
  /**
    * The metadata associated with the tax documents required in your Amazon Web Services Region.
    */
  var TaxDocuments: js.UndefOr[typingsJapgolly.awsSdk.clientsSnowballMod.TaxDocuments] = js.undefined
}
object JobMetadata {
