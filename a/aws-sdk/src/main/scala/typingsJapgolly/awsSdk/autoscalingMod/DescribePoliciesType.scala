...
trait DescribePoliciesType extends js.Object {
  ...
  /**
    ...
    */
  var PolicyNames: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.PolicyNames] = js.native
  /**
    * One or more policy types. The valid values are SimpleScaling, StepScaling, and TargetTrackingScaling.
    */
  var PolicyTypes: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.PolicyTypes] = js.native
}
