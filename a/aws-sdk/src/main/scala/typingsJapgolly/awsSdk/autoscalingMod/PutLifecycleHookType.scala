...
trait PutLifecycleHookType extends js.Object {
  ...
  /**
    ...
    */
  var HeartbeatTimeout: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.HeartbeatTimeout] = js.native
  /**
  ...
  /**
    ...
    */
  var LifecycleTransition: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.LifecycleTransition] = js.native
  /**
