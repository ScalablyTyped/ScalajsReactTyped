...
trait SetInstanceProtectionQuery extends js.Object {
  ...
  /**
    ...
    */
  var InstanceIds: typingsJapgolly.awsSdk.autoscalingMod.InstanceIds = js.native
  /**
    * Indicates whether the instance is protected from termination by Amazon EC2 Auto Scaling when scaling in.
    */
  var ProtectedFromScaleIn: typingsJapgolly.awsSdk.autoscalingMod.ProtectedFromScaleIn = js.native
}
