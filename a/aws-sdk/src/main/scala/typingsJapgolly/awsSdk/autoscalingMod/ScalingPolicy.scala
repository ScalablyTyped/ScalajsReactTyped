...
trait ScalingPolicy extends js.Object {
  ...
  /**
    ...
    */
  var Alarms: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.Alarms] = js.native
  /**
  ...
  /**
    ...
    */
  var Cooldown: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.Cooldown] = js.native
  /**
    * The estimated time, in seconds, until a newly launched instance can contribute to the CloudWatch metrics.
    */
  var EstimatedInstanceWarmup: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.EstimatedInstanceWarmup] = js.native
  /**
  ...
  /**
    ...
    */
  var MinAdjustmentMagnitude: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.MinAdjustmentMagnitude] = js.native
  /**
    * Available for backward compatibility. Use MinAdjustmentMagnitude instead.
    */
  var MinAdjustmentStep: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.MinAdjustmentStep] = js.native
  /**
  ...
  /**
    ...
    */
  var StepAdjustments: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.StepAdjustments] = js.native
  /**
    * A target tracking scaling policy.
    */
  var TargetTrackingConfiguration: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.TargetTrackingConfiguration] = js.native
}
