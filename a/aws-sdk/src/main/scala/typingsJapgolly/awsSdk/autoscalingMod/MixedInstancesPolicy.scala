...
trait MixedInstancesPolicy extends js.Object {
  /**
    ...
    */
  var InstancesDistribution: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.InstancesDistribution] = js.native
  /**
    * The launch template and instance types (overrides). This parameter must be specified when creating a mixed instances policy.
    */
  var LaunchTemplate: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.LaunchTemplate] = js.native
}
