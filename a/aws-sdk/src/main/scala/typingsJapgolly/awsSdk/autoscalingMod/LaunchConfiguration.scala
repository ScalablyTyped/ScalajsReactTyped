...
trait LaunchConfiguration extends js.Object {
  /**
    ...
    */
  var AssociatePublicIpAddress: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.AssociatePublicIpAddress] = js.native
  /**
    ...
    */
  var BlockDeviceMappings: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.BlockDeviceMappings] = js.native
  /**
  ...
  /**
    ...
    */
  var ClassicLinkVPCSecurityGroups: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.ClassicLinkVPCSecurityGroups] = js.native
  /**
  ...
  /**
    ...
    */
  var EbsOptimized: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.EbsOptimized] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceMonitoring: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.InstanceMonitoring] = js.native
  /**
  ...
  /**
    ...
    */
  var SecurityGroups: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.SecurityGroups] = js.native
  /**
    ...
    */
  var SpotPrice: js.UndefOr[typingsJapgolly.awsSdk.autoscalingMod.SpotPrice] = js.native
  /**
