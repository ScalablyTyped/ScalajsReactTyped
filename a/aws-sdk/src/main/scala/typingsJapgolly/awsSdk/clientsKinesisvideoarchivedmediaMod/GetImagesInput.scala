...
trait GetImagesInput extends StObject {
  ...
  /**
    ...
    */
  var Format: typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.Format
  
  /**
    * The list of a key-value pair structure that contains extra parameters that can be applied when the image is generated. The FormatConfig key is the JPEGQuality, which indicates the JPEG quality key to be used to generate the image. The FormatConfig value accepts ints from 1 to 100. If the value is 1, the image will be generated with less quality and the best compression. If the value is 100, the image will be generated with the best quality and less compression. If no value is provided, the default value of the JPEGQuality key will be set to 80.
    */
  var FormatConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.FormatConfig] = js.undefined
  
  /**
    * The height of the output image that is used in conjunction with the WidthPixels parameter. When both HeightPixels and WidthPixels parameters are provided, the image will be stretched to fit the specified aspect ratio. If only the HeightPixels parameter is provided, its original aspect ratio will be used to calculate the WidthPixels ratio. If neither parameter is provided, the original image size will be returned.
    */
  var HeightPixels: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.HeightPixels] = js.undefined
  
  /**
    * The origin of the Server or Producer timestamps to use to generate the images.
    */
  var ImageSelectorType: typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.ImageSelectorType
  ...
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.NextToken] = js.undefined
  ...
  /**
    ...
    */
  var SamplingInterval: typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.SamplingInterval
  ...
  /**
    ...
    */
  var StreamName: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.StreamName] = js.undefined
  ...
  /**
    ...
    */
  var WidthPixels: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.WidthPixels] = js.undefined
}
