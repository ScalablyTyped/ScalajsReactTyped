...
trait GetDASHStreamingSessionURLInput extends StObject {
  ...
  /**
    ...
    */
  var DASHFragmentSelector: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.DASHFragmentSelector] = js.undefined
  ...
  /**
    ...
    */
  var Expires: js.UndefOr[typingsJapgolly.awsSdk.clientsKinesisvideoarchivedmediaMod.Expires] = js.undefined
  ...
  /**
    ...
    */
  var MaxManifestFragmentResults: js.UndefOr[DASHMaxResults] = js.undefined
...
object GetDASHStreamingSessionURLInput {
  ...
  extension [Self <: GetDASHStreamingSessionURLInput](x: Self) {
    ...
    inline def setMaxManifestFragmentResults(value: DASHMaxResults): Self = StObject.set(x, "MaxManifestFragmentResults", value.asInstanceOf[js.Any])
