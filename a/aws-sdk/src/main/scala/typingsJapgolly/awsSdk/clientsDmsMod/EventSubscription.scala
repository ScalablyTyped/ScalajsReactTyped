...
trait EventSubscription extends StObject {
  ...
  /**
    ...
    */
  var EventCategoriesList: js.UndefOr[typingsJapgolly.awsSdk.clientsDmsMod.EventCategoriesList] = js.undefined
  ...
  /**
    ...
    */
  var SourceIdsList: js.UndefOr[typingsJapgolly.awsSdk.clientsDmsMod.SourceIdsList] = js.undefined
