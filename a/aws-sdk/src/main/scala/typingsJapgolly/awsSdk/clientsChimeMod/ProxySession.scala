...
trait ProxySession extends StObject {
  ...
  /**
    ...
    */
  var GeoMatchLevel: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.GeoMatchLevel] = js.undefined
  
  /**
    * The country and area code for the proxy phone number.
    */
  var GeoMatchParams: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.GeoMatchParams] = js.undefined
  ...
  /**
    ...
    */
  var NumberSelectionBehavior: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.NumberSelectionBehavior] = js.undefined
  
  /**
    * The proxy session participants.
    */
  var Participants: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.Participants] = js.undefined
