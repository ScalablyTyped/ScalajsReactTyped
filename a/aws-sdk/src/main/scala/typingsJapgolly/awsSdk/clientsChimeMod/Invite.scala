...
trait Invite extends StObject {
  ...
  /**
    ...
    */
  var EmailAddress: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.EmailAddress] = js.undefined
  
  /**
    * The status of the invite email.
    */
  var EmailStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.EmailStatus] = js.undefined
