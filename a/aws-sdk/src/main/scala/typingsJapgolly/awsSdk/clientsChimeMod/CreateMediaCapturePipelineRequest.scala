...
trait CreateMediaCapturePipelineRequest extends StObject {
  ...
  /**
    ...
    */
  var ChimeSdkMeetingConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.ChimeSdkMeetingConfiguration] = js.undefined
  
  /**
    * The token assigned to the client making the pipeline request.
    */
  var ClientRequestToken: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.ClientRequestToken] = js.undefined
