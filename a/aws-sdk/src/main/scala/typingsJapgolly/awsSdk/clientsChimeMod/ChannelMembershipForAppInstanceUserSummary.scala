...
trait ChannelMembershipForAppInstanceUserSummary extends StObject {
  ...
  var AppInstanceUserMembershipSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.AppInstanceUserMembershipSummary] = js.undefined
  
  var ChannelSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.ChannelSummary] = js.undefined
}
