...
trait TranscriptionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var EngineTranscribeMedicalSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.EngineTranscribeMedicalSettings] = js.undefined
  
  /**
    * The transcription configuration settings passed to Amazon Transcribe.
    */
  var EngineTranscribeSettings: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.EngineTranscribeSettings] = js.undefined
}
