...
trait ChimeSdkMeetingConfiguration extends StObject {
  ...
  /**
    ...
    */
  var ArtifactsConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.ArtifactsConfiguration] = js.undefined
  
  /**
    * The source configuration for a specified media capture pipline.
    */
  var SourceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsChimeMod.SourceConfiguration] = js.undefined
}
