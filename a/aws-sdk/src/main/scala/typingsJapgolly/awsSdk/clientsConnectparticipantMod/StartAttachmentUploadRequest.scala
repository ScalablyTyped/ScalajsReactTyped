...
trait StartAttachmentUploadRequest extends StObject {
  ...
  /**
    ...
    */
  var AttachmentName: typingsJapgolly.awsSdk.clientsConnectparticipantMod.AttachmentName
  
  /**
    * The size of the attachment in bytes.
    */
  var AttachmentSizeInBytes: typingsJapgolly.awsSdk.clientsConnectparticipantMod.AttachmentSizeInBytes
  ...
  /**
    ...
    */
  var ContentType: typingsJapgolly.awsSdk.clientsConnectparticipantMod.ContentType
}
