...
trait AttachmentItem extends StObject {
  ...
  /**
    ...
    */
  var AttachmentName: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectparticipantMod.AttachmentName] = js.undefined
  
  /**
    * Describes the MIME file type of the attachment. For a list of supported file types, see Feature specifications in the Amazon Connect Administrator Guide.
    */
  var ContentType: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectparticipantMod.ContentType] = js.undefined
