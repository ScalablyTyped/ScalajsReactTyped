...
trait GetTranscriptRequest extends StObject {
  ...
  /**
    ...
    */
  var ContactId: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectparticipantMod.ContactId] = js.undefined
  
  /**
    * The maximum number of results to return in the page. Default: 10. 
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectparticipantMod.MaxResults] = js.undefined
  
  /**
    * The pagination token. Use the value returned previously in the next subsequent request to retrieve the next set of results.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectparticipantMod.NextToken] = js.undefined
  
  /**
    * The direction from StartPosition from which to retrieve message. Default: BACKWARD when no StartPosition is provided, FORWARD with StartPosition. 
    */
  var ScanDirection: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectparticipantMod.ScanDirection] = js.undefined
  ...
  /**
    ...
    */
  var StartPosition: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectparticipantMod.StartPosition] = js.undefined
}
