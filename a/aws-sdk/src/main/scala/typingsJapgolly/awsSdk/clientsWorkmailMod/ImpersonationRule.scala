...
trait ImpersonationRule extends StObject {
  ...
  /**
    ...
    */
  var ImpersonationRuleId: typingsJapgolly.awsSdk.clientsWorkmailMod.ImpersonationRuleId
  ...
  /**
    ...
    */
  var TargetUsers: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkmailMod.TargetUsers] = js.undefined
}
