...
trait CreateOrganizationRequest extends StObject {
  ...
  /**
    ...
    */
  var DirectoryId: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkmailMod.DirectoryId] = js.undefined
  
  /**
    * The email domains to associate with the organization.
    */
  var Domains: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkmailMod.Domains] = js.undefined
