...
trait GetAccessControlEffectRequest extends StObject {
  ...
  /**
    ...
    */
  var ImpersonationRoleId: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkmailMod.ImpersonationRoleId] = js.undefined
  
  /**
    * The IPv4 address.
    */
  var IpAddress: typingsJapgolly.awsSdk.clientsWorkmailMod.IpAddress
