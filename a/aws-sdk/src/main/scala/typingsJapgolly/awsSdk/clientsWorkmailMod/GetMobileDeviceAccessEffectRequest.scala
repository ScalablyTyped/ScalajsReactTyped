...
trait GetMobileDeviceAccessEffectRequest extends StObject {
  ...
  /**
    ...
    */
  var DeviceModel: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkmailMod.DeviceModel] = js.undefined
  
  /**
    * Device operating system the simulated user will report.
    */
  var DeviceOperatingSystem: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkmailMod.DeviceOperatingSystem] = js.undefined
  
  /**
    * Device type the simulated user will report.
    */
  var DeviceType: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkmailMod.DeviceType] = js.undefined
  
  /**
    * Device user agent the simulated user will report.
    */
  var DeviceUserAgent: js.UndefOr[typingsJapgolly.awsSdk.clientsWorkmailMod.DeviceUserAgent] = js.undefined
