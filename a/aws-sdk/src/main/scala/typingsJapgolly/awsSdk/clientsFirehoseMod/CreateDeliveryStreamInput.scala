...
trait CreateDeliveryStreamInput extends StObject {
  ...
  var AmazonopensearchserviceDestinationConfiguration: js.UndefOr[
    typingsJapgolly.awsSdk.clientsFirehoseMod.AmazonopensearchserviceDestinationConfiguration
  ] = js.undefined
  ...
  /**
    ...
    */
  var ElasticsearchDestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.ElasticsearchDestinationConfiguration] = js.undefined
  
  /**
    * The destination in Amazon S3. You can specify only one destination.
    */
  var ExtendedS3DestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.ExtendedS3DestinationConfiguration] = js.undefined
  
  /**
    * Enables configuring Kinesis Firehose to deliver data to any HTTP endpoint destination. You can specify only one destination.
    */
  var HttpEndpointDestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.HttpEndpointDestinationConfiguration] = js.undefined
  
  /**
    * When a Kinesis data stream is used as the source for the delivery stream, a KinesisStreamSourceConfiguration containing the Kinesis data stream Amazon Resource Name (ARN) and the role ARN for the source stream.
    */
  var KinesisStreamSourceConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.KinesisStreamSourceConfiguration] = js.undefined
  
  /**
    * The destination in Amazon Redshift. You can specify only one destination.
    */
  var RedshiftDestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.RedshiftDestinationConfiguration] = js.undefined
  
  /**
    * [Deprecated] The destination in Amazon S3. You can specify only one destination.
    */
  var S3DestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.S3DestinationConfiguration] = js.undefined
  
  /**
    * The destination in Splunk. You can specify only one destination.
    */
  var SplunkDestinationConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.SplunkDestinationConfiguration] = js.undefined
