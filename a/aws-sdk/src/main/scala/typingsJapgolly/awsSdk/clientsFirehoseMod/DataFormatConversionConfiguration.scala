...
trait DataFormatConversionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var InputFormatConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.InputFormatConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var OutputFormatConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.OutputFormatConfiguration] = js.undefined
  
  /**
    * Specifies the AWS Glue Data Catalog table that contains the column information. This parameter is required if Enabled is set to true.
    */
  var SchemaConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.SchemaConfiguration] = js.undefined
}
