...
trait CloudWatchLoggingOptions extends StObject {
  ...
  /**
    ...
    */
  var LogGroupName: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.LogGroupName] = js.undefined
  
  /**
    * The CloudWatch log stream name for logging. This value is required if CloudWatch logging is enabled.
    */
  var LogStreamName: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.LogStreamName] = js.undefined
}
