...
trait EncryptionConfiguration extends StObject {
  ...
  /**
    * The encryption key.
    */
  var KMSEncryptionConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.KMSEncryptionConfig] = js.undefined
  
  /**
    * Specifically override existing encryption information to ensure that no encryption is used.
    */
  var NoEncryptionConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.NoEncryptionConfig] = js.undefined
}
