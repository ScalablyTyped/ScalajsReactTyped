...
trait ExtendedS3DestinationDescription extends StObject {
  ...
  /**
    ...
    */
  var BucketARN: typingsJapgolly.awsSdk.clientsFirehoseMod.BucketARN
  
  /**
    * The buffering option.
    */
  var BufferingHints: typingsJapgolly.awsSdk.clientsFirehoseMod.BufferingHints
  ...
  /**
    ...
    */
  var CompressionFormat: typingsJapgolly.awsSdk.clientsFirehoseMod.CompressionFormat
  
  /**
    * The serializer, deserializer, and schema for converting data from the JSON format to the Parquet or ORC format before writing it to Amazon S3.
    */
  var DataFormatConversionConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.DataFormatConversionConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var DynamicPartitioningConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.DynamicPartitioningConfiguration] = js.undefined
  
  /**
    * The encryption configuration. If no value is specified, the default is no encryption.
    */
  var EncryptionConfiguration: typingsJapgolly.awsSdk.clientsFirehoseMod.EncryptionConfiguration
  ...
  /**
    ...
    */
  var S3BackupMode: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.S3BackupMode] = js.undefined
}
