...
trait RedshiftDestinationUpdate extends StObject {
  ...
  /**
    ...
    */
  var ClusterJDBCURL: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.ClusterJDBCURL] = js.undefined
  
  /**
    * The COPY command.
    */
  var CopyCommand: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.CopyCommand] = js.undefined
  
  /**
    * The user password.
    */
  var Password: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.Password] = js.undefined
  ...
  /**
    ...
    */
  var Username: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.Username] = js.undefined
}
