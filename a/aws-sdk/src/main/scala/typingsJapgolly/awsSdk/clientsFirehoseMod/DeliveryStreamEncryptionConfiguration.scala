...
trait DeliveryStreamEncryptionConfiguration extends StObject {
  ...
  /**
    ...
    */
  var FailureDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.FailureDescription] = js.undefined
  ...
  /**
    ...
    */
  var KeyType: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.KeyType] = js.undefined
