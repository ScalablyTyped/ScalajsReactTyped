...
trait UpdateDestinationInput extends StObject {
  ...
  var AmazonopensearchserviceDestinationUpdate: js.UndefOr[
    typingsJapgolly.awsSdk.clientsFirehoseMod.AmazonopensearchserviceDestinationUpdate
  ] = js.undefined
  ...
  /**
    ...
    */
  var ElasticsearchDestinationUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.ElasticsearchDestinationUpdate] = js.undefined
  
  /**
    * Describes an update for a destination in Amazon S3.
    */
  var ExtendedS3DestinationUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.ExtendedS3DestinationUpdate] = js.undefined
  
  /**
    * Describes an update to the specified HTTP endpoint destination.
    */
  var HttpEndpointDestinationUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.HttpEndpointDestinationUpdate] = js.undefined
  
  /**
    * Describes an update for a destination in Amazon Redshift.
    */
  var RedshiftDestinationUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.RedshiftDestinationUpdate] = js.undefined
  
  /**
    * [Deprecated] Describes an update for a destination in Amazon S3.
    */
  var S3DestinationUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.S3DestinationUpdate] = js.undefined
  
  /**
    * Describes an update for a destination in Splunk.
    */
  var SplunkDestinationUpdate: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.SplunkDestinationUpdate] = js.undefined
}
