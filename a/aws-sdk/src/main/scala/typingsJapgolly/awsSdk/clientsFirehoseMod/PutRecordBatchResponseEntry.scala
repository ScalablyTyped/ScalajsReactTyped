...
trait PutRecordBatchResponseEntry extends StObject {
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.ErrorCode] = js.undefined
  
  /**
    * The error message for an individual record result.
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.ErrorMessage] = js.undefined
