...
trait SplunkDestinationConfiguration extends StObject {
  ...
  /**
    ...
    */
  var HECEndpoint: typingsJapgolly.awsSdk.clientsFirehoseMod.HECEndpoint
  
  /**
    * This type can be either "Raw" or "Event."
    */
  var HECEndpointType: typingsJapgolly.awsSdk.clientsFirehoseMod.HECEndpointType
  
  /**
    * This is a GUID that you obtain from your Splunk cluster when you create a new HEC endpoint.
    */
  var HECToken: typingsJapgolly.awsSdk.clientsFirehoseMod.HECToken
