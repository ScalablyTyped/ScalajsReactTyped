...
trait Serializer extends StObject {
  ...
  /**
    ...
    */
  var OrcSerDe: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.OrcSerDe] = js.undefined
  
  /**
    * A serializer to use for converting data to the Parquet format before storing it in Amazon S3. For more information, see Apache Parquet.
    */
  var ParquetSerDe: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.ParquetSerDe] = js.undefined
}
object Serializer {
