...
trait CopyCommand extends StObject {
  ...
  /**
    ...
    */
  var CopyOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.CopyOptions] = js.undefined
  
  /**
    * A comma-separated list of column names.
    */
  var DataTableColumns: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.DataTableColumns] = js.undefined
  
  /**
    * The name of the target table. The table must already exist in the database.
    */
  var DataTableName: typingsJapgolly.awsSdk.clientsFirehoseMod.DataTableName
}
object CopyCommand {
