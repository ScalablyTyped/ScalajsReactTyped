...
trait DeliveryStreamDescription extends StObject {
  ...
  /**
    ...
    */
  var DeliveryStreamARN: typingsJapgolly.awsSdk.clientsFirehoseMod.DeliveryStreamARN
  
  /**
    * Indicates the server-side encryption (SSE) status for the delivery stream.
    */
  var DeliveryStreamEncryptionConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsFirehoseMod.DeliveryStreamEncryptionConfiguration] = js.undefined
  ...
  /**
    ...
    */
  var DeliveryStreamStatus: typingsJapgolly.awsSdk.clientsFirehoseMod.DeliveryStreamStatus
  ...
  /**
    ...
    */
  var DeliveryStreamType: typingsJapgolly.awsSdk.clientsFirehoseMod.DeliveryStreamType
