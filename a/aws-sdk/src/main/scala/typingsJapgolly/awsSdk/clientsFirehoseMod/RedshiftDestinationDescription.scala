...
trait RedshiftDestinationDescription extends StObject {
  ...
  /**
    ...
    */
  var ClusterJDBCURL: typingsJapgolly.awsSdk.clientsFirehoseMod.ClusterJDBCURL
  
  /**
    * The COPY command.
    */
  var CopyCommand: typingsJapgolly.awsSdk.clientsFirehoseMod.CopyCommand
  ...
  /**
    ...
    */
  var S3DestinationDescription: typingsJapgolly.awsSdk.clientsFirehoseMod.S3DestinationDescription
  
  /**
    * The name of the user.
    */
  var Username: typingsJapgolly.awsSdk.clientsFirehoseMod.Username
}
