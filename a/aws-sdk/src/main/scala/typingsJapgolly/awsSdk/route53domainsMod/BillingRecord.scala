...
trait BillingRecord extends js.Object {
  ...
  /**
    ...
    */
  var DomainName: js.UndefOr[typingsJapgolly.awsSdk.route53domainsMod.DomainName] = js.native
  /**
    * The ID of the invoice that is associated with the billing record.
    */
  var InvoiceId: js.UndefOr[typingsJapgolly.awsSdk.route53domainsMod.InvoiceId] = js.native
  /**
  ...
  /**
    ...
    */
  var Price: js.UndefOr[typingsJapgolly.awsSdk.route53domainsMod.Price] = js.native
}
