...
trait RenewDomainRequest extends js.Object {
  /**
    ...
    */
  var CurrentExpiryYear: typingsJapgolly.awsSdk.route53domainsMod.CurrentExpiryYear = js.native
  /**
  ...
  /**
    ...
    */
  var DurationInYears: js.UndefOr[typingsJapgolly.awsSdk.route53domainsMod.DurationInYears] = js.native
}
