...
trait StartTranscriptionJobRequest extends js.Object {
  ...
  /**
    ...
    */
  var LanguageCode: typingsJapgolly.awsSdk.transcribeserviceMod.LanguageCode = js.native
  /**
    * An object that describes the input media for a transcription job.
    */
  var Media: typingsJapgolly.awsSdk.transcribeserviceMod.Media = js.native
  /**
  ...
  /**
    ...
    */
  var OutputBucketName: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.OutputBucketName] = js.native
  /**
  ...
  /**
    ...
    */
  var TranscriptionJobName: typingsJapgolly.awsSdk.transcribeserviceMod.TranscriptionJobName = js.native
}
