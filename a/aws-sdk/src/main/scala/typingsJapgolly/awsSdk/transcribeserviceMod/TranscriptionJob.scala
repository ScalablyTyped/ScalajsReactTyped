...
trait TranscriptionJob extends js.Object {
  ...
  /**
    ...
    */
  var JobExecutionSettings: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.JobExecutionSettings] = js.native
  /**
  ...
  /**
    ...
    */
  var Media: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.Media] = js.native
  /**
    * The format of the input media file.
    */
  var MediaFormat: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.MediaFormat] = js.native
  /**
    * The sample rate, in Hertz, of the audio track in the input media file. 
    */
  var MediaSampleRateHertz: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.MediaSampleRateHertz] = js.native
  /**
    * Optional settings for the transcription job. Use these settings to turn on speaker recognition, to set the maximum number of speakers that should be identified and to specify a custom vocabulary to use when processing the transcription job.
    */
  var Settings: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.Settings] = js.native
  /**
  ...
  /**
    ...
    */
  var Transcript: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.Transcript] = js.native
  /**
    * The name of the transcription job.
    */
  var TranscriptionJobName: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.TranscriptionJobName] = js.native
  /**
    * The status of the transcription job.
    */
  var TranscriptionJobStatus: js.UndefOr[typingsJapgolly.awsSdk.transcribeserviceMod.TranscriptionJobStatus] = js.native
}
