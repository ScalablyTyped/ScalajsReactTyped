...
trait AwsWafRateBasedRuleDetails extends StObject {
  
  /**
    * The predicates to include in the rate-based rule.
    */
  var MatchPredicates: js.UndefOr[AwsWafRateBasedRuleMatchPredicateList] = js.undefined
...
object AwsWafRateBasedRuleDetails {
  ...
  inline def apply(): AwsWafRateBasedRuleDetails = {
  ...
  extension [Self <: AwsWafRateBasedRuleDetails](x: Self) {
    ...
    inline def setMatchPredicatesVarargs(value: AwsWafRateBasedRuleMatchPredicate*): Self = StObject.set(x, "MatchPredicates", js.Array(value*))
