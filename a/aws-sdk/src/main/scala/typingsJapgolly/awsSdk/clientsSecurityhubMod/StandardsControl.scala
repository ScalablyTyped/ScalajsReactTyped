...
trait StandardsControl extends StObject {
  ...
  /**
    ...
    */
  var ControlStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.ControlStatus] = js.undefined
  ...
  /**
    ...
    */
  var SeverityRating: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.SeverityRating] = js.undefined
