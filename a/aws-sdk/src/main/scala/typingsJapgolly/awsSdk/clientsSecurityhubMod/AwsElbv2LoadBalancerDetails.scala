...
trait AwsElbv2LoadBalancerDetails extends StObject {
  ...
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.AvailabilityZones] = js.undefined
  ...
  /**
    ...
    */
  var SecurityGroups: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.SecurityGroups] = js.undefined
...
object AwsElbv2LoadBalancerDetails {
  ...
  extension [Self <: AwsElbv2LoadBalancerDetails](x: Self) {
