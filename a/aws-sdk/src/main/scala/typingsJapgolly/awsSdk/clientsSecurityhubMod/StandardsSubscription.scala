...
trait StandardsSubscription extends StObject {
  ...
  /**
    ...
    */
  var StandardsStatus: typingsJapgolly.awsSdk.clientsSecurityhubMod.StandardsStatus
  
  /**
    * The reason for the current status.
    */
  var StandardsStatusReason: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.StandardsStatusReason] = js.undefined
