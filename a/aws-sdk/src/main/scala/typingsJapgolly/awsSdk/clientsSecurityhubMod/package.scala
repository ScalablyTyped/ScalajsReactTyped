...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.SEND_FINDINGS_TO_SECURITY_HUB
  - typingsJapgolly.awsSdk.awsSdkStrings.RECEIVE_FINDINGS_FROM_SECURITY_HUB
  - typingsJapgolly.awsSdk.awsSdkStrings.UPDATE_FINDINGS_IN_SECURITY_HUB
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.NO_AVAILABLE_CONFIGURATION_RECORDER
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.awsSdk.awsSdkStrings.NOT_EQUALS
  - typingsJapgolly.awsSdk.awsSdkStrings.PREFIX_NOT_EQUALS
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.NEW
  - typingsJapgolly.awsSdk.awsSdkStrings.NOTIFIED
  - typingsJapgolly.awsSdk.awsSdkStrings.RESOLVED
