...
trait AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails extends StObject {
...
object AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails {
  ...
  inline def apply(): AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails]
  }
  
  extension [Self <: AwsOpenSearchServiceDomainServiceSoftwareOptionsDetails](x: Self) {
