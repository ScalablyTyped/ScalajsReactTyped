...
trait Occurrences extends StObject {
  ...
  /**
    ...
    */
  var Cells: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.Cells] = js.undefined
  ...
  /**
    ...
    */
  var Pages: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.Pages] = js.undefined
  
  /**
    * Occurrences of sensitive data in an Apache Avro object container or an Apache Parquet file.
    */
  var Records: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.Records] = js.undefined
}
object Occurrences {
