...
trait ActionRemoteIpDetails extends StObject {
  ...
  /**
    ...
    */
  var City: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.City] = js.undefined
  
  /**
    * The country where the remote IP address is located.
    */
  var Country: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.Country] = js.undefined
  
  /**
    * The coordinates of the location of the remote IP address.
    */
  var GeoLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsSecurityhubMod.GeoLocation] = js.undefined
