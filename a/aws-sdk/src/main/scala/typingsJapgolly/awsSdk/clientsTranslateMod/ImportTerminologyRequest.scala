...
trait ImportTerminologyRequest extends StObject {
  ...
  /**
    ...
    */
  var MergeStrategy: typingsJapgolly.awsSdk.clientsTranslateMod.MergeStrategy
  ...
  /**
    ...
    */
  var TerminologyData: typingsJapgolly.awsSdk.clientsTranslateMod.TerminologyData
}
