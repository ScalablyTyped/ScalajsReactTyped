...
trait TranslationSettings extends StObject {
  ...
  /**
    ...
    */
  var Formality: js.UndefOr[typingsJapgolly.awsSdk.clientsTranslateMod.Formality] = js.undefined
  ...
  /**
    ...
    */
  var Profanity: js.UndefOr[typingsJapgolly.awsSdk.clientsTranslateMod.Profanity] = js.undefined
}
