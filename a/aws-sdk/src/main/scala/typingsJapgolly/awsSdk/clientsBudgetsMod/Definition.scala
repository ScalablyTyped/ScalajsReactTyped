...
trait Definition extends StObject {
  ...
  /**
    ...
    */
  var IamActionDefinition: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.IamActionDefinition] = js.undefined
  
  /**
    * The service control policies (SCPs) action definition details. 
    */
  var ScpActionDefinition: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.ScpActionDefinition] = js.undefined
  
  /**
    * The Amazon Web Services Systems Manager (SSM) action definition details. 
    */
  var SsmActionDefinition: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.SsmActionDefinition] = js.undefined
}
object Definition {
