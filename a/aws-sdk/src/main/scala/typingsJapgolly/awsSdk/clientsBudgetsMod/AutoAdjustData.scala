...
trait AutoAdjustData extends StObject {
  ...
  /**
    ...
    */
  var AutoAdjustType: typingsJapgolly.awsSdk.clientsBudgetsMod.AutoAdjustType
  
  /**
    * The parameters that define or describe the historical data that your auto-adjusting budget is based on.
    */
  var HistoricalOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.HistoricalOptions] = js.undefined
