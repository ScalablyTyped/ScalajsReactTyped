...
trait BudgetPerformanceHistory extends StObject {
  ...
  var BudgetType: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.BudgetType] = js.undefined
  
  /**
    * A list of amounts of cost or usage that you created budgets for, which are compared to your actual costs or usage.
    */
  var BudgetedAndActualAmountsList: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.BudgetedAndActualAmountsList] = js.undefined
  ...
  var TimeUnit: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.TimeUnit] = js.undefined
}
