...
trait UpdateBudgetActionRequest extends StObject {
  ...
  /**
    ...
    */
  var ActionId: typingsJapgolly.awsSdk.clientsBudgetsMod.ActionId
  
  var ActionThreshold: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.ActionThreshold] = js.undefined
  
  /**
    *  This specifies if the action needs manual or automatic approval. 
    */
  var ApprovalModel: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.ApprovalModel] = js.undefined
  
  var BudgetName: typingsJapgolly.awsSdk.clientsBudgetsMod.BudgetName
  
  var Definition: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.Definition] = js.undefined
  ...
  var NotificationType: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.NotificationType] = js.undefined
  
  var Subscribers: js.UndefOr[typingsJapgolly.awsSdk.clientsBudgetsMod.Subscribers] = js.undefined
}
