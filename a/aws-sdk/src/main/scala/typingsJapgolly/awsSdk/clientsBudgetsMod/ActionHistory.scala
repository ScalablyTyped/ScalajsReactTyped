...
trait ActionHistory extends StObject {
  ...
  /**
    ...
    */
  var ActionHistoryDetails: typingsJapgolly.awsSdk.clientsBudgetsMod.ActionHistoryDetails
  
  /**
    * This distinguishes between whether the events are triggered by the user or are generated by the system. 
    */
  var EventType: typingsJapgolly.awsSdk.clientsBudgetsMod.EventType
