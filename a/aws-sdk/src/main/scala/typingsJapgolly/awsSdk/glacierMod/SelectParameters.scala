...
trait SelectParameters extends js.Object {
  ...
  /**
    ...
    */
  var ExpressionType: js.UndefOr[typingsJapgolly.awsSdk.glacierMod.ExpressionType] = js.native
  /**
    * Describes the serialization format of the object.
    */
  var InputSerialization: js.UndefOr[typingsJapgolly.awsSdk.glacierMod.InputSerialization] = js.native
  /**
    * Describes how the results of the select job are serialized.
    */
  var OutputSerialization: js.UndefOr[typingsJapgolly.awsSdk.glacierMod.OutputSerialization] = js.native
}
