...
trait GlacierJobDescription extends js.Object {
  ...
  /**
    ...
    */
  var OutputLocation: js.UndefOr[typingsJapgolly.awsSdk.glacierMod.OutputLocation] = js.native
  /**
  ...
  /**
    ...
    */
  var SelectParameters: js.UndefOr[typingsJapgolly.awsSdk.glacierMod.SelectParameters] = js.native
  /**
    * The status code can be InProgress, Succeeded, or Failed, and indicates the status of the job.
    */
  var StatusCode: js.UndefOr[typingsJapgolly.awsSdk.glacierMod.StatusCode] = js.native
  /**
