...
trait StreamDescription extends js.Object {
  ...
  /**
    ...
    */
  var KeySchema: js.UndefOr[typingsJapgolly.awsSdk.dynamodbstreamsMod.KeySchema] = js.native
  /**
  ...
  /**
    ...
    */
  var StreamStatus: js.UndefOr[typingsJapgolly.awsSdk.dynamodbstreamsMod.StreamStatus] = js.native
  /**
    ...
    */
  var StreamViewType: js.UndefOr[typingsJapgolly.awsSdk.dynamodbstreamsMod.StreamViewType] = js.native
  /**
