...
trait DeploymentTargets extends StObject {
  ...
  /**
    ...
    */
  var AccountFilterType: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.AccountFilterType] = js.undefined
  ...
  /**
    ...
    */
  var AccountsUrl: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.AccountsUrl] = js.undefined
