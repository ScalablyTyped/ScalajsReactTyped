...
trait StackDriftInformationSummary extends StObject {
  ...
  /**
    ...
    */
  var StackDriftStatus: typingsJapgolly.awsSdk.clientsCloudformationMod.StackDriftStatus
}
object StackDriftInformationSummary {
  
  inline def apply(StackDriftStatus: StackDriftStatus): StackDriftInformationSummary = {
