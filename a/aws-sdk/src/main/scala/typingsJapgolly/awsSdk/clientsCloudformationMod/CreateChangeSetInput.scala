...
trait CreateChangeSetInput extends StObject {
  ...
  /**
    ...
    */
  var ChangeSetName: typingsJapgolly.awsSdk.clientsCloudformationMod.ChangeSetName
  ...
  /**
    ...
    */
  var ChangeSetType: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ChangeSetType] = js.undefined
  
  /**
    * A unique identifier for this CreateChangeSet request. Specify this token if you plan to retry requests so that CloudFormation knows that you're not attempting to create another change set with the same name. You might retry CreateChangeSet requests to ensure that CloudFormation successfully received them.
    */
  var ClientToken: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ClientToken] = js.undefined
  ...
  /**
    ...
    */
  var ResourcesToImport: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ResourcesToImport] = js.undefined
