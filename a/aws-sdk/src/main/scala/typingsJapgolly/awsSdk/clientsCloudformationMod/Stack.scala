...
trait Stack extends StObject {
  ...
  /**
    ...
    */
  var EnableTerminationProtection: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.EnableTerminationProtection] = js.undefined
  ...
  /**
    ...
    */
  var Outputs: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.Outputs] = js.undefined
  ...
  /**
    ...
    */
  var StackStatus: typingsJapgolly.awsSdk.clientsCloudformationMod.StackStatus
  
  /**
    * Success/failure message associated with the stack status.
    */
  var StackStatusReason: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.StackStatusReason] = js.undefined
