...
trait DescribePublisherOutput extends StObject {
  ...
  /**
    ...
    */
  var IdentityProvider: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.IdentityProvider] = js.undefined
  ...
  /**
    ...
    */
  var PublisherProfile: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.PublisherProfile] = js.undefined
  
  /**
    * Whether the publisher is verified. Currently, all registered publishers are verified.
    */
  var PublisherStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.PublisherStatus] = js.undefined
}
