...
trait TypeConfigurationIdentifier extends StObject {
  ...
  /**
    ...
    */
  var TypeConfigurationAlias: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.TypeConfigurationAlias] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) for the configuration, in this account and region.
    */
  var TypeConfigurationArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.TypeConfigurationArn] = js.undefined
