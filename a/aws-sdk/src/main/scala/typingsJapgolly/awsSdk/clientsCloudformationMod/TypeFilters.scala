...
trait TypeFilters extends StObject {
  ...
  /**
    ...
    */
  var Category: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.Category] = js.undefined
  ...
  /**
    ...
    */
  var TypeNamePrefix: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.TypeNamePrefix] = js.undefined
}
object TypeFilters {
