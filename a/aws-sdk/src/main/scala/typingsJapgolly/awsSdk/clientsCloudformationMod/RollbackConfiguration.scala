...
trait RollbackConfiguration extends StObject {
  ...
  /**
    ...
    */
  var MonitoringTimeInMinutes: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.MonitoringTimeInMinutes] = js.undefined
  ...
  /**
    ...
    */
  var RollbackTriggers: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.RollbackTriggers] = js.undefined
}
