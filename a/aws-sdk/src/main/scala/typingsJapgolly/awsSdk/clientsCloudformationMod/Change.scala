...
trait Change extends StObject {
  ...
  /**
    ...
    */
  var HookInvocationCount: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.HookInvocationCount] = js.undefined
  
  /**
    * A ResourceChange structure that describes the resource and action that CloudFormation will perform.
    */
  var ResourceChange: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ResourceChange] = js.undefined
