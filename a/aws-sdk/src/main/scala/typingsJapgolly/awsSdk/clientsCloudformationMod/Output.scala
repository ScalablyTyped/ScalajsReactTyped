...
trait Output extends StObject {
  ...
  /**
    ...
    */
  var ExportName: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ExportName] = js.undefined
  
  /**
    * The key associated with the output.
    */
  var OutputKey: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.OutputKey] = js.undefined
  
  /**
    * The value associated with the output.
    */
  var OutputValue: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.OutputValue] = js.undefined
}
object Output {
