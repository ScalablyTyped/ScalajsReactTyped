...
trait ParameterDeclaration extends StObject {
  ...
  /**
    ...
    */
  var NoEcho: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.NoEcho] = js.undefined
  
  /**
    * The criteria that CloudFormation uses to validate parameter values.
    */
  var ParameterConstraints: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ParameterConstraints] = js.undefined
  
  /**
    * The name that's associated with the parameter.
    */
  var ParameterKey: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ParameterKey] = js.undefined
  
  /**
    * The type of parameter.
    */
  var ParameterType: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ParameterType] = js.undefined
}
