...
trait RecordHandlerProgressInput extends StObject {
  ...
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var OperationStatus: typingsJapgolly.awsSdk.clientsCloudformationMod.OperationStatus
  
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var ResourceModel: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ResourceModel] = js.undefined
  
  /**
    * Reserved for use by the CloudFormation CLI.
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.StatusMessage] = js.undefined
}
