...
trait StackResourceDrift extends StObject {
  ...
  /**
    ...
    */
  var PhysicalResourceIdContext: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.PhysicalResourceIdContext] = js.undefined
  
  /**
    * A collection of the resource properties whose actual values differ from their expected values. These will be present only for resources whose StackResourceDriftStatus is MODIFIED.
    */
  var PropertyDifferences: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.PropertyDifferences] = js.undefined
  ...
  /**
    * The ID of the stack.
    */
  var StackId: typingsJapgolly.awsSdk.clientsCloudformationMod.StackId
  ...
  /**
    ...
    */
  var StackResourceDriftStatus: typingsJapgolly.awsSdk.clientsCloudformationMod.StackResourceDriftStatus
