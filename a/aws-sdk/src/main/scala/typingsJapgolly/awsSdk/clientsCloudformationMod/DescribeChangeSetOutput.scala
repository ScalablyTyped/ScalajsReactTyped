...
trait DescribeChangeSetOutput extends StObject {
  ...
  /**
    ...
    */
  var ChangeSetId: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ChangeSetId] = js.undefined
  
  /**
    * The name of the change set.
    */
  var ChangeSetName: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ChangeSetName] = js.undefined
  
  /**
    * A list of Change structures that describes the resources CloudFormation changes if you execute the change set.
    */
  var Changes: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.Changes] = js.undefined
  ...
  /**
    ...
    */
  var ExecutionStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ExecutionStatus] = js.undefined
  
  /**
    * Verifies if IncludeNestedStacks is set to True.
    */
  var IncludeNestedStacks: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.IncludeNestedStacks] = js.undefined
