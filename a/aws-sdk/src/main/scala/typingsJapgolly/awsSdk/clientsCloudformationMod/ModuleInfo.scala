...
trait ModuleInfo extends StObject {
  ...
  /**
    ...
    */
  var LogicalIdHierarchy: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.LogicalIdHierarchy] = js.undefined
  ...
  /**
    ...
    */
  var TypeHierarchy: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.TypeHierarchy] = js.undefined
}
object ModuleInfo {
