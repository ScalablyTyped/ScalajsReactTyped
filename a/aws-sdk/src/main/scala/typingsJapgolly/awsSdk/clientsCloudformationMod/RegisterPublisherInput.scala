...
trait RegisterPublisherInput extends StObject {
  ...
  /**
    ...
    */
  var AcceptTermsAndConditions: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.AcceptTermsAndConditions] = js.undefined
  ...
  /**
    ...
    */
  var ConnectionArn: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudformationMod.ConnectionArn] = js.undefined
}
