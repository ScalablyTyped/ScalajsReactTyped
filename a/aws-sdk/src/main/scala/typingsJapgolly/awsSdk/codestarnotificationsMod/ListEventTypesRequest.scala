...
trait ListEventTypesRequest extends js.Object {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.codestarnotificationsMod.MaxResults] = js.native
  /**
    * An enumeration token that, when provided in a request, returns the next batch of the results.
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.codestarnotificationsMod.NextToken] = js.native
}
