...
trait CreateNotificationRuleRequest extends js.Object {
  ...
  /**
    ...
    */
  var DetailType: typingsJapgolly.awsSdk.codestarnotificationsMod.DetailType = js.native
  /**
    * A list of event types associated with this notification rule. For a list of allowed events, see EventTypeSummary.
    */
  var EventTypeIds: typingsJapgolly.awsSdk.codestarnotificationsMod.EventTypeIds = js.native
  /**
  ...
  /**
    ...
    */
  var Targets: typingsJapgolly.awsSdk.codestarnotificationsMod.Targets = js.native
}
