...
trait Limits extends StObject {
  ...
  var MaximumPartitionCount: typingsJapgolly.awsSdk.clientsCloudsearchMod.MaximumPartitionCount
  
  var MaximumReplicationCount: typingsJapgolly.awsSdk.clientsCloudsearchMod.MaximumReplicationCount
}
object Limits {
