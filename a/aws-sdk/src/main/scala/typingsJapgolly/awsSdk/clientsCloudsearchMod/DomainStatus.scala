...
trait DomainStatus extends StObject {
  ...
  var ARN: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudsearchMod.ARN] = js.undefined
  ...
  var DomainId: typingsJapgolly.awsSdk.clientsCloudsearchMod.DomainId
  
  var DomainName: typingsJapgolly.awsSdk.clientsCloudsearchMod.DomainName
  
  var Limits: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudsearchMod.Limits] = js.undefined
  ...
  /**
    ...
    */
  var SearchInstanceType: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudsearchMod.SearchInstanceType] = js.undefined
