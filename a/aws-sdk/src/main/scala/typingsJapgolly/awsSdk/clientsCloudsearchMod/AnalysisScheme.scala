...
trait AnalysisScheme extends StObject {
  ...
  var AnalysisOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudsearchMod.AnalysisOptions] = js.undefined
  
  var AnalysisSchemeLanguage: typingsJapgolly.awsSdk.clientsCloudsearchMod.AnalysisSchemeLanguage
