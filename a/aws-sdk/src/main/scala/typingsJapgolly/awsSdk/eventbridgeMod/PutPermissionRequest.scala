...
trait PutPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typingsJapgolly.awsSdk.eventbridgeMod.Action = js.native
  /**
    ...
    */
  var Condition: js.UndefOr[typingsJapgolly.awsSdk.eventbridgeMod.Condition] = js.native
  /**
  ...
  /**
    ...
    */
  var Principal: typingsJapgolly.awsSdk.eventbridgeMod.Principal = js.native
  /**
    ...
    */
  var StatementId: typingsJapgolly.awsSdk.eventbridgeMod.StatementId = js.native
}
