...
trait EcsParameters extends js.Object {
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typingsJapgolly.awsSdk.eventbridgeMod.LaunchType] = js.native
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typingsJapgolly.awsSdk.eventbridgeMod.NetworkConfiguration] = js.native
  /**
