...
trait Rule extends js.Object {
  ...
  /**
    ...
    */
  var EventBusName: js.UndefOr[typingsJapgolly.awsSdk.eventbridgeMod.EventBusName] = js.native
  /**
    * The event pattern of the rule. For more information, see Event Patterns in the Amazon EventBridge User Guide.
    */
  var EventPattern: js.UndefOr[typingsJapgolly.awsSdk.eventbridgeMod.EventPattern] = js.native
  /**
    ...
    */
  var ManagedBy: js.UndefOr[typingsJapgolly.awsSdk.eventbridgeMod.ManagedBy] = js.native
  /**
  ...
  /**
    ...
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.eventbridgeMod.RoleArn] = js.native
  /**
    * The scheduling expression: for example, "cron(0 20 * * ? *)" or "rate(5 minutes)".
    */
  var ScheduleExpression: js.UndefOr[typingsJapgolly.awsSdk.eventbridgeMod.ScheduleExpression] = js.native
  /**
