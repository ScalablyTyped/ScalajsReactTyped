...
trait Schedule extends js.Object {
  /**
    ...
    */
  var CopyTags: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.CopyTags] = js.native
  /**
    * The creation rule.
    */
  var CreateRule: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.CreateRule] = js.native
  /**
    * The rule for cross-Region snapshot copies.
    */
  var CrossRegionCopyRules: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.CrossRegionCopyRules] = js.native
  /**
    * The rule for enabling fast snapshot restore.
    */
  var FastRestoreRule: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.FastRestoreRule] = js.native
  /**
  ...
  /**
    * The retention rule.
    */
  var RetainRule: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.RetainRule] = js.native
  /**
