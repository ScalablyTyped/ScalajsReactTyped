...
trait CrossRegionCopyRule extends js.Object {
  /**
    ...
    */
  var CmkArn: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.CmkArn] = js.native
  /**
  ...
  /**
    ...
    */
  var Encrypted: typingsJapgolly.awsSdk.dlmMod.Encrypted = js.native
  /**
    * The retention rule.
    */
  ...
  /**
    * The target Region.
    */
  var TargetRegion: typingsJapgolly.awsSdk.dlmMod.TargetRegion = js.native
}
