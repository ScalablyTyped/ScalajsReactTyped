...
trait LifecyclePolicy extends js.Object {
  ...
  /**
    ...
    */
  var ExecutionRoleArn: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.ExecutionRoleArn] = js.native
  /**
    * The Amazon Resource Name (ARN) of the policy.
    */
  var PolicyArn: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.PolicyArn] = js.native
  /**
    * The configuration of the lifecycle policy
    */
  var PolicyDetails: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.PolicyDetails] = js.native
  /**
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.dlmMod.StatusMessage] = js.native
  /**
    * The tags.
    */
