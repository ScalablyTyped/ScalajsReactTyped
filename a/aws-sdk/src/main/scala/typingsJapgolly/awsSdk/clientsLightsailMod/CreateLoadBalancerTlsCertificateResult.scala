...
trait CreateLoadBalancerTlsCertificateResult extends StObject {
...
object CreateLoadBalancerTlsCertificateResult {
  ...
  inline def apply(): CreateLoadBalancerTlsCertificateResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateLoadBalancerTlsCertificateResult]
  }
  
  extension [Self <: CreateLoadBalancerTlsCertificateResult](x: Self) {
