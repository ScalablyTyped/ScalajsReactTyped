...
trait SetResourceAccessForBucketResult extends StObject {
...
object SetResourceAccessForBucketResult {
  ...
  inline def apply(): SetResourceAccessForBucketResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SetResourceAccessForBucketResult]
  }
  
  extension [Self <: SetResourceAccessForBucketResult](x: Self) {
