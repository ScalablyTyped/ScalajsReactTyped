...
trait UpdateRelationalDatabaseResult extends StObject {
...
object UpdateRelationalDatabaseResult {
  ...
  inline def apply(): UpdateRelationalDatabaseResult = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[UpdateRelationalDatabaseResult]
  }
  
  extension [Self <: UpdateRelationalDatabaseResult](x: Self) {
