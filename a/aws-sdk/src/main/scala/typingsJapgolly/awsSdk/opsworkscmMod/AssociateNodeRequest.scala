...
trait AssociateNodeRequest extends js.Object {
  /**
    ...
    */
  var EngineAttributes: typingsJapgolly.awsSdk.opsworkscmMod.EngineAttributes = js.native
  /**
    * The name of the node. 
    */
  var NodeName: typingsJapgolly.awsSdk.opsworkscmMod.NodeName = js.native
  /**
