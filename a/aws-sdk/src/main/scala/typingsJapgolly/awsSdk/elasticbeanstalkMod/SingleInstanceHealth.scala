...
trait SingleInstanceHealth extends js.Object {
  ...
  /**
    ...
    */
  var Deployment: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.Deployment] = js.native
  /**
  ...
  /**
    ...
    */
  var InstanceId: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.InstanceId] = js.native
  /**
    * The instance's type.
    */
