...
trait CreatePlatformVersionRequest extends js.Object {
  ...
  /**
    ...
    */
  var PlatformName: typingsJapgolly.awsSdk.elasticbeanstalkMod.PlatformName = js.native
  /**
    * The number, such as 1.0.2, for the new platform version.
    */
  var PlatformVersion: typingsJapgolly.awsSdk.elasticbeanstalkMod.PlatformVersion = js.native
  /**
