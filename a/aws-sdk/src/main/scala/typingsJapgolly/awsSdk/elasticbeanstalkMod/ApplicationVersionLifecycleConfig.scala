...
trait ApplicationVersionLifecycleConfig extends js.Object {
  /**
    ...
    */
  var MaxAgeRule: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.MaxAgeRule] = js.native
  /**
    * Specify a max count rule to restrict the number of application versions that are retained for an application.
    */
  var MaxCountRule: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.MaxCountRule] = js.native
}
