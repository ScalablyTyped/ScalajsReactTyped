...
trait EnvironmentDescription extends js.Object {
  /**
    ...
    */
  var AbortableOperationInProgress: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.AbortableOperationInProgress] = js.native
  /**
  ...
  /**
    ...
    */
  var EndpointURL: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.EndpointURL] = js.native
  /**
    * The environment's Amazon Resource Name (ARN), which can be used in other API requests that require an ARN.
    */
  var EnvironmentArn: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.EnvironmentArn] = js.native
  /**
  ...
  /**
    ...
    */
  var EnvironmentLinks: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.EnvironmentLinks] = js.native
  /**
