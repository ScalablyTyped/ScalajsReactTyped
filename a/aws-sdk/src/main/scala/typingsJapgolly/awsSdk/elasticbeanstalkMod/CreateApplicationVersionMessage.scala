...
trait CreateApplicationVersionMessage extends js.Object {
  ...
  /**
    ...
    */
  var AutoCreateApplication: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.AutoCreateApplication] = js.native
  /**
    * Settings for an AWS CodeBuild build.
    */
  var BuildConfiguration: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.BuildConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var VersionLabel: typingsJapgolly.awsSdk.elasticbeanstalkMod.VersionLabel = js.native
}
