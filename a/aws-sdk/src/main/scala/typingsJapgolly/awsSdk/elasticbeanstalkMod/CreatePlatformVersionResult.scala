...
trait CreatePlatformVersionResult extends js.Object {
  /**
    ...
    */
  var Builder: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.Builder] = js.native
  /**
    * Detailed information about the new version of the custom platform.
    */
  var PlatformSummary: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.PlatformSummary] = js.native
}
