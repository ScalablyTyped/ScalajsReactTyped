...
trait DescribeEnvironmentHealthResult extends js.Object {
  /**
    ...
    */
  var ApplicationMetrics: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.ApplicationMetrics] = js.native
  /**
    * Descriptions of the data that contributed to the environment's current health status.
    */
  var Causes: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.Causes] = js.native
  /**
