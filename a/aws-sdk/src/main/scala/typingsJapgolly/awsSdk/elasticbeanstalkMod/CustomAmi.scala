...
trait CustomAmi extends js.Object {
  /**
    ...
    */
  var ImageId: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.ImageId] = js.native
  /**
    * The type of virtualization used to create the custom AMI.
    */
  var VirtualizationType: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.VirtualizationType] = js.native
}
