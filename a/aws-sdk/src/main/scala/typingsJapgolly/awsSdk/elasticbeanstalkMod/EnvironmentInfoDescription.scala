...
trait EnvironmentInfoDescription extends js.Object {
  /**
    ...
    */
  var Ec2InstanceId: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.Ec2InstanceId] = js.native
  /**
  ...
  /**
    ...
    */
  var Message: js.UndefOr[typingsJapgolly.awsSdk.elasticbeanstalkMod.Message] = js.native
  /**
