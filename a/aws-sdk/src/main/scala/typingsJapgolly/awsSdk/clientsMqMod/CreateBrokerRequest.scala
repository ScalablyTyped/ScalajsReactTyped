...
trait CreateBrokerRequest extends StObject {
  ...
  /**
    ...
    */
  var AuthenticationStrategy: js.UndefOr[typingsJapgolly.awsSdk.clientsMqMod.AuthenticationStrategy] = js.undefined
  ...
  /**
    ...
    */
  var DeploymentMode: typingsJapgolly.awsSdk.clientsMqMod.DeploymentMode
  
  /**
    * Encryption options for the broker. Does not apply to RabbitMQ brokers.
    */
  var EncryptionOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsMqMod.EncryptionOptions] = js.undefined
  
  /**
    * Required. The type of broker engine. Currently, Amazon MQ supports ACTIVEMQ and RABBITMQ.
    */
  var EngineType: typingsJapgolly.awsSdk.clientsMqMod.EngineType
  ...
  /**
    ...
    */
  var Logs: js.UndefOr[typingsJapgolly.awsSdk.clientsMqMod.Logs] = js.undefined
