...
trait DescribeSnapshotScheduleOutput extends StObject {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.Description] = js.undefined
  
  /**
    * The number of hours between snapshots.
    */
  var RecurrenceInHours: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.RecurrenceInHours] = js.undefined
