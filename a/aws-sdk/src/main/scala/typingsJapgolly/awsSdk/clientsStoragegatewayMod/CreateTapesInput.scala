...
trait CreateTapesInput extends StObject {
  ...
  /**
    ...
    */
  var NumTapesToCreate: typingsJapgolly.awsSdk.clientsStoragegatewayMod.NumTapesToCreate
  ...
  /**
    ...
    */
  var TapeBarcodePrefix: typingsJapgolly.awsSdk.clientsStoragegatewayMod.TapeBarcodePrefix
