...
trait UpdateVTLDeviceTypeInput extends StObject {
  ...
  /**
    ...
    */
  var DeviceType: typingsJapgolly.awsSdk.clientsStoragegatewayMod.DeviceType
  
  /**
    * The Amazon Resource Name (ARN) of the medium changer you want to select.
    */
  var VTLDeviceARN: typingsJapgolly.awsSdk.clientsStoragegatewayMod.VTLDeviceARN
}
