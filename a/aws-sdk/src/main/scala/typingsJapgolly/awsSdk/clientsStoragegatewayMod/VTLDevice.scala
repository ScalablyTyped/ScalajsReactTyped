...
trait VTLDevice extends StObject {
  ...
  /**
    ...
    */
  var DeviceiSCSIAttributes: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.DeviceiSCSIAttributes] = js.undefined
  
  /**
    * Specifies the unique Amazon Resource Name (ARN) of the device (tape drive or media changer).
    */
  var VTLDeviceARN: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.VTLDeviceARN] = js.undefined
  
  /**
    * Specifies the model number of device that the VTL device emulates.
    */
  var VTLDeviceProductIdentifier: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.VTLDeviceProductIdentifier] = js.undefined
  
  /**
    * Specifies the type of device that the VTL device emulates.
    */
  var VTLDeviceType: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.VTLDeviceType] = js.undefined
  
  /**
    * Specifies the vendor of the device that the VTL device object emulates.
    */
  var VTLDeviceVendor: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.VTLDeviceVendor] = js.undefined
}
object VTLDevice {
