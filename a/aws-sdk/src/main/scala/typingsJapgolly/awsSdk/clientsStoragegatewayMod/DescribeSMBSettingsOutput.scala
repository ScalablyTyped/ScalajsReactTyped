...
trait DescribeSMBSettingsOutput extends StObject {
  ...
  /**
    ...
    */
  var ActiveDirectoryStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.ActiveDirectoryStatus] = js.undefined
  
  /**
    * The name of the domain that the gateway is joined to.
    */
  var DomainName: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.DomainName] = js.undefined
  ...
  /**
    ...
    */
  var SMBLocalGroups: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.SMBLocalGroups] = js.undefined
  ...
  /**
    ...
    */
  var SMBSecurityStrategy: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.SMBSecurityStrategy] = js.undefined
}
