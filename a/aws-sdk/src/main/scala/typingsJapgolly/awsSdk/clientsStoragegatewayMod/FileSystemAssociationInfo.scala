...
trait FileSystemAssociationInfo extends StObject {
  ...
  /**
    ...
    */
  var EndpointNetworkConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.EndpointNetworkConfiguration] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the file system association.
    */
  var FileSystemAssociationARN: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.FileSystemAssociationARN] = js.undefined
  
  /**
    * The status of the file system association. Valid Values: AVAILABLE | CREATING | DELETING | FORCE_DELETING | UPDATING | ERROR 
    */
  var FileSystemAssociationStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.FileSystemAssociationStatus] = js.undefined
  ...
  /**
    ...
    */
  var FileSystemAssociationStatusDetails: js.UndefOr[
    typingsJapgolly.awsSdk.clientsStoragegatewayMod.FileSystemAssociationStatusDetails
  ] = js.undefined
...
object FileSystemAssociationInfo {
  ...
  extension [Self <: FileSystemAssociationInfo](x: Self) {
