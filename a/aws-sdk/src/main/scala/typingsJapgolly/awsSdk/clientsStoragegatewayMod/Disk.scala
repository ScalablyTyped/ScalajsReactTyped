...
trait Disk extends StObject {
  ...
  var DiskAllocationType: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.DiskAllocationType] = js.undefined
  
  var DiskAttributeList: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.DiskAttributeList] = js.undefined
  
  /**
    * The unique device ID or other distinguishing data that identifies a local disk.
    */
  var DiskId: js.UndefOr[typingsJapgolly.awsSdk.clientsStoragegatewayMod.DiskId] = js.undefined
