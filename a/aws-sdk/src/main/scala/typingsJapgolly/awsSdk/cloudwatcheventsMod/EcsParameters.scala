...
trait EcsParameters extends js.Object {
  ...
  /**
    ...
    */
  var LaunchType: js.UndefOr[typingsJapgolly.awsSdk.cloudwatcheventsMod.LaunchType] = js.native
  /**
    ...
    */
  var NetworkConfiguration: js.UndefOr[typingsJapgolly.awsSdk.cloudwatcheventsMod.NetworkConfiguration] = js.native
  /**
