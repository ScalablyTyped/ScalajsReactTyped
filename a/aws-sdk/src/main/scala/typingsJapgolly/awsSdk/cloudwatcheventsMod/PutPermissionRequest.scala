...
trait PutPermissionRequest extends js.Object {
  /**
    ...
    */
  var Action: typingsJapgolly.awsSdk.cloudwatcheventsMod.Action = js.native
  /**
    ...
    */
  var Condition: js.UndefOr[typingsJapgolly.awsSdk.cloudwatcheventsMod.Condition] = js.native
  /**
  ...
  /**
    ...
    */
  var Principal: typingsJapgolly.awsSdk.cloudwatcheventsMod.Principal = js.native
  /**
    ...
    */
  var StatementId: typingsJapgolly.awsSdk.cloudwatcheventsMod.StatementId = js.native
}
