...
trait SizeConstraint extends js.Object {
  /**
    ...
    */
  var ComparisonOperator: typingsJapgolly.awsSdk.wafMod.ComparisonOperator = js.native
  /**
    * Specifies where in a web request to look for the size constraint.
    */
  var FieldToMatch: typingsJapgolly.awsSdk.wafMod.FieldToMatch = js.native
  /**
    ...
    */
  var Size: typingsJapgolly.awsSdk.wafMod.Size = js.native
  /**
    ...
    */
  var TextTransformation: typingsJapgolly.awsSdk.wafMod.TextTransformation = js.native
}
