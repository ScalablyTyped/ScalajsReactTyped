...
trait Action extends StObject {
  ...
  /**
    ...
    */
  var parameters: js.UndefOr[ActionParameterMap] = js.undefined
...
object Action {
  ...
  extension [Self <: Action](x: Self) {
    ...
    inline def setParameters(value: ActionParameterMap): Self = StObject.set(x, "parameters", value.asInstanceOf[js.Any])
