...
trait ForwardedValues extends js.Object {
  ...
  /**
    ...
    */
  var Headers: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.Headers] = js.native
  /**
  ...
  /**
    ...
    */
  var QueryStringCacheKeys: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.QueryStringCacheKeys] = js.native
}
