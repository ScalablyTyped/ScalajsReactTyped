...
trait Origin extends js.Object {
  /**
    ...
    */
  var CustomHeaders: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.CustomHeaders] = js.native
  /**
    * A complex type that contains information about a custom origin. If the origin is an Amazon S3 bucket, use the S3OriginConfig element instead.
    */
  var CustomOriginConfig: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.CustomOriginConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var S3OriginConfig: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.S3OriginConfig] = js.native
}
