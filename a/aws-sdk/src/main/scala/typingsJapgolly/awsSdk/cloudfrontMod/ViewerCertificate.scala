...
trait ViewerCertificate extends js.Object {
  ...
  /**
    * This field is deprecated. Use one of the following fields instead:    ACMCertificateArn     IAMCertificateId     CloudFrontDefaultCertificate   
    */
  var CertificateSource: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.CertificateSource] = js.native
  /**
  ...
  /**
    ...
    */
  var MinimumProtocolVersion: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.MinimumProtocolVersion] = js.native
  /**
    ...
    */
  var SSLSupportMethod: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.SSLSupportMethod] = js.native
}
