...
trait DefaultCacheBehavior extends js.Object {
  var AllowedMethods: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.AllowedMethods] = js.native
  /**
  ...
  /**
    ...
    */
  var ForwardedValues: typingsJapgolly.awsSdk.cloudfrontMod.ForwardedValues = js.native
  /**
    * A complex type that contains zero or more Lambda function associations for a cache behavior.
    */
  var LambdaFunctionAssociations: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.LambdaFunctionAssociations] = js.native
  /**
  ...
  /**
    ...
    */
  var TrustedSigners: typingsJapgolly.awsSdk.cloudfrontMod.TrustedSigners = js.native
  /**
    ...
    */
  var ViewerProtocolPolicy: typingsJapgolly.awsSdk.cloudfrontMod.ViewerProtocolPolicy = js.native
}
