...
trait CustomOriginConfig extends js.Object {
  ...
  /**
    ...
    */
  var OriginProtocolPolicy: typingsJapgolly.awsSdk.cloudfrontMod.OriginProtocolPolicy = js.native
  /**
  ...
  /**
    ...
    */
  var OriginSslProtocols: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.OriginSslProtocols] = js.native
}
