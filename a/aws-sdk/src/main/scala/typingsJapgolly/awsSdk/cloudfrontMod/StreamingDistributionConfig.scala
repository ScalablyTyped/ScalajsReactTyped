...
trait StreamingDistributionConfig extends js.Object {
  /**
    ...
    */
  var Aliases: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.Aliases] = js.native
  /**
  ...
  /**
    ...
    */
  var PriceClass: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.PriceClass] = js.native
  /**
    * A complex type that contains information about the Amazon S3 bucket from which you want CloudFront to get your media files for distribution. 
    */
  var S3Origin: typingsJapgolly.awsSdk.cloudfrontMod.S3Origin = js.native
  /**
