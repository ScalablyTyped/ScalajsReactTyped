...
trait LambdaFunctionAssociation extends js.Object {
  /**
    ...
    */
  var EventType: typingsJapgolly.awsSdk.cloudfrontMod.EventType = js.native
  /**
  ...
  /**
    ...
    */
  var LambdaFunctionARN: typingsJapgolly.awsSdk.cloudfrontMod.LambdaFunctionARN = js.native
}
