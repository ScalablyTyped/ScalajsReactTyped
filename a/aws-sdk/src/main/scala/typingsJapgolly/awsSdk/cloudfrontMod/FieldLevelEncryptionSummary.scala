...
trait FieldLevelEncryptionSummary extends js.Object {
  ...
  /**
    ...
    */
  var ContentTypeProfileConfig: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.ContentTypeProfileConfig] = js.native
  /**
  ...
  /**
    ...
    */
  var QueryArgProfileConfig: js.UndefOr[typingsJapgolly.awsSdk.cloudfrontMod.QueryArgProfileConfig] = js.native
}
