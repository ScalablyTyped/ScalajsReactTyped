...
trait CreateResourcePolicyStatementResponse extends StObject {
...
object CreateResourcePolicyStatementResponse {
  ...
  inline def apply(): CreateResourcePolicyStatementResponse = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CreateResourcePolicyStatementResponse]
  }
  
  extension [Self <: CreateResourcePolicyStatementResponse](x: Self) {
