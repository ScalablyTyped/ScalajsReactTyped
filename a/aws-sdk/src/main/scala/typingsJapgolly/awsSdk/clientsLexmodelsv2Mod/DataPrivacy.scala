...
trait DataPrivacy extends StObject {
...
object DataPrivacy {
  ...
  inline def apply(childDirected: ChildDirected): DataPrivacy = {
    val __obj = js.Dynamic.literal(childDirected = childDirected.asInstanceOf[js.Any])
