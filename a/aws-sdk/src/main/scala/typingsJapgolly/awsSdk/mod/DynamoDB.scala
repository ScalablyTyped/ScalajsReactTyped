...
/**
  ...
  */
class DynamoDB ()
  extends typingsJapgolly.awsSdk.allMod.DynamoDB {
...
object DynamoDB extends js.Object {
  @js.native
  class Converter ()
    extends typingsJapgolly.awsSdk.allMod.DynamoDB.Converter
  ...
  class DocumentClient ()
    extends typingsJapgolly.awsSdk.allMod.DynamoDB.DocumentClient {
