...
import typingsJapgolly.awsSdk.cloudfrontMod.ClientConfiguration
...
/**
  ...
  */
class CloudFront ()
  extends typingsJapgolly.awsSdk.allMod.CloudFront {
...
object CloudFront extends js.Object {
  ...
  class Signer protected ()
    extends typingsJapgolly.awsSdk.allMod.CloudFront.Signer {
    /**
