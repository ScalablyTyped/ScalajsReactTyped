...
import typingsJapgolly.awsSdk.webIdentityCredentialsMod.WebIdentityCredentials.WebIdentityCredentialsOptions
...
class WebIdentityCredentials ()
  extends typingsJapgolly.awsSdk.coreMod.WebIdentityCredentials {
  /**
