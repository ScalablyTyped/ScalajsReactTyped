...
/**
  ...
  */
open class S3 ()
  extends typingsJapgolly.awsSdk.clientsAllMod.S3 {
...
object S3 {
  ...
  open class ManagedUpload protected ()
    extends typingsJapgolly.awsSdk.clientsAllMod.S3.ManagedUpload {
    /**
  ...
  open class PresignedPost ()
    extends typingsJapgolly.awsSdk.clientsAllMod.S3.PresignedPost
}
