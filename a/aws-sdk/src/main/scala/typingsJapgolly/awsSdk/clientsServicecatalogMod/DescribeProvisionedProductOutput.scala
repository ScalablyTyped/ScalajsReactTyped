...
trait DescribeProvisionedProductOutput extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchDashboards: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.CloudWatchDashboards] = js.undefined
  
  /**
    * Information about the provisioned product.
    */
  var ProvisionedProductDetail: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisionedProductDetail] = js.undefined
}
