...
trait UpdateConstraintOutput extends StObject {
  ...
  /**
    ...
    */
  var ConstraintDetail: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ConstraintDetail] = js.undefined
  
  /**
    * The constraint parameters.
    */
  var ConstraintParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ConstraintParameters] = js.undefined
