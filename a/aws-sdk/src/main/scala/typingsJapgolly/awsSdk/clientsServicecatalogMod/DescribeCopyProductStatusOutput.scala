...
trait DescribeCopyProductStatusOutput extends StObject {
  ...
  /**
    ...
    */
  var CopyProductStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.CopyProductStatus] = js.undefined
  
  /**
    * The status message.
    */
  var StatusDetail: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.StatusDetail] = js.undefined
