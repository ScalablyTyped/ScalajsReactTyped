...
trait DescribeProductOutput extends StObject {
  ...
  /**
    ...
    */
  var LaunchPaths: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.LaunchPaths] = js.undefined
  
  /**
    * Summary information about the product view.
    */
  var ProductViewSummary: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProductViewSummary] = js.undefined
  
  /**
    * Information about the provisioning artifacts for the specified product.
    */
  var ProvisioningArtifacts: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisioningArtifacts] = js.undefined
}
