...
trait ResourceChange extends StObject {
  ...
  /**
    ...
    */
  var LogicalResourceId: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.LogicalResourceId] = js.undefined
  
  /**
    * The ID of the resource, if it was already created.
    */
  var PhysicalResourceId: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.PhysicalResourceId] = js.undefined
  
  /**
    * If the change type is Modify, indicates whether the existing resource is deleted and replaced with a new one.
    */
  var Replacement: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.Replacement] = js.undefined
  ...
  /**
    * The change scope.
    */
  var Scope: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.Scope] = js.undefined
}
