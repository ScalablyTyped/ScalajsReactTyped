...
trait ProvisionedProductAttribute extends StObject {
  ...
  /**
    ...
    */
  var PhysicalId: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.PhysicalId] = js.undefined
  ...
  /**
    ...
    */
  var UserArn: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.UserArn] = js.undefined
  
  /**
    * The ARN of the IAM user in the session. This ARN might contain a session ID.
    */
  var UserArnSession: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.UserArnSession] = js.undefined
}
