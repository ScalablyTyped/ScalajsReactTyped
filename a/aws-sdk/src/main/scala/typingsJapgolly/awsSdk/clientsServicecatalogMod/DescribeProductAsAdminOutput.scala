...
trait DescribeProductAsAdminOutput extends StObject {
  ...
  /**
    ...
    */
  var Budgets: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.Budgets] = js.undefined
  
  /**
    * Information about the product view.
    */
  var ProductViewDetail: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProductViewDetail] = js.undefined
  
  /**
    * Information about the provisioning artifacts (also known as versions) for the specified product.
    */
  var ProvisioningArtifactSummaries: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisioningArtifactSummaries] = js.undefined
  ...
  /**
    ...
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.Tags] = js.undefined
}
