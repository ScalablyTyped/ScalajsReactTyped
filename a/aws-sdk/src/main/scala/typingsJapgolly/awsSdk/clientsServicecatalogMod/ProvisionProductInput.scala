...
trait ProvisionProductInput extends StObject {
  ...
  /**
    ...
    */
  var ProvisioningParameters: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisioningParameters] = js.undefined
  
  /**
    * An object that contains information about the provisioning preferences for a stack set.
    */
  var ProvisioningPreferences: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisioningPreferences] = js.undefined
