...
trait AssociatePrincipalWithPortfolioInput extends StObject {
  ...
  /**
    ...
    */
  var PrincipalARN: typingsJapgolly.awsSdk.clientsServicecatalogMod.PrincipalARN
  
  /**
    * The principal type. The supported value is IAM.
    */
  var PrincipalType: typingsJapgolly.awsSdk.clientsServicecatalogMod.PrincipalType
}
