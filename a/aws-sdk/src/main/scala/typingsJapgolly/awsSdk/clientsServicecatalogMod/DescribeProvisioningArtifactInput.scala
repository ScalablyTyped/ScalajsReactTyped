...
trait DescribeProvisioningArtifactInput extends StObject {
  ...
  /**
    ...
    */
  var ProvisioningArtifactName: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisioningArtifactName] = js.undefined
  
  /**
    * Indicates whether a verbose level of detail is enabled.
    */
  var Verbose: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.Verbose] = js.undefined
}
