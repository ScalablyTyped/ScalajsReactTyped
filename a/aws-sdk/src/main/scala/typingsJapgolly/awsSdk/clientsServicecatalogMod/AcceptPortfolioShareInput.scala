...
trait AcceptPortfolioShareInput extends StObject {
  ...
  /**
    ...
    */
  var PortfolioShareType: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.PortfolioShareType] = js.undefined
}
object AcceptPortfolioShareInput {
  ...
  extension [Self <: AcceptPortfolioShareInput](x: Self) {
