...
trait DescribeProvisionedProductPlanOutput extends StObject {
  ...
  /**
    ...
    */
  var ProvisionedProductPlanDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisionedProductPlanDetails] = js.undefined
  
  /**
    * Information about the resource changes that will occur when the plan is executed.
    */
  var ResourceChanges: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ResourceChanges] = js.undefined
}
