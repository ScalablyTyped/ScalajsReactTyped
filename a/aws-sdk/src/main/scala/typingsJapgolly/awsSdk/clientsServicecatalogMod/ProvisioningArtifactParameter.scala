...
trait ProvisioningArtifactParameter extends StObject {
  ...
  /**
    * The default value.
    */
  var DefaultValue: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.DefaultValue] = js.undefined
  ...
  /**
    ...
    */
  var ParameterConstraints: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ParameterConstraints] = js.undefined
  
  /**
    * The parameter key.
    */
  var ParameterKey: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ParameterKey] = js.undefined
  
  /**
    * The parameter type.
    */
  var ParameterType: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ParameterType] = js.undefined
}
