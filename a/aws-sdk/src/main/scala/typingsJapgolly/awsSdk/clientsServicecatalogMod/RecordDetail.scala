...
trait RecordDetail extends StObject {
  ...
  /**
    ...
    */
  var ProvisionedProductName: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisionedProductName] = js.undefined
  
  /**
    * The type of provisioned product. The supported values are CFN_STACK and CFN_STACKSET.
    */
  var ProvisionedProductType: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProvisionedProductType] = js.undefined
  ...
  /**
    ...
    */
  var RecordErrors: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.RecordErrors] = js.undefined
  ...
  /**
    * One or more tags.
    */
  var RecordTags: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.RecordTags] = js.undefined
  
  /**
    * The record type.    PROVISION_PRODUCT     UPDATE_PROVISIONED_PRODUCT     TERMINATE_PROVISIONED_PRODUCT   
    */
  var RecordType: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.RecordType] = js.undefined
