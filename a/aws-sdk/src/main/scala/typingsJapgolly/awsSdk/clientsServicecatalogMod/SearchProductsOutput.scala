...
trait SearchProductsOutput extends StObject {
  ...
  /**
    ...
    */
  var ProductViewAggregations: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProductViewAggregations] = js.undefined
  
  /**
    * Information about the product views.
    */
  var ProductViewSummaries: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.ProductViewSummaries] = js.undefined
}
