...
trait RecordOutput extends StObject {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.Description] = js.undefined
  
  /**
    * The output key.
    */
  var OutputKey: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.OutputKey] = js.undefined
  
  /**
    * The output value.
    */
  var OutputValue: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.OutputValue] = js.undefined
}
object RecordOutput {
