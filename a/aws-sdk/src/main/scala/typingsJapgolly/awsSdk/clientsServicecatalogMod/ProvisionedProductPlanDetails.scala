...
trait ProvisionedProductPlanDetails extends StObject {
  ...
  /**
    ...
    */
  var NotificationArns: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.NotificationArns] = js.undefined
  ...
  /**
    * The status message.
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.StatusMessage] = js.undefined
