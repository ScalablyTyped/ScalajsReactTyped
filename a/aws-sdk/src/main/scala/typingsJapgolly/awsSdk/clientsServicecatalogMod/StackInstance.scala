...
trait StackInstance extends StObject {
  ...
  /**
    ...
    */
  var Region: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.Region] = js.undefined
  ...
  /**
    ...
    */
  var StackInstanceStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsServicecatalogMod.StackInstanceStatus] = js.undefined
}
