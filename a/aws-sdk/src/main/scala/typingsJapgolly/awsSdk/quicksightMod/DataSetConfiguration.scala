...
trait DataSetConfiguration extends js.Object {
  /**
    ...
    */
  var ColumnGroupSchemaList: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.ColumnGroupSchemaList] = js.native
  /**
    * Dataset schema.
    */
  var DataSetSchema: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.DataSetSchema] = js.native
  /**
    * Placeholder.
    */
