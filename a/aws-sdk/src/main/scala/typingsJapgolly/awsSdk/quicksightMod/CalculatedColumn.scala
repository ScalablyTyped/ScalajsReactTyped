...
trait CalculatedColumn extends js.Object {
  /**
    ...
    */
  var ColumnId: typingsJapgolly.awsSdk.quicksightMod.ColumnId = js.native
  /**
    * Column name.
    */
  var ColumnName: typingsJapgolly.awsSdk.quicksightMod.ColumnName = js.native
  /**
    * An expression that defines the calculated column.
    */
  var Expression: typingsJapgolly.awsSdk.quicksightMod.Expression = js.native
}
