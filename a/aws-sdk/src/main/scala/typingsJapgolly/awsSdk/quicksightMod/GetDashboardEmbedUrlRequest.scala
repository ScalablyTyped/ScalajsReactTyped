...
trait GetDashboardEmbedUrlRequest extends js.Object {
  ...
  /**
    ...
    */
  var IdentityType: typingsJapgolly.awsSdk.quicksightMod.IdentityType = js.native
  /**
  ...
  /**
    ...
    */
  var SessionLifetimeInMinutes: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.SessionLifetimeInMinutes] = js.native
  /**
