...
trait RedshiftParameters extends js.Object {
  /**
    ...
    */
  var ClusterId: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.ClusterId] = js.native
  /**
    * Database.
    */
  ...
  /**
    ...
    */
  var Host: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.Host] = js.native
  /**
