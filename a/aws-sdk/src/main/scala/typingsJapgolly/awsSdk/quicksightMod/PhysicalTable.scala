...
trait PhysicalTable extends js.Object {
  /**
    ...
    */
  var CustomSql: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.CustomSql] = js.native
  /**
    * A physical table type for relational data sources.
    */
  var RelationalTable: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.RelationalTable] = js.native
  /**
    * A physical table type for as S3 data source.
    */
  var S3Source: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.S3Source] = js.native
}
