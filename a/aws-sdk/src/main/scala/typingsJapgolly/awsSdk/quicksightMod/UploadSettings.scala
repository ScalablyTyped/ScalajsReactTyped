...
trait UploadSettings extends js.Object {
  ...
  /**
    ...
    */
  var Delimiter: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.Delimiter] = js.native
  /**
    * File format.
    */
  ...
  /**
    * Text qualifier.
    */
  var TextQualifier: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.TextQualifier] = js.native
}
