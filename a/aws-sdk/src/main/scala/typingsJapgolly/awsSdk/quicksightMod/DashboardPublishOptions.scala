...
trait DashboardPublishOptions extends js.Object {
  /**
    ...
    */
  var AdHocFilteringOption: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.AdHocFilteringOption] = js.native
  /**
    * Export to .csv option.
    */
  var ExportToCSVOption: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.ExportToCSVOption] = js.native
  /**
    * Sheet controls option.
    */
  var SheetControlsOption: js.UndefOr[typingsJapgolly.awsSdk.quicksightMod.SheetControlsOption] = js.native
}
