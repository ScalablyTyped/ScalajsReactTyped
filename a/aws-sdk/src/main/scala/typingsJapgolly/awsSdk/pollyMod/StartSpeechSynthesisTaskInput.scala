...
trait StartSpeechSynthesisTaskInput extends js.Object {
  /**
    ...
    */
  var Engine: js.UndefOr[typingsJapgolly.awsSdk.pollyMod.Engine] = js.native
  /**
  ...
  /**
    ...
    */
  var OutputFormat: typingsJapgolly.awsSdk.pollyMod.OutputFormat = js.native
  /**
    * Amazon S3 bucket name to which the output file will be saved.
    */
  var OutputS3BucketName: typingsJapgolly.awsSdk.pollyMod.OutputS3BucketName = js.native
  /**
    * The Amazon S3 key prefix for the output speech file.
    */
  var OutputS3KeyPrefix: js.UndefOr[typingsJapgolly.awsSdk.pollyMod.OutputS3KeyPrefix] = js.native
  /**
    ...
    */
  var SampleRate: js.UndefOr[typingsJapgolly.awsSdk.pollyMod.SampleRate] = js.native
  /**
    * ARN for the SNS topic optionally used for providing status notification for a speech synthesis task.
    */
  var SnsTopicArn: js.UndefOr[typingsJapgolly.awsSdk.pollyMod.SnsTopicArn] = js.native
  /**
  ...
  /**
    ...
    */
  var Text: typingsJapgolly.awsSdk.pollyMod.Text = js.native
  /**
    * Specifies whether the input text is plain text or SSML. The default value is plain text. 
    */
  var TextType: js.UndefOr[typingsJapgolly.awsSdk.pollyMod.TextType] = js.native
  /**
    * Voice ID to use for the synthesis. 
    */
  var VoiceId: typingsJapgolly.awsSdk.pollyMod.VoiceId = js.native
}
