...
trait Voice extends js.Object {
  ...
  /**
    * Gender of the voice.
    */
  var Gender: js.UndefOr[typingsJapgolly.awsSdk.pollyMod.Gender] = js.native
  /**
  ...
  /**
    ...
    */
  var LanguageName: js.UndefOr[typingsJapgolly.awsSdk.pollyMod.LanguageName] = js.native
  /**
