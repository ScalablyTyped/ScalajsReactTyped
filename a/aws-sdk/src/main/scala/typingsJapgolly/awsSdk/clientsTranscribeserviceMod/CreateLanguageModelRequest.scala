...
trait CreateLanguageModelRequest extends StObject {
  ...
  /**
    ...
    */
  var BaseModelName: typingsJapgolly.awsSdk.clientsTranscribeserviceMod.BaseModelName
  ...
  /**
    ...
    */
  var InputDataConfig: typingsJapgolly.awsSdk.clientsTranscribeserviceMod.InputDataConfig
