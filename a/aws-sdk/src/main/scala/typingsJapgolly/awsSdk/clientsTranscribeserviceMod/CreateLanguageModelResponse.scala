...
trait CreateLanguageModelResponse extends StObject {
  ...
  /**
    ...
    */
  var BaseModelName: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.BaseModelName] = js.undefined
  ...
  /**
    ...
    */
  var InputDataConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.InputDataConfig] = js.undefined
  ...
  /**
    ...
    */
  var ModelName: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.ModelName] = js.undefined
  
  /**
    * The status of your custom language model. When the status displays as COMPLETED, your model is ready to use.
    */
  var ModelStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.ModelStatus] = js.undefined
}
