...
trait Rule extends StObject {
  ...
  /**
    ...
    */
  var InterruptionFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.InterruptionFilter] = js.undefined
  
  /**
    * Flag the presence or absence of periods of silence in your Call Analytics transcription output. Refer to for more detail.
    */
  var NonTalkTimeFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.NonTalkTimeFilter] = js.undefined
  
  /**
    * Flag the presence or absence of specific sentiments in your Call Analytics transcription output. Refer to for more detail.
    */
  var SentimentFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.SentimentFilter] = js.undefined
  
  /**
    * Flag the presence or absence of specific words or phrases in your Call Analytics transcription output. Refer to for more detail.
    */
  var TranscriptFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.TranscriptFilter] = js.undefined
}
object Rule {
