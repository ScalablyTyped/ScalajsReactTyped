...
trait StartMedicalTranscriptionJobRequest extends StObject {
  ...
  /**
    ...
    */
  var LanguageCode: typingsJapgolly.awsSdk.clientsTranscribeserviceMod.LanguageCode
  
  var Media: typingsJapgolly.awsSdk.clientsTranscribeserviceMod.Media
  ...
  /**
    ...
    */
  var OutputBucketName: typingsJapgolly.awsSdk.clientsTranscribeserviceMod.OutputBucketName
  ...
  /**
    ...
    */
  var OutputKey: js.UndefOr[typingsJapgolly.awsSdk.clientsTranscribeserviceMod.OutputKey] = js.undefined
  ...
  /**
    ...
    */
  var Specialty: typingsJapgolly.awsSdk.clientsTranscribeserviceMod.Specialty
  ...
  /**
    ...
    */
  var Type: typingsJapgolly.awsSdk.clientsTranscribeserviceMod.Type
}
object StartMedicalTranscriptionJobRequest {
  ...
  extension [Self <: StartMedicalTranscriptionJobRequest](x: Self) {
