...
trait KinesisFirehoseDestination extends StObject {
  ...
  /**
    ...
    */
  var DeliveryStreamArn: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.DeliveryStreamArn
  ...
  /**
    ...
    */
  var IamRoleArn: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.IamRoleArn
}
