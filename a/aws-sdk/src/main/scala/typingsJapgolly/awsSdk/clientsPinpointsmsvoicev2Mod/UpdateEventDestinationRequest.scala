...
trait UpdateEventDestinationRequest extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchLogsDestination: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.CloudWatchLogsDestination] = js.undefined
  ...
  /**
    ...
    */
  var EventDestinationName: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.EventDestinationName
  
  /**
    * An object that contains information about an event destination for logging to Kinesis Data Firehose.
    */
  var KinesisFirehoseDestination: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.KinesisFirehoseDestination] = js.undefined
  ...
  /**
    ...
    */
  var SnsDestination: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.SnsDestination] = js.undefined
}
