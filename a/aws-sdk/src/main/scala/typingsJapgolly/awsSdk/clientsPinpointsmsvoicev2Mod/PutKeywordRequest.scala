...
trait PutKeywordRequest extends StObject {
  ...
  /**
    ...
    */
  var Keyword: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.Keyword
  ...
  /**
    ...
    */
  var KeywordMessage: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.KeywordMessage
