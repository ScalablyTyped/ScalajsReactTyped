...
trait ListPoolOriginationIdentitiesRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.MaxResults] = js.undefined
...
object ListPoolOriginationIdentitiesRequest {
  ...
  extension [Self <: ListPoolOriginationIdentitiesRequest](x: Self) {
