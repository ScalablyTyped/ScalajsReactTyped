...
trait PhoneNumberInformation extends StObject {
  ...
  /**
    ...
    */
  var IsoCountryCode: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.IsoCountryCode
  ...
  /**
    ...
    */
  var NumberType: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.NumberType
  
  /**
    * The name of the OptOutList associated with the phone number.
    */
  var OptOutListName: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.OptOutListName
  
  /**
    * The phone number in E.164 format.
    */
  var PhoneNumber: typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.PhoneNumber
