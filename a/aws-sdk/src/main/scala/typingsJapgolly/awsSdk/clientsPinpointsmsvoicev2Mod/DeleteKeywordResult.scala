...
trait DeleteKeywordResult extends StObject {
  ...
  /**
    ...
    */
  var KeywordAction: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.KeywordAction] = js.undefined
  
  /**
    * The message that was associated with the deleted keyword.
    */
  var KeywordMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.KeywordMessage] = js.undefined
