...
trait UpdatePhoneNumberResult extends StObject {
  ...
  /**
    ...
    */
  var IsoCountryCode: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.IsoCountryCode] = js.undefined
  
  /**
    * The type of message. Valid values are TRANSACTIONAL for messages that are critical or time-sensitive and PROMOTIONAL for messages that aren't critical or time-sensitive.
    */
  var MessageType: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.MessageType] = js.undefined
  ...
  /**
    ...
    */
  var NumberType: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.NumberType] = js.undefined
  
  /**
    * The name of the OptOutList associated with the phone number.
    */
  var OptOutListName: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.OptOutListName] = js.undefined
  
  /**
    * The phone number that was updated.
    */
  var PhoneNumber: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.PhoneNumber] = js.undefined
  ...
  /**
    ...
    */
  var TwoWayChannelArn: js.UndefOr[typingsJapgolly.awsSdk.clientsPinpointsmsvoicev2Mod.TwoWayChannelArn] = js.undefined
