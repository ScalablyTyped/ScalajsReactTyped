...
trait UpdateLayerRequest extends js.Object {
  ...
  /**
    ...
    */
  var CloudWatchLogsConfiguration: js.UndefOr[typingsJapgolly.awsSdk.opsworksMod.CloudWatchLogsConfiguration] = js.native
  /**
  ...
  /**
    * 
    */
  var LifecycleEventConfiguration: js.UndefOr[typingsJapgolly.awsSdk.opsworksMod.LifecycleEventConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var VolumeConfigurations: js.UndefOr[typingsJapgolly.awsSdk.opsworksMod.VolumeConfigurations] = js.native
}
