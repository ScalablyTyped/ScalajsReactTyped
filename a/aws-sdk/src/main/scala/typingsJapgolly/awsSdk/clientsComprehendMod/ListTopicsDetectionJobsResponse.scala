...
trait ListTopicsDetectionJobsResponse extends StObject {
  ...
  /**
    ...
    */
  var TopicsDetectionJobPropertiesList: js.UndefOr[typingsJapgolly.awsSdk.clientsComprehendMod.TopicsDetectionJobPropertiesList] = js.undefined
}
object ListTopicsDetectionJobsResponse {
  ...
  extension [Self <: ListTopicsDetectionJobsResponse](x: Self) {
