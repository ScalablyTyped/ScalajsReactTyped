...
trait HttpInstanceSummary extends StObject {
  ...
  /**
    ...
    */
  var HealthStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsServicediscoveryMod.HealthStatus] = js.undefined
  ...
  /**
    ...
    */
  var ServiceName: js.UndefOr[typingsJapgolly.awsSdk.clientsServicediscoveryMod.ServiceName] = js.undefined
}
