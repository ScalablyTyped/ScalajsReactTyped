...
trait NamespaceProperties extends StObject {
  ...
  /**
    ...
    */
  var DnsProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsServicediscoveryMod.DnsProperties] = js.undefined
  
  /**
    * A complex type that contains the name of an HTTP namespace.
    */
  var HttpProperties: js.UndefOr[typingsJapgolly.awsSdk.clientsServicediscoveryMod.HttpProperties] = js.undefined
}
