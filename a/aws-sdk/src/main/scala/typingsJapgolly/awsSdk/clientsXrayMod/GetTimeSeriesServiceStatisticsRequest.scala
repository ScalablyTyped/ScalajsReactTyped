...
trait GetTimeSeriesServiceStatisticsRequest extends StObject {
  ...
  /**
    ...
    */
  var EntitySelectorExpression: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.EntitySelectorExpression] = js.undefined
  ...
  /**
    ...
    */
  var GroupARN: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.GroupARN] = js.undefined
  
  /**
    * The case-sensitive name of the group for which to pull statistics from.
    */
  var GroupName: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.GroupName] = js.undefined
