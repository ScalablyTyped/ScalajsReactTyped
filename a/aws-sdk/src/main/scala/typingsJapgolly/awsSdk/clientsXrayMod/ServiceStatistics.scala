...
trait ServiceStatistics extends StObject {
  ...
  /**
    ...
    */
  var ErrorStatistics: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.ErrorStatistics] = js.undefined
  
  /**
    * Information about requests that failed with a 5xx Server Error status code.
    */
  var FaultStatistics: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.FaultStatistics] = js.undefined
