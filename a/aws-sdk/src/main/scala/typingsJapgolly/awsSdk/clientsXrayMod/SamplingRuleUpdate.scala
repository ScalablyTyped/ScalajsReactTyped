...
trait SamplingRuleUpdate extends StObject {
  ...
  /**
    ...
    */
  var HTTPMethod: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.HTTPMethod] = js.undefined
  
  /**
    * Matches the hostname from a request URL.
    */
  var Host: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.Host] = js.undefined
  ...
  /**
    ...
    */
  var ResourceARN: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.ResourceARN] = js.undefined
  ...
  /**
    ...
    */
  var ServiceName: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.ServiceName] = js.undefined
  
  /**
    * Matches the origin that the service uses to identify its type in segments.
    */
  var ServiceType: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.ServiceType] = js.undefined
  
  /**
    * Matches the path from a request URL.
    */
  var URLPath: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.URLPath] = js.undefined
}
