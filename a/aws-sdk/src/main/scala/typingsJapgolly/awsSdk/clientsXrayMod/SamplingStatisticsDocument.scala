...
trait SamplingStatisticsDocument extends StObject {
  ...
  /**
    ...
    */
  var BorrowCount: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.BorrowCount] = js.undefined
  
  /**
    * A unique identifier for the service in hexadecimal.
    */
  var ClientID: typingsJapgolly.awsSdk.clientsXrayMod.ClientID
  
  /**
    * The number of requests that matched the rule.
    */
  var RequestCount: typingsJapgolly.awsSdk.clientsXrayMod.RequestCount
  
  /**
    * The name of the sampling rule.
    */
  var RuleName: typingsJapgolly.awsSdk.clientsXrayMod.RuleName
  
  /**
    * The number of requests recorded.
    */
  var SampledCount: typingsJapgolly.awsSdk.clientsXrayMod.SampledCount
