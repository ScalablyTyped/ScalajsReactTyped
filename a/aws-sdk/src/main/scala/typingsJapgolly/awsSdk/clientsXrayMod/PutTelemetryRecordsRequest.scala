...
trait PutTelemetryRecordsRequest extends StObject {
  ...
  /**
    * 
    */
  var EC2InstanceId: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.EC2InstanceId] = js.undefined
  
  /**
    * 
    */
  var Hostname: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.Hostname] = js.undefined
