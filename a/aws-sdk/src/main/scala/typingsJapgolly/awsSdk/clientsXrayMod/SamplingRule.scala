...
trait SamplingRule extends StObject {
  ...
  /**
    ...
    */
  var FixedRate: typingsJapgolly.awsSdk.clientsXrayMod.FixedRate
  
  /**
    * Matches the HTTP method of a request.
    */
  var HTTPMethod: typingsJapgolly.awsSdk.clientsXrayMod.HTTPMethod
  
  /**
    * Matches the hostname from a request URL.
    */
  var Host: typingsJapgolly.awsSdk.clientsXrayMod.Host
  
  /**
    * The priority of the sampling rule.
    */
  var Priority: typingsJapgolly.awsSdk.clientsXrayMod.Priority
  
  /**
    * A fixed number of matching requests to instrument per second, prior to applying the fixed rate. The reservoir is not used directly by services, but applies to all services using the rule collectively.
    */
  var ReservoirSize: typingsJapgolly.awsSdk.clientsXrayMod.ReservoirSize
  
  /**
    * Matches the ARN of the Amazon Web Services resource on which the service runs.
    */
  var ResourceARN: typingsJapgolly.awsSdk.clientsXrayMod.ResourceARN
  ...
  /**
    ...
    */
  var RuleName: js.UndefOr[typingsJapgolly.awsSdk.clientsXrayMod.RuleName] = js.undefined
  
  /**
    * Matches the name that the service uses to identify itself in segments.
    */
  var ServiceName: typingsJapgolly.awsSdk.clientsXrayMod.ServiceName
  
  /**
    * Matches the origin that the service uses to identify its type in segments.
    */
  var ServiceType: typingsJapgolly.awsSdk.clientsXrayMod.ServiceType
  
  /**
    * Matches the path from a request URL.
    */
  var URLPath: typingsJapgolly.awsSdk.clientsXrayMod.URLPath
  
  /**
    * The version of the sampling rule format (1).
    */
  var Version: typingsJapgolly.awsSdk.clientsXrayMod.Version
}
object SamplingRule {
