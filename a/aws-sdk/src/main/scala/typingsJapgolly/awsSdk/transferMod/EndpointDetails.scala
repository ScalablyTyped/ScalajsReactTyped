...
trait EndpointDetails extends js.Object {
  /**
    ...
    */
  var AddressAllocationIds: js.UndefOr[typingsJapgolly.awsSdk.transferMod.AddressAllocationIds] = js.native
  /**
    * A list of subnet IDs that are required to host your SFTP server endpoint in your VPC.
    */
  var SubnetIds: js.UndefOr[typingsJapgolly.awsSdk.transferMod.SubnetIds] = js.native
  /**
    * The ID of the VPC endpoint.
    */
  var VpcEndpointId: js.UndefOr[typingsJapgolly.awsSdk.transferMod.VpcEndpointId] = js.native
  /**
    * The VPC ID of the virtual private cloud in which the SFTP server's endpoint will be hosted.
    */
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.transferMod.VpcId] = js.native
}
