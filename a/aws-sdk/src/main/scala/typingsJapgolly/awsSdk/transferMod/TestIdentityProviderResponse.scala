...
trait TestIdentityProviderResponse extends js.Object {
  /**
    ...
    */
  var Message: js.UndefOr[typingsJapgolly.awsSdk.transferMod.Message] = js.native
  /**
    * The response that is returned from your API Gateway.
    */
  var Response: js.UndefOr[typingsJapgolly.awsSdk.transferMod.Response] = js.native
  /**
    * The HTTP status code that is the response from your API Gateway.
    */
  var StatusCode: typingsJapgolly.awsSdk.transferMod.StatusCode = js.native
  /**
    * The endpoint of the service used to authenticate a user.
    */
  var Url: typingsJapgolly.awsSdk.transferMod.Url = js.native
}
