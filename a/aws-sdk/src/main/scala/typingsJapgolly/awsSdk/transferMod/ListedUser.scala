...
trait ListedUser extends js.Object {
  ...
  /**
    ...
    */
  var SshPublicKeyCount: js.UndefOr[typingsJapgolly.awsSdk.transferMod.SshPublicKeyCount] = js.native
  /**
    * The name of the user whose ARN was specified. User names are used for authentication purposes.
    */
  var UserName: js.UndefOr[typingsJapgolly.awsSdk.transferMod.UserName] = js.native
}
