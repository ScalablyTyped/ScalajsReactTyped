...
trait OutputConfig extends StObject {
  ...
  /**
    ...
    */
  var S3Bucket: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.S3Bucket] = js.undefined
  
  /**
    * The prefix applied to the training output files. 
    */
  var S3KeyPrefix: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.S3KeyPrefix] = js.undefined
}
object OutputConfig {
