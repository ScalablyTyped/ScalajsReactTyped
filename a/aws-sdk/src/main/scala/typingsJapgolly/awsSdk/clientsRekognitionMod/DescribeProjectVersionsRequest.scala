...
trait DescribeProjectVersionsRequest extends StObject {
  ...
  /**
    ...
    */
  var VersionNames: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.VersionNames] = js.undefined
}
object DescribeProjectVersionsRequest {
  ...
  extension [Self <: DescribeProjectVersionsRequest](x: Self) {
