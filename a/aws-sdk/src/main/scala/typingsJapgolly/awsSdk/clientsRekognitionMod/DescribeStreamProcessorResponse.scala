...
trait DescribeStreamProcessorResponse extends StObject {
  ...
  /**
    ...
    */
  var RegionsOfInterest: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.RegionsOfInterest] = js.undefined
  
  /**
    * ARN of the IAM role that allows access to the stream processor.
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.RoleArn] = js.undefined
  ...
  /**
    ...
    */
  var StreamProcessorArn: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.StreamProcessorArn] = js.undefined
}
