...
trait HumanLoopActivationOutput extends StObject {
  ...
  var HumanLoopActivationConditionsEvaluationResults: js.UndefOr[
    typingsJapgolly.awsSdk.clientsRekognitionMod.HumanLoopActivationConditionsEvaluationResults
  ] = js.undefined
  
  /**
    * Shows if and why human review was needed.
    */
  var HumanLoopActivationReasons: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.HumanLoopActivationReasons] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the HumanLoop created.
    */
  var HumanLoopArn: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.HumanLoopArn] = js.undefined
}
