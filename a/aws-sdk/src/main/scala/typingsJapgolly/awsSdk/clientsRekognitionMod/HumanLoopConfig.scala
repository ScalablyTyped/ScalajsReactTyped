...
trait HumanLoopConfig extends StObject {
  ...
  /**
    ...
    */
  var FlowDefinitionArn: typingsJapgolly.awsSdk.clientsRekognitionMod.FlowDefinitionArn
  
  /**
    * The name of the human review used for this image. This should be kept unique within a region.
    */
  var HumanLoopName: typingsJapgolly.awsSdk.clientsRekognitionMod.HumanLoopName
}
