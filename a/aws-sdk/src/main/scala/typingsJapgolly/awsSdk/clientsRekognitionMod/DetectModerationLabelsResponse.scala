...
trait DetectModerationLabelsResponse extends StObject {
  ...
  /**
    ...
    */
  var HumanLoopActivationOutput: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.HumanLoopActivationOutput] = js.undefined
  
  /**
    * Array of detected Moderation labels and the time, in milliseconds from the start of the video, they were detected.
    */
  var ModerationLabels: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.ModerationLabels] = js.undefined
