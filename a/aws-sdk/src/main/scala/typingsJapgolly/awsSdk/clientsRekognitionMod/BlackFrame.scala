...
trait BlackFrame extends StObject {
  ...
  /**
    ...
    */
  var MaxPixelThreshold: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.MaxPixelThreshold] = js.undefined
  ...
  /**
    ...
    */
  var MinCoveragePercentage: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.MinCoveragePercentage] = js.undefined
}
object BlackFrame {
