...
trait CreateProjectVersionRequest extends StObject {
  ...
  /**
    ...
    */
  var OutputConfig: typingsJapgolly.awsSdk.clientsRekognitionMod.OutputConfig
  ...
  /**
    ...
    */
  var TestingData: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.TestingData] = js.undefined
  ...
  /**
    ...
    */
  var TrainingData: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.TrainingData] = js.undefined
  
  /**
    * A name for the version of the model. This value must be unique.
    */
  var VersionName: typingsJapgolly.awsSdk.clientsRekognitionMod.VersionName
}
