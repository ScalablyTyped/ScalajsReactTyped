...
trait ProjectVersionDescription extends StObject {
  ...
  /**
    ...
    */
  var EvaluationResult: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.EvaluationResult] = js.undefined
  
  /**
    * The identifer for the AWS Key Management Service key (AWS KMS key) that was used to encrypt the model during training. 
    */
  var KmsKeyId: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.KmsKeyId] = js.undefined
  ...
  /**
    ...
    */
  var OutputConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.OutputConfig] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the model version. 
    */
  var ProjectVersionArn: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.ProjectVersionArn] = js.undefined
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.StatusMessage] = js.undefined
  
  /**
    * Contains information about the testing results.
    */
  var TestingDataResult: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.TestingDataResult] = js.undefined
  
  /**
    * Contains information about the training results.
    */
  var TrainingDataResult: js.UndefOr[typingsJapgolly.awsSdk.clientsRekognitionMod.TrainingDataResult] = js.undefined
