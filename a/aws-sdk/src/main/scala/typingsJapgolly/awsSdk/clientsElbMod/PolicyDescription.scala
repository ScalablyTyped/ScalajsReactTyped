...
trait PolicyDescription extends StObject {
  ...
  /**
    ...
    */
  var PolicyAttributeDescriptions: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.PolicyAttributeDescriptions] = js.undefined
  
  /**
    * The name of the policy.
    */
  var PolicyName: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.PolicyName] = js.undefined
