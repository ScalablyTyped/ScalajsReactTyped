...
trait LoadBalancerDescription extends StObject {
  ...
  /**
    ...
    */
  var AvailabilityZones: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.AvailabilityZones] = js.undefined
  
  /**
    * Information about your EC2 instances.
    */
  var BackendServerDescriptions: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.BackendServerDescriptions] = js.undefined
  ...
  /**
    ...
    */
  var DNSName: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.DNSName] = js.undefined
  
  /**
    * Information about the health checks conducted on the load balancer.
    */
  var HealthCheck: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.HealthCheck] = js.undefined
  
  /**
    * The IDs of the instances for the load balancer.
    */
  var Instances: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.Instances] = js.undefined
  
  /**
    * The listeners for the load balancer.
    */
  var ListenerDescriptions: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.ListenerDescriptions] = js.undefined
  ...
  /**
    ...
    */
  var Policies: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.Policies] = js.undefined
  ...
  /**
    ...
    */
  var SourceSecurityGroup: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.SourceSecurityGroup] = js.undefined
  
  /**
    * The IDs of the subnets for the load balancer.
    */
  var Subnets: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.Subnets] = js.undefined
  
  /**
    * The ID of the VPC for the load balancer.
    */
  var VPCId: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.VPCId] = js.undefined
}
