...
trait InstanceState extends StObject {
  ...
  /**
    ...
    */
  var ReasonCode: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.ReasonCode] = js.undefined
  
  /**
    * The current state of the instance. Valid values: InService | OutOfService | Unknown 
    */
  var State: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.State] = js.undefined
}
