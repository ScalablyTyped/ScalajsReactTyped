...
trait BackendServerDescription extends StObject {
  ...
  /**
    ...
    */
  var InstancePort: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.InstancePort] = js.undefined
  
  /**
    * The names of the policies enabled for the EC2 instance.
    */
  var PolicyNames: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.PolicyNames] = js.undefined
}
