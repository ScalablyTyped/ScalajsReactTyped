...
trait PolicyTypeDescription extends StObject {
  ...
  /**
    ...
    */
  var PolicyAttributeTypeDescriptions: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.PolicyAttributeTypeDescriptions] = js.undefined
  
  /**
    * The name of the policy type.
    */
  var PolicyTypeName: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.PolicyTypeName] = js.undefined
}
