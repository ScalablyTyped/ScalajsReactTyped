...
trait Policies extends StObject {
  ...
  /**
    ...
    */
  var AppCookieStickinessPolicies: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.AppCookieStickinessPolicies] = js.undefined
  
  /**
    * The stickiness policies created using CreateLBCookieStickinessPolicy.
    */
  var LBCookieStickinessPolicies: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.LBCookieStickinessPolicies] = js.undefined
