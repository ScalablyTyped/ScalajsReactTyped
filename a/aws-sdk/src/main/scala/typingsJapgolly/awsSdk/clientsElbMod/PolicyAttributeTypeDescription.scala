...
trait PolicyAttributeTypeDescription extends StObject {
  ...
  /**
    ...
    */
  var AttributeType: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.AttributeType] = js.undefined
  ...
  /**
    ...
    */
  var Cardinality: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.Cardinality] = js.undefined
  
  /**
    * The default value of the attribute, if applicable.
    */
  var DefaultValue: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.DefaultValue] = js.undefined
  
  /**
    * A description of the attribute.
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.Description] = js.undefined
}
