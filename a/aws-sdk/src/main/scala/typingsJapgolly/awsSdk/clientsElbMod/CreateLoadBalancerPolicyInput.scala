...
trait CreateLoadBalancerPolicyInput extends StObject {
  ...
  /**
    ...
    */
  var PolicyAttributes: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.PolicyAttributes] = js.undefined
  ...
  /**
    ...
    */
  var PolicyTypeName: typingsJapgolly.awsSdk.clientsElbMod.PolicyTypeName
}
