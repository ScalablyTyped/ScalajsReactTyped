...
trait Listener extends StObject {
  ...
  /**
    ...
    */
  var InstancePort: typingsJapgolly.awsSdk.clientsElbMod.InstancePort
  ...
  /**
    ...
    */
  var Protocol: typingsJapgolly.awsSdk.clientsElbMod.Protocol
  
  /**
    * The Amazon Resource Name (ARN) of the server certificate.
    */
  var SSLCertificateId: js.UndefOr[typingsJapgolly.awsSdk.clientsElbMod.SSLCertificateId] = js.undefined
}
object Listener {
