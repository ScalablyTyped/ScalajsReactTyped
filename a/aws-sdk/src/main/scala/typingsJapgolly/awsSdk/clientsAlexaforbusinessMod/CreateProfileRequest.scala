...
trait CreateProfileRequest extends StObject {
  ...
  /**
    ...
    */
  var Address: typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.Address
  ...
  /**
    ...
    */
  var DistanceUnit: typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.DistanceUnit
  ...
  /**
    ...
    */
  var ProfileName: typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.ProfileName
  ...
  /**
    ...
    */
  var TemperatureUnit: typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.TemperatureUnit
  
  /**
    * The time zone used by a room profile.
    */
  var Timezone: typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.Timezone
  
  /**
    * A wake word for Alexa, Echo, Amazon, or a computer.
    */
  var WakeWord: typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.WakeWord
}
