...
trait SkillSummary extends StObject {
  ...
  /**
    ...
    */
  var EnablementType: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.EnablementType] = js.undefined
  
  /**
    * The ARN of the skill summary.
    */
  var SkillId: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.SkillId] = js.undefined
  
  /**
    * The name of the skill.
    */
  var SkillName: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.SkillName] = js.undefined
  
  /**
    * Whether the skill is publicly available or is a private skill.
    */
  var SkillType: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.SkillType] = js.undefined
