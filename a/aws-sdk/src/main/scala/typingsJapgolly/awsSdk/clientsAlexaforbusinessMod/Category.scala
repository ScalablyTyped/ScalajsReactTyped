...
trait Category extends StObject {
  ...
  /**
    ...
    */
  var CategoryId: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.CategoryId] = js.undefined
  
  /**
    * The name of the skill store category.
    */
  var CategoryName: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.CategoryName] = js.undefined
}
object Category {
