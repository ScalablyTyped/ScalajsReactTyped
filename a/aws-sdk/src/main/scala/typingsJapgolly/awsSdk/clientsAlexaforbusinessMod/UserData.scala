...
trait UserData extends StObject {
  ...
  /**
    * The email of a user.
    */
  var Email: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.Email] = js.undefined
  
  /**
    * The enrollment ARN of a user.
    */
  var EnrollmentId: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.EnrollmentId] = js.undefined
  
  /**
    * The enrollment status of a user.
    */
  var EnrollmentStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.EnrollmentStatus] = js.undefined
