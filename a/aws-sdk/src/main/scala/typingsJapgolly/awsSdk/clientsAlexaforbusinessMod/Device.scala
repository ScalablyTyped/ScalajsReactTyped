...
trait Device extends StObject {
  ...
  /**
    ...
    */
  var DeviceName: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.DeviceName] = js.undefined
  
  /**
    * The serial number of a device.
    */
  var DeviceSerialNumber: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.DeviceSerialNumber] = js.undefined
  
  /**
    * The status of a device. If the status is not READY, check the DeviceStatusInfo value for details.
    */
  var DeviceStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.DeviceStatus] = js.undefined
  
  /**
    * Detailed information about a device's status.
    */
  var DeviceStatusInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.DeviceStatusInfo] = js.undefined
  
  /**
    * The type of a device.
    */
  var DeviceType: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.DeviceType] = js.undefined
  
  /**
    * The MAC address of a device.
    */
  var MacAddress: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.MacAddress] = js.undefined
  ...
  /**
    ...
    */
  var SoftwareVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.SoftwareVersion] = js.undefined
}
object Device {
