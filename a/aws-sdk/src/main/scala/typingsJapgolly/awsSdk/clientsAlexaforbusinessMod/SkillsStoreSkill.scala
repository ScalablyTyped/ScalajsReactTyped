...
trait SkillsStoreSkill extends StObject {
  ...
  /**
    ...
    */
  var IconUrl: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.IconUrl] = js.undefined
  
  /**
    * Sample utterances that interact with the skill.
    */
  var SampleUtterances: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.SampleUtterances] = js.undefined
  
  /**
    * Short description about the skill.
    */
  var ShortDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.ShortDescription] = js.undefined
  
  /**
    * Information about the skill.
    */
  var SkillDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsAlexaforbusinessMod.SkillDetails] = js.undefined
