...
trait FieldLevelEncryptionConfig extends StObject {
  ...
  /**
    ...
    */
  var ContentTypeProfileConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.ContentTypeProfileConfig] = js.undefined
  
  /**
    * A complex data type that specifies when to forward content if a profile isn't found and the profile that can be provided as a query argument in a request.
    */
  var QueryArgProfileConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.QueryArgProfileConfig] = js.undefined
}
