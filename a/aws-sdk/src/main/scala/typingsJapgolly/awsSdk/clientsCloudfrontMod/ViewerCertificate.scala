...
trait ViewerCertificate extends StObject {
  ...
  /**
    * This field is deprecated. Use one of the following fields instead:    ACMCertificateArn     IAMCertificateId     CloudFrontDefaultCertificate   
    */
  var CertificateSource: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.CertificateSource] = js.undefined
  ...
  /**
    ...
    */
  var MinimumProtocolVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.MinimumProtocolVersion] = js.undefined
  ...
  /**
    ...
    */
  var SSLSupportMethod: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.SSLSupportMethod] = js.undefined
}
