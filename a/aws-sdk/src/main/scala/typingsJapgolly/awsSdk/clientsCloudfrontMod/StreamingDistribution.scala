...
trait StreamingDistribution extends StObject {
  ...
  /**
    ...
    */
  var ActiveTrustedSigners: typingsJapgolly.awsSdk.clientsCloudfrontMod.ActiveTrustedSigners
  ...
  /**
    ...
    */
  var StreamingDistributionConfig: typingsJapgolly.awsSdk.clientsCloudfrontMod.StreamingDistributionConfig
}
