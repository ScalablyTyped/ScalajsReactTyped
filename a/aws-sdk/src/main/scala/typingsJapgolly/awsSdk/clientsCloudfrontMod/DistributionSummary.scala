...
trait DistributionSummary extends StObject {
  ...
  /**
    ...
    */
  var AliasICPRecordals: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.AliasICPRecordals] = js.undefined
  
  /**
    * A complex type that contains information about CNAMEs (alternate domain names), if any, for this distribution.
    */
  var Aliases: typingsJapgolly.awsSdk.clientsCloudfrontMod.Aliases
  
  /**
    * A complex type that contains zero or more CacheBehavior elements.
    */
  var CacheBehaviors: typingsJapgolly.awsSdk.clientsCloudfrontMod.CacheBehaviors
  ...
  /**
    ...
    */
  var CustomErrorResponses: typingsJapgolly.awsSdk.clientsCloudfrontMod.CustomErrorResponses
  ...
  /**
    ...
    */
  var HttpVersion: typingsJapgolly.awsSdk.clientsCloudfrontMod.HttpVersion
  ...
  /**
    ...
    */
  var PriceClass: typingsJapgolly.awsSdk.clientsCloudfrontMod.PriceClass
  
  /**
    * A complex type that identifies ways in which you want to restrict distribution of your content.
    */
  var Restrictions: typingsJapgolly.awsSdk.clientsCloudfrontMod.Restrictions
  ...
  /**
    ...
    */
  var ViewerCertificate: typingsJapgolly.awsSdk.clientsCloudfrontMod.ViewerCertificate
