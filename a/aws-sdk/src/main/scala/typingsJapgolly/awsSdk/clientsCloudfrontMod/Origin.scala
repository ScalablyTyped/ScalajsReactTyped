...
trait Origin extends StObject {
  ...
  /**
    ...
    */
  var CustomHeaders: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.CustomHeaders] = js.undefined
  
  /**
    * Use this type to specify an origin that is not an Amazon S3 bucket, with one exception. If the Amazon S3 bucket is configured with static website hosting, use this type. If the Amazon S3 bucket is not configured with static website hosting, use the S3OriginConfig type instead.
    */
  var CustomOriginConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.CustomOriginConfig] = js.undefined
  ...
  /**
    ...
    */
  var OriginShield: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.OriginShield] = js.undefined
  
  /**
    * Use this type to specify an origin that is an Amazon S3 bucket that is not configured with static website hosting. To specify any other type of origin, including an Amazon S3 bucket that is configured with static website hosting, use the CustomOriginConfig type instead.
    */
  var S3OriginConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.S3OriginConfig] = js.undefined
}
object Origin {
