...
trait CustomOriginConfig extends StObject {
  ...
  /**
    ...
    */
  var OriginProtocolPolicy: typingsJapgolly.awsSdk.clientsCloudfrontMod.OriginProtocolPolicy
  ...
  /**
    ...
    */
  var OriginSslProtocols: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.OriginSslProtocols] = js.undefined
}
