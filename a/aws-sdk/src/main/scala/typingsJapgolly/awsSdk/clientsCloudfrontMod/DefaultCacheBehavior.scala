...
trait DefaultCacheBehavior extends StObject {
  ...
  var AllowedMethods: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.AllowedMethods] = js.undefined
  ...
  /**
    ...
    */
  var ForwardedValues: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.ForwardedValues] = js.undefined
  
  /**
    * A list of CloudFront functions that are associated with this cache behavior. CloudFront functions must be published to the LIVE stage to associate them with a cache behavior.
    */
  var FunctionAssociations: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.FunctionAssociations] = js.undefined
  
  /**
    * A complex type that contains zero or more Lambda@Edge function associations for a cache behavior.
    */
  var LambdaFunctionAssociations: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.LambdaFunctionAssociations] = js.undefined
  ...
  /**
    ...
    */
  var TrustedKeyGroups: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.TrustedKeyGroups] = js.undefined
  ...
  /**
    ...
    */
  var TrustedSigners: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.TrustedSigners] = js.undefined
  ...
  /**
    ...
    */
  var ViewerProtocolPolicy: typingsJapgolly.awsSdk.clientsCloudfrontMod.ViewerProtocolPolicy
}
