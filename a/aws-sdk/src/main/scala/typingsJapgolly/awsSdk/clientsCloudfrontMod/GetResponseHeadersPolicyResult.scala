...
trait GetResponseHeadersPolicyResult extends StObject {
  ...
  /**
    ...
    */
  var ResponseHeadersPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsCloudfrontMod.ResponseHeadersPolicy] = js.undefined
}
object GetResponseHeadersPolicyResult {
  ...
  extension [Self <: GetResponseHeadersPolicyResult](x: Self) {
