...
object CloudFrontOriginAccessIdentityList {
  ...
  inline def apply(IsTruncated: Boolean, Marker: String, MaxItems: integer, Quantity: integer): CloudFrontOriginAccessIdentityList = {
  ...
  extension [Self <: CloudFrontOriginAccessIdentityList](x: Self) {
    ...
    inline def setItems(value: CloudFrontOriginAccessIdentitySummaryList): Self = StObject.set(x, "Items", value.asInstanceOf[js.Any])
    
    inline def setItemsUndefined: Self = StObject.set(x, "Items", js.undefined)
    
    inline def setItemsVarargs(value: CloudFrontOriginAccessIdentitySummary*): Self = StObject.set(x, "Items", js.Array(value*))
