...
trait LambdaFunctionAssociation extends StObject {
  ...
  /**
    ...
    */
  var EventType: typingsJapgolly.awsSdk.clientsCloudfrontMod.EventType
  ...
  /**
    ...
    */
  var LambdaFunctionARN: typingsJapgolly.awsSdk.clientsCloudfrontMod.LambdaFunctionARN
}
