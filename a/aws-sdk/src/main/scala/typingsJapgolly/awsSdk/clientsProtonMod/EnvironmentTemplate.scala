...
trait EnvironmentTemplate extends StObject {
...
object EnvironmentTemplate {
  ...
  inline def apply(arn: EnvironmentTemplateArn, createdAt: js.Date, lastModifiedAt: js.Date, name: ResourceName): EnvironmentTemplate = {
  ...
  extension [Self <: EnvironmentTemplate](x: Self) {
