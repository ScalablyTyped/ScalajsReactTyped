...
trait PermissionsBoundary extends StObject {
  ...
  /**
    ...
    */
  var CustomerManagedPolicyReference: js.UndefOr[typingsJapgolly.awsSdk.clientsSsoadminMod.CustomerManagedPolicyReference] = js.undefined
  
  /**
    * The AWS managed policy ARN that you want to attach to a permission set as a permissions boundary.
    */
  var ManagedPolicyArn: js.UndefOr[typingsJapgolly.awsSdk.clientsSsoadminMod.ManagedPolicyArn] = js.undefined
}
