...
trait VPC extends StObject {
  ...
  var VPCId: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53Mod.VPCId] = js.undefined
  
  /**
    * (Private hosted zones only) The region that an Amazon VPC was created in.
    */
  var VPCRegion: js.UndefOr[typingsJapgolly.awsSdk.clientsRoute53Mod.VPCRegion] = js.undefined
}
object VPC {
