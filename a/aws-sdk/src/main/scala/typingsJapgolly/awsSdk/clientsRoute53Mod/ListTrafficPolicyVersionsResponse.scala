...
trait ListTrafficPolicyVersionsResponse extends StObject {
  ...
  /**
    ...
    */
  var TrafficPolicies: typingsJapgolly.awsSdk.clientsRoute53Mod.TrafficPolicies
  ...
  /**
    ...
    */
  var TrafficPolicyVersionMarker: typingsJapgolly.awsSdk.clientsRoute53Mod.TrafficPolicyVersionMarker
}
