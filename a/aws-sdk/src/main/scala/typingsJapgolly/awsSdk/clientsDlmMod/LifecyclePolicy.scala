...
trait LifecyclePolicy extends StObject {
  ...
  /**
    ...
    */
  var ExecutionRoleArn: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.ExecutionRoleArn] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the policy.
    */
  var PolicyArn: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.PolicyArn] = js.undefined
  
  /**
    * The configuration of the lifecycle policy
    */
  var PolicyDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.PolicyDetails] = js.undefined
  
  /**
    * The identifier of the lifecycle policy.
    */
  var PolicyId: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.PolicyId] = js.undefined
  ...
  /**
    ...
    */
  var StatusMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.StatusMessage] = js.undefined
