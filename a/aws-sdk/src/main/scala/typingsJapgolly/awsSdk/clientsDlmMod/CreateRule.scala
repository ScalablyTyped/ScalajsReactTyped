...
trait CreateRule extends StObject {
  ...
  /**
    ...
    */
  var CronExpression: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.CronExpression] = js.undefined
  
  /**
    * The interval between snapshots. The supported values are 1, 2, 3, 4, 6, 8, 12, and 24.
    */
  var Interval: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.Interval] = js.undefined
