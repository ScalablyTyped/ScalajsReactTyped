...
trait Schedule extends StObject {
  ...
  /**
    ...
    */
  var ArchiveRule: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.ArchiveRule] = js.undefined
  
  /**
    * Copy all user-defined tags on a source volume to snapshots of the volume created by this policy.
    */
  var CopyTags: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.CopyTags] = js.undefined
  
  /**
    * The creation rule.
    */
  var CreateRule: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.CreateRule] = js.undefined
  ...
  /**
    ...
    */
  var CrossRegionCopyRules: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.CrossRegionCopyRules] = js.undefined
  
  /**
    *  [AMI policies only] The AMI deprecation rule for the schedule.
    */
  var DeprecateRule: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.DeprecateRule] = js.undefined
  
  /**
    *  [Snapshot policies only] The rule for enabling fast snapshot restore.
    */
  var FastRestoreRule: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.FastRestoreRule] = js.undefined
  ...
  /**
    ...
    */
  var RetainRule: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.RetainRule] = js.undefined
  
  /**
    *  [Snapshot policies only] The rule for sharing snapshots with other Amazon Web Services accounts.
    */
  var ShareRules: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.ShareRules] = js.undefined
