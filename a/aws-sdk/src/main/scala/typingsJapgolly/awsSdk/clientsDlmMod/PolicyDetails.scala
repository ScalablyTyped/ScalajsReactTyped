...
trait PolicyDetails extends StObject {
  ...
  /**
    ...
    */
  var EventSource: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.EventSource] = js.undefined
  ...
  /**
    ...
    */
  var Parameters: js.UndefOr[typingsJapgolly.awsSdk.clientsDlmMod.Parameters] = js.undefined
