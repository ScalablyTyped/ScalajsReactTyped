...
trait GetMailboxDetailsResponse extends js.Object {
  /**
    ...
    */
  var MailboxQuota: js.UndefOr[typingsJapgolly.awsSdk.workmailMod.MailboxQuota] = js.native
  /**
    * The current mailbox size, in MB, for the specified user.
    */
  var MailboxSize: js.UndefOr[typingsJapgolly.awsSdk.workmailMod.MailboxSize] = js.native
}
