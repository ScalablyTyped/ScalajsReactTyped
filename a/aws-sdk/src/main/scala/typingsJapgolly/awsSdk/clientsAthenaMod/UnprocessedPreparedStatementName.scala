...
trait UnprocessedPreparedStatementName extends StObject {
  ...
  /**
    ...
    */
  var ErrorCode: js.UndefOr[typingsJapgolly.awsSdk.clientsAthenaMod.ErrorCode] = js.undefined
  ...
  /**
    ...
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.clientsAthenaMod.ErrorMessage] = js.undefined
  
  /**
    * The name of a prepared statement that could not be returned due to an error.
    */
  var StatementName: js.UndefOr[typingsJapgolly.awsSdk.clientsAthenaMod.StatementName] = js.undefined
}
