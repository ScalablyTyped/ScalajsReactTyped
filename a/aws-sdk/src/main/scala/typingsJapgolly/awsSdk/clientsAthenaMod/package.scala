...
import typingsJapgolly.awsSdk.awsSdkStrings.BUCKET_OWNER_FULL_CONTROL
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.awsSdk.awsSdkStrings.GLUE
  - typingsJapgolly.awsSdk.awsSdkStrings.HIVE
  - java.lang.String
*/
