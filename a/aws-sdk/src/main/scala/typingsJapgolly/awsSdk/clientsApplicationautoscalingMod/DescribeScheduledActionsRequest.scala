...
trait DescribeScheduledActionsRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationautoscalingMod.MaxResults] = js.undefined
  ...
  /**
    ...
    */
  var ScalableDimension: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationautoscalingMod.ScalableDimension] = js.undefined
...
object DescribeScheduledActionsRequest {
  ...
  inline def apply(ServiceNamespace: ServiceNamespace): DescribeScheduledActionsRequest = {
  ...
  extension [Self <: DescribeScheduledActionsRequest](x: Self) {
    ...
    inline def setScheduledActionNames(value: ResourceIdsMaxLen1600): Self = StObject.set(x, "ScheduledActionNames", value.asInstanceOf[js.Any])
    
    inline def setScheduledActionNamesUndefined: Self = StObject.set(x, "ScheduledActionNames", js.undefined)
    
    inline def setScheduledActionNamesVarargs(value: ResourceIdMaxLen1600*): Self = StObject.set(x, "ScheduledActionNames", js.Array(value*))
