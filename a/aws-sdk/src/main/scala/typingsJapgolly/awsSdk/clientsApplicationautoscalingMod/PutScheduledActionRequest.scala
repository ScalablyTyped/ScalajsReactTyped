...
trait PutScheduledActionRequest extends StObject {
  ...
  /**
    ...
    */
  var ScalableTargetAction: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationautoscalingMod.ScalableTargetAction] = js.undefined
  ...
  /**
    ...
    */
  var ScheduledActionName: typingsJapgolly.awsSdk.clientsApplicationautoscalingMod.ScheduledActionName
