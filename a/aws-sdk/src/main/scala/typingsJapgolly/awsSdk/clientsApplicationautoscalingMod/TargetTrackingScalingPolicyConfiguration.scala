...
trait TargetTrackingScalingPolicyConfiguration extends StObject {
  ...
  var CustomizedMetricSpecification: js.UndefOr[
    typingsJapgolly.awsSdk.clientsApplicationautoscalingMod.CustomizedMetricSpecification
  ] = js.undefined
  
  /**
    * Indicates whether scale in by the target tracking scaling policy is disabled. If the value is true, scale in is disabled and the target tracking scaling policy won't remove capacity from the scalable target. Otherwise, scale in is enabled and the target tracking scaling policy can remove capacity from the scalable target. The default value is false.
    */
  var DisableScaleIn: js.UndefOr[typingsJapgolly.awsSdk.clientsApplicationautoscalingMod.DisableScaleIn] = js.undefined
  
  /**
    * A predefined metric. You can specify either a predefined metric or a customized metric.
    */
  var PredefinedMetricSpecification: js.UndefOr[
    typingsJapgolly.awsSdk.clientsApplicationautoscalingMod.PredefinedMetricSpecification
  ] = js.undefined
