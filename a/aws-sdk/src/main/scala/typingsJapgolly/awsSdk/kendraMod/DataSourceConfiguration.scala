...
trait DataSourceConfiguration extends js.Object {
  /**
    ...
    */
  var DatabaseConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.DatabaseConfiguration] = js.native
  /**
  ...
  /**
    ...
    */
  var SharePointConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.SharePointConfiguration] = js.native
}
