...
trait QueryRequest extends js.Object {
  /**
    ...
    */
  var AttributeFilter: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.AttributeFilter] = js.native
  /**
  ...
  /**
    ...
    */
  var QueryText: typingsJapgolly.awsSdk.kendraMod.QueryText = js.native
  /**
