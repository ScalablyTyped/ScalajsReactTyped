...
trait IndexStatistics extends js.Object {
  /**
    ...
    */
  var FaqStatistics: typingsJapgolly.awsSdk.kendraMod.FaqStatistics = js.native
  /**
    * The number of text documents indexed.
    */
  var TextDocumentStatistics: typingsJapgolly.awsSdk.kendraMod.TextDocumentStatistics = js.native
}
