...
trait DatabaseConfiguration extends js.Object {
  /**
    ...
    */
  var AclConfiguration: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.AclConfiguration] = js.native
  /**
    * Information about where the index should get the document information from the database.
    */
  var ColumnConfiguration: typingsJapgolly.awsSdk.kendraMod.ColumnConfiguration = js.native
  /**
    * The information necessary to connect to a database.
    */
  var ConnectionConfiguration: typingsJapgolly.awsSdk.kendraMod.ConnectionConfiguration = js.native
  /**
    * The type of database engine that runs the database.
    */
  var DatabaseEngineType: typingsJapgolly.awsSdk.kendraMod.DatabaseEngineType = js.native
