...
trait DescribeFaqResponse extends js.Object {
  ...
  /**
    ...
    */
  var Description: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.Description] = js.native
  /**
    * If the Status field is FAILED, the ErrorMessage field contains the reason why the FAQ failed.
    */
  var ErrorMessage: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.ErrorMessage] = js.native
  /**
  ...
  /**
    ...
    */
  var IndexId: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.IndexId] = js.native
  /**
  ...
  /**
    ...
    */
  var RoleArn: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.RoleArn] = js.native
  var S3Path: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.S3Path] = js.native
  /**
