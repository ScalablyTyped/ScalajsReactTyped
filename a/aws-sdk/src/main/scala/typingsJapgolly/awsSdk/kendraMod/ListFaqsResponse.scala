...
trait ListFaqsResponse extends js.Object {
  /**
    ...
    */
  var FaqSummaryItems: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.FaqSummaryItems] = js.native
  /**
    ...
    */
  var NextToken: js.UndefOr[typingsJapgolly.awsSdk.kendraMod.NextToken] = js.native
}
