...
trait ContinuousBackupsDescription extends js.Object {
  /**
    ...
    */
  var ContinuousBackupsStatus: typingsJapgolly.awsSdk.dynamodbMod.ContinuousBackupsStatus = js.native
  /**
    * The description of the point in time recovery settings applied to the table.
    */
  var PointInTimeRecoveryDescription: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.PointInTimeRecoveryDescription] = js.native
}
