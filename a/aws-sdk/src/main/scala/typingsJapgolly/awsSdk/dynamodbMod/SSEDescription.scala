...
trait SSEDescription extends js.Object {
  ...
  /**
    ...
    */
  var KMSMasterKeyArn: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.KMSMasterKeyArn] = js.native
  /**
    ...
    */
  var SSEType: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.SSEType] = js.native
  /**
