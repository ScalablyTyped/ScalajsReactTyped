...
trait BackupSummary extends js.Object {
  /**
    ...
    */
  var BackupArn: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.BackupArn] = js.native
  /**
  ...
  /**
    ...
    */
  var BackupName: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.BackupName] = js.native
  /**
  ...
  /**
    ...
    */
  var BackupStatus: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.BackupStatus] = js.native
  /**
    ...
    */
  var BackupType: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.BackupType] = js.native
  /**
    * ARN associated with the table.
    */
  var TableArn: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.TableArn] = js.native
  /**
    * Unique identifier for the table.
    */
  var TableId: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.TableId] = js.native
  /**
    * Name of the table.
    */
  var TableName: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.TableName] = js.native
}
