...
trait DescribeContributorInsightsOutput extends js.Object {
  /**
    ...
    */
  var ContributorInsightsRuleList: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.ContributorInsightsRuleList] = js.native
  /**
  ...
  /**
    ...
    */
  var FailureException: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.FailureException] = js.native
  /**
