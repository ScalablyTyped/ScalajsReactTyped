...
trait QueryInput extends js.Object {
  ...
  /**
    ...
    */
  var KeyConditions: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.KeyConditions] = js.native
  /**
  ...
  /**
    ...
    */
  var Select: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.Select] = js.native
  /**
