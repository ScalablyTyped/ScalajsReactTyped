...
trait BackupDescription extends js.Object {
  ...
  /**
    ...
    */
  var SourceTableDetails: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.SourceTableDetails] = js.native
  /**
    * Contains the details of the features enabled on the table when the backup was created. For example, LSIs, GSIs, streams, TTL.
    */
  var SourceTableFeatureDetails: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.SourceTableFeatureDetails] = js.native
}
