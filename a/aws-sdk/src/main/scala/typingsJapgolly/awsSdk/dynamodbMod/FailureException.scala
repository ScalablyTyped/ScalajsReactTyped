...
trait FailureException extends js.Object {
  /**
    ...
    */
  var ExceptionDescription: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.ExceptionDescription] = js.native
  /**
    * Exception name.
    */
  var ExceptionName: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.ExceptionName] = js.native
}
