...
trait GlobalSecondaryIndexDescription extends js.Object {
  /**
    ...
    */
  var Backfilling: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.Backfilling] = js.native
  /**
  ...
  /**
    ...
    */
  var IndexName: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.IndexName] = js.native
  /**
  ...
  /**
    ...
    */
  var IndexStatus: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.IndexStatus] = js.native
  /**
  ...
  /**
    ...
    */
  var KeySchema: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.KeySchema] = js.native
  /**
    * Represents attributes that are copied (projected) from the table into the global secondary index. These are in addition to the primary key attributes and index key attributes, which are automatically projected. 
    */
  var Projection: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.Projection] = js.native
  /**
