...
trait SourceTableDetails extends js.Object {
  /**
    ...
    */
  var BillingMode: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.BillingMode] = js.native
  /**
    * Number of items in the table. Note that this is an approximate value. 
    */
  var ItemCount: js.UndefOr[typingsJapgolly.awsSdk.dynamodbMod.ItemCount] = js.native
  /**
    * Schema of the table. 
    */
  ...
  /**
    ...
    */
  var ProvisionedThroughput: typingsJapgolly.awsSdk.dynamodbMod.ProvisionedThroughput = js.native
  /**
  ...
  /**
    ...
    */
  var TableId: typingsJapgolly.awsSdk.dynamodbMod.TableId = js.native
  /**
