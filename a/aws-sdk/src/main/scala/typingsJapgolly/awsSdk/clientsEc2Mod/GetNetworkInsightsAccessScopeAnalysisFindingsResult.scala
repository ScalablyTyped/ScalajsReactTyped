...
trait GetNetworkInsightsAccessScopeAnalysisFindingsResult extends StObject {
  ...
  /**
    ...
    */
  var AnalysisStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.AnalysisStatus] = js.undefined
...
object GetNetworkInsightsAccessScopeAnalysisFindingsResult {
  ...
  extension [Self <: GetNetworkInsightsAccessScopeAnalysisFindingsResult](x: Self) {
