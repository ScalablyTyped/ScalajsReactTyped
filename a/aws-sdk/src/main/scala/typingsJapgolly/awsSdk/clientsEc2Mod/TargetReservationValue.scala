...
trait TargetReservationValue extends StObject {
  ...
  /**
    ...
    */
  var ReservationValue: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ReservationValue] = js.undefined
  
  /**
    * The configuration of the Convertible Reserved Instances that make up the exchange.
    */
  var TargetConfiguration: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.TargetConfiguration] = js.undefined
}
