...
trait InstanceTypeOffering extends StObject {
  ...
  /**
    ...
    */
  var Location: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.Location] = js.undefined
  
  /**
    * The location type.
    */
  var LocationType: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.LocationType] = js.undefined
}
