...
trait CreateIpamPoolRequest extends StObject {
  ...
  /**
    ...
    */
  var AddressFamily: typingsJapgolly.awsSdk.clientsEc2Mod.AddressFamily
  ...
  /**
    ...
    */
  var IpamScopeId: typingsJapgolly.awsSdk.clientsEc2Mod.IpamScopeId
...
object CreateIpamPoolRequest {
  ...
  extension [Self <: CreateIpamPoolRequest](x: Self) {
