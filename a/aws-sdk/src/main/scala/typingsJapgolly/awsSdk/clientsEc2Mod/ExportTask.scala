...
trait ExportTask extends StObject {
  ...
  /**
    ...
    */
  var ExportToS3Task: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ExportToS3Task] = js.undefined
  
  /**
    * Information about the instance to export.
    */
  var InstanceExportDetails: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.InstanceExportDetails] = js.undefined
