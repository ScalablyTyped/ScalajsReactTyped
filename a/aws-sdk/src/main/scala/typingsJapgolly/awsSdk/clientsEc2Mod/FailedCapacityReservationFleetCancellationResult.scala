...
trait FailedCapacityReservationFleetCancellationResult extends StObject {
  ...
  /**
    ...
    */
  var CancelCapacityReservationFleetError: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.CancelCapacityReservationFleetError] = js.undefined
  
  /**
    * The ID of the Capacity Reservation Fleet that could not be cancelled.
    */
  var CapacityReservationFleetId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.CapacityReservationFleetId] = js.undefined
}
