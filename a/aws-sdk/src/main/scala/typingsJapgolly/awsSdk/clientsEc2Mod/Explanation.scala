...
trait Explanation extends StObject {
  ...
  /**
    ...
    */
  var ComponentAccount: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ComponentAccount] = js.undefined
  
  /**
    * The Region for the component.
    */
  var ComponentRegion: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ComponentRegion] = js.undefined
  ...
  /**
    * The port.
    */
  var Port: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.Port] = js.undefined
  ...
  /**
    ...
    */
  var TransitGatewayRouteTableRoute: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.TransitGatewayRouteTableRoute] = js.undefined
