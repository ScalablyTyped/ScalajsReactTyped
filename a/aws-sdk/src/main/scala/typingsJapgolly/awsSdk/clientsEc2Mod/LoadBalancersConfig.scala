...
trait LoadBalancersConfig extends StObject {
  ...
  /**
    ...
    */
  var ClassicLoadBalancersConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ClassicLoadBalancersConfig] = js.undefined
  
  /**
    * The target groups.
    */
  var TargetGroupsConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.TargetGroupsConfig] = js.undefined
}
