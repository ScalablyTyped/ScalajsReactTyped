...
trait DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest extends StObject {
  ...
  /**
    ...
    */
  var LocalGatewayRouteTableVirtualInterfaceGroupAssociationId: typingsJapgolly.awsSdk.clientsEc2Mod.LocalGatewayRouteTableVirtualInterfaceGroupAssociationId
}
