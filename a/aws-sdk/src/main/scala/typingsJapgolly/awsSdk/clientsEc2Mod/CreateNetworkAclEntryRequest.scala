...
trait CreateNetworkAclEntryRequest extends StObject {
  ...
  /**
    ...
    */
  var IcmpTypeCode: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.IcmpTypeCode] = js.undefined
  ...
  /**
    ...
    */
  var NetworkAclId: typingsJapgolly.awsSdk.clientsEc2Mod.NetworkAclId
  
  /**
    * TCP or UDP protocols: The range of ports the rule applies to. Required if specifying protocol 6 (TCP) or 17 (UDP).
    */
  var PortRange: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.PortRange] = js.undefined
  ...
  /**
    ...
    */
  var RuleAction: typingsJapgolly.awsSdk.clientsEc2Mod.RuleAction
