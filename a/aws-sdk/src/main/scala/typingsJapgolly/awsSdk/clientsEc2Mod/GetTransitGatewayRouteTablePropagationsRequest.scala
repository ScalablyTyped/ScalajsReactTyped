...
trait GetTransitGatewayRouteTablePropagationsRequest extends StObject {
  ...
  /**
    ...
    */
  var TransitGatewayRouteTableId: typingsJapgolly.awsSdk.clientsEc2Mod.TransitGatewayRouteTableId
}
object GetTransitGatewayRouteTablePropagationsRequest {
  
  inline def apply(TransitGatewayRouteTableId: TransitGatewayRouteTableId): GetTransitGatewayRouteTablePropagationsRequest = {
  ...
  extension [Self <: GetTransitGatewayRouteTablePropagationsRequest](x: Self) {
