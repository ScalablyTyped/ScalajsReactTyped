...
trait CreateNetworkInsightsAccessScopeResult extends StObject {
  ...
  /**
    ...
    */
  var NetworkInsightsAccessScope: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.NetworkInsightsAccessScope] = js.undefined
  
  /**
    * The Network Access Scope content.
    */
  var NetworkInsightsAccessScopeContent: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.NetworkInsightsAccessScopeContent] = js.undefined
}
