...
trait DescribeFastSnapshotRestoresRequest extends StObject {
  ...
  /**
    ...
    */
  var MaxResults: js.UndefOr[DescribeFastSnapshotRestoresMaxResults] = js.undefined
...
object DescribeFastSnapshotRestoresRequest {
  ...
  inline def apply(): DescribeFastSnapshotRestoresRequest = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[DescribeFastSnapshotRestoresRequest]
  }
  
  extension [Self <: DescribeFastSnapshotRestoresRequest](x: Self) {
    ...
    inline def setMaxResults(value: DescribeFastSnapshotRestoresMaxResults): Self = StObject.set(x, "MaxResults", value.asInstanceOf[js.Any])
