...
trait CreateClientVpnEndpointRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientConnectOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ClientConnectOptions] = js.undefined
  
  /**
    * Options for enabling a customizable text banner that will be displayed on Amazon Web Services provided clients when a VPN session is established.
    */
  var ClientLoginBannerOptions: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ClientLoginBannerOptions] = js.undefined
  ...
  /**
    ...
    */
  var ConnectionLogOptions: typingsJapgolly.awsSdk.clientsEc2Mod.ConnectionLogOptions
  ...
  /**
    ...
    */
  var SelfServicePortal: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.SelfServicePortal] = js.undefined
  ...
  /**
    ...
    */
  var TransportProtocol: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.TransportProtocol] = js.undefined
  
  /**
    * The ID of the VPC to associate with the Client VPN endpoint. If no security group IDs are specified in the request, the default security group for the VPC is applied.
    */
  var VpcId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.VpcId] = js.undefined
