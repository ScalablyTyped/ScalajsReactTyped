...
trait SpotFleetRequestConfigData extends StObject {
  ...
  /**
    ...
    */
  var AllocationStrategy: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.AllocationStrategy] = js.undefined
  ...
  /**
    ...
    */
  var ExcessCapacityTerminationPolicy: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ExcessCapacityTerminationPolicy] = js.undefined
  ...
  /**
    ...
    */
  var LoadBalancersConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.LoadBalancersConfig] = js.undefined
  
  /**
    * The order of the launch template overrides to use in fulfilling On-Demand capacity. If you specify lowestPrice, Spot Fleet uses price to determine the order, launching the lowest price first. If you specify prioritized, Spot Fleet uses the priority that you assign to each Spot Fleet launch template override, launching the highest priority first. If you do not specify a value, Spot Fleet defaults to lowestPrice.
    */
  var OnDemandAllocationStrategy: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.OnDemandAllocationStrategy] = js.undefined
  ...
  /**
    ...
    */
  var SpotMaintenanceStrategies: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.SpotMaintenanceStrategies] = js.undefined
