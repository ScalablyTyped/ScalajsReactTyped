...
trait ReplaceRouteRequest extends StObject {
  ...
  /**
    ...
    */
  var CarrierGatewayId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.CarrierGatewayId] = js.undefined
  
  /**
    * The Amazon Resource Name (ARN) of the core network.
    */
  var CoreNetworkArn: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.CoreNetworkArn] = js.undefined
  ...
  /**
    ...
    */
  var EgressOnlyInternetGatewayId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.EgressOnlyInternetGatewayId] = js.undefined
  ...
  /**
    ...
    */
  var InstanceId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.InstanceId] = js.undefined
  
  /**
    * The ID of the local gateway.
    */
  var LocalGatewayId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.LocalGatewayId] = js.undefined
  ...
  /**
    ...
    */
  var NatGatewayId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.NatGatewayId] = js.undefined
  ...
  /**
    ...
    */
  var TransitGatewayId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.TransitGatewayId] = js.undefined
  
  /**
    * The ID of a VPC endpoint. Supported for Gateway Load Balancer endpoints only.
    */
  var VpcEndpointId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.VpcEndpointId] = js.undefined
  
  /**
    * The ID of a VPC peering connection.
    */
  var VpcPeeringConnectionId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.VpcPeeringConnectionId] = js.undefined
}
