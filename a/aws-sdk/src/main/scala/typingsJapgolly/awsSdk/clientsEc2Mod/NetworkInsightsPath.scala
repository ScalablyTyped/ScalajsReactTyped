...
trait NetworkInsightsPath extends StObject {
  ...
  /**
    * The ID of the path.
    */
  var NetworkInsightsPathId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.NetworkInsightsPathId] = js.undefined
  
  /**
    * The protocol.
    */
  var Protocol: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.Protocol] = js.undefined
