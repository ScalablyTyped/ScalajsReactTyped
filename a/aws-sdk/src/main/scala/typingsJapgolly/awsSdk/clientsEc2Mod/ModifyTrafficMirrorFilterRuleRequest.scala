...
trait ModifyTrafficMirrorFilterRuleRequest extends StObject {
  ...
  /**
    ...
    */
  var TrafficDirection: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.TrafficDirection] = js.undefined
  
  /**
    * The ID of the Traffic Mirror rule.
    */
  var TrafficMirrorFilterRuleId: typingsJapgolly.awsSdk.clientsEc2Mod.TrafficMirrorFilterRuleId
}
