...
trait NetworkInsightsAccessScopeAnalysis extends StObject {
  ...
  /**
    ...
    */
  var FindingsFound: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.FindingsFound] = js.undefined
  ...
  /**
    ...
    */
  var NetworkInsightsAccessScopeAnalysisId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.NetworkInsightsAccessScopeAnalysisId] = js.undefined
  
  /**
    * The ID of the Network Access Scope.
    */
  var NetworkInsightsAccessScopeId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.NetworkInsightsAccessScopeId] = js.undefined
