...
trait EbsOptimizedInfo extends StObject {
  ...
  /**
    ...
    */
  var BaselineBandwidthInMbps: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.BaselineBandwidthInMbps] = js.undefined
  
  /**
    * The baseline input/output storage operations per seconds for an EBS-optimized instance type.
    */
  var BaselineIops: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.BaselineIops] = js.undefined
  
  /**
    * The baseline throughput performance for an EBS-optimized instance type, in MB/s.
    */
  var BaselineThroughputInMBps: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.BaselineThroughputInMBps] = js.undefined
  
  /**
    * The maximum bandwidth performance for an EBS-optimized instance type, in Mbps.
    */
  var MaximumBandwidthInMbps: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.MaximumBandwidthInMbps] = js.undefined
  
  /**
    * The maximum input/output storage operations per second for an EBS-optimized instance type.
    */
  var MaximumIops: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.MaximumIops] = js.undefined
  
  /**
    * The maximum throughput performance for an EBS-optimized instance type, in MB/s.
    */
  var MaximumThroughputInMBps: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.MaximumThroughputInMBps] = js.undefined
}
