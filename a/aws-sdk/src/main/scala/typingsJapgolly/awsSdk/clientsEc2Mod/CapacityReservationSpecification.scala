...
trait CapacityReservationSpecification extends StObject {
  ...
  /**
    ...
    */
  var CapacityReservationPreference: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.CapacityReservationPreference] = js.undefined
  
  /**
    * Information about the target Capacity Reservation or Capacity Reservation group.
    */
  var CapacityReservationTarget: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.CapacityReservationTarget] = js.undefined
}
