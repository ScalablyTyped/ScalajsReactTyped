...
trait ModifyTrafficMirrorSessionRequest extends StObject {
  ...
  /**
    ...
    */
  var TrafficMirrorFilterId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.TrafficMirrorFilterId] = js.undefined
  
  /**
    * The ID of the Traffic Mirror session.
    */
  var TrafficMirrorSessionId: typingsJapgolly.awsSdk.clientsEc2Mod.TrafficMirrorSessionId
  
  /**
    * The Traffic Mirror target. The target must be in the same VPC as the source, or have a VPC peering connection with the source.
    */
  var TrafficMirrorTargetId: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.TrafficMirrorTargetId] = js.undefined
