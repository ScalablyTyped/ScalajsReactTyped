...
trait EbsInfo extends StObject {
  ...
  /**
    ...
    */
  var EbsOptimizedInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.EbsOptimizedInfo] = js.undefined
  
  /**
    * Indicates whether the instance type is Amazon EBS-optimized. For more information, see Amazon EBS-optimized instances in Amazon EC2 User Guide.
    */
  var EbsOptimizedSupport: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.EbsOptimizedSupport] = js.undefined
