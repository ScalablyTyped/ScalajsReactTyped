...
trait ConnectionNotification extends StObject {
  ...
  /**
    ...
    */
  var ConnectionNotificationState: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ConnectionNotificationState] = js.undefined
  
  /**
    * The type of notification.
    */
  var ConnectionNotificationType: js.UndefOr[typingsJapgolly.awsSdk.clientsEc2Mod.ConnectionNotificationType] = js.undefined
...
object ConnectionNotification {
  ...
  extension [Self <: ConnectionNotification](x: Self) {
