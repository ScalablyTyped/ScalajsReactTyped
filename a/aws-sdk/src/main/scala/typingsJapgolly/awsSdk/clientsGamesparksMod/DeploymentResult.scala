...
trait DeploymentResult extends StObject {
  ...
  /**
    ...
    */
  var Message: js.UndefOr[typingsJapgolly.awsSdk.clientsGamesparksMod.Message] = js.undefined
  
  /**
    * The type of deployment result.
    */
  var ResultCode: js.UndefOr[typingsJapgolly.awsSdk.clientsGamesparksMod.ResultCode] = js.undefined
}
