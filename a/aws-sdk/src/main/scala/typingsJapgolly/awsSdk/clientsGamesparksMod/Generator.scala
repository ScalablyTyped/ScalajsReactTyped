...
trait Generator extends StObject {
  ...
  /**
    ...
    */
  var GameSdkVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsGamesparksMod.GameSdkVersion] = js.undefined
  ...
  /**
    ...
    */
  var Language: js.UndefOr[typingsJapgolly.awsSdk.clientsGamesparksMod.Language] = js.undefined
  
  /**
    * The platform that will be used to run the generated code.
    */
  var TargetPlatform: js.UndefOr[typingsJapgolly.awsSdk.clientsGamesparksMod.TargetPlatform] = js.undefined
}
object Generator {
