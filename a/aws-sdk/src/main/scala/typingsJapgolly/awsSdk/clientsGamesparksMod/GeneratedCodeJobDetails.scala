...
trait GeneratedCodeJobDetails extends StObject {
  ...
  /**
    ...
    */
  var GeneratedCodeJobId: js.UndefOr[typingsJapgolly.awsSdk.clientsGamesparksMod.GeneratedCodeJobId] = js.undefined
...
object GeneratedCodeJobDetails {
  ...
  extension [Self <: GeneratedCodeJobDetails](x: Self) {
