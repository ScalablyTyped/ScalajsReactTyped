...
trait CreateEventIntegrationRequest extends StObject {
  ...
  /**
    * The EventBridge bus.
    */
  var EventBridgeBus: typingsJapgolly.awsSdk.clientsAppintegrationsMod.EventBridgeBus
  
  /**
    * The event filter.
    */
  var EventFilter: typingsJapgolly.awsSdk.clientsAppintegrationsMod.EventFilter
