...
trait GetEventIntegrationResponse extends StObject {
  ...
  /**
    * The EventBridge bus.
    */
  var EventBridgeBus: js.UndefOr[typingsJapgolly.awsSdk.clientsAppintegrationsMod.EventBridgeBus] = js.undefined
  
  /**
    * The event filter.
    */
  var EventFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsAppintegrationsMod.EventFilter] = js.undefined
