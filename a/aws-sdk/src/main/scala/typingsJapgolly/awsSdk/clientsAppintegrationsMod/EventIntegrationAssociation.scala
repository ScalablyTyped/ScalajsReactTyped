...
trait EventIntegrationAssociation extends StObject {
  ...
  /**
    ...
    */
  var ClientAssociationMetadata: js.UndefOr[typingsJapgolly.awsSdk.clientsAppintegrationsMod.ClientAssociationMetadata] = js.undefined
  
  /**
    * The identifier for the client that is associated with the event integration.
    */
  var ClientId: js.UndefOr[typingsJapgolly.awsSdk.clientsAppintegrationsMod.ClientId] = js.undefined
  
  /**
    * The name of the EventBridge rule.
    */
  var EventBridgeRuleName: js.UndefOr[typingsJapgolly.awsSdk.clientsAppintegrationsMod.EventBridgeRuleName] = js.undefined
