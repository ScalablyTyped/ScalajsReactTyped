...
import typingsJapgolly.awsSdk.anon.GetLaunchProfileRequestwa
import typingsJapgolly.awsSdk.anon.GetStreamingImageRequestw
import typingsJapgolly.awsSdk.anon.GetStreamingSessionReques
import typingsJapgolly.awsSdk.anon.GetStreamingSessionStream
import typingsJapgolly.awsSdk.anon.GetStudioRequestwaiterWai
import typingsJapgolly.awsSdk.awsSdkStrings.launchProfileDeleted
import typingsJapgolly.awsSdk.awsSdkStrings.launchProfileReady
import typingsJapgolly.awsSdk.awsSdkStrings.streamingImageDeleted
import typingsJapgolly.awsSdk.awsSdkStrings.streamingImageReady
import typingsJapgolly.awsSdk.awsSdkStrings.streamingSessionDeleted
import typingsJapgolly.awsSdk.awsSdkStrings.streamingSessionReady
import typingsJapgolly.awsSdk.awsSdkStrings.streamingSessionStopped
import typingsJapgolly.awsSdk.awsSdkStrings.streamingSessionStreamReady
import typingsJapgolly.awsSdk.awsSdkStrings.studioComponentDeleted
import typingsJapgolly.awsSdk.awsSdkStrings.studioComponentReady
import typingsJapgolly.awsSdk.awsSdkStrings.studioDeleted
import typingsJapgolly.awsSdk.awsSdkStrings.studioReady
...
trait Nimble extends Service {
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_studioComponentDeleted(state: studioComponentDeleted, params: typingsJapgolly.awsSdk.anon.GetStudioComponentRequest): Request[GetStudioComponentResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_studioComponentDeleted(
    state: studioComponentDeleted,
    params: typingsJapgolly.awsSdk.anon.GetStudioComponentRequest,
    callback: js.Function2[/* err */ AWSError, /* data */ GetStudioComponentResponse, Unit]
  ): Request[GetStudioComponentResponse, AWSError] = js.native
  /**
  ...
  /**
    ...
    */
  @JSName("waitFor")
  def waitFor_studioComponentReady(state: studioComponentReady, params: typingsJapgolly.awsSdk.anon.GetStudioComponentRequest): Request[GetStudioComponentResponse, AWSError] = js.native
  @JSName("waitFor")
  def waitFor_studioComponentReady(
    state: studioComponentReady,
    params: typingsJapgolly.awsSdk.anon.GetStudioComponentRequest,
