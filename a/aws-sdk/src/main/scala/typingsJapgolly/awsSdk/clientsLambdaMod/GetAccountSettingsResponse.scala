...
trait GetAccountSettingsResponse extends StObject {
  ...
  /**
    ...
    */
  var AccountLimit: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.AccountLimit] = js.undefined
  
  /**
    * The number of functions and amount of storage in use.
    */
  var AccountUsage: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.AccountUsage] = js.undefined
}
