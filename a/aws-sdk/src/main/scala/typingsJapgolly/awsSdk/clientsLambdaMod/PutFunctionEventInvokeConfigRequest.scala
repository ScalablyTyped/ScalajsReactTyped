...
trait PutFunctionEventInvokeConfigRequest extends StObject {
  ...
  /**
    ...
    */
  var MaximumEventAgeInSeconds: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.MaximumEventAgeInSeconds] = js.undefined
  
  /**
    * The maximum number of times to retry when the function returns an error.
    */
  var MaximumRetryAttempts: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.MaximumRetryAttempts] = js.undefined
