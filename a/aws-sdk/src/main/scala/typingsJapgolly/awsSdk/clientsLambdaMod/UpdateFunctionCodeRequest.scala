...
trait UpdateFunctionCodeRequest extends StObject {
  ...
  /**
    ...
    */
  var S3Bucket: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.S3Bucket] = js.undefined
  
  /**
    * The Amazon S3 key of the deployment package. Use only with a function defined with a .zip file archive deployment package.
    */
  var S3Key: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.S3Key] = js.undefined
  
  /**
    * For versioned objects, the version of the deployment package object to use.
    */
  var S3ObjectVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.S3ObjectVersion] = js.undefined
