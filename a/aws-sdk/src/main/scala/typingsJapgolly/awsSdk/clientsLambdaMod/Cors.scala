...
trait Cors extends StObject {
  ...
  /**
    ...
    */
  var AllowCredentials: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.AllowCredentials] = js.undefined
  ...
  /**
    ...
    */
  var MaxAge: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.MaxAge] = js.undefined
}
object Cors {
