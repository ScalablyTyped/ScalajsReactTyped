...
trait GetFunctionCodeSigningConfigResponse extends StObject {
...
object GetFunctionCodeSigningConfigResponse {
  ...
  inline def apply(CodeSigningConfigArn: CodeSigningConfigArn, FunctionName: FunctionName): GetFunctionCodeSigningConfigResponse = {
  ...
  extension [Self <: GetFunctionCodeSigningConfigResponse](x: Self) {
