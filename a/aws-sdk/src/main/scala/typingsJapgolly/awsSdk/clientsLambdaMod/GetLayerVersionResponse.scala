...
trait GetLayerVersionResponse extends StObject {
  ...
  /**
    ...
    */
  var CompatibleArchitectures: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.CompatibleArchitectures] = js.undefined
  
  /**
    * The layer's compatible runtimes.
    */
  var CompatibleRuntimes: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.CompatibleRuntimes] = js.undefined
  ...
  /**
    ...
    */
  var LayerArn: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.LayerArn] = js.undefined
  
  /**
    * The ARN of the layer version.
    */
  var LayerVersionArn: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.LayerVersionArn] = js.undefined
  
  /**
    * The layer's software license.
    */
  var LicenseInfo: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.LicenseInfo] = js.undefined
