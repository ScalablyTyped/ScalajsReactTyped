...
trait InvocationRequest extends StObject {
  ...
  /**
    ...
    */
  var InvocationType: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.InvocationType] = js.undefined
  
  /**
    * Set to Tail to include the execution log in the response. Applies to synchronously invoked functions only.
    */
  var LogType: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.LogType] = js.undefined
