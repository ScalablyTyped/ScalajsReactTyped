...
trait AddPermissionRequest extends StObject {
  ...
  /**
    ...
    */
  var Action: typingsJapgolly.awsSdk.clientsLambdaMod.Action
  
  /**
    * For Alexa Smart Home functions, a token that must be supplied by the invoker.
    */
  var EventSourceToken: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.EventSourceToken] = js.undefined
  ...
  /**
    ...
    */
  var FunctionUrlAuthType: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.FunctionUrlAuthType] = js.undefined
  ...
  /**
    ...
    */
  var Principal: typingsJapgolly.awsSdk.clientsLambdaMod.Principal
  
  /**
    * The identifier for your organization in Organizations. Use this to grant permissions to all the Amazon Web Services accounts under this organization.
    */
  var PrincipalOrgID: js.UndefOr[typingsJapgolly.awsSdk.clientsLambdaMod.PrincipalOrgID] = js.undefined
