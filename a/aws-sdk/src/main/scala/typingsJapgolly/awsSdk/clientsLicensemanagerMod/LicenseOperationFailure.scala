...
trait LicenseOperationFailure extends StObject {
  ...
  /**
    * Reserved.
    */
  var MetadataList: js.UndefOr[typingsJapgolly.awsSdk.clientsLicensemanagerMod.MetadataList] = js.undefined
  ...
  /**
    * Resource type.
    */
  var ResourceType: js.UndefOr[typingsJapgolly.awsSdk.clientsLicensemanagerMod.ResourceType] = js.undefined
}
