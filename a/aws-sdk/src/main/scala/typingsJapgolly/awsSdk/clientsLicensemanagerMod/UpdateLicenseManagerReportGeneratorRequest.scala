...
trait UpdateLicenseManagerReportGeneratorRequest extends StObject {
  ...
  /**
    * The report context.
    */
  var ReportContext: typingsJapgolly.awsSdk.clientsLicensemanagerMod.ReportContext
  
  /**
    * Frequency by which reports are generated.
    */
  var ReportFrequency: typingsJapgolly.awsSdk.clientsLicensemanagerMod.ReportFrequency
  
  /**
    * Name of the report generator.
    */
  var ReportGeneratorName: typingsJapgolly.awsSdk.clientsLicensemanagerMod.ReportGeneratorName
