...
trait CreateLicenseVersionRequest extends StObject {
  ...
  /**
    ...
    */
  var ClientToken: typingsJapgolly.awsSdk.clientsLicensemanagerMod.ClientToken
  
  /**
    * Configuration for consumption of the license. Choose a provisional configuration for workloads running with continuous connectivity. Choose a borrow configuration for workloads with offline usage.
    */
  var ConsumptionConfiguration: typingsJapgolly.awsSdk.clientsLicensemanagerMod.ConsumptionConfiguration
  ...
  /**
    * License issuer.
    */
  var Issuer: typingsJapgolly.awsSdk.clientsLicensemanagerMod.Issuer
