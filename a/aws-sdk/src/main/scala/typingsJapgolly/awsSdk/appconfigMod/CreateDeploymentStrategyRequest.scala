...
trait CreateDeploymentStrategyRequest extends js.Object {
  ...
  /**
    ...
    */
  var GrowthFactor: typingsJapgolly.awsSdk.appconfigMod.GrowthFactor = js.native
  /**
  ...
  /**
    ...
    */
  var Name: typingsJapgolly.awsSdk.appconfigMod.Name = js.native
  /**
    * Save the deployment strategy to a Systems Manager (SSM) document.
    */
  var ReplicateTo: typingsJapgolly.awsSdk.appconfigMod.ReplicateTo = js.native
  /**
