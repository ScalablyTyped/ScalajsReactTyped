...
trait UpdateDeploymentStrategyRequest extends js.Object {
  ...
  /**
    ...
    */
  var DeploymentStrategyId: typingsJapgolly.awsSdk.appconfigMod.DeploymentStrategyId = js.native
  /**
  ...
  /**
    ...
    */
  var GrowthFactor: js.UndefOr[typingsJapgolly.awsSdk.appconfigMod.GrowthFactor] = js.native
  /**
