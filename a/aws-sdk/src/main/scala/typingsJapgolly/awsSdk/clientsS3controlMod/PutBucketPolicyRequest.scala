...
trait PutBucketPolicyRequest extends StObject {
  ...
  /**
    ...
    */
  var ConfirmRemoveSelfBucketAccess: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.ConfirmRemoveSelfBucketAccess] = js.undefined
  
  /**
    * The bucket policy as a JSON document.
    */
  var Policy: typingsJapgolly.awsSdk.clientsS3controlMod.Policy
}
