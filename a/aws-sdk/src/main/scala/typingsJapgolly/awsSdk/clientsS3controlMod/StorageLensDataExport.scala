...
trait StorageLensDataExport extends StObject {
  ...
  /**
    ...
    */
  var CloudWatchMetrics: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.CloudWatchMetrics] = js.undefined
  ...
  /**
    ...
    */
  var S3BucketDestination: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.S3BucketDestination] = js.undefined
}
