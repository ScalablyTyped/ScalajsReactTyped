...
trait StorageLensConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AccountLevel: typingsJapgolly.awsSdk.clientsS3controlMod.AccountLevel
  ...
  /**
    ...
    */
  var Exclude: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.Exclude] = js.undefined
  ...
  /**
    ...
    */
  var Include: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.Include] = js.undefined
  
  /**
    * A container for whether the S3 Storage Lens configuration is enabled.
    */
  var IsEnabled: typingsJapgolly.awsSdk.clientsS3controlMod.IsEnabled
  
  /**
    * The Amazon Resource Name (ARN) of the S3 Storage Lens configuration. This property is read-only and follows the following format:  arn:aws:s3:us-east-1:example-account-id:storage-lens/your-dashboard-name  
    */
  var StorageLensArn: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.StorageLensArn] = js.undefined
}
