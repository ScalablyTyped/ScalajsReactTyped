...
trait LifecycleRule extends StObject {
  ...
  /**
    ...
    */
  var AbortIncompleteMultipartUpload: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.AbortIncompleteMultipartUpload] = js.undefined
  ...
  /**
    ...
    */
  var ID: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.ID] = js.undefined
  
  /**
    * The noncurrent version expiration of the lifecycle rule.  This is not supported by Amazon S3 on Outposts buckets. 
    */
  var NoncurrentVersionExpiration: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.NoncurrentVersionExpiration] = js.undefined
