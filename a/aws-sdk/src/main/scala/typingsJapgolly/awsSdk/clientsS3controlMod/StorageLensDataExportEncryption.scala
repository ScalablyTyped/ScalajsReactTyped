...
trait StorageLensDataExportEncryption extends StObject {
  ...
  /**
    * 
    */
  var SSEKMS: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.SSEKMS] = js.undefined
  
  /**
    * 
    */
  var SSES3: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.SSES3] = js.undefined
}
