...
trait PutBucketVersioningRequest extends StObject {
  ...
  /**
    ...
    */
  var MFA: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.MFA] = js.undefined
  
  /**
    * The root-level tag for the VersioningConfiguration parameters.
    */
  var VersioningConfiguration: typingsJapgolly.awsSdk.clientsS3controlMod.VersioningConfiguration
}
