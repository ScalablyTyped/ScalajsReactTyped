...
trait Exclude extends StObject {
  ...
  /**
    ...
    */
  var Buckets: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.Buckets] = js.undefined
  
  /**
    * A container for the S3 Storage Lens Region excludes.
    */
  var Regions: js.UndefOr[typingsJapgolly.awsSdk.clientsS3controlMod.Regions] = js.undefined
}
object Exclude {
