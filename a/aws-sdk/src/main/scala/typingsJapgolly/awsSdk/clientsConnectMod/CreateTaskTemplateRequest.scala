...
trait CreateTaskTemplateRequest extends StObject {
...
object CreateTaskTemplateRequest {
  ...
  inline def apply(Fields: TaskTemplateFields, InstanceId: InstanceId, Name: TaskTemplateName): CreateTaskTemplateRequest = {
    val __obj = js.Dynamic.literal(Fields = Fields.asInstanceOf[js.Any], InstanceId = InstanceId.asInstanceOf[js.Any], Name = Name.asInstanceOf[js.Any])
