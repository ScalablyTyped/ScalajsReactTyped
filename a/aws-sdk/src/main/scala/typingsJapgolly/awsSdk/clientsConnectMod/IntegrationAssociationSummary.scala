...
trait IntegrationAssociationSummary extends StObject {
  ...
  /**
    ...
    */
  var IntegrationAssociationId: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.IntegrationAssociationId] = js.undefined
  
  /**
    * The integration type.
    */
  var IntegrationType: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.IntegrationType] = js.undefined
  
  /**
    * The user-provided, friendly name for the external application.
    */
  var SourceApplicationName: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.SourceApplicationName] = js.undefined
  ...
  /**
    ...
    */
  var SourceType: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.SourceType] = js.undefined
}
