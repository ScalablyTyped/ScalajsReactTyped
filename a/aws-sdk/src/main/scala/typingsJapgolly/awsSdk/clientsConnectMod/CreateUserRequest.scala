...
trait CreateUserRequest extends StObject {
  ...
  /**
    ...
    */
  var Password: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.Password] = js.undefined
  ...
  /**
    ...
    */
  var SecurityProfileIds: typingsJapgolly.awsSdk.clientsConnectMod.SecurityProfileIds
