...
trait RoutingProfileQueueConfigSummary extends StObject {
  ...
  /**
    ...
    */
  var Delay: typingsJapgolly.awsSdk.clientsConnectMod.Delay
  
  /**
    * The order in which contacts are to be handled for the queue. For more information, see Queues: priority and delay.
    */
  var Priority: typingsJapgolly.awsSdk.clientsConnectMod.Priority
  ...
  /**
    ...
    */
  var QueueName: typingsJapgolly.awsSdk.clientsConnectMod.QueueName
}
