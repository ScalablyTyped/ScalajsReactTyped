...
trait StartTaskContactRequest extends StObject {
  ...
  /**
    ...
    */
  var Name: typingsJapgolly.awsSdk.clientsConnectMod.Name
  ...
  /**
    ...
    */
  var TaskTemplateId: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.TaskTemplateId] = js.undefined
}
