...
trait HistoricalMetric extends StObject {
  ...
  /**
    ...
    */
  var Statistic: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.Statistic] = js.undefined
  
  /**
    * The threshold for the metric, used with service level metrics.
    */
  var Threshold: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.Threshold] = js.undefined
  
  /**
    * The unit for the metric.
    */
  var Unit: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.Unit] = js.undefined
}
