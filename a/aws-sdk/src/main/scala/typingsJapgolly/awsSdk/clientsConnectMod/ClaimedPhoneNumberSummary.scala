...
trait ClaimedPhoneNumberSummary extends StObject {
  ...
  /**
    ...
    */
  var PhoneNumber: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.PhoneNumber] = js.undefined
  ...
  /**
    ...
    */
  var PhoneNumberCountryCode: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.PhoneNumberCountryCode] = js.undefined
  
  /**
    * The description of the phone number.
    */
  var PhoneNumberDescription: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.PhoneNumberDescription] = js.undefined
  
  /**
    * A unique identifier for the phone number.
    */
  var PhoneNumberId: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.PhoneNumberId] = js.undefined
  
  /**
    * The status of the phone number.
    */
  var PhoneNumberStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.PhoneNumberStatus] = js.undefined
  
  /**
    * The type of phone number.
    */
  var PhoneNumberType: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.PhoneNumberType] = js.undefined
