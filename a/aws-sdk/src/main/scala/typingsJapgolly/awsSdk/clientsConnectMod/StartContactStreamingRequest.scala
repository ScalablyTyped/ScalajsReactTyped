...
trait StartContactStreamingRequest extends StObject {
  ...
  /**
    ...
    */
  var ChatStreamingConfiguration: typingsJapgolly.awsSdk.clientsConnectMod.ChatStreamingConfiguration
  
  /**
    * A unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
    */
  var ClientToken: typingsJapgolly.awsSdk.clientsConnectMod.ClientToken
