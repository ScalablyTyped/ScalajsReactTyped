...
trait S3Config extends StObject {
  ...
  /**
    * The S3 bucket name.
    */
  var BucketName: typingsJapgolly.awsSdk.clientsConnectMod.BucketName
  ...
  /**
    ...
    */
  var EncryptionConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.EncryptionConfig] = js.undefined
}
object S3Config {
