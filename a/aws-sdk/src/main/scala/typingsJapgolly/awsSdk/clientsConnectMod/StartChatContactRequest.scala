...
trait StartChatContactRequest extends StObject {
  ...
  /**
    ...
    */
  var ChatDurationInMinutes: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.ChatDurationInMinutes] = js.undefined
  ...
  /**
    ...
    */
  var ParticipantDetails: typingsJapgolly.awsSdk.clientsConnectMod.ParticipantDetails
  
  /**
    * The supported chat message content types. Content types can be text/plain or both text/plain and text/markdown.
    */
  var SupportedMessagingContentTypes: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.SupportedMessagingContentTypes] = js.undefined
}
