...
trait UserDataFilters extends StObject {
  ...
  /**
    ...
    */
  var ContactFilter: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.ContactFilter] = js.undefined
  
  /**
    * Contains information about a queue resource for which metrics are returned.
    */
  var Queues: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.Queues] = js.undefined
}
