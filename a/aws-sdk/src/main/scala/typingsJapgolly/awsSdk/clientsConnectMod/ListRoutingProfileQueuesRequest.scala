...
object ListRoutingProfileQueuesRequest {
  ...
  inline def apply(InstanceId: InstanceId, RoutingProfileId: RoutingProfileId): ListRoutingProfileQueuesRequest = {
  ...
  extension [Self <: ListRoutingProfileQueuesRequest](x: Self) {
