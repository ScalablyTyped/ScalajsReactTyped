...
trait SearchAvailablePhoneNumbersRequest extends StObject {
  ...
  /**
    ...
    */
  var PhoneNumberCountryCode: typingsJapgolly.awsSdk.clientsConnectMod.PhoneNumberCountryCode
  ...
  /**
    ...
    */
  var PhoneNumberType: typingsJapgolly.awsSdk.clientsConnectMod.PhoneNumberType
