...
trait ListContactFlowModulesResponse extends StObject {
  ...
  /**
    ...
    */
  var ContactFlowModulesSummaryList: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.ContactFlowModulesSummaryList] = js.undefined
...
object ListContactFlowModulesResponse {
  ...
  extension [Self <: ListContactFlowModulesResponse](x: Self) {
