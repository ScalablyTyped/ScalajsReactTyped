...
trait SearchVocabulariesRequest extends StObject {
  ...
  /**
    ...
    */
  var NameStartsWith: js.UndefOr[VocabularyName] = js.undefined
  ...
  /**
    ...
    */
  var State: js.UndefOr[VocabularyState] = js.undefined
}
object SearchVocabulariesRequest {
  
  inline def apply(InstanceId: InstanceId): SearchVocabulariesRequest = {
  ...
  extension [Self <: SearchVocabulariesRequest](x: Self) {
    ...
    inline def setNameStartsWith(value: VocabularyName): Self = StObject.set(x, "NameStartsWith", value.asInstanceOf[js.Any])
    
    inline def setNameStartsWithUndefined: Self = StObject.set(x, "NameStartsWith", js.undefined)
