...
trait UserPhoneConfig extends StObject {
  ...
  /**
    ...
    */
  var AfterContactWorkTimeLimit: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.AfterContactWorkTimeLimit] = js.undefined
  
  /**
    * The Auto accept setting.
    */
  var AutoAccept: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.AutoAccept] = js.undefined
  ...
  /**
    * The phone type.
    */
  var PhoneType: typingsJapgolly.awsSdk.clientsConnectMod.PhoneType
}
