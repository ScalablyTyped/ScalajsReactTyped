...
trait Threshold extends StObject {
  ...
  /**
    ...
    */
  var Comparison: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.Comparison] = js.undefined
  
  /**
    * The threshold value to compare.
    */
  var ThresholdValue: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.ThresholdValue] = js.undefined
}
object Threshold {
