...
trait UserSearchSummary extends StObject {
  ...
  /**
    ...
    */
  var DirectoryUserId: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.DirectoryUserId] = js.undefined
  ...
  /**
    ...
    */
  var SecurityProfileIds: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.SecurityProfileIds] = js.undefined
