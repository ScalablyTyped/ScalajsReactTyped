...
trait UseCase extends StObject {
  ...
  /**
    ...
    */
  var UseCaseId: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.UseCaseId] = js.undefined
  
  /**
    * The type of use case to associate to the integration association. Each integration association can have only one of each use case type.
    */
  var UseCaseType: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.UseCaseType] = js.undefined
}
object UseCase {
