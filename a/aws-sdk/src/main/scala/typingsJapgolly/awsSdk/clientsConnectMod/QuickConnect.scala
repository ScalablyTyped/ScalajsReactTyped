...
trait QuickConnect extends StObject {
  ...
  /**
    ...
    */
  var QuickConnectConfig: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.QuickConnectConfig] = js.undefined
  
  /**
    * The identifier for the quick connect.
    */
  var QuickConnectId: js.UndefOr[typingsJapgolly.awsSdk.clientsConnectMod.QuickConnectId] = js.undefined
