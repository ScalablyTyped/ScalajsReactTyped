...
object clientsPersonalizeeventsMod {
  ...
  trait ClientApiVersions extends StObject {
    ...
    /**
      ...
      */
    var apiVersion: js.UndefOr[typingsJapgolly.awsSdk.clientsPersonalizeeventsMod.apiVersion] = js.undefined
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdk.awsSdkStrings.`2018-03-22`
