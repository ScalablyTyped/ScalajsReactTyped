...
trait JournalS3ExportDescription extends StObject {
  ...
  /**
    ...
    */
  var OutputFormat: js.UndefOr[typingsJapgolly.awsSdk.clientsQldbMod.OutputFormat] = js.undefined
  ...
  var S3ExportConfiguration: typingsJapgolly.awsSdk.clientsQldbMod.S3ExportConfiguration
