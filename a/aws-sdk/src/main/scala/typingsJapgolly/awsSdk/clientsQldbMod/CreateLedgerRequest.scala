...
trait CreateLedgerRequest extends StObject {
  ...
  /**
    ...
    */
  var DeletionProtection: js.UndefOr[typingsJapgolly.awsSdk.clientsQldbMod.DeletionProtection] = js.undefined
  ...
  /**
    ...
    */
  var KmsKey: js.UndefOr[typingsJapgolly.awsSdk.clientsQldbMod.KmsKey] = js.undefined
  ...
  /**
    ...
    */
  var PermissionsMode: typingsJapgolly.awsSdk.clientsQldbMod.PermissionsMode
  
  /**
    * The key-value pairs to add as tags to the ledger that you want to create. Tag keys are case sensitive. Tag values are case sensitive and can be null.
    */
  var Tags: js.UndefOr[typingsJapgolly.awsSdk.clientsQldbMod.Tags] = js.undefined
}
