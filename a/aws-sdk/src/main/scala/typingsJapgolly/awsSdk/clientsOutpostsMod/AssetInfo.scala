...
trait AssetInfo extends StObject {
  ...
  /**
    ...
    */
  var AssetLocation: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.AssetLocation] = js.undefined
  
  /**
    *  The type of the asset. 
    */
  var AssetType: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.AssetType] = js.undefined
  
  /**
    *  Information about compute hardware assets. 
    */
  var ComputeAttributes: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.ComputeAttributes] = js.undefined
  
  /**
    *  The rack ID of the asset. 
    */
  var RackId: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.RackId] = js.undefined
}
object AssetInfo {
