...
trait RackPhysicalProperties extends StObject {
  ...
  /**
    ...
    */
  var FiberOpticCableType: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.FiberOpticCableType] = js.undefined
  
  /**
    * The maximum rack weight that this site can support. NO_LIMIT is over 2000 lbs (907 kg). 
    */
  var MaximumSupportedWeightLbs: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.MaximumSupportedWeightLbs] = js.undefined
  ...
  /**
    ...
    */
  var OpticalStandard: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.OpticalStandard] = js.undefined
  
  /**
    * The power connector for the hardware. 
    */
  var PowerConnector: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.PowerConnector] = js.undefined
  
  /**
    * The power draw available at the hardware placement position for the rack. 
    */
  var PowerDrawKva: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.PowerDrawKva] = js.undefined
  
  /**
    * The position of the power feed.
    */
  var PowerFeedDrop: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.PowerFeedDrop] = js.undefined
  
  /**
    * The power option that you can provide for hardware.
    */
  var PowerPhase: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.PowerPhase] = js.undefined
  
  /**
    * The number of uplinks each Outpost network device.
    */
  var UplinkCount: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.UplinkCount] = js.undefined
  
  /**
    * The uplink speed the rack supports for the connection to the Region. 
    */
  var UplinkGbps: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.UplinkGbps] = js.undefined
}
