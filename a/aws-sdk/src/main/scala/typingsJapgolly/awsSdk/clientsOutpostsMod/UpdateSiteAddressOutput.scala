...
trait UpdateSiteAddressOutput extends StObject {
  ...
  /**
    ...
    */
  var Address: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.Address] = js.undefined
  
  /**
    *  The type of the address. 
    */
  var AddressType: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.AddressType] = js.undefined
}
