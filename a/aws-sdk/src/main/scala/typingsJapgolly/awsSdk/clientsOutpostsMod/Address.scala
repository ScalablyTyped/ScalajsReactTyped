...
trait Address extends StObject {
  ...
  /**
    ...
    */
  var AddressLine1: typingsJapgolly.awsSdk.clientsOutpostsMod.AddressLine1
  
  /**
    * The second line of the address.
    */
  var AddressLine2: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.AddressLine2] = js.undefined
  
  /**
    * The third line of the address.
    */
  var AddressLine3: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.AddressLine3] = js.undefined
  
  /**
    * The city for the address.
    */
  var City: typingsJapgolly.awsSdk.clientsOutpostsMod.City
  
  /**
    * The name of the contact.
    */
  var ContactName: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.ContactName] = js.undefined
  
  /**
    * The phone number of the contact.
    */
  var ContactPhoneNumber: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.ContactPhoneNumber] = js.undefined
  
  /**
    * The ISO-3166 two-letter country code for the address.
    */
  var CountryCode: typingsJapgolly.awsSdk.clientsOutpostsMod.CountryCode
  
  /**
    * The district or county for the address.
    */
  var DistrictOrCounty: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.DistrictOrCounty] = js.undefined
  
  /**
    * The municipality for the address.
    */
  var Municipality: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.Municipality] = js.undefined
  
  /**
    * The postal code for the address.
    */
  var PostalCode: typingsJapgolly.awsSdk.clientsOutpostsMod.PostalCode
  
  /**
    * The state for the address.
    */
  var StateOrRegion: typingsJapgolly.awsSdk.clientsOutpostsMod.StateOrRegion
}
object Address {
