...
trait StartConnectionRequest extends StObject {
  ...
  /**
    ...
    */
  var AssetId: typingsJapgolly.awsSdk.clientsOutpostsMod.AssetId
  ...
  /**
    ...
    */
  var DeviceSerialNumber: typingsJapgolly.awsSdk.clientsOutpostsMod.DeviceSerialNumber
  
  /**
    *  The device index of the network interface on the Outpost server. 
    */
  var NetworkInterfaceDeviceIndex: typingsJapgolly.awsSdk.clientsOutpostsMod.NetworkInterfaceDeviceIndex
}
