...
trait Order extends StObject {
  ...
  /**
    * The ID of the order.
    */
  var OrderId: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.OrderId] = js.undefined
  ...
  /**
    ...
    */
  var PaymentOption: js.UndefOr[typingsJapgolly.awsSdk.clientsOutpostsMod.PaymentOption] = js.undefined
