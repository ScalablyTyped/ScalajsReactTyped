...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.AccessDeniedError
  - typingsJapgolly.awsSdk.awsSdkStrings.ConflictError
  - typingsJapgolly.awsSdk.awsSdkStrings.InternalServerError
  - typingsJapgolly.awsSdk.awsSdkStrings.ResourceNotFoundError
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.Meters
  - typingsJapgolly.awsSdk.awsSdkStrings.Feet_
  - java.lang.String
*/
type DimensionUnit = _DimensionUnit | java.lang.String

/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.Kilometers
  - typingsJapgolly.awsSdk.awsSdkStrings.Miles
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.SingleUse
  - typingsJapgolly.awsSdk.awsSdkStrings.Storage
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.TimeBased
  - typingsJapgolly.awsSdk.awsSdkStrings.DistanceBased
  - typingsJapgolly.awsSdk.awsSdkStrings.AccuracyBased
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.RequestBasedUsage
  - typingsJapgolly.awsSdk.awsSdkStrings.MobileAssetTracking
  - typingsJapgolly.awsSdk.awsSdkStrings.MobileAssetManagement
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.RouteNotFound
  - typingsJapgolly.awsSdk.awsSdkStrings.RouteTooLong
  - typingsJapgolly.awsSdk.awsSdkStrings.PositionsNotFound
  - typingsJapgolly.awsSdk.awsSdkStrings.DestinationPositionNotFound
  - typingsJapgolly.awsSdk.awsSdkStrings.DeparturePositionNotFound
  - typingsJapgolly.awsSdk.awsSdkStrings.OtherValidationError
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.Car
  - typingsJapgolly.awsSdk.awsSdkStrings.Truck
  - typingsJapgolly.awsSdk.awsSdkStrings.Walking
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.Kilograms
  - typingsJapgolly.awsSdk.awsSdkStrings.Pounds
  - java.lang.String
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.awsSdk.awsSdkStrings.`2020-11-19`
