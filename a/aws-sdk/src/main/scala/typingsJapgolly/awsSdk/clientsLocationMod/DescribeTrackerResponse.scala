...
trait DescribeTrackerResponse extends StObject {
  ...
  /**
    ...
    */
  var KmsKeyId: js.UndefOr[typingsJapgolly.awsSdk.clientsLocationMod.KmsKeyId] = js.undefined
  
  /**
    * The position filtering method of the tracker resource.
    */
  var PositionFiltering: js.UndefOr[typingsJapgolly.awsSdk.clientsLocationMod.PositionFiltering] = js.undefined
