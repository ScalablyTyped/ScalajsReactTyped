...
trait DevicePosition extends StObject {
  ...
  /**
    ...
    */
  var Position: typingsJapgolly.awsSdk.clientsLocationMod.Position
...
object DevicePosition {
  ...
  inline def apply(Position: Position, ReceivedTime: js.Date, SampleTime: js.Date): DevicePosition = {
