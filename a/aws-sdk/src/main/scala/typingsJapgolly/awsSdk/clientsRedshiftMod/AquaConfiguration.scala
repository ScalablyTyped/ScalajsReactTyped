...
trait AquaConfiguration extends StObject {
  ...
  /**
    ...
    */
  var AquaConfigurationStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsRedshiftMod.AquaConfigurationStatus] = js.undefined
  
  /**
    * This field is retired. Amazon Redshift automatically determines whether to use AQUA (Advanced Query Accelerator).
    */
  var AquaStatus: js.UndefOr[typingsJapgolly.awsSdk.clientsRedshiftMod.AquaStatus] = js.undefined
}
