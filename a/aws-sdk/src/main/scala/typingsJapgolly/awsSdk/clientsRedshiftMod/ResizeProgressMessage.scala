...
trait ResizeProgressMessage extends StObject {
  ...
  /**
    ...
    */
  var ImportTablesCompleted: js.UndefOr[typingsJapgolly.awsSdk.clientsRedshiftMod.ImportTablesCompleted] = js.undefined
  
  /**
    * The names of tables that are being currently imported. Valid Values: List of table names.
    */
  var ImportTablesInProgress: js.UndefOr[typingsJapgolly.awsSdk.clientsRedshiftMod.ImportTablesInProgress] = js.undefined
  
  /**
    * The names of tables that have not been yet imported. Valid Values: List of table names
    */
  var ImportTablesNotStarted: js.UndefOr[typingsJapgolly.awsSdk.clientsRedshiftMod.ImportTablesNotStarted] = js.undefined
