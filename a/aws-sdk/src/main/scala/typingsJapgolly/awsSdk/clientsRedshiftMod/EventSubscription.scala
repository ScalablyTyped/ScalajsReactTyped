...
trait EventSubscription extends StObject {
  ...
  /**
    ...
    */
  var EventCategoriesList: js.UndefOr[typingsJapgolly.awsSdk.clientsRedshiftMod.EventCategoriesList] = js.undefined
  ...
  /**
    ...
    */
  var SourceIdsList: js.UndefOr[typingsJapgolly.awsSdk.clientsRedshiftMod.SourceIdsList] = js.undefined
