...
import typingsJapgolly.awsSdk.anon.DescribeClusterSnapshotsM
import typingsJapgolly.awsSdk.anon.DescribeClustersMessagewa
import typingsJapgolly.awsSdk.awsSdkStrings.clusterAvailable
import typingsJapgolly.awsSdk.awsSdkStrings.clusterDeleted
import typingsJapgolly.awsSdk.awsSdkStrings.clusterRestored
import typingsJapgolly.awsSdk.awsSdkStrings.snapshotAvailable
...
trait Redshift extends Service {
  ...
  @JSName("config")
  var config_Redshift: ConfigBase & ClientConfiguration = js.native
