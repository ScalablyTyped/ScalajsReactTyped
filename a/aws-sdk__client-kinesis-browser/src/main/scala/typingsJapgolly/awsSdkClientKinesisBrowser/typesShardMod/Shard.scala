package typingsJapgolly.awsSdkClientKinesisBrowser.typesShardMod

import typingsJapgolly.awsSdkClientKinesisBrowser.typesHashKeyRangeMod.HashKeyRange
import typingsJapgolly.awsSdkClientKinesisBrowser.typesSequenceNumberRangeMod.SequenceNumberRange
...
trait Shard extends js.Object {
  ...
  /**
    ...
    */
  var HashKeyRange: typingsJapgolly.awsSdkClientKinesisBrowser.typesHashKeyRangeMod.HashKeyRange
  /**
  ...
  /**
    ...
    */
  var SequenceNumberRange: typingsJapgolly.awsSdkClientKinesisBrowser.typesSequenceNumberRangeMod.SequenceNumberRange
  /**
