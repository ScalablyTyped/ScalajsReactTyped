...
@JSImport("@aws-sdk/client-kinesis-browser/types/DescribeStreamSummaryInput", JSImport.Namespace)
@js.native
object typesDescribeStreamSummaryInputMod extends js.Object {
  @js.native
