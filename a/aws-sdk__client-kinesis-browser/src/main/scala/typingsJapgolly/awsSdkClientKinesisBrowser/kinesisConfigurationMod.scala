...
object kinesisConfigurationMod {
  ...
  @js.native
  val configurationProperties: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ConfigurationDefinition<KinesisResolvableConfiguration, KinesisResolvedConfiguration> */ Any = js.native
  ...
  object KinesisConfiguration {
    ...
    inline def apply(credentials: Credentials | Provider[Credentials], region: String | Provider[String]): KinesisConfiguration = {
  ...
  trait KinesisResolvedConfiguration
    ...
    def base64Decoder_MKinesisResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MKinesisResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("base64Encoder")
    ...
    def streamCollector_MKinesisResolvedConfiguration(stream: Any): js.Promise[js.typedarray.Uint8Array]
    @JSName("streamCollector")
    ...
    @JSName("urlParser")
    def urlParser_MKinesisResolvedConfiguration(url: URL): Endpoint
    @JSName("urlParser")
    var urlParser_Original: UrlParser
    
    @JSName("utf8Decoder")
    def utf8Decoder_MKinesisResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MKinesisResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("utf8Encoder")
