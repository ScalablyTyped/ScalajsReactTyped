...
@JSImport("@aws-sdk/client-kinesis-browser/types/DisableEnhancedMonitoringInput", JSImport.Namespace)
@js.native
object typesDisableEnhancedMonitoringInputMod extends js.Object {
  @js.native
