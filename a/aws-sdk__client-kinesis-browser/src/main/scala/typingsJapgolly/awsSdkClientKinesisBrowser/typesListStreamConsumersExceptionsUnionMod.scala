...
object typesListStreamConsumersExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientKinesisBrowser.typesExpiredNextTokenExceptionMod.ExpiredNextTokenException
  ...
  */
  ...
  object ListStreamConsumersExceptionsUnion {
    ...
    inline def ExpiredNextTokenException(): typingsJapgolly.awsSdkClientKinesisBrowser.typesExpiredNextTokenExceptionMod.ExpiredNextTokenException = {
      val __obj = js.Dynamic.literal(name = "ExpiredNextTokenException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientKinesisBrowser.typesExpiredNextTokenExceptionMod.ExpiredNextTokenException]
    }
