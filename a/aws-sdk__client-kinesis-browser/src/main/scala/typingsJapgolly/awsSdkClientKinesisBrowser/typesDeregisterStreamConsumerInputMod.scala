...
@JSImport("@aws-sdk/client-kinesis-browser/types/DeregisterStreamConsumerInput", JSImport.Namespace)
@js.native
object typesDeregisterStreamConsumerInputMod extends js.Object {
  @js.native
