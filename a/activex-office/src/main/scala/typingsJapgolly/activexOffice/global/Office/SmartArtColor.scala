...
/* private */ open class SmartArtColor ()
  extends StObject
     with typingsJapgolly.activexOffice.Office.SmartArtColor {
  ...
  var OfficeDotSmartArtColor_typekey: typingsJapgolly.activexOffice.Office.SmartArtColor = js.native
