...
import typingsJapgolly.activexOffice.Office.IFoundFiles
...
/* private */ open class IFind ()
  extends StObject
     with typingsJapgolly.activexOffice.Office.IFind {
  ...
  var OfficeDotIFind_typekey: typingsJapgolly.activexOffice.Office.IFind = js.native
