...
/* private */ open class ThreeDFormat ()
  extends StObject
     with typingsJapgolly.activexOffice.Office.ThreeDFormat {
  ...
  /* CompleteClass */
  override val ContourColor: typingsJapgolly.activexOffice.Office.ColorFormat = js.native
  ...
  /* CompleteClass */
  override val ExtrusionColor: typingsJapgolly.activexOffice.Office.ColorFormat = js.native
  ...
  var OfficeDotThreeDFormat_typekey: typingsJapgolly.activexOffice.Office.ThreeDFormat = js.native
