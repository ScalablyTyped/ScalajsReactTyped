...
@js.native
/* private */ open class SharedWorkspaceFile ()
  extends StObject
     with typingsJapgolly.activexOffice.Office.SharedWorkspaceFile {
  ...
  var OfficeDotSharedWorkspaceFile_typekey: typingsJapgolly.activexOffice.Office.SharedWorkspaceFile = js.native
