...
object ScopeFolder {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AddToSearchFolders = AddToSearchFolders.toJsFn, Application = Application.asInstanceOf[js.Any], Creator = Creator.asInstanceOf[js.Any], Name = Name.asInstanceOf[js.Any], Path = Path.asInstanceOf[js.Any], ScopeFolders = ScopeFolders.asInstanceOf[js.Any])
  ...
  extension [Self <: ScopeFolder](x: Self) {
    ...
    inline def setAddToSearchFolders(value: Callback): Self = StObject.set(x, "AddToSearchFolders", value.toJsFn)
