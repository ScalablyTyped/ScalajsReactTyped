...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.activexOffice.activexOfficeInts.`-2`
*/
trait MsoPresetMaterial extends StObject
object MsoPresetMaterial {
  
  inline def msoMaterialClear: `13` = 13.asInstanceOf[`13`]
  
  inline def msoMaterialDarkEdge: `11` = 11.asInstanceOf[`11`]
  
  inline def msoMaterialFlat: `14` = 14.asInstanceOf[`14`]
  
  inline def msoMaterialMatte: `1` = 1.asInstanceOf[`1`]
  
  inline def msoMaterialMatte2: `5` = 5.asInstanceOf[`5`]
  
  inline def msoMaterialMetal: `3` = 3.asInstanceOf[`3`]
  
  inline def msoMaterialMetal2: `7` = 7.asInstanceOf[`7`]
  
  inline def msoMaterialPlastic: `2` = 2.asInstanceOf[`2`]
  
  inline def msoMaterialPlastic2: `6` = 6.asInstanceOf[`6`]
  
  inline def msoMaterialPowder: `10` = 10.asInstanceOf[`10`]
  
  inline def msoMaterialSoftEdge: `12` = 12.asInstanceOf[`12`]
  
  inline def msoMaterialSoftMetal: `15` = 15.asInstanceOf[`15`]
  
  inline def msoMaterialTranslucentPowder: `9` = 9.asInstanceOf[`9`]
  
  inline def msoMaterialWarmMatte: `8` = 8.asInstanceOf[`8`]
  
  inline def msoMaterialWireFrame: `4` = 4.asInstanceOf[`4`]
  
  inline def msoPresetMaterialMixed: `-2` = -2.asInstanceOf[`-2`]
}
