...
*/
trait MsoCTPDockPosition extends StObject
object MsoCTPDockPosition {
  
  inline def msoCTPDockPositionBottom: `3` = 3.asInstanceOf[`3`]
  
  inline def msoCTPDockPositionFloating: `4` = 4.asInstanceOf[`4`]
  
  inline def msoCTPDockPositionLeft: `0` = 0.asInstanceOf[`0`]
  
  inline def msoCTPDockPositionRight: `2` = 2.asInstanceOf[`2`]
  
  inline def msoCTPDockPositionTop: `1` = 1.asInstanceOf[`1`]
}
