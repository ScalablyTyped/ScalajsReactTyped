...
*/
trait MsoButtonState extends StObject
object MsoButtonState {
  
  inline def msoButtonDown: `-1` = -1.asInstanceOf[`-1`]
  
  inline def msoButtonMixed: `2` = 2.asInstanceOf[`2`]
  
  inline def msoButtonUp: `0` = 0.asInstanceOf[`0`]
}
