...
*/
trait MsoCommandBarButtonHyperlinkType extends StObject
object MsoCommandBarButtonHyperlinkType {
  
  inline def msoCommandBarButtonHyperlinkInsertPicture: `2` = 2.asInstanceOf[`2`]
  
  inline def msoCommandBarButtonHyperlinkNone: `0` = 0.asInstanceOf[`0`]
  
  inline def msoCommandBarButtonHyperlinkOpen: `1` = 1.asInstanceOf[`1`]
}
