...
object MsoMetaPropertyType {
  ...
  inline def msoMetaPropertyTypeBoolean: `1` = 1.asInstanceOf[`1`]
  
  inline def msoMetaPropertyTypeBusinessData: `20` = 20.asInstanceOf[`20`]
  
  inline def msoMetaPropertyTypeBusinessDataSecondary: `21` = 21.asInstanceOf[`21`]
  
  inline def msoMetaPropertyTypeCalculated: `3` = 3.asInstanceOf[`3`]
  
  inline def msoMetaPropertyTypeChoice: `2` = 2.asInstanceOf[`2`]
  
  inline def msoMetaPropertyTypeComputed: `4` = 4.asInstanceOf[`4`]
  
  inline def msoMetaPropertyTypeCurrency: `5` = 5.asInstanceOf[`5`]
  
  inline def msoMetaPropertyTypeDateTime: `6` = 6.asInstanceOf[`6`]
  
  inline def msoMetaPropertyTypeFillInChoice: `7` = 7.asInstanceOf[`7`]
  
  inline def msoMetaPropertyTypeGuid: `8` = 8.asInstanceOf[`8`]
  
  inline def msoMetaPropertyTypeInteger: `9` = 9.asInstanceOf[`9`]
  
  inline def msoMetaPropertyTypeLookup: `10` = 10.asInstanceOf[`10`]
  
  inline def msoMetaPropertyTypeMax: `22` = 22.asInstanceOf[`22`]
  
  inline def msoMetaPropertyTypeMultiChoice: `12` = 12.asInstanceOf[`12`]
  
  inline def msoMetaPropertyTypeMultiChoiceFillIn: `13` = 13.asInstanceOf[`13`]
  
  inline def msoMetaPropertyTypeMultiChoiceLookup: `11` = 11.asInstanceOf[`11`]
  
  inline def msoMetaPropertyTypeNote: `14` = 14.asInstanceOf[`14`]
  
  inline def msoMetaPropertyTypeNumber: `15` = 15.asInstanceOf[`15`]
  
  inline def msoMetaPropertyTypeText: `16` = 16.asInstanceOf[`16`]
  
  inline def msoMetaPropertyTypeUnknown: `0` = 0.asInstanceOf[`0`]
  
  inline def msoMetaPropertyTypeUrl: `17` = 17.asInstanceOf[`17`]
  
  inline def msoMetaPropertyTypeUser: `18` = 18.asInstanceOf[`18`]
  
  inline def msoMetaPropertyTypeUserMulti: `19` = 19.asInstanceOf[`19`]
}
