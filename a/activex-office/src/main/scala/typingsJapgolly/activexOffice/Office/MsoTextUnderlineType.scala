...
object MsoTextUnderlineType {
  ...
  @scala.inline
  def msoNoUnderline: `0` = this.cast(0)
  @scala.inline
  def msoUnderlineDashHeavyLine: `8` = this.cast(8)
  @scala.inline
  def msoUnderlineDashLine: `7` = this.cast(7)
  @scala.inline
  def msoUnderlineDashLongHeavyLine: `10` = this.cast(10)
  @scala.inline
  def msoUnderlineDashLongLine: `9` = this.cast(9)
  @scala.inline
  def msoUnderlineDotDashHeavyLine: `12` = this.cast(12)
  @scala.inline
  def msoUnderlineDotDashLine: `11` = this.cast(11)
  @scala.inline
  def msoUnderlineDotDotDashHeavyLine: `14` = this.cast(14)
  @scala.inline
  def msoUnderlineDotDotDashLine: `13` = this.cast(13)
  @scala.inline
  def msoUnderlineDottedHeavyLine: `6` = this.cast(6)
  @scala.inline
  def msoUnderlineDottedLine: `5` = this.cast(5)
  @scala.inline
  def msoUnderlineDoubleLine: `3` = this.cast(3)
  @scala.inline
  def msoUnderlineHeavyLine: `4` = this.cast(4)
  @scala.inline
  def msoUnderlineMixed: `-2` = this.cast(-2)
  @scala.inline
  def msoUnderlineSingleLine: `2` = this.cast(2)
  @scala.inline
  def msoUnderlineWavyDoubleLine: `17` = this.cast(17)
  @scala.inline
  def msoUnderlineWavyHeavyLine: `16` = this.cast(16)
  @scala.inline
  def msoUnderlineWavyLine: `15` = this.cast(15)
  @scala.inline
  def msoUnderlineWords: `1` = this.cast(1)
}
