...
*/
trait MsoTextCaps extends StObject
object MsoTextCaps {
  
  inline def msoAllCaps: `2` = 2.asInstanceOf[`2`]
  
  inline def msoCapsMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoNoCaps: `0` = 0.asInstanceOf[`0`]
  
  inline def msoSmallCaps: `1` = 1.asInstanceOf[`1`]
}
