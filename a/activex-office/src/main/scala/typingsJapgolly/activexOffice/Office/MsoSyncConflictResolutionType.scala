...
object MsoSyncConflictResolutionType {
  ...
  inline def msoSyncConflictClientWins: `0` = 0.asInstanceOf[`0`]
  
  inline def msoSyncConflictMerge: `2` = 2.asInstanceOf[`2`]
  
  inline def msoSyncConflictServerWins: `1` = 1.asInstanceOf[`1`]
}
