...
object MsoTextureAlignment {
  ...
  inline def msoTextureAlignmentMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoTextureBottom: `7` = 7.asInstanceOf[`7`]
  
  inline def msoTextureBottomLeft: `6` = 6.asInstanceOf[`6`]
  
  inline def msoTextureBottomRight: `8` = 8.asInstanceOf[`8`]
  
  inline def msoTextureCenter: `4` = 4.asInstanceOf[`4`]
  
  inline def msoTextureLeft: `3` = 3.asInstanceOf[`3`]
  
  inline def msoTextureRight: `5` = 5.asInstanceOf[`5`]
  
  inline def msoTextureTop: `1` = 1.asInstanceOf[`1`]
  
  inline def msoTextureTopLeft: `0` = 0.asInstanceOf[`0`]
  
  inline def msoTextureTopRight: `2` = 2.asInstanceOf[`2`]
}
