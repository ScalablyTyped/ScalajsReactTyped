...
class OfficeTheme protected () extends js.Object {
  ...
  val ThemeEffectScheme: typingsJapgolly.activexOffice.Office.ThemeEffectScheme = js.native
  val ThemeFontScheme: typingsJapgolly.activexOffice.Office.ThemeFontScheme = js.native
