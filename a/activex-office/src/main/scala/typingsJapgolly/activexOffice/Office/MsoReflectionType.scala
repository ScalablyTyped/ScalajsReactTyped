...
object MsoReflectionType {
  ...
  inline def msoReflectionType1: `1` = 1.asInstanceOf[`1`]
  
  inline def msoReflectionType2: `2` = 2.asInstanceOf[`2`]
  
  inline def msoReflectionType3: `3` = 3.asInstanceOf[`3`]
  
  inline def msoReflectionType4: `4` = 4.asInstanceOf[`4`]
  
  inline def msoReflectionType5: `5` = 5.asInstanceOf[`5`]
  
  inline def msoReflectionType6: `6` = 6.asInstanceOf[`6`]
  
  inline def msoReflectionType7: `7` = 7.asInstanceOf[`7`]
  
  inline def msoReflectionType8: `8` = 8.asInstanceOf[`8`]
  
  inline def msoReflectionType9: `9` = 9.asInstanceOf[`9`]
  
  inline def msoReflectionTypeMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoReflectionTypeNone: `0` = 0.asInstanceOf[`0`]
}
