...
*/
trait MsoFilterComparison extends StObject
object MsoFilterComparison {
  
  inline def msoFilterComparisonContains: `8` = 8.asInstanceOf[`8`]
  
  inline def msoFilterComparisonEqual: `0` = 0.asInstanceOf[`0`]
  
  inline def msoFilterComparisonGreaterThan: `3` = 3.asInstanceOf[`3`]
  
  inline def msoFilterComparisonGreaterThanEqual: `5` = 5.asInstanceOf[`5`]
  
  inline def msoFilterComparisonIsBlank: `6` = 6.asInstanceOf[`6`]
  
  inline def msoFilterComparisonIsNotBlank: `7` = 7.asInstanceOf[`7`]
  
  inline def msoFilterComparisonLessThan: `2` = 2.asInstanceOf[`2`]
  
  inline def msoFilterComparisonLessThanEqual: `4` = 4.asInstanceOf[`4`]
  
  inline def msoFilterComparisonNotContains: `9` = 9.asInstanceOf[`9`]
  
  inline def msoFilterComparisonNotEqual: `1` = 1.asInstanceOf[`1`]
}
