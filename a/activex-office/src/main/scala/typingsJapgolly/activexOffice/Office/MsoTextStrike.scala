...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.activexOffice.activexOfficeInts.`-2`
*/
trait MsoTextStrike extends StObject
object MsoTextStrike {
  
  inline def msoDoubleStrike: `2` = 2.asInstanceOf[`2`]
  
  inline def msoNoStrike: `0` = 0.asInstanceOf[`0`]
  
  inline def msoSingleStrike: `1` = 1.asInstanceOf[`1`]
  
  inline def msoStrikeMixed: `-2` = -2.asInstanceOf[`-2`]
}
