...
class SignatureInfo protected () extends js.Object {
  ...
  val CertificateVerificationResults: typingsJapgolly.activexOffice.Office.CertificateVerificationResults = js.native
  val ContentVerificationResults: typingsJapgolly.activexOffice.Office.ContentVerificationResults = js.native
