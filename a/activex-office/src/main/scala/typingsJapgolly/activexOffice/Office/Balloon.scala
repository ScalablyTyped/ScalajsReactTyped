...
object Balloon {
  ...
  inline def apply(
    ...
    Parent: Any,
    Private: Double,
    SetAvoidRectangle: (Double, Double, Double, Double) => Callback,
    Show: CallbackTo[MsoBalloonButtonType],
    Text: String
  ): Balloon = {
    val __obj = js.Dynamic.literal(Animation = Animation.asInstanceOf[js.Any], Application = Application.asInstanceOf[js.Any], BalloonType = BalloonType.asInstanceOf[js.Any], Button = Button.asInstanceOf[js.Any], Callback = Callback.asInstanceOf[js.Any], Checkboxes = Checkboxes.asInstanceOf[js.Any], Close = Close.toJsFn, Creator = Creator.asInstanceOf[js.Any], Heading = Heading.asInstanceOf[js.Any], Icon = Icon.asInstanceOf[js.Any], Labels = Labels.asInstanceOf[js.Any], Mode = Mode.asInstanceOf[js.Any], Name = Name.asInstanceOf[js.Any], Parent = Parent.asInstanceOf[js.Any], Private = Private.asInstanceOf[js.Any], SetAvoidRectangle = js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: Double) => (SetAvoidRectangle(t0, t1, t2, t3)).runNow()), Show = Show.toJsFn, Text = Text.asInstanceOf[js.Any])
  ...
  extension [Self <: Balloon](x: Self) {
    ...
    inline def setSetAvoidRectangle(value: (Double, Double, Double, Double) => Callback): Self = StObject.set(x, "SetAvoidRectangle", js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: Double) => (value(t0, t1, t2, t3)).runNow()))
    
    inline def setShow(value: CallbackTo[MsoBalloonButtonType]): Self = StObject.set(x, "Show", value.toJsFn)
