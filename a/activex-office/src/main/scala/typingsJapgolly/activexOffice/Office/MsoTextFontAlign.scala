...
object MsoTextFontAlign {
  ...
  inline def msoFontAlignAuto: `0` = 0.asInstanceOf[`0`]
  
  inline def msoFontAlignBaseline: `3` = 3.asInstanceOf[`3`]
  
  inline def msoFontAlignBottom: `4` = 4.asInstanceOf[`4`]
  
  inline def msoFontAlignCenter: `2` = 2.asInstanceOf[`2`]
  
  inline def msoFontAlignMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoFontAlignTop: `1` = 1.asInstanceOf[`1`]
}
