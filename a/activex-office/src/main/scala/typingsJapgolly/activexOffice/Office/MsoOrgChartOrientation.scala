...
*/
trait MsoOrgChartOrientation extends StObject
object MsoOrgChartOrientation {
  
  inline def msoOrgChartOrientationMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoOrgChartOrientationVertical: `1` = 1.asInstanceOf[`1`]
}
