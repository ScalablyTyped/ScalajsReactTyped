...
trait ShapeRange extends StObject {
  ...
  val ConnectorFormat: typingsJapgolly.activexOffice.Office.ConnectorFormat = js.native
  ...
  val DiagramNode: typingsJapgolly.activexOffice.Office.DiagramNode = js.native
  ...
  val TextFrame: typingsJapgolly.activexOffice.Office.TextFrame = js.native
