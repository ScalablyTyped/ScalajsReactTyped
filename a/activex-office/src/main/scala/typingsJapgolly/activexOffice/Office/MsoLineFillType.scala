...
object MsoLineFillType {
  ...
  inline def msoLineFillBackground: `5` = 5.asInstanceOf[`5`]
  
  inline def msoLineFillGradient: `3` = 3.asInstanceOf[`3`]
  
  inline def msoLineFillMixed: `-2` = -2.asInstanceOf[`-2`]
  
  inline def msoLineFillNone: `0` = 0.asInstanceOf[`0`]
  
  inline def msoLineFillPatterned: `2` = 2.asInstanceOf[`2`]
  
  inline def msoLineFillPicture: `6` = 6.asInstanceOf[`6`]
  
  inline def msoLineFillSolid: `1` = 1.asInstanceOf[`1`]
  
  inline def msoLineFillTextured: `4` = 4.asInstanceOf[`4`]
}
