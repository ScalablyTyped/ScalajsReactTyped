...
object MetaProperty {
  ...
  inline def apply(
    ...
    Validate: CallbackTo[String],
    ValidationError: String,
    Value: Any
  ): MetaProperty = {
    val __obj = js.Dynamic.literal(Application = Application.asInstanceOf[js.Any], Creator = Creator.asInstanceOf[js.Any], Id = Id.asInstanceOf[js.Any], IsReadOnly = IsReadOnly.asInstanceOf[js.Any], IsRequired = IsRequired.asInstanceOf[js.Any], Name = Name.asInstanceOf[js.Any], Parent = Parent.asInstanceOf[js.Any], Type = Type.asInstanceOf[js.Any], Validate = Validate.toJsFn, ValidationError = ValidationError.asInstanceOf[js.Any], Value = Value.asInstanceOf[js.Any])
  ...
  extension [Self <: MetaProperty](x: Self) {
    ...
    inline def setValidate(value: CallbackTo[String]): Self = StObject.set(x, "Validate", value.toJsFn)
