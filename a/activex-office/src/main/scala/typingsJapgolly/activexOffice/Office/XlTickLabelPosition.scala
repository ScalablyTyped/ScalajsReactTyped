...
import typingsJapgolly.activexOffice.activexOfficeInts.`-4127`
import typingsJapgolly.activexOffice.activexOfficeInts.`-4134`
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.activexOffice.activexOfficeInts.`-4127`
  - typingsJapgolly.activexOffice.activexOfficeInts.`-4134`
