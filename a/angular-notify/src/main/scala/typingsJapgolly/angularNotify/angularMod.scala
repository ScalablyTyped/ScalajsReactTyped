...
import typingsJapgolly.angularNotify.anon.Classes
import typingsJapgolly.angularNotify.anon.Container
...
object angularMod {
  ...
  object cgNotify {
    ...
    object INotify {
      ...
      inline def apply(close: Callback, message: String): INotify = {
        val __obj = js.Dynamic.literal(close = close.toJsFn, message = message.asInstanceOf[js.Any])
