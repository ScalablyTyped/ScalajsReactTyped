...
object mod extends Shortcut {
  ...
  trait Request extends StObject {
    ...
    def apply(resourceId: String, hash: Any, callback: js.Function1[/* repeated */ Any, Any]): Unit = js.native
    def apply(resourceId: String, hash: Unit, callback: js.Function1[/* repeated */ Any, Any]): Unit = js.native
    /***
      * Request a resource.
  ...
  trait Static extends StObject {
    ...
    def request(resourceId: String, hash: Any, callback: js.Function1[/* repeated */ Any, Any]): Unit
    def request(resourceId: String, hash: Unit, callback: js.Function1[/* repeated */ Any, Any]): Unit
    /***
      * Request a resource.
      * settings: A set of key/value pairs of settings for the request.
      *   resourceId: Identifier string for the resource.
    ...
    /***
      ...
      */
    def subscribe(topic: String, callback: js.Function1[/* repeated */ Any, Any]): Unit
    def subscribe(topic: String, callback: js.Function1[/* repeated */ Any, Any], priority: Double): Unit
    /***
      * Subscribe to a message.
      * topic: Name of the message to subscribe to.
      ...
      * [priority]: Priority relative to other subscriptions for the same message. Lower values have higher priority. Default is 10.
      */
    def subscribe(topic: String, context: Any, callback: js.Function1[/* repeated */ Any, Any]): Unit
    def subscribe(topic: String, context: Any, callback: js.Function1[/* repeated */ Any, Any], priority: Double): Unit
    @JSName("subscribe")
    ...
    /***
      ...
      */
    def unsubscribe(topic: String, callback: js.Function1[/* repeated */ Any, Any]): Unit
  }
  object Static {
    ...
    inline def apply(
      ...
      store: Store,
      subscribe: Subscribe,
      unsubscribe: (String, js.Function1[/* repeated */ Any, Any]) => Callback
    ): Static = {
      val __obj = js.Dynamic.literal(publish = js.Any.fromFunction2(publish), request = request.asInstanceOf[js.Any], store = store.asInstanceOf[js.Any], subscribe = subscribe.asInstanceOf[js.Any], unsubscribe = js.Any.fromFunction2((t0: String, t1: js.Function1[/* repeated */ Any, Any]) => (unsubscribe(t0, t1)).runNow()))
    ...
    extension [Self <: Static](x: Self) {
      ...
      inline def setUnsubscribe(value: (String, js.Function1[/* repeated */ Any, Any]) => Callback): Self = StObject.set(x, "unsubscribe", js.Any.fromFunction2((t0: String, t1: js.Function1[/* repeated */ Any, Any]) => (value(t0, t1)).runNow()))
    }
  }
  ...
  trait Subscribe extends StObject {
    ...
    /***
      ...
      * [priority]: Priority relative to other subscriptions for the same message. Lower values have higher priority. Default is 10.
      */
    def apply(topic: String, callback: js.Function1[/* repeated */ Any, Any]): Unit = js.native
    def apply(topic: String, callback: js.Function1[/* repeated */ Any, Any], priority: Double): Unit = js.native
    /***
      * Subscribe to a message.
      * topic: Name of the message to subscribe to.
      * context: What this will be when the callback is invoked.
      ...
      * [priority]: Priority relative to other subscriptions for the same message. Lower values have higher priority. Default is 10.
      */
    def apply(topic: String, context: Any, callback: js.Function1[/* repeated */ Any, Any]): Unit = js.native
    def apply(topic: String, context: Any, callback: js.Function1[/* repeated */ Any, Any], priority: Double): Unit = js.native
  }
