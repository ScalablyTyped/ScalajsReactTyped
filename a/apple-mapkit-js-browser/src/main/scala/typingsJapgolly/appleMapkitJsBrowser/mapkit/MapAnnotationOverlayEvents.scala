...
trait MapAnnotationOverlayEvents[T] extends StObject {
  ...
  var deselect: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Annotation
  
  var `drag-end`: EventBase[T] & AnnotationAnnotation
  
  var `drag-start`: EventBase[T] & AnnotationAnnotation
  
  var dragging: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Coordinate
  
  var select: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Annotation
}
object MapAnnotationOverlayEvents {
  
  inline def apply[T](
    deselect: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Annotation,
    `drag-end`: EventBase[T] & AnnotationAnnotation,
    `drag-start`: EventBase[T] & AnnotationAnnotation,
    dragging: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Coordinate,
    select: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Annotation
  ...
  extension [Self <: MapAnnotationOverlayEvents[?], T](x: Self & MapAnnotationOverlayEvents[T]) {
    ...
    inline def setDeselect(value: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Annotation): Self = StObject.set(x, "deselect", value.asInstanceOf[js.Any])
    ...
    inline def setDragging(value: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Coordinate): Self = StObject.set(x, "dragging", value.asInstanceOf[js.Any])
    
    inline def setSelect(value: EventBase[T] & typingsJapgolly.appleMapkitJsBrowser.anon.Annotation): Self = StObject.set(x, "select", value.asInstanceOf[js.Any])
  }
}
