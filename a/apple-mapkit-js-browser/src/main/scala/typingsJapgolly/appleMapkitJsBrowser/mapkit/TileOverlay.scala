...
object TileOverlay {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(data = data.asInstanceOf[js.Any], maximumZ = maximumZ.asInstanceOf[js.Any], minimumZ = minimumZ.asInstanceOf[js.Any], opacity = opacity.asInstanceOf[js.Any], reload = reload.toJsFn, urlTemplate = urlTemplate.asInstanceOf[js.Any])
