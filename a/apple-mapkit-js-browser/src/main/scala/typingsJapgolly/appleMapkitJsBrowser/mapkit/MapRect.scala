...
object MapRect {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(copy = copy.toJsFn, maxX = maxX.asInstanceOf[js.Any], maxY = maxY.asInstanceOf[js.Any], midX = midX.asInstanceOf[js.Any], midY = midY.asInstanceOf[js.Any], minX = minX.asInstanceOf[js.Any], minY = minY.asInstanceOf[js.Any], origin = origin.asInstanceOf[js.Any], scale = js.Any.fromFunction2(scale), size = size.asInstanceOf[js.Any], toCoordinateRegion = toCoordinateRegion.toJsFn)
  ...
  extension [Self <: MapRect](x: Self) {
    ...
    inline def setCopy(value: CallbackTo[MapRect]): Self = StObject.set(x, "copy", value.toJsFn)
