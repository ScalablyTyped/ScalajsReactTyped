...
object SearchDelegate {
  ...
  extension [Self <: SearchDelegate](x: Self) {
    ...
    inline def setAutocompleteDidComplete(value: /* data */ SearchAutocompleteResponse => Callback): Self = StObject.set(x, "autocompleteDidComplete", js.Any.fromFunction1((t0: /* data */ SearchAutocompleteResponse) => value(t0).runNow()))
    
    inline def setAutocompleteDidCompleteUndefined: Self = StObject.set(x, "autocompleteDidComplete", js.undefined)
    
    inline def setAutocompleteDidError(value: /* error */ js.Error => Callback): Self = StObject.set(x, "autocompleteDidError", js.Any.fromFunction1((t0: /* error */ js.Error) => value(t0).runNow()))
    
    inline def setAutocompleteDidErrorUndefined: Self = StObject.set(x, "autocompleteDidError", js.undefined)
    
    inline def setSearchDidComplete(value: /* data */ SearchResponse => Callback): Self = StObject.set(x, "searchDidComplete", js.Any.fromFunction1((t0: /* data */ SearchResponse) => value(t0).runNow()))
