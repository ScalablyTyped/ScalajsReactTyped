...
object GeoJSONDelegate {
  ...
  extension [Self <: GeoJSONDelegate](x: Self) {
    ...
    inline def setGeoJSONDidComplete(value: (/* result */ ItemCollection, /* geoJSON */ js.Object) => Callback): Self = StObject.set(x, "geoJSONDidComplete", js.Any.fromFunction2((t0: /* result */ ItemCollection, t1: /* geoJSON */ js.Object) => (value(t0, t1)).runNow()))
    
    inline def setGeoJSONDidCompleteUndefined: Self = StObject.set(x, "geoJSONDidComplete", js.undefined)
    
    inline def setGeoJSONDidError(value: (/* error */ js.Error, /* geoJSON */ js.Object) => Callback): Self = StObject.set(x, "geoJSONDidError", js.Any.fromFunction2((t0: /* error */ js.Error, t1: /* geoJSON */ js.Object) => (value(t0, t1)).runNow()))
