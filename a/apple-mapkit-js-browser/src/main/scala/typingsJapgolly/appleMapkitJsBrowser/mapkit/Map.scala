...
import typingsJapgolly.appleMapkitJsBrowser.anon.AnnotationAnnotation
import typingsJapgolly.appleMapkitJsBrowser.anon.Code
import typingsJapgolly.appleMapkitJsBrowser.anon.Timestamp
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`double-tap`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-end`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`drag-start`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`long-press`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`map-type-change`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`region-change-end`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`region-change-start`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`rotation-end`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`rotation-start`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`scroll-end`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`scroll-start`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`single-tap`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`user-location-change`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`user-location-error`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`zoom-end`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.`zoom-start`
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.deselect
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.dragging
import typingsJapgolly.appleMapkitJsBrowser.appleMapkitJsBrowserStrings.select
...
trait Map extends StObject {
  ...
  def addEventListener_deselect[T](
    ...
    listener: js.ThisFunction1[
      /* this */ T, 
      /* event */ EventBase[this.type] & typingsJapgolly.appleMapkitJsBrowser.anon.Annotation, 
      Unit
    ]
  ): Unit = js.native
  @JSName("addEventListener")
  ...
  def addEventListener_dragging[T](
    ...
    listener: js.ThisFunction1[
      /* this */ T, 
      /* event */ EventBase[this.type] & typingsJapgolly.appleMapkitJsBrowser.anon.Coordinate, 
      Unit
    ]
  ): Unit = js.native
  @JSName("addEventListener")
