...
import typingsJapgolly.appleMapkitJsBrowser.mapkit.AnnotationConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.CameraZoomRangeConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.DirectionsConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.DirectionsRequest
import typingsJapgolly.appleMapkitJsBrowser.mapkit.DirectionsResponse
import typingsJapgolly.appleMapkitJsBrowser.mapkit.EtaRequestOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.EtaResponse
import typingsJapgolly.appleMapkitJsBrowser.mapkit.GeoJSONDelegate
import typingsJapgolly.appleMapkitJsBrowser.mapkit.GeocoderConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.ImageAnnotationConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.ImportGeoJSONCallback
import typingsJapgolly.appleMapkitJsBrowser.mapkit.InitializationEvent
import typingsJapgolly.appleMapkitJsBrowser.mapkit.InitializationEventType
import typingsJapgolly.appleMapkitJsBrowser.mapkit.ItemCollection
import typingsJapgolly.appleMapkitJsBrowser.mapkit.MapConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.MapKitInitOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.MarkerAnnotationConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.PaddingConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory
import typingsJapgolly.appleMapkitJsBrowser.mapkit.PointsOfInterestSearchOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.SearchConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.StyleConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.StylesOverlayOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.TileOverlayConstructorOptions
import typingsJapgolly.appleMapkitJsBrowser.mapkit.URLTemplateCallback
...
object global {
  ...
  object mapkit {
    ...
    open class Annotation protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Annotation {
      /**
        ...
        */
      def this(
        coordinate: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate,
    ...
    open class BoundingRegion protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.BoundingRegion {
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def copy(): typingsJapgolly.appleMapkitJsBrowser.mapkit.BoundingRegion = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def toCoordinateRegion(): typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateRegion = js.native
    ...
    open class CameraZoomRange protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.CameraZoomRange {
    ...
    open class CircleOverlay protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.CircleOverlay {
      /**
        ...
        * the circle.
        */
      def this(coordinate: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate, radius: Double) = this()
      def this(
        coordinate: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate,
        radius: Double,
    ...
    open class Coordinate protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate {
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def copy(): typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate = js.native
      
      /**
        * Returns a Boolean value indicating whether two coordinates are equal.
        */
      /* CompleteClass */
      override def equals(anotherCoordinate: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate): Boolean = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def toMapPoint(): typingsJapgolly.appleMapkitJsBrowser.mapkit.MapPoint = js.native
      
      /**
        * Returns the unwrapped map point that corresponds to the coordinate.
        */
      /* CompleteClass */
      override def toUnwrappedMapPoint(): typingsJapgolly.appleMapkitJsBrowser.mapkit.MapPoint = js.native
    }
    ...
    open class CoordinateRegion protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateRegion {
      /**
        ...
        */
      def this(
        center: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate,
        span: typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateSpan
      ) = this()
      ...
      /**
        ...
        */
      /* CompleteClass */
      var center: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate = js.native
      
      /**
        * Returns a copy of the calling coordinate region.
        */
      /* CompleteClass */
      override def copy(): typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateRegion = js.native
      
      /**
        * Returns a Boolean value indicating whether two regions are equal.
        */
      /* CompleteClass */
      override def equals(anotherRegion: typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateRegion): Boolean = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      var span: typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateSpan = js.native
      
      /**
        * Returns the bounding region that corresponds to the calling coordinate region.
        */
      /* CompleteClass */
      override def toBoundingRegion(): typingsJapgolly.appleMapkitJsBrowser.mapkit.BoundingRegion = js.native
      
      /**
        * Returns the map rectangle that corresponds to the calling coordinate region.
        */
      /* CompleteClass */
      override def toMapRect(): typingsJapgolly.appleMapkitJsBrowser.mapkit.MapRect = js.native
    }
    ...
    open class CoordinateSpan protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateSpan {
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def copy(): typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateSpan = js.native
      
      /**
        * Returns a Boolean value that indicates whether two spans are equal.
        */
      /* CompleteClass */
      override def equals(anotherSpan: typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateSpan): Boolean = js.native
    ...
    open class Directions ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Directions {
    ...
    object Directions {
      ...
      object Transport extends StObject {
        ...
        @JSBracketAccess
        def apply(value: Double): js.UndefOr[typingsJapgolly.appleMapkitJsBrowser.mapkit.Directions.Transport & Double] = js.native
        
        /* 0 */ val Automobile: typingsJapgolly.appleMapkitJsBrowser.mapkit.Directions.Transport.Automobile & Double = js.native
        
        /* 1 */ val Walking: typingsJapgolly.appleMapkitJsBrowser.mapkit.Directions.Transport.Walking & Double = js.native
      }
    }
    ...
    open class Geocoder ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Geocoder {
    ...
    open class LineGradient ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.LineGradient {
    ...
    open class Map protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Map {
      /**
    ...
    open class MapPoint protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.MapPoint {
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def copy(): typingsJapgolly.appleMapkitJsBrowser.mapkit.MapPoint = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def equals(anotherPoint: typingsJapgolly.appleMapkitJsBrowser.mapkit.MapPoint): Boolean = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def toCoordinate(): typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate = js.native
    ...
    open class MapRect protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.MapRect {
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def copy(): typingsJapgolly.appleMapkitJsBrowser.mapkit.MapRect = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def equals(anotherRect: typingsJapgolly.appleMapkitJsBrowser.mapkit.MapRect): Boolean = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      var origin: typingsJapgolly.appleMapkitJsBrowser.mapkit.MapPoint = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def scale(scaleFactor: Double, scaleCenter: typingsJapgolly.appleMapkitJsBrowser.mapkit.MapPoint): typingsJapgolly.appleMapkitJsBrowser.mapkit.MapRect = js.native
      
      /**
        * The width and height of a rectangle, starting from the origin point.
        */
      /* CompleteClass */
      var size: typingsJapgolly.appleMapkitJsBrowser.mapkit.MapSize = js.native
    ...
    open class MapSize protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.MapSize {
      /**
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def copy(): typingsJapgolly.appleMapkitJsBrowser.mapkit.MapSize = js.native
      ...
      /**
        ...
        */
      /* CompleteClass */
      override def equals(anotherSize: typingsJapgolly.appleMapkitJsBrowser.mapkit.MapSize): Boolean = js.native
    ...
    open class MarkerAnnotation protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.MarkerAnnotation {
      /**
        * Creates a marker annotation at the coordinate location with provided options.
        *
        * @param coordinate The coordinate at which this annotation should appear.
        * @param options A hash of properties with which to initialize the annotation.
        */
      def this(coordinate: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate) = this()
      def this(
        coordinate: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate,
    ...
    open class Overlay ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Overlay
    ...
    open class Padding ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Padding {
    ...
    object PointOfInterestCategory extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory & Double] = js.native
      
      /* 3 */ val ATM: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.ATM & Double = js.native
      
      /* 0 */ val Airport: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Airport & Double = js.native
      
      /* 1 */ val AmusementPark: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.AmusementPark & Double = js.native
      
      /* 2 */ val Aquarium: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Aquarium & Double = js.native
      
      /* 4 */ val Bakery: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Bakery & Double = js.native
      
      /* 5 */ val Bank: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Bank & Double = js.native
      
      /* 6 */ val Beach: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Beach & Double = js.native
      
      /* 7 */ val Brewery: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Brewery & Double = js.native
      
      /* 8 */ val Cafe: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Cafe & Double = js.native
      
      /* 9 */ val Campground: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Campground & Double = js.native
      
      /* 10 */ val CarRental: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.CarRental & Double = js.native
      
      /* 11 */ val EVCharger: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.EVCharger & Double = js.native
      
      /* 12 */ val FireStation: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.FireStation & Double = js.native
      
      /* 13 */ val FitnessCenter: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.FitnessCenter & Double = js.native
      
      /* 14 */ val FoodMarket: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.FoodMarket & Double = js.native
      
      /* 15 */ val GasStation: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.GasStation & Double = js.native
      
      /* 16 */ val Hospital: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Hospital & Double = js.native
      
      /* 17 */ val Hotel: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Hotel & Double = js.native
      
      /* 18 */ val Laundry: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Laundry & Double = js.native
      
      /* 19 */ val Library: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Library & Double = js.native
      
      /* 20 */ val Marina: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Marina & Double = js.native
      
      /* 21 */ val MovieTheater: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.MovieTheater & Double = js.native
      
      /* 22 */ val Museum: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Museum & Double = js.native
      
      /* 23 */ val NationalPark: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.NationalPark & Double = js.native
      
      /* 24 */ val Nightlife: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Nightlife & Double = js.native
      
      /* 25 */ val Park: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Park & Double = js.native
      
      /* 26 */ val Parking: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Parking & Double = js.native
      
      /* 27 */ val Pharmacy: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Pharmacy & Double = js.native
      
      /* 28 */ val Police: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Police & Double = js.native
      
      /* 29 */ val PostOffice: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.PostOffice & Double = js.native
      
      /* 30 */ val PublicTransport: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.PublicTransport & Double = js.native
      
      /* 31 */ val Restaurant: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Restaurant & Double = js.native
      
      /* 32 */ val Restroom: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Restroom & Double = js.native
      
      /* 33 */ val School: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.School & Double = js.native
      
      /* 34 */ val Stadium: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Stadium & Double = js.native
      
      /* 35 */ val Store: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Store & Double = js.native
      
      /* 36 */ val Theater: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Theater & Double = js.native
      
      /* 37 */ val University: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.University & Double = js.native
      
      /* 38 */ val Winery: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Winery & Double = js.native
      
      /* 39 */ val Zoo: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestCategory.Zoo & Double = js.native
    }
    ...
    open class PointOfInterestFilter ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestFilter {
    ...
    object PointOfInterestFilter {
      ...
      /**
        ...
        */
      /* static member */
      inline def excluding(categoryList: js.Array[PointOfInterestCategory]): typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestFilter = ^.asInstanceOf[js.Dynamic].applyDynamic("excluding")(categoryList.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestFilter]
      ...
      @js.native
      val filterExcludingAllCategories: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestFilter = js.native
      ...
      @js.native
      val filterIncludingAllCategories: typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestFilter = js.native
      
      /**
        * Creates a point of interest filter that includes categories from a list that you provide.
        */
      /* static member */
      inline def including(categoryList: js.Array[PointOfInterestCategory]): typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestFilter = ^.asInstanceOf[js.Dynamic].applyDynamic("including")(categoryList.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.appleMapkitJsBrowser.mapkit.PointOfInterestFilter]
    }
    ...
    open class PointsOfInterestSearch ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.PointsOfInterestSearch {
    ...
    open class PolygonOverlay protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.PolygonOverlay {
      /**
        ...
        * polygon.
        */
      def this(points: js.Array[typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate]) = this()
      def this(
        points: js.Array[typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate],
        options: StylesOverlayOptions
      ) = this()
    }
    ...
    open class PolylineOverlay protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.PolylineOverlay {
      /**
    ...
    open class Search ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Search {
    ...
    open class Style ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.Style {
      ...
      /**
        ...
        */
      /* CompleteClass */
      var lineGradient: typingsJapgolly.appleMapkitJsBrowser.mapkit.LineGradient = js.native
    ...
    open class TileOverlay protected ()
      extends StObject
         with typingsJapgolly.appleMapkitJsBrowser.mapkit.TileOverlay {
      /**
    ...
    @js.native
    val maps: js.Array[typingsJapgolly.appleMapkitJsBrowser.mapkit.Map] = js.native
