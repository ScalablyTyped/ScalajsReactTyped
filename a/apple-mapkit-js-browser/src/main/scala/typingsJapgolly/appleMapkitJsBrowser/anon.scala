...
import typingsJapgolly.appleMapkitJsBrowser.mapkit.CoordinateRegion
import typingsJapgolly.appleMapkitJsBrowser.mapkit.Overlay
import typingsJapgolly.appleMapkitJsBrowser.mapkit.Place
...
object anon {
  ...
  trait Annotation extends StObject {
    ...
    var annotation: js.UndefOr[typingsJapgolly.appleMapkitJsBrowser.mapkit.Annotation] = js.undefined
  ...
  object Annotation {
    ...
    extension [Self <: Annotation](x: Self) {
      ...
      inline def setAnnotation(value: typingsJapgolly.appleMapkitJsBrowser.mapkit.Annotation): Self = StObject.set(x, "annotation", value.asInstanceOf[js.Any])
  ...
  trait AnnotationAnnotation extends StObject {
    ...
    var annotation: typingsJapgolly.appleMapkitJsBrowser.mapkit.Annotation
  }
  object AnnotationAnnotation {
    
    inline def apply(annotation: typingsJapgolly.appleMapkitJsBrowser.mapkit.Annotation): AnnotationAnnotation = {
  ...
  trait Coordinate extends StObject {
    ...
    var coordinate: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate
  }
  object Coordinate {
    
    inline def apply(
      annotation: typingsJapgolly.appleMapkitJsBrowser.mapkit.Annotation,
    ...
    extension [Self <: Coordinate](x: Self) {
      ...
      inline def setCoordinate(value: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate): Self = StObject.set(x, "coordinate", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Timestamp {
    ...
    inline def apply(coordinate: typingsJapgolly.appleMapkitJsBrowser.mapkit.Coordinate, timestamp: js.Date): Timestamp = {
