...
@JSImport("angular-ui-router", "ParamTypes")
@js.native
open class ParamTypes ()
  extends typingsJapgolly.uirouterCore.mod.ParamTypes
/* static members */
object ParamTypes {
  ...
  /**
    ...
    * ```
    */
  @JSImport("angular-ui-router", "ParamTypes.any")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "ParamTypes.bool")
  @js.native
  ...
  /**
    ...
    * - `date.getDate() === 25`
    */
  @JSImport("angular-ui-router", "ParamTypes.date")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "ParamTypes.hash")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "ParamTypes.int")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "ParamTypes.json")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "ParamTypes.path")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "ParamTypes.query")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("angular-ui-router", "ParamTypes.string")
  @js.native
