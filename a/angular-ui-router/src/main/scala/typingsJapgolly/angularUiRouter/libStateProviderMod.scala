...
import typingsJapgolly.angularUiRouter.libInterfaceMod.Ng1StateDeclaration
import typingsJapgolly.uirouterCore.libStateStateBuilderMod.BuilderFunction
import typingsJapgolly.uirouterCore.libStateStateServiceMod.OnInvalidCallback
import typingsJapgolly.uirouterCore.mod.StateRegistry
