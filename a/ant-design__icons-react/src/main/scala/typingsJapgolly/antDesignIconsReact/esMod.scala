...
import typingsJapgolly.antDesignIconsReact.esComponentsIconMod.TwoToneColorPalette
import typingsJapgolly.antDesignIconsReact.esComponentsIconMod.TwoToneColorPaletteSetter
...
object esMod {
  ...
  @js.native
  open class default ()
    extends typingsJapgolly.antDesignIconsReact.esComponentsIconMod.default
  object default {
    ...
    /* static member */
    @JSImport("@ant-design/icons-react/es", "default.definitions")
    @js.native
    ...
    /* static member */
    @JSImport("@ant-design/icons-react/es", "default.displayName")
    @js.native
