...
import typingsJapgolly.awsLambda.anon.Bucket
import typingsJapgolly.awsLambda.anon.PrincipalId
import typingsJapgolly.awsLambda.anon.SourceIPAddress
import typingsJapgolly.awsLambda.anon.Xamzid2
