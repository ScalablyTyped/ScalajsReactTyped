...
import typingsJapgolly.awsLambda.anon.DictKey
...
object triggerCloudformationCustomResourceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceCreateEvent
    - typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceUpdateEvent
    - typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceDeleteEvent
  */
  ...
  object CloudFormationCustomResourceEvent {
    ...
    inline def CloudFormationCustomResourceCreateEvent(
      ...
      val __obj = js.Dynamic.literal(LogicalResourceId = LogicalResourceId.asInstanceOf[js.Any], RequestId = RequestId.asInstanceOf[js.Any], RequestType = "Create", ResourceProperties = ResourceProperties.asInstanceOf[js.Any], ResourceType = ResourceType.asInstanceOf[js.Any], ResponseURL = ResponseURL.asInstanceOf[js.Any], ServiceToken = ServiceToken.asInstanceOf[js.Any], StackId = StackId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceCreateEvent]
    }
    ...
    inline def CloudFormationCustomResourceDeleteEvent(
      ...
      val __obj = js.Dynamic.literal(LogicalResourceId = LogicalResourceId.asInstanceOf[js.Any], PhysicalResourceId = PhysicalResourceId.asInstanceOf[js.Any], RequestId = RequestId.asInstanceOf[js.Any], RequestType = "Delete", ResourceProperties = ResourceProperties.asInstanceOf[js.Any], ResourceType = ResourceType.asInstanceOf[js.Any], ResponseURL = ResponseURL.asInstanceOf[js.Any], ServiceToken = ServiceToken.asInstanceOf[js.Any], StackId = StackId.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceDeleteEvent]
    }
    ...
    inline def CloudFormationCustomResourceUpdateEvent(
      ...
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceUpdateEvent]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceSuccessResponse
    - typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceFailedResponse
  */
  ...
  object CloudFormationCustomResourceResponse {
    ...
    inline def CloudFormationCustomResourceFailedResponse(
      ...
      val __obj = js.Dynamic.literal(LogicalResourceId = LogicalResourceId.asInstanceOf[js.Any], PhysicalResourceId = PhysicalResourceId.asInstanceOf[js.Any], Reason = Reason.asInstanceOf[js.Any], RequestId = RequestId.asInstanceOf[js.Any], StackId = StackId.asInstanceOf[js.Any], Status = "FAILED")
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceFailedResponse]
    }
    
    inline def CloudFormationCustomResourceSuccessResponse(LogicalResourceId: String, PhysicalResourceId: String, RequestId: String, StackId: String): typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceSuccessResponse = {
      ...
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerCloudformationCustomResourceMod.CloudFormationCustomResourceSuccessResponse]
    }
  }
