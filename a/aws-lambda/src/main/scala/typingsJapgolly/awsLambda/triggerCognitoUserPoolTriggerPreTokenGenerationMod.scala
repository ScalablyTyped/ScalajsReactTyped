...
import typingsJapgolly.awsLambda.anon.ClaimsOverrideDetails
import typingsJapgolly.awsLambda.anon.GroupConfiguration
...
object triggerCognitoUserPoolTriggerPreTokenGenerationMod {
