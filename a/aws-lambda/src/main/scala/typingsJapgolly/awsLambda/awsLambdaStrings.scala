...
import typingsJapgolly.awsLambda.triggerAutoscalingMod.AutoScalingInstanceMarketOption
import typingsJapgolly.awsLambda.triggerAutoscalingMod.AutoScalingScaleInCause
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildCacheType
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildEnvironmentComputeType
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildEnvironmentPullCredentialsType
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildEnvironmentType
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildEnvironmentVariableType
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildPhaseStatusType
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildPhaseType
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildSourceLocationType
import typingsJapgolly.awsLambda.triggerCodebuildCloudwatchStateMod.CodeBuildStateType
import typingsJapgolly.awsLambda.triggerCodepipelineCloudwatchActionMod.CodePipelineActionCategory
import typingsJapgolly.awsLambda.triggerCodepipelineCloudwatchActionMod.CodePipelineActionState
import typingsJapgolly.awsLambda.triggerCodepipelineCloudwatchPipelineMod.CodePipelineState
import typingsJapgolly.awsLambda.triggerCodepipelineCloudwatchStageMod.CodePipelineStageState
import typingsJapgolly.awsLambda.triggerCognitoUserPoolTriggerCommonMod.ChallengeName
import typingsJapgolly.awsLambda.triggerCognitoUserPoolTriggerCustomEmailSenderMod.AccountTakeOverActionType
import typingsJapgolly.awsLambda.triggerCognitoUserPoolTriggerUserMigrationMod.UserStatus
import typingsJapgolly.awsLambda.triggerConnectContactFlowMod.ConnectContactFlowChannel
import typingsJapgolly.awsLambda.triggerConnectContactFlowMod.ConnectContactFlowInitiationMethod
import typingsJapgolly.awsLambda.triggerKinesisFirehoseTransformationMod.FirehoseRecordTransformationStatus
import typingsJapgolly.awsLambda.triggerLexV2Mod.LexV2IntentState
import typingsJapgolly.awsLambda.triggerS3BatchMod.S3BatchResultResultCode
import typingsJapgolly.awsLambda.triggerSecretsmanagerMod.SecretsManagerRotationEventStep
import typingsJapgolly.awsLambda.triggerSqsMod._SQSMessageAttributeDataType
