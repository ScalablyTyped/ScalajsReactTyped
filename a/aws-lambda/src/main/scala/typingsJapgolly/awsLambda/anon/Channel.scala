...
import typingsJapgolly.awsLambda.triggerConnectContactFlowMod.ConnectContactFlowEndpoint
import typingsJapgolly.awsLambda.triggerConnectContactFlowMod.ConnectContactFlowInitiationMethod
import typingsJapgolly.awsLambda.triggerConnectContactFlowMod.ConnectContactFlowQueue
...
trait Channel extends StObject {
  ...
  var Queue: ConnectContactFlowQueue | Null
...
object Channel {
  ...
  extension [Self <: Channel](x: Self) {
    ...
    inline def setQueue(value: ConnectContactFlowQueue): Self = StObject.set(x, "Queue", value.asInstanceOf[js.Any])
