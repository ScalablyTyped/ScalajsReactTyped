...
import typingsJapgolly.awsLambda.awsLambdaStrings.EMAIL
import typingsJapgolly.awsLambda.awsLambdaStrings.RESEND
import typingsJapgolly.awsLambda.awsLambdaStrings.SMS
import typingsJapgolly.awsLambda.awsLambdaStrings.SUPPRESS
