...
import typingsJapgolly.awsLambda.commonCloudfrontMod.CloudFrontFunctionsCookies
import typingsJapgolly.awsLambda.commonCloudfrontMod.CloudFrontFunctionsHeaders
