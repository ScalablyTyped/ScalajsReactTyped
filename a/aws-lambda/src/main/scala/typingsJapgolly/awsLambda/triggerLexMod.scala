...
import typingsJapgolly.awsLambda.anon.Alias
import typingsJapgolly.awsLambda.anon.ConfirmationStatus
import typingsJapgolly.awsLambda.anon.Content
import typingsJapgolly.awsLambda.anon.ContentType
...
import typingsJapgolly.awsLambda.awsLambdaStrings.Voice_
...
object triggerLexMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionClose
    - typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionElicitIntent
    - typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionElicitSlot
    - typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionConfirmIntent
    - typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionDelegate
  */
  trait LexDialogAction extends StObject
  object LexDialogAction {
    
    inline def LexDialogActionClose(fulfillmentState: Fulfilled | Failed_): typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionClose = {
      val __obj = js.Dynamic.literal(fulfillmentState = fulfillmentState.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Close")
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionClose]
    }
    
    inline def LexDialogActionConfirmIntent(intentName: String, slots: StringDictionary[String | Null]): typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionConfirmIntent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionConfirmIntent]
    }
    
    inline def LexDialogActionDelegate(slots: StringDictionary[String | Null]): typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionDelegate = {
      val __obj = js.Dynamic.literal(slots = slots.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Delegate")
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionDelegate]
    }
    
    inline def LexDialogActionElicitIntent(): typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionElicitIntent = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("ElicitIntent")
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionElicitIntent]
    }
    
    inline def LexDialogActionElicitSlot(intentName: String, slotToElicit: String, slots: StringDictionary[String | Null]): typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionElicitSlot = {
      ...
      __obj.asInstanceOf[typingsJapgolly.awsLambda.triggerLexMod.LexDialogActionElicitSlot]
    }
  }
  ...
  trait LexGenericAttachment extends StObject {
    ...
    var buttons: js.Array[typingsJapgolly.awsLambda.anon.Text]
  ...
  object LexGenericAttachment {
    ...
    inline def apply(
      ...
      buttons: js.Array[typingsJapgolly.awsLambda.anon.Text],
      imageUrl: String,
      subTitle: String,
      title: String
    ...
    extension [Self <: LexGenericAttachment](x: Self) {
      ...
      inline def setButtons(value: js.Array[typingsJapgolly.awsLambda.anon.Text]): Self = StObject.set(x, "buttons", value.asInstanceOf[js.Any])
      
      inline def setButtonsVarargs(value: typingsJapgolly.awsLambda.anon.Text*): Self = StObject.set(x, "buttons", js.Array(value*))
