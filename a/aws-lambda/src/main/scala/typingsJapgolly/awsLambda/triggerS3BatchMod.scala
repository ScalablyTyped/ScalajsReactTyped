...
object triggerS3BatchMod {
  ...
  */
  ...
  object S3BatchResultResultCode {
    ...
    inline def PermanentFailure: typingsJapgolly.awsLambda.awsLambdaStrings.PermanentFailure = "PermanentFailure".asInstanceOf[typingsJapgolly.awsLambda.awsLambdaStrings.PermanentFailure]
    
    inline def Succeeded: Succeeded_ = "Succeeded".asInstanceOf[Succeeded_]
    
    inline def TemporaryFailure: typingsJapgolly.awsLambda.awsLambdaStrings.TemporaryFailure = "TemporaryFailure".asInstanceOf[typingsJapgolly.awsLambda.awsLambdaStrings.TemporaryFailure]
  }
}
