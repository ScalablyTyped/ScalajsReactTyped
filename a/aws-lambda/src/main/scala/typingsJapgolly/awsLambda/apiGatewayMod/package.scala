...
package object apiGatewayMod {
  ...
  type APIGatewayEventRequestContext = typingsJapgolly.awsLambda.apiGatewayMod.APIGatewayEventRequestContextWithAuthorizer[typingsJapgolly.awsLambda.apiGatewayMod.APIGatewayEventDefaultAuthorizerContext]
}
