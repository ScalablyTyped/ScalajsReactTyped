...
import typingsJapgolly.awsLambda.awsLambdaStrings.CREATE_TIME
import typingsJapgolly.awsLambda.awsLambdaStrings.LOG_APPEND_TIME
import typingsJapgolly.awsLambda.awsLambdaStrings.awsColonkafka
