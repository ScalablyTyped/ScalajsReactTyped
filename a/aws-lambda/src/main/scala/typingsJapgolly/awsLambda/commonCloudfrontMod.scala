...
import typingsJapgolly.awsLambda.anon.Action
import typingsJapgolly.awsLambda.anon.Cookies
import typingsJapgolly.awsLambda.anon.DistributionDomainName
import typingsJapgolly.awsLambda.anon.DistributionId
import typingsJapgolly.awsLambda.anon.Headers
import typingsJapgolly.awsLambda.anon.Ip
import typingsJapgolly.awsLambda.anon.Key
import typingsJapgolly.awsLambda.anon.MultiValue
import typingsJapgolly.awsLambda.anon.MultiValueValue
import typingsJapgolly.awsLambda.awsLambdaStrings.`origin-access-identity`
import typingsJapgolly.awsLambda.awsLambdaStrings.base64
import typingsJapgolly.awsLambda.awsLambdaStrings.http
import typingsJapgolly.awsLambda.awsLambdaStrings.https
import typingsJapgolly.awsLambda.awsLambdaStrings.none_
import typingsJapgolly.awsLambda.awsLambdaStrings.text_
import typingsJapgolly.awsLambda.triggerCloudfrontRequestMod._CloudFrontRequestResult
...
object commonCloudfrontMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsLambda.anon.Custom
    - typingsJapgolly.awsLambda.anon.S3
  */
  trait CloudFrontOrigin extends StObject
  object CloudFrontOrigin {
    
    inline def Custom(s3: CloudFrontS3Origin): typingsJapgolly.awsLambda.anon.Custom = {
      val __obj = js.Dynamic.literal(s3 = s3.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.awsLambda.anon.Custom]
    }
    
    inline def S3(custom: CloudFrontCustomOrigin): typingsJapgolly.awsLambda.anon.S3 = {
      val __obj = js.Dynamic.literal(custom = custom.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.awsLambda.anon.S3]
    }
  }
