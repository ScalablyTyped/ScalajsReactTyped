...
import typingsJapgolly.awsLambda.anon.Size
import typingsJapgolly.awsLambda.awsLambdaStrings.ARCHIVE_ACCESS
import typingsJapgolly.awsLambda.awsLambdaStrings.DEEP_ARCHIVE_ACCESS
