...
object triggerAutoscalingMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsLambda.awsLambdaStrings.spot
    - typingsJapgolly.awsLambda.awsLambdaStrings.`on-demand`
  */
  trait AutoScalingInstanceMarketOption extends StObject
  object AutoScalingInstanceMarketOption {
    
    inline def `on-demand`: typingsJapgolly.awsLambda.awsLambdaStrings.`on-demand` = "on-demand".asInstanceOf[typingsJapgolly.awsLambda.awsLambdaStrings.`on-demand`]
    
    inline def spot: typingsJapgolly.awsLambda.awsLambdaStrings.spot = "spot".asInstanceOf[typingsJapgolly.awsLambda.awsLambdaStrings.spot]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsLambda.awsLambdaStrings.SCALE_IN
    - typingsJapgolly.awsLambda.awsLambdaStrings.INSTANCE_REFRESH
    - typingsJapgolly.awsLambda.awsLambdaStrings.MAX_INSTANCE_LIFETIME
    - typingsJapgolly.awsLambda.awsLambdaStrings.REBALANCE
  */
  trait AutoScalingScaleInCause extends StObject
  object AutoScalingScaleInCause {
    
    inline def INSTANCE_REFRESH: typingsJapgolly.awsLambda.awsLambdaStrings.INSTANCE_REFRESH = "INSTANCE_REFRESH".asInstanceOf[typingsJapgolly.awsLambda.awsLambdaStrings.INSTANCE_REFRESH]
    
    inline def MAX_INSTANCE_LIFETIME: typingsJapgolly.awsLambda.awsLambdaStrings.MAX_INSTANCE_LIFETIME = "MAX_INSTANCE_LIFETIME".asInstanceOf[typingsJapgolly.awsLambda.awsLambdaStrings.MAX_INSTANCE_LIFETIME]
    
    inline def REBALANCE: typingsJapgolly.awsLambda.awsLambdaStrings.REBALANCE = "REBALANCE".asInstanceOf[typingsJapgolly.awsLambda.awsLambdaStrings.REBALANCE]
    
    inline def SCALE_IN: typingsJapgolly.awsLambda.awsLambdaStrings.SCALE_IN = "SCALE_IN".asInstanceOf[typingsJapgolly.awsLambda.awsLambdaStrings.SCALE_IN]
  }
