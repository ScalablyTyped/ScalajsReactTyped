...
import typingsJapgolly.awsLambda.anon.DialogAction
import typingsJapgolly.awsLambda.awsLambdaStrings.DTMF
...
import typingsJapgolly.awsLambda.awsLambdaStrings.Speech
