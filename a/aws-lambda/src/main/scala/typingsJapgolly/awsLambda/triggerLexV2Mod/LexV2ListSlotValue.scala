...
trait LexV2ListSlotValue
  ...
  var shape: typingsJapgolly.awsLambda.awsLambdaStrings.List
...
object LexV2ListSlotValue {
  ...
  extension [Self <: LexV2ListSlotValue](x: Self) {
    ...
    inline def setShape(value: typingsJapgolly.awsLambda.awsLambdaStrings.List): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
