package typingsJapgolly.awsLambda.dynamodbStreamMod

import typingsJapgolly.awsLambda.awsLambdaStrings.INSERT
import typingsJapgolly.awsLambda.awsLambdaStrings.MODIFY
import typingsJapgolly.awsLambda.awsLambdaStrings.REMOVE
