...
import typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.coverage
import typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.polygon
