...
import typingsJapgolly.amapJsApiArrivalRange.anon.Info
...
object AMap {
  ...
  object ArrivalRange {
    ...
    trait EventMap extends StObject {
      ...
      var error: Event_[typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.error, Info]
    }
    object EventMap {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.complete
      - typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.error
      - typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.no_data
    */
    trait SearchStatus extends StObject
    object SearchStatus {
      
      inline def complete: typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.complete = "complete".asInstanceOf[typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.complete]
      
      inline def error: typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.error = "error".asInstanceOf[typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.error]
      
      inline def no_data: typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.no_data = "no_data".asInstanceOf[typingsJapgolly.amapJsApiArrivalRange.amapJsApiArrivalRangeStrings.no_data]
    }
  }
}
