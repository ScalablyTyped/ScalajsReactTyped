...
object ResponseCodes extends StObject {
  ...
  sealed trait httpBadRequest
    extends StObject
       with ResponseCodes
  /* 400 */ val httpBadRequest: typingsJapgolly.azureMsalCommon.distUtilsConstantsMod.ResponseCodes.httpBadRequest & Double = js.native
  
  @js.native
  sealed trait httpSuccess
    extends StObject
       with ResponseCodes
  /* 200 */ val httpSuccess: typingsJapgolly.azureMsalCommon.distUtilsConstantsMod.ResponseCodes.httpSuccess & Double = js.native
}
