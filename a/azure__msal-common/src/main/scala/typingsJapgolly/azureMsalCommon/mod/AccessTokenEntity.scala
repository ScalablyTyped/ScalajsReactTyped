...
open class AccessTokenEntity ()
  extends typingsJapgolly.azureMsalCommon.distCacheEntitiesAccessTokenEntityMod.AccessTokenEntity
/* static members */
object AccessTokenEntity {
  ...
  inline def createAccessTokenEntity(
    ...
    tokenType: js.UndefOr[typingsJapgolly.azureMsalCommon.distUtilsConstantsMod.AuthenticationScheme],
