...
import typingsJapgolly.azureMsalCommon.distCryptoJoseHeaderMod.JoseHeaderOptions
...
open class JoseHeader protected ()
  extends typingsJapgolly.azureMsalCommon.distCryptoJoseHeaderMod.JoseHeader {
