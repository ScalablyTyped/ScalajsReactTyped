...
open class AppMetadataEntity ()
  extends typingsJapgolly.azureMsalCommon.distCacheEntitiesAppMetadataEntityMod.AppMetadataEntity
/* static members */
object AppMetadataEntity {
  ...
  /**
    ...
    * @param familyId
    */
  inline def createAppMetadataEntity(clientId: String, environment: String): typingsJapgolly.azureMsalCommon.distCacheEntitiesAppMetadataEntityMod.AppMetadataEntity = (^.asInstanceOf[js.Dynamic].applyDynamic("createAppMetadataEntity")(clientId.asInstanceOf[js.Any], environment.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.azureMsalCommon.distCacheEntitiesAppMetadataEntityMod.AppMetadataEntity]
  inline def createAppMetadataEntity(clientId: String, environment: String, familyId: String): typingsJapgolly.azureMsalCommon.distCacheEntitiesAppMetadataEntityMod.AppMetadataEntity = (^.asInstanceOf[js.Dynamic].applyDynamic("createAppMetadataEntity")(clientId.asInstanceOf[js.Any], environment.asInstanceOf[js.Any], familyId.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.azureMsalCommon.distCacheEntitiesAppMetadataEntityMod.AppMetadataEntity]
