...
import typingsJapgolly.azureMsalCommon.distUrlIuriMod.IUri
...
open class UrlString protected ()
  extends typingsJapgolly.azureMsalCommon.distUrlUrlStringMod.UrlString {
...
object UrlString {
  ...
  inline def constructAuthorityUriFromObject(urlObject: IUri): typingsJapgolly.azureMsalCommon.distUrlUrlStringMod.UrlString = ^.asInstanceOf[js.Dynamic].applyDynamic("constructAuthorityUriFromObject")(urlObject.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.azureMsalCommon.distUrlUrlStringMod.UrlString]
