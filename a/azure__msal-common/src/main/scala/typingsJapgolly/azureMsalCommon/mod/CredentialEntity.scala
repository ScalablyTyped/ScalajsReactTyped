...
open class CredentialEntity ()
  extends typingsJapgolly.azureMsalCommon.distCacheEntitiesCredentialEntityMod.CredentialEntity
/* static members */
object CredentialEntity {
  ...
  inline def generateCredentialCacheKey(
    ...
    environment: String,
    credentialType: typingsJapgolly.azureMsalCommon.distUtilsConstantsMod.CredentialType,
    clientId: String
  ...
  inline def generateCredentialCacheKey(
    ...
    target: String,
    familyId: String,
    tokenType: typingsJapgolly.azureMsalCommon.distUtilsConstantsMod.AuthenticationScheme
