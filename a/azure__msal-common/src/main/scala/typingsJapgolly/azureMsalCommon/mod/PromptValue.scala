...
object PromptValue {
  ...
  @JSImport("@azure/msal-common", "PromptValue")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@azure/msal-common", "PromptValue.CONSENT")
  @js.native
  ...
  @JSImport("@azure/msal-common", "PromptValue.CREATE")
  @js.native
  ...
  @JSImport("@azure/msal-common", "PromptValue.LOGIN")
  @js.native
  ...
  @JSImport("@azure/msal-common", "PromptValue.NONE")
  @js.native
