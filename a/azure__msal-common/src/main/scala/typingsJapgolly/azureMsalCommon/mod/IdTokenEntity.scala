...
open class IdTokenEntity ()
  extends typingsJapgolly.azureMsalCommon.distCacheEntitiesIdTokenEntityMod.IdTokenEntity
/* static members */
object IdTokenEntity {
  ...
  /**
    ...
    * @param authority
    */
  inline def createIdTokenEntity(homeAccountId: String, environment: String, idToken: String, clientId: String, tenantId: String): typingsJapgolly.azureMsalCommon.distCacheEntitiesIdTokenEntityMod.IdTokenEntity = (^.asInstanceOf[js.Dynamic].applyDynamic("createIdTokenEntity")(homeAccountId.asInstanceOf[js.Any], environment.asInstanceOf[js.Any], idToken.asInstanceOf[js.Any], clientId.asInstanceOf[js.Any], tenantId.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.azureMsalCommon.distCacheEntitiesIdTokenEntityMod.IdTokenEntity]
