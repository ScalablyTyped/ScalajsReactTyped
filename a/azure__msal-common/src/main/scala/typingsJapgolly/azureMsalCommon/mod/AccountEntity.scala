...
open class AccountEntity ()
  extends typingsJapgolly.azureMsalCommon.distCacheEntitiesAccountEntityMod.AccountEntity
/* static members */
object AccountEntity {
  ...
  inline def createAccount(
    ...
    idToken: typingsJapgolly.azureMsalCommon.distAccountAuthTokenMod.AuthToken
  ...
  inline def createAccount(
    ...
    homeAccountId: String,
    idToken: typingsJapgolly.azureMsalCommon.distAccountAuthTokenMod.AuthToken,
    authority: typingsJapgolly.azureMsalCommon.distAuthorityAuthorityMod.Authority
  ): typingsJapgolly.azureMsalCommon.distCacheEntitiesAccountEntityMod.AccountEntity = (^.asInstanceOf[js.Dynamic].applyDynamic("createAccount")(clientInfo.asInstanceOf[js.Any], homeAccountId.asInstanceOf[js.Any], idToken.asInstanceOf[js.Any], authority.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.azureMsalCommon.distCacheEntitiesAccountEntityMod.AccountEntity]
  inline def createAccount(
    clientInfo: String,
    homeAccountId: String,
  ...
  /**
    ...
    * @param idToken
    */
  inline def createGenericAccount(homeAccountId: String, idToken: typingsJapgolly.azureMsalCommon.distAccountAuthTokenMod.AuthToken): typingsJapgolly.azureMsalCommon.distCacheEntitiesAccountEntityMod.AccountEntity = (^.asInstanceOf[js.Dynamic].applyDynamic("createGenericAccount")(homeAccountId.asInstanceOf[js.Any], idToken.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.azureMsalCommon.distCacheEntitiesAccountEntityMod.AccountEntity]
  ...
  inline def generateHomeAccountId(
    ...
    authType: typingsJapgolly.azureMsalCommon.distAuthorityAuthorityTypeMod.AuthorityType,
