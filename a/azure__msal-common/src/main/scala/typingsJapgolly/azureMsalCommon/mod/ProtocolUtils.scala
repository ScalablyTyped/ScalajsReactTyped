...
import typingsJapgolly.azureMsalCommon.distUtilsProtocolUtilsMod.RequestStateObject
...
open class ProtocolUtils ()
  extends typingsJapgolly.azureMsalCommon.distUtilsProtocolUtilsMod.ProtocolUtils
/* static members */
