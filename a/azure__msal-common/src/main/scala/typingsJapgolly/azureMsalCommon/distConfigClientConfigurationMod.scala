...
import typingsJapgolly.azureMsalCommon.anon.RequiredAuthOptions
import typingsJapgolly.azureMsalCommon.anon.RequiredICrypto
import typingsJapgolly.azureMsalCommon.anon.RequiredLoggerOptions
import typingsJapgolly.azureMsalCommon.anon.RequiredSystemOptions
import typingsJapgolly.azureMsalCommon.anon.RequiredTelemetryOptions
import typingsJapgolly.azureMsalCommon.distAccountClientCredentialsMod.ClientCredentials
import typingsJapgolly.azureMsalCommon.distAuthorityAuthorityMod.Authority
import typingsJapgolly.azureMsalCommon.distAuthorityAuthorityOptionsMod.AzureCloudInstance
