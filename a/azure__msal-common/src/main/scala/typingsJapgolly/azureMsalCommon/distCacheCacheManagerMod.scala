...
import typingsJapgolly.azureMsalCommon.distCacheUtilsCacheTypesMod.AppMetadataFilter
...
import typingsJapgolly.azureMsalCommon.distCacheUtilsCacheTypesMod.ValidCredentialType
