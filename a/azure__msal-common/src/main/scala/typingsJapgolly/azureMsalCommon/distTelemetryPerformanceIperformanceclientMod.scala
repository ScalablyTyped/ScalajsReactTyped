...
import typingsJapgolly.azureMsalCommon.anon.PartialPerformanceEvent
import typingsJapgolly.azureMsalCommon.distTelemetryPerformanceIperformancemeasurementMod.IPerformanceMeasurement
import typingsJapgolly.azureMsalCommon.distTelemetryPerformancePerformanceEventMod.PerformanceEvent
import typingsJapgolly.azureMsalCommon.distTelemetryPerformancePerformanceEventMod.PerformanceEvents
