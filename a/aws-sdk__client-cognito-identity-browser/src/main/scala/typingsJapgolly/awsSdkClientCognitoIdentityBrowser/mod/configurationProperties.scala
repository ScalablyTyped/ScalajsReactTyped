package typingsJapgolly.awsSdkClientCognitoIdentityBrowser.mod

import org.scalajs.dom.raw.Blob
import typingsJapgolly.awsSdkClientCognitoIdentityBrowser.cognitoIdentityConfigurationMod.CognitoIdentityResolvableConfiguration
