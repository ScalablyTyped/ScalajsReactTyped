...
import typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesCognitoIdentityProviderMod.UnmarshalledCognitoIdentityProvider
...
object typesCreateIdentityPoolOutputMod {
  ...
  trait CreateIdentityPoolOutput
    extends StObject
  ...
  object CreateIdentityPoolOutput {
    ...
    extension [Self <: CreateIdentityPoolOutput](x: Self) {
