...
object CognitoIdentityConfiguration {
  ...
  def apply(
    ...
    handler: /* context */ HandlerExecutionContext => CallbackTo[FinalizeHandler[js.Object, js.Any, Blob]] = null,
    ...
    streamCollector: Blob => CallbackTo[js.Promise[scala.scalajs.js.typedarray.Uint8Array]] = null,
    ...
    if (streamCollector != null) __obj.updateDynamic("streamCollector")(js.Any.fromFunction1((t0: org.scalajs.dom.raw.Blob) => streamCollector(t0).runNow()))
