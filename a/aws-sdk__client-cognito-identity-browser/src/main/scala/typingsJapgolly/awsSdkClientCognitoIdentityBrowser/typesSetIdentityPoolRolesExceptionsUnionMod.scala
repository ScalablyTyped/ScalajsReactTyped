...
object typesSetIdentityPoolRolesExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesConcurrentModificationExceptionMod.ConcurrentModificationException
  */
  trait SetIdentityPoolRolesExceptionsUnion extends StObject
  object SetIdentityPoolRolesExceptionsUnion {
    
    inline def ConcurrentModificationException(): typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesConcurrentModificationExceptionMod.ConcurrentModificationException = {
      val __obj = js.Dynamic.literal(name = "ConcurrentModificationException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesConcurrentModificationExceptionMod.ConcurrentModificationException]
    }
