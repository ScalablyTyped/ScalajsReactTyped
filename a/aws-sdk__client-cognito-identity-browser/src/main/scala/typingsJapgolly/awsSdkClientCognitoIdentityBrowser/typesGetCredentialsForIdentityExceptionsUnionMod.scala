...
object typesGetCredentialsForIdentityExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesInvalidIdentityPoolConfigurationExceptionMod.InvalidIdentityPoolConfigurationException
    - typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesInternalErrorExceptionMod.InternalErrorException
    - typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesExternalServiceExceptionMod.ExternalServiceException
  */
  trait GetCredentialsForIdentityExceptionsUnion extends StObject
  object GetCredentialsForIdentityExceptionsUnion {
    
    inline def ExternalServiceException(): typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesExternalServiceExceptionMod.ExternalServiceException = {
      val __obj = js.Dynamic.literal(name = "ExternalServiceException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesExternalServiceExceptionMod.ExternalServiceException]
    }
    ...
    inline def InvalidIdentityPoolConfigurationException(): typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesInvalidIdentityPoolConfigurationExceptionMod.InvalidIdentityPoolConfigurationException = {
      val __obj = js.Dynamic.literal(name = "InvalidIdentityPoolConfigurationException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCognitoIdentityBrowser.typesInvalidIdentityPoolConfigurationExceptionMod.InvalidIdentityPoolConfigurationException]
    }
