...
trait ImageBlock
  ...
  @JSName("class")
  var class_ImageBlock: typingsJapgolly.areNa.areNaStrings.Image
...
object ImageBlock {
  ...
  extension [Self <: ImageBlock](x: Self) {
    ...
    inline def setClass(value: typingsJapgolly.areNa.areNaStrings.Image): Self = StObject.set(x, "class", value.asInstanceOf[js.Any])
