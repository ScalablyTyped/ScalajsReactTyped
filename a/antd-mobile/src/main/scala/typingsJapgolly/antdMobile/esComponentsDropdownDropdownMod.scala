...
import typingsJapgolly.antdMobile.anon.activeKeystringnullundefi
...
object esComponentsDropdownDropdownMod extends Shortcut {
  
  @JSImport("antd-mobile/es/components/dropdown/dropdown", JSImport.Default)
  @js.native
  ...
  trait DropdownProps extends StObject {
    ...
    var arrow: js.UndefOr[Node] = js.undefined
    
    var className: js.UndefOr[String] = js.undefined
    
    var closeOnClickAway: js.UndefOr[Boolean] = js.undefined
  ...
  object DropdownProps {
    ...
    extension [Self <: DropdownProps](x: Self) {
      ...
      inline def setArrow(value: VdomNode): Self = StObject.set(x, "arrow", value.rawNode.asInstanceOf[js.Any])
      
      inline def setArrowNull: Self = StObject.set(x, "arrow", null)
      
      inline def setArrowUndefined: Self = StObject.set(x, "arrow", js.undefined)
      
      inline def setArrowVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "arrow", js.Array(value*))
      ...
      inline def setCloseOnClickAway(value: Boolean): Self = StObject.set(x, "closeOnClickAway", value.asInstanceOf[js.Any])
      
      inline def setCloseOnClickAwayUndefined: Self = StObject.set(x, "closeOnClickAway", js.undefined)
      ...
      inline def setOnChange(value: /* key */ String | Null => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* key */ String | Null) => value(t0).runNow()))
  ...
  object DropdownRef {
    ...
    inline def apply(close: Callback): DropdownRef = {
  ...
  type _To = ForwardRefExoticComponent[activeKeystringnullundefi]
  
  /* This means you don't have to write `default`, but can instead just say `esComponentsDropdownDropdownMod.foo` */
  override def _to: ForwardRefExoticComponent[activeKeystringnullundefi] = default
}
