...
object esComponentsFloatingBubbleFloatingBubbleMod {
  ...
  object FloatingBubbleProps {
    ...
    extension [Self <: FloatingBubbleProps](x: Self) {
      ...
      inline def setAxis(value: typingsJapgolly.antdMobile.antdMobileStrings.x | y | xy | lock): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
      ...
      inline def setMagnetic(value: typingsJapgolly.antdMobile.antdMobileStrings.x | y): Self = StObject.set(x, "magnetic", value.asInstanceOf[js.Any])
