...
object esComponentsSelectorSelectorMod {
  
  @JSImport("antd-mobile/es/components/selector/selector", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def Selector[V /* <: SelectorValue */](p: SelectorProps[V]): Element = ^.asInstanceOf[js.Dynamic].applyDynamic("Selector")(p.asInstanceOf[js.Any]).asInstanceOf[Element]
  ...
  object SelectorProps {
    ...
    extension [Self <: SelectorProps[?], V](x: Self & SelectorProps[V]) {
      ...
      inline def setOnChange(value: (/* v */ js.Array[V], /* extend */ Items[V]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* v */ js.Array[V], t1: /* extend */ Items[V]) => (value(t0, t1)).runNow()))
