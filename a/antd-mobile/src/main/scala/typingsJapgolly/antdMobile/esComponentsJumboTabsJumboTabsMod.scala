...
object esComponentsJumboTabsJumboTabsMod {
  
  @JSImport("antd-mobile/es/components/jumbo-tabs/jumbo-tabs", "JumboTab")
  @js.native
  val JumboTab: FC[JumboTabProps] = js.native
  
  @JSImport("antd-mobile/es/components/jumbo-tabs/jumbo-tabs", "JumboTabs")
  @js.native
  val JumboTabs: FC[JumboTabsProps] = js.native
  
  /* Inlined {  title :react.react.ReactNode,   description :react.react.ReactNode,   disabled :boolean | undefined,   forceRender :boolean | undefined,   destroyOnClose :boolean | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait JumboTabProps extends StObject {
  ...
  object JumboTabProps {
    
    inline def apply(): JumboTabProps = {
  ...
  /* Inlined {  activeKey :string | null | undefined,   defaultActiveKey :string | null | undefined,   onChange :(key : string): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait JumboTabsProps extends StObject {
  ...
  object JumboTabsProps {
    
    inline def apply(): JumboTabsProps = {
