...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--width' | '--height' | '--border-radius', string>> */
trait CSSPropertiesPartialRecorBackgroundPosition extends StObject {
...
object CSSPropertiesPartialRecorBackgroundPosition {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundPosition = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorBackgroundPosition]
  }
  
  extension [Self <: CSSPropertiesPartialRecorBackgroundPosition](x: Self) {
