...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/steps/steps.StepsProps> */
trait PartialStepsProps extends StObject {
...
object PartialStepsProps {
  
  inline def apply(): PartialStepsProps = {
