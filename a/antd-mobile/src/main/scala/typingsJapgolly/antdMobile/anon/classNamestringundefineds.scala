...
trait classNamestringundefineds extends StObject {
  ...
  var ref: js.UndefOr[Ref[typingsJapgolly.antdMobile.esComponentsFormFormMod.FormInstance]] = js.undefined
...
object classNamestringundefineds {
  
  inline def apply(): classNamestringundefineds = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[classNamestringundefineds]
  }
  
  extension [Self <: classNamestringundefineds](x: Self) {
    ...
    inline def setChildrenFunction2(value: (/* values */ Store, /* form */ FormInstance[Any]) => Element | Node): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
    ...
    inline def setRef(value: Ref[typingsJapgolly.antdMobile.esComponentsFormFormMod.FormInstance]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: typingsJapgolly.antdMobile.esComponentsFormFormMod.FormInstance | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: typingsJapgolly.antdMobile.esComponentsFormFormMod.FormInstance | Null) => value(t0).runNow()))
