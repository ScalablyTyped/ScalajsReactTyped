...
import typingsJapgolly.antdMobile.antdMobileStrings.danger
...
import typingsJapgolly.antdMobile.antdMobileStrings.mini
...
import typingsJapgolly.antdMobile.antdMobileStrings.outline
...
import typingsJapgolly.antdMobile.antdMobileStrings.rectangular
import typingsJapgolly.antdMobile.antdMobileStrings.removals
import typingsJapgolly.antdMobile.antdMobileStrings.reset
import typingsJapgolly.antdMobile.antdMobileStrings.rounded
import typingsJapgolly.antdMobile.antdMobileStrings.small
import typingsJapgolly.antdMobile.antdMobileStrings.solid
import typingsJapgolly.antdMobile.antdMobileStrings.spelling
import typingsJapgolly.antdMobile.antdMobileStrings.step
import typingsJapgolly.antdMobile.antdMobileStrings.submit
...
import typingsJapgolly.antdMobile.esComponentsButtonButtonMod.ButtonRef
...
/* Inlined {  color :'default' | 'primary' | 'success' | 'warning' | 'danger' | undefined,   fill :'none' | 'solid' | 'outline' | undefined,   size :'small' | 'large' | 'middle' | 'mini' | undefined,   block :boolean | undefined,   loading :boolean | 'auto' | undefined,   loadingText :string | undefined,   loadingIcon :react.react.ReactNode | undefined,   disabled :boolean | undefined,   onClick :(event : react.react.MouseEvent<std.HTMLButtonElement, std.MouseEvent>): void | std.Promise<void> | unknown | undefined,   type :'reset' | 'submit' | 'button' | undefined,   shape :'default' | 'rounded' | 'rectangular' | undefined,   children :react.react.ReactNode | undefined,   className :string | undefined,   style :react.react.CSSProperties & std.Partial<std.Record<'--border-radius' | '--text-color' | '--background-color' | '--border-width' | '--border-style' | '--border-color', string>> | undefined,   tabIndex :number | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/button/button.NativeButtonProps, 'onMouseDown' | 'onMouseUp' | 'onTouchEnd' | 'onTouchStart'> & react.react.AriaAttributes & react.react.RefAttributes<antd-mobile.antd-mobile/es/components/button/button.ButtonRef> */
trait colordefaultprimarysucces extends StObject {
  ...
  var color: js.UndefOr[default | primary | success | warning | danger] = js.undefined
  
  var disabled: js.UndefOr[Boolean] = js.undefined
  
  var fill: js.UndefOr[none | solid | outline] = js.undefined
  
  var key: js.UndefOr[Key | Null] = js.undefined
  
  var loading: js.UndefOr[Boolean | auto] = js.undefined
  ...
  var onClick: js.UndefOr[
    js.Function1[/* event */ ReactMouseEventFrom[HTMLButtonElement], Unit | js.Promise[Unit] | Any]
  ] = js.undefined
  ...
  var size: js.UndefOr[small | large | middle | mini] = js.undefined
  
  var style: js.UndefOr[CSSPropertiesPartialRecorAlignContent] = js.undefined
  
  var tabIndex: js.UndefOr[Double] = js.undefined
  
  var `type`: js.UndefOr[reset | submit | button] = js.undefined
}
object colordefaultprimarysucces {
  
  inline def apply(): colordefaultprimarysucces = {
  ...
  extension [Self <: colordefaultprimarysucces](x: Self) {
    ...
    inline def setColor(value: default | primary | success | warning | danger): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
    ...
    inline def setFill(value: none | solid | outline): Self = StObject.set(x, "fill", value.asInstanceOf[js.Any])
    ...
    inline def setLoading(value: Boolean | auto): Self = StObject.set(x, "loading", value.asInstanceOf[js.Any])
    ...
    inline def setOnClick(value: /* event */ ReactMouseEventFrom[HTMLButtonElement] => Unit | js.Promise[Unit] | Any): Self = StObject.set(x, "onClick", js.Any.fromFunction1(value))
    ...
    inline def setRef(value: Ref[ButtonRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: ButtonRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: ButtonRef | Null) => value(t0).runNow()))
    
    inline def setRefNull: Self = StObject.set(x, "ref", null)
    
    inline def setRefUndefined: Self = StObject.set(x, "ref", js.undefined)
    
    inline def setShape(value: default | rounded | rectangular): Self = StObject.set(x, "shape", value.asInstanceOf[js.Any])
    
    inline def setShapeUndefined: Self = StObject.set(x, "shape", js.undefined)
    
    inline def setSize(value: small | large | middle | mini): Self = StObject.set(x, "size", value.asInstanceOf[js.Any])
    
    inline def setSizeUndefined: Self = StObject.set(x, "size", js.undefined)
    
    inline def setStyle(value: CSSPropertiesPartialRecorAlignContent): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
    ...
    inline def setType(value: reset | submit | button): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
