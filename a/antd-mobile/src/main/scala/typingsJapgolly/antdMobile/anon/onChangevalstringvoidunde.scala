...
trait onChangevalstringvoidunde extends StObject {
  ...
  var showCount: js.UndefOr[
    Boolean | (js.Function2[/* length */ Double, /* maxLength */ js.UndefOr[Double], Node])
  ] = js.undefined
...
object onChangevalstringvoidunde {
  ...
  extension [Self <: onChangevalstringvoidunde](x: Self) {
    ...
    inline def setRefFunction1(value: TextAreaRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: TextAreaRef | Null) => value(t0).runNow()))
    ...
    inline def setShowCount(value: Boolean | (js.Function2[/* length */ Double, /* maxLength */ js.UndefOr[Double], Node])): Self = StObject.set(x, "showCount", value.asInstanceOf[js.Any])
    
    inline def setShowCountFunction2(value: (/* length */ Double, /* maxLength */ js.UndefOr[Double]) => Node): Self = StObject.set(x, "showCount", js.Any.fromFunction2(value))
