...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--fixed-active-line-width' | '--active-line-height' | '--active-line-border-radius' | '--title-font-size' | '--content-padding' | '--active-title-color' | '--active-line-color', string>> */
trait CSSPropertiesPartialRecorActivelineborderradius extends StObject {
  
  var `--active-line-border-radius`: js.UndefOr[String] = js.undefined
  
  var `--active-line-color`: js.UndefOr[String] = js.undefined
  
  var `--active-line-height`: js.UndefOr[String] = js.undefined
  
  var `--active-title-color`: js.UndefOr[String] = js.undefined
  
  var `--content-padding`: js.UndefOr[String] = js.undefined
  
  var `--fixed-active-line-width`: js.UndefOr[String] = js.undefined
  
  var `--title-font-size`: js.UndefOr[String] = js.undefined
  ...
  /**
    ...
    */
  var clear: js.UndefOr[typingsJapgolly.csstype.mod.Property.Clear] = js.undefined
...
object CSSPropertiesPartialRecorActivelineborderradius {
  
  inline def apply(): CSSPropertiesPartialRecorActivelineborderradius = {
  ...
  extension [Self <: CSSPropertiesPartialRecorActivelineborderradius](x: Self) {
    ...
    inline def `set--active-line-border-radiusUndefined`: Self = StObject.set(x, "--active-line-border-radius", js.undefined)
    
    inline def `set--active-line-color`(value: String): Self = StObject.set(x, "--active-line-color", value.asInstanceOf[js.Any])
    
    inline def `set--active-line-colorUndefined`: Self = StObject.set(x, "--active-line-color", js.undefined)
    
    inline def `set--active-line-height`(value: String): Self = StObject.set(x, "--active-line-height", value.asInstanceOf[js.Any])
    
    inline def `set--active-line-heightUndefined`: Self = StObject.set(x, "--active-line-height", js.undefined)
    
    inline def `set--active-title-color`(value: String): Self = StObject.set(x, "--active-title-color", value.asInstanceOf[js.Any])
    
    inline def `set--active-title-colorUndefined`: Self = StObject.set(x, "--active-title-color", js.undefined)
    
    inline def `set--content-padding`(value: String): Self = StObject.set(x, "--content-padding", value.asInstanceOf[js.Any])
    
    inline def `set--content-paddingUndefined`: Self = StObject.set(x, "--content-padding", js.undefined)
    
    inline def `set--fixed-active-line-width`(value: String): Self = StObject.set(x, "--fixed-active-line-width", value.asInstanceOf[js.Any])
    
    inline def `set--fixed-active-line-widthUndefined`: Self = StObject.set(x, "--fixed-active-line-width", js.undefined)
    
    inline def `set--title-font-size`(value: String): Self = StObject.set(x, "--title-font-size", value.asInstanceOf[js.Any])
    
    inline def `set--title-font-sizeUndefined`: Self = StObject.set(x, "--title-font-size", js.undefined)
    ...
    inline def setClear(value: typingsJapgolly.csstype.mod.Property.Clear): Self = StObject.set(x, "clear", value.asInstanceOf[js.Any])
