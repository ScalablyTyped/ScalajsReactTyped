...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--height' | '--width' | '--border-radius' | '--track-padding', string>> */
trait CSSPropertiesPartialRecorBlockOverflow extends StObject {
  
  var `--border-radius`: js.UndefOr[String] = js.undefined
  
  var `--height`: js.UndefOr[String] = js.undefined
  
  var `--track-padding`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBlockOverflow {
  
  inline def apply(): CSSPropertiesPartialRecorBlockOverflow = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorBlockOverflow]
  }
  
  extension [Self <: CSSPropertiesPartialRecorBlockOverflow](x: Self) {
    ...
    inline def `set--track-padding`(value: String): Self = StObject.set(x, "--track-padding", value.asInstanceOf[js.Any])
    
    inline def `set--track-paddingUndefined`: Self = StObject.set(x, "--track-padding", js.undefined)
