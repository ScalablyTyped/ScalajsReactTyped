...
import typingsJapgolly.antdMobile.esComponentsCheckboxCheckboxMod.CheckboxRef
...
/* Inlined std.Partial<{  checked :boolean | undefined,   defaultChecked :boolean | undefined,   disabled :boolean | undefined,   onChange :(checked : boolean): void | undefined,   value :antd-mobile.antd-mobile/es/components/checkbox/checkbox.CheckboxValue | undefined,   indeterminate :boolean | undefined,   block :boolean | undefined,   id :string | undefined,   icon :(checked : boolean, indeterminate : boolean): react.react.ReactNode | undefined,   children :react.react.ReactNode | undefined,   className :string | undefined,   style :react.react.CSSProperties & std.Partial<std.Record<'--font-size' | '--icon-size' | '--gap', string>> | undefined,   tabIndex :number | undefined} & react.react.AriaAttributes & react.react.RefAttributes<antd-mobile.antd-mobile/es/components/checkbox/checkbox.CheckboxRef>> */
trait Partialcheckedbooleanunde extends StObject {
  ...
  var icon: js.UndefOr[js.Function2[/* checked */ Boolean, /* indeterminate */ Boolean, Node]] = js.undefined
  ...
  var value: js.UndefOr[CheckboxValue] = js.undefined
}
object Partialcheckedbooleanunde {
  
  inline def apply(): Partialcheckedbooleanunde = {
  ...
  extension [Self <: Partialcheckedbooleanunde](x: Self) {
    ...
    inline def setIcon(value: (/* checked */ Boolean, /* indeterminate */ Boolean) => Node): Self = StObject.set(x, "icon", js.Any.fromFunction2(value))
    ...
    inline def setRef(value: Ref[CheckboxRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: CheckboxRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: CheckboxRef | Null) => value(t0).runNow()))
    ...
    inline def setValue(value: CheckboxValue): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
