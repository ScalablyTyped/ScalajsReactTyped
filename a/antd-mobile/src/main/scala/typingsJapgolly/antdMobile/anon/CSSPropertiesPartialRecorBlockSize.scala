...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--checked-color' | '--width' | '--height' | '--border-width', string>> */
trait CSSPropertiesPartialRecorBlockSize extends StObject {
  
  var `--border-width`: js.UndefOr[String] = js.undefined
  
  var `--checked-color`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBlockSize {
  
  inline def apply(): CSSPropertiesPartialRecorBlockSize = {
  ...
  extension [Self <: CSSPropertiesPartialRecorBlockSize](x: Self) {
    ...
    inline def `set--checked-color`(value: String): Self = StObject.set(x, "--checked-color", value.asInstanceOf[js.Any])
    
    inline def `set--checked-colorUndefined`: Self = StObject.set(x, "--checked-color", js.undefined)
