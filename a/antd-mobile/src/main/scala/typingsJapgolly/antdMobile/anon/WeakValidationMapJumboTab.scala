...
/* Inlined react.react.WeakValidationMap<antd-mobile.antd-mobile/es/components/jumbo-tabs/jumbo-tabs.JumboTabsProps> */
trait WeakValidationMapJumboTab extends StObject {
...
object WeakValidationMapJumboTab {
  
  inline def apply(): WeakValidationMapJumboTab = {
