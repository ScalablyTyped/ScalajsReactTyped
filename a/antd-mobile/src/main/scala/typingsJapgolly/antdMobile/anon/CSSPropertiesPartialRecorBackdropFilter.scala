...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--font-size' | '--color' | '--placeholder-color' | '--text-align', string>> */
trait CSSPropertiesPartialRecorBackdropFilter extends StObject {
...
object CSSPropertiesPartialRecorBackdropFilter {
  
  inline def apply(): CSSPropertiesPartialRecorBackdropFilter = {
