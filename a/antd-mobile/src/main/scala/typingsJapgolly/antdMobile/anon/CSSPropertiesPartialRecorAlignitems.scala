...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--active-background-color' | '--align-items' | '--border-bottom' | '--border-inner' | '--border-top' | '--extra-max-width' | '--font-size' | '--header-font-size' | '--padding-left' | '--padding-right' | '--prefix-padding-right' | '--prefix-width', string>> */
trait CSSPropertiesPartialRecorAlignitems extends StObject {
  
  var `--active-background-color`: js.UndefOr[String] = js.undefined
  ...
  var `--extra-max-width`: js.UndefOr[String] = js.undefined
  
  var `--font-size`: js.UndefOr[String] = js.undefined
  
  var `--header-font-size`: js.UndefOr[String] = js.undefined
  
  var `--padding-left`: js.UndefOr[String] = js.undefined
  
  var `--padding-right`: js.UndefOr[String] = js.undefined
  
  var `--prefix-padding-right`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAlignitems {
  
  inline def apply(): CSSPropertiesPartialRecorAlignitems = {
  ...
  extension [Self <: CSSPropertiesPartialRecorAlignitems](x: Self) {
    ...
    inline def `set--active-background-colorUndefined`: Self = StObject.set(x, "--active-background-color", js.undefined)
    
    inline def `set--align-items`(value: String): Self = StObject.set(x, "--align-items", value.asInstanceOf[js.Any])
    
    inline def `set--align-itemsUndefined`: Self = StObject.set(x, "--align-items", js.undefined)
    ...
    inline def `set--extra-max-width`(value: String): Self = StObject.set(x, "--extra-max-width", value.asInstanceOf[js.Any])
    
    inline def `set--extra-max-widthUndefined`: Self = StObject.set(x, "--extra-max-width", js.undefined)
    ...
    inline def `set--header-font-size`(value: String): Self = StObject.set(x, "--header-font-size", value.asInstanceOf[js.Any])
    
    inline def `set--header-font-sizeUndefined`: Self = StObject.set(x, "--header-font-size", js.undefined)
    
    inline def `set--padding-left`(value: String): Self = StObject.set(x, "--padding-left", value.asInstanceOf[js.Any])
    
    inline def `set--padding-leftUndefined`: Self = StObject.set(x, "--padding-left", js.undefined)
    
    inline def `set--padding-right`(value: String): Self = StObject.set(x, "--padding-right", value.asInstanceOf[js.Any])
    
    inline def `set--padding-rightUndefined`: Self = StObject.set(x, "--padding-right", js.undefined)
    
    inline def `set--prefix-padding-right`(value: String): Self = StObject.set(x, "--prefix-padding-right", value.asInstanceOf[js.Any])
    
    inline def `set--prefix-padding-rightUndefined`: Self = StObject.set(x, "--prefix-padding-right", js.undefined)
