...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/check-list/check-list.CheckListProps> */
trait PartialCheckListProps extends StObject {
...
object PartialCheckListProps {
  
  inline def apply(): PartialCheckListProps = {
