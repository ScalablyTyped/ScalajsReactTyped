...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--color' | '--font-size' | '--placeholder-color' | '--text-align' | '--disabled-color' | '--count-text-align', string>> */
trait CSSPropertiesPartialRecorBorder extends StObject {
  
  var `--color`: js.UndefOr[String] = js.undefined
  
  var `--count-text-align`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBorder {
  
  inline def apply(): CSSPropertiesPartialRecorBorder = {
  ...
  extension [Self <: CSSPropertiesPartialRecorBorder](x: Self) {
    ...
    inline def `set--count-text-align`(value: String): Self = StObject.set(x, "--count-text-align", value.asInstanceOf[js.Any])
    
    inline def `set--count-text-alignUndefined`: Self = StObject.set(x, "--count-text-align", js.undefined)
