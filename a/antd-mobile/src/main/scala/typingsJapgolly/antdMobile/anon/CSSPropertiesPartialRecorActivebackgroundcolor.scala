...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--prefix-width' | '--align-items' | '--active-background-color', string>> */
trait CSSPropertiesPartialRecorActivebackgroundcolor extends StObject {
...
object CSSPropertiesPartialRecorActivebackgroundcolor {
  
  inline def apply(): CSSPropertiesPartialRecorActivebackgroundcolor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorActivebackgroundcolor]
  }
  
  extension [Self <: CSSPropertiesPartialRecorActivebackgroundcolor](x: Self) {
