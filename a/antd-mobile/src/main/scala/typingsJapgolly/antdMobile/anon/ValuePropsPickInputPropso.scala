...
import typingsJapgolly.antdMobile.esComponentsStepperStepperMod.StepperProps
...
/* Inlined antd-mobile.antd-mobile/es/components/stepper/stepper.ValueProps & std.Pick<antd-mobile.antd-mobile/es/components/input.InputProps, 'onFocus' | 'onBlur'> & {  min :number | undefined,   max :number | undefined,   step :number | undefined,   digits :number | undefined,   disabled :boolean | undefined,   inputReadOnly :boolean | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--height' | '--input-width' | '--input-font-size' | '--input-background-color' | '--border-radius' | '--border' | '--border-inner' | '--active-border' | '--button-font-size' | '--button-background-color' | '--button-width' | '--input-font-color' | '--button-text-color'> */
trait ValuePropsPickInputPropso
  extends StObject
     with StepperProps {
  ...
  var style: js.UndefOr[CSSPropertiesPartialRecorActiveborder] = js.undefined
  
  var tabIndex: js.UndefOr[Double] = js.undefined
  
  var value: js.UndefOr[Double | Null] = js.undefined
}
object ValuePropsPickInputPropso {
  
  inline def apply(): ValuePropsPickInputPropso = {
    val __obj = js.Dynamic.literal(allowEmpty = true)
    __obj.asInstanceOf[ValuePropsPickInputPropso]
  }
  
  extension [Self <: ValuePropsPickInputPropso](x: Self) {
    ...
    inline def setStyle(value: CSSPropertiesPartialRecorActiveborder): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
