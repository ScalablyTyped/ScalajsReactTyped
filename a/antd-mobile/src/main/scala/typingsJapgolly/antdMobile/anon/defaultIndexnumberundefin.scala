...
trait defaultIndexnumberundefin extends StObject {
  ...
  var indicator: js.UndefOr[js.Function2[/* total */ Double, /* current */ Double, Node]] = js.undefined
...
object defaultIndexnumberundefin {
  
  inline def apply(): defaultIndexnumberundefin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[defaultIndexnumberundefin]
  }
  
  extension [Self <: defaultIndexnumberundefin](x: Self) {
    ...
    inline def setIndicator(value: (/* total */ Double, /* current */ Double) => Node): Self = StObject.set(x, "indicator", js.Any.fromFunction2(value))
    ...
    inline def setRefFunction1(value: SwiperRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: SwiperRef | Null) => value(t0).runNow()))
