...
import typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.SwipeActionRef
...
trait rightActionsArrayActionun extends StObject {
  ...
  var leftActions: js.UndefOr[
    js.Array[typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action]
  ] = js.undefined
  
  var onAction: js.UndefOr[
    js.Function2[
      /* action */ typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action, 
      /* e */ ReactMouseEventFrom[Element], 
      Unit
    ]
  ] = js.undefined
...
object rightActionsArrayActionun {
  
  inline def apply(): rightActionsArrayActionun = {
  ...
  extension [Self <: rightActionsArrayActionun](x: Self) {
    ...
    inline def setLeftActions(value: js.Array[typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action]): Self = StObject.set(x, "leftActions", value.asInstanceOf[js.Any])
    
    inline def setLeftActionsUndefined: Self = StObject.set(x, "leftActions", js.undefined)
    
    inline def setLeftActionsVarargs(value: typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action*): Self = StObject.set(x, "leftActions", js.Array(value*))
    
    inline def setOnAction(
      value: (/* action */ typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action, /* e */ ReactMouseEventFrom[Element]) => Callback
    ): Self = StObject.set(x, "onAction", js.Any.fromFunction2((t0: /* action */ typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action, t1: /* e */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    
    inline def setOnActionUndefined: Self = StObject.set(x, "onAction", js.undefined)
    
    inline def setOnActionsReveal(value: /* side */ left | right => Callback): Self = StObject.set(x, "onActionsReveal", js.Any.fromFunction1((t0: /* side */ left | right) => value(t0).runNow()))
    
    inline def setOnActionsRevealUndefined: Self = StObject.set(x, "onActionsReveal", js.undefined)
    
    inline def setRef(value: Ref[SwipeActionRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: SwipeActionRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: SwipeActionRef | Null) => value(t0).runNow()))
    
    inline def setRefNull: Self = StObject.set(x, "ref", null)
    
    inline def setRefUndefined: Self = StObject.set(x, "ref", js.undefined)
    
    inline def setRightActions(value: js.Array[typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action]): Self = StObject.set(x, "rightActions", value.asInstanceOf[js.Any])
    
    inline def setRightActionsUndefined: Self = StObject.set(x, "rightActions", js.undefined)
    
    inline def setRightActionsVarargs(value: typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action*): Self = StObject.set(x, "rightActions", js.Array(value*))
