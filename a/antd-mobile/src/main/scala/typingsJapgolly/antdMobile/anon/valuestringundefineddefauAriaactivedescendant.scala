...
/* Inlined {  value :string | undefined,   defaultValue :string | undefined,   onChange :(val : string): void | undefined,   length :number | undefined,   plain :boolean | undefined,   error :boolean | undefined,   caret :boolean | undefined,   seperated :boolean | undefined,   onBlur :(): void | undefined,   onFocus :(): void | undefined,   keyboard :react.react.ReactElement | undefined,   onFill :(val : string): void | undefined,   className :string | undefined,   style :react.react.CSSProperties & std.Partial<std.Record<'--border-radius' | '--border-color' | '--cell-size' | '--dot-size' | '--cell-gap', string>> | undefined,   tabIndex :number | undefined} & react.react.AriaAttributes & react.react.RefAttributes<antd-mobile.antd-mobile/es/components/passcode-input/passcode-input.PasscodeInputRef> */
trait valuestringundefineddefauAriaactivedescendant extends StObject {
  ...
  var onFill: js.UndefOr[js.Function1[/* val */ String, Unit]] = js.undefined
  
  var onFocus: js.UndefOr[js.Function0[Unit]] = js.undefined
  
  var plain: js.UndefOr[Boolean] = js.undefined
  
  var ref: js.UndefOr[Ref[PasscodeInputRef]] = js.undefined
  
  var seperated: js.UndefOr[Boolean] = js.undefined
  
  var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundAttachment] = js.undefined
  
  var tabIndex: js.UndefOr[Double] = js.undefined
  
  var value: js.UndefOr[String] = js.undefined
}
object valuestringundefineddefauAriaactivedescendant {
  
  inline def apply(): valuestringundefineddefauAriaactivedescendant = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[valuestringundefineddefauAriaactivedescendant]
  }
  
  extension [Self <: valuestringundefineddefauAriaactivedescendant](x: Self) {
    ...
    inline def setOnFill(value: /* val */ String => Callback): Self = StObject.set(x, "onFill", js.Any.fromFunction1((t0: /* val */ String) => value(t0).runNow()))
    
    inline def setOnFillUndefined: Self = StObject.set(x, "onFill", js.undefined)
    ...
    inline def setRef(value: Ref[PasscodeInputRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: PasscodeInputRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: PasscodeInputRef | Null) => value(t0).runNow()))
    
    inline def setRefNull: Self = StObject.set(x, "ref", null)
    
    inline def setRefUndefined: Self = StObject.set(x, "ref", js.undefined)
    
    inline def setSeperated(value: Boolean): Self = StObject.set(x, "seperated", value.asInstanceOf[js.Any])
    
    inline def setSeperatedUndefined: Self = StObject.set(x, "seperated", js.undefined)
    
    inline def setStyle(value: CSSPropertiesPartialRecorBackgroundAttachment): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
