...
/* Inlined std.Omit<antd-mobile.antd-mobile/es/components/date-picker/date-picker.DatePickerProps, 'value' | 'visible' | 'children'> */
trait OmitDatePickerPropsvaluev extends StObject {
...
object OmitDatePickerPropsvaluev {
  
  inline def apply(): OmitDatePickerPropsvaluev = {
