...
import typingsJapgolly.antdMobile.antdMobileStrings.single
...
object selectionModesinglevalueD {
  ...
  extension [Self <: selectionModesinglevalueD](x: Self) {
    ...
    inline def setOnChange(value: /* val */ js.Date | Null => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* val */ js.Date | Null) => value(t0).runNow()))
