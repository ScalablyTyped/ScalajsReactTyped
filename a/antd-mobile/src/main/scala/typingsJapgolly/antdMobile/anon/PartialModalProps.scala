...
trait PartialModalProps extends StObject {
  ...
  var actions: js.UndefOr[
    js.Array[typingsJapgolly.antdMobile.esComponentsModalModalActionButtonMod.Action]
  ] = js.undefined
...
object PartialModalProps {
  ...
  inline def apply(): PartialModalProps = {
  ...
  extension [Self <: PartialModalProps](x: Self) {
    ...
    inline def setActions(value: js.Array[typingsJapgolly.antdMobile.esComponentsModalModalActionButtonMod.Action]): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
    
    inline def setActionsUndefined: Self = StObject.set(x, "actions", js.undefined)
    
    inline def setActionsVarargs(value: typingsJapgolly.antdMobile.esComponentsModalModalActionButtonMod.Action*): Self = StObject.set(x, "actions", js.Array(value*))
    ...
    inline def setOnAction(
      value: (/* action */ typingsJapgolly.antdMobile.esComponentsModalModalActionButtonMod.Action, /* index */ Double) => Unit | js.Promise[Unit]
