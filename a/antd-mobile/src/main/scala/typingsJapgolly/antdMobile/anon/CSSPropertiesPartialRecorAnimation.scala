...
trait CSSPropertiesPartialRecorAnimation extends StObject {
  ...
  var `--icon-size`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAnimation {
  
  inline def apply(): CSSPropertiesPartialRecorAnimation = {
  ...
  extension [Self <: CSSPropertiesPartialRecorAnimation](x: Self) {
    ...
    inline def `set--icon-size`(value: String): Self = StObject.set(x, "--icon-size", value.asInstanceOf[js.Any])
    
    inline def `set--icon-sizeUndefined`: Self = StObject.set(x, "--icon-size", js.undefined)
