...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--height', string>> */
trait CSSPropertiesPartialRecorAlignTracks extends StObject {
...
object CSSPropertiesPartialRecorAlignTracks {
  
  inline def apply(): CSSPropertiesPartialRecorAlignTracks = {
