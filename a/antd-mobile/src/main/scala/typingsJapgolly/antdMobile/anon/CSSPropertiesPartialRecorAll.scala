...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--background-color' | '--border-radius' | '--max-width' | '--min-width' | '--z-index', string>> */
trait CSSPropertiesPartialRecorAll extends StObject {
...
object CSSPropertiesPartialRecorAll {
  
  inline def apply(): CSSPropertiesPartialRecorAll = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorAll]
  }
  
  extension [Self <: CSSPropertiesPartialRecorAll](x: Self) {
    ...
    inline def `set--max-width`(value: String): Self = StObject.set(x, "--max-width", value.asInstanceOf[js.Any])
    
    inline def `set--max-widthUndefined`: Self = StObject.set(x, "--max-width", js.undefined)
    
    inline def `set--min-width`(value: String): Self = StObject.set(x, "--min-width", value.asInstanceOf[js.Any])
    
    inline def `set--min-widthUndefined`: Self = StObject.set(x, "--min-width", js.undefined)
