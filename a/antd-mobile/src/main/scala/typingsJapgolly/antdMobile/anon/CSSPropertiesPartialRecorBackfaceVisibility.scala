...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--height' | '--border-bottom', string>> */
trait CSSPropertiesPartialRecorBackfaceVisibility extends StObject {
...
object CSSPropertiesPartialRecorBackfaceVisibility {
  
  inline def apply(): CSSPropertiesPartialRecorBackfaceVisibility = {
