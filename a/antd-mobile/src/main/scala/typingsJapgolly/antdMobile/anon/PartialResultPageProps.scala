...
import typingsJapgolly.antdMobile.antdMobileStrings.error
...
import typingsJapgolly.antdMobile.antdMobileStrings.info
...
import typingsJapgolly.antdMobile.antdMobileStrings.waiting
import typingsJapgolly.antdMobile.antdMobileStrings.warning
import typingsJapgolly.antdMobile.esComponentsResultPageResultPageMod.OnClick
import typingsJapgolly.antdMobile.esComponentsResultPageResultPageMod.ResultPageDetail
import typingsJapgolly.antdMobile.esComponentsResultPageResultPageMod.ResultPageDetails
import typingsJapgolly.react.mod.Booleanish
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/result-page/result-page.ResultPageProps> */
trait PartialResultPageProps extends StObject {
  ...
  var details: js.UndefOr[ResultPageDetails] = js.undefined
  
  var icon: js.UndefOr[Node] = js.undefined
  
  var onPrimaryButtonClick: js.UndefOr[OnClick] = js.undefined
  
  var onSecondaryButtonClick: js.UndefOr[OnClick] = js.undefined
  
  var primaryButtonText: js.UndefOr[Node] = js.undefined
  
  var secondaryButtonText: js.UndefOr[Node] = js.undefined
  
  var status: js.UndefOr[success | error | info | waiting | warning] = js.undefined
...
object PartialResultPageProps {
  
  inline def apply(): PartialResultPageProps = {
  ...
  extension [Self <: PartialResultPageProps](x: Self) {
    ...
    inline def setDetails(value: ResultPageDetails): Self = StObject.set(x, "details", value.asInstanceOf[js.Any])
    
    inline def setDetailsUndefined: Self = StObject.set(x, "details", js.undefined)
    
    inline def setDetailsVarargs(value: ResultPageDetail*): Self = StObject.set(x, "details", js.Array(value*))
    ...
    inline def setOnPrimaryButtonClick(value: /* event */ ReactMouseEventFrom[HTMLButtonElement] => Unit | js.Promise[Unit] | Any): Self = StObject.set(x, "onPrimaryButtonClick", js.Any.fromFunction1(value))
    
    inline def setOnPrimaryButtonClickUndefined: Self = StObject.set(x, "onPrimaryButtonClick", js.undefined)
    
    inline def setOnSecondaryButtonClick(value: /* event */ ReactMouseEventFrom[HTMLButtonElement] => Unit | js.Promise[Unit] | Any): Self = StObject.set(x, "onSecondaryButtonClick", js.Any.fromFunction1(value))
    ...
    inline def setStatus(value: success | error | info | waiting | warning): Self = StObject.set(x, "status", value.asInstanceOf[js.Any])
