...
import typingsJapgolly.antdMobile.esComponentsPickerViewPickerViewMod.PickerValueExtend
...
trait columnsArrayPickerColumnv extends StObject {
  ...
  var children: js.UndefOr[
    js.Function2[/* items */ js.Array[PickerColumnItem | Null], /* actions */ PickerActions, Node]
  ] = js.undefined
...
object columnsArrayPickerColumnv {
  ...
  extension [Self <: columnsArrayPickerColumnv](x: Self) {
    ...
    inline def setChildren(value: (/* items */ js.Array[PickerColumnItem | Null], /* actions */ PickerActions) => Node): Self = StObject.set(x, "children", js.Any.fromFunction2(value))
    ...
    inline def setOnConfirm(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Callback): Self = StObject.set(x, "onConfirm", js.Any.fromFunction2((t0: /* value */ js.Array[PickerValue], t1: /* extend */ PickerValueExtend) => (value(t0, t1)).runNow()))
    
    inline def setOnConfirmUndefined: Self = StObject.set(x, "onConfirm", js.undefined)
    
    inline def setOnSelect(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: /* value */ js.Array[PickerValue], t1: /* extend */ PickerValueExtend) => (value(t0, t1)).runNow()))
    ...
    inline def setRef(value: Ref[PickerActions]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: PickerActions | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: PickerActions | Null) => value(t0).runNow()))
