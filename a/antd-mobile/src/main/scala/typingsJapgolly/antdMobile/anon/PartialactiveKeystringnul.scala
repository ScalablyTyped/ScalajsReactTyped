...
import typingsJapgolly.antdMobile.esComponentsDropdownDropdownMod.DropdownRef
...
object PartialactiveKeystringnul {
  
  inline def apply(): PartialactiveKeystringnul = {
  ...
  extension [Self <: PartialactiveKeystringnul](x: Self) {
    ...
    inline def setRef(value: Ref[DropdownRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: DropdownRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: DropdownRef | Null) => value(t0).runNow()))
