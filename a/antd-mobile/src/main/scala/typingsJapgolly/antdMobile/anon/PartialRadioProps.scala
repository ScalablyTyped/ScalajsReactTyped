...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/radio/radio.RadioProps> */
trait PartialRadioProps extends StObject {
  ...
  var icon: js.UndefOr[js.Function1[/* checked */ Boolean, Node]] = js.undefined
...
object PartialRadioProps {
  ...
  extension [Self <: PartialRadioProps](x: Self) {
    ...
    inline def setIcon(value: /* checked */ Boolean => Node): Self = StObject.set(x, "icon", js.Any.fromFunction1(value))
