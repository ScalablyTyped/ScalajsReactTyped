...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/skeleton/skeleton.SkeletonProps> */
trait PartialSkeletonProps extends StObject {
...
object PartialSkeletonProps {
  ...
  inline def apply(): PartialSkeletonProps = {
