...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--track-width' | '--track-color' | '--fill-color' | '--text-width', string>> */
trait CSSPropertiesPartialRecorBackgroundBlendMode extends StObject {
  
  var `--fill-color`: js.UndefOr[String] = js.undefined
  
  var `--text-width`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBackgroundBlendMode {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundBlendMode = {
  ...
  extension [Self <: CSSPropertiesPartialRecorBackgroundBlendMode](x: Self) {
    ...
    inline def `set--text-width`(value: String): Self = StObject.set(x, "--text-width", value.asInstanceOf[js.Any])
    
    inline def `set--text-widthUndefined`: Self = StObject.set(x, "--text-width", js.undefined)
