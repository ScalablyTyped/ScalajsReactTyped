...
import typingsJapgolly.antdMobile.esComponentsVirtualInputVirtualInputMod.VirtualInputRef
...
/* Inlined {  onFocus :(): void | undefined,   onBlur :(): void | undefined,   onClick :(e : react.react.MouseEvent<std.HTMLDivElement, react.react.NativeMouseEvent>): void | undefined,   keyboard :react.react.ReactElement | undefined,   clearable :boolean | undefined,   onClear :(): void | undefined,   className :string | undefined,   style :react.react.CSSProperties & std.Partial<std.Record<'--color' | '--font-size' | '--placeholder-color' | '--text-align' | '--disabled-color' | '--caret-width' | '--caret-color', string>> | undefined,   tabIndex :number | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/input.InputProps, 'value' | 'onChange' | 'disabled' | 'placeholder'> & react.react.AriaAttributes & react.react.RefAttributes<antd-mobile.antd-mobile/es/components/virtual-input/virtual-input.VirtualInputRef> */
trait onFocusvoidundefinedonBlu extends StObject {
  ...
  var keyboard: js.UndefOr[Element] = js.undefined
  ...
  var ref: js.UndefOr[Ref[VirtualInputRef]] = js.undefined
  
  var style: js.UndefOr[CSSPropertiesPartialRecorBorderBlock] = js.undefined
  
  var tabIndex: js.UndefOr[Double] = js.undefined
  
  var value: js.UndefOr[String] = js.undefined
}
object onFocusvoidundefinedonBlu {
  
  inline def apply(): onFocusvoidundefinedonBlu = {
  ...
  extension [Self <: onFocusvoidundefinedonBlu](x: Self) {
    ...
    inline def setKeyboard(value: VdomElement): Self = StObject.set(x, "keyboard", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: /* val */ String => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* val */ String) => value(t0).runNow()))
    ...
    inline def setRef(value: Ref[VirtualInputRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: VirtualInputRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: VirtualInputRef | Null) => value(t0).runNow()))
    
    inline def setRefNull: Self = StObject.set(x, "ref", null)
    
    inline def setRefUndefined: Self = StObject.set(x, "ref", js.undefined)
    
    inline def setStyle(value: CSSPropertiesPartialRecorBorderBlock): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
