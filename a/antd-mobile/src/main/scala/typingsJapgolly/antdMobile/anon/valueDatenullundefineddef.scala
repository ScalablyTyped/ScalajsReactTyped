...
trait valueDatenullundefineddef extends StObject {
  ...
  var filter: js.UndefOr[PartialRecordPrecisionval] = js.undefined
  ...
  var style: (js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])]) & js.UndefOr[CSSPropertiesPartialRecorAlignSelf]
...
object valueDatenullundefineddef {
  ...
  extension [Self <: valueDatenullundefineddef](x: Self) {
    ...
    inline def setFilter(value: PartialRecordPrecisionval): Self = StObject.set(x, "filter", value.asInstanceOf[js.Any])
    ...
    inline def setStyle(
      value: (js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])]) & js.UndefOr[CSSPropertiesPartialRecorAlignSelf]
