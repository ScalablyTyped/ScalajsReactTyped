...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--width' | '--height' | '--item-border-radius' | '--background-color', string>> */
trait CSSPropertiesPartialRecorBackgroundOrigin extends StObject {
  
  var `--background-color`: js.UndefOr[String] = js.undefined
  
  var `--height`: js.UndefOr[String] = js.undefined
  
  var `--item-border-radius`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBackgroundOrigin {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundOrigin = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[CSSPropertiesPartialRecorBackgroundOrigin]
  }
  
  extension [Self <: CSSPropertiesPartialRecorBackgroundOrigin](x: Self) {
    ...
    inline def `set--item-border-radius`(value: String): Self = StObject.set(x, "--item-border-radius", value.asInstanceOf[js.Any])
    
    inline def `set--item-border-radiusUndefined`: Self = StObject.set(x, "--item-border-radius", js.undefined)
