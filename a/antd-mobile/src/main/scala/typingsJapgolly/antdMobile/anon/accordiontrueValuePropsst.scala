...
object accordiontrueValuePropsst {
  ...
  extension [Self <: accordiontrueValuePropsst](x: Self) {
    ...
    inline def setOnChange(value: /* activeKey */ String | Null => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* activeKey */ String | Null) => value(t0).runNow()))
