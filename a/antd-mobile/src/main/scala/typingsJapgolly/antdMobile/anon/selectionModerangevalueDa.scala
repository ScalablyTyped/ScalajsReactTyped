...
import typingsJapgolly.antdMobile.antdMobileStrings.Monday
import typingsJapgolly.antdMobile.antdMobileStrings.Sunday
...
import typingsJapgolly.antdMobile.antdMobileStrings.range
...
trait selectionModerangevalueDa
  ...
  var nextMonthButton: js.UndefOr[Node] = js.undefined
  
  var nextYearButton: js.UndefOr[Node] = js.undefined
  ...
  var prevMonthButton: js.UndefOr[Node] = js.undefined
  
  var prevYearButton: js.UndefOr[Node] = js.undefined
  
  var renderLabel: js.UndefOr[js.Function1[/* date */ js.Date, Node]] = js.undefined
...
object selectionModerangevalueDa {
  ...
  extension [Self <: selectionModerangevalueDa](x: Self) {
    ...
    inline def setNextMonthButton(value: VdomNode): Self = StObject.set(x, "nextMonthButton", value.rawNode.asInstanceOf[js.Any])
    
    inline def setNextMonthButtonNull: Self = StObject.set(x, "nextMonthButton", null)
    
    inline def setNextMonthButtonUndefined: Self = StObject.set(x, "nextMonthButton", js.undefined)
    
    inline def setNextMonthButtonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "nextMonthButton", js.Array(value*))
    
    inline def setNextMonthButtonVdomElement(value: VdomElement): Self = StObject.set(x, "nextMonthButton", value.rawElement.asInstanceOf[js.Any])
    
    inline def setNextYearButton(value: VdomNode): Self = StObject.set(x, "nextYearButton", value.rawNode.asInstanceOf[js.Any])
    
    inline def setNextYearButtonNull: Self = StObject.set(x, "nextYearButton", null)
    
    inline def setNextYearButtonUndefined: Self = StObject.set(x, "nextYearButton", js.undefined)
    
    inline def setNextYearButtonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "nextYearButton", js.Array(value*))
    
    inline def setNextYearButtonVdomElement(value: VdomElement): Self = StObject.set(x, "nextYearButton", value.rawElement.asInstanceOf[js.Any])
    
    inline def setOnChange(value: /* val */ (js.Tuple2[js.Date, js.Date]) | Null => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* val */ (js.Tuple2[js.Date, js.Date]) | Null) => value(t0).runNow()))
    
    inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
    
    inline def setOnPageChange(value: (/* year */ Double, /* month */ Double) => Callback): Self = StObject.set(x, "onPageChange", js.Any.fromFunction2((t0: /* year */ Double, t1: /* month */ Double) => (value(t0, t1)).runNow()))
    
    inline def setOnPageChangeUndefined: Self = StObject.set(x, "onPageChange", js.undefined)
    
    inline def setPrevMonthButton(value: VdomNode): Self = StObject.set(x, "prevMonthButton", value.rawNode.asInstanceOf[js.Any])
    
    inline def setPrevMonthButtonNull: Self = StObject.set(x, "prevMonthButton", null)
    
    inline def setPrevMonthButtonUndefined: Self = StObject.set(x, "prevMonthButton", js.undefined)
    
    inline def setPrevMonthButtonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "prevMonthButton", js.Array(value*))
    
    inline def setPrevMonthButtonVdomElement(value: VdomElement): Self = StObject.set(x, "prevMonthButton", value.rawElement.asInstanceOf[js.Any])
    
    inline def setPrevYearButton(value: VdomNode): Self = StObject.set(x, "prevYearButton", value.rawNode.asInstanceOf[js.Any])
    
    inline def setPrevYearButtonNull: Self = StObject.set(x, "prevYearButton", null)
    
    inline def setPrevYearButtonUndefined: Self = StObject.set(x, "prevYearButton", js.undefined)
    
    inline def setPrevYearButtonVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "prevYearButton", js.Array(value*))
    
    inline def setPrevYearButtonVdomElement(value: VdomElement): Self = StObject.set(x, "prevYearButton", value.rawElement.asInstanceOf[js.Any])
    
    inline def setRenderLabel(value: /* date */ js.Date => Node): Self = StObject.set(x, "renderLabel", js.Any.fromFunction1(value))
