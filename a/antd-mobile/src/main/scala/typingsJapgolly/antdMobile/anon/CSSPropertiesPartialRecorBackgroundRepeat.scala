...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--title-font-size' | '--description-font-size' | '--indicator-margin-right' | '--icon-size', string>> */
trait CSSPropertiesPartialRecorBackgroundRepeat extends StObject {
  
  var `--description-font-size`: js.UndefOr[String] = js.undefined
  
  var `--icon-size`: js.UndefOr[String] = js.undefined
  
  var `--indicator-margin-right`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorBackgroundRepeat {
  
  inline def apply(): CSSPropertiesPartialRecorBackgroundRepeat = {
  ...
  extension [Self <: CSSPropertiesPartialRecorBackgroundRepeat](x: Self) {
    ...
    inline def `set--description-font-sizeUndefined`: Self = StObject.set(x, "--description-font-size", js.undefined)
    ...
    inline def `set--indicator-margin-right`(value: String): Self = StObject.set(x, "--indicator-margin-right", value.asInstanceOf[js.Any])
    
    inline def `set--indicator-margin-rightUndefined`: Self = StObject.set(x, "--indicator-margin-right", js.undefined)
