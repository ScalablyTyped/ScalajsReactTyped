...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--width' | '--height', string>> */
trait CSSPropertiesPartialRecorAppearance extends StObject {
...
object CSSPropertiesPartialRecorAppearance {
  
  inline def apply(): CSSPropertiesPartialRecorAppearance = {
