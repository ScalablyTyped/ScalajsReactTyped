...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--star-size' | '--active-color' | '--inactive-color', string>> */
trait CSSPropertiesPartialRecorActivecolor extends StObject {
  
  var `--active-color`: js.UndefOr[String] = js.undefined
  
  var `--inactive-color`: js.UndefOr[String] = js.undefined
  
  var `--star-size`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorActivecolor {
  
  inline def apply(): CSSPropertiesPartialRecorActivecolor = {
  ...
  extension [Self <: CSSPropertiesPartialRecorActivecolor](x: Self) {
    ...
    inline def `set--active-colorUndefined`: Self = StObject.set(x, "--active-color", js.undefined)
    
    inline def `set--inactive-color`(value: String): Self = StObject.set(x, "--inactive-color", value.asInstanceOf[js.Any])
    
    inline def `set--inactive-colorUndefined`: Self = StObject.set(x, "--inactive-color", js.undefined)
    
    inline def `set--star-size`(value: String): Self = StObject.set(x, "--star-size", value.asInstanceOf[js.Any])
    
    inline def `set--star-sizeUndefined`: Self = StObject.set(x, "--star-size", js.undefined)
