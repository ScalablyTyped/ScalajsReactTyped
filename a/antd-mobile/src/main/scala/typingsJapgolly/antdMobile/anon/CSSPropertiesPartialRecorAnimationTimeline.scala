...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--gap' | '--gap-vertical' | '--gap-horizontal', string>> */
trait CSSPropertiesPartialRecorAnimationTimeline extends StObject {
...
object CSSPropertiesPartialRecorAnimationTimeline {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationTimeline = {
