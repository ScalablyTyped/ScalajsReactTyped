...
trait OmitPopoverPropscontentac extends StObject {
  ...
  var actions: js.Array[typingsJapgolly.antdMobile.esComponentsPopoverPopoverMenuMod.Action]
  ...
  var onAction: js.UndefOr[
    js.Function1[
      /* item */ typingsJapgolly.antdMobile.esComponentsPopoverPopoverMenuMod.Action, 
      Unit
    ]
  ] = js.undefined
...
object OmitPopoverPropscontentac {
  ...
  inline def apply(
    actions: js.Array[typingsJapgolly.antdMobile.esComponentsPopoverPopoverMenuMod.Action],
  ...
  extension [Self <: OmitPopoverPropscontentac](x: Self) {
    ...
    inline def setActions(value: js.Array[typingsJapgolly.antdMobile.esComponentsPopoverPopoverMenuMod.Action]): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
    
    inline def setActionsVarargs(value: typingsJapgolly.antdMobile.esComponentsPopoverPopoverMenuMod.Action*): Self = StObject.set(x, "actions", js.Array(value*))
    ...
    inline def setOnAction(value: /* item */ typingsJapgolly.antdMobile.esComponentsPopoverPopoverMenuMod.Action => Callback): Self = StObject.set(x, "onAction", js.Any.fromFunction1((t0: /* item */ typingsJapgolly.antdMobile.esComponentsPopoverPopoverMenuMod.Action) => value(t0).runNow()))
    ...
    inline def setRefFunction1(value: PopoverRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: PopoverRef | Null) => value(t0).runNow()))
