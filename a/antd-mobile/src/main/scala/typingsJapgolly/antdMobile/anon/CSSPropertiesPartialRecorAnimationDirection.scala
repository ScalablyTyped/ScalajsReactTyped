...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--initial-position-left' | '--initial-position-right' | '--initial-position-top' | '--initial-position-bottom' | '--z-index' | '--edge-distance' | '--size' | '--border-radius' | '--background', string>> */
trait CSSPropertiesPartialRecorAnimationDirection extends StObject {
  
  var `--background`: js.UndefOr[String] = js.undefined
  
  var `--border-radius`: js.UndefOr[String] = js.undefined
  
  var `--edge-distance`: js.UndefOr[String] = js.undefined
  
  var `--initial-position-bottom`: js.UndefOr[String] = js.undefined
  
  var `--initial-position-left`: js.UndefOr[String] = js.undefined
  
  var `--initial-position-right`: js.UndefOr[String] = js.undefined
  
  var `--initial-position-top`: js.UndefOr[String] = js.undefined
...
object CSSPropertiesPartialRecorAnimationDirection {
  
  inline def apply(): CSSPropertiesPartialRecorAnimationDirection = {
  ...
  extension [Self <: CSSPropertiesPartialRecorAnimationDirection](x: Self) {
    ...
    inline def `set--edge-distance`(value: String): Self = StObject.set(x, "--edge-distance", value.asInstanceOf[js.Any])
    
    inline def `set--edge-distanceUndefined`: Self = StObject.set(x, "--edge-distance", js.undefined)
    
    inline def `set--initial-position-bottom`(value: String): Self = StObject.set(x, "--initial-position-bottom", value.asInstanceOf[js.Any])
    
    inline def `set--initial-position-bottomUndefined`: Self = StObject.set(x, "--initial-position-bottom", js.undefined)
    
    inline def `set--initial-position-left`(value: String): Self = StObject.set(x, "--initial-position-left", value.asInstanceOf[js.Any])
    
    inline def `set--initial-position-leftUndefined`: Self = StObject.set(x, "--initial-position-left", js.undefined)
    
    inline def `set--initial-position-right`(value: String): Self = StObject.set(x, "--initial-position-right", value.asInstanceOf[js.Any])
    
    inline def `set--initial-position-rightUndefined`: Self = StObject.set(x, "--initial-position-right", js.undefined)
    
    inline def `set--initial-position-top`(value: String): Self = StObject.set(x, "--initial-position-top", value.asInstanceOf[js.Any])
    
    inline def `set--initial-position-topUndefined`: Self = StObject.set(x, "--initial-position-top", js.undefined)
