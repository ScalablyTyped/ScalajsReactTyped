...
/* Inlined {  accordion :false | undefined} & antd-mobile.antd-mobile/es/components/collapse/collapse.ValueProps<std.Array<string>> & {  children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
trait accordionfalseundefinedVa
  extends StObject
     with CollapseProps {
  
  var accordion: js.UndefOr[`false`] = js.undefined
  
  var activeKey: js.UndefOr[js.Array[String]] = js.undefined
  ...
  var defaultActiveKey: js.UndefOr[js.Array[String]] = js.undefined
  
  var onChange: js.UndefOr[js.Function1[/* activeKey */ js.Array[String], Unit]] = js.undefined
...
object accordionfalseundefinedVa {
  ...
  inline def apply(): accordionfalseundefinedVa = {
  ...
  extension [Self <: accordionfalseundefinedVa](x: Self) {
    ...
    inline def setActiveKey(value: js.Array[String]): Self = StObject.set(x, "activeKey", value.asInstanceOf[js.Any])
    ...
    inline def setDefaultActiveKey(value: js.Array[String]): Self = StObject.set(x, "defaultActiveKey", value.asInstanceOf[js.Any])
    ...
    inline def setOnChange(value: /* activeKey */ js.Array[String] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* activeKey */ js.Array[String]) => value(t0).runNow()))
