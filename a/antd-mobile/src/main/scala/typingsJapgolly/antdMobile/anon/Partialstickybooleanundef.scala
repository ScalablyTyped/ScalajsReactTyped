...
import typingsJapgolly.antdMobile.esComponentsIndexBarIndexBarMod.IndexBarRef
...
trait Partialstickybooleanundef extends StObject {
  ...
  var ref: js.UndefOr[Ref[IndexBarRef]] = js.undefined
...
object Partialstickybooleanundef {
  
  inline def apply(): Partialstickybooleanundef = {
  ...
  extension [Self <: Partialstickybooleanundef](x: Self) {
    ...
    inline def setOnIndexChange(value: /* index */ String => Callback): Self = StObject.set(x, "onIndexChange", js.Any.fromFunction1((t0: /* index */ String) => value(t0).runNow()))
    
    inline def setOnIndexChangeUndefined: Self = StObject.set(x, "onIndexChange", js.undefined)
    
    inline def setRef(value: Ref[IndexBarRef]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
    
    inline def setRefFunction1(value: IndexBarRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: IndexBarRef | Null) => value(t0).runNow()))
