...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--color' | '--font-size' | '--placeholder-color' | '--text-align', string>> */
trait CSSPropertiesPartialRecorAzimuth extends StObject {
...
object CSSPropertiesPartialRecorAzimuth {
  
  inline def apply(): CSSPropertiesPartialRecorAzimuth = {
