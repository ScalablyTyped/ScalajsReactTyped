...
/* Inlined std.Omit<antd-mobile.antd-mobile/es/components/picker.PickerProps, 'value' | 'visible' | 'children'> */
trait OmitPickerPropsvaluevisib extends StObject {
