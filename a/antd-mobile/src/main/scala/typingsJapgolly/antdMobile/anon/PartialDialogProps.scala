...
trait PartialDialogProps extends StObject {
  ...
  var actions: js.UndefOr[
    js.Array[
      typingsJapgolly.antdMobile.esComponentsDialogDialogActionButtonMod.Action | js.Array[typingsJapgolly.antdMobile.esComponentsDialogDialogActionButtonMod.Action]
    ]
  ] = js.undefined
...
object PartialDialogProps {
  ...
  extension [Self <: PartialDialogProps](x: Self) {
    ...
    inline def setActionsVarargs(
      value: (typingsJapgolly.antdMobile.esComponentsDialogDialogActionButtonMod.Action | js.Array[typingsJapgolly.antdMobile.esComponentsDialogDialogActionButtonMod.Action])*
    ...
    inline def setOnAction(
      value: (/* action */ typingsJapgolly.antdMobile.esComponentsDialogDialogActionButtonMod.Action, /* index */ Double) => Unit | js.Promise[Unit]
