...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/tree-select/tree-select.TreeSelectProps> */
trait PartialTreeSelectProps extends StObject {
  ...
  var options: js.UndefOr[js.Array[TreeSelectOption]] = js.undefined
...
object PartialTreeSelectProps {
  
  inline def apply(): PartialTreeSelectProps = {
