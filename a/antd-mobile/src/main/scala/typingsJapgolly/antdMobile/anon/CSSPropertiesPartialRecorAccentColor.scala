...
/* Inlined react.react.CSSProperties & std.Partial<std.Record<'--right' | '--top' | '--color', string>> */
trait CSSPropertiesPartialRecorAccentColor extends StObject {
...
object CSSPropertiesPartialRecorAccentColor {
  
  inline def apply(): CSSPropertiesPartialRecorAccentColor = {
  ...
  extension [Self <: CSSPropertiesPartialRecorAccentColor](x: Self) {
    ...
    inline def `set--right`(value: String): Self = StObject.set(x, "--right", value.asInstanceOf[js.Any])
    
    inline def `set--rightUndefined`: Self = StObject.set(x, "--right", js.undefined)
    
    inline def `set--top`(value: String): Self = StObject.set(x, "--top", value.asInstanceOf[js.Any])
