...
/* Inlined std.Partial<antd-mobile.antd-mobile/es/components/jumbo-tabs/jumbo-tabs.JumboTabsProps> */
trait PartialJumboTabsProps extends StObject {
...
object PartialJumboTabsProps {
  
  inline def apply(): PartialJumboTabsProps = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialJumboTabsProps]
  }
  
  extension [Self <: PartialJumboTabsProps](x: Self) {
