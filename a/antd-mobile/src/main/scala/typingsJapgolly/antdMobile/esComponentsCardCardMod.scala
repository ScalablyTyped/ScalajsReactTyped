...
object esComponentsCardCardMod {
  ...
  trait CardProps extends StObject {
    ...
    var onBodyClick: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLDivElement], Unit]] = js.undefined
    
    var onClick: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLDivElement], Unit]] = js.undefined
    
    var onHeaderClick: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLDivElement], Unit]] = js.undefined
  ...
  object CardProps {
    ...
    extension [Self <: CardProps](x: Self) {
      ...
      inline def setOnBodyClick(value: /* event */ ReactMouseEventFrom[HTMLDivElement] => Callback): Self = StObject.set(x, "onBodyClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
      ...
      inline def setOnHeaderClick(value: /* event */ ReactMouseEventFrom[HTMLDivElement] => Callback): Self = StObject.set(x, "onHeaderClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
