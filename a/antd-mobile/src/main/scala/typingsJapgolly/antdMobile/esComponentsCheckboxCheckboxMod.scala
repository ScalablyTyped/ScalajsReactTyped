...
object esComponentsCheckboxCheckboxMod {
  ...
  object CheckboxRef {
    ...
    inline def apply(check: Callback, toggle: Callback, uncheck: Callback): CheckboxRef = {
      val __obj = js.Dynamic.literal(check = check.toJsFn, toggle = toggle.toJsFn, uncheck = uncheck.toJsFn)
