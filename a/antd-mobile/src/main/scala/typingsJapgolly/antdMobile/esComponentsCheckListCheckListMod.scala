...
object esComponentsCheckListCheckListMod {
  
  @JSImport("antd-mobile/es/components/check-list/check-list", "CheckList")
  @js.native
  ...
  trait CheckListProps extends StObject {
    ...
    var onChange: js.UndefOr[js.Function1[/* val */ js.Array[String], Unit]] = js.undefined
    
    var readOnly: js.UndefOr[Boolean] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorAlignitems] & (js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])])
  ...
  object CheckListProps {
    ...
    inline def apply(
      style: js.UndefOr[CSSPropertiesPartialRecorAlignitems] & (js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])])
    ): CheckListProps = {
    ...
    extension [Self <: CheckListProps](x: Self) {
      ...
      inline def setOnChange(value: /* val */ js.Array[String] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* val */ js.Array[String]) => value(t0).runNow()))
      ...
      inline def setStyle(
        value: js.UndefOr[CSSPropertiesPartialRecorAlignitems] & (js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])])
