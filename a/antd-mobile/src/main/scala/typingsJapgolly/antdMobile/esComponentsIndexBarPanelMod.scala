...
object esComponentsIndexBarPanelMod {
  
  @JSImport("antd-mobile/es/components/index-bar/panel", "Panel")
  @js.native
  val Panel: FC[IndexBarPanelProps] = js.native
  
  /* Inlined {  index :string,   title :react.react.ReactNode | undefined,   brief :react.react.ReactNode | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait IndexBarPanelProps extends StObject {
    ...
    var brief: js.UndefOr[Node] = js.undefined
  ...
  object IndexBarPanelProps {
    
    inline def apply(index: String): IndexBarPanelProps = {
