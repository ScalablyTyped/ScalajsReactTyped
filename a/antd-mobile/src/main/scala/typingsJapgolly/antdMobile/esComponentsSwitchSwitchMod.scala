...
object esComponentsSwitchSwitchMod {
  ...
  trait SwitchProps extends StObject {
    ...
    var checkedText: js.UndefOr[Node] = js.undefined
    ...
    var uncheckedText: js.UndefOr[Node] = js.undefined
  }
  object SwitchProps {
    ...
    extension [Self <: SwitchProps](x: Self) {
      ...
      inline def setCheckedText(value: VdomNode): Self = StObject.set(x, "checkedText", value.rawNode.asInstanceOf[js.Any])
      
      inline def setCheckedTextNull: Self = StObject.set(x, "checkedText", null)
      
      inline def setCheckedTextUndefined: Self = StObject.set(x, "checkedText", js.undefined)
      
      inline def setCheckedTextVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "checkedText", js.Array(value*))
      
      inline def setCheckedTextVdomElement(value: VdomElement): Self = StObject.set(x, "checkedText", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setUncheckedText(value: VdomNode): Self = StObject.set(x, "uncheckedText", value.rawNode.asInstanceOf[js.Any])
      
      inline def setUncheckedTextNull: Self = StObject.set(x, "uncheckedText", null)
      
      inline def setUncheckedTextUndefined: Self = StObject.set(x, "uncheckedText", js.undefined)
      
      inline def setUncheckedTextVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "uncheckedText", js.Array(value*))
      
      inline def setUncheckedTextVdomElement(value: VdomElement): Self = StObject.set(x, "uncheckedText", value.rawElement.asInstanceOf[js.Any])
    }
  }
}
