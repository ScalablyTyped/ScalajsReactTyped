...
object esComponentsResultResultMod {
  
  @JSImport("antd-mobile/es/components/result/result", "Result")
  @js.native
  val Result: FC[ResultProps] = js.native
  
  /* Inlined {  status :'success' | 'error' | 'info' | 'waiting' | 'warning' | undefined,   title :react.react.ReactNode,   description :react.react.ReactNode | undefined,   icon :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
