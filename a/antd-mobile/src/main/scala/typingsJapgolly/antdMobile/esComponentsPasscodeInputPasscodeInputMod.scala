...
object esComponentsPasscodeInputPasscodeInputMod {
  
  @JSImport("antd-mobile/es/components/passcode-input/passcode-input", "PasscodeInput")
  @js.native
  val PasscodeInput: ForwardRefExoticComponent[valuestringundefineddefauAriaactivedescendant] = js.native
  
  /* Inlined {  value :string | undefined,   defaultValue :string | undefined,   onChange :(val : string): void | undefined,   length :number | undefined,   plain :boolean | undefined,   error :boolean | undefined,   caret :boolean | undefined,   seperated :boolean | undefined,   onBlur :(): void | undefined,   onFocus :(): void | undefined,   keyboard :react.react.ReactElement | undefined,   onFill :(val : string): void | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--cell-gap' | '--cell-size' | '--dot-size' | '--border-color' | '--border-radius'> */
  trait PasscodeInputProps extends StObject {
  ...
  object PasscodeInputProps {
    
    inline def apply(): PasscodeInputProps = {
  ...
  trait PasscodeInputRef extends StObject {
    
    def blur(): Unit
    
    def focus(): Unit
  }
  object PasscodeInputRef {
    
    inline def apply(blur: Callback, focus: Callback): PasscodeInputRef = {
