...
object esComponentsEmptyEmptyMod {
  
  @JSImport("antd-mobile/es/components/empty/empty", "Empty")
  @js.native
  val Empty: FC[EmptyProps] = js.native
  
  /* Inlined {  image :react.react.ReactNode | undefined,   imageStyle :react.react.CSSProperties | undefined,   description :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  ...
  object EmptyProps {
    ...
    extension [Self <: EmptyProps](x: Self) {
      ...
      inline def setDescriptionVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): Self = StObject.set(x, "description", js.Array(value*))
      ...
      inline def setImageVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): Self = StObject.set(x, "image", js.Array(value*))
