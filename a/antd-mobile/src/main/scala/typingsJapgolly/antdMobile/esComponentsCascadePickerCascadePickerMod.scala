...
import typingsJapgolly.antdMobile.anon.OmitPickerPropscolumnsopt
...
object esComponentsCascadePickerCascadePickerMod {
  
  @JSImport("antd-mobile/es/components/cascade-picker/cascade-picker", "CascadePicker")
  @js.native
  val CascadePicker: ForwardRefExoticComponent[OmitPickerPropscolumnsopt] = js.native
  
  trait CascadePickerOption extends StObject {
    
    var children: js.UndefOr[js.Array[CascadePickerOption]] = js.undefined
    
    var label: String
    
    var value: String
  }
  object CascadePickerOption {
    
    inline def apply(label: String, value: String): CascadePickerOption = {
    ...
    extension [Self <: CascadePickerOption](x: Self) {
      ...
      inline def setChildrenVarargs(value: CascadePickerOption*): Self = StObject.set(x, "children", js.Array(value*))
  ...
  /* Inlined std.Omit<antd-mobile.antd-mobile/es/components/picker.PickerProps, 'columns'> & {  options :std.Array<antd-mobile.antd-mobile/es/components/cascade-picker/cascade-picker.CascadePickerOption>} */
  trait CascadePickerProps extends StObject {
    ...
    var options: js.Array[CascadePickerOption]
  ...
  object CascadePickerProps {
    
    inline def apply(options: js.Array[CascadePickerOption]): CascadePickerProps = {
    ...
    extension [Self <: CascadePickerProps](x: Self) {
      ...
      inline def setOptions(value: js.Array[CascadePickerOption]): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      
      inline def setOptionsVarargs(value: CascadePickerOption*): Self = StObject.set(x, "options", js.Array(value*))
