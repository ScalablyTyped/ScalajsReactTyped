...
object esComponentsCollapseCollapseMod {
  
  @JSImport("antd-mobile/es/components/collapse/collapse", "Collapse")
  @js.native
  val Collapse: FC[CollapseProps] = js.native
  
  @JSImport("antd-mobile/es/components/collapse/collapse", "CollapsePanel")
  @js.native
  val CollapsePanel: FC[CollapsePanelProps] = js.native
  
  /* Inlined {  key :string,   title :react.react.ReactNode,   disabled :boolean | undefined,   forceRender :boolean | undefined,   destroyOnClose :boolean | undefined,   onClick :(event : react.react.MouseEvent<std.Element, std.MouseEvent>): void | undefined,   arrow :react.react.ReactNode | (active : boolean): react.react.ReactNode | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait CollapsePanelProps extends StObject {
    ...
    var arrow: js.UndefOr[Node | (js.Function1[/* active */ Boolean, Node])] = js.undefined
  ...
  object CollapsePanelProps {
    ...
    inline def apply(key: String): CollapsePanelProps = {
    ...
    extension [Self <: CollapsePanelProps](x: Self) {
      ...
      inline def setArrow(value: Node | (js.Function1[/* active */ Boolean, Node])): Self = StObject.set(x, "arrow", value.asInstanceOf[js.Any])
      
      inline def setArrowFunction1(value: /* active */ Boolean => Node): Self = StObject.set(x, "arrow", js.Any.fromFunction1(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antdMobile.anon.accordionfalseundefinedVa
    - typingsJapgolly.antdMobile.anon.accordiontrueValuePropsst
  */
  trait CollapseProps extends StObject
  object CollapseProps {
    
    inline def accordionfalseundefinedVa(): typingsJapgolly.antdMobile.anon.accordionfalseundefinedVa = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.antdMobile.anon.accordionfalseundefinedVa]
    }
    
    inline def accordiontrueValuePropsst(): typingsJapgolly.antdMobile.anon.accordiontrueValuePropsst = {
      val __obj = js.Dynamic.literal(accordion = true)
      __obj.asInstanceOf[typingsJapgolly.antdMobile.anon.accordiontrueValuePropsst]
    }
  }
  
  trait ValueProps[T] extends StObject {
    
    var activeKey: js.UndefOr[T] = js.undefined
    
    var arrow: js.UndefOr[Node | (js.Function1[/* active */ Boolean, Node])] = js.undefined
    
    var defaultActiveKey: js.UndefOr[T] = js.undefined
    
    var onChange: js.UndefOr[js.Function1[/* activeKey */ T, Unit]] = js.undefined
  }
  object ValueProps {
    
    inline def apply[T](): ValueProps[T] = {
      val __obj = js.Dynamic.literal()
    ...
    extension [Self <: ValueProps[?], T](x: Self & ValueProps[T]) {
      ...
      inline def setDefaultActiveKey(value: T): Self = StObject.set(x, "defaultActiveKey", value.asInstanceOf[js.Any])
      
      inline def setDefaultActiveKeyUndefined: Self = StObject.set(x, "defaultActiveKey", js.undefined)
      
      inline def setOnChange(value: /* activeKey */ T => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* activeKey */ T) => value(t0).runNow()))
