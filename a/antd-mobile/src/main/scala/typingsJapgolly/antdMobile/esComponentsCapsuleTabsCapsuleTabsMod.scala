...
object esComponentsCapsuleTabsCapsuleTabsMod {
  
  @JSImport("antd-mobile/es/components/capsule-tabs/capsule-tabs", "CapsuleTab")
  @js.native
  val CapsuleTab: FC[CapsuleTabProps] = js.native
  
  @JSImport("antd-mobile/es/components/capsule-tabs/capsule-tabs", "CapsuleTabs")
  @js.native
  val CapsuleTabs: FC[CapsuleTabsProps] = js.native
  ...
  trait CapsuleTabProps extends StObject {
  ...
  object CapsuleTabProps {
    
    inline def apply(): CapsuleTabProps = {
  ...
  trait CapsuleTabsProps extends StObject {
  ...
  object CapsuleTabsProps {
    
    inline def apply(): CapsuleTabsProps = {
