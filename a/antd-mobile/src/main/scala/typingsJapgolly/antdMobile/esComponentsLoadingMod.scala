...
import typingsJapgolly.antdMobile.esComponentsDotLoadingDotLoadingMod.DotLoadingProps
...
object esComponentsLoadingMod extends Shortcut {
  
  @JSImport("antd-mobile/es/components/loading", JSImport.Default)
  @js.native
  val default: NamedExoticComponent[DotLoadingProps] = js.native
  
  /* Inlined antd-mobile.antd-mobile/es/components/dot-loading.DotLoadingProps */
  trait LoadingProps extends StObject {
    ...
    var color: js.UndefOr[typingsJapgolly.antdMobile.antdMobileStrings.default | primary | white | String] = js.undefined
  ...
  object LoadingProps {
    ...
    extension [Self <: LoadingProps](x: Self) {
      ...
      inline def setColor(value: typingsJapgolly.antdMobile.antdMobileStrings.default | primary | white | String): Self = StObject.set(x, "color", value.asInstanceOf[js.Any])
  ...
  type _To = NamedExoticComponent[DotLoadingProps]
  
  /* This means you don't have to write `default`, but can instead just say `esComponentsLoadingMod.foo` */
  override def _to: NamedExoticComponent[DotLoadingProps] = default
}
