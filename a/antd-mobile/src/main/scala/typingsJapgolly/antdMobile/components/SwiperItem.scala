...
import typingsJapgolly.antdMobile.esComponentsSwiperSwiperItemMod.Props
...
object SwiperItem {
  ...
  implicit def make(companion: SwiperItem.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
