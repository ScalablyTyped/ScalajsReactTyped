...
@scala.inline
open class SharedBuilder_ListItemProps437040287 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def onClick(value: /* e */ ReactMouseEventFrom[org.scalajs.dom.Element] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: /* e */ ReactMouseEventFrom[org.scalajs.dom.Element]) => value(t0).runNow()))
  ...
  inline def prefixVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("prefix", js.Array(value*))
  
  inline def prefixVdomElement(value: VdomElement): this.type = set("prefix", value.rawElement.asInstanceOf[js.Any])
  
  inline def style(value: CSSPropertiesPartialRecorActivebackgroundcolor): this.type = set("style", value.asInstanceOf[js.Any])
