...
import typingsJapgolly.antdMobile.esComponentsEllipsisEllipsisMod.EllipsisProps
...
object Ellipsis {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def collapseText(value: String): this.type = set("collapseText", value.asInstanceOf[js.Any])
    
    inline def direction(value: start | end | middle): this.type = set("direction", value.asInstanceOf[js.Any])
    
    inline def expandText(value: String): this.type = set("expandText", value.asInstanceOf[js.Any])
    
    inline def onContentClick(value: /* e */ ReactMouseEventFrom[HTMLDivElement] => Callback): this.type = set("onContentClick", js.Any.fromFunction1((t0: /* e */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
    
    inline def rows(value: Double): this.type = set("rows", value.asInstanceOf[js.Any])
    
    inline def stopPropagationForActionButtons(value: js.Array[PropagationEvent]): this.type = set("stopPropagationForActionButtons", value.asInstanceOf[js.Any])
    
    inline def stopPropagationForActionButtonsVarargs(value: PropagationEvent*): this.type = set("stopPropagationForActionButtons", js.Array(value*))
