...
import typingsJapgolly.antdMobile.esComponentsEmptyEmptyMod.EmptyProps
...
object Empty {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def imageVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("image", js.Array(value*))
