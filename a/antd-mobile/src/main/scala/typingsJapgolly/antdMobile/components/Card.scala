...
object Card {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onBodyClick(value: /* event */ ReactMouseEventFrom[HTMLDivElement] => Callback): this.type = set("onBodyClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def onHeaderClick(value: /* event */ ReactMouseEventFrom[HTMLDivElement] => Callback): this.type = set("onHeaderClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
