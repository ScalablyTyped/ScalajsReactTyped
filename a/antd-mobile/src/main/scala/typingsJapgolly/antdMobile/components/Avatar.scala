...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecor
...
import typingsJapgolly.antdMobile.esComponentsAvatarAvatarMod.AvatarProps
...
object Avatar {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def fallbackVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("fallback", js.Array(value*))
    
    inline def fallbackVdomElement(value: VdomElement): this.type = set("fallback", value.rawElement.asInstanceOf[js.Any])
    
    inline def fit(value: contain | cover | fill | none | `scale-down`): this.type = set("fit", value.asInstanceOf[js.Any])
    
    inline def `lazy`(value: Boolean): this.type = set("lazy", value.asInstanceOf[js.Any])
    
    inline def onClick(value: /* event */ ReactMouseEventFrom[HTMLImageElement] => Callback): this.type = set("onClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLImageElement]) => value(t0).runNow()))
    ...
    inline def style(value: CSSPropertiesPartialRecor): this.type = set("style", value.asInstanceOf[js.Any])
