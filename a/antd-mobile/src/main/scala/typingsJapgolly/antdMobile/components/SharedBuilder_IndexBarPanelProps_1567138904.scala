...
@scala.inline
open class SharedBuilder_IndexBarPanelProps_1567138904 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def brief(value: VdomNode): this.type = set("brief", value.rawNode.asInstanceOf[js.Any])
  
  inline def briefNull: this.type = set("brief", null)
  
  inline def briefVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("brief", js.Array(value*))
  
  inline def briefVdomElement(value: VdomElement): this.type = set("brief", value.rawElement.asInstanceOf[js.Any])
