...
object Grid {
  ...
  inline def apply(columns: Double): Builder = {
  ...
  object Item {
    ...
    @JSImport("antd-mobile", "Grid.Item")
    @js.native
    val component: js.Object = js.native
    
    implicit def make(companion: Item.type): SharedBuilder_GridItemProps_695251492 = new SharedBuilder_GridItemProps_695251492(js.Array(this.component, js.Dictionary.empty))()
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def gap(value: Double | String | (js.Tuple2[Double | String, Double | String])): this.type = set("gap", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorAnimationTimeline): this.type = set("style", value.asInstanceOf[js.Any])
