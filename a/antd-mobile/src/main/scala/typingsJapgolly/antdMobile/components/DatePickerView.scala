...
import typingsJapgolly.antdMobile.esComponentsDatePickerViewDatePickerViewMod.DatePickerViewProps
...
object DatePickerView {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[DatePickerViewProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def filter(value: DatePickerFilter): this.type = set("filter", value.asInstanceOf[js.Any])
  ...
  def withProps(p: DatePickerViewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
