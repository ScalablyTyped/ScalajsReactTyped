...
object DefaultTabBar {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PropsType, typingsJapgolly.antdMobile.tabsMod.DefaultTabBar, Unit, PropsType] = {
  ...
  typingsJapgolly.antdMobile.tabsMod.DefaultTabBar](this.componentImport)
