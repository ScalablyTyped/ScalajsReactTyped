...
import typingsJapgolly.antdMobile.esComponentsTagTagMod.TagProps
...
object Tag {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: default | primary | success | warning | danger | String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def fill(value: solid | outline): this.type = set("fill", value.asInstanceOf[js.Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorBackgroundcolor): this.type = set("style", value.asInstanceOf[js.Any])
