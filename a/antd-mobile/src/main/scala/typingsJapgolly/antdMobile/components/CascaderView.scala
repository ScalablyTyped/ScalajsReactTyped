...
object CascaderView {
  ...
  inline def apply(options: js.Array[CascaderOption]): Builder = {
    val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[CascaderViewProps]))
  }
  
  @JSImport("antd-mobile", "CascaderView")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def activeIconVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("activeIcon", js.Array(value*))
    ...
    inline def defaultValue(value: js.Array[CascaderValue]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    
    inline def defaultValueVarargs(value: CascaderValue*): this.type = set("defaultValue", js.Array(value*))
    
    inline def onChange(value: (/* value */ js.Array[CascaderValue], /* extend */ CascaderValueExtend) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* value */ js.Array[CascaderValue], t1: /* extend */ CascaderValueExtend) => (value(t0, t1)).runNow()))
    
    inline def onTabsChange(value: /* index */ Double => Callback): this.type = set("onTabsChange", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
    
    inline def placeholder(value: String): this.type = set("placeholder", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorAlignTracks): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def value(value: js.Array[CascaderValue]): this.type = set("value", value.asInstanceOf[js.Any])
    
    inline def valueVarargs(value: CascaderValue*): this.type = set("value", js.Array(value*))
  }
  
  def withProps(p: CascaderViewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
