...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBorder
import typingsJapgolly.antdMobile.anon.MaxRows
...
import typingsJapgolly.antdMobile.esComponentsTextAreaTextAreaMod.TextAreaRef
...
object TextArea {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[TextAreaRef] {
    ...
    inline def autoSize(value: Boolean | MaxRows): this.type = set("autoSize", value.asInstanceOf[js.Any])
    ...
    inline def showCount(value: Boolean | (js.Function2[/* length */ Double, /* maxLength */ js.UndefOr[Double], Node])): this.type = set("showCount", value.asInstanceOf[js.Any])
    
    inline def showCountFunction2(value: (/* length */ Double, /* maxLength */ js.UndefOr[Double]) => Node): this.type = set("showCount", js.Any.fromFunction2(value))
    
    inline def style(value: CSSPropertiesPartialRecorBorder): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  def withProps(p: onChangevalstringvoidunde): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
