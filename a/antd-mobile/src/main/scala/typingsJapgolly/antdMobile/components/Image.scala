...
import typingsJapgolly.antdMobile.esComponentsImageImageMod.ImageProps
...
object Image {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onContainerClick(value: /* event */ ReactMouseEventFrom[HTMLDivElement] => Callback): this.type = set("onContainerClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def placeholderVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("placeholder", js.Array(value*))
    ...
    inline def style(value: CSSPropertiesPartialRecorAppearance): this.type = set("style", value.asInstanceOf[js.Any])
