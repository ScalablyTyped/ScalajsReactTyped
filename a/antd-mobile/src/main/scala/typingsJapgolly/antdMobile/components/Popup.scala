...
import typingsJapgolly.antdMobile.esComponentsPopupPopupMod.PopupProps
...
object Popup {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def position(value: bottom | top | left | right): this.type = set("position", value.asInstanceOf[js.Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorAlignmentBaseline): this.type = set("style", value.asInstanceOf[js.Any])
