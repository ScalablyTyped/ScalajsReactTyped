...
import typingsJapgolly.antdMobile.antdMobileStrings.italic
...
import typingsJapgolly.antdMobile.antdMobileStrings.oblique
...
import typingsJapgolly.antdMobile.antdMobileStrings.weight
...
object WaterMark {
  ...
  @JSImport("antd-mobile", "WaterMark")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def imageHeight(value: Double): this.type = set("imageHeight", value.asInstanceOf[js.Any])
    
    inline def imageWidth(value: Double): this.type = set("imageWidth", value.asInstanceOf[js.Any])
