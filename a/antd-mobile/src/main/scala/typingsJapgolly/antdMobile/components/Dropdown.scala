...
object Dropdown {
  ...
  object Item {
    ...
    @JSImport("antd-mobile", "Dropdown.Item")
    @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[DropdownRef] {
    ...
    inline def closeOnClickAway(value: Boolean): this.type = set("closeOnClickAway", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* key */ String | Null => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* key */ String | Null) => value(t0).runNow()))
  ...
  def withProps(p: activeKeystringnullundefi): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
