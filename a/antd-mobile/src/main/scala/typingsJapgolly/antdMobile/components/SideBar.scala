...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundOrigin
...
object SideBar {
  ...
  object Item {
    ...
    @JSImport("antd-mobile", "SideBar.Item")
    @js.native
    val component: js.Object = js.native
    
    implicit def make(companion: Item.type): SharedBuilder_SideBarItemProps_1952243687 = new SharedBuilder_SideBarItemProps_1952243687(js.Array(this.component, js.Dictionary.empty))()
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorBackgroundOrigin): this.type = set("style", value.asInstanceOf[js.Any])
