...
import typingsJapgolly.antdMobile.esComponentsPageIndicatorPageIndicatorMod.PageIndicatorProps
...
object PageIndicator {
  ...
  inline def apply(current: Double, total: Double): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PageIndicatorProps]))
  }
  
  @JSImport("antd-mobile", "PageIndicator")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: primary | white): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def direction(value: horizontal | vertical): this.type = set("direction", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorActivedotborderradius): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: PageIndicatorProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
