...
@scala.inline
open class SharedBuilder_MultipleProps686669472 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def defaultExpandKeys(value: js.Array[String]): this.type = set("defaultExpandKeys", value.asInstanceOf[js.Any])
  
  inline def defaultExpandKeysVarargs(value: String*): this.type = set("defaultExpandKeys", js.Array(value*))
  
  inline def defaultValue(value: js.Array[String]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
  
  inline def defaultValueVarargs(value: String*): this.type = set("defaultValue", js.Array(value*))
  
  inline def expandKeys(value: js.Array[String]): this.type = set("expandKeys", value.asInstanceOf[js.Any])
  
  inline def expandKeysVarargs(value: String*): this.type = set("expandKeys", js.Array(value*))
  
  inline def fieldNames(value: Label): this.type = set("fieldNames", value.asInstanceOf[js.Any])
  
  inline def onChange(value: (/* value */ js.Array[String], /* nodes */ js.Array[TreeSelectOption]) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* value */ js.Array[String], t1: /* nodes */ js.Array[TreeSelectOption]) => (value(t0, t1)).runNow()))
  
  inline def onExpand(value: (/* expandedKeys */ js.Array[String], /* nodes */ js.Array[TreeSelectOption]) => Callback): this.type = set("onExpand", js.Any.fromFunction2((t0: /* expandedKeys */ js.Array[String], t1: /* nodes */ js.Array[TreeSelectOption]) => (value(t0, t1)).runNow()))
  
  inline def selectAllText(value: js.Array[String]): this.type = set("selectAllText", value.asInstanceOf[js.Any])
  
  inline def selectAllTextVarargs(value: String*): this.type = set("selectAllText", js.Array(value*))
