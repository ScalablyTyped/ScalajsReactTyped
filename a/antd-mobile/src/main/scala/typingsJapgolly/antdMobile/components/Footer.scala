...
import typingsJapgolly.antdMobile.esComponentsFooterFooterMod.ChipItem
import typingsJapgolly.antdMobile.esComponentsFooterFooterMod.FooterProps
import typingsJapgolly.antdMobile.esComponentsFooterFooterMod.LinkItem
...
object Footer {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def chips(value: js.Array[ChipItem]): this.type = set("chips", value.asInstanceOf[js.Any])
    
    inline def chipsVarargs(value: ChipItem*): this.type = set("chips", js.Array(value*))
    ...
    inline def links(value: js.Array[LinkItem]): this.type = set("links", value.asInstanceOf[js.Any])
    
    inline def linksVarargs(value: LinkItem*): this.type = set("links", js.Array(value*))
    
    inline def onChipClick(value: (/* item */ ChipItem, /* index */ Double) => Callback): this.type = set("onChipClick", js.Any.fromFunction2((t0: /* item */ ChipItem, t1: /* index */ Double) => (value(t0, t1)).runNow()))
    
    inline def onLinkClick(value: (/* item */ LinkItem, /* index */ Double) => Callback): this.type = set("onLinkClick", js.Any.fromFunction2((t0: /* item */ LinkItem, t1: /* index */ Double) => (value(t0, t1)).runNow()))
    
    inline def style(value: CSSPropertiesPartialRecorAnimationIterationCount): this.type = set("style", value.asInstanceOf[js.Any])
