...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundClip
...
object ProgressCircle {
  ...
  @JSImport("antd-mobile", "ProgressCircle")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorBackgroundClip): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: ProgressCircle.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
