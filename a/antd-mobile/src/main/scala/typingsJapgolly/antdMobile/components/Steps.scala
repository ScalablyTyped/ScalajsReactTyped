...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundRepeat
...
import typingsJapgolly.antdMobile.esComponentsStepsStepsMod.Direction
...
object Steps {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorBackgroundRepeat): this.type = set("style", value.asInstanceOf[js.Any])
