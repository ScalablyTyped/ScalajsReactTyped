...
object TabBar {
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): SharedBuilder_TabBarItemProps1874712417 = new SharedBuilder_TabBarItemProps1874712417(js.Array(this.component, js.Dictionary.empty))()
