...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundPositionY
...
import typingsJapgolly.antdMobile.esComponentsSpinLoadingSpinLoadingMod.SpinLoadingProps
...
object SpinLoading {
  ...
  @JSImport("antd-mobile", "SpinLoading")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: default | primary | white | String): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorBackgroundPositionY): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: SpinLoading.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: SpinLoadingProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
