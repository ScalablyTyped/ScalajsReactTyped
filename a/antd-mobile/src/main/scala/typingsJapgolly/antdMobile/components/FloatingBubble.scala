...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAnimationDirection
...
import typingsJapgolly.antdMobile.antdMobileStrings.lock
...
import typingsJapgolly.antdMobile.antdMobileStrings.x
import typingsJapgolly.antdMobile.antdMobileStrings.xy
import typingsJapgolly.antdMobile.antdMobileStrings.y
import typingsJapgolly.antdMobile.esComponentsFloatingBubbleFloatingBubbleMod.FloatingBubbleProps
...
object FloatingBubble {
  ...
  @JSImport("antd-mobile", "FloatingBubble")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def axis(value: x | y | xy | lock): this.type = set("axis", value.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def magnetic(value: x | y): this.type = set("magnetic", value.asInstanceOf[js.Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorAnimationDirection): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: FloatingBubble.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: FloatingBubbleProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
