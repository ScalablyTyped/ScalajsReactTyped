...
object Popover {
  ...
  object Menu {
    ...
    @JSImport("antd-mobile", "Popover.Menu")
    @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[PopoverRef] {
    ...
    inline def mode(value: dark | light): this.type = set("mode", value.asInstanceOf[js.Any])
    ...
    inline def placement(value: DeprecatedPlacement | Placement): this.type = set("placement", value.asInstanceOf[js.Any])
  ...
  def withProps(p: defaultVisiblebooleanunde): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
