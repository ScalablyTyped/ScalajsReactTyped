...
object CapsuleTabs {
  ...
  object Tab {
    ...
    @JSImport("antd-mobile", "CapsuleTabs.Tab")
    @js.native
    val component: js.Object = js.native
    
    implicit def make(companion: Tab.type): SharedBuilder_CapsuleTabProps_1157229211 = new SharedBuilder_CapsuleTabProps_1157229211(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: CapsuleTabProps): SharedBuilder_CapsuleTabProps_1157229211 = new SharedBuilder_CapsuleTabProps_1157229211(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  @JSImport("antd-mobile", "CapsuleTabs")
  @js.native
  val component: js.Object = js.native
  ...
  implicit def make(companion: CapsuleTabs.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CapsuleTabsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
