...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAnimationDuration
...
import typingsJapgolly.antdMobile.esComponentsFloatingPanelFloatingPanelMod.FloatingPanelRef
...
object FloatingPanel {
  ...
  inline def apply(anchors: js.Array[Double]): Builder = {
    val __props = js.Dynamic.literal(anchors = anchors.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[anchorsArraynumberchildre]))
  }
  
  @JSImport("antd-mobile", "FloatingPanel")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[FloatingPanelRef] {
    ...
    inline def handleDraggingOfContent(value: Boolean): this.type = set("handleDraggingOfContent", value.asInstanceOf[js.Any])
    
    inline def onHeightChange(value: (/* height */ Double, /* animating */ Boolean) => Callback): this.type = set("onHeightChange", js.Any.fromFunction2((t0: /* height */ Double, t1: /* animating */ Boolean) => (value(t0, t1)).runNow()))
    
    inline def style(value: CSSPropertiesPartialRecorAnimationDuration): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: anchorsArraynumberchildre): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
