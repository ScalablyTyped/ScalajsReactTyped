...
import typingsJapgolly.antdMobile.esComponentsCascadePickerViewCascadePickerViewMod.CascadePickerViewProps
...
object CascadePickerView {
  
  inline def apply(options: js.Array[CascadePickerOption]): Builder = {
    val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[CascadePickerViewProps]))
  }
  
  @JSImport("antd-mobile", "CascadePickerView")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* value */ js.Array[PickerValue], t1: /* extend */ PickerValueExtend) => (value(t0, t1)).runNow()))
    
    inline def renderLabel(value: /* item */ PickerColumnItem => Node): this.type = set("renderLabel", js.Any.fromFunction1(value))
    
    inline def style(value: CSSPropertiesPartialRecorAlignItems_): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  def withProps(p: CascadePickerViewProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
