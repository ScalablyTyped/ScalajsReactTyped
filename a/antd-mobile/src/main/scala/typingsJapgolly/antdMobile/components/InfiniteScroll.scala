...
import typingsJapgolly.antdMobile.esComponentsInfiniteScrollInfiniteScrollMod.InfiniteScrollProps
...
object InfiniteScroll {
  ...
  inline def apply(hasMore: Boolean, loadMore: Boolean => js.Promise[Unit]): Builder = {
    val __props = js.Dynamic.literal(hasMore = hasMore.asInstanceOf[js.Any], loadMore = js.Any.fromFunction1(loadMore))
    new Builder(js.Array(this.component, __props.asInstanceOf[InfiniteScrollProps]))
  }
  
  @JSImport("antd-mobile", "InfiniteScroll")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def children(
      value: Node | (js.Function3[/* hasMore */ Boolean, /* failed */ Boolean, /* retry */ js.Function0[Unit], Node])
    ): this.type = set("children", value.asInstanceOf[js.Any])
    
    inline def childrenFunction3(value: (/* hasMore */ Boolean, /* failed */ Boolean, /* retry */ js.Function0[Unit]) => Node): this.type = set("children", js.Any.fromFunction3(value))
