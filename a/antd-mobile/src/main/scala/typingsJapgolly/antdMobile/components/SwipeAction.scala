...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundSize
import typingsJapgolly.antdMobile.anon.rightActionsArrayActionun
...
import typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.Action
...
object SwipeAction {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[SwipeActionRef] {
    ...
    inline def closeOnAction(value: Boolean): this.type = set("closeOnAction", value.asInstanceOf[js.Any])
    
    inline def closeOnTouchOutside(value: Boolean): this.type = set("closeOnTouchOutside", value.asInstanceOf[js.Any])
    
    inline def leftActions(value: js.Array[Action]): this.type = set("leftActions", value.asInstanceOf[js.Any])
    
    inline def leftActionsVarargs(value: Action*): this.type = set("leftActions", js.Array(value*))
    
    inline def onAction(value: (/* action */ Action, /* e */ ReactMouseEventFrom[Element]) => Callback): this.type = set("onAction", js.Any.fromFunction2((t0: /* action */ Action, t1: /* e */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
    
    inline def onActionsReveal(value: /* side */ left | right => Callback): this.type = set("onActionsReveal", js.Any.fromFunction1((t0: /* side */ left | right) => value(t0).runNow()))
    
    inline def rightActions(value: js.Array[Action]): this.type = set("rightActions", value.asInstanceOf[js.Any])
    
    inline def rightActionsVarargs(value: Action*): this.type = set("rightActions", js.Array(value*))
    
    inline def stopPropagation(value: js.Array[click]): this.type = set("stopPropagation", value.asInstanceOf[js.Any])
    
    inline def stopPropagationVarargs(value: click*): this.type = set("stopPropagation", js.Array(value*))
    
    inline def style(value: CSSPropertiesPartialRecorBackgroundSize): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  def withProps(p: rightActionsArrayActionun): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
