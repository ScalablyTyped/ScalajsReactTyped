...
@scala.inline
open class SharedBuilder_TabBarItemProps1874712417 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def badge(value: Node | Element): this.type = set("badge", value.asInstanceOf[js.Any])
  
  inline def badgeNull: this.type = set("badge", null)
  
  inline def badgeVarargs(
    value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
  ): this.type = set("badge", js.Array(value*))
  
  inline def badgeVdomElement(value: VdomElement): this.type = set("badge", value.rawElement.asInstanceOf[js.Any])
  
  inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
  
  inline def icon(value: Node | (js.Function1[/* active */ Boolean, Node])): this.type = set("icon", value.asInstanceOf[js.Any])
  
  inline def iconFunction1(value: /* active */ Boolean => Node): this.type = set("icon", js.Any.fromFunction1(value))
  ...
  inline def title(value: Node | (js.Function1[/* active */ Boolean, Node])): this.type = set("title", value.asInstanceOf[js.Any])
  
  inline def titleFunction1(value: /* active */ Boolean => Node): this.type = set("title", js.Any.fromFunction1(value))
