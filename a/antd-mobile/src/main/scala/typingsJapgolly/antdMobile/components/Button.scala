...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAlignContent
import typingsJapgolly.antdMobile.anon.colordefaultprimarysucces
...
object Button {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[ButtonRef] {
    ...
    inline def color(value: default | primary | success | warning | danger): this.type = set("color", value.asInstanceOf[js.Any])
    
    inline def disabled(value: Boolean): this.type = set("disabled", value.asInstanceOf[js.Any])
    
    inline def fill(value: none | solid | outline): this.type = set("fill", value.asInstanceOf[js.Any])
    
    inline def loading(value: Boolean | auto): this.type = set("loading", value.asInstanceOf[js.Any])
    ...
    inline def loadingIconVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("loadingIcon", js.Array(value*))
    ...
    inline def onClick(value: /* event */ ReactMouseEventFrom[HTMLButtonElement] => Unit | js.Promise[Unit] | Any): this.type = set("onClick", js.Any.fromFunction1(value))
    ...
    inline def shape(value: default | rounded | rectangular): this.type = set("shape", value.asInstanceOf[js.Any])
    
    inline def size(value: small | large | middle | mini): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorAlignContent): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def `type`(value: reset | submit | button): this.type = set("type", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: Button.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: colordefaultprimarysucces): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
