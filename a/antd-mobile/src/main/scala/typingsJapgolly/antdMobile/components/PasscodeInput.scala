...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundAttachment
import typingsJapgolly.antdMobile.anon.valuestringundefineddefauAriaactivedescendant
...
import typingsJapgolly.antdMobile.esComponentsPasscodeInputPasscodeInputMod.PasscodeInputRef
import typingsJapgolly.react.mod.Booleanish
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object PasscodeInput {
  
  @JSImport("antd-mobile", "PasscodeInput")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[PasscodeInputRef] {
    ...
    inline def caret(value: Boolean): this.type = set("caret", value.asInstanceOf[js.Any])
    ...
    inline def keyboard(value: VdomElement): this.type = set("keyboard", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onFill(value: /* val */ String => Callback): this.type = set("onFill", js.Any.fromFunction1((t0: /* val */ String) => value(t0).runNow()))
    ...
    inline def seperated(value: Boolean): this.type = set("seperated", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorBackgroundAttachment): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: PasscodeInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: valuestringundefineddefauAriaactivedescendant): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
