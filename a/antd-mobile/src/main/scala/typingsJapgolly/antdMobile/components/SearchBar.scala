...
object SearchBar {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def clearOnCancel(value: Boolean): this.type = set("clearOnCancel", value.asInstanceOf[js.Any])
    ...
    inline def onSearch(value: /* val */ String => Callback): this.type = set("onSearch", js.Any.fromFunction1((t0: /* val */ String) => value(t0).runNow()))
    ...
    inline def showCancelButton(value: Boolean | (js.Function2[/* focus */ Boolean, /* value */ String, Boolean])): this.type = set("showCancelButton", value.asInstanceOf[js.Any])
    
    inline def showCancelButtonFunction2(value: (/* focus */ Boolean, /* value */ String) => Boolean): this.type = set("showCancelButton", js.Any.fromFunction2(value))
    
    inline def style(value: CSSPropertiesPartialRecorBackgroundColor_): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  def withProps(p: valuestringundefineddefauAriaatomic): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
