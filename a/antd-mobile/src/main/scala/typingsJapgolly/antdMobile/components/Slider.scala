...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundPositionX
...
import typingsJapgolly.antdMobile.esComponentsSliderSliderMod.SliderValue
...
object Slider {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def defaultValue(value: SliderValue): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    ...
    inline def onAfterChange(value: /* value */ SliderValue => Callback): this.type = set("onAfterChange", js.Any.fromFunction1((t0: /* value */ SliderValue) => value(t0).runNow()))
    
    inline def onChange(value: /* value */ SliderValue => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* value */ SliderValue) => value(t0).runNow()))
    
    inline def popover(value: Boolean | (js.Function1[/* value */ Double, Node])): this.type = set("popover", value.asInstanceOf[js.Any])
    
    inline def popoverFunction1(value: /* value */ Double => Node): this.type = set("popover", js.Any.fromFunction1(value))
    
    inline def range(value: Boolean): this.type = set("range", value.asInstanceOf[js.Any])
    
    inline def residentPopover(value: Boolean): this.type = set("residentPopover", value.asInstanceOf[js.Any])
    
    inline def step(value: Double): this.type = set("step", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorBackgroundPositionX): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def ticks(value: Boolean): this.type = set("ticks", value.asInstanceOf[js.Any])
    
    inline def value(value: SliderValue): this.type = set("value", value.asInstanceOf[js.Any])
  }
