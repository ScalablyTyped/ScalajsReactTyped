...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBaselineShift
import typingsJapgolly.antdMobile.anon.PickPageIndicatorPropssty
import typingsJapgolly.antdMobile.anon.defaultIndexnumberundefin
import typingsJapgolly.antdMobile.anon.onClickeMouseEventHTMLDiv
...
import typingsJapgolly.antdMobile.esComponentsSwiperSwiperMod.SwiperRef
...
object Swiper {
  ...
  object Item {
    ...
    @JSImport("antd-mobile", "Swiper.Item")
    @js.native
    ...
    implicit def make(companion: Item.type): typingsJapgolly.antdMobile.components.Swiper.Item.Builder = new typingsJapgolly.antdMobile.components.Swiper.Item.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: onClickeMouseEventHTMLDiv): typingsJapgolly.antdMobile.components.Swiper.Item.Builder = new typingsJapgolly.antdMobile.components.Swiper.Item.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  @JSImport("antd-mobile", "Swiper")
  @js.native
  val component: js.Object = js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[SwiperRef] {
    ...
    inline def indicator(value: (/* total */ Double, /* current */ Double) => Node): this.type = set("indicator", js.Any.fromFunction2(value))
    
    inline def indicatorProps(value: PickPageIndicatorPropssty): this.type = set("indicatorProps", value.asInstanceOf[js.Any])
    ...
    inline def rubberband(value: Boolean): this.type = set("rubberband", value.asInstanceOf[js.Any])
    
    inline def slideSize(value: Double): this.type = set("slideSize", value.asInstanceOf[js.Any])
    
    inline def stuckAtBoundary(value: Boolean): this.type = set("stuckAtBoundary", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorBaselineShift): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def trackOffset(value: Double): this.type = set("trackOffset", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: Swiper.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: defaultIndexnumberundefin): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
