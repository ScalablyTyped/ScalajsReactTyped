...
import typingsJapgolly.antdMobile.esComponentsActionSheetActionSheetMod.Action
...
object ActionSheet {
  ...
  inline def apply(actions: js.Array[Action]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onAction(value: (/* action */ Action, /* index */ Double) => Callback): this.type = set("onAction", js.Any.fromFunction2((t0: /* action */ Action, t1: /* index */ Double) => (value(t0, t1)).runNow()))
    
    inline def onClose(value: Callback): this.type = set("onClose", value.toJsFn)
    
    inline def onMaskClick(value: Callback): this.type = set("onMaskClick", value.toJsFn)
    ...
    inline def safeArea(value: Boolean): this.type = set("safeArea", value.asInstanceOf[js.Any])
