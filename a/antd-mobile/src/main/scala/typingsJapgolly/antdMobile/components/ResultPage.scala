...
object ResultPage {
  ...
  object Card {
    ...
    @JSImport("antd-mobile", "ResultPage.Card")
    @js.native
    val component: js.Object = js.native
    
    implicit def make(companion: Card.type): SharedBuilder_ResultPageCardProps1639552688 = new SharedBuilder_ResultPageCardProps1639552688(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: ResultPageCardProps): SharedBuilder_ResultPageCardProps1639552688 = new SharedBuilder_ResultPageCardProps1639552688(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  @JSImport("antd-mobile", "ResultPage")
  @js.native
  val component: js.Object = js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def details(value: ResultPageDetails): this.type = set("details", value.asInstanceOf[js.Any])
    
    inline def detailsVarargs(value: ResultPageDetail*): this.type = set("details", js.Array(value*))
    ...
    inline def onPrimaryButtonClick(value: /* event */ ReactMouseEventFrom[HTMLButtonElement] => Unit | js.Promise[Unit] | Any): this.type = set("onPrimaryButtonClick", js.Any.fromFunction1(value))
    
    inline def onSecondaryButtonClick(value: /* event */ ReactMouseEventFrom[HTMLButtonElement] => Unit | js.Promise[Unit] | Any): this.type = set("onSecondaryButtonClick", js.Any.fromFunction1(value))
    ...
    inline def primaryButtonTextVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("primaryButtonText", js.Array(value*))
    ...
    inline def secondaryButtonTextVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("secondaryButtonText", js.Array(value*))
    ...
    inline def status(value: success | error | info | waiting | warning): this.type = set("status", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ResultPage.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ResultPageProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
