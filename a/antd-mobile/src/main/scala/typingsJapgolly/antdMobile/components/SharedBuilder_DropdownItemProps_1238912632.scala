...
@scala.inline
open class SharedBuilder_DropdownItemProps_1238912632 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def arrow(value: VdomNode): this.type = set("arrow", value.rawNode.asInstanceOf[js.Any])
