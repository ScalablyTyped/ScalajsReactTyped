...
import typingsJapgolly.antdMobile.esComponentsDividerDividerMod.DividerProps
...
object Divider {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def contentPosition(value: left | right | center): this.type = set("contentPosition", value.asInstanceOf[js.Any])
