...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBlockSize
...
object Switch {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def beforeChange(value: /* val */ Boolean => js.Promise[Unit]): this.type = set("beforeChange", js.Any.fromFunction1(value))
    
    inline def checked(value: Boolean): this.type = set("checked", value.asInstanceOf[js.Any])
    
    inline def checkedText(value: VdomNode): this.type = set("checkedText", value.rawNode.asInstanceOf[js.Any])
    
    inline def checkedTextNull: this.type = set("checkedText", null)
    
    inline def checkedTextVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("checkedText", js.Array(value*))
    
    inline def checkedTextVdomElement(value: VdomElement): this.type = set("checkedText", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* checked */ Boolean => Unit | js.Promise[Unit]): this.type = set("onChange", js.Any.fromFunction1(value))
    
    inline def style(value: CSSPropertiesPartialRecorBlockSize): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def uncheckedText(value: VdomNode): this.type = set("uncheckedText", value.rawNode.asInstanceOf[js.Any])
    
    inline def uncheckedTextNull: this.type = set("uncheckedText", null)
    
    inline def uncheckedTextVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("uncheckedText", js.Array(value*))
    
    inline def uncheckedTextVdomElement(value: VdomElement): this.type = set("uncheckedText", value.rawElement.asInstanceOf[js.Any])
  }
