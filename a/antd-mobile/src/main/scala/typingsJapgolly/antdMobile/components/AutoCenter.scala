...
object AutoCenter {
  ...
  @JSImport("antd-mobile", "AutoCenter")
  @js.native
  ...
  implicit def make(companion: AutoCenter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: AutoCenterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
