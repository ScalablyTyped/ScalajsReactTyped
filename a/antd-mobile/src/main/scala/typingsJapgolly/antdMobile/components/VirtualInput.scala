...
object VirtualInput {
  ...
  @JSImport("antd-mobile", "VirtualInput")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[VirtualInputRef] {
    ...
    inline def style(value: CSSPropertiesPartialRecorBorderBlock): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: VirtualInput.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: onFocusvoidundefinedonBlu): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
