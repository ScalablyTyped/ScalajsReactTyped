...
object CheckList {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[CheckListProps]))
  }
  ...
  object Item {
    ...
    @JSImport("antd-mobile", "CheckList.Item")
    @js.native
  ...
  @JSImport("antd-mobile", "CheckList")
  @js.native
  val component: js.Object = js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def onChange(value: /* val */ js.Array[String] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* val */ js.Array[String]) => value(t0).runNow()))
  ...
  def withProps(p: CheckListProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
