...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAnimation
import typingsJapgolly.antdMobile.anon.checkedbooleanundefinedde
...
import typingsJapgolly.antdMobile.esComponentsCheckboxGroupMod.CheckboxGroupProps
...
object Checkbox {
  ...
  object Group {
    ...
    @JSImport("antd-mobile", "Checkbox.Group")
    @js.native
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def defaultValue(value: js.Array[CheckboxValue]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
      
      inline def defaultValueVarargs(value: CheckboxValue*): this.type = set("defaultValue", js.Array(value*))
      
      inline def disabled(value: Boolean): this.type = set("disabled", value.asInstanceOf[js.Any])
      
      inline def onChange(value: /* val */ js.Array[CheckboxValue] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* val */ js.Array[CheckboxValue]) => value(t0).runNow()))
      
      inline def value(value: js.Array[CheckboxValue]): this.type = set("value", value.asInstanceOf[js.Any])
      
      inline def valueVarargs(value: CheckboxValue*): this.type = set("value", js.Array(value*))
    }
    
    implicit def make(companion: Group.type): typingsJapgolly.antdMobile.components.Checkbox.Group.Builder = new typingsJapgolly.antdMobile.components.Checkbox.Group.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: CheckboxGroupProps): typingsJapgolly.antdMobile.components.Checkbox.Group.Builder = new typingsJapgolly.antdMobile.components.Checkbox.Group.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[CheckboxRef] {
    ...
    inline def icon(value: (/* checked */ Boolean, /* indeterminate */ Boolean) => Node): this.type = set("icon", js.Any.fromFunction2(value))
    ...
    inline def style(value: CSSPropertiesPartialRecorAnimation): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def value(value: CheckboxValue): this.type = set("value", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: Checkbox.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: checkedbooleanundefinedde): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
