...
import typingsJapgolly.antdMobile.antdMobileStrings.evenly
...
import typingsJapgolly.antdMobile.esComponentsSpaceSpaceMod.SpaceProps
...
object Space {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def justify(value: start | end | center | between | around | evenly | stretch): this.type = set("justify", value.asInstanceOf[js.Any])
