...
object List {
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): SharedBuilder_ListItemProps437040287 = new SharedBuilder_ListItemProps437040287(js.Array(this.component, js.Dictionary.empty))()
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorAlignitems): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  def withProps(p: headerReactNodeundefinedm): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
