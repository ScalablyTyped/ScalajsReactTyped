...
import typingsJapgolly.antdMobile.indexedMod.MIndexedListProps
import typingsJapgolly.antdMobile.indexedMod.default
...
object Indexed {
  def apply(
    ...
    delayActivityIndicator: VdomNode = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[MIndexedListProps, default, Unit, MIndexedListProps] = {
    ...
    if (delayActivityIndicator != null) __obj.updateDynamic("delayActivityIndicator")(delayActivityIndicator.rawNode.asInstanceOf[js.Any])
  ...
  typingsJapgolly.antdMobile.indexedMod.MIndexedListProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antdMobile.indexedMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antdMobile.indexedMod.MIndexedListProps])(children: _*)
  }
