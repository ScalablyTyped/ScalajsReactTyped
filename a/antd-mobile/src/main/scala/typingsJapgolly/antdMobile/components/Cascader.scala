...
import typingsJapgolly.antdMobile.anon.optionsArrayCascaderOptioActiveIcon
...
object Cascader {
  ...
  inline def apply(options: js.Array[CascaderOption]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[optionsArrayCascaderOptioActiveIcon]))
  }
  
  @JSImport("antd-mobile", "Cascader")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[CascaderActions] {
    ...
    inline def children(value: (/* items */ js.Array[CascaderOption | Null], /* actions */ CascaderActions) => Node): this.type = set("children", js.Any.fromFunction2(value))
    ...
    inline def onConfirm(value: (/* value */ js.Array[String], /* extend */ CascaderValueExtend) => Callback): this.type = set("onConfirm", js.Any.fromFunction2((t0: /* value */ js.Array[String], t1: /* extend */ CascaderValueExtend) => (value(t0, t1)).runNow()))
    
    inline def onSelect(value: (/* value */ js.Array[String], /* extend */ CascaderValueExtend) => Callback): this.type = set("onSelect", js.Any.fromFunction2((t0: /* value */ js.Array[String], t1: /* extend */ CascaderValueExtend) => (value(t0, t1)).runNow()))
  ...
  def withProps(p: optionsArrayCascaderOptioActiveIcon): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
