...
import typingsJapgolly.antdMobile.esComponentsSliderThumbMod.ThumbProps
...
object Thumb {
  ...
  def withProps(p: ThumbProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
