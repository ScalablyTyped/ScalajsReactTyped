...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAnimationDelay
...
object ErrorBlock {
  ...
  @JSImport("antd-mobile", "ErrorBlock")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def fullPage(value: Boolean): this.type = set("fullPage", value.asInstanceOf[js.Any])
    
    inline def image(value: String | Element): this.type = set("image", value.asInstanceOf[js.Any])
    
    inline def imageVdomElement(value: VdomElement): this.type = set("image", value.rawElement.asInstanceOf[js.Any])
    
    inline def status(value: ErrorBlockStatus): this.type = set("status", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorAnimationDelay): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: ErrorBlock.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ErrorBlockProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
