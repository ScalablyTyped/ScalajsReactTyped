...
import typingsJapgolly.antdMobile.inputItemMod.InputItemProps
import typingsJapgolly.antdMobile.inputItemMod.default
...
object InputItem {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputItemProps, default, Unit, InputItemProps] = {
  ...
  typingsJapgolly.antdMobile.inputItemMod.InputItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antdMobile.inputItemMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antdMobile.inputItemMod.InputItemProps])(children: _*)
  }
