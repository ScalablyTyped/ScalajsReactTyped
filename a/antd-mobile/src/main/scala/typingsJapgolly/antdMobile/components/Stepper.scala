...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorActiveborder
...
object Stepper {
  ...
  object ValuePropsPickInputPropso {
    ...
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(allowEmpty = true)
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.antdMobile.anon.ValuePropsPickInputPropso]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def onChange(value: /* value */ Double | Null => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* value */ Double | Null) => value(t0).runNow()))
      ...
      inline def style(value: CSSPropertiesPartialRecorActiveborder): this.type = set("style", value.asInstanceOf[js.Any])
    ...
    def withProps(p: typingsJapgolly.antdMobile.anon.ValuePropsPickInputPropso): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  object ValuePropsWithNullPickInp {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def allowEmpty(value: `false`): this.type = set("allowEmpty", value.asInstanceOf[js.Any])
    ...
    implicit def make(companion: ValuePropsWithNullPickInp.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.antdMobile.anon.ValuePropsWithNullPickInp): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
