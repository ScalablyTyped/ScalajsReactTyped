...
object ThumbIcon {
  ...
  @JSImport("antd-mobile/es/components/slider/thumb-icon", "ThumbIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: ThumbIcon.type): SharedBuilder_NativeProps_2075513324 = new SharedBuilder_NativeProps_2075513324(js.Array(this.component, js.Dictionary.empty))()
