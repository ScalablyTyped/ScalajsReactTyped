...
import typingsJapgolly.antdMobile.esComponentsNumberKeyboardNumberKeyboardMod.NumberKeyboardProps
...
object NumberKeyboard {
  ...
  @JSImport("antd-mobile", "NumberKeyboard")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def closeOnConfirm(value: Boolean): this.type = set("closeOnConfirm", value.asInstanceOf[js.Any])
    ...
    inline def customKey(value: String | (js.Tuple2[String, String])): this.type = set("customKey", value.asInstanceOf[js.Any])
    ...
    inline def onConfirm(value: Callback): this.type = set("onConfirm", value.toJsFn)
    
    inline def onDelete(value: Callback): this.type = set("onDelete", value.toJsFn)
    
    inline def onInput(value: /* v */ String => Callback): this.type = set("onInput", js.Any.fromFunction1((t0: /* v */ String) => value(t0).runNow()))
    
    inline def randomOrder(value: Boolean): this.type = set("randomOrder", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: NumberKeyboard.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: NumberKeyboardProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
