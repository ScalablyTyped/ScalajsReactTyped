...
object JumboTabs {
  ...
  object Tab {
    ...
    @JSImport("antd-mobile", "JumboTabs.Tab")
    @js.native
    val component: js.Object = js.native
    
    implicit def make(companion: Tab.type): SharedBuilder_JumboTabProps1213141145 = new SharedBuilder_JumboTabProps1213141145(js.Array(this.component, js.Dictionary.empty))()
  ...
  @JSImport("antd-mobile", "JumboTabs")
  @js.native
  val component: js.Object = js.native
  ...
  implicit def make(companion: JumboTabs.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: JumboTabsProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
