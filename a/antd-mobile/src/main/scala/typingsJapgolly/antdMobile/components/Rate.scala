...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorActivecolor
...
import typingsJapgolly.antdMobile.esComponentsRateRateMod.RateProps
...
object Rate {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def character(value: VdomNode): this.type = set("character", value.rawNode.asInstanceOf[js.Any])
    
    inline def characterNull: this.type = set("character", null)
    
    inline def characterVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("character", js.Array(value*))
    ...
    inline def style(value: CSSPropertiesPartialRecorActivecolor): this.type = set("style", value.asInstanceOf[js.Any])
