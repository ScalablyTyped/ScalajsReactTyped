...
object Collapse {
  ...
  object accordionfalseundefinedVa {
    
    object Panel {
      
      @JSImport("antd-mobile", "Collapse.Panel")
      @js.native
      val component: js.Object = js.native
      
      implicit def make(companion: Panel.type): SharedBuilder_CollapsePanelProps_2073041382 = new SharedBuilder_CollapsePanelProps_2073041382(js.Array(this.component, js.Dictionary.empty))()
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def accordion(value: `false`): this.type = set("accordion", value.asInstanceOf[js.Any])
      
      inline def activeKey(value: js.Array[String]): this.type = set("activeKey", value.asInstanceOf[js.Any])
      ...
      inline def arrow(value: Node | (js.Function1[/* active */ Boolean, Node])): this.type = set("arrow", value.asInstanceOf[js.Any])
      
      inline def arrowFunction1(value: /* active */ Boolean => Node): this.type = set("arrow", js.Any.fromFunction1(value))
      ...
      inline def defaultActiveKey(value: js.Array[String]): this.type = set("defaultActiveKey", value.asInstanceOf[js.Any])
      
      inline def defaultActiveKeyVarargs(value: String*): this.type = set("defaultActiveKey", js.Array(value*))
      
      inline def onChange(value: /* activeKey */ js.Array[String] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* activeKey */ js.Array[String]) => value(t0).runNow()))
    ...
    implicit def make(companion: accordionfalseundefinedVa.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: typingsJapgolly.antdMobile.anon.accordionfalseundefinedVa): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object accordiontrueValuePropsst {
    
    inline def apply(): Builder = {
      val __props = js.Dynamic.literal(accordion = true)
      new Builder(js.Array(this.component, __props.asInstanceOf[typingsJapgolly.antdMobile.anon.accordiontrueValuePropsst]))
    }
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def onChange(value: /* activeKey */ String | Null => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* activeKey */ String | Null) => value(t0).runNow()))
    ...
    def withProps(p: typingsJapgolly.antdMobile.anon.accordiontrueValuePropsst): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
}
