...
@scala.inline
open class SharedBuilder_SkeletonParagraphProps_1088283518 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def lineCount(value: Double): this.type = set("lineCount", value.asInstanceOf[js.Any])
