...
@scala.inline
open class SharedBuilder_OmitPopoverPropscontentac362473843[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def destroyOnHide(value: Boolean): this.type = set("destroyOnHide", value.asInstanceOf[js.Any])
  ...
  inline def mode(value: light | dark): this.type = set("mode", value.asInstanceOf[js.Any])
  
  inline def onAction(value: /* item */ Action => Callback): this.type = set("onAction", js.Any.fromFunction1((t0: /* item */ Action) => value(t0).runNow()))
  ...
  inline def placement(value: Placement | DeprecatedPlacement): this.type = set("placement", value.asInstanceOf[js.Any])
  ...
  inline def trigger(value: click): this.type = set("trigger", value.asInstanceOf[js.Any])
