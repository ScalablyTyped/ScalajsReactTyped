...
object Mask {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: black | white): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def opacity(value: default | thin | thick | Double): this.type = set("opacity", value.asInstanceOf[js.Any])
