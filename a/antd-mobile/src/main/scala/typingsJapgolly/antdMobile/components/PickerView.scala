...
import typingsJapgolly.antdMobile.esComponentsPickerViewPickerViewMod.PickerViewProps
...
object PickerView {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PickerViewProps]))
  }
