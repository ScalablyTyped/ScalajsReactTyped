...
import typingsJapgolly.antdMobile.esComponentsCascadePickerCascadePickerMod.CascadePickerOption
...
object CascadePicker {
  
  inline def apply(options: js.Array[CascadePickerOption]): Builder = {
    val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[OmitPickerPropscolumnsopt]))
  }
  
  @JSImport("antd-mobile", "CascadePicker")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def children(value: (/* items */ js.Array[PickerColumnItem | Null], /* actions */ PickerActions) => Node): this.type = set("children", js.Any.fromFunction2(value))
    ...
    inline def defaultValue(value: js.Array[PickerValue]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    
    inline def defaultValueVarargs(value: PickerValue*): this.type = set("defaultValue", js.Array(value*))
    ...
    inline def onConfirm(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Callback): this.type = set("onConfirm", js.Any.fromFunction2((t0: /* value */ js.Array[PickerValue], t1: /* extend */ PickerValueExtend) => (value(t0, t1)).runNow()))
    
    inline def onSelect(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Callback): this.type = set("onSelect", js.Any.fromFunction2((t0: /* value */ js.Array[PickerValue], t1: /* extend */ PickerValueExtend) => (value(t0, t1)).runNow()))
    ...
    inline def renderLabel(value: /* item */ PickerColumnItem => Node): this.type = set("renderLabel", js.Any.fromFunction1(value))
    ...
    inline def style(value: CSSPropertiesPartialRecorAlignSelf): this.type = set("style", value.asInstanceOf[js.Any])
    ...
    inline def value(value: js.Array[PickerValue]): this.type = set("value", value.asInstanceOf[js.Any])
    
    inline def valueVarargs(value: PickerValue*): this.type = set("value", js.Array(value*))
    
    inline def visible(value: Boolean): this.type = set("visible", value.asInstanceOf[js.Any])
  }
  
  def withProps(p: OmitPickerPropscolumnsopt): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
