...
object IndexBar {
  ...
  object Panel {
    ...
    @JSImport("antd-mobile", "IndexBar.Panel")
    @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[IndexBarRef] {
    ...
    inline def onIndexChange(value: /* index */ String => Callback): this.type = set("onIndexChange", js.Any.fromFunction1((t0: /* index */ String) => value(t0).runNow()))
    
    inline def sticky(value: Boolean): this.type = set("sticky", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorAspectRatio): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: IndexBar.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: stickybooleanundefinedonI): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
