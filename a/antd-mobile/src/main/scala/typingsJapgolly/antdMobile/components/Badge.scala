...
object Badge {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def content(value: Node | Element): this.type = set("content", value.asInstanceOf[js.Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorAccentColor): this.type = set("style", value.asInstanceOf[js.Any])
