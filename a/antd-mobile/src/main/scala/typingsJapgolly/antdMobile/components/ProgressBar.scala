...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundBlendMode
...
object ProgressBar {
  ...
  @JSImport("antd-mobile", "ProgressBar")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorBackgroundBlendMode): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def text(value: Boolean | Node | (js.Function1[/* percent */ Double, Node])): this.type = set("text", value.asInstanceOf[js.Any])
    
    inline def textFunction1(value: /* percent */ Double => Node): this.type = set("text", js.Any.fromFunction1(value))
    
    inline def textNull: this.type = set("text", null)
    
    inline def textVarargs(value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | Element)*): this.type = set("text", js.Array(value*))
