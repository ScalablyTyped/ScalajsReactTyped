...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundImage
import typingsJapgolly.antdMobile.anon.Items
...
import typingsJapgolly.antdMobile.esComponentsSelectorSelectorMod.SelectorOption
...
object Selector {
  ...
  inline def apply[V /* <: SelectorValue */](options: js.Array[SelectorOption[V]]): Builder[V] = {
    val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    new Builder[V](js.Array(this.component, __props.asInstanceOf[SelectorProps[V]]))
  }
  
  @JSImport("antd-mobile", "Selector")
  @js.native
  val component: js.Object = js.native
  
  @scala.inline
  open class Builder[V /* <: SelectorValue */] (val args: js.Array[Any])
    extends AnyVal
    ...
    inline def defaultValue(value: js.Array[V]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    
    inline def defaultValueVarargs(value: V*): this.type = set("defaultValue", js.Array(value*))
    
    inline def disabled(value: Boolean): this.type = set("disabled", value.asInstanceOf[js.Any])
    
    inline def multiple(value: Boolean): this.type = set("multiple", value.asInstanceOf[js.Any])
    
    inline def onChange(value: (/* v */ js.Array[V], /* extend */ Items[V]) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* v */ js.Array[V], t1: /* extend */ Items[V]) => (value(t0, t1)).runNow()))
    
    inline def showCheckMark(value: Boolean): this.type = set("showCheckMark", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorBackgroundImage): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def value(value: js.Array[V]): this.type = set("value", value.asInstanceOf[js.Any])
    
    inline def valueVarargs(value: V*): this.type = set("value", js.Array(value*))
  }
  
  def withProps[V /* <: SelectorValue */](p: SelectorProps[V]): Builder[V] = new Builder[V](js.Array(this.component, p.asInstanceOf[js.Any]))
}
