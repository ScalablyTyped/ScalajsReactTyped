...
object TreeSelect {
  ...
  inline def apply(options: js.Array[TreeSelectOption]): Builder = {
    val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TreeSelectProps]))
  }
  ...
  object Multiple {
    ...
    @JSImport("antd-mobile", "TreeSelect.Multiple")
    @js.native
  ...
  @JSImport("antd-mobile", "TreeSelect")
  @js.native
  val component: js.Object = js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def fieldNames(value: Label): this.type = set("fieldNames", value.asInstanceOf[js.Any])
    
    inline def onChange(value: (/* value */ js.Array[String], /* extend */ Options) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* value */ js.Array[String], t1: /* extend */ Options) => (value(t0, t1)).runNow()))
