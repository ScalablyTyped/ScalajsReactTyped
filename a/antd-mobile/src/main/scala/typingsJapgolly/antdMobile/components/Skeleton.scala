...
object Skeleton {
  ...
  object Paragraph {
    ...
    @JSImport("antd-mobile", "Skeleton.Paragraph")
    @js.native
    val component: js.Object = js.native
    
    implicit def make(companion: Paragraph.type): SharedBuilder_SkeletonParagraphProps_1088283518 = new SharedBuilder_SkeletonParagraphProps_1088283518(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: SkeletonParagraphProps): SharedBuilder_SkeletonParagraphProps_1088283518 = new SharedBuilder_SkeletonParagraphProps_1088283518(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  
  object Title {
    
    @JSImport("antd-mobile", "Skeleton.Title")
    @js.native
    val component: js.Object = js.native
    
    implicit def make(companion: Title.type): SharedBuilder_SkeletonTitleProps_1963586210 = new SharedBuilder_SkeletonTitleProps_1963586210(js.Array(this.component, js.Dictionary.empty))()
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def style(value: CSSPropertiesPartialRecorBackgroundPosition): this.type = set("style", value.asInstanceOf[js.Any])
