...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAnimationComposition
...
object Radio {
  ...
  object Group {
    ...
    @JSImport("antd-mobile", "Radio.Group")
    @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def icon(value: /* checked */ Boolean => Node): this.type = set("icon", js.Any.fromFunction1(value))
    ...
    inline def style(value: CSSPropertiesPartialRecorAnimationComposition): this.type = set("style", value.asInstanceOf[js.Any])
