...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAll
...
import typingsJapgolly.antdMobile.esComponentsCenterPopupCenterPopupMod.CenterPopupProps
...
object CenterPopup {
  ...
  @JSImport("antd-mobile", "CenterPopup")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def disableBodyScroll(value: Boolean): this.type = set("disableBodyScroll", value.asInstanceOf[js.Any])
    ...
    inline def onMaskClick(value: /* event */ ReactMouseEventFrom[HTMLDivElement] => Callback): this.type = set("onMaskClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
    ...
    inline def style(value: CSSPropertiesPartialRecorAll): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  implicit def make(companion: CenterPopup.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CenterPopupProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
