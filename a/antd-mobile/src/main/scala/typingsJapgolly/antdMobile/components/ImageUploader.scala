...
import typingsJapgolly.antdMobile.esComponentsImageUploaderImageUploaderMod.ImageUploadItem
import typingsJapgolly.antdMobile.esComponentsImageUploaderImageUploaderMod.ImageUploaderProps
import typingsJapgolly.antdMobile.esComponentsImageUploaderImageUploaderMod.UploadTask
...
object ImageUploader {
  ...
  inline def apply(upload: File => js.Promise[ImageUploadItem]): Builder = {
    val __props = js.Dynamic.literal(upload = js.Any.fromFunction1(upload))
    new Builder(js.Array(this.component, __props.asInstanceOf[ImageUploaderProps]))
  }
  
  @JSImport("antd-mobile", "ImageUploader")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def beforeUpload(value: (/* file */ File, /* files */ js.Array[File]) => (js.Promise[File | Null]) | File | Null): this.type = set("beforeUpload", js.Any.fromFunction2(value))
    
    inline def capture(value: Boolean | user | environment): this.type = set("capture", value.asInstanceOf[js.Any])
    
    inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
    
    inline def defaultValue(value: js.Array[ImageUploadItem]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    
    inline def defaultValueVarargs(value: ImageUploadItem*): this.type = set("defaultValue", js.Array(value*))
    
    inline def deletable(value: Boolean): this.type = set("deletable", value.asInstanceOf[js.Any])
    
    inline def disableUpload(value: Boolean): this.type = set("disableUpload", value.asInstanceOf[js.Any])
    ...
    inline def onChange(value: /* items */ js.Array[ImageUploadItem] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* items */ js.Array[ImageUploadItem]) => value(t0).runNow()))
    
    inline def onCountExceed(value: /* exceed */ Double => Callback): this.type = set("onCountExceed", js.Any.fromFunction1((t0: /* exceed */ Double) => value(t0).runNow()))
    
    inline def onDelete(value: /* item */ ImageUploadItem => Boolean | js.Promise[Boolean] | Unit): this.type = set("onDelete", js.Any.fromFunction1(value))
    
    inline def onPreview(value: (/* index */ Double, /* item */ ImageUploadItem) => Callback): this.type = set("onPreview", js.Any.fromFunction2((t0: /* index */ Double, t1: /* item */ ImageUploadItem) => (value(t0, t1)).runNow()))
    
    inline def onUploadQueueChange(value: /* tasks */ js.Array[UploadTask] => Callback): this.type = set("onUploadQueueChange", js.Any.fromFunction1((t0: /* tasks */ js.Array[UploadTask]) => value(t0).runNow()))
    
    inline def preview(value: Boolean): this.type = set("preview", value.asInstanceOf[js.Any])
    
    inline def renderItem(
      value: (/* originNode */ Element, /* file */ ImageUploadItem, /* fileList */ js.Array[ImageUploadItem]) => Node
    ): this.type = set("renderItem", js.Any.fromFunction3(value))
    
    inline def showFailed(value: Boolean): this.type = set("showFailed", value.asInstanceOf[js.Any])
    
    inline def showUpload(value: Boolean): this.type = set("showUpload", value.asInstanceOf[js.Any])
    
    inline def style(value: CSSPropertiesPartialRecorAnimationTimingFunction): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def tabIndex(value: Double): this.type = set("tabIndex", value.asInstanceOf[js.Any])
    
    inline def value(value: js.Array[ImageUploadItem]): this.type = set("value", value.asInstanceOf[js.Any])
    
    inline def valueVarargs(value: ImageUploadItem*): this.type = set("value", js.Array(value*))
  }
  
  def withProps(p: ImageUploaderProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
