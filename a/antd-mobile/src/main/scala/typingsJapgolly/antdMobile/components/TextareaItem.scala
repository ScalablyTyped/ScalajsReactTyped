...
import typingsJapgolly.antdMobile.textareaItemMod.TextareaItemProps
import typingsJapgolly.antdMobile.textareaItemMod.default
import typingsJapgolly.antdMobile.textareaItemPropsTypeMod.TextAreaItemPropsType
...
object TextareaItem {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextareaItemProps, default, Unit, TextareaItemProps] = {
  ...
  typingsJapgolly.antdMobile.textareaItemMod.TextareaItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antdMobile.textareaItemMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antdMobile.textareaItemMod.TextareaItemProps])(children: _*)
  }
