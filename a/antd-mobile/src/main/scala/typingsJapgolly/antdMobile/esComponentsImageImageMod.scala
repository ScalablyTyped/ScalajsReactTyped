...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAppearance
...
import typingsJapgolly.antdMobile.antdMobileStrings.`lazy`
...
import typingsJapgolly.antdMobile.antdMobileStrings.`use-credentials`
import typingsJapgolly.antdMobile.antdMobileStrings.additions
import typingsJapgolly.antdMobile.antdMobileStrings.all
import typingsJapgolly.antdMobile.antdMobileStrings.anonymous
...
import typingsJapgolly.antdMobile.antdMobileStrings.async
...
import typingsJapgolly.antdMobile.antdMobileStrings.eager
...
import typingsJapgolly.antdMobile.antdMobileStrings.sync
...
object esComponentsImageImageMod {
  ...
  trait ImageProps extends StObject {
    ...
    var onClick: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLImageElement], Unit]] = js.undefined
    
    var onContainerClick: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLDivElement], Unit]] = js.undefined
  ...
  object ImageProps {
    ...
    extension [Self <: ImageProps](x: Self) {
      ...
      inline def setOnClick(value: /* event */ ReactMouseEventFrom[HTMLImageElement] => Callback): Self = StObject.set(x, "onClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLImageElement]) => value(t0).runNow()))
      
      inline def setOnClickUndefined: Self = StObject.set(x, "onClick", js.undefined)
      
      inline def setOnContainerClick(value: /* event */ ReactMouseEventFrom[HTMLDivElement] => Callback): Self = StObject.set(x, "onContainerClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
