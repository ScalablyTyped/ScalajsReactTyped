...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAnimationFillMode
import typingsJapgolly.antdMobile.anon.Immediate
import typingsJapgolly.antdMobile.anon.anchorsArraynumberchildre
...
object esComponentsFloatingPanelFloatingPanelMod {
  ...
  object FloatingPanelProps {
    ...
    inline def apply(anchors: js.Array[Double]): FloatingPanelProps = {
      val __obj = js.Dynamic.literal(anchors = anchors.asInstanceOf[js.Any], children = null)
    ...
    extension [Self <: FloatingPanelProps](x: Self) {
      ...
      inline def setOnHeightChange(value: (/* height */ Double, /* animating */ Boolean) => Callback): Self = StObject.set(x, "onHeightChange", js.Any.fromFunction2((t0: /* height */ Double, t1: /* animating */ Boolean) => (value(t0, t1)).runNow()))
