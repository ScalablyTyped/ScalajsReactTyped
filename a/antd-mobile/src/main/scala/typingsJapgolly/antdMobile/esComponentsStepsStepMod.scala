...
import typingsJapgolly.antdMobile.antdMobileStrings.finish
...
import typingsJapgolly.antdMobile.antdMobileStrings.process
...
import typingsJapgolly.antdMobile.antdMobileStrings.wait
...
object esComponentsStepsStepMod {
  
  @JSImport("antd-mobile/es/components/steps/step", "Step")
  @js.native
  val Step: FC[StepProps] = js.native
  
  /* Inlined {  title :react.react.ReactNode | undefined,   description :react.react.ReactNode | undefined,   icon :react.react.ReactNode | undefined,   status :'wait' | 'process' | 'finish' | 'error' | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
