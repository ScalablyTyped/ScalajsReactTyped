...
import typingsJapgolly.antdMobile.esComponentsDatePickerDatePickerDateUtilsMod.DatePrecision
import typingsJapgolly.antdMobile.esComponentsDatePickerDatePickerUtilsMod.Precision
import typingsJapgolly.antdMobile.esComponentsDatePickerDatePickerWeekUtilsMod.WeekPrecision
import typingsJapgolly.antdMobile.esComponentsErrorBlockMod.ErrorBlockStatus
...
import typingsJapgolly.antdMobile.esComponentsSwipeActionSwipeActionMod.ActionColor
...
object antdMobileStrings {
  ...
  @js.native
  sealed trait `--active-dot-color` extends StObject
  inline def `--active-dot-color`: `--active-dot-color` = "--active-dot-color".asInstanceOf[`--active-dot-color`]
  ...
  inline def `--dot-border-radius`: `--dot-border-radius` = "--dot-border-radius".asInstanceOf[`--dot-border-radius`]
  
  @js.native
  sealed trait `--dot-color` extends StObject
  inline def `--dot-color`: `--dot-color` = "--dot-color".asInstanceOf[`--dot-color`]
  
  @js.native
  sealed trait `--dot-size` extends StObject
  inline def `--dot-size`: `--dot-size` = "--dot-size".asInstanceOf[`--dot-size`]
  ...
  @js.native
  sealed trait canRelease
    extends StObject
       with PullStatus
  inline def canRelease: canRelease = "canRelease".asInstanceOf[canRelease]
  ...
  sealed trait horizontal
    extends StObject
       with Direction
       with typingsJapgolly.antdMobile.esComponentsStepsStepsMod.Direction
       with FormLayout
  ...
  @js.native
  sealed trait pulling
    extends StObject
       with PullStatus
  inline def pulling: pulling = "pulling".asInstanceOf[pulling]
  ...
  @js.native
  sealed trait refreshing
    extends StObject
       with PullStatus
  inline def refreshing: refreshing = "refreshing".asInstanceOf[refreshing]
  ...
  @js.native
  sealed trait `text-optional` extends StObject
  inline def `text-optional`: `text-optional` = "text-optional".asInstanceOf[`text-optional`]
  
  @js.native
  sealed trait `text-required` extends StObject
  inline def `text-required`: `text-required` = "text-required".asInstanceOf[`text-required`]
  ...
  @js.native
  sealed trait `week-day`
    extends StObject
       with Precision
       with WeekPrecision
  inline def `week-day`: `week-day` = "week-day".asInstanceOf[`week-day`]
