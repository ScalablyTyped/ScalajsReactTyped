...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAccentColor
...
object esComponentsBadgeBadgeMod {
  ...
  trait BadgeProps extends StObject {
    ...
    var content: js.UndefOr[Node | Element] = js.undefined
  ...
  object BadgeProps {
    ...
    extension [Self <: BadgeProps](x: Self) {
      ...
      inline def setContent(value: Node | Element): Self = StObject.set(x, "content", value.asInstanceOf[js.Any])
