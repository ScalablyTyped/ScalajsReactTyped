...
import typingsJapgolly.antdMobile.anon.Label
...
object esComponentsTreeSelectMultipleMod {
  
  @JSImport("antd-mobile/es/components/tree-select/multiple", "Multiple")
  @js.native
  val Multiple: FC[MultipleProps] = js.native
  
  /* Inlined {  options :std.Array<antd-mobile.antd-mobile/es/components/tree-select.TreeSelectOption>,   defaultValue :std.Array<string> | undefined,   value :std.Array<string> | undefined,   onChange :(value : std.Array<string>, nodes : std.Array<antd-mobile.antd-mobile/es/components/tree-select.TreeSelectOption>): void | undefined,   selectAllText :std.Array<string> | undefined,   fieldNames :{  label :string,   value :string,   children :string} | undefined,   expandKeys :std.Array<string> | undefined,   defaultExpandKeys :std.Array<string> | undefined,   onExpand :(expandedKeys : std.Array<string>, nodes : std.Array<antd-mobile.antd-mobile/es/components/tree-select.TreeSelectOption>): void | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait MultipleProps extends StObject {
    ...
    var defaultExpandKeys: js.UndefOr[js.Array[String]] = js.undefined
    
    var defaultValue: js.UndefOr[js.Array[String]] = js.undefined
    
    var expandKeys: js.UndefOr[js.Array[String]] = js.undefined
    
    var fieldNames: js.UndefOr[Label] = js.undefined
    
    var onChange: js.UndefOr[
        js.Function2[/* value */ js.Array[String], /* nodes */ js.Array[TreeSelectOption], Unit]
      ] = js.undefined
    
    var onExpand: js.UndefOr[
        js.Function2[/* expandedKeys */ js.Array[String], /* nodes */ js.Array[TreeSelectOption], Unit]
      ] = js.undefined
    
    var options: js.Array[TreeSelectOption]
    
    var selectAllText: js.UndefOr[js.Array[String]] = js.undefined
  ...
  object MultipleProps {
    
    inline def apply(options: js.Array[TreeSelectOption]): MultipleProps = {
    ...
    extension [Self <: MultipleProps](x: Self) {
      ...
      inline def setDefaultExpandKeys(value: js.Array[String]): Self = StObject.set(x, "defaultExpandKeys", value.asInstanceOf[js.Any])
      
      inline def setDefaultExpandKeysUndefined: Self = StObject.set(x, "defaultExpandKeys", js.undefined)
      
      inline def setDefaultExpandKeysVarargs(value: String*): Self = StObject.set(x, "defaultExpandKeys", js.Array(value*))
      ...
      inline def setExpandKeys(value: js.Array[String]): Self = StObject.set(x, "expandKeys", value.asInstanceOf[js.Any])
      
      inline def setExpandKeysUndefined: Self = StObject.set(x, "expandKeys", js.undefined)
      
      inline def setExpandKeysVarargs(value: String*): Self = StObject.set(x, "expandKeys", js.Array(value*))
      
      inline def setFieldNames(value: Label): Self = StObject.set(x, "fieldNames", value.asInstanceOf[js.Any])
      
      inline def setFieldNamesUndefined: Self = StObject.set(x, "fieldNames", js.undefined)
      
      inline def setOnChange(value: (/* value */ js.Array[String], /* nodes */ js.Array[TreeSelectOption]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ js.Array[String], t1: /* nodes */ js.Array[TreeSelectOption]) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setOnExpand(value: (/* expandedKeys */ js.Array[String], /* nodes */ js.Array[TreeSelectOption]) => Callback): Self = StObject.set(x, "onExpand", js.Any.fromFunction2((t0: /* expandedKeys */ js.Array[String], t1: /* nodes */ js.Array[TreeSelectOption]) => (value(t0, t1)).runNow()))
      ...
      inline def setSelectAllText(value: js.Array[String]): Self = StObject.set(x, "selectAllText", value.asInstanceOf[js.Any])
      
      inline def setSelectAllTextUndefined: Self = StObject.set(x, "selectAllText", js.undefined)
      
      inline def setSelectAllTextVarargs(value: String*): Self = StObject.set(x, "selectAllText", js.Array(value*))
