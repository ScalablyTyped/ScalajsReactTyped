...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAlignitems
import typingsJapgolly.antdMobile.anon.headerReactNodeundefinedm
...
object esComponentsListListMod {
  
  @JSImport("antd-mobile/es/components/list/list", "List")
  @js.native
  val List: ForwardRefExoticComponent[headerReactNodeundefinedm] = js.native
  
  /* Inlined {  header :react.react.ReactNode | undefined,   mode :'default' | 'card' | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--active-background-color' | '--align-items' | '--border-bottom' | '--border-inner' | '--border-top' | '--extra-max-width' | '--font-size' | '--header-font-size' | '--padding-left' | '--padding-right' | '--prefix-padding-right' | '--prefix-width'> */
  ...
  object ListProps {
    ...
    extension [Self <: ListProps](x: Self) {
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorAlignitems): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
  ...
  trait ListRef extends StObject {
    ...
    var nativeElement: HTMLDivElement | Null
  }
  object ListRef {
    
    inline def apply(): ListRef = {
