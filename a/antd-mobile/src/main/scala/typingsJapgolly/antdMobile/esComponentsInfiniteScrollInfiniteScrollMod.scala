...
object esComponentsInfiniteScrollInfiniteScrollMod {
  ...
  trait InfiniteScrollProps extends StObject {
    ...
    var children: js.UndefOr[
        Node | (js.Function3[/* hasMore */ Boolean, /* failed */ Boolean, /* retry */ js.Function0[Unit], Node])
      ] = js.undefined
  ...
  object InfiniteScrollProps {
    ...
    extension [Self <: InfiniteScrollProps](x: Self) {
      ...
      inline def setChildrenFunction3(value: (/* hasMore */ Boolean, /* failed */ Boolean, /* retry */ js.Function0[Unit]) => Node): Self = StObject.set(x, "children", js.Any.fromFunction3(value))
