...
object esComponentsProgressBarProgressBarMod {
  ...
  trait ProgressBarProps extends StObject {
    ...
    var text: js.UndefOr[Boolean | Node | (js.Function1[/* percent */ Double, Node])] = js.undefined
  }
  object ProgressBarProps {
    ...
    extension [Self <: ProgressBarProps](x: Self) {
      ...
      inline def setText(value: Boolean | Node | (js.Function1[/* percent */ Double, Node])): Self = StObject.set(x, "text", value.asInstanceOf[js.Any])
      
      inline def setTextFunction1(value: /* percent */ Double => Node): Self = StObject.set(x, "text", js.Any.fromFunction1(value))
