...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAnimationTimeline
...
object esComponentsGridGridMod {
  
  @JSImport("antd-mobile/es/components/grid/grid", "Grid")
  @js.native
  val Grid: FC[GridProps] = js.native
  
  @JSImport("antd-mobile/es/components/grid/grid", "GridItem")
  @js.native
  val GridItem: FC[GridItemProps] = js.native
  
  /* Inlined {  span :number | undefined,   onClick :(event : react.react.MouseEvent<std.HTMLDivElement, std.MouseEvent>): void | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait GridItemProps extends StObject {
  ...
  object GridItemProps {
    
    inline def apply(): GridItemProps = {
  ...
  /* Inlined {  columns :number,   gap :number | string | [number | string, number | string] | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--gap' | '--gap-vertical' | '--gap-horizontal'> */
  trait GridProps extends StObject {
    ...
    var gap: js.UndefOr[Double | String | (js.Tuple2[Double | String, Double | String])] = js.undefined
  ...
  object GridProps {
    ...
    inline def apply(columns: Double): GridProps = {
    ...
    extension [Self <: GridProps](x: Self) {
      ...
      inline def setGap(value: Double | String | (js.Tuple2[Double | String, Double | String])): Self = StObject.set(x, "gap", value.asInstanceOf[js.Any])
