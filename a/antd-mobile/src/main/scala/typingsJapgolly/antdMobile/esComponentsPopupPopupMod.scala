...
object esComponentsPopupPopupMod {
  
  @JSImport("antd-mobile/es/components/popup/popup", "Popup")
  @js.native
  val Popup: FC[PopupProps] = js.native
  
  /* Inlined antd-mobile.antd-mobile/es/components/popup/popup-base-props.PopupBaseProps & react.react.PropsWithChildren<{  position :'bottom' | 'top' | 'left' | 'right' | undefined}> & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--z-index'> */
  trait PopupProps extends StObject {
    ...
    var onMaskClick: js.UndefOr[js.Function1[/* event */ ReactMouseEventFrom[HTMLDivElement], Unit]] = js.undefined
    
    var position: js.UndefOr[bottom | top | left | right] = js.undefined
  ...
  object PopupProps {
    ...
    extension [Self <: PopupProps](x: Self) {
      ...
      inline def setOnMaskClick(value: /* event */ ReactMouseEventFrom[HTMLDivElement] => Callback): Self = StObject.set(x, "onMaskClick", js.Any.fromFunction1((t0: /* event */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
      
      inline def setOnMaskClickUndefined: Self = StObject.set(x, "onMaskClick", js.undefined)
      
      inline def setPosition(value: bottom | top | left | right): Self = StObject.set(x, "position", value.asInstanceOf[js.Any])
