...
object esComponentsSafeAreaSafeAreaMod {
  
  @JSImport("antd-mobile/es/components/safe-area/safe-area", "SafeArea")
  @js.native
  val SafeArea: FC[SafeAreaProps] = js.native
  
  /* Inlined {  position :'top' | 'bottom'} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait SafeAreaProps extends StObject {
  ...
  object SafeAreaProps {
    
    inline def apply(position: top | bottom): SafeAreaProps = {
