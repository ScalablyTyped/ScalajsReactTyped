...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundColor_
import typingsJapgolly.antdMobile.anon.valuestringundefineddefauAriaatomic
...
object esComponentsSearchBarSearchBarMod {
  
  @JSImport("antd-mobile/es/components/search-bar/search-bar", "SearchBar")
  @js.native
  ...
  trait SearchBarProps extends StObject {
    ...
    var clearOnCancel: js.UndefOr[Boolean] = js.undefined
    ...
    var onSearch: js.UndefOr[js.Function1[/* val */ String, Unit]] = js.undefined
    
    var onlyShowClearWhenFocus: js.UndefOr[Boolean] = js.undefined
    
    var placeholder: js.UndefOr[String] = js.undefined
    
    var showCancelButton: js.UndefOr[Boolean | (js.Function2[/* focus */ Boolean, /* value */ String, Boolean])] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundColor_] = js.undefined
  ...
  object SearchBarProps {
    ...
    extension [Self <: SearchBarProps](x: Self) {
      ...
      inline def setClearOnCancel(value: Boolean): Self = StObject.set(x, "clearOnCancel", value.asInstanceOf[js.Any])
      
      inline def setClearOnCancelUndefined: Self = StObject.set(x, "clearOnCancel", js.undefined)
      ...
      inline def setOnSearch(value: /* val */ String => Callback): Self = StObject.set(x, "onSearch", js.Any.fromFunction1((t0: /* val */ String) => value(t0).runNow()))
      ...
      inline def setShowCancelButton(value: Boolean | (js.Function2[/* focus */ Boolean, /* value */ String, Boolean])): Self = StObject.set(x, "showCancelButton", value.asInstanceOf[js.Any])
      
      inline def setShowCancelButtonFunction2(value: (/* focus */ Boolean, /* value */ String) => Boolean): Self = StObject.set(x, "showCancelButton", js.Any.fromFunction2(value))
      
      inline def setShowCancelButtonUndefined: Self = StObject.set(x, "showCancelButton", js.undefined)
      
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundColor_): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
