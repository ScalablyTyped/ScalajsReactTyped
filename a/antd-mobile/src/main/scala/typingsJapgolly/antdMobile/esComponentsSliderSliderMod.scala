...
object esComponentsSliderSliderMod {
  ...
  trait SliderProps extends StObject {
    ...
    var popover: js.UndefOr[Boolean | (js.Function1[/* value */ Double, Node])] = js.undefined
  ...
  object SliderProps {
    ...
    extension [Self <: SliderProps](x: Self) {
      ...
      inline def setOnAfterChange(value: /* value */ SliderValue => Callback): Self = StObject.set(x, "onAfterChange", js.Any.fromFunction1((t0: /* value */ SliderValue) => value(t0).runNow()))
