...
object esComponentsSwipeActionSwipeActionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antdMobile.antdMobileStrings.light
    - typingsJapgolly.antdMobile.antdMobileStrings.weak
    - typingsJapgolly.antdMobile.antdMobileStrings.primary
    - typingsJapgolly.antdMobile.antdMobileStrings.success
    - typingsJapgolly.antdMobile.antdMobileStrings.warning
    - typingsJapgolly.antdMobile.antdMobileStrings.danger
  */
  trait ActionColor extends StObject
  object ActionColor {
    
    inline def danger: typingsJapgolly.antdMobile.antdMobileStrings.danger = "danger".asInstanceOf[typingsJapgolly.antdMobile.antdMobileStrings.danger]
    
    inline def light: typingsJapgolly.antdMobile.antdMobileStrings.light = "light".asInstanceOf[typingsJapgolly.antdMobile.antdMobileStrings.light]
    
    inline def primary: typingsJapgolly.antdMobile.antdMobileStrings.primary = "primary".asInstanceOf[typingsJapgolly.antdMobile.antdMobileStrings.primary]
    ...
    inline def warning: typingsJapgolly.antdMobile.antdMobileStrings.warning = "warning".asInstanceOf[typingsJapgolly.antdMobile.antdMobileStrings.warning]
    
    inline def weak: typingsJapgolly.antdMobile.antdMobileStrings.weak = "weak".asInstanceOf[typingsJapgolly.antdMobile.antdMobileStrings.weak]
  }
  ...
  trait SwipeActionProps extends StObject {
    ...
    var onAction: js.UndefOr[js.Function2[/* action */ Action, /* e */ ReactMouseEventFrom[Element], Unit]] = js.undefined
  ...
  object SwipeActionProps {
    ...
    extension [Self <: SwipeActionProps](x: Self) {
      ...
      inline def setOnAction(value: (/* action */ Action, /* e */ ReactMouseEventFrom[Element]) => Callback): Self = StObject.set(x, "onAction", js.Any.fromFunction2((t0: /* action */ Action, t1: /* e */ ReactMouseEventFrom[Element]) => (value(t0, t1)).runNow()))
