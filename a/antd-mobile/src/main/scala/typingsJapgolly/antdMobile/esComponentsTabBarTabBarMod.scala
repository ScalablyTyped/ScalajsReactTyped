...
object esComponentsTabBarTabBarMod {
  
  @JSImport("antd-mobile/es/components/tab-bar/tab-bar", "TabBar")
  @js.native
  val TabBar: FC[TabBarProps] = js.native
  
  @JSImport("antd-mobile/es/components/tab-bar/tab-bar", "TabBarItem")
  @js.native
  val TabBarItem: FC[TabBarItemProps] = js.native
  
  /* Inlined {  icon :react.react.ReactNode | (active : boolean): react.react.ReactNode | undefined,   title :react.react.ReactNode | (active : boolean): react.react.ReactNode | undefined,   badge :antd-mobile.antd-mobile/es/components/badge.BadgeProps['content'] | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait TabBarItemProps extends StObject {
    ...
    var badge: js.UndefOr[Node | Element] = js.undefined
    
    var className: js.UndefOr[String] = js.undefined
    
    var icon: js.UndefOr[Node | (js.Function1[/* active */ Boolean, Node])] = js.undefined
    
    var style: js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
    
    var title: js.UndefOr[Node | (js.Function1[/* active */ Boolean, Node])] = js.undefined
  }
  object TabBarItemProps {
    
    inline def apply(): TabBarItemProps = {
    ...
    extension [Self <: TabBarItemProps](x: Self) {
      ...
      inline def setBadge(value: Node | Element): Self = StObject.set(x, "badge", value.asInstanceOf[js.Any])
      
      inline def setBadgeNull: Self = StObject.set(x, "badge", null)
      
      inline def setBadgeUndefined: Self = StObject.set(x, "badge", js.undefined)
      
      inline def setBadgeVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "badge", js.Array(value*))
      ...
      inline def setIcon(value: Node | (js.Function1[/* active */ Boolean, Node])): Self = StObject.set(x, "icon", value.asInstanceOf[js.Any])
      
      inline def setIconFunction1(value: /* active */ Boolean => Node): Self = StObject.set(x, "icon", js.Any.fromFunction1(value))
      ...
      inline def setTitle(value: Node | (js.Function1[/* active */ Boolean, Node])): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
      
      inline def setTitleFunction1(value: /* active */ Boolean => Node): Self = StObject.set(x, "title", js.Any.fromFunction1(value))
  ...
  /* Inlined {  activeKey :string | null | undefined,   defaultActiveKey :string | null | undefined,   onChange :(key : string): void | undefined,   safeArea :boolean | undefined,   children :react.react.ReactNode | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  ...
  object TabBarProps {
    ...
    extension [Self <: TabBarProps](x: Self) {
      ...
      inline def setOnChange(value: /* key */ String => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* key */ String) => value(t0).runNow()))
