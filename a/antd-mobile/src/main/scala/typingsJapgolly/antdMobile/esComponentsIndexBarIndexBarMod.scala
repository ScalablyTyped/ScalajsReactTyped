...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAspectRatio
import typingsJapgolly.antdMobile.anon.stickybooleanundefinedonI
...
object esComponentsIndexBarIndexBarMod {
  ...
  object IndexBarRef {
    ...
    inline def apply(scrollTo: String => Callback): IndexBarRef = {
      val __obj = js.Dynamic.literal(scrollTo = js.Any.fromFunction1((t0: String) => scrollTo(t0).runNow()))
