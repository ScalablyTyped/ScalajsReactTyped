...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAlignTracks
...
object esComponentsCascaderViewCascaderViewMod {
  
  @JSImport("antd-mobile/es/components/cascader-view/cascader-view", "CascaderView")
  @js.native
  val CascaderView: FC[CascaderViewProps] = js.native
  
  trait CascaderOption extends StObject {
  ...
  object CascaderOption {
    ...
    inline def apply(label: String, value: String): CascaderOption = {
    ...
    extension [Self <: CascaderOption](x: Self) {
      ...
      inline def setChildrenVarargs(value: CascaderOption*): Self = StObject.set(x, "children", js.Array(value*))
  ...
  trait CascaderValueExtend extends StObject {
    
    var isLeaf: Boolean
    
    var items: js.Array[CascaderOption | Null]
  }
  object CascaderValueExtend {
    
    inline def apply(isLeaf: Boolean, items: js.Array[CascaderOption | Null]): CascaderValueExtend = {
      val __obj = js.Dynamic.literal(isLeaf = isLeaf.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any])
    ...
    extension [Self <: CascaderValueExtend](x: Self) {
      ...
      inline def setItems(value: js.Array[CascaderOption | Null]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: (CascaderOption | Null)*): Self = StObject.set(x, "items", js.Array(value*))
    }
  }
  ...
  object CascaderViewProps {
    
    inline def apply(options: js.Array[CascaderOption]): CascaderViewProps = {
    ...
    extension [Self <: CascaderViewProps](x: Self) {
      ...
      inline def setOnChange(value: (/* value */ js.Array[CascaderValue], /* extend */ CascaderValueExtend) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ js.Array[CascaderValue], t1: /* extend */ CascaderValueExtend) => (value(t0, t1)).runNow()))
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorAlignTracks): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
