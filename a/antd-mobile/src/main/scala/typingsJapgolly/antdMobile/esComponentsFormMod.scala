...
import typingsJapgolly.antdMobile.anon.FnCall
import typingsJapgolly.antdMobile.anon.FnCallDependenciesForm
import typingsJapgolly.antdMobile.anon.PartialclassNamestringund
import typingsJapgolly.antdMobile.anon.WeakValidationMapclassNam
...
object esComponentsFormMod {
  ...
  object default {
    ...
    /**
      ...
      */
    inline def apply(props: classNamestringundefinedsAriaactivedescendant): Element | Null = ^.asInstanceOf[js.Dynamic].apply(props.asInstanceOf[js.Any]).asInstanceOf[Element | Null]
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antdMobile.antdMobileStrings.vertical
    - typingsJapgolly.antdMobile.antdMobileStrings.horizontal
  */
  trait FormLayout extends StObject
  object FormLayout {
    
    inline def horizontal: typingsJapgolly.antdMobile.antdMobileStrings.horizontal = "horizontal".asInstanceOf[typingsJapgolly.antdMobile.antdMobileStrings.horizontal]
    
    inline def vertical: typingsJapgolly.antdMobile.antdMobileStrings.vertical = "vertical".asInstanceOf[typingsJapgolly.antdMobile.antdMobileStrings.vertical]
  }
}
