...
object esComponentsPopoverPopoverMod {
  ...
  object PopoverProps {
    ...
    inline def apply(children: VdomElement): PopoverProps = {
      val __obj = js.Dynamic.literal(children = children.rawElement.asInstanceOf[js.Any], content = null)
  ...
  object PopoverRef {
    ...
    inline def apply(hide: Callback, show: Callback, visible: Boolean): PopoverRef = {
      val __obj = js.Dynamic.literal(hide = hide.toJsFn, show = show.toJsFn, visible = visible.asInstanceOf[js.Any])
