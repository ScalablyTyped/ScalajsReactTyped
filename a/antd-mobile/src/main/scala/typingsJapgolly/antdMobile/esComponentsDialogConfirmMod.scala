...
object esComponentsDialogConfirmMod {
  
  @JSImport("antd-mobile/es/components/dialog/confirm", JSImport.Namespace)
  @js.native
  val ^ : js.Any = js.native
  
  inline def confirm(p: DialogConfirmProps): js.Promise[Boolean] = ^.asInstanceOf[js.Dynamic].applyDynamic("confirm")(p.asInstanceOf[js.Any]).asInstanceOf[js.Promise[Boolean]]
  
  /* Inlined std.Omit<antd-mobile.antd-mobile/es/components/dialog.DialogProps, 'visible' | 'closeOnAction' | 'actions'> & {  confirmText :react.react.ReactNode | undefined,   cancelText :react.react.ReactNode | undefined,   onConfirm :(): void | std.Promise<void> | undefined,   onCancel :(): void | std.Promise<void> | undefined} */
  trait DialogConfirmProps extends StObject {
  ...
  object DialogConfirmProps {
    ...
    inline def apply(): DialogConfirmProps = {
    ...
    extension [Self <: DialogConfirmProps](x: Self) {
      ...
      inline def setOnCancel(value: CallbackTo[Unit | js.Promise[Unit]]): Self = StObject.set(x, "onCancel", value.toJsFn)
      ...
      inline def setOnConfirm(value: CallbackTo[Unit | js.Promise[Unit]]): Self = StObject.set(x, "onConfirm", value.toJsFn)
