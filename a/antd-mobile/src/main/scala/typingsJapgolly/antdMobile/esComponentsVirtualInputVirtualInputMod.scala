...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBorderBlock
import typingsJapgolly.antdMobile.anon.onFocusvoidundefinedonBlu
...
object esComponentsVirtualInputVirtualInputMod {
  
  @JSImport("antd-mobile/es/components/virtual-input/virtual-input", "VirtualInput")
  @js.native
  val VirtualInput: ForwardRefExoticComponent[onFocusvoidundefinedonBlu] = js.native
  
  /* Inlined {  onFocus :(): void | undefined,   onBlur :(): void | undefined,   onClick :(e : react.react.MouseEvent<std.HTMLDivElement, react.react.NativeMouseEvent>): void | undefined,   keyboard :react.react.ReactElement | undefined,   clearable :boolean | undefined,   onClear :(): void | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/input.InputProps, 'value' | 'onChange' | 'placeholder' | 'disabled'> & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--font-size' | '--color' | '--placeholder-color' | '--disabled-color' | '--text-align' | '--caret-width' | '--caret-color'> */
  trait VirtualInputProps extends StObject {
  ...
  object VirtualInputProps {
    
    inline def apply(): VirtualInputProps = {
  ...
  trait VirtualInputRef extends StObject {
    
    def blur(): Unit
    
    def focus(): Unit
  }
  object VirtualInputRef {
    
    inline def apply(blur: Callback, focus: Callback): VirtualInputRef = {
