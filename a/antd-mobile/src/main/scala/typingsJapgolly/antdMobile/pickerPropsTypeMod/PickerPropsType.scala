...
import typingsJapgolly.rmcPicker.popupPickerTypesMod.IPopupPickerProps
...
trait PickerPropsType extends IPopupPickerProps {
  ...
  var format: js.UndefOr[js.Function1[/* values */ js.Array[Node], String | js.Array[Node]]] = js.undefined
