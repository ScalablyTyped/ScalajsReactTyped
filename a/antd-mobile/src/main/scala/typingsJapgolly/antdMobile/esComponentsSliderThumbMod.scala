...
object esComponentsSliderThumbMod extends Shortcut {
  
  @JSImport("antd-mobile/es/components/slider/thumb", JSImport.Default)
  @js.native
  val default: FC[ThumbProps] = js.native
  
  /* Inlined {  value :number,   min :number,   max :number,   disabled :boolean, onDrag (value : number, first : boolean, last : boolean): void,   trackRef :react.react.RefObject<std.HTMLDivElement>,   icon :react.react.ReactNode | undefined,   popover :boolean | (value : number): react.react.ReactNode,   residentPopover :boolean} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait ThumbProps extends StObject {
    ...
    def onDrag(value: Double, first: Boolean, last: Boolean): Unit
    
    var popover: Boolean | (js.Function1[/* value */ Double, Node])
    
    var residentPopover: Boolean
    
    var style: js.UndefOr[CSSProperties & (Partial[Record[scala.Nothing, String]])] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
    
    var trackRef: RefHandle[HTMLDivElement]
  ...
  object ThumbProps {
    ...
    inline def apply(
      ...
      max: Double,
      min: Double,
      onDrag: (Double, Boolean, Boolean) => Callback,
      popover: Boolean | (js.Function1[/* value */ Double, Node]),
      residentPopover: Boolean,
      trackRef: RefHandle[HTMLDivElement],
      value: Double
    ): ThumbProps = {
      val __obj = js.Dynamic.literal(disabled = disabled.asInstanceOf[js.Any], max = max.asInstanceOf[js.Any], min = min.asInstanceOf[js.Any], onDrag = js.Any.fromFunction3((t0: Double, t1: Boolean, t2: Boolean) => (onDrag(t0, t1, t2)).runNow()), popover = popover.asInstanceOf[js.Any], residentPopover = residentPopover.asInstanceOf[js.Any], trackRef = trackRef.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
    ...
    extension [Self <: ThumbProps](x: Self) {
      ...
      inline def setOnDrag(value: (Double, Boolean, Boolean) => Callback): Self = StObject.set(x, "onDrag", js.Any.fromFunction3((t0: Double, t1: Boolean, t2: Boolean) => (value(t0, t1, t2)).runNow()))
      
      inline def setPopover(value: Boolean | (js.Function1[/* value */ Double, Node])): Self = StObject.set(x, "popover", value.asInstanceOf[js.Any])
      
      inline def setPopoverFunction1(value: /* value */ Double => Node): Self = StObject.set(x, "popover", js.Any.fromFunction1(value))
      
      inline def setResidentPopover(value: Boolean): Self = StObject.set(x, "residentPopover", value.asInstanceOf[js.Any])
      ...
      inline def setTrackRef(value: RefHandle[HTMLDivElement]): Self = StObject.set(x, "trackRef", value.asInstanceOf[js.Any])
      
      inline def setValue(value: Double): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
    }
  }
  
  type _To = FC[ThumbProps]
  
  /* This means you don't have to write `default`, but can instead just say `esComponentsSliderThumbMod.foo` */
  override def _to: FC[ThumbProps] = default
}
