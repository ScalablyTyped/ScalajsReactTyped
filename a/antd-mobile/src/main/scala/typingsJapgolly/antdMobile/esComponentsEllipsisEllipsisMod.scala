...
object esComponentsEllipsisEllipsisMod {
  ...
  trait EllipsisProps extends StObject {
    ...
    var onContentClick: js.UndefOr[js.Function1[/* e */ ReactMouseEventFrom[HTMLDivElement], Unit]] = js.undefined
  ...
  object EllipsisProps {
    ...
    extension [Self <: EllipsisProps](x: Self) {
      ...
      inline def setOnContentClick(value: /* e */ ReactMouseEventFrom[HTMLDivElement] => Callback): Self = StObject.set(x, "onContentClick", js.Any.fromFunction1((t0: /* e */ ReactMouseEventFrom[HTMLDivElement]) => value(t0).runNow()))
