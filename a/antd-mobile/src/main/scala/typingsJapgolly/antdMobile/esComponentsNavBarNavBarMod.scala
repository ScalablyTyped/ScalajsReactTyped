...
object esComponentsNavBarNavBarMod {
  ...
  trait NavBarProps extends StObject {
    ...
    var backArrow: js.UndefOr[Boolean | Node] = js.undefined
  ...
  object NavBarProps {
    ...
    extension [Self <: NavBarProps](x: Self) {
      ...
      inline def setBackArrow(value: Boolean | Node): Self = StObject.set(x, "backArrow", value.asInstanceOf[js.Any])
      
      inline def setBackArrowNull: Self = StObject.set(x, "backArrow", null)
      
      inline def setBackArrowUndefined: Self = StObject.set(x, "backArrow", js.undefined)
      
      inline def setBackArrowVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "backArrow", js.Array(value*))
      
      inline def setBackArrowVdomElement(value: VdomElement): Self = StObject.set(x, "backArrow", value.rawElement.asInstanceOf[js.Any])
