...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAnimationIterationCount
...
import typingsJapgolly.antdMobile.antdMobileStrings.plain
...
object esComponentsFooterFooterMod {
  
  @JSImport("antd-mobile/es/components/footer/footer", "Footer")
  @js.native
  val Footer: FC[FooterProps] = js.native
  
  trait ChipItem extends StObject {
    
    var text: Node
    
    var `type`: js.UndefOr[plain | link] = js.undefined
  }
  object ChipItem {
    
    inline def apply(): ChipItem = {
    ...
    extension [Self <: ChipItem](x: Self) {
      ...
      inline def setType(value: plain | link): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
      
      inline def setTypeUndefined: Self = StObject.set(x, "type", js.undefined)
    }
  }
  
  /* Inlined {  label :react.react.ReactNode | undefined,   links :std.Array<antd-mobile.antd-mobile/es/components/footer/footer.LinkItem> | undefined,   content :react.react.ReactNode | undefined,   chips :std.Array<antd-mobile.antd-mobile/es/components/footer/footer.ChipItem> | undefined,   onChipClick :(item : antd-mobile.antd-mobile/es/components/footer/footer.ChipItem, index : number): void | undefined,   onLinkClick :(item : antd-mobile.antd-mobile/es/components/footer/footer.LinkItem, index : number): void | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--background-color'> */
  trait FooterProps extends StObject {
    ...
    var chips: js.UndefOr[js.Array[ChipItem]] = js.undefined
    ...
    var links: js.UndefOr[js.Array[LinkItem]] = js.undefined
    
    var onChipClick: js.UndefOr[js.Function2[/* item */ ChipItem, /* index */ Double, Unit]] = js.undefined
    
    var onLinkClick: js.UndefOr[js.Function2[/* item */ LinkItem, /* index */ Double, Unit]] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorAnimationIterationCount] = js.undefined
  ...
  object FooterProps {
    ...
    extension [Self <: FooterProps](x: Self) {
      ...
      inline def setChips(value: js.Array[ChipItem]): Self = StObject.set(x, "chips", value.asInstanceOf[js.Any])
      
      inline def setChipsUndefined: Self = StObject.set(x, "chips", js.undefined)
      
      inline def setChipsVarargs(value: ChipItem*): Self = StObject.set(x, "chips", js.Array(value*))
      ...
      inline def setLinks(value: js.Array[LinkItem]): Self = StObject.set(x, "links", value.asInstanceOf[js.Any])
      
      inline def setLinksUndefined: Self = StObject.set(x, "links", js.undefined)
      
      inline def setLinksVarargs(value: LinkItem*): Self = StObject.set(x, "links", js.Array(value*))
      
      inline def setOnChipClick(value: (/* item */ ChipItem, /* index */ Double) => Callback): Self = StObject.set(x, "onChipClick", js.Any.fromFunction2((t0: /* item */ ChipItem, t1: /* index */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnChipClickUndefined: Self = StObject.set(x, "onChipClick", js.undefined)
      
      inline def setOnLinkClick(value: (/* item */ LinkItem, /* index */ Double) => Callback): Self = StObject.set(x, "onLinkClick", js.Any.fromFunction2((t0: /* item */ LinkItem, t1: /* index */ Double) => (value(t0, t1)).runNow()))
      
      inline def setOnLinkClickUndefined: Self = StObject.set(x, "onLinkClick", js.undefined)
      
      inline def setStyle(value: CSSPropertiesPartialRecorAnimationIterationCount): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
  ...
  trait LinkItem extends StObject {
  ...
  object LinkItem {
    ...
    inline def apply(href: String, text: String): LinkItem = {
