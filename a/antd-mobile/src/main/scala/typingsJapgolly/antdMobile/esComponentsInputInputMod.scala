...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackdropFilter
...
object esComponentsInputInputMod {
  
  @JSImport("antd-mobile/es/components/input/input", "Input")
  @js.native
  val Input: ForwardRefExoticComponent[valuestringundefineddefau] = js.native
  
  trait AriaProps extends StObject {
    
    var role: js.UndefOr[String] = js.undefined
  }
  object AriaProps {
    
    inline def apply(): AriaProps = {
  ...
  /* Inlined std.Pick<antd-mobile.antd-mobile/es/components/input/input.NativeInputProps, 'maxLength' | 'minLength' | 'autoComplete' | 'autoFocus' | 'pattern' | 'inputMode' | 'type' | 'name' | 'onFocus' | 'onBlur' | 'autoCapitalize' | 'autoCorrect' | 'onKeyDown' | 'onKeyUp' | 'onCompositionStart' | 'onCompositionEnd' | 'onClick' | 'step'> & {  value :string | undefined,   defaultValue :string | undefined,   onChange :(val : string): void | undefined,   placeholder :string | undefined,   disabled :boolean | undefined,   readOnly :boolean | undefined,   clearable :boolean | undefined,   onlyShowClearWhenFocus :boolean | undefined,   onClear :(): void | undefined,   id :string | undefined,   onEnterPress :(e : react.react.KeyboardEvent<std.HTMLInputElement>): void | undefined,   enterKeyHint :'enter' | 'done' | 'go' | 'next' | 'previous' | 'search' | 'send' | undefined,   min :number | undefined,   max :number | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--font-size' | '--color' | '--placeholder-color' | '--text-align'> & antd-mobile.antd-mobile/es/components/input/input.AriaProps */
  trait InputProps extends StObject {
    ...
    var onEnterPress: js.UndefOr[js.Function1[/* e */ ReactKeyboardEventFrom[HTMLInputElement], Unit]] = js.undefined
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorBackdropFilter] = js.undefined
  ...
  object InputProps {
    ...
    extension [Self <: InputProps](x: Self) {
      ...
      inline def setOnEnterPress(value: /* e */ ReactKeyboardEventFrom[HTMLInputElement] => Callback): Self = StObject.set(x, "onEnterPress", js.Any.fromFunction1((t0: /* e */ ReactKeyboardEventFrom[HTMLInputElement]) => value(t0).runNow()))
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackdropFilter): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
  ...
  object InputRef {
    ...
    inline def apply(blur: Callback, clear: Callback, focus: Callback): InputRef = {
      val __obj = js.Dynamic.literal(blur = blur.toJsFn, clear = clear.toJsFn, focus = focus.toJsFn, nativeElement = null)
