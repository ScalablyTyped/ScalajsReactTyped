...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorAlignItems_
...
object esComponentsPickerViewPickerViewMod {
  
  @JSImport("antd-mobile/es/components/picker-view/picker-view", "PickerView")
  @js.native
  val PickerView: NamedExoticComponent[PickerViewProps] = js.native
  
  type PickerColumn = js.Array[String | PickerColumnItem]
  ...
  trait PickerValueExtend extends StObject {
    ...
    var columns: js.Array[js.Array[PickerColumnItem]]
    
    var items: js.Array[PickerColumnItem | Null]
  }
  object PickerValueExtend {
    
    inline def apply(columns: js.Array[js.Array[PickerColumnItem]], items: js.Array[PickerColumnItem | Null]): PickerValueExtend = {
      val __obj = js.Dynamic.literal(columns = columns.asInstanceOf[js.Any], items = items.asInstanceOf[js.Any])
    ...
    extension [Self <: PickerValueExtend](x: Self) {
      ...
      inline def setColumnsVarargs(value: js.Array[PickerColumnItem]*): Self = StObject.set(x, "columns", js.Array(value*))
      
      inline def setItems(value: js.Array[PickerColumnItem | Null]): Self = StObject.set(x, "items", value.asInstanceOf[js.Any])
      
      inline def setItemsVarargs(value: (PickerColumnItem | Null)*): Self = StObject.set(x, "items", js.Array(value*))
    }
  }
  
  /* Inlined {  columns :std.Array<antd-mobile.antd-mobile/es/components/picker-view/picker-view.PickerColumn> | (value : std.Array<antd-mobile.antd-mobile/es/components/picker-view/picker-view.PickerValue>): std.Array<antd-mobile.antd-mobile/es/components/picker-view/picker-view.PickerColumn>,   value :std.Array<antd-mobile.antd-mobile/es/components/picker-view/picker-view.PickerValue> | undefined,   defaultValue :std.Array<antd-mobile.antd-mobile/es/components/picker-view/picker-view.PickerValue> | undefined,   mouseWheel :boolean | undefined,   loading :boolean | undefined,   loadingContent :react.react.ReactNode | undefined,   onChange :(value : std.Array<antd-mobile.antd-mobile/es/components/picker-view/picker-view.PickerValue>, extend : antd-mobile.antd-mobile/es/components/picker-view/picker-view.PickerValueExtend): void | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/picker.PickerProps, 'renderLabel'> & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--height' | '--item-height' | '--item-font-size'> */
  trait PickerViewProps extends StObject {
    ...
    var columns: js.Array[PickerColumn] | (js.Function1[/* value */ js.Array[PickerValue], js.Array[PickerColumn]])
    
    var defaultValue: js.UndefOr[js.Array[PickerValue]] = js.undefined
    ...
    var onChange: js.UndefOr[
        js.Function2[/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend, Unit]
      ] = js.undefined
    
    var renderLabel: js.UndefOr[js.Function1[/* item */ PickerColumnItem, Node]] = js.undefined
    
    var style: js.UndefOr[CSSPropertiesPartialRecorAlignItems_] = js.undefined
    
    var tabIndex: js.UndefOr[Double] = js.undefined
    
    var value: js.UndefOr[js.Array[PickerValue]] = js.undefined
  }
  object PickerViewProps {
    ...
    extension [Self <: PickerViewProps](x: Self) {
      ...
      inline def setColumns(
        value: js.Array[PickerColumn] | (js.Function1[/* value */ js.Array[PickerValue], js.Array[PickerColumn]])
      ): Self = StObject.set(x, "columns", value.asInstanceOf[js.Any])
      
      inline def setColumnsFunction1(value: /* value */ js.Array[PickerValue] => js.Array[PickerColumn]): Self = StObject.set(x, "columns", js.Any.fromFunction1(value))
      
      inline def setColumnsVarargs(value: PickerColumn*): Self = StObject.set(x, "columns", js.Array(value*))
      
      inline def setDefaultValue(value: js.Array[PickerValue]): Self = StObject.set(x, "defaultValue", value.asInstanceOf[js.Any])
      
      inline def setDefaultValueUndefined: Self = StObject.set(x, "defaultValue", js.undefined)
      
      inline def setDefaultValueVarargs(value: PickerValue*): Self = StObject.set(x, "defaultValue", js.Array(value*))
      ...
      inline def setOnChange(value: (/* value */ js.Array[PickerValue], /* extend */ PickerValueExtend) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ js.Array[PickerValue], t1: /* extend */ PickerValueExtend) => (value(t0, t1)).runNow()))
      
      inline def setOnChangeUndefined: Self = StObject.set(x, "onChange", js.undefined)
      
      inline def setRenderLabel(value: /* item */ PickerColumnItem => Node): Self = StObject.set(x, "renderLabel", js.Any.fromFunction1(value))
      ...
      inline def setValue(value: js.Array[PickerValue]): Self = StObject.set(x, "value", value.asInstanceOf[js.Any])
      
      inline def setValueUndefined: Self = StObject.set(x, "value", js.undefined)
      
      inline def setValueVarargs(value: PickerValue*): Self = StObject.set(x, "value", js.Array(value*))
    }
  }
}
