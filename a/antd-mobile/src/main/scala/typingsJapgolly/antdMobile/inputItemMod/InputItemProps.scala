...
import typingsJapgolly.antdMobile.antdMobileStrings.inherit
...
import typingsJapgolly.antdMobile.antdMobileStrings.no
...
import typingsJapgolly.antdMobile.antdMobileStrings.on
...
import typingsJapgolly.antdMobile.antdMobileStrings.yes
import typingsJapgolly.antdMobile.inputItemPropsTypeMod.InputItemPropsType
...
object InputItemProps {
  ...
  def apply(
    ...
    onErrorClick: ReactMouseEventFrom[HTMLDivElement] => Callback = null,
    onExtraClick: ReactMouseEventFrom[HTMLDivElement] => Callback = null,
    ...
    if (onErrorClick != null) __obj.updateDynamic("onErrorClick")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLDivElement]) => onErrorClick(t0).runNow()))
    if (onExtraClick != null) __obj.updateDynamic("onExtraClick")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLDivElement]) => onExtraClick(t0).runNow()))
