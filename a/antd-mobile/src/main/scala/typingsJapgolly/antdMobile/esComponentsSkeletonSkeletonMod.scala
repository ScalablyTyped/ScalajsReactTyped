...
import typingsJapgolly.antdMobile.anon.CSSPropertiesPartialRecorBackgroundPosition
...
object esComponentsSkeletonSkeletonMod {
  
  @JSImport("antd-mobile/es/components/skeleton/skeleton", "Skeleton")
  @js.native
  val Skeleton: FC[SkeletonProps] = js.native
  
  @JSImport("antd-mobile/es/components/skeleton/skeleton", "SkeletonParagraph")
  @js.native
  val SkeletonParagraph: FC[SkeletonParagraphProps] = js.native
  
  @JSImport("antd-mobile/es/components/skeleton/skeleton", "SkeletonTitle")
  @js.native
  val SkeletonTitle: FC[SkeletonTitleProps] = js.native
  
  /* Inlined {  animated :boolean | undefined,   lineCount :number | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  ...
  /* Inlined {  animated :boolean | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<'--width' | '--height' | '--border-radius'> */
  trait SkeletonProps extends StObject {
    ...
    var style: js.UndefOr[CSSPropertiesPartialRecorBackgroundPosition] = js.undefined
  ...
  object SkeletonProps {
    ...
    extension [Self <: SkeletonProps](x: Self) {
      ...
      inline def setStyle(value: CSSPropertiesPartialRecorBackgroundPosition): Self = StObject.set(x, "style", value.asInstanceOf[js.Any])
  ...
  /* Inlined {  animated :boolean | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
