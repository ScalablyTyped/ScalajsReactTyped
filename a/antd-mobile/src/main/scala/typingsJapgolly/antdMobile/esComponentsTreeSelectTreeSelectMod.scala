...
import typingsJapgolly.antdMobile.anon.Options
...
object esComponentsTreeSelectTreeSelectMod {
  
  @JSImport("antd-mobile/es/components/tree-select/tree-select", "TreeSelect")
  @js.native
  val TreeSelect: FC[TreeSelectProps] = js.native
  
  type TreeSelectOption = StringDictionary[Any]
  
  /* Inlined {  options :std.Array<antd-mobile.antd-mobile/es/components/tree-select/tree-select.TreeSelectOption>,   defaultValue :std.Array<string> | undefined,   value :std.Array<string> | undefined,   onChange :(value : std.Array<string>, extend : {  options :std.Array<antd-mobile.antd-mobile/es/components/tree-select/tree-select.TreeSelectOption>}): void | undefined,   fieldNames :{  label :string,   value :string,   children :string} | undefined} & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait TreeSelectProps extends StObject {
    ...
    var onChange: js.UndefOr[js.Function2[/* value */ js.Array[String], /* extend */ Options, Unit]] = js.undefined
  ...
  object TreeSelectProps {
    ...
    inline def apply(options: js.Array[TreeSelectOption]): TreeSelectProps = {
    ...
    extension [Self <: TreeSelectProps](x: Self) {
      ...
      inline def setOnChange(value: (/* value */ js.Array[String], /* extend */ Options) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ js.Array[String], t1: /* extend */ Options) => (value(t0, t1)).runNow()))
