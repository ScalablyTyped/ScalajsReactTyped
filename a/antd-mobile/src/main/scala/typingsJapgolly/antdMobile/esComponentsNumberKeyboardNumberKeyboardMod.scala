...
object esComponentsNumberKeyboardNumberKeyboardMod {
  
  @JSImport("antd-mobile/es/components/number-keyboard/number-keyboard", "NumberKeyboard")
  @js.native
  val NumberKeyboard: FC[NumberKeyboardProps] = js.native
  
  /* Inlined {  visible :boolean | undefined,   title :string | undefined,   confirmText :string | null | undefined,   customKey :string | [string, string] | undefined,   randomOrder :boolean | undefined,   showCloseButton :boolean | undefined,   onInput :(v : string): void | undefined,   onDelete :(): void | undefined,   onClose :(): void | undefined,   onConfirm :(): void | undefined,   closeOnConfirm :boolean | undefined,   safeArea :boolean | undefined} & std.Pick<antd-mobile.antd-mobile/es/components/popup.PopupProps, 'afterClose' | 'afterShow' | 'getContainer' | 'destroyOnClose' | 'forceRender' | 'stopPropagation'> & antd-mobile.antd-mobile/es/utils/native-props.NativeProps<never> */
  trait NumberKeyboardProps extends StObject {
    ...
    var confirmText: js.UndefOr[String | Null] = js.undefined
    
    var customKey: js.UndefOr[String | (js.Tuple2[String, String])] = js.undefined
    ...
    var onInput: js.UndefOr[js.Function1[/* v */ String, Unit]] = js.undefined
    
    var randomOrder: js.UndefOr[Boolean] = js.undefined
  ...
  object NumberKeyboardProps {
    
    inline def apply(): NumberKeyboardProps = {
    ...
    extension [Self <: NumberKeyboardProps](x: Self) {
      ...
      inline def setCustomKey(value: String | (js.Tuple2[String, String])): Self = StObject.set(x, "customKey", value.asInstanceOf[js.Any])
      
      inline def setCustomKeyUndefined: Self = StObject.set(x, "customKey", js.undefined)
      ...
      inline def setOnInput(value: /* v */ String => Callback): Self = StObject.set(x, "onInput", js.Any.fromFunction1((t0: /* v */ String) => value(t0).runNow()))
      
      inline def setOnInputUndefined: Self = StObject.set(x, "onInput", js.undefined)
      
      inline def setRandomOrder(value: Boolean): Self = StObject.set(x, "randomOrder", value.asInstanceOf[js.Any])
      
      inline def setRandomOrderUndefined: Self = StObject.set(x, "randomOrder", js.undefined)
