...
class Query protected ()
  extends typingsJapgolly.avoscloudSdk.mod.Query {
...
object Query extends js.Object {
  def and(var_args: typingsJapgolly.avoscloudSdk.mod.Query*): typingsJapgolly.avoscloudSdk.mod.Query = js.native
  def or(var_args: typingsJapgolly.avoscloudSdk.mod.Query*): typingsJapgolly.avoscloudSdk.mod.Query = js.native
}
