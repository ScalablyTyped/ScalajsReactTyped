...
import typingsJapgolly.avoscloudSdk.mod.Collection.Options
...
@js.native
class Collection[T] ()
  extends typingsJapgolly.avoscloudSdk.mod.Collection[T] {
  def this(models: js.Array[typingsJapgolly.avoscloudSdk.mod.Object]) = this()
  def this(models: js.Array[typingsJapgolly.avoscloudSdk.mod.Object], options: Options) = this()
}
