...
import typingsJapgolly.argparse.anon.Instantiable
import typingsJapgolly.argparse.anon.InstantiableAny
import typingsJapgolly.argparse.anon.Required
import typingsJapgolly.argparse.anon.`0`
...
object mod {
  ...
  trait ActionConstructorOptions
    ...
    @JSName("_")
    var _underscore: typingsJapgolly.argparse.argparseStrings.ActionConstructorOptions = js.native
  }
