...
import typingsJapgolly.asyncRedis.asyncRedisStrings.AFTER
import typingsJapgolly.asyncRedis.asyncRedisStrings.ASYNC
import typingsJapgolly.asyncRedis.asyncRedisStrings.BEFORE
import typingsJapgolly.asyncRedis.asyncRedisStrings.OK
...
object mod extends Shortcut {
  ...
  type Omitted = Omit[
    ...
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 116, starting with typingsJapgolly.asyncRedis.asyncRedisStrings.client_, typingsJapgolly.asyncRedis.asyncRedisStrings.CLIENT, typingsJapgolly.asyncRedis.asyncRedisStrings.hmset_ */ Any
  ]
