...
import typingsJapgolly.antDesignProUtils.esTypingMod.ProCoreActionType
import typingsJapgolly.antDesignProUtils.esTypingMod.ProFieldProps
import typingsJapgolly.antDesignProUtils.esTypingMod.ProFieldRequestData
...
import typingsJapgolly.antDesignProUtils.esTypingMod.ProSchemaValueEnumMap
import typingsJapgolly.antDesignProUtils.esTypingMod.ProSchemaValueEnumObj
import typingsJapgolly.antDesignProUtils.esTypingMod.ProTableEditableFnType
...
object DataIndex {
  ...
  extension [Self <: DataIndex[?, ?, ?, ?, ?], Entity, ExtraProps, ComponentsType, ExtraFormItemProps, ValueType](x: Self & (DataIndex[Entity, ExtraProps, ComponentsType, ExtraFormItemProps, ValueType])) {
    ...
    inline def setRender(
      value: (/* dom */ Node, /* entity */ Entity, /* index */ Double, /* action */ js.UndefOr[ProCoreActionType[js.Object]], /* schema */ (ProSchema[Entity, ExtraProps, ComponentsType, ValueType, Any]) & Type[ComponentsType]) => Node | Props
    ...
    inline def setTitleFunction3(
      value: (/* schema */ ProSchema[Entity, ExtraProps, ProSchemaComponentTypes, text, Any], /* type */ ComponentsType, /* dom */ Node) => Node
