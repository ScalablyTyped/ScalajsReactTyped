...
import typingsJapgolly.antDesignProUtils.anon.Constructor
...
object esConversionMomentValueMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antDesignProUtils.antDesignProUtilsStrings.number
    - typingsJapgolly.antDesignProUtils.antDesignProUtilsStrings.string
    - js.Function2[
  / * value * / typingsJapgolly.dayjs.mod.Dayjs, 
  / * valueType * / java.lang.String, 
  java.lang.String | scala.Double]
    - typingsJapgolly.antDesignProUtils.antDesignProUtilsBooleans.`false`
  */
