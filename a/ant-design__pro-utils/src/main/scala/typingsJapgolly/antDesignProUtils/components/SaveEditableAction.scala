...
import typingsJapgolly.antDesignProUtils.esUseEditableArrayMod.ActionRenderConfig
...
object SaveEditableAction {
  ...
  inline def apply[T](
    ...
    val __props = js.Dynamic.literal(cancelEditable = js.Any.fromFunction1((t0: RecordKey) => cancelEditable(t0).runNow()), children = children.asInstanceOf[js.Any], recordKey = recordKey.asInstanceOf[js.Any], row = row.asInstanceOf[js.Any], setEditableRowKeys = js.Any.fromFunction1((t0: js.Array[Key]) => setEditableRowKeys(t0).runNow()))
    new Builder[T](js.Array(this.component, __props.asInstanceOf[(ActionRenderConfig[T, NewLineConfig[T]]) & Row]))
  }
  
  @JSImport("@ant-design/pro-utils/es/useEditableArray", "SaveEditableAction")
  @js.native
  ...
  open class Builder[T] (val args: js.Array[Any])
    ...
    inline def addEditRecord(value: (T, /* options */ js.UndefOr[AddLineOptions]) => Boolean): this.type = set("addEditRecord", js.Any.fromFunction2(value))
    ...
    inline def newLineConfig(value: NewLineConfig[T]): this.type = set("newLineConfig", value.asInstanceOf[js.Any])
    ...
    inline def onDelete(value: (/* key */ RecordKey, /* row */ T & `0`) => js.Promise[Any | Unit]): this.type = set("onDelete", js.Any.fromFunction2(value))
  ...
  def withProps[T](p: (ActionRenderConfig[T, NewLineConfig[T]]) & Row): Builder[T] = new Builder[T](js.Array(this.component, p.asInstanceOf[js.Any]))
}
