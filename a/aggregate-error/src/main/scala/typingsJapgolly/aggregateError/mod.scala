...
object mod {
  ...
  open class default[T /* <: js.Error */] protected ()
    ...
    /* CompleteClass */
    @JSName("name")
    override val name_AggregateError: typingsJapgolly.aggregateError.aggregateErrorStrings.AggregateError = js.native
  }
  ...
  trait AggregateError[T /* <: js.Error */]
    ...
    @JSName("name")
    val name_AggregateError: typingsJapgolly.aggregateError.aggregateErrorStrings.AggregateError
  }
  object AggregateError {
    ...
    extension [Self <: AggregateError[?], T /* <: js.Error */](x: Self & AggregateError[T]) {
      ...
      inline def setName(value: typingsJapgolly.aggregateError.aggregateErrorStrings.AggregateError): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
}
