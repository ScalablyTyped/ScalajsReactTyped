package typingsJapgolly.azureLogger
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azureLogger.azureLoggerStrings.verbose
    - typingsJapgolly.azureLogger.azureLoggerStrings.info
    - typingsJapgolly.azureLogger.azureLoggerStrings.warning
    - typingsJapgolly.azureLogger.azureLoggerStrings.error
  */
  trait AzureLogLevel extends StObject
  object AzureLogLevel {
    
    inline def error: typingsJapgolly.azureLogger.azureLoggerStrings.error = "error".asInstanceOf[typingsJapgolly.azureLogger.azureLoggerStrings.error]
    
    inline def info: typingsJapgolly.azureLogger.azureLoggerStrings.info = "info".asInstanceOf[typingsJapgolly.azureLogger.azureLoggerStrings.info]
    
    inline def verbose: typingsJapgolly.azureLogger.azureLoggerStrings.verbose = "verbose".asInstanceOf[typingsJapgolly.azureLogger.azureLoggerStrings.verbose]
    
    inline def warning: typingsJapgolly.azureLogger.azureLoggerStrings.warning = "warning".asInstanceOf[typingsJapgolly.azureLogger.azureLoggerStrings.warning]
  }
