...
object httpMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.architectFunctions.architectFunctionsStrings.GET
    - typingsJapgolly.architectFunctions.architectFunctionsStrings.POST
    - typingsJapgolly.architectFunctions.architectFunctionsStrings.PATCH
    - typingsJapgolly.architectFunctions.architectFunctionsStrings.PUT
    - typingsJapgolly.architectFunctions.architectFunctionsStrings.DELETE
  */
  trait HttpMethods extends StObject
  object HttpMethods {
    
    inline def DELETE: typingsJapgolly.architectFunctions.architectFunctionsStrings.DELETE = "DELETE".asInstanceOf[typingsJapgolly.architectFunctions.architectFunctionsStrings.DELETE]
    
    inline def GET: typingsJapgolly.architectFunctions.architectFunctionsStrings.GET = "GET".asInstanceOf[typingsJapgolly.architectFunctions.architectFunctionsStrings.GET]
    
    inline def PATCH: typingsJapgolly.architectFunctions.architectFunctionsStrings.PATCH = "PATCH".asInstanceOf[typingsJapgolly.architectFunctions.architectFunctionsStrings.PATCH]
    
    inline def POST: typingsJapgolly.architectFunctions.architectFunctionsStrings.POST = "POST".asInstanceOf[typingsJapgolly.architectFunctions.architectFunctionsStrings.POST]
    
    inline def PUT: typingsJapgolly.architectFunctions.architectFunctionsStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.architectFunctions.architectFunctionsStrings.PUT]
  }
