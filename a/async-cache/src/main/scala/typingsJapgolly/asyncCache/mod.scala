package typingsJapgolly.asyncCache
...
object mod extends Shortcut {
  ...
  object Options {
    ...
    inline def apply[T](
      load: (String, js.Function3[/* error */ Any, /* asyncValue */ T, /* maxAge */ js.UndefOr[Double], Unit]) => Callback
    ): Options[T] = {
      val __obj = js.Dynamic.literal(load = js.Any.fromFunction2((t0: String, t1: js.Function3[/* error */ Any, /* asyncValue */ T, /* maxAge */ js.UndefOr[Double], Unit]) => (load(t0, t1)).runNow()))
    ...
    extension [Self <: Options[?], T](x: Self & Options[T]) {
      ...
      inline def setLoad(
        value: (String, js.Function3[/* error */ Any, /* asyncValue */ T, /* maxAge */ js.UndefOr[Double], Unit]) => Callback
      ): Self = StObject.set(x, "load", js.Any.fromFunction2((t0: String, t1: js.Function3[/* error */ Any, /* asyncValue */ T, /* maxAge */ js.UndefOr[Double], Unit]) => (value(t0, t1)).runNow()))
    }
  }
