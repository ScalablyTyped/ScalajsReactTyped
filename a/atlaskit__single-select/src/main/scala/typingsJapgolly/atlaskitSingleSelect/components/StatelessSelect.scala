...
object StatelessSelect {
  def apply(
    ...
    StatelessProps, 
    typingsJapgolly.atlaskitSingleSelect.mod.StatelessSelect, 
    Unit, 
    StatelessProps
  ] = {
  ...
  typingsJapgolly.atlaskitSingleSelect.mod.StatelessProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.atlaskitSingleSelect.mod.StatelessSelect](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.atlaskitSingleSelect.mod.StatelessProps])(children: _*)
  }
