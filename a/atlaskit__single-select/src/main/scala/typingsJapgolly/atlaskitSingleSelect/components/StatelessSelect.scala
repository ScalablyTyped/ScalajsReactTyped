...
import typingsJapgolly.atlaskitSingleSelect.mod.StatelessProps
...
object StatelessSelect {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.atlaskitSingleSelect.mod.StatelessSelect] {
    
    inline def appearance(value: default | subtle): this.type = set("appearance", value.asInstanceOf[js.Any])
    ...
    inline def loadingMessage(value: String): this.type = set("loadingMessage", value.asInstanceOf[js.Any])
    ...
    inline def selectedItem(value: ItemType): this.type = set("selectedItem", value.asInstanceOf[js.Any])
