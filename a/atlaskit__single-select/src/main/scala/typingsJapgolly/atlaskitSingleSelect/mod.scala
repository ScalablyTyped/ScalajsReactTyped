...
object mod {
  ...
  object ItemType {
    ...
    extension [Self <: ItemType](x: Self) {
      ...
      inline def setElemBefore(value: VdomNode): Self = StObject.set(x, "elemBefore", value.rawNode.asInstanceOf[js.Any])
      
      inline def setElemBeforeNull: Self = StObject.set(x, "elemBefore", null)
      
      inline def setElemBeforeUndefined: Self = StObject.set(x, "elemBefore", js.undefined)
      
      inline def setElemBeforeVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "elemBefore", js.Array(value*))
      
      inline def setElemBeforeVdomElement(value: VdomElement): Self = StObject.set(x, "elemBefore", value.rawElement.asInstanceOf[js.Any])
  ...
  trait Props extends StObject {
    ...
    var appearance: js.UndefOr[
        typingsJapgolly.atlaskitSingleSelect.atlaskitSingleSelectStrings.default | subtle
      ] = js.undefined
    ...
    var invalidMessage: js.UndefOr[Node] = js.undefined
  ...
  object Props {
    ...
    extension [Self <: Props](x: Self) {
      ...
      inline def setAppearance(value: typingsJapgolly.atlaskitSingleSelect.atlaskitSingleSelectStrings.default | subtle): Self = StObject.set(x, "appearance", value.asInstanceOf[js.Any])
      ...
      inline def setInvalidMessage(value: VdomNode): Self = StObject.set(x, "invalidMessage", value.rawNode.asInstanceOf[js.Any])
      
      inline def setInvalidMessageNull: Self = StObject.set(x, "invalidMessage", null)
      
      inline def setInvalidMessageUndefined: Self = StObject.set(x, "invalidMessage", js.undefined)
      
      inline def setInvalidMessageVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "invalidMessage", js.Array(value*))
      
      inline def setInvalidMessageVdomElement(value: VdomElement): Self = StObject.set(x, "invalidMessage", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnFilterChange(value: /* filter */ String => Callback): Self = StObject.set(x, "onFilterChange", js.Any.fromFunction1((t0: /* filter */ String) => value(t0).runNow()))
      
      inline def setOnFilterChangeUndefined: Self = StObject.set(x, "onFilterChange", js.undefined)
      
      inline def setOnOpenChange(value: /* change */ Event => Callback): Self = StObject.set(x, "onOpenChange", js.Any.fromFunction1((t0: /* change */ Event) => value(t0).runNow()))
      
      inline def setOnOpenChangeUndefined: Self = StObject.set(x, "onOpenChange", js.undefined)
      
      inline def setOnSelected(value: /* item */ ItemType => Callback): Self = StObject.set(x, "onSelected", js.Any.fromFunction1((t0: /* item */ ItemType) => value(t0).runNow()))
  ...
  type SingleSelect = japgolly.scalajs.react.facade.React.Component[Props & js.Object, js.Object]
