...
import typingsJapgolly.angularCompilerCli.srcNgtscAnnotationsComponentSrcResourcesMod.ResourceTypeForDiagnostics
import typingsJapgolly.angularCompilerCli.srcNgtscCyclesSrcAnalyzerMod.CycleHandlingStrategy
import typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcEmitterMod.ReferenceEmitKind
import typingsJapgolly.angularCompilerCli.srcNgtscPartialEvaluatorSrcDynamicMod.DynamicValueReason
import typingsJapgolly.angularCompilerCli.srcNgtscReflectionSrcHostMod.DeclarationKind
import typingsJapgolly.angularCompilerCli.srcNgtscReflectionSrcHostMod.TypeValueReferenceKind
import typingsJapgolly.angularCompilerCli.srcNgtscReflectionSrcHostMod.ValueUnavailableKind
