...
import typingsJapgolly.angularCompilerCli.srcNgtscTransformSrcTraitMod.TraitState.Analyzed
import typingsJapgolly.angularCompilerCli.srcNgtscTransformSrcTraitMod.TraitState.Pending
import typingsJapgolly.angularCompilerCli.srcNgtscTransformSrcTraitMod.TraitState.Resolved
import typingsJapgolly.angularCompilerCli.srcNgtscTransformSrcTraitMod.TraitState.Skipped
...
object srcNgtscTransformSrcTraitMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.srcNgtscTransformSrcTraitMod.PendingTrait[D, A, S, R]
    - typingsJapgolly.angularCompilerCli.srcNgtscTransformSrcTraitMod.SkippedTrait[D, A, S, R]
    - typingsJapgolly.angularCompilerCli.srcNgtscTransformSrcTraitMod.AnalyzedTrait[D, A, S, R]
    - typingsJapgolly.angularCompilerCli.srcNgtscTransformSrcTraitMod.ResolvedTrait[D, A, S, R]
  */
