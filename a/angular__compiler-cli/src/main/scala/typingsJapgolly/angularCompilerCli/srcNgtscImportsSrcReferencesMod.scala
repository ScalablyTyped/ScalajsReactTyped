...
object srcNgtscImportsSrcReferencesMod {
  ...
  open class Reference[T /* <: Node */] protected () extends StObject {
    ...
    /**
      ...
      */
    def getIdentityInExpression(expr: typingsJapgolly.typescript.mod.Expression): Identifier | Null = js.native
    ...
    /**
      ...
      */
    def getOriginForDiagnostics(container: typingsJapgolly.typescript.mod.Expression): typingsJapgolly.typescript.mod.Expression = js.native
    def getOriginForDiagnostics(
      container: typingsJapgolly.typescript.mod.Expression,
      fallback: typingsJapgolly.typescript.mod.Expression
    ): typingsJapgolly.typescript.mod.Expression = js.native
