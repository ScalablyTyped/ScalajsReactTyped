...
import typingsJapgolly.angularCompiler.mod.ChangeDetectionStrategy
...
import typingsJapgolly.angularCompiler.mod.R3HostMetadata
import typingsJapgolly.angularCompiler.mod.R3QueryMetadata
import typingsJapgolly.angularCompiler.mod.R3Reference
import typingsJapgolly.angularCompiler.mod.ViewEncapsulation
