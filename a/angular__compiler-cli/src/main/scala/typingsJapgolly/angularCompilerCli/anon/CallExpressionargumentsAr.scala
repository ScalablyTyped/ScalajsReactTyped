...
/* Inlined typescript.typescript.CallExpression & {  arguments :[typescript.typescript.ArrayLiteralExpression, typescript.typescript.Expression]} */
@js.native
trait CallExpressionargumentsAr extends StObject {
  ...
  val arguments: NodeArray[Expression] & (js.Tuple2[ArrayLiteralExpression, Expression]) = js.native
