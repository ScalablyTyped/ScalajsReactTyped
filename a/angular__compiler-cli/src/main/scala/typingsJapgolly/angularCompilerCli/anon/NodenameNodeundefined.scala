...
/* Inlined typescript.typescript.Node & {  name :typescript.typescript.Node | undefined} */
@js.native
trait NodenameNodeundefined extends StObject {
  ...
  var name: js.UndefOr[Node] = js.native
