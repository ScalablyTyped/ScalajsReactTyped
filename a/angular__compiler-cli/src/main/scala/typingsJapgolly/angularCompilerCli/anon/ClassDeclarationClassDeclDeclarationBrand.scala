...
import typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcTypeCheckBlockMod.Context
...
import typingsJapgolly.typescript.mod.SyntaxKind.ClassDeclaration
