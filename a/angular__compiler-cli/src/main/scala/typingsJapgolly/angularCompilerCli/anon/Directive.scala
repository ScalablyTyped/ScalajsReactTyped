...
import typingsJapgolly.angularCompilerCli.srcNgtscIndexerSrcApiMod.ElementIdentifier
import typingsJapgolly.angularCompilerCli.srcNgtscIndexerSrcApiMod.TemplateIdentifier
