...
import typingsJapgolly.angularCompilerCli.srcNgtscAnnotationsNgModuleSrcHandlerMod.TopLevelImportedExpression
...
trait ReadonlyNgModuleAnalysis extends StObject {
  ...
  val providers: js.UndefOr[typingsJapgolly.typescript.mod.Expression | Null] = js.undefined
  
  val providersRequiringFactory: js.UndefOr[Set[Reference[ClassDeclaration[DeclarationNode]]] | Null] = js.undefined
  
  val rawDeclarations: js.UndefOr[typingsJapgolly.typescript.mod.Expression | Null] = js.undefined
  
  val rawExports: js.UndefOr[typingsJapgolly.typescript.mod.Expression | Null] = js.undefined
  
  val rawImports: js.UndefOr[typingsJapgolly.typescript.mod.Expression | Null] = js.undefined
