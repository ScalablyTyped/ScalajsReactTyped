...
import typingsJapgolly.angularCompilerCli.ngccSrcPackagesConfigurationMod.NgccEntryPointConfig
import typingsJapgolly.angularCompilerCli.ngccSrcPackagesConfigurationMod.RawNgccPackageConfig
