...
import typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.FullTemplateMapping
import typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.SourceLocation
...
object srcNgtscTypecheckSrcTcbUtilMod {
  ...
  object TcbInliningRequirement extends StObject {
    ...
    /* 0 */ val MustInline: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcTcbUtilMod.TcbInliningRequirement.MustInline & Double = js.native
    ...
    sealed trait None
      extends StObject
         with TcbInliningRequirement
    /* 2 */ val None: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcTcbUtilMod.TcbInliningRequirement.None & Double = js.native
    ...
    sealed trait ShouldInlineForGenericBounds
      extends StObject
         with TcbInliningRequirement
    /* 1 */ val ShouldInlineForGenericBounds: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcTcbUtilMod.TcbInliningRequirement.ShouldInlineForGenericBounds & Double = js.native
  }
