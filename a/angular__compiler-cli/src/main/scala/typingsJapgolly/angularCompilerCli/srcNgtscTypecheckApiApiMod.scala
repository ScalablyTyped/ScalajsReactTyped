...
import typingsJapgolly.angularCompilerCli.angularCompilerCliBooleans.`false`
import typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.direct
import typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.external
import typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.indirect
import typingsJapgolly.angularCompilerCli.anon.ClassDeclarationClassDecl
import typingsJapgolly.angularCompilerCli.anon.Inputs
...
import typingsJapgolly.angularCompilerCli.srcNgtscMetadataSrcApiMod.TemplateGuardMeta
...
object srcNgtscTypecheckApiApiMod {
  ...
  trait TemplateId
    ...
    var __brand: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.TemplateId = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.DirectTemplateSourceMapping
    - typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.IndirectTemplateSourceMapping
    - typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.ExternalTemplateSourceMapping
  */
  trait TemplateSourceMapping extends StObject
  object TemplateSourceMapping {
    
    inline def DirectTemplateSourceMapping(node: StringLiteral | NoSubstitutionTemplateLiteral): typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.DirectTemplateSourceMapping = {
      val __obj = js.Dynamic.literal(node = node.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("direct")
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.DirectTemplateSourceMapping]
    }
    ...
    inline def ExternalTemplateSourceMapping(
      ...
      val __obj = js.Dynamic.literal(componentClass = componentClass.asInstanceOf[js.Any], node = node.asInstanceOf[js.Any], template = template.asInstanceOf[js.Any], templateUrl = templateUrl.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("external")
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.ExternalTemplateSourceMapping]
    }
    
    inline def IndirectTemplateSourceMapping(componentClass: ClassDeclaration[DeclarationNode], node: Expression, template: String): typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.IndirectTemplateSourceMapping = {
      val __obj = js.Dynamic.literal(componentClass = componentClass.asInstanceOf[js.Any], node = node.asInstanceOf[js.Any], template = template.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("indirect")
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiApiMod.IndirectTemplateSourceMapping]
    }
  }
