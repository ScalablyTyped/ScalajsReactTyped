...
import typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSemanticGraphMod.SemanticDepGraph
import typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcDependencyTrackingMod.FileDependencyGraph
import typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.IncrementalStateKind.Analyzed
import typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.IncrementalStateKind.Delta
import typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.IncrementalStateKind.Fresh
...
object srcNgtscIncrementalSrcStateMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.AnalyzedIncrementalState
    - typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.DeltaIncrementalState
    - typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.FreshIncrementalState
  */
  ...
  object IncrementalState {
    ...
    inline def AnalyzedIncrementalState(
      ...
      val __obj = js.Dynamic.literal(depGraph = depGraph.asInstanceOf[js.Any], emitted = emitted.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], priorAnalysis = priorAnalysis.asInstanceOf[js.Any], semanticDepGraph = semanticDepGraph.asInstanceOf[js.Any], typeCheckResults = null, versions = null)
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.AnalyzedIncrementalState]
    }
    ...
    inline def DeltaIncrementalState(
      ...
      val __obj = js.Dynamic.literal(changedResourceFiles = changedResourceFiles.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], lastAnalyzedState = lastAnalyzedState.asInstanceOf[js.Any], physicallyChangedTsFiles = physicallyChangedTsFiles.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.DeltaIncrementalState]
    }
    
    inline def FreshIncrementalState(kind: Fresh): typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.FreshIncrementalState = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscIncrementalSrcStateMod.FreshIncrementalState]
    }
  }
}
