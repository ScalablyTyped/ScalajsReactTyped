...
import typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.CompletionKind.Reference
import typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.CompletionKind.Variable
...
object srcNgtscTypecheckApiCompletionMod {
  ...
  object CompletionKind extends StObject {
    ...
    sealed trait Reference
      extends StObject
         with CompletionKind
    /* 0 */ val Reference: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.CompletionKind.Reference & Double = js.native
    
    @js.native
    sealed trait Variable
      extends StObject
         with CompletionKind
    /* 1 */ val Variable: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.CompletionKind.Variable & Double = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.ReferenceCompletion
    - typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.VariableCompletion
  */
  trait Completion extends StObject
  object Completion {
    
    inline def ReferenceCompletion(kind: Reference, node: TmplAstReference): typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.ReferenceCompletion = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], node = node.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.ReferenceCompletion]
    }
    
    inline def VariableCompletion(kind: Variable, node: TmplAstVariable): typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.VariableCompletion = {
      val __obj = js.Dynamic.literal(kind = kind.asInstanceOf[js.Any], node = node.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscTypecheckApiCompletionMod.VariableCompletion]
    }
  }
