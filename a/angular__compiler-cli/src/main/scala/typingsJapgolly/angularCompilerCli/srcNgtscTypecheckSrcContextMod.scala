...
import typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcSourceMod.TemplateSourceManager
import typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcTypeCheckFileMod.TypeCheckFile
...
object srcNgtscTypecheckSrcContextMod {
  ...
  object InliningMode extends StObject {
    ...
    sealed trait Error
      extends StObject
         with InliningMode
    /* 1 */ val Error: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcContextMod.InliningMode.Error & Double = js.native
    ...
    sealed trait InlineOps
      extends StObject
         with InliningMode
    /* 0 */ val InlineOps: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcContextMod.InliningMode.InlineOps & Double = js.native
  }
  ...
  object TypeCheckingHost {
    ...
    inline def apply(
      ...
      recordComplete: AbsoluteFsPath => Callback,
      recordShimData: (AbsoluteFsPath, ShimTypeCheckingData) => Callback,
      shouldCheckComponent: ClassDeclaration => Boolean
    ): TypeCheckingHost = {
      val __obj = js.Dynamic.literal(getSourceManager = js.Any.fromFunction1(getSourceManager), recordComplete = js.Any.fromFunction1((t0: AbsoluteFsPath) => recordComplete(t0).runNow()), recordShimData = js.Any.fromFunction2((t0: AbsoluteFsPath, t1: ShimTypeCheckingData) => (recordShimData(t0, t1)).runNow()), shouldCheckComponent = js.Any.fromFunction1(shouldCheckComponent))
    ...
    extension [Self <: TypeCheckingHost](x: Self) {
      ...
      inline def setRecordComplete(value: AbsoluteFsPath => Callback): Self = StObject.set(x, "recordComplete", js.Any.fromFunction1((t0: AbsoluteFsPath) => value(t0).runNow()))
      
      inline def setRecordShimData(value: (AbsoluteFsPath, ShimTypeCheckingData) => Callback): Self = StObject.set(x, "recordShimData", js.Any.fromFunction2((t0: AbsoluteFsPath, t1: ShimTypeCheckingData) => (value(t0, t1)).runNow()))
