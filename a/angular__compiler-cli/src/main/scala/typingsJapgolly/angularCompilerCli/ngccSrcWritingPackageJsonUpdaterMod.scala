...
import typingsJapgolly.angularCompilerCli.ngccSrcUtilsMod.JsonValue
...
object ngccSrcWritingPackageJsonUpdaterMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.unimportant
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.alphabetic
    - typingsJapgolly.angularCompilerCli.anon.Before
  */
