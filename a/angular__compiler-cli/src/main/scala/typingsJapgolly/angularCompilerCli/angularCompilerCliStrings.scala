...
import typingsJapgolly.angularCompilerCli.ngccSrcNgccOptionsMod.OptionalNgccOptionKeys
...
import typingsJapgolly.angularCompilerCli.ngccSrcPackagesEntryPointMod.PackageJsonFormatProperties
import typingsJapgolly.angularCompilerCli.ngccSrcWritingPackageJsonUpdaterMod.PackageJsonPropertyPositioning
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcAdapterMod.ExtendedCompilerHostMethods
import typingsJapgolly.angularCompilerCli.srcNgtscTranslatorSrcApiAstFactoryMod.BinaryOperator
import typingsJapgolly.angularCompilerCli.srcNgtscTranslatorSrcApiAstFactoryMod.UnaryOperator
import typingsJapgolly.angularCompilerCli.srcNgtscTranslatorSrcApiAstFactoryMod.VariableDeclarationType
...
object angularCompilerCliStrings {
  ...
  @js.native
  sealed trait typings
    extends StObject
       with PackageJsonFormatProperties
  inline def typings: typings = "typings".asInstanceOf[typings]
