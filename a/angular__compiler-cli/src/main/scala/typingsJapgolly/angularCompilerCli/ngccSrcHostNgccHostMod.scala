...
import typingsJapgolly.angularCompilerCli.srcNgtscReflectionSrcHostMod.ConcreteDeclaration
...
import typingsJapgolly.angularCompilerCli.srcNgtscReflectionSrcHostMod.InlineDeclaration
