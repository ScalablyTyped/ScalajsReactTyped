  ...
  trait DtsTransform extends StObject {
    ...
    var transformClass: js.UndefOr[
        js.Function3[
          ...
          typingsJapgolly.typescript.mod.ClassDeclaration
        ]
      ] = js.undefined
  ...
  object DtsTransform {
    ...
    extension [Self <: DtsTransform](x: Self) {
      ...
      inline def setTransformClass(
        value: (/* clazz */ typingsJapgolly.typescript.mod.ClassDeclaration, /* elements */ js.Array[ClassElement], /* imports */ ImportManager) => typingsJapgolly.typescript.mod.ClassDeclaration
