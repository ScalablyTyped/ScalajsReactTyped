...
object srcNgtscCoreApiSrcAdapterMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getCanonicalFileName
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.resolveModuleNames
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getCurrentDirectory
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getModifiedResourceFiles
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.readResource
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.resourceNameToFileName
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.transformResource
  */
  trait ExtendedCompilerHostMethods extends StObject
  object ExtendedCompilerHostMethods {
    
    inline def getCanonicalFileName: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getCanonicalFileName = "getCanonicalFileName".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getCanonicalFileName]
    
    inline def getCurrentDirectory: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getCurrentDirectory = "getCurrentDirectory".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getCurrentDirectory]
    
    inline def getModifiedResourceFiles: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getModifiedResourceFiles = "getModifiedResourceFiles".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.getModifiedResourceFiles]
    
    inline def readResource: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.readResource = "readResource".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.readResource]
    
    inline def resolveModuleNames: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.resolveModuleNames = "resolveModuleNames".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.resolveModuleNames]
    
    inline def resourceNameToFileName: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.resourceNameToFileName = "resourceNameToFileName".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.resourceNameToFileName]
    
    inline def transformResource: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.transformResource = "transformResource".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.transformResource]
  }
