...
import typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.unknown
...
import typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcReferencesMod.Reference
import typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcResolverMod.ModuleResolver
...
object srcNgtscImportsSrcEmitterMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcEmitterMod.EmittedReference
    - typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcEmitterMod.FailedEmitResult
  */
  trait ReferenceEmitResult extends StObject
  object ReferenceEmitResult {
    
    inline def EmittedReference(expression: Expression): typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcEmitterMod.EmittedReference = {
      val __obj = js.Dynamic.literal(expression = expression.asInstanceOf[js.Any], kind = 0, importedFile = null)
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcEmitterMod.EmittedReference]
    }
    
    inline def FailedEmitResult(context: SourceFile, reason: String, ref: Reference[Node]): typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcEmitterMod.FailedEmitResult = {
      val __obj = js.Dynamic.literal(context = context.asInstanceOf[js.Any], kind = 1, reason = reason.asInstanceOf[js.Any], ref = ref.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscImportsSrcEmitterMod.FailedEmitResult]
    }
  }
