...
import typingsJapgolly.angularCompilerCli.srcNgtscScopeSrcApiMod.ComponentScopeKind.NgModule
import typingsJapgolly.angularCompilerCli.srcNgtscScopeSrcApiMod.ComponentScopeKind.Standalone
...
object srcNgtscScopeSrcApiMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.srcNgtscScopeSrcApiMod.LocalModuleScope
    - typingsJapgolly.angularCompilerCli.srcNgtscScopeSrcApiMod.StandaloneScope
  */
  ...
  object ComponentScope {
    ...
    inline def LocalModuleScope(
      ...
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscScopeSrcApiMod.LocalModuleScope]
    }
    ...
    inline def StandaloneScope(
      ...
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.srcNgtscScopeSrcApiMod.StandaloneScope]
    }
  }
