...
trait ConcreteDeclaration[T /* <: typingsJapgolly.typescript.mod.Declaration */]
  extends StObject
...
object ConcreteDeclaration {
  ...
  inline def apply[T /* <: typingsJapgolly.typescript.mod.Declaration */](node: T): ConcreteDeclaration[T] = {
  ...
  extension [Self <: ConcreteDeclaration[?], T /* <: typingsJapgolly.typescript.mod.Declaration */](x: Self & ConcreteDeclaration[T]) {
