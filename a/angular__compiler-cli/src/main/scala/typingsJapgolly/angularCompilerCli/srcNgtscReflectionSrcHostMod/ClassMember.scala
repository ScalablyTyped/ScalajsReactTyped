...
trait ClassMember extends StObject {
  ...
  /**
    ...
    * ```
    */
  var implementation: typingsJapgolly.typescript.mod.Declaration | Null
...
object ClassMember {
  ...
  extension [Self <: ClassMember](x: Self) {
    ...
    inline def setImplementation(value: typingsJapgolly.typescript.mod.Declaration): Self = StObject.set(x, "implementation", value.asInstanceOf[js.Any])
