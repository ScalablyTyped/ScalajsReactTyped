...
trait NoValueDeclaration
  ...
  var decl: typingsJapgolly.typescript.mod.Declaration | Null
...
object NoValueDeclaration {
  ...
  extension [Self <: NoValueDeclaration](x: Self) {
    ...
    inline def setDecl(value: typingsJapgolly.typescript.mod.Declaration): Self = StObject.set(x, "decl", value.asInstanceOf[js.Any])
