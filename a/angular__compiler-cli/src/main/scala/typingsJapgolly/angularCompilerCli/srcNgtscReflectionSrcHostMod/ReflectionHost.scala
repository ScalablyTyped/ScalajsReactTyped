...
trait ReflectionHost extends StObject {
  ...
  /**
    ...
    * otherwise.
    */
  def getDeclarationOfIdentifier(id: Identifier): Declaration[typingsJapgolly.typescript.mod.Declaration] | Null
  ...
  /**
    ...
    */
  def getDtsDeclaration(declaration: DeclarationNode): typingsJapgolly.typescript.mod.Declaration | Null
  ...
  /**
    ...
    */
  def getExportsOfModule(module: Node): (Map[String, Declaration[typingsJapgolly.typescript.mod.Declaration]]) | Null
...
object ReflectionHost {
  ...
  inline def apply(
    ...
    getDeclarationOfIdentifier: Identifier => Declaration[typingsJapgolly.typescript.mod.Declaration] | Null,
    getDecoratorsOfDeclaration: DeclarationNode => js.Array[Decorator] | Null,
    getDefinitionOfFunction: Node => FunctionDefinition | Null,
    getDtsDeclaration: DeclarationNode => typingsJapgolly.typescript.mod.Declaration | Null,
    getExportsOfModule: Node => (Map[String, Declaration[typingsJapgolly.typescript.mod.Declaration]]) | Null,
  ...
  extension [Self <: ReflectionHost](x: Self) {
    ...
    inline def setGetDeclarationOfIdentifier(value: Identifier => Declaration[typingsJapgolly.typescript.mod.Declaration] | Null): Self = StObject.set(x, "getDeclarationOfIdentifier", js.Any.fromFunction1(value))
    ...
    inline def setGetDtsDeclaration(value: DeclarationNode => typingsJapgolly.typescript.mod.Declaration | Null): Self = StObject.set(x, "getDtsDeclaration", js.Any.fromFunction1(value))
    
    inline def setGetExportsOfModule(value: Node => (Map[String, Declaration[typingsJapgolly.typescript.mod.Declaration]]) | Null): Self = StObject.set(x, "getExportsOfModule", js.Any.fromFunction1(value))
