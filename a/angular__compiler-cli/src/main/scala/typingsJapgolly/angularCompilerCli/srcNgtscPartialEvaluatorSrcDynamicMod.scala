...
import typingsJapgolly.angularCompilerCli.angularCompilerCliInts.`6`
import typingsJapgolly.angularCompilerCli.angularCompilerCliInts.`7`
import typingsJapgolly.angularCompilerCli.angularCompilerCliInts.`8`
import typingsJapgolly.angularCompilerCli.angularCompilerCliInts.`9`
...
object srcNgtscPartialEvaluatorSrcDynamicMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.angularCompilerCli.angularCompilerCliInts.`6`
    - typingsJapgolly.angularCompilerCli.angularCompilerCliInts.`7`
    - typingsJapgolly.angularCompilerCli.angularCompilerCliInts.`8`
    - typingsJapgolly.angularCompilerCli.angularCompilerCliInts.`9`
  */
