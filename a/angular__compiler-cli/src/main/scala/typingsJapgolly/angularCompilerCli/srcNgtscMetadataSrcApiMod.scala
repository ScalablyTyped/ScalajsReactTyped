...
import typingsJapgolly.angularCompiler.mod.InputOutputPropertySet
import typingsJapgolly.angularCompiler.mod.SchemaMetadata
import typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.binding
import typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.dynamic
import typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.invocation
import typingsJapgolly.angularCompilerCli.srcNgtscImportsMod.Reference
import typingsJapgolly.angularCompilerCli.srcNgtscMetadataSrcApiMod.MetaKind.Directive
import typingsJapgolly.angularCompilerCli.srcNgtscMetadataSrcApiMod.MetaKind.NgModule
import typingsJapgolly.angularCompilerCli.srcNgtscMetadataSrcApiMod.MetaKind.Pipe
...
object srcNgtscMetadataSrcApiMod {
  ...
  trait DirectiveMeta
    extends StObject
       with typingsJapgolly.angularCompiler.mod.DirectiveMeta
  ...
  object MetadataRegistry {
    ...
    inline def apply(
      registerDirectiveMetadata: DirectiveMeta => Callback,
      registerNgModuleMetadata: NgModuleMeta => Callback,
      registerPipeMetadata: PipeMeta => Callback
    ): MetadataRegistry = {
      val __obj = js.Dynamic.literal(registerDirectiveMetadata = js.Any.fromFunction1((t0: DirectiveMeta) => registerDirectiveMetadata(t0).runNow()), registerNgModuleMetadata = js.Any.fromFunction1((t0: NgModuleMeta) => registerNgModuleMetadata(t0).runNow()), registerPipeMetadata = js.Any.fromFunction1((t0: PipeMeta) => registerPipeMetadata(t0).runNow()))
      __obj.asInstanceOf[MetadataRegistry]
    }
    
    extension [Self <: MetadataRegistry](x: Self) {
      
      inline def setRegisterDirectiveMetadata(value: DirectiveMeta => Callback): Self = StObject.set(x, "registerDirectiveMetadata", js.Any.fromFunction1((t0: DirectiveMeta) => value(t0).runNow()))
      
      inline def setRegisterNgModuleMetadata(value: NgModuleMeta => Callback): Self = StObject.set(x, "registerNgModuleMetadata", js.Any.fromFunction1((t0: NgModuleMeta) => value(t0).runNow()))
      
      inline def setRegisterPipeMetadata(value: PipeMeta => Callback): Self = StObject.set(x, "registerPipeMetadata", js.Any.fromFunction1((t0: PipeMeta) => value(t0).runNow()))
    }
  }
