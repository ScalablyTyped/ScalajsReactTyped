...
object linkerMod {
  ...
  open class FatalLinkerError protected ()
    extends typingsJapgolly.angularCompilerCli.linkerSrcFatalLinkerErrorMod.FatalLinkerError {
    /**
  ...
  open class FileLinker[TConstantScope, TStatement, TExpression] protected ()
    extends typingsJapgolly.angularCompilerCli.linkerSrcFileLinkerFileLinkerMod.FileLinker[TConstantScope, TStatement, TExpression] {
    def this(
      linkerEnvironment: typingsJapgolly.angularCompilerCli.linkerSrcFileLinkerLinkerEnvironmentMod.LinkerEnvironment[TStatement, TExpression],
  ...
  /* private */ open class LinkerEnvironment[TStatement, TExpression] ()
    extends typingsJapgolly.angularCompilerCli.linkerSrcFileLinkerLinkerEnvironmentMod.LinkerEnvironment[TStatement, TExpression]
  /* static members */
  object LinkerEnvironment {
    ...
    ): typingsJapgolly.angularCompilerCli.linkerSrcFileLinkerLinkerEnvironmentMod.LinkerEnvironment[TStatement, TExpression] = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(fileSystem.asInstanceOf[js.Any], logger.asInstanceOf[js.Any], host.asInstanceOf[js.Any], factory.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.angularCompilerCli.linkerSrcFileLinkerLinkerEnvironmentMod.LinkerEnvironment[TStatement, TExpression]]
  }
