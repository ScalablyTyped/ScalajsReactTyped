...
object srcNgtscTypecheckSrcCommentsMod {
  ...
  object CommentTriviaType extends StObject {
    ...
    /* "D" */ val DIAGNOSTIC: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcCommentsMod.CommentTriviaType.DIAGNOSTIC & String = js.native
    
    @js.native
    sealed trait EXPRESSION_TYPE_IDENTIFIER
      extends StObject
         with CommentTriviaType
    /* "T" */ val EXPRESSION_TYPE_IDENTIFIER: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcCommentsMod.CommentTriviaType.EXPRESSION_TYPE_IDENTIFIER & String = js.native
  }
  ...
  object ExpressionIdentifier extends StObject {
    ...
    /* "COMPCOMP" */ val COMPONENT_COMPLETION: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcCommentsMod.ExpressionIdentifier.COMPONENT_COMPLETION & String = js.native
    
    @js.native
    sealed trait DIRECTIVE
      extends StObject
         with ExpressionIdentifier
    /* "DIR" */ val DIRECTIVE: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcCommentsMod.ExpressionIdentifier.DIRECTIVE & String = js.native
    
    @js.native
    sealed trait EVENT_PARAMETER
      extends StObject
         with ExpressionIdentifier
    /* "EP" */ val EVENT_PARAMETER: typingsJapgolly.angularCompilerCli.srcNgtscTypecheckSrcCommentsMod.ExpressionIdentifier.EVENT_PARAMETER & String = js.native
  }
