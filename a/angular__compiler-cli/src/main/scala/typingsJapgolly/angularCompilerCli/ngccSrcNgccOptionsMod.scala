...
object ngccSrcNgccOptionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.ngccSrcNgccOptionsMod.AsyncNgccOptions
    - typingsJapgolly.angularCompilerCli.ngccSrcNgccOptionsMod.SyncNgccOptions
  */
  trait NgccOptions extends StObject
  object NgccOptions {
    
    inline def AsyncNgccOptions(basePath: String): typingsJapgolly.angularCompilerCli.ngccSrcNgccOptionsMod.AsyncNgccOptions = {
      val __obj = js.Dynamic.literal(async = true, basePath = basePath.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.ngccSrcNgccOptionsMod.AsyncNgccOptions]
    }
    
    inline def SyncNgccOptions(basePath: String): typingsJapgolly.angularCompilerCli.ngccSrcNgccOptionsMod.SyncNgccOptions = {
      val __obj = js.Dynamic.literal(basePath = basePath.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularCompilerCli.ngccSrcNgccOptionsMod.SyncNgccOptions]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.targetEntryPointPath
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.tsConfigPath
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.pathMappings
    - typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.findEntryPointsFromTsConfigProgram
  */
  trait OptionalNgccOptionKeys extends StObject
  object OptionalNgccOptionKeys {
    
    inline def findEntryPointsFromTsConfigProgram: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.findEntryPointsFromTsConfigProgram = "findEntryPointsFromTsConfigProgram".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.findEntryPointsFromTsConfigProgram]
    
    inline def pathMappings: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.pathMappings = "pathMappings".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.pathMappings]
    
    inline def targetEntryPointPath: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.targetEntryPointPath = "targetEntryPointPath".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.targetEntryPointPath]
    
    inline def tsConfigPath: typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.tsConfigPath = "tsConfigPath".asInstanceOf[typingsJapgolly.angularCompilerCli.angularCompilerCliStrings.tsConfigPath]
  }
