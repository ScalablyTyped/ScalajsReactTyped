...
object ngccSrcDependenciesModuleResolverMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularCompilerCli.ngccSrcDependenciesModuleResolverMod.ResolvedExternalModule
    - typingsJapgolly.angularCompilerCli.ngccSrcDependenciesModuleResolverMod.ResolvedRelativeModule
    - typingsJapgolly.angularCompilerCli.ngccSrcDependenciesModuleResolverMod.ResolvedDeepImport
  */
