...
object srcNgtscReflectionSrcTypescriptMod {
  ...
  open class TypeScriptReflectionHost protected ()
    ...
    /**
      ...
      */
    /* protected */ def getDeclarationOfSymbol(symbol: Symbol): typingsJapgolly.angularCompilerCli.srcNgtscReflectionSrcHostMod.Declaration[Declaration] | Null = js.native
    /* protected */ def getDeclarationOfSymbol(symbol: Symbol, originalId: Identifier): typingsJapgolly.angularCompilerCli.srcNgtscReflectionSrcHostMod.Declaration[Declaration] | Null = js.native
