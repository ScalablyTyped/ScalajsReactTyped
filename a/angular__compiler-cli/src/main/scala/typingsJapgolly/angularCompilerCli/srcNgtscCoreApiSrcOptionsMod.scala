...
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcPublicOptionsMod.BazelAndG3Options
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcPublicOptionsMod.DiagnosticOptions
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcPublicOptionsMod.I18nOptions
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcPublicOptionsMod.LegacyNgcOptions
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcPublicOptionsMod.MiscOptions
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcPublicOptionsMod.NgcCompatibilityOptions
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcPublicOptionsMod.StrictTemplateOptions
import typingsJapgolly.angularCompilerCli.srcNgtscCoreApiSrcPublicOptionsMod.TargetOptions
