...
import typingsJapgolly.asana.anon.Name
...
trait Workspaces
  ...
  /**
    ...
    * @return
    */
  def findById(workspace: String): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def findById(workspace: String, params: Unit, dispatchOptions: Any): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def findById(workspace: String, params: Params): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def findById(workspace: String, params: Params, dispatchOptions: Any): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def findById(workspace: Double): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def findById(workspace: Double, params: Unit, dispatchOptions: Any): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def findById(workspace: Double, params: Params): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def findById(workspace: Double, params: Params, dispatchOptions: Any): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  ...
  /**
    ...
    * @return {Promise} The requested resource
    */
  def getWorkspaces(): ^[ResourceList[typingsJapgolly.asana.mod.resources.Workspaces.Type]] = js.native
  def getWorkspaces(params: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Workspaces.Type]] = js.native
  def getWorkspaces(params: Any, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Workspaces.Type]] = js.native
  def getWorkspaces(params: Unit, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Workspaces.Type]] = js.native
  ...
  /**
    ...
    * @return
    */
  def update(workspace: String, data: Name): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def update(workspace: String, data: Name, dispatchOptions: Any): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def update(workspace: Double, data: Name): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
  def update(workspace: Double, data: Name, dispatchOptions: Any): ^[typingsJapgolly.asana.mod.resources.Workspaces.Type] = js.native
}
object Workspaces extends Shortcut {
  ...
  object Type {
    ...
    inline def apply(
    ...
    ): typingsJapgolly.asana.mod.resources.Workspaces.Type = {
      ...
      __obj.asInstanceOf[typingsJapgolly.asana.mod.resources.Workspaces.Type]
    }
    
    extension [Self <: typingsJapgolly.asana.mod.resources.Workspaces.Type](x: Self) {
