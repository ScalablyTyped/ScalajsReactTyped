...
trait Events_ extends Resource {
  /**
    ...
    */
  def get(resourceId: String): typingsJapgolly.bluebird.mod.^[Type] = js.native
  def get(resourceId: String, syncToken: String): typingsJapgolly.bluebird.mod.^[Type] = js.native
  def get(resourceId: String, syncToken: String, params: Params): typingsJapgolly.bluebird.mod.^[Type] = js.native
  def get(resourceId: Double): typingsJapgolly.bluebird.mod.^[Type] = js.native
  def get(resourceId: Double, syncToken: String): typingsJapgolly.bluebird.mod.^[Type] = js.native
  def get(resourceId: Double, syncToken: String, params: Params): typingsJapgolly.bluebird.mod.^[Type] = js.native
}
