...
import typingsJapgolly.asana.anon.TypeaheadParamsresourcety
import typingsJapgolly.asana.anon.TypeaheadParamsresourcetyCount
import typingsJapgolly.asana.anon.TypeaheadParamsresourcetyOptfields
import typingsJapgolly.asana.anon.TypeaheadParamsresourcetyOptpretty
import typingsJapgolly.asana.anon.TypeaheadParamsresourcetyQuery
import typingsJapgolly.asana.mod.resources.CustomFields.Type
import typingsJapgolly.asana.mod.resources.Typeahead.TypeaheadParams
...
trait Typeahead
  ...
  def typeaheadForWorkspace(workspaceGid: String, params: TypeaheadParamsresourcetyCount): ^[ResourceList[typingsJapgolly.asana.mod.resources.Projects.Type]] = js.native
  def typeaheadForWorkspace(workspaceGid: String, params: TypeaheadParamsresourcetyCount, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Projects.Type]] = js.native
  def typeaheadForWorkspace(workspaceGid: String, params: TypeaheadParamsresourcetyOptfields): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tags.Type]] = js.native
  def typeaheadForWorkspace(workspaceGid: String, params: TypeaheadParamsresourcetyOptfields, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tags.Type]] = js.native
  def typeaheadForWorkspace(workspaceGid: String, params: TypeaheadParamsresourcetyOptpretty): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def typeaheadForWorkspace(workspaceGid: String, params: TypeaheadParamsresourcetyOptpretty, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def typeaheadForWorkspace(workspaceGid: String, params: TypeaheadParamsresourcetyQuery): ^[ResourceList[typingsJapgolly.asana.mod.resources.Users.Type]] = js.native
  def typeaheadForWorkspace(workspaceGid: String, params: TypeaheadParamsresourcetyQuery, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Users.Type]] = js.native
