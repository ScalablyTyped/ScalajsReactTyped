...
trait Stories_ extends Resource {
  /**
    ...
    * @return
    */
  def createOnTask(task: String, data: js.Any): typingsJapgolly.bluebird.mod.^[ResourceList[ShortType]] = js.native
  def createOnTask(task: String, data: js.Any, dispatchOptions: js.Any): typingsJapgolly.bluebird.mod.^[ResourceList[ShortType]] = js.native
  def createOnTask(task: Double, data: js.Any): typingsJapgolly.bluebird.mod.^[ResourceList[ShortType]] = js.native
  def createOnTask(task: Double, data: js.Any, dispatchOptions: js.Any): typingsJapgolly.bluebird.mod.^[ResourceList[ShortType]] = js.native
  /**
    ...
    * @return
    */
  def findById(story: Double): typingsJapgolly.bluebird.mod.^[Type] = js.native
  def findById(story: Double, params: Params): typingsJapgolly.bluebird.mod.^[Type] = js.native
  def findById(story: Double, params: Params, dispatchOptions: js.Any): typingsJapgolly.bluebird.mod.^[Type] = js.native
  /**
