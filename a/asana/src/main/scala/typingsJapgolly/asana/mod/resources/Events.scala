...
import typingsJapgolly.asana.anon.Gid
...
import typingsJapgolly.asana.mod.resources.Events.Type
import typingsJapgolly.asana.mod.resources.Users.ShortType
...
object Events extends Shortcut {
  ...
  trait EventSection extends StObject {
    ...
    var project: Gid & js.UndefOr[typingsJapgolly.asana.mod.resources.Projects.Type]
  ...
  object EventSection {
    ...
    inline def apply(
      gid: String & js.UndefOr[String],
      name: String & js.UndefOr[String],
      project: Gid & js.UndefOr[typingsJapgolly.asana.mod.resources.Projects.Type],
      resource_subtype: String & js.UndefOr[String],
      resource_type: String & js.UndefOr[String]
    ): EventSection = {
    ...
    extension [Self <: EventSection](x: Self) {
      ...
      inline def setProject(value: Gid & js.UndefOr[typingsJapgolly.asana.mod.resources.Projects.Type]): Self = StObject.set(x, "project", value.asInstanceOf[js.Any])
  ...
  trait EventStory extends StObject {
    ...
    var story: js.UndefOr[typingsJapgolly.asana.mod.resources.Stories.ShortType] = js.undefined
  ...
  object EventStory {
    ...
    extension [Self <: EventStory](x: Self) {
      ...
      inline def setStory(value: typingsJapgolly.asana.mod.resources.Stories.ShortType): Self = StObject.set(x, "story", value.asInstanceOf[js.Any])
