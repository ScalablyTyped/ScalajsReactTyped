...
import typingsJapgolly.asana.anon.Typeworkspacestring
...
trait Tags
  ...
  /**
    ...
    * @return
    */
  def getTasksWithTag(tag: String): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def getTasksWithTag(tag: String, params: Unit, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def getTasksWithTag(tag: String, params: PaginationParams): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def getTasksWithTag(tag: String, params: PaginationParams, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def getTasksWithTag(tag: Double): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def getTasksWithTag(tag: Double, params: Unit, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def getTasksWithTag(tag: Double, params: PaginationParams): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
  def getTasksWithTag(tag: Double, params: PaginationParams, dispatchOptions: Any): ^[ResourceList[typingsJapgolly.asana.mod.resources.Tasks.Type]] = js.native
