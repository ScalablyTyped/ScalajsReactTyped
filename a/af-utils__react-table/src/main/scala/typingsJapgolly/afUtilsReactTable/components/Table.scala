package typingsJapgolly.afUtilsReactTable.components
...
import typingsJapgolly.afUtilsReactTable.mod.ComponentMap
import typingsJapgolly.afUtilsReactTable.mod.RowProps
import typingsJapgolly.afUtilsReactTable.mod.TableProps
...
object Table {
  ...
  inline def apply(columns: js.Array[ColumnModel], getRowData: /* repeated */ Any => Any, model: Model): Builder = {
    val __props = js.Dynamic.literal(columns = columns.asInstanceOf[js.Any], getRowData = js.Any.fromFunction1(getRowData), model = model.asInstanceOf[js.Any])
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def ColumnModel(value: TypeofColumnModel): this.type = set("ColumnModel", value.asInstanceOf[js.Any])
    ...
    inline def components(value: ComponentMap): this.type = set("components", value.asInstanceOf[js.Any])
    ...
    inline def getKey(value: (/* index */ Double, /* rowProps */ js.UndefOr[RowProps]) => Any): this.type = set("getKey", js.Any.fromFunction2(value))
    
    inline def getRowProps(value: (/* model */ Model, /* index */ Double, /* rowData */ js.UndefOr[Any]) => RowProps): this.type = set("getRowProps", js.Any.fromFunction3(value))
