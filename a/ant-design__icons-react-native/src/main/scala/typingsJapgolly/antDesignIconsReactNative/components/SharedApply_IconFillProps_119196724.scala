...
import typingsJapgolly.antDesignIconsReactNative.fillMod.FillGlyphMapType
import typingsJapgolly.antDesignIconsReactNative.fillMod.IconFillProps
...
abstract class SharedApply_IconFillProps_119196724[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IconFillProps, ComponentRef, Unit, IconFillProps] = {
  ...
  typingsJapgolly.antDesignIconsReactNative.fillMod.IconFillProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignIconsReactNative.fillMod.IconFillProps])(children: _*)
  }
}
