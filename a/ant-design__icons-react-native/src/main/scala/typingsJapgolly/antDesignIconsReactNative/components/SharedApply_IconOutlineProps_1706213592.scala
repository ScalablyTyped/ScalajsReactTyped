...
import typingsJapgolly.antDesignIconsReactNative.outlineMod.IconOutlineProps
import typingsJapgolly.antDesignIconsReactNative.outlineMod.OutlineGlyphMapType
...
abstract class SharedApply_IconOutlineProps_1706213592[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IconOutlineProps, ComponentRef, Unit, IconOutlineProps] = {
  ...
  typingsJapgolly.antDesignIconsReactNative.outlineMod.IconOutlineProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignIconsReactNative.outlineMod.IconOutlineProps])(children: _*)
  }
}
