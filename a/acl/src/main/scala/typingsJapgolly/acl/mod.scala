...
object mod extends Shortcut {
  ...
  trait Acl extends StObject {
    ...
    def areAnyRolesAllowed(roles: strings, resource: strings, permissions: strings): typingsJapgolly.bluebird.mod.^[Any] = js.native
    def areAnyRolesAllowed(roles: strings, resource: strings, permissions: strings, cb: AllowedCallback): typingsJapgolly.bluebird.mod.^[Any] = js.native
    
    def hasRole(userId: Value, role: String): typingsJapgolly.bluebird.mod.^[Boolean] = js.native
    def hasRole(userId: Value, role: String, cb: js.Function2[/* err */ js.Error, /* isInRole */ Boolean, Any]): typingsJapgolly.bluebird.mod.^[Boolean] = js.native
    ...
    def roleUsers(role: Value): typingsJapgolly.bluebird.mod.^[Any] = js.native
    def roleUsers(role: Value, cb: js.Function2[/* err */ js.Error, /* users */ Values, Any]): typingsJapgolly.bluebird.mod.^[Any] = js.native
    
    def userRoles(userId: Value): typingsJapgolly.bluebird.mod.^[js.Array[String]] = js.native
    def userRoles(userId: Value, cb: js.Function2[/* err */ js.Error, /* roles */ js.Array[String], Any]): typingsJapgolly.bluebird.mod.^[js.Array[String]] = js.native
    
    def whatResources(roles: strings): typingsJapgolly.bluebird.mod.^[Any] = js.native
    def whatResources(roles: strings, cb: AnyCallback): typingsJapgolly.bluebird.mod.^[Any] = js.native
    def whatResources(roles: strings, permissions: strings): typingsJapgolly.bluebird.mod.^[Any] = js.native
    def whatResources(roles: strings, permissions: strings, cb: AnyCallback): typingsJapgolly.bluebird.mod.^[Any] = js.native
  }
  ...
  trait Backend[T] extends StObject {
    ...
    def getAsync(bucket: String, key: Value): typingsJapgolly.bluebird.mod.^[Any] = js.native
    def getAsync(bucket: String, key: Value, cb: js.Function2[/* err */ js.Error | Null, /* value */ Any, Unit]): typingsJapgolly.bluebird.mod.^[Any] = js.native
    ...
    def unionAsync(bucket: String, keys: js.Array[Value]): typingsJapgolly.bluebird.mod.^[js.Array[Any]] = js.native
    def unionAsync(
      bucket: String,
      keys: js.Array[Value],
      cb: js.Function2[/* error */ js.UndefOr[js.Error], /* results */ js.Array[Any], Unit]
    ): typingsJapgolly.bluebird.mod.^[js.Array[Any]] = js.native
  }
  ...
  object NoOp {
    ...
    inline def apply(end: japgolly.scalajs.react.Callback, params: /* repeated */ String => NoOp): NoOp = {
      val __obj = js.Dynamic.literal(end = end.toJsFn, params = js.Any.fromFunction1(params))
