...
trait V3Any extends StObject {
  ...
  // @ts-ignore
  var v5: typingsJapgolly.algoliasearchHelper.typesAlgoliasearchMod.SearchForFacetValuesResponse
}
object V3Any {
  ...
  inline def apply(
    ...
    v5: typingsJapgolly.algoliasearchHelper.typesAlgoliasearchMod.SearchForFacetValuesResponse
  ): V3Any = {
  ...
  extension [Self <: V3Any](x: Self) {
    ...
    inline def setV5(value: typingsJapgolly.algoliasearchHelper.typesAlgoliasearchMod.SearchForFacetValuesResponse): Self = StObject.set(x, "v5", value.asInstanceOf[js.Any])
  }
}
