...
import typingsJapgolly.algoliasearch.algoliasearchStrings.min
...
import typingsJapgolly.algoliasearch.algoliasearchStrings.strict
...
trait QueryParameters
  extends typingsJapgolly.algoliasearch.mod.QueryParameters {
  /**
