...
trait Vector[TItem] extends StObject {
  ...
  /**
    ...
    */
  def ImageFile(): typingsJapgolly.activexWia.WIA.ImageFile = js.native
  def ImageFile(Width: Double): typingsJapgolly.activexWia.WIA.ImageFile = js.native
  def ImageFile(Width: Double, Height: Double): typingsJapgolly.activexWia.WIA.ImageFile = js.native
  def ImageFile(Width: Unit, Height: Double): typingsJapgolly.activexWia.WIA.ImageFile = js.native
