...
object DeviceInfo {
  ...
  inline def apply(
    Connect: CallbackTo[Device],
    DeviceID: String,
    Properties: Properties,
    Type: WiaDeviceType,
    WIADotDeviceInfo_typekey: DeviceInfo
  ): DeviceInfo = {
    val __obj = js.Dynamic.literal(Connect = Connect.toJsFn, DeviceID = DeviceID.asInstanceOf[js.Any], Properties = Properties.asInstanceOf[js.Any], Type = Type.asInstanceOf[js.Any])
  ...
  extension [Self <: DeviceInfo](x: Self) {
    ...
    inline def setConnect(value: CallbackTo[Device]): Self = StObject.set(x, "Connect", value.toJsFn)
