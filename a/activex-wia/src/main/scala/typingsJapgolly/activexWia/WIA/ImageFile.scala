...
object ImageFile {
  ...
  extension [Self <: ImageFile](x: Self) {
    ...
    inline def setLoadFile(value: String => Callback): Self = StObject.set(x, "LoadFile", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    
    inline def setPixelDepth(value: Double): Self = StObject.set(x, "PixelDepth", value.asInstanceOf[js.Any])
    
    inline def setProperties(value: Properties): Self = StObject.set(x, "Properties", value.asInstanceOf[js.Any])
    
    inline def setSaveFile(value: String => Callback): Self = StObject.set(x, "SaveFile", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
