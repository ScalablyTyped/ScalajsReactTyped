...
import typingsJapgolly.auth0Js.mod.Auth0Error
import typingsJapgolly.auth0Js.mod.Auth0UserProfile
import typingsJapgolly.auth0Lock.auth0LockStrings.authenticated
import typingsJapgolly.auth0Lock.auth0LockStrings.authorization_error
import typingsJapgolly.auth0Lock.auth0LockStrings.hide
import typingsJapgolly.auth0Lock.auth0LockStrings.show
import typingsJapgolly.auth0Lock.auth0LockStrings.unrecoverable_error
