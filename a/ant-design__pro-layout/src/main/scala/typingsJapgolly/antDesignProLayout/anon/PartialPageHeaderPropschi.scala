...
trait PartialPageHeaderPropschi extends StObject {
  ...
  var breadcrumbRender: js.UndefOr[js.Function2[/* props */ PageHeaderProps, /* defaultDom */ Node, Node]] = js.undefined
...
object PartialPageHeaderPropschi {
  ...
  extension [Self <: PartialPageHeaderPropschi](x: Self) {
    ...
    inline def setBreadcrumbRender(value: (/* props */ PageHeaderProps, /* defaultDom */ Node) => Node): Self = StObject.set(x, "breadcrumbRender", js.Any.fromFunction2(value))
