...
object AutoClose {
  ...
  extension [Self <: AutoClose](x: Self) {
    ...
    inline def setOnLoadingChange(value: /* loading */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "onLoadingChange", js.Any.fromFunction1((t0: /* loading */ js.UndefOr[Boolean]) => value(t0).runNow()))
