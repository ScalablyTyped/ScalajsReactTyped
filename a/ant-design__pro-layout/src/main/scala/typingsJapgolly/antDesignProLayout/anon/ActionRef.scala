...
trait ActionRef extends StObject {
  ...
  /**
    ...
    * */
  var logo: js.UndefOr[Node | Element | (WithFalse[js.Function0[Node | Element]])] = js.undefined
...
object ActionRef {
  ...
  extension [Self <: ActionRef](x: Self) {
    ...
    inline def setFooterRender(value: WithFalse[js.Function2[/* props */ HeaderViewProps, /* defaultDom */ Node, Node]]): Self = StObject.set(x, "footerRender", value.asInstanceOf[js.Any])
    
    inline def setFooterRenderFunction2(value: (/* props */ HeaderViewProps, /* defaultDom */ Node) => Node): Self = StObject.set(x, "footerRender", js.Any.fromFunction2(value))
    ...
    inline def setLogo(value: Node | Element | (WithFalse[js.Function0[Node | Element]])): Self = StObject.set(x, "logo", value.asInstanceOf[js.Any])
    
    inline def setLogoCallbackTo(value: CallbackTo[Node | Element]): Self = StObject.set(x, "logo", value.toJsFn)
    ...
    ): Self = StObject.set(x, "onPageChange", js.Any.fromFunction1((t0: /* location */ js.UndefOr[
          (/* import warning: importer.ImportType#apply Failed type conversion: @ant-design/pro-layout.@ant-design/pro-layout/es/typings.BasicRouteProps<std.Record<string, any>, @ant-design/pro-layout.@ant-design/pro-layout/es/typings.StaticContext, / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify H.LocationState * / any>['location'] */ js.Any) | Pathname
        ]) => value(t0).runNow()))
