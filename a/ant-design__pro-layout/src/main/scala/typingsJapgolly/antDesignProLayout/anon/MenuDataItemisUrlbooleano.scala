...
object MenuDataItemisUrlbooleano {
  ...
  inline def apply(isUrl: Boolean, onClick: Callback, routes: Unit): MenuDataItemisUrlbooleano = {
    val __obj = js.Dynamic.literal(isUrl = isUrl.asInstanceOf[js.Any], onClick = onClick.toJsFn, routes = routes.asInstanceOf[js.Any])
