...
object BaseMenuPropsPartialPriva {
  ...
  inline def apply(mode: js.UndefOr[MenuMode] & js.UndefOr[typingsJapgolly.rcMenu.esInterfaceMod.MenuMode]): BaseMenuPropsPartialPriva = {
  ...
  extension [Self <: BaseMenuPropsPartialPriva](x: Self) {
    ...
    inline def setMenuItemRenderFunction3(
      value: (/* item */ MenuDataItemisUrlbooleano, /* defaultDom */ Node, /* menuProps */ BaseMenuPropsPartialPriva & PartialPrivateSiderMenuPr) => Node
    ...
    inline def setSubMenuItemRenderFunction3(
      value: (/* item */ MenuDataItemisUrlboolean, /* defaultDom */ Node, BaseMenuPropsPartialPriva) => Node
