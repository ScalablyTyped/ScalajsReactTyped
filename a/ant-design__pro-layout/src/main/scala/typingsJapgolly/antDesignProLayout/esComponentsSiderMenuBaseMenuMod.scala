...
object esComponentsSiderMenuBaseMenuMod {
  ...
  trait BaseMenuProps extends StObject {
    ...
    var mode: js.UndefOr[MenuMode] & js.UndefOr[typingsJapgolly.rcMenu.esInterfaceMod.MenuMode]
  ...
  object BaseMenuProps {
    ...
    inline def apply(mode: js.UndefOr[MenuMode] & js.UndefOr[typingsJapgolly.rcMenu.esInterfaceMod.MenuMode]): BaseMenuProps = {
    ...
    extension [Self <: BaseMenuProps](x: Self) {
      ...
      inline def setHandleOpenChange(value: /* openKeys */ js.Array[String] => Callback): Self = StObject.set(x, "handleOpenChange", js.Any.fromFunction1((t0: /* openKeys */ js.Array[String]) => value(t0).runNow()))
      ...
      inline def setMode(value: js.UndefOr[MenuMode] & js.UndefOr[typingsJapgolly.rcMenu.esInterfaceMod.MenuMode]): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
      ...
      inline def setSubMenuItemRenderFunction3(value: (/* item */ MenuDataItemisUrlboolean, /* defaultDom */ Node, BaseMenuProps) => Node): Self = StObject.set(x, "subMenuItemRender", js.Any.fromFunction3(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.vertical
    - typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`vertical-left`
    - typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`vertical-right`
    - typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.horizontal
    - typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`inline`
  */
  trait MenuMode extends StObject
  object MenuMode {
    
    inline def horizontal: typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.horizontal = "horizontal".asInstanceOf[typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.horizontal]
    
    inline def `inline`: typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`inline` = "inline".asInstanceOf[typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`inline`]
    
    inline def vertical: typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.vertical = "vertical".asInstanceOf[typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.vertical]
    
    inline def `vertical-left`: typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`vertical-left` = "vertical-left".asInstanceOf[typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`vertical-left`]
    
    inline def `vertical-right`: typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`vertical-right` = "vertical-right".asInstanceOf[typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.`vertical-right`]
  }
}
