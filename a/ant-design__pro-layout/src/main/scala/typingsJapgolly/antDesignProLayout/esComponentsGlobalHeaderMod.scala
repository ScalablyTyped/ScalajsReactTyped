...
object esComponentsGlobalHeaderMod {
  ...
  object GlobalHeaderProps {
    ...
    extension [Self <: GlobalHeaderProps](x: Self) {
      ...
      inline def setHeaderContentRender(value: WithFalse[js.Function2[/* props */ HeaderViewProps, /* defaultDom */ Node, Node]]): Self = StObject.set(x, "headerContentRender", value.asInstanceOf[js.Any])
      
      inline def setHeaderContentRenderFunction2(value: (/* props */ HeaderViewProps, /* defaultDom */ Node) => Node): Self = StObject.set(x, "headerContentRender", js.Any.fromFunction2(value))
      ...
      inline def setMenuRender(value: WithFalse[js.Function2[/* props */ HeaderViewProps, /* defaultDom */ Node, Node]]): Self = StObject.set(x, "menuRender", value.asInstanceOf[js.Any])
      
      inline def setMenuRenderFunction2(value: (/* props */ HeaderViewProps, /* defaultDom */ Node) => Node): Self = StObject.set(x, "menuRender", js.Any.fromFunction2(value))
