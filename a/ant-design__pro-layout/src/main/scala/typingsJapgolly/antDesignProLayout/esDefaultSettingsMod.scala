...
object esDefaultSettingsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.Fluid
    - typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.Fixed
  */
  trait ContentWidth extends StObject
  object ContentWidth {
    
    inline def Fixed: typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.Fixed = "Fixed".asInstanceOf[typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.Fixed]
    
    inline def Fluid: typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.Fluid = "Fluid".asInstanceOf[typingsJapgolly.antDesignProLayout.antDesignProLayoutStrings.Fluid]
  }
