...
object esComponentsPageContainerMod {
  ...
  trait PageContainerProps extends StObject {
    ...
    /** @name 自定义 pageHeader */
    var pageHeaderRender: js.UndefOr[WithFalse[js.Function1[/* props */ this.type, Node]]] = js.undefined
    ...
    var tags: js.UndefOr[
        japgolly.scalajs.react.facade.React.Element | js.Array[japgolly.scalajs.react.facade.React.Element]
      ] = js.undefined
  ...
  object PageContainerProps {
    ...
    extension [Self <: PageContainerProps](x: Self) {
      ...
      inline def setBackIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "backIcon", js.Array(value*))
      ...
      inline def setBreadcrumbRender(value: (js.Function2[PageContainerProps, /* defaultDom */ Node, Node]) | `false`): Self = StObject.set(x, "breadcrumbRender", value.asInstanceOf[js.Any])
      
      inline def setBreadcrumbRenderFunction2(value: (PageContainerProps, /* defaultDom */ Node) => Node): Self = StObject.set(x, "breadcrumbRender", js.Any.fromFunction2(value))
      ...
      inline def setExtraContentVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "extraContent", js.Array(value*))
      ...
      inline def setPageHeaderRender(value: WithFalse[js.Function1[PageContainerProps, Node]]): Self = StObject.set(x, "pageHeaderRender", value.asInstanceOf[js.Any])
      
      inline def setPageHeaderRenderFunction1(value: PageContainerProps => Node): Self = StObject.set(x, "pageHeaderRender", js.Any.fromFunction1(value))
      ...
      inline def setTabBarExtraContentVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "tabBarExtraContent", js.Array(value*))
      ...
      inline def setTagsVarargs(value: japgolly.scalajs.react.facade.React.Element*): Self = StObject.set(x, "tags", js.Array(value*))
