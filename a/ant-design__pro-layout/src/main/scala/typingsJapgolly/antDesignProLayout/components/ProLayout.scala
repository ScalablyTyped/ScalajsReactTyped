...
import typingsJapgolly.antDesignProLayout.anon.Bottom
import typingsJapgolly.antDesignProLayout.anon.Desc
import typingsJapgolly.antDesignProLayout.anon.Id
...
import typingsJapgolly.antDesignProLayout.anon.Reload
...
import typingsJapgolly.antDesignProLayout.esLocalesMod.LocaleType
import typingsJapgolly.antDesignProLayout.esProLayoutMod.LayoutBreadcrumbProps
...
object ProLayout {
  ...
  inline def apply(mode: js.UndefOr[MenuMode] & js.UndefOr[typingsJapgolly.rcMenu.esInterfaceMod.MenuMode]): Builder = {
    val __props = js.Dynamic.literal(mode = mode.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ProLayoutProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def actionRef(value: MutableRefObject[js.UndefOr[Reload]]): this.type = set("actionRef", value.asInstanceOf[js.Any])
    ...
    inline def bgLayoutImgList(value: js.Array[Bottom]): this.type = set("bgLayoutImgList", value.asInstanceOf[js.Any])
    
    inline def bgLayoutImgListVarargs(value: Bottom*): this.type = set("bgLayoutImgList", js.Array(value*))
    
    inline def breadcrumbProps(value: BreadcrumbProps & LayoutBreadcrumbProps): this.type = set("breadcrumbProps", value.asInstanceOf[js.Any])
    
    inline def breadcrumbRender(
      value: WithFalse[
          js.Function1[/* routers */ js.UndefOr[js.Array[Route]], js.UndefOr[js.Array[Route]]]
        ]
    ): this.type = set("breadcrumbRender", value.asInstanceOf[js.Any])
    
    inline def breadcrumbRenderFunction1(value: /* routers */ js.UndefOr[js.Array[Route]] => js.UndefOr[js.Array[Route]]): this.type = set("breadcrumbRender", js.Any.fromFunction1(value))
    ...
    inline def disableMobile(value: Boolean): this.type = set("disableMobile", value.asInstanceOf[js.Any])
    ...
    inline def footerRender(value: WithFalse[js.Function2[/* props */ HeaderViewProps, /* defaultDom */ Node, Node]]): this.type = set("footerRender", value.asInstanceOf[js.Any])
    
    inline def footerRenderFunction2(value: (/* props */ HeaderViewProps, /* defaultDom */ Node) => Node): this.type = set("footerRender", js.Any.fromFunction2(value))
    ...
    inline def locale(value: LocaleType): this.type = set("locale", value.asInstanceOf[js.Any])
    ...
    inline def menuDataRender(value: /* menuData */ js.Array[MenuDataItem] => js.Array[MenuDataItem]): this.type = set("menuDataRender", js.Any.fromFunction1(value))
    ...
    ): this.type = set("onPageChange", js.Any.fromFunction1((t0: /* location */ js.UndefOr[
          (/* import warning: importer.ImportType#apply Failed type conversion: @ant-design/pro-layout.@ant-design/pro-layout/es/typings.BasicRouteProps<std.Record<string, any>, @ant-design/pro-layout.@ant-design/pro-layout/es/typings.StaticContext, / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify H.LocationState * / any>['location'] */ js.Any) | Pathname
        ]) => value(t0).runNow()))
    ...
    inline def pageTitleRenderFunction3(
    ...
    inline def route(value: typingsJapgolly.antDesignProLayout.esTypingsMod.Route): this.type = set("route", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ProLayoutProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
