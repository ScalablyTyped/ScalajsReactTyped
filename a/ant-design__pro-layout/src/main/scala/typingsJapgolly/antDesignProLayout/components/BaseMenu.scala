...
object BaseMenu {
  ...
  inline def apply(
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[BaseMenuProps & PrivateSiderMenuProps]))
  }
  
  @JSImport("@ant-design/pro-layout/es/components/SiderMenu/BaseMenu", "BaseMenu")
  @js.native
  ...
  def withProps(p: BaseMenuProps & PrivateSiderMenuProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
