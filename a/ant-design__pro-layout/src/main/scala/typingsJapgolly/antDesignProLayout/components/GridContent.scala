...
object GridContent {
  def apply(
    ...
    GridContentProps, 
    MountedWithRawType[GridContentProps, js.Object, RawMounted[GridContentProps, js.Object]]
  ] = {
  ...
  typingsJapgolly.antDesignProLayout.gridContentMod.GridContentProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignProLayout.gridContentMod.GridContentProps])(children: _*)
  }
