...
object ProPageHeader {
  
  inline def apply(prefixedClassName: String): Builder = {
    val __props = js.Dynamic.literal(prefixedClassName = prefixedClassName.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[PageContainerPropsprefixe]))
  }
  
  @JSImport("@ant-design/pro-layout", "ProPageHeader")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def breadcrumbRender(value: (js.Function2[PageContainerPropsprefixe, /* defaultDom */ Node, Node]) | `false`): this.type = set("breadcrumbRender", value.asInstanceOf[js.Any])
    
    inline def breadcrumbRenderFunction2(value: (PageContainerPropsprefixe, /* defaultDom */ Node) => Node): this.type = set("breadcrumbRender", js.Any.fromFunction2(value))
    ...
    inline def pageHeaderRender(value: WithFalse[js.Function1[/* props */ PageContainerProps, Node]]): this.type = set("pageHeaderRender", value.asInstanceOf[js.Any])
    
    inline def pageHeaderRenderFunction1(value: /* props */ PageContainerProps => Node): this.type = set("pageHeaderRender", js.Any.fromFunction1(value))
  ...
  def withProps(p: PageContainerPropsprefixe): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
