...
object RightContent {
  ...
  @JSImport("@ant-design/pro-layout/es/components/GlobalHeader/RightContent", "RightContent")
  @js.native
  ...
  implicit def make(companion: RightContent.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
