...
object DefaultHeader {
  ...
  inline def apply(matchMenuKeys: js.Array[String]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[HeaderViewProps & PrivateSiderMenuProps]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def actionsRender(value: WithFalse[js.Function1[HeaderViewProps, js.Array[Node]]]): this.type = set("actionsRender", value.asInstanceOf[js.Any])
    
    inline def actionsRenderFunction1(value: HeaderViewProps => js.Array[Node]): this.type = set("actionsRender", js.Any.fromFunction1(value))
    ...
    inline def hasSiderMenu(value: Boolean): this.type = set("hasSiderMenu", value.asInstanceOf[js.Any])
    
    inline def headerContentRender(value: WithFalse[js.Function2[HeaderViewProps, /* defaultDom */ Node, Node]]): this.type = set("headerContentRender", value.asInstanceOf[js.Any])
    
    inline def headerContentRenderFunction2(value: (HeaderViewProps, /* defaultDom */ Node) => Node): this.type = set("headerContentRender", js.Any.fromFunction2(value))
    
    inline def headerRender(value: WithFalse[js.Function2[HeaderViewProps, /* defaultDom */ Node, Node]]): this.type = set("headerRender", value.asInstanceOf[js.Any])
    
    inline def headerRenderFunction2(value: (HeaderViewProps, /* defaultDom */ Node) => Node): this.type = set("headerRender", js.Any.fromFunction2(value))
    
    inline def headerTitleRender(value: WithFalse[js.Function3[/* logo */ Node, /* title */ Node, HeaderViewProps, Node]]): this.type = set("headerTitleRender", value.asInstanceOf[js.Any])
    
    inline def headerTitleRenderFunction3(value: (/* logo */ Node, /* title */ Node, HeaderViewProps) => Node): this.type = set("headerTitleRender", js.Any.fromFunction3(value))
    ...
    inline def menuRender(value: WithFalse[js.Function2[HeaderViewProps, /* defaultDom */ Node, Node]]): this.type = set("menuRender", value.asInstanceOf[js.Any])
    
    inline def menuRenderFunction2(value: (HeaderViewProps, /* defaultDom */ Node) => Node): this.type = set("menuRender", js.Any.fromFunction2(value))
    ...
    inline def rightContentRender(value: WithFalse[js.Function1[HeaderViewProps, Node]]): this.type = set("rightContentRender", value.asInstanceOf[js.Any])
    
    inline def rightContentRenderFunction1(value: HeaderViewProps => Node): this.type = set("rightContentRender", js.Any.fromFunction1(value))
  ...
  def withProps(p: HeaderViewProps & PrivateSiderMenuProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
