...
object CollapsedIcon {
  ...
  @JSImport("@ant-design/pro-layout/es/components/CollapsedIcon", "CollapsedIcon")
  @js.native
  val component: js.Object = js.native
  
  implicit def make(companion: CollapsedIcon.type): Default[js.Object] = new Default[js.Object](js.Array(this.component, js.Dictionary.empty))()
}
