...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "ant-design__pro-utils" % "2.2.6-966dfb",
  ...
  "org.scalablytyped.japgolly" %%% "umijs__route-utils" % "3.0.0-4c5f92",
  "org.scalablytyped.japgolly" %%% "unstated-next" % "1.1.0-792d06")
