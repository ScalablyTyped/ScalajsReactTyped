...
package object utilMod {
  ...
  type RetryDecider = js.Function1[/* error */ typingsJapgolly.awsSdkTypes.utilMod.SdkError, scala.Boolean]
  type UrlParser = js.Function1[/* url */ java.lang.String, typingsJapgolly.awsSdkTypes.httpMod.HttpEndpoint]
}
