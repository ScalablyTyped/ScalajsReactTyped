...
object distTypesSerdeMod {
  ...
  object EndpointBearer {
    ...
    inline def apply(endpoint: CallbackTo[js.Promise[Endpoint]]): EndpointBearer = {
      val __obj = js.Dynamic.literal(endpoint = endpoint.toJsFn)
