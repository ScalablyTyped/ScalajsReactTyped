...
import typingsJapgolly.angularFormly.anon.Dictkey
import typingsJapgolly.angularFormly.anon.ErrorExistsAndShouldBeVisible
...
object IFieldObject {
  ...
  extension [Self <: IFieldObject](x: Self) {
    ...
    inline def setLink(
      value: (IScope, JQLite, IAttributes, /* controller */ js.UndefOr[IController], /* transclude */ js.UndefOr[ITranscludeFunction]) => Callback
    ): Self = StObject.set(x, "link", js.Any.fromFunction5((t0: IScope, t1: JQLite, t2: IAttributes, t3: /* controller */ js.UndefOr[IController], t4: /* transclude */ js.UndefOr[ITranscludeFunction]) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def setResetModel(value: Callback): Self = StObject.set(x, "resetModel", value.toJsFn)
    
    inline def setResetModelUndefined: Self = StObject.set(x, "resetModel", js.undefined)
    
    inline def setRunExpressions(value: Callback): Self = StObject.set(x, "runExpressions", value.toJsFn)
    ...
    inline def setUpdateInitialValue(value: Callback): Self = StObject.set(x, "updateInitialValue", value.toJsFn)
