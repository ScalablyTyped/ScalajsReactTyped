package typingsJapgolly.anyPromise

import org.scalablytyped.runtime.Instantiable1
import typingsJapgolly.anyPromise.mod.Promise
import typingsJapgolly.anyPromise.mod.Thenable
import typingsJapgolly.anyPromise.mod.^
