...
object AMap {
  ...
  object ControlBar {
    ...
    trait EventMap extends StObject {
      ...
      var hide: Event_[typingsJapgolly.amapJsApiControlBar.amapJsApiControlBarStrings.hide, Unit]
      
      var show: Event_[typingsJapgolly.amapJsApiControlBar.amapJsApiControlBarStrings.show, Unit]
    }
    object EventMap {
