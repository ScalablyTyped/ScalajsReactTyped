...
package object mod {
  ...
  type LoadCallback = js.Function2[
    ...
    /* root */ js.UndefOr[typingsJapgolly.apolloProtobufjs.mod.Root], 
    scala.Unit
  ]
  /**
  ...
  {[ P in keyof T ]:? T[P]}
    */ typingsJapgolly.apolloProtobufjs.apolloProtobufjsStrings.Properties with T
  /**
  ...
  type RPCImpl = js.Function3[
    /* method */ typingsJapgolly.apolloProtobufjs.mod.Method | (typingsJapgolly.apolloProtobufjs.mod.rpc.ServiceMethod[
      typingsJapgolly.apolloProtobufjs.mod.Message[js.Object], 
      typingsJapgolly.apolloProtobufjs.mod.Message[js.Object]
    ]), 
    /* requestData */ scala.scalajs.js.typedarray.Uint8Array, 
    /* callback */ typingsJapgolly.apolloProtobufjs.mod.RPCImplCallback, 
    scala.Unit
  ]
  /**
  ...
  /**
    ...
    */
  type TypeDecorator[T /* <: typingsJapgolly.apolloProtobufjs.mod.Message[T] */] = js.Function1[/* target */ typingsJapgolly.apolloProtobufjs.mod.Constructor[T], scala.Unit]
  /**
  ...
  type WrapperFromObjectConverter = js.ThisFunction1[
    /* this */ typingsJapgolly.apolloProtobufjs.mod.Type, 
  ...
  type WrapperToObjectConverter = js.ThisFunction2[
    /* this */ typingsJapgolly.apolloProtobufjs.mod.Type, 
    /* message */ typingsJapgolly.apolloProtobufjs.mod.Message[js.Object], 
    /* options */ js.UndefOr[typingsJapgolly.apolloProtobufjs.mod.IConversionOptions], 
