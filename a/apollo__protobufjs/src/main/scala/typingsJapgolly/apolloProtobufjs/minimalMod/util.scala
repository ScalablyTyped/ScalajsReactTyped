...
object util {
  ...
  object base64 {
    ...
    @JSImport("@apollo/protobufjs/minimal", "util.base64")
    @js.native
    val ^ : js.Any = js.native
  ...
  object float {
    ...
    @JSImport("@apollo/protobufjs/minimal", "util.float")
    @js.native
    val ^ : js.Any = js.native
  ...
  object path {
    ...
    @JSImport("@apollo/protobufjs/minimal", "util.path")
    @js.native
    val ^ : js.Any = js.native
  ...
  object utf8 {
    ...
    @JSImport("@apollo/protobufjs/minimal", "util.utf8")
    @js.native
    val ^ : js.Any = js.native
