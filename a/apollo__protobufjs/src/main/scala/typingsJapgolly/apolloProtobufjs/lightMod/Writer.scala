...
object Writer {
  ...
  /**
    ...
    */
  inline def create(): typingsJapgolly.apolloProtobufjs.mod.BufferWriter | typingsJapgolly.apolloProtobufjs.mod.Writer = ^.asInstanceOf[js.Dynamic].applyDynamic("create")().asInstanceOf[typingsJapgolly.apolloProtobufjs.mod.BufferWriter | typingsJapgolly.apolloProtobufjs.mod.Writer]
}
