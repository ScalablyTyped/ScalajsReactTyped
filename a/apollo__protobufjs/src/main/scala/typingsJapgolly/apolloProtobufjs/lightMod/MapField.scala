...
object MapField extends js.Object {
  ...
  def d[T /* <: StringDictionary[
    Double | Long | String | Boolean | scala.scalajs.js.typedarray.Uint8Array | scala.scalajs.js.typedarray.Uint8Array | js.Array[Double] | typingsJapgolly.apolloProtobufjs.mod.Message[js.Object]
  ] */](
    fieldId: Double,
  ...
  /**
    ...
    */
  def fromJSON(name: String, json: IMapField): typingsJapgolly.apolloProtobufjs.mod.MapField = js.native
}
