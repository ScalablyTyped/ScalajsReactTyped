...
import typingsJapgolly.apolloProtobufjs.mod.AnyNestedObject
import typingsJapgolly.apolloProtobufjs.mod.Codegen
import typingsJapgolly.apolloProtobufjs.mod.Constructor
import typingsJapgolly.apolloProtobufjs.mod.Enum
import typingsJapgolly.apolloProtobufjs.mod.Field
import typingsJapgolly.apolloProtobufjs.mod.IConversionOptions
import typingsJapgolly.apolloProtobufjs.mod.INamespace
import typingsJapgolly.apolloProtobufjs.mod.IToJSONOptions
import typingsJapgolly.apolloProtobufjs.mod.IType
import typingsJapgolly.apolloProtobufjs.mod.Message
import typingsJapgolly.apolloProtobufjs.mod.Namespace
import typingsJapgolly.apolloProtobufjs.mod.OneOf
import typingsJapgolly.apolloProtobufjs.mod.Reader
import typingsJapgolly.apolloProtobufjs.mod.ReflectionObject
import typingsJapgolly.apolloProtobufjs.mod.Root
import typingsJapgolly.apolloProtobufjs.mod.Service
import typingsJapgolly.apolloProtobufjs.mod.Type
...
/* Inlined @apollo/protobufjs.@apollo/protobufjs.Type & {  NamePart :@apollo/protobufjs.@apollo/protobufjs.Type} */
object UninterpretedOption {
  
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.NamePart")
  @js.native
  ...
  /** Comment text, if any. */
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.comment")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.ctor")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.extensions")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.fieldsArray")
  @js.native
  val fieldsArray: js.Array[Field] = js.native
  
  /** Defining file name. */
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.filename")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.fullName")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.name")
  @js.native
  def name: String = js.native
  inline def name_=(x: String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("name")(x.asInstanceOf[js.Any])
  
  /** Nested objects by name. */
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.nested")
  @js.native
  def nested: js.UndefOr[StringDictionary[ReflectionObject]] = js.native
  
  /** Nested objects of this namespace as an array for iteration. */
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.nestedArray")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.oneofsArray")
  @js.native
  val oneofsArray: js.Array[OneOf] = js.native
  
  /** Options. */
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.options")
  @js.native
  ...
  /** Parent namespace. */
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.parent")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.reserved")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.resolved")
  @js.native
  ...
  @JSImport("@apollo/protobufjs/ext/descriptor", "UninterpretedOption.root")
  @js.native
