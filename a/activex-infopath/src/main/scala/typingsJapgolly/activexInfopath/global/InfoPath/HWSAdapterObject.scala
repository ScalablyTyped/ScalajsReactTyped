...
/* private */ open class HWSAdapterObject ()
  extends StObject
     with typingsJapgolly.activexInfopath.InfoPath.HWSAdapterObject {
  
  /* private */ /* CompleteClass */
  @JSName("InfoPath.HWSAdapterObject_typekey")
  var InfoPathDotHWSAdapterObject_typekey: typingsJapgolly.activexInfopath.InfoPath.HWSAdapterObject = js.native
