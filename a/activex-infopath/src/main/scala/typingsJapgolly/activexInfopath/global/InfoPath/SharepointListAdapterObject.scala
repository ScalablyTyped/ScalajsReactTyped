...
@js.native
/* private */ open class SharepointListAdapterObject ()
  extends StObject
     with typingsJapgolly.activexInfopath.InfoPath.SharepointListAdapterObject {
  
  /* private */ /* CompleteClass */
  @JSName("InfoPath.SharepointListAdapterObject_typekey")
  var InfoPathDotSharepointListAdapterObject_typekey: typingsJapgolly.activexInfopath.InfoPath.SharepointListAdapterObject = js.native
