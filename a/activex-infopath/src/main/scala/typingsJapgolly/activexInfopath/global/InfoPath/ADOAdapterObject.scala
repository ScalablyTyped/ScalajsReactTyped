...
/* private */ open class ADOAdapterObject ()
  extends StObject
     with typingsJapgolly.activexInfopath.InfoPath.ADOAdapterObject {
  ...
  var InfoPathDotADOAdapterObject_typekey: typingsJapgolly.activexInfopath.InfoPath.ADOAdapterObject = js.native
