...
/* private */ open class SubmitToHostAdapterObject ()
  extends StObject
     with typingsJapgolly.activexInfopath.InfoPath.SubmitToHostAdapterObject {
  
  /* private */ /* CompleteClass */
  @JSName("InfoPath.SubmitToHostAdapterObject_typekey")
  var InfoPathDotSubmitToHostAdapterObject_typekey: typingsJapgolly.activexInfopath.InfoPath.SubmitToHostAdapterObject = js.native
