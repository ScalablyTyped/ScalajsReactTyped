...
import typingsJapgolly.amapJsApiRiding.anon.Info
...
object AMap {
  ...
  object Riding {
    ...
    trait EventMap extends StObject {
      ...
      var error: Event_[typingsJapgolly.amapJsApiRiding.amapJsApiRidingStrings.error, Info]
    }
    object EventMap {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.amapJsApiRiding.AMap.Riding.SearchResultBase
      - typingsJapgolly.amapJsApiRiding.AMap.Riding.SearchResultExt
    */
    trait SearchResult extends StObject
    object SearchResult {
      
      inline def SearchResultBase(count: Double, destination: LngLat, info: String, origin: LngLat, routes: js.Array[RideRoute]): typingsJapgolly.amapJsApiRiding.AMap.Riding.SearchResultBase = {
        ...
        __obj.asInstanceOf[typingsJapgolly.amapJsApiRiding.AMap.Riding.SearchResultBase]
      }
      ...
      inline def SearchResultExt(
        ...
        __obj.asInstanceOf[typingsJapgolly.amapJsApiRiding.AMap.Riding.SearchResultExt]
      }
    }
    ...
    */
    ...
    object SearchStatus {
      ...
      inline def complete: typingsJapgolly.amapJsApiRiding.amapJsApiRidingStrings.complete = "complete".asInstanceOf[typingsJapgolly.amapJsApiRiding.amapJsApiRidingStrings.complete]
      
      inline def error: typingsJapgolly.amapJsApiRiding.amapJsApiRidingStrings.error = "error".asInstanceOf[typingsJapgolly.amapJsApiRiding.amapJsApiRidingStrings.error]
      
      inline def no_data: typingsJapgolly.amapJsApiRiding.amapJsApiRidingStrings.no_data = "no_data".asInstanceOf[typingsJapgolly.amapJsApiRiding.amapJsApiRidingStrings.no_data]
    }
  }
}
