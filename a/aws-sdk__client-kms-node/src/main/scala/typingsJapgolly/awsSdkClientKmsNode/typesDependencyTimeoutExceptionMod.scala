...
import typingsJapgolly.awsSdkClientKmsNode.typesGenerateRandomExceptionsUnionMod.GenerateRandomExceptionsUnion
...
object typesDependencyTimeoutExceptionMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_DependencyTimeoutExceptionDetails> * / any */ trait DependencyTimeoutException
    ...
    var name: typingsJapgolly.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.DependencyTimeoutException
  }
  object DependencyTimeoutException {
    ...
    extension [Self <: DependencyTimeoutException](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.awsSdkClientKmsNode.awsSdkClientKmsNodeStrings.DependencyTimeoutException): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
