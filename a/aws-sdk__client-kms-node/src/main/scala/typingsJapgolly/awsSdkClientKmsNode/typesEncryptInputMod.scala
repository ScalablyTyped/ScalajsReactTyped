...
@JSImport("@aws-sdk/client-kms-node/types/EncryptInput", JSImport.Namespace)
@js.native
object typesEncryptInputMod extends js.Object {
  ...
  trait EncryptInput extends InputTypesUnion {
    ...
    /**
      ...
      */
    var Plaintext: scala.scalajs.js.typedarray.ArrayBuffer | scala.scalajs.js.typedarray.ArrayBufferView | String = js.native
  }
