...
object typesRevokeGrantExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientKmsNode.typesInvalidGrantIdExceptionMod.InvalidGrantIdException
  ...
  */
  ...
  object RevokeGrantExceptionsUnion {
    ...
    inline def InvalidGrantIdException(): typingsJapgolly.awsSdkClientKmsNode.typesInvalidGrantIdExceptionMod.InvalidGrantIdException = {
      val __obj = js.Dynamic.literal(name = "InvalidGrantIdException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientKmsNode.typesInvalidGrantIdExceptionMod.InvalidGrantIdException]
    }
