...
- typingsJapgolly.azdata.mod.InputBoxProperties because var conflicts: CSSStyles, ariaHidden, ariaLabel, ariaRole, ariaSelected, display, enabled, height, position, width. Inlined value, ariaLive, placeHolder, inputType, required, multiline, rows, columns, min, max, stopEnterPropagation, validationErrorMessage, readOnly, title, maxLength */ @js.native
