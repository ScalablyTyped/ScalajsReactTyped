...
- typingsJapgolly.azdata.mod.ComponentWithIconProperties because Already inherited
- typingsJapgolly.azdata.mod.ButtonProperties because var conflicts: CSSStyles, ariaHidden, ariaLabel, ariaRole, ariaSelected, display, enabled, height, iconHeight, iconPath, iconWidth, position, title, width. Inlined label, isFile, fileContent, buttonType, description, secondary, fileType */ @js.native
