...
- typingsJapgolly.azdata.mod.PropertiesContainerComponentProperties because var conflicts: CSSStyles, ariaHidden, ariaLabel, ariaRole, ariaSelected, display, enabled, height, position, width. Inlined propertyItems, showToggleButton */ @js.native
