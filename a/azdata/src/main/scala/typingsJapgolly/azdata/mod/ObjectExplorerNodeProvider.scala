...
object ObjectExplorerNodeProvider {
  ...
  extension [Self <: ObjectExplorerNodeProvider](x: Self) {
    ...
    inline def setHandleSessionClose(value: ObjectExplorerCloseSessionInfo => Callback): Self = StObject.set(x, "handleSessionClose", js.Any.fromFunction1((t0: ObjectExplorerCloseSessionInfo) => value(t0).runNow()))
