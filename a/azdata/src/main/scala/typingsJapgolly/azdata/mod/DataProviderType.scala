...
object DataProviderType extends js.Object {
  ...
  object AdminServicesProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.AdminServicesProvider with String]
  
  /* "AgentServicesProvider" */ @js.native
  object AgentServicesProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.AgentServicesProvider with String]
  
  /* "BackupProvider" */ @js.native
  object BackupProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.BackupProvider with String]
  
  /* "CapabilitiesProvider" */ @js.native
  object CapabilitiesProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.CapabilitiesProvider with String]
  
  /* "ConnectionProvider" */ @js.native
  object ConnectionProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.ConnectionProvider with String]
  
  /* "FileBrowserProvider" */ @js.native
  object FileBrowserProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.FileBrowserProvider with String]
  
  /* "IconProvider" */ @js.native
  object IconProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.IconProvider with String]
  
  /* "MetadataProvider" */ @js.native
  object MetadataProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.MetadataProvider with String]
  
  /* "ObjectExplorerNodeProvider" */ @js.native
  object ObjectExplorerNodeProvider
    extends TopLevel[
          typingsJapgolly.azdata.mod.DataProviderType.ObjectExplorerNodeProvider with String
        ]
  
  /* "ObjectExplorerProvider" */ @js.native
  object ObjectExplorerProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.ObjectExplorerProvider with String]
  
  /* "ProfilerProvider" */ @js.native
  object ProfilerProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.ProfilerProvider with String]
  
  /* "QueryProvider" */ @js.native
  object QueryProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.QueryProvider with String]
  
  /* "RestoreProvider" */ @js.native
  object RestoreProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.RestoreProvider with String]
  
  /* "ScriptingProvider" */ @js.native
  object ScriptingProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.ScriptingProvider with String]
  ...
  object TaskServicesProvider
    extends TopLevel[typingsJapgolly.azdata.mod.DataProviderType.TaskServicesProvider with String]
