...
object window {
  ...
  object MessageLevel extends StObject {
    ...
    sealed trait Error
      extends StObject
         with MessageLevel
    /* 0 */ val Error: typingsJapgolly.azdata.mod.window.MessageLevel.Error & Double = js.native
    
    @js.native
    sealed trait Information
      extends StObject
         with MessageLevel
    /* 2 */ val Information: typingsJapgolly.azdata.mod.window.MessageLevel.Information & Double = js.native
    
    @js.native
    sealed trait Warning
      extends StObject
         with MessageLevel
    /* 1 */ val Warning: typingsJapgolly.azdata.mod.window.MessageLevel.Warning & Double = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azdata.azdataStrings.close
    - typingsJapgolly.azdata.azdataStrings.cancel
    - typingsJapgolly.azdata.azdataStrings.ok
  */
  trait CloseReason extends StObject
  object CloseReason {
    
    inline def cancel: typingsJapgolly.azdata.azdataStrings.cancel = "cancel".asInstanceOf[typingsJapgolly.azdata.azdataStrings.cancel]
    
    inline def close: typingsJapgolly.azdata.azdataStrings.close = "close".asInstanceOf[typingsJapgolly.azdata.azdataStrings.close]
    
    inline def ok: typingsJapgolly.azdata.azdataStrings.ok = "ok".asInstanceOf[typingsJapgolly.azdata.azdataStrings.ok]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.azdata.azdataStrings.right
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azdata.azdataStrings.left
    - typingsJapgolly.azdata.azdataStrings.below
  */
  trait DialogPosition extends StObject
  object DialogPosition {
    
    inline def below: typingsJapgolly.azdata.azdataStrings.below = "below".asInstanceOf[typingsJapgolly.azdata.azdataStrings.below]
    
    inline def left: typingsJapgolly.azdata.azdataStrings.left = "left".asInstanceOf[typingsJapgolly.azdata.azdataStrings.left]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azdata.azdataStrings.normal
    - typingsJapgolly.azdata.azdataStrings.flyout
    - typingsJapgolly.azdata.azdataStrings.callout
  */
  trait DialogStyle extends StObject
  object DialogStyle {
    
    inline def callout: typingsJapgolly.azdata.azdataStrings.callout = "callout".asInstanceOf[typingsJapgolly.azdata.azdataStrings.callout]
    
    inline def flyout: typingsJapgolly.azdata.azdataStrings.flyout = "flyout".asInstanceOf[typingsJapgolly.azdata.azdataStrings.flyout]
    
    inline def normal: typingsJapgolly.azdata.azdataStrings.normal = "normal".asInstanceOf[typingsJapgolly.azdata.azdataStrings.normal]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azdata.azdataStrings.narrow
    - typingsJapgolly.azdata.azdataStrings.medium
    - typingsJapgolly.azdata.azdataStrings.wide
    - scala.Double
    - java.lang.String
  */
  ...
  object ModelViewDashboard {
    ...
    inline def apply(
      close: CallbackTo[Thenable[Unit]],
      open: CallbackTo[Thenable[Unit]],
      registerTabs: js.Function1[/* view */ ModelView, Thenable[js.Array[DashboardTab | DashboardTabGroup]]] => Callback,
      selectTab: String => Callback,
      updateTabs: js.Array[DashboardTab | DashboardTabGroup] => Callback
    ): ModelViewDashboard = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, open = open.toJsFn, registerTabs = js.Any.fromFunction1((t0: js.Function1[/* view */ ModelView, Thenable[js.Array[DashboardTab | DashboardTabGroup]]]) => registerTabs(t0).runNow()), selectTab = js.Any.fromFunction1((t0: String) => selectTab(t0).runNow()), updateTabs = js.Any.fromFunction1((t0: js.Array[DashboardTab | DashboardTabGroup]) => updateTabs(t0).runNow()))
      __obj.asInstanceOf[ModelViewDashboard]
    }
    
    extension [Self <: ModelViewDashboard](x: Self) {
      
      inline def setClose(value: CallbackTo[Thenable[Unit]]): Self = StObject.set(x, "close", value.toJsFn)
      
      inline def setOpen(value: CallbackTo[Thenable[Unit]]): Self = StObject.set(x, "open", value.toJsFn)
      
      inline def setRegisterTabs(
        value: js.Function1[/* view */ ModelView, Thenable[js.Array[DashboardTab | DashboardTabGroup]]] => Callback
      ): Self = StObject.set(x, "registerTabs", js.Any.fromFunction1((t0: js.Function1[/* view */ ModelView, Thenable[js.Array[DashboardTab | DashboardTabGroup]]]) => value(t0).runNow()))
      
      inline def setSelectTab(value: String => Callback): Self = StObject.set(x, "selectTab", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      
      inline def setUpdateTabs(value: js.Array[DashboardTab | DashboardTabGroup] => Callback): Self = StObject.set(x, "updateTabs", js.Any.fromFunction1((t0: js.Array[DashboardTab | DashboardTabGroup]) => value(t0).runNow()))
    }
  }
