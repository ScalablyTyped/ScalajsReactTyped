...
- typingsJapgolly.azdata.mod.DeclarativeTableProperties because var conflicts: CSSStyles, ariaHidden, ariaLabel, ariaRole, ariaSelected, display, enabled, height, position, width. Inlined data, columns, dataValues, enableRowSelection, selectedRow */ @js.native
