...
- typingsJapgolly.azdata.mod.InfoBoxComponentProperties because var conflicts: CSSStyles, ariaHidden, ariaLabel, ariaRole, ariaSelected, display, enabled, height, position, width. Inlined style, text, announceText */ @js.native
