...
object ColumnSizingMode extends StObject {
  ...
  /* 1 */ val AutoFit: typingsJapgolly.azdata.mod.ColumnSizingMode.AutoFit & Double = js.native
  ...
  sealed trait DataFit
    extends StObject
       with ColumnSizingMode
  /* 2 */ val DataFit: typingsJapgolly.azdata.mod.ColumnSizingMode.DataFit & Double = js.native
  ...
  sealed trait ForceFit
    extends StObject
       with ColumnSizingMode
  /* 0 */ val ForceFit: typingsJapgolly.azdata.mod.ColumnSizingMode.ForceFit & Double = js.native
}
