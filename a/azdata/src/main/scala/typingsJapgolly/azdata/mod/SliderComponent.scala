...
- typingsJapgolly.azdata.mod.SliderComponentProperties because var conflicts: CSSStyles, ariaHidden, ariaLabel, ariaRole, ariaSelected, display, enabled, height, position, width. Inlined value, min, max, step, showTicks */ @js.native
