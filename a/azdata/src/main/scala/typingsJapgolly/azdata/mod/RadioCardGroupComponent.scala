...
import typingsJapgolly.azdata.azdataStrings.left
import typingsJapgolly.azdata.azdataStrings.top
...
- typingsJapgolly.azdata.mod.RadioCardGroupComponentProperties because var conflicts: CSSStyles, ariaHidden, ariaLabel, ariaRole, ariaSelected, display, enabled, height, position, width. Inlined cards, cardWidth, cardHeight, iconWidth, iconHeight, selectedCardId, orientation, iconPosition */ @js.native
