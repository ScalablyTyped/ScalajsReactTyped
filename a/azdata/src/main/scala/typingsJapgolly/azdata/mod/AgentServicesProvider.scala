...
object AgentServicesProvider {
  ...
  inline def apply(
    ...
    providerId: String,
    registerOnUpdated: js.Function0[Any] => Callback,
  ...
  extension [Self <: AgentServicesProvider](x: Self) {
    ...
    inline def setRegisterOnUpdated(value: js.Function0[Any] => Callback): Self = StObject.set(x, "registerOnUpdated", js.Any.fromFunction1((t0: js.Function0[Any]) => value(t0).runNow()))
