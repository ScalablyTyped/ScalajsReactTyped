...
object ConnectionProvider {
  ...
  inline def apply(
    ...
    registerOnConnectionChanged: js.Function1[/* changedConnInfo */ ChangedConnectionInfo, Any] => Callback,
    registerOnConnectionComplete: js.Function1[/* connSummary */ ConnectionInfoSummary, Any] => Callback,
    registerOnIntelliSenseCacheComplete: js.Function1[/* connectionUri */ String, Any] => Callback
  ): ConnectionProvider = {
    val __obj = js.Dynamic.literal(cancelConnect = js.Any.fromFunction1(cancelConnect), changeDatabase = js.Any.fromFunction2(changeDatabase), connect = js.Any.fromFunction2(connect), disconnect = js.Any.fromFunction1(disconnect), getConnectionString = js.Any.fromFunction2(getConnectionString), listDatabases = js.Any.fromFunction1(listDatabases), providerId = providerId.asInstanceOf[js.Any], rebuildIntelliSenseCache = js.Any.fromFunction1(rebuildIntelliSenseCache), registerOnConnectionChanged = js.Any.fromFunction1((t0: js.Function1[/* changedConnInfo */ ChangedConnectionInfo, Any]) => registerOnConnectionChanged(t0).runNow()), registerOnConnectionComplete = js.Any.fromFunction1((t0: js.Function1[/* connSummary */ ConnectionInfoSummary, Any]) => registerOnConnectionComplete(t0).runNow()), registerOnIntelliSenseCacheComplete = js.Any.fromFunction1((t0: js.Function1[/* connectionUri */ String, Any]) => registerOnIntelliSenseCacheComplete(t0).runNow()))
  ...
  extension [Self <: ConnectionProvider](x: Self) {
    ...
    inline def setRegisterOnConnectionChanged(value: js.Function1[/* changedConnInfo */ ChangedConnectionInfo, Any] => Callback): Self = StObject.set(x, "registerOnConnectionChanged", js.Any.fromFunction1((t0: js.Function1[/* changedConnInfo */ ChangedConnectionInfo, Any]) => value(t0).runNow()))
    
    inline def setRegisterOnConnectionComplete(value: js.Function1[/* connSummary */ ConnectionInfoSummary, Any] => Callback): Self = StObject.set(x, "registerOnConnectionComplete", js.Any.fromFunction1((t0: js.Function1[/* connSummary */ ConnectionInfoSummary, Any]) => value(t0).runNow()))
    
    inline def setRegisterOnIntelliSenseCacheComplete(value: js.Function1[/* connectionUri */ String, Any] => Callback): Self = StObject.set(x, "registerOnIntelliSenseCacheComplete", js.Any.fromFunction1((t0: js.Function1[/* connectionUri */ String, Any]) => value(t0).runNow()))
  }
}
