...
import typingsJapgolly.algoliaRequesterCommon.anon.ReadonlyPromiseResponse
import typingsJapgolly.algoliaRequesterCommon.anon.ReadonlyPromisevoid
...
object mod {
  ...
  object Destroyable {
    ...
    inline def apply(destroy: CallbackTo[ReadonlyPromisevoid]): Destroyable = {
    ...
    extension [Self <: Destroyable](x: Self) {
      ...
      inline def setDestroy(value: CallbackTo[ReadonlyPromisevoid]): Self = StObject.set(x, "destroy", value.toJsFn)
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.DELETE
    - typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.GET
    - typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.POST
    - typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.PUT
  */
  trait MethodType extends StObject
  object MethodType {
    
    inline def DELETE: typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.DELETE = "DELETE".asInstanceOf[typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.DELETE]
    
    inline def GET: typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.GET = "GET".asInstanceOf[typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.GET]
    
    inline def POST: typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.POST = "POST".asInstanceOf[typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.POST]
    
    inline def PUT: typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.algoliaRequesterCommon.algoliaRequesterCommonStrings.PUT]
  }
