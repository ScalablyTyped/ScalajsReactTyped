...
import typingsJapgolly.atlaskitMotion.distTypesUtilsUseElementRefMod.CallbackRef
import typingsJapgolly.atlaskitMotion.distTypesUtilsUseElementRefMod.Element
...
object anon {
  ...
  object RefCallbackRef {
    ...
    inline def apply(ref: /* instance */ Element => Callback): RefCallbackRef = {
      val __obj = js.Dynamic.literal(ref = js.Any.fromFunction1((t0: /* instance */ Element) => ref(t0).runNow()))
      __obj.asInstanceOf[RefCallbackRef]
    }
    
    extension [Self <: RefCallbackRef](x: Self) {
      
      inline def setRef(value: /* instance */ Element => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: /* instance */ Element) => value(t0).runNow()))
    }
  }
  ...
  trait ResizingHeightOptschildre extends StObject {
    ...
    def children(opts: RefCallbackRef): Node
  ...
  object ResizingHeightOptschildre {
    ...
    inline def apply(children: RefCallbackRef => Node): ResizingHeightOptschildre = {
    ...
    extension [Self <: ResizingHeightOptschildre](x: Self) {
      ...
      inline def setChildren(value: RefCallbackRef => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
