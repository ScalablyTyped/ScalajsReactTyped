...
import typingsJapgolly.aphrodite.aphroditeInts.`100`
import typingsJapgolly.aphrodite.aphroditeInts.`200`
import typingsJapgolly.aphrodite.aphroditeInts.`300`
import typingsJapgolly.aphrodite.aphroditeInts.`400`
import typingsJapgolly.aphrodite.aphroditeInts.`500`
import typingsJapgolly.aphrodite.aphroditeInts.`600`
import typingsJapgolly.aphrodite.aphroditeInts.`700`
import typingsJapgolly.aphrodite.aphroditeInts.`800`
import typingsJapgolly.aphrodite.aphroditeInts.`900`
...
object typingsCssPropertiesMod {
  ...
  - typingsJapgolly.aphrodite.typingsCssPropertiesMod.CSSPropertiesLossy because Inheritance from two classes. Inlined  */ trait CSSProperties
    extends StObject
       ...
       with /* propertyName */ StringDictionary[
          js.UndefOr[
            String | Double | CSSPropertiesComplete | (js.Array[
              js.UndefOr[
                /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 258, starting with typingsJapgolly.aphrodite.typingsCssPropertiesMod.CSSWideKeyword, typingsJapgolly.aphrodite.aphroditeStrings.flat, typingsJapgolly.aphrodite.aphroditeStrings.`preserve-3d` */ Any
              ]
            ]) | CSSPropertiesLossy
          ]
        ]
  ...
  */
  ...
  object CSSWideKeyword {
    ...
    inline def inherit: typingsJapgolly.aphrodite.aphroditeStrings.inherit = "inherit".asInstanceOf[typingsJapgolly.aphrodite.aphroditeStrings.inherit]
    
    inline def initial: typingsJapgolly.aphrodite.aphroditeStrings.initial = "initial".asInstanceOf[typingsJapgolly.aphrodite.aphroditeStrings.initial]
    
    inline def unset: typingsJapgolly.aphrodite.aphroditeStrings.unset = "unset".asInstanceOf[typingsJapgolly.aphrodite.aphroditeStrings.unset]
  }
}
