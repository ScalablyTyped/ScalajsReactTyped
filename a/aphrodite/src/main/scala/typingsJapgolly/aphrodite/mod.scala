...
import typingsJapgolly.aphrodite.anon.Content
import typingsJapgolly.aphrodite.aphroditeBooleans.`false`
...
object mod {
  ...
  object Exports {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(StyleSheet = StyleSheet.asInstanceOf[js.Any], StyleSheetServer = StyleSheetServer.asInstanceOf[js.Any], StyleSheetTestUtils = StyleSheetTestUtils.asInstanceOf[js.Any], css = js.Any.fromFunction1(css), flushToStyleTag = flushToStyleTag.toJsFn)
    ...
    extension [Self <: Exports](x: Self) {
      ...
      inline def setFlushToStyleTag(value: Callback): Self = StObject.set(x, "flushToStyleTag", value.toJsFn)
  ...
  type StyleDeclarationMap = Map[
    /* keyof aphrodite.aphrodite/typings/css-properties.CSSProperties */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 340, starting with typingsJapgolly.aphrodite.aphroditeStrings.alignContent, typingsJapgolly.aphrodite.aphroditeStrings.alignItems, typingsJapgolly.aphrodite.aphroditeStrings.alignSelf */ Any, 
    String | Double
  ]
  ...
  object StyleSheetStatic {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(create = js.Any.fromFunction1(create), extend = js.Any.fromFunction1(extend), rehydrate = js.Any.fromFunction1((t0: js.Array[String]) => rehydrate(t0).runNow()))
    ...
    extension [Self <: StyleSheetStatic](x: Self) {
      ...
      inline def setRehydrate(value: js.Array[String] => Callback): Self = StObject.set(x, "rehydrate", js.Any.fromFunction1((t0: js.Array[String]) => value(t0).runNow()))
    }
  }
  ...
  object StyleSheetTestUtilsStatic {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(clearBufferAndResumeStyleInjection = clearBufferAndResumeStyleInjection.toJsFn, getBufferedStyles = getBufferedStyles.toJsFn, suppressStyleInjection = suppressStyleInjection.toJsFn)
      __obj.asInstanceOf[StyleSheetTestUtilsStatic]
    }
    
    extension [Self <: StyleSheetTestUtilsStatic](x: Self) {
      
      inline def setClearBufferAndResumeStyleInjection(value: Callback): Self = StObject.set(x, "clearBufferAndResumeStyleInjection", value.toJsFn)
      
      inline def setGetBufferedStyles(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "getBufferedStyles", value.toJsFn)
      
      inline def setSuppressStyleInjection(value: Callback): Self = StObject.set(x, "suppressStyleInjection", value.toJsFn)
    }
  }
}
