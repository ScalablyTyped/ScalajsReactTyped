...
object MapConstructorOptions {
  @scala.inline
  def apply(
    annotationForCluster: /* annotation */ Annotation => Callback = null,
    ...
    if (annotationForCluster != null) __obj.updateDynamic("annotationForCluster")(js.Any.fromFunction1((t0: /* annotation */ typingsJapgolly.appleMapkitJs.mapkit.Annotation) => annotationForCluster(t0).runNow()))
