package typingsJapgolly.angularUiScroll
...
import typingsJapgolly.angular.mod.IRepeatScope
...
object angularMod {
  ...
  object ui {
    ...
    object IScrollDatasource {
      ...
      inline def apply[T](get: (Double, Double, js.Function1[/* results */ js.Array[T], Any]) => Callback): IScrollDatasource[T] = {
        val __obj = js.Dynamic.literal(get = js.Any.fromFunction3((t0: Double, t1: Double, t2: js.Function1[/* results */ js.Array[T], Any]) => (get(t0, t1, t2)).runNow()))
        __obj.asInstanceOf[IScrollDatasource[T]]
      }
      
      extension [Self <: IScrollDatasource[?], T](x: Self & IScrollDatasource[T]) {
        
        inline def setGet(value: (Double, Double, js.Function1[/* results */ js.Array[T], Any]) => Callback): Self = StObject.set(x, "get", js.Any.fromFunction3((t0: Double, t1: Double, t2: js.Function1[/* results */ js.Array[T], Any]) => (value(t0, t1, t2)).runNow()))
      }
    }
  }
}
