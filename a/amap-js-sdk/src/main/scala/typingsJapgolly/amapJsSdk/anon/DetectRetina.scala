...
trait DetectRetina extends StObject {
  ...
  var map: typingsJapgolly.amapJsSdk.AMap.Map
...
object DetectRetina {
  ...
  inline def apply(map: typingsJapgolly.amapJsSdk.AMap.Map): DetectRetina = {
  ...
  extension [Self <: DetectRetina](x: Self) {
    ...
    inline def setMap(value: typingsJapgolly.amapJsSdk.AMap.Map): Self = StObject.set(x, "map", value.asInstanceOf[js.Any])
