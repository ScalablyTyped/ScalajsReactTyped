...
import typingsJapgolly.azureKustoData.anon.ColumnName
import typingsJapgolly.azureKustoData.anon.Data
import typingsJapgolly.azureKustoData.anon.Name
...
object sourceModelsMod {
  
  @JSImport("azure-kusto-data/source/models", "KustoResultColumn")
  @js.native
  ...
  @JSImport("azure-kusto-data/source/models", "KustoResultRow")
  @js.native
  ...
  @JSImport("azure-kusto-data/source/models", "KustoResultTable")
  @js.native
  ...
  @JSImport("azure-kusto-data/source/models", "WellKnownDataSet")
  @js.native
  object WellKnownDataSet extends StObject {
    ...
    /* "PrimaryResult" */ val PrimaryResult: typingsJapgolly.azureKustoData.sourceModelsMod.WellKnownDataSet.PrimaryResult & String = js.native
    
    @js.native
    sealed trait QueryCompletionInformation
      extends StObject
         with WellKnownDataSet
    /* "QueryCompletionInformation" */ val QueryCompletionInformation: typingsJapgolly.azureKustoData.sourceModelsMod.WellKnownDataSet.QueryCompletionInformation & String = js.native
    
    @js.native
    sealed trait QueryProperties
      extends StObject
         with WellKnownDataSet
    /* "QueryProperties" */ val QueryProperties: typingsJapgolly.azureKustoData.sourceModelsMod.WellKnownDataSet.QueryProperties & String = js.native
    
    @js.native
    sealed trait TableOfContents
      extends StObject
         with WellKnownDataSet
    /* "TableOfContents" */ val TableOfContents: typingsJapgolly.azureKustoData.sourceModelsMod.WellKnownDataSet.TableOfContents & String = js.native
  }
  ...
  type TimeSpanParser = js.Function1[/* value */ Double, Any]
}
