...
import typingsJapgolly.angularCli.srcUtilitiesPackageManagerMod.PackageManagerUtils
...
object srcCommandBuilderCommandModuleMod {
  ...
  object CommandScope extends StObject {
    ...
    sealed trait Both
      extends StObject
         with CommandScope
    /* 2 */ val Both: typingsJapgolly.angularCli.srcCommandBuilderCommandModuleMod.CommandScope.Both & Double = js.native
    ...
    sealed trait In
      extends StObject
         with CommandScope
    /* 0 */ val In: typingsJapgolly.angularCli.srcCommandBuilderCommandModuleMod.CommandScope.In & Double = js.native
    ...
    sealed trait Out
      extends StObject
         with CommandScope
    /* 1 */ val Out: typingsJapgolly.angularCli.srcCommandBuilderCommandModuleMod.CommandScope.Out & Double = js.native
  }
  
  trait CommandContext extends StObject {
    
    /** Arguments parsed in free-from without parser configuration. */
    var args: typingsJapgolly.angularCli.anon.Options
  ...
  object CommandContext {
    ...
    inline def apply(
      args: typingsJapgolly.angularCli.anon.Options,
    ...
    extension [Self <: CommandContext](x: Self) {
      ...
      inline def setArgs(value: typingsJapgolly.angularCli.anon.Options): Self = StObject.set(x, "args", value.asInstanceOf[js.Any])
