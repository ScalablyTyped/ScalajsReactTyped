...
object srcCommandsUpdateSchematicSchemaMod {
  ...
  object PackageManager extends StObject {
    ...
    sealed trait Cnpm
      extends StObject
         with PackageManager
    /* "cnpm" */ val Cnpm: typingsJapgolly.angularCli.srcCommandsUpdateSchematicSchemaMod.PackageManager.Cnpm & String = js.native
    
    @js.native
    sealed trait Npm
      extends StObject
         with PackageManager
    /* "npm" */ val Npm: typingsJapgolly.angularCli.srcCommandsUpdateSchematicSchemaMod.PackageManager.Npm & String = js.native
    
    @js.native
    sealed trait Pnpm
      extends StObject
         with PackageManager
    /* "pnpm" */ val Pnpm: typingsJapgolly.angularCli.srcCommandsUpdateSchematicSchemaMod.PackageManager.Pnpm & String = js.native
    
    @js.native
    sealed trait Yarn
      extends StObject
         with PackageManager
    /* "yarn" */ val Yarn: typingsJapgolly.angularCli.srcCommandsUpdateSchematicSchemaMod.PackageManager.Yarn & String = js.native
  }
