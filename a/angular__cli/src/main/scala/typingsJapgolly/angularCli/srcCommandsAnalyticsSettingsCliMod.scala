...
import typingsJapgolly.angularCli.anon.OptionsAnalyticsCommandAr
...
object srcCommandsAnalyticsSettingsCliMod {
  ...
  - typingsJapgolly.angularCli.srcCommandBuilderCommandModuleMod.CommandModuleImplementation because var conflicts: aliases, command, deprecated, describe, longDescriptionPath, scope. Inlined  */ @JSImport("@angular/cli/src/commands/analytics/settings/cli", "AnalyticsDisableModule")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.angularCli.srcCommandBuilderCommandModuleMod.CommandModuleImplementation because var conflicts: aliases, command, deprecated, describe, longDescriptionPath, scope. Inlined  */ @JSImport("@angular/cli/src/commands/analytics/settings/cli", "AnalyticsEnableModule")
  @js.native
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.angularCli.srcCommandBuilderCommandModuleMod.CommandModuleImplementation because var conflicts: aliases, command, deprecated, describe, longDescriptionPath, scope. Inlined  */ @JSImport("@angular/cli/src/commands/analytics/settings/cli", "AnalyticsPromptModule")
  @js.native
  ...
  trait AnalyticsSettingModule extends StObject {
    ...
    def builder(localYargs: Argv[js.Object]): Argv[AnalyticsCommandArgs] = js.native
    @JSName("builder")
    def builder_Union(argv: Argv[js.Object]): js.Promise[Argv[AnalyticsCommandArgs]] | Argv[AnalyticsCommandArgs] = js.native
