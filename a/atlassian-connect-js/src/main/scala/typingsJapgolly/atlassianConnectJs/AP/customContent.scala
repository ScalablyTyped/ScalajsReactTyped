...
object customContent {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmit
    - typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmitSuccess
    - typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmitError
    - typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotcancel
  */
  trait InterceptableEvent extends StObject
  object InterceptableEvent {
    
    inline def confluenceDotcustomcontentDotcancel: typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotcancel = "confluence.customcontent.cancel".asInstanceOf[typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotcancel]
    
    inline def confluenceDotcustomcontentDotsubmit: typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmit = "confluence.customcontent.submit".asInstanceOf[typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmit]
    
    inline def confluenceDotcustomcontentDotsubmitError: typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmitError = "confluence.customcontent.submitError".asInstanceOf[typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmitError]
    
    inline def confluenceDotcustomcontentDotsubmitSuccess: typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmitSuccess = "confluence.customcontent.submitSuccess".asInstanceOf[typingsJapgolly.atlassianConnectJs.atlassianConnectJsStrings.confluenceDotcustomcontentDotsubmitSuccess]
  }
}
