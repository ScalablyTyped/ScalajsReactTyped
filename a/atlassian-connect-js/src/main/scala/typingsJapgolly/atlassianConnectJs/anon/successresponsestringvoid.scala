...
object successresponsestringvoid {
  
  inline def apply(): successresponsestringvoid = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[successresponsestringvoid]
  }
  
  extension [Self <: successresponsestringvoid](x: Self) {
    ...
    inline def setSuccess(value: /* response */ String => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* response */ String) => value(t0).runNow()))
