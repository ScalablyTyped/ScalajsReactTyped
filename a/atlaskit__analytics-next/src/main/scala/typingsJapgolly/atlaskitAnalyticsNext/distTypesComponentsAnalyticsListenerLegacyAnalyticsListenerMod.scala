...
import typingsJapgolly.atlaskitAnalyticsNext.anon.GetAtlaskitAnalyticsEventHandlers
...
object distTypesComponentsAnalyticsListenerLegacyAnalyticsListenerMod {
  ...
  trait Props extends StObject {
    ...
    def onEvent(event: typingsJapgolly.atlaskitAnalyticsNext.distTypesEventsUianalyticseventMod.default): Unit = js.native
    def onEvent(
      event: typingsJapgolly.atlaskitAnalyticsNext.distTypesEventsUianalyticseventMod.default,
      channel: String
    ): Unit = js.native
  }
}
