...
import typingsJapgolly.apostrophe.AnonFields
import typingsJapgolly.apostrophe.AnonProjection
...
object AposModuleOptions {
  ...
  def apply[C](
    ...
    beforeConstruct: (/* self */ js.Any, /* options */ js.Any) => CallbackTo[js.Any] = null,
    ...
    if (beforeConstruct != null) __obj.updateDynamic("beforeConstruct")(js.Any.fromFunction2((t0: /* self */ js.Any, t1: /* options */ js.Any) => beforeConstruct(t0, t1).runNow()))
