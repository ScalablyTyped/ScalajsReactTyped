...
object SimpleTransformIteratorOptions {
  ...
  def apply[S, T](
    ...
    filter: /* item */ S => CallbackTo[Boolean] = null,
    limit: Int | Double = null,
    map: /* item */ S => CallbackTo[T] = null,
    maxBufferSize: Int | Double = null,
    offset: Int | Double = null,
    optional: js.UndefOr[Boolean] = js.undefined,
    prepend: js.Array[T] = null,
    source: AsyncIterator[S] = null,
    transform: (/* item */ S, /* callback */ js.Function1[/* result */ T, Unit]) => Callback = null
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction1((t0: /* item */ S) => filter(t0).runNow()))
    if (limit != null) __obj.updateDynamic("limit")(limit.asInstanceOf[js.Any])
    if (map != null) __obj.updateDynamic("map")(js.Any.fromFunction1((t0: /* item */ S) => map(t0).runNow()))
    ...
    if (transform != null) __obj.updateDynamic("transform")(js.Any.fromFunction2((t0: /* item */ S, t1: /* callback */ js.Function1[/* result */ T, scala.Unit]) => transform(t0, t1).runNow()))
