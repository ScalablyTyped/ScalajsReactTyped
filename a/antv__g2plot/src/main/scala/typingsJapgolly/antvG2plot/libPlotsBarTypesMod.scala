...
object libPlotsBarTypesMod {
  
  /* Inlined parent std.Omit<@antv/g2plot.@antv/g2plot/lib/plots/column/types.ColumnOptions, 'columnStyle' | 'columnWidthRatio' | 'minColumnWidth' | 'maxColumnWidth'> */
  trait BarOptions extends StObject {
    ...
    /**
      * @title 条形图柱子的背景配置
      */
    val barBackground: js.UndefOr[`0`] = js.undefined
    ...
    /**
      ...
      * @description 范围[0-1]
      */
    val barWidthRatio: js.UndefOr[Double] = js.undefined
    ...
    /**
      * @title 条形图最大宽度（像素）
      */
    val maxBarWidth: js.UndefOr[Double] = js.undefined
    ...
    /**
      * @title 条形图最小宽度（像素）
      */
    val minBarWidth: js.UndefOr[Double] = js.undefined
