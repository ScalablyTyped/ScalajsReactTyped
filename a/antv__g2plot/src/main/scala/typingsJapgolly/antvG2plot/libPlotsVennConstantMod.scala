...
object libPlotsVennConstantMod {
  ...
  object DEFAULT_OPTIONS {
    ...
    @js.native
    def data: js.UndefOr[js.Array[typingsJapgolly.antvG2.libInterfaceMod.Datum]] = js.native
    inline def data_=(x: js.UndefOr[js.Array[typingsJapgolly.antvG2.libInterfaceMod.Datum]]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("data")(x.asInstanceOf[js.Any])
