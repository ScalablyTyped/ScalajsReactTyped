...
trait PartialSunburstOptions extends StObject {
  ...
  var sunburstStyle: js.UndefOr[StyleAttr] = js.undefined
...
object PartialSunburstOptions {
  
  inline def apply(): PartialSunburstOptions = {
