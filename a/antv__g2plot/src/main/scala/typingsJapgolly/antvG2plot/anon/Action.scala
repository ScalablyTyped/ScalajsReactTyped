...
import typingsJapgolly.antvG2plot.antvG2plotBooleans.`true`
...
object Action {
  ...
  extension [Self <: Action](x: Self) {
    ...
    inline def setIsEnableCallbackTo(value: CallbackTo[`true`]): Self = StObject.set(x, "isEnable", value.toJsFn)
