...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/pie.PieOptions> */
trait PlotOptionsPieOptions extends StObject {
...
object PlotOptionsPieOptions {
  
  inline def apply(angleField: String, colorField: String): PlotOptionsPieOptions = {
    val __obj = js.Dynamic.literal(angleField = angleField.asInstanceOf[js.Any], colorField = colorField.asInstanceOf[js.Any])
