...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/area/types.AreaOptions> */
trait PartialAreaOptions extends StObject {
  ...
  var line: js.UndefOr[js.UndefOr[MappingOptions] & PickPointGeometryOptionss] = js.undefined
...
object PartialAreaOptions {
  
  inline def apply(): PartialAreaOptions = {
