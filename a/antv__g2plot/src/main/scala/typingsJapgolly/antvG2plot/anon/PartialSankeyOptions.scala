...
import typingsJapgolly.antvG2plot.libPlotsSankeyTypesMod.NodeLinkData
...
trait PartialSankeyOptions extends StObject {
  ...
  var data: js.UndefOr[typingsJapgolly.antvG2plot.libTypesCommonMod.Data | NodeLinkData] = js.undefined
  ...
  var edgeState: js.UndefOr[typingsJapgolly.antvG2plot.libTypesStateMod.State] = js.undefined
  ...
  var nodeState: js.UndefOr[typingsJapgolly.antvG2plot.libTypesStateMod.State] = js.undefined
...
object PartialSankeyOptions {
  ...
  extension [Self <: PartialSankeyOptions](x: Self) {
    ...
    inline def setData(value: typingsJapgolly.antvG2plot.libTypesCommonMod.Data | NodeLinkData): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    ...
    inline def setEdgeState(value: typingsJapgolly.antvG2plot.libTypesStateMod.State): Self = StObject.set(x, "edgeState", value.asInstanceOf[js.Any])
    ...
    inline def setNodeState(value: typingsJapgolly.antvG2plot.libTypesStateMod.State): Self = StObject.set(x, "nodeState", value.asInstanceOf[js.Any])
