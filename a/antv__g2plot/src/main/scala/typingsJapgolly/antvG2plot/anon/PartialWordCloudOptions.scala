...
import typingsJapgolly.antvG2plot.libPlotsWordCloudTypesMod.WordStyle
...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/word-cloud/types.WordCloudOptions> */
trait PartialWordCloudOptions extends StObject {
  ...
  var wordStyle: js.UndefOr[WordStyle] = js.undefined
  
  var xAxis: js.UndefOr[Axis] = js.undefined
  
  var yAxis: js.UndefOr[Axis] = js.undefined
}
object PartialWordCloudOptions {
  
  inline def apply(): PartialWordCloudOptions = {
