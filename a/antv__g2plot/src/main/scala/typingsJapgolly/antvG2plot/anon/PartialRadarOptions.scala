...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/radar/types.RadarOptions> */
trait PartialRadarOptions extends StObject {
  ...
  var area: js.UndefOr[MappingOptions] = js.undefined
...
object PartialRadarOptions {
  
  inline def apply(): PartialRadarOptions = {
