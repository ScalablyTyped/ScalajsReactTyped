...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/bar.BarOptions> */
trait PlotOptionsBarOptions extends StObject {
...
object PlotOptionsBarOptions {
  
  inline def apply(xField: String, yField: String): PlotOptionsBarOptions = {
    val __obj = js.Dynamic.literal(xField = xField.asInstanceOf[js.Any], yField = yField.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlotOptionsBarOptions]
  }
  
  extension [Self <: PlotOptionsBarOptions](x: Self) {
