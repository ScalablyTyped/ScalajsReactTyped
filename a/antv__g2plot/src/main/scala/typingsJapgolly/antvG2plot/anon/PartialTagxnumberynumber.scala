...
import typingsJapgolly.antvG2plot.antvG2plotStrings.italic
import typingsJapgolly.antvG2plot.antvG2plotStrings.normal
import typingsJapgolly.antvG2plot.antvG2plotStrings.oblique
...
trait PartialTagxnumberynumber extends StObject {
  ...
  var weight: js.UndefOr[typingsJapgolly.antvG2plot.libPlotsWordCloudTypesMod.FontWeight] = js.undefined
...
object PartialTagxnumberynumber {
  ...
  extension [Self <: PartialTagxnumberynumber](x: Self) {
    ...
    inline def setWeight(value: typingsJapgolly.antvG2plot.libPlotsWordCloudTypesMod.FontWeight): Self = StObject.set(x, "weight", value.asInstanceOf[js.Any])
