...
object PartialCSSStyleDeclaratio {
  ...
  extension [Self <: PartialCSSStyleDeclaratio](x: Self) {
    ...
    inline def setSetProperty(value: /* property */ String => japgolly.scalajs.react.Callback): Self = StObject.set(x, "setProperty", js.Any.fromFunction1((t0: /* property */ String) => value(t0).runNow()))
