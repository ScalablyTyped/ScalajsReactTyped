...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/column.ColumnOptions> */
trait PlotOptionsColumnOptions extends StObject {
...
object PlotOptionsColumnOptions {
  
  inline def apply(xField: String, yField: String): PlotOptionsColumnOptions = {
    val __obj = js.Dynamic.literal(xField = xField.asInstanceOf[js.Any], yField = yField.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlotOptionsColumnOptions]
  }
  
  extension [Self <: PlotOptionsColumnOptions](x: Self) {
