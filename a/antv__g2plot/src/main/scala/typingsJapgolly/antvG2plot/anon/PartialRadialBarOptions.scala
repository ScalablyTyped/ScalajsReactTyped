...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/radial-bar/types.RadialBarOptions> */
trait PartialRadialBarOptions extends StObject {
  ...
  var barStyle: js.UndefOr[ShapeAttrs] = js.undefined
...
object PartialRadialBarOptions {
  
  inline def apply(): PartialRadialBarOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialRadialBarOptions]
  }
  
  extension [Self <: PartialRadialBarOptions](x: Self) {
