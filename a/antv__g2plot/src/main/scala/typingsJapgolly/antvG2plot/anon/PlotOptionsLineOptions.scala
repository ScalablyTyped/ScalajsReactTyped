...
trait PlotOptionsLineOptions extends StObject {
...
object PlotOptionsLineOptions {
  
  inline def apply(): PlotOptionsLineOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PlotOptionsLineOptions]
  }
  
  extension [Self <: PlotOptionsLineOptions](x: Self) {
