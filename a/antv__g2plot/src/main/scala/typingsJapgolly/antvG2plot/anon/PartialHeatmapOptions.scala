...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/heatmap/types.HeatmapOptions> */
trait PartialHeatmapOptions extends StObject {
  ...
  var heatmapStyle: js.UndefOr[StyleAttr] = js.undefined
  ...
  var sizeRatio: js.UndefOr[Double] = js.undefined
  ...
  var `type`: js.UndefOr[polygon | density] = js.undefined
...
object PartialHeatmapOptions {
  
  inline def apply(): PartialHeatmapOptions = {
  ...
  extension [Self <: PartialHeatmapOptions](x: Self) {
    ...
    inline def setReflect(value: typingsJapgolly.antvG2plot.antvG2plotStrings.x | y): Self = StObject.set(x, "reflect", value.asInstanceOf[js.Any])
