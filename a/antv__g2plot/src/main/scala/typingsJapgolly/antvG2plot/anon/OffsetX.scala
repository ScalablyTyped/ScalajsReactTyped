...
import typingsJapgolly.antvG2plot.libTypesCommonMod.TextStyle
...
trait OffsetX extends StObject {
  ...
  val formatter: js.UndefOr[
    String | (js.Function2[
      ...
      /* data */ js.UndefOr[typingsJapgolly.antvG2plot.libTypesCommonMod.Data], 
      String
    ])
  ] = js.undefined
...
object OffsetX {
  ...
  extension [Self <: OffsetX](x: Self) {
    ...
    inline def setFormatterFunction2(
      value: (/* datum */ js.UndefOr[Datum], /* data */ js.UndefOr[typingsJapgolly.antvG2plot.libTypesCommonMod.Data]) => String
