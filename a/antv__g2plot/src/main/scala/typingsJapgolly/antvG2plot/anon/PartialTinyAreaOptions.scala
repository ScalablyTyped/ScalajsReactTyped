...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/tiny-area/types.TinyAreaOptions> */
trait PartialTinyAreaOptions extends StObject {
...
object PartialTinyAreaOptions {
  
  inline def apply(): PartialTinyAreaOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialTinyAreaOptions]
  }
  
  extension [Self <: PartialTinyAreaOptions](x: Self) {
