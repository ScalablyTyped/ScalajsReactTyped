...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/ring-progress.RingProgressOptions> */
trait PlotOptionsRingProgressOp extends StObject {
...
object PlotOptionsRingProgressOp {
  
  inline def apply(percent: Double): PlotOptionsRingProgressOp = {
    val __obj = js.Dynamic.literal(percent = percent.asInstanceOf[js.Any])
    __obj.asInstanceOf[PlotOptionsRingProgressOp]
  }
  
  extension [Self <: PlotOptionsRingProgressOp](x: Self) {
