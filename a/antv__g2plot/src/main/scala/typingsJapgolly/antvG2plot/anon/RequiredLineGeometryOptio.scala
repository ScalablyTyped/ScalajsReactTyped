...
trait RequiredLineGeometryOptio extends StObject {
  ...
  var label: typingsJapgolly.antvG2plot.libTypesLabelMod.Label
...
object RequiredLineGeometryOptio {
  ...
  inline def apply(
    ...
    label: typingsJapgolly.antvG2plot.libTypesLabelMod.Label,
    ...
    slider: Slider,
    smooth: Boolean,
    state: typingsJapgolly.antvG2plot.libTypesStateMod.State,
    stepType: String,
    styleField: String,
