...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/stock/types.StockOptions> */
trait PartialStockOptions extends StObject {
  ...
  var yField: js.UndefOr[js.Tuple4[String, String, String, String]] = js.undefined
}
object PartialStockOptions {
  
  inline def apply(): PartialStockOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialStockOptions]
  }
  
  extension [Self <: PartialStockOptions](x: Self) {
