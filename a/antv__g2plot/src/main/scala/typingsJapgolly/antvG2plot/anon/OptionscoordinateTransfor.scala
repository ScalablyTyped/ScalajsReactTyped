...
trait OptionscoordinateTransfor extends StObject {
  ...
  /**
    ...
    * @description 设置数据标签
    */
  val label: js.UndefOr[typingsJapgolly.antvG2plot.libTypesLabelMod.Label] = js.undefined
  
  /**
    * @title 图例
    * @description 设置画布图例 legend 的配置项
    */
  val legend: js.UndefOr[typingsJapgolly.antvG2plot.libTypesLegendMod.Legend] = js.undefined
  ...
  /**
    ...
    */
  val state: js.UndefOr[typingsJapgolly.antvG2plot.libTypesStateMod.State] = js.undefined
