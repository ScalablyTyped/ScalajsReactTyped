...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/liquid/types.LiquidOptions> */
trait PartialLiquidOptions extends StObject {
  ...
  var liquidStyle: js.UndefOr[StyleAttr] = js.undefined
...
object PartialLiquidOptions {
  
  inline def apply(): PartialLiquidOptions = {
