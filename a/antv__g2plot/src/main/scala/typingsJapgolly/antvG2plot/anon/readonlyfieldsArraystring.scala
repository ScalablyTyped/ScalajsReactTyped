...
import typingsJapgolly.antvG2.libInterfaceMod.GeometryLabelContentCallback
import typingsJapgolly.antvG2.libInterfaceMod.GeometryLabelLayoutCfg
import typingsJapgolly.antvG2.libInterfaceMod.IntervalGeometryLabelPosition
...
trait readonlyfieldsArraystring
  extends StObject
     with typingsJapgolly.antvG2plot.libTypesLabelMod.Label {
  ...
  /**
    ...
    */
  var background: js.UndefOr[typingsJapgolly.antvG2.anon.Padding] = js.undefined
  ...
  /**
    ...
    */
  var labelLine: js.UndefOr[Null | Boolean | typingsJapgolly.antvG2.anon.`0`] = js.undefined
...
object readonlyfieldsArraystring {
  ...
  extension [Self <: readonlyfieldsArraystring](x: Self) {
    ...
    inline def setBackground(value: typingsJapgolly.antvG2.anon.Padding): Self = StObject.set(x, "background", value.asInstanceOf[js.Any])
    ...
    inline def setLabelLine(value: Boolean | typingsJapgolly.antvG2.anon.`0`): Self = StObject.set(x, "labelLine", value.asInstanceOf[js.Any])
