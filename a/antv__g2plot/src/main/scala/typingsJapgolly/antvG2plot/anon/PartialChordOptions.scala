...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/chord/types.ChordOptions> */
trait PartialChordOptions extends StObject {
  ...
  var nodeSort: js.UndefOr[js.Function2[/* a */ Datum, /* b */ Datum, Double]] = js.undefined
...
object PartialChordOptions {
  
  inline def apply(): PartialChordOptions = {
