...
trait ChildrenId extends StObject {
  ...
  var children: typingsJapgolly.antvG2plot.libTypesCommonMod.Data
...
object ChildrenId {
  ...
  inline def apply(children: typingsJapgolly.antvG2plot.libTypesCommonMod.Data, id: String, name: String): ChildrenId = {
  ...
  extension [Self <: ChildrenId](x: Self) {
    ...
    inline def setChildren(value: typingsJapgolly.antvG2plot.libTypesCommonMod.Data): Self = StObject.set(x, "children", value.asInstanceOf[js.Any])
