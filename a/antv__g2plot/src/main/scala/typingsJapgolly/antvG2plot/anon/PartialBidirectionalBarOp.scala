...
/* Inlined std.Partial<@antv/g2plot.@antv/g2plot/lib/plots/bidirectional-bar/types.BidirectionalBarOptions> */
trait PartialBidirectionalBarOp extends StObject {
  ...
  var yAxis: js.UndefOr[`false` | StringDictionary[Axis]] = js.undefined
  
  var yField: js.UndefOr[js.Tuple2[String, String]] = js.undefined
}
object PartialBidirectionalBarOp {
  
  inline def apply(): PartialBidirectionalBarOp = {
