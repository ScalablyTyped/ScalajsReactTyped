...
/* Inlined @antv/g2plot.@antv/g2plot/lib/plots/mix/utils.PlotOptions<@antv/g2plot.@antv/g2plot/lib/plots/stock.StockOptions> */
trait PlotOptionsStockOptions extends StObject {
  ...
  var fallingFill: js.UndefOr[String] = js.undefined
  ...
  var risingFill: js.UndefOr[String] = js.undefined
  ...
  var stockStyle: js.UndefOr[StyleAttr] = js.undefined
  ...
  var yField: js.Tuple4[String, String, String, String]
}
object PlotOptionsStockOptions {
  
  inline def apply(xField: String, yField: js.Tuple4[String, String, String, String]): PlotOptionsStockOptions = {
