...
trait PartialVennOptions extends StObject {
  ...
  var data: js.UndefOr[js.Array[typingsJapgolly.antvG2.libInterfaceMod.Datum]] = js.undefined
...
object PartialVennOptions {
  ...
  extension [Self <: PartialVennOptions](x: Self) {
    ...
    inline def setData(value: js.Array[typingsJapgolly.antvG2.libInterfaceMod.Datum]): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
    
    inline def setDataUndefined: Self = StObject.set(x, "data", js.undefined)
    
    inline def setDataVarargs(value: typingsJapgolly.antvG2.libInterfaceMod.Datum*): Self = StObject.set(x, "data", js.Array(value*))
