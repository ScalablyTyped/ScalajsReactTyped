...
object libLabMod {
  ...
  object Stage extends StObject {
    ...
    sealed trait BETA
      extends StObject
         with Stage
    /* "BETA" */ val BETA: typingsJapgolly.antvG2plot.libLabMod.Stage.BETA & String = js.native
    
    @js.native
    sealed trait DEV
      extends StObject
         with Stage
    /* "DEV" */ val DEV: typingsJapgolly.antvG2plot.libLabMod.Stage.DEV & String = js.native
    
    @js.native
    sealed trait STABLE
      extends StObject
         with Stage
    /* "STABLE" */ val STABLE: typingsJapgolly.antvG2plot.libLabMod.Stage.STABLE & String = js.native
  }
