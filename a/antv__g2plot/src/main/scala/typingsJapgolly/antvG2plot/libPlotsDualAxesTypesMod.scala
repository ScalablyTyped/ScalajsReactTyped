...
object libPlotsDualAxesTypesMod {
  ...
  object AxisType extends StObject {
    ...
    sealed trait Left
      extends StObject
         with AxisType
    /* "Left" */ val Left: typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.AxisType.Left & String = js.native
    
    @js.native
    sealed trait Right
      extends StObject
         with AxisType
    /* "Right" */ val Right: typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.AxisType.Right & String = js.native
  }
  ...
  object DualAxesGeometry extends StObject {
    ...
    /* "column" */ val Column: typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.DualAxesGeometry.Column & String = js.native
    
    @js.native
    sealed trait Line
      extends StObject
         with DualAxesGeometry
    /* "line" */ val Line: typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.DualAxesGeometry.Line & String = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.GeometryColumnOption
    - typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.GeometryLineOption
  */
  trait GeometryOption extends StObject
  object GeometryOption {
    
    inline def GeometryColumnOption(): typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.GeometryColumnOption = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.GeometryColumnOption]
    }
    
    inline def GeometryLineOption(): typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.GeometryLineOption = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.GeometryLineOption]
    }
  }
