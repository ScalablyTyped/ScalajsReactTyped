...
import typingsJapgolly.antvG2plot.antvG2plotStrings.frequency
import typingsJapgolly.antvG2plot.antvG2plotStrings.id
import typingsJapgolly.antvG2plot.antvG2plotStrings.weight
