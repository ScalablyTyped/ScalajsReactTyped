...
import typingsJapgolly.antvG2plot.anon.IDFIELD
  ...
  trait VennOptions
    ...
    val color_VennOptions: js.UndefOr[
        String | js.Array[String] | (js.Function2[
          /* datum */ typingsJapgolly.antvG2plot.libTypesCommonMod.Datum, 
  ...
  object VennOptions {
    ...
    extension [Self <: VennOptions](x: Self) {
      ...
      inline def setColorFunction2(
        value: (/* datum */ typingsJapgolly.antvG2plot.libTypesCommonMod.Datum, /* defaultColor */ js.UndefOr[String]) => String
      ...
      inline def setPointStyleFunction1(value: /* datum */ typingsJapgolly.antvG2plot.libTypesCommonMod.Datum => ShapeStyle): Self = StObject.set(x, "pointStyle", js.Any.fromFunction1(value))
