...
import typingsJapgolly.antvG2plot.anon.OmitHierarchyOptionastype
...
import typingsJapgolly.antvG2plot.libTypesDrillDownMod.DrillDownCfg
...
object libPlotsTreemapTypesMod {
  ...
  trait TreemapOptions extends StObject {
    ...
    /**
      * @title 图形样式
      */
    val rectStyle: js.UndefOr[StyleAttr] = js.undefined
  ...
  object TreemapOptions {
    ...
    extension [Self <: TreemapOptions](x: Self) {
      ...
      inline def setRectStyle(value: StyleAttr): Self = StObject.set(x, "rectStyle", value.asInstanceOf[js.Any])
      
      inline def setRectStyleFunction1(value: /* datum */ Datum => ShapeStyle): Self = StObject.set(x, "rectStyle", js.Any.fromFunction1(value))
      
      inline def setRectStyleUndefined: Self = StObject.set(x, "rectStyle", js.undefined)
