...
import typingsJapgolly.antvG2plot.anon.Data
...
import typingsJapgolly.antvG2plot.libTypesCommonMod.Region
...
object libPlotsMixTypesMod {
  ...
  trait IView extends StObject {
    ...
    /**
      * @title view 中的数据
      */
    val data: typingsJapgolly.antvG2plot.libTypesCommonMod.Data
  ...
  object IView {
    ...
    inline def apply(data: typingsJapgolly.antvG2plot.libTypesCommonMod.Data, geometries: js.Array[IGeometry]): IView = {
