...
object libPlotsRingProgressTypesMod {
  
  /* Inlined parent std.Omit<@antv/g2plot.@antv/g2plot/lib/types.Options, 'data' | 'tooltip' | 'legend' | 'label' | 'color'> */
  trait RingProgressOptions extends StObject {
    ...
    /**
      * @title 进度条样式
      */
    val progressStyle: js.UndefOr[StyleAttr] = js.undefined
