...
import typingsJapgolly.antvG2plot.antvG2plotStrings.`x-rect`
import typingsJapgolly.antvG2plot.antvG2plotStrings.`y-rect`
import typingsJapgolly.antvG2plot.antvG2plotStrings.circle
import typingsJapgolly.antvG2plot.antvG2plotStrings.filter
import typingsJapgolly.antvG2plot.antvG2plotStrings.highlight
import typingsJapgolly.antvG2plot.antvG2plotStrings.path
