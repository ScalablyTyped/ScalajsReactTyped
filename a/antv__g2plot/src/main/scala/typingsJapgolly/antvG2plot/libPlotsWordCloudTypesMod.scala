...
object libPlotsWordCloudTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antvG2plot.antvG2plotStrings.normal
    - typingsJapgolly.antvG2plot.antvG2plotStrings.bold
    - typingsJapgolly.antvG2plot.antvG2plotStrings.bolder
    - typingsJapgolly.antvG2plot.antvG2plotStrings.lighter
    - scala.Double
    - scala.Unit
  */
