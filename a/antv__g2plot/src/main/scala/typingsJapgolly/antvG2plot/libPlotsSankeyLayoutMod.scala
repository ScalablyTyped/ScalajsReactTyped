...
import typingsJapgolly.antvG2plot.anon.PartialSankeyLayoutOption
...
object libPlotsSankeyLayoutMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antvG2plot.antvG2plotStrings.left
    - typingsJapgolly.antvG2plot.antvG2plotStrings.right
    - typingsJapgolly.antvG2plot.antvG2plotStrings.center
    - typingsJapgolly.antvG2plot.antvG2plotStrings.justify
    - js.Function
  */
