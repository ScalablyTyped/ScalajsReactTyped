...
import typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.AxisType
import typingsJapgolly.antvG2plot.libPlotsDualAxesTypesMod.GeometryOption
...
object libPlotsDualAxesUtilOptionMod {
