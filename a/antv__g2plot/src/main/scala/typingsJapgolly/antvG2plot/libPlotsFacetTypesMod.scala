...
import typingsJapgolly.antvG2plot.libAdaptorGeometriesBaseMod.Geometry_
...
object libPlotsFacetTypesMod {
  ...
  trait FacetCfg
    ...
    /* InferMemberOverrides */
    override def eachView(innerView: View, facet: CircleData): Any = js.native
