...
import typingsJapgolly.antvG2plot.anon.PartialSunburstOptions
import typingsJapgolly.antvG2plot.libPlotsSunburstTypesMod.SunburstOptions
...
open class Sunburst protected ()
  extends typingsJapgolly.antvG2plot.libPlotsSunburstMod.Sunburst {
