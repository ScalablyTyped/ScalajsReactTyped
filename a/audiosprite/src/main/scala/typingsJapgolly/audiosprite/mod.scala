...
import typingsJapgolly.audiosprite.anon.End
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.audiosprite.audiospriteInts.`1`
    - typingsJapgolly.audiosprite.audiospriteInts.`2`
  */
  trait Channels extends StObject
  object Channels {
    
    inline def `1`: typingsJapgolly.audiosprite.audiospriteInts.`1` = 1.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`1`]
    
    inline def `2`: typingsJapgolly.audiosprite.audiospriteInts.`2` = 2.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`2`]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.audiosprite.audiospriteStrings.jukebox
    - typingsJapgolly.audiosprite.audiospriteStrings.howler
    - typingsJapgolly.audiosprite.audiospriteStrings.createjs
    - scala.Null
  */
  ...
  */
  ...
  object LogLevel {
    ...
    inline def debug: typingsJapgolly.audiosprite.audiospriteStrings.debug = "debug".asInstanceOf[typingsJapgolly.audiosprite.audiospriteStrings.debug]
    
    inline def error: typingsJapgolly.audiosprite.audiospriteStrings.error = "error".asInstanceOf[typingsJapgolly.audiosprite.audiospriteStrings.error]
    
    inline def info: typingsJapgolly.audiosprite.audiospriteStrings.info = "info".asInstanceOf[typingsJapgolly.audiosprite.audiospriteStrings.info]
    
    inline def notice: typingsJapgolly.audiosprite.audiospriteStrings.notice = "notice".asInstanceOf[typingsJapgolly.audiosprite.audiospriteStrings.notice]
    
    inline def warning: typingsJapgolly.audiosprite.audiospriteStrings.warning = "warning".asInstanceOf[typingsJapgolly.audiosprite.audiospriteStrings.warning]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.audiosprite.audiospriteInts.`-1`
    - typingsJapgolly.audiosprite.audiospriteInts.`0`
    - typingsJapgolly.audiosprite.audiospriteInts.`1`
    - typingsJapgolly.audiosprite.audiospriteInts.`2`
    - typingsJapgolly.audiosprite.audiospriteInts.`3`
    - typingsJapgolly.audiosprite.audiospriteInts.`4`
    - typingsJapgolly.audiosprite.audiospriteInts.`5`
    - typingsJapgolly.audiosprite.audiospriteInts.`6`
    - typingsJapgolly.audiosprite.audiospriteInts.`7`
    - typingsJapgolly.audiosprite.audiospriteInts.`8`
    - typingsJapgolly.audiosprite.audiospriteInts.`9`
  */
  ...
  object VBR {
    ...
    inline def `0`: typingsJapgolly.audiosprite.audiospriteInts.`0` = 0.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`0`]
    
    inline def `1`: typingsJapgolly.audiosprite.audiospriteInts.`1` = 1.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`1`]
    
    inline def `2`: typingsJapgolly.audiosprite.audiospriteInts.`2` = 2.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`2`]
    
    inline def `3`: typingsJapgolly.audiosprite.audiospriteInts.`3` = 3.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`3`]
    
    inline def `4`: typingsJapgolly.audiosprite.audiospriteInts.`4` = 4.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`4`]
    
    inline def `5`: typingsJapgolly.audiosprite.audiospriteInts.`5` = 5.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`5`]
    
    inline def `6`: typingsJapgolly.audiosprite.audiospriteInts.`6` = 6.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`6`]
    
    inline def `7`: typingsJapgolly.audiosprite.audiospriteInts.`7` = 7.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`7`]
    
    inline def `8`: typingsJapgolly.audiosprite.audiospriteInts.`8` = 8.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`8`]
    
    inline def `9`: typingsJapgolly.audiosprite.audiospriteInts.`9` = 9.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`9`]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.audiosprite.audiospriteInts.`10`
    - typingsJapgolly.audiosprite.audiospriteInts.`-1`
    - typingsJapgolly.audiosprite.audiospriteInts.`0`
    - typingsJapgolly.audiosprite.audiospriteInts.`1`
    - typingsJapgolly.audiosprite.audiospriteInts.`2`
  ...
  */
  ...
  object VBRVorbis {
    ...
    inline def `10`: typingsJapgolly.audiosprite.audiospriteInts.`10` = 10.asInstanceOf[typingsJapgolly.audiosprite.audiospriteInts.`10`]
