...
object aa {
  ...
  object IFormExtensionsProvider {
    ...
    inline def apply(
      $get: Any,
      confirmResetStrategy: CallbackTo[Boolean],
  ...
  object INotifyConfigProvider {
    ...
    inline def apply(
      $get: Any,
      addOrUpdateNotifyConfig: (String, INotifyConfig) => Callback,
      defaultNotifyConfig: String,
      defaultTargetContainerName: String,
      notifyConfigs: Any,
      optionsTransformer: (INotifyOptions, ISCEService) => Callback
    ): INotifyConfigProvider = {
      val __obj = js.Dynamic.literal($get = $get.asInstanceOf[js.Any], addOrUpdateNotifyConfig = js.Any.fromFunction2((t0: String, t1: INotifyConfig) => (addOrUpdateNotifyConfig(t0, t1)).runNow()), defaultNotifyConfig = defaultNotifyConfig.asInstanceOf[js.Any], defaultTargetContainerName = defaultTargetContainerName.asInstanceOf[js.Any], notifyConfigs = notifyConfigs.asInstanceOf[js.Any], optionsTransformer = js.Any.fromFunction2((t0: INotifyOptions, t1: ISCEService) => (optionsTransformer(t0, t1)).runNow()))
      __obj.asInstanceOf[INotifyConfigProvider]
    }
    
    extension [Self <: INotifyConfigProvider](x: Self) {
      
      inline def setAddOrUpdateNotifyConfig(value: (String, INotifyConfig) => Callback): Self = StObject.set(x, "addOrUpdateNotifyConfig", js.Any.fromFunction2((t0: String, t1: INotifyConfig) => (value(t0, t1)).runNow()))
      ...
      inline def setOptionsTransformer(value: (INotifyOptions, ISCEService) => Callback): Self = StObject.set(x, "optionsTransformer", js.Any.fromFunction2((t0: INotifyOptions, t1: ISCEService) => (value(t0, t1)).runNow()))
    }
  }
  ...
  object IValidIconStrategy {
    ...
    inline def apply(getContainer: IAugmentedJQueryStatic => Callback, invalidIcon: String, validIcon: String): IValidIconStrategy = {
      val __obj = js.Dynamic.literal(getContainer = js.Any.fromFunction1((t0: IAugmentedJQueryStatic) => getContainer(t0).runNow()), invalidIcon = invalidIcon.asInstanceOf[js.Any], validIcon = validIcon.asInstanceOf[js.Any])
      __obj.asInstanceOf[IValidIconStrategy]
    }
    
    extension [Self <: IValidIconStrategy](x: Self) {
      
      inline def setGetContainer(value: IAugmentedJQueryStatic => Callback): Self = StObject.set(x, "getContainer", js.Any.fromFunction1((t0: IAugmentedJQueryStatic) => value(t0).runNow()))
