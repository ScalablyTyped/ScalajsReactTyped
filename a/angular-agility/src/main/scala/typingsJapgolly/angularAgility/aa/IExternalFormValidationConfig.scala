...
object IExternalFormValidationConfig {
  ...
  def apply(
    ...
    ignore: js.Any = null,
    resolve: js.Any = null,
    resolveFn: /* modelValue */ String => CallbackTo[String] = null
    ...
    if (resolveFn != null) __obj.updateDynamic("resolveFn")(js.Any.fromFunction1((t0: /* modelValue */ java.lang.String) => resolveFn(t0).runNow()))
