package typingsJapgolly.angularAgility
...
package object aa {
  type IFieldGroupStrategies = org.scalablytyped.runtime.StringDictionary[
    js.Function1[/* element */ typingsJapgolly.angular.mod.IAugmentedJQueryStatic, scala.Unit]
  ]
  ...
  type ILabelStrategies = org.scalablytyped.runtime.StringDictionary[
    js.Function3[
      /* element */ typingsJapgolly.angular.mod.IAugmentedJQueryStatic, 
  ...
  type IOnNavigateAwayStrategies = org.scalablytyped.runtime.StringDictionary[
    js.Function3[
      /* rootFormScope */ typingsJapgolly.angular.mod.IScope, 
      /* rootForm */ typingsJapgolly.angular.mod.IAugmentedJQueryStatic, 
      /* $injector */ typingsJapgolly.angular.mod.auto.IInjectorService, 
      scala.Unit
    ]
  ]
  ...
  type IValMsgPlacementStrategies = org.scalablytyped.runtime.StringDictionary[
    js.Function3[
      /* formFieldElement */ typingsJapgolly.angular.mod.IAugmentedJQueryStatic, 
