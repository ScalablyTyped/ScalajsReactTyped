...
object angularMod {
  ...
  object featureflags {
    ...
    object FeatureFlagsProvider {
      ...
      inline def apply(setInitialFlags: js.Array[FlagData] => Callback): FeatureFlagsProvider = {
        val __obj = js.Dynamic.literal(setInitialFlags = js.Any.fromFunction1((t0: js.Array[FlagData]) => setInitialFlags(t0).runNow()))
        __obj.asInstanceOf[FeatureFlagsProvider]
      }
      
      extension [Self <: FeatureFlagsProvider](x: Self) {
        
        inline def setSetInitialFlags(value: js.Array[FlagData] => Callback): Self = StObject.set(x, "setInitialFlags", js.Any.fromFunction1((t0: js.Array[FlagData]) => value(t0).runNow()))
      }
    }
