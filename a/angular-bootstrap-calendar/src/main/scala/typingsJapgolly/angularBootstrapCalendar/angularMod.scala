...
import typingsJapgolly.angularBootstrapCalendar.anon.Angular
import typingsJapgolly.angularBootstrapCalendar.anon.CalendarDayView
import typingsJapgolly.angularBootstrapCalendar.anon.WeekNumber
import typingsJapgolly.moment.ts3Dot1TypingsMomentMod.Moment
  ...
  object bootstrap {
    ...
    object calendar {
      ...
      object IEventAction {
        ...
        inline def apply(label: String, onClick: Any => Callback): IEventAction = {
          val __obj = js.Dynamic.literal(label = label.asInstanceOf[js.Any], onClick = js.Any.fromFunction1((t0: Any) => onClick(t0).runNow()))
