...
import typingsJapgolly.angularBootstrapCalendar.AnonAngular
import typingsJapgolly.angularBootstrapCalendar.AnonCalendarDayView
import typingsJapgolly.angularBootstrapCalendar.AnonWeekNumber
