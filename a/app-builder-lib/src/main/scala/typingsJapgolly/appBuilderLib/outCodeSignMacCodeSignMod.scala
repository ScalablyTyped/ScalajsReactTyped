...
object outCodeSignMacCodeSignMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Developer ID Application`
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Developer ID Installer`
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.`3rd Party Mac Developer Application`
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.`3rd Party Mac Developer Installer`
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Mac Developer`
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Apple Development`
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Apple Distribution`
  */
  trait CertType extends StObject
  object CertType {
    
    inline def `3rd Party Mac Developer Application`: typingsJapgolly.appBuilderLib.appBuilderLibStrings.`3rd Party Mac Developer Application` = ("3rd Party Mac Developer Application").asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.`3rd Party Mac Developer Application`]
    
    inline def `3rd Party Mac Developer Installer`: typingsJapgolly.appBuilderLib.appBuilderLibStrings.`3rd Party Mac Developer Installer` = ("3rd Party Mac Developer Installer").asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.`3rd Party Mac Developer Installer`]
    
    inline def `Apple Development`: typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Apple Development` = ("Apple Development").asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Apple Development`]
    
    inline def `Apple Distribution`: typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Apple Distribution` = ("Apple Distribution").asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Apple Distribution`]
    
    inline def `Developer ID Application`: typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Developer ID Application` = ("Developer ID Application").asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Developer ID Application`]
    
    inline def `Developer ID Installer`: typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Developer ID Installer` = ("Developer ID Installer").asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Developer ID Installer`]
    
    inline def `Mac Developer`: typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Mac Developer` = ("Mac Developer").asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.`Mac Developer`]
  }
