...
import typingsJapgolly.appBuilderLib.outAsarIntegrityMod.AsarIntegrity
...
object outFrameworkMod {
  ...
  object Framework {
    ...
    extension [Self <: Framework](x: Self) {
      ...
      inline def setCreateTransformer(value: CallbackTo[FileTransformer | Null]): Self = StObject.set(x, "createTransformer", value.toJsFn)
