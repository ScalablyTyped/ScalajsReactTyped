...
import typingsJapgolly.appBuilderLib.appBuilderLibStrings.sha256_
import typingsJapgolly.appBuilderLib.outCodeSignWindowsCodeSignMod.CustomWindowsSign
import typingsJapgolly.appBuilderLib.outCodeSignWindowsCodeSignMod.CustomWindowsSignTaskConfiguration
import typingsJapgolly.appBuilderLib.outCoreMod.TargetConfigType
...
object outOptionsWinOptionsMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.asInvoker
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.highestAvailable
    - typingsJapgolly.appBuilderLib.appBuilderLibStrings.requireAdministrator
  */
  trait RequestedExecutionLevel extends StObject
  object RequestedExecutionLevel {
    
    inline def asInvoker: typingsJapgolly.appBuilderLib.appBuilderLibStrings.asInvoker = "asInvoker".asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.asInvoker]
    
    inline def highestAvailable: typingsJapgolly.appBuilderLib.appBuilderLibStrings.highestAvailable = "highestAvailable".asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.highestAvailable]
    
    inline def requireAdministrator: typingsJapgolly.appBuilderLib.appBuilderLibStrings.requireAdministrator = "requireAdministrator".asInstanceOf[typingsJapgolly.appBuilderLib.appBuilderLibStrings.requireAdministrator]
  }
