...
import typingsJapgolly.appBuilderLib.appBuilderLibStrings.always
...
object outOptionsCommonWindowsInstallerConfigurationMod {
  ...
  object DesktopShortcutCreationPolicy extends StObject {
    ...
    /* 1 */ val ALWAYS: typingsJapgolly.appBuilderLib.outOptionsCommonWindowsInstallerConfigurationMod.DesktopShortcutCreationPolicy.ALWAYS & Double = js.native
    
    @js.native
    sealed trait FRESH_INSTALL
      extends StObject
         with DesktopShortcutCreationPolicy
    /* 0 */ val FRESH_INSTALL: typingsJapgolly.appBuilderLib.outOptionsCommonWindowsInstallerConfigurationMod.DesktopShortcutCreationPolicy.FRESH_INSTALL & Double = js.native
    
    @js.native
    sealed trait NEVER
      extends StObject
         with DesktopShortcutCreationPolicy
    /* 2 */ val NEVER: typingsJapgolly.appBuilderLib.outOptionsCommonWindowsInstallerConfigurationMod.DesktopShortcutCreationPolicy.NEVER & Double = js.native
  }
