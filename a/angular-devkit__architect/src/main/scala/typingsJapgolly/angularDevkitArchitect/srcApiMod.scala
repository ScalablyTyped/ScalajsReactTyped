...
import typingsJapgolly.angularDevkitArchitect.anon.Builder
import typingsJapgolly.angularDevkitArchitect.srcInputSchemaMod.Schema
import typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.State
import typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.State.Running
import typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.State.Stopped
import typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.State.Waiting
...
object srcApiMod {
  ...
  trait BuilderOutput
    extends StObject
       with JsonObject
       with typingsJapgolly.angularDevkitArchitect.srcOutputSchemaMod.Schema
  ...
  type BuilderProgress = JsonObject & typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.Schema & TypedBuilderProgress
  ...
  object BuilderRun {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(id = id.asInstanceOf[js.Any], info = info.asInstanceOf[js.Any], output = output.asInstanceOf[js.Any], progress = progress.asInstanceOf[js.Any], result = result.asInstanceOf[js.Any], stop = stop.toJsFn)
  ...
  trait Target
    extends StObject
       with JsonObject
       with typingsJapgolly.angularDevkitArchitect.srcInputSchemaMod.Target
  object Target {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularDevkitArchitect.anon.State
    - typingsJapgolly.angularDevkitArchitect.anon.Error
    - typingsJapgolly.angularDevkitArchitect.anon.Status
    - typingsJapgolly.angularDevkitArchitect.anon.Current
  */
  trait TypedBuilderProgress extends StObject
  object TypedBuilderProgress {
    
    inline def Current(current: Double, state: Running): typingsJapgolly.angularDevkitArchitect.anon.Current = {
      val __obj = js.Dynamic.literal(current = current.asInstanceOf[js.Any], state = state.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularDevkitArchitect.anon.Current]
    }
    
    inline def Error(state: typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.State.Error): typingsJapgolly.angularDevkitArchitect.anon.Error = {
      val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any], error = null)
      __obj.asInstanceOf[typingsJapgolly.angularDevkitArchitect.anon.Error]
    }
    
    inline def State(state: Stopped): typingsJapgolly.angularDevkitArchitect.anon.State = {
      val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularDevkitArchitect.anon.State]
    }
    
    inline def Status(state: Waiting): typingsJapgolly.angularDevkitArchitect.anon.Status = {
      val __obj = js.Dynamic.literal(state = state.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularDevkitArchitect.anon.Status]
    }
  }
}
