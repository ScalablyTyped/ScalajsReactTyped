...
import typingsJapgolly.angularDevkitArchitect.srcApiMod.TypedBuilderProgress
...
object anon {
  ...
  trait Analytics extends StObject {
    ...
    var analytics: js.UndefOr[typingsJapgolly.angularDevkitCore.srcAnalyticsApiMod.Analytics] = js.undefined
  ...
  object Analytics {
    ...
    extension [Self <: Analytics](x: Self) {
      ...
      inline def setAnalytics(value: typingsJapgolly.angularDevkitCore.srcAnalyticsApiMod.Analytics): Self = StObject.set(x, "analytics", value.asInstanceOf[js.Any])
  ...
  trait Error
    ...
    var state: typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.State.Error
  }
  object Error {
    
    inline def apply(state: typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.State.Error): Error = {
    ...
    extension [Self <: Error](x: Self) {
      ...
      inline def setState(value: typingsJapgolly.angularDevkitArchitect.srcProgressSchemaMod.State.Error): Self = StObject.set(x, "state", value.asInstanceOf[js.Any])
    }
  }
