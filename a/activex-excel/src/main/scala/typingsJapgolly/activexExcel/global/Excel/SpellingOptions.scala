...
@js.native
/* private */ open class SpellingOptions ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.SpellingOptions {
  ...
  var ExcelDotSpellingOptions_typekey: typingsJapgolly.activexExcel.Excel.SpellingOptions = js.native
