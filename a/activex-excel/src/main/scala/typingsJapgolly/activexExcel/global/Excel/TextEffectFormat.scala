...
/* private */ open class TextEffectFormat ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.TextEffectFormat {
  ...
  var ExcelDotTextEffectFormat_typekey: typingsJapgolly.activexExcel.Excel.TextEffectFormat = js.native
