...
/* private */ open class PlotArea ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.PlotArea {
  ...
  var ExcelDotPlotArea_typekey: typingsJapgolly.activexExcel.Excel.PlotArea = js.native
  ...
  /* CompleteClass */
  override val _InsideHeight: Double = js.native
  
  /* CompleteClass */
  override val _InsideLeft: Double = js.native
  
  /* CompleteClass */
  override val _InsideTop: Double = js.native
  
  /* CompleteClass */
  override val _InsideWidth: Double = js.native
}
