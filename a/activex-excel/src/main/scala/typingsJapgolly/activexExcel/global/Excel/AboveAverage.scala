...
@js.native
/* private */ open class AboveAverage ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.AboveAverage {
  ...
  var ExcelDotAboveAverage_typekey: typingsJapgolly.activexExcel.Excel.AboveAverage = js.native
