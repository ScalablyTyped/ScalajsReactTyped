...
/* private */ open class PivotFilter ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.PivotFilter {
  ...
  /* CompleteClass */
  override val DataCubeField: typingsJapgolly.activexExcel.Excel.CubeField = js.native
  ...
  var ExcelDotPivotFilter_typekey: typingsJapgolly.activexExcel.Excel.PivotFilter = js.native
  ...
  /* CompleteClass */
  override val MemberPropertyField: typingsJapgolly.activexExcel.Excel.PivotField = js.native
