...
@js.native
/* private */ open class CalculatedMember ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.CalculatedMember {
  ...
  var ExcelDotCalculatedMember_typekey: typingsJapgolly.activexExcel.Excel.CalculatedMember = js.native
