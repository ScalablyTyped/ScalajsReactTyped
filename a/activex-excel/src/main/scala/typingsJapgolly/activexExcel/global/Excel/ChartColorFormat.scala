...
/* private */ open class ChartColorFormat ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.ChartColorFormat {
  ...
  var ExcelDotChartColorFormat_typekey: typingsJapgolly.activexExcel.Excel.ChartColorFormat = js.native
