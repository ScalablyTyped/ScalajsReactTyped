...
/* private */ open class FillFormat ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.FillFormat {
  
  /* CompleteClass */
  override val Application: Any = js.native
  
  /* CompleteClass */
  var BackColor: typingsJapgolly.activexExcel.Excel.ColorFormat = js.native
  ...
  var ExcelDotFillFormat_typekey: typingsJapgolly.activexExcel.Excel.FillFormat = js.native
  
  /* CompleteClass */
  var ForeColor: typingsJapgolly.activexExcel.Excel.ColorFormat = js.native
