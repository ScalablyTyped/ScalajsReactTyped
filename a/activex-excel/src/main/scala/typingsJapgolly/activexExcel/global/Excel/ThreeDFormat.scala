...
/* private */ open class ThreeDFormat ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.ThreeDFormat {
  ...
  /* CompleteClass */
  override val ContourColor: typingsJapgolly.activexExcel.Excel.ColorFormat = js.native
  ...
  var ExcelDotThreeDFormat_typekey: typingsJapgolly.activexExcel.Excel.ThreeDFormat = js.native
  
  /* CompleteClass */
  override val ExtrusionColor: typingsJapgolly.activexExcel.Excel.ColorFormat = js.native
