...
@js.native
/* private */ open class ErrorBars ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.ErrorBars {
  ...
  var ExcelDotErrorBars_typekey: typingsJapgolly.activexExcel.Excel.ErrorBars = js.native
