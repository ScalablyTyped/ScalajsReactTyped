...
/* private */ open class SmartTagRecognizer ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.SmartTagRecognizer {
  ...
  var ExcelDotSmartTagRecognizer_typekey: typingsJapgolly.activexExcel.Excel.SmartTagRecognizer = js.native
