...
/* private */ open class Slicer ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.Slicer {
  
  /* CompleteClass */
  override val ActiveItem: typingsJapgolly.activexExcel.Excel.SlicerItem = js.native
  ...
  var ExcelDotSlicer_typekey: typingsJapgolly.activexExcel.Excel.Slicer = js.native
  ...
  /* CompleteClass */
  override val Shape: typingsJapgolly.activexExcel.Excel.Shape = js.native
  
  /* CompleteClass */
  override val SlicerCache: typingsJapgolly.activexExcel.Excel.SlicerCache = js.native
  
  /* CompleteClass */
  override val SlicerCacheLevel: typingsJapgolly.activexExcel.Excel.SlicerCacheLevel = js.native
