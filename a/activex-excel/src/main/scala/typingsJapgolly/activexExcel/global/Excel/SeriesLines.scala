...
@js.native
/* private */ open class SeriesLines ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.SeriesLines {
  ...
  var ExcelDotSeriesLines_typekey: typingsJapgolly.activexExcel.Excel.SeriesLines = js.native
