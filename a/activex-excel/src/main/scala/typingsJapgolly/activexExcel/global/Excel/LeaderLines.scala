...
@js.native
/* private */ open class LeaderLines ()
  extends StObject
     with typingsJapgolly.activexExcel.Excel.LeaderLines {
  ...
  var ExcelDotLeaderLines_typekey: typingsJapgolly.activexExcel.Excel.LeaderLines = js.native
