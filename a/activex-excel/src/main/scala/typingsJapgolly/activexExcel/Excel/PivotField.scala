...
trait PivotField extends StObject {
  ...
  def CalculatedItems(): typingsJapgolly.activexExcel.Excel.CalculatedItems = js.native
  ...
  val CubeField: typingsJapgolly.activexExcel.Excel.CubeField = js.native
  ...
  def PivotItems(Indexes: SafeArray[Double | String]): typingsJapgolly.activexExcel.Excel.PivotItems = js.native
