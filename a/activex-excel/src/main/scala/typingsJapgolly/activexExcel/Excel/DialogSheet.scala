...
- typingsJapgolly.activexExcel.Excel.AddSheetResult because Already inherited */ @JSGlobal("Excel.DialogSheet")
@js.native
class DialogSheet protected () extends Sheet {
  ...
  val DialogFrame: typingsJapgolly.activexExcel.Excel.DialogFrame = js.native
