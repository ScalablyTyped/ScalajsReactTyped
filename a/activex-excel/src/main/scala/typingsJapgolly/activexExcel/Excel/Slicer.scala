...
class Slicer protected () extends js.Object {
  ...
  val SlicerCache: typingsJapgolly.activexExcel.Excel.SlicerCache = js.native
  val SlicerCacheLevel: typingsJapgolly.activexExcel.Excel.SlicerCacheLevel = js.native
