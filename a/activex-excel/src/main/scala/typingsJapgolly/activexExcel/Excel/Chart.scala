...
import typingsJapgolly.activexExcel.activexExcelNumbers.`48`
...
- typingsJapgolly.activexExcel.Excel.AddSheetResult because Already inherited */ @JSGlobal("Excel.Chart")
@js.native
class Chart protected () extends Sheet {
  val Application: typingsJapgolly.activexExcel.Excel.Application = js.native
  val Area3DGroup: ChartGroup = js.native
  var AutoScaling: Boolean = js.native
  val BackWall: typingsJapgolly.activexExcel.Excel.Walls = js.native
  val Bar3DGroup: ChartGroup = js.native
  var BarShape: XlBarShape = js.native
  val ChartArea: typingsJapgolly.activexExcel.Excel.ChartArea = js.native
  ...
  val ChartTitle: typingsJapgolly.activexExcel.Excel.ChartTitle = js.native
  var ChartType: XlChartType = js.native
  val CodeName: String = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: typingsJapgolly.activexExcel.Excel.Corners = js.native
  val Creator: XlCreator = js.native
  val DataTable: typingsJapgolly.activexExcel.Excel.DataTable = js.native
  ...
  val Floor: typingsJapgolly.activexExcel.Excel.Floor = js.native
  ...
  val Legend: typingsJapgolly.activexExcel.Excel.Legend = js.native
  ...
  val PivotLayout: typingsJapgolly.activexExcel.Excel.PivotLayout = js.native
  val PlotArea: typingsJapgolly.activexExcel.Excel.PlotArea = js.native
  ...
  val SideWall: typingsJapgolly.activexExcel.Excel.Walls = js.native
  ...
  val Walls: typingsJapgolly.activexExcel.Excel.Walls = js.native
  ...
  def Axes(): typingsJapgolly.activexExcel.Excel.Axes | Axis = js.native
  def Axes(Type: XlAxisType): typingsJapgolly.activexExcel.Excel.Axes | Axis = js.native
  def Axes(Type: XlAxisType, AxisGroup: XlAxisGroup): typingsJapgolly.activexExcel.Excel.Axes | Axis = js.native
