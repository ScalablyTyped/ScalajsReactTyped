...
import typingsJapgolly.activexExcel.activexExcelInts.`48`
...
trait Chart
  ...
  def Axes(Type: Unit, AxisGroup: XlAxisGroup): typingsJapgolly.activexExcel.Excel.Axes | Axis = js.native
