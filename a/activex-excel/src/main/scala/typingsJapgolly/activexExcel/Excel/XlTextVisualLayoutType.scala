...
*/
trait XlTextVisualLayoutType extends StObject
object XlTextVisualLayoutType {
  
  inline def xlTextVisualLTR: `1` = 1.asInstanceOf[`1`]
  
  inline def xlTextVisualRTL: `2` = 2.asInstanceOf[`2`]
}
