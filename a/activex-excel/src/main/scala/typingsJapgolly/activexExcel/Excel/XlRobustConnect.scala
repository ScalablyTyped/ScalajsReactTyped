...
*/
trait XlRobustConnect extends StObject
object XlRobustConnect {
  
  inline def xlAlways: `1` = 1.asInstanceOf[`1`]
  
  inline def xlAsRequired: `0` = 0.asInstanceOf[`0`]
  
  inline def xlNever: `2` = 2.asInstanceOf[`2`]
}
