...
import typingsJapgolly.activexExcel.activexExcelNumbers.`-4145`
import typingsJapgolly.activexExcel.activexExcelNumbers.`-4158`
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.activexExcel.activexExcelNumbers.`-4145`
  - typingsJapgolly.activexExcel.activexExcelNumbers.`-4158`
*/
