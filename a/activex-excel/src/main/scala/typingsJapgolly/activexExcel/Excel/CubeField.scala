...
class CubeField protected () extends js.Object {
  ...
  val PivotFields: typingsJapgolly.activexExcel.Excel.PivotFields = js.native
  var Position: Double = js.native
  var ShowInFieldList: Boolean = js.native
  val TreeviewControl: typingsJapgolly.activexExcel.Excel.TreeviewControl = js.native
