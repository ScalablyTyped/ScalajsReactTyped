...
object XlXmlLoadOption {
  ...
  inline def xlXmlLoadImportToList: `2` = 2.asInstanceOf[`2`]
  
  inline def xlXmlLoadMapXml: `3` = 3.asInstanceOf[`3`]
  
  inline def xlXmlLoadOpenXml: `1` = 1.asInstanceOf[`1`]
  
  inline def xlXmlLoadPromptUser: `0` = 0.asInstanceOf[`0`]
}
