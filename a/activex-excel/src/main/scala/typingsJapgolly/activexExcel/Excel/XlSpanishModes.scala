...
*/
trait XlSpanishModes extends StObject
object XlSpanishModes {
  
  inline def xlSpanishTuteoAndVoseo: `1` = 1.asInstanceOf[`1`]
  
  inline def xlSpanishTuteoOnly: `0` = 0.asInstanceOf[`0`]
  
  inline def xlSpanishVoseoOnly: `2` = 2.asInstanceOf[`2`]
}
