...
trait PivotTable extends StObject {
  ...
  def CalculatedFields(): typingsJapgolly.activexExcel.Excel.CalculatedFields = js.native
  ...
  def PivotCache(): typingsJapgolly.activexExcel.Excel.PivotCache = js.native
  
  val PivotColumnAxis: PivotAxis = js.native
  
  def PivotFields(Indexes: SafeArray[Double | String]): typingsJapgolly.activexExcel.Excel.PivotFields = js.native
