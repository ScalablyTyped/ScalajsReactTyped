...
*/
trait XlPlatform extends StObject
object XlPlatform {
  
  inline def xlMSDOS: `3` = 3.asInstanceOf[`3`]
  
  inline def xlMacintosh: `1` = 1.asInstanceOf[`1`]
  
  inline def xlWindows: `2` = 2.asInstanceOf[`2`]
}
