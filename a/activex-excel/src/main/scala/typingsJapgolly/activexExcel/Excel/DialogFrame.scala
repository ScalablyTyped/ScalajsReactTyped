...
trait DialogFrame extends StObject {
  ...
  def Characters(Start: Any): typingsJapgolly.activexExcel.Excel.Characters = js.native
  def Characters(Start: Any, Length: Any): typingsJapgolly.activexExcel.Excel.Characters = js.native
  def Characters(Start: Unit, Length: Any): typingsJapgolly.activexExcel.Excel.Characters = js.native
