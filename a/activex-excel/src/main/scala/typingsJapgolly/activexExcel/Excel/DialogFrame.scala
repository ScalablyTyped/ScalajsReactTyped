...
class DialogFrame protected () extends js.Object {
  ...
  def Characters(Start: js.Any): typingsJapgolly.activexExcel.Excel.Characters = js.native
  def Characters(Start: js.Any, Length: js.Any): typingsJapgolly.activexExcel.Excel.Characters = js.native
