...
*/
trait XlGenerateTableRefs extends StObject
object XlGenerateTableRefs {
  
  inline def xlGenerateTableRefA1: `0` = 0.asInstanceOf[`0`]
  
  inline def xlGenerateTableRefStruct: `1` = 1.asInstanceOf[`1`]
}
