...
trait QueryTable extends StObject {
  ...
  var Recordset: typingsJapgolly.activexDao.DAO.Recordset | typingsJapgolly.activexAdodb.ADODB.Recordset = js.native
  ...
  val WorkbookConnection: typingsJapgolly.activexExcel.Excel.WorkbookConnection = js.native
}
