...
*/
trait XlWindowView extends StObject
object XlWindowView {
  
  inline def xlNormalView: `1` = 1.asInstanceOf[`1`]
  
  inline def xlPageBreakPreview: `2` = 2.asInstanceOf[`2`]
  
  inline def xlPageLayoutView: `3` = 3.asInstanceOf[`3`]
}
