...
import typingsJapgolly.activexExcel.activexExcelStrings.Apostrophe
import typingsJapgolly.activexExcel.activexExcelStrings.Backslash
import typingsJapgolly.activexExcel.activexExcelStrings.Quotationmark
import typingsJapgolly.activexExcel.activexExcelStrings.^
...
trait Range extends js.Object {
  ...
  val Comment: typingsJapgolly.activexExcel.Excel.Comment = js.native
  ...
  val DisplayFormat: typingsJapgolly.activexExcel.Excel.DisplayFormat = js.native
  @JSName("EntireColumn")
  ...
  val ListObject: typingsJapgolly.activexExcel.Excel.ListObject = js.native
  ...
  var Name: String | typingsJapgolly.activexExcel.Excel.Name = js.native
  @JSName("Next")
  ...
  val Phonetic: typingsJapgolly.activexExcel.Excel.Phonetic = js.native
  @JSName("Phonetics")
  val Phonetics_Original: Phonetics = js.native
  val PivotCell: typingsJapgolly.activexExcel.Excel.PivotCell = js.native
  ...
  val QueryTable: typingsJapgolly.activexExcel.Excel.QueryTable = js.native
  ...
  val SoundNote: typingsJapgolly.activexExcel.Excel.SoundNote = js.native
  @JSName("SparklineGroups")
  val SparklineGroups_Original: SparklineGroups = js.native
  var Style: typingsJapgolly.activexExcel.Excel.Style = js.native
  ...
  val Validation: typingsJapgolly.activexExcel.Excel.Validation = js.native
  ...
  val Worksheet: typingsJapgolly.activexExcel.Excel.Worksheet = js.native
  ...
  def AddComment(): typingsJapgolly.activexExcel.Excel.Comment = js.native
  def AddComment(Text: String): typingsJapgolly.activexExcel.Excel.Comment = js.native
  ...
  def CopyFromRecordset(Data: typingsJapgolly.activexDao.DAO.Recordset): Double = js.native
  def CopyFromRecordset(Data: typingsJapgolly.activexDao.DAO.Recordset, MaxRows: Double): Double = js.native
  def CopyFromRecordset(Data: typingsJapgolly.activexDao.DAO.Recordset, MaxRows: Double, MaxColumns: Double): Double = js.native
  /**
  ...
  def Phonetics(Index: Double): typingsJapgolly.activexExcel.Excel.Phonetic = js.native
