...
trait PictureFormat extends StObject {
  ...
  /* private */ @JSName("Excel.PictureFormat_typekey")
...
object PictureFormat {
  ...
  extension [Self <: PictureFormat](x: Self) {
    ...
    inline def setExcelDotPictureFormat_typekey(value: PictureFormat): Self = StObject.set(x, "Excel.PictureFormat_typekey", value.asInstanceOf[js.Any])
