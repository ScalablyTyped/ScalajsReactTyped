...
object XlDataBarAxisPosition {
  ...
  inline def xlDataBarAxisAutomatic: `0` = 0.asInstanceOf[`0`]
  
  inline def xlDataBarAxisMidpoint: `1` = 1.asInstanceOf[`1`]
  
  inline def xlDataBarAxisNone: `2` = 2.asInstanceOf[`2`]
}
