...
import typingsJapgolly.asyncValidator.anon.Array
import typingsJapgolly.asyncValidator.anon.Format
import typingsJapgolly.asyncValidator.anon.Len
import typingsJapgolly.asyncValidator.anon.Mismatch
import typingsJapgolly.asyncValidator.anon.PartialValidateMessages
...
object distTypesInterfaceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.asyncValidator.asyncValidatorStrings.pattern
    - typingsJapgolly.asyncValidator.asyncValidatorStrings.any
  */
  trait RuleType extends StObject
  object RuleType {
    
    inline def any: typingsJapgolly.asyncValidator.asyncValidatorStrings.any = "any".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.any]
    
    inline def array: typingsJapgolly.asyncValidator.asyncValidatorStrings.array = "array".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.array]
    
    inline def boolean: typingsJapgolly.asyncValidator.asyncValidatorStrings.boolean = "boolean".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.boolean]
    
    inline def date: typingsJapgolly.asyncValidator.asyncValidatorStrings.date = "date".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.date]
    
    inline def email: typingsJapgolly.asyncValidator.asyncValidatorStrings.email = "email".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.email]
    
    inline def `enum`: typingsJapgolly.asyncValidator.asyncValidatorStrings.`enum` = "enum".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.`enum`]
    
    inline def float: typingsJapgolly.asyncValidator.asyncValidatorStrings.float = "float".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.float]
    
    inline def hex: typingsJapgolly.asyncValidator.asyncValidatorStrings.hex = "hex".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.hex]
    
    inline def integer: typingsJapgolly.asyncValidator.asyncValidatorStrings.integer = "integer".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.integer]
    
    inline def method: typingsJapgolly.asyncValidator.asyncValidatorStrings.method = "method".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.method]
    
    inline def number: typingsJapgolly.asyncValidator.asyncValidatorStrings.number = "number".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.number]
    
    inline def `object`: typingsJapgolly.asyncValidator.asyncValidatorStrings.`object` = "object".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.`object`]
    
    inline def pattern: typingsJapgolly.asyncValidator.asyncValidatorStrings.pattern = "pattern".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.pattern]
    
    inline def regexp: typingsJapgolly.asyncValidator.asyncValidatorStrings.regexp = "regexp".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.regexp]
    
    inline def string: typingsJapgolly.asyncValidator.asyncValidatorStrings.string = "string".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.string]
    
    inline def url: typingsJapgolly.asyncValidator.asyncValidatorStrings.url = "url".asInstanceOf[typingsJapgolly.asyncValidator.asyncValidatorStrings.url]
  }
