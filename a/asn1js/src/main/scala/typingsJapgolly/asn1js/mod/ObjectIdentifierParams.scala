...
- typingsJapgolly.asn1js.mod.LocalObjectIdentifierValueBlockParams because var conflicts: blockLength, error, valueBeforeDecode, warnings. Inlined value */ trait ObjectIdentifierParams
  extends StObject
