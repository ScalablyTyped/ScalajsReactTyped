...
- typingsJapgolly.asn1js.mod.LocalRelativeObjectIdentifierValueBlockParams because var conflicts: blockLength, error, valueBeforeDecode, warnings. Inlined value */ trait RelativeObjectIdentifierParams
  extends StObject
