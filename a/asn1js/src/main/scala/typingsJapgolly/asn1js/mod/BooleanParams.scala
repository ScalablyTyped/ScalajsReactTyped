...
- typingsJapgolly.asn1js.mod.LocalBooleanValueBlockParams because var conflicts: blockLength, error, valueBeforeDecode, warnings. Inlined isHexOnly, valueHex, value */ trait BooleanParams
  extends StObject
