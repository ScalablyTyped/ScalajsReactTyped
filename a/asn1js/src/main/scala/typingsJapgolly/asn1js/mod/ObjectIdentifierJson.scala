...
/* Inlined parent asn1js.asn1js.BaseBlockJson<asn1js.asn1js.LocalObjectIdentifierValueBlockJson> */
trait ObjectIdentifierJson extends StObject {
  ...
  var valueBlock: LocalObjectIdentifierValueBlockJson
  
  var warnings: js.Array[String]
}
object ObjectIdentifierJson {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ObjectIdentifierJson]
  }
  
  extension [Self <: ObjectIdentifierJson](x: Self) {
    ...
    inline def setValueBlock(value: LocalObjectIdentifierValueBlockJson): Self = StObject.set(x, "valueBlock", value.asInstanceOf[js.Any])
