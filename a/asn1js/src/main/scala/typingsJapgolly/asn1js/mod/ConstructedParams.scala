...
- typingsJapgolly.asn1js.mod.LocalConstructedValueBlockParams because var conflicts: blockLength, error, valueBeforeDecode, warnings. Inlined value, isIndefiniteForm */ trait ConstructedParams
  extends StObject
