...
- typingsJapgolly.asn1js.mod.LocalBitStringValueBlockParams because var conflicts: blockLength, error, valueBeforeDecode, warnings. Inlined value, isHexOnly, valueHex, isIndefiniteForm, unusedBits, isConstructed */ trait BitStringParams
  extends StObject
