...
- typingsJapgolly.asn1js.mod.LocalOctetStringValueBlockParams because var conflicts: blockLength, error, valueBeforeDecode, warnings. Inlined value, isHexOnly, valueHex, isIndefiniteForm, isConstructed */ trait OctetStringParams
  extends StObject
