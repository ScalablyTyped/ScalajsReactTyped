...
import typingsJapgolly.antvDataSet.antvDataSetStrings.frequency
import typingsJapgolly.antvDataSet.antvDataSetStrings.id
import typingsJapgolly.antvDataSet.antvDataSetStrings.weigth
