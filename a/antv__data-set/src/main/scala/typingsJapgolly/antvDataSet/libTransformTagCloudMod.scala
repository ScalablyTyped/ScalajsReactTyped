...
import typingsJapgolly.antvDataSet.antvDataSetStrings.archimedean
import typingsJapgolly.antvDataSet.antvDataSetStrings.rectangular
...
object libTransformTagCloudMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Double
    - typingsJapgolly.antvDataSet.antvDataSetStrings.normal
    - typingsJapgolly.antvDataSet.antvDataSetStrings.bold
    - typingsJapgolly.antvDataSet.antvDataSetStrings.bolder
    - typingsJapgolly.antvDataSet.antvDataSetStrings.lighter
  */
