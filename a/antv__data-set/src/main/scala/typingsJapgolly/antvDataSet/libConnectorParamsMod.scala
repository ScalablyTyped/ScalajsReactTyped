...
import typingsJapgolly.antvDataSet.libConnectorHexjsonMod.Options
...
object libConnectorParamsMod {
  ...
  trait ConnectorParams extends StObject {
    ...
    var TopoJSON: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorTopojsonMod.Options]
    
    var csv: js.Tuple2[String, js.Object]
    
    var diagram: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorGraphMod.Options]
    
    var dsv: js.Tuple2[String, typingsJapgolly.antvDataSet.libConnectorDsvMod.Options]
    
    var geo: js.Tuple2[Any, js.Object]
    
    var geojson: js.Tuple2[Any, js.Object]
    
    var graph: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorGraphMod.Options]
    ...
    var hierarchy: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorHierarchyMod.Options]
    
    var topojson: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorTopojsonMod.Options]
    
    var tree: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorHierarchyMod.Options]
  ...
  object ConnectorParams {
    ...
    inline def apply(
      ...
      TopoJSON: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorTopojsonMod.Options],
      csv: js.Tuple2[String, js.Object],
      diagram: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorGraphMod.Options],
      dsv: js.Tuple2[String, typingsJapgolly.antvDataSet.libConnectorDsvMod.Options],
      geo: js.Tuple2[Any, js.Object],
      geojson: js.Tuple2[Any, js.Object],
      graph: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorGraphMod.Options],
      hex: js.Tuple2[js.Array[Any], Options],
      `hex-json`: js.Tuple2[js.Array[Any], Options],
      hexjson: js.Tuple2[js.Array[Any], Options],
      hierarchy: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorHierarchyMod.Options],
      topojson: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorTopojsonMod.Options],
      tree: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorHierarchyMod.Options],
    ...
    extension [Self <: ConnectorParams](x: Self) {
      ...
      inline def setDiagram(value: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorGraphMod.Options]): Self = StObject.set(x, "diagram", value.asInstanceOf[js.Any])
      
      inline def setDsv(value: js.Tuple2[String, typingsJapgolly.antvDataSet.libConnectorDsvMod.Options]): Self = StObject.set(x, "dsv", value.asInstanceOf[js.Any])
      ...
      inline def setGraph(value: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorGraphMod.Options]): Self = StObject.set(x, "graph", value.asInstanceOf[js.Any])
      ...
      inline def setHierarchy(value: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorHierarchyMod.Options]): Self = StObject.set(x, "hierarchy", value.asInstanceOf[js.Any])
      
      inline def setTopoJSON(value: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorTopojsonMod.Options]): Self = StObject.set(x, "TopoJSON", value.asInstanceOf[js.Any])
      
      inline def setTree(value: js.Tuple2[Any, typingsJapgolly.antvDataSet.libConnectorHierarchyMod.Options]): Self = StObject.set(x, "tree", value.asInstanceOf[js.Any])
