...
object IAlertOptions {
  ...
  def apply(
    ...
    onBeforeHide: /* alert */ IAlert => Callback = null,
    onBeforeShow: /* alert */ IAlert => Callback = null,
    onHide: /* alert */ IAlert => Callback = null,
    onShow: /* alert */ IAlert => Callback = null,
    ...
    if (onBeforeHide != null) __obj.updateDynamic("onBeforeHide")(js.Any.fromFunction1((t0: /* alert */ typingsJapgolly.angularStrap.mgcrea.ngStrap.alert.IAlert) => onBeforeHide(t0).runNow()))
    if (onBeforeShow != null) __obj.updateDynamic("onBeforeShow")(js.Any.fromFunction1((t0: /* alert */ typingsJapgolly.angularStrap.mgcrea.ngStrap.alert.IAlert) => onBeforeShow(t0).runNow()))
    if (onHide != null) __obj.updateDynamic("onHide")(js.Any.fromFunction1((t0: /* alert */ typingsJapgolly.angularStrap.mgcrea.ngStrap.alert.IAlert) => onHide(t0).runNow()))
    if (onShow != null) __obj.updateDynamic("onShow")(js.Any.fromFunction1((t0: /* alert */ typingsJapgolly.angularStrap.mgcrea.ngStrap.alert.IAlert) => onShow(t0).runNow()))
