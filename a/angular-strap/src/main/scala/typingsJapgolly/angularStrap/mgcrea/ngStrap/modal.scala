...
object modal {
  ...
  object IModal {
    ...
    inline def apply($promise: IPromise[Unit], hide: Callback, show: Callback, toggle: Callback): IModal = {
  ...
  object IModalOptions {
    ...
    extension [Self <: IModalOptions](x: Self) {
      ...
      inline def setOnBeforeHide(value: /* modal */ IModal => Callback): Self = StObject.set(x, "onBeforeHide", js.Any.fromFunction1((t0: /* modal */ IModal) => value(t0).runNow()))
      
      inline def setOnBeforeHideUndefined: Self = StObject.set(x, "onBeforeHide", js.undefined)
      
      inline def setOnBeforeShow(value: /* modal */ IModal => Callback): Self = StObject.set(x, "onBeforeShow", js.Any.fromFunction1((t0: /* modal */ IModal) => value(t0).runNow()))
      
      inline def setOnBeforeShowUndefined: Self = StObject.set(x, "onBeforeShow", js.undefined)
      
      inline def setOnHide(value: /* modal */ IModal => Callback): Self = StObject.set(x, "onHide", js.Any.fromFunction1((t0: /* modal */ IModal) => value(t0).runNow()))
      
      inline def setOnHideUndefined: Self = StObject.set(x, "onHide", js.undefined)
      
      inline def setOnShow(value: /* modal */ IModal => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* modal */ IModal) => value(t0).runNow()))
