...
object select {
  ...
  object ISelect {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(active = js.Any.fromFunction1(active), hide = hide.toJsFn, select = js.Any.fromFunction1((t0: Double) => select(t0).runNow()), show = show.toJsFn, update = js.Any.fromFunction1((t0: Any) => update(t0).runNow()))
    ...
    extension [Self <: ISelect](x: Self) {
      ...
      inline def setSelect(value: Double => Callback): Self = StObject.set(x, "select", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  ...
  object ISelectOptions {
    ...
    extension [Self <: ISelectOptions](x: Self) {
      ...
      inline def setOnBeforeHide(value: /* select */ ISelect => Callback): Self = StObject.set(x, "onBeforeHide", js.Any.fromFunction1((t0: /* select */ ISelect) => value(t0).runNow()))
      
      inline def setOnBeforeHideUndefined: Self = StObject.set(x, "onBeforeHide", js.undefined)
      
      inline def setOnBeforeShow(value: /* select */ ISelect => Callback): Self = StObject.set(x, "onBeforeShow", js.Any.fromFunction1((t0: /* select */ ISelect) => value(t0).runNow()))
      
      inline def setOnBeforeShowUndefined: Self = StObject.set(x, "onBeforeShow", js.undefined)
      
      inline def setOnHide(value: /* select */ ISelect => Callback): Self = StObject.set(x, "onHide", js.Any.fromFunction1((t0: /* select */ ISelect) => value(t0).runNow()))
      
      inline def setOnHideUndefined: Self = StObject.set(x, "onHide", js.undefined)
      
      inline def setOnShow(value: /* select */ ISelect => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* select */ ISelect) => value(t0).runNow()))
