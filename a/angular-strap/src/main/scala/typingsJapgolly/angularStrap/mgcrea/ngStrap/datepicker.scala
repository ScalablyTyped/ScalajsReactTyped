...
object datepicker {
  ...
  object IDatepickerOptions {
    ...
    extension [Self <: IDatepickerOptions](x: Self) {
      ...
      inline def setOnBeforeHide(value: /* datepicker */ IDatepicker => Callback): Self = StObject.set(x, "onBeforeHide", js.Any.fromFunction1((t0: /* datepicker */ IDatepicker) => value(t0).runNow()))
      
      inline def setOnBeforeHideUndefined: Self = StObject.set(x, "onBeforeHide", js.undefined)
      
      inline def setOnBeforeShow(value: /* datepicker */ IDatepicker => Callback): Self = StObject.set(x, "onBeforeShow", js.Any.fromFunction1((t0: /* datepicker */ IDatepicker) => value(t0).runNow()))
      
      inline def setOnBeforeShowUndefined: Self = StObject.set(x, "onBeforeShow", js.undefined)
      
      inline def setOnHide(value: /* datepicker */ IDatepicker => Callback): Self = StObject.set(x, "onHide", js.Any.fromFunction1((t0: /* datepicker */ IDatepicker) => value(t0).runNow()))
      
      inline def setOnHideUndefined: Self = StObject.set(x, "onHide", js.undefined)
      
      inline def setOnShow(value: /* datepicker */ IDatepicker => Callback): Self = StObject.set(x, "onShow", js.Any.fromFunction1((t0: /* datepicker */ IDatepicker) => value(t0).runNow()))
