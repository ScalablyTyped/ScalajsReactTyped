package typingsJapgolly.angularStrap.mgcrea.ngStrap.popover
...
object IPopoverOptions {
  ...
  def apply(
    ...
    id: String = null,
    onBeforeHide: /* popover */ IPopover => Callback = null,
    onBeforeShow: /* popover */ IPopover => Callback = null,
    onHide: /* popover */ IPopover => Callback = null,
    onShow: /* popover */ IPopover => Callback = null,
    ...
    if (onBeforeHide != null) __obj.updateDynamic("onBeforeHide")(js.Any.fromFunction1((t0: /* popover */ typingsJapgolly.angularStrap.mgcrea.ngStrap.popover.IPopover) => onBeforeHide(t0).runNow()))
    if (onBeforeShow != null) __obj.updateDynamic("onBeforeShow")(js.Any.fromFunction1((t0: /* popover */ typingsJapgolly.angularStrap.mgcrea.ngStrap.popover.IPopover) => onBeforeShow(t0).runNow()))
    if (onHide != null) __obj.updateDynamic("onHide")(js.Any.fromFunction1((t0: /* popover */ typingsJapgolly.angularStrap.mgcrea.ngStrap.popover.IPopover) => onHide(t0).runNow()))
    if (onShow != null) __obj.updateDynamic("onShow")(js.Any.fromFunction1((t0: /* popover */ typingsJapgolly.angularStrap.mgcrea.ngStrap.popover.IPopover) => onShow(t0).runNow()))
