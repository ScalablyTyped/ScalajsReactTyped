...
object IModalOptions {
  ...
  def apply(
    ...
    locals: js.Any = null,
    onBeforeHide: /* modal */ IModal => Callback = null,
    onBeforeShow: /* modal */ IModal => Callback = null,
    onHide: /* modal */ IModal => Callback = null,
    onShow: /* modal */ IModal => Callback = null,
    ...
    if (onBeforeHide != null) __obj.updateDynamic("onBeforeHide")(js.Any.fromFunction1((t0: /* modal */ typingsJapgolly.angularStrap.mgcrea.ngStrap.modal.IModal) => onBeforeHide(t0).runNow()))
    if (onBeforeShow != null) __obj.updateDynamic("onBeforeShow")(js.Any.fromFunction1((t0: /* modal */ typingsJapgolly.angularStrap.mgcrea.ngStrap.modal.IModal) => onBeforeShow(t0).runNow()))
    if (onHide != null) __obj.updateDynamic("onHide")(js.Any.fromFunction1((t0: /* modal */ typingsJapgolly.angularStrap.mgcrea.ngStrap.modal.IModal) => onHide(t0).runNow()))
    if (onShow != null) __obj.updateDynamic("onShow")(js.Any.fromFunction1((t0: /* modal */ typingsJapgolly.angularStrap.mgcrea.ngStrap.modal.IModal) => onShow(t0).runNow()))
