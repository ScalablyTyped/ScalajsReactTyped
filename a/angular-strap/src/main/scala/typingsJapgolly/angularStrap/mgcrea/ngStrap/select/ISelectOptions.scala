...
object ISelectOptions {
  ...
  def apply(
    ...
    onBeforeHide: /* select */ ISelect => Callback = null,
    onBeforeShow: /* select */ ISelect => Callback = null,
    onHide: /* select */ ISelect => Callback = null,
    onShow: /* select */ ISelect => Callback = null,
    ...
    if (onBeforeHide != null) __obj.updateDynamic("onBeforeHide")(js.Any.fromFunction1((t0: /* select */ typingsJapgolly.angularStrap.mgcrea.ngStrap.select.ISelect) => onBeforeHide(t0).runNow()))
    if (onBeforeShow != null) __obj.updateDynamic("onBeforeShow")(js.Any.fromFunction1((t0: /* select */ typingsJapgolly.angularStrap.mgcrea.ngStrap.select.ISelect) => onBeforeShow(t0).runNow()))
    if (onHide != null) __obj.updateDynamic("onHide")(js.Any.fromFunction1((t0: /* select */ typingsJapgolly.angularStrap.mgcrea.ngStrap.select.ISelect) => onHide(t0).runNow()))
    if (onShow != null) __obj.updateDynamic("onShow")(js.Any.fromFunction1((t0: /* select */ typingsJapgolly.angularStrap.mgcrea.ngStrap.select.ISelect) => onShow(t0).runNow()))
