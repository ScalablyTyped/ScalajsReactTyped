package typingsJapgolly.argon2Browser
...
object mod {
  ...
  object ArgonType extends StObject {
    ...
    sealed trait Argon2d
      extends StObject
         with ArgonType
    /* 0 */ val Argon2d: typingsJapgolly.argon2Browser.mod.ArgonType.Argon2d & Double = js.native
    
    @js.native
    sealed trait Argon2i
      extends StObject
         with ArgonType
    /* 1 */ val Argon2i: typingsJapgolly.argon2Browser.mod.ArgonType.Argon2i & Double = js.native
    
    @js.native
    sealed trait Argon2id
      extends StObject
         with ArgonType
    /* 2 */ val Argon2id: typingsJapgolly.argon2Browser.mod.ArgonType.Argon2id & Double = js.native
  }
