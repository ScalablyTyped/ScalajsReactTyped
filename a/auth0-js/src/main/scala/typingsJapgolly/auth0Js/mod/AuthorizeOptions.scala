...
import typingsJapgolly.auth0Js.auth0JsStrings.login
import typingsJapgolly.auth0Js.auth0JsStrings.signUp
import typingsJapgolly.auth0Js.auth0JsStrings.signup_
