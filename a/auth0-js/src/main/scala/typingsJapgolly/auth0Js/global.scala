...
import typingsJapgolly.auth0Js.mod.AuthOptions
import typingsJapgolly.auth0Js.mod.ManagementOptions
...
object global {
  ...
  object auth0 {
    ...
    open class Authentication protected ()
      extends typingsJapgolly.auth0Js.mod.Authentication {
    ...
    open class CrossOriginAuthentication protected ()
      extends typingsJapgolly.auth0Js.mod.CrossOriginAuthentication {
    ...
    open class DBConnection protected ()
      extends typingsJapgolly.auth0Js.mod.DBConnection {
    ...
    open class Management protected ()
      extends typingsJapgolly.auth0Js.mod.Management {
      /**
    ...
    open class PasswordlessAuthentication protected ()
      extends typingsJapgolly.auth0Js.mod.PasswordlessAuthentication {
      def this(request: Any, option: Any) = this()
    }
    ...
    open class Popup protected ()
      extends typingsJapgolly.auth0Js.mod.Popup {
    ...
    open class Redirect protected ()
      extends typingsJapgolly.auth0Js.mod.Redirect {
      def this(client: Any, options: Any) = this()
    }
    ...
    open class WebAuth protected ()
      extends typingsJapgolly.auth0Js.mod.WebAuth {
      def this(options: AuthOptions) = this()
    }
