...
object Atime {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(atime = atime.asInstanceOf[js.Any], birthtime = birthtime.asInstanceOf[js.Any], ctime = ctime.asInstanceOf[js.Any], isDirectory = isDirectory.toJsFn, isFile = isFile.toJsFn, mtime = mtime.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any])
