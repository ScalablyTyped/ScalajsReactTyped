...
import typingsJapgolly.angularDevkitCore.anon.PartialReadonlyJobDescrip
...
object srcExperimentalJobsStrategyMod {
  
  object strategy {
    
    @JSImport("@angular-devkit/core/src/experimental/jobs/strategy", "strategy")
    @js.native
