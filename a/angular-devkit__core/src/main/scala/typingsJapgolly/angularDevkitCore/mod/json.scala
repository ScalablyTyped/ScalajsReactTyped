...
object json {
  ...
  @JSImport("@angular-devkit/core", "json")
  @js.native
  ...
  object schema {
    ...
    @JSImport("@angular-devkit/core", "json.schema")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@angular-devkit/core", "json.schema.CoreSchemaRegistry")
    @js.native
    open class CoreSchemaRegistry ()
      extends typingsJapgolly.angularDevkitCore.srcJsonMod.schema.CoreSchemaRegistry {
    ...
    object CoreSchemaRegistry {
      ...
      @JSImport("@angular-devkit/core", "json.schema.CoreSchemaRegistry._set")
      @js.native
      def _set: Any = js.native
      inline def _set_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("_set")(x.asInstanceOf[js.Any])
    }
    
    @JSImport("@angular-devkit/core", "json.schema.SchemaValidationException")
    @js.native
    open class SchemaValidationException ()
      extends typingsJapgolly.angularDevkitCore.srcJsonMod.schema.SchemaValidationException {
    ...
    object transforms {
      ...
      @JSImport("@angular-devkit/core", "json.schema.transforms")
      @js.native
      val ^ : js.Any = js.native
