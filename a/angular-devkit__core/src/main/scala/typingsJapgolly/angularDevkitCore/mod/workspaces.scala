...
object workspaces {
  ...
  @JSImport("@angular-devkit/core", "workspaces")
  @js.native
  ...
  open class ProjectDefinitionCollection ()
    extends typingsJapgolly.angularDevkitCore.srcWorkspaceMod.ProjectDefinitionCollection {
  ...
  open class TargetDefinitionCollection ()
    extends typingsJapgolly.angularDevkitCore.srcWorkspaceMod.TargetDefinitionCollection {
  ...
  @JSImport("@angular-devkit/core", "workspaces.WorkspaceFormat")
  @js.native
