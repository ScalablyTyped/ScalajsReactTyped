...
object experimental {
  ...
  object jobs {
    ...
    @JSImport("@angular-devkit/core", "experimental.jobs")
    @js.native
    ...
    open class ChannelAlreadyExistException protected ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.ChannelAlreadyExistException {
    ...
    open class FallbackRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.FallbackRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT] {
    ...
    open class JobArgumentSchemaValidationError ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.JobArgumentSchemaValidationError {
    ...
    open class JobDoesNotExistException protected ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.JobDoesNotExistException {
      def this(name: JobName) = this()
    }
    
    @JSImport("@angular-devkit/core", "experimental.jobs.JobInboundMessageKind")
    @js.native
    ...
    open class JobInboundMessageSchemaValidationError ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.JobInboundMessageSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class JobNameAlreadyRegisteredException protected ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.JobNameAlreadyRegisteredException {
      def this(name: JobName) = this()
    }
    
    @JSImport("@angular-devkit/core", "experimental.jobs.JobOutboundMessageKind")
    @js.native
    ...
    open class JobOutputSchemaValidationError ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.JobOutputSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    
    @JSImport("@angular-devkit/core", "experimental.jobs.JobState")
    @js.native
    ...
    open class SimpleJobRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.SimpleJobRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT]
    ...
    open class SimpleScheduler[MinimumArgumentT /* <: JsonValue */, MinimumInputT /* <: JsonValue */, MinimumOutputT /* <: JsonValue */] protected ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalMod.jobs.SimpleScheduler[MinimumArgumentT, MinimumInputT, MinimumOutputT] {
    ...
    object strategy {
      ...
      @JSImport("@angular-devkit/core", "experimental.jobs.strategy")
      @js.native
      val ^ : js.Any = js.native
