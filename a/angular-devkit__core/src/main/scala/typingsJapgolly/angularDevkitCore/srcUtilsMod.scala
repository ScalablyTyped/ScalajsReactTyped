...
object srcUtilsMod {
  ...
  open class CircularDependencyFoundException ()
    extends typingsJapgolly.angularDevkitCore.srcUtilsPartiallyOrderedSetMod.CircularDependencyFoundException
  
  @JSImport("@angular-devkit/core/src/utils", "DependencyNotFoundException")
  @js.native
  open class DependencyNotFoundException ()
    extends typingsJapgolly.angularDevkitCore.srcUtilsPartiallyOrderedSetMod.DependencyNotFoundException
  
  @JSImport("@angular-devkit/core/src/utils", "PartiallyOrderedSet")
  @js.native
  open class PartiallyOrderedSet[T] ()
    extends typingsJapgolly.angularDevkitCore.srcUtilsPartiallyOrderedSetMod.PartiallyOrderedSet[T]
  
  @JSImport("@angular-devkit/core/src/utils", "PriorityQueue")
  @js.native
  open class PriorityQueue[T] protected ()
    extends typingsJapgolly.angularDevkitCore.srcUtilsPriorityQueueMod.PriorityQueue[T] {
