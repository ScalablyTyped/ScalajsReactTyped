...
object srcExperimentalMod {
  ...
  object jobs {
    ...
    open class ChannelAlreadyExistException protected ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.ChannelAlreadyExistException {
    ...
    open class FallbackRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.FallbackRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT] {
    ...
    open class JobArgumentSchemaValidationError ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.JobArgumentSchemaValidationError {
    ...
    open class JobDoesNotExistException protected ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.JobDoesNotExistException {
    ...
    open class JobInboundMessageSchemaValidationError ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.JobInboundMessageSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class JobNameAlreadyRegisteredException protected ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.JobNameAlreadyRegisteredException {
      def this(name: JobName) = this()
    }
    ...
    open class JobOutputSchemaValidationError ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.JobOutputSchemaValidationError {
      def this(errors: js.Array[SchemaValidatorError]) = this()
    }
    ...
    open class SimpleJobRegistry[MinimumArgumentValueT /* <: JsonValue */, MinimumInputValueT /* <: JsonValue */, MinimumOutputValueT /* <: JsonValue */] ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.SimpleJobRegistry[MinimumArgumentValueT, MinimumInputValueT, MinimumOutputValueT]
    ...
    open class SimpleScheduler[MinimumArgumentT /* <: JsonValue */, MinimumInputT /* <: JsonValue */, MinimumOutputT /* <: JsonValue */] protected ()
      extends typingsJapgolly.angularDevkitCore.srcExperimentalJobsMod.SimpleScheduler[MinimumArgumentT, MinimumInputT, MinimumOutputT] {
