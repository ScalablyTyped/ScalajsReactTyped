...
import typingsJapgolly.angularDevkitCore.angularDevkitCoreStrings.comment
import typingsJapgolly.angularDevkitCore.angularDevkitCoreStrings.content
import typingsJapgolly.angularDevkitCore.angularDevkitCoreStrings.escape
import typingsJapgolly.angularDevkitCore.angularDevkitCoreStrings.evaluate
import typingsJapgolly.angularDevkitCore.angularDevkitCoreStrings.interpolate
import typingsJapgolly.angularDevkitCore.anon.Exports
import typingsJapgolly.sourceMap.mod.Position
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcUtilsTemplateMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstContent
    - typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstEvaluate
    - typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstComment
    - typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstEscape
    - typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstInterpolate
  */
  trait TemplateAstNode extends StObject
  object TemplateAstNode {
    
    inline def TemplateAstComment(end: Position, start: Position, text: String): typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstComment = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], kind = "comment", start = start.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstComment]
    }
    
    inline def TemplateAstContent(content: String, end: Position, start: Position): typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstContent = {
      val __obj = js.Dynamic.literal(content = content.asInstanceOf[js.Any], end = end.asInstanceOf[js.Any], kind = "content", start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstContent]
    }
    
    inline def TemplateAstEscape(end: Position, expression: String, start: Position): typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstEscape = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], expression = expression.asInstanceOf[js.Any], kind = "escape", start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstEscape]
    }
    
    inline def TemplateAstEvaluate(end: Position, expression: String, start: Position): typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstEvaluate = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], expression = expression.asInstanceOf[js.Any], kind = "evaluate", start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstEvaluate]
    }
    
    inline def TemplateAstInterpolate(end: Position, expression: String, start: Position): typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstInterpolate = {
      val __obj = js.Dynamic.literal(end = end.asInstanceOf[js.Any], expression = expression.asInstanceOf[js.Any], kind = "interpolate", start = start.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularDevkitCore.srcUtilsTemplateMod.TemplateAstInterpolate]
    }
  }
