...
object srcJsonMod {
  ...
  object schema {
    ...
    open class CoreSchemaRegistry ()
      extends typingsJapgolly.angularDevkitCore.srcJsonSchemaMod.CoreSchemaRegistry {
    ...
    open class SchemaValidationException ()
      extends typingsJapgolly.angularDevkitCore.srcJsonSchemaMod.SchemaValidationException {
