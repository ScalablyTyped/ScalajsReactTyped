...
import typingsJapgolly.autoprefixer.anon.Browsers
import typingsJapgolly.autoprefixer.anon.From
import typingsJapgolly.autoprefixer.autoprefixerBooleans.`true`
import typingsJapgolly.autoprefixer.autoprefixerStrings.`no-2009`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.autoprefixer.autoprefixerStrings.autoplace
    - typingsJapgolly.autoprefixer.autoprefixerStrings.`no-autoplace`
  */
  trait GridValue extends StObject
  object GridValue {
    
    inline def autoplace: typingsJapgolly.autoprefixer.autoprefixerStrings.autoplace = "autoplace".asInstanceOf[typingsJapgolly.autoprefixer.autoprefixerStrings.autoplace]
    
    inline def `no-autoplace`: typingsJapgolly.autoprefixer.autoprefixerStrings.`no-autoplace` = "no-autoplace".asInstanceOf[typingsJapgolly.autoprefixer.autoprefixerStrings.`no-autoplace`]
  }
