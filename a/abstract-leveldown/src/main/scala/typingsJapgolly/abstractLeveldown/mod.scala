...
import typingsJapgolly.abstractLeveldown.abstractLeveldownStrings.`new`
import typingsJapgolly.abstractLeveldown.abstractLeveldownStrings.closed
import typingsJapgolly.abstractLeveldown.abstractLeveldownStrings.closing
import typingsJapgolly.abstractLeveldown.abstractLeveldownStrings.del
import typingsJapgolly.abstractLeveldown.abstractLeveldownStrings.open
import typingsJapgolly.abstractLeveldown.abstractLeveldownStrings.opening
...
object mod {
  ...
  open class AbstractChainedBatchCls[K, V] protected ()
    extends StObject
       with typingsJapgolly.abstractLeveldown.mod.AbstractChainedBatch[K, V] {
  ...
  trait AbstractIterator[K, V]
    ...
    var db: typingsJapgolly.abstractLeveldown.mod.AbstractLevelDOWN[K, V]
  ...
  object AbstractIterator {
    ...
    extension [Self <: AbstractIterator[?, ?], K, V](x: Self & (AbstractIterator[K, V])) {
      ...
      inline def setDb(value: typingsJapgolly.abstractLeveldown.mod.AbstractLevelDOWN[K, V]): Self = StObject.set(x, "db", value.asInstanceOf[js.Any])
      
      inline def setEnd(value: ErrorCallback => Callback): Self = StObject.set(x, "end", js.Any.fromFunction1((t0: ErrorCallback) => value(t0).runNow()))
  ...
  open class AbstractIteratorCls[K, V] protected ()
    ...
    /* CompleteClass */
    var db: typingsJapgolly.abstractLeveldown.mod.AbstractLevelDOWN[K, V] = js.native
  ...
  trait AbstractLevelDOWN[K, V]
    ...
    def batch(): typingsJapgolly.abstractLeveldown.mod.AbstractChainedBatch[K, V] = js.native
    def batch(array: js.Array[AbstractBatch[K, V]], cb: ErrorCallback): typingsJapgolly.abstractLeveldown.mod.AbstractChainedBatch[K, V] = js.native
    def batch(array: js.Array[AbstractBatch[K, V]], options: AbstractOptions, cb: ErrorCallback): typingsJapgolly.abstractLeveldown.mod.AbstractChainedBatch[K, V] = js.native
  ...
  open class AbstractLevelDOWNCls[K, V] protected ()
    extends StObject
       with typingsJapgolly.abstractLeveldown.mod.AbstractLevelDOWN[K, V] {
    // tslint:disable-next-line no-unnecessary-generics
  ...
  */
  ...
  object AbstractBatch {
    ...
    inline def DelBatch[K, V](key: K): typingsJapgolly.abstractLeveldown.mod.DelBatch[K, V] = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("del")
      __obj.asInstanceOf[typingsJapgolly.abstractLeveldown.mod.DelBatch[K, V]]
    }
    
    inline def PutBatch[K, V](key: K, value: V): typingsJapgolly.abstractLeveldown.mod.PutBatch[K, V] = {
      val __obj = js.Dynamic.literal(key = key.asInstanceOf[js.Any], value = value.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("put")
      __obj.asInstanceOf[typingsJapgolly.abstractLeveldown.mod.PutBatch[K, V]]
    }
  }
  ...
  Instantiable1[
          /* db */ Any, 
          typingsJapgolly.abstractLeveldown.mod.AbstractChainedBatch[js.Object, js.Object]
        ] {
    
    // tslint:disable-next-line no-unnecessary-generics
    def apply[K, V](db: Any): typingsJapgolly.abstractLeveldown.mod.AbstractChainedBatch[K, V] = js.native
  }
  ...
  Instantiable1[
          /* location */ String, 
          typingsJapgolly.abstractLeveldown.mod.AbstractLevelDOWN[js.Object, js.Object]
        ] {
    
    // tslint:disable-next-line no-unnecessary-generics
    def apply[K, V](location: String): typingsJapgolly.abstractLeveldown.mod.AbstractLevelDOWN[K, V] = js.native
  }
