...
import typingsJapgolly.activexScripting.activexScriptingNumbers.`3`
import typingsJapgolly.activexScripting.activexScriptingNumbers.`4`
import typingsJapgolly.activexScripting.activexScriptingNumbers.`5`
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.activexScripting.activexScriptingNumbers.`4`
  - typingsJapgolly.activexScripting.activexScriptingNumbers.`2`
  - typingsJapgolly.activexScripting.activexScriptingNumbers.`5`
  - typingsJapgolly.activexScripting.activexScriptingNumbers.`3`
