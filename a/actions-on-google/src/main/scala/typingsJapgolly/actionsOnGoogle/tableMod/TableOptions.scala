...
import typingsJapgolly.actionsOnGoogle.v2Mod.GoogleActionsV2UiElementsButton
import typingsJapgolly.actionsOnGoogle.v2Mod.GoogleActionsV2UiElementsImage
