...
import typingsJapgolly.actionsOnGoogle.distFrameworkExpressMod.ExpressHandler
import typingsJapgolly.actionsOnGoogle.distFrameworkExpressMod.ExpressMetadata
import typingsJapgolly.actionsOnGoogle.distFrameworkExpressMod.Express_
import typingsJapgolly.actionsOnGoogle.distFrameworkLambdaMod.LambdaMetadata
import typingsJapgolly.actionsOnGoogle.distFrameworkLambdaMod.Lambda_
...
object distFrameworkFrameworkMod {
  ...
  - typingsJapgolly.actionsOnGoogle.distFrameworkLambdaMod.LambdaHandler because Already inherited */ @js.native
  trait OmniHandler
