...
import typingsJapgolly.actionsOnGoogle.distServiceActionssdkApiV2Mod.GoogleActionsV2AppResponse
...
import typingsJapgolly.actionsOnGoogle.distServiceActionssdkConversationMod.Conversation
