...
object distServiceActionssdkConversationArgumentMod {
  
  @JSImport("actions-on-google/dist/service/actionssdk/conversation/argument", "Arguments")
  @js.native
  /** @hidden */
  open class Arguments ()
    extends typingsJapgolly.actionsOnGoogle.distServiceActionssdkConversationArgumentArgumentMod.Arguments {
  ...
  open class Parsed protected ()
    extends typingsJapgolly.actionsOnGoogle.distServiceActionssdkConversationArgumentArgumentMod.Parsed {
    /** @hidden */
    def this(raw: js.Array[GoogleActionsV2Argument]) = this()
  }
  ...
  open class Raw protected ()
    extends typingsJapgolly.actionsOnGoogle.distServiceActionssdkConversationArgumentArgumentMod.Raw {
    /** @hidden */
  ...
  open class Status protected ()
    extends typingsJapgolly.actionsOnGoogle.distServiceActionssdkConversationArgumentArgumentMod.Status {
    /** @hidden */
    def this(raw: js.Array[GoogleActionsV2Argument]) = this()
  }
}
