...
import typingsJapgolly.actionsOnGoogle.distServiceDialogflowConvMod.DialogflowConversation
...
object distServiceDialogflowDialogflowMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.actionsOnGoogle.actionsOnGoogleStrings.`Default Welcome Intent`
    - typingsJapgolly.actionsOnGoogle.actionsOnGoogleStrings.`Default Fallback Intent`
  */
  trait DefaultDialogflowIntent extends StObject
  object DefaultDialogflowIntent {
    
    inline def `Default Fallback Intent`: typingsJapgolly.actionsOnGoogle.actionsOnGoogleStrings.`Default Fallback Intent` = ("Default Fallback Intent").asInstanceOf[typingsJapgolly.actionsOnGoogle.actionsOnGoogleStrings.`Default Fallback Intent`]
    
    inline def `Default Welcome Intent`: typingsJapgolly.actionsOnGoogle.actionsOnGoogleStrings.`Default Welcome Intent` = ("Default Welcome Intent").asInstanceOf[typingsJapgolly.actionsOnGoogle.actionsOnGoogleStrings.`Default Welcome Intent`]
  }
