...
import typingsJapgolly.actionsOnGoogle.apiV2Mod.GoogleCloudDialogflowV2IntentMessage
import typingsJapgolly.actionsOnGoogle.commonMod.JsonObject
import typingsJapgolly.actionsOnGoogle.v1Mod.DialogflowV1Fulfillment
...
object incomingMod extends js.Object {
  ...
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.actionsOnGoogle.actionssdkMod.Image
    - typingsJapgolly.actionsOnGoogle.actionssdkMod.Suggestions
    - typingsJapgolly.actionsOnGoogle.actionssdkMod.BasicCard
    - typingsJapgolly.actionsOnGoogle.actionssdkMod.SimpleResponse
    - typingsJapgolly.actionsOnGoogle.actionssdkMod.LinkOutSuggestion
    - typingsJapgolly.actionsOnGoogle.actionssdkMod.List
    - typingsJapgolly.actionsOnGoogle.actionssdkMod.Carousel
