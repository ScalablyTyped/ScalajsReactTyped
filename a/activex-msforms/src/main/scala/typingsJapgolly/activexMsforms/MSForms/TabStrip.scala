...
object TabStrip {
  ...
  inline def apply(
    ...
    _GetClientHeight: Double => Callback,
    _GetClientLeft: Double => Callback,
    _GetClientTop: Double => Callback,
    _GetClientWidth: Double => Callback,
  ...
  extension [Self <: TabStrip](x: Self) {
    ...
    inline def set_GetClientHeight(value: Double => Callback): Self = StObject.set(x, "_GetClientHeight", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def set_GetClientLeft(value: Double => Callback): Self = StObject.set(x, "_GetClientLeft", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def set_GetClientTop(value: Double => Callback): Self = StObject.set(x, "_GetClientTop", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def set_GetClientWidth(value: Double => Callback): Self = StObject.set(x, "_GetClientWidth", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
