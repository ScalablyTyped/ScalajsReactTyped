...
object fmSnapPoint {
  ...
  inline def fmSnapPointBottomCenter: `7` = 7.asInstanceOf[`7`]
  
  inline def fmSnapPointBottomLeft: `6` = 6.asInstanceOf[`6`]
  
  inline def fmSnapPointBottomRight: `8` = 8.asInstanceOf[`8`]
  
  inline def fmSnapPointCenter: `4` = 4.asInstanceOf[`4`]
  
  inline def fmSnapPointCenterLeft: `3` = 3.asInstanceOf[`3`]
  
  inline def fmSnapPointCenterRight: `5` = 5.asInstanceOf[`5`]
  
  inline def fmSnapPointTopCenter: `1` = 1.asInstanceOf[`1`]
  
  inline def fmSnapPointTopLeft: `0` = 0.asInstanceOf[`0`]
  
  inline def fmSnapPointTopRight: `2` = 2.asInstanceOf[`2`]
}
