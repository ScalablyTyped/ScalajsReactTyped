...
trait ToggleButton extends StObject {
  ...
  /* private */ @JSName("MSForms.ToggleButton_typekey")
...
object ToggleButton {
  ...
  extension [Self <: ToggleButton](x: Self) {
    ...
    inline def setMSFormsDotToggleButton_typekey(value: ToggleButton): Self = StObject.set(x, "MSForms.ToggleButton_typekey", value.asInstanceOf[js.Any])
