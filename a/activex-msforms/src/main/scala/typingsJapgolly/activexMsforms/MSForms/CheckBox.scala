...
trait CheckBox extends StObject {
  ...
  /* private */ @JSName("MSForms.CheckBox_typekey")
...
object CheckBox {
  ...
  extension [Self <: CheckBox](x: Self) {
    ...
    inline def setMSFormsDotCheckBox_typekey(value: CheckBox): Self = StObject.set(x, "MSForms.CheckBox_typekey", value.asInstanceOf[js.Any])
