...
object MultiPage {
  ...
  extension [Self <: MultiPage](x: Self) {
    ...
    inline def set_GetTabFixedHeight(value: Double => Callback): Self = StObject.set(x, "_GetTabFixedHeight", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def set_GetTabFixedWidth(value: Double => Callback): Self = StObject.set(x, "_GetTabFixedWidth", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def set_SetTabFixedHeight(value: Double => Callback): Self = StObject.set(x, "_SetTabFixedHeight", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    
    inline def set_SetTabFixedWidth(value: Double => Callback): Self = StObject.set(x, "_SetTabFixedWidth", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
  }
}
