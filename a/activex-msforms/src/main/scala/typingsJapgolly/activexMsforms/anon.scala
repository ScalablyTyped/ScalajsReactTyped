...
object anon {
  ...
  object Control {
    ...
    inline def apply(Control: typingsJapgolly.activexMsforms.MSForms.Control): Control = {
    ...
    extension [Self <: Control](x: Self) {
      ...
      inline def setControl(value: typingsJapgolly.activexMsforms.MSForms.Control): Self = StObject.set(x, "Control", value.asInstanceOf[js.Any])
    }
  }
  ...
  object Index {
    ...
    inline def apply(Control: typingsJapgolly.activexMsforms.MSForms.Control, Index: Double): Index = {
