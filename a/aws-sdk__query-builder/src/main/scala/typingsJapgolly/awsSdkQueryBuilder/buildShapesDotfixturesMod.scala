...
object buildShapesDotfixturesMod {
  
  @JSImport("@aws-sdk/query-builder/build/shapes.fixtures", "blobShape")
  @js.native
  val blobShape: Blob = js.native
  
  @JSImport("@aws-sdk/query-builder/build/shapes.fixtures", "booleanShape")
  @js.native
