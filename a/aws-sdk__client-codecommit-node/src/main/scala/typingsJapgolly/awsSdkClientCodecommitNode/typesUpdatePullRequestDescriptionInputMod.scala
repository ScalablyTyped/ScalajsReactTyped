...
@JSImport("@aws-sdk/client-codecommit-node/types/UpdatePullRequestDescriptionInput", JSImport.Namespace)
@js.native
object typesUpdatePullRequestDescriptionInputMod extends js.Object {
  @js.native
  trait UpdatePullRequestDescriptionInput extends InputTypesUnion {
    /**
