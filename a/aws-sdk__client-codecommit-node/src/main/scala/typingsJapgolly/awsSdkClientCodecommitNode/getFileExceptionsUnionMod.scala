...
@js.native
object getFileExceptionsUnionMod extends js.Object {
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientCodecommitNode.typesFileDoesNotExistExceptionMod.FileDoesNotExistException
    ...
    - typingsJapgolly.awsSdkClientCodecommitNode.typesFileTooLargeExceptionMod.FileTooLargeException
  */
