package typingsJapgolly.awsSdkClientCodecommitNode.typesPullRequestMergedStateChangedEventMetadataMod

import typingsJapgolly.awsSdkClientCodecommitNode.typesMergeMetadataMod.UnmarshalledMergeMetadata
