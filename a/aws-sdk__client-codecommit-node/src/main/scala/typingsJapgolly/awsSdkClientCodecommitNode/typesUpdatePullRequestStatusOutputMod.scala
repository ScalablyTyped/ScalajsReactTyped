...
@JSImport("@aws-sdk/client-codecommit-node/types/UpdatePullRequestStatusOutput", JSImport.Namespace)
@js.native
object typesUpdatePullRequestStatusOutputMod extends js.Object {
  @js.native
