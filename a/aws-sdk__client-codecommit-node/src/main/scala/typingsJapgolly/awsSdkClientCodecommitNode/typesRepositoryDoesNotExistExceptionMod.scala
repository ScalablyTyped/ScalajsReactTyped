...
object typesRepositoryDoesNotExistExceptionMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_RepositoryDoesNotExistExceptionDetails> * / any */ trait RepositoryDoesNotExistException
    ...
    var name: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.RepositoryDoesNotExistException
  }
  object RepositoryDoesNotExistException {
    ...
    extension [Self <: RepositoryDoesNotExistException](x: Self) {
      ...
      inline def setName(
        value: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.RepositoryDoesNotExistException
