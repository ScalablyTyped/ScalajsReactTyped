...
object typesUpdateDefaultBranchInputMod {
  ...
  trait UpdateDefaultBranchInput
    extends StObject
  ...
  object UpdateDefaultBranchInput {
    ...
    inline def apply(defaultBranchName: String, repositoryName: String): UpdateDefaultBranchInput = {
    ...
    extension [Self <: UpdateDefaultBranchInput](x: Self) {
      ...
      inline def setDefaultBranchName(value: String): Self = StObject.set(x, "defaultBranchName", value.asInstanceOf[js.Any])
