...
trait EncryptionKeyDisabledException
  ...
  @JSName("name")
  var name_EncryptionKeyDisabledException: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionKeyDisabledException = js.native
}
