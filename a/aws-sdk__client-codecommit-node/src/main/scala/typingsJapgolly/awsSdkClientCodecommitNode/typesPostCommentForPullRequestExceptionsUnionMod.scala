...
object typesPostCommentForPullRequestExceptionsUnionMod {
  ...
  */
  ...
  object PostCommentForPullRequestExceptionsUnion {
    ...
    inline def BeforeCommitIdAndAfterCommitIdAreSameException(): typingsJapgolly.awsSdkClientCodecommitNode.typesBeforeCommitIdAndAfterCommitIdAreSameExceptionMod.BeforeCommitIdAndAfterCommitIdAreSameException = {
      val __obj = js.Dynamic.literal(name = "BeforeCommitIdAndAfterCommitIdAreSameException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesBeforeCommitIdAndAfterCommitIdAreSameExceptionMod.BeforeCommitIdAndAfterCommitIdAreSameException]
    }
    
    inline def ClientRequestTokenRequiredException(): typingsJapgolly.awsSdkClientCodecommitNode.typesClientRequestTokenRequiredExceptionMod.ClientRequestTokenRequiredException = {
      val __obj = js.Dynamic.literal(name = "ClientRequestTokenRequiredException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesClientRequestTokenRequiredExceptionMod.ClientRequestTokenRequiredException]
    }
    
    inline def CommentContentRequiredException(): typingsJapgolly.awsSdkClientCodecommitNode.typesCommentContentRequiredExceptionMod.CommentContentRequiredException = {
      val __obj = js.Dynamic.literal(name = "CommentContentRequiredException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesCommentContentRequiredExceptionMod.CommentContentRequiredException]
    }
    
    inline def CommentContentSizeLimitExceededException(): typingsJapgolly.awsSdkClientCodecommitNode.typesCommentContentSizeLimitExceededExceptionMod.CommentContentSizeLimitExceededException = {
      val __obj = js.Dynamic.literal(name = "CommentContentSizeLimitExceededException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesCommentContentSizeLimitExceededExceptionMod.CommentContentSizeLimitExceededException]
    }
    ...
    inline def CommitIdRequiredException(): typingsJapgolly.awsSdkClientCodecommitNode.typesCommitIdRequiredExceptionMod.CommitIdRequiredException = {
      val __obj = js.Dynamic.literal(name = "CommitIdRequiredException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesCommitIdRequiredExceptionMod.CommitIdRequiredException]
    }
    ...
    inline def IdempotencyParameterMismatchException(): typingsJapgolly.awsSdkClientCodecommitNode.typesIdempotencyParameterMismatchExceptionMod.IdempotencyParameterMismatchException = {
      val __obj = js.Dynamic.literal(name = "IdempotencyParameterMismatchException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesIdempotencyParameterMismatchExceptionMod.IdempotencyParameterMismatchException]
    }
    
    inline def InvalidClientRequestTokenException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidClientRequestTokenExceptionMod.InvalidClientRequestTokenException = {
      val __obj = js.Dynamic.literal(name = "InvalidClientRequestTokenException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidClientRequestTokenExceptionMod.InvalidClientRequestTokenException]
    }
    
    inline def InvalidCommitIdException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidCommitIdExceptionMod.InvalidCommitIdException = {
      val __obj = js.Dynamic.literal(name = "InvalidCommitIdException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidCommitIdExceptionMod.InvalidCommitIdException]
    }
    
    inline def InvalidFileLocationException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidFileLocationExceptionMod.InvalidFileLocationException = {
      val __obj = js.Dynamic.literal(name = "InvalidFileLocationException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidFileLocationExceptionMod.InvalidFileLocationException]
    }
    
    inline def InvalidFilePositionException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidFilePositionExceptionMod.InvalidFilePositionException = {
      val __obj = js.Dynamic.literal(name = "InvalidFilePositionException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidFilePositionExceptionMod.InvalidFilePositionException]
    }
    ...
    inline def InvalidRelativeFileVersionEnumException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidRelativeFileVersionEnumExceptionMod.InvalidRelativeFileVersionEnumException = {
      val __obj = js.Dynamic.literal(name = "InvalidRelativeFileVersionEnumException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidRelativeFileVersionEnumExceptionMod.InvalidRelativeFileVersionEnumException]
    }
    ...
    inline def PathDoesNotExistException(): typingsJapgolly.awsSdkClientCodecommitNode.typesPathDoesNotExistExceptionMod.PathDoesNotExistException = {
      val __obj = js.Dynamic.literal(name = "PathDoesNotExistException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesPathDoesNotExistExceptionMod.PathDoesNotExistException]
    }
    ...
    inline def RepositoryNotAssociatedWithPullRequestException(): typingsJapgolly.awsSdkClientCodecommitNode.typesRepositoryNotAssociatedWithPullRequestExceptionMod.RepositoryNotAssociatedWithPullRequestException = {
      val __obj = js.Dynamic.literal(name = "RepositoryNotAssociatedWithPullRequestException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesRepositoryNotAssociatedWithPullRequestExceptionMod.RepositoryNotAssociatedWithPullRequestException]
    }
  }
}
