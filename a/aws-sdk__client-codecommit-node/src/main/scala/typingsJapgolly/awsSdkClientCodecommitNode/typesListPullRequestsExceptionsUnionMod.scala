...
object typesListPullRequestsExceptionsUnionMod {
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidPullRequestStatusExceptionMod.InvalidPullRequestStatusException
    - typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidAuthorArnExceptionMod.InvalidAuthorArnException
    - typingsJapgolly.awsSdkClientCodecommitNode.typesAuthorDoesNotExistExceptionMod.AuthorDoesNotExistException
  ...
  */
  ...
  object ListPullRequestsExceptionsUnion {
    ...
    inline def AuthorDoesNotExistException(): typingsJapgolly.awsSdkClientCodecommitNode.typesAuthorDoesNotExistExceptionMod.AuthorDoesNotExistException = {
      val __obj = js.Dynamic.literal(name = "AuthorDoesNotExistException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesAuthorDoesNotExistExceptionMod.AuthorDoesNotExistException]
    }
    ...
    inline def InvalidAuthorArnException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidAuthorArnExceptionMod.InvalidAuthorArnException = {
      val __obj = js.Dynamic.literal(name = "InvalidAuthorArnException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidAuthorArnExceptionMod.InvalidAuthorArnException]
    }
    ...
    inline def InvalidMaxResultsException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidMaxResultsExceptionMod.InvalidMaxResultsException = {
      val __obj = js.Dynamic.literal(name = "InvalidMaxResultsException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidMaxResultsExceptionMod.InvalidMaxResultsException]
    }
    
    inline def InvalidPullRequestStatusException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidPullRequestStatusExceptionMod.InvalidPullRequestStatusException = {
      val __obj = js.Dynamic.literal(name = "InvalidPullRequestStatusException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidPullRequestStatusExceptionMod.InvalidPullRequestStatusException]
    }
