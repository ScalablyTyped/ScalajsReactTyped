...
object typesEncryptionKeyAccessDeniedExceptionMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_EncryptionKeyAccessDeniedExceptionDetails> * / any */ trait EncryptionKeyAccessDeniedException
    ...
    var name: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionKeyAccessDeniedException
  }
  object EncryptionKeyAccessDeniedException {
    ...
    extension [Self <: EncryptionKeyAccessDeniedException](x: Self) {
      ...
      inline def setName(
        value: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionKeyAccessDeniedException
