...
object codeCommitConfigurationMod {
  
  @JSImport("@aws-sdk/client-codecommit-node/CodeCommitConfiguration", "configurationProperties")
  @js.native
  val configurationProperties: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ConfigurationDefinition<CodeCommitResolvableConfiguration, CodeCommitResolvedConfiguration> */ Any = js.native
  
  trait CodeCommitConfiguration extends StObject {
  ...
  object CodeCommitConfiguration {
    ...
    inline def apply(): CodeCommitConfiguration = {
  ...
  trait CodeCommitResolvableConfiguration
    extends StObject
       with CodeCommitConfiguration {
  ...
  object CodeCommitResolvableConfiguration {
  ...
  trait CodeCommitResolvedConfiguration
    extends StObject
       with CodeCommitConfiguration {
    ...
    def base64Decoder_MCodeCommitResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MCodeCommitResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("base64Encoder")
    ...
    @JSName("credentials")
    def credentials_MCodeCommitResolvedConfiguration(): js.Promise[Credentials]
    @JSName("credentials")
    ...
    @JSName("handler")
    def handler_MCodeCommitResolvedConfiguration[Input /* <: js.Object */, Output /* <: js.Object */](context: HandlerExecutionContext): DeserializeHandler[Input, Output]
    @JSName("handler")
    var handler_Original: Terminalware
    
    @JSName("maxRedirects")
    var maxRedirects_CodeCommitResolvedConfiguration: Double
    
    @JSName("maxRetries")
    var maxRetries_CodeCommitResolvedConfiguration: Double
    
    var parser: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ResponseParser<_stream.Readable> */ Any
    
    @JSName("region")
    def region_MCodeCommitResolvedConfiguration(): js.Promise[String]
    @JSName("region")
    ...
    @JSName("sha256")
    var sha256_CodeCommitResolvedConfiguration: HashConstructor
    
    @JSName("signer")
    var signer_CodeCommitResolvedConfiguration: RequestSigner
    
    @JSName("signingName")
    var signingName_CodeCommitResolvedConfiguration: String
    
    @JSName("sslEnabled")
    var sslEnabled_CodeCommitResolvedConfiguration: Boolean
    
    @JSName("streamCollector")
    def streamCollector_MCodeCommitResolvedConfiguration(stream: Any): js.Promise[js.typedarray.Uint8Array]
    @JSName("streamCollector")
    var streamCollector_Original: StreamCollector
    
    @JSName("urlParser")
    def urlParser_MCodeCommitResolvedConfiguration(url: String): Endpoint
    @JSName("urlParser")
    def urlParser_MCodeCommitResolvedConfiguration(url: URL): Endpoint
    @JSName("urlParser")
    var urlParser_Original: UrlParser
    
    @JSName("utf8Decoder")
    def utf8Decoder_MCodeCommitResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MCodeCommitResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("utf8Encoder")
    var utf8Encoder_Original: Encoder
  }
  object CodeCommitResolvedConfiguration {
