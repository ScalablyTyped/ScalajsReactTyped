...
object typesGetFolderExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException
    ...
    - typingsJapgolly.awsSdkClientCodecommitNode.typesFolderDoesNotExistExceptionMod.FolderDoesNotExistException
  ...
  */
  trait GetFolderExceptionsUnion extends StObject
  object GetFolderExceptionsUnion {
    
    inline def CommitDoesNotExistException(): typingsJapgolly.awsSdkClientCodecommitNode.typesCommitDoesNotExistExceptionMod.CommitDoesNotExistException = {
      val __obj = js.Dynamic.literal(name = "CommitDoesNotExistException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesCommitDoesNotExistExceptionMod.CommitDoesNotExistException]
    }
    ...
    inline def FolderDoesNotExistException(): typingsJapgolly.awsSdkClientCodecommitNode.typesFolderDoesNotExistExceptionMod.FolderDoesNotExistException = {
      val __obj = js.Dynamic.literal(name = "FolderDoesNotExistException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesFolderDoesNotExistExceptionMod.FolderDoesNotExistException]
    }
    
    inline def InvalidCommitException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException = {
      val __obj = js.Dynamic.literal(name = "InvalidCommitException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidCommitExceptionMod.InvalidCommitException]
    }
    
    inline def InvalidPathException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidPathExceptionMod.InvalidPathException = {
      val __obj = js.Dynamic.literal(name = "InvalidPathException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidPathExceptionMod.InvalidPathException]
    }
    ...
    inline def PathRequiredException(): typingsJapgolly.awsSdkClientCodecommitNode.typesPathRequiredExceptionMod.PathRequiredException = {
      val __obj = js.Dynamic.literal(name = "PathRequiredException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesPathRequiredExceptionMod.PathRequiredException]
    }
