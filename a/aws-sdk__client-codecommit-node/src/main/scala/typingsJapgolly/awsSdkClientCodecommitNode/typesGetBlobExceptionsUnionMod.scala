...
object typesGetBlobExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientCodecommitNode.typesBlobIdRequiredExceptionMod.BlobIdRequiredException
    - typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidBlobIdExceptionMod.InvalidBlobIdException
    - typingsJapgolly.awsSdkClientCodecommitNode.typesBlobIdDoesNotExistExceptionMod.BlobIdDoesNotExistException
  ...
  */
  ...
  object GetBlobExceptionsUnion {
    ...
    inline def BlobIdDoesNotExistException(): typingsJapgolly.awsSdkClientCodecommitNode.typesBlobIdDoesNotExistExceptionMod.BlobIdDoesNotExistException = {
      val __obj = js.Dynamic.literal(name = "BlobIdDoesNotExistException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesBlobIdDoesNotExistExceptionMod.BlobIdDoesNotExistException]
    }
    
    inline def BlobIdRequiredException(): typingsJapgolly.awsSdkClientCodecommitNode.typesBlobIdRequiredExceptionMod.BlobIdRequiredException = {
      val __obj = js.Dynamic.literal(name = "BlobIdRequiredException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesBlobIdRequiredExceptionMod.BlobIdRequiredException]
    }
    ...
    inline def FileTooLargeException(): typingsJapgolly.awsSdkClientCodecommitNode.typesFileTooLargeExceptionMod.FileTooLargeException = {
      val __obj = js.Dynamic.literal(name = "FileTooLargeException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesFileTooLargeExceptionMod.FileTooLargeException]
    }
    
    inline def InvalidBlobIdException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidBlobIdExceptionMod.InvalidBlobIdException = {
      val __obj = js.Dynamic.literal(name = "InvalidBlobIdException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidBlobIdExceptionMod.InvalidBlobIdException]
    }
