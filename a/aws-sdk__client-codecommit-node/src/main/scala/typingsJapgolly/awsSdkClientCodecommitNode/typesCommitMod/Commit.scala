package typingsJapgolly.awsSdkClientCodecommitNode.typesCommitMod

import typingsJapgolly.awsSdkClientCodecommitNode.typesUserInfoMod.UserInfo
...
object Commit {
  ...
  def apply(
    ...
    message: String = null,
    parents: js.Array[String] | js.Iterable[String] = null,
    treeId: String = null
  ): Commit = {
