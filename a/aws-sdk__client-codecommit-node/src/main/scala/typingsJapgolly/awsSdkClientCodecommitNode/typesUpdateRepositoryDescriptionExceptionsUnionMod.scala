...
object typesUpdateRepositoryDescriptionExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidRepositoryDescriptionExceptionMod.InvalidRepositoryDescriptionException
  ...
  */
  trait UpdateRepositoryDescriptionExceptionsUnion extends StObject
  object UpdateRepositoryDescriptionExceptionsUnion {
    ...
    inline def InvalidRepositoryDescriptionException(): typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidRepositoryDescriptionExceptionMod.InvalidRepositoryDescriptionException = {
      val __obj = js.Dynamic.literal(name = "InvalidRepositoryDescriptionException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesInvalidRepositoryDescriptionExceptionMod.InvalidRepositoryDescriptionException]
    }
