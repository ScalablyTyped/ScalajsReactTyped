package typingsJapgolly.awsSdkClientCodecommitNode.typesEncryptionKeyNotFoundExceptionMod
...
trait EncryptionKeyNotFoundException
  extends ServiceException[EncryptionKeyNotFoundExceptionDetails]
  ...
  @JSName("name")
  var name_EncryptionKeyNotFoundException: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionKeyNotFoundException = js.native
}
