...
trait RepositoryNameRequiredException
  ...
  @JSName("name")
  var name_RepositoryNameRequiredException: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.RepositoryNameRequiredException = js.native
}
