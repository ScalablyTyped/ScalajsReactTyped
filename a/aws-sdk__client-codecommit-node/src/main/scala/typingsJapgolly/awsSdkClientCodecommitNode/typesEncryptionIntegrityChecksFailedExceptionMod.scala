...
object typesEncryptionIntegrityChecksFailedExceptionMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_EncryptionIntegrityChecksFailedExceptionDetails> * / any */ trait EncryptionIntegrityChecksFailedException
    ...
    var name: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionIntegrityChecksFailedException
  }
  object EncryptionIntegrityChecksFailedException {
    ...
    extension [Self <: EncryptionIntegrityChecksFailedException](x: Self) {
      ...
      inline def setName(
        value: typingsJapgolly.awsSdkClientCodecommitNode.awsSdkClientCodecommitNodeStrings.EncryptionIntegrityChecksFailedException
