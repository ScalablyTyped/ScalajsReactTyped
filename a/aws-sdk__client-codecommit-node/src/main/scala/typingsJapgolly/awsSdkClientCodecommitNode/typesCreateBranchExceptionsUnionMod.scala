...
object typesCreateBranchExceptionsUnionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.awsSdkClientCodecommitNode.typesBranchNameExistsExceptionMod.BranchNameExistsException
  ...
  */
  ...
  object CreateBranchExceptionsUnion {
    ...
    inline def BranchNameExistsException(): typingsJapgolly.awsSdkClientCodecommitNode.typesBranchNameExistsExceptionMod.BranchNameExistsException = {
      val __obj = js.Dynamic.literal(name = "BranchNameExistsException")
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientCodecommitNode.typesBranchNameExistsExceptionMod.BranchNameExistsException]
    }
