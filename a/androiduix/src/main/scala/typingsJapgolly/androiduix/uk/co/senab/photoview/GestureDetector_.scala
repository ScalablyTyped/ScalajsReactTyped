...
import typingsJapgolly.androiduix.android.view.ScaleGestureDetector
import typingsJapgolly.androiduix.uk.co.senab.photoview.GestureDetector.OnGestureListener
