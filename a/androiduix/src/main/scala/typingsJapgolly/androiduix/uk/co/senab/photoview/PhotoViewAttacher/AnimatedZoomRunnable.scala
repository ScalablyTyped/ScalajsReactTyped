...
class AnimatedZoomRunnable protected () extends Runnable {
  def this(
    arg: typingsJapgolly.androiduix.uk.co.senab.photoview.PhotoViewAttacher,
    currentZoom: Double,
    targetZoom: Double,
    focalX: Double,
    focalY: Double
  ) = this()
  var _PhotoViewAttacher_this: typingsJapgolly.androiduix.uk.co.senab.photoview.PhotoViewAttacher = js.native
