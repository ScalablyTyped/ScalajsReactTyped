...
object ^ extends js.Object {
  ...
  def inflate(context: Context, xml: String): typingsJapgolly.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: String, root: ViewGroup): typingsJapgolly.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: HTMLElement): typingsJapgolly.androiduix.android.view.View = js.native
  def inflate(context: Context, xml: HTMLElement, root: ViewGroup): typingsJapgolly.androiduix.android.view.View = js.native
