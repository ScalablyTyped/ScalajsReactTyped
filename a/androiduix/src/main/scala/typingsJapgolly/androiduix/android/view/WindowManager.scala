...
object WindowManager extends js.Object {
  ...
  @js.native
  class LayoutParams ()
    extends typingsJapgolly.androiduix.android.widget.FrameLayout.LayoutParams {
    ...
    def copyFrom(o: typingsJapgolly.androiduix.android.view.WindowManager.LayoutParams): Double = js.native
