...
import typingsJapgolly.androiduix.android.app.AlertController.AlertParams.OnPrepareListViewListener
...
import typingsJapgolly.androiduix.android.content.DialogInterface.OnMultiChoiceClickListener
...
class AlertParams_ protected () extends js.Object {
  ...
  @JSName("apply")
  def apply(dialog: typingsJapgolly.androiduix.android.app.AlertController): Unit = js.native
