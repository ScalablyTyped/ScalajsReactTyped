...
class Window_ protected () extends js.Object {
  ...
  def getAttributes(): typingsJapgolly.androiduix.android.view.WindowManager.LayoutParams = js.native
  ...
  def setAttributes(a: typingsJapgolly.androiduix.android.view.WindowManager.LayoutParams): Unit = js.native
