...
import typingsJapgolly.androiduix.android.graphics.Path
import typingsJapgolly.androiduix.android.graphics.Rect
import typingsJapgolly.androiduix.android.text.Layout.Alignment
import typingsJapgolly.androiduix.android.text.Layout.Directions
...
object Layout extends js.Object {
  ...
  class Ellipsizer protected ()
    extends typingsJapgolly.std.String {
  ...
  - typingsJapgolly.std.String because Already inherited
  - typingsJapgolly.androiduix.android.text.Spanned because var conflicts: iterator. Inlined getSpans, getSpanStart, getSpanEnd, getSpanFlags, nextSpanTransition */ @js.native
