package typingsJapgolly.atomWatcher

import typingsJapgolly.atomWatcher.anon.PartialWatcherOptions
import typingsJapgolly.atomWatcher.anon.PartialWatcherSettings
import typingsJapgolly.atomWatcher.atomWatcherStrings.renamed
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.atomWatcher.atomWatcherStrings.created
    - typingsJapgolly.atomWatcher.atomWatcherStrings.modified
    - typingsJapgolly.atomWatcher.atomWatcherStrings.deleted
    - typingsJapgolly.atomWatcher.atomWatcherStrings.renamed
  */
  trait EntryAction extends StObject
  object EntryAction {
    
    inline def created: typingsJapgolly.atomWatcher.atomWatcherStrings.created = "created".asInstanceOf[typingsJapgolly.atomWatcher.atomWatcherStrings.created]
    
    inline def deleted: typingsJapgolly.atomWatcher.atomWatcherStrings.deleted = "deleted".asInstanceOf[typingsJapgolly.atomWatcher.atomWatcherStrings.deleted]
    
    inline def modified: typingsJapgolly.atomWatcher.atomWatcherStrings.modified = "modified".asInstanceOf[typingsJapgolly.atomWatcher.atomWatcherStrings.modified]
    
    inline def renamed: typingsJapgolly.atomWatcher.atomWatcherStrings.renamed = "renamed".asInstanceOf[typingsJapgolly.atomWatcher.atomWatcherStrings.renamed]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.atomWatcher.atomWatcherStrings.file
    - typingsJapgolly.atomWatcher.atomWatcherStrings.directory
    - typingsJapgolly.atomWatcher.atomWatcherStrings.symlink
    - typingsJapgolly.atomWatcher.atomWatcherStrings.unknown
  */
  trait EntryType extends StObject
  object EntryType {
    
    inline def directory: typingsJapgolly.atomWatcher.atomWatcherStrings.directory = "directory".asInstanceOf[typingsJapgolly.atomWatcher.atomWatcherStrings.directory]
    
    inline def file: typingsJapgolly.atomWatcher.atomWatcherStrings.file = "file".asInstanceOf[typingsJapgolly.atomWatcher.atomWatcherStrings.file]
    
    inline def symlink: typingsJapgolly.atomWatcher.atomWatcherStrings.symlink = "symlink".asInstanceOf[typingsJapgolly.atomWatcher.atomWatcherStrings.symlink]
    
    inline def unknown: typingsJapgolly.atomWatcher.atomWatcherStrings.unknown = "unknown".asInstanceOf[typingsJapgolly.atomWatcher.atomWatcherStrings.unknown]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.atomWatcher.mod.RenamedEvent
    - typingsJapgolly.atomWatcher.mod.OtherEvent
  */
  trait Event extends StObject
  object Event {
    
    inline def OtherEvent(action: Exclude[EntryAction, renamed], kind: EntryType, path: String): typingsJapgolly.atomWatcher.mod.OtherEvent = {
      val __obj = js.Dynamic.literal(action = action.asInstanceOf[js.Any], kind = kind.asInstanceOf[js.Any], path = path.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.atomWatcher.mod.OtherEvent]
    }
    
    inline def RenamedEvent(kind: EntryType, oldPath: String, path: String): typingsJapgolly.atomWatcher.mod.RenamedEvent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.atomWatcher.mod.RenamedEvent]
    }
  }
