...
import typingsJapgolly.airtable.libRunActionMod.Body
import typingsJapgolly.airtable.libRunActionMod.Callback
import typingsJapgolly.airtable.libRunActionMod.Params
...
object libBaseMod {
  ...
  /* static member */
  inline def createFunctor(airtable: typingsJapgolly.airtable.mod.^, baseId: String): AirtableBase = (^.asInstanceOf[js.Dynamic].applyDynamic("createFunctor")(airtable.asInstanceOf[js.Any], baseId.asInstanceOf[js.Any])).asInstanceOf[AirtableBase]
  
  @js.native
  trait Base extends StObject {
    
    val _airtable: typingsJapgolly.airtable.mod.^ = js.native
    
    def _checkStatusForError(statusCode: Double): Null | typingsJapgolly.airtable.libAirtableErrorMod.^ = js.native
    def _checkStatusForError(statusCode: Double, body: BaseBody): Null | typingsJapgolly.airtable.libAirtableErrorMod.^ = js.native
    
    def _getRequestHeaders(headers: StringDictionary[String]): StringDictionary[String] = js.native
    
    val _id: String = js.native
    
    def doCall[TFields /* <: FieldSet */](tableName: String): typingsJapgolly.airtable.libTableMod.^[TFields] = js.native
    ...
    def table[TFields /* <: FieldSet */](tableName: String): typingsJapgolly.airtable.libTableMod.^[TFields] = js.native
  }
