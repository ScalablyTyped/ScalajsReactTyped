...
import typingsJapgolly.airtable.airtableStrings.get
import typingsJapgolly.airtable.airtableStrings.post
import typingsJapgolly.airtable.libFieldSetMod.FieldSet
import typingsJapgolly.airtable.libQueryParamsMod.QueryParams
import typingsJapgolly.airtable.libRecordDataMod.RecordData
import typingsJapgolly.airtable.libRecordsMod.Records
...
object libTableMod {
  ...
  trait Table[TFields /* <: FieldSet */] extends StObject {
    ...
    val _base: typingsJapgolly.airtable.libBaseMod.^ = js.native
    ...
    def _selectRecords(): typingsJapgolly.airtable.libQueryMod.^[TFields] = js.native
    def _selectRecords(params: QueryParams[TFields]): typingsJapgolly.airtable.libQueryMod.^[TFields] = js.native
    ...
    def select(): typingsJapgolly.airtable.libQueryMod.^[TFields] = js.native
    def select(params: QueryParams[TFields]): typingsJapgolly.airtable.libQueryMod.^[TFields] = js.native
  ...
  type TableSelectRecord[TFields /* <: FieldSet */] = js.Function1[
    ...
    typingsJapgolly.airtable.libQueryMod.^[TFields]
  ]
}
