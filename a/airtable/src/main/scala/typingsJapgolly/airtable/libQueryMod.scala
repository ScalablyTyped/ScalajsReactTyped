...
import typingsJapgolly.airtable.anon.Direction
import typingsJapgolly.airtable.anon.Error
import typingsJapgolly.airtable.anon.Errors
...
object libQueryMod {
  ...
  open class ^[TFields /* <: FieldSet */] protected ()
    extends StObject
       with Query[TFields] {
    def this(table: typingsJapgolly.airtable.libTableMod.^[TFields], params: QueryParams[TFields]) = this()
  }
  @JSImport("airtable/lib/query", JSImport.Namespace)
  @js.native
  ...
  trait Query[TFields /* <: FieldSet */] extends StObject {
    ...
    val _table: typingsJapgolly.airtable.libTableMod.^[TFields] = js.native
