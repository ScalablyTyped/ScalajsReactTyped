...
import typingsJapgolly.airtable.anon.PickAirtableOptionsapiKey
import typingsJapgolly.airtable.anon.TypeofAirtableTable
import typingsJapgolly.airtable.anon.TypeofBase
import typingsJapgolly.airtable.libAirtableBaseMod.AirtableBase
import typingsJapgolly.airtable.libObjectMapMod.ObjectMap
import typingsJapgolly.airtable.libQueryParamsMod.QueryParams
import typingsJapgolly.airtable.libRecordMod.RecordJson
...
object mod {
  ...
  open class BaseCls protected ()
    extends typingsJapgolly.airtable.libBaseMod.^ {
    def this(airtable: typingsJapgolly.airtable.mod.^, baseId: String) = this()
  }
  ...
  def Base_ : TypeofBase & (Instantiable2[
    /* airtable */ typingsJapgolly.airtable.mod.^, 
    /* baseId */ String, 
    typingsJapgolly.airtable.libBaseMod.^
  ]) = js.native
  ...
  def Error: Instantiable3[
    ...
    /* message */ String, 
    /* statusCode */ Double, 
    typingsJapgolly.airtable.libAirtableErrorMod.^
  ] = js.native
  type Error = typingsJapgolly.airtable.libAirtableErrorMod.^
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("airtable", "Error")
  @js.native
  open class ErrorCls protected ()
    extends typingsJapgolly.airtable.libAirtableErrorMod.^ {
  ...
  def Record: Instantiable3[
    /* table */ typingsJapgolly.airtable.libTableMod.^[/* import warning: RewrittenClass.unapply cls was tparam TFields */ Any], 
    /* recordId */ String, 
    /* recordJson */ js.UndefOr[RecordJson], 
    typingsJapgolly.airtable.libRecordMod.^[typingsJapgolly.airtable.libFieldSetMod.FieldSet]
  ] = js.native
  type Record[TFields /* <: typingsJapgolly.airtable.libFieldSetMod.FieldSet */] = typingsJapgolly.airtable.libRecordMod.^[TFields]
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("airtable", "Record")
  @js.native
  open class RecordCls[TFields /* <: typingsJapgolly.airtable.libFieldSetMod.FieldSet */] protected ()
    extends typingsJapgolly.airtable.libRecordMod.^[TFields] {
    def this(
      table: typingsJapgolly.airtable.libTableMod.^[/* import warning: RewrittenClass.unapply cls was tparam TFields */ Any],
      recordId: String
    ) = this()
  ...
  def Table: TypeofAirtableTable & (Instantiable3[
    ...
    /* tableId */ String, 
    /* tableName */ String, 
    typingsJapgolly.airtable.libTableMod.^[typingsJapgolly.airtable.libFieldSetMod.FieldSet]
  ]) = js.native
  type Table[TFields /* <: typingsJapgolly.airtable.libFieldSetMod.FieldSet */] = typingsJapgolly.airtable.libTableMod.^[TFields]
  
  /* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
  @JSImport("airtable", "Table")
  @js.native
  open class TableCls[TFields /* <: typingsJapgolly.airtable.libFieldSetMod.FieldSet */] protected ()
    extends typingsJapgolly.airtable.libTableMod.^[TFields] {
    def this(base: typingsJapgolly.airtable.libBaseMod.^, tableId: String, tableName: String) = this()
  }
  ...
  type Attachment = typingsJapgolly.airtable.libAttachmentMod.Attachment
  
  type Collaborator = typingsJapgolly.airtable.libCollaboratorMod.Collaborator
  
  type CustomHeaders = ObjectMap[String, String | Double | Boolean]
  
  type FieldSet = typingsJapgolly.airtable.libFieldSetMod.FieldSet
  
  type Query[TFields /* <: typingsJapgolly.airtable.libFieldSetMod.FieldSet */] = typingsJapgolly.airtable.libQueryMod.^[TFields]
  
  type RecordData[TFields /* <: typingsJapgolly.airtable.libFieldSetMod.FieldSet */] = typingsJapgolly.airtable.libRecordDataMod.RecordData[TFields]
  
  type Records[TFields /* <: typingsJapgolly.airtable.libFieldSetMod.FieldSet */] = typingsJapgolly.airtable.libRecordsMod.Records[TFields]
  
  type SelectOptions[TFields] = QueryParams[TFields]
  
  type Thumbnail = typingsJapgolly.airtable.libThumbnailMod.Thumbnail
}
