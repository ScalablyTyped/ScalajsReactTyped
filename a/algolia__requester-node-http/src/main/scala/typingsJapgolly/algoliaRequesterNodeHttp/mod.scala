package typingsJapgolly.algoliaRequesterNodeHttp
...
object mod {
  ...
  trait NodeHttpRequesterOptions extends StObject {
    ...
    var agent: js.UndefOr[Agent | typingsJapgolly.node.httpMod.Agent] = js.undefined
    
    var httpAgent: js.UndefOr[typingsJapgolly.node.httpMod.Agent] = js.undefined
  ...
  object NodeHttpRequesterOptions {
    ...
    extension [Self <: NodeHttpRequesterOptions](x: Self) {
      ...
      inline def setAgent(value: Agent | typingsJapgolly.node.httpMod.Agent): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
      
      inline def setAgentUndefined: Self = StObject.set(x, "agent", js.undefined)
      
      inline def setHttpAgent(value: typingsJapgolly.node.httpMod.Agent): Self = StObject.set(x, "httpAgent", value.asInstanceOf[js.Any])
