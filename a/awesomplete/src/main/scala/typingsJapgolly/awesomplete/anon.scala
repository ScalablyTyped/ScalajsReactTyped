...
object anon {
  ...
  object Replace {
    ...
    inline def apply(replace: (js.RegExp, String) => Callback): Replace = {
      val __obj = js.Dynamic.literal(replace = js.Any.fromFunction2((t0: js.RegExp, t1: String) => (replace(t0, t1)).runNow()))
      __obj.asInstanceOf[Replace]
    }
    
    extension [Self <: Replace](x: Self) {
      
      inline def setReplace(value: (js.RegExp, String) => Callback): Self = StObject.set(x, "replace", js.Any.fromFunction2((t0: js.RegExp, t1: String) => (value(t0, t1)).runNow()))
    }
  }
