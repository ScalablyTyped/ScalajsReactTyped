...
import typingsJapgolly.awesomplete.anon.Label
import typingsJapgolly.awesomplete.anon.Replace
import typingsJapgolly.awesomplete.anon.Value
...
object mod {
  ...
  /* static member */
  inline def $(expr: String): NodeList[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("$$")(expr.asInstanceOf[js.Any]).asInstanceOf[NodeList[Node]]
  inline def $(expr: String, con: Any): NodeList[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("$$")(expr.asInstanceOf[js.Any], con.asInstanceOf[js.Any])).asInstanceOf[NodeList[Node]]
  inline def $(expr: ParentNode): NodeList[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("$$")(expr.asInstanceOf[js.Any]).asInstanceOf[NodeList[Node]]
  inline def $(expr: ParentNode, con: Any): NodeList[Node] = (^.asInstanceOf[js.Dynamic].applyDynamic("$$")(expr.asInstanceOf[js.Any], con.asInstanceOf[js.Any])).asInstanceOf[NodeList[Node]]
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setReplace(value: /* suggestion */ String | Suggestion => Callback): Self = StObject.set(x, "replace", js.Any.fromFunction1((t0: /* suggestion */ String | Suggestion) => value(t0).runNow()))
