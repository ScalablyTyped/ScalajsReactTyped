...
import typingsJapgolly.awesomplete.AnonCall
...
object ^ extends js.Object {
  ...
  @JSName("$")
  def $(expr: typingsJapgolly.std.Element): String | Element = js.native
  @JSName("$")
  def $(expr: typingsJapgolly.std.Element, con: ParentNode): String | Element = js.native
  ...
  @JSName("$$")
  def DollarDollar(expr: typingsJapgolly.std.ParentNode): NodeList = js.native
  @JSName("$$")
  def DollarDollar(expr: typingsJapgolly.std.ParentNode, con: js.Any): NodeList = js.native
