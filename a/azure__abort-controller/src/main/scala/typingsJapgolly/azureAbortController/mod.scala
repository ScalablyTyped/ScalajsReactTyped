package typingsJapgolly.azureAbortController

import typingsJapgolly.azureAbortController.typesSrcAbortSignalMod.AbortSignalLike
import typingsJapgolly.azureAbortController.typesSrcAbortSignalMod.AbortSignal_
...
object mod {
  ...
  open class AbortController ()
    extends typingsJapgolly.azureAbortController.typesSrcAbortControllerMod.AbortController {
    /**
      * @param parentSignals - The AbortSignals that will signal aborted on the AbortSignal associated with this controller.
      */
  ...
  open class AbortError ()
    extends typingsJapgolly.azureAbortController.typesSrcAbortControllerMod.AbortError {
