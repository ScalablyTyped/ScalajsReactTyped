package typingsJapgolly.azureCoreHttpCompat
...
import typingsJapgolly.azureCoreClient.mod.CommonClientOptions
import typingsJapgolly.azureCoreClient.mod.ServiceClient
import typingsJapgolly.azureCoreClient.mod.ServiceClientOptions
import typingsJapgolly.azureCoreHttpCompat.anon.PreserveCase
import typingsJapgolly.azureCoreRestPipeline.typesLatestCoreRestPipelineMod.HttpMethods
...
object mod {
  ...
  trait CompatResponse extends StObject {
    ...
    var readableStreamBody: js.UndefOr[typingsJapgolly.node.NodeJS.ReadableStream] = js.undefined
  ...
  object CompatResponse {
    ...
    extension [Self <: CompatResponse](x: Self) {
      ...
      inline def setReadableStreamBody(value: typingsJapgolly.node.NodeJS.ReadableStream): Self = StObject.set(x, "readableStreamBody", value.asInstanceOf[js.Any])
  ...
  - typingsJapgolly.azureCoreHttpCompat.mod.ExtendedClientOptions because var conflicts: redirectOptions. Inlined keepAliveOptions */ trait ExtendedCommonClientOptions
    extends StObject
  ...
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.azureCoreHttpCompat.mod.ExtendedClientOptions because var conflicts: redirectOptions. Inlined keepAliveOptions */ trait ExtendedServiceClientOptions
    extends StObject
