...
import typingsJapgolly.autoSni.anon.Http
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setDomainsCallbackTo(value: CallbackTo[DomainList | js.Promise[DomainList]]): Self = StObject.set(x, "domains", value.toJsFn)
