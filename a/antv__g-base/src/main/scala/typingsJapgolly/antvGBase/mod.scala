...
import typingsJapgolly.antvGBase.libAbstractCanvasMod.default
import typingsJapgolly.antvGBase.libAnimateRegisterMod.EaseFn
import typingsJapgolly.antvGBase.libInterfacesMod.IBase
import typingsJapgolly.antvGBase.libTypesMod.CanvasCfg
...
object mod {
  ...
  open class AbstractGroup ()
    extends typingsJapgolly.antvGBase.libAbstractGroupMod.default
  
  /* note: abstract class */ @JSImport("@antv/g-base", "AbstractShape")
  @js.native
  open class AbstractShape protected ()
    extends typingsJapgolly.antvGBase.libAbstractShapeMod.default {
  ...
  open class Event protected ()
    extends typingsJapgolly.antvGBase.libEventGraphEventMod.default {
