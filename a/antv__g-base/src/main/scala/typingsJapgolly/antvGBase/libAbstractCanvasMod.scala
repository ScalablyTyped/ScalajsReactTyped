...
import typingsJapgolly.antvGBase.anon.X
import typingsJapgolly.antvGBase.libTypesMod.CanvasCfg
import typingsJapgolly.antvGBase.libTypesMod.Cursor
import typingsJapgolly.antvGBase.libTypesMod.Point
import typingsJapgolly.antvGBase.libTypesMod.Renderer
...
object libAbstractCanvasMod {
  ...
  - typingsJapgolly.antvGBase.libInterfacesMod.ICanvas because var conflicts: cfg, destroyed. Inlined getRenderer, getCursor, setCursor, changeSize, getPointByEvent, getClientByEvent, getPointByClient, getClientByPoint, draw */ @js.native
  trait Canvas
