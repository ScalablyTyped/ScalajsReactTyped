...
import typingsJapgolly.antvGBase.anon.Height
...
object libAbstractShapeMod {
  
  /* note: abstract class */ @JSImport("@antv/g-base/lib/abstract/shape", JSImport.Default)
  @js.native
  open class default protected () extends AbstractShape {
  ...
  - typingsJapgolly.antvGBase.libInterfacesMod.IShape because var conflicts: cfg, destroyed. Inlined isHit, isClipShape */ @js.native
  trait AbstractShape
