...
import typingsJapgolly.apolloEngineReportingProtobuf.apolloEngineReportingProtobufStrings.index
import typingsJapgolly.apolloEngineReportingProtobuf.apolloEngineReportingProtobufStrings.responseName
