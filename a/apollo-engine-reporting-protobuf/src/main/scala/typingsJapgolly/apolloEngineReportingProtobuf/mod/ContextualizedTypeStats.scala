...
import typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.IContextualizedTypeStats
...
class ContextualizedTypeStats ()
  extends typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats {
...
object ContextualizedTypeStats extends js.Object {
  /**
    ...
    */
  def create(): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def create(properties: IContextualizedTypeStats): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Reader, length: Double): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Uint8Array): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def decode(reader: Uint8Array, length: Double): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  def decodeDelimited(reader: Uint8Array): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  /**
  ...
  /**
    ...
    * @returns ContextualizedTypeStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats = js.native
  /**
    ...
    */
  def toObject(message: typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedTypeStats,
