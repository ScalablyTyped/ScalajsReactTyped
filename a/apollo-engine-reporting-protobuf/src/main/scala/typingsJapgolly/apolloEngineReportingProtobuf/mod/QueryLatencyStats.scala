...
import typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.IQueryLatencyStats
...
class QueryLatencyStats ()
  extends typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats {
...
object QueryLatencyStats extends js.Object {
  /**
    ...
    */
  def create(): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def create(properties: IQueryLatencyStats): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def decode(reader: Reader, length: Double): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def decode(reader: Uint8Array): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def decode(reader: Uint8Array, length: Double): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  def decodeDelimited(reader: Uint8Array): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  /**
  ...
  /**
    ...
    * @returns QueryLatencyStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats = js.native
  /**
    ...
    */
  def toObject(message: typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.QueryLatencyStats,
