...
import typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.IContextualizedQueryLatencyStats
...
class ContextualizedQueryLatencyStats ()
  extends typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats {
...
object ContextualizedQueryLatencyStats extends js.Object {
  /**
    ...
    */
  def create(): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def create(properties: IContextualizedQueryLatencyStats): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Reader, length: Double): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Uint8Array): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decode(reader: Uint8Array, length: Double): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  def decodeDelimited(reader: Uint8Array): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
  ...
  /**
    ...
    * @returns ContextualizedQueryLatencyStats
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats = js.native
  /**
    ...
    */
  def toObject(message: typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.ContextualizedQueryLatencyStats,
