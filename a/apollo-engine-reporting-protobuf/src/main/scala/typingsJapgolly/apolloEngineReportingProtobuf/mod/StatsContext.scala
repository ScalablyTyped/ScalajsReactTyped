...
import typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.IStatsContext
...
/**
  ...
  */
class StatsContext ()
  extends typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext {
...
object StatsContext extends js.Object {
  /**
    ...
    */
  def create(): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  def create(properties: IStatsContext): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  /**
    ...
    */
  def decode(reader: Reader): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  def decode(reader: Reader, length: Double): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  def decode(reader: Uint8Array): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  def decode(reader: Uint8Array, length: Double): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  /**
    ...
    * @throws {$protobuf.util.ProtocolError} If required fields are missing
    */
  def decodeDelimited(reader: Reader): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  def decodeDelimited(reader: Uint8Array): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  /**
  ...
  /**
    ...
    * @returns StatsContext
    */
  def fromObject(`object`: StringDictionary[js.Any]): typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext = js.native
  /**
    ...
    */
  def toObject(message: typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext): StringDictionary[js.Any] = js.native
  def toObject(
    message: typingsJapgolly.apolloEngineReportingProtobuf.protobufMod.StatsContext,
