package typingsJapgolly.amapJsApiLineSearch
...
import typingsJapgolly.amapJsApiLineSearch.AMap.LineSearch.SearchResult
import typingsJapgolly.amapJsApiLineSearch.AMap.LineSearch.SearchStatus
...
import typingsJapgolly.amapJsApiLineSearch.anon.Info
...
object AMap {
  ...
  object LineSearch {
    ...
    trait EventMap extends StObject {
      ...
      var error: Event_[typingsJapgolly.amapJsApiLineSearch.amapJsApiLineSearchStrings.error, Info]
    }
    object EventMap {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.amapJsApiLineSearch.AMap.LineSearch.LineInfoBase
      - typingsJapgolly.amapJsApiLineSearch.AMap.LineSearch.LineInfoExt
    */
    ...
    object LineInfo {
      ...
      inline def LineInfoBase(
        ...
        __obj.asInstanceOf[typingsJapgolly.amapJsApiLineSearch.AMap.LineSearch.LineInfoBase]
      }
      ...
      inline def LineInfoExt(
        ...
        __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.amapJsApiLineSearch.AMap.LineSearch.LineInfoExt]
      }
    }
    ...
    - typingsJapgolly.amapJsApiLineSearch.AMap.LineSearch.LineInfo because Already inherited */ trait LineInfoExt
      extends StObject
         with LineInfoBase {
    ...
    */
    ...
    object SearchStatus {
      ...
      inline def complete: typingsJapgolly.amapJsApiLineSearch.amapJsApiLineSearchStrings.complete = "complete".asInstanceOf[typingsJapgolly.amapJsApiLineSearch.amapJsApiLineSearchStrings.complete]
      
      inline def error: typingsJapgolly.amapJsApiLineSearch.amapJsApiLineSearchStrings.error = "error".asInstanceOf[typingsJapgolly.amapJsApiLineSearch.amapJsApiLineSearchStrings.error]
      
      inline def no_data: typingsJapgolly.amapJsApiLineSearch.amapJsApiLineSearchStrings.no_data = "no_data".asInstanceOf[typingsJapgolly.amapJsApiLineSearch.amapJsApiLineSearchStrings.no_data]
    }
  }
}
