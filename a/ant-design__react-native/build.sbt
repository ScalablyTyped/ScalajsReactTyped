...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "react-native-collapsible" % "1.6.0-535749",
  "org.scalablytyped.japgolly" %%% "react-native-gesture-handler" % "2.7.1-7e480b",
  "org.scalablytyped.japgolly" %%% "react-native-modal-popover" % "2.1.0-432fc5",
  "org.scalablytyped.japgolly" %%% "react-native-picker__picker" % "2.4.8-b442ae",
