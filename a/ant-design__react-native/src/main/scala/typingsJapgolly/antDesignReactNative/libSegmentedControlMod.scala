...
object libSegmentedControlMod {
  
  /* was `typeof SegmentedIOS` */
  @JSImport("@ant-design/react-native/lib/segmented-control", JSImport.Default)
  @js.native
  open class default ()
    extends typingsJapgolly.antDesignReactNative.libSegmentedControlSegmentedDotiosMod.default
  /* static members */
  object default {
  ...
  /* was `typeof SegmentedIOS` */
  type _default = typingsJapgolly.antDesignReactNative.libSegmentedControlSegmentedDotiosMod.default
}
