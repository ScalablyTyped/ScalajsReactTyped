package typingsJapgolly.antDesignReactNative.buttonMod
...
import typingsJapgolly.antDesignReactNative.buttonStyleMod.ButtonStyles
...
- typingsJapgolly.antDesignReactNative.propsTypeMod.ButtonPropsType because var conflicts: disabled. Inlined `type`, size, loading */ trait ButtonProps
...
object ButtonProps {
  ...
  def apply(
    ...
    onPress: /* _ */ js.UndefOr[js.Any] => Callback = null,
    ...
    if (onPress != null) __obj.updateDynamic("onPress")(js.Any.fromFunction1((t0: /* _ */ js.UndefOr[js.Any]) => onPress(t0).runNow()))
