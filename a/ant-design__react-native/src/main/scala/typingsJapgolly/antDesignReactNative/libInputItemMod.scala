...
import typingsJapgolly.antDesignReactNative.anon.Clear
...
import typingsJapgolly.antDesignReactNative.libInputItemPropsTypeMod.InputItemPropsType
...
object libInputItemMod {
  ...
  object default {
    ...
    @JSImport("@ant-design/react-native/lib/input-item", "default.defaultProps")
    @js.native
  ...
  @js.native
  trait InputItem extends Component[InputItemProps, InputItemState, Any] {
    
    def focus(): Unit = js.native
    
    var inputRef: typingsJapgolly.antDesignReactNative.libInputItemInputMod.default | Null = js.native
  ...
  object InputItemProps {
    ...
    extension [Self <: InputItemProps](x: Self) {
      ...
      inline def setKeyboardAppearance(value: typingsJapgolly.antDesignReactNative.antDesignReactNativeStrings.default | light | dark): Self = StObject.set(x, "keyboardAppearance", value.asInstanceOf[js.Any])
  ...
  trait InputItemState extends StObject {
    
    var focus: Boolean
  }
  object InputItemState {
    
    inline def apply(focus: Boolean): InputItemState = {
