...
object libTextareaItemPropsTypeMod {
  ...
  object TextAreaItemPropsType {
    ...
    extension [Self <: TextAreaItemPropsType](x: Self) {
      ...
      inline def setOnChange(value: /* val */ js.UndefOr[String] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* val */ js.UndefOr[String]) => value(t0).runNow()))
