...
object libDatePickerDatepickerDatePickerPropsMod {
  ...
  object DatePickerProps {
    ...
    extension [Self <: DatePickerProps](x: Self) {
      ...
      inline def setOnDateChange(value: /* date */ Any => Callback): Self = StObject.set(x, "onDateChange", js.Any.fromFunction1((t0: /* date */ Any) => value(t0).runNow()))
      
      inline def setOnDateChangeUndefined: Self = StObject.set(x, "onDateChange", js.undefined)
      
      inline def setOnScrollChange(value: (/* date */ Any, /* vals */ Any, /* index */ Double) => Callback): Self = StObject.set(x, "onScrollChange", js.Any.fromFunction3((t0: /* date */ Any, t1: /* vals */ Any, t2: /* index */ Double) => (value(t0, t1, t2)).runNow()))
