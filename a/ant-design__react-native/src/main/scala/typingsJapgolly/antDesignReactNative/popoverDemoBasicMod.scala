...
import typingsJapgolly.antDesignReactNative.antDesignReactNativeStrings.Popover
import typingsJapgolly.antDesignReactNative.antDesignReactNativeStrings.`Popover example`
