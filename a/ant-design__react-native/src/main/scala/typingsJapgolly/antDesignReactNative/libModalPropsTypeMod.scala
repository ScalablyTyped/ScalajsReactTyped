...
object libModalPropsTypeMod {
  ...
  object Action {
    ...
    extension [Self <: Action[?], T](x: Self & Action[T]) {
      ...
      inline def setOnPress(value: CallbackTo[Unit | js.Promise[Any]]): Self = StObject.set(x, "onPress", value.toJsFn)
  ...
  object ModalPropsType {
    ...
    extension [Self <: ModalPropsType[?], T](x: Self & ModalPropsType[T]) {
      ...
      inline def setOnAnimationEnd(value: /* visible */ Boolean => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onAnimationEnd", js.Any.fromFunction1((t0: /* visible */ Boolean) => value(t0).runNow()))
