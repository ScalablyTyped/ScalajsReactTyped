...
import typingsJapgolly.antDesignReactNative.antDesignReactNativeStrings.ActionSheet
import typingsJapgolly.antDesignReactNative.antDesignReactNativeStrings.`ActionSheet example`
