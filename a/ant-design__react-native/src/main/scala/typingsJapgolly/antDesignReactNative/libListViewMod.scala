...
import typingsJapgolly.antDesignReactNative.anon.Refresh
...
object libListViewMod {
  ...
  trait ListViewProps[T]
    ...
    def renderItem(item: T, index: Double, separators: Highlight): Element | Null
  }
  object ListViewProps {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(onFetch = js.Any.fromFunction3((t0: Double, t1: js.Function2[/* rows */ js.Array[T], /* limit */ Double, Any], t2: js.Function0[Unit]) => (onFetch(t0, t1, t2)).runNow()), renderItem = js.Any.fromFunction3(renderItem))
    ...
    extension [Self <: ListViewProps[?], T](x: Self & ListViewProps[T]) {
      ...
      inline def setOnFetch(
        value: (Double, js.Function2[/* rows */ js.Array[T], /* limit */ Double, Any], js.Function0[Unit]) => Callback
      ): Self = StObject.set(x, "onFetch", js.Any.fromFunction3((t0: Double, t1: js.Function2[/* rows */ js.Array[T], /* limit */ Double, Any], t2: js.Function0[Unit]) => (value(t0, t1, t2)).runNow()))
      
      inline def setRenderItem(value: (T, Double, Highlight) => Element | Null): Self = StObject.set(x, "renderItem", js.Any.fromFunction3(value))
    }
  }
