...
import typingsJapgolly.antDesignReactNative.anon.Max
...
object libStepperInputNumberMod {
  ...
  object InputNumberProps {
    ...
    extension [Self <: InputNumberProps](x: Self) {
      ...
      inline def setOnBlur(value: (/* e */ Any, /* repeated */ Any) => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction2((t0: /* e */ Any, t1: /* repeated */ Any) => (value(t0, t1)).runNow()))
