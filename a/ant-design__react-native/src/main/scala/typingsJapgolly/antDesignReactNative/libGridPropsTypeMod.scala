...
object libGridPropsTypeMod {
  ...
  object GridPropsType {
    ...
    extension [Self <: GridPropsType](x: Self) {
      ...
      inline def setOnPress(value: (/* dataItem */ js.UndefOr[DataItem], /* itemIndex */ Double) => Callback): Self = StObject.set(x, "onPress", js.Any.fromFunction2((t0: /* dataItem */ js.UndefOr[DataItem], t1: /* itemIndex */ Double) => (value(t0, t1)).runNow()))
