...
object libDatePickerLocaleSvSeMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/date-picker/locale/sv_Se", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/date-picker/locale/sv_Se", "default.DatePickerLocale")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/sv_Se", "default.dismissText")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/sv_Se", "default.extra")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/date-picker/locale/sv_Se", "default.okText")
    @js.native
