...
import typingsJapgolly.antDesignReactNative.anon.NativeEventContentSize
...
import typingsJapgolly.antDesignReactNative.libTextareaItemPropsTypeMod.TextAreaItemPropsType
