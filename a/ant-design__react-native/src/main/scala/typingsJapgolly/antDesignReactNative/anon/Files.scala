...
object Files {
  ...
  inline def apply(files: js.Array[scala.Nothing], onChange: Callback, onFail: Callback, selectable: Boolean): Files = {
    val __obj = js.Dynamic.literal(files = files.asInstanceOf[js.Any], onChange = onChange.toJsFn, onFail = onFail.toJsFn, selectable = selectable.asInstanceOf[js.Any])
