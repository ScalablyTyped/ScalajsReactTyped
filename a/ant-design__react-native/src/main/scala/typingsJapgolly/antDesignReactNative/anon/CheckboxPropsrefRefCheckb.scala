...
object CheckboxPropsrefRefCheckb {
  ...
  extension [Self <: CheckboxPropsrefRefCheckb](x: Self) {
    ...
    inline def setRefFunction1(value: CheckboxForwardedRef | Null => Callback): Self = StObject.set(x, "ref", js.Any.fromFunction1((t0: CheckboxForwardedRef | Null) => value(t0).runNow()))
