...
import typingsJapgolly.antDesignReactNative.libTabBarPropsTypeMod.TabBarProps
...
object libTabBarMod {
  ...
  object default {
    ...
    @js.native
    open class Item ()
      extends typingsJapgolly.antDesignReactNative.libTabBarTabBarItemMod.default
    /* static members */
    object Item {
  ...
  object TabBar {
    ...
    /* was `typeof TabBarItem` */
    type Item = typingsJapgolly.antDesignReactNative.libTabBarTabBarItemMod.default
  }
