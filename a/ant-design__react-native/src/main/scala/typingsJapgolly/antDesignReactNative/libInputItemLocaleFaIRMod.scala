...
object libInputItemLocaleFaIRMod {
  
  object default {
    
    @JSImport("@ant-design/react-native/lib/input-item/locale/fa_IR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/react-native/lib/input-item/locale/fa_IR", "default.backspaceLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/fa_IR", "default.cancelKeyboardLabel")
    @js.native
    ...
    @JSImport("@ant-design/react-native/lib/input-item/locale/fa_IR", "default.confirmLabel")
    @js.native
