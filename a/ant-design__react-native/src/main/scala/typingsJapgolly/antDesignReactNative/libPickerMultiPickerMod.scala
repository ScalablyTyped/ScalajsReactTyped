...
import typingsJapgolly.antDesignReactNative.anon.ComponentDidCatch
import typingsJapgolly.antDesignReactNative.anon.OnValueChange
import typingsJapgolly.antDesignReactNative.anon.Readonlydefault
...
object libPickerMultiPickerMod {
