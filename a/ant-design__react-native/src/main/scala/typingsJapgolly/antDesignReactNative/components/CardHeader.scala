...
import typingsJapgolly.antDesignReactNative.libCardCardHeaderMod.CardHeaderProps
import typingsJapgolly.antDesignReactNative.libCardCardHeaderMod.default
...
object CardHeader {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def styles(value: Partial[PickCardStyleheaderConten]): this.type = set("styles", value.asInstanceOf[js.Any])
