...
import typingsJapgolly.antDesignReactNative.libTextareaItemStyleMod.TextareaItemStyle
...
object TextareaItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignReactNative.mod.TextareaItem] {
    ...
    inline def onChange(value: /* val */ js.UndefOr[String] => Callback): this.type = set("onChange", js.Any.fromFunction1((t0: /* val */ js.UndefOr[String]) => value(t0).runNow()))
    ...
    inline def onContentSizeChange(
      value: (/* e */ Any) | (/* e */ NativeSyntheticEvent[TextInputContentSizeChangeEventData]) => Callback
    ): this.type = set("onContentSizeChange", js.Any.fromFunction1((t0: (/* e */ Any) | (/* e */ NativeSyntheticEvent[TextInputContentSizeChangeEventData])) => value(t0).runNow()))
    ...
    inline def onErrorClick(value: Callback): this.type = set("onErrorClick", value.toJsFn)
    ...
    inline def styles(value: Partial[TextareaItemStyle]): this.type = set("styles", value.asInstanceOf[js.Any])
