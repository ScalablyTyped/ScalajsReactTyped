...
import typingsJapgolly.antDesignReactNative.libSegmentedControlSegmentedDotandroidMod.SegmentControlProps
import typingsJapgolly.antDesignReactNative.libSegmentedControlSegmentedDotandroidMod.default
...
object SegmentedDotandroid {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def styles(value: Partial[SegmentControlStyle]): this.type = set("styles", value.asInstanceOf[js.Any])
