...
import typingsJapgolly.antDesignReactNative.libListListItemMod.BriefProps
...
object Brief {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignReactNative.libListListItemMod.Brief] {
    
    inline def style(value: StyleProp[TextStyle]): this.type = set("style", value.asInstanceOf[js.Any])
    
    inline def styleNull: this.type = set("style", null)
    
    inline def styles(value: Partial[PickListStyleBriefBriefTe]): this.type = set("styles", value.asInstanceOf[js.Any])
