...
import typingsJapgolly.antDesignReactNative.inputItemMod.InputItemProps
import typingsJapgolly.antDesignReactNative.inputItemStyleMod.InputItemStyle
...
object InputItem {
  def apply(
    ...
    InputItemProps, 
    typingsJapgolly.antDesignReactNative.inputItemMod.default, 
    Unit, 
    InputItemProps
  ] = {
  ...
  typingsJapgolly.antDesignReactNative.inputItemMod.InputItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignReactNative.inputItemMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignReactNative.inputItemMod.InputItemProps])(children: _*)
  }
