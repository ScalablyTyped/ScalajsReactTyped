...
import typingsJapgolly.antDesignReactNative.popupMod.PopupDatePickerProps
import typingsJapgolly.antDesignReactNative.popupMod.default
...
object Popup {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[PopupDatePickerProps, default, Unit, PopupDatePickerProps] = {
  ...
  typingsJapgolly.antDesignReactNative.popupMod.PopupDatePickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignReactNative.popupMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignReactNative.popupMod.PopupDatePickerProps])(children: _*)
  }
