...
import typingsJapgolly.antDesignReactNative.libSearchBarMod.SearchBarProps
...
object SearchBar {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignReactNative.mod.SearchBar] {
    ...
    inline def styles(value: PartialSearchBarStyle): this.type = set("styles", value.asInstanceOf[js.Any])
