...
import typingsJapgolly.antDesignReactNative.marqueeMod.default
...
object Marquee {
  ...
  typingsJapgolly.antDesignReactNative.marqueeMod.MarqueeProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignReactNative.marqueeMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignReactNative.marqueeMod.MarqueeProps])(children: _*)
  }
