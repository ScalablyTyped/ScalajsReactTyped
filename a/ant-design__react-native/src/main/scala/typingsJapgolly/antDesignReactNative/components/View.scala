...
import typingsJapgolly.antDesignReactNative.libViewMod.ViewInterface
...
object View {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignReactNative.mod.View] {
    ...
    inline def children(value: Node | ReactText): this.type = set("children", value.asInstanceOf[js.Any])
    ...
    inline def onTextLayout(value: ReactEventFrom[NodeHandle & org.scalajs.dom.Element] => Callback): this.type = set("onTextLayout", js.Any.fromFunction1((t0: ReactEventFrom[NodeHandle & org.scalajs.dom.Element]) => value(t0).runNow()))
    ...
    inline def style(value: StyleProp[TextStyle | ViewStyle]): this.type = set("style", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ViewInterface): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
