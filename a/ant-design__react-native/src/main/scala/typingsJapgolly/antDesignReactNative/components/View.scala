...
import typingsJapgolly.antDesignReactNative.viewMod.default
...
object View {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ViewProps, default, Unit, ViewProps] = {
  ...
  typingsJapgolly.antDesignReactNative.viewMod.default](this.componentImport)
