...
import typingsJapgolly.antDesignReactNative.nativePickerIosMod.default
...
import typingsJapgolly.reactNative.mod.PickerProps
...
object NativePickerDotios {
  ...
  typingsJapgolly.reactNative.mod.PickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignReactNative.nativePickerIosMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.PickerProps])(children: _*)
  }
