...
import typingsJapgolly.antDesignReactNative.libIconMod.IconNames
import typingsJapgolly.antDesignReactNative.libIconMod.IconProps
...
object Icon {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignReactNative.mod.Icon] {
