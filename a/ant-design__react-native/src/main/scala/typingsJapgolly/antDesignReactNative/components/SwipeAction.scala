...
import typingsJapgolly.antDesignReactNative.swipeActionMod.SwipeoutButtonProps
...
object SwipeAction {
  ...
  typingsJapgolly.antDesignReactNative.swipeActionMod.SwipeActionProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignReactNative.swipeActionMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignReactNative.swipeActionMod.SwipeActionProps])(children: _*)
  }
