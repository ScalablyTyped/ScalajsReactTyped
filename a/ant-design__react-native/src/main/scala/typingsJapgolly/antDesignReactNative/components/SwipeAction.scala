...
import typingsJapgolly.antDesignReactNative.libSwipeActionMod.SwipeActionProps
import typingsJapgolly.antDesignReactNative.libSwipeActionMod.SwipeoutButtonProps
...
object SwipeAction {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignReactNative.mod.SwipeAction] {
    ...
    inline def left(value: js.Array[SwipeoutButtonProps]): this.type = set("left", value.asInstanceOf[js.Any])
    
    inline def leftThreshold(value: Double): this.type = set("leftThreshold", value.asInstanceOf[js.Any])
    
    inline def leftVarargs(value: SwipeoutButtonProps*): this.type = set("left", js.Array(value*))
    ...
    inline def onSwipeableClose(value: Callback): this.type = set("onSwipeableClose", value.toJsFn)
    ...
    inline def onSwipeableOpen(value: Callback): this.type = set("onSwipeableOpen", value.toJsFn)
    ...
    inline def onSwipeableWillClose(value: Callback): this.type = set("onSwipeableWillClose", value.toJsFn)
    
    inline def onSwipeableWillOpen(value: Callback): this.type = set("onSwipeableWillOpen", value.toJsFn)
    ...
    inline def right(value: js.Array[SwipeoutButtonProps]): this.type = set("right", value.asInstanceOf[js.Any])
    
    inline def rightThreshold(value: Double): this.type = set("rightThreshold", value.asInstanceOf[js.Any])
    
    inline def rightVarargs(value: SwipeoutButtonProps*): this.type = set("right", js.Array(value*))
