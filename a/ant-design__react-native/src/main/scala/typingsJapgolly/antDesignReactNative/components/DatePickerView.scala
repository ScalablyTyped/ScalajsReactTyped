...
import typingsJapgolly.antDesignReactNative.libDatePickerViewPropsTypeMod.DatePickerProps
...
object DatePickerView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignReactNative.mod.DatePickerView] {
