...
import typingsJapgolly.antDesignReactNative.textMod.default
...
object Text {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextProps, default, Unit, TextProps] = {
  ...
  typingsJapgolly.reactNative.mod.TextProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignReactNative.textMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.reactNative.mod.TextProps])(children: _*)
  }
