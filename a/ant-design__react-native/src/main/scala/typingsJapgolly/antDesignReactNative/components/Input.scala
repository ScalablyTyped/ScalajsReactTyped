...
import typingsJapgolly.antDesignReactNative.inputMod.TextInputProps
...
object Input {
  def apply(
    ...
    TextInputProps, 
    typingsJapgolly.antDesignReactNative.inputMod.default, 
    Unit, 
    TextInputProps
  ] = {
  ...
  typingsJapgolly.antDesignReactNative.inputMod.TextInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignReactNative.inputMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignReactNative.inputMod.TextInputProps])(children: _*)
  }
