...
import typingsJapgolly.antDesignReactNative.libInputItemInputMod.TextInputProps
import typingsJapgolly.antDesignReactNative.libInputItemInputMod.default
