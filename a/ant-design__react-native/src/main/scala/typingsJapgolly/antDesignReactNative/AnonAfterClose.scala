...
object AnonAfterClose {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(closable = closable.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], selected = selected.asInstanceOf[js.Any], small = small.asInstanceOf[js.Any])
