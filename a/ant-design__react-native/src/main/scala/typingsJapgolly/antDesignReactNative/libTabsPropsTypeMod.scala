...
object libTabsPropsTypeMod {
  ...
  trait PropsType extends StObject {
    ...
    var renderUnderline: js.UndefOr[js.Function1[/* style */ Any, Node]] = js.undefined
  ...
  object PropsType {
    ...
    extension [Self <: PropsType](x: Self) {
      ...
      inline def setRenderUnderline(value: /* style */ Any => Node): Self = StObject.set(x, "renderUnderline", js.Any.fromFunction1(value))
