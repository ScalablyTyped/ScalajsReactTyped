...
trait ListViewProps[T] extends UltimateListViewProps {
  ...
  def renderItem(item: T, index: Double, separators: AnonHighlight): Element | Null
}
...
object ListViewProps {
  ...
  def apply[T](
    ...
    keyExtractor: (/* item */ T, /* index */ Double) => CallbackTo[String] = null,
    ...
    if (keyExtractor != null) __obj.updateDynamic("keyExtractor")(js.Any.fromFunction2((t0: /* item */ T, t1: /* index */ scala.Double) => keyExtractor(t0, t1).runNow()))
