...
import typingsJapgolly.antDesignReactNative.anon.NativeEvent
import typingsJapgolly.antDesignReactNative.anon.OnBlur
import typingsJapgolly.antDesignReactNative.anon.PartialSearchBarStyle
...
import typingsJapgolly.antDesignReactNative.libSearchBarPropsTypeMod.SearchBarState
...
object libSearchBarMod {
  ...
  object SearchBarProps {
    ...
    extension [Self <: SearchBarProps](x: Self) {
      ...
      inline def setOnCancel(value: /* value */ String => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
      ...
      inline def setOnClear(value: /* value */ String => Callback): Self = StObject.set(x, "onClear", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
