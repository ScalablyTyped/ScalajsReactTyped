...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "antv__g-plugin-svg-picker" % "1.7.17-ca4c16",
  "org.scalablytyped.japgolly" %%% "antv__g-plugin-svg-renderer" % "1.8.14-1581ef",
