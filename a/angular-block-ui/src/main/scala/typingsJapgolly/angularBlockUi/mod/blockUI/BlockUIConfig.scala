...
object BlockUIConfig {
  ...
  def apply(
    ...
    message: String = null,
    requestFilter: /* config */ IRequestConfig => CallbackTo[String | Boolean] = null,
    ...
    if (requestFilter != null) __obj.updateDynamic("requestFilter")(js.Any.fromFunction1((t0: /* config */ typingsJapgolly.angular.mod.IRequestConfig) => requestFilter(t0).runNow()))
