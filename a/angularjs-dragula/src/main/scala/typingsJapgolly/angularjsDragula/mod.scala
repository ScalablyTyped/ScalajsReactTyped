...
import typingsJapgolly.angular.mod.IAngularStatic
import typingsJapgolly.angular.mod.IScope
import typingsJapgolly.angularjsDragula.angularjsDragulaStrings.dragula
import typingsJapgolly.angularjsDragula.anon.ReadonlyBag
    ...
    object dragula {
      ...
      trait DragulaService extends StObject {
        ...
        /**
          ...
          */
        def add(scope: IScope, name: String, drake: Drake): Bag = js.native
