...
class TmplAstBoundAttribute protected ()
  extends typingsJapgolly.atAngularCompiler.publicUnderscoreApiMod.TmplAstBoundAttribute {
  def this(
    name: String,
    `type`: BindingType,
...
object TmplAstBoundAttribute extends js.Object {
  def fromBoundElementProperty(prop: typingsJapgolly.atAngularCompiler.srcExpressionUnderscoreParserAstMod.BoundElementProperty): BoundAttribute = js.native
  def fromBoundElementProperty(
    prop: typingsJapgolly.atAngularCompiler.srcExpressionUnderscoreParserAstMod.BoundElementProperty,
