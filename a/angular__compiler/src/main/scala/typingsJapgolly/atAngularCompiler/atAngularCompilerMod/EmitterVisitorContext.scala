...
class EmitterVisitorContext protected ()
  extends typingsJapgolly.atAngularCompiler.publicUnderscoreApiMod.EmitterVisitorContext {
...
object EmitterVisitorContext extends js.Object {
  def createRoot(): typingsJapgolly.atAngularCompiler.srcOutputAbstractUnderscoreEmitterMod.EmitterVisitorContext = js.native
}
