...
import typingsJapgolly.atAngularCompiler.Anon_Ctor
import typingsJapgolly.atAngularCompiler.Anon_FilePath
...
class StaticReflector protected ()
  extends typingsJapgolly.atAngularCompiler.publicUnderscoreApiMod.StaticReflector {
  def this(
    ...
    symbolResolver: typingsJapgolly.atAngularCompiler.srcAotStaticUnderscoreSymbolUnderscoreResolverMod.StaticSymbolResolver
  ) = this()
  def this(
    summaryResolver: typingsJapgolly.atAngularCompiler.srcSummaryUnderscoreResolverMod.SummaryResolver[typingsJapgolly.atAngularCompiler.srcAotStaticUnderscoreSymbolMod.StaticSymbol],
    symbolResolver: typingsJapgolly.atAngularCompiler.srcAotStaticUnderscoreSymbolUnderscoreResolverMod.StaticSymbolResolver,
