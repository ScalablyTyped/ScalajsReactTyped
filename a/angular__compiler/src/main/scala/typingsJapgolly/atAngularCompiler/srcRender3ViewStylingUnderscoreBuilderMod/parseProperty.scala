...
import typingsJapgolly.atAngularCompiler.Anon_HasOverrideFlag
...
@js.native
object parseProperty extends js.Object {
  def apply(name: String): Anon_HasOverrideFlag = js.native
}
