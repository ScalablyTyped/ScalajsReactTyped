...
object srcRender3ViewI18nContextMod extends js.Object {
  ...
  class I18nContext protected () extends js.Object {
    ...
    var bindings: Set[typingsJapgolly.atAngularCompiler.srcExpressionUnderscoreParserAstMod.AST] = js.native
    ...
    def appendBinding(binding: typingsJapgolly.atAngularCompiler.srcExpressionUnderscoreParserAstMod.AST): Unit = js.native
