...
object BindingForm extends js.Object {
  ...
  /* 0 */ val General: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreUtilExpressionUnderscoreConverterMod.BindingForm.General with Double = js.native
  /* 1 */ val TrySimple: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreUtilExpressionUnderscoreConverterMod.BindingForm.TrySimple with Double = js.native
  @JSBracketAccess
