...
object R3ResolvedDependencyType extends js.Object {
  ...
  /* 1 */ val Attribute: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3ResolvedDependencyType.Attribute with Double = js.native
  /* 2 */ val ChangeDetectorRef: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3ResolvedDependencyType.ChangeDetectorRef with Double = js.native
  /* 0 */ val Token: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3ResolvedDependencyType.Token with Double = js.native
  @JSBracketAccess
