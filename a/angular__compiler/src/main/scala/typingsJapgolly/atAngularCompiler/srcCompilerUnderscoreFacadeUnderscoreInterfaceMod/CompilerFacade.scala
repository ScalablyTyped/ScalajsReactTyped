...
import typingsJapgolly.atAngularCompiler.Anon_ResourceLoader
...
object CompilerFacade {
  ...
  def apply(
    ...
    __obj.updateDynamic("compileBase")(js.Any.fromFunction3((t0: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CoreEnvironment, t1: java.lang.String, t2: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3BaseMetadataFacade) => compileBase(t0, t1, t2).runNow()))
    __obj.updateDynamic("compileComponent")(js.Any.fromFunction3((t0: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CoreEnvironment, t1: java.lang.String, t2: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3ComponentMetadataFacade) => compileComponent(t0, t1, t2).runNow()))
    __obj.updateDynamic("compileDirective")(js.Any.fromFunction3((t0: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CoreEnvironment, t1: java.lang.String, t2: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3DirectiveMetadataFacade) => compileDirective(t0, t1, t2).runNow()))
    __obj.updateDynamic("compileInjectable")(js.Any.fromFunction3((t0: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CoreEnvironment, t1: java.lang.String, t2: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3InjectableMetadataFacade) => compileInjectable(t0, t1, t2).runNow()))
    __obj.updateDynamic("compileInjector")(js.Any.fromFunction3((t0: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CoreEnvironment, t1: java.lang.String, t2: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3InjectorMetadataFacade) => compileInjector(t0, t1, t2).runNow()))
    __obj.updateDynamic("compileNgModule")(js.Any.fromFunction3((t0: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CoreEnvironment, t1: java.lang.String, t2: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3NgModuleMetadataFacade) => compileNgModule(t0, t1, t2).runNow()))
    __obj.updateDynamic("compilePipe")(js.Any.fromFunction3((t0: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.CoreEnvironment, t1: java.lang.String, t2: typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreFacadeUnderscoreInterfaceMod.R3PipeMetadataFacade) => compilePipe(t0, t1, t2).runNow()))
