...
@JSImport("@angular/compiler/src/compiler", "templateJitUrl")
@js.native
object templateJitUrl extends js.Object {
  def apply(
    ngModuleType: CompileIdentifierMetadata,
    compMeta: typingsJapgolly.atAngularCompiler.srcCompileUnderscoreMetadataMod.CompileDirectiveMetadata
  ): String = js.native
}
