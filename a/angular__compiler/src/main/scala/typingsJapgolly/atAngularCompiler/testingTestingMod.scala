...
object testingTestingMod extends js.Object {
  ...
  class MockDirectiveResolver protected ()
    extends typingsJapgolly.atAngularCompiler.testingIndexMod.MockDirectiveResolver {
    def this(reflector: CompileReflector) = this()
  }
  
  @js.native
  class MockNgModuleResolver protected ()
    extends typingsJapgolly.atAngularCompiler.testingIndexMod.MockNgModuleResolver {
    def this(reflector: CompileReflector) = this()
  }
  
  @js.native
  class MockPipeResolver protected ()
    extends typingsJapgolly.atAngularCompiler.testingIndexMod.MockPipeResolver {
  ...
  class MockSchemaRegistry protected ()
    extends typingsJapgolly.atAngularCompiler.testingIndexMod.MockSchemaRegistry {
    def this(
