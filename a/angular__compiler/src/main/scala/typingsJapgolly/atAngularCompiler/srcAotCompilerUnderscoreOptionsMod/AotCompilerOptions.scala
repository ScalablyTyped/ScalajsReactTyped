package typingsJapgolly.atAngularCompiler.srcAotCompilerUnderscoreOptionsMod

import typingsJapgolly.atAngularCompiler.atAngularCompilerStrings.ngtsc
import typingsJapgolly.atAngularCompiler.atAngularCompilerStrings.tsc
