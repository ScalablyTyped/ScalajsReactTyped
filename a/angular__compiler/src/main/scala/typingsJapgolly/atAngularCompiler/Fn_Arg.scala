...
trait Fn_Arg extends js.Object {
  def apply[T](`this`: Visitor[_], arg: Expression): scala.Nothing = js.native
  def apply[T](`this`: Visitor[_], arg: Statement): scala.Nothing = js.native
  def apply[T](`this`: Visitor[_], arg: Node): scala.Nothing = js.native
}
