...
object testingMod extends js.Object {
  ...
  class MockDirectiveResolver protected ()
    extends typingsJapgolly.atAngularCompiler.testingTestingMod.MockDirectiveResolver {
    def this(reflector: CompileReflector) = this()
  }
  
  @js.native
  class MockNgModuleResolver protected ()
    extends typingsJapgolly.atAngularCompiler.testingTestingMod.MockNgModuleResolver {
    def this(reflector: CompileReflector) = this()
  }
  
  @js.native
  class MockPipeResolver protected ()
    extends typingsJapgolly.atAngularCompiler.testingTestingMod.MockPipeResolver {
  ...
  class MockSchemaRegistry protected ()
    extends typingsJapgolly.atAngularCompiler.testingTestingMod.MockSchemaRegistry {
    def this(
