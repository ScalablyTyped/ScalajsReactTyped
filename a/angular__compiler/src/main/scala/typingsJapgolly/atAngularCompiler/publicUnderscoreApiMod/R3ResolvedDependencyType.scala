...
@JSImport("@angular/compiler/public_api", "R3ResolvedDependencyType")
@js.native
object R3ResolvedDependencyType extends js.Object {
  ...
  def apply(value: Double): js.UndefOr[
    typingsJapgolly.atAngularCompiler.srcRender3R3UnderscoreFactoryMod.R3ResolvedDependencyType with Double
  ] = js.native
}
