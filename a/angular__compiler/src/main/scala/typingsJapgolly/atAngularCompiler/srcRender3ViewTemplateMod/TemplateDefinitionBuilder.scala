...
import typingsJapgolly.atAngularCompiler.srcCompilerUnderscoreUtilExpressionUnderscoreConverterMod.LocalResolver
...
import typingsJapgolly.atAngularCompiler.srcRender3R3UnderscoreAstMod.Icu
...
import typingsJapgolly.atAngularCompiler.srcRender3R3UnderscoreAstMod.Text
...
import typingsJapgolly.atAngularCompiler.srcRender3ViewI18nContextMod.I18nContext
...
class TemplateDefinitionBuilder protected ()
  ...
  def i18nAppendBindings(expressions: js.Array[typingsJapgolly.atAngularCompiler.srcExpressionUnderscoreParserAstMod.AST]): Unit = js.native
