...
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.CompilerFacade
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.CoreEnvironment
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.ParseSourceSpan
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.R3BaseMetadataFacade
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.R3ComponentMetadataFacade
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.R3DirectiveMetadataFacade
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.R3InjectableMetadataFacade
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.R3InjectorMetadataFacade
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.R3NgModuleMetadataFacade
import typingsJapgolly.angularCompiler.compilerFacadeInterfaceMod.R3PipeMetadataFacade
