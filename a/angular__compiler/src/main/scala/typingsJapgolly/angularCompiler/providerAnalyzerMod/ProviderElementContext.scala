...
import typingsJapgolly.angularCompiler.templateAstMod.AttrAst
import typingsJapgolly.angularCompiler.templateAstMod.DirectiveAst
...
import typingsJapgolly.angularCompiler.templateAstMod.ReferenceAst
