...
object testingTestingMod extends js.Object {
  ...
  class MockDirectiveResolver protected ()
    extends typingsJapgolly.angularCompiler.indexMod.MockDirectiveResolver {
    def this(reflector: CompileReflector) = this()
  }
  
  @js.native
  class MockNgModuleResolver protected ()
    extends typingsJapgolly.angularCompiler.indexMod.MockNgModuleResolver {
    def this(reflector: CompileReflector) = this()
  }
  
  @js.native
  class MockPipeResolver protected ()
    extends typingsJapgolly.angularCompiler.indexMod.MockPipeResolver {
  ...
  class MockSchemaRegistry protected ()
    extends typingsJapgolly.angularCompiler.indexMod.MockSchemaRegistry {
    def this(
