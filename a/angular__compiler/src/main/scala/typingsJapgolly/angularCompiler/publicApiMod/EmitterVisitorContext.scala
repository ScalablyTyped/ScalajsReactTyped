...
class EmitterVisitorContext protected ()
  extends typingsJapgolly.angularCompiler.srcCompilerMod.EmitterVisitorContext {
...
object EmitterVisitorContext extends js.Object {
  def createRoot(): typingsJapgolly.angularCompiler.abstractEmitterMod.EmitterVisitorContext = js.native
}
