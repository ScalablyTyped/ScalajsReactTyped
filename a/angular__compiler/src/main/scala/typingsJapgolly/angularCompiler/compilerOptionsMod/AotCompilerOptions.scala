package typingsJapgolly.angularCompiler.compilerOptionsMod

import typingsJapgolly.angularCompiler.angularCompilerStrings.ngtsc
import typingsJapgolly.angularCompiler.angularCompilerStrings.tsc
