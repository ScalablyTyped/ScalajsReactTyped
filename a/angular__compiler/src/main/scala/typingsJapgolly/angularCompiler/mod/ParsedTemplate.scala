...
trait ParsedTemplate extends StObject {
  ...
  /**
    ...
    * option is enabled.
    */
  var commentNodes: js.UndefOr[js.Array[org.scalajs.dom.Comment]] = js.undefined
...
object ParsedTemplate {
  ...
  extension [Self <: ParsedTemplate](x: Self) {
    ...
    inline def setCommentNodes(value: js.Array[org.scalajs.dom.Comment]): Self = StObject.set(x, "commentNodes", value.asInstanceOf[js.Any])
    
    inline def setCommentNodesUndefined: Self = StObject.set(x, "commentNodes", js.undefined)
    
    inline def setCommentNodesVarargs(value: org.scalajs.dom.Comment*): Self = StObject.set(x, "commentNodes", js.Array(value*))
