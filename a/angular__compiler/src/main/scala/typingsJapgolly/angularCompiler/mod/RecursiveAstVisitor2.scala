...
object RecursiveAstVisitor2 {
  ...
  inline def apply(
    visitAllExpressions: (js.Array[Expression], Any) => Callback,
    visitAllStatements: (js.Array[Statement], Any) => Callback,
