...
object ChangeDetectionStrategy extends StObject {
  ...
  /* 1 */ val Default: typingsJapgolly.angularCompiler.mod.ChangeDetectionStrategy.Default & Double = js.native
  
  @js.native
  sealed trait OnPush
    extends StObject
       with ChangeDetectionStrategy
  /* 0 */ val OnPush: typingsJapgolly.angularCompiler.mod.ChangeDetectionStrategy.OnPush & Double = js.native
}
