...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.angularCompiler.mod.R3ConstructorFactoryMetadata
  - typingsJapgolly.angularCompiler.mod.R3DelegatedFnOrClassMetadata
  - typingsJapgolly.angularCompiler.mod.R3ExpressionFactoryMetadata
*/
...
object R3FactoryMetadata {
  ...
  inline def R3ConstructorFactoryMetadata(
    ...
    __obj.asInstanceOf[typingsJapgolly.angularCompiler.mod.R3ConstructorFactoryMetadata]
  }
  ...
  inline def R3DelegatedFnOrClassMetadata(
    ...
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsJapgolly.angularCompiler.mod.R3DelegatedFnOrClassMetadata]
  }
  ...
  inline def R3ExpressionFactoryMetadata(
    ...
    __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsJapgolly.angularCompiler.mod.R3ExpressionFactoryMetadata]
  }
}
