...
object UnaryOperator extends StObject {
  ...
  sealed trait Minus
    extends StObject
       with UnaryOperator
  /* 0 */ val Minus: typingsJapgolly.angularCompiler.mod.UnaryOperator.Minus & Double = js.native
  
  @js.native
  sealed trait Plus
    extends StObject
       with UnaryOperator
  /* 1 */ val Plus: typingsJapgolly.angularCompiler.mod.UnaryOperator.Plus & Double = js.native
}
