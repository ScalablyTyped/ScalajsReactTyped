...
object TypeModifier extends StObject {
  ...
  sealed trait Const
    extends StObject
       with TypeModifier
  /* 1 */ val Const: typingsJapgolly.angularCompiler.mod.TypeModifier.Const & Double = js.native
  
  @js.native
  sealed trait None
    extends StObject
       with TypeModifier
  /* 0 */ val None: typingsJapgolly.angularCompiler.mod.TypeModifier.None & Double = js.native
}
