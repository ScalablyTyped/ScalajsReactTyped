...
import typingsJapgolly.angularCompiler.i18nAstMod.AST
...
object contextMod extends js.Object {
  ...
  class I18nContext protected () extends js.Object {
    ...
    var bindings: Set[typingsJapgolly.angularCompiler.astMod.AST] = js.native
    ...
    def appendBinding(binding: typingsJapgolly.angularCompiler.astMod.AST): Unit = js.native
