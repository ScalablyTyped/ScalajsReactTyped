...
package object compilerFacadeInterfaceMod {
  type ChangeDetectionStrategy = scala.Double
  type CoreEnvironment = org.scalablytyped.runtime.StringDictionary[js.Function]
