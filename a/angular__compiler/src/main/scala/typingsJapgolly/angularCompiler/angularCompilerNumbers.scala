...
import typingsJapgolly.angularCompiler.constantPoolMod.DefinitionKind
import typingsJapgolly.angularCompiler.coreMod.ArgumentType
import typingsJapgolly.angularCompiler.coreMod.AttributeMarker
import typingsJapgolly.angularCompiler.coreMod.BindingFlags
import typingsJapgolly.angularCompiler.coreMod.DepFlags
import typingsJapgolly.angularCompiler.coreMod.InjectFlags
import typingsJapgolly.angularCompiler.coreMod.NodeFlags
import typingsJapgolly.angularCompiler.coreMod.QueryBindingType
import typingsJapgolly.angularCompiler.coreMod.QueryValueType
import typingsJapgolly.angularCompiler.coreMod.RenderFlags
import typingsJapgolly.angularCompiler.coreMod.SelectorFlags
import typingsJapgolly.angularCompiler.coreMod.ViewFlags
