...
object BindingData {
  ...
  def apply(
    ...
    if (declareLocalCallback != null) __obj.updateDynamic("declareLocalCallback")(js.Any.fromFunction2((t0: /* scope */ typingsJapgolly.angularCompiler.templateMod.BindingScope, t1: /* relativeLevel */ scala.Double) => declareLocalCallback(t0, t1).runNow()))
