...
import typingsJapgolly.accedoAccedoOne.anon.Alpha2Code
import typingsJapgolly.accedoAccedoOne.anon.DeviceId
import typingsJapgolly.accedoAccedoOne.anon.Locales
import typingsJapgolly.accedoAccedoOne.anon.PickAccedoEntryParamsprev
import typingsJapgolly.accedoAccedoOne.anon.ReadonlyDetails
import typingsJapgolly.accedoAccedoOne.mod.AccedoLog.Level
import typingsJapgolly.accedoAccedoOne.mod.AccedoLog.Logobject
...
object mod {
  ...
  object AccedoConfig {
    ...
    extension [Self <: AccedoConfig](x: Self) {
      ...
      inline def setBrowserInfoProvider(value: CallbackTo[DeviceId]): Self = StObject.set(x, "browserInfoProvider", value.toJsFn)
      ...
      inline def setOnDeviceIdGenerated(value: /* deviceId */ String => Callback): Self = StObject.set(x, "onDeviceIdGenerated", js.Any.fromFunction1((t0: /* deviceId */ String) => value(t0).runNow()))
      
      inline def setOnDeviceIdGeneratedUndefined: Self = StObject.set(x, "onDeviceIdGenerated", js.undefined)
      
      inline def setOnSessionKeyChanged(value: /* sessionKey */ String => Callback): Self = StObject.set(x, "onSessionKeyChanged", js.Any.fromFunction1((t0: /* sessionKey */ String) => value(t0).runNow()))
