...
import typingsJapgolly.ansiStyles.mod.BackgroundColorName
import typingsJapgolly.ansiStyles.mod.ForegroundColorName
import typingsJapgolly.ansiStyles.mod.ModifierName
