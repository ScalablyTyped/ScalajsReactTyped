...
import typingsJapgolly.ajv.distTypesMod.EvaluatedItems
import typingsJapgolly.ajv.distTypesMod.EvaluatedProperties
...
object distCompileUtilMod {
  ...
  object Type extends StObject {
    ...
    sealed trait Num
      extends StObject
         with Type
    /* 0 */ val Num: typingsJapgolly.ajv.distCompileUtilMod.Type.Num & Double = js.native
    
    @js.native
    sealed trait Str
      extends StObject
         with Type
    /* 1 */ val Str: typingsJapgolly.ajv.distCompileUtilMod.Type.Str & Double = js.native
  }
  ...
  inline def useFunc(gen: CodeGen, f: typingsJapgolly.ajv.anon.Code): Name = (^.asInstanceOf[js.Dynamic].applyDynamic("useFunc")(gen.asInstanceOf[js.Any], f.asInstanceOf[js.Any])).asInstanceOf[Name]
