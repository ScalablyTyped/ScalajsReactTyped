...
import typingsJapgolly.ajv.ajvStrings.date
...
import typingsJapgolly.ajv.anon.PartialErrorObjectstringR
...
import typingsJapgolly.ajv.distCompileRulesMod.ValidationRules
import typingsJapgolly.ajv.distTypesJsonSchemaMod.JSONSchemaType
import typingsJapgolly.ajv.distTypesJtdSchemaMod.JTDDataType
import typingsJapgolly.ajv.distTypesJtdSchemaMod.JTDSchemaType
import typingsJapgolly.ajv.distTypesJtdSchemaMod.SomeJTDSchemaType
...
import typingsJapgolly.ajv.distTypesMod.AnyValidateFunction
import typingsJapgolly.ajv.distTypesMod.AsyncSchema
import typingsJapgolly.ajv.distTypesMod.AsyncValidateFunction
...
import typingsJapgolly.ajv.distTypesMod.RegExpEngine
import typingsJapgolly.ajv.distTypesMod.RegExpLike
import typingsJapgolly.ajv.distTypesMod.Schema
import typingsJapgolly.ajv.distTypesMod.SchemaObject
import typingsJapgolly.ajv.distTypesMod.UriResolver
...
object distCoreMod {
  ...
  object default {
    ...
    def MissingRefError: Instantiable4[
        ...
        typingsJapgolly.ajv.distCompileRefErrorMod.default
      ] = js.native
    ...
    def ValidationError: Instantiable1[
        ...
        typingsJapgolly.ajv.distRuntimeValidationErrorMod.default
      ] = js.native
  ...
  trait Ajv extends StObject {
    ...
    @JSName("compile")
    def compile_NT_ValidateFunction[N /* <: scala.Nothing */, T /* <: SomeJTDSchemaType */](schema: T): ValidateFunction[JTDDataType[T]] = js.native
    @JSName("compile")
    def compile_NT_ValidateFunction[N /* <: scala.Nothing */, T /* <: SomeJTDSchemaType */](schema: T, _meta: Boolean): ValidateFunction[JTDDataType[T]] = js.native
    @JSName("compile")
    def compile_T_ValidateFunction[T](schema: Schema): ValidateFunction[T] = js.native
    @JSName("compile")
    def compile_T_ValidateFunction[T](schema: Schema, _meta: Boolean): ValidateFunction[T] = js.native
    ...
    val scope: typingsJapgolly.ajv.distCompileCodegenMod.ValueScope = js.native
