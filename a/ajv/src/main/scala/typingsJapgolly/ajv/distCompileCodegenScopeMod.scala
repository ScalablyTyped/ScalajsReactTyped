...
import typingsJapgolly.ajv.distCompileCodegenCodeMod.Name
...
object distCompileCodegenScopeMod {
  ...
  object UsedValueState extends StObject {
    ...
    sealed trait Completed
      extends StObject
         with UsedValueState
    /* 1 */ val Completed: typingsJapgolly.ajv.distCompileCodegenScopeMod.UsedValueState.Completed & Double = js.native
    
    @js.native
    sealed trait Started
      extends StObject
         with UsedValueState
    /* 0 */ val Started: typingsJapgolly.ajv.distCompileCodegenScopeMod.UsedValueState.Started & Double = js.native
  }
