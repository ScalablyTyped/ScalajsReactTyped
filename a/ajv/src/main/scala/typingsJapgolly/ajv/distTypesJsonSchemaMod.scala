...
import typingsJapgolly.ajv.anon.AllOf
import typingsJapgolly.ajv.anon.AnyOf
import typingsJapgolly.ajv.anon.Dictkeyword
import typingsJapgolly.ajv.anon.OneOf
import typingsJapgolly.ajv.anon.TypeArray
...
object distTypesJsonSchemaMod {
  ...
  type JSONSchemaType[T] = StrictNullChecksWrapper[typingsJapgolly.ajv.ajvStrings.JSONSchemaType, UncheckedJSONSchemaType[T, `false`]]
  ...
  type PartialSchema[T] = StrictNullChecksWrapper[typingsJapgolly.ajv.ajvStrings.PartialSchema, UncheckedPartialSchema[T]]
  
  type PropertiesSchema[T] = StrictNullChecksWrapper[typingsJapgolly.ajv.ajvStrings.PropertiesSchema, UncheckedPropertiesSchema[T]]
  
  type RequiredMembers[T] = StrictNullChecksWrapper[typingsJapgolly.ajv.ajvStrings.RequiredMembers, UncheckedRequiredMembers[T]]
