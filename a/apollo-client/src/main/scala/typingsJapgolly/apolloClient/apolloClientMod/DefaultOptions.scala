...
import typingsJapgolly.apolloClient.PartialMutationOptionskey
import typingsJapgolly.apolloClient.PartialQueryOptionsOperat
import typingsJapgolly.apolloClient.PartialWatchQueryOptionsO
