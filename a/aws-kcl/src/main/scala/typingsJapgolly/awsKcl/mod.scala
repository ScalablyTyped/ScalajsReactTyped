...
object mod {
  ...
  object RecordProcessor {
    ...
    inline def apply(
      initialize: (InitializeInput, Callback) => japgolly.scalajs.react.Callback,
      leaseLost: (LeaseLossInput, Callback) => japgolly.scalajs.react.Callback,
      processRecords: (ProcessRecordsInput, Callback) => japgolly.scalajs.react.Callback,
      shardEnded: (ShardEndedInput, Callback) => japgolly.scalajs.react.Callback
    ): RecordProcessor = {
      val __obj = js.Dynamic.literal(initialize = js.Any.fromFunction2((t0: InitializeInput, t1: Callback) => (initialize(t0, t1)).runNow()), leaseLost = js.Any.fromFunction2((t0: LeaseLossInput, t1: Callback) => (leaseLost(t0, t1)).runNow()), processRecords = js.Any.fromFunction2((t0: ProcessRecordsInput, t1: Callback) => (processRecords(t0, t1)).runNow()), shardEnded = js.Any.fromFunction2((t0: ShardEndedInput, t1: Callback) => (shardEnded(t0, t1)).runNow()))
      __obj.asInstanceOf[RecordProcessor]
    }
    
    extension [Self <: RecordProcessor](x: Self) {
      
      inline def setInitialize(value: (InitializeInput, Callback) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "initialize", js.Any.fromFunction2((t0: InitializeInput, t1: Callback) => (value(t0, t1)).runNow()))
      
      inline def setLeaseLost(value: (LeaseLossInput, Callback) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "leaseLost", js.Any.fromFunction2((t0: LeaseLossInput, t1: Callback) => (value(t0, t1)).runNow()))
      
      inline def setProcessRecords(value: (ProcessRecordsInput, Callback) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "processRecords", js.Any.fromFunction2((t0: ProcessRecordsInput, t1: Callback) => (value(t0, t1)).runNow()))
      
      inline def setShardEnded(value: (ShardEndedInput, Callback) => japgolly.scalajs.react.Callback): Self = StObject.set(x, "shardEnded", js.Any.fromFunction2((t0: ShardEndedInput, t1: Callback) => (value(t0, t1)).runNow()))
    }
  }
