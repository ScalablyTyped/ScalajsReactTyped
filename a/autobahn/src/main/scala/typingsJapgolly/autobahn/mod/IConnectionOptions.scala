...
object IConnectionOptions {
  ...
  extension [Self <: IConnectionOptions](x: Self) {
    ...
    inline def setOn_internal_error(value: (/* error */ js.Object | Error, /* error_message */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "on_internal_error", js.Any.fromFunction2((t0: /* error */ js.Object | Error, t1: /* error_message */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
    
    inline def setOn_internal_errorUndefined: Self = StObject.set(x, "on_internal_error", js.undefined)
    
    inline def setOn_user_error(value: (/* error */ js.Object | Error, /* error_message */ js.UndefOr[String]) => Callback): Self = StObject.set(x, "on_user_error", js.Any.fromFunction2((t0: /* error */ js.Object | Error, t1: /* error_message */ js.UndefOr[String]) => (value(t0, t1)).runNow()))
    ...
    inline def setUse_deferred(value: CallbackTo[Promise[Any]]): Self = StObject.set(x, "use_deferred", value.toJsFn)
