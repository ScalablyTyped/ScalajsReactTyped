...
object IRegistration {
  ...
  inline def apply[TResult, TArgs, TKWArgs, TName](
    ...
    procedure: TName,
    session: Session,
    unregister: CallbackTo[Promise[Any]]
  ): IRegistration[TResult, TArgs, TKWArgs, TName] = {
    val __obj = js.Dynamic.literal(active = active.asInstanceOf[js.Any], endpoint = js.Any.fromFunction3(endpoint), id = id.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], procedure = procedure.asInstanceOf[js.Any], session = session.asInstanceOf[js.Any], unregister = unregister.toJsFn)
  ...
  extension [Self <: IRegistration[?, ?, ?, ?], TResult, TArgs, TKWArgs, TName](x: Self & (IRegistration[TResult, TArgs, TKWArgs, TName])) {
    ...
    inline def setUnregister(value: CallbackTo[Promise[Any]]): Self = StObject.set(x, "unregister", value.toJsFn)
  }
}
