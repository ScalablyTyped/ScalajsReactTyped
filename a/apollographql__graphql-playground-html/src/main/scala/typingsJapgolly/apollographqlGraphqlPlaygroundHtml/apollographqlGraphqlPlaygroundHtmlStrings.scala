...
import typingsJapgolly.apollographqlGraphqlPlaygroundHtml.distRenderPlaygroundPageMod.CursorShape
import typingsJapgolly.apollographqlGraphqlPlaygroundHtml.distRenderPlaygroundPageMod.Theme
