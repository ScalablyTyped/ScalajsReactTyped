...
object CommandManager {
  ...
  def apply(
    ...
    __obj.updateDynamic("addCommand")(js.Any.fromFunction1((t0: typingsJapgolly.ace.AceAjax.EditorCommand) => addCommand(t0).runNow()))
    __obj.updateDynamic("addCommands")(js.Any.fromFunction1((t0: js.Array[typingsJapgolly.ace.AceAjax.EditorCommand]) => addCommands(t0).runNow()))
    __obj.updateDynamic("exec")(js.Any.fromFunction3((t0: java.lang.String, t1: typingsJapgolly.ace.AceAjax.Editor, t2: js.Any) => exec(t0, t1, t2).runNow()))
