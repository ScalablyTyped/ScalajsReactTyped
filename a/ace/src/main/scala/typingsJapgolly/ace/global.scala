...
import typingsJapgolly.ace.AceAjax.Anchor
import typingsJapgolly.ace.AceAjax.BackgroundTokenizer
import typingsJapgolly.ace.AceAjax.Document
import typingsJapgolly.ace.AceAjax.Editor
import typingsJapgolly.ace.AceAjax.IEditSession
import typingsJapgolly.ace.AceAjax.IRangeList
import typingsJapgolly.ace.AceAjax.PlaceHolder
import typingsJapgolly.ace.AceAjax.Position
import typingsJapgolly.ace.AceAjax.Range
import typingsJapgolly.ace.AceAjax.RenderLoop
import typingsJapgolly.ace.AceAjax.ScrollBar
import typingsJapgolly.ace.AceAjax.Search
import typingsJapgolly.ace.AceAjax.Selection
import typingsJapgolly.ace.AceAjax.TextMode
import typingsJapgolly.ace.AceAjax.TokenInfo
import typingsJapgolly.ace.AceAjax.TokenIterator
import typingsJapgolly.ace.AceAjax.Tokenizer
import typingsJapgolly.ace.AceAjax.UndoManager
import typingsJapgolly.ace.AceAjax.VirtualRenderer
...
object global {
  ...
  object AceAjax {
    ...
    object Range {
      ...
      inline def fromPoints(pos1: Position, pos2: Position): typingsJapgolly.ace.AceAjax.Range = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPoints")(pos1.asInstanceOf[js.Any], pos2.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.ace.AceAjax.Range]
    }
