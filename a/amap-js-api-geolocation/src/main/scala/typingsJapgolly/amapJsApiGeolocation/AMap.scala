...
import typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationInts.`0`
import typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationInts.`1`
import typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.all
import typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.base
...
object AMap {
  ...
  object Geolocation {
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.LT
      - typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.LB
      - typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.RT
      - typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.RB
    */
    trait ButtonPosition extends StObject
    object ButtonPosition {
      
      inline def LB: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.LB = "LB".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.LB]
      
      inline def LT: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.LT = "LT".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.LT]
      
      inline def RB: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.RB = "RB".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.RB]
      
      inline def RT: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.RT = "RT".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.RT]
    }
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.html5
      - typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.ip
      - typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.sdk
    */
    trait LocationType extends StObject
    object LocationType {
      
      inline def html5: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.html5 = "html5".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.html5]
      
      inline def ip: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.ip = "ip".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.ip]
      
      inline def sdk: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.sdk = "sdk".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.sdk]
    }
    ...
    trait Options extends StObject {
      ...
      /**
        * 定位点Circle的配置
        */
      var circleOptions: js.UndefOr[typingsJapgolly.amapJsApi.AMap.Circle.Options[Any]] = js.undefined
      ...
      /**
        * 定位点Marker的配置
        */
      var markerOptions: js.UndefOr[typingsJapgolly.amapJsApi.AMap.Marker.Options[Any]] = js.undefined
    ...
    object Options {
      ...
      extension [Self <: Options](x: Self) {
        ...
        inline def setCircleOptions(value: typingsJapgolly.amapJsApi.AMap.Circle.Options[Any]): Self = StObject.set(x, "circleOptions", value.asInstanceOf[js.Any])
        ...
        inline def setMarkerOptions(value: typingsJapgolly.amapJsApi.AMap.Marker.Options[Any]): Self = StObject.set(x, "markerOptions", value.asInstanceOf[js.Any])
    ...
    */
    ...
    object SearchStatus {
      ...
      inline def complete: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.complete = "complete".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.complete]
      
      inline def error: typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.error = "error".asInstanceOf[typingsJapgolly.amapJsApiGeolocation.amapJsApiGeolocationStrings.error]
    }
  }
}
