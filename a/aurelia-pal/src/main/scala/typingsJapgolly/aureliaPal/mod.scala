package typingsJapgolly.aureliaPal
...
import typingsJapgolly.aureliaPal.anon.TypeofXMLHttpRequest
...
object mod {
  ...
  trait Dom extends StObject {
    ...
    def createCustomEvent(eventType: String, options: CustomEventInit[Any]): CustomEvent = js.native
