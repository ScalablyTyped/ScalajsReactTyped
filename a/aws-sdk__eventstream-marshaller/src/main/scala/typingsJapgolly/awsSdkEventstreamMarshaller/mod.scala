...
object mod {
  ...
  open class EventStreamMarshaller protected ()
    extends typingsJapgolly.awsSdkEventstreamMarshaller.distTypesEventStreamMarshallerMod.EventStreamMarshaller {
  ...
  open class Int64 protected ()
    extends typingsJapgolly.awsSdkEventstreamMarshaller.distTypesInt64Mod.Int64 {
