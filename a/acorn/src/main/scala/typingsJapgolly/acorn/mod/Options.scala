...
import typingsJapgolly.acorn.acornNumbers.`2015`
import typingsJapgolly.acorn.acornNumbers.`2016`
import typingsJapgolly.acorn.acornNumbers.`2017`
import typingsJapgolly.acorn.acornNumbers.`3`
import typingsJapgolly.acorn.acornNumbers.`5`
import typingsJapgolly.acorn.acornNumbers.`6`
import typingsJapgolly.acorn.acornNumbers.`7`
import typingsJapgolly.acorn.acornNumbers.`8`
...
trait Options extends js.Object {
  ...
  var onComment: js.UndefOr[
    (js.Function6[
      ...
      /* start */ Double, 
      /* end */ Double, 
      /* startLoc */ js.UndefOr[typingsJapgolly.estree.mod.Position], 
      /* endLoc */ js.UndefOr[typingsJapgolly.estree.mod.Position], 
      Unit
    ]) | js.Array[Comment]
  ] = js.undefined
  var onInsertedSemicolon: js.UndefOr[
    js.Function2[
      /* lastTokEnd */ Double, 
      /* lastTokEndLoc */ js.UndefOr[typingsJapgolly.estree.mod.Position], 
      Unit
    ]
  ] = js.undefined
...
object Options {
  ...
  def apply(
    ...
    onInsertedSemicolon: (/* lastTokEnd */ Double, /* lastTokEndLoc */ js.UndefOr[typingsJapgolly.estree.mod.Position]) => Callback = null,
    onToken: (js.Function1[/* token */ Token, _]) | js.Array[Token] = null,
    onTrailingComma: (/* lastTokEnd */ Double, /* lastTokEndLoc */ js.UndefOr[typingsJapgolly.estree.mod.Position]) => Callback = null,
    ...
    if (onInsertedSemicolon != null) __obj.updateDynamic("onInsertedSemicolon")(js.Any.fromFunction2((t0: /* lastTokEnd */ scala.Double, t1: /* lastTokEndLoc */ js.UndefOr[typingsJapgolly.estree.mod.Position]) => onInsertedSemicolon(t0, t1).runNow()))
    if (onToken != null) __obj.updateDynamic("onToken")(onToken.asInstanceOf[js.Any])
    if (onTrailingComma != null) __obj.updateDynamic("onTrailingComma")(js.Any.fromFunction2((t0: /* lastTokEnd */ scala.Double, t1: /* lastTokEndLoc */ js.UndefOr[typingsJapgolly.estree.mod.Position]) => onTrailingComma(t0, t1).runNow()))
