...
object esLocaleMsMYMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/ms_MY", "default.tableToolBar")
    @js.native
