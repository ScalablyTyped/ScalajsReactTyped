...
object esLocalePlPLMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/pl_PL", "default.tableToolBar")
    @js.native
