...
object esLocaleFaIRMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/fa_IR", "default.tableToolBar")
    @js.native
