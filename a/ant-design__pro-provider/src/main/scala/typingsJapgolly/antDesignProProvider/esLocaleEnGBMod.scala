...
object esLocaleEnGBMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/en_GB", "default.tableToolBar")
    @js.native
