...
object esLocaleMnMNMod {
  
  object default {
    
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.alert")
    @js.native
    def alert: Item = js.native
    inline def alert_=(x: Item): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("alert")(x.asInstanceOf[js.Any])
    
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.editableTable")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.form")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.loginForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.moneySymbol")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.pagination")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.stepsForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.switch")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.tableForm")
    @js.native
    ...
    @JSImport("@ant-design/pro-provider/es/locale/mn_MN", "default.tableToolBar")
    @js.native
