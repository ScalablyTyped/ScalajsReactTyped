...
import typingsJapgolly.arangodb.anon.DocumentJob
...
object foxxQueuesMod {
  ...
  object JobOptions {
    ...
    extension [Self <: JobOptions](x: Self) {
      ...
      inline def setFailure(value: (/* result */ Any, /* jobData */ Any, /* job */ DocumentJob) => Callback): Self = StObject.set(x, "failure", js.Any.fromFunction3((t0: /* result */ Any, t1: /* jobData */ Any, t2: /* job */ DocumentJob) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setSuccess(value: (/* result */ Any, /* jobData */ Any, /* job */ DocumentJob) => Callback): Self = StObject.set(x, "success", js.Any.fromFunction3((t0: /* result */ Any, t1: /* jobData */ Any, t2: /* job */ DocumentJob) => (value(t0, t1, t2)).runNow()))
