...
object GraphQLOptions {
  ...
  def apply(
    ...
    context: js.Any = null,
    formatError: /* error */ js.Any => CallbackTo[js.Any] = null,
    ...
    if (formatError != null) __obj.updateDynamic("formatError")(js.Any.fromFunction1((t0: /* error */ js.Any) => formatError(t0).runNow()))
