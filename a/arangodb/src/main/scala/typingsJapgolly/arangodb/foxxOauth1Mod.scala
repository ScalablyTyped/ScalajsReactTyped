...
import typingsJapgolly.arangodb.anon.Headers
import typingsJapgolly.arangodb.arangodbStrings.PLAINTEXT
import typingsJapgolly.arangodb.arangodbStrings.`HMAC-SHA1`
