...
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerBooleans.`false`
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.`match`
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.close
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.connect
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.direct
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.error
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.fanout
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.headers
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.topic
import typingsJapgolly.amqpConnectionManager.anon.Name
import typingsJapgolly.amqpConnectionManager.distEsmAmqpConnectionManagerMod.IAmqpConnectionManager
import typingsJapgolly.amqplib.mod.ConfirmChannel
...
import typingsJapgolly.promiseBreaker.mod.PromiseBreaker.Callback
...
object distEsmChannelWrapperMod {
  ...
  type Channel = ConfirmChannel | typingsJapgolly.amqplib.mod.Channel
  ...
  trait ChannelWrapper extends EventEmitter {
    ...
    def assertQueue(queue: String, options: typingsJapgolly.amqplib.propertiesMod.Options.AssertQueue): js.Promise[AssertQueue] = js.native
    ...
    def deleteQueue(queue: String, options: typingsJapgolly.amqplib.propertiesMod.Options.DeleteQueue): js.Promise[DeleteQueue] = js.native
  ...
  object Consumer {
    ...
    inline def apply(
      onMessage: ConsumeMessage => japgolly.scalajs.react.Callback,
      options: ConsumerOptions,
      queue: String
    ): Consumer = {
      val __obj = js.Dynamic.literal(onMessage = js.Any.fromFunction1((t0: ConsumeMessage) => onMessage(t0).runNow()), options = options.asInstanceOf[js.Any], queue = queue.asInstanceOf[js.Any], consumerTag = null)
    ...
    extension [Self <: Consumer](x: Self) {
      ...
      inline def setOnMessage(value: ConsumeMessage => japgolly.scalajs.react.Callback): Self = StObject.set(x, "onMessage", js.Any.fromFunction1((t0: ConsumeMessage) => value(t0).runNow()))
  ...
  trait ConsumerOptions
    extends StObject
       with typingsJapgolly.amqplib.propertiesMod.Options.Consume {
  ...
  object CreateChannelOpts {
    ...
    extension [Self <: CreateChannelOpts](x: Self) {
      ...
      inline def setSetupFunction2(
        value: ((/* channel */ Channel) | (/* channel */ ConfirmChannel), /* callback */ js.Function1[js.UndefOr[js.Error], Unit]) => japgolly.scalajs.react.Callback
      ): Self = StObject.set(x, "setup", js.Any.fromFunction2((t0: (/* channel */ Channel) | (/* channel */ ConfirmChannel), t1: /* callback */ js.Function1[js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
