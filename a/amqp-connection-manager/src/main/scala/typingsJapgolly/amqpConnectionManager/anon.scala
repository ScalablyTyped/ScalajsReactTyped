...
import typingsJapgolly.amqpConnectionManager.distEsmAmqpConnectionManagerMod.AmpqConnectionOptions
...
object anon {
  ...
  object Cancel {
    ...
    inline def apply(cancel: Callback, promise: js.Promise[Unit]): Cancel = {
  ...
  trait Connection extends StObject {
    ...
    var connection: typingsJapgolly.amqplib.mod.Connection
    
    var url: String | Connect
  }
  object Connection {
    
    inline def apply(connection: typingsJapgolly.amqplib.mod.Connection, url: String | Connect): Connection = {
    ...
    extension [Self <: Connection](x: Self) {
      ...
      inline def setConnection(value: typingsJapgolly.amqplib.mod.Connection): Self = StObject.set(x, "connection", value.asInstanceOf[js.Any])
