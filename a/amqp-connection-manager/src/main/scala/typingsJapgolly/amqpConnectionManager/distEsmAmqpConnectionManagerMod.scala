...
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.blocked
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.connect
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.connectFailed
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.disconnect
import typingsJapgolly.amqpConnectionManager.amqpConnectionManagerStrings.unblocked
import typingsJapgolly.amqpConnectionManager.anon.ConnectionOptions
import typingsJapgolly.amqpConnectionManager.anon.Err
import typingsJapgolly.amqpConnectionManager.anon.ErrError
import typingsJapgolly.amqpConnectionManager.anon.Reason
import typingsJapgolly.amqpConnectionManager.anon.Timeout
...
object distEsmAmqpConnectionManagerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.amqpConnectionManager.anon.ConnectionOptionsnoDelayb
    - typingsJapgolly.amqpConnectionManager.anon.TcpSocketConnectOptsnoDel
  */
  trait AmpqConnectionOptions extends StObject
  object AmpqConnectionOptions {
    
    inline def ConnectionOptionsnoDelayb(): typingsJapgolly.amqpConnectionManager.anon.ConnectionOptionsnoDelayb = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.amqpConnectionManager.anon.ConnectionOptionsnoDelayb]
    }
    
    inline def TcpSocketConnectOptsnoDel(port: Double): typingsJapgolly.amqpConnectionManager.anon.TcpSocketConnectOptsnoDel = {
      val __obj = js.Dynamic.literal(port = port.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.amqpConnectionManager.anon.TcpSocketConnectOptsnoDel]
    }
  }
  ...
  object AmqpConnectionManagerOptions {
    ...
    extension [Self <: AmqpConnectionManagerOptions](x: Self) {
      ...
      inline def setFindServersCallbackTo(value: CallbackTo[js.Promise[ConnectionUrl | js.Array[ConnectionUrl]]]): Self = StObject.set(x, "findServers", value.toJsFn)
      
      inline def setFindServersFunction1(
        value: /* callback */ js.Function1[/* urls */ ConnectionUrl | js.Array[ConnectionUrl], Unit] => Callback
      ): Self = StObject.set(x, "findServers", js.Any.fromFunction1((t0: /* callback */ js.Function1[/* urls */ ConnectionUrl | js.Array[ConnectionUrl], Unit]) => value(t0).runNow()))
  ...
  type ConnectListener = js.Function1[/* arg */ typingsJapgolly.amqpConnectionManager.anon.Connection, Unit]
  ...
  trait IAmqpConnectionManager extends StObject {
    ...
    def createChannel(): typingsJapgolly.amqpConnectionManager.distEsmChannelWrapperMod.default = js.native
    def createChannel(options: CreateChannelOpts): typingsJapgolly.amqpConnectionManager.distEsmChannelWrapperMod.default = js.native
