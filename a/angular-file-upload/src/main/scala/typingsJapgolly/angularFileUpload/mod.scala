...
import typingsJapgolly.angularFileUpload.anon.PartialFileUploaderOption
...
object mod {
  ...
  object FileItem {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(alias = alias.asInstanceOf[js.Any], cancel = cancel.toJsFn, file = file.asInstanceOf[js.Any], formData = formData.asInstanceOf[js.Any], headers = headers.asInstanceOf[js.Any], index = index.asInstanceOf[js.Any], isCancel = isCancel.asInstanceOf[js.Any], isError = isError.asInstanceOf[js.Any], isReady = isReady.asInstanceOf[js.Any], isSuccess = isSuccess.asInstanceOf[js.Any], isUploaded = isUploaded.asInstanceOf[js.Any], isUploading = isUploading.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], onBeforeUpload = onBeforeUpload.toJsFn, onCancel = js.Any.fromFunction3((t0: Response, t1: Double, t2: Headers) => (onCancel(t0, t1, t2)).runNow()), onComplete = js.Any.fromFunction3((t0: Response, t1: Double, t2: Headers) => (onComplete(t0, t1, t2)).runNow()), onError = js.Any.fromFunction3((t0: Response, t1: Double, t2: Headers) => (onError(t0, t1, t2)).runNow()), onProgress = js.Any.fromFunction1((t0: Double) => onProgress(t0).runNow()), onSuccess = js.Any.fromFunction3((t0: Response, t1: Double, t2: Headers) => (onSuccess(t0, t1, t2)).runNow()), progress = progress.asInstanceOf[js.Any], remove = remove.toJsFn, removeAfterUpload = removeAfterUpload.asInstanceOf[js.Any], upload = upload.toJsFn, uploader = uploader.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], withCredentials = withCredentials.asInstanceOf[js.Any])
    ...
    extension [Self <: FileItem](x: Self) {
      ...
      inline def setOnBeforeUpload(value: Callback): Self = StObject.set(x, "onBeforeUpload", value.toJsFn)
      
      inline def setOnCancel(value: (Response, Double, Headers) => Callback): Self = StObject.set(x, "onCancel", js.Any.fromFunction3((t0: Response, t1: Double, t2: Headers) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnComplete(value: (Response, Double, Headers) => Callback): Self = StObject.set(x, "onComplete", js.Any.fromFunction3((t0: Response, t1: Double, t2: Headers) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnError(value: (Response, Double, Headers) => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction3((t0: Response, t1: Double, t2: Headers) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnProgress(value: Double => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setOnSuccess(value: (Response, Double, Headers) => Callback): Self = StObject.set(x, "onSuccess", js.Any.fromFunction3((t0: Response, t1: Double, t2: Headers) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setUpload(value: Callback): Self = StObject.set(x, "upload", value.toJsFn)
  ...
  object Filter {
    ...
    extension [Self <: Filter](x: Self) {
      ...
      inline def setFnFunction3(
        value: (/* item */ File | FileLikeObject, /* options */ js.UndefOr[js.Object], /* deferred */ IDeferred[Any]) => Callback
      ): Self = StObject.set(x, "fn", js.Any.fromFunction3((t0: /* item */ File | FileLikeObject, t1: /* options */ js.UndefOr[js.Object], t2: /* deferred */ IDeferred[Any]) => (value(t0, t1, t2)).runNow()))
