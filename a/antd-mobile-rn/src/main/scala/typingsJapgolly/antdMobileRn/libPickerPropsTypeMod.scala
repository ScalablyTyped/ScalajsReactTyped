...
object libPickerPropsTypeMod {
  ...
  object PickerPropsType {
    ...
    extension [Self <: PickerPropsType](x: Self) {
      ...
      inline def setOnPickerChange(value: /* value */ CascaderValue => Callback): Self = StObject.set(x, "onPickerChange", js.Any.fromFunction1((t0: /* value */ CascaderValue) => value(t0).runNow()))
