...
import typingsJapgolly.antdMobileRn.libTextareaItemIndexDotnativeMod.TextareaItemNativeProps
...
object TextareaItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antdMobileRn.mod.TextareaItem] {
    ...
    inline def onBlur(value: /* val */ js.UndefOr[String] => Callback): this.type = set("onBlur", js.Any.fromFunction1((t0: /* val */ js.UndefOr[String]) => value(t0).runNow()))
    ...
    inline def onFocus(value: /* val */ js.UndefOr[String] => Callback): this.type = set("onFocus", js.Any.fromFunction1((t0: /* val */ js.UndefOr[String]) => value(t0).runNow()))
    ...
    inline def styles(value: ITextareaItemStyle): this.type = set("styles", value.asInstanceOf[js.Any])
