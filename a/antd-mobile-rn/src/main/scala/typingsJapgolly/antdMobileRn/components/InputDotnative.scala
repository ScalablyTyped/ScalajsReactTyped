...
import typingsJapgolly.antdMobileRn.inputNativeMod.TextInputProps
...
object InputDotnative {
  def apply(
    ...
    TextInputProps, 
    typingsJapgolly.antdMobileRn.inputNativeMod.default, 
    Unit, 
    TextInputProps
  ] = {
  ...
  typingsJapgolly.antdMobileRn.inputNativeMod.TextInputProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antdMobileRn.inputNativeMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antdMobileRn.inputNativeMod.TextInputProps])(children: _*)
  }
