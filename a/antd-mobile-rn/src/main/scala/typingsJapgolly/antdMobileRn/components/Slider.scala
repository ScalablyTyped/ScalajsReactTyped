...
import typingsJapgolly.antdMobileRn.libSliderIndexDotnativeMod.SliderProps
...
object Slider {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antdMobileRn.mod.Slider] {
    
    inline def defaultValue(value: Double): this.type = set("defaultValue", value.asInstanceOf[js.Any])
    
    inline def disabled(value: Boolean): this.type = set("disabled", value.asInstanceOf[js.Any])
    
    inline def handle(value: Any): this.type = set("handle", value.asInstanceOf[js.Any])
