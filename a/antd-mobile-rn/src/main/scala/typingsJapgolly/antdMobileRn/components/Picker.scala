...
import typingsJapgolly.antdMobileRn.abstractPickerMod.AbstractPickerProps
...
object Picker {
  def apply(
    ...
    AbstractPickerProps, 
    typingsJapgolly.antdMobileRn.mod.Picker, 
    Unit, 
    AbstractPickerProps
  ] = {
  ...
  typingsJapgolly.antdMobileRn.abstractPickerMod.AbstractPickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antdMobileRn.mod.Picker](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antdMobileRn.abstractPickerMod.AbstractPickerProps])(children: _*)
  }
