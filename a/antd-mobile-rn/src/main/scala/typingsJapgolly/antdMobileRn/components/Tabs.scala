...
object Tabs {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabsProps, typingsJapgolly.antdMobileRn.mod.Tabs, Unit, TabsProps] = {
  ...
  typingsJapgolly.antdMobileRn.tabsPropsTypeMod.TabsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antdMobileRn.mod.Tabs](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antdMobileRn.tabsPropsTypeMod.TabsProps])(children: _*)
  }
