...
import typingsJapgolly.antdMobileRn.libTagDemoBasicDotnativeMod.default
...
object BasicDotnative {
  ...
  implicit def make(companion: BasicDotnative.type): Default[default] = new Default[default](js.Array(this.component, js.Dictionary.empty))()
}
