...
import typingsJapgolly.antdMobileRn.buttonIndexNativeMod.ButtonProps
...
object Button {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[ButtonProps, typingsJapgolly.antdMobileRn.mod.Button, Unit, ButtonProps] = {
  ...
  typingsJapgolly.antdMobileRn.buttonIndexNativeMod.ButtonProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antdMobileRn.mod.Button](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antdMobileRn.buttonIndexNativeMod.ButtonProps])(children: _*)
  }
