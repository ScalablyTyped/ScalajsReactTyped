...
import typingsJapgolly.antdMobileRn.inputItemIndexNativeMod.InputItemProps
...
object InputItem {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputItemProps, typingsJapgolly.antdMobileRn.mod.InputItem, Unit, InputItemProps] = {
  ...
  typingsJapgolly.antdMobileRn.inputItemIndexNativeMod.InputItemProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antdMobileRn.mod.InputItem](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antdMobileRn.inputItemIndexNativeMod.InputItemProps])(children: _*)
  }
