...
object DatePickerView {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antdMobileRn.mod.DatePickerView] {
    ...
    inline def onScrollChange(value: (/* newValue */ Any, /* vals */ Any, /* index */ Double) => Callback): this.type = set("onScrollChange", js.Any.fromFunction3((t0: /* newValue */ Any, t1: /* vals */ Any, t2: /* index */ Double) => (value(t0, t1, t2)).runNow()))
