...
trait AnonBorderRadiusBorderStyle extends js.Object {
...
object AnonBorderRadiusBorderStyle {
  @scala.inline
  def apply(
    borderRadius: Double,
    borderStyle: String,
    ...
    __obj.asInstanceOf[AnonBorderRadiusBorderStyle]
  }
}
