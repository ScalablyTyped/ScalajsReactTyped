...
object libTextareaItemPropsTypeMod {
  ...
  object TextAreaItemPropsType {
    ...
    extension [Self <: TextAreaItemPropsType](x: Self) {
      ...
      inline def setOnBlur(value: /* val */ js.UndefOr[String] => Callback): Self = StObject.set(x, "onBlur", js.Any.fromFunction1((t0: /* val */ js.UndefOr[String]) => value(t0).runNow()))
      ...
      inline def setOnFocus(value: /* val */ js.UndefOr[String] => Callback): Self = StObject.set(x, "onFocus", js.Any.fromFunction1((t0: /* val */ js.UndefOr[String]) => value(t0).runNow()))
