...
object libPickerViewIndexDotnativeMod {
  
  @JSImport("antd-mobile-rn/lib/picker-view/index.native", JSImport.Default)
  @js.native
  open class default ()
    extends typingsJapgolly.antdMobileRn.libPickerViewPickerViewMod.default
  /* static members */
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/picker-view/index.native", "default.defaultProps")
    @js.native
