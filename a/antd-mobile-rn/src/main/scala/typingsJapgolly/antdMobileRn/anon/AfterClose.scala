...
object AfterClose {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(afterClose = afterClose.toJsFn, closable = closable.asInstanceOf[js.Any], disabled = disabled.asInstanceOf[js.Any], onChange = onChange.toJsFn, onClose = onClose.toJsFn, onLongPress = onLongPress.toJsFn, selected = selected.asInstanceOf[js.Any], small = small.asInstanceOf[js.Any], styles = styles.asInstanceOf[js.Any])
