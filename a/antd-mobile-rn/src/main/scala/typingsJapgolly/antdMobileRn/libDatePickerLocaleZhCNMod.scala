...
import typingsJapgolly.antdMobileRn.anon.Day
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libDatePickerLocaleZhCNMod {
  
  object default {
    
    @JSImport("antd-mobile-rn/lib/date-picker/locale/zh_CN", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/date-picker/locale/zh_CN", "default.DatePickerLocale")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/zh_CN", "default.dismissText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/zh_CN", "default.extra")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/date-picker/locale/zh_CN", "default.okText")
    @js.native
