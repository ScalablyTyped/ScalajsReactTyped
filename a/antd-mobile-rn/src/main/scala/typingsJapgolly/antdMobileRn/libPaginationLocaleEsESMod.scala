...
object libPaginationLocaleEsESMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/pagination/locale/es_ES", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("antd-mobile-rn/lib/pagination/locale/es_ES", "default.nextText")
    @js.native
    ...
    @JSImport("antd-mobile-rn/lib/pagination/locale/es_ES", "default.prevText")
    @js.native
