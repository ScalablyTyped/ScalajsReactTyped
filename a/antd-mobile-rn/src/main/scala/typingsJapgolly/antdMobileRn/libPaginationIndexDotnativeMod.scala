...
import typingsJapgolly.antdMobileRn.libPaginationPropsTypeMod.PaginationPropsType
import typingsJapgolly.antdMobileRn.libPaginationPropsTypeMod.PaginationState
