...
import typingsJapgolly.antdMobileRn.anon.BackgroundColorBorderColor
import typingsJapgolly.antdMobileRn.anon.BackgroundColorString
import typingsJapgolly.antdMobileRn.anon.BackgroundColorStringBorderColorString
import typingsJapgolly.antdMobileRn.anon.BorderColorString
import typingsJapgolly.antdMobileRn.anon.ColorStringFontSizeNumber
import typingsJapgolly.antdMobileRn.anon.FontWeightPaddingBottom
import typingsJapgolly.antdMobileRn.anon.HeightMarginTop
import typingsJapgolly.antdMobileRn.anon.HeightWidth
import typingsJapgolly.antdMobileRn.anon.MarginLeftWidth
import typingsJapgolly.antdMobileRn.anon.PaddingLeftNumber
import typingsJapgolly.antdMobileRn.anon.PaddingTopNumber
...
object libStepsStyleIndexDotnativeMod {
  ...
  object default {
    ...
    @JSImport("antd-mobile-rn/lib/steps/style/index.native", "default.content_l")
    @js.native
    ...
    @js.native
    def contentS: PaddingLeftNumber = js.native
    
    @JSImport("antd-mobile-rn/lib/steps/style/index.native", "default.content_s_h")
    @js.native
    ...
    @js.native
    def tailDefaultS: MarginLeftWidth = js.native
    
    @JSImport("antd-mobile-rn/lib/steps/style/index.native", "default.tail_default_s_h")
    @js.native
