...
trait AnonAlignItemsBorderBottomColor extends js.Object {
...
object AnonAlignItemsBorderBottomColor {
  @scala.inline
  def apply(
    alignItems: String,
  ...
  ): AnonAlignItemsBorderBottomColor = {
    ...
    __obj.asInstanceOf[AnonAlignItemsBorderBottomColor]
  }
}
