...
import typingsJapgolly.antdMobileRn.anon.AutoHeight
import typingsJapgolly.antdMobileRn.anon.NativeEventContentSize
import typingsJapgolly.antdMobileRn.anon.NativeEventContentSizeHeightWidth
...
import typingsJapgolly.antdMobileRn.libTextareaItemPropsTypeMod.TextAreaItemPropsType
import typingsJapgolly.antdMobileRn.libTextareaItemStyleIndexDotnativeMod.ITextareaItemStyle
...
object libTextareaItemIndexDotnativeMod {
  ...
  object TextareaItemNativeProps {
    ...
    extension [Self <: TextareaItemNativeProps](x: Self) {
      ...
      ): Self = StObject.set(x, "onContentSizeChange", js.Any.fromFunction1((t0: (/* e */ Any) | (/* e */ NativeSyntheticEvent[TextInputContentSizeChangeEventData])) => value(t0).runNow()))
