...
import typingsJapgolly.antdMobileRn.libCarouselPropsTypeMod.CarouselPropsType
...
object libCarouselIndexDotnativeMod {
  ...
  trait Carousel extends Component[CarouselProps, CarouselState, Any] {
    ...
    def renderContent(pages: Node): Element = js.native
  ...
  object CarouselProps {
    ...
    extension [Self <: CarouselProps](x: Self) {
      ...
      inline def setAfterChange(value: /* index */ Double => Callback): Self = StObject.set(x, "afterChange", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
      ...
      inline def setOnMomentumScrollEnd(
        value: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ CarouselState, /* carousel */ Carousel) => Callback
      ): Self = StObject.set(x, "onMomentumScrollEnd", js.Any.fromFunction3((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ CarouselState, t2: /* carousel */ Carousel) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnScrollBeginDrag(
        value: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ CarouselState, /* carousel */ Carousel) => Callback
      ): Self = StObject.set(x, "onScrollBeginDrag", js.Any.fromFunction3((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ CarouselState, t2: /* carousel */ Carousel) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnScrollBeginDragUndefined: Self = StObject.set(x, "onScrollBeginDrag", js.undefined)
      
      inline def setPagination(value: /* props */ PaginationProps => Node): Self = StObject.set(x, "pagination", js.Any.fromFunction1(value))
