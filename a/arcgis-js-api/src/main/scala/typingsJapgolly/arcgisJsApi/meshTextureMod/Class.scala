package typingsJapgolly.arcgisJsApi.meshTextureMod

import typingsJapgolly.arcgisJsApi.esri.MeshTexture
import typingsJapgolly.arcgisJsApi.esri.MeshTextureProperties
