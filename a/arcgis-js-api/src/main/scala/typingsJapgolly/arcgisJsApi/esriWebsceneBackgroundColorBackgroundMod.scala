...
import typingsJapgolly.arcgisJsApi.esri.backgroundColorBackground
import typingsJapgolly.arcgisJsApi.esri.backgroundColorBackgroundConstructor
import typingsJapgolly.arcgisJsApi.esri.backgroundColorBackgroundProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWebsceneBackgroundColorBackgroundMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWebsceneBackgroundColorBackgroundMod.foo` */
