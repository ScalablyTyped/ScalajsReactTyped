package typingsJapgolly.arcgisJsApi.navigationToggleViewModelMod

import typingsJapgolly.arcgisJsApi.esri.NavigationToggleViewModel
import typingsJapgolly.arcgisJsApi.esri.NavigationToggleViewModelProperties
