...
import typingsJapgolly.arcgisJsApi.esri.DateTimePickerInput
import typingsJapgolly.arcgisJsApi.esri.DateTimePickerInputConstructor
import typingsJapgolly.arcgisJsApi.esri.DateTimePickerInputProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriFormElementsInputsDateTimePickerInputMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriFormElementsInputsDateTimePickerInputMod.foo` */
