package typingsJapgolly.arcgisJsApi.heatmapSliderMod

import typingsJapgolly.arcgisJsApi.esri.HeatmapSlider
import typingsJapgolly.arcgisJsApi.esri.HeatmapSliderProperties
