...
import typingsJapgolly.arcgisJsApi.esri.RouteSolveResult
...
object esriRestSupportRouteSolveResultMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportRouteSolveResultMod.foo` */
