package typingsJapgolly.arcgisJsApi.identifyTaskMod

import typingsJapgolly.arcgisJsApi.esri.IdentifyTask
import typingsJapgolly.arcgisJsApi.esri.IdentifyTaskProperties
