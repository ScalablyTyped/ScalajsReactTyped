...
import typingsJapgolly.arcgisJsApi.esri.CornersGeoreference
import typingsJapgolly.arcgisJsApi.esri.ExtentAndRotationGeoreference
import typingsJapgolly.arcgisJsApi.esri.VideoElement
