package typingsJapgolly.arcgisJsApi.imageMediaInfoMod

import typingsJapgolly.arcgisJsApi.esri.ImageMediaInfo
import typingsJapgolly.arcgisJsApi.esri.ImageMediaInfoProperties
import typingsJapgolly.arcgisJsApi.esri.ImageMediaInfoValue
