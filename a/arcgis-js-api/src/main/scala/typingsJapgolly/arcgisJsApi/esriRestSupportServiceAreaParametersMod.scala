...
object esriRestSupportServiceAreaParametersMod extends Shortcut {
  
  @JSImport("esri/rest/support/ServiceAreaParameters", JSImport.Namespace)
  @js.native
  val ^ : js.Object & ServiceAreaParametersConstructor = js.native
  ...
  type _To = js.Object & ServiceAreaParametersConstructor
  
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportServiceAreaParametersMod.foo` */
  override def _to: js.Object & ServiceAreaParametersConstructor = ^
}
