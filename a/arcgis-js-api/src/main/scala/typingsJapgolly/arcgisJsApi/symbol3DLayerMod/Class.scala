package typingsJapgolly.arcgisJsApi.symbol3DLayerMod

import typingsJapgolly.arcgisJsApi.esri.Symbol3DLayer
import typingsJapgolly.arcgisJsApi.esri.Symbol3DLayerProperties
