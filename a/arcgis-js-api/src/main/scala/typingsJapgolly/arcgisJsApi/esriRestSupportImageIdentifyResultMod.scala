...
import typingsJapgolly.arcgisJsApi.esri.ImageIdentifyResult
import typingsJapgolly.arcgisJsApi.esri.ImageIdentifyResultConstructor
import typingsJapgolly.arcgisJsApi.esri.ImageIdentifyResultProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriRestSupportImageIdentifyResultMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportImageIdentifyResultMod.foo` */
