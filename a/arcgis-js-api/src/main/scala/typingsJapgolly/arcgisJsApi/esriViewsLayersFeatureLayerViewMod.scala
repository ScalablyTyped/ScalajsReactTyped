...
import typingsJapgolly.arcgisJsApi.esri.FeatureLayerView
import typingsJapgolly.arcgisJsApi.esri.FeatureLayerViewConstructor
import typingsJapgolly.arcgisJsApi.esri.FeatureLayerViewProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriViewsLayersFeatureLayerViewMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriViewsLayersFeatureLayerViewMod.foo` */
