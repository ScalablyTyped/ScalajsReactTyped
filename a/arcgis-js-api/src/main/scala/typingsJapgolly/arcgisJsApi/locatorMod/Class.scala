package typingsJapgolly.arcgisJsApi.locatorMod

import typingsJapgolly.arcgisJsApi.esri.Locator
import typingsJapgolly.arcgisJsApi.esri.LocatorProperties
