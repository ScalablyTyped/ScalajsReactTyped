...
trait AuthoringInfoProperties extends js.Object {
  ...
  /**
    ...
    */
  var `type`: js.UndefOr[
    `class-breaks-size` | `class-breaks-color` | `classed-color` | `classed-size` | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.predominance | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.relationship | `univariate-color-size`
  ] = js.undefined
  /**
...
object AuthoringInfoProperties {
  ...
  def apply(
    ...
    `type`: `class-breaks-size` | `class-breaks-color` | `classed-color` | `classed-size` | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.predominance | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.relationship | `univariate-color-size` = null,
