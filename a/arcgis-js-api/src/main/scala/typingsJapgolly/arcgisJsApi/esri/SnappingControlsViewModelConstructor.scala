...
@js.native
trait SnappingControlsViewModelConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[SnappingControlsViewModel]
     with Instantiable1[/* properties */ SnappingControlsViewModelProperties, SnappingControlsViewModel]
