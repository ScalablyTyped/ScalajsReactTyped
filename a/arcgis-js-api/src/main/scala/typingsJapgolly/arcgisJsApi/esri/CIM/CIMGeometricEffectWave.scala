...
trait CIMGeometricEffectWave
  ...
  @JSName("type")
  var type_CIMGeometricEffectWave: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectWave
...
object CIMGeometricEffectWave {
  ...
  extension [Self <: CIMGeometricEffectWave](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectWave): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
