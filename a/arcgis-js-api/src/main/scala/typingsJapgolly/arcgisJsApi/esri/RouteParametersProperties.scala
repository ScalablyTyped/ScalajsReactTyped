...
import typingsJapgolly.arcgisJsApi.anon.DataLayerPropertiestypela
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`complete-no-events`
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`instructions-only`
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`summary-only`
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`truck-time`
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.campus
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.desktop
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.featuresets
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.navigation
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.none_
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.now
