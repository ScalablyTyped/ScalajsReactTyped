...
trait CIMGeometricEffectDonut
  ...
  @JSName("type")
  var type_CIMGeometricEffectDonut: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectDonut
...
object CIMGeometricEffectDonut {
  ...
  extension [Self <: CIMGeometricEffectDonut](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectDonut): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
