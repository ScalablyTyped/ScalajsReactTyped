...
trait SubtypeGroupLayerElevationInfo
  extends StObject
     with Object {
  ...
  /**
    ...
    */
  var featureExpressionInfo: js.UndefOr[SubtypeGroupLayerElevationInfoFeatureExpressionInfo] = js.undefined
...
object SubtypeGroupLayerElevationInfo {
  ...
  inline def apply(
  ...
  ): SubtypeGroupLayerElevationInfo = {
    ...
    __obj.asInstanceOf[SubtypeGroupLayerElevationInfo]
  }
  
  extension [Self <: SubtypeGroupLayerElevationInfo](x: Self) {
    
    inline def setFeatureExpressionInfo(value: SubtypeGroupLayerElevationInfoFeatureExpressionInfo): Self = StObject.set(x, "featureExpressionInfo", value.asInstanceOf[js.Any])
