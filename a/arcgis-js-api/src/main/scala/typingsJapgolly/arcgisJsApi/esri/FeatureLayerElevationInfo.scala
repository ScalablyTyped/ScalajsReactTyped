...
object FeatureLayerElevationInfo {
  ...
  extension [Self <: FeatureLayerElevationInfo](x: Self) {
    
    inline def setFeatureExpressionInfo(value: FeatureLayerElevationInfoFeatureExpressionInfo): Self = StObject.set(x, "featureExpressionInfo", value.asInstanceOf[js.Any])
