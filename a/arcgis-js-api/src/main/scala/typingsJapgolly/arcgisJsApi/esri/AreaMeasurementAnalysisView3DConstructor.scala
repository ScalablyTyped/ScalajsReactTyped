...
@js.native
trait AreaMeasurementAnalysisView3DConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[AreaMeasurementAnalysisView3D]
     with Instantiable1[/* properties */ Any, AreaMeasurementAnalysisView3D]
