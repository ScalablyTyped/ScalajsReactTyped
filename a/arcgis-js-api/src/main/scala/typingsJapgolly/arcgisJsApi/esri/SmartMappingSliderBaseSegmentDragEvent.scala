...
trait SmartMappingSliderBaseSegmentDragEvent extends StObject {
...
object SmartMappingSliderBaseSegmentDragEvent {
  
  inline def apply(index: Double, state: start | drag, thumbIndices: js.Array[Double]): SmartMappingSliderBaseSegmentDragEvent = {
    ...
    __obj.asInstanceOf[SmartMappingSliderBaseSegmentDragEvent]
  }
  
  extension [Self <: SmartMappingSliderBaseSegmentDragEvent](x: Self) {
