...
@js.native
trait FloorFilterViewModelConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[FloorFilterViewModel]
     with Instantiable1[/* properties */ FloorFilterViewModelProperties, FloorFilterViewModel]
