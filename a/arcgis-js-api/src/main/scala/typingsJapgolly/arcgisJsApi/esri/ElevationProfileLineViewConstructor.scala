...
@js.native
trait ElevationProfileLineViewConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[ElevationProfileLineView]
     with Instantiable1[/* properties */ ElevationProfileLineViewProperties, ElevationProfileLineView]
