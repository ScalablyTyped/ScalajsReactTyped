...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`private`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.english
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.metric
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.org_admin
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.org_publisher
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.org_user
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.public
...
trait PortalUserProperties extends js.Object {
  /**
    ...
    */
  var access: js.UndefOr[`private` | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.org | public] = js.undefined
  /**
...
object PortalUserProperties {
  @scala.inline
  def apply(
    access: `private` | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.org | public = null,
    ...
    if (preferredView != null) __obj.updateDynamic("preferredView")(preferredView.asInstanceOf[js.Any])
