...
@js.native
trait SliceSlicePlaneConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[SliceSlicePlane]
     with Instantiable1[/* properties */ SliceSlicePlaneProperties, SliceSlicePlane] {
  
  def fromJSON(json: Any): SliceSlicePlane = js.native
}
