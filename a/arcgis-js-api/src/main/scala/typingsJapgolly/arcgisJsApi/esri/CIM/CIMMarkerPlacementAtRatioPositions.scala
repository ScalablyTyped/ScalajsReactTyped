...
trait CIMMarkerPlacementAtRatioPositions
  ...
  @JSName("type")
  var type_CIMMarkerPlacementAtRatioPositions: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtRatioPositions
}
object CIMMarkerPlacementAtRatioPositions {
  ...
  extension [Self <: CIMMarkerPlacementAtRatioPositions](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtRatioPositions): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
