...
@js.native
trait SmartMappingPrimaryHandleSliderViewModelConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[SmartMappingPrimaryHandleSliderViewModel]
     with Instantiable1[
      /* properties */ SmartMappingPrimaryHandleSliderViewModelProperties, 
