...
trait CIMGeometricEffectRadial
  ...
  @JSName("type")
  var type_CIMGeometricEffectRadial: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectRadial
}
object CIMGeometricEffectRadial {
  ...
  extension [Self <: CIMGeometricEffectRadial](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectRadial): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
