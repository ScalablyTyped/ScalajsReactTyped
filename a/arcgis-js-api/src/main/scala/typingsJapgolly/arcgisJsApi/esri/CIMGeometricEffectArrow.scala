...
trait CIMGeometricEffectArrow
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectArrow
...
object CIMGeometricEffectArrow {
  ...
  extension [Self <: CIMGeometricEffectArrow](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectArrow): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
