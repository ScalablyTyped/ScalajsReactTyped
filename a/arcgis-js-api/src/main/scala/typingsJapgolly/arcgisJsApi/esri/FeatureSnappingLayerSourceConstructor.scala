...
@js.native
trait FeatureSnappingLayerSourceConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[FeatureSnappingLayerSource]
     with Instantiable1[/* properties */ FeatureSnappingLayerSourceProperties, FeatureSnappingLayerSource]
