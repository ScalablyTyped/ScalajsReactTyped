...
trait CIMPictureStroke
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPictureStroke
...
object CIMPictureStroke {
  ...
  extension [Self <: CIMPictureStroke](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPictureStroke): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
