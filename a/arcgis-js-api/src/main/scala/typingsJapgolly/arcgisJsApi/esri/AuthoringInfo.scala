...
trait AuthoringInfo
  ...
  /**
    ...
    */
  var `type`: `class-breaks-size` | `class-breaks-color` | `classed-color` | `classed-size` | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.predominance | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.relationship | `univariate-color-size` = js.native
  /**
