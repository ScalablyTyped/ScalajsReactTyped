...
object ReactiveListenerOptions {
  ...
  extension [Self <: ReactiveListenerOptions[?], Target](x: Self & ReactiveListenerOptions[Target]) {
    ...
    inline def setOnListenerAdd(value: /* target */ Target => Callback): Self = StObject.set(x, "onListenerAdd", js.Any.fromFunction1((t0: /* target */ Target) => value(t0).runNow()))
    
    inline def setOnListenerAddUndefined: Self = StObject.set(x, "onListenerAdd", js.undefined)
    
    inline def setOnListenerRemove(value: /* target */ Target => Callback): Self = StObject.set(x, "onListenerRemove", js.Any.fromFunction1((t0: /* target */ Target) => value(t0).runNow()))
