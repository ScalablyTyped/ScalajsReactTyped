...
trait SubtypeGroupLayerCapabilitiesEditing
  extends StObject
     with Object {
  ...
  /**
    * Indicates if the `globalId` values provided by the client are used in [applyEdits](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-SubtypeGroupLayer.html#applyEdits).
    *
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-SubtypeGroupLayer.html#capabilities)
    */
...
object SubtypeGroupLayerCapabilitiesEditing {
  ...
  inline def apply(
  ...
  ): SubtypeGroupLayerCapabilitiesEditing = {
    ...
    __obj.asInstanceOf[SubtypeGroupLayerCapabilitiesEditing]
  }
  
  extension [Self <: SubtypeGroupLayerCapabilitiesEditing](x: Self) {
