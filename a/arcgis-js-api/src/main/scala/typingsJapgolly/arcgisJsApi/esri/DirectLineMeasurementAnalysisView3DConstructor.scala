...
@js.native
trait DirectLineMeasurementAnalysisView3DConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[DirectLineMeasurementAnalysisView3D]
     with Instantiable1[/* properties */ Any, DirectLineMeasurementAnalysisView3D]
