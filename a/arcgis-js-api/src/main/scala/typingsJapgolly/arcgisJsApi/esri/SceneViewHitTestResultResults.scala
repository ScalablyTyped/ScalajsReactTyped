...
object SceneViewHitTestResultResults {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any], distance = distance.asInstanceOf[js.Any], graphic = graphic.asInstanceOf[js.Any], mapPoint = mapPoint.asInstanceOf[js.Any])
