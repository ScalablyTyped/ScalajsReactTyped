...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.Absolute
...
trait CIMVectorMarker
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMVectorMarker
}
object CIMVectorMarker {
  ...
  extension [Self <: CIMVectorMarker](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMVectorMarker): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
