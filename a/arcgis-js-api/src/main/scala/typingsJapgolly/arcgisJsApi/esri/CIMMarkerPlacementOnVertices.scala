...
trait CIMMarkerPlacementOnVertices
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementOnVertices
}
object CIMMarkerPlacementOnVertices {
  ...
  extension [Self <: CIMMarkerPlacementOnVertices](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementOnVertices): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
