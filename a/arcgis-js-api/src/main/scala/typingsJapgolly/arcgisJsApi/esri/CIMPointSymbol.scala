...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.Display
...
trait CIMPointSymbol
  ...
  /**
    ...
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-symbols-CIMSymbol.html#CIMPointSymbol)
    */
  var angleAlignment: js.UndefOr[Display | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.Map] = js.undefined
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPointSymbol
...
object CIMPointSymbol {
  ...
  extension [Self <: CIMPointSymbol](x: Self) {
    ...
    inline def setAngleAlignment(value: Display | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.Map): Self = StObject.set(x, "angleAlignment", value.asInstanceOf[js.Any])
