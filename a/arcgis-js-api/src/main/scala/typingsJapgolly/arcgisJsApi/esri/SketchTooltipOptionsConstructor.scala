...
@js.native
trait SketchTooltipOptionsConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[SketchTooltipOptions]
     with Instantiable1[/* properties */ SketchTooltipOptionsProperties, SketchTooltipOptions]
