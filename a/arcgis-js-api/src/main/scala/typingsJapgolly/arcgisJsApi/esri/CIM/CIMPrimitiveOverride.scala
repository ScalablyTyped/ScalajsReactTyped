...
trait CIMPrimitiveOverride extends StObject {
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPrimitiveOverride
...
object CIMPrimitiveOverride {
  ...
  extension [Self <: CIMPrimitiveOverride](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPrimitiveOverride): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
