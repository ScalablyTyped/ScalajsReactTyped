...
trait CIMScaleDependentSizeVariation extends StObject {
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMScaleDependentSizeVariation
}
object CIMScaleDependentSizeVariation {
  ...
  extension [Self <: CIMScaleDependentSizeVariation](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMScaleDependentSizeVariation): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
