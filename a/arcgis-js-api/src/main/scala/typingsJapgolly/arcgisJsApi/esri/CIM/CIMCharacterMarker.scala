...
trait CIMCharacterMarker
  ...
  @JSName("type")
  var type_CIMCharacterMarker: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMCharacterMarker
...
object CIMCharacterMarker {
  ...
  extension [Self <: CIMCharacterMarker](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMCharacterMarker): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
