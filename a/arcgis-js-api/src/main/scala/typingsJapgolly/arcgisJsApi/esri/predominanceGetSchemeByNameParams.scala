...
object predominanceGetSchemeByNameParams {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any], geometryType = geometryType.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], numColors = numColors.asInstanceOf[js.Any])
