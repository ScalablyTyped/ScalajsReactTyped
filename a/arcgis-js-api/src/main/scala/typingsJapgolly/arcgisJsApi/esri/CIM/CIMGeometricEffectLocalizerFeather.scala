...
trait CIMGeometricEffectLocalizerFeather
  ...
  @JSName("type")
  var type_CIMGeometricEffectLocalizerFeather: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectLocalizerFeather
...
object CIMGeometricEffectLocalizerFeather {
  ...
  extension [Self <: CIMGeometricEffectLocalizerFeather](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectLocalizerFeather): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
