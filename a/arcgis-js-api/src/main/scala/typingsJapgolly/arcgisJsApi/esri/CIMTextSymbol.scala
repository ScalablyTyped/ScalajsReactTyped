...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.Regular
...
trait CIMTextSymbol
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMTextSymbol
...
object CIMTextSymbol {
  ...
  extension [Self <: CIMTextSymbol](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMTextSymbol): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
