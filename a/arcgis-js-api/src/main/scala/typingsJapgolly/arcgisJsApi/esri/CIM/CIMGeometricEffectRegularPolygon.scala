...
trait CIMGeometricEffectRegularPolygon
  ...
  @JSName("type")
  var type_CIMGeometricEffectRegularPolygon: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectRegularPolygon
}
object CIMGeometricEffectRegularPolygon {
  ...
  extension [Self <: CIMGeometricEffectRegularPolygon](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectRegularPolygon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
