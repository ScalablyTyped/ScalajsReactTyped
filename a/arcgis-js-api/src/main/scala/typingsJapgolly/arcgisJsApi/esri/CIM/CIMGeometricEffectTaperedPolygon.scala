...
trait CIMGeometricEffectTaperedPolygon
  ...
  @JSName("type")
  var type_CIMGeometricEffectTaperedPolygon: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectTaperedPolygon
}
object CIMGeometricEffectTaperedPolygon {
  ...
  extension [Self <: CIMGeometricEffectTaperedPolygon](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectTaperedPolygon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
