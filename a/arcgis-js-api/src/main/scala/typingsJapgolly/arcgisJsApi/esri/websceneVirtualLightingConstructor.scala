...
@js.native
trait websceneVirtualLightingConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[websceneVirtualLighting]
     with Instantiable1[/* properties */ websceneVirtualLightingProperties, websceneVirtualLighting]
