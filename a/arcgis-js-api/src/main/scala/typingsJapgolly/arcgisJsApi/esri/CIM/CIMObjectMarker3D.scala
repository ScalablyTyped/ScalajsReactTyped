...
trait CIMObjectMarker3D
  ...
  @JSName("type")
  var type_CIMObjectMarker3D: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMObjectMarker3D
...
object CIMObjectMarker3D {
  ...
  extension [Self <: CIMObjectMarker3D](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMObjectMarker3D): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
