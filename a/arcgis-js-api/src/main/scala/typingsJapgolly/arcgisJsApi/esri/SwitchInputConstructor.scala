...
trait SwitchInputConstructor
  ...
  */
Instantiable0[SwitchInput]
     with Instantiable1[/* properties */ SwitchInputProperties, SwitchInput] {
  
  def fromJSON(json: Any): SwitchInput = js.native
}
