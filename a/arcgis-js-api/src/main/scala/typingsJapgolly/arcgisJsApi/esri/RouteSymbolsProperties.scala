...
import typingsJapgolly.arcgisJsApi.anon.CIMSymbolPropertiestypeci
import typingsJapgolly.arcgisJsApi.anon.LineSymbol3DPropertiestyp
import typingsJapgolly.arcgisJsApi.anon.PictureFillSymbolProperti
import typingsJapgolly.arcgisJsApi.anon.PictureMarkerSymbolProper
import typingsJapgolly.arcgisJsApi.anon.PointSymbol3DPropertiesty
import typingsJapgolly.arcgisJsApi.anon.SimpleFillSymbolPropertie
import typingsJapgolly.arcgisJsApi.anon.SimpleLineSymbolPropertie
...
trait RouteSymbolsProperties extends StObject {
  ...
  var polygonBarriers: js.UndefOr[
    PictureFillSymbolProperti | SimpleFillSymbolPropertie | typingsJapgolly.arcgisJsApi.anon.PolygonSymbol3DProperties | CIMSymbolPropertiestypeci
  ] = js.undefined
...
object RouteSymbolsProperties {
  ...
  extension [Self <: RouteSymbolsProperties](x: Self) {
    ...
    inline def setPolygonBarriers(
      value: PictureFillSymbolProperti | SimpleFillSymbolPropertie | typingsJapgolly.arcgisJsApi.anon.PolygonSymbol3DProperties | CIMSymbolPropertiestypeci
