...
object ExternalRenderer {
  ...
  extension [Self <: ExternalRenderer](x: Self) {
    ...
    inline def setDispose(value: /* context */ js.UndefOr[RenderContext] => Callback): Self = StObject.set(x, "dispose", js.Any.fromFunction1((t0: /* context */ js.UndefOr[RenderContext]) => value(t0).runNow()))
    
    inline def setDisposeUndefined: Self = StObject.set(x, "dispose", js.undefined)
    
    inline def setRender(value: /* context */ js.UndefOr[RenderContext] => Callback): Self = StObject.set(x, "render", js.Any.fromFunction1((t0: /* context */ js.UndefOr[RenderContext]) => value(t0).runNow()))
    
    inline def setRenderUndefined: Self = StObject.set(x, "render", js.undefined)
    
    inline def setSetup(value: /* context */ js.UndefOr[RenderContext] => Callback): Self = StObject.set(x, "setup", js.Any.fromFunction1((t0: /* context */ js.UndefOr[RenderContext]) => value(t0).runNow()))
