...
trait CIMSymbolReference
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMSymbolReference
}
object CIMSymbolReference {
  ...
  extension [Self <: CIMSymbolReference](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMSymbolReference): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
