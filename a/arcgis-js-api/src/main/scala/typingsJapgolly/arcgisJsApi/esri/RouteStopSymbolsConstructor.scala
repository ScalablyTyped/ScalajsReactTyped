...
@js.native
trait RouteStopSymbolsConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[RouteStopSymbols]
     with Instantiable1[/* properties */ RouteStopSymbolsProperties, RouteStopSymbols] {
  
  def fromJSON(json: Any): RouteStopSymbols = js.native
}
