...
- typingsJapgolly.arcgisJsApi.esri.ArcGISCachedService because var conflicts: copyright. Inlined tileInfo
- typingsJapgolly.arcgisJsApi.esri.ArcGISMapService because var conflicts: fullExtent. Inlined capabilities, copyright, legendEnabled, spatialReference, version */ @js.native
trait TileLayer
  extends StObject
     with Layer
     with SublayersOwner
