...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.discrete
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.duration
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.ready
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.threshold
