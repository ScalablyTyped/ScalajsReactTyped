...
trait supportFeatureFilterProperties extends StObject {
...
object supportFeatureFilterProperties {
  
  inline def apply(): supportFeatureFilterProperties = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[supportFeatureFilterProperties]
  }
  
  extension [Self <: supportFeatureFilterProperties](x: Self) {
