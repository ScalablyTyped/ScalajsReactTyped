...
@js.native
trait ColumnTemplateBaseConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[ColumnTemplateBase]
     with Instantiable1[/* properties */ ColumnTemplateBaseProperties, ColumnTemplateBase] {
  
  def fromJSON(json: Any): ColumnTemplateBase = js.native
}
