...
trait CIMMarkerPlacementAtExtremities
  ...
  @JSName("type")
  var type_CIMMarkerPlacementAtExtremities: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtExtremities
}
object CIMMarkerPlacementAtExtremities {
  ...
  extension [Self <: CIMMarkerPlacementAtExtremities](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtExtremities): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
