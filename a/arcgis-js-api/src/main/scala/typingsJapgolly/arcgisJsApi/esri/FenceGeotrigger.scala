...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`enter-contains-and-exit-does-not-contain`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`enter-contains-and-exit-does-not-intersect`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`enter-intersects-and-exit-does-not-intersect`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`enter-or-exit`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`use-geometry-with-accuracy`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`use-geometry`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.enter
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.exit
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.fence
