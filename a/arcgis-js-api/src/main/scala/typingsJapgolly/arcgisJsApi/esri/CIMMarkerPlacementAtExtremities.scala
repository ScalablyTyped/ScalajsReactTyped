...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.Both
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.JustBegin
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.JustEnd
...
trait CIMMarkerPlacementAtExtremities
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAtExtremities
}
