...
trait HistogramRangeSliderThumbChangeEvent extends StObject {
...
object HistogramRangeSliderThumbChangeEvent {
  ...
  inline def apply(index: Double, oldValue: Double, value: Double): HistogramRangeSliderThumbChangeEvent = {
