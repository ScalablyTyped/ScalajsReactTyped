...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`horizontal-reversed`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`vertical-reversed`
...
object SliderProperties {
  ...
  extension [Self <: SliderProperties](x: Self) {
    ...
    inline def setInputCreatedFunction(
      value: (/* inputElement */ Any, /* type */ max | min | thumb, /* thumbIndex */ js.UndefOr[Double]) => Callback
    ): Self = StObject.set(x, "inputCreatedFunction", js.Any.fromFunction3((t0: /* inputElement */ Any, t1: /* type */ max | min | thumb, t2: /* thumbIndex */ js.UndefOr[Double]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setThumbCreatedFunction(
      value: (/* index */ Double, /* value */ Double, /* thumbElement */ HTMLElement, /* labelElement */ js.UndefOr[HTMLElement]) => Callback
    ): Self = StObject.set(x, "thumbCreatedFunction", js.Any.fromFunction4((t0: /* index */ Double, t1: /* value */ Double, t2: /* thumbElement */ HTMLElement, t3: /* labelElement */ js.UndefOr[HTMLElement]) => (value(t0, t1, t2, t3)).runNow()))
