...
object SliderProperties {
  ...
  def apply(
    ...
    thumbCreatedFunction: (/* index */ Double, /* value */ Double, /* thumbElement */ HTMLElement, /* labelElement */ js.UndefOr[HTMLElement]) => Callback = null,
  ...
  typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.average | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.min | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.max | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.tick | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.value], t2: /* index */ js.UndefOr[scala.Double]) => labelFormatFunction(t0, t1, t2).runNow()))
    ...
    if (thumbCreatedFunction != null) __obj.updateDynamic("thumbCreatedFunction")(js.Any.fromFunction4((t0: /* index */ scala.Double, t1: /* value */ scala.Double, t2: /* thumbElement */ org.scalajs.dom.raw.HTMLElement, t3: /* labelElement */ js.UndefOr[org.scalajs.dom.raw.HTMLElement]) => thumbCreatedFunction(t0, t1, t2, t3).runNow()))
