...
@js.native
trait HistogramRangeSliderConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[HistogramRangeSlider]
     with Instantiable1[/* properties */ HistogramRangeSliderProperties, HistogramRangeSlider]
