...
trait CIMLineSymbol
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMLineSymbol
...
object CIMLineSymbol {
  ...
  extension [Self <: CIMLineSymbol](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMLineSymbol): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
