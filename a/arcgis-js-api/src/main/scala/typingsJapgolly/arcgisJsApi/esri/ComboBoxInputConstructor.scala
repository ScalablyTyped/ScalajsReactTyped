...
@js.native
trait ComboBoxInputConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[ComboBoxInput]
     with Instantiable1[/* properties */ ComboBoxInputProperties, ComboBoxInput] {
  
  def fromJSON(json: Any): ComboBoxInput = js.native
}
