...
trait CIMGeometricEffectSuppress
  ...
  @JSName("type")
  var type_CIMGeometricEffectSuppress: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectSuppress
}
object CIMGeometricEffectSuppress {
  ...
  extension [Self <: CIMGeometricEffectSuppress](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectSuppress): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
