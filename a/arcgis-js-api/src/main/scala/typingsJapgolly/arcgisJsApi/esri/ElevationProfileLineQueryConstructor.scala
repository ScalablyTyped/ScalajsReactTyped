...
@js.native
trait ElevationProfileLineQueryConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[ElevationProfileLineQuery]
     with Instantiable1[/* properties */ ElevationProfileLineQueryProperties, ElevationProfileLineQuery]
