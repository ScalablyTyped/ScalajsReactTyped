...
object TypeSchemeForPolygon {
  ...
  extension [Self <: TypeSchemeForPolygon](x: Self) {
    ...
    inline def setOutline(value: TypeSchemeForPolygonOutline): Self = StObject.set(x, "outline", value.asInstanceOf[js.Any])
