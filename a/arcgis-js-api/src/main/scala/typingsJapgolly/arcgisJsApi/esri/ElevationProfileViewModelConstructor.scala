...
@js.native
trait ElevationProfileViewModelConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[ElevationProfileViewModel]
     with Instantiable1[/* properties */ ElevationProfileViewModelProperties, ElevationProfileViewModel]
