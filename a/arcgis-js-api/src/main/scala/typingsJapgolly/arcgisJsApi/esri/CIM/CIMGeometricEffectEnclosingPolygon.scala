...
trait CIMGeometricEffectEnclosingPolygon
  ...
  @JSName("type")
  var type_CIMGeometricEffectEnclosingPolygon: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectEnclosingPolygon
}
object CIMGeometricEffectEnclosingPolygon {
  ...
  extension [Self <: CIMGeometricEffectEnclosingPolygon](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectEnclosingPolygon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
