...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`add-flag-complete`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`add-flag-error`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`add-flag`
