...
trait CIMPointSymbol
  ...
  @JSName("type")
  var type_CIMPointSymbol: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPointSymbol
}
object CIMPointSymbol {
  ...
  extension [Self <: CIMPointSymbol](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPointSymbol): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
