...
@js.native
trait ElevationProfileLineInputConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[ElevationProfileLineInput]
     with Instantiable1[/* properties */ ElevationProfileLineInputProperties, ElevationProfileLineInput]
