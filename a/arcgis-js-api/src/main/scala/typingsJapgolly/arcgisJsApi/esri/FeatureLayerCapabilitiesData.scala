...
object FeatureLayerCapabilitiesData {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any], isVersioned = isVersioned.asInstanceOf[js.Any], supportsAttachment = supportsAttachment.asInstanceOf[js.Any], supportsM = supportsM.asInstanceOf[js.Any], supportsZ = supportsZ.asInstanceOf[js.Any])
