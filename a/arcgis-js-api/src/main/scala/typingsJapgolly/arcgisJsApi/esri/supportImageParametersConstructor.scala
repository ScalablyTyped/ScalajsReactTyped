...
@js.native
trait supportImageParametersConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[supportImageParameters]
     with Instantiable1[/* properties */ supportImageParametersProperties, supportImageParameters]
