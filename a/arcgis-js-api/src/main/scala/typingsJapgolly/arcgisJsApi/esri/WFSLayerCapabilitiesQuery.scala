...
trait WFSLayerCapabilitiesQuery
  extends StObject
     with Object {
  ...
  /**
    * Indicates if the layer supports queries for distinct values based on fields specified in the [outFields](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WFSLayer.html#outFields).
    *
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-layers-WFSLayer.html#capabilities)
    */
...
object WFSLayerCapabilitiesQuery {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[WFSLayerCapabilitiesQuery]
  }
  
  extension [Self <: WFSLayerCapabilitiesQuery](x: Self) {
