...
@js.native
trait ElevationProfileLineGroundConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[ElevationProfileLineGround]
     with Instantiable1[/* properties */ ElevationProfileLineGroundProperties, ElevationProfileLineGround]
