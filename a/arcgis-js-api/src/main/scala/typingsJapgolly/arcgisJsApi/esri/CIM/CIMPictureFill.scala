...
trait CIMPictureFill
  ...
  @JSName("type")
  var type_CIMPictureFill: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPictureFill
...
object CIMPictureFill {
  ...
  extension [Self <: CIMPictureFill](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPictureFill): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
