...
object VoxelVolumeStyle {
  ...
  inline def apply(toJSON: CallbackTo[Any], verticalExaggeration: Double, verticalOffset: Double, volumeId: Double): VoxelVolumeStyle = {
    val __obj = js.Dynamic.literal(toJSON = toJSON.toJsFn, verticalExaggeration = verticalExaggeration.asInstanceOf[js.Any], verticalOffset = verticalOffset.asInstanceOf[js.Any], volumeId = volumeId.asInstanceOf[js.Any])
