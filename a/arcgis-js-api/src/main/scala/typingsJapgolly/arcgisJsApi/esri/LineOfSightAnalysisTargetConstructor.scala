...
@js.native
trait LineOfSightAnalysisTargetConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[LineOfSightAnalysisTarget]
     with Instantiable1[/* properties */ LineOfSightAnalysisTargetProperties, LineOfSightAnalysisTarget]
