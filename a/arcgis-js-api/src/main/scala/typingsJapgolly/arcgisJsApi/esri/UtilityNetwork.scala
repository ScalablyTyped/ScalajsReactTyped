...
object UtilityNetwork {
  ...
  inline def apply(
    ...
    load: CallbackTo[js.Promise[Any]],
    rulesTableId: Double,
  ...
  extension [Self <: UtilityNetwork](x: Self) {
    ...
    inline def setLoad(value: CallbackTo[js.Promise[Any]]): Self = StObject.set(x, "load", value.toJsFn)
