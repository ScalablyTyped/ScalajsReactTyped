...
object PhaseCallbacks {
  ...
  extension [Self <: PhaseCallbacks](x: Self) {
    ...
    inline def setPrepare(value: /* event */ js.UndefOr[PhaseEvent] => Callback): Self = StObject.set(x, "prepare", js.Any.fromFunction1((t0: /* event */ js.UndefOr[PhaseEvent]) => value(t0).runNow()))
    
    inline def setPrepareUndefined: Self = StObject.set(x, "prepare", js.undefined)
    
    inline def setRender(value: /* event */ js.UndefOr[PhaseEvent] => Callback): Self = StObject.set(x, "render", js.Any.fromFunction1((t0: /* event */ js.UndefOr[PhaseEvent]) => value(t0).runNow()))
    
    inline def setRenderUndefined: Self = StObject.set(x, "render", js.undefined)
    
    inline def setUpdate(value: /* event */ js.UndefOr[PhaseEvent] => Callback): Self = StObject.set(x, "update", js.Any.fromFunction1((t0: /* event */ js.UndefOr[PhaseEvent]) => value(t0).runNow()))
