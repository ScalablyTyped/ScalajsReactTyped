...
trait CIMGeometricEffectReverse
  ...
  @JSName("type")
  var type_CIMGeometricEffectReverse: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectReverse
}
object CIMGeometricEffectReverse {
  ...
  extension [Self <: CIMGeometricEffectReverse](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectReverse): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
