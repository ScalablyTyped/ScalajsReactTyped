...
trait CIMObjectMarker3DLOD extends StObject {
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMObjectMarker3DLOD
}
object CIMObjectMarker3DLOD {
  ...
  extension [Self <: CIMObjectMarker3DLOD](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMObjectMarker3DLOD): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
