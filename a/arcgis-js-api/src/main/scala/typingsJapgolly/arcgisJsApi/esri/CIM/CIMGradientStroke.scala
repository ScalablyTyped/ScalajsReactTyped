...
trait CIMGradientStroke
  ...
  @JSName("type")
  var type_CIMGradientStroke: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGradientStroke
}
object CIMGradientStroke {
  ...
  extension [Self <: CIMGradientStroke](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGradientStroke): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
