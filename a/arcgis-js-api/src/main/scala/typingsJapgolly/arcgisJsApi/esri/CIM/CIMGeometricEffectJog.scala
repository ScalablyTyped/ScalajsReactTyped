...
trait CIMGeometricEffectJog
  ...
  @JSName("type")
  var type_CIMGeometricEffectJog: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectJog
}
object CIMGeometricEffectJog {
  ...
  extension [Self <: CIMGeometricEffectJog](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectJog): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
