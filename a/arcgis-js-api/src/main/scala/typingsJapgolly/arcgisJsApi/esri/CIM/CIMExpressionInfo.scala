...
trait CIMExpressionInfo extends StObject {
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMExpressionInfo
}
object CIMExpressionInfo {
  ...
  extension [Self <: CIMExpressionInfo](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMExpressionInfo): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
