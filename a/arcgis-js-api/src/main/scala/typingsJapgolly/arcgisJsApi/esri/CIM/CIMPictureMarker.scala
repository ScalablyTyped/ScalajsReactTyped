...
trait CIMPictureMarker
  ...
  @JSName("type")
  var type_CIMPictureMarker: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPictureMarker
...
object CIMPictureMarker {
  ...
  extension [Self <: CIMPictureMarker](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMPictureMarker): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
