...
trait CIMGeometricEffectOffsetTangent
  ...
  @JSName("type")
  var type_CIMGeometricEffectOffsetTangent: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectOffsetTangent
}
object CIMGeometricEffectOffsetTangent {
  ...
  extension [Self <: CIMGeometricEffectOffsetTangent](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectOffsetTangent): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
