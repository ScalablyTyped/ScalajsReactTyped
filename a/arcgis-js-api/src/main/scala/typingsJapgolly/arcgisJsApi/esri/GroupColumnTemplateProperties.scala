...
import typingsJapgolly.arcgisJsApi.anon.FieldColumnTemplateProper
import typingsJapgolly.arcgisJsApi.anon.GroupColumnTemplateProper
...
object GroupColumnTemplateProperties {
  ...
  extension [Self <: GroupColumnTemplateProperties](x: Self) {
