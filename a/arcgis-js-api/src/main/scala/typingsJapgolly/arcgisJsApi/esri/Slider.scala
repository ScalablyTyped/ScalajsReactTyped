...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`min-click`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`segment-click`
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`thumb-click`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`thumb-drag`
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`tick-click`
...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.dragging
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.editing
