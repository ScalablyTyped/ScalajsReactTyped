...
trait SliceViewModelProperties extends StObject {
  ...
  var excludedLayers: js.UndefOr[
    CollectionProperties[LayerProperties | typingsJapgolly.arcgisJsApi.anon.BuildingComponentSublayer]
  ] = js.undefined
...
object SliceViewModelProperties {
  ...
  extension [Self <: SliceViewModelProperties](x: Self) {
    ...
    inline def setExcludedLayers(
      value: CollectionProperties[LayerProperties | typingsJapgolly.arcgisJsApi.anon.BuildingComponentSublayer]
    ): Self = StObject.set(x, "excludedLayers", value.asInstanceOf[js.Any])
    
    inline def setExcludedLayersUndefined: Self = StObject.set(x, "excludedLayers", js.undefined)
    
    inline def setExcludedLayersVarargs(value: (LayerProperties | typingsJapgolly.arcgisJsApi.anon.BuildingComponentSublayer)*): Self = StObject.set(x, "excludedLayers", js.Array(value*))
