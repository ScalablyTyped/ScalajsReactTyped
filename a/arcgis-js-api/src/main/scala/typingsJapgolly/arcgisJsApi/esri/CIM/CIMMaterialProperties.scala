...
trait CIMMaterialProperties extends StObject {
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMaterialProperties
}
object CIMMaterialProperties {
  ...
  extension [Self <: CIMMaterialProperties](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMaterialProperties): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
