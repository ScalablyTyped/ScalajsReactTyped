...
object relationshipUpdateRendererParams {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(colors = colors.asInstanceOf[js.Any], constructor = constructor.asInstanceOf[js.Any], field1 = field1.asInstanceOf[js.Any], field2 = field2.asInstanceOf[js.Any], numClasses = numClasses.asInstanceOf[js.Any], renderer = renderer.asInstanceOf[js.Any])
