...
@js.native
trait CreateFeaturesWorkflowConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[CreateFeaturesWorkflow]
     with Instantiable1[/* properties */ CreateFeaturesWorkflowProperties, CreateFeaturesWorkflow]
