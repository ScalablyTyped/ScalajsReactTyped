...
trait CIMTextMargin extends StObject {
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMTextMargin
}
object CIMTextMargin {
  ...
  extension [Self <: CIMTextMargin](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMTextMargin): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
