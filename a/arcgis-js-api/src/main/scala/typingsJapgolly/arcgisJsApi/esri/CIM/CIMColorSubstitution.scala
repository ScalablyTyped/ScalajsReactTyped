...
trait CIMColorSubstitution extends StObject {
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMColorSubstitution
}
object CIMColorSubstitution {
  ...
  extension [Self <: CIMColorSubstitution](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMColorSubstitution): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
