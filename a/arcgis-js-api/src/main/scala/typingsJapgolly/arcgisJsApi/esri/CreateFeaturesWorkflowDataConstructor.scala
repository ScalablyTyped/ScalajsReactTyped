...
@js.native
trait CreateFeaturesWorkflowDataConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[CreateFeaturesWorkflowData]
     with Instantiable1[/* properties */ CreateFeaturesWorkflowDataProperties, CreateFeaturesWorkflowData]
