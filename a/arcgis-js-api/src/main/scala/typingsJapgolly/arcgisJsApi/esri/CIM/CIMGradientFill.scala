...
trait CIMGradientFill
  ...
  @JSName("type")
  var type_CIMGradientFill: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGradientFill
}
object CIMGradientFill {
  ...
  extension [Self <: CIMGradientFill](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGradientFill): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
