...
trait CIMCGAAttribute extends StObject {
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMCGAAttribute
...
object CIMCGAAttribute {
  ...
  extension [Self <: CIMCGAAttribute](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMCGAAttribute): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
