...
@js.native
trait LocalMediaElementSourceConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[LocalMediaElementSource]
     with Instantiable1[/* properties */ LocalMediaElementSourceProperties, LocalMediaElementSource]
