...
trait ScaleRangeSliderProperties
  ...
  var region: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 73, starting with typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.AE, typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.AR, typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.AT */ Any
  ] = js.undefined
...
object ScaleRangeSliderProperties {
  ...
  extension [Self <: ScaleRangeSliderProperties](x: Self) {
    ...
    inline def setRegion(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 73, starting with typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.AE, typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.AR, typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.AT */ Any
