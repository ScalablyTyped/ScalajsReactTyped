...
object BoundedMinMax {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(constructor = constructor.asInstanceOf[js.Any], maxDataValue = maxDataValue.asInstanceOf[js.Any], maxSize = maxSize.asInstanceOf[js.Any], minDataValue = minDataValue.asInstanceOf[js.Any], minSize = minSize.asInstanceOf[js.Any])
