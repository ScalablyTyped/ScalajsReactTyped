...
trait CIMGeometricEffectBuffer
  ...
  @JSName("type")
  var type_CIMGeometricEffectBuffer: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectBuffer
}
object CIMGeometricEffectBuffer {
  ...
  extension [Self <: CIMGeometricEffectBuffer](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMGeometricEffectBuffer): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
