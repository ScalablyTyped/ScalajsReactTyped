...
trait UI extends Accessor {
  ...
  def add(component: typingsJapgolly.std.HTMLElement): Unit = js.native
  def add(component: typingsJapgolly.std.HTMLElement, position: String): Unit = js.native
  def add(component: typingsJapgolly.std.HTMLElement, position: UIAddPosition): Unit = js.native
  /**
  ...
  def move(component: typingsJapgolly.std.HTMLElement): Unit = js.native
  def move(component: typingsJapgolly.std.HTMLElement, position: String): Unit = js.native
  ...
  def remove(component: typingsJapgolly.std.HTMLElement): Unit = js.native
}
