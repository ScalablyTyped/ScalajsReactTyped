...
import typingsJapgolly.arcgisJsApi.anon.FeatureReductionBinningPr
...
trait FeatureLayerProperties
  ...
  var featureReduction: js.UndefOr[
    FeatureReductionBinningPr | FeatureReductionClusterPr | typingsJapgolly.arcgisJsApi.anon.FeatureReductionSelection
  ] = js.undefined
...
object FeatureLayerProperties {
  ...
  extension [Self <: FeatureLayerProperties](x: Self) {
    ...
    inline def setFeatureReduction(
      value: FeatureReductionBinningPr | FeatureReductionClusterPr | typingsJapgolly.arcgisJsApi.anon.FeatureReductionSelection
