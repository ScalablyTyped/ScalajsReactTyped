...
trait promiseUtils extends StObject {
  ...
  /**
    ...
    *
    * @deprecated since version 4.24. Use [Promise](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/Promise) instead.
    *
    * [Read more...](https://developers.arcgis.com/javascript/latest/api-reference/esri-core-promiseUtils.html#create)
    */
  def create(executor: Executor): js.Promise[Any] = js.native
