...
@js.native
trait LayerFloorInfoConstructor
  extends StObject
     with /**
  ...
  */
Instantiable0[LayerFloorInfo]
     with Instantiable1[/* properties */ LayerFloorInfoProperties, LayerFloorInfo] {
  
  def fromJSON(json: Any): LayerFloorInfo = js.native
}
