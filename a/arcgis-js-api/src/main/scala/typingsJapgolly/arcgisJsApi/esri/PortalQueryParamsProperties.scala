...
object PortalQueryParamsProperties {
  ...
  def apply(
    ...
    num: Int | Double = null,
    query: String = null,
    sortField: title | uploaded | modified | username | created | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`type` | owner | `avg-rating` | `num-ratings` | `num-comments` | `num-views` = null,
