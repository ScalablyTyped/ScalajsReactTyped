...
import typingsJapgolly.arcgisJsApi.anon.BarcodeScannerInputProper
import typingsJapgolly.arcgisJsApi.anon.CodedValueDomainPropertie
import typingsJapgolly.arcgisJsApi.anon.ComboBoxInputPropertiesty
import typingsJapgolly.arcgisJsApi.anon.DateTimePickerInputProper
import typingsJapgolly.arcgisJsApi.anon.RadioButtonsInputProperti
import typingsJapgolly.arcgisJsApi.anon.RangeDomainPropertiestype
import typingsJapgolly.arcgisJsApi.anon.SwitchInputPropertiestype
import typingsJapgolly.arcgisJsApi.anon.TextAreaInputPropertiesty
import typingsJapgolly.arcgisJsApi.anon.TextBoxInputPropertiestyp
