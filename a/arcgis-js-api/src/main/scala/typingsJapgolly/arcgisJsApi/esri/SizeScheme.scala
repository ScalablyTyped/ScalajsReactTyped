...
object SizeScheme {
  ...
  inline def SizeSchemeForPoint(
    ...
    __obj.asInstanceOf[typingsJapgolly.arcgisJsApi.esri.SizeSchemeForPoint]
  }
  ...
  inline def SizeSchemeForPolygon(
    ...
    __obj.asInstanceOf[typingsJapgolly.arcgisJsApi.esri.SizeSchemeForPolygon]
  }
  ...
  inline def SizeSchemeForPolyline(
    ...
    __obj.asInstanceOf[typingsJapgolly.arcgisJsApi.esri.SizeSchemeForPolyline]
  }
}
