...
object AuthoringInfoVisualVariableProperties {
  ...
  def apply(
    ...
    `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.color | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.size | typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.opacity = null,
