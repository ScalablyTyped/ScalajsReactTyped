...
trait CIMMarkerPlacementAlongLineRandomSize
  ...
  @JSName("type")
  var type_CIMMarkerPlacementAlongLineRandomSize: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAlongLineRandomSize
}
object CIMMarkerPlacementAlongLineRandomSize {
  ...
  extension [Self <: CIMMarkerPlacementAlongLineRandomSize](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAlongLineRandomSize): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
