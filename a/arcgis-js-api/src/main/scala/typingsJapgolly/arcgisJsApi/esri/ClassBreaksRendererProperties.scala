...
trait ClassBreaksRendererProperties
  ...
  /**
    ...
    */
  var backgroundFillSymbol: js.UndefOr[
    FillSymbolProperties | typingsJapgolly.arcgisJsApi.anon.PolygonSymbol3DProperties
  ] = js.undefined
...
object ClassBreaksRendererProperties {
  ...
  extension [Self <: ClassBreaksRendererProperties](x: Self) {
    ...
    inline def setBackgroundFillSymbol(value: FillSymbolProperties | typingsJapgolly.arcgisJsApi.anon.PolygonSymbol3DProperties): Self = StObject.set(x, "backgroundFillSymbol", value.asInstanceOf[js.Any])
