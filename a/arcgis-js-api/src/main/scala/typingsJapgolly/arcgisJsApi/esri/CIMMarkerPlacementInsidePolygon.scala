...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.ClipAtBoundary
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.Fixed
...
trait CIMMarkerPlacementInsidePolygon
  ...
  var `type`: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementInsidePolygon
}
object CIMMarkerPlacementInsidePolygon {
  ...
  extension [Self <: CIMMarkerPlacementInsidePolygon](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementInsidePolygon): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
