...
trait CIMMarkerPlacementAlongLineVariableSize
  ...
  @JSName("type")
  var type_CIMMarkerPlacementAlongLineVariableSize: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAlongLineVariableSize
...
object CIMMarkerPlacementAlongLineVariableSize {
  ...
  extension [Self <: CIMMarkerPlacementAlongLineVariableSize](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.CIMMarkerPlacementAlongLineVariableSize): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
