...
import typingsJapgolly.arcgisJsApi.anon.WebStyleSymbolPropertiest
...
trait SketchViewModelProperties extends StObject {
  ...
  var polygonSymbol: js.UndefOr[
    SimpleFillSymbolPropertie | typingsJapgolly.arcgisJsApi.anon.PolygonSymbol3DProperties | CIMSymbolPropertiestypeci
  ] = js.undefined
...
object SketchViewModelProperties {
  ...
  extension [Self <: SketchViewModelProperties](x: Self) {
    ...
    inline def setPolygonSymbol(
      value: SimpleFillSymbolPropertie | typingsJapgolly.arcgisJsApi.anon.PolygonSymbol3DProperties | CIMSymbolPropertiestypeci
