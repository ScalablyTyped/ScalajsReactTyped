...
import typingsJapgolly.arcgisJsApi.esri.ActionBase
import typingsJapgolly.arcgisJsApi.esri.ActionBaseConstructor
import typingsJapgolly.arcgisJsApi.esri.ActionBaseProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriSupportActionsActionBaseMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriSupportActionsActionBaseMod.foo` */
