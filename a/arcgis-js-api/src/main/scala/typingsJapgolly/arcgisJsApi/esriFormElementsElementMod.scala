...
import typingsJapgolly.arcgisJsApi.esri.Element
...
object esriFormElementsElementMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriFormElementsElementMod.foo` */
