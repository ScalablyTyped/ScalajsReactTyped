...
import typingsJapgolly.arcgisJsApi.esri.TemplateItemGroup
import typingsJapgolly.arcgisJsApi.esri.TemplateItemGroupConstructor
import typingsJapgolly.arcgisJsApi.esri.TemplateItemGroupProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWidgetsFeatureTemplatesTemplateItemGroupMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWidgetsFeatureTemplatesTemplateItemGroupMod.foo` */
