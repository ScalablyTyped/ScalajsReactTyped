package typingsJapgolly.arcgisJsApi.vectorTileLayerMod

import typingsJapgolly.arcgisJsApi.esri.VectorTileLayer
import typingsJapgolly.arcgisJsApi.esri.VectorTileLayerProperties
