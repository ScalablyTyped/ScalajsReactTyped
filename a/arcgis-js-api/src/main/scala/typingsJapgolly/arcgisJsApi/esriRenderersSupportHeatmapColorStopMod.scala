...
import typingsJapgolly.arcgisJsApi.esri.HeatmapColorStop
import typingsJapgolly.arcgisJsApi.esri.HeatmapColorStopConstructor
import typingsJapgolly.arcgisJsApi.esri.HeatmapColorStopProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriRenderersSupportHeatmapColorStopMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRenderersSupportHeatmapColorStopMod.foo` */
