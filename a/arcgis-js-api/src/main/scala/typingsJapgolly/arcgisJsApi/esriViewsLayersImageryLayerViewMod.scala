...
import typingsJapgolly.arcgisJsApi.esri.ImageryLayerView
import typingsJapgolly.arcgisJsApi.esri.ImageryLayerViewConstructor
import typingsJapgolly.arcgisJsApi.esri.ImageryLayerViewProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriViewsLayersImageryLayerViewMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriViewsLayersImageryLayerViewMod.foo` */
