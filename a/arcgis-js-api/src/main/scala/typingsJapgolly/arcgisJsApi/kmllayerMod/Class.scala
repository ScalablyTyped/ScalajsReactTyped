package typingsJapgolly.arcgisJsApi.kmllayerMod

import typingsJapgolly.arcgisJsApi.esri.KMLLayer
import typingsJapgolly.arcgisJsApi.esri.KMLLayerProperties
