...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.`slice-view-3d`
import typingsJapgolly.arcgisJsApi.esri.SliceAnalysis
import typingsJapgolly.arcgisJsApi.esri.SliceAnalysisView3D
