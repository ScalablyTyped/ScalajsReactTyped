...
import typingsJapgolly.arcgisJsApi.esri.ScaleRanges
import typingsJapgolly.arcgisJsApi.esri.ScaleRangesConstructor
import typingsJapgolly.arcgisJsApi.esri.ScaleRangesProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWidgetsScaleRangeSliderScaleRangesMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWidgetsScaleRangeSliderScaleRangesMod.foo` */
