package typingsJapgolly.arcgisJsApi.compassMod

import typingsJapgolly.arcgisJsApi.esri.Compass
import typingsJapgolly.arcgisJsApi.esri.CompassProperties
