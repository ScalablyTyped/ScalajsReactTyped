package typingsJapgolly.arcgisJsApi.geoJSONLayerMod

import typingsJapgolly.arcgisJsApi.esri.GeoJSONLayer
import typingsJapgolly.arcgisJsApi.esri.GeoJSONLayerProperties
