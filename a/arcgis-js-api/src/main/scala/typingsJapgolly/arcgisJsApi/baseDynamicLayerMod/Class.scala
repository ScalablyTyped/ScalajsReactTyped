package typingsJapgolly.arcgisJsApi.baseDynamicLayerMod

import typingsJapgolly.arcgisJsApi.esri.BaseDynamicLayer
import typingsJapgolly.arcgisJsApi.esri.BaseDynamicLayerProperties
