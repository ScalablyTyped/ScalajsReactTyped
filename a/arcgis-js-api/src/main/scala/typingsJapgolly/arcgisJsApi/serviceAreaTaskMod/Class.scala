package typingsJapgolly.arcgisJsApi.serviceAreaTaskMod

import typingsJapgolly.arcgisJsApi.esri.ServiceAreaTask
import typingsJapgolly.arcgisJsApi.esri.ServiceAreaTaskProperties
