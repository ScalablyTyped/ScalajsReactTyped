package typingsJapgolly.arcgisJsApi.backgroundMod

import typingsJapgolly.arcgisJsApi.esri.Background
import typingsJapgolly.arcgisJsApi.esri.BackgroundProperties
