...
import typingsJapgolly.arcgisJsApi.esri.ElevationProfileLineInput
import typingsJapgolly.arcgisJsApi.esri.ElevationProfileLineInputConstructor
import typingsJapgolly.arcgisJsApi.esri.ElevationProfileLineInputProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWidgetsElevationProfileElevationProfileLineInputMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWidgetsElevationProfileElevationProfileLineInputMod.foo` */
