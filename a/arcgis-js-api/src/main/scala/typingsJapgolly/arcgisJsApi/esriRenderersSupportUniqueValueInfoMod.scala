...
import typingsJapgolly.arcgisJsApi.esri.UniqueValueInfo
import typingsJapgolly.arcgisJsApi.esri.UniqueValueInfoConstructor
import typingsJapgolly.arcgisJsApi.esri.UniqueValueInfoProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriRenderersSupportUniqueValueInfoMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRenderersSupportUniqueValueInfoMod.foo` */
