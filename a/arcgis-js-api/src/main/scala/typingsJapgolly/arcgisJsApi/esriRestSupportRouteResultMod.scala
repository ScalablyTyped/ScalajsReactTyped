...
import typingsJapgolly.arcgisJsApi.esri.RouteResult
import typingsJapgolly.arcgisJsApi.esri.RouteResultConstructor
import typingsJapgolly.arcgisJsApi.esri.RouteResultProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriRestSupportRouteResultMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportRouteResultMod.foo` */
