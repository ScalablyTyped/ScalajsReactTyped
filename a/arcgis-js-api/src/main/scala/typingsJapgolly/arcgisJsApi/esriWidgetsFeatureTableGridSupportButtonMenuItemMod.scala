...
import typingsJapgolly.arcgisJsApi.esri.ButtonMenuItem
import typingsJapgolly.arcgisJsApi.esri.ButtonMenuItemConstructor
import typingsJapgolly.arcgisJsApi.esri.ButtonMenuItemProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWidgetsFeatureTableGridSupportButtonMenuItemMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWidgetsFeatureTableGridSupportButtonMenuItemMod.foo` */
