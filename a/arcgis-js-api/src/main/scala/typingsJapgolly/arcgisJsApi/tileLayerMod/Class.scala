package typingsJapgolly.arcgisJsApi.tileLayerMod
...
import typingsJapgolly.arcgisJsApi.esri.TileLayer
import typingsJapgolly.arcgisJsApi.esri.TileLayerProperties
