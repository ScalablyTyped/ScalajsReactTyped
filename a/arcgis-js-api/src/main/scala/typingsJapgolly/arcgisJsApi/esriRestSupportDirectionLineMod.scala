...
import typingsJapgolly.arcgisJsApi.esri.DirectionLine
import typingsJapgolly.arcgisJsApi.esri.DirectionLineConstructor
import typingsJapgolly.arcgisJsApi.esri.DirectionLineProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriRestSupportDirectionLineMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportDirectionLineMod.foo` */
