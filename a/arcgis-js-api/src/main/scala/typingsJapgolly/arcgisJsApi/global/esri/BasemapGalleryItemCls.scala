...
import typingsJapgolly.arcgisJsApi.esri.BasemapGalleryItemProperties
...
/**
  ...
  */
open class BasemapGalleryItemCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.BasemapGalleryItem {
