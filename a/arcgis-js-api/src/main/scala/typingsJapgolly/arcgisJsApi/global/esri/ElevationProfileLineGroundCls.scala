...
import typingsJapgolly.arcgisJsApi.esri.ElevationProfileLineGroundProperties
...
/**
  ...
  */
open class ElevationProfileLineGroundCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.ElevationProfileLineGround {
