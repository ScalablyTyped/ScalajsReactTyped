...
import typingsJapgolly.arcgisJsApi.esri.LayerSearchSourceProperties
...
/**
  ...
  */
open class LayerSearchSourceCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.LayerSearchSource {
