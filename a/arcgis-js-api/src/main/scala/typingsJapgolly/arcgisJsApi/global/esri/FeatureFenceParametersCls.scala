...
import typingsJapgolly.arcgisJsApi.esri.FeatureFenceParametersProperties
...
/**
  ...
  */
open class FeatureFenceParametersCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.FeatureFenceParameters {
