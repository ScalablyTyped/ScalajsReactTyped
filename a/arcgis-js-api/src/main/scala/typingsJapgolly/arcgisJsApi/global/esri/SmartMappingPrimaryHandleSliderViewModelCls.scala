...
@JSGlobal("__esri.SmartMappingPrimaryHandleSliderViewModel")
@js.native
/**
  ...
  */
open class SmartMappingPrimaryHandleSliderViewModelCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.SmartMappingPrimaryHandleSliderViewModel {
