...
open class DirectLineMeasurementAnalysisView3DCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.DirectLineMeasurementAnalysisView3D {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val analysis: typingsJapgolly.arcgisJsApi.esri.DirectLineMeasurementAnalysis = js.native
