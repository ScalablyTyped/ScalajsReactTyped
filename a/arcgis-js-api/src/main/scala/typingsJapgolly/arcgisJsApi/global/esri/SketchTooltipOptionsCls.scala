...
import typingsJapgolly.arcgisJsApi.esri.SketchTooltipOptionsProperties
...
/**
  ...
  */
open class SketchTooltipOptionsCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.SketchTooltipOptions {
