...
import typingsJapgolly.arcgisJsApi.esri.websceneInitialViewPropertiesProperties
...
/**
  ...
  */
open class websceneInitialViewPropertiesCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.websceneInitialViewProperties {
