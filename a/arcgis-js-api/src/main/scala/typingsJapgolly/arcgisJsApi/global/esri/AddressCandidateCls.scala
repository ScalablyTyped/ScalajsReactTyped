...
import typingsJapgolly.arcgisJsApi.esri.AddressCandidateProperties
...
/**
  ...
  */
open class AddressCandidateCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.AddressCandidate {
