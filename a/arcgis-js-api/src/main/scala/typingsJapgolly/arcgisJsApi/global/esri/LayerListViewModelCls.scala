...
import typingsJapgolly.arcgisJsApi.esri.LayerListViewModelProperties
...
/**
  ...
  */
open class LayerListViewModelCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.LayerListViewModel {
