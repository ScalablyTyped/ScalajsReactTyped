...
import typingsJapgolly.arcgisJsApi.esri.SynthesizeAssociationGeometriesParametersProperties
...
open class SynthesizeAssociationGeometriesParametersCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.SynthesizeAssociationGeometriesParameters {
