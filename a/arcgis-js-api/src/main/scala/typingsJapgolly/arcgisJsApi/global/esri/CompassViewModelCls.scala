...
import typingsJapgolly.arcgisJsApi.esri.CompassViewModelProperties
...
/**
  ...
  */
open class CompassViewModelCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.CompassViewModel {
