...
import typingsJapgolly.arcgisJsApi.esri.ElevationProfileProperties
...
/**
  ...
  */
open class ElevationProfileCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.ElevationProfile {
