...
import typingsJapgolly.arcgisJsApi.esri.ClassedSizeSliderProperties
...
/**
  ...
  */
open class ClassedSizeSliderCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.ClassedSizeSlider {
