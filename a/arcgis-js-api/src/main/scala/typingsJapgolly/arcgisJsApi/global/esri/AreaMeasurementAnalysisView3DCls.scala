...
open class AreaMeasurementAnalysisView3DCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.AreaMeasurementAnalysisView3D {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val analysis: typingsJapgolly.arcgisJsApi.esri.AreaMeasurementAnalysis = js.native
