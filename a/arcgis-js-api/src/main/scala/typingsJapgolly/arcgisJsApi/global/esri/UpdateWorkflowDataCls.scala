...
import typingsJapgolly.arcgisJsApi.esri.UpdateWorkflowDataProperties
...
/**
  ...
  */
open class UpdateWorkflowDataCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.UpdateWorkflowData {
