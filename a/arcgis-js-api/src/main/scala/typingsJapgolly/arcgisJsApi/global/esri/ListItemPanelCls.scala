...
open class ListItemPanelCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.ListItemPanel {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var content: typingsJapgolly.arcgisJsApi.esri.Widget_ | HTMLElement | String | js.Array[Any] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var listItem: typingsJapgolly.arcgisJsApi.esri.ListItem = js.native
