...
open class LineOfSightAnalysisView3DCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.LineOfSightAnalysisView3D {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val analysis: typingsJapgolly.arcgisJsApi.esri.LineOfSightAnalysis = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val results: typingsJapgolly.arcgisJsApi.esri.Collection[typingsJapgolly.arcgisJsApi.esri.LineOfSightAnalysisResult] = js.native
