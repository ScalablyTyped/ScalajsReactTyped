...
import typingsJapgolly.arcgisJsApi.esri.BuildingExplorerViewModelProperties
...
/**
  ...
  */
open class BuildingExplorerViewModelCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.BuildingExplorerViewModel {
