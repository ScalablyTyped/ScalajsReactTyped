...
open class GeographicTransformationStepCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.GeographicTransformationStep {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getInverse(): typingsJapgolly.arcgisJsApi.esri.GeographicTransformationStep = js.native
