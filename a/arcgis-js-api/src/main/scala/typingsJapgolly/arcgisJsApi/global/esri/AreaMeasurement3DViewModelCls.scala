...
import typingsJapgolly.arcgisJsApi.esri.AreaMeasurement3DViewModelProperties
...
/**
  ...
  */
open class AreaMeasurement3DViewModelCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.AreaMeasurement3DViewModel {
