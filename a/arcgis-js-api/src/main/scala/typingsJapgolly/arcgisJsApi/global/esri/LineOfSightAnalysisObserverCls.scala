...
import typingsJapgolly.arcgisJsApi.esri.LineOfSightAnalysisObserverProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* This class was inferred from a value with a constructor, it was renamed because a distinct type already exists with the same name. */
@JSGlobal("__esri.LineOfSightAnalysisObserver")
@js.native
/**
  ...
  */
open class LineOfSightAnalysisObserverCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.LineOfSightAnalysisObserver {
