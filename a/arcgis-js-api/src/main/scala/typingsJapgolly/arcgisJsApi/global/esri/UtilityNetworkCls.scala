...
open class UtilityNetworkCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.UtilityNetwork {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def getTerminalConfiguration(feature: typingsJapgolly.arcgisJsApi.esri.Graphic): typingsJapgolly.arcgisJsApi.esri.TerminalConfiguration = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  var sharedNamedTraceConfigurations: js.Array[typingsJapgolly.arcgisJsApi.esri.NamedTraceConfiguration] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override val terminalConfigurations: js.Array[typingsJapgolly.arcgisJsApi.esri.TerminalConfiguration] = js.native
