...
import typingsJapgolly.arcgisJsApi.esri.ImagePixelLocationResultProperties
...
/**
  ...
  */
open class ImagePixelLocationResultCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.ImagePixelLocationResult {
