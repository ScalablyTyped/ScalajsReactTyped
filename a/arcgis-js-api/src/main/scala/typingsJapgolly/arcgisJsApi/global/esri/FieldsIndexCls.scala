...
open class FieldsIndexCls ()
  extends StObject
     with typingsJapgolly.arcgisJsApi.esri.FieldsIndex {
  ...
  /**
    ...
    */
  /* CompleteClass */
  var dateFields: js.Array[Any | typingsJapgolly.arcgisJsApi.esri.Field] = js.native
  ...
  /**
    ...
    */
  /* CompleteClass */
  override def get(fieldName: String): typingsJapgolly.arcgisJsApi.esri.Field = js.native
