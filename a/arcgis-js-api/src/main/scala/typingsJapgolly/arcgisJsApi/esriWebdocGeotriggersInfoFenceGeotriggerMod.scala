...
import typingsJapgolly.arcgisJsApi.esri.FenceGeotrigger
import typingsJapgolly.arcgisJsApi.esri.FenceGeotriggerConstructor
import typingsJapgolly.arcgisJsApi.esri.FenceGeotriggerProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWebdocGeotriggersInfoFenceGeotriggerMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWebdocGeotriggersInfoFenceGeotriggerMod.foo` */
