...
import typingsJapgolly.arcgisJsApi.esri.Viewing
import typingsJapgolly.arcgisJsApi.esri.ViewingConstructor
import typingsJapgolly.arcgisJsApi.esri.ViewingProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWebdocApplicationPropertiesViewingMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWebdocApplicationPropertiesViewingMod.foo` */
