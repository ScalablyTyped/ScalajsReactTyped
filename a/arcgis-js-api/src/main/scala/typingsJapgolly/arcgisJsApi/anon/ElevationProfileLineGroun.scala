...
import typingsJapgolly.arcgisJsApi.arcgisJsApiStrings.ground
import typingsJapgolly.arcgisJsApi.esri.Color_
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined arcgis-js-api.__esri.ElevationProfileLineGroundProperties & {  type :'ground'} */
trait ElevationProfileLineGroun extends StObject {
...
object ElevationProfileLineGroun {
  
  inline def apply(): ElevationProfileLineGroun = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("ground")
  ...
  extension [Self <: ElevationProfileLineGroun](x: Self) {
    ...
    inline def setType(value: ground): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
