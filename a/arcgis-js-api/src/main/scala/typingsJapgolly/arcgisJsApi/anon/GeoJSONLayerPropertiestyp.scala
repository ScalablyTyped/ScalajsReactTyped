...
import typingsJapgolly.arcgisJsApi.esri.GeoJSONLayerElevationInfo
...
/* Inlined arcgis-js-api.__esri.GeoJSONLayerProperties & {  type :'geojson'} */
trait GeoJSONLayerPropertiestyp extends StObject {
...
object GeoJSONLayerPropertiestyp {
  
  inline def apply(): GeoJSONLayerPropertiestyp = {
