...
import typingsJapgolly.arcgisJsApi.esri.PathSymbol3DLayerMaterialProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined arcgis-js-api.__esri.PathSymbol3DLayerProperties & {  type :'path'} */
trait PathSymbol3DLayerProperti extends StObject {
...
object PathSymbol3DLayerProperti {
  
  inline def apply(): PathSymbol3DLayerProperti = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("type")("path")
    __obj.asInstanceOf[PathSymbol3DLayerProperti]
  }
  
  extension [Self <: PathSymbol3DLayerProperti](x: Self) {
