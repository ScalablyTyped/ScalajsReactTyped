...
import typingsJapgolly.arcgisJsApi.esri.TextSymbol3DLayerBackgroundProperties
import typingsJapgolly.arcgisJsApi.esri.TextSymbol3DLayerHaloProperties
import typingsJapgolly.arcgisJsApi.esri.TextSymbol3DLayerMaterialProperties
