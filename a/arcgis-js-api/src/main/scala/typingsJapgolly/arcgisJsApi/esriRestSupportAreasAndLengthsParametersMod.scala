...
import typingsJapgolly.arcgisJsApi.esri.AreasAndLengthsParameters
...
object esriRestSupportAreasAndLengthsParametersMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportAreasAndLengthsParametersMod.foo` */
