package typingsJapgolly.arcgisJsApi.featureReductionSelectionMod

import typingsJapgolly.arcgisJsApi.esri.FeatureReductionSelection
import typingsJapgolly.arcgisJsApi.esri.FeatureReductionSelectionProperties
