package typingsJapgolly.arcgisJsApi.queryTaskMod

import typingsJapgolly.arcgisJsApi.esri.QueryTask
import typingsJapgolly.arcgisJsApi.esri.QueryTaskProperties
