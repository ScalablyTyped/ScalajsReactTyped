...
import typingsJapgolly.arcgisJsApi.esri.ElevationProfileLineQuery
import typingsJapgolly.arcgisJsApi.esri.ElevationProfileLineQueryConstructor
import typingsJapgolly.arcgisJsApi.esri.ElevationProfileLineQueryProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWidgetsElevationProfileElevationProfileLineQueryMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWidgetsElevationProfileElevationProfileLineQueryMod.foo` */
