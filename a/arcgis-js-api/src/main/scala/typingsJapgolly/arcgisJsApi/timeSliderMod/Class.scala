package typingsJapgolly.arcgisJsApi.timeSliderMod

import typingsJapgolly.arcgisJsApi.esri.TimeSlider
import typingsJapgolly.arcgisJsApi.esri.TimeSliderProperties
