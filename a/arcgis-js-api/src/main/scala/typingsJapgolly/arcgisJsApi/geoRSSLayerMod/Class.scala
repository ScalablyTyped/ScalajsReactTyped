package typingsJapgolly.arcgisJsApi.geoRSSLayerMod

import typingsJapgolly.arcgisJsApi.esri.GeoRSSLayer
import typingsJapgolly.arcgisJsApi.esri.GeoRSSLayerProperties
