...
import typingsJapgolly.arcgisJsApi.esri.RelatedRecordsInfo
import typingsJapgolly.arcgisJsApi.esri.RelatedRecordsInfoConstructor
import typingsJapgolly.arcgisJsApi.esri.RelatedRecordsInfoProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriPopupRelatedRecordsInfoMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriPopupRelatedRecordsInfoMod.foo` */
