...
import typingsJapgolly.arcgisJsApi.esri.ColorVariable
import typingsJapgolly.arcgisJsApi.esri.ColorVariableConstructor
import typingsJapgolly.arcgisJsApi.esri.ColorVariableProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriRenderersVisualVariablesColorVariableMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRenderersVisualVariablesColorVariableMod.foo` */
