package typingsJapgolly.arcgisJsApi.closestFacilityTaskMod

import typingsJapgolly.arcgisJsApi.esri.ClosestFacilityTask
import typingsJapgolly.arcgisJsApi.esri.ClosestFacilityTaskProperties
