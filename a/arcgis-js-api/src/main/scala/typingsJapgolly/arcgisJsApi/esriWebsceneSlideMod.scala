...
import typingsJapgolly.arcgisJsApi.esri.Slide
import typingsJapgolly.arcgisJsApi.esri.SlideConstructor
import typingsJapgolly.arcgisJsApi.esri.SlideProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriWebsceneSlideMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriWebsceneSlideMod.foo` */
