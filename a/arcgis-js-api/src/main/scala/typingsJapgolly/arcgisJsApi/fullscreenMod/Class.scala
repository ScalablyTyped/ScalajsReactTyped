package typingsJapgolly.arcgisJsApi.fullscreenMod

import typingsJapgolly.arcgisJsApi.esri.Fullscreen
import typingsJapgolly.arcgisJsApi.esri.FullscreenProperties
