...
import typingsJapgolly.arcgisJsApi.esri.GroupElement
...
object esriFormElementsGroupElementMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriFormElementsGroupElementMod.foo` */
