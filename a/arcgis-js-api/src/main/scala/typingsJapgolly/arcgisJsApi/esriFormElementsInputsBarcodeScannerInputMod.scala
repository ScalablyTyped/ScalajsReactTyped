...
import typingsJapgolly.arcgisJsApi.esri.BarcodeScannerInput
import typingsJapgolly.arcgisJsApi.esri.BarcodeScannerInputConstructor
import typingsJapgolly.arcgisJsApi.esri.BarcodeScannerInputProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriFormElementsInputsBarcodeScannerInputMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriFormElementsInputsBarcodeScannerInputMod.foo` */
