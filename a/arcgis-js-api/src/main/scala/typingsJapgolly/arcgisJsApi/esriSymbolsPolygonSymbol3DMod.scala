...
import typingsJapgolly.arcgisJsApi.esri.PolygonSymbol3D
...
object esriSymbolsPolygonSymbol3DMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriSymbolsPolygonSymbol3DMod.foo` */
