...
import typingsJapgolly.arcgisJsApi.esri.ImageHistogramParameters
import typingsJapgolly.arcgisJsApi.esri.ImageHistogramParametersConstructor
import typingsJapgolly.arcgisJsApi.esri.ImageHistogramParametersProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriRestSupportImageHistogramParametersMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriRestSupportImageHistogramParametersMod.foo` */
