...
import typingsJapgolly.arcgisJsApi.esri.SubtypeSublayer
import typingsJapgolly.arcgisJsApi.esri.SubtypeSublayerConstructor
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriLayersSupportSubtypeSublayerMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriLayersSupportSubtypeSublayerMod.foo` */
