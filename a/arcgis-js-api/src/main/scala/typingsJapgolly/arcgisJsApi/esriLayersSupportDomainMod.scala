...
import typingsJapgolly.arcgisJsApi.esri.Domain
import typingsJapgolly.arcgisJsApi.esri.DomainConstructor
import typingsJapgolly.arcgisJsApi.esri.DomainProperties
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object esriLayersSupportDomainMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriLayersSupportDomainMod.foo` */
