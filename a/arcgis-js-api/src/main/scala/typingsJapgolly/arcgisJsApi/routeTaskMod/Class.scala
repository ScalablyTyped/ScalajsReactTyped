package typingsJapgolly.arcgisJsApi.routeTaskMod

import typingsJapgolly.arcgisJsApi.esri.RouteTask
import typingsJapgolly.arcgisJsApi.esri.RouteTaskProperties
