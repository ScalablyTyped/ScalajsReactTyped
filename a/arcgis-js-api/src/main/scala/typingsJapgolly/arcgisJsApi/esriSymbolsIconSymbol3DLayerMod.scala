...
import typingsJapgolly.arcgisJsApi.esri.IconSymbol3DLayer
...
object esriSymbolsIconSymbol3DLayerMod extends Shortcut {
  ...
  /* This means you don't have to write `^`, but can instead just say `esriSymbolsIconSymbol3DLayerMod.foo` */
