package typingsJapgolly.arcgisJsApi.printTaskMod

import typingsJapgolly.arcgisJsApi.esri.PrintTask
import typingsJapgolly.arcgisJsApi.esri.PrintTaskProperties
