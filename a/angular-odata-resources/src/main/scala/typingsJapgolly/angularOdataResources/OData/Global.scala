...
trait Global extends StObject {
  ...
  var Property: Instantiable1[/* value */ String, typingsJapgolly.angularOdataResources.OData.Property]
  
  var Provider: typingsJapgolly.angularOdataResources.OData.Provider[Any]
