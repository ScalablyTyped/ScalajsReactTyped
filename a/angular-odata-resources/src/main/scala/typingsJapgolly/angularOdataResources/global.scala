...
import typingsJapgolly.angularOdataResources.OData.ProviderCallback
import typingsJapgolly.angularOdataResources.anon.Add
import typingsJapgolly.angularOdataResources.anon.TypeofPredicate
...
object global {
  ...
  object OData {
    ...
    open class BinaryOperation protected ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.BinaryOperation {
    ...
    open class Global protected ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.Global {
      def this(
      ...
      var Func: Instantiable2[
            /* methodName */ String, 
            /* args (repeated) */ Any, 
            typingsJapgolly.angularOdataResources.OData.MethodCall
          ] = js.native
      ...
      var OrderBy: Instantiable2[
            ...
            typingsJapgolly.angularOdataResources.OData.OrderByStatement
          ] = js.native
      ...
      var Predicate: TypeofPredicate & (Instantiable3[
            ...
            /* valueOrOperator */ js.UndefOr[Any], 
            /* value */ js.UndefOr[Any], 
            typingsJapgolly.angularOdataResources.OData.Predicate
          ]) = js.native
      ...
      /* CompleteClass */
      var Provider: typingsJapgolly.angularOdataResources.OData.Provider[Any] = js.native
    ...
    open class MethodCall protected ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.MethodCall {
    ...
    open class Operators ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.Operators {
    ...
    open class OrderByStatement protected ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.OrderByStatement {
    ...
    open class Property protected ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.Property {
    ...
    open class Provider[T] protected ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.Provider[T] {
    ...
    open class Value protected ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.Value {
    ...
    open class ValueTypes ()
      extends StObject
         with typingsJapgolly.angularOdataResources.OData.ValueTypes
    object ValueTypes {
