...
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.BasicAnimation
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.backwards
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.both
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.forwards
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.removed
...
object ATVAnimation {
  ...
  extension [Self <: ATVAnimation](x: Self) {
    ...
    inline def setAnimationDidStart(value: Callback): Self = StObject.set(x, "animationDidStart", value.toJsFn)
    
    inline def setAnimationDidStartUndefined: Self = StObject.set(x, "animationDidStart", js.undefined)
    
    inline def setAnimationDidStop(value: /* finished */ Boolean => Callback): Self = StObject.set(x, "animationDidStop", js.Any.fromFunction1((t0: /* finished */ Boolean) => value(t0).runNow()))
