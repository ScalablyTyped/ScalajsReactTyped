...
object RatingControl {
  ...
  inline def apply(hasUserSetRating: Boolean, rating: Double, show: Callback, title: String): RatingControl = {
    val __obj = js.Dynamic.literal(hasUserSetRating = hasUserSetRating.asInstanceOf[js.Any], rating = rating.asInstanceOf[js.Any], show = show.toJsFn, title = title.asInstanceOf[js.Any])
  ...
  extension [Self <: RatingControl](x: Self) {
    ...
    inline def setOnRate(value: /* selectedRating */ Double => Callback): Self = StObject.set(x, "onRate", js.Any.fromFunction1((t0: /* selectedRating */ Double) => value(t0).runNow()))
