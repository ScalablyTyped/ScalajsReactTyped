...
import typingsJapgolly.atvlegacycontentkit.atv.Node
import typingsJapgolly.atvlegacycontentkit.atv.player.events
import typingsJapgolly.atvlegacycontentkit.atv.player.states
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.HD
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.SD
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.emailAddress
import typingsJapgolly.atvlegacycontentkit.atvlegacycontentkitStrings.password
...
object global {
  ...
  object SKPaymentTransactionState extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.atvlegacycontentkit.SKPaymentTransactionState & Double] = js.native
    
    /* 4 */ val Deferred: typingsJapgolly.atvlegacycontentkit.SKPaymentTransactionState.Deferred & Double = js.native
    
    /* 2 */ val Failed: typingsJapgolly.atvlegacycontentkit.SKPaymentTransactionState.Failed & Double = js.native
    
    /* 1 */ val Purchased: typingsJapgolly.atvlegacycontentkit.SKPaymentTransactionState.Purchased & Double = js.native
    
    /* 0 */ val Purchasing: typingsJapgolly.atvlegacycontentkit.SKPaymentTransactionState.Purchasing & Double = js.native
    
    /* 3 */ val Restored: typingsJapgolly.atvlegacycontentkit.SKPaymentTransactionState.Restored & Double = js.native
  }
  ...
  open class XMLHttpRequest ()
    extends StObject
       with typingsJapgolly.atvlegacycontentkit.XMLHttpRequest
  ...
  object XMLHttpRequestState extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.atvlegacycontentkit.XMLHttpRequestState & Double] = js.native
    
    /* 4 */ val DONE: typingsJapgolly.atvlegacycontentkit.XMLHttpRequestState.DONE & Double = js.native
    
    /* 2 */ val HEADERS_RECEIVED: typingsJapgolly.atvlegacycontentkit.XMLHttpRequestState.HEADERS_RECEIVED & Double = js.native
    
    /* 3 */ val LOADING: typingsJapgolly.atvlegacycontentkit.XMLHttpRequestState.LOADING & Double = js.native
    
    /* 1 */ val OPENED: typingsJapgolly.atvlegacycontentkit.XMLHttpRequestState.OPENED & Double = js.native
    
    /* 0 */ val UNSENT: typingsJapgolly.atvlegacycontentkit.XMLHttpRequestState.UNSENT & Double = js.native
  }
  ...
  object atv {
    ...
    open class DOMView ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.DOMView
    ...
    open class FullScreenMediaBrowser ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.FullScreenMediaBrowser
    ...
    open class ImageView ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.ImageView {
      ...
      /**
        ...
        */
      /* CompleteClass */
      var subviews: js.Array[typingsJapgolly.atvlegacycontentkit.atv.View] = js.native
    }
    ...
    open class PINEntry ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.PINEntry {
    ...
    open class PopupMenu ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.PopupMenu
    ...
    open class ProxyDocument ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.ProxyDocument
    ...
    open class RatingControl ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.RatingControl {
    ...
    open class SKProductsRequest protected ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.SKProductsRequest {
      /**
    ...
    open class SKReceiptRefreshRequest protected ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.SKReceiptRefreshRequest {
      /**
    ...
    open class TextEntry ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.TextEntry {
    ...
    open class TextView ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.TextView {
    ...
    open class View ()
      extends StObject
         with typingsJapgolly.atvlegacycontentkit.atv.View {
    ...
    object player {
      ...
      object events extends StObject {
        ...
        @JSBracketAccess
        def apply(value: String): js.UndefOr[typingsJapgolly.atvlegacycontentkit.atv.player.events & String] = js.native
        
        /* "FFwd" */ val FFwd: typingsJapgolly.atvlegacycontentkit.atv.player.events.FFwd & String = js.native
        
        /* "Pause" */ val Pause: typingsJapgolly.atvlegacycontentkit.atv.player.events.Pause & String = js.native
        
        /* "Play" */ val Play: typingsJapgolly.atvlegacycontentkit.atv.player.events.Play & String = js.native
        
        /* "Rew" */ val Rew: typingsJapgolly.atvlegacycontentkit.atv.player.events.Rew & String = js.native
        
        /* "SkipFwd" */ val SkipFwd: typingsJapgolly.atvlegacycontentkit.atv.player.events.SkipFwd & String = js.native
        
        /* "SkipBack" */ val SwipBack: typingsJapgolly.atvlegacycontentkit.atv.player.events.SwipBack & String = js.native
      }
      ...
      object states extends StObject {
        ...
        @JSBracketAccess
        def apply(value: String): js.UndefOr[typingsJapgolly.atvlegacycontentkit.atv.player.states & String] = js.native
        
        /* "FastForwarding" */ val FastForwarding: typingsJapgolly.atvlegacycontentkit.atv.player.states.FastForwarding & String = js.native
        
        /* "Loading" */ val Loading: typingsJapgolly.atvlegacycontentkit.atv.player.states.Loading & String = js.native
        
        /* "Paused" */ val Paused: typingsJapgolly.atvlegacycontentkit.atv.player.states.Paused & String = js.native
        
        /* "Playing" */ val Playing: typingsJapgolly.atvlegacycontentkit.atv.player.states.Playing & String = js.native
        
        /* "Rewinding" */ val Rewinding: typingsJapgolly.atvlegacycontentkit.atv.player.states.Rewinding & String = js.native
        
        /* "Stopped" */ val Stopped: typingsJapgolly.atvlegacycontentkit.atv.player.states.Stopped & String = js.native
      }
