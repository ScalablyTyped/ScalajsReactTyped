package typingsJapgolly.algoliaCacheCommon

import typingsJapgolly.algoliaCacheCommon.anon.ReadonlyPromiseany
import typingsJapgolly.algoliaCacheCommon.anon.ReadonlyPromisevoid
