...
object global {
  ...
  object SHDocVw {
    ...
    /* private */ open class CScriptErrorList ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.CScriptErrorList {
      
      /* private */ /* CompleteClass */
      @JSName("SHDocVw.CScriptErrorList_typekey")
      var SHDocVwDotCScriptErrorList_typekey: typingsJapgolly.activexShdocvw.SHDocVw.CScriptErrorList = js.native
    ...
    /* private */ open class InternetExplorer ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.InternetExplorer
    ...
    /* private */ open class InternetExplorerMedium ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.InternetExplorerMedium
    ...
    /* private */ open class ShellBrowserWindow ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.ShellBrowserWindow
    
    @JSGlobal("SHDocVw.ShellNameSpace")
    @js.native
    /* private */ open class ShellNameSpace ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.ShellNameSpace {
      ...
      var SHDocVwDotShellNameSpace_typekey: typingsJapgolly.activexShdocvw.SHDocVw.ShellNameSpace = js.native
    ...
    /* private */ open class ShellUIHelper ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.ShellUIHelper
    ...
    /* private */ open class ShellWindows ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.ShellWindows
    ...
    /* private */ open class WebBrowser ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.WebBrowser
    ...
    /* private */ open class WebBrowserV1 ()
      extends StObject
         with typingsJapgolly.activexShdocvw.SHDocVw.WebBrowserV1
  }
}
