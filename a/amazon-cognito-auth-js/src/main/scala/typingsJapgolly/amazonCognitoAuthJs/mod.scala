...
import typingsJapgolly.amazonCognitoAuthJs.anon.ContentType
...
object mod {
  ...
  object CognitoAuthOptions {
    ...
    extension [Self <: CognitoAuthOptions](x: Self) {
      ...
      inline def setLaunchUri(value: /* url */ String => Callback): Self = StObject.set(x, "LaunchUri", js.Any.fromFunction1((t0: /* url */ String) => value(t0).runNow()))
  ...
  object CognitoAuthStorage {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getItem = js.Any.fromFunction1(getItem), removeItem = js.Any.fromFunction1((t0: String) => removeItem(t0).runNow()), setItem = js.Any.fromFunction2((t0: String, t1: String) => (setItem(t0, t1)).runNow()))
  ...
  object CognitoAuthUserHandler {
    ...
    inline def apply(onFailure: Any => Callback, onSuccess: CognitoAuthSession => Callback): CognitoAuthUserHandler = {
      val __obj = js.Dynamic.literal(onFailure = js.Any.fromFunction1((t0: Any) => onFailure(t0).runNow()), onSuccess = js.Any.fromFunction1((t0: CognitoAuthSession) => onSuccess(t0).runNow()))
      __obj.asInstanceOf[CognitoAuthUserHandler]
    }
    
    extension [Self <: CognitoAuthUserHandler](x: Self) {
      
      inline def setOnFailure(value: Any => Callback): Self = StObject.set(x, "onFailure", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
      
      inline def setOnSuccess(value: CognitoAuthSession => Callback): Self = StObject.set(x, "onSuccess", js.Any.fromFunction1((t0: CognitoAuthSession) => value(t0).runNow()))
    }
  }
  ...
  object XDomainRequest {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(abort = abort.toJsFn, onerror = onerror.toJsFn, onload = onload.toJsFn, onprogress = onprogress.toJsFn, ontimeout = ontimeout.toJsFn, open = js.Any.fromFunction2((t0: String, t1: String) => (open(t0, t1)).runNow()), responseText = responseText.asInstanceOf[js.Any], send = js.Any.fromFunction1((t0: String) => send(t0).runNow()), timeout = timeout.asInstanceOf[js.Any])
    ...
    extension [Self <: XDomainRequest](x: Self) {
      ...
      inline def setOpen(value: (String, String) => Callback): Self = StObject.set(x, "open", js.Any.fromFunction2((t0: String, t1: String) => (value(t0, t1)).runNow()))
