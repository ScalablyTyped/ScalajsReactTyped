...
object mod {
  ...
  - typingsJapgolly.assertionError.mod.Result because var conflicts: name. Inlined ok, toJSON */ @JSImport("assertion-error", "AssertionError")
  @js.native
  open class AssertionError[T] ()
    ...
    @JSName("name")
    def name_MAssertionError: typingsJapgolly.assertionError.assertionErrorStrings.AssertionError = js.native
  ...
  open class AssertionResult[T] ()
    ...
    /* CompleteClass */
    var name: typingsJapgolly.assertionError.assertionErrorStrings.AssertionError | typingsJapgolly.assertionError.assertionErrorStrings.AssertionResult = js.native
    @JSName("name")
    def name_MAssertionResult: typingsJapgolly.assertionError.assertionErrorStrings.AssertionResult = js.native
  ...
  trait Result extends StObject {
    ...
    var name: typingsJapgolly.assertionError.assertionErrorStrings.AssertionError | typingsJapgolly.assertionError.assertionErrorStrings.AssertionResult
  ...
  object Result {
    ...
    inline def apply(
      name: typingsJapgolly.assertionError.assertionErrorStrings.AssertionError | typingsJapgolly.assertionError.assertionErrorStrings.AssertionResult,
      ok: Boolean,
    ...
    extension [Self <: Result](x: Self) {
      ...
      inline def setName(
        value: typingsJapgolly.assertionError.assertionErrorStrings.AssertionError | typingsJapgolly.assertionError.assertionErrorStrings.AssertionResult
