...
object bindingMode extends StObject {
  ...
  sealed trait fromView
    extends StObject
       with bindingMode
  /* 3 */ val fromView: typingsJapgolly.aureliaBinding.mod.bindingMode.fromView & Double = js.native
  ...
  sealed trait oneTime
    extends StObject
       with bindingMode
  /* 0 */ val oneTime: typingsJapgolly.aureliaBinding.mod.bindingMode.oneTime & Double = js.native
  ...
  sealed trait oneWay
    extends StObject
       with bindingMode
  /* 1 */ val oneWay: typingsJapgolly.aureliaBinding.mod.bindingMode.oneWay & Double = js.native
  ...
  sealed trait toView
    extends StObject
       with bindingMode
  /* 1 */ val toView: typingsJapgolly.aureliaBinding.mod.bindingMode.toView & Double = js.native
  ...
  sealed trait twoWay
    extends StObject
       with bindingMode
  /* 2 */ val twoWay: typingsJapgolly.aureliaBinding.mod.bindingMode.twoWay & Double = js.native
}
