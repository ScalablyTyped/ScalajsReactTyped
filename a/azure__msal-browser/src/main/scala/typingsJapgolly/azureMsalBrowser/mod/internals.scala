...
object internals {
  ...
  open class BrowserCacheManager protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.BrowserCacheManager {
    def this(
      clientId: String,
  ...
  open class EventHandler protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.EventHandler {
    def this(logger: typingsJapgolly.azureMsalCommon.mod.Logger, browserCrypto: ICrypto) = this()
  }
  
  @JSImport("@azure/msal-browser", "internals.NativeMessageHandler")
  @js.native
  open class NativeMessageHandler protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.NativeMessageHandler {
    def this(logger: typingsJapgolly.azureMsalCommon.mod.Logger, handshakeTimeoutMs: Double) = this()
    def this(
      logger: typingsJapgolly.azureMsalCommon.mod.Logger,
  ...
  object NativeMessageHandler {
    ...
    /**
      ...
      */
    inline def createProvider(logger: typingsJapgolly.azureMsalCommon.mod.Logger, handshakeTimeoutMs: Double): js.Promise[
    ...
    /**
      ...
      */
    inline def isNativeAvailable(config: BrowserConfiguration, logger: typingsJapgolly.azureMsalCommon.mod.Logger): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isNativeAvailable")(config.asInstanceOf[js.Any], logger.asInstanceOf[js.Any])).asInstanceOf[Boolean]
    inline def isNativeAvailable(
      config: BrowserConfiguration,
      logger: typingsJapgolly.azureMsalCommon.mod.Logger,
      nativeExtensionProvider: Unit,
      authenticationScheme: typingsJapgolly.azureMsalCommon.distUtilsConstantsMod.AuthenticationScheme
  ...
  open class PopupClient protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.PopupClient {
    def this(
      config: BrowserConfiguration,
  ...
  open class RedirectClient protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.RedirectClient {
    def this(
      config: BrowserConfiguration,
      storageImpl: typingsJapgolly.azureMsalBrowser.distCacheBrowserCacheManagerMod.BrowserCacheManager,
      browserCrypto: ICrypto,
  ...
  open class RedirectHandler protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.RedirectHandler {
    def this(
  ...
  open class SilentCacheClient protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.SilentCacheClient {
    def this(
      config: BrowserConfiguration,
      storageImpl: typingsJapgolly.azureMsalBrowser.distCacheBrowserCacheManagerMod.BrowserCacheManager,
      browserCrypto: ICrypto,
  ...
  open class SilentIframeClient protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.SilentIframeClient {
    def this(
      config: BrowserConfiguration,
      storageImpl: typingsJapgolly.azureMsalBrowser.distCacheBrowserCacheManagerMod.BrowserCacheManager,
      browserCrypto: ICrypto,
      ...
      eventHandler: typingsJapgolly.azureMsalBrowser.distEventEventHandlerMod.EventHandler,
      navigationClient: INavigationClient,
      apiId: typingsJapgolly.azureMsalBrowser.distUtilsBrowserConstantsMod.ApiId,
      performanceClient: IPerformanceClient,
      nativeStorageImpl: typingsJapgolly.azureMsalBrowser.distCacheBrowserCacheManagerMod.BrowserCacheManager
    ) = this()
    def this(
  ...
  open class SilentRefreshClient protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.SilentRefreshClient {
    def this(
      config: BrowserConfiguration,
      storageImpl: typingsJapgolly.azureMsalBrowser.distCacheBrowserCacheManagerMod.BrowserCacheManager,
      browserCrypto: ICrypto,
  ...
  open class StandardInteractionClient protected ()
    extends typingsJapgolly.azureMsalBrowser.distInternalsMod.StandardInteractionClient {
    def this(
      config: BrowserConfiguration,
      storageImpl: typingsJapgolly.azureMsalBrowser.distCacheBrowserCacheManagerMod.BrowserCacheManager,
      browserCrypto: ICrypto,
