...
open class BrowserUtils ()
  extends typingsJapgolly.azureMsalBrowser.distUtilsBrowserUtilsMod.BrowserUtils
/* static members */
object BrowserUtils {
  ...
  inline def blockRedirectInIframe(
    interactionType: typingsJapgolly.azureMsalBrowser.distUtilsBrowserConstantsMod.InteractionType,
