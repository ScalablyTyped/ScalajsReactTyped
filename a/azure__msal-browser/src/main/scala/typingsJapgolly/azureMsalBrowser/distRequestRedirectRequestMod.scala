...
import typingsJapgolly.azureMsalBrowser.distEventEventMessageMod._EventPayload
...
import typingsJapgolly.azureMsalCommon.distUtilsMsalTypesMod.StringDict
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object distRequestRedirectRequestMod {
  
  /* Inlined std.Partial<std.Omit<@azure/msal-common.@azure/msal-common.CommonAuthorizationUrlRequest, 'responseMode' | 'scopes' | 'codeChallenge' | 'codeChallengeMethod' | 'requestedClaimsHash' | 'nativeBroker'>> & {  scopes :std.Array<string>,   redirectStartPage :string | undefined,   onRedirectNavigate :(url : string): boolean | void | undefined} */
  ...
  object RedirectRequest {
    ...
    inline def apply(scopes: js.Array[String]): RedirectRequest = {
    ...
    extension [Self <: RedirectRequest](x: Self) {
      ...
      inline def setRedirectStartPageUndefined: Self = StObject.set(x, "redirectStartPage", js.undefined)
