...
import typingsJapgolly.azureMsalBrowser.distAppClientApplicationMod.ClientApplication
import typingsJapgolly.azureMsalBrowser.distAppIpublicclientapplicationMod.IPublicClientApplication
