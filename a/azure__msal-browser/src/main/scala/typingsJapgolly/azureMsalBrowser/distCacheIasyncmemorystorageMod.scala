...
object distCacheIasyncmemorystorageMod {
  ...
  object IAsyncStorage {
    ...
    inline def apply[T](
      ...
      val __obj = js.Dynamic.literal(containsKey = js.Any.fromFunction1(containsKey), getItem = js.Any.fromFunction1(getItem), getKeys = getKeys.toJsFn, removeItem = js.Any.fromFunction1(removeItem), setItem = js.Any.fromFunction2(setItem))
