...
import typingsJapgolly.azureMsalBrowser.anon.RequiredBrowserAuthOption
import typingsJapgolly.azureMsalBrowser.anon.RequiredBrowserSystemOpti
import typingsJapgolly.azureMsalBrowser.anon.RequiredBrowserTelemetryO
...
import typingsJapgolly.azureMsalCommon.distConfigClientConfigurationMod.SystemOptions
