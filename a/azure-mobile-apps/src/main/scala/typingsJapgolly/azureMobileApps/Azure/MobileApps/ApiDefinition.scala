...
object ApiDefinition {
  ...
  extension [Self <: ApiDefinition](x: Self) {
    ...
    inline def setDeleteFunction3(value: (/* req */ Request, /* res */ Response, /* next */ NextMiddleware) => Callback): Self = StObject.set(x, "delete", js.Any.fromFunction3((t0: /* req */ Request, t1: /* res */ Response, t2: /* next */ NextMiddleware) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setGetFunction3(value: (/* req */ Request, /* res */ Response, /* next */ NextMiddleware) => Callback): Self = StObject.set(x, "get", js.Any.fromFunction3((t0: /* req */ Request, t1: /* res */ Response, t2: /* next */ NextMiddleware) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setPatchFunction3(value: (/* req */ Request, /* res */ Response, /* next */ NextMiddleware) => Callback): Self = StObject.set(x, "patch", js.Any.fromFunction3((t0: /* req */ Request, t1: /* res */ Response, t2: /* next */ NextMiddleware) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setPostFunction3(value: (/* req */ Request, /* res */ Response, /* next */ NextMiddleware) => Callback): Self = StObject.set(x, "post", js.Any.fromFunction3((t0: /* req */ Request, t1: /* res */ Response, t2: /* next */ NextMiddleware) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setPutFunction3(value: (/* req */ Request, /* res */ Response, /* next */ NextMiddleware) => Callback): Self = StObject.set(x, "put", js.Any.fromFunction3((t0: /* req */ Request, t1: /* res */ Response, t2: /* next */ NextMiddleware) => (value(t0, t1, t2)).runNow()))
