...
object modelExpressionAttributeValueMapMod {
  
  @JSImport("@aws-sdk/client-dynamodb-browser/model/_ExpressionAttributeValueMap", "_ExpressionAttributeValueMap")
  @js.native
  val ExpressionAttributeValueMap: Map[
