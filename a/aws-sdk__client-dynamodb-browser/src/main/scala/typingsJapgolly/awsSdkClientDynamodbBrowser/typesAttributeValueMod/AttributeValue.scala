package typingsJapgolly.awsSdkClientDynamodbBrowser.typesAttributeValueMod
...
object AttributeValue {
  @scala.inline
  def apply(
    B: scala.scalajs.js.typedarray.ArrayBuffer | scala.scalajs.js.typedarray.ArrayBufferView | String = null,
    ...
    L: js.Array[AttributeValue] | js.Iterable[AttributeValue] = null,
    M: StringDictionary[AttributeValue] | (js.Iterable[js.Tuple2[String, AttributeValue]]) = null,
    N: String = null,
    NS: js.Array[String] | js.Iterable[String] = null,
    NULL: js.UndefOr[Boolean] = js.undefined,
    S: String = null,
    SS: js.Array[String] | js.Iterable[String] = null
  ): AttributeValue = {
