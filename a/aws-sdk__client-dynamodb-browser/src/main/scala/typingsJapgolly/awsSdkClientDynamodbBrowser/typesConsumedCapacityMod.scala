...
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesCapacityMod.Capacity
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesCapacityMod.UnmarshalledCapacity
