package typingsJapgolly.awsSdkClientDynamodbBrowser.typesAutoScalingSettingsUpdateMod

import typingsJapgolly.awsSdkClientDynamodbBrowser.typesAutoScalingPolicyUpdateMod.AutoScalingPolicyUpdate
