...
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesReplicaDescriptionMod.ReplicaDescription
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesReplicaDescriptionMod.UnmarshalledReplicaDescription
