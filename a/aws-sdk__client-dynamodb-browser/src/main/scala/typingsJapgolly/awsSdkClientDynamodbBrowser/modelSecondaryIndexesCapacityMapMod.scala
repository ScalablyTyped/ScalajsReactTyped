...
object modelSecondaryIndexesCapacityMapMod {
  
  @JSImport("@aws-sdk/client-dynamodb-browser/model/_SecondaryIndexesCapacityMap", "_SecondaryIndexesCapacityMap")
  @js.native
  val SecondaryIndexesCapacityMap: Map[
