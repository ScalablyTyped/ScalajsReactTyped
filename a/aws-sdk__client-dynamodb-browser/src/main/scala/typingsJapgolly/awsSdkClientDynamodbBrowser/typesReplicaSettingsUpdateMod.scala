...
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesReplicaGlobalSecondaryIndexSettingsUpdateMod.ReplicaGlobalSecondaryIndexSettingsUpdate
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesReplicaGlobalSecondaryIndexSettingsUpdateMod.UnmarshalledReplicaGlobalSecondaryIndexSettingsUpdate
...
object typesReplicaSettingsUpdateMod {
  ...
  trait ReplicaSettingsUpdate extends StObject {
    ...
    var ReplicaGlobalSecondaryIndexSettingsUpdate: js.UndefOr[
        (js.Array[
          typingsJapgolly.awsSdkClientDynamodbBrowser.typesReplicaGlobalSecondaryIndexSettingsUpdateMod.ReplicaGlobalSecondaryIndexSettingsUpdate
        ]) | (js.Iterable[
          typingsJapgolly.awsSdkClientDynamodbBrowser.typesReplicaGlobalSecondaryIndexSettingsUpdateMod.ReplicaGlobalSecondaryIndexSettingsUpdate
        ])
      ] = js.undefined
