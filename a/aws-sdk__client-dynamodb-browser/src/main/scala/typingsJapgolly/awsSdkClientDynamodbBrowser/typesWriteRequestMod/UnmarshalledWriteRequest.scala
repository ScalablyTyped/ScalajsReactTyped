...
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesDeleteRequestMod.UnmarshalledDeleteRequest
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesPutRequestMod.UnmarshalledPutRequest
