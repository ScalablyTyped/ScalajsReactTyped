...
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesAutoScalingPolicyDescriptionMod.AutoScalingPolicyDescription
import typingsJapgolly.awsSdkClientDynamodbBrowser.typesAutoScalingPolicyDescriptionMod.UnmarshalledAutoScalingPolicyDescription
