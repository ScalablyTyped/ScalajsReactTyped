...
@JSImport("@aws-sdk/client-dynamodb-browser", "DescribeTableCommand")
@js.native
class DescribeTableCommand protected ()
  extends typingsJapgolly.awsSdkClientDynamodbBrowser.describeTableCommandMod.DescribeTableCommand {
