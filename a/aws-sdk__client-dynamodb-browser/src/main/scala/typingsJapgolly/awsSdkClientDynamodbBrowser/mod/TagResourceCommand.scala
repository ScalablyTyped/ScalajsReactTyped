...
@JSImport("@aws-sdk/client-dynamodb-browser", "TagResourceCommand")
@js.native
class TagResourceCommand protected ()
  extends typingsJapgolly.awsSdkClientDynamodbBrowser.tagResourceCommandMod.TagResourceCommand {
