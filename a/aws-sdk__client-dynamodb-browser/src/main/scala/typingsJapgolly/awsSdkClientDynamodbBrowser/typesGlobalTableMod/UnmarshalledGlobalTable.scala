package typingsJapgolly.awsSdkClientDynamodbBrowser.typesGlobalTableMod

import typingsJapgolly.awsSdkClientDynamodbBrowser.typesReplicaMod.UnmarshalledReplica
