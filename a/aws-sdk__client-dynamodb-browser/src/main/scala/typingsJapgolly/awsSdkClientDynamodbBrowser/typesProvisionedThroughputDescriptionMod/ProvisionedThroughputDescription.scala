package typingsJapgolly.awsSdkClientDynamodbBrowser.typesProvisionedThroughputDescriptionMod
...
object ProvisionedThroughputDescription {
  @scala.inline
  def apply(
    LastDecreaseDateTime: js.Date | String | Double = null,
    LastIncreaseDateTime: js.Date | String | Double = null,
