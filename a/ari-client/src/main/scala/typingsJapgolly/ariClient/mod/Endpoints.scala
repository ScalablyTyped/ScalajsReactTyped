...
import typingsJapgolly.ariClient.anon.Body
import typingsJapgolly.ariClient.anon.Tech
import typingsJapgolly.ariClient.anon.Variables
...
trait Endpoints extends StObject {
  ...
  def get(params: typingsJapgolly.ariClient.anon.Resource): js.Promise[Endpoint] = js.native
  /**
    * Details for an endpoint.
    *
    * @param [params.tech] - Technology of the endpoint.
    ...
    */
  def get(
    params: typingsJapgolly.ariClient.anon.Resource,
