...
import typingsJapgolly.ariClient.anon.ConfigClass
import typingsJapgolly.ariClient.anon.Configuration
import typingsJapgolly.ariClient.anon.Fields
import typingsJapgolly.ariClient.anon.LogChannelName
import typingsJapgolly.ariClient.anon.ModuleName
import typingsJapgolly.ariClient.anon.Only
...
trait Asterisk extends StObject {
  ...
  /**
    ...
    */
  def getGlobalVar(params: typingsJapgolly.ariClient.anon.Variable): js.Promise[Variable] = js.native
  /**
    * Get the value of a global variable.
    *
    * @param params.variable - The variable to get.
