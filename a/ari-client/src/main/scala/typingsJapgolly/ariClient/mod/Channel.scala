...
import typingsJapgolly.ariClient.anon.After
import typingsJapgolly.ariClient.anon.App
import typingsJapgolly.ariClient.anon.AppAppArgs
import typingsJapgolly.ariClient.anon.AppArgs
import typingsJapgolly.ariClient.anon.Beep
import typingsJapgolly.ariClient.anon.Caller
import typingsJapgolly.ariClient.anon.Connectiontype
import typingsJapgolly.ariClient.anon.Context
import typingsJapgolly.ariClient.anon.Direction
import typingsJapgolly.ariClient.anon.Lang
import typingsJapgolly.ariClient.anon.Media
import typingsJapgolly.ariClient.anon.MohClass
import typingsJapgolly.ariClient.anon.Reason
import typingsJapgolly.ariClient.anon.SnoopId
import typingsJapgolly.ariClient.anon.Spy
import typingsJapgolly.ariClient.anon.Value
...
trait Channel
  ...
  /**
    ...
    */
  def getChannelVar(params: typingsJapgolly.ariClient.anon.Variable): js.Promise[Variable] = js.native
  /**
    * Get the value of a channel variable or function.
    *
    * @param params.variable - The channel variable or function to get.
    */
  def getChannelVar(
    params: typingsJapgolly.ariClient.anon.Variable,
  ...
  /**
    ...
    */
  def redirect(params: typingsJapgolly.ariClient.anon.Endpoint): js.Promise[Unit] = js.native
  /**
    * Redirect the channel to a different location.
    *
    * @param params.endpoint - The endpoint to redirect the channel to.
    */
  def redirect(params: typingsJapgolly.ariClient.anon.Endpoint, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
