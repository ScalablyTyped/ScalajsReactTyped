...
import typingsJapgolly.ariClient.anon.AbsorbDTMF
...
import typingsJapgolly.ariClient.anon.Name
...
trait Bridge
  ...
  /**
    ...
    */
  def removeChannel(params: typingsJapgolly.ariClient.anon.Channel): js.Promise[Unit] = js.native
  /**
    * Remove a channel from a bridge.
    *
    * @param params.channel - Ids of channels to remove from bridge.
    */
  def removeChannel(params: typingsJapgolly.ariClient.anon.Channel, callback: js.Function1[/* err */ js.Error, Unit]): Unit = js.native
