...
import typingsJapgolly.awsSdkClientGlacierNode.typesGetDataRetrievalPolicyExceptionsUnionMod.GetDataRetrievalPolicyExceptionsUnion
...
import typingsJapgolly.awsSdkClientGlacierNode.typesListProvisionedCapacityExceptionsUnionMod.ListProvisionedCapacityExceptionsUnion
...
import typingsJapgolly.awsSdkClientGlacierNode.typesSetDataRetrievalPolicyExceptionsUnionMod.SetDataRetrievalPolicyExceptionsUnion
...
object typesServiceUnavailableExceptionMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_ServiceUnavailableExceptionDetails> * / any */ trait ServiceUnavailableException
    ...
    var name: typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.ServiceUnavailableException
  }
  object ServiceUnavailableException {
    
    inline def apply(): ServiceUnavailableException = {
    ...
    extension [Self <: ServiceUnavailableException](x: Self) {
      ...
      inline def setName(
        value: typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.ServiceUnavailableException
  ...
  object ServiceUnavailableExceptionDetails {
    ...
    inline def apply(): ServiceUnavailableExceptionDetails = {
