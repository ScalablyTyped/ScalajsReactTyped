package typingsJapgolly.awsSdkClientGlacierNode.typesS3LocationMod

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.REDUCED_REDUNDANCY
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.STANDARD
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.STANDARD_IA
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.`authenticated-read`
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.`aws-exec-read`
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.`bucket-owner-full-control`
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.`bucket-owner-read`
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.`private`
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.`public-read-write`
import typingsJapgolly.awsSdkClientGlacierNode.awsSdkClientGlacierNodeStrings.`public-read`
import typingsJapgolly.awsSdkClientGlacierNode.typesEncryptionMod.Encryption
import typingsJapgolly.awsSdkClientGlacierNode.typesGrantMod.Grant
...
trait S3Location extends js.Object {
  ...
  /**
    ...
    */
  var Encryption: js.UndefOr[typingsJapgolly.awsSdkClientGlacierNode.typesEncryptionMod.Encryption] = js.undefined
  /**
