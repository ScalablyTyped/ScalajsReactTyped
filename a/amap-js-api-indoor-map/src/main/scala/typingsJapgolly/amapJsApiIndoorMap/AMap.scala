...
import typingsJapgolly.amapJsApiIndoorMap.AMap.IndoorMap.Building
import typingsJapgolly.amapJsApiIndoorMap.AMap.IndoorMap.SearchResult
import typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapBooleans.`false`
import typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapInts.`0`
import typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapInts.`1`
...
import typingsJapgolly.amapJsApiIndoorMap.anon.Buildingid
...
object AMap {
  ...
  object IndoorMap {
    ...
    trait EventMap extends StObject {
      ...
      var complete: Event_[typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.complete, Unit]
    ...
    */
    ...
    object SearchResult {
      ...
      inline def SearchErrorResult(error: js.Error, id: String): typingsJapgolly.amapJsApiIndoorMap.AMap.IndoorMap.SearchErrorResult = {
        val __obj = js.Dynamic.literal(error = error.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], status = 1)
        __obj.asInstanceOf[typingsJapgolly.amapJsApiIndoorMap.AMap.IndoorMap.SearchErrorResult]
      }
      
      inline def SearchSuccessResult(building: Building, id: String): typingsJapgolly.amapJsApiIndoorMap.AMap.IndoorMap.SearchSuccessResult = {
        val __obj = js.Dynamic.literal(building = building.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], status = 0)
        __obj.asInstanceOf[typingsJapgolly.amapJsApiIndoorMap.AMap.IndoorMap.SearchSuccessResult]
      }
    }
    ...
    /* Rewritten from type alias, can be one of: 
      - typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.public
      - typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.connection
      - typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.shop
    */
    trait ShopCategory extends StObject
    object ShopCategory {
      
      inline def connection: typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.connection = "connection".asInstanceOf[typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.connection]
      
      inline def public: typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.public = "public".asInstanceOf[typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.public]
      
      inline def shop: typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.shop = "shop".asInstanceOf[typingsJapgolly.amapJsApiIndoorMap.amapJsApiIndoorMapStrings.shop]
    }
  }
}
