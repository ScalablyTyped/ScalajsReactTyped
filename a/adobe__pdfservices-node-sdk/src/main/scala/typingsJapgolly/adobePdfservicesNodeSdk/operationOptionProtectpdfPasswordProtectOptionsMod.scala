...
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.AES_128
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.AES_256
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.ALL_CONTENT
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.ALL_CONTENT_EXCEPT_METADATA
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.COPY_CONTENT
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.EDIT_ANNOTATIONS
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.EDIT_CONTENT
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.EDIT_DOCUMENT_ASSEMBLY
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.EDIT_FILL_AND_SIGN_FORM_FIELDS
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.PRINT_HIGH_QUALITY
import typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.PRINT_LOW_QUALITY
import typingsJapgolly.adobePdfservicesNodeSdk.operationOptionProtectpdfPermissionsMod.Permissions
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object operationOptionProtectpdfPasswordProtectOptionsMod {
  ...
  trait ContentEncryption extends StObject {
    ...
    /**
      ...
      */
    var ALL_CONTENT: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.ALL_CONTENT
    
    /**
      * Encrypts all the content except the metadata of the PDF file.
      */
    var ALL_CONTENT_EXCEPT_METADATA: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.ALL_CONTENT_EXCEPT_METADATA
  }
  ...
  trait EncryptionAlgorithm extends StObject {
    ...
    /**
      ...
      */
    var AES_128: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.AES_128
    
    /**
      * Represents AES-256 encryption algorithm.
      */
    var AES_256: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.AES_256
  }
  ...
  trait Permission extends StObject {
    ...
    /**
      ...
      */
    var COPY_CONTENT: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.COPY_CONTENT
    
    /**
      * Enables additions of comments, digital signatures and filling in of forms in a PDF document.
      */
    var EDIT_ANNOTATIONS: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.EDIT_ANNOTATIONS
    
    /**
      * Enables all the editing permissions in the PDF document except commenting and page extraction.
      */
    var EDIT_CONTENT: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.EDIT_CONTENT
    
    /**
      * Enables insertion, deletion and rotation of pages in a PDF document.
      */
    var EDIT_DOCUMENT_ASSEMBLY: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.EDIT_DOCUMENT_ASSEMBLY
    
    /**
      * Enables filling in of forms, digital signature and creation of template pages in a PDF document.
      */
    var EDIT_FILL_AND_SIGN_FORM_FIELDS: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.EDIT_FILL_AND_SIGN_FORM_FIELDS
    
    /**
      * Enables high quality printing of the PDF document.
      */
    var PRINT_HIGH_QUALITY: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.PRINT_HIGH_QUALITY
    
    /**
      * Enables low quality printing of the PDF document.
      */
    var PRINT_LOW_QUALITY: typingsJapgolly.adobePdfservicesNodeSdk.adobePdfservicesNodeSdkStrings.PRINT_LOW_QUALITY
  }
  object Permission {
