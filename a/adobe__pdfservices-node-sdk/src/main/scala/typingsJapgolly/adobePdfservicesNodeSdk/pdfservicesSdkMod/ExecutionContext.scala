...
@JSImport("@adobe/pdfservices-node-sdk/pdfservices-sdk", "ExecutionContext")
@js.native
open class ExecutionContext ()
  extends typingsJapgolly.adobePdfservicesNodeSdk.executionContextMod.ExecutionContext
/* static members */
