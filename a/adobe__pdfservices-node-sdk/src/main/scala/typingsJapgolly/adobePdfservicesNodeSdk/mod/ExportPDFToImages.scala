...
object ExportPDFToImages {
  ...
  object SupportedSourceFormat {
    ...
    @JSImport("@adobe/pdfservices-node-sdk", "ExportPDFToImages.SupportedSourceFormat")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@adobe/pdfservices-node-sdk", "ExportPDFToImages.SupportedSourceFormat.pdf")
    @js.native
  ...
  object SupportedTargetFormats {
    ...
    @JSImport("@adobe/pdfservices-node-sdk", "ExportPDFToImages.SupportedTargetFormats")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@adobe/pdfservices-node-sdk", "ExportPDFToImages.SupportedTargetFormats.JPEG")
    @js.native
    def JPEG: Any = js.native
    inline def JPEG_=(x: Any): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("JPEG")(x.asInstanceOf[js.Any])
    
    @JSImport("@adobe/pdfservices-node-sdk", "ExportPDFToImages.SupportedTargetFormats.PNG")
    @js.native
