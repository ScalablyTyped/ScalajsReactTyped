...
import typingsJapgolly.adobePdfservicesNodeSdk.authCredentialsMod.Credentials
import typingsJapgolly.adobePdfservicesNodeSdk.clientConfigMod.ClientConfig
