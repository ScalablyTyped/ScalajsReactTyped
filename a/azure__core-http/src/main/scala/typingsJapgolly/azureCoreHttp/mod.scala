...
import typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Composite
...
import typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Dictionary
import typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Enum
...
import typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Sequence
...
import typingsJapgolly.azureCoreHttp.typesLatestSrcCreateSpanLegacyMod.SpanConfig
import typingsJapgolly.azureCoreHttp.typesLatestSrcCredentialsApiKeyCredentialsMod.ApiKeyCredentialOptions
...
import typingsJapgolly.azureCoreHttp.typesLatestSrcHttpHeadersMod.RawHttpHeaders
import typingsJapgolly.azureCoreHttp.typesLatestSrcHttpOperationResponseMod.HttpOperationResponse
import typingsJapgolly.azureCoreHttp.typesLatestSrcHttpOperationResponseMod.RestResponse
import typingsJapgolly.azureCoreHttp.typesLatestSrcHttpPipelineLoggerMod.HttpPipelineLogger
import typingsJapgolly.azureCoreHttp.typesLatestSrcOperationOptionsMod.OperationOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcOperationResponseMod.OperationResponse
import typingsJapgolly.azureCoreHttp.typesLatestSrcPipelineOptionsMod.InternalPipelineOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesDeserializationPolicyMod.DeserializationContentTypes
...
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesRequestPolicyMod.RequestPolicyOptionsLike
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesTracingPolicyMod.TracingPolicyOptions
...
import typingsJapgolly.azureCoreHttp.typesLatestSrcServiceClientMod.ServiceClientOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcUtilSerializerDotcommonMod.SerializerOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcUtilUtilsMod.ServiceCallback
import typingsJapgolly.azureCoreHttp.typesLatestSrcWebResourceMod.HttpMethods
import typingsJapgolly.azureCoreHttp.typesLatestSrcWebResourceMod.RequestOptionsBase
...
object mod {
  ...
  open class AccessTokenRefresher protected ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcCredentialsAccessTokenRefresherMod.AccessTokenRefresher {
  ...
  open class ApiKeyCredentials protected ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcCredentialsApiKeyCredentialsMod.ApiKeyCredentials {
    /**
  ...
  open class BaseRequestPolicy protected ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesRequestPolicyMod.BaseRequestPolicy {
    /**
  ...
  open class BasicAuthenticationCredentials protected ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcCredentialsBasicAuthenticationCredentialsMod.BasicAuthenticationCredentials {
    /**
  ...
  open class ExpiringAccessTokenCache ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcCredentialsAccessTokenCacheMod.ExpiringAccessTokenCache {
  ...
  open class HttpHeaders ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcHttpHeadersMod.HttpHeaders {
  ...
  object HttpPipelineLogLevel extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.azureCoreHttp.typesLatestSrcHttpPipelineLogLevelMod.HttpPipelineLogLevel & Double
      ] = js.native
    
    /* 1 */ val ERROR: typingsJapgolly.azureCoreHttp.typesLatestSrcHttpPipelineLogLevelMod.HttpPipelineLogLevel.ERROR & Double = js.native
    
    /* 3 */ val INFO: typingsJapgolly.azureCoreHttp.typesLatestSrcHttpPipelineLogLevelMod.HttpPipelineLogLevel.INFO & Double = js.native
    
    /* 0 */ val OFF: typingsJapgolly.azureCoreHttp.typesLatestSrcHttpPipelineLogLevelMod.HttpPipelineLogLevel.OFF & Double = js.native
    
    /* 2 */ val WARNING: typingsJapgolly.azureCoreHttp.typesLatestSrcHttpPipelineLogLevelMod.HttpPipelineLogLevel.WARNING & Double = js.native
  }
  ...
  object MapperType {
    ...
    @js.native
    def Base64Url: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Base64Url = js.native
    ...
    @js.native
    def Boolean: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Boolean = js.native
    ...
    @js.native
    def ByteArray: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.ByteArray = js.native
    ...
    @js.native
    def Composite: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Composite = js.native
    ...
    @js.native
    def Date: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Date = js.native
    
    @JSImport("@azure/core-http", "MapperType.DateTime")
    @js.native
    def DateTime: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.DateTime = js.native
    
    @JSImport("@azure/core-http", "MapperType.DateTimeRfc1123")
    @js.native
    def DateTimeRfc1123: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.DateTimeRfc1123 = js.native
    ...
    @js.native
    def Dictionary: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Dictionary = js.native
    ...
    @js.native
    def Enum: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Enum = js.native
    ...
    @js.native
    def Number: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Number = js.native
    ...
    @js.native
    def Object: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Object = js.native
    ...
    @js.native
    def Sequence: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Sequence = js.native
    ...
    @js.native
    def Stream: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.Stream = js.native
    ...
    @js.native
    def String: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.String = js.native
    inline def String_=(x: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.String): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("String")(x.asInstanceOf[js.Any])
    
    @JSImport("@azure/core-http", "MapperType.TimeSpan")
    @js.native
    def TimeSpan: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.TimeSpan = js.native
    ...
    @js.native
    def UnixTime: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.UnixTime = js.native
  ...
  object QueryCollectionFormat extends StObject {
    ...
    def apply(value: String): js.UndefOr[
        typingsJapgolly.azureCoreHttp.typesLatestSrcQueryCollectionFormatMod.QueryCollectionFormat & String
      ] = js.native
  ...
  open class RequestPolicyOptions ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesRequestPolicyMod.RequestPolicyOptions {
  ...
  open class RestError protected ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcRestErrorMod.RestError {
  ...
  object RetryMode extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesExponentialRetryPolicyMod.RetryMode & Double
      ] = js.native
    
    /* 0 */ val Exponential: typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesExponentialRetryPolicyMod.RetryMode.Exponential & Double = js.native
  }
  
  @JSImport("@azure/core-http", "Serializer")
  @js.native
  open class Serializer ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcSerializerMod.Serializer {
    def this(/**
  ...
  open class ServiceClient ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcServiceClientMod.ServiceClient {
  ...
  open class TopicCredentials protected ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcCredentialsTopicCredentialsMod.TopicCredentials {
    /**
  ...
  open class URLBuilder ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcUrlMod.URLBuilder
  /* static members */
  object URLBuilder {
    ...
    /**
      ...
      */
    inline def parse(text: String): typingsJapgolly.azureCoreHttp.typesLatestSrcUrlMod.URLBuilder = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(text.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.azureCoreHttp.typesLatestSrcUrlMod.URLBuilder]
  }
  
  @JSImport("@azure/core-http", "URLQuery")
  @js.native
  open class URLQuery ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcUrlMod.URLQuery
  /* static members */
  object URLQuery {
    ...
    /**
      ...
      */
    inline def parse(text: String): typingsJapgolly.azureCoreHttp.typesLatestSrcUrlMod.URLQuery = ^.asInstanceOf[js.Dynamic].applyDynamic("parse")(text.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.azureCoreHttp.typesLatestSrcUrlMod.URLQuery]
  }
  
  @JSImport("@azure/core-http", "WebResource")
  @js.native
  open class WebResource protected ()
    extends typingsJapgolly.azureCoreHttp.typesLatestSrcWebResourceMod.WebResource {
    def this(
