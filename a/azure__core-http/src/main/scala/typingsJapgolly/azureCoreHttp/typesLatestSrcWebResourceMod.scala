...
import typingsJapgolly.azureAbortController.typesSrcAbortSignalMod.AbortSignalLike
...
import typingsJapgolly.azureCoreHttp.typesLatestSrcOperationResponseMod.OperationResponse
import typingsJapgolly.azureCoreHttp.typesLatestSrcOperationSpecMod.OperationSpec
...
import typingsJapgolly.azureCoreHttp.typesLatestSrcUtilSerializerDotcommonMod.SerializerOptions
...
object typesLatestSrcWebResourceMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.GET
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PUT
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.POST
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.DELETE
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PATCH
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.HEAD
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.OPTIONS
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.TRACE
  */
  trait HttpMethods extends StObject
  object HttpMethods {
    
    inline def DELETE: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.DELETE = "DELETE".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.DELETE]
    
    inline def GET: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.GET = "GET".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.GET]
    
    inline def HEAD: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.HEAD = "HEAD".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.HEAD]
    
    inline def OPTIONS: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.OPTIONS = "OPTIONS".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.OPTIONS]
    
    inline def PATCH: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PATCH = "PATCH".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PATCH]
    
    inline def POST: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.POST = "POST".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.POST]
    
    inline def PUT: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PUT = "PUT".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PUT]
    
    inline def TRACE: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.TRACE = "TRACE".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.TRACE]
  }
  ...
  object RequestOptionsBase {
    ...
    extension [Self <: RequestOptionsBase](x: Self) {
      ...
      inline def setOnDownloadProgress(value: /* progress */ TransferProgressEvent => Callback): Self = StObject.set(x, "onDownloadProgress", js.Any.fromFunction1((t0: /* progress */ TransferProgressEvent) => value(t0).runNow()))
      
      inline def setOnDownloadProgressUndefined: Self = StObject.set(x, "onDownloadProgress", js.undefined)
      
      inline def setOnUploadProgress(value: /* progress */ TransferProgressEvent => Callback): Self = StObject.set(x, "onUploadProgress", js.Any.fromFunction1((t0: /* progress */ TransferProgressEvent) => value(t0).runNow()))
  ...
  object WebResourceLike {
    ...
    inline def apply(
      ...
      timeout: Double,
      url: String,
      validateRequestProperties: Callback,
      withCredentials: Boolean
    ): WebResourceLike = {
      val __obj = js.Dynamic.literal(headers = headers.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], prepare = js.Any.fromFunction1(prepare), requestId = requestId.asInstanceOf[js.Any], timeout = timeout.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any], validateRequestProperties = validateRequestProperties.toJsFn, withCredentials = withCredentials.asInstanceOf[js.Any])
    ...
    extension [Self <: WebResourceLike](x: Self) {
      ...
      inline def setValidateRequestProperties(value: Callback): Self = StObject.set(x, "validateRequestProperties", value.toJsFn)
