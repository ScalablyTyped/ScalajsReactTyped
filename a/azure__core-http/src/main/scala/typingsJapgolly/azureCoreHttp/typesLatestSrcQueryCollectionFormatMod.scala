...
object typesLatestSrcQueryCollectionFormatMod {
  ...
  object QueryCollectionFormat extends StObject {
    ...
    /* "," */ val Csv: typingsJapgolly.azureCoreHttp.typesLatestSrcQueryCollectionFormatMod.QueryCollectionFormat.Csv & String = js.native
    ...
    sealed trait Multi
      extends StObject
         with QueryCollectionFormat
    /* "Multi" */ val Multi: typingsJapgolly.azureCoreHttp.typesLatestSrcQueryCollectionFormatMod.QueryCollectionFormat.Multi & String = js.native
    ...
    sealed trait Pipes
      extends StObject
         with QueryCollectionFormat
    /* "|" */ val Pipes: typingsJapgolly.azureCoreHttp.typesLatestSrcQueryCollectionFormatMod.QueryCollectionFormat.Pipes & String = js.native
    ...
    sealed trait Ssv
      extends StObject
         with QueryCollectionFormat
    /* " " */ val Ssv: typingsJapgolly.azureCoreHttp.typesLatestSrcQueryCollectionFormatMod.QueryCollectionFormat.Ssv & String = js.native
    ...
    sealed trait Tsv
      extends StObject
         with QueryCollectionFormat
    /* "\t" */ val Tsv: typingsJapgolly.azureCoreHttp.typesLatestSrcQueryCollectionFormatMod.QueryCollectionFormat.Tsv & String = js.native
  }
}
