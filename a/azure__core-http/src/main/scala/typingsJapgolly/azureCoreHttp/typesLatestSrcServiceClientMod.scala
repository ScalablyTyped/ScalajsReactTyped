...
import typingsJapgolly.azureCoreHttp.typesLatestSrcOperationArgumentsMod.OperationArguments
import typingsJapgolly.azureCoreHttp.typesLatestSrcOperationParameterMod.ParameterPath
...
import typingsJapgolly.azureCoreHttp.typesLatestSrcWebResourceMod.RequestPrepareOptions
