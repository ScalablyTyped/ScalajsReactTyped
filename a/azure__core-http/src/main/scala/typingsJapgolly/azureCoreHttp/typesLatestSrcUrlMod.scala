...
object typesLatestSrcUrlMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.SCHEME
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.HOST
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PORT
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PATH
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.QUERY
  */
  trait URLTokenType extends StObject
  object URLTokenType {
    
    inline def HOST: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.HOST = "HOST".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.HOST]
    
    inline def PATH: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PATH = "PATH".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PATH]
    
    inline def PORT: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PORT = "PORT".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PORT]
    
    inline def QUERY: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.QUERY = "QUERY".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.QUERY]
    
    inline def SCHEME: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.SCHEME = "SCHEME".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.SCHEME]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.SCHEME
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.SCHEME_OR_HOST
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.HOST
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PORT
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.PATH
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.QUERY
    - typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.DONE
  */
  trait URLTokenizerState extends StObject
  object URLTokenizerState {
    
    inline def DONE: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.DONE = "DONE".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.DONE]
    ...
    inline def SCHEME_OR_HOST: typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.SCHEME_OR_HOST = "SCHEME_OR_HOST".asInstanceOf[typingsJapgolly.azureCoreHttp.azureCoreHttpStrings.SCHEME_OR_HOST]
  }
}
