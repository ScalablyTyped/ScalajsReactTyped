...
import typingsJapgolly.azureCoreHttp.typesLatestSrcHttpClientMod.HttpClient
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesDeserializationPolicyMod.DeserializationOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesExponentialRetryPolicyMod.RetryOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesKeepAlivePolicyMod.KeepAliveOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesLogPolicyMod.LogPolicyOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesRedirectPolicyMod.RedirectOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcPoliciesUserAgentPolicyMod.UserAgentOptions
import typingsJapgolly.azureCoreHttp.typesLatestSrcServiceClientMod.ProxyOptions
