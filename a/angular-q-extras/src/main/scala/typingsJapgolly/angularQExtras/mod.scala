  ...
  object angularAugmentingMod {
    ...
    */
    ...
    object PromiseState {
      ...
      inline def fulfilled: typingsJapgolly.angularQExtras.angularQExtrasStrings.fulfilled = "fulfilled".asInstanceOf[typingsJapgolly.angularQExtras.angularQExtrasStrings.fulfilled]
      
      inline def rejected: typingsJapgolly.angularQExtras.angularQExtrasStrings.rejected = "rejected".asInstanceOf[typingsJapgolly.angularQExtras.angularQExtrasStrings.rejected]
    }
