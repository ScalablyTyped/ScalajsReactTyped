...
import typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.all
import typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.base
...
import typingsJapgolly.amapJsApiTransfer.anon.Destination
import typingsJapgolly.amapJsApiTransfer.anon.Info
...
object Transfer {
  ...
  trait EventMap extends StObject {
    ...
    var error: Event_[typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.error, Info]
  }
  object EventMap {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.amapJsApiTransfer.AMap.Transfer.RailwayDetailsBase
    - typingsJapgolly.amapJsApiTransfer.AMap.Transfer.RailwayDetailsExt
  */
  ...
  object RailwayDetails {
    ...
    inline def RailwayDetailsBase(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.amapJsApiTransfer.AMap.Transfer.RailwayDetailsBase]
    }
    ...
    inline def RailwayDetailsExt(
      ...
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.amapJsApiTransfer.AMap.Transfer.RailwayDetailsExt]
    }
  }
  ...
  - typingsJapgolly.amapJsApiTransfer.AMap.Transfer.RailwayDetails because Already inherited */ trait RailwayDetailsExt
    extends StObject
  ...
  */
  ...
  object SearchResult {
    ...
    inline def SearchResultBase(
      ...
      __obj.asInstanceOf[typingsJapgolly.amapJsApiTransfer.AMap.Transfer.SearchResultBase]
    }
    ...
    inline def SearchResultExt(
      ...
      __obj.asInstanceOf[typingsJapgolly.amapJsApiTransfer.AMap.Transfer.SearchResultExt]
    }
  }
  ...
  */
  ...
  object SearchStatus {
    ...
    inline def complete: typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.complete = "complete".asInstanceOf[typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.complete]
    
    inline def error: typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.error = "error".asInstanceOf[typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.error]
    
    inline def no_data: typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.no_data = "no_data".asInstanceOf[typingsJapgolly.amapJsApiTransfer.amapJsApiTransferStrings.no_data]
  }
  ...
  */
  ...
  object Segment {
    ...
    inline def RailwaySegment(distance: Double, instruction: String, time: Double, transit: RailwayDetails): typingsJapgolly.amapJsApiTransfer.AMap.Transfer.RailwaySegment = {
      val __obj = js.Dynamic.literal(distance = distance.asInstanceOf[js.Any], instruction = instruction.asInstanceOf[js.Any], time = time.asInstanceOf[js.Any], transit = transit.asInstanceOf[js.Any], transit_mode = "RAILWAY")
      __obj.asInstanceOf[typingsJapgolly.amapJsApiTransfer.AMap.Transfer.RailwaySegment]
    }
    
    inline def TaxiSegment(distance: Double, instruction: String, time: Double, transit: TaxiDetails): typingsJapgolly.amapJsApiTransfer.AMap.Transfer.TaxiSegment = {
      ...
      __obj.asInstanceOf[typingsJapgolly.amapJsApiTransfer.AMap.Transfer.TaxiSegment]
    }
    ...
    inline def TransitSegment(
      ...
      __obj.asInstanceOf[typingsJapgolly.amapJsApiTransfer.AMap.Transfer.TransitSegment]
    }
    
    inline def WalkSegment(distance: Double, instruction: String, time: Double, transit: WalkDetails): typingsJapgolly.amapJsApiTransfer.AMap.Transfer.WalkSegment = {
      ...
      __obj.asInstanceOf[typingsJapgolly.amapJsApiTransfer.AMap.Transfer.WalkSegment]
    }
  }
