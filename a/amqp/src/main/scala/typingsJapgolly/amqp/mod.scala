...
import typingsJapgolly.amqp.amqpInts.`0`
import typingsJapgolly.amqp.amqpInts.`1`
import typingsJapgolly.amqp.amqpInts.`2`
import typingsJapgolly.amqp.amqpInts.`3`
import typingsJapgolly.amqp.amqpInts.`4`
import typingsJapgolly.amqp.amqpInts.`5`
import typingsJapgolly.amqp.amqpInts.`6`
import typingsJapgolly.amqp.amqpInts.`7`
import typingsJapgolly.amqp.amqpInts.`8`
import typingsJapgolly.amqp.amqpInts.`9`
import typingsJapgolly.amqp.amqpStrings.ack
import typingsJapgolly.amqp.amqpStrings.direct
import typingsJapgolly.amqp.amqpStrings.error
import typingsJapgolly.amqp.amqpStrings.exchangeBindOk
import typingsJapgolly.amqp.amqpStrings.exchangeUnbindOk
import typingsJapgolly.amqp.amqpStrings.fanout
import typingsJapgolly.amqp.amqpStrings.open
import typingsJapgolly.amqp.amqpStrings.topic
import typingsJapgolly.amqp.anon.ApplicationName
import typingsJapgolly.amqp.anon.CaFile
...
object mod {
  ...
  object Ack {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(acknowledge = js.Any.fromFunction1((t0: Boolean) => acknowledge(t0).runNow()), consumerTag = consumerTag.asInstanceOf[js.Any], contentType = contentType.asInstanceOf[js.Any], deliveryTag = deliveryTag.asInstanceOf[js.Any], exchange = exchange.asInstanceOf[js.Any], queue = queue.asInstanceOf[js.Any], redelivered = redelivered.asInstanceOf[js.Any], reject = js.Any.fromFunction1((t0: Boolean) => reject(t0).runNow()), routingKey = routingKey.asInstanceOf[js.Any])
      __obj.asInstanceOf[Ack]
    }
    
    extension [Self <: Ack](x: Self) {
      
      inline def setAcknowledge(value: Boolean => japgolly.scalajs.react.Callback): Self = StObject.set(x, "acknowledge", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
      
      inline def setReject(value: Boolean => japgolly.scalajs.react.Callback): Self = StObject.set(x, "reject", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
    }
  }
