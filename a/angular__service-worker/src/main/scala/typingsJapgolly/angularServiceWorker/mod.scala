...
import typingsJapgolly.angularServiceWorker.angularServiceWorkerStrings.NO_NEW_VERSION_DETECTED
import typingsJapgolly.angularServiceWorker.angularServiceWorkerStrings.UNRECOVERABLE_STATE
import typingsJapgolly.angularServiceWorker.angularServiceWorkerStrings.UPDATE_ACTIVATED
import typingsJapgolly.angularServiceWorker.angularServiceWorkerStrings.UPDATE_AVAILABLE
import typingsJapgolly.angularServiceWorker.angularServiceWorkerStrings.VERSION_DETECTED
import typingsJapgolly.angularServiceWorker.angularServiceWorkerStrings.VERSION_INSTALLATION_FAILED
import typingsJapgolly.angularServiceWorker.angularServiceWorkerStrings.VERSION_READY
import typingsJapgolly.angularServiceWorker.anon.Action
import typingsJapgolly.angularServiceWorker.anon.AppData
import typingsJapgolly.angularServiceWorker.anon.Hash
import typingsJapgolly.angularServiceWorker.anon.ServerPublicKey
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularServiceWorker.mod.VersionDetectedEvent
    - typingsJapgolly.angularServiceWorker.mod.VersionInstallationFailedEvent
    - typingsJapgolly.angularServiceWorker.mod.VersionReadyEvent
    - typingsJapgolly.angularServiceWorker.mod.NoNewVersionDetectedEvent
  */
  trait VersionEvent extends StObject
  object VersionEvent {
    
    inline def NoNewVersionDetectedEvent(version: AppData): typingsJapgolly.angularServiceWorker.mod.NoNewVersionDetectedEvent = {
      val __obj = js.Dynamic.literal(version = version.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("NO_NEW_VERSION_DETECTED")
      __obj.asInstanceOf[typingsJapgolly.angularServiceWorker.mod.NoNewVersionDetectedEvent]
    }
    
    inline def VersionDetectedEvent(version: Hash): typingsJapgolly.angularServiceWorker.mod.VersionDetectedEvent = {
      val __obj = js.Dynamic.literal(version = version.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("VERSION_DETECTED")
      __obj.asInstanceOf[typingsJapgolly.angularServiceWorker.mod.VersionDetectedEvent]
    }
    
    inline def VersionInstallationFailedEvent(error: String, version: Hash): typingsJapgolly.angularServiceWorker.mod.VersionInstallationFailedEvent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.angularServiceWorker.mod.VersionInstallationFailedEvent]
    }
    
    inline def VersionReadyEvent(currentVersion: Hash, latestVersion: Hash): typingsJapgolly.angularServiceWorker.mod.VersionReadyEvent = {
      ...
      __obj.asInstanceOf[typingsJapgolly.angularServiceWorker.mod.VersionReadyEvent]
    }
  }
