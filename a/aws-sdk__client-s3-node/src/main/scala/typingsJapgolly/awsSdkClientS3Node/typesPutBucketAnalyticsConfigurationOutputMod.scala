...
@JSImport("@aws-sdk/client-s3-node/types/PutBucketAnalyticsConfigurationOutput", JSImport.Namespace)
@js.native
object typesPutBucketAnalyticsConfigurationOutputMod extends js.Object {
  @js.native
