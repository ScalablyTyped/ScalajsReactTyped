...
import typingsJapgolly.awsSdkClientS3Node.typesCsvinputMod.CSVInput
import typingsJapgolly.awsSdkClientS3Node.typesJsoninputMod.JSONInput
import typingsJapgolly.awsSdkClientS3Node.typesParquetInputMod.ParquetInput
