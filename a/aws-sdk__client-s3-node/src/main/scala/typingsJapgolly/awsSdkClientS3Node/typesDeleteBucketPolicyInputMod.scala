...
object typesDeleteBucketPolicyInputMod {
  
  trait DeleteBucketPolicyInput
    extends StObject
  ...
  object DeleteBucketPolicyInput {
    ...
    inline def apply(Bucket: String): DeleteBucketPolicyInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[DeleteBucketPolicyInput]
    }
    
    extension [Self <: DeleteBucketPolicyInput](x: Self) {
