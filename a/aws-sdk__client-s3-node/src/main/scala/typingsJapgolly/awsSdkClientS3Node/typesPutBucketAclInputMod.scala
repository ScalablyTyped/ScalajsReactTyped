...
@JSImport("@aws-sdk/client-s3-node/types/PutBucketAclInput", JSImport.Namespace)
@js.native
object typesPutBucketAclInputMod extends js.Object {
  @js.native
  trait PutBucketAclInput extends _InputTypesUnion {
    ...
    var AccessControlPolicy: js.UndefOr[
        typingsJapgolly.awsSdkClientS3Node.typesAccessControlPolicyMod.AccessControlPolicy
      ] = js.native
    /**
      * _BucketName shape
      */
