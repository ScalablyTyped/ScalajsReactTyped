...
import typingsJapgolly.awsSdkClientS3Node.typesGlacierJobParametersMod.GlacierJobParameters
import typingsJapgolly.awsSdkClientS3Node.typesOutputLocationMod.OutputLocation
import typingsJapgolly.awsSdkClientS3Node.typesSelectParametersMod.SelectParameters
...
trait RestoreRequest extends js.Object {
  ...
  var GlacierJobParameters: js.UndefOr[
    typingsJapgolly.awsSdkClientS3Node.typesGlacierJobParametersMod.GlacierJobParameters
  ] = js.undefined
  /**
    * <p>Describes the location where the restore job's output is stored.</p>
    */
  var OutputLocation: js.UndefOr[typingsJapgolly.awsSdkClientS3Node.typesOutputLocationMod.OutputLocation] = js.undefined
  /**
    * <p>Describes the parameters for Select job types.</p>
    */
  var SelectParameters: js.UndefOr[typingsJapgolly.awsSdkClientS3Node.typesSelectParametersMod.SelectParameters] = js.undefined
  /**
