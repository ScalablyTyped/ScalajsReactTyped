...
import typingsJapgolly.awsSdkClientS3Node.typesPutBucketLoggingInputMod.PutBucketLoggingInput
import typingsJapgolly.awsSdkClientS3Node.typesPutBucketLoggingOutputMod.PutBucketLoggingOutput
