...
@JSImport("@aws-sdk/client-s3-node/types/DeleteBucketMetricsConfigurationOutput", JSImport.Namespace)
@js.native
object typesDeleteBucketMetricsConfigurationOutputMod extends js.Object {
  @js.native
