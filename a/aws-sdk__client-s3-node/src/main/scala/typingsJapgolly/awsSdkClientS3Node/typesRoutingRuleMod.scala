...
import typingsJapgolly.awsSdkClientS3Node.typesConditionMod.Condition
import typingsJapgolly.awsSdkClientS3Node.typesConditionMod.UnmarshalledCondition
import typingsJapgolly.awsSdkClientS3Node.typesRedirectMod.Redirect
import typingsJapgolly.awsSdkClientS3Node.typesRedirectMod.UnmarshalledRedirect
...
object typesRoutingRuleMod {
  ...
  trait RoutingRule extends StObject {
    ...
    /**
      ...
      */
    var Condition: js.UndefOr[typingsJapgolly.awsSdkClientS3Node.typesConditionMod.Condition] = js.undefined
    ...
    /**
      ...
      */
    var Redirect: typingsJapgolly.awsSdkClientS3Node.typesRedirectMod.Redirect
  }
  object RoutingRule {
