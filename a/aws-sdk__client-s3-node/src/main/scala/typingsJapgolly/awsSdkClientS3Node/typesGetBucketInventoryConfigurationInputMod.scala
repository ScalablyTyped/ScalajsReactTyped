...
@JSImport("@aws-sdk/client-s3-node/types/GetBucketInventoryConfigurationInput", JSImport.Namespace)
@js.native
object typesGetBucketInventoryConfigurationInputMod extends js.Object {
  @js.native
  trait GetBucketInventoryConfigurationInput extends _InputTypesUnion {
    /**
