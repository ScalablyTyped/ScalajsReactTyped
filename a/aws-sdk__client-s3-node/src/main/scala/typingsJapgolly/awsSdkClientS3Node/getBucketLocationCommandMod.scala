...
import typingsJapgolly.awsSdkClientS3Node.typesGetBucketLocationInputMod.GetBucketLocationInput
import typingsJapgolly.awsSdkClientS3Node.typesGetBucketLocationOutputMod.GetBucketLocationOutput
