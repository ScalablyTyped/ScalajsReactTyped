...
@JSImport("@aws-sdk/client-s3-node/types/GetBucketNotificationConfigurationInput", JSImport.Namespace)
@js.native
object typesGetBucketNotificationConfigurationInputMod extends js.Object {
  @js.native
