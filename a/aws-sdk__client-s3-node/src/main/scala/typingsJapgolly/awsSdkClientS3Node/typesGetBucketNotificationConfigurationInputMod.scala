...
object typesGetBucketNotificationConfigurationInputMod {
  
  trait GetBucketNotificationConfigurationInput
    extends StObject
  ...
  object GetBucketNotificationConfigurationInput {
    ...
    inline def apply(Bucket: String): GetBucketNotificationConfigurationInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetBucketNotificationConfigurationInput]
    }
    
    extension [Self <: GetBucketNotificationConfigurationInput](x: Self) {
