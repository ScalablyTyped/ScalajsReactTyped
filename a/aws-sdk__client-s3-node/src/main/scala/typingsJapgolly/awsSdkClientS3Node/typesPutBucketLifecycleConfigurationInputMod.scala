...
import typingsJapgolly.awsSdkClientS3Node.typesBucketLifecycleConfigurationMod.BucketLifecycleConfiguration
...
object typesPutBucketLifecycleConfigurationInputMod {
  ...
  trait PutBucketLifecycleConfigurationInput
    extends StObject
  ...
  object PutBucketLifecycleConfigurationInput {
    ...
    inline def apply(Bucket: String): PutBucketLifecycleConfigurationInput = {
      val __obj = js.Dynamic.literal(Bucket = Bucket.asInstanceOf[js.Any])
      __obj.asInstanceOf[PutBucketLifecycleConfigurationInput]
    }
    
    extension [Self <: PutBucketLifecycleConfigurationInput](x: Self) {
