...
@JSImport("@aws-sdk/client-s3-node/types/PutBucketAccelerateConfigurationOutput", JSImport.Namespace)
@js.native
object typesPutBucketAccelerateConfigurationOutputMod extends js.Object {
  @js.native
