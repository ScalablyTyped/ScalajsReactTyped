...
import typingsJapgolly.awsSdkClientS3Node.typesDeleteBucketReplicationOutputMod.DeleteBucketReplicationOutput
...
import typingsJapgolly.awsSdkClientS3Node.typesUploadPartCopyOutputMod.UploadPartCopyOutput
