package typingsJapgolly.awsSdkClientS3Node.typesCompletedMultipartUploadMod

import typingsJapgolly.awsSdkClientS3Node.typesCompletedPartMod.CompletedPart
