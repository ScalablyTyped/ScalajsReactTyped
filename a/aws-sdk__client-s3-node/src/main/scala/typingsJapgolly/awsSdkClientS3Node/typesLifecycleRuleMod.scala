...
import typingsJapgolly.awsSdkClientS3Node.typesAbortIncompleteMultipartUploadMod.UnmarshalledAbortIncompleteMultipartUpload
import typingsJapgolly.awsSdkClientS3Node.typesLifecycleExpirationMod.LifecycleExpiration
import typingsJapgolly.awsSdkClientS3Node.typesLifecycleExpirationMod.UnmarshalledLifecycleExpiration
import typingsJapgolly.awsSdkClientS3Node.typesLifecycleRuleFilterMod.LifecycleRuleFilter
import typingsJapgolly.awsSdkClientS3Node.typesLifecycleRuleFilterMod.UnmarshalledLifecycleRuleFilter
import typingsJapgolly.awsSdkClientS3Node.typesNoncurrentVersionExpirationMod.NoncurrentVersionExpiration
import typingsJapgolly.awsSdkClientS3Node.typesNoncurrentVersionExpirationMod.UnmarshalledNoncurrentVersionExpiration
import typingsJapgolly.awsSdkClientS3Node.typesNoncurrentVersionTransitionMod.NoncurrentVersionTransition
import typingsJapgolly.awsSdkClientS3Node.typesNoncurrentVersionTransitionMod.UnmarshalledNoncurrentVersionTransition
import typingsJapgolly.awsSdkClientS3Node.typesTransitionMod.Transition
import typingsJapgolly.awsSdkClientS3Node.typesTransitionMod.UnmarshalledTransition
