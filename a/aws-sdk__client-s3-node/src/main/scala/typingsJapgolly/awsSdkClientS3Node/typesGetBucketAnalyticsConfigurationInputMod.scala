...
@JSImport("@aws-sdk/client-s3-node/types/GetBucketAnalyticsConfigurationInput", JSImport.Namespace)
@js.native
object typesGetBucketAnalyticsConfigurationInputMod extends js.Object {
  @js.native
