...
object typesNoSuchBucketMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_NoSuchBucketDetails> * / any */ trait NoSuchBucket extends StObject {
    ...
    var name: typingsJapgolly.awsSdkClientS3Node.awsSdkClientS3NodeStrings.NoSuchBucket
  }
  object NoSuchBucket {
    ...
    extension [Self <: NoSuchBucket](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.awsSdkClientS3Node.awsSdkClientS3NodeStrings.NoSuchBucket): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
