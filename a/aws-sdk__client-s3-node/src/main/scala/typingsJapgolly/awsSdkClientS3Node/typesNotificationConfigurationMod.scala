...
import typingsJapgolly.awsSdkClientS3Node.typesLambdaFunctionConfigurationMod.LambdaFunctionConfiguration
import typingsJapgolly.awsSdkClientS3Node.typesLambdaFunctionConfigurationMod.UnmarshalledLambdaFunctionConfiguration
import typingsJapgolly.awsSdkClientS3Node.typesQueueConfigurationMod.QueueConfiguration
import typingsJapgolly.awsSdkClientS3Node.typesQueueConfigurationMod.UnmarshalledQueueConfiguration
import typingsJapgolly.awsSdkClientS3Node.typesTopicConfigurationMod.TopicConfiguration
