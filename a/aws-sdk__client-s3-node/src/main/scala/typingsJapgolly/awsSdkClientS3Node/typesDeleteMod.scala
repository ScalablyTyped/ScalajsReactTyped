...
import typingsJapgolly.awsSdkClientS3Node.typesObjectIdentifierMod.ObjectIdentifier
import typingsJapgolly.awsSdkClientS3Node.typesObjectIdentifierMod.UnmarshalledObjectIdentifier
