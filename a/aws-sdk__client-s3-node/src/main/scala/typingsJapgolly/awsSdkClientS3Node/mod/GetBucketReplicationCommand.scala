...
@JSImport("@aws-sdk/client-s3-node", "GetBucketReplicationCommand")
@js.native
class GetBucketReplicationCommand protected ()
  extends typingsJapgolly.awsSdkClientS3Node.getBucketReplicationCommandMod.GetBucketReplicationCommand {
