...
@JSImport("@aws-sdk/client-s3-node", "PutBucketLifecycleConfigurationCommand")
@js.native
open class PutBucketLifecycleConfigurationCommand protected ()
  extends typingsJapgolly.awsSdkClientS3Node.commandsPutBucketLifecycleConfigurationCommandMod.PutBucketLifecycleConfigurationCommand {
