...
@JSImport("@aws-sdk/client-s3-node/types/DeleteBucketInventoryConfigurationInput", JSImport.Namespace)
@js.native
object typesDeleteBucketInventoryConfigurationInputMod extends js.Object {
  @js.native
