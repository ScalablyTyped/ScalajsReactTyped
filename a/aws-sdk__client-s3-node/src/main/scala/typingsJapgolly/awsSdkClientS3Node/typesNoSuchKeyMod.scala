...
object typesNoSuchKeyMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_NoSuchKeyDetails> * / any */ trait NoSuchKey extends StObject {
    ...
    var name: typingsJapgolly.awsSdkClientS3Node.awsSdkClientS3NodeStrings.NoSuchKey
  }
  object NoSuchKey {
    ...
    extension [Self <: NoSuchKey](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.awsSdkClientS3Node.awsSdkClientS3NodeStrings.NoSuchKey): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
