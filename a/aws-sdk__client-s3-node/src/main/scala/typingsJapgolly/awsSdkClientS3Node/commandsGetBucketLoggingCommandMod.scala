...
import typingsJapgolly.awsSdkClientS3Node.typesGetBucketLoggingInputMod.GetBucketLoggingInput
import typingsJapgolly.awsSdkClientS3Node.typesGetBucketLoggingOutputMod.GetBucketLoggingOutput
