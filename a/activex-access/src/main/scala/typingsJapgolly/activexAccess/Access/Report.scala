...
trait Report extends StObject {
  ...
  /* private */ @JSName("Access.Report_typekey")
  var AccessDotReport_typekey: typingsJapgolly.activexAccess.Access.Report = js.native
  ...
  var AllowReportView: Boolean = js.native
  ...
  var DateGrouping: Double = js.native
  ...
  var DrawStyle: Double = js.native
  ...
  var FillStyle: Double = js.native
  ...
  var FontItalic: Double = js.native
  
  var FontName: String = js.native
  
  var FontSize: Double = js.native
  
  var FontUnderline: Double = js.native
  ...
  def GroupLevel(Index: Double): typingsJapgolly.activexAccess.Access.GroupLevel = js.native
  
  var GrpKeepTogether: Double = js.native
  
  var HasData: Double = js.native
  ...
  val Module: typingsJapgolly.activexAccess.Access.Module = js.native
  ...
  var MoveLayout: Boolean = js.native
  
  var Moveable: Boolean = js.native
  
  var Name: String = js.native
  
  var NextRecord: Boolean = js.native
  ...
  var OnNoData: String = js.native
  
  var OnNoDataMacro: String = js.native
  
  var OnOpen: String = js.native
  
  var OnOpenMacro: String = js.native
  
  var OnPage: String = js.native
  
  var OnPageMacro: String = js.native
  ...
  var PageFooter: Double = js.native
  
  var PageHeader: Double = js.native
  ...
  def Print(Expr: String): Unit = js.native
  
  var PrintCount: Double = js.native
  
  var PrintSection: Boolean = js.native
  ...
  var Recordset: typingsJapgolly.activexDao.DAO.Recordset | typingsJapgolly.activexAdodb.ADODB.Recordset | Null = js.native
  
  val Report: typingsJapgolly.activexAccess.Access.Report = js.native
  
  def Requery(): Unit = js.native
  
  var RibbonName: String = js.native
  
  def Scale(flags: Double, x1: Double, y1: Double, x2: Double, y2: Double): Unit = js.native
  ...
  var ScaleTop: Double = js.native
  
  var ScaleWidth: Double = js.native
  
  var ScrollBars: Double = js.native
  
  def Section(Index: String): typingsJapgolly.activexAccess.Access.Section = js.native
  def Section(Index: AcReportSection): typingsJapgolly.activexAccess.Access.Section = js.native
  ...
  var ShowPageMargins: Boolean = js.native
  
  var Tag: String = js.native
  
  def TextHeight(Expr: String): Double = js.native
  
  def TextWidth(Expr: String): Double = js.native
