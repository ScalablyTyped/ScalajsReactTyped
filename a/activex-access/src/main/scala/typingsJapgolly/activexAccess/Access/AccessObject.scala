...
object AccessObject {
  ...
  inline def apply(
    ...
    FullName: String,
    GetDependencyInfo: CallbackTo[DependencyInfo],
  ...
  extension [Self <: AccessObject](x: Self) {
    ...
    inline def setGetDependencyInfo(value: CallbackTo[DependencyInfo]): Self = StObject.set(x, "GetDependencyInfo", value.toJsFn)
