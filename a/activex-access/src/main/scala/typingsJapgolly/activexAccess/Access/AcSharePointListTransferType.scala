...
*/
trait AcSharePointListTransferType extends StObject
object AcSharePointListTransferType {
  
  inline def acImportSharePointList: `0` = 0.asInstanceOf[`0`]
  
  inline def acLinkSharePointList: `1` = 1.asInstanceOf[`1`]
}
