...
object AcVerticalAnchor {
  ...
  inline def acVerticalAnchorBoth: `2` = 2.asInstanceOf[`2`]
  
  inline def acVerticalAnchorBottom: `1` = 1.asInstanceOf[`1`]
  
  inline def acVerticalAnchorTop: `0` = 0.asInstanceOf[`0`]
}
