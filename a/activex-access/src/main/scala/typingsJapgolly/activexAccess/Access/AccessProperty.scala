...
trait AccessProperty extends StObject {
  ...
  @JSName("Properties")
  val Properties_Original: typingsJapgolly.activexDao.DAO.Properties
...
object AccessProperty {
  ...
  inline def apply(
    ...
    Name: String,
    Parent: Any,
    Properties: typingsJapgolly.activexDao.DAO.Properties,
    Type: Double,
    Value: Any
  ): AccessProperty = {
  ...
  extension [Self <: AccessProperty](x: Self) {
    ...
    inline def setProperties(value: typingsJapgolly.activexDao.DAO.Properties): Self = StObject.set(x, "Properties", value.asInstanceOf[js.Any])
