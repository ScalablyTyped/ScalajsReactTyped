...
object PageHdrFtrInReport {
  ...
  extension [Self <: PageHdrFtrInReport](x: Self) {
    ...
    inline def setSetTabOrder(value: Callback): Self = StObject.set(x, "SetTabOrder", value.toJsFn)
