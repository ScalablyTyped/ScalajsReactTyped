...
*/
trait AcTransformXMLScriptOption extends StObject
object AcTransformXMLScriptOption {
  
  inline def acDisableScript: `2` = 2.asInstanceOf[`2`]
  
  inline def acEnableScript: `0` = 0.asInstanceOf[`0`]
  
  inline def acPromptScript: `1` = 1.asInstanceOf[`1`]
}
