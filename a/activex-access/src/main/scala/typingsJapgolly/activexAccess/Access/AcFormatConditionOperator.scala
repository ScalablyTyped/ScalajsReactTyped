...
object AcFormatConditionOperator {
  ...
  inline def acBetween: `0` = 0.asInstanceOf[`0`]
  
  inline def acEqual: `2` = 2.asInstanceOf[`2`]
  
  inline def acGreaterThan: `4` = 4.asInstanceOf[`4`]
  
  inline def acGreaterThanOrEqual: `6` = 6.asInstanceOf[`6`]
  
  inline def acLessThan: `5` = 5.asInstanceOf[`5`]
  
  inline def acLessThanOrEqual: `7` = 7.asInstanceOf[`7`]
  
  inline def acNotBetween: `1` = 1.asInstanceOf[`1`]
  
  inline def acNotEqual: `3` = 3.asInstanceOf[`3`]
}
