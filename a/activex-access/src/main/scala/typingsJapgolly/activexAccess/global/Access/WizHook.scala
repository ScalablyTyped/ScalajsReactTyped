...
/* private */ open class WizHook ()
  extends StObject
     with typingsJapgolly.activexAccess.Access.WizHook {
  
  /* private */ /* CompleteClass */
  @JSName("Access.WizHook_typekey")
  var AccessDotWizHook_typekey: typingsJapgolly.activexAccess.Access.WizHook = js.native
  ...
  override def OpenEmScript(
    pProperty: typingsJapgolly.activexAccess.Access.AccessProperty,
    OpenMode: Double,
    Extra: Double,
    Version: Double
  ): Double = js.native
