...
import typingsJapgolly.activexAccess.Access.Children
import typingsJapgolly.activexAccess.Access.Properties
...
@js.native
/* private */ open class PageHdrFtrInReport ()
  extends StObject
     with typingsJapgolly.activexAccess.Access.PageHdrFtrInReport {
  
  /* private */ /* CompleteClass */
  @JSName("Access._PageHdrFtrInReport_typekey")
  var AccessDot_PageHdrFtrInReport_typekey: typingsJapgolly.activexAccess.Access.PageHdrFtrInReport = js.native
  ...
  /* CompleteClass */
  @JSName("Controls")
  override val Controls_Original: Children = js.native
  ...
  /* CompleteClass */
  override def Properties(Index: String): typingsJapgolly.activexAccess.Access.AccessProperty = js.native
  /* CompleteClass */
  override def Properties(Index: Double): typingsJapgolly.activexAccess.Access.AccessProperty = js.native
  /* CompleteClass */
  @JSName("Properties")
  ...
  /* CompleteClass */
  override def SetTabOrder(): Unit = js.native
