...
/* private */ open class AccessObjectProperty ()
  extends StObject
     with typingsJapgolly.activexAccess.Access.AccessObjectProperty {
  
  /* private */ /* CompleteClass */
  @JSName("Access.AccessObjectProperty_typekey")
  var AccessDotAccessObjectProperty_typekey: typingsJapgolly.activexAccess.Access.AccessObjectProperty = js.native
