...
/* private */ open class SectionInReport ()
  extends StObject
     with typingsJapgolly.activexAccess.Access.SectionInReport {
  
  /* private */ /* CompleteClass */
  @JSName("Access._SectionInReport_typekey")
  var AccessDot_SectionInReport_typekey: typingsJapgolly.activexAccess.Access.SectionInReport = js.native
