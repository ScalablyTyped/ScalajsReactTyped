package typingsJapgolly.activexAccess.global
...
import typingsJapgolly.activexAccess.AccWizObjects.WIZ_WIN32_FIND_DATA
...
object AccWizObjects {
  ...
  /* private */ open class FieldList ()
    extends StObject
       with typingsJapgolly.activexAccess.AccWizObjects.FieldList {
    
    /* private */ /* CompleteClass */
    @JSName("AccWizObjects.FieldList_typekey")
    var AccWizObjectsDotFieldList_typekey: typingsJapgolly.activexAccess.AccWizObjects.FieldList = js.native
  ...
  /* private */ open class ImexGrid ()
    extends StObject
       with typingsJapgolly.activexAccess.AccWizObjects.ImexGrid {
    
    /* private */ /* CompleteClass */
    @JSName("AccWizObjects.ImexGrid_typekey")
    var AccWizObjectsDotImexGrid_typekey: typingsJapgolly.activexAccess.AccWizObjects.ImexGrid = js.native
  ...
  /* private */ open class WizShellLinkA ()
    extends StObject
       with typingsJapgolly.activexAccess.AccWizObjects.WizShellLinkA {
    
    /* private */ /* CompleteClass */
    @JSName("AccWizObjects.WizShellLinkA_typekey")
    var AccWizObjectsDotWizShellLinkA_typekey: typingsJapgolly.activexAccess.AccWizObjects.WizShellLinkA = js.native
