...
@js.native
/* private */ open class AccessProperty ()
  extends StObject
     with typingsJapgolly.activexAccess.Access.AccessProperty {
  
  /* private */ /* CompleteClass */
  @JSName("Access._AccessProperty_typekey")
  var AccessDot_AccessProperty_typekey: typingsJapgolly.activexAccess.Access.AccessProperty = js.native
  
  /* CompleteClass */
  override val Application: typingsJapgolly.activexAccess.Access.Application = js.native
  
  /* CompleteClass */
  override val Category: Double = js.native
  ...
  /* CompleteClass */
  override def Properties(Item: String): Property = js.native
  /* CompleteClass */
  override def Properties(Item: Double): Property = js.native
  /* CompleteClass */
  @JSName("Properties")
