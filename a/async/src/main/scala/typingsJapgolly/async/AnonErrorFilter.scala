...
object AnonErrorFilter {
  @scala.inline
  def apply(
    errorFilter: /* error */ js.Error => CallbackTo[Boolean] = null,
    interval: Double | (js.Function1[/* retryCount */ Double, Double]) = null,
    times: Int | Double = null
  ): AnonErrorFilter = {
    val __obj = js.Dynamic.literal()
    if (errorFilter != null) __obj.updateDynamic("errorFilter")(js.Any.fromFunction1((t0: /* error */ js.Error) => errorFilter(t0).runNow()))
