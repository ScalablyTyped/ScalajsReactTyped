...
import typingsJapgolly.aframe.anon.GetMeshMixin
import typingsJapgolly.animejs.mod.AnimeInstance
import typingsJapgolly.animejs.mod.AnimeParams
...
object AFrame {
  ...
  extension [Self <: AFrame](x: Self) {
    ...
    inline def setRegisterElement(value: (String, js.Object) => Callback): Self = StObject.set(x, "registerElement", js.Any.fromFunction2((t0: String, t1: js.Object) => (value(t0, t1)).runNow()))
    ...
    inline def setRegisterPrimitive(value: (String, PrimitiveDefinition) => Callback): Self = StObject.set(x, "registerPrimitive", js.Any.fromFunction2((t0: String, t1: PrimitiveDefinition) => (value(t0, t1)).runNow()))
