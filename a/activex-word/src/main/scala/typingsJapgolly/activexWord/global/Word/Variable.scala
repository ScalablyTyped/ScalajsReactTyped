...
@js.native
/* private */ open class Variable ()
  extends StObject
     with typingsJapgolly.activexWord.Word.Variable {
  ...
  var WordDotVariable_typekey: typingsJapgolly.activexWord.Word.Variable = js.native
}
