...
/* private */ open class Envelope ()
  extends StObject
     with typingsJapgolly.activexWord.Word.Envelope {
  
  /* CompleteClass */
  override val Address: typingsJapgolly.activexWord.Word.Range = js.native
  ...
  /* CompleteClass */
  override val AddressStyle: typingsJapgolly.activexWord.Word.Style = js.native
  ...
  /* CompleteClass */
  override val ReturnAddress: typingsJapgolly.activexWord.Word.Range = js.native
  ...
  /* CompleteClass */
  override val ReturnAddressStyle: typingsJapgolly.activexWord.Word.Style = js.native
  ...
  var WordDotEnvelope_typekey: typingsJapgolly.activexWord.Word.Envelope = js.native
}
