...
@js.native
/* private */ open class LetterContent ()
  extends StObject
     with typingsJapgolly.activexWord.Word.LetterContent {
  ...
  /* CompleteClass */
  override val Duplicate: typingsJapgolly.activexWord.Word.LetterContent = js.native
  ...
  var WordDotLetterContent_typekey: typingsJapgolly.activexWord.Word.LetterContent = js.native
}
