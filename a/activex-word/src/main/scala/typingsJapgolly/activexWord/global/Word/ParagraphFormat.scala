...
/* private */ open class ParagraphFormat ()
  extends StObject
     with typingsJapgolly.activexWord.Word.ParagraphFormat {
  ...
  /* CompleteClass */
  override def CloseUp(): Unit = js.native
  ...
  /* CompleteClass */
  override val Duplicate: typingsJapgolly.activexWord.Word.ParagraphFormat = js.native
  ...
  /* CompleteClass */
  override def IndentCharWidth(Count: Double): Unit = js.native
  
  /* CompleteClass */
  override def IndentFirstLineCharWidth(Count: Double): Unit = js.native
  ...
  /* CompleteClass */
  override def OpenOrCloseUp(): Unit = js.native
  
  /* CompleteClass */
  override def OpenUp(): Unit = js.native
  ...
  /* CompleteClass */
  override def Space1(): Unit = js.native
  
  /* CompleteClass */
  override def Space15(): Unit = js.native
  
  /* CompleteClass */
  override def Space2(): Unit = js.native
  ...
  /* CompleteClass */
  override def TabIndent(Count: Double): Unit = js.native
  
  /* CompleteClass */
  var TabStops: typingsJapgolly.activexWord.Word.TabStops = js.native
  ...
  var WordDotParagraphFormat_typekey: typingsJapgolly.activexWord.Word.ParagraphFormat = js.native
