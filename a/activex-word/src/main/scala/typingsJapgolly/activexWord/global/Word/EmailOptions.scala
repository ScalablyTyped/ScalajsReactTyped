...
@js.native
/* private */ open class EmailOptions ()
  extends StObject
     with typingsJapgolly.activexWord.Word.EmailOptions {
  ...
  /* CompleteClass */
  override val ComposeStyle: typingsJapgolly.activexWord.Word.Style = js.native
  
  /* CompleteClass */
  override val Creator: Double = js.native
  
  /* CompleteClass */
  override val Dummy1: Boolean = js.native
  
  /* CompleteClass */
  override val Dummy2: Boolean = js.native
  
  /* CompleteClass */
  override def Dummy3(): Unit = js.native
  
  /* CompleteClass */
  override val EmailSignature: typingsJapgolly.activexWord.Word.EmailSignature = js.native
  ...
  /* CompleteClass */
  override val PlainTextStyle: typingsJapgolly.activexWord.Word.Style = js.native
  
  /* CompleteClass */
  var RelyOnCSS: Boolean = js.native
  
  /* CompleteClass */
  override val ReplyStyle: typingsJapgolly.activexWord.Word.Style = js.native
  ...
  var WordDotEmailOptions_typekey: typingsJapgolly.activexWord.Word.EmailOptions = js.native
}
