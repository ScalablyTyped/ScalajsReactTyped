...
@js.native
/* private */ open class MappedDataField ()
  extends StObject
     with typingsJapgolly.activexWord.Word.MappedDataField {
  ...
  var WordDotMappedDataField_typekey: typingsJapgolly.activexWord.Word.MappedDataField = js.native
}
