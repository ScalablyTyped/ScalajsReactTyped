...
@JSGlobal("Word.SmartTagRecognizer")
@js.native
/* private */ open class SmartTagRecognizer ()
  extends StObject
     with typingsJapgolly.activexWord.Word.SmartTagRecognizer {
  ...
  var WordDotSmartTagRecognizer_typekey: typingsJapgolly.activexWord.Word.SmartTagRecognizer = js.native
}
