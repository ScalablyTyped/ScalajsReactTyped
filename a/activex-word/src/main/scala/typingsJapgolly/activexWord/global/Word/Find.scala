...
/* private */ open class Find[TParent] ()
  extends StObject
     with typingsJapgolly.activexWord.Word.Find[TParent] {
  ...
  /* CompleteClass */
  override val Replacement: typingsJapgolly.activexWord.Word.Replacement = js.native
  ...
  var WordDotFind_typekey: typingsJapgolly.activexWord.Word.Find[
    typingsJapgolly.activexWord.Word.Range | typingsJapgolly.activexWord.Word.Selection
  ] = js.native
