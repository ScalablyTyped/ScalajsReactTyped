...
trait OldContentControl extends StObject {
  ...
  val OldContentControl: typingsJapgolly.activexWord.Word.ContentControl
}
object OldContentControl {
  
  inline def apply(InUndoRedo: Boolean, OldContentControl: typingsJapgolly.activexWord.Word.ContentControl): OldContentControl = {
  ...
  extension [Self <: OldContentControl](x: Self) {
    ...
    inline def setOldContentControl(value: typingsJapgolly.activexWord.Word.ContentControl): Self = StObject.set(x, "OldContentControl", value.asInstanceOf[js.Any])
  }
}
