...
object OMathLimUpp {
  ...
  inline def apply(
    ...
    Lim: OMath,
    Parent: Any,
    ToLimLow: CallbackTo[OMathFunction],
    WordDotOMathLimUpp_typekey: OMathLimUpp
  ): OMathLimUpp = {
    val __obj = js.Dynamic.literal(Application = Application.asInstanceOf[js.Any], Creator = Creator.asInstanceOf[js.Any], E = E.asInstanceOf[js.Any], Lim = Lim.asInstanceOf[js.Any], Parent = Parent.asInstanceOf[js.Any], ToLimLow = ToLimLow.toJsFn)
  ...
  extension [Self <: OMathLimUpp](x: Self) {
    ...
    inline def setToLimLow(value: CallbackTo[OMathFunction]): Self = StObject.set(x, "ToLimLow", value.toJsFn)
