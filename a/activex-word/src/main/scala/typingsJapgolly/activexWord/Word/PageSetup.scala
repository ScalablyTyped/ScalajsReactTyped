...
trait PageSetup extends StObject {
  ...
  var LineNumbering: typingsJapgolly.activexWord.Word.LineNumbering
  ...
  var TextColumns: typingsJapgolly.activexWord.Word.TextColumns
...
object PageSetup {
  ...
  extension [Self <: PageSetup](x: Self) {
    ...
    inline def setTogglePortrait(value: Callback): Self = StObject.set(x, "TogglePortrait", value.toJsFn)
