...
trait FillFormat extends StObject {
  ...
  /* private */ @JSName("Word.FillFormat_typekey")
  var WordDotFillFormat_typekey: FillFormat
}
object FillFormat {
  ...
  inline def apply(
    ...
    Visible: MsoTriState,
    WordDotFillFormat_typekey: FillFormat
  ): FillFormat = {
    ...
    __obj.updateDynamic("Word.FillFormat_typekey")(WordDotFillFormat_typekey.asInstanceOf[js.Any])
  ...
  extension [Self <: FillFormat](x: Self) {
    ...
    inline def setWordDotFillFormat_typekey(value: FillFormat): Self = StObject.set(x, "Word.FillFormat_typekey", value.asInstanceOf[js.Any])
  }
}
