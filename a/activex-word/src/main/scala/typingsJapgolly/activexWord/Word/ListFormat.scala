...
class ListFormat protected () extends js.Object {
  ...
  val List: typingsJapgolly.activexWord.Word.List = js.native
  ...
  def ApplyListTemplate(ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate): Unit = js.native
  def ApplyListTemplate(ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  def ApplyListTemplate(
    ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate,
  ...
  def ApplyListTemplateOld(ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate): Unit = js.native
  def ApplyListTemplateOld(ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  def ApplyListTemplateOld(
    ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate,
    ContinuePreviousList: js.Any,
    ApplyTo: js.Any
  ): Unit = js.native
  def ApplyListTemplateWithLevel(ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate): Unit = js.native
  def ApplyListTemplateWithLevel(ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate, ContinuePreviousList: js.Any): Unit = js.native
  ...
  def CanContinuePreviousList(ListTemplate: typingsJapgolly.activexWord.Word.ListTemplate): WdContinue = js.native
