...
trait EmailOptions extends StObject {
  ...
  val EmailSignature: typingsJapgolly.activexWord.Word.EmailSignature
...
object EmailOptions {
  ...
  extension [Self <: EmailOptions](x: Self) {
    ...
    inline def setDummy3(value: Callback): Self = StObject.set(x, "Dummy3", value.toJsFn)
