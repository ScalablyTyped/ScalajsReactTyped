...
object WdRevisedPropertiesMark {
  ...
  inline def wdRevisedPropertiesMarkBold: `1` = 1.asInstanceOf[`1`]
  
  inline def wdRevisedPropertiesMarkColorOnly: `5` = 5.asInstanceOf[`5`]
  
  inline def wdRevisedPropertiesMarkDoubleStrikeThrough: `7` = 7.asInstanceOf[`7`]
  
  inline def wdRevisedPropertiesMarkDoubleUnderline: `4` = 4.asInstanceOf[`4`]
  
  inline def wdRevisedPropertiesMarkItalic: `2` = 2.asInstanceOf[`2`]
  
  inline def wdRevisedPropertiesMarkNone: `0` = 0.asInstanceOf[`0`]
  
  inline def wdRevisedPropertiesMarkStrikeThrough: `6` = 6.asInstanceOf[`6`]
  
  inline def wdRevisedPropertiesMarkUnderline: `3` = 3.asInstanceOf[`3`]
}
