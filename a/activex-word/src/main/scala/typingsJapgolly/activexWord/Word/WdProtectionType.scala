...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.activexWord.activexWordInts.`-1`
*/
trait WdProtectionType extends StObject
object WdProtectionType {
  
  inline def wdAllowOnlyComments: `1` = 1.asInstanceOf[`1`]
  
  inline def wdAllowOnlyFormFields: `2` = 2.asInstanceOf[`2`]
  
  inline def wdAllowOnlyReading: `3` = 3.asInstanceOf[`3`]
  
  inline def wdAllowOnlyRevisions: `0` = 0.asInstanceOf[`0`]
  
  inline def wdNoProtection: `-1` = -1.asInstanceOf[`-1`]
}
