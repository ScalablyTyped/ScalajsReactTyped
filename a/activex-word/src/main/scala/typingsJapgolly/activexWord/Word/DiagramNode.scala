...
class DiagramNode protected () extends js.Object {
  ...
  val Diagram: typingsJapgolly.activexWord.Word.Diagram = js.native
  var Layout: MsoOrgChartLayoutType = js.native
  val Parent: js.Any = js.native
  val Root: DiagramNode = js.native
  val Shape: typingsJapgolly.activexWord.Word.Shape = js.native
  val TextShape: typingsJapgolly.activexWord.Word.Shape = js.native
