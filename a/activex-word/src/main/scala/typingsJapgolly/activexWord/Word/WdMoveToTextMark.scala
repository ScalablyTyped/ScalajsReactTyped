...
object WdMoveToTextMark {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def wdMoveToTextMarkBold: `1` = this.cast(1)
  @scala.inline
  def wdMoveToTextMarkColorOnly: `5` = this.cast(5)
  @scala.inline
  def wdMoveToTextMarkDoubleStrikeThrough: `7` = this.cast(7)
  @scala.inline
  def wdMoveToTextMarkDoubleUnderline: `4` = this.cast(4)
  @scala.inline
  def wdMoveToTextMarkItalic: `2` = this.cast(2)
  @scala.inline
  def wdMoveToTextMarkNone: `0` = this.cast(0)
  @scala.inline
  def wdMoveToTextMarkStrikeThrough: `6` = this.cast(6)
  @scala.inline
  def wdMoveToTextMarkUnderline: `3` = this.cast(3)
}
