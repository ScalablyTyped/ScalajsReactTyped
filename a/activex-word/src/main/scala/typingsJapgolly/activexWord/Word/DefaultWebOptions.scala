...
trait DefaultWebOptions extends StObject {
  ...
  /* private */ @JSName("Word.DefaultWebOptions_typekey")
...
object DefaultWebOptions {
  ...
  extension [Self <: DefaultWebOptions](x: Self) {
    ...
    inline def setCheckIfWordIsDefaultHTMLEditor(value: Boolean): Self = StObject.set(x, "CheckIfWordIsDefaultHTMLEditor", value.asInstanceOf[js.Any])
    ...
    inline def setWordDotDefaultWebOptions_typekey(value: DefaultWebOptions): Self = StObject.set(x, "Word.DefaultWebOptions_typekey", value.asInstanceOf[js.Any])
  }
}
