...
*/
trait WdBrowserLevel extends StObject
object WdBrowserLevel {
  
  inline def wdBrowserLevelMicrosoftInternetExplorer5: `1` = 1.asInstanceOf[`1`]
  
  inline def wdBrowserLevelMicrosoftInternetExplorer6: `2` = 2.asInstanceOf[`2`]
  
  inline def wdBrowserLevelV4: `0` = 0.asInstanceOf[`0`]
}
