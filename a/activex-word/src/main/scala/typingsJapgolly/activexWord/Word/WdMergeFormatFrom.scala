...
object WdMergeFormatFrom {
  ...
  inline def wdMergeFormatFromOriginal: `0` = 0.asInstanceOf[`0`]
  
  inline def wdMergeFormatFromPrompt: `2` = 2.asInstanceOf[`2`]
  
  inline def wdMergeFormatFromRevised: `1` = 1.asInstanceOf[`1`]
}
