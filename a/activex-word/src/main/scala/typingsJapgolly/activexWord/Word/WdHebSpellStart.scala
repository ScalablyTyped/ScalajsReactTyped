...
*/
trait WdHebSpellStart extends StObject
object WdHebSpellStart {
  
  inline def wdFullScript: `0` = 0.asInstanceOf[`0`]
  
  inline def wdMixedAuthorizedScript: `3` = 3.asInstanceOf[`3`]
  
  inline def wdMixedScript: `2` = 2.asInstanceOf[`2`]
  
  inline def wdPartialScript: `1` = 1.asInstanceOf[`1`]
}
