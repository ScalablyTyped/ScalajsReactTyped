...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: typingsJapgolly.activexWord.Word.DownBars = js.native
  val DropLines: typingsJapgolly.activexWord.Word.DropLines = js.native
  ...
  val HiLoLines: typingsJapgolly.activexWord.Word.HiLoLines = js.native
  val Index: Double = js.native
  var Overlap: Double = js.native
  val Parent: js.Any = js.native
  val RadarAxisLabels: TickLabels = js.native
  var SecondPlotSize: Double = js.native
  val SeriesLines: typingsJapgolly.activexWord.Word.SeriesLines = js.native
  ...
  val UpBars: typingsJapgolly.activexWord.Word.UpBars = js.native
