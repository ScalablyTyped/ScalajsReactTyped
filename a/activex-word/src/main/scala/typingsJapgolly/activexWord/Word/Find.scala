...
trait Find[TParent] extends StObject {
  ...
  val Replacement: typingsJapgolly.activexWord.Word.Replacement
...
object Find {
  ...
  inline def apply[TParent](
    ...
    ClearAllFuzzyOptions: Callback,
    ClearFormatting: Callback,
    ClearHitHighlight: CallbackTo[Boolean],
  ...
  extension [Self <: Find[?], TParent](x: Self & Find[TParent]) {
    ...
    inline def setClearAllFuzzyOptions(value: Callback): Self = StObject.set(x, "ClearAllFuzzyOptions", value.toJsFn)
    
    inline def setClearFormatting(value: Callback): Self = StObject.set(x, "ClearFormatting", value.toJsFn)
    
    inline def setClearHitHighlight(value: CallbackTo[Boolean]): Self = StObject.set(x, "ClearHitHighlight", value.toJsFn)
    ...
    inline def setSetAllFuzzyOptions(value: Callback): Self = StObject.set(x, "SetAllFuzzyOptions", value.toJsFn)
