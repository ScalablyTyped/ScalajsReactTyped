...
object Borders {
  ...
  inline def apply(
    ...
    ApplyPageBordersToAllSections: Callback,
    Count: Double,
    Creator: Double,
  ...
  extension [Self <: Borders](x: Self) {
    ...
    inline def setApplyPageBordersToAllSections(value: Callback): Self = StObject.set(x, "ApplyPageBordersToAllSections", value.toJsFn)
