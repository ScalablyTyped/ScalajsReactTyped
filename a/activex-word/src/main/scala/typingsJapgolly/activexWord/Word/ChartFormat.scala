...
import typingsJapgolly.activexOffice.Office.TextFrame2
...
trait ChartFormat extends StObject {
  ...
  val PictureFormat: typingsJapgolly.activexWord.Word.PictureFormat
  
  val Shadow: ShadowFormat
  
  val SoftEdge: SoftEdgeFormat
  
  val TextFrame2: typingsJapgolly.activexOffice.Office.TextFrame2
  
  val ThreeD: ThreeDFormat
  
  /* private */ @JSName("Word.ChartFormat_typekey")
...
object ChartFormat {
  ...
  extension [Self <: ChartFormat](x: Self) {
    ...
    inline def setWordDotChartFormat_typekey(value: ChartFormat): Self = StObject.set(x, "Word.ChartFormat_typekey", value.asInstanceOf[js.Any])
  }
}
