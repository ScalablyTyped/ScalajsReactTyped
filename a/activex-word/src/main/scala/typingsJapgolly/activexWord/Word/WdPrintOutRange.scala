...
object WdPrintOutRange {
  ...
  inline def wdPrintAllDocument: `0` = 0.asInstanceOf[`0`]
  
  inline def wdPrintCurrentPage: `2` = 2.asInstanceOf[`2`]
  
  inline def wdPrintFromTo: `3` = 3.asInstanceOf[`3`]
  
  inline def wdPrintRangeOfPages: `4` = 4.asInstanceOf[`4`]
  
  inline def wdPrintSelection: `1` = 1.asInstanceOf[`1`]
}
