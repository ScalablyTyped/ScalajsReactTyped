...
trait Lists extends StObject {
  ...
  def Item(Index: Double): typingsJapgolly.activexWord.Word.List
...
object Lists {
  ...
  inline def apply(
    ...
    Count: Double,
    Creator: Double,
    Item: Double => typingsJapgolly.activexWord.Word.List,
    Parent: Any,
  ...
  extension [Self <: Lists](x: Self) {
    ...
    inline def setItem(value: Double => typingsJapgolly.activexWord.Word.List): Self = StObject.set(x, "Item", js.Any.fromFunction1(value))
