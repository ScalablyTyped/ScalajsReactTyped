...
object WdCompareDestination {
  ...
  inline def wdCompareDestinationNew: `2` = 2.asInstanceOf[`2`]
  
  inline def wdCompareDestinationOriginal: `0` = 0.asInstanceOf[`0`]
  
  inline def wdCompareDestinationRevised: `1` = 1.asInstanceOf[`1`]
}
