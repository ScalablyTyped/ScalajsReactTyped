...
class Range protected () extends js.Object {
  ...
  val Find: typingsJapgolly.activexWord.Word.Find[Range] = js.native
  ...
  val ListFormat: typingsJapgolly.activexWord.Word.ListFormat = js.native
  ...
  val SynonymInfo: typingsJapgolly.activexWord.Word.SynonymInfo = js.native
  val TableStyle: js.Any = js.native
  val Tables: typingsJapgolly.activexWord.Word.Tables = js.native
  var Text: String = js.native
  var TextRetrievalMode: typingsJapgolly.activexWord.Word.TextRetrievalMode = js.native
