...
object ColorFormat {
  ...
  extension [Self <: ColorFormat](x: Self) {
    ...
    inline def setSetCMYK(value: (Double, Double, Double, Double) => Callback): Self = StObject.set(x, "SetCMYK", js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: Double) => (value(t0, t1, t2, t3)).runNow()))
