...
*/
trait WdSpellingWordType extends StObject
object WdSpellingWordType {
  
  inline def wdAnagram: `2` = 2.asInstanceOf[`2`]
  
  inline def wdSpellword: `0` = 0.asInstanceOf[`0`]
  
  inline def wdWildcard: `1` = 1.asInstanceOf[`1`]
}
