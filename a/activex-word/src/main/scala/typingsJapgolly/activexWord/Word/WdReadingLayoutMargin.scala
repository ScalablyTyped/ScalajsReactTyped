...
*/
trait WdReadingLayoutMargin extends StObject
object WdReadingLayoutMargin {
  
  inline def wdAutomaticMargin: `0` = 0.asInstanceOf[`0`]
  
  inline def wdFullMargin: `2` = 2.asInstanceOf[`2`]
  
  inline def wdSuppressMargin: `1` = 1.asInstanceOf[`1`]
}
