...
object Index {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AccentedLetters = AccentedLetters.asInstanceOf[js.Any], Application = Application.asInstanceOf[js.Any], Creator = Creator.asInstanceOf[js.Any], Delete = Delete.toJsFn, Filter = Filter.asInstanceOf[js.Any], HeadingSeparator = HeadingSeparator.asInstanceOf[js.Any], IndexLanguage = IndexLanguage.asInstanceOf[js.Any], NumberOfColumns = NumberOfColumns.asInstanceOf[js.Any], Parent = Parent.asInstanceOf[js.Any], Range = Range.asInstanceOf[js.Any], RightAlignPageNumbers = RightAlignPageNumbers.asInstanceOf[js.Any], SortBy = SortBy.asInstanceOf[js.Any], TabLeader = TabLeader.asInstanceOf[js.Any], Type = Type.asInstanceOf[js.Any], Update = Update.toJsFn)
