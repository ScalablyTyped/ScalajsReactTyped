...
class FormField protected () extends js.Object {
  ...
  val CheckBox: typingsJapgolly.activexWord.Word.CheckBox = js.native
  val Creator: Double = js.native
  val DropDown: typingsJapgolly.activexWord.Word.DropDown = js.native
  ...
  val TextInput: typingsJapgolly.activexWord.Word.TextInput = js.native
