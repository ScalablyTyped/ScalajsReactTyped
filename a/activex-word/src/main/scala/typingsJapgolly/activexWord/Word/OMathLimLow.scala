...
object OMathLimLow {
  ...
  inline def apply(
    ...
    Lim: OMath,
    Parent: Any,
    ToLimUpp: CallbackTo[OMathFunction],
    WordDotOMathLimLow_typekey: OMathLimLow
  ): OMathLimLow = {
    val __obj = js.Dynamic.literal(Application = Application.asInstanceOf[js.Any], Creator = Creator.asInstanceOf[js.Any], E = E.asInstanceOf[js.Any], Lim = Lim.asInstanceOf[js.Any], Parent = Parent.asInstanceOf[js.Any], ToLimUpp = ToLimUpp.toJsFn)
  ...
  extension [Self <: OMathLimLow](x: Self) {
    ...
    inline def setToLimUpp(value: CallbackTo[OMathFunction]): Self = StObject.set(x, "ToLimUpp", value.toJsFn)
