...
trait AutoCorrect extends StObject {
  ...
  val FirstLetterExceptions: typingsJapgolly.activexWord.Word.FirstLetterExceptions
  
  var HangulAndAlphabetAutoAdd: Boolean
  
  val HangulAndAlphabetExceptions: typingsJapgolly.activexWord.Word.HangulAndAlphabetExceptions
  
  var OtherCorrectionsAutoAdd: Boolean
  
  val OtherCorrectionsExceptions: typingsJapgolly.activexWord.Word.OtherCorrectionsExceptions
  ...
  val TwoInitialCapsExceptions: typingsJapgolly.activexWord.Word.TwoInitialCapsExceptions
