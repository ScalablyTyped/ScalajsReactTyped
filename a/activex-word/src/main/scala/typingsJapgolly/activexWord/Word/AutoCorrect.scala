...
class AutoCorrect protected () extends js.Object {
  ...
  val FirstLetterExceptions: typingsJapgolly.activexWord.Word.FirstLetterExceptions = js.native
  var HangulAndAlphabetAutoAdd: Boolean = js.native
  val HangulAndAlphabetExceptions: typingsJapgolly.activexWord.Word.HangulAndAlphabetExceptions = js.native
  var OtherCorrectionsAutoAdd: Boolean = js.native
  val OtherCorrectionsExceptions: typingsJapgolly.activexWord.Word.OtherCorrectionsExceptions = js.native
  ...
  val TwoInitialCapsExceptions: typingsJapgolly.activexWord.Word.TwoInitialCapsExceptions = js.native
