...
object WdHeaderFooterIndex {
  ...
  inline def wdHeaderFooterEvenPages: `3` = 3.asInstanceOf[`3`]
  
  inline def wdHeaderFooterFirstPage: `2` = 2.asInstanceOf[`2`]
  
  inline def wdHeaderFooterPrimary: `1` = 1.asInstanceOf[`1`]
}
