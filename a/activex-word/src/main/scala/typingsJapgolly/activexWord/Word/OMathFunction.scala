...
trait OMathFunction extends StObject {
  ...
  val OMath: typingsJapgolly.activexWord.Word.OMath
...
object OMathFunction {
  ...
  inline def apply(
    ...
    Rad: OMathRad,
    Range: Range,
    Remove: CallbackTo[OMathFunction],
    ScrPre: OMathScrPre,
    ScrSub: OMathScrSub,
  ...
  extension [Self <: OMathFunction](x: Self) {
    ...
    inline def setRemove(value: CallbackTo[OMathFunction]): Self = StObject.set(x, "Remove", value.toJsFn)
