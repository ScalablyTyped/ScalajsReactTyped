...
trait ThreeDFormat extends StObject {
  ...
  /* private */ @JSName("Word.ThreeDFormat_typekey")
...
object ThreeDFormat {
  ...
  extension [Self <: ThreeDFormat](x: Self) {
    ...
    inline def setWordDotThreeDFormat_typekey(value: ThreeDFormat): Self = StObject.set(x, "Word.ThreeDFormat_typekey", value.asInstanceOf[js.Any])
