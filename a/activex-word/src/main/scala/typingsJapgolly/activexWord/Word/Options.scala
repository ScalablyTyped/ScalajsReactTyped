...
object Options {
  ...
  inline def apply(
    ...
    SetWPHelpOptions: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback,
  ...
  extension [Self <: Options](x: Self) {
    ...
    inline def setSetWPHelpOptions(
      value: (js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any], js.UndefOr[Any]) => Callback
    ): Self = StObject.set(x, "SetWPHelpOptions", js.Any.fromFunction6((t0: js.UndefOr[Any], t1: js.UndefOr[Any], t2: js.UndefOr[Any], t3: js.UndefOr[Any], t4: js.UndefOr[Any], t5: js.UndefOr[Any]) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
