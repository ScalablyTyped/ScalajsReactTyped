...
object WdMailSystem {
  ...
  inline def wdMAPI: `1` = 1.asInstanceOf[`1`]
  
  inline def wdMAPIandPowerTalk: `3` = 3.asInstanceOf[`3`]
  
  inline def wdNoMailSystem: `0` = 0.asInstanceOf[`0`]
  
  inline def wdPowerTalk: `2` = 2.asInstanceOf[`2`]
}
