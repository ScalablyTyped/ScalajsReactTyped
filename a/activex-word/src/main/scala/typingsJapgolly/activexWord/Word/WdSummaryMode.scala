...
*/
trait WdSummaryMode extends js.Object

object WdSummaryMode {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def wdSummaryModeCreateNew: `3` = this.cast(3)
  @scala.inline
  def wdSummaryModeHideAllButSummary: `1` = this.cast(1)
  @scala.inline
  def wdSummaryModeHighlight: `0` = this.cast(0)
  @scala.inline
  def wdSummaryModeInsert: `2` = this.cast(2)
}
