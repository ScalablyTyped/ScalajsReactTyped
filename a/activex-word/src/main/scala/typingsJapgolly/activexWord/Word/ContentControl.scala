...
trait ContentControl extends StObject {
  ...
  def SetPlaceholderText(BuildingBlock: Unit, Range: typingsJapgolly.activexWord.Word.Range): Unit = js.native
  def SetPlaceholderText(BuildingBlock: Unit, Range: typingsJapgolly.activexWord.Word.Range, Text: String): Unit = js.native
  ...
  def SetPlaceholderText(BuildingBlock: BuildingBlock, Range: typingsJapgolly.activexWord.Word.Range): Unit = js.native
  def SetPlaceholderText(BuildingBlock: BuildingBlock, Range: typingsJapgolly.activexWord.Word.Range, Text: String): Unit = js.native
  ...
  val XMLMapping: typingsJapgolly.activexWord.Word.XMLMapping = js.native
}
