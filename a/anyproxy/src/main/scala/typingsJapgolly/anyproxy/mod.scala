...
import typingsJapgolly.anyproxy.anon.PartialResponse
...
object mod {
  ...
  */
  ...
  object NetworkType {
    ...
    inline def http: typingsJapgolly.anyproxy.anyproxyStrings.http = "http".asInstanceOf[typingsJapgolly.anyproxy.anyproxyStrings.http]
    
    inline def https: typingsJapgolly.anyproxy.anyproxyStrings.https = "https".asInstanceOf[typingsJapgolly.anyproxy.anyproxyStrings.https]
  }
