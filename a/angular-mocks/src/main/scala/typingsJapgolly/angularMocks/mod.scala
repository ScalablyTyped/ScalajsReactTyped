...
import typingsJapgolly.angularMocks.angularMocksStrings.alt
import typingsJapgolly.angularMocks.angularMocksStrings.ctrl
import typingsJapgolly.angularMocks.angularMocksStrings.meta
import typingsJapgolly.angularMocks.angularMocksStrings.shift
import typingsJapgolly.angularMocks.anon.Call
import typingsJapgolly.angularMocks.anon.Dictkey
import typingsJapgolly.angularMocks.mod.angularAugmentingMod.IInjectStatic
import typingsJapgolly.angularMocks.mod.angularAugmentingMod.mock.IBrowserTriggerEventData
import typingsJapgolly.angularMocks.mod.angularAugmentingMod.mock.IHttpHeaders
import typingsJapgolly.angularMocks.mod.angularAugmentingMod.mock.IRequestHandler
...
object mod {
  ...
  object angularAugmentingMod {
    ...
    object IExceptionHandlerProvider {
      ...
      inline def apply($get: Any, mode: String => Callback): IExceptionHandlerProvider = {
        val __obj = js.Dynamic.literal($get = $get.asInstanceOf[js.Any], mode = js.Any.fromFunction1((t0: String) => mode(t0).runNow()))
        __obj.asInstanceOf[IExceptionHandlerProvider]
      }
      
      extension [Self <: IExceptionHandlerProvider](x: Self) {
        
        inline def setMode(value: String => Callback): Self = StObject.set(x, "mode", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
      }
    }
    ...
    object ILogService {
      ...
      inline def apply(assertEmpty: Callback, reset: Callback): ILogService = {
        val __obj = js.Dynamic.literal(assertEmpty = assertEmpty.toJsFn, reset = reset.toJsFn)
        __obj.asInstanceOf[ILogService]
      }
      
      extension [Self <: ILogService](x: Self) {
        
        inline def setAssertEmpty(value: Callback): Self = StObject.set(x, "assertEmpty", value.toJsFn)
    ...
    object animate {
      ...
      object IAnimateService {
        ...
        inline def apply(closeAndFlush: Callback, flush: Callback): IAnimateService = {
          val __obj = js.Dynamic.literal(closeAndFlush = closeAndFlush.toJsFn, flush = flush.toJsFn)
          __obj.asInstanceOf[IAnimateService]
        }
        
        extension [Self <: IAnimateService](x: Self) {
          
          inline def setCloseAndFlush(value: Callback): Self = StObject.set(x, "closeAndFlush", value.toJsFn)
