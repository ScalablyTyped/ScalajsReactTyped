package typingsJapgolly.assetsWebpackPlugin.mod
...
object Options {
  ...
  def apply(
    ...
    processOutput: /* assets */ Assets => CallbackTo[String] = null,
    ...
    if (processOutput != null) __obj.updateDynamic("processOutput")(js.Any.fromFunction1((t0: /* assets */ typingsJapgolly.assetsWebpackPlugin.mod.Assets) => processOutput(t0).runNow()))
