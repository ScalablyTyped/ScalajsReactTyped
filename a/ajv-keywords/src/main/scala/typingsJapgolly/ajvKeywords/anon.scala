...
import typingsJapgolly.ajvKeywords.ajvKeywordsBooleans.`true`
import typingsJapgolly.ajvKeywords.distDefinitionsDynamicDefaultsMod.DynamicDefaultFunc
import typingsJapgolly.ajvKeywords.distDefinitionsInstanceofMod.Constructor
import typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.TransformConfig
...
object anon {
  ...
  trait keyinTransformNameTransfo extends StObject {
    ...
    @JSName("toEnumCase")
    var toEnumCase_Original: typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.Transform
    
    def toLowerCase(s: String): String
    def toLowerCase(s: String, cfg: TransformConfig): String
    @JSName("toLowerCase")
    var toLowerCase_Original: typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.Transform
    
    def toUpperCase(s: String): String
    def toUpperCase(s: String, cfg: TransformConfig): String
    @JSName("toUpperCase")
    var toUpperCase_Original: typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.Transform
    ...
    @JSName("trimEnd")
    var trimEnd_Original: typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.Transform
    
    def trimLeft(s: String): String
    def trimLeft(s: String, cfg: TransformConfig): String
    @JSName("trimLeft")
    var trimLeft_Original: typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.Transform
    
    def trimRight(s: String): String
    def trimRight(s: String, cfg: TransformConfig): String
    @JSName("trimRight")
    var trimRight_Original: typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.Transform
    
    def trimStart(s: String): String
    def trimStart(s: String, cfg: TransformConfig): String
    @JSName("trimStart")
    var trimStart_Original: typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.Transform
    
    @JSName("trim")
    var trim_Original: typingsJapgolly.ajvKeywords.distDefinitionsTransformMod.Transform
  }
