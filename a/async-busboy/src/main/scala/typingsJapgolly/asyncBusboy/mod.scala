...
import typingsJapgolly.busboy.mod.FileInfo
import typingsJapgolly.busboy.mod.Limits
...
object mod {
  ...
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setOnFile(value: (/* name */ String, /* stream */ Readable, /* info */ FileInfo) => Callback): Self = StObject.set(x, "onFile", js.Any.fromFunction3((t0: /* name */ String, t1: /* stream */ Readable, t2: /* info */ FileInfo) => (value(t0, t1, t2)).runNow()))
