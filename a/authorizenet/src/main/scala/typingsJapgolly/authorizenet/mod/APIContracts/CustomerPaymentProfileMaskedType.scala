...
@JSImport("authorizenet", "APIContracts.CustomerPaymentProfileMaskedType")
@js.native
open class CustomerPaymentProfileMaskedType protected () extends CustomerPaymentProfileBaseType {
