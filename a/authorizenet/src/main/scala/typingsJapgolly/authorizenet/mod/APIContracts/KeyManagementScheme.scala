...
open class KeyManagementScheme protected () extends StObject {
  ...
  var DUKPT: typingsJapgolly.authorizenet.mod.APIContracts.KeyManagementScheme.DUKPT = js.native
  
  def getDUKPT(): typingsJapgolly.authorizenet.mod.APIContracts.KeyManagementScheme.DUKPT = js.native
  
  def setDUKPT(p_DUKPT: typingsJapgolly.authorizenet.mod.APIContracts.KeyManagementScheme.DUKPT): Unit = js.native
}
