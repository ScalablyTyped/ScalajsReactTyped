...
@JSImport("authorizenet", "APIContracts.ArrayOfCustomerPaymentProfileListItemType")
@js.native
open class ArrayOfCustomerPaymentProfileListItemType protected () extends StObject {
