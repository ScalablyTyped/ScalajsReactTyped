...
open class PaymentScheduleType () extends StObject {
  def this(obj: typingsJapgolly.authorizenet.anon.Interval) = this()
  
  def getInterval(): typingsJapgolly.authorizenet.mod.APIContracts.PaymentScheduleType.Interval = js.native
  ...
  var interval: typingsJapgolly.authorizenet.mod.APIContracts.PaymentScheduleType.Interval = js.native
  
  def setInterval(p_interval: typingsJapgolly.authorizenet.mod.APIContracts.PaymentScheduleType.Interval): Unit = js.native
...
object PaymentScheduleType {
  ...
  open class Interval () extends StObject {
    def this(obj: typingsJapgolly.authorizenet.anon.Unit) = this()
