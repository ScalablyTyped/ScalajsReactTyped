...
@JSImport("authorizenet", "APIContracts.CustomerType")
@js.native
open class CustomerType protected () extends StObject {
  ...
  def setFaxNumber(p_faxNumber: Any): Unit = js.native
  ...
  def setType(p_type: Any): Unit = js.native
