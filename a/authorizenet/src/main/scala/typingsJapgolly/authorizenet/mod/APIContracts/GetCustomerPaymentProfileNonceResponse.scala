...
@JSImport("authorizenet", "APIContracts.GetCustomerPaymentProfileNonceResponse")
@js.native
open class GetCustomerPaymentProfileNonceResponse protected () extends ANetApiResponse {
