...
@JSImport("authorizenet", "APIContracts.CustomerProfileSummaryType")
@js.native
open class CustomerProfileSummaryType protected () extends StObject {
  def this(obj: Any, args: Any*) = this()
  def this(obj: Unit, args: Any*) = this()
  
  var createdDate: Any = js.native
  ...
  def getCreatedDate(): Any = js.native
  ...
  def setCreatedDate(p_createdDate: Any): Unit = js.native
