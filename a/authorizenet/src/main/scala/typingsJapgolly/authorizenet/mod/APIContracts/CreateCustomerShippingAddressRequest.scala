...
@JSImport("authorizenet", "APIContracts.CreateCustomerShippingAddressRequest")
@js.native
open class CreateCustomerShippingAddressRequest protected () extends ANetApiRequest {
  ...
  def getJSON(): typingsJapgolly.authorizenet.anon.CreateCustomerShippingAddressRequest = js.native
