...
open class TransactionDetailsType protected () extends StObject {
  ...
  var emvDetails: typingsJapgolly.authorizenet.mod.APIContracts.TransactionDetailsType.EmvDetails = js.native
  ...
  def getEmvDetails(): typingsJapgolly.authorizenet.mod.APIContracts.TransactionDetailsType.EmvDetails = js.native
  ...
  def setEmvDetails(p_emvDetails: typingsJapgolly.authorizenet.mod.APIContracts.TransactionDetailsType.EmvDetails): Unit = js.native
