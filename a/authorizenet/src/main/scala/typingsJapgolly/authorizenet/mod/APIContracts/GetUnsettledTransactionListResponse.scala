...
@JSImport("authorizenet", "APIContracts.GetUnsettledTransactionListResponse")
@js.native
open class GetUnsettledTransactionListResponse protected () extends ANetApiResponse {
