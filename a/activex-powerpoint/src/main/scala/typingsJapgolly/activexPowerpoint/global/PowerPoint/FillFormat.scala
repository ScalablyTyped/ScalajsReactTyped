...
/* private */ open class FillFormat ()
  extends StObject
     with typingsJapgolly.activexPowerpoint.PowerPoint.FillFormat {
  
  /* CompleteClass */
  override val Application: Any = js.native
  
  /* CompleteClass */
  var BackColor: typingsJapgolly.activexPowerpoint.PowerPoint.ColorFormat = js.native
  ...
  var PowerPointDotFillFormat_typekey: typingsJapgolly.activexPowerpoint.PowerPoint.FillFormat = js.native
