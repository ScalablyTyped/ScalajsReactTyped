...
/* private */ open class ChartFont ()
  extends StObject
     with typingsJapgolly.activexPowerpoint.PowerPoint.ChartFont {
  ...
  var PowerPointDotChartFont_typekey: typingsJapgolly.activexPowerpoint.PowerPoint.ChartFont = js.native
