...
/* private */ open class TextEffectFormat ()
  extends StObject
     with typingsJapgolly.activexPowerpoint.PowerPoint.TextEffectFormat {
  ...
  var PowerPointDotTextEffectFormat_typekey: typingsJapgolly.activexPowerpoint.PowerPoint.TextEffectFormat = js.native
