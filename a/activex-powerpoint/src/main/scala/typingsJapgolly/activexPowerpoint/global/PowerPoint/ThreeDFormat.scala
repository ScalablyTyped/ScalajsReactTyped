...
/* private */ open class ThreeDFormat ()
  extends StObject
     with typingsJapgolly.activexPowerpoint.PowerPoint.ThreeDFormat {
  ...
  /* CompleteClass */
  override val ContourColor: typingsJapgolly.activexPowerpoint.PowerPoint.ColorFormat = js.native
  ...
  /* CompleteClass */
  override val ExtrusionColor: typingsJapgolly.activexPowerpoint.PowerPoint.ColorFormat = js.native
  ...
  var PowerPointDotThreeDFormat_typekey: typingsJapgolly.activexPowerpoint.PowerPoint.ThreeDFormat = js.native
