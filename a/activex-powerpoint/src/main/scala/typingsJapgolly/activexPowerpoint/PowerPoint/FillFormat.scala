...
trait FillFormat extends StObject {
  ...
  /* private */ @JSName("PowerPoint.FillFormat_typekey")
  var PowerPointDotFillFormat_typekey: FillFormat
...
object FillFormat {
  ...
  inline def apply(
    ...
    PowerPointDotFillFormat_typekey: FillFormat,
    ...
    __obj.updateDynamic("PowerPoint.FillFormat_typekey")(PowerPointDotFillFormat_typekey.asInstanceOf[js.Any])
  ...
  extension [Self <: FillFormat](x: Self) {
    ...
    inline def setPowerPointDotFillFormat_typekey(value: FillFormat): Self = StObject.set(x, "PowerPoint.FillFormat_typekey", value.asInstanceOf[js.Any])
