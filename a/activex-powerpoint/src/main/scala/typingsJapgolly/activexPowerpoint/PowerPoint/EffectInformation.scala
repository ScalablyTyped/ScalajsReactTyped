...
class EffectInformation protected () extends js.Object {
  ...
  val PlaySettings: typingsJapgolly.activexPowerpoint.PowerPoint.PlaySettings = js.native
  @JSName("PowerPoint.EffectInformation_typekey")
  var PowerPointDotEffectInformation_typekey: EffectInformation = js.native
  val SoundEffect: typingsJapgolly.activexPowerpoint.PowerPoint.SoundEffect = js.native
