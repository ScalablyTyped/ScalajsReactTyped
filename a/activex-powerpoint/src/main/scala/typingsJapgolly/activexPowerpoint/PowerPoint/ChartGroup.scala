...
class ChartGroup protected () extends js.Object {
  ...
  val DownBars: typingsJapgolly.activexPowerpoint.PowerPoint.DownBars = js.native
  val DropLines: typingsJapgolly.activexPowerpoint.PowerPoint.DropLines = js.native
  ...
  val HiLoLines: typingsJapgolly.activexPowerpoint.PowerPoint.HiLoLines = js.native
  ...
  val SeriesLines: typingsJapgolly.activexPowerpoint.PowerPoint.SeriesLines = js.native
  ...
  val UpBars: typingsJapgolly.activexPowerpoint.PowerPoint.UpBars = js.native
