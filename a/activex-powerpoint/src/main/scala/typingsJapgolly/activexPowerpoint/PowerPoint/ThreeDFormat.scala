...
trait ThreeDFormat extends StObject {
  ...
  /* private */ @JSName("PowerPoint.ThreeDFormat_typekey")
...
object ThreeDFormat {
  ...
  extension [Self <: ThreeDFormat](x: Self) {
    ...
    inline def setPowerPointDotThreeDFormat_typekey(value: ThreeDFormat): Self = StObject.set(x, "PowerPoint.ThreeDFormat_typekey", value.asInstanceOf[js.Any])
