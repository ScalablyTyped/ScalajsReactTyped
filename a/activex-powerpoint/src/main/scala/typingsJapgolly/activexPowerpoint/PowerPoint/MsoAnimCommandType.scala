...
object MsoAnimCommandType {
  ...
  inline def msoAnimCommandTypeCall: `1` = 1.asInstanceOf[`1`]
  
  inline def msoAnimCommandTypeEvent: `0` = 0.asInstanceOf[`0`]
  
  inline def msoAnimCommandTypeVerb: `2` = 2.asInstanceOf[`2`]
}
