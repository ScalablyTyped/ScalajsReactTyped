...
class Chart protected () extends js.Object {
  ...
  val BackWall: typingsJapgolly.activexPowerpoint.PowerPoint.Walls = js.native
  val Bar3DGroup: ChartGroup = js.native
  var BarShape: XlBarShape = js.native
  val ChartArea: typingsJapgolly.activexPowerpoint.PowerPoint.ChartArea = js.native
  val ChartData: typingsJapgolly.activexPowerpoint.PowerPoint.ChartData = js.native
  var ChartStyle: js.Any = js.native
  val ChartTitle: typingsJapgolly.activexPowerpoint.PowerPoint.ChartTitle = js.native
  var ChartType: XlChartType = js.native
  val Column3DGroup: ChartGroup = js.native
  val Corners: typingsJapgolly.activexPowerpoint.PowerPoint.Corners = js.native
  val Creator: Double = js.native
  val DataTable: typingsJapgolly.activexPowerpoint.PowerPoint.DataTable = js.native
  var DepthPercent: Double = js.native
  var DisplayBlanksAs: XlDisplayBlanksAs = js.native
  var Elevation: Double = js.native
  val Floor: typingsJapgolly.activexPowerpoint.PowerPoint.Floor = js.native
  ...
  val Legend: typingsJapgolly.activexPowerpoint.PowerPoint.Legend = js.native
  val Line3DGroup: ChartGroup = js.native
  var Name: String = js.native
  val Parent: js.Any = js.native
  var Perspective: Double = js.native
  val Pie3DGroup: ChartGroup = js.native
  val PlotArea: typingsJapgolly.activexPowerpoint.PowerPoint.PlotArea = js.native
  ...
  val SideWall: typingsJapgolly.activexPowerpoint.PowerPoint.Walls = js.native
  var Subtype: Double = js.native
  val SurfaceGroup: ChartGroup = js.native
  var Title: String = js.native
  var Type: Double = js.native
  val Walls: typingsJapgolly.activexPowerpoint.PowerPoint.Walls = js.native
