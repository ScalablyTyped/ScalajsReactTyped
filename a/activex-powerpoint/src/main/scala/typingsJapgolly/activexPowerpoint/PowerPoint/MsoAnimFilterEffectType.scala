...
*/
trait MsoAnimFilterEffectType extends StObject
object MsoAnimFilterEffectType {
  
  inline def msoAnimFilterEffectTypeBarn: `1` = 1.asInstanceOf[`1`]
  
  inline def msoAnimFilterEffectTypeBlinds: `2` = 2.asInstanceOf[`2`]
  
  inline def msoAnimFilterEffectTypeBox: `3` = 3.asInstanceOf[`3`]
  
  inline def msoAnimFilterEffectTypeCheckerboard: `4` = 4.asInstanceOf[`4`]
  
  inline def msoAnimFilterEffectTypeCircle: `5` = 5.asInstanceOf[`5`]
  
  inline def msoAnimFilterEffectTypeDiamond: `6` = 6.asInstanceOf[`6`]
  
  inline def msoAnimFilterEffectTypeDissolve: `7` = 7.asInstanceOf[`7`]
  
  inline def msoAnimFilterEffectTypeFade: `8` = 8.asInstanceOf[`8`]
  
  inline def msoAnimFilterEffectTypeImage: `9` = 9.asInstanceOf[`9`]
  
  inline def msoAnimFilterEffectTypeNone: `0` = 0.asInstanceOf[`0`]
  
  inline def msoAnimFilterEffectTypePixelate: `10` = 10.asInstanceOf[`10`]
  
  inline def msoAnimFilterEffectTypePlus: `11` = 11.asInstanceOf[`11`]
  
  inline def msoAnimFilterEffectTypeRandomBar: `12` = 12.asInstanceOf[`12`]
  
  inline def msoAnimFilterEffectTypeSlide: `13` = 13.asInstanceOf[`13`]
  
  inline def msoAnimFilterEffectTypeStretch: `14` = 14.asInstanceOf[`14`]
  
  inline def msoAnimFilterEffectTypeStrips: `15` = 15.asInstanceOf[`15`]
  
  inline def msoAnimFilterEffectTypeWedge: `16` = 16.asInstanceOf[`16`]
  
  inline def msoAnimFilterEffectTypeWheel: `17` = 17.asInstanceOf[`17`]
  
  inline def msoAnimFilterEffectTypeWipe: `18` = 18.asInstanceOf[`18`]
}
