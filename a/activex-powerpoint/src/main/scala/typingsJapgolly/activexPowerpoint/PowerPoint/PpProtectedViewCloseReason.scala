...
object PpProtectedViewCloseReason {
  ...
  inline def ppProtectedViewCloseEdit: `1` = 1.asInstanceOf[`1`]
  
  inline def ppProtectedViewCloseForced: `2` = 2.asInstanceOf[`2`]
  
  inline def ppProtectedViewCloseNormal: `0` = 0.asInstanceOf[`0`]
}
