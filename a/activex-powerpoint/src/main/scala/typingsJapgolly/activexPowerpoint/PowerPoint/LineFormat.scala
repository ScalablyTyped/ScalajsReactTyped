...
trait LineFormat extends StObject {
  ...
  /* private */ @JSName("PowerPoint.LineFormat_typekey")
...
object LineFormat {
  ...
  extension [Self <: LineFormat](x: Self) {
    ...
    inline def setPowerPointDotLineFormat_typekey(value: LineFormat): Self = StObject.set(x, "PowerPoint.LineFormat_typekey", value.asInstanceOf[js.Any])
