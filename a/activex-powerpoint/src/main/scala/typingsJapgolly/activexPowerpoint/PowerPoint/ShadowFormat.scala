...
trait ShadowFormat extends StObject {
  ...
  /* private */ @JSName("PowerPoint.ShadowFormat_typekey")
...
object ShadowFormat {
  ...
  extension [Self <: ShadowFormat](x: Self) {
    ...
    inline def setPowerPointDotShadowFormat_typekey(value: ShadowFormat): Self = StObject.set(x, "PowerPoint.ShadowFormat_typekey", value.asInstanceOf[js.Any])
