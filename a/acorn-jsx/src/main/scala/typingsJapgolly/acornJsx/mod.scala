...
import typingsJapgolly.acornJsx.anon.TypeofParser
...
object mod {
  ...
  inline def apply(): js.Function1[
    /* BaseParser */ TypeofParser & (Instantiable2[/* options */ typingsJapgolly.acorn.mod.Options, /* input */ String, Parser]), 
    TypeofParser & (Instantiable2[/* options */ typingsJapgolly.acorn.mod.Options, /* input */ String, Parser])
