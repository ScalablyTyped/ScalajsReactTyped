...
import typingsJapgolly.activexVbide.VBIDE.vbextFileTypes
import typingsJapgolly.activexVbide.VBIDE.vbextProcKind
...
object activexVbideNumbers {
  @js.native
  sealed trait `0`
    extends vbextCodePaneview
       with vbextFileTypes
       with vbextProcKind
       with vbextProjectProtection
       with vbextRefKind
       with vbextVBAMode
  ...
  @js.native
  sealed trait `10`
    extends vbextFileTypes
       with vbextWindowType
  
  @js.native
  sealed trait `100`
    extends vbextComponentType
       with vbextProjectType
  
  @js.native
  sealed trait `101` extends vbextProjectType
  ...
  @js.native
  sealed trait `15` extends vbextWindowType
