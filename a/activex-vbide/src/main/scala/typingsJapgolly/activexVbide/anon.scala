...
object anon {
  ...
  trait Reference extends StObject {
    ...
    val Reference: typingsJapgolly.activexVbide.VBIDE.Reference
  }
  object Reference {
    
    inline def apply(Reference: typingsJapgolly.activexVbide.VBIDE.Reference): Reference = {
    ...
    extension [Self <: Reference](x: Self) {
      ...
      inline def setReference(value: typingsJapgolly.activexVbide.VBIDE.Reference): Self = StObject.set(x, "Reference", value.asInstanceOf[js.Any])
    }
  }
}
