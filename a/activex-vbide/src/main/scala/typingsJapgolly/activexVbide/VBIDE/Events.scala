...
trait Events extends StObject {
  ...
  def CommandBarEvents(CommandBarControl: Any): typingsJapgolly.activexVbide.VBIDE.CommandBarEvents
  
  def ReferencesEvents(VBProject: VBProject): typingsJapgolly.activexVbide.VBIDE.ReferencesEvents
