...
import typingsJapgolly.angularMeteor.angularMod.meteor.IScope
...
object anon {
  ...
  object Bind {
    ...
    inline def apply(bind: (IScope, String) => Callback): Bind = {
      val __obj = js.Dynamic.literal(bind = js.Any.fromFunction2((t0: IScope, t1: String) => (bind(t0, t1)).runNow()))
      __obj.asInstanceOf[Bind]
    }
    
    extension [Self <: Bind](x: Self) {
      
      inline def setBind(value: (IScope, String) => Callback): Self = StObject.set(x, "bind", js.Any.fromFunction2((t0: IScope, t1: String) => (value(t0, t1)).runNow()))
    }
  }
