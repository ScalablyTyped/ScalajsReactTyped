...
import typingsJapgolly.angularMeteor.anon.Bind
import typingsJapgolly.angularMeteor.anon.Email
import typingsJapgolly.angularMeteor.anon.Height
import typingsJapgolly.angularMeteor.anon.Id
import typingsJapgolly.angularMeteor.anon.Password
import typingsJapgolly.angularMeteor.anon.Username
  ...
  object meteor {
    ...
    trait IMeteorService extends StObject {
      ...
      /**
        ...
        */
      def autorun(scope: typingsJapgolly.angular.mod.IScope, fn: Function): Unit = js.native
    ...
    trait IRootScopeService
      extends StObject
         with typingsJapgolly.angular.mod.IRootScopeService {
