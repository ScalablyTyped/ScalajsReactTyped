package typingsJapgolly.amapJsApiStationSearch
...
import typingsJapgolly.amapJsApiStationSearch.AMap.StationSearch.SearchResult
import typingsJapgolly.amapJsApiStationSearch.AMap.StationSearch.SearchStatus
...
import typingsJapgolly.amapJsApiStationSearch.anon.Info
...
object AMap {
  ...
  object StationSearch {
    ...
    trait EventMap extends StObject {
      ...
      var error: Event_[typingsJapgolly.amapJsApiStationSearch.amapJsApiStationSearchStrings.error, Info]
    }
    object EventMap {
    ...
    */
    ...
    object SearchStatus {
      ...
      inline def complete: typingsJapgolly.amapJsApiStationSearch.amapJsApiStationSearchStrings.complete = "complete".asInstanceOf[typingsJapgolly.amapJsApiStationSearch.amapJsApiStationSearchStrings.complete]
      
      inline def error: typingsJapgolly.amapJsApiStationSearch.amapJsApiStationSearchStrings.error = "error".asInstanceOf[typingsJapgolly.amapJsApiStationSearch.amapJsApiStationSearchStrings.error]
      
      inline def no_data: typingsJapgolly.amapJsApiStationSearch.amapJsApiStationSearchStrings.no_data = "no_data".asInstanceOf[typingsJapgolly.amapJsApiStationSearch.amapJsApiStationSearchStrings.no_data]
    }
