package typingsJapgolly.admZip.anon
...
trait PartialInitOptions extends StObject {
  ...
  var method: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 61, starting with typingsJapgolly.admZip.admZipInts.`0x0018`, typingsJapgolly.admZip.admZipInts.`19`, typingsJapgolly.admZip.admZipInts.`16` */ Any
  ] = js.undefined
...
object PartialInitOptions {
  ...
  extension [Self <: PartialInitOptions](x: Self) {
    ...
    inline def setMethod(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 61, starting with typingsJapgolly.admZip.admZipInts.`0x0018`, typingsJapgolly.admZip.admZipInts.`19`, typingsJapgolly.admZip.admZipInts.`16` */ Any
