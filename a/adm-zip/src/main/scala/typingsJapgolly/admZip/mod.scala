package typingsJapgolly.admZip

import japgolly.scalajs.react.Callback
import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.admZip.anon.Filter
import typingsJapgolly.admZip.anon.Overwrite
import typingsJapgolly.admZip.anon.PartialInitOptions
import typingsJapgolly.admZip.anon.TypeofFS
...
object mod {
  ...
  object EntryHeader {
    ...
    inline def apply(
      ...
      dataHeaderToBinary: CallbackTo[Buffer],
      diskNumStart: Double,
      encripted: Boolean,
      entryHeaderSize: Double,
      entryHeaderToBinary: CallbackTo[Buffer],
      extraLength: Double,
      fileNameLength: Double,
      flags: Double,
      inAttr: Double,
      loadDataHeaderFromBinary: Buffer => Callback,
      loadFromBinary: Buffer => Callback,
      made: Double,
      method: Double,
      offset: Double,
      ...
      val __obj = js.Dynamic.literal(attr = attr.asInstanceOf[js.Any], commentLength = commentLength.asInstanceOf[js.Any], compressedSize = compressedSize.asInstanceOf[js.Any], crc = crc.asInstanceOf[js.Any], dataHeader = dataHeader.asInstanceOf[js.Any], dataHeaderToBinary = dataHeaderToBinary.toJsFn, diskNumStart = diskNumStart.asInstanceOf[js.Any], encripted = encripted.asInstanceOf[js.Any], entryHeaderSize = entryHeaderSize.asInstanceOf[js.Any], entryHeaderToBinary = entryHeaderToBinary.toJsFn, extraLength = extraLength.asInstanceOf[js.Any], fileNameLength = fileNameLength.asInstanceOf[js.Any], flags = flags.asInstanceOf[js.Any], inAttr = inAttr.asInstanceOf[js.Any], loadDataHeaderFromBinary = js.Any.fromFunction1((t0: Buffer) => loadDataHeaderFromBinary(t0).runNow()), loadFromBinary = js.Any.fromFunction1((t0: Buffer) => loadFromBinary(t0).runNow()), made = made.asInstanceOf[js.Any], method = method.asInstanceOf[js.Any], offset = offset.asInstanceOf[js.Any], realDataOffset = realDataOffset.asInstanceOf[js.Any], size = size.asInstanceOf[js.Any], time = time.asInstanceOf[js.Any], version = version.asInstanceOf[js.Any])
    ...
    extension [Self <: EntryHeader](x: Self) {
      ...
      inline def setDataHeaderToBinary(value: CallbackTo[Buffer]): Self = StObject.set(x, "dataHeaderToBinary", value.toJsFn)
      ...
      inline def setEntryHeaderToBinary(value: CallbackTo[Buffer]): Self = StObject.set(x, "entryHeaderToBinary", value.toJsFn)
      ...
      inline def setLoadDataHeaderFromBinary(value: Buffer => Callback): Self = StObject.set(x, "loadDataHeaderFromBinary", js.Any.fromFunction1((t0: Buffer) => value(t0).runNow()))
      
      inline def setLoadFromBinary(value: Buffer => Callback): Self = StObject.set(x, "loadFromBinary", js.Any.fromFunction1((t0: Buffer) => value(t0).runNow()))
  ...
  trait InitOptions extends StObject {
    ...
    /* Read method */
    var method: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 60, starting with typingsJapgolly.admZip.admZipInts.`0x0018`, typingsJapgolly.admZip.admZipInts.`19`, typingsJapgolly.admZip.admZipInts.`16` */ Any
  ...
  object InitOptions {
    ...
    inline def apply(
      method: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 60, starting with typingsJapgolly.admZip.admZipInts.`0x0018`, typingsJapgolly.admZip.admZipInts.`19`, typingsJapgolly.admZip.admZipInts.`16` */ Any,
      noSort: Boolean,
      readEntries: Boolean
    ): InitOptions = {
    ...
    extension [Self <: InitOptions](x: Self) {
      ...
      inline def setMethod(
        value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 60, starting with typingsJapgolly.admZip.admZipInts.`0x0018`, typingsJapgolly.admZip.admZipInts.`19`, typingsJapgolly.admZip.admZipInts.`16` */ Any
