...
object mod extends Shortcut {
  ...
  object global {
    ...
    trait Array[T] extends StObject {
      ...
      /** The promise of the original server interaction that created this collection. */
      @JSName("$promise")
      var $promise: IPromise[typingsJapgolly.angularResource.mod.global.Array[T]]
    ...
    object Array {
      ...
      inline def apply[T]($promise: IPromise[typingsJapgolly.angularResource.mod.global.Array[T]], $resolved: Boolean): typingsJapgolly.angularResource.mod.global.Array[T] = {
        val __obj = js.Dynamic.literal($promise = $promise.asInstanceOf[js.Any], $resolved = $resolved.asInstanceOf[js.Any])
        __obj.asInstanceOf[typingsJapgolly.angularResource.mod.global.Array[T]]
      }
      
      extension [Self <: typingsJapgolly.angularResource.mod.global.Array[?], T](x: Self & typingsJapgolly.angularResource.mod.global.Array[T]) {
        
        inline def set$promise(value: IPromise[typingsJapgolly.angularResource.mod.global.Array[T]]): Self = StObject.set(x, "$promise", value.asInstanceOf[js.Any])
