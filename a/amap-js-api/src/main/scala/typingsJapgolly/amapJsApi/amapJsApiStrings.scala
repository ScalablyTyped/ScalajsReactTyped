...
import typingsJapgolly.amapJsApi.AMap.AnimationName
import typingsJapgolly.amapJsApi.AMap.LabelMarker.Anchor
import typingsJapgolly.amapJsApi.AMap.LabelMarker.FontWeight
import typingsJapgolly.amapJsApi.AMap.LabelMarker.TextDirection
import typingsJapgolly.amapJsApi.AMap.Lang
import typingsJapgolly.amapJsApi.AMap.Map.ViewMode
import typingsJapgolly.amapJsApi.AMap.Marker.LabelDirection
...
import typingsJapgolly.amapJsApi.AMap.Text.TextAlign
import typingsJapgolly.amapJsApi.AMap.Text.VerticalAlign
...
object amapJsApiStrings {
  ...
  @js.native
  sealed trait bg
    extends typingsJapgolly.amapJsApi.AMap.Map.Feature
  ...
  sealed trait `bottom-center`
    extends Anchor
       with typingsJapgolly.amapJsApi.AMap.Marker.Anchor
       with typingsJapgolly.amapJsApi.AMap.InfoWindow.Anchor
