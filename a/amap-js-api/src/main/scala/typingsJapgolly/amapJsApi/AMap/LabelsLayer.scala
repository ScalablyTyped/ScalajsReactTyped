...
import typingsJapgolly.amapJsApi.anon.Name
...
object LabelsLayer {
  ...
  trait EventData extends StObject {
    ...
    var opts: typingsJapgolly.amapJsApi.anon.Icon
  }
  object EventData {
    
    inline def apply(data: Name, opts: typingsJapgolly.amapJsApi.anon.Icon): EventData = {
    ...
    extension [Self <: EventData](x: Self) {
      ...
      inline def setOpts(value: typingsJapgolly.amapJsApi.anon.Icon): Self = StObject.set(x, "opts", value.asInstanceOf[js.Any])
    }
  }
