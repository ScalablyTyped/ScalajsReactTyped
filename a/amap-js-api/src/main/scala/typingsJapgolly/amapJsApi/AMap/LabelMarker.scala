...
object LabelMarker {
  ...
  */
  ...
  type EventMap[I] = typingsJapgolly.amapJsApi.AMap.LabelsLayer.EventMap[I]
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.amapJsApi.amapJsApiStrings.normal
    - typingsJapgolly.amapJsApi.amapJsApiStrings.thin
    - typingsJapgolly.amapJsApi.amapJsApiStrings.bold
  */
  trait FontWeight extends StObject
  object FontWeight {
    
    inline def bold: typingsJapgolly.amapJsApi.amapJsApiStrings.bold = "bold".asInstanceOf[typingsJapgolly.amapJsApi.amapJsApiStrings.bold]
    
    inline def normal: typingsJapgolly.amapJsApi.amapJsApiStrings.normal = "normal".asInstanceOf[typingsJapgolly.amapJsApi.amapJsApiStrings.normal]
    
    inline def thin: typingsJapgolly.amapJsApi.amapJsApiStrings.thin = "thin".asInstanceOf[typingsJapgolly.amapJsApi.amapJsApiStrings.thin]
  }
