package typingsJapgolly.amapJsApi.AMap.BezierCurve

import typingsJapgolly.amapJsApi.AMap.LngLat
import typingsJapgolly.amapJsApi.AMap.Map
import typingsJapgolly.amapJsApi.AMap.StrokeLineCap
import typingsJapgolly.amapJsApi.AMap.StrokeLineJoin
...
trait GetOptionsResult[ExtraData]
  extends typingsJapgolly.amapJsApi.AMap.Polyline.GetOptionsResult[ExtraData]
