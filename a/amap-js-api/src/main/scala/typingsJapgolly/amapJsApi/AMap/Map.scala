...
import typingsJapgolly.amapJsApi.AMap.Map.Feature
import typingsJapgolly.amapJsApi.AMap.Map.Status
import typingsJapgolly.amapJsApi.AMap.Map.ViewMode
import typingsJapgolly.amapJsApi.amapJsApiBooleans.`false`
import typingsJapgolly.amapJsApi.amapJsApiStrings.EPSG3395
import typingsJapgolly.amapJsApi.amapJsApiStrings.EPSG3857
import typingsJapgolly.amapJsApi.amapJsApiStrings.EPSG4326
import typingsJapgolly.amapJsApi.amapJsApiStrings.all
import typingsJapgolly.amapJsApi.amapJsApiStrings.c
...
import typingsJapgolly.amapJsApi.amapJsApiStrings.d
...
import typingsJapgolly.amapJsApi.amapJsApiStrings.dv
...
import typingsJapgolly.amapJsApi.amapJsApiStrings.marker
...
import typingsJapgolly.amapJsApi.amapJsApiStrings.polygon_
import typingsJapgolly.amapJsApi.amapJsApiStrings.polyline
...
import typingsJapgolly.amapJsApi.amapJsApiStrings.v
import typingsJapgolly.amapJsApi.amapJsApiStrings.vw
...
import typingsJapgolly.amapJsApi.anon.City
import typingsJapgolly.amapJsApi.anon.Id
import typingsJapgolly.amapJsApi.anon.Location
import typingsJapgolly.amapJsApi.anon.PartialStatus
...
object Map {
  ...
  trait EventMap extends StObject {
    ...
    var click: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.click, Map]
    
    var complete: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.complete, Unit]
    
    var contextmenu: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.contextmenu, Map]
    
    var dblclick: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.dblclick, Map]
    
    var dragend: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.dragend, Unit]
    
    var dragging: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.dragging, Unit]
    
    var dragstart: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.dragstart, Unit]
    ...
    var mapmove: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.mapmove, Unit]
    
    var mousedown: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.mousedown, Map]
    
    var mousemove: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.mousemove, Map]
    
    var mouseout: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.mouseout, Map]
    
    var mouseover: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.mouseover, Map]
    
    var mouseup: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.mouseup, Map]
    
    var mousewheel: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.mousewheel, Map]
    
    var moveend: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.moveend, Unit]
    
    var movestart: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.movestart, Unit]
    
    var rdblclick: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.rdblclick, Map]
    
    var resize: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.resize, Unit]
    
    var rightclick: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.rightclick, Map]
    
    var touchend: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.touchend, Map]
    
    var touchmove: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.touchmove, Map]
    
    var touchstart: MapsEvent[typingsJapgolly.amapJsApi.amapJsApiStrings.touchstart, Map]
    
    var zoomchange: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.zoomchange, Unit]
    
    var zoomend: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.zoomend, Unit]
    
    var zoomstart: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.zoomstart, Unit]
  }
  object EventMap {
  ...
  */
  ...
  object Feature {
    ...
    inline def bg: typingsJapgolly.amapJsApi.amapJsApiStrings.bg = "bg".asInstanceOf[typingsJapgolly.amapJsApi.amapJsApiStrings.bg]
    
    inline def building: typingsJapgolly.amapJsApi.amapJsApiStrings.building = "building".asInstanceOf[typingsJapgolly.amapJsApi.amapJsApiStrings.building]
    
    inline def point: point_ = "point".asInstanceOf[point_]
    
    inline def road: typingsJapgolly.amapJsApi.amapJsApiStrings.road = "road".asInstanceOf[typingsJapgolly.amapJsApi.amapJsApiStrings.road]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.amapJsApi.amapJsApiStrings.`2D`
    - typingsJapgolly.amapJsApi.amapJsApiStrings.`3D`
  */
  trait ViewMode extends StObject
  object ViewMode {
    
    inline def `2D`: typingsJapgolly.amapJsApi.amapJsApiStrings.`2D` = "2D".asInstanceOf[typingsJapgolly.amapJsApi.amapJsApiStrings.`2D`]
    
    inline def `3D`: typingsJapgolly.amapJsApi.amapJsApiStrings.`3D` = "3D".asInstanceOf[typingsJapgolly.amapJsApi.amapJsApiStrings.`3D`]
  }
}
