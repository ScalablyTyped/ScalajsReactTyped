...
import typingsJapgolly.amapJsApi.LngLatcontrolPointsArrayL
...
class Polyline_[ExtraData] () extends PathOverlay[ExtraData] {
  ...
  def this(options: typingsJapgolly.amapJsApi.AMap.Polyline.Options[ExtraData]) = this()
  /**
    * 获取折线的总长度（单位：米）
    */
  ...
  /**
    ...
    * @param options 属性
    */
  def setOptions(options: typingsJapgolly.amapJsApi.AMap.Polyline.Options[ExtraData] | Partial[Options[ExtraData]]): Unit = js.native
  /**
    * 设置组成该折线的节点数组
    * @param path 节点数组
    */
