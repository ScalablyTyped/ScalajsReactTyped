...
import typingsJapgolly.amapJsApi.AMap.Circle.Options
...
import typingsJapgolly.amapJsApi.amapJsApiStrings.setRadius
...
object Circle {
  ...
  trait EventMap[I]
    ...
    var setRadius: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.setRadius, Unit]
  }
  object EventMap {
