...
object GeoJSON {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.amapJsApi.anon.Geometry
    - typingsJapgolly.amapJsApi.anon.Features
  */
  trait GeoJSONObject extends StObject
  object GeoJSONObject {
    
    inline def Features(features: js.Array[GeoJSONObject], properties: Any): typingsJapgolly.amapJsApi.anon.Features = {
      ...
      __obj.asInstanceOf[typingsJapgolly.amapJsApi.anon.Features]
    }
    
    inline def Geometry(geometry: typingsJapgolly.amapJsApi.AMap.GeoJSON.Geometry, properties: Any): typingsJapgolly.amapJsApi.anon.Geometry = {
      val __obj = js.Dynamic.literal(geometry = geometry.asInstanceOf[js.Any], properties = properties.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Feature")
      __obj.asInstanceOf[typingsJapgolly.amapJsApi.anon.Geometry]
    }
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.amapJsApi.anon.Coordinates
    - typingsJapgolly.amapJsApi.anon.CoordinatesType
    - typingsJapgolly.amapJsApi.anon.CoordinatesArray
    - typingsJapgolly.amapJsApi.anon.Geometries
  */
  trait Geometry extends StObject
  object Geometry {
    
    inline def Coordinates(coordinates: js.Tuple2[Double, Double]): typingsJapgolly.amapJsApi.anon.Coordinates = {
      val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("Point")
      __obj.asInstanceOf[typingsJapgolly.amapJsApi.anon.Coordinates]
    }
    
    inline def CoordinatesArray(coordinates: js.Array[js.Array[js.Tuple2[Double, Double]]], `type`: MultiLineString | MultiPolygon): typingsJapgolly.amapJsApi.anon.CoordinatesArray = {
      val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.amapJsApi.anon.CoordinatesArray]
    }
    
    inline def CoordinatesType(
      coordinates: js.Array[js.Tuple2[Double, Double]],
      `type`: MultiPoint | LineString | typingsJapgolly.amapJsApi.amapJsApiStrings.Polygon
    ): typingsJapgolly.amapJsApi.anon.CoordinatesType = {
      val __obj = js.Dynamic.literal(coordinates = coordinates.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.amapJsApi.anon.CoordinatesType]
    }
    
    inline def Geometries(geometries: js.Array[Geometry]): typingsJapgolly.amapJsApi.anon.Geometries = {
      val __obj = js.Dynamic.literal(geometries = geometries.asInstanceOf[js.Any])
      __obj.updateDynamic("type")("GeometryCollection")
      __obj.asInstanceOf[typingsJapgolly.amapJsApi.anon.Geometries]
    }
  }
