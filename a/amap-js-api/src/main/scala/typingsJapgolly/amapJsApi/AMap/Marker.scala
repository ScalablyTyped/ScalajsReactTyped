...
import typingsJapgolly.amapJsApi.AMap.Marker.Anchor
import typingsJapgolly.amapJsApi.AMap.Marker.Label
...
import typingsJapgolly.amapJsApi.anon.PassedPath
import typingsJapgolly.amapJsApi.anon.Position
...
object Marker {
  ...
  */
  ...
  trait EventMap[I] extends StObject {
    ...
    var movealong: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.movealong, Unit]
    
    var moveend: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.moveend, Unit]
    
    var moving: Event_[typingsJapgolly.amapJsApi.amapJsApiStrings.moving, PassedPath]
