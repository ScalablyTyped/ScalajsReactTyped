...
object Browser {
  ...
  @js.native
  val plat: typingsJapgolly.amapJsApi.amapJsApiStrings.android | typingsJapgolly.amapJsApi.amapJsApiStrings.ios | typingsJapgolly.amapJsApi.amapJsApiStrings.windows | typingsJapgolly.amapJsApi.amapJsApiStrings.mac | other = js.native
