...
import typingsJapgolly.amapJsApi.AMap.event.EventListener
import typingsJapgolly.amapJsApi.amapJsApiInts.`0`
import typingsJapgolly.amapJsApi.amapJsApiInts.`1`
...
object event {
  ...
  /**
    ...
    * @param context 事件上下文
    */
  inline def addDomListener[N /* <: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 111, starting with typingsJapgolly.amapJsApi.amapJsApiStrings.a, typingsJapgolly.amapJsApi.amapJsApiStrings.abbr, typingsJapgolly.amapJsApi.amapJsApiStrings.address */ Any */, E /* <: /* keyof std.HTMLElementEventMap */ /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 100, starting with typingsJapgolly.amapJsApi.amapJsApiStrings.fullscreenchange, typingsJapgolly.amapJsApi.amapJsApiStrings.fullscreenerror, typingsJapgolly.amapJsApi.amapJsApiStrings.copy */ Any */, C](
  ...
  /**
    ...
    * @param context 事件上下文
    */
  inline def addListener[I /* <: typingsJapgolly.amapJsApi.AMap.EventEmitter */, C](
    // tslint:disable-next-line: no-unnecessary-generics
  instance: I,
    eventName: String,
  ...
  /**
    ...
    * @param context 事件上下文
    */
  inline def addListenerOnce[I /* <: typingsJapgolly.amapJsApi.AMap.EventEmitter */, C](
    // tslint:disable-next-line: no-unnecessary-generics
  instance: I,
    eventName: String,
    handler: js.ThisFunction1[/* this */ C, /* event */ Any, Unit]
  ...
  /**
    ...
    * @param data 事件数据
    */
  inline def trigger(instance: typingsJapgolly.amapJsApi.AMap.EventEmitter, eventName: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("trigger")(instance.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def trigger(instance: typingsJapgolly.amapJsApi.AMap.EventEmitter, eventName: String, data: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("trigger")(instance.asInstanceOf[js.Any], eventName.asInstanceOf[js.Any], data.asInstanceOf[js.Any])).asInstanceOf[Unit]
}
