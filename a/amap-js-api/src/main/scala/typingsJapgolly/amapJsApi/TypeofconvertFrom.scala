...
import typingsJapgolly.amapJsApi.AMap.convertFrom.Result
import typingsJapgolly.amapJsApi.AMap.convertFrom.SearchStatus
import typingsJapgolly.amapJsApi.AMap.convertFrom.Type
