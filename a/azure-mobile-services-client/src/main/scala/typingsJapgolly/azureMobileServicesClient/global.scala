...
import typingsJapgolly.azureMobileServicesClient.Microsoft.WindowsAzure.WindowsAzureStatic
...
object global {
  ...
  object WindowsAzure extends Shortcut {
    ...
    open class MobileServiceClient protected ()
      extends StObject
         with typingsJapgolly.azureMobileServicesClient.Microsoft.WindowsAzure.MobileServiceClient {
