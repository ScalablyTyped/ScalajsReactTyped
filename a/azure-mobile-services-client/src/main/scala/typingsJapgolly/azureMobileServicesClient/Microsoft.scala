package typingsJapgolly.azureMobileServicesClient
...
object Microsoft {
  ...
  object WindowsAzure {
    ...
    object User {
      ...
      inline def apply(
        accessTokens: Any,
        getIdentities: CallbackTo[Any],
        level: String,
        mobileServiceAuthenticationToken: String,
        userId: String
      ): User = {
        val __obj = js.Dynamic.literal(accessTokens = accessTokens.asInstanceOf[js.Any], getIdentities = getIdentities.toJsFn, level = level.asInstanceOf[js.Any], mobileServiceAuthenticationToken = mobileServiceAuthenticationToken.asInstanceOf[js.Any], userId = userId.asInstanceOf[js.Any])
      ...
      extension [Self <: User](x: Self) {
        ...
        inline def setGetIdentities(value: CallbackTo[Any]): Self = StObject.set(x, "getIdentities", value.toJsFn)
    ...
    trait WindowsAzureStatic extends StObject {
      ...
      var MobileServiceClient: typingsJapgolly.azureMobileServicesClient.Microsoft.WindowsAzure.MobileServiceClient
    }
