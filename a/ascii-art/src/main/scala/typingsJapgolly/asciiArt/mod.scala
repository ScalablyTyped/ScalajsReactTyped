package typingsJapgolly.asciiArt
...
object mod {
  ...
  object Art {
    ...
    extension [Self <: Art](x: Self) {
      ...
      inline def setToPromise(value: CallbackTo[js.Promise[String]]): Self = StObject.set(x, "toPromise", value.toJsFn)
