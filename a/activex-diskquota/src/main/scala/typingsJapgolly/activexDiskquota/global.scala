...
object global {
  ...
  object DiskQuotaTypeLibrary {
    ...
    /* private */ open class DIDiskQuotaUser ()
      extends StObject
         with typingsJapgolly.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser {
      ...
      var DiskQuotaTypeLibraryDotDIDiskQuotaUser_typekey: typingsJapgolly.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser = js.native
    ...
    /* private */ open class DiskQuotaControl ()
      extends StObject
         with typingsJapgolly.activexDiskquota.DiskQuotaTypeLibrary.DiskQuotaControl {
      
      /** Add a user quota entry by Name */
      /* CompleteClass */
      override def AddUser(LogonName: String): typingsJapgolly.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser = js.native
      ...
      /* CompleteClass */
      override def DeleteUser(pUser: typingsJapgolly.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser): Unit = js.native
      
      /* private */ /* CompleteClass */
      @JSName("DiskQuotaTypeLibrary.DiskQuotaControl_typekey")
      var DiskQuotaTypeLibraryDotDiskQuotaControl_typekey: typingsJapgolly.activexDiskquota.DiskQuotaTypeLibrary.DiskQuotaControl = js.native
      
      /** Find a user quota entry by Name */
      /* CompleteClass */
      override def FindUser(LogonName: String): typingsJapgolly.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser = js.native
      
      /** Promote a user quota entry to the head of the name resolution queue */
      /* CompleteClass */
      override def GiveUserNameResolutionPriority(pUser: typingsJapgolly.activexDiskquota.DiskQuotaTypeLibrary.DIDiskQuotaUser): Unit = js.native
