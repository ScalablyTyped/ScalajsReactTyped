...
import typingsJapgolly.applepayjs.ApplePayJS.ApplePayContactField
...
import typingsJapgolly.applepayjs.ApplePayJS.ApplePayLineItemType
import typingsJapgolly.applepayjs.ApplePayJS.ApplePayMerchantCapability
