...
import typingsJapgolly.applepayjs.ApplePayJS.ApplePayErrorCode
import typingsJapgolly.applepayjs.ApplePayJS.ApplePayErrorContactField
...
object global {
  ...
  open class ApplePayError protected ()
    extends StObject
       with typingsJapgolly.applepayjs.ApplePayError {
    /**
  ...
  object ApplePayJS {
    ...
    open class ApplePayPaymentAuthorizedEvent ()
      extends StObject
         with typingsJapgolly.applepayjs.ApplePayJS.ApplePayPaymentAuthorizedEvent
    ...
    open class ApplePayPaymentMethodSelectedEvent ()
      extends StObject
         with typingsJapgolly.applepayjs.ApplePayJS.ApplePayPaymentMethodSelectedEvent
    ...
    open class ApplePayShippingContactSelectedEvent ()
      extends StObject
         with typingsJapgolly.applepayjs.ApplePayJS.ApplePayShippingContactSelectedEvent
    ...
    open class ApplePayShippingContactUpdate ()
      extends StObject
         with typingsJapgolly.applepayjs.ApplePayJS.ApplePayShippingContactUpdate {
    ...
    open class ApplePayShippingMethodSelectedEvent ()
      extends StObject
         with typingsJapgolly.applepayjs.ApplePayJS.ApplePayShippingMethodSelectedEvent
    ...
    open class ApplePayValidateMerchantEvent ()
      extends StObject
         with typingsJapgolly.applepayjs.ApplePayJS.ApplePayValidateMerchantEvent
    
    /* note: abstract class */ @JSGlobal("ApplePayJS.Event")
    @js.native
    open class Event ()
      extends StObject
         with typingsJapgolly.applepayjs.ApplePayJS.Event
    object Event {
  ...
  open class ApplePaySession protected ()
    extends StObject
       with typingsJapgolly.applepayjs.ApplePaySession {
    /**
