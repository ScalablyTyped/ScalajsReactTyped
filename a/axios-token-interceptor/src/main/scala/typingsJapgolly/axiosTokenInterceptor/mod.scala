...
object mod {
  ...
  object InterceptorOptions {
    ...
    extension [Self <: InterceptorOptions[?], T](x: Self & InterceptorOptions[T]) {
      ...
      inline def setGetToken(value: CallbackTo[String | js.Promise[String]]): Self = StObject.set(x, "getToken", value.toJsFn)
  ...
  object TokenCacheOptions {
    ...
    extension [Self <: TokenCacheOptions[?], T](x: Self & TokenCacheOptions[T]) {
      ...
      inline def setGetMaxAgeCallbackTo(value: CallbackTo[Double]): Self = StObject.set(x, "getMaxAge", value.toJsFn)
