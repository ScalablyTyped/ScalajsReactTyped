...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.azureSb.mpnserviceMod.TileTemplate
  - typingsJapgolly.azureSb.mpnserviceMod.FlipTileTemplate
  - typingsJapgolly.azureSb.mpnserviceMod.ToastTemplate
*/
