...
import typingsJapgolly.azureSb.anon.Etag
import typingsJapgolly.azureSb.anon.HeadersObject
...
object libNotificationhubserviceMod {
  ...
  trait NotificationHubService extends StObject {
    ...
    var apns: typingsJapgolly.azureSb.libApnsserviceMod.^ = js.native
    ...
    var gcm: typingsJapgolly.azureSb.libGcmserviceMod.^ = js.native
    ...
    var mpns: typingsJapgolly.azureSb.libMpnserviceMod.^ = js.native
    ...
    var wns: typingsJapgolly.azureSb.libWnsserviceMod.^ = js.native
  }
}
