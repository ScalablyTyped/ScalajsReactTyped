package typingsJapgolly.azureSb.servicebusserviceMod

import typingsJapgolly.azureSb.mod.Azure.ServiceBus.CreateNotificationHubOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.CreateQueueOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.CreateRuleOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.CreateSubscriptionOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.CreateTopicIfNotExistsOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.CreateTopicOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ListNotificationHubsOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ListQueuesOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ListRulesOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ListSubscriptionsOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ListTopicsOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.Message
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.MessageOrName
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ReceiveQueueMessageOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ReceiveSubscriptionMessageOptions
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ResponseCallback
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.ResultAndResponseCallback
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.Results.Models.Queue
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.Results.Models.Rule
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.Results.Models.Subscription
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.Results.Models.Topic
import typingsJapgolly.azureSb.mod.Azure.ServiceBus.TypedResultAndResponseCallback
...
trait ServiceBusService
  extends typingsJapgolly.azureSb.servicebusservicebaseMod.^ {
  /*
