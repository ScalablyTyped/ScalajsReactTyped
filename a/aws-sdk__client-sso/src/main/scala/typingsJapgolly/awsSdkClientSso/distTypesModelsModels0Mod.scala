...
import typingsJapgolly.awsSdkClientSso.awsSdkClientSsoStrings.client
import typingsJapgolly.awsSdkClientSso.distTypesModelsSsoserviceexceptionMod.SSOServiceException
...
object distTypesModelsModels0Mod {
  ...
  open class InvalidRequestException protected () extends SSOServiceException {
    ...
    @JSName("name")
    val name_InvalidRequestException: typingsJapgolly.awsSdkClientSso.awsSdkClientSsoStrings.InvalidRequestException = js.native
  }
  ...
  open class ResourceNotFoundException protected () extends SSOServiceException {
    ...
    @JSName("name")
    val name_ResourceNotFoundException: typingsJapgolly.awsSdkClientSso.awsSdkClientSsoStrings.ResourceNotFoundException = js.native
  }
  ...
  open class TooManyRequestsException protected () extends SSOServiceException {
    ...
    @JSName("name")
    val name_TooManyRequestsException: typingsJapgolly.awsSdkClientSso.awsSdkClientSsoStrings.TooManyRequestsException = js.native
  }
  ...
  open class UnauthorizedException protected () extends SSOServiceException {
    ...
    @JSName("name")
    val name_UnauthorizedException: typingsJapgolly.awsSdkClientSso.awsSdkClientSsoStrings.UnauthorizedException = js.native
  }
