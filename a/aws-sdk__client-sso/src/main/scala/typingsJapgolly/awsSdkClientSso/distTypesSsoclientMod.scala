...
object distTypesSsoclientMod {
  ...
  object SSOClientResolvedConfigType {
    ...
    inline def apply(
      ...
      retryStrategy: CallbackTo[js.Promise[RetryStrategy]],
      runtime: String,
      serviceId: String,
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.awsSdkClientSso.distTypesCommandsGetRoleCredentialsCommandMod.GetRoleCredentialsCommandOutput
    - typingsJapgolly.awsSdkClientSso.distTypesCommandsListAccountRolesCommandMod.ListAccountRolesCommandOutput
    - typingsJapgolly.awsSdkClientSso.distTypesCommandsListAccountsCommandMod.ListAccountsCommandOutput
    - typingsJapgolly.awsSdkClientSso.distTypesCommandsLogoutCommandMod.LogoutCommandOutput
  */
  ...
  object _ServiceOutputTypes {
    ...
    inline def GetRoleCredentialsCommandOutput($metadata: ResponseMetadata): typingsJapgolly.awsSdkClientSso.distTypesCommandsGetRoleCredentialsCommandMod.GetRoleCredentialsCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientSso.distTypesCommandsGetRoleCredentialsCommandMod.GetRoleCredentialsCommandOutput]
    }
    
    inline def ListAccountRolesCommandOutput($metadata: ResponseMetadata): typingsJapgolly.awsSdkClientSso.distTypesCommandsListAccountRolesCommandMod.ListAccountRolesCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientSso.distTypesCommandsListAccountRolesCommandMod.ListAccountRolesCommandOutput]
    }
    
    inline def ListAccountsCommandOutput($metadata: ResponseMetadata): typingsJapgolly.awsSdkClientSso.distTypesCommandsListAccountsCommandMod.ListAccountsCommandOutput = {
      val __obj = js.Dynamic.literal($metadata = $metadata.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.awsSdkClientSso.distTypesCommandsListAccountsCommandMod.ListAccountsCommandOutput]
    }
  }
}
