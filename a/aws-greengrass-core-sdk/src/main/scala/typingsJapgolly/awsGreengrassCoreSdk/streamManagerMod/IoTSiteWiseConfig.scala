...
import typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.IoTSiteWiseConfigMap
...
open class IoTSiteWiseConfig protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerClientMod.IoTSiteWiseConfig {
  /**
...
object IoTSiteWiseConfig {
  ...
  inline def fromMap(d: IoTSiteWiseConfigMap): typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.IoTSiteWiseConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMap")(d.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.IoTSiteWiseConfig]
}
