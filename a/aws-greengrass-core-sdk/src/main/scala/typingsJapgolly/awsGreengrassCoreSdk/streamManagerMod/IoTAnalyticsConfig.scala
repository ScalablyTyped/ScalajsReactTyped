...
@JSImport("aws-greengrass-core-sdk/stream-manager", "IoTAnalyticsConfig")
@js.native
open class IoTAnalyticsConfig protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerClientMod.IoTAnalyticsConfig {
  /**
