...
open class Persistence ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerClientMod.Persistence {
...
object Persistence {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "Persistence.optionsFlipped")
  @js.native
