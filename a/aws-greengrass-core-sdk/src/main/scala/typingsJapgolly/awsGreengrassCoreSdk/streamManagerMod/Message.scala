...
@JSImport("aws-greengrass-core-sdk/stream-manager", "Message")
@js.native
open class Message protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerClientMod.Message {
  /**
...
object Message {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "Message.formatsMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "Message.typesMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "Message.validationsMap")
  @js.native
