...
import typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamDefinitionMap
...
@JSImport("aws-greengrass-core-sdk/stream-manager", "MessageStreamDefinition")
@js.native
open class MessageStreamDefinition protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerClientMod.MessageStreamDefinition {
  /**
  ...
  def this(
    ...
    strategyOnFull: js.UndefOr[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.StrategyOnFull | Null],
    persistence: js.UndefOr[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.Persistence | Null],
    flushOnWrite: js.UndefOr[Boolean | Null],
    exportDefinition: js.UndefOr[
        typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.ExportDefinition | Null
      ]
  ) = this()
}
/* static members */
object MessageStreamDefinition {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "MessageStreamDefinition.formatsMap")
  @js.native
  ...
  inline def fromMap(d: MessageStreamDefinitionMap): typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMap")(d.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamDefinition]
  
  @JSImport("aws-greengrass-core-sdk/stream-manager", "MessageStreamDefinition.typesMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "MessageStreamDefinition.validationsMap")
  @js.native
