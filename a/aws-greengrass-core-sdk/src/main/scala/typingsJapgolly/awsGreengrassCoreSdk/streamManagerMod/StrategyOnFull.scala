...
open class StrategyOnFull ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerClientMod.StrategyOnFull {
...
object StrategyOnFull {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager", "StrategyOnFull.optionsFlipped")
  @js.native
