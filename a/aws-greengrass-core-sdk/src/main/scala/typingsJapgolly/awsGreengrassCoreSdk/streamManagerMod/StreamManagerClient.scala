...
import typingsJapgolly.awsGreengrassCoreSdk.streamManagerClientMod.StreamManagerClientOptions
...
open class StreamManagerClient ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerClientMod.StreamManagerClient {
