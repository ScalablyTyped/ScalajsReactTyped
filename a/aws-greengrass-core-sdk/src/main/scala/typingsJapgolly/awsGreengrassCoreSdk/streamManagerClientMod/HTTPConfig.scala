...
import typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.HTTPConfigMap
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("aws-greengrass-core-sdk/stream-manager/client", "HTTPConfig")
@js.native
open class HTTPConfig protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.HTTPConfig {
  /**
  ...
  def this(
    ...
    exportFormat: js.UndefOr[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.ExportFormat | Null]
  ) = this()
}
/* static members */
object HTTPConfig {
  ...
  inline def fromMap(d: HTTPConfigMap): typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.HTTPConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMap")(d.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.HTTPConfig]
}
