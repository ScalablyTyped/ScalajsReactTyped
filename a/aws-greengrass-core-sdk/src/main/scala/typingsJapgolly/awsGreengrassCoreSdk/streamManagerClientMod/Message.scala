...
@JSImport("aws-greengrass-core-sdk/stream-manager/client", "Message")
@js.native
open class Message protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.Message {
  /**
...
object Message {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Message.formatsMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Message.typesMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "Message.validationsMap")
  @js.native
