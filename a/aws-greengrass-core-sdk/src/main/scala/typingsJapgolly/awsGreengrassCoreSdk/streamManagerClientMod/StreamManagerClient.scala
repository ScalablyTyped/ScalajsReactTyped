...
open class StreamManagerClient () extends StObject {
  ...
  /**
    ...
    * @returns
    */
  def createMessageStream(definition: typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamDefinition): js.Promise[Unit] = js.native
  ...
  /**
    ...
    * @returns
    */
  def describeMessageStream(streamName: String): js.Promise[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamInfo] = js.native
  ...
  /**
    ...
    */
  def readMessages(streamName: String): js.Promise[js.Array[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.Message]] = js.native
  def readMessages(
    streamName: String,
    options: typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.ReadMessagesOptions
  ): js.Promise[js.Array[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.Message]] = js.native
  ...
  /**
    ...
    * @returns
    */
  def updateMessageStream(definition: typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.MessageStreamDefinition): js.Promise[Unit] = js.native
}
