...
import typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.KinesisConfigMap
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("aws-greengrass-core-sdk/stream-manager/client", "KinesisConfig")
@js.native
open class KinesisConfig protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.KinesisConfig {
  /**
...
object KinesisConfig {
  ...
  inline def fromMap(d: KinesisConfigMap): typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.KinesisConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMap")(d.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.KinesisConfig]
}
