...
import typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.S3ExportTaskExecutorConfigMap
...
@JSImport("aws-greengrass-core-sdk/stream-manager/client", "S3ExportTaskExecutorConfig")
@js.native
open class S3ExportTaskExecutorConfig protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.S3ExportTaskExecutorConfig {
  /**
  ...
  def this(
    ...
    statusConfig: js.UndefOr[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.StatusConfig | Null]
  ) = this()
}
/* static members */
object S3ExportTaskExecutorConfig {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "S3ExportTaskExecutorConfig.formatsMap")
  @js.native
  ...
  inline def fromMap(d: S3ExportTaskExecutorConfigMap): typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.S3ExportTaskExecutorConfig = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMap")(d.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.S3ExportTaskExecutorConfig]
  
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "S3ExportTaskExecutorConfig.typesMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/client", "S3ExportTaskExecutorConfig.validationsMap")
  @js.native
