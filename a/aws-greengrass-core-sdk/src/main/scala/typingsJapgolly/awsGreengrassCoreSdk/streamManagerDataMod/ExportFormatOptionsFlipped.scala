...
import typingsJapgolly.awsGreengrassCoreSdk.awsGreengrassCoreSdkStrings.JSON_BATCHED
import typingsJapgolly.awsGreengrassCoreSdk.awsGreengrassCoreSdkStrings.RAW_NOT_BATCHED
