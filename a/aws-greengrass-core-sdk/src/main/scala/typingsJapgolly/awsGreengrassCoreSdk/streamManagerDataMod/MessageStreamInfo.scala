...
@JSImport("aws-greengrass-core-sdk/stream-manager/data", "MessageStreamInfo")
@js.native
/**
  * @param definition
...
open class MessageStreamInfo ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMessageStreamInfoMod.MessageStreamInfo {
...
object MessageStreamInfo {
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/data", "MessageStreamInfo._exportStatuses")
  @js.native
  ...
  /**
    ...
    */
  @JSImport("aws-greengrass-core-sdk/stream-manager/data", "MessageStreamInfo._storageStatus")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/data", "MessageStreamInfo.formatsMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/data", "MessageStreamInfo.typesMap")
  @js.native
  ...
  @JSImport("aws-greengrass-core-sdk/stream-manager/data", "MessageStreamInfo.validationsMap")
  @js.native
