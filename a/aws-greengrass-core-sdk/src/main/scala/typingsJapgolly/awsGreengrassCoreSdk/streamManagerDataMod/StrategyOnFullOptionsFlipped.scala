...
import typingsJapgolly.awsGreengrassCoreSdk.awsGreengrassCoreSdkStrings.OverwriteOldestData
import typingsJapgolly.awsGreengrassCoreSdk.awsGreengrassCoreSdkStrings.RejectNewData
