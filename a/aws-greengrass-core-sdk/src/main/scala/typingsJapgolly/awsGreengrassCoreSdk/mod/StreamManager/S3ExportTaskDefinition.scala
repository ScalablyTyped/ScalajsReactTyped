...
import typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.S3ExportTaskDefinitionMap
import typingsJapgolly.std.Record
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("aws-greengrass-core-sdk", "StreamManager.S3ExportTaskDefinition")
@js.native
open class S3ExportTaskDefinition protected ()
  extends typingsJapgolly.awsGreengrassCoreSdk.streamManagerMod.S3ExportTaskDefinition {
  /**
...
object S3ExportTaskDefinition {
  ...
  inline def fromMap(d: S3ExportTaskDefinitionMap): typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.S3ExportTaskDefinition = ^.asInstanceOf[js.Dynamic].applyDynamic("fromMap")(d.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.awsGreengrassCoreSdk.streamManagerDataMod.S3ExportTaskDefinition]
}
