...
object mod {
  ...
  inline def generate(opts: GenerateOptions, config: AutogypiConfig): typingsJapgolly.bluebird.mod.^[js.Array[js.Object]] = (^.asInstanceOf[js.Dynamic].applyDynamic("generate")(opts.asInstanceOf[js.Any], config.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[js.Array[js.Object]]]
  ...
  inline def writeJson(outputPath: String, json: Any): typingsJapgolly.bluebird.mod.^[js.Object] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJson")(outputPath.asInstanceOf[js.Any], json.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[js.Object]]
  inline def writeJson(outputPath: String, json: Any, name: String): typingsJapgolly.bluebird.mod.^[js.Object] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJson")(outputPath.asInstanceOf[js.Any], json.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[js.Object]]
  inline def writeJson(outputPath: String, json: Any, name: String, header: String): typingsJapgolly.bluebird.mod.^[js.Object] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJson")(outputPath.asInstanceOf[js.Any], json.asInstanceOf[js.Any], name.asInstanceOf[js.Any], header.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[js.Object]]
  inline def writeJson(outputPath: String, json: Any, name: Unit, header: String): typingsJapgolly.bluebird.mod.^[js.Object] = (^.asInstanceOf[js.Dynamic].applyDynamic("writeJson")(outputPath.asInstanceOf[js.Any], json.asInstanceOf[js.Any], name.asInstanceOf[js.Any], header.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.bluebird.mod.^[js.Object]]
