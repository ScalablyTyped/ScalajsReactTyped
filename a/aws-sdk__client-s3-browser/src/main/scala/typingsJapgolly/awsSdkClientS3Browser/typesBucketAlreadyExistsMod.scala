...
import typingsJapgolly.awsSdkClientS3Browser.typesCreateBucketExceptionsUnionMod.CreateBucketExceptionsUnion
...
object typesBucketAlreadyExistsMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_BucketAlreadyExistsDetails> * / any */ trait BucketAlreadyExists
    ...
    var name: typingsJapgolly.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.BucketAlreadyExists
  }
  object BucketAlreadyExists {
    ...
    extension [Self <: BucketAlreadyExists](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.BucketAlreadyExists): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
