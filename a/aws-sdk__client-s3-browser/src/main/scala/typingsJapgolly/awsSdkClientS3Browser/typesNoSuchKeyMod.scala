...
object typesNoSuchKeyMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_NoSuchKeyDetails> * / any */ trait NoSuchKey extends StObject {
    ...
    var name: typingsJapgolly.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchKey
  }
  object NoSuchKey {
    ...
    extension [Self <: NoSuchKey](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchKey): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
