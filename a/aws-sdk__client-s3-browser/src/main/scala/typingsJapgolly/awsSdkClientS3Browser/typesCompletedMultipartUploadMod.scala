...
import typingsJapgolly.awsSdkClientS3Browser.typesCompletedPartMod.CompletedPart
import typingsJapgolly.awsSdkClientS3Browser.typesCompletedPartMod.UnmarshalledCompletedPart
