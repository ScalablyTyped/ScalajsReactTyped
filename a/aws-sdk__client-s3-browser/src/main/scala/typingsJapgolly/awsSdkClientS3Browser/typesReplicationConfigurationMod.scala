...
import typingsJapgolly.awsSdkClientS3Browser.typesReplicationRuleMod.ReplicationRule
import typingsJapgolly.awsSdkClientS3Browser.typesReplicationRuleMod.UnmarshalledReplicationRule
