...
import typingsJapgolly.awsSdkClientS3Browser.typesLifecycleRuleMod.LifecycleRule
import typingsJapgolly.awsSdkClientS3Browser.typesLifecycleRuleMod.UnmarshalledLifecycleRule
