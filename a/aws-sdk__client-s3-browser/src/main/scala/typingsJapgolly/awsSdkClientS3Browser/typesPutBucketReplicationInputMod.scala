...
object typesPutBucketReplicationInputMod {
  ...
  trait PutBucketReplicationInput
    ...
    /**
      ...
      */
    var ReplicationConfiguration: typingsJapgolly.awsSdkClientS3Browser.typesReplicationConfigurationMod.ReplicationConfiguration
  }
  object PutBucketReplicationInput {
    ...
    extension [Self <: PutBucketReplicationInput](x: Self) {
