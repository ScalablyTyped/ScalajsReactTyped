...
import typingsJapgolly.awsSdkClientS3Browser.typesLifecycleConfigurationMod.LifecycleConfiguration
...
object typesPutBucketLifecycleInputMod {
  ...
  trait PutBucketLifecycleInput
    ...
    var LifecycleConfiguration: js.UndefOr[
        typingsJapgolly.awsSdkClientS3Browser.typesLifecycleConfigurationMod.LifecycleConfiguration
      ] = js.undefined
  }
  object PutBucketLifecycleInput {
    ...
    extension [Self <: PutBucketLifecycleInput](x: Self) {
