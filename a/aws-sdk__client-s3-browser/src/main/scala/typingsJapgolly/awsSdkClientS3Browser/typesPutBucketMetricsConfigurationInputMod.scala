...
object typesPutBucketMetricsConfigurationInputMod {
  ...
  trait PutBucketMetricsConfigurationInput
    ...
    /**
      ...
      */
    var MetricsConfiguration: typingsJapgolly.awsSdkClientS3Browser.typesMetricsConfigurationMod.MetricsConfiguration
  }
  object PutBucketMetricsConfigurationInput {
    
    inline def apply(Bucket: String, Id: String, MetricsConfiguration: MetricsConfiguration): PutBucketMetricsConfigurationInput = {
    ...
    extension [Self <: PutBucketMetricsConfigurationInput](x: Self) {
