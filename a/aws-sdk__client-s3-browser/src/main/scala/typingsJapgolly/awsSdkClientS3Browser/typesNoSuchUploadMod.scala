...
object typesNoSuchUploadMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_NoSuchUploadDetails> * / any */ trait NoSuchUpload extends StObject {
    ...
    var name: typingsJapgolly.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchUpload
  }
  object NoSuchUpload {
    ...
    extension [Self <: NoSuchUpload](x: Self) {
      ...
      inline def setName(value: typingsJapgolly.awsSdkClientS3Browser.awsSdkClientS3BrowserStrings.NoSuchUpload): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
    }
  }
