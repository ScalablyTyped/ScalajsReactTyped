...
import typingsJapgolly.agentBase.agentBaseBooleans.`false`
import typingsJapgolly.agentBase.agentBaseBooleans.`true`
import typingsJapgolly.agentBase.anon.PickAgentaddRequest
...
object mod {
  ...
  open class Agent () extends EventEmitter {
    ...
    var options: typingsJapgolly.node.httpsMod.AgentOptions = js.native
  ...
  type AgentLike = PickAgentaddRequest | typingsJapgolly.node.httpMod.Agent
  ...
  trait HttpRequestOptions
    ...
    var _defaultAgent: js.UndefOr[typingsJapgolly.node.httpMod.Agent] = js.undefined
    
    var agent: js.UndefOr[typingsJapgolly.node.httpMod.Agent | Boolean] = js.undefined
    ...
    var createConnection: js.UndefOr[
        js.Function2[
          /* options */ this.type, 
          /* oncreate */ js.Function2[/* err */ js.Error, /* socket */ typingsJapgolly.node.nodeColonnetMod.Socket, Unit], 
  ...
  object HttpRequestOptions {
    ...
    extension [Self <: HttpRequestOptions](x: Self) {
      ...
      inline def setAgent(value: typingsJapgolly.node.httpMod.Agent | Boolean): Self = StObject.set(x, "agent", value.asInstanceOf[js.Any])
      ...
      inline def setCreateConnection(
        value: (HttpRequestOptions, /* oncreate */ js.Function2[/* err */ js.Error, /* socket */ typingsJapgolly.node.nodeColonnetMod.Socket, Unit]) => typingsJapgolly.node.nodeColonnetMod.Socket
      ...
      inline def set_defaultAgent(value: typingsJapgolly.node.httpMod.Agent): Self = StObject.set(x, "_defaultAgent", value.asInstanceOf[js.Any])
  ...
  object HttpsRequestOptions {
    ...
    extension [Self <: HttpsRequestOptions](x: Self) {
      ...
      inline def setCreateConnection(
        value: (HttpsRequestOptions, /* oncreate */ js.Function2[/* err */ js.Error, /* socket */ typingsJapgolly.node.nodeColonnetMod.Socket, Unit]) => typingsJapgolly.node.nodeColonnetMod.Socket
      ): Self = StObject.set(x, "createConnection", js.Any.fromFunction2(value))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.agentBase.mod.HttpRequestOptions
    - typingsJapgolly.agentBase.mod.HttpsRequestOptions
  */
  trait RequestOptions extends StObject
  object RequestOptions {
    
    inline def HttpRequestOptions(port: Double): typingsJapgolly.agentBase.mod.HttpRequestOptions = {
      val __obj = js.Dynamic.literal(port = port.asInstanceOf[js.Any], secureEndpoint = false)
      __obj.asInstanceOf[typingsJapgolly.agentBase.mod.HttpRequestOptions]
    }
    
    inline def HttpsRequestOptions(port: Double): typingsJapgolly.agentBase.mod.HttpsRequestOptions = {
      val __obj = js.Dynamic.literal(port = port.asInstanceOf[js.Any], secureEndpoint = true)
      __obj.asInstanceOf[typingsJapgolly.agentBase.mod.HttpsRequestOptions]
    }
  }
}
