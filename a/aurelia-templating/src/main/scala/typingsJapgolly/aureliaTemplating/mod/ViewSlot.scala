...
@js.native
open class ViewSlot protected () extends StObject {
  /**
  ...
  /**
  	...
  	*/
  def add(view: View_): Unit | js.Promise[Any] = js.native
  ...
  /**
  	 ...
  	 */
  def animateView(view: View_): Unit | js.Promise[Any] = js.native
  def animateView(view: View_, direction: String): Unit | js.Promise[Any] = js.native
  ...
  /**
  	...
  	*/
  def insert(index: Double, view: View_): Unit | js.Promise[Any] = js.native
  ...
  /**
  	 ...
  	 */
  def move(sourceIndex: Any, targetIndex: Any): Unit = js.native
  ...
  def remove(view: View_, returnToCache: Unit, skipAnimation: Boolean): View_ | js.Promise[View_] = js.native
  ...
  /**
  	...
  	*/
  def removeAll(): Unit | js.Promise[Any] = js.native
  def removeAll(returnToCache: Boolean): Unit | js.Promise[Any] = js.native
  def removeAll(returnToCache: Boolean, skipAnimation: Boolean): Unit | js.Promise[Any] = js.native
  def removeAll(returnToCache: Unit, skipAnimation: Boolean): Unit | js.Promise[Any] = js.native
  ...
  def removeAt(index: Double, returnToCache: Unit, skipAnimation: Boolean): View_ | js.Promise[View_] = js.native
  ...
  def removeMany(viewsToRemove: js.Array[View_], returnToCache: Unit, skipAnimation: Boolean): Unit | js.Promise[Unit] = js.native
