...
@js.native
open class ResourceDescription protected () extends StObject {
  /**
  	...
  	*/
  def this(key: String, exportedValue: Any) = this()
  def this(key: String, exportedValue: Any, resourceTypeMeta: js.Object) = this()
