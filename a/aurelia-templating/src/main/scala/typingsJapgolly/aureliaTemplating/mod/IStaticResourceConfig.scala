...
object IStaticResourceConfig {
  ...
  extension [Self <: IStaticResourceConfig](x: Self) {
    ...
    inline def setProcessAttributes(
      value: (/* viewCompiler */ ViewCompiler, /* resources */ ViewResources_, /* node */ Element, /* attributes */ NamedNodeMap, /* elementInstruction */ BehaviorInstruction) => Callback
    ): Self = StObject.set(x, "processAttributes", js.Any.fromFunction5((t0: /* viewCompiler */ ViewCompiler, t1: /* resources */ ViewResources_, t2: /* node */ Element, t3: /* attributes */ NamedNodeMap, t4: /* elementInstruction */ BehaviorInstruction) => (value(t0, t1, t2, t3, t4)).runNow()))
    ...
    inline def setType(
      value: element | attribute | valueConverter | bindingBehavior | typingsJapgolly.aureliaTemplating.aureliaTemplatingStrings.viewEngineHooks
