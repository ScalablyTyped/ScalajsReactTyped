...
class Animator () extends js.Object {
  ...
  def animate(element: js.Array[typingsJapgolly.std.HTMLElement], className: String): js.Promise[Boolean] = js.native
  /**
    ...
    * @returns Resolved when the animation is done
    */
  def animate(element: typingsJapgolly.std.HTMLElement, className: String): js.Promise[Boolean] = js.native
  /**
