...
@js.native
open class BindingLanguage () extends StObject {
  ...
  def createAttributeInstruction(
    resources: ViewResources_,
    element: Element,
    info: js.Object,
    existingInstruction: js.Object,
    context: HtmlBehaviorResource
  ): BehaviorInstruction = js.native
  def createAttributeInstruction(
    resources: ViewResources_,
    element: Element,
    info: js.Object,
    existingInstruction: Unit,
    context: HtmlBehaviorResource
  ): BehaviorInstruction = js.native
