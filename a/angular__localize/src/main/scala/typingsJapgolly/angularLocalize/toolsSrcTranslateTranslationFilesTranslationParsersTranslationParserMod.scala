...
import typingsJapgolly.angularLocalize.angularLocalizeBooleans.`false`
import typingsJapgolly.angularLocalize.angularLocalizeBooleans.`true`
import typingsJapgolly.angularLocalize.mod.MessageId
...
object toolsSrcTranslateTranslationFilesTranslationParsersTranslationParserMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularLocalize.toolsSrcTranslateTranslationFilesTranslationParsersTranslationParserMod.CanParseAnalysis[Hint]
    - typingsJapgolly.angularLocalize.toolsSrcTranslateTranslationFilesTranslationParsersTranslationParserMod.CannotParseAnalysis
  */
  trait ParseAnalysis[Hint] extends StObject
  object ParseAnalysis {
    
    inline def CanParseAnalysis[Hint](diagnostics: Diagnostics, hint: Hint): typingsJapgolly.angularLocalize.toolsSrcTranslateTranslationFilesTranslationParsersTranslationParserMod.CanParseAnalysis[Hint] = {
      val __obj = js.Dynamic.literal(canParse = true, diagnostics = diagnostics.asInstanceOf[js.Any], hint = hint.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularLocalize.toolsSrcTranslateTranslationFilesTranslationParsersTranslationParserMod.CanParseAnalysis[Hint]]
    }
    
    inline def CannotParseAnalysis(diagnostics: Diagnostics): typingsJapgolly.angularLocalize.toolsSrcTranslateTranslationFilesTranslationParsersTranslationParserMod.CannotParseAnalysis = {
      val __obj = js.Dynamic.literal(canParse = false, diagnostics = diagnostics.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.angularLocalize.toolsSrcTranslateTranslationFilesTranslationParsersTranslationParserMod.CannotParseAnalysis]
    }
  }
