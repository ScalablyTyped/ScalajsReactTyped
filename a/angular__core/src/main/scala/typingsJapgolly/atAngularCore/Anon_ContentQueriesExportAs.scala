...
import typingsJapgolly.atAngularCore.atAngularCoreMod.DirectiveDefFeature
...
trait Anon_ContentQueriesExportAs[T] extends js.Object {
  ...
  {[ P in keyof T ]:? string | [string, string] | undefined}
    */ typingsJapgolly.atAngularCore.atAngularCoreStrings.Anon_ContentQueriesExportAs with js.Any
  ] = js.native
  /**
