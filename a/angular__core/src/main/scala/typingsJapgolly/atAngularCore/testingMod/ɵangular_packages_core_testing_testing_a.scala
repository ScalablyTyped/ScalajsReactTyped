...
class ɵangular_packages_core_testing_testing_a ()
  extends typingsJapgolly.atAngularCore.testingTestingMod.ɵangular_packages_core_testing_testing_a
...
object ɵangular_packages_core_testing_testing_a extends js.Object {
  ...
  def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef): typingsJapgolly.atAngularCore.testingTestingMod.ɵangular_packages_core_testing_testing_a = js.native
  def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsJapgolly.atAngularCore.testingTestingMod.ɵangular_packages_core_testing_testing_a = js.native
  /**
    ...
    */
  def initTestEnvironment(ngModule: Type[_], platform: PlatformRef): typingsJapgolly.atAngularCore.testingTestingMod.ɵangular_packages_core_testing_testing_a = js.native
  def initTestEnvironment(ngModule: Type[_], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsJapgolly.atAngularCore.testingTestingMod.ɵangular_packages_core_testing_testing_a = js.native
