...
import typingsJapgolly.atAngularCore.schematicsMigrationsStaticDashQueriesAngularQueryDashDefinitionMod.NgQueryDefinition
import typingsJapgolly.atAngularCore.schematicsMigrationsStaticDashQueriesStrategiesTimingDashStrategyMod.TimingResult
import typingsJapgolly.atAngularCore.schematicsMigrationsStaticDashQueriesStrategiesTimingDashStrategyMod.TimingStrategy
