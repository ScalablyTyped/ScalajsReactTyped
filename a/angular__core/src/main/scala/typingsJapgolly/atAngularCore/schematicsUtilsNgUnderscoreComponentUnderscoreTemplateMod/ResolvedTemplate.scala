package typingsJapgolly.atAngularCore.schematicsUtilsNgUnderscoreComponentUnderscoreTemplateMod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.atAngularCore.Anon_Character
...
object ResolvedTemplate {
  ...
  def apply(
    ...
    content: String,
    filePath: String,
    getCharacterAndLineOfPosition: Double => CallbackTo[Anon_Character],
    `inline`: Boolean,
    start: Double
  ): ResolvedTemplate = {
