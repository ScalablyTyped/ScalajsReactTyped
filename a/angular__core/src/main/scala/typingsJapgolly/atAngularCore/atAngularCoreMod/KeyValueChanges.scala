...
object KeyValueChanges {
  ...
  /* r */ typingsJapgolly.atAngularCore.atAngularCoreMod.KeyValueChangeRecord[K, V], 
  scala.Unit]) => forEachAddedItem(t0).runNow()))
    __obj.updateDynamic("forEachChangedItem")(js.Any.fromFunction1((t0: js.Function1[
  /* r */ typingsJapgolly.atAngularCore.atAngularCoreMod.KeyValueChangeRecord[K, V], 
  scala.Unit]) => forEachChangedItem(t0).runNow()))
