...
object ChangeDetectionStrategy extends js.Object {
  ...
  /* 1 */ val Default: typingsJapgolly.atAngularCore.atAngularCoreMod.ChangeDetectionStrategy.Default with Double = js.native
  /* 0 */ val OnPush: typingsJapgolly.atAngularCore.atAngularCoreMod.ChangeDetectionStrategy.OnPush with Double = js.native
  @JSBracketAccess
