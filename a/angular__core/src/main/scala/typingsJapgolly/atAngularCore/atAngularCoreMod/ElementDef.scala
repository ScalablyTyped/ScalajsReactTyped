...
object ElementDef {
  ...
  def apply(
    ...
    handleEvent: (/* view */ ViewData, /* eventName */ String, /* event */ js.Any) => CallbackTo[Boolean] = null,
    name: String = null,
    ns: String = null,
    ...
    if (handleEvent != null) __obj.updateDynamic("handleEvent")(js.Any.fromFunction3((t0: /* view */ typingsJapgolly.atAngularCore.atAngularCoreMod.ViewData, t1: /* eventName */ java.lang.String, t2: /* event */ js.Any) => handleEvent(t0, t1, t2).runNow()))
