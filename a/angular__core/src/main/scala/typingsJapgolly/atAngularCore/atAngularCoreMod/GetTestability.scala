...
object GetTestability {
  ...
  def apply(
    ...
    __obj.updateDynamic("addToWindow")(js.Any.fromFunction1((t0: typingsJapgolly.atAngularCore.atAngularCoreMod.TestabilityRegistry) => addToWindow(t0).runNow()))
    __obj.updateDynamic("findTestabilityInTree")(js.Any.fromFunction3((t0: typingsJapgolly.atAngularCore.atAngularCoreMod.TestabilityRegistry, t1: js.Any, t2: scala.Boolean) => findTestabilityInTree(t0, t1, t2).runNow()))
