...
object RendererStyleFlags2 extends js.Object {
  ...
  /* 2 */ val DashCase: typingsJapgolly.atAngularCore.atAngularCoreMod.RendererStyleFlags2.DashCase with Double = js.native
  /* 1 */ val Important: typingsJapgolly.atAngularCore.atAngularCoreMod.RendererStyleFlags2.Important with Double = js.native
  @JSBracketAccess
