...
object ViewEncapsulation extends js.Object {
  ...
  /* 0 */ val Emulated: typingsJapgolly.atAngularCore.atAngularCoreMod.ViewEncapsulation.Emulated with Double = js.native
  /* 1 */ val Native: typingsJapgolly.atAngularCore.atAngularCoreMod.ViewEncapsulation.Native with Double = js.native
  /* 2 */ val None: typingsJapgolly.atAngularCore.atAngularCoreMod.ViewEncapsulation.None with Double = js.native
  /* 3 */ val ShadowDom: typingsJapgolly.atAngularCore.atAngularCoreMod.ViewEncapsulation.ShadowDom with Double = js.native
  @JSBracketAccess
