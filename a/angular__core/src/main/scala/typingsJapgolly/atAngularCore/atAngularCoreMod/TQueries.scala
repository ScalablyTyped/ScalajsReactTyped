...
object TQueries {
  ...
  def apply(
    ...
    __obj.updateDynamic("elementEnd")(js.Any.fromFunction1((t0: typingsJapgolly.atAngularCore.atAngularCoreMod.TNode) => elementEnd(t0).runNow()))
    __obj.updateDynamic("elementStart")(js.Any.fromFunction2((t0: typingsJapgolly.atAngularCore.atAngularCoreMod.TView, t1: typingsJapgolly.atAngularCore.atAngularCoreMod.TNode) => elementStart(t0, t1).runNow()))
    __obj.updateDynamic("embeddedTView")(js.Any.fromFunction1((t0: typingsJapgolly.atAngularCore.atAngularCoreMod.TNode) => embeddedTView(t0).runNow()))
    __obj.updateDynamic("getByIndex")(js.Any.fromFunction1((t0: scala.Double) => getByIndex(t0).runNow()))
    __obj.updateDynamic("template")(js.Any.fromFunction2((t0: typingsJapgolly.atAngularCore.atAngularCoreMod.TView, t1: typingsJapgolly.atAngularCore.atAngularCoreMod.TNode) => template(t0, t1).runNow()))
    __obj.updateDynamic("track")(js.Any.fromFunction1((t0: typingsJapgolly.atAngularCore.atAngularCoreMod.TQuery) => track(t0).runNow()))
