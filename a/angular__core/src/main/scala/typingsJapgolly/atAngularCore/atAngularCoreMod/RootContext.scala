...
object RootContext {
  ...
  def apply(
    ...
    scheduler: js.Function0[Unit] => Callback,
    playerHandler: ɵPlayerHandler = null
  ): RootContext = {
    val __obj = js.Dynamic.literal(clean = clean.asInstanceOf[js.Any], components = components.asInstanceOf[js.Any], flags = flags.asInstanceOf[js.Any])
    __obj.updateDynamic("scheduler")(js.Any.fromFunction1((t0: js.Function0[scala.Unit]) => scheduler(t0).runNow()))
