...
object TView {
  ...
  def apply(
    ...
    template: (/* rf */ ɵRenderFlags, js.Object) => Callback = null,
    viewCheckHooks: HookData = null,
    viewHooks: HookData = null,
    viewQuery: (/* rf */ ɵRenderFlags, js.Object) => Callback = null
  ): TView = {
    ...
    if (template != null) __obj.updateDynamic("template")(js.Any.fromFunction2((t0: /* rf */ typingsJapgolly.atAngularCore.atAngularCoreMod.ɵRenderFlags, t1: js.Object) => template(t0, t1).runNow()))
    ...
    if (viewQuery != null) __obj.updateDynamic("viewQuery")(js.Any.fromFunction2((t0: /* rf */ typingsJapgolly.atAngularCore.atAngularCoreMod.ɵRenderFlags, t1: js.Object) => viewQuery(t0, t1).runNow()))
