...
object TQuery {
  ...
  def apply(
    ...
    __obj.updateDynamic("embeddedTView")(js.Any.fromFunction2((t0: typingsJapgolly.atAngularCore.atAngularCoreMod.TNode, t1: scala.Double) => embeddedTView(t0, t1).runNow()))
