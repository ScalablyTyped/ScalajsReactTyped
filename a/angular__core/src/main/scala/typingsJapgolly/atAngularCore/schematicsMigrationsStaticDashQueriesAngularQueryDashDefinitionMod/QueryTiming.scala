...
object QueryTiming extends js.Object {
  ...
  /* 1 */ val DYNAMIC: typingsJapgolly.atAngularCore.schematicsMigrationsStaticDashQueriesAngularQueryDashDefinitionMod.QueryTiming.DYNAMIC with Double = js.native
  /* 0 */ val STATIC: typingsJapgolly.atAngularCore.schematicsMigrationsStaticDashQueriesAngularQueryDashDefinitionMod.QueryTiming.STATIC with Double = js.native
  @JSBracketAccess
