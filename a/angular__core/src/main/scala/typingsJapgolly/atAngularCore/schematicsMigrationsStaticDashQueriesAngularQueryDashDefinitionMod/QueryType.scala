...
object QueryType extends js.Object {
  ...
  /* 1 */ val ContentChild: typingsJapgolly.atAngularCore.schematicsMigrationsStaticDashQueriesAngularQueryDashDefinitionMod.QueryType.ContentChild with Double = js.native
  /* 0 */ val ViewChild: typingsJapgolly.atAngularCore.schematicsMigrationsStaticDashQueriesAngularQueryDashDefinitionMod.QueryType.ViewChild with Double = js.native
  @JSBracketAccess
