...
import typingsJapgolly.atAngularCore.atAngularCoreMod.ChangeDetectionStrategy
import typingsJapgolly.atAngularCore.atAngularCoreMod.ComponentDefFeature
import typingsJapgolly.atAngularCore.atAngularCoreMod.ComponentTemplate
import typingsJapgolly.atAngularCore.atAngularCoreMod.ContentQueriesFunction
import typingsJapgolly.atAngularCore.atAngularCoreMod.DirectiveTypesOrFactory
...
import typingsJapgolly.atAngularCore.atAngularCoreMod.PipeTypesOrFactory
import typingsJapgolly.atAngularCore.atAngularCoreMod.SchemaMetadata
...
import typingsJapgolly.atAngularCore.atAngularCoreMod.ɵCssSelectorList
...
trait Anon_ChangeDetection[T] extends js.Object {
  ...
  {[ P in keyof T ]:? string | [string, string]}
    */ typingsJapgolly.atAngularCore.atAngularCoreStrings.Anon_ChangeDetection with js.Any
  ] = js.native
  /**
