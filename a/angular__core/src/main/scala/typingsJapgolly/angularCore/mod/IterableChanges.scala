...
object IterableChanges {
  ...
  def apply[V](
    ...
    __obj.updateDynamic("forEachAddedItem")(js.Any.fromFunction1((t0: js.Function1[/* record */ typingsJapgolly.angularCore.mod.IterableChangeRecord[V], scala.Unit]) => forEachAddedItem(t0).runNow()))
    __obj.updateDynamic("forEachIdentityChange")(js.Any.fromFunction1((t0: js.Function1[/* record */ typingsJapgolly.angularCore.mod.IterableChangeRecord[V], scala.Unit]) => forEachIdentityChange(t0).runNow()))
    __obj.updateDynamic("forEachItem")(js.Any.fromFunction1((t0: js.Function1[/* record */ typingsJapgolly.angularCore.mod.IterableChangeRecord[V], scala.Unit]) => forEachItem(t0).runNow()))
    __obj.updateDynamic("forEachMovedItem")(js.Any.fromFunction1((t0: js.Function1[/* record */ typingsJapgolly.angularCore.mod.IterableChangeRecord[V], scala.Unit]) => forEachMovedItem(t0).runNow()))
    __obj.updateDynamic("forEachOperation")(js.Any.fromFunction1((t0: js.Function3[
  /* record */ typingsJapgolly.angularCore.mod.IterableChangeRecord[V], 
  /* previousIndex */ scala.Double | scala.Null, 
  /* currentIndex */ scala.Double | scala.Null, 
  scala.Unit]) => forEachOperation(t0).runNow()))
    __obj.updateDynamic("forEachPreviousItem")(js.Any.fromFunction1((t0: js.Function1[/* record */ typingsJapgolly.angularCore.mod.IterableChangeRecord[V], scala.Unit]) => forEachPreviousItem(t0).runNow()))
    __obj.updateDynamic("forEachRemovedItem")(js.Any.fromFunction1((t0: js.Function1[/* record */ typingsJapgolly.angularCore.mod.IterableChangeRecord[V], scala.Unit]) => forEachRemovedItem(t0).runNow()))
