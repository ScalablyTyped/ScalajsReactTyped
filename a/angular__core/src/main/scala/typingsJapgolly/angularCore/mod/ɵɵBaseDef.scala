...
trait ɵɵBaseDef[T] extends js.Object {
  ...
  {[ P in keyof T ]: string}
    */ typingsJapgolly.angularCore.angularCoreStrings.ɵɵBaseDef with js.Any
  /**
...
object ɵɵBaseDef {
  ...
  {[ P in keyof T ]: string}
    */ typingsJapgolly.angularCore.angularCoreStrings.ɵɵBaseDef with js.Any,
    ...
    if (contentQueries != null) __obj.updateDynamic("contentQueries")(js.Any.fromFunction3((t0: /* rf */ typingsJapgolly.angularCore.mod.ɵRenderFlags, t1: T, t2: /* directiveIndex */ scala.Double) => contentQueries(t0, t1, t2).runNow()))
    if (hostBindings != null) __obj.updateDynamic("hostBindings")(js.Any.fromFunction3((t0: /* rf */ typingsJapgolly.angularCore.mod.ɵRenderFlags, t1: T, t2: /* elementIndex */ scala.Double) => hostBindings(t0, t1, t2).runNow()))
    if (viewQuery != null) __obj.updateDynamic("viewQuery")(js.Any.fromFunction2((t0: /* rf */ typingsJapgolly.angularCore.mod.ɵRenderFlags, t1: T) => viewQuery(t0, t1).runNow()))
