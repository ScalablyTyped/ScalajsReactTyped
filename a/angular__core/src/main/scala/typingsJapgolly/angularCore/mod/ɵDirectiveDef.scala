...
object ɵDirectiveDef {
  ...
  extension [Self <: ɵDirectiveDef[?], T](x: Self & ɵDirectiveDef[T]) {
    ...
    inline def setProvidersResolver(
      value: (/* def */ ɵDirectiveDef[T], /* processProvidersFn */ js.UndefOr[ProcessProvidersFunction]) => Callback
    ): Self = StObject.set(x, "providersResolver", js.Any.fromFunction2((t0: /* def */ ɵDirectiveDef[T], t1: /* processProvidersFn */ js.UndefOr[ProcessProvidersFunction]) => (value(t0, t1)).runNow()))
