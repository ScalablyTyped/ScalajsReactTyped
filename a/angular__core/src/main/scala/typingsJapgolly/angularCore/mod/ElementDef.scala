...
object ElementDef {
  ...
  def apply(
    ...
    if (handleEvent != null) __obj.updateDynamic("handleEvent")(js.Any.fromFunction3((t0: /* view */ typingsJapgolly.angularCore.mod.ViewData, t1: /* eventName */ java.lang.String, t2: /* event */ js.Any) => handleEvent(t0, t1, t2).runNow()))
