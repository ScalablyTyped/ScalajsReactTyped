...
object R3DeclareNgModuleFacade {
  ...
  extension [Self <: R3DeclareNgModuleFacade](x: Self) {
    ...
    inline def setBootstrapCallbackTo(value: CallbackTo[js.Array[OpaqueValue]]): Self = StObject.set(x, "bootstrap", value.toJsFn)
    ...
    inline def setDeclarationsCallbackTo(value: CallbackTo[js.Array[OpaqueValue]]): Self = StObject.set(x, "declarations", value.toJsFn)
    ...
    inline def setExportsCallbackTo(value: CallbackTo[js.Array[OpaqueValue]]): Self = StObject.set(x, "exports", value.toJsFn)
    ...
    inline def setImportsCallbackTo(value: CallbackTo[js.Array[OpaqueValue]]): Self = StObject.set(x, "imports", value.toJsFn)
