...
object LQuery {
  @scala.inline
  def apply[T](queryList: QueryList[T], setDirty: Callback, matches: js.Array[T | Null] = null): LQuery[T] = {
    val __obj = js.Dynamic.literal(queryList = queryList.asInstanceOf[js.Any])
    __obj.updateDynamic("setDirty")(setDirty.toJsFn)
