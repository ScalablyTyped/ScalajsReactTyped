...
import typingsJapgolly.angularCore.angularCoreStrings.Asterisk
import typingsJapgolly.angularCore.angularCoreStrings.BrowserAnimations
import typingsJapgolly.angularCore.angularCoreStrings.HTML
import typingsJapgolly.angularCore.angularCoreStrings.NoopAnimations
import typingsJapgolly.angularCore.angularCoreStrings.ResourceURL
import typingsJapgolly.angularCore.angularCoreStrings.Script
import typingsJapgolly.angularCore.angularCoreStrings.Style
import typingsJapgolly.angularCore.angularCoreStrings.URL
import typingsJapgolly.angularCore.anon.AppProviders
import typingsJapgolly.angularCore.anon.Bootstrap
import typingsJapgolly.angularCore.anon.Call
import typingsJapgolly.angularCore.anon.ChangeDetection
import typingsJapgolly.angularCore.anon.ContentQueries
import typingsJapgolly.angularCore.anon.CtorParameters
import typingsJapgolly.angularCore.anon.Declarations
import typingsJapgolly.angularCore.anon.ElementInjector
import typingsJapgolly.angularCore.anon.Fn0
import typingsJapgolly.angularCore.anon.FnCall
import typingsJapgolly.angularCore.anon.FnCallPropNameValueSanitizer
import typingsJapgolly.angularCore.anon.FnCallValue
import typingsJapgolly.angularCore.anon.Imports
import typingsJapgolly.angularCore.anon.InjectOptionsoptionalfals
import typingsJapgolly.angularCore.anon.Pure
import typingsJapgolly.angularCore.anon.RElementownerDocumentDocu
import typingsJapgolly.angularCore.anon.Text
import typingsJapgolly.angularCore.anon.Token
...
/**
  ...
  * @publicApi
  */
type CtorDependency = typingsJapgolly.angularCore.anon.Attribute | Null
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.angularCore.mod.Type[T]
  - typingsJapgolly.angularCore.mod.AbstractType[T]
  - typingsJapgolly.angularCore.mod.InjectionToken[T]
*/
