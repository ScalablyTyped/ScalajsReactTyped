...
object ɵExtraLocaleDataIndex {
  ...
  inline def ExtraDayPeriodFormats: `0` = 0.asInstanceOf[`0`]
  
  inline def ExtraDayPeriodStandalone: `1` = 1.asInstanceOf[`1`]
  
  inline def ExtraDayPeriodsRules: `2` = 2.asInstanceOf[`2`]
}
