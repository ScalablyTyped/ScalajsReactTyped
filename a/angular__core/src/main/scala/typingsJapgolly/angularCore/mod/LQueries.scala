...
object LQueries {
  ...
  def apply(
    ...
    __obj.updateDynamic("createEmbeddedView")(js.Any.fromFunction1((t0: typingsJapgolly.angularCore.mod.TView) => createEmbeddedView(t0).runNow()))
    __obj.updateDynamic("detachView")(js.Any.fromFunction1((t0: typingsJapgolly.angularCore.mod.TView) => detachView(t0).runNow()))
    __obj.updateDynamic("insertView")(js.Any.fromFunction1((t0: typingsJapgolly.angularCore.mod.TView) => insertView(t0).runNow()))
