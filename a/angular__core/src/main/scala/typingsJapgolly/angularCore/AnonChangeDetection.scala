...
import typingsJapgolly.angularCore.mod.DirectiveTypesOrFactory
import typingsJapgolly.angularCore.mod.FactoryFn
import typingsJapgolly.angularCore.mod.HostBindingsFunction
import typingsJapgolly.angularCore.mod.PipeTypesOrFactory
...
trait AnonChangeDetection[T] extends js.Object {
  ...
  {[ P in keyof T ]:? string | [string, string]}
    */ typingsJapgolly.angularCore.angularCoreStrings.AnonChangeDetection with js.Any
  ] = js.native
  /**
