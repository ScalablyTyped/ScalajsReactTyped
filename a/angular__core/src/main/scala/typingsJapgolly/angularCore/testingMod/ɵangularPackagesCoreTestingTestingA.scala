...
class ɵangularPackagesCoreTestingTestingA ()
  extends typingsJapgolly.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA
...
object ɵangularPackagesCoreTestingTestingA extends js.Object {
  ...
  def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef): typingsJapgolly.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA = js.native
  def initTestEnvironment(ngModule: js.Array[Type[_]], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsJapgolly.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA = js.native
  /**
    ...
    */
  def initTestEnvironment(ngModule: Type[_], platform: PlatformRef): typingsJapgolly.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA = js.native
  def initTestEnvironment(ngModule: Type[_], platform: PlatformRef, aotSummaries: js.Function0[js.Array[_]]): typingsJapgolly.angularCore.testingTestingMod.ɵangularPackagesCoreTestingTestingA = js.native
