...
import typingsJapgolly.angularCore.mod.NgModuleRef
...
trait EnvironmentInjector extends StObject {
  ...
  var environmentInjector: js.UndefOr[typingsJapgolly.angularCore.mod.EnvironmentInjector | NgModuleRef[Any]] = js.undefined
...
object EnvironmentInjector {
  ...
  extension [Self <: EnvironmentInjector](x: Self) {
    ...
    inline def setEnvironmentInjector(value: typingsJapgolly.angularCore.mod.EnvironmentInjector | NgModuleRef[Any]): Self = StObject.set(x, "environmentInjector", value.asInstanceOf[js.Any])
