...
import typingsJapgolly.angularCore.mod.ChangeDetectionStrategy
import typingsJapgolly.angularCore.mod.ComponentDefFeature
import typingsJapgolly.angularCore.mod.ComponentTemplate
import typingsJapgolly.angularCore.mod.ContentQueriesFunction
import typingsJapgolly.angularCore.mod.CssSelector
import typingsJapgolly.angularCore.mod.DependencyTypeList
import typingsJapgolly.angularCore.mod.HostBindingsFunction
import typingsJapgolly.angularCore.mod.PipeType
import typingsJapgolly.angularCore.mod.SchemaMetadata
import typingsJapgolly.angularCore.mod.TAttributes
import typingsJapgolly.angularCore.mod.TConstants
import typingsJapgolly.angularCore.mod.TConstantsOrFactory
import typingsJapgolly.angularCore.mod.Type
import typingsJapgolly.angularCore.mod.TypeOrFactory
import typingsJapgolly.angularCore.mod.ViewEncapsulation
import typingsJapgolly.angularCore.mod.ViewQueriesFunction
import typingsJapgolly.angularCore.mod.ɵAttributeMarker
import typingsJapgolly.angularCore.mod.ɵComponentType
import typingsJapgolly.angularCore.mod.ɵCssSelectorList
import typingsJapgolly.angularCore.mod.ɵDirectiveType
...
object ChangeDetection {
  ...
  inline def apply[T](decls: Double, template: (/* rf */ ɵRenderFlags, T) => Callback, `type`: Type[T], vars: Double): ChangeDetection[T] = {
    val __obj = js.Dynamic.literal(decls = decls.asInstanceOf[js.Any], template = js.Any.fromFunction2((t0: /* rf */ ɵRenderFlags, t1: T) => (template(t0, t1)).runNow()), vars = vars.asInstanceOf[js.Any])
  ...
  extension [Self <: ChangeDetection[?], T](x: Self & ChangeDetection[T]) {
    ...
    inline def setConstsCallbackTo(value: CallbackTo[TConstants]): Self = StObject.set(x, "consts", value.toJsFn)
    ...
    inline def setDependenciesCallbackTo(value: CallbackTo[DependencyTypeList]): Self = StObject.set(x, "dependencies", value.toJsFn)
    ...
    inline def setTemplate(value: (/* rf */ ɵRenderFlags, T) => Callback): Self = StObject.set(x, "template", js.Any.fromFunction2((t0: /* rf */ ɵRenderFlags, t1: T) => (value(t0, t1)).runNow()))
