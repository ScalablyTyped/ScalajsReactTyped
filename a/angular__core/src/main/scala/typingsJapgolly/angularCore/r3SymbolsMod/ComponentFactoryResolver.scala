...
object ComponentFactoryResolver {
  ...
  def apply(resolveComponentFactory: Type[js.Any] => CallbackTo[ComponentFactory[js.Any]]): ComponentFactoryResolver = {
    ...
    __obj.updateDynamic("resolveComponentFactory")(js.Any.fromFunction1((t0: typingsJapgolly.angularCore.r3SymbolsMod.Type[js.Any]) => resolveComponentFactory(t0).runNow()))
