...
import typingsJapgolly.angularCore.anon.Deps
import typingsJapgolly.angularCore.anon.Instantiable
import typingsJapgolly.angularCore.anon.ProcessNewMacroTasksSynchronously
import typingsJapgolly.angularCore.anon.Providers
import typingsJapgolly.angularCore.anon.UseFactory
import typingsJapgolly.angularCore.anon.UseValue
...
import typingsJapgolly.angularCore.mod.ProviderToken
...
object testingMod {
  ...
  trait TestBed extends StObject {
    ...
    def configureTestingModule(moduleDef: TestModuleMetadata): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    ...
    def overrideComponent(component: Type[Any], `override`: MetadataOverride[Component]): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    
    def overrideDirective(directive: Type[Any], `override`: MetadataOverride[Directive]): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    
    def overrideModule(ngModule: Type[Any], `override`: MetadataOverride[NgModule]): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    
    def overridePipe(pipe: Type[Any], `override`: MetadataOverride[Pipe]): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    
    /**
      * Overwrites all providers for the given token with the given provider definition.
      */
    def overrideProvider(token: Any, provider: Deps): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    def overrideProvider(token: Any, provider: UseFactory): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    def overrideProvider(token: Any, provider: UseValue): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    
    def overrideTemplate(component: Type[Any], template: String): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    
    def overrideTemplateUsingTestingModule(component: Type[Any], template: String): typingsJapgolly.angularCore.testingMod.TestBed = js.native
    ...
    def resetTestingModule(): typingsJapgolly.angularCore.testingMod.TestBed = js.native
  }
  ...
  open class TestBedCls protected ()
    extends StObject
       with typingsJapgolly.angularCore.testingMod.TestBed {
  ...
  inline def getTestBed(): typingsJapgolly.angularCore.testingMod.TestBed = ^.asInstanceOf[js.Dynamic].applyDynamic("getTestBed")().asInstanceOf[typingsJapgolly.angularCore.testingMod.TestBed]
  ...
  trait TestBedStatic
    extends StObject
       with typingsJapgolly.angularCore.testingMod.TestBed
       with Instantiable1[/* args (repeated) */ Any, typingsJapgolly.angularCore.testingMod.TestBed]
