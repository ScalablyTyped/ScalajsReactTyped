...
import typingsJapgolly.angularCore.mod.IcuType
import typingsJapgolly.angularCore.mod.LViewFlags
import typingsJapgolly.angularCore.mod.PreOrderHookFlags
import typingsJapgolly.angularCore.mod.QueryFlags
import typingsJapgolly.angularCore.mod.RuntimeErrorCode
import typingsJapgolly.angularCore.mod.SelectorFlags
import typingsJapgolly.angularCore.mod.TNodeFlags
import typingsJapgolly.angularCore.mod.TNodeProviderIndexes
import typingsJapgolly.angularCore.mod.TNodeType
import typingsJapgolly.angularCore.mod.TViewType
import typingsJapgolly.angularCore.mod.ɵAttributeMarker
import typingsJapgolly.angularCore.mod.ɵCurrencyIndex
import typingsJapgolly.angularCore.mod.ɵExtraLocaleDataIndex
import typingsJapgolly.angularCore.mod.ɵProfilerEvent
import typingsJapgolly.angularCore.mod.ɵRenderFlags
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object angularCoreInts {
  ...
  sealed trait `902`
    extends StObject
       with RuntimeErrorCode
  inline def `902`: `902` = 902.asInstanceOf[`902`]
  
  @js.native
  sealed trait `903`
    extends StObject
       with RuntimeErrorCode
  inline def `903`: `903` = 903.asInstanceOf[`903`]
  
  @js.native
  sealed trait `904`
    extends StObject
       with RuntimeErrorCode
  inline def `904`: `904` = 904.asInstanceOf[`904`]
  
  @js.native
  sealed trait `905`
    extends StObject
       with RuntimeErrorCode
  inline def `905`: `905` = 905.asInstanceOf[`905`]
  
  @js.native
  sealed trait `906`
    extends StObject
       with RuntimeErrorCode
  inline def `906`: `906` = 906.asInstanceOf[`906`]
  
  @js.native
  sealed trait `907`
    extends StObject
       with RuntimeErrorCode
  inline def `907`: `907` = 907.asInstanceOf[`907`]
  
  @js.native
  sealed trait `908`
    extends StObject
       with RuntimeErrorCode
  inline def `908`: `908` = 908.asInstanceOf[`908`]
