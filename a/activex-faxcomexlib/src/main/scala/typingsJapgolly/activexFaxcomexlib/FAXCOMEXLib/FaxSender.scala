...
object FaxSender {
  ...
  inline def apply(
    ...
    FaxNumber: String,
    HomePhone: String,
    LoadDefaultSender: Callback,
    Name: String,
    OfficeLocation: String,
    OfficePhone: String,
    SaveDefaultSender: Callback,
    State: String,
    ...
    val __obj = js.Dynamic.literal(BillingCode = BillingCode.asInstanceOf[js.Any], City = City.asInstanceOf[js.Any], Company = Company.asInstanceOf[js.Any], Country = Country.asInstanceOf[js.Any], Department = Department.asInstanceOf[js.Any], Email = Email.asInstanceOf[js.Any], FaxNumber = FaxNumber.asInstanceOf[js.Any], HomePhone = HomePhone.asInstanceOf[js.Any], LoadDefaultSender = LoadDefaultSender.toJsFn, Name = Name.asInstanceOf[js.Any], OfficeLocation = OfficeLocation.asInstanceOf[js.Any], OfficePhone = OfficePhone.asInstanceOf[js.Any], SaveDefaultSender = SaveDefaultSender.toJsFn, State = State.asInstanceOf[js.Any], StreetAddress = StreetAddress.asInstanceOf[js.Any], TSID = TSID.asInstanceOf[js.Any], Title = Title.asInstanceOf[js.Any], ZipCode = ZipCode.asInstanceOf[js.Any])
  ...
  extension [Self <: FaxSender](x: Self) {
    ...
    inline def setLoadDefaultSender(value: Callback): Self = StObject.set(x, "LoadDefaultSender", value.toJsFn)
    ...
    inline def setSaveDefaultSender(value: Callback): Self = StObject.set(x, "SaveDefaultSender", value.toJsFn)
