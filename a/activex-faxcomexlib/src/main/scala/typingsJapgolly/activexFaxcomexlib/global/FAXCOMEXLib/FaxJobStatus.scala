...
/* private */ open class FaxJobStatus ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxJobStatus {
  ...
  var FAXCOMEXLibDotFaxJobStatus_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxJobStatus = js.native
