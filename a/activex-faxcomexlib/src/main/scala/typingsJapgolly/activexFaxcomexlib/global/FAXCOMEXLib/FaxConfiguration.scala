...
@js.native
/* private */ open class FaxConfiguration ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxConfiguration {
  ...
  var FAXCOMEXLibDotFaxConfiguration_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxConfiguration = js.native
