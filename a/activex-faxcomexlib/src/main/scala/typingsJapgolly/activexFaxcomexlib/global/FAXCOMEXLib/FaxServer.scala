...
/* private */ open class FaxServer ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxServer {
  ...
  /* CompleteClass */
  override val Configuration: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxConfiguration = js.native
  ...
  /* CompleteClass */
  override val CurrentAccount: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxAccount = js.native
  ...
  var FAXCOMEXLibDotFaxServer_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxServer = js.native
  
  /** The FaxAccountSet configuration object */
  /* CompleteClass */
  override val FaxAccountSet: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxAccountSet = js.native
  ...
  /** The security configuration object */
  /* CompleteClass */
  override val Security2: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxSecurity2 = js.native
