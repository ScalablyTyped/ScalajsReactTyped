...
/* private */ open class FaxActivity ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxActivity {
  
  /* private */ /* CompleteClass */
  @JSName("FAXCOMEXLib.FaxActivity_typekey")
  var FAXCOMEXLibDotFaxActivity_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxActivity = js.native
