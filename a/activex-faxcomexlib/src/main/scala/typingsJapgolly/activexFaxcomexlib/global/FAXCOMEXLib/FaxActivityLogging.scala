...
/* private */ open class FaxActivityLogging ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxActivityLogging {
  ...
  var FAXCOMEXLibDotFaxActivityLogging_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxActivityLogging = js.native
