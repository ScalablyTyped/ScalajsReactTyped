...
@js.native
/* private */ open class FaxOutgoingJob ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingJob {
  ...
  var FAXCOMEXLibDotFaxOutgoingJob_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingJob = js.native
