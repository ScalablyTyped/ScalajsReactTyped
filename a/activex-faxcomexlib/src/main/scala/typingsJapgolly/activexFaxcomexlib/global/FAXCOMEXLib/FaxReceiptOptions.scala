...
/* private */ open class FaxReceiptOptions ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxReceiptOptions {
  ...
  var FAXCOMEXLibDotFaxReceiptOptions_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxReceiptOptions = js.native
