...
/* private */ open class FaxSender ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxSender {
  ...
  var FAXCOMEXLibDotFaxSender_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxSender = js.native
  ...
  /** Load default sender */
  /* CompleteClass */
  override def LoadDefaultSender(): Unit = js.native
  ...
  /** Save default sender */
  /* CompleteClass */
  override def SaveDefaultSender(): Unit = js.native
