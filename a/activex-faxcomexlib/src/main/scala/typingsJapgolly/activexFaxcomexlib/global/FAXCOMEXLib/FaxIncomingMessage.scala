...
@js.native
/* private */ open class FaxIncomingMessage ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxIncomingMessage {
  ...
  var FAXCOMEXLibDotFaxIncomingMessage_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxIncomingMessage = js.native
