...
/* private */ open class FaxOutgoingMessage ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingMessage {
  ...
  var FAXCOMEXLibDotFaxOutgoingMessage_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingMessage = js.native
