...
@js.native
/* private */ open class IFaxOutgoingJob ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.IFaxOutgoingJob {
  ...
  var FAXCOMEXLibDotIFaxOutgoingJob_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.IFaxOutgoingJob = js.native
  ...
  /* CompleteClass */
  override val Recipient: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxRecipient = js.native
