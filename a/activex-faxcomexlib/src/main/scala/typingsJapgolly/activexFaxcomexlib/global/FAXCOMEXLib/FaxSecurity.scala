...
/* private */ open class FaxSecurity ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxSecurity {
  ...
  var FAXCOMEXLibDotFaxSecurity_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxSecurity = js.native
