...
@js.native
/* private */ open class FaxEventLogging ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxEventLogging {
  
  /* private */ /* CompleteClass */
  @JSName("FAXCOMEXLib.FaxEventLogging_typekey")
  var FAXCOMEXLibDotFaxEventLogging_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxEventLogging = js.native
