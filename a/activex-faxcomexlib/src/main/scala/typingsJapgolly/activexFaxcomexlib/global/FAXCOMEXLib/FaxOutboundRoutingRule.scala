...
/* private */ open class FaxOutboundRoutingRule ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutboundRoutingRule {
  ...
  var FAXCOMEXLibDotFaxOutboundRoutingRule_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutboundRoutingRule = js.native
