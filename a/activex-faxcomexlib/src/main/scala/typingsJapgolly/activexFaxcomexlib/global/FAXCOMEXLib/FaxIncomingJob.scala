...
/* private */ open class FaxIncomingJob ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxIncomingJob {
  ...
  var FAXCOMEXLibDotFaxIncomingJob_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxIncomingJob = js.native
