...
/* private */ open class FaxOutgoingMessageIterator ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingMessageIterator {
  ...
  var FAXCOMEXLibDotFaxOutgoingMessageIterator_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingMessageIterator = js.native
  
  /** Current message */
  /* CompleteClass */
  override val Message: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.IFaxOutgoingMessage = js.native
