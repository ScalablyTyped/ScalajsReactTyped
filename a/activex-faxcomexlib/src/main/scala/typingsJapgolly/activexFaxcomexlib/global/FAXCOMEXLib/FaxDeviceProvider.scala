...
/* private */ open class FaxDeviceProvider ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxDeviceProvider {
  ...
  var FAXCOMEXLibDotFaxDeviceProvider_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxDeviceProvider = js.native
