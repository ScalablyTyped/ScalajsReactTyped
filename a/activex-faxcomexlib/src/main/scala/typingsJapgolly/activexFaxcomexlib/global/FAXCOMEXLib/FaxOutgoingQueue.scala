...
/* private */ open class FaxOutgoingQueue ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingQueue {
  ...
  var FAXCOMEXLibDotFaxOutgoingQueue_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxOutgoingQueue = js.native
