...
/* private */ open class FaxDevice ()
  extends StObject
     with typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxDevice {
  ...
  var FAXCOMEXLibDotFaxDevice_typekey: typingsJapgolly.activexFaxcomexlib.FAXCOMEXLib.FaxDevice = js.native
