...
import typingsJapgolly.anydbSqlMigrations.anon.Check
...
object mod {
  ...
  type MigFn = js.Function1[/* tx */ Transaction, typingsJapgolly.bluebird.mod.^[Any]]
  ...
  trait MigrationTask extends StObject {
    ...
    def down(tx: Transaction): typingsJapgolly.bluebird.mod.^[Any]
    @JSName("down")
    var down_Original: MigFn
    
    var name: String
    
    def up(tx: Transaction): typingsJapgolly.bluebird.mod.^[Any]
    @JSName("up")
  ...
  object MigrationTask {
    ...
    inline def apply(
      down: /* tx */ Transaction => typingsJapgolly.bluebird.mod.^[Any],
      name: String,
      up: /* tx */ Transaction => typingsJapgolly.bluebird.mod.^[Any]
    ): MigrationTask = {
    ...
    extension [Self <: MigrationTask](x: Self) {
      ...
      inline def setDown(value: /* tx */ Transaction => typingsJapgolly.bluebird.mod.^[Any]): Self = StObject.set(x, "down", js.Any.fromFunction1(value))
      
      inline def setName(value: String): Self = StObject.set(x, "name", value.asInstanceOf[js.Any])
      
      inline def setUp(value: /* tx */ Transaction => typingsJapgolly.bluebird.mod.^[Any]): Self = StObject.set(x, "up", js.Any.fromFunction1(value))
    }
  }
