package typingsJapgolly.awsSdkClientDynamodbNode.typesGlobalTableDescriptionMod
...
import typingsJapgolly.awsSdkClientDynamodbNode.typesReplicaDescriptionMod.UnmarshalledReplicaDescription
