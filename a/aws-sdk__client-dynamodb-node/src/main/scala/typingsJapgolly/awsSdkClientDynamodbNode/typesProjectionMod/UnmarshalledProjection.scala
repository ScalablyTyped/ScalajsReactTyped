package typingsJapgolly.awsSdkClientDynamodbNode.typesProjectionMod

import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ALL
import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.INCLUDE
