...
import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ALL_ATTRIBUTES
import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.ALL_PROJECTED_ATTRIBUTES
import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.AND
import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.COUNT
...
import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.SPECIFIC_ATTRIBUTES
...
import typingsJapgolly.awsSdkClientDynamodbNode.typesConditionMod.Condition
