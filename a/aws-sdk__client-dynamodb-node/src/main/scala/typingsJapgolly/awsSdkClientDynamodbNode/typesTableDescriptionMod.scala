...
import typingsJapgolly.awsSdkClientDynamodbNode.typesAttributeDefinitionMod.UnmarshalledAttributeDefinition
import typingsJapgolly.awsSdkClientDynamodbNode.typesGlobalSecondaryIndexDescriptionMod.GlobalSecondaryIndexDescription
import typingsJapgolly.awsSdkClientDynamodbNode.typesGlobalSecondaryIndexDescriptionMod.UnmarshalledGlobalSecondaryIndexDescription
...
import typingsJapgolly.awsSdkClientDynamodbNode.typesLocalSecondaryIndexDescriptionMod.LocalSecondaryIndexDescription
import typingsJapgolly.awsSdkClientDynamodbNode.typesLocalSecondaryIndexDescriptionMod.UnmarshalledLocalSecondaryIndexDescription
...
import typingsJapgolly.awsSdkClientDynamodbNode.typesRestoreSummaryMod.RestoreSummary
import typingsJapgolly.awsSdkClientDynamodbNode.typesRestoreSummaryMod.UnmarshalledRestoreSummary
...
object typesTableDescriptionMod {
  ...
  trait TableDescription extends StObject {
    ...
    /**
      ...
      */
    var RestoreSummary: js.UndefOr[typingsJapgolly.awsSdkClientDynamodbNode.typesRestoreSummaryMod.RestoreSummary] = js.undefined
    ...
    var StreamSpecification: js.UndefOr[
        typingsJapgolly.awsSdkClientDynamodbNode.typesStreamSpecificationMod.StreamSpecification
      ] = js.undefined
  ...
  object TableDescription {
    ...
    extension [Self <: TableDescription](x: Self) {
      ...
      inline def setGlobalSecondaryIndexes(value: js.Array[GlobalSecondaryIndexDescription] | js.Iterable[GlobalSecondaryIndexDescription]): Self = StObject.set(x, "GlobalSecondaryIndexes", value.asInstanceOf[js.Any])
      ...
      inline def setLocalSecondaryIndexes(value: js.Array[LocalSecondaryIndexDescription] | js.Iterable[LocalSecondaryIndexDescription]): Self = StObject.set(x, "LocalSecondaryIndexes", value.asInstanceOf[js.Any])
  ...
  object UnmarshalledTableDescription {
    ...
    extension [Self <: UnmarshalledTableDescription](x: Self) {
      ...
      inline def setAttributeDefinitionsVarargs(value: UnmarshalledAttributeDefinition*): Self = StObject.set(x, "AttributeDefinitions", js.Array(value*))
      ...
      inline def setGlobalSecondaryIndexesVarargs(value: UnmarshalledGlobalSecondaryIndexDescription*): Self = StObject.set(x, "GlobalSecondaryIndexes", js.Array(value*))
      ...
      inline def setLocalSecondaryIndexesVarargs(value: UnmarshalledLocalSecondaryIndexDescription*): Self = StObject.set(x, "LocalSecondaryIndexes", js.Array(value*))
