...
import typingsJapgolly.awsSdkClientDynamodbNode.typesPointInTimeRecoveryDescriptionMod.PointInTimeRecoveryDescription
import typingsJapgolly.awsSdkClientDynamodbNode.typesPointInTimeRecoveryDescriptionMod.UnmarshalledPointInTimeRecoveryDescription
...
object typesContinuousBackupsDescriptionMod {
  ...
  trait ContinuousBackupsDescription extends StObject {
    ...
    var PointInTimeRecoveryDescription: js.UndefOr[
        typingsJapgolly.awsSdkClientDynamodbNode.typesPointInTimeRecoveryDescriptionMod.PointInTimeRecoveryDescription
      ] = js.undefined
  }
