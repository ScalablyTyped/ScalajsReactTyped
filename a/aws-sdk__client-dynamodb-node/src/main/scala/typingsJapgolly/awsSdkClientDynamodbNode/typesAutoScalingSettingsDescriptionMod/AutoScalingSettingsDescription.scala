package typingsJapgolly.awsSdkClientDynamodbNode.typesAutoScalingSettingsDescriptionMod

import typingsJapgolly.awsSdkClientDynamodbNode.typesAutoScalingPolicyDescriptionMod.AutoScalingPolicyDescription
...
object AutoScalingSettingsDescription {
  ...
  def apply(
    ...
    ScalingPolicies: js.Array[AutoScalingPolicyDescription] | js.Iterable[AutoScalingPolicyDescription] = null
