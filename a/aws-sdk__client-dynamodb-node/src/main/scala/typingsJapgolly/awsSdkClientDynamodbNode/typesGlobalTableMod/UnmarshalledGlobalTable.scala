package typingsJapgolly.awsSdkClientDynamodbNode.typesGlobalTableMod

import typingsJapgolly.awsSdkClientDynamodbNode.typesReplicaMod.UnmarshalledReplica
