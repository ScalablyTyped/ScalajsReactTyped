package typingsJapgolly.awsSdkClientDynamodbNode.typesKeySchemaElementMod

import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.HASH
import typingsJapgolly.awsSdkClientDynamodbNode.awsSdkClientDynamodbNodeStrings.RANGE
