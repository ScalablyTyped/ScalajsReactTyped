package typingsJapgolly.awsSdkClientDynamodbNode.typesAutoScalingSettingsUpdateMod

import typingsJapgolly.awsSdkClientDynamodbNode.typesAutoScalingPolicyUpdateMod.UnmarshalledAutoScalingPolicyUpdate
