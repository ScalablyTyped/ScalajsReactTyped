...
object mod {
  ...
  open class ^[T] protected () extends AGChannel[T] {
    def this(
      ...
      dataDemux: typingsJapgolly.streamDemux.mod.^[T]
    ) = this()
  }
  ...
  */
  ...
  object ChannelState {
    ...
    inline def pending: typingsJapgolly.agChannel.agChannelStrings.pending = "pending".asInstanceOf[typingsJapgolly.agChannel.agChannelStrings.pending]
    
    inline def subscribed: typingsJapgolly.agChannel.agChannelStrings.subscribed = "subscribed".asInstanceOf[typingsJapgolly.agChannel.agChannelStrings.subscribed]
    
    inline def unsubscribed: typingsJapgolly.agChannel.agChannelStrings.unsubscribed = "unsubscribed".asInstanceOf[typingsJapgolly.agChannel.agChannelStrings.unsubscribed]
  }
