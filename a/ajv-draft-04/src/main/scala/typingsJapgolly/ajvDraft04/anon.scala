...
object anon {
  ...
  trait Comparison extends StObject {
    ...
    var comparison: typingsJapgolly.ajvDraft04.distVocabularyValidationLimitNumberMod.Comparison
  ...
  object Comparison {
    ...
    inline def apply(
      comparison: typingsJapgolly.ajvDraft04.distVocabularyValidationLimitNumberMod.Comparison,
      limit: Double
    ): Comparison = {
    ...
    extension [Self <: Comparison](x: Self) {
      ...
      inline def setComparison(value: typingsJapgolly.ajvDraft04.distVocabularyValidationLimitNumberMod.Comparison): Self = StObject.set(x, "comparison", value.asInstanceOf[js.Any])
