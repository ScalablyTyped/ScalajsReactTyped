...
import typingsJapgolly.asar.anon.Algorithm
import typingsJapgolly.asar.anon.Stat
import typingsJapgolly.asar.asarBooleans.`true`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.asar.asarStrings.directory
    - typingsJapgolly.asar.asarStrings.file
    - typingsJapgolly.asar.asarStrings.link
  */
  trait InputMetadataType extends StObject
  object InputMetadataType {
    
    inline def directory: typingsJapgolly.asar.asarStrings.directory = "directory".asInstanceOf[typingsJapgolly.asar.asarStrings.directory]
    
    inline def file: typingsJapgolly.asar.asarStrings.file = "file".asInstanceOf[typingsJapgolly.asar.asarStrings.file]
    
    inline def link: typingsJapgolly.asar.asarStrings.link = "link".asInstanceOf[typingsJapgolly.asar.asarStrings.link]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.asar.mod.DirectoryMetadata
    - typingsJapgolly.asar.mod.FileMetadata
    - typingsJapgolly.asar.mod.LinkMetadata
  */
  trait Metadata extends StObject
  object Metadata {
    
    inline def DirectoryMetadata(files: StringDictionary[EntryMetadata], unpacked: Boolean): typingsJapgolly.asar.mod.DirectoryMetadata = {
      val __obj = js.Dynamic.literal(files = files.asInstanceOf[js.Any], unpacked = unpacked.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.asar.mod.DirectoryMetadata]
    }
    
    inline def FileMetadata(unpacked: Boolean): typingsJapgolly.asar.mod.FileMetadata = {
      val __obj = js.Dynamic.literal(unpacked = unpacked.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.asar.mod.FileMetadata]
    }
    
    inline def LinkMetadata(link: String): typingsJapgolly.asar.mod.LinkMetadata = {
      val __obj = js.Dynamic.literal(link = link.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.asar.mod.LinkMetadata]
    }
  }
}
