package typingsJapgolly.angularGrowlV2
...
import typingsJapgolly.angular.mod.IHttpInterceptorFactory
...
object angularMod {
  ...
  object growl {
    ...
    object IGrowlMessage {
      ...
      inline def apply(destroy: Callback, setText: String => Callback, text: String): IGrowlMessage = {
        val __obj = js.Dynamic.literal(destroy = destroy.toJsFn, setText = js.Any.fromFunction1((t0: String) => setText(t0).runNow()), text = text.asInstanceOf[js.Any])
