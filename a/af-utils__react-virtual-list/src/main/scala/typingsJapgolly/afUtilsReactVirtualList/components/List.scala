package typingsJapgolly.afUtilsReactVirtualList.components
...
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.`additions removals`
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.`additions text`
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.`inline`
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.`removals additions`
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.`removals text`
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.`text additions`
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.`text removals`
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.additions
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.all
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.ascending
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.assertive
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.both
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.copy
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.date
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.decimal
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.descending
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.dialog
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.email
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.execute
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.grammar
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.grid
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.horizontal
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.inherit
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.link
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.list
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.listbox
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.location
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.menu
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.mixed
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.move
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.no
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.none
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.numeric
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.off
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.on
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.other
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.page
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.polite
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.popup
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.removals
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.search
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.spelling
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.step
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.tel
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.text
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.time
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.tree
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.url
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.vertical
import typingsJapgolly.afUtilsReactVirtualList.afUtilsReactVirtualListStrings.yes
import typingsJapgolly.afUtilsReactVirtualList.mod.ChildProps
import typingsJapgolly.afUtilsReactVirtualList.mod.ListProps
...
object List {
  ...
  inline def apply(children: ComponentType[ChildProps], itemData: Any, model: Model): Builder = {
    val __props = js.Dynamic.literal(children = children.asInstanceOf[js.Any], itemData = itemData.asInstanceOf[js.Any], model = model.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[ListProps]))
  }
  
  @JSImport("@af-utils/react-virtual-list", "List")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def component(value: String | ComponentType[Any]): this.type = set("component", value.asInstanceOf[js.Any])
    
    inline def contentEditable(value: Booleanish | inherit): this.type = set("contentEditable", value.asInstanceOf[js.Any])
    
    inline def contextMenu(value: String): this.type = set("contextMenu", value.asInstanceOf[js.Any])
    
    inline def countOffset(value: Boolean): this.type = set("countOffset", value.asInstanceOf[js.Any])
    ...
    inline def getKey(value: (/* i */ Double, /* itemData */ js.UndefOr[Any]) => Any): this.type = set("getKey", js.Any.fromFunction2(value))
