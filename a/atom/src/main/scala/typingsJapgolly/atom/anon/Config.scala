...
trait Config extends StObject {
  ...
  var config: js.UndefOr[typingsJapgolly.atom.srcConfigMod.Config] = js.undefined
...
object Config {
  ...
  extension [Self <: Config](x: Self) {
    ...
    inline def setConfig(value: typingsJapgolly.atom.srcConfigMod.Config): Self = StObject.set(x, "config", value.asInstanceOf[js.Any])
