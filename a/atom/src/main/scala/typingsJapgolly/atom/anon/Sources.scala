...
trait Sources extends StObject {
  ...
  var scope: js.UndefOr[typingsJapgolly.atom.srcScopeDescriptorMod.ScopeDescriptor] = js.undefined
...
object Sources {
  ...
  extension [Self <: Sources](x: Self) {
    ...
    inline def setScope(value: typingsJapgolly.atom.srcScopeDescriptorMod.ScopeDescriptor): Self = StObject.set(x, "scope", value.asInstanceOf[js.Any])
