...
object TestRunnerParams {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(buildAtomEnvironment = js.Any.fromFunction1(buildAtomEnvironment), buildDefaultApplicationDelegate = buildDefaultApplicationDelegate.toJsFn, headless = headless.asInstanceOf[js.Any], logFile = logFile.asInstanceOf[js.Any], testPaths = testPaths.asInstanceOf[js.Any])
  ...
  extension [Self <: TestRunnerParams](x: Self) {
    ...
    inline def setBuildDefaultApplicationDelegate(value: CallbackTo[js.Object]): Self = StObject.set(x, "buildDefaultApplicationDelegate", value.toJsFn)
