...
import typingsJapgolly.atom.atomStrings.devicon
import typingsJapgolly.atom.atomStrings.fa
import typingsJapgolly.atom.atomStrings.fab
import typingsJapgolly.atom.atomStrings.fi
import typingsJapgolly.atom.atomStrings.icomoon
import typingsJapgolly.atom.atomStrings.ion
import typingsJapgolly.atom.atomStrings.mdi
...
object toolBarMod {
  ...
  object ButtonOptions {
    ...
    extension [Self <: ButtonOptions](x: Self) {
      ...
      inline def setCallbackFunction1(value: /* data */ js.UndefOr[Any] => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* data */ js.UndefOr[Any]) => value(t0).runNow()))
  ...
  object ToolBarButtonView {
    ...
    inline def apply(
      _onClick: MouseEvent => Callback,
      _onMouseDown: MouseEvent => Callback,
      destroy: Callback,
      element: HTMLButtonElement,
      enabled: Boolean,
      executeCallback: MouseEvent => Callback,
      ...
      val __obj = js.Dynamic.literal(_onClick = js.Any.fromFunction1((t0: MouseEvent) => _onClick(t0).runNow()), _onMouseDown = js.Any.fromFunction1((t0: MouseEvent) => _onMouseDown(t0).runNow()), destroy = destroy.toJsFn, element = element.asInstanceOf[js.Any], enabled = enabled.asInstanceOf[js.Any], executeCallback = js.Any.fromFunction1((t0: MouseEvent) => executeCallback(t0).runNow()), getSelected = getSelected.toJsFn, group = group.asInstanceOf[js.Any], options = options.asInstanceOf[js.Any], priority = priority.asInstanceOf[js.Any], setEnabled = js.Any.fromFunction1((t0: Boolean) => setEnabled(t0).runNow()), setSelected = js.Any.fromFunction1((t0: Boolean) => setSelected(t0).runNow()), subscriptions = subscriptions.asInstanceOf[js.Any])
    ...
    extension [Self <: ToolBarButtonView](x: Self) {
      ...
      inline def setExecuteCallback(value: MouseEvent => Callback): Self = StObject.set(x, "executeCallback", js.Any.fromFunction1((t0: MouseEvent) => value(t0).runNow()))
      ...
      inline def setSetSelected(value: Boolean => Callback): Self = StObject.set(x, "setSelected", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
      
      inline def setSubscriptions(value: Disposable): Self = StObject.set(x, "subscriptions", value.asInstanceOf[js.Any])
      
      inline def set_onClick(value: MouseEvent => Callback): Self = StObject.set(x, "_onClick", js.Any.fromFunction1((t0: MouseEvent) => value(t0).runNow()))
      
      inline def set_onMouseDown(value: MouseEvent => Callback): Self = StObject.set(x, "_onMouseDown", js.Any.fromFunction1((t0: MouseEvent) => value(t0).runNow()))
    }
  }
  ...
  object ToolBarSpacerView {
    ...
    inline def apply(destroy: Callback, element: HTMLHRElement, group: String, priority: Double): ToolBarSpacerView = {
      val __obj = js.Dynamic.literal(destroy = destroy.toJsFn, element = element.asInstanceOf[js.Any], group = group.asInstanceOf[js.Any], priority = priority.asInstanceOf[js.Any])
