...
object srcContextMenuManagerMod {
  ...
  object ContextMenuItemOptions {
    ...
    extension [Self <: ContextMenuItemOptions](x: Self) {
      ...
      inline def setCreated(value: /* event */ Event => Callback): Self = StObject.set(x, "created", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
      ...
      inline def setShouldDisplay(value: /* event */ Event => Callback): Self = StObject.set(x, "shouldDisplay", js.Any.fromFunction1((t0: /* event */ Event) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.atom.srcContextMenuManagerMod.ContextMenuItemOptions
    - typingsJapgolly.atom.anon.Type
  */
  trait ContextMenuOptions extends StObject
  object ContextMenuOptions {
    
    inline def ContextMenuItemOptions(): typingsJapgolly.atom.srcContextMenuManagerMod.ContextMenuItemOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.atom.srcContextMenuManagerMod.ContextMenuItemOptions]
    }
    
    inline def Type(): typingsJapgolly.atom.anon.Type = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")("separator")
      __obj.asInstanceOf[typingsJapgolly.atom.anon.Type]
    }
  }
}
