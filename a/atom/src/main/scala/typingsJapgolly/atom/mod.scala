...
import typingsJapgolly.atom.anon.Config
import typingsJapgolly.atom.anon.RefreshOnWindowFocus
...
import typingsJapgolly.atom.srcAtomEnvironmentMod.AtomEnvironment
import typingsJapgolly.atom.srcBufferedProcessMod.NodeProcessOptions
import typingsJapgolly.atom.srcBufferedProcessMod.ProcessOptions
import typingsJapgolly.atom.srcNotificationMod.ErrorNotificationOptions
import typingsJapgolly.atom.srcNotificationMod.NotificationOptions
...
object mod {
  ...
  open class BufferedNodeProcess protected ()
    extends typingsJapgolly.atom.srcBufferedNodeProcessMod.BufferedNodeProcess {
  ...
  open class BufferedProcess protected ()
    extends typingsJapgolly.atom.srcBufferedProcessMod.BufferedProcess {
  ...
  open class CompositeDisposable protected ()
    extends typingsJapgolly.atom.dependenciesEventKitMod.CompositeDisposable {
  ...
  open class Directory protected ()
    extends typingsJapgolly.atom.dependenciesPathwatcherMod.Directory {
    // Construction
  ...
  open class Disposable ()
    extends typingsJapgolly.atom.dependenciesEventKitMod.Disposable {
  ...
  open class Emitter[OptionalEmissions, RequiredEmissions] ()
    extends typingsJapgolly.atom.dependenciesEventKitMod.Emitter[OptionalEmissions, RequiredEmissions]
  
  @JSImport("atom", "File")
  @js.native
  open class File protected ()
    extends typingsJapgolly.atom.dependenciesPathwatcherMod.File {
    // Construction
  ...
  open class GitRepository protected ()
    extends typingsJapgolly.atom.srcGitRepositoryMod.GitRepository {
  ...
  object GitRepository {
    ...
    inline def open(path: String): typingsJapgolly.atom.srcGitRepositoryMod.GitRepository = ^.asInstanceOf[js.Dynamic].applyDynamic("open")(path.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.atom.srcGitRepositoryMod.GitRepository]
    inline def open(path: String, options: RefreshOnWindowFocus): typingsJapgolly.atom.srcGitRepositoryMod.GitRepository = (^.asInstanceOf[js.Dynamic].applyDynamic("open")(path.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.atom.srcGitRepositoryMod.GitRepository]
  }
  
  @JSImport("atom", "Notification")
  @js.native
  open class Notification protected ()
    extends typingsJapgolly.atom.srcNotificationMod.Notification {
  ...
  open class Point ()
    extends typingsJapgolly.atom.dependenciesTextBufferMod.Point {
  ...
  open class Range ()
    extends typingsJapgolly.atom.dependenciesTextBufferMod.Range {
  ...
  open class Task protected ()
    extends typingsJapgolly.atom.srcTaskMod.Task {
  ...
  object Task {
    ...
    inline def once(taskPath: String, args: Any*): typingsJapgolly.atom.srcTaskMod.Task = ^.asInstanceOf[js.Dynamic].applyDynamic("once")(scala.List(taskPath.asInstanceOf[js.Any]).`++`(args.asInstanceOf[Seq[js.Any]])*).asInstanceOf[typingsJapgolly.atom.srcTaskMod.Task]
  }
  ...
  open class TextBuffer ()
    extends typingsJapgolly.atom.dependenciesTextBufferMod.TextBuffer {
  ...
  open class TextEditor ()
    extends typingsJapgolly.atom.srcTextEditorMod.TextEditor {
  ...
  /* key */ StringDictionary[Any] {
    ...
    var coreDotfileSystemWatcher: native | experimental | poll | typingsJapgolly.atom.atomStrings.atom
  ...
  object ConfigValues {
    ...
    inline def apply(
      ...
      coreDotfileSystemWatcher: native | experimental | poll | typingsJapgolly.atom.atomStrings.atom,
    ...
    extension [Self <: ConfigValues](x: Self) {
      ...
      inline def setCoreDotfileSystemWatcher(value: native | experimental | poll | typingsJapgolly.atom.atomStrings.atom): Self = StObject.set(x, "core.fileSystemWatcher", value.asInstanceOf[js.Any])
  ...
  object atomAugmentingMod {
    ...
    object ConfigValues {
      ...
      inline def apply(
        ...
        editorDotundoGroupingInterval: Double,
        editorDotzoomFontWhenCtrlScrolling: Boolean
      ): typingsJapgolly.atom.mod.atomAugmentingMod.ConfigValues = {
        val __obj = js.Dynamic.literal()
        __obj.updateDynamic("core.allowPendingPaneItems")(coreDotallowPendingPaneItems.asInstanceOf[js.Any])
        __obj.updateDynamic("core.audioBeep")(coreDotaudioBeep.asInstanceOf[js.Any])
        __obj.updateDynamic("core.automaticallyUpdate")(coreDotautomaticallyUpdate.asInstanceOf[js.Any])
        ...
        __obj.updateDynamic("editor.foldEndPattern")(null)
        __obj.updateDynamic("editor.increaseIndentPattern")(null)
        __obj.asInstanceOf[typingsJapgolly.atom.mod.atomAugmentingMod.ConfigValues]
      }
      
      extension [Self <: typingsJapgolly.atom.mod.atomAugmentingMod.ConfigValues](x: Self) {
