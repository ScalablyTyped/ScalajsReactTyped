...
import typingsJapgolly.atom.anon.AllowPrevious
import typingsJapgolly.atom.anon.Autoscroll
import typingsJapgolly.atom.anon.Cancel
import typingsJapgolly.atom.anon.Center
import typingsJapgolly.atom.anon.ClipDirectionInvalidate
import typingsJapgolly.atom.anon.InvalidateMaintainHistory
import typingsJapgolly.atom.anon.Path
import typingsJapgolly.atom.anon.Persistent
import typingsJapgolly.atom.anon.PreserveFoldsReversed
import typingsJapgolly.atom.anon.PreserveLeadingWhitespace
import typingsJapgolly.atom.anon.Scopes
import typingsJapgolly.atom.anon.Text
import typingsJapgolly.atom.anon.`28`
import typingsJapgolly.atom.anon.`29`
import typingsJapgolly.atom.anon.`30`
import typingsJapgolly.atom.atomBooleans.`false`
import typingsJapgolly.atom.dependenciesFirstMateSrcGrammarMod.Grammar
import typingsJapgolly.atom.dependenciesTextBufferSrcDisplayMarkerLayerMod.DisplayMarkerLayer
import typingsJapgolly.atom.dependenciesTextBufferSrcDisplayMarkerLayerMod.FindDisplayMarkerOptions
import typingsJapgolly.atom.dependenciesTextBufferSrcDisplayMarkerMod.DisplayMarker
import typingsJapgolly.atom.dependenciesTextBufferSrcMarkerLayerMod.MarkerLayer
...
import typingsJapgolly.atom.dependenciesTextBufferSrcRangeMod.RangeLike
import typingsJapgolly.atom.dependenciesTextBufferSrcTextBufferMod.BufferScanResult
import typingsJapgolly.atom.dependenciesTextBufferSrcTextBufferMod.BufferStoppedChangingEvent
import typingsJapgolly.atom.dependenciesTextBufferSrcTextBufferMod.ContextualBufferScanResult
import typingsJapgolly.atom.dependenciesTextBufferSrcTextBufferMod.ScanContextOptions
...
import typingsJapgolly.atom.srcCursorMod.Cursor
import typingsJapgolly.atom.srcCursorMod.CursorPositionChangedEvent
import typingsJapgolly.atom.srcDecorationMod.Decoration
import typingsJapgolly.atom.srcDecorationMod.DecorationLayerOptions
import typingsJapgolly.atom.srcDecorationMod.DecorationOptions
import typingsJapgolly.atom.srcGutterMod.Gutter
import typingsJapgolly.atom.srcGutterMod.GutterOptions
import typingsJapgolly.atom.srcLayerDecorationMod.LayerDecoration
import typingsJapgolly.atom.srcOtherTypesMod.EditorChangedEvent
import typingsJapgolly.atom.srcOtherTypesMod.ReadonlyEditOptions
import typingsJapgolly.atom.srcOtherTypesMod.TextEditOptions
import typingsJapgolly.atom.srcOtherTypesMod.TextInsertionOptions
import typingsJapgolly.atom.srcScopeDescriptorMod.ScopeDescriptor
import typingsJapgolly.atom.srcSelectionMod.Selection
import typingsJapgolly.atom.srcSelectionMod.SelectionChangedEvent
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object srcTextEditorMod {
  
  @JSImport("atom/src/text-editor", "TextEditor")
  @js.native
  // NOTE: undocumented within the public API. Don't go down the rabbit hole.
  open class TextEditor () extends StObject {
    ...
    def addSelectionForBufferRange(bufferRange: RangeCompatible, options: PreserveFoldsReversed): Selection = js.native
    ...
    def addSelectionForScreenRange(screenRange: RangeCompatible, options: PreserveFoldsReversed): Selection = js.native
    ...
    def markBufferRange(range: RangeCompatible, properties: InvalidateMaintainHistory): DisplayMarker = js.native
    ...
    def markScreenRange(range: RangeCompatible, properties: InvalidateMaintainHistory): DisplayMarker = js.native
    ...
    def setSelectedBufferRange(bufferRange: RangeCompatible, options: PreserveFoldsReversed): Unit = js.native
    ...
    def setSelectedBufferRanges(bufferRanges: js.Array[RangeCompatible], options: PreserveFoldsReversed): Unit = js.native
