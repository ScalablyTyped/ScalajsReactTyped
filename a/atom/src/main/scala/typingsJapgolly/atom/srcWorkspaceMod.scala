...
import typingsJapgolly.atom.anon.AutoFocus
import typingsJapgolly.atom.anon.FilePath
import typingsJapgolly.atom.anon.LeadingContextLines
import typingsJapgolly.atom.anon.Visible
import typingsJapgolly.atom.atomStrings.bottom_
import typingsJapgolly.atom.atomStrings.center
import typingsJapgolly.atom.atomStrings.down
import typingsJapgolly.atom.atomStrings.left_
import typingsJapgolly.atom.atomStrings.right_
import typingsJapgolly.atom.atomStrings.up
import typingsJapgolly.atom.mod.Disposable
import typingsJapgolly.atom.mod.TextEditor
import typingsJapgolly.atom.srcDockMod.Dock
import typingsJapgolly.atom.srcOtherTypesMod.CancellablePromise
...
import typingsJapgolly.atom.srcPaneMod.PaneItemOpenedEvent
import typingsJapgolly.atom.srcPanelMod.Panel
import typingsJapgolly.atom.srcViewRegistryMod.ViewModel
import typingsJapgolly.atom.srcWorkspaceCenterMod.WorkspaceCenter
...
object srcWorkspaceMod {
  ...
  trait Workspace extends StObject {
    ...
    def onDidAddPane(callback: js.Function1[/* event */ typingsJapgolly.atom.anon.Pane, Unit]): Disposable = js.native
    ...
    def onDidDestroyPane(callback: js.Function1[/* event */ typingsJapgolly.atom.anon.Pane, Unit]): Disposable = js.native
    ...
    def onWillDestroyPane(callback: js.Function1[/* event */ typingsJapgolly.atom.anon.Pane, Unit]): Disposable = js.native
  ...
  object WorkspaceScanOptions {
    ...
    extension [Self <: WorkspaceScanOptions](x: Self) {
      ...
      inline def setOnPathsSearched(value: /* pathsSearched */ Double => Callback): Self = StObject.set(x, "onPathsSearched", js.Any.fromFunction1((t0: /* pathsSearched */ Double) => value(t0).runNow()))
