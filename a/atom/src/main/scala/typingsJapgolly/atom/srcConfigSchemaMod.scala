...
object srcConfigSchemaMod {
  ...
  object atomAugmentingMod {
    ...
    object ConfigValues {
      ...
      inline def apply(
      ...
      ): typingsJapgolly.atom.srcConfigSchemaMod.atomAugmentingMod.ConfigValues = {
        ...
        __obj.asInstanceOf[typingsJapgolly.atom.srcConfigSchemaMod.atomAugmentingMod.ConfigValues]
      }
      
      extension [Self <: typingsJapgolly.atom.srcConfigSchemaMod.atomAugmentingMod.ConfigValues](x: Self) {
