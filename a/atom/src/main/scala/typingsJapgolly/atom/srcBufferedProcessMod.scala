...
object srcBufferedProcessMod {
  ...
  object NodeProcessOptions {
    ...
    extension [Self <: NodeProcessOptions](x: Self) {
      ...
      inline def setExit(value: /* code */ Double => Callback): Self = StObject.set(x, "exit", js.Any.fromFunction1((t0: /* code */ Double) => value(t0).runNow()))
      ...
      inline def setStderr(value: /* data */ String => Callback): Self = StObject.set(x, "stderr", js.Any.fromFunction1((t0: /* data */ String) => value(t0).runNow()))
      
      inline def setStderrUndefined: Self = StObject.set(x, "stderr", js.undefined)
      
      inline def setStdout(value: /* data */ String => Callback): Self = StObject.set(x, "stdout", js.Any.fromFunction1((t0: /* data */ String) => value(t0).runNow()))
