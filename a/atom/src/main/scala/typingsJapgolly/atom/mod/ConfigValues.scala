...
/* key */ StringDictionary[js.Any] {
  ...
  var `autocomplete-plusDotsuggestionListFollows`: Word | typingsJapgolly.atom.atomStrings.Cursor
...
object ConfigValues {
  ...
  def apply(
    ...
    `autocomplete-plusDotsuggestionListFollows`: Word | typingsJapgolly.atom.atomStrings.Cursor,
