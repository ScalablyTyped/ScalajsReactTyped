...
object GutterOptions {
  ...
  def apply(
    name: String,
    `class`: String = null,
    labelFn: /* lineData */ LineDataExtended => CallbackTo[String] = null,
    onMouseDown: /* lineData */ LineData => Callback = null,
    onMouseMove: /* lineData */ LineData => Callback = null,
    ...
    if (labelFn != null) __obj.updateDynamic("labelFn")(js.Any.fromFunction1((t0: /* lineData */ typingsJapgolly.atom.mod.LineDataExtended) => labelFn(t0).runNow()))
    if (onMouseDown != null) __obj.updateDynamic("onMouseDown")(js.Any.fromFunction1((t0: /* lineData */ typingsJapgolly.atom.mod.LineData) => onMouseDown(t0).runNow()))
    if (onMouseMove != null) __obj.updateDynamic("onMouseMove")(js.Any.fromFunction1((t0: /* lineData */ typingsJapgolly.atom.mod.LineData) => onMouseMove(t0).runNow()))
