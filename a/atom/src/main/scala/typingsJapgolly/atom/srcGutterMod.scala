...
import typingsJapgolly.atom.atomStrings.decorated
...
object srcGutterMod {
  ...
  object Gutter {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(decorateMarker = js.Any.fromFunction2(decorateMarker), destroy = destroy.toJsFn, hide = hide.toJsFn, isVisible = isVisible.toJsFn, onDidChangeVisible = js.Any.fromFunction1(onDidChangeVisible), onDidDestroy = js.Any.fromFunction1(onDidDestroy), show = show.toJsFn)
  ...
  object GutterOptions {
    ...
    extension [Self <: GutterOptions](x: Self) {
      ...
      inline def setOnMouseDown(value: /* lineData */ LineData => Callback): Self = StObject.set(x, "onMouseDown", js.Any.fromFunction1((t0: /* lineData */ LineData) => value(t0).runNow()))
      
      inline def setOnMouseDownUndefined: Self = StObject.set(x, "onMouseDown", js.undefined)
      
      inline def setOnMouseMove(value: /* lineData */ LineData => Callback): Self = StObject.set(x, "onMouseMove", js.Any.fromFunction1((t0: /* lineData */ LineData) => value(t0).runNow()))
