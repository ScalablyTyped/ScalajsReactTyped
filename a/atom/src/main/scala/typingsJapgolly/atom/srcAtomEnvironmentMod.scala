...
import typingsJapgolly.atom.anon.Buttons
import typingsJapgolly.atom.anon.DetailedMessage
import typingsJapgolly.atom.anon.DevMode
import typingsJapgolly.atom.anon.Height
import typingsJapgolly.atom.anon.Width
import typingsJapgolly.atom.anon.X
import typingsJapgolly.atom.anon.Y
import typingsJapgolly.atom.atomStrings.beta
import typingsJapgolly.atom.atomStrings.dev
import typingsJapgolly.atom.atomStrings.error
import typingsJapgolly.atom.atomStrings.info
import typingsJapgolly.atom.atomStrings.nightly
import typingsJapgolly.atom.atomStrings.none
import typingsJapgolly.atom.atomStrings.question
import typingsJapgolly.atom.atomStrings.stable
import typingsJapgolly.atom.atomStrings.warning
import typingsJapgolly.atom.mod.Disposable
import typingsJapgolly.atom.srcClipboardMod.Clipboard
import typingsJapgolly.atom.srcCommandRegistryMod.CommandRegistry
import typingsJapgolly.atom.srcConfigMod.Config
import typingsJapgolly.atom.srcContextMenuManagerMod.ContextMenuManager
import typingsJapgolly.atom.srcDeserializerManagerMod.DeserializerManager
import typingsJapgolly.atom.srcGetWindowLoadSettingsMod.WindowLoadSettings
import typingsJapgolly.atom.srcGrammarRegistryMod.GrammarRegistry
import typingsJapgolly.atom.srcHistoryManagerMod.HistoryManager
import typingsJapgolly.atom.srcKeymapExtensionsMod.KeymapManager
import typingsJapgolly.atom.srcMenuManagerMod.MenuManager
import typingsJapgolly.atom.srcNotificationManagerMod.NotificationManager
import typingsJapgolly.atom.srcPackageManagerMod.PackageManager
import typingsJapgolly.atom.srcProjectMod.Project
import typingsJapgolly.atom.srcStyleManagerMod.StyleManager
import typingsJapgolly.atom.srcTextEditorRegistryMod.TextEditorRegistry
import typingsJapgolly.atom.srcThemeManagerMod.ThemeManager
import typingsJapgolly.atom.srcTooltipManagerMod.TooltipManager
import typingsJapgolly.atom.srcViewRegistryMod.ViewRegistry
import typingsJapgolly.atom.srcWorkspaceMod.Workspace
...
object srcAtomEnvironmentMod {
  ...
  object PreventableExceptionThrownEvent {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(column = column.asInstanceOf[js.Any], line = line.asInstanceOf[js.Any], message = message.asInstanceOf[js.Any], originalError = originalError.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, url = url.asInstanceOf[js.Any])
