...
import typingsJapgolly.atom.anon.History
import typingsJapgolly.atom.anon.Invalidate
import typingsJapgolly.atom.anon.MaintainHistory
import typingsJapgolly.atom.anon.NewExtent
import typingsJapgolly.atom.anon.NewRange
import typingsJapgolly.atom.anon.ShouldDestroyOnFileDelete
import typingsJapgolly.atom.anon.groupingIntervalnumberund
import typingsJapgolly.atom.dependenciesTextBufferSrcHelpersMod.TextChange
import typingsJapgolly.atom.dependenciesTextBufferSrcMarkerLayerMod.FindMarkerOptions
...
import typingsJapgolly.atom.srcOtherTypesMod.FileSavedEvent
import typingsJapgolly.atom.srcOtherTypesMod.HandleableErrorEvent
import typingsJapgolly.atom.srcOtherTypesMod.HistoryTransactionOptions
import typingsJapgolly.atom.srcOtherTypesMod.HistoryTraversalOptions
...
object dependenciesTextBufferSrcTextBufferMod {
  ...
  open class Point ()
    extends typingsJapgolly.atom.dependenciesTextBufferSrcPointMod.Point {
  ...
  open class Range ()
    extends typingsJapgolly.atom.dependenciesTextBufferSrcRangeMod.Range {
  ...
  object TextBufferFileBackend {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(createReadStream = createReadStream.toJsFn, createWriteStream = createWriteStream.toJsFn, existsSync = existsSync.toJsFn, getPath = getPath.toJsFn)
      __obj.asInstanceOf[TextBufferFileBackend]
    }
    
    extension [Self <: TextBufferFileBackend](x: Self) {
      
      inline def setCreateReadStream(value: CallbackTo[ReadStream]): Self = StObject.set(x, "createReadStream", value.toJsFn)
      
      inline def setCreateWriteStream(value: CallbackTo[WriteStream]): Self = StObject.set(x, "createWriteStream", value.toJsFn)
      
      inline def setExistsSync(value: CallbackTo[Boolean]): Self = StObject.set(x, "existsSync", value.toJsFn)
