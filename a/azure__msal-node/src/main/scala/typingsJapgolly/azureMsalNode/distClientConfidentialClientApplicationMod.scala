...
import typingsJapgolly.azureMsalNode.distClientClientApplicationMod.ClientApplication
import typingsJapgolly.azureMsalNode.distClientIconfidentialclientapplicationMod.IConfidentialClientApplication
