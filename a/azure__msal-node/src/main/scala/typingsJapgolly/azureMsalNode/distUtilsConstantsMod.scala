...
object distUtilsConstantsMod {
  ...
  object ApiId extends StObject {
    ...
    sealed trait acquireTokenByClientCredential
      extends StObject
         with ApiId
    /* 771 */ val acquireTokenByClientCredential: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.ApiId.acquireTokenByClientCredential & Double = js.native
    
    @js.native
    sealed trait acquireTokenByCode
      extends StObject
         with ApiId
    /* 871 */ val acquireTokenByCode: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.ApiId.acquireTokenByCode & Double = js.native
    
    @js.native
    sealed trait acquireTokenByDeviceCode
      extends StObject
         with ApiId
    /* 671 */ val acquireTokenByDeviceCode: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.ApiId.acquireTokenByDeviceCode & Double = js.native
    
    @js.native
    sealed trait acquireTokenByRefreshToken
      extends StObject
         with ApiId
    /* 872 */ val acquireTokenByRefreshToken: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.ApiId.acquireTokenByRefreshToken & Double = js.native
    
    @js.native
    sealed trait acquireTokenByUsernamePassword
      extends StObject
         with ApiId
    /* 371 */ val acquireTokenByUsernamePassword: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.ApiId.acquireTokenByUsernamePassword & Double = js.native
    
    @js.native
    sealed trait acquireTokenSilent
      extends StObject
         with ApiId
    /* 62 */ val acquireTokenSilent: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.ApiId.acquireTokenSilent & Double = js.native
  }
  ...
  object HttpMethod extends StObject {
    ...
    sealed trait GET
      extends StObject
         with HttpMethod
    /* "get" */ val GET: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.HttpMethod.GET & String = js.native
    
    @js.native
    sealed trait POST
      extends StObject
         with HttpMethod
    /* "post" */ val POST: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.HttpMethod.POST & String = js.native
  }
  ...
  object HttpStatus extends StObject {
    ...
    sealed trait OK
      extends StObject
         with HttpStatus
    /* 200 */ val OK: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.HttpStatus.OK & Double = js.native
    
    @js.native
    sealed trait REDIRECT
      extends StObject
         with HttpStatus
    /* 302 */ val REDIRECT: typingsJapgolly.azureMsalNode.distUtilsConstantsMod.HttpStatus.REDIRECT & Double = js.native
  }
