...
import typingsJapgolly.azureMsalCommon.distUtilsConstantsMod.ResponseMode
...
object distRequestAuthorizationUrlRequestMod {
  ...
  /* Inlined std.Partial<std.Omit<@azure/msal-common.@azure/msal-common.CommonAuthorizationUrlRequest, 'scopes' | 'redirectUri' | 'resourceRequestMethod' | 'resourceRequestUri' | 'authenticationScheme' | 'requestedClaimsHash'>> & {  scopes :std.Array<string>,   redirectUri :string} */
  ...
  object AuthorizationUrlRequest {
    ...
    inline def apply(redirectUri: String, scopes: js.Array[String]): AuthorizationUrlRequest = {
      val __obj = js.Dynamic.literal(redirectUri = redirectUri.asInstanceOf[js.Any], scopes = scopes.asInstanceOf[js.Any])
