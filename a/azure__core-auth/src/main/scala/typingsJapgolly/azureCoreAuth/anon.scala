...
object anon {
  ...
  trait TracingContext extends StObject {
    ...
    /**
      ...
      */
    var tracingContext: js.UndefOr[typingsJapgolly.azureCoreAuth.mod.TracingContext] = js.undefined
  }
  object TracingContext {
    ...
    extension [Self <: TracingContext](x: Self) {
      ...
      inline def setTracingContext(value: typingsJapgolly.azureCoreAuth.mod.TracingContext): Self = StObject.set(x, "tracingContext", value.asInstanceOf[js.Any])
