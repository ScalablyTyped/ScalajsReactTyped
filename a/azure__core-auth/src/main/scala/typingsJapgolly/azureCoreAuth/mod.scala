package typingsJapgolly.azureCoreAuth

import typingsJapgolly.azureAbortController.typesSrcAbortSignalMod.AbortSignalLike
import typingsJapgolly.azureCoreAuth.anon.Timeout
...
object mod {
  ...
  trait GetTokenOptions extends StObject {
    ...
    /**
      ...
      */
    var tracingOptions: js.UndefOr[typingsJapgolly.azureCoreAuth.anon.TracingContext] = js.undefined
  }
  object GetTokenOptions {
    ...
    extension [Self <: GetTokenOptions](x: Self) {
      ...
      inline def setTracingOptions(value: typingsJapgolly.azureCoreAuth.anon.TracingContext): Self = StObject.set(x, "tracingOptions", value.asInstanceOf[js.Any])
