...
@js.native
class _underscore ()
  extends typingsJapgolly.agGrid.utilsMod.Utils

@JSImport("ag-grid", "_")
@js.native
object _underscore
  extends Instantiable0[typingsJapgolly.agGrid.utilsMod.Utils] {
  ...
  def sortRowNodesByOrder(
    rowNodes: js.Array[typingsJapgolly.agGrid.rowNodeMod.RowNode],
  ...
  def traverseNodesWithKey(
    nodes: js.Array[typingsJapgolly.agGrid.rowNodeMod.RowNode],
    callback: js.Function2[/* node */ typingsJapgolly.agGrid.rowNodeMod.RowNode, /* key */ String, Unit]
  ): Unit = js.native
