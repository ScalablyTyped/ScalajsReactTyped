...
import typingsJapgolly.agGrid.AnonInstantiableICellEditorComp
import typingsJapgolly.agGrid.AnonInstantiableICellRendererComp
import typingsJapgolly.agGrid.AnonInstantiableIFilterComp
import typingsJapgolly.agGrid.AnonInstantiableIFloatingFilterComp
import typingsJapgolly.agGrid.columnMod.Column
import typingsJapgolly.agGrid.componentResolverMod.ComponentHolder
import typingsJapgolly.agGrid.componentResolverMod.DynamicComponentDef
import typingsJapgolly.agGrid.componentResolverMod.DynamicComponentParams
...
object ColDef {
  ...
  def apply(
    ...
    cellEditorSelector: /* params */ DynamicComponentParams => CallbackTo[DynamicComponentDef] = null,
    ...
    cellRendererSelector: /* params */ DynamicComponentParams => CallbackTo[DynamicComponentDef] = null,
    ...
    colId: String = null,
    colSpan: /* params */ ColSpanParams => CallbackTo[Double] = null,
    columnGroupShow: String = null,
    comparator: (/* valueA */ js.Any, /* valueB */ js.Any, /* nodeA */ js.UndefOr[RowNode], /* nodeB */ js.UndefOr[RowNode], /* isInverted */ js.UndefOr[Boolean]) => CallbackTo[Double] = null,
    ...
    equals: (/* valueA */ js.Any, /* valueB */ js.Any) => CallbackTo[Boolean] = null,
    field: String = null,
    ...
    getQuickFilterText: /* params */ GetQuickFilterTextParams => CallbackTo[String] = null,
    ...
    newValueHandler: /* params */ js.Any => CallbackTo[Boolean] = null,
    ...
    pinnedRowValueFormatter: /* params */ ValueFormatterParams => CallbackTo[String] = null,
    pivot: js.UndefOr[Boolean] = js.undefined,
    pivotComparator: (/* valueA */ String, /* valueB */ String) => CallbackTo[Double] = null,
    ...
    rowSpan: /* params */ RowSpanParams => CallbackTo[Double] = null,
    ...
    suppressKeyboardEvent: /* params */ SuppressKeyboardEventParams => CallbackTo[Boolean] = null,
    ...
    tooltip: /* params */ TooltipParams => CallbackTo[String] = null,
    tooltipField: String = null,
    `type`: String | js.Array[String] = null,
    unSortIcon: js.UndefOr[Boolean] = js.undefined,
    valueFormatter: /* params */ ValueFormatterParams => CallbackTo[String] = null,
    valueGetter: (js.Function1[/* params */ ValueGetterParams, _]) | String = null,
    valueParser: /* params */ ValueParserParams => CallbackTo[js.Any | String] = null,
    ...
    if (cellEditorSelector != null) __obj.updateDynamic("cellEditorSelector")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.componentResolverMod.DynamicComponentParams) => cellEditorSelector(t0).runNow()))
    ...
    if (cellRendererSelector != null) __obj.updateDynamic("cellRendererSelector")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.componentResolverMod.DynamicComponentParams) => cellRendererSelector(t0).runNow()))
    ...
    if (colSpan != null) __obj.updateDynamic("colSpan")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.colDefMod.ColSpanParams) => colSpan(t0).runNow()))
    if (columnGroupShow != null) __obj.updateDynamic("columnGroupShow")(columnGroupShow.asInstanceOf[js.Any])
    if (comparator != null) __obj.updateDynamic("comparator")(js.Any.fromFunction5((t0: /* valueA */ js.Any, t1: /* valueB */ js.Any, t2: /* nodeA */ js.UndefOr[typingsJapgolly.agGrid.rowNodeMod.RowNode], t3: /* nodeB */ js.UndefOr[typingsJapgolly.agGrid.rowNodeMod.RowNode], t4: /* isInverted */ js.UndefOr[scala.Boolean]) => comparator(t0, t1, t2, t3, t4).runNow()))
    ...
    if (equals != null) __obj.updateDynamic("equals")(js.Any.fromFunction2((t0: /* valueA */ js.Any, t1: /* valueB */ js.Any) => equals(t0, t1).runNow()))
    ...
    if (getQuickFilterText != null) __obj.updateDynamic("getQuickFilterText")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.colDefMod.GetQuickFilterTextParams) => getQuickFilterText(t0).runNow()))
    ...
    if (newValueHandler != null) __obj.updateDynamic("newValueHandler")(js.Any.fromFunction1((t0: /* params */ js.Any) => newValueHandler(t0).runNow()))
    ...
    if (pinnedRowValueFormatter != null) __obj.updateDynamic("pinnedRowValueFormatter")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.colDefMod.ValueFormatterParams) => pinnedRowValueFormatter(t0).runNow()))
    if (!js.isUndefined(pivot)) __obj.updateDynamic("pivot")(pivot.asInstanceOf[js.Any])
    if (pivotComparator != null) __obj.updateDynamic("pivotComparator")(js.Any.fromFunction2((t0: /* valueA */ java.lang.String, t1: /* valueB */ java.lang.String) => pivotComparator(t0, t1).runNow()))
    ...
    if (rowSpan != null) __obj.updateDynamic("rowSpan")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.colDefMod.RowSpanParams) => rowSpan(t0).runNow()))
    ...
    if (suppressKeyboardEvent != null) __obj.updateDynamic("suppressKeyboardEvent")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.colDefMod.SuppressKeyboardEventParams) => suppressKeyboardEvent(t0).runNow()))
    ...
    if (tooltip != null) __obj.updateDynamic("tooltip")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.colDefMod.TooltipParams) => tooltip(t0).runNow()))
    ...
    if (valueFormatter != null) __obj.updateDynamic("valueFormatter")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.colDefMod.ValueFormatterParams) => valueFormatter(t0).runNow()))
    if (valueGetter != null) __obj.updateDynamic("valueGetter")(valueGetter.asInstanceOf[js.Any])
    if (valueParser != null) __obj.updateDynamic("valueParser")(js.Any.fromFunction1((t0: /* params */ typingsJapgolly.agGrid.colDefMod.ValueParserParams) => valueParser(t0).runNow()))
