package typingsJapgolly.agGrid.componentMod
...
- typingsJapgolly.agGrid.iComponentMod.IComponent because var conflicts: destroy. Inlined getGui, afterGuiAttached, init */ @JSImport("ag-grid/dist/lib/widgets/component", "Component")
@js.native
