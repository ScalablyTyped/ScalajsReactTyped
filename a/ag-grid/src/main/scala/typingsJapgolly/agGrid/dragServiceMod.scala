...
object dragServiceMod extends js.Object {
  ...
  trait DragListenerParams extends js.Object {
    ...
    def onDragStart(mouseEvent: typingsJapgolly.std.MouseEvent): Unit = js.native
    def onDragStart(mouseEvent: Touch): Unit = js.native
    /** Callback for drag stopping */
    def onDragStop(mouseEvent: typingsJapgolly.std.MouseEvent): Unit = js.native
    def onDragStop(mouseEvent: Touch): Unit = js.native
    /** Callback for mouse move while dragging */
    def onDragging(mouseEvent: typingsJapgolly.std.MouseEvent): Unit = js.native
  ...
  class DragService () extends js.Object {
    ...
    def onUpCommon(eventOrTouch: typingsJapgolly.std.MouseEvent): Unit = js.native
