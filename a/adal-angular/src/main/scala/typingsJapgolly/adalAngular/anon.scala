...
import typingsJapgolly.adalAngular.adalAngularInts.`1`
import typingsJapgolly.adalAngular.adalAngularInts.`2`
import typingsJapgolly.adalAngular.adalAngularInts.`3`
import typingsJapgolly.adalAngular.adalAngularStrings.ERRORColon
import typingsJapgolly.adalAngular.adalAngularStrings.INFOColon
import typingsJapgolly.adalAngular.adalAngularStrings.VERBOSEColon
import typingsJapgolly.adalAngular.adalAngularStrings.WARNINGColon
...
object anon {
  ...
  trait ERROR extends StObject {
    ...
    var ERROR: typingsJapgolly.adalAngular.adalAngularInts.`0`
  ...
  object ERROR {
    ...
    extension [Self <: ERROR](x: Self) {
      ...
      inline def setERROR(value: typingsJapgolly.adalAngular.adalAngularInts.`0`): Self = StObject.set(x, "ERROR", value.asInstanceOf[js.Any])
