...
import typingsJapgolly.angularUiBootstrap.AnonDate
...
object IDatepickerPopupConfig {
  ...
  def apply(
    ...
    customClass: /* args */ IDatepickerCellArgs => CallbackTo[String] = null,
    dateDisabled: /* args */ IDatepickerCellArgs => CallbackTo[Boolean] = null,
    ...
    if (customClass != null) __obj.updateDynamic("customClass")(js.Any.fromFunction1((t0: /* args */ typingsJapgolly.angularUiBootstrap.mod.angularAugmentingMod.ui.bootstrap.IDatepickerCellArgs) => customClass(t0).runNow()))
    if (dateDisabled != null) __obj.updateDynamic("dateDisabled")(js.Any.fromFunction1((t0: /* args */ typingsJapgolly.angularUiBootstrap.mod.angularAugmentingMod.ui.bootstrap.IDatepickerCellArgs) => dateDisabled(t0).runNow()))
