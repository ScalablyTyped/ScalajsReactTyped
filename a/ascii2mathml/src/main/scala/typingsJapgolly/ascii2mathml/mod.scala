...
import typingsJapgolly.ascii2mathml.ascii2mathmlStrings.`inline`
import typingsJapgolly.ascii2mathml.ascii2mathmlStrings.block
import typingsJapgolly.ascii2mathml.ascii2mathmlStrings.ltr
import typingsJapgolly.ascii2mathml.ascii2mathmlStrings.rtl
...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsJapgolly.ascii2mathml.mod.ascii2mathml = js.native
  ...
  type _To = typingsJapgolly.ascii2mathml.mod.ascii2mathml
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsJapgolly.ascii2mathml.mod.ascii2mathml = ^
  ...
  trait ascii2mathml extends StObject {
    ...
    /**
      ...
      * @param options Options
      */
    def apply(options: Options): typingsJapgolly.ascii2mathml.mod.ascii2mathml = js.native
  }
}
