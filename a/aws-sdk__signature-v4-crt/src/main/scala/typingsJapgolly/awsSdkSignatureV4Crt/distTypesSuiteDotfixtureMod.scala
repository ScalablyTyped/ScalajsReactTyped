...
object distTypesSuiteDotfixtureMod {
  
  object credentials {
    
    @JSImport("@aws-sdk/signature-v4-crt/dist-types/suite.fixture", "credentials")
    @js.native
    val ^ : js.Any = js.native
    
    @JSImport("@aws-sdk/signature-v4-crt/dist-types/suite.fixture", "credentials.accessKeyId")
    @js.native
    ...
    @JSImport("@aws-sdk/signature-v4-crt/dist-types/suite.fixture", "credentials.secretAccessKey")
    @js.native
  ...
  @JSImport("@aws-sdk/signature-v4-crt/dist-types/suite.fixture", "region")
  @js.native
  val region: /* "us-east-1" */ String = js.native
  
  @JSImport("@aws-sdk/signature-v4-crt/dist-types/suite.fixture", "requests")
  @js.native
  val requests: js.Array[TestCase] = js.native
  
  @JSImport("@aws-sdk/signature-v4-crt/dist-types/suite.fixture", "service")
  @js.native
  val service: /* "service" */ String = js.native
  
  @JSImport("@aws-sdk/signature-v4-crt/dist-types/suite.fixture", "signingDate")
  @js.native
