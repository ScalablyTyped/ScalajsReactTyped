...
import typingsJapgolly.awsSdkTypes.distTypesSignatureMod.RequestSigningArguments
...
object distTypesCrtSignerV4Mod {
  ...
  type AwsSigningAlgorithm = typingsJapgolly.awsCrt.distNativeAuthMod.AwsSigningAlgorithm
