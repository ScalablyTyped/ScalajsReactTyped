...
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.remove
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.replace
