...
import typingsJapgolly.algoliaClientSearch.mod.SaveSynonymResponse
...
object ReadonlyWaitablePromiseSaWait {
  ...
  inline def apply(
    `catch`: CallbackTo[js.Promise[SaveSynonymResponse | Any]],
    `finally`: CallbackTo[js.Promise[SaveSynonymResponse]],
  ...
  extension [Self <: ReadonlyWaitablePromiseSaWait](x: Self) {
    ...
    inline def setCatch(value: CallbackTo[js.Promise[SaveSynonymResponse | Any]]): Self = StObject.set(x, "catch", value.toJsFn)
    
    inline def setFinally(value: CallbackTo[js.Promise[SaveSynonymResponse]]): Self = StObject.set(x, "finally", value.toJsFn)
