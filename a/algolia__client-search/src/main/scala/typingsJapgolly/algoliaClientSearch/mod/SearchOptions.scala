...
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.all
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.allOptional
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.alpha
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.attribute
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.count
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.exactPhrase
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.excludeWords
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.firstWords
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.ignorePlurals
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.lastWords
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.min
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.multiWordsSynonym
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.none
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.prefixAll
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.prefixLast
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.prefixNone
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.singleWordSynonym
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.strict
import typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.word
import typingsJapgolly.algoliaClientSearch.anon.From
...
trait SearchOptions extends StObject {
  ...
  val alternativesAsExact: js.UndefOr[
    js.Array[
      typingsJapgolly.algoliaClientSearch.algoliaClientSearchStrings.ignorePlurals | singleWordSynonym | multiWordsSynonym
    ]
  ] = js.undefined
