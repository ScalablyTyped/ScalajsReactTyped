...
import typingsJapgolly.algoliaClientSearch.anon.Answer
import typingsJapgolly.algoliaClientSearch.anon.Avg
import typingsJapgolly.algoliaClientSearch.anon.FacetOrdering
import typingsJapgolly.algoliaClientSearch.anon.Match
