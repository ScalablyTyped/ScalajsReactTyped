...
object distCssCsspropertyMod {
  ...
  object CSSProperty {
    ...
    extension [Self <: CSSProperty[?, ?], Parsed, Used](x: Self & (CSSProperty[Parsed, Used])) {
      ...
      inline def setPostProcessor(value: IElement[Any, Any] => Callback): Self = StObject.set(x, "postProcessor", js.Any.fromFunction1((t0: IElement[Any, Any]) => value(t0).runNow()))
      
      inline def setPreProcessor(value: IElement[Any, Any] => Callback): Self = StObject.set(x, "preProcessor", js.Any.fromFunction1((t0: IElement[Any, Any]) => value(t0).runNow()))
    }
  }
