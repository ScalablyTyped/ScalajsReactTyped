...
import typingsJapgolly.antvGLite.distComponentsCullableMod.Cullable
import typingsJapgolly.antvGLite.distComponentsGeometryMod.Geometry
import typingsJapgolly.antvGLite.distComponentsRbushnodeMod.RBushNode
import typingsJapgolly.antvGLite.distComponentsRenderableMod.Renderable
import typingsJapgolly.antvGLite.distComponentsSortableMod.Sortable
import typingsJapgolly.antvGLite.distComponentsTransformMod.Transform
import typingsJapgolly.antvGLite.distDomInterfacesMod.ICSSStyleDeclaration
...
import typingsJapgolly.antvGLite.distDomInterfacesMod.IParentNode
import typingsJapgolly.antvGLite.distDomNodeMod.Node
import typingsJapgolly.antvGLite.distServicesInterfacesMod.SceneGraphService
import typingsJapgolly.antvGLite.distShapesMod.AABB
import typingsJapgolly.antvGLite.distShapesMod.Rectangle
...
object distDomElementMod {
  
  /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
  - typingsJapgolly.antvGLite.distDomInterfacesMod.IEventTarget because Already inherited
  - typingsJapgolly.antvGLite.distDomInterfacesMod.INode because Already inherited
  - typingsJapgolly.antvGLite.distDomInterfacesMod.IChildNode because var conflicts: childNodes, firstChild, isConnected, lastChild, nextSibling, nodeName, nodeType, nodeValue, ownerDocument, parentElement, parentNode, previousSibling, shadow, textContent. Inlined after, before, remove, replaceWith
  - typingsJapgolly.antvGLite.distDomInterfacesMod.IElement because var conflicts: childNodes, firstChild, isConnected, lastChild, nextSibling, nodeName, nodeType, nodeValue, ownerDocument, parentElement, parentNode, previousSibling, shadow, textContent. Inlined id, tagName, name, className, classList, attributes, style, parsedStyle, getElementById, getElementsByName, getElementsByClassName, getElementsByTagName, scrollLeft, scrollTop, clientLeft, clientTop, setAttribute, setAttribute, getAttribute, removeAttribute, hasAttribute */ @JSImport("@antv/g-lite/dist/dom/Element", "Element")
  @js.native
