...
import typingsJapgolly.antvGLite.antvGLiteStrings.circle
import typingsJapgolly.antvGLite.antvGLiteStrings.ellipse
import typingsJapgolly.antvGLite.antvGLiteStrings.shape
