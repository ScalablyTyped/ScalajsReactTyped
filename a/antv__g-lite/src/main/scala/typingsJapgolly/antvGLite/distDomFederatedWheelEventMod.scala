...
import typingsJapgolly.antvGLite.distDomFederatedMouseEventMod.FederatedMouseEvent
...
object distDomFederatedWheelEventMod {
  ...
  - typingsJapgolly.std.UIEvent because Already inherited
  - typingsJapgolly.std.MouseEvent because Already inherited
  - typingsJapgolly.std.WheelEvent because var conflicts: altKey, button, buttons, cancelBubble, clientX, clientY, ctrlKey, metaKey, movementX, movementY, offsetX, offsetY, relatedTarget, returnValue, screenX, screenY, shiftKey. Inlined DOM_DELTA_PIXEL, DOM_DELTA_PAGE, deltaZ, deltaX, deltaMode, DOM_DELTA_LINE, deltaY */ @JSImport("@antv/g-lite/dist/dom/FederatedWheelEvent", "FederatedWheelEvent")
  @js.native
  /**
