...
import typingsJapgolly.antvGLite.anon.PartialPropertyParseOptio
import typingsJapgolly.antvGLite.distCssCssomMod.CSSStyleValue
import typingsJapgolly.antvGLite.distCssCsspropertyMod.CSSProperty
...
object distCssInterfacesMod {
  ...
  object PropertySyntax extends StObject {
    ...
    sealed trait ANGLE
      extends StObject
         with PropertySyntax
    /* "<angle>" */ val ANGLE: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.ANGLE & String = js.native
    
    @js.native
    sealed trait CLIP_PATH
      extends StObject
         with PropertySyntax
    /* "<clip-path>" */ val CLIP_PATH: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.CLIP_PATH & String = js.native
    ...
    sealed trait COLOR
      extends StObject
         with PropertySyntax
    /* "<color>" */ val COLOR: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.COLOR & String = js.native
    ...
    sealed trait COORDINATE
      extends StObject
         with PropertySyntax
    /* "<coordinate>" */ val COORDINATE: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.COORDINATE & String = js.native
    ...
    sealed trait FILTER
      extends StObject
         with PropertySyntax
    /* "<filter>" */ val FILTER: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.FILTER & String = js.native
    ...
    sealed trait LENGTH
      extends StObject
         with PropertySyntax
    /* "<length>" */ val LENGTH: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.LENGTH & String = js.native
    
    @js.native
    sealed trait LENGTH_PERCENTAGE
      extends StObject
         with PropertySyntax
    /* "<length> | <percentage>" */ val LENGTH_PERCENTAGE: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.LENGTH_PERCENTAGE & String = js.native
    
    @js.native
    sealed trait LENGTH_PERCENTAGE_12
      extends StObject
         with PropertySyntax
    /* "[<length> | <percentage>]{1,2}" */ val LENGTH_PERCENTAGE_12: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.LENGTH_PERCENTAGE_12 & String = js.native
    ...
    sealed trait LENGTH_PERCENTAGE_14
      extends StObject
         with PropertySyntax
    /* "[<length> | <percentage>]{1,4}" */ val LENGTH_PERCENTAGE_14: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.LENGTH_PERCENTAGE_14 & String = js.native
    ...
    sealed trait LIST_OF_POINTS
      extends StObject
         with PropertySyntax
    /* "<list-of-points>" */ val LIST_OF_POINTS: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.LIST_OF_POINTS & String = js.native
    
    @js.native
    sealed trait MARKER
      extends StObject
         with PropertySyntax
    /* "<marker>" */ val MARKER: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.MARKER & String = js.native
    ...
    sealed trait NUMBER
      extends StObject
         with PropertySyntax
    /* "<number>" */ val NUMBER: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.NUMBER & String = js.native
    
    @js.native
    sealed trait OFFSET_DISTANCE
      extends StObject
         with PropertySyntax
    /* "<offset-distance>" */ val OFFSET_DISTANCE: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.OFFSET_DISTANCE & String = js.native
    
    @js.native
    sealed trait OFFSET_PATH
      extends StObject
         with PropertySyntax
    /* "<offset-path>" */ val OFFSET_PATH: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.OFFSET_PATH & String = js.native
    ...
    sealed trait OPACITY_VALUE
      extends StObject
         with PropertySyntax
    /* "<opacity-value>" */ val OPACITY_VALUE: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.OPACITY_VALUE & String = js.native
    ...
    sealed trait PAINT
      extends StObject
         with PropertySyntax
    /* "<paint>" */ val PAINT: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.PAINT & String = js.native
    
    @js.native
    sealed trait PATH
      extends StObject
         with PropertySyntax
    /* "<path>" */ val PATH: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.PATH & String = js.native
    ...
    sealed trait PERCENTAGE
      extends StObject
         with PropertySyntax
    /* "<percentage>" */ val PERCENTAGE: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.PERCENTAGE & String = js.native
    ...
    sealed trait SHADOW_BLUR
      extends StObject
         with PropertySyntax
    /* "<shadow-blur>" */ val SHADOW_BLUR: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.SHADOW_BLUR & String = js.native
    
    @js.native
    sealed trait TEXT
      extends StObject
         with PropertySyntax
    /* "<text>" */ val TEXT: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.TEXT & String = js.native
    
    @js.native
    sealed trait TEXT_TRANSFORM
      extends StObject
         with PropertySyntax
    /* "<text-transform>" */ val TEXT_TRANSFORM: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.TEXT_TRANSFORM & String = js.native
    
    @js.native
    sealed trait TRANSFORM
      extends StObject
         with PropertySyntax
    /* "<transform>" */ val TRANSFORM: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.TRANSFORM & String = js.native
    
    @js.native
    sealed trait TRANSFORM_ORIGIN
      extends StObject
         with PropertySyntax
    /* "<transform-origin>" */ val TRANSFORM_ORIGIN: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.TRANSFORM_ORIGIN & String = js.native
    
    @js.native
    sealed trait Z_INDEX
      extends StObject
         with PropertySyntax
    /* "<z-index>" */ val Z_INDEX: typingsJapgolly.antvGLite.distCssInterfacesMod.PropertySyntax.Z_INDEX & String = js.native
  }
