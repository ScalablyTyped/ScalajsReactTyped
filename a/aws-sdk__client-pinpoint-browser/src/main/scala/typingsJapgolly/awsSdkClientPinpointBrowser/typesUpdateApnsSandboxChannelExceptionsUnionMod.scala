...
object typesUpdateApnsSandboxChannelExceptionsUnionMod {
  ...
  */
  trait UpdateApnsSandboxChannelExceptionsUnion extends StObject
  object UpdateApnsSandboxChannelExceptionsUnion {
