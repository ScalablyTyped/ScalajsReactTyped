...
object typesUpdateApnsVoipChannelInputMod {
  ...
  trait UpdateApnsVoipChannelInput
    ...
    /**
      ...
      */
    var APNSVoipChannelRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesApnsvoipchannelrequestMod.APNSVoipChannelRequest
  ...
  object UpdateApnsVoipChannelInput {
    ...
    extension [Self <: UpdateApnsVoipChannelInput](x: Self) {
