...
@JSImport("@aws-sdk/client-pinpoint-browser/types/DeleteSegmentInput", JSImport.Namespace)
@js.native
object typesDeleteSegmentInputMod extends js.Object {
  @js.native
  trait DeleteSegmentInput extends InputTypesUnion {
    /**
