...
object typesUpdateEmailChannelInputMod {
  ...
  trait UpdateEmailChannelInput
    ...
    /**
      ...
      */
    var EmailChannelRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesEmailChannelRequestMod.EmailChannelRequest
  }
