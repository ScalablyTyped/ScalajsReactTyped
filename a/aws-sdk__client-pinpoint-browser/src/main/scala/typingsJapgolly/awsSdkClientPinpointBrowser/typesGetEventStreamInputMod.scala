...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetEventStreamInput", JSImport.Namespace)
@js.native
object typesGetEventStreamInputMod extends js.Object {
  @js.native
  trait GetEventStreamInput extends InputTypesUnion {
    /**
