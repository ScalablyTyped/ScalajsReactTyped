...
object typesSendMessagesInputMod {
  ...
  trait SendMessagesInput
    ...
    /**
      ...
      */
    var MessageRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesMessageRequestMod.MessageRequest
  }
  object SendMessagesInput {
    
    inline def apply(ApplicationId: String, MessageRequest: MessageRequest): SendMessagesInput = {
    ...
    extension [Self <: SendMessagesInput](x: Self) {
