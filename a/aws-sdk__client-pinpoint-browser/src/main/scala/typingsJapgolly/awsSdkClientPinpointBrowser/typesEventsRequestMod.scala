...
import typingsJapgolly.awsSdkClientPinpointBrowser.typesEventsBatchMod.EventsBatch
import typingsJapgolly.awsSdkClientPinpointBrowser.typesEventsBatchMod.UnmarshalledEventsBatch
