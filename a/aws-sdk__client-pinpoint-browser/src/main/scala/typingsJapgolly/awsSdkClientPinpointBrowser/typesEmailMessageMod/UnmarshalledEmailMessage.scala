...
import typingsJapgolly.awsSdkClientPinpointBrowser.typesRawEmailMod.UnmarshalledRawEmail
import typingsJapgolly.awsSdkClientPinpointBrowser.typesSimpleEmailMod.UnmarshalledSimpleEmail
