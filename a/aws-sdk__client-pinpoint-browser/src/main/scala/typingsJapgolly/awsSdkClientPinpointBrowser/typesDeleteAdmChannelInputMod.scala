...
@JSImport("@aws-sdk/client-pinpoint-browser/types/DeleteAdmChannelInput", JSImport.Namespace)
@js.native
object typesDeleteAdmChannelInputMod extends js.Object {
  @js.native
  trait DeleteAdmChannelInput extends InputTypesUnion {
    /**
