...
object typesUpdateCampaignInputMod {
  ...
  trait UpdateCampaignInput
    ...
    /**
      ...
      */
    var WriteCampaignRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesWriteCampaignRequestMod.WriteCampaignRequest
  }
