...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetSegmentVersionsInput", JSImport.Namespace)
@js.native
object typesGetSegmentVersionsInputMod extends js.Object {
  @js.native
  trait GetSegmentVersionsInput extends InputTypesUnion {
    /**
