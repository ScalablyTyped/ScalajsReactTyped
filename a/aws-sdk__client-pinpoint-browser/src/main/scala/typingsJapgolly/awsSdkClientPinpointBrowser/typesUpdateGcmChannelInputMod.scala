...
object typesUpdateGcmChannelInputMod {
  ...
  trait UpdateGcmChannelInput
    ...
    /**
      ...
      */
    var GCMChannelRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesGcmchannelrequestMod.GCMChannelRequest
  }
  object UpdateGcmChannelInput {
    ...
    extension [Self <: UpdateGcmChannelInput](x: Self) {
