...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetSegmentExportJobsExceptionsUnion", JSImport.Namespace)
@js.native
object getSegmentExportJobsExceptionsUnionMod extends js.Object {
