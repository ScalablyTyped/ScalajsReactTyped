...
object typesUpdateSmsChannelInputMod {
  ...
  trait UpdateSmsChannelInput
    ...
    /**
      * SMS Channel Request
      */
    var SMSChannelRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesSmschannelrequestMod.SMSChannelRequest
  }
  object UpdateSmsChannelInput {
    ...
    extension [Self <: UpdateSmsChannelInput](x: Self) {
