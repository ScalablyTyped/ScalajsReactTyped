...
object modelMapOfEndpointSendConfigurationMod {
  
  @JSImport("@aws-sdk/client-pinpoint-browser/model/_MapOfEndpointSendConfiguration", "_MapOfEndpointSendConfiguration")
  @js.native
  val MapOfEndpointSendConfiguration: Map[
