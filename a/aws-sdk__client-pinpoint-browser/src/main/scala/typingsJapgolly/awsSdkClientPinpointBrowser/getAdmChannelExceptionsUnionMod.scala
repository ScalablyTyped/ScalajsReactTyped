...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetAdmChannelExceptionsUnion", JSImport.Namespace)
@js.native
object getAdmChannelExceptionsUnionMod extends js.Object {
