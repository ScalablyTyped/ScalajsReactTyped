...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetGcmChannelExceptionsUnion", JSImport.Namespace)
@js.native
object getGcmChannelExceptionsUnionMod extends js.Object {
