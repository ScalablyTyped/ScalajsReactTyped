...
object typesCreateAppInputMod {
  
  trait CreateAppInput
    extends StObject
    ...
    /**
      * Application Request.
      */
    var CreateApplicationRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesCreateApplicationRequestMod.CreateApplicationRequest
  }
  object CreateAppInput {
    ...
    extension [Self <: CreateAppInput](x: Self) {
