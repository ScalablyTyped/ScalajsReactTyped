...
@JSImport("@aws-sdk/client-pinpoint-browser/types/GetBaiduChannelInput", JSImport.Namespace)
@js.native
object typesGetBaiduChannelInputMod extends js.Object {
  @js.native
  trait GetBaiduChannelInput extends InputTypesUnion {
    /**
