...
object typesSendUsersMessagesInputMod {
  ...
  trait SendUsersMessagesInput
    ...
    /**
      ...
      */
    var SendUsersMessageRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesSendUsersMessageRequestMod.SendUsersMessageRequest
  }
  object SendUsersMessagesInput {
    ...
    extension [Self <: SendUsersMessagesInput](x: Self) {
