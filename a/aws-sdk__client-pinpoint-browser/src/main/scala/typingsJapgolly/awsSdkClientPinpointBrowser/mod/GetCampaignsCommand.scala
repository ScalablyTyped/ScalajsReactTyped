...
@JSImport("@aws-sdk/client-pinpoint-browser", "GetCampaignsCommand")
@js.native
open class GetCampaignsCommand protected ()
  extends typingsJapgolly.awsSdkClientPinpointBrowser.commandsGetCampaignsCommandMod.GetCampaignsCommand {
