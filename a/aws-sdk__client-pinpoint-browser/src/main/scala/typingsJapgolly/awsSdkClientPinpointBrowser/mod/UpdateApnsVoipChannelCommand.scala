...
@js.native
class UpdateApnsVoipChannelCommand protected ()
  extends typingsJapgolly.awsSdkClientPinpointBrowser.updateApnsVoipChannelCommandMod.UpdateApnsVoipChannelCommand {
