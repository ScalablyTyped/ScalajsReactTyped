...
object typesUpdateApnsVoipSandboxChannelInputMod {
  
  trait UpdateApnsVoipSandboxChannelInput
    extends StObject
    ...
    /**
      ...
      */
    var APNSVoipSandboxChannelRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesApnsvoipsandboxchannelrequestMod.APNSVoipSandboxChannelRequest
  ...
  object UpdateApnsVoipSandboxChannelInput {
    ...
    extension [Self <: UpdateApnsVoipSandboxChannelInput](x: Self) {
