package typingsJapgolly.awsSdkClientPinpointBrowser.typesAttributeDimensionMod

import typingsJapgolly.awsSdkClientPinpointBrowser.awsSdkClientPinpointBrowserStrings.EXCLUSIVE
import typingsJapgolly.awsSdkClientPinpointBrowser.awsSdkClientPinpointBrowserStrings.INCLUSIVE
...
object AttributeDimension {
  ...
  def apply(
    ...
    Values: js.Array[String] | js.Iterable[String] = null
  ): AttributeDimension = {
