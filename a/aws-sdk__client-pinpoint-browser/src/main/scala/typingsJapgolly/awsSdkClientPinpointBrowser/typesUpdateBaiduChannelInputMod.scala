...
object typesUpdateBaiduChannelInputMod {
  ...
  trait UpdateBaiduChannelInput
    ...
    /**
      ...
      */
    var BaiduChannelRequest: typingsJapgolly.awsSdkClientPinpointBrowser.typesBaiduChannelRequestMod.BaiduChannelRequest
  }
  object UpdateBaiduChannelInput {
    ...
    extension [Self <: UpdateBaiduChannelInput](x: Self) {
