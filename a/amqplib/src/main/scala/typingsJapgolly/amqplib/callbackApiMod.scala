...
object callbackApiMod {
  ...
  trait Channel extends EventEmitter {
    ...
    def assertQueue(queue: String, options: typingsJapgolly.amqplib.propertiesMod.Options.AssertQueue): Unit = js.native
    def assertQueue(
      queue: String,
      options: typingsJapgolly.amqplib.propertiesMod.Options.AssertQueue,
    ...
    def assertQueue(queue: Unit, options: typingsJapgolly.amqplib.propertiesMod.Options.AssertQueue): Unit = js.native
    def assertQueue(
      queue: Unit,
      options: typingsJapgolly.amqplib.propertiesMod.Options.AssertQueue,
      callback: js.Function2[/* err */ Any, /* ok */ AssertQueue, Unit]
    ...
    def deleteQueue(queue: String, options: typingsJapgolly.amqplib.propertiesMod.Options.DeleteQueue): Unit = js.native
    def deleteQueue(
      queue: String,
      options: typingsJapgolly.amqplib.propertiesMod.Options.DeleteQueue,
