...
@JSImport("apollo-reporting-protobuf/generated/protobuf", "QueryLatencyStats")
@js.native
/**
...
open class QueryLatencyStats ()
  ...
  @JSName("requestsWithoutFieldInstrumentation")
  var requestsWithoutFieldInstrumentation_QueryLatencyStats: Double = js.native
...
object QueryLatencyStats {
  ...
  inline def decode(reader: js.typedarray.Uint8Array): QueryLatencyStats = ^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any]).asInstanceOf[QueryLatencyStats]
  inline def decode(reader: js.typedarray.Uint8Array, length: Double): QueryLatencyStats = (^.asInstanceOf[js.Dynamic].applyDynamic("decode")(reader.asInstanceOf[js.Any], length.asInstanceOf[js.Any])).asInstanceOf[QueryLatencyStats]
  /**
  ...
  inline def decodeDelimited(reader: js.typedarray.Uint8Array): QueryLatencyStats = ^.asInstanceOf[js.Dynamic].applyDynamic("decodeDelimited")(reader.asInstanceOf[js.Any]).asInstanceOf[QueryLatencyStats]
  /**
  ...
  /**
    ...
    */
  inline def toObject(message: QueryLatencyStats): StringDictionary[Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any]).asInstanceOf[StringDictionary[Any]]
  inline def toObject(message: QueryLatencyStats, options: IConversionOptions): StringDictionary[Any] = (^.asInstanceOf[js.Dynamic].applyDynamic("toObject")(message.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[StringDictionary[Any]]
