...
import typingsJapgolly.awsSdkSharedIniFileLoader.distTypesTypesMod.SharedConfigFiles
...
object buildFromSharedConfigFilesMod {
  ...
  trait SharedConfigInit
    extends StObject
       with typingsJapgolly.awsSdkSharedIniFileLoader.distTypesLoadSharedConfigFilesMod.SharedConfigInit {
