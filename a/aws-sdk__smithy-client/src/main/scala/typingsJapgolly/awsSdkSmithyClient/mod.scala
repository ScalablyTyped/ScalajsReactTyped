...
import typingsJapgolly.awsSdkSmithyClient.distTypesClientMod.SmithyResolvedConfiguration
import typingsJapgolly.awsSdkSmithyClient.distTypesDefaultsModeMod.DefaultsModeConfigs
...
import typingsJapgolly.awsSdkSmithyClient.distTypesObjectMappingMod.ObjectMappingInstruction
import typingsJapgolly.awsSdkSmithyClient.distTypesObjectMappingMod.Value
import typingsJapgolly.awsSdkSmithyClient.distTypesObjectMappingMod.ValueSupplier
...
object mod {
  ...
  open class Client[HandlerOptions, ClientInput /* <: js.Object */, ClientOutput /* <: MetadataBearer */, ResolvedClientConfiguration /* <: SmithyResolvedConfiguration[HandlerOptions] */] protected ()
    extends typingsJapgolly.awsSdkSmithyClient.distTypesClientMod.Client[HandlerOptions, ClientInput, ClientOutput, ResolvedClientConfiguration] {
  ...
  open class Command[Input /* <: ClientInput */, Output /* <: ClientOutput */, ResolvedClientConfiguration, ClientInput /* <: js.Object */, ClientOutput /* <: MetadataBearer */] ()
    extends typingsJapgolly.awsSdkSmithyClient.distTypesCommandMod.Command[Input, Output, ResolvedClientConfiguration, ClientInput, ClientOutput]
  
  @JSImport("@aws-sdk/smithy-client", "LazyJsonString")
  @js.native
  open class LazyJsonString ()
    extends typingsJapgolly.awsSdkSmithyClient.distTypesLazyJsonMod.LazyJsonString
  /* static members */
  object LazyJsonString {
    ...
    inline def fromObject(`object`: Any): typingsJapgolly.awsSdkSmithyClient.distTypesLazyJsonMod.LazyJsonString = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(`object`.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.awsSdkSmithyClient.distTypesLazyJsonMod.LazyJsonString]
  }
  ...
  open class ServiceException protected ()
    extends typingsJapgolly.awsSdkSmithyClient.distTypesExceptionsMod.ServiceException {
    def this(options: ServiceExceptionOptions) = this()
  }
  
  @JSImport("@aws-sdk/smithy-client", "StringWrapper")
  @js.native
  val StringWrapper: typingsJapgolly.awsSdkSmithyClient.distTypesLazyJsonMod.StringWrapper = js.native
  ...
  inline def decorateServiceException[E /* <: typingsJapgolly.awsSdkSmithyClient.distTypesExceptionsMod.ServiceException */](exception: E): E = ^.asInstanceOf[js.Dynamic].applyDynamic("decorateServiceException")(exception.asInstanceOf[js.Any]).asInstanceOf[E]
  inline def decorateServiceException[E /* <: typingsJapgolly.awsSdkSmithyClient.distTypesExceptionsMod.ServiceException */](exception: E, additions: Record[String, Any]): E = (^.asInstanceOf[js.Dynamic].applyDynamic("decorateServiceException")(exception.asInstanceOf[js.Any], additions.asInstanceOf[js.Any])).asInstanceOf[E]
