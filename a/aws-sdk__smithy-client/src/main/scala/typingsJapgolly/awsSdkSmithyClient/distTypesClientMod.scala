...
import typingsJapgolly.awsSdkTypes.distTypesClientMod.InvokeFunction
...
object distTypesClientMod {
  ...
  open class Client[HandlerOptions, ClientInput /* <: js.Object */, ClientOutput /* <: MetadataBearer */, ResolvedClientConfiguration /* <: SmithyResolvedConfiguration[HandlerOptions] */] protected ()
    extends StObject
       with typingsJapgolly.awsSdkTypes.distTypesClientMod.Client[ClientInput, ClientOutput, ResolvedClientConfiguration] {
