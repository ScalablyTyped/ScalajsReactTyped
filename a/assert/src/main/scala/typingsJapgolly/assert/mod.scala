...
import typingsJapgolly.assert.assertStrings.ERR_ASSERTION
import typingsJapgolly.assert.assertStrings.deepEqual
import typingsJapgolly.assert.assertStrings.deepStrictEqual
import typingsJapgolly.assert.assertStrings.equal
import typingsJapgolly.assert.assertStrings.ifError
import typingsJapgolly.assert.assertStrings.notDeepEqual
import typingsJapgolly.assert.assertStrings.notEqual
import typingsJapgolly.assert.assertStrings.ok
import typingsJapgolly.assert.assertStrings.strictEqual
...
object mod {
  ...
  val strict: (Omit[
    ...
    equal | notEqual | deepEqual | notDeepEqual | ok | strictEqual | deepStrictEqual | ifError | typingsJapgolly.assert.assertStrings.strict
  ]) & DeepEqual = js.native
