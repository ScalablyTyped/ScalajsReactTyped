...
object esThemeThemeCacheMod {
  ...
  open class default ()
    ...
    /* CompleteClass */
    override def delete(derivativeOption: DerivativeOptions): js.UndefOr[typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]] = js.native
    
    /* private */ /* CompleteClass */
    var deleteByPath: Any = js.native
    
    /* CompleteClass */
    override def get(derivativeOption: DerivativeOptions): js.UndefOr[typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]] = js.native
    ...
    override def set(
      ...
      value: typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]
    ): Unit = js.native
  ...
  trait ThemeCache extends StObject {
    ...
    def delete(derivativeOption: DerivativeOptions): js.UndefOr[typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]]
    
    /* private */ var deleteByPath: Any
    
    def get(derivativeOption: DerivativeOptions): js.UndefOr[typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]]
  ...
  object ThemeCache {
    ...
    inline def apply(
      cache: Any,
      cacheCallTimes: Any,
      delete: DerivativeOptions => js.UndefOr[typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]],
      deleteByPath: Any,
      get: DerivativeOptions => js.UndefOr[typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]],
      has: DerivativeOptions => Boolean,
      internalGet: Any,
      keys: Any,
      set: (DerivativeOptions, typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]) => Callback,
      size: CallbackTo[Double]
    ): ThemeCache = {
      val __obj = js.Dynamic.literal(cache = cache.asInstanceOf[js.Any], cacheCallTimes = cacheCallTimes.asInstanceOf[js.Any], delete = js.Any.fromFunction1(delete), deleteByPath = deleteByPath.asInstanceOf[js.Any], get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has), internalGet = internalGet.asInstanceOf[js.Any], keys = keys.asInstanceOf[js.Any], set = js.Any.fromFunction2((t0: DerivativeOptions, t1: typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]) => (set(t0, t1)).runNow()), size = size.toJsFn)
    ...
    extension [Self <: ThemeCache](x: Self) {
      ...
      inline def setDelete(
        value: DerivativeOptions => js.UndefOr[typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]]
      ...
      inline def setSet(
        value: (DerivativeOptions, typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]) => Callback
      ): Self = StObject.set(x, "set", js.Any.fromFunction2((t0: DerivativeOptions, t1: typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]) => (value(t0, t1)).runNow()))
