...
object esThemeCreateThemeMod {
  ...
  ): typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any] = ^.asInstanceOf[js.Dynamic].applyDynamic("default")(derivatives.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.antDesignCssinjs.esThemeThemeMod.default[Any, Any]]
  inline def default[DesignToken /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TokenType */ Any */, DerivativeToken /* <: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify TokenType */ Any */](
