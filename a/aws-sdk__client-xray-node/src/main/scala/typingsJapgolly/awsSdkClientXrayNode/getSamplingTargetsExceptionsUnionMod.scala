...
@JSImport("@aws-sdk/client-xray-node/types/GetSamplingTargetsExceptionsUnion", JSImport.Namespace)
@js.native
object getSamplingTargetsExceptionsUnionMod extends js.Object {
