...
object xrayconfigurationMod {
  ...
  object XRayConfiguration {
    ...
    inline def apply(): XRayConfiguration = {
  ...
  trait XRayResolvableConfiguration
    extends StObject
       with XRayConfiguration {
  ...
  object XRayResolvableConfiguration {
  ...
  trait XRayResolvedConfiguration
    extends StObject
       with XRayConfiguration {
    ...
    def base64Decoder_MXRayResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MXRayResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("base64Encoder")
    ...
    @JSName("credentials")
    def credentials_MXRayResolvedConfiguration(): js.Promise[Credentials]
    @JSName("credentials")
    ...
    @JSName("handler")
    def handler_MXRayResolvedConfiguration[Input /* <: js.Object */, Output /* <: js.Object */](context: HandlerExecutionContext): DeserializeHandler[Input, Output]
    @JSName("handler")
    var handler_Original: Terminalware
    
    @JSName("maxRedirects")
    var maxRedirects_XRayResolvedConfiguration: Double
    
    @JSName("maxRetries")
    var maxRetries_XRayResolvedConfiguration: Double
    
    var parser: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ResponseParser<_stream.Readable> */ Any
    
    @JSName("region")
    def region_MXRayResolvedConfiguration(): js.Promise[String]
    @JSName("region")
    ...
    @JSName("sha256")
    var sha256_XRayResolvedConfiguration: HashConstructor
    
    @JSName("signer")
    var signer_XRayResolvedConfiguration: RequestSigner
    
    @JSName("signingName")
    var signingName_XRayResolvedConfiguration: String
    
    @JSName("sslEnabled")
    var sslEnabled_XRayResolvedConfiguration: Boolean
    
    @JSName("streamCollector")
    def streamCollector_MXRayResolvedConfiguration(stream: Any): js.Promise[js.typedarray.Uint8Array]
    @JSName("streamCollector")
    var streamCollector_Original: StreamCollector
    
    @JSName("urlParser")
    def urlParser_MXRayResolvedConfiguration(url: String): Endpoint
    @JSName("urlParser")
    def urlParser_MXRayResolvedConfiguration(url: URL): Endpoint
    @JSName("urlParser")
    var urlParser_Original: UrlParser
    
    @JSName("utf8Decoder")
    def utf8Decoder_MXRayResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MXRayResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("utf8Encoder")
    var utf8Encoder_Original: Encoder
  }
  object XRayResolvedConfiguration {
