...
import typingsJapgolly.autolinker.distCommonjsAnchorTagBuilderMod.AnchorTagBuilderCfg
import typingsJapgolly.autolinker.distCommonjsAutolinkerMod.AutolinkerConfig
import typingsJapgolly.autolinker.distCommonjsHtmlTagMod.HtmlTagCfg
...
object mod {
  ...
  /**
    ...
    */
  open class default ()
    extends typingsJapgolly.autolinker.distCommonjsAutolinkerMod.default {
  ...
  open class AbstractMatch protected ()
    extends typingsJapgolly.autolinker.distCommonjsMatchMod.AbstractMatch {
    /**
  ...
  open class AnchorTagBuilder ()
    extends typingsJapgolly.autolinker.distCommonjsAnchorTagBuilderMod.AnchorTagBuilder {
  ...
  open class EmailMatch protected ()
    extends typingsJapgolly.autolinker.distCommonjsMatchMod.EmailMatch {
    /**
      * @method constructor
      * @param {Object} cfg The configuration properties for the Match
      *   instance, specified in an Object (map).
  ...
  open class HashtagMatch protected ()
    extends typingsJapgolly.autolinker.distCommonjsMatchMod.HashtagMatch {
    /**
      * @method constructor
      * @param {Object} cfg The configuration properties for the Match
      *   instance, specified in an Object (map).
  ...
  /**
    ...
    */
  open class HtmlTag ()
    extends typingsJapgolly.autolinker.distCommonjsHtmlTagMod.HtmlTag {
  ...
  open class MentionMatch protected ()
    extends typingsJapgolly.autolinker.distCommonjsMatchMod.MentionMatch {
    /**
      * @method constructor
      * @param {Object} cfg The configuration properties for the Match
      *   instance, specified in an Object (map).
  ...
  open class PhoneMatch protected ()
    extends typingsJapgolly.autolinker.distCommonjsMatchMod.PhoneMatch {
    /**
      * @method constructor
      * @param {Object} cfg The configuration properties for the Match
      *   instance, specified in an Object (map).
  ...
  open class UrlMatch protected ()
    extends typingsJapgolly.autolinker.distCommonjsMatchMod.UrlMatch {
    /**
      * @method constructor
      * @param {Object} cfg The configuration properties for the Match
      *   instance, specified in an Object (map).
