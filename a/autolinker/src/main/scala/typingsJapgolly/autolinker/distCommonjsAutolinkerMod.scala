...
import typingsJapgolly.autolinker.autolinkerStrings.end
import typingsJapgolly.autolinker.autolinkerStrings.middle
import typingsJapgolly.autolinker.autolinkerStrings.smart
import typingsJapgolly.autolinker.distCommonjsHtmlTagMod.HtmlTag
...
object distCommonjsAutolinkerMod {
  ...
  */
  ...
  object HashtagConfig {
    ...
    inline def `false`: typingsJapgolly.autolinker.autolinkerBooleans.`false` = false.asInstanceOf[typingsJapgolly.autolinker.autolinkerBooleans.`false`]
