...
object distCommonjsRegexLibMod {
  
  @JSImport("autolinker/dist/commonjs/regex-lib", "alphaCharsAndMarksStr")
  @js.native
  val alphaCharsAndMarksStr: String = js.native
  
  @JSImport("autolinker/dist/commonjs/regex-lib", "alphaCharsStr")
  @js.native
  val alphaCharsStr: String = js.native
  
  @JSImport("autolinker/dist/commonjs/regex-lib", "alphaNumericAndMarksCharsStr")
  @js.native
  ...
  @js.native
  val decimalNumbersStr: String = js.native
