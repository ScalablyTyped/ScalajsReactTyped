...
object AutolinkerConfig {
  ...
  def apply(
    ...
    replaceFn: /* match */ Match => CallbackTo[ReplaceFnReturn] = null,
    ...
    if (replaceFn != null) __obj.updateDynamic("replaceFn")(js.Any.fromFunction1((t0: /* match */ typingsJapgolly.autolinker.matchMatchMod.Match) => replaceFn(t0).runNow()))
