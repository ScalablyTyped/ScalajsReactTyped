...
import typingsJapgolly.aliOss.anon.Acl
import typingsJapgolly.aliOss.anon.AllowEmpty
import typingsJapgolly.aliOss.anon.DataPutChannelConf
import typingsJapgolly.aliOss.anon.Enable
import typingsJapgolly.aliOss.anon.EndTime
import typingsJapgolly.aliOss.anon.Error
import typingsJapgolly.aliOss.anon.Etag
import typingsJapgolly.aliOss.anon.Name
import typingsJapgolly.aliOss.anon.ResRules
import typingsJapgolly.aliOss.anon.Rules
import typingsJapgolly.aliOss.anon.SourceBucketName
import typingsJapgolly.aliOss.anon.Status
import typingsJapgolly.aliOss.anon.Timeout
...
trait OSS extends StObject {
  ...
  /**
    * Create a new bucket.
    */
  def putBucket(name: String): js.Promise[typingsJapgolly.aliOss.anon.Bucket] = js.native
  def putBucket(name: String, options: PutBucketOptions): js.Promise[typingsJapgolly.aliOss.anon.Bucket] = js.native
