...
object distTypesResolveDefaultsModeConfigDotnativeMod {
  
  @JSImport("@aws-sdk/util-defaults-mode-browser/dist-types/resolveDefaultsModeConfig.native", JSImport.Namespace)
  @js.native
