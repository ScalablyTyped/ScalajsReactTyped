package typingsJapgolly.anyDbTransaction

import japgolly.scalajs.react.Callback
import typingsJapgolly.anyDb.mod.Adapter
import typingsJapgolly.anyDb.mod.Queryable
...
object mod {
  ...
  object TransactionOptions {
    ...
    extension [Self <: TransactionOptions](x: Self) {
      ...
      inline def setCallback(value: (/* error */ js.Error, /* transaction */ Transaction) => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* error */ js.Error, t1: /* transaction */ Transaction) => (value(t0, t1)).runNow()))
