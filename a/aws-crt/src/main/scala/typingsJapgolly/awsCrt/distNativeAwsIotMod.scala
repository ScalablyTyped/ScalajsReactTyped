...
import typingsJapgolly.awsCrt.distCommonAuthMod.WebsocketOptionsBase
import typingsJapgolly.awsCrt.distNativeAuthMod.AwsCredentialsProvider
import typingsJapgolly.awsCrt.distNativeHttpMod.HttpProxyOptions
import typingsJapgolly.awsCrt.distNativeIoMod.SocketOptions
import typingsJapgolly.awsCrt.distNativeIoMod.TlsContextOptions
...
import typingsJapgolly.awsCrt.distNativeMqttMod.MqttWill
