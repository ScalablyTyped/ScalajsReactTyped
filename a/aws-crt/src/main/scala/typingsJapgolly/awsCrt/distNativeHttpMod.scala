...
import typingsJapgolly.awsCrt.awsCrtStrings.close
import typingsJapgolly.awsCrt.awsCrtStrings.connect
import typingsJapgolly.awsCrt.awsCrtStrings.data
import typingsJapgolly.awsCrt.awsCrtStrings.end
import typingsJapgolly.awsCrt.awsCrtStrings.error
import typingsJapgolly.awsCrt.awsCrtStrings.headers
import typingsJapgolly.awsCrt.awsCrtStrings.response
import typingsJapgolly.awsCrt.distCommonEventMod.BufferedEventEmitter
import typingsJapgolly.awsCrt.distCommonHttpMod.CommonHttpProxyOptions
import typingsJapgolly.awsCrt.distCommonHttpMod.HttpClientConnectionClosed
import typingsJapgolly.awsCrt.distCommonHttpMod.HttpClientConnectionConnected
import typingsJapgolly.awsCrt.distCommonHttpMod.HttpClientConnectionError
...
import typingsJapgolly.awsCrt.distCommonHttpMod.HttpStreamComplete
import typingsJapgolly.awsCrt.distCommonHttpMod.HttpStreamData
import typingsJapgolly.awsCrt.distCommonHttpMod.HttpStreamError
import typingsJapgolly.awsCrt.distCommonResourceSafetyMod.ResourceSafe
...
object distNativeHttpMod {
  ...
  type HttpHeaders = typingsJapgolly.awsCrt.distNativeBindingMod.HttpHeaders
  ...
  open class HttpRequest protected ()
    extends typingsJapgolly.awsCrt.distNativeBindingMod.HttpRequest {
  ...
  type HttpStreamHeaders = js.Function1[/* headers */ typingsJapgolly.awsCrt.distNativeHttpMod.HttpHeaders, Unit]
  ...
  type nativeHttpRequest = typingsJapgolly.awsCrt.distNativeBindingMod.HttpRequest
}
