...
object distCommonAuthMod {
  ...
  object WebsocketOptionsBase {
    ...
    extension [Self <: WebsocketOptionsBase](x: Self) {
      ...
      inline def setCreate_signing_config(value: CallbackTo[AwsSigningConfigBase]): Self = StObject.set(x, "create_signing_config", value.toJsFn)
