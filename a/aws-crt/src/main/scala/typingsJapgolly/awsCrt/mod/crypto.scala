...
object crypto {
  ...
  @js.native
  open class Md5Hash ()
    extends typingsJapgolly.awsCrt.distNativeCryptoMod.Md5Hash
  
  @JSImport("aws-crt", "crypto.Sha1Hash")
  @js.native
  open class Sha1Hash ()
    extends typingsJapgolly.awsCrt.distNativeCryptoMod.Sha1Hash
  
  @JSImport("aws-crt", "crypto.Sha256Hash")
  @js.native
  open class Sha256Hash ()
    extends typingsJapgolly.awsCrt.distNativeCryptoMod.Sha256Hash
  
  @JSImport("aws-crt", "crypto.Sha256Hmac")
  @js.native
  open class Sha256Hmac protected ()
    extends typingsJapgolly.awsCrt.distNativeCryptoMod.Sha256Hmac {
