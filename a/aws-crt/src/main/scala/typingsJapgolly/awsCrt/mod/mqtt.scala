...
import typingsJapgolly.awsCrt.distNativeMqttMod.MqttConnectionConfig
...
object mqtt {
  ...
  open class HttpProxyOptions protected ()
    extends typingsJapgolly.awsCrt.distNativeMqttMod.HttpProxyOptions {
    /**
      *
  ...
  open class MqttClient ()
    extends typingsJapgolly.awsCrt.distNativeMqttMod.MqttClient {
  ...
  open class MqttClientConnection protected ()
    extends typingsJapgolly.awsCrt.distNativeMqttMod.MqttClientConnection {
    /**
      * @param client The client that owns this connection
      * @param config The configuration for this connection
      */
    def this(client: typingsJapgolly.awsCrt.distNativeMqttMod.MqttClient, config: MqttConnectionConfig) = this()
  }
  /* static members */
  ...
  open class MqttWill protected ()
    extends typingsJapgolly.awsCrt.distNativeMqttMod.MqttWill {
    def this(
