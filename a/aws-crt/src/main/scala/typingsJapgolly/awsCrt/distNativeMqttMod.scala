...
import typingsJapgolly.awsCrt.awsCrtStrings.connect
import typingsJapgolly.awsCrt.awsCrtStrings.disconnect
import typingsJapgolly.awsCrt.awsCrtStrings.error
import typingsJapgolly.awsCrt.awsCrtStrings.interrupt
import typingsJapgolly.awsCrt.awsCrtStrings.message
import typingsJapgolly.awsCrt.awsCrtStrings.resume
import typingsJapgolly.awsCrt.distCommonEventMod.BufferedEventEmitter
import typingsJapgolly.awsCrt.distCommonHttpMod.HttpProxyAuthenticationType
import typingsJapgolly.awsCrt.distCommonMqttMod.MqttConnectionConnected
import typingsJapgolly.awsCrt.distCommonMqttMod.MqttConnectionDisconnected
import typingsJapgolly.awsCrt.distCommonMqttMod.MqttConnectionResumed
import typingsJapgolly.awsCrt.distCommonMqttMod.MqttRequest
import typingsJapgolly.awsCrt.distCommonMqttMod.MqttSubscribeRequest
import typingsJapgolly.awsCrt.distCommonMqttMod.OnMessageCallback
import typingsJapgolly.awsCrt.distCommonMqttMod.Payload
import typingsJapgolly.awsCrt.distCommonMqttMod.QoS
import typingsJapgolly.awsCrt.distNativeErrorMod.CrtError
...
import typingsJapgolly.awsCrt.distNativeIoMod.ClientTlsContext
...
import typingsJapgolly.awsCrt.distNativeNativeResourceMod.NativeResource
...
object distNativeMqttMod {
  ...
  open class MqttWill protected ()
    extends typingsJapgolly.awsCrt.distCommonMqttMod.MqttWill {
    def this(
  ...
  object QoS extends StObject {
    ...
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[typingsJapgolly.awsCrt.distCommonMqttMod.QoS & Double] = js.native
    
    /* 1 */ val AtLeastOnce: typingsJapgolly.awsCrt.distCommonMqttMod.QoS.AtLeastOnce & Double = js.native
    
    /* 0 */ val AtMostOnce: typingsJapgolly.awsCrt.distCommonMqttMod.QoS.AtMostOnce & Double = js.native
    
    /* 2 */ val ExactlyOnce: typingsJapgolly.awsCrt.distCommonMqttMod.QoS.ExactlyOnce & Double = js.native
  }
  ...
  trait MqttConnectionConfig extends StObject {
    ...
    var proxy_options: js.UndefOr[typingsJapgolly.awsCrt.distNativeHttpMod.HttpProxyOptions] = js.undefined
    ...
    /**
      ...
      */
    var will: js.UndefOr[typingsJapgolly.awsCrt.distCommonMqttMod.MqttWill] = js.undefined
  }
  object MqttConnectionConfig {
    ...
    extension [Self <: MqttConnectionConfig](x: Self) {
      ...
      inline def setProxy_options(value: typingsJapgolly.awsCrt.distNativeHttpMod.HttpProxyOptions): Self = StObject.set(x, "proxy_options", value.asInstanceOf[js.Any])
      ...
      inline def setWebsocket_handshake_transform(
        value: (/* request */ HttpRequest, /* done */ js.Function1[/* error_code */ js.UndefOr[Double], Unit]) => Callback
      ): Self = StObject.set(x, "websocket_handshake_transform", js.Any.fromFunction2((t0: /* request */ HttpRequest, t1: /* done */ js.Function1[/* error_code */ js.UndefOr[Double], Unit]) => (value(t0, t1)).runNow()))
      
      inline def setWebsocket_handshake_transformUndefined: Self = StObject.set(x, "websocket_handshake_transform", js.undefined)
      
      inline def setWill(value: typingsJapgolly.awsCrt.distCommonMqttMod.MqttWill): Self = StObject.set(x, "will", value.asInstanceOf[js.Any])
