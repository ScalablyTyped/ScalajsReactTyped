package typingsJapgolly.amapJsApiGeocoder.AMap
...
import typingsJapgolly.amapJsApiGeocoder.AMap.Geocoder.BatchReGeocodeResult
import typingsJapgolly.amapJsApiGeocoder.AMap.Geocoder.GeocodeResult
import typingsJapgolly.amapJsApiGeocoder.AMap.Geocoder.ReGeocodeResult
import typingsJapgolly.amapJsApiGeocoder.AMap.Geocoder.SearchStatus
...
import typingsJapgolly.amapJsApiGeocoder.anon.Info
...
object Geocoder {
  ...
  trait EventMap extends StObject {
    ...
    var error: Event_[typingsJapgolly.amapJsApiGeocoder.amapJsApiGeocoderStrings.error, Info]
  }
  object EventMap {
  ...
  */
  ...
  object SearchStatus {
    ...
    inline def complete: typingsJapgolly.amapJsApiGeocoder.amapJsApiGeocoderStrings.complete = "complete".asInstanceOf[typingsJapgolly.amapJsApiGeocoder.amapJsApiGeocoderStrings.complete]
    
    inline def error: typingsJapgolly.amapJsApiGeocoder.amapJsApiGeocoderStrings.error = "error".asInstanceOf[typingsJapgolly.amapJsApiGeocoder.amapJsApiGeocoderStrings.error]
    
    inline def no_data: typingsJapgolly.amapJsApiGeocoder.amapJsApiGeocoderStrings.no_data = "no_data".asInstanceOf[typingsJapgolly.amapJsApiGeocoder.amapJsApiGeocoderStrings.no_data]
  }
}
