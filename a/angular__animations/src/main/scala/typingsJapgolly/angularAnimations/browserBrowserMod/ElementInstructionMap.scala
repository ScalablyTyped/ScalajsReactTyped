...
object ElementInstructionMap {
  ...
  def apply(
    ...
    __obj.updateDynamic("append")(js.Any.fromFunction2((t0: js.Any, t1: js.Array[typingsJapgolly.angularAnimations.browserBrowserMod.AnimationTimelineInstruction]) => append(t0, t1).runNow()))
