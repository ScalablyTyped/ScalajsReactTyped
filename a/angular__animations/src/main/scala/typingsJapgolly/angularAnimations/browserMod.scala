...
import typingsJapgolly.angularAnimations.angularAnimationsInts.`0`
import typingsJapgolly.angularAnimations.angularAnimationsInts.`1`
import typingsJapgolly.angularAnimations.mod.AnimationMetadata
import typingsJapgolly.angularAnimations.mod.AnimationOptions
import typingsJapgolly.angularAnimations.mod.AnimationPlayer
import typingsJapgolly.angularAnimations.mod.AnimationTriggerMetadata
import typingsJapgolly.angularAnimations.mod.ɵStyleData
import typingsJapgolly.angularAnimations.mod.ɵStyleDataMap
...
object browserMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.angularAnimations.angularAnimationsInts.`0`
    - typingsJapgolly.angularAnimations.angularAnimationsInts.`1`
  */
  ...
  object DOMAnimation {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(addEventListener = js.Any.fromFunction2(addEventListener), cancel = cancel.toJsFn, currentTime = currentTime.asInstanceOf[js.Any], dispatchEvent = js.Any.fromFunction1(dispatchEvent), finish = finish.toJsFn, onfinish = onfinish.asInstanceOf[js.Any], pause = pause.toJsFn, play = play.toJsFn, position = position.asInstanceOf[js.Any])
  ...
  object ElementInstructionMap {
    ...
    inline def apply(
      _map: Any,
      append: (Any, js.Array[AnimationTimelineInstruction]) => Callback,
      clear: Callback,
      get: Any => js.Array[AnimationTimelineInstruction],
      has: Any => Boolean
    ): ElementInstructionMap = {
      val __obj = js.Dynamic.literal(_map = _map.asInstanceOf[js.Any], append = js.Any.fromFunction2((t0: Any, t1: js.Array[AnimationTimelineInstruction]) => (append(t0, t1)).runNow()), clear = clear.toJsFn, get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has))
      __obj.asInstanceOf[ElementInstructionMap]
    }
    
    extension [Self <: ElementInstructionMap](x: Self) {
      
      inline def setAppend(value: (Any, js.Array[AnimationTimelineInstruction]) => Callback): Self = StObject.set(x, "append", js.Any.fromFunction2((t0: Any, t1: js.Array[AnimationTimelineInstruction]) => (value(t0, t1)).runNow()))
  ...
  object SpecialCasedStyles {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(_element = _element.asInstanceOf[js.Any], _endStyles = _endStyles.asInstanceOf[js.Any], _initialStyles = _initialStyles.asInstanceOf[js.Any], _startStyles = _startStyles.asInstanceOf[js.Any], _state = _state.asInstanceOf[js.Any], destroy = destroy.toJsFn, finish = finish.toJsFn, start = start.toJsFn)
