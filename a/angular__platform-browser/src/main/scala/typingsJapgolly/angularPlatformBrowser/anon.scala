...
import typingsJapgolly.angularCore.mod.ApplicationModule
...
import typingsJapgolly.angularPlatformBrowser.angularPlatformBrowserBooleans.`true`
import typingsJapgolly.angularPlatformBrowser.mod.BrowserModule
