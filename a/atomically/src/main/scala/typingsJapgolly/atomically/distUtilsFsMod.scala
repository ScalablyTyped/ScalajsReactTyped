package typingsJapgolly.atomically

import typingsJapgolly.atomically.anon.FnCall
import typingsJapgolly.atomically.anon.FnCallFdBufferOffsetLengthPosition
import typingsJapgolly.atomically.anon.FnCallPathFlagsMode
import typingsJapgolly.atomically.anon.FnCallPathOptions
import typingsJapgolly.atomically.anon.TypeofrealpathSync
import typingsJapgolly.atomically.distTypesMod.FN
...
object distUtilsFsMod {
  ...
  object default {
    ...
    inline def statSyncAttempt_Union(path: PathLike): js.UndefOr[Stats] = ^.asInstanceOf[js.Dynamic].applyDynamic("statSyncAttempt")(path.asInstanceOf[js.Any]).asInstanceOf[js.UndefOr[Stats]]
