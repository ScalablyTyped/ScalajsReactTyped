package typingsJapgolly.asymmetrikLeafletD3

import japgolly.scalajs.react.Callback
import typingsJapgolly.asymmetrikLeafletD3.leafletMod.internal.ObjectFn
...
object leafletMod {
  ...
  object HexbinHoverHandler {
    ...
    inline def apply(mouseout: (HexbinLayer_, Any) => Callback, mouseover: (HexbinLayer_, Any) => Callback): HexbinHoverHandler = {
      val __obj = js.Dynamic.literal(mouseout = js.Any.fromFunction2((t0: HexbinLayer_, t1: Any) => (mouseout(t0, t1)).runNow()), mouseover = js.Any.fromFunction2((t0: HexbinLayer_, t1: Any) => (mouseover(t0, t1)).runNow()))
    ...
    extension [Self <: HexbinHoverHandler](x: Self) {
      ...
      inline def setMouseout(value: (HexbinLayer_, Any) => Callback): Self = StObject.set(x, "mouseout", js.Any.fromFunction2((t0: HexbinLayer_, t1: Any) => (value(t0, t1)).runNow()))
      
      inline def setMouseover(value: (HexbinLayer_, Any) => Callback): Self = StObject.set(x, "mouseover", js.Any.fromFunction2((t0: HexbinLayer_, t1: Any) => (value(t0, t1)).runNow()))
    }
