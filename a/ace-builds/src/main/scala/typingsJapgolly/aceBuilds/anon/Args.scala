...
trait Args extends StObject {
  ...
  var command: typingsJapgolly.aceBuilds.mod.Ace.Command
  
  var editor: Editor
}
object Args {
  
  inline def apply(args: js.Array[Any], command: typingsJapgolly.aceBuilds.mod.Ace.Command, editor: Editor): Args = {
  ...
  extension [Self <: Args](x: Self) {
    ...
    inline def setCommand(value: typingsJapgolly.aceBuilds.mod.Ace.Command): Self = StObject.set(x, "command", value.asInstanceOf[js.Any])
