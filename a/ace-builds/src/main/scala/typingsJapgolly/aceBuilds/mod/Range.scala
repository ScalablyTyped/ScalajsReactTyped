...
open class Range protected ()
  extends StObject
     with typingsJapgolly.aceBuilds.mod.Ace.Range {
  def this(startRow: Double, startColumn: Double, endRow: Double, endColumn: Double) = this()
  
  /* CompleteClass */
  override def clipRows(firstRow: Double, lastRow: Double): typingsJapgolly.aceBuilds.mod.Ace.Range = js.native
  
  /* CompleteClass */
  override def collapseRows(): typingsJapgolly.aceBuilds.mod.Ace.Range = js.native
  ...
  /* CompleteClass */
  override def compareRange(range: typingsJapgolly.aceBuilds.mod.Ace.Range): Double = js.native
  ...
  /* CompleteClass */
  override def containsRange(range: typingsJapgolly.aceBuilds.mod.Ace.Range): Boolean = js.native
  
  /* CompleteClass */
  var end: Point = js.native
  
  /* CompleteClass */
  override def extend(row: Double, column: Double): typingsJapgolly.aceBuilds.mod.Ace.Range = js.native
  ...
  /* CompleteClass */
  override def intersects(range: typingsJapgolly.aceBuilds.mod.Ace.Range): Boolean = js.native
  ...
  /* CompleteClass */
  override def isEqual(range: typingsJapgolly.aceBuilds.mod.Ace.Range): Boolean = js.native
  ...
  /* CompleteClass */
  override def toScreenRange(session: typingsJapgolly.aceBuilds.mod.Ace.EditSession): typingsJapgolly.aceBuilds.mod.Ace.Range = js.native
}
object Range {
  ...
  inline def fromPoints(start: Point, end: Point): typingsJapgolly.aceBuilds.mod.Ace.Range = (^.asInstanceOf[js.Dynamic].applyDynamic("fromPoints")(start.asInstanceOf[js.Any], end.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.aceBuilds.mod.Ace.Range]
}
