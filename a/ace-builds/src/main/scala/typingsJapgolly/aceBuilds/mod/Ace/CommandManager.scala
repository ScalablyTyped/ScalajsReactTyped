...
import typingsJapgolly.aceBuilds.aceBuildsStrings.afterExec
import typingsJapgolly.aceBuilds.aceBuildsStrings.exec
import typingsJapgolly.aceBuilds.anon.HashId
...
trait CommandManager
  ...
  def handleKeyboard(data: js.Object, hashId: Double, keyString: String, keyCode: String): Unit | typingsJapgolly.aceBuilds.anon.Command = js.native
  def handleKeyboard(data: js.Object, hashId: Double, keyString: String, keyCode: Double): Unit | typingsJapgolly.aceBuilds.anon.Command = js.native
