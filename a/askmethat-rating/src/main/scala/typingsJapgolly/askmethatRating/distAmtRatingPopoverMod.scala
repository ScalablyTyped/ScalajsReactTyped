...
object distAmtRatingPopoverMod {
  ...
  object AskmethatRatingPopoverDirection extends StObject {
    ...
    /* 1 */ val bottom: typingsJapgolly.askmethatRating.distAmtRatingPopoverMod.AskmethatRatingPopoverDirection.bottom & Double = js.native
    
    @js.native
    sealed trait top
      extends StObject
         with AskmethatRatingPopoverDirection
    /* 0 */ val top: typingsJapgolly.askmethatRating.distAmtRatingPopoverMod.AskmethatRatingPopoverDirection.top & Double = js.native
  }
