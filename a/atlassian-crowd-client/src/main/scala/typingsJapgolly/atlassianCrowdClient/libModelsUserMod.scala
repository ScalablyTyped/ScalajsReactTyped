...
import typingsJapgolly.atlassianCrowdClient.anon.Value
...
object libModelsUserMod {
  ...
  object User {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(active = active.asInstanceOf[js.Any], attributes = attributes.asInstanceOf[js.Any], displayname = displayname.asInstanceOf[js.Any], email = email.asInstanceOf[js.Any], firstname = firstname.asInstanceOf[js.Any], lastname = lastname.asInstanceOf[js.Any], toCrowd = toCrowd.toJsFn, username = username.asInstanceOf[js.Any])
    ...
    extension [Self <: User](x: Self) {
      ...
      inline def setToCrowd(value: CallbackTo[UserObj]): Self = StObject.set(x, "toCrowd", value.toJsFn)
