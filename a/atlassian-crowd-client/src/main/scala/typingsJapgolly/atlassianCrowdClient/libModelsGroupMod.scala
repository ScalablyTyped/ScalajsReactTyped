...
import typingsJapgolly.atlassianCrowdClient.anon.Active
import typingsJapgolly.atlassianCrowdClient.atlassianCrowdClientStrings.GROUP
...
object libModelsGroupMod {
  ...
  object Group {
    ...
    inline def apply(active: Boolean, description: String, groupname: String, toCrowd: CallbackTo[GroupObj]): Group = {
      val __obj = js.Dynamic.literal(active = active.asInstanceOf[js.Any], description = description.asInstanceOf[js.Any], groupname = groupname.asInstanceOf[js.Any], toCrowd = toCrowd.toJsFn)
    ...
    extension [Self <: Group](x: Self) {
      ...
      inline def setToCrowd(value: CallbackTo[GroupObj]): Self = StObject.set(x, "toCrowd", value.toJsFn)
    }
  }
