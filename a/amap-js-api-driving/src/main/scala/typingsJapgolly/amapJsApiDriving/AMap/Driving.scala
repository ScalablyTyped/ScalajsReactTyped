package typingsJapgolly.amapJsApiDriving.AMap
...
import typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchOptions
import typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchPoint
import typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchResultBase
import typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchResultExt
import typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchStatus
import typingsJapgolly.amapJsApiDriving.amapJsApiDrivingInts.`0`
import typingsJapgolly.amapJsApiDriving.amapJsApiDrivingInts.`1`
import typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.all
import typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.base
...
import typingsJapgolly.amapJsApiDriving.anon.Destination
import typingsJapgolly.amapJsApiDriving.anon.Info
import typingsJapgolly.amapJsApiDriving.anon.IsWaypoint
import typingsJapgolly.amapJsApiDriving.anon.PoiisWaypointboolean
...
object Driving {
  ...
  trait EventMap extends StObject {
    ...
    var error: Event_[typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.error, Info]
  }
  object EventMap {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchResultBase
    - typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchResultExt
  */
  ...
  object SearchResult {
    ...
    inline def SearchResultBase(
      ...
      __obj.asInstanceOf[typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchResultBase]
    }
    ...
    inline def SearchResultExt(
      ...
      __obj.asInstanceOf[typingsJapgolly.amapJsApiDriving.AMap.Driving.SearchResultExt]
    }
  }
  ...
  */
  ...
  object SearchStatus {
    ...
    inline def complete: typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.complete = "complete".asInstanceOf[typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.complete]
    
    inline def error: typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.error = "error".asInstanceOf[typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.error]
    
    inline def no_data: typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.no_data = "no_data".asInstanceOf[typingsJapgolly.amapJsApiDriving.amapJsApiDrivingStrings.no_data]
  }
