...
import typingsJapgolly.aliApp.anon.Index
import typingsJapgolly.aliApp.anon.PartialBadge
...
object ActionSheetOptions {
  ...
  extension [Self <: ActionSheetOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ Index => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ Index) => value(t0).runNow()))
