...
import typingsJapgolly.aliApp.anon.AuthCode
...
object GetAuthCodeOptions {
  ...
  extension [Self <: GetAuthCodeOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ AuthCode => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ AuthCode) => value(t0).runNow()))
