...
object ComponentRelation {
  ...
  extension [Self <: ComponentRelation](x: Self) {
    ...
    inline def setLinkChanged(value: /* target */ Component => Callback): Self = StObject.set(x, "linkChanged", js.Any.fromFunction1((t0: /* target */ Component) => value(t0).runNow()))
    
    inline def setLinkChangedUndefined: Self = StObject.set(x, "linkChanged", js.undefined)
    
    inline def setLinked(value: /* target */ Component => Callback): Self = StObject.set(x, "linked", js.Any.fromFunction1((t0: /* target */ Component) => value(t0).runNow()))
    ...
    inline def setUnlinked(value: /* target */ Component => Callback): Self = StObject.set(x, "unlinked", js.Any.fromFunction1((t0: /* target */ Component) => value(t0).runNow()))
