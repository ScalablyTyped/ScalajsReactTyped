...
import typingsJapgolly.aliApp.aliAppStrings.develop
import typingsJapgolly.aliApp.aliAppStrings.release
import typingsJapgolly.aliApp.aliAppStrings.trial
