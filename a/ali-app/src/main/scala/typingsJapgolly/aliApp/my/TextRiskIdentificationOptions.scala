...
import typingsJapgolly.aliApp.anon.Fail
...
object TextRiskIdentificationOptions {
  ...
  extension [Self <: TextRiskIdentificationOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ Fail => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ Fail) => value(t0).runNow()))
