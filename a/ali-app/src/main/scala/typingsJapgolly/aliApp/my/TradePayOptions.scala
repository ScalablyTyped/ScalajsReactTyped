...
import typingsJapgolly.aliApp.anon.ResultCode
...
object TradePayOptions {
  ...
  extension [Self <: TradePayOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ ResultCode => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ ResultCode) => value(t0).runNow()))
