...
import typingsJapgolly.aliApp.AnonResultStatus
import typingsJapgolly.aliApp.aliAppStrings.TINYAPP
import typingsJapgolly.aliApp.aliAppStrings.WINDOWS
import typingsJapgolly.aliApp.aliAppStrings.alipay
import typingsJapgolly.aliApp.aliAppStrings.merchant
...
object ZMCreditBorrowOptions {
  ...
  def apply(
    ...
    success: /* res */ AnonResultStatus => Callback = null
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* res */ typingsJapgolly.aliApp.AnonResultStatus) => success(t0).runNow()))
