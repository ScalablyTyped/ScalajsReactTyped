...
import typingsJapgolly.aliApp.anon.ResultStatus
...
object ZMCreditBorrowOptions {
  ...
  extension [Self <: ZMCreditBorrowOptions](x: Self) {
    ...
    inline def setSuccess(value: /* res */ ResultStatus => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* res */ ResultStatus) => value(t0).runNow()))
