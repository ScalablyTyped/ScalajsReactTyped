...
object GetLocationOptions {
  ...
  inline def apply(cacheTimeout: Double, success: LocationData => Callback, `type`: `0` | `1` | `2` | `3`): GetLocationOptions = {
    val __obj = js.Dynamic.literal(cacheTimeout = cacheTimeout.asInstanceOf[js.Any], success = js.Any.fromFunction1((t0: LocationData) => success(t0).runNow()))
