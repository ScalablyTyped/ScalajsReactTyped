...
import typingsJapgolly.antvUtil.libLodashGetRangeMod.RangeType
import typingsJapgolly.antvUtil.libLodashGroupByMod.ObjectType
import typingsJapgolly.antvUtil.libLodashParseRadiusMod.RadiusType
import typingsJapgolly.antvUtil.libLodashThrottleMod.OptionsType
...
import typingsJapgolly.antvUtil.libPathTypesMod.NormalArray
...
object mod {
  ...
  @js.native
  open class Cache[T] ()
    extends typingsJapgolly.antvUtil.libLodashMod.Cache[T]
  ...
  inline def omit[T](obj: typingsJapgolly.antvUtil.libLodashTypesMod.ObjectType[T], keys: js.Array[String]): typingsJapgolly.antvUtil.libLodashTypesMod.ObjectType[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("omit")(obj.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.antvUtil.libLodashTypesMod.ObjectType[T]]
  ...
  inline def pick[T](`object`: typingsJapgolly.antvUtil.libLodashPickMod.ObjectType[T], keys: js.Array[String]): typingsJapgolly.antvUtil.libLodashPickMod.ObjectType[T] = (^.asInstanceOf[js.Dynamic].applyDynamic("pick")(`object`.asInstanceOf[js.Any], keys.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.antvUtil.libLodashPickMod.ObjectType[T]]
  ...
  inline def reduce[T, G](
    arr: typingsJapgolly.antvUtil.libLodashTypesMod.ObjectType[T],
    fn: js.Function3[/* result */ T, /* data */ G, /* idx */ String | Double, T],
    init: T
  ): T = (^.asInstanceOf[js.Dynamic].applyDynamic("reduce")(arr.asInstanceOf[js.Any], fn.asInstanceOf[js.Any], init.asInstanceOf[js.Any])).asInstanceOf[T]
  ...
  inline def sortBy[T](arr: js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]], key: String): js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("sortBy")(arr.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]]]
  inline def sortBy[T](arr: js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]], key: js.Array[String]): js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("sortBy")(arr.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]]]
  inline def sortBy[T](arr: js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]], key: js.Function): js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]] = (^.asInstanceOf[js.Dynamic].applyDynamic("sortBy")(arr.asInstanceOf[js.Any], key.asInstanceOf[js.Any])).asInstanceOf[js.Array[typingsJapgolly.antvUtil.libLodashSortByMod.ObjectType[T]]]
  ...
  inline def substitute[T](str: String, o: typingsJapgolly.antvUtil.libLodashSubstituteMod.ObjectType[T]): String = (^.asInstanceOf[js.Dynamic].applyDynamic("substitute")(str.asInstanceOf[js.Any], o.asInstanceOf[js.Any])).asInstanceOf[String]
