...
import typingsJapgolly.awsSdkConfigResolver.distTypesRegionInfoPartitionHashMod.PartitionHash
import typingsJapgolly.awsSdkConfigResolver.distTypesRegionInfoRegionHashMod.RegionHash
