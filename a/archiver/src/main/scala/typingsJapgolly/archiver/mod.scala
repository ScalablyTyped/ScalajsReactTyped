...
import typingsJapgolly.archiver.anon.PartialEntryData
import typingsJapgolly.archiver.anon.Processed
import typingsJapgolly.archiver.anon.ProcessedBytes
...
object mod {
  ...
  */
  ...
  object Format {
    ...
    inline def tar: typingsJapgolly.archiver.archiverStrings.tar = "tar".asInstanceOf[typingsJapgolly.archiver.archiverStrings.tar]
    
    inline def zip: typingsJapgolly.archiver.archiverStrings.zip = "zip".asInstanceOf[typingsJapgolly.archiver.archiverStrings.zip]
  }
