...
object libUseInfiniteScrollTypesMod {
  ...
  object InfiniteScrollOptions {
    ...
    extension [Self <: InfiniteScrollOptions[?], TData /* <: Data */](x: Self & InfiniteScrollOptions[TData]) {
      ...
      inline def setOnBefore(value: Callback): Self = StObject.set(x, "onBefore", value.toJsFn)
      
      inline def setOnBeforeUndefined: Self = StObject.set(x, "onBefore", js.undefined)
      
      inline def setOnError(value: /* e */ js.Error => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* e */ js.Error) => value(t0).runNow()))
      
      inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
      
      inline def setOnFinally(value: (/* data */ js.UndefOr[TData], /* e */ js.UndefOr[js.Error]) => Callback): Self = StObject.set(x, "onFinally", js.Any.fromFunction2((t0: /* data */ js.UndefOr[TData], t1: /* e */ js.UndefOr[js.Error]) => (value(t0, t1)).runNow()))
      ...
      inline def setTargetCallbackTo(value: CallbackTo[TargetValue[Element | Document]]): Self = StObject.set(x, "target", value.toJsFn)
