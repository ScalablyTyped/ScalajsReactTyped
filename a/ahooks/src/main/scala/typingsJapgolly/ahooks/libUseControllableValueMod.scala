...
object libUseControllableValueMod {
  ...
  object StandardProps {
    ...
    inline def apply[T](onChange: T => Callback, value: T): StandardProps[T] = {
      val __obj = js.Dynamic.literal(onChange = js.Any.fromFunction1((t0: T) => onChange(t0).runNow()), value = value.asInstanceOf[js.Any])
