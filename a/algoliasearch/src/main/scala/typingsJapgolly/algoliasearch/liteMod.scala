...
import typingsJapgolly.algoliasearch.mod.BrowseParameters
import typingsJapgolly.algoliasearch.mod.BrowseResponse
import typingsJapgolly.algoliasearch.mod.ClientOptions
import typingsJapgolly.algoliasearch.mod.MultiResponse
import typingsJapgolly.algoliasearch.mod.QueryParameters
import typingsJapgolly.algoliasearch.mod.SearchForFacetValues.Parameters
import typingsJapgolly.algoliasearch.mod.SearchForFacetValues.Response
...
object liteMod extends js.Object {
  ...
  trait Index extends js.Object {
    ...
    /**
      ...
      */
    def search[T](params: QueryParameters): js.Promise[typingsJapgolly.algoliasearch.mod.Response[T]] = js.native
    /**
      * Search in an index
      * https://github.com/algolia/algoliasearch-client-js#search-in-an-index---search
      */
    def search[T](
      ...
      cb: js.Function2[/* err */ js.Error, /* res */ typingsJapgolly.algoliasearch.mod.Response[T], Unit]
    ): Unit = js.native
    /**
      * Search in an index
