...
import typingsJapgolly.algoliasearch.AnonForwardToReplicas
import typingsJapgolly.algoliasearch.AnonResults
...
trait Index extends js.Object {
  ...
  /**
    * Search in an index
    */
  def searchForFacetValues(options: Parameters): js.Promise[typingsJapgolly.algoliasearch.mod.SearchForFacetValues.Response] = js.native
  /**
    * Search in an index
    */
  def searchForFacetValues(
    ...
    cb: js.Function2[
      /* err */ js.Error, 
      /* res */ typingsJapgolly.algoliasearch.mod.SearchForFacetValues.Response, 
      Unit
    ]
  ): Unit = js.native
  /**
