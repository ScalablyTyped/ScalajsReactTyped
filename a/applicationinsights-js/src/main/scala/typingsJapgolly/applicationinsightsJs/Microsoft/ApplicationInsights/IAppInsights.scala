...
trait IAppInsights extends js.Object {
  ...
  /**
    ...
    */
  def trackException(exception: js.Error): js.Any = js.native
  def trackException(exception: js.Error, handledAt: String): js.Any = js.native
  def trackException(exception: js.Error, handledAt: String, properties: StringDictionary[String]): js.Any = js.native
  def trackException(
    exception: js.Error,
    handledAt: String,
    properties: StringDictionary[String],
