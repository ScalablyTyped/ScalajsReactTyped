...
open class UntypedFormBuilder () extends FormBuilder {
  ...
  /**
    ...
    */
  def group(controlsConfig: StringDictionary[Any]): typingsJapgolly.angularForms.mod.UntypedFormGroup = js.native
  def group(controlsConfig: StringDictionary[Any], options: AbstractControlOptions): typingsJapgolly.angularForms.mod.UntypedFormGroup = js.native
}
/* static members */
