...
- typingsJapgolly.angularForms.mod.ControlValueAccessor because var conflicts: setDisabledState. Inlined writeValue */ @JSImport("@angular/forms", "RadioControlValueAccessor")
@js.native
...
object RadioControlValueAccessor {
  ...
  def ɵdir: ɵɵDirectiveDeclaration[
    ...
    scala.Nothing, 
    typingsJapgolly.angularForms.anon.FormControlName, 
    js.Object, 
    scala.Nothing, 
    scala.Nothing, 
    `false`
