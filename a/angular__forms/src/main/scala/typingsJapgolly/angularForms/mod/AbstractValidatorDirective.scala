...
object AbstractValidatorDirective {
  ...
  extension [Self <: AbstractValidatorDirective](x: Self) {
    ...
    inline def setRegisterOnValidatorChange(value: js.Function0[Unit] => Callback): Self = StObject.set(x, "registerOnValidatorChange", js.Any.fromFunction1((t0: js.Function0[Unit]) => value(t0).runNow()))
