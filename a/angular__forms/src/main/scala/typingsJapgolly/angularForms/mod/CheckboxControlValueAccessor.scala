...
- typingsJapgolly.angularForms.mod.ControlValueAccessor because var conflicts: setDisabledState. Inlined writeValue */ @JSImport("@angular/forms", "CheckboxControlValueAccessor")
@js.native
open class CheckboxControlValueAccessor ()
  extends StObject
...
/* static members */
object CheckboxControlValueAccessor {
  
  @JSImport("@angular/forms", "CheckboxControlValueAccessor")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@angular/forms", "CheckboxControlValueAccessor.\u0275dir")
  @js.native
  ...
  @JSImport("@angular/forms", "CheckboxControlValueAccessor.\u0275fac")
  @js.native
  def ɵfac: ɵɵFactoryDeclaration[CheckboxControlValueAccessor, scala.Nothing] = js.native
  inline def ɵfac_=(x: ɵɵFactoryDeclaration[CheckboxControlValueAccessor, scala.Nothing]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("\u0275fac")(x.asInstanceOf[js.Any])
}
