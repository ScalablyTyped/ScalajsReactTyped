...
import typingsJapgolly.atAngularCore.atAngularCoreMod.AfterViewInit
import typingsJapgolly.atAngularCore.atAngularCoreMod.EventEmitter
import typingsJapgolly.atAngularForms.Anon_UpdateOn
...
class NgForm protected ()
  ...
  /**
    ...
    *
    */
  var options: Anon_UpdateOn = js.native
  /**
    * @description
