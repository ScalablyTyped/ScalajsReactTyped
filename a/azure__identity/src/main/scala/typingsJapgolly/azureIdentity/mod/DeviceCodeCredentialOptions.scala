...
object DeviceCodeCredentialOptions {
  ...
  extension [Self <: DeviceCodeCredentialOptions](x: Self) {
    ...
    inline def setUserPromptCallback(value: /* deviceCodeInfo */ DeviceCodeInfo => Callback): Self = StObject.set(x, "userPromptCallback", js.Any.fromFunction1((t0: /* deviceCodeInfo */ DeviceCodeInfo) => value(t0).runNow()))
