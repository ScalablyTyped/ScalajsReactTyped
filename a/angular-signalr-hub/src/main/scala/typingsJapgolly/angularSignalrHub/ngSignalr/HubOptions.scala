...
object HubOptions {
  @scala.inline
  def apply(
    errorHandler: /* error */ String => Callback = null,
    ...
    stateChanged: /* state */ StateChanged => Callback = null,
    transport: js.Any = null,
    useSharedConnection: js.UndefOr[Boolean] = js.undefined
  ): HubOptions = {
    val __obj = js.Dynamic.literal()
    if (errorHandler != null) __obj.updateDynamic("errorHandler")(js.Any.fromFunction1((t0: /* error */ java.lang.String) => errorHandler(t0).runNow()))
    ...
    if (stateChanged != null) __obj.updateDynamic("stateChanged")(js.Any.fromFunction1((t0: /* state */ typingsJapgolly.signalr.SignalR.StateChanged) => stateChanged(t0).runNow()))
