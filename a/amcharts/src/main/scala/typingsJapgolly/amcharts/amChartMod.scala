...
import typingsJapgolly.amcharts.anon.Type
...
object amChartMod {
  ...
  trait AmChart extends StObject {
    ...
    /**
      ...
      */
    def addLegend(legend: typingsJapgolly.amcharts.amLegendMod.default): Unit = js.native
    def addLegend(legend: typingsJapgolly.amcharts.amLegendMod.default, legendDivId: String): Unit = js.native
    /**
      * Adds a legend to the chart.
      * By default, you don't need to create div for your legend,
      * however if you want it to be positioned in some different way,
      ...
      */
    def addLegend(legend: typingsJapgolly.amcharts.amLegendMod.default, legendDiv: HTMLElement): Unit = js.native
    ...
    /**
      ...
      * }
      */
    var allLabels: js.Array[typingsJapgolly.amcharts.labelMod.default] = js.native
    ...
    /**
      ...
      */
    var `export`: typingsJapgolly.amcharts.exportSettingsMod.default = js.native
    ...
    /**
      * Legend of a chart.
      */
    var legend: typingsJapgolly.amcharts.amLegendMod.default = js.native
    ...
    /**
      ...
      */
    var titles: js.Array[typingsJapgolly.amcharts.titleMod.default] = js.native
