...
import typingsJapgolly.amcharts.categoryAxisMod.default
...
class ChartScrollbar ()
  extends typingsJapgolly.amcharts.chartScrollbarMod.ChartScrollbar {
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var graph: typingsJapgolly.amcharts.amGraphMod.default = js.native
  /**
