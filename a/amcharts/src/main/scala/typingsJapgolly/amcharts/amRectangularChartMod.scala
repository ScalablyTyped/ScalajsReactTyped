...
object amRectangularChartMod {
  ...
  trait AmRectangularChart
    ...
    /**
      ...
      */
    def addChartCursor(cursor: typingsJapgolly.amcharts.chartCursorMod.default): Unit = js.native
    
    /**
      * Adds a ChartScrollbar to a chart
      */
    def addChartScrollbar(scrollbar: typingsJapgolly.amcharts.chartScrollbarMod.default): Unit = js.native
    ...
    /**
      ...
      */
    def addTrendLine(trendLine: typingsJapgolly.amcharts.trendLineMod.default): Unit = js.native
    ...
    /**
      * Cursor of a chart.
      */
    var chartCursor: typingsJapgolly.amcharts.chartCursorMod.default = js.native
    
    /**
      * Chart scrollbar.
      */
    var chartScrollbar: typingsJapgolly.amcharts.chartScrollbarMod.default = js.native
    ...
    /**
      ...
      */
    def removeTrendLine(trendLine: typingsJapgolly.amcharts.trendLineMod.default): Unit = js.native
    ...
    /**
      ...
      */
    var trendLines: js.Array[typingsJapgolly.amcharts.trendLineMod.default] = js.native
