package typingsJapgolly.amcharts.stockEventMod
...
trait StockEvent extends js.Object {
  ...
  /**
    ...
    */
  var graph: typingsJapgolly.amcharts.stockGraphMod.default
  /**
...
object StockEvent {
  ...
  def apply(
    ...
    color: String,
    date: js.Date,
    graph: typingsJapgolly.amcharts.stockGraphMod.default,
