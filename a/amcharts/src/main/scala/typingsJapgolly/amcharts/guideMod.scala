...
object guideMod {
  ...
  trait Guide extends StObject {
    ...
    /**
      ...
      * you might need to specify which which value axis should be used.
      */
    var valueAxis: typingsJapgolly.amcharts.valueAxisMod.default
  }
  object Guide {
    ...
    inline def apply(
      ...
      toValue: Double,
      value: Double,
      valueAxis: typingsJapgolly.amcharts.valueAxisMod.default
    ): Guide = {
    ...
    extension [Self <: Guide](x: Self) {
      ...
      inline def setValueAxis(value: typingsJapgolly.amcharts.valueAxisMod.default): Self = StObject.set(x, "valueAxis", value.asInstanceOf[js.Any])
    }
  }
}
