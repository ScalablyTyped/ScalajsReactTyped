...
import typingsJapgolly.amcharts.anon.Delta2X
...
object chartCursorMod {
  ...
  trait ChartCursor extends StObject {
    ...
    /**
      ...
      */
    def removeListener(chart: typingsJapgolly.amcharts.amChartMod.default, `type`: String, handler: Any): Unit = js.native
