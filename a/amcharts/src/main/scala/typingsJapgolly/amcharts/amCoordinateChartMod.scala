...
object amCoordinateChartMod extends js.Object {
  ...
  trait AmCoordinateChart
    ...
    /**
      ...
      */
    var graphs: js.Array[typingsJapgolly.amcharts.amGraphMod.default] = js.native
    /**
    ...
    /**
      ...
      */
    var guides: js.Array[typingsJapgolly.amcharts.guideMod.default] = js.native
    /**
    ...
    /**
      ...
      */
    def addGraph(graph: typingsJapgolly.amcharts.amGraphMod.default): Unit = js.native
    /**
      ...
      */
    def addValueAxis(axis: typingsJapgolly.amcharts.valueAxisMod.default): Unit = js.native
    /**
    ...
    /**
      ...
      */
    def getGraphById(graphId: String): typingsJapgolly.amcharts.amGraphMod.default = js.native
    /**
      * Returns value axis by id.
      */
    def getValueAxisById(axisId: String): typingsJapgolly.amcharts.valueAxisMod.default = js.native
    /**
      * Hide the graph (if it is visible).
      * Usually this method is called from the Legend, when you click on the legend marker.
      */
    def hideGraph(graph: typingsJapgolly.amcharts.amGraphMod.default): Unit = js.native
    /**
      * Hide value balloon of a graph.
      * Usually this method is called from the Legend, when you click on the legend text.
      */
    def hideGraphsBalloon(graph: typingsJapgolly.amcharts.amGraphMod.default): Unit = js.native
    /**
      * Highlight the graph. Usually this method is called from the Legend, when you roll-over the legend entry.
      */
    def highlightGraph(graph: typingsJapgolly.amcharts.amGraphMod.default): Unit = js.native
    /**
      * Removes graph from the chart.
      */
    def removeGraph(graph: typingsJapgolly.amcharts.amGraphMod.default): Unit = js.native
    /**
      * Removes value axis from the chart.
      * When you remove value axis, all graphs assigned to this axis are also removed.
      */
    def removeValueAxis(axis: typingsJapgolly.amcharts.valueAxisMod.default): Unit = js.native
    /**
      * Show the graph (if it is hidden).
      * Usually this method is called from the Legend, when you click on the legend marker.
      */
    def showGraph(graph: typingsJapgolly.amcharts.amGraphMod.default): Unit = js.native
    /**
      * Show value balloon of a graph.
      * Usually this method is called from the Legend, when you click on the legend text.
      */
    def showGraphsBalloon(graph: typingsJapgolly.amcharts.amGraphMod.default): Unit = js.native
    /**
      * UnhighlightGraph the graph.
      * Usually this method is called from the Legend, when you roll-out the legend entry.
      */
    def unhighlightGraph(graph: typingsJapgolly.amcharts.amGraphMod.default): Unit = js.native
  }
