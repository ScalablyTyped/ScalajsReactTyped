...
object axisBaseMod {
  ...
  trait AxisBase extends StObject {
    ...
    /**
      * Adds guide to the axis.
      */
    def addGuide(guide: typingsJapgolly.amcharts.guideMod.default): Unit
    ...
    /**
      * Removes guide from the axis.
      */
    def removeGuide(guide: typingsJapgolly.amcharts.guideMod.default): Unit
  ...
  object AxisBase {
    ...
    extension [Self <: AxisBase](x: Self) {
      ...
      inline def setRemoveGuide(value: typingsJapgolly.amcharts.guideMod.default => Callback): Self = StObject.set(x, "removeGuide", js.Any.fromFunction1((t0: typingsJapgolly.amcharts.guideMod.default) => value(t0).runNow()))
