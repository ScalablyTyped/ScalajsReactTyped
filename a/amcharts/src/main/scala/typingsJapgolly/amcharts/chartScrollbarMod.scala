...
object chartScrollbarMod {
  ...
  open class default ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    var categoryAxis: typingsJapgolly.amcharts.categoryAxisMod.default = js.native
  ...
  object ChartScrollbar {
    ...
    extension [Self <: ChartScrollbar](x: Self) {
      ...
      inline def setCategoryAxis(value: typingsJapgolly.amcharts.categoryAxisMod.default): Self = StObject.set(x, "categoryAxis", value.asInstanceOf[js.Any])
