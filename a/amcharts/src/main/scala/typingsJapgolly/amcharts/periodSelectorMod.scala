...
import typingsJapgolly.amcharts.anon.Count
...
object periodSelectorMod {
  ...
  object PeriodSelector {
    ...
    inline def apply(
      addListener: (String, js.Function1[/* e */ Count, Unit]) => Callback,
      dateFormat: String,
      fromText: String,
      ...
      val __obj = js.Dynamic.literal(addListener = js.Any.fromFunction2((t0: String, t1: js.Function1[/* e */ Count, Unit]) => (addListener(t0, t1)).runNow()), dateFormat = dateFormat.asInstanceOf[js.Any], fromText = fromText.asInstanceOf[js.Any], hideOutOfScopePeriods = hideOutOfScopePeriods.asInstanceOf[js.Any], inputFieldWidth = inputFieldWidth.asInstanceOf[js.Any], inputFieldsEnabled = inputFieldsEnabled.asInstanceOf[js.Any], periods = periods.asInstanceOf[js.Any], periodsText = periodsText.asInstanceOf[js.Any], position = position.asInstanceOf[js.Any], removeListener = js.Any.fromFunction3((t0: typingsJapgolly.amcharts.amChartMod.default, t1: String, t2: Any) => (removeListener(t0, t1, t2)).runNow()), selectFromStart = selectFromStart.asInstanceOf[js.Any], toText = toText.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
      __obj.asInstanceOf[PeriodSelector]
    }
    
    extension [Self <: PeriodSelector](x: Self) {
      
      inline def setAddListener(value: (String, js.Function1[/* e */ Count, Unit]) => Callback): Self = StObject.set(x, "addListener", js.Any.fromFunction2((t0: String, t1: js.Function1[/* e */ Count, Unit]) => (value(t0, t1)).runNow()))
