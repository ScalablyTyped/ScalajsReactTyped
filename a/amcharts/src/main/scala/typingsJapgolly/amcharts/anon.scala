...
object anon {
  ...
  object ChartDataItem {
    ...
    inline def apply(chart: default, dataItem: typingsJapgolly.amcharts.sliceMod.default, `type`: String): ChartDataItem = {
    ...
    extension [Self <: ChartDataItem](x: Self) {
      ...
      inline def setDataItem(value: typingsJapgolly.amcharts.sliceMod.default): Self = StObject.set(x, "dataItem", value.asInstanceOf[js.Any])
  ...
  trait Date extends StObject {
    ...
    var eventObject: js.UndefOr[typingsJapgolly.amcharts.stockEventMod.default] = js.undefined
  ...
  object Date {
    ...
    extension [Self <: Date](x: Self) {
      ...
      inline def setEventObject(value: typingsJapgolly.amcharts.stockEventMod.default): Self = StObject.set(x, "eventObject", value.asInstanceOf[js.Any])
      
      inline def setEventObjectUndefined: Self = StObject.set(x, "eventObject", js.undefined)
      
      inline def setGraph(value: typingsJapgolly.amcharts.stockGraphMod.default): Self = StObject.set(x, "graph", value.asInstanceOf[js.Any])
      
      inline def setGraphUndefined: Self = StObject.set(x, "graph", js.undefined)
      
      inline def setPanel(value: typingsJapgolly.amcharts.stockPanelMod.default): Self = StObject.set(x, "panel", value.asInstanceOf[js.Any])
  ...
  trait Delta2X extends StObject {
    ...
    var mostCloseGraph: js.UndefOr[typingsJapgolly.amcharts.amGraphMod.default] = js.undefined
  ...
  object Delta2X {
    ...
    extension [Self <: Delta2X](x: Self) {
      ...
      inline def setMostCloseGraph(value: typingsJapgolly.amcharts.amGraphMod.default): Self = StObject.set(x, "mostCloseGraph", value.asInstanceOf[js.Any])
  ...
  object Graph {
    ...
    extension [Self <: Graph](x: Self) {
      ...
      inline def setItem(value: typingsJapgolly.amcharts.graphDataItemMod.default): Self = StObject.set(x, "item", value.asInstanceOf[js.Any])
