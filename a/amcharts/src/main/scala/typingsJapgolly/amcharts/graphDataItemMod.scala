...
object graphDataItemMod {
  ...
  open class default ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    var serialDataItem: typingsJapgolly.amcharts.serialDataItemMod.default = js.native
  ...
  trait GraphDataItem extends StObject {
    ...
    /**
      * SerialDataItem of this graphDataItem
      */
    var serialDataItem: typingsJapgolly.amcharts.serialDataItemMod.default
  ...
  object GraphDataItem {
    ...
    inline def apply(
      ...
      percents: js.Object,
      serialDataItem: typingsJapgolly.amcharts.serialDataItemMod.default,
      url: String,
      values: js.Object,
      x: Double,
      y: Double
    ...
    extension [Self <: GraphDataItem](x: Self) {
      ...
      inline def setSerialDataItem(value: typingsJapgolly.amcharts.serialDataItemMod.default): Self = StObject.set(x, "serialDataItem", value.asInstanceOf[js.Any])
