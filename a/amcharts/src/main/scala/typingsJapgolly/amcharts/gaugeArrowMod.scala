...
object gaugeArrowMod {
  ...
  open class default ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    var axis: typingsJapgolly.amcharts.gaugeAxisMod.default = js.native
  ...
  trait GaugeArrow extends StObject {
    ...
    /**
      ...
      * @default GaugeAxis
      */
    var axis: typingsJapgolly.amcharts.gaugeAxisMod.default
  ...
  object GaugeArrow {
    ...
    inline def apply(
      alpha: Double,
      axis: typingsJapgolly.amcharts.gaugeAxisMod.default,
      borderAlpha: Double,
    ...
    extension [Self <: GaugeArrow](x: Self) {
      ...
      inline def setAxis(value: typingsJapgolly.amcharts.gaugeAxisMod.default): Self = StObject.set(x, "axis", value.asInstanceOf[js.Any])
