...
object gaugeBandMod {
  ...
  object GaugeBand {
    ...
    extension [Self <: GaugeBand](x: Self) {
      ...
      inline def setSetEndValue(value: Double => Callback): Self = StObject.set(x, "setEndValue", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setSetStartValue(value: Double => Callback): Self = StObject.set(x, "setStartValue", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
