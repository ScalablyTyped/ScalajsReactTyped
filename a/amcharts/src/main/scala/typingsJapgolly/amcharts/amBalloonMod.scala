...
object amBalloonMod {
  ...
  object AmBalloon {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(adjustBorderColor = adjustBorderColor.asInstanceOf[js.Any], borderAlpha = borderAlpha.asInstanceOf[js.Any], borderColor = borderColor.asInstanceOf[js.Any], borderThickness = borderThickness.asInstanceOf[js.Any], color = color.asInstanceOf[js.Any], cornerRadius = cornerRadius.asInstanceOf[js.Any], fillAlpha = fillAlpha.asInstanceOf[js.Any], fillColor = fillColor.asInstanceOf[js.Any], fontSize = fontSize.asInstanceOf[js.Any], hide = hide.toJsFn, horizontalPadding = horizontalPadding.asInstanceOf[js.Any], pointerWidth = pointerWidth.asInstanceOf[js.Any], setBounds = js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: Double) => (setBounds(t0, t1, t2, t3)).runNow()), setPosition = js.Any.fromFunction2((t0: Double, t1: Double) => (setPosition(t0, t1)).runNow()), show = js.Any.fromFunction1((t0: String) => show(t0).runNow()), showBullet = showBullet.asInstanceOf[js.Any], textAlign = textAlign.asInstanceOf[js.Any], textShadowColor = textShadowColor.asInstanceOf[js.Any], verticalPadding = verticalPadding.asInstanceOf[js.Any])
    ...
    extension [Self <: AmBalloon](x: Self) {
      ...
      inline def setSetBounds(value: (Double, Double, Double, Double) => Callback): Self = StObject.set(x, "setBounds", js.Any.fromFunction4((t0: Double, t1: Double, t2: Double, t3: Double) => (value(t0, t1, t2, t3)).runNow()))
