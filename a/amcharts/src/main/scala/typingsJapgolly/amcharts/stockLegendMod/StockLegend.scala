package typingsJapgolly.amcharts.stockLegendMod

import japgolly.scalajs.react.Callback
import typingsJapgolly.amcharts.AnonDataItem
import typingsJapgolly.amcharts.amLegendMod.AmLegend
...
object StockLegend {
  @scala.inline
  def apply(
    addListener: (String, js.Function1[/* e */ AnonDataItem, Unit]) => Callback,
    align: String,
    autoMargins: Boolean,
