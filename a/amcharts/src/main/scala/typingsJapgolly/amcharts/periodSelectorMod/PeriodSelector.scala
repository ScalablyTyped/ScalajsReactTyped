...
object PeriodSelector {
  @scala.inline
  def apply(
    addListener: (String, js.Function1[/* e */ AnonCount, Unit]) => Callback,
    dateFormat: String,
    fromText: String,
    ...
    val __obj = js.Dynamic.literal(dateFormat = dateFormat.asInstanceOf[js.Any], fromText = fromText.asInstanceOf[js.Any], hideOutOfScopePeriods = hideOutOfScopePeriods.asInstanceOf[js.Any], inputFieldWidth = inputFieldWidth.asInstanceOf[js.Any], inputFieldsEnabled = inputFieldsEnabled.asInstanceOf[js.Any], periods = periods.asInstanceOf[js.Any], periodsText = periodsText.asInstanceOf[js.Any], position = position.asInstanceOf[js.Any], selectFromStart = selectFromStart.asInstanceOf[js.Any], toText = toText.asInstanceOf[js.Any], width = width.asInstanceOf[js.Any])
    __obj.updateDynamic("addListener")(js.Any.fromFunction2((t0: java.lang.String, t1: js.Function1[/* e */ typingsJapgolly.amcharts.AnonCount, scala.Unit]) => addListener(t0, t1).runNow()))
