...
import typingsJapgolly.amcharts.anon.Number
...
object amAngularGaugeMod {
  ...
  trait AmAngularGauge
    ...
    /**
      ...
      */
    def addArrow(arrow: typingsJapgolly.amcharts.gaugeArrowMod.default): Unit = js.native
    
    /**
      * Adds axis to angular gauge.
      */
    def addAxis(axis: typingsJapgolly.amcharts.gaugeAxisMod.default): Unit = js.native
    ...
    /**
      * Array of arrows.
      */
    var arrows: js.Array[typingsJapgolly.amcharts.gaugeArrowMod.default] = js.native
    ...
    /**
      ...
      * @default [GaugeAxis]
      */
    var axes: js.Array[typingsJapgolly.amcharts.gaugeAxisMod.default] = js.native
    ...
    /**
      ...
      */
    def makeChart(container: String, config: Any, delay: Double): typingsJapgolly.amcharts.amChartMod.default = js.native
    ...
    /**
      ...
      */
    def removeArrow(arrow: typingsJapgolly.amcharts.gaugeArrowMod.default): Unit = js.native
    
    /**
      * Removes axis from the chart.
      */
    def removeAxis(axis: typingsJapgolly.amcharts.gaugeAxisMod.default): Unit = js.native
