...
object chartScrollbarSettingsMod {
  ...
  open class default ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    var graph: typingsJapgolly.amcharts.amGraphMod.default = js.native
  ...
  object ChartScrollbarSettings {
    ...
    extension [Self <: ChartScrollbarSettings](x: Self) {
      ...
      inline def setGraph(value: typingsJapgolly.amcharts.amGraphMod.default): Self = StObject.set(x, "graph", value.asInstanceOf[js.Any])
