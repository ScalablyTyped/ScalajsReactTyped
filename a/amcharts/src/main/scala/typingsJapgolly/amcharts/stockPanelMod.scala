...
import typingsJapgolly.amcharts.amSerialChartMod.AmSerialChart
...
object stockPanelMod extends js.Object {
  ...
  trait StockPanel extends AmSerialChart {
    ...
    /**
      ...
      */
    var drawOnAxis: typingsJapgolly.amcharts.valueAxisMod.default = js.native
    /**
    ...
    var stockGraphs: js.Array[typingsJapgolly.amcharts.stockGraphMod.default] = js.native
    /**
      * Stock chart legend.
      */
    var stockLegend: typingsJapgolly.amcharts.stockLegendMod.default = js.native
    /**
    ...
    /**
      ...
      */
    def addStockGraph(graph: typingsJapgolly.amcharts.stockGraphMod.default): Unit = js.native
    /**
      * Removes graph from the panel.
      */
    def removeStockGraph(graph: typingsJapgolly.amcharts.stockGraphMod.default): Unit = js.native
  }
