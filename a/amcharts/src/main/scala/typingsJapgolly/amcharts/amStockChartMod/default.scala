...
class default () extends AmStockChart {
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var balloon: typingsJapgolly.amcharts.amBalloonMod.default = js.native
  /**
    * Settings for category axes.
    */
  /* CompleteClass */
  override var categoryAxesSettings: typingsJapgolly.amcharts.categoryAxesSettingsMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var chartCursorSettings: typingsJapgolly.amcharts.chartCursorSettingsMod.default = js.native
  /**
    * Chart scrollbar settings.
    */
  /* CompleteClass */
  override var chartScrollbarSettings: typingsJapgolly.amcharts.chartScrollbarSettingsMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var dataSetSelector: typingsJapgolly.amcharts.dataSetSelectorMod.default = js.native
  /**
    * Array of DataSets.
    */
  /* CompleteClass */
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var legendSettings: typingsJapgolly.amcharts.legendSettingsMod.default = js.native
  /**
    * Data set selected as main.
    */
  /* CompleteClass */
  override var mainDataSet: typingsJapgolly.amcharts.dataSetMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var panelsSettings: typingsJapgolly.amcharts.panelSettingsMod.default = js.native
  /**
    ...
    */
  /* CompleteClass */
  override var periodSelector: typingsJapgolly.amcharts.periodSelectorMod.default = js.native
  /**
    * Scrollbar's chart object, get only.
    */
  /* CompleteClass */
  override var scrollbarChart: typingsJapgolly.amcharts.amSerialChartMod.default = js.native
  /**
  ...
  /**
    ...
    */
  /* CompleteClass */
  override var valueAxesSettings: typingsJapgolly.amcharts.valueAxesSettingsMod.default = js.native
  /**
