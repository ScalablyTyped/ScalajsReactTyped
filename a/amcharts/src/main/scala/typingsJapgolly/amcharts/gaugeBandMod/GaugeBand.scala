package typingsJapgolly.amcharts.gaugeBandMod
...
object GaugeBand {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(alpha = alpha.asInstanceOf[js.Any], balloonText = balloonText.asInstanceOf[js.Any], color = color.asInstanceOf[js.Any], endValue = endValue.asInstanceOf[js.Any], gradientRatio = gradientRatio.asInstanceOf[js.Any], id = id.asInstanceOf[js.Any], innerRadius = innerRadius.asInstanceOf[js.Any], radius = radius.asInstanceOf[js.Any], startValue = startValue.asInstanceOf[js.Any], url = url.asInstanceOf[js.Any])
    __obj.updateDynamic("setEndValue")(js.Any.fromFunction1((t0: scala.Double) => setEndValue(t0).runNow()))
    __obj.updateDynamic("setStartValue")(js.Any.fromFunction1((t0: scala.Double) => setStartValue(t0).runNow()))
