...
object dataSetMod {
  ...
  open class default ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    var stockEvents: js.Array[typingsJapgolly.amcharts.stockEventMod.default] = js.native
  ...
  trait DataSet extends StObject {
    ...
    /**
      * Array of StockEvent objects.
      */
    var stockEvents: js.Array[typingsJapgolly.amcharts.stockEventMod.default]
  ...
  object DataSet {
    ...
    inline def apply(
      ...
      stockEvents: js.Array[typingsJapgolly.amcharts.stockEventMod.default],
      title: String
    ): DataSet = {
    ...
    extension [Self <: DataSet](x: Self) {
      ...
      inline def setStockEvents(value: js.Array[typingsJapgolly.amcharts.stockEventMod.default]): Self = StObject.set(x, "stockEvents", value.asInstanceOf[js.Any])
      
      inline def setStockEventsVarargs(value: typingsJapgolly.amcharts.stockEventMod.default*): Self = StObject.set(x, "stockEvents", js.Array(value*))
