...
import typingsJapgolly.angularDesktopNotification.anon.Default
    ...
    object desktopNotification {
      ...
      object AugmentedNotificationOptions {
        ...
        extension [Self <: AugmentedNotificationOptions](x: Self) {
          ...
          inline def setOnError(value: /* evt */ Event => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* evt */ Event) => value(t0).runNow()))
      ...
      object IDesktopNotificationProvider {
        ...
        inline def apply(config: IDesktopNotificationOptions => Callback): IDesktopNotificationProvider = {
          val __obj = js.Dynamic.literal(config = js.Any.fromFunction1((t0: IDesktopNotificationOptions) => config(t0).runNow()))
          __obj.asInstanceOf[IDesktopNotificationProvider]
        }
        
        extension [Self <: IDesktopNotificationProvider](x: Self) {
          
          inline def setConfig(value: IDesktopNotificationOptions => Callback): Self = StObject.set(x, "config", js.Any.fromFunction1((t0: IDesktopNotificationOptions) => value(t0).runNow()))
        }
      }
      ...
      trait IDesktopNotificationService extends StObject {
        ...
        def show(title: String, options: org.scalajs.dom.NotificationOptions): Unit = js.native
