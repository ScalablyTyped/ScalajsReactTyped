...
import typingsJapgolly.animejs.mod.AnimeTarget
import typingsJapgolly.animejs.mod.AnimeTimelineInstance
import typingsJapgolly.animejs.mod.FunctionBasedParameter
import typingsJapgolly.animejs.mod.StaggerOptions
