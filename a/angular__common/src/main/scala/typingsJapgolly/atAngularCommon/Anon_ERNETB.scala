...
trait Anon_ERNETB extends js.Object {
...
object Anon_ERNETB {
  @scala.inline
  def apply(ERN: js.Array[String], ETB: js.Array[String], JPY: js.Array[String], USD: js.Array[String]): Anon_ERNETB = {
    ...
    __obj.asInstanceOf[Anon_ERNETB]
  }
}
