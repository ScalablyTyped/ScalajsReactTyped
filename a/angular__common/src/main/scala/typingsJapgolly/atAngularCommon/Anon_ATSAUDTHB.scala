...
trait Anon_ATSAUDTHB extends js.Object {
...
object Anon_ATSAUDTHB {
  @scala.inline
  def apply(ATS: js.Array[String], AUD: js.Array[String], THB: js.Array[String], TWD: js.Array[String]): Anon_ATSAUDTHB = {
    ...
    __obj.asInstanceOf[Anon_ATSAUDTHB]
  }
}
