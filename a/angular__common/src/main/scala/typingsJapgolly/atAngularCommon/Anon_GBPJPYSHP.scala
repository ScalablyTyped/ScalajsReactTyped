...
trait Anon_GBPJPYSHP extends js.Object {
...
object Anon_GBPJPYSHP {
  @scala.inline
  def apply(GBP: js.Array[String], JPY: js.Array[String], SHP: js.Array[String], USD: js.Array[String]): Anon_GBPJPYSHP = {
    ...
    __obj.asInstanceOf[Anon_GBPJPYSHP]
  }
}
