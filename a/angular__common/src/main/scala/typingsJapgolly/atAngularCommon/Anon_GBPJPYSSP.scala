...
trait Anon_GBPJPYSSP extends js.Object {
...
object Anon_GBPJPYSSP {
  @scala.inline
  def apply(GBP: js.Array[String], JPY: js.Array[String], SSP: js.Array[String], USD: js.Array[String]): Anon_GBPJPYSSP = {
    ...
    __obj.asInstanceOf[Anon_GBPJPYSSP]
  }
}
