...
trait Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNY extends js.Object {
...
object Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNY {
  @scala.inline
  def apply(
    ARS: js.Array[String],
    AUD: js.Array[String],
  ...
  ): Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNY = {
    ...
    __obj.asInstanceOf[Anon_ARSAUDBEFBMDBNDBSDBZDCADCLPCNY]
  }
}
