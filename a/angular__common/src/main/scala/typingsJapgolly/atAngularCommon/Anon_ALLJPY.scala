...
trait Anon_ALLJPY extends js.Object {
...
object Anon_ALLJPY {
  @scala.inline
  def apply(ALL: js.Array[String], JPY: js.Array[String], THB: js.Array[String], USD: js.Array[String]): Anon_ALLJPY = {
    ...
    __obj.asInstanceOf[Anon_ALLJPY]
  }
}
