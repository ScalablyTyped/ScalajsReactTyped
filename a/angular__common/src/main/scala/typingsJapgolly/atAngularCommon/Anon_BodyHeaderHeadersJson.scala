...
trait Anon_BodyHeaderHeadersJson extends js.Object {
...
object Anon_BodyHeaderHeadersJson {
  @scala.inline
  def apply(
    observe: response,
    body: js.Any = null,
    ...
    __obj.asInstanceOf[Anon_BodyHeaderHeadersJson]
  }
}
