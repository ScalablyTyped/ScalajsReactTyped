...
trait Anon_JPYNPR extends js.Object {
...
object Anon_JPYNPR {
  @scala.inline
  def apply(JPY: js.Array[String], NPR: js.Array[String], THB: js.Array[String], USD: js.Array[String]): Anon_JPYNPR = {
    ...
    __obj.asInstanceOf[Anon_JPYNPR]
  }
}
