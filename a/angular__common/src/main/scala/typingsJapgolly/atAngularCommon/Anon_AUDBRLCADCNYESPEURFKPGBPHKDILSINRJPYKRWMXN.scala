...
trait Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRWMXN extends js.Object {
...
object Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRWMXN {
  @scala.inline
  def apply(
  ...
  ): Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRWMXN = {
    ...
    __obj.asInstanceOf[Anon_AUDBRLCADCNYESPEURFKPGBPHKDILSINRJPYKRWMXN]
  }
}
