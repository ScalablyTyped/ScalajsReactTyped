...
object FormStyle extends js.Object {
  ...
  /* 0 */ val Format: typingsJapgolly.atAngularCommon.atAngularCommonMod.FormStyle.Format with Double = js.native
  /* 1 */ val Standalone: typingsJapgolly.atAngularCommon.atAngularCommonMod.FormStyle.Standalone with Double = js.native
  @JSBracketAccess
