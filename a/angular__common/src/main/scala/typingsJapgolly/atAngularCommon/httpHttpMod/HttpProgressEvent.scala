...
import typingsJapgolly.atAngularCommon.httpHttpMod.HttpEventType.DownloadProgress
import typingsJapgolly.atAngularCommon.httpHttpMod.HttpEventType.UploadProgress
