...
object localesSaqMod extends Shortcut {
  
  @JSImport("@angular/common/locales/saq", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesSaqMod.foo` */
