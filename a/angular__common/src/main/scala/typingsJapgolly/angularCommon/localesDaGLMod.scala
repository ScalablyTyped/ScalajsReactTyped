...
object localesDaGLMod extends Shortcut {
  
  @JSImport("@angular/common/locales/da-GL", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesDaGLMod.foo` */
