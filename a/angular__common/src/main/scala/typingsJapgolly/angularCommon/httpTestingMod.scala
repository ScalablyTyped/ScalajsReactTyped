...
import typingsJapgolly.angularCommon.anon.HeadersStatus
import typingsJapgolly.angularCommon.anon.IgnoreCancelled
import typingsJapgolly.angularCommon.anon.TypeofHttpClientModule
import typingsJapgolly.angularCommon.httpMod.HttpEvent
...
object httpTestingMod {
  ...
  open class TestRequest protected () extends StObject {
    ...
    /**
      ...
      */
    def error(error: ProgressEvent): Unit = js.native
    def error(error: ProgressEvent, opts: TestRequestErrorOptions): Unit = js.native
