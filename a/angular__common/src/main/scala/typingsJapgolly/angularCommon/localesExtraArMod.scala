...
object localesExtraArMod extends Shortcut {
  
  @JSImport("@angular/common/locales/extra/ar", JSImport.Default)
  @js.native
  val default: js.Array[js.Array[js.Array[String]]] = js.native
  
  type _To = js.Array[js.Array[js.Array[String]]]
  
  /* This means you don't have to write `default`, but can instead just say `localesExtraArMod.foo` */
