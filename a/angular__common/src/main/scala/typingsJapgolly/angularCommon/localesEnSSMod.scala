...
object localesEnSSMod extends Shortcut {
  
  @JSImport("@angular/common/locales/en-SS", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesEnSSMod.foo` */
