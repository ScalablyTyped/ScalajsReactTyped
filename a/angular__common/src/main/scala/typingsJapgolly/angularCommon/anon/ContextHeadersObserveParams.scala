...
trait ContextHeadersObserveParams extends StObject {
...
object ContextHeadersObserveParams {
  
  inline def apply(): ContextHeadersObserveParams = {
    val __obj = js.Dynamic.literal(observe = "response", responseType = "blob")
    __obj.asInstanceOf[ContextHeadersObserveParams]
  }
  
  extension [Self <: ContextHeadersObserveParams](x: Self) {
