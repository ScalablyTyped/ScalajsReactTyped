...
object BDT {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(BDT = BDT.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any])
    __obj.asInstanceOf[BDT]
  }
  
  extension [Self <: BDT](x: Self) {
    
    inline def setBDT(value: js.Array[String]): Self = StObject.set(x, "BDT", value.asInstanceOf[js.Any])
    
    inline def setBDTVarargs(value: String*): Self = StObject.set(x, "BDT", js.Array(value*))
