...
object MDL {
  ...
  extension [Self <: MDL](x: Self) {
    ...
    inline def setMDL(value: js.Array[String]): Self = StObject.set(x, "MDL", value.asInstanceOf[js.Any])
    
    inline def setMDLVarargs(value: String*): Self = StObject.set(x, "MDL", js.Array(value*))
