...
object KZT {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(BYN = BYN.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], KZT = KZT.asInstanceOf[js.Any], LSL = LSL.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], RUB = RUB.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any])
  ...
  extension [Self <: KZT](x: Self) {
    ...
    inline def setKZTVarargs(value: String*): Self = StObject.set(x, "KZT", js.Array(value*))
