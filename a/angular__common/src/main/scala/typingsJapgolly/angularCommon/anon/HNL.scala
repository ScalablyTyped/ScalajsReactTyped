...
object HNL {
  ...
  extension [Self <: HNL](x: Self) {
    ...
    inline def setHNL(value: js.Array[String]): Self = StObject.set(x, "HNL", value.asInstanceOf[js.Any])
    
    inline def setHNLVarargs(value: String*): Self = StObject.set(x, "HNL", js.Array(value*))
