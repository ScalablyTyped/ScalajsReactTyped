...
object VES {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AUD = AUD.asInstanceOf[js.Any], BOB = BOB.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], COP = COP.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], PTE = PTE.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], SCR = SCR.asInstanceOf[js.Any], SYP = SYP.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], VES = VES.asInstanceOf[js.Any], XAF = XAF.asInstanceOf[js.Any], XOF = XOF.asInstanceOf[js.Any], XPF = XPF.asInstanceOf[js.Any], ZMW = ZMW.asInstanceOf[js.Any])
    __obj.asInstanceOf[VES]
  }
  
  extension [Self <: VES](x: Self) {
    ...
    inline def setVES(value: js.Array[String]): Self = StObject.set(x, "VES", value.asInstanceOf[js.Any])
    
    inline def setVESVarargs(value: String*): Self = StObject.set(x, "VES", js.Array(value*))
