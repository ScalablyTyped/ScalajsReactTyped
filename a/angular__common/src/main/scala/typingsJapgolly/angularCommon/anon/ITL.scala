...
object ITL {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[ITL]
  }
  
  extension [Self <: ITL](x: Self) {
    ...
    inline def setLUF(value: js.Array[String]): Self = StObject.set(x, "LUF", value.asInstanceOf[js.Any])
    
    inline def setLUFVarargs(value: String*): Self = StObject.set(x, "LUF", js.Array(value*))
