...
object PTE {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AUD = AUD.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], FJD = FJD.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], PTE = PTE.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], SYP = SYP.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], XOF = XOF.asInstanceOf[js.Any], ZMK = ZMK.asInstanceOf[js.Any])
    __obj.asInstanceOf[PTE]
  }
  
  extension [Self <: PTE](x: Self) {
    ...
    inline def setZMK(value: js.Array[String]): Self = StObject.set(x, "ZMK", value.asInstanceOf[js.Any])
    
    inline def setZMKVarargs(value: String*): Self = StObject.set(x, "ZMK", js.Array(value*))
  }
}
