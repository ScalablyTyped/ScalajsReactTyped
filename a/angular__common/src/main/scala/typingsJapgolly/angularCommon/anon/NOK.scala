...
object NOK {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(BRL = BRL.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], EGP = EGP.asInstanceOf[js.Any], HKD = HKD.asInstanceOf[js.Any], INR = INR.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], KRW = KRW.asInstanceOf[js.Any], MXN = MXN.asInstanceOf[js.Any], NOK = NOK.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], VND = VND.asInstanceOf[js.Any])
