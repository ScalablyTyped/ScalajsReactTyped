...
object PYG {
  ...
  extension [Self <: PYG](x: Self) {
    ...
    inline def setPYG(value: js.Array[String]): Self = StObject.set(x, "PYG", value.asInstanceOf[js.Any])
    
    inline def setPYGVarargs(value: String*): Self = StObject.set(x, "PYG", js.Array(value*))
