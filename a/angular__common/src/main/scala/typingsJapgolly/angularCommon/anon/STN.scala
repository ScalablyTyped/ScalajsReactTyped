...
object STN {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AUD = AUD.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], PTE = PTE.asInstanceOf[js.Any], RON = RON.asInstanceOf[js.Any], STN = STN.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any])
    __obj.asInstanceOf[STN]
  }
  
  extension [Self <: STN](x: Self) {
    ...
    inline def setSTN(value: js.Array[String]): Self = StObject.set(x, "STN", value.asInstanceOf[js.Any])
    
    inline def setSTNVarargs(value: String*): Self = StObject.set(x, "STN", js.Array(value*))
