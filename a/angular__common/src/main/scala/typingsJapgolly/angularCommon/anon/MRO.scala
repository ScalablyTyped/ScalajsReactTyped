...
object MRO {
  ...
  extension [Self <: MRO](x: Self) {
    ...
    inline def setMRO(value: js.Array[String]): Self = StObject.set(x, "MRO", value.asInstanceOf[js.Any])
    
    inline def setMROVarargs(value: String*): Self = StObject.set(x, "MRO", js.Array(value*))
