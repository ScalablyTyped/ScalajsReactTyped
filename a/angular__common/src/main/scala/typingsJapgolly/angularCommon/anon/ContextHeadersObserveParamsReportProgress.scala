...
trait ContextHeadersObserveParamsReportProgress extends StObject {
...
object ContextHeadersObserveParamsReportProgress {
  
  inline def apply(): ContextHeadersObserveParamsReportProgress = {
    val __obj = js.Dynamic.literal(responseType = "arraybuffer")
    __obj.asInstanceOf[ContextHeadersObserveParamsReportProgress]
  }
  
  extension [Self <: ContextHeadersObserveParamsReportProgress](x: Self) {
