...
object AUDAWG {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(AUD = AUD.asInstanceOf[js.Any], AWG = AWG.asInstanceOf[js.Any], BYN = BYN.asInstanceOf[js.Any], CAD = CAD.asInstanceOf[js.Any], FJD = FJD.asInstanceOf[js.Any], JPY = JPY.asInstanceOf[js.Any], PHP = PHP.asInstanceOf[js.Any], RUR = RUR.asInstanceOf[js.Any], SBD = SBD.asInstanceOf[js.Any], THB = THB.asInstanceOf[js.Any], TWD = TWD.asInstanceOf[js.Any], USD = USD.asInstanceOf[js.Any], XPF = XPF.asInstanceOf[js.Any], XXX = XXX.asInstanceOf[js.Any])
    __obj.asInstanceOf[AUDAWG]
  }
  
  extension [Self <: AUDAWG](x: Self) {
    ...
    inline def setAWG(value: js.Array[String]): Self = StObject.set(x, "AWG", value.asInstanceOf[js.Any])
    
    inline def setAWGVarargs(value: String*): Self = StObject.set(x, "AWG", js.Array(value*))
