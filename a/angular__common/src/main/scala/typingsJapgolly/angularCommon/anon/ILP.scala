...
object ILP {
  ...
  extension [Self <: ILP](x: Self) {
    ...
    inline def setKMF(value: js.Array[String]): Self = StObject.set(x, "KMF", value.asInstanceOf[js.Any])
    
    inline def setKMFVarargs(value: String*): Self = StObject.set(x, "KMF", js.Array(value*))
