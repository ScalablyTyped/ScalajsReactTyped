...
object PAB {
  ...
  extension [Self <: PAB](x: Self) {
    ...
    inline def setPAB(value: js.Array[String]): Self = StObject.set(x, "PAB", value.asInstanceOf[js.Any])
    
    inline def setPABVarargs(value: String*): Self = StObject.set(x, "PAB", js.Array(value*))
