...
object localesKlnMod extends Shortcut {
  
  @JSImport("@angular/common/locales/kln", JSImport.Default)
  @js.native
  ...
  /* This means you don't have to write `default`, but can instead just say `localesKlnMod.foo` */
