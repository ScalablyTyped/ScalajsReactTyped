...
import typingsJapgolly.angularCommon.httpHttpMod.HttpEventType.DownloadProgress
import typingsJapgolly.angularCommon.httpHttpMod.HttpEventType.UploadProgress
