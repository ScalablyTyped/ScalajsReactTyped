...
libraryDependencies ++= Seq(
  ...
  "org.scalablytyped.japgolly" %%% "antd" % "4.0.0-fc0bcd",
  "org.scalablytyped.japgolly" %%% "antv__g2" % "3.5.9-6057eb",
  "org.scalablytyped.japgolly" %%% "bizcharts" % "3.5.6-a6361b",
