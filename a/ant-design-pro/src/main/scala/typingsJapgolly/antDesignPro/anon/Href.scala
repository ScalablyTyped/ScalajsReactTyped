...
object Href {
  ...
  extension [Self <: Href](x: Self) {
    ...
    inline def setInnerRef(value: /* node */ HTMLAnchorElement | Null => Callback): Self = StObject.set(x, "innerRef", js.Any.fromFunction1((t0: /* node */ HTMLAnchorElement | Null) => value(t0).runNow()))
