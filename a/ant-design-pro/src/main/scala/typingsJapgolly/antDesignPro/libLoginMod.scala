...
object libLoginMod {
  ...
  object default {
    ...
    @js.native
    open class Tab ()
      extends typingsJapgolly.antDesignPro.libLoginLoginTabMod.default
  ...
  object Login {
    ...
    /* was `typeof LoginTab` */
    type Tab = typingsJapgolly.antDesignPro.libLoginLoginTabMod.default
  }
  ...
  object LoginProps {
    ...
    extension [Self <: LoginProps](x: Self) {
      ...
      inline def setOnSubmit(value: (/* error */ Any, /* values */ Any) => Callback): Self = StObject.set(x, "onSubmit", js.Any.fromFunction2((t0: /* error */ Any, t1: /* values */ Any) => (value(t0, t1)).runNow()))
