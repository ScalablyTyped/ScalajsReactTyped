...
object RegionFilter {
  ...
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "Annotation.RegionFilter")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignPro.libChartsBizchartsMod.Annotation.RegionFilter] {
