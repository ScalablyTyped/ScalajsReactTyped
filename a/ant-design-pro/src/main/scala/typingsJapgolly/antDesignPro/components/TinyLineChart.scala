...
object TinyLineChart {
  
  inline def apply(data: js.Array[Double | (Record[String, Any])]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TinyLineOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "TinyLineChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def guideLine(value: js.Array[js.Object]): this.type = set("guideLine", value.asInstanceOf[js.Any])
    
    inline def guideLineVarargs(value: js.Object*): this.type = set("guideLine", js.Array(value*))
    ...
    inline def point(value: MappingOptionsPickPointGe): this.type = set("point", value.asInstanceOf[js.Any])
  ...
  def withProps(p: TinyLineOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
