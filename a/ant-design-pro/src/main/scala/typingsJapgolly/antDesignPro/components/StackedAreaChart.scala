...
object StackedAreaChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[StackedAreaOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "StackedAreaChart")
  @js.native
  ...
  def withProps(p: StackedAreaOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
