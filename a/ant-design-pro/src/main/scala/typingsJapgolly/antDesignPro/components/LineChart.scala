...
object LineChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[LineOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "LineChart")
  @js.native
  ...
  def withProps(p: LineOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
