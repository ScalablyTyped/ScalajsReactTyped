...
import typingsJapgolly.antvG2plot.anon.OffsetX
...
object FunnelChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[FunnelOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "FunnelChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def compareField(value: String): this.type = set("compareField", value.asInstanceOf[js.Any])
    
    inline def conversionTag(value: `false` | OffsetX): this.type = set("conversionTag", value.asInstanceOf[js.Any])
    ...
    inline def dynamicHeight(value: Boolean): this.type = set("dynamicHeight", value.asInstanceOf[js.Any])
    ...
    inline def funnelStyle(value: StyleAttr): this.type = set("funnelStyle", value.asInstanceOf[js.Any])
    ...
    inline def isTransposed(value: Boolean): this.type = set("isTransposed", value.asInstanceOf[js.Any])
    ...
    inline def showFacetTitle(value: Boolean): this.type = set("showFacetTitle", value.asInstanceOf[js.Any])
  ...
  def withProps(p: FunnelOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
