...
object Marker {
  ...
  inline def apply(attrs: R): Builder = {
    val __props = js.Dynamic.literal(attrs = attrs.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[(Pick[IMarkerProps, String | Double]) & RefAttributes[Any]]))
  }
  ...
  def withProps(p: (Pick[IMarkerProps, String | Double]) & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
