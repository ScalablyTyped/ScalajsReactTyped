...
object LineAdvance {
  ...
  inline def apply(position: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[ILineAdvanceGemoProps]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "LineAdvance")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def area(value: Boolean | IAreaGemoProps): this.type = set("area", value.asInstanceOf[js.Any])
    ...
    inline def point(value: Boolean | IPointGemoProps): this.type = set("point", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ILineAdvanceGemoProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
