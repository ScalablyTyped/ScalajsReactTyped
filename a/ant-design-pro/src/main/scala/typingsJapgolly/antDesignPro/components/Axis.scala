...
object Axis {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[AxisProps, typingsJapgolly.antDesignPro.bizchartsMod.Axis, Unit, AxisProps] = {
  ...
  typingsJapgolly.antDesignPro.bizchartsMod.Axis](this.componentImport)
