...
object DensityHeatmapChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[DensityHeatmapOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "DensityHeatmapChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def radius(value: (Record[String, Any]) | Double): this.type = set("radius", value.asInstanceOf[js.Any])
  ...
  def withProps(p: DensityHeatmapOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
