...
object Coord {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[CoordProps, typingsJapgolly.antDesignPro.bizchartsMod.Coord, Unit, CoordProps] = {
  ...
  typingsJapgolly.antDesignPro.bizchartsMod.Coord](this.componentImport)
