...
object PercentStackedColumnChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]], xField: String, yField: String): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PercentStackedColumnOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "PercentStackedColumnChart")
  @js.native
  ...
  def withProps(p: PercentStackedColumnOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
