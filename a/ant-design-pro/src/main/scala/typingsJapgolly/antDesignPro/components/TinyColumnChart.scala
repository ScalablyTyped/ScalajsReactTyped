...
object TinyColumnChart {
  
  inline def apply(data: js.Array[Double | (Record[String, Any])]): Builder = {
    val __props = js.Dynamic.literal(data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[TinyColumnOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "TinyColumnChart")
  @js.native
  ...
  def withProps(p: TinyColumnOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
