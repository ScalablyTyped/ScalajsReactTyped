...
import typingsJapgolly.antDesignPro.loginItemMod.default
...
object LoginItem {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[LoginItemProps, default, Unit, LoginItemProps] = {
  ...
  typingsJapgolly.antDesignPro.loginItemMod.default](this.componentImport)
