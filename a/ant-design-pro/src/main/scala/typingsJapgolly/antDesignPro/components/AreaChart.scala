...
object AreaChart {
  ...
  inline def apply(data: js.Array[Record[String, Any]]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[AreaOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "AreaChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def areaStyle(value: StyleAttr): this.type = set("areaStyle", value.asInstanceOf[js.Any])
    ...
    inline def line(value: js.UndefOr[MappingOptions] & PickPointGeometryOptionss): this.type = set("line", value.asInstanceOf[js.Any])
    ...
    inline def startOnZero(value: Boolean): this.type = set("startOnZero", value.asInstanceOf[js.Any])
  ...
  def withProps(p: AreaOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
