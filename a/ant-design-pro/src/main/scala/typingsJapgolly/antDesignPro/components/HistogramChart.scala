...
object HistogramChart {
  ...
  inline def apply(binField: String, data: js.Array[Record[String, Any]]): Builder = {
    val __props = js.Dynamic.literal(binField = binField.asInstanceOf[js.Any], data = data.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[HistogramOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "HistogramChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def binNumber(value: Double): this.type = set("binNumber", value.asInstanceOf[js.Any])
    
    inline def binWidth(value: Double): this.type = set("binWidth", value.asInstanceOf[js.Any])
  ...
  def withProps(p: HistogramOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
