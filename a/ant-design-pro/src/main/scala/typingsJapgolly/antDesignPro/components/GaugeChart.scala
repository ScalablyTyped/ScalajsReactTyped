...
import typingsJapgolly.antvG2plot.anon.StepRatio
...
import typingsJapgolly.antvG2plot.libPlotsGaugeTypesMod.Indicator
import typingsJapgolly.antvG2plot.libPlotsGaugeTypesMod.Range
...
import typingsJapgolly.antvG2plot.libTypesStatisticMod.Statistic
...
object GaugeChart {
  ...
  inline def apply(percent: Double): Builder = {
    val __props = js.Dynamic.literal(percent = percent.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[GaugeOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "GaugeChart")
  @js.native
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def axis(value: typingsJapgolly.antvG2plot.libTypesAxisMod.Axis): this.type = set("axis", value.asInstanceOf[js.Any])
    ...
    inline def gaugeStyle(value: StyleAttr): this.type = set("gaugeStyle", value.asInstanceOf[js.Any])
    
    inline def height(value: Double): this.type = set("height", value.asInstanceOf[js.Any])
    
    inline def indicator(value: `false` | Indicator): this.type = set("indicator", value.asInstanceOf[js.Any])
    ...
    inline def meter(value: StepRatio): this.type = set("meter", value.asInstanceOf[js.Any])
    ...
    inline def range(value: Range): this.type = set("range", value.asInstanceOf[js.Any])
    ...
    inline def statistic(value: Statistic): this.type = set("statistic", value.asInstanceOf[js.Any])
  ...
  def withProps(p: GaugeOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
