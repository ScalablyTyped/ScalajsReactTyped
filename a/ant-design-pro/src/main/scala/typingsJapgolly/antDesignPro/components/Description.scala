...
import typingsJapgolly.antDesignPro.libDescriptionListDescriptionMod.default
...
object Description {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def term(value: VdomNode): this.type = set("term", value.rawNode.asInstanceOf[js.Any])
    
    inline def termNull: this.type = set("term", null)
    
    inline def termVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): this.type = set("term", js.Array(value*))
    
    inline def termVdomElement(value: VdomElement): this.type = set("term", value.rawElement.asInstanceOf[js.Any])
