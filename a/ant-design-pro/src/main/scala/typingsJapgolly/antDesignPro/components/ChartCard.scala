...
import typingsJapgolly.antDesignPro.libChartsChartCardMod.IChartCardProps
...
import typingsJapgolly.antd.libCardCardMod.CardTabListType
import typingsJapgolly.antd.libCardCardMod.CardType
...
object ChartCard {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antDesignPro.libChartsMod.ChartCard] {
    ...
    inline def actions(value: js.Array[Node]): this.type = set("actions", value.asInstanceOf[js.Any])
    
    inline def actionsVarargs(value: Node*): this.type = set("actions", js.Array(value*))
    
    inline def activeTabKey(value: String): this.type = set("activeTabKey", value.asInstanceOf[js.Any])
    ...
    inline def contentHeight(value: Double): this.type = set("contentHeight", value.asInstanceOf[js.Any])
    
    inline def contextMenu(value: String): this.type = set("contextMenu", value.asInstanceOf[js.Any])
    
    inline def cover(value: VdomNode): this.type = set("cover", value.rawNode.asInstanceOf[js.Any])
    
    inline def coverNull: this.type = set("cover", null)
    
    inline def coverVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("cover", js.Array(value*))
    
    inline def coverVdomElement(value: VdomElement): this.type = set("cover", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def defaultActiveTabKey(value: String): this.type = set("defaultActiveTabKey", value.asInstanceOf[js.Any])
    ...
    inline def headStyle(value: CSSProperties): this.type = set("headStyle", value.asInstanceOf[js.Any])
    ...
    inline def size(value: CardSize): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def tabList(value: js.Array[CardTabListType]): this.type = set("tabList", value.asInstanceOf[js.Any])
    
    inline def tabListVarargs(value: CardTabListType*): this.type = set("tabList", js.Array(value*))
    ...
    inline def `type`(value: CardType): this.type = set("type", value.asInstanceOf[js.Any])
