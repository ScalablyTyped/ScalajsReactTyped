...
import typingsJapgolly.antDesignPro.chartCardMod.IChartCardProps
import typingsJapgolly.antDesignPro.chartCardMod.default
...
object ChartCard {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[IChartCardProps, default, Unit, IChartCardProps] = {
  ...
  typingsJapgolly.antDesignPro.chartCardMod.IChartCardProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignPro.chartCardMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignPro.chartCardMod.IChartCardProps])(children: _*)
  }
