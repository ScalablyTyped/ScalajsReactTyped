...
object PieChart {
  ...
  inline def apply(angleField: String, colorField: String, data: js.Array[Record[String, Any]]): Builder = {
    ...
    new Builder(js.Array(this.component, __props.asInstanceOf[PieOptions & RefAttributes[Any]]))
  }
  
  @JSImport("ant-design-pro/lib/Charts/bizcharts", "PieChart")
  @js.native
  ...
  def withProps(p: PieOptions & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
