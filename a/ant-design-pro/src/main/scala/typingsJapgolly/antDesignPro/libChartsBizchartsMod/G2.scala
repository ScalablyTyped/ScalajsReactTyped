...
object G2 {
  ...
  open class ComponentController[O] protected ()
    extends typingsJapgolly.bizcharts.mod.G2.ComponentController[O] {
  ...
  open class Coordinate ()
    extends typingsJapgolly.bizcharts.mod.G2.Coordinate {
  ...
  open class Element protected ()
    extends typingsJapgolly.bizcharts.mod.G2.Element {
  ...
  open class Facet[C /* <: FacetCfg[FacetData] */, F /* <: FacetData */] protected ()
    extends typingsJapgolly.bizcharts.mod.G2.Facet[C, F] {
  ...
  open class Geometry[S /* <: ShapePoint */] protected ()
    extends typingsJapgolly.bizcharts.mod.G2.Geometry[S] {
    /**
      * 创建 Geometry 实例。
      * @param cfg
      */
  ...
  open class GeometryLabel protected ()
    extends typingsJapgolly.bizcharts.mod.G2.GeometryLabel {
  ...
  open class InteractionAction[T] protected ()
    extends typingsJapgolly.bizcharts.mod.G2.InteractionAction[T] {
  ...
  open class TooltipController ()
    extends typingsJapgolly.bizcharts.mod.G2.TooltipController
