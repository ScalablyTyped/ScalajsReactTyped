...
@js.native
/* private */ open class CTemplatePrinter ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.CTemplatePrinter {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.CTemplatePrinter_typekey")
  var MSHTMLDotCTemplatePrinter_typekey: typingsJapgolly.activexMshtml.MSHTML.CTemplatePrinter = js.native
