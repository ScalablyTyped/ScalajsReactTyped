...
/* private */ open class DOMBeforeUnloadEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMBeforeUnloadEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMBeforeUnloadEvent_typekey")
  var MSHTMLDotDOMBeforeUnloadEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMBeforeUnloadEvent = js.native
