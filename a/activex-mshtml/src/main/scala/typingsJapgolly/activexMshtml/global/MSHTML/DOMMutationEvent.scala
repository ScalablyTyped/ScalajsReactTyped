...
/* private */ open class DOMMutationEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMMutationEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMMutationEvent_typekey")
  var MSHTMLDotDOMMutationEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMMutationEvent = js.native
