...
/* private */ open class HTMLDefaults ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.HTMLDefaults {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.HTMLDefaults_typekey")
  var MSHTMLDotHTMLDefaults_typekey: typingsJapgolly.activexMshtml.MSHTML.HTMLDefaults = js.native
  ...
  /* CompleteClass */
  override val style: typingsJapgolly.activexMshtml.MSHTML.IHTMLStyle = js.native
  ...
  /* CompleteClass */
  var viewLink: typingsJapgolly.activexMshtml.MSHTML.IHTMLDocument = js.native
