...
@js.native
/* private */ open class DOMMouseWheelEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMMouseWheelEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMMouseWheelEvent_typekey")
  var MSHTMLDotDOMMouseWheelEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMMouseWheelEvent = js.native
  ...
  /* CompleteClass */
  override def initMouseWheelEvent(
    eventType: String,
    canBubble: Boolean,
    cancelable: Boolean,
    viewArg: IHTMLWindow2,
