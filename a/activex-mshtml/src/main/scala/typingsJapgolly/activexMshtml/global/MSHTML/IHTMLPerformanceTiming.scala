...
/* private */ open class IHTMLPerformanceTiming ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.IHTMLPerformanceTiming {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.IHTMLPerformanceTiming_typekey")
  var MSHTMLDotIHTMLPerformanceTiming_typekey: typingsJapgolly.activexMshtml.MSHTML.IHTMLPerformanceTiming = js.native
