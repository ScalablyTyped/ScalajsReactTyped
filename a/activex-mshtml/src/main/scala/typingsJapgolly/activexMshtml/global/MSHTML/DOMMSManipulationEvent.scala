...
/* private */ open class DOMMSManipulationEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMMSManipulationEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMMSManipulationEvent_typekey")
  var MSHTMLDotDOMMSManipulationEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMMSManipulationEvent = js.native
