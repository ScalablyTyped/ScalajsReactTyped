...
@js.native
/* private */ open class IDOMTreeWalker ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.IDOMTreeWalker {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.IDOMTreeWalker_typekey")
  var MSHTMLDotIDOMTreeWalker_typekey: typingsJapgolly.activexMshtml.MSHTML.IDOMTreeWalker = js.native
