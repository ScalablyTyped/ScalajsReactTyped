...
@js.native
/* private */ open class DOMWheelEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMWheelEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMWheelEvent_typekey")
  var MSHTMLDotDOMWheelEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMWheelEvent = js.native
