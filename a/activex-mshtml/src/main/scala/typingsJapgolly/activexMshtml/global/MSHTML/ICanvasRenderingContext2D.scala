...
/* private */ open class ICanvasRenderingContext2D ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.ICanvasRenderingContext2D {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.ICanvasRenderingContext2D_typekey")
  var MSHTMLDotICanvasRenderingContext2D_typekey: typingsJapgolly.activexMshtml.MSHTML.ICanvasRenderingContext2D = js.native
