...
/* private */ open class CPrintManagerTemplatePrinter ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.CPrintManagerTemplatePrinter {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.CPrintManagerTemplatePrinter_typekey")
  var MSHTMLDotCPrintManagerTemplatePrinter_typekey: typingsJapgolly.activexMshtml.MSHTML.CPrintManagerTemplatePrinter = js.native
