...
@js.native
/* private */ open class SVGPathSegLinetoRel ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.SVGPathSegLinetoRel {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.SVGPathSegLinetoRel_typekey")
  var MSHTMLDotSVGPathSegLinetoRel_typekey: typingsJapgolly.activexMshtml.MSHTML.SVGPathSegLinetoRel = js.native
