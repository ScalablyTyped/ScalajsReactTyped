...
@js.native
/* private */ open class ISVGPathSegArcAbs ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.ISVGPathSegArcAbs {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.ISVGPathSegArcAbs_typekey")
  var MSHTMLDotISVGPathSegArcAbs_typekey: typingsJapgolly.activexMshtml.MSHTML.ISVGPathSegArcAbs = js.native
