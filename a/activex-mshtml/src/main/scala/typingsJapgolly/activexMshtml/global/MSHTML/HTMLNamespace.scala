...
/* private */ open class HTMLNamespace ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.HTMLNamespace {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.HTMLNamespace_typekey")
  var MSHTMLDotHTMLNamespace_typekey: typingsJapgolly.activexMshtml.MSHTML.HTMLNamespace = js.native
