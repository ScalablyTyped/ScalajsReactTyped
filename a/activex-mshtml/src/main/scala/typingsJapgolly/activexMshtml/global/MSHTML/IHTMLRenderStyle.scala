...
/* private */ open class IHTMLRenderStyle ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.IHTMLRenderStyle {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.IHTMLRenderStyle_typekey")
  var MSHTMLDotIHTMLRenderStyle_typekey: typingsJapgolly.activexMshtml.MSHTML.IHTMLRenderStyle = js.native
