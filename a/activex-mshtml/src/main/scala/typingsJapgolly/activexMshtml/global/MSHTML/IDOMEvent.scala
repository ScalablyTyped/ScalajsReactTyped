...
@js.native
/* private */ open class IDOMEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.IDOMEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.IDOMEvent_typekey")
  var MSHTMLDotIDOMEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.IDOMEvent = js.native
