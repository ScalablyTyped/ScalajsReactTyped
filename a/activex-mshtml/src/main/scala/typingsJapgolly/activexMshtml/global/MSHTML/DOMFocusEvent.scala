...
/* private */ open class DOMFocusEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMFocusEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMFocusEvent_typekey")
  var MSHTMLDotDOMFocusEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMFocusEvent = js.native
