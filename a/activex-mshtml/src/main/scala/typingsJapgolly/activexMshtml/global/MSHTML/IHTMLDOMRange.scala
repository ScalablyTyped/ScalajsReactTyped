...
/* private */ open class IHTMLDOMRange ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.IHTMLDOMRange {
  ...
  var MSHTMLDotIHTMLDOMRange_typekey: typingsJapgolly.activexMshtml.MSHTML.IHTMLDOMRange = js.native
