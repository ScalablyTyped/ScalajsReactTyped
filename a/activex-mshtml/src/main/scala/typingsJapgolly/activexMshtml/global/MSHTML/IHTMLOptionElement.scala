...
import typingsJapgolly.activexMshtml.MSHTML.IHTMLFormElement
...
/* private */ open class IHTMLOptionElement ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.IHTMLOptionElement {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.IHTMLOptionElement_typekey")
  var MSHTMLDotIHTMLOptionElement_typekey: typingsJapgolly.activexMshtml.MSHTML.IHTMLOptionElement = js.native
