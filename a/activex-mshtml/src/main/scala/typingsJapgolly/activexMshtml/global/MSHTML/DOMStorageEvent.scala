...
/* private */ open class DOMStorageEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMStorageEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMStorageEvent_typekey")
  var MSHTMLDotDOMStorageEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMStorageEvent = js.native
  ...
  override def initStorageEvent(
    ...
    newValueArg: String,
    urlArg: String,
    storageAreaArg: typingsJapgolly.activexMshtml.MSHTML.IHTMLStorage
  ): Unit = js.native
  ...
  /* CompleteClass */
  override val storageArea: typingsJapgolly.activexMshtml.MSHTML.IHTMLStorage = js.native
