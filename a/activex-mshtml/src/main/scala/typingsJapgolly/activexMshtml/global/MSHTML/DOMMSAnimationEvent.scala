...
/* private */ open class DOMMSAnimationEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMMSAnimationEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMMSAnimationEvent_typekey")
  var MSHTMLDotDOMMSAnimationEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMMSAnimationEvent = js.native
