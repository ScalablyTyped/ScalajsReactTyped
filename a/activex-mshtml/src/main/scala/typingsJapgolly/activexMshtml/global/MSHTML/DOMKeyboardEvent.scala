...
/* private */ open class DOMKeyboardEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMKeyboardEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMKeyboardEvent_typekey")
  var MSHTMLDotDOMKeyboardEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMKeyboardEvent = js.native
