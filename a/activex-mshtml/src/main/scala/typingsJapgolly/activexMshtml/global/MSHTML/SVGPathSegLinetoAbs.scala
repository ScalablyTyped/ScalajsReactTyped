...
/* private */ open class SVGPathSegLinetoAbs ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.SVGPathSegLinetoAbs {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.SVGPathSegLinetoAbs_typekey")
  var MSHTMLDotSVGPathSegLinetoAbs_typekey: typingsJapgolly.activexMshtml.MSHTML.SVGPathSegLinetoAbs = js.native
