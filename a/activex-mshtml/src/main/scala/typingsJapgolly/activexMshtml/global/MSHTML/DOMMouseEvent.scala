...
/* private */ open class DOMMouseEvent ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.DOMMouseEvent {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.DOMMouseEvent_typekey")
  var MSHTMLDotDOMMouseEvent_typekey: typingsJapgolly.activexMshtml.MSHTML.DOMMouseEvent = js.native
