...
/* private */ open class HTMLPerformanceTiming ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.HTMLPerformanceTiming {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.HTMLPerformanceTiming_typekey")
  var MSHTMLDotHTMLPerformanceTiming_typekey: typingsJapgolly.activexMshtml.MSHTML.HTMLPerformanceTiming = js.native
