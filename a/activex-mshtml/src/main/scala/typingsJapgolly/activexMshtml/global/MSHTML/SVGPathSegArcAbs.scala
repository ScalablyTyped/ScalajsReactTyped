...
@js.native
/* private */ open class SVGPathSegArcAbs ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.SVGPathSegArcAbs {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.SVGPathSegArcAbs_typekey")
  var MSHTMLDotSVGPathSegArcAbs_typekey: typingsJapgolly.activexMshtml.MSHTML.SVGPathSegArcAbs = js.native
