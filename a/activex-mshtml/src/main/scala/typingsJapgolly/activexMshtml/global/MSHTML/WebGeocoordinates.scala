...
/* private */ open class WebGeocoordinates ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.WebGeocoordinates {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.WebGeocoordinates_typekey")
  var MSHTMLDotWebGeocoordinates_typekey: typingsJapgolly.activexMshtml.MSHTML.WebGeocoordinates = js.native
