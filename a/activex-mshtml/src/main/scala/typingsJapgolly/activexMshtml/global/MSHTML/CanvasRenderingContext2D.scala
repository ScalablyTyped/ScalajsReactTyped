...
@js.native
/* private */ open class CanvasRenderingContext2D ()
  extends StObject
     with typingsJapgolly.activexMshtml.MSHTML.CanvasRenderingContext2D {
  
  /* private */ /* CompleteClass */
  @JSName("MSHTML.CanvasRenderingContext2D_typekey")
  var MSHTMLDotCanvasRenderingContext2D_typekey: typingsJapgolly.activexMshtml.MSHTML.CanvasRenderingContext2D = js.native
  ...
  /* CompleteClass */
  override val canvas: typingsJapgolly.activexMshtml.MSHTML.IHTMLCanvasElement = js.native
  ...
  /* CompleteClass */
  override def createImageData(a1: Any, a2: Any): typingsJapgolly.activexMshtml.MSHTML.ICanvasImageData = js.native
  
  /* CompleteClass */
  override def createLinearGradient(x0: Double, y0: Double, x1: Double, y1: Double): typingsJapgolly.activexMshtml.MSHTML.ICanvasGradient = js.native
  
  /* CompleteClass */
  override def createPattern(Image: Any, repetition: Any): typingsJapgolly.activexMshtml.MSHTML.ICanvasPattern = js.native
  
  /* CompleteClass */
  override def createRadialGradient(x0: Double, y0: Double, r0: Double, x1: Double, y1: Double, r1: Double): typingsJapgolly.activexMshtml.MSHTML.ICanvasGradient = js.native
  ...
  /* CompleteClass */
  override def getImageData(sx: Double, sy: Double, sw: Double, sh: Double): typingsJapgolly.activexMshtml.MSHTML.ICanvasImageData = js.native
  ...
  /* CompleteClass */
  override def measureText(text: String): typingsJapgolly.activexMshtml.MSHTML.ICanvasTextMetrics = js.native
  ...
  override def putImageData(
    imagedata: typingsJapgolly.activexMshtml.MSHTML.ICanvasImageData,
    dx: Double,
    dy: Double,
    dirtyX: Any,
    dirtyY: Any,
