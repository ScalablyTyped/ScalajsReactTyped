...
trait SVGGElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.SVGGElement_typekey")
...
object SVGGElement {
  ...
  extension [Self <: SVGGElement](x: Self) {
    ...
    inline def setMSHTMLDotSVGGElement_typekey(value: SVGGElement): Self = StObject.set(x, "MSHTML.SVGGElement_typekey", value.asInstanceOf[js.Any])
