...
object styleFontStyle {
  ...
  inline def styleFontStyleItalic: `1` = 1.asInstanceOf[`1`]
  
  inline def styleFontStyleNormal: `3` = 3.asInstanceOf[`3`]
  
  inline def styleFontStyleNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleFontStyleOblique: `2` = 2.asInstanceOf[`2`]
  
  inline def styleFontStyle_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
