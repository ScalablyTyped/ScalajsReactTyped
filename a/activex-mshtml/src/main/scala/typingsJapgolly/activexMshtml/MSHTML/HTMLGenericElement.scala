...
trait HTMLGenericElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLGenericElement_typekey")
  ...
  def namedRecordset(dataMember: String): Any = js.native
  def namedRecordset(dataMember: String, hierarchy: Any): Any = js.native
