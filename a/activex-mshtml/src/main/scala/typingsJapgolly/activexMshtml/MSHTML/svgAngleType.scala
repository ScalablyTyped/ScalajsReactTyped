...
*/
trait svgAngleType extends StObject
object svgAngleType {
  
  inline def SVG_ANGLETYPE_DEG: `2` = 2.asInstanceOf[`2`]
  
  inline def SVG_ANGLETYPE_GRAD: `4` = 4.asInstanceOf[`4`]
  
  inline def SVG_ANGLETYPE_RAD: `3` = 3.asInstanceOf[`3`]
  
  inline def SVG_ANGLETYPE_UNKNOWN: `0` = 0.asInstanceOf[`0`]
  
  inline def SVG_ANGLETYPE_UNSPECIFIED: `1` = 1.asInstanceOf[`1`]
  
  inline def svgAngleType_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
