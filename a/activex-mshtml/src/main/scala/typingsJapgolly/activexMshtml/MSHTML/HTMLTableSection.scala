...
@js.native
trait HTMLTableSection extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLTableSection_typekey")
  var MSHTMLDotHTMLTableSection_typekey: HTMLTableSection = js.native
  ...
  /** @param index [index=-1] */
  def ie9_insertRow(): Any = js.native
  def ie9_insertRow(index: Double): Any = js.native
  ...
  /**
    ...
    */
  def moveRow(): Any = js.native
  def moveRow(indexFrom: Double): Any = js.native
  def moveRow(indexFrom: Double, indexTo: Double): Any = js.native
  def moveRow(indexFrom: Unit, indexTo: Double): Any = js.native
