...
object textpathMethodtype {
  ...
  inline def TEXTPATH_METHODTYPE_ALIGN: `1` = 1.asInstanceOf[`1`]
  
  inline def TEXTPATH_METHODTYPE_STRETCH: `2` = 2.asInstanceOf[`2`]
  
  inline def TEXTPATH_METHODTYPE_UNKNOWN: `0` = 0.asInstanceOf[`0`]
  
  inline def textpathMethodtype_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
