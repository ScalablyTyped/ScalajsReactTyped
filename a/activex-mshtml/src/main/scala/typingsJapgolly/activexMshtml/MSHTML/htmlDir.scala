...
object htmlDir {
  ...
  inline def htmlDirLeftToRight: `1` = 1.asInstanceOf[`1`]
  
  inline def htmlDirNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def htmlDirRightToLeft: `2` = 2.asInstanceOf[`2`]
  
  inline def htmlDir_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
