...
*/
trait _VIEW_OBJECT_ALPHA_MODE extends StObject
object _VIEW_OBJECT_ALPHA_MODE {
  
  inline def VIEW_OBJECT_ALPHA_MODE_IGNORE: `0` = 0.asInstanceOf[`0`]
  
  inline def VIEW_OBJECT_ALPHA_MODE_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
  
  inline def VIEW_OBJECT_ALPHA_MODE_PREMULTIPLIED: `1` = 1.asInstanceOf[`1`]
}
