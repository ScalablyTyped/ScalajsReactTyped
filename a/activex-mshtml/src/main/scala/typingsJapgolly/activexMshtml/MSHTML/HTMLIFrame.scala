...
@js.native
trait HTMLIFrame extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLIFrame_typekey")
  ...
  val contentDocument: Any = js.native
  
  var contentEditable: String = js.native
  
  def contentWindow(pvarIndex: Any): Any = js.native
  ...
  def getSVGDocument(): Any = js.native
