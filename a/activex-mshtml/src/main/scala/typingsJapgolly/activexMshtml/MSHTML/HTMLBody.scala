...
trait HTMLBody extends StObject {
  ...
  /* private */ @JSName("MSHTML.HTMLBody_typekey")
  var MSHTMLDotHTMLBody_typekey: HTMLBody = js.native
  
  var aLink: Any = js.native
  ...
  var bottomMargin: Any = js.native
