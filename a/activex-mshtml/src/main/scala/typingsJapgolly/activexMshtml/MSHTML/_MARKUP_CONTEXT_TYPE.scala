...
*/
trait _MARKUP_CONTEXT_TYPE extends StObject
object _MARKUP_CONTEXT_TYPE {
  
  inline def CONTEXT_TYPE_EnterScope: `2` = 2.asInstanceOf[`2`]
  
  inline def CONTEXT_TYPE_ExitScope: `3` = 3.asInstanceOf[`3`]
  
  inline def CONTEXT_TYPE_NoScope: `4` = 4.asInstanceOf[`4`]
  
  inline def CONTEXT_TYPE_None: `0` = 0.asInstanceOf[`0`]
  
  inline def CONTEXT_TYPE_Text: `1` = 1.asInstanceOf[`1`]
  
  inline def MARKUP_CONTEXT_TYPE_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
