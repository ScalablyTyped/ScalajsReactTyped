...
object htmlMediaReadyState {
  ...
  inline def htmlMediaReadyStateHaveCurrentData: `2` = 2.asInstanceOf[`2`]
  
  inline def htmlMediaReadyStateHaveEnoughData: `4` = 4.asInstanceOf[`4`]
  
  inline def htmlMediaReadyStateHaveFutureData: `3` = 3.asInstanceOf[`3`]
  
  inline def htmlMediaReadyStateHaveMetadata: `1` = 1.asInstanceOf[`1`]
  
  inline def htmlMediaReadyStateHaveNothing: `0` = 0.asInstanceOf[`0`]
  
  inline def htmlMediaReadyState_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
