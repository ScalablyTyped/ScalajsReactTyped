...
*/
trait styleMsScrollSnapType extends js.Object

object styleMsScrollSnapType {
  @scala.inline
  /* private */ def cast[T](in: js.Any): T = in.asInstanceOf[T]
  @scala.inline
  def styleMsScrollSnapTypeMandatory: `2` = this.cast(2)
  @scala.inline
  def styleMsScrollSnapTypeNone: `1` = this.cast(1)
  @scala.inline
  def styleMsScrollSnapTypeNotSet: `0` = this.cast(0)
  @scala.inline
  def styleMsScrollSnapTypeProximity: `3` = this.cast(3)
  @scala.inline
  def styleMsScrollSnapType_Max: `2147483647` = this.cast(2147483647)
}
