...
trait DOMFocusEvent extends StObject {
  ...
  /* private */ @JSName("MSHTML.DOMFocusEvent_typekey")
...
object DOMFocusEvent {
  ...
  inline def apply(
    ...
    initFocusEvent: (String, Boolean, Boolean, IHTMLWindow2, Double, IEventTarget) => Callback,
    ...
    val __obj = js.Dynamic.literal(bubbles = bubbles.asInstanceOf[js.Any], cancelBubble = cancelBubble.asInstanceOf[js.Any], cancelable = cancelable.asInstanceOf[js.Any], currentTarget = currentTarget.asInstanceOf[js.Any], defaultPrevented = defaultPrevented.asInstanceOf[js.Any], detail = detail.asInstanceOf[js.Any], eventPhase = eventPhase.asInstanceOf[js.Any], initEvent = js.Any.fromFunction3((t0: String, t1: Boolean, t2: Boolean) => (initEvent(t0, t1, t2)).runNow()), initFocusEvent = js.Any.fromFunction6((t0: String, t1: Boolean, t2: Boolean, t3: IHTMLWindow2, t4: Double, t5: IEventTarget) => (initFocusEvent(t0, t1, t2, t3, t4, t5)).runNow()), initUIEvent = js.Any.fromFunction5((t0: String, t1: Boolean, t2: Boolean, t3: IHTMLWindow2, t4: Double) => (initUIEvent(t0, t1, t2, t3, t4)).runNow()), isTrusted = isTrusted.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, relatedTarget = relatedTarget.asInstanceOf[js.Any], srcElement = srcElement.asInstanceOf[js.Any], stopImmediatePropagation = stopImmediatePropagation.toJsFn, stopPropagation = stopPropagation.toJsFn, target = target.asInstanceOf[js.Any], timeStamp = timeStamp.asInstanceOf[js.Any], view = view.asInstanceOf[js.Any])
  ...
  extension [Self <: DOMFocusEvent](x: Self) {
    ...
    inline def setInitFocusEvent(value: (String, Boolean, Boolean, IHTMLWindow2, Double, IEventTarget) => Callback): Self = StObject.set(x, "initFocusEvent", js.Any.fromFunction6((t0: String, t1: Boolean, t2: Boolean, t3: IHTMLWindow2, t4: Double, t5: IEventTarget) => (value(t0, t1, t2, t3, t4, t5)).runNow()))
    ...
    inline def setMSHTMLDotDOMFocusEvent_typekey(value: DOMFocusEvent): Self = StObject.set(x, "MSHTML.DOMFocusEvent_typekey", value.asInstanceOf[js.Any])
