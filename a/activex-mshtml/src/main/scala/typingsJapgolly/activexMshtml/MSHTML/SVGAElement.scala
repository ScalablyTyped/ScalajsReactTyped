...
trait SVGAElement extends StObject {
  ...
  /* private */ @JSName("MSHTML.SVGAElement_typekey")
...
object SVGAElement {
  ...
  extension [Self <: SVGAElement](x: Self) {
    ...
    inline def setMSHTMLDotSVGAElement_typekey(value: SVGAElement): Self = StObject.set(x, "MSHTML.SVGAElement_typekey", value.asInstanceOf[js.Any])
    ...
    inline def setTarget(value: SVGAnimatedString): Self = StObject.set(x, "target", value.asInstanceOf[js.Any])
