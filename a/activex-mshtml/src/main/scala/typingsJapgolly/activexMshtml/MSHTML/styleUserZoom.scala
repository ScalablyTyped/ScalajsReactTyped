...
*/
trait styleUserZoom extends StObject
object styleUserZoom {
  
  inline def styleUserZoomFixed: `2` = 2.asInstanceOf[`2`]
  
  inline def styleUserZoomNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleUserZoomZoom: `1` = 1.asInstanceOf[`1`]
  
  inline def styleUserZoom_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
