...
object DOMDragEvent {
  ...
  inline def apply(
    ...
    initDragEvent: (String, Boolean, Boolean, IHTMLWindow2, Double, Double, Double, Double, Double, Boolean, Boolean, Boolean, Boolean, Double, IEventTarget, IHTMLDataTransfer) => Callback,
  ...
  extension [Self <: DOMDragEvent](x: Self) {
    ...
    inline def setInitDragEvent(
      value: (String, Boolean, Boolean, IHTMLWindow2, Double, Double, Double, Double, Double, Boolean, Boolean, Boolean, Boolean, Double, IEventTarget, IHTMLDataTransfer) => Callback
    ): Self = StObject.set(x, "initDragEvent", js.Any.fromFunction16((t0: String, t1: Boolean, t2: Boolean, t3: IHTMLWindow2, t4: Double, t5: Double, t6: Double, t7: Double, t8: Double, t9: Boolean, t10: Boolean, t11: Boolean, t12: Boolean, t13: Double, t14: IEventTarget, t15: IHTMLDataTransfer) => (value(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15)).runNow()))
