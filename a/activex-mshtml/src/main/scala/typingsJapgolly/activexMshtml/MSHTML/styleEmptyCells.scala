...
object styleEmptyCells {
  ...
  inline def styleEmptyCellsHide: `2` = 2.asInstanceOf[`2`]
  
  inline def styleEmptyCellsNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def styleEmptyCellsShow: `1` = 1.asInstanceOf[`1`]
  
  inline def styleEmptyCells_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
