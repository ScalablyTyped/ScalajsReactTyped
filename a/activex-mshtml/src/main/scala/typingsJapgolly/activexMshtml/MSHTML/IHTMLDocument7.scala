...
object IHTMLDocument7 {
  ...
  inline def apply(
    ...
    getSelection: CallbackTo[IHTMLSelection],
  ...
  extension [Self <: IHTMLDocument7](x: Self) {
    ...
    inline def setGetSelection(value: CallbackTo[IHTMLSelection]): Self = StObject.set(x, "getSelection", value.toJsFn)
