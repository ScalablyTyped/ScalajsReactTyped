...
object SVGMarkerElement {
  ...
  inline def apply(
    ...
    setOrientToAngle: SVGAngle => Callback,
    setOrientToAuto: Callback,
  ...
  extension [Self <: SVGMarkerElement](x: Self) {
    ...
    inline def setSetOrientToAngle(value: SVGAngle => Callback): Self = StObject.set(x, "setOrientToAngle", js.Any.fromFunction1((t0: SVGAngle) => value(t0).runNow()))
    
    inline def setSetOrientToAuto(value: Callback): Self = StObject.set(x, "setOrientToAuto", value.toJsFn)
