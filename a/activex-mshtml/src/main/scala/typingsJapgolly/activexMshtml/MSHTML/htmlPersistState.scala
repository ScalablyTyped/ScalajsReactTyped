...
*/
trait htmlPersistState extends StObject
object htmlPersistState {
  
  inline def htmlPersistStateFavorite: `1` = 1.asInstanceOf[`1`]
  
  inline def htmlPersistStateHistory: `2` = 2.asInstanceOf[`2`]
  
  inline def htmlPersistStateNormal: `0` = 0.asInstanceOf[`0`]
  
  inline def htmlPersistStateSnapshot: `3` = 3.asInstanceOf[`3`]
  
  inline def htmlPersistStateUserData: `4` = 4.asInstanceOf[`4`]
  
  inline def htmlPersistState_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
