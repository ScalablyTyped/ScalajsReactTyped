...
*/
trait sandboxAllow extends StObject
object sandboxAllow {
  
  inline def sandboxAllowForms: `3` = 3.asInstanceOf[`3`]
  
  inline def sandboxAllowPopups: `4` = 4.asInstanceOf[`4`]
  
  inline def sandboxAllowSameOrigin: `1` = 1.asInstanceOf[`1`]
  
  inline def sandboxAllowScripts: `0` = 0.asInstanceOf[`0`]
  
  inline def sandboxAllowTopNavigation: `2` = 2.asInstanceOf[`2`]
  
  inline def sandboxAllow_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
