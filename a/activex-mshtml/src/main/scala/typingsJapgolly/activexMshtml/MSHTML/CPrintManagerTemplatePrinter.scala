...
trait CPrintManagerTemplatePrinter extends StObject {
  ...
  def drawPreviewPage(pElemDisp: Any, nPage: Double): Unit
  ...
  def getPrintTaskOptionValue(bstrKey: String): Any
...
object CPrintManagerTemplatePrinter {
  ...
  inline def apply(
    ...
    drawPreviewPage: (Any, Double) => Callback,
    duplex: Boolean,
    endPrint: Callback,
    ...
    getPrintTaskOptionValue: String => Any,
    header: String,
    headerFooterFont: String,
    invalidatePreview: Callback,
    marginBottom: Double,
    marginLeft: Double,
    marginRight: Double,
    marginTop: Double,
  ...
  extension [Self <: CPrintManagerTemplatePrinter](x: Self) {
    ...
    inline def setDrawPreviewPage(value: (Any, Double) => Callback): Self = StObject.set(x, "drawPreviewPage", js.Any.fromFunction2((t0: Any, t1: Double) => (value(t0, t1)).runNow()))
    
    inline def setDuplex(value: Boolean): Self = StObject.set(x, "duplex", value.asInstanceOf[js.Any])
    
    inline def setEndPrint(value: Callback): Self = StObject.set(x, "endPrint", value.toJsFn)
    ...
    inline def setGetPrintTaskOptionValue(value: String => Any): Self = StObject.set(x, "getPrintTaskOptionValue", js.Any.fromFunction1(value))
    ...
    inline def setInvalidatePreview(value: Callback): Self = StObject.set(x, "invalidatePreview", value.toJsFn)
    ...
    inline def setSetPageCount(value: Double => Callback): Self = StObject.set(x, "setPageCount", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    ...
    inline def setStartPrint(value: Callback): Self = StObject.set(x, "startPrint", value.toJsFn)
