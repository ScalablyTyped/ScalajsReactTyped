...
object SVGPathElement {
  ...
  inline def apply(
    ...
    createSVGPathSegClosePath: CallbackTo[ISVGPathSegClosePath],
    ...
    getTotalLength: CallbackTo[Double],
  ...
  extension [Self <: SVGPathElement](x: Self) {
    ...
    inline def setCreateSVGPathSegClosePath(value: CallbackTo[ISVGPathSegClosePath]): Self = StObject.set(x, "createSVGPathSegClosePath", value.toJsFn)
