...
trait DOMEvent extends StObject {
  ...
  /* private */ @JSName("MSHTML.DOMEvent_typekey")
...
object DOMEvent {
  ...
  extension [Self <: DOMEvent](x: Self) {
    ...
    inline def setMSHTMLDotDOMEvent_typekey(value: DOMEvent): Self = StObject.set(x, "MSHTML.DOMEvent_typekey", value.asInstanceOf[js.Any])
