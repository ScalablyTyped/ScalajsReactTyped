...
object DOMMouseWheelEvent {
  ...
  inline def apply(
    ...
    initMouseWheelEvent: (String, Boolean, Boolean, IHTMLWindow2, Double, Double, Double, Double, Double, Double, IEventTarget, String, Double) => Callback,
    ...
    val __obj = js.Dynamic.literal(altKey = altKey.asInstanceOf[js.Any], bubbles = bubbles.asInstanceOf[js.Any], button = button.asInstanceOf[js.Any], buttons = buttons.asInstanceOf[js.Any], cancelBubble = cancelBubble.asInstanceOf[js.Any], cancelable = cancelable.asInstanceOf[js.Any], clientX = clientX.asInstanceOf[js.Any], clientY = clientY.asInstanceOf[js.Any], ctrlKey = ctrlKey.asInstanceOf[js.Any], currentTarget = currentTarget.asInstanceOf[js.Any], defaultPrevented = defaultPrevented.asInstanceOf[js.Any], detail = detail.asInstanceOf[js.Any], eventPhase = eventPhase.asInstanceOf[js.Any], fromElement = fromElement.asInstanceOf[js.Any], getModifierState = js.Any.fromFunction1(getModifierState), initEvent = js.Any.fromFunction3((t0: String, t1: Boolean, t2: Boolean) => (initEvent(t0, t1, t2)).runNow()), initMouseEvent = js.Any.fromFunction15((t0: String, t1: Boolean, t2: Boolean, t3: IHTMLWindow2, t4: Double, t5: Double, t6: Double, t7: Double, t8: Double, t9: Boolean, t10: Boolean, t11: Boolean, t12: Boolean, t13: Double, t14: IEventTarget) => (initMouseEvent(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14)).runNow()), initMouseWheelEvent = js.Any.fromFunction13((t0: String, t1: Boolean, t2: Boolean, t3: IHTMLWindow2, t4: Double, t5: Double, t6: Double, t7: Double, t8: Double, t9: Double, t10: IEventTarget, t11: String, t12: Double) => (initMouseWheelEvent(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12)).runNow()), initUIEvent = js.Any.fromFunction5((t0: String, t1: Boolean, t2: Boolean, t3: IHTMLWindow2, t4: Double) => (initUIEvent(t0, t1, t2, t3, t4)).runNow()), isTrusted = isTrusted.asInstanceOf[js.Any], layerX = layerX.asInstanceOf[js.Any], layerY = layerY.asInstanceOf[js.Any], metaKey = metaKey.asInstanceOf[js.Any], offsetX = offsetX.asInstanceOf[js.Any], offsetY = offsetY.asInstanceOf[js.Any], pageX = pageX.asInstanceOf[js.Any], pageY = pageY.asInstanceOf[js.Any], preventDefault = preventDefault.toJsFn, relatedTarget = relatedTarget.asInstanceOf[js.Any], screenX = screenX.asInstanceOf[js.Any], screenY = screenY.asInstanceOf[js.Any], shiftKey = shiftKey.asInstanceOf[js.Any], srcElement = srcElement.asInstanceOf[js.Any], stopImmediatePropagation = stopImmediatePropagation.toJsFn, stopPropagation = stopPropagation.toJsFn, target = target.asInstanceOf[js.Any], timeStamp = timeStamp.asInstanceOf[js.Any], toElement = toElement.asInstanceOf[js.Any], view = view.asInstanceOf[js.Any], wheelDelta = wheelDelta.asInstanceOf[js.Any], which = which.asInstanceOf[js.Any], x = x.asInstanceOf[js.Any], y = y.asInstanceOf[js.Any])
  ...
  extension [Self <: DOMMouseWheelEvent](x: Self) {
    ...
    inline def setInitMouseWheelEvent(
      value: (String, Boolean, Boolean, IHTMLWindow2, Double, Double, Double, Double, Double, Double, IEventTarget, String, Double) => Callback
    ): Self = StObject.set(x, "initMouseWheelEvent", js.Any.fromFunction13((t0: String, t1: Boolean, t2: Boolean, t3: IHTMLWindow2, t4: Double, t5: Double, t6: Double, t7: Double, t8: Double, t9: Double, t10: IEventTarget, t11: String, t12: Double) => (value(t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12)).runNow()))
