...
object HTCDefaultDispatch {
  ...
  inline def apply(
    CreateEventObject: CallbackTo[IHTMLEventObj],
    MSHTMLDotHTCDefaultDispatch_typekey: HTCDefaultDispatch,
    defaults: Any,
    document: Any,
    element: IHTMLElement
  ): HTCDefaultDispatch = {
    val __obj = js.Dynamic.literal(CreateEventObject = CreateEventObject.toJsFn, defaults = defaults.asInstanceOf[js.Any], document = document.asInstanceOf[js.Any], element = element.asInstanceOf[js.Any])
  ...
  extension [Self <: HTCDefaultDispatch](x: Self) {
    ...
    inline def setCreateEventObject(value: CallbackTo[IHTMLEventObj]): Self = StObject.set(x, "CreateEventObject", value.toJsFn)
