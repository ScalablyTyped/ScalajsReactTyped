...
*/
trait htmlCaptionVAlign extends StObject
object htmlCaptionVAlign {
  
  inline def htmlCaptionVAlignBottom: `2` = 2.asInstanceOf[`2`]
  
  inline def htmlCaptionVAlignNotSet: `0` = 0.asInstanceOf[`0`]
  
  inline def htmlCaptionVAlignTop: `1` = 1.asInstanceOf[`1`]
  
  inline def htmlCaptionVAlign_Max: `2147483647` = 2147483647d.asInstanceOf[`2147483647`]
}
