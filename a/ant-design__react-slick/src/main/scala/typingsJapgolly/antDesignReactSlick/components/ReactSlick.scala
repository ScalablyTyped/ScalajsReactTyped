...
object ReactSlick {
  ...
  typingsJapgolly.antDesignReactSlick.mod.Settings, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antDesignReactSlick.mod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antDesignReactSlick.mod.Settings])(children: _*)
  }
