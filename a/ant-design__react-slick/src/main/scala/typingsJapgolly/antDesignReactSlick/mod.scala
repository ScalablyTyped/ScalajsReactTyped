...
import typingsJapgolly.antDesignReactSlick.antDesignReactSlickStrings.unslick
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antDesignReactSlick.antDesignReactSlickStrings.ondemand
    - typingsJapgolly.antDesignReactSlick.antDesignReactSlickStrings.progressive
  */
  trait LazyLoadTypes extends StObject
  object LazyLoadTypes {
    
    inline def ondemand: typingsJapgolly.antDesignReactSlick.antDesignReactSlickStrings.ondemand = "ondemand".asInstanceOf[typingsJapgolly.antDesignReactSlick.antDesignReactSlickStrings.ondemand]
    
    inline def progressive: typingsJapgolly.antDesignReactSlick.antDesignReactSlickStrings.progressive = "progressive".asInstanceOf[typingsJapgolly.antDesignReactSlick.antDesignReactSlickStrings.progressive]
  }
