...
trait NumberLiteralTypeAnnotation extends ASTNode {
  ...
  var raw: String
  var `type`: typingsJapgolly.astTypes.astTypesStrings.NumberLiteralTypeAnnotation
  var value: Double
}
...
object NumberLiteralTypeAnnotation {
  ...
  def apply(
    raw: String,
    `type`: typingsJapgolly.astTypes.astTypesStrings.NumberLiteralTypeAnnotation,
    value: Double,
