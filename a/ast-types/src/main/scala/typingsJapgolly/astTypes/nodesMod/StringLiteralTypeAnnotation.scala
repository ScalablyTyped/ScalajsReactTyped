...
trait StringLiteralTypeAnnotation extends ASTNode {
  ...
  var raw: String
  var `type`: typingsJapgolly.astTypes.astTypesStrings.StringLiteralTypeAnnotation
  var value: String
}
...
object StringLiteralTypeAnnotation {
  ...
  def apply(
    raw: String,
    `type`: typingsJapgolly.astTypes.astTypesStrings.StringLiteralTypeAnnotation,
    value: String,
