...
trait TSOptionalType extends ASTNode {
  var comments: js.UndefOr[js.Array[CommentKind]] = js.undefined
  var loc: js.UndefOr[SourceLocationKind] = js.undefined
  var `type`: typingsJapgolly.astTypes.astTypesStrings.TSOptionalType
...
object TSOptionalType {
  @scala.inline
  def apply(
    `type`: typingsJapgolly.astTypes.astTypesStrings.TSOptionalType,
