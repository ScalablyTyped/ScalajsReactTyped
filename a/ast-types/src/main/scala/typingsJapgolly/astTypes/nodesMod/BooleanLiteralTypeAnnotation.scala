...
trait BooleanLiteralTypeAnnotation extends ASTNode {
  ...
  var raw: String
  var `type`: typingsJapgolly.astTypes.astTypesStrings.BooleanLiteralTypeAnnotation
  var value: Boolean
}
...
object BooleanLiteralTypeAnnotation {
  ...
  def apply(
    raw: String,
    `type`: typingsJapgolly.astTypes.astTypesStrings.BooleanLiteralTypeAnnotation,
    value: Boolean,
