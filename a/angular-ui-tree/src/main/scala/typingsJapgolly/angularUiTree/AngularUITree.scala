...
import typingsJapgolly.angularUiTree.anon.Index
...
object AngularUITree {
  ...
  object ICallbacks {
    ...
    inline def apply(
      ...
      dragStart: /* eventInfo */ IEventInfo => Callback,
      dropped: /* eventInfo */ IEventInfo => Callback
    ): ICallbacks = {
      val __obj = js.Dynamic.literal(accept = js.Any.fromFunction3(accept), dragStart = js.Any.fromFunction1((t0: /* eventInfo */ IEventInfo) => dragStart(t0).runNow()), dropped = js.Any.fromFunction1((t0: /* eventInfo */ IEventInfo) => dropped(t0).runNow()))
    ...
    extension [Self <: ICallbacks](x: Self) {
      ...
      inline def setDragStart(value: /* eventInfo */ IEventInfo => Callback): Self = StObject.set(x, "dragStart", js.Any.fromFunction1((t0: /* eventInfo */ IEventInfo) => value(t0).runNow()))
      
      inline def setDropped(value: /* eventInfo */ IEventInfo => Callback): Self = StObject.set(x, "dropped", js.Any.fromFunction1((t0: /* eventInfo */ IEventInfo) => value(t0).runNow()))
    }
  }
