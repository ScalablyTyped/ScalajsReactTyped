...
import typingsJapgolly.antvComponent.libTypesMod.ImageAnnotationCfg
...
object libAnnotationImageMod {
  ...
  trait ImageAnnotation
    extends typingsJapgolly.antvComponent.libAbstractGroupComponentMod.default[ImageAnnotationCfg] {
