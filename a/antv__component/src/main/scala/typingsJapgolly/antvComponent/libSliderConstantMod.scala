...
object libSliderConstantMod {
  
  object BACKGROUND_STYLE {
    
    @JSImport("@antv/component/lib/slider/constant", "BACKGROUND_STYLE")
    @js.native
  ...
  @js.native
  val DEFAULT_HANDLER_WIDTH: /* 10 */ Double = js.native
  
  object FOREGROUND_STYLE {
    
    @JSImport("@antv/component/lib/slider/constant", "FOREGROUND_STYLE")
    @js.native
    val ^ : js.Any = js.native
  ...
  object HANDLER_STYLE {
    ...
    @JSImport("@antv/component/lib/slider/constant", "HANDLER_STYLE")
    @js.native
    val ^ : js.Any = js.native
  ...
  @js.native
  val SLIDER_CHANGE: /* "sliderchange" */ String = js.native
  
  object TEXT_STYLE {
    
    @JSImport("@antv/component/lib/slider/constant", "TEXT_STYLE")
    @js.native
    val ^ : js.Any = js.native
