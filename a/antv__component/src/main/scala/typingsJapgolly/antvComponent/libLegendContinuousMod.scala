...
import typingsJapgolly.antvComponent.libInterfacesMod.ISlider
import typingsJapgolly.antvComponent.libTypesMod.ContinueLegendCfg
...
object libLegendContinuousMod {
  ...
  trait ContinueLegend
    extends typingsJapgolly.antvComponent.libLegendBaseMod.default[ContinueLegendCfg]
       with ISlider {
