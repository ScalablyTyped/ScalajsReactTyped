...
import typingsJapgolly.antvComponent.libTypesMod.ArcAnnotationCfg
...
object libAnnotationArcMod {
  ...
  @js.native
  trait ArcAnnotation
    extends typingsJapgolly.antvComponent.libAbstractGroupComponentMod.default[ArcAnnotationCfg] {
