...
import typingsJapgolly.antvComponent.anon.PartialSliderCfg
import typingsJapgolly.antvComponent.anon.Width
import typingsJapgolly.antvComponent.libInterfacesMod.ISlider
import typingsJapgolly.antvComponent.libSliderHandlerMod.IStyle
...
object libSliderSliderMod {
  ...
  @js.native
  open class Slider ()
    extends typingsJapgolly.antvComponent.libAbstractGroupComponentMod.default[SliderCfg]
       with ISlider {
