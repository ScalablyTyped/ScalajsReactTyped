...
import typingsJapgolly.antvComponent.libAbstractGroupComponentMod.GroupComponent
import typingsJapgolly.antvComponent.libAbstractGroupComponentMod.GroupComponentCtor
