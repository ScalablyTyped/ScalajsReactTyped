...
import typingsJapgolly.antvComponent.libSliderSliderMod.HandlerStyle
import typingsJapgolly.antvComponent.libSliderSliderMod.TrendCfg
...
trait PartialSliderCfg extends StObject {
  ...
  var animateOption: js.UndefOr[typingsJapgolly.antvComponent.libTypesMod.AnimateOption] = js.undefined
...
object PartialSliderCfg {
  ...
  inline def apply(): PartialSliderCfg = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialSliderCfg]
  }
  
  extension [Self <: PartialSliderCfg](x: Self) {
    
    inline def setAnimate(value: Boolean): Self = StObject.set(x, "animate", value.asInstanceOf[js.Any])
    
    inline def setAnimateOption(value: typingsJapgolly.antvComponent.libTypesMod.AnimateOption): Self = StObject.set(x, "animateOption", value.asInstanceOf[js.Any])
