...
object ItemHeight {
  ...
  extension [Self <: ItemHeight](x: Self) {
    ...
    inline def setDefaultCfg(value: ItemBackground): Self = StObject.set(x, "defaultCfg", value.asInstanceOf[js.Any])
    ...
    inline def setItemHeight(value: Any): Self = StObject.set(x, "itemHeight", value.asInstanceOf[js.Any])
    ...
    inline def setItemValue(value: Any): Self = StObject.set(x, "itemValue", value.asInstanceOf[js.Any])
    
    inline def setItemWidth(value: Any): Self = StObject.set(x, "itemWidth", value.asInstanceOf[js.Any])
    ...
    inline def setMaxItemWidth(value: Any): Self = StObject.set(x, "maxItemWidth", value.asInstanceOf[js.Any])
