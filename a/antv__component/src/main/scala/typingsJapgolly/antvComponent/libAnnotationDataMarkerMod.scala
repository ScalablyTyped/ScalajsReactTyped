...
import typingsJapgolly.antvComponent.libTypesMod.DataMarkerAnnotationCfg
...
object libAnnotationDataMarkerMod {
  ...
  trait DataMarkerAnnotation
    extends typingsJapgolly.antvComponent.libAbstractGroupComponentMod.default[DataMarkerAnnotationCfg] {
