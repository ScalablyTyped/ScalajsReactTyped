...
import typingsJapgolly.alipayjssdk.alipayjssdkInts.`2`
...
trait CurrentPosition extends StObject {
  ...
  var status: typingsJapgolly.alipayjssdk.alipayjssdkInts.`0` | typingsJapgolly.alipayjssdk.alipayjssdkInts.`1` | `2`
...
object CurrentPosition {
  ...
  inline def apply(
    ...
    duration: Double,
    status: typingsJapgolly.alipayjssdk.alipayjssdkInts.`0` | typingsJapgolly.alipayjssdk.alipayjssdkInts.`1` | `2`,
    url: String
  ): CurrentPosition = {
  ...
  extension [Self <: CurrentPosition](x: Self) {
    ...
    inline def setStatus(
      value: typingsJapgolly.alipayjssdk.alipayjssdkInts.`0` | typingsJapgolly.alipayjssdk.alipayjssdkInts.`1` | `2`
