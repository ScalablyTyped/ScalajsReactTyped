...
object List {
  ...
  inline def apply(member: Member): typingsJapgolly.awsSdkBuildTypes.buildApiModelMod.List = {
  ...
  extension [Self <: typingsJapgolly.awsSdkBuildTypes.buildApiModelMod.List](x: Self) {
