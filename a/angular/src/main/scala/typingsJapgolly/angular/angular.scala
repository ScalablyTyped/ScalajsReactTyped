...
object angular {
  ...
  object Instruction {
    ...
    inline def apply(
      ...
      resolveComponent: CallbackTo[Any],
      ...
      val __obj = js.Dynamic.literal(auxInstruction = auxInstruction.asInstanceOf[js.Any], child = child.asInstanceOf[js.Any], component = component.asInstanceOf[js.Any], replaceChild = js.Any.fromFunction1(replaceChild), resolveComponent = resolveComponent.toJsFn, specificity = specificity.toJsFn, toLinkUrl = toLinkUrl.toJsFn, toRootUrl = toRootUrl.toJsFn, toUrlPath = toUrlPath.toJsFn, toUrlQuery = toUrlQuery.toJsFn, urlParams = urlParams.toJsFn, urlPath = urlPath.toJsFn)
    ...
    extension [Self <: Instruction](x: Self) {
      ...
      inline def setResolveComponent(value: CallbackTo[Any]): Self = StObject.set(x, "resolveComponent", value.toJsFn)
      
      inline def setSpecificity(value: CallbackTo[Double]): Self = StObject.set(x, "specificity", value.toJsFn)
      
      inline def setToLinkUrl(value: CallbackTo[String]): Self = StObject.set(x, "toLinkUrl", value.toJsFn)
      
      inline def setToRootUrl(value: CallbackTo[String]): Self = StObject.set(x, "toRootUrl", value.toJsFn)
      
      inline def setToUrlPath(value: CallbackTo[String]): Self = StObject.set(x, "toUrlPath", value.toJsFn)
      
      inline def setToUrlQuery(value: CallbackTo[String]): Self = StObject.set(x, "toUrlQuery", value.toJsFn)
      
      inline def setUrlParams(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "urlParams", value.toJsFn)
      
      inline def setUrlPath(value: CallbackTo[String]): Self = StObject.set(x, "urlPath", value.toJsFn)
    }
  }
