...
object IController {
  ...
  extension [Self <: IController](x: Self) {
    ...
    inline def set$onChanges(value: /* onChangesObj */ IOnChangesObject => Callback): Self = StObject.set(x, "$onChanges", js.Any.fromFunction1((t0: /* onChangesObj */ IOnChangesObject) => value(t0).runNow()))
