...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.adalNode.adalNodeInts.`0`
    - typingsJapgolly.adalNode.adalNodeInts.`1`
    - typingsJapgolly.adalNode.adalNodeInts.`2`
    - typingsJapgolly.adalNode.adalNodeInts.`3`
  */
  trait LoggingLevel extends StObject
  object LoggingLevel {
    
    inline def `0`: typingsJapgolly.adalNode.adalNodeInts.`0` = 0.asInstanceOf[typingsJapgolly.adalNode.adalNodeInts.`0`]
    
    inline def `1`: typingsJapgolly.adalNode.adalNodeInts.`1` = 1.asInstanceOf[typingsJapgolly.adalNode.adalNodeInts.`1`]
    
    inline def `2`: typingsJapgolly.adalNode.adalNodeInts.`2` = 2.asInstanceOf[typingsJapgolly.adalNode.adalNodeInts.`2`]
    
    inline def `3`: typingsJapgolly.adalNode.adalNodeInts.`3` = 3.asInstanceOf[typingsJapgolly.adalNode.adalNodeInts.`3`]
  }
  ...
  object LoggingOptions {
    ...
    extension [Self <: LoggingOptions](x: Self) {
      ...
      inline def setLog(
        value: (/* level */ LoggingLevel, /* message */ String, /* error */ js.UndefOr[js.Error]) => Callback
      ): Self = StObject.set(x, "log", js.Any.fromFunction3((t0: /* level */ LoggingLevel, t1: /* message */ String, t2: /* error */ js.UndefOr[js.Error]) => (value(t0, t1, t2)).runNow()))
  ...
  object TokenCache {
    ...
    inline def apply(
      add: (js.Array[TokenResponse], js.Function2[/* err */ js.Error, /* result */ Boolean, Unit]) => Callback,
      find: (Any, js.Function2[/* err */ js.Error, /* results */ js.Array[Any], Unit]) => Callback,
      remove: (js.Array[TokenResponse], js.Function2[/* err */ js.Error, /* result */ Null, Unit]) => Callback
    ): TokenCache = {
      val __obj = js.Dynamic.literal(add = js.Any.fromFunction2((t0: js.Array[TokenResponse], t1: js.Function2[/* err */ js.Error, /* result */ Boolean, Unit]) => (add(t0, t1)).runNow()), find = js.Any.fromFunction2((t0: Any, t1: js.Function2[/* err */ js.Error, /* results */ js.Array[Any], Unit]) => (find(t0, t1)).runNow()), remove = js.Any.fromFunction2((t0: js.Array[TokenResponse], t1: js.Function2[/* err */ js.Error, /* result */ Null, Unit]) => (remove(t0, t1)).runNow()))
    ...
    extension [Self <: TokenCache](x: Self) {
      ...
      inline def setAdd(
        value: (js.Array[TokenResponse], js.Function2[/* err */ js.Error, /* result */ Boolean, Unit]) => Callback
      ): Self = StObject.set(x, "add", js.Any.fromFunction2((t0: js.Array[TokenResponse], t1: js.Function2[/* err */ js.Error, /* result */ Boolean, Unit]) => (value(t0, t1)).runNow()))
      
      inline def setFind(value: (Any, js.Function2[/* err */ js.Error, /* results */ js.Array[Any], Unit]) => Callback): Self = StObject.set(x, "find", js.Any.fromFunction2((t0: Any, t1: js.Function2[/* err */ js.Error, /* results */ js.Array[Any], Unit]) => (value(t0, t1)).runNow()))
      
      inline def setRemove(
        value: (js.Array[TokenResponse], js.Function2[/* err */ js.Error, /* result */ Null, Unit]) => Callback
      ): Self = StObject.set(x, "remove", js.Any.fromFunction2((t0: js.Array[TokenResponse], t1: js.Function2[/* err */ js.Error, /* result */ Null, Unit]) => (value(t0, t1)).runNow()))
    }
  }
