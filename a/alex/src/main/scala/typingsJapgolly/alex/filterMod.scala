...
object filterMod {
  ...
  inline def filter(): Unit | (Transformer[typingsJapgolly.mdast.mod.Root, typingsJapgolly.mdast.mod.Root]) = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")().asInstanceOf[Unit | (Transformer[typingsJapgolly.mdast.mod.Root, typingsJapgolly.mdast.mod.Root])]
  inline def filter(options: Options): Unit | (Transformer[typingsJapgolly.mdast.mod.Root, typingsJapgolly.mdast.mod.Root]) = ^.asInstanceOf[js.Dynamic].applyDynamic("filter")(options.asInstanceOf[js.Any]).asInstanceOf[Unit | (Transformer[typingsJapgolly.mdast.mod.Root, typingsJapgolly.mdast.mod.Root])]
