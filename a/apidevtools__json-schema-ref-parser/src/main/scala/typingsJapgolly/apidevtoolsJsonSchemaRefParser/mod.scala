package typingsJapgolly.apidevtoolsJsonSchemaRefParser

import org.scalablytyped.runtime.StringDictionary
import typingsJapgolly.apidevtoolsJsonSchemaRefParser.anon.Circular
import typingsJapgolly.apidevtoolsJsonSchemaRefParser.anon.Dictkey
import typingsJapgolly.apidevtoolsJsonSchemaRefParser.anon.External
import typingsJapgolly.jsonSchema.mod.JSONSchema4
import typingsJapgolly.jsonSchema.mod.JSONSchema4Type
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNKNOWN
    - typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EPARSER
    - typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNMATCHEDPARSER
    - typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.ERESOLVER
    - typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNMATCHEDRESOLVER
    - typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EMISSINGPOINTER
    - typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EINVALIDPOINTER
  */
  trait JSONParserErrorType extends StObject
  object JSONParserErrorType {
    
    inline def EINVALIDPOINTER: typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EINVALIDPOINTER = "EINVALIDPOINTER".asInstanceOf[typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EINVALIDPOINTER]
    
    inline def EMISSINGPOINTER: typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EMISSINGPOINTER = "EMISSINGPOINTER".asInstanceOf[typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EMISSINGPOINTER]
    
    inline def EPARSER: typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EPARSER = "EPARSER".asInstanceOf[typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EPARSER]
    
    inline def ERESOLVER: typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.ERESOLVER = "ERESOLVER".asInstanceOf[typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.ERESOLVER]
    
    inline def EUNKNOWN: typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNKNOWN = "EUNKNOWN".asInstanceOf[typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNKNOWN]
    
    inline def EUNMATCHEDPARSER: typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNMATCHEDPARSER = "EUNMATCHEDPARSER".asInstanceOf[typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNMATCHEDPARSER]
    
    inline def EUNMATCHEDRESOLVER: typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNMATCHEDRESOLVER = "EUNMATCHEDRESOLVER".asInstanceOf[typingsJapgolly.apidevtoolsJsonSchemaRefParser.apidevtoolsJsonSchemaRefParserStrings.EUNMATCHEDRESOLVER]
  }
