...
object mod extends Shortcut {
  ...
  @js.native
  val ^ : typingsJapgolly.args.mod.args = js.native
  ...
  type _To = typingsJapgolly.args.mod.args
  
  /* This means you don't have to write `^`, but can instead just say `mod.foo` */
  override def _to: typingsJapgolly.args.mod.args = ^
  
  @js.native
  trait args extends StObject {
    
    def command(name: String, description: String): typingsJapgolly.args.mod.args = js.native
    def command(
      name: String,
      description: String,
      init: js.Function3[
    ...
    ): typingsJapgolly.args.mod.args = js.native
    def command(
      name: String,
      description: String,
      init: js.Function3[
    ...
    def command(name: String, description: String, init: Unit, aliases: js.Array[String]): typingsJapgolly.args.mod.args = js.native
    
    def example(usage: String, description: String): typingsJapgolly.args.mod.args = js.native
    
    def examples(list: js.Array[Example]): typingsJapgolly.args.mod.args = js.native
    
    def option(name: String, description: String): typingsJapgolly.args.mod.args = js.native
    def option(name: String, description: String, defaultValue: Any): typingsJapgolly.args.mod.args = js.native
    def option(name: String, description: String, defaultValue: Any, init: OptionInitFunction): typingsJapgolly.args.mod.args = js.native
    def option(name: String, description: String, defaultValue: Unit, init: OptionInitFunction): typingsJapgolly.args.mod.args = js.native
    def option(name: js.Tuple2[String, String], description: String): typingsJapgolly.args.mod.args = js.native
    def option(name: js.Tuple2[String, String], description: String, defaultValue: Any): typingsJapgolly.args.mod.args = js.native
    def option(name: js.Tuple2[String, String], description: String, defaultValue: Any, init: OptionInitFunction): typingsJapgolly.args.mod.args = js.native
    def option(name: js.Tuple2[String, String], description: String, defaultValue: Unit, init: OptionInitFunction): typingsJapgolly.args.mod.args = js.native
    
    def options(list: js.Array[Option]): typingsJapgolly.args.mod.args = js.native
