...
object ConfigurationOptions {
  ...
  def apply(
    ...
    name: String = null,
    usageFilter: /* output */ js.Any => CallbackTo[js.Any] = null,
    value: String = null,
    ...
    if (usageFilter != null) __obj.updateDynamic("usageFilter")(js.Any.fromFunction1((t0: /* output */ js.Any) => usageFilter(t0).runNow()))
