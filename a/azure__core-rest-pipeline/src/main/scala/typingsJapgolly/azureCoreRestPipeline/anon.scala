...
import typingsJapgolly.azureCoreRestPipeline.types3Dot1CoreRestPipelineMod.PipelinePhase
...
object anon {
  ...
  trait Phase extends StObject {
    ...
    var phase: js.UndefOr[
        typingsJapgolly.azureCoreRestPipeline.typesLatestCoreRestPipelineMod.PipelinePhase
      ] = js.undefined
  }
  object Phase {
    ...
    extension [Self <: Phase](x: Self) {
      ...
      inline def setPhase(value: typingsJapgolly.azureCoreRestPipeline.typesLatestCoreRestPipelineMod.PipelinePhase): Self = StObject.set(x, "phase", value.asInstanceOf[js.Any])
