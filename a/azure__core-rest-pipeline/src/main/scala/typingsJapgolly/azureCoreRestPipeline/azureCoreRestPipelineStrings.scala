...
import typingsJapgolly.azureCoreRestPipeline.typesLatestCoreRestPipelineMod.PipelinePhase
...
object azureCoreRestPipelineStrings {
  ...
  sealed trait DELETE
    extends StObject
       with HttpMethods
       with typingsJapgolly.azureCoreRestPipeline.types3Dot1CoreRestPipelineMod.HttpMethods
  ...
  sealed trait Deserialize
    extends StObject
       with PipelinePhase
       with typingsJapgolly.azureCoreRestPipeline.types3Dot1CoreRestPipelineMod.PipelinePhase
