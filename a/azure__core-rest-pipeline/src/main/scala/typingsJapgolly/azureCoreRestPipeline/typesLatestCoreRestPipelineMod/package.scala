...
import typingsJapgolly.azureCoreRestPipeline.typesLatestCoreRestPipelineMod.^
...
type RequestBodyType = ReadableStream | (js.Function0[ReadableStream | org.scalajs.dom.ReadableStream[js.typedarray.Uint8Array]]) | org.scalajs.dom.ReadableStream[js.typedarray.Uint8Array] | Blob | js.typedarray.ArrayBuffer | js.typedarray.ArrayBufferView | FormData | String | Null
