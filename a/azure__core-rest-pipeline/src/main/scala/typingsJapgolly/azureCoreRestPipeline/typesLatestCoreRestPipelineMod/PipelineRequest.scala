package typingsJapgolly.azureCoreRestPipeline.typesLatestCoreRestPipelineMod
...
object PipelineRequest {
  ...
  extension [Self <: PipelineRequest](x: Self) {
    ...
    inline def setBodyCallbackTo(value: CallbackTo[ReadableStream | org.scalajs.dom.ReadableStream[js.typedarray.Uint8Array]]): Self = StObject.set(x, "body", value.toJsFn)
