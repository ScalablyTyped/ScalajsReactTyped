...
import typingsJapgolly.antvG2.anon.PartialBBox
...
object libUtilBboxMod {
  ...
  object BBox {
    ...
    inline def fromObject(bbox: typingsJapgolly.antvGBase.libTypesMod.BBox): BBox = ^.asInstanceOf[js.Dynamic].applyDynamic("fromObject")(bbox.asInstanceOf[js.Any]).asInstanceOf[BBox]
