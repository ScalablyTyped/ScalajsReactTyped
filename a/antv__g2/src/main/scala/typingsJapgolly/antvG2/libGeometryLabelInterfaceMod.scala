...
import typingsJapgolly.antvG2.anon.Padding
import typingsJapgolly.antvG2.anon.Path
import typingsJapgolly.antvG2.anon.`0`
...
object libGeometryLabelInterfaceMod {
  ...
  - typingsJapgolly.antvG2.libGeometryLabelInterfaceMod.LabelPointCfg because var conflicts: content, rotate. Inlined x, y, start, color, textAlign, textBaseline, angle, r */ trait LabelItem
    extends StObject
       with LabelCfg {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antvG2.antvG2Strings.start
    - typingsJapgolly.antvG2.antvG2Strings.center
    - typingsJapgolly.antvG2.antvG2Strings.end
    - typingsJapgolly.antvG2.antvG2Strings.left
    - typingsJapgolly.antvG2.antvG2Strings.right
  */
  trait TextAlign extends StObject
  object TextAlign {
    
    inline def center: typingsJapgolly.antvG2.antvG2Strings.center = "center".asInstanceOf[typingsJapgolly.antvG2.antvG2Strings.center]
    
    inline def end: typingsJapgolly.antvG2.antvG2Strings.end = "end".asInstanceOf[typingsJapgolly.antvG2.antvG2Strings.end]
    
    inline def left: typingsJapgolly.antvG2.antvG2Strings.left = "left".asInstanceOf[typingsJapgolly.antvG2.antvG2Strings.left]
    
    inline def right: typingsJapgolly.antvG2.antvG2Strings.right = "right".asInstanceOf[typingsJapgolly.antvG2.antvG2Strings.right]
    
    inline def start: typingsJapgolly.antvG2.antvG2Strings.start = "start".asInstanceOf[typingsJapgolly.antvG2.antvG2Strings.start]
  }
