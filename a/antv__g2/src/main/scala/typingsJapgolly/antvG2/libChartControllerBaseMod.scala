...
object libChartControllerBaseMod {
  
  /* note: abstract class */ @JSImport("@antv/g2/lib/chart/controller/base", "Controller")
  @js.native
  open class Controller[O] protected () extends StObject {
