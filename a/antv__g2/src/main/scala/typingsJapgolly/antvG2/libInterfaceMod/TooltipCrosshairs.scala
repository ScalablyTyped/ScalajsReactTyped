...
import typingsJapgolly.antvComponent.libTypesMod.CrosshairLineCfg
import typingsJapgolly.antvComponent.libTypesMod.CrosshairTextBackgroundCfg
import typingsJapgolly.antvG2.antvG2Strings.x
import typingsJapgolly.antvG2.antvG2Strings.xy
...
object TooltipCrosshairs {
  ...
  extension [Self <: TooltipCrosshairs](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.antvG2.antvG2Strings.x | y | xy): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
