...
object mod {
  ...
  open class ComponentController[O] protected ()
    extends typingsJapgolly.antvG2.libCoreMod.ComponentController[O] {
  ...
  open class Coordinate ()
    extends typingsJapgolly.antvG2.libCoreMod.Coordinate {
  ...
  open class Element protected ()
    extends typingsJapgolly.antvG2.libCoreMod.Element {
  ...
  open class Facet[C /* <: FacetCfg[FacetData] */, F /* <: FacetData */] protected ()
    extends typingsJapgolly.antvG2.libCoreMod.Facet[C, F] {
  ...
  open class Geometry[S /* <: ShapePoint */] protected ()
    extends typingsJapgolly.antvG2.libCoreMod.Geometry[S] {
    /**
      * 创建 Geometry 实例。
      * @param cfg
      */
  ...
  open class GeometryLabel protected ()
    extends typingsJapgolly.antvG2.libCoreMod.GeometryLabel {
  ...
  open class InteractionAction[T] protected ()
    extends typingsJapgolly.antvG2.libCoreMod.InteractionAction[T] {
  ...
  open class TooltipController ()
    extends typingsJapgolly.antvG2.libCoreMod.TooltipController
