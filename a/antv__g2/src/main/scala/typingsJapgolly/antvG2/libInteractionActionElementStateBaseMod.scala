...
object libInteractionActionElementStateBaseMod {
  ...
  trait StateBase
    ...
    /**
      ...
      */
    /* protected */ def hasState(element: typingsJapgolly.antvG2.libGeometryElementMod.default): Boolean = js.native
    
    /**
      * 设置状态激活
      * @param enable 状态值
      */
    /* protected */ def setElementState(element: typingsJapgolly.antvG2.libGeometryElementMod.default, enable: Boolean): Unit = js.native
