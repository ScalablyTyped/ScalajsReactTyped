...
import typingsJapgolly.antvG2.mod.View
...
object AnonAutoSetAxis {
  ...
  def apply(
    ...
    eachView: (/* view */ View, /* facet */ js.Any) => Callback = null,
    ...
    if (eachView != null) __obj.updateDynamic("eachView")(js.Any.fromFunction2((t0: /* view */ typingsJapgolly.antvG2.mod.View, t1: /* facet */ js.Any) => eachView(t0, t1).runNow()))
