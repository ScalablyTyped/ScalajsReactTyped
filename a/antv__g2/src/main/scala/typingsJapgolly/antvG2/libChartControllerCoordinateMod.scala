...
object libChartControllerCoordinateMod {
  ...
  object CoordinateController {
    ...
    inline def apply(
      ...
      getOption: CallbackTo[CoordinateOption],
      ...
      transpose: CallbackTo[CoordinateController],
      update: CoordinateOption => CoordinateController,
      wrapperOption: Any
    ): CoordinateController = {
      val __obj = js.Dynamic.literal(adjust = js.Any.fromFunction2(adjust), coordinate = coordinate.asInstanceOf[js.Any], create = js.Any.fromFunction2(create), execActions = execActions.asInstanceOf[js.Any], getCoordinate = getCoordinate.toJsFn, getOption = getOption.toJsFn, hasAction = js.Any.fromFunction1(hasAction), option = option.asInstanceOf[js.Any], reflect = js.Any.fromFunction1(reflect), rotate = js.Any.fromFunction1(rotate), scale = js.Any.fromFunction2(scale), transpose = transpose.toJsFn, update = js.Any.fromFunction1(update), wrapperOption = wrapperOption.asInstanceOf[js.Any])
    ...
    extension [Self <: CoordinateController](x: Self) {
      ...
      inline def setGetOption(value: CallbackTo[CoordinateOption]): Self = StObject.set(x, "getOption", value.toJsFn)
      ...
      inline def setReflect(value: typingsJapgolly.antvG2.antvG2Strings.x | y => CoordinateController): Self = StObject.set(x, "reflect", js.Any.fromFunction1(value))
      ...
      inline def setTranspose(value: CallbackTo[CoordinateController]): Self = StObject.set(x, "transpose", value.toJsFn)
