...
object libInteractionGrammarInteractionMod {
  ...
  trait GrammarInteraction
    extends typingsJapgolly.antvG2.libInteractionInteractionMod.default {
  ...
  object InteractionStep {
    ...
    extension [Self <: InteractionStep](x: Self) {
      ...
      inline def setActionFunction1(value: /* context */ IInteractionContext => Callback): Self = StObject.set(x, "action", js.Any.fromFunction1((t0: /* context */ IInteractionContext) => value(t0).runNow()))
      ...
      inline def setCallback(value: /* context */ IInteractionContext => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* context */ IInteractionContext) => value(t0).runNow()))
