...
import typingsJapgolly.antvG2.anon.EachView
import typingsJapgolly.antvG2.anon.StyleFill
import typingsJapgolly.antvG2.libChartViewMod.View
import typingsJapgolly.antvG2.libInterfaceMod.AxisCfg
import typingsJapgolly.antvG2.libInterfaceMod.Condition
...
import typingsJapgolly.antvG2.libInterfaceMod.FacetDataFilter
...
object libFacetFacetMod {
  
  /* note: abstract class */ @JSImport("@antv/g2/lib/facet/facet", "Facet")
  @js.native
  open class Facet[C /* <: FacetCfg[FacetData] */, F /* <: FacetData */] protected () extends StObject {
