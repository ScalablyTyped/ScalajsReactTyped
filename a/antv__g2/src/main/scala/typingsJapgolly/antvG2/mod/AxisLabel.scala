...
object AxisLabel {
  ...
  def apply(
    ...
    formatter: (/* text */ String, /* item */ js.Any, /* index */ Double) => CallbackTo[String] = null,
    htmlTemplate: (/* text */ String, /* item */ js.Any, /* index */ Double) => CallbackTo[String] = null,
    ...
    if (formatter != null) __obj.updateDynamic("formatter")(js.Any.fromFunction3((t0: /* text */ java.lang.String, t1: /* item */ js.Any, t2: /* index */ scala.Double) => formatter(t0, t1, t2).runNow()))
    if (htmlTemplate != null) __obj.updateDynamic("htmlTemplate")(js.Any.fromFunction3((t0: /* text */ java.lang.String, t1: /* item */ js.Any, t2: /* index */ scala.Double) => htmlTemplate(t0, t1, t2).runNow()))
