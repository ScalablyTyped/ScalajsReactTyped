...
object libInteractionActionElementStateMod {
  ...
  trait ElementState
    ...
    /** 组件的选项是否同 element 匹配 */
    /* protected */ def isMathItem(element: typingsJapgolly.antvG2.libGeometryElementMod.default, field: String, item: ListItem): Boolean = js.native
    ...
    /* protected */ def setStateByElement(element: typingsJapgolly.antvG2.libGeometryElementMod.default, enable: Boolean): Unit = js.native
