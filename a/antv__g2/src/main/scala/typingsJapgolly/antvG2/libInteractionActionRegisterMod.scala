...
import typingsJapgolly.antvG2.libInteractionActionBaseMod.default
...
object libInteractionActionRegisterMod {
  ...
  inline def createCallbackAction(callback: ActionCallback, context: IInteractionContext): typingsJapgolly.antvG2.libInteractionActionCallbackMod.default = (^.asInstanceOf[js.Dynamic].applyDynamic("createCallbackAction")(callback.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.antvG2.libInteractionActionCallbackMod.default]
