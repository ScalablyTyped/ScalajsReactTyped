...
import typingsJapgolly.antvG2.anon.PartialViewCfg
import typingsJapgolly.antvG2.antvG2Strings.annotation
import typingsJapgolly.antvG2.antvG2Strings.axis
import typingsJapgolly.antvG2.antvG2Strings.circle
import typingsJapgolly.antvG2.antvG2Strings.gestucre
import typingsJapgolly.antvG2.antvG2Strings.legend
...
import typingsJapgolly.antvG2.antvG2Strings.scrollbar
import typingsJapgolly.antvG2.antvG2Strings.slider
import typingsJapgolly.antvG2.antvG2Strings.tooltip
import typingsJapgolly.antvG2.antvG2Strings.tree
import typingsJapgolly.antvG2.antvG2Strings.x
import typingsJapgolly.antvG2.antvG2Strings.y
import typingsJapgolly.antvG2.libChartControllerBaseMod.Controller
import typingsJapgolly.antvG2.libChartLayoutMod.Layout
import typingsJapgolly.antvG2.libChartLayoutPaddingCalMod.PaddingCal
import typingsJapgolly.antvG2.libConstantMod.LAYER
import typingsJapgolly.antvG2.libDependentsMod.Attribute
import typingsJapgolly.antvG2.libDependentsMod.Coordinate
import typingsJapgolly.antvG2.libFacetMod.Facet
import typingsJapgolly.antvG2.libInteractionMod.Interaction
import typingsJapgolly.antvG2.libInterfaceMod.AxisOption
import typingsJapgolly.antvG2.libInterfaceMod.CircleCfg
import typingsJapgolly.antvG2.libInterfaceMod.ComponentOption
...
import typingsJapgolly.antvG2.libInterfaceMod.EventPayload
...
import typingsJapgolly.antvG2.libInterfaceMod.LegendOption
...
import typingsJapgolly.antvG2.libInterfaceMod.MirrorCfg
import typingsJapgolly.antvG2.libInterfaceMod.Options
import typingsJapgolly.antvG2.libInterfaceMod.Padding
import typingsJapgolly.antvG2.libInterfaceMod.Point
import typingsJapgolly.antvG2.libInterfaceMod.RectCfg
...
import typingsJapgolly.antvG2.libInterfaceMod.TooltipOption
import typingsJapgolly.antvG2.libInterfaceMod.TreeCfg
...
import typingsJapgolly.antvGBase.libInterfacesMod.ICanvas
...
object libChartViewMod {
  ...
  open class View protected ()
    ...
    /**
      ...
      * @returns [[Annotation]]
      */
    def annotation(): typingsJapgolly.antvG2.libChartControllerAnnotationMod.default = js.native
    ...
    /**
      ...
      */
    def coord(`type`: String): typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    def coord(`type`: String, coordinateCfg: CoordinateCfg): typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    def coord(`type`: CoordinateOption): typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    def coord(`type`: CoordinateOption, coordinateCfg: CoordinateCfg): typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    ...
    /**
      ...
      * @returns
      */
    def coordinate(): typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    def coordinate(option: CoordinateOption): typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    /**
      * 声明坐标系类型，并进行配置。
      *
      * ```ts
      ...
      * @returns
      */
    def coordinate(`type`: String): typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    def coordinate(`type`: String, coordinateCfg: CoordinateCfg): typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    
    /** 坐标系的位置大小，ViewBBox - padding = coordinateBBox。 */
    var coordinateBBox: BBox = js.native
    
    /** Coordinate 相关的控制器类，负责坐标系实例的创建、更新、变换等 */
    /* protected */ var coordinateController: typingsJapgolly.antvG2.libChartControllerCoordinateMod.default = js.native
    ...
    /** 所有的 geometry 实例。 */
    var geometries: js.Array[typingsJapgolly.antvG2.libGeometryBaseMod.default[ShapePoint]] = js.native
    ...
    def getController_annotation(name: annotation): typingsJapgolly.antvG2.libChartControllerAnnotationMod.default = js.native
    @JSName("getController")
    def getController_axis(name: axis): typingsJapgolly.antvG2.libChartControllerAxisMod.default = js.native
    @JSName("getController")
    def getController_gestucre(name: gestucre): typingsJapgolly.antvG2.libChartControllerGestureMod.default = js.native
    @JSName("getController")
    def getController_legend(name: legend): typingsJapgolly.antvG2.libChartControllerLegendMod.default = js.native
    @JSName("getController")
    def getController_scrollbar(name: scrollbar): typingsJapgolly.antvG2.libChartControllerScrollbarMod.default = js.native
    @JSName("getController")
    def getController_slider(name: slider): typingsJapgolly.antvG2.libChartControllerSliderMod.default = js.native
    @JSName("getController")
    def getController_tooltip(name: tooltip): typingsJapgolly.antvG2.libChartControllerTooltipMod.default = js.native
    ...
    /**
      ...
      * @returns
      */
    def getGeometries(): js.Array[typingsJapgolly.antvG2.libGeometryBaseMod.default[ShapePoint]] = js.native
    ...
    /**
      ...
      */
    def guide(): typingsJapgolly.antvG2.libChartControllerAnnotationMod.default = js.native
