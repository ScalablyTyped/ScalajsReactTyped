...
/* Inlined std.Partial<@antv/g2.@antv/g2/lib/geometry/path.PathCfg> */
trait PartialPathCfg extends StObject {
...
object PartialPathCfg {
  
  inline def apply(): PartialPathCfg = {
