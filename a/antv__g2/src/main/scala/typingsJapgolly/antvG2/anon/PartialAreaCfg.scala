...
/* Inlined std.Partial<@antv/g2.@antv/g2/lib/geometry/area.AreaCfg> */
trait PartialAreaCfg extends StObject {
...
object PartialAreaCfg {
  
  inline def apply(): PartialAreaCfg = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialAreaCfg]
  }
  
  extension [Self <: PartialAreaCfg](x: Self) {
