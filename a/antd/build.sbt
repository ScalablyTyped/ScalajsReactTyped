...
name := "antd"
version := "3.25.1-b860d5"
scalaVersion := "2.12.10"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.github.japgolly.scalajs-react" %%% "core" % "1.4.2",
  "com.olvind" %%% "scalablytyped-runtime" % "2.1.0",
  "org.gulliblytyped.japgolly" %%% "ant-design__create-react-context" % "0.2.4-48d0e8",
  ...
  "org.gulliblytyped.japgolly" %%% "rc-mentions" % "0.4.1-90f6b4",
  "org.gulliblytyped.japgolly" %%% "rc-menu" % "7.5.3-159a55",
  "org.gulliblytyped.japgolly" %%% "react" % "16.9-dt-20191025Z-992e25",
  "org.gulliblytyped.japgolly" %%% "react-slick" % "0.23-dt-20190503Z-337406",
