...
import typingsJapgolly.antd.anon.ClassName
import typingsJapgolly.antd.antdStrings.blur
import typingsJapgolly.antd.antdStrings.leave
import typingsJapgolly.antd.antdStrings.update
...
object libCarouselMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antd.antdStrings.scrollx
    - typingsJapgolly.antd.antdStrings.fade
  */
  trait CarouselEffect extends StObject
  object CarouselEffect {
    
    inline def fade: typingsJapgolly.antd.antdStrings.fade = "fade".asInstanceOf[typingsJapgolly.antd.antdStrings.fade]
    
    inline def scrollx: typingsJapgolly.antd.antdStrings.scrollx = "scrollx".asInstanceOf[typingsJapgolly.antd.antdStrings.scrollx]
  }
  ...
  object CarouselProps {
    ...
    extension [Self <: CarouselProps](x: Self) {
      ...
      inline def setAppendDots(value: /* dots */ Node => Element): Self = StObject.set(x, "appendDots", js.Any.fromFunction1(value))
