...
object ShowSearchType {
  ...
  def apply(
    ...
    if (filter != null) __obj.updateDynamic("filter")(js.Any.fromFunction3((t0: /* inputValue */ java.lang.String, t1: /* path */ js.Array[typingsJapgolly.antd.libCascaderMod.CascaderOptionType], t2: /* names */ typingsJapgolly.antd.libCascaderMod.FilledFieldNamesType) => filter(t0, t1, t2).runNow()))
    if (limit != null) __obj.updateDynamic("limit")(limit.asInstanceOf[js.Any])
    if (!js.isUndefined(matchInputWidth)) __obj.updateDynamic("matchInputWidth")(matchInputWidth.asInstanceOf[js.Any])
    if (render != null) __obj.updateDynamic("render")(js.Any.fromFunction4((t0: /* inputValue */ java.lang.String, t1: /* path */ js.Array[typingsJapgolly.antd.libCascaderMod.CascaderOptionType], t2: /* prefixCls */ js.UndefOr[java.lang.String], t3: /* names */ typingsJapgolly.antd.libCascaderMod.FilledFieldNamesType) => render(t0, t1, t2, t3).runNow()))
    if (sort != null) __obj.updateDynamic("sort")(js.Any.fromFunction4((t0: /* a */ js.Array[typingsJapgolly.antd.libCascaderMod.CascaderOptionType], t1: /* b */ js.Array[typingsJapgolly.antd.libCascaderMod.CascaderOptionType], t2: /* inputValue */ java.lang.String, t3: /* names */ typingsJapgolly.antd.libCascaderMod.FilledFieldNamesType) => sort(t0, t1, t2, t3).runNow()))
