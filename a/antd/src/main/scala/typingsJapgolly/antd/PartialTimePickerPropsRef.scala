...
trait PartialTimePickerPropsRef extends js.Object {
...
object PartialTimePickerPropsRef {
  @scala.inline
  def apply(
    addon: js.UndefOr[CallbackTo[Node]] = js.undefined,
    ...
    value: Moment = null
  ): PartialTimePickerPropsRef = {
    val __obj = js.Dynamic.literal()
    addon.foreach(p => __obj.updateDynamic("addon")(p.toJsFn))
    ...
    __obj.asInstanceOf[PartialTimePickerPropsRef]
  }
}
