...
object PickPickPickerTimePropsMo {
  ...
  def apply(
    ...
    disabledDate: /* date */ Moment => CallbackTo[Boolean] = null,
    ...
    onOk: /* date */ Moment => Callback = null,
    ...
    if (disabledDate != null) __obj.updateDynamic("disabledDate")(js.Any.fromFunction1((t0: /* date */ typingsJapgolly.moment.mod.Moment) => disabledDate(t0).runNow()))
    ...
    if (onOk != null) __obj.updateDynamic("onOk")(js.Any.fromFunction1((t0: /* date */ typingsJapgolly.moment.mod.Moment) => onOk(t0).runNow()))
    ...
    __obj.asInstanceOf[PickPickPickerTimePropsMo]
  }
}
