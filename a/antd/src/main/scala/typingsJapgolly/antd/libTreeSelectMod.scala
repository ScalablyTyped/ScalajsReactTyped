...
object libTreeSelectMod extends Shortcut {
  ...
  trait InternalTreeSelectType extends StObject {
    ...
    def apply[ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](props: Children & (TreeSelectProps[ValueType, OptionType])): Element = js.native
  }
  ...
  object TreeSelectProps {
    ...
    extension [Self <: TreeSelectProps[?, ?], ValueType, OptionType /* <: BaseOptionType | DefaultOptionType */](x: Self & (TreeSelectProps[ValueType, OptionType])) {
      ...
      inline def setSwitcherIconFunction1(
        value: (/* props */ AntTreeNodeProps) | (/* props */ typingsJapgolly.rcTree.esTreeNodeMod.TreeNodeProps[DataNode]) => Node
      ...
      inline def setTreeIconFunction1(value: /* props */ typingsJapgolly.rcTree.esTreeNodeMod.TreeNodeProps[DataNode] => Node): Self = StObject.set(x, "treeIcon", js.Any.fromFunction1(value))
  ...
  /* This means you don't have to write `default`, but can instead just say `libTreeSelectMod.foo` */
