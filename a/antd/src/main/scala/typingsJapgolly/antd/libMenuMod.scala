...
import typingsJapgolly.antd.libMenuMenuContextMod.MenuContextProps
...
object libMenuMod {
  ...
  object default {
    ...
    @js.native
    open class Item ()
      extends typingsJapgolly.antd.libMenuMenuItemMod.default
    /* static member */
    /* was `typeof Item` */
    object Item {
    ...
    @js.native
    def ItemGroup: js.Function1[/* hasChildrenProps */ MenuItemGroupProps, Element] = js.native
    inline def ItemGroup_=(x: js.Function1[/* hasChildrenProps */ MenuItemGroupProps, Element]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("ItemGroup")(x.asInstanceOf[js.Any])
    
    /* static member */
    /* was `typeof SubMenu` */
    @JSImport("antd/lib/menu", "default.SubMenu")
    @js.native
    def SubMenu: js.Function1[/* props */ SubMenuProps, typingsJapgolly.react.mod.global.JSX.Element] = js.native
    inline def SubMenu_=(x: js.Function1[/* props */ SubMenuProps, typingsJapgolly.react.mod.global.JSX.Element]): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("SubMenu")(x.asInstanceOf[js.Any])
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.antd.antdStrings.`vertical-left`
    - typingsJapgolly.antd.antdStrings.`vertical-right`
  ...
  */
  ...
  object MenuMode {
    ...
    inline def `vertical-left`: typingsJapgolly.antd.antdStrings.`vertical-left` = "vertical-left".asInstanceOf[typingsJapgolly.antd.antdStrings.`vertical-left`]
    
    inline def `vertical-right`: typingsJapgolly.antd.antdStrings.`vertical-right` = "vertical-right".asInstanceOf[typingsJapgolly.antd.antdStrings.`vertical-right`]
  }
  ...
  trait MenuProps extends StObject {
    ...
    var mode: js.UndefOr[typingsJapgolly.rcMenu.esInterfaceMod.MenuMode] = js.undefined
  ...
  object MenuProps {
    ...
    extension [Self <: MenuProps](x: Self) {
      ...
      inline def setMode(value: typingsJapgolly.rcMenu.esInterfaceMod.MenuMode): Self = StObject.set(x, "mode", value.asInstanceOf[js.Any])
