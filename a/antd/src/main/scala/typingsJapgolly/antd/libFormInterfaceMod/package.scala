...
package object libFormInterfaceMod {
  ...
  import typingsJapgolly.antd.libFormFormMod.WrappedFormInternalProps
  import typingsJapgolly.antd.libUnderscoreUtilTypeMod.Omit
  ...
  type ConnectedComponentClass[C /* <: ComponentType[_] */, P] = (ComponentClassP[(LibraryManagedAttributes[C, P]) with js.Object]) with (NonReactStatics[C, js.Object]) with Anon_WrappedComponent[C]
