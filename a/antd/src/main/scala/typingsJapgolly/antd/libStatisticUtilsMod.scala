...
object libStatisticUtilsMod {
  ...
  object FormatConfig {
    ...
    extension [Self <: FormatConfig](x: Self) {
      ...
      inline def setFormatterFunction2(value: (/* value */ valueType, /* config */ js.UndefOr[FormatConfig]) => Node): Self = StObject.set(x, "formatter", js.Any.fromFunction2(value))
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - js.Function2[
  / * value * / typingsJapgolly.antd.libStatisticUtilsMod.valueType, 
  / * config * / js.UndefOr[typingsJapgolly.antd.libStatisticUtilsMod.FormatConfig], 
