...
object libRadioMod extends js.Object {
  @js.native
  class Button ()
    extends typingsJapgolly.antd.libRadioRadioButtonMod.default
  
  @js.native
  class Group protected ()
    extends typingsJapgolly.antd.libRadioGroupMod.default {
    def this(props: RadioGroupProps) = this()
  }
  
  @js.native
  class default ()
    extends typingsJapgolly.antd.libRadioRadioMod.default
