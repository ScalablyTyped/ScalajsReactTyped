package typingsJapgolly.antd.libUnderscoreUtilTransButtonMod
...
trait TransButtonProps extends HTMLAttributes[HTMLDivElement] {
  ...
  var onClick_TransButtonProps: js.UndefOr[
    js.Function1[/* e */ js.UndefOr[ReactMouseEventFrom[org.scalajs.dom.raw.HTMLDivElement]], Unit]
  ] = js.undefined
}
...
object TransButtonProps {
  ...
  def apply(
    ...
    onClick: /* e */ js.UndefOr[ReactMouseEventFrom[org.scalajs.dom.raw.HTMLDivElement]] => Callback = null,
    ...
    if (onClick != null) __obj.updateDynamic("onClick")(js.Any.fromFunction1((t0: /* e */ js.UndefOr[japgolly.scalajs.react.ReactMouseEventFrom[org.scalajs.dom.raw.HTMLDivElement]]) => onClick(t0).runNow()))
