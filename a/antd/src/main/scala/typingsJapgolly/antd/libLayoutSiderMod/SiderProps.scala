package typingsJapgolly.antd.libLayoutSiderMod
...
object SiderProps {
  ...
  def apply(
    ...
    onBreakpoint: /* broken */ Boolean => Callback = null,
    ...
    onCollapse: (/* collapsed */ Boolean, /* type */ CollapseType) => Callback = null,
    ...
    if (onBreakpoint != null) __obj.updateDynamic("onBreakpoint")(js.Any.fromFunction1((t0: /* broken */ scala.Boolean) => onBreakpoint(t0).runNow()))
