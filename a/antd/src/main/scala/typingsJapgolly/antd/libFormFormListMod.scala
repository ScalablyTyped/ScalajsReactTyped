...
object libFormFormListMod extends Shortcut {
  ...
  trait FormListProps extends StObject {
    ...
    def children(fields: js.Array[FormListFieldData], operation: FormListOperation, meta: Errors): Node
  ...
  object FormListProps {
    ...
    inline def apply(
      children: (js.Array[FormListFieldData], FormListOperation, Errors) => Node,
    ...
    extension [Self <: FormListProps](x: Self) {
      ...
      inline def setChildren(value: (js.Array[FormListFieldData], FormListOperation, Errors) => Node): Self = StObject.set(x, "children", js.Any.fromFunction3(value))
  ...
  /* This means you don't have to write `default`, but can instead just say `libFormFormListMod.foo` */
