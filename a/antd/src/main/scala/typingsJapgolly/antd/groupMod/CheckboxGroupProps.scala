...
object CheckboxGroupProps {
  ...
  def apply(
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* checkedValue */ js.Array[typingsJapgolly.antd.groupMod.CheckboxValueType]) => onChange(t0).runNow()))
