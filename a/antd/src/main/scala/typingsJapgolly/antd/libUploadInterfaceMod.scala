...
import typingsJapgolly.antd.anon.PercentNumber
...
object libUploadInterfaceMod {
  ...
  trait RcFile
    extends StObject
       with typingsJapgolly.rcUpload.esInterfaceMod.RcFile {
  ...
  trait ShowUploadListInterface extends StObject {
    ...
    var downloadIcon: js.UndefOr[Node | (js.Function1[/* file */ UploadFile[Any], Node])] = js.undefined
    
    var previewIcon: js.UndefOr[Node | (js.Function1[/* file */ UploadFile[Any], Node])] = js.undefined
    
    var removeIcon: js.UndefOr[Node | (js.Function1[/* file */ UploadFile[Any], Node])] = js.undefined
  ...
  object ShowUploadListInterface {
    ...
    extension [Self <: ShowUploadListInterface](x: Self) {
      ...
      inline def setDownloadIcon(value: Node | (js.Function1[/* file */ UploadFile[Any], Node])): Self = StObject.set(x, "downloadIcon", value.asInstanceOf[js.Any])
      
      inline def setDownloadIconFunction1(value: /* file */ UploadFile[Any] => Node): Self = StObject.set(x, "downloadIcon", js.Any.fromFunction1(value))
      
      inline def setDownloadIconNull: Self = StObject.set(x, "downloadIcon", null)
      
      inline def setDownloadIconUndefined: Self = StObject.set(x, "downloadIcon", js.undefined)
      
      inline def setDownloadIconVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "downloadIcon", js.Array(value*))
      
      inline def setDownloadIconVdomElement(value: VdomElement): Self = StObject.set(x, "downloadIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setPreviewIcon(value: Node | (js.Function1[/* file */ UploadFile[Any], Node])): Self = StObject.set(x, "previewIcon", value.asInstanceOf[js.Any])
      
      inline def setPreviewIconFunction1(value: /* file */ UploadFile[Any] => Node): Self = StObject.set(x, "previewIcon", js.Any.fromFunction1(value))
      ...
      inline def setPreviewIconVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "previewIcon", js.Array(value*))
      
      inline def setPreviewIconVdomElement(value: VdomElement): Self = StObject.set(x, "previewIcon", value.rawElement.asInstanceOf[js.Any])
      
      inline def setRemoveIcon(value: Node | (js.Function1[/* file */ UploadFile[Any], Node])): Self = StObject.set(x, "removeIcon", value.asInstanceOf[js.Any])
      
      inline def setRemoveIconFunction1(value: /* file */ UploadFile[Any] => Node): Self = StObject.set(x, "removeIcon", js.Any.fromFunction1(value))
  ...
  */
  ...
  object UploadFileStatus {
    ...
    inline def done: typingsJapgolly.antd.antdStrings.done = "done".asInstanceOf[typingsJapgolly.antd.antdStrings.done]
    
    inline def error: typingsJapgolly.antd.antdStrings.error = "error".asInstanceOf[typingsJapgolly.antd.antdStrings.error]
    
    inline def removed: typingsJapgolly.antd.antdStrings.removed = "removed".asInstanceOf[typingsJapgolly.antd.antdStrings.removed]
    ...
    inline def uploading: typingsJapgolly.antd.antdStrings.uploading = "uploading".asInstanceOf[typingsJapgolly.antd.antdStrings.uploading]
  }
  ...
  trait UploadListProps[T] extends StObject {
    ...
    var appendAction: js.UndefOr[Node] = js.undefined
    ...
    var iconRender: js.UndefOr[
        js.Function2[/* file */ UploadFile[T], /* listType */ js.UndefOr[UploadListType], Node]
      ] = js.undefined
  ...
  object UploadListProps {
    ...
    extension [Self <: UploadListProps[?], T](x: Self & UploadListProps[T]) {
      ...
      inline def setAppendAction(value: VdomNode): Self = StObject.set(x, "appendAction", value.rawNode.asInstanceOf[js.Any])
      
      inline def setAppendActionNull: Self = StObject.set(x, "appendAction", null)
      
      inline def setAppendActionUndefined: Self = StObject.set(x, "appendAction", js.undefined)
      
      inline def setAppendActionVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "appendAction", js.Array(value*))
      
      inline def setAppendActionVdomElement(value: VdomElement): Self = StObject.set(x, "appendAction", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setIconRender(value: (/* file */ UploadFile[T], /* listType */ js.UndefOr[UploadListType]) => Node): Self = StObject.set(x, "iconRender", js.Any.fromFunction2(value))
      ...
      inline def setItemRender(
        value: (/* originNode */ Element, /* file */ UploadFile[Any], /* fileList */ js.Array[UploadFile[T]], /* actions */ Download) => Node
      ...
      inline def setOnDownload(value: /* file */ UploadFile[T] => Callback): Self = StObject.set(x, "onDownload", js.Any.fromFunction1((t0: /* file */ UploadFile[T]) => value(t0).runNow()))
      
      inline def setOnDownloadUndefined: Self = StObject.set(x, "onDownload", js.undefined)
      
      inline def setOnPreview(value: /* file */ UploadFile[T] => Callback): Self = StObject.set(x, "onPreview", js.Any.fromFunction1((t0: /* file */ UploadFile[T]) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.antd.antdStrings.picture
    - typingsJapgolly.antd.antdStrings.`picture-card`
  */
  trait UploadListType extends StObject
  object UploadListType {
    
    inline def picture: typingsJapgolly.antd.antdStrings.picture = "picture".asInstanceOf[typingsJapgolly.antd.antdStrings.picture]
    
    inline def `picture-card`: typingsJapgolly.antd.antdStrings.`picture-card` = "picture-card".asInstanceOf[typingsJapgolly.antd.antdStrings.`picture-card`]
  ...
  object UploadProps {
    ...
    extension [Self <: UploadProps[?], T](x: Self & UploadProps[T]) {
      ...
      inline def setOnChange(value: /* info */ UploadChangeParam[UploadFile[T]] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* info */ UploadChangeParam[UploadFile[T]]) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antd.antdStrings.drag
    - typingsJapgolly.antd.antdStrings.select_
  */
  trait UploadType extends StObject
  object UploadType {
    
    inline def drag: typingsJapgolly.antd.antdStrings.drag = "drag".asInstanceOf[typingsJapgolly.antd.antdStrings.drag]
