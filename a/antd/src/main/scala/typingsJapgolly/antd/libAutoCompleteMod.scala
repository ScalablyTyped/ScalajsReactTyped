...
import typingsJapgolly.antd.anon.Option
...
object libAutoCompleteMod extends Shortcut {
  ...
  @js.native
  val default: (js.Function1[/* props */ Children & (AutoCompleteProps[Any, DefaultOptionType]), Element]) & Option = js.native
  ...
  type DataSourceItemType = DataSourceItemObject | Node
  
  type _To = (js.Function1[/* props */ Children & (AutoCompleteProps[Any, DefaultOptionType]), Element]) & Option
  
  /* This means you don't have to write `default`, but can instead just say `libAutoCompleteMod.foo` */
  override def _to: (js.Function1[/* props */ Children & (AutoCompleteProps[Any, DefaultOptionType]), Element]) & Option = default
}
