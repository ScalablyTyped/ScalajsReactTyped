package typingsJapgolly.antd.libUploadDraggerMod
...
object DraggerProps {
  ...
  def apply(
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* info */ typingsJapgolly.antd.libUploadInterfaceMod.UploadChangeParam[typingsJapgolly.antd.libUploadInterfaceMod.UploadFile]) => onChange(t0).runNow()))
    if (onDownload != null) __obj.updateDynamic("onDownload")(js.Any.fromFunction1((t0: /* file */ typingsJapgolly.antd.libUploadInterfaceMod.UploadFile) => onDownload(t0).runNow()))
    if (onPreview != null) __obj.updateDynamic("onPreview")(js.Any.fromFunction1((t0: /* file */ typingsJapgolly.antd.libUploadInterfaceMod.UploadFile) => onPreview(t0).runNow()))
    if (onRemove != null) __obj.updateDynamic("onRemove")(js.Any.fromFunction1((t0: /* file */ typingsJapgolly.antd.libUploadInterfaceMod.UploadFile) => onRemove(t0).runNow()))
