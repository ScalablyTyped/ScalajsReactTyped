...
trait WeakValidationMapStatisticProps extends js.Object {
  ...
  var prefix: js.UndefOr[Validator[js.UndefOr[Null | Node]]] = js.undefined
  ...
  var suffix: js.UndefOr[Validator[js.UndefOr[Null | Node]]] = js.undefined
  var title: js.UndefOr[Validator[js.UndefOr[Null | Node]]] = js.undefined
  var value: js.UndefOr[Validator[js.UndefOr[Null | valueType]]] = js.undefined
  var valueRender: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* node */ Node, Node]) | Null]]] = js.undefined
...
object WeakValidationMapStatisticProps {
  ...
  def apply(
    ...
    prefix: Validator[js.UndefOr[Null | Node]] = null,
    prefixCls: Validator[js.UndefOr[Null | String]] = null,
    style: Validator[js.UndefOr[CSSProperties | Null]] = null,
    suffix: Validator[js.UndefOr[Null | Node]] = null,
    title: Validator[js.UndefOr[Null | Node]] = null,
    value: Validator[js.UndefOr[Null | valueType]] = null,
    valueRender: Validator[js.UndefOr[(js.Function1[/* node */ Node, Node]) | Null]] = null,
