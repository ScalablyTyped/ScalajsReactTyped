package typingsJapgolly.antd.draggerMod
...
import typingsJapgolly.antd.uploadInterfaceMod.PreviewFileHandler
...
import typingsJapgolly.antd.uploadInterfaceMod.TransformFileHandler
