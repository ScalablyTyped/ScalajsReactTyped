...
object libTypographyLinkMod extends Shortcut {
  
  @JSImport("antd/lib/typography/Link", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[LinkProps & RefAttributes[HTMLElement]] = js.native
  ...
  type _To = ForwardRefExoticComponent[LinkProps & RefAttributes[HTMLElement]]
  
  /* This means you don't have to write `default`, but can instead just say `libTypographyLinkMod.foo` */
  override def _to: ForwardRefExoticComponent[LinkProps & RefAttributes[HTMLElement]] = default
}
