...
trait ScrollNumber
  ...
  def renderScrollNumber(hasGetPrefixCls: ConfigConsumerProps): (CElement[_, japgolly.scalajs.react.raw.React.Component[js.Object, js.Object]]) | japgolly.scalajs.react.raw.React.Element = js.native
}
