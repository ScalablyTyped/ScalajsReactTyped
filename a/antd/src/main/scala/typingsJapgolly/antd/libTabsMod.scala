...
object libTabsMod {
  ...
  */
  ...
  trait TabsProps extends StObject {
    ...
    var moreIcon: js.UndefOr[Node] = js.undefined
    ...
    var onEdit: js.UndefOr[
        js.Function2[
          /* e */ ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element] | String, 
          /* action */ add | remove, 
          Unit
        ]
      ] = js.undefined
    ...
    var onTabClick: js.UndefOr[
        js.Function2[
          /* activeKey */ String, 
          /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element] | ReactMouseEventFrom[org.scalajs.dom.Element], 
          Unit
        ]
      ] = js.undefined
  ...
  object TabsProps {
    ...
    extension [Self <: TabsProps](x: Self) {
      ...
      inline def setAddIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "addIcon", js.Array(value*))
      ...
      inline def setMoreIcon(value: VdomNode): Self = StObject.set(x, "moreIcon", value.rawNode.asInstanceOf[js.Any])
      
      inline def setMoreIconNull: Self = StObject.set(x, "moreIcon", null)
      
      inline def setMoreIconUndefined: Self = StObject.set(x, "moreIcon", js.undefined)
      
      inline def setMoreIconVarargs(value: (Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*): Self = StObject.set(x, "moreIcon", js.Array(value*))
      
      inline def setMoreIconVdomElement(value: VdomElement): Self = StObject.set(x, "moreIcon", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setOnChange(value: /* activeKey */ String => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* activeKey */ String) => value(t0).runNow()))
      ...
      ): Self = StObject.set(x, "onEdit", js.Any.fromFunction2((t0: /* e */ ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element] | String, t1: /* action */ add | remove) => (value(t0, t1)).runNow()))
      ...
      ): Self = StObject.set(x, "onTabClick", js.Any.fromFunction2((t0: /* activeKey */ String, t1: /* e */ ReactKeyboardEventFrom[org.scalajs.dom.Element] | ReactMouseEventFrom[org.scalajs.dom.Element]) => (value(t0, t1)).runNow()))
      
      inline def setOnTabClickUndefined: Self = StObject.set(x, "onTabClick", js.undefined)
      
      inline def setOnTabScroll(value: /* info */ Direction => Callback): Self = StObject.set(x, "onTabScroll", js.Any.fromFunction1((t0: /* info */ Direction) => value(t0).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.antd.antdStrings.card
    - typingsJapgolly.antd.antdStrings.`editable-card`
  */
  trait TabsType extends StObject
  object TabsType {
    
    inline def card: typingsJapgolly.antd.antdStrings.card = "card".asInstanceOf[typingsJapgolly.antd.antdStrings.card]
    
    inline def `editable-card`: typingsJapgolly.antd.antdStrings.`editable-card` = "editable-card".asInstanceOf[typingsJapgolly.antd.antdStrings.`editable-card`]
    
    inline def line: typingsJapgolly.antd.antdStrings.line = "line".asInstanceOf[typingsJapgolly.antd.antdStrings.line]
  }
}
