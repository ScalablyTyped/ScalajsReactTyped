package typingsJapgolly.antd.esInputDashNumberMod
...
/* Inlined parent antd.antd/es/_util/type.Omit<react.react.InputHTMLAttributes<std.HTMLInputElement>, antd.antd/es/input-number.OmitAttrs> */
