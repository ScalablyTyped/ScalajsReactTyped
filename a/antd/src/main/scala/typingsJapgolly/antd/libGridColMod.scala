...
object libGridColMod extends Shortcut {
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Double
    - typingsJapgolly.antd.antdStrings.none
    - typingsJapgolly.antd.antdStrings.auto
    - java.lang.String
  */
  ...
  /* This means you don't have to write `default`, but can instead just say `libGridColMod.foo` */
