...
import typingsJapgolly.antd.groupMod.AbstractCheckboxGroupProps
...
object RadioGroupProps {
  ...
  def apply(
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.antd.radioInterfaceMod.RadioChangeEvent) => onChange(t0).runNow()))
