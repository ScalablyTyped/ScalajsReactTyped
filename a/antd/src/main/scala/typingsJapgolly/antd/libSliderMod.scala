...
import typingsJapgolly.antd.anon.PrefixCls
...
object libSliderMod extends Shortcut {
  ...
  type HandleGeneratorFn = js.Function1[/* config */ PrefixCls, Element]
  ...
  trait SliderBaseProps extends StObject {
    ...
    /**
      ...
      */
    var tipFormatter: js.UndefOr[Null | (js.Function1[/* value */ js.UndefOr[Double], Node])] = js.undefined
  ...
  object SliderBaseProps {
    ...
    extension [Self <: SliderBaseProps](x: Self) {
      ...
      inline def setTipFormatter(value: /* value */ js.UndefOr[Double] => Node): Self = StObject.set(x, "tipFormatter", js.Any.fromFunction1(value))
  ...
  type SliderMarks = js.UndefOr[Record[String | Double, Node | MarkObj]]
  ...
  object SliderRangeProps {
    ...
    extension [Self <: SliderRangeProps](x: Self) {
      ...
      inline def setOnAfterChange(value: /* value */ js.Tuple2[Double, Double] => Callback): Self = StObject.set(x, "onAfterChange", js.Any.fromFunction1((t0: /* value */ js.Tuple2[Double, Double]) => value(t0).runNow()))
      
      inline def setOnAfterChangeUndefined: Self = StObject.set(x, "onAfterChange", js.undefined)
      
      inline def setOnChange(value: /* value */ js.Tuple2[Double, Double] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* value */ js.Tuple2[Double, Double]) => value(t0).runNow()))
  ...
  object SliderSingleProps {
    ...
    extension [Self <: SliderSingleProps](x: Self) {
      ...
      inline def setOnAfterChange(value: /* value */ Double => Callback): Self = StObject.set(x, "onAfterChange", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
  ...
  trait SliderTooltipProps extends StObject {
    ...
    var formatter: js.UndefOr[Null | (js.Function1[/* value */ js.UndefOr[Double], Node])] = js.undefined
  ...
  object SliderTooltipProps {
    ...
    extension [Self <: SliderTooltipProps](x: Self) {
      ...
      inline def setFormatter(value: /* value */ js.UndefOr[Double] => Node): Self = StObject.set(x, "formatter", js.Any.fromFunction1(value))
