...
object libPageHeaderMod extends Shortcut {
  
  @JSImport("antd/lib/page-header", JSImport.Default)
  @js.native
  val default: FC[PageHeaderProps] = js.native
  ...
  trait PageHeaderProps extends StObject {
    ...
    var onBack: js.UndefOr[js.Function1[/* e */ js.UndefOr[ReactMouseEventFrom[HTMLDivElement]], Unit]] = js.undefined
  ...
  object PageHeaderProps {
    ...
    extension [Self <: PageHeaderProps](x: Self) {
      ...
      inline def setOnBack(value: /* e */ js.UndefOr[ReactMouseEventFrom[HTMLDivElement]] => Callback): Self = StObject.set(x, "onBack", js.Any.fromFunction1((t0: /* e */ js.UndefOr[ReactMouseEventFrom[HTMLDivElement]]) => value(t0).runNow()))
  ...
  type _To = FC[PageHeaderProps]
  
  /* This means you don't have to write `default`, but can instead just say `libPageHeaderMod.foo` */
  override def _to: FC[PageHeaderProps] = default
}
