...
import typingsJapgolly.antd.libTableInterfaceMod.ExpandType
...
object libTableHooksUseSelectionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antd.libTableInterfaceMod.SelectionItem
    - typingsJapgolly.antd.antdStrings.SELECT_ALL
    - typingsJapgolly.antd.antdStrings.SELECT_INVERT
    - typingsJapgolly.antd.antdStrings.SELECT_NONE
  */
  ...
  object UseSelectionConfig {
    ...
    inline def apply[RecordType](
      ...
      getRowKey: (RecordType, /* index */ js.UndefOr[Double]) => typingsJapgolly.rcTable.libInterfaceMod.Key,
      locale: TableLocale,
    ...
    extension [Self <: UseSelectionConfig[?], RecordType](x: Self & UseSelectionConfig[RecordType]) {
      ...
      inline def setGetRowKey(value: (RecordType, /* index */ js.UndefOr[Double]) => typingsJapgolly.rcTable.libInterfaceMod.Key): Self = StObject.set(x, "getRowKey", js.Any.fromFunction2(value))
