...
import typingsJapgolly.antd.antdStrings.inner
...
object libCardCardMod extends Shortcut {
  
  @JSImport("antd/lib/card/Card", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[CardProps & RefAttributes[HTMLDivElement]] = js.native
  ...
  trait CardProps extends StObject {
    ...
    var cover: js.UndefOr[Node] = js.undefined
  ...
  object CardProps {
    ...
    extension [Self <: CardProps](x: Self) {
      ...
      inline def setCover(value: VdomNode): Self = StObject.set(x, "cover", value.rawNode.asInstanceOf[js.Any])
      ...
      inline def setCoverVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "cover", js.Array(value*))
      
      inline def setCoverVdomElement(value: VdomElement): Self = StObject.set(x, "cover", value.rawElement.asInstanceOf[js.Any])
      ...
      inline def setTabListVarargs(value: CardTabListType*): Self = StObject.set(x, "tabList", js.Array(value*))
  ...
  */
  ...
  type _To = ForwardRefExoticComponent[CardProps & RefAttributes[HTMLDivElement]]
  
  /* This means you don't have to write `default`, but can instead just say `libCardCardMod.foo` */
  override def _to: ForwardRefExoticComponent[CardProps & RefAttributes[HTMLDivElement]] = default
}
