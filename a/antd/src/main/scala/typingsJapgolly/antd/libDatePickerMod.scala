...
import typingsJapgolly.antd.anon.OmitPickerDatePropsMoment
import typingsJapgolly.antd.anon.OmitPickerTimePropsMoment
...
object libDatePickerMod {
  ...
  object default {
    ...
    open class RangePicker protected ()
      extends Component[
              typingsJapgolly.antd.libDatePickerGeneratePickerMod.RangePickerProps[Moment], 
              Any, 
              Any
            ] {
      def this(props: typingsJapgolly.antd.libDatePickerGeneratePickerMod.RangePickerProps[Moment]) = this()
      def this(props: typingsJapgolly.antd.libDatePickerGeneratePickerMod.RangePickerProps[Moment], context: Any) = this()
    }
    @JSImport("antd/lib/date-picker", "default.RangePicker")
    @js.native
    def RangePicker: PickerComponentClass[typingsJapgolly.antd.libDatePickerGeneratePickerMod.RangePickerProps[Moment], Any] = js.native
    inline def RangePicker_=(
      x: PickerComponentClass[typingsJapgolly.antd.libDatePickerGeneratePickerMod.RangePickerProps[Moment], Any]
  ...
  object MonthPickerProps {
    ...
    inline def apply(): MonthPickerProps = {
    ...
    extension [Self <: MonthPickerProps](x: Self) {
      ...
      inline def setDisabledTime(value: /* date */ Moment | Null => DisabledTimes): Self = StObject.set(x, "disabledTime", js.Any.fromFunction1(value))
      ...
      inline def setShowTime(value: Boolean | SharedTimeProps[Moment]): Self = StObject.set(x, "showTime", value.asInstanceOf[js.Any])
  ...
  type RangePickerProps = typingsJapgolly.antd.libDatePickerGeneratePickerMod.RangePickerProps[Moment]
  ...
  object WeekPickerProps {
    ...
    inline def apply(): WeekPickerProps = {
      val __obj = js.Dynamic.literal()
