...
trait FilterDropdownProps extends StObject {
  ...
  var selectedKeys: js.Array[typingsJapgolly.react.mod.Key] = js.native
  
  def setSelectedKeys(selectedKeys: js.Array[typingsJapgolly.react.mod.Key]): Unit = js.native
