...
import typingsJapgolly.antd.anon.Compare
...
trait ColumnGroupType[RecordType] extends StObject {
  ...
  var key: js.UndefOr[typingsJapgolly.rcTable.libInterfaceMod.Key] = js.undefined
...
object ColumnGroupType {
  ...
  extension [Self <: ColumnGroupType[?], RecordType](x: Self & ColumnGroupType[RecordType]) {
    ...
    inline def setFilterDropdown(value: Node | (js.Function1[/* props */ FilterDropdownProps, Node])): Self = StObject.set(x, "filterDropdown", value.asInstanceOf[js.Any])
    
    inline def setFilterDropdownFunction1(value: /* props */ FilterDropdownProps => Node): Self = StObject.set(x, "filterDropdown", js.Any.fromFunction1(value))
    
    inline def setFilterDropdownNull: Self = StObject.set(x, "filterDropdown", null)
    ...
    inline def setFilterDropdownVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "filterDropdown", js.Array(value*))
    
    inline def setFilterDropdownVdomElement(value: VdomElement): Self = StObject.set(x, "filterDropdown", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def setFilterIcon(value: Node | (js.Function1[/* filtered */ Boolean, Node])): Self = StObject.set(x, "filterIcon", value.asInstanceOf[js.Any])
    
    inline def setFilterIconFunction1(value: /* filtered */ Boolean => Node): Self = StObject.set(x, "filterIcon", js.Any.fromFunction1(value))
    
    inline def setFilterIconNull: Self = StObject.set(x, "filterIcon", null)
    
    inline def setFilterIconUndefined: Self = StObject.set(x, "filterIcon", js.undefined)
    
    inline def setFilterIconVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "filterIcon", js.Array(value*))
    
    inline def setFilterIconVdomElement(value: VdomElement): Self = StObject.set(x, "filterIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def setKey(value: typingsJapgolly.rcTable.libInterfaceMod.Key): Self = StObject.set(x, "key", value.asInstanceOf[js.Any])
    ...
    inline def setOnFilterDropdownOpenChange(value: /* open */ Boolean => Callback): Self = StObject.set(x, "onFilterDropdownOpenChange", js.Any.fromFunction1((t0: /* open */ Boolean) => value(t0).runNow()))
    
    inline def setOnFilterDropdownOpenChangeUndefined: Self = StObject.set(x, "onFilterDropdownOpenChange", js.undefined)
    
    inline def setOnFilterDropdownVisibleChange(value: /* visible */ Boolean => Callback): Self = StObject.set(x, "onFilterDropdownVisibleChange", js.Any.fromFunction1((t0: /* visible */ Boolean) => value(t0).runNow()))
    ...
    inline def setTitleFunction1(value: /* props */ ColumnTitleProps[RecordType] => Node): Self = StObject.set(x, "title", js.Any.fromFunction1(value))
