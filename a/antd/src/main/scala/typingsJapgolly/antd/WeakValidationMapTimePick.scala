...
trait WeakValidationMapTimePick extends js.Object {
  var addon: js.UndefOr[Validator[js.UndefOr[js.Function0[Node] | Null]]] = js.undefined
  ...
  var clearIcon: js.UndefOr[Validator[js.UndefOr[Null | Node]]] = js.undefined
  ...
  var renderExtraFooter: js.UndefOr[Validator[js.UndefOr[(js.Function1[/* mode */ PanelMode, Node]) | Null]]] = js.undefined
  ...
  var suffixIcon: js.UndefOr[Validator[js.UndefOr[Null | Node]]] = js.undefined
...
object WeakValidationMapTimePick {
  @scala.inline
  def apply(
    addon: Validator[js.UndefOr[js.Function0[Node] | Null]] = null,
    ...
    clearIcon: Validator[js.UndefOr[Null | Node]] = null,
    ...
    renderExtraFooter: Validator[js.UndefOr[(js.Function1[/* mode */ PanelMode, Node]) | Null]] = null,
    ...
    suffixIcon: Validator[js.UndefOr[Null | Node]] = null,
