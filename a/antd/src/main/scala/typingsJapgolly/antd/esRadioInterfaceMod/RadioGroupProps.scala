...
import typingsJapgolly.antd.esCheckboxGroupMod.AbstractCheckboxGroupProps
import typingsJapgolly.antd.esCheckboxGroupMod.CheckboxOptionType
...
object RadioGroupProps {
  ...
  def apply(
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.antd.esRadioInterfaceMod.RadioChangeEvent) => onChange(t0).runNow()))
