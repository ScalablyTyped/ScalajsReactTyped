...
object libTimePickerMod extends Shortcut {
  ...
  trait TimePickerProps extends StObject {
    ...
    var addon: js.UndefOr[js.Function0[Node]] = js.undefined
  ...
  object TimePickerProps {
    ...
    extension [Self <: TimePickerProps](x: Self) {
      ...
      inline def setAddon(value: CallbackTo[Node]): Self = StObject.set(x, "addon", value.toJsFn)
      ...
      inline def setMonthCellRender(value: (Moment, /* locale */ Locale) => Node): Self = StObject.set(x, "monthCellRender", js.Any.fromFunction2(value))
  ...
  object TimeRangePickerProps {
    ...
    extension [Self <: TimeRangePickerProps](x: Self) {
      ...
      inline def setDateRender(value: (Moment, Moment, /* info */ RangeInfo) => Node): Self = StObject.set(x, "dateRender", js.Any.fromFunction3(value))
      ...
      ): Self = StObject.set(x, "onCalendarChange", js.Any.fromFunction3((t0: /* values */ RangeValue[Moment], t1: /* formatString */ js.Tuple2[String, String], t2: /* info */ RangeInfo) => (value(t0, t1, t2)).runNow()))
      
      inline def setOnCalendarChangeUndefined: Self = StObject.set(x, "onCalendarChange", js.undefined)
      
      inline def setOnChange(value: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* values */ RangeValue[Moment], t1: /* formatString */ js.Tuple2[String, String]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnOk(value: /* dates */ RangeValue[Moment] => Callback): Self = StObject.set(x, "onOk", js.Any.fromFunction1((t0: /* dates */ RangeValue[Moment]) => value(t0).runNow()))
      ...
      inline def setOnPanelChange(value: (/* values */ RangeValue[Moment], /* modes */ js.Tuple2[PanelMode, PanelMode]) => Callback): Self = StObject.set(x, "onPanelChange", js.Any.fromFunction2((t0: /* values */ RangeValue[Moment], t1: /* modes */ js.Tuple2[PanelMode, PanelMode]) => (value(t0, t1)).runNow()))
  ...
  /* This means you don't have to write `default`, but can instead just say `libTimePickerMod.foo` */
