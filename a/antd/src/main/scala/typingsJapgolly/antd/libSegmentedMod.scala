...
import typingsJapgolly.antd.anon.PickSegmentedPropschildre
...
object libSegmentedMod extends Shortcut {
  
  @JSImport("antd/lib/segmented", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[PickSegmentedPropschildre] = js.native
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antd.libSegmentedMod.SegmentedLabeledOptionWithIcon
    - typingsJapgolly.antd.libSegmentedMod.SegmentedLabeledOptionWithoutIcon
  */
  trait SegmentedLabeledOption extends StObject
  object SegmentedLabeledOption {
    
    inline def SegmentedLabeledOptionWithIcon(value: SegmentedRawOption): typingsJapgolly.antd.libSegmentedMod.SegmentedLabeledOptionWithIcon = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], icon = null)
      __obj.asInstanceOf[typingsJapgolly.antd.libSegmentedMod.SegmentedLabeledOptionWithIcon]
    }
    
    inline def SegmentedLabeledOptionWithoutIcon(value: SegmentedRawOption): typingsJapgolly.antd.libSegmentedMod.SegmentedLabeledOptionWithoutIcon = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], label = null)
      __obj.asInstanceOf[typingsJapgolly.antd.libSegmentedMod.SegmentedLabeledOptionWithoutIcon]
    }
  }
  
  /* Inlined parent std.Omit<rc-segmented.rc-segmented.SegmentedLabeledOption, 'label'> */
  trait SegmentedLabeledOptionWithIcon
    extends StObject
       with SegmentedLabeledOption {
  ...
  object SegmentedLabeledOptionWithIcon {
    
    inline def apply(value: SegmentedRawOption): SegmentedLabeledOptionWithIcon = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], icon = null)
  ...
  trait SegmentedLabeledOptionWithoutIcon
    extends StObject
       with typingsJapgolly.rcSegmented.mod.SegmentedLabeledOption
       with SegmentedLabeledOption
  object SegmentedLabeledOptionWithoutIcon {
    
    inline def apply(value: SegmentedRawOption): SegmentedLabeledOptionWithoutIcon = {
      val __obj = js.Dynamic.literal(value = value.asInstanceOf[js.Any], label = null)
      __obj.asInstanceOf[SegmentedLabeledOptionWithoutIcon]
    }
  }
  
  /* Inlined parent std.Omit<rc-segmented.rc-segmented.SegmentedProps, 'size' | 'options'> */
  ...
  object SegmentedProps {
    ...
    inline def apply(options: js.Array[SegmentedRawOption | SegmentedLabeledOption]): SegmentedProps = {
  ...
  type _To = ForwardRefExoticComponent[PickSegmentedPropschildre]
  
  /* This means you don't have to write `default`, but can instead just say `libSegmentedMod.foo` */
  override def _to: ForwardRefExoticComponent[PickSegmentedPropschildre] = default
}
