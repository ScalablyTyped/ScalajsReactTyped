package typingsJapgolly.antd.columnMod
...
object ColumnProps {
  ...
  def apply[RecordType](
    ...
    onFilter: (/* value */ js.Any, RecordType) => CallbackTo[Boolean] = null,
    ...
    if (onFilter != null) __obj.updateDynamic("onFilter")(js.Any.fromFunction2((t0: /* value */ js.Any, t1: RecordType) => onFilter(t0, t1).runNow()))
