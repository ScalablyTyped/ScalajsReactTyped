...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.antd.generatePickerMod.PickerBaseProps[DateType]
  - typingsJapgolly.antd.generatePickerMod.PickerDateProps[DateType]
  - typingsJapgolly.antd.generatePickerMod.PickerTimeProps[DateType]
*/
