...
import typingsJapgolly.antd.libFormFormItemLabelMod.FormItemLabelProps
import typingsJapgolly.antd.libFormHooksUseFormItemStatusMod.UseFormItemStatus
...
object libFormFormItemMod extends Shortcut {
  ...
  object FormItemProps {
    ...
    extension [Self <: FormItemProps[?], Values](x: Self & FormItemProps[Values]) {
      ...
      inline def setChildrenFunction1(value: /* form */ FormInstance[Values] => Node): Self = StObject.set(x, "children", js.Any.fromFunction1(value))
  ...
  trait InternalFormItemType extends StObject {
    ...
    def apply[Values](props: FormItemProps[Values]): Element = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    ...
    - typingsJapgolly.antd.antdStrings.validating
