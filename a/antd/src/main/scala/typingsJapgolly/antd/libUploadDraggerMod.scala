...
object libUploadDraggerMod extends Shortcut {
  
  @JSImport("antd/lib/upload/Dragger", JSImport.Default)
  @js.native
  val default: ForwardRefExoticComponent[UploadPropsanyheightnumbe] = js.native
  
  /* Inlined parent antd.antd/lib/upload/interface.UploadProps<any> */
  ...
  type _To = ForwardRefExoticComponent[UploadPropsanyheightnumbe]
  
  /* This means you don't have to write `default`, but can instead just say `libUploadDraggerMod.foo` */
  override def _to: ForwardRefExoticComponent[UploadPropsanyheightnumbe] = default
}
