...
import typingsJapgolly.antd.antdStrings.picker
import typingsJapgolly.antd.libDatePickerGeneratePickerInterfaceMod.PickerComponentClass
import typingsJapgolly.antd.libDatePickerGeneratePickerMod.PickerDateProps
import typingsJapgolly.antd.libDatePickerGeneratePickerMod.PickerTimeProps
