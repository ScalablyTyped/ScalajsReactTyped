...
trait PickAntdIconPropschildren extends StObject {
  ...
  var ref: js.UndefOr[typingsJapgolly.react.mod.Ref[HTMLSpanElement]] = js.undefined
...
object PickAntdIconPropschildren {
  ...
  extension [Self <: PickAntdIconPropschildren](x: Self) {
    ...
    inline def setRef(value: typingsJapgolly.react.mod.Ref[HTMLSpanElement]): Self = StObject.set(x, "ref", value.asInstanceOf[js.Any])
