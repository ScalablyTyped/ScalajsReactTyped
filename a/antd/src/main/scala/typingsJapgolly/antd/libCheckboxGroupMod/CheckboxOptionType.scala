...
object CheckboxOptionType {
  ...
  def apply(
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.antd.libCheckboxCheckboxMod.CheckboxChangeEvent) => onChange(t0).runNow()))
