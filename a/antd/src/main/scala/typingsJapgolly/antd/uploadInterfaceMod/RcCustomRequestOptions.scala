...
object RcCustomRequestOptions {
  ...
  def apply(
    ...
    onProgress: (AnonPercent, File) => Callback,
    ...
    __obj.updateDynamic("onProgress")(js.Any.fromFunction2((t0: typingsJapgolly.antd.AnonPercent, t1: org.scalajs.dom.raw.File) => onProgress(t0, t1).runNow()))
