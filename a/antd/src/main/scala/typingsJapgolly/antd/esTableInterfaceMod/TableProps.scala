...
object TableProps {
  ...
  def apply[T](
    ...
    __obj.updateDynamic("setCheckboxPropsCache")(js.Any.fromFunction1((t0: typingsJapgolly.antd.esTableInterfaceMod.CheckboxPropsCache) => setCheckboxPropsCache(t0).runNow()))
