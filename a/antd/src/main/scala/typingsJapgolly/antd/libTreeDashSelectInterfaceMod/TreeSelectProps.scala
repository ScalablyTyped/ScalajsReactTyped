package typingsJapgolly.antd.libTreeDashSelectInterfaceMod
...
import typingsJapgolly.antd.libSelectMod.AbstractSelectProps
...
trait TreeSelectProps[T /* <: TreeNodeValue */] extends AbstractSelectProps {
  ...
  var maxTagPlaceholder: js.UndefOr[Node | (js.Function1[/* omittedValues */ js.Array[_], Node])] = js.undefined
  var multiple: js.UndefOr[Boolean] = js.undefined
  @JSName("notFoundContent")
  var notFoundContent_TreeSelectProps: js.UndefOr[Node] = js.undefined
...
object TreeSelectProps {
  ...
  def apply[T /* <: TreeNodeValue */](
    ...
    onChange: (/* value */ T, /* label */ js.Any, /* extra */ js.Any) => Callback = null,
  ...
  typingsJapgolly.antd.libSelectMod.SelectProps[typingsJapgolly.antd.libSelectMod.SelectValue]]) => dropdownRender(t0, t1).runNow()))
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction3((t0: /* value */ T, t1: /* label */ js.Any, t2: /* extra */ js.Any) => onChange(t0, t1, t2).runNow()))
