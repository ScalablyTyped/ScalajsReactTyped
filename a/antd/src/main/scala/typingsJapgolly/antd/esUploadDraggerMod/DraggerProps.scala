package typingsJapgolly.antd.esUploadDraggerMod
...
import typingsJapgolly.antd.esUploadInterfaceMod.PreviewFileHandler
...
import typingsJapgolly.antd.esUploadInterfaceMod.TransformFileHandler
