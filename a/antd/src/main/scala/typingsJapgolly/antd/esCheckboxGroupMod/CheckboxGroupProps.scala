...
object CheckboxGroupProps {
  ...
  def apply(
    ...
    name: String = null,
    onChange: /* checkedValue */ js.Array[CheckboxValueType] => Callback = null,
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* checkedValue */ js.Array[typingsJapgolly.antd.esCheckboxGroupMod.CheckboxValueType]) => onChange(t0).runNow()))
