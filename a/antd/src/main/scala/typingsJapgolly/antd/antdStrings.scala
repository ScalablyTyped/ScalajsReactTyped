...
import typingsJapgolly.antd.esDateDashPickerInterfaceMod.DatePickerMode
...
import typingsJapgolly.antd.esMessageMod.NoticeType
import typingsJapgolly.antd.esNotificationMod.IconType
import typingsJapgolly.antd.esNotificationMod.NotificationPlacement
import typingsJapgolly.antd.esRadioInterfaceMod.RadioGroupButtonStyle
import typingsJapgolly.antd.esSelectMod.ModeOption
import typingsJapgolly.antd.esStatisticUtilsMod._Formatter
...
import typingsJapgolly.antd.esUploadInterfaceMod.UploadFileStatus
...
import typingsJapgolly.antd.libInputDashNumberMod.OmitAttrs
import typingsJapgolly.antd.libListMod.ColumnType
...
import typingsJapgolly.antd.libTableInterfaceMod.TableSelectWay
import typingsJapgolly.antd.libTableInterfaceMod.TableSize
import typingsJapgolly.antd.libTabsMod.TabsPosition
import typingsJapgolly.antd.libTabsMod.TabsType
import typingsJapgolly.antd.libTransferMod.TransferDirection
import typingsJapgolly.antd.libTransferRenderListBodyMod.OmitProp
import typingsJapgolly.antd.libTreeDirectoryTreeMod.ExpandAction
import typingsJapgolly.antd.libUnderscoreUtilResponsiveObserveMod.Breakpoint
...
object antdStrings {
  ...
  sealed trait SECRET_COMBOBOX_MODE_DO_NOT_USE
    extends ModeOption
       with typingsJapgolly.antd.libSelectMod.ModeOption
  ...
  sealed trait ascend
    extends SortOrder
       with typingsJapgolly.antd.esTableInterfaceMod.SortOrder
  ...
  sealed trait body
    extends OmitProp
       with typingsJapgolly.antd.esTransferRenderListBodyMod.OmitProp
  ...
  sealed trait bottom
    extends DotPosition
       with typingsJapgolly.antd.libCarouselMod.DotPosition
       with MentionPlacement
       with typingsJapgolly.antd.libMentionsMod.MentionPlacement
       with typingsJapgolly.antd.esMentionsMod.MentionPlacement
       with typingsJapgolly.antd.libMentionMod.MentionPlacement
       with TabsPosition
       with typingsJapgolly.antd.esTabsMod.TabsPosition
       with TooltipPlacement
       with typingsJapgolly.antd.libTooltipMod.TooltipPlacement
       with placementType
       with typingsJapgolly.antd.libDrawerMod.placementType
  
  @js.native
  sealed trait bottomCenter
    extends Placement
       with typingsJapgolly.antd.libDropdownDropdownMod.Placement
  
  @js.native
  sealed trait bottomLeft
    extends NotificationPlacement
       with typingsJapgolly.antd.libNotificationMod.NotificationPlacement
       with Placement
       with typingsJapgolly.antd.libDropdownDropdownMod.Placement
       with TooltipPlacement
       with typingsJapgolly.antd.libTooltipMod.TooltipPlacement
  ...
  sealed trait button
    extends ButtonHTMLType
       with typingsJapgolly.antd.esButtonButtonMod.ButtonHTMLType
  ...
  sealed trait card
    extends TabsType
       with typingsJapgolly.antd.esTabsMod.TabsType
  ...
  sealed trait checkbox
    extends RowSelectionType
       with typingsJapgolly.antd.esTableInterfaceMod.RowSelectionType
  ...
  sealed trait circle
    extends ButtonShape
       with typingsJapgolly.antd.esButtonButtonMod.ButtonShape
       with ProgressType
       with typingsJapgolly.antd.esProgressProgressMod.ProgressType
  ...
  sealed trait click
    extends CascaderExpandTrigger
       with typingsJapgolly.antd.esCascaderMod.CascaderExpandTrigger
       with ExpandAction
       with typingsJapgolly.antd.esTreeDirectoryTreeMod.ExpandAction
       with TooltipTrigger
       with typingsJapgolly.antd.libTooltipMod.TooltipTrigger
  
  @js.native
  sealed trait clickTrigger
    extends CollapseType
       with typingsJapgolly.antd.libLayoutSiderMod.CollapseType
  ...
  sealed trait column
    extends ColumnType
       with typingsJapgolly.antd.esListMod.ColumnType
  ...
  sealed trait countdown
    extends _Formatter
       with typingsJapgolly.antd.libStatisticUtilsMod._Formatter
  ...
  sealed trait danger
    extends BaseType
       with typingsJapgolly.antd.libTypographyBaseMod.BaseType
       with ButtonType
       with typingsJapgolly.antd.esButtonButtonMod.ButtonType
  
  @js.native
  sealed trait dark
    extends MenuTheme
       with typingsJapgolly.antd.esMenuMenuContextMod.MenuTheme
       with SiderTheme
       with typingsJapgolly.antd.libLayoutSiderMod.SiderTheme
  ...
  sealed trait dashed
    extends ButtonType
       ...
       with typingsJapgolly.antd.libDropdownDropdownDashButtonMod.DropdownButtonType
  
  @js.native
  sealed trait date
    extends DatePickerMode
       with typingsJapgolly.antd.libDateDashPickerInterfaceMod.DatePickerMode
  ...
  sealed trait default
    extends ButtonSize
       with typingsJapgolly.antd.esButtonButtonMod.ButtonSize
       with ButtonType
       with typingsJapgolly.antd.esButtonButtonMod.ButtonType
       with CardSize
       with typingsJapgolly.antd.libCardMod.CardSize
       with ListSize
       with typingsJapgolly.antd.esListMod.ListSize
       with ModeOption
       with typingsJapgolly.antd.libSelectMod.ModeOption
       with ProgressSize
       with typingsJapgolly.antd.esProgressProgressMod.ProgressSize
       with SpinSize
       with typingsJapgolly.antd.esSpinMod.SpinSize
       with SwitchSize
       with typingsJapgolly.antd.esSwitchMod.SwitchSize
       with TableSize
       with typingsJapgolly.antd.esTableInterfaceMod.TableSize
  ...
  sealed trait defaultValue
    extends OmitAttrs
       with typingsJapgolly.antd.esInputDashNumberMod.OmitAttrs
  ...
  sealed trait done
    extends UploadFileStatus
       with typingsJapgolly.antd.libUploadInterfaceMod.UploadFileStatus
  ...
  sealed trait drag
    extends UploadType
       with typingsJapgolly.antd.libUploadInterfaceMod.UploadType
  ...
  sealed trait error
    extends IconType
       with typingsJapgolly.antd.libNotificationMod.IconType
       with NoticeType
       with typingsJapgolly.antd.libMessageMod.NoticeType
  ...
  sealed trait fade
    extends CarouselEffect
       with typingsJapgolly.antd.libCarouselMod.CarouselEffect
  ...
  sealed trait filled
    extends ThemeType
       with typingsJapgolly.antd.esIconMod.ThemeType
  ...
  sealed trait horizontal
    extends FormLayout
       with typingsJapgolly.antd.esFormFormMod.FormLayout
       with ListItemLayout
       with typingsJapgolly.antd.esListMod.ListItemLayout
       with MenuMode
       with typingsJapgolly.antd.libMenuMod.MenuMode
  ...
  sealed trait left
    extends DotPosition
       ...
       with typingsJapgolly.antd.libCollapseCollapseMod.ExpandIconPosition
       with FormLabelAlign
       with typingsJapgolly.antd.libFormFormItemMod.FormLabelAlign
       with TabsPosition
       with typingsJapgolly.antd.esTabsMod.TabsPosition
       with TooltipPlacement
       with typingsJapgolly.antd.libTooltipMod.TooltipPlacement
       with TransferDirection
       with typingsJapgolly.antd.esTransferMod.TransferDirection
       with placementType
       with typingsJapgolly.antd.libDrawerMod.placementType
  ...
  sealed trait lg
    extends Breakpoint
       with typingsJapgolly.antd.esUnderscoreUtilResponsiveObserveMod.Breakpoint
       with ColumnType
       with typingsJapgolly.antd.esListMod.ColumnType
  ...
  sealed trait month
    extends CalendarMode
       with typingsJapgolly.antd.libCalendarMod.CalendarMode
       with DatePickerMode
       with typingsJapgolly.antd.libDateDashPickerInterfaceMod.DatePickerMode
  ...
  sealed trait onSelect
    extends TableSelectWay
       with typingsJapgolly.antd.esTableInterfaceMod.TableSelectWay
  ...
  sealed trait outline
    extends RadioGroupButtonStyle
       with typingsJapgolly.antd.libRadioInterfaceMod.RadioGroupButtonStyle
  ...
  sealed trait picture
    extends UploadListType
       with typingsJapgolly.antd.libUploadInterfaceMod.UploadListType
