...
import typingsJapgolly.antd.libAvatarSizeContextMod._AvatarSize
...
import typingsJapgolly.antd.libCardCardMod.CardSize
import typingsJapgolly.antd.libCarouselMod.CarouselEffect
import typingsJapgolly.antd.libCarouselMod.DotPosition
import typingsJapgolly.antd.libCollapseCollapseMod.ExpandIconPositionLegacy
import typingsJapgolly.antd.libCollapseCollapseMod._ExpandIconPosition
import typingsJapgolly.antd.libCollapseCollapsePanelMod.CollapsibleType
import typingsJapgolly.antd.libConfigProviderContextMod._DirectionType
import typingsJapgolly.antd.libConfigProviderSizeContextMod._SizeType
...
import typingsJapgolly.antd.libGridColMod._FlexType
...
import typingsJapgolly.antd.libLocaleProviderLocaleReceiverMod.LocaleComponentName
import typingsJapgolly.antd.libMentionsMod.MentionPlacement
import typingsJapgolly.antd.libMenuMenuContextMod.MenuTheme
import typingsJapgolly.antd.libMenuMod.MenuMode
import typingsJapgolly.antd.libMessageMod.NoticeType
import typingsJapgolly.antd.libNotificationMod.IconType
import typingsJapgolly.antd.libNotificationMod.NotificationPlacement
import typingsJapgolly.antd.libPaginationPaginationMod.PaginationPosition
...
import typingsJapgolly.antd.libResultMod.ExceptionStatusType
...
import typingsJapgolly.antd.libTableInterfaceMod.RowSelectMethod
import typingsJapgolly.antd.libTableInterfaceMod.RowSelectionType
import typingsJapgolly.antd.libTableInterfaceMod.TableAction
import typingsJapgolly.antd.libTableInterfaceMod.TablePaginationPosition
import typingsJapgolly.antd.libTableInterfaceMod._ExpandType
import typingsJapgolly.antd.libTableInterfaceMod._SortOrder
...
import typingsJapgolly.antd.libUploadInterfaceMod.UploadFileStatus
...
import typingsJapgolly.antd.libUtilResponsiveObserveMod.Breakpoint
...
object antdStrings {
  ...
  inline def SECRET_COMBOBOX_MODE_DO_NOT_USE: SECRET_COMBOBOX_MODE_DO_NOT_USE = "SECRET_COMBOBOX_MODE_DO_NOT_USE".asInstanceOf[SECRET_COMBOBOX_MODE_DO_NOT_USE]
  ...
  sealed trait ascend
    extends StObject
       with _SortOrder
  inline def ascend: ascend = "ascend".asInstanceOf[ascend]
  ...
  inline def checkedKeys: checkedKeys = "checkedKeys".asInstanceOf[checkedKeys]
  ...
  sealed trait descend
    extends StObject
       with _SortOrder
  inline def descend: descend = "descend".asInstanceOf[descend]
  ...
  inline def handleClear: handleClear = "handleClear".asInstanceOf[handleClear]
  ...
  inline def nextIcon: nextIcon = "nextIcon".asInstanceOf[nextIcon]
  ...
  inline def prevIcon: prevIcon = "prevIcon".asInstanceOf[prevIcon]
