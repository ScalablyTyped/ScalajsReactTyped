...
import typingsJapgolly.antd.anon.Bordered
import typingsJapgolly.antd.anon.DisplayName
import typingsJapgolly.antd.anon.Ref
...
import typingsJapgolly.rcCascader.esCascaderMod.OnMultipleChange
import typingsJapgolly.rcCascader.esCascaderMod.OnSingleChange
...
import typingsJapgolly.rcCascader.esCascaderMod.ValueType
...
object libCascaderMod extends Shortcut {
  ...
  object MultipleCascaderProps {
    ...
    extension [Self <: MultipleCascaderProps](x: Self) {
      ...
      inline def setDisplayRender(
        value: (/* label */ js.Array[String], /* selectedOptions */ js.UndefOr[js.Array[DefaultOptionType]]) => Node
      ...
      inline def setOnChange(
        value: (/* value */ js.Array[SingleValueType], /* selectOptions */ js.Array[js.Array[DefaultOptionType]]) => Callback
      ): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ js.Array[SingleValueType], t1: /* selectOptions */ js.Array[js.Array[DefaultOptionType]]) => (value(t0, t1)).runNow()))
  ...
  object SingleCascaderProps {
    ...
    extension [Self <: SingleCascaderProps](x: Self) {
      ...
      inline def setOnChange(value: (/* value */ SingleValueType, /* selectOptions */ js.Array[DefaultOptionType]) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* value */ SingleValueType, t1: /* selectOptions */ js.Array[DefaultOptionType]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.antd.libCascaderMod.SingleCascaderProps
    - typingsJapgolly.antd.libCascaderMod.MultipleCascaderProps
  */
  trait UnionCascaderProps extends StObject
  object UnionCascaderProps {
    
    inline def MultipleCascaderProps(): typingsJapgolly.antd.libCascaderMod.MultipleCascaderProps = {
      val __obj = js.Dynamic.literal(multiple = true)
      __obj.asInstanceOf[typingsJapgolly.antd.libCascaderMod.MultipleCascaderProps]
    }
    
    inline def SingleCascaderProps(): typingsJapgolly.antd.libCascaderMod.SingleCascaderProps = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.antd.libCascaderMod.SingleCascaderProps]
    }
  }
