...
import typingsJapgolly.antd.libGridColMod.FlexType
...
object Col {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def flex(value: FlexType): this.type = set("flex", value.asInstanceOf[js.Any])
    ...
    inline def lg(value: ColSpanType | ColSize): this.type = set("lg", value.asInstanceOf[js.Any])
    
    inline def md(value: ColSpanType | ColSize): this.type = set("md", value.asInstanceOf[js.Any])
    
    inline def offset(value: ColSpanType): this.type = set("offset", value.asInstanceOf[js.Any])
    ...
    inline def order(value: ColSpanType): this.type = set("order", value.asInstanceOf[js.Any])
    ...
    inline def pull(value: ColSpanType): this.type = set("pull", value.asInstanceOf[js.Any])
    
    inline def push(value: ColSpanType): this.type = set("push", value.asInstanceOf[js.Any])
    ...
    inline def sm(value: ColSpanType | ColSize): this.type = set("sm", value.asInstanceOf[js.Any])
    
    inline def span(value: ColSpanType): this.type = set("span", value.asInstanceOf[js.Any])
    ...
    inline def xl(value: ColSpanType | ColSize): this.type = set("xl", value.asInstanceOf[js.Any])
    
    inline def xs(value: ColSpanType | ColSize): this.type = set("xs", value.asInstanceOf[js.Any])
    
    inline def xxl(value: ColSpanType | ColSize): this.type = set("xxl", value.asInstanceOf[js.Any])
  }
  
  implicit def make(companion: Col.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: ColProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
