...
object Menu {
  ...
  object Divider {
    ...
    implicit def make(companion: Divider.type): SharedBuilder_MenuDividerProps622254111 = new SharedBuilder_MenuDividerProps622254111(js.Array(this.component, js.Dictionary.empty))()
  ...
  object Item {
    ...
    implicit def make(companion: Item.type): SharedBuilder_MenuItemProps111955261[typingsJapgolly.antd.mod.Menu.Item] = new SharedBuilder_MenuItemProps111955261[typingsJapgolly.antd.mod.Menu.Item](js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: MenuItemProps): SharedBuilder_MenuItemProps111955261[typingsJapgolly.antd.mod.Menu.Item] = new SharedBuilder_MenuItemProps111955261[typingsJapgolly.antd.mod.Menu.Item](js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.antd.mod.Menu] {
    
    inline def _internalRenderMenuItem(
      value: (/* originNode */ japgolly.scalajs.react.facade.React.Element, /* menuItemProps */ Any, /* stateProps */ Selected) => japgolly.scalajs.react.facade.React.Element
    ): this.type = set("_internalRenderMenuItem", js.Any.fromFunction3(value))
    
    inline def _internalRenderSubMenuItem(
      value: (/* originNode */ japgolly.scalajs.react.facade.React.Element, /* subMenuItemProps */ Any, /* stateProps */ Active) => japgolly.scalajs.react.facade.React.Element
    ...
    inline def expandIconFunction1(value: /* props */ RenderIconInfo => japgolly.scalajs.react.facade.React.Node): this.type = set("expandIcon", js.Any.fromFunction1(value))
    
    inline def expandIconNull: this.type = set("expandIcon", null)
    
    inline def expandIconVarargs(
      value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
    ): this.type = set("expandIcon", js.Array(value*))
    ...
    inline def itemIconFunction1(value: /* props */ RenderIconInfo => japgolly.scalajs.react.facade.React.Node): this.type = set("itemIcon", js.Any.fromFunction1(value))
    
    inline def itemIconNull: this.type = set("itemIcon", null)
    
    inline def itemIconVarargs(
      value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
    ): this.type = set("itemIcon", js.Array(value*))
    ...
    inline def overflowedIndicatorVarargs(
      value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
    ): this.type = set("overflowedIndicator", js.Array(value*))
