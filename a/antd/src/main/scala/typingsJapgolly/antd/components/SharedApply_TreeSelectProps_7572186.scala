...
import typingsJapgolly.antd.libTreeDashSelectInterfaceMod.TreeDataSimpleMode
...
abstract class SharedApply_TreeSelectProps_7572186[ComponentRef] () {
  ...
  def apply[T /* <: TreeNodeValue */](
    ...
    onChange: (T, /* label */ js.Any, /* extra */ js.Any) => Callback = null,
    ...
    treeData: js.Array[typingsJapgolly.antd.libTreeDashSelectInterfaceMod.TreeNode] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TreeSelectProps[T], ComponentRef, Unit, TreeSelectProps[T]] = {
  ...
  typingsJapgolly.antd.libSelectMod.SelectProps[typingsJapgolly.antd.libSelectMod.SelectValue]]) => dropdownRender(t0, t1).runNow()))
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction3((t0: T, t1: /* label */ js.Any, t2: /* extra */ js.Any) => onChange(t0, t1, t2).runNow()))
  ...
  typingsJapgolly.antd.libTreeDashSelectInterfaceMod.TreeSelectProps[T], 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libTreeDashSelectInterfaceMod.TreeSelectProps[T]])(children: _*)
  }
}
