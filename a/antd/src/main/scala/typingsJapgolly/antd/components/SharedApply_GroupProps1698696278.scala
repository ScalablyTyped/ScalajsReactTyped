...
abstract class SharedApply_GroupProps1698696278 () {
  ...
  typingsJapgolly.antd.inputGroupMod.GroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.inputGroupMod.GroupProps])(children: _*)
  }
}
