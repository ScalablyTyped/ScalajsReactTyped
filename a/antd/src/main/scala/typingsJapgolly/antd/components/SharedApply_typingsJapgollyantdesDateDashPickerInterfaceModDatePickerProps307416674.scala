...
import typingsJapgolly.antd.esDateDashPickerInterfaceMod.DatePickerProps
...
abstract class SharedApply_typingsJapgollyantdesDateDashPickerInterfaceModDatePickerProps307416674[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DatePickerProps, ComponentRef, Unit, DatePickerProps] = {
  ...
  typingsJapgolly.antd.esDateDashPickerInterfaceMod.DatePickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](__component)
    f(__obj.asInstanceOf[typingsJapgolly.antd.esDateDashPickerInterfaceMod.DatePickerProps])(children: _*)
  }
}
