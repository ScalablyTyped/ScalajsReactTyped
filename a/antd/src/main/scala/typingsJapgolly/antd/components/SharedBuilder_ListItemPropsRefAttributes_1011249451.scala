...
@scala.inline
open class SharedBuilder_ListItemPropsRefAttributes_1011249451[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def colStyle(value: CSSProperties): this.type = set("colStyle", value.asInstanceOf[js.Any])
