...
abstract class SharedApply_TabsProps_641622985[ComponentRef] () {
  ...
  def apply(
    ...
    if (renderTabBar != null) __obj.updateDynamic("renderTabBar")(js.Any.fromFunction2((t0: /* props */ typingsJapgolly.antd.libTabsMod.TabsProps, t1: /* DefaultTabBar */ japgolly.scalajs.react.raw.React.ComponentClassP[js.Object]) => renderTabBar(t0, t1).runNow()))
  ...
  typingsJapgolly.antd.libTabsMod.TabsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libTabsMod.TabsProps])(children: _*)
  }
}
