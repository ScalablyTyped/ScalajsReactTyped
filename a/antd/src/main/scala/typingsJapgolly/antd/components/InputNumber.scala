...
import typingsJapgolly.antd.inputNumberMod.InputNumberProps
import typingsJapgolly.antd.inputNumberMod.default
...
object InputNumber {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputNumberProps, default, Unit, InputNumberProps] = {
  ...
  typingsJapgolly.antd.inputNumberMod.InputNumberProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.inputNumberMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.inputNumberMod.InputNumberProps])(children: _*)
  }
