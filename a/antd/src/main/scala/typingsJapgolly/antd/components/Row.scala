...
object Row {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def align(value: top | middle | bottom | stretch): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def gutter(value: Gutter | (js.Tuple2[Gutter, Gutter])): this.type = set("gutter", value.asInstanceOf[js.Any])
    ...
    inline def justify(value: start | end | center | `space-around` | `space-between` | `space-evenly`): this.type = set("justify", value.asInstanceOf[js.Any])
  ...
  def withProps(p: RowProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
