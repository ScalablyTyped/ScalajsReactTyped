...
@scala.inline
open class SharedBuilder_BasicPropsRefAttributes1405826332[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def hasSider(value: Boolean): this.type = set("hasSider", value.asInstanceOf[js.Any])
