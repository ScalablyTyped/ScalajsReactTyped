...
import typingsJapgolly.antd.esSliderMod.SliderMarks
import typingsJapgolly.antd.esSliderMod.SliderProps
import typingsJapgolly.antd.esSliderMod.SliderValue
import typingsJapgolly.antd.esSliderMod.default
...
object Slider {
  def apply(
    ...
    if (onAfterChange != null) __obj.updateDynamic("onAfterChange")(js.Any.fromFunction1((t0: /* value */ typingsJapgolly.antd.esSliderMod.SliderValue) => onAfterChange(t0).runNow()))
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* value */ typingsJapgolly.antd.esSliderMod.SliderValue) => onChange(t0).runNow()))
  ...
  typingsJapgolly.antd.esSliderMod.SliderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.esSliderMod.default](js.constructorOf[typingsJapgolly.antd.esSliderMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.antd.esSliderMod.SliderProps])(children: _*)
  }
}
