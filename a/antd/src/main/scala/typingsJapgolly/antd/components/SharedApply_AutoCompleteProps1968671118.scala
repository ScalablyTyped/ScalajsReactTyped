...
import typingsJapgolly.antd.libAutoDashCompleteMod.AutoCompleteProps
import typingsJapgolly.antd.libAutoDashCompleteMod.DataSourceItemType
import typingsJapgolly.antd.libAutoDashCompleteMod.ValidInputElement
...
abstract class SharedApply_AutoCompleteProps1968671118[ComponentRef] () {
  ...
  typingsJapgolly.antd.libAutoDashCompleteMod.AutoCompleteProps, 
  japgolly.scalajs.react.Children.None, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libAutoDashCompleteMod.AutoCompleteProps])
  }
}
