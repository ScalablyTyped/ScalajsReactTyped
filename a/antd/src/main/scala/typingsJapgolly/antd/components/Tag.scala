...
object Tag {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def color(value: LiteralUnion[PresetColorType | PresetStatusColorType, String]): this.type = set("color", value.asInstanceOf[js.Any])
    ...
    inline def onClose(value: /* e */ ReactMouseEventFrom[HTMLElement] => Callback): this.type = set("onClose", js.Any.fromFunction1((t0: /* e */ ReactMouseEventFrom[HTMLElement]) => value(t0).runNow()))
  ...
  def withProps(p: TagProps & RefAttributes[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
