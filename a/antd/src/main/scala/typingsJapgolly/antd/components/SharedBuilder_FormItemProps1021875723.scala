...
@scala.inline
open class SharedBuilder_FormItemProps1021875723[Values] (val args: js.Array[Any])
  extends AnyVal
     with StBuildingComponent[scala.Nothing] {
  
  inline def children(value: ChildrenType[Values]): this.type = set("children", value.asInstanceOf[js.Any])
  
  inline def childrenFunction1(value: /* form */ FormInstance[Values] => japgolly.scalajs.react.facade.React.Node): this.type = set("children", js.Any.fromFunction1(value))
  
  inline def childrenNull: this.type = set("children", null)
  
  inline def childrenVarargs(
    value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
  ): this.type = set("children", js.Array(value*))
