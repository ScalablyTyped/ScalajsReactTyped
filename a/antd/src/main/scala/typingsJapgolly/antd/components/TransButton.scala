...
import typingsJapgolly.antd.libUtilTransButtonMod.TransButtonProps
...
object TransButton {
  ...
  implicit def make(companion: TransButton.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: TransButtonProps & RefAttributes[HTMLDivElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
