...
import typingsJapgolly.antd.antdStrings.`datetime-local`
...
import typingsJapgolly.antd.antdStrings.file
...
import typingsJapgolly.antd.antdStrings.image_
...
import typingsJapgolly.antd.antdStrings.month
...
import typingsJapgolly.antd.antdStrings.number
...
import typingsJapgolly.antd.antdStrings.password
...
import typingsJapgolly.antd.antdStrings.range
...
import typingsJapgolly.antd.antdStrings.week
...
@scala.inline
open class SharedBuilder_SearchPropsRefAttributes_1645173871[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def enterButton(value: VdomNode): this.type = set("enterButton", value.rawNode.asInstanceOf[js.Any])
  
  inline def enterButtonNull: this.type = set("enterButton", null)
  
  inline def enterButtonVarargs(
    value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
  ): this.type = set("enterButton", js.Array(value*))
  
  inline def enterButtonVdomElement(value: VdomElement): this.type = set("enterButton", value.rawElement.asInstanceOf[js.Any])
  ...
  inline def inputPrefixCls(value: String): this.type = set("inputPrefixCls", value.asInstanceOf[js.Any])
  ...
  ): this.type = set("onSearch", js.Any.fromFunction2((t0: /* value */ String, t1: /* event */ js.UndefOr[
      ReactEventFrom[HTMLInputElement] | ReactMouseEventFrom[HTMLElement] | ReactKeyboardEventFrom[HTMLInputElement]
    ]) => (value(t0, t1)).runNow()))
