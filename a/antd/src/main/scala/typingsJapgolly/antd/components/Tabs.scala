...
object Tabs {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def addIcon(value: VdomNode): this.type = set("addIcon", value.rawNode.asInstanceOf[js.Any])
    
    inline def addIconNull: this.type = set("addIcon", null)
    
    inline def addIconVarargs(
      value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
    ): this.type = set("addIcon", js.Array(value*))
    
    inline def addIconVdomElement(value: VdomElement): this.type = set("addIcon", value.rawElement.asInstanceOf[js.Any])
    ...
    inline def hideAdd(value: Boolean): this.type = set("hideAdd", value.asInstanceOf[js.Any])
    ...
    inline def moreIconVarargs(
      value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
    ): this.type = set("moreIcon", js.Array(value*))
    ...
    inline def onEdit(
      value: (/* e */ ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element] | String, /* action */ add | remove) => Callback
    ): this.type = set("onEdit", js.Any.fromFunction2((t0: /* e */ ReactMouseEventFrom[org.scalajs.dom.Element] | ReactKeyboardEventFrom[org.scalajs.dom.Element] | String, t1: /* action */ add | remove) => (value(t0, t1)).runNow()))
    ...
    inline def tabBarExtraContentVarargs(
      value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
    ): this.type = set("tabBarExtraContent", js.Array(value*))
    ...
    inline def `type`(value: TabsType): this.type = set("type", value.asInstanceOf[js.Any])
