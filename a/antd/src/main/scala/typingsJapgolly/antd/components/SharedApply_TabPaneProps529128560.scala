...
abstract class SharedApply_TabPaneProps529128560 () {
  ...
  typingsJapgolly.antd.libTabsMod.TabPaneProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libTabsMod.TabPaneProps])(children: _*)
  }
}
