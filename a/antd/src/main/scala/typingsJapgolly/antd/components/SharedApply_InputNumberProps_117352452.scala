...
import typingsJapgolly.antd.libInputDashNumberMod.InputNumberProps
...
abstract class SharedApply_InputNumberProps_117352452[ComponentRef] () {
  ...
  typingsJapgolly.antd.libInputDashNumberMod.InputNumberProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libInputDashNumberMod.InputNumberProps])(children: _*)
  }
}
