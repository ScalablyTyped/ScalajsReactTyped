...
import typingsJapgolly.antd.esInputTextAreaMod.AutoSizeType
import typingsJapgolly.antd.esInputTextAreaMod.TextAreaProps
import typingsJapgolly.antd.esInputTextAreaMod.default
...
object TextArea {
  def apply(
    ...
    onPressEnter: ReactKeyboardEventFrom[HTMLTextAreaElement] => Callback = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextAreaProps, default, Unit, TextAreaProps] = {
    ...
    if (onPressEnter != null) __obj.updateDynamic("onPressEnter")(js.Any.fromFunction1((t0: japgolly.scalajs.react.ReactKeyboardEventFrom[org.scalajs.dom.raw.HTMLTextAreaElement]) => onPressEnter(t0).runNow()))
  ...
  typingsJapgolly.antd.esInputTextAreaMod.TextAreaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.esInputTextAreaMod.default](js.constructorOf[typingsJapgolly.antd.esInputTextAreaMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.antd.esInputTextAreaMod.TextAreaProps])(children: _*)
  }
}
