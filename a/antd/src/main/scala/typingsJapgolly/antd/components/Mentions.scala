...
import typingsJapgolly.antd.mentionsMod.MentionProps
...
object Mentions {
  def apply(
    ...
    if (validateSearch != null) __obj.updateDynamic("validateSearch")(js.Any.fromFunction2((t0: /* text */ java.lang.String, t1: typingsJapgolly.antd.mentionsMod.MentionProps) => validateSearch(t0, t1).runNow()))
  ...
  typingsJapgolly.antd.mentionsMod.MentionProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.mentionsMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.mentionsMod.MentionProps])(children: _*)
  }
