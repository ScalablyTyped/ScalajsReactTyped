...
abstract class SharedApply_typingsJapgollyantdesTreeTreeModAntTreeNodeProps707892145 () {
  ...
  typingsJapgolly.antd.esTreeTreeMod.AntTreeNodeProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](__component)
    f(__obj.asInstanceOf[typingsJapgolly.antd.esTreeTreeMod.AntTreeNodeProps])(children: _*)
  }
}
