...
import typingsJapgolly.antd.libUploadDraggerMod.DraggerProps
import typingsJapgolly.antd.libUploadDraggerMod.default
...
object Dragger {
  ...
  typingsJapgolly.antd.libUploadDraggerMod.DraggerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.libUploadDraggerMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libUploadDraggerMod.DraggerProps])(children: _*)
  }
