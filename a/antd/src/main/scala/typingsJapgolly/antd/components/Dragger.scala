...
import typingsJapgolly.antd.esUploadDraggerMod.DraggerProps
import typingsJapgolly.antd.esUploadDraggerMod.default
...
object Dragger {
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[DraggerProps, default, Unit, DraggerProps] = {
  ...
  typingsJapgolly.antd.esUploadDraggerMod.DraggerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.esUploadDraggerMod.default](js.constructorOf[typingsJapgolly.antd.esUploadDraggerMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.antd.esUploadDraggerMod.DraggerProps])(children: _*)
  }
}
