...
import typingsJapgolly.antd.libInputTextAreaMod.ShowCountProps
...
@scala.inline
open class SharedBuilder_TextAreaPropsRefAttributes668919691[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
