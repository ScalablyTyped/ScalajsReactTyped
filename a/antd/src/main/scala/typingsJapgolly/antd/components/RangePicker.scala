...
object RangePicker {
  def apply(
    ...
    RangePickerProps, 
    typingsJapgolly.antd.libDateDashPickerRangePickerMod.default, 
    Unit, 
    RangePickerProps
  ] = {
  ...
  typingsJapgolly.antd.libDateDashPickerInterfaceMod.RangePickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.libDateDashPickerRangePickerMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libDateDashPickerInterfaceMod.RangePickerProps])(children: _*)
  }
