...
import typingsJapgolly.antd.esTableColumnMod.default
import typingsJapgolly.antd.esTableInterfaceMod.ColumnFilterItem
import typingsJapgolly.antd.esTableInterfaceMod.ColumnProps
import typingsJapgolly.antd.esTableInterfaceMod.CompareFn
import typingsJapgolly.antd.esTableInterfaceMod.FilterDropdownProps
...
object Column {
  def apply[T](
    ...
    if (onHeaderCell != null) __obj.updateDynamic("onHeaderCell")(js.Any.fromFunction1((t0: /* props */ typingsJapgolly.antd.esTableInterfaceMod.ColumnProps[T]) => onHeaderCell(t0).runNow()))
  ...
  typingsJapgolly.antd.esTableInterfaceMod.ColumnProps[T], 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.antd.esTableColumnMod.default[T]](js.constructorOf[typingsJapgolly.antd.esTableColumnMod.default[T]])
    f(__obj.asInstanceOf[typingsJapgolly.antd.esTableInterfaceMod.ColumnProps[T]])
  }
}
