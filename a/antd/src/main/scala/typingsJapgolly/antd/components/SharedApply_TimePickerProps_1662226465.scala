...
import typingsJapgolly.antd.libTimeDashPickerMod.TimePickerLocale
...
abstract class SharedApply_TimePickerProps_1662226465[ComponentRef] () {
  ...
  typingsJapgolly.antd.libTimeDashPickerMod.TimePickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libTimeDashPickerMod.TimePickerProps])(children: _*)
  }
}
