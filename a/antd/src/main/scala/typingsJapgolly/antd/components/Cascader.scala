...
import typingsJapgolly.antd.esCascaderMod.CascaderExpandTrigger
import typingsJapgolly.antd.esCascaderMod.CascaderOptionType
import typingsJapgolly.antd.esCascaderMod.CascaderProps
import typingsJapgolly.antd.esCascaderMod.FieldNamesType
import typingsJapgolly.antd.esCascaderMod.ShowSearchType
...
object Cascader {
  def apply(
    ...
    if (displayRender != null) __obj.updateDynamic("displayRender")(js.Any.fromFunction2((t0: /* label */ js.Array[java.lang.String], t1: /* selectedOptions */ js.UndefOr[js.Array[typingsJapgolly.antd.esCascaderMod.CascaderOptionType]]) => displayRender(t0, t1).runNow()))
    ...
    if (loadData != null) __obj.updateDynamic("loadData")(js.Any.fromFunction1((t0: /* selectedOptions */ js.UndefOr[js.Array[typingsJapgolly.antd.esCascaderMod.CascaderOptionType]]) => loadData(t0).runNow()))
    if (notFoundContent != null) __obj.updateDynamic("notFoundContent")(notFoundContent.rawNode.asInstanceOf[js.Any])
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* value */ js.Array[java.lang.String], t1: /* selectedOptions */ js.UndefOr[js.Array[typingsJapgolly.antd.esCascaderMod.CascaderOptionType]]) => onChange(t0, t1).runNow()))
  ...
  typingsJapgolly.antd.esCascaderMod.CascaderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.esCascaderMod.default](js.constructorOf[typingsJapgolly.antd.esCascaderMod.default])
    f(__obj.asInstanceOf[typingsJapgolly.antd.esCascaderMod.CascaderProps])(children: _*)
  }
}
