...
abstract class SharedApply_GroupProps1726691944 () {
  ...
  typingsJapgolly.antd.libInputGroupMod.GroupProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libInputGroupMod.GroupProps])(children: _*)
  }
}
