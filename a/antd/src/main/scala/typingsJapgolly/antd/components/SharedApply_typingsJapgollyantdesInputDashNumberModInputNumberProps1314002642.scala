...
import typingsJapgolly.antd.esInputDashNumberMod.InputNumberProps
...
abstract class SharedApply_typingsJapgollyantdesInputDashNumberModInputNumberProps1314002642[ComponentRef] () {
  ...
  def apply(
    ...
    formatter: /* value */ js.UndefOr[Double | String] => CallbackTo[String] = null,
    ...
    parser: /* displayValue */ js.UndefOr[String] => CallbackTo[Double | String] = null,
    pattern: String = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[InputNumberProps, ComponentRef, Unit, InputNumberProps] = {
    ...
    if (formatter != null) __obj.updateDynamic("formatter")(js.Any.fromFunction1((t0: /* value */ js.UndefOr[scala.Double | java.lang.String]) => formatter(t0).runNow()))
    ...
    if (parser != null) __obj.updateDynamic("parser")(js.Any.fromFunction1((t0: /* displayValue */ js.UndefOr[java.lang.String]) => parser(t0).runNow()))
  ...
  typingsJapgolly.antd.esInputDashNumberMod.InputNumberProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](__component)
    f(__obj.asInstanceOf[typingsJapgolly.antd.esInputDashNumberMod.InputNumberProps])(children: _*)
  }
}
