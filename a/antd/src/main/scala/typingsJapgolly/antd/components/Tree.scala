...
object Tree {
  ...
  typingsJapgolly.antd.libTreeTreeMod.TreeProps, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.libTreeMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libTreeTreeMod.TreeProps])(children: _*)
  }
