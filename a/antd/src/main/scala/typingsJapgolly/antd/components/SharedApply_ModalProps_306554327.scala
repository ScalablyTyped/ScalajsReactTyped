...
import typingsJapgolly.antd.modalModalMod.ModalProps
...
abstract class SharedApply_ModalProps_306554327[ComponentRef] () {
  ...
  typingsJapgolly.antd.modalModalMod.ModalProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.modalModalMod.ModalProps])(children: _*)
  }
}
