...
import typingsJapgolly.antd.datePickerMod.default
...
object DatePicker {
  def PickerBaseProps(
    ...
    onChange: (/* value */ Moment | Null, /* dateString */ String) => Callback = null,
    ...
    onOk: Moment => Callback = null,
    onOpenChange: /* open */ Boolean => Callback = null,
    onPanelChange: (Moment, /* mode */ PanelMode) => Callback = null,
    ...
    typingsJapgolly.antd.generatePickerMod.PickerBaseProps[Moment], 
    default, 
    Unit, 
    typingsJapgolly.antd.generatePickerMod.PickerBaseProps[Moment]
  ] = {
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction2((t0: /* value */ typingsJapgolly.moment.mod.Moment | scala.Null, t1: /* dateString */ java.lang.String) => onChange(t0, t1).runNow()))
    ...
    if (onOk != null) __obj.updateDynamic("onOk")(js.Any.fromFunction1((t0: typingsJapgolly.moment.mod.Moment) => onOk(t0).runNow()))
    if (onOpenChange != null) __obj.updateDynamic("onOpenChange")(js.Any.fromFunction1((t0: /* open */ scala.Boolean) => onOpenChange(t0).runNow()))
    if (onPanelChange != null) __obj.updateDynamic("onPanelChange")(js.Any.fromFunction2((t0: typingsJapgolly.moment.mod.Moment, t1: /* mode */ typingsJapgolly.rcPicker.interfaceMod.PanelMode) => onPanelChange(t0, t1).runNow()))
  ...
  typingsJapgolly.antd.generatePickerMod.PickerBaseProps[typingsJapgolly.moment.mod.Moment], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.datePickerMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.generatePickerMod.PickerBaseProps[typingsJapgolly.moment.mod.Moment]])(children: _*)
  }
  def PickerDateProps(
    allowClear: js.UndefOr[Boolean] = js.undefined,
    `aria-activedescendant`: String = null,
    ...
    disabled: js.UndefOr[Boolean] = js.undefined,
    disabledDate: Moment => CallbackTo[Boolean] = null,
    disabledTime: /* date */ Moment | Null => CallbackTo[DisabledTimes] = null,
    dropdownAlign: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AlignType */ js.Any = null,
    dropdownClassName: String = null,
    format: String | js.Array[String] = null,
    getPopupContainer: /* node */ HTMLElement => CallbackTo[HTMLElement] = null,
    ...
    typingsJapgolly.antd.generatePickerMod.PickerDateProps[Moment], 
    default, 
    Unit, 
    typingsJapgolly.antd.generatePickerMod.PickerDateProps[Moment]
  ] = {
    ...
    if (!js.isUndefined(disabled)) __obj.updateDynamic("disabled")(disabled.asInstanceOf[js.Any])
    if (disabledDate != null) __obj.updateDynamic("disabledDate")(js.Any.fromFunction1((t0: typingsJapgolly.moment.mod.Moment) => disabledDate(t0).runNow()))
    if (disabledTime != null) __obj.updateDynamic("disabledTime")(js.Any.fromFunction1((t0: /* date */ typingsJapgolly.moment.mod.Moment | scala.Null) => disabledTime(t0).runNow()))
    if (dropdownAlign != null) __obj.updateDynamic("dropdownAlign")(dropdownAlign.asInstanceOf[js.Any])
    if (dropdownClassName != null) __obj.updateDynamic("dropdownClassName")(dropdownClassName.asInstanceOf[js.Any])
    if (format != null) __obj.updateDynamic("format")(format.asInstanceOf[js.Any])
    if (getPopupContainer != null) __obj.updateDynamic("getPopupContainer")(js.Any.fromFunction1((t0: /* node */ org.scalajs.dom.raw.HTMLElement) => getPopupContainer(t0).runNow()))
    ...
    val f = japgolly.scalajs.react.JsForwardRefComponent.force[
  typingsJapgolly.antd.generatePickerMod.PickerDateProps[typingsJapgolly.moment.mod.Moment], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.datePickerMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.generatePickerMod.PickerDateProps[typingsJapgolly.moment.mod.Moment]])(children: _*)
  }
  def PickerTimeProps(
    picker: time,
    allowClear: js.UndefOr[Boolean] = js.undefined,
    ...
    typingsJapgolly.antd.generatePickerMod.PickerTimeProps[Moment], 
    default, 
    Unit, 
    typingsJapgolly.antd.generatePickerMod.PickerTimeProps[Moment]
  ] = {
    ...
    val f = japgolly.scalajs.react.JsForwardRefComponent.force[
  typingsJapgolly.antd.generatePickerMod.PickerTimeProps[typingsJapgolly.moment.mod.Moment], 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.antd.datePickerMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.generatePickerMod.PickerTimeProps[typingsJapgolly.moment.mod.Moment]])(children: _*)
  }
