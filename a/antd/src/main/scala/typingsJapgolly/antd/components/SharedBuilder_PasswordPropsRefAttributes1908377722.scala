...
@scala.inline
open class SharedBuilder_PasswordPropsRefAttributes1908377722[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def iconRender(value: /* visible */ Boolean => japgolly.scalajs.react.facade.React.Node): this.type = set("iconRender", js.Any.fromFunction1(value))
  ...
  inline def visibilityToggle(value: Boolean): this.type = set("visibilityToggle", value.asInstanceOf[js.Any])
