...
import typingsJapgolly.antd.libTimePickerMod.TimePickerProps
...
object TimePicker {
  ...
  object RangePicker {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def dateRender(value: (Moment, Moment, /* info */ RangeInfo) => japgolly.scalajs.react.facade.React.Node): this.type = set("dateRender", js.Any.fromFunction3(value))
      ...
      inline def defaultPickerValue(value: js.Tuple2[Moment, Moment]): this.type = set("defaultPickerValue", value.asInstanceOf[js.Any])
      
      inline def defaultValue(value: RangeValue[Moment]): this.type = set("defaultValue", value.asInstanceOf[js.Any])
      ...
      inline def disabledTime(value: (/* date */ EventValue[Moment], /* type */ RangeType) => DisabledTimes): this.type = set("disabledTime", js.Any.fromFunction2(value))
      ...
      inline def onCalendarChange(
        value: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String], /* info */ RangeInfo) => Callback
      ): this.type = set("onCalendarChange", js.Any.fromFunction3((t0: /* values */ RangeValue[Moment], t1: /* formatString */ js.Tuple2[String, String], t2: /* info */ RangeInfo) => (value(t0, t1, t2)).runNow()))
      
      inline def onChange(value: (/* values */ RangeValue[Moment], /* formatString */ js.Tuple2[String, String]) => Callback): this.type = set("onChange", js.Any.fromFunction2((t0: /* values */ RangeValue[Moment], t1: /* formatString */ js.Tuple2[String, String]) => (value(t0, t1)).runNow()))
      ...
      inline def onOk(value: /* dates */ RangeValue[Moment] => Callback): this.type = set("onOk", js.Any.fromFunction1((t0: /* dates */ RangeValue[Moment]) => value(t0).runNow()))
      ...
      inline def onPanelChange(value: (/* values */ RangeValue[Moment], /* modes */ js.Tuple2[PanelMode, PanelMode]) => Callback): this.type = set("onPanelChange", js.Any.fromFunction2((t0: /* values */ RangeValue[Moment], t1: /* modes */ js.Tuple2[PanelMode, PanelMode]) => (value(t0, t1)).runNow()))
      ...
      inline def value(value: RangeValue[Moment]): this.type = set("value", value.asInstanceOf[js.Any])
      
      inline def valueNull: this.type = set("value", null)
    }
    
    implicit def make(companion: RangePicker.type): typingsJapgolly.antd.components.TimePicker.RangePicker.Builder = new typingsJapgolly.antd.components.TimePicker.RangePicker.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: TimeRangePickerProps & RefAttributes[Any]): typingsJapgolly.antd.components.TimePicker.RangePicker.Builder = new typingsJapgolly.antd.components.TimePicker.RangePicker.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def addon(value: CallbackTo[japgolly.scalajs.react.facade.React.Node]): this.type = set("addon", value.toJsFn)
    ...
    inline def disabledTime(value: /* date */ Moment => DisabledTimes): this.type = set("disabledTime", js.Any.fromFunction1(value))
  ...
  def withProps(p: TimePickerProps & RefAttributes[Any]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
