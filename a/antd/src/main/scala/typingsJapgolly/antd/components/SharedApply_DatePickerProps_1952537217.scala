...
abstract class SharedApply_DatePickerProps_1952537217[ComponentRef] () {
  ...
  def apply(
    ...
    if (renderExtraFooter != null) __obj.updateDynamic("renderExtraFooter")(js.Any.fromFunction1((t0: /* mode */ typingsJapgolly.antd.libDateDashPickerInterfaceMod.DatePickerMode) => renderExtraFooter(t0).runNow()))
  ...
  typingsJapgolly.antd.libDateDashPickerInterfaceMod.DatePickerProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libDateDashPickerInterfaceMod.DatePickerProps])(children: _*)
  }
}
