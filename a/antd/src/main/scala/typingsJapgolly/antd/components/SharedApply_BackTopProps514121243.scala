...
abstract class SharedApply_BackTopProps514121243[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[BackTopProps, ComponentRef, Unit, BackTopProps] = {
  ...
  typingsJapgolly.antd.libBackDashTopMod.BackTopProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libBackDashTopMod.BackTopProps])(children: _*)
  }
}
