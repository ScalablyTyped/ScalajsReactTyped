...
import typingsJapgolly.antd.libInputResizableTextAreaMod.AutoSizeType
...
abstract class SharedApply_TextAreaProps707916733[ComponentRef] () {
  ...
  def apply(
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TextAreaProps, ComponentRef, Unit, TextAreaProps] = {
  ...
  typingsJapgolly.antd.libInputTextAreaMod.TextAreaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libInputTextAreaMod.TextAreaProps])(children: _*)
  }
}
