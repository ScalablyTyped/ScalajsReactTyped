...
object Transfer {
  def apply(
    ...
    if (onScroll != null) __obj.updateDynamic("onScroll")(js.Any.fromFunction2((t0: /* direction */ typingsJapgolly.antd.libTransferMod.TransferDirection, t1: /* e */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLDivElement]) => onScroll(t0, t1).runNow()))
    if (onSearch != null) __obj.updateDynamic("onSearch")(js.Any.fromFunction2((t0: /* direction */ typingsJapgolly.antd.libTransferMod.TransferDirection, t1: /* value */ java.lang.String) => onSearch(t0, t1).runNow()))
    if (onSearchChange != null) __obj.updateDynamic("onSearchChange")(js.Any.fromFunction2((t0: /* direction */ typingsJapgolly.antd.libTransferMod.TransferDirection, t1: /* e */ japgolly.scalajs.react.ReactEventFrom[org.scalajs.dom.raw.HTMLInputElement]) => onSearchChange(t0, t1).runNow()))
    ...
    if (rowKey != null) __obj.updateDynamic("rowKey")(js.Any.fromFunction1((t0: /* record */ typingsJapgolly.antd.libTransferMod.TransferItem) => rowKey(t0).runNow()))
  ...
  typingsJapgolly.antd.libTransferMod.TransferProps, 
  japgolly.scalajs.react.Children.None, 
  typingsJapgolly.antd.libTransferMod.default](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libTransferMod.TransferProps])
  }
