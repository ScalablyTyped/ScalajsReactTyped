...
abstract class SharedApply_typingsJapgollyantdesLayoutLayoutModBasicProps95024345 () {
  ...
  def apply(
    ...
    BasicProps, 
    MountedWithRawType[BasicProps, js.Object, RawMounted[BasicProps, js.Object]]
  ] = {
