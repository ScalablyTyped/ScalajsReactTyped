...
@scala.inline
open class SharedBuilder_SiderPropsRefAttributes_447020899[R <: js.Object] (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def breakpoint(value: xs | sm | md | lg | xl | xxl): this.type = set("breakpoint", value.asInstanceOf[js.Any])
  
  inline def className(value: String): this.type = set("className", value.asInstanceOf[js.Any])
  
  inline def collapsed(value: Boolean): this.type = set("collapsed", value.asInstanceOf[js.Any])
  
  inline def collapsedWidth(value: Double | String): this.type = set("collapsedWidth", value.asInstanceOf[js.Any])
  ...
  inline def onBreakpoint(value: /* broken */ Boolean => Callback): this.type = set("onBreakpoint", js.Any.fromFunction1((t0: /* broken */ Boolean) => value(t0).runNow()))
  ...
  inline def onCollapse(value: (/* collapsed */ Boolean, /* type */ CollapseType) => Callback): this.type = set("onCollapse", js.Any.fromFunction2((t0: /* collapsed */ Boolean, t1: /* type */ CollapseType) => (value(t0, t1)).runNow()))
  ...
  inline def reverseArrow(value: Boolean): this.type = set("reverseArrow", value.asInstanceOf[js.Any])
  ...
  inline def theme(value: SiderTheme): this.type = set("theme", value.asInstanceOf[js.Any])
  ...
  inline def zeroWidthTriggerStyle(value: CSSProperties): this.type = set("zeroWidthTriggerStyle", value.asInstanceOf[js.Any])
}
