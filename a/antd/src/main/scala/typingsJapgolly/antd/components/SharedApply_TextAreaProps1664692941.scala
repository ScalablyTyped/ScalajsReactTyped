...
import typingsJapgolly.antd.resizableTextAreaMod.AutoSizeType
...
abstract class SharedApply_TextAreaProps1664692941[ComponentRef] () {
  ...
  def apply(
    ...
    if (onResize != null) __obj.updateDynamic("onResize")(js.Any.fromFunction1((t0: /* size */ typingsJapgolly.antd.AnonHeight) => onResize(t0).runNow()))
  ...
  typingsJapgolly.antd.textAreaMod.TextAreaProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.textAreaMod.TextAreaProps])(children: _*)
  }
}
