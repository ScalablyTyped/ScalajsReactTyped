...
import typingsJapgolly.antd.esConfigDashProviderMod.ConfigProviderProps
import typingsJapgolly.antd.esLocaleDashProviderMod.Locale
import scala.scalajs.js
import scala.scalajs.js.`|`
import scala.scalajs.js.annotation._

abstract class SharedApply_typingsJapgollyantdesConfigDashProviderModConfigProviderProps_1477427432[ComponentRef] () {
  ...
  typingsJapgolly.antd.esConfigDashProviderMod.ConfigProviderProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](__component)
    f(__obj.asInstanceOf[typingsJapgolly.antd.esConfigDashProviderMod.ConfigProviderProps])(children: _*)
  }
}
