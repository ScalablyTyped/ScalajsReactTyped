...
object Button {
  ...
  object Group {
    ...
    implicit def make(companion: Group.type): SharedBuilder_ButtonGroupProps_1559762238 = new SharedBuilder_ButtonGroupProps_1559762238(js.Array(this.component, js.Dictionary.empty))()
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def shape(value: ButtonShape): this.type = set("shape", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: ButtonType): this.type = set("type", value.asInstanceOf[js.Any])
  ...
  def withProps(p: ButtonProps & RefAttributes[HTMLElement]): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
