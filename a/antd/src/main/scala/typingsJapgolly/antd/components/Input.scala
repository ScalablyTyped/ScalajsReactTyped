...
object Input {
  ...
  object Group {
    ...
    open class Builder (val args: js.Array[Any])
      ...
      inline def size(value: large | small | default): this.type = set("size", value.asInstanceOf[js.Any])
      
      inline def style(value: CSSProperties): this.type = set("style", value.asInstanceOf[js.Any])
    }
    
    implicit def make(companion: Group.type): typingsJapgolly.antd.components.Input.Group.Builder = new typingsJapgolly.antd.components.Input.Group.Builder(js.Array(this.component, js.Dictionary.empty))()
    
    def withProps(p: GroupProps): typingsJapgolly.antd.components.Input.Group.Builder = new typingsJapgolly.antd.components.Input.Group.Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
  }
