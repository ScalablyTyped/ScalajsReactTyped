...
import typingsJapgolly.antd.libSpaceMod.SpaceProps
import typingsJapgolly.antd.libSpaceMod.SpaceSize
...
object Space {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def align(value: start | end | center | baseline): this.type = set("align", value.asInstanceOf[js.Any])
    ...
    inline def direction(value: typingsJapgolly.antd.antdStrings.horizontal | typingsJapgolly.antd.antdStrings.vertical): this.type = set("direction", value.asInstanceOf[js.Any])
    ...
    inline def size(value: SpaceSize | (js.Tuple2[SpaceSize, SpaceSize])): this.type = set("size", value.asInstanceOf[js.Any])
    
    inline def slot(value: String): this.type = set("slot", value.asInstanceOf[js.Any])
    
    inline def spellCheck(value: Booleanish): this.type = set("spellCheck", value.asInstanceOf[js.Any])
    
    inline def split(value: VdomNode): this.type = set("split", value.rawNode.asInstanceOf[js.Any])
    
    inline def splitNull: this.type = set("split", null)
    
    inline def splitVarargs(
      value: (japgolly.scalajs.react.facade.Empty | String | JsNumber | japgolly.scalajs.react.facade.React.Element)*
    ): this.type = set("split", js.Array(value*))
    
    inline def splitVdomElement(value: VdomElement): this.type = set("split", value.rawElement.asInstanceOf[js.Any])
