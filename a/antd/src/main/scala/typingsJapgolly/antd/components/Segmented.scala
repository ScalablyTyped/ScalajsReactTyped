...
object Segmented {
  ...
  inline def apply(options: js.Array[SegmentedRawOption | SegmentedLabeledOption]): Builder = {
    val __props = js.Dynamic.literal(options = options.asInstanceOf[js.Any])
    new Builder(js.Array(this.component, __props.asInstanceOf[PickSegmentedPropschildre]))
  }
  ...
  def withProps(p: PickSegmentedPropschildre): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
