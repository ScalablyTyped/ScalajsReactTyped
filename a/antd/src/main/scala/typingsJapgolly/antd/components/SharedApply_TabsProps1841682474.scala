...
import typingsJapgolly.antd.AnonInkBar
...
abstract class SharedApply_TabsProps1841682474[ComponentRef] () {
  ...
  def apply(
    ...
    renderTabBar: (/* props */ TabsProps, /* DefaultTabBar */ ComponentClassP[js.Object]) => CallbackTo[japgolly.scalajs.react.raw.React.Element] = null,
    ...
    children: ChildArg*
  ): UnmountedWithRoot[TabsProps, ComponentRef, Unit, TabsProps] = {
    ...
    if (renderTabBar != null) __obj.updateDynamic("renderTabBar")(js.Any.fromFunction2((t0: /* props */ typingsJapgolly.antd.tabsMod.TabsProps, t1: /* DefaultTabBar */ japgolly.scalajs.react.raw.React.ComponentClassP[js.Object]) => renderTabBar(t0, t1).runNow()))
  ...
  typingsJapgolly.antd.tabsMod.TabsProps, 
  japgolly.scalajs.react.Children.Varargs, 
  ComponentRef](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.tabsMod.TabsProps])(children: _*)
  }
}
