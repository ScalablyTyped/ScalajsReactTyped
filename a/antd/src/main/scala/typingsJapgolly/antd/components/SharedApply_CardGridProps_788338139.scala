...
abstract class SharedApply_CardGridProps_788338139 () {
  ...
  typingsJapgolly.antd.libCardGridMod.CardGridProps, 
  japgolly.scalajs.react.Children.Varargs, 
  js.Object](this.componentImport)
    f(__obj.asInstanceOf[typingsJapgolly.antd.libCardGridMod.CardGridProps])(children: _*)
  }
}
