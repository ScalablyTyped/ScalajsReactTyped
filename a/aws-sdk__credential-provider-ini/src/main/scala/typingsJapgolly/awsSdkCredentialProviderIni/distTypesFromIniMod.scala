...
import typingsJapgolly.awsSdkCredentialProviderIni.distTypesResolveAssumeRoleCredentialsMod.AssumeRoleParams
import typingsJapgolly.awsSdkCredentialProviderWebIdentity.distTypesFromWebTokenMod.AssumeRoleWithWebIdentityParams
