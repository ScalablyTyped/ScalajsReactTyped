...
object mod {
  ...
  open class IconDirective protected ()
    extends typingsJapgolly.antDesignIconsAngular.publicApiMod.IconDirective {
    def this(
  ...
  open class IconModule ()
    extends typingsJapgolly.antDesignIconsAngular.publicApiMod.IconModule
  /* static members */
  object IconModule {
  ...
  open class IconService protected ()
    extends typingsJapgolly.antDesignIconsAngular.publicApiMod.IconService {
    def this(
