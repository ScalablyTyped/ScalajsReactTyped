...
import typingsJapgolly.antvScale.libTypesMod.CreateTransform
import typingsJapgolly.antvScale.libTypesMod.Interpolate
import typingsJapgolly.antvScale.libTypesMod.Interpolator
import typingsJapgolly.antvScale.libTypesMod.NiceMethod
import typingsJapgolly.antvScale.libTypesMod.TickMethod
import typingsJapgolly.antvScale.libUtilsFindTickIntervalMod.TickInterval
import typingsJapgolly.antvScale.libUtilsTimeIntervalMod.Interval
...
object libUtilsMod {
  ...
  open class InternMap[K, V] protected ()
    extends typingsJapgolly.antvScale.libUtilsInternMapMod.InternMap[K, V] {
