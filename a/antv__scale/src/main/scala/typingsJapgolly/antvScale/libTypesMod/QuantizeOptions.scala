...
trait QuantizeOptions extends StObject {
...
object QuantizeOptions {
  
  inline def apply(): QuantizeOptions = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[QuantizeOptions]
  }
  
  extension [Self <: QuantizeOptions](x: Self) {
