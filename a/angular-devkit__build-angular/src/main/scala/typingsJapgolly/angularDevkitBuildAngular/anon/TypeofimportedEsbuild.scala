...
trait TypeofimportedEsbuild extends StObject {
  ...
  def build(options: BuildOptionswritefalse): js.Promise[typingsJapgolly.esbuild.anon.BuildResultoutputFilesArr] = js.native
  def build(options: typingsJapgolly.esbuild.mod.BuildOptions): js.Promise[BuildResult] = js.native
  
  def buildSync(options: BuildOptionswritefalse): typingsJapgolly.esbuild.anon.BuildResultoutputFilesArr = js.native
  def buildSync(options: typingsJapgolly.esbuild.mod.BuildOptions): BuildResult = js.native
  ...
  def serve(serveOptions: ServeOptions, buildOptions: typingsJapgolly.esbuild.mod.BuildOptions): js.Promise[ServeResult] = js.native
