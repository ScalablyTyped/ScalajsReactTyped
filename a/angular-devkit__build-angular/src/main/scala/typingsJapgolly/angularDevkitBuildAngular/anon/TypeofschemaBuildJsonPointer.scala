...
@js.native
trait TypeofschemaBuildJsonPointer extends StObject {
  
  var CoreSchemaRegistry: TypeofCoreSchemaRegistryInstantiable = js.native
  
  var SchemaValidationException: TypeofSchemaValidationExcInstantiable = js.native
