package typingsJapgolly.awsSdkCredentialProviderCognitoIdentity.fromCognitoIdentityMod

import typingsJapgolly.awsSdkClientCognitoIdentityBrowser.cognitoIdentityClientMod.CognitoIdentityClient
import typingsJapgolly.awsSdkCredentialProviderCognitoIdentity.cognitoProviderParametersMod.CognitoProviderParameters
import typingsJapgolly.awsSdkCredentialProviderCognitoIdentity.loginsMod.Logins
