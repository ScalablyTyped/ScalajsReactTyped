...
version := "3.188.0-ffe8d5"
scalaVersion := "3.1.2"
enablePlugins(ScalaJSPlugin)
libraryDependencies ++= Seq(
  "com.github.japgolly.scalajs-react" %%% "core" % "2.1.1",
  "com.olvind" %%% "scalablytyped-runtime" % "2.4.2",
  "org.scalablytyped.japgolly" %%% "aws-sdk__client-cognito-identity" % "3.188.0-32c170",
  ...
  "org.scalablytyped.japgolly" %%% "aws-sdk__signature-v4" % "3.188.0-55e289",
