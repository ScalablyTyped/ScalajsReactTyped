...
object typesDeleteFunctionInputMod {
  
  trait DeleteFunctionInput
    extends StObject
  ...
  object DeleteFunctionInput {
    ...
    inline def apply(FunctionName: String): DeleteFunctionInput = {
      val __obj = js.Dynamic.literal(FunctionName = FunctionName.asInstanceOf[js.Any])
      __obj.asInstanceOf[DeleteFunctionInput]
    }
    
    extension [Self <: DeleteFunctionInput](x: Self) {
