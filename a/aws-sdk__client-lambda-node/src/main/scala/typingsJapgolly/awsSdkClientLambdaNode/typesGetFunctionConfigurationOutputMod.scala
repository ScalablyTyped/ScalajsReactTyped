...
object typesGetFunctionConfigurationOutputMod {
  
  trait GetFunctionConfigurationOutput
    extends StObject
  ...
  object GetFunctionConfigurationOutput {
    ...
    inline def apply($metadata: ResponseMetadata): GetFunctionConfigurationOutput = {
