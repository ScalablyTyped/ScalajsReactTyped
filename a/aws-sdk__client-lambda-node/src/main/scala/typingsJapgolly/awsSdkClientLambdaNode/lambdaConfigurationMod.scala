...
object lambdaConfigurationMod {
  ...
  trait LambdaResolvableConfiguration
    extends StObject
  ...
  trait LambdaResolvedConfiguration
    extends StObject
       with LambdaConfiguration {
    ...
    def base64Decoder_MLambdaResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("base64Decoder")
    var base64Decoder_Original: Decoder
    
    @JSName("base64Encoder")
    def base64Encoder_MLambdaResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("base64Encoder")
    ...
    @JSName("credentials")
    def credentials_MLambdaResolvedConfiguration(): js.Promise[Credentials]
    @JSName("credentials")
    ...
    @JSName("handler")
    def handler_MLambdaResolvedConfiguration[Input /* <: js.Object */, Output /* <: js.Object */](context: HandlerExecutionContext): DeserializeHandler[Input, Output]
    @JSName("handler")
    var handler_Original: Terminalware
    
    @JSName("maxRedirects")
    var maxRedirects_LambdaResolvedConfiguration: Double
    
    @JSName("maxRetries")
    var maxRetries_LambdaResolvedConfiguration: Double
    
    var parser: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __aws_sdk_types.ResponseParser<_stream.Readable> */ Any
    
    @JSName("region")
    def region_MLambdaResolvedConfiguration(): js.Promise[String]
    @JSName("region")
    ...
    @JSName("sha256")
    var sha256_LambdaResolvedConfiguration: HashConstructor
    
    @JSName("signer")
    var signer_LambdaResolvedConfiguration: RequestSigner
    
    @JSName("signingName")
    var signingName_LambdaResolvedConfiguration: String
    
    @JSName("sslEnabled")
    var sslEnabled_LambdaResolvedConfiguration: Boolean
    
    @JSName("streamCollector")
    def streamCollector_MLambdaResolvedConfiguration(stream: Any): js.Promise[js.typedarray.Uint8Array]
    @JSName("streamCollector")
    var streamCollector_Original: StreamCollector
    
    @JSName("urlParser")
    def urlParser_MLambdaResolvedConfiguration(url: String): Endpoint
    @JSName("urlParser")
    def urlParser_MLambdaResolvedConfiguration(url: URL): Endpoint
    @JSName("urlParser")
    var urlParser_Original: UrlParser
    
    @JSName("utf8Decoder")
    def utf8Decoder_MLambdaResolvedConfiguration(input: String): js.typedarray.Uint8Array
    @JSName("utf8Decoder")
    var utf8Decoder_Original: Decoder
    
    @JSName("utf8Encoder")
    def utf8Encoder_MLambdaResolvedConfiguration(input: js.typedarray.Uint8Array): String
    @JSName("utf8Encoder")
