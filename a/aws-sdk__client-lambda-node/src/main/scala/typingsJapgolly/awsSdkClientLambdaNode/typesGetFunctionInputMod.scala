...
object typesGetFunctionInputMod {
  
  trait GetFunctionInput
    extends StObject
  ...
  object GetFunctionInput {
    
    inline def apply(FunctionName: String): GetFunctionInput = {
      val __obj = js.Dynamic.literal(FunctionName = FunctionName.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetFunctionInput]
    }
    
    extension [Self <: GetFunctionInput](x: Self) {
