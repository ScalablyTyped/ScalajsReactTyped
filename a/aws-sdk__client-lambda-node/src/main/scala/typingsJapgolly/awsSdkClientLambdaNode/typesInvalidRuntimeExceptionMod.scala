...
object typesInvalidRuntimeExceptionMod {
  ...
  - Dropped / * import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify __ServiceException__<_InvalidRuntimeExceptionDetails> * / any */ trait InvalidRuntimeException
    ...
    var name: typingsJapgolly.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidRuntimeException
  }
  object InvalidRuntimeException {
    ...
    extension [Self <: InvalidRuntimeException](x: Self) {
      ...
      inline def setName(
        value: typingsJapgolly.awsSdkClientLambdaNode.awsSdkClientLambdaNodeStrings.InvalidRuntimeException
