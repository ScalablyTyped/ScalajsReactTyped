...
object typesGetFunctionConfigurationInputMod {
  
  trait GetFunctionConfigurationInput
    extends StObject
  ...
  object GetFunctionConfigurationInput {
    
    inline def apply(FunctionName: String): GetFunctionConfigurationInput = {
      val __obj = js.Dynamic.literal(FunctionName = FunctionName.asInstanceOf[js.Any])
      __obj.asInstanceOf[GetFunctionConfigurationInput]
    }
    
    extension [Self <: GetFunctionConfigurationInput](x: Self) {
