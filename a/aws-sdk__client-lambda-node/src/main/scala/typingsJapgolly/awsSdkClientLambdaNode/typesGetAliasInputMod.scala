...
@JSImport("@aws-sdk/client-lambda-node/types/GetAliasInput", JSImport.Namespace)
@js.native
object typesGetAliasInputMod extends js.Object {
  @js.native
  trait GetAliasInput extends _InputTypesUnion {
    /**
