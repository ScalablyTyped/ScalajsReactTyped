...
object typesUpdateFunctionConfigurationInputMod extends js.Object {
  ...
  trait UpdateFunctionConfigurationInput extends _InputTypesUnion {
    ...
    /**
      ...
      */
    var DeadLetterConfig: js.UndefOr[typingsJapgolly.awsSdkClientLambdaNode.typesDeadLetterConfigMod.DeadLetterConfig] = js.native
    /**
    ...
    /**
      ...
      */
    var Environment: js.UndefOr[typingsJapgolly.awsSdkClientLambdaNode.typesEnvironmentMod.Environment] = js.native
    /**
    ...
    /**
      ...
      */
    var TracingConfig: js.UndefOr[typingsJapgolly.awsSdkClientLambdaNode.typesTracingConfigMod.TracingConfig] = js.native
    /**
      * <p>Specify security groups and subnets in a VPC to which your Lambda function needs access.</p>
      */
    var VpcConfig: js.UndefOr[typingsJapgolly.awsSdkClientLambdaNode.typesVpcConfigMod.VpcConfig] = js.native
  }
