...
object brokenLinkCheckerReportMod {
  ...
  trait BrokenLinkCheckerReport extends StObject {
    ...
    /**
      ...
      */
    def addLink(syntheticsLink: typingsJapgolly.awsSyntheticsPuppeteer.syntheticsLinkMod.^): Unit = js.native
    def addLink(syntheticsLink: typingsJapgolly.awsSyntheticsPuppeteer.syntheticsLinkMod.^, isBrokenLink: Boolean): Unit = js.native
    
    var brokenLinks: js.Array[String] = js.native
    
    def getLinks(): Record[String, typingsJapgolly.awsSyntheticsPuppeteer.syntheticsLinkMod.^] = js.native
    
    def getTotalBrokenLinks(): Double = js.native
    
    def getTotalLinksChecked(): Double = js.native
    
    var links: Record[String, typingsJapgolly.awsSyntheticsPuppeteer.syntheticsLinkMod.^] = js.native
