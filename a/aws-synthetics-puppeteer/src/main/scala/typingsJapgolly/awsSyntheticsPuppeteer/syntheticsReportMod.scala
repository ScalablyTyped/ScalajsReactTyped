...
object syntheticsReportMod {
  ...
  object CanaryStepResult {
    ...
    inline def apply(
      endTime: Any,
      failureReason: Any,
      getEndTime: CallbackTo[Any],
      getFailureReason: CallbackTo[Any],
      getMetricsPublished: CallbackTo[Boolean],
      getStartTime: CallbackTo[Any],
      getStatus: CallbackTo[Any],
      getStepName: CallbackTo[Any],
      getStepNum: CallbackTo[Any],
    ...
    extension [Self <: CanaryStepResult](x: Self) {
      ...
      inline def setGetEndTime(value: CallbackTo[Any]): Self = StObject.set(x, "getEndTime", value.toJsFn)
      
      inline def setGetFailureReason(value: CallbackTo[Any]): Self = StObject.set(x, "getFailureReason", value.toJsFn)
      
      inline def setGetMetricsPublished(value: CallbackTo[Boolean]): Self = StObject.set(x, "getMetricsPublished", value.toJsFn)
      
      inline def setGetStartTime(value: CallbackTo[Any]): Self = StObject.set(x, "getStartTime", value.toJsFn)
      
      inline def setGetStatus(value: CallbackTo[Any]): Self = StObject.set(x, "getStatus", value.toJsFn)
      
      inline def setGetStepName(value: CallbackTo[Any]): Self = StObject.set(x, "getStepName", value.toJsFn)
      
      inline def setGetStepNum(value: CallbackTo[Any]): Self = StObject.set(x, "getStepNum", value.toJsFn)
