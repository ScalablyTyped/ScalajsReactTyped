...
import typingsJapgolly.azureArmResource.libLockOperationsMod.AuthorizationOperations
import typingsJapgolly.azureArmResource.libLockOperationsMod.ManagementLocks
