...
import typingsJapgolly.azureArmResource.lockOperationsMod.AuthorizationOperations
import typingsJapgolly.azureArmResource.lockOperationsMod.ManagementLocks
