...
import typingsJapgolly.azureArmResource.libSubscriptionOperationsMod.Operations
import typingsJapgolly.azureArmResource.libSubscriptionOperationsMod.Subscriptions
import typingsJapgolly.azureArmResource.libSubscriptionOperationsMod.Tenants
...
object libSubscriptionSubscriptionClientMod {
  
  @JSImport("azure-arm-resource/lib/subscription/subscriptionClient", JSImport.Default)
  @js.native
  open class default protected () extends SubscriptionClient {
    /**
  ...
  @js.native
  open class SubscriptionClient protected () extends AzureServiceClient {
    /**
      * Initializes a new instance of the SubscriptionClient class.
      * @constructor
      *
