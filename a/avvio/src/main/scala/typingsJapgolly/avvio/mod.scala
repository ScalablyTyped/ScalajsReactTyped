...
import typingsJapgolly.avvio.avvioStrings.close
import typingsJapgolly.avvio.avvioStrings.preReady
import typingsJapgolly.avvio.avvioStrings.start
...
object mod {
  ...
  trait Options extends StObject {
    ...
    var expose: js.UndefOr[typingsJapgolly.avvio.anon.After] = js.undefined
  }
  object Options {
    ...
    extension [Self <: Options](x: Self) {
      ...
      inline def setExpose(value: typingsJapgolly.avvio.anon.After): Self = StObject.set(x, "expose", value.asInstanceOf[js.Any])
