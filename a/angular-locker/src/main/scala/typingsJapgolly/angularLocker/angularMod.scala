package typingsJapgolly.angularLocker
...
object angularMod {
  ...
  object locker {
    ...
    object ILockerProvider {
      ...
      inline def apply($get: Any, defaults: ILockerSettings => Callback): ILockerProvider = {
        val __obj = js.Dynamic.literal($get = $get.asInstanceOf[js.Any], defaults = js.Any.fromFunction1((t0: ILockerSettings) => defaults(t0).runNow()))
        __obj.asInstanceOf[ILockerProvider]
      }
      
      extension [Self <: ILockerProvider](x: Self) {
        
        inline def setDefaults(value: ILockerSettings => Callback): Self = StObject.set(x, "defaults", js.Any.fromFunction1((t0: ILockerSettings) => value(t0).runNow()))
      }
    }
