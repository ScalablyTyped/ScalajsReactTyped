...
import typingsJapgolly.authmosphere.authenticationMiddlewareOptionsMod.AuthenticationMiddlewareOptions
import typingsJapgolly.authmosphere.scopeMiddlewareOptionsMod.ScopeMiddlewareOptions
