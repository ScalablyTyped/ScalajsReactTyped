...
import typingsJapgolly.authmosphere.anon.Code
import typingsJapgolly.authmosphere.anon.RefreshToken
import typingsJapgolly.authmosphere.anon.TokenInfoEndpoint
...
object libSrcTypesOauthconfigMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsDirConfig
    - typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsClientConfig
  */
  trait CredentialsConfig extends StObject
  object CredentialsConfig {
    
    inline def CredentialsClientConfig(clientId: String, clientSecret: String): typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsClientConfig = {
      val __obj = js.Dynamic.literal(clientId = clientId.asInstanceOf[js.Any], clientSecret = clientSecret.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsClientConfig]
    }
    
    inline def CredentialsDirConfig(credentialsDir: String): typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsDirConfig = {
      val __obj = js.Dynamic.literal(credentialsDir = credentialsDir.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsDirConfig]
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsDirConfig
    - typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsUserClientConfig
  */
  ...
  object CredentialsPasswordConfig {
    ...
    inline def CredentialsUserClientConfig(applicationPassword: String, applicationUsername: String, clientId: String, clientSecret: String): typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsUserClientConfig = {
      ...
      __obj.asInstanceOf[typingsJapgolly.authmosphere.libSrcTypesOauthconfigMod.CredentialsUserClientConfig]
    }
  }
