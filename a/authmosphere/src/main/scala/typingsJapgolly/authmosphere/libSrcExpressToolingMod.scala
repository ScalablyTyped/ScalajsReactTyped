...
import typingsJapgolly.authmosphere.libSrcTypesAuthenticationMiddlewareOptionsMod.AuthenticationMiddlewareOptions
import typingsJapgolly.authmosphere.libSrcTypesScopeMiddlewareOptionsMod.ScopeMiddlewareOptions
...
object libSrcExpressToolingMod {
