...
object GraphQLObjectTypeConfig {
  ...
  extension [Self <: GraphQLObjectTypeConfig](x: Self) {
    ...
    inline def setFieldsCallbackTo(value: CallbackTo[GraphQLFieldConfigMap]): Self = StObject.set(x, "fields", value.toJsFn)
    ...
    inline def setInterfacesCallbackTo(value: CallbackTo[js.Array[GraphQLInterfaceType]]): Self = StObject.set(x, "interfaces", value.toJsFn)
