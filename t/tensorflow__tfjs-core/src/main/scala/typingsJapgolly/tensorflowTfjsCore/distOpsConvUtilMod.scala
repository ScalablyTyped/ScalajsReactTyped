...
object distOpsConvUtilMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.SAME
    - typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.VALID
    - typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.NUMBER
    - typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.EXPLICIT
  */
  trait PadType extends StObject
  object PadType {
    
    inline def EXPLICIT: typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.EXPLICIT = "EXPLICIT".asInstanceOf[typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.EXPLICIT]
    
    inline def NUMBER: typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.NUMBER = "NUMBER".asInstanceOf[typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.NUMBER]
    
    inline def SAME: typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.SAME = "SAME".asInstanceOf[typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.SAME]
    
    inline def VALID: typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.VALID = "VALID".asInstanceOf[typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.VALID]
  }
}
