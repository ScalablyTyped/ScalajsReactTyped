...
import typingsJapgolly.tensorflowTfjsCore.AnonFactory
import typingsJapgolly.tensorflowTfjsCore.AnonGrads
...
import typingsJapgolly.tensorflowTfjsCore.environmentMod.Environment
import typingsJapgolly.tensorflowTfjsCore.kernelRegistryMod.NamedAttrMap
import typingsJapgolly.tensorflowTfjsCore.tensorMod.DataId
import typingsJapgolly.tensorflowTfjsCore.tensorMod.Tensor
import typingsJapgolly.tensorflowTfjsCore.tensorMod.TensorTracker
import typingsJapgolly.tensorflowTfjsCore.tensorTypesMod.GradSaveFunc
...
class Engine protected ()
  ...
  {[ P in keyof I ]: (): I[P]}
    */ typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.Engine with I
    ]
  ): T = js.native
  def runKernelFunc[T /* <: Tensor[Rank] | js.Array[Tensor[Rank]] */, I /* <: NamedTensorMap */](
    forwardFunc: ForwardFunc[T],
