...
trait Activation[T /* <: Tensor3D | Tensor4D */] extends StObject {
  ...
  var activation: js.UndefOr[typingsJapgolly.tensorflowTfjsCore.distOpsFusedTypesMod.Activation] = js.undefined
...
object Activation {
  ...
  extension [Self <: Activation[?], T /* <: Tensor3D | Tensor4D */](x: Self & Activation[T]) {
    ...
    inline def setActivation(value: typingsJapgolly.tensorflowTfjsCore.distOpsFusedTypesMod.Activation): Self = StObject.set(x, "activation", value.asInstanceOf[js.Any])
