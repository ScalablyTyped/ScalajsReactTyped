...
object serialization {
  ...
  open class Serializable ()
    extends typingsJapgolly.tensorflowTfjsCore.distSerializationMod.Serializable
  /* static members */
  object Serializable {
  ...
  /* private */ open class SerializationMap ()
    extends typingsJapgolly.tensorflowTfjsCore.distSerializationMod.SerializationMap
  /* static members */
