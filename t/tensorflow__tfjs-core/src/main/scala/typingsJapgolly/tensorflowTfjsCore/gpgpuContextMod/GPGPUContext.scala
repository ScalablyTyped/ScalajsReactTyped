...
import typingsJapgolly.tensorflowTfjsCore.webglTypesMod.WebGL1DisjointQueryTimerExtension
import typingsJapgolly.tensorflowTfjsCore.webglTypesMod.WebGL2DisjointQueryTimerExtension
