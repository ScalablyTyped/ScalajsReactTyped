...
object distOpsOpsForConverterMod {
  ...
  @JSImport("@tensorflow/tfjs-core/dist/ops/ops_for_converter", "raggedGather")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs-core/dist/ops/ops_for_converter", "raggedRange")
  @js.native
