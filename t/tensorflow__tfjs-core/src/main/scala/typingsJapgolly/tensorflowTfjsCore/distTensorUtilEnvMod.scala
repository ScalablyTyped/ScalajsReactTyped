...
import typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.numeric
import typingsJapgolly.tensorflowTfjsCore.tensorflowTfjsCoreStrings.string_or_numeric
