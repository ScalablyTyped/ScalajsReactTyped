...
import typingsJapgolly.tensorflowTfjsCore.anon.Attrs
import typingsJapgolly.tensorflowTfjsCore.distTapeMod.NamedGradientMap
...
object distKernelRegistryMod {
  ...
  object KernelConfig {
    ...
    extension [Self <: KernelConfig](x: Self) {
      ...
      inline def setDisposeFunc(value: /* backend */ js.Object => Callback): Self = StObject.set(x, "disposeFunc", js.Any.fromFunction1((t0: /* backend */ js.Object) => value(t0).runNow()))
      ...
      inline def setSetupFunc(value: /* backend */ js.Object => Callback): Self = StObject.set(x, "setupFunc", js.Any.fromFunction1((t0: /* backend */ js.Object) => value(t0).runNow()))
