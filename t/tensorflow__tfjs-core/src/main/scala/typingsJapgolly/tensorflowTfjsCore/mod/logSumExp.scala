...
@JSImport("@tensorflow/tfjs-core", "logSumExp")
@js.native
object logSumExp extends js.Object {
  ...
  def apply[T /* <: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] */](x: TensorLike, axis: js.Array[Double], keepDims: Boolean): T = js.native
  def apply[T /* <: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] */](x: TensorLike, axis: Double): T = js.native
  def apply[T /* <: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] */](x: TensorLike, axis: Double, keepDims: Boolean): T = js.native
  ...
  def apply[T /* <: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] */](x: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank], axis: Double): T = js.native
  def apply[T /* <: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] */](x: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank], axis: Double, keepDims: Boolean): T = js.native
}
