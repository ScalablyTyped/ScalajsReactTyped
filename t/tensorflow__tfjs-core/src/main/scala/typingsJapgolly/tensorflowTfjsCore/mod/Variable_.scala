...
@js.native
open class Variable_[R /* <: typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank */] protected ()
  extends typingsJapgolly.tensorflowTfjsCore.distBaseMod.Variable_[R] {
