...
object LoadOptions {
  ...
  def apply(
    ...
    onProgress: /* fraction */ Double => Callback = null,
    ...
    if (onProgress != null) __obj.updateDynamic("onProgress")(js.Any.fromFunction1((t0: /* fraction */ scala.Double) => onProgress(t0).runNow()))
