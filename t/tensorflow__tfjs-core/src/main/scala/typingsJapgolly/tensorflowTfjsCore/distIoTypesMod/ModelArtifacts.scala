...
trait ModelArtifacts extends StObject {
  ...
  /**
    ...
    */
  var initializerSignature: js.UndefOr[js.Object] = js.undefined
...
object ModelArtifacts {
  ...
  extension [Self <: ModelArtifacts](x: Self) {
    ...
    inline def setInitializerSignature(value: js.Object): Self = StObject.set(x, "initializerSignature", value.asInstanceOf[js.Any])
    
    inline def setInitializerSignatureUndefined: Self = StObject.set(x, "initializerSignature", js.undefined)
