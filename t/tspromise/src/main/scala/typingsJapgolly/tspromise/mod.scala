...
object mod {
  ...
  open class ^[T] protected ()
    ...
    def this(callback: js.Function2[
            ...
            /* reject */ js.UndefOr[js.Function1[/* error */ js.Error, Unit]], 
            Unit
          ]) = this()
  }
  @JSImport("tspromise", JSImport.Namespace)
  ...
  /* static member */
  inline def all(promises: js.Array[Thenable[Any]]): Thenable[js.Array[Any]] = ^.asInstanceOf[js.Dynamic].applyDynamic("all")(promises.asInstanceOf[js.Any]).asInstanceOf[Thenable[js.Array[Any]]]
