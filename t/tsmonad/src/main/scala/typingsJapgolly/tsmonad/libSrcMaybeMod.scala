...
import typingsJapgolly.tsmonad.libSrcMonadMod.Eq
import typingsJapgolly.tsmonad.libSrcMonadMod.Functor
import typingsJapgolly.tsmonad.libSrcMonadMod.Monad
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libSrcMaybeMod {
  ...
  object MaybePatterns {
    ...
    inline def apply[T, U](just: T => U, nothing: CallbackTo[U]): MaybePatterns[T, U] = {
      val __obj = js.Dynamic.literal(just = js.Any.fromFunction1(just), nothing = nothing.toJsFn)
    ...
    extension [Self <: MaybePatterns[?, ?], T, U](x: Self & (MaybePatterns[T, U])) {
      ...
      inline def setNothing(value: CallbackTo[U]): Self = StObject.set(x, "nothing", value.toJsFn)
    }
  }
