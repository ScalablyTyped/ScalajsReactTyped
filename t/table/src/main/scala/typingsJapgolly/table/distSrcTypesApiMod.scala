...
import typingsJapgolly.table.anon.ColumnUserConfigreadonlyw
...
object distSrcTypesApiMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.table.tableStrings.center
    - typingsJapgolly.table.tableStrings.justify
    - typingsJapgolly.table.tableStrings.left
    - typingsJapgolly.table.tableStrings.right
  */
  trait Alignment extends StObject
  object Alignment {
    
    inline def center: typingsJapgolly.table.tableStrings.center = "center".asInstanceOf[typingsJapgolly.table.tableStrings.center]
    
    inline def justify: typingsJapgolly.table.tableStrings.justify = "justify".asInstanceOf[typingsJapgolly.table.tableStrings.justify]
    
    inline def left: typingsJapgolly.table.tableStrings.left = "left".asInstanceOf[typingsJapgolly.table.tableStrings.left]
    
    inline def right: typingsJapgolly.table.tableStrings.right = "right".asInstanceOf[typingsJapgolly.table.tableStrings.right]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.table.tableStrings.bottom
    - typingsJapgolly.table.tableStrings.middle
    - typingsJapgolly.table.tableStrings.top
  */
  trait VerticalAlignment extends StObject
  object VerticalAlignment {
    
    inline def bottom: typingsJapgolly.table.tableStrings.bottom = "bottom".asInstanceOf[typingsJapgolly.table.tableStrings.bottom]
    
    inline def middle: typingsJapgolly.table.tableStrings.middle = "middle".asInstanceOf[typingsJapgolly.table.tableStrings.middle]
    
    inline def top: typingsJapgolly.table.tableStrings.top = "top".asInstanceOf[typingsJapgolly.table.tableStrings.top]
  }
  ...
  object WritableStream {
    ...
    inline def apply(write: js.Array[String] => Callback): WritableStream = {
      val __obj = js.Dynamic.literal(write = js.Any.fromFunction1((t0: js.Array[String]) => write(t0).runNow()))
      __obj.asInstanceOf[WritableStream]
    }
    
    extension [Self <: WritableStream](x: Self) {
      
      inline def setWrite(value: js.Array[String] => Callback): Self = StObject.set(x, "write", js.Any.fromFunction1((t0: js.Array[String]) => value(t0).runNow()))
    }
  }
}
