...
object dom {
  ...
  open class DOMUtils protected () extends StObject {
    ...
    def getAttribs(): NodeList[Node] = js.native
    def getAttribs(elm: HTMLElement): NodeList[Node] = js.native
  ...
  open class TreeWalker protected () extends StObject {
    def this(startNode: typingsJapgolly.tinymce.mod.html.Node, rootNode: typingsJapgolly.tinymce.mod.html.Node) = this()
    
    def current(): typingsJapgolly.tinymce.mod.html.Node = js.native
    
    def next(): typingsJapgolly.tinymce.mod.html.Node = js.native
    
    def prev(): typingsJapgolly.tinymce.mod.html.Node = js.native
  }
