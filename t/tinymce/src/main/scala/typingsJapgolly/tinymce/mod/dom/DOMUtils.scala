...
class DOMUtils protected () extends js.Object {
  ...
  def remove[T](node: typingsJapgolly.std.Element): Element | js.Array[T] = js.native
  def remove[T](node: typingsJapgolly.std.Element, keepChildren: Boolean): Element | js.Array[T] = js.native
