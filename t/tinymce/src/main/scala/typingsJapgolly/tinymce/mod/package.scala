...
inline def ScriptLoader: typingsJapgolly.tinymce.mod.dom.ScriptLoader = ^.asInstanceOf[js.Dynamic].selectDynamic("ScriptLoader").asInstanceOf[typingsJapgolly.tinymce.mod.dom.ScriptLoader]
