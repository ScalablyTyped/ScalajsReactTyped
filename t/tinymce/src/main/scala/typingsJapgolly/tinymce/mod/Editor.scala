...
import typingsJapgolly.tinymce.mod.dom.DOMUtils
import typingsJapgolly.tinymce.mod.dom.DomQuery
import typingsJapgolly.tinymce.mod.dom.Selection
import typingsJapgolly.tinymce.mod.dom.Serializer
import typingsJapgolly.tinymce.mod.html.DomParser
import typingsJapgolly.tinymce.mod.html.Schema
import typingsJapgolly.tinymce.mod.util.Observable
import typingsJapgolly.tinymce.mod.util.URI
...
class Editor protected () extends Observable {
  ...
  var notificationManager: typingsJapgolly.tinymce.mod.notificationManager = js.native
