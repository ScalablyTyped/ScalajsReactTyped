...
object Settings_ {
  ...
  def apply(
    ...
    color_picker_callback: (/* callback */ js.Function1[/* hexColor */ String, Unit], /* value */ String) => Callback = null,
    ...
    file_browser_callback: (/* field_name */ String, /* url */ String, /* type */ String, /* win */ Window_) => Callback = null,
    file_browser_callback_types: String = null,
    file_picker_callback: (/* callback */ js.Function2[/* filename */ String, /* metadata */ js.Object, Unit], /* valud */ String, /* meta */ js.Object) => Callback = null,
    ...
    images_dataimg_filter: /* img */ js.Any => Callback = null,
    ...
    images_upload_handler: (/* blobInfo */ js.Any, /* success */ js.Function1[/* msg */ String, Unit], /* failure */ js.Function1[/* msg */ String, Unit]) => Callback = null,
    ...
    init_instance_callback: /* editor */ Editor => Callback = null,
    ...
    setup: /* edtor */ Editor => Callback = null,
    ...
    urlconverter_callback: (/* url */ String, /* node */ HTMLElement, /* on_save */ Boolean, /* name */ String) => Callback = null,
    ...
    if (color_picker_callback != null) __obj.updateDynamic("color_picker_callback")(js.Any.fromFunction2((t0: /* callback */ js.Function1[/* hexColor */ java.lang.String, scala.Unit], t1: /* value */ java.lang.String) => color_picker_callback(t0, t1).runNow()))
    ...
    if (file_browser_callback != null) __obj.updateDynamic("file_browser_callback")(js.Any.fromFunction4((t0: /* field_name */ java.lang.String, t1: /* url */ java.lang.String, t2: /* type */ java.lang.String, t3: /* win */ typingsJapgolly.std.Window_) => file_browser_callback(t0, t1, t2, t3).runNow()))
    ...
    if (file_picker_callback != null) __obj.updateDynamic("file_picker_callback")(js.Any.fromFunction3((t0: /* callback */ js.Function2[/* filename */ java.lang.String, /* metadata */ js.Object, scala.Unit], t1: /* valud */ java.lang.String, t2: /* meta */ js.Object) => file_picker_callback(t0, t1, t2).runNow()))
    ...
    if (images_dataimg_filter != null) __obj.updateDynamic("images_dataimg_filter")(js.Any.fromFunction1((t0: /* img */ js.Any) => images_dataimg_filter(t0).runNow()))
    ...
    if (images_upload_handler != null) __obj.updateDynamic("images_upload_handler")(js.Any.fromFunction3((t0: /* blobInfo */ js.Any, t1: /* success */ js.Function1[/* msg */ java.lang.String, scala.Unit], t2: /* failure */ js.Function1[/* msg */ java.lang.String, scala.Unit]) => images_upload_handler(t0, t1, t2).runNow()))
    ...
    if (init_instance_callback != null) __obj.updateDynamic("init_instance_callback")(js.Any.fromFunction1((t0: /* editor */ typingsJapgolly.tinymce.mod.Editor) => init_instance_callback(t0).runNow()))
    ...
    if (setup != null) __obj.updateDynamic("setup")(js.Any.fromFunction1((t0: /* edtor */ typingsJapgolly.tinymce.mod.Editor) => setup(t0).runNow()))
    ...
    if (urlconverter_callback != null) __obj.updateDynamic("urlconverter_callback")(js.Any.fromFunction4((t0: /* url */ java.lang.String, t1: /* node */ org.scalajs.dom.raw.HTMLElement, t2: /* on_save */ scala.Boolean, t3: /* name */ java.lang.String) => urlconverter_callback(t0, t1, t2, t3).runNow()))
