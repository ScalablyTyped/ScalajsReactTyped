...
import typingsJapgolly.tinymce.mod.settings.Menu
import typingsJapgolly.tinymce.tinymceBooleans.`false`
import typingsJapgolly.tinymce.tinymceStrings.auto
import typingsJapgolly.tinymce.tinymceStrings.fixed
import typingsJapgolly.tinymce.tinymceStrings.relative
import typingsJapgolly.tinymce.tinymceStrings.responsive
...
object Settings_ {
  ...
  extension [Self <: Settings_](x: Self) {
    ...
    inline def setColor_picker_callback(value: (/* callback */ js.Function1[/* hexColor */ String, Unit], /* value */ String) => Callback): Self = StObject.set(x, "color_picker_callback", js.Any.fromFunction2((t0: /* callback */ js.Function1[/* hexColor */ String, Unit], t1: /* value */ String) => (value(t0, t1)).runNow()))
    ...
    inline def setFile_browser_callback(
      value: (/* field_name */ String, /* url */ String, /* type */ String, /* win */ Window) => Callback
    ): Self = StObject.set(x, "file_browser_callback", js.Any.fromFunction4((t0: /* field_name */ String, t1: /* url */ String, t2: /* type */ String, t3: /* win */ Window) => (value(t0, t1, t2, t3)).runNow()))
    ...
    inline def setFile_picker_callback(
      value: (/* callback */ js.Function2[/* filename */ String, /* metadata */ js.Object, Unit], /* valud */ String, /* meta */ js.Object) => Callback
    ): Self = StObject.set(x, "file_picker_callback", js.Any.fromFunction3((t0: /* callback */ js.Function2[/* filename */ String, /* metadata */ js.Object, Unit], t1: /* valud */ String, t2: /* meta */ js.Object) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setImages_dataimg_filter(value: /* img */ HTMLImageElement => Callback): Self = StObject.set(x, "images_dataimg_filter", js.Any.fromFunction1((t0: /* img */ HTMLImageElement) => value(t0).runNow()))
    ...
    inline def setImages_upload_handler(
      value: (/* blobInfo */ Any, /* success */ js.Function1[/* msg */ String, Unit], /* failure */ js.Function1[/* msg */ String, Unit]) => Callback
    ): Self = StObject.set(x, "images_upload_handler", js.Any.fromFunction3((t0: /* blobInfo */ Any, t1: /* success */ js.Function1[/* msg */ String, Unit], t2: /* failure */ js.Function1[/* msg */ String, Unit]) => (value(t0, t1, t2)).runNow()))
    ...
    inline def setInit_instance_callback(value: /* editor */ Editor => Callback): Self = StObject.set(x, "init_instance_callback", js.Any.fromFunction1((t0: /* editor */ Editor) => value(t0).runNow()))
    ...
    inline def setPaste_postprocess(value: (/* plugin */ Any, /* args */ Any) => Callback): Self = StObject.set(x, "paste_postprocess", js.Any.fromFunction2((t0: /* plugin */ Any, t1: /* args */ Any) => (value(t0, t1)).runNow()))
    
    inline def setPaste_postprocessUndefined: Self = StObject.set(x, "paste_postprocess", js.undefined)
    
    inline def setPaste_preprocess(value: (/* plugin */ Any, /* args */ Any) => Callback): Self = StObject.set(x, "paste_preprocess", js.Any.fromFunction2((t0: /* plugin */ Any, t1: /* args */ Any) => (value(t0, t1)).runNow()))
    ...
    inline def setSetup(value: /* edtor */ Editor => Callback): Self = StObject.set(x, "setup", js.Any.fromFunction1((t0: /* edtor */ Editor) => value(t0).runNow()))
    ...
    inline def setUrlconverter_callback(
      value: (/* url */ String, /* node */ HTMLElement, /* on_save */ Boolean, /* name */ String) => Callback
    ): Self = StObject.set(x, "urlconverter_callback", js.Any.fromFunction4((t0: /* url */ String, t1: /* node */ HTMLElement, t2: /* on_save */ Boolean, t3: /* name */ String) => (value(t0, t1, t2, t3)).runNow()))
