...
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ChannelGroupClientList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ChannelGroupCopy
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ChannelGroupList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.PermList
