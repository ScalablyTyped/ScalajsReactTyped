...
import typingsJapgolly.ts3NodejsLibrary.anon.Cgid
import typingsJapgolly.ts3NodejsLibrary.anon.Cid
import typingsJapgolly.ts3NodejsLibrary.anon.Cldbid
import typingsJapgolly.ts3NodejsLibrary.anon.PartialChannelEntry
import typingsJapgolly.ts3NodejsLibrary.anon.PartialChannelGroupEntry
import typingsJapgolly.ts3NodejsLibrary.anon.PartialClientEntry
import typingsJapgolly.ts3NodejsLibrary.anon.PartialConnectionParams
import typingsJapgolly.ts3NodejsLibrary.anon.PartialServerEntry
import typingsJapgolly.ts3NodejsLibrary.anon.PartialServerGroupEntry
import typingsJapgolly.ts3NodejsLibrary.anon.Permid
import typingsJapgolly.ts3NodejsLibrary.anon.Sgid
import typingsJapgolly.ts3NodejsLibrary.libExceptionResponseErrorMod.ResponseError
import typingsJapgolly.ts3NodejsLibrary.libNodeChannelGroupMod.TeamSpeakChannelGroup
import typingsJapgolly.ts3NodejsLibrary.libNodeChannelGroupMod.TeamSpeakChannelGroup.GroupType
import typingsJapgolly.ts3NodejsLibrary.libNodeChannelMod.TeamSpeakChannel
import typingsJapgolly.ts3NodejsLibrary.libNodeChannelMod.TeamSpeakChannel.ChannelType
import typingsJapgolly.ts3NodejsLibrary.libNodeClientMod.TeamSpeakClient
...
import typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup
import typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.MultiGroupType
import typingsJapgolly.ts3NodejsLibrary.libNodeServerMod.TeamSpeakServer
import typingsJapgolly.ts3NodejsLibrary.libNodeServerMod.TeamSpeakServer.ServerType
import typingsJapgolly.ts3NodejsLibrary.libTransportTeamSpeakQueryMod.TeamSpeakQuery.Response
import typingsJapgolly.ts3NodejsLibrary.libTransportTeamSpeakQueryMod.TeamSpeakQuery.ResponseEntry
import typingsJapgolly.ts3NodejsLibrary.libTransportTeamSpeakQueryMod.TeamSpeakQuery.executeArgs
import typingsJapgolly.ts3NodejsLibrary.libTypesEnumMod.LogLevel
import typingsJapgolly.ts3NodejsLibrary.libTypesEnumMod.ReasonIdentifier
import typingsJapgolly.ts3NodejsLibrary.libTypesEnumMod.TextMessageTargetMode.CHANNEL
import typingsJapgolly.ts3NodejsLibrary.libTypesEnumMod.TextMessageTargetMode.CLIENT
import typingsJapgolly.ts3NodejsLibrary.libTypesEnumMod.TextMessageTargetMode.SERVER
import typingsJapgolly.ts3NodejsLibrary.libTypesEnumMod.TokenType.ChannelGroup
import typingsJapgolly.ts3NodejsLibrary.libTypesEnumMod.TokenType.ServerGroup
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.ChannelCreate
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.ChannelDelete
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.ChannelMove
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.ClientConnect
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.ClientDisconnect
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.ClientMoved
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.Debug
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.ServerEdit
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.TextMessage
import typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.TokenUsed
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ApiKeyAdd
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ApiKeyList
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.BanAdd
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.BanClient
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ChannelEdit
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ClientDBEdit
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ClientEdit
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ClientUpdate
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.InstanceEdit
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ServerTempPasswordAdd
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.TransferDownload
import typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.TransferUpload
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ApiKeyEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.BanEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.BindingEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ChannelClientPermIdList
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ChannelClientPermSidList
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ChannelFind
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ChannelGroupClientList
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ChannelGroupCopy
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ChannelInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientDBEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientDBFind
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientDBInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientFind
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientGetDbidFromUid
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientGetIdEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientGetNameFromDbid
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientGetNameFromUid
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientGetUidFromClid
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ClientSetServerQueryLogin
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ComplainEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.CustomInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.CustomSearch
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.FTGetFileEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.FTGetFileInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.FTInitDownload
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.FTInitUpload
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.FileTransferEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.HostInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.InstanceInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.LogView
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.MessageEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.MessageGet
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.PermFind
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.PermGet
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.PermIdGetByName
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.PermOverviewEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.PermissionEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.PrivilegeKeyEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.QueryLoginAdd
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.QueryLoginEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ServerCreate
...
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ServerGroupsByClientId
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ServerIdGetByPort
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ServerInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ServerRequestConnectionInfo
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ServerTempPasswordEntry
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.SnapshotCreate
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.Token
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.Version
import typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.Whoami
...
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryBooleans.`false`
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryBooleans.`true`
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.`0`
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.channelcreate
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.channeldelete
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.channeledit
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.channelmoved
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.clientconnect
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.clientdisconnect
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.clientmoved
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.close
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.debug
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.error
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.flooding
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.ready
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.serveredit
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.textmessage
import typingsJapgolly.ts3NodejsLibrary.ts3NodejsLibraryStrings.tokenused
...
object libTeamSpeakMod {
  ...
  open class TeamSpeak protected () extends EventEmitter {
    ...
    def apiKeyAdd(props: ApiKeyAdd): js.Promise[typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.ApiKeyAdd] = js.native
    ...
    /**
      ...
      */
    def ban(properties: BanAdd): js.Promise[typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.BanAdd] = js.native
    ...
    /**
      ...
      */
    def banClient(properties: BanClient): js.Promise[typingsJapgolly.ts3NodejsLibrary.libTypesResponseTypesMod.BanAdd] = js.native
    ...
    val config: typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.ConnectionParams = js.native
    ...
    /**
      ...
      */
    def getServerGroupById(group: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[js.UndefOr[TeamSpeakServerGroup]] = js.native
    ...
    def on_channeledit(
      event: channeledit,
      listener: js.Function1[/* event */ typingsJapgolly.ts3NodejsLibrary.libTypesEventsMod.ChannelEdit, Unit]
    ): this.type = js.native
    @JSName("on")
    ...
    def privilegeKeyAdd(
      ...
      group: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType
    ): Any = js.native
    def privilegeKeyAdd(
      tokentype: ServerGroup,
      group: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType,
    ...
    /**
      ...
      */
    def serverCreate(properties: typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ServerEdit): js.Promise[ServerCreate] = js.native
    ...
    /**
      ...
      */
    def serverEdit(properties: typingsJapgolly.ts3NodejsLibrary.libTypesPropertyTypesMod.ServerEdit): js.Promise[js.Array[Any]] = js.native
    ...
    /**
      ...
      * @param group the servergroup id
      */
    def serverGroupClientList(group: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[js.Array[ServerGroupClientEntry]] = js.native
    ...
    /**
      ...
      */
    def serverGroupCopy(sourceGroup: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[ServerGroupCopy] = js.native
    def serverGroupCopy(
      sourceGroup: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType,
      targetGroup: Unit,
      `type`: Double
    ...
    def serverGroupCopy(
      sourceGroup: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType,
      targetGroup: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType
    ): js.Promise[ServerGroupCopy] = js.native
    def serverGroupCopy(
      sourceGroup: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType,
      targetGroup: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType,
    ...
    /**
      ...
      */
    def serverGroupDel(group: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[js.Array[Any]] = js.native
    def serverGroupDel(
      group: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType,
      force: Boolean
    ): js.Promise[js.Array[Any]] = js.native
    ...
    /**
      ...
      * @param permsid if the permsid option is set to true the output will contain the permission names
      */
    def serverGroupPermList(group: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[js.Array[Permission[Sgid]]] = js.native
    ...
    /**
      ...
      * @param tokencustomset token custom set
      */
    def serverGroupPrivilegeKeyAdd(group: typingsJapgolly.ts3NodejsLibrary.libNodeServerGroupMod.TeamSpeakServerGroup.GroupType): js.Promise[Token] = js.native
  ...
  object TeamSpeak {
    ...
    object QueryProtocol extends StObject {
      ...
      sealed trait RAW
        extends StObject
           with typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.QueryProtocol
    ...
    trait ConnectionParams extends StObject {
      ...
      var protocol: typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.QueryProtocol
    ...
    object ConnectionParams {
      ...
      inline def apply(
        ...
        protocol: typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.QueryProtocol,
        queryport: Double,
        readyTimeout: Double
      ): typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.ConnectionParams = {
        ...
        __obj.asInstanceOf[typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.ConnectionParams]
      }
      
      extension [Self <: typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.ConnectionParams](x: Self) {
        ...
        inline def setProtocol(value: typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.QueryProtocol): Self = StObject.set(x, "protocol", value.asInstanceOf[js.Any])
  ...
  type ConnectionParams = typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.ConnectionParams
}
