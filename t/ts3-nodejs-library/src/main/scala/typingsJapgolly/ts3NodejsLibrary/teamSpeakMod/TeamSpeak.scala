...
import typingsJapgolly.ts3NodejsLibrary.PartialChannelGroupList
import typingsJapgolly.ts3NodejsLibrary.PartialChannelList
import typingsJapgolly.ts3NodejsLibrary.PartialClientList
import typingsJapgolly.ts3NodejsLibrary.PartialConnectionParams
import typingsJapgolly.ts3NodejsLibrary.PartialServerGroupList
import typingsJapgolly.ts3NodejsLibrary.PartialServerList
import typingsJapgolly.ts3NodejsLibrary.channelGroupMod.TeamSpeakChannelGroup
...
import typingsJapgolly.ts3NodejsLibrary.eventsMod.ChannelCreate
import typingsJapgolly.ts3NodejsLibrary.eventsMod.ChannelDelete
import typingsJapgolly.ts3NodejsLibrary.eventsMod.ChannelMove
import typingsJapgolly.ts3NodejsLibrary.eventsMod.ClientConnect
import typingsJapgolly.ts3NodejsLibrary.eventsMod.ClientDisconnect
import typingsJapgolly.ts3NodejsLibrary.eventsMod.ClientMoved
import typingsJapgolly.ts3NodejsLibrary.eventsMod.Debug
import typingsJapgolly.ts3NodejsLibrary.eventsMod.ServerEdit
import typingsJapgolly.ts3NodejsLibrary.eventsMod.TextMessage
import typingsJapgolly.ts3NodejsLibrary.eventsMod.TokenUsed
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.BanAdd
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.BanClient
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.ChannelEdit
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.ClientDBEdit
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.ClientEdit
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.ClientUpdate
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.InstanceEdit
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.ServerTempPasswordAdd
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.TransferDownload
import typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.TransferUpload
...
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.BanList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.BindingList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ChannelClientPermListId
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ChannelClientPermListSid
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ChannelFind
...
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ChannelInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientDBFind
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientDBInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientDBList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientFind
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientGetDbidFromUid
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientGetIds
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientGetNameFromDbid
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientGetNameFromUid
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientGetUidFromClid
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ClientSetServerQueryLogin
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ComplainList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.CustomInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.CustomSearch
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.FTGetFileInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.FTGetFileList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.FTInitDownload
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.FTInitUpload
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.FTList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.HostInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.InstanceInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.LogView
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.MessageGet
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.MessageList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.PermFind
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.PermGet
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.PermIdGetByName
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.PermList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.PermOverview
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.PermissionList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.PrivilegeKeyList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.QueryLoginAdd
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.QueryLoginList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ServerCreate
...
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ServerGroupsByClientId
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ServerIdGetByPort
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ServerInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ServerRequestConnectionInfo
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ServerTempPasswordList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.SnapshotCreate
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.Token
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.Version
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.Whoami
import typingsJapgolly.ts3NodejsLibrary.serverGroupMod.TeamSpeakServerGroup
import typingsJapgolly.ts3NodejsLibrary.serverMod.TeamSpeakServer
...
class TeamSpeak protected () extends EventEmitter {
  ...
  /**
    ...
    */
  def ban(properties: BanAdd): js.Promise[typingsJapgolly.ts3NodejsLibrary.responseTypesMod.BanAdd] = js.native
  /**
    ...
    */
  def banClient(properties: BanClient): js.Promise[typingsJapgolly.ts3NodejsLibrary.responseTypesMod.BanAdd] = js.native
  /**
  ...
  def clientKick(
    clid: Double,
    reasonid: typingsJapgolly.ts3NodejsLibrary.enumMod.ReasonIdentifier,
    reasonmsg: String
  ...
  /**
    ...
    */
  def logAdd(loglevel: typingsJapgolly.ts3NodejsLibrary.enumMod.LogLevel, logmsg: String): js.Promise[js.Array[QueryResponseTypes]] = js.native
  /**
  ...
  def on_channeledit(
    event: channeledit,
    listener: js.Function1[/* event */ typingsJapgolly.ts3NodejsLibrary.eventsMod.ChannelEdit, Unit]
  ): this.type = js.native
  @JSName("on")
  ...
  /**
    ...
    */
  def privilegeKeyAdd(tokentype: typingsJapgolly.ts3NodejsLibrary.enumMod.TokenType, group: Double): js.Promise[Token] = js.native
  def privilegeKeyAdd(tokentype: typingsJapgolly.ts3NodejsLibrary.enumMod.TokenType, group: Double, cid: Double): js.Promise[Token] = js.native
  def privilegeKeyAdd(
    tokentype: typingsJapgolly.ts3NodejsLibrary.enumMod.TokenType,
    group: Double,
    cid: Double,
    description: String
  ...
  def sendTextMessage(
    target: Double,
    targetmode: typingsJapgolly.ts3NodejsLibrary.enumMod.TextMessageTargetMode,
    msg: String
  ): js.Promise[js.Array[QueryResponseTypes]] = js.native
  /**
    ...
    */
  def serverCreate(properties: typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.ServerEdit): js.Promise[ServerCreate] = js.native
  /**
    * deletes the server
  ...
  /**
    ...
    */
  def serverEdit(properties: typingsJapgolly.ts3NodejsLibrary.propertyTypesMod.ServerEdit): js.Promise[js.Array[QueryResponseTypes]] = js.native
