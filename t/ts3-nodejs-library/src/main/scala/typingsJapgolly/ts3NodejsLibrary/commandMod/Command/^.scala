...
import typingsJapgolly.ts3NodejsLibrary.AnonKey
import typingsJapgolly.ts3NodejsLibrary.PartialPartialQueryRespon
import typingsJapgolly.ts3NodejsLibrary.PickParserArgumentraw
...
object ^ extends js.Object {
  /**
    ...
    */
  def build(command: typingsJapgolly.ts3NodejsLibrary.commandMod.Command): String = js.native
  /**
    * the custom snapshot request parser
    * @param data snapshot string
    * @param cmd command object
    */
  def buildSnapshotDeploy(data: String, cmd: typingsJapgolly.ts3NodejsLibrary.commandMod.Command): String = js.native
  /** escapes a string */
