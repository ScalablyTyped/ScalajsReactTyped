...
import typingsJapgolly.ts3NodejsLibrary.anon.PartialPermType
import typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak
import typingsJapgolly.ts3NodejsLibrary.libUtilPermissionMod.Permission.IConfig
import typingsJapgolly.ts3NodejsLibrary.libUtilPermissionMod.Permission.PermId
import typingsJapgolly.ts3NodejsLibrary.libUtilPermissionMod.Permission.PermSid
