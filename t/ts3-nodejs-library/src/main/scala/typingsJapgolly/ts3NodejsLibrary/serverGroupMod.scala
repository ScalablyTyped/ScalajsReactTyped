...
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ServerGroupClientList
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.ServerGroupCopy
