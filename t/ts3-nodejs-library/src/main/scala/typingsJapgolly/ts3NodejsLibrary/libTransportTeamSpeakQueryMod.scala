...
import typingsJapgolly.ts3NodejsLibrary.libTeamSpeakMod.TeamSpeak.ConnectionParams
import typingsJapgolly.ts3NodejsLibrary.libTransportCommandMod.Command
import typingsJapgolly.ts3NodejsLibrary.libTransportCommandMod.Command.ParserCallback
import typingsJapgolly.ts3NodejsLibrary.libTransportCommandMod.Command.flags
import typingsJapgolly.ts3NodejsLibrary.libTransportCommandMod.Command.multiOpts
import typingsJapgolly.ts3NodejsLibrary.libTransportCommandMod.Command.options
...
object libTransportTeamSpeakQueryMod {
  ...
  object TeamSpeakQuery {
    ...
    object QueueItem {
      ...
      inline def apply(cmd: Command, fulfill: Any => Callback, priority: Boolean, reject: Any => Callback): QueueItem = {
        val __obj = js.Dynamic.literal(cmd = cmd.asInstanceOf[js.Any], fulfill = js.Any.fromFunction1((t0: Any) => fulfill(t0).runNow()), priority = priority.asInstanceOf[js.Any], reject = js.Any.fromFunction1((t0: Any) => reject(t0).runNow()))
      ...
      extension [Self <: QueueItem](x: Self) {
        ...
        inline def setFulfill(value: Any => Callback): Self = StObject.set(x, "fulfill", js.Any.fromFunction1((t0: Any) => value(t0).runNow()))
