package typingsJapgolly.ts3NodejsLibrary.teamSpeakQueryMod

import typingsJapgolly.node.eventsMod.EventEmitter
import typingsJapgolly.ts3NodejsLibrary.queryResponseMod.QueryResponseTypes
import typingsJapgolly.ts3NodejsLibrary.teamSpeakMod.ConnectionParams
import typingsJapgolly.ts3NodejsLibrary.teamSpeakQueryMod.TeamSpeakQuery.executeArgs
