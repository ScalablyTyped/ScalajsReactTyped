...
import typingsJapgolly.ts3NodejsLibrary.enumMod.ClientType
...
import typingsJapgolly.ts3NodejsLibrary.enumMod.TextMessageTargetMode
import typingsJapgolly.ts3NodejsLibrary.enumMod.TokenType
import typingsJapgolly.ts3NodejsLibrary.responseTypesMod.TokenCustomSet
