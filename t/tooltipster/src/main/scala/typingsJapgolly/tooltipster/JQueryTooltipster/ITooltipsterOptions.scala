...
import typingsJapgolly.tooltipster.AnonClick
import typingsJapgolly.tooltipster.AnonMouseenter
...
object ITooltipsterOptions {
  ...
  /* pluginName */ StringDictionary[js.Any] = null,
    ...
    functionAfter: (/* instance */ ITooltipsterInstance, /* helper */ ITooltipsterHelper) => Callback = null,
    functionBefore: (/* instance */ ITooltipsterInstance, /* helper */ ITooltipsterHelper) => Callback = null,
    functionFormat: (/* instance */ ITooltipsterInstance, /* helper */ ITooltipsterHelper, /* content */ js.Any) => CallbackTo[String | JQuery] = null,
    functionInit: (/* instance */ ITooltipsterInstance, /* helper */ ITooltipsterHelper) => Callback = null,
    functionPosition: (/* instance */ ITooltipsterInstance, /* helper */ ITooltipsterHelper, /* position */ ITooltipPosition) => CallbackTo[ITooltipPosition] = null,
    functionReady: (/* instance */ ITooltipsterInstance, /* helper */ ITooltipsterHelper) => Callback = null,
    ...
    if (!js.isUndefined(contentAsHTML)) __obj.updateDynamic("contentAsHTML")(contentAsHTML.asInstanceOf[js.Any])
    if (!js.isUndefined(contentCloning)) __obj.updateDynamic("contentCloning")(contentCloning.asInstanceOf[js.Any])
    ...
    if (functionAfter != null) __obj.updateDynamic("functionAfter")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterInstance, t1: /* helper */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterHelper) => functionAfter(t0, t1).runNow()))
    if (functionBefore != null) __obj.updateDynamic("functionBefore")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterInstance, t1: /* helper */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterHelper) => functionBefore(t0, t1).runNow()))
    if (functionFormat != null) __obj.updateDynamic("functionFormat")(js.Any.fromFunction3((t0: /* instance */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterInstance, t1: /* helper */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterHelper, t2: /* content */ js.Any) => functionFormat(t0, t1, t2).runNow()))
    if (functionInit != null) __obj.updateDynamic("functionInit")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterInstance, t1: /* helper */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterHelper) => functionInit(t0, t1).runNow()))
    if (functionPosition != null) __obj.updateDynamic("functionPosition")(js.Any.fromFunction3((t0: /* instance */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterInstance, t1: /* helper */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterHelper, t2: /* position */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipPosition) => functionPosition(t0, t1, t2).runNow()))
    if (functionReady != null) __obj.updateDynamic("functionReady")(js.Any.fromFunction2((t0: /* instance */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterInstance, t1: /* helper */ typingsJapgolly.tooltipster.JQueryTooltipster.ITooltipsterHelper) => functionReady(t0, t1).runNow()))
    ...
    if (!js.isUndefined(repositionOnScroll)) __obj.updateDynamic("repositionOnScroll")(repositionOnScroll.asInstanceOf[js.Any])
    if (restoration != null) __obj.updateDynamic("restoration")(restoration.asInstanceOf[js.Any])
    if (!js.isUndefined(selfDestruction)) __obj.updateDynamic("selfDestruction")(selfDestruction.asInstanceOf[js.Any])
    if (side != null) __obj.updateDynamic("side")(side.asInstanceOf[js.Any])
    if (theme != null) __obj.updateDynamic("theme")(theme.asInstanceOf[js.Any])
    if (timer != null) __obj.updateDynamic("timer")(timer.asInstanceOf[js.Any])
    if (!js.isUndefined(trackOrigin)) __obj.updateDynamic("trackOrigin")(trackOrigin.asInstanceOf[js.Any])
    if (!js.isUndefined(trackTooltip)) __obj.updateDynamic("trackTooltip")(trackTooltip.asInstanceOf[js.Any])
    ...
    if (!js.isUndefined(viewportAware)) __obj.updateDynamic("viewportAware")(viewportAware.asInstanceOf[js.Any])
