...
import typingsJapgolly.telebot.AnonCacheTime
import typingsJapgolly.telebot.AnonCaption
import typingsJapgolly.telebot.AnonChatId
import typingsJapgolly.telebot.AnonCurrency
import typingsJapgolly.telebot.AnonDuration
import typingsJapgolly.telebot.AnonErrorMessage
import typingsJapgolly.telebot.AnonErrorMessageString
import typingsJapgolly.telebot.AnonFileName
import typingsJapgolly.telebot.AnonFoursquareId
import typingsJapgolly.telebot.AnonHeight
import typingsJapgolly.telebot.AnonInlineMessageId
import typingsJapgolly.telebot.AnonInlineMsgId
import typingsJapgolly.telebot.AnonLimit
import typingsJapgolly.telebot.AnonMessageId
import typingsJapgolly.telebot.AnonNotification
import typingsJapgolly.telebot.AnonNotificationBoolean
import typingsJapgolly.telebot.AnonNotificationReplyMarkup
import typingsJapgolly.telebot.AnonReplyMarkup
import typingsJapgolly.telebot.AnonReplyToMessage
...
trait telebot extends js.Object {
  ...
  def setGameScore(user_id: Double, score: Double, opt: AnonChatId): Boolean | js.Error | js.Any = js.native
