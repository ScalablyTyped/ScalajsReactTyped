...
object mod {
  ...
  */
  ...
  object ChannelType {
    ...
    inline def apn: typingsJapgolly.twilioNotifications.twilioNotificationsStrings.apn = "apn".asInstanceOf[typingsJapgolly.twilioNotifications.twilioNotificationsStrings.apn]
    
    inline def fcm: typingsJapgolly.twilioNotifications.twilioNotificationsStrings.fcm = "fcm".asInstanceOf[typingsJapgolly.twilioNotifications.twilioNotificationsStrings.fcm]
    
    inline def twilsock: typingsJapgolly.twilioNotifications.twilioNotificationsStrings.twilsock = "twilsock".asInstanceOf[typingsJapgolly.twilioNotifications.twilioNotificationsStrings.twilsock]
  }
