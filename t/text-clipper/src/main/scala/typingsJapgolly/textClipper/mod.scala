package typingsJapgolly.textClipper

import typingsJapgolly.textClipper.textClipperBooleans.`false`
import typingsJapgolly.textClipper.textClipperBooleans.`true`
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.textClipper.mod.ClipPlainTextOptions
    - typingsJapgolly.textClipper.mod.ClipHtmlOptions
  */
  trait ClipOptions extends StObject
  object ClipOptions {
    
    inline def ClipHtmlOptions(): typingsJapgolly.textClipper.mod.ClipHtmlOptions = {
      val __obj = js.Dynamic.literal(html = true)
      __obj.asInstanceOf[typingsJapgolly.textClipper.mod.ClipHtmlOptions]
    }
    
    inline def ClipPlainTextOptions(): typingsJapgolly.textClipper.mod.ClipPlainTextOptions = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[typingsJapgolly.textClipper.mod.ClipPlainTextOptions]
    }
  }
