package typingsJapgolly.treeSync
...
object mod {
  ...
  object TreeSync {
    ...
    inline def apply(sync: CallbackTo[js.Array[TreeSyncResult]]): TreeSync = {
    ...
    extension [Self <: TreeSync](x: Self) {
      ...
      inline def setSync(value: CallbackTo[js.Array[TreeSyncResult]]): Self = StObject.set(x, "sync", value.toJsFn)
    }
  }
