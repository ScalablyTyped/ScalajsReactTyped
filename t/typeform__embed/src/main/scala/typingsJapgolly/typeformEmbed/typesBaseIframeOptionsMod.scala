...
import typingsJapgolly.typeformEmbed.anon.PartialHTMLIFrameElementW
...
object typesBaseIframeOptionsMod {
  ...
  trait HTMLIFrameElementWithStyleString extends StObject {
    ...
    var childNodes: NodeList[ChildNode & Node]
    ...
    var querySelectorAll_Original: js.Function1[a, NodeList[HTMLAnchorElement & Node]]
    @JSName("querySelectorAll")
    def querySelectorAll_a(selectors: a): NodeList[HTMLAnchorElement & Node]
  ...
  object HTMLIFrameElementWithStyleString {
    ...
    inline def apply(
      ...
      addEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[HTMLIFrameElementWithStyleString, /* ev */ Event, Any]) => Callback,
      ...
      getSVGDocument: CallbackTo[Document | Null],
      ...
      removeEventListener: (fullscreenchange, /* listener */ js.ThisFunction1[HTMLIFrameElementWithStyleString, /* ev */ Event, Any]) => Callback,
    ...
    extension [Self <: HTMLIFrameElementWithStyleString](x: Self) {
      ...
      inline def setAddEventListener(
        value: (fullscreenchange, /* listener */ js.ThisFunction1[HTMLIFrameElementWithStyleString, /* ev */ Event, Any]) => Callback
      ): Self = StObject.set(x, "addEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[HTMLIFrameElementWithStyleString, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setOnprogress(value: js.ThisFunction1[HTMLIFrameElementWithStyleString, /* ev */ ProgressEvent, Any]): Self = StObject.set(x, "onprogress", value.asInstanceOf[js.Any])
      ...
      inline def setRemoveEventListener(
        value: (fullscreenchange, /* listener */ js.ThisFunction1[HTMLIFrameElementWithStyleString, /* ev */ Event, Any]) => Callback
      ): Self = StObject.set(x, "removeEventListener", js.Any.fromFunction2((t0: fullscreenchange, t1: /* listener */ js.ThisFunction1[HTMLIFrameElementWithStyleString, /* ev */ Event, Any]) => (value(t0, t1)).runNow()))
