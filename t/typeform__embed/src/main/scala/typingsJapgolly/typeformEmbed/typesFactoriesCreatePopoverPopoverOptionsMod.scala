...
object typesFactoriesCreatePopoverPopoverOptionsMod {
  ...
  - typingsJapgolly.typeformEmbed.typesBaseModalWindowOptionsMod.ModalWindowOptions because var conflicts: keepSession. Inlined container, autoClose */ trait PopoverOptions
    extends StObject
       with BaseOptions
       with UrlOptions
