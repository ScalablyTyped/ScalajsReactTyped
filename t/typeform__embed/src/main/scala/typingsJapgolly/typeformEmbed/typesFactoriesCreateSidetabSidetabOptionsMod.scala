...
object typesFactoriesCreateSidetabSidetabOptionsMod {
  ...
  - typingsJapgolly.typeformEmbed.typesBaseModalWindowOptionsMod.ModalWindowOptions because var conflicts: keepSession. Inlined container, autoClose */ trait SidetabOptions
    extends StObject
       with BaseOptions
       with UrlOptions
