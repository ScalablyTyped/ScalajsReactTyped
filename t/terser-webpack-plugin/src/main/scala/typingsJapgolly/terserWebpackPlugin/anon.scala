...
import typingsJapgolly.terserWebpackPlugin.mod.MinimizerImplementation
import typingsJapgolly.terserWebpackPlugin.mod.MinimizerOptions
import typingsJapgolly.terserWebpackPlugin.terserWebpackPluginStrings.comment1
import typingsJapgolly.terserWebpackPlugin.terserWebpackPluginStrings.comment2
import typingsJapgolly.terserWebpackPlugin.terserWebpackPluginStrings.comment3
import typingsJapgolly.terserWebpackPlugin.terserWebpackPluginStrings.comment4
