...
import typingsJapgolly.terserWebpackPlugin.anon.Col
import typingsJapgolly.terserWebpackPlugin.anon.Implementation
...
object mod {
  ...
  object esbuildMinify {
    ...
    inline def apply(
      input: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.Input,
      sourceMap: Unit,
      minimizerOptions: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.PredefinedOptions & typingsJapgolly.terserWebpackPlugin.typesUtilsMod.CustomOptions
    ): js.Promise[typingsJapgolly.terserWebpackPlugin.typesUtilsMod.MinimizedResult] = (^.asInstanceOf[js.Dynamic].apply(input.asInstanceOf[js.Any], sourceMap.asInstanceOf[js.Any], minimizerOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.terserWebpackPlugin.typesUtilsMod.MinimizedResult]]
    inline def apply(
      input: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.Input,
      sourceMap: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.SourceMapInput,
      minimizerOptions: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.PredefinedOptions & typingsJapgolly.terserWebpackPlugin.typesUtilsMod.CustomOptions
    ): js.Promise[typingsJapgolly.terserWebpackPlugin.typesUtilsMod.MinimizedResult] = (^.asInstanceOf[js.Dynamic].apply(input.asInstanceOf[js.Any], sourceMap.asInstanceOf[js.Any], minimizerOptions.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.terserWebpackPlugin.typesUtilsMod.MinimizedResult]]
  ...
  object terserMinify {
    ...
    inline def apply(
      ...
      sourceMap: Unit,
      minimizerOptions: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.PredefinedOptions & typingsJapgolly.terserWebpackPlugin.typesUtilsMod.CustomOptions,
      extractComments: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.ExtractCommentsOptions
    ): js.Promise[typingsJapgolly.terserWebpackPlugin.typesUtilsMod.MinimizedResult] = (^.asInstanceOf[js.Dynamic].apply(input.asInstanceOf[js.Any], sourceMap.asInstanceOf[js.Any], minimizerOptions.asInstanceOf[js.Any], extractComments.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.terserWebpackPlugin.typesUtilsMod.MinimizedResult]]
    inline def apply(
      input: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.Input,
      sourceMap: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.SourceMapInput,
      minimizerOptions: typingsJapgolly.terserWebpackPlugin.typesUtilsMod.PredefinedOptions & typingsJapgolly.terserWebpackPlugin.typesUtilsMod.CustomOptions
  ...
  /* Rewritten from type alias, can be one of: 
    - scala.Boolean
    - typingsJapgolly.terserWebpackPlugin.terserWebpackPluginStrings.all
    - typingsJapgolly.terserWebpackPlugin.terserWebpackPluginStrings.some
    - js.RegExp
    - typingsJapgolly.terserWebpackPlugin.mod.ExtractCommentsFunction
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.terserWebpackPlugin.mod.ExtractCommentsCondition
    - typingsJapgolly.terserWebpackPlugin.mod.ExtractCommentsObject
  */
  ...
  object MinimizeFunctionHelpers {
    ...
    extension [Self <: MinimizeFunctionHelpers](x: Self) {
      ...
      inline def setGetMinimizerVersion(value: CallbackTo[js.UndefOr[String]]): Self = StObject.set(x, "getMinimizerVersion", value.toJsFn)
  ...
  trait MinimizedResult extends StObject {
    ...
    var map: js.UndefOr[typingsJapgolly.jridgewellTraceMapping.distTypesTypesMod.SourceMapInput] = js.undefined
  ...
  object MinimizedResult {
    ...
    extension [Self <: MinimizedResult](x: Self) {
      ...
      inline def setMap(value: typingsJapgolly.jridgewellTraceMapping.distTypesTypesMod.SourceMapInput): Self = StObject.set(x, "map", value.asInstanceOf[js.Any])
  ...
  type TerserECMA = typingsJapgolly.terserWebpackPlugin.typesUtilsMod.TerserECMA
  
  type TerserOptions = typingsJapgolly.terserWebpackPlugin.typesUtilsMod.TerserOptions
  ...
  object TerserPlugin {
    ...
    inline def apply[T](apply: Compiler => Callback, optimize: Any, options: Any): TerserPlugin[T] = {
