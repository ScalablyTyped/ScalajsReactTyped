...
import typingsJapgolly.tern.libInferMod.ANull
import typingsJapgolly.tern.libInferMod.AVal
import typingsJapgolly.tern.libInferMod.Obj
...
trait Objnamestring extends StObject {
  ...
  def defProp(prop: String, originNode: typingsJapgolly.estree.mod.Node): AVal = js.native
  ...
  /**
    ...
    */
  var originNode: js.UndefOr[typingsJapgolly.estree.mod.Node] = js.native
