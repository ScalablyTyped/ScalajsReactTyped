...
object ASyncConstructorOptions {
  ...
  extension [Self <: ASyncConstructorOptions](x: Self) {
    ...
    inline def setGetFile(
      value: (/* filename */ String, /* callback */ js.Function2[/* error */ js.UndefOr[js.Error], /* content */ js.UndefOr[String], Unit]) => Callback
    ): Self = StObject.set(x, "getFile", js.Any.fromFunction2((t0: /* filename */ String, t1: /* callback */ js.Function2[/* error */ js.UndefOr[js.Error], /* content */ js.UndefOr[String], Unit]) => (value(t0, t1)).runNow()))
