...
class FnCls protected ()
  extends typingsJapgolly.tern.inferMod.Fn {
  def this(
    name: js.UndefOr[scala.Nothing],
    self: typingsJapgolly.tern.inferMod.AVal,
    args: js.Array[typingsJapgolly.tern.inferMod.AVal],
    argNames: js.Array[String],
    retval: typingsJapgolly.tern.inferMod.AVal
  ) = this()
  def this(
    name: String,
    self: typingsJapgolly.tern.inferMod.AVal,
