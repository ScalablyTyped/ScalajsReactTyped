...
import typingsJapgolly.tern.libTernMod.Server
...
object libInferMod {
  ...
  object ANull {
    ...
    extension [Self <: ANull](x: Self) {
      ...
      inline def setAddType(value: /* repeated */ Any => Callback): Self = StObject.set(x, "addType", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      
      inline def setForAllProps(value: /* repeated */ Any => Callback): Self = StObject.set(x, "forAllProps", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      
      inline def setGatherProperties(value: /* repeated */ Any => Callback): Self = StObject.set(x, "gatherProperties", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      ...
      inline def setPropagate(value: /* repeated */ Any => Callback): Self = StObject.set(x, "propagate", js.Any.fromFunction1((t0: /* repeated */ Any) => value(t0).runNow()))
      
      inline def setPropagatesTo(value: CallbackTo[Any]): Self = StObject.set(x, "propagatesTo", value.toJsFn)
  ...
  trait AVal
    ...
    /**
      ...
      * assignment “weak”.
      */
    def addType(`type`: typingsJapgolly.tern.libInferMod.Type): Unit = js.native
    def addType(`type`: typingsJapgolly.tern.libInferMod.Type, weight: Double): Unit = js.native
    ...
    /**
      ...
      */
    def getFunctionType(): js.UndefOr[typingsJapgolly.tern.libInferMod.Fn] = js.native
    
    /**
      * Asks the AVal if it contains an Object type. Useful when
      * you aren’t interested in other kinds of types.
      */
    def getObjType(): typingsJapgolly.tern.libInferMod.Obj | Null = js.native
    
    /** Get an `AVal` that represents the named property of this type. */
    def getProp(prop: String): typingsJapgolly.tern.libInferMod.AVal = js.native
    ...
    /**
      ...
      */
    def getType(): typingsJapgolly.tern.libInferMod.Type | Null = js.native
    def getType(guess: Boolean): typingsJapgolly.tern.libInferMod.Type | Null = js.native
    
    /** Queries whether the AVal _currently_ holds the given type. */
    def hasType(`type`: typingsJapgolly.tern.libInferMod.Type): Boolean = js.native
    ...
    val propertyOf: js.UndefOr[typingsJapgolly.tern.libInferMod.Obj] = js.native
    
    val types: js.Array[typingsJapgolly.tern.libInferMod.Type] = js.native
  }
  ...
  trait Context extends StObject {
    ...
    var topScope: typingsJapgolly.tern.libInferMod.Scope
  }
  object Context {
    ...
    extension [Self <: Context](x: Self) {
      ...
      inline def setTopScope(value: typingsJapgolly.tern.libInferMod.Scope): Self = StObject.set(x, "topScope", value.asInstanceOf[js.Any])
    }
  }
  ...
  trait Fn
    ...
    val args: js.UndefOr[js.Array[typingsJapgolly.tern.libInferMod.AVal]] = js.native
    
    /**
      * Asks the AVal if it contains a function type. Useful when
      * you aren’t interested in other kinds of types.
      */
    def getFunctionType(): typingsJapgolly.tern.libInferMod.Fn = js.native
    
    def isArrowFn(): Boolean = js.native
    
    val retval: typingsJapgolly.tern.libInferMod.AVal = js.native
    
    var self: js.UndefOr[typingsJapgolly.tern.libInferMod.Type] = js.native
  }
  ...
  trait Obj
    extends StObject
       with IType
       with typingsJapgolly.tern.libInferMod.Type {
    ...
    def defProp(prop: String): typingsJapgolly.tern.libInferMod.AVal = js.native
    def defProp(prop: String, originNode: Node): typingsJapgolly.tern.libInferMod.AVal = js.native
    
    /** Call the given function for all properties of the object, including properties that are added in the future. */
    def forAllProps(
      f: js.Function3[
          /* prop */ String, 
          /* val */ typingsJapgolly.tern.libInferMod.AVal, 
          /* local */ Boolean, 
          Unit
        ]
    ): Unit = js.native
    ...
    /**
      ...
      * you aren’t interested in other kinds of types.
      */
    def getObjType(): typingsJapgolly.tern.libInferMod.Obj = js.native
    
    /** Get an `AVal` that represents the named property of this type. */
    def getProp(prop: String): typingsJapgolly.tern.libInferMod.AVal = js.native
    
    /** Looks up the AVal associated with the given property, or returns null if it doesn’t exist. */
    def hasProp(prop: String): typingsJapgolly.tern.libInferMod.AVal | Null = js.native
  ...
  trait Prim
    ...
    /** Get an `AVal` that represents the named property of this type. */
    def getProp(prop: String): typingsJapgolly.tern.libInferMod.AVal
  ...
  object Prim {
    ...
    extension [Self <: Prim](x: Self) {
      ...
      inline def setGatherProperties(value: (js.Function1[/* repeated */ Any, Unit], Double) => Callback): Self = StObject.set(x, "gatherProperties", js.Any.fromFunction2((t0: js.Function1[/* repeated */ Any, Unit], t1: Double) => (value(t0, t1)).runNow()))
      
      inline def setGetProp(value: String => typingsJapgolly.tern.libInferMod.AVal): Self = StObject.set(x, "getProp", js.Any.fromFunction1(value))
  ...
  trait Scope
    ...
    /**
      ...
      */
    def defVar(name: String, originNode: Node): typingsJapgolly.tern.libInferMod.AVal = js.native
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tern.libInferMod.Obj
    - typingsJapgolly.tern.libInferMod.Prim
  */
  ...
  trait AValConstructor
    extends StObject
       with Instantiable0[typingsJapgolly.tern.libInferMod.AVal]
  
  @js.native
  trait ArrConstructor
    extends StObject
       with /** Constructor that creates an array type with the given content type. */
  Instantiable0[typingsJapgolly.tern.libInferMod.Arr]
       with Instantiable1[
          /* contentType */ typingsJapgolly.tern.libInferMod.AVal, 
          typingsJapgolly.tern.libInferMod.Arr
        ]
  ...
  trait Constraint_
    ...
    def typeHint(): js.UndefOr[typingsJapgolly.tern.libInferMod.Type]
  }
  object Constraint_ {
    
    inline def apply(
      addType: /* repeated */ Any => Callback,
      forAllProps: /* repeated */ Any => Callback,
      gatherProperties: /* repeated */ Any => Callback,
      ...
      propagate: /* repeated */ Any => Callback,
      propagatesTo: CallbackTo[Any],
      toString_ : /* repeated */ Any => String,
      typeHint: CallbackTo[js.UndefOr[typingsJapgolly.tern.libInferMod.Type]]
    ): Constraint_ = {
      val __obj = js.Dynamic.literal(addType = js.Any.fromFunction1((t0: /* repeated */ Any) => addType(t0).runNow()), forAllProps = js.Any.fromFunction1((t0: /* repeated */ Any) => forAllProps(t0).runNow()), gatherProperties = js.Any.fromFunction1((t0: /* repeated */ Any) => gatherProperties(t0).runNow()), getFunctionType = js.Any.fromFunction1(getFunctionType), getObjType = js.Any.fromFunction1(getObjType), getProp = js.Any.fromFunction1(getProp), getSymbolType = js.Any.fromFunction1(getSymbolType), getType = js.Any.fromFunction1(getType), hasType = js.Any.fromFunction1(hasType), isEmpty = js.Any.fromFunction1(isEmpty), propHint = propHint.toJsFn, propagate = js.Any.fromFunction1((t0: /* repeated */ Any) => propagate(t0).runNow()), propagatesTo = propagatesTo.toJsFn, typeHint = typeHint.toJsFn)
    ...
    extension [Self <: Constraint_](x: Self) {
      ...
      inline def setPropHint(value: CallbackTo[js.UndefOr[String]]): Self = StObject.set(x, "propHint", value.toJsFn)
      
      inline def setTypeHint(value: CallbackTo[js.UndefOr[typingsJapgolly.tern.libInferMod.Type]]): Self = StObject.set(x, "typeHint", value.toJsFn)
    }
  }
  ...
  trait FnConstructor
    extends StObject
       with Instantiable5[
          ...
          /* argNames */ js.Array[String], 
          /* retval */ typingsJapgolly.tern.libInferMod.AVal, 
          typingsJapgolly.tern.libInferMod.Fn
        ]
  ...
  trait IType
    ...
    def getType(): typingsJapgolly.tern.libInferMod.Type
    
    /** Queries whether the AVal _currently_ holds the given type. */
    def hasType(`type`: typingsJapgolly.tern.libInferMod.Type): Boolean
  ...
  object IType {
    ...
    inline def apply(
      ...
      getProp: /* repeated */ Any => ANull,
      getSymbolType: /* repeated */ Any => js.UndefOr[ANull],
      getType: CallbackTo[typingsJapgolly.tern.libInferMod.Type],
      hasType: typingsJapgolly.tern.libInferMod.Type => Boolean,
      isEmpty: /* repeated */ Any => Boolean,
      origin: String,
      ...
      val __obj = js.Dynamic.literal(addType = js.Any.fromFunction1((t0: /* repeated */ Any) => addType(t0).runNow()), forAllProps = js.Any.fromFunction1((t0: /* repeated */ Any) => forAllProps(t0).runNow()), gatherProperties = js.Any.fromFunction1((t0: /* repeated */ Any) => gatherProperties(t0).runNow()), getFunctionType = js.Any.fromFunction1(getFunctionType), getObjType = js.Any.fromFunction1(getObjType), getProp = js.Any.fromFunction1(getProp), getSymbolType = js.Any.fromFunction1(getSymbolType), getType = getType.toJsFn, hasType = js.Any.fromFunction1(hasType), isEmpty = js.Any.fromFunction1(isEmpty), origin = origin.asInstanceOf[js.Any], propHint = js.Any.fromFunction1(propHint), propagate = js.Any.fromFunction1((t0: /* repeated */ Any) => propagate(t0).runNow()), propagatesTo = propagatesTo.toJsFn, typeHint = js.Any.fromFunction1(typeHint))
      __obj.updateDynamic("toString")(js.Any.fromFunction1(toString_))
    ...
    extension [Self <: IType](x: Self) {
      ...
      inline def setGetType(value: CallbackTo[typingsJapgolly.tern.libInferMod.Type]): Self = StObject.set(x, "getType", value.toJsFn)
      
      inline def setHasType(value: typingsJapgolly.tern.libInferMod.Type => Boolean): Self = StObject.set(x, "hasType", js.Any.fromFunction1(value))
  ...
  trait ObjConstructor
    extends StObject
       with Instantiable0[typingsJapgolly.tern.libInferMod.Obj]
       with Instantiable1[`true` | (/* proto */ js.Object), typingsJapgolly.tern.libInferMod.Obj]
       with Instantiable2[
  ...
  trait ScopeConstructor
    extends StObject
       with Instantiable0[typingsJapgolly.tern.libInferMod.Scope]
       with Instantiable2[
          /* parent */ typingsJapgolly.tern.libInferMod.Scope, 
          /* originNode */ Node, 
          typingsJapgolly.tern.libInferMod.Scope
        ]
  
  @js.native
  trait TypeConstructor
    extends StObject
       with Instantiable0[typingsJapgolly.tern.libInferMod.Type]
}
