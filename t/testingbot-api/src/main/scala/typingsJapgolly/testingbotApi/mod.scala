...
object mod {
  ...
  */
  ...
  object BrowserType {
    ...
    inline def rc: typingsJapgolly.testingbotApi.testingbotApiStrings.rc = "rc".asInstanceOf[typingsJapgolly.testingbotApi.testingbotApiStrings.rc]
    
    inline def webdriver: typingsJapgolly.testingbotApi.testingbotApiStrings.webdriver = "webdriver".asInstanceOf[typingsJapgolly.testingbotApi.testingbotApiStrings.webdriver]
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.testingbotApi.testingbotApiBooleans.`true`
    - typingsJapgolly.testingbotApi.testingbotApiBooleans.`false`
    - typingsJapgolly.testingbotApi.testingbotApiInts.`0`
    - typingsJapgolly.testingbotApi.testingbotApiInts.`1`
  */
  trait TestSuccess extends StObject
  object TestSuccess {
    
    inline def `0`: typingsJapgolly.testingbotApi.testingbotApiInts.`0` = 0.asInstanceOf[typingsJapgolly.testingbotApi.testingbotApiInts.`0`]
    
    inline def `1`: typingsJapgolly.testingbotApi.testingbotApiInts.`1` = 1.asInstanceOf[typingsJapgolly.testingbotApi.testingbotApiInts.`1`]
    
    inline def `false`: typingsJapgolly.testingbotApi.testingbotApiBooleans.`false` = false.asInstanceOf[typingsJapgolly.testingbotApi.testingbotApiBooleans.`false`]
    
    inline def `true`: typingsJapgolly.testingbotApi.testingbotApiBooleans.`true` = true.asInstanceOf[typingsJapgolly.testingbotApi.testingbotApiBooleans.`true`]
  }
  ...
  trait TestingBot extends StObject {
    ...
    def deleteLabTest(testID: String, callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    
    def deleteTest(testID: String): Unit = js.native
    def deleteTest(testID: String, callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    
    def getBrowsers(): Unit = js.native
    def getBrowsers(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    def getBrowsers(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any], `type`: BrowserType): Unit = js.native
    def getBrowsers(callback: Unit, `type`: BrowserType): Unit = js.native
    
    def getLabTestDetails(testID: String): Unit = js.native
    def getLabTestDetails(testID: String, callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    
    def getLabTests(): Unit = js.native
    def getLabTests(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    def getLabTests(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any], offset: Double): Unit = js.native
    def getLabTests(
      callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any],
      offset: Double,
      limit: Double
    ): Unit = js.native
    def getLabTests(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any], offset: Unit, limit: Double): Unit = js.native
    ...
    def getTestDetails(testID: String, callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    
    def getTests(): Unit = js.native
    def getTests(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    def getTests(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any], offset: Double): Unit = js.native
    def getTests(
      callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any],
      offset: Double,
      limit: Double
    ): Unit = js.native
    def getTests(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any], offset: Unit, limit: Double): Unit = js.native
    ...
    def getTunnel(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    
    def getUserInfo(): Unit = js.native
    def getUserInfo(callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
    ...
    def updateUserInfo(data: UserInfo, callback: js.Function2[/* error */ Any, /* responseBody */ Any, Any]): Unit = js.native
  }
