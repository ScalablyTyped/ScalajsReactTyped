...
object TweenProps {
  ...
  def apply(
    ...
    onChange: /* e */ Event => Callback = null,
    onComplete: /* e */ Event => Callback = null,
    ...
    if (onChange != null) __obj.updateDynamic("onChange")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.createjsLib.createjs.Event) => onChange(t0).runNow()))
    if (onComplete != null) __obj.updateDynamic("onComplete")(js.Any.fromFunction1((t0: /* e */ typingsJapgolly.createjsLib.createjs.Event) => onComplete(t0).runNow()))
