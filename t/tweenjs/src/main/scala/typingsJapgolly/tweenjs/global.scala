...
import typingsJapgolly.tweenjs.createjs.TimelineProps
import typingsJapgolly.tweenjs.createjs.TweenProps
...
object global {
  ...
  object createjs {
    ...
    open class AbstractTween ()
      extends StObject
         with typingsJapgolly.tweenjs.createjs.AbstractTween {
    ...
    open class Ease ()
      extends StObject
         with typingsJapgolly.tweenjs.createjs.Ease
    /* static members */
    object Ease {
    ...
    open class MotionGuidePlugin ()
      extends StObject
         with typingsJapgolly.tweenjs.createjs.MotionGuidePlugin
    /* static members */
    object MotionGuidePlugin {
      ...
      inline def change(
        tween: typingsJapgolly.tweenjs.createjs.Tween,
        step: typingsJapgolly.tweenjs.createjs.TweenStep,
        prop: String,
        value: Any,
        ratio: Double,
        end: Boolean
      ...
      inline def init(tween: typingsJapgolly.tweenjs.createjs.Tween, prop: String, value: Any): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("init")(tween.asInstanceOf[js.Any], prop.asInstanceOf[js.Any], value.asInstanceOf[js.Any])).asInstanceOf[Unit]
      ...
      inline def step(
        ...
        step: typingsJapgolly.tweenjs.createjs.TweenStep,
        props: TweenProps
      ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("step")(tween.asInstanceOf[js.Any], step.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[Unit]
    }
    ...
    open class Timeline ()
      extends StObject
         with typingsJapgolly.tweenjs.createjs.Timeline {
    ...
    open class Tween protected ()
      extends StObject
         with typingsJapgolly.tweenjs.createjs.Tween {
    ...
    object Tween {
      ...
      // methods
      inline def get(target: Any): typingsJapgolly.tweenjs.createjs.Tween = ^.asInstanceOf[js.Dynamic].applyDynamic("get")(target.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.tweenjs.createjs.Tween]
      inline def get(target: Any, props: TweenProps): typingsJapgolly.tweenjs.createjs.Tween = (^.asInstanceOf[js.Dynamic].applyDynamic("get")(target.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.tweenjs.createjs.Tween]
    ...
    open class TweenAction protected ()
      extends StObject
         with typingsJapgolly.tweenjs.createjs.TweenAction {
      def this(
        prev: typingsJapgolly.tweenjs.createjs.TweenAction,
        t: Double,
        scope: Any,
        funct: js.Function,
        params: js.Array[Any]
      ...
      /* CompleteClass */
      var next: typingsJapgolly.tweenjs.createjs.TweenAction = js.native
      
      /* CompleteClass */
      var params: js.Array[Any] = js.native
      
      /* CompleteClass */
      var prev: typingsJapgolly.tweenjs.createjs.TweenAction = js.native
    ...
    open class TweenJS ()
      extends StObject
         with typingsJapgolly.tweenjs.createjs.TweenJS
    /* static members */
    object TweenJS {
    ...
    open class TweenStep protected ()
      extends StObject
         with typingsJapgolly.tweenjs.createjs.TweenStep {
      def this(
        prev: typingsJapgolly.tweenjs.createjs.TweenStep,
        t: Double,
        d: Double,
        props: TweenProps,
        ease: js.Function,
      ...
      /* CompleteClass */
      var next: typingsJapgolly.tweenjs.createjs.TweenStep = js.native
      
      /* CompleteClass */
      var passive: Boolean = js.native
      
      /* CompleteClass */
      var prev: typingsJapgolly.tweenjs.createjs.TweenStep = js.native
