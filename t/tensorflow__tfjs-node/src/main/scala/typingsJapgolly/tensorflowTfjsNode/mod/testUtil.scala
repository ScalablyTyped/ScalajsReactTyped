...
import typingsJapgolly.tensorflowTfjsCore.distTestUtilMod.DoneFn
...
import typingsJapgolly.tensorflowTfjsNode.tensorflowTfjsNodeDoubles.`0.001`
import typingsJapgolly.tensorflowTfjsNode.tensorflowTfjsNodeDoubles.`0.1`
...
object testUtil {
  ...
  @JSImport("@tensorflow/tfjs-node", "test_util.TEST_EPSILON_FLOAT16")
  @js.native
