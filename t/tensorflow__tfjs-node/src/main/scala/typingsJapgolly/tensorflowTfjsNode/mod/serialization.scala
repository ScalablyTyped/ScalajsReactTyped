...
object serialization {
  ...
  /* note: abstract class */ @JSImport("@tensorflow/tfjs-node", "serialization.Serializable")
  @js.native
  open class Serializable ()
    extends typingsJapgolly.tensorflowTfjs.mod.serialization.Serializable
  /* static members */
  object Serializable {
  ...
  /* private */ open class SerializationMap ()
    extends typingsJapgolly.tensorflowTfjs.mod.serialization.SerializationMap
  /* static members */
