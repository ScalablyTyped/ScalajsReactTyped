...
object util {
  ...
  inline def getArrayFromDType_string(dtype: typingsJapgolly.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string, size: Double): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("getArrayFromDType")(dtype.asInstanceOf[js.Any], size.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  inline def makeOnesTypedArray_string(size: Double, dtype: typingsJapgolly.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeOnesTypedArray")(size.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
  ...
  inline def makeZerosTypedArray_string(size: Double, dtype: typingsJapgolly.tensorflowTfjsNode.tensorflowTfjsNodeStrings.string): js.Array[String] = (^.asInstanceOf[js.Dynamic].applyDynamic("makeZerosTypedArray")(size.asInstanceOf[js.Any], dtype.asInstanceOf[js.Any])).asInstanceOf[js.Array[String]]
