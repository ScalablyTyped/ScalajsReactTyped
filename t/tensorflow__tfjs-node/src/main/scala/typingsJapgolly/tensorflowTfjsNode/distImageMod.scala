...
object distImageMod {
  ...
  object ImageType extends StObject {
    ...
    sealed trait BMP
      extends StObject
         with ImageType
    /* "BMP" */ val BMP: typingsJapgolly.tensorflowTfjsNode.distImageMod.ImageType.BMP & String = js.native
    
    @js.native
    sealed trait GIF
      extends StObject
         with ImageType
    /* "gif" */ val GIF: typingsJapgolly.tensorflowTfjsNode.distImageMod.ImageType.GIF & String = js.native
    
    @js.native
    sealed trait JPEG
      extends StObject
         with ImageType
    /* "jpeg" */ val JPEG: typingsJapgolly.tensorflowTfjsNode.distImageMod.ImageType.JPEG & String = js.native
    
    @js.native
    sealed trait PNG
      extends StObject
         with ImageType
    /* "png" */ val PNG: typingsJapgolly.tensorflowTfjsNode.distImageMod.ImageType.PNG & String = js.native
  }
