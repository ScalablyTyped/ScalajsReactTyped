...
object distTfjsBindingMod {
  ...
  trait TFJSBinding extends StObject {
    ...
    var TFEOpAttr: Instantiable0[typingsJapgolly.tensorflowTfjsNode.distTfjsBindingMod.TFEOpAttr]
    ...
    var TensorMetadata: Instantiable0[typingsJapgolly.tensorflowTfjsNode.distTfjsBindingMod.TensorMetadata]
  ...
  object TFJSBinding {
    ...
    extension [Self <: TFJSBinding](x: Self) {
      ...
      inline def setDeleteSavedModel(value: Double => Callback): Self = StObject.set(x, "deleteSavedModel", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      
      inline def setDeleteTensor(value: Double => Callback): Self = StObject.set(x, "deleteTensor", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
      ...
      inline def setGetNumOfSavedModels(value: CallbackTo[Double]): Self = StObject.set(x, "getNumOfSavedModels", value.toJsFn)
      
      inline def setIsUsingGpuDevice(value: CallbackTo[Boolean]): Self = StObject.set(x, "isUsingGpuDevice", value.toJsFn)
