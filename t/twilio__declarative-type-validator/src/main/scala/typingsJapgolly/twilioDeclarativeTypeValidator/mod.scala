package typingsJapgolly.twilioDeclarativeTypeValidator
...
object mod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twilioDeclarativeTypeValidator.mod.TypeRule
    - typingsJapgolly.twilioDeclarativeTypeValidator.mod.RuleDefinition
    - js.Array[
  typingsJapgolly.twilioDeclarativeTypeValidator.mod.TypeRule | typingsJapgolly.twilioDeclarativeTypeValidator.mod.RuleDefinition]
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twilioDeclarativeTypeValidator.twilioDeclarativeTypeValidatorStrings.undefined
    - typingsJapgolly.twilioDeclarativeTypeValidator.twilioDeclarativeTypeValidatorStrings.`object`
    - typingsJapgolly.twilioDeclarativeTypeValidator.twilioDeclarativeTypeValidatorStrings.boolean
    - typingsJapgolly.twilioDeclarativeTypeValidator.twilioDeclarativeTypeValidatorStrings.number
    - typingsJapgolly.twilioDeclarativeTypeValidator.twilioDeclarativeTypeValidatorStrings.bigint
    - typingsJapgolly.twilioDeclarativeTypeValidator.twilioDeclarativeTypeValidatorStrings.string
    - typingsJapgolly.twilioDeclarativeTypeValidator.twilioDeclarativeTypeValidatorStrings.symbol
    - typingsJapgolly.twilioDeclarativeTypeValidator.twilioDeclarativeTypeValidatorStrings.function
    - typingsJapgolly.twilioDeclarativeTypeValidator.anon.Instantiable
  */
  trait TypeRule
    extends StObject
       with _RuleArgument
