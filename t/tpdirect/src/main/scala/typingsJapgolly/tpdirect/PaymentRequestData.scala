...
import typingsJapgolly.tpdirect.anon.PaymentRequestAmountidstr
import typingsJapgolly.tpdirect.anon.RequestPayerEmail
...
object PaymentRequestData {
  ...
  extension [Self <: PaymentRequestData](x: Self) {
