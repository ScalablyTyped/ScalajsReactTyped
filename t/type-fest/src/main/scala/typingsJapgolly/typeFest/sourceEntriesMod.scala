...
import typingsJapgolly.typeFest.sourceEntryMod.ArrayEntry
import typingsJapgolly.typeFest.sourceEntryMod.MapEntry
import typingsJapgolly.typeFest.sourceEntryMod.ObjectEntry
import typingsJapgolly.typeFest.sourceEntryMod.SetEntry
