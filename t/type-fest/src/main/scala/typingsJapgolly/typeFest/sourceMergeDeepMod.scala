...
import typingsJapgolly.typeFest.sourceConditionalSimplifyMod.ConditionalSimplifyDeep
import typingsJapgolly.typeFest.sourceEnforceOptionalMod.EnforceOptional
import typingsJapgolly.typeFest.sourceInternalMod.UnknownArrayOrTuple
import typingsJapgolly.typeFest.sourceInternalMod.UnknownRecord
import typingsJapgolly.typeFest.sourceMergeMod.Merge
...
object sourceMergeDeepMod {
  ...
  */
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.typeFest.typeFestStrings.spread
    - typingsJapgolly.typeFest.typeFestStrings.replace
  */
  trait ArrayMergeMode extends StObject
  object ArrayMergeMode {
    
    inline def replace: typingsJapgolly.typeFest.typeFestStrings.replace = "replace".asInstanceOf[typingsJapgolly.typeFest.typeFestStrings.replace]
    
    inline def spread: typingsJapgolly.typeFest.typeFestStrings.spread = "spread".asInstanceOf[typingsJapgolly.typeFest.typeFestStrings.spread]
  }
  
  /**
  Merge default and internal options with user provided options.
  */
  type DefaultMergeDeepOptions[Options /* <: MergeDeepOptions */] = Merge[typingsJapgolly.typeFest.anon.ArrayMergeMode, Options]
