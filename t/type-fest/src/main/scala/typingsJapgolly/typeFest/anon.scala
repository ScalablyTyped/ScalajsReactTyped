...
import typingsJapgolly.typeFest.typeFestBooleans.`true`
import typingsJapgolly.typeFest.typeFestStrings.corporation
import typingsJapgolly.typeFest.typeFestStrings.foundation
import typingsJapgolly.typeFest.typeFestStrings.github
import typingsJapgolly.typeFest.typeFestStrings.individual
import typingsJapgolly.typeFest.typeFestStrings.opencollective
import typingsJapgolly.typeFest.typeFestStrings.patreon
import typingsJapgolly.typeFest.typeFestStrings.replace
...
object anon {
  ...
  trait ArrayMergeMode extends StObject {
    ...
    var arrayMergeMode: replace
    
    var recurseIntoArrays: `false`
    
    var spreadTopLevelArrays: `true`
  }
  object ArrayMergeMode {
    
    inline def apply(): ArrayMergeMode = {
      val __obj = js.Dynamic.literal(arrayMergeMode = "replace", recurseIntoArrays = false, spreadTopLevelArrays = true)
      __obj.asInstanceOf[ArrayMergeMode]
    }
    
    extension [Self <: ArrayMergeMode](x: Self) {
      
      inline def setArrayMergeMode(value: replace): Self = StObject.set(x, "arrayMergeMode", value.asInstanceOf[js.Any])
      
      inline def setRecurseIntoArrays(value: `false`): Self = StObject.set(x, "recurseIntoArrays", value.asInstanceOf[js.Any])
      
      inline def setSpreadTopLevelArrays(value: `true`): Self = StObject.set(x, "spreadTopLevelArrays", value.asInstanceOf[js.Any])
    }
  }
