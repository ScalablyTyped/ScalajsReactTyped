...
trait OmitContentViewWidgetanysAbsoluteBounds[ChildType /* <: Widget[Any] */] extends StObject {
  ...
  def _apply[Target](
    options: `19`[Target],
    rules: RuleSet[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
  ): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `19`[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]], 
    /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]], 
    typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  ]
  ...
  def append(widgets: Widget[Any]*): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  
  def appendTo(parent: Composite[Widget[Any]]): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  @JSName("appendTo")
  ...
  def detach(): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  @JSName("detach")
  var detach_Original: js.Function0[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
  ...
  def insertAfter(widget: Widget[Any]): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  @JSName("insertAfter")
  ...
  def insertBefore(widget: Widget[Any]): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  @JSName("insertBefore")
  ...
  var jsxAttributes: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], Widget[Any]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[
    CompositeAddChildEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
  ]
  
  var onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], background]
  
  var onBaselineChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], baseline]
  
  var onBottomChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], bottom]
  
  var onBoundsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], bounds]
  
  var onCenterXChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], centerX]
  
  var onCenterYChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], centerY]
  
  var onClassChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], `class`]
  
  var onClassListChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], classList]
  
  var onCornerRadiusChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], cornerRadius]
  
  var onDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], data]
  
  var onDispose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onElevationChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], elevation]
  
  var onEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], id]
  
  var onLayoutDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], layoutData]
  
  var onLeftChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], left]
  
  var onLongPress: Listeners[
    WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
  ]
  
  var onOpacityChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], opacity]
  
  var onPan: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanDown: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanRight: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanUp: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onRemoveChild: Listeners[
    CompositeRemoveChildEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
  ]
  
  var onResize: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onRightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTap: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTopChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]
  
  var onTransformChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], transform]
  
  var onVisibleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], visible]
  
  var onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[
    /* type */ String, 
    js.Promise[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
  ]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
...
object OmitContentViewWidgetanysAbsoluteBounds {
  ...
  inline def apply[ChildType /* <: Widget[Any] */](
    ...
    _apply: (/* options */ `19`[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]) => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    ...
    append: /* repeated */ Widget[Any] => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    appendTo: /* parent */ Composite[Widget[Any]] => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    apply: (/* options */ `19`[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]) => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    ...
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]],
    dispose: Callback,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    insertBefore: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    isDisposed: CallbackTo[Boolean],
    jsxAttributes: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], Widget[Any]],
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    onAddChild: Listeners[
      CompositeAddChildEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
    ],
    onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], background],
    onBaselineChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], baseline],
    onBottomChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], bottom],
    onBoundsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], bounds],
    onCenterXChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], centerX],
    onCenterYChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], centerY],
    onClassChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], `class`],
    onClassListChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], classList],
    onCornerRadiusChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], cornerRadius],
    onDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], data],
    onDispose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onElevationChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], elevation],
    onEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], excludeFromLayout],
    onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], height],
    onHighlightOnTouchChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], highlightOnTouch],
    onIdChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], id],
    onLayoutDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], layoutData],
    onLeftChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], left],
    onLongPress: Listeners[
      WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
    ],
    onOpacityChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], opacity],
    onPan: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onPanDown: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onPanHorizontal: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onPanLeft: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onPanRight: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onPanUp: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onPanVertical: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onRemoveChild: Listeners[
      CompositeRemoveChildEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
    ],
    onResize: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onRightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onTap: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onTopChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], top],
    onTouchCancel: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onTouchEnd: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onTouchMove: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onTouchStart: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]],
    onTransformChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], transform],
    onVisibleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], visible],
    onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    opacity: Double,
    ...
    trigger: /* type */ String => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType],
    triggerAsync: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]],
    visible: Boolean,
  ...
  extension [Self <: OmitContentViewWidgetanysAbsoluteBounds[?], ChildType /* <: Widget[Any] */](x: Self & OmitContentViewWidgetanysAbsoluteBounds[ChildType]) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(
      value: /* parent */ Composite[Widget[Any]] => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
    ): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `19`[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]) => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
    ...
    inline def setDetach(value: CallbackTo[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: CallbackTo[Boolean]): Self = StObject.set(x, "isDisposed", value.toJsFn)
    
    inline def setJsxAttributes(
      value: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], Widget[Any]]
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]
    ...
    inline def setOnBackgroundChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], excludeFromLayout]
    ): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], highlightOnTouch]
    ): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    ...
    inline def setOnOpacityChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    ...
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(
      value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.ContentView_[ChildType]]
