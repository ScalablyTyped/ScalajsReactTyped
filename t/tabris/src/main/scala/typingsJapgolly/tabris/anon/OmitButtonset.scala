...
trait OmitButtonset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[Button, Omit[Button, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]]) & `6`
...
object OmitButtonset {
  ...
  extension [Self <: OmitButtonset](x: Self) {
    ...
    inline def setDetach(value: CallbackTo[Button]): Self = StObject.set(x, "detach", value.toJsFn)
