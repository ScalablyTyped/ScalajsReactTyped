...
trait OmitAlertDialogtextInputs extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[Properties[Omit[AlertDialog, textInputs], OmitOmitAlertDialogtextIn]], 
    Any
  ]
  ...
  @JSName("set")
  var set_Original: js.Function1[/* properties */ Properties[AlertDialog, Omit[AlertDialog, set]], AlertDialog]
  @JSName("set")
  def set_set[T /* <: NativeObject */](properties: Properties[T, Omit[T, set]]): AlertDialog
...
object OmitAlertDialogtextInputs {
  ...
  inline def apply(
    ...
    constructor: /* properties */ js.UndefOr[Properties[Omit[AlertDialog, textInputs], OmitOmitAlertDialogtextIn]] => Any,
    ...
    set: /* properties */ Properties[AlertDialog, Omit[AlertDialog, set]] => AlertDialog,
    title: String,
    trigger: /* type */ String => AlertDialog,
    triggerAsync: /* type */ String => js.Promise[AlertDialog]
  ): OmitAlertDialogtextInputs = {
    ...
    __obj.asInstanceOf[OmitAlertDialogtextInputs]
  }
  
  extension [Self <: OmitAlertDialogtextInputs](x: Self) {
    ...
    inline def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Omit[AlertDialog, textInputs], OmitOmitAlertDialogtextIn]] => Any
    ...
    inline def setSet(value: /* properties */ Properties[AlertDialog, Omit[AlertDialog, set]] => AlertDialog): Self = StObject.set(x, "set", js.Any.fromFunction1(value))
