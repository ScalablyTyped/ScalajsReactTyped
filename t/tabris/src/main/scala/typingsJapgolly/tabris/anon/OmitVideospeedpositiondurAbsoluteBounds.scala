...
trait OmitVideospeedpositiondurAbsoluteBounds extends StObject {
...
object OmitVideospeedpositiondurAbsoluteBounds {
  ...
  inline def apply(
  ...
  ): OmitVideospeedpositiondurAbsoluteBounds = {
    ...
    __obj.asInstanceOf[OmitVideospeedpositiondurAbsoluteBounds]
  }
  
  extension [Self <: OmitVideospeedpositiondurAbsoluteBounds](x: Self) {
