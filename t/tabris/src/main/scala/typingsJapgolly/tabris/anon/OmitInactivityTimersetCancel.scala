...
import typingsJapgolly.tabris.mod.InactivityTimer
...
import typingsJapgolly.tabris.tabrisStrings.delay
...
trait OmitInactivityTimersetCancel extends StObject {
  ...
  var jsxAttributes: JSXAttributes[
    typingsJapgolly.tabris.global.tabris.InactivityTimer, 
    Omit[
      typingsJapgolly.tabris.global.tabris.InactivityTimer, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.InactivityTimer
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.InactivityTimer
  def on(
    `type`: String,
  ...
  var onDelayChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.InactivityTimer, delay]
  
  var onTimeout: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.InactivityTimer]]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.InactivityTimer
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.InactivityTimer
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.InactivityTimer]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[
    /* type */ String, 
    js.Promise[typingsJapgolly.tabris.global.tabris.InactivityTimer]
  ]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.InactivityTimer]
}
object OmitInactivityTimersetCancel {
  ...
  extension [Self <: OmitInactivityTimersetCancel](x: Self) {
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.InactivityTimer
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.InactivityTimer
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnDelayChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.InactivityTimer, delay]): Self = StObject.set(x, "onDelayChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTimeout(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.InactivityTimer]]): Self = StObject.set(x, "onTimeout", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.InactivityTimer): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.InactivityTimer]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
