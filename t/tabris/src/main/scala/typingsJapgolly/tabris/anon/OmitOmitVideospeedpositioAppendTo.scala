...
import typingsJapgolly.tabris.global.tabris.widgets.Video
...
trait OmitOmitVideospeedpositioAppendTo extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[OmitVideospeedpositiondurAppendTo, Omit[OmitVideospeedpositiondurAppendTo, set]]
    ], 
    Any
  ]
...
object OmitOmitVideospeedpositioAppendTo {
  ...
  inline def apply(
  ...
  ): OmitOmitVideospeedpositioAppendTo = {
    ...
    __obj.asInstanceOf[OmitOmitVideospeedpositioAppendTo]
  }
  
  extension [Self <: OmitOmitVideospeedpositioAppendTo](x: Self) {
