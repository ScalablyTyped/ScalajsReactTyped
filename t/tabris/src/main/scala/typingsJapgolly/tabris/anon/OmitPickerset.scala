...
trait OmitPickerset extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): Picker
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], Picker]
  ...
  def detach(): Picker
  @JSName("detach")
  var detach_Original: js.Function0[Picker]
  ...
  def insertAfter(widget: Widget[Any]): Picker
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], Picker]
  
  def insertBefore(widget: Widget[Any]): Picker
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], Picker]
  ...
  var jsxAttributes: (JSXAttributes[Picker, Omit[Picker, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]]) & PartialPickPickeritemText & `3`
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Picker
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Picker
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[Picker, background]
  
  var onBaselineChanged: ChangeListeners[Picker, baseline]
  
  var onBorderColorChanged: ChangeListeners[Picker, borderColor]
  
  var onBottomChanged: ChangeListeners[Picker, bottom]
  
  var onBoundsChanged: ChangeListeners[Picker, bounds]
  
  var onCenterXChanged: ChangeListeners[Picker, centerX]
  
  var onCenterYChanged: ChangeListeners[Picker, centerY]
  
  var onClassChanged: ChangeListeners[Picker, `class`]
  
  var onClassListChanged: ChangeListeners[Picker, classList]
  
  var onCornerRadiusChanged: ChangeListeners[Picker, cornerRadius]
  
  var onDataChanged: ChangeListeners[Picker, data]
  
  var onDispose: Listeners[EventObject[Picker]]
  
  var onElevationChanged: ChangeListeners[Picker, elevation]
  
  var onEnabledChanged: ChangeListeners[Picker, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[Picker, excludeFromLayout]
  
  var onFloatMessageChanged: ChangeListeners[Picker, floatMessage]
  
  var onFontChanged: ChangeListeners[Picker, font]
  
  var onHeightChanged: ChangeListeners[Picker, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[Picker, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[Picker, id]
  
  var onItemCountChanged: ChangeListeners[Picker, itemCount]
  
  var onItemTextChanged: ChangeListeners[Picker, itemText]
  
  var onLayoutDataChanged: ChangeListeners[Picker, layoutData]
  
  var onLeftChanged: ChangeListeners[Picker, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[Picker]]
  
  var onMessageChanged: ChangeListeners[Picker, message]
  
  var onOpacityChanged: ChangeListeners[Picker, opacity]
  
  var onPan: Listeners[WidgetPanEvent[Picker]]
  
  var onPanDown: Listeners[WidgetPanEvent[Picker]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[Picker]]
  
  var onPanLeft: Listeners[WidgetPanEvent[Picker]]
  
  var onPanRight: Listeners[WidgetPanEvent[Picker]]
  
  var onPanUp: Listeners[WidgetPanEvent[Picker]]
  
  var onPanVertical: Listeners[WidgetPanEvent[Picker]]
  
  var onResize: Listeners[WidgetResizeEvent[Picker]]
  
  var onRightChanged: ChangeListeners[Picker, right]
  
  var onSelect: Listeners[PickerSelectEvent[Picker]]
  
  var onSelectionIndexChanged: ChangeListeners[Picker, selectionIndex]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[Picker]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Picker]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[Picker]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[Picker]]
  
  var onTap: Listeners[WidgetTapEvent[Picker]]
  
  var onTextColorChanged: ChangeListeners[Picker, textColor]
  
  var onTopChanged: ChangeListeners[Picker, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[Picker]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[Picker]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[Picker]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[Picker]]
  
  var onTransformChanged: ChangeListeners[Picker, transform]
  
  var onVisibleChanged: ChangeListeners[Picker, visible]
  
  var onWidthChanged: ChangeListeners[Picker, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Picker
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): Picker
  
  def triggerAsync(`type`: String): js.Promise[Picker]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Picker]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Picker]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitPickerset {
  ...
  inline def apply(
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => Picker,
    insertBefore: /* widget */ Widget[Any] => Picker,
    ...
    message: String,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Picker,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Picker,
    onBackgroundChanged: ChangeListeners[Picker, background],
    onBaselineChanged: ChangeListeners[Picker, baseline],
    onBorderColorChanged: ChangeListeners[Picker, borderColor],
    onBottomChanged: ChangeListeners[Picker, bottom],
    onBoundsChanged: ChangeListeners[Picker, bounds],
    onCenterXChanged: ChangeListeners[Picker, centerX],
    onCenterYChanged: ChangeListeners[Picker, centerY],
    onClassChanged: ChangeListeners[Picker, `class`],
    onClassListChanged: ChangeListeners[Picker, classList],
    onCornerRadiusChanged: ChangeListeners[Picker, cornerRadius],
    onDataChanged: ChangeListeners[Picker, data],
    onDispose: Listeners[EventObject[Picker]],
    onElevationChanged: ChangeListeners[Picker, elevation],
    onEnabledChanged: ChangeListeners[Picker, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[Picker, excludeFromLayout],
    onFloatMessageChanged: ChangeListeners[Picker, floatMessage],
    onFontChanged: ChangeListeners[Picker, font],
    onHeightChanged: ChangeListeners[Picker, height],
    onHighlightOnTouchChanged: ChangeListeners[Picker, highlightOnTouch],
    onIdChanged: ChangeListeners[Picker, id],
    onItemCountChanged: ChangeListeners[Picker, itemCount],
    onItemTextChanged: ChangeListeners[Picker, itemText],
    onLayoutDataChanged: ChangeListeners[Picker, layoutData],
    onLeftChanged: ChangeListeners[Picker, left],
    onLongPress: Listeners[WidgetLongPressEvent[Picker]],
    onMessageChanged: ChangeListeners[Picker, message],
    onOpacityChanged: ChangeListeners[Picker, opacity],
    onPan: Listeners[WidgetPanEvent[Picker]],
    onPanDown: Listeners[WidgetPanEvent[Picker]],
    onPanHorizontal: Listeners[WidgetPanEvent[Picker]],
    onPanLeft: Listeners[WidgetPanEvent[Picker]],
    onPanRight: Listeners[WidgetPanEvent[Picker]],
    onPanUp: Listeners[WidgetPanEvent[Picker]],
    onPanVertical: Listeners[WidgetPanEvent[Picker]],
    onResize: Listeners[WidgetResizeEvent[Picker]],
    onRightChanged: ChangeListeners[Picker, right],
    onSelect: Listeners[PickerSelectEvent[Picker]],
    onSelectionIndexChanged: ChangeListeners[Picker, selectionIndex],
    onSwipeDown: Listeners[WidgetSwipeEvent[Picker]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[Picker]],
    onSwipeRight: Listeners[WidgetSwipeEvent[Picker]],
    onSwipeUp: Listeners[WidgetSwipeEvent[Picker]],
    onTap: Listeners[WidgetTapEvent[Picker]],
    onTextColorChanged: ChangeListeners[Picker, textColor],
    onTopChanged: ChangeListeners[Picker, top],
    onTouchCancel: Listeners[WidgetTouchEvent[Picker]],
    onTouchEnd: Listeners[WidgetTouchEvent[Picker]],
    onTouchMove: Listeners[WidgetTouchEvent[Picker]],
    onTouchStart: Listeners[WidgetTouchEvent[Picker]],
    onTransformChanged: ChangeListeners[Picker, transform],
    onVisibleChanged: ChangeListeners[Picker, visible],
    onWidthChanged: ChangeListeners[Picker, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Picker,
    opacity: Double,
    ...
    trigger: /* type */ String => Picker,
    triggerAsync: /* type */ String => js.Promise[Picker],
    visible: Boolean,
    ...
    __obj.asInstanceOf[OmitPickerset]
  }
  
  extension [Self <: OmitPickerset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => Picker): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[Picker]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => Picker): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => Picker): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Picker
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Picker
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[Picker, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[Picker, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBorderColorChanged(value: ChangeListeners[Picker, borderColor]): Self = StObject.set(x, "onBorderColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[Picker, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[Picker, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[Picker, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[Picker, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[Picker, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[Picker, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[Picker, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[Picker, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[Picker]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[Picker, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[Picker, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[Picker, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFloatMessageChanged(value: ChangeListeners[Picker, floatMessage]): Self = StObject.set(x, "onFloatMessageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFontChanged(value: ChangeListeners[Picker, font]): Self = StObject.set(x, "onFontChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[Picker, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[Picker, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[Picker, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnItemCountChanged(value: ChangeListeners[Picker, itemCount]): Self = StObject.set(x, "onItemCountChanged", value.asInstanceOf[js.Any])
    
    inline def setOnItemTextChanged(value: ChangeListeners[Picker, itemText]): Self = StObject.set(x, "onItemTextChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[Picker, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[Picker, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[Picker]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnMessageChanged(value: ChangeListeners[Picker, message]): Self = StObject.set(x, "onMessageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[Picker, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[Picker]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[Picker]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[Picker]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[Picker]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[Picker]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[Picker]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[Picker]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[Picker]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[Picker, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[PickerSelectEvent[Picker]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSelectionIndexChanged(value: ChangeListeners[Picker, selectionIndex]): Self = StObject.set(x, "onSelectionIndexChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[Picker]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[Picker]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[Picker]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[Picker]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[Picker]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTextColorChanged(value: ChangeListeners[Picker, textColor]): Self = StObject.set(x, "onTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[Picker, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[Picker]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[Picker]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[Picker]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[Picker]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[Picker, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[Picker, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[Picker, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => Picker): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[Picker]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
