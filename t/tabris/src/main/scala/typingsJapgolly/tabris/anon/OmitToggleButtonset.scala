...
trait OmitToggleButtonset extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): ToggleButton
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], ToggleButton]
  ...
  def detach(): ToggleButton
  @JSName("detach")
  var detach_Original: js.Function0[ToggleButton]
  ...
  def insertAfter(widget: Widget[Any]): ToggleButton
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], ToggleButton]
  
  def insertBefore(widget: Widget[Any]): ToggleButton
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], ToggleButton]
  ...
  var jsxAttributes: (JSXAttributes[
    ToggleButton, 
    Omit[ToggleButton, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `3`
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): ToggleButton
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): ToggleButton
  def on(
    `type`: String,
  ...
  var onAlignmentChanged: ChangeListeners[ToggleButton, alignment]
  
  var onBackgroundChanged: ChangeListeners[ToggleButton, background]
  
  var onBaselineChanged: ChangeListeners[ToggleButton, baseline]
  
  var onBottomChanged: ChangeListeners[ToggleButton, bottom]
  
  var onBoundsChanged: ChangeListeners[ToggleButton, bounds]
  
  var onCenterXChanged: ChangeListeners[ToggleButton, centerX]
  
  var onCenterYChanged: ChangeListeners[ToggleButton, centerY]
  
  var onCheckedChanged: ChangeListeners[ToggleButton, checked]
  
  var onClassChanged: ChangeListeners[ToggleButton, `class`]
  
  var onClassListChanged: ChangeListeners[ToggleButton, classList]
  
  var onCornerRadiusChanged: ChangeListeners[ToggleButton, cornerRadius]
  
  var onDataChanged: ChangeListeners[ToggleButton, data]
  
  var onDispose: Listeners[EventObject[ToggleButton]]
  
  var onElevationChanged: ChangeListeners[ToggleButton, elevation]
  
  var onEnabledChanged: ChangeListeners[ToggleButton, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[ToggleButton, excludeFromLayout]
  
  var onFontChanged: ChangeListeners[ToggleButton, font]
  
  var onHeightChanged: ChangeListeners[ToggleButton, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[ToggleButton, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[ToggleButton, id]
  
  var onImageChanged: ChangeListeners[ToggleButton, image]
  
  var onLayoutDataChanged: ChangeListeners[ToggleButton, layoutData]
  
  var onLeftChanged: ChangeListeners[ToggleButton, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[ToggleButton]]
  
  var onOpacityChanged: ChangeListeners[ToggleButton, opacity]
  
  var onPan: Listeners[WidgetPanEvent[ToggleButton]]
  
  var onPanDown: Listeners[WidgetPanEvent[ToggleButton]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[ToggleButton]]
  
  var onPanLeft: Listeners[WidgetPanEvent[ToggleButton]]
  
  var onPanRight: Listeners[WidgetPanEvent[ToggleButton]]
  
  var onPanUp: Listeners[WidgetPanEvent[ToggleButton]]
  
  var onPanVertical: Listeners[WidgetPanEvent[ToggleButton]]
  
  var onResize: Listeners[WidgetResizeEvent[ToggleButton]]
  
  var onRightChanged: ChangeListeners[ToggleButton, right]
  
  var onSelect: Listeners[ToggleButtonSelectEvent[ToggleButton]]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[ToggleButton]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[ToggleButton]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[ToggleButton]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[ToggleButton]]
  
  var onTap: Listeners[WidgetTapEvent[ToggleButton]]
  
  var onTextChanged: ChangeListeners[ToggleButton, text]
  
  var onTextColorChanged: ChangeListeners[ToggleButton, textColor]
  
  var onTopChanged: ChangeListeners[ToggleButton, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[ToggleButton]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[ToggleButton]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[ToggleButton]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[ToggleButton]]
  
  var onTransformChanged: ChangeListeners[ToggleButton, transform]
  
  var onVisibleChanged: ChangeListeners[ToggleButton, visible]
  
  var onWidthChanged: ChangeListeners[ToggleButton, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): ToggleButton
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): ToggleButton
  
  def triggerAsync(`type`: String): js.Promise[ToggleButton]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[ToggleButton]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, ToggleButton]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitToggleButtonset {
  ...
  inline def apply(
    ...
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[ToggleButton],
    dispose: Callback,
    elevation: Double,
    enabled: Boolean,
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => ToggleButton,
    onAlignmentChanged: ChangeListeners[ToggleButton, alignment],
    onBackgroundChanged: ChangeListeners[ToggleButton, background],
    onBaselineChanged: ChangeListeners[ToggleButton, baseline],
    onBottomChanged: ChangeListeners[ToggleButton, bottom],
    onBoundsChanged: ChangeListeners[ToggleButton, bounds],
    onCenterXChanged: ChangeListeners[ToggleButton, centerX],
    onCenterYChanged: ChangeListeners[ToggleButton, centerY],
    onCheckedChanged: ChangeListeners[ToggleButton, checked],
    onClassChanged: ChangeListeners[ToggleButton, `class`],
    onClassListChanged: ChangeListeners[ToggleButton, classList],
    onCornerRadiusChanged: ChangeListeners[ToggleButton, cornerRadius],
    onDataChanged: ChangeListeners[ToggleButton, data],
    onDispose: Listeners[EventObject[ToggleButton]],
    onElevationChanged: ChangeListeners[ToggleButton, elevation],
    onEnabledChanged: ChangeListeners[ToggleButton, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[ToggleButton, excludeFromLayout],
    onFontChanged: ChangeListeners[ToggleButton, font],
    onHeightChanged: ChangeListeners[ToggleButton, height],
    onHighlightOnTouchChanged: ChangeListeners[ToggleButton, highlightOnTouch],
    onIdChanged: ChangeListeners[ToggleButton, id],
    onImageChanged: ChangeListeners[ToggleButton, image],
    onLayoutDataChanged: ChangeListeners[ToggleButton, layoutData],
    onLeftChanged: ChangeListeners[ToggleButton, left],
    onLongPress: Listeners[WidgetLongPressEvent[ToggleButton]],
    onOpacityChanged: ChangeListeners[ToggleButton, opacity],
    onPan: Listeners[WidgetPanEvent[ToggleButton]],
    onPanDown: Listeners[WidgetPanEvent[ToggleButton]],
    onPanHorizontal: Listeners[WidgetPanEvent[ToggleButton]],
    onPanLeft: Listeners[WidgetPanEvent[ToggleButton]],
    onPanRight: Listeners[WidgetPanEvent[ToggleButton]],
    onPanUp: Listeners[WidgetPanEvent[ToggleButton]],
    onPanVertical: Listeners[WidgetPanEvent[ToggleButton]],
    onResize: Listeners[WidgetResizeEvent[ToggleButton]],
    onRightChanged: ChangeListeners[ToggleButton, right],
    onSelect: Listeners[ToggleButtonSelectEvent[ToggleButton]],
    onSwipeDown: Listeners[WidgetSwipeEvent[ToggleButton]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[ToggleButton]],
    onSwipeRight: Listeners[WidgetSwipeEvent[ToggleButton]],
    onSwipeUp: Listeners[WidgetSwipeEvent[ToggleButton]],
    onTap: Listeners[WidgetTapEvent[ToggleButton]],
    onTextChanged: ChangeListeners[ToggleButton, text],
    onTextColorChanged: ChangeListeners[ToggleButton, textColor],
    onTopChanged: ChangeListeners[ToggleButton, top],
    onTouchCancel: Listeners[WidgetTouchEvent[ToggleButton]],
    onTouchEnd: Listeners[WidgetTouchEvent[ToggleButton]],
    onTouchMove: Listeners[WidgetTouchEvent[ToggleButton]],
    onTouchStart: Listeners[WidgetTouchEvent[ToggleButton]],
    onTransformChanged: ChangeListeners[ToggleButton, transform],
    onVisibleChanged: ChangeListeners[ToggleButton, visible],
    onWidthChanged: ChangeListeners[ToggleButton, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => ToggleButton,
    opacity: Double,
    ...
    trigger: /* type */ String => ToggleButton,
    triggerAsync: /* type */ String => js.Promise[ToggleButton],
    visible: Boolean,
    ...
    __obj.asInstanceOf[OmitToggleButtonset]
  }
  
  extension [Self <: OmitToggleButtonset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => ToggleButton): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[ToggleButton]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => ToggleButton): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => ToggleButton): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => ToggleButton
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => ToggleButton
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAlignmentChanged(value: ChangeListeners[ToggleButton, alignment]): Self = StObject.set(x, "onAlignmentChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[ToggleButton, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[ToggleButton, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[ToggleButton, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[ToggleButton, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[ToggleButton, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[ToggleButton, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCheckedChanged(value: ChangeListeners[ToggleButton, checked]): Self = StObject.set(x, "onCheckedChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[ToggleButton, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[ToggleButton, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[ToggleButton, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[ToggleButton, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[ToggleButton]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[ToggleButton, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[ToggleButton, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[ToggleButton, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnFontChanged(value: ChangeListeners[ToggleButton, font]): Self = StObject.set(x, "onFontChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[ToggleButton, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[ToggleButton, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[ToggleButton, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnImageChanged(value: ChangeListeners[ToggleButton, image]): Self = StObject.set(x, "onImageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[ToggleButton, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[ToggleButton, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[ToggleButton]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[ToggleButton, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[ToggleButton]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[ToggleButton]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[ToggleButton]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[ToggleButton]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[ToggleButton]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[ToggleButton]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[ToggleButton]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[ToggleButton]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[ToggleButton, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[ToggleButtonSelectEvent[ToggleButton]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[ToggleButton]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[ToggleButton]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[ToggleButton]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[ToggleButton]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[ToggleButton]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTextChanged(value: ChangeListeners[ToggleButton, text]): Self = StObject.set(x, "onTextChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTextColorChanged(value: ChangeListeners[ToggleButton, textColor]): Self = StObject.set(x, "onTextColorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[ToggleButton, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[ToggleButton]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[ToggleButton]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[ToggleButton]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[ToggleButton]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[ToggleButton, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[ToggleButton, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[ToggleButton, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => ToggleButton): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[ToggleButton]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
