...
trait OmitStatusBarset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[
    StatusBar_, 
    Omit[StatusBar_, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `4`
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): StatusBar_
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[StatusBar_, background]
  
  var onDisplayModeChanged: ChangeListeners[StatusBar_, displayMode]
  
  var onTap: Listeners[StatusBarTapEvent[StatusBar_]]
  
  var onThemeChanged: ChangeListeners[StatusBar_, theme]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): StatusBar_
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): StatusBar_
  
  def triggerAsync(`type`: String): js.Promise[StatusBar_]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[StatusBar_]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, StatusBar_]
}
object OmitStatusBarset {
  ...
  inline def apply(
    ...
    onDisplayModeChanged: ChangeListeners[StatusBar_, displayMode],
    onTap: Listeners[StatusBarTapEvent[StatusBar_]],
    onThemeChanged: ChangeListeners[StatusBar_, theme],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => StatusBar_,
    theme: dark | default | light,
    trigger: /* type */ String => StatusBar_,
    triggerAsync: /* type */ String => js.Promise[StatusBar_]
  ): OmitStatusBarset = {
    ...
    __obj.asInstanceOf[OmitStatusBarset]
  }
  
  extension [Self <: OmitStatusBarset](x: Self) {
    ...
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => StatusBar_
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[StatusBar_, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDisplayModeChanged(value: ChangeListeners[StatusBar_, displayMode]): Self = StObject.set(x, "onDisplayModeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[StatusBarTapEvent[StatusBar_]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnThemeChanged(value: ChangeListeners[StatusBar_, theme]): Self = StObject.set(x, "onThemeChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => StatusBar_): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[StatusBar_]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
