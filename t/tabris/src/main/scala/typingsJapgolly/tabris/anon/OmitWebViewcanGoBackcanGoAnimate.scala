...
import typingsJapgolly.tabris.mod.WebViewDownloadEvent
import typingsJapgolly.tabris.mod.WebViewMessageEvent
import typingsJapgolly.tabris.mod.WebViewNavigateEvent
...
import typingsJapgolly.tabris.mod.widgets.WebView
...
import typingsJapgolly.tabris.tabrisStrings.canGoBack
import typingsJapgolly.tabris.tabrisStrings.canGoForward
...
import typingsJapgolly.tabris.tabrisStrings.html
...
trait OmitWebViewcanGoBackcanGoAnimate extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): typingsJapgolly.tabris.global.tabris.widgets.WebView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[
    /* parent */ Composite[Widget[Any]], 
    typingsJapgolly.tabris.global.tabris.widgets.WebView
  ]
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[Omit[WebView, canGoBack | canGoForward], OmitOmitWebViewcanGoBackcAnimate]
    ], 
    Any
  ]
  ...
  def detach(): typingsJapgolly.tabris.global.tabris.widgets.WebView
  @JSName("detach")
  var detach_Original: js.Function0[typingsJapgolly.tabris.global.tabris.widgets.WebView]
  ...
  def insertAfter(widget: Widget[Any]): typingsJapgolly.tabris.global.tabris.widgets.WebView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], typingsJapgolly.tabris.global.tabris.widgets.WebView]
  
  def insertBefore(widget: Widget[Any]): typingsJapgolly.tabris.global.tabris.widgets.WebView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], typingsJapgolly.tabris.global.tabris.widgets.WebView]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.widgets.WebView
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.widgets.WebView
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, background]
  
  var onBaselineChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, baseline]
  
  var onBottomChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, bottom]
  
  var onBoundsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, bounds]
  
  var onCanGoBackChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, canGoBack]
  
  var onCanGoForwardChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, canGoForward]
  
  var onCenterXChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, centerX]
  
  var onCenterYChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, centerY]
  
  var onClassChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, `class`]
  
  var onClassListChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, cornerRadius]
  
  var onDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, data]
  
  var onDispose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onDownload: Listeners[WebViewDownloadEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onElevationChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, elevation]
  
  var onEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, highlightOnTouch]
  
  var onHtmlChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, html]
  
  var onIdChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, id]
  
  var onLayoutDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, layoutData]
  
  var onLeftChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, left]
  
  var onLoad: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onLongPress: Listeners[WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onMessage: Listeners[WebViewMessageEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onNavigate: Listeners[WebViewNavigateEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onOpacityChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onPanDown: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onPanRight: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onPanUp: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onResize: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onRightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onTap: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onTopChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]
  
  var onTransformChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, transform]
  
  var onUrlChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, url]
  
  var onVisibleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, visible]
  
  var onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.widgets.WebView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def postMessage(message: String, targetOrigin: String): typingsJapgolly.tabris.global.tabris.widgets.WebView
  @JSName("postMessage")
  ...
  var set_Original: js.Function1[
    /* properties */ Properties[
      typingsJapgolly.tabris.global.tabris.widgets.WebView, 
      Omit[typingsJapgolly.tabris.global.tabris.widgets.WebView, set]
    ], 
    typingsJapgolly.tabris.global.tabris.widgets.WebView
  ]
  @JSName("set")
  def set_set[T /* <: NativeObject */](properties: Properties[T, Omit[T, set]]): typingsJapgolly.tabris.global.tabris.widgets.WebView
  ...
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.widgets.WebView
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.widgets.WebView]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[
    /* type */ String, 
    js.Promise[typingsJapgolly.tabris.global.tabris.widgets.WebView]
  ]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.widgets.WebView]
...
object OmitWebViewcanGoBackcanGoAnimate {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ Composite[Widget[Any]] => typingsJapgolly.tabris.global.tabris.widgets.WebView,
    ...
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[typingsJapgolly.tabris.global.tabris.widgets.WebView],
    dispose: Callback,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    initScript: String,
    insertAfter: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.WebView,
    insertBefore: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.WebView,
    isDisposed: CallbackTo[Boolean],
    jsxAttributes: (JSXAttributes[
      typingsJapgolly.tabris.global.tabris.widgets.WebView, 
      Omit[typingsJapgolly.tabris.global.tabris.widgets.WebView, set | jsxAttributes]
    ]) & js.Object,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.WebView,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.WebView,
    onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, background],
    onBaselineChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, baseline],
    onBottomChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, bottom],
    onBoundsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, bounds],
    onCanGoBackChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, canGoBack],
    onCanGoForwardChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, canGoForward],
    onCenterXChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, centerX],
    onCenterYChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, centerY],
    onClassChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, `class`],
    onClassListChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, classList],
    onCornerRadiusChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, cornerRadius],
    onDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, data],
    onDispose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onDownload: Listeners[WebViewDownloadEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onElevationChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, elevation],
    onEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, excludeFromLayout],
    onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, height],
    onHighlightOnTouchChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, highlightOnTouch],
    onHtmlChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, html],
    onIdChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, id],
    onLayoutDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, layoutData],
    onLeftChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, left],
    onLoad: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onLongPress: Listeners[WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onMessage: Listeners[WebViewMessageEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onNavigate: Listeners[WebViewNavigateEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onOpacityChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, opacity],
    onPan: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onPanDown: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onPanHorizontal: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onPanLeft: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onPanRight: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onPanUp: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onPanVertical: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onResize: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onRightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onTap: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onTopChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onTouchEnd: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onTouchMove: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onTouchStart: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]],
    onTransformChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, transform],
    onUrlChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, url],
    onVisibleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, visible],
    onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.WebView,
    opacity: Double,
    parent: CallbackTo[Composite[Widget[Any]]],
    postMessage: (/* message */ String, /* targetOrigin */ String) => typingsJapgolly.tabris.global.tabris.widgets.WebView,
  ...
  extension [Self <: OmitWebViewcanGoBackcanGoAnimate](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => typingsJapgolly.tabris.global.tabris.widgets.WebView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[typingsJapgolly.tabris.global.tabris.widgets.WebView]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setGoBack(value: Callback): Self = StObject.set(x, "goBack", value.toJsFn)
    
    inline def setGoForward(value: Callback): Self = StObject.set(x, "goForward", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.WebView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.WebView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.WebView
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.WebView
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCanGoBackChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, canGoBack]): Self = StObject.set(x, "onCanGoBackChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCanGoForwardChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, canGoForward]): Self = StObject.set(x, "onCanGoForwardChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnDownload(value: Listeners[WebViewDownloadEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onDownload", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHtmlChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, html]): Self = StObject.set(x, "onHtmlChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLoad(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onLoad", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnMessage(value: Listeners[WebViewMessageEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onMessage", value.asInstanceOf[js.Any])
    
    inline def setOnNavigate(value: Listeners[WebViewNavigateEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onNavigate", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.WebView]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnUrlChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, url]): Self = StObject.set(x, "onUrlChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.WebView, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setPostMessage(
      value: (/* message */ String, /* targetOrigin */ String) => typingsJapgolly.tabris.global.tabris.widgets.WebView
    ...
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.widgets.WebView): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.widgets.WebView]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
