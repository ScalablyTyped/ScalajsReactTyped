...
trait OmitTimeDialogset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[
    TimeDialog, 
    Omit[TimeDialog, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `3`
...
object OmitTimeDialogset {
  ...
  extension [Self <: OmitTimeDialogset](x: Self) {
    ...
    inline def setClose(value: CallbackTo[TimeDialog]): Self = StObject.set(x, "close", value.toJsFn)
    ...
    inline def setOpen(value: CallbackTo[TimeDialog]): Self = StObject.set(x, "open", value.toJsFn)
