...
import typingsJapgolly.tabris.mod.AlertDialog
...
import typingsJapgolly.tabris.tabrisStrings.textInputs
...
trait OmitAlertDialogtextInputsCid extends StObject {
  ...
  def close(): typingsJapgolly.tabris.global.tabris.AlertDialog
  @JSName("close")
  var close_Original: js.Function0[typingsJapgolly.tabris.global.tabris.AlertDialog]
  ...
  var jsxAttributes: (JSXAttributes[
    typingsJapgolly.tabris.global.tabris.AlertDialog, 
    Omit[
      typingsJapgolly.tabris.global.tabris.AlertDialog, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.AlertDialog
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.AlertDialog
  def on(
    `type`: String,
  ...
  var onButtonsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.AlertDialog, buttons]
  
  var onClose: Listeners[AlertDialogCloseEvent[typingsJapgolly.tabris.global.tabris.AlertDialog]]
  
  var onCloseCancel: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.AlertDialog]]
  
  var onCloseNeutral: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.AlertDialog]]
  
  var onCloseOk: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.AlertDialog]]
  
  var onMessageChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.AlertDialog, message]
  
  var onTitleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.AlertDialog, title]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.AlertDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def open(): typingsJapgolly.tabris.global.tabris.AlertDialog
  @JSName("open")
  var open_Original: js.Function0[typingsJapgolly.tabris.global.tabris.AlertDialog]
  
  @JSName("set")
  var set_Original: js.Function1[
    /* properties */ Properties[
      typingsJapgolly.tabris.global.tabris.AlertDialog, 
      Omit[typingsJapgolly.tabris.global.tabris.AlertDialog, set]
    ], 
    typingsJapgolly.tabris.global.tabris.AlertDialog
  ]
  @JSName("set")
  def set_set[T /* <: NativeObject */](properties: Properties[T, Omit[T, set]]): typingsJapgolly.tabris.global.tabris.AlertDialog
  
  var title: String
  
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.AlertDialog
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.AlertDialog]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typingsJapgolly.tabris.global.tabris.AlertDialog]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.AlertDialog]
}
object OmitAlertDialogtextInputsCid {
  ...
  extension [Self <: OmitAlertDialogtextInputsCid](x: Self) {
    ...
    inline def setClose(value: CallbackTo[typingsJapgolly.tabris.global.tabris.AlertDialog]): Self = StObject.set(x, "close", value.toJsFn)
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.AlertDialog
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.AlertDialog
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnButtonsChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.AlertDialog, buttons]): Self = StObject.set(x, "onButtonsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClose(value: Listeners[AlertDialogCloseEvent[typingsJapgolly.tabris.global.tabris.AlertDialog]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnCloseCancel(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.AlertDialog]]): Self = StObject.set(x, "onCloseCancel", value.asInstanceOf[js.Any])
    
    inline def setOnCloseNeutral(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.AlertDialog]]): Self = StObject.set(x, "onCloseNeutral", value.asInstanceOf[js.Any])
    
    inline def setOnCloseOk(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.AlertDialog]]): Self = StObject.set(x, "onCloseOk", value.asInstanceOf[js.Any])
    
    inline def setOnMessageChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.AlertDialog, message]): Self = StObject.set(x, "onMessageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTitleChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.AlertDialog, title]): Self = StObject.set(x, "onTitleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.AlertDialog
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: CallbackTo[typingsJapgolly.tabris.global.tabris.AlertDialog]): Self = StObject.set(x, "open", value.toJsFn)
    ...
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.AlertDialog): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.AlertDialog]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
