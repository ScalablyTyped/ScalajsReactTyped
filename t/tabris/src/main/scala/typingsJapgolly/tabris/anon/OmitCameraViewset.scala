...
trait OmitCameraViewset extends StObject {
  ...
  def appendTo(parent: Composite[Widget[Any]]): CameraView
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], CameraView]
  ...
  def detach(): CameraView
  @JSName("detach")
  var detach_Original: js.Function0[CameraView]
  ...
  def insertAfter(widget: Widget[Any]): CameraView
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], CameraView]
  
  def insertBefore(widget: Widget[Any]): CameraView
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], CameraView]
  ...
  var jsxAttributes: (JSXAttributes[
    CameraView, 
    Omit[CameraView, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `3`
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): CameraView
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): CameraView
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[CameraView, background]
  
  var onBaselineChanged: ChangeListeners[CameraView, baseline]
  
  var onBottomChanged: ChangeListeners[CameraView, bottom]
  
  var onBoundsChanged: ChangeListeners[CameraView, bounds]
  
  var onCameraChanged: ChangeListeners[CameraView, camera]
  
  var onCenterXChanged: ChangeListeners[CameraView, centerX]
  
  var onCenterYChanged: ChangeListeners[CameraView, centerY]
  
  var onClassChanged: ChangeListeners[CameraView, `class`]
  
  var onClassListChanged: ChangeListeners[CameraView, classList]
  
  var onCornerRadiusChanged: ChangeListeners[CameraView, cornerRadius]
  
  var onDataChanged: ChangeListeners[CameraView, data]
  
  var onDispose: Listeners[EventObject[CameraView]]
  
  var onElevationChanged: ChangeListeners[CameraView, elevation]
  
  var onEnabledChanged: ChangeListeners[CameraView, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[CameraView, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[CameraView, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[CameraView, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[CameraView, id]
  
  var onLayoutDataChanged: ChangeListeners[CameraView, layoutData]
  
  var onLeftChanged: ChangeListeners[CameraView, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[CameraView]]
  
  var onOpacityChanged: ChangeListeners[CameraView, opacity]
  
  var onPan: Listeners[WidgetPanEvent[CameraView]]
  
  var onPanDown: Listeners[WidgetPanEvent[CameraView]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[CameraView]]
  
  var onPanLeft: Listeners[WidgetPanEvent[CameraView]]
  
  var onPanRight: Listeners[WidgetPanEvent[CameraView]]
  
  var onPanUp: Listeners[WidgetPanEvent[CameraView]]
  
  var onPanVertical: Listeners[WidgetPanEvent[CameraView]]
  
  var onResize: Listeners[WidgetResizeEvent[CameraView]]
  
  var onRightChanged: ChangeListeners[CameraView, right]
  
  var onScaleModeChanged: ChangeListeners[CameraView, scaleMode]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[CameraView]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[CameraView]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[CameraView]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[CameraView]]
  
  var onTap: Listeners[WidgetTapEvent[CameraView]]
  
  var onTopChanged: ChangeListeners[CameraView, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[CameraView]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[CameraView]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[CameraView]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[CameraView]]
  
  var onTransformChanged: ChangeListeners[CameraView, transform]
  
  var onVisibleChanged: ChangeListeners[CameraView, visible]
  
  var onWidthChanged: ChangeListeners[CameraView, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): CameraView
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): CameraView
  
  def triggerAsync(`type`: String): js.Promise[CameraView]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[CameraView]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, CameraView]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitCameraViewset {
  ...
  inline def apply(
    ...
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => CameraView,
    onBackgroundChanged: ChangeListeners[CameraView, background],
    onBaselineChanged: ChangeListeners[CameraView, baseline],
    onBottomChanged: ChangeListeners[CameraView, bottom],
    onBoundsChanged: ChangeListeners[CameraView, bounds],
    onCameraChanged: ChangeListeners[CameraView, camera],
    onCenterXChanged: ChangeListeners[CameraView, centerX],
    onCenterYChanged: ChangeListeners[CameraView, centerY],
    onClassChanged: ChangeListeners[CameraView, `class`],
    onClassListChanged: ChangeListeners[CameraView, classList],
    onCornerRadiusChanged: ChangeListeners[CameraView, cornerRadius],
    onDataChanged: ChangeListeners[CameraView, data],
    onDispose: Listeners[EventObject[CameraView]],
    onElevationChanged: ChangeListeners[CameraView, elevation],
    onEnabledChanged: ChangeListeners[CameraView, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[CameraView, excludeFromLayout],
    onHeightChanged: ChangeListeners[CameraView, height],
    onHighlightOnTouchChanged: ChangeListeners[CameraView, highlightOnTouch],
    onIdChanged: ChangeListeners[CameraView, id],
    onLayoutDataChanged: ChangeListeners[CameraView, layoutData],
    onLeftChanged: ChangeListeners[CameraView, left],
    onLongPress: Listeners[WidgetLongPressEvent[CameraView]],
    onOpacityChanged: ChangeListeners[CameraView, opacity],
    onPan: Listeners[WidgetPanEvent[CameraView]],
    onPanDown: Listeners[WidgetPanEvent[CameraView]],
    onPanHorizontal: Listeners[WidgetPanEvent[CameraView]],
    onPanLeft: Listeners[WidgetPanEvent[CameraView]],
    onPanRight: Listeners[WidgetPanEvent[CameraView]],
    onPanUp: Listeners[WidgetPanEvent[CameraView]],
    onPanVertical: Listeners[WidgetPanEvent[CameraView]],
    onResize: Listeners[WidgetResizeEvent[CameraView]],
    onRightChanged: ChangeListeners[CameraView, right],
    onScaleModeChanged: ChangeListeners[CameraView, scaleMode],
    onSwipeDown: Listeners[WidgetSwipeEvent[CameraView]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[CameraView]],
    onSwipeRight: Listeners[WidgetSwipeEvent[CameraView]],
    onSwipeUp: Listeners[WidgetSwipeEvent[CameraView]],
    onTap: Listeners[WidgetTapEvent[CameraView]],
    onTopChanged: ChangeListeners[CameraView, top],
    onTouchCancel: Listeners[WidgetTouchEvent[CameraView]],
    onTouchEnd: Listeners[WidgetTouchEvent[CameraView]],
    onTouchMove: Listeners[WidgetTouchEvent[CameraView]],
    onTouchStart: Listeners[WidgetTouchEvent[CameraView]],
    onTransformChanged: ChangeListeners[CameraView, transform],
    onVisibleChanged: ChangeListeners[CameraView, visible],
    onWidthChanged: ChangeListeners[CameraView, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => CameraView,
    opacity: Double,
    ...
    trigger: /* type */ String => CameraView,
    triggerAsync: /* type */ String => js.Promise[CameraView],
    visible: Boolean,
  ...
  extension [Self <: OmitCameraViewset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ Composite[Widget[Any]] => CameraView): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[CameraView]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => CameraView): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => CameraView): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => CameraView
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => CameraView
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[CameraView, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[CameraView, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[CameraView, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[CameraView, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCameraChanged(value: ChangeListeners[CameraView, camera]): Self = StObject.set(x, "onCameraChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[CameraView, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[CameraView, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[CameraView, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[CameraView, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[CameraView, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[CameraView, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[CameraView]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[CameraView, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[CameraView, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[CameraView, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[CameraView, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[CameraView, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[CameraView, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[CameraView, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[CameraView, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[CameraView]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[CameraView, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[CameraView]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[CameraView]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[CameraView]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[CameraView]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[CameraView]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[CameraView]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[CameraView]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[CameraView]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[CameraView, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnScaleModeChanged(value: ChangeListeners[CameraView, scaleMode]): Self = StObject.set(x, "onScaleModeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[CameraView]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[CameraView]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[CameraView]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[CameraView]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[CameraView]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[CameraView, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[CameraView]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[CameraView]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[CameraView]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[CameraView]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[CameraView, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[CameraView, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[CameraView, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => CameraView): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[CameraView]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
