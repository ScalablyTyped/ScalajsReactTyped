...
import typingsJapgolly.tabris.mod.widgets.ActivityIndicator
...
trait OmitActivityIndicatorset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[
    ActivityIndicator, 
    Omit[ActivityIndicator, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `3`
...
object OmitActivityIndicatorset {
  ...
  inline def apply(
    ...
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[ActivityIndicator],
    dispose: Callback,
    elevation: Double,
    enabled: Boolean,
  ...
  extension [Self <: OmitActivityIndicatorset](x: Self) {
    ...
    inline def setDetach(value: CallbackTo[ActivityIndicator]): Self = StObject.set(x, "detach", value.toJsFn)
