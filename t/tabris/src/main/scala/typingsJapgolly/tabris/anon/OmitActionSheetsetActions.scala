...
import typingsJapgolly.tabris.mod.ActionSheet
import typingsJapgolly.tabris.mod.ActionSheetCloseEvent
import typingsJapgolly.tabris.mod.ActionSheetSelectEvent
...
import typingsJapgolly.tabris.tabrisStrings.actions
...
trait OmitActionSheetsetActions extends StObject {
  ...
  var actions: js.Array[Image]
  
  var cid: String
  
  def close(): typingsJapgolly.tabris.global.tabris.ActionSheet
  @JSName("close")
  var close_Original: js.Function0[typingsJapgolly.tabris.global.tabris.ActionSheet]
  
  @JSName("constructor")
  var constructor_Original: js.Function1[/* properties */ js.UndefOr[Properties[ActionSheet, Omit[ActionSheet, set]]], Any]
  ...
  var jsxAttributes: (JSXAttributes[
    typingsJapgolly.tabris.global.tabris.ActionSheet, 
    Omit[
      typingsJapgolly.tabris.global.tabris.ActionSheet, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.ActionSheet
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.ActionSheet
  def on(
    `type`: String,
  ...
  var onActionsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ActionSheet, actions]
  
  var onClose: Listeners[ActionSheetCloseEvent[typingsJapgolly.tabris.global.tabris.ActionSheet]]
  
  var onMessageChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ActionSheet, message]
  
  var onSelect: Listeners[ActionSheetSelectEvent[typingsJapgolly.tabris.global.tabris.ActionSheet]]
  
  var onTitleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.ActionSheet, title]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.ActionSheet
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def open(): typingsJapgolly.tabris.global.tabris.ActionSheet
  @JSName("open")
  var open_Original: js.Function0[typingsJapgolly.tabris.global.tabris.ActionSheet]
  
  var title: String
  
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.ActionSheet
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.ActionSheet]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typingsJapgolly.tabris.global.tabris.ActionSheet]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.ActionSheet]
}
object OmitActionSheetsetActions {
  ...
  extension [Self <: OmitActionSheetsetActions](x: Self) {
    ...
    inline def setActions(value: js.Array[Image]): Self = StObject.set(x, "actions", value.asInstanceOf[js.Any])
    
    inline def setActionsVarargs(value: Image*): Self = StObject.set(x, "actions", js.Array(value*))
    
    inline def setCid(value: String): Self = StObject.set(x, "cid", value.asInstanceOf[js.Any])
    
    inline def setClose(value: CallbackTo[typingsJapgolly.tabris.global.tabris.ActionSheet]): Self = StObject.set(x, "close", value.toJsFn)
    
    inline def setConstructor(value: /* properties */ js.UndefOr[Properties[ActionSheet, Omit[ActionSheet, set]]] => Any): Self = StObject.set(x, "constructor", js.Any.fromFunction1(value))
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.ActionSheet
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.ActionSheet
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnActionsChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ActionSheet, actions]): Self = StObject.set(x, "onActionsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClose(value: Listeners[ActionSheetCloseEvent[typingsJapgolly.tabris.global.tabris.ActionSheet]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnMessageChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ActionSheet, message]): Self = StObject.set(x, "onMessageChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[ActionSheetSelectEvent[typingsJapgolly.tabris.global.tabris.ActionSheet]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnTitleChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.ActionSheet, title]): Self = StObject.set(x, "onTitleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.ActionSheet
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: CallbackTo[typingsJapgolly.tabris.global.tabris.ActionSheet]): Self = StObject.set(x, "open", value.toJsFn)
    
    inline def setTitle(value: String): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
    
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.ActionSheet): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.ActionSheet]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
