...
trait OmitRowset extends StObject {
  ...
  def append(widgets: Widget[Any]*): Row
  
  def appendTo(parent: Composite[Widget[Any]]): Row
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], Row]
  ...
  def detach(): Row
  @JSName("detach")
  var detach_Original: js.Function0[Row]
  ...
  def insertAfter(widget: Widget[Any]): Row
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], Row]
  
  def insertBefore(widget: Widget[Any]): Row
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], Row]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[Row, Widget[Any]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Row
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Row
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[Row]]
  
  var onBackgroundChanged: ChangeListeners[Row, background]
  
  var onBaselineChanged: ChangeListeners[Row, baseline]
  
  var onBottomChanged: ChangeListeners[Row, bottom]
  
  var onBoundsChanged: ChangeListeners[Row, bounds]
  
  var onCenterXChanged: ChangeListeners[Row, centerX]
  
  var onCenterYChanged: ChangeListeners[Row, centerY]
  
  var onClassChanged: ChangeListeners[Row, `class`]
  
  var onClassListChanged: ChangeListeners[Row, classList]
  
  var onCornerRadiusChanged: ChangeListeners[Row, cornerRadius]
  
  var onDataChanged: ChangeListeners[Row, data]
  
  var onDispose: Listeners[EventObject[Row]]
  
  var onElevationChanged: ChangeListeners[Row, elevation]
  
  var onEnabledChanged: ChangeListeners[Row, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[Row, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[Row, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[Row, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[Row, id]
  
  var onLayoutDataChanged: ChangeListeners[Row, layoutData]
  
  var onLeftChanged: ChangeListeners[Row, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[Row]]
  
  var onOpacityChanged: ChangeListeners[Row, opacity]
  
  var onPan: Listeners[WidgetPanEvent[Row]]
  
  var onPanDown: Listeners[WidgetPanEvent[Row]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[Row]]
  
  var onPanLeft: Listeners[WidgetPanEvent[Row]]
  
  var onPanRight: Listeners[WidgetPanEvent[Row]]
  
  var onPanUp: Listeners[WidgetPanEvent[Row]]
  
  var onPanVertical: Listeners[WidgetPanEvent[Row]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[Row]]
  
  var onResize: Listeners[WidgetResizeEvent[Row]]
  
  var onRightChanged: ChangeListeners[Row, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[Row]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Row]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[Row]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[Row]]
  
  var onTap: Listeners[WidgetTapEvent[Row]]
  
  var onTopChanged: ChangeListeners[Row, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[Row]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[Row]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[Row]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[Row]]
  
  var onTransformChanged: ChangeListeners[Row, transform]
  
  var onVisibleChanged: ChangeListeners[Row, visible]
  
  var onWidthChanged: ChangeListeners[Row, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Row
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): Row
  
  def triggerAsync(`type`: String): js.Promise[Row]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Row]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Row]
...
object OmitRowset {
  ...
  inline def apply(
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => Row,
    insertBefore: /* widget */ Widget[Any] => Row,
    isDisposed: CallbackTo[Boolean],
    jsxAttributes: JSXCompositeAttributes[Row, Widget[Any]],
    layout: RowLayout,
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Row,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Row,
    onAddChild: Listeners[CompositeAddChildEvent[Row]],
    onBackgroundChanged: ChangeListeners[Row, background],
    onBaselineChanged: ChangeListeners[Row, baseline],
    onBottomChanged: ChangeListeners[Row, bottom],
    onBoundsChanged: ChangeListeners[Row, bounds],
    onCenterXChanged: ChangeListeners[Row, centerX],
    onCenterYChanged: ChangeListeners[Row, centerY],
    onClassChanged: ChangeListeners[Row, `class`],
    onClassListChanged: ChangeListeners[Row, classList],
    onCornerRadiusChanged: ChangeListeners[Row, cornerRadius],
    onDataChanged: ChangeListeners[Row, data],
    onDispose: Listeners[EventObject[Row]],
    onElevationChanged: ChangeListeners[Row, elevation],
    onEnabledChanged: ChangeListeners[Row, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[Row, excludeFromLayout],
    onHeightChanged: ChangeListeners[Row, height],
    onHighlightOnTouchChanged: ChangeListeners[Row, highlightOnTouch],
    onIdChanged: ChangeListeners[Row, id],
    onLayoutDataChanged: ChangeListeners[Row, layoutData],
    onLeftChanged: ChangeListeners[Row, left],
    onLongPress: Listeners[WidgetLongPressEvent[Row]],
    onOpacityChanged: ChangeListeners[Row, opacity],
    onPan: Listeners[WidgetPanEvent[Row]],
    onPanDown: Listeners[WidgetPanEvent[Row]],
    onPanHorizontal: Listeners[WidgetPanEvent[Row]],
    onPanLeft: Listeners[WidgetPanEvent[Row]],
    onPanRight: Listeners[WidgetPanEvent[Row]],
    onPanUp: Listeners[WidgetPanEvent[Row]],
    onPanVertical: Listeners[WidgetPanEvent[Row]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[Row]],
    onResize: Listeners[WidgetResizeEvent[Row]],
    onRightChanged: ChangeListeners[Row, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[Row]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[Row]],
    onSwipeRight: Listeners[WidgetSwipeEvent[Row]],
    onSwipeUp: Listeners[WidgetSwipeEvent[Row]],
    onTap: Listeners[WidgetTapEvent[Row]],
    onTopChanged: ChangeListeners[Row, top],
    onTouchCancel: Listeners[WidgetTouchEvent[Row]],
    onTouchEnd: Listeners[WidgetTouchEvent[Row]],
    onTouchMove: Listeners[WidgetTouchEvent[Row]],
    onTouchStart: Listeners[WidgetTouchEvent[Row]],
    onTransformChanged: ChangeListeners[Row, transform],
    onVisibleChanged: ChangeListeners[Row, visible],
    onWidthChanged: ChangeListeners[Row, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Row,
    opacity: Double,
    ...
    trigger: /* type */ String => Row,
    triggerAsync: /* type */ String => js.Promise[Row],
    visible: Boolean,
    ...
    __obj.asInstanceOf[OmitRowset]
  }
  
  extension [Self <: OmitRowset](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => Row): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[Row]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => Row): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => Row): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: CallbackTo[Boolean]): Self = StObject.set(x, "isDisposed", value.toJsFn)
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[Row, Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Row
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Row
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[Row]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[Row, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[Row, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[Row, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[Row, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[Row, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[Row, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[Row, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[Row, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[Row, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[Row, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[Row]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[Row, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[Row, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[Row, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[Row, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[Row, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[Row, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[Row, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[Row, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[Row]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[Row, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[Row]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[Row]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[Row]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[Row]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[Row]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[Row]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[Row]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[Row]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[Row]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[Row, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[Row]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[Row]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[Row]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[Row]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[Row]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[Row, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[Row]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[Row]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[Row]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[Row]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[Row, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[Row, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[Row, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => Row): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[Row]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
