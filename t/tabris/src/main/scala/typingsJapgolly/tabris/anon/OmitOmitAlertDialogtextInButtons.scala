...
trait OmitOmitAlertDialogtextInButtons extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[OmitAlertDialogtextInputsButtons, Omit[OmitAlertDialogtextInputsButtons, set]]
    ], 
    Any
  ]
...
object OmitOmitAlertDialogtextInButtons {
  ...
  inline def apply(
  ...
  ): OmitOmitAlertDialogtextInButtons = {
    ...
    __obj.asInstanceOf[OmitOmitAlertDialogtextInButtons]
  }
  
  extension [Self <: OmitOmitAlertDialogtextInButtons](x: Self) {
