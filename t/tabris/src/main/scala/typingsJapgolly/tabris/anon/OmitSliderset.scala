...
trait OmitSliderset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[Slider, Omit[Slider, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]]) & `3`
...
object OmitSliderset {
  ...
  extension [Self <: OmitSliderset](x: Self) {
    ...
    inline def setDetach(value: CallbackTo[Slider]): Self = StObject.set(x, "detach", value.toJsFn)
