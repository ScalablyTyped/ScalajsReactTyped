...
trait OmitDateDialogsetCheckDisposed extends StObject {
  ...
  def close(): typingsJapgolly.tabris.global.tabris.DateDialog
  @JSName("close")
  var close_Original: js.Function0[typingsJapgolly.tabris.global.tabris.DateDialog]
  ...
  var jsxAttributes: (JSXAttributes[
    typingsJapgolly.tabris.global.tabris.DateDialog, 
    Omit[
      typingsJapgolly.tabris.global.tabris.DateDialog, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.DateDialog
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.DateDialog
  def on(
    `type`: String,
  ...
  var onClose: Listeners[DateDialogCloseEvent[typingsJapgolly.tabris.global.tabris.DateDialog]]
  
  var onDateChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, date]
  
  var onMaxDateChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, maxDate]
  
  var onMinDateChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, minDate]
  
  var onSelect: Listeners[DateDialogSelectEvent[typingsJapgolly.tabris.global.tabris.DateDialog]]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.DateDialog
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def open(): typingsJapgolly.tabris.global.tabris.DateDialog
  @JSName("open")
  var open_Original: js.Function0[typingsJapgolly.tabris.global.tabris.DateDialog]
  
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.DateDialog
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.DateDialog]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typingsJapgolly.tabris.global.tabris.DateDialog]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.DateDialog]
}
object OmitDateDialogsetCheckDisposed {
  ...
  inline def apply(
    ...
    cid: String,
    close: CallbackTo[typingsJapgolly.tabris.global.tabris.DateDialog],
    constructor: /* properties */ js.UndefOr[Properties[DateDialog, Omit[DateDialog, set]]] => Any,
    date: js.Date,
    jsxAttributes: (JSXAttributes[
      typingsJapgolly.tabris.global.tabris.DateDialog, 
      Omit[typingsJapgolly.tabris.global.tabris.DateDialog, set | jsxAttributes]
    ]) & `3`,
    maxDate: js.Date,
    minDate: js.Date,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.DateDialog,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.DateDialog,
    onClose: Listeners[DateDialogCloseEvent[typingsJapgolly.tabris.global.tabris.DateDialog]],
    onDateChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, date],
    onMaxDateChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, maxDate],
    onMinDateChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, minDate],
    onSelect: Listeners[DateDialogSelectEvent[typingsJapgolly.tabris.global.tabris.DateDialog]],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.DateDialog,
    open: CallbackTo[typingsJapgolly.tabris.global.tabris.DateDialog],
    trigger: /* type */ String => typingsJapgolly.tabris.global.tabris.DateDialog,
    triggerAsync: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.DateDialog]
  ...
  extension [Self <: OmitDateDialogsetCheckDisposed](x: Self) {
    ...
    inline def setClose(value: CallbackTo[typingsJapgolly.tabris.global.tabris.DateDialog]): Self = StObject.set(x, "close", value.toJsFn)
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.DateDialog
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.DateDialog
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnClose(value: Listeners[DateDialogCloseEvent[typingsJapgolly.tabris.global.tabris.DateDialog]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnDateChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, date]): Self = StObject.set(x, "onDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMaxDateChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, maxDate]): Self = StObject.set(x, "onMaxDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnMinDateChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.DateDialog, minDate]): Self = StObject.set(x, "onMinDateChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSelect(value: Listeners[DateDialogSelectEvent[typingsJapgolly.tabris.global.tabris.DateDialog]]): Self = StObject.set(x, "onSelect", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.DateDialog
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: CallbackTo[typingsJapgolly.tabris.global.tabris.DateDialog]): Self = StObject.set(x, "open", value.toJsFn)
    
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.DateDialog): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.DateDialog]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
