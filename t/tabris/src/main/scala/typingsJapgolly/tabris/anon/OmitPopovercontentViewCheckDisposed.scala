...
trait OmitPopovercontentViewCheckDisposed extends StObject {
  ...
  def close(): typingsJapgolly.tabris.global.tabris.Popover
  @JSName("close")
  var close_Original: js.Function0[typingsJapgolly.tabris.global.tabris.Popover]
  ...
  var jsxAttributes: (JSXAttributes[
    typingsJapgolly.tabris.global.tabris.Popover, 
    Omit[
      typingsJapgolly.tabris.global.tabris.Popover, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.Popover
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.Popover
  def on(
    `type`: String,
  ...
  var onAnchorChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, anchor]
  
  var onClose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.Popover]]
  
  var onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, height]
  
  var onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.Popover
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def open(): typingsJapgolly.tabris.global.tabris.Popover
  @JSName("open")
  var open_Original: js.Function0[typingsJapgolly.tabris.global.tabris.Popover]
  
  @JSName("set")
  var set_Original: js.Function1[
    /* properties */ Properties[
      typingsJapgolly.tabris.global.tabris.Popover, 
      Omit[typingsJapgolly.tabris.global.tabris.Popover, set]
    ], 
    typingsJapgolly.tabris.global.tabris.Popover
  ]
  @JSName("set")
  def set_set[T /* <: NativeObject */](properties: Properties[T, Omit[T, set]]): typingsJapgolly.tabris.global.tabris.Popover
  
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.Popover
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.Popover]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typingsJapgolly.tabris.global.tabris.Popover]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.Popover]
...
object OmitPopovercontentViewCheckDisposed {
  ...
  inline def apply(
    ...
    anchor: Widget[Any],
    cid: String,
    close: CallbackTo[typingsJapgolly.tabris.global.tabris.Popover],
    constructor: /* properties */ js.UndefOr[Properties[Omit[Popover, contentView], OmitOmitPopovercontentVieCheckDisposed]] => Any,
    height: Dimension,
    jsxAttributes: (JSXAttributes[
      typingsJapgolly.tabris.global.tabris.Popover, 
      Omit[typingsJapgolly.tabris.global.tabris.Popover, set | jsxAttributes]
    ]) & ContentView,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.Popover,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.Popover,
    onAnchorChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, anchor],
    onClose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.Popover]],
    onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, height],
    onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.Popover,
    open: CallbackTo[typingsJapgolly.tabris.global.tabris.Popover],
    set: /* properties */ Properties[
      typingsJapgolly.tabris.global.tabris.Popover, 
      Omit[typingsJapgolly.tabris.global.tabris.Popover, set]
    ] => typingsJapgolly.tabris.global.tabris.Popover,
    trigger: /* type */ String => typingsJapgolly.tabris.global.tabris.Popover,
    triggerAsync: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.Popover],
    width: Dimension
  ...
  extension [Self <: OmitPopovercontentViewCheckDisposed](x: Self) {
    ...
    inline def setClose(value: CallbackTo[typingsJapgolly.tabris.global.tabris.Popover]): Self = StObject.set(x, "close", value.toJsFn)
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.Popover
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.Popover
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAnchorChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, anchor]): Self = StObject.set(x, "onAnchorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClose(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.Popover]]): Self = StObject.set(x, "onClose", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.Popover, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    
    inline def setOnce(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.Popover
    ): Self = StObject.set(x, "once", js.Any.fromFunction3(value))
    
    inline def setOpen(value: CallbackTo[typingsJapgolly.tabris.global.tabris.Popover]): Self = StObject.set(x, "open", value.toJsFn)
    ...
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.Popover): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.Popover]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
