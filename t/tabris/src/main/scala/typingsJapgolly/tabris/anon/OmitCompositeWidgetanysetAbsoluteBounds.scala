...
import typingsJapgolly.tabris.mod.widgets.Composite
...
trait OmitCompositeWidgetanysetAbsoluteBounds[ChildType /* <: Widget[Any] */] extends StObject {
  ...
  def _apply[Target](
    options: `21`[Target],
    rules: RuleSet[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `21`[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]], 
    /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]], 
    typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  ]
  ...
  def _setParent(parent: typingsJapgolly.tabris.mod.Composite[Widget[Any]]): Unit
  def _setParent(parent: typingsJapgolly.tabris.mod.Composite[Widget[Any]], index: Double): Unit
  @JSName("_setParent")
  var _setParent_Original: js.Function2[
    /* parent */ typingsJapgolly.tabris.mod.Composite[Widget[Any]], 
  ...
  def append(widgets: Widget[Any]*): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  
  def appendTo(parent: typingsJapgolly.tabris.mod.Composite[Widget[Any]]): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("appendTo")
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[Properties[Composite[Widget[Any]], Omit[Composite[Widget[Any]], set]]], 
    Any
  ]
  ...
  def detach(): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("detach")
  var detach_Original: js.Function0[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ...
  def insertAfter(widget: Widget[Any]): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("insertAfter")
  ...
  def insertBefore(widget: Widget[Any]): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  @JSName("insertBefore")
  ...
  var jsxAttributes: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], Widget[Any]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[
    CompositeAddChildEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], background]
  
  var onBaselineChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], baseline]
  
  var onBottomChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], bottom]
  
  var onBoundsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], bounds]
  
  var onCenterXChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], centerX]
  
  var onCenterYChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], centerY]
  
  var onClassChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], `class`]
  
  var onClassListChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], classList]
  
  var onCornerRadiusChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], cornerRadius]
  
  var onDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], data]
  
  var onDispose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]]
  
  var onElevationChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], elevation]
  
  var onEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[
    typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], 
    excludeFromLayout
  ]
  
  var onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], height]
  
  var onHighlightOnTouchChanged: ChangeListeners[
    typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], 
    highlightOnTouch
  ]
  
  var onIdChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], id]
  
  var onLayoutDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], layoutData]
  
  var onLeftChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], left]
  
  var onLongPress: Listeners[
    WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onOpacityChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], opacity]
  
  var onPan: Listeners[
    WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onPanDown: Listeners[
    WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onPanHorizontal: Listeners[
    WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onPanLeft: Listeners[
    WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onPanRight: Listeners[
    WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onPanUp: Listeners[
    WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onPanVertical: Listeners[
    WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onRemoveChild: Listeners[
    CompositeRemoveChildEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onResize: Listeners[
    WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onRightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], right]
  
  var onSwipeDown: Listeners[
    WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onSwipeLeft: Listeners[
    WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onSwipeRight: Listeners[
    WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onSwipeUp: Listeners[
    WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onTap: Listeners[
    WidgetTapEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onTopChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], top]
  
  var onTouchCancel: Listeners[
    WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onTouchEnd: Listeners[
    WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onTouchMove: Listeners[
    WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onTouchStart: Listeners[
    WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  var onTransformChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], transform]
  
  var onVisibleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], visible]
  
  var onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def parent(): typingsJapgolly.tabris.mod.Composite[Widget[Any]]
  @JSName("parent")
  var parent_Original: js.Function0[typingsJapgolly.tabris.mod.Composite[Widget[Any]]]
  ...
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[
    /* type */ String, 
    js.Promise[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[
    /* type */ String, 
    typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
  ]
...
object OmitCompositeWidgetanysetAbsoluteBounds {
  ...
  inline def apply[ChildType /* <: Widget[Any] */](
    ...
    _apply: (/* options */ `21`[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]) => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType],
    ...
    _setParent: (/* parent */ typingsJapgolly.tabris.mod.Composite[Widget[Any]], /* index */ js.UndefOr[Double]) => Callback,
    ...
    append: /* repeated */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType],
    appendTo: /* parent */ typingsJapgolly.tabris.mod.Composite[Widget[Any]] => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType],
    apply: (/* options */ `21`[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]) => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType],
    ...
    constructor: /* properties */ js.UndefOr[Properties[Composite[Widget[Any]], Omit[Composite[Widget[Any]], set]]] => Any,
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]],
    dispose: Callback,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType],
    insertBefore: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType],
    isDisposed: CallbackTo[Boolean],
    jsxAttributes: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], Widget[Any]],
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType],
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType],
    onAddChild: Listeners[
      CompositeAddChildEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], background],
    onBaselineChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], baseline],
    onBottomChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], bottom],
    onBoundsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], bounds],
    onCenterXChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], centerX],
    onCenterYChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], centerY],
    onClassChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], `class`],
    onClassListChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], classList],
    onCornerRadiusChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], cornerRadius],
    onDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], data],
    onDispose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]],
    onElevationChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], elevation],
    onEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], enabled],
    onExcludeFromLayoutChanged: ChangeListeners[
      typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], 
      excludeFromLayout
    ],
    onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], height],
    onHighlightOnTouchChanged: ChangeListeners[
      typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], 
      highlightOnTouch
    ],
    onIdChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], id],
    onLayoutDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], layoutData],
    onLeftChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], left],
    onLongPress: Listeners[
      WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onOpacityChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], opacity],
    onPan: Listeners[
      WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onPanDown: Listeners[
    ...
    onPanHorizontal: Listeners[
      WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onPanLeft: Listeners[
      WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onPanRight: Listeners[
      WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onPanUp: Listeners[
      WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onPanVertical: Listeners[
      WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    ...
    onRightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], right],
    onSwipeDown: Listeners[
      WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onSwipeLeft: Listeners[
      WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onSwipeRight: Listeners[
      WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ],
    onSwipeUp: Listeners[
      WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
  ...
  extension [Self <: OmitCompositeWidgetanysetAbsoluteBounds[?], ChildType /* <: Widget[Any] */](x: Self & OmitCompositeWidgetanysetAbsoluteBounds[ChildType]) {
    ...
    inline def setAppend(
      value: /* repeated */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
    ): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(
      value: /* parent */ typingsJapgolly.tabris.mod.Composite[Widget[Any]] => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
    ): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `21`[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]) => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
    ...
    inline def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Composite[Widget[Any]], Omit[Composite[Widget[Any]], set]]] => Any
    ...
    inline def setDetach(value: CallbackTo[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(
      value: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
    ...
    inline def setJsxAttributes(
      value: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], Widget[Any]]
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(
      value: Listeners[
          CompositeAddChildEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], background]
    ): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], baseline]
    ): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], classList]
    ): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], cornerRadius]
    ): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], elevation]
    ): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    ...
    inline def setOnHeightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    ...
    inline def setOnIdChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], layoutData]
    ): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    ...
    inline def setOnOpacityChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(
      value: Listeners[
          WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(
      value: Listeners[
          WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(
      value: Listeners[
          WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(
      value: Listeners[
          WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(
      value: Listeners[
          WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(
      value: Listeners[
          WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(
      value: Listeners[
          WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    ...
    inline def setOnRightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(
      value: Listeners[
          WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(
      value: Listeners[
          WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(
      value: Listeners[
          WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(
      value: Listeners[
          WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
        ]
    ): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    ...
    inline def setOnTopChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    ...
    inline def setOnTransformChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], transform]
    ): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setParent(value: CallbackTo[typingsJapgolly.tabris.mod.Composite[Widget[Any]]]): Self = StObject.set(x, "parent", value.toJsFn)
    ...
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(
      value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.widgets.Composite[ChildType]]
    ): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
    ...
    inline def set_setParent(
      value: (/* parent */ typingsJapgolly.tabris.mod.Composite[Widget[Any]], /* index */ js.UndefOr[Double]) => Callback
    ): Self = StObject.set(x, "_setParent", js.Any.fromFunction2((t0: /* parent */ typingsJapgolly.tabris.mod.Composite[Widget[Any]], t1: /* index */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
