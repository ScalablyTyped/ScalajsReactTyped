...
trait OmitWebViewcanGoBackcanGoAbsoluteBounds extends StObject {
...
object OmitWebViewcanGoBackcanGoAbsoluteBounds {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OmitWebViewcanGoBackcanGoAbsoluteBounds]
  }
  
  extension [Self <: OmitWebViewcanGoBackcanGoAbsoluteBounds](x: Self) {
