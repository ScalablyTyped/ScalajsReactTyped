...
trait OmitPdfViewset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[PdfView, Omit[PdfView, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]]) & `11`
...
object OmitPdfViewset {
  ...
  extension [Self <: OmitPdfViewset](x: Self) {
    ...
    inline def setDetach(value: CallbackTo[PdfView]): Self = StObject.set(x, "detach", value.toJsFn)
