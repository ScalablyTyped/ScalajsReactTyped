...
import typingsJapgolly.tabris.mod.widgets.RefreshComposite
...
import typingsJapgolly.tabris.tabrisStrings.refreshEnabled
import typingsJapgolly.tabris.tabrisStrings.refreshIndicator
import typingsJapgolly.tabris.tabrisStrings.refreshMessage
...
trait OmitRefreshCompositesetAbsoluteBounds extends StObject {
  ...
  def _apply[Target](
    options: `24`[Target],
    rules: RuleSet[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
  ): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  @JSName("_apply")
  var _apply_Original: js.Function2[
    /* options */ `24`[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite], 
    /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite], 
    typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  ]
  ...
  def append(widgets: Widget[Any]*): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  
  def appendTo(parent: Composite[Widget[Any]]): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  @JSName("appendTo")
  ...
  def detach(): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  @JSName("detach")
  var detach_Original: js.Function0[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
  ...
  def insertAfter(widget: Widget[Any]): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  @JSName("insertAfter")
  ...
  def insertBefore(widget: Widget[Any]): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  @JSName("insertBefore")
  ...
  var jsxAttributes: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, Widget[Any]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[
    CompositeAddChildEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
  ]
  
  var onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, background]
  
  var onBaselineChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, baseline]
  
  var onBottomChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, bottom]
  
  var onBoundsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, bounds]
  
  var onCenterXChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, centerX]
  
  var onCenterYChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, centerY]
  
  var onClassChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, `class`]
  
  var onClassListChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, classList]
  
  var onCornerRadiusChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, cornerRadius]
  
  var onDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, data]
  
  var onDispose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onElevationChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, elevation]
  
  var onEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, id]
  
  var onLayoutDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, layoutData]
  
  var onLeftChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, left]
  
  var onLongPress: Listeners[
    WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
  ]
  
  var onOpacityChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, opacity]
  
  var onPan: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onPanDown: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onPanLeft: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onPanRight: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onPanUp: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onPanVertical: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onRefresh: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onRefreshEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshEnabled]
  
  var onRefreshIndicatorChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshIndicator]
  
  var onRefreshMessageChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshMessage]
  
  var onRemoveChild: Listeners[
    CompositeRemoveChildEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
  ]
  
  var onResize: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onRightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onTap: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onTopChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]
  
  var onTransformChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, transform]
  
  var onVisibleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, visible]
  
  var onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[
    /* type */ String, 
    js.Promise[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
  ]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
...
object OmitRefreshCompositesetAbsoluteBounds {
  ...
  inline def apply(
    ...
    _apply: (/* options */ `24`[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]) => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    ...
    append: /* repeated */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    appendTo: /* parent */ Composite[Widget[Any]] => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    apply: (/* options */ `24`[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]) => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    ...
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite],
    dispose: Callback,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    insertBefore: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    isDisposed: CallbackTo[Boolean],
    jsxAttributes: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, Widget[Any]],
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    onAddChild: Listeners[
      CompositeAddChildEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
    ],
    onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, background],
    onBaselineChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, baseline],
    onBottomChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, bottom],
    onBoundsChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, bounds],
    onCenterXChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, centerX],
    onCenterYChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, centerY],
    onClassChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, `class`],
    onClassListChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, classList],
    onCornerRadiusChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, cornerRadius],
    onDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, data],
    onDispose: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onElevationChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, elevation],
    onEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, excludeFromLayout],
    onHeightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, height],
    onHighlightOnTouchChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, highlightOnTouch],
    onIdChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, id],
    onLayoutDataChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, layoutData],
    onLeftChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, left],
    onLongPress: Listeners[
      WidgetLongPressEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
    ],
    onOpacityChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, opacity],
    onPan: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onPanDown: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onPanHorizontal: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onPanLeft: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onPanRight: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onPanUp: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onPanVertical: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onRefresh: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onRefreshEnabledChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshEnabled],
    onRefreshIndicatorChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshIndicator],
    onRefreshMessageChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshMessage],
    onRemoveChild: Listeners[
      CompositeRemoveChildEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
    ],
    onResize: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onRightChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onSwipeRight: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onSwipeUp: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onTap: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onTopChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, top],
    onTouchCancel: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onTouchEnd: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onTouchMove: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onTouchStart: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]],
    onTransformChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, transform],
    onVisibleChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, visible],
    onWidthChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite,
    opacity: Double,
  ...
  extension [Self <: OmitRefreshCompositesetAbsoluteBounds](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(
      value: /* parent */ Composite[Widget[Any]] => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
    ): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    
    inline def setApply(
      value: (/* options */ `24`[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite], /* rules */ RuleSet[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]) => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
    ...
    inline def setDetach(value: CallbackTo[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: CallbackTo[Boolean]): Self = StObject.set(x, "isDisposed", value.toJsFn)
    
    inline def setJsxAttributes(
      value: JSXCompositeAttributes[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, Widget[Any]]
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite
    ...
    inline def setOnBackgroundChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, cornerRadius]
    ): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, excludeFromLayout]
    ): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, highlightOnTouch]
    ): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    ...
    inline def setOnOpacityChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRefresh(value: Listeners[EventObject[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onRefresh", value.asInstanceOf[js.Any])
    
    inline def setOnRefreshEnabledChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshEnabled]
    ): Self = StObject.set(x, "onRefreshEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnRefreshIndicatorChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshIndicator]
    ): Self = StObject.set(x, "onRefreshIndicatorChanged", value.asInstanceOf[js.Any])
    
    inline def setOnRefreshMessageChanged(
      value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, refreshMessage]
    ): Self = StObject.set(x, "onRefreshMessageChanged", value.asInstanceOf[js.Any])
    ...
    inline def setOnResize(value: Listeners[WidgetResizeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(
      value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.widgets.RefreshComposite]
