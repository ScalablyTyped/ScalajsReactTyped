...
trait OmitTextViewset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[TextView, Omit[TextView, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]]) & `3`
...
object OmitTextViewset {
  ...
  extension [Self <: OmitTextViewset](x: Self) {
    ...
    inline def setDetach(value: CallbackTo[TextView]): Self = StObject.set(x, "detach", value.toJsFn)
