...
trait OmitOmitAlertDialogtextIn extends StObject {
...
object OmitOmitAlertDialogtextIn {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OmitOmitAlertDialogtextIn]
  }
  
  extension [Self <: OmitOmitAlertDialogtextIn](x: Self) {
