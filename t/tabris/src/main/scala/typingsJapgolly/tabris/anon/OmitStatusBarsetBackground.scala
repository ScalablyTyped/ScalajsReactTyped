...
import typingsJapgolly.tabris.mod.StatusBarTapEvent
import typingsJapgolly.tabris.mod.StatusBar_
...
trait OmitStatusBarsetBackground extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[
    typingsJapgolly.tabris.global.tabris.StatusBar_, 
    Omit[
      typingsJapgolly.tabris.global.tabris.StatusBar_, 
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): typingsJapgolly.tabris.global.tabris.StatusBar_
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.StatusBar_
  def on(
    `type`: String,
  ...
  var onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, background]
  
  var onDisplayModeChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, displayMode]
  
  var onTap: Listeners[StatusBarTapEvent[typingsJapgolly.tabris.global.tabris.StatusBar_]]
  
  var onThemeChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, theme]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): typingsJapgolly.tabris.global.tabris.StatusBar_
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): typingsJapgolly.tabris.global.tabris.StatusBar_
  
  def triggerAsync(`type`: String): js.Promise[typingsJapgolly.tabris.global.tabris.StatusBar_]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[typingsJapgolly.tabris.global.tabris.StatusBar_]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, typingsJapgolly.tabris.global.tabris.StatusBar_]
}
object OmitStatusBarsetBackground {
  ...
  inline def apply(
    ...
    jsxAttributes: (JSXAttributes[
      typingsJapgolly.tabris.global.tabris.StatusBar_, 
      Omit[typingsJapgolly.tabris.global.tabris.StatusBar_, set | jsxAttributes]
    ]) & `4`,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.StatusBar_,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.StatusBar_,
    onBackgroundChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, background],
    onDisplayModeChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, displayMode],
    onTap: Listeners[StatusBarTapEvent[typingsJapgolly.tabris.global.tabris.StatusBar_]],
    onThemeChanged: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, theme],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.StatusBar_,
    theme: dark | default | light,
    trigger: /* type */ String => typingsJapgolly.tabris.global.tabris.StatusBar_,
    triggerAsync: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.StatusBar_]
  ...
  extension [Self <: OmitStatusBarsetBackground](x: Self) {
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.StatusBar_
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => typingsJapgolly.tabris.global.tabris.StatusBar_
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnBackgroundChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDisplayModeChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, displayMode]): Self = StObject.set(x, "onDisplayModeChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[StatusBarTapEvent[typingsJapgolly.tabris.global.tabris.StatusBar_]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnThemeChanged(value: ChangeListeners[typingsJapgolly.tabris.global.tabris.StatusBar_, theme]): Self = StObject.set(x, "onThemeChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => typingsJapgolly.tabris.global.tabris.StatusBar_): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[typingsJapgolly.tabris.global.tabris.StatusBar_]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
