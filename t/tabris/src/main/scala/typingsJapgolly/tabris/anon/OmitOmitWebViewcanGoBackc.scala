...
trait OmitOmitWebViewcanGoBackc extends StObject {
...
object OmitOmitWebViewcanGoBackc {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[OmitOmitWebViewcanGoBackc]
  }
  
  extension [Self <: OmitOmitWebViewcanGoBackc](x: Self) {
