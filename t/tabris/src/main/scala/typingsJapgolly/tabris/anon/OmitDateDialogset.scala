...
import typingsJapgolly.tabris.mod.DateDialog
import typingsJapgolly.tabris.mod.DateDialogCloseEvent
import typingsJapgolly.tabris.mod.DateDialogSelectEvent
...
import typingsJapgolly.tabris.tabrisStrings.date
import typingsJapgolly.tabris.tabrisStrings.jsxAttributes
import typingsJapgolly.tabris.tabrisStrings.maxDate
import typingsJapgolly.tabris.tabrisStrings.minDate
...
trait OmitDateDialogset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[
    DateDialog, 
    Omit[DateDialog, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `3`
...
object OmitDateDialogset {
  ...
  extension [Self <: OmitDateDialogset](x: Self) {
    ...
    inline def setClose(value: CallbackTo[DateDialog]): Self = StObject.set(x, "close", value.toJsFn)
    ...
    inline def setOpen(value: CallbackTo[DateDialog]): Self = StObject.set(x, "open", value.toJsFn)
