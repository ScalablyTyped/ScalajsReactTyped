...
trait OmitOmitPopovercontentVieAnchor extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[OmitPopovercontentViewAnchor, Omit[OmitPopovercontentViewAnchor, set]]
    ], 
    Any
  ]
...
object OmitOmitPopovercontentVieAnchor {
  ...
  inline def apply(
    ...
    width: Dimension
  ): OmitOmitPopovercontentVieAnchor = {
    ...
    __obj.asInstanceOf[OmitOmitPopovercontentVieAnchor]
  }
  
  extension [Self <: OmitOmitPopovercontentVieAnchor](x: Self) {
