...
trait OmitProgressBarset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[
    ProgressBar, 
    Omit[ProgressBar, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `3`
...
object OmitProgressBarset {
  ...
  extension [Self <: OmitProgressBarset](x: Self) {
    ...
    inline def setDetach(value: CallbackTo[ProgressBar]): Self = StObject.set(x, "detach", value.toJsFn)
