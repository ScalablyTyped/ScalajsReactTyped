...
trait OmitCompositeWidgetanyset[ChildType /* <: Widget[Any] */] extends StObject {
  ...
  def append(widgets: Widget[Any]*): Composite[ChildType]
  
  def appendTo(parent: typingsJapgolly.tabris.mod.Composite[Widget[Any]]): Composite[ChildType]
  @JSName("appendTo")
  ...
  def detach(): Composite[ChildType]
  @JSName("detach")
  var detach_Original: js.Function0[Composite[ChildType]]
  ...
  def insertAfter(widget: Widget[Any]): Composite[ChildType]
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], Composite[ChildType]]
  
  def insertBefore(widget: Widget[Any]): Composite[ChildType]
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], Composite[ChildType]]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[Composite[ChildType], Widget[Any]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Composite[ChildType]
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Composite[ChildType]
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[Composite[ChildType]]]
  
  var onBackgroundChanged: ChangeListeners[Composite[ChildType], background]
  
  var onBaselineChanged: ChangeListeners[Composite[ChildType], baseline]
  
  var onBottomChanged: ChangeListeners[Composite[ChildType], bottom]
  
  var onBoundsChanged: ChangeListeners[Composite[ChildType], bounds]
  
  var onCenterXChanged: ChangeListeners[Composite[ChildType], centerX]
  
  var onCenterYChanged: ChangeListeners[Composite[ChildType], centerY]
  
  var onClassChanged: ChangeListeners[Composite[ChildType], `class`]
  
  var onClassListChanged: ChangeListeners[Composite[ChildType], classList]
  
  var onCornerRadiusChanged: ChangeListeners[Composite[ChildType], cornerRadius]
  
  var onDataChanged: ChangeListeners[Composite[ChildType], data]
  
  var onDispose: Listeners[EventObject[Composite[ChildType]]]
  
  var onElevationChanged: ChangeListeners[Composite[ChildType], elevation]
  
  var onEnabledChanged: ChangeListeners[Composite[ChildType], enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[Composite[ChildType], excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[Composite[ChildType], height]
  
  var onHighlightOnTouchChanged: ChangeListeners[Composite[ChildType], highlightOnTouch]
  
  var onIdChanged: ChangeListeners[Composite[ChildType], id]
  
  var onLayoutDataChanged: ChangeListeners[Composite[ChildType], layoutData]
  
  var onLeftChanged: ChangeListeners[Composite[ChildType], left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[Composite[ChildType]]]
  
  var onOpacityChanged: ChangeListeners[Composite[ChildType], opacity]
  
  var onPan: Listeners[WidgetPanEvent[Composite[ChildType]]]
  
  var onPanDown: Listeners[WidgetPanEvent[Composite[ChildType]]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[Composite[ChildType]]]
  
  var onPanLeft: Listeners[WidgetPanEvent[Composite[ChildType]]]
  
  var onPanRight: Listeners[WidgetPanEvent[Composite[ChildType]]]
  
  var onPanUp: Listeners[WidgetPanEvent[Composite[ChildType]]]
  
  var onPanVertical: Listeners[WidgetPanEvent[Composite[ChildType]]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[Composite[ChildType]]]
  
  var onResize: Listeners[WidgetResizeEvent[Composite[ChildType]]]
  
  var onRightChanged: ChangeListeners[Composite[ChildType], right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[Composite[ChildType]]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Composite[ChildType]]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[Composite[ChildType]]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[Composite[ChildType]]]
  
  var onTap: Listeners[WidgetTapEvent[Composite[ChildType]]]
  
  var onTopChanged: ChangeListeners[Composite[ChildType], top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[Composite[ChildType]]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[Composite[ChildType]]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[Composite[ChildType]]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[Composite[ChildType]]]
  
  var onTransformChanged: ChangeListeners[Composite[ChildType], transform]
  
  var onVisibleChanged: ChangeListeners[Composite[ChildType], visible]
  
  var onWidthChanged: ChangeListeners[Composite[ChildType], width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Composite[ChildType]
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): Composite[ChildType]
  
  def triggerAsync(`type`: String): js.Promise[Composite[ChildType]]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Composite[ChildType]]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Composite[ChildType]]
...
object OmitCompositeWidgetanyset {
  ...
  inline def apply[ChildType /* <: Widget[Any] */](
    ...
    appendTo: /* parent */ typingsJapgolly.tabris.mod.Composite[Widget[Any]] => Composite[ChildType],
    ...
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[Composite[ChildType]],
    dispose: Callback,
    elevation: Double,
    enabled: Boolean,
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => Composite[ChildType],
    insertBefore: /* widget */ Widget[Any] => Composite[ChildType],
    isDisposed: CallbackTo[Boolean],
    jsxAttributes: JSXCompositeAttributes[Composite[ChildType], Widget[Any]],
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Composite[ChildType],
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Composite[ChildType],
    onAddChild: Listeners[CompositeAddChildEvent[Composite[ChildType]]],
    onBackgroundChanged: ChangeListeners[Composite[ChildType], background],
    onBaselineChanged: ChangeListeners[Composite[ChildType], baseline],
    onBottomChanged: ChangeListeners[Composite[ChildType], bottom],
    onBoundsChanged: ChangeListeners[Composite[ChildType], bounds],
    onCenterXChanged: ChangeListeners[Composite[ChildType], centerX],
    onCenterYChanged: ChangeListeners[Composite[ChildType], centerY],
    onClassChanged: ChangeListeners[Composite[ChildType], `class`],
    onClassListChanged: ChangeListeners[Composite[ChildType], classList],
    onCornerRadiusChanged: ChangeListeners[Composite[ChildType], cornerRadius],
    onDataChanged: ChangeListeners[Composite[ChildType], data],
    onDispose: Listeners[EventObject[Composite[ChildType]]],
    onElevationChanged: ChangeListeners[Composite[ChildType], elevation],
    onEnabledChanged: ChangeListeners[Composite[ChildType], enabled],
    onExcludeFromLayoutChanged: ChangeListeners[Composite[ChildType], excludeFromLayout],
    onHeightChanged: ChangeListeners[Composite[ChildType], height],
    onHighlightOnTouchChanged: ChangeListeners[Composite[ChildType], highlightOnTouch],
    onIdChanged: ChangeListeners[Composite[ChildType], id],
    onLayoutDataChanged: ChangeListeners[Composite[ChildType], layoutData],
    onLeftChanged: ChangeListeners[Composite[ChildType], left],
    onLongPress: Listeners[WidgetLongPressEvent[Composite[ChildType]]],
    onOpacityChanged: ChangeListeners[Composite[ChildType], opacity],
    onPan: Listeners[WidgetPanEvent[Composite[ChildType]]],
    onPanDown: Listeners[WidgetPanEvent[Composite[ChildType]]],
    onPanHorizontal: Listeners[WidgetPanEvent[Composite[ChildType]]],
    onPanLeft: Listeners[WidgetPanEvent[Composite[ChildType]]],
    onPanRight: Listeners[WidgetPanEvent[Composite[ChildType]]],
    onPanUp: Listeners[WidgetPanEvent[Composite[ChildType]]],
    onPanVertical: Listeners[WidgetPanEvent[Composite[ChildType]]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[Composite[ChildType]]],
    onResize: Listeners[WidgetResizeEvent[Composite[ChildType]]],
    onRightChanged: ChangeListeners[Composite[ChildType], right],
    onSwipeDown: Listeners[WidgetSwipeEvent[Composite[ChildType]]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[Composite[ChildType]]],
    onSwipeRight: Listeners[WidgetSwipeEvent[Composite[ChildType]]],
    onSwipeUp: Listeners[WidgetSwipeEvent[Composite[ChildType]]],
    onTap: Listeners[WidgetTapEvent[Composite[ChildType]]],
    onTopChanged: ChangeListeners[Composite[ChildType], top],
    onTouchCancel: Listeners[WidgetTouchEvent[Composite[ChildType]]],
    onTouchEnd: Listeners[WidgetTouchEvent[Composite[ChildType]]],
    onTouchMove: Listeners[WidgetTouchEvent[Composite[ChildType]]],
    onTouchStart: Listeners[WidgetTouchEvent[Composite[ChildType]]],
    onTransformChanged: ChangeListeners[Composite[ChildType], transform],
    onVisibleChanged: ChangeListeners[Composite[ChildType], visible],
    onWidthChanged: ChangeListeners[Composite[ChildType], width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Composite[ChildType],
    opacity: Double,
    ...
    trigger: /* type */ String => Composite[ChildType],
    triggerAsync: /* type */ String => js.Promise[Composite[ChildType]],
    visible: Boolean,
  ...
  extension [Self <: OmitCompositeWidgetanyset[?], ChildType /* <: Widget[Any] */](x: Self & OmitCompositeWidgetanyset[ChildType]) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => Composite[ChildType]): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    
    inline def setAppendTo(value: /* parent */ typingsJapgolly.tabris.mod.Composite[Widget[Any]] => Composite[ChildType]): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[Composite[ChildType]]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => Composite[ChildType]): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => Composite[ChildType]): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: CallbackTo[Boolean]): Self = StObject.set(x, "isDisposed", value.toJsFn)
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[Composite[ChildType], Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Composite[ChildType]
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Composite[ChildType]
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[Composite[ChildType]]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[Composite[ChildType], background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[Composite[ChildType], baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[Composite[ChildType], bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[Composite[ChildType], bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[Composite[ChildType], centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[Composite[ChildType], centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[Composite[ChildType], `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[Composite[ChildType], classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[Composite[ChildType], cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[Composite[ChildType], data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[Composite[ChildType]]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[Composite[ChildType], elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[Composite[ChildType], enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[Composite[ChildType], excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[Composite[ChildType], height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[Composite[ChildType], highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[Composite[ChildType], id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[Composite[ChildType], layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[Composite[ChildType], left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[Composite[ChildType]]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[Composite[ChildType], opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[Composite[ChildType]]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[Composite[ChildType]]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[Composite[ChildType], right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[Composite[ChildType]]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[Composite[ChildType], top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[Composite[ChildType]]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[Composite[ChildType], transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[Composite[ChildType], visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[Composite[ChildType], width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => Composite[ChildType]): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[Composite[ChildType]]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
