...
trait OmitImageViewset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[
    ImageView, 
    Omit[ImageView, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `3`
...
object OmitImageViewset {
  ...
  extension [Self <: OmitImageViewset](x: Self) {
    ...
    inline def setDetach(value: CallbackTo[ImageView]): Self = StObject.set(x, "detach", value.toJsFn)
