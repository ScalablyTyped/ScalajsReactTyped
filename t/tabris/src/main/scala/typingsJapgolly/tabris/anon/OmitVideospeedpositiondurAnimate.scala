...
trait OmitVideospeedpositiondurAnimate extends StObject {
  ...
  var set_Original: js.Function1[
    /* properties */ Properties[
      typingsJapgolly.tabris.global.tabris.widgets.Video, 
      Omit[typingsJapgolly.tabris.global.tabris.widgets.Video, set]
    ], 
    typingsJapgolly.tabris.global.tabris.widgets.Video
  ]
  @JSName("set")
  def set_set[T /* <: NativeObject */](properties: Properties[T, Omit[T, set]]): typingsJapgolly.tabris.global.tabris.widgets.Video
