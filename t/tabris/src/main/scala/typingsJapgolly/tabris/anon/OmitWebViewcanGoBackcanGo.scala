...
trait OmitWebViewcanGoBackcanGo extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[Properties[Omit[WebView, canGoBack | canGoForward], OmitOmitWebViewcanGoBackc]], 
    Any
  ]
  ...
  var jsxAttributes: (JSXAttributes[WebView, Omit[WebView, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]]) & js.Object
  ...
  @JSName("set")
  var set_Original: js.Function1[/* properties */ Properties[WebView, Omit[WebView, set]], WebView]
  @JSName("set")
  def set_set[T /* <: NativeObject */](properties: Properties[T, Omit[T, set]]): WebView
...
object OmitWebViewcanGoBackcanGo {
  ...
  inline def apply(
    ...
    constructor: /* properties */ js.UndefOr[Properties[Omit[WebView, canGoBack | canGoForward], OmitOmitWebViewcanGoBackc]] => Any,
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[WebView],
    dispose: Callback,
    elevation: Double,
    enabled: Boolean,
    ...
    set: /* properties */ Properties[WebView, Omit[WebView, set]] => WebView,
    ...
    __obj.asInstanceOf[OmitWebViewcanGoBackcanGo]
  }
  
  extension [Self <: OmitWebViewcanGoBackcanGo](x: Self) {
    ...
    inline def setConstructor(
      value: /* properties */ js.UndefOr[Properties[Omit[WebView, canGoBack | canGoForward], OmitOmitWebViewcanGoBackc]] => Any
    ...
    inline def setDetach(value: CallbackTo[WebView]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setSet(value: /* properties */ Properties[WebView, Omit[WebView, set]] => WebView): Self = StObject.set(x, "set", js.Any.fromFunction1(value))
