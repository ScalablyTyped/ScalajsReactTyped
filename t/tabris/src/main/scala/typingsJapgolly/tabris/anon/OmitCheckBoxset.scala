...
trait OmitCheckBoxset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[CheckBox, Omit[CheckBox, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]]) & `3`
...
object OmitCheckBoxset {
  ...
  extension [Self <: OmitCheckBoxset](x: Self) {
    ...
    inline def setDetach(value: CallbackTo[CheckBox]): Self = StObject.set(x, "detach", value.toJsFn)
