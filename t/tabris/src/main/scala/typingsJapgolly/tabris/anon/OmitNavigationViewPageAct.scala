...
object OmitNavigationViewPageAct {
  ...
  inline def apply[PageType /* <: Page */, ActionType /* <: Action */](
    ...
    cornerRadius: Double,
    data: Any,
    detach: CallbackTo[NavigationView[PageType, ActionType]],
    dispose: Callback,
  ...
  extension [Self <: OmitNavigationViewPageAct[?, ?], PageType /* <: Page */, ActionType /* <: Action */](x: Self & (OmitNavigationViewPageAct[PageType, ActionType])) {
    ...
    inline def setDetach(value: CallbackTo[NavigationView[PageType, ActionType]]): Self = StObject.set(x, "detach", value.toJsFn)
