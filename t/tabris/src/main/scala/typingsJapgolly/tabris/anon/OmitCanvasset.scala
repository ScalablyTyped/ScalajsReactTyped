...
trait OmitCanvasset extends StObject {
  ...
  def append(widgets: Widget[Any]*): Canvas
  
  def appendTo(parent: Composite[Widget[Any]]): Canvas
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ Composite[Widget[Any]], Canvas]
  ...
  def detach(): Canvas
  @JSName("detach")
  var detach_Original: js.Function0[Canvas]
  ...
  def insertAfter(widget: Widget[Any]): Canvas
  @JSName("insertAfter")
  var insertAfter_Original: js.Function1[/* widget */ Widget[Any], Canvas]
  
  def insertBefore(widget: Widget[Any]): Canvas
  @JSName("insertBefore")
  var insertBefore_Original: js.Function1[/* widget */ Widget[Any], Canvas]
  
  def isDisposed(): Boolean
  @JSName("isDisposed")
  var isDisposed_Original: js.Function0[Boolean]
  
  var jsxAttributes: JSXCompositeAttributes[Canvas, Widget[Any]]
  ...
  def off(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Unit]): Canvas
  def off(
    `type`: String,
  ...
  def on(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Canvas
  def on(
    `type`: String,
  ...
  var onAddChild: Listeners[CompositeAddChildEvent[Canvas]]
  
  var onBackgroundChanged: ChangeListeners[Canvas, background]
  
  var onBaselineChanged: ChangeListeners[Canvas, baseline]
  
  var onBottomChanged: ChangeListeners[Canvas, bottom]
  
  var onBoundsChanged: ChangeListeners[Canvas, bounds]
  
  var onCenterXChanged: ChangeListeners[Canvas, centerX]
  
  var onCenterYChanged: ChangeListeners[Canvas, centerY]
  
  var onClassChanged: ChangeListeners[Canvas, `class`]
  
  var onClassListChanged: ChangeListeners[Canvas, classList]
  
  var onCornerRadiusChanged: ChangeListeners[Canvas, cornerRadius]
  
  var onDataChanged: ChangeListeners[Canvas, data]
  
  var onDispose: Listeners[EventObject[Canvas]]
  
  var onElevationChanged: ChangeListeners[Canvas, elevation]
  
  var onEnabledChanged: ChangeListeners[Canvas, enabled]
  
  var onExcludeFromLayoutChanged: ChangeListeners[Canvas, excludeFromLayout]
  
  var onHeightChanged: ChangeListeners[Canvas, height]
  
  var onHighlightOnTouchChanged: ChangeListeners[Canvas, highlightOnTouch]
  
  var onIdChanged: ChangeListeners[Canvas, id]
  
  var onLayoutDataChanged: ChangeListeners[Canvas, layoutData]
  
  var onLeftChanged: ChangeListeners[Canvas, left]
  
  var onLongPress: Listeners[WidgetLongPressEvent[Canvas]]
  
  var onOpacityChanged: ChangeListeners[Canvas, opacity]
  
  var onPan: Listeners[WidgetPanEvent[Canvas]]
  
  var onPanDown: Listeners[WidgetPanEvent[Canvas]]
  
  var onPanHorizontal: Listeners[WidgetPanEvent[Canvas]]
  
  var onPanLeft: Listeners[WidgetPanEvent[Canvas]]
  
  var onPanRight: Listeners[WidgetPanEvent[Canvas]]
  
  var onPanUp: Listeners[WidgetPanEvent[Canvas]]
  
  var onPanVertical: Listeners[WidgetPanEvent[Canvas]]
  
  var onRemoveChild: Listeners[CompositeRemoveChildEvent[Canvas]]
  
  var onResize: Listeners[WidgetResizeEvent[Canvas]]
  
  var onRightChanged: ChangeListeners[Canvas, right]
  
  var onSwipeDown: Listeners[WidgetSwipeEvent[Canvas]]
  
  var onSwipeLeft: Listeners[WidgetSwipeEvent[Canvas]]
  
  var onSwipeRight: Listeners[WidgetSwipeEvent[Canvas]]
  
  var onSwipeUp: Listeners[WidgetSwipeEvent[Canvas]]
  
  var onTap: Listeners[WidgetTapEvent[Canvas]]
  
  var onTopChanged: ChangeListeners[Canvas, top]
  
  var onTouchCancel: Listeners[WidgetTouchEvent[Canvas]]
  
  var onTouchEnd: Listeners[WidgetTouchEvent[Canvas]]
  
  var onTouchMove: Listeners[WidgetTouchEvent[Canvas]]
  
  var onTouchStart: Listeners[WidgetTouchEvent[Canvas]]
  
  var onTransformChanged: ChangeListeners[Canvas, transform]
  
  var onVisibleChanged: ChangeListeners[Canvas, visible]
  
  var onWidthChanged: ChangeListeners[Canvas, width]
  ...
  def once(`type`: String, listener: js.Function1[/* event */ EventObject[NativeObject], Any]): Canvas
  def once(
    `type`: String,
    listener: js.Function1[/* event */ EventObject[NativeObject], Any],
    context: js.Object
  ...
  def trigger(`type`: String): Canvas
  
  def triggerAsync(`type`: String): js.Promise[Canvas]
  @JSName("triggerAsync")
  var triggerAsync_Original: js.Function1[/* type */ String, js.Promise[Canvas]]
  
  @JSName("trigger")
  var trigger_Original: js.Function1[/* type */ String, Canvas]
  
  var visible: Boolean
  
  var width: Dimension | auto
}
object OmitCanvasset {
  ...
  inline def apply(
    ...
    id: String,
    insertAfter: /* widget */ Widget[Any] => Canvas,
    insertBefore: /* widget */ Widget[Any] => Canvas,
    isDisposed: CallbackTo[Boolean],
    jsxAttributes: JSXCompositeAttributes[Canvas, Widget[Any]],
    layoutData: LayoutDataValue,
    left: ConstraintValue,
    off: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Canvas,
    on: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Canvas,
    onAddChild: Listeners[CompositeAddChildEvent[Canvas]],
    onBackgroundChanged: ChangeListeners[Canvas, background],
    onBaselineChanged: ChangeListeners[Canvas, baseline],
    onBottomChanged: ChangeListeners[Canvas, bottom],
    onBoundsChanged: ChangeListeners[Canvas, bounds],
    onCenterXChanged: ChangeListeners[Canvas, centerX],
    onCenterYChanged: ChangeListeners[Canvas, centerY],
    onClassChanged: ChangeListeners[Canvas, `class`],
    onClassListChanged: ChangeListeners[Canvas, classList],
    onCornerRadiusChanged: ChangeListeners[Canvas, cornerRadius],
    onDataChanged: ChangeListeners[Canvas, data],
    onDispose: Listeners[EventObject[Canvas]],
    onElevationChanged: ChangeListeners[Canvas, elevation],
    onEnabledChanged: ChangeListeners[Canvas, enabled],
    onExcludeFromLayoutChanged: ChangeListeners[Canvas, excludeFromLayout],
    onHeightChanged: ChangeListeners[Canvas, height],
    onHighlightOnTouchChanged: ChangeListeners[Canvas, highlightOnTouch],
    onIdChanged: ChangeListeners[Canvas, id],
    onLayoutDataChanged: ChangeListeners[Canvas, layoutData],
    onLeftChanged: ChangeListeners[Canvas, left],
    onLongPress: Listeners[WidgetLongPressEvent[Canvas]],
    onOpacityChanged: ChangeListeners[Canvas, opacity],
    onPan: Listeners[WidgetPanEvent[Canvas]],
    onPanDown: Listeners[WidgetPanEvent[Canvas]],
    onPanHorizontal: Listeners[WidgetPanEvent[Canvas]],
    onPanLeft: Listeners[WidgetPanEvent[Canvas]],
    onPanRight: Listeners[WidgetPanEvent[Canvas]],
    onPanUp: Listeners[WidgetPanEvent[Canvas]],
    onPanVertical: Listeners[WidgetPanEvent[Canvas]],
    onRemoveChild: Listeners[CompositeRemoveChildEvent[Canvas]],
    onResize: Listeners[WidgetResizeEvent[Canvas]],
    onRightChanged: ChangeListeners[Canvas, right],
    onSwipeDown: Listeners[WidgetSwipeEvent[Canvas]],
    onSwipeLeft: Listeners[WidgetSwipeEvent[Canvas]],
    onSwipeRight: Listeners[WidgetSwipeEvent[Canvas]],
    onSwipeUp: Listeners[WidgetSwipeEvent[Canvas]],
    onTap: Listeners[WidgetTapEvent[Canvas]],
    onTopChanged: ChangeListeners[Canvas, top],
    onTouchCancel: Listeners[WidgetTouchEvent[Canvas]],
    onTouchEnd: Listeners[WidgetTouchEvent[Canvas]],
    onTouchMove: Listeners[WidgetTouchEvent[Canvas]],
    onTouchStart: Listeners[WidgetTouchEvent[Canvas]],
    onTransformChanged: ChangeListeners[Canvas, transform],
    onVisibleChanged: ChangeListeners[Canvas, visible],
    onWidthChanged: ChangeListeners[Canvas, width],
    once: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Canvas,
    opacity: Double,
    ...
    trigger: /* type */ String => Canvas,
    triggerAsync: /* type */ String => js.Promise[Canvas],
    visible: Boolean,
  ...
  extension [Self <: OmitCanvasset](x: Self) {
    ...
    inline def setAppend(value: /* repeated */ Widget[Any] => Canvas): Self = StObject.set(x, "append", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[Canvas]): Self = StObject.set(x, "detach", value.toJsFn)
    ...
    inline def setInsertAfter(value: /* widget */ Widget[Any] => Canvas): Self = StObject.set(x, "insertAfter", js.Any.fromFunction1(value))
    
    inline def setInsertBefore(value: /* widget */ Widget[Any] => Canvas): Self = StObject.set(x, "insertBefore", js.Any.fromFunction1(value))
    
    inline def setIsDisposed(value: CallbackTo[Boolean]): Self = StObject.set(x, "isDisposed", value.toJsFn)
    
    inline def setJsxAttributes(value: JSXCompositeAttributes[Canvas, Widget[Any]]): Self = StObject.set(x, "jsxAttributes", value.asInstanceOf[js.Any])
    ...
    inline def setOff(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Unit], /* context */ js.UndefOr[js.Object]) => Canvas
    ): Self = StObject.set(x, "off", js.Any.fromFunction3(value))
    
    inline def setOn(
      value: (/* type */ String, /* listener */ js.Function1[/* event */ EventObject[NativeObject], Any], /* context */ js.UndefOr[js.Object]) => Canvas
    ): Self = StObject.set(x, "on", js.Any.fromFunction3(value))
    
    inline def setOnAddChild(value: Listeners[CompositeAddChildEvent[Canvas]]): Self = StObject.set(x, "onAddChild", value.asInstanceOf[js.Any])
    
    inline def setOnBackgroundChanged(value: ChangeListeners[Canvas, background]): Self = StObject.set(x, "onBackgroundChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBaselineChanged(value: ChangeListeners[Canvas, baseline]): Self = StObject.set(x, "onBaselineChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBottomChanged(value: ChangeListeners[Canvas, bottom]): Self = StObject.set(x, "onBottomChanged", value.asInstanceOf[js.Any])
    
    inline def setOnBoundsChanged(value: ChangeListeners[Canvas, bounds]): Self = StObject.set(x, "onBoundsChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterXChanged(value: ChangeListeners[Canvas, centerX]): Self = StObject.set(x, "onCenterXChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCenterYChanged(value: ChangeListeners[Canvas, centerY]): Self = StObject.set(x, "onCenterYChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassChanged(value: ChangeListeners[Canvas, `class`]): Self = StObject.set(x, "onClassChanged", value.asInstanceOf[js.Any])
    
    inline def setOnClassListChanged(value: ChangeListeners[Canvas, classList]): Self = StObject.set(x, "onClassListChanged", value.asInstanceOf[js.Any])
    
    inline def setOnCornerRadiusChanged(value: ChangeListeners[Canvas, cornerRadius]): Self = StObject.set(x, "onCornerRadiusChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDataChanged(value: ChangeListeners[Canvas, data]): Self = StObject.set(x, "onDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnDispose(value: Listeners[EventObject[Canvas]]): Self = StObject.set(x, "onDispose", value.asInstanceOf[js.Any])
    
    inline def setOnElevationChanged(value: ChangeListeners[Canvas, elevation]): Self = StObject.set(x, "onElevationChanged", value.asInstanceOf[js.Any])
    
    inline def setOnEnabledChanged(value: ChangeListeners[Canvas, enabled]): Self = StObject.set(x, "onEnabledChanged", value.asInstanceOf[js.Any])
    
    inline def setOnExcludeFromLayoutChanged(value: ChangeListeners[Canvas, excludeFromLayout]): Self = StObject.set(x, "onExcludeFromLayoutChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHeightChanged(value: ChangeListeners[Canvas, height]): Self = StObject.set(x, "onHeightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnHighlightOnTouchChanged(value: ChangeListeners[Canvas, highlightOnTouch]): Self = StObject.set(x, "onHighlightOnTouchChanged", value.asInstanceOf[js.Any])
    
    inline def setOnIdChanged(value: ChangeListeners[Canvas, id]): Self = StObject.set(x, "onIdChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLayoutDataChanged(value: ChangeListeners[Canvas, layoutData]): Self = StObject.set(x, "onLayoutDataChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLeftChanged(value: ChangeListeners[Canvas, left]): Self = StObject.set(x, "onLeftChanged", value.asInstanceOf[js.Any])
    
    inline def setOnLongPress(value: Listeners[WidgetLongPressEvent[Canvas]]): Self = StObject.set(x, "onLongPress", value.asInstanceOf[js.Any])
    
    inline def setOnOpacityChanged(value: ChangeListeners[Canvas, opacity]): Self = StObject.set(x, "onOpacityChanged", value.asInstanceOf[js.Any])
    
    inline def setOnPan(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPan", value.asInstanceOf[js.Any])
    
    inline def setOnPanDown(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanDown", value.asInstanceOf[js.Any])
    
    inline def setOnPanHorizontal(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanHorizontal", value.asInstanceOf[js.Any])
    
    inline def setOnPanLeft(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanLeft", value.asInstanceOf[js.Any])
    
    inline def setOnPanRight(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanRight", value.asInstanceOf[js.Any])
    
    inline def setOnPanUp(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanUp", value.asInstanceOf[js.Any])
    
    inline def setOnPanVertical(value: Listeners[WidgetPanEvent[Canvas]]): Self = StObject.set(x, "onPanVertical", value.asInstanceOf[js.Any])
    
    inline def setOnRemoveChild(value: Listeners[CompositeRemoveChildEvent[Canvas]]): Self = StObject.set(x, "onRemoveChild", value.asInstanceOf[js.Any])
    
    inline def setOnResize(value: Listeners[WidgetResizeEvent[Canvas]]): Self = StObject.set(x, "onResize", value.asInstanceOf[js.Any])
    
    inline def setOnRightChanged(value: ChangeListeners[Canvas, right]): Self = StObject.set(x, "onRightChanged", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeDown(value: Listeners[WidgetSwipeEvent[Canvas]]): Self = StObject.set(x, "onSwipeDown", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeLeft(value: Listeners[WidgetSwipeEvent[Canvas]]): Self = StObject.set(x, "onSwipeLeft", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeRight(value: Listeners[WidgetSwipeEvent[Canvas]]): Self = StObject.set(x, "onSwipeRight", value.asInstanceOf[js.Any])
    
    inline def setOnSwipeUp(value: Listeners[WidgetSwipeEvent[Canvas]]): Self = StObject.set(x, "onSwipeUp", value.asInstanceOf[js.Any])
    
    inline def setOnTap(value: Listeners[WidgetTapEvent[Canvas]]): Self = StObject.set(x, "onTap", value.asInstanceOf[js.Any])
    
    inline def setOnTopChanged(value: ChangeListeners[Canvas, top]): Self = StObject.set(x, "onTopChanged", value.asInstanceOf[js.Any])
    
    inline def setOnTouchCancel(value: Listeners[WidgetTouchEvent[Canvas]]): Self = StObject.set(x, "onTouchCancel", value.asInstanceOf[js.Any])
    
    inline def setOnTouchEnd(value: Listeners[WidgetTouchEvent[Canvas]]): Self = StObject.set(x, "onTouchEnd", value.asInstanceOf[js.Any])
    
    inline def setOnTouchMove(value: Listeners[WidgetTouchEvent[Canvas]]): Self = StObject.set(x, "onTouchMove", value.asInstanceOf[js.Any])
    
    inline def setOnTouchStart(value: Listeners[WidgetTouchEvent[Canvas]]): Self = StObject.set(x, "onTouchStart", value.asInstanceOf[js.Any])
    
    inline def setOnTransformChanged(value: ChangeListeners[Canvas, transform]): Self = StObject.set(x, "onTransformChanged", value.asInstanceOf[js.Any])
    
    inline def setOnVisibleChanged(value: ChangeListeners[Canvas, visible]): Self = StObject.set(x, "onVisibleChanged", value.asInstanceOf[js.Any])
    
    inline def setOnWidthChanged(value: ChangeListeners[Canvas, width]): Self = StObject.set(x, "onWidthChanged", value.asInstanceOf[js.Any])
    ...
    inline def setTrigger(value: /* type */ String => Canvas): Self = StObject.set(x, "trigger", js.Any.fromFunction1(value))
    
    inline def setTriggerAsync(value: /* type */ String => js.Promise[Canvas]): Self = StObject.set(x, "triggerAsync", js.Any.fromFunction1(value))
