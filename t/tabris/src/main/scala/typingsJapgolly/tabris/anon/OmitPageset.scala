...
trait OmitPageset extends StObject {
  ...
  def appendTo(parent: NavigationView[typingsJapgolly.tabris.mod.Page, Action]): Page
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ NavigationView[typingsJapgolly.tabris.mod.Page, Action], Page]
...
object OmitPageset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ NavigationView[typingsJapgolly.tabris.mod.Page, Action] => Page,
  ...
  extension [Self <: OmitPageset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ NavigationView[typingsJapgolly.tabris.mod.Page, Action] => Page): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[Page]): Self = StObject.set(x, "detach", value.toJsFn)
