...
trait OmitActionSheetset extends StObject {
  ...
  var jsxAttributes: (JSXAttributes[
    ActionSheet, 
    Omit[ActionSheet, set | typingsJapgolly.tabris.tabrisStrings.jsxAttributes]
  ]) & `1`
...
object OmitActionSheetset {
  ...
  extension [Self <: OmitActionSheetset](x: Self) {
    ...
    inline def setClose(value: CallbackTo[ActionSheet]): Self = StObject.set(x, "close", value.toJsFn)
    ...
    inline def setOpen(value: CallbackTo[ActionSheet]): Self = StObject.set(x, "open", value.toJsFn)
