...
trait OmitTabset extends StObject {
  ...
  def appendTo(parent: TabFolder[typingsJapgolly.tabris.mod.Tab]): Tab
  @JSName("appendTo")
  var appendTo_Original: js.Function1[/* parent */ TabFolder[typingsJapgolly.tabris.mod.Tab], Tab]
...
object OmitTabset {
  ...
  inline def apply(
    ...
    appendTo: /* parent */ TabFolder[typingsJapgolly.tabris.mod.Tab] => Tab,
  ...
  extension [Self <: OmitTabset](x: Self) {
    ...
    inline def setAppendTo(value: /* parent */ TabFolder[typingsJapgolly.tabris.mod.Tab] => Tab): Self = StObject.set(x, "appendTo", js.Any.fromFunction1(value))
    ...
    inline def setDetach(value: CallbackTo[Tab]): Self = StObject.set(x, "detach", value.toJsFn)
