...
trait OmitVideospeedpositiondur extends StObject {
  ...
  var constructor_Original: js.Function1[
    /* properties */ js.UndefOr[
      Properties[Omit[Video, speed | position | duration | state], OmitOmitVideospeedpositio]
    ], 
    Any
  ]
  ...
  @JSName("set")
  var set_Original: js.Function1[/* properties */ Properties[Video, Omit[Video, set]], Video]
  @JSName("set")
  def set_set[T /* <: NativeObject */](properties: Properties[T, Omit[T, set]]): Video
...
object OmitVideospeedpositiondur {
  ...
  inline def apply(
    ...
    set: /* properties */ Properties[Video, Omit[Video, set]] => Video,
  ...
  extension [Self <: OmitVideospeedpositiondur](x: Self) {
    ...
    inline def setSet(value: /* properties */ Properties[Video, Omit[Video, set]] => Video): Self = StObject.set(x, "set", js.Any.fromFunction1(value))
