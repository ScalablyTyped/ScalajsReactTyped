...
import typingsJapgolly.tabris.tabrisStrings.`SHA-1`
import typingsJapgolly.tabris.tabrisStrings.`SHA-256`
import typingsJapgolly.tabris.tabrisStrings.`SHA-384`
import typingsJapgolly.tabris.tabrisStrings.`SHA-512`
