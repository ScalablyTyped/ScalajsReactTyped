...
import typingsJapgolly.tabris.mod.LayoutDataProperties
...
open class LayoutData protected ()
  extends typingsJapgolly.tabris.mod.LayoutData {
  /**
...
object LayoutData {
  ...
  @js.native
  val center: typingsJapgolly.tabris.mod.LayoutData = js.native
  ...
  /**
    ...
    */
  inline def from(layoutDataValue: LayoutDataValue): typingsJapgolly.tabris.mod.LayoutData = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(layoutDataValue.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.tabris.mod.LayoutData]
  ...
  @js.native
  val stretch: typingsJapgolly.tabris.mod.LayoutData = js.native
  ...
  @js.native
  val stretchX: typingsJapgolly.tabris.mod.LayoutData = js.native
  ...
  @js.native
  val stretchY: typingsJapgolly.tabris.mod.LayoutData = js.native
}
