...
// fetch
inline def fetch(url: String): js.Promise[typingsJapgolly.tabris.Response] = js.Dynamic.global.applyDynamic("fetch")(url.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.tabris.Response]]
inline def fetch(url: String, init: RequestInit): js.Promise[typingsJapgolly.tabris.Response] = (js.Dynamic.global.applyDynamic("fetch")(url.asInstanceOf[js.Any], init.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.tabris.Response]]
inline def fetch(url: typingsJapgolly.tabris.Request): js.Promise[typingsJapgolly.tabris.Response] = js.Dynamic.global.applyDynamic("fetch")(url.asInstanceOf[js.Any]).asInstanceOf[js.Promise[typingsJapgolly.tabris.Response]]
inline def fetch(url: typingsJapgolly.tabris.Request, init: RequestInit): js.Promise[typingsJapgolly.tabris.Response] = (js.Dynamic.global.applyDynamic("fetch")(url.asInstanceOf[js.Any], init.asInstanceOf[js.Any])).asInstanceOf[js.Promise[typingsJapgolly.tabris.Response]]
...
inline def localStorage: typingsJapgolly.tabris.Storage = js.Dynamic.global.selectDynamic("localStorage").asInstanceOf[typingsJapgolly.tabris.Storage]
inline def localStorage_=(x: typingsJapgolly.tabris.Storage): Unit = js.Dynamic.global.updateDynamic("localStorage")(x.asInstanceOf[js.Any])
...
inline def secureStorage: typingsJapgolly.tabris.Storage = js.Dynamic.global.selectDynamic("secureStorage").asInstanceOf[typingsJapgolly.tabris.Storage]
inline def secureStorage_=(x: typingsJapgolly.tabris.Storage): Unit = js.Dynamic.global.updateDynamic("secureStorage")(x.asInstanceOf[js.Any])
