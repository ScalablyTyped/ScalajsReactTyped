...
open class Response ()
  extends StObject
     with typingsJapgolly.tabris.Response {
  def this(body: String) = this()
  def this(body: typingsJapgolly.tabris.Blob) = this()
  def this(body: typingsJapgolly.tabris.FormData) = this()
  def this(body: String, init: ResponseInit) = this()
  def this(body: Unit, init: ResponseInit) = this()
  def this(body: typingsJapgolly.tabris.Blob, init: ResponseInit) = this()
  def this(body: typingsJapgolly.tabris.FormData, init: ResponseInit) = this()
}
object Response {
