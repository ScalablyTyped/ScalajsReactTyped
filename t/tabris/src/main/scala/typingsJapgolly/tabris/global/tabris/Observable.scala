...
import typingsJapgolly.tabris.mod.SubscriptionHandler
...
open class Observable[T] protected ()
  extends typingsJapgolly.tabris.mod.Observable[T] {
  /**
...
object Observable {
  ...
  /**
    ...
    * @param source
    */
  inline def mutations[T /* <: js.Object */](source: T): typingsJapgolly.tabris.mod.Observable[T] = ^.asInstanceOf[js.Dynamic].applyDynamic("mutations")(source.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.tabris.mod.Observable[T]]
}
