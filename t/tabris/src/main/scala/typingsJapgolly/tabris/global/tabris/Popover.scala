...
import typingsJapgolly.tabris.anon.OmitOmitPopovercontentVieCid
import typingsJapgolly.tabris.anon.OmitPopovercontentViewCheckDisposed
...
/**
  ...
  */
open class Popover ()
  extends typingsJapgolly.tabris.mod.Popover {
...
object Popover {
  ...
  /**
    ...
    */
  inline def open(popover: typingsJapgolly.tabris.mod.Popover): typingsJapgolly.tabris.mod.Popover = ^.asInstanceOf[js.Dynamic].applyDynamic("open")(popover.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.tabris.mod.Popover]
}
