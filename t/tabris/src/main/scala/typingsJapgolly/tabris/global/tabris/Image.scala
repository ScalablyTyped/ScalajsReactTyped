...
import typingsJapgolly.tabris.mod.ImageLikeObject
...
open class Image protected ()
  extends typingsJapgolly.tabris.mod.Image {
  /**
...
object Image {
  ...
  /**
    ...
    */
  inline def from(imageValue: ImageValue): typingsJapgolly.tabris.mod.Image = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(imageValue.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.tabris.mod.Image]
