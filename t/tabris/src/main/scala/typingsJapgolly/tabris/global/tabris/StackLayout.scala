...
open class StackLayout ()
  extends typingsJapgolly.tabris.mod.StackLayout {
...
object StackLayout {
  ...
  @js.native
  def default: typingsJapgolly.tabris.mod.StackLayout = js.native
  inline def default_=(x: typingsJapgolly.tabris.mod.StackLayout): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("default")(x.asInstanceOf[js.Any])
}
