...
open class ConstraintLayout ()
  extends typingsJapgolly.tabris.mod.ConstraintLayout {
...
object ConstraintLayout {
  ...
  @js.native
  def default: typingsJapgolly.tabris.mod.ConstraintLayout = js.native
  inline def default_=(x: typingsJapgolly.tabris.mod.ConstraintLayout): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("default")(x.asInstanceOf[js.Any])
}
