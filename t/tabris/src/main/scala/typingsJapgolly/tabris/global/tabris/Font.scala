...
open class Font protected ()
  extends typingsJapgolly.tabris.mod.Font {
  /**
...
object Font {
  ...
  /**
    ...
    */
  inline def from(fontValue: FontValue): typingsJapgolly.tabris.mod.Font = ^.asInstanceOf[js.Dynamic].applyDynamic("from")(fontValue.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.tabris.mod.Font]
