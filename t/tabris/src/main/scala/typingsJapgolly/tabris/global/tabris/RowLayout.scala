...
open class RowLayout ()
  extends typingsJapgolly.tabris.mod.RowLayout {
...
object RowLayout {
  ...
  @js.native
  def default: typingsJapgolly.tabris.mod.RowLayout = js.native
  inline def default_=(x: typingsJapgolly.tabris.mod.RowLayout): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("default")(x.asInstanceOf[js.Any])
}
