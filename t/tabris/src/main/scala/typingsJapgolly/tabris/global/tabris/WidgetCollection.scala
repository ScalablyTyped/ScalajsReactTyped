...
/**
  ...
  */
open class WidgetCollection[WidgetType /* <: typingsJapgolly.tabris.mod.Widget[Any] */] ()
  extends typingsJapgolly.tabris.mod.WidgetCollection[WidgetType] {
  def this(widgets: js.Array[typingsJapgolly.tabris.mod.Widget[Any]]) = this()
}
