...
import typingsJapgolly.tabris.anon.Cancel
import typingsJapgolly.tabris.anon.OmitAlertDialogtextInputs
import typingsJapgolly.tabris.anon.OmitOmitAlertDialogtextInButtons
import typingsJapgolly.tabris.anon.TextInputs
...
open class AlertDialog () extends Popup {
  ...
  /**
    ...
    * @constant
    */
  val textInputs: ContentView_[typingsJapgolly.tabris.mod.TextInput] = js.native
