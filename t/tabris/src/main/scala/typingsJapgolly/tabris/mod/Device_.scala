...
import typingsJapgolly.tabris.tabrisStrings.Android
import typingsJapgolly.tabris.tabrisStrings.`landscape-primary`
import typingsJapgolly.tabris.tabrisStrings.`landscape-secondary`
import typingsJapgolly.tabris.tabrisStrings.`portrait-primary`
import typingsJapgolly.tabris.tabrisStrings.`portrait-secondary`
import typingsJapgolly.tabris.tabrisStrings.iOS
...
/* private */ open class Device_ () extends NativeObject {
  ...
  /**
    ...
    */
  var onOrientationChanged: ChangeListeners[this.type, typingsJapgolly.tabris.tabrisStrings.orientation] = js.native
