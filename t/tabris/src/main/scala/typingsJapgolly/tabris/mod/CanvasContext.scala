...
import typingsJapgolly.tabris.tabrisStrings.alphabetic
import typingsJapgolly.tabris.tabrisStrings.bevel
import typingsJapgolly.tabris.tabrisStrings.bottom
import typingsJapgolly.tabris.tabrisStrings.butt
import typingsJapgolly.tabris.tabrisStrings.center
import typingsJapgolly.tabris.tabrisStrings.end
import typingsJapgolly.tabris.tabrisStrings.hanging
import typingsJapgolly.tabris.tabrisStrings.ideographic
import typingsJapgolly.tabris.tabrisStrings.left
import typingsJapgolly.tabris.tabrisStrings.middle
import typingsJapgolly.tabris.tabrisStrings.miter
import typingsJapgolly.tabris.tabrisStrings.right
import typingsJapgolly.tabris.tabrisStrings.round
import typingsJapgolly.tabris.tabrisStrings.square
...
/* private */ open class CanvasContext () extends StObject {
  ...
  /**
    ...
    */
  def createImageData(imageData: typingsJapgolly.tabris.ImageData): typingsJapgolly.tabris.ImageData = js.native
  /**
    ...
    */
  def createImageData(width: Double, height: Double): typingsJapgolly.tabris.ImageData = js.native
  ...
  /**
    ...
    */
  def getImageData(x: Double, y: Double, width: Double, height: Double): typingsJapgolly.tabris.ImageData = js.native
  ...
  /**
    ...
    */
  def putImageData(imageData: typingsJapgolly.tabris.ImageData, x: Double, y: Double): Unit = js.native
