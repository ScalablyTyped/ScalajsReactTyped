...
import typingsJapgolly.tabris.anon.OmitActionSheetset
import typingsJapgolly.tabris.anon.`1`
...
open class ActionSheet () extends Popup {
  ...
  /**
    ...
    */
  var actions: js.Array[typingsJapgolly.tabris.anon.Image] = js.native
  
  /**
    * @constant
    */
  @JSName("jsxAttributes")
  val jsxAttributes_ActionSheet: (JSXAttributes[
    this.type, 
