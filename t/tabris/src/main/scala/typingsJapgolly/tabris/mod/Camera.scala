...
import typingsJapgolly.tabris.anon.Flash
import typingsJapgolly.tabris.anon.Height
import typingsJapgolly.tabris.anon.Width
import typingsJapgolly.tabris.tabrisStrings.active
import typingsJapgolly.tabris.tabrisStrings.back
import typingsJapgolly.tabris.tabrisStrings.captureResolution
import typingsJapgolly.tabris.tabrisStrings.external
import typingsJapgolly.tabris.tabrisStrings.front
...
/* private */ open class Camera () extends NativeObject {
  ...
  /**
    ...
    */
  var onAvailableCaptureResolutionsChanged: ChangeListeners[this.type, typingsJapgolly.tabris.tabrisStrings.availableCaptureResolutions] = js.native
