...
import typingsJapgolly.tabris.File
import typingsJapgolly.tabris.anon.Quantity
...
/* private */ open class FileSystem () extends NativeObject {
  ...
  /**
    ...
    */
  def openFile(): js.Promise[js.Array[File]] = js.native
  def openFile(options: Quantity): js.Promise[js.Array[File]] = js.native
