...
import typingsJapgolly.tabris.anon.Files
import typingsJapgolly.tabris.tabrisStrings.idleTimeoutEnabled
import typingsJapgolly.tabris.tabrisStrings.pinnedCertificates
import typingsJapgolly.tabris.tabrisStrings.trustedCertificates
