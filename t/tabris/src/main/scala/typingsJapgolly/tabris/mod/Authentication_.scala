...
import typingsJapgolly.tabris.anon.AllowCredentials
import typingsJapgolly.tabris.anon.Message
import typingsJapgolly.tabris.anon.`2`
import typingsJapgolly.tabris.tabrisStrings.face
import typingsJapgolly.tabris.tabrisStrings.fingerprint
...
/* private */ open class Authentication_ () extends NativeObject {
  ...
  /**
    ...
    */
  var onAvailableBiometricsChanged: ChangeListeners[this.type, typingsJapgolly.tabris.tabrisStrings.availableBiometrics] = js.native
}
