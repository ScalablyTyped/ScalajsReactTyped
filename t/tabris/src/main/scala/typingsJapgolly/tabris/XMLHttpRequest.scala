...
import typingsJapgolly.tabris.tabrisStrings._empty
import typingsJapgolly.tabris.tabrisStrings.arraybuffer
import typingsJapgolly.tabris.tabrisStrings.readystatechange
