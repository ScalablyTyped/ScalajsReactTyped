...
import typingsJapgolly.twineSugarcube.audioMod.AudioList
...
object Delete {
  ...
  inline def apply(
    add: (String, /* repeated */ String | Id) => Callback,
    clear: Callback,
    delete: String => Callback,
    get: String => AudioList | Null,
    has: String => Boolean
  ): Delete = {
    val __obj = js.Dynamic.literal(add = js.Any.fromFunction2((t0: String, t1: /* repeated */ String | Id) => (add(t0, t1)).runNow()), clear = clear.toJsFn, delete = js.Any.fromFunction1((t0: String) => delete(t0).runNow()), get = js.Any.fromFunction1(get), has = js.Any.fromFunction1(has))
    __obj.asInstanceOf[Delete]
  }
  
  extension [Self <: Delete](x: Self) {
    
    inline def setAdd(value: (String, /* repeated */ String | Id) => Callback): Self = StObject.set(x, "add", js.Any.fromFunction2((t0: String, t1: /* repeated */ String | Id) => (value(t0, t1)).runNow()))
