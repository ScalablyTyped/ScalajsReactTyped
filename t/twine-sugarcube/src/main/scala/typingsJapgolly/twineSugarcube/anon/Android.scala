...
object Android {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(Android = Android.asInstanceOf[js.Any], BlackBerry = BlackBerry.asInstanceOf[js.Any], Opera = Opera.asInstanceOf[js.Any], Windows = Windows.asInstanceOf[js.Any], any = any.toJsFn, iOS = iOS.asInstanceOf[js.Any])
