...
import typingsJapgolly.twineSugarcube.userdataMod.SugarCubeStoryVariables
import typingsJapgolly.twineSugarcube.userdataMod.SugarCubeTemporaryVariables
