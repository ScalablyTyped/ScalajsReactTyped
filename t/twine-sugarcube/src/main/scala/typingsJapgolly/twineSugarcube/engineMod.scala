...
import typingsJapgolly.twineSugarcube.twineSugarcubeStrings.idle
import typingsJapgolly.twineSugarcube.twineSugarcubeStrings.playing
import typingsJapgolly.twineSugarcube.twineSugarcubeStrings.rendering
