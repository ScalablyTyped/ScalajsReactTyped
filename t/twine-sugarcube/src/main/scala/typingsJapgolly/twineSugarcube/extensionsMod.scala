...
import typingsJapgolly.twineSugarcube.twineSugarcubeStrings.`false`
import typingsJapgolly.twineSugarcube.twineSugarcubeStrings.`true`
...
object extensionsMod {
  ...
  object global {
    ...
    object JQueryStatic {
      ...
      inline def apply(wiki: /* repeated */ java.lang.String => Callback): JQueryStatic = {
        val __obj = js.Dynamic.literal(wiki = js.Any.fromFunction1((t0: /* repeated */ java.lang.String) => wiki(t0).runNow()))
        __obj.asInstanceOf[JQueryStatic]
      }
      
      extension [Self <: JQueryStatic](x: Self) {
        
        inline def setWiki(value: /* repeated */ java.lang.String => Callback): Self = StObject.set(x, "wiki", js.Any.fromFunction1((t0: /* repeated */ java.lang.String) => value(t0).runNow()))
      }
    }
