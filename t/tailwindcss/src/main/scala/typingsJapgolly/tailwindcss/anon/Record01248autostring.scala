...
/* Inlined std.Record<'0' | '1' | '2' | '4' | '8' | 'auto', string> */
trait Record01248autostring extends StObject {
...
object Record01248autostring {
  
  inline def apply(`0`: String, `1`: String, `2`: String, `4`: String, `8`: String, auto: String): Record01248autostring = {
    ...
    __obj.asInstanceOf[Record01248autostring]
  }
  
  extension [Self <: Record01248autostring](x: Self) {
