...
trait PartialThemeConfigextendP extends StObject {
  ...
  var extend: js.UndefOr[PartialThemeConfig] = js.undefined
...
object PartialThemeConfigextendP {
  
  inline def apply(): PartialThemeConfigextendP = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialThemeConfigextendP]
  }
  
  extension [Self <: PartialThemeConfigextendP](x: Self) {
    ...
    inline def setExtend(value: PartialThemeConfig): Self = StObject.set(x, "extend", value.asInstanceOf[js.Any])
