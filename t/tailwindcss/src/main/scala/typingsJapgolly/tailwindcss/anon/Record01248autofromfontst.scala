...
/* Inlined std.Record<'0' | '1' | '2' | '4' | '8' | 'auto' | 'from-font', string> */
trait Record01248autofromfontst extends StObject {
  ...
  var `from-font`: String
}
object Record01248autofromfontst {
  
  inline def apply(`0`: String, `1`: String, `2`: String, `4`: String, `8`: String, auto: String, `from-font`: String): Record01248autofromfontst = {
    ...
    __obj.updateDynamic("from-font")(`from-font`.asInstanceOf[js.Any])
    __obj.asInstanceOf[Record01248autofromfontst]
  }
  
  extension [Self <: Record01248autofromfontst](x: Self) {
    ...
    inline def `setFrom-font`(value: String): Self = StObject.set(x, "from-font", value.asInstanceOf[js.Any])
  }
}
