...
/* Inlined std.Record<'0' | '50' | '75' | '90' | '95' | '100' | '105' | '110' | '125' | '150' | '200', string> */
trait Record0507590951001051101 extends StObject {
...
object Record0507590951001051101 {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Record0507590951001051101]
  }
  
  extension [Self <: Record0507590951001051101](x: Self) {
    ...
    inline def set125(value: String): Self = StObject.set(x, "125", value.asInstanceOf[js.Any])
    
    inline def set150(value: String): Self = StObject.set(x, "150", value.asInstanceOf[js.Any])
