...
/* Inlined std.Partial<tailwindcss.tailwindcss/types/config.ThemeConfig & {  extend :std.Partial<tailwindcss.tailwindcss/types/config.ThemeConfig>}> */
trait PartialThemeConfigextendPAccentColor extends StObject {
  ...
  var divideColor: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: tailwindcss.tailwindcss/types/config.ThemeConfig['colors'] */ js.Any
  ] = js.undefined
  
  var divideOpacity: js.UndefOr[
    /* import warning: importer.ImportType#apply Failed type conversion: tailwindcss.tailwindcss/types/config.ThemeConfig['opacity'] */ js.Any
  ] = js.undefined
  ...
  var extend: js.UndefOr[PartialThemeConfigAccentColor] = js.undefined
...
object PartialThemeConfigextendPAccentColor {
  
  inline def apply(): PartialThemeConfigextendPAccentColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[PartialThemeConfigextendPAccentColor]
  }
  
  extension [Self <: PartialThemeConfigextendPAccentColor](x: Self) {
    ...
    inline def setExtend(value: PartialThemeConfigAccentColor): Self = StObject.set(x, "extend", value.asInstanceOf[js.Any])
