...
/* Inlined std.Record<'75' | '100' | '150' | '200' | '300' | '500' | '700' | '1000' | 'DEFAULT', string> */
trait Record7510015020030050070100 extends StObject {
...
object Record7510015020030050070100 {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Record7510015020030050070100]
  }
  
  extension [Self <: Record7510015020030050070100](x: Self) {
