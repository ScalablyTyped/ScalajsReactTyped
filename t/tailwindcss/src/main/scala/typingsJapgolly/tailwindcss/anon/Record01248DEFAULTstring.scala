...
/* Inlined std.Record<'0' | '1' | '2' | '4' | '8' | 'DEFAULT', string> */
trait Record01248DEFAULTstring extends StObject {
...
object Record01248DEFAULTstring {
  
  inline def apply(`0`: String, `1`: String, `2`: String, `4`: String, `8`: String, DEFAULT: String): Record01248DEFAULTstring = {
    ...
    __obj.asInstanceOf[Record01248DEFAULTstring]
  }
  
  extension [Self <: Record01248DEFAULTstring](x: Self) {
