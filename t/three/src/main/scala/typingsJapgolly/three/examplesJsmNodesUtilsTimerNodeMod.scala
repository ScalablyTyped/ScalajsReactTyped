...
object examplesJsmNodesUtilsTimerNodeMod {
  ...
  object default {
    ...
    @js.native
    def GLOBAL: typingsJapgolly.three.threeStrings.global = js.native
    inline def GLOBAL_=(x: typingsJapgolly.three.threeStrings.global): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("GLOBAL")(x.asInstanceOf[js.Any])
