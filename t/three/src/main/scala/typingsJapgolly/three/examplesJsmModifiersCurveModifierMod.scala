...
object examplesJsmModifiersCurveModifierMod {
  ...
  inline def modifyShader(material: typingsJapgolly.three.srcThreeMod.Material, uniforms: SplineUniform): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("modifyShader")(material.asInstanceOf[js.Any], uniforms.asInstanceOf[js.Any])).asInstanceOf[Unit]
  inline def modifyShader(
    material: typingsJapgolly.three.srcThreeMod.Material,
    uniforms: SplineUniform,
    numberOfCurves: Double
  ): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("modifyShader")(material.asInstanceOf[js.Any], uniforms.asInstanceOf[js.Any], numberOfCurves.asInstanceOf[js.Any])).asInstanceOf[Unit]
