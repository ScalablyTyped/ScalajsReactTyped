...
import typingsJapgolly.three.cubicInterpolantMod.CubicInterpolant
import typingsJapgolly.three.discreteInterpolantMod.DiscreteInterpolant
import typingsJapgolly.three.linearInterpolantMod.LinearInterpolant
