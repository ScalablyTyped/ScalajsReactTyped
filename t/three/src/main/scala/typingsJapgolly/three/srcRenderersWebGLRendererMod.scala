...
import typingsJapgolly.three.srcRenderersWebGLMultipleRenderTargetsMod.WebGLMultipleRenderTargets
...
import typingsJapgolly.three.srcRenderersWebxrWebXRManagerMod.WebXRManager
...
object srcRenderersWebGLRendererMod {
  ...
  trait WebGLRendererParameters extends StObject {
    ...
    /**
      ...
      */
    var canvas: js.UndefOr[HTMLCanvasElement | EventTarget] = js.undefined
  ...
  object WebGLRendererParameters {
    ...
    extension [Self <: WebGLRendererParameters](x: Self) {
      ...
      inline def setCanvas(value: HTMLCanvasElement | EventTarget): Self = StObject.set(x, "canvas", value.asInstanceOf[js.Any])
