...
@JSImport("three/src/Three", "QuaternionLinearInterpolant")
@js.native
open class QuaternionLinearInterpolant protected ()
  extends typingsJapgolly.three.srcMathInterpolantsQuaternionLinearInterpolantMod.QuaternionLinearInterpolant {
