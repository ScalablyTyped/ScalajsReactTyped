...
@JSImport("three/src/Three", "Int16BufferAttribute")
@js.native
open class Int16BufferAttribute protected ()
  extends typingsJapgolly.three.srcCoreBufferAttributeMod.Int16BufferAttribute {
