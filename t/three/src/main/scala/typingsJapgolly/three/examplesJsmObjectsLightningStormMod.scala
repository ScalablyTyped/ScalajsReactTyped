...
import typingsJapgolly.three.examplesJsmGeometriesLightningStrikeMod.LightningStrike
import typingsJapgolly.three.examplesJsmGeometriesLightningStrikeMod.RayParameters
...
object examplesJsmObjectsLightningStormMod {
  ...
  object StormParams {
    ...
    extension [Self <: StormParams](x: Self) {
      ...
      inline def setOnLightningDown(value: /* lightning */ LightningStrike => Callback): Self = StObject.set(x, "onLightningDown", js.Any.fromFunction1((t0: /* lightning */ LightningStrike) => value(t0).runNow()))
      
      inline def setOnLightningDownUndefined: Self = StObject.set(x, "onLightningDown", js.undefined)
      
      inline def setOnRayPosition(value: (/* source */ Vector3, /* dest */ Vector3) => Callback): Self = StObject.set(x, "onRayPosition", js.Any.fromFunction2((t0: /* source */ Vector3, t1: /* dest */ Vector3) => (value(t0, t1)).runNow()))
