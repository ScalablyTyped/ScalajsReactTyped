...
object examplesJsmNodesCoreNodeFunctionMod {
  ...
  open class default protected ()
    ...
    def this(
      `type`: String,
      inputs: js.Array[typingsJapgolly.three.examplesJsmNodesCoreNodeFunctionInputMod.default]
    ) = this()
    def this(
      `type`: String,
      inputs: js.Array[typingsJapgolly.three.examplesJsmNodesCoreNodeFunctionInputMod.default],
  ...
  trait NodeFunction extends StObject {
    ...
    var inputs: js.Array[typingsJapgolly.three.examplesJsmNodesCoreNodeFunctionInputMod.default] = js.native
