...
@js.native
class PointLight ()
  extends typingsJapgolly.three.pointLightMod.PointLight {
  ...
  def this(color: typingsJapgolly.three.colorMod.Color, intensity: Double, distance: Double) = this()
  ...
  def this(color: typingsJapgolly.three.colorMod.Color, intensity: Double, distance: Double, decay: Double) = this()
}
