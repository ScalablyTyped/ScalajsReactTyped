...
object srcMathMathUtilsMod {
  ...
  @JSImport("three/src/math/MathUtils", "DEG2RAD")
  @js.native
  val DEG2RAD: Double = js.native
  
  @JSImport("three/src/math/MathUtils", "RAD2DEG")
  @js.native
  ...
  inline def setQuaternionFromProperEuler(q: Quaternion, a: Double, b: Double, c: Double, order: String): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("setQuaternionFromProperEuler")(q.asInstanceOf[js.Any], a.asInstanceOf[js.Any], b.asInstanceOf[js.Any], c.asInstanceOf[js.Any], order.asInstanceOf[js.Any])).asInstanceOf[Unit]
