...
import typingsJapgolly.three.anon.Call
...
import typingsJapgolly.three.examplesJsmNodesCoreNodeBuilderMod.NodeBuilderContext
import typingsJapgolly.three.examplesJsmNodesCoreNodeMod.default
import typingsJapgolly.three.examplesJsmNodesNodesMod.BufferNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.BypassNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.CameraNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.CodeNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.ComputeNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.ContextNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.ExpressionNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.FrontFacingNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.FunctionCallNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.FunctionNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.InstanceIndexNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.MaterialNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.MaterialReferenceNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.MathNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.ModelNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.ModelViewProjectionNode
...
import typingsJapgolly.three.examplesJsmNodesNodesMod.NormalNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.PointUVNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.PositionNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.PropertyNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.ReferenceNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.UVNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.UserDataNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.VarNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.VaryNode
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.ConstructedNode
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.ConvertType
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.GetConstructors
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.GetConstructorsByScope
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.GetPossibleScopes
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.NodeArray_
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.NodeObjectOption
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.NodeObject_
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.NodeObjects_
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.NodeOrType
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.NodeRepresentation
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.ProxiedObject
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.ProxiedTuple
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.RemoveHeadAndTail
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.RemoveTail
...
object examplesJsmNodesShadernodeShaderNodeBaseElementsMod {
  ...
  open class ShaderNode[T, R /* <: Node */] protected ()
    extends typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeMod.ShaderNode[T, R] {
  ...
  inline def sampler(texture: typingsJapgolly.three.examplesJsmNodesAccessorsTextureNodeMod.default): Swizzable[Node] = ^.asInstanceOf[js.Dynamic].applyDynamic("sampler")(texture.asInstanceOf[js.Any]).asInstanceOf[Swizzable[Node]]
  ...
  inline def storage(value: ArrayLike[Double], nodeOrType: NodeOrType, count: Double): Swizzable[typingsJapgolly.three.examplesJsmNodesAccessorsStorageBufferNodeMod.default] = (^.asInstanceOf[js.Dynamic].applyDynamic("storage")(value.asInstanceOf[js.Any], nodeOrType.asInstanceOf[js.Any], count.asInstanceOf[js.Any])).asInstanceOf[Swizzable[typingsJapgolly.three.examplesJsmNodesAccessorsStorageBufferNodeMod.default]]
  ...
  inline def texture(value: Texture): Swizzable[typingsJapgolly.three.examplesJsmNodesAccessorsTextureNodeMod.default] = ^.asInstanceOf[js.Dynamic].applyDynamic("texture")(value.asInstanceOf[js.Any]).asInstanceOf[Swizzable[typingsJapgolly.three.examplesJsmNodesAccessorsTextureNodeMod.default]]
  inline def texture(value: Texture, uvNode: Unit, levelNode: NodeRepresentation[Node]): Swizzable[typingsJapgolly.three.examplesJsmNodesAccessorsTextureNodeMod.default] = (^.asInstanceOf[js.Dynamic].applyDynamic("texture")(value.asInstanceOf[js.Any], uvNode.asInstanceOf[js.Any], levelNode.asInstanceOf[js.Any])).asInstanceOf[Swizzable[typingsJapgolly.three.examplesJsmNodesAccessorsTextureNodeMod.default]]
  inline def texture(value: Texture, uvNode: NodeRepresentation[Node]): Swizzable[typingsJapgolly.three.examplesJsmNodesAccessorsTextureNodeMod.default] = (^.asInstanceOf[js.Dynamic].applyDynamic("texture")(value.asInstanceOf[js.Any], uvNode.asInstanceOf[js.Any])).asInstanceOf[Swizzable[typingsJapgolly.three.examplesJsmNodesAccessorsTextureNodeMod.default]]
