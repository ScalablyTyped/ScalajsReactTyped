...
import typingsJapgolly.three.anon.Children
...
open class IFCManager () extends StObject {
  ...
  /**
    ...
    */
  def getExpressId(geometry: typingsJapgolly.three.srcThreeMod.BufferGeometry, faceIndex: Double): js.UndefOr[Double] = js.native
  ...
  def getSubset(modelID: Double, material: typingsJapgolly.three.srcThreeMod.Material): (Mesh[BufferGeometry, Material | js.Array[Material]]) | Null = js.native
  ...
  def removeSubset(modelID: Double, parent: Unit, material: typingsJapgolly.three.srcThreeMod.Material): Unit = js.native
  def removeSubset(modelID: Double, parent: Object3D[Event]): Unit = js.native
  def removeSubset(modelID: Double, parent: Object3D[Event], material: typingsJapgolly.three.srcThreeMod.Material): Unit = js.native
