...
open class IFCModel_ ()
  ...
  def getSubset(material: typingsJapgolly.three.srcThreeMod.Material): (Mesh[BufferGeometry, Material | js.Array[Material]]) | Null = js.native
  ...
  def removeSubset(parent: Unit, material: typingsJapgolly.three.srcThreeMod.Material): Unit = js.native
  def removeSubset(parent: Object3D[Event]): Unit = js.native
  def removeSubset(parent: Object3D[Event], material: typingsJapgolly.three.srcThreeMod.Material): Unit = js.native
