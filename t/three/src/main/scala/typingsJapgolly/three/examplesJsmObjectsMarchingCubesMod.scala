...
object examplesJsmObjectsMarchingCubesMod {
  ...
  open class MarchingCubes protected ()
    ...
    def this(resolution: Double, material: typingsJapgolly.three.srcThreeMod.Material) = this()
    def this(resolution: Double, material: typingsJapgolly.three.srcThreeMod.Material, enableUvs: Boolean) = this()
    def this(
      resolution: Double,
    ...
    def generateBufferGeometry(): typingsJapgolly.three.srcThreeMod.BufferGeometry = js.native
    
    def generateGeometry(): typingsJapgolly.three.srcThreeMod.BufferGeometry = js.native
