...
object examplesJsmNodesCoreNodeUniformMod {
  ...
  open class default protected ()
    extends StObject
       with NodeUniform {
    def this(name: String, `type`: String, node: typingsJapgolly.three.examplesJsmNodesCoreInputNodeMod.default) = this()
    def this(
      name: String,
      `type`: String,
      node: typingsJapgolly.three.examplesJsmNodesCoreInputNodeMod.default,
      needsUpdate: Boolean
    ) = this()
    ...
    /* CompleteClass */
    var node: typingsJapgolly.three.examplesJsmNodesCoreInputNodeMod.default = js.native
  ...
  trait NodeUniform extends StObject {
    ...
    var node: typingsJapgolly.three.examplesJsmNodesCoreInputNodeMod.default
  ...
  object NodeUniform {
    ...
    extension [Self <: NodeUniform](x: Self) {
      ...
      inline def setNode(value: typingsJapgolly.three.examplesJsmNodesCoreInputNodeMod.default): Self = StObject.set(x, "node", value.asInstanceOf[js.Any])
