...
import typingsJapgolly.three.examplesJsmCsmCsmfrustumMod.default
...
object examplesJsmCsmCsmMod {
  ...
  object CMSMode extends StObject {
    ...
    sealed trait custom
      extends StObject
         with CMSMode
    /* "custom" */ val custom: typingsJapgolly.three.examplesJsmCsmCsmMod.CMSMode.custom & String = js.native
    
    @js.native
    sealed trait logarithmic
      extends StObject
         with CMSMode
    /* "logarithmic" */ val logarithmic: typingsJapgolly.three.examplesJsmCsmCsmMod.CMSMode.logarithmic & String = js.native
    
    @js.native
    sealed trait practical
      extends StObject
         with CMSMode
    /* "practical" */ val practical: typingsJapgolly.three.examplesJsmCsmCsmMod.CMSMode.practical & String = js.native
    
    @js.native
    sealed trait uniform
      extends StObject
         with CMSMode
    /* "uniform" */ val uniform: typingsJapgolly.three.examplesJsmCsmCsmMod.CMSMode.uniform & String = js.native
  }
  ...
  object CMSParameters {
    ...
    extension [Self <: CMSParameters](x: Self) {
      ...
      inline def setCustomSplitsCallback(
        value: (/* cascades */ Double, /* cameraNear */ Double, /* cameraFar */ Double, /* breaks */ js.Array[Double]) => Callback
      ): Self = StObject.set(x, "customSplitsCallback", js.Any.fromFunction4((t0: /* cascades */ Double, t1: /* cameraNear */ Double, t2: /* cameraFar */ Double, t3: /* breaks */ js.Array[Double]) => (value(t0, t1, t2, t3)).runNow()))
