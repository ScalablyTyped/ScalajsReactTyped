...
import typingsJapgolly.three.threeStrings.replace
...
object examplesJsmRenderersWebglNodesSlotNodeMod {
  ...
  @js.native
  open class default[TNode /* <: typingsJapgolly.three.examplesJsmNodesCoreNodeMod.default */] protected () extends SlotNode[TNode] {
    def this(params: SlotNodeParameters[TNode]) = this()
  }
  
  @js.native
  trait SlotNode[TNode /* <: typingsJapgolly.three.examplesJsmNodesCoreNodeMod.default */]
  ...
  trait SlotNodeParameters[TNode /* <: typingsJapgolly.three.examplesJsmNodesCoreNodeMod.default */] extends StObject {
  ...
  object SlotNodeParameters {
    ...
    inline def apply[TNode /* <: typingsJapgolly.three.examplesJsmNodesCoreNodeMod.default */](): SlotNodeParameters[TNode] = {
      val __obj = js.Dynamic.literal()
      __obj.asInstanceOf[SlotNodeParameters[TNode]]
    }
    
    extension [Self <: SlotNodeParameters[?], TNode /* <: typingsJapgolly.three.examplesJsmNodesCoreNodeMod.default */](x: Self & SlotNodeParameters[TNode]) {
