...
open class TubeGeometry ()
  extends typingsJapgolly.three.mod.TubeGeometry {
  def this(path: typingsJapgolly.three.srcExtrasCoreCurveMod.Curve[typingsJapgolly.three.srcMathVector3Mod.Vector3]) = this()
  def this(path: Unit, tubularSegments: Double) = this()
  def this(
    path: typingsJapgolly.three.srcExtrasCoreCurveMod.Curve[typingsJapgolly.three.srcMathVector3Mod.Vector3],
