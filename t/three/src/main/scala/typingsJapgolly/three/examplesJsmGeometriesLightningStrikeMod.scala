...
object examplesJsmGeometriesLightningStrikeMod {
  ...
  object RandomGenerator {
    ...
    inline def apply(getSeed: CallbackTo[Double], random: CallbackTo[Double], setSeed: Double => Callback): RandomGenerator = {
      val __obj = js.Dynamic.literal(getSeed = getSeed.toJsFn, random = random.toJsFn, setSeed = js.Any.fromFunction1((t0: Double) => setSeed(t0).runNow()))
    ...
    extension [Self <: RandomGenerator](x: Self) {
      ...
      inline def setSetSeed(value: Double => Callback): Self = StObject.set(x, "setSeed", js.Any.fromFunction1((t0: Double) => value(t0).runNow()))
    }
  }
  ...
  object RayParameters {
    ...
    extension [Self <: RayParameters](x: Self) {
      ...
      inline def setOnDecideSubrayCreation(value: (/* segment */ LightningSegment, /* lightningStrike */ LightningStrike) => Callback): Self = StObject.set(x, "onDecideSubrayCreation", js.Any.fromFunction2((t0: /* segment */ LightningSegment, t1: /* lightningStrike */ LightningStrike) => (value(t0, t1)).runNow()))
      ...
      inline def setOnSubrayCreation(
        value: (/* segment */ LightningSegment, /* parentSubray */ LightningSubray, /* childSubray */ LightningSubray, /* lightningStrike */ LightningStrike) => Callback
      ): Self = StObject.set(x, "onSubrayCreation", js.Any.fromFunction4((t0: /* segment */ LightningSegment, t1: /* parentSubray */ LightningSubray, t2: /* childSubray */ LightningSubray, t3: /* lightningStrike */ LightningStrike) => (value(t0, t1, t2, t3)).runNow()))
