...
import typingsJapgolly.three.examplesJsmNodesNodesMod.ConstNode
...
object examplesJsmNodesShadernodeShaderNodeMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.three.examplesJsmNodesNodesMod.Node
    - typingsJapgolly.three.examplesJsmNodesCoreConstantsMod.NodeTypeOption
  */
