...
object srcMathMatrix3Mod {
  ...
  object Matrix {
    ...
    inline def apply(
      ...
      identity: CallbackTo[Matrix],
      invert: CallbackTo[Matrix],
      multiplyScalar: Double => Matrix,
      transpose: CallbackTo[Matrix]
    ): Matrix = {
      val __obj = js.Dynamic.literal(copy = js.Any.fromFunction1(copy), determinant = determinant.toJsFn, elements = elements.asInstanceOf[js.Any], identity = identity.toJsFn, invert = invert.toJsFn, multiplyScalar = js.Any.fromFunction1(multiplyScalar), transpose = transpose.toJsFn)
    ...
    extension [Self <: Matrix](x: Self) {
      ...
      inline def setIdentity(value: CallbackTo[Matrix]): Self = StObject.set(x, "identity", value.toJsFn)
      
      inline def setInvert(value: CallbackTo[Matrix]): Self = StObject.set(x, "invert", value.toJsFn)
      
      inline def setMultiplyScalar(value: Double => Matrix): Self = StObject.set(x, "multiplyScalar", js.Any.fromFunction1(value))
      
      inline def setTranspose(value: CallbackTo[Matrix]): Self = StObject.set(x, "transpose", value.toJsFn)
    }
  }
