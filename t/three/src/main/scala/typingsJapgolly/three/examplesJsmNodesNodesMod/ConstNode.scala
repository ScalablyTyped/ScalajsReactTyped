...
import typingsJapgolly.three.examplesJsmNodesCoreConstNodeMod.default
...
@JSImport("three/examples/jsm/nodes/Nodes", "ConstNode")
@js.native
open class ConstNode protected () extends default {
