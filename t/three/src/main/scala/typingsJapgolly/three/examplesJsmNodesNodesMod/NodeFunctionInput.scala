...
import typingsJapgolly.three.examplesJsmNodesCoreNodeFunctionInputMod.default
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

@JSImport("three/examples/jsm/nodes/Nodes", "NodeFunctionInput")
@js.native
open class NodeFunctionInput protected () extends default {
