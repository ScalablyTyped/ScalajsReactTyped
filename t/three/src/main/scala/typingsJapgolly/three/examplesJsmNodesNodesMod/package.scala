...
import typingsJapgolly.three.anon.Alpha
...
import typingsJapgolly.three.anon.DotNL
import typingsJapgolly.three.anon.DotVH
import typingsJapgolly.three.anon.F0
...
import typingsJapgolly.three.examplesJsmNodesGeometryRangeNodeMod.RangeModeBound
import typingsJapgolly.three.examplesJsmNodesLightingLightingContextNodeMod.LightingModelNode
import typingsJapgolly.three.examplesJsmNodesNodesMod.^
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.Binary
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.Fn_
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.Operator
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.Ternary
import typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.Unary
...
inline def BRDFLambert: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[DiffuseColor, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("BRDF_Lambert").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[DiffuseColor, Node]]

inline def BRDF_GGX: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[F0, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("BRDF_GGX").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[F0, Node]]

// Analytical approximation of the DFG LUT, one half of the
// split-sum approximation used in indirect specular lighting.
// via 'environmentBRDF' from "Physically Based Shading on Mobile"
// https://www.unrealengine.com/blog/physically-based-shading-on-mobile
inline def DFGApprox: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeElementsMod.ShaderNode[Roughness, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("DFGApprox").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeElementsMod.ShaderNode[Roughness, Node]]

// Microfacet Models for Refraction through Rough Surfaces - equation (33)
// http://graphicrants.blogspot.com/2013/08/specular-brdf-reference.html
// alpha is "roughness squared" in Disney’s reparameterization
inline def D_GGX: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[Alpha, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("D_GGX").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[Alpha, Node]]

inline def EPSILON: Swizzable[Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("EPSILON").asInstanceOf[Swizzable[Node]]

inline def FSchlick: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[DotVH, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("F_Schlick").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[DotVH, Node]]

inline def INFINITY: Swizzable[Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("INFINITY").asInstanceOf[Swizzable[Node]]

inline def VGGXSmithCorrelated: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[DotNL, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("V_GGX_SmithCorrelated").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[DotNL, Node]]
...
inline def getDistanceAttenuation: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[CutoffDistance, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("getDistanceAttenuation").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[CutoffDistance, Node]]

inline def getGeometryRoughness: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[js.Object, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("getGeometryRoughness").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeBaseElementsMod.ShaderNode[js.Object, Node]]

inline def getRoughness: typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeElementsMod.ShaderNode[Roughness, Node] = ^.asInstanceOf[js.Dynamic].selectDynamic("getRoughness").asInstanceOf[typingsJapgolly.three.examplesJsmNodesShadernodeShaderNodeElementsMod.ShaderNode[Roughness, Node]]
...
inline def lightingContext(node: default): Swizzable[typingsJapgolly.three.examplesJsmNodesLightingLightingContextNodeMod.default] = ^.asInstanceOf[js.Dynamic].applyDynamic("lightingContext")(node.asInstanceOf[js.Any]).asInstanceOf[Swizzable[typingsJapgolly.three.examplesJsmNodesLightingLightingContextNodeMod.default]]
inline def lightingContext(node: default, lightingModelNode: LightingModelNode): Swizzable[typingsJapgolly.three.examplesJsmNodesLightingLightingContextNodeMod.default] = (^.asInstanceOf[js.Dynamic].applyDynamic("lightingContext")(node.asInstanceOf[js.Any], lightingModelNode.asInstanceOf[js.Any])).asInstanceOf[Swizzable[typingsJapgolly.three.examplesJsmNodesLightingLightingContextNodeMod.default]]
...
inline def materialReference(name: String, nodeOrType: NodeOrType, material: typingsJapgolly.three.srcThreeMod.Material): Swizzable[MaterialReferenceNode] = (^.asInstanceOf[js.Dynamic].applyDynamic("materialReference")(name.asInstanceOf[js.Any], nodeOrType.asInstanceOf[js.Any], material.asInstanceOf[js.Any])).asInstanceOf[Swizzable[MaterialReferenceNode]]
...
inline def range(min: RangeModeBound, max: RangeModeBound): Swizzable[typingsJapgolly.three.examplesJsmNodesGeometryRangeNodeMod.default] = (^.asInstanceOf[js.Dynamic].applyDynamic("range")(min.asInstanceOf[js.Any], max.asInstanceOf[js.Any])).asInstanceOf[Swizzable[typingsJapgolly.three.examplesJsmNodesGeometryRangeNodeMod.default]]
