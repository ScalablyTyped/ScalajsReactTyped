...
object examplesJsmExportersGltfexporterMod {
  ...
  object GLTFExporterPlugin {
    ...
    extension [Self <: GLTFExporterPlugin](x: Self) {
      ...
      inline def setAfterParse(value: /* input */ Object3D[Event] | js.Array[Object3D[Event]] => Callback): Self = StObject.set(x, "afterParse", js.Any.fromFunction1((t0: /* input */ Object3D[Event] | js.Array[Object3D[Event]]) => value(t0).runNow()))
      
      inline def setAfterParseUndefined: Self = StObject.set(x, "afterParse", js.undefined)
      
      inline def setBeforeParse(value: /* input */ Object3D[Event] | js.Array[Object3D[Event]] => Callback): Self = StObject.set(x, "beforeParse", js.Any.fromFunction1((t0: /* input */ Object3D[Event] | js.Array[Object3D[Event]]) => value(t0).runNow()))
      
      inline def setBeforeParseUndefined: Self = StObject.set(x, "beforeParse", js.undefined)
      
      inline def setWriteMaterial(value: (/* material */ Material, /* materialDef */ StringDictionary[Any]) => Callback): Self = StObject.set(x, "writeMaterial", js.Any.fromFunction2((t0: /* material */ Material, t1: /* materialDef */ StringDictionary[Any]) => (value(t0, t1)).runNow()))
      ...
      inline def setWriteMesh(
        value: (/* mesh */ Mesh[
              BufferGeometry, 
              typingsJapgolly.three.srcMaterialsMaterialMod.Material | js.Array[typingsJapgolly.three.srcMaterialsMaterialMod.Material]
            ], /* meshDef */ StringDictionary[Any]) => Callback
      ): Self = StObject.set(x, "writeMesh", js.Any.fromFunction2((t0: /* mesh */ Mesh[
              BufferGeometry, 
              typingsJapgolly.three.srcMaterialsMaterialMod.Material | js.Array[typingsJapgolly.three.srcMaterialsMaterialMod.Material]
            ], t1: /* meshDef */ StringDictionary[Any]) => (value(t0, t1)).runNow()))
      
      inline def setWriteMeshUndefined: Self = StObject.set(x, "writeMesh", js.undefined)
      
      inline def setWriteNode(value: (/* object */ Object3D[Event], /* nodeDef */ StringDictionary[Any]) => Callback): Self = StObject.set(x, "writeNode", js.Any.fromFunction2((t0: /* object */ Object3D[Event], t1: /* nodeDef */ StringDictionary[Any]) => (value(t0, t1)).runNow()))
      
      inline def setWriteNodeUndefined: Self = StObject.set(x, "writeNode", js.undefined)
      
      inline def setWriteTexture(value: (/* map */ Texture, /* textureDef */ StringDictionary[Any]) => Callback): Self = StObject.set(x, "writeTexture", js.Any.fromFunction2((t0: /* map */ Texture, t1: /* textureDef */ StringDictionary[Any]) => (value(t0, t1)).runNow()))
