...
object examplesJsmObjectsReflectorMod {
  ...
  open class Reflector ()
    ...
    def this(geometry: typingsJapgolly.three.srcThreeMod.BufferGeometry, options: ReflectorOptions) = this()
    ...
    @JSName("type")
    var type_Reflector: typingsJapgolly.three.threeStrings.Reflector = js.native
  }
