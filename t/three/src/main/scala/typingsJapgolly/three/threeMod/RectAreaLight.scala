...
class RectAreaLight ()
  ...
  def this(color: typingsJapgolly.three.srcMathColorMod.Color) = this()
  def this(color: String, intensity: Double) = this()
  def this(color: Double, intensity: Double) = this()
  def this(color: typingsJapgolly.three.srcMathColorMod.Color, intensity: Double) = this()
  def this(color: String, intensity: Double, width: Double) = this()
  def this(color: Double, intensity: Double, width: Double) = this()
  def this(color: typingsJapgolly.three.srcMathColorMod.Color, intensity: Double, width: Double) = this()
  ...
  def this(
    color: typingsJapgolly.three.srcMathColorMod.Color,
    intensity: Double,
    width: Double,
    height: Double
  ) = this()
