...
import typingsJapgolly.three.anon.DataType
import typingsJapgolly.three.anon.PartialXRHandJoints
...
object srcRenderersWebxrWebXRControllerMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.webxr.XRSessionEventType
    - typingsJapgolly.webxr.XRInputSourceEventType
    - typingsJapgolly.three.threeStrings.disconnected
    - typingsJapgolly.three.threeStrings.connected
  */
