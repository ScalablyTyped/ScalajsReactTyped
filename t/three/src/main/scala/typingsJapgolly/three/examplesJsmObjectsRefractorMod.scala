...
object examplesJsmObjectsRefractorMod {
  ...
  open class Refractor ()
    ...
    def this(geometry: typingsJapgolly.three.srcThreeMod.BufferGeometry) = this()
    def this(geometry: Unit, options: RefractorOptions) = this()
    def this(geometry: typingsJapgolly.three.srcThreeMod.BufferGeometry, options: RefractorOptions) = this()
    ...
    @JSName("type")
    var type_Refractor: typingsJapgolly.three.threeStrings.Refractor = js.native
  }
