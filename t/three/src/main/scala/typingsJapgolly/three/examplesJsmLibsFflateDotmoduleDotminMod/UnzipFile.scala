...
object UnzipFile {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(compression = compression.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], ondata = js.Any.fromFunction3((t0: /* err */ js.Error, t1: /* data */ js.typedarray.Uint8Array, t2: /* final */ Boolean) => (ondata(t0, t1, t2)).runNow()), start = start.toJsFn, terminate = terminate.toJsFn)
