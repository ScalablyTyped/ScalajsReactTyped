...
import typingsJapgolly.three.anon.DISTANCEATTENUATION
...
object examplesJsmObjectsReflectorForSSRPassMod {
  ...
  open class ReflectorForSSRPass[TGeometry /* <: BufferGeometry */] protected ()
    ...
    @JSName("type")
    var type_ReflectorForSSRPass: typingsJapgolly.three.threeStrings.ReflectorForSSRPass = js.native
  }
  /* static members */
  object ReflectorForSSRPass {
    ...
    @js.native
    def ReflectorShader: typingsJapgolly.three.examplesJsmObjectsReflectorForSSRPassMod.ReflectorShader = js.native
