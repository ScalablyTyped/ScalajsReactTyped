...
class Client protected () extends js.Object {
  ...
  /**
    ...
    */
  def get(sid: String): js.Promise[typingsJapgolly.twilioMcsClient.mediaMod.Media] = js.native
  /**
    ...
    * @returns {Promise<Media>}
    */
  def post(contentType: String, media: String): js.Promise[typingsJapgolly.twilioMcsClient.mediaMod.Media] = js.native
  def post(contentType: String, media: Buffer): js.Promise[typingsJapgolly.twilioMcsClient.mediaMod.Media] = js.native
  /**
    ...
    * @returns {Promise<Media>}
    */
  def postFormData(formData: FormData): js.Promise[typingsJapgolly.twilioMcsClient.mediaMod.Media] = js.native
  /**
