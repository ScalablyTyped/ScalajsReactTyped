...
import typingsJapgolly.twilio.libRestPreviewWirelessSimUsageMod.UsageContext
import typingsJapgolly.twilio.libRestPreviewWirelessSimUsageMod.UsageListInstance
...
object libRestPreviewWirelessSimMod {
  ...
  open class SimContext protected () extends StObject {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^, sid: String) = this()
  ...
  open class SimInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^, payload: SimPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def SimList(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^): SimListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("SimList")(version.asInstanceOf[js.Any]).asInstanceOf[SimListInstance]
  ...
  open class SimPage protected ()
    extends typingsJapgolly.twilio.libBasePageMod.^[
          typingsJapgolly.twilio.libRestPreviewWirelessMod.^, 
          SimPayload, 
          SimResource, 
          SimInstance
        ] {
    /**
      ...
      */
    def this(
      version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^,
  ...
  object SimListInstanceEachOptions {
    ...
    extension [Self <: SimListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ SimInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ SimInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
