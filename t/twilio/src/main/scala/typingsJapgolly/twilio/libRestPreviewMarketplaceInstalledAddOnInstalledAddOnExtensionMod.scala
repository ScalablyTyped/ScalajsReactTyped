...
object libRestPreviewMarketplaceInstalledAddOnInstalledAddOnExtensionMod {
  ...
  object InstalledAddOnExtensionInstanceUpdateOptions {
    ...
    extension [Self <: InstalledAddOnExtensionInstanceUpdateOptions](x: Self) {
  ...
  object InstalledAddOnExtensionListInstanceEachOptions {
    ...
    extension [Self <: InstalledAddOnExtensionListInstanceEachOptions](x: Self) {
      
      inline def setCallback(
        value: (/* item */ InstalledAddOnExtensionInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ InstalledAddOnExtensionInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
  ...
  object InstalledAddOnExtensionListInstanceOptions {
    ...
    extension [Self <: InstalledAddOnExtensionListInstanceOptions](x: Self) {
  ...
  object InstalledAddOnExtensionListInstancePageOptions {
    ...
    extension [Self <: InstalledAddOnExtensionListInstancePageOptions](x: Self) {
  ...
  object InstalledAddOnExtensionResource {
    ...
    extension [Self <: InstalledAddOnExtensionResource](x: Self) {
  ...
  object InstalledAddOnExtensionSolution {
    ...
    extension [Self <: InstalledAddOnExtensionSolution](x: Self) {
