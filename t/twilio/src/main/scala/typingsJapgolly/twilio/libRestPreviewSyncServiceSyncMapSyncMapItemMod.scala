...
object libRestPreviewSyncServiceSyncMapSyncMapItemMod {
  ...
  object SyncMapItemListInstanceEachOptions {
    ...
    extension [Self <: SyncMapItemListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ SyncMapItemInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ SyncMapItemInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twilio.twilioStrings.inclusive
    - typingsJapgolly.twilio.twilioStrings.exclusive
  */
  trait SyncMapItemQueryFromBoundType extends StObject
  object SyncMapItemQueryFromBoundType {
    
    inline def exclusive: typingsJapgolly.twilio.twilioStrings.exclusive = "exclusive".asInstanceOf[typingsJapgolly.twilio.twilioStrings.exclusive]
    
    inline def inclusive: typingsJapgolly.twilio.twilioStrings.inclusive = "inclusive".asInstanceOf[typingsJapgolly.twilio.twilioStrings.inclusive]
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twilio.twilioStrings.asc
    - typingsJapgolly.twilio.twilioStrings.desc
  */
  trait SyncMapItemQueryResultOrder extends StObject
  object SyncMapItemQueryResultOrder {
    
    inline def asc: typingsJapgolly.twilio.twilioStrings.asc = "asc".asInstanceOf[typingsJapgolly.twilio.twilioStrings.asc]
    
    inline def desc: typingsJapgolly.twilio.twilioStrings.desc = "desc".asInstanceOf[typingsJapgolly.twilio.twilioStrings.desc]
  }
