...
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskFieldMod.FieldContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskFieldMod.FieldListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskSampleMod.SampleContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskSampleMod.SampleListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskTaskActionsMod.TaskActionsContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskTaskActionsMod.TaskActionsListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskTaskStatisticsMod.TaskStatisticsContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskTaskStatisticsMod.TaskStatisticsListInstance
...
object libRestPreviewUnderstandAssistantTaskMod {
  ...
  open class TaskContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, assistantSid: String, sid: String) = this()
  ...
  open class TaskInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(
      version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^,
      payload: TaskPayload,
      assistantSid: String,
      sid: String
    ) = this()
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the Assistant.
    */
  inline def TaskList(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, assistantSid: String): TaskListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("TaskList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[TaskListInstance]
  ...
  open class TaskPage protected ()
    extends typingsJapgolly.twilio.libBasePageMod.^[
          typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, 
          TaskPayload, 
          TaskResource, 
          TaskInstance
        ] {
  ...
  object TaskListInstanceEachOptions {
    ...
    extension [Self <: TaskListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ TaskInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ TaskInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
