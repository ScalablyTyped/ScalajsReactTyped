...
import typingsJapgolly.twilio.libRestPreviewTrustedCommsBrandedChannelChannelMod.ChannelListInstance
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object libRestPreviewTrustedCommsBrandedChannelMod {
  ...
  open class BrandedChannelContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^, sid: String) = this()
  ...
  open class BrandedChannelInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(
      version: typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^,
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def BrandedChannelList(version: typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^): BrandedChannelListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("BrandedChannelList")(version.asInstanceOf[js.Any]).asInstanceOf[BrandedChannelListInstance]
  ...
  open class BrandedChannelPage protected ()
    extends typingsJapgolly.twilio.libBasePageMod.^[
          typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^, 
