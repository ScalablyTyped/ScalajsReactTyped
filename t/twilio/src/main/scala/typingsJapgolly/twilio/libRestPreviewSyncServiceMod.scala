...
import typingsJapgolly.twilio.libRestPreviewSyncServiceDocumentMod.DocumentContext
import typingsJapgolly.twilio.libRestPreviewSyncServiceDocumentMod.DocumentListInstance
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncListMod.SyncListContext
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncListMod.SyncListListInstance
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncMapMod.SyncMapContext
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncMapMod.SyncMapListInstance
...
object libRestPreviewSyncServiceMod {
  ...
  open class ServiceContext protected () extends StObject {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewSyncMod.^, sid: String) = this()
  ...
  open class ServiceInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewSyncMod.^, payload: ServicePayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def ServiceList(version: typingsJapgolly.twilio.libRestPreviewSyncMod.^): ServiceListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("ServiceList")(version.asInstanceOf[js.Any]).asInstanceOf[ServiceListInstance]
  ...
  open class ServicePage protected ()
    extends typingsJapgolly.twilio.libBasePageMod.^[
          typingsJapgolly.twilio.libRestPreviewSyncMod.^, 
          ServicePayload, 
          ServiceResource, 
          ServiceInstance
        ] {
    /**
      ...
      */
    def this(
      version: typingsJapgolly.twilio.libRestPreviewSyncMod.^,
  ...
  object ServiceListInstanceEachOptions {
    ...
    extension [Self <: ServiceListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ ServiceInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ ServiceInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
