...
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncMapSyncMapItemMod.SyncMapItemContext
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncMapSyncMapItemMod.SyncMapItemListInstance
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncMapSyncMapPermissionMod.SyncMapPermissionContext
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncMapSyncMapPermissionMod.SyncMapPermissionListInstance
...
object libRestPreviewSyncServiceSyncMapMod {
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def SyncMapList(version: typingsJapgolly.twilio.libRestPreviewSyncMod.^, serviceSid: String): SyncMapListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncMapList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[SyncMapListInstance]
  ...
  object SyncMapListInstanceEachOptions {
    ...
    extension [Self <: SyncMapListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ SyncMapInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ SyncMapInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
