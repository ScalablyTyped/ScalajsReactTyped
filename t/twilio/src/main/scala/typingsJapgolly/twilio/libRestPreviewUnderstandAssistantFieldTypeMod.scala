...
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantFieldTypeFieldValueMod.FieldValueContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantFieldTypeFieldValueMod.FieldValueListInstance
...
object libRestPreviewUnderstandAssistantFieldTypeMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the Assistant.
    */
  inline def FieldTypeList(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, assistantSid: String): FieldTypeListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("FieldTypeList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[FieldTypeListInstance]
  ...
  object FieldTypeListInstanceEachOptions {
    ...
    extension [Self <: FieldTypeListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ FieldTypeInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ FieldTypeInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
