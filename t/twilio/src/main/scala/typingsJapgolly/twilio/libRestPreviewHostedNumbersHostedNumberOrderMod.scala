...
object libRestPreviewHostedNumbersHostedNumberOrderMod {
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def HostedNumberOrderList(version: typingsJapgolly.twilio.libRestPreviewHostedNumbersMod.^): HostedNumberOrderListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("HostedNumberOrderList")(version.asInstanceOf[js.Any]).asInstanceOf[HostedNumberOrderListInstance]
  ...
  object HostedNumberOrderListInstanceEachOptions {
    ...
    extension [Self <: HostedNumberOrderListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ HostedNumberOrderInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ HostedNumberOrderInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
