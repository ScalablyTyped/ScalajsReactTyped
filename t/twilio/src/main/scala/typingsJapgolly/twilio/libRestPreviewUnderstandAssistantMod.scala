...
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantAssistantFallbackActionsMod.AssistantFallbackActionsContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantAssistantFallbackActionsMod.AssistantFallbackActionsListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantAssistantInitiationActionsMod.AssistantInitiationActionsContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantAssistantInitiationActionsMod.AssistantInitiationActionsListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantDialogueMod.DialogueContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantDialogueMod.DialogueListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantFieldTypeMod.FieldTypeContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantFieldTypeMod.FieldTypeListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantModelBuildMod.ModelBuildContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantModelBuildMod.ModelBuildListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantQueryMod.QueryContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantQueryMod.QueryListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantStyleSheetMod.StyleSheetContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantStyleSheetMod.StyleSheetListInstance
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskMod.TaskContext
import typingsJapgolly.twilio.libRestPreviewUnderstandAssistantTaskMod.TaskListInstance
...
object libRestPreviewUnderstandAssistantMod {
  ...
  open class AssistantContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def AssistantList(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^): AssistantListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("AssistantList")(version.asInstanceOf[js.Any]).asInstanceOf[AssistantListInstance]
  ...
  object AssistantListInstanceEachOptions {
    ...
    extension [Self <: AssistantListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ AssistantInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ AssistantInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
