...
object libBaseRequestClientMod {
  ...
  open class ^ ()
    ...
    /**
      ...
      */
    /* CompleteClass */
    override def request[TData](opts: RequestOptions[TData, js.Object]): js.Promise[typingsJapgolly.twilio.libHttpResponseMod.^[TData]] = js.native
  }
  ...
  trait RequestClient extends StObject {
    ...
    /**
      ...
      * @param opts The options https.Agent takes in
      */
    def request[TData](opts: RequestOptions[TData, js.Object]): js.Promise[typingsJapgolly.twilio.libHttpResponseMod.^[TData]]
  }
  object RequestClient {
    
    inline def apply(
      request: RequestOptions[Any, js.Object] => js.Promise[typingsJapgolly.twilio.libHttpResponseMod.^[Any]]
    ): RequestClient = {
    ...
    extension [Self <: RequestClient](x: Self) {
      ...
      inline def setRequest(
        value: RequestOptions[Any, js.Object] => js.Promise[typingsJapgolly.twilio.libHttpResponseMod.^[Any]]
