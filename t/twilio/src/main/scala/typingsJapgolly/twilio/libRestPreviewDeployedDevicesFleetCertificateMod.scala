...
object libRestPreviewDeployedDevicesFleetCertificateMod {
  ...
  open class CertificateContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^, fleetSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param fleetSid - The unique identifier of the Fleet.
    */
  inline def CertificateList(version: typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^, fleetSid: String): CertificateListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("CertificateList")(version.asInstanceOf[js.Any], fleetSid.asInstanceOf[js.Any])).asInstanceOf[CertificateListInstance]
  ...
  object CertificateListInstanceEachOptions {
    ...
    extension [Self <: CertificateListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ CertificateInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ CertificateInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
