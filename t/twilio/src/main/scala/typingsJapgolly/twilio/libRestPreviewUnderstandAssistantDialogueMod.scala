...
object libRestPreviewUnderstandAssistantDialogueMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the parent Assistant.
    */
  inline def DialogueList(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, assistantSid: String): DialogueListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DialogueList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[DialogueListInstance]
