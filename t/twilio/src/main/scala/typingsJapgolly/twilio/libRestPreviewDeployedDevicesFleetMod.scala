...
import typingsJapgolly.twilio.libRestPreviewDeployedDevicesFleetCertificateMod.CertificateContext
import typingsJapgolly.twilio.libRestPreviewDeployedDevicesFleetCertificateMod.CertificateListInstance
import typingsJapgolly.twilio.libRestPreviewDeployedDevicesFleetDeploymentMod.DeploymentContext
import typingsJapgolly.twilio.libRestPreviewDeployedDevicesFleetDeploymentMod.DeploymentListInstance
import typingsJapgolly.twilio.libRestPreviewDeployedDevicesFleetDeviceMod.DeviceContext
import typingsJapgolly.twilio.libRestPreviewDeployedDevicesFleetDeviceMod.DeviceListInstance
import typingsJapgolly.twilio.libRestPreviewDeployedDevicesFleetKeyMod.KeyContext
import typingsJapgolly.twilio.libRestPreviewDeployedDevicesFleetKeyMod.KeyListInstance
...
object libRestPreviewDeployedDevicesFleetMod {
  ...
  open class FleetContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^, sid: String) = this()
  ...
  open class FleetInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(
      version: typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^,
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def FleetList(version: typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^): FleetListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("FleetList")(version.asInstanceOf[js.Any]).asInstanceOf[FleetListInstance]
  ...
  open class FleetPage protected ()
    extends typingsJapgolly.twilio.libBasePageMod.^[
          typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^, 
          FleetPayload, 
          FleetResource, 
          FleetInstance
        ] {
  ...
  object FleetListInstanceEachOptions {
    ...
    extension [Self <: FleetListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ FleetInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ FleetInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
