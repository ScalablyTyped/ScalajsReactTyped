  ...
  object SyncListPermissionListInstanceEachOptions {
    ...
    extension [Self <: SyncListPermissionListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ SyncListPermissionInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ SyncListPermissionInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
