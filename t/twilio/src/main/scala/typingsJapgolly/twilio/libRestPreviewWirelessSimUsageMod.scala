...
object libRestPreviewWirelessSimUsageMod {
  ...
  open class UsageContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^, simSid: String) = this()
  ...
  open class UsageInstance protected () extends SerializableClass {
    /**
      ...
      * @param simSid - The sim_sid
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^, payload: UsagePayload, simSid: String) = this()
  ...
  /**
    ...
    * @param simSid - The sim_sid
    */
  inline def UsageList(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^, simSid: String): UsageListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("UsageList")(version.asInstanceOf[js.Any], simSid.asInstanceOf[js.Any])).asInstanceOf[UsageListInstance]
