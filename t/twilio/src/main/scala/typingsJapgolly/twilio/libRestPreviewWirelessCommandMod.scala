...
object libRestPreviewWirelessCommandMod {
  ...
  open class CommandInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^, payload: CommandPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CommandList(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^): CommandListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CommandList")(version.asInstanceOf[js.Any]).asInstanceOf[CommandListInstance]
  ...
  object CommandListInstanceEachOptions {
    ...
    extension [Self <: CommandListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ CommandInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ CommandInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
