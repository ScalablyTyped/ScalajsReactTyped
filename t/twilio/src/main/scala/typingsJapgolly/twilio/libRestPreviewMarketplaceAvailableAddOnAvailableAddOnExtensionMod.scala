  ...
  object AvailableAddOnExtensionListInstanceEachOptions {
    ...
    extension [Self <: AvailableAddOnExtensionListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ AvailableAddOnExtensionInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ AvailableAddOnExtensionInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
