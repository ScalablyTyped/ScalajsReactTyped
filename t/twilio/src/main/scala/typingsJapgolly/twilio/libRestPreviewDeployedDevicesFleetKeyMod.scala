...
object libRestPreviewDeployedDevicesFleetKeyMod {
  ...
  /**
    ...
    * @param fleetSid - The unique identifier of the Fleet.
    */
  inline def KeyList(version: typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^, fleetSid: String): KeyListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("KeyList")(version.asInstanceOf[js.Any], fleetSid.asInstanceOf[js.Any])).asInstanceOf[KeyListInstance]
  ...
  object KeyListInstanceEachOptions {
    ...
    extension [Self <: KeyListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ KeyInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ KeyInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
