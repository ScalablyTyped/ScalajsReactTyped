...
import typingsJapgolly.twilio.libRestPreviewMarketplaceInstalledAddOnInstalledAddOnExtensionMod.InstalledAddOnExtensionContext
import typingsJapgolly.twilio.libRestPreviewMarketplaceInstalledAddOnInstalledAddOnExtensionMod.InstalledAddOnExtensionListInstance
...
object libRestPreviewMarketplaceInstalledAddOnMod {
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def InstalledAddOnList(version: typingsJapgolly.twilio.libRestPreviewMarketplaceMod.^): InstalledAddOnListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("InstalledAddOnList")(version.asInstanceOf[js.Any]).asInstanceOf[InstalledAddOnListInstance]
  ...
  object InstalledAddOnListInstanceEachOptions {
    ...
    extension [Self <: InstalledAddOnListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ InstalledAddOnInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ InstalledAddOnInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
