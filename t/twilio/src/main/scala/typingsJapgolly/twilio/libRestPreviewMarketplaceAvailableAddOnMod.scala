...
import typingsJapgolly.twilio.libRestPreviewMarketplaceAvailableAddOnAvailableAddOnExtensionMod.AvailableAddOnExtensionContext
import typingsJapgolly.twilio.libRestPreviewMarketplaceAvailableAddOnAvailableAddOnExtensionMod.AvailableAddOnExtensionListInstance
...
object libRestPreviewMarketplaceAvailableAddOnMod {
  ...
  open class AvailableAddOnContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewMarketplaceMod.^, sid: String) = this()
  ...
  open class AvailableAddOnInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(
      version: typingsJapgolly.twilio.libRestPreviewMarketplaceMod.^,
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def AvailableAddOnList(version: typingsJapgolly.twilio.libRestPreviewMarketplaceMod.^): AvailableAddOnListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("AvailableAddOnList")(version.asInstanceOf[js.Any]).asInstanceOf[AvailableAddOnListInstance]
  ...
  open class AvailableAddOnPage protected ()
    extends typingsJapgolly.twilio.libBasePageMod.^[
          typingsJapgolly.twilio.libRestPreviewMarketplaceMod.^, 
  ...
  object AvailableAddOnListInstanceEachOptions {
    ...
    extension [Self <: AvailableAddOnListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ AvailableAddOnInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ AvailableAddOnInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
