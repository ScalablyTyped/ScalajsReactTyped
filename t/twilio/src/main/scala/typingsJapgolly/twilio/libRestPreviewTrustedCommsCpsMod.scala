...
object libRestPreviewTrustedCommsCpsMod {
  ...
  open class CpsInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^, payload: CpsPayload) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CpsList(version: typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^): CpsListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CpsList")(version.asInstanceOf[js.Any]).asInstanceOf[CpsListInstance]
