...
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncListSyncListItemMod.SyncListItemContext
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncListSyncListItemMod.SyncListItemListInstance
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncListSyncListPermissionMod.SyncListPermissionContext
import typingsJapgolly.twilio.libRestPreviewSyncServiceSyncListSyncListPermissionMod.SyncListPermissionListInstance
...
object libRestPreviewSyncServiceSyncListMod {
  ...
  open class SyncListContext protected () extends StObject {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewSyncMod.^, serviceSid: String, sid: String) = this()
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def SyncListList(version: typingsJapgolly.twilio.libRestPreviewSyncMod.^, serviceSid: String): SyncListListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SyncListList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[SyncListListInstance]
  ...
  object SyncListListInstanceEachOptions {
    ...
    extension [Self <: SyncListListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ SyncListInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ SyncListInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
