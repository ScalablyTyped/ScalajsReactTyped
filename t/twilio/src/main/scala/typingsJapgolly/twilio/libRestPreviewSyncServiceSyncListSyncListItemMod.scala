  ...
  object SyncListItemListInstanceEachOptions {
    ...
    extension [Self <: SyncListItemListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ SyncListItemInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ SyncListItemInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
