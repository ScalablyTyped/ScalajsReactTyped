...
object libRestPreviewUnderstandAssistantQueryMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the parent Assistant.
    */
  inline def QueryList(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, assistantSid: String): QueryListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("QueryList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[QueryListInstance]
  ...
  object QueryListInstanceEachOptions {
    ...
    extension [Self <: QueryListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ QueryInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ QueryInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
