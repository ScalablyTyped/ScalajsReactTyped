...
import typingsJapgolly.twilio.libRestPreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrderMod.DependentHostedNumberOrderListInstance
...
object libRestPreviewHostedNumbersAuthorizationDocumentMod {
  ...
  open class AuthorizationDocumentContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewHostedNumbersMod.^, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def AuthorizationDocumentList(version: typingsJapgolly.twilio.libRestPreviewHostedNumbersMod.^): AuthorizationDocumentListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("AuthorizationDocumentList")(version.asInstanceOf[js.Any]).asInstanceOf[AuthorizationDocumentListInstance]
  ...
  object AuthorizationDocumentListInstanceEachOptions {
    ...
    extension [Self <: AuthorizationDocumentListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ AuthorizationDocumentInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ AuthorizationDocumentInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twilio.twilioStrings.opened
    - typingsJapgolly.twilio.twilioStrings.signing
    - typingsJapgolly.twilio.twilioStrings.signed
    - typingsJapgolly.twilio.twilioStrings.canceled
  ...
  */
  ...
  object AuthorizationDocumentStatus {
    ...
    inline def canceled: typingsJapgolly.twilio.twilioStrings.canceled = "canceled".asInstanceOf[typingsJapgolly.twilio.twilioStrings.canceled]
    ...
    inline def opened: typingsJapgolly.twilio.twilioStrings.opened = "opened".asInstanceOf[typingsJapgolly.twilio.twilioStrings.opened]
    
    inline def signed: typingsJapgolly.twilio.twilioStrings.signed = "signed".asInstanceOf[typingsJapgolly.twilio.twilioStrings.signed]
    
    inline def signing: typingsJapgolly.twilio.twilioStrings.signing = "signing".asInstanceOf[typingsJapgolly.twilio.twilioStrings.signing]
  }
}
