...
object libRestPreviewDeployedDevicesFleetDeviceMod {
  ...
  /**
    ...
    * @param fleetSid - The unique identifier of the Fleet.
    */
  inline def DeviceList(version: typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^, fleetSid: String): DeviceListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DeviceList")(version.asInstanceOf[js.Any], fleetSid.asInstanceOf[js.Any])).asInstanceOf[DeviceListInstance]
  ...
  object DeviceListInstanceEachOptions {
    ...
    extension [Self <: DeviceListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ DeviceInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ DeviceInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
