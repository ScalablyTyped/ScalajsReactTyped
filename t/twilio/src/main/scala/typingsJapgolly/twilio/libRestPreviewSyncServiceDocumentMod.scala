...
import typingsJapgolly.twilio.libRestPreviewSyncServiceDocumentDocumentPermissionMod.DocumentPermissionContext
import typingsJapgolly.twilio.libRestPreviewSyncServiceDocumentDocumentPermissionMod.DocumentPermissionListInstance
...
object libRestPreviewSyncServiceDocumentMod {
  ...
  /**
    ...
    * @param serviceSid - The service_sid
    */
  inline def DocumentList(version: typingsJapgolly.twilio.libRestPreviewSyncMod.^, serviceSid: String): DocumentListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DocumentList")(version.asInstanceOf[js.Any], serviceSid.asInstanceOf[js.Any])).asInstanceOf[DocumentListInstance]
  ...
  object DocumentListInstanceEachOptions {
    ...
    extension [Self <: DocumentListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ DocumentInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ DocumentInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
