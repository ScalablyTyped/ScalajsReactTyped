...
object libRestPreviewTrustedCommsCurrentCallMod {
  ...
  open class CurrentCallContext protected () extends StObject {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^) = this()
  ...
  open class CurrentCallInstance protected () extends SerializableClass {
    /**
      ...
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^, payload: CurrentCallPayload) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def CurrentCallList(version: typingsJapgolly.twilio.libRestPreviewTrustedCommsMod.^): CurrentCallListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("CurrentCallList")(version.asInstanceOf[js.Any]).asInstanceOf[CurrentCallListInstance]
