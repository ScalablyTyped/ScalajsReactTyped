...
object libRestPreviewUnderstandAssistantTaskSampleMod {
  ...
  /**
    ...
    * @param taskSid - The unique ID of the Task associated with this Sample.
    */
  inline def SampleList(
    version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^,
    assistantSid: String,
    taskSid: String
  ): SampleListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("SampleList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], taskSid.asInstanceOf[js.Any])).asInstanceOf[SampleListInstance]
  ...
  object SampleListInstanceEachOptions {
    ...
    extension [Self <: SampleListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ SampleInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ SampleInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
