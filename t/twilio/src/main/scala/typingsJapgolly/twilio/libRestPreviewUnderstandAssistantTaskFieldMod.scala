...
object libRestPreviewUnderstandAssistantTaskFieldMod {
  ...
  /**
    ...
    * @param taskSid - The unique ID of the Task associated with this Field.
    */
  inline def FieldList(
    version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^,
    assistantSid: String,
    taskSid: String
  ): FieldListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("FieldList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], taskSid.asInstanceOf[js.Any])).asInstanceOf[FieldListInstance]
  ...
  object FieldListInstanceEachOptions {
    ...
    extension [Self <: FieldListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ FieldInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ FieldInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
