...
object libRestApiV2010Mod {
  ...
  open class ^ protected () extends V2010 {
    /**
      ...
      */
    def this(domain: typingsJapgolly.twilio.libRestApiMod.^) = this()
  }
  ...
  trait V2010
    ...
    var account: /* import warning: transforms.QualifyReferences#resolveTypeRef many Couldn't qualify AccountContext */ Any = js.native
