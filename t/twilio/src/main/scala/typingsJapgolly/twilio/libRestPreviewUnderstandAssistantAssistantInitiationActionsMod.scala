...
object libRestPreviewUnderstandAssistantAssistantInitiationActionsMod {
  ...
  /**
    ...
    * @param assistantSid - The assistant_sid
    */
  inline def AssistantInitiationActionsList(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, assistantSid: String): AssistantInitiationActionsListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("AssistantInitiationActionsList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[AssistantInitiationActionsListInstance]
