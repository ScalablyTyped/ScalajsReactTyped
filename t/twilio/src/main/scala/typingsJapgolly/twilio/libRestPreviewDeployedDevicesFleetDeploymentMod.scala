...
object libRestPreviewDeployedDevicesFleetDeploymentMod {
  ...
  /**
    ...
    * @param fleetSid - The unique identifier of the Fleet.
    */
  inline def DeploymentList(version: typingsJapgolly.twilio.libRestPreviewDeployedDevicesMod.^, fleetSid: String): DeploymentListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("DeploymentList")(version.asInstanceOf[js.Any], fleetSid.asInstanceOf[js.Any])).asInstanceOf[DeploymentListInstance]
  ...
  object DeploymentListInstanceEachOptions {
    ...
    extension [Self <: DeploymentListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ DeploymentInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ DeploymentInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
