...
object libRestPreviewUnderstandAssistantTaskTaskActionsMod {
  ...
  /**
    ...
    * @param taskSid - The unique ID of the Task.
    */
  inline def TaskActionsList(
    version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^,
    assistantSid: String,
    taskSid: String
  ): TaskActionsListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("TaskActionsList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any], taskSid.asInstanceOf[js.Any])).asInstanceOf[TaskActionsListInstance]
