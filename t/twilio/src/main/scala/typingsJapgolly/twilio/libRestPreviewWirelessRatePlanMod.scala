...
object libRestPreviewWirelessRatePlanMod {
  ...
  open class RatePlanInstance protected () extends SerializableClass {
    /**
      ...
      * @param sid - The sid
      */
    def this(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^, payload: RatePlanPayload, sid: String) = this()
  ...
  /**
    ...
    * @param version - Version of the resource
    */
  inline def RatePlanList(version: typingsJapgolly.twilio.libRestPreviewWirelessMod.^): RatePlanListInstance = ^.asInstanceOf[js.Dynamic].applyDynamic("RatePlanList")(version.asInstanceOf[js.Any]).asInstanceOf[RatePlanListInstance]
  ...
  object RatePlanListInstanceEachOptions {
    ...
    extension [Self <: RatePlanListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ RatePlanInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ RatePlanInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
