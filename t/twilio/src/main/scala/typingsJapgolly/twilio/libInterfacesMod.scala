...
import typingsJapgolly.twilio.twilioStrings.get_
import typingsJapgolly.twilio.twilioStrings.post_
...
object libInterfacesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twilio.twilioStrings.get_
    - typingsJapgolly.twilio.twilioStrings.post_
    - typingsJapgolly.twilio.twilioStrings.put
    - typingsJapgolly.twilio.twilioStrings.patch
    - typingsJapgolly.twilio.twilioStrings.delete
  */
  trait HttpMethod extends StObject
  object HttpMethod {
    
    inline def delete: typingsJapgolly.twilio.twilioStrings.delete = "delete".asInstanceOf[typingsJapgolly.twilio.twilioStrings.delete]
    
    inline def get: get_ = "get".asInstanceOf[get_]
    
    inline def patch: typingsJapgolly.twilio.twilioStrings.patch = "patch".asInstanceOf[typingsJapgolly.twilio.twilioStrings.patch]
    
    inline def post: post_ = "post".asInstanceOf[post_]
    
    inline def put: typingsJapgolly.twilio.twilioStrings.put = "put".asInstanceOf[typingsJapgolly.twilio.twilioStrings.put]
  }
  ...
  object ListEachOptions {
    ...
    extension [Self <: ListEachOptions[?], TInstance](x: Self & ListEachOptions[TInstance]) {
      ...
      inline def setCallback(
        value: (/* item */ TInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ TInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
      
      inline def setCallbackUndefined: Self = StObject.set(x, "callback", js.undefined)
      
      inline def setDone(value: /* err */ js.UndefOr[js.Error] => Callback): Self = StObject.set(x, "done", js.Any.fromFunction1((t0: /* err */ js.UndefOr[js.Error]) => value(t0).runNow()))
  ...
  object ListOptions {
    ...
    extension [Self <: ListOptions[?], TInstance](x: Self & ListOptions[TInstance]) {
      ...
      inline def setCallback(value: /* items */ js.Array[TInstance] => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* items */ js.Array[TInstance]) => value(t0).runNow()))
  ...
  object PageOptions {
    ...
    extension [Self <: PageOptions[?], TPage](x: Self & PageOptions[TPage]) {
      ...
      inline def setCallback(value: /* page */ TPage => Callback): Self = StObject.set(x, "callback", js.Any.fromFunction1((t0: /* page */ TPage) => value(t0).runNow()))
