...
object libRestPreviewUnderstandAssistantModelBuildMod {
  ...
  /**
    ...
    * @param assistantSid - The unique ID of the parent Assistant.
    */
  inline def ModelBuildList(version: typingsJapgolly.twilio.libRestPreviewUnderstandMod.^, assistantSid: String): ModelBuildListInstance = (^.asInstanceOf[js.Dynamic].applyDynamic("ModelBuildList")(version.asInstanceOf[js.Any], assistantSid.asInstanceOf[js.Any])).asInstanceOf[ModelBuildListInstance]
  ...
  object ModelBuildListInstanceEachOptions {
    ...
    extension [Self <: ModelBuildListInstanceEachOptions](x: Self) {
      ...
      inline def setCallback(
        value: (/* item */ ModelBuildInstance, /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => Callback
      ): Self = StObject.set(x, "callback", js.Any.fromFunction2((t0: /* item */ ModelBuildInstance, t1: /* done */ js.Function1[/* err */ js.UndefOr[js.Error], Unit]) => (value(t0, t1)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twilio.twilioStrings.enqueued
    - typingsJapgolly.twilio.twilioStrings.building
  ...
  */
  ...
  object ModelBuildStatus {
    ...
    inline def building: typingsJapgolly.twilio.twilioStrings.building = "building".asInstanceOf[typingsJapgolly.twilio.twilioStrings.building]
    ...
    inline def enqueued: typingsJapgolly.twilio.twilioStrings.enqueued = "enqueued".asInstanceOf[typingsJapgolly.twilio.twilioStrings.enqueued]
