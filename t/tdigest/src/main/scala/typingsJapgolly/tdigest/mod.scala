...
import typingsJapgolly.tdigest.anon.PartialDigestConfiguratio
import typingsJapgolly.tdigest.tdigestBooleans.`false`
import typingsJapgolly.tdigest.tdigestBooleans.`true`
