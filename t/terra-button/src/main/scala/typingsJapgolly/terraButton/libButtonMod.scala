...
import typingsJapgolly.terraButton.terraButtonStrings.`additions removals`
import typingsJapgolly.terraButton.terraButtonStrings.`additions text`
import typingsJapgolly.terraButton.terraButtonStrings.`inline`
import typingsJapgolly.terraButton.terraButtonStrings.`removals additions`
import typingsJapgolly.terraButton.terraButtonStrings.`removals text`
import typingsJapgolly.terraButton.terraButtonStrings.`text additions`
import typingsJapgolly.terraButton.terraButtonStrings.`text removals`
import typingsJapgolly.terraButton.terraButtonStrings.additions
import typingsJapgolly.terraButton.terraButtonStrings.all
import typingsJapgolly.terraButton.terraButtonStrings.ascending
import typingsJapgolly.terraButton.terraButtonStrings.assertive
import typingsJapgolly.terraButton.terraButtonStrings.both
import typingsJapgolly.terraButton.terraButtonStrings.copy
import typingsJapgolly.terraButton.terraButtonStrings.date
import typingsJapgolly.terraButton.terraButtonStrings.decimal
import typingsJapgolly.terraButton.terraButtonStrings.descending
import typingsJapgolly.terraButton.terraButtonStrings.dialog
import typingsJapgolly.terraButton.terraButtonStrings.email
import typingsJapgolly.terraButton.terraButtonStrings.execute
import typingsJapgolly.terraButton.terraButtonStrings.grammar
import typingsJapgolly.terraButton.terraButtonStrings.grid
import typingsJapgolly.terraButton.terraButtonStrings.horizontal
import typingsJapgolly.terraButton.terraButtonStrings.inherit
import typingsJapgolly.terraButton.terraButtonStrings.link
import typingsJapgolly.terraButton.terraButtonStrings.list
import typingsJapgolly.terraButton.terraButtonStrings.listbox
import typingsJapgolly.terraButton.terraButtonStrings.location
import typingsJapgolly.terraButton.terraButtonStrings.menu
import typingsJapgolly.terraButton.terraButtonStrings.mixed
import typingsJapgolly.terraButton.terraButtonStrings.move
import typingsJapgolly.terraButton.terraButtonStrings.no
import typingsJapgolly.terraButton.terraButtonStrings.none
import typingsJapgolly.terraButton.terraButtonStrings.numeric
import typingsJapgolly.terraButton.terraButtonStrings.off
import typingsJapgolly.terraButton.terraButtonStrings.on
import typingsJapgolly.terraButton.terraButtonStrings.other
import typingsJapgolly.terraButton.terraButtonStrings.page
import typingsJapgolly.terraButton.terraButtonStrings.polite
import typingsJapgolly.terraButton.terraButtonStrings.popup
import typingsJapgolly.terraButton.terraButtonStrings.removals
import typingsJapgolly.terraButton.terraButtonStrings.search
import typingsJapgolly.terraButton.terraButtonStrings.spelling
import typingsJapgolly.terraButton.terraButtonStrings.step
import typingsJapgolly.terraButton.terraButtonStrings.tel
import typingsJapgolly.terraButton.terraButtonStrings.text
import typingsJapgolly.terraButton.terraButtonStrings.time
import typingsJapgolly.terraButton.terraButtonStrings.tree
import typingsJapgolly.terraButton.terraButtonStrings.url
import typingsJapgolly.terraButton.terraButtonStrings.vertical
import typingsJapgolly.terraButton.terraButtonStrings.yes
...
object libButtonMod {
  ...
  @JSImport("terra-button/lib/Button", JSImport.Default)
  @js.native
  open class default[T /* <: HTMLAnchorElement | HTMLButtonElement */] ()
    extends Component[ButtonProps[T], js.Object, Any]
  /* static members */
  object default {
    ...
    @JSImport("terra-button/lib/Button", "default.Opts")
    @js.native
  ...
  @js.native
  sealed trait ButtonTypes extends StObject
  @JSImport("terra-button/lib/Button", "ButtonTypes")
  @js.native
  object ButtonTypes extends StObject {
    
    @JSBracketAccess
    def apply(value: String): js.UndefOr[ButtonTypes & String] = js.native
  ...
  @js.native
  sealed trait ButtonVariants extends StObject
  @JSImport("terra-button/lib/Button", "ButtonVariants")
  @js.native
  object ButtonVariants extends StObject {
    
    @JSBracketAccess
    def apply(value: String): js.UndefOr[ButtonVariants & String] = js.native
  ...
  type Button[T /* <: HTMLAnchorElement | HTMLButtonElement */] = japgolly.scalajs.react.facade.React.Component[ButtonProps[T] & js.Object, js.Object]
  
  /* Inlined parent terra-button.terra-button/lib/Button.Omit<react.react.HTMLAttributes<T>, terra-button.terra-button/lib/Button.OmittedKeys> */
  trait ButtonProps[T /* <: HTMLButtonElement | HTMLAnchorElement */] extends StObject {
    ...
    /**
      ...
      */
    var refCallback: js.UndefOr[Ref[T]] = js.undefined
    ...
    /**
      ...
      */
    var variant: js.UndefOr[ButtonVariants] = js.undefined
    
    var vocab: js.UndefOr[String] = js.undefined
  }
  object ButtonProps {
    
    inline def apply[T /* <: HTMLButtonElement | HTMLAnchorElement */](text: String): ButtonProps[T] = {
    ...
    extension [Self <: ButtonProps[?], T /* <: HTMLButtonElement | HTMLAnchorElement */](x: Self & ButtonProps[T]) {
      ...
      inline def setRefCallback(value: Ref[T]): Self = StObject.set(x, "refCallback", value.asInstanceOf[js.Any])
      
      inline def setRefCallbackFunction1(value: T | Null => Callback): Self = StObject.set(x, "refCallback", js.Any.fromFunction1((t0: T | Null) => value(t0).runNow()))
      
      inline def setRefCallbackNull: Self = StObject.set(x, "refCallback", null)
      
      inline def setRefCallbackUndefined: Self = StObject.set(x, "refCallback", js.undefined)
      ...
      inline def setVariant(value: ButtonVariants): Self = StObject.set(x, "variant", value.asInstanceOf[js.Any])
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.terraButton.terraButtonStrings.`type`
    - typingsJapgolly.terraButton.terraButtonStrings.disabled
    - typingsJapgolly.terraButton.terraButtonStrings.tabIndex
    - typingsJapgolly.terraButton.terraButtonStrings.`aria-disabled`
    - typingsJapgolly.terraButton.terraButtonStrings.`aria-label`
  */
  trait OmittedKeys extends StObject
  object OmittedKeys {
    
    inline def `aria-disabled`: typingsJapgolly.terraButton.terraButtonStrings.`aria-disabled` = "aria-disabled".asInstanceOf[typingsJapgolly.terraButton.terraButtonStrings.`aria-disabled`]
    
    inline def `aria-label`: typingsJapgolly.terraButton.terraButtonStrings.`aria-label` = "aria-label".asInstanceOf[typingsJapgolly.terraButton.terraButtonStrings.`aria-label`]
    
    inline def disabled: typingsJapgolly.terraButton.terraButtonStrings.disabled = "disabled".asInstanceOf[typingsJapgolly.terraButton.terraButtonStrings.disabled]
    
    inline def tabIndex: typingsJapgolly.terraButton.terraButtonStrings.tabIndex = "tabIndex".asInstanceOf[typingsJapgolly.terraButton.terraButtonStrings.tabIndex]
    
    inline def `type`: typingsJapgolly.terraButton.terraButtonStrings.`type` = "type".asInstanceOf[typingsJapgolly.terraButton.terraButtonStrings.`type`]
  }
}
