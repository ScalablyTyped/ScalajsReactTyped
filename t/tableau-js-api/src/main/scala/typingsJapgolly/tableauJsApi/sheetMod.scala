...
import typingsJapgolly.tableauJsApi.enumsMod.DashboardObjectType
import typingsJapgolly.tableauJsApi.enumsMod.FilterUpdateType
import typingsJapgolly.tableauJsApi.enumsMod.SelectionUpdateType
import typingsJapgolly.tableauJsApi.enumsMod.SheetType
import typingsJapgolly.tableauJsApi.filteringMod.Filter
import typingsJapgolly.tableauJsApi.filteringMod.FilterOptions
import typingsJapgolly.tableauJsApi.filteringMod.HierarchicalFilterOptions
import typingsJapgolly.tableauJsApi.filteringMod.RangeFilterOptions
import typingsJapgolly.tableauJsApi.filteringMod.RelativeDateFilterOptions
import typingsJapgolly.tableauJsApi.marksMod.Mark
import typingsJapgolly.tableauJsApi.otherMod.Point
import typingsJapgolly.tableauJsApi.otherMod.Size
import typingsJapgolly.tableauJsApi.tableauJsApiStrings.EXACTLY
import typingsJapgolly.tableauJsApi.tableauJsApiStrings.RANGE
import typingsJapgolly.tableauJsApi.workbookMod.DataSource
...
object sheetMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tableauJsApi.anon.Behavior
    - typingsJapgolly.tableauJsApi.anon.MaxSize
    - typingsJapgolly.tableauJsApi.anon.BehaviorMaxSize
    - typingsJapgolly.tableauJsApi.anon.MinSize
  */
  trait SheetSizeOptions extends StObject
  object SheetSizeOptions {
    
    inline def Behavior(): typingsJapgolly.tableauJsApi.anon.Behavior = {
      val __obj = js.Dynamic.literal(behavior = "AUTOMATIC")
      __obj.asInstanceOf[typingsJapgolly.tableauJsApi.anon.Behavior]
    }
    
    inline def BehaviorMaxSize(maxSize: SheetSize): typingsJapgolly.tableauJsApi.anon.BehaviorMaxSize = {
      val __obj = js.Dynamic.literal(behavior = "ATMOST", maxSize = maxSize.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tableauJsApi.anon.BehaviorMaxSize]
    }
    
    inline def MaxSize(behavior: EXACTLY | RANGE, maxSize: SheetSize, minSize: SheetSize): typingsJapgolly.tableauJsApi.anon.MaxSize = {
      ...
      __obj.asInstanceOf[typingsJapgolly.tableauJsApi.anon.MaxSize]
    }
    
    inline def MinSize(minSize: SheetSize): typingsJapgolly.tableauJsApi.anon.MinSize = {
      val __obj = js.Dynamic.literal(behavior = "ATLEAST", minSize = minSize.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tableauJsApi.anon.MinSize]
    }
  }
}
