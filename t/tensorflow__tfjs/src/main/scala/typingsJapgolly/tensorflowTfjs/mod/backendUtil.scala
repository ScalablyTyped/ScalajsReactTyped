...
import typingsJapgolly.tensorflowTfjs.tensorflowTfjsNumbers.`30`
...
object backendUtil extends js.Object {
  ...
  def computeConv2DInfo(
    ...
    roundingMode: typingsJapgolly.tensorflowTfjs.tensorflowTfjsStrings.floor | typingsJapgolly.tensorflowTfjs.tensorflowTfjsStrings.round | typingsJapgolly.tensorflowTfjs.tensorflowTfjsStrings.ceil
