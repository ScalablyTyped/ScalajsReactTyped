...
object serialization {
  ...
  open class Serializable ()
    extends typingsJapgolly.tensorflowTfjsCore.mod.serialization.Serializable
  /* static members */
  object Serializable {
  ...
  /* private */ open class SerializationMap ()
    extends typingsJapgolly.tensorflowTfjsCore.mod.serialization.SerializationMap
  /* static members */
