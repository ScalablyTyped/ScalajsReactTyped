package typingsJapgolly.tensorflowTfjs.mod.webgl
...
import typingsJapgolly.tensorflowTfjs.tensorflowTfjsNumbers.`1`
import typingsJapgolly.tensorflowTfjs.tensorflowTfjsNumbers.`2`
