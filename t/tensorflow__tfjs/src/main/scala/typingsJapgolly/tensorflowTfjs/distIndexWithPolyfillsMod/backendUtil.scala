...
import typingsJapgolly.tensorflowTfjs.tensorflowTfjsStrings.channelsFirst
import typingsJapgolly.tensorflowTfjs.tensorflowTfjsStrings.channelsLast
...
import typingsJapgolly.tensorflowTfjsCore.anon.AllDims
import typingsJapgolly.tensorflowTfjsCore.anon.Begin
import typingsJapgolly.tensorflowTfjsCore.anon.ExpandDims
import typingsJapgolly.tensorflowTfjsCore.anon.Imag
import typingsJapgolly.tensorflowTfjsCore.anon.Path
import typingsJapgolly.tensorflowTfjsCore.anon.Real
...
import typingsJapgolly.tensorflowTfjsCore.distOpsRaggedToDenseUtilMod.RowPartitionType
import typingsJapgolly.tensorflowTfjsCore.distOpsScatterNdUtilMod.ScatterShapeInfo
import typingsJapgolly.tensorflowTfjsCore.distOpsSegmentUtilMod.GatherOpShapeInfo
import typingsJapgolly.tensorflowTfjsCore.distOpsSliceUtilMod.SliceInfo_
...
object backendUtil {
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util")
  @js.native
  val ^ : js.Any = js.native
  
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.ERF_A1")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.ERF_A5")
  @js.native
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.RowPartitionType")
  @js.native
  object RowPartitionType extends StObject {
    
    @JSBracketAccess
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.tensorflowTfjsCore.distOpsRaggedToDenseUtilMod.RowPartitionType & Double
      ] = js.native
    
    /* 0 */ val FIRST_DIM_SIZE: typingsJapgolly.tensorflowTfjsCore.distOpsRaggedToDenseUtilMod.RowPartitionType.FIRST_DIM_SIZE & Double = js.native
    
    /* 2 */ val ROW_LENGTHS: typingsJapgolly.tensorflowTfjsCore.distOpsRaggedToDenseUtilMod.RowPartitionType.ROW_LENGTHS & Double = js.native
    
    /* 4 */ val ROW_LIMITS: typingsJapgolly.tensorflowTfjsCore.distOpsRaggedToDenseUtilMod.RowPartitionType.ROW_LIMITS & Double = js.native
    
    /* 3 */ val ROW_SPLITS: typingsJapgolly.tensorflowTfjsCore.distOpsRaggedToDenseUtilMod.RowPartitionType.ROW_SPLITS & Double = js.native
    
    /* 5 */ val ROW_STARTS: typingsJapgolly.tensorflowTfjsCore.distOpsRaggedToDenseUtilMod.RowPartitionType.ROW_STARTS & Double = js.native
    
    /* 1 */ val VALUE_ROWIDS: typingsJapgolly.tensorflowTfjsCore.distOpsRaggedToDenseUtilMod.RowPartitionType.VALUE_ROWIDS & Double = js.native
  }
  ...
  @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "backend_util.SELU_SCALEALPHA")
  @js.native
  val SELU_SCALEALPHA: /* 1.7580993408473768 */ Double = js.native
  
  inline def applyActivation(x: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank], activation: Activation): Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] = (^.asInstanceOf[js.Dynamic].applyDynamic("applyActivation")(x.asInstanceOf[js.Any], activation.asInstanceOf[js.Any])).asInstanceOf[Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank]]
  ...
  ): Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] = (^.asInstanceOf[js.Dynamic].applyDynamic("applyActivation")(x.asInstanceOf[js.Any], activation.asInstanceOf[js.Any], preluActivationWeights.asInstanceOf[js.Any], leakyreluAlpha.asInstanceOf[js.Any])).asInstanceOf[Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank]]
  inline def applyActivation(
    x: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank],
    activation: Activation,
    preluActivationWeights: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank]
  ): Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] = (^.asInstanceOf[js.Dynamic].applyDynamic("applyActivation")(x.asInstanceOf[js.Any], activation.asInstanceOf[js.Any], preluActivationWeights.asInstanceOf[js.Any])).asInstanceOf[Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank]]
  inline def applyActivation(
    x: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank],
    activation: Activation,
    preluActivationWeights: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank],
  ...
  inline def checkEinsumDimSizes(
    ...
    tensors: js.Array[Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank]]
  ...
  inline def checkPadOnDimRoundingMode(opDesc: String, pad: valid | same): Unit = (^.asInstanceOf[js.Dynamic].applyDynamic("checkPadOnDimRoundingMode")(opDesc.asInstanceOf[js.Any], pad.asInstanceOf[js.Any])).asInstanceOf[Unit]
  ...
  inline def getFusedBiasGradient(
    bias: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank],
    dyActivation: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank]
  ): Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] = (^.asInstanceOf[js.Dynamic].applyDynamic("getFusedBiasGradient")(bias.asInstanceOf[js.Any], dyActivation.asInstanceOf[js.Any])).asInstanceOf[Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank]]
  
  inline def getFusedDyActivation(
    dy: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank],
    y: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank],
    activation: Activation
  ): Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank] = (^.asInstanceOf[js.Dynamic].applyDynamic("getFusedDyActivation")(dy.asInstanceOf[js.Any], y.asInstanceOf[js.Any], activation.asInstanceOf[js.Any])).asInstanceOf[Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank]]
  ...
  inline def prepareSplitSize(x: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank], numOrSizeSplits: js.Array[Double]): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSplitSize")(x.asInstanceOf[js.Any], numOrSizeSplits.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
  ...
  inline def prepareSplitSize(x: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank], numOrSizeSplits: Double): js.Array[Double] = (^.asInstanceOf[js.Dynamic].applyDynamic("prepareSplitSize")(x.asInstanceOf[js.Any], numOrSizeSplits.asInstanceOf[js.Any])).asInstanceOf[js.Array[Double]]
  inline def prepareSplitSize(
    x: Tensor[typingsJapgolly.tensorflowTfjsCore.distTypesMod.Rank],
