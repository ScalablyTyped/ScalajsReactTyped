...
object layers {
  ...
  /* note: abstract class */ @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "layers.Layer")
  @js.native
  open class Layer ()
    extends typingsJapgolly.tensorflowTfjs.mod.layers.Layer {
  ...
  /* note: abstract class */ @JSImport("@tensorflow/tfjs/dist/index_with_polyfills", "layers.RNNCell")
  @js.native
  open class RNNCell ()
    extends typingsJapgolly.tensorflowTfjs.mod.layers.RNNCell {
    def this(args: LayerArgs) = this()
  }
