...
import typingsJapgolly.tampermonkey.tampermonkeyStrings.browser
import typingsJapgolly.tampermonkey.tampermonkeyStrings.disabled
import typingsJapgolly.tampermonkey.tampermonkeyStrings.native
