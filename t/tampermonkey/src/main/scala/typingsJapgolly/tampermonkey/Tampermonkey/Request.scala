...
import typingsJapgolly.tampermonkey.tampermonkeyStrings.GET
import typingsJapgolly.tampermonkey.tampermonkeyStrings.HEAD
import typingsJapgolly.tampermonkey.tampermonkeyStrings.POST
import typingsJapgolly.tampermonkey.tampermonkeyStrings.arraybuffer
import typingsJapgolly.tampermonkey.tampermonkeyStrings.blob
import typingsJapgolly.tampermonkey.tampermonkeyStrings.json
...
object Request {
  ...
  extension [Self <: Request[?], TContext](x: Self & Request[TContext]) {
    ...
    inline def setOnabort(value: Callback): Self = StObject.set(x, "onabort", value.toJsFn)
