...
import typingsJapgolly.tampermonkey.Tampermonkey.ContentType
...
import typingsJapgolly.tampermonkey.Tampermonkey.OpenTabObject
import typingsJapgolly.tampermonkey.Tampermonkey.OpenTabOptions
import typingsJapgolly.tampermonkey.Tampermonkey.Request
import typingsJapgolly.tampermonkey.Tampermonkey.Response
import typingsJapgolly.tampermonkey.Tampermonkey.ScriptInfo
import typingsJapgolly.tampermonkey.Tampermonkey.ValueChangeListener
...
object global {
  ...
  object Tampermonkey {
    ...
    object ReadyState extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.tampermonkey.Tampermonkey.ReadyState & Double] = js.native
      
      /* 4 */ val Done: typingsJapgolly.tampermonkey.Tampermonkey.ReadyState.Done & Double = js.native
      
      /* 2 */ val HeadersReceived: typingsJapgolly.tampermonkey.Tampermonkey.ReadyState.HeadersReceived & Double = js.native
      
      /* 3 */ val Loading: typingsJapgolly.tampermonkey.Tampermonkey.ReadyState.Loading & Double = js.native
      
      /* 1 */ val Opened: typingsJapgolly.tampermonkey.Tampermonkey.ReadyState.Opened & Double = js.native
      
      /* 0 */ val Unsent: typingsJapgolly.tampermonkey.Tampermonkey.ReadyState.Unsent & Double = js.native
    }
  }
