...
import typingsJapgolly.tabbable.tabbableStrings.`legacy-full`
import typingsJapgolly.tabbable.tabbableStrings.`non-zero-area`
import typingsJapgolly.tabbable.tabbableStrings.full
import typingsJapgolly.tabbable.tabbableStrings.none
