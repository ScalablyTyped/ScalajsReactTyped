...
import typingsJapgolly.tensorflowTfjsConverter.compiledApiMod.IGraphDef
import typingsJapgolly.tensorflowTfjsConverter.compiledApiMod.ISignatureDef
import typingsJapgolly.tensorflowTfjsConverter.compiledApiMod.ITensorShape
...
object operationMapperMod extends js.Object {
  ...
  def parseDtypeParam(value: typingsJapgolly.tensorflowTfjsConverter.compiledApiMod.DataType): DataType = js.native
