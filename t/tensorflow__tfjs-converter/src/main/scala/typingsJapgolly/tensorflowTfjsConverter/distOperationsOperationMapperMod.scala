...
import typingsJapgolly.tensorflowTfjsConverter.distDataCompiledApiMod.IGraphDef
import typingsJapgolly.tensorflowTfjsConverter.distDataCompiledApiMod.ISignatureDef
import typingsJapgolly.tensorflowTfjsConverter.distDataCompiledApiMod.ITensorShape
...
object distOperationsOperationMapperMod {
  ...
  inline def parseDtypeParam(value: typingsJapgolly.tensorflowTfjsConverter.distDataCompiledApiMod.DataType): DataType = ^.asInstanceOf[js.Dynamic].applyDynamic("parseDtypeParam")(value.asInstanceOf[js.Any]).asInstanceOf[DataType]
