...
import typingsJapgolly.tensorflowTfjsConverter.distOperationsTypesMod.InputParamValue
...
import typingsJapgolly.tensorflowTfjsConverter.distOperationsTypesMod.ParamValue
