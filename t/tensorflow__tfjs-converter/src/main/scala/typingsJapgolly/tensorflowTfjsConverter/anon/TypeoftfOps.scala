...
import typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.bool
import typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.complex64
import typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.euclidean
import typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.float32
import typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.fro
import typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.int32
import typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.left
import typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.right
...
trait TypeoftfOps extends StObject {
  ...
  def booleanMaskAsync(
    tensor: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    mask: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]
  ): js.Promise[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def booleanMaskAsync(
    tensor: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    mask: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    axis: Double
  ): js.Promise[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def booleanMaskAsync(tensor: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], mask: TensorLike): js.Promise[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def booleanMaskAsync(
    tensor: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    mask: TensorLike,
    axis: Double
  ): js.Promise[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def booleanMaskAsync(tensor: TensorLike, mask: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): js.Promise[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def booleanMaskAsync(
    tensor: TensorLike,
    mask: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    axis: Double
  ): js.Promise[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def booleanMaskAsync(tensor: TensorLike, mask: TensorLike): js.Promise[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def booleanMaskAsync(tensor: TensorLike, mask: TensorLike, axis: Double): js.Promise[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  ...
  ): TensorBuffer[R, typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.string] = js.native
  def buffer[R /* <: Rank */](
    shape: /* import warning: importer.ImportType#apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: Unit,
  ...
  def buffer_string[R /* <: Rank */](
    shape: /* import warning: importer.ImportType#apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
    dtype: typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.string
  ): TensorBuffer[R, typingsJapgolly.tensorflowTfjsConverter.tensorflowTfjsConverterStrings.string] = js.native
  @JSName("buffer")
  def buffer_string[R /* <: Rank */](
    shape: /* import warning: importer.ImportType#apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any,
  ...
  def diag(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def dot(
    t1: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    t2: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]
  ): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dot(t1: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], t2: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dot(t1: TensorLike, t2: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dot(t1: TensorLike, t2: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  
  def dropout(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], rate: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dropout(
  ...
  def dropout(x: TensorLike, rate: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dropout(x: TensorLike, rate: Double, noiseShape: js.Array[Double]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dropout(x: TensorLike, rate: Double, noiseShape: js.Array[Double], seed: String): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dropout(x: TensorLike, rate: Double, noiseShape: js.Array[Double], seed: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dropout(x: TensorLike, rate: Double, noiseShape: Unit, seed: String): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def dropout(x: TensorLike, rate: Double, noiseShape: Unit, seed: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  
  def einsum(equation: String, tensors: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]*): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def euclideanNorm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: js.Array[Double]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(
    x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    axis: js.Array[Double],
    keepDims: Boolean
  ): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: Double, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: Unit, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: TensorLike, axis: js.Array[Double]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: TensorLike, axis: js.Array[Double], keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: TensorLike, axis: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: TensorLike, axis: Double, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def euclideanNorm(x: TensorLike, axis: Unit, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def fft(input: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def gatherND(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], indices: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def gatherND(x: TensorLike, indices: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def gatherND(x: TensorLike, indices: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  
  val greater: Typeofgreater = js.native
  
  val greaterEqual: TypeofgreaterEqual = js.native
  
  def ifft(input: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def irfft(input: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def lowerBound(
    sortedSequence: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    values: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]
  ): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def lowerBound(sortedSequence: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], values: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def lowerBound(sortedSequence: TensorLike, values: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def lowerBound(sortedSequence: TensorLike, values: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def meshgrid[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](): js.Array[T] = js.native
  def meshgrid[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: T | TensorLike): js.Array[T] = js.native
  def meshgrid[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: T | TensorLike, y: T | TensorLike): js.Array[T] = js.native
  def meshgrid[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: T | TensorLike, y: T | TensorLike, hasIndexing: Indexing): js.Array[T] = js.native
  def meshgrid[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: T | TensorLike, y: Unit, hasIndexing: Indexing): js.Array[T] = js.native
  def meshgrid[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: Unit, y: T | TensorLike): js.Array[T] = js.native
  def meshgrid[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: Unit, y: T | TensorLike, hasIndexing: Indexing): js.Array[T] = js.native
  def meshgrid[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: Unit, y: Unit, hasIndexing: Indexing): js.Array[T] = js.native
  ...
  def moments(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): Mean = js.native
  def moments(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: js.Array[Double]): Mean = js.native
  def moments(
    x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    axis: js.Array[Double],
    keepDims: Boolean
  ): Mean = js.native
  def moments(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: Double): Mean = js.native
  def moments(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: Double, keepDims: Boolean): Mean = js.native
  def moments(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: Unit, keepDims: Boolean): Mean = js.native
  ...
  def norm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], ord: euclidean | fro): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(
    x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    ord: euclidean | fro,
    axis: js.Array[Double]
  ...
  def norm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], ord: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(
    x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    ord: Double,
    axis: js.Array[Double]
  ...
  def norm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], ord: Double, axis: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(
    x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    ord: Double,
    axis: Double,
  ...
  def norm(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], ord: Unit, axis: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(
    x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    ord: Unit,
    axis: Double,
  ...
  def norm(x: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: euclidean | fro): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: euclidean | fro, axis: js.Array[Double]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: euclidean | fro, axis: js.Array[Double], keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: euclidean | fro, axis: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: euclidean | fro, axis: Double, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: euclidean | fro, axis: Unit, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Double, axis: js.Array[Double]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Double, axis: js.Array[Double], keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Double, axis: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Double, axis: Double, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Double, axis: Unit, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Unit, axis: js.Array[Double]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Unit, axis: js.Array[Double], keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Unit, axis: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Unit, axis: Double, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def norm(x: TensorLike, ord: Unit, axis: Unit, keepDims: Boolean): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  
  val notEqual: TypeofnotEqual = js.native
  
  def oneHot(indices: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], depth: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def oneHot(
    indices: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    depth: Double,
    onValue: Double
  ...
  def oneHot(indices: TensorLike, depth: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def oneHot(indices: TensorLike, depth: Double, onValue: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def oneHot(indices: TensorLike, depth: Double, onValue: Double, offValue: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def oneHot(indices: TensorLike, depth: Double, onValue: Double, offValue: Double, dtype: DataType): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def oneHot(indices: TensorLike, depth: Double, onValue: Double, offValue: Unit, dtype: DataType): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def oneHot(indices: TensorLike, depth: Double, onValue: Unit, offValue: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def oneHot(indices: TensorLike, depth: Double, onValue: Unit, offValue: Double, dtype: DataType): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def oneHot(indices: TensorLike, depth: Double, onValue: Unit, offValue: Unit, dtype: DataType): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def print[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: T): Unit = js.native
  def print[T /* <: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] */](x: T, verbose: Boolean): Unit = js.native
  
  val prod: Typeofprod = js.native
  
  def raggedGather(
    paramsNestedSplits: js.Array[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]],
    paramsDenseValues: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    indices: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
  ...
  def raggedRange(
    starts: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    limits: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    deltas: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]
  ...
  def raggedTensorToTensor(
    shape: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    values: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    defaultValue: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    rowPartitionTensors: js.Array[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]],
  ...
  def rfft(input: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def rfft(input: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], fftLength: Double): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def searchSorted(sortedSequence: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], values: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def searchSorted(
    sortedSequence: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    values: TensorLike,
    side: left | right
  ): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def searchSorted(sortedSequence: TensorLike, values: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def searchSorted(
    sortedSequence: TensorLike,
    values: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    side: left | right
  ): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def searchSorted(sortedSequence: TensorLike, values: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def searchSorted(sortedSequence: TensorLike, values: TensorLike, side: left | right): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  ...
  def setdiff1dAsync(
    x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    y: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]
  ): js.Promise[
    js.Tuple2[
  ...
  def setdiff1dAsync(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], y: TensorLike): js.Promise[
    js.Tuple2[
      typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], 
      typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]
    ]
  ] = js.native
  def setdiff1dAsync(x: TensorLike, y: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): js.Promise[
    js.Tuple2[
      typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], 
      typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]
    ]
  ...
  def stridedSlice(
    x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] | TensorLike,
  ...
  def tensor[R /* <: Rank */](values: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R] = js.native
  def tensor[R /* <: Rank */](
    values: TensorLike,
    shape: /* import warning: importer.ImportType#apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any
  ): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R] = js.native
  ...
  def tensor[R /* <: Rank */](values: TensorLike, shape: Unit, dtype: DataType): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R] = js.native
  def tensor[R /* <: Rank */](values: WebGLData): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R] = js.native
  def tensor[R /* <: Rank */](
    values: WebGLData,
    shape: /* import warning: importer.ImportType#apply Failed type conversion: @tensorflow/tfjs-core.@tensorflow/tfjs-core/dist/types.ShapeMap[R] */ js.Any
  ): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R] = js.native
  ...
  def tensor[R /* <: Rank */](values: WebGLData, shape: Unit, dtype: DataType): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R] = js.native
  ...
  def unstack(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): js.Array[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def unstack(x: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], axis: Double): js.Array[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def unstack(x: TensorLike): js.Array[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  def unstack(x: TensorLike, axis: Double): js.Array[typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]] = js.native
  
  def upperBound(
    sortedSequence: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank],
    values: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]
  ): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def upperBound(sortedSequence: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank], values: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def upperBound(sortedSequence: TensorLike, values: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  def upperBound(sortedSequence: TensorLike, values: TensorLike): typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank] = js.native
  
  def variable[R /* <: Rank */](initialValue: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R]): Variable[R] = js.native
  def variable[R /* <: Rank */](initialValue: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R], trainable: Boolean): Variable[R] = js.native
  def variable[R /* <: Rank */](
    initialValue: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[R],
    trainable: Boolean,
    name: String
  ...
  def whereAsync(condition: typingsJapgolly.tensorflowTfjsCore.distTensorMod.Tensor[Rank]): js.Promise[Tensor2D] = js.native
