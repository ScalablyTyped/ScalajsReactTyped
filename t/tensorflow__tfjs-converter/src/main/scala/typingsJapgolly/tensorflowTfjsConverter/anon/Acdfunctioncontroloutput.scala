...
trait Acdfunctioncontroloutput extends StObject {
...
object Acdfunctioncontroloutput {
  ...
  inline def apply(
    ...
    __obj.asInstanceOf[Acdfunctioncontroloutput]
  }
  
  extension [Self <: Acdfunctioncontroloutput](x: Self) {
