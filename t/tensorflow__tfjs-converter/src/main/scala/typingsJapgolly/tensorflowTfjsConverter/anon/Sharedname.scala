...
trait Sharedname extends StObject {
  ...
  var _acd_function_control_output: B
...
object Sharedname {
  ...
  extension [Self <: Sharedname](x: Self) {
    ...
    inline def set_acd_function_control_output(value: B): Self = StObject.set(x, "_acd_function_control_output", value.asInstanceOf[js.Any])
