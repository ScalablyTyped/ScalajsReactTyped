...
object distExecutorExecutionContextMod {
  ...
  open class ExecutionContext () extends StObject {
    ...
    def currentContext: js.Array[ExecutionContextInfo] = js.native
    ...
    /**
      ...
      * frames
      */
    def currentContext_=(contexts: js.Array[ExecutionContextInfo]): Unit = js.native
