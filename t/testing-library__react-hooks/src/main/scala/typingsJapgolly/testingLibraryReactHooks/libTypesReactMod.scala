...
import typingsJapgolly.testingLibraryReactHooks.libTypesMod.ServerRenderHookResult
import typingsJapgolly.testingLibraryReactHooks.libTypesMod.ServerRenderer
...
object libTypesReactMod {
  ...
  trait RenderHookOptions[TProps]
    extends StObject
       with typingsJapgolly.testingLibraryReactHooks.libTypesMod.RenderHookOptions[TProps] {
