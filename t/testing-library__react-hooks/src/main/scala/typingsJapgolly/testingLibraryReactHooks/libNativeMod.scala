...
import typingsJapgolly.reactTestRenderer.mod.VoidOrUndefinedOnly
import typingsJapgolly.std.Omit
import typingsJapgolly.testingLibraryReactHooks.anon.Render
...
object libNativeMod {
  ...
  @JSImport("@testing-library/react-hooks/lib/native", JSImport.Namespace)
  @js.native
  ...
  inline def renderHook[TProps, TResult](callback: js.Function1[/* props */ TProps, TResult]): (Rerender[TResult, TProps]) & (Omit[Render[TProps], render | act | rerender | unmount]) = ^.asInstanceOf[js.Dynamic].applyDynamic("renderHook")(callback.asInstanceOf[js.Any]).asInstanceOf[(Rerender[TResult, TProps]) & (Omit[Render[TProps], render | act | rerender | unmount])]
  ...
  ): (Rerender[TResult, TProps]) & (Omit[Render[TProps], render | act | rerender | unmount]) = (^.asInstanceOf[js.Dynamic].applyDynamic("renderHook")(callback.asInstanceOf[js.Any], options.asInstanceOf[js.Any])).asInstanceOf[(Rerender[TResult, TProps]) & (Omit[Render[TProps], render | act | rerender | unmount])]
