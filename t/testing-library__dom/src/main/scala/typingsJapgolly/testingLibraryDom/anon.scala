...
object anon {
  ...
  object PartialConfig {
    ...
    extension [Self <: PartialConfig](x: Self) {
      ...
      inline def setEventWrapper(value: /* cb */ js.Function1[/* repeated */ Any, Any] => Callback): Self = StObject.set(x, "eventWrapper", js.Any.fromFunction1((t0: /* cb */ js.Function1[/* repeated */ Any, Any]) => value(t0).runNow()))
