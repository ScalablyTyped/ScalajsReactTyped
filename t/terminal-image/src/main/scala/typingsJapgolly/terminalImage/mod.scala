package typingsJapgolly.terminalImage

import typingsJapgolly.terminalImage.anon.ReadonlyBuffer
import typingsJapgolly.terminalImage.anon.Readonlywidthstringnumber
import typingsJapgolly.terminalImage.anon.ReadonlywidthstringnumberHeight
...
object mod {
  ...
  object default {
    ...
    @JSImport("terminal-image", JSImport.Default)
    @js.native
