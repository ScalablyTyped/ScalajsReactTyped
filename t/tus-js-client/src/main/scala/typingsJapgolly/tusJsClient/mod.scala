...
import typingsJapgolly.tusJsClient.anon.End
import typingsJapgolly.tusJsClient.anon.PickReadableStreamDefault
...
object mod {
  ...
  object FileSource {
    ...
    inline def apply(close: Callback, size: Double, slice: (Double, Double) => js.Promise[SliceResult]): FileSource = {
      val __obj = js.Dynamic.literal(close = close.toJsFn, size = size.asInstanceOf[js.Any], slice = js.Any.fromFunction2(slice))
  ...
  object HttpRequest {
    ...
    inline def apply(
      ...
      getUnderlyingObject: CallbackTo[Any],
      send: Any => js.Promise[HttpResponse],
      setHeader: (String, String) => Callback,
      setProgressHandler: js.Function1[/* bytesSent */ Double, Unit] => Callback
    ): HttpRequest = {
      val __obj = js.Dynamic.literal(abort = abort.toJsFn, getHeader = js.Any.fromFunction1(getHeader), getMethod = getMethod.toJsFn, getURL = getURL.toJsFn, getUnderlyingObject = getUnderlyingObject.toJsFn, send = js.Any.fromFunction1(send), setHeader = js.Any.fromFunction2((t0: String, t1: String) => (setHeader(t0, t1)).runNow()), setProgressHandler = js.Any.fromFunction1((t0: js.Function1[/* bytesSent */ Double, Unit]) => setProgressHandler(t0).runNow()))
    ...
    extension [Self <: HttpRequest](x: Self) {
      ...
      inline def setGetUnderlyingObject(value: CallbackTo[Any]): Self = StObject.set(x, "getUnderlyingObject", value.toJsFn)
      ...
      inline def setSetProgressHandler(value: js.Function1[/* bytesSent */ Double, Unit] => Callback): Self = StObject.set(x, "setProgressHandler", js.Any.fromFunction1((t0: js.Function1[/* bytesSent */ Double, Unit]) => value(t0).runNow()))
    }
  }
  ...
  object HttpResponse {
    ...
    inline def apply(
      ...
      val __obj = js.Dynamic.literal(getBody = getBody.toJsFn, getHeader = js.Any.fromFunction1(getHeader), getStatus = getStatus.toJsFn, getUnderlyingObject = getUnderlyingObject.toJsFn)
    ...
    extension [Self <: HttpResponse](x: Self) {
      ...
      inline def setGetStatus(value: CallbackTo[Double]): Self = StObject.set(x, "getStatus", value.toJsFn)
  ...
  object HttpStack {
    ...
    inline def apply(createRequest: (String, String) => HttpRequest, getName: CallbackTo[String]): HttpStack = {
      val __obj = js.Dynamic.literal(createRequest = js.Any.fromFunction2(createRequest), getName = getName.toJsFn)
  ...
  object UploadOptions {
    ...
    extension [Self <: UploadOptions](x: Self) {
      ...
      inline def setOnAfterResponse(value: (/* req */ HttpRequest, /* res */ HttpResponse) => Callback): Self = StObject.set(x, "onAfterResponse", js.Any.fromFunction2((t0: /* req */ HttpRequest, t1: /* res */ HttpResponse) => (value(t0, t1)).runNow()))
      
      inline def setOnAfterResponseUndefined: Self = StObject.set(x, "onAfterResponse", js.undefined)
      
      inline def setOnBeforeRequest(value: /* req */ HttpRequest => Callback): Self = StObject.set(x, "onBeforeRequest", js.Any.fromFunction1((t0: /* req */ HttpRequest) => value(t0).runNow()))
      
      inline def setOnBeforeRequestUndefined: Self = StObject.set(x, "onBeforeRequest", js.undefined)
      
      inline def setOnChunkComplete(value: (/* chunkSize */ Double, /* bytesAccepted */ Double, /* bytesTotal */ Double) => Callback): Self = StObject.set(x, "onChunkComplete", js.Any.fromFunction3((t0: /* chunkSize */ Double, t1: /* bytesAccepted */ Double, t2: /* bytesTotal */ Double) => (value(t0, t1, t2)).runNow()))
      ...
      inline def setOnError(value: /* error */ js.Error | DetailedError => Callback): Self = StObject.set(x, "onError", js.Any.fromFunction1((t0: /* error */ js.Error | DetailedError) => value(t0).runNow()))
      
      inline def setOnErrorNull: Self = StObject.set(x, "onError", null)
      
      inline def setOnErrorUndefined: Self = StObject.set(x, "onError", js.undefined)
      
      inline def setOnProgress(value: (/* bytesSent */ Double, /* bytesTotal */ Double) => Callback): Self = StObject.set(x, "onProgress", js.Any.fromFunction2((t0: /* bytesSent */ Double, t1: /* bytesTotal */ Double) => (value(t0, t1)).runNow()))
  ...
  object UrlStorage {
    ...
    inline def apply(
      ...
      findAllUploads: CallbackTo[js.Promise[js.Array[PreviousUpload]]],
      findUploadsByFingerprint: String => js.Promise[js.Array[PreviousUpload]],
      removeUpload: String => js.Promise[Unit]
    ): UrlStorage = {
      val __obj = js.Dynamic.literal(addUpload = js.Any.fromFunction2(addUpload), findAllUploads = findAllUploads.toJsFn, findUploadsByFingerprint = js.Any.fromFunction1(findUploadsByFingerprint), removeUpload = js.Any.fromFunction1(removeUpload))
    ...
    extension [Self <: UrlStorage](x: Self) {
      ...
      inline def setFindAllUploads(value: CallbackTo[js.Promise[js.Array[PreviousUpload]]]): Self = StObject.set(x, "findAllUploads", value.toJsFn)
