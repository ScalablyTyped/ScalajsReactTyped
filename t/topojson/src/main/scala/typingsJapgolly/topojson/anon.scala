...
object anon {
  ...
  trait Geometries extends StObject {
    ...
    var `type`: typingsJapgolly.topojson.topojsonStrings.GeometryCollection
  }
  object Geometries {
    ...
    extension [Self <: Geometries](x: Self) {
      ...
      inline def setType(value: typingsJapgolly.topojson.topojsonStrings.GeometryCollection): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    }
  }
}
