...
object anon {
  ...
  object CreateOptionsFileOptionss {
    ...
    extension [Self <: CreateOptionsFileOptionss](x: Self) {
      ...
      inline def setOnwarn(value: (/* message */ String, /* data */ Buffer) => Callback): Self = StObject.set(x, "onwarn", js.Any.fromFunction2((t0: /* message */ String, t1: /* data */ Buffer) => (value(t0, t1)).runNow()))
  ...
  object ExtractOptionsFileOptions {
    ...
    extension [Self <: ExtractOptionsFileOptions](x: Self) {
      ...
      inline def setOnentry(value: /* entry */ ReadEntry => Callback): Self = StObject.set(x, "onentry", js.Any.fromFunction1((t0: /* entry */ ReadEntry) => value(t0).runNow()))
