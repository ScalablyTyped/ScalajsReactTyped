...
import typingsJapgolly.tar.tarStrings.close
import typingsJapgolly.tar.tarStrings.end
import typingsJapgolly.tar.tarStrings.entry
...
object mod {
  ...
  object ParseOptions {
    ...
    extension [Self <: ParseOptions](x: Self) {
      ...
      inline def setOnwarn(value: (/* code */ String, /* message */ String, /* data */ Buffer) => Callback): Self = StObject.set(x, "onwarn", js.Any.fromFunction3((t0: /* code */ String, t1: /* message */ String, t2: /* data */ Buffer) => (value(t0, t1, t2)).runNow()))
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tar.anon.File
    - typingsJapgolly.tar.anon.F
  */
  trait RequiredFileOptions extends StObject
  object RequiredFileOptions {
    
    inline def F(f: String): typingsJapgolly.tar.anon.F = {
      val __obj = js.Dynamic.literal(f = f.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tar.anon.F]
    }
    
    inline def File(file: String): typingsJapgolly.tar.anon.File = {
      val __obj = js.Dynamic.literal(file = file.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tar.anon.File]
    }
  }
