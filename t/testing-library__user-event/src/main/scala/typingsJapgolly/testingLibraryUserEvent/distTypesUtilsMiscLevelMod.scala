...
object distTypesUtilsMiscLevelMod {
  ...
  object ApiLevel extends StObject {
    ...
    sealed trait Call
      extends StObject
         with ApiLevel
    /* 1 */ val Call: typingsJapgolly.testingLibraryUserEvent.distTypesUtilsMiscLevelMod.ApiLevel.Call & Double = js.native
    
    @js.native
    sealed trait Trigger
      extends StObject
         with ApiLevel
    /* 2 */ val Trigger: typingsJapgolly.testingLibraryUserEvent.distTypesUtilsMiscLevelMod.ApiLevel.Trigger & Double = js.native
  }
