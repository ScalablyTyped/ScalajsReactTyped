...
import typingsJapgolly.testingLibraryUserEvent.distTypesOptionsMod.PointerEventsCheckLevel
...
trait DirectOptionskeyboardStat extends StObject {
  ...
  var keyboardState: js.UndefOr[typingsJapgolly.testingLibraryUserEvent.distTypesSystemMod.System] = js.undefined
  ...
  var pointerState: js.UndefOr[typingsJapgolly.testingLibraryUserEvent.distTypesSystemMod.System] = js.undefined
...
object DirectOptionskeyboardStat {
  ...
  extension [Self <: DirectOptionskeyboardStat](x: Self) {
    ...
    inline def setKeyboardState(value: typingsJapgolly.testingLibraryUserEvent.distTypesSystemMod.System): Self = StObject.set(x, "keyboardState", value.asInstanceOf[js.Any])
    ...
    inline def setPointerState(value: typingsJapgolly.testingLibraryUserEvent.distTypesSystemMod.System): Self = StObject.set(x, "pointerState", value.asInstanceOf[js.Any])
