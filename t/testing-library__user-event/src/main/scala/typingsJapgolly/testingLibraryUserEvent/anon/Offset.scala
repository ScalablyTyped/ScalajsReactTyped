...
trait Offset extends StObject {
  ...
  var node: typingsJapgolly.testingLibraryUserEvent.distTypesDocumentPrepareDocumentMod.global.Node
...
object Offset {
  ...
  inline def apply(
    node: typingsJapgolly.testingLibraryUserEvent.distTypesDocumentPrepareDocumentMod.global.Node,
    offset: Double
  ): Offset = {
