...
import typingsJapgolly.testingLibraryUserEvent.distTypesSetupDirectApiMod.DirectOptions
...
object mod {
  ...
  object PointerEventsCheckLevel extends StObject {
    ...
    def apply(value: Double): js.UndefOr[
        typingsJapgolly.testingLibraryUserEvent.distTypesOptionsMod.PointerEventsCheckLevel & Double
      ] = js.native
