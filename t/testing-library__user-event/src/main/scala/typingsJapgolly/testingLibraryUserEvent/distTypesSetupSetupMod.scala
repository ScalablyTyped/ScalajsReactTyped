...
import typingsJapgolly.testingLibraryUserEvent.anon.Api
import typingsJapgolly.testingLibraryUserEvent.anon.DirectOptionskeyboardStat
import typingsJapgolly.testingLibraryUserEvent.anon.FnCall
import typingsJapgolly.testingLibraryUserEvent.anon.RequiredOptions
...
object distTypesSetupSetupMod {
  ...
  inline def setupDirect(): typingsJapgolly.testingLibraryUserEvent.anon.System = ^.asInstanceOf[js.Dynamic].applyDynamic("setupDirect")().asInstanceOf[typingsJapgolly.testingLibraryUserEvent.anon.System]
  inline def setupDirect(hasKeyboardStatePointerStateOptions: Unit, // backward-compatibility
  node: Node): typingsJapgolly.testingLibraryUserEvent.anon.System = (^.asInstanceOf[js.Dynamic].applyDynamic("setupDirect")(hasKeyboardStatePointerStateOptions.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.testingLibraryUserEvent.anon.System]
  inline def setupDirect(hasKeyboardStatePointerStateOptions: DirectOptionskeyboardStat): typingsJapgolly.testingLibraryUserEvent.anon.System = ^.asInstanceOf[js.Dynamic].applyDynamic("setupDirect")(hasKeyboardStatePointerStateOptions.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.testingLibraryUserEvent.anon.System]
  inline def setupDirect(
    hasKeyboardStatePointerStateOptions: DirectOptionskeyboardStat,
    // backward-compatibility
  node: Node
  ): typingsJapgolly.testingLibraryUserEvent.anon.System = (^.asInstanceOf[js.Dynamic].applyDynamic("setupDirect")(hasKeyboardStatePointerStateOptions.asInstanceOf[js.Any], node.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.testingLibraryUserEvent.anon.System]
