...
import typingsJapgolly.testingLibraryUserEvent.anon.Alt
import typingsJapgolly.testingLibraryUserEvent.anon.UnpreventedDefault
...
object distTypesSystemKeyboardMod {
  ...
  object DOM_KEY_LOCATION extends StObject {
    ...
    /* 1 */ val LEFT: typingsJapgolly.testingLibraryUserEvent.distTypesSystemKeyboardMod.DOM_KEY_LOCATION.LEFT & Double = js.native
    
    @js.native
    sealed trait NUMPAD
      extends StObject
         with DOM_KEY_LOCATION
    /* 3 */ val NUMPAD: typingsJapgolly.testingLibraryUserEvent.distTypesSystemKeyboardMod.DOM_KEY_LOCATION.NUMPAD & Double = js.native
    
    @js.native
    sealed trait RIGHT
      extends StObject
         with DOM_KEY_LOCATION
    /* 2 */ val RIGHT: typingsJapgolly.testingLibraryUserEvent.distTypesSystemKeyboardMod.DOM_KEY_LOCATION.RIGHT & Double = js.native
    
    @js.native
    sealed trait STANDARD
      extends StObject
         with DOM_KEY_LOCATION
    /* 0 */ val STANDARD: typingsJapgolly.testingLibraryUserEvent.distTypesSystemKeyboardMod.DOM_KEY_LOCATION.STANDARD & Double = js.native
  }
