...
object mod {
  ...
  trait TinderRecommendation extends StObject {
    ...
    // todo
    var teaser: typingsJapgolly.tinder.anon.String
  ...
  object TinderRecommendation {
    ...
    inline def apply(
      ...
      teaser: typingsJapgolly.tinder.anon.String,
    ...
    extension [Self <: TinderRecommendation](x: Self) {
      ...
      inline def setTeaser(value: typingsJapgolly.tinder.anon.String): Self = StObject.set(x, "teaser", value.asInstanceOf[js.Any])
