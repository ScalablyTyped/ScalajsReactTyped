...
import typingsJapgolly.titanium.Titanium.Calendar.Alert
import typingsJapgolly.titanium.Titanium.Calendar.Calendar
...
@js.native
trait TypeofCalendarATTENDEEROLECHAIR extends js.Object {
  /**
