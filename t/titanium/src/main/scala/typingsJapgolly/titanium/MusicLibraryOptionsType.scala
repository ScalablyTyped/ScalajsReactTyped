...
object MusicLibraryOptionsType {
  ...
  def apply(
    ...
    success: /* param0 */ MusicLibraryResponseType => CallbackTo[js.Any] = null
    ...
    if (success != null) __obj.updateDynamic("success")(js.Any.fromFunction1((t0: /* param0 */ typingsJapgolly.titanium.MusicLibraryResponseType) => success(t0).runNow()))
