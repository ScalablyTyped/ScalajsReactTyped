...
object TypeofSystemButton {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(ACTION = ACTION.asInstanceOf[js.Any], ACTIVITY = ACTIVITY.asInstanceOf[js.Any], ADD = ADD.asInstanceOf[js.Any], BOOKMARKS = BOOKMARKS.asInstanceOf[js.Any], CAMERA = CAMERA.asInstanceOf[js.Any], CANCEL = CANCEL.asInstanceOf[js.Any], COMPOSE = COMPOSE.asInstanceOf[js.Any], CONTACT_ADD = CONTACT_ADD.asInstanceOf[js.Any], DISCLOSURE = DISCLOSURE.asInstanceOf[js.Any], DONE = DONE.asInstanceOf[js.Any], EDIT = EDIT.asInstanceOf[js.Any], FAST_FORWARD = FAST_FORWARD.asInstanceOf[js.Any], FIXED_SPACE = FIXED_SPACE.asInstanceOf[js.Any], FLEXIBLE_SPACE = FLEXIBLE_SPACE.asInstanceOf[js.Any], INFO_DARK = INFO_DARK.asInstanceOf[js.Any], INFO_LIGHT = INFO_LIGHT.asInstanceOf[js.Any], ORGANIZE = ORGANIZE.asInstanceOf[js.Any], PAUSE = PAUSE.asInstanceOf[js.Any], PLAY = PLAY.asInstanceOf[js.Any], REFRESH = REFRESH.asInstanceOf[js.Any], REPLY = REPLY.asInstanceOf[js.Any], REWIND = REWIND.asInstanceOf[js.Any], SAVE = SAVE.asInstanceOf[js.Any], SPINNER = SPINNER.asInstanceOf[js.Any], STOP = STOP.asInstanceOf[js.Any], TRASH = TRASH.asInstanceOf[js.Any], apiName = apiName.asInstanceOf[js.Any], bubbleParent = bubbleParent.asInstanceOf[js.Any])
