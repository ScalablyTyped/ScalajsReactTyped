...
import typingsJapgolly.titanium.Titanium.Geolocation.Android.LocationProvider
import typingsJapgolly.titanium.Titanium.Geolocation.Android.LocationRule
