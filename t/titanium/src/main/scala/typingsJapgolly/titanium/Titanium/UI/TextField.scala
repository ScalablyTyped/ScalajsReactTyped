...
import typingsJapgolly.titanium.textFieldSelectedParams
...
trait TextField extends View {
  ...
  /**
  			 ...
  			 */
  var keyboardToolbar: js.Array[View] | typingsJapgolly.titanium.Titanium.UI.iOS.Toolbar = js.native
  /**
  ...
  /**
  			 ...
  			 */
  def getKeyboardToolbar(): js.Array[View] | typingsJapgolly.titanium.Titanium.UI.iOS.Toolbar = js.native
  /**
  ...
  /**
  			 * Sets the value of the <Titanium.UI.TextField.keyboardToolbar> property.
  			 */
  def setKeyboardToolbar(keyboardToolbar: typingsJapgolly.titanium.Titanium.UI.iOS.Toolbar): Unit = js.native
  /**
