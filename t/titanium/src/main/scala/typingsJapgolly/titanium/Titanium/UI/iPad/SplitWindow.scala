package typingsJapgolly.titanium.Titanium.UI.iPad
...
import typingsJapgolly.titanium.Titanium.UI.NavigationWindow
import typingsJapgolly.titanium.Titanium.UI.View
import typingsJapgolly.titanium.openWindowParams
import typingsJapgolly.titanium.titleAttributesParams
import typingsJapgolly.titanium.windowToolbarParam
...
trait SplitWindow extends Proxy {
  ...
  /**
  				 ...
  				 */
  def getDetailView(): View = js.native
  /**
  ...
  /**
  				 ...
  				 */
  def getMasterView(): View = js.native
  /**
  ...
  /**
  				 ...
  				 */
  def setDetailView(detailView: js.Any): Unit = js.native
  /**
  ...
  /**
  				 ...
  				 */
  def setMasterView(masterView: js.Any): Unit = js.native
  /**
