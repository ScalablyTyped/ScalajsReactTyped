...
import typingsJapgolly.titanium.TableViewAnimationProperties
import typingsJapgolly.titanium.TableViewContentInsetOption
import typingsJapgolly.titanium.TableViewEdgeInsets
import typingsJapgolly.titanium.TableViewIndexEntry
