...
object ListViewStyle {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(GROUPED = GROUPED.asInstanceOf[js.Any], PLAIN = PLAIN.asInstanceOf[js.Any], apiName = apiName.asInstanceOf[js.Any], bubbleParent = bubbleParent.asInstanceOf[js.Any])
