...
import typingsJapgolly.titanium.animationOption
...
trait SplitWindow extends Proxy {
  ...
  /**
  				 ...
  				 */
  val navigationWindow: typingsJapgolly.titanium.Titanium.UI.NavigationWindow = js.native
  /**
  ...
  /**
  				 ...
  				 */
  def getNavigationWindow(): typingsJapgolly.titanium.Titanium.UI.NavigationWindow = js.native
  /**
