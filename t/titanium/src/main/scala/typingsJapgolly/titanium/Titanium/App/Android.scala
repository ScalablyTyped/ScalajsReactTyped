package typingsJapgolly.titanium.Titanium.App

import typingsJapgolly.titanium.Titanium.Android.Intent
...
object Android extends js.Object {
  /**
  			 ...
  			 */
  val R: typingsJapgolly.titanium.Titanium.App.Android.R = js.native
  /**
