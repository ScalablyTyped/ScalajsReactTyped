...
object AttributedString {
  ...
  def apply(
    ...
    __obj.updateDynamic("addAttribute")(js.Any.fromFunction1((t0: typingsJapgolly.titanium.Titanium.UI.iOS.Attribute) => addAttribute(t0).runNow()))
    ...
    __obj.updateDynamic("setAttributes")(js.Any.fromFunction1((t0: js.Array[typingsJapgolly.titanium.Titanium.UI.iOS.Attribute]) => setAttributes(t0).runNow()))
