...
object TypeofSystemButtonStyle {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(BORDERED = BORDERED.asInstanceOf[js.Any], DONE = DONE.asInstanceOf[js.Any], PLAIN = PLAIN.asInstanceOf[js.Any], apiName = apiName.asInstanceOf[js.Any], bubbleParent = bubbleParent.asInstanceOf[js.Any])
