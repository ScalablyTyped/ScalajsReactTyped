...
import typingsJapgolly.titanium.Titanium.UI.iOS.AdView
import typingsJapgolly.titanium.Titanium.UI.iOS.AnchorAttachmentBehavior
import typingsJapgolly.titanium.Titanium.UI.iOS.Animator
import typingsJapgolly.titanium.Titanium.UI.iOS.ApplicationShortcuts
import typingsJapgolly.titanium.Titanium.UI.iOS.AttributedString
import typingsJapgolly.titanium.Titanium.UI.iOS.BlurView
import typingsJapgolly.titanium.Titanium.UI.iOS.CollisionBehavior
import typingsJapgolly.titanium.Titanium.UI.iOS.CoverFlowView
import typingsJapgolly.titanium.Titanium.UI.iOS.DocumentViewer
import typingsJapgolly.titanium.Titanium.UI.iOS.DynamicItemBehavior
import typingsJapgolly.titanium.Titanium.UI.iOS.FeedbackGenerator
import typingsJapgolly.titanium.Titanium.UI.iOS.GravityBehavior
import typingsJapgolly.titanium.Titanium.UI.iOS.LivePhotoView
import typingsJapgolly.titanium.Titanium.UI.iOS.MenuPopup
import typingsJapgolly.titanium.Titanium.UI.iOS.NavigationWindow
import typingsJapgolly.titanium.Titanium.UI.iOS.PreviewAction
import typingsJapgolly.titanium.Titanium.UI.iOS.PreviewActionGroup
import typingsJapgolly.titanium.Titanium.UI.iOS.PreviewContext
import typingsJapgolly.titanium.Titanium.UI.iOS.PushBehavior
import typingsJapgolly.titanium.Titanium.UI.iOS.SnapBehavior
import typingsJapgolly.titanium.Titanium.UI.iOS.SplitWindow
import typingsJapgolly.titanium.Titanium.UI.iOS.Stepper
import typingsJapgolly.titanium.Titanium.UI.iOS.TabbedBar
import typingsJapgolly.titanium.Titanium.UI.iOS.Toolbar
import typingsJapgolly.titanium.Titanium.UI.iOS.ViewAttachmentBehavior
import typingsJapgolly.titanium.Titanium.UI.iOS.WebViewConfiguration
import typingsJapgolly.titanium.Titanium.UI.iOS.WebViewDecisionHandler
import typingsJapgolly.titanium.Titanium.UI.iOS.WebViewProcessPool
...
trait TypeofiOS extends js.Object {
  ...
  /**
  			 ...
  			 */
  def createAttribute(): typingsJapgolly.titanium.Titanium.UI.iOS.Attribute = js.native
  def createAttribute(parameters: js.Any): typingsJapgolly.titanium.Titanium.UI.iOS.Attribute = js.native
  /**
