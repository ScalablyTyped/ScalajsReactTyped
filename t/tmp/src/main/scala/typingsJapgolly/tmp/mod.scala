...
import typingsJapgolly.tmp.tmpBooleans.`true`
...
object mod {
  ...
  object DirResult {
    ...
    inline def apply(name: String, removeCallback: Callback): DirResult = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], removeCallback = removeCallback.toJsFn)
    ...
    extension [Self <: DirResult](x: Self) {
      ...
      inline def setRemoveCallback(value: Callback): Self = StObject.set(x, "removeCallback", value.toJsFn)
    }
  }
  ...
  object FileResult {
    ...
    inline def apply(fd: Double, name: String, removeCallback: Callback): FileResult = {
      val __obj = js.Dynamic.literal(fd = fd.asInstanceOf[js.Any], name = name.asInstanceOf[js.Any], removeCallback = removeCallback.toJsFn)
  ...
  object FileResultNoFd {
    ...
    inline def apply(name: String, removeCallback: Callback): FileResultNoFd = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], removeCallback = removeCallback.toJsFn)
