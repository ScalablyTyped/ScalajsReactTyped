...
import typingsJapgolly.typedoc.typedocStrings.`datetime-local`
import typingsJapgolly.typedoc.typedocStrings.button
import typingsJapgolly.typedoc.typedocStrings.checkbox
import typingsJapgolly.typedoc.typedocStrings.color
import typingsJapgolly.typedoc.typedocStrings.date
import typingsJapgolly.typedoc.typedocStrings.email
import typingsJapgolly.typedoc.typedocStrings.file
import typingsJapgolly.typedoc.typedocStrings.hidden
import typingsJapgolly.typedoc.typedocStrings.image
import typingsJapgolly.typedoc.typedocStrings.month
import typingsJapgolly.typedoc.typedocStrings.number
import typingsJapgolly.typedoc.typedocStrings.password
import typingsJapgolly.typedoc.typedocStrings.radio
import typingsJapgolly.typedoc.typedocStrings.range
...
import typingsJapgolly.typedoc.typedocStrings.tel
import typingsJapgolly.typedoc.typedocStrings.text
import typingsJapgolly.typedoc.typedocStrings.time
import typingsJapgolly.typedoc.typedocStrings.url
import typingsJapgolly.typedoc.typedocStrings.week
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

trait JsxInputElementProps
  extends StObject
...
object JsxInputElementProps {
  
  inline def apply(): JsxInputElementProps = {
  ...
  extension [Self <: JsxInputElementProps](x: Self) {
    ...
    inline def setType(
      value: button | checkbox | color | date | `datetime-local` | email | file | hidden | image | month | number | password | radio | range | reset | search | submit | tel | text | time | url | week
