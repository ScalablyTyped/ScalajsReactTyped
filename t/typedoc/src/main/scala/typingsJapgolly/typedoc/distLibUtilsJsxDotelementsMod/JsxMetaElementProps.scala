...
import typingsJapgolly.typedoc.typedocStrings.`content-security-policy`
import typingsJapgolly.typedoc.typedocStrings.`content-type`
import typingsJapgolly.typedoc.typedocStrings.`default-style`
import typingsJapgolly.typedoc.typedocStrings.`utf-8`
import typingsJapgolly.typedoc.typedocStrings.`x-ua-compatible`
import typingsJapgolly.typedoc.typedocStrings.refresh
