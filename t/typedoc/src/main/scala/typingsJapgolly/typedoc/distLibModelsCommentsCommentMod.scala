...
import typingsJapgolly.typedoc.distLibModelsReflectionsMod.Reflection
import typingsJapgolly.typedoc.distLibSerializationMod.Serializer
import typingsJapgolly.typedoc.typedocStrings.`inline-tag`
...
object distLibModelsCommentsCommentMod {
  ...
  open class Comment () extends StObject {
    ...
    def toObject(serializer: Serializer): typingsJapgolly.typedoc.distLibSerializationSchemaMod.Comment = js.native
  }
  /* static members */
  object Comment {
  ...
  open class CommentTag protected () extends StObject {
    ...
    def toObject(): typingsJapgolly.typedoc.distLibSerializationSchemaMod.CommentTag = js.native
  }
  
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.typedoc.anon.Kind
    - typingsJapgolly.typedoc.anon.Text
    - typingsJapgolly.typedoc.distLibModelsCommentsCommentMod.InlineTagDisplayPart
  */
  trait CommentDisplayPart extends StObject
  object CommentDisplayPart {
    
    inline def InlineTagDisplayPart(tag: /* template literal string: @${string} */ String, text: String): typingsJapgolly.typedoc.distLibModelsCommentsCommentMod.InlineTagDisplayPart = {
      val __obj = js.Dynamic.literal(kind = "inline-tag", tag = tag.asInstanceOf[js.Any], text = text.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.typedoc.distLibModelsCommentsCommentMod.InlineTagDisplayPart]
    }
