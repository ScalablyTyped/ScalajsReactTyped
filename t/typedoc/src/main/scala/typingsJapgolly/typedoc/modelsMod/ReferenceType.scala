package typingsJapgolly.typedoc.modelsMod
...
class ReferenceType protected ()
  extends typingsJapgolly.typedoc.modelsTypesMod.ReferenceType {
  def this(name: String, symbolID: Double) = this()
  def this(name: String, symbolID: Double, reflection: typingsJapgolly.typedoc.abstractMod.Reflection) = this()
}
