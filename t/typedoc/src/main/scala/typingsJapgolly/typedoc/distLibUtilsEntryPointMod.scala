...
import typingsJapgolly.typedoc.distLibUtilsOptionsMod.Options
...
object distLibUtilsEntryPointMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.typedoc.typedocStrings.resolve
    - typingsJapgolly.typedoc.typedocStrings.expand
    - typingsJapgolly.typedoc.typedocStrings.packages
  */
