...
import typingsJapgolly.typescript.mod.ImportsNotUsedAsValues
import typingsJapgolly.typescript.mod.JsxEmit
import typingsJapgolly.typescript.mod.MapLike
import typingsJapgolly.typescript.mod.ModuleDetectionKind
import typingsJapgolly.typescript.mod.ModuleKind
import typingsJapgolly.typescript.mod.ModuleResolutionKind
import typingsJapgolly.typescript.mod.NewLineKind
import typingsJapgolly.typescript.mod.ScriptTarget
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

/* Inlined std.Readonly<typescript.typescript.CompilerOptions> */
trait ReadonlyCompilerOptions extends StObject {
  
  val allowJs: js.UndefOr[Boolean] = js.undefined
  
  val allowSyntheticDefaultImports: js.UndefOr[Boolean] = js.undefined
  
  val allowUmdGlobalAccess: js.UndefOr[Boolean] = js.undefined
  
  val allowUnreachableCode: js.UndefOr[Boolean] = js.undefined
  
  val allowUnusedLabels: js.UndefOr[Boolean] = js.undefined
  
  val alwaysStrict: js.UndefOr[Boolean] = js.undefined
  
  val assumeChangesOnlyAffectDirectDependencies: js.UndefOr[Boolean] = js.undefined
  
  val baseUrl: js.UndefOr[String] = js.undefined
  
  val charset: js.UndefOr[String] = js.undefined
  
  val checkJs: js.UndefOr[Boolean] = js.undefined
  
  val composite: js.UndefOr[Boolean] = js.undefined
  
  val declaration: js.UndefOr[Boolean] = js.undefined
  
  val declarationDir: js.UndefOr[String] = js.undefined
  
  val declarationMap: js.UndefOr[Boolean] = js.undefined
  
  val disableReferencedProjectLoad: js.UndefOr[Boolean] = js.undefined
  
  val disableSizeLimit: js.UndefOr[Boolean] = js.undefined
  
  val disableSolutionSearching: js.UndefOr[Boolean] = js.undefined
  
  val disableSourceOfProjectReferenceRedirect: js.UndefOr[Boolean] = js.undefined
  
  val downlevelIteration: js.UndefOr[Boolean] = js.undefined
  
  val emitBOM: js.UndefOr[Boolean] = js.undefined
  
  val emitDeclarationOnly: js.UndefOr[Boolean] = js.undefined
  
  val emitDecoratorMetadata: js.UndefOr[Boolean] = js.undefined
  
  val esModuleInterop: js.UndefOr[Boolean] = js.undefined
  
  val exactOptionalPropertyTypes: js.UndefOr[Boolean] = js.undefined
  
  val experimentalDecorators: js.UndefOr[Boolean] = js.undefined
  
  val forceConsistentCasingInFileNames: js.UndefOr[Boolean] = js.undefined
  
  val importHelpers: js.UndefOr[Boolean] = js.undefined
  
  val importsNotUsedAsValues: js.UndefOr[ImportsNotUsedAsValues] = js.undefined
  
  val incremental: js.UndefOr[Boolean] = js.undefined
  
  val inlineSourceMap: js.UndefOr[Boolean] = js.undefined
  
  val inlineSources: js.UndefOr[Boolean] = js.undefined
  
  val isolatedModules: js.UndefOr[Boolean] = js.undefined
  
  val jsx: js.UndefOr[JsxEmit] = js.undefined
  
  val jsxFactory: js.UndefOr[String] = js.undefined
  
  val jsxFragmentFactory: js.UndefOr[String] = js.undefined
  
  val jsxImportSource: js.UndefOr[String] = js.undefined
  
  val keyofStringsOnly: js.UndefOr[Boolean] = js.undefined
  
  val lib: js.UndefOr[js.Array[String]] = js.undefined
  
  val locale: js.UndefOr[String] = js.undefined
  
  val mapRoot: js.UndefOr[String] = js.undefined
  
  val maxNodeModuleJsDepth: js.UndefOr[Double] = js.undefined
  
  val module: js.UndefOr[ModuleKind] = js.undefined
  
  val moduleDetection: js.UndefOr[ModuleDetectionKind] = js.undefined
  
  val moduleResolution: js.UndefOr[ModuleResolutionKind] = js.undefined
  
  val moduleSuffixes: js.UndefOr[js.Array[String]] = js.undefined
  
  val newLine: js.UndefOr[NewLineKind] = js.undefined
  
  val noEmit: js.UndefOr[Boolean] = js.undefined
  
  val noEmitHelpers: js.UndefOr[Boolean] = js.undefined
  
  val noEmitOnError: js.UndefOr[Boolean] = js.undefined
  
  val noErrorTruncation: js.UndefOr[Boolean] = js.undefined
  
  val noFallthroughCasesInSwitch: js.UndefOr[Boolean] = js.undefined
  
  val noImplicitAny: js.UndefOr[Boolean] = js.undefined
  
  val noImplicitOverride: js.UndefOr[Boolean] = js.undefined
  
  val noImplicitReturns: js.UndefOr[Boolean] = js.undefined
  
  val noImplicitThis: js.UndefOr[Boolean] = js.undefined
  
  val noImplicitUseStrict: js.UndefOr[Boolean] = js.undefined
  
  val noLib: js.UndefOr[Boolean] = js.undefined
  
  val noPropertyAccessFromIndexSignature: js.UndefOr[Boolean] = js.undefined
  
  val noResolve: js.UndefOr[Boolean] = js.undefined
  
  val noStrictGenericChecks: js.UndefOr[Boolean] = js.undefined
  
  val noUncheckedIndexedAccess: js.UndefOr[Boolean] = js.undefined
  
  val noUnusedLocals: js.UndefOr[Boolean] = js.undefined
  
  val noUnusedParameters: js.UndefOr[Boolean] = js.undefined
  
  val out: js.UndefOr[String] = js.undefined
  
  val outDir: js.UndefOr[String] = js.undefined
  
  val outFile: js.UndefOr[String] = js.undefined
  
  val paths: js.UndefOr[MapLike[js.Array[String]]] = js.undefined
  
  val preserveConstEnums: js.UndefOr[Boolean] = js.undefined
  
  val preserveSymlinks: js.UndefOr[Boolean] = js.undefined
  
  val preserveValueImports: js.UndefOr[Boolean] = js.undefined
  
  val project: js.UndefOr[String] = js.undefined
  
  val reactNamespace: js.UndefOr[String] = js.undefined
  
  val removeComments: js.UndefOr[Boolean] = js.undefined
  
  val resolveJsonModule: js.UndefOr[Boolean] = js.undefined
  
  val rootDir: js.UndefOr[String] = js.undefined
  
  val rootDirs: js.UndefOr[js.Array[String]] = js.undefined
  
  val skipDefaultLibCheck: js.UndefOr[Boolean] = js.undefined
  
  val skipLibCheck: js.UndefOr[Boolean] = js.undefined
  
  val sourceMap: js.UndefOr[Boolean] = js.undefined
  
  val sourceRoot: js.UndefOr[String] = js.undefined
  
  val strict: js.UndefOr[Boolean] = js.undefined
  
  val strictBindCallApply: js.UndefOr[Boolean] = js.undefined
  
  val strictFunctionTypes: js.UndefOr[Boolean] = js.undefined
  
  val strictNullChecks: js.UndefOr[Boolean] = js.undefined
  
  val strictPropertyInitialization: js.UndefOr[Boolean] = js.undefined
  
  val stripInternal: js.UndefOr[Boolean] = js.undefined
  
  val suppressExcessPropertyErrors: js.UndefOr[Boolean] = js.undefined
  
  val suppressImplicitAnyIndexErrors: js.UndefOr[Boolean] = js.undefined
  
  val target: js.UndefOr[ScriptTarget] = js.undefined
  
  val traceResolution: js.UndefOr[Boolean] = js.undefined
  
  val tsBuildInfoFile: js.UndefOr[String] = js.undefined
  
  val typeRoots: js.UndefOr[js.Array[String]] = js.undefined
  
  val types: js.UndefOr[js.Array[String]] = js.undefined
  
  val useDefineForClassFields: js.UndefOr[Boolean] = js.undefined
  
  val useUnknownInCatchVariables: js.UndefOr[Boolean] = js.undefined
}
