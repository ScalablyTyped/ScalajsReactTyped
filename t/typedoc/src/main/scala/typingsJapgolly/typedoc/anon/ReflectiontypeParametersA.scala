...
import typingsJapgolly.typedoc.distLibModelsCommentsCommentMod.Comment
...
import typingsJapgolly.typedoc.distLibModelsReflectionsAbstractMod.ReflectionFlag
import typingsJapgolly.typedoc.distLibModelsReflectionsAbstractMod.ReflectionFlags
import typingsJapgolly.typedoc.distLibModelsReflectionsAbstractMod.TraverseCallback
...
import typingsJapgolly.typedoc.distLibModelsSourcesFileMod.SourceReference
...
trait ReflectiontypeParametersA extends StObject {
  ...
  def toObject(serializer: Serializer): typingsJapgolly.typedoc.distLibSerializationSchemaMod.Reflection = js.native
