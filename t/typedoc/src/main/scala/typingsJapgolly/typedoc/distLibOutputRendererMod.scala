...
import typingsJapgolly.typedoc.distLibUtilsMod.EventHooks
...
object distLibOutputRendererMod {
  ...
  open class Renderer protected () extends ChildableComponent[Application, RendererComponent] {
    ...
    def defineTheme(
      name: String,
      theme: Instantiable1[/* renderer */ Renderer, typingsJapgolly.typedoc.distLibOutputThemeMod.Theme]
    ): Unit = js.native
    ...
    /**
      ...
      */
    var theme: js.UndefOr[typingsJapgolly.typedoc.distLibOutputThemeMod.Theme] = js.native
