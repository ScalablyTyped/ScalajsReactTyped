...
object distLibUtilsArrayMod {
  ...
  inline def zip[T /* <: js.Array[js.Iterable[Any]] */](
    ...
    /* import warning: importer.ImportType#apply Failed type conversion: {[ K in keyof T ]: T[K] extends std.Iterable<infer U>? U : T[K]} */ js.Any
