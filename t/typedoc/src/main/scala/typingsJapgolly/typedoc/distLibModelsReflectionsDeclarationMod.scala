...
import typingsJapgolly.typedoc.distLibModelsReflectionsContainerMod.ContainerReflection
...
import typingsJapgolly.typedoc.distLibModelsTypesMod.Type
...
object distLibModelsReflectionsDeclarationMod {
  ...
  open class DeclarationReflection protected () extends ContainerReflection {
    ...
    /**
      ...
      * @internal
      */
    var escapedName: js.UndefOr[typingsJapgolly.typescript.mod.String] = js.native
