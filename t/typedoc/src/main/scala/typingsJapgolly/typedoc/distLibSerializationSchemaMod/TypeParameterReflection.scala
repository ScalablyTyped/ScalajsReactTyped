...
trait TypeParameterReflection extends StObject {
  ...
  var default: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]
...
object TypeParameterReflection {
  ...
  inline def apply(
    ...
    default: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]],
  ...
  extension [Self <: TypeParameterReflection](x: Self) {
    ...
    inline def setDefault(value: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]): Self = StObject.set(x, "default", value.asInstanceOf[js.Any])
