...
trait DeclarationReflection extends StObject {
  ...
  var extendedBy: ToSerialized[
    js.UndefOr[js.Array[typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType]]
  ]
  
  var extendedTypes: ToSerialized[js.UndefOr[js.Array[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]]
  ...
  var implementedBy: ToSerialized[
    js.UndefOr[js.Array[typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType]]
  ]
  
  var implementedTypes: ToSerialized[js.UndefOr[js.Array[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]]
...
object DeclarationReflection {
  ...
  extension [Self <: DeclarationReflection](x: Self) {
    ...
    inline def setExtendedTypes(value: ToSerialized[js.UndefOr[js.Array[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]]): Self = StObject.set(x, "extendedTypes", value.asInstanceOf[js.Any])
    ...
    inline def setImplementedTypes(value: ToSerialized[js.UndefOr[js.Array[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]]): Self = StObject.set(x, "implementedTypes", value.asInstanceOf[js.Any])
