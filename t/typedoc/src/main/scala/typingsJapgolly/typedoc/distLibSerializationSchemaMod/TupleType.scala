...
trait TupleType extends StObject {
  ...
  var elements: js.UndefOr[ModelToObject[js.Array[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]] = js.undefined
...
object TupleType {
  ...
  extension [Self <: TupleType](x: Self) {
    ...
    inline def setElements(value: ModelToObject[js.Array[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]): Self = StObject.set(x, "elements", value.asInstanceOf[js.Any])
