...
trait QueryType extends StObject {
  ...
  var queryType: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType]
...
object QueryType {
  ...
  inline def apply(
    queryType: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType],
  ...
  extension [Self <: QueryType](x: Self) {
    ...
    inline def setQueryType(value: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType]): Self = StObject.set(x, "queryType", value.asInstanceOf[js.Any])
