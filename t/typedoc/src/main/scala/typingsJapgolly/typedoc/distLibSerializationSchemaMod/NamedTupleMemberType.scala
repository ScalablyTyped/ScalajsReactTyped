...
trait NamedTupleMemberType extends StObject {
  ...
  var element: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]
...
object NamedTupleMemberType {
  ...
  inline def apply(
    element: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType],
  ...
  extension [Self <: NamedTupleMemberType](x: Self) {
    ...
    inline def setElement(value: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]): Self = StObject.set(x, "element", value.asInstanceOf[js.Any])
