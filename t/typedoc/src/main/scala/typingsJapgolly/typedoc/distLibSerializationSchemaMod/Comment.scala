...
trait Comment extends StObject {
  ...
  var blockTags: js.UndefOr[
    ToSerialized[js.Array[typingsJapgolly.typedoc.distLibModelsCommentsCommentMod.CommentTag]]
  ] = js.undefined
...
object Comment {
  ...
  extension [Self <: Comment](x: Self) {
    ...
    inline def setBlockTags(value: ToSerialized[js.Array[typingsJapgolly.typedoc.distLibModelsCommentsCommentMod.CommentTag]]): Self = StObject.set(x, "blockTags", value.asInstanceOf[js.Any])
