...
trait PredicateType extends StObject {
  ...
  var targetType: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]
...
object PredicateType {
  ...
  inline def apply(
    ...
    targetType: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]],
  ...
  extension [Self <: PredicateType](x: Self) {
    ...
    inline def setTargetType(value: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]): Self = StObject.set(x, "targetType", value.asInstanceOf[js.Any])
