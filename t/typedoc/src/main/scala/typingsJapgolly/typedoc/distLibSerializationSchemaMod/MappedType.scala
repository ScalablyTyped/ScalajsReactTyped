...
trait MappedType extends StObject {
  ...
  var nameType: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]
  
  var optionalModifier: ToSerialized[js.UndefOr[`-_` | Plussign]]
  
  var parameter: ToSerialized[String]
  
  var parameterType: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]
  
  var readonlyModifier: ToSerialized[js.UndefOr[`-_` | Plussign]]
  
  var templateType: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]
...
object MappedType {
  ...
  inline def apply(
    nameType: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]],
    optionalModifier: ToSerialized[js.UndefOr[`-_` | Plussign]],
    parameter: ToSerialized[String],
    parameterType: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType],
    readonlyModifier: ToSerialized[js.UndefOr[`-_` | Plussign]],
    templateType: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType],
  ...
  extension [Self <: MappedType](x: Self) {
    ...
    inline def setNameType(value: ToSerialized[js.UndefOr[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]]): Self = StObject.set(x, "nameType", value.asInstanceOf[js.Any])
    ...
    inline def setParameterType(value: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]): Self = StObject.set(x, "parameterType", value.asInstanceOf[js.Any])
    ...
    inline def setTemplateType(value: ToSerialized[typingsJapgolly.typedoc.distLibModelsTypesMod.SomeType]): Self = StObject.set(x, "templateType", value.asInstanceOf[js.Any])
