...
object DeclarationOption {
  ...
  def apply(
    ...
    convert: (/* param */ OptionDeclaration, /* value */ js.UndefOr[js.Any]) => CallbackTo[js.Any] = null,
    ...
    if (convert != null) __obj.updateDynamic("convert")(js.Any.fromFunction2((t0: /* param */ typingsJapgolly.typedoc.optionsDeclarationMod.OptionDeclaration, t1: /* value */ js.UndefOr[js.Any]) => convert(t0, t1).runNow()))
