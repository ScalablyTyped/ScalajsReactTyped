...
/* private */ open class ReferenceType ()
  extends typingsJapgolly.typedoc.distLibModelsMod.ReferenceType
/* static members */
object ReferenceType {
  ...
  inline def createSymbolReference(symbol: Symbol, context: typingsJapgolly.typedoc.distLibConverterMod.Context): typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType = (^.asInstanceOf[js.Dynamic].applyDynamic("createSymbolReference")(symbol.asInstanceOf[js.Any], context.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType]
  inline def createSymbolReference(symbol: Symbol, context: typingsJapgolly.typedoc.distLibConverterMod.Context, name: String): typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType = (^.asInstanceOf[js.Dynamic].applyDynamic("createSymbolReference")(symbol.asInstanceOf[js.Any], context.asInstanceOf[js.Any], name.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typedoc.distLibModelsTypesMod.ReferenceType]
}
