...
import typingsJapgolly.shiki.mod.Theme
import typingsJapgolly.std.Record
import typingsJapgolly.typedoc.anon.All
import typingsJapgolly.typedoc.anon.Both
import typingsJapgolly.typedoc.anon.Dicttag
import typingsJapgolly.typedoc.anon.Expand
...
trait TypeDocOptionMap extends StObject {
  ...
  var requiredToBeDocumented: js.Array[
    /* keyof typedoc.anon.TypeofReflectionKind */ typingsJapgolly.typedoc.typedocStrings.All | ClassOrInterface | VariableOrProperty | FunctionOrMethod | ClassMember | SomeSignature | SomeModule | SomeType | SomeValue | SomeMember | SomeExport | ExportContainer | Inheritable | ContainsCallSignatures | SignatureContainer
  ]
...
object TypeDocOptionMap {
  ...
  extension [Self <: TypeDocOptionMap](x: Self) {
    ...
    inline def setRequiredToBeDocumentedVarargs(
      value: (/* keyof typedoc.anon.TypeofReflectionKind */ typingsJapgolly.typedoc.typedocStrings.All | ClassOrInterface | VariableOrProperty | FunctionOrMethod | ClassMember | SomeSignature | SomeModule | SomeType | SomeValue | SomeMember | SomeExport | ExportContainer | Inheritable | ContainsCallSignatures | SignatureContainer)*
