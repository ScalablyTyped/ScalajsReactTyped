...
import typingsJapgolly.typedoc.distLibUtilsOptionsDeclarationMod.ParameterType.Path
...
trait StringDeclarationOption
  ...
  /**
    ...
    */
  @JSName("type")
  var type_StringDeclarationOption: js.UndefOr[
    typingsJapgolly.typedoc.distLibUtilsOptionsDeclarationMod.ParameterType.String | Path
  ] = js.undefined
...
object StringDeclarationOption {
  ...
  extension [Self <: StringDeclarationOption](x: Self) {
    ...
    inline def setType(value: typingsJapgolly.typedoc.distLibUtilsOptionsDeclarationMod.ParameterType.String | Path): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
    
    inline def setTypeUndefined: Self = StObject.set(x, "type", js.undefined)
    
    inline def setValidate(value: /* value */ String => Callback): Self = StObject.set(x, "validate", js.Any.fromFunction1((t0: /* value */ String) => value(t0).runNow()))
