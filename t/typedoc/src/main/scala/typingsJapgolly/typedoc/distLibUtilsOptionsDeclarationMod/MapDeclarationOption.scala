...
trait MapDeclarationOption[T]
  ...
  @JSName("type")
  var type_MapDeclarationOption: typingsJapgolly.typedoc.distLibUtilsOptionsDeclarationMod.ParameterType.Map
}
object MapDeclarationOption {
  ...
  inline def apply[T](
    ...
    name: String,
    `type`: typingsJapgolly.typedoc.distLibUtilsOptionsDeclarationMod.ParameterType.Map
  ...
  extension [Self <: MapDeclarationOption[?], T](x: Self & MapDeclarationOption[T]) {
    ...
    inline def setType(value: typingsJapgolly.typedoc.distLibUtilsOptionsDeclarationMod.ParameterType.Map): Self = StObject.set(x, "type", value.asInstanceOf[js.Any])
  }
}
