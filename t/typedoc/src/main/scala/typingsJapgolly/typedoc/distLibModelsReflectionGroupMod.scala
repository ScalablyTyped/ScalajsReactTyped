...
import typingsJapgolly.typedoc.distLibModelsReflectionCategoryMod.ReflectionCategory
...
object distLibModelsReflectionGroupMod {
  ...
  open class ReflectionGroup protected () extends StObject {
    ...
    def toObject(serializer: Serializer): typingsJapgolly.typedoc.distLibSerializationSchemaMod.ReflectionGroup = js.native
  }
}
