...
import typingsJapgolly.typedoc.componentsMod.ConverterComponent
...
class Converter () extends ChildableComponent[Application, ConverterComponent] {
  ...
  def convertType(context: Context, node: Node, `type`: typingsJapgolly.typescript.mod.Type): js.UndefOr[Type] = js.native
  ...
  def convertTypes(context: Context, nodes: js.Array[Node], types: js.Array[typingsJapgolly.typescript.mod.Type]): js.Array[Type] = js.native
