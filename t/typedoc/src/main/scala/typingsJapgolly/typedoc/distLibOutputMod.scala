...
object distLibOutputMod {
  ...
  open class DefaultTheme protected ()
    extends typingsJapgolly.typedoc.distLibOutputThemesDefaultDefaultThemeMod.DefaultTheme {
    /**
  ...
  open class DefaultThemeRenderContext protected ()
    extends typingsJapgolly.typedoc.distLibOutputThemesDefaultDefaultThemeRenderContextMod.DefaultThemeRenderContext {
    def this(
      theme: typingsJapgolly.typedoc.distLibOutputThemesDefaultDefaultThemeMod.DefaultTheme,
      options: Options
    ) = this()
  }
  ...
  open class IndexEvent protected ()
    extends typingsJapgolly.typedoc.distLibOutputEventsMod.IndexEvent {
  ...
  open class MarkdownEvent protected ()
    extends typingsJapgolly.typedoc.distLibOutputEventsMod.MarkdownEvent {
  ...
  open class PageEvent[Model] protected ()
    extends typingsJapgolly.typedoc.distLibOutputEventsMod.PageEvent[Model] {
    /**
  ...
  open class Renderer protected ()
    extends typingsJapgolly.typedoc.distLibOutputRendererMod.Renderer {
    /**
  ...
  open class RendererEvent protected ()
    extends typingsJapgolly.typedoc.distLibOutputEventsMod.RendererEvent {
  ...
  open class Theme protected ()
    extends typingsJapgolly.typedoc.distLibOutputThemeMod.Theme {
    /**
  ...
  open class UrlMapping[Model] protected ()
    extends typingsJapgolly.typedoc.distLibOutputModelsUrlMappingMod.UrlMapping[Model] {
    def this(
      url: String,
      model: Model,
