...
import typingsJapgolly.tablesorter.filterBoxMod.FilterBox
import typingsJapgolly.tablesorter.matchTypeMod.MatchType
...
import typingsJapgolly.tablesorter.relativeSortingMod.RelativeSorting
