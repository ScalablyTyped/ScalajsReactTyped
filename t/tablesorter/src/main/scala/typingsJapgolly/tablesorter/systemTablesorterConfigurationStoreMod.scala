...
import typingsJapgolly.tablesorter.sortingTableSortingMod.TableSorting
...
import typingsJapgolly.tablesorter.systemTablesorterCacheMod.TablesorterCache
...
import typingsJapgolly.tablesorter.widgetsWidgetOptionStoreMod.WidgetOptionStore
...
object systemTablesorterConfigurationStoreMod {
  ...
  object TablesorterConfigurationStore {
    ...
    inline def apply[TElement](
      ...
      imgAttr: String,
      initWidgets: Boolean,
      initialized: TElement => Callback,
      namespace: String,
      numberSorter: (/* x */ Double, /* y */ Double, /* ascending */ Boolean, /* maxValue */ Double) => Double,
      onRenderHeader: (/* index */ Double, /* config */ TablesorterConfigurationStore[TElement], /* table */ JQuery[TElement]) => Callback,
