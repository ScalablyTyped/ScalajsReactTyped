...
import typingsJapgolly.tablesorter.pagingAjaxDataProcessorMod.AjaxDataProcessor
import typingsJapgolly.tablesorter.pagingAjaxErrorHandlerMod.AjaxErrorHandler
import typingsJapgolly.tablesorter.pagingAjaxUrlProcessorMod.AjaxUrlProcessor
import typingsJapgolly.tablesorter.pagingPageSizeMod.PageSize
import typingsJapgolly.tablesorter.pagingPagerClassesMod.PagerClasses
import typingsJapgolly.tablesorter.pagingPagerDataPartMod.PagerDataPart
import typingsJapgolly.tablesorter.pagingPagerInitialRowsMod.PagerInitialRows
import typingsJapgolly.tablesorter.pagingPagerOutputProcessorMod.PagerOutputProcessor
import typingsJapgolly.tablesorter.pagingPagerSelectorsMod.PagerSelectors
