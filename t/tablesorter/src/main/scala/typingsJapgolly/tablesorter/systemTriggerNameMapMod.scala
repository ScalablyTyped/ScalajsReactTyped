...
object systemTriggerNameMapMod {
  ...
  object TriggerNameMap {
    ...
    inline def apply[TElement](
      ...
      applyWidgets: TElement => Callback,
    ...
    extension [Self <: TriggerNameMap[?], TElement](x: Self & TriggerNameMap[TElement]) {
      ...
      inline def setApplyWidgets(value: TElement => Callback): Self = StObject.set(x, "applyWidgets", js.Any.fromFunction1((t0: TElement) => value(t0).runNow()))
      ...
      inline def setUpdateHeaders(value: TElement => Callback): Self = StObject.set(x, "updateHeaders", js.Any.fromFunction1((t0: TElement) => value(t0).runNow()))
