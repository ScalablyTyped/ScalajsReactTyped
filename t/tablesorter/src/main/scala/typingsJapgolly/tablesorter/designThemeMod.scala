...
object designThemeMod {
  ...
  open class Theme () extends StObject {
    ...
    /**
      ...
      */
    var even: String = js.native
    
    /**
      * A set of classes to apply to the filter-row.
      */
    var filterRow: String = js.native
