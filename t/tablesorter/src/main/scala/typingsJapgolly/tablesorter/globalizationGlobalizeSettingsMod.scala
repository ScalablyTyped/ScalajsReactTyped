...
import typingsJapgolly.globalize.distGlobalizeMod.DateFormatterOptions
import typingsJapgolly.globalize.distGlobalizeMod.Globalize
...
object globalizationGlobalizeSettingsMod {
  ...
  trait GlobalizeSettings
    ...
    /**
      ...
      */
    var Globalize: typingsJapgolly.globalize.distGlobalizeMod.Globalize
