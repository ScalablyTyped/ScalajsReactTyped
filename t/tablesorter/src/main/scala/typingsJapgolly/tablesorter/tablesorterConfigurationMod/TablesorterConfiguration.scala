package typingsJapgolly.tablesorter.tablesorterConfigurationMod
...
import typingsJapgolly.tablesorter.tablesorterConfigBaseMod.TablesorterConfigBase
...
import typingsJapgolly.tablesorter.widgetOptionsMod.WidgetOptions
...
object TablesorterConfiguration {
  ...
  def apply[TElement](
    ...
    initialized: TElement => Callback = null,
    namespace: String = null,
    numberSorter: (/* x */ Double, /* y */ Double, /* ascending */ Boolean, /* maxValue */ Double) => CallbackTo[Double] = null,
    onRenderHeader: (/* index */ Double, /* config */ TablesorterConfigurationStore[TElement], /* table */ JQuery[TElement]) => Callback = null,
    onRenderTemplate: (/* index */ Double, /* template */ String) => CallbackTo[String] = null,
    ...
    if (initialized != null) __obj.updateDynamic("initialized")(js.Any.fromFunction1((t0: TElement) => initialized(t0).runNow()))
    if (namespace != null) __obj.updateDynamic("namespace")(namespace.asInstanceOf[js.Any])
    if (numberSorter != null) __obj.updateDynamic("numberSorter")(js.Any.fromFunction4((t0: /* x */ scala.Double, t1: /* y */ scala.Double, t2: /* ascending */ scala.Boolean, t3: /* maxValue */ scala.Double) => numberSorter(t0, t1, t2, t3).runNow()))
    if (onRenderHeader != null) __obj.updateDynamic("onRenderHeader")(js.Any.fromFunction3((t0: /* index */ scala.Double, t1: /* config */ typingsJapgolly.tablesorter.tablesorterConfigurationStoreMod.TablesorterConfigurationStore[TElement], t2: /* table */ typingsJapgolly.tablesorter.mod._Global_.JQuery[TElement]) => onRenderHeader(t0, t1, t2).runNow()))
    if (onRenderTemplate != null) __obj.updateDynamic("onRenderTemplate")(js.Any.fromFunction2((t0: /* index */ scala.Double, t1: /* template */ java.lang.String) => onRenderTemplate(t0, t1).runNow()))
