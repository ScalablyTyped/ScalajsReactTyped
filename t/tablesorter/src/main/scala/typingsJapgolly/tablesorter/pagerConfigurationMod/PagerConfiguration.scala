package typingsJapgolly.tablesorter.pagerConfigurationMod
...
object PagerConfiguration {
  @scala.inline
  def apply[TElement](
    ajaxError: (/* config */ TablesorterConfigurationStore[TElement], /* request */ jqXHR[js.Any], /* ajaxSettings */ AjaxSettings[js.Any], /* thrownError */ String) => CallbackTo[String] = null,
    ajaxObject: JQueryAjaxSettings = null,
    ajaxProcessing: (/* data */ js.Any, TElement, /* request */ jqXHR[js.Any]) => CallbackTo[
    ...
    customAjaxUrl: (TElement, /* url */ String) => CallbackTo[String] = null,
    ...
    if (ajaxError != null) __obj.updateDynamic("ajaxError")(js.Any.fromFunction4((t0: /* config */ typingsJapgolly.tablesorter.tablesorterConfigurationStoreMod.TablesorterConfigurationStore[TElement], t1: /* request */ typingsJapgolly.jquery.JQuery_.jqXHR[js.Any], t2: /* ajaxSettings */ typingsJapgolly.jquery.JQuery_.AjaxSettings[js.Any], t3: /* thrownError */ java.lang.String) => ajaxError(t0, t1, t2, t3).runNow()))
    if (ajaxObject != null) __obj.updateDynamic("ajaxObject")(ajaxObject.asInstanceOf[js.Any])
    if (ajaxProcessing != null) __obj.updateDynamic("ajaxProcessing")(js.Any.fromFunction3((t0: /* data */ js.Any, t1: TElement, t2: /* request */ typingsJapgolly.jquery.JQuery_.jqXHR[js.Any]) => ajaxProcessing(t0, t1, t2).runNow()))
    ...
    if (customAjaxUrl != null) __obj.updateDynamic("customAjaxUrl")(js.Any.fromFunction2((t0: TElement, t1: /* url */ java.lang.String) => customAjaxUrl(t0, t1).runNow()))
