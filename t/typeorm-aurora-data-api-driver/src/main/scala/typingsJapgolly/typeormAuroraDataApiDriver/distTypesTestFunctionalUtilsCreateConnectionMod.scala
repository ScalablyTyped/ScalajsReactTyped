...
object distTypesTestFunctionalUtilsCreateConnectionMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.typeormAuroraDataApiDriver.typeormAuroraDataApiDriverStrings.mysql
    - typingsJapgolly.typeormAuroraDataApiDriver.typeormAuroraDataApiDriverStrings.postgres
  */
  trait DbType extends StObject
  object DbType {
    
    inline def mysql: typingsJapgolly.typeormAuroraDataApiDriver.typeormAuroraDataApiDriverStrings.mysql = "mysql".asInstanceOf[typingsJapgolly.typeormAuroraDataApiDriver.typeormAuroraDataApiDriverStrings.mysql]
    
    inline def postgres: typingsJapgolly.typeormAuroraDataApiDriver.typeormAuroraDataApiDriverStrings.postgres = "postgres".asInstanceOf[typingsJapgolly.typeormAuroraDataApiDriver.typeormAuroraDataApiDriverStrings.postgres]
  }
}
