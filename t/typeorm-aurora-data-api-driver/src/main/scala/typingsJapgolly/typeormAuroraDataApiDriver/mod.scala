...
object mod {
  ...
  open class MysqlQueryTransformer ()
    extends typingsJapgolly.typeormAuroraDataApiDriver.distTypesQueryTransformerMod.MysqlQueryTransformer {
  ...
  open class PostgresQueryTransformer ()
    extends typingsJapgolly.typeormAuroraDataApiDriver.distTypesQueryTransformerMod.PostgresQueryTransformer {
    def this(transformOptions: Any) = this()
  }
