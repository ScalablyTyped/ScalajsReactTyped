...
object distTypesSrcTypeormAuroraDataApiDriverMod {
  ...
  open class MysqlQueryTransformer ()
    extends typingsJapgolly.typeormAuroraDataApiDriver.distTypesSrcQueryTransformerMod.MysqlQueryTransformer {
  ...
  open class PostgresQueryTransformer ()
    extends typingsJapgolly.typeormAuroraDataApiDriver.distTypesSrcQueryTransformerMod.PostgresQueryTransformer {
    def this(transformOptions: Any) = this()
  }
