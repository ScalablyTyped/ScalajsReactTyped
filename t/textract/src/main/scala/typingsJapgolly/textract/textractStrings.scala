...
object textractStrings {
  ...
  inline def ASCII7: ASCII7 = "ASCII7".asInstanceOf[ASCII7]
  ...
  inline def ZapfDingbats: ZapfDingbats = "ZapfDingbats".asInstanceOf[ZapfDingbats]
  ...
  inline def htmlmeta: htmlmeta = "htmlmeta".asInstanceOf[htmlmeta]
