...
import typingsJapgolly.twilsock.mod.ConnectionState
import typingsJapgolly.twilsock.mod.MessageType
import typingsJapgolly.twilsock.mod.Messages.Method
...
object twilsockStrings {
  ...
  sealed trait DELETE
    extends StObject
       with Method
       with typingsJapgolly.twilsock.mod.Method
  ...
  sealed trait client_update
    extends StObject
       with MessageType
       with typingsJapgolly.twilsock.mod.Messages.MessageType
