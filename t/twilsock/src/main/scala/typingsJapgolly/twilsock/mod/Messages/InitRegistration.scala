...
object InitRegistration {
  ...
  inline def apply(
    ...
    populateInitRegistrations: js.Array[String] => Callback,
    product: String,
    `type`: String
  ): InitRegistration = {
    val __obj = js.Dynamic.literal(message_types = message_types.asInstanceOf[js.Any], notification_protocol_version = notification_protocol_version.asInstanceOf[js.Any], populateInitRegistrations = js.Any.fromFunction1((t0: js.Array[String]) => populateInitRegistrations(t0).runNow()), product = product.asInstanceOf[js.Any])
  ...
  extension [Self <: InitRegistration](x: Self) {
    ...
    inline def setPopulateInitRegistrations(value: js.Array[String] => Callback): Self = StObject.set(x, "populateInitRegistrations", js.Any.fromFunction1((t0: js.Array[String]) => value(t0).runNow()))
