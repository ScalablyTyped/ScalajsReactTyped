...
import typingsJapgolly.twilsock.offlinestorageMod.OfflineProductStorage
import typingsJapgolly.twilsock.upstreamMod.Result
...
object clientMod extends js.Object {
  ...
  type Context = typingsJapgolly.twilsock.protocolMod.Protocol.Context
}
