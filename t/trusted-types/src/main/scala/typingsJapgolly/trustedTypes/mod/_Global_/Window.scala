...
trait Window extends js.Object {
  var TrustedHTML: typingsJapgolly.trustedTypes.mod._Global_.TrustedHTML
  var TrustedScript: typingsJapgolly.trustedTypes.mod._Global_.TrustedScript
  var TrustedScriptURL: typingsJapgolly.trustedTypes.mod._Global_.TrustedScriptURL
  var TrustedTypePolicy: typingsJapgolly.trustedTypes.mod._Global_.TrustedTypePolicy
  var TrustedTypePolicyFactory: typingsJapgolly.trustedTypes.mod._Global_.TrustedTypePolicyFactory
  /** @deprecated Prefer the lowercase version. */
  var TrustedTypes: js.UndefOr[TrustedTypePolicyFactory] = js.undefined
  var TrustedURL: typingsJapgolly.trustedTypes.mod._Global_.TrustedURL
