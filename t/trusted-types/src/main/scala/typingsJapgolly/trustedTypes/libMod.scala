...
import typingsJapgolly.trustedTypes.trustedTypesStrings.createHTML
import typingsJapgolly.trustedTypes.trustedTypesStrings.createScript
import typingsJapgolly.trustedTypes.trustedTypesStrings.createScriptURL
import typingsJapgolly.trustedTypes.trustedTypesStrings.name
...
object libMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.trustedTypes.trustedTypesStrings.createHTML
    - typingsJapgolly.trustedTypes.trustedTypesStrings.createScript
    - typingsJapgolly.trustedTypes.trustedTypesStrings.createScriptURL
  */
  ...
  trait TrustedTypesWindow extends StObject {
    ...
    var TrustedHTML: Instantiable0[typingsJapgolly.trustedTypes.libMod.TrustedHTML]
    
    var TrustedScript: Instantiable0[typingsJapgolly.trustedTypes.libMod.TrustedScript]
    
    var TrustedScriptURL: Instantiable0[typingsJapgolly.trustedTypes.libMod.TrustedScriptURL]
    
    var TrustedTypePolicy: Instantiable0[typingsJapgolly.trustedTypes.libMod.TrustedTypePolicy[TrustedTypePolicyOptions]]
    
    var TrustedTypePolicyFactory: Instantiable0[typingsJapgolly.trustedTypes.libMod.TrustedTypePolicyFactory]
