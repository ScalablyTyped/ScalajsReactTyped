package typingsJapgolly.timezoneJs
...
object mod {
  ...
  object TimezoneJsOptions {
    ...
    extension [Self <: TimezoneJsOptions](x: Self) {
      ...
      inline def setSuccess(value: /* data */ String => Callback): Self = StObject.set(x, "success", js.Any.fromFunction1((t0: /* data */ String) => value(t0).runNow()))
