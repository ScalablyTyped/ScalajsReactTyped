...
object TdClient {
  @scala.inline
  def apply(send: TdObject => CallbackTo[js.Promise[TdError | TdObject]]): TdClient = {
    val __obj = js.Dynamic.literal()
    __obj.updateDynamic("send")(js.Any.fromFunction1((t0: typingsJapgolly.tdweb.mod.TdObject) => send(t0).runNow()))
