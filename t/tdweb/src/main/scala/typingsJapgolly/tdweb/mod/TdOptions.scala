package typingsJapgolly.tdweb.mod

import japgolly.scalajs.react.CallbackTo
import typingsJapgolly.tdweb.tdwebStrings.asmjs
import typingsJapgolly.tdweb.tdwebStrings.auto
import typingsJapgolly.tdweb.tdwebStrings.debug
import typingsJapgolly.tdweb.tdwebStrings.error
import typingsJapgolly.tdweb.tdwebStrings.info
import typingsJapgolly.tdweb.tdwebStrings.log
import typingsJapgolly.tdweb.tdwebStrings.warning
import typingsJapgolly.tdweb.tdwebStrings.wasm
...
object TdOptions {
  ...
  def apply(
    ...
    onUpdate: /* update */ TdObject => CallbackTo[js.Any] = null,
    ...
    if (onUpdate != null) __obj.updateDynamic("onUpdate")(js.Any.fromFunction1((t0: /* update */ typingsJapgolly.tdweb.mod.TdObject) => onUpdate(t0).runNow()))
