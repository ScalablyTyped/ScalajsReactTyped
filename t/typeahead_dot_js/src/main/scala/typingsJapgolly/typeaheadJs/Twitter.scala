    ...
    object Dataset {
      ...
      extension [Self <: Dataset[?], T](x: Self & Dataset[T]) {
        ...
        inline def setSourceFunction3(
          value: (/* query */ String, /* syncResults */ js.Function1[/* result */ js.Array[T], Unit], /* asyncResults */ js.UndefOr[js.Function1[/* result */ js.Array[T], Unit]]) => Callback
        ): Self = StObject.set(x, "source", js.Any.fromFunction3((t0: /* query */ String, t1: /* syncResults */ js.Function1[/* result */ js.Array[T], Unit], t2: /* asyncResults */ js.UndefOr[js.Function1[/* result */ js.Array[T], Unit]]) => (value(t0, t1, t2)).runNow()))
