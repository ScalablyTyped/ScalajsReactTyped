...
import typingsJapgolly.tsconfigPaths.libTsconfigLoaderMod.TsConfigLoaderParams
import typingsJapgolly.tsconfigPaths.libTsconfigLoaderMod.TsConfigLoaderResult
import typingsJapgolly.tsconfigPaths.tsconfigPathsStrings.failed
import typingsJapgolly.tsconfigPaths.tsconfigPathsStrings.success
...
object libConfigLoaderMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tsconfigPaths.libConfigLoaderMod.ConfigLoaderSuccessResult
    - typingsJapgolly.tsconfigPaths.libConfigLoaderMod.ConfigLoaderFailResult
  */
  trait ConfigLoaderResult extends StObject
  object ConfigLoaderResult {
    
    inline def ConfigLoaderFailResult(message: String): typingsJapgolly.tsconfigPaths.libConfigLoaderMod.ConfigLoaderFailResult = {
      val __obj = js.Dynamic.literal(message = message.asInstanceOf[js.Any], resultType = "failed")
      __obj.asInstanceOf[typingsJapgolly.tsconfigPaths.libConfigLoaderMod.ConfigLoaderFailResult]
    }
    
    inline def ConfigLoaderSuccessResult(absoluteBaseUrl: String, configFileAbsolutePath: String, paths: StringDictionary[js.Array[String]]): typingsJapgolly.tsconfigPaths.libConfigLoaderMod.ConfigLoaderSuccessResult = {
      ...
      __obj.asInstanceOf[typingsJapgolly.tsconfigPaths.libConfigLoaderMod.ConfigLoaderSuccessResult]
    }
  }
