...
import typingsJapgolly.trimblemapsTrimblemapsJs.mod.PositionOptions
...
trait FitBoundsOptions extends StObject {
  ...
  var fitBoundsOptions: js.UndefOr[typingsJapgolly.trimblemapsTrimblemapsJs.mod.FitBoundsOptions] = js.undefined
...
object FitBoundsOptions {
  ...
  extension [Self <: FitBoundsOptions](x: Self) {
    ...
    inline def setFitBoundsOptions(value: typingsJapgolly.trimblemapsTrimblemapsJs.mod.FitBoundsOptions): Self = StObject.set(x, "fitBoundsOptions", value.asInstanceOf[js.Any])
