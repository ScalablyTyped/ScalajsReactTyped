...
object Dataset {
  ...
  inline def apply(lonLat: LngLatLike, success: Any => Callback): Dataset = {
    val __obj = js.Dynamic.literal(lonLat = lonLat.asInstanceOf[js.Any], success = js.Any.fromFunction1((t0: Any) => success(t0).runNow()))
