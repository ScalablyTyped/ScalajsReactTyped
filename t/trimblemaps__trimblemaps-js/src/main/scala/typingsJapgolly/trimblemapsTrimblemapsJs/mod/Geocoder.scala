...
object Geocoder {
  ...
  inline def geocode(geocodeOptions: typingsJapgolly.trimblemapsTrimblemapsJs.anon.Address): Cancelable = ^.asInstanceOf[js.Dynamic].applyDynamic("geocode")(geocodeOptions.asInstanceOf[js.Any]).asInstanceOf[Cancelable]
