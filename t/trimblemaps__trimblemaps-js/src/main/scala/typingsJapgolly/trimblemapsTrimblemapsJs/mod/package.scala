...
import typingsJapgolly.trimblemapsTrimblemapsJs.anon.FailIfMajorPerformanceCaveat
import typingsJapgolly.trimblemapsTrimblemapsJs.mod.^
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.BackgroundLayout
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.FillLayout
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.FillExtrusionLayout
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.LineLayout
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.SymbolLayout
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.RasterLayout
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.CircleLayout
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.HeatmapLayout
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.HillshadeLayout
*/
...
/* Rewritten from type alias, can be one of: 
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.LngLatBounds
  - js.Tuple2[
typingsJapgolly.trimblemapsTrimblemapsJs.mod.LngLatLike, 
typingsJapgolly.trimblemapsTrimblemapsJs.mod.LngLatLike]
...
/* Rewritten from type alias, can be one of: 
  ...
  - typingsJapgolly.trimblemapsTrimblemapsJs.mod.LngLat
  - typingsJapgolly.trimblemapsTrimblemapsJs.anon.Lat
  - typingsJapgolly.trimblemapsTrimblemapsJs.anon.Lon
*/
