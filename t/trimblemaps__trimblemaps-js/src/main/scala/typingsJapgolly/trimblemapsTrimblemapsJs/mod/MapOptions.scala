...
trait MapOptions extends StObject {
  ...
  var language: js.UndefOr[
    /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 56, starting with typingsJapgolly.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.da, typingsJapgolly.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.hi, typingsJapgolly.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.bn */ Any
  ] = js.undefined
  ...
  var style: js.UndefOr[
    datalight | mobilesatellite | simple_dark | satellite | mobileday | dark_accessible | transportation_dark | datadark | basic_dark | transportation | simple_light | default | light_accessible | mobilenight | basic | terrain
  ] = js.undefined
...
object MapOptions {
  ...
  inline def apply(container: String | HTMLElement): MapOptions = {
  ...
  extension [Self <: MapOptions](x: Self) {
    ...
    inline def setLanguage(
      value: /* import warning: LimitUnionLength.leaveTypeRef Was union type with length 56, starting with typingsJapgolly.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.da, typingsJapgolly.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.hi, typingsJapgolly.trimblemapsTrimblemapsJs.trimblemapsTrimblemapsJsStrings.bn */ Any
    ...
    inline def setStyle(
      value: datalight | mobilesatellite | simple_dark | satellite | mobileday | dark_accessible | transportation_dark | datadark | basic_dark | transportation | simple_light | default | light_accessible | mobilenight | basic | terrain
