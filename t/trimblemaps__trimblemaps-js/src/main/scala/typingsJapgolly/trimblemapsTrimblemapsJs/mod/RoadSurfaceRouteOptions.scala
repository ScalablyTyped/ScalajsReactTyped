...
object RoadSurfaceRouteOptions {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(callback = js.Any.fromFunction2((t0: /* error */ js.Error, t1: DataAny) => (callback(t0, t1)).runNow()), provider = provider.asInstanceOf[js.Any], routeDuration = routeDuration.asInstanceOf[js.Any], routePath = routePath.asInstanceOf[js.Any])
