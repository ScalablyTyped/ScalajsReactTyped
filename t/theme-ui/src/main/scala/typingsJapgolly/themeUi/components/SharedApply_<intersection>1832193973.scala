...
abstract class `SharedApply_<intersection>1832193973` () {
  ...
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLDivElement], 
  org.scalajs.dom.raw.HTMLDivElement]) with typingsJapgolly.themeUi.mod.SxProps with typingsJapgolly.themeUi.AnonAs])(children: _*)
  }
}
