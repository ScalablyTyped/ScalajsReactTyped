...
object StyledUl {
  ...
  (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLUListElement], 
    org.scalajs.dom.raw.HTMLUListElement
  ]) with typingsJapgolly.themeUi.mod.SxProps with typingsJapgolly.themeUi.AnonAs, 
  japgolly.scalajs.react.Children.Varargs, 
  typingsJapgolly.react.mod.LegacyRef[org.scalajs.dom.raw.HTMLUListElement]](this.componentImport)
    f(__obj.asInstanceOf[(typingsJapgolly.react.mod.DetailedHTMLProps[
  typingsJapgolly.react.mod.HTMLAttributes[org.scalajs.dom.raw.HTMLUListElement], 
  org.scalajs.dom.raw.HTMLUListElement]) with typingsJapgolly.themeUi.mod.SxProps with typingsJapgolly.themeUi.AnonAs])(children: _*)
  }
  @JSImport("theme-ui", "Styled.ul")
  @js.native
