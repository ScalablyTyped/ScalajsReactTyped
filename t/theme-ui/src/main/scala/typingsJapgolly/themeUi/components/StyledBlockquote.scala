...
object StyledBlockquote {
  ...
  (typingsJapgolly.react.mod.DetailedHTMLProps[
    typingsJapgolly.react.mod.BlockquoteHTMLAttributes[org.scalajs.dom.raw.HTMLElement], 
  ...
  typingsJapgolly.react.mod.BlockquoteHTMLAttributes[org.scalajs.dom.raw.HTMLElement], 
  org.scalajs.dom.raw.HTMLElement]) with typingsJapgolly.themeUi.mod.SxProps with typingsJapgolly.themeUi.AnonAs])(children: _*)
  }
