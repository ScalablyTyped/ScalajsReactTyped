...
object distDeclarationsSrcMod {
  ...
  object jsx {
    ...
    inline def apply[P /* <: js.Object */](`type`: ComponentClassP[P & js.Object], props: Attributes & P, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    inline def apply[P /* <: js.Object */](`type`: ComponentClassP[P & js.Object], props: Null, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    inline def apply[P /* <: js.Object */](`type`: ComponentClassP[P & js.Object], props: Unit, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    inline def apply[P /* <: js.Object */](`type`: String, props: Attributes & P, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    inline def apply[P /* <: js.Object */](`type`: String, props: Null, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    inline def apply[P /* <: js.Object */](`type`: String, props: Unit, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    ...
    inline def apply[P /* <: js.Object */](`type`: FunctionComponent[P], props: Attributes & P, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    inline def apply[P /* <: js.Object */](`type`: FunctionComponent[P], props: Null, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    inline def apply[P /* <: js.Object */](`type`: FunctionComponent[P], props: Unit, children: Node*): japgolly.scalajs.react.facade.React.Element = (^.asInstanceOf[js.Dynamic].apply((scala.List(`type`.asInstanceOf[js.Any], props.asInstanceOf[js.Any])).`++`(children.asInstanceOf[Seq[js.Any]])*)).asInstanceOf[japgolly.scalajs.react.facade.React.Element]
    ...
    object JSX {
      ...
      type IntrinsicElements = typingsJapgolly.themeUiCore.distDeclarationsSrcJsxNamespaceMod.ThemeUIJSX.IntrinsicElements
