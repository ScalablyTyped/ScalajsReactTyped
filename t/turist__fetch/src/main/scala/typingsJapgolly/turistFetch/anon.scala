...
import typingsJapgolly.node.dnsMod.Resolver
import typingsJapgolly.node.dnsMod.SoaRecord
import typingsJapgolly.node.dnsMod.SrvRecord
import typingsJapgolly.turistFetch.turistFetchStrings.A
import typingsJapgolly.turistFetch.turistFetchStrings.AAAA
import typingsJapgolly.turistFetch.turistFetchStrings.ANY
import typingsJapgolly.turistFetch.turistFetchStrings.CAA
import typingsJapgolly.turistFetch.turistFetchStrings.CNAME
import typingsJapgolly.turistFetch.turistFetchStrings.MX
import typingsJapgolly.turistFetch.turistFetchStrings.NAPTR
import typingsJapgolly.turistFetch.turistFetchStrings.NS
import typingsJapgolly.turistFetch.turistFetchStrings.PTR
import typingsJapgolly.turistFetch.turistFetchStrings.SOA
import typingsJapgolly.turistFetch.turistFetchStrings.SRV
import typingsJapgolly.turistFetch.turistFetchStrings.TXT
import typingsJapgolly.turistFetch.turistFetchStrings.ipv4first
import typingsJapgolly.turistFetch.turistFetchStrings.verbatim
...
object anon {
  ...
  trait Typeofdns extends StObject {
    ...
    var Resolver: Instantiable0[typingsJapgolly.node.dnsMod.Resolver]
  ...
  object Typeofdns {
    ...
    inline def apply(
      ...
      TIMEOUT: String,
      V4MAPPED: Double,
      getServers: CallbackTo[js.Array[String]],
      lookup: Typeoflookup,
    ...
    extension [Self <: Typeofdns](x: Self) {
      ...
      inline def setGetServers(value: CallbackTo[js.Array[String]]): Self = StObject.set(x, "getServers", value.toJsFn)
      ...
      inline def setReverse(
        value: (String, js.Function2[/* err */ ErrnoException | Null, /* hostnames */ js.Array[String], Unit]) => Callback
      ): Self = StObject.set(x, "reverse", js.Any.fromFunction2((t0: String, t1: js.Function2[/* err */ ErrnoException | Null, /* hostnames */ js.Array[String], Unit]) => (value(t0, t1)).runNow()))
      
      inline def setSERVFAIL(value: String): Self = StObject.set(x, "SERVFAIL", value.asInstanceOf[js.Any])
      
      inline def setSetDefaultResultOrder(value: ipv4first | verbatim => Callback): Self = StObject.set(x, "setDefaultResultOrder", js.Any.fromFunction1((t0: ipv4first | verbatim) => value(t0).runNow()))
      
      inline def setSetServers(value: js.Array[String] => Callback): Self = StObject.set(x, "setServers", js.Any.fromFunction1((t0: js.Array[String]) => value(t0).runNow()))
  ...
  trait Typeofpromises extends StObject {
    ...
    var Resolver: Instantiable0[typingsJapgolly.node.dnsMod.promises.Resolver] = js.native
