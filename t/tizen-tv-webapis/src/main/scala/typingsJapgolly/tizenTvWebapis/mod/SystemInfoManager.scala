...
object SystemInfoManager {
  ...
  inline def apply(
    ...
    val __obj = js.Dynamic.literal(getVersion = getVersion.toJsFn, isSupportedAudioCodec = js.Any.fromFunction1(isSupportedAudioCodec), isSupportedVideoCodec = js.Any.fromFunction1(isSupportedVideoCodec))
