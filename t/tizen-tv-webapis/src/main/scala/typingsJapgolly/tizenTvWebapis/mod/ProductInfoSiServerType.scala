...
object ProductInfoSiServerType extends StObject {
  ...
  /* 2 */ val SI_TYPE_DEVELOPING_SERVER: typingsJapgolly.tizenTvWebapis.mod.ProductInfoSiServerType.SI_TYPE_DEVELOPING_SERVER & Double = js.native
  ...
  sealed trait SI_TYPE_DEVELOPMENT_SERVER
    extends StObject
       with ProductInfoSiServerType
  /* 1 */ val SI_TYPE_DEVELOPMENT_SERVER: typingsJapgolly.tizenTvWebapis.mod.ProductInfoSiServerType.SI_TYPE_DEVELOPMENT_SERVER & Double = js.native
  ...
  sealed trait SI_TYPE_OPERATIING_SERVER
    extends StObject
       with ProductInfoSiServerType
  /* 0 */ val SI_TYPE_OPERATIING_SERVER: typingsJapgolly.tizenTvWebapis.mod.ProductInfoSiServerType.SI_TYPE_OPERATIING_SERVER & Double = js.native
}
