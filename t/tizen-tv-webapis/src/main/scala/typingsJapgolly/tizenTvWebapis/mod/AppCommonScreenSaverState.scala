...
object AppCommonScreenSaverState extends StObject {
  ...
  /* 0 */ val SCREEN_SAVER_OFF: typingsJapgolly.tizenTvWebapis.mod.AppCommonScreenSaverState.SCREEN_SAVER_OFF & Double = js.native
  ...
  sealed trait SCREEN_SAVER_ON
    extends StObject
       with AppCommonScreenSaverState
  /* 1 */ val SCREEN_SAVER_ON: typingsJapgolly.tizenTvWebapis.mod.AppCommonScreenSaverState.SCREEN_SAVER_ON & Double = js.native
}
