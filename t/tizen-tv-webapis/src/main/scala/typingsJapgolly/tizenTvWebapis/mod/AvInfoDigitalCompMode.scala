...
object AvInfoDigitalCompMode extends StObject {
  ...
  /* 0 */ val DOLBY_DIGITAL_COMP_MODE_LINE: typingsJapgolly.tizenTvWebapis.mod.AvInfoDigitalCompMode.DOLBY_DIGITAL_COMP_MODE_LINE & Double = js.native
  ...
  sealed trait DOLBY_DIGITAL_COMP_MODE_RF
    extends StObject
       with AvInfoDigitalCompMode
  /* 1 */ val DOLBY_DIGITAL_COMP_MODE_RF: typingsJapgolly.tizenTvWebapis.mod.AvInfoDigitalCompMode.DOLBY_DIGITAL_COMP_MODE_RF & Double = js.native
}
