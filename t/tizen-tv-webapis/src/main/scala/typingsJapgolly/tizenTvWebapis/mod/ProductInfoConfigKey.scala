...
object ProductInfoConfigKey extends StObject {
  ...
  /* 0 */ val CONFIG_KEY_DATA_SERVICE: typingsJapgolly.tizenTvWebapis.mod.ProductInfoConfigKey.CONFIG_KEY_DATA_SERVICE & Double = js.native
  ...
  sealed trait CONFIG_KEY_SERVICE_COUNTRY
    extends StObject
       with ProductInfoConfigKey
  /* 1 */ val CONFIG_KEY_SERVICE_COUNTRY: typingsJapgolly.tizenTvWebapis.mod.ProductInfoConfigKey.CONFIG_KEY_SERVICE_COUNTRY & Double = js.native
}
