...
object ProductInfoNoGlass3dSupport extends StObject {
  ...
  /* 0 */ val NO_GLASS_3D_NOT_SUPPORTED: typingsJapgolly.tizenTvWebapis.mod.ProductInfoNoGlass3dSupport.NO_GLASS_3D_NOT_SUPPORTED & Double = js.native
  ...
  sealed trait NO_GLASS_3D_SUPPORTED
    extends StObject
       with ProductInfoNoGlass3dSupport
  /* 1 */ val NO_GLASS_3D_SUPPORTED: typingsJapgolly.tizenTvWebapis.mod.ProductInfoNoGlass3dSupport.NO_GLASS_3D_SUPPORTED & Double = js.native
}
