...
object SsoLoginState extends StObject {
  ...
  sealed trait SSO_LOGIN
    extends StObject
       with SsoLoginState
  /* 1 */ val SSO_LOGIN: typingsJapgolly.tizenTvWebapis.mod.SsoLoginState.SSO_LOGIN & Double = js.native
  ...
  sealed trait SSO_NOT_LOGIN
    extends StObject
       with SsoLoginState
  /* 0 */ val SSO_NOT_LOGIN: typingsJapgolly.tizenTvWebapis.mod.SsoLoginState.SSO_NOT_LOGIN & Double = js.native
}
