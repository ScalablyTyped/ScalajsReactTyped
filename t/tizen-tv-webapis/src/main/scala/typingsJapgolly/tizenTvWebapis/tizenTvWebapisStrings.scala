...
import typingsJapgolly.tizenTvWebapis.mod.AVPlayBufferOption
import typingsJapgolly.tizenTvWebapis.mod.AVPlayBufferSizeUnit
import typingsJapgolly.tizenTvWebapis.mod.AVPlayDisplayMode
import typingsJapgolly.tizenTvWebapis.mod.AVPlayDrmOperation
import typingsJapgolly.tizenTvWebapis.mod.AVPlayDrmType
import typingsJapgolly.tizenTvWebapis.mod.AVPlayError
import typingsJapgolly.tizenTvWebapis.mod.AVPlayEvent
import typingsJapgolly.tizenTvWebapis.mod.AVPlayPlayerState
import typingsJapgolly.tizenTvWebapis.mod.AVPlayStreamType
import typingsJapgolly.tizenTvWebapis.mod.AVPlayStreamingPropertyType
import typingsJapgolly.tizenTvWebapis.mod.HistoryType
import typingsJapgolly.tizenTvWebapis.mod.TVServerType
...
object tizenTvWebapisStrings {
  ...
  inline def AMH: AMH = "AMH".asInstanceOf[AMH]
  ...
  inline def CZE: CZE = "CZE".asInstanceOf[CZE]
  
  @js.native
  sealed trait DAG extends StObject
  inline def DAG: DAG = "DAG".asInstanceOf[DAG]
  ...
  inline def EWE: EWE = "EWE".asInstanceOf[EWE]
  ...
  inline def GAA: GAA = "GAA".asInstanceOf[GAA]
  ...
  inline def GLA: GLA = "GLA".asInstanceOf[GLA]
  ...
  inline def GOS: GOS = "GOS".asInstanceOf[GOS]
  
  @js.native
  sealed trait GRE extends StObject
  inline def GRE: GRE = "GRE".asInstanceOf[GRE]
  ...
  inline def IGB: IGB = "IGB".asInstanceOf[IGB]
  ...
  inline def KAN: KAN = "KAN".asInstanceOf[KAN]
  
  @js.native
  sealed trait KOK extends StObject
  inline def KOK: KOK = "KOK".asInstanceOf[KOK]
  ...
  inline def MAL: MAL = "MAL".asInstanceOf[MAL]
  
  @js.native
  sealed trait MAO extends StObject
  inline def MAO: MAO = "MAO".asInstanceOf[MAO]
  ...
  inline def NSO: NSO = "NSO".asInstanceOf[NSO]
  
  @js.native
  sealed trait NZI extends StObject
  inline def NZI: NZI = "NZI".asInstanceOf[NZI]
  
  @js.native
  sealed trait ORI extends StObject
  inline def ORI: ORI = "ORI".asInstanceOf[ORI]
  ...
  inline def QAA: QAA = "QAA".asInstanceOf[QAA]
  
  @js.native
  sealed trait QAB extends StObject
  inline def QAB: QAB = "QAB".asInstanceOf[QAB]
  ...
  inline def ROM: ROM = "ROM".asInstanceOf[ROM]
  ...
  inline def SRP: SRP = "SRP".asInstanceOf[SRP]
  ...
  inline def TAM: TAM = "TAM".asInstanceOf[TAM]
  ...
  inline def TSN: TSN = "TSN".asInstanceOf[TSN]
  
  @js.native
  sealed trait TSO extends StObject
  inline def TSO: TSO = "TSO".asInstanceOf[TSO]
  ...
  inline def TWI: TWI = "TWI".asInstanceOf[TWI]
  ...
  inline def VERY_FAST: VERY_FAST = "VERY_FAST".asInstanceOf[VERY_FAST]
  ...
  inline def XHO: XHO = "XHO".asInstanceOf[XHO]
  
  @js.native
  sealed trait XSM extends StObject
  inline def XSM: XSM = "XSM".asInstanceOf[XSM]
  ...
  inline def YUE: YUE = "YUE".asInstanceOf[YUE]
