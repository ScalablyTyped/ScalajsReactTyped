...
object mod {
  ...
  object Configuration {
    ...
    extension [Self <: Configuration](x: Self) {
      ...
      inline def setUpdateToken(value: String => Callback): Self = StObject.set(x, "updateToken", js.Any.fromFunction1((t0: String) => value(t0).runNow()))
    }
  }
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.media
    - typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.body
    - typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.history
  */
  trait MediaCategory extends StObject
  object MediaCategory {
    
    inline def body: typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.body = "body".asInstanceOf[typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.body]
    
    inline def history: typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.history = "history".asInstanceOf[typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.history]
    
    inline def media: typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.media = "media".asInstanceOf[typingsJapgolly.twilioMcsClient.twilioMcsClientStrings.media]
  }
