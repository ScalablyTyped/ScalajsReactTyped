package typingsJapgolly.traceryGrammar
...
import typingsJapgolly.traceryGrammar.anon.A
import typingsJapgolly.traceryGrammar.anon.Node
import typingsJapgolly.traceryGrammar.traceryGrammarInts.`0`
import typingsJapgolly.traceryGrammar.traceryGrammarInts.`1`
import typingsJapgolly.traceryGrammar.traceryGrammarInts.`2`
...
object mod {
  ...
  inline def parseTag(): typingsJapgolly.traceryGrammar.anon.Modifiers = ^.asInstanceOf[js.Dynamic].applyDynamic("parseTag")().asInstanceOf[typingsJapgolly.traceryGrammar.anon.Modifiers]
  inline def parseTag(tagContents: String): typingsJapgolly.traceryGrammar.anon.Modifiers = ^.asInstanceOf[js.Dynamic].applyDynamic("parseTag")(tagContents.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.traceryGrammar.anon.Modifiers]
  ...
  object TraceryNodeAction {
    ...
    inline def apply(
      activate: Callback,
      createUndo: CallbackTo[TraceryNodeAction],
      finishedRules: js.Array[String],
      node: TraceryNode,
      rule: String,
      ruleSections: js.Array[String],
      target: String,
      toText: CallbackTo[String],
      `type`: `0` | `1` | `2`
    ): TraceryNodeAction = {
      val __obj = js.Dynamic.literal(activate = activate.toJsFn, createUndo = createUndo.toJsFn, finishedRules = finishedRules.asInstanceOf[js.Any], node = node.asInstanceOf[js.Any], rule = rule.asInstanceOf[js.Any], ruleSections = ruleSections.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any], toText = toText.toJsFn)
    ...
    extension [Self <: TraceryNodeAction](x: Self) {
      ...
      inline def setCreateUndo(value: CallbackTo[TraceryNodeAction]): Self = StObject.set(x, "createUndo", value.toJsFn)
      ...
      inline def setToText(value: CallbackTo[String]): Self = StObject.set(x, "toText", value.toJsFn)
