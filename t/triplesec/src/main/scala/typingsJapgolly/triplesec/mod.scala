package typingsJapgolly.triplesec
...
object mod {
  ...
  object Arguments {
    ...
    extension [Self <: Arguments](x: Self) {
      ...
      inline def setProgress_hook(value: /* progress */ Progress => Callback): Self = StObject.set(x, "progress_hook", js.Any.fromFunction1((t0: /* progress */ Progress) => value(t0).runNow()))
  ...
  object WordArray {
    ...
    inline def apply(sigBytes: Double, to_hex: CallbackTo[String], words: js.Array[Double]): WordArray = {
      val __obj = js.Dynamic.literal(sigBytes = sigBytes.asInstanceOf[js.Any], to_hex = to_hex.toJsFn, words = words.asInstanceOf[js.Any])
    ...
    extension [Self <: WordArray](x: Self) {
      ...
      inline def setTo_hex(value: CallbackTo[String]): Self = StObject.set(x, "to_hex", value.toJsFn)
