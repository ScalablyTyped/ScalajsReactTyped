...
import typingsJapgolly.tap.mod.Assertions.Basic
import typingsJapgolly.tap.mod.Assertions.DoesNotThrow
import typingsJapgolly.tap.mod.Assertions.Equal
import typingsJapgolly.tap.mod.Assertions.Match
import typingsJapgolly.tap.mod.Assertions.NotEqual
import typingsJapgolly.tap.mod.Assertions.Throws
import typingsJapgolly.tap.mod.Assertions.Type
import typingsJapgolly.tap.mod.Options.Assert
import typingsJapgolly.tap.mod.Options.Bag
import typingsJapgolly.tap.mod.Options.Pragma
import typingsJapgolly.tap.mod.Options.Spawn
import typingsJapgolly.tap.mod.global.Tap.Fixture.Instance
import typingsJapgolly.tap.mod.global.Tap.Fixture.Spec
import typingsJapgolly.tap.mod.global.Tap.Tap
import typingsJapgolly.tap.tapStrings.dir
import typingsJapgolly.tap.tapStrings.file
import typingsJapgolly.tap.tapStrings.link
import typingsJapgolly.tap.tapStrings.symlink
...
object mod extends Shortcut {
  ...
  @js.native
  open class Test ()
    extends typingsJapgolly.tap.mod.global.Tap.Test {
    def this(options: typingsJapgolly.tap.mod.Options.Test) = this()
  }
  ...
  object global {
    ...
    object Tap {
      ...
      open class Test ()
        ...
        def current(): typingsJapgolly.tap.mod.global.Tap.Test = js.native
        ...
        def only(name: String, extra: typingsJapgolly.tap.mod.Options.Test): js.Promise[Unit] = js.native
        def only(
          name: String,
          extra: typingsJapgolly.tap.mod.Options.Test,
        ...
        def skip(name: String, extra: typingsJapgolly.tap.mod.Options.Test): js.Promise[Unit] = js.native
        def skip(
          name: String,
          extra: typingsJapgolly.tap.mod.Options.Test,
          cb: js.Function1[/* t */ this.type, js.Promise[Unit] | Unit]
        ...
        def test(name: String, extra: typingsJapgolly.tap.mod.Options.Test): js.Promise[Unit] = js.native
        def test(
          name: String,
          extra: typingsJapgolly.tap.mod.Options.Test,
          cb: js.Function1[/* t */ this.type, js.Promise[Unit] | Unit]
        ...
        def threw(error: js.Error, extra: js.Error, proxy: typingsJapgolly.tap.mod.global.Tap.Test): Unit = js.native
        def threw(error: js.Error, extra: Unit, proxy: typingsJapgolly.tap.mod.global.Tap.Test): Unit = js.native
        ...
        def todo(name: String, extra: typingsJapgolly.tap.mod.Options.Test): js.Promise[Unit] = js.native
        def todo(
          name: String,
          extra: typingsJapgolly.tap.mod.Options.Test,
          cb: js.Function1[/* t */ this.type, js.Promise[Unit] | Unit]
      ...
      trait TestConstructor
        extends StObject
           with Instantiable0[typingsJapgolly.tap.mod.global.Tap.Test]
           with Instantiable1[
                  /* options */ typingsJapgolly.tap.mod.Options.Test, 
                  typingsJapgolly.tap.mod.global.Tap.Test
                ]
    }
  }
  ...
  object DeprecatedAssertionSynonyms {
    ...
    inline def apply(
      ...
      tearDown: js.Function0[Unit | js.Promise[Unit]] => Callback,
      `throw`: Throws,
    ...
    extension [Self <: DeprecatedAssertionSynonyms](x: Self) {
      ...
      inline def setTearDown(value: js.Function0[Unit | js.Promise[Unit]] => Callback): Self = StObject.set(x, "tearDown", js.Any.fromFunction1((t0: js.Function0[Unit | js.Promise[Unit]]) => value(t0).runNow()))
  ...
  object Options {
    ...
    object Test {
      ...
      inline def apply(): typingsJapgolly.tap.mod.Options.Test = {
        val __obj = js.Dynamic.literal()
        __obj.asInstanceOf[typingsJapgolly.tap.mod.Options.Test]
      }
      
      extension [Self <: typingsJapgolly.tap.mod.Options.Test](x: Self) {
