...
import typingsJapgolly.toastifyJs.toastifyJsStrings.bottom
import typingsJapgolly.toastifyJs.toastifyJsStrings.center
import typingsJapgolly.toastifyJs.toastifyJsStrings.left
import typingsJapgolly.toastifyJs.toastifyJsStrings.right
import typingsJapgolly.toastifyJs.toastifyJsStrings.top
...
object mod {
  ...
  object Toastify {
    ...
    inline def apply(hideToast: Callback, options: Options, showToast: Callback): Toastify = {
      val __obj = js.Dynamic.literal(hideToast = hideToast.toJsFn, options = options.asInstanceOf[js.Any], showToast = showToast.toJsFn, toastElement = null)
      __obj.asInstanceOf[Toastify]
    }
    
    extension [Self <: Toastify](x: Self) {
      
      inline def setHideToast(value: Callback): Self = StObject.set(x, "hideToast", value.toJsFn)
      
      inline def setOptions(value: Options): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
      
      inline def setShowToast(value: Callback): Self = StObject.set(x, "showToast", value.toJsFn)
