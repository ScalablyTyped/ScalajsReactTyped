...
@scala.inline
open class SharedBuilder_SpacerProps_16984989 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def isInlineBlock(value: Boolean): this.type = set("isInlineBlock", value.asInstanceOf[js.Any])
  ...
  inline def marginBottom(
    value: largePlussign2 | `small-2` | `small-1` | typingsJapgolly.terraSpacer.terraSpacerStrings.none | large | medium | small | largePlussign4 | largePlussign3 | largePlussign1
