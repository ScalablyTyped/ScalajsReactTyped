...
import typingsJapgolly.tinycolor2.anon.Aliceblue
import typingsJapgolly.tinycolor2.anon.`000`
...
object mod extends Shortcut {
  ...
  object ColorFormats {
    ...
    - typingsJapgolly.tinycolor2.mod._ColorInputWithoutInstance because Already inherited */ trait HSLA
      extends StObject
         with HSL
         with Alpha
    object HSLA {
    ...
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typingsJapgolly.tinycolor2.mod._ColorInput because Already inherited
    - typingsJapgolly.tinycolor2.mod._ColorInputWithoutInstance because Already inherited */ trait HSVA
      extends StObject
         with HSV {
    ...
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typingsJapgolly.tinycolor2.mod._ColorInput because Already inherited
    - typingsJapgolly.tinycolor2.mod._ColorInputWithoutInstance because Already inherited */ trait PRGBA
      extends StObject
         with PRGB
         with Alpha
    object PRGBA {
    ...
    /* import warning: transforms.RemoveMultipleInheritance#findNewParents newComments Dropped parents 
    - typingsJapgolly.tinycolor2.mod._ColorInput because Already inherited
    - typingsJapgolly.tinycolor2.mod._ColorInputWithoutInstance because Already inherited */ trait RGBA
      extends StObject
         with RGB
         with Alpha
    object RGBA {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tinycolor2.mod.ColorInputWithoutInstance
    - typingsJapgolly.tinycolor2.mod.Instance
  */
  type ColorInput = _ColorInput | String
  
  /* Rewritten from type alias, can be one of: 
    - java.lang.String
    - typingsJapgolly.tinycolor2.mod.ColorFormats.PRGB
    - typingsJapgolly.tinycolor2.mod.ColorFormats.PRGBA
    - typingsJapgolly.tinycolor2.mod.ColorFormats.RGB
    - typingsJapgolly.tinycolor2.mod.ColorFormats.RGBA
    - typingsJapgolly.tinycolor2.mod.ColorFormats.HSL
    - typingsJapgolly.tinycolor2.mod.ColorFormats.HSLA
    - typingsJapgolly.tinycolor2.mod.ColorFormats.HSV
    - typingsJapgolly.tinycolor2.mod.ColorFormats.HSVA
  */
  ...
  object _ColorInputWithoutInstance {
    ...
    inline def HSL(h: Double, l: Double, s: Double): typingsJapgolly.tinycolor2.mod.ColorFormats.HSL = {
      val __obj = js.Dynamic.literal(h = h.asInstanceOf[js.Any], l = l.asInstanceOf[js.Any], s = s.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tinycolor2.mod.ColorFormats.HSL]
    }
    
    inline def HSLA(a: Double, h: Double, l: Double, s: Double): typingsJapgolly.tinycolor2.mod.ColorFormats.HSLA = {
      val __obj = js.Dynamic.literal(a = a.asInstanceOf[js.Any], h = h.asInstanceOf[js.Any], l = l.asInstanceOf[js.Any], s = s.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tinycolor2.mod.ColorFormats.HSLA]
    }
    
    inline def HSV(h: Double, s: Double, v: Double): typingsJapgolly.tinycolor2.mod.ColorFormats.HSV = {
      val __obj = js.Dynamic.literal(h = h.asInstanceOf[js.Any], s = s.asInstanceOf[js.Any], v = v.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tinycolor2.mod.ColorFormats.HSV]
    }
    
    inline def HSVA(a: Double, h: Double, s: Double, v: Double): typingsJapgolly.tinycolor2.mod.ColorFormats.HSVA = {
      val __obj = js.Dynamic.literal(a = a.asInstanceOf[js.Any], h = h.asInstanceOf[js.Any], s = s.asInstanceOf[js.Any], v = v.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tinycolor2.mod.ColorFormats.HSVA]
    }
    
    inline def PRGB(b: String, g: String, r: String): typingsJapgolly.tinycolor2.mod.ColorFormats.PRGB = {
      val __obj = js.Dynamic.literal(b = b.asInstanceOf[js.Any], g = g.asInstanceOf[js.Any], r = r.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tinycolor2.mod.ColorFormats.PRGB]
    }
    
    inline def PRGBA(a: Double, b: String, g: String, r: String): typingsJapgolly.tinycolor2.mod.ColorFormats.PRGBA = {
      val __obj = js.Dynamic.literal(a = a.asInstanceOf[js.Any], b = b.asInstanceOf[js.Any], g = g.asInstanceOf[js.Any], r = r.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tinycolor2.mod.ColorFormats.PRGBA]
    }
    
    inline def RGB(b: Double, g: Double, r: Double): typingsJapgolly.tinycolor2.mod.ColorFormats.RGB = {
      val __obj = js.Dynamic.literal(b = b.asInstanceOf[js.Any], g = g.asInstanceOf[js.Any], r = r.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tinycolor2.mod.ColorFormats.RGB]
    }
    
    inline def RGBA(a: Double, b: Double, g: Double, r: Double): typingsJapgolly.tinycolor2.mod.ColorFormats.RGBA = {
      val __obj = js.Dynamic.literal(a = a.asInstanceOf[js.Any], b = b.asInstanceOf[js.Any], g = g.asInstanceOf[js.Any], r = r.asInstanceOf[js.Any])
      __obj.asInstanceOf[typingsJapgolly.tinycolor2.mod.ColorFormats.RGBA]
    }
  }
