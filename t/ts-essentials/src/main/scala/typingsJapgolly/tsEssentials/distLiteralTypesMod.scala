...
import typingsJapgolly.std.Uncapitalize
import typingsJapgolly.tsEssentials.tsEssentialsStrings._empty
import typingsJapgolly.tsEssentials.tsEssentialsStrings.`-_`
...
object distLiteralTypesMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tsEssentials.tsEssentialsStrings._underscore
    - typingsJapgolly.tsEssentials.tsEssentialsStrings.`-_`
  */
  ...
  object Separator {
    ...
    inline def _underscore: typingsJapgolly.tsEssentials.tsEssentialsStrings._underscore = "_".asInstanceOf[typingsJapgolly.tsEssentials.tsEssentialsStrings._underscore]
  }
