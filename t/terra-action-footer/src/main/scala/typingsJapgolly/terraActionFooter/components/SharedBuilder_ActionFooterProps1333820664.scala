...
@scala.inline
open class SharedBuilder_ActionFooterProps1333820664 (val args: js.Array[Any])
  extends AnyVal
  ...
  inline def end(value: VdomNode): this.type = set("end", value.rawNode.asInstanceOf[js.Any])
  ...
  inline def start(value: VdomNode): this.type = set("start", value.rawNode.asInstanceOf[js.Any])
