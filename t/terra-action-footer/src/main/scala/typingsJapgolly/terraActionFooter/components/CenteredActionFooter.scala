...
import typingsJapgolly.terraActionFooter.libCenteredActionFooterMod.CenteredActionFooterProps
import org.scalablytyped.runtime.StObject
import scala.scalajs.js
import scala.scalajs.js.annotation.{JSGlobalScope, JSGlobal, JSImport, JSName, JSBracketAccess}

object CenteredActionFooter {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def center(value: VdomNode): this.type = set("center", value.rawNode.asInstanceOf[js.Any])
    
    inline def centerNull: this.type = set("center", null)
    
    inline def centerVarargs(value: (Empty | String | JsNumber | Element)*): this.type = set("center", js.Array(value*))
    
    inline def centerVdomElement(value: VdomElement): this.type = set("center", value.rawElement.asInstanceOf[js.Any])
  ...
  implicit def make(companion: CenteredActionFooter.type): Builder = new Builder(js.Array(this.component, js.Dictionary.empty))()
  
  def withProps(p: CenteredActionFooterProps): Builder = new Builder(js.Array(this.component, p.asInstanceOf[js.Any]))
}
