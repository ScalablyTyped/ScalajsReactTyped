package typingsJapgolly.typography
...
object mod {
  ...
  object Typography {
    ...
    inline def apply(
      ...
      createStyles: CallbackTo[String],
      establishBaseline: CallbackTo[BaseLine],
      injectStyles: Callback,
      ...
      val __obj = js.Dynamic.literal(adjustFontSizeTo = js.Any.fromFunction1(adjustFontSizeTo), createStyles = createStyles.toJsFn, establishBaseline = establishBaseline.toJsFn, injectStyles = injectStyles.toJsFn, linesForFontSize = js.Any.fromFunction1(linesForFontSize), options = options.asInstanceOf[js.Any], rhythm = js.Any.fromFunction1(rhythm), scale = js.Any.fromFunction1(scale), toJSON = toJSON.toJsFn)
    ...
    extension [Self <: Typography](x: Self) {
      ...
      inline def setCreateStyles(value: CallbackTo[String]): Self = StObject.set(x, "createStyles", value.toJsFn)
      
      inline def setEstablishBaseline(value: CallbackTo[BaseLine]): Self = StObject.set(x, "establishBaseline", value.toJsFn)
      
      inline def setInjectStyles(value: Callback): Self = StObject.set(x, "injectStyles", value.toJsFn)
