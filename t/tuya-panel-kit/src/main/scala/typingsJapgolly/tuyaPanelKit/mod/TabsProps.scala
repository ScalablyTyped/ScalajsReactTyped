...
trait TabsProps extends StObject {
  ...
  /**
    ...
    * @defaultValue undefined
    */
  var renderPlaceholder: js.UndefOr[js.Function2[/* activeIndex */ Double, /* child */ Node, Node]] = js.undefined
...
object TabsProps {
  ...
  extension [Self <: TabsProps](x: Self) {
    ...
    inline def setOnChange(value: (/* tab */ TabDataSource, /* idx */ Double) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* tab */ TabDataSource, t1: /* idx */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def setRenderPlaceholder(value: (/* activeIndex */ Double, /* child */ Node) => Node): Self = StObject.set(x, "renderPlaceholder", js.Any.fromFunction2(value))
