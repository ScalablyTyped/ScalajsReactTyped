...
import typingsJapgolly.tuyaPanelKit.anon.Content
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.arrow
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.switch
...
object PopUpListProps {
  ...
  extension [Self <: PopUpListProps](x: Self) {
    ...
    inline def setOnSelect(value: (/* value */ String | Double, /* params */ js.UndefOr[`11`]) => Callback): Self = StObject.set(x, "onSelect", js.Any.fromFunction2((t0: /* value */ String | Double, t1: /* params */ js.UndefOr[`11`]) => (value(t0, t1)).runNow()))
    ...
    inline def set_onDataChange(value: /* value */ js.UndefOr[String | js.Array[String]] => Callback): Self = StObject.set(x, "_onDataChange", js.Any.fromFunction1((t0: /* value */ js.UndefOr[String | js.Array[String]]) => value(t0).runNow()))
