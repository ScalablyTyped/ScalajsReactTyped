...
object TimerPickerProps {
  ...
  extension [Self <: TimerPickerProps](x: Self) {
    ...
    inline def setOnTimerChange(value: (/* startTime */ Double, /* endTime */ Double) => Callback): Self = StObject.set(x, "onTimerChange", js.Any.fromFunction2((t0: /* startTime */ Double, t1: /* endTime */ Double) => (value(t0, t1)).runNow()))
