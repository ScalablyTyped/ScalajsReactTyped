...
object BrickButtonProps {
  ...
  extension [Self <: BrickButtonProps](x: Self) {
    ...
    inline def setOnChange(value: (/* eventName */ String, /* args */ Any) => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction2((t0: /* eventName */ String, t1: /* args */ Any) => (value(t0, t1)).runNow()))
