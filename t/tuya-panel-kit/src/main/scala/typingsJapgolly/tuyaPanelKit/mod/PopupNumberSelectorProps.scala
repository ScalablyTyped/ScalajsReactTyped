...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.basic
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.slider
...
trait PopupNumberSelectorProps extends StObject {
  ...
  var renderMaximumTrack: js.UndefOr[js.Function0[Node]] = js.undefined
  
  var renderMinimumTrack: js.UndefOr[js.Function0[Node]] = js.undefined
  
  var renderThumb: js.UndefOr[js.Function0[Node]] = js.undefined
  ...
  var title: js.UndefOr[String | js.Array[String] | Node] = js.undefined
...
object PopupNumberSelectorProps {
  ...
  extension [Self <: PopupNumberSelectorProps](x: Self) {
    ...
    inline def setOnBack(value: /* args */ `11` => Callback): Self = StObject.set(x, "onBack", js.Any.fromFunction1((t0: /* args */ `11`) => value(t0).runNow()))
    ...
    inline def setOnConfirm(value: (/* data */ Any, /* args */ `11`) => Callback): Self = StObject.set(x, "onConfirm", js.Any.fromFunction2((t0: /* data */ Any, t1: /* args */ `11`) => (value(t0, t1)).runNow()))
    ...
    inline def setOnLayout(value: /* x */ Double => Callback): Self = StObject.set(x, "onLayout", js.Any.fromFunction1((t0: /* x */ Double) => value(t0).runNow()))
    ...
    inline def setOnMaskPress(value: /* args */ `11` => Callback): Self = StObject.set(x, "onMaskPress", js.Any.fromFunction1((t0: /* args */ `11`) => value(t0).runNow()))
    ...
    inline def setOnScrollEvent(value: /* value */ Double => Callback): Self = StObject.set(x, "onScrollEvent", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
    ...
    inline def setOnSlidingComplete(value: /* newValue */ Double => Callback): Self = StObject.set(x, "onSlidingComplete", js.Any.fromFunction1((t0: /* newValue */ Double) => value(t0).runNow()))
    
    inline def setOnSlidingCompleteUndefined: Self = StObject.set(x, "onSlidingComplete", js.undefined)
    
    inline def setOnSlidingStart(value: /* newValue */ Double => Callback): Self = StObject.set(x, "onSlidingStart", js.Any.fromFunction1((t0: /* newValue */ Double) => value(t0).runNow()))
    ...
    inline def setOnSwitchValueChange(value: /* value */ Boolean => Callback): Self = StObject.set(x, "onSwitchValueChange", js.Any.fromFunction1((t0: /* value */ Boolean) => value(t0).runNow()))
    ...
    inline def setRenderMaximumTrack(value: CallbackTo[Node]): Self = StObject.set(x, "renderMaximumTrack", value.toJsFn)
    
    inline def setRenderMaximumTrackUndefined: Self = StObject.set(x, "renderMaximumTrack", js.undefined)
    
    inline def setRenderMinimumTrack(value: CallbackTo[Node]): Self = StObject.set(x, "renderMinimumTrack", value.toJsFn)
    
    inline def setRenderMinimumTrackUndefined: Self = StObject.set(x, "renderMinimumTrack", js.undefined)
    
    inline def setRenderThumb(value: CallbackTo[Node]): Self = StObject.set(x, "renderThumb", value.toJsFn)
    ...
    inline def setTitle(value: String | js.Array[String] | Node): Self = StObject.set(x, "title", value.asInstanceOf[js.Any])
    ...
    inline def setTitleVarargs(value: (Element | Empty | JsNumber | String)*): Self = StObject.set(x, "title", js.Array(value*))
    ...
    inline def set_onDataChange(value: /* value */ Double => Callback): Self = StObject.set(x, "_onDataChange", js.Any.fromFunction1((t0: /* value */ Double) => value(t0).runNow()))
