...
import typingsJapgolly.tuyaPanelKit.anon.CellRadius
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.iconfont
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.image
...
object TYSectionSliderProps {
  ...
  extension [Self <: TYSectionSliderProps](x: Self) {
    ...
    inline def setOnValueChange(value: /* newValue */ Double => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction1((t0: /* newValue */ Double) => value(t0).runNow()))
