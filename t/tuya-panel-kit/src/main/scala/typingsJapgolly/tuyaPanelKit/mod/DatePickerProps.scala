...
object DatePickerProps {
  ...
  extension [Self <: DatePickerProps](x: Self) {
    ...
    inline def setOnDateChange(value: /* value */ js.UndefOr[js.Date] => Callback): Self = StObject.set(x, "onDateChange", js.Any.fromFunction1((t0: /* value */ js.UndefOr[js.Date]) => value(t0).runNow()))
    
    inline def setOnDateChangeUndefined: Self = StObject.set(x, "onDateChange", js.undefined)
    
    inline def setOnValueChange(value: (/* value */ js.UndefOr[String | Double], /* index */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction2((t0: /* value */ js.UndefOr[String | Double], t1: /* index */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
