...
import typingsJapgolly.reactNative.mod.ViewPagerAndroidProps
...
trait CarouselProps
  ...
  /**
    ...
    * @defaultValue <a target="_blank" href="https://github.com/tuya/tuya-panel-kit/blob/master/src/components/carousel/dot.js#L33">defaultDot</a>
    */
  var dots: js.UndefOr[ElementType | (js.Function1[/* params */ CurrentIndex, Node])] = js.undefined
...
object CarouselProps {
  ...
  extension [Self <: CarouselProps](x: Self) {
    ...
    inline def setCarouselChange(value: /* index */ Double => Callback): Self = StObject.set(x, "carouselChange", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
    ...
    inline def setDots(value: ElementType | (js.Function1[/* params */ CurrentIndex, Node])): Self = StObject.set(x, "dots", value.asInstanceOf[js.Any])
    
    inline def setDotsFunction1(value: /* params */ CurrentIndex => Node): Self = StObject.set(x, "dots", js.Any.fromFunction1(value))
    ...
    inline def setOnMomentumScrollEnd(value: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ Any) => Callback): Self = StObject.set(x, "onMomentumScrollEnd", js.Any.fromFunction2((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ Any) => (value(t0, t1)).runNow()))
    
    inline def setOnMomentumScrollEndUndefined: Self = StObject.set(x, "onMomentumScrollEnd", js.undefined)
    
    inline def setOnScrollBeginDrag(value: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ Any) => Callback): Self = StObject.set(x, "onScrollBeginDrag", js.Any.fromFunction2((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ Any) => (value(t0, t1)).runNow()))
    
    inline def setOnScrollBeginDragUndefined: Self = StObject.set(x, "onScrollBeginDrag", js.undefined)
    
    inline def setOnScrollEndDrag(value: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ Any) => Callback): Self = StObject.set(x, "onScrollEndDrag", js.Any.fromFunction2((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ Any) => (value(t0, t1)).runNow()))
