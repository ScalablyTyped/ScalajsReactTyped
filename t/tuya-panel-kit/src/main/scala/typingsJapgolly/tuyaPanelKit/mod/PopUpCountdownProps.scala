...
import typingsJapgolly.tuyaPanelKit.anon.Hour
...
object PopUpCountdownProps {
  ...
  extension [Self <: PopUpCountdownProps](x: Self) {
    ...
    inline def setOnValueChange(value: /* data */ js.UndefOr[Hour] => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction1((t0: /* data */ js.UndefOr[Hour]) => value(t0).runNow()))
