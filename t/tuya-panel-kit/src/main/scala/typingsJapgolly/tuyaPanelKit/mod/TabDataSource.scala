...
trait TabDataSource
  ...
  var renderTab: js.UndefOr[
    js.Function3[/* isActive */ Boolean, /* state */ js.Object, /* props */ js.Object, Node]
  ] = js.undefined
...
object TabDataSource {
  ...
  extension [Self <: TabDataSource](x: Self) {
    ...
    inline def setRenderTab(value: (/* isActive */ Boolean, /* state */ js.Object, /* props */ js.Object) => Node): Self = StObject.set(x, "renderTab", js.Any.fromFunction3(value))
