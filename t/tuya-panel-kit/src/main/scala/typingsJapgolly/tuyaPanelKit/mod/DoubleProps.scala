...
import typingsJapgolly.tuyaPanelKit.anon.MaxValue
...
object DoubleProps {
  ...
  extension [Self <: DoubleProps](x: Self) {
    ...
    inline def setOnSlidingComplete(value: /* argus */ MaxValue => Callback): Self = StObject.set(x, "onSlidingComplete", js.Any.fromFunction1((t0: /* argus */ MaxValue) => value(t0).runNow()))
    
    inline def setOnSlidingCompleteUndefined: Self = StObject.set(x, "onSlidingComplete", js.undefined)
    
    inline def setOnValueChange(value: /* argus */ MaxValue => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction1((t0: /* argus */ MaxValue) => value(t0).runNow()))
