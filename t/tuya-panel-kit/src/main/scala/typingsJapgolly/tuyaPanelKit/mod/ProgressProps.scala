...
trait ProgressProps
  ...
  /**
    ...
    * @defaultValue null
    */
  var renderCenterView: js.UndefOr[Node] = js.undefined
...
object ProgressProps {
  ...
  extension [Self <: ProgressProps](x: Self) {
    ...
    inline def setRenderCenterView(value: VdomNode): Self = StObject.set(x, "renderCenterView", value.rawNode.asInstanceOf[js.Any])
    
    inline def setRenderCenterViewNull: Self = StObject.set(x, "renderCenterView", null)
    
    inline def setRenderCenterViewUndefined: Self = StObject.set(x, "renderCenterView", js.undefined)
    
    inline def setRenderCenterViewVarargs(value: (Empty | String | JsNumber | Element)*): Self = StObject.set(x, "renderCenterView", js.Array(value*))
    
    inline def setRenderCenterViewVdomElement(value: VdomElement): Self = StObject.set(x, "renderCenterView", value.rawElement.asInstanceOf[js.Any])
