...
object PopupPickerProps {
  ...
  extension [Self <: PopupPickerProps](x: Self) {
    ...
    inline def setOnConfirm(value: (/* data */ Any, /* idx */ Double, /* args */ `11`) => Callback): Self = StObject.set(x, "onConfirm", js.Any.fromFunction3((t0: /* data */ Any, t1: /* idx */ Double, t2: /* args */ `11`) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnConfirmUndefined: Self = StObject.set(x, "onConfirm", js.undefined)
    
    inline def setOnValueChange(value: (/* newValue */ String | Double, /* idx */ Double) => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction2((t0: /* newValue */ String | Double, t1: /* idx */ Double) => (value(t0, t1)).runNow()))
    ...
    inline def set_onDataChange(value: (/* newValue */ String | Double, /* idx */ Double) => Callback): Self = StObject.set(x, "_onDataChange", js.Any.fromFunction2((t0: /* newValue */ String | Double, t1: /* idx */ Double) => (value(t0, t1)).runNow()))
