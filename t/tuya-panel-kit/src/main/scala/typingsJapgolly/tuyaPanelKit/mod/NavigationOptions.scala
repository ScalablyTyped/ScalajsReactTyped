...
import typingsJapgolly.tuyaPanelKit.anon.Uri
import typingsJapgolly.tuyaPanelKit.themeMod.LinearGradientBackground
import typingsJapgolly.tuyaPanelKit.themeMod.RadialGradientBackground
...
object NavigationOptions {
  ...
  extension [Self <: NavigationOptions](x: Self) {
    ...
    inline def setRenderStatusBar(value: CallbackTo[Element]): Self = StObject.set(x, "renderStatusBar", value.toJsFn)
    
    inline def setRenderStatusBarUndefined: Self = StObject.set(x, "renderStatusBar", js.undefined)
    
    inline def setRenderTopBar(value: CallbackTo[Element]): Self = StObject.set(x, "renderTopBar", value.toJsFn)
