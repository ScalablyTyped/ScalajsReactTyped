...
trait NavigationRoute extends StObject {
  ...
  var options: js.UndefOr[
    StackNavigationOptions | (js.Function1[
...
object NavigationRoute {
  ...
  extension [Self <: NavigationRoute](x: Self) {
    ...
    inline def setOptions(
      value: StackNavigationOptions | (js.Function1[
          /* props */ typingsJapgolly.tuyaPanelKit.anon.NavigationRoute, 
          StackNavigationOptions
        ]) | NavigationOptions
    ): Self = StObject.set(x, "options", value.asInstanceOf[js.Any])
    
    inline def setOptionsFunction1(value: /* props */ typingsJapgolly.tuyaPanelKit.anon.NavigationRoute => StackNavigationOptions): Self = StObject.set(x, "options", js.Any.fromFunction1(value))
