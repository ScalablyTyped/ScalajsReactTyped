...
object SwipeoutProps {
  ...
  extension [Self <: SwipeoutProps](x: Self) {
    ...
    inline def setOnClose(value: (/* sectionID */ js.UndefOr[Double], /* rowID */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onClose", js.Any.fromFunction2((t0: /* sectionID */ js.UndefOr[Double], t1: /* rowID */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
    
    inline def setOnCloseUndefined: Self = StObject.set(x, "onClose", js.undefined)
    
    inline def setOnOpen(value: (/* sectionID */ js.UndefOr[Double], /* rowID */ js.UndefOr[Double]) => Callback): Self = StObject.set(x, "onOpen", js.Any.fromFunction2((t0: /* sectionID */ js.UndefOr[Double], t1: /* rowID */ js.UndefOr[Double]) => (value(t0, t1)).runNow()))
    ...
    inline def setScroll(value: /* value */ js.UndefOr[Boolean] => Callback): Self = StObject.set(x, "scroll", js.Any.fromFunction1((t0: /* value */ js.UndefOr[Boolean]) => value(t0).runNow()))
