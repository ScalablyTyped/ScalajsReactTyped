...
object PickerViewProps {
  ...
  extension [Self <: PickerViewProps](x: Self) {
    ...
    inline def setOnValueChange(value: (/* value */ String | Double, /* index */ Double) => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction2((t0: /* value */ String | Double, t1: /* index */ Double) => (value(t0, t1)).runNow()))
