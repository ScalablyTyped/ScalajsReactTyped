...
object TabContentProps {
  ...
  inline def apply(activeIndex: Double): TabContentProps = {
    val __obj = js.Dynamic.literal(activeIndex = activeIndex.asInstanceOf[js.Any], children = null)
  ...
  extension [Self <: TabContentProps](x: Self) {
    ...
    inline def setOnMove(value: (/* gestureState */ js.Object, /* index */ Double, /* percent */ Double) => Callback): Self = StObject.set(x, "onMove", js.Any.fromFunction3((t0: /* gestureState */ js.Object, t1: /* index */ Double, t2: /* percent */ Double) => (value(t0, t1, t2)).runNow()))
    
    inline def setOnMoveUndefined: Self = StObject.set(x, "onMove", js.undefined)
    
    inline def setOnRelease(value: (/* gestureState */ js.Object, /* index */ Double, /* percent */ Double) => Callback): Self = StObject.set(x, "onRelease", js.Any.fromFunction3((t0: /* gestureState */ js.Object, t1: /* index */ Double, t2: /* percent */ Double) => (value(t0, t1, t2)).runNow()))
