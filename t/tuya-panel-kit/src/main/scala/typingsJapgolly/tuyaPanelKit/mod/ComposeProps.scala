...
import typingsJapgolly.tuyaPanelKit.anon.Value1
import typingsJapgolly.tuyaPanelKit.anon.Value2x
...
object ComposeProps {
  ...
  extension [Self <: ComposeProps](x: Self) {
    ...
    inline def setOnSlidingComplete(value: /* argus */ Value2x => Callback): Self = StObject.set(x, "onSlidingComplete", js.Any.fromFunction1((t0: /* argus */ Value2x) => value(t0).runNow()))
    
    inline def setOnSlidingCompleteUndefined: Self = StObject.set(x, "onSlidingComplete", js.undefined)
    
    inline def setOnValueChange(value: /* argus */ Value1 => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction1((t0: /* argus */ Value1) => value(t0).runNow()))
