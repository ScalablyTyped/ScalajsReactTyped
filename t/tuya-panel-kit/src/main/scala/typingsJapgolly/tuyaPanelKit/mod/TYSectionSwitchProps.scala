...
object TYSectionSwitchProps {
  ...
  inline def apply(onValueChange: Boolean => Callback): TYSectionSwitchProps = {
    val __obj = js.Dynamic.literal(onValueChange = js.Any.fromFunction1((t0: Boolean) => onValueChange(t0).runNow()))
  ...
  extension [Self <: TYSectionSwitchProps](x: Self) {
    ...
    inline def setOnValueChange(value: Boolean => Callback): Self = StObject.set(x, "onValueChange", js.Any.fromFunction1((t0: Boolean) => value(t0).runNow()))
