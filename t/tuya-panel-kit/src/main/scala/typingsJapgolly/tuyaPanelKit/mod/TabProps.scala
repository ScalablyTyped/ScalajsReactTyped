...
object TabProps {
  ...
  extension [Self <: TabProps](x: Self) {
    ...
    inline def setOnChange(value: /* activeKey */ js.UndefOr[Double | String] => Callback): Self = StObject.set(x, "onChange", js.Any.fromFunction1((t0: /* activeKey */ js.UndefOr[Double | String]) => value(t0).runNow()))
