...
object ActiveStyle {
  ...
  extension [Self <: ActiveStyle](x: Self) {
    ...
    inline def setOnItemPress(value: Callback): Self = StObject.set(x, "onItemPress", value.toJsFn)
    
    inline def setOnItemPressUndefined: Self = StObject.set(x, "onItemPress", js.undefined)
    
    inline def setOnPress(value: /* index */ String => Callback): Self = StObject.set(x, "onPress", js.Any.fromFunction1((t0: /* index */ String) => value(t0).runNow()))
