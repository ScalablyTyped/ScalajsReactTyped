...
import typingsJapgolly.tuyaPanelKit.mod.MobileInfo
...
object Dictkey {
  ...
  inline def apply(
    ...
    gotoDpAlarm: Category => Callback,
    hideLoading: AnyFunction,
    is24Hour: CallbackTo[js.Promise[Boolean]],
    jumpTo: String => Any,
    lang: I18NLanMap,
  ...
  extension [Self <: Dictkey](x: Self) {
    ...
    inline def setGotoDpAlarm(value: Category => Callback): Self = StObject.set(x, "gotoDpAlarm", js.Any.fromFunction1((t0: Category) => value(t0).runNow()))
    
    inline def setHideLoading(value: AnyFunction): Self = StObject.set(x, "hideLoading", value.asInstanceOf[js.Any])
    
    inline def setIs24Hour(value: CallbackTo[js.Promise[Boolean]]): Self = StObject.set(x, "is24Hour", value.toJsFn)
