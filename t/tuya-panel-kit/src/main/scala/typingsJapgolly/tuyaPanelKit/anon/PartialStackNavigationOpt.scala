...
import typingsJapgolly.tuyaPanelKit.`@reactNavigationStackTypesMod`.GestureDirection
...
import typingsJapgolly.tuyaPanelKit.`@reactNavigationStackTypesMod`.StackCardStyleInterpolator
...
import typingsJapgolly.tuyaPanelKit.`@reactNavigationStackTypesMod`.StackHeaderLeftButtonProps
import typingsJapgolly.tuyaPanelKit.`@reactNavigationStackTypesMod`.StackHeaderProps
import typingsJapgolly.tuyaPanelKit.`@reactNavigationStackTypesMod`.StackHeaderStyleInterpolator
import typingsJapgolly.tuyaPanelKit.`@reactNavigationStackTypesMod`.StackHeaderTitleProps
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.pop_
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.push_
...
trait PartialStackNavigationOpt extends StObject {
  ...
  var headerRight: js.UndefOr[js.Function1[/* props */ `9`, Node]] = js.undefined
...
object PartialStackNavigationOpt {
  ...
  extension [Self <: PartialStackNavigationOpt](x: Self) {
    ...
    inline def setHeaderRight(value: /* props */ `9` => Node): Self = StObject.set(x, "headerRight", js.Any.fromFunction1(value))
