...
object BackIconColor {
  ...
  inline def apply(): BackIconColor = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[BackIconColor]
  }
  
  extension [Self <: BackIconColor](x: Self) {
    ...
    inline def setList(value: CellFontColor): Self = StObject.set(x, "list", value.asInstanceOf[js.Any])
    
    inline def setListUndefined: Self = StObject.set(x, "list", js.undefined)
    
    inline def setNumberSelector(value: CellPlusColor): Self = StObject.set(x, "numberSelector", value.asInstanceOf[js.Any])
