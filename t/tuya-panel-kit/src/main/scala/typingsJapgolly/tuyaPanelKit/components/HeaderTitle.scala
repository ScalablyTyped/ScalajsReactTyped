...
import typingsJapgolly.tuyaPanelKit.`@reactNavigationStackViewsHeaderHeaderTitleMod`.Props
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.`no-hide-descendants`
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.all
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.clip
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.email
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.full
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.head
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.middle
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.phoneNumber
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.tail
...
object HeaderTitle {
  ...
  inline def apply(children: js.UndefOr[Node] & js.UndefOr[String]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    ...
    inline def android_hyphenationFrequency(value: normal | none_ | full): this.type = set("android_hyphenationFrequency", value.asInstanceOf[js.Any])
    
    inline def dataDetectorType(value: phoneNumber | link | email | none_ | all): this.type = set("dataDetectorType", value.asInstanceOf[js.Any])
    ...
    inline def style(value: WithAnimatedValue[StyleProp[TextStyle]]): this.type = set("style", value.asInstanceOf[js.Any])
