...
import typingsJapgolly.tuyaPanelKit.anon.CurrentIndex
import typingsJapgolly.tuyaPanelKit.mod.CarouselProps
...
object Carousel {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.tuyaPanelKit.mod.Carousel] {
    ...
    inline def carouselChange(value: /* index */ Double => Callback): this.type = set("carouselChange", js.Any.fromFunction1((t0: /* index */ Double) => value(t0).runNow()))
    ...
    inline def dotWrapperStyle(value: StyleProp[ViewStyle]): this.type = set("dotWrapperStyle", value.asInstanceOf[js.Any])
    
    inline def dotWrapperStyleNull: this.type = set("dotWrapperStyle", null)
    
    inline def dots(value: ElementType | (js.Function1[/* params */ CurrentIndex, Node])): this.type = set("dots", value.asInstanceOf[js.Any])
    
    inline def dotsFunction1(value: /* params */ CurrentIndex => Node): this.type = set("dots", js.Any.fromFunction1(value))
    
    inline def focusable(value: Boolean): this.type = set("focusable", value.asInstanceOf[js.Any])
    
    inline def hasDots(value: Boolean): this.type = set("hasDots", value.asInstanceOf[js.Any])
    ...
    inline def onMomentumScrollEnd(value: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ Any) => Callback): this.type = set("onMomentumScrollEnd", js.Any.fromFunction2((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ Any) => (value(t0, t1)).runNow()))
    ...
    inline def onPageScroll(value: ReactEventFrom[NodeHandle & Element] => Callback): this.type = set("onPageScroll", js.Any.fromFunction1((t0: ReactEventFrom[NodeHandle & Element]) => value(t0).runNow()))
    
    inline def onPageScrollStateChanged(value: /* state */ Idle | Dragging | Settling => Callback): this.type = set("onPageScrollStateChanged", js.Any.fromFunction1((t0: /* state */ Idle | Dragging | Settling) => value(t0).runNow()))
    
    inline def onPageSelected(value: ReactEventFrom[NodeHandle & Element] => Callback): this.type = set("onPageSelected", js.Any.fromFunction1((t0: ReactEventFrom[NodeHandle & Element]) => value(t0).runNow()))
    ...
    inline def onScrollBeginDrag(value: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ Any) => Callback): this.type = set("onScrollBeginDrag", js.Any.fromFunction2((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ Any) => (value(t0, t1)).runNow()))
    
    inline def onScrollEndDrag(value: (/* event */ NativeSyntheticEvent[NativeScrollEvent], /* state */ Any) => Callback): this.type = set("onScrollEndDrag", js.Any.fromFunction2((t0: /* event */ NativeSyntheticEvent[NativeScrollEvent], t1: /* state */ Any) => (value(t0, t1)).runNow()))
    ...
    inline def pageStyle(value: StyleProp[ViewStyle]): this.type = set("pageStyle", value.asInstanceOf[js.Any])
    
    inline def pageStyleNull: this.type = set("pageStyle", null)
