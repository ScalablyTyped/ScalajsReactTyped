...
import typingsJapgolly.tuyaPanelKit.mod.CircleViewProps
...
object CircleView {
  ...
  inline def apply(radius: Double): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.tuyaPanelKit.mod.CircleView] {
