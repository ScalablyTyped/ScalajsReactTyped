...
import typingsJapgolly.tuyaPanelKit.mod.SectionDataProps
import typingsJapgolly.tuyaPanelKit.mod.TYSectionListProps
...
object TYSectionList {
  ...
  inline def apply(sections: js.Array[SectionListData[SectionDataProps, DefaultSectionT]]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.tuyaPanelKit.mod.TYSectionList] {
    ...
    inline def getItem(value: (/* data */ Any, /* index */ Double) => SectionDataProps): this.type = set("getItem", js.Any.fromFunction2(value))
    ...
    inline def getItemLayout(
      value: (/* data */ (js.Array[SectionListData[SectionDataProps, DefaultSectionT]]) | Null, /* index */ Double) => Length
    ...
    inline def keyExtractor(value: (SectionDataProps, /* index */ Double) => String): this.type = set("keyExtractor", js.Any.fromFunction2(value))
    ...
    inline def renderItem(value: /* info */ SectionListRenderItemInfo[SectionDataProps, DefaultSectionT] => Element | Null): this.type = set("renderItem", js.Any.fromFunction1(value))
    ...
    inline def renderSectionFooter(value: /* info */ Section[SectionDataProps, DefaultSectionT] => Element | Null): this.type = set("renderSectionFooter", js.Any.fromFunction1(value))
    
    inline def renderSectionHeader(value: /* info */ Section[SectionDataProps, DefaultSectionT] => Element | Null): this.type = set("renderSectionHeader", js.Any.fromFunction1(value))
    ...
    inline def sectionListRef(value: Callback): this.type = set("sectionListRef", value.toJsFn)
