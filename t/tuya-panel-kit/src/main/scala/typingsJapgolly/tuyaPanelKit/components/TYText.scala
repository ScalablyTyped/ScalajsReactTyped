...
import typingsJapgolly.tuyaPanelKit.mod.TYTextProps
...
object TYText {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.tuyaPanelKit.mod.TYText] {
    ...
    inline def size(value: large | normal | small | Double): this.type = set("size", value.asInstanceOf[js.Any])
    ...
    inline def `type`(value: heading | title | paragraph): this.type = set("type", value.asInstanceOf[js.Any])
    
    inline def weight(value: Double | String): this.type = set("weight", value.asInstanceOf[js.Any])
  }
