...
import typingsJapgolly.tuyaPanelKit.mod.TYListItemProps
...
object TYListItem {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.tuyaPanelKit.mod.TYListItem] {
    
    inline def Action(value: Any): this.type = set("Action", value.asInstanceOf[js.Any])
    ...
    inline def actionDisabled(value: Boolean): this.type = set("actionDisabled", value.asInstanceOf[js.Any])
    
    inline def actionType(value: auto | image | iconfont | text): this.type = set("actionType", value.asInstanceOf[js.Any])
    ...
    inline def arrowUseIcon(value: Boolean): this.type = set("arrowUseIcon", value.asInstanceOf[js.Any])
    ...
    inline def iconType(value: auto | image | iconfont | text): this.type = set("iconType", value.asInstanceOf[js.Any])
    
    inline def imageFollowIconColor(value: Boolean): this.type = set("imageFollowIconColor", value.asInstanceOf[js.Any])
    
    inline def importantForAccessibility(value: typingsJapgolly.reactNative.reactNativeStrings.auto | yes | no | `no-hide-descendants`): this.type = set("importantForAccessibility", value.asInstanceOf[js.Any])
    
    inline def needUpdate(value: Boolean): this.type = set("needUpdate", value.asInstanceOf[js.Any])
    ...
    inline def theme(value: CellBg): this.type = set("theme", value.asInstanceOf[js.Any])
