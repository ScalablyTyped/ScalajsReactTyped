...
import typingsJapgolly.tuyaPanelKit.mod.ModalProps
...
object Modal {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.tuyaPanelKit.mod.Modal] {
    ...
    inline def onMaskPress(value: Callback): this.type = set("onMaskPress", value.toJsFn)
