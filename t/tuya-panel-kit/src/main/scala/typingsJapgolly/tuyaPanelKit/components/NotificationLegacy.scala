...
import typingsJapgolly.tuyaPanelKit.mod.NotificationLegacyProps
...
object NotificationLegacy {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.tuyaPanelKit.mod.NotificationLegacy] {
    ...
    inline def enableClose(value: String): this.type = set("enableClose", value.asInstanceOf[js.Any])
