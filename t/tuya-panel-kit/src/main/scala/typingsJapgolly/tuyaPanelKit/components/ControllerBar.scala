...
import typingsJapgolly.tuyaPanelKit.mod.ControllerBarProps
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.alpha
...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.pure
...
object ControllerBar {
  ...
  inline def apply(button: js.Array[ButtonProps]): Builder = {
  ...
  open class Builder (val args: js.Array[Any])
    extends AnyVal
       with StBuildingComponent[typingsJapgolly.tuyaPanelKit.mod.ControllerBar] {
    ...
    inline def backgroundType(value: alpha | pure): this.type = set("backgroundType", value.asInstanceOf[js.Any])
    ...
    inline def hasBottomBorder(value: Boolean): this.type = set("hasBottomBorder", value.asInstanceOf[js.Any])
