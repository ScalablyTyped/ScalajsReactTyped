...
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.JUMP_TO
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.none_
import typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.tab
...
object `@reactNavigationRoutersTabRouterMod` {
  ...
  /* Rewritten from type alias, can be one of: 
    - typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.initialRoute
    - typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.order
    - typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.history
    - typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.none_
  */
  trait BackBehavior extends StObject
  object BackBehavior {
    
    inline def history: typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.history = "history".asInstanceOf[typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.history]
    
    inline def initialRoute: typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.initialRoute = "initialRoute".asInstanceOf[typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.initialRoute]
    
    inline def none: none_ = "none".asInstanceOf[none_]
    
    inline def order: typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.order = "order".asInstanceOf[typingsJapgolly.tuyaPanelKit.tuyaPanelKitStrings.order]
  }
  ...
  object TabActionHelpers {
    ...
    inline def apply[ParamList /* <: ParamListBase */](
      ...
      val __obj = js.Dynamic.literal(jumpTo = js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends ParamList[RouteName] ? [RouteName] | [RouteName, ParamList[RouteName]] : [RouteName, ParamList[RouteName]] */ js.Any) => jumpTo(t0).runNow()))
    ...
    extension [Self <: TabActionHelpers[?], ParamList /* <: ParamListBase */](x: Self & TabActionHelpers[ParamList]) {
      ...
      inline def setJumpTo(
        value: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends ParamList[RouteName] ? [RouteName] | [RouteName, ParamList[RouteName]] : [RouteName, ParamList[RouteName]] */ js.Any => Callback
      ): Self = StObject.set(x, "jumpTo", js.Any.fromFunction1((t0: /* import warning: importer.ImportType#apply Failed type conversion: undefined extends ParamList[RouteName] ? [RouteName] | [RouteName, ParamList[RouteName]] : [RouteName, ParamList[RouteName]] */ js.Any) => value(t0).runNow()))
    }
  }
