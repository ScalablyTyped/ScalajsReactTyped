...
import typingsJapgolly.tuyaPanelKit.`@reactNavigationRoutersTabRouterMod`.BackBehavior
...
import typingsJapgolly.tuyaPanelKit.mod.MobileService
import typingsJapgolly.tuyaPanelKit.mod.NetworkType
