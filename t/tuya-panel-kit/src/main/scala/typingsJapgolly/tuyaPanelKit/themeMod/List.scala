...
object List {
  ...
  inline def apply(dark: ListTheme, light: ListTheme): typingsJapgolly.tuyaPanelKit.themeMod.List = {
    val __obj = js.Dynamic.literal(dark = dark.asInstanceOf[js.Any], light = light.asInstanceOf[js.Any])
    __obj.asInstanceOf[typingsJapgolly.tuyaPanelKit.themeMod.List]
  }
  
  extension [Self <: typingsJapgolly.tuyaPanelKit.themeMod.List](x: Self) {
