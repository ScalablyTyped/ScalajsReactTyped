...
trait GlobalTheme extends StObject {
  ...
  var list: typingsJapgolly.tuyaPanelKit.themeMod.List
...
object GlobalTheme {
  ...
  inline def apply(
    ...
    dialog: Dialog,
    global: Global,
    list: typingsJapgolly.tuyaPanelKit.themeMod.List,
    picker: Picker,
    popup: Popup,
    slider: Slider,
  ...
  extension [Self <: GlobalTheme](x: Self) {
    ...
    inline def setList(value: typingsJapgolly.tuyaPanelKit.themeMod.List): Self = StObject.set(x, "list", value.asInstanceOf[js.Any])
