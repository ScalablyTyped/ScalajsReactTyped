...
object BuilderProgramHost {
  ...
  def apply(
    ...
    createHash: /* data */ String => CallbackTo[String] = null,
    writeFile: (/* fileName */ String, /* data */ String, /* writeByteOrderMark */ Boolean, /* onError */ js.UndefOr[js.Function1[/* message */ String, Unit]], /* sourceFiles */ js.UndefOr[js.Array[SourceFile]]) => Callback = null
  ): BuilderProgramHost = {
    ...
    if (writeFile != null) __obj.updateDynamic("writeFile")(js.Any.fromFunction5((t0: /* fileName */ java.lang.String, t1: /* data */ java.lang.String, t2: /* writeByteOrderMark */ scala.Boolean, t3: /* onError */ js.UndefOr[js.Function1[/* message */ java.lang.String, scala.Unit]], t4: /* sourceFiles */ js.UndefOr[js.Array[typingsJapgolly.typescript.typescriptMod.SourceFile]]) => writeFile(t0, t1, t2, t3, t4).runNow()))
