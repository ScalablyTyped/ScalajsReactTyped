...
import typingsJapgolly.typescript.typescriptMod.TypePredicateKind.AssertsIdentifier
import typingsJapgolly.typescript.typescriptMod.TypePredicateKind.AssertsThis
import typingsJapgolly.typescript.typescriptMod.TypePredicateKind.This
...
object TypePredicate {
  ...
  def IdentifierTypePredicate(
    kind: typingsJapgolly.typescript.typescriptMod.TypePredicateKind.Identifier,
