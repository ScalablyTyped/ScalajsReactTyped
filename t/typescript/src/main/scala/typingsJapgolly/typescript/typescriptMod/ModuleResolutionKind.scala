...
object ModuleResolutionKind extends js.Object {
  ...
  /* 1 */ val Classic: typingsJapgolly.typescript.typescriptMod.ModuleResolutionKind.Classic with Double = js.native
  /* 2 */ val NodeJs: typingsJapgolly.typescript.typescriptMod.ModuleResolutionKind.NodeJs with Double = js.native
  @JSBracketAccess
