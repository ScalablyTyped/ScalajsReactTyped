...
object TransformationContext {
  ...
  def apply(
    ...
    __obj.updateDynamic("enableEmitNotification")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.typescriptMod.SyntaxKind) => enableEmitNotification(t0).runNow()))
    __obj.updateDynamic("enableSubstitution")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.typescriptMod.SyntaxKind) => enableSubstitution(t0).runNow()))
    ...
    __obj.updateDynamic("hoistFunctionDeclaration")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.typescriptMod.FunctionDeclaration) => hoistFunctionDeclaration(t0).runNow()))
    __obj.updateDynamic("hoistVariableDeclaration")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.typescriptMod.Identifier) => hoistVariableDeclaration(t0).runNow()))
    __obj.updateDynamic("isEmitNotificationEnabled")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.typescriptMod.Node) => isEmitNotificationEnabled(t0).runNow()))
    __obj.updateDynamic("isSubstitutionEnabled")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.typescriptMod.Node) => isSubstitutionEnabled(t0).runNow()))
    __obj.updateDynamic("onEmitNode")(js.Any.fromFunction3((t0: typingsJapgolly.typescript.typescriptMod.EmitHint, t1: typingsJapgolly.typescript.typescriptMod.Node, t2: js.Function2[
  ...
  scala.Unit]) => onEmitNode(t0, t1, t2).runNow()))
    __obj.updateDynamic("onSubstituteNode")(js.Any.fromFunction2((t0: typingsJapgolly.typescript.typescriptMod.EmitHint, t1: typingsJapgolly.typescript.typescriptMod.Node) => onSubstituteNode(t0, t1).runNow()))
    __obj.updateDynamic("readEmitHelpers")(readEmitHelpers.toJsFn)
    __obj.updateDynamic("requestEmitHelper")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.typescriptMod.EmitHelper) => requestEmitHelper(t0).runNow()))
