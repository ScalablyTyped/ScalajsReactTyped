...
object SubstitutionType {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any], substitute = substitute.asInstanceOf[js.Any], symbol = symbol.asInstanceOf[js.Any], typeVariable = typeVariable.asInstanceOf[js.Any])
