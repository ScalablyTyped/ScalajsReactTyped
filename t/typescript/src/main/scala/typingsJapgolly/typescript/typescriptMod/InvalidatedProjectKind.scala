...
object InvalidatedProjectKind extends js.Object {
  ...
  /* 0 */ val Build: typingsJapgolly.typescript.typescriptMod.InvalidatedProjectKind.Build with Double = js.native
  /* 1 */ val UpdateBundle: typingsJapgolly.typescript.typescriptMod.InvalidatedProjectKind.UpdateBundle with Double = js.native
  /* 2 */ val UpdateOutputFileStamps: typingsJapgolly.typescript.typescriptMod.InvalidatedProjectKind.UpdateOutputFileStamps with Double = js.native
  @JSBracketAccess
