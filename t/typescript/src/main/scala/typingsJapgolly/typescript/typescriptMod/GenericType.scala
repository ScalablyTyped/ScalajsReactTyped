...
object GenericType {
  ...
  def apply(
    ...
    val __obj = js.Dynamic.literal(flags = flags.asInstanceOf[js.Any], objectFlags = objectFlags.asInstanceOf[js.Any], symbol = symbol.asInstanceOf[js.Any], target = target.asInstanceOf[js.Any])
