...
object LanguageVariant extends js.Object {
  ...
  /* 1 */ val JSX: typingsJapgolly.typescript.typescriptMod.LanguageVariant.JSX with Double = js.native
  /* 0 */ val Standard: typingsJapgolly.typescript.typescriptMod.LanguageVariant.Standard with Double = js.native
  @JSBracketAccess
