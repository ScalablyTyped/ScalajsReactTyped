...
trait ClassLikeDeclarationBase
  ...
  @JSName("kind")
  var kind_ClassLikeDeclarationBase: typingsJapgolly.typescript.typescriptMod.SyntaxKind.ClassDeclaration | typingsJapgolly.typescript.typescriptMod.SyntaxKind.ClassExpression = js.native
