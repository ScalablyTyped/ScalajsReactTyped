...
object NewLineKind extends js.Object {
  ...
  /* 0 */ val CarriageReturnLineFeed: typingsJapgolly.typescript.typescriptMod.NewLineKind.CarriageReturnLineFeed with Double = js.native
  /* 1 */ val LineFeed: typingsJapgolly.typescript.typescriptMod.NewLineKind.LineFeed with Double = js.native
  @JSBracketAccess
