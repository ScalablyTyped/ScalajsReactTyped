...
object FileWatcherEventKind extends js.Object {
  ...
  /* 1 */ val Changed: typingsJapgolly.typescript.typescriptMod.FileWatcherEventKind.Changed with Double = js.native
  /* 0 */ val Created: typingsJapgolly.typescript.typescriptMod.FileWatcherEventKind.Created with Double = js.native
  /* 2 */ val Deleted: typingsJapgolly.typescript.typescriptMod.FileWatcherEventKind.Deleted with Double = js.native
  @JSBracketAccess
