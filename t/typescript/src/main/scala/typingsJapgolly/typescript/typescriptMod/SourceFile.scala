...
trait SourceFile
  ...
  var endOfFileToken: Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.EndOfFileToken] = js.native
  ...
  @JSName("kind")
  var kind_SourceFile: typingsJapgolly.typescript.typescriptMod.SyntaxKind.SourceFile = js.native
