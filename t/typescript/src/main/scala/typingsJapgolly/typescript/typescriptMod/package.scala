...
package object typescriptMod {
  ...
  import typingsJapgolly.typescript.Anon_Affected
  import typingsJapgolly.typescript.Anon_BucketKey
  import typingsJapgolly.typescript.Anon_EscapedIdentifier
  import typingsJapgolly.typescript.Anon_Metadata
  import typingsJapgolly.typescript.Anon_Name
  import typingsJapgolly.typescript.Anon_PathBrand
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.AbstractKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.AssertsKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.AsteriskAsteriskToken
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.AsyncKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.AwaitKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.ConstKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.DeclareKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.DefaultKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.ExportKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.PrivateKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.ProtectedKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.PublicKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.ReadonlyKeyword
  import typingsJapgolly.typescript.typescriptMod.SyntaxKind.StaticKeyword
  ...
  */
  ...
  type AsteriskToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.AsteriskToken]
  ...
  */
  ...
  type ColonToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.ColonToken]
  ...
  type DotDotDotToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.DotDotDotToken]
  type DotToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.DotToken]
  type EmitHelperUniqueNameCallback = js.Function1[/* name */ String, String]
  type EndOfFileToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.EndOfFileToken] with JSDocContainer
  type EnumType = Type
  type EqualityOperatorOrHigher = RelationalOperatorOrHigher | EqualityOperator
  type EqualsGreaterThanToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.EqualsGreaterThanToken]
  type EqualsToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.EqualsToken]
  type ErrorCallback = js.Function2[/* message */ DiagnosticMessage, /* length */ Double, Unit]
  type ExclamationToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.ExclamationToken]
  ...
  */
  ...
  type MinusToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.MinusToken]
  type Modifier = Token[
  ...
  type PlusToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.PlusToken]
  type QuestionDotToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.QuestionDotToken]
  type QuestionToken = Token[typingsJapgolly.typescript.typescriptMod.SyntaxKind.QuestionToken]
