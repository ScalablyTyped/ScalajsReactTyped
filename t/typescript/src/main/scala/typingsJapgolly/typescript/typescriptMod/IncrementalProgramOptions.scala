...
object IncrementalProgramOptions {
  ...
  def apply[T /* <: BuilderProgram */](
    ...
    createProgram: (/* rootNames */ js.UndefOr[js.Array[String]], /* options */ js.UndefOr[CompilerOptions], /* host */ js.UndefOr[CompilerHost], /* oldProgram */ js.UndefOr[T], /* configFileParsingDiagnostics */ js.UndefOr[js.Array[Diagnostic]], /* projectReferences */ js.UndefOr[js.Array[ProjectReference]]) => CallbackTo[T] = null,
    ...
    if (createProgram != null) __obj.updateDynamic("createProgram")(js.Any.fromFunction6((t0: /* rootNames */ js.UndefOr[js.Array[java.lang.String]], t1: /* options */ js.UndefOr[typingsJapgolly.typescript.typescriptMod.CompilerOptions], t2: /* host */ js.UndefOr[typingsJapgolly.typescript.typescriptMod.CompilerHost], t3: /* oldProgram */ js.UndefOr[T], t4: /* configFileParsingDiagnostics */ js.UndefOr[js.Array[typingsJapgolly.typescript.typescriptMod.Diagnostic]], t5: /* projectReferences */ js.UndefOr[js.Array[typingsJapgolly.typescript.typescriptMod.ProjectReference]]) => createProgram(t0, t1, t2, t3, t4, t5).runNow()))
