...
object WatchDirectoryFlags extends js.Object {
  ...
  /* 0 */ val None: typingsJapgolly.typescript.typescriptMod.WatchDirectoryFlags.None with Double = js.native
  /* 1 */ val Recursive: typingsJapgolly.typescript.typescriptMod.WatchDirectoryFlags.Recursive with Double = js.native
  @JSBracketAccess
