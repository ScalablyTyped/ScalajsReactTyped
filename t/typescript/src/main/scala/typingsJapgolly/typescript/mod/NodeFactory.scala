...
import typingsJapgolly.typescript.mod.SyntaxKind.Unknown
...
trait NodeFactory extends StObject {
  ...
  @JSName("createToken")
  def createToken_TKind_Token[TKind /* <: Unknown | typingsJapgolly.typescript.mod.SyntaxKind.EndOfFileToken */](token: TKind): Token[TKind] = js.native
