...
object CreateSourceFileOptions {
  ...
  extension [Self <: CreateSourceFileOptions](x: Self) {
    ...
    inline def setSetExternalModuleIndicator(value: /* file */ SourceFile => Callback): Self = StObject.set(x, "setExternalModuleIndicator", js.Any.fromFunction1((t0: /* file */ SourceFile) => value(t0).runNow()))
