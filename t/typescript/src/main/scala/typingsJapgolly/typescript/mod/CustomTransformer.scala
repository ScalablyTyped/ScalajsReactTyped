...
object CustomTransformer {
  ...
  def apply(
    ...
    __obj.updateDynamic("transformBundle")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.mod.Bundle) => transformBundle(t0).runNow()))
    __obj.updateDynamic("transformSourceFile")(js.Any.fromFunction1((t0: typingsJapgolly.typescript.mod.SourceFile) => transformSourceFile(t0).runNow()))
