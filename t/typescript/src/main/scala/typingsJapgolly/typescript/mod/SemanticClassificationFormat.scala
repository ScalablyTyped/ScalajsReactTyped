...
object SemanticClassificationFormat extends StObject {
  ...
  /* "original" */ val Original: typingsJapgolly.typescript.mod.SemanticClassificationFormat.Original & java.lang.String = js.native
  
  @js.native
  sealed trait TwentyTwenty
    extends StObject
       with SemanticClassificationFormat
  /* "2020" */ val TwentyTwenty: typingsJapgolly.typescript.mod.SemanticClassificationFormat.TwentyTwenty & java.lang.String = js.native
}
