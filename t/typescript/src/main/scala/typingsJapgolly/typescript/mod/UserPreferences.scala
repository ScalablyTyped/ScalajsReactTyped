...
import typingsJapgolly.typescript.typescriptStrings.`project-relative`
import typingsJapgolly.typescript.typescriptStrings.all
import typingsJapgolly.typescript.typescriptStrings.auto
import typingsJapgolly.typescript.typescriptStrings.braces
...
import typingsJapgolly.typescript.typescriptStrings.literals
import typingsJapgolly.typescript.typescriptStrings.minimal
import typingsJapgolly.typescript.typescriptStrings.none
import typingsJapgolly.typescript.typescriptStrings.off
import typingsJapgolly.typescript.typescriptStrings.on
import typingsJapgolly.typescript.typescriptStrings.relative
import typingsJapgolly.typescript.typescriptStrings.shortest
