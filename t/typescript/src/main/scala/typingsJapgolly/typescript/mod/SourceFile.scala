...
trait SourceFile
  ...
  val endOfFileToken: Token[typingsJapgolly.typescript.mod.SyntaxKind.EndOfFileToken] = js.native
  ...
  @JSName("kind")
  val kind_SourceFile: typingsJapgolly.typescript.mod.SyntaxKind.SourceFile = js.native
