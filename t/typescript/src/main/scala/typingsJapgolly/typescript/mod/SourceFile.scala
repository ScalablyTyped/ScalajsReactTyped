...
trait SourceFile
  ...
  var endOfFileToken: Token[typingsJapgolly.typescript.mod.SyntaxKind.EndOfFileToken] = js.native
  ...
  @JSName("kind")
  var kind_SourceFile: typingsJapgolly.typescript.mod.SyntaxKind.SourceFile = js.native
