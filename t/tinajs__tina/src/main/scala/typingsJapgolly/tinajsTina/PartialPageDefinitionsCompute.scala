...
object PartialPageDefinitionsCompute {
  ...
  def apply(
    ...
    onPageScroll: PartialPageDefinitionsCompute => Callback = null,
    onPullDownRefresh: PartialPageDefinitionsCompute => Callback = null,
    onReachBottom: PartialPageDefinitionsCompute => Callback = null,
    onReady: js.ThisFunction0[PartialPageDefinitionsCompute, Unit] = null,
    onShareAppMessage: PartialPageDefinitionsCompute => Callback = null,
    ...
    if (onPageScroll != null) __obj.updateDynamic("onPageScroll")(js.Any.fromFunction1((t0: typingsJapgolly.tinajsTina.PartialPageDefinitionsCompute) => onPageScroll(t0).runNow()))
    if (onPullDownRefresh != null) __obj.updateDynamic("onPullDownRefresh")(js.Any.fromFunction1((t0: typingsJapgolly.tinajsTina.PartialPageDefinitionsCompute) => onPullDownRefresh(t0).runNow()))
    if (onReachBottom != null) __obj.updateDynamic("onReachBottom")(js.Any.fromFunction1((t0: typingsJapgolly.tinajsTina.PartialPageDefinitionsCompute) => onReachBottom(t0).runNow()))
    if (onReady != null) __obj.updateDynamic("onReady")(onReady.asInstanceOf[js.Any])
    if (onShareAppMessage != null) __obj.updateDynamic("onShareAppMessage")(js.Any.fromFunction1((t0: typingsJapgolly.tinajsTina.PartialPageDefinitionsCompute) => onShareAppMessage(t0).runNow()))
