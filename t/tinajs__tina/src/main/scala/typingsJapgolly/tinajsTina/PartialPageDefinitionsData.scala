...
trait PartialPageDefinitionsData extends js.Object {
  ...
  var mixins: js.UndefOr[js.Array[PartialPageDefinitionsCreated]] = js.undefined
...
object PartialPageDefinitionsData {
  @scala.inline
  def apply(
    attached: js.UndefOr[Callback] = js.undefined,
    beforeLoad: js.ThisFunction0[PartialPageDefinitionsData, Unit] = null,
    ...
    mixins: js.Array[PartialPageDefinitionsCreated] = null,
    moved: js.UndefOr[Callback] = js.undefined,
    onHide: js.ThisFunction0[PartialPageDefinitionsData, Unit] = null,
    onLoad: js.ThisFunction1[PartialPageDefinitionsData, /* options */ js.UndefOr[js.Any], Unit] = null,
    onPageScroll: PartialPageDefinitionsData => Callback = null,
    onPullDownRefresh: PartialPageDefinitionsData => Callback = null,
    onReachBottom: PartialPageDefinitionsData => Callback = null,
    onReady: js.ThisFunction0[PartialPageDefinitionsData, Unit] = null,
    onShareAppMessage: PartialPageDefinitionsData => Callback = null,
    onShow: js.ThisFunction0[PartialPageDefinitionsData, Unit] = null,
    onUnload: js.ThisFunction0[PartialPageDefinitionsData, Unit] = null,
    properties: ComponentProperties = null,
    ready: js.UndefOr[Callback] = js.undefined
  ): PartialPageDefinitionsData = {
    ...
    if (onPageScroll != null) __obj.updateDynamic("onPageScroll")(js.Any.fromFunction1((t0: typingsJapgolly.tinajsTina.PartialPageDefinitionsData) => onPageScroll(t0).runNow()))
    if (onPullDownRefresh != null) __obj.updateDynamic("onPullDownRefresh")(js.Any.fromFunction1((t0: typingsJapgolly.tinajsTina.PartialPageDefinitionsData) => onPullDownRefresh(t0).runNow()))
    if (onReachBottom != null) __obj.updateDynamic("onReachBottom")(js.Any.fromFunction1((t0: typingsJapgolly.tinajsTina.PartialPageDefinitionsData) => onReachBottom(t0).runNow()))
    if (onReady != null) __obj.updateDynamic("onReady")(onReady.asInstanceOf[js.Any])
    if (onShareAppMessage != null) __obj.updateDynamic("onShareAppMessage")(js.Any.fromFunction1((t0: typingsJapgolly.tinajsTina.PartialPageDefinitionsData) => onShareAppMessage(t0).runNow()))
    ...
    __obj.asInstanceOf[PartialPageDefinitionsData]
  }
}
