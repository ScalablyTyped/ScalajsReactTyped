package typingsJapgolly.testcafeSafeStorage

import typingsJapgolly.testcafeSafeStorage.libErrorsMod.CODES
import typingsJapgolly.testcafeSafeStorage.libErrorsMod.RAU
...
object mod {
  ...
  open class default[T] () extends SafeStorage[T] {
    ...
    def this(validator: Unit, cryptoContext: typingsJapgolly.testcafeSafeStorage.libCryptoMod.default) = this()
    def this(validator: Validator[T], cryptoContext: typingsJapgolly.testcafeSafeStorage.libCryptoMod.default) = this()
  }
  ...
  object errors {
    ...
    object CODES extends StObject {
      ...
      @JSBracketAccess
      def apply(value: Double): js.UndefOr[typingsJapgolly.testcafeSafeStorage.libErrorsMod.CODES & Double] = js.native
      
      /* 1 */ val E001: typingsJapgolly.testcafeSafeStorage.libErrorsMod.CODES.E001 & Double = js.native
      
      /* 2 */ val E002: typingsJapgolly.testcafeSafeStorage.libErrorsMod.CODES.E002 & Double = js.native
      
      /* 3 */ val E003: typingsJapgolly.testcafeSafeStorage.libErrorsMod.CODES.E003 & Double = js.native
    }
    
    @JSImport("testcafe-safe-storage", "errors.LoadedDataInvalid")
    @js.native
    open class LoadedDataInvalid[T /* <: RAU */] ()
      extends typingsJapgolly.testcafeSafeStorage.libErrorsMod.LoadedDataInvalid[T]
    
    @JSImport("testcafe-safe-storage", "errors.MultipleSavedDataDetected")
    @js.native
    open class MultipleSavedDataDetected[T /* <: RAU */] ()
      extends typingsJapgolly.testcafeSafeStorage.libErrorsMod.MultipleSavedDataDetected[T]
    
    @JSImport("testcafe-safe-storage", "errors.SavedDataNotDetected")
    @js.native
    open class SavedDataNotDetected[T /* <: RAU */] ()
      extends typingsJapgolly.testcafeSafeStorage.libErrorsMod.SavedDataNotDetected[T]
  }
