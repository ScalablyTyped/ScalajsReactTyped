...
object libCryptoMod {
  ...
  object CryptoContext {
    ...
    inline def apply(
      _createCipher: Any,
      _createDecipher: Any,
      _generateEncryptionKeys: CallbackTo[js.Promise[EncryptionContext]],
      _generateKeyPair: CallbackTo[js.Promise[KeyPair]],
      _generateNonce: CallbackTo[js.Promise[Buffer]],
      _generatePassphrase: Buffer => js.Promise[Buffer],
      _loadAuthTag: CallbackTo[js.Promise[Buffer]],
      _loadDecryptionKeys: CallbackTo[js.Promise[DecryptionContext]],
      _loadNonce: Any,
      ...
      val __obj = js.Dynamic.literal(_createCipher = _createCipher.asInstanceOf[js.Any], _createDecipher = _createDecipher.asInstanceOf[js.Any], _generateEncryptionKeys = _generateEncryptionKeys.toJsFn, _generateKeyPair = _generateKeyPair.toJsFn, _generateNonce = _generateNonce.toJsFn, _generatePassphrase = js.Any.fromFunction1(_generatePassphrase), _loadAuthTag = _loadAuthTag.toJsFn, _loadDecryptionKeys = _loadDecryptionKeys.toJsFn, _loadNonce = _loadNonce.asInstanceOf[js.Any], _loadPassphrase = js.Any.fromFunction1(_loadPassphrase), _loadPrivateKey = js.Any.fromFunction1(_loadPrivateKey), _saveAuthTag = js.Any.fromFunction1(_saveAuthTag), _saveNonce = _saveNonce.asInstanceOf[js.Any], _savePassphrase = js.Any.fromFunction2(_savePassphrase), _savePrivateKey = js.Any.fromFunction2(_savePrivateKey), decrypt = js.Any.fromFunction1(decrypt), encrypt = js.Any.fromFunction1(encrypt))
    ...
    extension [Self <: CryptoContext](x: Self) {
      ...
      inline def set_generateEncryptionKeys(value: CallbackTo[js.Promise[EncryptionContext]]): Self = StObject.set(x, "_generateEncryptionKeys", value.toJsFn)
      
      inline def set_generateKeyPair(value: CallbackTo[js.Promise[KeyPair]]): Self = StObject.set(x, "_generateKeyPair", value.toJsFn)
      
      inline def set_generateNonce(value: CallbackTo[js.Promise[Buffer]]): Self = StObject.set(x, "_generateNonce", value.toJsFn)
      ...
      inline def set_loadAuthTag(value: CallbackTo[js.Promise[Buffer]]): Self = StObject.set(x, "_loadAuthTag", value.toJsFn)
      
      inline def set_loadDecryptionKeys(value: CallbackTo[js.Promise[DecryptionContext]]): Self = StObject.set(x, "_loadDecryptionKeys", value.toJsFn)
