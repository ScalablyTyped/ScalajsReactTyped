...
import typingsJapgolly.testingLibraryJestDom.anon.Exact
import typingsJapgolly.testingLibraryJestDom.anon.NormalizeWhitespace
...
object matchersMod extends Shortcut {
  ...
  @JSImport("@testing-library/jest-dom/matchers", JSImport.Default)
  @js.native
  val default: TestingLibraryMatchers[Any, Unit] = js.native
  
  /* import warning: RemoveDifficultInheritance.summarizeChanges 
  - Dropped {[ P in string ]: any} */ @js.native
  trait TestingLibraryMatchers[E, R] extends StObject {
    ...
    /**
      ...
      */
    def toHaveAccessibleDescription(): R = js.native
    def toHaveAccessibleDescription(text: E): R = js.native
    def toHaveAccessibleDescription(text: String): R = js.native
    def toHaveAccessibleDescription(text: js.RegExp): R = js.native
    ...
    /**
      ...
      */
    def toHaveAccessibleName(): R = js.native
    def toHaveAccessibleName(text: E): R = js.native
    def toHaveAccessibleName(text: String): R = js.native
    def toHaveAccessibleName(text: js.RegExp): R = js.native
    ...
    def toHaveAttribute(attr: String, value: Any): R = js.native
    ...
    def toHaveDescription(text: E): R = js.native
    ...
    /**
      ...
      */
    def toHaveErrorMessage(): R = js.native
    def toHaveErrorMessage(text: E): R = js.native
    def toHaveErrorMessage(text: String): R = js.native
    def toHaveErrorMessage(text: js.RegExp): R = js.native
    ...
    /**
      ...
      */
    def toHaveFormValues(expectedValues: Record[String, Any]): R = js.native
    ...
    def toHaveStyle(css: Record[String, Any]): R = js.native
  ...
  type _To = TestingLibraryMatchers[Any, Unit]
  
  /* This means you don't have to write `default`, but can instead just say `matchersMod.foo` */
  override def _to: TestingLibraryMatchers[Any, Unit] = default
}
