...
import typingsJapgolly.tsJest.anon.TypeofScriptSnapshot
import typingsJapgolly.tsJest.tsJestBooleans.`false`
import typingsJapgolly.tsJest.tsJestStrings.dts
import typingsJapgolly.tsJest.tsJestStrings.js_
import typingsJapgolly.tsJest.tsJestStrings.quit
...
@js.native
trait TTypeScript extends StObject {
