...
@JSImport("typescript-services", "CaseSwitchClause")
@js.native
open class CaseSwitchClause protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.CaseSwitchClause {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.CaseSwitchClause, includingPosition: Boolean): Boolean = js.native
