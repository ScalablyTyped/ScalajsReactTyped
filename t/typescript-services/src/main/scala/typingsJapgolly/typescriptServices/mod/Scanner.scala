...
open class Scanner protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.Scanner {
  def this(
    fileName: String,
    text: ISimpleText,
...
object Scanner {
  ...
  /* static member */
  inline def isValidIdentifier(text: ISimpleText, languageVersion: typingsJapgolly.typescriptServices.TypeScript.LanguageVersion): Boolean = (^.asInstanceOf[js.Dynamic].applyDynamic("isValidIdentifier")(text.asInstanceOf[js.Any], languageVersion.asInstanceOf[js.Any])).asInstanceOf[Boolean]
