...
@js.native
open class FunctionDeclarationSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.FunctionDeclarationSyntax {
  def this(
...
object FunctionDeclarationSyntax {
  ...
  inline def create(
    ...
    identifier: ISyntaxToken,
    callSignature: typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax
  ): typingsJapgolly.typescriptServices.TypeScript.FunctionDeclarationSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(functionKeyword.asInstanceOf[js.Any], identifier.asInstanceOf[js.Any], callSignature.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.FunctionDeclarationSyntax]
  
  /* static member */
  inline def create1(identifier: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.FunctionDeclarationSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(identifier.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.FunctionDeclarationSyntax]
}
