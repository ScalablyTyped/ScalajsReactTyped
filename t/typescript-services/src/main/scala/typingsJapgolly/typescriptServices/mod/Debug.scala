...
@js.native
class Debug ()
  extends typingsJapgolly.typescriptServices.TypeScript.Debug
...
object Debug extends js.Object {
  ...
  def shouldAssert(level: typingsJapgolly.typescriptServices.TypeScript.AssertionLevel): Boolean = js.native
}
