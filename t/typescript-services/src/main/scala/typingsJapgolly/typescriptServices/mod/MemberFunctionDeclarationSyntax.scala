...
open class MemberFunctionDeclarationSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.MemberFunctionDeclarationSyntax {
  def this(
...
object MemberFunctionDeclarationSyntax {
  ...
  inline def create(
    propertyName: ISyntaxToken,
    callSignature: typingsJapgolly.typescriptServices.TypeScript.CallSignatureSyntax
  ): typingsJapgolly.typescriptServices.TypeScript.MemberFunctionDeclarationSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(propertyName.asInstanceOf[js.Any], callSignature.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.MemberFunctionDeclarationSyntax]
  
  /* static member */
  inline def create1(propertyName: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.MemberFunctionDeclarationSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(propertyName.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.MemberFunctionDeclarationSyntax]
}
