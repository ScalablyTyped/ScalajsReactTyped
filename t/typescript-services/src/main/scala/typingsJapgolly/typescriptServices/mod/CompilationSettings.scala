...
open class CompilationSettings ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.CompilationSettings {
  
  /* CompleteClass */
  var allowAutomaticSemicolonInsertion: Boolean = js.native
  
  /* CompleteClass */
  var codeGenTarget: typingsJapgolly.typescriptServices.TypeScript.LanguageVersion = js.native
  ...
  /* CompleteClass */
  var moduleGenTarget: typingsJapgolly.typescriptServices.TypeScript.ModuleGenTarget = js.native
