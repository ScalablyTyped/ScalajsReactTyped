...
object Collections {
  ...
  @js.native
  def DefaultStringTable: typingsJapgolly.typescriptServices.TypeScript.Collections.StringTable = js.native
  ...
  inline def DefaultStringTable_=(x: typingsJapgolly.typescriptServices.TypeScript.Collections.StringTable): Unit = ^.asInstanceOf[js.Dynamic].updateDynamic("DefaultStringTable")(x.asInstanceOf[js.Any])
  
  @JSImport("typescript-services", "Collections.HashTable")
  @js.native
  open class HashTable[TKey, TValue] protected ()
    extends StObject
       with typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue] {
  ...
  open class StringTable protected ()
    extends StObject
       with typingsJapgolly.typescriptServices.TypeScript.Collections.StringTable {
  ...
  inline def createHashTable[TKey, TValue](): typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue] = ^.asInstanceOf[js.Dynamic].applyDynamic("createHashTable")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue]]
  inline def createHashTable[TKey, TValue](capacity: Double): typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue] = ^.asInstanceOf[js.Dynamic].applyDynamic("createHashTable")(capacity.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue]]
  inline def createHashTable[TKey, TValue](capacity: Double, hash: js.Function1[/* k */ TKey, Double]): typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue] = (^.asInstanceOf[js.Dynamic].applyDynamic("createHashTable")(capacity.asInstanceOf[js.Any], hash.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue]]
  inline def createHashTable[TKey, TValue](capacity: Unit, hash: js.Function1[/* k */ TKey, Double]): typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue] = (^.asInstanceOf[js.Dynamic].applyDynamic("createHashTable")(capacity.asInstanceOf[js.Any], hash.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.Collections.HashTable[TKey, TValue]]
