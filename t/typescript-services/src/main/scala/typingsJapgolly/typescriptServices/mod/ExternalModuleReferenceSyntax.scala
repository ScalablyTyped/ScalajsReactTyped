...
open class ExternalModuleReferenceSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ExternalModuleReferenceSyntax {
  def this(
...
object ExternalModuleReferenceSyntax {
  ...
  /* static member */
  inline def create1(stringLiteral: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.ExternalModuleReferenceSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(stringLiteral.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ExternalModuleReferenceSyntax]
}
