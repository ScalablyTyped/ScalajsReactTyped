...
@JSImport("typescript-services", "WithStatement")
@js.native
open class WithStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.WithStatement {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.WithStatement, includingPosition: Boolean): Boolean = js.native
