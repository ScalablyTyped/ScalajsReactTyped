...
@js.native
open class WithStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.WithStatementSyntax {
  def this(
...
object WithStatementSyntax {
  ...
  /* static member */
  inline def create1(condition: IExpressionSyntax, statement: IStatementSyntax): typingsJapgolly.typescriptServices.TypeScript.WithStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(condition.asInstanceOf[js.Any], statement.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.WithStatementSyntax]
}
