...
@js.native
open class EqualsValueClause protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.EqualsValueClause {
  def this(value: typingsJapgolly.typescriptServices.TypeScript.AST) = this()
  ...
  /* CompleteClass */
  var value: typingsJapgolly.typescriptServices.TypeScript.AST = js.native
