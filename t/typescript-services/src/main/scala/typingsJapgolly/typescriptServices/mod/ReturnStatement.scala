...
open class ReturnStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ReturnStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.ReturnStatement, includingPosition: Boolean): Boolean = js.native
