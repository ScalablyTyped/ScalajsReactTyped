...
@js.native
open class DebuggerStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.DebuggerStatementSyntax {
...
object DebuggerStatementSyntax {
  ...
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.DebuggerStatementSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.DebuggerStatementSyntax]
}
