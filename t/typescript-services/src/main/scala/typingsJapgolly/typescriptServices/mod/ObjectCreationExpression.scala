...
@JSImport("typescript-services", "ObjectCreationExpression")
@js.native
open class ObjectCreationExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ObjectCreationExpression {
  def this(
    expression: typingsJapgolly.typescriptServices.TypeScript.AST,
    argumentList: typingsJapgolly.typescriptServices.TypeScript.ArgumentList
  ) = this()
  ...
  /* CompleteClass */
  var argumentList: typingsJapgolly.typescriptServices.TypeScript.ArgumentList = js.native
  ...
  override def structuralEquals(
    ast: typingsJapgolly.typescriptServices.TypeScript.ObjectCreationExpression,
