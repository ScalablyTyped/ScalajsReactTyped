...
open class LabeledStatementSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.LabeledStatementSyntax {
  def this(
...
object LabeledStatementSyntax {
  ...
  /* static member */
  inline def create1(identifier: ISyntaxToken, statement: IStatementSyntax): typingsJapgolly.typescriptServices.TypeScript.LabeledStatementSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(identifier.asInstanceOf[js.Any], statement.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.LabeledStatementSyntax]
}
