...
open class ObjectType protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ObjectType {
  def this(typeMembers: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2) = this()
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.ObjectType, includingPosition: Boolean): Boolean = js.native
  ...
  /* CompleteClass */
  var typeMembers: typingsJapgolly.typescriptServices.TypeScript.ISeparatedSyntaxList2 = js.native
