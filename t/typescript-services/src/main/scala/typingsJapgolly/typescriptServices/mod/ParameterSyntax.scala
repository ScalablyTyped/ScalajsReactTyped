...
open class ParameterSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ParameterSyntax {
  def this(
...
object ParameterSyntax {
  ...
  /* static member */
  inline def create(identifier: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.ParameterSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create")(identifier.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ParameterSyntax]
  
  /* static member */
  inline def create1(identifier: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.ParameterSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(identifier.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ParameterSyntax]
}
