...
@js.native
open class SimplePropertyAssignmentSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.SimplePropertyAssignmentSyntax {
  def this(
...
object SimplePropertyAssignmentSyntax {
  ...
  /* static member */
  inline def create1(propertyName: ISyntaxToken, expression: IExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.SimplePropertyAssignmentSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(propertyName.asInstanceOf[js.Any], expression.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.SimplePropertyAssignmentSyntax]
}
