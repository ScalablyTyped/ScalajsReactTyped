...
import typingsJapgolly.typescriptServices.TypeScript.Services.CompletionEntryDetails
...
open class LanguageService protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.Services.LanguageService {
  ...
  /* CompleteClass */
  override def getBreakpointStatementAtPosition(fileName: String, position: Double): typingsJapgolly.typescriptServices.TypeScript.Services.SpanInfo = js.native
  ...
  /* CompleteClass */
  override def getCompletionsAtPosition(fileName: String, position: Double, isMemberCompletion: Boolean): typingsJapgolly.typescriptServices.TypeScript.Services.CompletionInfo = js.native
  
  /* CompleteClass */
  override def getDefinitionAtPosition(fileName: String, position: Double): js.Array[typingsJapgolly.typescriptServices.TypeScript.Services.DefinitionInfo] = js.native
  ...
  override def getFormattingEditsAfterKeystroke(
    ...
    position: Double,
    key: String,
    options: typingsJapgolly.typescriptServices.TypeScript.Services.FormatCodeOptions
  ): js.Array[typingsJapgolly.typescriptServices.TypeScript.Services.TextEdit] = js.native
  ...
  /* CompleteClass */
  override def getImplementorsAtPosition(fileName: String, position: Double): js.Array[typingsJapgolly.typescriptServices.TypeScript.Services.ReferenceEntry] = js.native
  ...
  override def getIndentationAtPosition(
    fileName: String,
    position: Double,
    options: typingsJapgolly.typescriptServices.TypeScript.Services.EditorOptions
  ): Double = js.native
  ...
  /* CompleteClass */
  override def getNameOrDottedNameSpan(fileName: String, startPos: Double, endPos: Double): typingsJapgolly.typescriptServices.TypeScript.Services.SpanInfo = js.native
  
  /* CompleteClass */
  override def getNavigateToItems(searchValue: String): js.Array[typingsJapgolly.typescriptServices.TypeScript.Services.NavigateToItem] = js.native
  
  /* CompleteClass */
  override def getOccurrencesAtPosition(fileName: String, position: Double): js.Array[typingsJapgolly.typescriptServices.TypeScript.Services.ReferenceEntry] = js.native
  ...
  /* CompleteClass */
  override def getReferencesAtPosition(fileName: String, position: Double): js.Array[typingsJapgolly.typescriptServices.TypeScript.Services.ReferenceEntry] = js.native
  ...
  /* CompleteClass */
  override def getScriptLexicalStructure(fileName: String): js.Array[typingsJapgolly.typescriptServices.TypeScript.Services.NavigateToItem] = js.native
  
  /* CompleteClass */
  override def getSemanticDiagnostics(fileName: String): js.Array[Diagnostic] = js.native
  
  /* CompleteClass */
  override def getSignatureAtPosition(fileName: String, position: Double): typingsJapgolly.typescriptServices.TypeScript.Services.SignatureInfo = js.native
  ...
  /* CompleteClass */
  override def getTypeAtPosition(fileName: String, position: Double): typingsJapgolly.typescriptServices.TypeScript.Services.TypeInfo = js.native
