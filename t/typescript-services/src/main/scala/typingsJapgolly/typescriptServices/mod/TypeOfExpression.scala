...
@js.native
open class TypeOfExpression protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.TypeOfExpression {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.TypeOfExpression, includingPosition: Boolean): Boolean = js.native
