...
@js.native
open class GenericType protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.GenericType {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.GenericType, includingPosition: Boolean): Boolean = js.native
