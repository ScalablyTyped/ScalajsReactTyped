...
@js.native
open class PositionedSkippedToken protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.PositionedSkippedToken {
  def this(
    parentToken: typingsJapgolly.typescriptServices.TypeScript.PositionedToken,
    token: ISyntaxToken,
    fullStart: Double
  ) = this()
