...
open class CastExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.CastExpressionSyntax {
  def this(
...
object CastExpressionSyntax {
  ...
  /* static member */
  inline def create1(`type`: ITypeSyntax, expression: IUnaryExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.CastExpressionSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(`type`.asInstanceOf[js.Any], expression.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.CastExpressionSyntax]
}
