...
@JSImport("typescript-services", "ExportAssignment")
@js.native
open class ExportAssignment protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ExportAssignment {
  def this(identifier: typingsJapgolly.typescriptServices.TypeScript.Identifier) = this()
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.ExportAssignment, includingPosition: Boolean): Boolean = js.native
