...
@js.native
open class InterfaceDeclarationSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.InterfaceDeclarationSyntax {
  def this(
...
object InterfaceDeclarationSyntax {
  ...
  inline def create(
    ...
    identifier: ISyntaxToken,
    body: typingsJapgolly.typescriptServices.TypeScript.ObjectTypeSyntax
  ): typingsJapgolly.typescriptServices.TypeScript.InterfaceDeclarationSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create")(interfaceKeyword.asInstanceOf[js.Any], identifier.asInstanceOf[js.Any], body.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.InterfaceDeclarationSyntax]
  
  /* static member */
  inline def create1(identifier: ISyntaxToken): typingsJapgolly.typescriptServices.TypeScript.InterfaceDeclarationSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(identifier.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.InterfaceDeclarationSyntax]
}
