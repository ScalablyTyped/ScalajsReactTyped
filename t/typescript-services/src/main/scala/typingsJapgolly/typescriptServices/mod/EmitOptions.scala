...
open class EmitOptions protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.EmitOptions {
  def this(
  ...
  /* CompleteClass */
  override def compilationSettings(): typingsJapgolly.typescriptServices.TypeScript.ImmutableCompilationSettings = js.native
  
  /* private */ /* CompleteClass */
  override def determineCommonDirectoryPath(compiler: Any): Any = js.native
  
  /* CompleteClass */
  override def diagnostic(): typingsJapgolly.typescriptServices.TypeScript.Diagnostic = js.native
