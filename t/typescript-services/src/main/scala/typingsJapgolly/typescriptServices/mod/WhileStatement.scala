...
open class WhileStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.WhileStatement {
  def this(
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.WhileStatement, includingPosition: Boolean): Boolean = js.native
