...
@js.native
open class ConditionalExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ConditionalExpressionSyntax {
  def this(
...
object ConditionalExpressionSyntax {
  ...
  /* static member */
  inline def create1(condition: IExpressionSyntax, whenTrue: IExpressionSyntax, whenFalse: IExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.ConditionalExpressionSyntax = (^.asInstanceOf[js.Dynamic].applyDynamic("create1")(condition.asInstanceOf[js.Any], whenTrue.asInstanceOf[js.Any], whenFalse.asInstanceOf[js.Any])).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ConditionalExpressionSyntax]
}
