...
open class DeleteExpressionSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.DeleteExpressionSyntax {
...
object DeleteExpressionSyntax {
  ...
  /* static member */
  inline def create1(expression: IUnaryExpressionSyntax): typingsJapgolly.typescriptServices.TypeScript.DeleteExpressionSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(expression.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.DeleteExpressionSyntax]
}
