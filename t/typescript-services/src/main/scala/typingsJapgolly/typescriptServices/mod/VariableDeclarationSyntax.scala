...
@js.native
open class VariableDeclarationSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.VariableDeclarationSyntax {
...
object VariableDeclarationSyntax {
  ...
  /* static member */
  inline def create1(variableDeclarators: ISeparatedSyntaxList): typingsJapgolly.typescriptServices.TypeScript.VariableDeclarationSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(variableDeclarators.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.VariableDeclarationSyntax]
}
