...
open class BreakStatement protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.BreakStatement {
  ...
  /* CompleteClass */
  override def structuralEquals(ast: typingsJapgolly.typescriptServices.TypeScript.BreakStatement, includingPosition: Boolean): Boolean = js.native
