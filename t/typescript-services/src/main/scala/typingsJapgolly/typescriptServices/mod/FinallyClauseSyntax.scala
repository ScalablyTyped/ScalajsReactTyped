...
open class FinallyClauseSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.FinallyClauseSyntax {
  def this(
...
object FinallyClauseSyntax {
  ...
  /* static member */
  inline def create1(): typingsJapgolly.typescriptServices.TypeScript.FinallyClauseSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")().asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.FinallyClauseSyntax]
}
