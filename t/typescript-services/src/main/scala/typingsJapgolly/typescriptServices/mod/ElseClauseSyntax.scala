...
@js.native
open class ElseClauseSyntax protected ()
  extends StObject
     with typingsJapgolly.typescriptServices.TypeScript.ElseClauseSyntax {
...
object ElseClauseSyntax {
  ...
  /* static member */
  inline def create1(statement: IStatementSyntax): typingsJapgolly.typescriptServices.TypeScript.ElseClauseSyntax = ^.asInstanceOf[js.Dynamic].applyDynamic("create1")(statement.asInstanceOf[js.Any]).asInstanceOf[typingsJapgolly.typescriptServices.TypeScript.ElseClauseSyntax]
}
